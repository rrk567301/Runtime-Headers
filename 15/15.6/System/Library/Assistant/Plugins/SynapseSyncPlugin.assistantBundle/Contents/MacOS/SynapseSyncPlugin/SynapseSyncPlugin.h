...
- (char)_checkIfResetIsNeededForSyncTransaction:(id)a0 validity:(id)a1 serverCountOfItems:(long long)a2 startAnchorFromServer:(id)a3;
...
- (char)isSyncSlotNameAllowedToSync:(id)a0;
