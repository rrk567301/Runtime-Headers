...
+ (char)_addABMultiValuesForProperty:(id)a0 fromSAPerson:(id)a1 toABPerson:(id)a2;
...
+ (id)_convertToSAValuesForMultiValueProperty:(id)a0 fromABPerson:(id)a1 onlyUniqueLabels:(char)a2 noEmptyLabels:(char)a3;
+ (id)_convertToSAValuesForMultiValueProperty:(id)a0 fromABPerson:(id)a1 onlyUniqueLabels:(char)a2 noEmptyLabels:(char)a3 withFavoritesFromAddressBook:(id)a4 accountIdentifier:(id)a5;
...
+ (char)_setABMultiValueForProperty:(id)a0 fromSAPerson:(id)a1 toABPerson:(id)a2;
+ (char)addFieldsFromSAPerson:(id)a0 toABPerson:(id)a1;
...
+ (id)newSAPeopleFromMergingABPeople:(id)a0 withAccountIdentifier:(id)a1 returnSAABPeople:(char)a2;
+ (id)newSAPersonFromABPerson:(id)a0;
+ (id)newSAPersonFromABPerson:(id)a0 conversionType:(int)a1;
+ (id)newSAPersonFromABPerson:(id)a0 conversionType:(int)a1 withAccountIdentifier:(id)a2 withExternalIdentifier:(id)a3 forAddressBook:(id)a4 returnSAABPerson:(char)a5;
...
+ (id)phonemeDataKey;
+ (char)setFieldsFromSAPerson:(id)a0 toABPerson:(id)a1;
