...
- (void)reader:(id)a0 didFindExternalReferenceToObjectIdentifier:(long long)a1 componentIdentifier:(long long)a2 isWeak:(char)a3 allowUnknownObject:(char)a4 objectClass:(id)a5 objectProtocol:(id)a6 fromParentObject:(id)a7 completion:(id /* block */)a8;
