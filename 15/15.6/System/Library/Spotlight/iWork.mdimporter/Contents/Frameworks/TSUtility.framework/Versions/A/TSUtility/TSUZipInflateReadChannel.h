...
- (id)initWithReadChannel:(id)a0 uncompressedSize:(unsigned long long)a1 CRC:(unsigned int)a2 validateCRC:(char)a3;
- (void)prepareBuffer;
- (char)processData:(id)a0 inflateResult:(int *)a1 CRC:(unsigned int *)a2 isDone:(char)a3 handler:(id /* block */)a4;
