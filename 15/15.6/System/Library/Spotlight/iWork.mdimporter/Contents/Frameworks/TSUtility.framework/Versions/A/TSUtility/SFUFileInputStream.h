...
- (id)p_init;
- (char)p_configureWithFileDescriptor:(int)a0 offset:(long long)a1 length:(long long)a2;
- (char)p_configureWithPath:(id)a0 offset:(long long)a1 length:(long long)a2;
