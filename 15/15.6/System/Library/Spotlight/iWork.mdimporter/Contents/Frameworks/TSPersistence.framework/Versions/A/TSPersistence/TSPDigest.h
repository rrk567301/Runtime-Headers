...
+ (id)digestFromReadChannel:(id)a0 scanForOSLikeCorruption:(char)a1 foundLikelyOSCorruption:(char *)a2 foundLikelyZeroBytesCorruption:(char *)a3 error:(out id *)a4;
...
- (id)initFromReadChannel:(id)a0 scanForOSLikeCorruption:(char)a1 foundLikelyOSCorruption:(char *)a2 foundLikelyZeroBytesCorruption:(char *)a3 error:(out id *)a4;
