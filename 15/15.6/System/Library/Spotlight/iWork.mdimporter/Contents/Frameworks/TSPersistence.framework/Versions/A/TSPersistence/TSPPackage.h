...
+ (char)isZeroLengthFileOrEmptyDirectory:(id)a0 isDirectory:(char *)a1;
...
- (id)initWithPackageIdentifier:(unsigned char)a0 documentProperties:(id)a1 fileFormatVersion:(unsigned long long)a2 decryptionKey:(id)a3 fileCoordinatorDelegate:(id)a4 isLazyLoading:(char)a5;
...
- (id)newReadChannelForComponentLocator:(id)a0 compressionAlgorithm:(long long)a1 isStoredOutsideObjectArchive:(char)a2 error:(id *)a3;
- (id)newZipArchiveFromPackageURL:(id)a0 isLazyLoading:(char)a1 error:(id *)a2;
...
- (char)reloadZipArchiveIfNeededWithURLImpl:(id)a0 isLazyLoading:(char)a1 forceReload:(char)a2 error:(id *)a3;
