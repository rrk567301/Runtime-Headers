...
@property (readonly, nonatomic) char canLinkData;
...
+ (id)newPackageWriterWithPackageType:(long long)a0 URL:(id)a1 documentTargetURL:(id)a2 relativeURLForExternalData:(id)a3 packageIdentifier:(unsigned char)a4 documentProperties:(id)a5 documentMetadata:(id)a6 fileFormatVersion:(unsigned long long)a7 updateType:(long long)a8 cloneMode:(char)a9 documentSaveValidationPolicy:(id)a10 encryptionKey:(id)a11 originalDocumentPackage:(id)a12 originalSupportPackage:(id)a13 fileCoordinatorDelegate:(id)a14 progress:(id)a15 error:(id *)a16;

- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (char)closeAndReturnError:(id *)a0;
- (void)setError:(id)a0;
...
- (char)addData:(id)a0 infoMessage:(void *)a1 saveOperationState:(id)a2 error:(id *)a3;
- (void)closeCurrentChannel;
- (id)componentZipArchiveWriter;
- (void)copyComponent:(id)a0 locator:(id)a1 completion:(id /* block */)a2;
- (id)copyData:(id)a0 withReadChannel:(id)a1 decryptionInfo:(id)a2 size:(unsigned long long)a3 calculateCRC:(char)a4 preferredFilename:(id)a5 error:(id *)a6;
...
- (id)initWithURL:(id)a0 documentTargetURL:(id)a1 relativeURLForExternalData:(id)a2 packageIdentifier:(unsigned char)a3 documentProperties:(id)a4 documentMetadata:(id)a5 fileFormatVersion:(unsigned long long)a6 updateType:(long long)a7 cloneMode:(char)a8 documentSaveValidationPolicy:(id)a9 encryptionKey:(id)a10 originalDocumentPackage:(id)a11 originalSupportPackage:(id)a12 fileCoordinatorDelegate:(id)a13 progress:(id)a14 error:(id *)a15;
- (id)linkOrCopyData:(id)a0 fromURL:(id)a1 fromTemporaryLocation:(char)a2 decryptionInfo:(id)a3 preferredFilename:(id)a4 error:(id *)a5;
- (id)newComponentWriteChannelWithPackageLocator:(id)a0 compressionAlgorithm:(long long)a1 storeOutsideObjectArchive:(char)a2;
...
- (id)newRawComponentWriteChannelWithPackageLocator:(id)a0 storeOutsideObjectArchive:(char)a1;
- (id)newRawDataWriteChannelForRelativePath:(id)a0 originalLastModificationDate:(id)a1 originalSize:(unsigned long long)a2 originalCRC:(unsigned int)a3 forceCalculatingSizeAndCRCForPreservingLastModificationDate:(char)a4;
- (id)packageEntryInfoForComponentLocator:(id)a0 isStoredOutsideObjectArchive:(char)a1 packageURL:(id)a2;
