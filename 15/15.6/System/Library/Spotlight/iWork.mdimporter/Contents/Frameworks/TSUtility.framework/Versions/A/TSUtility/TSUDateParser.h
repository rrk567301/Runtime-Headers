...
- (id)newDateFromString:(id)a0 preferredFormatString:(id)a1 successfulFormatString:(id *)a2 tryAggressiveFormats:(char)a3;
...
- (id)p_newDateFromStringTryingFormats:(id)a0 locale:(id)a1 formats:(id)a2 outSuccessfulFormatString:(id *)a3 perfect:(char *)a4;
