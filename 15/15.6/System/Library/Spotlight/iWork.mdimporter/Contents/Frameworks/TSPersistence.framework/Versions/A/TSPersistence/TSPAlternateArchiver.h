...
@property (readonly, nonatomic) char isDiff;
...
- (const void *)baseFieldPathAndReturnShouldDeleteReturnedValue:(char *)a0;
- (void)enumerateKnownFieldRulesUsingBlock:(id /* block */)a0;
- (id)initWithObject:(id)a0 version:(unsigned long long)a1 fieldPath:(const void *)a2 isDiff:(char)a3 diffReadVersion:(unsigned long long)a4 parentArchiver:(id)a5;
