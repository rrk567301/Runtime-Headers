...
+ (id)formatString:(id)a0 transformedForNegativeStyle:(unsigned char)a1 placeMinusSignAfterRLM:(char)a2;

- (void).cxx_destruct;
- (id)initWithLocale:(id)a0;
- (char)currencyFromString:(id)a0 additionalCurrencyCode:(id)a1 value:(double *)a2 formatString:(id *)a3 currencyCode:(id *)a4;
- (char)decimalFromString:(id)a0 value:(double *)a1 formatString:(id *)a2;
- (id)defaultFormatStringForValueType:(int)a0;
- (id)defaultFormatStringForValueType:(int)a0 negativeStyle:(unsigned char)a1;
- (char)fractionFromString:(id)a0 value:(double *)a1;
...
- (char)p_valueFromString:(id)a0 formatters:(id)a1 value:(double *)a2 formatString:(id *)a3;
- (char)percentageFromString:(id)a0 value:(double *)a1 formatString:(id *)a2;
- (char)scientificFromString:(id)a0 value:(double *)a1 formatString:(id *)a2;
