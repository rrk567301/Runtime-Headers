...
@property (class, readonly, nonatomic) char tsp_isPerformingUpgrade;
@property (class, readonly, nonatomic) char tsp_isInternalObjectContainerClass;
...
@property (readonly, nonatomic) char tsp_isTransientObject;
...
@property (readonly, nonatomic) char canModify;
@property (readonly, nonatomic) NSString *packageLocator;
@property (readonly, nonatomic) char isComponentRoot;
@property (readonly, nonatomic) char componentRequiresCurrentVersion;
@property (readonly, nonatomic) unsigned long long componentReadVersion;
@property (readonly, nonatomic) char componentCanBeDropped;
...
@property (readonly, nonatomic) char shouldAlwaysArchiveWhenInMemory;
...
@property (readonly, nonatomic) char tsp_isPersisted;
...
+ (char)tsp_isTransientObjectIdentifier:(long long)a0;
...
+ (id)tsp_deserializeFromURL:(id)a0 options:(id)a1 context:(id)a2 isCrossDocumentPaste:(char)a3 isCrossAppPaste:(char)a4 completion:(id /* block */)a5;
...
- (void)setObjectUUID:(id)a0 updatingObjectUUIDMap:(char)a1;
...
- (char)tsp_hasSameUnknownFieldsAsObject:(id)a0;
