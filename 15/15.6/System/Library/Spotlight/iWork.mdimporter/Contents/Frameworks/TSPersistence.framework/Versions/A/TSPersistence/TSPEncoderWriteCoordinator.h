...
@interface TSPEncoderWriteCoordinator : NSObject <TSPArchiverManagerDelegate, TSPComponentWriterDelegate, TSPDataArchiver, TSPObjectModifyDelegate, TSPProxyObjectWriting, TSPProxyObjectMapping> {
    ...
    _Atomic char _didStopCapturingSnapshots;
...
- (char)archiverManager:(id)a0 shouldDelayArchivingObject:(id)a1;
...
- (char)componentWriter:(id)a0 shouldDelayWritingObject:(id)a1;
- (id)componentWriter:(id)a0 wantsComponentOfObject:(id)a1 componentReadVersion:(unsigned long long *)a2;
- (id)componentWriter:(id)a0 wantsExplicitComponentRootObjectForObject:(id)a1 archiverOrNil:(id)a2 claimingComponent:(id)a3 hasArchiverAccessLock:(char)a4;
...
- (char)shouldDelayArchivingObject:(id)a0;
