...
+ (id)bezierPathWithRoundedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 upperRightRadius:(double)a1 lowerRightRadius:(double)a2 lowerLeftRadius:(double)a3 upperLeftRadius:(double)a4 useLegacyCorners:(char)a5 keepNoOpElements:(char)a6;
...
- (void)appendBezierPathWithArcWithCenter:(struct CGPoint { double x0; double x1; })a0 radius:(double)a1 startAngle:(double)a2 endAngle:(double)a3 clockwise:(char)a4;
...
- (char)_isValid:(double)a0;
- (void)_doPath;
- (void)_addPathSegment:(long long)a0 point:(struct CGPoint { double x0; double x1; })a1;
- (void)_appendToPath:(id)a0 skippingInitialMoveIfPossible:(char)a1;
- (struct CGPoint { double x0; double x1; })_checkPointForValidity:(struct CGPoint { double x0; double x1; })a0;
- (void)appendBezierPath:(id)a0 skippingInitialMoveIfPossible:(char)a1;
- (void)appendBezierPathWithArcWithEllipseBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 startAngle:(double)a1 swingAngle:(double)a2 angleType:(int)a3 startNewPath:(char)a4;
- (void)appendBezierPathWithArcWithEllipseBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 startRadialVector:(struct CGPoint { double x0; double x1; })a1 endRadialVector:(struct CGPoint { double x0; double x1; })a2 angleSign:(int)a3 startNewPath:(char)a4;
