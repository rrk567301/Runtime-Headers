...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)validateObjectContextForObject:(id)a0;
- (void)acquireArchiverAccessLockAndWriteObjects:(id)a0 parentObject:(id)a1 completion:(id /* block */)a2;
- (char)canSkipArchivingStronglyReferencedObject:(id)a0 fromComponentRootObject:(id)a1;
...
- (char)isObjectExternal:(id)a0 archiverOrNil:(id)a1 parentObject:(id)a2 hasArchiverAccessLock:(char)a3 claimingComponent:(id *)a4 isOwnedByDifferentPackage:(char *)a5 isAmbiguousOwnership:(char *)a6;
- (char)isObjectExternalBecauseItAlreadyBelongsToAnotherComponent:(id)a0 parentObject:(id)a1 claimingComponent:(id *)a2 claimingPackageIdentifier:(unsigned char *)a3 claimingComponentWillBeCopied:(char *)a4 claimingComponentReadVersion:(unsigned long long *)a5;
- (char)isObjectExternalBecauseOfExplicitComponentOwnership:(id)a0 archiverOrNil:(id)a1 claimingComponentOrNil:(id)a2 hasArchiverAccessLock:(char)a3 explicitComponentRootObject:(id *)a4 claimingComponent:(id *)a5 isOwnedByDifferentPackage:(char *)a6;
- (char)shouldDelayWritingObject:(id)a0;
- (char)shouldWriteObject:(id)a0;
- (char)supportsAutomaticAmbiguousOwnershipResolutionWithComponentReadVersion:(unsigned long long)a0;
- (void)validateAmbiguousObjectOwnershipForObject:(id)a0 explicitComponentRootObject:(id)a1 parentObject:(id)a2 claimingComponent:(id)a3 claimingPackageIdentifier:(unsigned char)a4 claimingComponentWillBeCopied:(char)a5 claimingComponentReadVersion:(unsigned long long)a6 isAmbiguousOwnership:(char *)a7;
- (void)validateExplicitComponentOwnershipForObject:(id)a0 archiverOrNil:(id)a1 parentObject:(id)a2 hasArchiverAccessLock:(char)a3;
