...
@interface TSPDataReferenceMap : NSObject <TSPDataInDocumentProviding> {
    ...
    _Atomic char _isReady;
    _Atomic char _isTornDown;
...
- (char)p_isObjectIdentifierInDocument:(long long)a0;
...
- (char)isDataInDocument:(id)a0;
- (void)markAsReady;
- (void)objectIdentifier:(long long)a0 didAddReferenceToDataIdentifier:(long long)a1 isObjectPersisted:(char)a2;
- (void)objectIdentifier:(long long)a0 willRemoveReferenceToDataIdentifier:(long long)a1 isObjectPersisted:(char)a2;
...
- (char)p_isDataInDocument:(long long)a0;
- (void)p_notifyDataInDocumentUpdated;
- (char)p_objectIdentifier:(long long)a0 didAddReferenceToDataIdentifier:(long long)a1 increment:(long long)a2 isObjectPersisted:(char)a3;
- (char)p_objectIdentifier:(long long)a0 willRemoveReferenceToDataIdentifier:(long long)a1 isObjectPersisted:(char)a2;
