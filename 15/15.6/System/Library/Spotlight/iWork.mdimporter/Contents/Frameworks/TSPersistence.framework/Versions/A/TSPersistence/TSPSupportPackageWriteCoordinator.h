...
- (long long)componentIdentifierForObjectIdentifier:(long long)a0 objectOrNil:(id)a1 objectUUIDOrNil:(id)a2 outComponentIsVersioned:(char *)a3;
- (char)componentWriter:(id)a0 externalPackageDidWriteObject:(id)a1 claimingComponent:(id *)a2 componentReadVersion:(unsigned long long *)a3;
...
- (char)isComponentExternalWithIdentifier:(long long)a0 wasCopied:(char *)a1 componentReadVersion:(unsigned long long *)a2;
- (char)isObjectInExternalPackage:(id)a0 claimingComponent:(id *)a1 componentReadVersion:(unsigned long long *)a2;
- (char)isObjectWrittenInExternalPackageWithIdentifier:(long long)a0;
- (char)shouldEnqueueComponent:(id)a0;
- (char)wasComponentCopied:(long long)a0;
