...
@property (readonly, nonatomic) char isEmbiggened;
...
@property (readonly, nonatomic) char needToUpgradeCellStorage;
@property (readonly, nonatomic) char upgradeRepairedTiles;
@property (nonatomic) char shouldUseWideRows;
...
- (id)_tileForID:(unsigned long long)a0 createIfMissing:(char)a1;
- (id)_tileFromGroupForTileID:(unsigned long long)a0;
...
- (char)auditRowInfoCellCountsReturningResult:(id *)a0;
- (char)auditTilesForRowOverlapAndExtensionPastTableBounds:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 withDataStore:(id)a1 result:(id *)a2;
