...
@property (nonatomic, setter=i_setAdvancedGradientFlag:) char i_advancedGradientFlag;
...
@property (readonly, nonatomic) char isAdvancedGradient;
@property (readonly, nonatomic) char isAdvancedGradientIgnoringFlag;
...
- (char)isEqualIgnoringTransform:(id)a0;
...
- (void)p_setIsAdvancedGradient:(char)a0;
- (void)p_setOpacity:(double)a0;
- (char)p_stopsHaveAlpha;
