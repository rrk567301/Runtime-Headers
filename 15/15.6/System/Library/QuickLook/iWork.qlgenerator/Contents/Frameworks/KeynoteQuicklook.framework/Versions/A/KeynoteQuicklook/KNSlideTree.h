...
+ (char)areMultipleMasterTypesInCollection:(id)a0;
+ (id)slideNodeDepthMapToCleanUpSlideNodes:(id)a0 atDepths:(id)a1 minimumValidDepth:(unsigned long long)a2;
+ (id)slideNodeDepthMapToCleanUpSlideNodes:(id)a0 atDepths:(id)a1 minimumValidDepth:(unsigned long long)a2 canExceedSlideTreeMaxDepth:(char)a3;
+ (id)slideNodeDepthMapToCleanUpSlideNodes:(id)a0 minimumValidDepth:(unsigned long long)a1;
+ (id)slideNodeDepthMapToCleanUpSlideNodes:(id)a0 minimumValidDepth:(unsigned long long)a1 canExceedSlideTreeMaxDepth:(char)a2;
...
- (char)containsSlideNode:(id)a0;
- (id)defaultSlideNodeForNewSelectionNearestToIndex:(unsigned long long)a0;
- (id)descendantsOfSlideNode:(id)a0 omitSkippedSlideNodes:(char)a1 omitCollapsedSlideNodes:(char)a2;
...
- (id)slideNodeAfterSlideNode:(id)a0 omitSkippedSlideNodes:(char)a1 omitCollapsedSlideNodes:(char)a2;
- (id)slideNodeAtIndex:(unsigned long long)a0 ignoreHiddenNodes:(char)a1;
- (id)slideNodeBeforeSlideNode:(id)a0 omitSkippedSlideNodes:(char)a1 omitCollapsedSlideNodes:(char)a2;
- (id)slideNodeForFormulaReferenceName:(id)a0 caseSensitive:(char)a1;
- (char)slideNodeIsDisplayed:(id)a0;
...
- (unsigned long long)visiblePageCountIsSeparatedByBuilds:(char)a0;
