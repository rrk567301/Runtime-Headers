...
@property (readonly, nonatomic) char shouldResizeWithAnchor;
@property (readonly, nonatomic) char shouldSplitAcrossAnchorRects;
@property (readonly, nonatomic) char shouldUseHeadTail;
@property (readonly, nonatomic) char shouldResizeInOneDirection;
@property (readonly, nonatomic) char shouldInvertStretchAxis;
@property (readonly, nonatomic) TSUColor *penColor;
@property (readonly, nonatomic) long long toolType;
@property (readonly, nonatomic) char shouldShowAnchorRect;
@property (readonly, nonatomic) char needsTextRecognition;
@property (readonly, nonatomic) char isCalloutLine;
@property (readonly, nonatomic) char isCalloutMarginAnnotation;
@property (readonly, nonatomic) char isCalloutParentStorage;
...
- (char)isStretchableParagraphAnnotation;
- (char)p_isSubStorage;
