...
@property (readonly, nonatomic) char hasDelayedArchivingPriority;
@property (readonly, nonatomic) char hasMaxSegmentElementCount;
@property (readonly, nonatomic) char hasMaxSegmentSize;
...
@property (readonly, nonatomic) char disableSegmentation;
...
- (id)initWithContext:(id)a0 shouldDelayArchiving:(char)a1 storeOutsideObjectArchive:(char)a2;
...
- (char)hasMaxSegmentCost;
- (id)initWithArray:(id)a0 context:(id)a1;
- (id)initWithContext:(id)a0 shouldDelayArchiving:(char)a1 delayedArchivingPriority:(unsigned int)a2 storeOutsideObjectArchive:(char)a3;
...
- (char)mergeSegmentIfNeededAtIndex:(unsigned long long)a0;
...
- (id)segmentRanges;
- (void)setMaxSegmentElementCount:(unsigned long long)a0 willModify:(char)a1;
- (void)setMaxSegmentSize:(unsigned long long)a0 willModify:(char)a1;
- (void)setRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forSegmentIndex:(unsigned long long)a1;
- (char)shouldBisectForCount:(unsigned long long)a0 byteSize:(unsigned long long)a1 cost:(unsigned long long)a2;
