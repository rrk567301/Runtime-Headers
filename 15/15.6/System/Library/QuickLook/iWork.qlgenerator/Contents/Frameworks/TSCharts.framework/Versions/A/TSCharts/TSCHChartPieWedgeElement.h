...
- (void).cxx_destruct;
- (char)angleInRange:(double)a0 startAngle:(double)a1 endAngle:(double)a2;
- (struct CGPoint { double x0; double x1; })arcEndPoint;
- (struct CGPoint { double x0; double x1; })arcStartPoint;
- (struct CGPoint { double x0; double x1; })bendedLineMidpointWithStartPoint:(struct CGPoint { double x0; double x1; })a0 length:(double)a1 shouldBeUpwards:(char)a2;
- (char)calloutLineIntersectsWedgeWithStartPoint:(struct CGPoint { double x0; double x1; })a0 midPoint:(struct CGPoint { double x0; double x1; })a1;
...
- (struct CGPoint { double x0; double x1; })defaultLabelCenterPointForLabelWithSize:(struct CGSize { double x0; double x1; })a0 bended:(char)a1;
- (struct CGPoint { double x0; double x1; })defaultLabelEndpointForBendedLineLabels;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })defaultLabelRectForLabelWithSize:(struct CGSize { double x0; double x1; })a0 bended:(char)a1;
- (struct CGPoint { double x0; double x1; })firstHalfOfBendedLineVectorNormalizedShouldBeUpwards:(char)a0;
...
- (char)isInUpperHalfOfChartWithStartPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)isOnLeftSideOfChart;
- (struct TSCHChartPieLabelRects { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; })labelRectsForFirstLabelWithSize:(struct CGSize { double x0; double x1; })a0 secondLabelSize:(struct CGSize { double x0; double x1; })a1 stacked:(char)a2 stackedLabelCenterAlign:(char)a3 placeToTheSideOfPieChart:(char)a4;
- (char)lineIntersectsLineWithStartPoint:(struct CGPoint { double x0; double x1; })a0 firstLineEndPoint:(struct CGPoint { double x0; double x1; })a1 secondLineStartPoint:(struct CGPoint { double x0; double x1; })a2 secondLineEndPoint:(struct CGPoint { double x0; double x1; })a3 outIntersectionPoint:(struct CGPoint { double x0; double x1; } *)a4;
- (char)lineIntersectsWedgeWithLineStartPoint:(struct CGPoint { double x0; double x1; })a0 lineEndPoint:(struct CGPoint { double x0; double x1; })a1;
...
- (char)pointWithinWedgeSpread:(struct CGPoint { double x0; double x1; })a0;
- (char)pointWithinWedgeSpread:(struct CGPoint { double x0; double x1; })a0 percentage:(double)a1;
...
- (char)shouldUsePerpendicularBendedLineWithStartPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)wedgeBisectionIntersectsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 outIntersectionPointClosestToWedgeTip:(struct CGPoint { double x0; double x1; } *)a1;
