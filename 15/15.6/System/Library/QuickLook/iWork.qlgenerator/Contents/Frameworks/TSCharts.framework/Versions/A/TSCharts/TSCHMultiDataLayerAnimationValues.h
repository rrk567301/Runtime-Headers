...
+ (id)animationValuesWithLayer:(id)a0 key:(id)a1 values:(id)a2 keyTimes:(id)a3 needPresentationLayerValues:(char)a4;

- (id)description;
- (void).cxx_destruct;
- (id)initWithLayer:(id)a0 key:(id)a1 values:(id)a2 keyTimes:(id)a3 needPresentationLayerValues:(char)a4;
