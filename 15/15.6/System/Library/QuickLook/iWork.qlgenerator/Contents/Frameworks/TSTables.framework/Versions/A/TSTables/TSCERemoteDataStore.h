...
@property (nonatomic) char hasInterestingKeys;
@property (readonly, nonatomic) NSMutableDictionary *ownerMap;
@property (nonatomic) char registeredWithCoordinator;
@property (nonatomic) double remoteDataSyncKey;
@property (retain, nonatomic) NSMutableSet *unSyncedStocks;
@property (readonly, nonatomic) char hasArchivableState;
@property (readonly, nonatomic) char hasFullyPopulatedCache;
...
- (void)p_recursiveWriteWillModify:(char)a0 withBlock:(id /* block */)a1;
- (id)p_tsceValueFromTsceCellValue:(id)a0;
- (id)p_updateCachesWithMap:(id)a0 quotes:(id)a1 overwriteValues:(char)a2;
