...
@property (nonatomic) char isVertical;

- (id)initWithLeftAnchor:(struct CGPoint { double x0; double x1; })a0 rightAnchor:(struct CGPoint { double x0; double x1; })a1 isVertical:(char)a2;
