...
@interface TSCEEvaluationContext : NSObject <NSCopying> {
    ...
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _containingCell;
...
@property (nonatomic) char inArrayMode;
@property (nonatomic) char suppressCycleCheck;
@property (nonatomic) char allowAbort;
@property (nonatomic) char pivotRefsReturnsValueGrid;
@property (nonatomic) char isForChartFormulas;
@property (nonatomic) char wantsCalculatedPrecedents;
@property (nonatomic) char shouldReportWarnings;
@property (nonatomic) char hasWarnings;
@property (nonatomic) char allowLambdaAsResult;
@property (nonatomic) unsigned char hidingActionMask;
@property (nonatomic) unsigned char intersectionRangeContext;
@property (readonly, nonatomic) char evaluationAborted;
@property (readonly, nonatomic) TSCERemoteDataSpecifierSet *remoteDataKeysInterestedIn;
@property (nonatomic) char shouldPickupRemoteDataInterests;
@property (readonly, nonatomic) char calculatedPrecedentsExist;

+ (id)contextForCalcEngine:(id)a0 containingTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 containingCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
+ (id)contextForCalcEngine:(id)a0 containingTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 containingCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2 inArrayMode:(char)a3;
...
- (void)addCalculatedPrecedent:(const struct TSCEAnyRef { unsigned short x0; struct TSCESpanningRangeRef { struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x0; unsigned char x1; } x1; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x2; char x3; char x4; id x5; } *)a0;
...
- (const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)containingCell;
- (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })containingCellRef;
...
- (id)initWithCalcEngine:(id)a0 containingTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 containingCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2 inArrayMode:(char)a3;
- (char)insideFunctor:(unsigned long long)a0;
...
- (id)unwrapThunk:(id)a0 takeSideEffects:(char)a1;
