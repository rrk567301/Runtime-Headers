...
@property (nonatomic) char containsCellBorderChanges;
@property (nonatomic) char containsSuppressCustomFormatHandlingProperty;
...
- (void)addCellDiff:(id)a0 andCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (id)addCellDiff:(id)a0 andCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 avoidCopy:(char)a2;
...
- (id)addCellDiff:(id)a0 andCellUID:(struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a1 avoidCopy:(char)a2;
- (void)addCellDiffs:(id)a0 atCellUIDs:(id)a1;
- (void)appendCellDiffMap:(id)a0;
- (id)cellDiffMapByIntersectingUIDs:(const void *)a0 inRows:(char)a1;
...
- (id)initWithContext:(id)a0 cellDiffArray:(id)a1 cellUIDList:(id)a2 uidBased:(char)a3;
- (void)p_resolveCellIDsToUUIDsByTableInfo:(id)a0;
- (char)p_scanCellDiffArrayForCellBorderChanges:(id)a0;
- (char)p_scanCellDiffArrayForSuppressCustomFormatHandlingProperty:(id)a0;
- (char)p_scanNSArrayOfDiffsForCellBorderChanges:(id)a0;
- (char)p_scanNSArrayOfDiffsForSuppressCustomFormatHandlingProperty:(id)a0;
