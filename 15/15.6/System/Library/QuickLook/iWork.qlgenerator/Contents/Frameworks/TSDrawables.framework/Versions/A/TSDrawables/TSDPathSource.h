...
@property (readonly, nonatomic) char isRectangularForever;
@property (readonly, nonatomic) char isCircular;
...
@property (nonatomic) char hasHorizontalFlip;
@property (nonatomic) char hasVerticalFlip;
