...
- (int)chunkPlane;
- (struct CGPath { } *)clippingPathForRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inGroupIndex:(unsigned long long)a1 series:(id)a2 withContext:(struct CGContext { } *)a3 relativelyPositive:(char)a4 stackRects:(id)a5 forceRoundedCornersOff:(char)a6;
...
- (void)p_drawLayer:(struct CGLayer { } *)a0 intoContext:(struct CGContext { } *)a1 contextRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 groupIndex:(unsigned long long)a3 series:(id)a4 relativelyPositive:(char)a5 stackRects:(id)a6 forceRoundedCornersOff:(char)a7;
...
- (void)p_renderLabelsWithLabelCount:(unsigned long long)a0 transforms:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a1 clipRects:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2 strings:(id)a3 context:(struct CGContext { } *)a4 tLayerRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 groupedShadows:(char)a6 groupedTransparencyLayerOpened:(char *)a7 textEngine:(id)a8 paragraphStyle:(id)a9 viewScale:(double)a10;
- (id)p_strokeForSeriesIndex:(unsigned long long)a0 withContext:(struct CGContext { } *)a1;
- (void)renderElementStroke:(id)a0 intoContext:(struct CGContext { } *)a1 usingElementRenderRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 inGroupIndex:(unsigned long long)a3 series:(id)a4 relativelyPositive:(char)a5 stackRects:(id)a6 forceRoundedCornersOff:(char)a7;
...
- (struct CGPath { } *)roundedCornerPathForRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 shouldRoundOuterEndOnly:(char)a1 relativelyPositive:(char)a2;
