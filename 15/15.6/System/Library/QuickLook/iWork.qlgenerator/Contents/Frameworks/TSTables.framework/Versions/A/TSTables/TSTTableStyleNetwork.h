...
+ (id)p_deriveHeaderColumnPivotSeparatorAndHeaderRowPivotGroupVerticalStrokeFromTableStyle:(id)a0 propertyMap:(id)a1 returnHeaderRowPivotGroupVerticalStroke:(char)a2;
...
+ (unsigned long long)styleAreaForColumnType:(unsigned char)a0 rowType:(unsigned char)a1 forAPivotTable:(char)a2;
...
- (char)stylesInStylesheet:(id)a0;
- (void)saveToArchiver:(id)a0;
- (char)isEquivalentForCrossDocumentPasteMasterComparison:(id)a0 objectComparisonBlock:(id /* block */)a1;
- (void)loadFromArchive:(const void *)a0 unarchiver:(id)a1;
- (void)loadFromUnarchiver:(id)a0;
- (id)deriveCategoryTextStyleForTableStyleArea:(unsigned long long)a0 connectedToStylesheet:(char)a1;
...
- (id)deriveCategoryCellStyleForTableStyleArea:(unsigned long long)a0 connectedToStylesheet:(char)a1;
- (id)cellStyleForTableStyleArea:(unsigned long long)a0;
- (const void *)cellStyles;
- (void)clearAndGenerateCategoryStylesConnectedToStylesheet:(char)a0;
- (void)clearAndGeneratePivotStylesConnectedToStylesheet:(char)a0;
- (void)enumerateAllStylesWithBlock:(id /* block */)a0;
- (void)generateCategoryStrokesInTableStyle:(id)a0;
- (void)generateCategoryStylesConnectedToStylesheet:(char)a0;
- (void)generatePivotStrokesInTableStyle:(id)a0;
- (void)generatePivotStylesConnectedToStylesheet:(char)a0;
...
- (id)p_deriveCategoryCellStyleForTableStyleArea:(unsigned long long)a0 fromCellStyle:(id)a1 connectedToStylesheet:(char)a2;
- (id)p_deriveCategoryTextStyleForTableStyleArea:(unsigned long long)a0 fromTextStyle:(id)a1 connectedToStylesheet:(char)a2;
- (id)p_derivePivotCellStyleFromCellStyle:(id)a0 optionalSourceFill:(id)a1 brightnessShift:(double)a2 connectedToStylesheet:(char)a3 styleArea:(unsigned long long)a4;
- (void)p_saveToArchive:(void *)a0 archiver:(id)a1 isPre30Alternate:(char)a2;
- (id)sheetFill;
