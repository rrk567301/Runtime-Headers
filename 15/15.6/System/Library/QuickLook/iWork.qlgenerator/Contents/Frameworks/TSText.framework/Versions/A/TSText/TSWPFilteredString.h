...
- (void)attributesAtCharIndex:(unsigned long long)a0 attributesOfInterest:(char *)a1 attributesTable:(id *)a2 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a3;
...
- (id)initWithTextSource:(id)a0 subrange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 removeRanges:(id)a2;
