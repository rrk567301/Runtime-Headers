...
- (void)addRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 height:(double)a1 paddingInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2 isCheckbox:(char)a3;
