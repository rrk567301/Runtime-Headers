...
- (char)applyFixedHeight:(double)a0;
- (char)applyFixedWidth:(double)a0;
- (char)p_applyUnifyFixedSize:(double)a0 region:(id)a1 direction:(long long)a2 count:(unsigned int)a3 currentArray:(void *)a4 minimumArray:(void *)a5;
