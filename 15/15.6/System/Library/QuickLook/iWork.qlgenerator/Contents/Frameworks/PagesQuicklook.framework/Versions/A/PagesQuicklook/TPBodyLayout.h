...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_rectForSelection:(id)a0 useParagraphModeRects:(char)a1;
...
- (char)excludeFromNearestVisibleRectSearchForSelectionPath:(id)a0;
- (id)existingAttachmentLayoutForInfo:(id)a0;
- (char)isFootnoteContainerOnSamePageAsTarget:(id)a0;
- (char)needsInflation;
