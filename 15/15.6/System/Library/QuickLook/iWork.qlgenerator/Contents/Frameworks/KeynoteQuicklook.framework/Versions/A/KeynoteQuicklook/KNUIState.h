...
@property (nonatomic) char showsMobileLightTable;
@property (nonatomic) double mobileLightTableZoomScale;
@property (nonatomic) char mobileLightTableHidesSkippedSlides;
@property (nonatomic) char showsMobileOutline;
...
@property (nonatomic) char desktopOutlineViewDefaultFixed;
...
@property (nonatomic) char commentsPrintingToggleEnabled;
