...
@property (readonly, nonatomic, getter=isInSyncWithShow) char inSyncWithShow;
...
- (char)isLocallyOutOfSyncWithShowUsingLocalOutOfSyncToken:(id)a0;
...
- (id)recordingByMarkingAsOutOfSyncWithShow:(char)a0 withLocalOutOfSyncToken:(id)a1 restoringModificationDate:(id)a2;
