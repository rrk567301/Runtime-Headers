...
@interface TSTPivotOwner : TSPObject <TSCEFormulaOwning, TSCETableNameChangeProtocol> {
    ...
    char _resetHeaderLabelsAfterSort;
    char _invalidateAfterAsyncSort;
    char _autoImplicitSort;
    char _isHidingGrandTotalColumns;
    char _isHidingGrandTotalRows;
}
...
@property (nonatomic) char shouldSkipNextAsyncSort;
...
- (void)clearAllPivotHiddenAndFiltered:(char)a0;
...
- (char)groupingColumnUidExists:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
...
- (char)isHidingGrandTotalColumns;
- (char)isHidingGrandTotalRows;
...
- (void)p_resetHiddenTotalsForGroupingColumnUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 hideTotals:(char)a1;
- (void)p_resetSortingStructures;
- (void)p_resetSummaryFormulasForRunningTotalsOnly:(char)a0 preservingStyles:(char)a1;
- (void)p_setEmptyPivotTableLabels;
- (void)p_setPivotHeaderCellsResettingPivotHidden:(char)a0 preservingStyles:(char)a1;
...
- (char)requiresTrailingAlignment:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)requiresUnwrapping:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (void)setHidingGrandTotalColumns:(char)a0;
- (void)setHidingGrandTotalRows:(char)a0;
- (void)setPivotOptions:(id)a0 groupingColumnUid:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a1 forSortingOptions:(char)a2 redoSort:(char)a3;
