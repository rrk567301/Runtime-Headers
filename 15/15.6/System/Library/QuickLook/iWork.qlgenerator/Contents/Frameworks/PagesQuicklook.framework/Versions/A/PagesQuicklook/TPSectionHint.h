...
+ (char)verifyHints:(id)a0 withBodyStorage:(id)a1 upToPageIndex:(unsigned long long)a2;

- (id)init;
- (void).cxx_destruct;
- (id)copyForArchiving;
- (id)initWithArchive:(const void *)a0 unarchiver:(id)a1;
- (char)containsDocumentPageIndex:(unsigned long long)a0;
- (id)copyForCaching;
- (char)hasEndOfTextLayoutBeforePageIndex:(unsigned long long)a0;
- (char)hasPageHintOfKind:(long long)a0 atPageIndex:(unsigned long long)a1;
- (char)hasPageHintOfKind:(long long)a0 beforePageIndex:(unsigned long long)a1;
