...
@property (readonly, nonatomic) char rangeIsEmpty;
...
- (id)initWithAddress:(const void *)a0 rangeVector:(const void *)a1 propertyId:(unsigned short)a2 noop:(char)a3;
- (id)initWithAddress:(const void *)a0 rangeVector:(const void *)a1 propertyId:(unsigned short)a2 transformBehavior:(int)a3 noop:(char)a4;
- (id)initWithAddress:(const void *)a0 rangeVector:(const void *)a1 propertyType:(struct { unsigned short x0; char x1; char x2; unsigned short x3[6]; })a2 transformBehavior:(int)a3 noop:(char)a4;
...
- (char)isEqualWithIgnoringEmptyRange:(id)a0;
