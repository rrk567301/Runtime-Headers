...
- (char)isUnderlineStrokeWithVerticalTextLayout:(char)a0;
...
- (id)subStrokeFromStartIndex:(unsigned long long)a0 toEndIndex:(unsigned long long)a1 adjustingStart:(char)a2 andAdjustingEnd:(char)a3 toEdgesOfRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
