...
- (char)isForDstTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
- (char)isForSrcTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
