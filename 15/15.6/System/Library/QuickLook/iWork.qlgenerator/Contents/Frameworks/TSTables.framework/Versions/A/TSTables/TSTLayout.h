...
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } origin; struct { unsigned int numberOfColumns; unsigned int numberOfRows; } size; } editingSpillingTextRange;
@property (nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } origin; struct { unsigned int numberOfColumns; unsigned int numberOfRows; } size; } prevEditingSpillingTextRange;
@property (readonly, nonatomic) char containedTextEditorSpills;
@property (readonly, nonatomic) char containedTextEditorWraps;
...
- (char)p_layoutWhollyContainsGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (void)p_updateCachedStyleInformationFromCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (int)reapCoordinatesChangedMaskForChrome;
- (void)removeContainedTextEditingLayout;
- (char)resizeMayChangeAspectRatio;
- (void)setupContainedTextEditingLayout:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)supportsRotation;
- (void)validateTableNameVisibility;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })adjustRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 forScrollingToSelectionPath:(id)a1 forZoom:(char)a2;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })adjustedInsetsForTarget:(id)a0;
- (char)descendersCannotClip;
- (char)forceParentAutosizeFlagsForTextLayout:(id)a0;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })_floatingCellRangeAtRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inLayoutSpace:(id)a1 withTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })alignedStrokeFrameForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (id)alignedStrokeFramePathForGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 frameType:(int)a1 viewScale:(double)a2 inset:(double)a3 reoriginToZero:(char)a4 clipToVisibleRect:(char)a5 cornerRadius:(double)a6 outMaskPath:(id *)a7;
- (id)alignedStrokeFramePathForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 frameType:(int)a1 viewScale:(double)a2 inset:(double)a3 reoriginToZero:(char)a4 clipToVisibleRect:(char)a5 cornerRadius:(double)a6 outMaskPath:(id *)a7;
- (id)attachmentCellLayoutForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 optionalCell:(id)a1;
- (void)bezierPathsForCellRegion:(id)a0 selectionMask:(unsigned int)a1 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 viewScale:(double)a3 inset:(double)a4 clipToVisibleRect:(char)a5 cornerRadius:(double)a6 block:(id /* block */)a7;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })extendedPartitionRangeSingleSpaceIntersectionWithCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })floatingHeaderColumnRangeAtRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })floatingHeaderRowRangeAtRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (int)naturalAlignmentForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })p_cellIDForWPLayout:(id)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_computeSpillingTextFrameForEditingLayout:(id)a0 textSize:(struct CGSize { double x0; double x1; })a1 editingSpillRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a2;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })p_maximumSpillRangeForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })p_spillRangeForMaskingRichTextLayout:(id)a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })p_spillRangeToRightForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_textFrameForWrappingCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 defaultRowHeight:(char *)a1;
