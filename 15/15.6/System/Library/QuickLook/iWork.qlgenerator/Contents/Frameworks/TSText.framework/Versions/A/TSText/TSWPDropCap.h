...
@property (nonatomic) char shapeEnabled;
...
- (id)initWithType:(long long)a0 numberOfLines:(unsigned long long)a1 numberOfRaisedLines:(unsigned long long)a2 outdent:(double)a3 padding:(double)a4 shapeEnabled:(char)a5 cornerRadius:(double)a6 characterScale:(double)a7 wrapType:(long long)a8 numberOfCharacters:(unsigned long long)a9;
