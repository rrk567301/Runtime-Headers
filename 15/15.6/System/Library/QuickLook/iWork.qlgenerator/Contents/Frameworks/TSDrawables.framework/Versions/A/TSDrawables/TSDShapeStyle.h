...
@property (readonly) char wantsHighContrastBackgroundColor;
@property (readonly) char hasLineEnds;
...
- (char)wantsHighContrastFillColorWithColor:(id)a0;
- (char)wantsHighContrastStrokeColorWithColor:(id)a0;
- (char)wantsHighContrastBackgroundColorWithColor:(id)a0;
