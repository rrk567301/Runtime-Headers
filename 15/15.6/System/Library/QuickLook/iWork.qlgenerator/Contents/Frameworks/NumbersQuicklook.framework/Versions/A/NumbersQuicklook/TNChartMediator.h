...
- (struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; struct TSCERangeRef *x1; struct __compressed_pair<TSCERangeRef *, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; } x2; })expandSingleRangeForLabels:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 formulaType:(unsigned long long)a1;
- (struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; struct TSCERangeRef *x1; struct __compressed_pair<TSCERangeRef *, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; } x2; })expandSingleTractForProposedCategoryLabels:(id)a0 byRow:(char)a1;
- (id)formulaOwner;
- (id)formulaStorageFromCatTable:(id)a0 selection:(id)a1 direction:(int)a2;
- (id)formulaStorageFromPivotTable:(id)a0;
- (id)formulaStorageFromPivotTable:(id)a0 cellRect:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a1;
- (id)formulaStorageFromPivotTable:(id)a0 cellRect:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a1 aggregateIndex:(unsigned short)a2 plotDirection:(int)a3 groupLabelOptions:(unsigned char)a4;
...
- (char)interestedInRewrite:(id)a0;
- (void)invalidateAndSynchronizeMediator;
- (void)invalidateForCalcEngine:(id)a0;
- (char)labelFormulasAreAllStaticInFormulaStorage:(id)a0;
...
- (char)p_didHeaderRowRangesChangeForCalcEngine:(id)a0;
- (struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; struct TSCERangeRef *x1; struct __compressed_pair<TSCERangeRef *, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; } x2; })p_expandSingleRangeForLabels:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 iterateOverRowsNotColumns:(char)a1;
...
- (struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })p_headerRowRangeRefForTableInfo:(id)a0;
- (char)p_isScatterOrBubble;
- (char)p_isValidFormulaEditForScheme:(id)a0;
- (char)p_labelsAreStaticInMap:(id)a0 ofType:(unsigned long long)a1;
...
- (void)p_reregister:(char)a0 withCalculationEngine:(id)a1;
- (char)p_tableHasBaseCell:(struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a0 withCalcEngine:(id)a1;
- (char)p_tableHasBaseRange:(struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a0 withCalcEngine:(id)a1;
- (char)p_tabularCategoryLabelsAppearRegularInMap:(id)a0;
...
- (char)repairBadRefsInFormulas:(id)a0;
- (void)repairMissingCategoryLabelsInMap:(id)a0;
- (void)repairMissingCategoryLabelsInMap:(id)a0 ignoringNonVisibleLabels:(char)a1;
...
- (void)setEditingIsPhantomOverride:(char)a0;
...
- (void)setFormulaStorage:(id)a0 doRegistration:(char)a1;
- (char)shouldSkipHiddenData;
