...
@property (nonatomic) char isLabelRTL;
...
@property (readonly, nonatomic) char isLabelTateChuYoko;
...
- (id)initWithType:(unsigned long long)a0 labelString:(id)a1 textLine:(struct __CTLine { } *)a2 listNumber:(unsigned long long)a3 isTateChuYoko:(char)a4 baselineOffset:(double)a5;
- (char)isEqualToListLabel:(id)a0;
