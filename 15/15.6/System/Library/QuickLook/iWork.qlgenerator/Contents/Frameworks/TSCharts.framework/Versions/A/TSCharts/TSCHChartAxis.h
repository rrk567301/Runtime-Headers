...
@property (readonly, nonatomic) char supportsFormattedStringForInvalidValue;
@property (readonly, nonatomic) char supportsLabelAngleBaselineOptions;
...
@property (readonly) char supportsSummaryValueLabels;
...
+ (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })sizeOfLabelsForInfo:(id)a0 onlyHeight:(char)a1;
...
+ (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })sizeOfSeriesLabelsForInfo:(id)a0 onlyHeight:(char)a1;
...
- (id)p_dataFormatterForSeries:(id)a0 groupIndex:(unsigned long long)a1 onlyForValidValue:(char)a2;
...
- (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })sizeOfLabelsForInfo:(id)a0 enumerator:(id)a1 onlyHeight:(char)a2;
