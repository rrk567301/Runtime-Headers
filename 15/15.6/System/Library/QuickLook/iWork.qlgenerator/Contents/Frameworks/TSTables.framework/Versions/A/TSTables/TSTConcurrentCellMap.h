...
@property (nonatomic) char applyingToTable;
...
- (void)convertToUuidBasedCellMapUsingTableInfo:(id)a0 pruneCategorizedCells:(char)a1;
...
- (id)initWithContext:(id)a0 affectsCellBorders:(char)a1;
- (id)initWithContext:(id)a0 uidBased:(char)a1 affectsCellBorders:(char)a2;
