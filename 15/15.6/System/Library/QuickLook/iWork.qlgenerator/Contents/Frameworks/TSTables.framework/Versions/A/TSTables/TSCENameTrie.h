...
- (char)containsName:(id)a0;
- (void)enumerateNamesMatchingPrefix:(id)a0 block:(id /* block */)a1;
- (id)foldName:(id)a0;
- (char)insertFoldedName:(id)a0;
- (char)insertName:(id)a0;
- (void *)nodeForName:(id)a0 createIfMissing:(char)a1;
