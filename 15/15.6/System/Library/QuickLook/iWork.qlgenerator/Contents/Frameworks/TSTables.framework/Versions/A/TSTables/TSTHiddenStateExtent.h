...
@property (readonly, nonatomic) char forRows;
@property (readonly, nonatomic) char anyHidden;
@property (readonly, nonatomic) char anyUserHidden;
@property (readonly, nonatomic) char anyCollapsed;
...
- (id)tableTranslator;
- (char)anyHiddenInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)anyHiddenInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forAction:(unsigned char)a1;
- (id)applyCollapseExpandState:(id)a0 outUndoState:(id *)a1;
- (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })cellReferenceForIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0;
...
- (char)hasHiddenAtIndex:(unsigned int)a0;
- (id)hiddenOrCollapsedIndexes;
- (char)hideAtBaseIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0 forAction:(unsigned char)a1;
- (char)hideAtUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 forAction:(unsigned char)a1;
- (char)hideAtUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 forIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a1 forViewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a2 forAction:(unsigned char)a3;
- (char)hideAtViewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a0 forAction:(unsigned char)a1;
...
- (id)initWithHiddenStatesOwner:(id)a0 forRows:(char)a1;
...
- (char)isGroupUIDCollapsed:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
...
- (id)p_calculateAverageThresholdWithCalcEngine:(id)a0 formulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
- (id)p_calculateTopOrBottomThresholdWithCalcEngine:(id)a0 formulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1 isTop:(char)a2 keyScale:(unsigned char)a3;
- (void)p_calculateUniqueDistinctIndexWithCalcEngine:(id)a0 formulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1 tableModel:(id)a2 rule:(id)a3;
- (id)p_calculateUniqueThresholdWithCalcEngine:(id)a0 formulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
- (char)p_canUsePrePivotFilterSet;
- (id)p_collapsedIndexes;
- (id)p_createThresholdCellValue:(id)a0 locale:(id)a1;
...
- (id)precedentsForFilterSet:(id)a0 calcEngine:(id)a1 hostOwnerUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a2 hostCellID:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a3;
...
- (void)setGroupUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 asCollapsed:(char)a1;
- (void)setupAfterUnarchive;
- (char)showAtBaseIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0 forAction:(unsigned char)a1;
- (char)showAtUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 forAction:(unsigned char)a1;
- (char)showAtUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 forIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a1 forViewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a2 forAction:(unsigned char)a3;
- (char)showAtViewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a0 forAction:(unsigned char)a1;
