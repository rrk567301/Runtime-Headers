...
@property (readonly, nonatomic) char hasRunningTotalAggregates;
...
- (id)columnNameForAggregateIndex:(unsigned long long)a0 allowDuplicateNames:(char)a1;
...
- (id)compactDescriptionForAggregateIndex:(unsigned long long)a0 useShortLabel:(char)a1 allowDuplicateNames:(char)a2 locale:(id)a3;
- (id)descriptionForAggregateIndex:(unsigned long long)a0 locale:(id)a1;
- (id)descriptionForAggregateIndex:(unsigned long long)a0 useShortLabel:(char)a1 allowDuplicateNames:(char)a2 locale:(id)a3;
...
- (id)findExistingGroupNodeInGroupBy:(id)a0 usingValues:(const void *)a1 upToLevel:(unsigned long long)a2 coerceForDateFields:(char)a3;
- (id)firstAggregate;
...
- (void)getPivotHidingIndexesForGroupingColumn:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 columns:(id)a1 rows:(id)a2 forHiding:(char)a3 forPivotTable:(id)a4;
...
- (id)groupByForOwnerIndex:(unsigned short)a0 createIfMissing:(char)a1;
...
- (id)groupValueTupleForUuidCoord:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 createIfMissing:(char)a1;
...
- (char)hasUnfilteredAt:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 forDimension:(long long)a1;
- (char)hasValidRunningTotalFieldForAggregate:(id)a0;
...
- (void)p_resetAllGroupUids:(void *)a0 baseGroupUids:(void *)a1 summaryGroupUids:(void *)a2 forGroupBy:(id)a3 uptoLevel:(unsigned char)a4 isFlattening:(char)a5;
...
- (char)sawMissingCombination:(const struct TSUIndexSet { unsigned char x0 : 1; unsigned char x1 : 1; struct TSUIndexRange { long long x0; long long x1; } x2; struct *x3; } *)a0;
...
- (char)verifyConnectionsWithPivotDataModel:(id)a0 pivotTableUID:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a1;
