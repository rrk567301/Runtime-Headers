...
- (id)p_resourceAtIndex:(unsigned long long)a0 childIndex:(unsigned long long)a1 dimension:(unsigned long long)a2 createIfAbsent:(char)a3;
- (id)p_resourceForExternalLabelAttribute:(id)a0 index:(unsigned long long)a1 createIfAbsent:(char)a2;
- (void)p_submitExternalAttributesForIndex:(unsigned long long)a0 processor:(id)a1;
- (id)p_texcoordResourceAtIndex:(unsigned long long)a0 createIfAbsent:(char)a1;
- (id)p_vertexResourceAtIndex:(unsigned long long)a0 createIfAbsent:(char)a1;
