...
- (id)copyByUpdatingHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0;
- (id)copyByUpgradingToLinkedRefAtHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0;
- (id)copyToUidFormForTableInfo:(id)a0 inCellCoordinate:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 preserveHostCell:(char)a2;
- (char)evaluateFormulaAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 withCalcEngine:(id)a1 onOwnerUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a2;
...
- (char)isEqualForInspector:(id)a0;
