...
@property (readonly, nonatomic) char useReverseMap;
@property (nonatomic) TSTTableDataListSegment *cachedSegment;
@property (nonatomic) char isNewForBraveNewCell;
@property (nonatomic) NSObject<TSDContainerInfo, TSWPStorageParent> *richTextParentInfo;
@property (readonly, nonatomic) char mightHaveCustomFormats;
...
- (unsigned int)addCellFormat:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addCommentStorage:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addConditionalStyleSet:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addControlCellSpec:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addFormula:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addFormulaError:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addImportWarningSet:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addMultipleChoiceListFormat:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addRichText:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addString:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
- (unsigned int)addStyle:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
...
- (void)dropReferenceForKey:(unsigned int)a0 callWillModify:(char)a1;
- (void)dropReferences:(unsigned int)a0 forKey:(unsigned int)a1 callWillModify:(char)a2;
...
- (void)p_setObject:(id)a0 atKey:(unsigned int)a1 updateReverseMap:(char)a2;
- (id)p_setPayload:(id)a0 atSuggestedKey:(unsigned int)a1 callWillModify:(char)a2;
...
- (id)stringForKey:(unsigned int)a0 outShouldWrap:(char *)a1 outIsShared:(char *)a2;
- (id)styleForKey:(unsigned int)a0;
- (void)takeReferenceForKey:(unsigned int)a0 callWillModify:(char)a1;
- (void)takeReferences:(unsigned int)a0 forKey:(unsigned int)a1 callWillModify:(char)a2;
