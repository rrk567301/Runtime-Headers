...
+ (char)isSupportAtURLValid:(id)a0 documentUUID:(id)a1 versionUUID:(id)a2 documentProperties:(id *)a3;
+ (id)supportBundleURLForDocumentUUID:(id)a0 delegate:(id)a1;
+ (id)supportDirectoryURLWithDelegate:(id)a0 isUnique:(char *)a1;
...
- (char)copyOrMoveSupportAtURL:(id)a0 originalDocumentProperties:(id)a1 toURL:(id)a2 isCopying:(char)a3 newDocumentProperties:(id)a4 error:(id *)a5;
- (char)didUpdateDocumentUUIDWithOriginalDocumentProperties:(id)a0 newDocumentProperties:(id)a1 preserveOriginalDocumentSupport:(char)a2 preserveShareUUID:(char)a3 originalURL:(id)a4 newURL:(id *)a5 error:(id *)a6;
- (char)endSaveWithSuccess:(char)a0 packageWriter:(id)a1 newURL:(id *)a2 writtenPackage:(id *)a3;
- (id)supportURLWithDocumentUUID:(id)a0;
- (void)updatePresentedItemURL:(id)a0;
- (char)writeSupportForDocumentUUID:(id)a0 error:(id *)a1 writer:(id /* block */)a2;
