...
- (unsigned long long)countOfGridLinesInBody:(id)a0 forAxis:(id)a1 minor:(char)a2 outNewLineDescriptors:(struct **)a3;
...
- (char)hasAxisLineInBody:(id)a0 forAxis:(id)a1 outTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a2 outLine:(struct { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } *)a3;
