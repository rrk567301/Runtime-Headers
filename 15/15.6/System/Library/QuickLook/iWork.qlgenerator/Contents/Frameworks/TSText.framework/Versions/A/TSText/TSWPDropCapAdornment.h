...
@property (nonatomic) char hasChangeTracking;
...
@property (readonly, nonatomic) char characterFillShouldFillTextContainer;
...
@property (readonly, nonatomic) char suppressLineFragmentTextRendering;
...
- (void)drawAdornment:(id)a0 inContext:(struct CGContext { } *)a1 viewScale:(double)a2 flipShadows:(char)a3 blackAndWhite:(char)a4;
- (struct CGPoint { double x0; double x1; })glyphOriginIncludingOutdent;
- (id)initWithDropCapStyle:(id)a0 characterStyle:(id)a1 paragraphStyle:(id)a2 text:(id)a3 rightToLeft:(char)a4 vertical:(char)a5 fontHeightInfo:(struct TSWPFontHeightInfo { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; })a6 lineSpacingMode:(int)a7 lineSpacingAmount:(double)a8;
- (struct CGPoint { double x0; double x1; })originIncludingOutdent;
- (char)p_calculateMetrics;
- (id)p_createWrapSegments;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_imageBoundsIncludingShadow:(char)a0;
