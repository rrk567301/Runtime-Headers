...
- (void)p_setLeftStroke:(id)a0 order:(int)a1 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
...
- (id)cellBorderAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (char)mightHaveCellBorderAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (void)p_setBottomStroke:(id)a0 order:(int)a1 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
- (void)p_setRightStroke:(id)a0 order:(int)a1 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
...
- (void)p_setTopStroke:(id)a0 order:(int)a1 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })p_strokeRect;
- (void)setBordersWithCellMap:(id)a0;
- (void)setBordersWithConcurrentCellMap:(id)a0 forTableInfo:(id)a1;
- (void)setCellBorder:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
