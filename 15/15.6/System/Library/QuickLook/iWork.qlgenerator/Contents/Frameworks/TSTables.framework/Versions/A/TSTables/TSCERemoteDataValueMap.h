...
- (id)allSpecifiers;
- (char)containsValueForAllSpecifiersInSet:(id)a0;
- (char)containsValueForSpecifier:(id)a0;
...
- (id)updateWithValuesFromMap:(id)a0 overwriteValues:(char)a1;
