...
@property (readonly, nonatomic) char hasIWorkAuthorName;
...
- (id)iCloudDocumentPreferenceKeyForKvsDocumentKey:(id)a0 isMatchingKey:(char *)a1;
- (id)iCloudPreferenceKeys;
- (unsigned long long)iWorkAuthorColorIndex;
- (id)iWorkAuthorPrivateIDsAndMetadata;
- (char)isICloudDocumentPreference:(id)a0 validForKey:(id)a1;
- (char)isValidIWorkAuthorColorIndex:(unsigned long long)a0;
