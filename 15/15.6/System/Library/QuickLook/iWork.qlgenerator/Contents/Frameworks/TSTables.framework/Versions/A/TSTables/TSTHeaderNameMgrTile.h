...
- (void *)createFragmentEntryForString:(id)a0 createIfMissingUsingPrecedentCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
