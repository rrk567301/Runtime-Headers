...
@property (nonatomic) char forceOutputSizeToMatchThumbnailSize;
@property (nonatomic) char shouldTintWhiteImages;

- (void)p_hideCaptionAndTitleFromDeepCopiedDrawable:(id)a0;
- (char)p_isTextInfo:(id)a0;
...
- (char)p_requiresModifiedStrokeForDrawable:(id)a0 atScaleFactor:(double)a1;
