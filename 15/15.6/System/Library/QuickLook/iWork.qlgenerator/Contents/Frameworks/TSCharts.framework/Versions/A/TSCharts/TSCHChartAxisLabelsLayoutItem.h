...
- (char)p_circularStridingLabelAtIndex:(unsigned long long)a0 inLayoutSize:(struct CGSize { double x0; double x1; })a1 intersectsLabelAtIndex:(unsigned long long)a2 extraTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a3;
...
- (struct CGPoint { double x0; double x1; })p_relativeAnchorPointForLabelGeometry:(id)a0 useMidpoints:(char)a1;
