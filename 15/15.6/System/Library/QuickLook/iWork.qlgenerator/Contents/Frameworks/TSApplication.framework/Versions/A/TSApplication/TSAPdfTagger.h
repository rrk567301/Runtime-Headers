...
+ (char)isHeaderTag:(int)a0;
+ (char)isHeadingStyle:(id)a0 headingIndex:(int *)a1;
+ (char)shouldMapDrawableRep:(id)a0;
+ (char)totalCellNumberInAllTablesExceedsMaxAllowedInDocument:(id)a0;
...
- (void)assertCharIndexRelativeToParagraphRange:(char)a0;
- (void)assertTopOfContextStackIsParagraph:(char)a0;
...
- (void)beginCheckboxCell:(char)a0;
- (void)beginComment;
...
- (void)beginPrimaryTextRunWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 hasActualContents:(char)a1;
...
- (void)beginTableCell:(id)a0 withCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 cellHasContents:(char)a2 cellIsPrimary:(char)a3;
...
- (char)charIndexIsAtEndOfParagraph:(unsigned long long)a0;
- (char)charIndexIsAtStartOfParagraph:(unsigned long long)a0;
...
- (void)endPrimaryTextRunWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 hasActualContents:(char)a1;
- (void)endRatingCell;
...
- (void)endTableCell:(id)a0 withCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 cellHasContents:(char)a2 cellIsPrimary:(char)a3;
...
- (char)needsSeparateRunsForLineFragmentWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
...
- (char)textStorageChunkIsFootnote:(id)a0;
