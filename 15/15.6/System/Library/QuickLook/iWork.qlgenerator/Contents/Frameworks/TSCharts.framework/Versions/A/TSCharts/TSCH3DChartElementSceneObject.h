...
- (void)render:(id)a0;
- (struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; })adjustedScaleForInfoChartScale:(void *)a0 scene:(id)a1;
- (char)applyEffectsForProperties:(id)a0 series:(id)a1 index:(void *)a2 pipeline:(id)a3 injectEffectsUsingBlock:(id /* block */)a4;
- (float)chartOpacityForScene:(id)a0;
- (id)delegateFromScene:(id)a0;
- (float)depthForScene:(id)a0;
- (id)elementPropertiesFromScene:(id)a0;
- (id)geometryForSeries:(id)a0 index:(void *)a1 scene:(id)a2;
...
- (char)p_isRenderPassDelayedForDelegate:(id)a0;
- (void)p_processItems:(id)a0 processItemsClass:(Class)a1;
- (void)postrenderElement:(id)a0;
- (void)prerenderElement:(id)a0;
- (void)rayPick:(id)a0;
- (struct ElementRenderPass { int x0; })render:(id)a0 pushMatrix:(char)a1 delayedPass:(char)a2;
...
- (void)renderTwoPassGeometry:(char)a0 processor:(id)a1 renderBlock:(id /* block */)a2;
...
- (char)shouldDelayForChartOpacity:(float)a0;
