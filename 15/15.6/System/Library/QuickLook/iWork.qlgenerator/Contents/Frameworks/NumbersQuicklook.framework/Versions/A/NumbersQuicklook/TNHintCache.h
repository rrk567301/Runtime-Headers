...
@interface TNHintCache : NSObject {
    struct { struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } topLeft; struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } bottomRight; } mPageRange;
...
@property (nonatomic) char pageCoordinatesWithAnnotationsIsValid;
...
- (id)layoutAtCoordinate:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 parentLayout:(id)a1;
- (id)p_hintCacheEntryAtCoordinate:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (struct { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })pageRangeWithUpperBound:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
