...
@property (readonly, nonatomic) char sourceObjectsMayUseMultipleStylesheets;
...
- (id)initWithTargetStylesheet:(id)a0 deepCopyObjectMap:(id)a1 sourceObjectsMayUseMultipleStylesheets:(char)a2;
