...
- (void)p_finishContextAfterRendering:(struct CGContext { } *)a0 modelCache:(id)a1 didEnableTransparencyLayer:(char)a2;
...
- (void)p_renderLabelsWithLabelCount:(unsigned long long)a0 transforms:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a1 clipRects:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2 strings:(id)a3 context:(struct CGContext { } *)a4 tLayerRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 textEngine:(id)a6 paragraphStyle:(id)a7 viewScale:(double)a8;
- (void)p_setupContextForRendering:(struct CGContext { } *)a0 layerRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 modelCache:(id)a2 shadow:(id)a3 outDidEnableTransparencyLayer:(char *)a4;
