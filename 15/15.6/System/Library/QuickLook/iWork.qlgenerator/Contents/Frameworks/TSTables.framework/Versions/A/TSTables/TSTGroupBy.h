...
@interface TSTGroupBy : TSPObject <TSCEFormulaOwning, TSTGroupByChangeProtocol, TSTCompatibilityVersionProviding> {
    ...
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _columnOrderChangedCoord;
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _rowOrderChangedCoord;
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _rowOrderChangedIgnoringRecalcCoord;
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _hiddenStatesChangedCoord;
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _nextAggFormulaCoord;
...
@property (readonly, nonatomic) char isForPivotTable;
...
@property (readonly, nonatomic) struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } indirectAggTypeChangeFormulaCoord;
@property (readonly, nonatomic) struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } groupingColumnsFormulaCoord;
@property (readonly, nonatomic) struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } groupingColumnHeadersFormulaCoord;
@property (readonly, nonatomic) struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } allAggsInGroupRootFormulaCoord;
@property (readonly, nonatomic) struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } columnOrderChangedPrecedent;
@property (readonly, nonatomic) struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } rowOrderChangedPrecedent;
@property (readonly, nonatomic) struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } rowOrderChangedPrecedentIgnoringRecalc;
@property (readonly, nonatomic) struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } hiddenStatesChangedPrecedent;
@property (readonly, nonatomic) char usesPrePivotAggregateTypesOnly;
@property (nonatomic) char needsRebuildOfAggFormulas;
...
+ (char)validateNumberOfGroupsForGroupingColumnList:(id)a0 pivotDataModel:(id)a1 limit:(unsigned long long)a2 groupNodeCount:(unsigned long long *)a3;
+ (char)validateNumberOfGroupsForGroupingColumnList:(id)a0 sourceTableModel:(id)a1 sourceBodyTract:(id)a2 limit:(unsigned long long)a3 groupNodeCount:(unsigned long long *)a4;
...
- (struct vector<TSCECategoryRef *, std::allocator<TSCECategoryRef *>> { id *x0; id *x1; struct __compressed_pair<TSCECategoryRef *__strong *, std::allocator<TSCECategoryRef *>> { id *x0; } x2; })captureAnyCategoryRefsForViewRegion:(id)a0 atLevel:(unsigned char)a1 asSpanning:(char)a2;
- (struct vector<TSCECategoryRef *, std::allocator<TSCECategoryRef *>> { id *x0; id *x1; struct __compressed_pair<TSCECategoryRef *__strong *, std::allocator<TSCECategoryRef *>> { id *x0; } x2; })captureCategoryLabelRefsForViewRegion:(id)a0 atLevel:(unsigned char)a1 asSpanning:(char)a2 forRows:(char)a3;
- (struct vector<TSCECategoryRef *, std::allocator<TSCECategoryRef *>> { id *x0; id *x1; struct __compressed_pair<TSCECategoryRef *__strong *, std::allocator<TSCECategoryRef *>> { id *x0; } x2; })captureCategoryRefsForViewRegion:(id)a0 atLevel:(unsigned char)a1 asSpanning:(char)a2;
...
- (char)isSpanningCategoryRef:(id)a0;
- (char)isValidCategoryRef:(id)a0;
- (id)linkedResolver;
...
- (char)containsRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
...
- (id)aggNodeForAggFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
- (id)aggregateLabelForCategoryRef:(id)a0;
- (struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })aggregateRangeRefForCategoryRef:(id)a0;
...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct __compressed_pair<TSKUIDStruct *, std::allocator<TSKUIDStruct>> { struct TSKUIDStruct *x0; } x2; })bodyRowUidsForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 ordered:(char)a2;
- (struct vector<TSCECategoryRef *, std::allocator<TSCECategoryRef *>> { id *x0; id *x1; struct __compressed_pair<TSCECategoryRef *__strong *, std::allocator<TSCECategoryRef *>> { id *x0; } x2; })captureCategoryRefsFromIterator:(id)a0 atLevel:(unsigned char)a1 asSpanning:(char)a2;
- (id)categoryRefForAggregateRangeRef:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0;
...
- (struct vector<TSCECellRef, std::allocator<TSCECellRef>> { struct TSCECellRef *x0; struct TSCECellRef *x1; struct __compressed_pair<TSCECellRef *, std::allocator<TSCECellRef>> { struct TSCECellRef *x0; } x2; })cellRefsForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 ordered:(char)a2;
- (char)changeCell:(id)a0 atCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 toBeInGroup:(id)a2;
...
- (void)clearAggNode:(id)a0 forFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
- (void)clearValueForFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
- (id)columnAggregateListCopy;
- (id)columnAggregatesOnColumnUids:(const void *)a0;
- (id)columnNameForCategoryLevel:(unsigned char)a0 shortForm:(char)a1;
...
- (char)createAggregatorsIfMissingAndAssert:(char)a0;
...
- (id)findGroupNodeForValue:(id)a0 atLevel:(unsigned char)a1 createIfMissing:(char)a2;
- (unsigned int)findKeyForRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
- (void)freeAggFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })getNextAggFormulaCoord;
- (id)groupHierarchyTreeAsFiltered:(char)a0 usingOrder:(id)a1 forDimension:(long long)a2;
- (unsigned char)groupLevelForGroupUid:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
- (unsigned char)groupLevelForGroupUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 isBlank:(char *)a1 isError:(char *)a2;
...
- (id)groupValueHierarchyStringForCategoryRef:(id)a0 forHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 namingContext:(id)a2;
...
- (id)initWithGroupings:(id)a0 isEnabled:(char)a1 categoryOwner:(id)a2 groupByUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a3 ownerIndex:(unsigned short)a4;
...
- (char)isBlankGroupUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
- (char)isDeferringGroupByChangeNotifications;
- (char)isErrorGroupUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
- (char)isGroupingColumn:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
- (char)isPrePivotV2Compatible;
...
- (char)p_setCell:(id)a0 groupingCellPlan:(const void *)a1 groupValue:(id)a2 toGroup:(id)a3 templateCell:(id)a4;
- (void)p_setCell:(id)a0 groupingTypeCombo:(unsigned short)a1 groupingCellValue:(id)a2 toBeInGroup:(id)a3;
- (id)prettyStringForCategoryRef:(id)a0 forHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 namingContext:(id)a2;
...
- (void)setAggNode:(id)a0 forFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
...
- (void)setValue:(id)a0 forFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1;
...
- (void)updateAggFormulaCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (void)updateWithDocumentRoot:(id)a0;
- (void)upgradeForNewAggregateTypes:(id)a0;
- (void)usedAggFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
- (id)valueForFormulaCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
- (id)valueGridForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 hidingActionMask:(unsigned char)a2 outError:(id *)a3;
- (id)valueGridForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 outError:(id *)a2;
- (id)valueGridForCategoryRef:(id)a0 outError:(id *)a1;
- (struct vector<TSCEValue *, std::allocator<TSCEValue *>> { id *x0; id *x1; struct __compressed_pair<TSCEValue *__strong *, std::allocator<TSCEValue *>> { id *x0; } x2; })valuesForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 hidingActionMask:(unsigned char)a2 outError:(id *)a3;
- (struct vector<TSCEValue *, std::allocator<TSCEValue *>> { id *x0; id *x1; struct __compressed_pair<TSCEValue *__strong *, std::allocator<TSCEValue *>> { id *x0; } x2; })valuesForCategoryRef:(id)a0 atRowUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 outError:(id *)a2;
- (struct vector<TSCEValue *, std::allocator<TSCEValue *>> { id *x0; id *x1; struct __compressed_pair<TSCEValue *__strong *, std::allocator<TSCEValue *>> { id *x0; } x2; })valuesForCategoryRef:(id)a0 outError:(id *)a1;
