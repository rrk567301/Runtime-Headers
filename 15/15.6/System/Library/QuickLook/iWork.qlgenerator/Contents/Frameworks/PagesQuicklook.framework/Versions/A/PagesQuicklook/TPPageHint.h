...
@property (nonatomic) char hasForcedFootnotes;
...
- (char)syncsFlowRanges:(id)a0 withEndOfPageHint:(id)a1;
- (char)syncsWithEndOfPageHint:(id)a0 bodyStorage:(id)a1 flowRanges:(id)a2;
