...
- (void)drawLineFromPoint:(struct CGPoint { double x0; double x1; })a0 toPoint:(struct CGPoint { double x0; double x1; })a1 thickness:(double)a2 length:(double)a3 lineCount:(long long)a4 lineFragmentStart:(struct CGPoint { double x0; double x1; })a5 isWavyUnderline:(char)a6;
