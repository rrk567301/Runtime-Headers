...
@interface KNSlideNode : TSPObject <TSKDocumentObject, TSKModel, TSCEResolverContainer> {
    ...
    NSArray *_children;
    char _backgroundIsNoFillOrColorFillWithAlpha;
...
@property (nonatomic, getter=isSkipped) char skipped;
@property (nonatomic, getter=isCollapsed) char collapsed;
@property (nonatomic, getter=isCollapsedInOutlineView) char collapsedInOutlineView;
...
@property (readonly, nonatomic) char needsToUpdateLiveVideoSourceUsageAfterUnarchiving;
...
- (id)descendantsOmittingSkippedSlideNodes:(char)a0 omittingCollapsedSlideNodes:(char)a1;
- (void)didLoadSlide:(id)a0;
- (char)hasSlideSpecificHyperlinkToNode:(id)a0;
