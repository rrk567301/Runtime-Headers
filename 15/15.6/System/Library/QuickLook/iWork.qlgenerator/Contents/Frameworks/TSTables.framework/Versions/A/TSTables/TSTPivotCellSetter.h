...
@interface TSTPivotCellSetter : NSObject {
    ...
    char _preservingStyles;
    NSObject<OS_dispatch_queue> *_workerQueue;
    TSULocale *_documentLocale;
    NSString *_blankString;
}

@property (readonly, nonatomic) char madeChange;

- (void).cxx_destruct;
- (void)applyCellValue:(id)a0 atUidCoord:(struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a1 appendTotalForPivotsFlag:(char)a2;
...
- (id)initWithPivotTable:(id)a0 minion:(id)a1 preservingStyles:(char)a2;
