...
- (char)okToAnchorDrawable:(id)a0 toPageIndex:(unsigned long long)a1;
- (void)accquireLockAndPerformAction:(id /* block */)a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })bodyRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (void)changeTrackingVisibilityDidChange;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })documentPageRangeOfSectionIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })footnoteLayoutRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (char)isPaginationComplete;
- (char)isPaginationCompleteThroughPageIndex:(unsigned long long)a0;
...
- (char)okToAnchorDrawables:(id)a0 toPageIndex:(unsigned long long)a1;
- (unsigned long long)p_autoNumberForStorage:(id)a0 ignoreDeletedFootnotes:(char)a1 footnoteKind:(long long)a2;
- (unsigned long long)pageIndexForAnchoredCharIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (unsigned long long)pageIndexForCharIndex:(unsigned long long)a0 forcePagination:(char)a1;
...
- (unsigned long long)sectionIndexForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
