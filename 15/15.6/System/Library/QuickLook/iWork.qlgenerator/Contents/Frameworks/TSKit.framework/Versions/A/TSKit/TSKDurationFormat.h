...
@property (readonly, nonatomic) char useAutomaticUnits;
...
- (id)asDurationFormat;
- (id)initWithUseAutomaticUnits:(char)a0 durationUnitSmallest:(unsigned char)a1 durationUnitLargest:(unsigned char)a2 durationStyle:(unsigned char)a3;
...
- (id)stringFromDurationTimeInterval:(double)a0 locale:(id)a1 showPrecision:(char)a2;
