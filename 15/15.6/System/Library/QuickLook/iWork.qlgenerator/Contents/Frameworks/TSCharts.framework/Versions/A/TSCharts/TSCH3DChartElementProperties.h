...
- (id)init;
- (void).cxx_destruct;
- (char)applyElementTransformToProcessor:(id)a0 series:(id)a1 index:(void *)a2 propertyAccessor:(id)a3;
...
- (char)applyCombinedTransform:(void *)a0 series:(id)a1 index:(void *)a2 propertyAccessor:(id)a3;
