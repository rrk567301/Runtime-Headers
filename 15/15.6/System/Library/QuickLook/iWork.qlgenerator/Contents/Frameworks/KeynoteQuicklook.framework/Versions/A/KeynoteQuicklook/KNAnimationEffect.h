...
@property (class, readonly, nonatomic) char isResponsibleForDrawingAllTextures;
@property (class, readonly, nonatomic) char isCARendererBased;
...
+ (id)updateDirectionAttributeValue:(long long)a0 andCustomTextDirectionValue:(unsigned long long)a1 turnOffBounce:(char)a2 turnOffMotionBlur:(char)a3 forAttributes:(id)a4;
