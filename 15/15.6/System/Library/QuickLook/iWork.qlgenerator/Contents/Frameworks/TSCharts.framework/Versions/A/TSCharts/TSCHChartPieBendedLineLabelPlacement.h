...
- (char)conflictBetweenWedgeLayoutInfo:(id)a0 nextWedgeLayoutInfo:(id)a1;
...
- (struct CGPoint { double x0; double x1; })firstHalfOfBendedLineVectorNormalizedWithWedgeLayoutInfo:(id)a0 shouldBeUpwards:(char)a1;
...
- (char)innermostWedgeLayoutInfoWillUsePerpendicularAngle:(id)a0;
...
- (double)shiftAmountForWedgeLayoutInfo:(id)a0 adjacentWedgeLayoutInfo:(id)a1 adjacentShouldBeAbove:(char)a2;
...
- (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })transformToShiftWedgeLayoutInfoAwayFromAdjacentWedgeLayoutInfo:(id)a0 adjacentWedgeLayoutInfo:(id)a1 adjacentShouldBeAbove:(char)a2 totalHeightOverlap:(double)a3;
- (id)updateLabelTransformsToPreventOverlap;
- (char)wedgeLayoutInfoShouldShiftForCleanUp:(id)a0 withCleanUpOption:(unsigned long long)a1;
- (char)wedgeLayoutInfoShouldShiftToPreventBendPointOnCircumference:(id)a0;
- (char)wedgeLayoutInfoShouldShiftToPreventTooShortCalloutLineFirstHalf:(id)a0;
- (char)wedgeLayoutInfoShouldUsePerpendicularAngle:(id)a0 defaultMidpoint:(struct CGPoint { double x0; double x1; })a1;
