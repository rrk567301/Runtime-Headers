...
- (void)p_drawInContext:(struct CGContext { } *)a0 withContent:(char)a1 strokeDrawOptions:(unsigned long long)a2 withOpacity:(double)a3 withMask:(char)a4 withIAMask:(char)a5 forLayer:(char)a6 forShadow:(char)a7 forHitTest:(char)a8;
- (char)p_shouldUseSourceImageForDescription:(id)a0 clipBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 image:(struct CGImage { } *)a3;
