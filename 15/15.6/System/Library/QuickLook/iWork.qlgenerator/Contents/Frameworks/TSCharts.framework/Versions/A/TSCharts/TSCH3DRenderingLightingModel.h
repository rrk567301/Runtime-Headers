...
+ (id)p_lightingModelFromFill:(id)a0 lightings:(id)a1 returningTransparency:(char *)a2;
+ (id)renderingLightingModelWithFill:(id)a0 lightings:(id)a1;
+ (id)renderingLightingModelWithLightingModel:(id)a0 percentage:(id)a1 hasTransparency:(char)a2;

- (void).cxx_destruct;
- (void)affect:(id)a0 states:(id)a1 scene:(id)a2 texturePool:(id)a3;
- (id)initWithLightingModel:(id)a0 percentage:(id)a1 hasTransparency:(char)a2;
