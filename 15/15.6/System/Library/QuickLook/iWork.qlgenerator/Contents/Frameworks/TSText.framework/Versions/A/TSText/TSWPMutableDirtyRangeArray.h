...
- (void)addChangedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 delta:(long long)a1 allowEmpty:(char)a2;
- (void)addRange:(struct { struct _NSRange { unsigned long long x0; unsigned long long x1; } x0; long long x1; })a0 allowEmpty:(char)a1;
