...
- (void)p_renderLabels:(id)a0 labelType:(int)a1 part:(id)a2 positioner:(id)a3 offset:(void *)a4 offset2DBlock:(id /* block */)a5 strideBlock:(id /* block */)a6 skipFirst:(char)a7 showLast:(char)a8;
