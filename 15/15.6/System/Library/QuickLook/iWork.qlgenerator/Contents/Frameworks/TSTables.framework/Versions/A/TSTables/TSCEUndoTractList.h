...
- (void)addToExcludedTractUids:(const void *)a0 isRows:(char)a1;
...
- (void)addToIncludedUidsTractColumnUids:(const void *)a0 rowUids:(const void *)a1 isRangeRef:(char)a2 preserveRectangularRange:(char)a3;
