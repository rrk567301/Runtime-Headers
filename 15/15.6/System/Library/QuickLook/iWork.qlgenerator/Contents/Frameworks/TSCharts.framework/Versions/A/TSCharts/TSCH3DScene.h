...
- (id)enumeratorMap;
- (id)extractObjects:(char)a0 ofClasses:(id)a1;
...
- (id)removeObjects:(char)a0 ofClasses:(id)a1 addTo:(id)a2;
- (id)removeObjects:(char)a0 ofClasses:(id)a1 into:(id)a2;
- (void)removeObjectsNotOfClass:(Class)a0;
- (void)resetDelegates;
- (id)returnRemoved:(char)a0 removeObjectsPassingTest:(id /* block */)a1;
