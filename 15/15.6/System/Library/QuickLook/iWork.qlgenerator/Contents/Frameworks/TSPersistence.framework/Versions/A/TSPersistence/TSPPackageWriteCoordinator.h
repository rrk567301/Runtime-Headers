...
@interface TSPPackageWriteCoordinator : NSObject <TSPArchiverManagerDelegate, TSPComponentWriterDelegate, TSPDataArchiver, TSPDataReferenceMapPersistedObjectProvider, TSPExternalReferenceDelegate, TSPPersistedObjectUUIDMapDelegate, TSPObjectModifyDelegate> {
    _Atomic char _didWriteObjectContainer;
    ...
    _Atomic char _writeSuccess;
    _Atomic char _didAttemptRecoveryByDirtyingAllComponents;
    _Atomic char _isRecoverableError;
    _Atomic char _isCancelled;
    _Atomic char _didWriteRootObject;
    _Atomic char _didWriteMetadata;
    ...
    struct IdentifierMap<bool> { struct __hash_table<std::__hash_value_type<const long long, bool>, std::__unordered_map_hasher<const long long, std::__hash_value_type<const long long, bool>, std::hash<long long>, std::equal_to<const long long>>, std::__unordered_map_equal<const long long, std::__hash_value_type<const long long, bool>, std::equal_to<const long long>, std::hash<long long>>, std::allocator<std::__hash_value_type<const long long, bool>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> *>>> { struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> *>>> { void **__value_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> *>> { struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> *>> { unsigned long long __value_; } __data_; } __value_; } __ptr_; } __bucket_list_; struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<const long long, bool>, void *>>> { struct __hash_node_base<std::__hash_node<std::__hash_value_type<const long long, bool>, void *> *> { void *__next_; } __value_; } __p1_; struct __compressed_pair<unsigned long, std::__unordered_map_hasher<const long long, std::__hash_value_type<const long long, bool>, std::hash<long long>, std::equal_to<const long long>>> { unsigned long long __value_; } __p2_; struct __compressed_pair<float, std::__unordered_map_equal<const long long, std::__hash_value_type<const long long, bool>, std::equal_to<const long long>, std::hash<long long>>> { float __value_; } __p3_; } __table_; } _validatedExternalReferences;
}
...
- (char)didWriteComponentWithIdentifier:(long long)a0 wasCopied:(char *)a1 componentReadVersion:(unsigned long long *)a2;
- (void)addDataFinalizeHandlerForSuccessfulSave:(id /* block */)a0;
- (void)addDelayedObject:(id)a0 forComponentRootObject:(id)a1 claimingComponent:(id)a2 isDelayedObjectReferencedByObjectContainer:(char)a3 completion:(id /* block */)a4;
...
- (void)archiveComponent:(id)a0 locator:(id)a1 compressionAlgorithm:(long long)a2 storeOutsideObjectArchive:(char)a3 rootObject:(id)a4 withPackageWriter:(id)a5;
...
- (char)componentWriter:(id)a0 object:(id)a1 belongsToCopiedComponent:(id)a2;
...
- (char)didWriteData:(id)a0;
- (char)didWriteObject:(id)a0 claimingComponent:(id *)a1 componentReadVersion:(unsigned long long *)a2;
- (char)didWriteObjectWithIdentifier:(long long)a0;
- (char)enqueueComponent:(id)a0 rootObjectOrNil:(id)a1 forceArchive:(char)a2 isWastefullyEnqueueing:(char)a3 isWeakReference:(char)a4 referencingComponent:(id)a5 referencedObject:(id)a6 hasArchiverAccessLock:(char)a7;
- (void)enqueueReferencedObject:(id)a0 referencingComponent:(id)a1 isWeakReference:(char)a2 forWastefullyEnqueuedComponent:(id)a3 componentRootObject:(id)a4 componentInfo:(struct WrittenComponentInfo { id x0; id x1; char x2; char x3; id x4; char x5; char x6; char x7; id x8; id x9; char x10; unsigned char x11; long long x12; unsigned long long x13; unsigned long long x14; unsigned long long x15; unsigned long long x16; char x17; id x18; id x19; id x20; id x21; id x22; id x23; id x24; id x25; } *)a5 hasArchiverAccessLock:(char)a6;
- (void)enqueueRootObject:(id)a0 forceArchive:(char)a1 isAddingDelayedObjectReferencedByObjectContainer:(char)a2 completion:(id /* block */)a3;
- (void)enqueueRootObjectImpl:(id)a0 forceArchive:(char)a1 isAddingDelayedObjectReferencedByObjectContainer:(char)a2 completion:(id /* block */)a3;
- (void)enumerateWrittenObjectsWithBlock:(id /* block */)a0;
- (id)explicitComponentRootObjectForObject:(id)a0;
- (id)explicitComponentRootObjectForObject:(id)a0 archiverOrNil:(id)a1 claimingComponent:(id)a2 newClaimingComponent:(id)a3 newClaimingRootObject:(id)a4 willEnqueueDelayedObject:(char)a5 hasArchiverAccessLock:(char)a6;
...
- (char)shouldArchiveComponent:(id)a0 checkForceArchive:(char)a1;
- (char)shouldCopyComponentOfObject:(id)a0;
- (char)shouldEnqueueComponent:(id)a0;
- (void)stopCapturingSnapshots;
- (long long)updateDelayedObjectsSetForWrittenComponentInfo:(struct WrittenComponentInfo { id x0; id x1; char x2; char x3; id x4; char x5; char x6; char x7; id x8; id x9; char x10; unsigned char x11; long long x12; unsigned long long x13; unsigned long long x14; unsigned long long x15; unsigned long long x16; char x17; id x18; id x19; id x20; id x21; id x22; id x23; id x24; id x25; } *)a0 componentIdentifier:(long long)a1 withObject:(id)a2 canDelayObjects:(char)a3;
...
- (char)wasObjectPersistedWithIdentifier:(long long)a0;
- (void)willModifyObject:(id)a0 options:(unsigned long long)a1;
- (void)writeComponent:(id)a0 rootObjectOrNil:(id)a1 forceArchive:(char)a2 withPackageWriter:(id)a3;
