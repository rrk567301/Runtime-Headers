...
@property (nonatomic) char needsFormulaReset;
...
- (void)registerAllFormulasWithCalculationEngine:(id)a0 wasCrossDocumentPaste:(char)a1;
...
- (char)cellExistsAtCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (unsigned char)cellValueTypeAtSummaryModelCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)defaultCellStyleForCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)defaultTextStyleForCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (id)explicitFormatOfKind:(unsigned char)a0 atModelCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 currencyIsMostRecentlySet:(char *)a2;
- (id)formulaAtCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (int)getCell:(id)a0 atCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
- (int)getValue:(id *)a0 atCellID:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 fetchRichTextAttributesIfPlainText:(char)a2;
- (char)hasFormulaAtCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (unsigned char)p_ColumnCategoryLevelForCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (unsigned char)p_RowCategoryLevelForCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isLabel:(char *)a1;
...
- (unsigned long long)p_tableStyleAreaForCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (void)removeCategoryColumnCellsForRows:(void *)a0;
- (void)removeColumnsAtSummaryIndexes:(id)a0;
- (void)resetForCategories;
- (void)resetForCategoriesWithForce:(char)a0;
