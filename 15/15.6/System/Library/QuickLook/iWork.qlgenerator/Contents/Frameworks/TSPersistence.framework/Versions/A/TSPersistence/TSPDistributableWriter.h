...
- (void).cxx_destruct;
- (void)cancel;
- (id)_initWithDatabase:(id)a0 fileManager:(id)a1 outputStream:(id)a2 checkCrc:(unsigned int)a3 includeToc:(char)a4;
- (char)_processEntry:(id)a0 tocEntries:(id)a1 progressContext:(id)a2 error:(id *)a3;
- (char)goAndReportProgress:(char)a0 error:(id *)a1 context:(id)a2;
