...
- (id)debugBounds;
- (id)initWithScene:(id)a0 containingViewport:(void *)a1 originalContainingViewport:(void *)a2 layoutSettings:(const struct { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; long long x8; unsigned long long x9; } *)a3;
