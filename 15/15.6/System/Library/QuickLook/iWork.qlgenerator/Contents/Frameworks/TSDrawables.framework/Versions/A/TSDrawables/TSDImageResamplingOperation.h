...
- (id)p_destinationTypeForOriginalFileType:(id)a0 sourceHasAlpha:(char)a1 prioritizeHighEfficiencyFormat:(char)a2;
...
- (id)p_performResampleOperationWithResampleOptions:(unsigned long long)a0 bitmapContextOptions:(unsigned long long)a1 prioritizeHighEfficiencyFormat:(char)a2;
