...
@property (readonly, nonatomic) struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } formulaCoord;
...
- (void)addChild:(id)a0 skipWillModify:(char)a1;
...
- (id)initWithFormulaCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 groupNode:(id)a1 aggregator:(id)a2;
- (void)removeChild:(id)a0 skipWillModify:(char)a1;
