...
@property (readonly, nonatomic) char allowUnknownObject;
...
@property (nonatomic) char keepObjectInMemory;
@property (readonly, nonatomic) long long tsp_identifier;
@property (readonly, nonatomic) char tsp_isLazyReference;
...
+ (id)weakReferenceForObject:(id)a0 retainedUntilArchived:(char)a1;
...
- (char)isEqualToLazyReference:(id)a0;
- (char)referencesObject:(id)a0;
- (void)retainObject:(id)a0;
- (void)addLoadObserver:(id)a0 action:(SEL)a1;
- (id)initWeakReferenceWithObject:(id)a0;
- (id)initWeakReferenceWithObject:(id)a0 retainedUntilArchived:(char)a1;
- (id)initWithDelegate:(id)a0 identifier:(long long)a1 ownershipMode:(long long)a2 allowUnknownObject:(char)a3 objectClass:(Class)a4 objectProtocol:(id)a5;
- (id)initWithObject:(id)a0 ownershipMode:(long long)a1;
- (long long)releaseObjectIfPossible;
- (void)resetIdentifierFromCopy:(char)a0;
- (void)resetToIdentifier:(long long)a0;
- (char)validateObject:(id)a0 expectedObjectClass:(Class)a1 expectedObjectProtocol:(id)a2 delegate:(id)a3 shouldIgnoreFailure:(char *)a4 shouldUpdateObjectClass:(char *)a5 error:(id *)a6;
