...
+ (char)hasSwapTuplesRequiringConversion:(id)a0;
...
- (char)canApplyTupleToStyleSwapSupporting:(id)a0;
...
- (char)isSwappingSameStyleObject:(id)a0;
- (char)isSwappingSameStyleValues:(id)a0;
