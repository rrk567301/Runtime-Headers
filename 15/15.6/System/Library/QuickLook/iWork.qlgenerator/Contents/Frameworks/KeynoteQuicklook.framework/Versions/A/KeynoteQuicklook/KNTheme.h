...
@property (readonly, nonatomic) char defaultTemplateSlideNodeIsOurBestGuess;
...
- (char)customTimingCurvesContainsName:(id)a0;
...
- (char)containsTemplateSlideWithName:(id)a0;
