...
@property (readonly, nonatomic) char paragraphStyleIndexesAreValid;
...
- (id)applyStyleSwapTuple:(id)a0 ignoringBeforeValues:(char)a1;
...
- (id)listOfStyles;
- (char)otherStateIsEquivalent:(id)a0 ignoringSeriesThemeStyles:(char)a1;
- (void)p_addParagraphStyleForSemanticUsage:(id)a0 mappedStyle:(id)a1 mappedState:(id)a2 fromPriorStyle:(id)a3 andPriorState:(id)a4 maintainPriorIndex:(char)a5 withStyleMapper:(id)a6 withStylesheet:(id)a7 toNewParagraphStylesTable:(id)a8 andStyleMap:(id)a9;
