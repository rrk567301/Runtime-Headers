...
+ (struct TSUDecimal { struct { unsigned long long x0[2]; } x0; })getFixedPaymentWithRate:(id)a0 rate:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a1 nper:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a2 pv:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a3 fv:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a4 dueBeginning:(char)a5 outError:(id *)a6;
+ (struct TSUDecimal { struct { unsigned long long x0[2]; } x0; })getInterestPortionOfPaymentWithRate:(id)a0 rate:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a1 per:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a2 nper:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a3 pv:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a4 fv:(const struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a5 dueBeginning:(char)a6 outError:(id *)a7;
