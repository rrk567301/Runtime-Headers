...
@property (readonly, nonatomic) char isCompositeRenderer;
...
- (void)drawErrorBarsInContext:(struct CGContext { } *)a0 chartVertical:(char)a1 elementRenderClass:(Class)a2;
- (void)drawTrendLinesInContext:(struct CGContext { } *)a0 chartVertical:(char)a1 elementRenderClass:(Class)a2;
