...
- (id)customEffectTimingCurveDisplayParametersForAttributes:(id)a0 layoutStyleOnly:(char)a1;
- (id)initWithAnimationClass:(Class)a0;
- (id)localizedNameForType:(long long)a0;
- (char)supportsAnimationType:(long long)a0;
- (char)supportsCustomAttributeKey:(id)a0;
