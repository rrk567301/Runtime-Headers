...
@property (readonly, nonatomic) char pathIsLineSegment;
...
@property (readonly, nonatomic) char isTailEndOnLeft;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_boundsOfLineEndForHead:(char)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
- (id)p_cachedPath;
...
- (id)p_unitePath:(id)a0 withLineEndForHead:(char)a1 stroke:(id)a2;
