...
- (id)initForInsertingRowsOrColumnsIntoTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 rowColumnUuids:(const void *)a1 areRows:(char)a2;
- (id)initForMergeCellsWithTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 columnUids:(const void *)a1 rowUids:(const void *)a2 mergeSource:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a3;
...
- (id)initForMovingRowsOrColumnsInTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 rowColumnUuids:(const void *)a1 shuffleMap:(id)a2 areRows:(char)a3 srcTract:(const void *)a4 destTract:(const void *)a5;
...
- (id)initForRemoveRowsOrColumnsFromTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 rowColumnUuids:(const void *)a1 areRows:(char)a2;
...
- (id)initForUndoMergeCellsWithTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 columnUids:(const void *)a1 rowUids:(const void *)a2 mergeSource:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a3;
...
- (id)initWithTransposeTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 transposedBodyRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })a1 numberOfFooterRows:(unsigned int)a2;
