...
+ (char)improvesContrastWhenColor:(id)a0 displayedOverBackgroundColor:(id)a1 comparedToColor:(id)a2 displayedOverBackgroundColor:(id)a3 inScenario:(unsigned long long)a4;
...
- (char)p_isEqualToColor:(id)a0 withTolerance:(double)a1;
...
- (char)isAlmostEqualToColor:(id)a0;
- (char)isEqualWithTolerance:(id)a0;
...
- (char)improvesContrastWhenDisplayedOverAlternateBackgroundColor:(id)a0 ratherThanStandardBackgroundColor:(id)a1 inScenario:(unsigned long long)a2;
