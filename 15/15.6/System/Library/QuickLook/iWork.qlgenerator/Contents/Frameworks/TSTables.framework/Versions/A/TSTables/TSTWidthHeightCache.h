...
@property (nonatomic) char needsToBeArchived;
...
- (void)resetModelCacheRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (void)setFitHeight:(double)a0 forCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
- (char)p_insertColumns:(unsigned int)a0 atColumn:(unsigned short)a1;
- (char)p_insertRows:(unsigned int)a0 atRow:(unsigned int)a1;
- (void)p_moveColumnsFrom:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 toColumn:(unsigned short)a1;
- (void)p_moveRowsFrom:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 toRow:(unsigned int)a1;
- (void)p_moveRowsUsingShuffleMapping:(id)a0;
- (id)p_resetFittingHeightsForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
