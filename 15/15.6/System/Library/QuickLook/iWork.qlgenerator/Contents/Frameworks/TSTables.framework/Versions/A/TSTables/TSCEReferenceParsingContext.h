...
@property (nonatomic) char filterColons;
@property (nonatomic) char referenceIsComplete;
@property (retain, nonatomic) TSCEAbortObject *abortObject;
@property (nonatomic) char parseAsBaseTableReference;
@property (nonatomic) char trimNames;
@property (nonatomic) char namesUsed;
