...
- (char)shouldRemovePastedFillStyleProperties;
- (char)shouldRemovePastedFrameStrokeStyleProperties;
- (char)shouldRemovePastedLineEndStyleProperties;
- (char)shouldValidatePastedLineEndStyleProperties;
