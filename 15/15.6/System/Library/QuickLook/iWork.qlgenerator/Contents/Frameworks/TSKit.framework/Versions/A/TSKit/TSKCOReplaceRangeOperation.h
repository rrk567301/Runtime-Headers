...
- (id)initWithAddress:(const void *)a0 rangeVector:(const void *)a1 insertLength:(unsigned long long)a2 noop:(char)a3;
- (id)initWithAddress:(const void *)a0 rangeVector:(const void *)a1 insertLength:(unsigned long long)a2 preserveLowerPriorityLocation:(char)a3 noop:(char)a4;
