...
+ (id)localizedStringForDirection:(unsigned long long)a0 shortVersion:(char)a1;
...
- (void)addDirection:(unsigned long long)a0 useShortString:(char)a1;
- (char)containsDirection:(unsigned long long)a0;
