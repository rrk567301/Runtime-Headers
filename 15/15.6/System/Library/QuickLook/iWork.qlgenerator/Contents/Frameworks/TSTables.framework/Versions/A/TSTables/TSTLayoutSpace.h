@class TSTLayoutSpaceBezierPathCache, TSTLayoutSpaceBundle, TSTLayoutEngine, TSTCoordinateArray, TSTLayout;
...
@property (nonatomic) char invalidatedForEditingCell;
@property (nonatomic) char invalidTableOffset;
@property (nonatomic) unsigned short invalidColumnIndex;
@property (nonatomic) unsigned int invalidRowIndex;
@property (nonatomic) char layoutDirectionIsLeftToRight;
...
@property (readonly, nonatomic) char frameHasWidthAndHeight;
...
- (void)unlock;
- (int)validate:(id)a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })visibleRange;
- (void)lockForRead;
- (void)lockForWrite;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frameForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })alignedStrokeFrameForCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (id)alignedStrokeFramePathForGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a1 inset:(double)a2 reoriginToZero:(char)a3 cornerRadius:(double)a4;
...
- (id)alignedStrokeLinePathForColumnGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a1 inset:(double)a2 reoriginToZero:(char)a3 cornerRadius:(double)a4;
- (id)alignedStrokeLinePathForRowGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a1 inset:(double)a2 reoriginToZero:(char)a3 cornerRadius:(double)a4;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })canvasFrameForCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (char)containsGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })contentFrameForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (void)drawStrokesInGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 clearStrokes:(char)a1 context:(struct CGContext { } *)a2;
...
- (struct { unsigned int x0; unsigned int x1; })gridPointHitByCanvasPoint:(struct CGPoint { double x0; double x1; })a0 tabsViewable:(char)a1;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })intersectionCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)intersectsColumnGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)intersectsGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)intersectsRowGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })nearestRangeForLayoutRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (id)p_createColumnCoordinatesForGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 invalidColumnIndex:(unsigned short)a1 previousCoordinates:(id)a2 outCoordinatesChanged:(char *)a3;
- (id)p_createRowCoordinatesForGridRange:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0 invalidRowIndex:(unsigned int)a1 previousCoordinates:(id)a2 validateSingleRow:(char)a3 outCoordinatesChanged:(char *)a4;
- (char)p_drawStrokeForGridColumn:(unsigned int)a0 strokeRect:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a1 clearStroke:(char)a2 shadowType:(int)a3 context:(struct CGContext { } *)a4;
- (char)p_drawStrokeForGridRow:(unsigned int)a0 strokeRect:(struct { struct { unsigned int x0; unsigned int x1; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a1 clearStroke:(char)a2 shadowType:(int)a3 context:(struct CGContext { } *)a4;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })p_rangeForLayoutRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })rangeIntersectingLayoutRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })strokeFrameForRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (double)strokeWidthForDrawingWithAlignedWidth:(double)a0 originalWidth:(double)a1;
- (void)validateCoordinateDirection;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })visiblePartOfRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
