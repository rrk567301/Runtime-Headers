...
- (char)addUUID:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
- (void)addUUIDs:(const void *)a0;
- (void)addUuidsFromSet:(id)a0;
- (void)addUuidsFromVector:(const void *)a0;
- (void)removeAllUuids;
- (char)removeUUID:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
- (void)removeUUIDs:(const void *)a0;
- (char)removeUuidsFromSet:(id)a0;
