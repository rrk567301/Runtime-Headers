...
@property (nonatomic) char cachedPivotIndexSetsAreValid;
...
- (int)p_applyViewCellCoord:(struct TSUViewCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 toSummaryUsingBlock:(id /* block */)a1 toBaseUsingBlock:(id /* block */)a2;
