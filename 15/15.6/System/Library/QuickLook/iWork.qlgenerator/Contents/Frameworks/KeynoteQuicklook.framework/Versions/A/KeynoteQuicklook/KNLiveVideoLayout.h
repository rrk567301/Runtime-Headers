...
@interface KNLiveVideoLayout : TSDStyledLayout {
    ...
    char _isCachedAlignmentFrameValid;
}
...
@property (readonly, nonatomic) char shouldRenderFrameStroke;
@property (readonly, nonatomic) double scale;
@property (readonly, nonatomic) long long effectiveMaskKind;
@property (readonly, nonatomic) double maskCornerRadius;
@property (readonly, nonatomic) char isVideoMaskPathRectangular;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_computeAlignmentFrameInRoot:(char)a0;
