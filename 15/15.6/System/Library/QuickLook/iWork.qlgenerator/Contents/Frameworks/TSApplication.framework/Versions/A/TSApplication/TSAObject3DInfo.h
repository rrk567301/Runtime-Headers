...
@interface TSAObject3DInfo : TSDDrawableInfo <TSDDrawableInfoCustomUnarchivingSubclassProviding, TSDStyleOwning, TSSStyleClient, TSDMixing, TSDFileBasedInfo, TSDFittingOnInsertion> {
    ...
    char _playsAnimations;
    char _hasEmbeddedAnimations;
}
...
@property (nonatomic) char playsAnimations;
@property (nonatomic) char hasEmbeddedAnimations;
@property (retain, nonatomic) TSUBezierPath *tracedPath;
@property (nonatomic) float opacity;
@property (readonly, nonatomic) char isUSDZ;
@property (readonly, nonatomic) char readyForQuicklook;
@property (readonly, nonatomic) char readyToPlayAnimations;
@property (readonly, nonatomic) char canPlayEmbeddedAnimationsInSlideshow;
...
- (id)initWithContext:(id)a0 geometry:(id)a1 objectData:(id)a2 thumbnailImageData:(id)a3 embeddedAnimations:(char)a4 boundingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 tracedPath:(id)a6;
