...
@property (readonly, nonatomic) char isAxisAlignedUnflippedInRoot;
...
@property (readonly, nonatomic) char providesGuidesForChildLayouts;
@property (readonly, nonatomic) char exclusivelyProvidesGuidesForChildLayouts;
...
@property (readonly, nonatomic) char shouldBeIncludedInParentFrameForCulling;
...
@property (readonly, nonatomic) char shouldSnapWhileResizing;
...
@property (readonly, nonatomic) char shouldUseCaptionEdgeInsetsInInterimPosition;
@property (readonly, nonatomic) char isRootLayoutForInspectorGeometry;
@property (readonly, nonatomic) char isRootLevelForInlineGeometry;
@property (readonly, nonatomic) char supportsRotation;
@property (readonly, nonatomic) char supportsFlipping;
@property (readonly, nonatomic) char supportsCalloutAttributes;
...
- (void)addLayoutsInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toArray:(id)a1 deep:(char)a2;
...
- (void)p_fixTransformFromInterimPosition:(struct CGPoint { double x0; double x1; })a0 interimPositionXSet:(char)a1 interimPositionYSet:(char)a2;
