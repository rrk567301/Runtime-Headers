...
- (id)populatedSliceByIndex:(unsigned long long)a0 byRow:(char)a1;
...
- (id)allWarnings;
- (id)asMatrixWithAccessContext:(struct TSCEGridAccessContext { id x0; id x1; id x2; int x3; char x4; char x5; char x6; char x7; char x8; unsigned char x9; unsigned char x10; struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x11; } *)a0 outError:(id *)a1;
...
- (char)hasValueAtColumn:(unsigned int)a0 row:(unsigned int)a1;
- (char)hasValueAtCoord:(const struct TSCEGridCoord { unsigned int x0; unsigned int x1; } *)a0;
...
- (id)intersectionWithCellRect:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
