...
@property (readonly, nonatomic) char showInSuggestedBookmarksList;
@property (readonly, nonatomic) char allowAsBookmarkSuggestionStyle;
@property (nonatomic) char allowsMissingPropertiesWithNoParentStyleForUpgrade;
...
- (id)getTypesetterAttributes:(id)a0 scalePercent:(unsigned long long)a1 isRightToLeft:(char)a2;
- (id)initWithContext:(id)a0 name:(id)a1 overridePropertyMap:(id)a2 isVariation:(char)a3;
- (id)initialListStyle;
- (void)localizeForBidi:(char)a0;
...
- (char)p_contentTagIsBody;
- (id)p_coreTextCharacterStyle:(id)a0 allowLigatures:(char)a1 scalePercent:(unsigned long long)a2 shouldCache:(BOOL *)a3;
