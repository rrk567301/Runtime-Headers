...
- (id)getSpaceContainingCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (void)invalidateCoordinates;
- (void)invalidateTableOffsets;
- (int)validateLayoutSpaces;
- (char)enumerateFrozenLayoutSpacesUsingBlock:(id /* block */)a0;
- (void)enumerateLayoutSpacesUsingBlock:(id /* block */)a0;
- (char)enumerateRepeatLayoutSpacesUsingBlock:(id /* block */)a0;
- (void)invalidateCoordinatesAfterColumn:(unsigned short)a0;
- (void)invalidateCoordinatesAfterRow:(unsigned int)a0;
- (void)invalidateCoordinatesForEditingCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
