...
@property (readonly, nonatomic) char clientsMustRemap;
...
+ (id)mappedStyleWithMapper:(id)a0 forStyle:(id)a1 bakeComputable:(char)a2;
+ (id)mappedStylesWithMapper:(id)a0 forStyles:(id)a1 bakeComputable:(char)a2;
...
- (id)mappedStyleForStyle:(id)a0 bakeComputable:(char)a1;
