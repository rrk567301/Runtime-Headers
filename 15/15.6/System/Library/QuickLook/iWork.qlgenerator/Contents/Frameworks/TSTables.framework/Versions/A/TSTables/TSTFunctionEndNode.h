...
@property (weak, nonatomic) TSTFunctionNode *functionNode;
...
- (void)buildASTNodeArray:(struct TSCEASTNodeArray { } *)a0 hostCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 symbolTable:(void *)a2;
- (id)exportString;
