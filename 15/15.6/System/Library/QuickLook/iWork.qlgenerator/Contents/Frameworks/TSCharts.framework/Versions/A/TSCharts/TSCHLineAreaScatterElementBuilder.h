...
- (id)init;
- (void).cxx_destruct;
- (char)p_addBottomStroke:(struct { id x0; id x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; } *)a0 toPath:(struct CGPath { } *)a1 seriesIndex:(unsigned long long)a2 withPointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a3 withCount:(unsigned long long)a4;
- (struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)p_createPointArrayForSeries:(id)a0 inAreaFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 groupIndexSet:(id)a2 outCount:(unsigned long long *)a3;
- (unsigned long long)countOfElementsInSeries:(id)a0 forGroups:(id)a1 forBodyLayout:(id)a2 outNewElementBounds:(struct CGRect **)a3 outNewClipRects:(struct CGRect **)a4 outNewElementPaths:(const struct CGPath ***)a5 outSelectionKnobLocations:(id *)a6 forHighlightPath:(char)a7;
...
- (void)p_addCurvedTopStroke:(struct { id x0; id x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; } *)a0 toPath:(struct CGPath { } *)a1 withPointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a2 withCount:(unsigned long long)a3;
- (void)p_addKnobsForPoint:(struct CGPoint { double x0; double x1; })a0 strokedUnitSymbolRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 toKnobSet:(id)a2 symbolsShowing:(char)a3 includePoint:(char)a4;
- (void)p_addStraightTopStroke:(struct { id x0; id x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; } *)a0 toPath:(struct CGPath { } *)a1 withPointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a2 withCount:(unsigned long long)a3;
- (void)p_addTopStroke:(struct { id x0; id x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; } *)a0 toPath:(struct CGPath { } *)a1 withPointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a2 withCount:(unsigned long long)a3 lineType:(int)a4;
- (double)p_bubbleMaxForSeries:(id)a0 inChartBodyLayoutSize:(struct CGSize { double x0; double x1; })a1;
- (id)p_calculateSelectionKnobSet:(id)a0 bodyLayoutItem:(id)a1 series:(id)a2 pointsArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a3 withCount:(unsigned long long)a4;
- (struct { struct CGPoint { double x0; double x1; } x0; char x1; } *)p_centerPointsForSeries:(id)a0 groupIndexSet:(id)a1 nullsUseIntercept:(char)a2 plotAreaFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
...
- (struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)p_createPointArrayForSeries:(id)a0 inAreaFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 groupIndexSet:(id)a2 cullBadPoints:(char)a3 outCount:(unsigned long long *)a4;
- (void)p_cullLastValidPointIfEqualToFirstValidPointInArray:(struct { struct CGPoint { double x0; double x1; } x0; double x1; char x2; unsigned long long x3; } *)a0 pointsArrayCount:(unsigned long long *)a1;
- (long long)p_hitCheckPoint:(struct CGPoint { double x0; double x1; })a0 inSeries:(id)a1 withSeriesElementPath:(struct CGPath { } *)a2;
- (char)p_hitCheckPoint:(struct CGPoint { double x0; double x1; })a0 inSymbolsOfSeries:(id)a1 withBodyLayout:(id)a2;
...
- (struct CGPath { } *)p_newUnitPathForSymbol:(int)a0 symbolSize:(double)a1 stroke:(id)a2 forHitCheck:(char)a3;
...
- (char)p_shouldAddSelectionKnobWithPoint:(struct CGPoint { double x0; double x1; })a0 previousPoint:(struct CGPoint { double x0; double x1; })a1 minimumDistanceSquared:(double)a2 selectionKnobRadius:(double)a3;
- (id)p_symbolKnobLocationsForSeries:(id)a0 forGroups:(id)a1 inBodyLayout:(id)a2;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_symbolRectWithSymbolPoint:(struct CGPoint { double x0; double x1; })a0 symbolType:(int)a1 symbolSize:(double)a2 stroke:(id)a3;
- (char)p_topStrokeShouldBeClosed;
- (void)p_trendlineInfoForSeries:(id)a0 forBodyLayout:(id)a1 outVertical:(char *)a2 outOffsetInBody:(double *)a3;
- (id)p_uncachedUnitPathForSymbol:(int)a0 symbolSize:(double)a1 stroke:(id)a2 forHitCheck:(char)a3;
- (char)symbolTypeIsClosed:(int)a0;
