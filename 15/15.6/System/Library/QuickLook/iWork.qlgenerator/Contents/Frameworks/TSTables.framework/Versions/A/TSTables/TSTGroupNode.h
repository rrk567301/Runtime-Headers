...
@property (readonly, nonatomic) char hasUnfilteredRows;
...
@property (readonly, nonatomic) char isBlankNode;
@property (readonly, nonatomic) char isErrorNode;
...
+ (char)needFormulasForAggregateType:(unsigned char)a0;
...
- (char)containsAnyRowUidInRowUidSet:(id)a0;
- (void)encodeToArchive:(void *)a0 backwardCompatOptions:(unsigned long long)a1 archiver:(id)a2;
- (void)enumerateAllGroupsWithStop:(char *)a0 withBlock:(id /* block */)a1;
- (void)enumerateDirectChildren:(id /* block */)a0;
- (void)enumerateGroupsAtLevel:(unsigned char)a0 withStop:(char *)a1 withBlock:(id /* block */)a2;
- (void)enumerateGroupsBetweenLevel:(unsigned char)a0 andLevel:(unsigned char)a1 withBlock:(id /* block */)a2;
- (void)enumerateGroupsBetweenLevel:(unsigned char)a0 andLevel:(unsigned char)a1 withStop:(char *)a2 withBlock:(id /* block */)a3;
...
- (id)groupValueCellValueForGroupBySet:(id)a0 aggIndex:(unsigned short)a1 appendAggregateName:(char)a2;
- (id)groupValueHierarchyForChart:(char)a0;
- (id)groupValueHierarchyForChart:(char)a0 groupBySet:(id)a1 aggIndex:(unsigned short)a2 appendAggregateName:(char)a3;
...
- (void)p_addChildGroupUidsIntoSet:(id)a0 recursively:(char)a1 skipFiltered:(char)a2;
...
- (char)updateGroupCellValueIfKeyMatches:(id)a0;
