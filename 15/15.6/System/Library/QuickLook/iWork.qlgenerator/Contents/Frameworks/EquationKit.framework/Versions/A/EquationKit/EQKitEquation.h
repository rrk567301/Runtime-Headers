...
+ (id)equationSourceFromDataProvider:(struct CGDataProvider { } *)a0;
+ (id)equationSourceFromPDFData:(id)a0;
+ (char)isEquationInPDFData:(id)a0;

- (void)dealloc;
- (id)description;
- (id)init;
- (id)newLayout;
- (char)exportToXMLWriter:(struct _xmlTextWriter { } *)a0 ns:(const char *)a1 prefix:(const char *)a2 characterCount:(int *)a3;
- (id)initWithRoot:(id)a0 source:(id)a1;
- (char)isBaseFontNameUsed;
- (id)pdfDataWithLayout:(id)a0 layoutContext:(id)a1 sourceString:(id)a2 tightFit:(char)a3;
- (id)pdfDataWithLayoutContext:(id)a0 baselineOffset:(double *)a1 sourceString:(id)a2;
