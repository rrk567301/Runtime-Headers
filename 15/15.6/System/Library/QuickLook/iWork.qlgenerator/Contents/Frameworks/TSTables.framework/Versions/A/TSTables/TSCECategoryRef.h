...
@property (readonly, nonatomic) char mayReturnArray;
@property (readonly, nonatomic) char refersToPivotTable;
@property (readonly, nonatomic) char refersToPivotTableRows;
@property (readonly, nonatomic) char refersToPivotTableColumns;
@property (nonatomic) char showAggregateName;

+ (struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })groupByRootUid;
+ (char)isRelativeAncestorGroupUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
