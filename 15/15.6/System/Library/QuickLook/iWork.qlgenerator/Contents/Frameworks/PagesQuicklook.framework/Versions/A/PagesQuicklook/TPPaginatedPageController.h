...
@property (nonatomic) char allowParagraphMetrics;
@property (nonatomic) long long withPageLayoutRecursionCount;
@property (nonatomic) char isPaginating;
...
@property (readonly, nonatomic) char isPageLayoutRightToLeft;
...
- (id)anchoredDrawablesOnPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })anchoredRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
...
- (char)canProvideInfoForPageIndex:(unsigned long long)a0;
- (char)canProvideNumberingInfoForPageIndex:(unsigned long long)a0;
...
- (void)d_timePaginationResettingMetrics:(char)a0;
- (void)didLayoutChangingDirtyRanges;
- (id)displayPageNumberForCharIndex:(unsigned long long)a0 withSystemFormatting:(char)a1;
- (id)displayPageNumberForPageIndex:(unsigned long long)a0 withSystemFormatting:(char)a1;
...
- (id)i_pageIndexPathForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
- (void)i_rebuildCachedLayoutChildrenFromStartPage:(unsigned long long)a0 toEndPage:(unsigned long long)a1 setNeedsLayout:(char)a2;
...
- (char)isPaginationCompleteForSelection:(id)a0 inFlow:(id)a1;
- (char)isPaginationCompleteThroughPageIndex:(unsigned long long)a0;
- (char)isPaginationInProgress;
- (char)isSectionInfo:(id)a0 onPage:(unsigned long long)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_anchoredRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
- (unsigned long long)p_backupPageIndexForCharIndex:(unsigned long long)a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_bodyRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
- (id)p_cachedPageLayoutForPageIndex:(unsigned long long)a0 preferredLayoutController:(id)a1;
- (char)p_canAnchorDrawable:(id)a0 toPageLayout:(id)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_footnoteLayoutRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
- (void)p_forceRestartPaginationAndResetMetricsCache:(char)a0;
...
- (void)p_layOutIntoPageLayout:(id)a0 outDidSync:(out char *)a1;
- (void)p_layOutNextPageForLayoutController:(id)a0 dirtyRange:(id)a1;
- (char)p_layOutNextPageOnceWithOffscreenLayoutController;
- (void)p_layOutTextIntoPageLayout:(id)a0 didSync:(out char *)a1 initialFootnoteIndex:(out unsigned long long *)a2;
- (void)p_notifyObserversDidLayoutWhileSyncing:(char)a0;
- (id)p_pageHintForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
...
- (unsigned long long)p_pageIndexForAnchoredCharIndex:(unsigned long long)a0 forcePagination:(char)a1 searchAfterPaginationPoint:(char)a2;
- (unsigned long long)p_pageIndexForCharIndex:(unsigned long long)a0 includeEmptyPages:(char)a1 caretAffinity:(long long)a2 forcePagination:(char)a3 searchAfterPaginationPoint:(char)a4;
- (unsigned long long)p_pageIndexForFootnoteIndex:(unsigned long long)a0 forcePagination:(char)a1 searchAfterPaginationPoint:(char)a2;
- (id)p_pageIndicesForFlow:(id)a0 withSelection:(id)a1 forcePagination:(char)a2;
...
- (unsigned long long)p_pageNumberForContinuousSectionsAtPageIndex:(unsigned long long)a0 finalPage:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_pageRangeAffectedByInfo:(id)a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_pageRangeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forcePagination:(char)a1 includingEmptyPages:(char)a2 caretAffinity:(long long)a3 leadingCharIndex:(unsigned long long)a4 outEndIsValid:(char *)a5;
- (void)p_paginateThroughPageIndex:(unsigned long long)a0 forLayoutController:(id)a1 clearOffscreenInfos:(char)a2;
- (id)p_paginationState;
- (void)p_performPaginationResetAndMetricsReset:(char)a0;
...
- (id)p_sectionHintForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 allowAfterPaginationPoint:(char)a2;
...
- (char)pageAtIndexHasBody:(unsigned long long)a0;
- (char)pageBeginsWithPaginatedAttachment:(unsigned long long)a0;
- (unsigned long long)pageCountForPageIndex:(unsigned long long)a0;
- (char)pageEndsWithPaginatedAttachment:(unsigned long long)a0;
- (unsigned long long)pageHeightCountForPageViewState:(long long)a0;
- (unsigned long long)pageIndexForAnchoredAttachment:(id)a0 forcePagination:(char)a1;
...
- (unsigned long long)pageIndexForFootnoteIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (unsigned long long)pageIndexFromCanvasPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)pageIndexIsFirstPageOfSection:(unsigned long long)a0;
- (id)pageIndexesForSelection:(id)a0 forcePagination:(char)a1 outEndIsValid:(char *)a2;
- (id)pageIndicesForPartitionableAttachmentAtBodyCharIndex:(unsigned long long)a0 selectionPath:(id)a1 forcePagination:(char)a2;
- (long long)pageKindForPageIndex:(unsigned long long)a0;
...
- (struct CGPoint { double x0; double x1; })pageOriginForPageIndex:(unsigned long long)a0 allowAfterPaginationPoint:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })pageRangeForSelection:(id)a0 includingEmptyPages:(char)a1 outEndIsValid:(char *)a2;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })pageRectForPageIndex:(unsigned long long)a0 allowAfterPaginationPoint:(char)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })sectionBodyRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
...
- (unsigned long long)sectionPageIndexForPageIndex:(unsigned long long)a0 forcePagination:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })sectionPageRangeForPageIndex:(unsigned long long)a0 forcePagination:(char)a1 outEndIsValid:(char *)a2;
- (id)sectionTemplateDrawableProviderForPageIndex:(unsigned long long)a0;
- (char)shouldHeaderFooterBeVisibleForPageIndex:(unsigned long long)a0;
- (char)shouldUseFacingPagesForPageIndex:(unsigned long long)a0;
