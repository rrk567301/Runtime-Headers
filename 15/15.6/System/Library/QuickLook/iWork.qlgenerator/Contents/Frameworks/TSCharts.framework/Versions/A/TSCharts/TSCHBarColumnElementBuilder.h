...
- (id)initWithVertical:(char)a0;
- (struct CGPath { } *)newRoundedRectPathWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 chartInfo:(id)a1 series:(id)a2 groupIndex:(unsigned long long)a3 isVertical:(char)a4 forGroups:(id)a5 forBodyLayout:(id)a6;
...
- (double)p_beginValueForSeries:(id)a0 groupIndex:(unsigned long long)a1 unitSpaceIntercept:(double)a2 relativelyPositive:(char)a3 valueAxis:(id)a4;
