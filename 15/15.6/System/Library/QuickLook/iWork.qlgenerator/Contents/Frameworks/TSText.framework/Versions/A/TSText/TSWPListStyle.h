...
@property (class, readonly, nonatomic) TSSPropertySet *classicImportExportProperties;
@property (class, readonly, nonatomic) NSArray *textInspectorBulletStrings;
@property (class, readonly, nonatomic) NSArray *additionalBulletStrings;
@property (class, readonly, nonatomic) TSSPropertySet *stickyOverrideProperties;
@property (class, readonly, nonatomic) NSString *defaultLabelString;
@property (class, readonly, nonatomic) unsigned long long defaultLabelNumberType;
@property (class, readonly, nonatomic) char defaultTieredNumber;
@property (class, readonly, nonatomic) NSArray *defaultLabelGeometries;
@property (class, readonly, nonatomic) NSString *presetStyleDescriptor;
...
+ (unsigned long long)pLabelTypeForLevel:(unsigned long long)a0 forPropertyMapping:(id)a1 includeDegenerateLevels:(char)a2;
...
+ (char)deprecated_isDefaultMissingBulletImage:(id)a0;
...
- (char)wantsCustomResolveLogicForProperty:(int)a0 forStyles:(id)a1;
