...
@property (nonatomic) char textColorShouldBeBlack;

+ (void)clearCachesForDocumentRoot:(id)a0;
+ (struct TSCHTextLayoutResults { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; double x1; char x2; })initializeTextLayoutResults;
+ (id)sharedInteriorWrappingText;
+ (id)sharedText;
+ (char)shouldLayoutTextForWrapWidth:(double)a0 textLayoutProperties:(id)a1;
...
- (void)drawAttributedString:(struct __CFAttributedString { } *)a0 paragraphStyle:(id)a1 styleProvidingSource:(id)a2 intoContext:(struct CGContext { } *)a3 atPosition:(struct CGPoint { double x0; double x1; })a4 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5 viewScale:(double)a6;
...
- (struct CGSize { double x0; double x1; })measureAttributedString:(struct __CFAttributedString { } *)a0 paragraphStyle:(id)a1 styleProvidingSource:(id)a2 outErasableFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3;
...
- (struct CGSize { double x0; double x1; })measureText:(id)a0 paragraphStyle:(id)a1 wrapWidth:(double)a2 checkNumberTemplates:(char)a3 layoutProperties:(id)a4 styleProvidingSource:(id)a5 outErasableFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a6 outTextLayoutResults:(struct TSCHTextLayoutResults { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; double x1; char x2; } *)a7;
...
- (struct CGSize { double x0; double x1; })measureText:(id)a0 paragraphStyle:(id)a1 wrapWidth:(double)a2 outErasableFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3 checkNumberTemplates:(char)a4;
- (struct CGSize { double x0; double x1; })measureText:(id)a0 paragraphStyle:(id)a1 wrapWidth:(double)a2 outErasableFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3 layoutProperties:(id)a4 outTextLayoutResults:(struct TSCHTextLayoutResults { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; double x1; char x2; } *)a5;
...
- (char)p_styleSupportsEqualDigits:(id)a0 textCache:(id)a1;
- (id)p_textCacheForParagraphStyle:(id)a0 styleProvidingSource:(id)a1;
- (id)p_wpColumnForText:(id)a0 paragraphStyle:(id)a1 textBlack:(char)a2 wrapWidth:(double)a3 styleProvidingSource:(id)a4 textCache:(id)a5 layoutProperties:(id)a6;
- (id)p_wpStorageForAttributedString:(struct __CFAttributedString { } *)a0 paragraphStyle:(id)a1;
- (id)p_wpTextForParagraphStyle:(id)a0 text:(id)a1 textBlack:(char)a2 styleProvidingSource:(id)a3 cacheKey:(id)a4 textCache:(id)a5;
- (struct __CTFont { } *)retainedCTFontForParagraphStyle:(id)a0;
- (struct TSCHTextLayoutResults { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; double x1; char x2; })textLayoutResultsForColumn:(id)a0;
