...
@property (readonly, nonatomic) char equalWidth;
...
- (id)initWithColumnCount:(unsigned long long)a0 equalWidth:(char)a1 widthArray:(const double *)a2 gapArray:(const double *)a3;
...
- (void)setEqualWidth:(char)a0;
- (void)saveToArchive:(void *)a0 archiver:(id)a1;
- (id)p_description;
- (id)copyWithColumnCount:(unsigned long long)a0;
- (id)copyWithEqualWidth:(char)a0;
...
- (double)fractionalGapWidthForColumnIndex:(unsigned long long)a0;
- (double)fractionalWidthForColumnIndex:(unsigned long long)a0;
- (id)initWithColumnCount:(unsigned long long)a0 equalWidth:(char)a1 widthArray:(const double *)a2 gapArray:(const double *)a3 assert:(char)a4;
- (id)initWithEqualColumnCount:(unsigned long long)a0 gapFraction:(double)a1 assert:(char)a2;
