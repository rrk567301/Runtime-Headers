...
@property (nonatomic) char doesNotNeedFormulaRewriteForImport;
...
- (id)copyByRewritingToGeometricFormWithTableInfo:(id)a0 containsBadRef:(char *)a1;
...
- (char)isUniquesOrDuplicates;
- (char)matchesCell:(id)a0;
- (char)matchesRow:(unsigned int)a0 withFormulaTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 withCalculationEngine:(id)a2;
