...
@property (readonly, nonatomic) char canBeMasked;
...
@property (readonly, nonatomic) char canAdjustImage;
...
@property (nonatomic) char shouldTracePDFData;
@property (nonatomic) char backgroundRemoved;
...
@property (readonly, nonatomic) char canBeDividedIntoCompoundShape;
