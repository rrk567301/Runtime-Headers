...
- (id)copyWithContext:(id)a0 shallowCopyStyles:(char)a1;
...
- (char)isEquivalentToPreset:(id)a0 outReasons:(id *)a1;
- (id)migratedPresetInTheme:(id)a0 followReplacements:(char)a1;
