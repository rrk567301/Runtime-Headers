...
@property (nonatomic) char shouldPreCache;
...
- (void)p_processSlideNode:(id)a0 isHighPriority:(char)a1;
...
- (id)p_slideNodesToCacheAroundCurrentSlideNode:(id)a0 shouldIncludeExtraSlideAtEnd:(char)a1;
