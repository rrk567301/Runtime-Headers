...
+ (double)columnLayoutWidthForBodyWidth:(double)a0 insets:(inout struct NSEdgeInsets { double x0; double x1; double x2; double x3; } *)a1;
...
- (void)drawColumn:(id)a0 inContext:(struct CGContext { } *)a1 isFlipped:(char)a2 viewScale:(double)a3;
- (void)drawColumn:(id)a0 selection:(id)a1 inContext:(struct CGContext { } *)a2 isFlipped:(char)a3 viewScale:(double)a4;
...
- (void)drawColumn:(id)a0 selection:(id)a1 inContext:(struct CGContext { } *)a2 isFlipped:(char)a3 viewScale:(double)a4 renderMode:(unsigned long long)a5;
- (void)drawText:(id)a0 inContext:(struct CGContext { } *)a1 minSize:(struct CGSize { double x0; double x1; })a2 maxSize:(struct CGSize { double x0; double x1; })a3 anchor:(struct CGPoint { double x0; double x1; })a4 flags:(int)a5 isFlipped:(char)a6 viewScale:(double)a7;
