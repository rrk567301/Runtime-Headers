...
@property (nonatomic) char mapDestTrailingCharacterProperties;
...
- (void)mapCharacterPropertiesFromParagraph:(unsigned long long)a0 toRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 useParagraphProperties:(char)a2 ioTransaction:(void *)a3;
- (void)setupFlagsForPastingSrcStorage:(id)a0 intoDestStorage:(id)a1 atDestRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 srcStylesAmbiguous:(char)a3;
- (void)willPasteStorage:(id)a0 intoDestStorage:(id)a1 atDestRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 srcStylesAmbiguous:(char)a3;
