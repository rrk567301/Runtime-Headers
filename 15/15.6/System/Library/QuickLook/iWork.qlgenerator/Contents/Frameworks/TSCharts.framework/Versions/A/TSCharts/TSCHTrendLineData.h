...
- (void)p_addPathToTrendLinePathWithPoints:(struct { double x0; double x1; } *)a0 count:(unsigned long long)a1 curved:(char)a2 curveFitter:(id)a3;
- (void)p_calcBounds;
...
- (unsigned long long)p_fillArrayX:(double *)a0 andY:(double *)a1 fromPoints:(id)a2 hasNegativeX:(char *)a3;
...
- (void)p_releaseCache;
- (struct { double x0; double x1; })p_unitPoint:(struct { double x0; double x1; })a0 toScreenFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 offset:(double)a2 vertical:(char)a3;
- (void)p_updateTrendLineData;
- (char)showTrendLineForAxisID:(id)a0;
- (id)trendLinePathForChartRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 offsetInBody:(double)a1 vertical:(char)a2;
- (void)trendLineUnitSpacePoints:(struct **)a0 count:(unsigned long long *)a1 drawCurve:(char *)a2 maxPoints:(unsigned long long)a3;
