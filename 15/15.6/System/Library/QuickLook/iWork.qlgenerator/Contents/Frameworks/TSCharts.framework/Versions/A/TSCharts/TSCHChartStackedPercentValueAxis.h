...
- (char)supportsNegativeStyle;
- (char)supportsReferenceLines;
- (double)totalForGroupIndex:(unsigned long long)a0 series:(id)a1;
- (double)totalForValueIndex:(unsigned long long)a0;
- (double)unitSpaceValueForDataSpaceValue:(double)a0 series:(id)a1 groupIndex:(unsigned long long)a2 addValuesFromAllPreviousSeries:(char)a3;
