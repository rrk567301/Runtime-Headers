...
- (char)isIdentifierNode;
- (id)lastComponentWithWhitespaceAppended;
- (id)resolveIdentifier:(id)a0 hostTable:(id)a1 baseHostCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2 symbolTable:(void *)a3;
