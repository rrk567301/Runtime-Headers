...
@property (readonly, nonatomic) char shouldShowShadow;
@property (readonly, nonatomic) char shouldShowReflection;
@property (readonly, nonatomic) char isInvisible;
...
- (void)drawGradientWithAlphaOverReflection:(struct CGContext { } *)a0 applyingOpacity:(char)a1 reflectionSize:(struct CGSize { double x0; double x1; })a2;
...
- (void)drawReflectionInContext:(struct CGContext { } *)a0 drawChildren:(char)a1;
- (void)drawReflectionInContext:(struct CGContext { } *)a0 withTransparencyLayer:(char)a1 applyingOpacity:(char)a2 shouldClipGradient:(char)a3 withBlock:(id /* block */)a4;
- (void)drawReflectionIntoReflectionFrameInContext:(struct CGContext { } *)a0 withTransparencyLayer:(char)a1 applyingOpacity:(char)a2 drawChildren:(char)a3;
- (void)drawShadowInContext:(struct CGContext { } *)a0 withChildren:(char)a1 withDrawableOpacity:(char)a2;
- (struct CGImage { } *)newShadowImageWithSize:(struct CGSize { double x0; double x1; })a0 shadow:(id)a1 drawSelector:(SEL)a2 unflipped:(char)a3;
- (struct CGImage { } *)newShadowImageWithSize:(struct CGSize { double x0; double x1; })a0 unflipped:(char)a1 withChildren:(char)a2;
- (void)p_drawReflectionInContext:(struct CGContext { } *)a0;
- (void)p_drawReflectionIntoReflectionFrameInContext:(struct CGContext { } *)a0 withTransparencyLayer:(char)a1 applyingOpacity:(char)a2 shouldClipGradient:(char)a3 withBlock:(id /* block */)a4;
- (struct CGImage { } *)p_newReflectionImageWithSize:(struct CGSize { double x0; double x1; })a0 applyOpacity:(char)a1 viewScale:(double)a2 withBlock:(id /* block */)a3;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_clipRectInRootForTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 includeShadow:(char)a1 includeReflection:(char)a2;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_rectWithEffectsAppliedToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 additionalTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 includeShadow:(char)a2 includeReflection:(char)a3;
