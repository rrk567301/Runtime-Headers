...
@property (readonly) char isAutoUpdating;
...
@property (readonly) char uses24HourTimeCycle;
...
@property (readonly) char currencyUsesRightToLeftWritingDirection;
...
+ (id)displayNameForCode:(id)a0 ofType:(id)a1 displayStandalone:(char)a2;
+ (id)displayNameForCurrencyCode:(id)a0;
+ (id)localeIDWithDefaultRegionCode:(id)a0;
+ (id)localeIDWithoutDefaultRegionCode:(id)a0 avoidAmbiguousCases:(char)a1;
+ (char)localeIsAutoUpdating:(id)a0;
+ (void)saveLocaleForReuse:(id)a0;
+ (void)setLocalizedStringBundle:(struct __CFBundle { } *)a0;
+ (id)simplifiedDisplayNameForLocaleID:(id)a0 displayStandalone:(char)a1;
...
+ (char)isValidCurrencyCode:(id)a0;
...
- (id)currencySymbolForCurrencyCode:(id)a0;
- (id)displayLanguageNameWithStandalone:(char)a0;
- (id)displayNameForCurrencyCode:(id)a0;
...
- (char)localizedCaseInsensitiveIsEqual:(id)a0 toString:(id)a1;
- (long long)localizedCompare:(id)a0 toString:(id)a1;
- (id)numberFormatterStringFromDouble:(double)a0 withFormat:(id)a1 useDecimalPlaces:(char)a2 minDecimalPlaces:(unsigned short)a3 decimalPlaces:(unsigned short)a4 showThousandsSeparator:(char)a5 currencyCode:(id)a6 suppressMinusSign:(char)a7;
...
- (id)simplifiedDisplayNameWithStandalone:(char)a0;
...
- (char)isEqualViaFormattingAsDouble:(double)a0 :(double)a1;
- (char)isLanguageFormulasDirectionRightToLeft;
- (id)copyWithGregorianCalendar;
- (id)displayNameWithCurrencySymbolForCurrencyCode:(id)a0 standardizeWhitespace:(char)a1;
- (id)initWithLocale:(id)a0 documentLanguageIdentifier:(id)a1 formattingSymbols:(id)a2;
- (id)initWithLocale:(id)a0 documentLanguageIdentifier:(id)a1 useAutoupdating:(char)a2 formattingSymbols:(id)a3;
