...
+ (id)dataWithFillSetIdentifier:(id)a0 isLowRes:(char)a1;
+ (id)dataWithProperties:(id)a0 layersProperties:(id)a1 identifier:(id)a2 imageSource:(id)a3;
+ (id)dataWithProperties:(id)a0 layersProperties:(id)a1 identifier:(id)a2 imageSource:(id)a3 isLowRes:(char)a4;
...
- (struct ColorResult { char x0; struct Color { float x0; float x1; float x2; float x3; } x1; })colorFromRedKey:(id)a0 greenKey:(id)a1 blueKey:(id)a2;
...
- (id)initWithProperties:(id)a0 layersProperties:(id)a1 identifier:(id)a2 imageSource:(id)a3 isLowRes:(char)a4;
