...
+ (char)errorBarIsVerticalForAxisID:(id)a0 series:(id)a1;
+ (long long)errorBarTypeForAxisID:(id)a0 series:(id)a1;
+ (char)hasErrorBarsForSeries:(id)a0;
+ (long long)p_errorBarSettingForSeries:(id)a0 useXAxis:(char)a1 axisID:(id)a2;

- (void).cxx_destruct;
- (void)updateIfNeeded;
- (id)initWithSeries:(id)a0;
- (char)hasErrorDataForInputAxis:(id)a0 outputAxis:(id)a1 inputAxisContinuous:(char)a2 outputAxisContinuous:(char)a3 groupIndex:(unsigned long long)a4 groupsCount:(unsigned long long)a5 barVertical:(char)a6 barType:(long long)a7 outUnitValue:(struct CGPoint { double x0; double x1; } *)a8 outUnitPositive:(struct CGPoint { double x0; double x1; } *)a9 outUnitNegative:(struct CGPoint { double x0; double x1; } *)a10;
- (void)invalidateData;
...
- (double)p_customErrorForAxisID:(id)a0 valueIndex:(unsigned long long)a1 positive:(char)a2;
- (long long)p_errorBarSettingForAxisID:(id)a0 value:(double)a1 barType:(long long)a2;
- (long long)p_errorBarTypeForAxisID:(id)a0;
- (double)p_errorForValue:(double *)a0 onAxisID:(id)a1 valueIndex:(unsigned long long)a2 positive:(char)a3;
- (double)p_fixedErrorForAxisID:(id)a0;
- (struct CGPoint { double x0; double x1; })p_getValuePointForGroupIndex:(unsigned long long)a0 inputAxis:(id)a1 inputAxisContinuous:(char)a2 outputAxis:(id)a3 barVertical:(char)a4;
...
- (char)showErrorBarsForAxisID:(id)a0;
