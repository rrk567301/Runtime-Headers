...
+ (void)initialize;
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })transparencyInsetsForCGImage:(struct CGImage { } *)a0;
+ (id)p_drawingByAppendingStrokes:(id)a0 toDrawing:(id)a1;
+ (id)p_strokesForPencilKitDrawing:(id)a0;
+ (id)p_strokesForTSKStrokes:(id)a0;
...
- (id)drawingByAppendingStrokes:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
...
- (char)isLinePerpendicularToTextWithVerticalTextLayout:(char)a0;
- (char)isVerticalLine;
- (void)p_clearSubDrawingCache;
- (id)p_drawingByAddingSubStrokeFromStroke:(id)a0 fromStartIndex:(unsigned long long)a1 toEndIndex:(unsigned long long)a2 andAdjustStart:(char)a3 andAdjustEnd:(char)a4 toEdgesOfRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5;
