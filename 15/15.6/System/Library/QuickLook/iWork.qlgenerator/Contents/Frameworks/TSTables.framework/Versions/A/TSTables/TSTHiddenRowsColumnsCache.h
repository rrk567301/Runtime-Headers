...
- (void).cxx_destruct;
- (void)validate:(id)a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })visibleCellOffsetBy:(struct TSUColumnRowOffset { int x0; int x1; })a0 fromCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
- (unsigned int)numberOfVisibleRowsInCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (unsigned int)numberOfVisibleColumnsInCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
