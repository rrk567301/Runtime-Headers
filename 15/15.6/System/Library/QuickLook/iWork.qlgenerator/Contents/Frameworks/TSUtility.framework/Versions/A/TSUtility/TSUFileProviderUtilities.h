...
@property (class, readonly) char isPauseSyncSPIAvailable;
...
+ (char)pauseSyncSynchronouslyOnSandboxedURL:(id)a0 behavior:(unsigned long long)a1 error:(id *)a2;
+ (char)pauseSyncSynchronouslyOnSandboxedURL:(id)a0 behavior:(unsigned long long)a1 uuid:(id)a2 error:(id *)a3;
