...
- (id)deepCopy;
- (void)addPath:(id)a0 withBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 shouldSmooth:(char)a2 forKey:(id)a3;
