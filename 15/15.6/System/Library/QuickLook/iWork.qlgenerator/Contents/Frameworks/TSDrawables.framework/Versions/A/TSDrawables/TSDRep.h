...
@property (readonly, nonatomic) char isDrawingInFlippedContext;
...
@property (readonly, nonatomic) char masksToBounds;
...
@property (readonly, nonatomic) char wantsToDistortWithImagerContext;
...
- (void)didDisplayTextureWithDescription:(id)a0 isAtEndOfBuild:(char)a1;
