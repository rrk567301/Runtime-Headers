...
@property (nonatomic) char isRangeRef;
@property (nonatomic) char preserveRectangularRange;
...
+ (void)saveToArchive:(void *)a0 columnUids:(const void *)a1 rowUids:(const void *)a2 purpose:(unsigned char)a3 isRangeRef:(char)a4 preserveRectangularRange:(char)a5;
+ (void)saveToArchive:(void *)a0 tsuColumnUids:(const void *)a1 tsuRowUids:(const void *)a2 purpose:(unsigned char)a3 isRangeRef:(char)a4 preserveRectangularRange:(char)a5;
...
- (char)remapUsingColumnUidMap:(const void *)a0 rowUidMap:(const void *)a1 clearIfMissing:(char)a2;
- (char)remapUsingUidMap:(const void *)a0;
