...
@property (readonly, nonatomic) char slideObjectsLayerWithTemplate;
...
- (char)isNoteSelectionPath:(id)a0;
- (void)loadFromArchive:(const void *)a0 unarchiver:(id)a1;
- (void)loadFromUnarchiver:(id)a0;
- (void)p_checkTemplateSlide;
- (char)p_oneOrMoreDrawablesMayHaveImplicitBuildEventsInDrawables:(id)a0;
- (id)p_slideNodeUUIDStringFromURL:(id)a0;
- (char)p_urlIsSlideSpecific:(id)a0;
...
- (void)setTemplateSlide:(id)a0 resetTemplateSlideBackgroundObjects:(char)a1;
