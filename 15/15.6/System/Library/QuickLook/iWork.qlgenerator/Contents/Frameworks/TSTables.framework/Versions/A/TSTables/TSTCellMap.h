...
- (const void *)cellIDs;
- (void)addCell:(id)a0 andCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDAtIndex:(unsigned long long)a0;
...
- (id)initWithContext:(id)a0 uidBased:(char)a1;
- (const void *)rowUIDs;
...
- (id)findCellForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (id)initShallowMapWithContext:(id)a0 uidBased:(char)a1;
- (id)initWithContext:(id)a0 cell:(id)a1 cellIDList:(const void *)a2;
- (id)initWithContext:(id)a0 cell:(id)a1 cellUIDList:(id)a2;
- (id)initWithContext:(id)a0 cell:(id)a1 cellUIDList:(id)a2 skipCellUIDListCopy:(char)a3;
- (id)mergeActions;
- (id)p_addCell:(id)a0;
...
- (void)p_shallowAddCell:(id)a0 atCellCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
