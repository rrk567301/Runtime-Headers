...
@property (readonly, nonatomic) char isFallbackFont;
@property (readonly, nonatomic) char isMasqueradingFont;
@property (readonly, nonatomic) char isRequestedFont;
@property (readonly, nonatomic) char isSystemProxyFont;
@property (readonly, nonatomic) char shouldShowFallbackBadge;
...
- (id)copyWithSize:(double)a0 bold:(char)a1 italic:(char)a2;
- (id)copyWithSize:(double)a0 bold:(char)a1 italic:(char)a2 traits:(id)a3;
- (struct __CTFont { } *)ctFontForSize:(double)a0;
- (struct __CTFont { } *)ctFontForSize:(double)a0 bold:(char)a1 italic:(char)a2;
- (struct __CTFont { } *)ctFontForSize:(double)a0 bold:(char)a1 italic:(char)a2 traits:(id)a3;
...
- (char)isBaseFontEqualToBaseFontFor:(id)a0;
