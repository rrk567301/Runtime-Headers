...
@property (readonly, nonatomic) char isMarkedCorrupt;
...
- (char)referencesSameCustomFormat:(id)a0;
...
- (id)p_nonCustomCurrencyFormatRemovingAccountingStyle:(char)a0 locale:(id)a1;
