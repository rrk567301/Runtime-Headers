...
- (char)setObject:(id)a0 forIdentifier:(long long)a1;
...
- (void)unarchiver:(id)a0 didReadLazyReference:(id)a1 isExternal:(char *)a2;
- (char)validateObjectIdentifierForObject:(id)a0;
