...
@property (nonatomic) char needsFormulaRewriteForImport;
@property (nonatomic) char downgradedForPrePivot;
...
- (void)p_addRules:(id)a0 atRuleIndices:(id)a1 inFilter:(unsigned long long)a2 isNew:(char)a3;
- (id)p_downgradedFilterRuleForListItem:(id)a0 fromPredicate:(id)a1;
- (char)p_thresholdComparisonMatchesFilter:(long long)a0 withPredicateType:(unsigned char)a1;
- (char)preventsRowInsertion;
...
- (char)rowIsShown:(unsigned int)a0 withHiddenStateExtent:(id)a1 withCalcEngine:(id)a2;
