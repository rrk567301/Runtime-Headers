...
- (void)archiveWithArchiver:(id)a0 queue:(id)a1 waitForArchiving:(char)a2;
- (id)archiverForObject:(id)a0 archiveQueue:(id)a1 waitForArchiving:(char)a2;
- (id)archiverForObject:(id)a0 hasArchiverAccessLock:(char)a1;
- (id)explicitComponentRootObjectForObject:(id)a0 hasArchiverAccessLock:(char)a1;
