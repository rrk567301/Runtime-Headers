...
@property (nonatomic) char storeOutsideObjectArchive;
@property (nonatomic) char shouldDelayArchiving;
...
- (void)addObject:(id)a0 willModify:(char)a1;
...
- (id)initWithArray:(id)a0 delegate:(id)a1 shouldDelayArchiving:(char)a2 context:(id)a3;
- (id)initWithDelegate:(id)a0 shouldDelayArchiving:(char)a1 context:(id)a2;
