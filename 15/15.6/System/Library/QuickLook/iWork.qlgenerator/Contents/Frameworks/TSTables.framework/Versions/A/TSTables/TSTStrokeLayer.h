...
- (struct { double x0; struct TSTSimpleRange { long long x0; unsigned long long x1; } x1; char x2; unsigned long long x3; })findWidthAndRangeAtIndex:(long long)a0;
- (id)initWithContext:(id)a0 columnOrRowIndex:(unsigned int)a1;
- (id)nextStrokeAndRange:(id)a0;
- (struct { double x0; struct TSTSimpleRange { long long x0; unsigned long long x1; } x1; char x2; unsigned long long x3; })nextWidthAndRange:(struct { double x0; struct TSTSimpleRange { long long x0; unsigned long long x1; } x1; char x2; unsigned long long x3; })a0;
