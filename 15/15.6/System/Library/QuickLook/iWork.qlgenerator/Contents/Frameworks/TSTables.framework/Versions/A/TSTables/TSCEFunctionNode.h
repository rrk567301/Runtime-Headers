...
+ (id)functionSpec;
+ (id)vectorCriterionPairsWithContext:(id)a0 functionSpec:(id)a1 arguments:(const void *)a2 dimensions:(struct TSCEGridDimensions { unsigned int x0; unsigned int x1; })a3 skipFirst:(char)a4 skipLast:(char)a5 outError:(id *)a6;
