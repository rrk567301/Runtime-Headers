...
- (char)containsAnyPropertyInProperties:(id)a0;
...
- (id)initWithFirstKey:(int)a0 andArgumentList:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
...
- (char)isEqualToPropertyMap:(id)a0;
- (void)p_enumerateReferencedDataForProperty:(int)a0 withObject:(id)a1 stop:(char *)a2 usingBlock:(id /* block */)a3;
