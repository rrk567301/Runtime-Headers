...
@property (nonatomic) char sectionTemplateFirstPageDifferent;
@property (nonatomic) char sectionTemplateFirstPageHidesHeaderFooter;
@property (nonatomic) char sectionTemplateEvenOddPagesDifferent;
...
- (char)isHeaderFooterVisible:(long long)a0;
...
- (void)p_upgradePageSizeAndMarginsFromObsoleteSettings:(id)a0;
