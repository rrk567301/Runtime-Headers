...
@property (readonly, nonatomic) char excelCompat_1x1_Truncation;
@property (readonly, nonatomic) char mayHaveBeenImplicitIntersection;

+ (id)functionSpecForFunctionIndex:(unsigned short)a0;
+ (id)englishFunctionNameFromFunctionIndex:(unsigned short)a0;
+ (char)functionIndexUsesThunks:(unsigned short)a0;
+ (id)functionSpecForFunctionName:(id)a0;
+ (id)functionSpecForOperator:(long long)a0 arguments:(int)a1;
+ (id)functionSpecList;
+ (char)hasAnyDateArgumentsToFunction:(unsigned short)a0;
+ (char)isModeEnabled:(unsigned short)a0 functionIndex:(unsigned short)a1;
+ (void)loadSpecDictionary;
+ (id)specWithFunctionName:(id)a0 minArgs:(unsigned long long)a1 maxArgs:(unsigned long long)a2 fanoutOptions:(unsigned int)a3 mayHaveBeenImplicitIntersection:(char)a4 shipVersion:(int)a5 arguments:(const void *)a6 functionIndex:(unsigned short)a7;
...
+ (id)specWithFunctionName:(id)a0 minArgs:(unsigned long long)a1 maxArgs:(unsigned long long)a2 mayHaveBeenImplicitIntersection:(char)a3 shipVersion:(int)a4 arguments:(const void *)a5 functionIndex:(unsigned short)a6;
+ (id)specWithFunctionName:(id)a0 minArgs:(unsigned long long)a1 maxArgs:(unsigned long long)a2 repeatingGroupSize:(short)a3 fanoutOptions:(unsigned int)a4 mayHaveBeenImplicitIntersection:(char)a5 shipVersion:(int)a6 arguments:(const void *)a7 functionIndex:(unsigned short)a8;
...
+ (id)specWithFunctionName:(id)a0 minArgs:(unsigned long long)a1 maxArgs:(unsigned long long)a2 repeatingGroupSize:(short)a3 nonRepeatingArgsAtEnd:(unsigned short)a4 fanoutOptions:(unsigned int)a5 mayHaveBeenImplicitIntersection:(char)a6 shipVersion:(int)a7 arguments:(const void *)a8 functionIndex:(unsigned short)a9;
