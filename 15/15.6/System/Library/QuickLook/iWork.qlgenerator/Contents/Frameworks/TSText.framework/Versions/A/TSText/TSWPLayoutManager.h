...
@property (readonly, nonatomic) char layoutFinished;
@property (readonly, nonatomic) char isLayingOut;
...
+ (void)fixColumnBoundsForTarget:(id)a0 storage:(id)a1 charIndex:(unsigned long long)a2 firstColumnIndex:(unsigned long long)a3 precedingHeight:(double)a4 height:(double)a5 alreadyHasMargins:(char)a6 styleProvider:(id)a7;
...
- (char)needsLayoutInColumn:(id)a0;
...
- (void *)layOutIntoTarget:(id)a0 withLayoutState:(void *)a1 outSync:(char *)a2;
