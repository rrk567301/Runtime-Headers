...
@interface TSCH3DChartModelEnumerator : NSObject {
    ...
    struct ValueEnumerator { char _forward; unsigned long long _index; unsigned long long _max; double _value; } _seriesEnumerator;
    struct ValueEnumerator { char _forward; unsigned long long _index; unsigned long long _max; double _value; } _coordinateEnumerator;
}
...
- (void)resetForReverseSeriesEnumeration:(char)a0;
