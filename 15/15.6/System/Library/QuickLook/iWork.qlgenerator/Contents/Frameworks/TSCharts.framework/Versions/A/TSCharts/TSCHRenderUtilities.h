...
+ (void)applyHDRHeadroomFromCGLayer:(struct CGLayer { } *)a0 toContext:(struct CGContext { } *)a1;
+ (struct { double x0; double x1; double x2; char x3; })barElementsRendererValueRangeForModelCache:(id)a0 groupIndex:(unsigned long long)a1;
+ (char)centerPointForSeries:(id)a0 groupIndex:(unsigned long long)a1 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 point:(struct CGPoint { double x0; double x1; } *)a3;
+ (char)centerPointForSeries:(id)a0 groupIndex:(unsigned long long)a1 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 point:(struct CGPoint { double x0; double x1; } *)a3 nullsUseIntercept:(char)a4;
+ (id)commonAncestorLayerForLayer:(id)a0 withLayer:(id)a1;
+ (void)debugRenderLayoutRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inContext:(struct CGContext { } *)a1 withColor:(id)a2 alpha:(double)a3 fillRect:(char)a4;
+ (void)drawCGLayer:(struct CGLayer { } *)a0 inContext:(struct CGContext { } *)a1 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
...
+ (struct CGPath { } *)newPolarAxisShapePathWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 unitSpaceValue:(double)a1 numberOfValues:(unsigned long long)a2 elliptical:(char)a3 rotation:(double)a4;
...
+ (char)strokeEnabledForRenderingForAxis:(id)a0 chart:(id)a1;
