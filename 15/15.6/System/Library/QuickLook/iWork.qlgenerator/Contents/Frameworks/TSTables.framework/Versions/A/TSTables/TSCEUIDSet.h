...
- (char)containsUuid:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
...
- (char)isAllInvalid;
- (char)p_addUUID:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
- (void)p_addUUIDs:(const void *)a0;
- (void)p_addUUIDsFromVector:(const void *)a0;
- (char)p_removeUUID:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0;
