...
+ (void)upgradeSceneDepthSettingsForChartInfo:(id)a0 hasConstantDepth:(char)a1 willModifyBlock:(id /* block */)a2;
...
- (char)p_shouldClearSceneForLayoutSettings:(struct { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; long long x8; unsigned long long x9; })a0;
