@class NSSet, NSDictionary, NSArray, NSMutableDictionary, NSMutableArray, NSObject;
...
- (id)cacheKeyForFontWithPostScriptName:(id)a0 atSize:(double)a1 bold:(char)a2 italic:(char)a3;
...
- (id)fontForPostscriptName:(id)a0 atSize:(double)a1 bold:(char)a2 italic:(char)a3;
