...
@interface TSCEReferenceValue : TSCEValue {
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _hostCell;
}
...
@property (nonatomic) char isOutputOfAFunction;
@property (nonatomic) char permitsAccessInsideMergeRegions;
@property (readonly, nonatomic) struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } tableUID;
@property (readonly, nonatomic) struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } range;
...
- (id)asReferenceValue;
- (id)initWithEvalRef:(id)a0 hostCell:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a1 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a2 permitsAccessInsideMergeRegions:(char)a3 isOutputOfAFunction:(char)a4;
- (char)nativeType;
...
- (id)initWithContext:(id)a0 rangeRef:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a2;
- (id)initWithContext:(id)a0 rangeRef:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a2 cacheValue:(id)a3 wasFetchedWithRichTextAttributes:(char)a4;
- (id)initWithContext:(id)a0 tableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 rangeCoord:(const struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } *)a2 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a3;
- (id)initWithContext:(id)a0 tableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 rangeCoord:(const struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } *)a2 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a3 isOutputOfAFunction:(char)a4;
- (id)initWithContext:(id)a0 tableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 relativeCellCoord:(const struct TSCERelativeCellCoordinate { int x0; short x1; char x2; char x3; } *)a2 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a3;
- (id)initWithContext:(id)a0 tableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 relativeRangeCoord:(const struct TSCERelativeRangeCoordinate { struct TSCERelativeCellCoordinate { int x0; short x1; char x2; char x3; } x0; struct TSCERelativeCellCoordinate { int x0; short x1; char x2; char x3; } x1; } *)a2 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a3;
- (id)intersectionWithHostCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 rangeContext:(unsigned char)a1;
- (char)isReferenceValue;
- (id)referredToValue:(id)a0 fetchRichTextAttributesIfPlainText:(char)a1;
