...
+ (id)_newDetector;
+ (char)detectedDataInString:(id)a0 scanRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 withTextCheckingTypes:(unsigned long long)a2;
+ (id)p_newArrayByScanningString:(id)a0 scanRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 returnAllResults:(char)a2 dataDetector:(id)a3;
