...
@property (readonly, nonatomic) char hasTSCEFormula;
@property (readonly, nonatomic) char isControl;
...
+ (char)interactionTypeIsControl:(unsigned int)a0;
+ (char)isShimControlFormatType:(unsigned int)a0;
...
- (char)validateFormatAndValue:(id)a0;
