...
- (id)init;
- (void).cxx_destruct;
- (id)providerForData:(id)a0 shouldValidate:(char)a1;
...
- (id)p_providerForData:(id)a0 temporary:(char)a1 shouldValidate:(char)a2;
...
- (id)temporaryProviderForData:(id)a0 shouldValidate:(char)a1;
