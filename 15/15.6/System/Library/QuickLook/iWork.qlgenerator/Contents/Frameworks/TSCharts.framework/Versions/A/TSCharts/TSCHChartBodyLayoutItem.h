...
- (void)layoutOutward;
- (char)layoutSpacePointIsInChartBody:(struct CGPoint { double x0; double x1; })a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })p_exactSummaryLabelsDrawingRectForSeries:(id)a0;
