...
@property (readonly, nonatomic) char isSavingDocumentAs;
@property (readonly, nonatomic) char isSavingCollaborativeDocument;
...
- (void)setSparseReferenceArray:(id)a0 isWeak:(char)a1 message:(void *)a2;
