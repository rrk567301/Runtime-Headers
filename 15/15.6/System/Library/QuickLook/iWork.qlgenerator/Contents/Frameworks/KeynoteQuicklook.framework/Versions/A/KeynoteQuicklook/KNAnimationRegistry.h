...
- (id)animationInfoForEffectIdentifier:(id)a0 animationType:(long long)a1 includeObsoleteNames:(char)a2;
- (id)animationInfoForEffectIdentifier:(id)a0 animationType:(long long)a1 includeObsoleteNames:(char)a2 drawable:(id)a3;
- (id)animationInfosForAnimationType:(long long)a0 category:(id)a1;
- (id)animationInfosForAnimationType:(long long)a0 filter:(id)a1;
- (char)canMapEffectIdentifier:(id)a0 animationType:(long long)a1 toEffectIdentifier:(id)a2 includeObsoleteNames:(char)a3 forDrawable:(id)a4;
