...
@property (readonly, nonatomic) char hasAnyDrawables;
...
- (void)addDrawable:(id)a0 toPageIndex:(unsigned long long)a1 insertContext:(id)a2 suppressDOLC:(char)a3;
...
- (void)removeDrawable:(id)a0 suppressDOLC:(char)a1;
