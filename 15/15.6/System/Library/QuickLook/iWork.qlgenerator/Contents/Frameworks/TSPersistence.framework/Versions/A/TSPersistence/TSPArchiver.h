...
@property (readonly, nonatomic) char needsToScheduleArchive;
...
- (char)updateMessageInfo:(void *)a0 withArchiver:(id)a1;
- (id)addAlternateArchiverForVersion:(unsigned long long)a0 fieldPath:(const void *)a1 isDiffArchiver:(char)a2 diffReadVersion:(unsigned long long)a3 message:(const struct Message { void /* function */ **x0; struct InternalMetadata { void *x0; } x1; } *)a4;
- (void)addDocumentFeatureInfoWithIdentifier:(id)a0 readVersion:(unsigned long long)a1 writeVersion:(unsigned long long)a2 validatingValues:(char)a3;
