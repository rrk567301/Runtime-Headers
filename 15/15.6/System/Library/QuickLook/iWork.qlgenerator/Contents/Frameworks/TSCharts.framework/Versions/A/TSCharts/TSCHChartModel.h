...
- (id)barStackRectsWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withBlock:(id /* block */)a1;
...
- (void)p_synchronizeModelWithSeriesNonStyleMigration:(char)a0;
- (void)p_synchronizeReferenceLines;
- (void)p_synchronizeSeriesListWithSeriesNonStyleMigration:(char)a0;
...
- (void)setShouldCacheMediatorData:(char)a0;
- (void)setTextEditingSelectionPath:(id)a0 string:(id)a1;
- (void)updateTransientModelFromInfoModel;
- (void)validateIfNeeded;
- (void)validateIfNeededWithSeriesNonStyleMigration:(char)a0;
