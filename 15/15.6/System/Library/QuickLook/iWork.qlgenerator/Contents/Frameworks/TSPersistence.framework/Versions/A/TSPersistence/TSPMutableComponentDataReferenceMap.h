...
- (id)init;
- (void).cxx_destruct;
- (long long)addReferenceFromObjectIdentifier:(long long)a0 toDataIdentifier:(long long)a1 objectHasUUID:(char)a2;
- (long long)incrementReferenceFromObjectIdentifier:(long long)a0 toDataIdentifier:(long long)a1 objectHasUUID:(char)a2 increment:(unsigned long long)a3;
