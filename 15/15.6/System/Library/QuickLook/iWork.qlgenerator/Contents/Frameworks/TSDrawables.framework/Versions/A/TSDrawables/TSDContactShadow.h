...
+ (id)contactShadowWithOffset:(double)a0 height:(double)a1 radius:(double)a2 opacity:(double)a3 color:(id)a4 enabled:(char)a5;
...
- (id)initWithOffset:(double)a0 height:(double)a1 radius:(double)a2 opacity:(double)a3 color:(id)a4 enabled:(char)a5;
...
- (struct CGImage { } *)newShadowImageFromContext:(struct CGContext { } *)a0 withSize:(struct CGSize { double x0; double x1; })a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 unflipped:(char)a3;
