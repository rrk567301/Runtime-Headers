...
- (char)dumpComponentMessages:(id)a0 printNewLine:(char)a1 withPrinter:(void *)a2 outputStream:(void *)a3;
- (char)dumpMessagesForDocumentUUID:(id)a0 versionUUID:(id)a1 packageIdentifier:(unsigned char)a2;
- (char)dumpMessagesToFilePath:(id)a0;
