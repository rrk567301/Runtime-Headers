@class NSObject, NSMutableString, TSDDrawableInfo, TSWPCharacterStyle, TSWPDeletionRangeMap, TSWPStorageBroadcaster, NSString, NSSet, TSDInfoGeometry, TSWPDocumentRoot, TSPObject, NSArray, TSSStylesheet;
...
@property (readonly, nonatomic) char hasAnyCommentsRequiring2_2;
@property (weak, nonatomic) TSWPDocumentRoot *documentRoot;
@property (nonatomic) char isInInit;
...
@property (nonatomic) char usesSystemFonts;
...
@property (readonly, nonatomic) char containsOnlyInlineDrawableAttachments;
...
+ (void)initialize;
+ (id)filterText:(id)a0 removingAttachments:(char)a1;
+ (char)allowsElementKind:(unsigned int)a0 forStorageKind:(unsigned char)a1;
...
+ (char)allowsSmartFieldKind:(unsigned short)a0 forStorageKind:(unsigned char)a1;
...
+ (id)filterText:(id)a0 removingAttachments:(char)a1 removingControlCharacters:(char)a2;
+ (id)filterText:(id)a0 removingAttachments:(char)a1 removingControlCharacters:(char)a2 returnIndexSet:(char)a3;
+ (void)nonUndoableRemoveUnsupportedHyperlinksInInfos:(id)a0;
+ (void)nonUndoableRemoveUnsupportedHyperlinksInInfos:(id)a0 forCrossDocumentPaste:(char)a1;
+ (void)resetAllTextAttributeUUIDStringsInInfo:(id)a0;
+ (void)resetAllTextAttributeUUIDStringsInInfos:(id)a0;
+ (char)shouldInvalidateForStylePropertyChangeSet:(id)a0;
...
- (void)commonInit;
- (char)isSelectable;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })nextWordFromIndex:(unsigned long long)a0 forward:(char)a1;
- (unsigned long long)sectionCount;
- (unsigned long long)wordCount;
- (unsigned long long)paragraphCount;
- (char)validate:(unsigned long long)a0;
...
- (char)hasHiddenTextAtCharIndex:(unsigned long long)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1;
...
- (char)allowsElementKind:(unsigned int)a0;
- (char)anchoredDrawableAttachmentCharacterAtCharIndex:(unsigned long long)a0;
- (void)applyChange:(id)a0 changeRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 accept:(char)a2 undoTransaction:(void *)a3;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })attachmentRangeForCharIndex:(unsigned long long)a0 forwards:(char)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })attachmentRangeForCharIndex:(unsigned long long)a0 forwards:(char)a1 attributeKind:(unsigned long long)a2;
...
- (id)characterStyleAtCharIndex:(unsigned long long)a0 left:(char)a1 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
...
- (id)editableAnnotationForInsertionPointSelection:(id)a0 includeComments:(char)a1 withOutRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2 selectionIsOnEdge:(char *)a3;
...
- (id)firstHighlightForSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 outRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 requireComment:(char)a2;
...
- (char)hasDeletedTextAtCharIndex:(unsigned long long)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1;
- (char)hasDeletionInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)hasHiddenTextAtCharIndex:(unsigned long long)a0;
- (char)hasSectionForParagraphBreakAtCharIndex:(unsigned long long)a0;
- (char)hasSmartFields;
- (char)hasSmartFieldsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)hasVisibleTextAtCharIndex:(unsigned long long)a0;
...
- (void)invalidatePageCountAttachmentCharIndexes:(char)a0;
- (char)isAllWhitespaceInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)isDOLCSuppressed;
- (char)isWholeParagraphsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 ignoreAttachmentCharacters:(char)a1 requireParagraphBreakSelected:(char)a2;
- (char)isWritingDirectionRightToLeftForListAtParIndex:(unsigned long long)a0;
- (char)isWritingDirectionRightToLeftForParagraphAtCharIndex:(unsigned long long)a0;
- (char)isWritingDirectionRightToLeftForParagraphAtParIndex:(unsigned long long)a0;
- (unsigned long long)listEndAtCharIndex:(unsigned long long)a0;
- (unsigned long long)listNumberForParagraphEnumerator:(const struct TSWPParagraphEnumerator { id x0; id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; BOOL x6; struct _NSRange { unsigned long long x0; unsigned long long x1; } x7; } *)a0 numberingData:(struct { unsigned long long x0; unsigned long long x1; char x2; } *)a1;
- (unsigned long long)listNumberForParagraphIndex:(unsigned long long)a0 numberingData:(struct { unsigned long long x0; unsigned long long x1; char x2; } *)a1;
...
- (void)p_attributesAtCharIndex:(unsigned long long)a0 attributesOfInterest:(char[23])a1 attributesTable:(id[23])a2 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a3;
...
- (char)p_hasDeletedTextAtCharIndex:(unsigned long long)a0 requireHidden:(char)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
- (char)p_hasGoodAttributesForPlainTextPaste;
- (unsigned long long)p_indexOfFirstNonDeletedCharInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 requireVisible:(char)a1;
- (char)p_passesExtraTablesChecksForStoringInAStringValueCell;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_rangeForSelectionAtCharIndex:(unsigned long long)a0 caretIndex:(unsigned long long)a1 handleNextWordWhitespace:(char)a2;
...
- (char)p_shouldInsertionSplitChange:(id)a0 changeSession:(id)a1;
- (struct TSWPParagraphAttributeArray { void /* function */ **x0; struct TSWPAttributeRecord *x1; id x2; unsigned int x3 : 32; unsigned char x4 : 8; unsigned char x5 : 1; } *)paragraphAttributeArrayForKind:(unsigned long long)a0 withCreate:(char)a1;
...
- (struct TSWPParagraphEnumerator { id x0; id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; BOOL x6; struct _NSRange { unsigned long long x0; unsigned long long x1; } x7; })paragraphEnumeratorForCharRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 styleProvider:(id)a1 requireHidden:(char)a2;
...
- (char)paragraphHasListLabelAtCharIndex:(unsigned long long)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeByExtendingRangeToWhitespace:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 skipVisibleDeleted:(char)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeForSelectionAtCharIndex:(unsigned long long)a0 includePreviousWord:(char)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfParagraphBreakingCharacter:(unsigned short)a0 backwards:(char)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })replaceCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withStorage:(id)a1 usePasteRules:(char)a2 dolcContext:(id)a3 undoTransaction:(void *)a4;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })replaceCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withString:(id)a1 notifyObservers:(char)a2 undoTransaction:(void *)a3;
...
- (char)setDOLCSuppressed:(char)a0;
...
- (void)nonUndoableSetWPKind:(unsigned char)a0 keepHighlights:(char)a1;
- (char)phoneticsExistOnRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
...
- (struct TSWPAttributeArray { void /* function */ **x0; struct TSWPAttributeRecord *x1; id x2; unsigned int x3 : 32; unsigned char x4 : 8; unsigned char x5 : 1; } *)attributeArrayForKind:(unsigned long long)a0 withCreate:(char)a1;
...
- (char)hasObject:(id)a0 attributeArrayKind:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 findUsingExactRangeLocation:(char)a3;
...
- (char)allowsElementKind:(unsigned int)a0 nestingDepth:(long long)a1;
...
- (char)allowsSmartFieldKind:(unsigned short)a0;
...
- (void)applyChanges:(char)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 outChangedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a3 outSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a4 undoTransaction:(void *)a5 forceAll:(char)a6 kind:(int)a7;
...
- (struct TSWPAttributeArray { void /* function */ **x0; struct TSWPAttributeRecord *x1; id x2; unsigned int x3 : 32; unsigned char x4 : 8; unsigned char x5 : 1; } *)attributeArrayForKind:(unsigned long long)a0 withCreate:(char)a1 actionState:(void *)a2;
- (struct TSWPAttributeArray { void /* function */ **x0; struct TSWPAttributeRecord *x1; id x2; unsigned int x3 : 32; unsigned char x4 : 8; unsigned char x5 : 1; } *)attributeArrayForKind:(unsigned long long)a0 withCreate:(char)a1 fromUndo:(char)a2 actionState:(void *)a3;
...
- (char)canAcceptAttachmentForDrawableInfo:(id)a0;
- (char)canAcceptDrawableAttachments;
- (char)canTransferAttributesForInitialization:(unsigned long long)a0 withFlags:(unsigned int)a1;
- (void *)cfRetainedNonUndoableFastCopyAttributeRecord:(struct TSWPAttributeRecord { unsigned long long x0; union { id x0; struct TSWPParagraphData { union { struct { unsigned int x0; } x0; struct { unsigned short x0; unsigned short x1; } x1; struct { unsigned short x0; unsigned short x1; } x2; struct { int x0; } x3; struct { unsigned int x0; } x4; struct { unsigned short x0; unsigned short x1; } x5; } x0; } x1; } x1; } *)a0 shouldAddRecord:(char *)a1 attributeArrayKind:(unsigned long long)a2 atIndex:(unsigned long long)a3 sourceStorage:(id)a4 objectContext:(id)a5 flags:(unsigned int)a6 actionState:(void *)a7;
...
- (id)firstHighlightForSelection:(id)a0 requireComment:(char)a1;
- (char)hasAttachmentsRequiring4_1InRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)hasData:(struct TSWPParagraphData { union { struct { unsigned int x0; } x0; struct { unsigned short x0; unsigned short x1; } x1; struct { unsigned short x0; unsigned short x1; } x2; struct { int x0; } x3; struct { unsigned int x0; } x4; struct { unsigned short x0; unsigned short x1; } x5; } x0; })a0 attributeArrayKind:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
- (char)hasDrawableAttachmentOfClass:(Class)a0;
- (char)hasEmptyListAtCharIndex:(unsigned long long)a0;
- (char)hasEmptyParagraphFillOrBordersAtCharIndex:(unsigned long long)a0;
- (char)hasObject:(id)a0 attributeArrayKind:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
- (char)hasPartitionableAttachmentAtStartOfTextRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)hasVisibleTextOnlyContent;
- (char)hasVisibleTextOnlyContentInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)highlightsForSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 requireComment:(char)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })insertSectionBreakAtCharIndex:(unsigned long long)a0 replaceParagraphBreak:(char)a1 sectionToInsert:(id)a2 changeSession:(id)a3 dolcContext:(id)a4 undoTransaction:(void *)a5;
...
- (char)isAllWhitespaceInSelection:(id)a0;
- (char)isCharRangeEntirelyDeleted:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)isCharRangeEntirelyHidden:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)isCharRangePartiallyDeleted:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)isEmptyParagraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 ignoreAttachmentCharacters:(char)a1 outRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
- (char)isEmptyParagraphSelection:(id)a0 ignoreAttachmentCharacters:(char)a1 outRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
- (char)isObjectValid:(id)a0 forStyleKind:(int)a1;
- (char)isSingleAnchoredDrawableAttachmentForSelection:(id)a0;
- (id)languageAtParIndex:(unsigned long long)a0 useStringTokenizer:(char)a1 useDocumentLanguage:(char)a2;
...
- (id)languageForTextRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 useStringTokenizer:(char)a1 useDocumentLanguage:(char)a2;
- (unsigned long long)listStartAtParIndex:(unsigned long long)a0;
- (unsigned long long)moveByLineRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 up:(char)a1;
...
- (void)nonUndoableFilterInvalidContentForStorage:(id)a0 keepHighlights:(char)a1;
- (void)nonUndoableFilterInvalidContentForStorage:(id)a0 keepHighlights:(char)a1 nestingDepth:(long long)a2;
- (void)nonUndoableFilterInvalidContentForStorage:(id)a0 keepHighlights:(char)a1 nestingDepth:(long long)a2 rangesToUpdate:(id)a3;
...
- (void)nonUndoableRemoveUnsupportedHyperlinksForCrossDocumentPaste:(char)a0;
...
- (char)pAllowsAttachment:(id)a0 withNestingDepth:(long long)a1;
...
- (char)p_canTransferBookmark:(id)a0;
...
- (void)p_createAttributeTablesIfNeededWithListStyleFlag:(char)a0;
- (void)p_deduplicateAttributeObjectsWithVersion:(unsigned long long)a0 hasPreUFFVersion:(char)a1;
...
- (void)p_finalizeLoadingFromUnarchiverWithTimes:(const double *)a0 isInDocument:(char)a1 isFromCopy:(char)a2 hasTableListStyle:(char)a3 isCrossAppPaste:(char)a4 hasPreUFFVersion:(char)a5 fileFormatVersion:(unsigned long long)a6;
...
- (char)p_hasVisibleTextInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 graphicalAttachmentsIncluded:(char)a1;
- (id)p_highlightsForSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 outRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 requireComment:(char)a2 stopOnFirst:(char)a3;
...
- (void)p_repairHyperlinksWithVersion:(unsigned long long)a0 hasPreUFFVersion:(char)a1;
...
- (id)p_replacementsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withString:(id)a1 replaceTextData:(id)a2 changeSession:(id)a3 shouldTrackDeletions:(char)a4;
- (char)p_shouldAcceptChangesForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 copiedRanges:(id)a1 removeDeletedText:(char *)a2;
...
- (char)phoneticsExistInSelection:(id)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })replaceCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withString:(id)a1 notifyObservers:(char)a2 changeSession:(id)a3 undoTransaction:(void *)a4;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })replaceCharactersInSelection:(id)a0 withStorage:(id)a1 usePasteRules:(char)a2 srcStylesAmbiguous:(char)a3 dolcContext:(id)a4 changeSession:(id)a5 undoTransaction:(void *)a6;
- (id)replaceCharactersInSelection:(id)a0 withStorage:(id)a1 usePasteRules:(char)a2 srcStylesAmbiguous:(char)a3 dolcContext:(id)a4 changeSession:(id)a5 undoTransaction:(void *)a6 outInsertedRanges:(id *)a7;
...
- (void)saveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 toArchiver:(id)a1 styleProvider:(id)a2 archiveChanges:(char)a3 removeDeletedText:(char)a4 archivePencilAnnotations:(char)a5;
- (char)selectionContainsExclusivelyEmptyParagraphs:(id)a0 ignoreAttachmentCharacters:(char)a1;
