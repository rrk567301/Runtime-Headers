...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)intersectsRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })a0;
- (void)saveToArchiver:(id)a0;
- (void)loadFromUnarchiver:(id)a0;
- (void)applyBlockToRecordsInRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })a0 cellRestrictions:(unsigned long long)a1 doWillModify:(char)a2 block:(id /* block */)a3;
- (struct TSCECellRecord { struct TSCECellRecordEdgeLists *x0; struct os_unfair_lock_s { unsigned int x0; } x1; unsigned long long x2; struct TSCEPackedEdge { char x0[8]; } x3; unsigned int x4; unsigned short x5; unsigned short x6; } *)findCellRecord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (void)sortCellRecords;
- (void)appendExpandedEdgeToArchive:(void *)a0 edge:(const struct TSCEInternalCellReference { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; unsigned short x1; unsigned short x2; } *)a1;
- (char)applyBlockToRecords:(unsigned long long)a0 doWillModify:(char)a1 block:(id /* block */)a2;
- (char)applyBlockToSortedRecords:(unsigned long long)a0 doWillModify:(char)a1 block:(id /* block */)a2;
...
- (char)coordInRange:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (char)insertCellRecord:(struct TSCECellRecord { struct TSCECellRecordEdgeLists *x0; struct os_unfair_lock_s { unsigned int x0; } x1; unsigned long long x2; struct TSCEPackedEdge { char x0[8]; } x3; unsigned int x4; unsigned short x5; unsigned short x6; } *)a0 cellDependencies:(id)a1;
- (void)pruneEmptyRecords:(id)a0;
- (void)removeCellRecord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 cellDependencies:(id)a1;
- (char)replaceCellRecord:(struct TSCECellRecord { struct TSCECellRecordEdgeLists *x0; struct os_unfair_lock_s { unsigned int x0; } x1; unsigned long long x2; struct TSCEPackedEdge { char x0[8]; } x3; unsigned int x4; unsigned short x5; unsigned short x6; } *)a0 cellDependencies:(id)a1;
