...
- (char)canDeleteWithAuthor:(id)a0 docIsReadOnly:(char)a1;
- (char)canEditWithAuthor:(id)a0 docIsReadOnly:(char)a1;
- (void)commentWillBeAddedToDocumentRoot;
- (id)copyByAppendingText:(id)a0;
- (id)copyWithContext:(id)a0 preserveStorageUUID:(char)a1;
...
- (char)isEqualToCommentStorage:(id)a0;
- (id)matchingReply:(id)a0;
- (char)p_canDeleteCommentStorageWithAuthor:(id)a0 docIsReadOnly:(char)a1;
- (char)p_canModifyCommentStorageWithAuthor:(id)a0 docIsReadOnly:(char)a1;
- (char)p_matchesCommentStorage:(id)a0;
