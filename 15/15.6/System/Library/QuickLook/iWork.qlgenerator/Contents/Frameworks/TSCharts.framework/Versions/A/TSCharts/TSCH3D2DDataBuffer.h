...
@property (readonly, nonatomic) struct DataBuffer2DDimension { struct tvec2<int> { union { int x; int r; int s; } ; union { int y; int g; int t; } ; } _size; unsigned long long _components; char _hasLevels; } dimension;
...
+ (id)bufferWithCapacitySize:(void *)a0 components:(unsigned long long)a1;
