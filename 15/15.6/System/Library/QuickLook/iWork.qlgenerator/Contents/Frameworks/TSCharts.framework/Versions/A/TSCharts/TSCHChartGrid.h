...
- (void)addingMultipleCols:(char)a0;
- (void)addingMultipleRows:(char)a0;
...
- (char)contentsEqualToGrid:(id)a0;
...
- (void)p_adjustNameListLength:(char)a0;
- (char)p_name:(id)a0 isInArray:(id)a1;
- (void)p_updateColumnIndexMap;
- (void)p_updateColumnMapStartingAtIndex:(unsigned long long)a0;
- (void)p_updateIdMapStartingAtIndex:(unsigned long long)a0 isRow:(char)a1;
...
- (void)saveToUnityArchive:(void *)a0 forCopy:(char)a1;
...
- (void)validateRowColumnIdMapsAndFix:(char)a0;
