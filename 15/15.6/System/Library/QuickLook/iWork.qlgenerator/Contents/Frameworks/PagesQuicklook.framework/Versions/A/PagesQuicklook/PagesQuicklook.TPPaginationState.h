...
@property (nonatomic, readonly) char isPaginationComplete;
...
- (char)isPaginationCompleteThroughDocumentPageIndex:(unsigned long long)a0;
- (char)isPaginationCompleteUpToDocumentPageIndex:(unsigned long long)a0;
