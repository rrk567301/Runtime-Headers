...
@property (readonly, nonatomic) char isLetFunction;
@property (readonly, nonatomic) char isLambdaFunction;
...
@property (readonly, nonatomic, getter=isInvalidFunction) char invalidFunction;
...
- (void)insertFormulaText:(id)a0 includeWhitespace:(char)a1 unwrapped:(char)a2;
- (void)insertFormulaTextNonRecursive:(id)a0 phase:(unsigned long long)a1 deferredWorkStack:(id)a2;
- (char)isDescendantOfChild:(id)a0;
