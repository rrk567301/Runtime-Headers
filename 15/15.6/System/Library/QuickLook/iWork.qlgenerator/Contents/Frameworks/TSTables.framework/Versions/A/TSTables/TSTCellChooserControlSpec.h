...
@property (readonly, nonatomic) char startWithFirstItem;

+ (id)instanceWithArchive:(const void *)a0 unarchiver:(id)a1;
+ (id)popupCellSpec:(id)a0 startWithFirstItem:(char)a1;
...
- (id)initWithPopupModel:(id)a0 startWithFirstItem:(char)a1;
