...
@interface _TtC8TSChartsP33_9974A0D4784435EAA6E46641D25D8C6B18TSCHChartTypeRadar : TSCH2DChartType

@property (nonatomic, readonly) long long userInterfaceTag;
@property (nonatomic, readonly) NSString *userInterfaceName;
@property (nonatomic, readonly) NSString *name;
@property (nonatomic, readonly) char usesPolarCoordinates;
...
@property (nonatomic, readonly) char supportsGridlineTickmarks;
@property (nonatomic, readonly) char layoutFrameShouldEncloseInfoGeometry;
