@class TSTTableSortOrder, TSTConcurrentMutableCellUIDSet, TSTCellWillChangeDistributor, TSTPencilAnnotationOwner, TSTTableDataStore, TSDStroke, TSTTableInfo, TSTMergeOwner, TSTCellStyle, TSTOwnerUidMapper, TSTCellDictionary, TSCECalculationEngine, TSTTableTranslator, NSMapTable, TSWPShapeStyle, TSCEHauntedOwner, TSWPParagraphStyle, TSCESpillOwner, TSTCategoryOwner, TSWPStorage, TSTColumnRowUIDMap, TSTStructuredTextImportRecord, NSArray, TSTPivotOwner, TSTConditionalStyleFormulaOwner, TSTHiddenStatesOwner, TSTSortRuleReferenceTracker, TSTHiddenStateFormulaOwner, NSString, TSTTableStyle, TSTStrokeSidecar, NSUUID, TSTTableStylePreset, TSTTableFilterSet;
...
@property (nonatomic) char isAPivotDataModel;
...
@property (readonly, nonatomic) char upgradeNeedsToUpdateFilterSetForImport;
...
@property (nonatomic) char upgradeShouldSuppressFormulaWarnings;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })range;
...
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })bodyRange;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })bodyColumnRange;
- (void)adoptStylesheet:(id)a0 withMapper:(id)a1;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })bodyRowRange;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })cellRangeForTableArea:(unsigned long long)a0;
- (id)drawableInfo;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })footerRowRange;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })headerColumnRange;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })headerRowRange;
...
- (void)prepareForPasteWithCalculationEngine:(id)a0 sourceOffset:(struct TSUColumnRowOffset { int x0; int x1; })a1 bakeFormulas:(char)a2;
...
- (unsigned long long)tableStyleAreaForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (double)widthOfColumnAtIndex:(struct TSUModelColumnIndex { unsigned short x0; })a0 isDefault:(out char *)a1;
- (id)allDataAsString;
...
- (struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })UIDForIndex:(unsigned int)a0 isRows:(char)a1;
- (id)UIDSetForIndexes:(id)a0 isRows:(char)a1;
- (id)UIDSetForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isRows:(char)a1;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct __compressed_pair<TSKUIDStruct *, std::allocator<TSKUIDStruct>> { struct TSKUIDStruct *x0; } x2; })UIDsForIndexes:(id)a0 isRows:(char)a1;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct __compressed_pair<TSKUIDStruct *, std::allocator<TSKUIDStruct>> { struct TSKUIDStruct *x0; } x2; })UIDsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isRows:(char)a1;
- (char)_hasRatingFormats;
- (void)_removeAnnotationsFromDeleteRange:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0;
- (void)accumulateCurrentCellsConcurrently:(id)a0;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })actualHeaderColumnRange;
- (void)addCellRefToClearError:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0;
- (void)addPasteboardCustomFormatsToDocumentAndUpdateCells;
- (void)addReferencedStylesToSet:(id)a0;
- (struct TSCECellCoordSet { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; struct map<unsigned short, TSUIndexSet, std::less<unsigned short>, std::allocator<std::pair<const unsigned short, TSUIndexSet>>> { struct __tree<std::__value_type<unsigned short, TSUIndexSet>, std::__map_value_compare<unsigned short, std::__value_type<unsigned short, TSUIndexSet>, std::less<unsigned short>>, std::allocator<std::__value_type<unsigned short, TSUIndexSet>>> { void *x0; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<unsigned short, TSUIndexSet>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x0; } x1; struct __compressed_pair<unsigned long, std::__map_value_compare<unsigned short, std::__value_type<unsigned short, TSUIndexSet>, std::less<unsigned short>>> { unsigned long long x0; } x2; } x0; } x1; })arrayFormulasSpillingIntoRegion:(id)a0;
- (void)assertCollaborationConvergence;
- (void)assertListTilesAndRows;
- (char)auditColumnRowCellCountsReturningResult:(id *)a0 hasUndercounts:(char *)a1;
- (char)auditDatalistDuplicationReturningResult:(id *)a0;
- (char)auditRowInfoCellCountsReturningResult:(id *)a0;
- (char)auditTilesForRowOverlapAndExtensionPastTableBounds:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 result:(id *)a1;
- (struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })baseCellCoordForCellContainingRichTextStorage:(id)a0;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })bottomCornerRange;
- (id)cachedCommentHostingForAnnotationUUID:(id)a0;
- (id)cellAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)cellBorderAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)cellExistsAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (char)cellModifiedInCurrentRecalcCycle:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } *)a0;
...
- (id)cellStyleAtModelCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isDefault:(out char *)a1;
- (id)cellStyleForCellWithEmptyStyleAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isDefault:(out char *)a1;
- (id)cellStyleOfColumnAtIndex:(struct TSUModelColumnIndex { unsigned short x0; })a0 isDefault:(out char *)a1;
- (id)cellStyleOfRowAtIndex:(struct TSUModelRowIndex { unsigned int x0; })a0 isDefault:(out char *)a1;
...
- (id)cellValueAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)cellValueFromCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
- (unsigned char)cellValueTypeAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (void)clearSpillCellsForOriginID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 boundingResultRegion:(id *)a1;
- (void)clearSpillCellsInRange:(const struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a0;
...
- (id)columnUuids;
- (id)commentHostingAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)commentHostingAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 forCommentStorage:(id)a1;
- (id)commentHostingAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 forCommentStorage:(id)a1 updateCommentMaps:(char)a2;
- (double)computeDefaultFontHeightForTableStyleArea:(unsigned long long)a0;
- (void)computeDefaultRowHeight;
- (id)conditionalStyleSetAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (char)confirmRefCountsReturningResult:(id *)a0;
- (void)copyPivotDetailDataFromSourceModel:(id)a0 inSourceRegion:(id)a1 columnMapping:(id)a2 rowMapping:(id)a3;
- (id)createPivotOwner;
- (id)defaultCellStyleForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)defaultCellStyleForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 useSoftDefault:(char)a1 outSource:(out unsigned long long *)a2;
- (id)defaultCellStyleForTableStyleArea:(unsigned long long)a0;
- (void)defaultStyleHandlesAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 useSoftDefault:(char)a1 styleDefaultsCache:(id)a2 outCellStyleHandle:(id *)a3 outTextStyleHandle:(id *)a4;
- (void)defaultStylesForTableStyleArea:(unsigned long long)a0 outCellStyle:(id *)a1 outTextStyle:(id *)a2;
- (id)defaultTextStyleForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)defaultTextStyleForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 useSoftDefault:(char)a1 outSource:(out unsigned long long *)a2;
...
- (id)formatForCalcEngineAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 formatIsExplicitOut:(char *)a1;
- (id)formulaAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)formulaSpecAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (id)formulaSyntaxErrorAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (int)getCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
- (int)getCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 suppressCellBorder:(char)a2;
- (int)getDefaultCell:(out id)a0 forBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
- (int)getDefaultCell:(out id)a0 forTableStyleArea:(unsigned long long)a1;
- (void)getPendingCellCopy:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 suppressCellBorder:(char)a2;
...
- (int)getValue:(id *)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 fetchRichTextAttributesIfPlainText:(char)a2;
- (int)getValue:(id *)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 fetchRichTextAttributesIfPlainText:(char)a2 skipPendingWrites:(char)a3;
- (struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })groupByUID;
- (char)hasCommentAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (char)hasCommentStorageAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (char)hasFormulaAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
- (char)hasFormulas;
- (char)hasImportWarnings;
- (char)hasNamesInHeaders;
- (char)hasPastableFormulas;
- (char)hasUsefulPivotDataInSourceBodyTract:(id)a0;
...
- (double)heightOfRowAtIndex:(struct TSUModelRowIndex { unsigned int x0; })a0 isDefault:(out char *)a1;
...
- (id)initWithContext:(id)a0 fromSourceModel:(id)a1 region:(id)a2 tableInfo:(id)a3 waitForCalcEngine:(char)a4;
- (id)initWithContext:(id)a0 fromSourceModel:(id)a1 region:(id)a2 tableInfo:(id)a3 waitForCalcEngine:(char)a4 formulaCoordSpace:(long long)a5;
...
- (int)insertRowsAtIndex:(struct TSUModelRowIndex { unsigned int x0; })a0 uids:(const void *)a1 metadatas:(id)a2 tableArea:(unsigned long long)a3 unsetFilterHidingAction:(char)a4;
- (int)insertRowsInBaseRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 uids:(const void *)a1 metadata:(id)a2 unsetFilterHidingAction:(char)a3;
- (char)isRegisteredWithCalcEngine:(id)a0;
- (int)linkToCalcEngine:(id)a0 ownerKind:(unsigned short)a1;
- (void)loadAllLazyReferences;
- (void)lockSpilling;
- (void)logTableTileAuditStatus:(char)a0 withVersion:(unsigned long long)a1;
...
- (id)mutableIndexesForUIDs:(const void *)a0 isRows:(char)a1;
...
- (char)p_auditTableHealthUpgradingFromVersion:(unsigned long long)a0;
- (char)p_auditTilesForRowOverlapAndExtensionPastTableBoundsWithVersion:(unsigned long long)a0;
- (void)p_clearDefaultStyles;
- (void)p_createCommentMapsIfNeeded;
- (id)p_displayNameForColumnAtIndex:(unsigned short)a0 documentLocalized:(char)a1 derivation:(out long long *)a2;
- (void)p_iterateDataStoreCellsInRegion:(id)a0 searchFlags:(unsigned long long)a1 usingBlock:(id /* block */)a2;
- (void)p_modifyAllCellsConcurrentlyWithSearchFlags:(unsigned long long)a0 affectsCellBorders:(char)a1 ignoreFormulas:(char)a2 clearImportWarnings:(char)a3 formulaReplacer:(id)a4 modificationBlock:(id /* block */)a5 furtherPassNeededBlock:(id /* block */)a6 furtherPassConcurrentBlock:(id /* block */)a7 preApplyBlock:(id /* block */)a8;
- (void)p_modifyAllCellsConcurrentlyWithSearchFlags:(unsigned long long)a0 affectsCellBorders:(char)a1 ignoreFormulas:(char)a2 clearImportWarnings:(char)a3 formulaReplacer:(id)a4 modificationBlock:(id /* block */)a5 preApplyBlock:(id /* block */)a6;
- (void)p_modifyCellsConcurrentlyInBaseRegion:(id)a0 searchFlags:(unsigned long long)a1 affectsCellBorders:(char)a2 ignoreFormulas:(char)a3 clearImportWarnings:(char)a4 formulaReplacer:(id)a5 modificationBlock:(id /* block */)a6 furtherPassNeededBlock:(id /* block */)a7 furtherPassConcurrentBlock:(id /* block */)a8 preApplyBlock:(id /* block */)a9;
- (void)p_rebuildTheTable;
- (int)p_shouldAllowApplyBaseCellMap:(id)a0;
- (int)p_shouldAllowSetCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
...
- (void)postCommentNotificationForStorage:(id)a0 baseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 notificationKey:(id)a2;
...
- (id)regionForValueOrCommentCellsInBaseCellRect:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0;
- (void)registerAllFormulasWithCalculationEngine:(id)a0 wasCrossDocumentPaste:(char)a1 infoIsCategorized:(char)a2 wasUndo:(char)a3;
- (int)registerWithCalcEngine:(id)a0 ownerKind:(unsigned short)a1;
- (int)registerWithCalcEngine:(id)a0 ownerKind:(unsigned short)a1 linkOnly:(char)a2;
...
- (int)removeCommentStorageAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (void)resetDependenciesForCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (void)resetSpillingRangesInRange:(const struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a0;
...
- (id)rowUuids;
- (int)setCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 ignoreFormula:(char)a2 clearImportWarnings:(char)a3;
- (int)setCell:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 ignoreFormula:(char)a2 clearImportWarnings:(char)a3 calcEngine:(id)a4;
...
- (void)setCellsConcurrently:(id)a0 ignoreFormula:(char)a1 clearImportWarnings:(char)a2 formulaReplacer:(id)a3;
- (int)setCellsWithBaseCellMap:(id)a0 ignoreFormulas:(char)a1 skipDirtyingNonFormulaCells:(char)a2;
- (int)setCommentStorage:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1;
...
- (void)setIsRegisteredWithCalcEngine:(char)a0;
...
- (char)spillArrayValue:(id)a0 primaryCell:(id)a1 withContext:(id)a2 hasWarnings:(char)a3 didBeginOrEndWithTextCell:(char *)a4 propagateCheckboxes:(char)a5;
...
- (id)stringAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 optionalCell:(id)a1;
...
- (unsigned long long)tableAreaForBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0;
...
- (id)tableAreasForBaseCellRect:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0;
...
- (id)textStyleAtModelCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isDefault:(out char *)a1;
- (id)textStyleForCalcEngineAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isDefault:(out char *)a1;
- (id)textStyleForCellWithEmptyStyleAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a0 isDefault:(out char *)a1;
- (id)textStyleOfColumnAtIndex:(struct TSUModelColumnIndex { unsigned short x0; })a0 isDefault:(out char *)a1;
- (id)textStyleOfRowAtIndex:(struct TSUModelRowIndex { unsigned int x0; })a0 isDefault:(out char *)a1;
- (struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })topCornerRange;
- (void)unlockSpilling;
- (void)updateCalcEngineForTableSize;
- (void)updateCalculationEngineForFormula:(id)a0 inBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 usingCalcEngine:(id)a2;
...
- (void)validateTableStylesInSameStylesheetExpectingDocSS:(char)a0;
- (char)verifySubOwnerUIDsUsed;
- (void)willBeAddedCellCleanup:(char)a0;
