...
- (char)p_validateComponent:(id)a0 error:(id *)a1;
- (char)p_validateData:(id)a0 timing:(long long)a1 documentMetadata:(id)a2 scanForOSLikeCorruption:(char)a3 error:(id *)a4;
...
- (char)readComponentIfNeededAsync:(id)a0;
- (void)readExternalReferenceComponentIfNeededAsyncForObjectIdentifier:(long long)a0 componentIdentifier:(long long)a1 isWeak:(char)a2 fromComponent:(id)a3;
