...
- (void)p_drawLinePathsIntoContext:(struct CGContext { } *)a0 linePath:(struct CGPath { } *)a1 tailPath:(struct CGPath { } *)a2 headPath:(struct CGPath { } *)a3 fillTail:(char)a4 fillHead:(char)a5 stroke:(id)a6;
...
- (char)p_shouldRenderSeriesIndex:(unsigned long long)a0;
