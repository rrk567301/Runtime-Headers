...
@property (readonly, nonatomic) struct TSCEFunctor { TSCEFormulaObject *_formula; unsigned int _numArgs; unsigned int _firstSymbol; } groupingFunctor;
...
+ (char)groupingTypeIsAnyDateType:(long long)a0;
