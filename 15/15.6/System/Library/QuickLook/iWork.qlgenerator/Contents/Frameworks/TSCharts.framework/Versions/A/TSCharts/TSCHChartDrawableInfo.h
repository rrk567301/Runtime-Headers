...
- (char)isEquivalentForSerializationRoundTrip:(id)a0;
...
- (void)p_setDrawableGeometry:(id)a0 clearObjectPlaceholderFlag:(char)a1;
- (void)setGeometry:(id)a0 omitLegendResize:(char)a1;
