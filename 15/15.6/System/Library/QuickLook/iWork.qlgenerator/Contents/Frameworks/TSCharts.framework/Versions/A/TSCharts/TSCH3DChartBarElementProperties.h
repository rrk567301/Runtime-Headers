...
- (struct BarElementInfo { char x0; float x1; char x2; unsigned long long x3; })barElementInfoAtIndex:(void *)a0;
- (id)boundsGeometryForSeries:(id)a0 index:(void *)a1;
- (id)calculateInterceptForSeries:(id)a0;
- (float)chartInitialDepthOffset;
- (struct BarElementInfo { char x0; float x1; char x2; unsigned long long x3; } *)elementInfoAtIndex:(void *)a0;
...
- (void)setElementInfo:(const struct BarElementInfo { char x0; float x1; char x2; unsigned long long x3; } *)a0 atIndex:(void *)a1;
