...
- (void)dealloc;
- (id)description;
- (id)initWithAttachment:(unsigned int)a0 indexOnAttachment:(long long)a1 textureName:(unsigned int)a2 textureSize:(struct CGSize { double x0; double x1; })a3 name:(id)a4 target:(unsigned int)a5 valid:(char)a6;
