...
@property (readonly, nonatomic) struct TSUViewCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; } viewCellCoord;
@property (readonly, nonatomic) struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; } baseCellCoord;
@property (copy, nonatomic) TSDCommentStorage *storage;
@property (readonly, nonatomic) char isHighlight;
...
- (id)initWithStorage:(id)a0 forTableInfo:(id)a1 baseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a2;
