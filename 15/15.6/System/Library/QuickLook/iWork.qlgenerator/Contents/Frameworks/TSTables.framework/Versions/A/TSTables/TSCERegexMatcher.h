...
+ (id)regexMatcherWithRegexString:(id)a0 caseSensitive:(char)a1 entireMatch:(char)a2 outError:(id *)a3;
+ (id)regexMatcherWithStringMatch:(id)a0 caseSensitive:(char)a1 entireMatch:(char)a2 outError:(id *)a3;
+ (id)regexMatcherWithRegexString:(id)a0 caseSensitive:(char)a1 outError:(id *)a2;
...
- (char)containsMatchInString:(id)a0;
- (id)initWithRegexString:(id)a0 caseSensitive:(char)a1 entireMatch:(char)a2 outError:(id *)a3;
- (id)initWithString:(id)a0 caseSensitive:(char)a1 entireMatch:(char)a2 outError:(id *)a3;
