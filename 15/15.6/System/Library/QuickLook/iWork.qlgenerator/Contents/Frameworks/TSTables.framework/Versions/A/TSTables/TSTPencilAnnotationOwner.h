...
- (id)_indexesForRange:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0 startingOnly:(char)a1;
- (id)_indexesForRows:(id)a0;
- (id)_indexesIntersectingButNotContainingBaseCellRegion:(id)a0;
- (unsigned long long)addAnnotation:(id)a0 withAnchorRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a1;
...
- (id)annotationsStartingInRange:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })cellRangeForAnnotation:(id)a0;
- (void)enumerateAnnotationsAndFormulasContainedInRegion:(id)a0 withBlock:(id /* block */)a1;
- (void)enumerateAnnotationsAndFormulasInRange:(struct TSUModelCellRect { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; })a0 withBlock:(id /* block */)a1;
