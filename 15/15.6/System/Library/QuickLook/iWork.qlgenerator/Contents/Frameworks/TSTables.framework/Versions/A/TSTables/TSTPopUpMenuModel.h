...
+ (id)popupMenuModelFromTable:(id)a0 region:(id)a1 initialValue:(char *)a2 overflow:(char *)a3;
...
- (char)booleanAtIndex:(unsigned long long)a0;
...
- (char)isEqualToChoices:(id)a0;
- (char)p_booleanForListItem:(id)a0;
...
- (id)popUpItemFromBoolean:(char)a0;
- (unsigned long long)tst_dataObjectHash;
- (char)tst_dataObjectIsEqual:(id)a0;
