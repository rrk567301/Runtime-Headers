...
- (struct TextureAttributes { int x0; int x1; char x2; char x3; char x4; struct TextureSizeHint { int x0; struct tvec2<int> { union { int x0; int x1; int x2; } x0; union { int x0; int x1; int x2; } x1; } x1; } x5; char x6; })textureAttributesForVariable:(id)a0;
- (id)textureFunctionNameForVariable:(id)a0 projective:(char)a1;
- (id)textureVariables;
