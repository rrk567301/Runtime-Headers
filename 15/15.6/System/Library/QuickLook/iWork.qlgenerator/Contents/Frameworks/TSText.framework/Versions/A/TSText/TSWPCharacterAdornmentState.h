...
@property (nonatomic) char hasValidFillState;
...
@property (nonatomic) char fillsCurrentTextContainer;
@property (retain, nonatomic) NSMutableSet *currentDropCapAdornments;
@property (nonatomic) char hasValidStrokeState;
...
- (void)setStateWithFill:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 paths:(id)a3 rubyPaths:(id)a4 shadow:(id)a5 fillsCurrentTextContainer:(char)a6;
