...
+ (id)createFromGridValue:(id)a0 functionSpec:(id)a1 argumentIndex:(int)a2 evaluationContext:(id)a3 ignoreError:(char)a4 ignoreDuplicates:(char)a5 outError:(id *)a6;
