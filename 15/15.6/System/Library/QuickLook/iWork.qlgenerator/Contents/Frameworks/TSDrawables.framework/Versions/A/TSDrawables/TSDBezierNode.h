...
- (void)setInControlPoint:(struct CGPoint { double x0; double x1; })a0 reflect:(int)a1 constrain:(char)a2;
- (void)setInControlPointFromReflection:(struct CGPoint { double x0; double x1; })a0 constrain:(char)a1;
- (void)setOutControlPoint:(struct CGPoint { double x0; double x1; })a0 reflect:(int)a1 constrain:(char)a2;
- (void)swapControlPoints;
- (char)underPoint:(struct CGPoint { double x0; double x1; })a0 withTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 andTolerance:(double)a2 returningType:(long long *)a3;
