...
- (struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; })backProjectCameraSpacePoint:(void *)a0;
...
- (id)narrowedByViewport:(void *)a0 samples:(long long)a1;
- (id)pixelAlignedForScaledViewport:(void *)a0 viewportScale:(float)a1 samples:(float)a2 correspondingNoramlizedBounds:(void *)a3;
...
- (void)setContainingViewportSize:(void *)a0;
