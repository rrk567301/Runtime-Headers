...
- (void)addConclusion:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addDeclaration:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addOutcome:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addResolution:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addStatement:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addTemporary:(id)a0 space:(id)a1 type:(struct TSCH3DShaderType { unsigned long long x0; })a2 format:(id)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
...
- (void)addToSection:(id)a0 variable:(id)a1 space:(id)a2 type:(struct TSCH3DShaderType { unsigned long long x0; })a3 format:(id)a4 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a5;
...
- (id)linkedUniformVariablesForType:(struct TSCH3DShaderType { unsigned long long x0; })a0 isTexture:(char)a1;
...
- (struct pair<signed char, TSCH3DShaderVariableLinkage *> { char x0; id x1; })resultLinkageOfVariable:(id)a0;
