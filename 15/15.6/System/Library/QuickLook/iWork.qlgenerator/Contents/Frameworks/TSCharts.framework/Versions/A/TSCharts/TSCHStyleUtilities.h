...
+ (id)nullFill;
+ (id)defaultShadow;
+ (char)allSeriesInList:(id)a0 haveExplosionValue:(double)a1;
+ (id)availableStrokes;
...
+ (void)breakUpFontName:(id)a0 isBold:(char *)a1 isItalic:(char *)a2;
...
+ (char)groupedShadowsForChartModel:(id)a0;
+ (char)hasNoFill:(id)a0;
+ (char)hasShadow:(id)a0;
+ (char)isNullFill:(id)a0;
+ (char)labelExplosionIsCenteredInWedgeWithInnerRadius:(double)a0 labelExplosion:(double)a1;
...
+ (char)shouldAnchorLabelsForSeries:(id)a0 innerRadius:(double)a1 calloutLineType:(long long)a2 defaultLabelExplosion:(double)a3;
+ (char)shouldExteriorBorderButtonBeAdded:(id)a0;
+ (char)shouldExteriorBorderButtonBeDisabled:(id)a0;
+ (id)stylesheetOfStyles:(id)a0 nilAllowed:(char)a1;
...
+ (id)uiStringForLabelFormatType:(int)a0 useShortString:(char)a1;
...
+ (char)upgradeShadowProperties:(id)a0 inMap:(id)a1;
+ (id)upgradedShadowPropertyForParagraphStyle:(id)a0;
+ (char)upgradedShadowPropertyFromShadow:(id)a0 outUpgraded:(id *)a1;
+ (char)useOutsideParagraphStyleIndexForSeries:(id)a0 chartType:(id)a1 layout:(id)a2;
