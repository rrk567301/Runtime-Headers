...
@interface TSTTableInfo : TSDDrawableInfo <TSDReplaceableMediaContainer, TSDReducibleImageContainer, TSDCompatibilityAwareMediaContainer, TSDSelectableHintMediaContainer, TSSPropertySource, TSCECalculationEngineRegistration, TSDContainerInfo, TSDMixing, TSKModel, TSKSearchable, TSSPresetSource, TSSStyleClient, TSCEColumnRowUIDMapping, TSTCompatibilityVersionProviding, TSTCustomStrokeProviding, TSTStyleProviding, TSTTableHiddenRowColumnProviding, TSTAdditionalHiddenRowColumnProviding, TSTTableInternalGeometryProviding, TSTTableMergeRangeProviding, TSTTableStrokeProviding, TSWPStorageParent, TSWPTextStatisticsTrackerProvider, TSKAnnotationParent> {
    ...
    char _needsFilterSetUpdated;
    char _resetGroupingsOnUpgrade;
}
...
@property (nonatomic) char migratingStylesOnly;
@property (retain, nonatomic) TSCEMutableUIDSet *rowUIDsForImportedGroupingRows;
@property (nonatomic) char documentIsClosing;
...
@property (readonly, nonatomic, getter=isCategorized) char categorized;
@property (readonly, nonatomic) char hasCategoryRules;
...
@property (readonly, nonatomic) char isAPivotTable;
@property (readonly, nonatomic) char isEmptyPivot;
...
@property (readonly, nonatomic) char isGroupedForRows;
@property (readonly, nonatomic) char isGroupedForColumns;
...
@property (readonly, nonatomic) char hasMigratableStylesInCells;
...
@property (readonly, nonatomic) char pivotTableCanBeRefreshed;
@property (readonly, nonatomic) char pivotSourceIsRangeBased;
...
@property (nonatomic) char presetNeedsStrongOwnership;
...
@property (readonly, nonatomic, getter=isNewlyImported) char newlyImported;
@property (readonly, nonatomic) char hasImportWarnings;
@property (readonly, nonatomic) char isValidForInteraction;
...
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } range;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } bodyRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } bodyColumnRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } bodyRowRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } filteringRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } filteringBodyRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } filteringBodyRowRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } headerRowRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } footerRowRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } headerColumnRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } actualHeaderColumnRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } topCornerRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } bottomCornerRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } categoryColumnRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } baseColumnRange;
@property (readonly, nonatomic) struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } filteringBaseColumnRange;
@property (readonly, nonatomic) char wasRemovedFromDocument;
...
@property (readonly, nonatomic) char hasHeaderColumnForAggregateNames;
@property (readonly, nonatomic) char hasHeaderRowForAggregateNames;
...
+ (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })cellRangeForTableArea:(unsigned long long)a0 givenTableSize:(struct { unsigned int x0; unsigned int x1; })a1 numberOfHeaderRows:(unsigned int)a2 numberOfFooterRows:(unsigned int)a3 numberOfHeaderColumns:(unsigned int)a4;
...
+ (unsigned long long)tableAreaForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 inTableWithHeaderColumns:(unsigned int)a1 headerRows:(unsigned int)a2 footerRows:(unsigned int)a3 totalRows:(unsigned int)a4;
...
+ (id)pivotDetailTableNameFromSourcePivotTableInfo:(id)a0 pivotSourceCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
+ (id)tablePrototypeWithIndex:(long long)a0 context:(id)a1 geometry:(id)a2 stylePreset:(id)a3 forTableInsertOnly:(char)a4;
+ (unsigned long long)tableStyleAreaForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 inTableWithHeaderColumns:(unsigned int)a1 headerRows:(unsigned int)a2 footerRows:(unsigned int)a3 totalRows:(unsigned int)a4;
+ (void)upgradeSubOwnerUidForMapperOnCalcEngine:(id)a0;
+ (char)validateNewName:(id)a0 forTable:(id)a1;
...
- (id)cellAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })cellRangeForTableArea:(unsigned long long)a0;
- (id)cellRegionWithConditionalStyleMatchingCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })minPopulatedCellRange;
...
- (void)setDrawableIsBeingCopied:(char)a0;
...
- (void)chooseUniqueNameInContainer:(id)a0 forPaste:(char)a1 needsNewName:(char)a2 avoidNames:(id)a3;
- (id)infoForSelectionPath:(id)a0;
- (char)isEquivalentForCrossDocumentPasteMasterComparison:(id)a0 objectComparisonBlock:(id /* block */)a1;
...
- (char)findChartableRangesFromTableRange:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })a0 getBodyRange:(out struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } *)a1 headerColumnRange:(out struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } *)a2 headerRowRange:(out struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; } *)a3;
- (id)formulaOwner;
- (char)hasCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (int)setCellsWithCellMap:(id)a0 ignoreFormulas:(char)a1 skipDirtyingNonFormulaCells:(char)a2;
...
- (struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })cellUIDForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)hasDeferredImportActions;
...
- (char)mergeCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (double)widthOfColumnAtIndex:(unsigned short)a0 isDefault:(out char *)a1;
- (id)allRowGroupUIDs;
- (id)cellRangeName:(struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x1; })a0 usedSymbolicName:(out char *)a1;
...
- (id)newCell;
- (void)p_setFormulaWithSymbolCellCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 andAttributeCellCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
...
- (void)_correctAndCheckStateSuppressingAssertions:(char)a0;
- (id)_initWithContext:(id)a0 flatteningFromComplexInfo:(id)a1 cellRegion:(id)a2 waitForCalcEngine:(char)a3 flatteningOptions:(long long)a4 isSnapshot:(char)a5;
- (id)_initWithContext:(id)a0 fromSourceInfo:(id)a1 cellRegion:(id)a2 tableModel:(id)a3 waitForCalcEngine:(char)a4 formulaCoordSpace:(long long)a5;
...
- (id)applyConcurrentCellMapToBaseTable:(id)a0 options:(unsigned long long)a1 requestInverseMap:(char)a2 requestPruneMap:(char)a3 stylesContainer:(id)a4 migrationHelper:(id)a5;
...
- (void)applyWritingDirection:(int)a0 toCell:(id)a1 cellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
- (void)assertCollaborationConvergence;
- (void)bakeFormulas;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })bodyRangeForLowestLevelGroupEnclosingCellAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)canTranspose;
...
- (char)cellExistsAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDAboveCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDBelowCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDForCellContainingRichTextStorage:(id)a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDForCellUID:(struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a0;
- (char)cellIDIsLegal:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDLeftOfCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })cellIDRightOfCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (id)cellIteratorWithRegion:(id)a0 flags:(unsigned long long)a1 searchFlags:(unsigned long long)a2 clampingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a3;
- (id)cellMapForRegion:(id)a0 uidBased:(char)a1 suppressMergeContent:(char)a2 useCategoriesWildcards:(char)a3;
...
- (id)cellRegionFromCellUIDList:(id)a0 includeLabelsWithSummaries:(char)a1 didAddLabels:(char *)a2;
- (id)cellRegionFromCellUIDLookupList:(id)a0;
- (id)cellRegionFromCellUIDLookupList:(id)a0 includeLabelsWithSummaries:(char)a1 didAddLabels:(char *)a2;
- (id)cellRegionFromCellUIDRegion:(id)a0;
- (id)cellStyleAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 isDefault:(out char *)a1;
- (id)cellStyleAtCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 isDefault:(out char *)a1;
- (id)cellStyleOfColumnAtIndex:(unsigned short)a0 isDefault:(out char *)a1;
- (id)cellStyleOfRowAtIndex:(unsigned int)a0 isDefault:(out char *)a1;
- (id)cellTractRefForUIDRectRef:(id)a0;
- (struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })cellUIDForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 useCategoriesWildcards:(char)a1;
- (id)cellUIDListFromCellRegion:(id)a0;
- (id)cellUIDListFromCellRegion:(id)a0 useCategoriesWildcards:(char)a1;
...
- (id)cellValueFromCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (unsigned char)cellValueTypeAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (id)cellValueViewStringAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 optionalCell:(id)a1;
- (id)changeDescriptorsForReorganizingFromRowUids:(const void *)a0 toRowUids:(const void *)a1;
- (id)characterFillAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 optionalCell:(id)a1;
- (char)checkStateForArchiving:(char)a0;
- (void)chooseUniqueNameInContainer:(id)a0 forPaste:(char)a1;
- (void)chooseUniqueNameInContainer:(id)a0 forPaste:(char)a1 needsNewName:(char)a2;
- (id)chromeLabelForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (id)columnNameForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 restrictToBodyRange:(char)a1;
...
- (id)commentHostingAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (id)commentHostingAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 forCommentStorage:(id)a1;
- (id)commentHostingAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 forCommentStorage:(id)a1 updateCommentMaps:(char)a2;
...
- (id)concurrentCellMapForRegion:(id)a0 suppressMergeContent:(char)a1 gatherCellBorders:(char)a2;
- (id)conditionalStyleSetAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (void)convertCellUIDLookupList:(id)a0 toCellRangeVector:(void *)a1 prunedSummaryCellUIDs:(void *)a2;
- (void)convertFormulasToUidForm:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 preserveHostCell:(char)a2;
- (id)createDetailTableForPivotTableCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (id)defaultCellStyleForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (id)defaultCellStyleForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 useSoftDefault:(char)a1 outSource:(out unsigned long long *)a2;
- (id)defaultCellStyleForTableStyleArea:(unsigned long long)a0;
- (void)defaultStyleHandlesForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 useSoftDefault:(char)a1 styleDefaultsCache:(id)a2 outCellStyleHandle:(id *)a3 outTextStyleHandle:(id *)a4;
- (id)defaultTextStyleForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (id)defaultTextStyleForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 useSoftDefault:(char)a1 outSource:(out unsigned long long *)a2;
...
- (void)flattenGroupValuesIfNeededForCell:(id)a0 viewCellCoord:(struct TSUViewCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; })a1 summaryAndLabelRows:(id)a2 categoryColumns:(id)a3;
- (id)formulaAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (id)geometryForRTLTableWithGeometry:(id)a0;
- (int)getCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (int)getCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 holdingReadLockWithAccessController:(id)a2;
- (int)getCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 suppressCellBorder:(char)a2;
...
- (int)getCell:(id)a0 atCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 suppressCellBorder:(char)a2;
- (int)getDefaultCell:(out id)a0 forCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
- (void)getTextPropertiesWithCell:(id)a0 cellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 wraps:(char *)a2 alignment:(int *)a3 verticalAlignment:(int *)a4 padding:(id *)a5;
...
- (int)getValue:(id *)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 fetchRichTextAttributesIfPlainText:(char)a2;
...
- (char)groupingTypesAreUniqueForColumn:(unsigned short)a0;
- (void)handlePivotSorting:(char)a0;
- (char)hasActiveFilters;
- (char)hasCommentAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)hasFilterRulesAffectingInsertRows;
- (char)hasFilterRulesInBaseColumns:(id)a0;
- (char)hasFormulaAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)hasFormulaAtCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0;
- (char)hasFormulas;
- (char)hasGroupingArrowAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)hasGroupingArrowInCellRegion:(id)a0;
- (char)hasHiddenColumnAtIndex:(unsigned short)a0;
- (char)hasHiddenColumnAtIndex:(unsigned short)a0 forAction:(unsigned char)a1;
- (char)hasHiddenColumnsOrRows;
- (char)hasHiddenRowAtIndex:(unsigned int)a0;
- (char)hasHiddenRowAtIndex:(unsigned int)a0 forAction:(unsigned char)a1;
- (char)hasMergeFragmentAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)hasMergeRangeSpanningRowsForCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)hasMergeRangesIntersectingCellRegion:(id)a0;
...
- (char)hasSpillRangesIntersectingCellRegion:(id)a0;
- (char)hasSpillingErrors;
- (char)hasSummaryRowsInRegion:(id)a0;
- (char)hasUntitledTableNameFormat;
- (char)hasUsefulPivotSourceCellsInBodyRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (double)heightOfRowAtIndex:(unsigned int)a0 isDefault:(out char *)a1;
...
- (id)initAsDetailTableWithContext:(id)a0 sourcePivotTableInfo:(id)a1 pivotSourceCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
- (id)initPivotTableWithContext:(id)a0 sourceTableInfo:(id)a1;
- (id)initPivotTableWithContext:(id)a0 sourceTableInfo:(id)a1 sourceBodyRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a2 sourceHeaderRowRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
- (id)initPivotTableWithContext:(id)a0 sourceTableInfo:(id)a1 sourceBodyRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a2 sourceHeaderRowRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 optionalDataModel:(id)a4;
- (id)initWithContext:(id)a0 fromSourceInfo:(id)a1 cellRegion:(id)a2 waitForCalcEngine:(char)a3 flattenCategories:(long long)a4 isSnapshot:(char)a5;
...
- (void)insertColumnsAtIndex:(unsigned short)a0 count:(unsigned int)a1 addBefore:(char)a2;
- (int)insertColumnsAtIndex:(unsigned short)a0 uids:(const void *)a1 metadatas:(id)a2 tableArea:(unsigned long long)a3;
- (void)insertRowsAtIndex:(unsigned int)a0 count:(unsigned int)a1 addBefore:(char)a2;
- (int)insertRowsAtIndex:(unsigned int)a0 uids:(const void *)a1 metadatas:(id)a2 tableArea:(unsigned long long)a3;
- (int)insertRowsAtIndex:(unsigned int)a0 uids:(const void *)a1 metadatas:(id)a2 tableArea:(unsigned long long)a3 unsetFilterHidingAction:(char)a4;
- (char)isCategoryAnyKindOfCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (char)isCategoryGroupingColumn:(unsigned short)a0;
- (char)isCategoryLabelCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)isCellRangeHidden:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)isGroupCollapsedAndVisible:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0 dimension:(long long)a1;
- (char)isGroupOrParentsCollapsed:(struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; })a0 dimension:(long long)a1;
- (char)isGroupingColumnCollapsed:(unsigned short)a0;
- (char)isGroupingColumnCollapsedAndVisible:(unsigned short)a0;
- (char)isGroupingRowCollapsed:(unsigned int)a0;
- (char)isGroupingRowCollapsedAndVisible:(unsigned int)a0;
- (char)isLabelRow:(unsigned int)a0;
- (char)isPivotAnyKindOfCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)isPivotGrandTotalColumn:(unsigned short)a0;
- (char)isPivotGrandTotalRow:(unsigned int)a0;
- (char)isPivotLeadingColumn:(unsigned short)a0;
- (char)isPivotLeadingRow:(unsigned int)a0;
- (char)isPivotTrailingAligned:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)isPivotUnwrapped:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)isRegisteredWithCalcEngine:(id)a0;
- (char)isSafeToConvertToImageForImagePaste;
- (char)isSingleCellOrMergeRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)isSummaryCell:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (char)isSummaryColumn:(unsigned short)a0;
- (char)isSummaryOrLabelRow:(unsigned int)a0;
- (char)isValidMergeRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (void)iterateCellsInRegion:(id)a0 flags:(unsigned long long)a1 searchFlags:(unsigned long long)a2 clampingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a3 usingBlock:(id /* block */)a4;
- (Class)iteratorClass;
- (double)labelRowHeightAtCategoryLevel:(unsigned char)a0;
- (id)labelValueViewStringAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 optionalCell:(id)a1;
...
- (id)mergeActionForRegion:(id)a0 nonOriginPartialsOnly:(char)a1;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })mergeOriginForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })mergeRangeAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
- (struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; struct TSUCellRect *x1; struct __compressed_pair<TSUCellRect *, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; } x2; })mergeRangesAndCrumbsIntersectingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; struct TSUCellRect *x1; struct __compressed_pair<TSUCellRect *, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; } x2; })mergeRangesIntersectingRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)mergeRangesPartiallyIntersectCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (char)mergeRangesPartiallyIntersectCellRegion:(id)a0;
...
- (void)modifiedTextPropertiesForCategoryOrPivotCellAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 wraps:(char *)a1 padding:(id *)a2 alignment:(int *)a3;
...
- (id)p_layoutEngineCreateIfNeeded:(char)a0;
...
- (void)p_postCommentNotificationFromDiff:(id)a0 inverseDiff:(id)a1 cellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a2;
- (void)p_setFillOnCell:(id)a0 positive:(char)a1;
- (void)p_setFormula:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (void)p_setFormulaWithSymbolString:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
- (void)performReadForOneOffFormulaEvaluation:(id)a0 forCellCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
...
- (void)postCommentNotificationForStorage:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1 notificationKey:(id)a2;
- (void)prepareForPasteWithSourceOffset:(struct TSUColumnRowOffset { int x0; int x1; })a0 bakeFormulas:(char)a1;
...
- (id)regionForValueOrCommentCellsInRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
- (id)regionSubtractingCategoryColumnsAndRows:(id)a0;
- (void)registerAllFormulasWithCalculationEngine:(id)a0 wasCrossDocumentPaste:(char)a1 wasUndo:(char)a2;
- (int)registerWithCalcEngine:(id)a0;
- (void)releaseLayoutEngine;
- (void)remapTableUIDsInFormulasWithMap:(const void *)a0 calcEngine:(id)a1 bakeForBadRefs:(char)a2;
...
- (id)rowNameForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 restrictToBodyRange:(char)a1;
...
- (int)setCell:(id)a0 atCellCoord:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a1;
- (int)setCell:(id)a0 atCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 ignoreFormula:(char)a2 clearImportWarnings:(char)a3;
- (int)setCell:(id)a0 atCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a1 ignoreFormula:(char)a2 clearImportWarnings:(char)a3 formulaReplacer:(id)a4;
...
- (void)setFormulaOwnerUIDsWithMap:(id)a0 shouldStealReferences:(char)a1;
- (void)setHeight:(double)a0 ofRowAtIndex:(unsigned int)a1;
- (void)setIsCategoryEnabled:(char)a0;
- (void)setLabelRowHeight:(double)a0 atCategoryLevel:(unsigned char)a1;
- (void)setNeedsFilterFormulaRewriteForImport:(char)a0;
...
- (void)setupTableModelForPrototypeIndex:(long long)a0 forTableInsertOnly:(char)a1;
- (char)shouldDisplaySummaryLabelRowAtGroupLevel:(unsigned char)a0;
...
- (id)stringAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 optionalCell:(id)a1;
- (id)strokeExporterReturningDefaultStrokes:(char)a0;
...
- (char)supportsRichTextUndoAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0;
...
- (id)tableAreasForCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (id)textStyleAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; })a0 isDefault:(out char *)a1;
- (id)textStyleAtCellUID:(const struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 isDefault:(out char *)a1;
- (id)textStyleForCellWithEmptyStyleAtCellUID:(struct TSKUIDStructCoord { struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })a0 isDefault:(out char *)a1;
- (id)textStyleOfColumnAtIndex:(unsigned short)a0 isDefault:(out char *)a1;
- (id)textStyleOfRowAtIndex:(unsigned int)a0 isDefault:(out char *)a1;
- (char)unmergeCellRange:(struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; char x2; char x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; })a0;
...
- (char)verifyPivotTableConnections;
- (char)verifySubOwnerUIDsUsed;
- (void)willMakeGroupingChangesInRowUIDs:(id)a0;
- (char)writeCellIDsInCellUIDList:(id)a0 toVector:(void *)a1 prunedCellUIDs:(void *)a2;
