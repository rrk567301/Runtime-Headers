...
@property (readonly, nonatomic) char isContactShadow;
@property (readonly, nonatomic) char isDropShadow;
@property (readonly, nonatomic) char isCurvedShadow;
@property (readonly, nonatomic) NSString *typeDescription;
@property (readonly, nonatomic) char showForEditingText;
...
+ (id)shadowWithAngle:(double)a0 offset:(double)a1 radius:(double)a2 opacity:(double)a3 color:(id)a4 enabled:(char)a5;
...
+ (id)contactShadowWithAngle:(double)a0 offset:(double)a1 radius:(double)a2 height:(double)a3 opacity:(double)a4 color:(id)a5 enabled:(char)a6;
+ (id)curvedShadowWithOffset:(double)a0 angle:(double)a1 radius:(double)a2 curve:(double)a3 opacity:(double)a4 color:(id)a5 enabled:(char)a6;
+ (id)defaultDisabledShadow;
+ (id)defaultShadow;
+ (id)keyPathsForValuesAffectingTSUColor;
+ (id)mixableObjectClasses;
+ (id)p_defaultShadowEnabled:(char)a0;
...
- (void)applyToContext:(struct CGContext { } *)a0 viewScale:(double)a1 flipped:(char)a2;
- (void)applyToContext:(struct CGContext { } *)a0 viewScale:(double)a1 flipped:(char)a2 extraOffset:(struct CGSize { double x0; double x1; })a3;
...
- (struct CGImage { } *)newShadowImageForRep:(id)a0 withSize:(struct CGSize { double x0; double x1; })a1 drawSelector:(SEL)a2 unflipped:(char)a3;
...
- (id)i_initWithOpacity:(double)a0 color:(id)a1 angle:(double)a2 offset:(double)a3 radius:(double)a4 enabled:(char)a5;
- (void)i_setAngle:(double)a0;
- (void)i_setColor:(id)a0;
- (void)i_setEnabled:(char)a0;
