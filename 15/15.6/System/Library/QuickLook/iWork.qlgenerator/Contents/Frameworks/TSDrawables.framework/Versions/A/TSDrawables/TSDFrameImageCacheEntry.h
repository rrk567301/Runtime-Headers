...
- (void)dealloc;
- (struct CGImage { } *)newImageForCALayer:(char)a0 mask:(char)a1;
- (void)setImage:(struct CGImage { } *)a0 forCALayer:(char)a1 mask:(char)a2;
- (id)initWithFrame:(id)a0 size:(struct CGSize { double x0; double x1; })a1 viewScale:(double)a2;
- (int)p_cacheIndexForCALayer:(char)a0 mask:(char)a1;
