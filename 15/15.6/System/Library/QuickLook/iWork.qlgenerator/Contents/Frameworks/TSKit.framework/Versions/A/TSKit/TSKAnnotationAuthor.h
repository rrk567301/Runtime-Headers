...
@property (nonatomic) char isPublicAuthor;
...
+ (id)authorNameExplanatoryStringWithUseExplanation:(char)a0 withSettingsExplanation:(char)a1;
...
- (id)initWithContext:(id)a0 name:(id)a1 color:(id)a2 publicIDs:(id)a3 isPublicAuthor:(char)a4;
- (char)isPreferredOver:(id)a0;
