...
@property struct { char forceOmitLegend; char forceOmitTitle; char forceOmitAxisTitle; char forceOmitLabelPlacement; char forceTitleAtTop; char forceLegendAtBottom; char enable3DTightBounds; char enable3DScaledDepthBounds; long long maxDepthRatioType; unsigned long long max3DLimitingSeries; } layoutSettings;
...
- (void)setForceLegendAtBottom:(char)a0;
- (void)setForceOmitLabelPlacement:(char)a0;
- (void)setForceOmitLegend:(char)a0;
- (void)setForceTitleAtTop:(char)a0;
