...
+ (id)infoGeometryForTransformInRoot:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 isChildFlipped:(char)a1;
+ (id)infoGeometryInRootIncludingCounterRotateIfNeededForDrawable:(id)a0;
+ (id)p_infoGeometryForCounterTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 isChildFlipped:(char)a1;
