...
@interface TSTArchivedCellSelection : TSPObject <TSKArchivedSelection> {
    ...
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _legacyAnchorCellID;
    struct TSUCellCoord { unsigned int row; unsigned short column; char _preserveRow; char _preserveColumn; } _legacyCursorCellID;
