...
@property (readonly, nonatomic) char isDefaultsOnly;
@property (readonly, nonatomic) char isEligibleForDefaultsOnlyReplacement;
...
- (char)hasSpillStrokeInRange:(struct TSTSimpleRange { long long x0; unsigned long long x1; })a0;
...
- (char)replaceCustomStrokeLayerWith:(id)a0;
- (char)replaceDefaultStrokeLayerWith:(id)a0;
