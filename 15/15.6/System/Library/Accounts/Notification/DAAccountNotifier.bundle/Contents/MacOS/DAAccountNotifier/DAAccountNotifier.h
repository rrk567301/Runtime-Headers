...
@property (readonly, nonatomic) char shouldProcessAccountChanges;
...
+ (char)_daAccountChangeType:(unsigned long long *)a0 forACAccountChangeType:(int)a1;
+ (id)_dataclassesWeCareAbout;
+ (char)_isStore:(id)a0 fromClient:(id)a1;
+ (char)_isStoreFromCalaccessd:(id)a0;
+ (char)_isStoreFromCalendarMigrationTool:(id)a0;
+ (char)_isStoreFromDataAccess:(id)a0;
+ (char)_isStoreFromRemindd:(id)a0;
...
- (char)_shouldRefreshForChangeOfType:(int)a0 forAccount:(id)a1 oldAccount:(id)a2;
