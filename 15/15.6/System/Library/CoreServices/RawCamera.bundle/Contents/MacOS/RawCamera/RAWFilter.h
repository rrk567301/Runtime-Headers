...
- (id)apply:(id)a0 image:(id)a1 arguments:(id)a2 inoutSpace:(struct CGColorSpace { } *)a3 isPremultiplied:(char)a4;
...
- (id)apply:(id)a0 image:(id)a1 extent:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 roiCallback:(id /* block */)a3 arguments:(id)a4 inoutSpace:(struct CGColorSpace { } *)a5 isAlphaOne:(char)a6;
- (id)apply:(id)a0 image:(id)a1 arguments:(id)a2 inoutSpace:(struct CGColorSpace { } *)a3 isPremultiplied:(char)a4 isAlphaOne:(char)a5;
