...
- (id)viewDIR:(id)a0 do360:(char)a1 crop:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
...
- (id)viewGDIR:(id)a0 do360:(char)a1 crop:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
...
- (id)viewTGDIR:(id)a0 lothresh:(float)a1 factor:(float)a2 do360:(char)a3 crop:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
