...
- (id)_scaleImage:(id)a0 targetSize:(struct CGSize { double x0; double x1; })a1 device:(id)a2 useBoxFiltering:(char)a3 outputImage:(id)a4 context:(id)a5;
...
- (id)performCrispHairRefinementWithParams:(const struct crisp_hair_params { float x0; float x1; float x2; float x3; float x4; } *)a0 alpha:(id)a1 disparity:(id)a2 tmpImage0:(id)a3 tmpImage1:(id)a4 tmpImage2:(id)a5 editTimeRender:(char)a6 context:(id)a7;
- (id)performDisparityRefinementUsingParams:(const struct disparity_refinement_params { int x0; float x1; float x2; float x3; float x4; int x5; float x6; float x7; float x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; int x20; } *)a0 inputDisparity:(id)a1 inputSegmentation:(id)a2 inputImageLuma:(id)a3 inputImageChroma:(id)a4 inputSlmParams:(id)a5 inputWeightsX:(id)a6 inputWeightsY:(id)a7 inputPreproc:(id)a8 inputSampledD:(id)a9 outputBlurMap:(id)a10 scale:(float)a11 havePerformedMatting:(char)a12 editTimeRender:(char)a13 context:(id)a14 enableFGBlur:(char)a15;
