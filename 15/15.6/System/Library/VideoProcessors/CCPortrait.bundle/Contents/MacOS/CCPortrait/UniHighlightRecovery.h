...
+ (char)runHighlightRecoveryWithInputTexture:(id)a0 outputTexture:(id)a1 temporaryTexture:(id)a2 dynamicParams:(id)a3 iterations:(int)a4 tileSize:(int)a5 scanKernel:(id)a6 diffuseKernel:(id)a7 copyBackKernel:(id)a8 copyKernel:(id)a9 commandBuffer:(id)a10 constants:(id)a11 forCoreImage:(char)a12;
