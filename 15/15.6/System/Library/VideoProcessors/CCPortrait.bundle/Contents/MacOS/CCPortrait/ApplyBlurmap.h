...
- (id)createLocalContrastImage:(id)a0 coreImageRender:(char)a1 morphologicalRadius:(double)a2 inputHalfRes1:(id)a3 inputHalfResRGTex:(id)a4 device:(id)a5 context:(id)a6;
...
- (id)erodeAndDilate:(id)a0 radius:(int)a1 coreImageRender:(char)a2 context:(id)a3 extent:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 pixelFormat:(unsigned long long)a5;
- (char)gainMapNeedsGamma22:(id)a0;
...
- (int)loadShaders;
- (int)setOptions:(const void *)a0 isPrewarm:(char)a1;
- (int)unloadModels;
