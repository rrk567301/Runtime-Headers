...
+ (id)googleTokenForEmailAddress:(id)a0 shouldCreateToken:(char)a1;
...
- (id)init;
- (void).cxx_destruct;
- (char)connection:(id)a0 canAuthenticateAgainstProtectionSpace:(id)a1;
...
- (id)tokenForAccountUID:(id)a0 shouldCreateToken:(char)a1;
- (id)tokenForAccountWithEmailAddress:(id)a0 shouldCreateToken:(char)a1;
