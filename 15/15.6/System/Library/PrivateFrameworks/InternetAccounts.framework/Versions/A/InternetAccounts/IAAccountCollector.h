...
- (void)removeAccountWithUID:(id)a0 deleteFromDataSource:(char)a1 reply:(id /* block */)a2;
- (void)removeAccountWithUID:(id)a0 deleteFromPlugin:(char)a1 reply:(id /* block */)a2;
