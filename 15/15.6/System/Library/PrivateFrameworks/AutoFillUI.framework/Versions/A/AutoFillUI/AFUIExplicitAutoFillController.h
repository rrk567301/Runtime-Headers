...
@property (readonly, nonatomic) char isPopoverPresentedFromVerticalEdge;
@property (nonatomic) char isCreditCardAuthenticationOngoing;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (char)isCreditCardAuthenticationOngoing;
+ (char)isCreditCardViewControllerAuthenticating;
+ (char)isExplicitAutoFillInvocationWithDocumentTraits:(id)a0;
+ (void)setIsCreditCardAuthenticationOngoing:(char)a0;
