...
@property (nonatomic) char useCredentials;
...
@property (nonatomic) char skipLoadingLaunchDaemons;
...
- (char)initializeDeviceAttributes:(id *)a0;
- (char)initializeImageProperties:(id *)a0;
