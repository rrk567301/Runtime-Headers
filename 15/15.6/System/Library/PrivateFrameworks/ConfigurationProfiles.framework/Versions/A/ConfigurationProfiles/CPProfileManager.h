...
- (char)isUserAllowed:(id)a0 profile:(id)a1;
...
- (id)uninstallProfile:(id)a0 forUser:(id)a1 removalPassword:(id)a2 ignoringAuth:(char)a3;
- (id)uninstallProfileByIdentifier:(id)a0 forUser:(id)a1 removalPassword:(id)a2;
- (id)uninstallProfileByIdentifier:(id)a0 forUser:(id)a1 removalPassword:(id)a2 ignoringAuth:(char)a3 authData:(id)a4;
