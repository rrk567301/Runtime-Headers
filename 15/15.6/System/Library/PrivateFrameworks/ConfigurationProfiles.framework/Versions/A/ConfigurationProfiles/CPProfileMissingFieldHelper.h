...
- (void)addMissingField:(id)a0 forKey:(id)a1 isRequired:(char)a2 useSecureEntry:(char)a3;
- (void)addMissingField:(id)a0 forKey:(id)a1 isRequired:(char)a2 useSecureEntry:(char)a3 options:(id)a4;
