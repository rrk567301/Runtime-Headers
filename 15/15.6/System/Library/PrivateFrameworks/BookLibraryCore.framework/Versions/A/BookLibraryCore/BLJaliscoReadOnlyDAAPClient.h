...
- (id)_itemsFetchRequestForDSIDs:(id)a0 excludeStoreIDs:(id)a1 isExplicitRestricted:(char)a2;
- (id)fetchAllServerItemsForDSIDs:(id)a0;
- (id)fetchAllServerItemsWithPredicate:(id)a0 sortDescriptor:(id)a1;
- (id)fetchItemsForDSIDs:(id)a0 excludeStoreIDs:(id)a1 isExplicitRestricted:(char)a2;
...
- (id)p_allItemsFetchRequestForDSIDs:(id)a0 matchingSearchString:(id)a1 isExplicitRestricted:(char)a2;
- (char)p_createPersistentDirectoryIfNeeded;
- (id)p_fetchRequestForStoreIDs:(id)a0 dsids:(id)a1;
- (id)p_itemsFetchRequestIncludingHiddenItems:(char)a0 dsids:(id)a1;
...
- (id)searchAllServerItemsForDSIDs:(id)a0 matchingSearchString:(id)a1 isExplicitRestricted:(char)a2;
