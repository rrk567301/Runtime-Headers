...
+ (id)_dcIdentifierFromOpfPath:(id)a0 isEPUB:(char)a1;
+ (char)_isMultiUser;
...
+ (id)identifierFromBookContainer:(id)a0 allowHash:(char)a1 allowStoreID:(char)a2 error:(id *)a3;
+ (id)identifierFromBookPath:(id)a0 allowHash:(char)a1 allowStoreID:(char)a2 error:(id *)a3;
+ (id)identifierFromBookPath:(id)a0 error:(id *)a1;
+ (id)identifierFromBookZipArchive:(id)a0 allowHash:(char)a1 allowStoreID:(char)a2 error:(id *)a3;
...
+ (char)writeBinaryPropertyList:(id)a0 toPath:(id)a1 error:(id *)a2;
