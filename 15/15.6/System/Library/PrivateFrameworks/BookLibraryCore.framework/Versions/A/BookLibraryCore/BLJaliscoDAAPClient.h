...
@interface BLJaliscoDAAPClient : NSObject <BLPurchaseDAAPServerDelegate, BUAccountsObserving> {
    ...
    char _storeAuthenticationRequired;
...
@property (nonatomic) char isGDPRPrivacyAcknowledgementRequired;
@property (nonatomic) char storeAuthenticationRequired;
@property (readonly, nonatomic, getter=isInitiallyLoadingJalisco) char initiallyLoadingJalisco;
...
- (id)_newPurchaseDAAPServerWithDSID:(id)a0;
...
- (id)_fetchItemsForNeedsImport:(char)a0;
...
- (void)_sendCompletionHandlersWithSuccess:(char)a0 generation:(unsigned long long)a1;
...
- (id)predicateForBookletItems:(char)a0;
- (id)predicateForItems:(char)a0;
