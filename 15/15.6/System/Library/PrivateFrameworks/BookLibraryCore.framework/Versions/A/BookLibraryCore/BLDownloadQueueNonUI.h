...
- (void)_addDownloadWithMetadata:(id)a0 isRestore:(char)a1 completion:(id /* block */)a2;
...
- (void)purchaseWithBuyParameters:(id)a0 storeID:(id)a1 isAudiobook:(char)a2 completion:(id /* block */)a3;
- (void)purchaseWithBuyParameters:(id)a0 storeID:(id)a1 isAudiobook:(char)a2 userInfo:(id)a3 completion:(id /* block */)a4;
