...
- (id)_downloadStatusFromDictionary:(id)a0 outParamNewlyTrackedDownload:(char *)a1;
- (id)_downloadStatusStoreID:(id)a0 storePlaylistID:(id)a1 orPermLink:(id)a2 downloadID:(id)a3 title:(id)a4 collectionTitle:(id)a5 assetKind:(id)a6 isPaused:(char)a7;
- (id)_numberFromObject:(id)a0;
- (void)_postDownloadCompleteNotificationWithDictionary:(id)a0 failed:(char)a1;
...
- (void)sendInitialProgressNotificationForDownloadWithStoreID:(id)a0 storePlaylistID:(id)a1 orPermlink:(id)a2 downloadID:(id)a3 title:(id)a4 collectionTitle:(id)a5 assetKind:(id)a6 isPaused:(char)a7 targetObserver:(id)a8;
