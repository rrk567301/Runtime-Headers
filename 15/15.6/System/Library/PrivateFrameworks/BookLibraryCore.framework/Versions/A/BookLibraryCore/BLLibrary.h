...
+ (void)initialize;
+ (char)_addDate:(id)a0 toPlist:(id)a1 bookItem:(id)a2 error:(id *)a3;
+ (id)_bookItemsFromPlist:(id)a0 sharedPlist:(id)a1;
+ (id)defaultBookLibrary;

- (void).cxx_destruct;
- (id)_init;
- (char)_addBookItemToEduContainer:(id)a0 error:(id *)a1;
- (char)_addSharedBookToPurchasesPlistWithPermlink:(id)a0 error:(id *)a1;
- (id)_allPlists;
- (id)_bookItemFromPermlink:(id)a0 error:(id *)a1;
- (id)_bookItemFromStoreID:(id)a0 permlink:(id)a1 error:(id *)a2;
- (char)_bookItemIsShared:(id)a0;
