...
- (char)_addOrUpdateCloudEntryWithDictionary:(id)a0 error:(id *)a1;
- (char)_coordinatedReadOfPromisesWithError:(id *)a0;
- (char)_writePlist:(id)a0 toURL:(id)a1 error:(id *)a2;
- (char)addBookItem:(id)a0 error:(id *)a1;
- (id)allBookItems;
...
- (char)removeBookItem:(id)a0 error:(id *)a1;
- (char)updateBookItem:(id)a0 error:(id *)a1;
