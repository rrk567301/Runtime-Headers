...
@property (readonly, getter=hasHDR) char HDR;
...
- (void)setExplicitContent:(char)a0;
- (id)purchaseDate;
- (void)setPurchaseDate:(id)a0;
- (void)setCompilation:(char)a0;
- (id)collectionName;
- (id)composerName;
- (char)isCompilation;
...
- (void)setMusicShow:(char)a0;
- (id)showComposer;
- (id)workName;
- (void)setRental:(char)a0;
...
- (void)setHighDefinition:(char)a0;
...
- (void)setSharedResource:(char)a0;
