...
@property (nonatomic) char isServerSetup;
@property (nonatomic) char isServerSetupPending;
@property (readonly, nonatomic, getter=isPrimaryAccount) char primaryAccount;
...
- (char)_isGDPRPrivacyAcknowledgementRequired;
...
- (char)_saveInMoc:(id)a0 error:(id *)a1;
- (void)_sendHandlers:(id)a0 success:(char)a1;
- (void)_sendSetupConfigurationHandlersWithSuccess:(char)a0;
...
- (char)_updatePersistentServerRevision:(id)a0 database:(id)a1 items:(id)a2 error:(id *)a3;
...
- (void)fetchAllItemsPolitely:(char)a0 reason:(long long)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)updateItemImageURLsIgnoringCache:(char)a0 completion:(id /* block */)a1;
