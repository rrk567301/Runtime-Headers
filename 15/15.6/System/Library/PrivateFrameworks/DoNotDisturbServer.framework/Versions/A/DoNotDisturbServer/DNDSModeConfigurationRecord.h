...
@property (readonly, nonatomic) char wasLastModifiedByThisDevice;
@property (readonly, getter=isAutomaticallyGenerated) char automaticallyGenerated;
@property (readonly) char hasSecureData;
...
- (id)_initWithMode:(id)a0 configuration:(id)a1 secureConfiguration:(id)a2 triggers:(id)a3 impactsAvailability:(unsigned long long)a4 dimsLockScreen:(unsigned long long)a5 created:(id)a6 lastModified:(id)a7 lastModifiedByVersion:(struct { long long x0; long long x1; long long x2; })a8 lastModifiedByDeviceID:(id)a9 automaticallyGenerated:(char)a10 compatibilityVersion:(long long)a11 ephemeralResolvedCompatibilityVersion:(long long)a12 hasSecureData:(char)a13;
- (id)dictionaryRepresentationWithContext:(id)a0;
- (long long)populateCKRecord:(inout id)a0 lastChanceRecord:(id)a1;
- (char)populateDNDSIDSRecord:(inout id)a0;
