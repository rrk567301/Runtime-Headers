...
- (id)_activeDateIntervalForModeAssertion:(id)a0 currentlyActive:(char)a1;
- (id)_allModes;
...
- (char)_setDefaultScheduleTriggerWithScheduleSettings:(id)a0;
- (char)_setDimsLockScreenSetting:(unsigned long long)a0 forModeConfigurationWithIdentifier:(id)a1;
- (char)_setLostModeState:(unsigned long long)a0 error:(id *)a1;
- (char)_setScheduleTrigger:(id)a0 forModeConfigurationWithIdentifier:(id)a1;
...
- (char)eventBehaviorResolver:(id)a0 isAvailabilityActiveForBundleIdentifier:(id)a1;
- (id)gamingModeForGamingTriggerManager:(id)a0;
- (void)globalConfigurationManager:(id)a0 didUpdateModesCanImpactAvailabilitySetting:(char)a1;
- (void)globalConfigurationManager:(id)a0 didUpdatePhoneCallBypassSettings:(id)a1;
- (void)globalConfigurationManager:(id)a0 didUpdatePreventAutoReplySetting:(char)a1;
- (id)hearingTestModeForHearingTestTriggerManager:(id)a0;
- (char)isCloudSyncDisabledForSyncManager:(id)a0;
...
- (void)reachabilityChangedTo:(char)a0;
...
- (char)remoteAppConfigurationServiceProvider:(id)a0 invalidateAppContextForActionIdentifier:(id)a1 bundleIdentifier:(id)a2 withError:(out id *)a3;
- (char)remoteAvailabilityServiceProvider:(id)a0 isLocalUserAvailableForApplicationIdentifier:(id)a1 withError:(out id *)a2;
...
- (char)remoteServiceProvider:(id)a0 clearAppActionWithIdentifier:(id)a1 forApplicationIdentifier:(id)a2 modeIdentifier:(id)a3 withError:(id *)a4;
- (char)remoteServiceProvider:(id)a0 clearSystemActionWithIdentifier:(id)a1 forModeIdentifier:(id)a2 withError:(id *)a3;
- (char)remoteServiceProvider:(id)a0 clearSystemConfigurationActionWithIdentifier:(id)a1 modeIdentifier:(id)a2 withError:(id *)a3;
...
- (char)remoteServiceProvider:(id)a0 getModesCanImpactAvailabilityReturningError:(id *)a1;
- (unsigned long long)remoteServiceProvider:(id)a0 getPairSyncStateReturningError:(id *)a1;
- (char)remoteServiceProvider:(id)a0 getPreventAutoReplyReturningError:(id *)a1;
- (id)remoteServiceProvider:(id)a0 getSystemActionsForModeIdentifier:(id)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 handleHearingTestEvent:(id)a1 withError:(id *)a2;
...
- (char)remoteServiceProvider:(id)a0 removeModeConfigurationWithModeIdentifier:(id)a1 deletePlaceholder:(char)a2 withError:(id *)a3;
...
- (char)remoteServiceProvider:(id)a0 setAppAction:(id)a1 forApplicationIdentifier:(id)a2 modeIdentifier:(id)a3 withError:(id *)a4;
- (char)remoteServiceProvider:(id)a0 setAppConfigurationPredicate:(id)a1 forActionIdentifier:(id)a2 forApplicationIdentifier:(id)a3 modeIdentifier:(id)a4 withError:(id *)a5;
- (char)remoteServiceProvider:(id)a0 setAppConfigurationTargetContentIdentifierPrefix:(id)a1 forActionIdentifier:(id)a2 forApplicationIdentifier:(id)a3 modeIdentifier:(id)a4 withError:(id *)a5;
- (char)remoteServiceProvider:(id)a0 setBehaviorSettings:(id)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setCloudSyncPreferenceEnabled:(char)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setModeConfiguration:(id)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setModesCanImpactAvailability:(char)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setPairSyncPreferenceEnabled:(char)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setPreventAutoReply:(char)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setScheduleSettings:(id)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 setScreenIsShared:(char)a1 screenIsMirrored:(char)a2 withError:(id *)a3;
- (char)remoteServiceProvider:(id)a0 setSystemAction:(id)a1 forModeIdentifier:(id)a2 withError:(id *)a3;
- (id)remoteServiceProvider:(id)a0 silencedModesForContactHandle:(id)a1 withError:(id *)a2;
- (char)remoteServiceProvider:(id)a0 syncModeConfigurationsReturningError:(id *)a1;
- (id)remoteServiceProvider:(id)a0 takeModeAssertionWithDetails:(id)a1 clientIdentifier:(id)a2 error:(id *)a3;
- (char)remoteServiceProvider:(id)a0 userAvailabilityInActiveModeForContactHandle:(id)a1 withError:(id *)a2;
...
- (char)setUILockState:(unsigned long long)a0 error:(id *)a1;
- (void)setWorkoutTriggerEnabled:(char)a0 forWorkoutTriggerManager:(id)a1;
