...
- (char)removeAppSpecificSettingsForApplicationIdentifier:(id)a0 error:(id *)a1;
- (char)removeModeSpecificSettingsForModeIdentifier:(id)a0 error:(id *)a1;
- (id)removeModeSpecificSettingsForModeIdentifiersNotInModeIdentifiers:(id)a0 error:(id *)a1;
- (char)setAppSpecificSettings:(id)a0 identifier:(id)a1 type:(Class)a2 applicationIdentifier:(id)a3 modeIdentifier:(id)a4 error:(id *)a5;
- (char)setModeSpecificSettings:(id)a0 identifier:(id)a1 type:(Class)a2 modeIdentifier:(id)a3 error:(id *)a4;
