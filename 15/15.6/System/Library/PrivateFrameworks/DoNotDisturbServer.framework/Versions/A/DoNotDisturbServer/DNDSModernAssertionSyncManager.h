...
- (void)updateDevices:(id)a0 force:(char)a1 shouldFuzz:(char)a2;
- (void)_loadMetadataFromBackingStore;
- (char)_maintainMetadataBackingStore;
- (void)_queue_handleDidSendRequestIdentifier:(id)a0 withSuccess:(char)a1 error:(id)a2;
- (void)_queue_handleMessage:(id)a0 withVersionNumber:(unsigned long long)a1 fromDeviceIdentifier:(id)a2;
- (void)_queue_sendStateSnapshotToPairedDevices:(id)a0 force:(char)a1;
- (void)_queue_updateDevices;
- (char)_saveMetadataToBackingStore;
...
- (void)syncService:(id)a0 didSendWithRequestIdentifier:(id)a1 withSuccess:(char)a2 error:(id)a3;
- (char)syncService:(id)a0 shouldAcceptIncomingMessage:(id)a1 withVersionNumber:(unsigned long long)a2 messageType:(id)a3 fromDeviceIdentifier:(id)a4;
