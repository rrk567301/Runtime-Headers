...
- (char)_isDisconnectedWatch:(unsigned long long)a0 inReduceInterruptions:(long long)a1;
- (id)_legacyModeConfigurationForModeConfiguration:(id)a0;
- (id)_queue_adjustEventBehaviorResolutionForAuxiliaryState:(id)a0;
- (char)_queue_eventSourceIsContact:(id)a0;
- (char)_queue_eventSourceIsContact:(id)a0 inGroupWithIdentifier:(id)a1;
- (char)_queue_eventSourceIsEmergencyContact:(id)a0;
- (char)_queue_eventSourceIsFavorite:(id)a0;
- (char)_queue_eventSourceIsRepeat:(id)a0 clientDetails:(id)a1 date:(id)a2;
- (id)_queue_firstContactForPredicate:(id)a0;
- (char)_queue_isBreakthroughAllowedForModeIdentifier:(id)a0 withConfiguration:(id)a1 application:(id)a2 sender:(id)a3 urgency:(unsigned long long)a4 eventType:(unsigned long long)a5 threadIdentifier:(id)a6 filterCriteria:(id)a7 notifyAnyway:(char)a8 intelligentBehavior:(long long)a9 reason:(out unsigned long long *)a10;
- (char)_queue_isBreakthroughAllowedForSender:(id)a0 eventType:(unsigned long long)a1 clientDetails:(id)a2 date:(id)a3 reason:(out unsigned long long *)a4;
...
- (char)_queue_shouldAdjustEventBehaviorForMirroring;
