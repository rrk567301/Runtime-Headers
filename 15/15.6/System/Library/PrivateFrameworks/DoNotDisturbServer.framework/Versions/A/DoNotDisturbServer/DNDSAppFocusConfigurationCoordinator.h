...
- (void)_executeAction:(id)a0 orActionIdentifier:(id)a1 withBundleIdentifier:(id)a2 modeIdentifier:(id)a3 groupIdentifier:(id)a4 exiting:(char)a5 metadata:(id)a6;
- (void)_executeAction:(id)a0 orActionIdentifier:(id)a1 withBundleIdentifier:(id)a2 modeIdentifier:(id)a3 groupIdentifier:(id)a4 exiting:(char)a5 metadataProvider:(id)a6;
...
- (char)_removeTask:(id)a0 fromGroupWithIdentifier:(id)a1;
- (char)_shouldExecuteActionOnApplicationWithBundleIdentifier:(id)a0;
