...
@property (nonatomic) char displayNameIncludingCountryShowsOnlyCountry;
...
- (id)displayNameIncludingCountry:(char)a0;
- (id)displayNameIncludingCountry:(char)a0 withFormat:(id)a1;
