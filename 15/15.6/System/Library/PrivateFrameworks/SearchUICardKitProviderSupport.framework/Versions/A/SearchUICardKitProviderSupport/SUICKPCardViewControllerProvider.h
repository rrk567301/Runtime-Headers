...
- (void)unregisterCardViewController:(id)a0;
- (void)userDidEngageCardSection:(id)a0 withEngagementFeedback:(id)a1;
- (void)cardViewController:(id)a0 preferredContentSizeDidChange:(struct CGSize { double x0; double x1; })a1 animated:(char)a2;
- (id)customViewControllerForCardSection:(id)a0;
- (char)_askDelegateToPerformReferentialCommand:(id)a0 forCardSection:(id)a1;
