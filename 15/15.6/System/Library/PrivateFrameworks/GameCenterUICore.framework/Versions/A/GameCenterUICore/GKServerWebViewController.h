...
@property char waitForLoad;
@property char navbarSetupCompleted;
...
@property (nonatomic) char dismissOnAuthenticate;
...
- (void)serverWebViewJSRoot:(id)a0 changeNavBarWithButtons:(id)a1 showSpinner:(char)a2;
...
- (char)shouldStartLoadWithURL:(id)a0 request:(id)a1 redirectTo:(id *)a2;
