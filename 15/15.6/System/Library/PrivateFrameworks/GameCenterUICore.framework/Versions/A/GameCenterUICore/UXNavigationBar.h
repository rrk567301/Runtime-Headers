...
@property (nonatomic) char didSetupObservers;
...
@property (readonly, nonatomic) char currentSpinnerEnabled;
...
- (void)setupObservers;
- (void)popNavigationItemAnimated:(char)a0;
...
- (id)currentTitleView;
- (void)popToNavigationItem:(id)a0 animated:(char)a1;
