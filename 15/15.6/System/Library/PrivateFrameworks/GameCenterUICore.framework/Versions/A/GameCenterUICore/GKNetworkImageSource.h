...
- (void).cxx_destruct;
- (void)loadAndCacheAvatarFromGamedForURLString:(id)a0 useUIImage:(char)a1 cacheSubdirectory:(id)a2 reference:(id)a3 queue:(id)a4 handler:(id /* block */)a5;
