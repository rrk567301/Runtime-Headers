...
- (void)enumerateEntriesForPredictiveSearch:(id)a0 shouldMatchAfterDecoding:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateEntriesForPredictiveSearch:(id)a0 usingBlock:(id /* block */)a1;
- (void)enumerateEntriesWithCommonPrefix:(id)a0 shouldMatchAfterDecoding:(char)a1 usingBlock:(id /* block */)a2;
