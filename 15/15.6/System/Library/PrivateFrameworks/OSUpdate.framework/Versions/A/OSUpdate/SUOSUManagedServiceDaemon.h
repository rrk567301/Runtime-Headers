...
- (void)postDDMNotificationToAllUsersForScheduledUpdate:(id)a0 updateVersion:(id)a1 ignoreDoNoDisturb:(char)a2 companyName:(id)a3 options:(id)a4 client:(id)a5 completion:(id /* block */)a6;
