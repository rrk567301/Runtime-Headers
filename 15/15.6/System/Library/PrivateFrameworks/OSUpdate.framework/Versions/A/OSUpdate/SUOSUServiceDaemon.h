...
@property char clientCanPerformExternalUpdate;
@property char finishedPerformingExternalUpdatePostlogoutActions;
...
- (id)_updateFilteredAvailableMobileSoftwareDescriptors:(id)a0 mdmInitiated:(char)a1;
...
- (char)_nowExceedslastMDMUpdateLaterNotificationTimeInterval;
...
- (void)allDeclarationsRemovingInvalidDeclarations:(char)a0 completion:(id /* block */)a1;
...
- (void)downloadAndPrepareMobileSoftwareUpdateWithDescriptors:(id)a0 inBackground:(char)a1 mdmInitiated:(char)a2 completion:(id /* block */)a3;
...
- (void)postDDMNotificationToAllUsersForScheduledUpdate:(id)a0 updateVersion:(id)a1 ignoreDoNoDisturb:(char)a2 companyName:(id)a3 options:(id)a4 completion:(id /* block */)a5;
...
- (void)setFinishedExternalUpdatePostlogoutActions:(char)a0;
- (void)setGlobalSettings:(id)a0 withCompletion:(id /* block */)a1;
- (void)setIsReadyToPerformExternalUpdate:(char)a0;
...
- (char)shouldDoPeriodicMDMActions;
...
- (void)stashLoginCredentialsWithFLO:(char)a0 withCompletion:(id /* block */)a1;
