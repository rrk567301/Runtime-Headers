...
+ (void)initialize;
+ (char)updateFromFactoryVersionRequired:(char *)a0 withError:(id *)a1;
+ (void)prepareRosettaUpdate;

- (void).cxx_destruct;
- (id)initWithDelegate:(id)a0;
- (id)availableUpdateProductsWithError:(id *)a0;
- (void)client:(id)a0 installDidBeginForUpdates:(id)a1 progress:(id)a2 mdmInitiated:(char)a3;
- (void)client:(id)a0 installDidFinishSuccessfullyForUpdates:(id)a1 mdmInitiated:(char)a2;
- (void)client:(id)a0 installDidFinishWithError:(id)a1 forUpdates:(id)a2 mdmInitiated:(char)a3;
- (void)client:(id)a0 installDidFinishWithError:(id)a1 forUpdates:(id)a2 mdmInitiated:(char)a3 installEvent:(id)a4;
...
- (char)startInstallingMacbuddyUpdateWithBuildVersion:(id)a0 withOptions:(id)a1;
- (void)startInstallingMacbuddyUpdateWithProduct:(id)a0;
- (void)startInstallingMacbuddyUpdateWithProduct:(id)a0 withOptions:(id)a1;
- (char)startInstallingMacbuddyUpdateWithProductMarketingVersion:(id)a0 withOptions:(id)a1;
