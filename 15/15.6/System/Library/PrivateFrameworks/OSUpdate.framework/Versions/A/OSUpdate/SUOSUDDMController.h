...
+ (char)scheduleUpdateVersion:(id)a0 forDateTime:(id)a1 options:(id)a2;

- (id)init;
- (void).cxx_destruct;
- (char)scheduleUpdate:(id)a0;
- (char)cancelUpdate:(id)a0;
- (char)cancelUpdateForKey:(id)a0 withError:(id *)a1;
...
- (char)scheduleUpdate:(id)a0 withError:(id *)a1;
