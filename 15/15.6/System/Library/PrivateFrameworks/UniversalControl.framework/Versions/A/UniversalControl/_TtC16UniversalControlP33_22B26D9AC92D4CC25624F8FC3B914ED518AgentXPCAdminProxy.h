...
- (void)xpcSetAutomaticallyReconnect:(char)a0 completion:(id /* block */)a1;
- (void)xpcSynchronizeWith:(id)a0 completion:(id /* block */)a1;
- (void)xpcTakeClientAssertion:(id)a0 assertionID:(id)a1 deviceID:(id)a2 completion:(id /* block */)a3;
