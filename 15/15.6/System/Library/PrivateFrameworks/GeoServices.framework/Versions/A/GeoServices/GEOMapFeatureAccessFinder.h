...
- (id)init;
- (void).cxx_destruct;
- (char)_boundingCircle:(const void *)a0 intersectsFeature:(id)a1;
- (char)_boundingCircle:(const void *)a0 intersectsPoints:(struct GeoCodecsVectorTilePoint { float x0; float x1; } *)a1 pointCount:(unsigned long long)a2;
- (char)_boundingCircle:(const void *)a0 intersectsTransitLink:(id)a1;
- (char)_boundingCircle:(const void *)a0 withBuildingTilePoints:(struct vector<GeoCodecsVectorTilePoint, std::allocator<GeoCodecsVectorTilePoint>> { struct GeoCodecsVectorTilePoint *x0; struct GeoCodecsVectorTilePoint *x1; struct __compressed_pair<GeoCodecsVectorTilePoint *, std::allocator<GeoCodecsVectorTilePoint>> { struct GeoCodecsVectorTilePoint *x0; } x2; })a1;
...
- (char)_featureHasValidGeometry:(id)a0;
