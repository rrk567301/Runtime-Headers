...
@property (nonatomic) char hasLocationCorrectionMagnitude;
@property (nonatomic) unsigned int locationCorrectionMagnitude;
@property (nonatomic) char hasHeadingCorrectionMagnitude;
@property (nonatomic) unsigned int headingCorrectionMagnitude;
@property (nonatomic) char hasAltitudeCorrectionMagnitude;
