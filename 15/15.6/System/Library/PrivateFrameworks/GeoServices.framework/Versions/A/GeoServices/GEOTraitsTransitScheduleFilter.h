...
@property (readonly, nonatomic) char hasHighFrequencyFilter;
@property (retain, nonatomic) GEOTraitsTransitScheduleModeFilter *highFrequencyFilter;
@property (readonly, nonatomic) char hasLowFrequencyFilter;
@property (retain, nonatomic) GEOTraitsTransitScheduleModeFilter *lowFrequencyFilter;
@property (readonly, nonatomic) char hasOperatingHoursRange;
