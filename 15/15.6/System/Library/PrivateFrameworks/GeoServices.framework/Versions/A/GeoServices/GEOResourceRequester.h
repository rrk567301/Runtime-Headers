...
- (id)init;
- (void).cxx_destruct;
- (void)fetchResources:(id)a0 force:(char)a1 manifestConfiguration:(id)a2 auditToken:(id)a3 queue:(id)a4 handler:(id /* block */)a5;
- (void)fetchResources:(id)a0 force:(char)a1 unpack:(char)a2 manifestConfiguration:(id)a3 auditToken:(id)a4 queue:(id)a5 handler:(id /* block */)a6;
