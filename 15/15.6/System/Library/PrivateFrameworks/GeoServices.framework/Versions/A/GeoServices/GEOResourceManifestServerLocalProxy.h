...
@interface GEOResourceManifestServerLocalProxy : NSObject <GEOResourceFiltersManagerDelegate, GEOPListStateCapturing, GEOKeyBagProtectedDataDidBecomeAvailableObserver, GEOConfigChangeListenerDelegate, GEOTileGroupActivationSessionDelegate, GEOResourceManifestServerProxy> {
    ...
    char _tileGroupActivationSessionHasFinishedFirstTileGroupChange;
    char _tileGroupActivationShouldFlushTileCache;
...
- (void)_forceChangeActiveTileGroup:(id)a0 flushTileCache:(char)a1;
...
- (char)_updateManifestIfNecessary:(id /* block */)a0;
- (void)_updateTimerFired;
- (char)_writeActiveTileGroupToDisk:(id)a0 error:(id *)a1;
- (char)_writeManifestToDisk:(id)a0 error:(id *)a1;
- (char)_writeManifestToDisk:(id)a0 updatedMetadataForURL:(id)a1 eTag:(id)a2 error:(id *)a3;
