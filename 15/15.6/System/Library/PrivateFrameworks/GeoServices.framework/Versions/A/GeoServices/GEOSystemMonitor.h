...
@interface GEOSystemMonitor : NSObject {
    ...
    char _powerPluggedIn;
    unsigned long long _batteryLevel;
}

@property (class, readonly, nonatomic) GEOSystemMonitor *sharedInstance;

@property (readonly, nonatomic, getter=isPowerAdapterConnected) char powerAdapterConnected;
@property (readonly, nonatomic) unsigned long long batteryLevel;

- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (void)addBatteryLevelObserver:(id)a0 onlyWhenCharging:(char)a1 queue:(id)a2;
