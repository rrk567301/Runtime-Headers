...
- (char)_edgeStart:(const void *)a0 end:(const void *)a1 connectsTo:(const void *)a2;
- (char)_findEdgeAhead;
...
- (char)_pointConnects:(const void *)a0 rect:(const struct { struct { double x0; double x1; } x0; struct { double x0; double x1; } x1; } *)a1 to:(const struct { double x0; double x1; } *)a2;
