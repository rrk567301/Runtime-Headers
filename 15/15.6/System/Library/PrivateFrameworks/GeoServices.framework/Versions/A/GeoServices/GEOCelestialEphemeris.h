...
@property (readonly, nonatomic) char isTransitAboveHorizon;
...
- (id)initWithLocation:(struct { double x0; double x1; })a0 date:(id)a1 body:(long long)a2 useHighPrecision:(char)a3;
- (id)initWithLocation:(struct { double x0; double x1; })a0 julianDay:(double)a1 body:(long long)a2 altitude:(double)a3 useHighPrecision:(char)a4;
