...
- (id)initWithDisplayName:(id)a0 isSelected:(char)a1 metadata:(id)a2 elementType:(unsigned long long)a3 evChargingConnectorType:(int)a4 selectionSequenceNumber:(id)a5;
