...
@property (readonly, nonatomic) char hasTripTimes;
@property (retain, nonatomic) GEOTraversalTimes *tripTimes;
@property (readonly, nonatomic) char hasFeature;
@property (retain, nonatomic) GEOWaypointRouteFeatures *feature;
@property (readonly, nonatomic) char hasRoutePlanningInfo;
...
@property (readonly, nonatomic) char hasRestrictionZoneInfo;
@property (retain, nonatomic) GEORestrictionZoneInfo *restrictionZoneInfo;
@property (readonly, nonatomic) char hasOutOfMapsAlertsInfo;
