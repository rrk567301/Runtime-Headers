...
@property (readonly, nonatomic) char displayFullScreenPhotoGallery;
@property (readonly, nonatomic) char useGallery;
@property (readonly, nonatomic) NSString *uid;
@property (readonly, nonatomic) double sizeRatio;
@property (readonly, nonatomic) char highQuality;
@property (readonly, nonatomic) char businessProvided;
@property (readonly, nonatomic) NSString *backgroundJoeColor;
@property (readonly, nonatomic) char isBackgroundJoeColorCurated;
@property (readonly, nonatomic) GEOMapItemPhotosAttribution *attribution;
@property (readonly, nonatomic) NSDate *dateCreated;
@property (readonly, nonatomic) char needsObfuscationWhenRenderedInFullScreen;
...
- (id)bestPhotoForSize:(struct CGSize { double x0; double x1; })a0 allowSmaller:(char)a1;
