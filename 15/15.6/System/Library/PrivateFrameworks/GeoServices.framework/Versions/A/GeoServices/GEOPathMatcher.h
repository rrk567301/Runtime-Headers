...
@property (nonatomic) char shouldDropDivergingSegments;
@property (nonatomic) char forceSync;

- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)_isFailedRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a0;
...
- (char)_isRangeValid:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a0;
...
- (id)_supportPointForRouteCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a0 isRangeStart:(char)a1;
...
- (char)_verifySegmentDistanceFromRoute:(id)a0 segmentIndex:(long long)a1 requestedPathRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a2;
...
- (void)setShouldSaveInternalInfo:(char)a0;
- (char)shouldSaveInternalInfo;
