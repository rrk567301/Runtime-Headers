...
@property (nonatomic) char hasTimestampVal;
...
@property (nonatomic) char hasDisplayTimezone;
@property (nonatomic) char displayTimezone;
@property (readonly, nonatomic) char hasFormatPattern;
