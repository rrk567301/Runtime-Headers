...
@property (readonly, nonatomic) char isTransitIncidentsTTLExpired;
@property (readonly, nonatomic) char hasTransitIncidentComponent;
...
- (id)_departureSequencesForSystem:(id)a0 excludingIncidentEntities:(id)a1 ignoreDirectionFilter:(char)a2 direction:(id)a3 validForDateFromBlock:(id /* block */)a4;
...
- (id)directionsForSystem:(id)a0 excludingIncidentEntities:(id)a1 validForDateFromBlock:(id /* block */)a2 hasSequencesWithNoDirection:(out char *)a3;
- (id)headSignsForLine:(id)a0;
- (id)inactiveLinesForSystem:(id)a0 relativeToDateFromBlock:(id /* block */)a1 excludingIncidentEntities:(id)a2 usingContainers:(char)a3;
- (id)initWithTransitInfo:(id)a0 schedule:(id)a1 timeZone:(id)a2 incidents:(id)a3 hasTransitIncidentComponent:(char)a4 incidentExpirationDate:(id)a5 providerID:(int)a6 coordinate:(struct { double x0; double x1; })a7 transitStops:(id)a8 composedRoute:(id)a9 nearbySchedule:(id)a10;
- (unsigned long long)numAdditionalDeparturesForSequence:(id)a0;
- (id)serviceResumesResultForLine:(id)a0 excludingIncidentEntities:(id)a1 afterDate:(id)a2 usingContainers:(char)a3;
