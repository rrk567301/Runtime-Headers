...
@property (readonly, nonatomic) char isOnTileBorder;
@property (readonly, nonatomic) struct { double x0; double x1; } coordinate;

+ (struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; unsigned long long x3; unsigned long long x4; } *)connectivityJunctionForRoadFeature:(id)a0 startJunction:(char)a1 outError:(out id *)a2;
+ (char)isPointOnTileBorder:(struct GeoCodecsVectorTilePoint { float x0; float x1; } *)a0;
+ (id)junctionForRoadFeature:(id)a0 startJunction:(char)a1;
