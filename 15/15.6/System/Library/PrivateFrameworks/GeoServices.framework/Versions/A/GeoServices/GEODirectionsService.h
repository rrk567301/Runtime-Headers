...
+ (char)_canCurrentVoiceLanguageHandleWrittenText;
+ (char)canSpeakWrittenAddresses;
+ (char)canSpeakWrittenPlaceNames;
...
- (void)_submitDirectionsRequest:(id)a0 waypoints:(id)a1 traits:(id)a2 auditToken:(id)a3 useBackgroundURL:(char)a4 requestPriority:(long long)a5 allowRetry:(char)a6 handler:(id /* block */)a7;
