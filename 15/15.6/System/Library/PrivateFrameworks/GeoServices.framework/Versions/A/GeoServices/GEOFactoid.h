@class NSString, GEOMapItemIdentifier, GEOPDFactoid, GEOColor;
...
@property (readonly, nonatomic, getter=shouldUseStructuredData) char useStructuredData;
@property (readonly, nonatomic) NSString *symbolName;
@property (readonly, nonatomic) GEOMapItemIdentifier *placeIdentifier;
@property (readonly, nonatomic) char canBeDisplayedInPlaceSummary;
