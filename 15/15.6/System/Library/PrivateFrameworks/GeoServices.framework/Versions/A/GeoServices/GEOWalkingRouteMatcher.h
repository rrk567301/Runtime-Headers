...
- (void)_addRecentLocation:(id)a0 isOnRoute:(char)a1;
...
- (double)_maxMatchDistance:(double)a0 routeCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 previousMatchGood:(char)a2;
