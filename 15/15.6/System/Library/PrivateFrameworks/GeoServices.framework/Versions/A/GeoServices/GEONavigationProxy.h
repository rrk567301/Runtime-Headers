...
- (void)setDestinationName:(id)a0 nextDestinationName:(id)a1;
...
- (void)setNavigationSessionState:(unsigned long long)a0 transportType:(int)a1 navigationType:(int)a2 isResumingMultipointRoute:(char)a3;
...
- (void)startWithDestinationName:(id)a0 nextDestinationName:(id)a1;
