...
@property (nonatomic) char reconnectAutomatically;
...
+ (id)getServerConnectionFor:(unsigned long long)a0 debugIdentifier:(id)a1 queue:(id)a2 creationBlock:(id /* block */)a3 reconnectBlock:(id /* block */)a4 eventHandler:(id /* block */)a5;
...
- (id)initWithClientConnection:(id)a0 debugIdentifier:(id)a1;
- (char)initiateBarrierIfNecessary:(id)a0 delegate:(id)a1;
