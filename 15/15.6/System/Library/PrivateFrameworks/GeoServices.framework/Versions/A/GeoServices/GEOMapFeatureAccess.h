...
@property (nonatomic) char joinAllRoadsByMuid;
@property (nonatomic) char cachedTilesCallbackImmediately;
@property (retain, nonatomic) GEOApplicationAuditToken *auditToken;
@property (nonatomic) char allowNetworkTileLoad;
@property (nonatomic) char flipNegativeTravelDirectionRoads;
@property (nonatomic) char visitDoubleTravelDirectionRoadsTwice;
@property (nonatomic) char allowStaleData;
@property (nonatomic) char preferStaleData;
@property (nonatomic) char allowOfflineData;
...
- (void)_preloadTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 preloadToDiskOnly:(char)a2 tileSetStyle:(int)a3 tileScale:(int)a4 completionHandler:(id /* block */)a5;
...
- (void)preloadBuildingTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 preloadToDiskOnly:(char)a2 completionHandler:(id /* block */)a3;
- (void)preloadBuildingTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 tileSetStyle:(int)a2 preloadToDiskOnly:(char)a3 completionHandler:(id /* block */)a4;
- (void)preloadRoadTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 completionHandler:(id /* block */)a2;
- (void)preloadRoadTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 preloadToDiskOnly:(char)a2 completionHandler:(id /* block */)a3;
- (void)preloadTransitTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 completionHandler:(id /* block */)a2;
- (void)preloadTransitTilesNear:(struct { double x0; double x1; })a0 radius:(double)a1 preloadToDiskOnly:(char)a2 completionHandler:(id /* block */)a3;
