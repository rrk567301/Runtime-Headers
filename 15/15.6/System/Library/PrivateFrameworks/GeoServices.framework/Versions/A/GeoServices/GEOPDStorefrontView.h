...
@property (readonly, nonatomic) char hasPhotoPosition;
...
@property (readonly, nonatomic) char hasLookAt;
@property (retain, nonatomic) GEOPDOrientedPosition *lookAt;
@property (readonly, nonatomic) char hasLookAtGeo;
@property (retain, nonatomic) GEOPDGeographicCoordinate *lookAtGeo;
@property (readonly, nonatomic) char hasViewpointGeo;
