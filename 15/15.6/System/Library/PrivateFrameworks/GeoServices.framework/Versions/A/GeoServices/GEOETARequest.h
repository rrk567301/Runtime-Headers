...
@property (readonly, nonatomic) char hasOriginalWaypointRoute;
...
@property (nonatomic) char hasIncludeRouteTrafficDetail;
@property (nonatomic) char includeRouteTrafficDetail;
@property (nonatomic) char hasIncludeShortTrafficSummary;
@property (nonatomic) char includeShortTrafficSummary;
...
@property (nonatomic) char hasIncludeEtaRouteIncidents;
@property (nonatomic) char includeEtaRouteIncidents;
...
@property (readonly, nonatomic) char hasPathComputationOptions;
