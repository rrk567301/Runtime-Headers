...
@property (readonly, nonatomic) char hasViewTargetBounds;

- (id)initWithAltitude:(double)a0 latitude:(double)a1 longitude:(double)a2 heading:(float)a3 pitch:(float)a4 distance:(float)a5 minViewTargetBounds:(struct { double x0; double x1; double x2; })a6 maxViewTargetBounds:(struct { double x0; double x1; double x2; })a7 hasViewTargetBounds:(char)a8;
