...
- (char)_locationMeetsSpeedThresholdForRoadMatch:(id)a0 distanceFromRoute:(double)a1;
- (id)_routeMatcherForRoute:(id)a0;
- (char)_shouldConsiderRoadMatch:(id)a0 overRouteMatch:(id)a1 forLocation:(id)a2;
