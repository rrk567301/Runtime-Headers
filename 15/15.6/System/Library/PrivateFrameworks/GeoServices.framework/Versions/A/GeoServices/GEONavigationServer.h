...
- (void)setNavigationSessionState:(unsigned long long)a0 transportType:(int)a1 isResumingMultipointRoute:(char)a2;
...
- (char)shouldAcceptNewConnection:(id)a0 shouldCreateNavigationPeer:(char)a1;
