...
- (void)updateWithCurrentTime:(id)a0 location:(id)a1 isMostRecentReroute:(char)a2 destinationCoordinate:(struct { double x0; double x1; })a3 numThrottledReroutes:(unsigned long long)a4;
