@class GEOAddress, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOEnrichmentData, GEOEVCharger, GEOMapRegion, GEOMuninViewState, GEOPDURLData, NSData, GEOPlace, GEOEnclosingPlace, GEOStorefrontPresentationInfo, GEOEnrichmentInfo, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOInlineRapEnablement, NSNumber, GEOLocalizedString, GEOPlacecardLayoutData, GEOPOIClaim, GEOViewportFrame, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPDHikeAssociatedInfo, GEOPlaceResult, GEOExploreGuides, NSArray, GEOPlaceQuestionnaire, GEOHikeSummary, GEOStorefrontInfo, GEOStyleAttributes, NSString, NSTimeZone, GEOTooltip, GEOTrailHead, GEORestaurantFeaturesLink, GEOMapItemIdentifier, GEOMapItemPhotosAttribution, GEOMapItemDetourInfo, GEOPDHikeGeometry, NSSet, GEOBusinessAssets, GEOPDPlace, GEOPriceDescription, NSDate;
...
- (id)_asPlaceInfo;
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize { double x0; double x1; })a0 allowSmaller:(char)a1;
- (id)_bestHeroBrandIconURLForSize:(struct CGSize { double x0; double x1; })a0 allowSmaller:(char)a1;
...
- (char)_hasTravelTimeForTransportType:(int)a0;
