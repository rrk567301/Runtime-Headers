...
@property (readonly, nonatomic) char supportsAreaHighlight;
@property (readonly, nonatomic) char hasRichData;
...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 supportsAreaHighlight:(char)a1;
