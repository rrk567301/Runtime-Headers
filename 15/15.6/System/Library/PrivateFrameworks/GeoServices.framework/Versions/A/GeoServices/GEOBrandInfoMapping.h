...
@interface GEOBrandInfoMapping : PBCodable <NSCopying> {
    ...
    struct { char *list; unsigned long long count; unsigned long long size; } _isSuggesteds;
...
@property (nonatomic) char hasGlobalBrandId;
...
@property (readonly, nonatomic) char *isSuggesteds;
...
- (char)isSuggestedAtIndex:(unsigned long long)a0;
...
- (void)setIsSuggesteds:(char *)a0 count:(unsigned long long)a1;
