...
+ (id)_requestCounterTicketForType:(struct { int x0; union { int x0; int x1; int x2; } x1; })a0 appId:(id)a1 traits:(id)a2 withParent:(id)a3 logNetworkActivityOnly:(char)a4;
