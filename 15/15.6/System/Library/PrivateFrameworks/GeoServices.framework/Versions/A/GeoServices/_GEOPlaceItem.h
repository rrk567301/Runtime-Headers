@class GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEORestaurantFeaturesLink, NSNumber, geo_isolater, GEOMapItemClientAttributes, GEOMuninViewState, GEOTrailHead, GEOBusinessAssets, GEOMessageLink, GEOMapItemContainedPlace, GEOPlacecardLayoutData, GEOPDPlace, GEOPDHikeAssociatedInfo, GEOStyleAttributes, GEOMapItemIdentifier, NSSet, GEOEnrichmentInfo, GEOMiniBrowseCategories, GEOViewportFrame, GEOExploreGuides, GEOLabelGeometry, GEOAppleRating, GEOPDFlyover, GEOEnrichmentData, NSData, GEOPlaceResult, GEOEnhancedPlacement, NSDate, GEOAssociatedApp, NSArray, GEOPOIClaim, NSTimeZone, GEOFeatureStyleAttributes, GEOMapItemPlaceAttribution, GEOPDURLData, GEOPriceDescription, GEOInlineRapEnablement, GEOAddressObject, GEOTooltip, GEOAddress, NSString, GEOStorefrontInfo, GEOEVCharger, GEOPDHikeGeometry, NSURL, GEOLocalizedString, NSDictionary, GEOHikeSummary, GEOPlaceQuestionnaire, GEOEnclosingPlace, GEOMapRegion, GEOMapItemReviewsAttribution, GEOStorefrontPresentationInfo, GEOPlace;
