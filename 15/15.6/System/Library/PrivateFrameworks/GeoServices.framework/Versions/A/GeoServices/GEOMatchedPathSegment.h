...
@property (nonatomic) char isDivergentSegment;
...
@property (readonly, nonatomic) char isPartialStart;
@property (readonly, nonatomic) char isPartialEnd;
@property (readonly, nonatomic) char isFailedSegment;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (struct pair<GEOLocationCoordinate3D, geo::PolylineCoordinate> { struct { double x0; double x1; double x2; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })_interpolatedCoordinateFrom:(unsigned long long)a0 routeCoordinate:(const struct PolylineCoordinate { unsigned int x0; float x1; } *)a1;
...
- (id)initUnmatchedSegmentWithRoute:(id)a0 range:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a1 isFailedSegment:(char)a2;
