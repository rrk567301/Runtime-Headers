...
- (id)initWithCategory:(id)a0 routeInfo:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3 searchSessionData:(id)a4;
- (id)initWithMapItemToRefine:(id)a0 traits:(id)a1;
- (id)_initWithTraits:(id)a0 includeHistoricalLocations:(char)a1 supportedMapsResultTypes:(id)a2;
- (id)_initWithTransitScheduleRequestForStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripId:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
- (void)addAuxiliaryTierRequestedComponent:(id)a0;
- (void)addDisplayLanguage:(id)a0;
- (void)addPartiallyComposedSearchResultRequestedComponent:(id)a0;
- (void)addPartiallyComposedSearchResultRequestedComponents:(id)a0;
...
- (id)browseCategorySuggestionparametersWithTraits:(id)a0 isFromNoQueryState:(char)a1;
...
- (id)initForCategoryListWithTraits:(id)a0 isFromNoQueryState:(char)a1;
- (id)initForCuratedCollectionItemLookupWithIdentifiers:(id)a0 collectionIdentifier:(id)a1 traits:(id)a2;
- (id)initForCuratedCollectionLookupWithIdentifiers:(id)a0 isBatchLookup:(char)a1 overrideSuppress:(char)a2 traits:(id)a3;
...
- (id)initWithCategory:(id)a0 maxResults:(unsigned int)a1 traits:(id)a2 searchSessionData:(id)a3;
...
- (id)initWithReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 floorOrdinal:(int)a1 includeEntryPoints:(char)a2 preserveOriginalLocation:(char)a3 traits:(id)a4;
- (id)initWithReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 includeEntryPoints:(char)a1 preserveOriginalLocation:(char)a2 traits:(id)a3;
- (id)initWithReverseGeocodeLocation:(id)a0 includeEntryPoints:(char)a1 preserveOriginalLocation:(char)a2 placeTypeLimit:(int)a3 traits:(id)a4;
- (id)initWithSearchCategory:(id)a0 venueIdentifier:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3;
- (id)initWithSearchQuery:(id)a0 entryMetadata:(id)a1 metadata:(id)a2 autocompleteEntry:(id)a3 retainedSearch:(id)a4 maxResults:(unsigned int)a5 filters:(id)a6 suppressResultsRequiringAttribution:(char)a7 traits:(id)a8 routeInfo:(id)a9 error:(id *)a10 searchSessionData:(id)a11;
...
- (id)initWithTransitDeparturesAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripId:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
- (id)initWithTransitScheduleAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripId:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
- (id)initWithTransitTripDetailsAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripId:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
- (id)initWithTripIds:(id)a0 traits:(id)a1;
- (id)initWithUpdatedTransitScheduleDetailsAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripId:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
...
- (id)partiallyComposedSearchResultRequestedComponentAtIndex:(unsigned long long)a0;
