@class NSString, GEOLocation, NSDate, NSError;
...
+ (char)supportsTravelState:(long long)a0 forTransportType:(int)a1;
...
- (void)_updateTravelStateHasArrived:(char)a0 isTraveling:(char)a1 travelScore:(double)a2 isNavigating:(char)a3 isNavigatingToDestination:(char)a4;
- (void)setRouteName:(id)a0;
- (void)setSupportsLiveTraffic:(char)a0;
