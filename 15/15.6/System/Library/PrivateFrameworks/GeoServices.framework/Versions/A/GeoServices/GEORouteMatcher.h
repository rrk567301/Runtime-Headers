@class _GEOCandidateRouteMatch, NSArray, GEOComposedRoute, GEOApplicationAuditToken, GEOPathMatcher, NSMutableArray, GEORouteMatch, GEOLocation;
...
@property (readonly, nonatomic) char hasBeenOnRouteOnce;
...
@property (nonatomic) char useStrictInitialOnRouteCriteria;
@property (nonatomic) double maxMatchDistanceFromPreviousRouteMatch;
@property (nonatomic) char requiresRoadNetworkData;
@property (nonatomic) char shouldSnapRouteMatchToRoute;
@property (nonatomic) char useMatchedCoordinateForMatching;
@property (nonatomic) char shouldWaitForSnappedSegments;
...
- (char)_shouldConsiderCourseForLocation:(id)a0;
