...
- (void)doEnvironmentSwitchCheck:(id)a0 authProxyURL:(id)a1 suppressNotification:(char)a2;
- (void)handleSecureProxyChallenge:(id)a0;
- (void)invalidateTokens;
- (char)isCurrentEnvironmentSecure;
...
- (void)renewMapsAuthProxyToken:(unsigned long long)a0 fromToken:(id)a1 authProxyURL:(id)a2 suppressNotification:(char)a3;
- (void)requestFeatureFlagsWithURL:(id)a0 suppressNotification:(char)a1;
