...
@property (readonly, nonatomic) char hasPathMapMatcherInstructions;
...
@property (readonly, nonatomic) char hasRouteLabelDetailText;
...
@property (readonly, nonatomic) char hasTrafficDescriptionLong;
...
@property (readonly, nonatomic) char hasLaunchAndGoCardText;
...
@property (readonly, nonatomic) char hasElevationProfile;
...
@property (readonly, nonatomic) char hasOriginListInstruction;
@property (retain, nonatomic) GEODrivingWalkingInstruction *originListInstruction;
@property (readonly, nonatomic) char hasDestinationListInstruction;
...
- (id)convertToFullRoute:(id)a0 includeDepartureRoutes:(char)a1 uniquePointRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
...
- (char)isContingentRouteFor:(id)a0 afterPoint:(unsigned int)a1 mainRoutes:(id)a2;
