@class GEOPBTransitArtwork, GEORouteInformation, GEOLabelAction, GEOFormattedString, PBDataReader, GEOAdvisoriesInfo, PBUnknownFields;
...
@interface GEORoutePlanningInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_advisoriesInfo : 1; unsigned char read_infrastructureDescription : 1; unsigned char read_labelAction : 1; unsigned char read_labelArtwork : 1; unsigned char read_labelDetailText : 1; unsigned char read_routePlanningDescription : 1; unsigned char read_trafficDescriptionArtwork : 1; unsigned char read_trafficDescriptionText : 1; unsigned char wrote_anyField : 1; } _flags;
}

@property (readonly, nonatomic) char hasRoutePlanningDescription;
@property (retain, nonatomic) GEORouteInformation *routePlanningDescription;
@property (readonly, nonatomic) char hasLabelDetailText;
...
@property (readonly, nonatomic) char hasLabelAction;
@property (retain, nonatomic) GEOLabelAction *labelAction;
@property (readonly, nonatomic) char hasInfrastructureDescription;
...
@property (readonly, nonatomic) char hasTrafficDescriptionText;
@property (retain, nonatomic) GEOFormattedString *trafficDescriptionText;
@property (readonly, nonatomic) char hasTrafficDescriptionArtwork;
