...
@property (readonly, nonatomic) char isLowFrequency;
...
@property (readonly, nonatomic) char hasWalkingETA;
...
- (char)areOperatingHours:(id)a0 activeForDate:(id)a1;
...
- (char)hasFrequencyAtDate:(id)a0;
- (id)initWithSequence:(id)a0 line:(id)a1 pbLine:(id)a2 stopInfo:(id)a3 container:(id)a4;
- (char)isDepartureDateInactive:(id)a0 withReferenceDate:(id)a1;
- (char)isValidForDate:(id)a0 inTimeZone:(id)a1;
