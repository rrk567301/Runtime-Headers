...
+ (id)_mapItemsFromDirectionsAction:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
+ (id)_mapItemsFromPresentAction:(id)a0 currentLocationIndices:(id *)a1 options:(id *)a2;
+ (id)_mapItemsFromPresentAction:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
+ (id)mapItemsFromURL:(id)a0 currentLocationIndices:(id *)a1 options:(id *)a2;
+ (id)mapItemsFromURL:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
