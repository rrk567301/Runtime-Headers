...
@property (nonatomic) char hasPaymentMethodRegionMuid;
@property (nonatomic) unsigned long long paymentMethodRegionMuid;
@property (readonly, nonatomic) char hasEducationalScreenHeader;
...
@property (readonly, nonatomic) char hasSuggestionTitle;
@property (retain, nonatomic) GEOFormattedString *suggestionTitle;
@property (readonly, nonatomic) char hasSuggestionBody;
