...
+ (char)_validateResource:(unsigned long long)a0 atPath:(id)a1 data:(id *)a2 error:(id *)a3;
+ (char)_validateResource:(unsigned long long)a0 withData:(id)a1 data:(id *)a2 error:(id *)a3;
