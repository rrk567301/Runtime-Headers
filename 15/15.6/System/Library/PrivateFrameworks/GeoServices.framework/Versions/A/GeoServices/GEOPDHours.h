...
@property (readonly, nonatomic) char hasHoursThreshold;
...
+ (char)currentOperatingHoursAvailableForPlaceData:(id)a0 withTimeZone:(id)a1;
+ (char)isValid:(id)a0;
+ (char)operatingHoursAvailableForPlaceData:(id)a0;
