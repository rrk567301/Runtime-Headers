...
@property (readonly, nonatomic) char isOnParkingLotRoad;
@property (readonly, nonatomic) char routeMatchedToEnd;
@property (retain, nonatomic) GEORouteMatch *projectedFrom;
@property (nonatomic) char isTunnelProjection;
@property (nonatomic) char isGoodMatch;
@property (nonatomic) char shouldProjectLocationAlongRoute;
...
- (char)isEqualIgnoringScore:(id)a0;
- (char)routeMatchBehind:(id)a0;
