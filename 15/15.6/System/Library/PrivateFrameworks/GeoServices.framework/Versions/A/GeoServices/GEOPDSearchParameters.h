@class GEOPDAutocompleteEntry, PBUnknownFields, GEOPDViewportInfo, NSMutableArray, NSString, GEOPDSSearchSessionData, GEOPDAutocompleteSessionData, GEOPDSPunchInHints, GEOPDSSearchFilter, GEOPDETAFilter, GEOPDPaginationParameters, GEOPDSearchOriginationInfo, GEOPDRecentRouteInfo, GEOPDSSearchStructureIntentRequestType, GEOPDResultRefinementQuery, GEOPDSSearchEvChargingParameters, GEOPDRetainedSearchMetadata, GEOPDSSearchLocationParameters, GEOPDSInferredSignals, PBDataReader, NSData, GEOPDSSessionUserActionMetadata;
...
- (char)readFrom:(id)a0;
- (void)writeTo:(id)a0;
- (void)addPlaceSummaryRevision:(id)a0;
- (void)addSearchImplicitInfo:(id)a0 idenitfier:(id)a1 categoryID:(id)a2;
- (id)initWithGeoMapItemIdentifier:(id)a0 categoryID:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3 searchSessionData:(id)a4;
- (id)initWithSearchQuery:(id)a0 entryMetadata:(id)a1 metadata:(id)a2 autocompleteEntry:(id)a3 retainedSearch:(id)a4 maxResults:(unsigned int)a5 traits:(id)a6 routeInfo:(id)a7 searchSessionData:(id)a8;
