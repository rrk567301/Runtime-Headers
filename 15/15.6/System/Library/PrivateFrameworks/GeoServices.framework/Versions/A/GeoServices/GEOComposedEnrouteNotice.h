...
@property (readonly, nonatomic) char hasHighlightDistance;
...
@property (readonly, nonatomic) char hasGroupItemHorizontalDisplayOrder;
@property (readonly, nonatomic) unsigned int groupItemHorizontalDisplayOrder;
@property (readonly, nonatomic) char hasGroupItemVerticalDisplayOrder;
@property (readonly, nonatomic) unsigned int groupItemVerticalDisplayOrder;
@property (readonly, nonatomic) char hasPriority;
