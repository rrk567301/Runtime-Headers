...
@property (readonly, nonatomic) char isFlipped;
...
@property (readonly, nonatomic) char isValidTravelDirection;
...
@property (readonly, nonatomic) char isDrivable;
@property (readonly, nonatomic) char isWalkable;
@property (readonly, nonatomic) char isRoadPedestrianNavigable;
...
- (void)updateForDesiredRoadDirectionality:(unsigned long long)a0 isOutboundRoad:(char)a1;
