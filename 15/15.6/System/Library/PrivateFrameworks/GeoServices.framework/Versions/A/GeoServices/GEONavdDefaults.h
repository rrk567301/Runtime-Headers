...
@property (readonly, nonatomic) char useConservativeDepartureForRefreshTimer;
...
@property (readonly, nonatomic) char shouldUseServerSideETAs;
@property (readonly, nonatomic) char transitTTLSupported;
