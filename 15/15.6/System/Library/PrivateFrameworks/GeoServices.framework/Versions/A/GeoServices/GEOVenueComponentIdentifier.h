...
@property (readonly, nonatomic, getter=_hasBuildingID) char hasBuildingID;
...
@property (readonly, nonatomic, getter=_hasUnitID) char hasUnitID;
@property (readonly, nonatomic) unsigned long long unitID;
@property (readonly, nonatomic, getter=_hasFixtureID) char hasFixtureID;
