...
@property (readonly, nonatomic) char hasStateUserSession;
@property (retain, nonatomic) GEOLogMsgStateUserSession *stateUserSession;
@property (nonatomic) char hasSessionBatchIdBits;
@property (nonatomic) unsigned int sessionBatchIdBits;
@property (nonatomic) char hasCollectionTime;
@property (nonatomic) double collectionTime;
@property (readonly, nonatomic) char hasStateOffline;
