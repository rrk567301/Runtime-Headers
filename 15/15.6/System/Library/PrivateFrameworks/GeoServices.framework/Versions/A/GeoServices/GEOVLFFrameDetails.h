@class PBDataReader, GEOVLFUsageTileID, PBUnknownFields;
...
@interface GEOVLFFrameDetails : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_resultTranslationX : 1; unsigned char has_resultTranslationY : 1; unsigned char has_resultTranslationZ : 1; unsigned char has_timestamp : 1; unsigned char has_radialDistortion1 : 1; unsigned char has_radialDistortion2 : 1; unsigned char has_resultStatus : 1; unsigned char has_vioStatus : 1; unsigned char read_unknownFields : 1; unsigned char read_calibrationMatrixs : 1; unsigned char read_resultPoseRotations : 1; unsigned char read_slamPoses : 1; unsigned char read_vioPoses : 1; unsigned char read_tileId : 1; unsigned char wrote_anyField : 1; } _flags;
}

@property (nonatomic) char hasVioStatus;
...
@property (nonatomic) char hasRadialDistortion1;
@property (nonatomic) float radialDistortion1;
@property (nonatomic) char hasRadialDistortion2;
...
@property (nonatomic) char hasResultTranslationX;
@property (nonatomic) double resultTranslationX;
@property (nonatomic) char hasResultTranslationY;
@property (nonatomic) double resultTranslationY;
@property (nonatomic) char hasResultTranslationZ;
