...
@property (nonatomic) char hasShowTransitSchedules;
@property (nonatomic) char showTransitSchedules;
...
@property (readonly, nonatomic) char hasTransitSurchargeOptions;
