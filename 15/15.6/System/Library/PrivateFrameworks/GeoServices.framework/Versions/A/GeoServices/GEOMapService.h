...
@property (class, nonatomic) char shouldResolveAttribution;
...
- (void)resolveMapItemFromHandle:(id)a0 withTraits:(id)a1 useCache:(char)a2 completionHandler:(id /* block */)a3;
- (id)serializedClientMetadataForSiri;
- (id)ticketForVendorSpecificPlaceRefinementRequestParameters:(id)a0 traits:(id)a1;
- (id)_bpod_ticketForIdentifiers:(id)a0 traits:(id)a1;
- (id)_cachedMapItemForHandle:(id)a0 enforceMaxAge:(char)a1;
...
- (void)_resolveMapItemFromHandle:(id)a0 withTraits:(id)a1 cachePolicy:(unsigned long long)a2 coordinateOnlyRefinement:(char)a3 completionHandler:(id /* block */)a4;
- (id)_searchable_ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 floor:(int)a1 includeEntryPoints:(char)a2 shiftLocationsIfNeeded:(char)a3 preserveOriginalLocation:(char)a4 traits:(id)a5;
- (id)_searchable_ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 includeEntryPoints:(char)a1 shiftLocationsIfNeeded:(char)a2 preserveOriginalLocation:(char)a3 traits:(id)a4;
...
- (void)resolveMapItemFromHandle:(id)a0 withTraits:(id)a1 useCache:(char)a2 coordinateOnlyRefinement:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)setDefaultTraitsHardwareIdentifier:(id)a0;
...
- (id)ticketForBatchReverseGeocodeLocations:(id)a0 shiftLocationsIfNeeded:(char)a1 additionalPlaceTypes:(int *)a2 additionalPlaceTypesCount:(unsigned int)a3 placeTypeLimit:(int)a4 traits:(id)a5;
- (id)ticketForBatchReverseGeocodeLocations:(id)a0 shiftLocationsIfNeeded:(char)a1 additionalPlaceTypes:(int *)a2 additionalPlaceTypesCount:(unsigned int)a3 traits:(id)a4;
- (id)ticketForBatchReverseGeocodeLocations:(id)a0 shiftLocationsIfNeeded:(char)a1 traits:(id)a2;
...
- (id)ticketForCategoryListWithTraits:(id)a0 isFromNoQueryState:(char)a1;
...
- (id)ticketForCuratedCollections:(id)a0 isBatchLookup:(char)a1 overrideSuppress:(char)a2 traits:(id)a3;
...
- (id)ticketForPhoneNumbers:(id)a0 allowCellularDataForLookup:(char)a1 traits:(id)a2;
...
- (id)ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 floor:(int)a1 includeEntryPoints:(char)a2 shiftLocationsIfNeeded:(char)a3 preserveOriginalLocation:(char)a4 traits:(id)a5;
- (id)ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 includeEntryPoints:(char)a1 shiftLocationsIfNeeded:(char)a2 preserveOriginalLocation:(char)a3 traits:(id)a4;
- (id)ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 includeEntryPoints:(char)a1 shiftLocationsIfNeeded:(char)a2 traits:(id)a3;
- (id)ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 shiftLocationsIfNeeded:(char)a1 preserveOriginalLocation:(char)a2 traits:(id)a3;
- (id)ticketForReverseGeocodeCoordinate:(struct { double x0; double x1; })a0 shiftLocationsIfNeeded:(char)a1 traits:(id)a2;
- (id)ticketForReverseGeocodeLocation:(id)a0 preserveOriginalLocation:(char)a1 placeTypeLimit:(int)a2 traits:(id)a3;
- (id)ticketForReverseGeocodeLocation:(id)a0 traits:(id)a1;
- (id)ticketForSearchAlongRouteWithCategory:(id)a0 searchQuery:(id)a1 completionItem:(id)a2 originalWaypointRouteData:(id)a3 zilchData:(id)a4 sessionState:(id)a5 routeId:(id)a6 routeAttributes:(id)a7 maxResults:(unsigned int)a8 traits:(id)a9 searchSessionData:(id)a10;
...
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3 searchSessionData:(id)a4;
...
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 relatedSearchSuggestion:(id)a2 retainedSearch:(id)a3 maxResults:(unsigned int)a4 traits:(id)a5 searchSessionData:(id)a6;
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 retainedSearch:(id)a2 maxResults:(unsigned int)a3 suppressResultsRequiringAttribution:(char)a4 traits:(id)a5;
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 retainedSearch:(id)a2 maxResults:(unsigned int)a3 suppressResultsRequiringAttribution:(char)a4 traits:(id)a5 searchSessionData:(id)a6;
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 retainedSearch:(id)a2 maxResults:(unsigned int)a3 traits:(id)a4;
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 retainedSearch:(id)a2 maxResults:(unsigned int)a3 traits:(id)a4 searchSessionData:(id)a5;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 completionItem:(id)a2 retainedSearch:(id)a3 maxResults:(unsigned int)a4 suppressResultsRequiringAttribution:(char)a5 traits:(id)a6;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 completionItem:(id)a2 retainedSearch:(id)a3 maxResults:(unsigned int)a4 suppressResultsRequiringAttribution:(char)a5 traits:(id)a6 searchSessionData:(id)a7;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 maxResults:(unsigned int)a2 suppressResultsRequiringAttribution:(char)a3 traits:(id)a4;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 maxResults:(unsigned int)a2 suppressResultsRequiringAttribution:(char)a3 traits:(id)a4 searchSessionData:(id)a5;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3;
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 maxResults:(unsigned int)a2 traits:(id)a3 searchSessionData:(id)a4;
...
- (id)ticketForTerritoryForLocations:(id)a0 shiftLocationsIfNeeded:(char)a1 traits:(id)a2;
- (id)ticketForTransitDeparturesAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripID:(unsigned long long)a2 includeAllDirectionNames:(char)a3 traits:(id)a4;
...
- (id)ticketForTransitScheduleAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripID:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
- (id)ticketForTransitTripDetailsAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripID:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
...
- (id)ticketForUpdatedTransitScheduleDetailsAtStation:(unsigned long long)a0 line:(unsigned long long)a1 referenceTripID:(unsigned long long)a2 includeAllDirectionNames:(char)a3 routingParameters:(id)a4 traits:(id)a5;
...
- (id)ticketforCategory:(id)a0 maxResults:(unsigned int)a1 traits:(id)a2 searchSessionData:(id)a3;
