...
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2 extraStorage:(id)a3 useWebPlaceCard:(char)a4;
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2 extraStorage:(id)a3 useWebPlaceCard:(char)a4 muninViewState:(id)a5;
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2 mapItemIdentifier:(id)a3;
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2 mapItemIdentifier:(id)a3 extraStorage:(id)a4 useWebPlaceCard:(char)a5;
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2 mapItemIdentifier:(id)a3 extraStorage:(id)a4 useWebPlaceCard:(char)a5 muninViewState:(id)a6;
...
+ (id)URLForInternalBusiness:(id)a0 id:(unsigned long long)a1 provider:(int)a2 coordinate:(struct { double x0; double x1; })a3 address:(id)a4 extraStorage:(id)a5 useWebPlaceCard:(char)a6;
+ (id)URLForInternalBusiness:(id)a0 id:(unsigned long long)a1 provider:(int)a2 coordinate:(struct { double x0; double x1; })a3 address:(id)a4 extraStorage:(id)a5 useWebPlaceCard:(char)a6 enrichmentInfo:(id)a7;
+ (id)URLForInternalBusiness:(id)a0 id:(unsigned long long)a1 provider:(int)a2 coordinate:(struct { double x0; double x1; })a3 address:(id)a4 extraStorage:(id)a5 useWebPlaceCard:(char)a6 muninViewState:(id)a7;
