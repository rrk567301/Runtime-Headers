...
@interface GEONavigationListener : NSObject <GEONavigationServerListenerXPCInterface> {
    ...
    char _isResumingMultipointRoute;
    char _navigationStateInterrupted;
}

@property (readonly, nonatomic) GEOLocation *lastLocation;
@property (readonly, nonatomic) char isResumingMultipointRoute;
...
- (void)navigationStateChanged:(unsigned long long)a0 transportType:(int)a1 isResumingMultipointRoute:(char)a2;
...
- (id)initWithQueue:(id)a0 wantsRoutes:(char)a1;
