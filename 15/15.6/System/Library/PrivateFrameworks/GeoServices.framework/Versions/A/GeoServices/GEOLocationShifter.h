...
- (void).cxx_destruct;
- (void)_reset;
- (char)shiftCoordinate:(struct { double x0; double x1; })a0 accuracy:(double)a1 shiftedCoordinate:(struct { double x0; double x1; } *)a2 shiftedAccuracy:(double *)a3;
...
- (char)shiftLatLng:(id)a0 accuracy:(double)a1 shiftedCoordinate:(struct { double x0; double x1; } *)a2 shiftedAccuracy:(double *)a3;
