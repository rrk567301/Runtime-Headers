...
@property (readonly, nonatomic) char isRecalculating;
...
@property (nonatomic) char hasGuidancePromptsEnabled;
...
@property (nonatomic) char hasLowGuidanceNavigation;
@property (nonatomic) char lowGuidanceNavigation;
@property (nonatomic) char hasHapticsType;
@property (nonatomic) int hapticsType;
@property (nonatomic) char hasIsConnectedToCarplay;
@property (nonatomic) char isConnectedToCarplay;
@property (readonly, nonatomic) char hasAlightMessage;
...
@property (nonatomic) char hasDisplayedStepID;
...
- (char)hasArrivedAtIntermediateWaypointInRoute:(id)a0;
...
- (void)updateFeedbackWithNavigationState:(int)a0 locationUnreliable:(char)a1 announcementStage:(unsigned long long)a2 nextAnnouncementStage:(unsigned long long)a3 nextAnnouncementTime:(double)a4;
