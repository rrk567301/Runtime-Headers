...
@property (readonly, nonatomic) char hasClientSubmissionUuid;
...
@property (readonly, nonatomic) char hasCommonContext;
@property (retain, nonatomic) GEORPFeedbackCommonContext *commonContext;
@property (readonly, nonatomic) char hasCommonCorrections;
@property (retain, nonatomic) GEORPFeedbackCommonCorrections *commonCorrections;
@property (readonly, nonatomic) char hasParentFeedbackId;
@property (retain, nonatomic) NSString *parentFeedbackId;
@property (readonly, nonatomic) char hasDynamicForm;
