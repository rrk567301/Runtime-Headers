...
- (char)_isLocation:(id)a0 nearStation:(id)a1;
- (char)_isLocation:(id)a0 nearStop:(id)a1;
- (char)_isLocation:(id)a0 nearTransitPoint:(struct { double x0; double x1; })a1 transitID:(unsigned long long)a2 featureSize:(double)a3;
