...
+ (id)_infosForRouteLineStyleInfos:(id)a0 pathIndex:(unsigned long long)a1 coordinates:(id)a2 updateable:(char)a3;
+ (id)cameraInfosForGeoWaypointRoute:(id)a0 coordinates:(id)a1 updateable:(char)a2;
+ (id)cameraInfosForRoute:(id)a0 etaRoute:(id)a1;
+ (id)visualInfosForGeoWaypointRoute:(id)a0 coordinates:(id)a1 updateable:(char)a2;
