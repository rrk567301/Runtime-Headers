...
@property (readonly, nonatomic) char hasOriginatingCoordinate;
@property (retain, nonatomic) GEOLatLng *originatingCoordinate;
@property (readonly, nonatomic) char hasInternalDetourInfo;
...
@property (readonly, nonatomic) char hasUserValues;
