...
@property (readonly, nonatomic) char hasLifetimeError;

- (id)description;
- (id)init;
- (void).cxx_destruct;
- (void)cancel;
- (void)_loadAssetMetadataRequireWiFi:(char)a0 unsuccessfulKeysAccumulator:(id)a1 errorsAccumulator:(id)a2 queue:(id)a3 willLoadHandler:(id /* block */)a4 progressHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
- (void)_loadTiles:(id)a0 requireWiFi:(char)a1 unsuccessfulKeysAccumulator:(id)a2 errorsAccumulator:(id)a3 queue:(id)a4 group:(id)a5 willLoadHandler:(id /* block */)a6 progressHandler:(id /* block */)a7;
...
- (void)loadWithCallbackQueue:(id)a0 requireWiFi:(char)a1 willLoadHandler:(id /* block */)a2 progressHandler:(id /* block */)a3 finishedHandler:(id /* block */)a4 errorHandler:(id /* block */)a5;
