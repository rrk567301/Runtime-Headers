...
@property (nonatomic) char hasBackgrounded;
@property (nonatomic) char backgrounded;
@property (nonatomic) char hasRerouteType;
...
@property (nonatomic) char hasBannerDurationSeconds;
@property (nonatomic) double bannerDurationSeconds;
@property (readonly, nonatomic) char hasDisplayedBannerId;
