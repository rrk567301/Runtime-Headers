...
+ (id)_pdHoursFromHour:(long long)a0 fromMinute:(long long)a1 toHour:(long long)a2 toMinute:(long long)a3 inTimeZone:(id)a4 onDay:(long long)a5 month:(long long)a6 year:(long long)a7 openingThreshold:(double)a8 closingThreshold:(double)a9 shouldGoOverMidnight:(char)a10;
