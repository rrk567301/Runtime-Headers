...
@property (nonatomic) char useMapMatchingTilesetForRoads;
...
- (char)_hasLoadedTilesNearCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1 zoomLevel:(unsigned long long)a2 tileStyle:(int)a3 tileSize:(int)a4 tileScale:(int)a5;
- (id)buildMapEdgeTransitFrom:(const struct TransitEdgePiece { id x0; unsigned long long x1; id x2; unsigned int x3; char x4; } *)a0 edgeHandler:(id /* block */)a1;
...
- (char)hasLoadedBuildingTilesNearCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1;
- (char)hasLoadedRoadTilesNearCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1;
- (char)hasLoadedTransitTilesNearCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1;
