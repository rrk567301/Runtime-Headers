...
- (void)_receivedRouteResponse:(id)a0 forLocation:(id)a1 isReroute:(char)a2;
- (void)_requestNewRouteFromLocation:(id)a0 usualRouteData:(id)a1;
- (void)_routeRequestFailed:(id)a0;
- (char)_shouldUpdateETAForRouteMatch:(id)a0;
- (void)_updateLocation:(id)a0 allowServer:(char)a1;
...
- (void)updateLocation:(id)a0 allowServer:(char)a1 hypothesisHandler:(id /* block */)a2;
