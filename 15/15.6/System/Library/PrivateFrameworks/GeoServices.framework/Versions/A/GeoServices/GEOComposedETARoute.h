...
@property (readonly, nonatomic) char hasValidTravelDurations;
...
- (id)navigabilityInfo;
- (char)prepareForRequest:(id)a0 route:(id)a1 routeMatch:(id)a2 targetLegIndex:(unsigned long long)a3 state:(int)a4;
...
- (char)updateForResponse:(id)a0 route:(id)a1;
