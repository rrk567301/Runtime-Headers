...
+ (struct _NSRange { unsigned long long x0; unsigned long long x1; })_appendPointData:(id)a0 toPointData:(id)a1 withContinuity:(char)a2;
...
+ (id)_buildStepInfosFromSteps:(id)a0 withDecoderData:(id)a1 andIsWalkingOnlyRoute:(char)a2 andBuildPointData:(id)a3;
...
+ (char)_shouldBreakPointSectionAtStep:(id)a0 previousStep:(id)a1;
