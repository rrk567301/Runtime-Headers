...
@property (nonatomic) char hasNumberOfKeypoints;
@property (nonatomic) unsigned int numberOfKeypoints;
@property (nonatomic) char hasNumberOfMatches;
@property (nonatomic) unsigned int numberOfMatches;
@property (nonatomic) char hasNumberOfInliers;
...
@property (nonatomic) char hasTKptsMs;
@property (nonatomic) unsigned int tKptsMs;
@property (nonatomic) char hasTMatchMs;
@property (nonatomic) unsigned int tMatchMs;
@property (nonatomic) char hasTPoseMs;
