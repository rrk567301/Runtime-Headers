...
@interface GEOLocalizationCapabilities : PBCodable <NSCopying> {
    ...
    char _supportsLocalizedTrafficControlIcons;
...
@property (nonatomic) char hasSupportsLocalizedTrafficControlIcons;
@property (nonatomic) char supportsLocalizedTrafficControlIcons;
