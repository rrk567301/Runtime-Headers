...
@property (nonatomic) char hasMuid;
@property (nonatomic) unsigned long long muid;
@property (nonatomic) char hasGuidanceSnappingType;
@property (nonatomic) int guidanceSnappingType;
@property (readonly, nonatomic) char hasLineColor;
...
@property (nonatomic) char hasTransitType;
@property (nonatomic) int transitType;
@property (nonatomic) char hasPreferredDepartureTimeStyle;
...
@property (nonatomic) char hasPlaceDisplayStyle;
