...
@property (readonly, nonatomic) char hasEvChargingInfo;
@property (retain, nonatomic) GEOEVChargingInfo *evChargingInfo;
@property (readonly, nonatomic) char hasArInfo;
@property (retain, nonatomic) GEOARInfo *arInfo;
@property (readonly, nonatomic) char hasLocalizedAddress;
...
@property (readonly, nonatomic) char hasWaypointCaption;
