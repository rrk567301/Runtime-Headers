...
@property (readonly, nonatomic) char hasOriginalClientCapabilities;
...
@property (readonly, nonatomic) char hasOriginalRouteAttributes;
@property (retain, nonatomic) GEORouteAttributes *originalRouteAttributes;
@property (readonly, nonatomic) char hasOriginalAdditionalEnabledMarkets;
