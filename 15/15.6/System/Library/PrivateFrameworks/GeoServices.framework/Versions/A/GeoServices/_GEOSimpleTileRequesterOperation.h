...
@property (nonatomic) char shouldDownloadToDisk;
...
@property (readonly, nonatomic) char responseIsCacheable;
...
@property (readonly, nonatomic, getter=isExistingCachedDataCurrent) char existingCachedDataCurrent;
