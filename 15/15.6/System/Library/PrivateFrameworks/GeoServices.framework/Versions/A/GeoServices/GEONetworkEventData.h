...
@property (nonatomic) char hasDataRequestKindType;
@property (nonatomic) int dataRequestKindType;
@property (nonatomic) char hasDataRequestKindSubtype;
...
@property (nonatomic) char hasUsedBackgroundUrl;
@property (nonatomic) char usedBackgroundUrl;
@property (readonly, nonatomic) char hasRequestingAppIdentifier;
@property (retain, nonatomic) NSString *requestingAppIdentifier;
@property (readonly, nonatomic) char hasRequestingAppMajorVer;
@property (retain, nonatomic) NSString *requestingAppMajorVer;
@property (readonly, nonatomic) char hasRequestingAppMinorVer;
...
@property (readonly, nonatomic) char hasManifestEnvironment;
