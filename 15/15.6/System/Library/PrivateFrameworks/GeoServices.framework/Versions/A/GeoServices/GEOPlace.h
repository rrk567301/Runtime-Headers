...
+ (id)_placesFromURL:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
+ (id)_placesFromDirectionsAction:(id)a0 currentLocationIndices:(id *)a1 options:(id *)a2;
+ (id)_placesFromDirectionsAction:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
+ (id)_placesFromPresentAction:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
+ (id)_placesFromShowAction:(id)a0 currentLocationIndices:(id *)a1 options:(id *)a2;
+ (id)_placesFromShowAction:(id)a0 hasCurrentLocation:(char *)a1 currentLocationIndex:(unsigned long long *)a2 options:(id *)a3;
