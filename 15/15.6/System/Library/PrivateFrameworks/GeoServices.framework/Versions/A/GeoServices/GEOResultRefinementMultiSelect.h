...
@property (readonly, nonatomic) char showEqualWidthButtonsOnFilterView;
...
- (id)initWithDisplayName:(id)a0 multiSelect:(id)a1 maximumNumberOfSelectElements:(unsigned int)a2 clauseType:(long long)a3 showEqualWidthButtonsOnFilterView:(char)a4 displayNameForMultiSelected:(id)a5 multiSelectIdentifier:(id)a6;
