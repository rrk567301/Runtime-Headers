...
@property (nonatomic) char hasClientCreatedAt;
...
@property (readonly, nonatomic) char hasSearchCommon;
...
@property (nonatomic) char hasIsSprMap;
@property (nonatomic) char isSprMap;
@property (readonly, nonatomic) char hasCombinedUserPath;
