...
@property (readonly, nonatomic, getter=_hasVenueID) char hasVenueID;
@property (readonly, nonatomic) unsigned long long venueID;
@property (readonly, nonatomic, getter=_hasFeatureID) char hasFeatureID;
@property (readonly, nonatomic) unsigned long long featureID;
@property (readonly, nonatomic, getter=_hasBusinessID) char hasBusinessID;
