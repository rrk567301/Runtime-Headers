...
@property (nonatomic) char shouldLoadAssets;
@property (nonatomic) char forceDisableMetros;
...
- (void)_geodCrashed;
- (void)_loadStep:(id)a0 requireWiFi:(char)a1;
...
- (void)_retryFailuresWithErrorsReset:(char)a0;
