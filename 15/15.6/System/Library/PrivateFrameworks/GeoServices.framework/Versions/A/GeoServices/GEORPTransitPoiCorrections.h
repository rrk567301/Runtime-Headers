...
@property (nonatomic) char hasLineShapeIncorrect;
@property (nonatomic) char lineShapeIncorrect;
@property (nonatomic) char hasLineScheduleDelay;
@property (nonatomic) char lineScheduleDelay;
