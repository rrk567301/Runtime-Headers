...
- (id)opportunisticTaskForNewTileGroup:(id)a0 inResourceManifest:(id)a1 oldTileGroup:(id)a2 activeScales:(id)a3 activeScenarios:(id)a4 activeNames:(id)a5 dataSet:(id)a6;
