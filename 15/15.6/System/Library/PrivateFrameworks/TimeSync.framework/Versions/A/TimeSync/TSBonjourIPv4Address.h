...
@property (nonatomic) char hasLinkLayerAddress;
@property (readonly, nonatomic) unsigned int ipv4Address;
@property (readonly, nonatomic) const char *linkLayerAddress;

+ (char)getLinkLayerAddress:(char *)a0 forIPv4Address:(unsigned int)a1 error:(id *)a2;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)init;
- (char)getLinkLayerAddressError:(id *)a0;
