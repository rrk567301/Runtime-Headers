...
@property (nonatomic) char dailyRefreshInitialized;
...
@property (nonatomic) char persistAPSAfterShutdown;
...
- (void)_tearDownAllAPSConnectionsUnregisteringTopics:(char)a0;
...
- (char)_wrapperIsSuspended:(id)a0;
