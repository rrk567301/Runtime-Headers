...
- (id)_addOrModifyTask:(id)a0 inICSCalendar:(id)a1 withList:(id)a2 shouldMergeProperties:(char)a3 outMergeDidChooseLocalProperties:(char *)a4 inMobileCalendar:(id)a5 batchSaveRequest:(id)a6;
...
- (char)rem_setReminderPropertiesWithBlock:(id /* block */)a0 error:(id *)a1;
...
- (id)saveWithLocalObject:(void *)a0 toContainer:(void *)a1 shouldMergeProperties:(char)a2 outMergeDidChooseLocalProperties:(char *)a3 account:(id)a4 calendar:(id)a5 batchSaveRequest:(id)a6;
