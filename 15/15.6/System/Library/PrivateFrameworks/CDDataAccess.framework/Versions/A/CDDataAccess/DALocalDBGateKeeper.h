...
- (char)_canWakenWaiter:(id)a0;
- (void)_notifyWaitersForDataclasses:(id)a0;
- (void)_registerWaiter:(id)a0 forDataclassLocks:(long long)a1 preempt:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)relinquishLocksForWaiter:(id)a0 dataclasses:(long long)a1 moreComing:(char)a2;
