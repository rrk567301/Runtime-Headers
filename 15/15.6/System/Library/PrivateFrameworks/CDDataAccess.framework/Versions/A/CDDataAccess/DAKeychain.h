...
- (char)canAccessCredentialsWithAccessibility:(int)a0;
- (id)guessPasswordForURL:(id)a0;
- (void)migratePasswordForAccount:(id)a0;
- (id)passwordForAccountWithPersistentUUID:(id)a0 expectedAccessibility:(int)a1 shouldSetAccessibility:(char)a2 passwordExpected:(char)a3;
- (void)removeKeychainInformationsForURL:(id)a0;
- (char)removePasswordForAccount:(id)a0 withPersistentUUID:(id)a1;
- (char)saveKeychainInformationsForURL:(id)a0 andPassword:(id)a1 withAccessibility:(int)a2;
- (char)setPassword:(id)a0 forAccount:(id)a1 withPersistentUUID:(id)a2 withAccessibility:(int)a3;
