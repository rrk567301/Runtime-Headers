...
- (char)cooldownSyncAndReturnError:(id *)a0;
- (void)cooldownWithCompletionHandler:(void (^)(NSError *))a0;
- (id)initFor:(long long)a0 warmup:(char)a1 error:(id *)a2;
- (char)recordDirectFeedbackWithEngagedIds:(id)a0 rejectedIds:(id)a1 ignoredIds:(id)a2 neverPresentedIds:(id)a3 error:(id *)a4;
- (id)resolveAddressToContactForRequest:(id)a0 error:(id *)a1;
...
- (char)warmupSyncFor:(long long)a0 error:(id *)a1;
