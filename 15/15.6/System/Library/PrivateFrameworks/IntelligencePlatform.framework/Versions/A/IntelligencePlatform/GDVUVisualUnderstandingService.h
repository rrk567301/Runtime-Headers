...
- (id)init;
- (void).cxx_destruct;
- (char)keyObservationFor:(id)a0 output:(long long *)a1 error:(id *)a2;
...
- (id)inferredDeviceOwnerWithIgnoreMeGroundTruth:(char)a0;
...
- (char)similarEntitiesTo:(id)a0 error:(id *)a1 body:(id /* block */)a2;
- (char)similarityWithBetween:(id)a0 and:(id)a1 output:(double *)a2 error:(id *)a3;
