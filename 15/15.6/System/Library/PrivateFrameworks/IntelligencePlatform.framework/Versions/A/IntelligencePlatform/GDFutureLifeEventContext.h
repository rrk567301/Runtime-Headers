...
- (char)enumerateFutureActivityEventsInAscendingOrder:(char)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
...
- (char)enumerateEntriesForFutureActivityEventsInAscendingOrder:(char)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
- (id)extremeFutureActivityEventWithEntityIdentifierType:(Class)a0 ascending:(char)a1 outStartDate:(id *)a2 outEndDate:(id *)a3 error:(id *)a4;
