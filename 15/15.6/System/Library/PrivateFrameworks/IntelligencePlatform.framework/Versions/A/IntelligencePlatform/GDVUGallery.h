...
@property (nonatomic, readonly) char ready;
...
- (void).cxx_destruct;
- (void)reportMetrics;
- (char)resetAndReturnError:(id *)a0;
- (id)clustersFor:(id)a0;
- (id)keyObservationsFor:(long long)a0 limit:(long long)a1 offset:(long long)a2;
- (char)mutateAndReturnError:(id *)a0 handler:(id /* block */)a1;
- (char)resetWithType:(long long)a0 error:(id *)a1;
- (char)updateAndReturnError:(id *)a0 progressHandler:(id /* block */)a1;
