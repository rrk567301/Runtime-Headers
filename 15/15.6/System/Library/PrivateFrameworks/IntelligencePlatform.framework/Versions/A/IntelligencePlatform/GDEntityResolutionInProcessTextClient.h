...
- (id)initWithMode:(long long)a0 warmup:(char)a1 error:(id *)a2;
- (void)resolveEntitiesForRequest:(id)a0 completionHandler:(id /* block */)a1;
- (id)generateMentionsForQuery:(id)a0 error:(id *)a1;
- (char)cooldownWithError:(id *)a0;
- (id)initForMode:(long long)a0 error:(id *)a1;
- (char)recordDirectFeedbackWithEngagedIds:(id)a0 rejectedIds:(id)a1 ignored:(id)a2 neverPresented:(id)a3 error:(id *)a4;
...
- (char)warmupForMode:(long long)a0 error:(id *)a1;
