...
@property (readonly, nonatomic) char hasMoreAnswers;
@property (readonly, copy, nonatomic) GDKnosisDebug *debug;

- (void).cxx_destruct;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)initWithQuery:(id)a0 kgq:(id)a1 status:(unsigned long long)a2 answers:(id)a3 errorMessage:(id)a4 limit:(id)a5 offset:(id)a6 hasMoreAnswers:(char)a7 debug:(id)a8;
