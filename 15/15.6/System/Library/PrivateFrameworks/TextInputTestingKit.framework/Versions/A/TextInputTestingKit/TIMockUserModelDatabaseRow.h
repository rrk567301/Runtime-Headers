...
- (char)isMatchForKey:(id)a0 forInputMode:(id)a1 sinceDate:(id)a2;
- (char)isMatchForKeyPrefix:(id)a0 forInputMode:(id)a1 sinceDate:(id)a2;
- (char)isMatchForKeyPrefix:(id)a0 forInputMode:(id)a1 weeklyKeySuffixes:(id)a2 endDate:(id)a3;
- (char)isMatchSinceDate:(id)a0;
