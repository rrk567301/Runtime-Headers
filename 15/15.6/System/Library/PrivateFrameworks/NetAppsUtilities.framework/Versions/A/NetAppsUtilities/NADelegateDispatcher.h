...
- (id)_descriptionForArgument:(id)a0 index:(unsigned long long)a1 format:(char)a2 metadata:(id)a3;
...
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3;
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3 arg1:(id)a4;
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3 arg1:(id)a4 arg2:(id)a5;
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3 arg1:(id)a4 arg2:(id)a5 arg3:(id)a6;
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3 arg1:(id)a4 arg2:(id)a5 arg3:(id)a6 arg4:(id)a7;
- (void)_logEventForSelector:(SEL)a0 metadata:(id)a1 formatArgs:(char)a2 arg0:(id)a3 arg1:(id)a4 arg2:(id)a5 arg3:(id)a6 arg4:(id)a7 arg5:(id)a8;
