...
- (void)_registerWithBackupd:(struct __CFString { } *)a0;
- (void)_teardownDatabaseOnQueue;
- (void)_unregisterWithBackupd:(struct __CFString { } *)a0;
...
- (char)ownsCurrentThreadOtherwiseAssert:(char)a0;
- (void)performBlock:(id /* block */)a0 afterDelay:(double)a1;
- (void)setupDatabaseWithAllowLocalMigration:(char)a0 pathBlock:(id /* block */)a1 setupStoreHandler:(void /* function */ *)a2 connectionInitializer:(void /* function */ *)a3 versionChecker:(void /* function */ *)a4 migrationHandler:(void /* function */ *)a5 schemaVersion:(int)a6 dataProtectionClass:(unsigned int)a7 registerBlock:(id /* block */)a8;
- (void)setupDatabaseWithAllowLocalMigration:(char)a0 pathBlock:(id /* block */)a1 setupStoreHandler:(void /* function */ *)a2 connectionInitializer:(void /* function */ *)a3 versionChecker:(void /* function */ *)a4 migrationHandler:(void /* function */ *)a5 schemaVersion:(int)a6 dataProtectionClass:(unsigned int)a7 registerBlock:(id /* block */)a8 exclusiveOwnership:(char)a9;
