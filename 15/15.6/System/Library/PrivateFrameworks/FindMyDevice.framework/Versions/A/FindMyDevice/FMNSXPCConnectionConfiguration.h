...
@property (class, readonly, nonatomic) FMNSXPCConnectionConfiguration *fmmConfiguration;
@property (class, readonly, nonatomic) FMNSXPCConnectionConfiguration *fmmUserAgentConfiguration;
@property (class, readonly, nonatomic) FMNSXPCConnectionConfiguration *fmmUserAgentServicesConfiguration;
@property (class, readonly, nonatomic) FMNSXPCConnectionConfiguration *sharedConfigurationConfiguration;
...
@property (nonatomic) char machService;
