...
- (id)initWithModelAtURL:(id)a0 key:(id)a1 identifierSource:(long long)a2 cacheURLIdentifier:(id)a3 modelAttributes:(id)a4 standardizeURL:(char)a5;
- (id)initWithModelAtURL:(id)a0 sourceURL:(id)a1 UUID:(id)a2 key:(id)a3 identifierSource:(long long)a4 cacheURLIdentifier:(id)a5 modelAttributes:(id)a6 standardizeURL:(char)a7 string_id:(unsigned long long)a8 generateNewStringId:(char)a9;
