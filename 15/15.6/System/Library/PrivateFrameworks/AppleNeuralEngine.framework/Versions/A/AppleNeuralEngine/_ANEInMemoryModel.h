...
- (id)init;
- (void).cxx_destruct;
- (char)evaluateWithQoS:(unsigned int)a0 options:(id)a1 request:(id)a2 error:(id *)a3;
- (char)loadWithQoS:(unsigned int)a0 options:(id)a1 error:(id *)a2;
- (char)unloadWithQoS:(unsigned int)a0 error:(id *)a1;
- (void)purgeCompiledModel;
- (char)compileWithQoS:(unsigned int)a0 options:(id)a1 error:(id *)a2;
- (char)compiledModelExists;
- (id)compilerOptionsWithOptions:(id)a0 isCompiledModelCached:(char)a1;
- (id)initWithDesctiptor:(id)a0;
- (id)localModelPath;
- (char)mapIOSurfacesWithRequest:(id)a0 cacheInference:(char)a1 error:(id *)a2;
- (id)saveModelFiles;
