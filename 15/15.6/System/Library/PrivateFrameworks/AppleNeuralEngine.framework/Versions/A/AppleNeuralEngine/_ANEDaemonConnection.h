...
- (id)initWithMachServiceName:(id)a0 restricted:(char)a1;
- (void)loadModel:(id)a0 sandboxExtension:(id)a1 options:(id)a2 qos:(unsigned int)a3 withReply:(id /* block */)a4;
- (void)loadModelNewInstance:(id)a0 options:(id)a1 modelInstParams:(id)a2 qos:(unsigned int)a3 withReply:(id /* block */)a4;
