...
@property (nonatomic) char shouldRefreshNameIfPossible;
...
+ (id)tokenWithAddress:(id)a0 isRecent:(char)a1 contact:(id)a2;
...
- (char)_writeToPasteboard:(id)a0 type:(id)a1 forceAddressOnly:(char)a2;
...
- (id)initWithAddress:(id)a0 isRecent:(char)a1 contact:(id)a2;
...
- (char)writeToPasteboard:(id)a0 type:(id)a1;
...
- (id)initWithName:(id)a0 rawAddress:(id)a1 addressType:(long long)a2 isRecent:(char)a3 contact:(id)a4;
