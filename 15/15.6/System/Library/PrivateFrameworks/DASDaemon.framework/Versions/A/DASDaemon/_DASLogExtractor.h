...
- (void)addConditionToHistory:(id)a0 fromMessage:(id)a1 atTimestamp:(id)a2 compactRepresentation:(char)a3;
- (id)copyActivitySummary:(id)a0 startDate:(id)a1 endDate:(id)a2 detail:(char)a3 error:(int *)a4;
- (id)copyApplicationSummary:(id)a0 startDate:(id)a1 endDate:(id)a2 detail:(char)a3 error:(int *)a4;
...
- (char)didActivityRun:(id)a0 forActivity:(id)a1;
...
- (id)getBARSummaryFromLogs:(id)a0 forApplication:(id)a1 detail:(char)a2;
...
- (id)getMessagesActivityFinish:(id)a0 forActivity:(id)a1 isCompleted:(char)a2;
...
- (id)getSummaryFromLogs:(id)a0 forActivity:(id)a1 detail:(char)a2;
- (id)getpolicyToIntervals:(id)a0;
- (int)handleLogEventsLogEvents:(id)a0 sinceDate:(id)a1 withHandler:(id /* block */)a2;
- (id)objectForTrigger:(id)a0 fromCondition:(id)a1 compactRepresentation:(char)a2;
- (int)summarizeActivity:(id)a0 startDate:(id)a1 endDate:(id)a2 detail:(char)a3;
- (id)summarizeAllDenialsOverMessages:(id)a0 forActivity:(id)a1 detail:(char)a2;
- (int)summarizeApplication:(id)a0 startDate:(id)a1 endDate:(id)a2 detail:(char)a3;
- (id)summarizePolicyDenialsOverMessages:(id)a0 maxDuration:(double)a1;
- (id)summarizeRuntimeOverMessages:(id)a0 forActivity:(id)a1;
- (int)sysConditionsLog:(char)a0 startDate:(id)a1 endDate:(id)a2;
