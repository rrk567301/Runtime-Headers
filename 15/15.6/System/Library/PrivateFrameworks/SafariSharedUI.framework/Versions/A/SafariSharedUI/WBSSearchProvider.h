...
@property (readonly, nonatomic) char usesSearchTermsFromFragment;
@property (readonly, nonatomic) char usesSecureSearchURL;
...
@property (readonly, nonatomic) char searchShouldUseSafeSearchTemplate;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (id)defaultProviderInUserVisibleProviders:(id)a0 usingSettings:(id)a1 forPrivateBrowsing:(char)a2;
...
- (char)urlIsHomepage:(id)a0 shouldUseCanonicalRepresentation:(char)a1;
...
- (char)shouldDisplaySearchProviderInContext:(id)a0;
- (id)suggestionsURLForUserTypedString:(id)a0;
- (char)urlIsHomepage:(id)a0;
