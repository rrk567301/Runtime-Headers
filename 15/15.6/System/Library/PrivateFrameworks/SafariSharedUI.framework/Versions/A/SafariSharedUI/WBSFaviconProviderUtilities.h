...
+ (char)isFaviconSize:(struct CGSize { double x0; double x1; })a0 morePreferrableThanFaviconSize:(struct CGSize { double x0; double x1; })a1 givenDesiredSize:(struct CGSize { double x0; double x1; })a2;
