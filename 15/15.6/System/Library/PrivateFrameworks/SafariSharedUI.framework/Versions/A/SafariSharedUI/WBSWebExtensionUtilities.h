...
+ (char)isProfileServerIDForDefaultProfile:(id)a0;
+ (double)nextTabID;
+ (double)nextWindowID;
...
+ (char)validateContentsOfDictionary:(id)a0 requiredKeys:(id)a1 optionalKeys:(id)a2 keyToExpectedValueType:(id)a3 outExceptionString:(id *)a4;
