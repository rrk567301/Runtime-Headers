...
- (char)_setMetadataInfo:(id)a0 forURLString:(id)a1;
...
- (void)linkAndUpdateMetadataInfoForURLString:(id)a0 lastFetchDate:(id)a1 lastFetchDidSucceed:(char)a2 metadataHasImage:(char)a3 completionHandler:(id /* block */)a4;
