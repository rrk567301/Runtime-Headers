...
- (void)registerOneTimeRequestForURLString:(id)a0 withToken:(id)a1 returnDefaultIconIfNoneAvailable:(char)a2 iconSize:(struct CGSize { double x0; double x1; })a3 isURLTypedByUser:(char)a4 completion:(id /* block */)a5;
...
- (void)registerRequestForURLString:(id)a0 withToken:(id)a1 returnDefaultIconIfNoneAvailable:(char)a2 iconSize:(struct CGSize { double x0; double x1; })a3 isURLTypedByUser:(char)a4 completion:(id /* block */)a5;
- (void)_issueRequest:(id)a0 isOneTime:(char)a1 withToken:(id)a2 completion:(id /* block */)a3;
