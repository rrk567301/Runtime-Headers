...
- (char)_anyWebKitSQLiteStoresExistInFolder:(id)a0;
- (void)_copySQLiteStoresFromSafariExtensionFolder:(id)a0 toWebKitExtensionFolder:(id)a1;
- (char)_copySafariSQLiteStoreAndAssociatedFiles:(id)a0 toWebKitSQLiteStore:(id)a1 webKitWebExtensionFolder:(id)a2;
