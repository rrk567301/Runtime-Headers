...
- (void).cxx_destruct;
- (void)generateLockupViewsForAvailableApps:(id)a0 forExtensionImport:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_lockupViewRequestedCompleted:(id)a0 loadedSuccessfully:(char)a1;
