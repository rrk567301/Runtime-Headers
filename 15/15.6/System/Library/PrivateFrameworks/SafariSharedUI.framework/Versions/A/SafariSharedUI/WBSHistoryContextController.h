...
- (void).cxx_destruct;
- (void)contextForPageURL:(id)a0 content:(id)a1 contentType:(long long)a2 metadata:(id)a3 isPrivate:(char)a4 isReaderAvailable:(char)a5 withCompletionHandler:(id /* block */)a6;
