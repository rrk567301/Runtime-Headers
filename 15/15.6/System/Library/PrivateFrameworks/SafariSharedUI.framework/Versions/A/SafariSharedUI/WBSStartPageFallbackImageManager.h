...
- (id)displayableImageForImage:(id)a0 withRequiredImageSize:(struct CGSize { double x0; double x1; })a1 fallbackImageSize:(struct CGSize { double x0; double x1; })a2 fontSize:(double)a3 fontWeight:(long long)a4 fontDesign:(long long)a5 baselineOffset:(double)a6 backgroundColor:(id)a7 cornerRadius:(double)a8 title:(id)a9 url:(id)a10 shouldGenerateGlyph:(char)a11;
