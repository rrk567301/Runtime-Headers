...
- (char)linkPageURLString:(id)a0 toIconURLString:(id)a1;
...
- (void)setImageData:(id)a0 forPageURLString:(id)a1 iconURLString:(id)a2 iconSize:(struct CGSize { double x0; double x1; })a3 hasGeneratedResolutions:(char)a4;
- (void)setIsRejectedResource:(char)a0 forPageURLString:(id)a1 iconURLString:(id)a2;
