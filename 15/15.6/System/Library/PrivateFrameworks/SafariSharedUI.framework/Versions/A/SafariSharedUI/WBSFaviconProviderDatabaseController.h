...
- (char)_deleteRejectedResourceForPageURLString:(id)a0 iconURLString:(id)a1;
...
- (char)_hasPageURLsForIconUUID:(id)a0;
- (id)_setIconUUID:(id)a0 forIconURLString:(id)a1 size:(struct CGSize { double x0; double x1; })a2 hasGeneratedResolutions:(char)a3;
- (void)_setPageURL:(id)a0 toIconUUID:(id)a1;
- (char)_setRejectedResourceForPageURL:(id)a0 iconURLString:(id)a1;
...
- (void)linkAndUpdateTimestampForIconWithPageURLString:(id)a0 iconURLString:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 iconHasGeneratedResolutions:(char)a3 completionHandler:(id /* block */)a4;
