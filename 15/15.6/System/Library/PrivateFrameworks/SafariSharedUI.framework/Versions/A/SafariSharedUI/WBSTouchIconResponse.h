...
@property (readonly, nonatomic, getter=isGenerated) char generated;
...
+ (id)responseWithURL:(id)a0 touchIcon:(id)a1 generated:(char)a2 extractedBackgroundColor:(id)a3;
