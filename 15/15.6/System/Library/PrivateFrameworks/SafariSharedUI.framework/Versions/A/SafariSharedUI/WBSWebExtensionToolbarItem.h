...
@property (readonly, nonatomic) char showingExtensionPopup;
...
- (char)shouldRequestAccessForTab:(id)a0;
- (id)badgeTextForTab:(id)a0;
- (void)didViewBadgeInTab:(id)a0;
- (char)hasUpdatedBadgeTextInTab:(id)a0;
- (char)isEnabledForTab:(id)a0;
