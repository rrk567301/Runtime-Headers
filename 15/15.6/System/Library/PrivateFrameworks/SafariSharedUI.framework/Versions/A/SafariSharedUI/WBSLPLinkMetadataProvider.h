...
- (char)_isImageInMetadata:(id)a0;
- (void)_notifyResponse:(id)a0 ofType:(long long)a1 didReceiveNewData:(char)a2 forRequest:(id)a3;
...
- (char)_shouldStartFetchOperationForRequest:(id)a0 withMetadataInfo:(id)a1;
- (char)_shouldUseWebViewToUpdateMetadataWithInfo:(id)a0 request:(id)a1 existingOperation:(id)a2;
- (void)_storeAndNotifySuccessfulResponseForRequest:(id)a0 withMetadata:(id)a1 didReceiveNewData:(char)a2;
