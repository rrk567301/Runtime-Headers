...
@interface WBSFaviconProvider : NSObject <WBSWebViewMetadataFetchOperationDelegate, WBSSiteMetadataProvider> {
    ...
    char _isSavingPendingChangesBeforeTermination;
...
- (id)initWithPersistenceBaseURL:(id)a0 persistenceName:(id)a1 preferredIconSize:(struct CGSize { double x0; double x1; })a2 atScale:(double)a3 allScales:(id)a4 isReadOnly:(char)a5 shouldCheckIntegrityWhenOpeningDatabaseBlock:(id /* block */)a6;
- (void)linkIconFromPageURL:(id)a0 toCurrentPageURL:(id)a1 isPrivate:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)saveFaviconImageData:(id)a0 iconURL:(id)a1 pageURL:(id)a2 originalPageURL:(id)a3 size:(struct CGSize { double x0; double x1; })a4 isPrivate:(char)a5 completionHandler:(id /* block */)a6;
- (void)setUpWithCompletionHandler:(id /* block */)a0;
- (void)shouldIconDataBeSavedForIconWithPageURL:(id)a0 originalPageURL:(id)a1 iconURL:(id)a2 size:(struct CGSize { double x0; double x1; })a3 isPrivate:(char)a4 completionHandler:(id /* block */)a5;
- (void)stopWatchingUpdatesForRequest:(id)a0;
- (void)_addCachedResponse:(id)a0 forRequest:(id)a1;
- (void)_atomicallyLinkPageURLs:(id)a0 toIconWithInfo:(id)a1 isPrivate:(char)a2;
- (void)_atomicallySaveImageData:(id)a0 iconURL:(id)a1 pageURL:(id)a2 originalPageURL:(id)a3 size:(struct CGSize { double x0; double x1; })a4 isPrivate:(char)a5 completionHandler:(id /* block */)a6;
- (id)_cachedResponseForRequest:(id)a0;
- (void)_confirmImageDataShouldBeSaved:(id)a0 size:(struct CGSize { double x0; double x1; })a1 pageURL:(id)a2 iconURL:(id)a3 includingPrivateData:(char)a4 completionHandler:(id /* block */)a5;
- (id)_createSemaphoreAndAddToWebViewImageOperationSemaphoresIfNecessary:(char *)a0;
- (void)_getIconForRequest:(id)a0 withCompletionHandler:(id /* block */)a1;
- (id)_hostFromRequest:(id)a0;
- (id)_hostFromURL:(id)a0;
- (char)_isIconDateExpired:(id)a0;
- (void)_linkPageURL:(id)a0 toIconWithInfo:(id)a1 isPrivate:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)_prepareAndSendResponseForRequests:(id)a0 forceDidReceiveNewData:(char)a1;
...
- (void)_saveImageData:(id)a0 iconURL:(id)a1 pageURL:(id)a2 originalPageURL:(id)a3 size:(struct CGSize { double x0; double x1; })a4 isPrivate:(char)a5 completionHandler:(id /* block */)a6;
- (char)_shouldRejectIconWithBadData;
...
- (void)_updateOutstandingRequestsForPageURL:(id)a0 forceDidReceiveNewData:(char)a1;
