@class UABestAppSuggestionManager, WBSForYouPerSitePreferenceManager, NSArray, NSString, WBSForYouDataSourceWeightManager, UABestAppSuggestion, NSCache, CKContextClient, NSObject, WBSFoundInRecommendationManager, NSMutableSet, WBSForYouTopicManager;
...
+ (void)_rankRecommendationsInPlace:(id)a0 history:(id)a1 weightManager:(id)a2 suppressHistoryDeduplication:(char)a3;
...
- (void)banURLsOfSameDomainAsURL:(id)a0 postingChangeNotificationWhenDone:(char)a1;
- (void)downvoteSource:(unsigned long long)a0 postingChangeNotificationWhenDone:(char)a1;
