...
@property (readonly, nonatomic, getter=isPrivateBrowsingEnabled) char privateBrowsingEnabled;
...
+ (id)bannerWithImage:(id)a0 title:(id)a1 message:(id)a2 interactive:(char)a3 dismissHandler:(id /* block */)a4;
...
+ (id)privacyReportBannerWithNumberOfTrackers:(long long)a0 privateBrowsingEnabled:(char)a1 privacyReportData:(id)a2 selectionHandler:(id /* block */)a3;
