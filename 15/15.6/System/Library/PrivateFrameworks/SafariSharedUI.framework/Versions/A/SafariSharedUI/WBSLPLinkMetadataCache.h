...
@property (readonly, nonatomic) char storesMetadataOnDisk;
...
- (char)_isMetadataExpiredWithInfo:(id)a0;
- (char)_isUsingInMemoryDatabase;
- (void)_purgeMetadataForURLStrings:(id)a0 completionHandler:(id /* block */)a1;
- (void)_setMetadata:(id)a0 forURLString:(id)a1 lastFetchDate:(id)a2 lastFetchDidSucceed:(char)a3 metadataHasImage:(char)a4 existingInfo:(id)a5 completionHandler:(id /* block */)a6;
...
- (char)isMetadataCachedWithInfo:(id)a0;
...
- (void)setMetadata:(id)a0 forURLString:(id)a1 lastFetchDate:(id)a2 lastFetchDidSucceed:(char)a3 metadataHasImage:(char)a4 completionHandler:(id /* block */)a5;
