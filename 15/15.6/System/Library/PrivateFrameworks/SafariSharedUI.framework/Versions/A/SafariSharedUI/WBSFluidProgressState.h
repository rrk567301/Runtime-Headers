...
@property (readonly, nonatomic) char isFluidProgressStalled;
...
@property (nonatomic) char hasCompletedLoad;
@property (nonatomic) char hasCanceledLoad;
@property (nonatomic) char hasCommittedLoad;
@property (nonatomic) char shouldAnimateUsingInitialPosition;
