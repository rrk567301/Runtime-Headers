...
- (id)appearanceIfImageExists:(char)a0;
- (void)cacheImageFromURL:(id)a0 completion:(id /* block */)a1;
- (void)clearImageWithIdentifier:(id)a0 withinProfile:(char)a1;
- (void)clearPrefetchedImage;
- (void)commitPrefetchedImageWithLuminance:(double)a0 forIdentifier:(id)a1 isGeneratedImage:(char)a2 withinProfile:(char)a3;
...
- (char)hasGlobalBackgroundImage;
- (char)hasProfileSpecificBackgroundImage:(id)a0;
- (id)imageForIdentifier:(id)a0 forProfile:(id)a1;
- (char)isCorrectBackgroundImageLoadedForIdentifier:(id)a0;
...
- (void)processImageForIdentifier:(id)a0 isGeneratedImage:(char)a1 withinProfile:(char)a2;
- (void)processImageForIdentifier:(id)a0 isGeneratedImage:(char)a1 withinProfile:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)_commitImage:(id)a0 appearanceName:(id)a1 luminance:(double)a2 forIdentifier:(id)a3 isGeneratedImage:(char)a4 withinProfile:(char)a5 completionHandler:(id /* block */)a6;
- (void)_deleteImageWithIdentifier:(id)a0;
- (id)_fetchImage:(id)a0 source:(struct CGImageSource { } *)a1 adjustForDarkAppearance:(char)a2;
- (double)_iconOpacityForBackgroundColor:(id)a0 forDarkIcon:(char)a1;
- (char)_isColorSpaceIncompatibleForThresholdingInImage:(struct CGImage { } *)a0;
- (char)_isGeneratedBackgroundImageInImageSource:(struct CGImageSource { } *)a0;
...
- (unsigned long long)_primaryIndexForImage:(id)a0 source:(struct CGImageSource { } *)a1 adjustForDarkAppearance:(char)a2;
- (void)_processImageForIdentifier:(id)a0 isGeneratedImage:(char)a1 withinProfile:(char)a2 completionHandler:(id /* block */)a3;
- (void)_readImagePropertiesFromImageSource:(struct CGImageSource { } *)a0 forImageIdentifier:(id)a1 isNonGlobalBackgroundImage:(char)a2;
- (void)_saveImage:(id)a0 appearance:(id)a1 luminance:(double)a2 forIdentifier:(id)a3 isGeneratedImage:(char)a4 withinProfile:(char)a5 completion:(id /* block */)a6;
- (void)_setHasProfileSpecificBackgroundImage:(char)a0 forIdentifier:(id)a1;
- (void)_setHasTabGroupSpecificBackgroundImage:(char)a0 forIdentifier:(id)a1;
...
- (char)_tabGroupShouldInheritProfileBackgroundImage:(id)a0 forProfileWithIdentifier:(id)a1;
- (char)_tabGroupShouldUseGlobalBackgroundImage:(id)a0 forProfileWithIdentifier:(id)a1;
- (id)_templateImageWithImage:(id)a0 color:(id)a1;
- (id)_thumbnailForImage:(id)a0 source:(struct CGImageSource { } *)a1 adjustForDarkAppearance:(char)a2;
...
- (char)hasTabGroupSpecificBackgroundImage:(id)a0;
