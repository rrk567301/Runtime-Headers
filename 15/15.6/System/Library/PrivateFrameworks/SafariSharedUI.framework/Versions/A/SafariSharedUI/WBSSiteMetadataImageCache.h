...
@property (readonly, nonatomic, getter=isTerminating) char terminating;
...
- (void)_didLoadImage:(id)a0 forKeyString:(id)a1 fromDisk:(char)a2;
...
- (char)_internalDidLoadImageAndShouldNotify:(id)a0 forKeyString:(id)a1 fromDisk:(char)a2;
...
- (char)isImageRetainedForKeyString:(id)a0;
