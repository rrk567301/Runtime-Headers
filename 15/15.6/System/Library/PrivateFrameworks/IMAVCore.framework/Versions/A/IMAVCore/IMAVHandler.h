...
- (void)account:(id)a0 avAction:(unsigned int)a1 withArguments:(id)a2 toAVChat:(id)a3 isVideo:(char)a4;
- (void)account:(id)a0 conference:(id)a1 changedToNewConferenceID:(id)a2;
- (void)account:(id)a0 conference:(id)a1 invitationSentSuccessfully:(char)a2;
...
- (void)_notifyOfIncomingInvitationFor:(id)a0 notifyInvitationListeners:(char)a1;
