...
- (void)_deliverConnectionStatusChange:(char)a0;
...
- (void)setEnabledTopicsAreInteractive:(char)a0;
...
- (void)_asyncOnDelegateQueueWithBlock:(id /* block */)a0 requiresDelegate:(char)a1;
- (void)_cancelConnectionOnIvarQueue;
- (void)_connectIfNecessary;
- (void)_connectIfNecessaryOnIvarQueue;
- (void)_deliverConnectionStatusFromDealloc:(char)a0;
...
- (id)_initWithEnvironmentName:(id)a0 namedDelegatePort:(id)a1 enablePushDuringSleep:(char)a2 personaUniqueString:(id)a3 queue:(id)a4;
...
- (void)_onIvarQueue_setEnabledTopics:(id)a0 ignoredTopics:(id)a1 opportunisticTopics:(id)a2 nonWakingTopics:(id)a3 sendToDaemon:(char)a4 completion:(id /* block */)a5;
...
- (void)_sendOutgoingMessage:(id)a0 fake:(char)a1;
- (void)_sendPerAppTokenRequestForTopic:(id)a0 identifier:(id)a1;
- (void)_setEnableStatusNotifications:(char)a0 sendToDaemon:(char)a1;
- (void)_setEnabledTopics:(id)a0 ignoredTopics:(id)a1 opportunisticTopics:(id)a2 nonWakingTopics:(id)a3 sendToDaemon:(char)a4 completion:(id /* block */)a5;
- (void)_setTrackActivityPresence:(char)a0 sendToDaemon:(char)a1;
...
- (void)calloutToInvalidateCompletion:(id /* block */)a0 withSuccess:(char)a1 error:(id)a2;
...
- (id)initWithEnvironmentName:(id)a0 namedDelegatePort:(id)a1 enablePushDuringSleep:(char)a2 personaUniqueString:(id)a3 queue:(id)a4;
- (id)initWithEnvironmentName:(id)a0 namedDelegatePort:(id)a1 enablePushDuringSleep:(char)a2 queue:(id)a3;
...
- (void)setEnableCriticalReliability:(char)a0;
- (void)setEnableStatusNotifications:(char)a0;
