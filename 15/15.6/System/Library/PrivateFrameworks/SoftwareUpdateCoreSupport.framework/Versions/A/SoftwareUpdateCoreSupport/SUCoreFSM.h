...
@property (nonatomic) char performingEvent;
...
- (char)_activateMachineWithStateTable:(id)a0 withActionTable:(id)a1;
- (id)_initMachine:(id)a0 ofInstance:(id)a1 withTable:(id)a2 startingIn:(id)a3 usingDelegate:(id)a4 registeringAllInfoClass:(Class)a5 registeringAndActivating:(char)a6;
- (void)_performEvent:(id)a0 withInfo:(id)a1 issueType:(id)a2 forCell:(id)a3 attachedAction:(id)a4 checkingAttached:(char)a5;
- (void)_postEvent:(id)a0 withInfo:(id)a1;
- (void)_registerAction:(id)a0 ForEvent:(id)a1 inState:(id)a2 usingDelegate:(id)a3 withInfoClass:(Class)a4 actionTable:(id)a5 loggingRegistration:(char)a6;
- (void)_registerAllActions:(id)a0 withInfoClass:(Class)a1 stateTable:(id)a2 actionTable:(id)a3 loggingRegistration:(char)a4;
