...
@property (nonatomic) char splunkAccessCreated;
@property (nonatomic) char eventExtensionsDetermined;
@property (retain, nonatomic) NSMutableDictionary *eventExtensions;
@property (nonatomic) int activeSendTaskCount;
@property (nonatomic) char dropEventsOnSendFailure;
...
- (void)_removeFileUUID:(id)a0 loggingError:(char)a1 forReason:(id)a2;
...
- (char)_storeServerURLMetadata:(id)a0 toFileUUID:(id)a1;
...
- (void)dropOnSendFailure:(char)a0;
- (void)handleSendFinishedInvalidFileUUID:(id)a0 withError:(id)a1;
- (void)handleSendFinishedWithFileUUID:(id)a0 sendSucceeded:(char)a1 withStatusCode:(long long)a2 withError:(id)a3;
- (id)initStoringToPath:(id)a0;
- (id)initStoringToPath:(id)a0 withAccessControl:(long long)a1;
- (char)sendEvent:(id)a0 returningFinalEventDictionary:(id *)a1;
- (char)sendEvent:(id)a0 toServerURL:(id)a1;
- (char)sendEvent:(id)a0 toServerURL:(id)a1 returningFinalEventDictionary:(id *)a2;
