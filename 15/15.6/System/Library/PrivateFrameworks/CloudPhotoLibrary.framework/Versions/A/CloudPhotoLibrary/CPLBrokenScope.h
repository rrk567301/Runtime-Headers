...
@property (readonly, nonatomic) char shouldShowAlertToUser;
@property (readonly, nonatomic) char hasEngineRecoveryMechanism;
...
- (void)_showAlertWithMessage:(id)a0 readMoreURL:(id)a1 createRadarURL:(id)a2 showsRecoverButton:(char)a3;
