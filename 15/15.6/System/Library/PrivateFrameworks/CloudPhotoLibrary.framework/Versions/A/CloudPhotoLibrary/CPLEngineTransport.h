...
- (void)cancelBlockedTasksIncludingBackground:(char)a0;
...
- (char)getProposedStagingScopeIdentifier:(id *)a0 stagingTransportScope:(id *)a1 forScope:(id)a2 transportScope:(id)a3 transportUserIdentifier:(id)a4;
...
- (char)isNewTransportScope:(id)a0 compatibleWithOldTransportScope:(id)a1;
...
- (id)setupTaskUpdateDisabledFeatures:(char)a0 completionHandler:(id /* block */)a1;
- (id)sharedLibraryServerRampTaskWithCompletionHandler:(id /* block */)a0;
- (char)shouldIgnoreScopeWithIdentifier:(id)a0;
