...
+ (id)scopedIdentifierWithString:(id)a0 includeScopeIndex:(char)a1;
+ (id)scopedIdentifierWithString:(id)a0 includeScopeIndex:(char)a1 defaultScopeIdentifier:(id)a2;
...
- (char)isInAMomentShare;
- (unsigned long long)cplSpecialHash;
- (char)cplSpecialIsEqual:(id)a0;
