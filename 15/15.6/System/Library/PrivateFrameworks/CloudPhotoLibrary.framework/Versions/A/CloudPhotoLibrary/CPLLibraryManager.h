...
@interface CPLLibraryManager : NSObject <CPLAbstractObject> {
    ...
    char _preventObserving;
    char _forManagement;
    char _hasFetchedBoundaryKey;
}
...
- (void)fetchComputeStatesForRecordsWithScopedIdentifiers:(id)a0 validator:(id)a1 onDemand:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)_closeDeactivating:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)_getMappedIdentifiersForIdentifiers:(id)a0 inAreLocalIdentifiers:(char)a1 completionHandler:(id /* block */)a2;
- (void)_getMappedScopedIdentifiersForScopedIdentifiers:(id)a0 inAreLocalIdentifiers:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)_setStatus:(unsigned long long)a0 andError:(id)a1;
...
- (void)beginDownloadForResource:(id)a0 clientBundleID:(id)a1 highPriority:(char)a2 proposedTaskIdentifier:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)beginDownloadForResource:(id)a0 highPriority:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)setShouldOverrideSystemBudgetsForSyncSession:(char)a0;
