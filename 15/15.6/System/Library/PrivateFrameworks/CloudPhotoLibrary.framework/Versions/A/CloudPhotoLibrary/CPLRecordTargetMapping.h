...
@property (readonly, nonatomic) char hasUnknownTargets;
...
@property (readonly, nonatomic) char hasUpdatedTargets;
...
- (id)init;
- (void).cxx_destruct;
- (void)_setTarget:(id)a0 forRecordWithScopedIdentifier:(id)a1 isUpdate:(char)a2;
