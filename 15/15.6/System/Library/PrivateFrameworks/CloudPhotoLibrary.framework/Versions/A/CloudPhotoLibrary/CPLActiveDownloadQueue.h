...
@property (readonly, nonatomic, getter=isFIFOQueue) char FIFOQueue;
...
@property (readonly, nonatomic) char isHighPriority;
...
- (id)initWithName:(id)a0 type:(unsigned long long)a1 FIFOQueue:(char)a2 maximumBatchSize:(unsigned long long)a3 maximumConcurrentTransportTasks:(unsigned long long)a4 coalescingInterval:(long long)a5 groupConstructor:(id /* block */)a6;
