...
@interface CPLEngineScheduler : NSObject <CPLAbstractObject, CPLEngineComponent> {
    ...
    char _needsToUpdateLastSyncDate;
    char _nextSessionShouldRequestMoreTime;
    char _lastSessionWasDeferredBecauseOfTimeButDidNotRequestMoreTime;
...
@property (readonly, nonatomic) char hasAScheduledSyncSession;
...
- (void)_startSyncSession:(id)a0 withMinimalPhase:(unsigned long long)a1 rewind:(char)a2;
...
- (void)blockAllSyncSessionsWithReason:(id)a0 onlyIfBlocked:(char)a1 block:(id /* block */)a2;
...
- (char)isSynchronizationDisabledWithReasonError:(id *)a0;
...
- (char)waitForEngineElementToBeBlocked:(id)a0 timeout:(double)a1;
