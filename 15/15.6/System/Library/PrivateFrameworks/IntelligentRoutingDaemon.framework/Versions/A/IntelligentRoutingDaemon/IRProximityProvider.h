...
@property (nonatomic) char isUwbFenceSessionStarted;
...
+ (char)didContainer:(id)a0 changeWithUpdatetContainer:(id)a1 andRangeThreshold:(double)a2;
+ (char)isBLEProximityType:(id)a0;
+ (char)isUWBProximityType:(id)a0;
...
- (char)_isPdedestrianFenceAvailable;
