...
+ (char)isGlobalLowLatencyMiLoWithPersistenceManager:(id)a0;

- (void)dealloc;
- (void).cxx_destruct;
- (id)initWithQueue:(id)a0;
- (char)shouldAcceptNewConnection:(id)a0;
...
- (char)unregisterWithServiceIdentifier:(id)a0 withConnection:(id)a1;
