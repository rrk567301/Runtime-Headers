...
@property (nonatomic) char isLowLatencyMiLo;
...
- (void)_checkAndStartLowLatencyMiLoIfNeededWithForce:(char)a0 historyEventsContainer:(id)a1;
...
- (id)getStatistics;
- (id)initWithService:(id)a0 queue:(id)a1 delegate:(id)a2 avOutputDeviceProvider:(id)a3 biomeProvider:(id)a4 miloProvider:(id)a5 rapportProvider:(id)a6 proximityProvider:(id)a7 serviceStore:(id)a8 displayMonitor:(id)a9 audioAVOutputContextController:(id)a10 isLowLatencyMiLo:(char)a11;
