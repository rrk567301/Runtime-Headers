...
@property (nonatomic) char calculateScoreWithoutPortion;

+ (char)_filterHistoryBySameApp:(id)a0 withSystemState:(id)a1;
+ (char)filterHistoryByBrokeredDeviceScan:(id)a0;
+ (char)filterHistoryBySimilarApp:(id)a0 withSystemState:(id)a1;

- (id)init;
- (void).cxx_destruct;
- (char)_filterHistoryByEventsToWatch:(id)a0;
- (char)_filterHistoryByMilo:(id)a0 withMiloPrediction:(id)a1;
- (char)_filterHistoryBySameDay:(id)a0 comparedToDate:(id)a1 withSystemState:(id)a2;
- (char)_filterHistoryBySameLoi:(id)a0 withSystemState:(id)a1;
- (char)_filterHistoryByTimeInterval:(id)a0 comparedToDate:(id)a1;
- (id)_filterHistoryEvents:(id)a0 withSystemState:(id)a1 date:(id)a2 miloPrediction:(id)a3 candiatesContainer:(id)a4;
- (char)_filterHistorywithSameCandidates:(id)a0 withSameCandidates:(id)a1;
