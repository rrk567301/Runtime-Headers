...
+ (char)_isClientAllowedCA:(id)a0;
+ (char)logUiEvent:(id)a0 withService:(id)a1 forCandidateIdentifier:(id)a2 systemStateManager:(id)a3 candidatesContainer:(id)a4 inspections:(id)a5 statisticsManager:(id)a6 historyEventsContainer:(id)a7;
