...
- (void)registerForRepeatingBackgroundXPCActivityWithIdentifier:(id)a0 interval:(long long)a1 isDiskIntensive:(char)a2 isMemoryIntensive:(char)a3 handler:(id /* block */)a4;
