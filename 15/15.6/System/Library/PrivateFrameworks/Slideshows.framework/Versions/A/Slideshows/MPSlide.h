...
- (char)determineShowTime:(double *)a0 showDuration:(double *)a1;
...
- (id)fullDebugLog;
- (char)hasAnimationPathForKey:(id)a0;
...
- (char)isPanoramaInDocument:(id)a0;
...
- (void)setMirrorToDuplicatePaths:(char)a0;
