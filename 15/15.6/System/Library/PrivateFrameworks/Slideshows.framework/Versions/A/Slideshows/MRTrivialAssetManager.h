...
- (void)dealloc;
- (id)init;
- (struct CGImage { } *)CGImageForAssetAtPath:(id)a0 andSize:(struct CGSize { double x0; double x1; })a1 orientation:(char *)a2 thumbnailIfPossible:(char)a3 now:(char)a4;
- (struct __IOSurface { } *)IOSurfaceForAssetAtPath:(id)a0 andSize:(struct CGSize { double x0; double x1; })a1 orientation:(char *)a2;
- (char)isSupportedMovieForAssetAtPath:(id)a0;
