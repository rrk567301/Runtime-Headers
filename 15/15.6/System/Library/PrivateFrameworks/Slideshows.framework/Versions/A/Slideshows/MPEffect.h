...
- (void)_updateEffectTimingWithDocument:(id)a0 forExport:(char)a1;
- (void)_updateTiming:(char)a0;
- (void)_updateTiming:(char)a0 forExport:(char)a1;
...
- (void)createTextsWithStrings:(id)a0 secondLineFactor:(double)a1 fillIn:(char)a2;
- (id)effectAttributeForKey:(id)a0;
- (id)effectAttributes;
- (id)effectPresetID;
- (id)formattedAttributes;
- (id)fullDebugLog;
- (char)hasPanoramasInDocument:(id)a0;
...
- (void)setSkipEffectTiming:(char)a0;
