...
- (void)renderEffect2AtTime:(double)a0 movieVersion:(char)a1 inContext:(id)a2 withArguments:(id)a3;
- (void)renderEffect3AtTime:(double)a0 movieVersion:(char)a1 inContext:(id)a2 withArguments:(id)a3;
- (void)renderEffect4AtTime:(double)a0 movieVersion:(char)a1 inContext:(id)a2 withArguments:(id)a3;
- (void)renderEffect5AtTime:(double)a0 movieVersion:(char)a1 inContext:(id)a2 withArguments:(id)a3;
- (void)renderEffect6AtTime:(double)a0 movieVersion:(char)a1 inContext:(id)a2 withArguments:(id)a3;
