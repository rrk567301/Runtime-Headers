...
- (void)_drawPortraitBreakForLandscapeAtTime:(double)a0 duration:(double)a1 onePage:(char)a2 inContext:(id)a3 withArguments:(id)a4;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_rectForSlideAtIndex:(long long)a0 frame:(id)a1 leftCount:(long long)a2 movie:(char)a3 localAspectRatio:(double)a4;
...
- (void)_renderPortraitBreakPageAtIndex:(long long)a0 flipped:(char)a1 onePage:(char)a2 atTime:(double)a3 inContext:(id)a4 withArguments:(id)a5;
- (void)_renderXLPageAtIndex:(long long)a0 flipped:(char)a1 atTime:(double)a2 inContext:(id)a3 withArguments:(id)a4;
