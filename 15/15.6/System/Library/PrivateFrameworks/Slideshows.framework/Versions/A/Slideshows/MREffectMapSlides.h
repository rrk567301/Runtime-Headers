...
- (void)renderKey:(id)a0 shadow:(id)a1 shadowRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 size:(struct CGSize { double x0; double x1; })a3 position:(struct CGPoint { double x0; double x1; })a4 xRot:(double)a5 tX:(double)a6 isPano:(char)a7 time:(double)a8 inContext:(id)a9 withArguments:(id)a10;
