...
- (void)setSettingAlwaysBounceVertical:(char)a0;
- (void)setSettingAlwaysBounceHorizontal:(char)a0;
- (void)setSettingContentSize:(struct CGSize { double x0; double x1; })a0;
- (void)setSettingIndicatorStyle:(unsigned long long)a0;
- (void)setSettingShowsHorizontalScrollIndicator:(char)a0;
- (void)setSettingShowsVerticalScrollIndicator:(char)a0;
