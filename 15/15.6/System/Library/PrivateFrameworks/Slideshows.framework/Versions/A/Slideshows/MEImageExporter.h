...
+ (id)operationWithOriginalPath:(id)a0 size:(struct CGSize { double x0; double x1; })a1 blackWhite:(char)a2 andDestinationPath:(id)a3;
...
- (id)initWithOriginalPath:(id)a0 size:(struct CGSize { double x0; double x1; })a1 blackWhite:(char)a2 andDestinationPath:(id)a3;
