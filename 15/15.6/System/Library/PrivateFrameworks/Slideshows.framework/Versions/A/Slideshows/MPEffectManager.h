...
- (id)allCategoryIDs;
- (id)allEffectIDs;
- (char)allowTextCustomizationForEffectID:(id)a0 presetID:(id)a1 forTextAtIndex:(long long)a2;
...
- (id)defaultStringForTextInEffectID:(id)a0 presetID:(id)a1 atIndex:(long long)a2 needsNSConversion:(char)a3;
- (id)descriptionForEffectID:(id)a0;
- (double)durationPaddingForEffectID:(id)a0;
- (char)effectDoesAccumulate:(id)a0;
- (id)effectIDsForCategoryID:(id)a0;
- (char)effectNeedsPanoInformation:(id)a0;
- (char)effectNeedsRandomSeedInformation:(id)a0;
...
- (char)posterTimeIsStaticForEffectID:(id)a0 andPresetID:(id)a1;
...
- (char)skipPanoramaScaleForEffectID:(id)a0;
- (id)thumbnailForEffectID:(id)a0;
- (char)useUppercaseForEffectID:(id)a0 presetID:(id)a1 forTextAtIndex:(long long)a2;
