...
- (char)isAudioAtPath:(id)a0;
- (char)isImageAtPath:(id)a0;
- (char)isMovieAtPath:(id)a0;
- (id)keyedLayers;
...
- (void)moveExternalPathsFromDirectory:(id)a0 toDirectory:(id)a1 remap:(char)a2 options:(id)a3;
- (void)moveLayersFromIndices:(id)a0 toIndex:(long long)a1;
- (char)nearingEndWithOptions:(id)a0;
...
- (char)readFromPath:(id)a0 ofType:(id)a1 error:(id *)a2;
- (void)reconnectAllTransitions;
- (id)regionsOfInterestForPath:(id)a0;
- (id)regionsOfInterestForPath:(id)a0 detect:(char)a1;
...
- (void)saveExternalPathsToDirectory:(id)a0 remap:(char)a1 options:(id)a2;
- (char)savesPathsAsAbsolute;
- (void)setAbsolutePath:(id)a0 forKey:(id)a1;
- (void)setAbsoluteStillPath:(id)a0 forKey:(id)a1;
- (void)setAlwaysLookupAbsolutePaths:(char)a0;
...
- (void)setPreserveMedia:(char)a0;
- (void)setProperties:(id)a0 forMediaPath:(id)a1;
- (void)setSavesPathsAsAbsolute:(char)a0;
- (void)setStyleID:(id)a0;
- (void)setTemporarilyCacheAbsolutePaths:(char)a0;
