...
- (void)setAnimationPaths:(id)a0 onPlug:(id)a1 atPosition:(unsigned long long)a2 atTimeOffset:(double)a3 withTimeOffsetKind:(int)a4 forDuration:(double)a5 withFunctionTimeOffset:(double)a6 andFunctionTimeFactor:(double)a7 easeIn:(char)a8 easeOut:(char)a9 otherAttributes:(id)a10;
