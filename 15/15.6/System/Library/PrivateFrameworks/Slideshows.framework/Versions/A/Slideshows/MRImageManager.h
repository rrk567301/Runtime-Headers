...
- (id)_textureWithSize:(struct { unsigned int x0; unsigned int x1; })a0 isFBO:(char)a1 options:(const struct { int x0; char x1; char x2; char x3; char x4; char x5; } *)a2;
...
- (id)textureWithSize:(struct { unsigned int x0; unsigned int x1; })a0 options:(const struct { int x0; char x1; char x2; char x3; char x4; char x5; } *)a1;
