...
+ (id)resolutionStringWithSize:(struct CGSize { double x0; double x1; })a0 keepAspectRatio:(char)a1;
+ (id)resolutionStringWithSize:(struct CGSize { double x0; double x1; })a0 keepAspectRatio:(char)a1 andPlatforms:(unsigned long long)a2;
