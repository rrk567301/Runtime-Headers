...
+ (id)localizedStringsDictByDate:(id)a0 useHours:(char)a1;
...
- (void)_drawGrayChapters:(id)a0 time:(double)a1 arguments:(id)a2 showInfo:(char)a3 startProgress:(double)a4 titleEnd:(double)a5 titleToChapter:(double)a6 drawPhotos:(char)a7 startIndex:(long long)a8 exit:(double)a9 isExiting:(char)a10 chapterIntro:(double)a11 chapterProgress:(double)a12;
- (char)_isMovieForSlideAtIndex:(long long)a0;
