...
- (void)drawSortedPins:(id)a0 providers:(id)a1 attributes:(id)a2 offset:(struct CGPoint { double x0; double x1; })a3 outro:(char)a4 atTime:(double)a5 inContext:(id)a6 withArguments:(id)a7;
