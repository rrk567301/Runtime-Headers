...
@property (nonatomic) char prepareWidgetsManually;
@property (nonatomic) char motionEnabled;
@property (nonatomic) char dynamicsEnabled;
...
- (void)pageAppearingWithProgress:(float)a0 animated:(char)a1;
- (void)pageDidAppear:(char)a0;
- (void)pageDidDisappear:(char)a0;
- (void)pageDisappearingWithProgress:(float)a0 animated:(char)a1;
...
- (void)pageWillDisappear:(char)a0;
