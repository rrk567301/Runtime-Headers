...
- (id)_drawFrame:(id)a0 provider:(id)a1 index:(long long)a2 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 time:(double)a4 onTable:(char)a5 inContext:(id)a6 withArguments:(id)a7;
- (double)_durationForEffect;
- (double)_durationForEffect:(char)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_frameRectFromInfo:(id)a0 onShelf:(char)a1;
- (double)_nextSlideProviderAspectRatioToFitInAspectRatio:(id)a0 providerKeys:(id)a1 slideInformation:(id)a2 index:(long long *)a3 force:(char)a4;
- (id)_randomFrameForAspectRatio:(id)a0 forTable:(char)a1 allowMatte:(char)a2 onlyLoaded:(char)a3 ignoreFrames:(id)a4 randomGenerator:(id)a5;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_rectForFrameID:(id)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 onTable:(char)a2 aspectRatio:(double)a3 slideAspectRatio:(double)a4;
...
- (id)layoutsWithSlidesInfo:(id)a0 seed:(unsigned long long)a1 hasShelf:(char)a2;
