...
@property (nonatomic) char shouldPropagate;
@property (nonatomic) char shouldCancelCouchPotato;
@property (nonatomic) char hasCancelledCouchPotato;
@property (nonatomic) char isInstantaneous;
