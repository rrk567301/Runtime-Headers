...
@property char hasPosterImageChanged;
@property char haveTemplatesChanged;
@property char havePagesChanged;
@property char haveNavigatorsChanged;
@property char haveCouchesChanged;
@property char haveGuidelinesChanged;
@property char canBeEdited;
@property char isClosing;
@property char enableDisplayDebugging;
...
+ (struct CGImage { } *)retainedPosterImageForFileURL:(id)a0 withResolution:(unsigned long long)a1 coordinateReading:(char)a2;
...
+ (id)infoForFileURL:(id)a0 coordinateReading:(char)a1;
...
- (char)loadFromContents:(id)a0 ofType:(id)a1 error:(id *)a2;
...
- (char)_hasThumbnailForImportedResourceURL:(id)a0;
- (char)_hasThumbnailForImportedResourceURL:(id)a0 size:(struct CGSize { double x0; double x1; })a1;
- (char)_hasThumbnailFromMediaForImportedResourceURL:(id)a0;
...
- (char)_readImportedResourceURL:(id)a0 error:(id *)a1 byMediaAccessor:(id /* block */)a2;
- (char)_readImportedResourceURL:(id)a0 error:(id *)a1 byMetadataAccessor:(id /* block */)a2;
- (char)_readImportedResourceURL:(id)a0 error:(id *)a1 byThumbnailAccessor:(id /* block */)a2;
- (char)_readImportedResourceURL:(id)a0 size:(struct CGSize { double x0; double x1; })a1 error:(id *)a2 byThumbnailAccessor:(id /* block */)a3;
...
- (char)_updateImportedResourceURL:(id)a0 error:(id *)a1 byMetadataAccessor:(id /* block */)a2;
- (char)_updateImportedResourceURL:(id)a0 size:(struct CGSize { double x0; double x1; })a1 error:(id *)a2 byThumbnailAccessor:(id /* block */)a3;
- (void)addCouch:(id)a0;
- (void)addGuidelines:(id)a0;
- (void)addNavigator:(id)a0;
- (void)addPageTemplate:(id)a0;
- (void)addScript:(id)a0 extend:(char)a1;
- (void)addWidgetTemplate:(id)a0;
- (id)allGuidelineGlobalUniqueKeys;
- (struct CGSize { double x0; double x1; })bestResolutionSizeForDisplaySize:(struct CGSize { double x0; double x1; })a0 keepAspectRatio:(char *)a1;
- (id)canvasForKeyPath:(id)a0;
- (id)couchWithName:(id)a0;
- (id)couchesNames;
- (char)deleteImportedResourceURLs:(id)a0 progressBlock:(id /* block */)a1 error:(id *)a2;
- (void)documentModelChanged:(char)a0;
...
- (char)hasThumbnailImageInDiskCacheForMediaItem:(id)a0 andResolution:(unsigned long long)a1;
- (id)importResourceURL:(id)a0 opaque:(char)a1 force:(char)a2 progressBlock:(id /* block */)a3 error:(id *)a4;
- (id)importResourceURLs:(id)a0 opaque:(char)a1 force:(char)a2 progressBlock:(id /* block */)a3 error:(id *)a4;
...
- (char)isImportedResourceURLEmbedded:(id)a0;
...
- (id)pagesNames;
- (id)prepareMediaURL:(id)a0 force:(char)a1 progressBlock:(id /* block */)a2 error:(id *)a3;
- (id)prepareMediaURLs:(id)a0 force:(char)a1 progressBlock:(id /* block */)a2 error:(id *)a3;
- (char)registerProducerPlugin:(id)a0;
