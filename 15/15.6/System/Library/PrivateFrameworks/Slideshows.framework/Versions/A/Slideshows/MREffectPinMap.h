...
- (void)_unload;
- (void)_drawArrowInContext:(id)a0 atTime:(double)a1 withArguments:(id)a2 atPoint:(struct CGPoint { double x0; double x1; })a3 scale:(double)a4 withTextAtIndex:(long long)a5 t:(struct CGPoint { double x0; double x1; })a6 pointDown:(char)a7 m:(float[16])a8;
