...
- (void)_drawFrame:(id)a0 info:(id)a1 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 stretch:(char)a3 zIndex:(long long)a4 zRotation:(double)a5 subtract:(id)a6 key:(id)a7 time:(double)a8 inContext:(id)a9 withArguments:(id)a10;
