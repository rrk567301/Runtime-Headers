...
@property (nonatomic) char isTransitioning;
@property (nonatomic) char isGoingToNext;
@property (nonatomic) char delegateIsTransitioningToo;
@property (nonatomic) char isInZoomMode;
