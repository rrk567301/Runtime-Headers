...
- (id)initWithSnippet:(id)a0 core:(id)a1 signature:(id)a2 detectedLanguage:(id)a3 isIncomingMessage:(char)a4 score:(id)a5 startDate:(id)a6 startDateCore:(id)a7 endDate:(id)a8 endDateCore:(id)a9;
- (id)toLightJson;
- (id)toLightNSData;
