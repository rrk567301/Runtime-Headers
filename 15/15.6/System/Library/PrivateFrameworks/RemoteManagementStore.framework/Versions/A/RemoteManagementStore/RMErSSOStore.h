...
+ (char)isPreEnrollmentErSSOStore:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (void)createErSSOStoreWithDeclarations:(id)a0 chosenBundleID:(id)a1 personaID:(id)a2 isUserEnrollment:(char)a3 completionHandler:(id /* block */)a4;
