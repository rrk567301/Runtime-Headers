...
- (void)_sendStatusForSuccessKeys:(id)a0 failedKeys:(id)a1 reasons:(id)a2 applyError:(id)a3 scope:(long long)a4 configurations:(id)a5 success:(char)a6 completionHandler:(id /* block */)a7;
