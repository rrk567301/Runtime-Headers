...
@property (readonly, nonatomic) id<RMConfigurationSingleAdapter> wrappedAdapter;
...
- (void)endProcessingConfigurations:(char)a0 scope:(long long)a1 completionHandler:(id /* block */)a2;
