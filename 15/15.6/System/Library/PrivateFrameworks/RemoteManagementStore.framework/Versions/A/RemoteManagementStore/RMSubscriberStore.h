...
+ (void)storeForStoreDeclarationKeyString:(id)a0 scope:(long long)a1 completionHandler:(id /* block */)a2;
+ (void)storesWithScope:(long long)a0 completionHandler:(id /* block */)a1;
+ (void)subscribedStoreConfigurationsVisibleUIWithScope:(long long)a0 configurationTypes:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)_reasonsFromErrorWithFirstReason:(id)a0 error:(id)a1;
- (void)_removeStatusForDeclarationIdentifier:(id)a0 declarationServerToken:(id)a1 completionHandler:(id /* block */)a2;
- (void)_writeStatusForDeclaration:(id)a0 validity:(char)a1 reasons:(id)a2 completionHandler:(id /* block */)a3;
...
- (char)isValidStatusItem:(id)a0;
- (void)publishStatus:(id)a0 completionHandler:(id /* block */)a1;
- (void)setConfigurationUI:(id)a0 visible:(char)a1 ui:(id)a2 completionHandler:(id /* block */)a3;
