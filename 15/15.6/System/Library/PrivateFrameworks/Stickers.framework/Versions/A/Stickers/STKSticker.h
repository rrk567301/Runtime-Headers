...
@property (nonatomic, readonly) char distributionIsRestricted;
@property (nonatomic, readonly) char canDistribute;
...
@property (nonatomic, readonly) char isGeneratedSticker;
