...
@property (nonatomic) char calculateSize;
@property (nonatomic) char force32BitSize;
@property (nonatomic) char calculateCRC;
...
- (void)beginEntryWithName:(id)a0 force32BitSize:(char)a1 lastModificationDate:(id)a2 size:(unsigned long long)a3 CRC:(unsigned int)a4 forceCalculatingSizeAndCRCForPreservingLastModificationDate:(char)a5;
- (void)beginEntryWithNameImpl:(id)a0 force32BitSize:(char)a1 lastModificationDate:(id)a2 size:(unsigned long long)a3 CRC:(unsigned int)a4 forceCalculatingSizeAndCRCForPreservingLastModificationDate:(char)a5;
...
- (void)writeEntryWithName:(id)a0 force32BitSize:(char)a1 fromReadChannel:(id)a2 completion:(id /* block */)a3;
- (void)writeEntryWithName:(id)a0 force32BitSize:(char)a1 lastModificationDate:(id)a2 size:(unsigned long long)a3 CRC:(unsigned int)a4 fromReadChannel:(id)a5 completion:(id /* block */)a6;
- (void)writeEntryWithName:(id)a0 force32BitSize:(char)a1 lastModificationDate:(id)a2 size:(unsigned long long)a3 CRC:(unsigned int)a4 fromReadChannel:(id)a5 writeHandler:(id /* block */)a6;
