...
@property (nonatomic, getter=isStreamOutputDone) char streamOutputDone;
...
- (id)_currentDataIntersectionWithOffset:(long long)a0 length:(unsigned long long)a1 isReadDone:(char *)a2;
