...
@property (nonatomic, getter=isCompressed) char compressed;
...
@property (readonly, nonatomic, getter=isSymLink) char symLink;
...
- (id)_extractFromArchiveData:(id)a0 destinationURL:(id)a1 allowEntriesOutsideRoot:(char)a2 error:(id *)a3;
- (id)dataFromArchive:(id)a0;
- (id)extractFromArchive:(id)a0;
- (char)extractFromArchive:(id)a0 destinationURL:(id)a1 error:(id *)a2;
