...
@property (readonly, nonatomic) char hasCloudKitEntitlement;
...
@property (readonly, nonatomic) char isPrimaryAccountManagedAppleID;
@property (readonly, nonatomic) char isStoreAccountManagedAppleID;
@property (readonly, nonatomic) char isUserSignedInToiTunes;
@property (readonly, nonatomic) char isUserSignedInToiCloud;
@property (readonly, nonatomic) char isGlobalICloudDriveSyncOptedIn;
@property (readonly, nonatomic) char hasRecommendationsEnabled;
...
- (char)detectedUserSwitchWithId:(id)a0 outSignedIn:(char *)a1 outSignedOut:(char *)a2 outAccountNumberChanged:(char *)a3;
