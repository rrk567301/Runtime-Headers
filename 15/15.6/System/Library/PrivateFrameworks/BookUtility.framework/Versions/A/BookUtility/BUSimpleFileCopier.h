...
+ (char)countFilesAndSizesInDirectory:(id)a0 totalFileSize:(unsigned long long *)a1 totalFileCount:(unsigned long long *)a2 totalFileCountExcludeDir:(unsigned long long *)a3;

- (void).cxx_destruct;
- (id)initWithURL:(id)a0;
- (char)fileManager:(id)a0 shouldCopyItemAtURL:(id)a1 toURL:(id)a2;
- (char)copyToURL:(id)a0 error:(id *)a1;
- (void)_finishCurrentCopyItem;
- (char)countTotalFileSize:(unsigned long long *)a0 totalFileCount:(unsigned long long *)a1;
