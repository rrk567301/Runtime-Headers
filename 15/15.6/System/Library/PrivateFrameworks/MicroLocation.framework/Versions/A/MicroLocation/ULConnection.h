...
+ (id)getRecordingTriggerUUIDAndRequestMicroLocationRecordingScanWithAdditionalInformation:(id)a0 shouldForceRecording:(char)a1 handler:(id /* block */)a2;
...
+ (void)requestMicroLocationRecordingScanWithAdditionalInformation:(id)a0 shouldForceRecording:(char)a1;
...
- (void)_manageConnectionAvailableNotificationObservation:(char)a0;
