...
- (id)init;
- (void).cxx_destruct;
- (char)updateKDLToLatestVersionWithError:(id *)a0;
- (id)listOffendingKextsForService:(long long)a0 error:(id *)a1;
- (char)queryCurrentState:(unsigned long long *)a0 forService:(long long)a1 error:(id *)a2;
- (char)updateKDLFromPath:(id)a0 error:(id *)a1;
