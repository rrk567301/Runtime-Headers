...
@property (weak, nonatomic) id<TVRMSPairingServerDelegate> delegate;
...
- (char)startServerWithExpectedPasscodeHash:(id)a0 advertisedDeviceName:(id)a1 advertisedDeviceModel:(id)a2;
