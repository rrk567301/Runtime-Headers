...
@property (nonatomic) char startedSetup;
@property (nonatomic) char connected;
@property (nonatomic) char hidSessionActivated;
@property (nonatomic) char hidTouchSessionActivated;
@property (nonatomic) char textInputSessionActivated;
@property (nonatomic) char receivedSiriSettings;
@property (nonatomic) char receivedVolumeSettings;
@property (nonatomic) char pttFeatureSupported;
@property (nonatomic) char isInvalidating;
@property (copy, nonatomic) id /* block */ invalidationCompletionBlock;
@property (nonatomic, getter=isSiriEnabled) char siriEnabled;
...
@property (nonatomic, getter=isGuideButtonSupported) char guideButtonSupported;
...
- (void)sendEvent:(id)a0 options:(id)a1 shouldRetry:(char)a2 response:(id /* block */)a3;
