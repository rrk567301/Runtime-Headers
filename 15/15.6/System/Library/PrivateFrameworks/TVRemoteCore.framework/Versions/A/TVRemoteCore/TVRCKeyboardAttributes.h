...
@property (nonatomic, getter=_isLikelyPINEntry, setter=_setLikelyPINEntry:) char likelyPINEntry;
@property (nonatomic, getter=_isSecure, setter=_setSecure:) char secure;
@property (nonatomic, getter=_enablesReturnKeyAutomatically, setter=_setEnablesReturnKeyAutomatically:) char enablesReturnKeyAutomatically;
...
- (id)_init;
- (char)isEqualToAttributes:(id)a0;
