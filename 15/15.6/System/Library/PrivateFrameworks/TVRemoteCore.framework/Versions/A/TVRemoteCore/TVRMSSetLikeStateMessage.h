@interface TVRMSSetLikeStateMessage : PBCodable <NSCopying> {
    struct { unsigned char databaseID : 1; unsigned char itemID : 1; unsigned char likeState : 1; unsigned char sessionIdentifier : 1; } _has;
}

@property (nonatomic) char hasLikeState;
