...
- (void)_setDeviceSupportsFindMyRemote:(char)a0;
...
- (void)_enableFindingSession:(char)a0;
...
- (void)device:(id)a0 didUpdateFindMyRemoteSupported:(char)a1;
...
- (char)isEqualToTVRXDevice:(id)a0;
