...
+ (id)supportedUTIs;
+ (char)shouldPreserveAAEncoding:(id)a0;
+ (char)shouldPreserveHDREncoding:(id)a0;
+ (char)shouldPreserveHEIFEncoding:(id)a0 target:(long long)a1 sourceUTI:(id)a2;
+ (char)supportsUTI:(id)a0;

- (char)boolFromTranscoderUserInfo:(id)a0 withKey:(id)a1;
...
- (char)transcodeProcessingRequired:(long long)a0;
