...
@property (nonatomic) char needsSegmentInfo;
@property (readonly, nonatomic) char shouldReadFromKeychain;
...
@property (nonatomic) char force3rdPartySymbolication;
@property (readonly, nonatomic) char _shouldPerformThirdPartySymbolication;
...
+ (char)symbolicationEndPointIsReachableWithTimeout:(unsigned long long)a0 errorOut:(id *)a1;
+ (id)_speedTracerProtectionSpace;
+ (char)_thirdPartySymbolicationDefaultIsSet;
...
- (id)initWithGroupName:(id)a0 timeoutInSec:(double)a1 shouldReadFromKeychain:(char)a2 resultCollectionCompletionBlock:(id /* block */)a3;
...
- (char)_setUpCredentialsHandling;
- (id)_uuidInfoList;
...
- (void)addRequestForSymbolOwnerUUID:(id)a0 offset:(unsigned long long)a1 isTextExec:(char)a2;
- (id)initWithGroupName:(id)a0 timeoutInSec:(double)a1 shouldReadFromKeychain:(char)a2 completionBlock:(id /* block */)a3;
