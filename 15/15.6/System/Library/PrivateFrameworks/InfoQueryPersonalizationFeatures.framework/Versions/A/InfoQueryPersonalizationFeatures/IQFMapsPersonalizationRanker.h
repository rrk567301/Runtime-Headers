...
@interface IQFMapsPersonalizationRanker : NSObject {
    ...
    char _enableEntityRelevance;
    NSObject<OS_dispatch_queue> *_caLoggingQueue;
}

- (id)init;
- (void).cxx_destruct;
- (id)initWithVisitCountThreshold:(double)a0 lastVisitDaysThreshold:(double)a1 visitCountGivenLocationThreshold:(double)a2 entityRelevanceThreshold:(double)a3 enableEntityRelevance:(char)a4;
