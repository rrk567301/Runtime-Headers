...
- (char)determineBestAppWithDelay:(double)a0 withBlock:(id /* block */)a1;
- (char)fetchAllNearbyAppSuggestions;
- (char)isActivityInfo:(id)a0 atTime:(id)a1 similarToAppSuggestion:(id)a2;
...
- (id)targetAEDescForBundleIdentifierIfRunning:(id)a0 sendBringForward:(char)a1;
