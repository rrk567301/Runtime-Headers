...
- (char)getAdvertisedBytes:(id)a0 completionHandler:(id /* block */)a1;
- (id)getSysdiagnoseStringsIncludingPrivateData:(char)a0;
...
- (id)recentActions:(char)a0;
- (void)rendevous:(id)a0 domain:(id)a1 active:(char)a2;
