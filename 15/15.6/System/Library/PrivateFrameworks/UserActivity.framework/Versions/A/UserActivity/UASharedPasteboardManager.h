...
@property char remotePasteboardAvailable;
@property char currentGenerationHasUpdates;
@property char updateScheduled;
...
- (id)fetchRemoteName;
- (char)addData:(id)a0 toItemAtIndex:(unsigned long long)a1 generation:(unsigned long long)a2;
...
- (char)isRemotePasteboardAvailable;
...
- (char)typeIsDisallowedForReceiving:(id)a0;
- (char)typeIsDisallowedForSending:(id)a0;
