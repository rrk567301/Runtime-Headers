...
@property (nonatomic) char hasResidentKey;
@property (nonatomic) char hasUserVerification;
@property (nonatomic) char isUserConsenting;
@property (nonatomic) char isUserVerified;
