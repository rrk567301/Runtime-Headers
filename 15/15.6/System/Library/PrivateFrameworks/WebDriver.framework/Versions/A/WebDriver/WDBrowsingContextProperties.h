...
- (id)initWithBrowsingContext:(id)a0 url:(id)a1 active:(char)a2 windowFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
