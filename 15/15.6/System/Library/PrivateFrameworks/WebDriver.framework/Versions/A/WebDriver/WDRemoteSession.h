...
@interface WDRemoteSession : NSObject <WDSession> {
    ...
    char _automaticInspectionEnabled;
    char _automaticProfilingEnabled;
    char _usesStrictFileInteractabilityChecks;
...
@property (nonatomic) char automaticProfilingEnabled;
@property (nonatomic) char acceptInsecureCertificates;
@property (nonatomic) char allowsInsecureMediaCapture;
@property (nonatomic) char suppressICECandidateFiltering;
...
@property (nonatomic) char usesStrictFileInteractabilityChecks;
...
- (void)addAuthenticatorWithProtocol:(id)a0 transport:(id)a1 hasResidentKey:(char)a2 hasUserVerification:(char)a3 isUserConsenting:(char)a4 isUserVerified:(char)a5 extensions:(id)a6 userVerificationMethods:(id)a7 completionHandler:(id /* block */)a8;
- (void)addCredentialToAuthenticatorID:(id)a0 credentialID:(id)a1 isResidentCredential:(char)a2 relyingPartyID:(id)a3 privateKey:(id)a4 userHandle:(id)a5 signCount:(id)a6 largeBlob:(id)a7 completionHandler:(id /* block */)a8;
...
- (void)computeLayoutForElement:(id)a0 coordinateSystem:(long long)a1 scrollIntoViewIfNeeded:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)evaluateJavaScriptFunction:(id)a0 withArguments:(id)a1 expectingImplicitCallbackArgument:(char)a2 forceUserGesture:(char)a3 browsingContext:(id)a4 callbackTimeout:(unsigned long long)a5 completionHandler:(id /* block */)a6;
- (void)evaluateJavaScriptFunction:(id)a0 withArguments:(id)a1 expectingImplicitCallbackArgument:(char)a2 forceUserGesture:(char)a3 browsingContext:(id)a4 completionHandler:(id /* block */)a5;
- (void)evaluateJavaScriptFunction:(id)a0 withArguments:(id)a1 expectingImplicitCallbackArgument:(char)a2 forceUserGesture:(char)a3 callbackTimeout:(unsigned long long)a4 completionHandler:(id /* block */)a5;
- (void)evaluateJavaScriptFunction:(id)a0 withArguments:(id)a1 expectingImplicitCallbackArgument:(char)a2 forceUserGesture:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)selectFiles:(id)a0 forFileInputElement:(id)a1 allowsMultipleSelection:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)setUserVerifiedForAuthenticatorID:(id)a0 isUserVerified:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)takeScreenshotOfElement:(id)a0 scrollIntoView:(char)a1 completionHandler:(id /* block */)a2;
