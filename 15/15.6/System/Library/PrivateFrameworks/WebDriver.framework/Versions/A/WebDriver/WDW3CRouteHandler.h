...
- (char)_ensureHandlerErrorIsEmpty:(id)a0 orSendResponse:(id)a1 relatedSession:(id)a2;
- (char)_ensurePayload:(id)a0 fromRequest:(id)a1 hasOptionalParameter:(id)a2 allowedTypes:(id)a3 orSendResponse:(id)a4 withErrorCode:(long long)a5 relatedSession:(id)a6;
- (char)_ensurePayload:(id)a0 fromRequest:(id)a1 hasOptionalParameter:(id)a2 ofType:(long long)a3 orSendResponse:(id)a4 withErrorCode:(long long)a5 relatedSession:(id)a6;
- (char)_ensurePayload:(id)a0 fromRequest:(id)a1 hasRequiredParameter:(id)a2 ofType:(long long)a3 orSendResponse:(id)a4 withErrorCode:(long long)a5 relatedSession:(id)a6;
- (char)_ensurePayload:(id)a0 hasOptionalParameter:(id)a1 ofType:(long long)a2;
- (char)_ensureRequest:(id)a0 hasURLParameter:(id)a1 ofType:(long long)a2 orSendResponse:(id)a3 withErrorCode:(long long)a4 relatedSession:(id)a5;
- (char)_ensureSessionErrorIsEmpty:(id)a0 forRequest:(id)a1 orSendResponse:(id)a2 relatedSession:(id)a3;
...
- (char)_extractFunctionBody:(id *)a0 andArguments:(id *)a1 fromRequest:(id)a2 orSendResponse:(id)a3 relatedSession:(id)a4;
- (char)_extractInteractionSteps:(id *)a0 andInputSources:(id *)a1 fromPayload:(id)a2 inSession:(id)a3 error:(id *)a4;
...
- (char)_findSession:(id *)a0 fromRequest:(id)a1 orSendResponse:(id)a2;
...
- (char)_parseAction:(id)a0 intoInputSource:(id *)a1 withStates:(id *)a2 inSession:(id)a3 error:(id *)a4;
- (char)_parseCharKey:(id *)a0 andVirtualKey:(id *)a1 fromString:(id)a2;
- (char)_parseElement:(id *)a0 fromURLParameter:(id)a1 ofRequest:(id)a2 orSendResponse:(id)a3 relatedSession:(id)a4;
- (char)_parseMouseButton:(long long *)a0 fromNumber:(id)a1;
- (char)_parsePayload:(id *)a0 fromRequest:(id)a1 orSendResponse:(id)a2 relatedSession:(id)a3;
- (char)_parseSearchStrategy:(long long *)a0 andQuery:(id *)a1 fromPayloadOfRequest:(id)a2 orSendResponse:(id)a3 relatedSession:(id)a4;
...
- (char)_translateCapability:(id)a0 withValue:(id)a1 intoOptions:(id)a2;
- (id)_translateClientPayload:(id)a0 toAutomationPayloadInSession:(id)a1;
- (char)_validateCapabilities:(id)a0 error:(id *)a1;
