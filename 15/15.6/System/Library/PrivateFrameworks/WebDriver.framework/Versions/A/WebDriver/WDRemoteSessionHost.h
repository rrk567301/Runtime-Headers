...
@interface WDRemoteSessionHost : NSObject <RWIDriverSession, WDSessionHost> {
    ...
    char _ignoreExistingRunningApplications;
...
@property (readonly, nonatomic) char supportsFileUploadForLocalPaths;
...
- (char)_bootstrapWithApplicationIfMatching:(id)a0;
...
- (void)bootstrapSessionIgnoringExistingRunningApplications:(char)a0 environment:(id)a1 completionHandler:(id /* block */)a2;
- (char)canLaunchBrowserWithName:(id)a0 version:(id)a1;
