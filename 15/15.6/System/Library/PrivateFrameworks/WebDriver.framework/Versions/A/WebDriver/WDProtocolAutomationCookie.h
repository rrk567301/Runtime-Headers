...
- (id)initWithName:(id)a0 value:(id)a1 domain:(id)a2 path:(id)a3 expires:(double)a4 size:(int)a5 httpOnly:(char)a6 secure:(char)a7 session:(char)a8 sameSite:(long long)a9;
