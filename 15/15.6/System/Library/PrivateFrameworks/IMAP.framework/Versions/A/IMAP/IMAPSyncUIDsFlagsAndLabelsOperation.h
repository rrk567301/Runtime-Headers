...
- (void)_imapSyncUIDsFlagsAndLabelsOperationCommonInitIncludeLabels:(char)a0 delegate:(id)a1;
- (id)_syncUIDsFlagsAndLabelsOperationDescription:(id)a0;
- (char)handleResponse:(id)a0 forCommand:(id)a1;
- (id)initWithChangedSince:(unsigned long long)a0 highestKnownUID:(unsigned int)a1 includeLabels:(char)a2 mailboxName:(id)a3 delegate:(id)a4;
- (id)initWithMessageNumbers:(id)a0 includeLabels:(char)a1 mailboxName:(id)a2 delegate:(id)a3;
