...
@property (nonatomic) char needToCheckForIncompleteMessages;
@property (nonatomic) char checkingForIncompleteMessages;
@property (nonatomic) char persistingMessages;
@property (nonatomic) char gettingMessagesToFetch;
...
@property (readonly, nonatomic) char hasMessagesToFetch;
