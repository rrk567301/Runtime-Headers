...
- (char)_lockedUpdateDownloadsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 fetchResults:(id)a1 error:(id)a2;
...
- (char)handleFetchResponse:(id)a0 forUid:(unsigned int)a1;
