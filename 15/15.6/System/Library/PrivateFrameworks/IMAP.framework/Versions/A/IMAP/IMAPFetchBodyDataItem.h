...
- (id)init;
- (void).cxx_destruct;
- (void)_finalizeCommandStringWithHeaderFieldNames:(id)a0 peek:(char)a1;
...
- (id)initWithPartSectionSpecifier:(id)a0 textSectionSpecifier:(long long)a1 peek:(char)a2 headerFieldNames:(id)a3 dataRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4;
