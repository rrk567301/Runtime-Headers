...
@property (readonly) char canStartIdle;
@property (weak, nonatomic) IMAPTask *lastTaskSource;
@property (nonatomic) char trackSyncState;
...
- (void)_closeConnectionAndCompact:(char)a0 allowNetworking:(char)a1;
- (void)_finishIdling;
...
- (char)connection:(id)a0 shouldProcessUnsolicitedResponse:(id)a1;
- (char)isSelectedOnMailbox:(id)a0;
