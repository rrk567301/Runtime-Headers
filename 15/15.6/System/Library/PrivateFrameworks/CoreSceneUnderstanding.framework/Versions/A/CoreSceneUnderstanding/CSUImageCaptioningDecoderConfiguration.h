...
@property (nonatomic) char saveDecoderFeatures;
...
@property (nonatomic) char bridgeIsPrecompiled;
@property (nonatomic) char decoderIsPrecompiled;
...
+ (id)CSUImageCaptioningDecoderConfigurationForRevision:(long long)a0 saveDecoderFeatures:(char)a1 error:(id *)a2;
