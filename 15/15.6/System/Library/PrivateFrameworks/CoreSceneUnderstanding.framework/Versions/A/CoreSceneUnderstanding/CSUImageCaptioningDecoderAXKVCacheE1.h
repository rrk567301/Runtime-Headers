...
- (char)loadDecoderObj:(id *)a0;
- (char)compareTensorShapesForShape1:(const void *)a0 Shape2:(const void *)a1;
...
- (char)populateInputBuffer:(id)a0 WithError:(id *)a1;
