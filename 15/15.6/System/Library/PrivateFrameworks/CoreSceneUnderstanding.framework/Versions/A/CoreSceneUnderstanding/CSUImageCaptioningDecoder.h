...
- (id)computeDecodedCaptionsForFeaturesAXKVCacheE1:(id)a0 withDecodingMethod:(long long)a1 runDecoderOnly:(char)a2 error:(id *)a3;
- (id)computeDecodedCaptionsForFeaturesE1:(id)a0 withDecodingMethod:(long long)a1 runDecoderOnly:(char)a2 error:(id *)a3;
- (id)computeDecodedCaptionsForFeaturesE5:(id)a0 withDecodingMethod:(long long)a1 runDecoderOnly:(char)a2 error:(id *)a3;
