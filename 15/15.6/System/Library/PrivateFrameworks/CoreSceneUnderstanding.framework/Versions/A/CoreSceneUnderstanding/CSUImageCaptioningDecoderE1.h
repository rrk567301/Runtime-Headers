...
- (char)compareTensorShapesForShape1:(const void *)a0 Shape2:(unsigned long long[5])a1 rank:(unsigned long long)a2;
- (id)computeDecodedCaptionsForFeatures:(id)a0 withDecodingMethod:(long long)a1 runDecoderOnly:(char)a2 error:(id *)a3;
...
- (char)loadPostProcUtilsWithBeamWidth:(int)a0 error:(id *)a1;
...
- (char)populateInputBufferWithBridgeFeatures:(id)a0 WithError:(id *)a1;
- (id)postProcessResults:(id)a0 error:(id *)a1;
- (char)reshapeEncodedFeaturesBufferForBridgeNet:(id)a0 WithError:(id *)a1;
