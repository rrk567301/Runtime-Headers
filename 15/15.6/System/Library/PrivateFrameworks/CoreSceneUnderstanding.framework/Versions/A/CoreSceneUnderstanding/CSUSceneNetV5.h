...
- (char)enumerateEntityNetClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
- (char)enumerateHierarchicalSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
- (char)enumerateLeafSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
...
- (char)enumerateHierarchicalSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1;
...
- (char)enumerateAestheticsAttributeScores:(id)a0 usingBlock:(id /* block */)a1;
- (char)enumerateAestheticsAttributeScores:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
- (char)enumerateAestheticsGlobalScores:(id)a0 usingBlock:(id /* block */)a1;
- (char)enumerateAestheticsGlobalScores:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
- (char)enumerateEntityNetClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1;
- (char)enumerateLeafSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1;
- (char)enumerateSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1;
- (char)enumerateSceneClassificationLikelihoods:(id)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
