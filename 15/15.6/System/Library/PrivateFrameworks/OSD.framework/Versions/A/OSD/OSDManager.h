...
- (void)showImage:(long long)a0 onDisplayID:(unsigned int)a1 priority:(unsigned int)a2 msecUntilFade:(unsigned int)a3 filledChiclets:(unsigned int)a4 totalChiclets:(unsigned int)a5 locked:(char)a6;
