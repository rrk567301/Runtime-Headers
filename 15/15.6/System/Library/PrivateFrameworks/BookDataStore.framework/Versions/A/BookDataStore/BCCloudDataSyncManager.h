...
- (void)databaseController:(id)a0 attachmentChanged:(char)a1;
- (void)databaseController:(id)a0 fetchedAllRecordsInZone:(id)a1;
- (void)databaseController:(id)a0 reachabilityChanged:(char)a1;
