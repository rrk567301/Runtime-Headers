...
@property (nonatomic) char attachedToContainer;
@property (nonatomic) double backOffInterval;
@property (nonatomic) char serverFetchPostponed;
@property (nonatomic) char fetchRecordZoneChangesSuccess;
...
- (void)connectUserTo:(id)a0 container:(id)a1 updateSubscription:(char)a2 completion:(id /* block */)a3 subscriptionCompletion:(id /* block */)a4;
...
- (void)willAttachToContainer:(id)a0 serviceMode:(char)a1 completion:(id /* block */)a2;
