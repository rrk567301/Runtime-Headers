...
@property (nonatomic) char connectionHealthy;
...
- (void)engagementDataIncludingDeleted:(char)a0 forKey:(id)a1 completion:(id /* block */)a2;
- (void)fetchAllHiddenItemStoreIDsWithCompletion:(id /* block */)a0;
- (void)fetchAssetDetailsForUnsyncedTastes:(id /* block */)a0;
- (void)fetchAssetDetailsIncludingDeleted:(char)a0 completion:(id /* block */)a1;
- (void)fetchAssetReviewsForUserID:(id)a0 includingDeleted:(char)a1 completion:(id /* block */)a2;
- (void)fetchCollectionDetailsIncludingDeleted:(char)a0 completion:(id /* block */)a1;
- (void)fetchCollectionMembersInCollectionID:(id)a0 completion:(id /* block */)a1;
- (void)fetchCollectionMembersIncludingDeleted:(char)a0 completion:(id /* block */)a1;
- (void)fetchEngagementDatasIncludingDeleted:(char)a0 completion:(id /* block */)a1;
...
- (void)fetchStoreItemsIncludingDeleted:(char)a0 completion:(id /* block */)a1;
- (void)fetchUserDataIncludingDeleted:(char)a0 completion:(id /* block */)a1;
...
- (void)priceTrackingCtlRefreshTrackedPricesIgnoringSchedule:(char)a0 completion:(id /* block */)a1;
...
- (void)setCloudSyncPaused:(char)a0;
...
- (void)setEnableCollectionSync:(char)a0;
- (void)setEnableSecureCloudSync:(char)a0;
...
- (void)updatePolitely:(char)a0 uiManager:(id)a1 reason:(long long)a2 completion:(id /* block */)a3;
...
- (void)userDatumIncludingDeleted:(char)a0 forKey:(id)a1 completion:(id /* block */)a2;
