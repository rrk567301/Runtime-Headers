...
@property (nonatomic) char signalDataChangedTransaction;
...
- (void)_dirtyMutableCloudDataWithFetchLimit:(unsigned long long)a0 synchronous:(char)a1 completion:(id /* block */)a2;
- (id)_fetchHistoryAfterToken:(id)a0 inMoc:(id)a1 error:(id *)a2;
...
- (void)fetchCloudDataIncludingDeleted:(char)a0 completion:(id /* block */)a1;
...
- (void)mutableCloudDataWithPredicate:(id)a0 sortDescriptors:(id)a1 synchronous:(char)a2 completion:(id /* block */)a3;
...
- (void)setCloudData:(id)a0 predicate:(id)a1 isEqualCheckIgnoringEmptySalt:(char)a2 completion:(id /* block */)a3;
- (void)setCloudData:(id)a0 predicate:(id)a1 mergers:(id)a2 completion:(id /* block */)a3;
- (void)setCloudData:(id)a0 predicate:(id)a1 mergers:(id)a2 isEqualCheckIgnoringEmptySalt:(char)a3 completion:(id /* block */)a4;
- (void)setCloudData:(id)a0 predicate:(id)a1 propertyIDKey:(id)a2 completion:(id /* block */)a3;
- (void)setCloudData:(id)a0 predicate:(id)a1 propertyIDKey:(id)a2 isEqualCheckIgnoringEmptySalt:(char)a3 completion:(id /* block */)a4;
- (void)setCloudData:(id)a0 predicate:(id)a1 propertyIDKey:(id)a2 mergers:(id)a3 completion:(id /* block */)a4;
- (void)setCloudData:(id)a0 predicate:(id)a1 propertyIDKey:(id)a2 mergers:(id)a3 isEqualCheckIgnoringEmptySalt:(char)a4 completion:(id /* block */)a5;
