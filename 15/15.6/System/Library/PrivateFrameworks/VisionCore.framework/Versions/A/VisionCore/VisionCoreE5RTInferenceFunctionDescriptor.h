...
+ (id)loadOrCompileProgramLibrary:(id)a0 modelBaseName:(id)a1 e5rtComputeDeviceType:(unsigned long long)a2 supportedOnANEFrom:(long long)a3 fullyANEResidentFrom:(long long)a4 allowCompilation:(char)a5 error:(id *)a6;
