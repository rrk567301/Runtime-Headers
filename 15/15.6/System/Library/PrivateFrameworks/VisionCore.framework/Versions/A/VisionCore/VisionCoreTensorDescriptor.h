...
- (char)getByteOffset:(unsigned long long *)a0 forPosition:(const unsigned long long *)a1 rank:(unsigned long long)a2 error:(id *)a3;
- (char)E5RTExecutionContextAssignNewTensorInstanceToNamedObjects:(id)a0 error:(id *)a1;
