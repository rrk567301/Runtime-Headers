...
@property (readonly, nonatomic) char shouldInitializeAdditionalModelHeads;
...
+ (id)descriptorForModel:(unsigned long long)a0 requireObjDetNet:(char)a1 requireSliderNet:(char)a2 error:(id *)a3;
+ (id)sceneNetV3AndReturnError:(id *)a0;
+ (char)_getAnalyzerName:(id *)a0 ANESpecificAnalyzerName:(id *)a1 specifier:(id *)a2 forModel:(unsigned long long)a3 objDetNet:(char)a4 sliderNet:(char)a5 error:(id *)a6;
