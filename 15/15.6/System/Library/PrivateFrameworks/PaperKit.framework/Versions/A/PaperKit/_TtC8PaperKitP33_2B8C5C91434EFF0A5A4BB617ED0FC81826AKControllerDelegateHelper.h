...
- (id)newContentSnapshotPDFDataIncludingAdornments:(char)a0 atScale:(double)a1 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 onOverlayAtPageIndex:(long long)a3 forAnnotationController:(id)a4;
