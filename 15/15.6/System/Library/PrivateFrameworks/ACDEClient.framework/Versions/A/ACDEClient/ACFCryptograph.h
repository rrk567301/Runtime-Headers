...
- (id)decryptAES128CBCData:(id)a0 withKey:(id)a1 initializationVector:(id)a2 pading:(char)a3;
- (id)encodeBase16:(id)a0;
- (id)encodeBase64:(id)a0;
- (id)encodeObscuredDataWithString:(id)a0 length:(unsigned long long)a1;
- (id)encrypt3DESCBCData:(id)a0 withKey:(id)a1 pading:(char)a2;
- (id)encryptAES128CBCData:(id)a0 withKey:(id)a1 initializationVector:(id)a2 pading:(char)a3;
- (id)encryptData:(id)a0 withKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a1;
...
- (id)signatureForData:(id)a0 withKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a1;
