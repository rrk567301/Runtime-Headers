...
@property char isWaitingForResponse;
...
+ (id)invocation;
+ (id)invocationWithMethod:(id)a0 url:(id)a1 timeout:(double)a2 delegate:(id)a3 invokeImmediately:(char)a4;
...
- (id)initWithMethod:(id)a0 url:(id)a1 timeout:(double)a2 delegate:(id)a3 invokeImmediately:(char)a4;
