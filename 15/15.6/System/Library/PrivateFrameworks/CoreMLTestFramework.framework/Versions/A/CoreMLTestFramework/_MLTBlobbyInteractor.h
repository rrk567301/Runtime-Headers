...
- (char)downloadAsset:(id)a0 localPath:(id)a1 accessKey:(id)a2 secretKey:(id)a3 error:(id *)a4;
- (char)uploadAsset:(id)a0 localPath:(id)a1 accessKey:(id)a2 secretKey:(id)a3 error:(id *)a4;
- (char)uploadAssetData:(id)a0 uploadData:(id)a1 accessKey:(id)a2 secretKey:(id)a3 error:(id *)a4;
