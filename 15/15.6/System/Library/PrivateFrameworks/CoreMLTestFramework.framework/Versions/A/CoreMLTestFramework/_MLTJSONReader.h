...
@property char isReaderForInferenceTest;
@property char isReaderForGradientTest;
...
- (void).cxx_destruct;
- (id)readLine;
- (id)nextDataSample:(char)a0;
- (id)MLFeatureValueFromDict:(id)a0 error:(id *)a1;
- (char)assignDataFromFile:(id)a0 encoding:(unsigned long long)a1 error:(id *)a2;
- (id)biasGradientsForLayerName:(id)a0 error:(id *)a1;
- (char)getArrayValues:(id)a0 outArray:(id *)a1 outDataType:(long long *)a2 error:(id *)a3;
...
- (char)setFeaturesNamesAndTotalCaseCount:(id)a0 withStreaming:(char)a1 error:(id *)a2;
