...
- (void).cxx_destruct;
- (void)runTest:(id)a0;
- (char)cleanupAndReturnError:(struct archive { } *)a0 writerArchive:(struct archive { } *)a1 extractedFiles:(id)a2 error:(id *)a3;
- (void)deleteFiles:(id)a0;
- (id)errorForTest:(id)a0 error:(id *)a1;
- (id)errorIfAny;
- (char)extractBundle:(id)a0 error:(id *)a1;
...
- (char)runAllTestsInBundle:(id *)a0;
- (char)runTestInBundle:(id)a0 error:(id *)a1;
- (id)testsInBundle;
