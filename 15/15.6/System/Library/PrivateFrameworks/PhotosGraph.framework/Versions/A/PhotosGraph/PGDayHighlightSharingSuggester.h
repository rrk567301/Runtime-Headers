...
+ (char)canSuggestHighlightNodeWithoutPeople:(id)a0 loggingConnection:(id)a1;
+ (char)shouldSuggestHighlightNode:(id)a0 neighborScoreComputer:(id)a1 loggingConnection:(id)a2;
