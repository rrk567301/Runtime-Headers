...
- (id)_resolvedLocationNodeForIncompleteAddressNode:(id)a0 withTargetDimension:(unsigned long long)a1 resolvedDimension:(unsigned long long *)a2 continueResolvingHigherDimensions:(char)a3;
