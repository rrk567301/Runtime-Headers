...
+ (char)_canUseOverTheYearsForStartYear:(long long)a0 endYear:(long long)a1;
...
+ (char)_eventNodesCoverCompleteMonth:(id)a0;
+ (char)_eventNodesCoverCompleteYear:(id)a0;
+ (id)_featuredDateNodesFromDateNodes:(id)a0 featuredYearNodes:(id)a1;
+ (char)_hasReachedNumberVisitsPerMonth:(unsigned long long)a0 inEvents:(id)a1 withLocationNodes:(id)a2 startDateNode:(id)a3 endDateNode:(id)a4;
+ (char)_hasReachedNumberVisitsPerYear:(unsigned long long)a0 inEvents:(id)a1 withLocationNodes:(id)a2 startDateNode:(id)a3 endDateNode:(id)a4;
+ (id)_locationNodesForTimeTitleFromLocationNodes:(id)a0;
+ (char)_momentNodes:(id)a0 coverCompleteMonth:(char)a1 coverCompleteYear:(char)a2;
...
+ (id)numberOfYearsAgoWithMomentNodes:(id)a0 relativeToDateComponents:(id)a1 useOrdinal:(char)a2;
+ (long long)numberOfYearsFromDate:(id)a0 toDate:(id)a1;
+ (id)peopleTimeTitleWithEventNodes:(id)a0;
+ (id)peopleTimeTitleWithEventNodes:(id)a0 requireMultipleYears:(char)a1;
...
+ (char)yearIsNeededForDisplayingDate:(id)a0;
