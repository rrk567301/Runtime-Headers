...
@property (nonatomic) char interestingForMeaningInference;
...
- (double)_calculateMatchingScoreForPartOfDayWithMatchingTrait:(id)a0 requiredTrait:(id)a1 requiresStrictMatching:(char)a2;
- (void)_calculateMatchingScoreForScenesWithRequiredCriteria:(id)a0 result:(id /* block */)a1;
- (id)initWithMoment:(id)a0 cache:(id)a1 serviceManager:(id)a2;
- (id)matchingResultWithCriteria:(id)a0;
- (double)matchingScoreWithCriteria:(id)a0 failed:(char *)a1 isReliable:(char *)a2;
