...
+ (id)_photosGraphPropertiesForMemory:(id)a0 musicCurationFeatures:(id)a1 appleMusicCuration:(id)a2 flexMusicCuration:(id)a3 isAppleMusicSubscriber:(char)a4 error:(id *)a5;
...
- (char)curateMusicForUpNextMemoriesWithLocalIdentifiers:(id)a0 musicCurationOptions:(id)a1 photoLibrary:(id)a2 managerContext:(id)a3 error:(id *)a4;
