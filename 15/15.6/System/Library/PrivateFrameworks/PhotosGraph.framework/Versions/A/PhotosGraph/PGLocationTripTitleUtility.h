...
@property (nonatomic) char filterMomentsAndCities;
@property (nonatomic) char allowLongAOI;
...
+ (void)_aoiTitleWithLocationNodes:(id)a0 momentNodes:(id)a1 allowLongAOI:(char)a2 graph:(id)a3 locationHelper:(id)a4 result:(id /* block */)a5;
+ (void)_cityStateAndCountryNodesForLocationNodes:(id)a0 result:(id /* block */)a1;
+ (id)_filteredCityNodesByNameForCityNodes:(id)a0;
+ (char)visitedLocations:(id)a0 onlyDuringMoments:(id)a1 locationHelper:(id)a2;
...
- (void)_cityTitleWithCityNode:(id)a0 countryNode:(id)a1 visitedCountryOnlyOnce:(char)a2 momentNodes:(id)a3 result:(id /* block */)a4;
- (void)_generateLocationTitle;
- (void)_generateTitleForMomentNodes:(id)a0 resolvedMomentNodes:(id)a1 resolvedLocations:(id)a2;
- (id)_locationTitleWithLocationNode:(id)a0 addressNode:(id)a1 countryNode:(id)a2 allowSecondPart:(char)a3;
- (id)initWithMomentNodes:(id)a0 filterMomentsAndCities:(char)a1 allowLongAOI:(char)a2 locationHelper:(id)a3;
- (id)initWithMomentNodes:(id)a0 filterMomentsAndCities:(char)a1 locationHelper:(id)a2;
