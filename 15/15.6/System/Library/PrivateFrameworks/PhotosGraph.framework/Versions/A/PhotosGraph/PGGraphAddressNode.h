...
@property (readonly, nonatomic) char isImproved;
@property (readonly, nonatomic) char isOcean;
@property (readonly, nonatomic) char isCoarse;
@property (readonly, nonatomic) char isPrecise;
