...
- (id)_questionsToAddFromMomentNodes:(id)a0 useRepresentativeAssets:(char)a1 localFactoryScore:(double)a2 alreadyGeneratedQuestions:(id)a3 limit:(unsigned long long)a4 graph:(id)a5 sceneTaxonomy:(id)a6 progressBlock:(id /* block */)a7;
