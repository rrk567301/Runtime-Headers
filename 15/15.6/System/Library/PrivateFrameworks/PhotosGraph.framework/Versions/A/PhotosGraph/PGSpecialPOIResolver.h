...
+ (char)specialPOIContainsCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0;
+ (char)specialPOINameIsInString:(id)a0;
...
- (char)anyMomentContainsSpecialPOI:(unsigned long long)a0;
- (char)anyMomentHasPOIAmusementPark;
- (id)initWithMomentNodes:(id)a0;
- (char)momentsContainSpecialPOI:(unsigned long long)a0 withMomentRatio:(double)a1;
