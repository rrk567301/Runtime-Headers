@interface PGMeaningfulEventLooseRequiredCriteriaFactory : NSObject
...
+ (id)_requiredCriteriaForIdentifiers:(id)a0 graph:(id)a1 sceneTaxonomy:(id)a2;
...
+ (id)requiredCriteriaForIdentifiers:(id)a0 graph:(id)a1 sceneTaxonomy:(id)a2;
