...
@property (readonly, nonatomic) char contactFaceprintMatch;
...
@property (readonly, nonatomic) char personContactBiologicalSexMatch;
@property (readonly, nonatomic) char personContactBiologicalSexMismatch;
...
@property (readonly) char isHighConfidence;
