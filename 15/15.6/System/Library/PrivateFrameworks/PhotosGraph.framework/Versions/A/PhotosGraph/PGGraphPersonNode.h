...
@property (class, readonly) MARelation *birthdayMomentOfPerson;
@property (class, readonly) MARelation *anniversaryMomentOfPerson;
@property (class, readonly) MARelation *socialGroupOfPerson;
...
@property (readonly, nonatomic) char isInferredChild;
...
@property (readonly) char isUserCreated;
...
@property (readonly) char isMySister;
@property (readonly) char isMyBrother;
@property (readonly) char isMySon;
@property (readonly) char isMyDaughter;
...
@property (readonly) char isMyInferredSister;
@property (readonly) char isMyInferredBrother;
@property (readonly) char isMyInferredSon;
@property (readonly) char isMyInferredDaughter;
...
+ (id)filterForAgeCategories:(id)a0 includingMe:(char)a1;
...
- (char)_contactSuggestionEdge:(id)a0 fitsQuery:(unsigned long long)a1;
- (id)_contactSuggestionEdgesSortedByConfidence;
- (char)_hasRelationshipLabel:(id)a0 withStatus:(unsigned long long)a1;
...
- (char)isTaggedWithRelationship:(unsigned long long)a0 withConfidence:(double)a1;
