...
+ (id)_specForFoodieWithPersonNodes:(id)a0 locationName:(id)a1 tripTitleLocationType:(unsigned long long)a2 allowInspiredTastesTitle:(char)a3 genericOnly:(char)a4;
...
+ (id)specCollectionForFoodieMemoryWithPersonNodes:(id)a0 locationName:(id)a1 tripTitleLocationType:(unsigned long long)a2 allowInspiredTastesTitle:(char)a3 genericOnly:(char)a4;
