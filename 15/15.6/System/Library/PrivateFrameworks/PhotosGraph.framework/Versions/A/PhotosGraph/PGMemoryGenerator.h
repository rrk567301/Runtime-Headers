...
- (void)_enumerateBestScoringPotentialMemoriesInPotentialMemories:(id)a0 withGraph:(id)a1 attemptUpgradesBeforeSorting:(char)a2 usingBlock:(id /* block */)a3;
...
- (id)relevantCurationFeederForTriggeredMemory:(id)a0 relevantFeeder:(id)a1 inGraph:(id)a2 allowGuestAsset:(char)a3 progressReporter:(id)a4;
- (id)relevantFeederForTriggeredMemory:(id)a0 inGraph:(id)a1 allowGuestAsset:(char)a2 progressReporter:(id)a3;
- (id)relevantKeyCurationFeederForTriggeredMemory:(id)a0 inGraph:(id)a1 allowGuestAsset:(char)a2 progressReporter:(id)a3;
