...
@property (nonatomic) char keepsExistingAssetCurationScores;
@property (readonly) char isSharedLibraryEnabled;
@property (readonly) NSSet *sharedLibraryParticipants;

+ (unsigned short)edgeDomainForMeaningNodeLabel:(id)a0 isV1Algorithm:(char)a1;
+ (id)expandedRelationshipLabelsForRelationship:(unsigned long long)a0;
+ (char)isSharedLibraryEnabledForLibrary:(id)a0;
...
- (void)addMeaningToMeaningfulEventNode:(id)a0 meaningLabel:(id)a1 meaningIsReliable:(char)a2;
...
- (void)_insertMomentFeaturesForMomentNode:(id)a0 momentEnvelope:(id)a1 assets:(id)a2 photoLibrary:(id)a3 featureProvider:(id)a4 atMomentIngest:(char)a5 curationContext:(id)a6;
...
- (char)_shouldUpdateCurationScore:(double)a0 withNewCurationScore:(double)a1;
...
- (void)addMeaningToMeaningfulEventNode:(id)a0 meaningLabel:(id)a1 meaningConfidence:(double)a2 meaningIsHighPrecision:(char)a3 isV1Algorithm:(char)a4;
...
- (id)insertAddressNodeWithProjectedPlacemark:(id)a0 atEventLocation:(id)a1 usingImprovedPlacemark:(char)a2;
- (id)insertAddressNodeWithProjectedPlacemark:(id)a0 atEventLocation:(id)a1 usingImprovedPlacemark:(char)a2 changeRequest:(id)a3;
...
- (void)insertMomentFeaturesForMomentNode:(id)a0 momentEnvelope:(id)a1 assets:(id)a2 featureProvider:(id)a3 atMomentIngest:(char)a4 curationContext:(id)a5;
- (void)insertMomentFeaturesForMomentNode:(id)a0 momentEnvelope:(id)a1 photoLibrary:(id)a2 featureProvider:(id)a3 atMomentIngest:(char)a4 curationContext:(id)a5;
...
- (id)insertPOINodeWithPlace:(id)a0 fromMomentNode:(id)a1 hasInsertedSpecialPOIAmusementParkNode:(char)a2;
- (id)insertPOIWithFeeder:(id)a0 fromMomentNode:(id)a1 isNearHomeOrWork:(char)a2;
...
- (id)insertPeopleWithClueCollection:(id)a0 fromMomentNode:(id)a1 addressNodes:(id)a2 isNearPeopleAddress:(char *)a3;
...
- (id)insertPersonNodeForPerson:(id)a0 fromMomentNode:(id)a1 numberOfAssetsWithPerson:(unsigned long long)a2 importanceInMoment:(double)a3 includeMergeCandidates:(char)a4;
...
- (id)insertPresentEdgeFromPersonNode:(id)a0 toMomentNode:(id)a1 numberOfAssetsWithPerson:(unsigned long long)a2 importance:(double)a3 includeMergeCandidates:(char)a4;
...
- (void)setCanUseLocationDomain:(char)a0;
- (void)setContactsAccessStatus:(char)a0;
...
- (char)shouldUpdatePersonRepresentativeAssetUUIDsWithPositiveSceneCriteria:(id)a0 actionValueString:(id)a1 assetIsPassingSceneCriteria:(char)a2 personLocalIdentifierIsDoingActionInAsset:(char)a3;
