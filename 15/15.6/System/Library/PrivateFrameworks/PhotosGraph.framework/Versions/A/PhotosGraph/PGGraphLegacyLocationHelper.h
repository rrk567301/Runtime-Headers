...
- (id)_closestLocationNodeFromLocationNode:(id)a0 withDimension:(unsigned long long)a1 remapMatchingDimensionBlock:(id /* block */)a2 reverse:(char)a3;
- (id)_commonNodeForLocationNode:(id)a0 andLocationNode:(id)a1;
- (char)_locationNodesRepresentSameCity:(id)a0;
...
- (id)closestLocationNodeFromLocationNode:(id)a0 withDimension:(unsigned long long)a1 reverse:(char)a2;
...
- (char)locationIsInSupersetCategoryForLocationNode:(id)a0;
- (id)locationNodeWithDimension:(unsigned long long)a0 rootNode:(id)a1;
- (id)relevantAddressNodesForMomentNodes:(id)a0 applyDensestCloseLocationNode:(char)a1;
- (id)relevantLocationNodesForMomentNodes:(id)a0 applyDensestCloseLocationNode:(char)a1;
