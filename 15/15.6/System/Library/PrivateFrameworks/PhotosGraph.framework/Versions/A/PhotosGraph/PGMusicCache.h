...
- (id)init;
- (void).cxx_destruct;
- (char)removeSongSourcesWithSongSourceCategory:(id)a0 progressReporter:(id)a1 error:(id *)a2;
- (char)removeAllWithProgressReporter:(id)a0 error:(id *)a1;
- (char)removeSongSourcesWithSongSourceCategories:(id)a0 progressReporter:(id)a1 error:(id *)a2;
