@class PGGraphPersonRelationshipTagNodeCollection, NSString, PGGraphStorytellingRelationshipEdgeCollection, PGGraphRelationshipTagEdgeCollection, NSSet, PGGraphFeatureNodeCollection, PGGraphSocialGroupNodeCollection, PGGraphMomentNodeCollection, PGGraphHomeWorkNodeCollection, PGGraphSocialGroupMemberNodeCollection, PGGraphRelationshipEdgeCollection;
...
+ (id)personNodesInAgeCategories:(id)a0 includingMe:(char)a1 inGraph:(id)a2;
...
- (void)enumerateLocalIdentifiersUsingBlock:(id /* block */)a0;
- (id)ownedPetNodes;
- (id)personNodeByLocalIdentifier;
- (id)relationshipTagNodesWithConfidence:(double)a0;
