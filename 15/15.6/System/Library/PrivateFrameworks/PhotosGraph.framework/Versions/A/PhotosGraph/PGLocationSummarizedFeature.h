...
- (void).cxx_destruct;
- (id)initWithSubtype:(unsigned short)a0 intervalsPresent:(id)a1 numberOfAssets:(unsigned long long)a2 isMandatoryForKeyAsset:(char)a3 locationNode:(id)a4;
- (id)initWithSubtype:(unsigned short)a0 intervalsPresent:(id)a1 numberOfAssets:(unsigned long long)a2 isMandatoryForKeyAsset:(char)a3 locationNode:(id)a4 personNode:(id)a5 locationName:(id)a6;
