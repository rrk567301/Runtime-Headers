...
@property (readonly) char isUserVerified;
...
@property (readonly, nonatomic) char isFrequentSocialGroup;
...
+ (id)filter;
+ (id)filterWithIsUserVerified:(char)a0;
...
- (id)initWithSocialGroupIdentifier:(long long)a0 importance:(double)a1 isUserVerified:(char)a2;
- (id)persistedUUID;
