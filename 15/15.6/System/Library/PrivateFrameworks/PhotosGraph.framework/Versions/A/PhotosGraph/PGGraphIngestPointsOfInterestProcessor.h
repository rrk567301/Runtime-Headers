@class PGGraphBuilder, NSString, NSDictionary, CLSBusinessCacheUpdater;
...
- (char)_fetchPointsOfInterestForRegions:(id)a0 loggingConnection:(id)a1 progress:(id /* block */)a2;
