...
+ (char)translateLegacyMemoryCategory:(unsigned long long)a0 subcategory:(unsigned long long)a1 toNewMemoryCategory:(unsigned long long *)a2 triggerType:(unsigned long long *)a3;
