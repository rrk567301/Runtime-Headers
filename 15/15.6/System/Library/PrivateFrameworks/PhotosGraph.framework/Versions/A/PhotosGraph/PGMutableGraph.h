...
- (id)addUniquelyIdentifiedNodeWithLabel:(id)a0 domain:(unsigned short)a1 properties:(id)a2 didCreate:(char *)a3;
...
- (id)addUniqueNodeWithLabel:(id)a0 domain:(unsigned short)a1 properties:(id)a2 didCreate:(char *)a3;
