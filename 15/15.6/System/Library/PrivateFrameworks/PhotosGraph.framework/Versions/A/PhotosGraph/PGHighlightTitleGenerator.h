...
@property (nonatomic) char createVerboseTitle;
...
- (id)initWithCollection:(id)a0 curatedAssetCollection:(id)a1 keyAsset:(id)a2 createVerboseTitle:(char)a3 titleGenerationContext:(id)a4;
- (id)initWithCollection:(id)a0 filteredMomentNodes:(id)a1 curatedAssetCollection:(id)a2 keyAsset:(id)a3 createVerboseTitle:(char)a4 titleGenerationContext:(id)a5;
