...
+ (char)_hasMomentsForPersonLocalIdentifiers:(id)a0 inGraph:(id)a1 photoLibrary:(id)a2 usePersonMoments:(char)a3;
...
+ (id)validateSocialGroups:(id)a0 withPhotoLibrary:(id)a1 graph:(id)a2 usePersonMoments:(char)a3;
