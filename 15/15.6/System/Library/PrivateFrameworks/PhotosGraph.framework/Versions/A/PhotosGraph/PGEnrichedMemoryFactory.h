...
- (id)curatedAssetUUIDsWithTriggeredMemory:(id)a0 keyAsset:(id)a1 extendedCuratedAssetUUIDs:(id)a2 targetCurationDuration:(double)a3 allowGuestAsset:(char)a4 progressReporter:(id)a5;
...
- (id)enrichedMemoryWithTriggeredMemory:(id)a0 withConfiguration:(id)a1 progressReporter:(id)a2 debug:(char)a3;
