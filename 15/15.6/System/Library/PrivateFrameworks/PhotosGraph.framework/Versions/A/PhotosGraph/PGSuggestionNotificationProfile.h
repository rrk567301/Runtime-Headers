@class NSArray, CLSServiceManager, NSSet, NSDate, NSObject;
@protocol OS_os_log;
...
@property (readonly, nonatomic) char eligibleForNotification;
...
- (id)initWithExistingSuggestions:(id)a0 serviceManager:(id)a1;
...
- (char)shouldNotifyForSuggestion:(id)a0 withOptions:(id)a1;
