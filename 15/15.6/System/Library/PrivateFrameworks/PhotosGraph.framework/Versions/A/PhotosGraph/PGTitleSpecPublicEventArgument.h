...
@property (readonly, nonatomic) char shouldUseLongPublicEventTitle;

+ (id)_cleanUpEventName:(id)a0;
+ (id)argumentWithPublicEventType:(unsigned long long)a0;
+ (id)argumentWithPublicEventType:(unsigned long long)a0 shouldUseLongPublicEventTitle:(char)a1;
...
- (id)initWithPublicEventType:(unsigned long long)a0 shouldUseLongPublicEventTitle:(char)a1;
