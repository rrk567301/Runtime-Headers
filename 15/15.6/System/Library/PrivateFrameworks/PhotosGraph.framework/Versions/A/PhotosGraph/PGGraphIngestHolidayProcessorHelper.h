...
- (char)isCelebratingForEventRule:(id)a0 momentNode:(id)a1 momentLocalDate:(id)a2 withGraph:(id)a3 loggingConnection:(id)a4 localeCountryCode:(id)a5 keyboardLanguageCodes:(id)a6;
- (double)locationScoreForEventRule:(id)a0 localeCountryCode:(id)a1 momentCountryCodes:(id)a2 keyboardLanguageCodes:(id)a3;
- (char)momentTraitsMatchesHolidayTraits:(id)a0 momentNode:(id)a1 loggingConnection:(id)a2;
