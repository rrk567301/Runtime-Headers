...
+ (char)_isFallbackMemory:(id)a0;
+ (double)_momentCommonalityScoreComparingMomentNodes:(id)a0 toMomentNodes:(id)a1;
+ (char)canElectEndOfYearTriggeredMemory:(id)a0 withAlreadyElectedMemories:(id)a1;
+ (char)canElectTriggeredMemory:(id)a0 withAlreadyElectedMemories:(id)a1;
...
- (char)tooSoonToElectMemory:(id)a0;
