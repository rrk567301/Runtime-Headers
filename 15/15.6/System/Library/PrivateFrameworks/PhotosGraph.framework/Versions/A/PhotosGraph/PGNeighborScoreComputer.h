...
- (char)_hasAddressNodesForMomentNode:(id)a0;
...
- (id)neighborsFromMomentNode:(id)a0 count:(unsigned long long)a1 locationRequired:(char)a2 minDayDuration:(unsigned long long)a3 maxDayDuration:(unsigned long long)a4;
