...
+ (char)_isHighPrecisionLandscapeAsset:(id)a0;
+ (char)_isHighPrecisionCityscapeAsset:(id)a0;
+ (id)_isVIPStringForResult:(char)a0;
+ (id)_passedFilteringStringForResult:(char)a0;
+ (id)_passedHighPrecisionStringForResult:(char)a0;
...
- (void)_gatherMetricsForStoryPromptSuggestionsQuestions:(id)a0 progressBlock:(id /* block */)a1;
...
- (void)_gatherMetricsForExhaustiveMomentLabelingQuestions:(id)a0 questionMetricType:(unsigned short)a1 isEventLabelingMetricEvent:(char)a2 progressBlock:(id /* block */)a3;
...
- (void)_gatherMetricsForMemoryMusicQuestions:(id)a0 progressBlock:(id /* block */)a1;
...
- (void)_gatherMetricsForRelationshipQuestions:(id)a0 questionMetricType:(unsigned short)a1 progressBlock:(id /* block */)a2 useGraphInference:(char)a3;
...
- (id)_meaningInferenceResultsForMeaningLabel:(id)a0 momentUUIDs:(id)a1 isEventLabelingMetricEvent:(char)a2;
- (id)_meaningLabelsOfMomentNode:(id)a0 forMeaningLabel:(id)a1 isEventLabelingMetricEvent:(char)a2;
...
- (id)_reasonByAssetEntityIdentifierForHolidayQuestions:(id)a0;
- (id)_reasonResultByAssetEntityIdentifierForMusicQualityQuestions:(id)a0;
- (id)_reasonResultByAssetEntityIdentifierForStoryPromptSuggestionsQuestions:(id)a0;
...
- (char)_relationshipInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1 useGraphInference:(char)a2;
- (id)_relationshipInferenceResultsForQuestionMetricType:(unsigned short)a0 personUUIDs:(id)a1 useGraphInference:(char)a2;
- (unsigned long long)_relationshipTagFromQuestionMetricType:(unsigned short)a0;
- (char)_relationshipTagInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1;
- (char)_relatonshipInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1;
...
- (id)preparePayloadForPrecisionRecallEval:(id)a0 withEvaluations:(id)a1;
