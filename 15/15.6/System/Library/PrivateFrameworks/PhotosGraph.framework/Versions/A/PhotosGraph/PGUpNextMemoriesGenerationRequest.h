...
@property (readonly, nonatomic) char wantsVerboseDebugInfo;
...
- (id)initWithRootMemoryLocalIdentifier:(id)a0 momentUUIDs:(id)a1 memoryLocalIdentifiersToAvoid:(id)a2 targetUpNextMemoryCount:(unsigned long long)a3 customVectors:(id)a4 wantsVerboseDebugInfo:(char)a5 sharingFilter:(unsigned short)a6;
...
- (id)localMemoriesByUniqueMemoryIdentifiersWithWorkingContext:(id)a0;
- (id)upNextMemoryLocalIdentifiersWithWorkingContext:(id)a0 rootMemory:(id)a1 localMemoriesByUniqueMemoryIdentifiers:(id)a2 uniqueMemoryIdentifiersOfMemoriesToAvoid:(id)a3 aggregator:(id)a4 debugInfo:(out id *)a5 error:(id *)a6;
