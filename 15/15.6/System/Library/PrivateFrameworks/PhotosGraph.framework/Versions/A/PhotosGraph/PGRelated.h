...
@property (nonatomic, getter=isGeneratingTitleBasedOnKeyAsset) char generateTitleBasedOnKeyAsset;
@property (nonatomic) char shouldGenerateTitle;
...
- (id)_initWithGraphMatchingResult:(id)a0 highlight:(id)a1 moments:(id)a2 needsDebugInfo:(char)a3;
- (id)initWithGraphMatchingResult:(id)a0 assetCollection:(id)a1 needsDebugInfo:(char)a2;
- (id)initWithGraphMatchingResult:(id)a0 highlight:(id)a1 needsDebugInfo:(char)a2;
- (id)initWithGraphMatchingResult:(id)a0 memory:(id)a1 needsDebugInfo:(char)a2;
- (id)initWithGraphMatchingResult:(id)a0 moment:(id)a1 needsDebugInfo:(char)a2;
- (id)initWithGraphMatchingResult:(id)a0 moments:(id)a1 tripMemoryTitleType:(unsigned long long)a2 tripMomentNodes:(id)a3 titleGenerationContext:(id)a4 needsDebugInfo:(char)a5;
- (id)initWithHighlight:(id)a0 needsDebugInfo:(char)a1;
- (id)initWithMemory:(id)a0 needsDebugInfo:(char)a1;
- (id)initWithMoment:(id)a0 needsDebugInfo:(char)a1;
