...
@property (nonatomic) char clearCurations;
...
- (char)smartDescriptionMixedUpdated;
- (char)smartDescriptionPrivateUpdated;
- (char)smartDescriptionSharedUpdated;
- (char)verboseSmartDescriptionMixedUpdated;
- (char)verboseSmartDescriptionPrivateUpdated;
- (char)verboseSmartDescriptionSharedUpdated;
