@class NSString, CLSBusinessCacheUpdater, PGGraphBuilder;
...
- (char)_momentNode:(id)a0 hasValidConstraintsForLocationOfInterestVisit:(id)a1 requiredCriteriaByPOIIdentifier:(id)a2 meaningfulEventProcessorCache:(id)a3;
...
- (char)shouldRunWithGraphUpdate:(id)a0;
