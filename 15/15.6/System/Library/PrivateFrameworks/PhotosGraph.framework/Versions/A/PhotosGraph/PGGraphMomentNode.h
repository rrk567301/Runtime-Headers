...
@property (class, readonly) MARelation *highlightOfMoment;
...
@property (readonly) unsigned char hasHigherThanImprovedAssets : 2;
@property (readonly) unsigned char hasAssetsWithInterestingScenes : 2;
@property (readonly) unsigned char containsBetterScoringAsset : 2;
@property (readonly) unsigned char containsNonJunkAssets : 2;
...
@property (readonly) char happensAtSensitiveLocation;
...
@property (readonly) unsigned char isInteresting : 2;
@property (readonly) unsigned char isInterestingWithAlternateJunking : 2;
@property (readonly) unsigned char isSmartInteresting : 2;
...
+ (id)poiWithNonzeroConfidenceOfMomentWithHasLegacyWeights:(char)a0;
+ (id)propertiesWithMoment:(id)a0;
+ (id)reliableMeaningOfMoment;
+ (id)roiWithNonzeroConfidenceOfMomentWithHasLegacyWeights:(char)a0;
...
+ (id)significantPartOfDayOfMomentWithHasLegacyWeights:(char)a0;
+ (id)smartInterestingFilter;
+ (id)specialPOIOfMoment;
+ (id)timeBasedPropertiesWithMoment:(id)a0;
