...
@property char hasLineBreak;
@property char insertNonBreakableSpace;
@property char hasSpecArgumentHandlingLineBreakBehavior;
...
- (char)_canFulfillWeekdayCriteriaWithMomentNodes:(id)a0;
- (char)_resolveRequiredInputForArgument:(id)a0;
- (id)_titleWithResolvedArguments:(id)a0;
- (id)initWithFormat:(id)a0 titleCategory:(long long)a1;
- (id)titleWithMomentNodes:(id)a0 argumentEvaluationContext:(id)a1;
- (id)titleWithMomentNodes:(id)a0 features:(id)a1 argumentEvaluationContext:(id)a2;
