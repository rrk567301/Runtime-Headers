...
@property (class, readonly) unsigned short domain;

@property (readonly) PGGraphMomentNode *momentNode;
@property (readonly) PGGraphSceneNode *sceneNode;
@property (readonly) double confidence;
@property (readonly, nonatomic) unsigned char isReliable : 2;
@property (readonly, nonatomic) char isSearchableForEvent;
...
+ (id)filter;
+ (id)filterWithMinimumConfidence:(double)a0;
...
- (id)edgeDescription;
- (id)initFromMomentNode:(id)a0 toSceneNode:(id)a1 confidence:(double)a2 isReliable:(char)a3 numberOfAssets:(unsigned long long)a4 numberOfHighConfidenceAssets:(unsigned long long)a5 numberOfSearchConfidenceAssets:(unsigned long long)a6 numberOfDominantSceneAssets:(unsigned long long)a7;
