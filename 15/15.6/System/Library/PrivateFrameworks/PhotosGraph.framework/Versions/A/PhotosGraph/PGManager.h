...
@property (class, readonly, nonatomic) char photosChallengeIsEnabled;
...
@property (readonly) char photoLibraryIsReadonly;
...
+ (void)initialize;
+ (char)graphConsistencyCheckIsEnabled;
...
+ (char)geoServiceProviderDidChangeForGraph:(id)a0;
+ (Class)graphClass;
...
- (id)blockedFeatures;
- (char)copyGraphToURL:(id)a0;
- (char)saveGraphToURL:(id)a0;
...
- (id)curationOfLength:(unsigned long long)a0 forMemory:(id)a1 customDuration:(double)a2 useAssetEligibility:(char)a3 curationContext:(id)a4;
- (unsigned long long)currentGraphVersion;
- (id)defaultGraphExportFullPath;
- (id)defaultSnapshotRootPath;
- (char)generateDefaultRulesForLibraryScopeWithLocalIdentifier:(id)a0 withOptions:(id)a1 error:(id *)a2;
...
- (char)isReadyWithError:(id *)a0;
- (void)matchWithVisualFormat:(id)a0 usingBlock:(id /* block */)a1;
- (char)mePersonContactIdentifierDidChangeWithGraphUpdate:(id)a0;
...
- (id)searchableAssetUUIDsBySocialGroupWithEventUUIDs:(id)a0 ofType:(unsigned long long)a1 isFullAnalysis:(char)a2 progressReporter:(id)a3;
...
- (char)_addressesDidChangeBetweenAddressesInGraph:(id)a0 andAddressesInContacts:(id)a1 addressType:(unsigned long long)a2 person:(id)a3 graph:(id)a4;
...
- (id)_defaultStatisticsWithGraph:(id)a0 verbose:(char)a1 forDiagnostics:(char)a2;
...
- (id)_peopleRelationshipsStatisticsWithGraph:(id)a0 includingDebugInfo:(char)a1;
...
- (id)_socialGroupsDebugStringIncludingMeNode:(char)a0 withGraph:(id)a1;
- (id)_socialGroupsDebugStringWithGraph:(id)a0;
- (id)_socialGroupsStatistics:(id)a0;
- (id)_sortedTextFeaturesFromTextFeatures:(id)a0;
- (id)_stringDescriptionForBusinessItemsWithGraph:(id)a0 includingInferredThroughPublicEvents:(char)a1 verbose:(char)a2;
...
- (id)_stringDescriptionForMeaningfulEvents:(id)a0 isTrip:(char)a1 forDiagnostics:(char)a2 titleGenerationContext:(id)a3;
- (id)_stringDescriptionForMemoriesNotification;
- (id)_stringDescriptionForMusicWithGraph:(id)a0 summaryOnly:(char)a1;
- (id)_stringDescriptionForPeopleEventsWithGraph:(id)a0;
- (id)_stringDescriptionForPetsWithGraph:(id)a0;
- (id)_stringDescriptionForPublicEventsWithGraph:(id)a0 verbose:(char)a1;
- (id)_stringDescriptionForSocialGroups:(id)a0 includeImportance:(char)a1;
- (id)_stringDescriptionForUrbanCities:(id)a0;
- (id)_summaryOfInferencesForMomentNodes:(id)a0 inGraph:(id)a1;
- (char)_supportsSemanticalDedupingForMemory:(id)a0;
...
- (char)canProceedWithFullGraphRebuildStamp:(_Atomic unsigned long long)a0;
...
- (char)date:(id)a0 isEqualToDate:(id)a1;
- (id)defaultPeopleClustersExportIntermediatePath;
- (char)destroyValidationGraph;
...
- (char)graphIsUsable:(id)a0 error:(id *)a1;
...
- (char)homeWorkAddressesDidChangeForPersonInContact:(id)a0 andPersonNode:(id)a1 withHomeWorkNodesByPersonNode:(id)a2 graph:(id)a3;
...
- (char)isInterestingForMoment:(id)a0;
- (char)isSmartInterestingForMoment:(id)a0;
...
- (void)notifyCoalescingBlocksGraphAnalysisFinished:(char)a0 error:(id)a1;
...
- (char)shouldValidateGraphConsistency;
- (void)stampFullGraphRebuild;
- (void)startGraphUpdate:(id)a0 progressBlock:(id /* block */)a1 completionBlock:(id /* block */)a2;
- (void)startLibraryAnalysis:(id /* block */)a0 keepExistingGraph:(char)a1 completionBlock:(id /* block */)a2;
- (void)startLibraryAnalysisWithRecipe:(id)a0 progressBlock:(id /* block */)a1 keepExistingGraph:(char)a2 completionBlock:(id /* block */)a3;
- (char)swapInGraphAtURL:(id)a0 progressBlock:(id /* block */)a1 error:(id *)a2;
...
- (void)unloadGraph;
- (char)updateGraph:(id)a0 withGraphUpdate:(id)a1 withRecipe:(id)a2 progressBlock:(id /* block */)a3;
- (void)updateGraphWithRecipe:(id)a0 keepExistingGraph:(char)a1 progressBlock:(id /* block */)a2 completionBlock:(id /* block */)a3;
