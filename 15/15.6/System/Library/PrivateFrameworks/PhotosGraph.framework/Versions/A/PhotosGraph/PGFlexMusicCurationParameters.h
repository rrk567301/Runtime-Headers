...
- (id)init;
- (void).cxx_destruct;
- (id)initWithMood:(unsigned long long)a0 moodKeywords:(id)a1 recentlyUsedSongs:(id)a2 entityUUID:(id)a3 useMoodKeywords:(char)a4 features:(id)a5 musicCuratorContext:(id)a6;
- (id)initWithMood:(unsigned long long)a0 moodKeywords:(id)a1 recentlyUsedSongs:(id)a2 entityUUID:(id)a3 useMoodKeywords:(char)a4 features:(id)a5 musicCuratorContext:(id)a6 genre:(id)a7;
