...
+ (char)graphExistsAtURL:(id)a0;
+ (char)graphExistsWithName:(id)a0 parentDirectoryURL:(id)a1;
...
- (id)momentsResultForMomentNodes:(id)a0 inPhotoLibrary:(id)a1 sortChronologically:(char)a2;
- (char)eventIsStellar:(id)a0;
- (char)hasSocialGroups;
- (id)highlightGroupNodesSortedByDate;
- (unsigned long long)numberOfPersonNodesIncludingMe:(char)a0;
...
- (char)_enumerateMomentNodesForAssetCollection:(id)a0 paddingTime:(double)a1 error:(id *)a2 enumerationBlock:(id /* block */)a3;
...
- (id)_peopleMatchingResultFromEvent:(id)a0 matchedEvent:(id)a1 presentPeopleCountForEvent:(unsigned long long)a2 presentPeopleCountForMatchedEvent:(unsigned long long)a3 commonPeople:(id)a4 relationshipScoreCache:(id)a5 needsKeywords:(char)a6;
...
- (id)_socialGroupNodeForPersonNodes:(id)a0 searchWithTolerance:(char)a1;
...
- (void)enumeratePeopleClustersIncludingMeNode:(char)a0 socialGroupsVersion:(unsigned long long)a1 singlePersonGroups:(out id *)a2 withBlock:(id /* block */)a3;
- (void)enumeratePeopleClustersWithLinkage:(unsigned long long)a0 threshold:(double)a1 includingMeNode:(char)a2 socialGroupsVersion:(unsigned long long)a3 singlePersonGroups:(out id *)a4 withBlock:(id /* block */)a5;
- (void)enumeratePersonNodesIncludingMe:(char)a0 withBlock:(id /* block */)a1;
- (void)enumeratePublicEventNodesUsingBlock:(id /* block */)a0;
- (void)enumerateSocialGroupsIncludingMeNode:(char)a0 socialGroupsVersion:(unsigned long long)a1 simulateMeNodeNotSet:(char)a2 validGroupsBlock:(id /* block */)a3 invalidGroupsBlock:(id /* block */)a4 averageWeight:(out float *)a5;
- (void)enumerateSocialGroupsIncludingMeNode:(char)a0 validGroupsBlock:(id /* block */)a1 invalidGroupsBlock:(id /* block */)a2 averageWeight:(out float *)a3;
- (void)enumerateSocialGroupsWithBlock:(id /* block */)a0 includeInvalidGroups:(char)a1;
- (char)eventIsVeryMeaningful:(id)a0;
- (id)eventNodeForAssetCollection:(id)a0;
- (char)exportMatchMomentEventResults:(id)a0 relatedType:(unsigned long long)a1 focusOnNodes:(id)a2 toFileURL:(id)a3 error:(id *)a4;
- (id)favoritedPersonNodesIncludingMe:(char)a0;
...
- (char)isBestPairSocialGroup:(id)a0;
- (char)isPairSocialGroup:(id)a0;
- (char)isSocialGroupEligible:(unsigned long long)a0 longevity:(float)a1;
...
- (id)memberLocalIdentifiersBySocialGroupUUIDWithMemberNodesBySocialGroupNode:(id)a0 shouldIncludeMeNode:(char)a1 simulateMeNodeNotSet:(char)a2;
...
- (id)momentsForMomentNodes:(id)a0 inPhotoLibrary:(id)a1 sortChronologically:(char)a2;
- (id)monthNodeForMonth:(long long)a0;
- (id)musicGenreDistributionUsingTaggedGenres:(char)a0;
...
- (id)personNodesIncludingMe:(char)a0;
- (id)poiNodes;
...
- (id)shortTripNodes;
- (char)singlePersonBelongsToSocialGroupOfMaxSize:(id)a0 groups:(id)a1 maxSize:(unsigned long long)a2;
- (char)singlePersonGroupIsInSocialGroups:(id)a0 groups:(id)a1;
...
- (id)socialGroupsIdentifiersFromSocialGroupNodes:(id)a0 shouldIncludeMeNode:(char)a1;
- (id)socialGroupsIdentifiersFromSocialGroupNodesWithMemberNodesBySocialGroupNode:(id)a0 shouldIncludeMeNode:(char)a1 simulateMeNodeNotSet:(char)a2;
