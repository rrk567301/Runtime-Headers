...
+ (id)_beautifiedLocationStringWithTitleComponents:(id)a0 momentNodes:(id)a1 lineBreakBehavior:(unsigned long long)a2 keyAssetAddressNode:(id)a3 curationAddressNodes:(id)a4 isMatchingKeyAsset:(char *)a5 useDistrict:(char)a6 allowFamilyHome:(char)a7 showAllCities:(char)a8 locationHelper:(id)a9 serviceManager:(id)a10;
...
+ (id)_firstComponentInTimeFromComponents:(id)a0 momentNodes:(id)a1 curationAddressNodes:(id)a2 allowFamilyHome:(char)a3 serviceManager:(id)a4;
...
+ (id)_locationStringWithDistrictsFromTitleComponents:(id)a0 momentNodes:(id)a1 lineBreakBehavior:(unsigned long long)a2 allowFamilyHome:(char)a3 locationHelper:(id)a4 serviceManager:(id)a5;
+ (id)_peopleLocationFromAddressNode:(id)a0 serviceManager:(id)a1;
...
+ (char)_titleComponentsAreInSameSupersetCity:(id)a0 graph:(id)a1 locationHelper:(id)a2;
...
+ (id)businessNodeForTitlingFromMomentNodes:(id)a0 businessNodesByMomentNode:(id)a1;
+ (id)commonAOIComponentsForMomentNodes:(id)a0 addressNodes:(id)a1 aoiDisplayType:(unsigned long long)a2 containsAmusementParkPOI:(char)a3 locationHelper:(id)a4;
+ (id)commonCityTitleComponentsFromMomentNodes:(id)a0 addressNodes:(id)a1 incompleteLocationResolver:(id)a2 locationHelper:(id)a3;
+ (char)containsAmusementParkPOIFromMomentNodes:(id)a0;
...
+ (void)generateLocationTitleWithOptions:(id)a0 locationHelper:(id)a1 serviceManager:(id)a2 result:(id /* block */)a3;
+ (id)peopleLocationTitleComponentsFromAddressNodes:(id)a0 peopleDisplayType:(unsigned long long)a1 serviceManager:(id)a2;
+ (id)peopleLocationTitleComponentsFromAddressNodesSet:(id)a0 peopleDisplayType:(unsigned long long)a1 serviceManager:(id)a2;
