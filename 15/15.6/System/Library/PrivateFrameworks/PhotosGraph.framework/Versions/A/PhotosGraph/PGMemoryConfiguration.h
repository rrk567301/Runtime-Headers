...
@property (readonly, nonatomic) char requireSceneProcessingMeetsThresholdOverTime;
@property (readonly, nonatomic) char requireFaceProcessingMeetsThresholdOverTime;
