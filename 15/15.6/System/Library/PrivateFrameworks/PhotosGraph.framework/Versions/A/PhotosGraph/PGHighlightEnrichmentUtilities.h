...
+ (char)canUseLocationInformationWithHighlightInfo:(id)a0 graph:(id)a1;
+ (char)canUseSharingComposition:(unsigned short)a0 forSharingFilter:(unsigned short)a1;
...
+ (id)filteredSummarizedFeaturesForHighlightWithInfo:(id)a0 sharingFilter:(unsigned short)a1;
+ (id)headKeyAssetWithExtendedCuration:(id)a0;
+ (id)internalPredicateForFetchingAssetsForSharingFilter:(unsigned short)a0;
+ (id)keyAssetForDayGroupHighlightWithHighlightInfo:(id)a0 sharingFilter:(unsigned short)a1 curationManager:(id)a2 progressBlock:(id /* block */)a3;
+ (id)keyAssetForMixedSharingCompositionKeyAssetRelationship:(unsigned short)a0 keyAssetPrivate:(id)a1 keyAssetShared:(id)a2;
+ (double)meaningScoreWithMeanings:(id)a0 forLongTrip:(char)a1 graph:(id)a2 collection:(id)a3 keyAsset:(id)a4 keyAssetCriteriaScore:(double *)a5 curationManager:(id)a6;
+ (unsigned short)mixedSharingCompositionKeyAssetRelationshipForKeyAssetPrivate:(id)a0 keyAssetShared:(id)a1 shouldCompareHighlight:(char)a2;
