...
+ (char)candidate:(id)a0 passesFilteringWithContext:(id)a1 curationContext:(id)a2 statistics:(struct { int x0; int x1; } *)a3;
+ (char)passesFilteringWithAsset:(id)a0 curationContext:(id)a1 orientation:(long long)a2 reason:(id *)a3;
