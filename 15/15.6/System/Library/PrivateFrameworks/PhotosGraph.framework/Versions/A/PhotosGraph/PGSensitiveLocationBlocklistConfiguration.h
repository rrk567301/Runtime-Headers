...
+ (char)dateInterval:(id)a0 intersectsSensitiveDateIntervals:(id)a1;
+ (char)isAssetAtSensitiveLocationAndDate:(id)a0;
+ (char)isSensitiveLocation:(id)a0 duringDateInterval:(id)a1;
