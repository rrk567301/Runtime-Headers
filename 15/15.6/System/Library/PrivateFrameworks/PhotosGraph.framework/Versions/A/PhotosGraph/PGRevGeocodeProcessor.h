@class NSArray, CLSLocationCache, PHPhotoLibrary, NSObject;
@protocol OS_os_log;
...
+ (id)momentsRequiringRevGeocodingWithUUIDs:(id)a0 inPhotoLibrary:(id)a1 defaultToAllAssets:(char)a2 loggingConnection:(id)a3;

- (void).cxx_destruct;
- (char)revGeocodeAssets:(id)a0 progressBlock:(id /* block */)a1;
- (id)initWithPhotoLibrary:(id)a0 homeLocations:(id)a1 loggingConnection:(id)a2 locationCache:(id)a3;
...
- (char)_populateCacheWithRegions:(id)a0 withProgressBlock:(id /* block */)a1;
- (void)_processMetricsOfAssetClustersInMoment:(id)a0;
- (char)_regionIsHome:(id)a0;
- (void)_resetMetrics;
- (id)_revGeoLocationDataForRegion:(id)a0;
- (char)_revGeocodeAssetClusters:(id)a0 progressBlock:(id /* block */)a1;
- (char)_setRevGeoLocationData:(id)a0 onAssets:(id)a1;
- (void)_updateGeoInfoForAssetClusters:(id)a0 progressBlock:(id /* block */)a1;
- (char)revGeocodeMoments:(id)a0 progressBlock:(id /* block */)a1;
