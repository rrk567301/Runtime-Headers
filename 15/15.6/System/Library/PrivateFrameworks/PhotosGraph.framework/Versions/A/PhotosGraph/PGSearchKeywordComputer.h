...
- (id)assetSearchKeywordsByMomentUUIDWithEventUUIDs:(id)a0 ofType:(unsigned long long)a1 searchEntityAccumulator:(id)a2 progressBlock:(id /* block */)a3;
...
- (id)searchableAssetUUIDsBySocialGroupWithEventUUIDs:(id)a0 ofType:(unsigned long long)a1 inPhotoLibrary:(id)a2 isFullAnalysis:(char)a3 progressBlock:(id /* block */)a4;
