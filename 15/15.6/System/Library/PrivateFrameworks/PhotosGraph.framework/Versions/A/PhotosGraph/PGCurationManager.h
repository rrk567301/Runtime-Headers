...
+ (char)areAssetsInteresting:(id)a0 minimumNumberOfCuratedAssets:(unsigned long long)a1 duration:(unsigned long long)a2;
+ (id)assetsBeautifier;
...
- (id)_filteredAssetsForAssets:(id)a0 inMoments:(id)a1 keepFavorites:(char)a2;
...
- (id)bestAssetInAssets:(id)a0 forReferencePersonLocalIdentifiers:(id)a1 minimumNumberOfCommonPeople:(unsigned long long)a2 forKeyAsset:(char)a3 forMemories:(char)a4 allowGuestAsset:(char)a5;
- (id)bestAssetInAssets:(id)a0 forReferencePersonLocalIdentifiers:(id)a1 requiredMinimumNumberOfReferencePersons:(unsigned long long)a2 forMemories:(char)a3 forSocialGroup:(char)a4 allowGuestAsset:(char)a5 wantsGoodSquareCropScore:(char)a6;
...
- (char)isAssetCollectionInteresting:(id)a0 curationContext:(id)a1;
- (char)isAssetFeederInteresting:(id)a0 withAlternateJunking:(char)a1 smart:(char)a2;
