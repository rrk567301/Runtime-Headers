...
- (char)_addIfNeededFrequentLocationQuestionForAsset:(id)a0 withLocationTypeName:(id)a1 toQuestions:(id)a2;
- (char)_distanceTooCloseBetweenCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 otherCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a1;
