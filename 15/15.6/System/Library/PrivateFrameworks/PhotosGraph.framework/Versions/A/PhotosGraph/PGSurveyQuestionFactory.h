@class NSArray, NSDictionary, CLSCurationSession, PGManagerWorkingContext, NSString;

@interface PGSurveyQuestionFactory : NSObject <PGQuestionFactory>

@property (nonatomic) char ignoreExistingQuestions;
...
- (char)questionAlreadyExists:(id)a0;
- (id)representativeAssetsFromMomentNode:(id)a0 curationContext:(id)a1;
- (char)shouldAddQuestion:(id)a0 toAlreadyGeneratedQuestions:(id)a1;
