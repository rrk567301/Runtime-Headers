...
@property (readonly) char filterLocations;
@property unsigned long long lineBreakBehavior;
@property (retain) NSSet *usedLocationNodes;

+ (id)argumentWithLocationType:(unsigned long long)a0 filterLocations:(char)a1;
+ (id)argumentWithLocationTypeLocationForLocationName:(id)a0;

- (void).cxx_destruct;
- (id)_generateBusinessItemTitleWithMomentNodes:(id)a0 locationHelper:(id)a1 serviceManager:(id)a2;
- (id)_generateLocationTitleWithOptions:(id)a0 locationHelper:(id)a1 serviceManager:(id)a2;
...
- (id)initWithLocationType:(unsigned long long)a0 filterLocations:(char)a1;
