...
- (id)_assetsStatisticsInHighlights:(id)a0 photoLibrary:(id)a1 includeUtility:(char)a2 progressReporter:(id)a3;
- (id)_dayHighlights;
- (id)_daysWithinAggregations;
- (id)_daysWithinTrips;
- (unsigned long long)_debugNumberOfAssets;
- (id)_defaultHighlights;
- (void)_fillAestheticAndBehavioralCurationStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillContentScoreStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillDayHighlightsStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillGenericStatisticsWithGraph:(id)a0;
- (void)_fillHiddenHighlightsStatisticsWithGraph:(id)a0;
- (void)_fillKeyAssetsStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillMomentsStatisticsWithGraph:(id)a0;
- (void)_fillMonthHighlightsStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillOnesiesHighlightStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
- (void)_fillProcessingLevelStatisticsWithGraph:(id)a0 progressReporter:(id)a1;
