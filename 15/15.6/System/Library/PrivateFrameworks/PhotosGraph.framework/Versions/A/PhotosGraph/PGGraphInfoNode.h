...
+ (id)genericPropertiesWithCreationDate:(id)a0 localeIdentifier:(id)a1 languageIdentifiers:(id)a2 geoServiceProviderID:(id)a3 curationAlgorithmsVersion:(unsigned long long)a4 contactsStoreAccess:(char)a5;
+ (id)locationPropertiesWithCanUseLocationDomain:(char)a0;
...
- (id)initWithCreationDate:(id)a0 localeIdentifier:(id)a1 languageIdentifiers:(id)a2 geoServiceProviderID:(id)a3 curationAlgorithmsVersion:(unsigned long long)a4 contactsStoreAccess:(char)a5;
