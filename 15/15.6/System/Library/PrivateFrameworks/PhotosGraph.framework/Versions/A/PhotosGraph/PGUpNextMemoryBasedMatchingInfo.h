...
@property (readonly, nonatomic) char isTripMemory;
...
- (char)_implIsTripMemory;
- (id)initWithMemoryNodeAsCollection:(id)a0 momentNodes:(id)a1;
- (id)initWithMemoryNodeAsCollection:(id)a0 momentNodes:(id)a1 personNodes:(id)a2 sceneNodes:(id)a3 meaningNodes:(id)a4 isTripMemory:(char)a5 representativeLocation:(id)a6 representativeDate:(id)a7 memoryFeatureNodes:(id)a8;
