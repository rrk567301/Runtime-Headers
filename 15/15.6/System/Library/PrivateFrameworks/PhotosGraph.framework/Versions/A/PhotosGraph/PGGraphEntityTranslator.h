...
@property (class, readonly, nonatomic) Class entityClass;
@property (class, readonly, nonatomic) NSString *entityClassName;
@property (class, readonly, nonatomic) NSString *managedEntityName;
@property (class, readonly, nonatomic) char includesRelationshipChanges;
