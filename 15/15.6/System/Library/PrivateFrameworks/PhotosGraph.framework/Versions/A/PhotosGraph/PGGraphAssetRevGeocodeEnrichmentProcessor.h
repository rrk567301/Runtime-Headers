...
+ (id)homeLocationsWithServiceManager:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (char)_allowReverseGeocodingWithUpdateType:(long long)a0;
...
- (char)revGeoProviderDidChangeForGraphApplicationDataURL:(id)a0;
