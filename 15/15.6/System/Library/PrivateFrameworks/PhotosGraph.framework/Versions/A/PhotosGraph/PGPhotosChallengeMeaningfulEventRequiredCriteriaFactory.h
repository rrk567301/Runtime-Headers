@interface PGPhotosChallengeMeaningfulEventRequiredCriteriaFactory : NSObject
...
+ (id)_requiredCriteriaForIdentifiers:(id)a0 inferenceType:(unsigned long long)a1 graph:(id)a2 sceneTaxonomy:(id)a3 params:(id)a4;
+ (id)_restaurantCriteriaByCriteriaForIdentifiers:(id)a0 withGraph:(id)a1 sceneTaxonomy:(id)a2 params:(id)a3;
...
+ (id)_weddingSceneNodesWithGraph:(id)a0 includeWedding:(char)a1 sceneTaxonomy:(id)a2;
+ (id)_winterSportCriteriaWithGraph:(id)a0 sceneTaxonomy:(id)a1;
+ (id)_winterSportSceneNodesWithGraph:(id)a0 sceneTaxonomy:(id)a1;
+ (id)requiredCriteriaForIdentifiers:(id)a0 inferenceType:(unsigned long long)a1 graph:(id)a2 sceneTaxonomy:(id)a3 params:(id)a4;
