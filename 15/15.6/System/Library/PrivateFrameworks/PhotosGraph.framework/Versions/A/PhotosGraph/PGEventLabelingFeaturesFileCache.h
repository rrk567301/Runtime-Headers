...
- (id)init;
- (void).cxx_destruct;
- (char)clearCacheWithError:(id *)a0;
- (char)isCacheEmptyAtGraphServiceURL:(id)a0;
- (char)writeFeaturesForMomentNode:(id)a0 assetFetchResult:(id)a1 photoLibrary:(id)a2 progressReporter:(id)a3 error:(id *)a4;
