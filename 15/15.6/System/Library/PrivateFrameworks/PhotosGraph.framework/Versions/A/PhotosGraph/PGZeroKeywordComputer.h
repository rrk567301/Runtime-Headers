@class PGGraphMomentNodeCollection, PGCurationManager, CLSSceneTaxonomyHierarchy, CLSCurationContext, PHPhotoLibrary, PGSearchComputationCache;
...
@property (readonly, nonatomic) char shouldFilterMomentNodesWithPresence;
...
- (id)placeZeroKeywordsWithGraph:(id)a0 options:(id)a1 progressBlock:(id /* block */)a2;
- (id)sceneZeroKeywordsWithGraph:(id)a0 options:(id)a1 progressBlock:(id /* block */)a2;
- (id)socialGroupKeyAssetLocalIdentifierWithPersonLocalIdentifiers:(id)a0;
