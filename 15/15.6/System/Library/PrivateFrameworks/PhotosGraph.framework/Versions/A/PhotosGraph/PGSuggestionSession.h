...
- (char)suggesterClass:(Class)a0 supportsOptions:(id)a1;
- (char)suggestion:(id)a0 isEqualToSuggestion:(id)a1;
- (char)_suggestionIsColliding:(id)a0 relaxCollisionRules:(char)a1;
- (id)activeSuggestersWithOptions:(id)a0;
- (id)anySuggestionCollidingWithSuggestion:(id)a0 inSuggestions:(id)a1 relaxCollisionRules:(char)a2 collisionReason:(unsigned long long *)a3;
...
- (unsigned long long)outstanderSuggestion:(id)a0 collidesWithSuggestion:(id)a1 relaxCollisionRules:(char)a2;
- (unsigned long long)reasonForSuggestion:(id)a0 collidingWithSuggestion:(id)a1 relaxCollisionRules:(char)a2;
- (unsigned long long)singleAssetSuggestion:(id)a0 collidesWithSuggestion:(id)a1;
- (id)suggesterClasses;
- (char)suggestion:(id)a0 collidesWithMemories:(id)a1;
- (id)suggestionsByCollisionReasonCollidingWithSuggestion:(id)a0 inSuggestions:(id)a1 relaxCollisionRules:(char)a2;
- (char)supportsRelaxedCollisionRulesForSuggester:(id)a0;
