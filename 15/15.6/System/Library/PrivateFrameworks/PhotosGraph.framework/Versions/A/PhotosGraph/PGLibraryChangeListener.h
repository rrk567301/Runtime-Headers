...
@property char libraryBecameUnavailable;
...
- (id)_consumer:(id)a0 withChangeTokens:(id)a1 processedChangeTokens:(id)a2 consumedTokens:(char)a3;
- (char)_distributeChangesInFetchResult:(id)a0;
...
- (void)registerForLibraryUnavailability:(id)a0;
