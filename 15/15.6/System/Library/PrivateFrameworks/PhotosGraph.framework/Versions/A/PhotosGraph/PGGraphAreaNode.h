...
@property (readonly) unsigned char isBlocked : 2;
...
@property (readonly, nonatomic) char supportsNameShortening;
...
+ (void)setIsBlocked:(char)a0 onNodeForIdentifier:(unsigned long long)a1 inGraph:(id)a2;
...
- (id)addressNodes;
- (char)diameterIsLargerThanDiameter:(double)a0;
- (id)initWithLabel:(id)a0 domain:(unsigned short)a1 properties:(id)a2;
- (id)initWithLabel:(id)a0 domain:(unsigned short)a1 weight:(float)a2 properties:(id)a3;
- (id)initWithName:(id)a0 isBlocked:(char)a1 popularityScore:(double)a2;
