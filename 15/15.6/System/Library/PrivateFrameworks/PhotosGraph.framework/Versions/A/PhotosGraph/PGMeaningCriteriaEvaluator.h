...
+ (id)meaningCriteriaEvaluatorsForMeaningLabel:(id)a0 withDictionary:(id)a1 serviceManager:(id)a2;

- (id)description;
- (void).cxx_destruct;
- (char)allCriteriaIsValid;
- (char)allCriteriaPassForAssets:(id)a0;
- (char)allCriteriaPassForMomentNode:(id)a0 momentNodeCache:(id)a1;
- (id)initWithDictionary:(id)a0 meaningCriteriaInfo:(id)a1 serviceManager:(id)a2;
