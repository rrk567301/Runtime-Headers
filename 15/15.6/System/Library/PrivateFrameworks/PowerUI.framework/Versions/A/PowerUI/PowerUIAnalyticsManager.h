...
- (char)submitEngagementEventWithBatteryLevel:(id)a0 targetSoC:(id)a1 predictedEndOfCharge:(id)a2 modeOfOperation:(int)a3 eventType:(int)a4;
- (char)submitGaugingEventWithUpdateType:(int)a0 qmaxState:(int)a1 daysSinceQMax:(id)a2 ocvState:(int)a3 daysSinceOCV:(id)a4 fullChargeState:(int)a5 daysSinceFullChargeAttempt:(id)a6;
