...
@property (nonatomic) char immediateCharge;
...
+ (id)obcEngagedContentWithDeadline:(id)a0 toppingOff:(char)a1;
+ (id)obcEngagedRequestWithDeadline:(id)a0 isToppingOff:(char)a1;
...
- (char)internalCECNotificationsDisabled;
...
- (id)postInternalCECNotificationWithID:(id)a0 chargingStatus:(char)a1 information:(id)a2 shouldReplace:(char)a3;
- (void)postInternalChargeDurationNotificationWithDuration:(double)a0 withConfidence:(double)a1;
- (id)postInternalChargingIntelligenceNotificationWithChargingStatus:(char)a0 information:(id)a1 url:(id)a2 validUntil:(id)a3;
