...
- (char)inTypicalChargingLocationWithError:(id *)a0;
...
- (char)locationIsUncertain:(id)a0;
...
- (id)longChargesAroundDate:(id)a0 withinSeconds:(double)a1 withinDays:(int)a2 withMinimumDuration:(double)a3 checkWhetherNearDate:(char)a4;
- (char)longChargesOccurredInLocationsNear:(id)a0 withError:(id *)a1;
