...
- (void)client:(id)a0 setChargingStatus:(char)a1 withHandler:(id /* block */)a2;
...
- (void)engageFrom:(id)a0 until:(id)a1 repeatUntil:(id)a2 overrideAllSignals:(char)a3 withHandler:(id /* block */)a4;
...
- (void)simulateCurrentOutputAsOfDate:(id)a0 overrideAllSignals:(char)a1 withHandler:(id /* block */)a2;
