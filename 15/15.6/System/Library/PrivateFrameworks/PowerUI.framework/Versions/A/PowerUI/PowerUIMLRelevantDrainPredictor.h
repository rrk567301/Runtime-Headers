...
- (char)isStartSecondsValue:(double)a0 withinDynamicBinWindowOfLength:(int)a1 aroundCurrentStartSecondValue:(double)a2;
- (char)isStartSoCValue:(double)a0 withinDynamicBinWindowOfLength:(int)a1 aroundCurrentStartSoCValue:(double)a2;
