...
- (double)adjustedChargingDecision:(unsigned long long)a0 withPluginDate:(id)a1 withPluginBatteryLevel:(double)a2 forDate:(id)a3 forStatus:(char)a4;
- (id)arrayWithShape:(id)a0 values:(id)a1 type:(long long)a2;
- (struct PowerUIModelQueryResult { char x0; double x1; double x2; })chargingDecision:(unsigned long long)a0 withPluginDate:(id)a1 withPluginBatteryLevel:(double)a2 forDate:(id)a3 withLog:(id)a4;
