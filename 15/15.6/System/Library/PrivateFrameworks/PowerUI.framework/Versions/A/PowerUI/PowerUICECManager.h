...
@property (nonatomic) char displayedFirstTimeNotification;
@property (nonatomic) char isCECEnabled;
@property (nonatomic) char isCECTemporarilyDisabled;
...
@property (nonatomic) char tOverrideActiveCheck;
@property (nonatomic) char firstChargingEvaluation;
...
@property (nonatomic) char shouldSupportCEC;
...
- (char)shouldEngageCEC;
- (void)unregisterTimer;
- (void)recordAnalytics;
- (void)analyticsCECEngagementEvaluation:(char)a0 byPredictedTime:(char)a1 byGridMix:(char)a2;
- (void)analyticsCECSessionChargingState:(char)a0;
- (unsigned long long)cecState;
- (void)clearAnalyticsDate;
- (id)defaultDateToDisableUntilGivenDate:(id)a0;
- (char)evaluateEngagementAndSetup;
...
- (void)setTemporarilyDisabled:(char)a0 from:(id)a1;
