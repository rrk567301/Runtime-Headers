...
+ (int)_anchorType2CertType:(int)a0;
...
- (int)_validateCertificateChain:(id)a0 realtime:(char)a1 error:(id *)a2;
...
- (id)copyEvaluatedCertificateChainInfo:(id)a0 forSpecificType:(int)a1;
- (id)copyLeafCertificateSerialNumber:(id)a0;
- (id)copyParsedCertificateChainInfo:(id)a0 assumeType:(int)a1;
- (id)copyParsedCertificateChainInfoFromCerts:(id)a0 assumeType:(int)a1;
...
- (void)validateCertificate:(id)a0 realtime:(char)a1 completionHandler:(id /* block */)a2;
- (int)validateCertificate:(id)a0 realtime:(char)a1 error:(id *)a2;
- (int)validateCertificateChain:(id)a0 realtime:(char)a1 error:(id *)a2;
- (int)validateCertificateChain:(id)a0 type:(int)a1 realtime:(char)a2 error:(id *)a3;
