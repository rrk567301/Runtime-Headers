...
@property (readonly, nonatomic) char isUnfinishedOrPending;
...
- (id)initWithTaskID:(id)a0 localeID:(id)a1 trainingAssetURL:(id)a2 dataAssetURL:(id)a3 inferenceAssetURL:(id)a4 trainingMode:(long long)a5 startImmediately:(char)a6;
