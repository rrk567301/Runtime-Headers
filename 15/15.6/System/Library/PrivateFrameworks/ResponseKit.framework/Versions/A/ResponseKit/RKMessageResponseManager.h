...
+ (char)_isMirroredResponseValidForResponse:(id)a0;
+ (id)_mostRecentTextFromChronologicalConversationHistory:(id)a0;
+ (char)_needsMirroredAnalysisForMessage:(id)a0 forChronologicalConversationHistory:(id)a1;
+ (char)_responseLooksLikeIncomingCheckInResponse:(id)a0;
+ (char)_responseLooksLikeOutgoingCheckInResponse:(id)a0;
+ (char)_responseTypeIsSunsetted:(id)a0;
...
- (char)isQuestion:(id)a0 withLanguage:(id)a1;
