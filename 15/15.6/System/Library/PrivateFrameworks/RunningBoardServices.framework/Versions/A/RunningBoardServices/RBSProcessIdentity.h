...
@property (readonly, nonatomic) char inheritsCoalitionBand;
@property (readonly, nonatomic, getter=isDext) char dext;
@property (readonly, nonatomic, getter=isAnonymous) char anonymous;
@property (readonly, nonatomic) char isMultiInstanceExtension;
...
@property (readonly, nonatomic) char supportsLaunchingDirectly;
@property (readonly, nonatomic, getter=isEmbeddedApplication) char embeddedApplication;
...
+ (id)identityForLaunchdJobLabel:(id)a0 isMultiInstance:(char)a1 pid:(int)a2 auid:(unsigned int)a3;
