...
@property (nonatomic) char hasStartedUp;
...
- (id)_fetchRecordsWithRecordIDs:(id)a0 canRetry:(char)a1;
- (id)_leaveCloudShareRequestingNewInvitationToken:(char)a0 allowCloudPull:(char)a1;
- (id)_performCloudPullWithOptions:(id)a0 useCachedServerToken:(char)a1;
- (id)_performImmediateCloudPullWithOptions:(id)a0 useCachedServerToken:(char)a1;
...
- (id)_setWriteAccessEnabled:(char)a0 forParticipant:(id)a1 usingShare:(id)a2;
...
- (char)isInternalModel:(id)a0;
- (id)leaveCloudShareRequestingNewInvitationToken:(char)a0;
...
- (char)populateManateeCloudRecord:(id)a0 withModel:(id)a1 encodingContext:(id)a2 error:(id *)a3;
- (char)populateV4CloudRecord:(id)a0 withModel:(id)a1 metadataFieldData:(id)a2 startEncoding:(unsigned long long)a3 endEncoding:(unsigned long long)a4 encodingContext:(id)a5 error:(id *)a6;
- (void)pushGroupWithBlockRow:(unsigned long long)a0 tuples:(id)a1 options:(id)a2 activity:(id)a3 completionPromise:(id)a4;
- (id)pushRecordsToUpdate:(id)a0 recordIDsToRemove:(id)a1 configuration:(id)a2 rollbackEnabled:(char)a3;
- (id)pushRecordsToUpdate:(id)a0 recordIDsToRemove:(id)a1 configuration:(id)a2 rollbackEnabled:(char)a3 needsNewInvitationToken:(char)a4;
- (id)queryRecordsWithType:(id)a0;
- (id)recordIDForModel:(id)a0;
- (id)registerSubscriptionForExternalRecordType:(id)a0;
- (char)resolveConflicts:(id)a0 options:(id)a1;
- (char)retryCloudKitOperation:(id)a0 afterError:(id)a1 retryBlock:(id /* block */)a2;
- (id)revokeShareAccessForParticipant:(id)a0;
- (id)setWriteAccessEnabled:(char)a0 forParticipant:(id)a1;
