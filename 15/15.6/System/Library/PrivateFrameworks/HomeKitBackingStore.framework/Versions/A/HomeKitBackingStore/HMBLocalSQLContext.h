...
+ (void)unlinkDatastoreAt:(id)a0 everything:(char)a1;
...
- (char)_deleteItemsWithBlockRow:(unsigned long long)a0 error:(id *)a1;
- (char)_updateRecordWithRow:(unsigned long long)a0 modelEncoding:(unsigned long long)a1 modelData:(id)a2 modelSchema:(id)a3 error:(id *)a4;
- (long long)migrateFromSchemaVersion:(long long)a0 error:(id *)a1;
- (char)_deleteBlocksWithZoneRow:(unsigned long long)a0 error:(id *)a1;
...
- (char)_deleteBlockWithRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteIndexSentinelsWithModelType:(id)a0 error:(id *)a1;
- (char)_deleteIndexSentinelsWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteItemWithRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteItemWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteItemWithZoneRow:(unsigned long long)a0 type:(unsigned long long)a1 externalID:(id)a2 error:(id *)a3;
- (char)_deleteNullBlocksWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteNullItemsWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteNullItemsWithZoneRow:(unsigned long long)a0 type:(unsigned long long)a1 error:(id *)a2;
- (char)_deleteRecordWithRow:(unsigned long long)a0 error:(id *)a1;
- (unsigned long long)_deleteRecordWithRow:(unsigned long long)a0 expectedOutputBlockRow:(unsigned long long)a1 error:(id *)a2;
- (char)_deleteRecordWithZoneRow:(unsigned long long)a0 externalID:(id)a1 error:(id *)a2;
- (char)_deleteRecordWithZoneRow:(unsigned long long)a0 modelID:(id)a1 error:(id *)a2;
- (char)_deleteRecordsWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteZombieRecordsWithZoneRow:(unsigned long long)a0 error:(id *)a1;
- (char)_deleteZoneWithRow:(unsigned long long)a0 error:(id *)a1;
...
- (char)_insertIndexSentinelWithZoneRow:(unsigned long long)a0 modelType:(id)a1 error:(id *)a2;
...
- (char)_resetOutputForRecordsWithBlockRow:(unsigned long long)a0 error:(id *)a1;
...
- (char)_selectRecordsWithZoneRow:(unsigned long long)a0 modelType:(id)a1 returning:(unsigned long long)a2 error:(id *)a3 handler:(id /* block */)a4;
...
- (char)_updateBlockWithRow:(unsigned long long)a0 options:(id)a1 error:(id *)a2;
- (char)_updateItemWithZoneRow:(unsigned long long)a0 blockRow:(unsigned long long)a1 type:(unsigned long long)a2 externalID:(id)a3 externalData:(id)a4 modelEncoding:(unsigned long long)a5 modelData:(id)a6 error:(id *)a7;
- (char)_updateRecordWithRow:(unsigned long long)a0 externalID:(id)a1 externalData:(id)a2 error:(id *)a3;
- (char)_updateRecordWithRow:(unsigned long long)a0 modelType:(id)a1 modelSchema:(id)a2 error:(id *)a3;
- (char)_updateRecordWithRow:(unsigned long long)a0 pushBlockRow:(id)a1 pushData:(id)a2 pushEncoding:(unsigned long long)a3 error:(id *)a4;
- (char)_updateRecordWithZoneRow:(unsigned long long)a0 externalID:(id)a1 externalData:(id)a2 error:(id *)a3;
- (char)_updateRecordWithZoneRow:(unsigned long long)a0 modelID:(id)a1 externalData:(id)a2 error:(id *)a3;
- (char)_updateRecordWithZoneRow:(unsigned long long)a0 modelID:(id)a1 pushEncoding:(unsigned long long)a2 pushData:(id)a3 pushBlockRow:(id)a4 error:(id *)a5;
- (char)_updateRecordsClearPushWithPushBlockRow:(unsigned long long)a0 error:(id *)a1;
- (char)_updateZoneWithRow:(unsigned long long)a0 replication:(id)a1 error:(id *)a2;
- (char)initializeNewlyCreatedDatabaseWithError:(id *)a0;
- (long long)migrateToSchema01WithError:(id *)a0;
- (char)prepareTablesWithError:(id *)a0;
...
- (char)sqlBlockWithActivity:(id)a0 error:(id *)a1 block:(id /* block */)a2;
- (id)sqlTransactionWithActivity:(id)a0 block:(id /* block */)a1;
- (char)sqlTransactionWithActivity:(id)a0 error:(id *)a1 block:(id /* block */)a2;
