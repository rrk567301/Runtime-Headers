...
- (char)bindPropertiesToStatement:(struct sqlite3_stmt { } *)a0 currentSequence:(id)a1 error:(id *)a2;
- (id)fetchRowFromStatement:(struct sqlite3_stmt { } *)a0 skip:(char *)a1 updatedSequenceColumn:(id *)a2 error:(id *)a3;
