...
+ (char)shouldMirrorInputExternalData:(id)a0 overwriteExistingExternalData:(id)a1;
...
- (char)removeOutputBlockWithRow:(unsigned long long)a0 error:(id *)a1;
...
- (void)startUp;
- (char)_insertDeletionItemsForModelsAndDescendantModelsWithBlockRow:(unsigned long long)a0 context:(id)a1 type:(unsigned long long)a2 modelIDs:(id)a3 currentDepth:(unsigned long long)a4 maximumDepth:(unsigned long long)a5 options:(id)a6 error:(id *)a7;
...
- (char)removeAllRecordsWithError:(id *)a0;
- (char)removeBlockWithRow:(unsigned long long)a0 error:(id *)a1;
