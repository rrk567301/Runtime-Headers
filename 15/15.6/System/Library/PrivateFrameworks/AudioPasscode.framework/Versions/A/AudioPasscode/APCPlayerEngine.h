...
- (char)startEngine;
- (char)startEngineAtTime:(unsigned long long)a0;
- (char)startEngineAtTime:(unsigned long long)a0 withBeginning:(id /* block */)a1;
- (char)startEngineAtTime:(unsigned long long)a0 withBeginning:(id /* block */)a1 callbackTime:(unsigned long long)a2;
- (void)stopEngine:(char)a0 withCompletion:(id /* block */)a1;
