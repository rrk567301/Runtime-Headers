...
@property (nonatomic) char silenceOutputOnNextAssetEnding;
@property (nonatomic) unsigned long long numLoopsToStopAfter;
@property (nonatomic) float fadeOutTimeSeconds;
@property (nonatomic) char triggerFadeOut;
@property (nonatomic) char embedPasscode;
...
- (id).cxx_construct;
- (void)reset;
- (char)allocateRenderResourcesAndReturnError:(id *)a0;
