...
@property (nonatomic) char prefersSeparatorsInLeadingGroup;
@property (nonatomic) char prefersSeparatorsInTrailingGroup;
...
@property (nonatomic) char customSectionInsets;

+ (long long)sectionType;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (id)buildGroupForFractionalWidth:(double)a0 numberOfCards:(long long)a1 isTopAligned:(char)a2 prefersSeparator:(char)a3 forView:(id)a4;
...
- (char)primaryCardSectionIsLeading;
- (id)rowModels;
