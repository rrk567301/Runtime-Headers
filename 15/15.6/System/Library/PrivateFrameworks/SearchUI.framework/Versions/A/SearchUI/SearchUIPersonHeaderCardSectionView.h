...
- (void)contactHeaderViewController:(id)a0 didPerformActionOfType:(id)a1 fromDisambiguation:(char)a2;
- (void)contactHeaderViewController:(id)a0 willPresentDisambiguationUIForActionType:(id)a1;
- (id)setupContentView;
- (id)embeddedViewController;
- (void)sendCommandEngagementFeedbackWithType:(id)a0 didSelectFromOptionsMenu:(char)a1 didDisplayHandleOptions:(char)a2;
