...
+ (void)createViewControllersForButtons:(id)a0 buttonFont:(id)a1 isCompact:(char)a2 sourceView:(id)a3 rowModel:(id)a4 delegate:(id)a5 completionHandler:(id /* block */)a6;
...
+ (char)supportsConfigurationForCardSection:(id)a0;
