...
@property (readonly) char prefersModalPresentation;
@property (readonly) char supportsShare;
...
+ (char)hasValidCommandForResult:(id)a0 feedbackListener:(id)a1;
...
+ (char)hasCustomViewControllerForRowModel:(id)a0 environment:(id)a1;
+ (char)hasValidHandlerForCommand:(id)a0 rowModel:(id)a1 environment:(id)a2;
+ (char)hasValidHandlerForRowModel:(id)a0 environment:(id)a1;
+ (char)isDestructiveButtonItem:(id)a0;
+ (id)lastCopyCommandForRowModel:(id)a0;
+ (id)pasteboardObjectForRowModel:(id)a0 environment:(id)a1 isDragging:(char)a2;
...
- (id)menuForRowModel:(id)a0 buttonItem:(id)a1 commandEnvironment:(id)a2 doesFallbackToCardSectionButtonItems:(char)a3;
...
- (char)shouldDeselectAfterExecution;
