...
- (char)clickable;
- (void)updateWithImage:(id)a0 animateTransition:(char)a1;
- (void)updateWithImage:(id)a0 fallbackImage:(id)a1 needsOverlayButton:(char)a2;
- (void)updateWithImage:(id)a0 fallbackImage:(id)a1 needsOverlayButton:(char)a2 animateTransition:(char)a3;
