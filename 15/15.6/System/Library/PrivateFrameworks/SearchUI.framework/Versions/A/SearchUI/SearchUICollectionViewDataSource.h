...
- (void)applySnapshot:(id)a0 animated:(char)a1 skipsDiffing:(char)a2 completion:(id /* block */)a3;
...
- (void)reloadSection:(id)a0 animated:(char)a1;
- (void)reloadSection:(id)a0 animated:(char)a1 reconfigureExisting:(char)a2;
- (void)reloadSectionWithIdentifier:(id)a0 animated:(char)a1 reconfigureExisting:(char)a2;
...
- (void)updateWithSnapshot:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
