...
@property (nonatomic) char presentsAlternateDetails;
@property (nonatomic) char selectAlternateResult;
...
- (char)isValidResultForFeedback:(id)a0;
- (id)sectionForRow:(unsigned long long)a0;
- (char)selectAlternateResultTemporarily:(char)a0;
...
- (void)sendVisibleResultsFeedbackForOnlyNewResults:(char)a0;
