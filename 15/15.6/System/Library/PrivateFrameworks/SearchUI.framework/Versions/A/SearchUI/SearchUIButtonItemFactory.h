...
- (id)init;
- (void).cxx_destruct;
- (void)fetchSearchUIButtonitemsWithSFButtonItems:(id)a0 maxButtonItems:(unsigned long long)a1 shouldReverseButtonOrder:(char)a2 completion:(id /* block */)a3;
- (void)updateCompletionHandlerWithSFButtonItems:(id)a0 maxButtonItems:(unsigned long long)a1 shouldReverseButtonOrder:(char)a2 completion:(id /* block */)a3;
