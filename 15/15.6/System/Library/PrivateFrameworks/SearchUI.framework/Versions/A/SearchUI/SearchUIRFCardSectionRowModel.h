...
@property (nonatomic, readonly) char hasLeadingImage;
@property (nonatomic, readonly) char prefersNoSeparatorAbove;
@property (nonatomic, readonly) NSString *dragTitle;
@property (nonatomic, readonly) NSString *dragSubtitle;
@property (nonatomic, readonly) char supportsCustomHighlightBehavior;
...
+ (char)shouldHideViewForCardSection:(id)a0;
+ (char)supportsConfigurationFor:(id)a0;
