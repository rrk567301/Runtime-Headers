...
@property (readonly) char supportsContextMenuConfiguration;
...
- (void)updateImageForStatusUpdate:(char)a0;
- (void)updateWithButtonItem:(id)a0 buttonItemViewType:(unsigned long long)a1;
- (void)updateWithButtonItem:(id)a0 buttonItemViewType:(unsigned long long)a1 isStatusUpdate:(char)a2;
