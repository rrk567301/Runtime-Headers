...
+ (id)alignLeadingView:(id)a0 toTrailingView:(id)a1 spacing:(double)a2 minimum:(char)a3 priority:(float)a4;
...
+ (id)baselineAlignBottomView:(id)a0 toTopView:(id)a1 dynamicSpacing:(double)a2 forFont:(id)a3 minimum:(char)a4;
+ (id)baselineAlignBottomView:(id)a0 toTopView:(id)a1 dynamicSpacing:(double)a2 minimum:(char)a3;
...
+ (id)baselineAlignBottomView:(id)a0 toTopView:(id)a1 spacing:(double)a2 isDynamic:(char)a3 forFont:(id)a4 minimum:(char)a5;
+ (id)baselineAlignBottomView:(id)a0 toTopView:(id)a1 spacing:(double)a2 isDynamic:(char)a3 forFont:(id)a4 minimum:(char)a5 priority:(float)a6;
+ (id)baselineAlignBottomView:(id)a0 toTopView:(id)a1 spacing:(double)a2 minimum:(char)a3;
...
+ (char)frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isVisibleInBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 insettedBy:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a1 isLTR:(char)a2;
+ (double)roundedItemCornerRadius;
+ (double)sectionCornerRadius;
+ (void)setVisibility:(char)a0 forView:(id)a1;
+ (char)view:(id)a0 isVisibleInBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 ofView:(id)a2;
