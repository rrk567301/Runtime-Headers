@class SFEngagementSignal, NSString, NSArray, NSDictionary, GEOUserSessionEntity, NSData, PARReply;
...
@property (nonatomic) char suggestionsAreBlended;
...
- (id)initWithReply:(id)a0 factory:(id)a1 responseData:(id)a2;
