...
+ (id)sessionWithConfiguration:(id)a0 delegate:(id)a1 startImmediately:(char)a2;
...
- (id)imageLoader;
- (id)initInternal:(id)a0 startImmediately:(char)a1;
- (id)initWithConfiguration:(id)a0 connection:(id)a1 delegate:(id)a2 startImmediately:(char)a3;
- (char)loadImage:(id)a0 withCompletionHandler:(id /* block */)a1;
- (char)loadImage:(id)a0 withContext:(id)a1 completionHandler:(id /* block */)a2;
- (char)loadMoreResults:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)loadTask:(id)a0;
