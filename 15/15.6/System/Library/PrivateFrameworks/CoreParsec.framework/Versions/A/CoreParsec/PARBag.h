@class NSURL, NSString, NSDictionary, NSData, NSArray, NSNumber, NSUserDefaults;
...
@property (readonly, nonatomic) char feedbackEnabled;
@property (readonly, nonatomic) char imageTimingFeedbackEnabled;
...
@property (readonly, nonatomic) char smartHistoryEnabled;
...
@property (readonly, nonatomic) char smartHistoryFeatureFeedbackEnabled;
@property (readonly, nonatomic) unsigned long long smartHistoryMinimumQueryLength;
@property (readonly, nonatomic) char sampleClientTiming;
...
@property (readonly, nonatomic) char sampleFeatures;
@property (readonly, nonatomic) char collectScores;
@property (readonly, nonatomic) char collectAnonymousMetadata;
@property (readonly, nonatomic) NSArray *anonymousMetadataPreference;
@property (readonly, nonatomic) char use2LayerRanking;
@property (readonly, nonatomic) NSArray *suggestionRankerModel;
@property (readonly, nonatomic) char disableAsTypedSuggestion;
@property (readonly, nonatomic) char spotlightBiomeFBWritesEnabled;
@property (readonly, nonatomic) char spotlightFeatureQualityAggregatesEnabled;
@property (readonly, nonatomic) char spotlightFeatureQualityUploadsEnabled;
...
@property (readonly, nonatomic) char rpcCompression;
@property (readonly, nonatomic) char exp;
@property (readonly, nonatomic) char engagementCardGrpcDisabled;
...
@property (readonly, nonatomic) char allowSafariRankingDataCollection;
@property (readonly, nonatomic) char sessionExperimentMetadataEnabled;
@property (readonly, nonatomic) char experimentsCustomFeedbackEnabled;
...
@property (readonly, nonatomic) char disableSafariNavIntent;
@property (readonly, copy, nonatomic) NSString *dpgDenyListBundleIDs;
@property (readonly, nonatomic) char assumesHTTP3Capable;
@property (readonly, nonatomic) char enablesL4S;
...
- (id)bagURL;
- (char)bag_boolForKey:(id)a0;
- (id)_bag_objectOfClass:(Class)a0 forKey:(id)a1;
- (id)_bag_objectOfClass:(Class)a0 forKey:(id)a1 override:(char)a2;
...
- (id)valueForKey:(id)a0 override:(char)a1;
