...
@property (readonly, nonatomic) char hasPeople;
@property (readonly, nonatomic) char hasFavoritedAssets;
@property (readonly, nonatomic) char hasBestScoringAssets;
@property (readonly, nonatomic) char hasNonJunkAssets;
...
+ (id)feederForAssetCollection:(id)a0 options:(id)a1 feederPrefetchOptions:(id)a2 curationContext:(id)a3 sharedLibraryEnabled:(char)a4;
