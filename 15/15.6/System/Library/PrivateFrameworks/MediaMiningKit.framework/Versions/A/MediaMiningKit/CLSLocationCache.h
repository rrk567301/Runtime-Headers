...
+ (char)cachedRegion:(id)a0 isMatchingOtherRegion:(id)a1;
+ (id)defaultCacheName;
...
- (char)hasCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 withHorizontalAccuracy:(double)a1;
