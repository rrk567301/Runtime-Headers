...
- (char)isRemoteLocation:(id)a0 inDateInterval:(id)a1;
...
- (id)mePersonFetchContactIfNeeeded:(char)a0;
...
- (id)personsFromEventParticipants:(id)a0 excludeCurrentUser:(char)a1;
