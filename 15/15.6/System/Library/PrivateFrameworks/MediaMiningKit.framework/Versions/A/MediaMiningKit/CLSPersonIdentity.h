...
@property (nonatomic) char isUserCreated;
@property (nonatomic) char hasContactProfilePicture;
@property (nonatomic) char hasPhoneNumber;
...
+ (char)isChildRelationship:(unsigned long long)a0;
+ (char)isFamilyRelationship:(unsigned long long)a0;
+ (char)isParentRelationship:(unsigned long long)a0;
+ (char)isSiblingRelationship:(unsigned long long)a0;
+ (id)mePerson;
...
- (char)hasAddresses;
- (char)hasSameFamilyNameAsPerson:(id)a0;
- (char)isLocationCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 closeToAddressesOfType:(unsigned long long)a1;
- (char)isLocationCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 farAwayFromAddressesOfType:(unsigned long long)a1;
- (char)isOrganization;
