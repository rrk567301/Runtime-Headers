...
- (id)universalDates;
- (id)locationRegions;
- (char)hasMeaningClueWithKey:(id)a0 andValue:(id)a1;
...
- (char)hasMeaningClueWithKey:(id)a0 value:(id)a1 andMinimumScore:(double)a2;
- (char)hasOutputClueWithKey:(id)a0 andValue:(id)a1;
- (char)hasOutputClueWithKey:(id)a0 value:(id)a1 andMinimumScore:(double)a2;
