...
@property (nonatomic) char enableDensityClusteringLocationsDistance;
...
@property (nonatomic) char enableMultipassDensityClustering;
...
@property (nonatomic) char enableAdaptiveElectionSmoother;
@property (nonatomic) char enableAdaptiveElectionSmootherAutomaticLimit;
