...
- (id)_personResultsForPersonLocalIdentifier:(id)a0 isLackingFaces:(out char *)a1 inPhotoLibrary:(id)a2;
- (id)_personResultsForfullName:(id)a0;
- (id)_personWithContact:(id)a0 viewPerson:(id)a1 createPersonIfNeeded:(char)a2;
...
- (id)inferredDeviceOwnerForPhotoLibrary:(id)a0 ignoreContactLinking:(char)a1;
...
- (id)personsInContactStoreForContactIdentifiers:(id)a0 needsRefetching:(char)a1 progressBlock:(id /* block */)a2;
