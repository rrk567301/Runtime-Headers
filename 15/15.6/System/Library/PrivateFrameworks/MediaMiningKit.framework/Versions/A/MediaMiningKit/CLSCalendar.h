...
+ (char)isDateValid:(id)a0;
+ (char)isFirstMonthOfSeasonForLocalDate:(id)a0;
+ (char)isFirstTenDaysOfSeasonForLocalDate:(id)a0;
+ (char)isFirstTwoWeeksOfMonthForLocalDate:(id)a0;
+ (char)isLastMonthOfSeasonForLocalDate:(id)a0;
+ (char)isLastTwoWeeksOfMonthForLocalDate:(id)a0;
+ (char)isLastWeekOfMonthForLocalDate:(id)a0;
+ (char)isMiddleMonthOfSeasonForLocalDate:(id)a0;
+ (char)isSecondHalfOfSeasonForLocalDate:(id)a0;
...
+ (char)supportsSeasonsWithLocale:(id)a0;
