...
@property (nonatomic, getter=isBeingDisplayed) char beingDisplayed;
@property (retain, nonatomic) NSColor *backgroundColor;
@property (retain, nonatomic) NSColor *highlightedBackgroundColor;
@property (nonatomic) char shouldAppearSelected;
...
- (char)vui_highlighted;
- (char)vui_addSubview:(id)a0 oldView:(id)a1;
