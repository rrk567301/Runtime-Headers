...
@property (class, nonatomic) char alwaysGenerateAttributedString;
@property (class, nonatomic) char keepStatisticsOnLanguageComponents;
...
@property (nonatomic) char isEmpty;
...
- (id)initWithAttributedString:(id)a0 baseParagraphStyle:(id)a1 keepStatisticsOnLanguageComponents:(char)a2;
- (id)initWithLanguageAwareString:(id)a0 attributes:(id)a1 keepStatisticsOnLanguageComponents:(char)a2;
- (id)initWithString:(id)a0 attributes:(id)a1 baseParagraphStyle:(id)a2 keepStatisticsOnLanguageComponents:(char)a3;
- (id)initWithString:(id)a0 baseParagraphStyle:(id)a1 generateAttributedString:(char)a2 keepStatisticsOnLanguageComponents:(char)a3;
- (long long)writingDirectionOfLine:(long long)a0 maximumLinesShown:(long long)a1 withWidth:(double)a2 lineBreakMode:(unsigned long long)a3 cacheLayoutInfo:(char)a4;
- (long long)writingDirectionOfLine:(long long)a0 maximumLinesShown:(long long)a1 withWidth:(double)a2 lineBreakMode:(unsigned long long)a3 cacheLayoutInfo:(char)a4 lineNumberReported:(long long *)a5;
