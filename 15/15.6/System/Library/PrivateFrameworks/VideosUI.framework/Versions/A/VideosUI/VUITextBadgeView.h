...
@property (nonatomic) char backgroundImageForMaterialRenderingHasChanged;
...
@property (nonatomic) char isUppercased;
@property (nonatomic) int blendMode;
@property (retain, nonatomic) NSColor *tintColor;
@property (nonatomic) double layerCornerRadius;

+ (char)_viewBackgroundImageNeedsUpdatingWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 currentBackgroundImage:(id)a1;
...
- (char)_textBadgeBackgroundImageNeedsUpdating;
