@interface VUIBezierPath : NSBezierPath

@property (nonatomic) struct CGPath { } *vuiCGPath;

+ (id)vui_bezierPathWithArcCenter:(struct CGPoint { double x0; double x1; })a0 radius:(double)a1 startAngle:(double)a2 endAngle:(double)a3 clockwise:(char)a4;
