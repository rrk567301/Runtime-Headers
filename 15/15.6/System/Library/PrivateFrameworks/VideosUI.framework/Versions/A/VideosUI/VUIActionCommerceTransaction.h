...
+ (char)isTransactionInProgressForBuyParams:(id)a0;

- (void).cxx_destruct;
- (void)_handleBuyCompletionForOffer:(id)a0 appContext:(id)a1 shouldPlayWhenDone:(char)a2 serverResponse:(id)a3 completionHandler:(id /* block */)a4;
- (void)_handleSubscriptionCompletionForOffer:(id)a0 appContext:(id)a1 shouldInitiateFamilySetup:(char)a2 serverResponse:(id)a3 completionHandler:(id /* block */)a4;
