...
@property (nonatomic) char hasDisclaimerText;
...
- (void)setBackgroundImage:(id)a0 forHighlightedState:(char)a1;
- (void)setImageView:(id)a0 forHighlightedState:(char)a1;
