...
@property (nonatomic) char allowsManualRenewal;
...
@property (nonatomic) char isAdultContent;
...
@property (nonatomic) char markedAsDeleted;
...
@property (nonatomic) char shouldMarkAsDeletedAfterCancellationOrFailure;
...
@property (nonatomic) char prefer3DOrImmersiveDownload;
