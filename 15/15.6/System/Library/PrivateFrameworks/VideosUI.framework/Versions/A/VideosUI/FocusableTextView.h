...
@property (nonatomic) char needsTextSizeComputation;
...
@property (readonly, nonatomic, getter=isTextTruncating) char textTruncating;
@property (retain, nonatomic) NSColor *moreLabelTextColor;
@property (nonatomic) char canBeExpanded;
...
- (void)_configureAlignmentWithTextAlignment:(long long)a0 allowsTextAlignmentOverride:(char)a1;
...
- (void)setSuppressesServicesContextMenu:(char)a0;
