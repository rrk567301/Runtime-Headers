...
@property (nonatomic, getter=isVideoPlaybackPlaying) char videoPlaybackPlaying;
@property (readonly, nonatomic) double elapsedTime;
@property (readonly, nonatomic) double duration;
@property (nonatomic, getter=isMuted) char muted;
@property (nonatomic) float volume;
@property (nonatomic) char isPlaylistActive;
...
- (void)setClipsMode:(char)a0;
- (void)setSmartRoutingEligible:(char)a0;
