...
@property (nonatomic) char cachesPropertiesOnFirstAccess;
...
@property (readonly, nonatomic) char markedAsDeleted;
...
@property (nonatomic, getter=hasLocalChanges) char localChanges;
...
- (char)_didRequestPropertyWithKey:(id)a0;
- (id)_valueForPropertyDescriptor:(id)a0;
- (char)isFetchedPropertiesEqualToFetchedMediaEntity:(id)a0;
