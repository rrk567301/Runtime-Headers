...
- (char)controllerExistsForIdentifier:(id)a0;
- (void)focusOnSearchField;
- (char)hasRemoteBarItems;
- (void)numberOfChildControllersDidChangeFor:(id)a0 from:(long long)a1 to:(long long)a2 animated:(char)a3;
...
- (void)updateWithBarItems:(id)a0 setSelectedIdentifierFromDefaults:(char)a1 appContext:(id)a2;
