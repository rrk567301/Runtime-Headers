...
@property (nonatomic) char usesKeyIdentifierPenaltyBox;
@property (nonatomic) char sendsLocationWhenOptedIn;
@property (nonatomic) char sendsMescalHeader;
...
- (id)_bodyDictionaryForRequests:(id)a0 isStopRequest:(char)a1 locationAuthorizationStatus:(long long)a2;
...
- (void)_handleResponseDict:(id)a0 forKeyRequest:(id)a1 completion:(id /* block */)a2;
- (void)_handleResponseDicts:(id)a0 forKeyRequests:(id)a1 completion:(id /* block */)a2;
- (void)_handleResponseForKeyRequests:(id)a0 responseData:(id)a1 URLResponse:(id)a2 error:(id)a3 completion:(id /* block */)a4;
- (void)_initiateKeyRequests:(id)a0 completion:(id /* block */)a1;
- (id)_jsonDictionaryForRequest:(id)a0 isStopRequest:(char)a1 locationAuthorizationStatus:(long long)a2;
- (void)_loadCertificateDataWithCompletion:(id /* block */)a0;
- (void)_sendKeyRequestsToServer:(id)a0 isStopRequest:(char)a1 isSecureInvalidationRequest:(char)a2 completion:(id /* block */)a3;
