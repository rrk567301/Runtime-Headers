...
+ (id)sharedInstance;
+ (char)boolValueForKey:(id)a0 fromDictionary:(id)a1 defaultValue:(char)a2;
...
- (char)_populateConfigWithDictionary:(id)a0 isLaunching:(char)a1;
...
- (char)_updateFromCache;
- (void)_updateTVSettingsIfNeeded:(char)a0;
