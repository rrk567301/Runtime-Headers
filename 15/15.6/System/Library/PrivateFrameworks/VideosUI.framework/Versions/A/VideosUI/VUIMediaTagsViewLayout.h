...
@property (readonly, nonatomic) char useAlignmentRectInset;
@property (nonatomic) char centerAlign;
@property (readonly, nonatomic, getter=isWrappingAllowed) char wrappingAllowed;
@property (readonly, nonatomic) char adjustGenresToFit;
@property (nonatomic) char alignBadgeVertically;
...
@property (readonly, nonatomic, getter=isGroupActivityTagEnabled) char groupActivityTagEnabled;
