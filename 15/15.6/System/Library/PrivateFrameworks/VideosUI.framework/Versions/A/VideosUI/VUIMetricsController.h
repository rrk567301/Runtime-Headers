...
@interface VUIMetricsController : NSObject {
    ...
    char _isAppJustLaunched;
    char _isAppJustDeepLinkOpened;
    char _isGDPRConsented;
    char _shouldRecordEnter;
    char _shouldRecordExit;
    char _shouldRecordCachedAccount;
}
...
@property (nonatomic) char shouldPostAppLaunchData;
@property (nonatomic) char isInDebugMode;
...
@property (nonatomic) char shouldFlushMetrics;
@property (readonly, nonatomic) char perfEventPublishingEnabled;
...
- (void)_setGDPRConsentStatus:(char)a0;
- (void)_updateBaseFieldsWithData:(id)a0;
- (void)cacheUMImpression:(id)a0;
- (id)extractPageMetricsFromEventData:(id)a0;
- (void)forceGDPRConsentStatus:(char)a0;
- (id)getBasePerfData:(char)a0;
