@class NSString, NSArray, NSDictionary, NSDate, NSNumber, VUIUpsellOnExitPolicy;
...
@property (readonly, nonatomic) char isAdultContent;
...
@property (readonly, nonatomic) char isSharedWatchEnabled;
@property (readonly, nonatomic) NSString *channelName;
@property (readonly, nonatomic) char isFederated;
@property (readonly, nonatomic) char isEligibleForPlayerTabs;
@property (readonly, nonatomic) char isEligibleForInfoTab;
