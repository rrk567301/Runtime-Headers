...
@property (nonatomic) char hasSetTabBarIndex;
...
+ (char)shouldIgnoreLastSelectedTabIndex;
...
- (id)_tabBarChildViewControllerWithIdentifier:(id)a0 documentRef:(id)a1 isNonServerTab:(char)a2 title:(id)a3 isSelectedTab:(char)a4 appContext:(id)a5 iconResource:(id)a6 contextData:(id)a7 uiConfigDict:(id)a8;
...
- (void)setSelectedIndexForTabBarItemIdentifier:(id)a0 clearStack:(char)a1;
- (void)setVuiSelectedIndex:(unsigned long long)a0;
- (void)updateWithTabBarItems:(id)a0 setSelectedIdentifierFromDefaults:(char)a1 appContext:(id)a2;
