...
@property (nonatomic) char overridesStartTimeWithResumeTime;
...
@property (nonatomic, getter=isGradientDisabled) char gradientDisabled;
@property (retain, nonatomic) TVPPlaylist *playlist;
@property (retain, nonatomic) NSView *overlayView;
@property (readonly, nonatomic) char hasProgress;
@property (nonatomic) double primaryVideoAspectRatio;
@property (nonatomic) char showsSecondaryVideoView;
...
@property (nonatomic) char restrictionsAlreadyUnlocked;
@property (nonatomic) char shouldDelayLoadingImage;
@property (retain, nonatomic) VUIAppContext *appContext;
@property (nonatomic) char allowsPictureInPicture;
...
- (id)_sportingEventTimeSpanStringFromMediaItem:(id)a0;
- (id)_sportingEventTimeSpanStringFromStartTime:(id)a0 endTime:(id)a1;
