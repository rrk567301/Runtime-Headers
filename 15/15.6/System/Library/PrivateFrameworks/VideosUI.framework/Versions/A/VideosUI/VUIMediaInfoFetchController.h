...
- (id)_prewarmIndices;
- (char)mediaInfoContainsPlayerAtIndex:(unsigned long long)a0;
- (id)_createPlayerWithPlaylist:(id)a0 isForPrewarming:(char)a1;
- (id)_identifierForPlaylist:(id)a0 isForPrewarming:(char)a1;
...
- (char)mediaInfoContainsImageAtIndex:(unsigned long long)a0;
