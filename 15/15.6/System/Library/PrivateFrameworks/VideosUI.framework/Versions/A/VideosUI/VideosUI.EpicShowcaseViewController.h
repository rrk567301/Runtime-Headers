@interface VideosUI.EpicShowcaseViewController : VUIBaseViewController {
    ...
    void /* unknown type, empty encoding */ didHostedInStackView;
    void /* unknown type, empty encoding */ selfVisibilityMonitor;
    void /* unknown type, empty encoding */ didCreateCellVisibilityMonitor;
