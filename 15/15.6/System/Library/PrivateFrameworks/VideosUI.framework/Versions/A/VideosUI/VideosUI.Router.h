...
- (char)dismissViewControllerWithID:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
...
- (void)presentAlertWithTitle:(id)a0 message:(id)a1 actions:(id)a2 animated:(char)a3;
