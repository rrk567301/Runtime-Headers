...
+ (id)_metricsDataFromTVPMediaItem:(id)a0 contentPosition:(id)a1 isBackground:(char)a2 isAmbient:(char)a3 actionType:(id)a4;
...
+ (void)recordBGVideoPlayOfTVPMediaItem:(id)a0 contentPosition:(id)a1 isAmbient:(char)a2 actionType:(id)a3;
+ (void)recordBGVideoPlayOfTVPMediaItem:(id)a0 isAmbient:(char)a1;
...
+ (void)recordPlay:(id)a0 isLaunchingExtras:(char)a1;
