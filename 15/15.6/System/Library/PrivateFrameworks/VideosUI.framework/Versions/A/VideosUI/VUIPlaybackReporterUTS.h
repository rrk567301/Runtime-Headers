...
- (char)_isTransitionValidForPlayer:(id)a0 fromState:(id)a1 toState:(id)a2;
- (void)_reportForPlayer:(id)a0 playerState:(id)a1 completionState:(unsigned long long)a2 completionBlock:(id /* block */)a3;
- (void)_reportLinearOrEBSForPlayer:(id)a0 isLinear:(char)a1 playerState:(id)a2 completionState:(unsigned long long)a3 completionBlock:(id /* block */)a4;
...
- (char)enforceSinglePlaybackSession;
