...
@property (nonatomic) char isDescriptionPreferredOnPhoneSizeClass;
...
- (struct CGSize { double x0; double x1; })_layoutSubviewsWithSize:(struct CGSize { double x0; double x1; })a0 computationOnly:(char)a1;
