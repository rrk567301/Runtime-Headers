...
+ (char)filenameExtension:(id)a0 conformsToOneOfTypes:(id)a1;
+ (id)resourceModelTypeForFilenameExtension:(id)a0;
+ (char)type:(id)a0 conformsToOneOfTypes:(id)a1;
+ (id)typeForFilenameExtensionOrLastPathComponent:(id)a0;
+ (id)typeForURL:(id)a0 error:(id *)a1;
+ (char)url:(id)a0 conformsToOneOfTypes:(id)a1;
+ (char)url:(id)a0 conformsToType:(id)a1;
