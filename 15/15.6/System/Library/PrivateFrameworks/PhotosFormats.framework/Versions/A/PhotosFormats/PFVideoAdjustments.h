...
+ (char)isRecognizedSlowMotionFormatWithIdentifier:(id)a0 version:(id)a1;
...
+ (struct { long long x0; int x1; unsigned int x2; long long x3; })minFrameDurationForNominalFrameRate:(float)a0;
...
- (char)_parseAppleVideoDataBlobDictionary:(id)a0 forSlowMotionTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } *)a1 rate:(float *)a2;
...
- (char)_isValidSlowMotionTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 rate:(float)a1;
- (char)_parseLegacySLMDictionary:(id)a0 forSlowMotionTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } *)a1 rate:(float *)a2;
- (char)_parseVersionedDataForSlowMotionTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } *)a0 rate:(float *)a1;
- (void)_updateDerivedPropertiesFromVersionedData;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })convertToOriginalTimeFromScaledTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 forExport:(char)a1;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })convertToScaledTimeFromOriginalTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 forExport:(char)a1;
