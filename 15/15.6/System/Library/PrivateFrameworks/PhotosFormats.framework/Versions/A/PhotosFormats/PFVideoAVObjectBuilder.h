...
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })slowMotionRampInRangeForExport:(char)a0;
- (id)_getOrCreateTimeRangeMapperForExport:(char)a0;
...
- (void)requestAVAssetForExport:(char)a0 withResultHandler:(id /* block */)a1;
- (void)requestAsynchronousAVAssetWithResultHandler:(id /* block */)a0;
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })slowMotionRampOutRangeForExport:(char)a0;
