...
@property (readonly) char isHighDynamicRange;
@property (readonly) char isHDR10;
@property (readonly) char isProResLOG;
@property (readonly) char hasDolby8_4Metadata;
@property (readonly) char isSpatial;
@property (readonly) char hasHEVCProfileTierLevelInfo;
...
+ (char)videoTrackFormatDescriptionHasDolby8_4Metadata:(struct opaqueCMFormatDescription { } *)a0;
