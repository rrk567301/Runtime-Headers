...
@property (readonly, nonatomic, getter=isProxyOnly) char proxyOnly;
...
+ (char)saveImage:(struct CGImage { } *)a0 toURL:(id)a1 error:(id *)a2;

- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (id)contentsDictionary;
- (char)loadContentsFromDictionary:(id)a0 proxyPath:(id *)a1 imagePath:(id *)a2 adjustmentPath:(id *)a3 error:(id *)a4;
- (char)loadFromArchiveURL:(id)a0 error:(id *)a1;
- (char)saveToArchiveURL:(id)a0 error:(id *)a1;
