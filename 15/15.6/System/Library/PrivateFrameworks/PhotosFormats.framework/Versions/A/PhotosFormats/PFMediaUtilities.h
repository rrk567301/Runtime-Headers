...
+ (char)canGenerateImageDerivativesFromType:(id)a0;
...
+ (char)embeddedJPEGSuitableForDerivativesInRawImageSource:(struct CGImageSource { } *)a0 enforcePixelCountLimits:(char)a1 timeZoneLookup:(id)a2;
...
+ (char)isValidAVFileForURL:(id)a0;
+ (char)isValidImageFileForURL:(id)a0;
...
+ (char)typeRequiresRasterizationDPI:(id)a0;
...
+ (char)audioChannelLayoutIsCinematicVideoRender:(const struct AudioChannelLayout { unsigned int x0; unsigned int x1; unsigned int x2; struct AudioChannelDescription { unsigned int x0; unsigned int x1; float x2[3]; } x3[1]; } *)a0;
...
+ (char)canLoadAssetAsRawForInteractiveEditingWithImageProperties:(id)a0;
...
+ (char)embeddedJPEGSuitableForDerivativesInImageOfType:(id)a0 url:(id)a1 imageProperties:(id)a2;
...
+ (char)insertTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 ofAsset:(id)a1 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 intoMutableComposition:(id)a3 error:(id *)a4;
