...
- (char)unarchiveDirectoryAtURL:(id)a0 error:(id *)a1;
- (id)_getKeyData;
- (char)archiveFileAtURL:(id)a0 outputFileURL:(id)a1 error:(id *)a2;
- (id)configurationForProfile:(id)a0;
- (char)createKeychainEntryReturningKeyData:(id *)a0 keyInfo:(id *)a1;
- (char)findExistingKeychainEntryReturningKeyData:(id *)a0 keyInfo:(id *)a1;
- (char)unarchiveFileAtURL:(id)a0 outputFileURL:(id)a1 error:(id *)a2;
