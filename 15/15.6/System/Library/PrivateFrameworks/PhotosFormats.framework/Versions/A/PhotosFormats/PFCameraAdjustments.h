...
@property (readonly, nonatomic, getter=isDepthEnabled) char depthEnabled;
@property (readonly, nonatomic) char isEligibleForCinematicAudioEffectProcessing;
...
@property (readonly, nonatomic) char hasCrop;
@property (readonly, nonatomic, getter=isSloMoEnabled) char sloMoEnabled;
...
- (char)canBeRenderedByCapturePipelineWithVideoComplement:(char)a0 deferredIdentifier:(id)a1;
