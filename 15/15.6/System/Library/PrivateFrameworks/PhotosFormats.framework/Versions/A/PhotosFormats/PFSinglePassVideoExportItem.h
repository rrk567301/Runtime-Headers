...
@property char shouldDeleteDestinationURLOnDeallocation;
...
@property char needsCurrentEncodingBitRateUpdate;
@property char maximizePowerEfficiency;
...
- (void)configureOutputMetadataForAssetWriter:(id)a0;
- (long long)estimatedOutputBitRate;
- (double)inputAssetDuration;
- (char)isAPACAudioTrack:(id)a0;
- (void)notifyDataAvailableToHandler:(id /* block */)a0 ignoreMinimumChunkLength:(char)a1;
...
- (char)setupConversionWithError:(id *)a0;
- (void)setupOutputFileSourceWithOutputAvailableHandler:(id /* block */)a0;
- (char)startConversionWithError:(id *)a0 outputAvailableHandler:(id /* block */)a1;
