...
@property (nonatomic) char shouldDither;
...
+ (struct opaqueCMSampleBuffer { } *)_copyNextSampleBuffer:(id)a0 reader:(id)a1 time:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a2 didReachEnd:(char *)a3 error:(id *)a4;
...
+ (char)_exportGIFToURL:(id)a0 request:(id)a1 progress:(id /* block */)a2 error:(id *)a3;
