...
@property (readonly) char channelLayoutUsesHigherOrderAmbisonics;
@property (readonly) char channelLayoutUsesChannelDescriptions;
@property (readonly) long long channelCount;

+ (id)infoForFirstAudioTrackOfAsset:(id)a0 matchingCodecPredicate:(id /* block */)a1;

- (void).cxx_destruct;
- (char)channelLayoutUsesHOA;
- (char)getHOAChannelCount:(long long *)a0 BEDChannelCount:(long long *)a1;
