...
+ (char)_enumerateV3MetadataInAsset:(id)a0 withBlock:(id /* block */)a1 error:(out id *)a2;
...
- (char)_getSourceFilePath:(id)a0 destinationFilePath:(id)a1 areOnSameVolume:(char *)a2 volumeSupportsCloning:(char *)a3;
- (void)_readMetadataIfNeeded;
- (char)copyOrLinkPath:(id)a0 toPath:(id)a1 error:(id *)a2;
