...
- (char)_isArray:(id)a0 equalToArray:(id)a1 usingObjectEquality:(id /* block */)a2;
- (char)_isDictionary:(id)a0 equalToDictionary:(id)a1 usingObjectEquality:(id /* block */)a2;
