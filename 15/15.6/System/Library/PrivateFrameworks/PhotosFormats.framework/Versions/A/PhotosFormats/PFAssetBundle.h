...
@property (readonly, nonatomic) char didReadOriginalPairedVideoMetadata;
...
@property (nonatomic) char spatialOvercaptureResourcesPurgeable;

+ (char)fileName:(id)a0 matchesRegex:(id)a1;
+ (id)insertAuxiliaryResourceTypeMarker:(id)a0 intoFileName:(id)a1;
+ (char)isValidDCFFileName:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (id)initWithPropertyList:(id)a0;
- (char)writeToBundleAtURL:(id)a0 error:(id *)a1;
- (char)isMediaSubtype:(unsigned long long)a0;
- (id)initWithAssetBundleAtURL:(id)a0;
- (id)initWithOriginalPhotoURL:(id)a0 alternatePhotoURL:(id)a1 fullSizePhotoURL:(id)a2 adjustmentBaseFullSizePhotoURL:(id)a3 spatialOvercapturePhotoURL:(id)a4 originalPairedVideoURL:(id)a5 fullSizePairedVideoURL:(id)a6 adjustmentBaseFullSizePairedVideoURL:(id)a7 spatialOvercapturePairedVideoURL:(id)a8 fullSizeVideoURL:(id)a9 adjustmentsURL:(id)a10 originalAdjustmentsURL:(id)a11 adjustmentsSecondaryDataURL:(id)a12 mediaSubtypes:(unsigned long long)a13 playbackStyle:(long long)a14 playbackVariation:(unsigned long long)a15 videoComplementVisibilityState:(unsigned short)a16;
- (id)initWithOriginalVideoURL:(id)a0 fullSizeRenderedVideoURL:(id)a1 adjustmentBaseVideoURL:(id)a2 spatialOvercaptureVideoURL:(id)a3 adjustmentsURL:(id)a4 originalAdjustmentsURL:(id)a5 mediaSubtypes:(unsigned long long)a6 playbackStyle:(long long)a7 playbackVariation:(unsigned long long)a8;
- (void)setLibraryCreationDate:(id)a0 inTimeZone:(id)a1;
- (id)URLForAuxiliaryResourceWithKey:(id)a0;
- (char)_pathExtension:(id)a0 matchesType:(id)a1 error:(id *)a2;
- (void)_readLivePhotoVideoMetadataIfNeeded;
- (char)_verifyFileSourceExistsAtURL:(id)a0 error:(id *)a1;
- (char)_writeFileAtURL:(id)a0 toDirectory:(id)a1 withUpdatedFilename:(id)a2 updateManifest:(id)a3 bundlePathKey:(id)a4 verifyUTIType:(struct __CFString { } *)a5 error:(id *)a6;
- (char)_writeFileAtURL:(id)a0 toDirectory:(id)a1 withUpdatedFilename:(id)a2 writtenFileURL:(id *)a3 error:(id *)a4;
- (char)_writeFileAtURL:(id)a0 toDirectory:(id)a1 writtenFileURL:(id *)a2 error:(id *)a3;
- (void)addAuxiliaryResourceAtURL:(id)a0 resourceKey:(id)a1;
...
- (char)linkOrCopyURL:(id)a0 toURL:(id)a1 forceCopy:(char)a2 error:(id *)a3;
- (id)urlsByPathKey;
- (char)writeAllResourceURLsToDirectoryAtURL:(id)a0 updatingManifest:(id)a1 error:(id *)a2;
