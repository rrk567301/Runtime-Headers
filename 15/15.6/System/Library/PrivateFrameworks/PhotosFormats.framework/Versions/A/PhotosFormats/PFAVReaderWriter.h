...
- (void)readingAndWritingDidFinishSuccessfully:(char)a0 withError:(id)a1;
...
- (char)setUpReaderAndWriterReturningError:(id *)a0;
- (char)startReadingAndWritingReturningError:(id *)a0;
