...
- (id)initWithRouteString:(id)a0 speed:(unsigned char)a1 hubDeviceHandle:(id)a2 parentHighSpeedHubDeviceHandle:(id)a3 parentHighSpeedHubPort:(id)a4 mtt:(char)a5 laneSpeedExponent:(id)a6;
