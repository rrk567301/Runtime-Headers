...
- (char)hostTransferManagerTransferRequestAvailable:(id)a0;
...
- (char)startTransferRequestWithSetupPacket:(id)a0 data:(id)a1 completion:(id /* block */)a2;
- (char)transferRequestAvailable;
