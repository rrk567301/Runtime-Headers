...
- (char)requestIDInvalid:(unsigned char)a0;
- (void)resetSequenceNumberToZero;
- (void)sendTransferResponseForRequestID:(unsigned char)a0 sequenceNumber:(unsigned int)a1 endOfTransfer:(char)a2 ackRequest:(char)a3 remainingSize:(unsigned int)a4 statusCode:(unsigned char)a5 payloadData:(id)a6;
- (char)sequenceNumberInvalid:(unsigned int)a0;
