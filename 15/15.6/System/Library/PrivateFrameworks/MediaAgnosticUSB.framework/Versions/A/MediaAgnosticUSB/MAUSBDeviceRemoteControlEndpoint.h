...
- (void)initTransfer;
- (id)initWithDelegate:(id)a0 handle:(id)a1 deviceAddress:(unsigned char)a2 ssid:(unsigned char)a3 protocolConfig:(id)a4 elasticBuffer:(char)a5 receiveBufferSize:(unsigned long long)a6 queue:(id)a7;
