...
- (id)initWithHandle:(id)a0 deviceAddress:(unsigned char)a1 ssid:(unsigned char)a2 statusCode:(unsigned char)a3 endpointStatus:(unsigned char)a4 acknowledgementRequest:(char)a5 negativeCredit:(char)a6 endOfTransfer:(char)a7 transferType:(unsigned char)a8 streamID:(unsigned short)a9 sequenceNumber:(unsigned int)a10 requestID:(unsigned char)a11 remainingSizeCredit:(unsigned int)a12 payloadData:(id)a13;
