...
- (id)initWithDeviceAddress:(unsigned char)a0 ssid:(unsigned char)a1 dialogToken:(unsigned short)a2 routeString:(id)a3 speed:(unsigned char)a4 hub:(unsigned short)a5 parentHSHub:(unsigned short)a6 parentHSHubPort:(unsigned char)a7 mtt:(char)a8 laneSpeedExponent:(unsigned char)a9;
