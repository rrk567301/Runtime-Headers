...
- (char)createEndpointForDescriptor:(id)a0;
- (char)createEndpointsForMAUSBDescriptors:(id)a0 handleRequest:(id)a1;
- (char)createEndpointsForMAUSBDescriptors:(id)a0 standardDescriptors:(id)a1;
...
- (char)hostRemoteEndpointTransferRequestAvailable:(id)a0;
...
- (char)readDataLength:(unsigned int)a0 endpointAddress:(unsigned char)a1 completion:(id /* block */)a2;
...
- (char)writeData:(id)a0 endpointAddress:(unsigned char)a1 completion:(id /* block */)a2;
