...
- (char)clearTransfersForDevice:(unsigned short)a0 endpointAddress:(unsigned char)a1;
...
- (char)insertDevice:(id)a0 portNumber:(unsigned char)a1 highSpeed:(char)a2;
- (char)insertHubForLocationID:(unsigned int)a0 portNumber:(unsigned char)a1;
...
- (char)removeDeviceFromPortNumber:(unsigned char)a0;
