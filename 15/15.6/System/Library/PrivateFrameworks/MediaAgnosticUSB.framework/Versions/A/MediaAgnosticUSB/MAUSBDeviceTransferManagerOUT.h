...
@interface MAUSBDeviceTransferManagerOUT : MAUSBObject {
    ...
    char _changeReceiveBufferSizePacketWaitingForAcknowledgement;
}

@property char deviceNotResponding;
...
- (id)initWithDelegate:(id)a0 handle:(id)a1 deviceAddress:(unsigned char)a2 ssid:(unsigned char)a3 transferType:(unsigned char)a4 protocolConfig:(id)a5 elasticBuffer:(char)a6 queue:(id)a7 receiveBufferSize:(unsigned long long)a8;
- (id)initWithDelegate:(id)a0 handle:(id)a1 deviceAddress:(unsigned char)a2 ssid:(unsigned char)a3 transferType:(unsigned char)a4 protocolConfig:(id)a5 elasticBuffer:(char)a6 queue:(id)a7 receiveBufferSize:(unsigned long long)a8 requestID:(unsigned char)a9;
- (void)inputTransferRequest:(id)a0;
- (void)sendTransferResponseForRequestID:(unsigned char)a0 sequenceNumber:(unsigned int)a1 endOfTransfer:(char)a2 credit:(unsigned int)a3 statusCode:(unsigned char)a4;
