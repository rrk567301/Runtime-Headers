...
- (id)initWithDelegate:(id)a0 handle:(id)a1 deviceAddress:(unsigned char)a2 ssid:(unsigned char)a3 transferType:(unsigned char)a4 protocolConfig:(id)a5 elasticBuffer:(char)a6 receiveBufferSize:(unsigned long long)a7 queue:(id)a8;
- (void)inputTransferRequest:(id)a0;
- (void)setDeviceNotResponding:(char)a0;
