@class NSString, NSArray, GKVoiceChatServiceFocus, GKRWLock, NSMutableDictionary, VoiceChatSessionRoster, GKInterfaceListener, NSMutableArray, NSObject;
@protocol GKVoiceChatSessionDelegate, GKVoiceChatReliableChannel, GKVoiceChatPeerInfoProvider, OS_dispatch_queue;
...
- (void)interfaceStateDidChangeWithWifiUp:(char)a0 cellUp:(char)a1;
...
- (id)initWithGameStateSession:(id)a0 publicWrapper:(id)a1 sessionName:(id)a2;
