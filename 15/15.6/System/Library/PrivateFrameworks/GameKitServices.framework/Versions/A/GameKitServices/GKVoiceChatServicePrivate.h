...
- (char)getNSError:(id *)a0 code:(long long)a1 description:(id)a2 hResult:(int)a3;
- (char)getNSError:(id *)a0 code:(long long)a1 description:(id)a2 reason:(id)a3;
...
- (char)inviteIsValid:(id)a0;
- (id)localDisplayNameForCallID:(unsigned int)a0;
- (id)remoteDisplayNameForCallID:(unsigned int)a0;
- (int)startICEConnectionCheck:(id)a0 isCaller:(char)a1;
- (int)startICEConnectionCheck:(id)a0 isCaller:(char)a1 withCallID:(unsigned int)a2;
