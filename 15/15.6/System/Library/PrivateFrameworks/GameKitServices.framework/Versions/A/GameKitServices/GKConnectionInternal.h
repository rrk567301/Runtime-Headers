...
- (void)internalInitiateRelayWithParticipant:(id)a0 withConnectionData:(id)a1 withRelayInfo:(id)a2 didInitiate:(char)a3;
- (void)internalUpdateRelayWithParticipant:(id)a0 withConnectionData:(id)a1 withRelayInfo:(id)a2 didInitiate:(char)a3;
- (void)internal_setRemoteConnectionData:(id)a0 fromParticipantID:(id)a1 pendingConnectionPIDList:(id)a2;
- (char)localGamingCheckEstablishConnection:(id)a0 connectionData:(id)a1;
...
- (id)newRelayUpdateDictionaryForParticipant:(id)a0 didInitiate:(char)a1;
- (void)preRelease;
- (void)setParticipantID:(id)a0 forPeerID:(id)a1;
- (char)shouldWeInitiateRelayWithPID:(unsigned int)a0;
