...
- (char)_hasChangeForDayOccurrenceKey:(id)a0 dayOccurrence:(id)a1;
- (char)_hasChangeToScheduleEnabled;
- (void)_modifyDayOccurrencesForWeekdays:(unsigned long long)a0 block:(id /* block */)a1;
- (char)_shouldRemoveOverrideOccurrence:(id)a0;
...
- (char)hasChangeAffectingScheduling;
- (char)hasChangeToSleepDurationGoal;
- (char)hasChangeToWindDownTime;
- (char)hasOverrideOccurrenceRemoval;
