@class HKSPThrottler, HKSPObserverSet, HKSPAnalyticsManager, HKSPSleepWidgetManager, HKSPXPCClientIdentifier, HKHealthStore, HKSPSyncAnchorContainer, HKSleepHealthStore, NSString, HKSPXPCConnectionProvider, HKSPSleepFocusConfiguration, HKSPSleepStoreExportedObject, HKSPSleepStoreModelCache;
...
- (id)_getSleepScheduleStateOnDoSync:(char)a0;
- (char)_reloadsWidgets;
...
- (char)_connectAutomatically;
- (id)_dismissGoodMorningOnServer;
- (id)_dismissSleepLockOnServer;
- (id)_getSleepEventRecordDoSync:(char)a0;
- (id)_getSleepEventRecordFromServerDoSync:(char)a0;
- (id)_getSleepModeDoSync:(char)a0;
- (id)_getSleepModeFromServerDoSync:(char)a0;
- (id)_getSleepScheduleDoSync:(char)a0;
- (id)_getSleepScheduleFromServerDoSync:(char)a0;
- (id)_getSleepScheduleModelDoSync:(char)a0;
- (id)_getSleepScheduleModelFromServerDoSync:(char)a0;
- (id)_getSleepScheduleStateFromServerDoSync:(char)a0;
- (id)_getSleepSettingsDoSync:(char)a0;
- (id)_getSleepSettingsFromServerDoSync:(char)a0;
- (id)_getSleepWidgetStateDoSync:(char)a0;
- (id)_getSleepWidgetStateFromServerDoSync:(char)a0;
- (void)_notifyObserversForChangedSleepEventRecord:(id)a0;
- (void)_notifyObserversForChangedSleepMode:(long long)a0 reason:(unsigned long long)a1;
- (void)_notifyObserversForChangedSleepSchedule:(id)a0;
- (void)_notifyObserversForChangedSleepScheduleState:(unsigned long long)a0 reason:(unsigned long long)a1;
- (void)_notifyObserversForChangedSleepSettings:(id)a0;
- (void)_notifyObserversForSleepEvent:(id)a0;
- (char)_observeSleepFocusMode;
...
- (char)_resultHasSchedule:(id)a0;
- (char)_resultScheduleIsValid:(id)a0;
- (char)_resultScheduleMeetsDefaultGoal:(id)a0;
...
- (void)configureSleepFocusWithState:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)confirmAwakeWithCompletion:(id /* block */)a0;
- (void)connectSynchronously:(char)a0;
- (void)createSleepFocusInState:(unsigned long long)a0 completion:(id /* block */)a1;
...
- (id)initWithConnectionProviderProvider:(id /* block */)a0 identifier:(id)a1 healthStore:(id)a2 options:(unsigned long long)a3 analyticsManager:(id)a4 throttlerProvider:(id /* block */)a5 callbackScheduler:(id)a6 sleepFocusModeBridgeProvider:(id /* block */)a7 widgetTimelineControllersProvider:(id /* block */)a8 widgetRelevanceControllerProvider:(id /* block */)a9 currentDateProvider:(id /* block */)a10;
...
- (void)setSleepModeOn:(char)a0 completion:(id /* block */)a1;
- (void)setSleepModeOn:(char)a0 reason:(unsigned long long)a1 completion:(id /* block */)a2;
- (void)setSleepTrackingOnboardingCompletedVersion:(long long)a0 completion:(id /* block */)a1;
- (void)setUpcomingWakeUpAlarmEnabled:(char)a0 date:(id)a1 completion:(id /* block */)a2;
- (void)setWakeUpAlarmEnabled:(char)a0 resolvedOccurrence:(id)a1 date:(id)a2 completion:(id /* block */)a3;
- (void)setWidgetOverrideState:(long long)a0 completion:(id /* block */)a1;
- (char)shouldInvalidateRelevanceForWidgetOfKind:(id)a0;
- (char)shouldReloadWidgetOfKind:(id)a0;
...
- (char)sleepModeOnWithError:(id *)a0;
...
- (void)trackSleepDataInteractionEventWithType:(unsigned long long)a0 isOnboardedVitals:(char)a1 completion:(id /* block */)a2;
