...
@property (nonatomic) char orientationChanged;
...
@property (nonatomic) char suggestionCategorySupportsBatchDismissal;
...
@property (nonatomic) char prominentActionButton;
