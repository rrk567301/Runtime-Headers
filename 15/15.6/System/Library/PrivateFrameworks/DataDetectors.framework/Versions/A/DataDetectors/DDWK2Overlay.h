...
- (id)hitView;
- (void)_addMultiViewForObject:(id)a0 withArrow:(char)a1 availableViews:(id)a2;
- (void)_mouseEnteredBasicHLView:(id)a0 withRelatedObjects:(id)a1;
- (void)_mouseExitedBasicHLView:(id)a0 withInfos:(id)a1;
- (void)_setTrackingAreaForBasicHighlight:(id)a0 entering:(char)a1 ignoreCleanup:(char)a2;
- (char)accessibilityDataDetectorExistsAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (id)accessibilityDataDetectorTypeAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)accessibilityShowDataDetectorMenuAtPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (void)addTrackingArea:(id)a0 alreadyInside:(char)a1;
...
- (void)handleMouseClick:(char)a0 onTriangle:(char)a1 onView:(id)a2;
- (void)hideHighlights;
...
- (void)setAllState:(int)a0 disableAnimations:(char)a1;
- (void)setHighlightedObjects:(id)a0;
- (void)setNeedsRelayout;
- (void)setState:(int)a0 forHighlightView:(id)a1 disableAnimation:(char)a2;
