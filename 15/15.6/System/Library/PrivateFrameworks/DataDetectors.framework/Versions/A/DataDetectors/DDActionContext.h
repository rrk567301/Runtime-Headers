...
@property char immediate;
@property char isRightClick;
...
@property char altMode;
@property char skipAnimation;
@property char holdContent;
...
- (id)contextForView:(id)a0 altMode:(char)a1 interactionStartedHandler:(id /* block */)a2 interactionChangedHandler:(id /* block */)a3 interactionStoppedHandler:(id /* block */)a4;
