...
@property (readonly, nonatomic, getter=isPopoverVisible) char popoverVisible;
...
- (void)setPopoverContentSize:(struct CGSize { double x0; double x1; })a0 animated:(char)a1;
- (void)_updateContentSize;
- (void)dismissPopoverAnimated:(char)a0;
- (id)initWithContentViewController:(id)a0;
- (void)presentPopoverFromBarButtonItem:(id)a0 permittedArrowDirections:(unsigned long long)a1 animated:(char)a2;
