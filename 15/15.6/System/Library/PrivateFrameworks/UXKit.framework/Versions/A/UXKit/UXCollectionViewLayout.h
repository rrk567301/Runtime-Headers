...
- (char)_isValidSection:(long long)a0 item:(long long)a1;
- (char)_selectableItemAtIndexPath:(id)a0;
...
- (char)shouldInvalidateLayoutForScaleFactorChangeFrom:(double)a0 to:(double)a1;
