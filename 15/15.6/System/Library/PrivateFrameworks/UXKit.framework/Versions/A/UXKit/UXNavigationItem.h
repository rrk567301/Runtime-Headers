...
@property (nonatomic) char hidesAlternateTitleView;
@property (nonatomic) char hidesGlobalTrailingView;
...
- (void)setLeftBarButtonItems:(id)a0 animated:(char)a1;
- (void)setRightBarButtonItem:(id)a0 animated:(char)a1;
- (void)setLeftBarButtonItem:(id)a0 animated:(char)a1;
- (void)setRightBarButtonItems:(id)a0 animated:(char)a1;
- (void)_updateInternalTitleView;
- (void)setLeadingBarButtonItems:(id)a0 animated:(char)a1;
- (void)setTrailingBarButtonItems:(id)a0 animated:(char)a1;
