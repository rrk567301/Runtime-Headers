...
@property (nonatomic, setter=_setFloatingHeadersDisabled:) char _floatingHeadersDisabled;
...
- (void)deselectRowAtIndexPath:(id)a0 animated:(char)a1;
...
- (void)scrollToRowAtIndexPath:(id)a0 atScrollPosition:(long long)a1 animated:(char)a2;
- (void)selectRowAtIndexPath:(id)a0 animated:(char)a1 scrollPosition:(long long)a2;
...
- (void)setOverdrawEnabled:(char)a0;
