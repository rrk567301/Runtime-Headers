...
@property (nonatomic) char isInteractiveTransitioning;
@property (nonatomic) char trailingViewNeedsRemoval;
...
- (void)_finishInteractiveTransition:(char)a0 duration:(double)a1 completion:(id /* block */)a2;
