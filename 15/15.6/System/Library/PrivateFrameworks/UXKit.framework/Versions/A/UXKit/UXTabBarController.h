...
@property (nonatomic) char segmentTransitionInProgress;
@property (nonatomic) char viewControllerTransitionInProgress;
...
- (void)setTransientViewController:(id)a0 animated:(char)a1;
...
- (void)_setObservedNavigationItem:(id)a0 updateBarButtonItems:(char)a1;
- (void)_transitionToTargetViewControllerWithCompletion:(id /* block */)a0;
- (void)_transitionToViewController:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
...
- (void)populateShortcutMenuItemsStartingAtIndex:(unsigned long long)a0 ofMenu:(id)a1 useSeparators:(char)a2;
...
- (void)setSelectedIndex:(unsigned long long)a0 allowsCurrentTabReselectionCallback:(char)a1;
