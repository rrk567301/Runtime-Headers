...
@property (nonatomic) char accessibilityChildrenHidden;
...
@property (nonatomic, getter=isExclusiveTouch) char exclusiveTouch;
...
@property (nonatomic) char needsContentBackgroundVisualEffect;
