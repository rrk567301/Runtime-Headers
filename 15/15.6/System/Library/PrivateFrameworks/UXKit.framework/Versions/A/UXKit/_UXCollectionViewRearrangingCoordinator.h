...
@property (readonly, nonatomic) char isRearranging;
@property (nonatomic) char enabled;
@property (nonatomic) long long initiationMode;
@property (nonatomic) char allowDragOutsideCells;
@property (nonatomic) char continuouslyUpdateInsideCells;
@property (nonatomic) char usePileForSingleItem;
@property (nonatomic) char allowAutoscroll;
...
- (void)reloadLayout;
- (char)_allowAutoscrollForDraggingInfo:(id)a0;
...
- (void)_finishRearrangingForLocation:(struct CGPoint { double x0; double x1; })a0 shouldComplete:(char)a1;
- (void)_gestureRecognized:(id)a0;
- (id)_imageForItemAtIndexPath:(id)a0;
- (char)_isEquivalentSourceOfDraggingInfo:(id)a0;
- (char)_isSourceOfDraggingInfo:(id)a0;
- (void)_moveItemsAtIndexPaths:(id)a0 toIndexPaths:(id)a1;
- (void)_reloadCollectionViewWithAnimation;
- (char)_shouldHandleExternalDrop:(id)a0;
