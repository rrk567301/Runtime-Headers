...
@property (nonatomic) char recalculatingWindowKeyViewLoop;
@property (retain, nonatomic) NSView *alternateTitleView;
@property (retain, nonatomic) NSView *alternateCondensedTitleView;
@property (nonatomic) char alternateTitleEnabled;
@property (nonatomic, getter=isDetached) char detached;
...
@property (nonatomic, getter=isTranslucent) char translucent;
...
- (void)_completeInteractiveTransition:(char)a0 duration:(double)a1;
- (id)_popNavigationItem;
- (id)_popNavigationItemAnimated:(char)a0 duration:(double)a1;
- (void)_prepareForNavigationItemTransition;
- (void)_pushItem:(id)a0;
- (void)_pushNavigationItem:(id)a0 animated:(char)a1 duration:(double)a2;
