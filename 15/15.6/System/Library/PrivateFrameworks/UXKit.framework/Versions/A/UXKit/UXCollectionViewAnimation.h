...
- (id)initWithView:(id)a0 viewType:(unsigned long long)a1 finalLayoutAttributes:(id)a2 startFraction:(double)a3 endFraction:(double)a4 animateFromCurrentPosition:(char)a5 deleteAfterAnimation:(char)a6 customAnimations:(id /* block */)a7;
