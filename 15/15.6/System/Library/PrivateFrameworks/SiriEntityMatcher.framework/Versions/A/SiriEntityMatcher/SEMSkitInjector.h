...
- (char)_analyzeCascadeEntity:(id)a0 outSearchGroup:(unsigned short *)a1 indexTokens:(void *)a2 builder:(void *)a3 error:(id *)a4;
- (char)_buildDocumentsFromEntities:(id)a0 error:(id *)a1;
