...
@interface SEMSpanMatchResultInterpreter : NSObject {
    char _useSensitiveLogging;
    char _useMediaThresholdFiltering;
}
...
- (char)_checkEligibilityOfSpanMatch:(id)a0 allowPartialMatch:(char)a1 allowApproxMatch:(char)a2 allowAliasMatch:(char)a3 query:(id)a4;
