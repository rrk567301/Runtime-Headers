...
+ (char)deleteExistingSATModelForLanguageCode:(id)a0;
...
+ (id)getSpeakerModelPathForType:(unsigned long long)a0 withLanguageCode:(id)a1 withConfigPath:(id)a2 createDirectory:(char)a3;
