...
+ (id)csvReader:(id)a0 header:(char)a1;
...
- (id)fixStrings:(id)a0;
- (id)initWithFileName:(id)a0 header:(char)a1;
- (long long)intAtRow:(id)a0 col:(id)a1 defaultValue:(long long)a2;
- (id)parseFile:(id)a0 header:(char)a1;
- (void)sortOnColumn:(id)a0 ascending:(char)a1;
- (void)sortOnColumnIndex:(long long)a0 ascending:(char)a1;
