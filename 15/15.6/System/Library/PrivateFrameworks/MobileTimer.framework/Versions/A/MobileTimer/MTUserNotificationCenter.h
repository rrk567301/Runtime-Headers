...
+ (id)_allIdentifiersForAlarm:(id)a0 includeMainIdentifier:(char)a1;
+ (id)_allIdentifiersForAlarm:(id)a0 includeMainIdentifier:(char)a1 includeSnooze:(char)a2;
...
- (void)dismissNotificationsForAlarm:(id)a0 includeMainIdentifier:(char)a1;
- (void)dismissNotificationsForAlarm:(id)a0 includeMainIdentifier:(char)a1 includeSnooze:(char)a2;
- (void)dismissNotificationsForAlarm:(id)a0 includeSnooze:(char)a1;
