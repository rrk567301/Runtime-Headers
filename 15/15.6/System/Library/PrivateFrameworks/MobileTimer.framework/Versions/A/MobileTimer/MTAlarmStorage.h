...
- (void)_queue_setAllAlarms:(id)a0 sleepAlarms:(id)a1 source:(id)a2 persist:(char)a3 notify:(char)a4 override:(char)a5;
...
- (char)_queue_hasMatchingAlarm:(id)a0;
...
- (void)_queue_setAllAlarms:(id)a0 sleepAlarms:(id)a1 source:(id)a2 persist:(char)a3 notify:(char)a4;
