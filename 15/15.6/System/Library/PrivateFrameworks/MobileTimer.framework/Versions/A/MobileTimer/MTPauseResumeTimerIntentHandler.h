...
- (void)_handlePauseTimer:(id)a0 dryRun:(char)a1 completion:(id /* block */)a2;
- (void)_handleResumeTimer:(id)a0 dryRun:(char)a1 completion:(id /* block */)a2;
- (id)_responseToPauseTimerIntent:(id)a0 withPausedTimers:(id)a1 error:(id)a2 dryRun:(char)a3;
- (id)_responseToResumeTimerIntent:(id)a0 withResumedTimers:(id)a1 error:(id)a2 dryRun:(char)a3;
