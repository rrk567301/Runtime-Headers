...
@property (readonly, nonatomic) char hasDefaultTitle;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
+ (char)isActiveTimer:(id)a0;
+ (id)propertiesAffectingSessions;
+ (char)stateChangeIsAllowableFromState:(unsigned long long)a0 toState:(unsigned long long)a1;
...
- (char)isEqualToTimer:(id)a0;
- (void)_copyStateOntoTimer:(id)a0;
- (char)_isEqualToTimer:(id)a0 checkLastModified:(char)a1;
