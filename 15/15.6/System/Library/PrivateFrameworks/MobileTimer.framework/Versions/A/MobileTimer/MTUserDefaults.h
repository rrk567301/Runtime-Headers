...
- (char)boolForKey:(id)a0 exists:(char *)a1;
- (void)distributedNotificationPosted:(id)a0;
- (float)floatForKey:(id)a0 exists:(char *)a1;
- (long long)integerForKey:(id)a0 exists:(char *)a1;
...
- (void)setBool:(char)a0 forKey:(id)a1 notification:(id)a2;
...
- (double)timeIntervalForKey:(id)a0 exists:(char *)a1;
