...
- (id)_responseToSetTimerAttributeIntent:(id)a0 withUpdatedTimer:(id)a1 error:(id)a2 dryRun:(char)a3;
- (void)_updateTimer:(id)a0 toDuration:(double)a1 toLabel:(id)a2 dryRun:(char)a3 completion:(id /* block */)a4;
