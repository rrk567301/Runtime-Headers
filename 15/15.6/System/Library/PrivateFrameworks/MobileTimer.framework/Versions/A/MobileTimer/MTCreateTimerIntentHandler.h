...
- (void)_createTimerWithIntent:(id)a0 dryRun:(char)a1 completion:(id /* block */)a2;
- (id)_responseToCreateTimerIntent:(id)a0 withCreatedTimer:(id)a1 error:(id)a2 dryRun:(char)a3;
- (char)_timer:(id)a0 conflictsWithRunningTimersInTimers:(id)a1;
