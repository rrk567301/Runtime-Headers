...
- (id)_nextScheduledAlertIncludingBedtimeNotification:(char)a0;
...
- (char)_shouldPostNotificationForScheduledAlarm:(id)a0;
...
- (id)nextAlarm;
- (id)nextAlarmIncludingBedtimeNotification:(char)a0;
- (id)nextScheduledAlarmIncludingBedtimeNotification:(char)a0;
- (id)nextTriggerDateIncludingBedtimeNotification:(char)a0;
