...
- (void)_deleteTimer:(id)a0 multiple:(char)a1 dryRun:(char)a2 completion:(id /* block */)a3;
- (id)_responseToDeleteTimerIntent:(id)a0 withDeletedTimers:(id)a1 error:(id)a2 dryRun:(char)a3;
