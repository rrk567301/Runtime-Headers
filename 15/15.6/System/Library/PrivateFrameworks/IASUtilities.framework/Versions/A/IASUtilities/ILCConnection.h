...
- (char)writeFilename:(id)a0 withHandle:(id)a1 flags:(int)a2;
- (char)beginFile:(id)a0 forFilename:(id)a1 flags:(int)a2 isSysdiagnose:(char)a3;
...
- (char)sendFile:(id)a0 flags:(int)a1 error:(id *)a2;
- (void)sendGoodbyeWithReason:(int)a0;
- (void)socketWorkThread;
- (void)updateFilesForUUID:(id)a0 didFail:(char)a1;
