...
+ (char)isLocaleIdentifier:(id)a0 containedInLocaleIdentifiers:(id)a1;
...
- (char)isSupportedCommandIdentifier:(id)a0 forLocaleIdentifier:(id)a1;
- (char)isSupportedCommandIdentifier:(id)a0 forTargetTypes:(id)a1;
...
- (id)phrasesForCommandIdentifier:(id)a0 targetTypes:(id)a1 parameterStrings:(id)a2;
...
- (id)spokenStringPermutationsOfLanguageModelDictionary:(id)a0 stringsTable:(id)a1 restrictPermutationsToShortestAndLongest:(char)a2;
