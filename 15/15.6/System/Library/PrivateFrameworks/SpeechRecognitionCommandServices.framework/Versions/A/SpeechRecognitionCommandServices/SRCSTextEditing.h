...
- (id)_actOnStrings:(id)a0 range:(id)a1 ambiguityResolution:(id)a2 substringSearchGranularity:(int)a3 alwaysCallActionOnClosestMatch:(char)a4 options:(id)a5 provider:(id)a6 actionBlock:(id /* block */)a7;
...
- (long long)_indexOfFirstPhraseMatchResultPairBeforeInsertion:(char)a0 fromArray:(id)a1;
...
- (char)_range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includesRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_rangeOfWordBasedSearchString:(id)a0 inString:(id)a1 withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 forwardSearchDirection:(char)a3;
- (id)_stringBySurroundingString:(id)a0 withPrefixString:(id)a1 suffixString:(id)a2;
- (id)_strippedPhraseStringsFromStrings:(id)a0;
- (id)actOnStrings:(id)a0 ambiguityResolution:(id)a1 substringSearchGranularity:(int)a2 alwaysCallActionOnClosestMatch:(char)a3 options:(id)a4 actionBlock:(id /* block */)a5;
...
- (id)orderedPhraseMatchesFromStrings:(id)a0 forwardDirection:(char)a1 referenceLocation:(long long)a2 substringSearchGranularity:(int)a3;
- (void)pasteboardCopy;
- (void)pasteboardCut;
