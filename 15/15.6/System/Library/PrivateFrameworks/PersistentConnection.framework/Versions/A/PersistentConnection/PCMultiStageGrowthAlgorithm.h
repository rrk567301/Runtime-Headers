...
@property (nonatomic) char isServerOriginatedKeepAlive;
...
@property (nonatomic) struct _PCTimeRange { double start; double duration; } signalAvoidanceRange;
...
- (void)_setCurrentKeepAliveInterval:(double)a0 varianceMode:(unsigned int)a1;
- (void)_setCurrentKeepAliveInterval:(double)a0 varianceMode:(unsigned int)a1 allowRoundUp:(char)a2;
...
- (char)useIntervalIfImprovement:(double)a0;
