...
@property (class, nonatomic, readonly) char shouldSyncInReadOnlyMode;
@property (class, nonatomic, readonly) _TtC18PodcastsFoundation18SyncKeysRepository *shared;

@property (nonatomic) char isNonFollowedShowsSyncDirty;
@property (nonatomic) char isInterestSyncDirty;
@property (nonatomic) char isPlaylistSyncDirty;
...
@property (nonatomic) char isLibrarySyncEnabled;

- (id)init;
- (void).cxx_destruct;
- (char)isBookmarksSyncDirtyFor:(long long)a0;
- (char)isSubscriptionSyncDirtyFor:(long long)a0;
- (void)markBookmarksSyncDirty:(char)a0 for:(long long)a1;
- (void)markInterestSyncDirty:(char)a0;
- (void)markSubscriptionSyncDirty:(char)a0 for:(long long)a1;
