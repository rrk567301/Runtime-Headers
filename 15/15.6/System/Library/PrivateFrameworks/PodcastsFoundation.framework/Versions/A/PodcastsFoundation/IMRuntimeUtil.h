...
+ (void)associateBoolValue:(char)a0 forKey:(id)a1 onObject:(id)a2;
+ (void)associateBoolValue:(char)a0 forKey:(id)a1 onObject:(id)a2 withPolicy:(unsigned long long)a3;
...
+ (char)associatedBoolValueForKey:(id)a0 onObject:(id)a1;
+ (char)associatedBoolValueForKey:(id)a0 onObject:(id)a1 withDefault:(char)a2;
