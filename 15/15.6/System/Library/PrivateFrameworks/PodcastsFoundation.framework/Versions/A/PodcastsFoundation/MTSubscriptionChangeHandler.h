...
- (void)_unsafeUpdatePriceTypeAndSendNotificationsIfNeededFor:(id)a0 subscriptionActive:(char)a1 episodeEffects:(id)a2 taskID:(id)a3;
- (unsigned long long)_updateEntitledAttributes:(id)a0 subscriptionActive:(char)a1 taskID:(id)a2;
- (id)episodesWithEffect:(unsigned long long)a0 fromEpisodeEffects:(id)a1;
- (void)unsafeHandleSubscriptionChangeForChannel:(id)a0 subscriptionBecameActive:(char)a1 subscriptionEnabledDate:(double)a2;
