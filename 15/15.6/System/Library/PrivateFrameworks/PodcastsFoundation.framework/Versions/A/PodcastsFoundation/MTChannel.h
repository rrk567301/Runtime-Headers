@class NSString, NSSet, MTInterest;
...
@property (nonatomic) char subscriptionActive;
...
@property (readonly, nonatomic) char isMultiShow;
@property (readonly, nonatomic) char isSingleShow;

+ (id)predicateForChannelWithStoreId:(long long)a0;
+ (id)createOrFindChannelFromFeedChannelItem:(id)a0 personalizedRequest:(char)a1 context:(id)a2;
...
+ (id)sortDescriptorsForLibraryChannelsPage:(char)a0;
