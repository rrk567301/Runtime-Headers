...
+ (id)_nextEpisodeForUnplayedPodcast:(id)a0 serial:(char)a1 filter:(id)a2 ctx:(id)a3;
+ (id)_upNextForPodcast:(id)a0 serial:(char)a1 excludeExplicit:(long long)a2 ctx:(id)a3;
+ (id)_upNextResultForUnfollowedPodcast:(id)a0 filter:(id)a1 ctx:(id)a2;
+ (id)_upNextResultForUnplayedFollowedPodcast:(id)a0 nextEpisodeForUnplayedShow:(id)a1 newestEpisodeWithShowBump:(id)a2 mostRecentlyPlayed:(id)a3 filter:(id)a4 serial:(char)a5 ctx:(id)a6;
+ (id)_upNextScoreWithLastModifiedDate:(double)a0 lastDatePlayed:(double)a1 filter:(id)a2 podcast:(id)a3 ctx:(id)a4;
+ (id)caughtUpNextEpisodeForPodcast:(id)a0 nextEpisodeForUnplayedShow:(id)a1 mostRecentlyPlayedLastDatePlayed:(double)a2 serial:(char)a3 filter:(id)a4;
...
+ (id)nextEpisodeForPodcast:(id)a0 mostRecentlyPlayed:(id)a1 caughtUpNextEpisode:(id)a2 serial:(char)a3 filter:(id)a4;
