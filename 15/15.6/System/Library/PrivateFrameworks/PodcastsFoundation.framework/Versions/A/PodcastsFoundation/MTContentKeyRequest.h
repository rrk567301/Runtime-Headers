...
- (id)initFrom:(id)a0 adamId:(id)a1 requestType:(long long)a2 offlineRequest:(char)a3;
- (id)initWithKeyIdentifier:(id)a0 adamId:(id)a1 requestType:(long long)a2 offlineRequest:(char)a3 secureInvalidationDsid:(id)a4;
