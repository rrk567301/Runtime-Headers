...
- (void)cleanupAfterContentKeyRequestForOfflineRenewal:(char)a0 withError:(id)a1;
- (void)cleanupAfterContentKeyRequestWithError:(id)a0;
- (void)finishContentKeyRequest:(id)a0 forOfflineRenewal:(char)a1 withResponse:(id)a2;
...
- (void)startKeyLoadingProcessWithKeyIdentifier:(id)a0 contentAdamId:(id)a1 isRenewal:(char)a2 completion:(id /* block */)a3;
- (void)startKeyLoadingProcessWithKeyRequestData:(id)a0 isRenewal:(char)a1 completion:(id /* block */)a2;
