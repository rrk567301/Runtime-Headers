...
@property (nonatomic) char excludeUnentitled;
@property (nonatomic) char excludeGhostEpisodes;
@property (nonatomic) char restrictToUserEpisodes;
@property (copy, nonatomic) NSString *excludingEpisodeUuid;

+ (long long)playStateFilterFromExcludePlayed:(char)a0;
