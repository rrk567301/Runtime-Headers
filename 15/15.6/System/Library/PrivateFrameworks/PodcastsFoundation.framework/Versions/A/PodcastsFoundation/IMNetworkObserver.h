...
@property (readonly, getter=isObserving) char observing;
...
+ (char)isLikelyToReachRemoteServerWithReachabilityFlags:(unsigned int)a0;
...
- (char)networkTypeIsCellularType:(long long)a0;
