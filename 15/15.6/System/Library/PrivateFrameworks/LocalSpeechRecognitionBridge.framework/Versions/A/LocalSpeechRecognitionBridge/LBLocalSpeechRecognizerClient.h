...
@interface LBLocalSpeechRecognizerClient : NSObject <LBLocalSpeechServiceDelegate> {
    ...
    char _shouldEnableAudioCapture;
}
...
+ (char)isInstalledFromStatusString:(id)a0;
...
- (char)_shouldSetSpeechEventForRecordType:(long long)a0;
- (void)_stopSpeechRecognitionTaskWithReason:(unsigned long long)a0 requestId:(id)a1 shouldInvalidateAfterStop:(char)a2 completion:(id /* block */)a3;
...
- (oneway void)localSpeechServiceDidReceivedEagerResultWithRequestId:(id)a0 rcId:(unsigned long long)a1 shouldAccept:(char)a2 mitigationSignal:(char)a3 featuresToLog:(id)a4;
