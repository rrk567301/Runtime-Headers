...
- (void)drawSelf;
- (long long)getStringWidth:(id)a0 withAttributes:(id)a1 isTime:(char)a2;
- (id)getTextImage:(id)a0 withAttributes:(id)a1 isTime:(char)a2;
- (id)getTimeImage:(long long)a0 isMenuDown:(char)a1;
- (id)imageArray;
...
- (void)setShowAnimatedStatus:(char)a0;
- (void)setShowTimer:(char)a0;
