...
- (char)detectMentionsInUtterance:(id)a0 maximumCandidates:(unsigned long long)a1 status:(id *)a2 completionBlock:(id /* block */)a3;
- (id)detectMentionsInUtterance:(id)a0 status:(id *)a1;
- (char)detectMentionsInUtterance:(id)a0 status:(id *)a1 completionBlock:(id /* block */)a2;
...
- (char)detectMentionsInUtterance:(id)a0 utteranceTokens:(id)a1 tokenEmbeddings:(id)a2 maximumCandidates:(unsigned long long)a3 status:(id *)a4 completionBlock:(id /* block */)a5;
