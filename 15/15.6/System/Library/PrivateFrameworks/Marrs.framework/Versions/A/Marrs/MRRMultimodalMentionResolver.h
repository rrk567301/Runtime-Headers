...
- (char)resolveCandidatesForUtterance:(id)a0 entities:(id)a1 maximumCandidates:(unsigned long long)a2 status:(id *)a3 completionBlock:(id /* block */)a4;
- (char)resolveCandidatesForUtterance:(id)a0 mentions:(id)a1 entities:(id)a2 maximumCandidates:(unsigned long long)a3 status:(id *)a4 completionBlock:(id /* block */)a5;
- (char)resolveCandidatesForUtterance:(id)a0 status:(id *)a1 completionBlock:(id /* block */)a2;
...
- (char)resolveCandidatesForUtterance:(id)a0 utteranceTokens:(id)a1 tokenEmbeddings:(id)a2 entities:(id)a3 maximumCandidates:(unsigned long long)a4 status:(id *)a5 completionBlock:(id /* block */)a6;
- (char)resolveCandidatesForUtterance:(id)a0 utteranceTokens:(id)a1 tokenEmbeddings:(id)a2 mentions:(id)a3 entities:(id)a4 maximumCandidates:(unsigned long long)a5 status:(id *)a6 completionBlock:(id /* block */)a7;
