@class NSString, QSSUserLanguageProfile, NSMutableDictionary, NSData;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct CreateLanguageProfileResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
