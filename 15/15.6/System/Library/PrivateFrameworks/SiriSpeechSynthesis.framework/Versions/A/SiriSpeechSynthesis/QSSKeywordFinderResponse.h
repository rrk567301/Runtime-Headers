@class NSString, NSArray, NSMutableDictionary, NSData, QSSRecognitionSausage;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct KeywordFinderResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
