@class NSString, NSMutableDictionary, NSData, QSSTextToSpeechResponseDevData;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct FinalTextToSpeechStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
