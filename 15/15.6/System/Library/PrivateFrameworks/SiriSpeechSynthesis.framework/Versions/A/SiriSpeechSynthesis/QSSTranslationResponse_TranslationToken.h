@class QSSAlignment, NSString, NSMutableDictionary, NSData;
...
@property (readonly, nonatomic) QSSAlignment *mt_alignment;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TranslationToken { unsigned char x0[1]; } *)a1 verify:(char)a2;
