@class NSData, QSSStartBatchRecoverRequest, NSMutableDictionary;
...
@property (readonly, nonatomic) QSSStartBatchRecoverRequest *contentAsQSSStartBatchRecoverRequest;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct BatchRecoverStreamingRequest { unsigned char x0[1]; } *)a1 verify:(char)a2;
