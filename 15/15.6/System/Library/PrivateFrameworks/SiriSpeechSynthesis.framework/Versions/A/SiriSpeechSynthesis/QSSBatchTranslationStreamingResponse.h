@class QSSFinalBlazarResponse, NSMutableDictionary, QSSTranslationSupportedLanguagesResponse, QSSBatchTranslationResponse, NSData;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct BatchTranslationStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
