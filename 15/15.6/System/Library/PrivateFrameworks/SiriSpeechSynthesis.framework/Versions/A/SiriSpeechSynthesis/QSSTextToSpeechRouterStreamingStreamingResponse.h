@class QSSBeginTextToSpeechStreamingResponse, QSSPartialTextToSpeechStreamingResponse, NSMutableDictionary, NSData, QSSFinalTextToSpeechStreamingResponse;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TextToSpeechRouterStreamingStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
