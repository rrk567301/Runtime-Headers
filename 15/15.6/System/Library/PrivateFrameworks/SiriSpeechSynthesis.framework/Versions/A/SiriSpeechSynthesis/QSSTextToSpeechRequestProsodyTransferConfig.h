@class QSSTextToSpeechUserVoiceProfile, NSString, QSSTextToSpeechSpeechFeatureInputWave, NSMutableDictionary, NSData;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TextToSpeechRequestProsodyTransferConfig { unsigned char x0[1]; } *)a1 verify:(char)a2;
