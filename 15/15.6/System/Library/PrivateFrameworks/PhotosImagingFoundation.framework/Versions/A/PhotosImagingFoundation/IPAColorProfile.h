...
@property (readonly, nonatomic) char needsGamutMapping;
...
+ (char)loadProfilesWithError:(id *)a0;
...
+ (id)profileWithColorSyncProfile:(struct ColorSyncProfile { } *)a0 name:(id)a1 wantsCache:(char)a2;
...
- (char)isEqualToColorProfile:(id)a0;
