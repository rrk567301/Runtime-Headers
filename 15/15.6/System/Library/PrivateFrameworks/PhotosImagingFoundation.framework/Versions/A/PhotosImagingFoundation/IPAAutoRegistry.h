...
- (char)hasMappingForAutoIdentifier:(id)a0 operationIdentifier:(id)a1;
- (char)isPersistableAutoIdentifier:(id)a0 forOperationIdentifier:(id)a1;
- (void)registerAutoCalculatorSettingsClass:(Class)a0 toAutoIdentifier:(id)a1 operationIdentifier:(id)a2;
- (void)registerAutoCalculatorSettingsClass:(Class)a0 toAutoIdentifier:(id)a1 operationIdentifier:(id)a2 persistable:(char)a3;
