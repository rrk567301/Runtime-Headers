...
- (id)initWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 startDate:(id)a1 endDate:(id)a2 isAllDay:(char)a3 frequency:(id)a4;
- (id)initWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 startDate:(id)a1 endDate:(id)a2 isAllDay:(char)a3 startComponents:(id)a4 endComponents:(id)a5 frequencyComponents:(id)a6;
