...
- (char)finalizeWithSelector:(SEL)a0 allocatorBufferAddr:(void *)a1 size:(unsigned long long)a2 error:(id *)a3;
...
- (id)createVectorOfBoolWithCArray:(const char *)a0 count:(unsigned long long)a1;
- (id)createVectorOfBoolWithCArray:(const char *)a0 count:(unsigned long long)a1 alignment:(unsigned long long)a2;
