...
@property (readonly, nonatomic) char deserializerGeneratesResourceRefs;
@property unsigned long long reflectionSerializationVersion;
@property (readonly) char supportsOpenGL;
@property (readonly) char supportsCorrectBaseVertex;
...
- (void)doesAliasResources:(const id *)a0 count:(unsigned long long)a1 all:(char)a2 resource:(id)a3 allocator:(id)a4;
...
- (id)initWithDevice:(id)a0 deserializerGeneratesResourceRefs:(char)a1 deserializerVersion:(unsigned int)a2;
...
- (unsigned int)newBufferWithLength:(unsigned long long)a0 options:(unsigned long long)a1 heap:(id)a2 offset:(unsigned long long)a3 useOffset:(char)a4 allocator:(id)a5;
...
- (unsigned int)newTextureWithDescriptor:(id)a0 heap:(id)a1 offset:(unsigned long long)a2 useOffset:(char)a3 allocator:(id)a4;
...
- (id)initWithDevice:(id)a0 deserializerGeneratesResourceRefs:(char)a1;
- (id)initWithDevice:(id)a0 objectRefAllocator:(id)a1 deserializerGeneratesResourceRefs:(char)a2;
- (id)initWithDevice:(id)a0 objectRefAllocator:(id)a1 deserializerGeneratesResourceRefs:(char)a2 deserializerVersion:(unsigned int)a3;
