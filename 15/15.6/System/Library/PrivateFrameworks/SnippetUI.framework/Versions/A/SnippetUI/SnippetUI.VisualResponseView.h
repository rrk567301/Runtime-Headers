...
@property (nonatomic, readonly) char containsComponentsWithAction;
@property (nonatomic, readonly) char requestsKeyWindow;
@property (nonatomic, copy) NSString *viewId;
@property (nonatomic, copy) NSString *responseViewId;
@property (nonatomic) char isRedacted;
...
- (void)setIsInAmbient:(char)a0 withScaleFactor:(double)a1;
