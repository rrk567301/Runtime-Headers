...
- (char)_loadImageIsApp:(id)a0;
- (char)_loadImageIsAppExtension:(id)a0;
- (char)_loadImageIsBundle:(id)a0;
- (char)_loadImageIsDylib:(id)a0;
- (char)_loadImageIsFramework:(id)a0;
