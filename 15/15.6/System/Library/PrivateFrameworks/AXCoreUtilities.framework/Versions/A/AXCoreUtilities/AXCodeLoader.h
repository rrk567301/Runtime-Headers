...
@interface AXCodeLoader : NSObject <AXImageMonitorObserver> {
    ...
    char _initialLoadHasOccurred;
    char _initialLoadHasFinished;
    NSString *_currentPlatformKey;
}

@property (nonatomic) long long trackingMode;
@property (readonly, nonatomic) char isTrackingLoadedCodeItems;
@property (readonly, nonatomic) char isInitialLoadFinished;
@property (nonatomic) char shouldAutoloadAccessibilityCodeItems;
...
- (id)_queue_loadedCodeItemsUsingTrackedItemsIfAvailable:(char)a0;
...
- (id)loadedCodeItemPathsUsingTrackedItemsIfAvailable:(char)a0;
- (id)loadedCodeItemsUsingTrackedItemsIfAvailable:(char)a0;
- (void)logLoaderState;
