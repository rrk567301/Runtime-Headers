...
@property (nonatomic) char measurementsEnabled;
...
- (id)generateReport;
- (id)initWithName:(id)a0 measurementsEnabled:(char)a1;
- (id)initWithName:(id)a0 measurementsEnabled:(char)a1 orEnabledByEnvironmentVariables:(id)a2;
