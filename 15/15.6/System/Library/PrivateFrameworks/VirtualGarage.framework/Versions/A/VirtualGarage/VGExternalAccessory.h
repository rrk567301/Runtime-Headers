...
- (char)_currentStatePassesEVRoutingRequirements;
- (id)_firmwareId;
- (char)_isConnectedToCarPlayAccessory;
- (char)_isConnectedToElectricVehicle;
- (char)_isConnectedVehicleAllowlisted;
...
- (char)isConnectedToAccessoryWithIdentifier:(id)a0;
- (char)isConnectedToVehicle:(id)a0;
