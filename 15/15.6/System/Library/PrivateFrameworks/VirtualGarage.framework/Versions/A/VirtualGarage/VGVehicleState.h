...
@property (readonly, nonatomic) char isCharging;
...
- (id)_storage;
- (id)initWithIdentifier:(id)a0 dateOfUpdate:(id)a1 origin:(long long)a2 batteryPercentage:(id)a3 currentEVRange:(id)a4 maxEVRange:(id)a5 minBatteryCapacity:(id)a6 currentBatteryCapacity:(id)a7 maxBatteryCapacity:(id)a8 consumptionArguments:(id)a9 chargingArguments:(id)a10 isCharging:(char)a11 activeConnector:(unsigned long long)a12;
- (char)isSignificantlyDifferentFromVehicleState:(id)a0;
