...
- (void)_updateGarageWithVehicle:(id)a0 syncAcrossDevices:(char)a1;
- (void)_updateStateOfChargeForVehicle:(id)a0 syncAcrossDevices:(char)a1 completion:(id /* block */)a2;
...
- (char)shouldUnpairVehicle:(id)a0;
