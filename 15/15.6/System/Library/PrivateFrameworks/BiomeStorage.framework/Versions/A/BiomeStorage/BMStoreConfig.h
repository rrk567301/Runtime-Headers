...
+ (id)newStreamDefaultConfigurationForPublicStream:(char)a0;
+ (id)newStreamDefaultConfigurationForPublicStream:(char)a0 protectionClass:(unsigned long long)a1;
+ (id)newStreamDefaultConfigurationForPublicStream:(char)a0 protectionClass:(unsigned long long)a1 segmentSize:(unsigned long long)a2;
...
- (id)tombstonesConfig;
- (id)_initWithStoreVersion:(unsigned long long)a0 storeBasePath:(id)a1 segmentSize:(unsigned long long)a2 protectionClass:(unsigned long long)a3 storeLocationOption:(long long)a4 account:(id)a5 remoteName:(id)a6 pruningPolicy:(id)a7 streamType:(unsigned long long)a8 domain:(unsigned long long)a9 user:(unsigned int)a10 isManaged:(char)a11 streamIdentifier:(id)a12;
