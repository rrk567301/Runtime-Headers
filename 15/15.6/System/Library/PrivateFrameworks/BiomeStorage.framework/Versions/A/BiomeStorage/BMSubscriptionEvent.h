...
- (id)initWithClient:(id)a0 identifier:(id)a1 useCase:(id)a2 starting:(char)a3;
- (id)initWithProto:(id)a0;
- (id)_initWithClient:(id)a0 identifier:(id)a1 useCase:(id)a2 starting:(char)a3 bootUUID:(id)a4;
