...
@property (readonly, nonatomic) char includeTombstones;
...
- (id)initWithStream:(id)a0 permission:(unsigned long long)a1 config:(id)a2 includeTombstones:(char)a3;
- (id)initWithStream:(id)a0 permission:(unsigned long long)a1 config:(id)a2 includeTombstones:(char)a3 eventDataClass:(Class)a4 useCase:(id)a5;
...
- (void)_removeEventsFrom:(double)a0 to:(double)a1 reason:(unsigned long long)a2 policyID:(id)a3 pruneFutureEvents:(char)a4 shouldDeleteUsingBlock:(id /* block */)a5;
...
- (id)initWithStream:(id)a0 streamPath:(id)a1 permission:(unsigned long long)a2 config:(id)a3 includeTombstones:(char)a4 eventDataClass:(Class)a5 useCase:(id)a6;
- (char)isSubscriptionStore;
- (char)isTombstoneStore;
- (id)loadMetadata;
- (id)metadataPath;
...
- (void)removeEventsFrom:(double)a0 to:(double)a1 reason:(unsigned long long)a2 pruneFutureEvents:(char)a3 shouldDeleteUsingBlock:(id /* block */)a4;
- (void)removeEventsFrom:(double)a0 to:(double)a1 reason:(unsigned long long)a2 pruneFutureEvents:(char)a3 usingBlock:(id /* block */)a4;
...
- (id)tombstoneStore;
- (char)updateMetadata:(Class)a0 pruningPolicy:(id)a1;
- (char)updatePruningPolicy:(id)a0;
- (char)verifyStreamHealthFrom:(double)a0 to:(double)a1 error:(id *)a2;
- (char)verifyStreamHealthFromV1:(double)a0 to:(double)a1 frameStore:(id)a2 error:(id *)a3;
- (char)verifyStreamHealthFromV2:(double)a0 to:(double)a1 frameStore:(id)a2 error:(id *)a3;
- (char)writeEventBytes:(const void *)a0 length:(unsigned long long)a1 dataVersion:(unsigned int)a2 timestamp:(double)a3;
- (char)writeEventBytes:(const void *)a0 length:(unsigned long long)a1 dataVersion:(unsigned int)a2 timestamp:(double)a3 outBookmark:(id *)a4;
- (char)writeEventData:(id)a0 dataVersion:(unsigned int)a1 timestamp:(double)a2;
- (char)writeEventData:(id)a0 dataVersion:(unsigned int)a1 timestamp:(double)a2 outBookmark:(id *)a3;
- (char)writeEventWithEventBody:(id)a0;
- (char)writeEventWithEventBody:(id)a0 timestamp:(double)a1;
- (char)writeEventWithEventBody:(id)a0 timestamp:(double)a1 outBookmark:(id *)a2;
- (char)writeEventWithEventBody:(id)a0 timestamp:(double)a1 outEventSize:(unsigned long long *)a2 outBookmark:(id *)a3;
