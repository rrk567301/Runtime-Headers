...
- (void).cxx_destruct;
- (id)nextEvent;
- (char)isDataAccessible;
- (void)setEndTime:(double)a0 maxEvents:(unsigned long long)a1 lastN:(unsigned long long)a2 reverse:(char)a3;
- (id)_eventWithFrameStore:(id)a0 frame:(id)a1 error:(unsigned char)a2;
- (char)advanceBookmarkToStartTime:(double)a0 eventsFound:(unsigned long long *)a1 lastN:(unsigned long long)a2;
- (char)advanceBookmarkV1ToStartTime:(double)a0 eventsFound:(unsigned long long *)a1 lastN:(unsigned long long)a2;
- (char)advanceBookmarkV2ToStartTime:(double)a0 eventsFound:(unsigned long long *)a1 lastN:(unsigned long long)a2;
- (id)copyNextEventAndMoveBookmark:(char)a0;
- (id)copyNextEventAndMoveBookmark:(char)a0 makeEvent:(id /* block */)a1;
...
- (id)peekEvent;
- (char)skipToBookmarkOffset:(id)a0;
