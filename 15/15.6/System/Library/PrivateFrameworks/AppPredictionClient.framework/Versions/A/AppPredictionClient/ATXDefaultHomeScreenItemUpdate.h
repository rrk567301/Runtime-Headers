...
@property (readonly, nonatomic) char shouldSuggestStackInGallery;

- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithDictionary:(id)a0;
- (id)dictionaryRepresentation;
- (id)initWithStack:(id)a0 todayStack:(id)a1 onboardingStacks:(id)a2 smallWidgets:(id)a3 mediumWidgets:(id)a4 largeWidgets:(id)a5 extraLargeWidgets:(id)a6 shouldSuggestStackInGallery:(char)a7;
