...
+ (char)isCHSWidgetDescriptorAllowedForAmbientOnboardingStacks:(id)a0;
+ (char)isCHSWidgetDescriptorAllowedForCarPlayOnboardingStacks:(id)a0;
+ (char)isDescriptorSpecial:(id)a0;
+ (char)shouldFilterOutWidgetDescriptorDueToAppProtection:(id)a0 fromDisabledApps:(id)a1;
