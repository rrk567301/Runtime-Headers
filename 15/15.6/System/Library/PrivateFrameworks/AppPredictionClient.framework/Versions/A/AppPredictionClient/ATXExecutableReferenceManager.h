...
@interface ATXExecutableReferenceManager : NSObject {
    ...
    char __cachedExecutableToReferenceMapNeedsWrite;
}
...
- (char)canExecutableClearOnEngagement:(id)a0;
- (id)_loadReferences;
...
- (void)_purgeReferencesIfPossibleInMap:(id)a0 forceWrite:(char)a1;
- (id)_readData;
...
- (void)recordExecutable:(id)a0 clientModelId:(id)a1 shouldClearEngagement:(char)a2;
