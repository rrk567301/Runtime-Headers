@class WFWorkflowRunViewSource, SFSearchResult, WFSuggestionsWorkflowRunnerClient, NSString;
...
- (char)_delegateDoesRespond;
- (char)_shouldTellDelegateToClearActionOnDismissal:(long long)a0;
