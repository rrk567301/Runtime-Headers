...
+ (char)_isAutoShortcutEnabledForSpotlight:(id)a0;
+ (char)_isEqualRecentTopics:(id)a0 otherRecentTopics:(id)a1;
+ (char)_isValidSuggestion:(id)a0 forWorldState:(id)a1;
...
+ (char)_shouldDisplayUpcomingMediaForTesting;
...
+ (char)isAutoShortcutEnabledForSpotlightForBundleId:(id)a0 signature:(id)a1;
+ (char)isAutoShortcutsEnabledForSpotlightForBundleId:(id)a0;
...
+ (char)topic:(id)a0 isDuplicateComparingTopics:(id)a1;
