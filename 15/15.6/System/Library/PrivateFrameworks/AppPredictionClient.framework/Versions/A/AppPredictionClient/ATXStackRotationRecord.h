...
@property (readonly, nonatomic) char isStalenessRotation;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithInfoSuggestionId:(id)a0 clientModelId:(id)a1 criterion:(id)a2 widget:(id)a3 kind:(id)a4 intent:(id)a5 isStalenessRotation:(char)a6 rotationDate:(id)a7 durationLimit:(double)a8 coolDownInterval:(double)a9;
