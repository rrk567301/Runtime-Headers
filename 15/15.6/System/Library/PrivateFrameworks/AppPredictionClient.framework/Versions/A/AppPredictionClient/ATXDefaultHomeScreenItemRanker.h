...
+ (char)_shouldDownrankWidget:(id)a0;
...
- (void)_filterOutWidgetsFromProtectedApps:(id)a0;
...
- (void)_sortWidgets:(id)a0 byRankerPlist:(int)a1 shouldDownRankAlreadyInstalledWidgets:(char)a2;
- (void)_sortWidgetsByDistinctDaysAppWasLaunched:(id)a0 shouldDownRankAlreadyInstalledWidgets:(char)a1;
- (void)_sortWidgetsByRawLaunchCounts:(id)a0 shouldDownRankAlreadyInstalledWidgets:(char)a1;
