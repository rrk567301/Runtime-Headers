...
+ (id)_defaultWidgetStackFromSmallStack:(id)a0 mediumStack:(id)a1 largeStack:(id)a2 extraLargeStack:(id)a3 suggestedSize:(unsigned long long)a4 maxWidgetsPerStack:(unsigned long long)a5 isiPad:(char)a6;
+ (char)_isSpecialAvocadoDescriptor:(id)a0;
...
+ (id)defaultWidgetStackFromSmallStack:(id)a0 mediumStack:(id)a1 largeStack:(id)a2 extraLargeStack:(id)a3 suggestedSize:(unsigned long long)a4 maxWidgetsPerStack:(unsigned long long)a5 isiPad:(char)a6;
...
+ (id)stackFromDefaultStackPersonalities:(id)a0 suggestedSize:(unsigned long long)a1 maxWidgetsPerStack:(unsigned long long)a2 personalityToDescriptorDictionary:(id)a3 isiPad:(char)a4;
+ (id)widget:(id)a0 filteredForSize:(unsigned long long)a1;
+ (id)widgetDescriptorFromChronoDescriptor:(id)a0 appBundleId:(id)a1 rankType:(long long)a2;
