...
- (char)_activityIsEligibleForSetUpSuggestion:(id)a0 modeGlobals:(id)a1;
- (char)_activityIsEligibleForTriggerSuggestion:(id)a0 modeGlobals:(id)a1;
...
- (char)_shouldSendAutomationSuggestionForMode:(int)a0;
- (char)_shouldSendModeSetUpSuggestionAtEndOfModeToLockScreen:(id)a0 modeGlobals:(id)a1;
- (char)_shouldSendModeTriggerSuggestionAtEndOfModeToLockScreen:(id)a0 modeGlobals:(id)a1;
- (id)_suggestionWithActivity:(id)a0 modeGlobals:(id)a1;
- (void)addObserver:(id)a0 sendingInitialChangeNotification:(char)a1;
...
- (void)registerObserver:(id)a0 sendingInitialChangeNotification:(char)a1;
