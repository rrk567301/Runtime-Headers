...
@interface ATXHomeScreenEventLogger : NSObject <ATXHomeScreenEventLogging> {
    ...
    NSSet *_dockAppSet;
    char _hasAppPanelOnHomeScreen;
    char _hasAppPanelOnLoH;
    char _hasSuggestionWidgetOnHomeScreen;
    char _hasSuggestionWidgetOnLoH;
...
- (void)_logCaptureRateForAppPredictionPanelWithEngagedSuggestion:(id)a0 isSuggestionsWidget:(char)a1 widgetIdentifier:(id)a2;
