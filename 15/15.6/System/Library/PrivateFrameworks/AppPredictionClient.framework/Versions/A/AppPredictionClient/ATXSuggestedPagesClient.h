...
@property (class, readonly, nonatomic) char shouldShowInternalFeedbackUI;
...
- (char)allowsSuggestionsForModeUUID:(id)a0;
...
- (void)sendModificationMetricsToCoreAnalyticsWithBundleIds:(id)a0 suggestedPage:(id)a1 isAdded:(char)a2;
- (void)suggestedPagesWithFilter:(id)a0 layoutOptions:(id)a1 completionHandler:(id /* block */)a2;
- (void)updateSuggestedPagesWithCompletionHandler:(id /* block */)a0;
