...
@property (nonatomic) char requiresAppLaunch;
...
@property (nonatomic, getter=isSuggestedWidget) char suggestedWidget;
@property (nonatomic, getter=isOnboardingWidget) char onboardingWidget;
...
- (id)_dictionaryRepresentationIncludingFullIntent:(char)a0;
...
- (char)isSameWidgetAsWidgetBundleId:(id)a0 widgetKind:(id)a1;
