...
- (void)_addHidingButtonToAutoShortcut:(id)a0;
...
- (char)_autoShortcutHasBeenHiddenForSearchResult:(id)a0 withFeedbackManager:(id)a1;
- (char)_contextHasBeenHiddenForSearchResult:(id)a0 adapter:(id)a1 feedbackManager:(id)a2;
...
- (id)_hidingCommandButtonItemWithIdentifier:(id)a0 title:(id)a1 symbolName:(id)a2 isAction:(char)a3;
...
- (char)_isExecutableIdentifierRecognized:(id)a0;
- (id)_localizableKeyWithExecutableIdentifier:(id)a0;
- (id)_localizedTitleWithQueryTopic:(id)a0;
- (id)_makeClearButtonItemForAutoShortcutAndShouldClearWholeSection:(char)a0 ForResult:(id)a1;
- (id)_nameWithNearbySuggestionIdentifier:(id)a0;
- (id)_nearbySuggestionIdentifierWithName:(id)a0;
- (char)_shouldAddHidingButtonItemForContextIdentifier:(id)a0;
- (char)_shouldAddHidingButtonItemForExecutableIdentifier:(id)a0;
...
- (char)shouldHideSearchResult:(id)a0;
