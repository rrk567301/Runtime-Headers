...
- (void)logDigestOnboardingWithEntrySource:(int)a0 digestSetupOutcome:(int)a1 finalUIShown:(int)a2 timeTaken:(double)a3 didSelectShowMore:(char)a4 numDaysForAverageNotificationCount:(unsigned long long)a5 shownApps:(id)a6 appsAddedToDigest:(id)a7 deliveryTimes:(id)a8;
- (id)onBoardingAppSelectionEventWithApp:(id)a0 rank:(unsigned long long)a1 addedToDigest:(char)a2 wasShownInDigest:(char)a3 sessionUUID:(id)a4;
