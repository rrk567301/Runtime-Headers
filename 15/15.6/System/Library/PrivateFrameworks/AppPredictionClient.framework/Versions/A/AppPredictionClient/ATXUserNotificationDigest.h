...
@property (readonly, nonatomic) char hasLoggedUpcoming;
@property (readonly, nonatomic) char hasLoggedCollapsed;
@property (readonly, nonatomic) char hasLoggedScheduled;
...
- (char)doesDigestShareContentWithOtherDigest:(id)a0;
