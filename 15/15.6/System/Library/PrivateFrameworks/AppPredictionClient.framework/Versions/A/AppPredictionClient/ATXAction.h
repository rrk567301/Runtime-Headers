@class NSUUID, NSString, ATXAVRouteInfo, NSArray, ATXLazyIntent, NSDictionary, NSUserActivity, CSSearchableItemAttributeSet, INIntent, ATXActionCriteria, NSNumber, UAUserActivityProxy;
...
@property (readonly, nonatomic) char isHeuristic;
@property (readonly, nonatomic) char isFutureMedia;
@property (copy, nonatomic) NSArray *predictableParameterCombinations;
@property (readonly, nonatomic) char isTVWhiteListedLongFormMedia;
...
+ (char)_isTVIntent:(id)a0 bundleId:(id)a1;
...
- (id)actionKey;
- (id)actionSubtitle;
- (id)initWithIntent:(id)a0 actionUUID:(id)a1 bundleId:(id)a2 heuristic:(id)a3 heuristicMetadata:(id)a4 criteria:(id)a5 isFutureMedia:(char)a6 title:(id)a7 subtitle:(id)a8;
...
- (char)_shouldUseCachedTitle:(id)a0 cachedLanguageCode:(id)a1;
...
- (id)initFromBestAppSuggestion:(id)a0 activity:(id)a1 actionUUID:(id)a2 bundleId:(id)a3 contentAttributeSet:(id)a4 itemIdentifier:(id)a5 heuristic:(id)a6 heuristicMetadata:(id)a7 criteria:(id)a8 isFutureMedia:(char)a9 title:(id)a10 subtitle:(id)a11;
- (id)initWithActivityProxy:(id)a0 activity:(id)a1 activityString:(id)a2 itemIdentifier:(id)a3 contentAttributeSet:(id)a4 intent:(id)a5 actionUUID:(id)a6 bundleId:(id)a7 type:(unsigned long long)a8 heuristic:(id)a9 heuristicMetadata:(id)a10 criteria:(id)a11 isFutureMedia:(char)a12 routeInfo:(id)a13 title:(id)a14 subtitle:(id)a15 languageCode:(id)a16 cachedHash:(id)a17;
- (id)initWithNSUserActivity:(id)a0 actionUUID:(id)a1 bundleId:(id)a2 contentAttributeSet:(id)a3 itemIdentifier:(id)a4 heuristic:(id)a5 heuristicMetadata:(id)a6 criteria:(id)a7 isFutureMedia:(char)a8 title:(id)a9 subtitle:(id)a10;
- (id)initWithNSUserActivityString:(id)a0 actionUUID:(id)a1 bundleId:(id)a2 itemIdentifier:(id)a3 contentAttributeSet:(id)a4 heuristic:(id)a5 heuristicMetadata:(id)a6 isFutureMedia:(char)a7 title:(id)a8 subtitle:(id)a9;
