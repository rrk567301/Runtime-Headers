...
- (char)eventCausesNotificationInactivity;
- (char)eventCausesNotificationNonprominence;
...
- (char)isDeliveredInPrioritySection;
- (char)isEqualToATXUserNotificationLoggingEvent:(id)a0;
- (char)isReceiveEvent;
