...
- (void)_dismissSuggestions:(id)a0 guardedData:(id)a1 fromSuggestionsWidget:(id)a2 dismissFromAllUIs:(char)a3 duration:(double)a4;
- (void)_handleStackSuggestionDidUpdate:(id)a0;
- (char)_isFallbackSuggestionUsed:(id)a0 guardedData:(id)a1;
- (char)_isSystemInitiatedLayoutUpdateAllowed:(id)a0;
- (char)_isWidgetEngaged:(id)a0 kind:(id)a1 afterMostRecentProactiveRotationToSuggestionWithIdentifier:(id)a2 guardedData:(id)a3;
...
- (id)_newSuggestionLayoutForOldLayout:(id)a0 replacedSuggestionId:(id)a1 shouldSuggestionsBeDisjoint:(char)a2 usedFallbackIndexSet:(id)a3 guardedData:(id)a4;
...
- (char)_replaceSuggestionIfNeeded:(id)a0 fromProactiveWidget:(id)a1 guardedData:(id)a2;
- (id)_replaceSuggestionWithId:(id)a0 fromSuggestionsArray:(id)a1 suggestionLayoutType:(long long)a2 usedFallbackIndexSet:(id)a3 shouldSuggestionsBeDisjoint:(char)a4 guardedData:(id)a5;
- (void)_replaceSuggestionWithId:(id)a0 shouldSuggestionsBeDisjoint:(char)a1 guardedData:(id)a2;
...
- (void)_updateGuardedData:(id)a0 withCachedSuggestions:(id)a1 updateProactiveWidgetLayoutsOnly:(char)a2;
...
- (char)hasWidgetBeenSeen:(id)a0;
- (char)hasWidgetBeenTapped:(id)a0;
...
- (char)isSuggestionReplacementAvailableForSuggestion:(id)a0 inLayout:(id)a1;
...
- (void)logUserDidAddWidgetToStack:(id)a0 stackIdentifier:(id)a1 isSuggestion:(char)a2;
- (void)logUserDidChangeStackConfiguration:(id)a0;
- (void)logUserDidCreateStack:(id)a0 page:(id)a1 isSuggestion:(char)a2;
...
- (void)setIsUserInteractingWithProactiveWidget:(char)a0;
