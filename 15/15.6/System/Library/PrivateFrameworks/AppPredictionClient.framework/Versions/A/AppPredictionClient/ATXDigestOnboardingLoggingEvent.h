...
@property (readonly, nonatomic) char didSelectShowMore;
...
- (id)initWithSessionUUID:(id)a0 entrySource:(int)a1 digestOnboardingOutcome:(int)a2 finalUIShown:(int)a3 didSelectShowMore:(char)a4 timeTaken:(double)a5 deliveryTimes:(id)a6;
