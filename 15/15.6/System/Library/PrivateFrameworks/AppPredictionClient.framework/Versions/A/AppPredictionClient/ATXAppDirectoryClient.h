...
@property (nonatomic) char didSendFeedbackDuringSession;
...
- (void).cxx_destruct;
- (id)_init;
- (void)predictedAppsAndRecentAppsWithShouldUseDefaultCategories:(char)a0 reply:(id /* block */)a1;
...
- (void)categoriesWithShouldUseDefault:(char)a0 reply:(id /* block */)a1;
...
- (void)predictedAppsAndRecentAppsWithMaxNumberOfPredictedApps:(unsigned long long)a0 shouldUseDefaultCategories:(char)a1 reply:(id /* block */)a2;
