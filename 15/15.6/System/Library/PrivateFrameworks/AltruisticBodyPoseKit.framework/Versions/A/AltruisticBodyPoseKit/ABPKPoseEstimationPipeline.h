...
@interface ABPKPoseEstimationPipeline : NSObject {
    ...
    char _deviceANEVersionPriorOrEqualToH12;
    char _useLSTM3D;
...
- (void)computeRootTransforms:(id)a0 withCameraExtrinsics:(struct { void /* unknown type, empty encoding */ x0[4]; })a1 withVioPose:(struct { void /* unknown type, empty encoding */ x0[4]; })a2 withVioPoseValidity:(char)a3;
- (char)initAlgorithmModules;
