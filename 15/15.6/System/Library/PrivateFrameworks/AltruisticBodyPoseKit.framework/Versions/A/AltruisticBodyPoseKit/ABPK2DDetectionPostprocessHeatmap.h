@class ABPKPersonIDTracker, ABPK2DExtrapolationFiltering, ABPKImagePreProcessingParams, NSMutableArray;
...
- (id)initWithInputJoints:(unsigned long long)a0 andOutputJoints:(unsigned long long)a1 use3DSkeletonForExtrapolation:(char)a2 shouldPush3DSupportSkeleton:(char)a3 withExtrapolationTime:(double)a4;
