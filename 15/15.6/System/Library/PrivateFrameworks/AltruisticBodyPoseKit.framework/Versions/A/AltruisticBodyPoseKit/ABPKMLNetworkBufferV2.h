...
- (void)dealloc;
- (void).cxx_destruct;
- (char)_readSurfaceDescriptor;
- (char)_readTensorDescriptor;
- (id)initWithName:(id)a0 operation:(struct e5rt_execution_stream_operation { } *)a1 bindMode:(long long)a2 useSurface:(char)a3;
