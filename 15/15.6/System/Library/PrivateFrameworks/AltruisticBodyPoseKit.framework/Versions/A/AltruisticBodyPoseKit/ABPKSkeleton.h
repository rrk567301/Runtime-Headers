...
- (void)setLocalPoses:(const struct ABPKTransform { struct { } x0; } *)a0 andUpdateModelPoses:(char)a1;
- (void)setModelPoses:(const struct { void /* unknown type, empty encoding */ x0[4]; } *)a0 andUpdateLocalPoses:(char)a1;
- (void)setModelPosesFromDict:(id)a0 andUpdateLocalPoses:(char)a1;
- (void)transformModelPoses:(struct { void /* unknown type, empty encoding */ x0[4]; })a0 andUpdateLocalPoses:(char)a1;
