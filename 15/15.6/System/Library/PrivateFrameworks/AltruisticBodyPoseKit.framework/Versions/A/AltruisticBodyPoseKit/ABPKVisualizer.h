...
- (int)generateStickFigureImageFrom:(SEL)a0 detectedBodies2d:(struct __CVBuffer { } *)a1 confidences:(id)a2 skeletonDefinition:(id)a3 overlayImage:(id)a4 color:(struct __CVBuffer { } *)a5 faceOnly:(char)a6;
- (BOOL)jointInImageDimensions:(SEL)a0 imageDimensions:(struct CGSize { double x0; double x1; })a1;
- (void)overlayJoints:(SEL)a0 withSkeletonDefinition:(id)a1 confidences:(id)a2 OnImage:(id)a3 color:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a4 faceOnly:(char)a5;
