...
- (char)overlayResult:(id)a0 OnImage:(struct __CVBuffer { } *)a1 andGenerateOverlayImage:(struct __CVBuffer { } *)a2;
- (char)overlayTrackedBodiesOnImage:(struct __CVBuffer { } *)a0 andGenerateOverlayImage:(struct __CVBuffer { } *)a1;
