@class NSMutableDictionary, NSData, NSObject, OPTTSStartTextToSpeechStreamingRequest;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TextToSpeechRouterStreamingStreamingRequest { unsigned char x0[1]; } *)a1 verify:(char)a2;
