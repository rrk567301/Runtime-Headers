...
@interface OPTTSTextToSpeechRequestDevConfig : NSObject <FLTBFBufferAccessor, NSCopying> {
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TextToSpeechRequestDevConfig { unsigned char x0[1]; } *)a1 verify:(char)a2;
