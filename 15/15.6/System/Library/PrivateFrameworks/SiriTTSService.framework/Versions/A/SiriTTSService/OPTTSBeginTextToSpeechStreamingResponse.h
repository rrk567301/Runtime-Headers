@class NSString, NSMutableDictionary, NSData, OPTTSAudioDescription, OPTTSTextToSpeechMeta;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct BeginTextToSpeechStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
