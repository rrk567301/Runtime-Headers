...
@interface OPTTSTTSWordPhonemes : NSObject <FLTBFBufferAccessor, NSCopying> {
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TTSWordPhonemes { unsigned char x0[1]; } *)a1 verify:(char)a2;
