...
+ (id)actionCandidateFeaturesFromActionEvent:(id)a0 actionMetadata:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3;
+ (id)actionDetailsFromActionCandidateId:(id)a0;
+ (id)anchorFeaturesForAnchorOccurrence:(id)a0 anchor:(id)a1 anchorMetadata:(id)a2;
+ (id)appCandidateFeaturesFromAppLaunchEvent:(id)a0 appMetadata:(id)a1 appWasLaunched:(char)a2 appEngaged:(char)a3;
...
+ (id)linkActionCandidateFeaturesFromLinkActionEvent:(id)a0 actionMetadata:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3;
+ (id)linkActionDetailsFromLinkActionCandidateId:(id)a0;
+ (id)modeCandidateFeaturesFromModeEvent:(id)a0 modeMetadata:(id)a1 modeOccurred:(char)a2 modeEngaged:(char)a3;
...
- (id)secondsAfterAnchorWhenCandidateOccurredForAnchor:(id)a0 candidateId:(id)a1 onlyConsiderFirstOccurrencePerAnchor:(char)a2;
...
- (void)updateOrInsertActionTrainingSample:(id)a0 featurizedAction:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
...
- (void)updateOrInsertAppTrainingSample:(id)a0 featurizedApp:(id)a1 appWasLaunched:(char)a2 appEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
- (void)updateOrInsertCandidateEventToDatabaseWithCandidateFeatures:(id)a0 anchor:(id)a1 anchorEvent:(id)a2;
- (void)updateOrInsertLinkActionTrainingSample:(id)a0 featurizedAction:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
- (void)updateOrInsertLocation:(id)a0;
- (void)updateOrInsertModeTrainingSample:(id)a0 featurizedMode:(id)a1 modeOccurred:(char)a2 modeEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
