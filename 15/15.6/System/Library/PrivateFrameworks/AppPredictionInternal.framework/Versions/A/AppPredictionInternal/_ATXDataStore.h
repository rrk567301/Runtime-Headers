...
+ (char)isSqliteData:(id)a0;
+ (id)loadDataFromFile:(id)a0;
+ (char)pareDownForBackup:(struct sqlite3 { } *)a0;
+ (id)removeSensitiveInformationFromModeEntityScoresFile:(id)a0 shouldBackupContacts:(char)a1;
...
- (id)_allAppsRequireInstallDate:(char)a0;
- (id)_appInfoForBundleIdNoSync:(id)a0;
- (struct _PASDBIterAction_ { char x0; })_deserializeActionLogRowWithStmt:(id)a0 invokingBlock:(id /* block */)a1;
...
- (void)_markBundleId:(id)a0 asEnterpriseApp:(char)a1;
...
- (char)_removeActionsWithoutTitle;
...
- (char)actionExistsForBundleId:(id)a0 actionType:(id)a1;
...
- (char)alogContainsActionUUID:(id)a0;
...
- (void)enumerateStateForApps:(id)a0 withGlobalBlock:(id /* block */)a1 thenWithPerAppBlock:(id /* block */)a2 readOnly:(char)a3;
- (void)enumerateStateForAppsReadOnly:(id)a0 withGlobalBlock:(id /* block */)a1 thenWithPerAppBlock:(id /* block */)a2;
- (id)filenamesAndDataForBackupShouldPareDown:(char)a0 transport:(unsigned long long)a1;
- (id)filenamesAndDataForBackupWithTransport:(unsigned long long)a0;
- (char)hasOrphanSlotSetKeys;
...
- (char)migrationUpdateOrInsertTimestamp:(long long)a0 intoColumn:(id)a1 forBundleId:(id)a2;
...
- (void)updateOrInsertInstallTimestamp:(long long)a0 genreId:(id)a1 subGenreIds:(id)a2 app2VecCluster:(id)a3 forBundleId:(id)a4 isExtension:(char)a5 isEnterpriseApp:(char)a6;
...
- (void)updateOrInsertPredictionsAndFeedbackForAppAction:(id)a0 feedbackReceived:(char)a1 forUIType:(id)a2;
...
- (void)updateOrInsertTimestamp:(long long)a0 intoColumn:(id)a1 forBundleId:(id)a2 isExtension:(char)a3;
...
- (void)writeEligibleForWidgets:(char)a0 cacheKey:(id)a1;
...
- (char)writeSlotSetKeyParameters:(id)a0 rowId:(id)a1 slotSet:(id)a2 success:(long long *)a3;
- (void)writeSubtitle:(id)a0 cacheKey:(id)a1;
- (void)writeSupportsBackgroundExecution:(char)a0 cacheKey:(id)a1;
