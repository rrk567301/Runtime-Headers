...
- (char)isWidgetFamilyEligibleForSuggestion;
- (char)overlapExistsBetween:(id)a0 andTimelineEntry:(id)a1;
...
- (char)startDatesAreCloseEnoughToMerge:(id)a0 withTimelineEntry:(id)a1;
