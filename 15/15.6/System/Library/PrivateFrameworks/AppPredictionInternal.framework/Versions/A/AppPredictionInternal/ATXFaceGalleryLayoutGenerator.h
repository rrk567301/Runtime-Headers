...
- (char)_complicationExistsOnSystem:(id)a0;
- (char)_descriptorIsEligibleForComplications:(id)a0;
...
- (char)_isFocusUser;
- (id)_itemFromDescriptor:(id)a0 shouldShowDisplayName:(char)a1 shouldShowComplications:(char)a2 systemSuggestedComplicationSet:(id)a3 systemSuggestedLandscapeComplicationSet:(id)a4;
- (id)_itemsFromDescriptors:(id)a0 widgetDescriptorsAdditionalData:(id)a1 aggregatedAppLaunchData:(id)a2 bundleIdToCompanionBundleId:(id)a3 shouldShowDisplayName:(char)a4 shouldShowComplications:(char)a5 limit:(id)a6;
...
- (id)initWithDescriptors:(id)a0 complicationProvider:(id)a1 complicationDescriptorProvider:(id)a2 parameters:(id)a3 dayZero:(char)a4 locale:(id)a5;
- (char)isDescriptor:(id)a0 availableInAssetParameter:(id)a1;
- (char)isDescriptorFromGalleryItem:(id)a0 availableInAssetParameter:(id)a1;
- (char)shouldAddDescriptorFromExtension:(id)a0 descriptorIdentifierInAsset:(id)a1 withSemanticType:(long long)a2 assetParametersToFilterOut:(id)a3;
- (char)shouldRemoveDescriptorFromFeatured:(id)a0 withDescriptorsToRemove:(id)a1;
