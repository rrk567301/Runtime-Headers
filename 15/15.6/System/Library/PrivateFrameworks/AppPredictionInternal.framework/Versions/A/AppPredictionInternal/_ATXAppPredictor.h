...
+ (id)inputScoresForPredictionItem:(const struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0;
...
+ (void)updateConfidenceForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 subscores:(id)a1;
...
- (void)_copyValidScoreInputsFromPredictionItem:(const struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 toPredictionItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a1;
...
- (char)_initAppLaunchAndInstallMonitors;
- (char)_initDependencies;
- (void)_initFeaturizers;
- (double)_predictionScoreAndUpdateConfidenceForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 interpreter:(id)a1 consumerSubType:(unsigned char)a2 scoreLogger:(id)a3 intentType:(id)a4;
...
- (char)predictAndWriteCacheFileWithLimit:(unsigned long long)a0 consumerSubType:(unsigned char)a1 intent:(id)a2 candidateBundleIdentifiers:(id)a3 candidateActiontypes:(id)a4 scoreLogger:(id)a5 path:(id)a6 cacheFileDescriptors:(id)a7 featureCache:(id)a8;
...
- (double)predictionScoreAndUpdateConfidenceForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 consumerSubType:(unsigned char)a1;
...
- (char)writeCacheFileWithSerializedChunks:(id)a0 path:(id)a1 cacheFileDescriptors:(id)a2 consumerSubType:(unsigned char)a3;
