...
- (char)sessionLoggingGymDistanceEnable;
...
- (char)allowBehavioralPredictionsOnLockscreen;
...
- (char)disableLocationQualityChecksForHeroApp;
...
- (char)sessionLoggingCurrentLOITypeEnable;
- (double)sessionLoggingDistanceAccuracy;
- (char)sessionLoggingHomeDistanceEnable;
- (char)sessionLoggingSchoolDistanceEnable;
- (int)sessionLoggingUniqueAppActionSequenceLength;
- (char)sessionLoggingWorkDistanceEnable;
...
- (char)useOriginalScreenLockStateStream;
