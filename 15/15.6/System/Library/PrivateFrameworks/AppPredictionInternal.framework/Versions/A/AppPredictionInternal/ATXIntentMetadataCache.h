...
- (void)_setEligibleForWidgets:(char)a0 intent:(id)a1;
- (void)_setSubtitle:(id)a0 cacheKey:(id)a1;
- (void)_setSupportsBackgroundExecution:(char)a0 intent:(id)a1;
- (void)_setTitle:(id)a0 cacheKey:(id)a1;
- (void)applicationsDidUpdate:(id)a0;
- (id)initWithDataStore:(id)a0 cacheInvalidationCriteria:(id)a1 startMonitoring:(char)a2;
- (char)isEligibleForWidgetsForIntent:(id)a0;
- (void)setValidParameterCombinationsWithSchema:(id)a0 intent:(id)a1;
- (id)subtitleForIntent:(id)a0 localeIdentifier:(id)a1;
- (char)supportsBackgroundExecutionForIntent:(id)a0;
