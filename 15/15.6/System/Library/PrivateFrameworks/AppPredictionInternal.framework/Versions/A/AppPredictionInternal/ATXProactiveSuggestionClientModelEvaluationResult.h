...
@property (readonly, nonatomic) char removeDockedApps;
...
- (id)description;
- (void).cxx_destruct;
- (id)filteredSuggestions:(id)a0 removeDockedApps:(char)a1;
- (id)initWithSessionType:(unsigned long long)a0 executableType:(long long)a1 removeDockedApps:(char)a2;
