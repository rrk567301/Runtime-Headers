...
- (id)initWithTrackedProactiveSuggestion:(id)a0 feedbackMetadata:(id)a1 matchingSuggestionUUIDs:(id)a2 associatedBlendingCacheUUIDs:(id)a3 associatedClientModelCacheUUIDs:(id)a4 sessionContextStatuses:(id)a5 sessionExpirationDate:(id)a6 completed:(char)a7;
- (char)isEqualToATXSingleSuggestionSession:(id)a0;
- (char)tryUpdateSessionStatus:(unsigned long long)a0 consumerSubType:(unsigned char)a1;
