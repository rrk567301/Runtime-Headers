...
- (char)_currentActivePredictionsContainSuggestionFromSourceId:(id)a0 guardedData:(id)a1;
...
- (char)_shouldSkipRefreshForOldSuggestions:(id)a0 newSuggestions:(id)a1;
...
- (void)handleProactiveStackRotationForInfoSuggestion:(id)a0 isStalenessRotation:(char)a1;
- (void)handleSuggestionDismissal:(id)a0 isDismissalLongTerm:(char)a1 completion:(id /* block */)a2;
...
- (char)shouldSkipUpdatingPredictionRefreshDateForPreviouslyScheduledDate:(id)a0 newDate:(id)a1;
