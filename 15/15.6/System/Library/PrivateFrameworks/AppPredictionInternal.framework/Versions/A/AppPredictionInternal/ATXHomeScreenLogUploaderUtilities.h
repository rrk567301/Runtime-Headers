...
+ (id)abGroup;
+ (char)_isDwellLongEnoughForPseudoTap:(id)a0 endingEventTime:(double)a1;
...
+ (char)isRotationSessionDueToProactive:(id)a0;
+ (char)isRotationSessionDueToUserScroll:(id)a0;
+ (char)isValidAppLaunch:(id)a0;
