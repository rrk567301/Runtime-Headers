...
- (void)_updateWidgetAddSheetDictionariesForDescriptor:(id)a0 inStack:(char)a1 rank:(unsigned long long)a2;
- (void)_updateWidgetAddSheetDictionariesForStack:(id)a0 suggestedSize:(unsigned long long)a1;
- (void)_updateWidgetAddSheetDictionariesWithDictionary:(id)a0 suggestedSize:(unsigned long long)a1 inStack:(char)a2 rank:(unsigned long long)a3;
