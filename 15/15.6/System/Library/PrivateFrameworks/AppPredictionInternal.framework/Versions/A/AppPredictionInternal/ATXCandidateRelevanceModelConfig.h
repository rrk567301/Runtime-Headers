...
- (void).cxx_destruct;
- (char)isEnabled;
- (char)candidateIsStillValidToSuggest:(id)a0;
...
- (char)shouldTrainModelWithCandidateDatasetMetadata:(id)a0;
- (char)shouldTrainModelWithOverallDatasetMetadata:(id)a0;
- (char)shouldTrainModelWithPositiveCandidateDatasetMetadata:(id)a0;
