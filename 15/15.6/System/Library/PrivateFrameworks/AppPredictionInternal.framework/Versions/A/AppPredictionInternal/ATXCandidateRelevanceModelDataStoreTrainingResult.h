...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithModel:(id)a0 candidate:(id)a1 featurizationManager:(id)a2 modelUUID:(id)a3 datasetMetadata:(id)a4 clientModelName:(id)a5 trainDate:(id)a6 isVerified:(char)a7;
- (char)isEqualToATXCandidateRelevanceModelDataStoreTrainingResult:(id)a0;
