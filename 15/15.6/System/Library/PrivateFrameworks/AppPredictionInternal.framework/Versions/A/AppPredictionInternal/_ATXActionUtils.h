...
+ (char)isActionKey:(id)a0;
+ (char)isCallIntentEquivalenceBetweenAction:(id)a0 other:(id)a1;
+ (char)isContainmentBetweenAction:(id)a0 other:(id)a1;
+ (char)isINStartCallIntentSupportedForAction:(id)a0;
+ (char)isNSUAType:(id)a0;
+ (char)isTitleEquivalenceBetweenAction:(id)a0 other:(id)a1;
...
+ (id)sha256hex:(id)a0;
+ (char)shouldAcceptAudioOrVideoCallIntent:(id)a0;
+ (char)shouldAcceptMessageContent:(id)a0;
+ (char)shouldPredictRecipient:(id)a0 withDate:(id)a1 andRecipientDate:(id)a2;
...
+ (char)uniqueRecipientsMatchedBetweenIntent:(id)a0 andIntent:(id)a1;
