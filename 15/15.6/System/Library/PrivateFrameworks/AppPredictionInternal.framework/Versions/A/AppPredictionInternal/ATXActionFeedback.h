...
- (void)receiveLockscreenFeedbackWithAction:(id)a0 actionResponse:(id)a1 engagement:(char)a2 triggeredByUserInteraction:(char)a3;
- (void)receiveLockscreenFeedbackWithAction:(id)a0 actionResponse:(id)a1 engagement:(char)a2 triggeredByUserInteraction:(char)a3 currentDate:(id)a4;
