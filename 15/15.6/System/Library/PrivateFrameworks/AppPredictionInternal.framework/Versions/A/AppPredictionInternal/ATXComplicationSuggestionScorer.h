...
- (char)_isNewlyInstalledWidget:(id)a0 additionalData:(id)a1;
- (char)_modularSetIsSuggestibleGivenAppScoreDictionary:(id)a0;
...
- (id)scoredComplicationDescriptorsForModularSetGivenComplicationDescriptors:(id)a0 widgetDescriptorsAdditionalData:(id)a1 aggregatedAppLaunchData:(id)a2 bundleIdToCompanionBundleId:(id)a3 checkEligibility:(char)a4;
