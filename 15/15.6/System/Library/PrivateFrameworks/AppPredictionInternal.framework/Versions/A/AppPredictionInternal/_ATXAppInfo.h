...
@property (nonatomic) char isEnterpriseApp;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithBundleId:(id)a0 isExtension:(char)a1 isEnterpriseApp:(char)a2 installDate:(id)a3 lastLaunch:(id)a4 lastSpotlightLaunch:(id)a5 averageSecondsBetweenLaunches:(id)a6 medianSecondsBetweenLaunches:(id)a7 genreId:(id)a8 subGenreIds:(id)a9 app2VecCluster:(id)a10;
