...
- (char)entityOccurredGloballyOverLastNDays:(unsigned long long)a0;
- (char)entityOccurredInModeOverLastNDays:(unsigned long long)a0;
- (char)entityOccurredOverLastNDays:(unsigned long long)a0 withHistogram:(id)a1;
