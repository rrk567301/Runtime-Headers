...
- (void)shouldPredictBundleIdForShortcuts:(id)a0 action:(id)a1 forPrimaryShortcuts:(char)a2 reply:(id /* block */)a3;
- (void)sortAppsByLaunches:(id)a0 reply:(id /* block */)a1;
- (id)consumerSubTypesToUpdateWithRefreshRate:(double)a0 disabledConsumerSubTypes:(id)a1 shouldOverrideRefreshRateForDisabledConsumerSubTypes:(char)a2;
...
- (char)syncGenerateNewAppPredictionsForConsumerSubType:(unsigned char)a0 intent:(id)a1 candidateBundleIdentifiers:(id)a2 candidateIntentTypeIdentifiers:(id)a3 featureCache:(id)a4;
- (char)updateAppPredictionsWithConsumerSubTypes:(id)a0 featureCache:(id)a1;
