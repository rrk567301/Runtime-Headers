...
+ (char)actionScoreAboveThresholdOrWhitelistedAction:(id)a0 confidenceThreshold:(double)a1 actionKeyWhitelist:(id)a2 actionTypeWhitelist:(id)a3;
...
+ (char)isActionPredictionContainerEligibleForLimit:(id)a0;
