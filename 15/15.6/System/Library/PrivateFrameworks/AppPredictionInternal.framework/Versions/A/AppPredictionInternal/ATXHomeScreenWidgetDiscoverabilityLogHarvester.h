@class NSArray, ATXTimelineRelevanceAdoption, NSSet, NSMutableDictionary, NSDictionary, NSMutableArray, BMStream, NSUserDefaults;
...
- (char)_isRegularlyUsedApp:(id)a0;
...
- (char)_shouldConsiderWidgetWhenCalculatingRankBasedMetricsWithFamilyMask:(unsigned long long)a0;
