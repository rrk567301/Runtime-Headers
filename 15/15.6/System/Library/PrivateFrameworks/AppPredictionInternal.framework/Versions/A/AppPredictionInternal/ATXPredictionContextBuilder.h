...
- (id)init;
- (void).cxx_destruct;
- (id)_getContextForOverrideKey:(id)a0 fromContextOverride:(id)a1 withDefaultContext:(id)a2 allowNilValues:(char)a3;
...
- (id)initWithAppInfoManager:(id)a0 locationManager:(id)a1 motionManagerWrapper:(id)a2 ambientLightMonitor:(id)a3 deviceStateMonitorClass:(Class)a4 contextSourcesInitialized:(char)a5;
- (id)initWithAppInfoManager:(id)a0 locationManager:(id)a1 motionManagerWrapper:(id)a2 ambientLightMonitor:(id)a3 deviceStateMonitorClass:(Class)a4 contextSourcesInitialized:(char)a5 contextStream:(id)a6 biomeStreamsInitialized:(char)a7;
...
- (char)tryInitBiomeStreamsAndReturnSuccess:(id)a0;
- (char)tryInitContextSourcesAndReturnSuccess:(id)a0;
