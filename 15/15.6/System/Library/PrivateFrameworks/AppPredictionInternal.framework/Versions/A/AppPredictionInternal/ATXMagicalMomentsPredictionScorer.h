...
- (char)subExpertCanMakeHighConfidencePredictions;
- (char)subExpertCanMakeHighConfidencePredictionsForBundleId:(id)a0;
- (char)subExpertHasObservedEnoughLaunchesForMultipleAppsToMakePredictions;
- (char)subExpertHasObservedEnoughLaunchesForOneAppToMakePredictions;
- (char)subExpertHasWitnessedEnoughRelevantAppLaunches;
