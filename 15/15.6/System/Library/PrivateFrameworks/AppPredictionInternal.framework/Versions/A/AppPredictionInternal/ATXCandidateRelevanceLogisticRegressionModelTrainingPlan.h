...
- (id)initWithIntercept:(char)a0 learningRate:(float)a1 minIterations:(unsigned long long)a2 stoppingThreshold:(float)a3 regularizationStrategy:(unsigned long long)a4 regularizationRate:(float)a5 regularizationL1Ratio:(float)a6 weightTruncationThreshold:(float)a7;
- (char)isEqualToATXCandidateRelevanceLogisticRegressionModelTrainingPlan:(id)a0;
