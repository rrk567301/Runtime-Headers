...
- (id)_key:(id)a0 byAppendingStringIndicatingIfWidgetWasAdded:(char)a1;
- (id)_pickIndexForNegativeExampleFromGalleryItems;
- (void)_populateFeaturesForNegativeExample;
- (void)_populateHomeScreenConfigFeaturesForWidgetBundleId:(id)a0 widgetKind:(id)a1 parentAppBundleId:(id)a2 widgetWasAdded:(char)a3;
- (void)_populateParentAppFeaturesForParentAppBundleId:(id)a0 widgetWasAdded:(char)a1;
