...
+ (char)isConversionOutcome:(unsigned long long)a0;
...
+ (void)yesWithProbabilityAlwaysSays:(char)a0;
...
- (void)logLaunchEventWithLaunchReason:(id)a0 predicted:(char)a1 position:(long long)a2;
- (void)logNotificationInteraction:(long long)a0 orbed:(char)a1 onscreen:(char)a2;
