...
- (void)clearDigestFeedbackHistogramWithShouldResetBookmarks:(char)a0 reply:(id /* block */)a1;
...
- (void)dumpNotificationJSONFromSource:(id)a0 startDate:(id)a1 endDate:(id)a2 inferMessages:(char)a3 reply:(id /* block */)a4;
...
- (void)generateSerializedAppGroupedNotificationDigestFromSource:(id)a0 digestTimeString:(id)a1 startDate:(id)a2 endDate:(id)a3 inferMessages:(char)a4 reply:(id /* block */)a5;
- (void)generateSerializedMissedNotificationBundleFromFileData:(id)a0 modeString:(id)a1 reply:(id /* block */)a2;
- (void)generateSerializedMissedNotificationBundleFromSource:(id)a0 modeString:(id)a1 startDate:(id)a2 endDate:(id)a3 inferMessages:(char)a4 reply:(id /* block */)a5;
- (void)generateSerializedNotificationDigestFromFileData:(id)a0 digestTimeString:(id)a1 reply:(id /* block */)a2;
- (void)generateSerializedNotificationDigestFromSource:(id)a0 digestTimeString:(id)a1 startDate:(id)a2 endDate:(id)a3 inferMessages:(char)a4 reply:(id /* block */)a5;
...
- (void)trainModeEntityModelsWithDeferTrainingWhenApplicable:(char)a0 reply:(id /* block */)a1;
