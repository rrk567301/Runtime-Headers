...
@interface ATXActionToWidgetConverter : NSObject {
    ...
    char _allowsSendMessageIntentConversion;
}

+ (char)isWidgetIntent:(id)a0 validConversionFromActionIntent:(id)a1;
...
- (id)initWithAllowsSendMessageIntentConversion:(char)a0;
- (id)initWithIntentMetadataCache:(id)a0 widgetDescriptorCache:(id)a1 infoConfidenceMapper:(id)a2 engagementRecordManager:(id)a3 metadataProvider:(id)a4 allowsSendMessageIntentConversion:(char)a5;
