...
- (char)randomizationDisabledForWidgetWithIdentifier:(id)a0 kind:(id)a1;
- (long long)resolvedValueForConfigWithKey:(id)a0 forWidgetWithIdentifier:(id)a1 kind:(id)a2;
- (char)shouldUsePersonalizedBudgets;
- (long long)softRotationQuotaForWidgetWithIdentifier:(id)a0 kind:(id)a1;
- (char)stalenessDisabledForWidgetWithIdentifier:(id)a0 kind:(id)a1;
