...
+ (char)_predictNextAppLaunchEmbedding:(id)a0 into:(float *)a1 launchSequence:(id)a2;
...
- (void)setDistributionBasedScoreInputsForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 withGeoHashResolution:(unsigned long long)a1 withGeoHashLaunchCounts:(id)a2;
- (void)setDistributionBasedScoreInputsForTimeAndDay:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 forBundleId:(id)a1 withTimeOfDayHistogram:(id)a2 withDayOfWeekHistogram:(id)a3;
- (void)setModeAffinityScores:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0 appModeEntityScores:(id)a1;
- (void)setZeroValuesForModeEntityFeatures:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[817]; float x3; char x4; char x5; } *)a0;
