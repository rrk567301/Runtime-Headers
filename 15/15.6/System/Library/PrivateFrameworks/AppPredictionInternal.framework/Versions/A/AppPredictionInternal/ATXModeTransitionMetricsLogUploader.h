@class BMStream, ATXDNDModeConfigurationClient, NSDictionary;
...
- (char)_previousModeEndEvent:(id)a0 isContiguousWithModeStartEvent:(id)a1;
- (id)_timeBasedMergedPublisher;
- (id)initWithComputedModeStream:(id)a0 inferredModeStream:(id)a1;
