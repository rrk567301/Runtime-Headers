...
- (char)_complicationIsAlreadyAdded:(id)a0 alreadyAddedComplications:(id)a1;
...
- (id)_inlineSetDescriptors_ShouldRefresh:(char)a0;
- (id)_landscapeModularFallbackSets;
- (id)_landscapeModularSetDescriptors_ShouldRefresh:(char)a0 widgetDescriptorsAdditionalData:(id)a1 aggregatedAppLaunchData:(id)a2 bundleIdToCompanionBundleId:(id)a3;
- (char)_layoutIsValidGivenComplications:(id)a0 allowedComplicationPersonalities:(id)a1;
- (long long)_layoutTypeForSet:(id)a0;
- (id)_modularDescriptors_ShouldRefresh:(char)a0 widgetDescriptorsAdditionalData:(id)a1 aggregatedAppLaunchData:(id)a2 bundleIdToCompanionBundleId:(id)a3;
...
- (char)_shouldAddComplication:(id)a0 andFilterFromAppsDisabledByAppProtection:(id)a1;
