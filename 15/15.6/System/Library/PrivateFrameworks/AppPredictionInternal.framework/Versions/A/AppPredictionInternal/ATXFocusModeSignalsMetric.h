...
@property (nonatomic) char wasAppSuggestedDuringModeSetup;
@property (nonatomic) char wasAppSuggestionDuringModeSetupAccepted;
...
@property (nonatomic) char entityOccurredGloballyOverLastNDays;
@property (nonatomic) char entityOccurredInModeOverLastNDays;
...
@property (nonatomic) char isAppCandidateSuggestion;
@property (nonatomic) char isAppRecommendedSuggestion;
