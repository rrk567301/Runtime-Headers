...
@property (class, readonly, nonatomic) char isExpertEnabledForPredictions;
...
+ (char)shouldHandleTriggerEventWithRateLimiter:(id)a0;
+ (char)shouldPredicateOnStartDateForTrigger;
