...
@property (nonatomic) char hasSuggestionsWidget;
@property (nonatomic) char hasSuggestionsWidgetInTodayPage;
@property (nonatomic) char hasAppPredictionPanel;
@property (nonatomic) char hasAppPredictionPanelInTodayPage;
...
- (char)_widgetBundleIdIsSuggestionsWidget:(id)a0;
- (void)finalizeWithSessionEndDate:(id)a0;
- (char)isEqualToATXScreenLogUnlockSession:(id)a0;
