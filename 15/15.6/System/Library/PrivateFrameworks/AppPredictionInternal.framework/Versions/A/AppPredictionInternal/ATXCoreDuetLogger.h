...
- (void).cxx_destruct;
- (id)abGroup;
- (char)actionTypeIsActivity:(id)a0;
...
- (void)logDonationCountWithAlogEventCount:(unsigned long long)a0 forIntents:(char)a1;
- (void)logDonationRatioWithDuetEventCount:(unsigned long long)a0 alogEventCount:(unsigned long long)a1 forIntents:(char)a2;
