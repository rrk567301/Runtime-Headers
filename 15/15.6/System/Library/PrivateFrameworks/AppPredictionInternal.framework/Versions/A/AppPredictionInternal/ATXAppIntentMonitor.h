...
- (void)_handleDonationImmediatelyForBundleId:(id)a0 sourceItemID:(id)a1 completedSuccessfully:(char)a2 isDonatedBySiri:(char)a3 isAllowedDaemonDonationBundleId:(char)a4;
- (char)_isAllowedDaemonDonationBundleId:(id)a0;
...
- (char)sessionStartedBeforeDonationForStartDate:(id)a0 latestDonationDate:(id)a1;
- (void)setDeletionHighWaterMark:(id)a0 defaultsKey:(id)a1;
- (char)shouldAcceptMessageDonation:(id)a0;
- (char)shouldProcessIntentDonationsForSessionStartDate:(id)a0;
- (char)shouldProcessNSUADonationsForSessionStartDate:(id)a0;
