...
@property (nonatomic) char hasLocationEnabled;
@property (nonatomic) char locationEnabled;
@property (nonatomic) char hasDistanceFromHome;
@property (nonatomic) double distanceFromHome;
@property (nonatomic) char hasDistanceFromWork;
@property (nonatomic) double distanceFromWork;
@property (nonatomic) char hasDistanceFromSchool;
@property (nonatomic) double distanceFromSchool;
@property (nonatomic) char hasDistanceFromGym;
@property (nonatomic) double distanceFromGym;
@property (nonatomic) char hasCanPredictClipsGivenRecentMotion;
@property (nonatomic) char canPredictClipsGivenRecentMotion;
@property (nonatomic) char hasGeohash;
@property (nonatomic) unsigned long long geohash;
@property (nonatomic) char hasCoarseGeohash;
@property (nonatomic) unsigned long long coarseGeohash;
@property (nonatomic) char hasLargeGeohash;
