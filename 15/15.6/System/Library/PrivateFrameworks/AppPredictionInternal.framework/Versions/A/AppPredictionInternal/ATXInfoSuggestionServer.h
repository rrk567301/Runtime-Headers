...
- (void)_addSuggestions:(id)a0 forSourceIdentifier:(id)a1 needReset:(char)a2 errorHandler:(id /* block */)a3;
...
- (void)userDidDismissSuggestion:(id)a0 isDismissalLongTerm:(char)a1 completion:(id /* block */)a2;
