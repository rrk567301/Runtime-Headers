@class ATXSuggestedPagesWidgetAggregator, NSSet, NSDictionary, ATXSuggestedPagesAppAggregator, ATXWidgetDescriptorCache, ATXSuggestedPagesTunableConstants;
...
- (id)initWithWidgetAggregator:(id)a0 appAggregator:(id)a1 descriptorCache:(id)a2;
