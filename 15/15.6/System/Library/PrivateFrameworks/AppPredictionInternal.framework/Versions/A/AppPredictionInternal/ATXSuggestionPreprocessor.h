...
- (char)_bundleSupportsINPlayMediaIntentForBundleId:(id)a0 fromUnitTest:(char)a1;
...
- (char)shouldFilterOutSuggestion:(id)a0 withBundleId:(id)a1 fromAppsThatCannotBeSuggested:(id)a2 fromAppsWhoseContentsCannotBeSuggested:(id)a3;
