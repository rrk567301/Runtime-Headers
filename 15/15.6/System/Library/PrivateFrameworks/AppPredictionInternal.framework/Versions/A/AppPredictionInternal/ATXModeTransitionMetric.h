...
@property (nonatomic) char previousModeHadScheduledExit;
...
@property (nonatomic) char appBasedSchedulingEnabled;
@property (nonatomic) char timeBasedSchedulingEnabled;
@property (nonatomic) char locationBasedSchedulingEnabled;
@property (nonatomic) char smartActivationEnabled;

- (id)description;
- (void).cxx_destruct;
- (id)metricName;
- (id)coreAnalyticsDictionary;
- (id)initWithPreviousModeSemanticType:(id)a0 previousModeDuration:(double)a1 previousModeHadScheduledExit:(char)a2 exitReason:(id)a3 enterReason:(id)a4 transitionDeviceType:(id)a5 transitionSource:(id)a6 nextModeSemanticType:(id)a7;
