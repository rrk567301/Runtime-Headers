...
- (long long)addFeaturizedActionToDatabase:(id)a0 featurizedAction:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
- (long long)addFeaturizedAppToDatabase:(id)a0 featurizedApp:(id)a1 appWasLaunched:(char)a2 appEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
- (long long)addFeaturizedLinkActionToDatabase:(id)a0 featurizedAction:(id)a1 actionOccurred:(char)a2 actionEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
- (long long)addFeaturizedModeToDatabase:(id)a0 featurizedMode:(id)a1 modeOccurred:(char)a2 modeEngaged:(char)a3 anchorEvent:(id)a4 anchor:(id)a5;
...
- (char)anchorOccurredLongEnoughAgo:(id)a0 anchor:(id)a1;
...
- (char)shouldCreateTrainingSamplesForAnchorEvent:(id)a0 anchor:(id)a1;
