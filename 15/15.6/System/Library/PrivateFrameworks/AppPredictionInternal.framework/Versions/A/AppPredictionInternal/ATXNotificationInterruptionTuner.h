...
- (char)appWithBundleId:(id)a0 isRecommendedByAllowListModel:(id)a1;
- (char)appWithBundleId:(id)a0 isRecommendedByDenyListModel:(id)a1;
- (char)contactWithIdentifier:(id)a0 isRecommendedByAllowListModel:(id)a1;
- (char)contactWithIdentifier:(id)a0 isRecommendedByDenyListModel:(id)a1;
...
- (char)validateNotificationUrgency:(id)a0;
