...
- (id)initWithDeviceStateContext:(id)a0 timeContext:(id)a1 locationMotionContext:(id)a2 ambientLightContext:(id)a3 userContext:(id)a4 isOverridden:(char)a5;
- (char)isEqualToATXPredictionContext:(id)a0;
