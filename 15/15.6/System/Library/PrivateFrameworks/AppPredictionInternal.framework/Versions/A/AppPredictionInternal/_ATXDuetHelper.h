...
- (void)_enumerateBatchesInDuetStream:(id)a0 creationDateStart:(id)a1 creationDateEnd:(id)a2 otherPredicates:(id)a3 limit:(unsigned long long)a4 ascending:(char)a5 block:(id /* block */)a6;
- (void)_enumerateBatchesInDuetStream:(id)a0 creationDateStart:(id)a1 creationDateEnd:(id)a2 otherPredicates:(id)a3 limit:(unsigned long long)a4 batchSize:(unsigned long long)a5 ascending:(char)a6 block:(id /* block */)a7;
- (void)_enumerateBatchesInDuetStream:(id)a0 startDate:(id)a1 endDate:(id)a2 otherPredicates:(id)a3 limit:(unsigned long long)a4 ascending:(char)a5 block:(id /* block */)a6;
- (void)_enumerateBatchesInDuetStream:(id)a0 startDate:(id)a1 endDate:(id)a2 otherPredicates:(id)a3 limit:(unsigned long long)a4 batchSize:(unsigned long long)a5 ascending:(char)a6 block:(id /* block */)a7;
- (void)_handleTombstoneCreationWithNotification:(id)a0;
- (id)_queryDuetStreamUnbatched:(id)a0 creationDateStart:(id)a1 creationDateEnd:(id)a2 ascending:(char)a3 otherPredicates:(id)a4 limit:(unsigned long long)a5 offset:(unsigned long long)a6;
- (id)_queryDuetStreamUnbatched:(id)a0 startDate:(id)a1 endDate:(id)a2 ascending:(char)a3 otherPredicates:(id)a4 limit:(unsigned long long)a5 offset:(unsigned long long)a6;
