...
@interface ATXAppDirectoryOrderingProvider : NSObject {
    ...
    char _currentCacheDueForRefresh;
}
...
- (id)_groupEnterpriseAppsByIssuerWithBundleIDs:(id)a0 isMDM:(char)a1;
- (id)_issuingOrganizationForEnterpriseAppBundleID:(id)a0 isMDM:(char)a1;
...
- (char)_readCategoriesFromDisk;
- (void)_reorderAndHideDupesForAppsInCategory:(id)a0;
- (id)_reorderedHiddenApps:(id)a0;
- (id)_screenTimeIdFromBundleId:(id)a0;
- (char)_shiftAppIndices:(id)a0 category:(id)a1;
- (char)_shouldConsiderAppForRecents:(id)a0;
- (char)_shouldInvalidateCachedCategoriesForDemoMode;
- (id)_sortCategories:(id)a0;
- (void)_splitEnterpriseCategoryWithAppsInCategory:(id)a0 appsByCategoryName:(id)a1 isMDMAppCategory:(char)a2;
...
- (void)_updateCategoriesForRemovedApps:(id)a0 uninstalled:(char)a1 hidden:(char)a2;
...
- (char)_writeCategoriesToDisk;
- (char)_writeHiddenAppsToDisk:(id)a0;
- (char)_writeRecentsToDisk;
- (char)_writeToDisk:(id)a0 cache:(id)a1 logIdentifier:(id)a2;
