...
- (char)appLaunchEventOccurredWhileInMode:(id)a0 modeTransitionEvent:(id)a1;
...
- (char)notificationEventOccurredWhileInMode:(id)a0 modeTransitionEvent:(id)a1;
- (double)ratioOfModePopularityToGlobalPopularityOfInterruptingEntity:(id)a0;
- (char)successfullyCalculatedAppSessionInterruptions;
