...
- (char)_allRequiredActionTypesPresent:(id)a0 minOccurrences:(unsigned long long)a1 forContext:(id)a2;
- (char)_enoughActionHistory;
...
- (char)shouldDisplayDailyRoutineForContext:(id)a0;
