...
+ (id)partOfWeekPredicatesUsingStartDate:(char)a0;
+ (id)timeOfDayPredicatesWithRequestedDurationInHours:(unsigned long long)a0 shouldPredicateOnStartDate:(char)a1;
