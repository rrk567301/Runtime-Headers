...
- (id)initWithTitle:(id)a0 description:(id)a1 image:(id)a2 imageTintColor:(id)a3 spacing:(long long)a4 showsBackground:(char)a5;
- (id)initWithTitle:(id)a0 description:(id)a1 image:(id)a2 imageTintColor:(id)a3 spacing:(long long)a4 status:(id)a5 showsBackground:(char)a6;
- (id)initWithTitle:(id)a0 description:(id)a1 symbol:(id)a2 symbolTintColor:(id)a3 spacing:(long long)a4 showsBackground:(char)a5;
- (id)initWithTitle:(id)a0 description:(id)a1 symbol:(id)a2 symbolTintColor:(id)a3 spacing:(long long)a4 status:(id)a5 showsBackground:(char)a6;
