...
@property char needsExtraWideContent;
@property char linkButtonGoesAboveContent;
...
- (void)setPrivacyLinkHidden:(char)a0;
- (void)setTopImageHidden:(char)a0;
- (void)_addImageView;
...
- (id)initLargeContentTemplateWithTitle:(id)a0 contentArea:(id)a1 needsBodyText:(char)a2;
