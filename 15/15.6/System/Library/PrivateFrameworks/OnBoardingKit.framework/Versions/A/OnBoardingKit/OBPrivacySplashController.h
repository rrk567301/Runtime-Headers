...
@property char showPIIIcon;
@property char suppressPerPageAnalyticsLogging;
@property char allowsOpeningSafari;
@property (nonatomic) char showLinkToPrivacyGateway;
@property char showsLinkToUnifiedAbout;
@property char forceLargeMargins;
@property (retain) NSString *displayLanguage;
@property unsigned long long displayDeviceType;
@property char useModalStyle;
