...
- (void)_initializeStartingStateForStopAnimation:(char)a0;
- (void)_startAnimationForLayer:(id)a0;
- (void)_stepAnimationStatesForLayer:(id)a0;
- (id)initWithUrlToPackage:(id)a0 animatedStates:(id)a1 startAtFirstState:(id)a2;
...
- (id)initWithUrlToPackage:(id)a0 sizingTransformScale:(double)a1 animatedStates:(id)a2 startAtFirstState:(id)a3;
