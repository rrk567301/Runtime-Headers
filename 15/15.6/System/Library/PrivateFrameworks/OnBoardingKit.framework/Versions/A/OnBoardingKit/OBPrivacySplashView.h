...
@property (nonatomic) char isCombined;

- (void).cxx_destruct;
- (void)addIcon:(id)a0;
- (void)addLabel:(id)a0;
- (void)addTitle:(id)a0 contentList:(id)a1 separator:(char)a2;
- (void)addContentList:(id)a0;
- (void)addGenericPrivacyHeading;
- (void)addLabel:(id)a0 toStackView:(id)a1;
- (void)addLabel:(id)a0 toStackView:(id)a1 centered:(char)a2;
...
- (id)attributedContentStringWithString:(id)a0 centered:(char)a1;
...
- (id)initWithContentList:(id)a0 allowsOpeningSafari:(char)a1;
