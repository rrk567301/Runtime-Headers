...
+ (id)sharedInstance;
+ (char)bluetoothPairedForProductID:(unsigned int)a0 minimumVersion:(id)a1 withPairedDevices:(id)a2;
+ (char)bluetoothPairedForProductID:(unsigned int)a0 withPairedDevices:(id)a1;
...
+ (char)bluetoothPairedWithTag:(id)a0 withPairedPeers:(id)a1;

- (id)init;
- (void).cxx_destruct;
- (char)bluetoothPairedForProductID:(unsigned int)a0;
- (char)bluetoothPairedForProductID:(unsigned int)a0 minimumVersion:(id)a1;
- (char)bluetoothPairedWithTag:(id)a0;
