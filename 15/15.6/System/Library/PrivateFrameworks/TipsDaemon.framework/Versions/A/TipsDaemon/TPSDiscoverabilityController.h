...
- (char)_isConditionMet:(id)a0 hasUpdates:(char *)a1 forIdentifier:(id)a2;
- (id)_matchingIdentifiersForConditionWithType:(unsigned long long)a0 forObserverIdentifiers:(id)a1 hasUpdates:(char *)a2;
- (void)_removeCacheData;
- (void)_updateCacheData;
- (void)_updateContextualInfoMapCache;
- (char)_updateTriggerConditionForObserverIdentifiers:(id)a0;
- (void)contextualEligibilityWithTipIdentifiers:(id)a0 tipsDeliveryInfoMap:(id)a1 deliveryInfoMap:(id)a2 experimentCampChangesToAll:(char)a3;
- (id)contextualInfoForIdentifier:(id)a0;
- (id)contextualInfoIdentifiers;
- (id)contextualInfoMap;
- (id)initWithTipStatusController:(id)a0;
- (char)isContextualInfoExistForIdentifier:(id)a0;
...
- (void)restartTriggerTrackingIfNotDisplayedForIdentifier:(id)a0 updateCache:(char)a1;
- (void)restartTriggerTrackingIfNotDisplayedForIdentifiers:(id)a0;
- (void)updateContentViewedForIdentifier:(id)a0;
- (char)updateDesiredOutcomeConditionForObserverIdentifiers:(id)a0;
