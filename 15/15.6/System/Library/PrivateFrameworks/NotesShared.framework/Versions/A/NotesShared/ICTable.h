@class ICCRTTCompatibleDocument, NSMutableDictionary, ICTableCellChangeNotifier, NSObject;
...
- (char)columnIsEmptyAtIndex:(unsigned long long)a0;
- (id)copyIntoNewDocumentWithReplicaID:(id)a0;
- (id)defaultContentAtColumn:(id)a0 row:(id)a1;
- (char)isEmptyAtColumnIdentifiers:(id)a0 rowIdentifiers:(id)a1;
- (char)isEmptyAtColumnIndexes:(id)a0 rowIndexes:(id)a1;
- (id)mergeableStringForColumnID:(id)a0 rowID:(id)a1;
- (char)rowIsEmptyAtIndex:(unsigned long long)a0;
