@class NSHashTable, NSString, ICCRTTCompatibleDocument, ICTTVectorMultiTimestamp, NSUUID, NSMutableAttributedString, NSObject;
...
- (void)checkTimestampLogStyleErrors:(char)a0;
...
- (void)generateIdsForLocalChangesSafeForSharedTimestamp:(char)a0;
...
- (id)initWithReplicaID:(id)a0 asFragment:(char)a1;
...
- (unsigned long long)mergeWithString:(id)a0 mergeTimestamps:(char)a1;
...
- (char)selection:(id)a0 wasModifiedAfter:(id)a1;
...
- (char)textEitherSideOfSelectionAnchor:(struct TopoID { id x0; unsigned int x1; })a0 wasModifiedAfter:(id)a1;
...
- (void)enumerateHighlightableRangesModifiedAfter:(id)a0 includingAttributes:(char)a1 usingBlock:(id /* block */)a2;
- (id)initWithArchive:(const void *)a0 replicaID:(id)a1;
- (id)initWithArchive:(const void *)a0 replicaID:(id)a1 orderedSubstrings:(void *)a2;
- (id)initWithArchive:(const void *)a0 replicaID:(id)a1 timestamp:(id)a2;
- (id)initWithData:(id)a0 replicaID:(id)a1;
- (id)initWithData:(id)a0 replicaID:(id)a1 fragment:(char)a2;
- (long long)substring:(void *)a0 modifiedAfter:(id)a1 includeAttributes:(char)a2 replicaID:(id *)a3;
