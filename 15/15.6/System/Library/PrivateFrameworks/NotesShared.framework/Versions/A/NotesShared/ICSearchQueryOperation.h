@class NSError, NSString, NSArray, ICLinkSuggestionQuery, NSMutableDictionary, NSOperationQueue, NSMutableArray, ICSearchQuery;
@protocol ICSearchSuggestionsResponder;

@interface ICSearchQueryOperation : NSOperation

@property (class, nonatomic, readonly) NSOperationQueue *searchSuggestionsQueue;
...
@property (nonatomic) char performTopHitSearch;
@property (nonatomic) char performNLSearch;
@property (retain, nonatomic) NSError *error;
@property (readonly, nonatomic) char allowEmptySearchString;
@property (nonatomic) char modernResultsOnly;
...
+ (void)suggestionSearchResultsWithLinkSuggestionQuery:(ICLinkSuggestionQuery *)a0 completionHandler:(void (^)(NSArray *, NSError *))a1;
...
- (id)initWithQueryString:(id)a0 rankingQueries:(id)a1 performTopHitSearch:(char)a2 modernResultsOnly:(char)a3;
- (id)initWithQueryString:(id)a0 rankingQueries:(id)a1 performTopHitSearch:(char)a2 modernResultsOnly:(char)a3 attributes:(id)a4;
- (id)initWithSearchSuggestionsResponder:(id)a0 searchString:(id)a1 performNLSearch:(char)a2 performTopHitSearch:(char)a3 tokens:(id)a4 modernResultsOnly:(char)a5;
