...
@property (readonly, nonatomic) char isRightToLeftLanguage;

+ (char)hasSpacesBetweenWordsForLanguage:(unsigned long long)a0;
+ (id)loadWordsForLanguage:(unsigned long long)a0;
+ (id)sentencePunctuationForLanguage:(unsigned long long)a0 endOfParagraph:(char)a1;
