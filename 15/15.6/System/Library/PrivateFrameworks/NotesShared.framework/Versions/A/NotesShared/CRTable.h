...
@property (readonly, nonatomic) char isLeftToRight;
...
- (char)containsColumn:(id)a0;
- (id)initWithDocument:(id)a0 isRightToLeft:(char)a1;
...
- (char)containsRow:(id)a0;
- (unsigned long long)countOfPopulatedCells;
- (id)crTableColumnDirection;
- (id)defaultContentAtColumn:(id)a0 row:(id)a1;
- (void)enumerateCellObjectsInCellSelectionContainingColumnIndices:(id)a0 rowIndices:(id)a1 copyItems:(char)a2 usingBlock:(id /* block */)a3;
