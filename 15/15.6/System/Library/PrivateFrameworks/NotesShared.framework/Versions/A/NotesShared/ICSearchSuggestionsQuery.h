...
- (void).cxx_destruct;
- (id)initWithSearchString:(id)a0 additionalLiteralSearchString:(id)a1 searchTokens:(id)a2 filterQueries:(id)a3 rankingQueriesDefinition:(id)a4 modernResultsOnly:(char)a5 suggestionsResponder:(id)a6;
