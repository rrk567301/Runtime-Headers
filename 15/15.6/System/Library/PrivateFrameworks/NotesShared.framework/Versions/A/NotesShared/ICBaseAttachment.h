...
@property (readonly, nonatomic, getter=isUsed) char used;

+ (id)attachmentWithIdentifier:(id)a0 context:(id)a1;
+ (id)attachmentWithIdentifier:(id)a0 includeDeleted:(char)a1 context:(id)a2;
...
+ (id)predicateForVisibleAttachmentsIncludingTrash:(char)a0 inContext:(id)a1;
