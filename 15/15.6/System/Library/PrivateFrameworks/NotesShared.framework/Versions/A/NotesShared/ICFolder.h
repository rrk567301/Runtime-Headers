...
@property (readonly, nonatomic) char isDefaultFolderForAccount;
@property (nonatomic) char importedFromLegacy;
...
+ (char)isTitleValid:(id)a0 account:(id)a1 folder:(id)a2 parentFolder:(id)a3 error:(out id *)a4;
+ (char)isTitleValid:(id)a0 account:(id)a1 parentFolder:(id)a2 error:(out id *)a3;
...
+ (id)predicateForVisibleFoldersIncludingHiddenNoteContainers:(char)a0 inContext:(id)a1;
...
- (char)containsSharedDescendantFolders:(char *)a0;
- (char)containsSharedNotesOrSharedDescendantFolders;
- (char)containsSharedNotesOrSharedDescendantFolders:(char *)a0;
...
- (char)visibleChildFoldersContainsFolderWithTitle:(id)a0;
