...
@property (readonly, nonatomic) char canBeEdited;
@property (readonly, nonatomic) long long minimumSupportedVersion;
@property (readonly, copy, nonatomic) NSString *entityName;
@property (readonly, copy, nonatomic) NSPredicate *predicate;

+ (id)queryForCallNotesAllowsRecentlyDeleted:(char)a0;
+ (id)queryForMathNotesAllowsRecentlyDeleted:(char)a0;
+ (id)queryForNotesMatchingFilterSelection:(id)a0;
+ (id)queryForNotesMatchingTagSelection:(id)a0;
+ (id)queryForPinnedNotes:(char)a0 allowsRecentlyDeleted:(char)a1;
+ (id)queryForRecentlyDeletedMathNotes;
+ (id)queryForSharedNotes:(char)a0 allowsRecentlyDeleted:(char)a1;
+ (id)queryForSystemPaperNotesAllowsRecentlyDeleted:(char)a0;
