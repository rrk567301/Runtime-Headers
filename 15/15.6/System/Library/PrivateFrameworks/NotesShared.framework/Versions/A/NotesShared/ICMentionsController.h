@class ICNote, NSString, ICMentionsParticipantNode, NSMutableDictionary, ICTableColumnTextView, NSTextView, ICAttachmentInsertionController, NSMutableSet, NSObject;
...
@property (readonly, nonatomic) char allowsMentions;
...
+ (char)range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isPrefixedWithAtForString:(id)a1;
+ (id)allKeyword;
+ (id)allUserRecordName;
+ (char)isBeginningExplicitMentionAtSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inString:(id)a1 languageHasSpaces:(char)a2;
...
- (id)checkForMentionsInString:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 selectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 languageHasSpaces:(char)a3;
