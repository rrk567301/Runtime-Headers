@class ICAttachment, NSString, ICAssetGenerationManager, NSData, ICAccount, NSObject, NSDate;
...
@property (nonatomic) char versionOutOfDate;
@property (retain, nonatomic) NSDate *modifiedDate;
@property (retain, nonatomic) ICAttachment *attachment;
@property (nonatomic) char scaleWhenDrawing;
...
+ (void)enumerateAttachmentPreviewImagesInContext:(id)a0 batchSize:(unsigned long long)a1 saveAfterBatch:(char)a2 usingBlock:(id /* block */)a3;
+ (id)fileQueueGroup;
...
- (char)makeSurePreviewImageDirectoryExists:(id *)a0;
...
- (char)setImageData:(id)a0 withSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 appearanceType:(unsigned long long)a3;
- (void)setPrimaryEncryptedData:(id)a0;
- (char)setScaledImageFromImageSrc:(struct CGImageSource { } *)a0 typeUTI:(struct __CFString { } *)a1;
