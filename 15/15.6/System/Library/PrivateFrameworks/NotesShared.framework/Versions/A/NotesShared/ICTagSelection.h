...
@property (nonatomic) char allowsRecentlyDeleted;
@property (nonatomic) char automaticallyRemoveDeletedTags;
@property (readonly, nonatomic) char isNonEmpty;
@property (readonly, nonatomic) char hasMultipleTagsSelected;
...
- (void)addObjectID:(id)a0 toExcluded:(char)a1;
- (void)addUnresolvedTagIdentifier:(id)a0 toExcluded:(char)a1;
...
- (id)initWithManagedObjectContext:(id)a0 includedObjectIDs:(id)a1 excludedObjectIDs:(id)a2 tagOperator:(unsigned long long)a3;
...
- (char)isEqualToTagSelection:(id)a0;
- (void)managedObjectContextObjectIDsDidSave:(id)a0;
- (id)rawFilterValue;
- (void)removeObjectID:(id)a0 fromExcluded:(char)a1;
- (void)removeUnresolvedTagIdentifier:(id)a0 fromExcluded:(char)a1;
