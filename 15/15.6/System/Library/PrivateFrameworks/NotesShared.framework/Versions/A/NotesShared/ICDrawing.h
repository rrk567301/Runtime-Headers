...
@property (readonly, nonatomic) char canChangeTransientOrientation;
...
- (unsigned int)saveToArchive:(void *)a0 withPathData:(char)a1;
...
- (id)serializeWithPathData:(char)a0;
- (id)serializeWithPathData:(char)a0 toVersion:(unsigned int *)a1;
- (id)setCommand:(id)a0 hidden:(char)a1;
- (void)setCommandIDForInsertion:(id)a0;
- (char)setTransientOrientation:(long long)a0;
- (void)sortCommands;
