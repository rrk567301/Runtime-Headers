@class NSObject, NSString, NSMapTable, NSMutableOrderedSet, ICCRSet, ICCRArray, ICCRDocument;
...
- (char)containsObjectEqualTo:(id)a0;
...
- (void)moveObjectFromIndex:(unsigned long long)a0 toIndex:(unsigned long long)a1 mutableSafe:(char)a2;
...
- (void)wipeoutCaches;
- (void)encodeWithICCRCoder:(id)a0 orderedSet:(void *)a1;
- (void)encodeWithICCRCoder:(id)a0;
- (id)initWithICCRCoder:(id)a0;
- (id)initWithICCRCoder:(id)a0 orderedSet:(const void *)a1;
