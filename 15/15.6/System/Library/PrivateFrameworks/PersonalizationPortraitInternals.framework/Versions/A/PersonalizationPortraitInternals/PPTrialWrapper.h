...
- (id)filepathForFactorName:(id)a0 namespaceName:(id)a1 isDirectory:(char)a2;
- (char)hasFactor:(id)a0 namespaceName:(id)a1;
- (char)hasModel:(id)a0 namespaceName:(id)a1;
- (char)hasOverrideForFileFactor:(id)a0 namespaceName:(id)a1;
...
- (void)setUseDefaultFiles:(char)a0;
