...
- (id)tombstoneStream;
- (char)deleteAllEventsInEventStream:(id)a0 error:(id *)a1;
- (id)entityStream;
- (id)topicStream;
- (char)saveEvents:(id)a0 stream:(id)a1 maxRetries:(long long)a2 retryInterval:(double)a3 shouldContinueBlock:(id /* block */)a4;
- (char)deleteAllEventsInEventStream:(id)a0 matchingPredicate:(id)a1 error:(id *)a2;
- (char)deleteEvents:(id)a0 error:(id *)a1;
- (id)eventForNamedEntityRecord:(id)a0 sourceDeviceID:(id)a1;
- (id)eventForTopicRecord:(id)a0 sourceDeviceID:(id)a1;
- (char)iterEventBatchesMatchingPredicate:(id)a0 streams:(id)a1 sortDescriptors:(id)a2 batchSize:(unsigned long long)a3 error:(id *)a4 block:(id /* block */)a5;
- (char)iterEventBatchesMatchingPredicate:(id)a0 streams:(id)a1 sortDescriptors:(id)a2 batchSize:(unsigned long long)a3 readMetaData:(char)a4 remoteOnly:(char)a5 error:(id *)a6 block:(id /* block */)a7;
