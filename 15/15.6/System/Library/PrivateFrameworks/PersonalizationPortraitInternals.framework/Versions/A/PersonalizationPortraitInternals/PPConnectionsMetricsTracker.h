...
- (id)init;
- (void).cxx_destruct;
- (void)trackConversionGoalForConsumer:(id)a0 source:(id)a1 trigger:(id)a2 originatingApp:(id)a3 targetApp:(id)a4 converted:(char)a5;
- (void)trackDismissalForConsumer:(id)a0 source:(id)a1 trigger:(id)a2 originatingApp:(id)a3 targetApp:(id)a4;
- (void)trackDonationFromBundleId:(id)a0 source:(id)a1 hasLatLon:(char)a2 isEligible:(char)a3;
- (void)trackOpportunityForConsumer:(id)a0 trigger:(id)a1 targetApp:(id)a2;
- (void)trackPasteboardItemFromBundleId:(id)a0 hasAddress:(char)a1 isEligible:(char)a2;
