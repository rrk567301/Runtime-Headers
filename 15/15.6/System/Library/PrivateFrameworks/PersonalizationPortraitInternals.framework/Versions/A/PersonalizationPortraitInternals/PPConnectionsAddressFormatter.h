...
+ (id)formattedAddressWithLocationField:(unsigned char)a0 address:(id)a1 duetEvent:(id)a2 shortStyle:(char)a3;
...
+ (char)isValidAddressDictionary:(id)a0;
+ (id)postalAddressFromAttributeSet:(id)a0;
+ (id)postalAddressFromDuetEvent:(id)a0;
+ (id)singleLineFormattedAddressWithPostalAddress:(id)a0 shortStyle:(char)a1;
