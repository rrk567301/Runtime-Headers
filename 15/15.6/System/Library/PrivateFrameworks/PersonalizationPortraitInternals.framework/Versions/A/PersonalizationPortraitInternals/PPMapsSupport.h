...
+ (char)harvestMapItem:(id)a0 documentIdentifier:(id)a1 groupIdentifier:(id)a2 includingPostalAddress:(char)a3 localNamedEntityStore:(id)a4 localLocationStore:(id)a5 error:(id *)a6;
