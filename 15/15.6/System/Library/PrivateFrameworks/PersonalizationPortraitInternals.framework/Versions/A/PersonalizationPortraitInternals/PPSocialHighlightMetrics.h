...
+ (char)_queryLinksWithFetchAttributes:(id)a0 interval:(double)a1 handler:(id /* block */)a2;
...
+ (id)feedbackTypeCountsByHighlightIdentifierInInterval:(double)a0 forTVOS:(char)a1;
...
+ (void)logLinkExpiredMetricsForHighlight:(id)a0 feedbackCountsByClient:(id)a1 forTVOS:(char)a2;
