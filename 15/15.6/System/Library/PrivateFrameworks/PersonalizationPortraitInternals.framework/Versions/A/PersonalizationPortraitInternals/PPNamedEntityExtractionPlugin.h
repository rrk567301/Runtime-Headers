...
- (id)_entityContainersForContent:(id)a0 contentDataSource:(id)a1 isOutgoing:(char)a2 contactHandles:(id)a3 uniqueIdentifier:(id)a4 domainIdentifier:(id)a5 bundleIdentifier:(id)a6;
...
- (char)_processUserActivity:(id)a0 extractionContainer:(id)a1 rawTextOut:(id *)a2 language:(id)a3;
