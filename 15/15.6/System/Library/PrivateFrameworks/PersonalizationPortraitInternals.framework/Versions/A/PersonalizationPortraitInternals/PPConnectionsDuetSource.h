...
- (char)isDuetEventAuthorized:(id)a0 bundleID:(id)a1;
...
- (id)locationItemsWithCriteria:(id)a0 earliest:(id)a1 latest:(id)a2 limit:(unsigned long long)a3 duetLimit:(long long)a4 consumer:(unsigned long long)a5 richLocationItems:(char)a6 resolveEKLocations:(char)a7 explanationSet:(id)a8;
- (id)supportedLocationFields;
- (char)testMetadataForValidAddressAndNameWithEvent:(id)a0;
