...
@property (nonatomic) char verboseLoggingEnabled;
@property (nonatomic) char mslEnabled;
@property (nonatomic) char preciseTipPositionLoggingEnabled;
...
- (char)startPencilFusionUpdatesToQueue:(id)a0 withHandler:(id /* block */)a1;
