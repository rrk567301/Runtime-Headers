...
- (void)behaviorUnderstandingClearAllDataWithShouldClearFeaturizer:(char)a0 shouldClearSampleGenerator:(char)a1 completion:(id /* block */)a2;
- (void)behaviorUnderstandingClearEntityTaggingInjectedTagsWithCompletion:(id /* block */)a0;
- (void)behaviorUnderstandingDigestWithShouldDigestFeaturizer:(char)a0 shouldDigestSampleGenerator:(char)a1 completion:(id /* block */)a2;
...
- (void)behaviorUnderstandingMockEntityRelevanceContextWithDate:(NSDate *)a0 completion:(void (^)(char, NSError *))a1;
...
- (void)clearStatusWithCompletion:(void (^)(char, NSError *))a0;
...
- (void)photosMetadataWithStartDate:(id)a0 endDate:(id)a1 maxEvents:(long long)a2 newestFirst:(char)a3 completion:(id /* block */)a4;
- (void)resolveEntityWithRequest:(GDEntityResolutionRequest *)a0 enableSessionLogging:(char)a1 configName:(NSString *)a2 encodedConfig:(NSString *)a3 completion:(void (^)(GDEntityResolutionResult *, NSError *))a4;
- (void)runDeltaUpdatePipelineWithSource:(NSString *)a0 completion:(void (^)(char, NSError *))a1;
- (void)runToMatchingPipelineWithCompletion:(void (^)(char, NSError *))a0;
