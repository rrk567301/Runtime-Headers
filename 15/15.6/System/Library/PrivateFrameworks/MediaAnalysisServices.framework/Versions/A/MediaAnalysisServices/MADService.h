...
+ (char)_isEntitledForVUIndexAccess;
...
- (char)performRequests:(id)a0 assetLocalIdentifier:(id)a1 photoLibraryURL:(id)a2 error:(id *)a3;
- (char)performRequests:(id)a0 onImageURL:(id)a1 withIdentifier:(id)a2 error:(id *)a3;
...
- (char)performRequests:(id)a0 onAssetWithSyndicationIdentifier:(id)a1 error:(id *)a2;
- (char)performRequests:(id)a0 onImageData:(id)a1 withUniformTypeIdentifier:(id)a2 andIdentifier:(id)a3 error:(id *)a4;
...
- (char)performRequests:(id)a0 onAssetWithIdentifier:(id)a1 identifierType:(unsigned long long)a2 fromPhotoLibraryWithURL:(id)a3 error:(id *)a4;
