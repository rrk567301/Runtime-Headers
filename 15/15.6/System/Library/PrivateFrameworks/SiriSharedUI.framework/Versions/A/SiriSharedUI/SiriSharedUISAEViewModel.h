...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ shouldPreserveResultSpace;
...
- (id)copyWithInputType:(long long)a0 conversationTranscriptItems:(id)a1 serverUtterances:(id)a2 speechRecognitionHypothesis:(id)a3 shouldPreserveResultSpace:(char)a4;
...
- (id)initWithInputType:(long long)a0 conversationTranscriptItems:(id)a1 serverUtterances:(id)a2 userUtterance:(id)a3 shouldPreserveResultSpace:(char)a4;
