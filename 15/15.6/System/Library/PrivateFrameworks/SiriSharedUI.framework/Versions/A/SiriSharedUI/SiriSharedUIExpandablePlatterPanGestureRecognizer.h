...
@interface SiriSharedUIExpandablePlatterPanGestureRecognizer : NSPanGestureRecognizer <NSGestureRecognizerDelegate>
...
@property (nonatomic) char allowExpandedState;
