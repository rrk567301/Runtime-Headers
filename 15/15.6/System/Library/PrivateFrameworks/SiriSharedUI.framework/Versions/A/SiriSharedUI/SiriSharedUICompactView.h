@class NSArray, NSString, NSView, SiriSharedUIContentPlatterView, NSLayoutConstraint, SiriSharedUIRectSet;
...
@interface SiriSharedUICompactView : SiriSharedUIStandardView <SiriSharedUICompactAdditionalContentViewDelegate, SiriSharedUICompactConversationViewDelegate, SiriSharedUICompactResultViewDelegate, SiriSharedUIStackableContentActionHandling, NSScrollViewDelegate, SiriSharedUIAccessibilityFocusing> {
...
- (void)resultViewContentScrolling:(id)a0 didBegin:(char)a1;
...
- (void)setConversationViewHidden:(char)a0;
