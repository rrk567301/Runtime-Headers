...
- (void)_logPunchOutEventForSiriViewController:(id)a0 aceCommand:(id)a1 URL:(id)a2 appID:(id)a3 sashItem:(id)a4 shouldCreateNewTurn:(char)a5;
- (char)_shouldCreateNewTurnForSiriViewControllerInteraction:(id)a0 sashItem:(id)a1;
