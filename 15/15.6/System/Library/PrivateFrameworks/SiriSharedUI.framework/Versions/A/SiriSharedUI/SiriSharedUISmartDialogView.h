...
@property (nonatomic) char revealRecognizedSpeech;
...
- (void)_setBackgroundViewsVisible:(char)a0;
...
- (void)_smartDialogSizeNeedsUpdatingWithAnimation:(char)a0;
