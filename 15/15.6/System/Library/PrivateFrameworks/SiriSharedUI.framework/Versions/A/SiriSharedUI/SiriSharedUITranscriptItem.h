...
@property (nonatomic, getter=isRestored) char restored;
@property (nonatomic) char shouldBeExposed;
@property (nonatomic) char snippetViewControllerHasBeenUnloaded;
...
- (char)isAnnouncementItem;
- (char)isConversationItem;
- (char)isHintItem;
