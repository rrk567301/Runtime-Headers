...
@property (readonly, nonatomic) char isInputParameter;
...
- (void).cxx_destruct;
- (id)initWithVariableSource:(id)a0 parameter:(id)a1 isInputParameter:(char)a2 environment:(long long)a3 contentAttributionTracker:(id)a4 widgetSizeClass:(id)a5;
