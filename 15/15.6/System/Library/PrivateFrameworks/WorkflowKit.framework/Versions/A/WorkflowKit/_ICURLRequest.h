...
@property (nonatomic, getter=isCallbackRequest) char callbackRequest;
@property (nonatomic) char deferCompletionUntilReturn;
...
@property (nonatomic, getter=isInternalCallbackRequest) char internalCallbackRequest;
