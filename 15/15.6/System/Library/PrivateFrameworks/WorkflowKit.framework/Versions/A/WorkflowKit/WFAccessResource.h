...
@property (class, readonly, nonatomic, getter=isSystemResource) char systemResource;

@property (readonly, nonatomic) NSString *resourceName;
@property (readonly, nonatomic) NSString *username;
@property (readonly, nonatomic) char canLogOut;
@property (readonly, nonatomic) char logOutAffectsOtherApps;
@property (readonly, nonatomic) char supportsMultipleAccounts;
...
- (id)initWithDefinition:(id)a0 enableDistributedNotifications:(char)a1;
