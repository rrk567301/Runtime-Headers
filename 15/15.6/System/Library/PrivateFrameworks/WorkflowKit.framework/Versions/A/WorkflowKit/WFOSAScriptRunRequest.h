...
+ (void)createRunRequestWithScript:(id)a0 languageName:(id)a1 input:(id)a2 ignoresInput:(char)a3 completionHandler:(id /* block */)a4;
+ (id)inputAppleEventWithConvertedInputDescriptor:(id)a0 forScript:(id)a1 ignoresInput:(char)a2;
