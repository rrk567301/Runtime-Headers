...
- (char)saveProperties:(id)a0 toStorage:(id)a1 error:(id *)a2;
- (id)descriptionWithValues:(char)a0;
- (void)enumerateSettablePropertiesWithBlock:(id /* block */)a0;
- (id)initWithStorage:(id)a0 properties:(id)a1;
- (id)initWithStorage:(id)a0 properties:(id)a1 settingDefaultValues:(char)a2;
- (void)loadFromStorage:(id)a0;
- (void)loadFromStorage:(id)a0 properties:(id)a1;
- (void)markPropertyModifiedIfNecessary:(id)a0;
- (void)resetModificationsForProperties:(id)a0 onlySinceLastSave:(char)a1;
...
- (char)writeToStorage:(id)a0 error:(id *)a1;
