...
@property (nonatomic) char performExpensiveFetchOperations;
@property (retain, nonatomic) NSObject<OS_xpc_object> *xpcActivity;

+ (id)createRecordFromItem:(id)a0 zoneID:(id)a1;
+ (void)hydrateItem:(id)a0 withRecord:(id)a1 setNilValues:(char)a2;
+ (id)recordFromSystemFieldsData:(id)a0 error:(id *)a1;
...
+ (void)hydrateItem:(id)a0 withRecord:(id)a1 resolvedReferences:(id)a2 setNilValues:(char)a3;
...
+ (id)systemFieldsDataFromRecord:(id)a0 error:(id *)a1;
...
- (id)updateItems:(id)a0 setNilValues:(char)a1 completionHandler:(id /* block */)a2;
- (id)updateItems:(id)a0 setNilValues:(char)a1 qualityOfService:(long long)a2 timeoutIntervalForRequest:(double)a3 completionHandler:(id /* block */)a4;
