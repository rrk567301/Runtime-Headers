...
@property (readonly, nonatomic) char forceExecutionOnPhone;
@property (readonly, nonatomic) NSString *groupIdentifier;
@property (readonly, nonatomic) NSString *title;
@property (readonly, nonatomic) NSString *subtitle;
@property (retain, nonatomic) INIntent *intent;

+ (id)intentActionWithShortcut:(id)a0 forceExecutionOnPhone:(char)a1 groupIdentifier:(id)a2 error:(id *)a3;
...
- (id)initWithIntent:(id)a0 forceExecutionOnPhone:(char)a1;
- (id)initWithInteraction:(id)a0 forceExecutionOnPhone:(char)a1;
