...
@property (nonatomic) char resourcesAvailable;
@property (nonatomic) char resourcesRequiredForDisplayAvailable;
...
@property (readonly, nonatomic) char didEvaluateAvailabilityOfNodes;
...
- (char)nodeIsRelevant:(id)a0;
- (void)addResourceNodes:(id)a0;
- (id)currentlyRequiredResourcesOfClass:(Class)a0;
- (char)currentlyRequiresResourceOfClass:(Class)a0;
- (char)currentlyRequiresResourceOfClasses:(id)a0;
...
- (char)nodeIsAvailable:(id)a0 error:(id *)a1;
- (void)notifyTargets;
