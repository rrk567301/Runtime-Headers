...
@property (readonly, nonatomic) char negativeProperty;
@property (readonly, nonatomic) NSString *negativePropertyName;

- (id)initWithDictionary:(id)a0;
- (id)initWithPropertyName:(id)a0 propertyUserInfo:(id)a1 negativeProperty:(char)a2 negativePropertyName:(id)a3;
