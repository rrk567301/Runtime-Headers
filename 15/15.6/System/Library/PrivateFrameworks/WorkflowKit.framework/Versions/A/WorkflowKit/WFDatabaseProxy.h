...
- (char)isReference:(id)a0 allowedToRunOnDomain:(id)a1;
...
- (char)saveSmartPromptStateData:(id)a0 actionUUID:(id)a1 reference:(id)a2 error:(id *)a3;
- (void)setOutcome:(long long)a0 forRunEvent:(id)a1;
- (void)setTrustedToRunScripts:(char)a0 forReference:(id)a1 onDomain:(id)a2;
