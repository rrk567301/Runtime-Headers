...
+ (id)donationsByRemovingDuplicatesFromDonations:(id)a0 excludingAppIdentifiers:(id)a1 includingSingleDonationPerApp:(char)a2;
...
- (void)_fetchDonationsWithLimit:(unsigned long long)a0 applicationBundleIdentifier:(id)a1 includeSuggestedForAllApps:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)fetchDonationsWithLimit:(unsigned long long)a0 applicationBundleIdentifier:(id)a1 includeSuggestedForAllApps:(char)a2 completionHandler:(id /* block */)a3;
