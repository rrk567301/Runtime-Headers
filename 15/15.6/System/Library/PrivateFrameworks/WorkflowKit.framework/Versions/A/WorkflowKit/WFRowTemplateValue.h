...
@property (readonly, nonatomic) char removable;
...
- (id)initWithContentItemClass:(Class)a0 contentPropertyName:(id)a1 comparisonOperator:(long long)a2 removable:(char)a3;
