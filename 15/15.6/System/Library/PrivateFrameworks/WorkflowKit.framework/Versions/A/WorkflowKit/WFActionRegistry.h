...
- (id)createActionWithIdentifier:(id)a0 serializedParameters:(id)a1 forceLocalActionsOnly:(char)a2;
...
- (id)createActionsWithIdentifiers:(id)a0 serializedParameterArray:(id)a1 forceLocalActionsOnly:(char)a2;
...
- (id)suggestionsForHome:(id)a0 includingRelatedActions:(char)a1;
