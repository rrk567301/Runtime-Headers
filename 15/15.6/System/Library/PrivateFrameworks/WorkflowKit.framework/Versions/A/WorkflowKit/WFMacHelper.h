...
@property (nonatomic) char wasStopped;
...
- (id)createDiskImageWithFiles:(id)a0 volumeName:(id)a1 sizeToFit:(char)a2 imageSizeInMegabytes:(double)a3 encryptImage:(char)a4 completionHandler:(id /* block */)a5;
...
- (void)runCommandAtURL:(id)a0 arguments:(id)a1 workingDirectory:(id)a2 inputFile:(id)a3 takesResponsibility:(char)a4 stdoutURL:(id)a5 stderrURL:(id)a6 completionHandler:(id /* block */)a7;
