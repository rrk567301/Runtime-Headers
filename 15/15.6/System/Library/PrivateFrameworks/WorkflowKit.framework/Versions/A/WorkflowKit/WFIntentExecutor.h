@class INIntent, NSString, NSProgress, WFNetworkExtensionProxy, INCExtensionConnection;
...
@property (nonatomic) char forceExecutionOnPhone;
@property (nonatomic) char skipResolveAndConfirm;
...
- (id)initWithIntent:(id)a0 donateInteraction:(char)a1 groupIdentifier:(id)a2;
...
- (id)initWithIntent:(id)a0 donateInteraction:(char)a1 groupIdentifier:(id)a2 remoteWidgetConnection:(id)a3;
- (id)initWithIntent:(id)a0 donateInteraction:(char)a1 groupIdentifier:(id)a2 requiresTrustCheck:(char)a3;
...
- (void)resumeConnectionWithCompletionHandler:(id /* block */)a0;
- (void)showConfirmationForInteraction:(id)a0 confirmationRequired:(char)a1 authenticationRequired:(char)a2 completionHandler:(id /* block */)a3;
