...
@property (readonly, nonatomic) char includesTimeForISO8601;

- (id)initWithCustomDateFormat:(id)a0;
- (id)initWithDateStyle:(id)a0 timeStyle:(id)a1 relativeDateStyle:(id)a2;
- (id)initWithDateStyle:(id)a0 timeStyle:(id)a1 relativeDateStyle:(id)a2 customDateFormat:(id)a3 includesTimeForISO8601:(char)a4;
- (id)initWithISO8601DateStyleAndTime:(char)a0;
