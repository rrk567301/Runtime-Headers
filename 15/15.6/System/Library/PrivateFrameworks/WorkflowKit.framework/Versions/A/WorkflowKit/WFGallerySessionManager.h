...
@property (readonly, nonatomic) char performExpensiveFetchOperations;
...
- (char)bannerIsRestricted:(id)a0;
- (char)collectionIsRestricted:(id)a0;
...
- (id)initWithContainer:(id)a0 preferredLocalizations:(id)a1 currentRegion:(id)a2 currentIdiom:(id)a3 performExpensiveFetchOperations:(char)a4;
...
- (void)uploadWorkflow:(id)a0 withName:(id)a1 shortDescription:(id)a2 longDescription:(id)a3 private:(char)a4 completionHandler:(id /* block */)a5;
- (char)workflowIsRestricted:(id)a0;
