...
- (char)validateAppleIDCertificatesWithError:(id *)a0;
- (void)validateAppleIDValidationRecordWithCompletion:(id /* block */)a0;
- (char)validateSigningCertificateChainWithICloudIdentifier:(id *)a0 error:(id *)a1;
- (char)validateWithSigningMethod:(long long *)a0 error:(id *)a1;
- (char)validateWithSigningMethod:(long long *)a0 iCloudIdentifier:(id *)a1 error:(id *)a2;
