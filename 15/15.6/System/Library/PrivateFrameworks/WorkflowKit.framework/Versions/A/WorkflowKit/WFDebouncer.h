...
@property (readonly, nonatomic) char unboundedFiringReasons;
@property (readonly, nonatomic, getter=isPendingFire) char pendingFire;
...
- (id)initWithDelay:(double)a0 maximumDelay:(double)a1 queue:(id)a2 userInfo:(id)a3 unboundedFiringReasons:(char)a4;
