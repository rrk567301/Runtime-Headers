...
- (id)schemaForBundleIdentifier:(id)a0 ignoreCache:(char)a1;
- (id)schemasByBundleIdentifier;
- (char)shouldConsiderSystemIntents;
- (char)shouldCreateActionForIntentClassName:(id)a0 actionIdentifier:(id)a1 bundleIdentifier:(id)a2 inSchema:(id)a3;
