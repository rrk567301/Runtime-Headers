...
@property (readonly, nonatomic) char shouldOverrideParameterLabels;
@property (readonly, nonatomic) char shouldOverrideSubcategory;
...
- (char)isPlatformProvidedUnderstandingAction;
