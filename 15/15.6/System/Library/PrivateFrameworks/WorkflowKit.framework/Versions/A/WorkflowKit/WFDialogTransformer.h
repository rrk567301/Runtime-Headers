...
@property (nonatomic) char hasPresentedFirstDialog;
...
- (id)attributionAllowingAction:(char)a0;
...
- (void)handleUIRequestResponse:(id)a0 error:(id)a1 forRequest:(id)a2 shouldFailoverToLocalUI:(char)a3 completionHandler:(id /* block */)a4;
...
- (char)shouldHandleAlertAsSiriDialog:(id)a0;
