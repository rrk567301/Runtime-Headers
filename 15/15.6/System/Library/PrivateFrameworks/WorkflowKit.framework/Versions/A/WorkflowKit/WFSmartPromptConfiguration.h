...
@property (readonly, nonatomic) char isSpecialRequest;
...
- (id)initWithSmartPromptStates:(id)a0 attributionSet:(id)a1 previousAttributions:(id)a2 contentItemCache:(id)a3 action:(id)a4 contentDestination:(id)a5 reference:(id)a6 workflowName:(id)a7 source:(id)a8 isWebpageCoercion:(char)a9;
