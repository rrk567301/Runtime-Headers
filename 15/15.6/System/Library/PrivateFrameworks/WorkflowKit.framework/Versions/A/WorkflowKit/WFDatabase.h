@class NSHashTable, NSString, NSManagedObjectContext, NSURL, NSArray, WFCoreDataChangeNotification, WFLibrary, NSObject, NSPersistentStoreDescription, WFDebouncer;
...
@property (nonatomic) char destroysOnDeallocation;
...
@property (readonly) char hasValidLibrary;
...
@property (nonatomic, getter=isPostingDistributedNotifications) char postDistributedNotifications;
...
- (id)collectionRecordForCollectionIdentifier:(id)a0 createIfNecessary:(char)a1;
...
- (id)createTriggerEventWithTriggerID:(id)a0 eventInfo:(id)a1 confirmed:(char)a2 error:(id *)a3;
- (char)createWorkflowWithIdentifier:(id)a0 record:(id)a1 error:(id *)a2;
...
- (char)deleteAutoShortcutsPreferencesForIdentifier:(id)a0 error:(id *)a1;
- (char)deleteReference:(id)a0 error:(id *)a1;
- (char)deleteReference:(id)a0 tombstone:(char)a1 deleteConflictIfPresent:(char)a2 error:(id *)a3;
- (void)deleteShortcutSuggestionsFromApps:(id)a0;
- (id)deletedFolders;
- (id)deletedWorkflowIDsForSync;
- (id)folderForWorkflowReference:(id)a0;
- (char)hasConflictingReferenceForReference:(id)a0;
- (id)initWithStoreDescription:(id)a0 runMigrationsIfNecessary:(char)a1 useLockFile:(char)a2 error:(id *)a3;
- (char)isReference:(id)a0 allowedToRunOnDomain:(id)a1;
- (char)isSiriEnabledForAutoShortcutsWithBundleIdentifier:(id)a0 error:(id *)a1;
- (id)latestLibrary;
...
- (char)mergeAutoShortcutsPreferencesWithNewPreferences:(id)a0 error:(id *)a1;
...
- (id)referenceForWorkflowID:(id)a0 includingTombstones:(char)a1;
...
- (char)saveRecord:(id)a0 withDescriptor:(id)a1 error:(id *)a2;
...
- (char)setShortcutSuggestions:(id)a0 forAppWithBundleIdentifier:(id)a1 error:(id *)a2;
- (char)setSiriAutoShortcutsEnablement:(char)a0 forBundleIdentifier:(id)a1 source:(unsigned long long)a2 error:(id *)a3;
...
- (id)sortedTriggerEventsWithConfirmationOnly:(char)a0;
...
- (char)updateAutoShortcutsPreferencesWithNewPreferences:(id)a0 error:(id *)a1;
...
- (char)startObservingChangesForResult:(id)a0;
...
- (char)_moveReferences:(id)a0 toIndexes:(id)a1 ofCollectionID:(id)a2 error:(id *)a3;
...
- (void)accessStorageForDescriptor:(id)a0 forWriting:(char)a1 readingRecordProperties:(id)a2 usingBlock:(id /* block */)a3 withError:(id *)a4;
...
- (id)collectionWithIdentifier:(id)a0 createIfNecessary:(char)a1;
...
- (void)createLibraryFromCurrentDatabaseSnapshot;
...
- (char)deleteAllBookmarksForWorkflowID:(id)a0 error:(id *)a1;
...
- (char)hasConflictWithName:(id)a0;
- (char)hasVisibleWorkflowsWithName:(id)a0;
- (void)invalidateAllObjectsAndNotify;
- (char)isAutoShortcutDisabledForAppDescriptor:(id)a0 autoShortcutIdentifier:(id)a1 error:(id *)a2;
- (char)isAutoShortcutDisabledForBundleIdentifier:(id)a0 autoShortcutIdentifier:(id)a1;
- (char)isAutoShortcutDisabledForBundleIdentifier:(id)a0 autoShortcutIdentifier:(id)a1 error:(id *)a2;
- (char)isSiriEnabledForAutoShortcutsWithAppDescriptor:(id)a0 error:(id *)a1;
- (char)isSiriEnabledForAutoShortcutsWithBundleIdentifier:(id)a0;
- (char)isSpotlightEnabledForAutoShortcutsWithAppDescriptor:(id)a0 error:(id *)a1;
- (char)isSpotlightEnabledForAutoShortcutsWithBundleIdentifier:(id)a0;
- (char)isSpotlightEnabledForAutoShortcutsWithBundleIdentifier:(id)a0 error:(id *)a1;
...
- (char)mergeAutomationsAndShortcuts;
- (id)missingErrorForDescriptor:(id)a0;
- (id)mostRunOrLatestImportedVisibleShortcut;
- (char)moveCollections:(id)a0 toIndexes:(id)a1 error:(id *)a2;
- (char)moveCollections:(id)a0 toIndexes:(id)a1 ofCollectionWithIdentifier:(id)a2 error:(id *)a3;
- (char)moveReferences:(id)a0 toIndex:(long long)a1 ofCollection:(id)a2 error:(id *)a3;
- (char)moveReferences:(id)a0 toIndexes:(id)a1 ofCollection:(id)a2 error:(id *)a3;
- (void)notifyResultsAboutChange:(id)a0;
- (char)object:(id)a0 didUpdateProperties:(id)a1 error:(id *)a2;
- (id)objectForDescriptor:(id)a0 properties:(id)a1 createIfNecessary:(char)a2;
- (id)objectOfClass:(Class)a0 withIdentifier:(id)a1 forKey:(id)a2 createIfNecessary:(char)a3 properties:(id)a4;
...
- (char)prependReferences:(id)a0 toCollection:(id)a1 error:(id *)a2;
- (char)prependReferences:(id)a0 toCollectionWithType:(id)a1 error:(id *)a2;
...
- (char)reloadRecord:(id)a0 withDescriptor:(id)a1 error:(id *)a2;
- (void)remoteChangeDebouncerDidFire;
- (void)remoteContextDidSave:(id)a0;
- (id)removeInvalidShortcutsFromLibrary;
- (char)removeReferences:(id)a0 fromCollectionWithIdentifier:(id)a1 error:(id *)a2;
- (void)removeRunEventsWithoutAssociatedShortcuts;
- (char)replaceWithFileAtURL:(id)a0 error:(id *)a1;
- (id)saveAutoShortcutsPreferencesForAppDescriptor:(id)a0 update:(id /* block */)a1 error:(id *)a2;
- (char)saveContextOrRollback:(id)a0 error:(id *)a1;
- (void)saveLibraryToDatabase:(id)a0;
- (char)saveSmartPromptState:(id)a0 reference:(id)a1 error:(id *)a2;
- (void)saveSmartPromptStatesForInsertedAction:(id)a0 contentDestination:(id)a1 reference:(id)a2;
- (char)setAutoShortcutDisabledForAppDescriptor:(id)a0 autoShortcutDisabled:(char)a1 autoShortcutIdentifier:(id)a2 error:(id *)a3;
- (char)setAutoShortcutDisabledForBundleIdentifier:(id)a0 autoShortcutDisabled:(char)a1 autoShortcutIdentifier:(id)a2 source:(unsigned long long)a3 error:(id *)a4;
- (char)setSiriAutoShortcutsEnablement:(char)a0 forAppDescriptor:(id)a1 error:(id *)a2;
- (char)setSpotlightAutoShortcutsEnablement:(char)a0 forAppDescriptor:(id)a1 error:(id *)a2;
- (char)setSpotlightAutoShortcutsEnablement:(char)a0 forBundleIdentifier:(id)a1 source:(unsigned long long)a2 error:(id *)a3;
- (char)setWalrusStateForTesting:(long long)a0 withError:(id *)a1;
- (id)shortcutsWithOutOfSyncWalrusStatus;
- (char)shouldAddWorkflowToLibrary:(id)a0;
- (char)shouldPromptForCurrentContentItemCount:(unsigned long long)a0 previousCount:(unsigned long long)a1;
...
- (void)trackMetricsForToggleType:(unsigned long long)a0 source:(unsigned long long)a1 bundleIdentifier:(id)a2 isEnabled:(char)a3;
...
- (id)validateWorkflowName:(id)a0 forCreation:(char)a1 overwriting:(char)a2 error:(id *)a3;
- (id)visiblePredicate;
- (id)visibleReferencesForWorkflowIDs:(id)a0 sortBy:(unsigned long long)a1 nameContaining:(id)a2 nameEqualing:(id)a3 hasAssociatedAppBundleIdentifier:(char)a4 associatedAppBundleIdentifier:(id)a5 hasTombstonedConflicts:(char)a6 isRecentlyModified:(char)a7 isRecentlyRun:(char)a8 limitTo:(unsigned long long)a9;
- (id)visibleReferencesForWorkflowIDs:(id)a0 sortByKeys:(id)a1 nameContaining:(id)a2 nameEqualing:(id)a3 hasAssociatedAppBundleIdentifier:(char)a4 associatedAppBundleIdentifier:(id)a5 hasTombstonedConflicts:(char)a6 isRecentlyModified:(char)a7 isRecentlyRun:(char)a8 limitTo:(unsigned long long)a9;
- (char)wipeAllLibrariesWithError:(id *)a0;
- (id)workflowFetchRequestWithCollectionID:(id)a0 includeTombstones:(char)a1 limit:(unsigned long long)a2;
