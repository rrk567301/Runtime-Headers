...
- (id)entriesForKey:(id)a0 before:(char)a1 timeInterval:(double)a2 count:(long long)a3 withFilters:(id)a4;
...
- (char)flushCachesIfRequiredForEntryKey:(id)a0;
...
- (id)lastEntryForKey:(id)a0 withComparisons:(id)a1 isSingleton:(char)a2;
...
- (void)logMessage:(id)a0 fromFile:(id)a1 fromFunction:(id)a2 fromLineNumber:(long long)a3;
- (void)logPreUnlockState:(char)a0;
...
- (void)setupArrayForTableName:(id)a0 forColumnNamed:(id)a1 withValueType:(short)a2 withShouldIndexFKID:(char)a3;
...
- (void)setupTableName:(id)a0 withEntryKeyConfig:(id)a1 withKeyOrder:(id)a2 isDynamic:(char)a3 withShouldIndexFKID:(char)a4;
- (void)startStorage;
- (void)stopStorage;
