...
+ (id)PLEntryKeyForOperatorName:(id)a0 withType:(id)a1 withName:(id)a2 withWildCardName:(id)a3 isDynamic:(char)a4;
...
+ (id)entryKeyForOperatorName:(id)a0 withType:(id)a1 withName:(id)a2 isDynamic:(char)a3;
+ (id)entryKeyForOperatorName:(id)a0 withType:(id)a1 withName:(id)a2 withWildCardName:(id)a3;
+ (id)entryKeyForOperatorName:(id)a0 withType:(id)a1 withName:(id)a2 withWildCardName:(id)a3 isDynamic:(char)a4;
...
+ (char)isEntryKeySetup:(id)a0 forOperatorName:(id)a1;
+ (Class)operatorClassForEntryKey:(id)a0;
+ (id)operatorNameForEntryKey:(id)a0;
+ (void)setupEntryObjectsForOperatorClass:(Class)a0;
+ (char)shouldConfigureAdditionalTable:(id)a0 withType:(id)a1 withName:(id)a2;
+ (char)shouldConfigureTable:(id)a0 withType:(id)a1 withName:(id)a2 withConfigs:(id)a3;
