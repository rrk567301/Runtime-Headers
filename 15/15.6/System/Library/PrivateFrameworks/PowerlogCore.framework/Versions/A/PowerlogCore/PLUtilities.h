...
+ (char)isSiriEnabled;
+ (char)AppDeletionEnabled;
+ (id)JSONSanitizeDictionary:(id)a0;
+ (char)OverrideAllowlistEnabled;
+ (char)SwitchToIncrementalVacuumEnabled;
...
+ (char)PLCopyItemsFromPath:(id)a0 toPath:(id)a1;
+ (char)PreUnlockTelemetryEnabled;
...
+ (short)canLogMode:(id)a0 fullMode:(char)a1;
+ (id)cleanLaunchdApplicationMacOS:(id)a0;
+ (id)cleanLaunchdName:(id)a0;
+ (unsigned long long)coalitionIDForPid:(int)a0;
+ (long long)compareFilesByKey:(id)a0 file1:(id)a1 file2:(id)a2 sortAscending:(char)a3;
+ (char)compressWithSource:(id)a0 withDestination:(id)a1 withLevel:(int)a2;
...
+ (id)crashReporterKey;
+ (char)createAndChownDirectory:(id)a0;
+ (char)createAndChownDirectoryIfDirectoryDoesNotExist:(id)a0;
...
+ (char)decompressWithSource:(id)a0 withDestination:(id)a1 withRemoveSrc:(char)a2;
...
+ (struct jetsam_priority_info { int x0; char x1; long long x2; })getJetsamPriority:(int)a0;
...
+ (struct process_memory_limit_info { int x0; char x1; char x2; char x3; })getProcessMemoryLimit:(int)a0;
...
+ (char)isALSCurveHigherThanDefault;
+ (char)isDaemonOrAppleXPCService:(int)a0;
+ (char)isEduMode;
+ (char)isFullModeDaemon;
+ (char)isHeySiriEnabled;
+ (char)isImproveFitnessPlusEnabled;
+ (char)isLiteModeDaemon;
+ (char)isPingPongChargingWith:(char)a0 andBatteryLevelPercent:(double)a1;
+ (char)isPowerlogHelperd;
+ (char)isSafetyDataSubmissionAllowed;
+ (char)isValidString:(id)a0;
+ (id)launchdNameToProcessName:(id)a0;
+ (id)liteModeDaemonName;
+ (short)logModeForEntryKey:(id)a0 withKey:(id)a1 andValue:(id)a2;
+ (char)markFileAsPurgeable:(id)a0 withUrgency:(unsigned long long)a1;
+ (char)markFilesAsPurgeable:(id)a0 withUrgency:(unsigned long long)a1;
+ (char)markFilesInDirectoryAsPurgeable:(id)a0 ofType:(id)a1 withUrgency:(unsigned long long)a2;
+ (id)mobileUserADG;
+ (id)modeForEntryKey:(id)a0 withKeyName:(id)a1;
+ (char)moveItemAtPath:(id)a0 toPath:(id)a1 withName:(id)a2 error:(id *)a3;
...
+ (char)shouldCreateQuarantine;
+ (char)shouldLogForEntryKey:(id)a0;
+ (char)shouldLogForEntryKey:(id)a0 withKey:(id)a1 andValue:(id)a2;
+ (char)shouldLogPreUnlockTelemetry;
