...
+ (id)entryKeyForType:(id)a0 andName:(id)a1 isDynamic:(char)a2;
+ (id)entryKeys;
+ (char)fullMode;
+ (char)isDebugEnabledForKey:(id)a0;
+ (id)storageQueueName;
...
- (char)postFilteredNotificationForEntry:(id)a0 withFilteredDefition:(id)a1 withNotificationName:(id)a2;
- (void)setupFilterRequest:(id)a0;
- (char)shouldWriteEntry:(id)a0 withDebug:(char)a1;
