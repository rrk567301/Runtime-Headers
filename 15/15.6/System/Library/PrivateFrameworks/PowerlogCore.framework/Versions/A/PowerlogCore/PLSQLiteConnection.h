...
@property char metadataStmtCreated;
...
- (char)attachDB:(id)a0 withName:(id)a1;
...
- (char)checkEmptyMasterTable:(id)a0;
- (void)clearTableHasTimestampColumnCache;
- (char)commonInitProcessWithFilePath:(id)a0 withCacheSize:(long long)a1;
- (char)copyDatabase:(id)a0;
- (char)copyDatabaseToPath:(id)a0;
- (char)copyDatabaseToPath:(id)a0 fromDate:(id)a1 toDate:(id)a2;
- (char)copyDatabaseToPath:(id)a0 fromDate:(id)a1 toDate:(id)a2 withTableFilters:(id)a3 vacuumDB:(char)a4;
- (char)copyDatabaseToPath:(id)a0 fromDate:(id)a1 toDate:(id)a2 withTableFilters:(id)a3 vacuumDB:(char)a4 withCacheSize:(long long)a5;
- (char)copyTable:(id)a0 fromConnection:(id)a1 withDBName:(id)a2 withProperties:(id)a3 andAttach:(char)a4;
- (char)copyTable:(id)a0 fromDBName:(id)a1 withProperties:(id)a2;
...
- (char)isIncrementalVacuumEnabled;
- (char)isTransactionInProgress;
- (void)loadArrayValuesIntoEntry:(id)a0;
- (void)loadDynamicValuesIntoEntry:(id)a0;
- (char)mergeDataFromOtherDBFile:(id)a0;
- (void)moveDatabaseToPath:(id)a0;
- (char)openCurrentFileWithCacheSize:(long long)a0;
- (char)openCurrentFileWithCacheSize:(long long)a0 withFlags:(id)a1;
...
- (char)tableExistsForTableName:(id)a0;
- (char)tableHasTimestampColumn:(id)a0;
- (id)tableInfo:(id)a0;
