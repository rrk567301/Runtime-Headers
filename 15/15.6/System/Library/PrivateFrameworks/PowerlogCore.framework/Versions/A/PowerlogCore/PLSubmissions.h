...
- (char)fullModeSubmissionBehavior;
- (id)generateMSSSubmissionWithPayload:(id)a0;
- (void)generateOTASubmissionAndSendTaskingEndSubmission:(char)a0;
...
- (char)taskingBlobDRExists;
- (char)taskingBlobExists;
- (char)taskingBlobLegacyExists;
- (void)taskingCleanup;
- (void)taskingModeSafeguard;
- (void)taskingModeSetup;
- (char)taskingTypeSpecified;
