...
+ (id)getThreadName:(unsigned long long)a0 inProcess:(int)a1 isNamed:(char *)a2;
...
- (char)shouldGatherStatsForProcessName:(id)a0;
- (char)shouldIncludeThread:(id)a0 withTotalSystemTime:(double)a1 withTotalUserTime:(double)a2;
