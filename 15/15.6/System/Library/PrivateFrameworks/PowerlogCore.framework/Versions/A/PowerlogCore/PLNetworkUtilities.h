...
+ (id)decodeIPPacket:(id)a0 encryptedPath:(char)a1;
+ (char)getCompanionLink:(struct npi_if_info { unsigned int x0; unsigned int x1; unsigned int x2; } *)a0;
+ (id)getIPSecWakeInfo;
+ (int)getInterfaceType:(char *)a0 withPktIFName:(char *)a1 withPktIFInfo:(struct npi_if_info { unsigned int x0; unsigned int x1; unsigned int x2; } *)a2 withPktPhyIFInfo:(struct npi_if_info { unsigned int x0; unsigned int x1; unsigned int x2; } *)a3;
...
+ (char)isESPPacket:(struct __CFData { } *)a0 offset:(unsigned char)a1;
