...
- (id)generateRapidMSSWithStartDate:(id)a0 endDate:(id)a1 atPath:(id)a2;
- (id)generateRapidSignpostSummaryWithStartDate:(id)a0 endDate:(id)a1;
- (id)generateSignpostSubmissionWithTagConfig:(id)a0 withAllowlist:(id)a1 withStartDate:(id)a2 withEndDate:(id)a3 includeSPFile:(char)a4;
- (id)generateTaskingMSSWithStartDate:(id)a0 endDate:(id)a1 atPath:(id)a2;
- (id)getSignpostMetricsWithStartDate:(id)a0 withEndDate:(id)a1 processMXSignpost:(char)a2;
