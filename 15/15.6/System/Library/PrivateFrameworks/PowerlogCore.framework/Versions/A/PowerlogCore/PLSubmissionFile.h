...
- (void)submit;
- (char)createTagFileWithPath:(id)a0 withInfo:(id)a1;
- (void)submitLogToiCloud:(id)a0 WithCompress:(char)a1;
- (void)cleanupTmpDirectory;
- (char)createTagFileWithPath:(id)a0;
- (void)decorateFile;
...
- (void)submitLogToiCloudWithCompress:(char)a0;
