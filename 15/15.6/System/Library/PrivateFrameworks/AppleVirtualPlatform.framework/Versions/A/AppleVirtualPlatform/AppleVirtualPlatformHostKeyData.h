...
- (void).cxx_destruct;
- (id)initWithDataRepresentation:(id)a0 maxDataSize:(long long)a1 chipID:(unsigned long long)a2 ecid:(unsigned long long)a3 updatedDataRepresentation:(char *)a4 error:(id *)a5;
