...
- (void)requestAuthorizationForApplicationWithBundleIdentifier:(id)a0 preparing:(char)a1 overrides:(id)a2 currentScreenShareAttributes:(id)a3 completionHandler:(id /* block */)a4;
- (void)setAuthorization:(char)a0 forBundleIdentifier:(id)a1;
