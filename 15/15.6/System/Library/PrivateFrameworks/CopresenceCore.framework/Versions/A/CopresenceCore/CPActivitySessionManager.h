...
@property (class, nonatomic, readonly) char supportsMultipleActivitySessions;
...
- (void)audioPolicyManager:(id)a0 sharePlayAllowedStateChanged:(char)a1;
...
- (void)presentSessionDismissalAlertForActivitySessionUUID:(id)a0 allowingCancellation:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)resetSessions;
- (void)setUsingAirplay:(char)a0 forActivitySessionWithUUID:(id)a1;
- (void)systemStateObserver:(id)a0 sharePlayAllowedStateChanged:(char)a1;
