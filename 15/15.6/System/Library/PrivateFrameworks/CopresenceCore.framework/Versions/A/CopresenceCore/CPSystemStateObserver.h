...
@property (nonatomic, readonly) char allowSharePlay;
@property (nonatomic, readonly) char allowScreenSharing;
@property (nonatomic, readonly) char allowScreenSharingInitiation;
