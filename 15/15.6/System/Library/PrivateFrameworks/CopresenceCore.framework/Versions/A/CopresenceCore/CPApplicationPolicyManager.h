...
@property (nonatomic, readonly) char autoLaunchEnabled;
...
- (void)setAuthorization:(char)a0 forBundleID:(id)a1;
- (char)shouldAutoLaunchAppForActivity:(id)a0 onConversation:(id)a1;
