...
- (void)serverDidStart:(char)a0 error:(id)a1;
- (void)serverIsReady:(char)a0;
- (char)startAccessPoint:(id *)a0;
- (void)stopAccessPointAndJoinPreviousNetwork:(char)a0;
- (void)stopPairing;
