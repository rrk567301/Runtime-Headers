...
- (void)sizeUsers:(id)a0 recalculationPermitted:(char)a1 progressBlock:(id /* block */)a2 completionBlock:(id /* block */)a3;
...
- (char)user:(id)a0 needsSizeUpdated:(id)a1 latestEvent:(unsigned long long *)a2;
