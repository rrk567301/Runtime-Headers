...
- (void)setSize:(unsigned long long)a0 andCount:(unsigned long long)a1 forPathGroup:(unsigned long long)a2 sizeIsFinal:(char)a3;
...
- (char)updateUser:(id)a0 withID:(id)a1 andExcludablePaths:(id)a2;
