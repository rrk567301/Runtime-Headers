...
@property (nonatomic) char containsConfMigratorClaimedFiles;
@property (nonatomic) char containsDoNotScanPaths;
...
@property (nonatomic) char doNotCoalesce;
@property (nonatomic) char statistical;

- (void).cxx_destruct;
- (void)absorbChildClassifier:(id)a0;
- (void)addBundle:(id)a0 atLocation:(id)a1 withStats:(id)a2 isPlatformBinary:(char)a3;
