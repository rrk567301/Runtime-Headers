...
- (void)obtainTotalSizeOfOtherUsersOnSystemWithCompletionBlock:(id /* block */)a0 andProgressBlock:(id /* block */)a1 recalculationPermitted:(char)a2;
- (void)obtainTotalSizeOfOtherUsersOnSystemWithCompletionBlock:(id /* block */)a0 userFilterBlock:(id /* block */)a1 andProgressBlock:(id /* block */)a2 recalculationPermitted:(char)a3;
- (char)prepareToShove;
- (char)prepareToShoveAndRunTemplateMigration;
