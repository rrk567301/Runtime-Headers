...
@property char scanned;
@property (retain) NSObject<OS_dispatch_queue> *scanQueue;
@property (retain) NSMutableArray *decisionLog;

- (void).cxx_destruct;
- (void)addBundlesFromEnumerator:(id)a0 toDictionary:(id)a1 skipAppStoreBundles:(char)a2;
...
- (char)shouldMigrateApplicationBundle:(id)a0 withVersion:(id)a1 andSourceLocation:(id)a2 presentInLocation:(id *)a3 relocateToLocation:(id *)a4;
- (char)shouldMigrateBundle:(id)a0 withVersion:(id)a1 andSourceLocation:(id)a2 presentInLocation:(id *)a3 relocateToLocation:(id *)a4;
