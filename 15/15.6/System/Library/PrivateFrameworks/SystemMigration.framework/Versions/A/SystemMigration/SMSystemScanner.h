...
@property char mustRemovelastKnownFinalTMSelectedSourceDisk;
...
- (char)addNewSystem:(id)a0 replaceIfKnown:(char)a1;
...
- (char)isDiskInSameVolumeGroupAsCurrentSystem:(id)a0;
- (char)isLostSourceLTIDSameAs:(id)a0;
- (char)isLostSourceParentATMSparseBundleThatMatches:(id)a0;
- (char)isLostSourceParentExSameAs:(id)a0;
- (char)isLostSourceParentSameAs:(id)a0;
- (char)isLostSourceSameAs:(id)a0;
- (char)isLostSystemGrandParentSameAs:(id)a0;
- (char)isLostSystemGreatGrandParentSameAs:(id)a0;
- (char)isLostSystemParentSameAs:(id)a0;
- (char)isSourceLost;
- (id)listAndQueueForSystem:(id)a0;
- (void)markLostForLastKnownFinalSelectedSourceDiskDetails:(char)a0 forSystem:(id)a1 wasRegained:(char)a2;
- (id)matchSMSystem:(id)a0;
- (char)mountDiskIfNeeded:(id)a0;
...
- (char)registerAlreadyMountedBackups:(id)a0;
...
- (void)removeSystem:(id)a0 lockQueue:(char)a1;
