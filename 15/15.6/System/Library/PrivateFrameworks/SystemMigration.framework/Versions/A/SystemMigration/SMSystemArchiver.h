...
+ (char)clearProblemSymlinksFromDataVolume:(id)a0 error:(id *)a1;
...
+ (char)reapPreviousSystemOnDataVolume:(id)a0 withPather:(id)a1 andProgress:(id /* block */)a2 error:(id *)a3;
