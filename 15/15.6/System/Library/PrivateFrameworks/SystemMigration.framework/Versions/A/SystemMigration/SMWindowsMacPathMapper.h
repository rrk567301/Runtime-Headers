...
- (char)isOtherDiskXMURLString:(id)a0 outName:(id *)a1;
...
- (char)isSharedFilesXMURLString:(id)a0;
- (void)mapShortname:(id)a0 toBasePath:(id)a1;
- (id)pathForDomainOfXMURLString:(id)a0;
- (id)pathForURL:(id)a0 userRelative:(char)a1 domainPathOnly:(char)a2;
- (id)pathForXMURLString:(id)a0;
- (void)redirectShortname:(id)a0 toShortname:(id)a1 orBasePath:(id)a2;
- (char)saveToArchiveInDirectory:(id)a0 forUser:(unsigned int)a1 error:(id *)a2;
