...
@property char disableFileVaultUsersMigration;
@property (retain) SMSystem_Client *sourceSystem;
@property (retain) SMSystem_Client *targetSystem;
@property char isOneToOneMigration;
@property (readonly) char migratableState;
@property (readonly) NSString *migratableStateDescription;
@property (readonly) char conflictExists;
