...
- (char)isLostSourceALatestBackup;
- (char)isLostSourceClassTMBased;
- (char)isLostSourceParentTMSparseBundleClass;
...
- (char)requiresSystemRetention;
- (void)scanMountedDisk:(id)a0;
- (id)timeCapsuleParentOfMountPoint:(id)a0;
- (void)unmountEverythingThatIsNotTheFinalizedSource;
- (void)updateLastKnownFinalSelectedSourceDiskDetails:(id)a0 lost:(char)a1 forSystem:(id)a2 wasRegained:(char)a3;
