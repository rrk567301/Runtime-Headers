...
@property char customPathsSystemToSystemSizeFinal;
@property unsigned long long customPathsSystemToUserSize;
@property char customPathsSystemToUserSizeFinal;
...
@property char someUserNeedsToLogin;
...
- (void)addSubComponent:(id)a0 toNode:(id)a1 select:(char)a2;
- (void)addSystemComponentToTransfer:(id)a0 toRequest:(id)a1;
- (void)addUser:(id)a0 isAlreadyTransferred:(char)a1;
...
- (void)recursivelyFindAndUpdateSize:(id)a0 forComponentWithIdentifier:(id)a1 fromNode:(id)a2 sizeIsFinal:(char)a3;
...
- (void)updateSize:(id)a0 forComponentWithIdentifier:(id)a1 sizeIsFinal:(char)a2;
