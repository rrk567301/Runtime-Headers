...
@property char engineWaitingForPathing;
...
@property (readonly) char shouldContinueSteps;
...
- (char)engineSourceSystemAvailable;
...
- (char)isEngineState:(unsigned long long)a0;
...
- (void)waitIfSuspended:(char *)a0 sourceDisappeared:(char *)a1;
