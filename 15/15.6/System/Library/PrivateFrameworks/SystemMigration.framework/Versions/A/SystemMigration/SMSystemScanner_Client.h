...
@property char currentlyLostConnectedSourceSystem;
...
@property char automaticallyAdvertiseHandoff;
...
- (void)notifyListenersOfLostCurrentSourceDiskStatus:(char)a0;
...
- (id)xpcDictFromSystem:(id)a0 includeOneTimeData:(char)a1;
