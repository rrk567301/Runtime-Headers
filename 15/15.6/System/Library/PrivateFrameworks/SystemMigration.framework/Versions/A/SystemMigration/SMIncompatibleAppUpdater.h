...
@property char startedUpdate;
@property char appleEVVerified;
@property char requireEVValidation;
@property (retain) NSMutableData *catalogData;
@property (readonly) char updateComplete;
@property (readonly) char updateSuccessful;
...
- (void)completedWithSuccess:(char)a0;
