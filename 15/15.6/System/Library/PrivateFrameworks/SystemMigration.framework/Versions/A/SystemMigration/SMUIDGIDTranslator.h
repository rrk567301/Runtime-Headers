...
- (char)translatedUID:(unsigned int *)a0 andGID:(unsigned int *)a1 forOldUID:(unsigned int)a2 andOldGID:(unsigned int)a3;
- (char)translatedUID:(unsigned int *)a0 andGID:(unsigned int *)a1 forOldUID:(unsigned int)a2 andOldGID:(unsigned int)a3 ofType:(long long)a4;
