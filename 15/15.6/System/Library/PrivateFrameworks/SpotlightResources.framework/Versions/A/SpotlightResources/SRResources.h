...
@property char autoUpdatingLocale;
@property (readonly, nonatomic) NSString *client;
@property (readonly, nonatomic) NSLocale *locale;
@property (readonly, nonatomic) char hasUpdates;
@property (copy, nonatomic) id /* block */ parameterUpdates;
@property (readonly, nonatomic) char forceLoad;
...
- (char)booleanForKey:(id)a0 didFailWithError:(id *)a1;
...
- (void)didUpdateDefaultsWithLanguage:(id)a0 contentVersions:(id)a1 trial:(char)a2;
- (id)fetchBooleanParameter:(id)a0;
- (id)fetchDoubleParameter:(id)a0;
- (id)fetchFilePathParameter:(id)a0;
- (id)fetchLongParameter:(id)a0;
- (id)fetchParameter:(id)a0 checkForPositive:(char)a1;
