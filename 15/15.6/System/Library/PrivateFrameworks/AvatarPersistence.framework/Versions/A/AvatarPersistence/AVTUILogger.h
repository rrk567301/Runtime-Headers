...
- (void)logCarouselDelegateNearnessFactorDidChange:(double)a0 towardRecord:(char)a1 editable:(char)a2;
- (void)logCarouselDelegateWillEndFocusRecord:(id)a0;
- (void)logCarouselEndsDraggingWithVelocity:(double)a0 willSwitchIndexPathInsteadOfScrollBack:(char)a1 forHighVelocity:(char)a2;
...
- (void)logPerformedRecentStickersMigration:(char)a0;
...
- (void)logSetupHandlerCompletedForTransition:(id)a0 state:(long long)a1 finished:(char)a2;
...
- (void)logAccountInfo:(id)a0 status:(long long)a1 deviceToDeviceEncryption:(char)a2;
...
- (void)logDidResetZoneWithSuccess:(char)a0 error:(id)a1;
...
- (void)logExportRequestResult:(char)a0 error:(id)a1;
...
- (void)logImportRequestResult:(char)a0 error:(id)a1;
...
- (void)logUnableToReadRemoteRecord:(id)a0 isCritical:(char)a1;
- (void)logUnthrottlingAVTView;
- (void)logUpdatingBackupExclusionStatus:(char)a0;
