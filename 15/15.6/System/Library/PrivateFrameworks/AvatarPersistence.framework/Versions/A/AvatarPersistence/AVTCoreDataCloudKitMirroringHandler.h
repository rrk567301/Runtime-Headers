...
@property (nonatomic) char exportInFlight;
@property (weak, nonatomic) id<AVTCoreDataCloudKitMirroringHandlerDelegate> delegate;

- (void)dealloc;
- (void).cxx_destruct;
- (void)didResetSync:(id)a0;
- (void)exportChangesWithManagedObjectContext:(id)a0 discretionary:(char)a1 workQueue:(id)a2 completionHandler:(id /* block */)a3;
- (void)importChangesWithManagedObjectContext:(id)a0 discretionary:(char)a1 workQueue:(id)a2 completionHandler:(id /* block */)a3;
- (id)initWithLogger:(id)a0 blockScheduler:(id)a1;
- (void)resetZoneWithManagedObjectContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)scheduleExportChangesWithManagedObjectContext:(id)a0 discretionary:(char)a1 workQueue:(id)a2 completionHandler:(id /* block */)a3;
