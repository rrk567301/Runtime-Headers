...
@property (nonatomic) char setupCompleted;
...
+ (char)resetSyncShouldPreserveContentForReason:(unsigned long long)a0;
...
- (char)processInternalSettingsChanges:(id /* block */)a0;
...
- (void)scheduleExportWithManagedObjectContext:(id)a0 discretionary:(char)a1 completion:(id /* block */)a2;
- (void)scheduleImportDiscretionary:(char)a0 completionBlock:(id /* block */)a1;
