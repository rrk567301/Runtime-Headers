...
- (char)_removeFile:(id)a0 error:(id *)a1;
- (id)_filesFromDirectory:(id)a0 error:(id *)a1;
- (char)_removeFiles:(id)a0 fromDirectory:(id)a1 error:(id *)a2;
- (id)archivedDataWithObject:(id)a0 error:(id *)a1;
- (char)createDirectory:(id)a0 error:(id *)a1;
- (id)dataFromPath:(id)a0;
- (id)filesFromDirectory:(id)a0 error:(id *)a1;
- (char)isDataExistAsDirectoryForPath:(id)a0;
- (char)removeExistingFilesFromDirectory:(id)a0;
- (void)removeFile:(id)a0 error:(id *)a1;
- (char)removeFiles:(id)a0 fromDirectory:(id)a1 error:(id *)a2;
- (void)removeFiles:(id)a0 withFilenameContainsSubstring:(id)a1 fromDirectory:(id)a2 error:(id *)a3;
- (char)saveData:(id)a0 withFilePath:(id)a1;
