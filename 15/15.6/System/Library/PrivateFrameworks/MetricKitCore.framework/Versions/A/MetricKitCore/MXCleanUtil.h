...
- (char)_isDiagnosticDeliveryStaleForDirectory:(id)a0;
- (char)_isDiagnosticSourceFilename:(id)a0;
- (char)_isMetricDeliveryStaleForDirectory:(id)a0;
- (char)_isMetricSourceFilename:(id)a0;
- (char)_isStaleDiagnosticSourceForFilename:(id)a0;
- (char)_isStaleForDate:(id)a0;
- (char)_isStaleMetricSourceForFilename:(id)a0;
- (char)_isStaleSourceForFilename:(id)a0;
