...
- (char)validateActionsDictionary:(id)a0;
- (char)validateActionsDictionaryContent:(id)a0 identifier:(id)a1;
- (char)validateDiagnosticsConfiguration:(id)a0;
- (char)validateOSLogPreferencesProtocol:(id)a0;
- (char)validateSettingsDictionary:(id)a0;
- (char)validateSettingsNodeContents:(id)a0 identifier:(id)a1;
- (char)validateSettingsNodeDictionary:(id)a0 identifier:(id)a1 isDefault:(char)a2;
