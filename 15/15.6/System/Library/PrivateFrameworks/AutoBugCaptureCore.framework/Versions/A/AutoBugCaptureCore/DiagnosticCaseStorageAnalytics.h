...
- (id)historicalDiagnosticCaseStorageDictionaryFromIdentifier:(id)a0 withEvents:(char)a1 count:(unsigned long long)a2;
- (id)historicalDiagnosticCaseStorageFromIdentifier:(id)a0 count:(unsigned long long)a1;
- (id)initWithWorkspace:(id)a0 withCache:(char)a1;
