...
@interface ABCAdministrator : NSObject <ABCPersistentStoreControllerDelegate> {
    ...
    char _autoBugCaptureAdministrativelyEnabled;
...
- (char)checkToSeeIfUserIsLoggedInForSCDStore:(struct __SCDynamicStore { } *)a0;
...
- (void)shutdownAgent;
- (void)startAutoBugCaptureAdministrative:(char)a0;
- (void)startAutoBugCaptureAdministrative:(char)a0 parameters:(id)a1;
- (void)startEssentialServices;
- (void)startMaintenanceServices;
- (void)startUploadTaskScheduler;
- (void)startupAgent;
- (void)stopAutoBugCapture:(char)a0;
