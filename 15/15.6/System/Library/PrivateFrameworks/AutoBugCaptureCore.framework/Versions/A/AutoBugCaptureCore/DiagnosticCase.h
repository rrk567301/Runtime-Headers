...
@property (readonly, nonatomic, getter=isSnapshot) char snapshot;
@property (readonly, nonatomic, getter=wantsRemote) char wantsRemote;
@property (readonly, nonatomic, getter=isRemoteTrigger) char remoteTrigger;
@property (nonatomic) unsigned long long caseFlags;
@property (nonatomic) double preferredDuration;
@property (readonly, nonatomic) char writeIPSFile;
@property (nonatomic) char readyToEndSession;
...
+ (id)_stringRepresentationOfJSONObject:(id)a0 prettyPrint:(char)a1;
...
- (char)_parseSignatureIntoCaseStorage:(id)a0;
- (void)setClosureType:(short)a0;
- (char)_parseCaseStorageIntoSignature:(id)a0;
- (char)matchSignature:(id)a0;
- (id)stringRepresentationOfSignature;
- (void)_addToAttachments:(id)a0;
- (id)_caseSummaryFileName;
- (id)_generateCaseSummaryDictionary;
- (void)_updatePayloadDictionaryArray:(char)a0;
- (id)_updatedPayloadPathForOriginalPath:(id)a0 sandboxExtensionToken:(id)a1;
- (void)addEvent:(id)a0 forced:(char)a1;
- (void)addEvents:(id)a0 forced:(char)a1;
...
- (void)allowIPSFileOutput:(char)a0;
...
- (void)markAttachmentsAsPurgeable:(char)a0 urgency:(unsigned long long)a1;
...
- (void)reportGeneratorEnded:(id)a0 reportInfo:(id)a1 error:(id)a2 isFinalReportGenerator:(char)a3;
- (char)sendReports;
