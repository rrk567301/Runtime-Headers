...
- (void)snapshotWithSignature:(id)a0 delay:(unsigned long long)a1 events:(id)a2 payload:(id)a3 actions:(id)a4 wantsRemoteCase:(char)a5 reply:(id /* block */)a6;
- (void)startSessionWithSignature:(id)a0 duration:(unsigned long long)a1 events:(id)a2 payload:(id)a3 actions:(id)a4 wantsRemoteCase:(char)a5 reply:(id /* block */)a6;
...
- (char)_checkRateLimitForAllowance:(id)a0 time:(id)a1;
