...
@interface CloudKitUploadController : NSObject {
    ...
    char _aggregateOperationResult;
}
...
- (char)logUploadRequiresConsent:(id)a0;
...
- (void)recordOperationCompleteForOperationID:(id)a0 completionTime:(id)a1 success:(char)a2;
- (void)registerCaseSummaryActivities;
- (void)registerCloudKitUploadActivities;
- (void)registerLogUploadActivities;
- (char)shouldDeferFromCloudKitError:(id)a0;
...
- (id)uploadOperationWithRecordsToSave:(id)a0 recordIDsToDelete:(id)a1 allowCellular:(char)a2 activity:(id)a3;
- (void)uploadToCloudKitContainer:(id)a0 withRecords:(id)a1 activity:(id)a2;
- (char)validateCaseAttachmentsForDiagnosticCaseStorage:(id)a0 record:(id)a1;
