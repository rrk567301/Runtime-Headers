...
- (char)stopNetDiagnosticTaskWithReply:(id /* block */)a0;
...
- (char)netDiagnosticTaskStatusWithReply:(id /* block */)a0;
- (void)sendNotificationListener;
- (char)startNetDiagnosticTaskWithOptions:(id)a0 reply:(id /* block */)a1;
