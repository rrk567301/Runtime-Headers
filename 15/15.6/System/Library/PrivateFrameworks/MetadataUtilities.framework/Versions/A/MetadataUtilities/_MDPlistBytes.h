...
+ (void)enumerateObjectsFromPlistBytes:(char *)a0 count:(unsigned int)a1 shouldDeallocate:(char)a2 usingBlock:(id /* block */)a3;
...
- (void)dumpUIDs;
- (char)enumerateQueryResults:(unsigned long long)a0 attributeSize:(unsigned long long)a1 stringCache:(struct { struct __CFDictionary *x0; struct __CFDictionary *x1; unsigned int x2; } *)a2 usingBlock:(id /* block */)a3;
...
- (id)initWithByteVector:(char *)a0 count:(unsigned int)a1 shouldDeallocate:(char)a2;
