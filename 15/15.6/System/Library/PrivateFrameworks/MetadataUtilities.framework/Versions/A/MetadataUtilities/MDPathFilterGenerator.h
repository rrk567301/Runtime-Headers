...
- (void)addNamed:(id)a0 field:(int)a1 value:(int)a2 forPath:(id)a3 permitLink:(char)a4;
- (void)addNamed:(id)a0 field:(int)a1 value:(int)a2 hasAuxValue:(char)a3 auxValue:(unsigned long long)a4 forPath:(id)a5 permitLink:(char)a6 copyParentWildcardLink:(char)a7;
