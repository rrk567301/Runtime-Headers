...
@property char hasProcessedSDEF;
...
@property char includeStandardAdditions;
@property char strictPropertyScope;
@property char strictCommandScope;
@property char strictParameterType;
...
- (char)handlerIsStandardAddition:(id)a0;
...
- (id)sendAppleEvent:(id)a0 modifiers:(id)a1 withContext:(id)a2 waitForReply:(char)a3 error:(id *)a4;
