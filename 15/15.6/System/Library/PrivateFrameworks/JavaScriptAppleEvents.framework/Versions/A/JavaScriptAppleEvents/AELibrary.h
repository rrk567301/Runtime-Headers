...
- (id)sendAppleEvent:(id)a0 timeout:(long long)a1 withContext:(id)a2 waitForReply:(char)a3 error:(id *)a4;
- (id)sendAppleEvent:(id)a0 withContext:(id)a1 waitForReply:(char)a2 error:(id *)a3;
