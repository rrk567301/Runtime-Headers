...
- (void)startTestSpeechRequestWithAssistantId:(id)a0 requestId:(id)a1 enableASR:(char)a2 inputOrigin:(id)a3 location:(id)a4 jitContext:(id)a5 overrideModelPath:(id)a6 requestContextData:(id)a7;
...
- (void)endSessionWithAssistantId:(id)a0 withDelay:(char)a1;
- (void)handleCommand:(id)a0 executionContextInfo:(id)a1 reply:(id /* block */)a2;
- (char)implementsCommand:(id)a0 forDomain:(id)a1;
...
- (void)sendMultiUserInfoWithDeviceAssistantId:(id)a0 multiUserInfo:(id)a1 isRMVEnabled:(char)a2;
- (char)sessionExistsForAssistantId:(id)a0;
...
- (void)startSpeechDictationSessionWithAssistantId:(id)a0 languageCode:(id)a1 recognitionOnDevice:(char)a2;
- (void)startSpeechRequestWithAssistantId:(id)a0 requestId:(id)a1 inputOrigin:(id)a2 location:(id)a3 asrOnServer:(char)a4 requestContextData:(id)a5;
...
- (void)startUnderstandingDictationSessionWithAssistantId:(id)a0 languageCode:(id)a1 understandingOnDevice:(char)a2;
