...
@property (readonly) char isTapToRadarMode;
...
- (char)accessoryReachable:(id)a0 remoteEndpoint:(id)a1 error:(id *)a2;
- (char)accessoryUnreachable:(id)a0 error:(id *)a1;
- (char)accessoryUnreachable:(id)a0 remoteEndpoint:(id)a1 error:(id *)a2;
...
- (char)handlePowerSource:(id)a0 currentCapacity:(unsigned long long)a1 maxCapacity:(unsigned long long)a2;
- (id)logTokenForCategory:(int)a0;
- (char)offerAssetToAccessory:(id)a0 asset:(id)a1 downstreamID:(unsigned long long)a2 error:(id *)a3;
- (char)offerAssetToAccessory:(id)a0 asset:(id)a1 error:(id *)a2;
- (char)offerDynamicAssetToAccessory:(id)a0 asset:(id)a1 error:(id *)a2;
- (void)offerDynamicAssetToAccessory:(id)a0 asset:(id)a1 internalOffer:(char)a2 tag:(id)a3;
- (char)offerFirmwareAssetToDownstreamEndpoint:(id)a0 error:(id *)a1;
...
- (char)qProcessCrshDynamicAsset:(id)a0;
- (void)qProcessDynamicAssets;
- (char)qProcessMticDynamicAsset:(id)a0;
...
- (char)recvDataFromEndpoint:(id)a0 data:(id)a1 error:(id *)a2;
...
- (char)shouldSendFirmwareStagingProgressForAccessory:(id)a0 asset:(id)a1;
- (char)solicitDynamicAssetForAccessory:(id)a0 asset:(id)a1 error:(id *)a2;
- (char)solicitDynamicAssetForAccessory:(id)a0 asset:(id)a1 internalSolicit:(char)a2 error:(id *)a3;
- (char)solicitDynamicAssetForAccessory:(id)a0 assetTag:(id)a1 error:(id *)a2;
- (char)solicitDynamicAssetForRemoteEndpoint:(id)a0 assetTag:(id)a1 internalSolicit:(char)a2 error:(id *)a3;
...
- (char)tssResponseForEndpoint:(id)a0 tssResponse:(id)a1;
- (char)unsolicitedDynamicAssetForAccessory:(id)a0 assetTag:(id)a1 error:(id *)a2;
...
- (void)updateEnableMixMatch:(char)a0 remoteEndpoint:(id)a1;
...
- (void)updatePrefixNeedsLogicalUnitNumber:(char)a0 remoteEndpoint:(id)a1;
...
- (void)updateSocLiveNonce:(char)a0 remoteEndpoint:(id)a1;
- (void)updateStagedFirmwareVersion:(id)a0 remoteEndpoint:(id)a1;
- (void)updateStatistics:(id)a0 remoteEndpoint:(id)a1;
- (void)updateSuffixNeedsLogicalUnitNumber:(char)a0 remoteEndpoint:(id)a1;
