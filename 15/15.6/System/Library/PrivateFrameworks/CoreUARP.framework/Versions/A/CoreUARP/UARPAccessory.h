...
@property char userInitiatedFirmwareStaging;
@property char userInitiatedFirmwareApply;
...
@property char enableFirmwareDownloadOnDemand;
...
- (id)bsdNotifications;
- (char)clientQueryPendingForProperty:(unsigned long long)a0;
...
- (void)setAssetTransfersPaused:(char)a0;
