...
- (void)addTLV:(unsigned long long)a0 keyValueString:(id)a1 tlvArray:(id)a2;
...
- (void)addTLV:(unsigned long long)a0 keyValue:(id)a1 tlvArray:(id)a2 payloadsURL:(id)a3 isFilepath:(char)a4;
- (void)addTLV:(unsigned long long)a0 legacyTLV:(unsigned long long)a1 keyValue:(id)a2 tlvArray:(id)a3 payloadsURL:(id)a4 isFilepath:(char)a5;
...
- (void)addTLVs:(unsigned long long)a0 excludedHwRevisions:(id)a1 tlvArray:(id)a2;
- (void)addVoiceAssistTLVs2;
- (void)composeMatchingPayloads:(id)a0 tlvArray:(id)a1;
- (void)composeMeasuredPayloads:(id)a0 tlvType:(unsigned long long)a1 tlvArray:(id)a2 payloadsURL:(id)a3;
- (void)composeRequiredPersonalizationOptions:(id)a0 tlvArray:(id)a1;
- (id)createTLVWithType:(unsigned long long)a0 keyValue:(id)a1 payloadsURL:(id)a2 isFilepath:(char)a3;
- (char)expandPlist:(id *)a0;
