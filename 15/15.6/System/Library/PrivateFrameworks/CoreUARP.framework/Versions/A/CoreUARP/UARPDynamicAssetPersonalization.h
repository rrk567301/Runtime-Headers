...
- (char)compareTssResponse:(id)a0;
- (id)initWithEndpoint:(id)a0 url:(id)a1 tatsuServerURL:(id)a2;
- (char)prepareDynamicAsset:(id)a0 error:(id *)a1;
- (char)processDynamicAsset:(id *)a0;
- (char)processTssResponse:(id)a0;
- (char)tssRequest:(id)a0 error:(id *)a1;
- (char)tssRequest:(id)a0 error:(id *)a1 authListed:(char)a2;
