...
- (void)reportInstantAnswerButtonSelected:(id)a0 cardSectionID:(id)a1 command:(id)a2;
- (void)reportInstantAnswerCardSelected:(id)a0 cardSectionID:(id)a1;
- (void)reportLocalSearchEnded;
- (void)reportMessageListResultEngaged:(id)a0 engagementAction:(long long)a1;
- (void)reportMessageListResultsFetched:(id)a0 isFinished:(char)a1;
- (void)reportMessageListResultsVisible:(id)a0;
- (void)reportQueryClearedEvent:(long long)a0;
- (void)reportQueryWithRestrictedComponents:(id)a0 triggerEvent:(unsigned long long)a1 searchType:(unsigned long long)a2 hasCurrentMailboxScope:(char)a3 languages:(id)a4;
- (void)reportQueryWithRestrictedComponents:(id)a0 triggerEvent:(unsigned long long)a1 searchType:(unsigned long long)a2 hasCurrentMailboxScope:(char)a3 searchViewAppeared:(char)a4 languages:(id)a5;
- (void)reportRankingFeedbackForSuggestions:(id)a0;
- (void)reportSearchEndedEvent:(long long)a0;
- (void)reportSearchViewAppeared:(char)a0 currentMailboxScope:(char)a1 languages:(id)a2;
