...
@property (class, readonly, nonatomic) char canOpenRadar;

@property (copy, nonatomic) NSString *title;
@property (nonatomic) char prependSystemVersionToTitle;
@property (copy, nonatomic) NSString *radarDescription;
@property (nonatomic) char appendStandardDisclaimerToDescription;
@property (nonatomic) char appendSysdiagnoseHowTo;
@property (nonatomic) char customFooter;
