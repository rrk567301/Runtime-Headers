...
@property (nonatomic) char hasCustomSignature;
@property (nonatomic) char showSmartReplySuggestions;
...
- (id)initWithThreadIdentifier:(id)a0 senderEmailAddress:(id)a1 toRecipients:(id)a2 ccRecipients:(id)a3 subject:(id)a4 hasCustomSignature:(char)a5 showSmartReplySuggestions:(char)a6 originalMessageCategorySubtype:(id)a7 originalContentMessages:(id)a8;
