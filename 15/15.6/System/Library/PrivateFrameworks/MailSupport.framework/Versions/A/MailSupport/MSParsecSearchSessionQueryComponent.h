...
@property (readonly, nonatomic) char cannedSuggestion;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (id)_structuredQueryForComponents:(id)a0 hasCurrentMailboxScope:(char)a1 languages:(id)a2;
+ (id)freeTextQueryComponentWithString:(id)a0;
+ (id)suggestionAtomQueryComponentWithCategory:(id)a0 scope:(id)a1 queryString:(id)a2 cannedSuggestion:(char)a3;
...
- (id)initWithCategory:(id)a0 scope:(id)a1 queryString:(id)a2 cannedSuggestion:(char)a3;
