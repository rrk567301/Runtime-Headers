...
@property (readonly) char usesExternalViewer;
...
+ (char)_appleTitleExistsInDoc:(id)a0;
...
+ (id)remoteBookWithID:(id)a0 params:(id)a1 isRemote:(char)a2;
...
- (char)_configureType4BookFromDDMConfigDictionary:(id)a0;
...
- (id)initWithID:(id)a0 andCacheDictionary:(id)a1 isRemote:(char)a2;
- (char)isEqualToHelpBook:(id)a0;
- (char)isInSandboxCache;
- (id)pathToResourceAtRelativePath:(id)a0;
- (void)setPathToLoadFrom:(id)a0;
- (char)setPreferredLocalization:(id)a0;
