...
@property (readonly) char frameReorderingRequired;
...
+ (id)logCategory;
+ (char)isInitializationSegment:(id)a0 combinableWithInitializationSegment:(id)a1;
+ (char)canFragmentData:(id)a0;
...
- (char)isCombinableWithFragment:(id)a0;
