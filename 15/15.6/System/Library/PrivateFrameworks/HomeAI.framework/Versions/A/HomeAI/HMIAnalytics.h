...
@property (class, readonly) char upload;
@property (class, readonly) char lazyPayloads;
...
+ (char)sendEventWithName:(id)a0 payloadBuilder:(id /* block */)a1;
...
+ (void)videoPackageAnalyzerDidClassifyCandidateAsPackage:(char)a0 camera:(id)a1;
