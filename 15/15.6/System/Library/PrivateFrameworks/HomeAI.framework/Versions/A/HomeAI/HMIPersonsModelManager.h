@class HMFTimer, NSDictionary, HMFOSTransaction, NSString;
...
+ (char)persistModel:(id)a0 toPath:(id)a1 error:(id *)a2;
+ (char)persistTorsoToFaceCrop:(id)a0 forHomeUUID:(id)a1 error:(id *)a2;
+ (char)persistTorsoprinterVersionForHomeUUID:(id)a0 error:(id *)a1;
+ (char)persistUserDefinedPersonLinks:(id)a0 forHomeUUID:(id)a1 error:(id *)a2;
...
- (char)_hasTorsoprinterVersionChangedForHome:(id)a0;
- (char)_isTorsoFaceCropMapStale:(id)a0;
- (void)_loadTorsoDataForHomeUUID:(id)a0 intoTorsoModelsByHome:(id)a1 torsoToFaceCropByHome:(id)a2;
- (char)_resetStaleTorsoStateForHome:(id)a0 torsoToFaceCropMap:(id)a1;
- (id)buildEquivalencyMapForPersonsModels:(id)a0 userDefinedPersonLinks:(id)a1 error:(id *)a2;
- (char)buildPersonsModelForHomeUUID:(id)a0 sourceUUID:(id)a1 externalLibrary:(char)a2 faceObservationsByPerson:(id)a3 error:(id *)a4;
...
- (char)loadModelsWithError:(id *)a0;
- (id)loadPersonsModelFromURL:(id)a0 externalLibrary:(char)a1 homeUUID:(id)a2 error:(id *)a3;
...
- (char)removePersonsModelForHomeUUID:(id)a0 sourceUUID:(id)a1 error:(id *)a2;
- (id)summaryForHomeUUID:(id)a0 error:(id *)a1;
- (char)updateTorsoModelForHome:(id)a0 torsoAnnotations:(id)a1 error:(id *)a2;
