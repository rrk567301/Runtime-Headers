...
- (void).cxx_destruct;
- (void)flush;
- (char)handleSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 outputFrame:(char)a1;
- (char)_createSessionWithFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
...
- (id)initWithFrameReordering:(char)a0;
