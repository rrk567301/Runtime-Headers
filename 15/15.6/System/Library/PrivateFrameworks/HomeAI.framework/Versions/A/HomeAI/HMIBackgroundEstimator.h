...
@property char adjustBrightness;
...
@property (readonly) char hasNewBackground;
...
- (char)_adjustBackgroundAtAttribute:(const char *)a0 backgroundChanged:(char)a1 timeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2;
...
- (id)_foregroundBlobsFromBlobs:(id)a0 backgroundChanged:(char *)a1;
- (void)_foregroundDifferencesFromPixelBuffer:(struct __CVBuffer { } *)a0 differences:(float *)a1;
- (void)_foregroundPixelsFromPixelBuffer:(struct __CVBuffer { } *)a0 attribute:(char *)a1 assignment:(unsigned short *)a2 useChromaOnly:(char)a3;
...
- (char)_invalidateBackgroundForPixelBuffer:(struct __CVBuffer { } *)a0 timeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
...
- (char)_updateBackgroundFromPixelBuffer:(struct __CVBuffer { } *)a0 timeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
