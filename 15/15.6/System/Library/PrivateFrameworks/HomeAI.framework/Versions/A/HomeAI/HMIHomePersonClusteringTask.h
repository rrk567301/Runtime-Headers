...
@property (readonly) char doImpurePersonCleanup;
...
- (id)initWithTaskID:(int)a0 homeUUID:(id)a1 dataSource:(id)a2 sourceUUID:(id)a3 personsModelManager:(id)a4 doImpurePersonCleanup:(char)a5 error:(id *)a6;
