...
+ (struct __CVBuffer { } *)createPixelBufferWithSize:(struct CGSize { double x0; double x1; })a0 pixelFormat:(unsigned int)a1 useIOSurface:(char)a2;
...
+ (struct __CVBuffer { } *)cropPixelBuffer:(struct __CVBuffer { } *)a0 crop:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 options:(long long)a2 error:(id *)a3;
...
+ (char)isPixelFormatCompressed:(unsigned int)a0;
