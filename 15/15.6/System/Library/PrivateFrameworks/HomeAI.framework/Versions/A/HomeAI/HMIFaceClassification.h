...
@property (readonly) char fromTorsoClassification;
...
- (id)initWithPersonUUID:(id)a0 sourceUUID:(id)a1 confidence:(double)a2 fromTorsoClassification:(char)a3 familiarity:(long long)a4;
...
- (id)initWithUUID:(id)a0 sourceUUID:(id)a1 sessionEntityUUID:(id)a2 faceCrop:(id)a3 faceprint:(id)a4 confidence:(double)a5 fromTorsoClassification:(char)a6 familiarity:(long long)a7;
