...
@property char forceKeyFrameOnNextEncodedFrame;
...
- (char)_initSessionWithDimensions:(struct { int x0; int x1; })a0 codecType:(unsigned int)a1 useHardwareAcceleration:(char)a2 error:(id *)a3;
...
- (id)initWithDimensions:(struct { int x0; int x1; })a0 codecType:(unsigned int)a1 useHardwareAcceleration:(char)a2 error:(id *)a3;
