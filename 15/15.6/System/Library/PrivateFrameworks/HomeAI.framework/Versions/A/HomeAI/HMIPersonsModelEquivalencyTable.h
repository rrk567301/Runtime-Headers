...
- (char)facesAreSamePersonFromSet:(id)a0 andSet:(id)a1;
- (char)facesAreSamePersonFromSet:(id)a0 andSet:(id)a1 distanceThreshold:(double)a2 percentMatchingThreshold:(double)a3;
- (id)initWith;
