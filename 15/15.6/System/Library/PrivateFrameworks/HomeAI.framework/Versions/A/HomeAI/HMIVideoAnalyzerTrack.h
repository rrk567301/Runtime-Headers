...
- (char)isClassified;
- (char)isExpiredAtTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (char)isLostAtTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (char)isStationaryAtTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
