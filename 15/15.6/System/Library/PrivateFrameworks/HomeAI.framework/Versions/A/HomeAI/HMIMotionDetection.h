...
- (void).cxx_destruct;
- (id)classPaddingMap;
- (char)applyEventTypeAndCheckIfSubBoundingIsStatic:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 eventClass:(Class)a1 confidence:(float)a2;
