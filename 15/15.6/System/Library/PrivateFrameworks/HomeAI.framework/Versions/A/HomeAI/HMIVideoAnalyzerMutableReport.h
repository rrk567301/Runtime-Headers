...
- (void)appendFragmentResult:(id)a0 forKey:(id)a1 source:(id)a2 redactFrames:(char)a3;
...
- (id)averagePrecisionWithDetectionTruth:(id)a0 minPrecision:(float)a1 iouThreshold:(float)a2 videoMetric:(char)a3;
- (id)chartDataWithBaseline:(char)a0 comparator:(id /* block */)a1;
- (id)chartDataWithClassificationTruth:(id)a0 isBaseline:(char)a1;
- (id)chartDataWithDetectionTruth:(id)a0 isBaseline:(char)a1 iouThreshold:(float)a2 videoMetric:(char)a3;
- (id)compareWithClassificationTruth:(id)a0 eventClass:(Class)a1 confidenceThreshold:(float)a2;
- (id)compareWithDetectionTruth:(id)a0 eventClass:(Class)a1 confidenceThreshold:(float)a2 iouThreshold:(float)a3 videoMetric:(char)a4;
...
- (void)writeHTMLReportComparison:(id)a0 truth:(id)a1 eventClass:(Class)a2 comparisonType:(id)a3 assetPath:(id)a4 outputPath:(id)a5 limit:(unsigned long long)a6 shuffle:(char)a7;
