...
- (char)_resetPreviousFrameResult:(id)a0 expirationPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 regionOfInterest:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
