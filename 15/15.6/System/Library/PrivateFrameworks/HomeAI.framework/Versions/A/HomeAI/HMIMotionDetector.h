...
- (char)applyActivityZoneFilteringOnSourcePoint:(struct CGPoint { double x0; double x1; })a0 destinationPoint:(struct CGPoint { double x0; double x1; })a1 frameSize:(struct CGSize { double x0; double x1; })a2 activityZones:(id)a3;
