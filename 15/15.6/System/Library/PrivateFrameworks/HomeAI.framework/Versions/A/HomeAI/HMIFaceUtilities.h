...
+ (char)saveFaceClassifications:(id)a0 videoId:(id)a1 fragmentId:(unsigned long long)a2 frameId:(id)a3 baseURL:(id)a4 error:(id *)a5;
+ (char)serializeJSONObject:(id)a0 url:(id)a1 error:(id *)a2;
