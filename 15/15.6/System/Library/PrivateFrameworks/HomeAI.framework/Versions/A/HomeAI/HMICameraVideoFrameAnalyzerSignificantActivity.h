...
- (void).cxx_destruct;
- (id)flushAndGetAnalysisStateUpdateForHome:(id)a0 enableFaceClassification:(char)a1;
...
- (id)_targetEventsSetFromEventTriggers:(long long)a0 enableFaceClassification:(char)a1 enableTorsoRecognition:(char)a2;
...
- (id)getAnalyzerEvents:(id)a0 eventTriggers:(long long)a1 enableFaceClassification:(char)a2 enableTorsoRecognition:(char)a3;
