...
- (char)_runNeuralNetworkOnPixelBuffer:(struct __CVBuffer { } *)a0 offsetsZero:(id)a1 offsetsOne:(id)a2 scores:(id)a3 yaws:(id)a4 rolls:(id)a5 error:(id *)a6;
- (id)initWithConfidenceThresholds:(id)a0 nmsConfiguration:(id)a1 error:(id *)a2;
- (char)predict:(struct __CVBuffer { } *)a0 detectedObjects:(id)a1 error:(id *)a2;
