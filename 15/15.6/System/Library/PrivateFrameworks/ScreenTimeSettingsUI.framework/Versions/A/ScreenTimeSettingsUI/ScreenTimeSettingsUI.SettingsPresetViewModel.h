...
- (id)initWithDsid:(id)a0 childAge:(id)a1 isInitialSetup:(char)a2 restrictionsToPresetMappingViewModel:(id)a3 restrictionsDataSource:(id)a4 agePresetsAnalytics:(id)a5;
