...
@property (readonly, nonatomic) char editListButtonEnabled;
...
@property (readonly, nonatomic) char contactManagementHidden;
@property (readonly, nonatomic) char contactEditButtonHidden;
@property (readonly, nonatomic) char allowContactEditingHidden;
@property (readonly, nonatomic) char allowContactEditingEnabled;
@property (nonatomic) char isValidatingSpecificContacts;
@property (nonatomic) char isValidatingWhitelistedContacts;
@property (retain) STCoreUsersController *representedObject;
@property (readonly, copy, nonatomic) NSString *descriptionString;
@property (nonatomic) char showContactsManagingControls;
...
- (char)_familyMemberChangedForOldUser:(id)a0 newUser:(id)a1;
...
- (void)_setAllowContactEditing:(char)a0;
