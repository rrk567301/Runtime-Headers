@class SFCard, NSString, NSData, NSArray, SFImage, SFColor, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, SFRichText, NSMutableDictionary;

@interface SFNewsCardSection : SFCardSection <SFNewsCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char overlayTextInImage : 1; } _has;
}
...
@property (nonatomic) char overlayTextInImage;
