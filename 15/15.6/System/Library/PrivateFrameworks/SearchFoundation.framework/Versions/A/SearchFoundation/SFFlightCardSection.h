@class SFColor, NSString, SFFlight, NSData, NSArray, SFCard, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;

@interface SFFlightCardSection : SFCardSection <SFFlightCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char selectedLegIndex : 1; } _has;
}
