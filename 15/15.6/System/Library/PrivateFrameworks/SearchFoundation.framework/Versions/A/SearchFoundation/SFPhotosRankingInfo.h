...
- (char)hasTotalNumberOfAssetsInLibrary;
- (char)hasAssetEstimationOffAmount;
- (char)hasTotalNumberOfAssetsIndexed;
- (char)hasTotalNumberOfEmbeddingMatchedAssets;
- (char)hasTotalNumberOfMetadataMatchedAssets;
