@class SFColor, NSString, NSArray, NSData, SFCard, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, NSMutableDictionary, SFRichText;

@interface SFHeroTitleCardSection : SFCardSection <SFHeroTitleCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char maxVisibleButtonItems : 1; } _has;
}
