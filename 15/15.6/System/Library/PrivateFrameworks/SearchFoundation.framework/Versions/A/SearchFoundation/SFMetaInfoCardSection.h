@class SFCard, NSString, NSURL, NSData, SFImage, NSArray, NSDictionary, SFColor, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;

@interface SFMetaInfoCardSection : SFCardSection <SFMetaInfoCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char trending : 1; } _has;
}

@property (class, readonly) char supportsSecureCoding;

@property (copy, nonatomic) NSString *type;
@property (nonatomic) char trending;
