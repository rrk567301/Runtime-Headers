...
@interface SFVerticalLayoutCardSection : SFCardSection <SFVerticalLayoutCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char contentsLeading : 1; unsigned char useAppIconMetrics : 1; } _has;
}
...
@property (nonatomic) char contentsLeading;
...
- (char)hasContentsLeading;
- (char)hasUseAppIconMetrics;
