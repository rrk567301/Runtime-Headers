@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFButtonItem, RFVisualProperty, NSString, RFTextProperty, SFCommand, NSArray, NSData, SFUserReportRequest;

@interface RFSummaryItemButtonCardSection : SFCardSection <RFSummaryItemButtonCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char buttonItemsAreTrailing : 1; } _has;
}
...
- (char)hasButtonItemsAreTrailing;
