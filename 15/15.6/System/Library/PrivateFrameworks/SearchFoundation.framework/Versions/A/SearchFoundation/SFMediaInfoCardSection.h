@class NSMutableDictionary, SFColor, SFActionItem, SFCard, NSDictionary, SFAppEntityAnnotation, NSString, SFCommand, SFRichText, SFMediaItem, NSData, NSArray, SFUserReportRequest;

@interface SFMediaInfoCardSection : SFCardSection <SFMediaInfoCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char isMediaContainer : 1; unsigned char watchListItemType : 1; } _has;
}
...
@property (nonatomic) char isMediaContainer;
...
- (char)hasIsMediaContainer;
- (char)hasWatchListItemType;
