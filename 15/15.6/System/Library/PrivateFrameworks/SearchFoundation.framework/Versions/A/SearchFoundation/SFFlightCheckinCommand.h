...
@interface SFFlightCheckinCommand : SFCommand <SFFlightCheckinCommand, NSSecureCoding, NSCopying> {
    struct { unsigned char placeHolderProperty : 1; } _has;
}

@property (class, readonly) char supportsSecureCoding;

@property (nonatomic) char placeHolderProperty;
