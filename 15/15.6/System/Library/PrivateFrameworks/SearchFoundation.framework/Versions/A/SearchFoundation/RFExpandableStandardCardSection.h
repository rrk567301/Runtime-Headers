@class NSData, NSString, RFSummaryItemStandardCardSection, NSArray, SFCard, SFColor, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
...
- (char)hasSummary_item_standard_card_section;
