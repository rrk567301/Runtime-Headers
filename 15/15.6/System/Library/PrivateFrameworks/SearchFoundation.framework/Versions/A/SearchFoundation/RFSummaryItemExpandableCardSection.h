@class SFCard, RFTextProperty, NSArray, NSData, NSString, SFColor, NSDictionary, RFSummaryItemAttribution, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;

@interface RFSummaryItemExpandableCardSection : SFCardSection <RFSummaryItemExpandableCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char attribution_ignores_expansion : 1; } _has;
}
...
@property (nonatomic) char attribution_ignores_expansion;
...
- (char)hasAttribution_ignores_expansion;
