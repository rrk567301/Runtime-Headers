@class SFColor, NSData, NSArray, RFTextProperty, NSString, SFCard, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;

@interface RFLongItemStandardCardSection : SFCardSection <RFLongItemStandardCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char is_quote : 1; unsigned char has_background_platter : 1; } _has;
}

@property (class, readonly) char supportsSecureCoding;

@property (retain, nonatomic) RFTextProperty *text_1;
@property (nonatomic) char is_quote;
@property (nonatomic) char has_background_platter;
...
- (char)hasHas_background_platter;
- (char)hasIs_quote;
