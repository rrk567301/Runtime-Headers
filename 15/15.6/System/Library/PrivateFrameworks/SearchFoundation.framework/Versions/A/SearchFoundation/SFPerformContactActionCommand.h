...
@property (nonatomic) char didDisplayHandleOptions;
@property (nonatomic) char didSelectFromOptionsMenu;
...
- (char)hasContactActionType;
- (char)hasDidDisplayHandleOptions;
- (char)hasDidSelectFromOptionsMenu;
