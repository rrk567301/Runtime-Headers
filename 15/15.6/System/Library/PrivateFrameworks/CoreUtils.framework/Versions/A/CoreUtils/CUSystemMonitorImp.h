...
- (void)_systemConfigSystemNameChanged:(char)a0;
...
- (char)_hasMonitorPassingTest:(id /* block */)a0;
- (void)_invokeBlock:(id /* block */)a0 passingTest:(id /* block */)a1;
- (void)_locationVisitUpdate:(id)a0 arrived:(char)a1;
- (void)_locationVisitsMonitorStart;
- (void)_locationVisitsMonitorStop;
- (void)_locationsOfInterestDidChange:(char)a0;
- (void)_manateeChanged:(id)a0;
- (void)_manateeMonitorStart;
- (void)_manateeMonitorStop;
- (void)_manateeRead;
- (void)_manatreeUpdateRetryTimer:(char)a0;
- (void)_meDeviceCheckCompletion:(id)a0 error:(id)a1 firstCheck:(char)a2;
- (void)_meDeviceCheckStart:(char)a0;
- (void)_meDeviceMonitorStart;
- (void)_meDeviceMonitorStop;
- (void)_meDeviceMonitorStopFMF;
- (char)_meDeviceOverride;
- (void)_meDeviceRetryTimerUpdate:(char)a0;
...
- (void)_primaryAppleIDChanged2:(char)a0;
...
- (void)_screenSaverChanged:(char)a0;
- (void)_screenSaverDidStart:(id)a0;
- (void)_screenSaverDidStop:(id)a0;
- (void)_screenSaverMonitorStart;
- (void)_screenSaverMonitorStop;
- (void)_systemConfigChanged:(id)a0 initial:(char)a1;
- (void)_systemConfigConsoleUserChanged:(char)a0;
- (void)_systemConfigNetInterfaceChanged:(id)a0 initial:(char)a1;
- (void)_systemConfigUpdateKeyPtr:(id *)a0 name:(id)a1 enabled:(char)a2 creator:(id /* block */)a3;
- (void)_systemConfigUpdateNotifications;
- (void)_systemLockStateMonitorStart;
- (void)_systemLockStateMonitorStop;
- (void)_systemLockStateUpdate:(char)a0;
...
- (void)_wifiMonitorStateChanged:(char)a0;
