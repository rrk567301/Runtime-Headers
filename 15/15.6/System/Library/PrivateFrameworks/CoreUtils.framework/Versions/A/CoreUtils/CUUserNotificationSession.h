@class NSError, NSString, NSArray, NSMutableDictionary, NSDictionary, UNNotificationSound, NSObject, UNUserNotificationCenter;
...
- (char)_runInit:(id *)a0;
- (char)_runRequestAddStart:(id *)a0;
- (char)_runResponse:(id)a0 error:(id *)a1;
