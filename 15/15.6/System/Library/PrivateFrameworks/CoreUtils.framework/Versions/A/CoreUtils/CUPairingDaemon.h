...
- (int)_removePairedPeer:(id)a0 options:(unsigned long long)a1 removeAdminAllowed:(char)a2;
- (void)_rpIdentityUpdate;
- (int)_saveIdentity:(id)a0 options:(unsigned long long)a1;
- (int)_savePairedPeer:(id)a0 options:(unsigned long long)a1 removeAdminAllowed:(char)a2;
...
- (int)removePairedPeer:(id)a0 options:(unsigned long long)a1 removeAdminAllowed:(char)a2;
- (int)savePairedPeer:(id)a0 options:(unsigned long long)a1;
- (int)savePairedPeer:(id)a0 options:(unsigned long long)a1 removeAdminAllowed:(char)a2;
