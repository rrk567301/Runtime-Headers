@class NSError, NSString, CUWriteRequest, CUReadRequest, CUNANDataSession, CUBonjourDevice, CUWiFiManager, NSMutableArray, NSObject, CUNetLinkEndpoint, CUNetLinkManager;
...
- (void)_processWrites:(char)a0;
- (void)_abortReadsWithError:(id)a0;
- (void)_abortWritesWithError:(id)a0;
- (char)_activateDirectAndReturnError:(id *)a0;
...
- (char)_startConnectingToBonjourDevice:(id)a0 error:(id *)a1;
- (char)_startConnectingToDestination:(id)a0 error:(id *)a1;
