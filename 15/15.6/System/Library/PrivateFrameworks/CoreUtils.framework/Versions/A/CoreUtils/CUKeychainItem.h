...
@property (nonatomic) char invisible;
...
- (char)_updateWithAttributesDictionary:(id)a0 flags:(unsigned int)a1 error:(id *)a2;
- (id)descriptionWithLevel:(int)a0;
- (char)isEqualToKeychainItem:(id)a0 flags:(unsigned int)a1;
