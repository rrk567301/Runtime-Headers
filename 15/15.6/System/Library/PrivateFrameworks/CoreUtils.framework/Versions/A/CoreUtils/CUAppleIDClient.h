...
- (char)_validatePeerHashes:(id)a0;
...
- (char)validatePeerWithFlags:(unsigned int)a0 error:(id *)a1;
- (char)verifyBytes:(const void *)a0 verifyLength:(unsigned long long)a1 signatureBytes:(const void *)a2 signatureLength:(unsigned long long)a3 error:(id *)a4;
- (char)verifyData:(id)a0 signature:(id)a1 error:(id *)a2;
