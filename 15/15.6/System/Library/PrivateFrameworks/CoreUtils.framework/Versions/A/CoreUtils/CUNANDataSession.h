@class WiFiAwareDataSession, NSString, WiFiAwarePublisherDataSessionHandle, WiFiAwarePublisher, WiFiAwarePublishDatapathServiceSpecificInfo, NSObject, CUNANEndpoint;
...
@property (nonatomic) char wfaPairingCacheEnabled;
...
- (char)_dataSession:(id)a0 confirmedForPeerDataAddress:(id)a1 serviceSpecificInfo:(id)a2 error:(id *)a3;
