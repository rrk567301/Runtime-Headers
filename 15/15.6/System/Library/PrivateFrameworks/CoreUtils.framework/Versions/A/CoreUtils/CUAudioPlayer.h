...
- (void)_playURL:(id)a0 loop:(char)a1 completion:(id /* block */)a2;
...
- (void)playURL:(id)a0 loop:(char)a1 completion:(id /* block */)a2;
- (void)prepareURL:(id)a0 identifier:(id *)a1 completion:(id /* block */)a2;
- (char)setPortUID:(id)a0 channelName:(id)a1 error:(id *)a2;
