@class NSString, NSArray, NSData, NSBundle, NSObject;
...
@property char meDeviceUseFindMyLocate;
...
@property (readonly, nonatomic) char firstUnlocked;
@property (readonly, nonatomic) char firstUnlockedSync;
