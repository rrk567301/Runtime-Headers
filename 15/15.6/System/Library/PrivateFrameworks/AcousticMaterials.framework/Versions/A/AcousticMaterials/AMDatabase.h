...
+ (char)closeDatabase:(out id *)a0;
+ (char)openDatabase:(out id *)a0;
...
+ (char)checkDatabaseReadAccess:(out id *)a0;
+ (id)labelsForSemanticType:(id)a0 error:(out id *)a1;
+ (id)materialNamesForAcousticParameterType:(id)a0 error:(out id *)a1;
+ (char)openDatabaseWithAcousticParameterFilter:(unsigned long long)a0 error:(out id *)a1;
