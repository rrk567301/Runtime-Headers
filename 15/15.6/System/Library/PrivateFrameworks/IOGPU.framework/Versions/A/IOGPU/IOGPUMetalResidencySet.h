...
- (char)_commitAddedAllocations:(const id *)a0 count:(unsigned long long)a1 removedAllocations:(const id *)a2 count:(unsigned long long)a3;
- (char)_commitAddedHeaps:(const id *)a0 count:(unsigned long long)a1 removedHeaps:(const id *)a2 count:(unsigned long long)a3;
- (char)_commitAddedResources:(const id *)a0 count:(unsigned long long)a1 removedResources:(const id *)a2 count:(unsigned long long)a3;
