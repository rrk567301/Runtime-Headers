...
- (void)_buildData:(id)a0 timestamp:(unsigned long long)a1 cpuInfo:(struct processor_basic_info { int x0; int x1; unsigned int x2; int x3; union { unsigned int x0; unsigned int x1; } x4; } *)a2;
