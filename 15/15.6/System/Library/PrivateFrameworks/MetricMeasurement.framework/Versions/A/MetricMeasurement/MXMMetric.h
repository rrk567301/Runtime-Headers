...
@property (readonly, nonatomic) char _shouldConstructProbe;
@property (readonly, nonatomic) char _shouldAlwaysWrapInProxy;
@property (readonly, nonatomic) char _shouldNeverWrapInProxy;
...
- (char)harvestData:(id *)a0 error:(id *)a1;
- (id)initWithIdentifier:(id)a0 filter:(id)a1;
- (void)probeDidUpdate:(id)a0 data:(id)a1 stop:(char *)a2;
