...
@property (readonly, nonatomic) char ignoresGuardianRestrictionsDuringValidation;

+ (void)initialize;
+ (id)os_log;
+ (char)_isPublicRecord;
+ (char)hasAddressBookContentForRecord:(id)a0;
+ (id)_newUniqueIdForTable:(id)a0;
+ (id)_table;
+ (char)abEntityKnowsKey:(id)a0 inManagedObjectContext:(id)a1;
+ (id)abEntityName;
...
+ (char)validateContainedRecord:(id)a0 forGuardianRestrictions:(id *)a1;
...
- (char)_isPublicRecord;
- (id)_table;
- (char)_valueHasChangedForKey:(id)a0;
...
- (char)isKindOfEntityNamed:(id)a0;
