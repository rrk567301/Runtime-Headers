...
- (id)initWithIdentifier:(id)a0 name:(id)a1 type:(long long)a2 persistentStoreURL:(id)a3 persistentStoreIdentifier:(id)a4 permissions:(id)a5 guardianRestricted:(char)a6 lastSyncDate:(id)a7 iOSLegacyIdentifier:(int)a8 externalIdentifier:(id)a9 providerIdentifier:(id)a10 providerMetadata:(id)a11;
