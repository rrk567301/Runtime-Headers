...
+ (char)assignIOSLegacyIdentifiersToInsertedRecordsInManagedObjectContext:(id)a0 error:(id *)a1;
+ (char)assignIOSLegacyIdentifiersToInsertedRecordsInManagedObjectContext:(id)a0 registrar:(id)a1 error:(id *)a2;
