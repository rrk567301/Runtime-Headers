...
@property (nonatomic, readonly) char has_adamID;
...
@property (nonatomic, readonly) char has_previewGenerationSizeHeight;
@property (nonatomic, readonly) double previewGenerationSizeHeight;
@property (nonatomic, readonly) char has_previewGenerationSizeWidth;
