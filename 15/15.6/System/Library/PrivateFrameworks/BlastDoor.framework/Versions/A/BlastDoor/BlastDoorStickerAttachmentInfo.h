...
@property (nonatomic, readonly) char has_positionIntent;
@property (nonatomic, readonly) unsigned long long positionIntent;
@property (nonatomic, readonly) char has_associatedPositionIntent;
@property (nonatomic, readonly) unsigned long long associatedPositionIntent;
@property (nonatomic, readonly) char has_parentPreviewWidth;
@property (nonatomic, readonly) double parentPreviewWidth;
@property (nonatomic, readonly) char has_stickerOffset;
@property (nonatomic, readonly) struct CGPoint { double x0; double x1; } stickerOffset;
@property (nonatomic, readonly) char has_stickerScale;
@property (nonatomic, readonly) double stickerScale;
@property (nonatomic, readonly) char has_stickerRotation;
@property (nonatomic, readonly) double stickerRotation;
@property (nonatomic, readonly) char isReaction;
@property (nonatomic, readonly) char has_stickerPositionVersion;
