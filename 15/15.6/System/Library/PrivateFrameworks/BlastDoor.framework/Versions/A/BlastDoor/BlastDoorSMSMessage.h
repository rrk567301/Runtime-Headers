@class NSString, NSArray, NSDate, BlastDoorSMSMessage_SMSFilteringSettings;
...
@property (nonatomic, readonly) char has_spamCategory;
...
@property (nonatomic, readonly) char has_iMessageCapability;
...
@property (nonatomic, readonly) char has_replaceMessage;
...
@property (nonatomic, readonly) char has_trackMessage;
@property (nonatomic, readonly) char trackMessage;
@property (nonatomic, readonly) char has_sendEnabled;
@property (nonatomic, readonly) char sendEnabled;
@property (nonatomic, readonly) char foundAppleGUID;
