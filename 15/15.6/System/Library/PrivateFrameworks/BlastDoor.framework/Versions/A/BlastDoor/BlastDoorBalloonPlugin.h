@class NSString, NSArray, BlastDoorEncodedAttachments, BlastDoorBalloonPluginPayloadWrapper, NSAttributedString;
...
@property (nonatomic, readonly) char has_associatedMessageRange;
@property (nonatomic, readonly) struct _NSRange { unsigned long long x0; unsigned long long x1; } associatedMessageRange;
@property (nonatomic, readonly) char has_associatedMessageType;
