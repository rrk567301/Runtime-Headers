...
@interface NTPBAdCtaEngagement : PBCodable <NSCopying> {
    struct { unsigned char videoAdDuration : 1; unsigned char videoAdPlayTime : 1; unsigned char adCreativeType : 1; unsigned char adCtaEngagemetType : 1; unsigned char adEngagementType : 1; unsigned char adLocation : 1; unsigned char adType : 1; unsigned char feedType : 1; unsigned char newsProductType : 1; unsigned char videoAdPlacementPosition : 1; unsigned char videoAdType : 1; unsigned char videoAdViewComplete : 1; } _has;
}

@property (nonatomic) char hasAdCtaEngagemetType;
...
@property (nonatomic) char hasAdEngagementType;
...
@property (nonatomic) char hasVideoAdPlayTime;
...
@property (nonatomic) char hasVideoAdViewComplete;
@property (nonatomic) char videoAdViewComplete;
