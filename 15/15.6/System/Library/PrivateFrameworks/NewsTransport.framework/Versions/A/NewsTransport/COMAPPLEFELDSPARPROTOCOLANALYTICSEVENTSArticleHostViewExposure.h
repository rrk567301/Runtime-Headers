@class COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSAlternateHeadline, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement, NSString, NSData, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposureData, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData, NSMutableArray, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewData, COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewContextData;
...
- (int)StringAsArticleHostViewType:(id)a0;
- (int)StringAsArticleSuggestionOrigin:(id)a0;
- (int)StringAsArticleViewPresentationReason:(id)a0;
...
- (int)StringAsHeroArticleType:(id)a0;
- (int)StringAsModuleLocation:(id)a0;
- (int)StringAsParentFeedType:(id)a0;
- (int)StringAsPreviousArticleHostViewTypeIfSwipe:(id)a0;
...
- (id)articleHostViewTypeAsString:(int)a0;
- (id)articleSuggestionOriginAsString:(int)a0;
- (id)articleTypeAsString:(int)a0;
- (id)articleViewPresentationReasonAsString:(int)a0;
- (void)clearFractionalCohortMemberships;
- (void)clearPurchaseOffersItems;
- (void)clearSurfacedByTagIds;
- (void)clearTopicIds;
- (id)coverArticleFeatureTypeAsString:(int)a0;
...
- (id)heroArticleTypeAsString:(int)a0;
- (id)loadFailureReasonAsString:(int)a0;
...
- (id)previousArticleHostViewTypeIfSwipeAsString:(int)a0;
