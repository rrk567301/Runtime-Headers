...
@interface NTPBArticleLikeDislike : PBCodable <NSCopying> {
    struct { unsigned char backendArticleVersionInt64 : 1; unsigned char personalizationTreatmentId : 1; unsigned char previousArticlePublisherArticleVersion : 1; unsigned char publisherArticleVersionInt64 : 1; unsigned char articleType : 1; unsigned char backendArticleVersion : 1; unsigned char characterCount : 1; unsigned char contentType : 1; unsigned char feedType : 1; unsigned char groupType : 1; unsigned char likeDislikeLocation : 1; unsigned char nextArticleAffordanceType : 1; unsigned char publisherArticleVersion : 1; unsigned char topStoryType : 1; unsigned char userAction : 1; unsigned char fromNextArticleAffordanceTap : 1; unsigned char isBreakingNewsArticle : 1; unsigned char isCoverArticle : 1; unsigned char isDigitalReplicaAd : 1; unsigned char isFreeArticle : 1; unsigned char isGroupedArticle : 1; unsigned char isNativeAd : 1; unsigned char isPaidSubscriberToSourceChannel : 1; unsigned char isSearchResultArticle : 1; unsigned char isTopStoryArticle : 1; unsigned char isUserSubscribedToFeed : 1; } _has;
}
...
@property (nonatomic) char hasLikeDislikeLocation;
