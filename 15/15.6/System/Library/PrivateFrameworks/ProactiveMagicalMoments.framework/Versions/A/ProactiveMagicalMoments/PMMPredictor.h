...
@property (nonatomic) char unlockedSinceBoot;
...
+ (id)sharedInstance;
+ (char)_predictionPopulatesContinuity:(id)a0;
+ (char)_predictionIsAudio:(id)a0;
+ (char)_predictionPopulatesNowPlaying:(id)a0 fromUnitTest:(char)a1;
+ (char)_predictionPopulatesSpringboard:(id)a0;
+ (char)_predictionPopulatesStark:(id)a0;
+ (char)bundleSupportsINPlayMediaIntentForBundleId:(id)a0 fromUnitTest:(char)a1;
+ (id)getHighestConfidencePredictionForNowPlayingConsumerFromPredictions:(id)a0 fromUnitTest:(char)a1;
...
- (id)_publishPredictionWithPredictedApplication:(id)a0 fromUnitTest:(char)a1;
- (char)_recommendingAudioWhileAlreadyPlaying:(id)a0;
...
- (void)dataProtectionMonitor:(id)a0 unlockedSinceBoot:(char)a1;
