...
@property (readonly, nonatomic) char useUniformSampling;
...
- (id)initWithOptions:(id)a0 framesPerSync:(unsigned long long)a1 frameLimit:(id)a2 sensitiveFrameCountThreshold:(unsigned long long)a3 useUniformSampling:(char)a4;
