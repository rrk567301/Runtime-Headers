...
@property (readonly) char otgxRetrieveAllClasses;
...
- (char)isSensitive:(id)a0 sensitivityScore:(id *)a1;
- (char)isSensitive:(id)a0 sensitivityScore:(id *)a1 classificationMode:(unsigned long long)a2;
- (char)loadNetworkForURL:(id)a0 espressoEngine:(int)a1 storageType:(int)a2 deviceId:(int)a3;
- (id)scaleMethod;
- (char)shouldProcessDetections;
