...
+ (char)removePersistentStoreWithError:(id *)a0;
+ (id)_persistentStoreDirURL;

- (void).cxx_destruct;
- (id)_fetchRecordWithRelatedUniqueIdentifier:(id)a0 context:(id)a1 error:(id *)a2;
- (char)_saveContext:(id)a0 error:(id *)a1;
- (id)fetchUserActivityWithRelatedUniqueIdentifier:(id)a0 error:(id *)a1;
- (char)saveUserActivity:(id)a0 forRelatedUniqueIdentifier:(id)a1 sourceBundleIdentifier:(id)a2 error:(id *)a3;
