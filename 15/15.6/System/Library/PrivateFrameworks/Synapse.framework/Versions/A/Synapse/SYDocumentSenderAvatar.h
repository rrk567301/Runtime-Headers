...
- (void).cxx_destruct;
- (void)fetchThumbnailImagesWithScale:(double)a0 isRTL:(char)a1 completion:(id /* block */)a2;
- (id)initWithDocumentSender:(id)a0;
- (id)_createAvatarImageRenderer;
- (id)_createContactFromPersonNameComponents:(id)a0;
- (id)_createRenderingScopeWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 isRTL:(char)a2;
- (id)_defaultThumbnailImageWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 isRTL:(char)a2;
...
- (id)fetchThumbnailImagesWithScale:(double)a0 isRTL:(char)a1;
