...
- (void)createAndShowContextualLinkWithUserActivity:(id)a0 linkPreviewMetadata:(id)a1 preferNewDocument:(char)a2 completion:(id /* block */)a3;
...
- (void)_sendRequestToCreateLinkWithContentItemData:(id)a0 preferNewDocument:(char)a1 completion:(id /* block */)a2;
