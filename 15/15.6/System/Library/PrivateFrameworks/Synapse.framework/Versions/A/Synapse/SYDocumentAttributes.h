...
+ (char)removeDocumentAttributesForFileAtURL:(id)a0 error:(id *)a1;
+ (void)fetchDocumentAttributesForFileAtURL:(id)a0 completion:(id /* block */)a1;
+ (void)_removeDocumentAttributesForFileAtURL:(id)a0 keepDocumentRelatedUniqueIdentifierKey:(char)a1 completion:(id /* block */)a2;
+ (char)_removeDocumentAttributesForFileAtURL:(id)a0 keepDocumentRelatedUniqueIdentifierKey:(char)a1 error:(id *)a2;
...
- (char)saveToFileURL:(id)a0 additionalAttributes:(id)a1 error:(id *)a2;
