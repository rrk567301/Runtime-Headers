...
- (id)archiveItemsWithURLs:(id)a0 passphrase:(id)a1 addToKeychain:(char)a2 compressionFormat:(unsigned long long)a3 destinationFolderURL:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)receiveArchivedItemsDescriptors:(id)a0 placeholderName:(id)a1 placeholderTypeIdentifier:(id)a2;
- (id)unarchiveItemAtURL:(id)a0 passphrase:(id)a1 destinationFolderURL:(id)a2 completionHandler:(id /* block */)a3;
- (id)unarchiveItemAtURL:(id)a0 passphrases:(id)a1 addToKeychain:(char)a2 destinationFolderURL:(id)a3 acceptedFormats:(unsigned long long)a4 completionHandler:(id /* block */)a5;
