...
@property char registrationCompleted;
@property unsigned long long loginType;
@property char sharedDeviceKeys;
@property long long protocolVersion;
@property (copy) NSNumber *sdkVersionString;
@property char createUsersEnabled;
@property char authorizationEnabled;
...
@property (nonatomic) char allowDeviceIdentifiersInAttestation;
...
- (char)encryptAndSaveTemporaryAccountCredential:(id)a0;
- (char)supportsCreateNewUsers;
- (char)supportsCreateTemporaryUsers;
- (char)supportsTokenUnlock;
