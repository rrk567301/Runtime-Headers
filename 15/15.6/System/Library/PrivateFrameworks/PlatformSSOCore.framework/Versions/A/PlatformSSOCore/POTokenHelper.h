...
- (char)waitForTokenAvailable:(id)a0;
- (id)base64URLtokenHashForUser:(id)a0;
- (char)canTokenIdLogin:(id)a0 pubKeyHash:(id)a1;
- (id)findInfoForTokenId:(id)a0;
- (id)getDriverConfiguration;
- (char)retrieveCertAndKeyForTokenId:(id)a0 context:(id)a1 certificate:(struct __SecCertificate **)a2 privateKey:(struct __SecKey **)a3;
