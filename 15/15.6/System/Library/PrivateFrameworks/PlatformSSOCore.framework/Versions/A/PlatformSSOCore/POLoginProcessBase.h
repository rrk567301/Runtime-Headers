...
@property (readonly, nonatomic) char isSmartCardAuth;
@property (readonly, nonatomic) char isLAAuth;
...
@property (nonatomic) char registrationCompleted;

- (void).cxx_destruct;
- (char)checkPolicyIfPlatformSSOAccount;
- (char)createPasswordCredentialContext;
- (char)checkForUserNameAndDeviceRegistration;
- (char)checkIfUserIsRegistered;
- (char)checkPolicyForAuthBypass:(unsigned long long)a0;
- (id)contextStringWithoutNULL:(const char *)a0;
- (void)createBiometricCredentialContext;
- (void)createConfigurationManager;
- (char)createSmartCardCredentialContext;
...
- (void)setContextBool:(char)a0 withFlags:(unsigned int)a1 forKey:(const char *)a2;
- (char)setContextData:(char *)a0 withSize:(unsigned long long)a1 withFlags:(unsigned int)a2 forKey:(const char *)a3;
