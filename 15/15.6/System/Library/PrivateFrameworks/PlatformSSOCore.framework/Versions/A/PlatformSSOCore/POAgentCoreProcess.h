...
- (void)_verifyLogin:(id)a0 passwordContext:(id)a1 smartCardContext:(id)a2 tokenId:(id)a3 deviceConfiguration:(id)a4 loginConfiguration:(id)a5 forAuthorization:(char)a6 completion:(id /* block */)a7;
...
- (char)verifySecurityEntitlement;
