@class NSArray, NSString, NSOperationQueue, POWSTrustProcess;
...
@property (nonatomic) char waitForConnectivity;
...
- (void)_performNonceRequestWithContext:(id)a0 request:(id)a1 completion:(id /* block */)a2;
...
- (void)addCryptoHeadersToJWTBody:(id)a0 context:(id)a1;
...
- (char)validateIdToken:(id)a0 context:(id)a1 key:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a2;
- (char)validatePartyUInfo:(id)a0 context:(id)a1;
- (char)validatePartyVInfo:(id)a0 context:(id)a1 publicKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a2;
- (unsigned long long)validateWSTrustAuthenticationResponseWithContext:(id)a0 response:(id)a1 returningAssertion:(id *)a2;
- (char)validateWSTrustMexResponseWithContext:(id)a0 response:(id)a1;
