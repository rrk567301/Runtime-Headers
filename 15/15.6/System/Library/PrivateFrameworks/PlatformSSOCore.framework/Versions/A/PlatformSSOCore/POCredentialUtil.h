...
+ (char)encryptPendingSSOTokens:(id)a0 usingPublicKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a1 sharedData:(id)a2 encryptedTokens:(id *)a3;
+ (id)maskName:(id)a0;
