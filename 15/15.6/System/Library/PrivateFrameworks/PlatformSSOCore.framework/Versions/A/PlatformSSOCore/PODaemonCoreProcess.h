...
+ (char)createPrebootKey:(struct __SecKey **)a0 encryptedKey:(id *)a1 error:(id *)a2;
...
- (char)_removeStashedUserLoginStateListDataWithError:(id *)a0;
- (char)_savePendingSSOTokensData:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
- (char)_saveStashedDecryptionContextData:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
- (char)_saveStashedSSOTokensData:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
...
- (char)writeData:(id)a0 toPath:(id)a1 saveError:(id *)a2;
...
- (id)initWithXPCConnection:(id)a0 baseSystem:(char)a1;
