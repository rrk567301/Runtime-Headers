...
+ (char)isSceneGraphNode:(id)a0;
+ (char)isTransformNode:(id)a0;
...
+ (char)isShaderOutputProperty:(id)a0;
+ (id)localTransformOperationWithNode:(id)a0 time:(double)a1;
+ (void)setLocalTransformOperationWithNode:(id)a0 op:(id)a1 time:(double)a2;
