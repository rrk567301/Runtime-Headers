...
+ (void)makeDirectoryAtPath:(id)a0 mode:(unsigned short)a1 uid:(unsigned int)a2 createHierarchy:(char)a3;
+ (id)sharedObject;

- (id)fileNameForLogType:(id)a0 fileNamePrefix:(id)a1 additionalHeaders:(id)a2 attemptIndex:(unsigned long long)a3;
- (char)hasXAttrAt:(const char *)a0 withName:(const char *)a1;
...
- (char)writeLogWithType:(id)a0 fileNamePrefix:(id)a1 additionalHeaders:(id)a2 writingOptions:(id)a3 writerBlock:(id /* block */)a4;
