...
+ (void)markState:(long long)a0 deviceID:(id)a1 shared:(char)a2 discovery:(id)a3 flags:(unsigned long long)a4 sourceApp:(long long)a5 atTime:(id)a6 errorCode:(unsigned long long)a7;
