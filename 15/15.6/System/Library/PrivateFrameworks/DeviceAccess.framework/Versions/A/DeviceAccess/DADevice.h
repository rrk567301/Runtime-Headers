...
@property (nonatomic) char pendingRemoval;
@property (nonatomic) char allowPairing;
@property (copy, nonatomic) NSData *bluetoothClassicAddress;
@property (retain, nonatomic) NSUUID *bluetoothIdentifier;
@property (nonatomic) char discoveredInExtension;
...
+ (char)deviceMetadataURLValid:(id)a0;
