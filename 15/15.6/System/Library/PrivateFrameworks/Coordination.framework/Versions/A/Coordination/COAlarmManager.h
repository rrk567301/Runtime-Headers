...
@property (nonatomic) char dtMonitoring;
@property (nonatomic) char canDispatch;
...
- (id)_alarmsForAccessory:(id)a0 includingSleepAlarm:(char)a1;
- (char)_canDispatchForAssociatedAccessory;
