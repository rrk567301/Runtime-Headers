...
- (void)_onqueue_setDictionary:(id)a0 clusters:(id)a1 cacheLocally:(char)a2 completionHandler:(id /* block */)a3;
- (id)_clustersForClustersTmp:(id)a0;
- (void)_lostConnectionToService;
- (char)_onqueue_clustersValid:(id)a0;
- (void)_onqueue_registerObserver:(id)a0;
- (void)_onqueue_removeObjectsForKeyPaths:(id)a0 clusters:(id)a1 cacheLocally:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)setBool:(char)a0 forKeyPath:(id)a1 clusters:(id)a2 completionHandler:(id /* block */)a3;
