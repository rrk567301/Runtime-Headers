...
- (id)compoundsFromName:(id)a0 includeSpaceAsDelimiter:(char)a1;
- (double)emissionProbability:(id)a0 hiddenState:(unsigned long long)a1 isOOV:(char *)a2;
- (unsigned long long)extractMetricForType:(unsigned long long)a0;
- (char)formCompoundFamilyName:(id)a0;
- (char)formCompoundGivenName:(id)a0;
...
- (char)isCoupleName:(id)a0;
- (char)isGivenNameAbbreviation:(id)a0;
- (char)isInitial:(id)a0;
- (char)isParticle:(id)a0;
...
- (char)validSequence:(id)a0 compoundsConstraints:(id)a1 labelsConstraints:(id)a2;
