...
- (id)parseChineseName:(id)a0 normalize:(char)a1;
- (id)parseFullnameWithDefaultHMMClassifier:(id)a0;
- (id)parseFullnameWithDefaultHMMClassifier:(id)a0 normalize:(char)a1 score:(double *)a2;
- (id)parseJapaneseName:(id)a0;
- (id)parseJapaneseName:(id)a0 normalize:(char)a1;
- (id)parseKoreanName:(id)a0;
- (id)parseKoreanName:(id)a0 normalize:(char)a1;
