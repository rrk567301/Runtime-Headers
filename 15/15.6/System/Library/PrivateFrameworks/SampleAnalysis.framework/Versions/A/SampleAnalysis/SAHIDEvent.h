...
- (char)addSelfToBuffer:(struct { unsigned char x0; unsigned char x1; unsigned short x2; unsigned int x3; unsigned long long x4; } *)a0 bufferLength:(unsigned long long)a1 withCompletedSerializationDictionary:(id)a2;
