...
@interface SABinary : NSObject <SASerializable, SAJSONSerialization, NSCopying> {
    ...
    char _foundPathViaBinaryLocator;
...
- (char)addSelfToBuffer:(struct { unsigned char x0; unsigned char x1; unsigned char x2[16]; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; union { unsigned char x0; struct { unsigned char x0 : 1; } x1; } x10; unsigned short x11; } *)a0 bufferLength:(unsigned long long)a1 withCompletedSerializationDictionary:(id)a2;
- (void)addSelfToSerializationDictionary:(id)a0;
- (char)cacheSymbolOwnerWithOptions:(unsigned long long)a0 pid:(int)a1;
- (char)cacheSymbolOwnerWithOptions:(unsigned long long)a0 pid:(int)a1 additionalCSSymbolicatorFlags:(unsigned int)a2;
