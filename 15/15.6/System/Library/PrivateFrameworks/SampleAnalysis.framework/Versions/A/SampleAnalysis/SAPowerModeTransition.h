...
- (char)addSelfToBuffer:(struct { unsigned char x0; unsigned char x1; union { unsigned long long x0; struct { BOOL x0; BOOL x1; } x1; } x2; unsigned long long x3; } *)a0 bufferLength:(unsigned long long)a1 withCompletedSerializationDictionary:(id)a2;
