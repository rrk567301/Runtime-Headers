@class SADispatchQueue, NSString, SAFrame, SATimestamp, SAThreadExclavesInfo, SASwiftTask, SAWaitInfo, SATurnstileInfo;
...
@property (readonly) char hasSwiftTask;
