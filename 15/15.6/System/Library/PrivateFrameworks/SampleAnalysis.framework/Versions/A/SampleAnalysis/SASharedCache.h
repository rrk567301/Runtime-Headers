...
- (char)addSelfToBuffer:(struct { unsigned char x0; unsigned char x1; unsigned char x2[16]; unsigned short x3; unsigned long long x4; } *)a0 bufferLength:(unsigned long long)a1 withCompletedSerializationDictionary:(id)a2;
- (void)addSelfToSerializationDictionary:(id)a0;
- (char)matchesUUID:(unsigned char[16])a0 slide:(unsigned long long)a1;
- (char)matchesUUID:(unsigned char[16])a0 slide:(unsigned long long)a1 slidBaseAddress:(unsigned long long)a2;
