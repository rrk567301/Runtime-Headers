...
@interface SATask : NSObject <SASerializable> {
    ...
    char _isBeta;
    char _alreadyGatheredDataFromLiveProcess;
    char _hasNoSharedCache;
    char _assumeBinaryLoadInfosContainsMainBinary;
    int _pid;
    int _ppid;
    int _rpid;
...
@property (readonly) char isTranslocated;
...
- (void)enumerateTaskStatesBetweenStartTime:(id)a0 endTime:(id)a1 reverseOrder:(char)a2 withSampleIndex:(char)a3 block:(id /* block */)a4;
- (void)enumerateTaskStatesBetweenStartTime:(id)a0 startSampleIndex:(unsigned long long)a1 endTime:(id)a2 endSampleIndex:(unsigned long long)a3 reverseOrder:(char)a4 block:(id /* block */)a5;
- (id)firstTaskStateOnOrAfterTime:(id)a0 sampleIndex:(unsigned long long)a1;
- (id)firstTaskStateOnOrAfterTime:(id)a0 withSampleIndex:(char)a1;
- (unsigned long long)indexOfFirstTaskStateOnOrAfterTime:(id)a0 sampleIndex:(unsigned long long)a1;
- (unsigned long long)indexOfFirstTaskStateOnOrAfterTime:(id)a0 withSampleIndex:(char)a1;
- (unsigned long long)indexOfLastTaskStateOnOrBeforeTime:(id)a0 sampleIndex:(unsigned long long)a1;
- (unsigned long long)indexOfLastTaskStateOnOrBeforeTime:(id)a0 withSampleIndex:(char)a1;
...
- (id)lastTaskStateOnOrBeforeTime:(id)a0 withSampleIndex:(char)a1;
