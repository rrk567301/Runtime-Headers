...
- (void)attestKey:(long long)a0 pending:(char)a1 clientDataHash:(id)a2 completion:(id /* block */)a3;
...
- (char)isCallerCurrentSSOExtension;
- (void)isDeviceRegisteredWithCompletion:(id /* block */)a0;
- (char)isURL:(id)a0 validForProfile:(id)a1;
