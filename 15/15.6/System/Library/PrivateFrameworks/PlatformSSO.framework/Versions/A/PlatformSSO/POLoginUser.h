...
- (id)initForLogin:(char)a0 userId:(unsigned int)a1;
- (char)isPlatformSSOTokenLogin;
- (char)isPlatformSSOUser;
- (char)isRightSet:(const char *)a0;
