...
- (char)verifyPasswordChangeEntitlement;
...
- (void)configurationDidChangeAndRemovedExtension:(id)a0 removed:(char)a1 completion:(id /* block */)a2;
...
- (void)performPasswordLogin:(id)a0 loginUserName:(id)a1 passwordContext:(id)a2 updateLocalAccountPassword:(char)a3 completion:(id /* block */)a4;
- (void)performPasswordLogin:(id)a0 passwordContext:(id)a1 updateLocalAccountPassword:(char)a2 completion:(id /* block */)a3;
...
- (void)screenDidUnlockWithCredentialContext:(id)a0 smartCardContext:(id)a1 biometricContext:(id)a2 tokenId:(id)a3 atLogin:(char)a4 tokenUnlock:(char)a5 completion:(id /* block */)a6;
...
- (char)verifyAgentEntitlement;
- (char)verifyLoginUserEntitlement;
