...
- (char)isPlatformSSOEnabled;
- (unsigned int)performLogin;
- (void)saveValuesInContextForPasswordAuth;
- (void)saveValuesInContextForSmartCardAuth;
- (void)setErrorMessageForResult:(unsigned long long)a0 policyError:(char)a1;
- (void)setSystemAuthPluginProcess:(id)a0;
- (char)shouldContinueFileVaultUnlockTokenUnlock;
- (char)shouldCreateNewUser;
