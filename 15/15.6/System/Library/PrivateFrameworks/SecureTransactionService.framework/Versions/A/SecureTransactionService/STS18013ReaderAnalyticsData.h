...
@property (readonly, nonatomic, getter=isTrusted) char trusted;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithTrusted:(char)a0 untrustedIdentifier:(id)a1 untrustedOrganization:(id)a2 untrustedIssuerIdentifier:(id)a3 untrustedIssuerOrganization:(id)a4;
