...
+ (char)sendOneMessageWithSessionInfo:(id)a0 userInfo:(id)a1 category:(unsigned short)a2 type:(unsigned short)a3 payload:(id)a4 error:(id *)a5;
+ (id)_privacyLogs:(id *)a0;
+ (char)closeEphemeralSessiontWithSessionId:(id)a0;
+ (id)createEphemeralSessionWithSessionInfo:(id)a0 userInfo:(id)a1 error:(id *)a2;
+ (id)getPersistentIdentifierForDNU:(char)a0;
+ (id)newHierarchyTokenFromParentToken:(id)a0;
+ (void)regeneratePersistentIdentifierForDNU:(char)a0;
...
- (char)sendMessageWithCategory:(unsigned short)a0 type:(unsigned short)a1 payload:(id)a2 error:(id *)a3;
...
- (char)sendMessageWithDictionary:(id)a0 error:(id *)a1;
- (char)serverSupportsFileUpload;
- (char)setDigestKey:(id)a0 algorithm:(int)a1;
...
- (char)uploadDataArray:(id)a0 completionHandler:(id /* block */)a1;
- (char)uploadFileWithURL:(id)a0 completionHandler:(id /* block */)a1;
