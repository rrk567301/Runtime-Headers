...
+ (id)betweenQueryCriterionWithColumnName:(id)a0 fromValue:(id)a1 toValue:(id)a2 negation:(char)a3;
...
+ (id)inQueryCriterionWithColumnName:(id)a0 values:(id)a1 negation:(char)a2;
+ (id)isNullQueryCriterionWithColumnName:(id)a0 negation:(char)a1;
+ (id)isQueryCriterionWithColumnName:(id)a0 value:(id)a1 negation:(char)a2;
...
+ (id)likeQueryCriterionWithColumnName:(id)a0 value:(id)a1 negation:(char)a2;
