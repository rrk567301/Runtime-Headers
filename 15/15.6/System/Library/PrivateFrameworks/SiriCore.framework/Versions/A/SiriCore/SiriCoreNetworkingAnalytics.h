...
@interface SiriCoreNetworkingAnalytics : NSObject {
    ...
    char _isConnectionActive;
    char _netIdAvailable;
...
+ (id)sessionConnectionFailedError:(id)a0 connectionMode:(id)a1 sessionType:(id)a2 sessionState:(id)a3 dormant:(char)a4 analysisInfo:(id)a5;
...
- (id)_createSchemaClientEventFromNetId:(id)a0 networkConnectionId:(id)a1 connectionProvider:(int)a2;
