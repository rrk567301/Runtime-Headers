...
+ (char)tryParsingAceHeaderData:(id)a0 compressionType:(unsigned char *)a1 bytesRead:(unsigned long long *)a2 error:(id *)a3;
+ (char)tryParsingPacketWithBytes:(const void *)a0 length:(unsigned long long)a1 rawPacket:(struct { unsigned char x0; unsigned int x1; } *)a2 object:(id *)a3 bytesRead:(unsigned long long *)a4 error:(id *)a5;
