...
- (void)setConnectionMetricsFromConnection:(id)a0 isPop:(char)a1 isMPTCP:(char)a2 attemptedEndpoints:(id)a3 completion:(id /* block */)a4;
- (void)setConnectionMetricsFromNWConnectionForDirect:(id)a0 isMPTCP:(char)a1 attemptedEndpoints:(id)a2 withCompletion:(id /* block */)a3;
- (void)setConnectionMetricsFromNWConnectionForPOP:(id)a0 withCompletion:(id /* block */)a1;
- (void)setConnectionMetricsFromStream:(id)a0 isPop:(char)a1 withCompletion:(id /* block */)a2;
