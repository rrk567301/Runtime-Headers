...
@property (nonatomic) char hearingAidConnectedOrReachable;
@property (nonatomic) char hearingAidReachableForAudioTransfer;
...
@property (readonly, nonatomic) char hearingAidReachable;
...
- (void)_registerListener:(id)a0 forAvailableDeviceHandler:(id /* block */)a1 beginSearching:(char)a2;
...
- (void)updateListenersWithConnectionStatus:(char)a0;
