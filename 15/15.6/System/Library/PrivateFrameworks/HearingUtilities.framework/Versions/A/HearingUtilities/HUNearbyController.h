...
@property (nonatomic) char shouldPublishNearbyUpdates;
@property (nonatomic) char hasPendingNearbyUpdates;
...
@property char scIDSServiceHasPeers;
...
- (id)nearbyDeviceWithIdentifier:(id)a0 justCreated:(char *)a1;
