...
- (void)willSwitchUser;
- (void)cleanUp;
- (void)processPropertyUpdates:(id)a0 isLocal:(char)a1;
...
- (void)setListenForAvailableDeviceUpdates:(char)a0;
- (void)setPairedHearingAidID:(id)a0;
- (void)transitionToPeer;
- (void)updateNearbyDeviceAvailabilityWithForce:(char)a0;
