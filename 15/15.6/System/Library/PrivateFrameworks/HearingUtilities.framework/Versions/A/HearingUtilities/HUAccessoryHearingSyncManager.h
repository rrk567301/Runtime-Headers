...
@property (nonatomic) char isHeadphoneStreamSelected;
@property (nonatomic) char noiseDisabled;
...
- (void)_sendIDSMessageIfNeededForListeningModes:(id)a0 addresses:(id)a1 force:(char)a2;
...
- (char)hasPairedDeviceWithHearingProtectionEnabled;
- (char)hasPairedDevicesWithListeningModes;
...
- (void)sendIDSMessageIfNeededForNewListeningModes:(id)a0 addresses:(id)a1 force:(char)a2;
- (void)sendListeningModesIDSMessageIfNeeded;
- (void)sendNoiseMeasurementsDisabledIfNeeded;
- (void)sendUpdateToAccessory;
- (char)shouldUpdateWatchesWithListeningModes:(id)a0;
