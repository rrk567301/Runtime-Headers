...
- (char)containerIdIsWellknown:(id)a0 class:(unsigned long long)a1;
- (id)initWithSystemContainerMapping:(id)a0 systemGroupContainerMapping:(id)a1 bypassListedCodeSignIdentifierMapping:(id)a2;
- (char)isLookupAllowedToBypassEntitlementFromCodeSignIdentifier:(id)a0 forContainerClass:(unsigned long long)a1 containerIdentifier:(id)a2;
- (char)systemContainerIdIsWellknown:(id)a0;
- (char)systemGroupContainerIdIsWellknown:(id)a0;
