...
- (id)containerForContainerIdentity:(id)a0 createIfNecessary:(char)a1 error:(id *)a2;
- (id)createStagedContainerForContainerIdentity:(id)a0 finalContainerPath:(id *)a1 dataProtectionClass:(int)a2 error:(id *)a3;
- (char)deleteURL:(id)a0 forUserIdentity:(id)a1 error:(id *)a2;
- (char)deleteURL:(id)a0 forUserIdentity:(id)a1 reclaimSoon:(char)a2 error:(id *)a3;
- (id)initWithContainerCache:(id)a0 clientIdentity:(id)a1 userIdentityCache:(id)a2;
- (char)upgradeContainer:(id)a0 clientIdentity:(id)a1 error:(id *)a2;
