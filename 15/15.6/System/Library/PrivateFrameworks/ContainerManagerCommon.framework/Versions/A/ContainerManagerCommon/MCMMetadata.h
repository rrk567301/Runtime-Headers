...
- (char)_initFromMetadataInDictionary:(id)a0 containerPath:(id)a1 userIdentity:(id)a2 containerClass:(unsigned long long)a3 fsNode:(id)a4 fileURL:(id)a5 userIdentityCache:(id)a6 error:(id *)a7;
- (id)_modifiedDictBySetttingValue:(id)a0 forKey:(id)a1 onInfo:(id)a2;
- (char)_persisted;
- (char)_writeFileURL:(id)a0 dictionary:(id)a1 options:(unsigned long long)a2 error:(id *)a3;
...
- (id)metadataBySettingValuesWithInfoDict:(id)a0 fullReplace:(char)a1;
- (char)writeMetadataToDiskWithError:(id *)a0;
- (char)writeMetadataToFileURL:(id)a0 options:(unsigned long long)a1 error:(id *)a2;
