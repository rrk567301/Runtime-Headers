...
+ (char)schemaIsUpToDateForIdentifier:(id)a0 containerClass:(unsigned long long)a1 currentSchemaVersion:(id)a2 latestSchemaVersion:(id *)a3;
...
- (char)_executeActions:(id)a0 error:(id *)a1;
...
- (char)writeSchemaFromVersion:(id)a0 toTargetVersion:(id)a1 error:(id *)a2;
- (char)writeSchemaToTargetVersion:(id)a0 error:(id *)a1;
