...
+ (id)containerIdentityWithUUID:(id)a0 userIdentity:(id)a1 identifier:(id)a2 containerConfig:(id)a3 platform:(unsigned int)a4 containerPathIdentifier:(id)a5 existed:(char)a6 transient:(char)a7 userIdentityCache:(id)a8 error:(unsigned long long *)a9;
...
- (id)identityByChangingTransient:(char)a0;
...
- (id)initWithUUID:(id)a0 userIdentity:(id)a1 identifier:(id)a2 containerConfig:(id)a3 platform:(unsigned int)a4 containerPathIdentifier:(id)a5 existed:(char)a6 transient:(char)a7 userIdentityCache:(id)a8 error:(unsigned long long *)a9;
