...
+ (id)containerIdentityWithUUID:(id)a0 userIdentity:(id)a1 identifier:(id)a2 containerConfig:(id)a3 platform:(unsigned int)a4 transient:(char)a5 userIdentityCache:(id)a6 error:(unsigned long long *)a7;
...
- (struct container_object_s { } *)createLibsystemContainerWithContainerPathIdentifier:(id)a0 existed:(char)a1 error:(unsigned long long *)a2;
...
- (id)initWithUUID:(id)a0 userIdentity:(id)a1 identifier:(id)a2 containerConfig:(id)a3 platform:(unsigned int)a4 transient:(char)a5 userIdentityCache:(id)a6 error:(unsigned long long *)a7;
- (id)initWithVersion1PlistDictionary:(id)a0 containerIdentity:(id)a1 error:(unsigned long long *)a2;
- (char)isEqualToConcreteContainerIdentity:(id)a0;
