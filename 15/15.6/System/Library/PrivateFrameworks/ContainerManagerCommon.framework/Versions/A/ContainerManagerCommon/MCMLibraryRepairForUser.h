...
- (char)fixAndRetryIfPermissionsErrorWithURL:(id)a0 containerPath:(id)a1 containerIdentifier:(id)a2 error:(id *)a3 duringBlock:(id /* block */)a4;
- (char)fixAndRetryIfPermissionsErrorWithURL:(id)a0 containerRootURL:(id)a1 error:(id *)a2 duringBlock:(id /* block */)a3;
- (id)initWithManagedUserPathRegistry:(id)a0 fileManager:(id)a1 classIterator:(id)a2;
- (char)performRepairForContainerPath:(id)a0 containerIdentifier:(id)a1 error:(id *)a2;
