...
- (void)setDataProtectionOnDataContainerForMetadata:(id)a0 isSecondOrThirdPartyApp:(char)a1 retryIfLocked:(char)a2 deferUntilNextLaunch:(char)a3 withCompletion:(id /* block */)a4;
