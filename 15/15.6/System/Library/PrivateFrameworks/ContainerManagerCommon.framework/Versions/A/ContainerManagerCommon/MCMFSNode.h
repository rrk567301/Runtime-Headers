...
- (char)isEqual:(id)a0;
- (id)initWithINode:(unsigned long long)a0 device:(int)a1 ctime:(struct timespec { long long x0; long long x1; })a2 mtime:(struct timespec { long long x0; long long x1; })a3 birthtime:(struct timespec { long long x0; long long x1; })a4 isDirectory:(char)a5 isSymlink:(char)a6;
