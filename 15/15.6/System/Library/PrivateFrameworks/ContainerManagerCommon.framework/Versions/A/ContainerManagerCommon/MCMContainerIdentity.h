...
+ (id)containerIdentityWithMinimalContainerIdentity:(id)a0 transient:(char)a1;
+ (id)containerIdentityWithUserIdentity:(id)a0 identifier:(id)a1 containerConfig:(id)a2 platform:(unsigned int)a3 transient:(char)a4 userIdentityCache:(id)a5 error:(unsigned long long *)a6;
...
- (id)initWithUserIdentity:(id)a0 identifier:(id)a1 containerConfig:(id)a2 platform:(unsigned int)a3 transient:(char)a4 userIdentityCache:(id)a5 error:(unsigned long long *)a6;
- (id)initWithVersion1PlistDictionary:(id)a0 userIdentityCache:(id)a1 error:(unsigned long long *)a2;
- (char)isEqualToContainerIdentity:(id)a0;
