...
- (id)_containerClassPathForUserIdentity:(id)a0 containerClass:(unsigned long long)a1 transient:(char)a2;
- (id)_queue_containerClassCacheForContainerClassPath:(id)a0;
- (id)_queue_containerClassCacheForUserIdentity:(id)a0 containerClass:(unsigned long long)a1 transient:(char)a2;
- (void)_queue_flush;
...
- (id)entriesForUserIdentities:(id)a0 contentClass:(unsigned long long)a1 transient:(char)a2 error:(id *)a3;
- (id)entryForContainerIdentity:(id)a0 classCache:(id)a1 error:(id *)a2;
- (id)entryForContainerIdentity:(id)a0 error:(id *)a1;
- (void)flushCacheForUserIdentity:(id)a0 containerClass:(unsigned long long)a1 transient:(char)a2;
...
- (char)removeContainerForUserIdentity:(id)a0 contentClass:(unsigned long long)a1 identifier:(id)a2 transient:(char)a3 error:(id *)a4;
