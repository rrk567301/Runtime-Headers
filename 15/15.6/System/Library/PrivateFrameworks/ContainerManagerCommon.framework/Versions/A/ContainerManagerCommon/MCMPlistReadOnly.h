...
@property (nonatomic) char keepArtifacts;
...
- (char)_initPropertiesWithPlist:(id)a0 conformingToProtocol:(id)a1 error:(id *)a2;
- (char)_isNonatomicReadonlyBoolPropertyTypeWithAttributes:(const char *)a0;
