...
- (void).cxx_destruct;
- (char)invalidateCodeSigningInfoForIdentifierAndItsChildren:(id)a0 withError:(id *)a1;
...
- (id)_codeSigningInfoForCodeSigningEntry:(id)a0 externalRequest:(char)a1;
- (id)_entitlementsFromCodeSigningEntry:(id)a0;
- (char)_onQueue_addGroupIdentifier:(id)a0 forIdentifier:(id)a1 containerClass:(unsigned long long)a2 error:(id *)a3 reconcileHandler:(id /* block */)a4;
- (id)_onQueue_codeSigningEntryForIdentifier:(id)a0 withError:(id *)a1;
- (id)_onQueue_codeSigningInfoForIdentifier:(id)a0 externalRequest:(char)a1;
...
- (char)_onQueue_identifierHasCallerRegisteredEntitlements:(id)a0;
- (id)_onQueue_identifiersWithError:(id *)a0;
- (char)_onQueue_invalidateCodeSigningInfoForIdentifier:(id)a0 error:(id *)a1;
...
- (char)_onQueue_processCodeSigningInfo:(id)a0 identifier:(id)a1 options:(id)a2 oldEntitlements:(id)a3 error:(id *)a4 reconcileHandler:(id /* block */)a5;
- (void)_onQueue_reconcileSystemContainersWithContext:(id)a0;
- (char)_onQueue_removeAllAdvanceCopiesWithError:(id *)a0;
- (char)_onQueue_removeAllInvalidPluginCodeSigningEntriesWithNumRemoved:(int *)a0 error:(id *)a1;
- (char)_onQueue_removeGroupIdentifier:(id)a0 forIdentifier:(id)a1 containerClass:(unsigned long long)a2 error:(id *)a3 reconcileHandler:(id /* block */)a4;
...
- (char)_onqueue_enumerateOwnersAndGroupsWithGroupClass:(unsigned long long)a0 error:(id *)a1 block:(id /* block */)a2;
- (id)_readCodeSigningMappingFromDiskAtURL:(id)a0;
- (char)addGroupIdentifier:(id)a0 forIdentifier:(id)a1 containerClass:(unsigned long long)a2 error:(id *)a3 reconcileHandler:(id /* block */)a4;
...
- (char)enumerateOwnersAndGroupsWithGroupClass:(unsigned long long)a0 error:(id *)a1 block:(id /* block */)a2;
...
- (char)identifierHasCallerRegisteredEntitlements:(id)a0;
- (char)identifierHasSystemContainer:(id)a0;
...
- (char)invalidateCodeSigningInfoForIdentifier:(id)a0 withError:(id *)a1;
...
- (char)removeAllAdvanceCopiesWithError:(id *)a0;
- (char)removeAllInvalidPluginCodeSigningEntriesWithNumRemoved:(int *)a0 error:(id *)a1;
- (id)removeCodeSigningDictionaryForIdentifiers:(id)a0;
- (char)removeGroupIdentifier:(id)a0 forIdentifier:(id)a1 containerClass:(unsigned long long)a2 error:(id *)a3 reconcileHandler:(id /* block */)a4;
