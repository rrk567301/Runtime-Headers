...
- (id)init;
- (void).cxx_destruct;
- (char)insertAsyncFileOperation:(id)a0 error:(id *)a1;
- (void)_runOperation:(id)a0;
- (id)reserveAsyncOperationForFileSize:(long long)a0 path:(id)a1 group:(id)a2 operationPendingForPath:(char *)a3;
