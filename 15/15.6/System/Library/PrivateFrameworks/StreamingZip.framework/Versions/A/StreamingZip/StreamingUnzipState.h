@class NSArray, NSSet, NSString, NSDictionary, NSMutableData, NSNumber, StreamingFileWriter;
...
@property (nonatomic) char denyInvalidSymlinks;
@property (nonatomic) char performCachedWrites;
@property (nonatomic) char performingExtraction;
@property (readonly, nonatomic) NSNumber *overrideUID;
@property (readonly, nonatomic) NSNumber *overrideGID;
@property (retain, nonatomic) StreamingFileWriter *fileWriter;
...
- (char)resolveOwnershipWithExtraField:(struct { unsigned char x0[2]; struct { unsigned short x0; } x1; struct { unsigned int x0; } x2; struct { unsigned int x0; } x3; struct { unsigned short x0; } x4; struct { unsigned short x0; } x5; } *)a0 outUID:(unsigned int *)a1 outGID:(unsigned int *)a2;
- (id)serializeState;
- (id)updateHashFromOffset:(unsigned long long)a0 withBytes:(const void *)a1 length:(unsigned long long)a2;
- (id)updateHashFromOffset:(unsigned long long)a0 withBytes:(const void *)a1 length:(unsigned long long)a2 onlyFinishCurrentChunk:(char)a3;
