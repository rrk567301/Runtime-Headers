...
- (id)allDataSources;
- (id)collectionView:(id)a0 evaluateFactoryForSupplementaryElementOfKind:(id)a1 atIndexPath:(id)a2 isRecursive:(char)a3;
- (void)collectionViewDidBecomeInactive:(id)a0;
- (char)containsDataSource:(id)a0;
...
- (char)item:(id)a0 matchesSearchTerms:(id)a1 inSection:(long long)a2;
