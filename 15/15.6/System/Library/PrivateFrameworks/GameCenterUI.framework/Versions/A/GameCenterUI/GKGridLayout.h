...
@property (nonatomic) char noMoreShowMore;
...
@property (nonatomic) char movedItemsInUpdateCarrySections;
@property (nonatomic) char displayClipView;
...
@property (nonatomic) char displayingOverlay;
@property (nonatomic) double segmentedBoxY;
@property (nonatomic) char shouldLayoutRTL;
...
@property (nonatomic) char hideSearchBarOnAppear;
@property (nonatomic) char hideAboveSegmentOnAppear;
@property (nonatomic) double bottomContentPadding;
@property (nonatomic) char ignoreBoundsForSizeCalculation;
...
- (void)finalizePinnedAttributes:(id)a0 forSection:(long long)a1 footer:(char)a2;
...
- (char)shouldSlideInSupplementaryElementOfKind:(id)a0 forUpdateItem:(id)a1 atIndexPath:(id)a2;
- (char)shouldSlideOutSupplementaryElementOfKind:(id)a0 forUpdateItem:(id)a1 atIndexPath:(id)a2;
