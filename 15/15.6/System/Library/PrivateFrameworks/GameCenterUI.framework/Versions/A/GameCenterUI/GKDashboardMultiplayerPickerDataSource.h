...
@property (nonatomic) char browsingForNearbyPlayers;
@property (nonatomic) char didLoad;
@property (nonatomic) char excludesContacts;
@property (nonatomic) long long pickerOrigin;
@property (readonly, nonatomic) char hasFriends;
@property (retain, nonatomic) NSMutableSet *selectedMessageGroups;
@property (retain, nonatomic) GKContactDataSource *contactSource;
@property (nonatomic) char selectionShouldSkipDelegateResponse;
@property (nonatomic) char isShowingNearbyExpanded;
...
@property (nonatomic) char showsAllFriends;
@property (nonatomic) int numberOfFriendsToShowInitially;
@property (nonatomic) char showingExpandedSearch;
@property (nonatomic) char supportsNearby;
@property (nonatomic) char nearbyOnly;
...
- (id)playersForSection:(long long)a0 ignoreSearch:(char)a1;
- (void)didPickContact:(id)a0;
- (void)handleGroupExpansionAtLocation:(struct CGPoint { double x0; double x1; })a0;
- (char)_canShowMoreFriends;
...
- (char)canSelectPlayerGroup:(id)a0 atIndexPath:(id)a1 inCollectionView:(id)a2;
- (id)candidateIndexPaths;
- (unsigned long long)cornerMaskForItemAtIndexPath:(id)a0;
- (unsigned long long)cornerMaskForSectionHeader;
- (long long)defaultFilterScopeFromPickerOrigin:(long long)a0;
...
- (id)initWithMaxSelectable:(long long)a0 previouslyInvitedPlayers:(id)a1 nearbyOnly:(char)a2 pickerOrigin:(long long)a3;
- (char)isPlayerAtIndexPathCoreRecent:(id)a0;
- (char)isShowingAddFriendsFooter;
...
- (void)setNearbyPlayer:(id)a0 reachable:(char)a1;
- (void)setNearbyPlayerID:(id)a0 reachable:(char)a1;
- (void)setupCollectionView:(id)a0;
- (char)shouldSelectPlayerGroup:(id)a0;
