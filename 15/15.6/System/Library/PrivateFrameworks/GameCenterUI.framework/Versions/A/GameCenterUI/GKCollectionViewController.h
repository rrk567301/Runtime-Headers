...
@interface GKCollectionViewController : NSUICollectionViewController <GKComposeControllerDelegate, _GKStateMachineDelegate, GKCollectionViewDataSourceDelegate, NSTextFieldDelegate> {
    char _skipLoadAfterViewDidLoad;
}
...
@property (nonatomic) char skipLoadAfterViewDidLoad;
...
@property char hasViewFactories;
@property char didSlideIn;
...
@property (nonatomic) char shouldSlideInContents;
@property (nonatomic) char showSupplementaryViewsWhileLoading;
@property (readonly, nonatomic) NSString *loadingState;
@property (readonly, nonatomic) char readyToDisplayData;
...
- (void)dataSource:(id)a0 didUpdatePlaceholderVisibility:(char)a1;
...
- (id)gkDataSource;
- (void)hidePlaceholderAnimated:(char)a0;
...
- (void)setIsReadyToDisplayData:(char)a0;
- (void)showCollectionView;
- (double)showMoreTextMarginAtIndexPath:(id)a0;
- (void)showPlaceholderWithTitle:(id)a0 message:(id)a1 buttonTitle:(id)a2 animated:(char)a3 block:(id /* block */)a4;
