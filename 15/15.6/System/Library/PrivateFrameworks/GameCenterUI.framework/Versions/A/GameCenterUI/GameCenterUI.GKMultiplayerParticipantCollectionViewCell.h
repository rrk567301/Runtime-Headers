...
@property (nonatomic) char removeButtonHidden;

- (void).cxx_destruct;
- (void)prepareForReuse;
- (void)layout;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (void)applyWithParticipant:(id)a0 number:(long long)a1 isRemovingEnabled:(char)a2 isInvitingEnabled:(char)a3 layoutMode:(long long)a4;
