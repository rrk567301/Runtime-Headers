...
@property (nonatomic) char autoWidthUsesTwoColumnsWhenSpace;
...
- (char)collectionView:(id)a0 shouldDeselectItemAtIndexPath:(id)a1;
...
- (void)setToHorizontalLayout:(char)a0;
