...
@property (nonatomic) char useViewSizeForFlowMaxColumnCount;
...
@property (nonatomic) char sectionHeadersShouldPin;
@property (nonatomic) char incrementalRevealConsumesPadding;
@property (nonatomic) char shouldAlwaysIncludeShowMore;
@property (nonatomic) char shouldShowSectionHeadersWhenNoItems;
