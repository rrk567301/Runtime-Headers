...
@property (nonatomic) char shouldEnforcePreferredWidth;
@property (readonly, nonatomic) char usingAttributedText;
@property (nonatomic) char shouldInhibitReplay;
...
- (void)replayAndApplyStyleWithSystemContentChange:(char)a0;
