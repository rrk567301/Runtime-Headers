...
@property (nonatomic) char applyOrthogonalConstraints;
...
+ (id)containerViewForViews:(id)a0 overlap:(double)a1 vertical:(char)a2;
+ (id)containerViewForViews:(id)a0 overlap:(double)a1 vertical:(char)a2 applyOrthogonalConstraints:(char)a3;
