...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ avatarBackgroundImage;
@property (nonatomic, readonly) void /* unknown type, empty encoding */ messageLabel;
@property (nonatomic, readonly) void /* unknown type, empty encoding */ scoreLabel;
@property (nonatomic, readonly) void /* unknown type, empty encoding */ emojiLabel;
