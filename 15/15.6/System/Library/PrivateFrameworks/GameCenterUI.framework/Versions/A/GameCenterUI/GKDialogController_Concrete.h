...
- (void)_presentViewController:(id)a0 withTitle:(char)a1;
- (void)checkAuthentication;
- (char)presentViewController:(id)a0 withDismiss:(id /* block */)a1;
- (char)presentViewController:(id)a0 withTitle:(char)a1;
