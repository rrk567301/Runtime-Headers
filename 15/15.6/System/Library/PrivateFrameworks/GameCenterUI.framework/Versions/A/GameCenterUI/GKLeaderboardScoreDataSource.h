...
@property (nonatomic) char isLoadingData;
@property (nonatomic) char isLoadingNextData;
@property (nonatomic) char isLoadingPreviousData;
...
@property (nonatomic) char firstLoad;
...
@property (nonatomic) char shouldDisplayFriendSuggestions;
...
@property (nonatomic) char autoScrollToLocalPlayerPosition;
