...
@property (nonatomic, getter=isSelectable) char selectable;
@property (nonatomic) char showsPlayerSubtitle;
@property (nonatomic) char showsMessagesHandleInStatusText;
