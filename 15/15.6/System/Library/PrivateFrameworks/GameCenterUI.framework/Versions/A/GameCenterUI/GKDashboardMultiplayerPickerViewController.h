...
@property (nonatomic) char usePreferredFocusCell;
...
@property (nonatomic) char recipientRemovedImplicitly;
@property (nonatomic) char skipAddressTokenization;
@property (nonatomic) char isAnimatingComposeTextViewSizeChange;
...
@property (readonly, nonatomic) char nearbyOnly;
...
- (id)initWithMaxSelectable:(long long)a0 hiddenPlayers:(id)a1 nearbyOnly:(char)a2 pickerOrigin:(long long)a3;
...
- (void)setSupportsNearby:(char)a0;
