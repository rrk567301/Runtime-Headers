...
- (void)showWithImage:(id)a0 isAnimationPermitted:(char)a1;
- (void)addBorderWithBorderWidth:(double)a0 color:(id)a1;
- (void)setImageWithImage:(id)a0 animated:(char)a1;
- (void)showWithAvatarImage:(id)a0 isAnimationPermitted:(char)a1;
