...
@interface GKCollectionViewCell : NSUICollectionViewCell {
    char _shouldDisplaySwipeToEditAccessories;
...
@property (nonatomic) char doesAbutLeftEdge;
...
- (void)setShouldDisplaySwipeToEditAccessories:(char)a0;
- (void)shutActionPaneAnimated:(char)a0 completion:(id /* block */)a1;
