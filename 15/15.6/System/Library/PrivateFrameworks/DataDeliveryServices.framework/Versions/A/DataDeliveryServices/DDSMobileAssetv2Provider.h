...
- (void)updateCatalogForAssetType:(id)a0 discretionaryDownload:(char)a1 withCompletion:(id /* block */)a2;
...
- (void)beginDownloadForAssertion:(id)a0 discretionaryDownload:(char)a1 handler:(id /* block */)a2;
- (void)beginDownloadForAssertions:(id)a0 discretionaryDownload:(char)a1;
- (void)beginDownloadForAssets:(id)a0 withPolicy:(id)a1 discretionaryDownload:(char)a2 error:(id *)a3 handler:(id /* block */)a4;
...
- (id)downloadOptionsForCatalogWithType:(id)a0 discretionaryDownload:(char)a1;
- (id)downloadOptionsForPolicy:(id)a0 discretionaryDownload:(char)a1;
...
- (char)shouldMatchAttributeValue:(id)a0 givenValue:(id)a1;
