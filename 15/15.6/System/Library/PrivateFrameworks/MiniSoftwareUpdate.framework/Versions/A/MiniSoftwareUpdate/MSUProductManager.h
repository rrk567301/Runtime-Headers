...
+ (char)_downloadPKMForPackage:(id)a0 product:(id)a1 catalog:(id)a2 error:(id *)a3;
...
- (id)init;
- (void).cxx_destruct;
- (char)__evaluateProduct:(id)a0 evaluationOptions:(id)a1 catalog:(id)a2 installable:(char *)a3 error:(id *)a4;
- (char)_evaluateProduct:(id)a0 evaluationOptions:(id)a1 catalog:(id)a2 installable:(char *)a3 error:(id *)a4;
