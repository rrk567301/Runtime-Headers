...
@property (getter=isStaged) char staged;
...
@property (getter=isEvaluated) char evaluated;
@property (getter=isInstallable) char installable;
...
@property char visibleOnlyForPredicate;
