...
+ (char)auditTokenFromData:(id)a0 auditToken:(struct { unsigned int x0[8]; } *)a1;
+ (char)checkEntitlementFromXPC:(id)a0 entitlement:(id)a1;
+ (char)checkSignatureOfFile:(id)a0 teamIdentifier:(id *)a1 trusted:(char *)a2 signedBySet:(long long *)a3 certificates:(id *)a4 error:(id *)a5;
...
+ (char)sandboxAllowsXPC:(const char *)a0;
