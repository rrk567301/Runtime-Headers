...
- (void)configurePrivateDataOffset:(unsigned short)a0 privateDataLength:(unsigned short)a1 confidentialDataOffset:(unsigned short)a2 confidentialDataLength:(unsigned short)a3 contactlessVisibility:(char)a4 wiredVisibility:(char)a5;
