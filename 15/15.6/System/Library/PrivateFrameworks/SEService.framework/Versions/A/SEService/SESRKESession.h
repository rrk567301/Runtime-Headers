...
- (char)continueExecutingRKEFunction:(id)a0 action:(id)a1 arbitraryData:(id)a2 readerIdentifier:(id)a3 error:(id *)a4;
...
- (char)isPassiveEntryAvailable:(id)a0 isAvailable:(BOOL *)a1 error:(id *)a2;
- (void)sendEvent:(id)a0 fromVehicle:(id)a1;
- (char)sendPassthroughMessage:(id)a0 readerIdentifier:(id)a1 error:(id *)a2;
