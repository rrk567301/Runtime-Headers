...
- (char)acquire;
- (id)initWithBundleIdentifier:(id)a0 flags:(unsigned int)a1 reason:(unsigned int)a2 name:(id)a3 withHandler:(id /* block */)a4 acquire:(char)a5;
...
- (id)initWithBundleIdentifier:(id)a0 pid:(int)a1 flags:(unsigned int)a2 reason:(unsigned int)a3 name:(id)a4 withHandler:(id /* block */)a5 acquire:(char)a6;
- (id)initWithPID:(int)a0 flags:(unsigned int)a1 reason:(unsigned int)a2 name:(id)a3;
- (id)initWithPID:(int)a0 flags:(unsigned int)a1 reason:(unsigned int)a2 name:(id)a3 withHandler:(id /* block */)a4 acquire:(char)a5;
