...
@property (readonly) char background;
...
- (id)_packageReferenceForRetryingFailedPackageReference:(id)a0 invalidatingCurrentReference:(char)a1;
- (void)_runBlockOnDownloaderThread:(id /* block */)a0 waitUntilDone:(char)a1 ignoreIfThreadStopped:(char)a2;
...
- (id)initWithProduct:(id)a0 inBackground:(char)a1;
