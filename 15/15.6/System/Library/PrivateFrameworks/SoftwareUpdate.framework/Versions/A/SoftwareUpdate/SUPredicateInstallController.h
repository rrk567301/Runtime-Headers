...
@property char requireLicenseAgreement;
...
- (char)_isSoftwareUpdateRunningWithPID:(id)a0;
- (char)_isUpdateUIAlreadyRunning;
- (id)_optionsFilePath;
- (void)_softwareUpdateDidExit:(id)a0;
- (char)_startSoftwareUpdateWithOptionsFile:(id)a0;
- (id)_writeOptionsFileForPredicate:(id)a0 confirmComplete:(char)a1;
- (long long)countOfCachedProductsMatchingPredicate:(id)a0;
- (char)isCacheCurrent;
- (id)metadataOfCachedProductsMatchingPredicate:(id)a0;
- (char)startUpdateUIWithPredicate:(id)a0 confirmComplete:(char)a1;
