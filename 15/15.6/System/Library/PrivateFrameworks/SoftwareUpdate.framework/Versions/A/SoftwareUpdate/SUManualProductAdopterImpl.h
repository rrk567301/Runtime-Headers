...
- (void)dealloc;
- (id)description;
- (char)_mungeDistributionWithDisplayName:(id)a0 displayVersion:(id)a1 error:(id *)a2;
- (void)_mungePackageURLsUnderChoice:(id)a0;
- (id)_pathByCopyingProductArchiveFromFileHandle:(id)a0 archiveName:(id)a1;
- (char)adoptWithDisplayName:(id)a0 displayVersion:(id)a1 allowDevSigning:(char)a2 error:(id *)a3;
- (id)adoptedProduct;
