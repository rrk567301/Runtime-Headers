...
@property (nonatomic) char notificationPending;
@property (nonatomic) char notificationBundleExists;
@property char mdmInitiatedNotificationBundleInstall;
...
- (void)_handleMajorOSBundleInstalled:(char)a0;
