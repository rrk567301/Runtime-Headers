...
- (char)_canStartInstallingMacBuddyEligibleProductKey:(id)a0 withError:(id *)a1;
- (char)_canStartUpdateWithPredicate:(id)a0 error:(id *)a1;
...
- (char)_determineUpdatesToInstallFromAvailable:(id)a0 filterKey:(id)a1;
...
- (void)_notifyUpdateEndedWithError:(id)a0 didCancel:(char)a1 signalRunning:(char)a2;
...
- (void)initiateBackgroundScanIfNecessary:(char)a0 replyWhenDone:(id /* block */)a1;
...
- (void)suspendBackgroundOperations:(char)a0 duration:(long long)a1;
