...
+ (id)consumerMapping;
+ (unsigned char)consumerSubtypeForString:(id)a0 found:(char *)a1;
+ (char)isActionSpotlightConsumerSubType:(unsigned char)a0;
...
+ (unsigned long long)consumerTypeForString:(id)a0 found:(char *)a1;
+ (unsigned long long)consumerTypeForSubType:(unsigned char)a0;
+ (unsigned long long)engagementTypeForString:(id)a0 found:(char *)a1;
