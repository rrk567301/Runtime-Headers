@class AUCrashHandler, NSUUID, NSXPCConnection, AUAudioUnitBusArray_XPC, AUParameterTree, NSArray;
...
@interface AUAudioUnit_XPC : AUAudioUnit {
    ...
    struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } _mCrashNotificationMutex;
    ...
    struct optional<bool> { union { char __null_state_; BOOL __val_; } ; BOOL __engaged_; } _localCachingDisabled;
}
...
- (id)_findComponentDescriptionsForPath:(id)a0;
...
- (char)_setBusCount:(unsigned long long)a0 scope:(unsigned int)a1 error:(id *)a2;
