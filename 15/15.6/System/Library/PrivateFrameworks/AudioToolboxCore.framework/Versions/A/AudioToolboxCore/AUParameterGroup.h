...
- (char)isGroup;
- (void)_deserialize:(struct CADeserializer { struct __CFData *x0; char *x1; char *x2; char *x3; BOOL x4; } *)a0 fromSetFullState:(char)a1;
- (void)_indexChildren;
- (void)_observersChanged:(char)a0 deltaCount:(int)a1;
