...
@property (nonatomic) struct _WarpStaticParameters { int warpMode; struct { unsigned long long width; unsigned long long height; unsigned long long depth; } inputSize; float rateMaxSize; float rateMax; float rateMin; float rateFalloffPower; int atlasPaddingWidth; char atlasTranspose; char valid; } staticParams;
...
+ (int)decodeWarpData:(id)a0 intoStaticParam:(struct _WarpStaticParameters { int x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; float x2; float x3; float x4; float x5; int x6; char x7; char x8; } *)a1 dynamicParam:(struct _WarpDynamicParameters { float x0; float x1; float x2; } *)a2 timestamp:(unsigned long long *)a3;
+ (id)encodeStaticParams:(struct _WarpStaticParameters { int x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; float x2; float x3; float x4; float x5; int x6; char x7; char x8; })a0 dynamicParams:(struct _WarpDynamicParameters { float x0; float x1; float x2; })a1 timestamp:(unsigned long long)a2;
...
- (id)warpMapWithStaticParams:(struct _WarpStaticParameters { int x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; float x2; float x3; float x4; float x5; int x6; char x7; char x8; })a0 dynamicParams:(struct _WarpDynamicParameters { float x0; float x1; float x2; })a1 roiOut:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; } *)a2;
