...
+ (struct _UnwarpRenderOptions { char x0; float x1; })defaultRenderOptions;
+ (id)parameterDataFromVRRMap:(id)a0;

- (void).cxx_destruct;
- (void)encodeUnwarpFromTexture:(id)a0 withWarpMap:(id)a1 withRenderEncoder:(id)a2 withOptions:(struct _UnwarpRenderOptions { char x0; float x1; })a3;
