...
- (id)connections;
- (char)_connectionCanControlReceiving:(id)a0;
- (void)fetchSharedTripsWithCompletion:(id /* block */)a0;
- (char)_connectionCanControlSharing:(id)a0;
- (void)_purgeSubscriptionsForConnection:(id)a0;
- (void)_setNotificationCenter:(id)a0;
- (id)_subscribedConnectionsForTripID:(id)a0 createIfNeeded:(char)a1;
...
- (void)relay:(id)a0 accountStatusChanged:(char)a1;
