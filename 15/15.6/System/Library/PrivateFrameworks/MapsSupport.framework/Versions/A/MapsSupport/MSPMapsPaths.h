...
@property (readonly, nonatomic) char shouldSyncMergeFavoritesAfterCheckingOrCreatingMarkerFile;
@property (readonly, nonatomic) NSString *historySyncedMarkerFile;
@property (readonly, nonatomic) char shouldSyncMergeHistoryAfterCheckingOrCreatingMarkerFile;
...
- (char)_deleteSyncedFileAtPath:(id)a0;
- (char)_shouldSyncMergeAfterCheckingOrCreatingMarkerFileAtPath:(id)a0;
