...
- (void).cxx_destruct;
- (void)updateContacts;
- (char)_allowMessageWithState:(id)a0 forGroup:(id)a1 fromID:(id)a2;
- (void)_cleanGroup:(id)a0;
- (char)_cleanUpNecessaryForGroup:(id)a0;
...
- (void)_updateDelegateWithUpdateState:(id)a0 to:(id)a1 freshAvailable:(char)a2;
...
- (char)subscribeToUpdatesToSharedTrip:(id)a0 error:(id *)a1;
- (char)unsubscribeFromUpdatesToSharedTrip:(id)a0 error:(id *)a1;
