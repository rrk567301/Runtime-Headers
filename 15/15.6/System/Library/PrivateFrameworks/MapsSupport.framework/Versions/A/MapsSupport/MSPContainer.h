...
@property (readonly, nonatomic) char _preventsAssertionsForDuplicateStorageIdentifiers;
@property (nonatomic, getter=_simulatesClearingDiscardableDataAfterOperations, setter=_setSimulatesClearingDiscardableDataAfterOperations:) char simulatesClearingDiscardableDataAfterOperations;
@property (readonly, nonatomic) char containerHasLoadedContents;
...
+ (char)_deletes:(unsigned long long)a0 mayRepresentDataLossIfAppliedTo:(unsigned long long)a1;
...
- (char)_checkAndAddCoalescedEditForContext:(id)a0 identifiers:(id)a1 enqueuedBlock:(id /* block */)a2 completionQueue:(id)a3 completion:(id /* block */)a4;
...
- (void)_performInitialLoadNotifyingObservers:(char)a0 kickOffSynchronously:(char)a1 completion:(id /* block */)a2;
