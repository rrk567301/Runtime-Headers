...
@property (readonly, nonatomic) char entitledToShareTrip;
@property (readonly, nonatomic) char entitledToReceiveTrips;
@property (readonly, nonatomic) MSPSharedTripSharingIdentity *sharingIdentity;
@property (readonly, nonatomic) char canAddReceivers;
...
+ (id)sharedInstance;
+ (char)_supportsPassingClosureReasons;
...
- (unsigned long long)_capabilityTypeForContact:(id)a0 serviceName:(id *)a1 isActiveReceiver:(char *)a2;
...
- (char)_serviceCanAttemptConnection:(id *)a0;
...
- (id)_subscriptionTokensForTripID:(id)a0 createIfNeeded:(char)a1;
- (char)_supportsArchivingSharingState;
- (char)_supportsMonitoringBlockList;
...
- (unsigned long long)capabilityTypeForContact:(id)a0 serviceName:(id *)a1 isActiveReceiver:(char *)a2;
...
- (char)isSharingWithContact:(id)a0;
