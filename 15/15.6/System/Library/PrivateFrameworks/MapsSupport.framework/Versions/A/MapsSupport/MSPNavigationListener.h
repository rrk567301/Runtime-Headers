...
@property (readonly, nonatomic) char isInNavigatingState;
@property (readonly, nonatomic) char isCompatibleTransportType;
@property (readonly, nonatomic) char isCompatibleNavigationType;
...
- (char)_currentlyArrivedAtWaypoint;
- (void)_initPendingStateIfNeeded;
- (void)_initPendingStateIfNeededWithTransportType:(int)a0 isResumingMultipointRoute:(char)a1;
- (char)_isCompatibleTransportType:(int)a0;
- (void)_performDelegateNotificationBlockIfReady:(id /* block */)a0;
- (int)_referenceFrameForDestination:(id)a0;
- (char)_updateArrivalTimeAndDistance:(id)a0;
- (void)_updateCurrentWaypointIndexFromArrivalTimeInfo:(id)a0;
- (char)_updateLocation:(id)a0 withRouteMatchedCoordinate:(struct { unsigned int x0; float x1; })a1;
- (void)_updateRoute:(id)a0;
- (void)_updateTransaction;
- (void)_updateTransportTypeFromCurrentState;
- (char)_updateWaypointsIfNeeded:(id)a0;
