...
- (void)_updateStorage;
- (char)_validateNavigationState:(id *)a0;
...
- (char)startSharingWith:(id)a0 capabilityType:(unsigned long long)a1 serviceName:(id)a2 error:(id *)a3;
- (char)startSharingWithGroup:(id)a0 error:(id *)a1;
- (char)stopSharingWith:(id)a0 reason:(unsigned long long)a1 error:(id *)a2;
- (char)stopSharingWithGroup:(id)a0 reason:(unsigned long long)a1 error:(id *)a2;
- (char)stopSharingWithReason:(unsigned long long)a0 error:(id *)a1;
- (void)touchedRules;
