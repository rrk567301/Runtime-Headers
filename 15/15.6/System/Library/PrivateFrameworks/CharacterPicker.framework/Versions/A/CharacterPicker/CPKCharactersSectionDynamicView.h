...
- (void)highlightIndex:(long long)a0 byMouse:(char)a1;
- (char)index:(long long *)a0 atPoint:(struct CGPoint { double x0; double x1; })a1;
- (void)insertSelectedItem:(id)a0;
- (void)insertSelectedItem:(id)a0 byDrag:(char)a1;
- (void)mouseDown:(id)a0 sender:(id)a1;
- (void)playErrorSound;
- (void)setVisiblySelected:(char)a0 forIndex:(unsigned long long)a1;
- (id)stickerViewForEntity:(id)a0 atIndexPath:(id)a1 shouldCreate:(char)a2;
- (char)viewIsShowingPlaceholderItem:(id)a0;
