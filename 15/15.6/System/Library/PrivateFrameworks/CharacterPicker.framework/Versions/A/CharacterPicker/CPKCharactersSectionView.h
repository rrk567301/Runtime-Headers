...
@property (nonatomic) char allowFallbackInSection;
@property (nonatomic) char alwaysShowsScrollBars;
...
@property (nonatomic) char highlightedByMouse;
...
- (void)showSkinToneVariantsPopupAtIndex:(long long)a0 byMouse:(char)a1;
