...
+ (id)_dataCategories;
+ (void)_cacheDataArrayOnlyFastData:(char)a0 usingBlock:(id /* block */)a1;
...
- (char)_cacheDecomposedEntityDataWithCheckGlyph:(char)a0 forceUpdate:(char)a1;
...
- (char)isStickersCategory:(long long)a0;
- (char)needsSecondaryDataSourcePreparation;
- (long long)numberOfCharactersInCategory:(long long)a0;
- (void)prepareDataOnlyFastData:(char)a0 usingBlock:(id /* block */)a1;
