...
@property char showMemojiControls;

- (void)viewDidMoveToWindow;
- (char)isRTL;
- (void)_genmojiButtonSelected:(id)a0;
- (void)_optionsButtonSelected:(id)a0;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 tableInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1 hasCVButton:(char)a2;
- (void)setCVButtonVisible:(char)a0;
