...
- (void)_selectedCatageoryIndex:(long long)a0 byUser:(char)a1;
...
- (void)_scrollToShowCategory:(long long)a0 animate:(char)a1 withCompletion:(id /* block */)a2;
- (char)_shouldIgnoreUserSelectionOnMatrix:(id)a0;
