...
- (id)initFromPublicKeyBytes:(id)a0 inGroup:(struct ccec_cp { unsigned long long x0; unsigned long long x1; struct cczp_funcs *x2; unsigned long long x3[1]; } *)a1 compressed:(char)a2 corecryptoError:(int *)a3;
...
- (id)serializedPublicKey:(char)a0;
