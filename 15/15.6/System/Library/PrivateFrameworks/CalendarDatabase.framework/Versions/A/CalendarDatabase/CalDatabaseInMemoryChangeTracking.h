...
- (id)changedEntityIDsBetweenMinExternalTimestamp:(unsigned long long)a0 minSelfTimestamp:(unsigned long long)a1 maxExternalTimestamp:(unsigned long long)a2 allowIntegrationChanges:(char)a3 latestSelfTimestamp:(unsigned long long *)a4 client:(int)a5 changeType:(unsigned long long *)a6 deleteOffset:(unsigned long long *)a7;
- (id)changedEntityIDsBetweenTimestamp:(id)a0 andTimestamp:(unsigned long long)a1 allowIntegrationChanges:(char)a2 latestTimestamp:(id *)a3 client:(unsigned int)a4 changeType:(unsigned long long *)a5 deleteOffset:(unsigned long long *)a6;
