...
- (id)chargeLibrariesToCallers:(id)a0 keepBoundaries:(char)a1;
...
- (id)findOrAddChildWithName:(id)a0 address:(unsigned long long)a1 nodeSearchType:(int)a2 isLeafNode:(char)a3;
- (id)fullOutputWithThreshold:(unsigned int)a0;
- (id)fullOutputWithThreshold:(unsigned int)a0 showPseudoNodes:(char)a1;
...
- (id)stringFromCallTreeIndentIfNoBranches:(char)a0;
- (id)stringFromCallTreeIndentIfNoBranches:(char)a0 showPseudoNodes:(char)a1;
