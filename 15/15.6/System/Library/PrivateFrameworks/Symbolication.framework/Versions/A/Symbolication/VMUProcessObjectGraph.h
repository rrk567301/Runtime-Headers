...
@property (nonatomic) char isTranslatedByRosetta;
...
@property (nonatomic) char showsPhysFootprint;
@property (nonatomic) char didPhysFootprintDirtyAccounting;
...
- (id)_descriptionForRegionAddress:(unsigned long long)a0 withOffset:(unsigned long long)a1 showSegment:(char)a2;
...
- (id)nodeDescription:(unsigned int)a0 withOffset:(unsigned long long)a1 showLabel:(char)a2;
- (char)nodeDetailIsAutoreleasePoolContentPage:(struct { unsigned long long x0; unsigned long x1 : 60; unsigned char x2 : 4; id x3; })a0;
- (char)nodeIsAutoreleasePoolContentPage:(unsigned int)a0;
