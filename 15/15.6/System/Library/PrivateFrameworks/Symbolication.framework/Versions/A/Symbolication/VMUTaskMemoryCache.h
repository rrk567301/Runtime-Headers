...
@interface VMUTaskMemoryCache : NSObject {
    ...
    char _dyldPlatformIsValid;
    char _haveAttemptedDyldPlatformFetch;
...
+ (char)taskIs64Bit:(unsigned int)a0;
...
- (char)copyRange:(struct _VMURange { unsigned long long x0; unsigned long long x1; })a0 to:(void *)a1;
