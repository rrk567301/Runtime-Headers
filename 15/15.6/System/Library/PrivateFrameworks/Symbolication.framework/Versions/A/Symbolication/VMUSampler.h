...
+ (id)sampleAllThreadsOfTask:(unsigned int)a0 symbolicate:(char)a1;
...
- (id)initWithPID:(int)a0 task:(unsigned int)a1 processName:(id)a2 is64Bit:(char)a3 options:(unsigned long long)a4;
...
- (id)dispatchQueueNameForSerialNumber:(unsigned long long)a0 returnedConcurrentFlag:(char *)a1 returnedThreadId:(unsigned long long *)a2;
- (void)flushData;
- (void)forceStop;
...
- (void)preloadSymbols;
- (unsigned long long)recordSampleTo:(id)a0 timestamp:(unsigned long long)a1 thread:(unsigned int)a2 recordFramePointers:(char)a3 clearMemoryCache:(char)a4;
- (id)sampleAllThreadsOnceWithFramePointers:(char)a0;
- (void)sampleForDuration:(unsigned int)a0 interval:(unsigned int)a1;
- (unsigned int)sampleLimit;
- (void)setRecordThreadStates:(char)a0;
...
- (void)writeOutput:(id)a0 append:(char)a1;
