...
@property (readonly) char isCoreMediaFigObject;
...
- (id)_copyWithInstanceSize:(unsigned int)a0 superclassOffset:(unsigned int)a1 asVariant:(char)a2 mutable:(char)a3;
...
- (void)_identifyObjCClassStructureBlocksForIsa:(unsigned long long)a0 isMetaclass:(char)a1 withScanner:(id)a2 addressIdentifierBlock:(id /* block */)a3;
- (id)_initWithClass:(unsigned long long)a0 type:(unsigned int)a1 realizedOnly:(char)a2 infoMap:(id)a3 objectIdentifier:(id)a4 reader:(id /* block */)a5;
- (unsigned int)_ivarGapForClass;
- (void)_logDescriptionWithSuperclasses:(char)a0 indentation:(int)a1 toLogger:(id /* block */)a2;
...
- (void)_replaceFieldRecursively:(id)a0 atOffset:(unsigned int)a1 withField:(id)a2;
- (void)_setBinaryPath:(id)a0 sanitize:(char)a1;
...
- (void)_setIsCoreMediaFigObject:(char)a0;
- (void)_setIsRootClass:(char)a0;
- (void)_setIsa:(unsigned long long)a0;
- (void)_setSuperclassInfo:(id)a0;
- (void)_setSuperclassOffset:(unsigned int)a0;
...
- (id)initWithClosureContext:(unsigned long long)a0 typeInfo:(struct swift_typeinfo { int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })a1 infoMap:(id)a2 swiftFieldMetadataContext:(struct libSwiftRemoteMirrorWrapper { struct _DummyVMUSwiftReflectionContext *x0; unsigned long long x1; unsigned long long x2; } *)a3;
