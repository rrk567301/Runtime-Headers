...
@property (nonatomic) char singleHyphenLongNames;
@property (nonatomic) char parametersShowAsAssignment;
@property (readonly) int optind;
@property (nonatomic) char abortOnError;
...
- (void)usage:(id)a0;
- (void)usage:(id)a0 shouldExit:(char)a1;
