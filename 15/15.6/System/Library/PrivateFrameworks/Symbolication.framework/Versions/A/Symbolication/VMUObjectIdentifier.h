...
@interface VMUObjectIdentifier : NSObject {
    ...
    char _targetProcessContainsMallocStackLoggingLiteZone;
...
@property (readonly) char hasSwiftContent;
@property (readonly) char hasSwiftReflection;
...
@property (readonly, nonatomic) char taskIsDriverKit;
...
- (char)_isUnrealizedObjCClass:(unsigned long long)a0 recursionDepth:(unsigned int)a1;
- (char)_isValidInstanceLength:(unsigned long long)a0 expectedLength:(unsigned long long)a1;
- (char)_isaPointerRefersToVTable:(unsigned long long)a0 remoteAddress:(unsigned long long)a1 symbol:(struct _CSTypeRef { unsigned long long x0; unsigned long long x1; })a2 symbolNameOut:(const char **)a3;
...
- (char)_remoteAddressIsOKtoRead:(unsigned long long)a0;
...
- (id)labelForNSCFStringAtRemoteAddress:(unsigned long long)a0 printDetail:(char)a1;
...
- (id)labelForNSString:(void *)a0 mappedSize:(unsigned long long)a1 remoteAddress:(unsigned long long)a2 printDetail:(char)a3;
...
- (id)uniquifyStringLabel:(id)a0 stringType:(int)a1 printDetail:(char)a2;
