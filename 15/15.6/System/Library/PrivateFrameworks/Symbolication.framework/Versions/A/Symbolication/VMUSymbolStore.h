...
@interface VMUSymbolStore : NSObject <NSSecureCoding> {
    ...
    NSData *_signature;
    char _resymbolicatedSuccessfully;
...
- (char)_getDsymPathsForUUIDs:(id)a0 andReportProgress:(id)a1;
- (void)_groupAddressTrackerByUuid;
- (char)_readContentsOfDsymFile:(id)a0 error:(id *)a1;
- (char)_refillSymbolOwnersWithDataAndReportProgress:(id)a0;
...
- (char)resymbolicateWithDsymPath:(id)a0 libraryNames:(id)a1 all:(char)a2 progress:(id)a3 showDebugInfo:(char)a4 error:(id *)a5;
