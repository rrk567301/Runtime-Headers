...
@property (nonatomic) struct { char groupByType; char referenceTreeShowRegionVirtualSize; unsigned int *autoreleasePoolsExtraReleasesCount; } options;
...
- (void)iterateAutoreleasePoolsInThreadsGroupingByType:(char)a0 showVirtualSize:(char)a1 extraReleasesCount:(unsigned int *)a2 withBlock:(id /* block */)a3;
