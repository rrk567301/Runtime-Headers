...
@property (readonly, nonatomic) char graphIs64bit;
...
+ (char)encapsulateData:(id)a0 to:(id)a1 withSupplementalDataTag:(const char *)a2 error:(id *)a3 dataGeneratorBlock:(id /* block */)a4;
...
- (unsigned int)reverseEnumerateNodesWithBlock:(id /* block */)a0;
...
- (void)invertEdges;
- (id)invertedGraph;
- (char)isNodePresent:(unsigned int)a0;
- (unsigned int)parentGroupForNode:(unsigned int)a0;
- (id)plistRepresentationWithOptions:(unsigned long long)a0 fromOriginalMemgraph:(id)a1;
