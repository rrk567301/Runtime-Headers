...
@interface VMUTaskMemoryScanner : NSObject <VMUCommonGraphInterface> {
    ...
    char _initializedRegionMallocBlockCounts;
    ...
    char _targetProcessHasObjCPatches;
...
@property (nonatomic) char mallocEnumerationShouldFail;
...
@property (nonatomic) char abandonedMarkingEnabled;
@property (nonatomic) char recordRuntimeMetadataChunkInfo;
...
@property (readonly, nonatomic) char is64bit;
@property (readonly, nonatomic) char isTranslatedByRosetta;
@property (readonly, nonatomic) unsigned int vmPageSize;
@property (readonly, nonatomic) unsigned int kernelPageSize;
@property (readonly, nonatomic) char hasClassInfosDerivedFromStackBacktraces;
...
- (char)addAllNodesFromTaskWithError:(id *)a0;
- (void)detachFromTask;
...
- (char)_callRemoteMallocEnumerators:(unsigned int)a0 error:(id *)a1 block:(id /* block */)a2;
...
- (unsigned int)_nodeForAddress:(unsigned long long)a0 checkMaxInteriorOffset:(char)a1;
...
- (char)addMallocNodesFromTaskWithError:(id *)a0;
- (void)addRootNodesFromTask;
- (char)addRootNodesFromTaskWithError:(id *)a0;
- (char)addressIsInDataSegment:(unsigned long long)a0;
...
- (void *)copyUserMarked;
- (char)doesTargetProcessHaveObjCPatches;
...
- (unsigned long long)ledgerValueForKey:(id)a0 keyExists:(char *)a1;
