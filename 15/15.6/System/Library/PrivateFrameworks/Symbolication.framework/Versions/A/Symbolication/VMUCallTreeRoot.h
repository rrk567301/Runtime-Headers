...
- (id)addUniqueChildWithName:(id)a0 address:(unsigned long long)a1 count:(unsigned int)a2 numBytes:(unsigned long long)a3 toNode:(id)a4 isLeafNode:(char)a5;
- (void)allBacktracesHaveBeenAdded;
- (id)chargeSystemLibrariesToCallersAndKeepBoundaries:(char)a0;
- (id)descriptionStringForAddress:(unsigned long long)a0 atTime:(unsigned long long)a1 leafFrame:(char)a2 startOfRecursion:(char)a3;
- (id)initWithCallGraphFile:(id)a0 fileHeader:(id *)a1 topFunctionsList:(id *)a2 binaryImagesList:(id *)a3;
- (id)initWithCallGraphFile:(id)a0 fileHeader:(id *)a1 topFunctionsList:(id *)a2 binaryImagesList:(id *)a3 error:(id *)a4;
