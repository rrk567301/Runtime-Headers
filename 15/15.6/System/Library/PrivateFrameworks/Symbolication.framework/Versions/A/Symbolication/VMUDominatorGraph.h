...
+ (id)callTreeWithGraph:(id)a0 groupByType:(char)a1 showRegionVirtualSize:(char)a2 desiredAddress:(id)a3 debugTimer:(id)a4;
+ (id)callTreeWithGraph:(id)a0 groupByType:(char)a1 showRegionVirtualSize:(char)a2 desiredClassesPattern:(id)a3 debugTimer:(id)a4;
...
- (char)hasAnyDirectDomineesForNodeName:(unsigned int)a0;
