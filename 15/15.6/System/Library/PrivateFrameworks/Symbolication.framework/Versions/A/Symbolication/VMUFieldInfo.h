...
@property (readonly, nonatomic) char isCapture;
@property (readonly, nonatomic) char isByref;
@property (readonly, nonatomic) char isStorageImplPointer;
@property (readonly, nonatomic) char isArraySize;
@property (readonly, nonatomic) char isArrayEntries;
@property (readonly, nonatomic) char isStorageBitmapPointer;
@property (readonly, nonatomic) char isKeysPointer;
@property (readonly, nonatomic) char isValuesPointer;
@property (readonly, nonatomic) char isValueField;
@property (readonly, nonatomic) char isKeyField;
@property (readonly, nonatomic) char typeNameMayDescribeReferencedAllocation;
...
- (id)initSwiftEnumPayloadFieldWithName:(id)a0 type:(id)a1 kind:(unsigned int)a2 scan:(unsigned int)a3 offset:(unsigned int)a4 size:(unsigned int)a5 stride:(unsigned int)a6 possibleEnumSubFieldArray:(id)a7 swiftTyperef:(unsigned long long *)a8;
- (id)initWithName:(id)a0 type:(id)a1 kind:(unsigned int)a2 scan:(unsigned int)a3 offset:(unsigned int)a4 size:(unsigned int)a5 stride:(unsigned int)a6 subFieldArray:(id)a7 swiftTyperef:(unsigned long long *)a8;
- (id)initWithName:(id)a0 type:(id)a1 scan:(unsigned int)a2 offset:(unsigned int)a3 size:(unsigned int)a4;
- (id)initWithObjcIvar:(struct objc_ivar { } *)a0 size:(unsigned int)a1 offset:(unsigned int)a2 ivarName:(const char *)a3 isARC:(char)a4 is64Bit:(char)a5;
