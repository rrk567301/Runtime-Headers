...
- (char)hasClassInfosDerivedFromStackBacktraces;
...
- (char)isRootNode:(unsigned int)a0;
...
- (void)setClassInfoIndex:(unsigned int)a0 forNode:(unsigned int)a1;
