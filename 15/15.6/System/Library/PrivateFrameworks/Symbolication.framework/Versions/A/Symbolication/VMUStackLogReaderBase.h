@class NSSet, VMUTask, NSString, VMUVMRegionTracker, NSMapTable, NSMutableDictionary;
...
- (char)shouldIgnoreSymbolWithName:(id)a0 binaryPath:(id)a1;
...
- (id)symbolicatedBacktraceForNode:(unsigned int)a0 nodeDetails:(struct { unsigned long long x0; unsigned long x1 : 60; unsigned char x2 : 4; id x3; })a1 isLiteZone:(char)a2 options:(unsigned long long)a3;
