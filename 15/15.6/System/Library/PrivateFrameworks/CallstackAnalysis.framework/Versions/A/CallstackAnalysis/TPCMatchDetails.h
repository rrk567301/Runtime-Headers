...
@property (nonatomic) char validMatchResult;
@property (nonatomic) char isMatch;
@property (nonatomic) char isApproximateMatch;
@property (nonatomic) char shouldSuppress;
