...
@property (nonatomic) char isSymbolicated;
@property (nonatomic) char isThirdParty;
...
+ (char)isBlockInvokeFrame:(id)a0;
+ (char)isEqualToCleansedString:(id)a0 string2:(id)a1;
+ (char)isSwiftClosureFrame:(id)a0;
