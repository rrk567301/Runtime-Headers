...
+ (char)isAncestorThirdPartyFrame:(unsigned long long)a0 object:(id)a1;
+ (char)isLastRegionSimilarToBacktrace:(id)a0 score:(unsigned long long *)a1;
+ (char)isWALCheckpointFrame:(id)a0;
+ (void)shouldSuppress:(id)a0 thirdPartyFrameCount:(unsigned long long)a1;
+ (char)signatureFrameIsBoundary:(id)a0;
+ (id)validateBacktrace:(id)a0 error:(id *)a1;
+ (char)validateUltimateAncestorIsRoot:(id)a0 store:(id)a1;

- (id)diagnosticsDictionaryForDiagnostics:(id)a0;
- (char)isCallerThirdPartyFrame:(unsigned long long)a0 level:(unsigned long long)a1 backtrace:(id)a2;
