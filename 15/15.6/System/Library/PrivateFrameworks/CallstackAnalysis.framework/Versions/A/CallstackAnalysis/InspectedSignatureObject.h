...
@property (nonatomic) char lowest_3P_frame_seen;
@property (nonatomic) char has_trigger_frame;
@property (nonatomic) char direct_wal_checkpoint_invocation;
@property (nonatomic) unsigned long long special_frame;
@property (nonatomic) char sqlite_usage;
...
- (id)init;
- (void).cxx_destruct;
- (void)updateRegionStats:(long long)a0 distance:(long long)a1 region:(char)a2;
