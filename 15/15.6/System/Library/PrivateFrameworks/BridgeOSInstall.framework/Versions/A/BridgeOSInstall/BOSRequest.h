...
@property char enableSSO;
@property (retain) NSData *appleConnectData;
@property char showUI;
@property char cleanInstall;
@property char loopbackEnabled;
@property char testModeEnabled;
...
- (char)clientContextIsEqualTo:(id)a0;
