...
- (void)setStagedUpdatesOnly:(char)a0;
- (id)_catalogEvaluationPredicate;
- (id)_destinationURLForPackageReference:(id)a0 destinationDirectoryURL:(id)a1;
- (char)_downloadPackagesForProductToDirectory:(id)a0;
- (char)_evaluateProductsInCatalogWithPredicate:(id)a0;
- (char)_findProductMatchingPredicate:(id)a0;
- (id)_findProductPredicate;
- (char)_loadCatalog;
- (char)_queueRequiredPackagesReferencesWithDownloader:(id)a0 destinationDirectoryURL:(id)a1;
