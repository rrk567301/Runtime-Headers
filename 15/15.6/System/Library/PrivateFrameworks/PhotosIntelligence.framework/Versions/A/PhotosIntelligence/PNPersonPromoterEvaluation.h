...
+ (char)createDirectoryIfNotExitAtURL:(id)a0;
+ (char)exportPhotoLibrary:(id)a0 toURL:(id)a1 forPeople:(id)a2 error:(id *)a3;
+ (char)exportPhotoLibrary:(id)a0 toURL:(id)a1 forPeopleType:(unsigned long long)a2 error:(id *)a3;
