...
+ (char)assetIsEligibleForSettlingEffect:(id)a0;
+ (double)cropScoreWithAsset:(id)a0 classification:(unsigned long long)a1 passesClockOverlap:(char *)a2 cropZoomRatio:(double *)a3 orientation:(long long)a4;
+ (id)fetchLivePhotoTabHighlightCandidateAssetsWithOptions:(id)a0 excludeExistingWallpapers:(char)a1 statistics:(struct { int x0; int x1; int x2; int x3; int x4; int x5; } *)a2;
+ (id)fetchLivePhotoTabHighlightSettlingEffectAssetsWithOptions:(id)a0 excludeExistingWallpapers:(char)a1;
...
+ (char)_assetPassesFRCInstantPlayback:(id)a0;
...
+ (char)_cacheExistsForAsset:(id)a0;
...
+ (id)_filterSuggestions:(id)a0 withSingleFeature:(unsigned long long)a1 included:(char)a2;
...
+ (char)_updateAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1 toClear:(char)a2;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })bestWallpaperCropForAsset:(id)a0 classification:(unsigned long long)a1 outputCropScore:(double *)a2 outputLayoutAcceptable:(char *)a3;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })bestWallpaperCropForAsset:(id)a0 classification:(unsigned long long)a1 outputCropScore:(double *)a2 outputLayoutAcceptable:(char *)a3 layoutConfiguration:(id)a4;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })bestWallpaperCropForSuggestion:(id)a0 outputCropScore:(double *)a1 outputLayoutAcceptable:(char *)a2;
+ (char)clearAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1;
...
+ (char)hasAnyKnownPersonLocalIdentifierInPhotoLibrary:(id)a0;
...
+ (char)setAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1;
+ (id)wallpaperCroppingDebugKeyValuePairsForAsset:(id)a0;
+ (char)wallpaperDemoModeEnabled;
...
+ (id)wallpaperPeopleLocalIdentifiersInPhotoLibrary:(id)a0 vipOnly:(char)a1;
