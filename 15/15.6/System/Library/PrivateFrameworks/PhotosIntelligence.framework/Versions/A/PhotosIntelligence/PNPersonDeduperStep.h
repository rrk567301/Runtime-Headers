@class NSString, NSDictionary, NSMapTable, PNPersonClusterManager, PNPersonDeduperProfile;
...
- (char)addPotentialMergeCandidateForPerson:(id)a0 withOtherPerson:(id)a1 updateBlock:(id /* block */)a2;
...
- (char)isPersonSimilar:(id)a0 withOtherPerson:(id)a1 withDistance:(float)a2 minAgeType:(unsigned short)a3;
- (id)mergeCandidatePersonsWithUpdateBlock:(id /* block */)a0;
- (char)shouldStopWithUpdateBlock:(id /* block */)a0;
