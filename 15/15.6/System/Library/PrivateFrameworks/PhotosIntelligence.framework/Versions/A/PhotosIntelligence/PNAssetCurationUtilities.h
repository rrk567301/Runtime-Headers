...
+ (char)assetIsSafeForWidgetDisplay:(id)a0;
...
+ (char)assetIsSafeForDisplay:(id)a0 modelSet:(id)a1;
+ (char)_assetIsSafeForWidgetDisplay:(id)a0 sceneClassifications:(id)a1 modelSet:(id)a2;
+ (id)_internalPredicateToFilterSyndicatedAssetsEligibleWithCurationScore:(double)a0;
+ (char)_isSupportedTabooEventIdentifier:(unsigned long long)a0;
...
+ (char)assetIsSafeForWidgetDisplay:(id)a0 sceneClassifications:(id)a1;
