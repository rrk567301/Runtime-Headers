...
- (float)distanceBetweenHuman:(id)a0 andHuman:(id)a1 useCommonMoments:(char)a2 minAgeType:(unsigned short *)a3 updateBlock:(id /* block */)a4 error:(id *)a5;
- (float)distanceBetweenPerson:(id)a0 andPerson:(id)a1 useCommonMoments:(char)a2 minAgeType:(unsigned short *)a3 updateBlock:(id /* block */)a4 error:(id *)a5;
- (float)distanceBetweenPet:(id)a0 andPet:(id)a1 useCommonMoments:(char)a2;
- (float)distanceBetweenPetFaces:(id)a0 andPetFaces:(id)a1;
- (float)distanceWithOverlapCheckBetweenPerson:(id)a0 andPerson:(id)a1 useCommonMoments:(char)a2 minAgeType:(unsigned short *)a3 updateBlock:(id /* block */)a4 error:(id *)a5;
