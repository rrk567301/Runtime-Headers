...
+ (id)_logger;
+ (char)_isMePersonWithLocalIdentifier:(id)a0 inPhotoLibrary:(id)a1 error:(id *)a2;
+ (void)_logIntelligencePlatformUserFeedback:(long long)a0 forSuggestion:(id)a1;
+ (id)_meContactIdentifierWithError:(id *)a0;
+ (id)fetchAutonamingSuggestionForPerson:(id)a0 checkIsMe:(char)a1 withError:(id *)a2;
