...
+ (char)isEnabled;
+ (char)hasProcessedForLibrary:(id)a0;
+ (id)requestSuggestedMePersonIdentifierAtURL:(id)a0 withError:(id *)a1;
+ (void)setProcessed:(char)a0 forLibrary:(id)a1;
+ (id)_personPromoterInformationAtURL:(id)a0;
+ (char)_writePersonPromoterInformation:(id)a0 atURL:(id)a1;
...
- (char)promoteUnverifiedPersonsWithUpdateBlock:(id /* block */)a0;
- (char)_personClusterShouldBeVerified:(id)a0;
...
- (char)_promoteInterestingPersons:(id)a0 updateBlock:(id /* block */)a1;
