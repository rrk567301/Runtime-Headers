...
- (id)iconStyleFor:(id)a0 forceToFillBackground:(char)a1;
- (id)imageForIconEntry:(id)a0 style:(id)a1 language:(id)a2 useRoundCorenr:(char)a3;
- (id)imageForInputSource:(id)a0 language:(id)a1 forceToFillBackground:(char)a2 useRoundCorenr:(char)a3;
