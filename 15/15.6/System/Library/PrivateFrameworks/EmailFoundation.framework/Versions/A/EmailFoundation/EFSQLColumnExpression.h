...
- (id)in:(id)a0;
- (id)is:(id)a0;
- (id)beginsWith:(id)a0 caseSensitive:(char)a1;
- (id)between:(id)a0;
- (id)cachedSelf;
- (id)contains:(id)a0 caseSensitive:(char)a1;
- (id)doesNotContain:(id)a0 caseSensitive:(char)a1;
- (id)doesNotMatchMask:(id)a0;
- (id)ef_SQLIsolatedExpression;
- (void)ef_renderSQLExpressionInto:(id)a0;
- (id)endsWith:(id)a0 caseSensitive:(char)a1;
- (id)equalTo:(id)a0;
