...
@property (nonatomic) char _usingInSwiftSheet;
@property (copy, nonatomic) id /* block */ resizeBlock;
@property (nonatomic) char accountsProvidedBySuggestion;
...
- (char)handleInsecureConnectionForAccount:(id)a0 withSaveError:(id)a1;
