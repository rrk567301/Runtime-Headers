...
@property (nonatomic) char disableAutoReload;
...
- (void)digestSaveError:(id)a0 inWindow:(id)a1 isSetup:(char)a2;
- (char)handleInsecureConnectionForAccount:(id)a0 withSaveError:(id)a1 inWindow:(id)a2;
