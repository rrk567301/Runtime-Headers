...
@property (readonly, nonatomic, getter=isConfiguring) char configuring;
@property (readonly, nonatomic, getter=isGreyMode) char greyMode;
...
- (id)nameColor;
- (void)setDataclassEnabled:(char)a0 sender:(id)a1;
