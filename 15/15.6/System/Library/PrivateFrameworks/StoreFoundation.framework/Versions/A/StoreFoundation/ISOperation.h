...
- (char)runSubOperation:(id)a0 returningError:(id *)a1;
- (void)_sendErrorToDelegate:(id)a0;
- (void)_sendSuccessToDelegate;
- (void)_failAfterException;
- (char)_loadRequredBagReturningError:(id *)a0;
- (void)_main:(char)a0;
- (int)runRunLoopUntilStopped;
- (char)runSyncReturningError:(id *)a0;
- (void)sendProgressToDelegate;
- (char)showDialogInSeperateProcessForOperation:(id)a0;
- (void)stopRunLoop;
