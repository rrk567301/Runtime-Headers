...
- (id)connectionWithServiceName:(id)a0 protocol:(id)a1 isMachService:(char)a2;
- (id)downloadServiceWithErrorHandler:(id /* block */)a0;
- (id)objectProxyForServiceName:(id)a0 protocol:(id)a1 interfaceClassName:(id)a2 isMachService:(char)a3 errorHandler:(id /* block */)a4;
- (void)performSynchronousBlock:(id /* block */)a0 withServiceName:(id)a1 protocol:(id)a2 isMachService:(char)a3 interfaceClassName:(id)a4;
