...
@property (getter=_shouldSetCookies, setter=_setShouldSetCookies:) char _shouldSetCookies;
...
@property char checkForIncompleteFinish;
@property char cancelIfNotAlreadyOnDisk;
@property char requireExtendedValidationCertificate;
@property (copy) NSArray *anchorCertificates;
@property char anchorRevocationCheck;
@property (readonly) char fileWasAlreadyOnDisk;
@property char shouldRetryOnNetworkError;
...
- (void)connection:(id)a0 conditionalRequirementsChanged:(char)a1;
