...
@interface PSGPBPrediction : PBCodable <NSCopying> {
    struct { unsigned char dataSourceType : 1; unsigned char maxPredictionItems : 1; unsigned char maxStructuredInfoItems : 1; unsigned char maxTextualResponseItems : 1; unsigned char numStructuredInfoItems : 1; unsigned char numTextualResponseItems : 1; unsigned char triggerSourceType : 1; unsigned char hasContextBeforeInput : 1; unsigned char hasRecipientNames : 1; unsigned char hasResponseContext : 1; unsigned char isDocumentEmpty : 1; unsigned char isResponseContextBlacklisted : 1; unsigned char portraitTimeout : 1; unsigned char requiredAppUnavailable : 1; } _has;
}
...
@property (nonatomic) char hasPortraitTimeout;
@property (nonatomic) char portraitTimeout;
@property (nonatomic) char hasRequiredAppUnavailable;
@property (nonatomic) char requiredAppUnavailable;
