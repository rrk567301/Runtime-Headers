...
+ (void)runHarvestSkipMessageCollection:(char)a0 clearCheckpoint:(char)a1 reportMetrics:(char)a2 modelConfigPath:(id)a3 modelVocabPath:(id)a4 modelFilePath:(id)a5 storeDirectory:(id)a6 evalFraction:(id)a7;
...
- (char)deferAfterWriteCheckpointForActivity:(id)a0;
