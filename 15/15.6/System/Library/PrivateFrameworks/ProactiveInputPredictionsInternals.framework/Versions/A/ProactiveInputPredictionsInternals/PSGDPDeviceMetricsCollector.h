...
+ (char)recordEngagementMetrics:(id)a0 selectedRecorder:(id)a1 ignoredRecorder:(id)a2;
+ (char)recordResponse:(id)a0 numTimesToLog:(unsigned long long)a1 recorder:(id)a2 prefix:(id)a3;
+ (char)sendEngagementToDPUsingData:(id)a0;
