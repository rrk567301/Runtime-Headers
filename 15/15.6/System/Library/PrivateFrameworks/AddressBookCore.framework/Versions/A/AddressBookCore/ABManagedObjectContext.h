...
@property char writeChangesToServer;
@property char sendsChangeNotifications;
@property char unlockOnDealloc;
...
- (id)abObjectsForPredicate:(id)a0 entityName:(id)a1 affectedStores:(id)a2 asFaults:(char)a3;
