...
@property (readonly) char isMainAccount;
@property (readonly) char isChildDelegateAccount;
...
@property char canBecomeDefaultAccount;
@property char canReimportFromMetadata;
@property char showAllContactsIfOnlyOneGroup;
@property char supportsDistributionLists;
@property char usesSyncServices;
...
@property (readonly, getter=isInitialSyncComplete) char initialSyncComplete;
...
- (void)setGuardianRestricted:(char)a0;
