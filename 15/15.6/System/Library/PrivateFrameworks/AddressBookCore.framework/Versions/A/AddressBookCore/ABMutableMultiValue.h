...
- (void)_combineWithMultiValue:(id)a0 updating:(char)a1;
- (void)_createArrays;
...
- (char)removeValueAndLabelAtIndex:(unsigned long long)a0;
- (char)replaceLabelAtIndex:(unsigned long long)a0 withLabel:(id)a1;
- (char)replaceValueAtIndex:(unsigned long long)a0 withValue:(id)a1;
- (char)setPrimaryIdentifier:(id)a0;
