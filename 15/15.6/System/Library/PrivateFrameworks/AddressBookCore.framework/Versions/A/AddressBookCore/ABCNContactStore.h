...
- (char)addMember:(id)a0 toGroup:(id)a1 error:(id *)a2;
...
- (id)contactWithIdentifier:(id)a0 unify:(char)a1 error:(id *)a2;
- (id)contactsMatchingPredicate:(id)a0 error:(id *)a1;
- (char)deleteContact:(id)a0 error:(id *)a1;
- (id)deprecated_executeFetchRequest:(id)a0 error:(id *)a1;
- (id)executeFetchRequest2:(id)a0 error:(id *)a1;
- (id)fetchContactsWithIdentifiers:(id)a0 unify:(char)a1 error:(id *)a2;
...
- (char)isContactReadOnly:(id)a0;
- (id)makeDataMapper;
- (id)membersOfGroupWithIdentifier:(id)a0 error:(id *)a1;
- (id)photoForContact:(id)a0;
- (id)photoForContacts:(id)a0;
- (char)saveContact:(id)a0 error:(id *)a1;
- (char)saveContacts:(id)a0 error:(id *)a1;
- (char)saveGroup:(id)a0 error:(id *)a1;
- (id)saveImmutableContact:(id)a0 error:(id *)a1;
- (char)setImageData:(id)a0 onContact:(id)a1 error:(id *)a2;
