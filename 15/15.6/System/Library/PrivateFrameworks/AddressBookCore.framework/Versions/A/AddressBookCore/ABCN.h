...
+ (id)fetchContactsWithIdentifiers:(id)a0 unify:(char)a1 inAddressBook:(id)a2 error:(id *)a3;
...
+ (char)isContactReadOnly:(id)a0 inAddressBook:(id)a1;
...
+ (char)setImageData:(id)a0 onContact:(id)a1 inAddressBook:(id)a2 error:(id *)a3;
+ (char)setImageData:(id)a0 onLinkedContacts:(id)a1 inAddressBook:(id)a2 error:(id *)a3;
+ (char)setImageData:(id)a0 onNonUnifiedContact:(id)a1 inAddressBook:(id)a2 error:(id *)a3;
