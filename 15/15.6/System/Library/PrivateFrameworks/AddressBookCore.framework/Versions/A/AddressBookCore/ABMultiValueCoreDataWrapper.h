...
+ (char)applyMultiValue:(id)a0 withCustomProperty:(id)a1 toRecord:(id)a2 managedObject:(id)a3;
+ (char)applyMultiValue:(id)a0 withProperty:(id)a1 toManagedObject:(id)a2;
+ (char)applyMultiValue:(id)a0 withProperty:(id)a1 toRecord:(id)a2;
...
+ (char)populateIdentifiers:(id)a0 values:(id)a1 labels:(id)a2 primaryIdentifier:(id *)a3 withDataFromManagedObject:(id)a4 property:(id)a5;
+ (char)populateIdentifiers:(id)a0 values:(id)a1 labels:(id)a2 primaryIdentifier:(id *)a3 withDataFromRecord:(id)a4 customPropertyDescription:(id)a5;
+ (char)populateIdentifiers:(id)a0 values:(id)a1 labels:(id)a2 primaryIdentifier:(id *)a3 withDataFromRecord:(id)a4 property:(id)a5;
