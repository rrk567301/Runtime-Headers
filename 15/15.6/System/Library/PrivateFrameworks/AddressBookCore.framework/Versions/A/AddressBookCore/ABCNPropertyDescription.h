...
- (id)initWithKey:(id)a0 readSelector:(SEL)a1 writeSelector:(SEL)a2 addressBookProperty:(id)a3 coreDataKey:(id)a4 isMultiValue:(char)a5 toAddressBookTransform:(id /* block */)a6 fromAddressBookTransform:(id /* block */)a7;
