...
+ (long long)addPropertiesAndTypes:(id)a0 forClass:(Class)a1 withAddressBook:(id)a2 acquireLock:(char)a3 save:(char)a4;
...
+ (id)propertyTypesForClass:(Class)a0 withAddressBook:(id)a1 acquireLock:(char)a2;
