...
@property (readonly, nonatomic) char _usePointer;
...
@property (nonatomic) char scalePointerPhaseScrollToPixels;
...
- (void)_pointerOrFingerScrollAt:(struct CGPoint { double x0; double x1; })a0 byDelta:(struct CGVector { double x0; double x1; })a1 duration:(double)a2 touchDownAndLift:(char)a3;
