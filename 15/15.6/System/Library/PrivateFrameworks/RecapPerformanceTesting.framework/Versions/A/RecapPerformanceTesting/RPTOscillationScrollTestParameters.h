...
@property (nonatomic) char shouldFlick;
@property (nonatomic) double useDefaultDurationForFlick;
@property (nonatomic) char preventDismissalGestures;
@property (nonatomic) char finishWithHalfIteration;
...
@property (readonly, nonatomic) char managesTestStartAndEnd;
...
- (struct CGPoint { double x0; double x1; })_incrementPoint:(struct CGPoint { double x0; double x1; })a0 final:(char)a1;
- (struct CGPoint { double x0; double x1; })finalFingerPosition;
- (id)initWithTestName:(id)a0 iterations:(unsigned long long)a1 scrollingBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 useFlicks:(char)a3 preventDismissalGestures:(char)a4 initialAmplitude:(double)a5 amplitudeVariationPerIteration:(double)a6 initialDirection:(long long)a7 iterationDuration:(double)a8 finishWithHalfIteration:(char)a9;
- (id)initWithTestName:(id)a0 iterations:(unsigned long long)a1 scrollingBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 useFlicks:(char)a3 preventDismissalGestures:(char)a4 initialAmplitude:(double)a5 amplitudeVariationPerIteration:(double)a6 initialDirection:(long long)a7 iterationDuration:(double)a8 finishWithHalfIteration:(char)a9 completionHandler:(id /* block */)a10;
