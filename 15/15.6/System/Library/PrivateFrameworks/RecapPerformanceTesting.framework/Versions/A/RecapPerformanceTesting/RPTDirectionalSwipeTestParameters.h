...
- (id)initWithTestName:(id)a0 scrollingBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 swipeCount:(long long)a2 reverse:(char)a3 direction:(long long)a4 completionHandler:(id /* block */)a5;
