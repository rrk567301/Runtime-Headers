...
@property (nonatomic) char useFlicks;
...
- (id)initWithTestName:(id)a0 iterations:(unsigned long long)a1 scrollingBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 amplitude:(double)a3 direction:(long long)a4 iterationDuration:(double)a5 useFlicks:(char)a6 completionHandler:(id /* block */)a7;
