...
- (id)initWithViewControllerOfPreferredContentSize:(struct CGSize { double x0; double x1; })a0 title:(id)a1 wantsBorder:(char)a2;
...
- (id)initWithContextSize:(struct CGSize { double x0; double x1; })a0 isBitmap:(char)a1 drawingBlock:(id /* block */)a2;
...
- (id)initWithViewControllerOfPreferredContentSize:(struct CGSize { double x0; double x1; })a0 minimumSize:(struct CGSize { double x0; double x1; })a1 title:(id)a2 wantsBorder:(char)a3;
