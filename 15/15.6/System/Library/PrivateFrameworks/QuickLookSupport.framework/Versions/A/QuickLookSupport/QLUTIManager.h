...
+ (id)claimedPDFTypes;
+ (id)claimedCSVTypes;
+ (char)contentTypeIsInternallyClaimed:(id)a0;
...
+ (char)contentType:(id)a0 conformsToContentTypeInArray:(id)a1;
+ (char)contentTypeIsIWorkType:(id)a0;
+ (char)externalGeneratorPreferredForType:(id)a0;
+ (id)iWorkTypes;
