...
@property (readonly, nonatomic, getter=isUnique) char unique;
...
- (id)initWithEntity:(Class)a0 name:(id)a1 columns:(id)a2 unique:(char)a3 predicateString:(id)a4;
- (id)initWithEntity:(Class)a0 name:(id)a1 columns:(id)a2 collationForColumn:(id)a3 unique:(char)a4 predicateString:(id)a5;
