...
- (char)hasActiveAssertion:(id)a0;
- (char)hasActiveAssertionForIdentifier:(id)a0;
- (void)removeObserver:(id)a0 forAssertionIdentifier:(id)a1;
- (void)resumeBudgetConsumption;
- (void)suspendBudgetConsumption;
- (char)takeAssertion:(id)a0;
- (char)takeAssertion:(id)a0 preNotificationBlock:(id /* block */)a1;
