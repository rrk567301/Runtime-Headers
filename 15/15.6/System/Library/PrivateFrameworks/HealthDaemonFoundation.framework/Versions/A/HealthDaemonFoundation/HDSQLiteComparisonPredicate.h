...
+ (id)predicateWithProperty:(id)a0 value:(id)a1 comparisonType:(long long)a2 influenceIndexUsage:(char)a3;
...
- (id)initWithProperty:(id)a0 value:(id)a1 comparisonType:(long long)a2 influenceIndexUsage:(char)a3;
