...
@property (nonatomic) char hasDefaultApp;

+ (id)modelWithDefaultAction:(id)a0 actions:(id)a1 recentActions:(id)a2 directoryServiceActions:(id)a3 foundOnDeviceActions:(id)a4 hasDefaultApp:(char)a5;

- (void).cxx_destruct;
- (id)model;
- (void)removeUninterestingItentActions;
- (id)initWithDefaultAction:(id)a0 actions:(id)a1 recentActions:(id)a2 directoryServiceActions:(id)a3 foundOnDeviceActions:(id)a4 hasDefaultApp:(char)a5;
