...
@property (readonly, nonatomic) char shouldGroupByBundleIdentifier;
@property (readonly, nonatomic) char shouldCurateIfPerformed;
@property (readonly, nonatomic) char isSuggested;
@property (readonly, nonatomic) char shouldPromoteLoneActionToBeDefault;
@property (readonly, nonatomic) char shouldOpenToBundleIdentifier;
...
+ (id)itemWithType:(id)a0 contactProperty:(id)a1 bundleIdentifier:(id)a2 dialRequest:(id)a3 isSuggested:(char)a4 options:(unsigned long long)a5 isEligibleDefaultApp:(char)a6;
...
+ (id)itemWithType:(id)a0 contactProperty:(id)a1 bundleIdentifier:(id)a2 url:(id)a3 isSensitive:(char)a4 group:(long long)a5 options:(unsigned long long)a6;
...
+ (id)itemWithType:(id)a0 contactProperty:(id)a1 bundleIdentifier:(id)a2 userActivity:(id)a3 isSuggested:(char)a4 options:(unsigned long long)a5;
...
- (char)isHandledByFirstPartyApp;
- (id)performActionWithContext:(id)a0;
- (char)runningOniPad;
- (char)shouldUseApplicationNameForLabel;
- (char)shouldUseLabelForQuickActionButtonTitle;
