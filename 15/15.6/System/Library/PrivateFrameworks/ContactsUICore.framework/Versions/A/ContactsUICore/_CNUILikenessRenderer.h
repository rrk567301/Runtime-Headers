...
+ (struct CGImage { } *)cgImageForLikenessProvider:(id)a0 pointSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 style:(unsigned long long)a3 alwaysUsePointSize:(char)a4;
