...
+ (char)isDestinationAvailable:(id)a0 givenStatusesByDestination:(id)a1;
+ (char)isStatusOfAnyDestinationUnknown:(id)a0;
...
+ (char)shouldRetryRefreshingIDSStatusOfDesinationsGivenResult:(id)a0;
