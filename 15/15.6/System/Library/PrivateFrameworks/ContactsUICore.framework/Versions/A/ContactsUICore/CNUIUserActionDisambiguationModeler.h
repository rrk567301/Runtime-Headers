...
- (char)hasDefaultAppForActionType:(id)a0;
- (id)initWithTargetDiscoveringHelper:(id)a0 rankingHelper:(id)a1 defaultActionFetcher:(id)a2 discoveringEnvironment:(id)a3;
- (id)modelsWithActionType:(id)a0 defaultAction:(id)a1 actions:(id)a2 recentActions:(id)a3 sorts:(char)a4 throttles:(char)a5;
