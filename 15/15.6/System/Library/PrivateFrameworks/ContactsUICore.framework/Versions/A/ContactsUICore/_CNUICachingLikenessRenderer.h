...
@property (readonly, nonatomic) char shouldRequireMainThread;
...
- (id)initWithLikenessRenderer:(id)a0 schedulerProvider:(id)a1 capacity:(unsigned long long)a2 shouldRequireMainThread:(char)a3;
- (id)initWithLikenessRenderer:(id)a0 schedulerProvider:(id)a1 capacity:(unsigned long long)a2 shouldRequireMainThread:(char)a3 contactStore:(id)a4;
