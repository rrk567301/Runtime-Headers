...
@property (readonly, nonatomic) char matchFamilyMembersWithContacts;
...
- (id)familyInfo;
- (id)initWithMainContactStoreFacade:(id)a0 fetchFamilyCircleRequest:(id)a1 matchFamilyMembersWithContacts:(char)a2 schedulerProvider:(id)a3;
- (id)initWithMainContactStoreFacade:(id)a0 matchFamilyMembersWithContacts:(char)a1 schedulerProvider:(id)a2;
