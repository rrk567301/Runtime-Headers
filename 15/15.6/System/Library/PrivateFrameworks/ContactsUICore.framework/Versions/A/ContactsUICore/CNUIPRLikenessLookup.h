...
+ (id)contactFuture:(id)a0 contactStore:(id)a1 personaId:(id)a2 scheduler:(id)a3 refetchContact:(char)a4;
+ (id)contactFuture:(id)a0 contactStore:(id)a1 refetchContact:(char)a2;
...
+ (char)useGivenAvatarForContact:(id)a0;
...
- (char)mayIncludeSource:(long long)a0;
- (id)photoFutureForContactFuture:(id)a0 photoFuture:(id)a1 allowingFallbackForMeCard:(char)a2;
...
- (char)shouldFetchSharedPhotoForContact:(id)a0;
