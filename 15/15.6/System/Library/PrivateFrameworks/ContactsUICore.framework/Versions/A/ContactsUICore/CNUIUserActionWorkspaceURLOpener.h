...
+ (id)openConfigurationWithEndpoint:(id)a0 isSensitive:(char)a1;
+ (id)urlCouldNotBeOpenedErrorWithURL:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (id)initWithWorkspace:(id)a0;
- (id)openURL:(id)a0 isSensitive:(char)a1 connectionEndpoint:(id)a2 bundleIdentifier:(id)a3 withScheduler:(id)a4;
- (id)openURL:(id)a0 isSensitive:(char)a1 withScheduler:(id)a2;
