...
- (char)manifestHasInternalUseOnlyBuild:(id)a0 error:(id *)a1;
- (char)networkAvailableForPersonalizationWithOptions:(id)a0;
- (char)personalizationRequired;
- (char)personalizationRequiredForVolumeAtMountPoint:(id)a0;
...
- (char)volumeHasBeenPersonalized:(id)a0 prebootFolder:(id)a1;
