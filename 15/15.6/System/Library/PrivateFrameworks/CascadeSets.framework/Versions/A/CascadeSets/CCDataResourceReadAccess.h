...
- (char)_enumerateReadableSets:(id *)a0 resourceOptions:(unsigned char)a1 itemType:(unsigned short)a2 usingBlock:(id /* block */)a3;
...
- (char)_shouldSkipAccessRequestForResource:(id)a0;
- (char)enumerateReadableSets:(id *)a0 withOptions:(unsigned short)a1 itemType:(unsigned short)a2 usingBlock:(id /* block */)a3;
