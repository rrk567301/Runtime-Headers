...
- (char)recursivelyEnumerateFieldsWithError:(id *)a0 forParentField:(id)a1 isRepeatedSubMessage:(char)a2 repeatedSubMessageIndex:(unsigned int)a3 usingBlock:(id /* block */)a4;
- (char)recursivelyEnumerateFieldsWithError:(id *)a0 usingBlock:(id /* block */)a1;
