...
- (char)constructStateVectorsFromDatabaseWithDeviceMapping:(id)a0 outContent:(id *)a1 outMetaContent:(id *)a2 error:(id *)a3;
- (char)enumerateProvenanceRecordsForStateVector:(id)a0 withType:(unsigned char)a1 selectAtomsInState:(unsigned char)a2 skipOverAtomsInState:(unsigned char)a3 deviceMapping:(id)a4 error:(id *)a5 usingBlock:(id /* block */)a6;
...
- (char)_enumerateProvenanceRecordsFromCommand:(id)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
