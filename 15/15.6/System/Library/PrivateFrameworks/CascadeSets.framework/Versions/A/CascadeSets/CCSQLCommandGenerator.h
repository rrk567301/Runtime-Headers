...
+ (id)_produceSelectClauseWithTableName:(id)a0 columnNames:(id)a1 count:(char)a2;
...
+ (id)selectFromTableWithName:(id)a0 columns:(id)a1 count:(char)a2 join:(id)a3 criterion:(id)a4 order:(id)a5 limit:(id)a6 offset:(id)a7;
