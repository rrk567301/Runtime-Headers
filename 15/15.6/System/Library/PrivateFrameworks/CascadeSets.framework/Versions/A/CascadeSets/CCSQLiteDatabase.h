...
- (char)_prepareSqliteStatement:(struct sqlite3_stmt **)a0 usingCommand:(id)a1 outError:(id *)a2;
- (char)_validateAndBindSqliteStatementParameters:(struct sqlite3_stmt { } *)a0 usingCommand:(id)a1 outError:(id *)a2;
- (char)_validateCommand:(id)a0 outError:(id *)a1;
