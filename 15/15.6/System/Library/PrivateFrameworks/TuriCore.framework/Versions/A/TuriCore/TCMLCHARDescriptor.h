...
+ (id)defineSTGCNDescriptor:(id)a0 inputChannels:(unsigned long long)a1 outputChannels:(unsigned long long)a2 numKeypoints:(unsigned long long)a3 temporalKernelSize:(unsigned long long)a4 stride:(unsigned long long)a5 dropout:(float)a6 residual:(char)a7;
