...
- (void)arcWithX:(double)a0 y:(double)a1 radius:(double)a2 startAngle:(double)a3 endAngle:(double)a4 anticlockwise:(char)a5;
...
- (char)isPointInPathWithX:(double)a0 y:(double)a1;
