...
@interface TCMPSConvolutionWeights : NSObject <MPSCNNConvolutionDataSource> {
    ...
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct __compressed_pair<std::basic_string<char>::__rep, std::allocator<char>> { union __rep { struct __short { struct { unsigned char __is_long_ : 1; unsigned char __size_ : 7; } ; char __padding_[0]; char __data_[23]; } __s; struct __long { struct { unsigned char __is_long_ : 1; unsigned long __cap_ : 63; } ; unsigned long long __size_; char *__data_; } __l; } __value_; } __r_; } _kernelParamsBinaryName;
...
@property (readonly, nonatomic) char updateWeights;
...
- (id)initWithKernelWidth:(unsigned long long)a0 kernelHeight:(unsigned long long)a1 inputFeatureChannels:(unsigned long long)a2 outputFeatureChannels:(unsigned long long)a3 neuronType:(int)a4 strideX:(unsigned long long)a5 strideY:(unsigned long long)a6 neuronA:(float)a7 neuronB:(float)a8 kernelParamsBinaryName:(const char *)a9 device:(id)a10 cmd_queue:(id)a11 updateWeights:(char)a12 init_weight_ptr:(float *)a13 init_bias_ptr:(float *)a14 optimizerOptions:(struct OptimizerOptions { BOOL x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; })a15;
