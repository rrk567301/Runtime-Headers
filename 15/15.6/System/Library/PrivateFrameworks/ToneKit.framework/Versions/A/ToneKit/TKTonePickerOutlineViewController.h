...
- (void)_didUpdateExpandedStatus:(char)a0 withNotification:(id)a1;
...
- (void)_selectOutlineViewRow:(long long)a0 allowingDelegateCallback:(char)a1;
- (id)initWithTonePickerController:(id)a0;
- (void)pickerOutlineViewDidFinishHandlingMouseDrag:(id)a0;
- (char)pickerOutlineViewHandleReturnKeyDown:(id)a0;
- (void)pickerOutlineViewWillBeginHandlingMouseDrag:(id)a0;
- (void)tonePickerController:(id)a0 didUpdateCheckedStatus:(char)a1 ofTonePickerItem:(id)a2;
