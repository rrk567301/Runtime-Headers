...
@property (readonly, nonatomic) char serverGenerated;
...
- (id)initWithContentType:(unsigned long long)a0 identifier:(id)a1 reason:(id)a2 title:(id)a3 subTitle:(id)a4 sfSymbolName:(id)a5 accountId:(id)a6 bundleID:(id)a7 actions:(id)a8 dismissAction:(id)a9 iconSpecification:(id)a10 serverGenerated:(char)a11;
