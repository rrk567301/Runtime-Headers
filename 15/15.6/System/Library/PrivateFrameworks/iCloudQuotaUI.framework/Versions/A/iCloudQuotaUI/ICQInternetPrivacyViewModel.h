...
- (void)enableCellular:(char)a0 onNetworkName:(id)a1 completion:(id /* block */)a2;
- (void)enableDNS:(id /* block */)a0;
- (void)enableLocationSharing:(char)a0 completion:(id /* block */)a1;
- (void)enableSafari:(id /* block */)a0;
- (void)enableWifi:(char)a0 onNetworkName:(id)a1 completion:(id /* block */)a2;
- (void)isLocationSharingEnabled:(id /* block */)a0;
- (id)issueTitle:(id)a0;
- (id)pausedPrivateRelayFooter;
- (void)setEnabled:(char)a0 completion:(id /* block */)a1;
