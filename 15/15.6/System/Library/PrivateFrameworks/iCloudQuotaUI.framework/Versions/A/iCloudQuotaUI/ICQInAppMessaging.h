...
@property (nonatomic, getter=isICloudReachable) char iCloudReachable;
@property (retain, nonatomic) ICQInAppMessage *lastMessage;
@property (nonatomic) char hasNewObserver;
@property (retain, nonatomic) ICQUnfairLock *unfairLock;
@property (retain, nonatomic) ACAccountStore *accountStore;
@property (nonatomic) char isRegisteredForNotifications;
@property (copy, nonatomic) NSString *placement;
@property (nonatomic) char isCellularConstraintReached;
