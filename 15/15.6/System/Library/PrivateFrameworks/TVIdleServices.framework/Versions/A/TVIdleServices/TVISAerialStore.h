...
- (void)_setCategoryWithIdentifier:(id)a0 isActive:(char)a1 error:(id *)a2;
- (void)_setSubcategoryWithIdentifier:(id)a0 isActive:(char)a1 error:(id *)a2;
...
- (char)isMigrationNeededForManifest:(id)a0;
- (char)isMigrationNeededWithPersistentContainer:(id)a0;
...
- (char)needsUpdateForManifest:(id)a0;
