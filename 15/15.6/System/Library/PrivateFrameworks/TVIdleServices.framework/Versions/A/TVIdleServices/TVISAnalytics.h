...
+ (void)sendAerialsStartedEventWithUserAction:(char)a0 enabledCategories:(id)a1 disabledCategories:(id)a2;
...
+ (void)sendMemoriesStartedEventWithUserAction:(char)a0;
...
+ (void)sendSwitcherSessionConcludedWithPhotosPosterDeferred:(char)a0 photosPosterState:(unsigned long long)a1 portraitPosterDeferred:(unsigned long long)a2 portraitPosterState:(unsigned long long)a3 reason:(unsigned long long)a4;
