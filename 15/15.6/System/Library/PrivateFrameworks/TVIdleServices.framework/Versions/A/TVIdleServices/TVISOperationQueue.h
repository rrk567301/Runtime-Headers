...
@interface TVISOperationQueue : NSObject {
    struct { char respondsToWillScheduleWork; char respondsToDidFinishWork; char respondsToWillBeginWork; char respondsToDidEndWork; char respondsToWillBeginTransaction; char respondsToDidEndTransaction; char respondsToBarrierTask; } _ownerFlags;
}
