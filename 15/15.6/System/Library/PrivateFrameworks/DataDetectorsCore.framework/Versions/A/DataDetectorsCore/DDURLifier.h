...
+ (char)urlIfyNode:(id)a0;
+ (char)urlIfyNode:(id)a0 phoneNumberTypes:(unsigned long long)a1;
...
+ (char)urlIfyTextNode:(id)a0 inNode:(id)a1 forMatches:(id)a2;
+ (id)urlMatchesForString:(id)a0;
+ (id)urlMatchesForString:(id)a0 includingTel:(char)a1;
