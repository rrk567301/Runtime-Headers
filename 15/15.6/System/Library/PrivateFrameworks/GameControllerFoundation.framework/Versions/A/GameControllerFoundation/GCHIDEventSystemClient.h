...
- (id)registerServicesChangedHandler:(id /* block */)a0 notifyExisting:(char)a1;
- (void)registerServicesChangedObserver:(id)a0 notifyExisting:(char)a1;
...
- (void)unregisterServicesChangedObserver:(id)a0 notifyExisting:(char)a1;
