...
- (char)downloadFactorsSynchronouslyWithError:(id *)a0;
- (char)evaluateTargetingExpressionForPlugin:(id)a0 error:(id *)a1;
- (char)evaluateTargetingExpressionWithParameters:(id)a0 error:(id *)a1;
- (char)fetchDataIfNecessaryWithError:(id *)a0;
...
- (id)recipeURL;
- (char)submitTask:(id)a0 result:(id)a1 duration:(double)a2 errorToBeSubmitted:(id)a3 error:(id *)a4;
