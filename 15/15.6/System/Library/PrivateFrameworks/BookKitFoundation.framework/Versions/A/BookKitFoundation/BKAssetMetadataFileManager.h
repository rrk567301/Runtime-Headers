...
- (char)_writeExtendedAttributes:(id)a0 url:(id)a1 error:(id *)a2;
...
- (char)checkValidFilePermissionsForAsset:(id)a0 error:(id *)a1;
...
- (id)moveAsset:(id)a0 toDirectory:(id)a1 toFilename:(id)a2 replaceExisting:(char)a3 error:(id *)a4;
- (id)moveAsset:(id)a0 toURL:(id)a1 replaceExisting:(char)a2 error:(id *)a3;
...
- (char)removeAsset:(id)a0 error:(id *)a1;
- (id)replaceUbiquitousAsset:(id)a0 withAsset:(id)a1 error:(id *)a2;
- (char)setExtendedAttributesForAsset:(id)a0 error:(id *)a1;
- (id)taskToInstallAsset:(id)a0;
- (id)trashAsset:(id)a0 error:(id *)a1;
- (id)updateAsset:(id)a0 withUpdates:(id)a1 temporaryDirectory:(id)a2 inflateIfNeeded:(char)a3 error:(id *)a4;
- (char)updateExtendedAttributesForAsset:(id)a0 error:(id *)a1;
