...
@interface UINSMouseEventTranslator : UINSEventTranslator {
    ...
    char _dragAndDropDragging;
    unsigned long long _gesturePhase;
    unsigned long long _lastSeenTouchSenderID;
}

@property (readonly, getter=isLeftMouseDown) char leftMouseDown;
...
- (void)_handleTouchEvent:(id)a0 cancel:(char)a1;
- (char)_nextScrollGestureDelta:(struct CGPoint { double x0; double x1; } *)a0 wait:(char)a1;
- (void)_sendDragAndDropEvent:(id)a0 isInsideApp:(char)a1 isDragging:(char)a2;
