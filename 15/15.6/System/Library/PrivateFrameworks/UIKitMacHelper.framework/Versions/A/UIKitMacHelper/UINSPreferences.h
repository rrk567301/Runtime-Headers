...
@interface UINSPreferences : NSPreferences {
    char _hasSystemPreferencesModule;
...
@property (readonly, nonatomic) char arePreferencesLoaded;
...
- (id)_scrollViewWithContent:(id)a0 maxHeight:(double)a1 adjustsTitlebarSeparator:(char)a2;
