...
@interface UINSDocumentBrowserViewController : NSObject <UINSDocumentBrowserViewController, NSOpenPanelNewDocumentDelegate, NSSavePanelCustomActionDelegate> {
    ...
    char _panelDidCreateNewDocument;
    NSURL *_urlToImport;
...
@property (nonatomic) char allowsDocumentCreation;
...
- (void)revealDocumentAtURL:(id)a0 importIfNeeded:(char)a1 completion:(id /* block */)a2;
