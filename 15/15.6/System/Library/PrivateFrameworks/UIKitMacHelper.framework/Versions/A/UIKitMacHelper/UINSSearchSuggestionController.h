...
@property (readonly, nonatomic) char hasVisibleMenu;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (char)areAppKitSearchSuggestionsAvailable;
...
- (char)_handleKeyDownWithKeyCode:(unsigned short)a0 modifierFlags:(unsigned long long)a1;
