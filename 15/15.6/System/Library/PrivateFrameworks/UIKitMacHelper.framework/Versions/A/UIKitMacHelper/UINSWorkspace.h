...
@property (readonly, nonatomic) char prefersSmallerDisplaySize;
...
- (char)_haveMultipleApplicableDisplaySizesForScene:(id)a0;
- (void)_lock_noteSceneDidConnect:(id)a0;
- (char)_mainScreenFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 visibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1 displayID:(unsigned int *)a2;
