...
- (char)postEventWithName:(id)a0 error:(id *)a1;
- (char)postSameStateAction:(id)a0 transition:(id)a1 event:(id)a2 error:(id *)a3;
- (char)postStateChangeAction:(id)a0 transition:(id)a1 event:(id)a2 error:(id *)a3;
