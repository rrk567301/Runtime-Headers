...
@property (nonatomic) char initialLoadCommitted;
...
@property (nonatomic) char shouldClearHistoryOnNextLoad;
@property (nonatomic) char shouldKeepCurrentHistoryItem;
...
@property char disableScrolling;
@property double topContentInset;
@property (nonatomic) char navigationEnabled;
...
- (char)_canGoBackToURL:(id)a0;
- (char)_canGoForwardToURL:(id)a0;
...
- (char)_url:(id)a0 isEqualToBackForwardListItem:(id)a1;
