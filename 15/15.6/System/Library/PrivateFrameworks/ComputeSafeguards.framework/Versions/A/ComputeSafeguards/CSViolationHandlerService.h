...
- (void)reportExcessiveCPUUseBy:(id)a0 pid:(unsigned long long)a1 path:(id)a2 endTime:(struct mach_timespec { unsigned int x0; int x1; })a3 observedValue:(long long)a4 observationWindow:(long long)a5 limitValue:(long long)a6 limitWindow:(long long)a7 fatal:(char)a8;
