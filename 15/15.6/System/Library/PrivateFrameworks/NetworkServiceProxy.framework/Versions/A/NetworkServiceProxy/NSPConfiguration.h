...
+ (char)fetchDate:(id)a0 isWithinStart:(id)a1 end:(id)a2 etag:(id)a3;
+ (id)proxyAccountTypeToString:(id)a0;
+ (id)proxyTrafficStateToString:(id)a0;
+ (char)validatePrivacyProxyConfiguration:(id)a0;
+ (void)verifyConfigurationSignature:(id)a0 configuration:(id)a1 host:(id)a2 validateCert:(char)a3 completionHandler:(id /* block */)a4;
...
- (char)fetchDateIsWithinStart:(id)a0 end:(id)a1;
