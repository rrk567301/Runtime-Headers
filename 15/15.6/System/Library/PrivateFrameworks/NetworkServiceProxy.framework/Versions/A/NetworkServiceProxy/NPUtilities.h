...
+ (char)compareAddressEndpoints:(id)a0 endpoint2:(id)a1 addressOnly:(char)a2;
...
+ (char)printDictionaryAsJson:(id)a0 debugName:(id)a1;
...
+ (char)rollDiceWithSuccessRatio:(id)a0;
