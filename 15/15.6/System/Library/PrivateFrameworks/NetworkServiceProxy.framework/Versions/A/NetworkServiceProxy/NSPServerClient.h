...
- (void)dumpPrivacyProxyTokenEventsWithCompletionHandler:(id)a0 mostRecent:(char)a1 limit:(unsigned long long)a2 dumpStats:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)overrideProxiedContentMap:(id)a0 enabled:(char)a1 completionHandler:(id /* block */)a2;
- (void)privateAccessTokensAllowTools:(char)a0 completionHandler:(id /* block */)a1;
- (char)removePrivacyProxyPolicy;
...
- (void)setForceFallback:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)setGeohashSharingPreference:(char)a0 completionHandler:(id /* block */)a1;
- (void)setInProcessFlowDivert:(char)a0 completionHandler:(id /* block */)a1;
- (void)setLocationMonitorInterval:(double)a0;
- (void)setPreferredPathRoutingEnabled:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)setPrivacyProxyStatus:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)setPrivateAccessTokensEnabled:(char)a0 completionHandler:(id /* block */)a1;
- (void)setProxiedContentMapDoHBootstrapEnabled:(char)a0 completionHandler:(id /* block */)a1;
