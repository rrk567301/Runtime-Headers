...
@property (readonly, nonatomic) char isPoweredBy;
...
- (id)initWithLinkURL:(id)a0 bundleID:(id)a1 heroImageURLString:(id)a2 iconImageURLString:(id)a3 redirectURL:(id)a4 action:(long long)a5 mapIconStyleAttributes:(id)a6 mapItemMUID:(id)a7 businessLinkContentItemModels:(id)a8 isPoweredBy:(char)a9;
