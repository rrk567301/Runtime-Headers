...
@property (retain, nonatomic) id<BCSShardCacheQueryable> filterShardCache;
@property (retain, nonatomic) id<BCSDomainItemCaching> domainItemCache;
...
- (char)shouldSkipCacheForConfigItemOfType:(long long)a0;
- (char)shouldSkipCacheForItemOfType:(long long)a0;
- (char)shouldSkipCacheForShardItemOfType:(long long)a0;
