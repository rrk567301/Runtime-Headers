...
- (void)_enqueueCoalesceObject:(id)a0 isDuplicateRequest:(char *)a1 inCoalesceObjectPool:(id)a2;
- (id)_dequeueCoalesceObjectsForCoalesceKey:(id)a0 inCoalesceObjectPool:(id)a1;
- (id)dequeueCoalesceObjectsForCoalesceKey:(id)a0;
- (void)enqueueCoalesceObject:(id)a0 isDuplicateRequest:(char *)a1;
- (char)isDuplicateRequest:(id)a0;
