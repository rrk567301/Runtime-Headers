...
@property (readonly, nonatomic, getter=isInternalInstall) char isInternalInstall;
@property (readonly, nonatomic, getter=isStagingMode) char isStagingMode;
...
- (id)initWithUserDefaults:(id)a0 isInternalInstall:(char)a1 type:(long long)a2;
