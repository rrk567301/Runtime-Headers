...
- (void).cxx_destruct;
- (char)_allHigherPriorityRemoteFetchesHaveCompletedWithLinkItemIdentifier:(id)a0 itemsFound:(id)a1 itemIdentifiersToFetch:(id)a2;
- (id)_chopItemIdentifiersToFetchFromURL:(id)a0 isBloomFilterCached:(char)a1;
...
- (void)queryChopperDelegate:(id)a0 fetchLinkItemModelWithURL:(id)a1 isBloomFilterCached:(char)a2 forClientBundleID:(id)a3 metric:(id)a4 completion:(id /* block */)a5;
- (void)queryChopperDelegate:(id)a0 isBusinessRegisteredForURL:(id)a1 isBloomFilterCached:(char)a2 forClientBundleID:(id)a3 metric:(id)a4 completion:(id /* block */)a5;
- (char)shouldChopURL:(id)a0;
