...
@property (readonly, nonatomic) char skipRegistrationCheck;
@property (readonly, nonatomic) char cacheOnly;
...
- (void).cxx_destruct;
- (id)initWithItemIdentifiers:(id)a0 config:(id)a1 clientBundleId:(id)a2 shardType:(long long)a3 skipRegistrationCheck:(char)a4;
