...
- (void)_isBusinessRegisteredForURL:(id)a0 chopURL:(char)a1 completion:(id /* block */)a2;
- (id)businessItemForPhoneNumber:(id)a0 isChatSuggestVisible:(char *)a1 error:(id *)a2;
- (id)businessItemForPhoneNumber:(id)a0 isMessageable:(char *)a1 isChatSuggestVisible:(char *)a2 error:(id *)a3;
...
- (void)fetchLinkItemWithURL:(id)a0 chopURL:(char)a1 completion:(id /* block */)a2;
...
- (void)isBusinessRegisteredForURL:(id)a0 chopURL:(char)a1 completion:(id /* block */)a2;
