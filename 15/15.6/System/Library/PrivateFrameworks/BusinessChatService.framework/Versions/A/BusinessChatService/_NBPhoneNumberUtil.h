@class _NBRegExMatcher, NSMutableDictionary, NSRegularExpression, NSDictionary, NSLock, _NBMetadataHelper;
...
- (char)isNANPACountry:(id)a0;
- (void)buildNationalNumberForParsing:(id)a0 nationalNumber:(id *)a1;
- (char)canBeInternationallyDialled:(id)a0;
- (char)canBeInternationallyDialled:(id)a0 error:(id *)a1;
- (char)checkRegionForParsing:(id)a0 defaultRegion:(id)a1;
- (id)chooseFormattingPatternForNumber:(id)a0 nationalNumber:(id)a1;
- (id)componentsSeparatedByRegex:(id)a0 regex:(id)a1;
- (char)descHasPossibleNumberData:(id)a0;
...
- (id)formatNumberForMobileDialing:(id)a0 regionCallingFrom:(id)a1 withFormatting:(char)a2;
- (id)formatNumberForMobileDialing:(id)a0 regionCallingFrom:(id)a1 withFormatting:(char)a2 error:(id *)a3;
...
- (char)formattingRuleHasFirstGroupOnly:(id)a0;
...
- (id)getNddPrefixForRegion:(id)a0 stripNonDigits:(char)a1;
...
- (char)hasFormattingPatternForNumber:(id)a0;
- (char)hasUnexpectedItalianLeadingZero:(id)a0;
- (char)hasValidCountryCallingCode:(id)a0;
- (int)indexOfStringByString:(id)a0 target:(id)a1;
- (void)initNormalizationMappings;
- (void)initRegularExpressionSet;
- (char)isAllDigits:(id)a0;
- (char)isAlphaNumber:(id)a0;
- (char)isLeadingZeroPossible:(id)a0;
- (char)isNationalNumberSuffixOfTheOther:(id)a0 second:(id)a1;
- (char)isNumberGeographical:(id)a0;
- (long long)isNumberMatch:(id)a0 second:(id)a1;
- (long long)isNumberMatch:(id)a0 second:(id)a1 error:(id *)a2;
- (char)isNumberMatchingDesc:(id)a0 numberDesc:(id)a1;
- (char)isPossibleNumber:(id)a0;
- (char)isPossibleNumber:(id)a0 error:(id *)a1;
- (char)isPossibleNumberString:(id)a0 regionDialingFrom:(id)a1 error:(id *)a2;
- (long long)isPossibleNumberWithReason:(id)a0;
- (long long)isPossibleNumberWithReason:(id)a0 error:(id *)a1;
- (char)isStartingStringByRegex:(id)a0 regex:(id)a1;
- (char)isValidNumber:(id)a0;
- (char)isValidNumberForRegion:(id)a0 regionCode:(id)a1;
- (char)isValidRegionCode:(id)a0;
- (char)isViablePhoneNumber:(id)a0;
- (id)matchFirstByRegex:(id)a0 regex:(id)a1;
- (id)matchedStringByRegex:(id)a0 regex:(id)a1;
- (id)matchesByRegex:(id)a0 regex:(id)a1;
- (char)matchesEntirely:(id)a0 string:(id)a1;
- (id)maybeExtractCountryCode:(id)a0 metadata:(id)a1 nationalNumber:(id *)a2 keepRawInput:(char)a3 phoneNumber:(id *)a4 error:(id *)a5;
...
- (char)maybeStripNationalPrefixAndCarrierCode:(id *)a0 metadata:(id)a1 carrierCode:(id *)a2;
- (id)normalizeDiallableCharsOnly:(id)a0;
- (id)normalizeDigitsOnly:(id)a0;
- (id)normalizeHelper:(id)a0 normalizationReplacements:(id)a1 removeNonMatches:(char)a2;
...
- (id)parseHelper:(id)a0 defaultRegion:(id)a1 keepRawInput:(char)a2 checkRegion:(char)a3 error:(id *)a4;
- (char)parsePrefixAsIdd:(id)a0 sourceString:(id *)a1;
...
- (char)rawInputContainsNationalPrefix:(id)a0 nationalPrefix:(id)a1 regionCode:(id)a2;
...
- (id)stringByReplacingOccurrencesString:(id)a0 withMap:(id)a1 removeNonMatches:(char)a2;
- (int)stringPositionByRegex:(id)a0 regex:(id)a1;
- (long long)testNumberLength:(id)a0 desc:(id)a1;
- (char)truncateTooLongNumber:(id)a0;
