@class NSDictionary, AppleDeviceQueryCacheArmory, NSArray;

@interface AppleDeviceQueryArmoryHelperArmory : NSObject

@property (retain) AppleDeviceQueryCacheArmory *propertiesCache;
