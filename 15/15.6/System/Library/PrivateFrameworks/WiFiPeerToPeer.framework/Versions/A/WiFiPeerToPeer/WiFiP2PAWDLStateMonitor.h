...
- (id)copyStatistics;
- (char)fetchAWDLActiveServices:(id *)a0 withActivePorts:(id *)a1 error:(id *)a2;
- (int)queryAverageRSSIForPeer:(id)a0;
- (id)queryPeerDatabase;
- (void)softAPChannelChangedEvent:(char)a0 channelNumber:(unsigned short)a1;
- (void)startConnectionUsingProxy:(id)a0 completionHandler:(id /* block */)a1;
- (void)threadCoexistenceEvent:(id)a0;
- (char)updateLTERestrictedChannels:(id)a0 error:(id *)a1;
- (void)updatedAWDLState:(id)a0;
- (void)updatedLowLatencyStatistics;
- (void)updatedRealtimeMode:(char)a0;
