...
- (void)showInfrastructureDisconnectOnRetroModeNotificationForService:(id)a0 localization:(id)a1 phoneDisconnected:(char)a2 uuid:(id)a3 completionHandler:(id /* block */)a4;
