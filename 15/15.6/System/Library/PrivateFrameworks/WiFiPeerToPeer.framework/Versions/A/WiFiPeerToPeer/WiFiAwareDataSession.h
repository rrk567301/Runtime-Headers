@class NSData, NSString, WiFiAwareDiscoveryResult, WiFiAwareInternetSharingConfiguration, WiFiMACAddress, WiFiP2PXPCConnection, NSNumber, WiFiAwarePublishDatapathServiceSpecificInfo, WiFiAwarePublishServiceSpecificInfo;
...
@property char pairingCachingEnabled;
