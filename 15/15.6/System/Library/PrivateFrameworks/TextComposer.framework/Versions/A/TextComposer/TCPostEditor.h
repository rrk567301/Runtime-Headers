...
+ (char)checkingEnabledForLanguage:(id)a0;
+ (char)deviceHasSuitableANE;
+ (id)sharedEditor;
...
- (void)clearTagger;
- (id)combinedResultsForResults:(id)a0 useAutocorrection:(char)a1;
...
- (char)controlRepeatedAutocorrectionsWithOptions:(id)a0;
...
- (id)finalResultsFromCheckingString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 language:(id)a2 conditionalOnTerminationEstimation:(char)a3 options:(id)a4;
...
- (char)suppressTelemetryWithOptions:(id)a0;
- (id)taggerWithString:(id)a0 language:(id)a1;
- (char)useAutocorrectionWithOptions:(id)a0;
- (char)useCacheWithOptions:(id)a0;
- (void)warmEditorsInBackground:(char)a0;
