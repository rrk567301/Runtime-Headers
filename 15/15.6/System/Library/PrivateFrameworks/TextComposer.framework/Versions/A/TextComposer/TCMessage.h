...
- (id)initWithText:(id)a0 senderIdentifier:(id)a1 timestamp:(id)a2 senderName:(id)a3 messageId:(id)a4 threadIdentifier:(id)a5 entryType:(long long)a6 primaryRecipientIdentifiers:(id)a7 secondaryRecipientIdentifiers:(id)a8 spotlightCacheKey:(id)a9 isFromMe:(char)a10;
