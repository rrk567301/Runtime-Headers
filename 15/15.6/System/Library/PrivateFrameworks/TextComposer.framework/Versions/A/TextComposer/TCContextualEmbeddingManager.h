...
- (char)compileEmbeddingForIdentifier:(id)a0 error:(id *)a1;
...
- (char)enableE5;
- (char)loadTokenVectorEmbeddingForIdentifier:(id)a0 error:(id *)a1;
- (char)shouldAbortCompileEmbeddingForIdentifier:(id)a0;
