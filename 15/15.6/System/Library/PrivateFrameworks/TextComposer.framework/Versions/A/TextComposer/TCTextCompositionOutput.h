...
- (id)attributedStringForMixedOutput:(id)a0 input:(id)a1 tagger:(id)a2 parseLists:(char)a3 parseTables:(char)a4 error:(id *)a5;
...
- (id)attributedStringForUnorderedListOutput:(id)a0 input:(id)a1 handleTitles:(char)a2 strictFormatting:(char)a3 allowAlternatives:(char)a4 tagger:(id)a5 error:(id *)a6;
...
- (id)inputLengths;
- (id)outputLengths;
- (id)prefixForListItemNumber:(unsigned long long)a0 level:(unsigned long long)a1 ordered:(char)a2;
