...
- (void)requestModelInvocationWith:(unsigned long long)a0 prompt:(id)a1 modelType:(long long)a2 isPrecomputeRequest:(char)a3 seed:(long long)a4 draftSteps:(long long)a5 pid:(long long)a6 appPid:(long long)a7 requestIdentifier:(id)a8 regionPolicy:(long long)a9 disallowedStrings:(id)a10 completionHandler:(id /* block */)a11;
