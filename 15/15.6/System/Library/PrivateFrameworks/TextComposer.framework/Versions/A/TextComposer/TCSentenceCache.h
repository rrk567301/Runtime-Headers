...
- (char)_detailRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inSentence:(id)a1 matchesRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 inString:(id)a3 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4;
...
- (char)_retrieveCachedResultsForSentence:(id)a0 offset:(unsigned long long)a1 mutableResults:(id)a2;
...
- (void)retrieveCachedResultsForString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 tagger:(id)a2 offset:(unsigned long long)a3 ignoreTermination:(char)a4 mutableResults:(id)a5 remainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a6;
