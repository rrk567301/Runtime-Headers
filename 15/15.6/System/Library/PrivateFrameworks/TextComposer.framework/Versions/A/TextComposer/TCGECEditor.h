...
- (id)OTABundlePath;
- (void)checkSentence:(id)a0 locale:(id)a1 offset:(unsigned long long)a2 options:(id)a3 requireResult:(char)a4 mutableResults:(id)a5;
...
- (void)loadModelsInBackground:(char)a0;
- (long long)modelTypeWithOptions:(id)a0;
- (id)modelUsingBackgroundLoading:(char)a0;
- (void)resetModels;
