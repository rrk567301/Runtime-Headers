...
- (id)initWithAttributedString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 options:(id)a2 lookBack:(char)a3 tagger:(id)a4 error:(id *)a5;
