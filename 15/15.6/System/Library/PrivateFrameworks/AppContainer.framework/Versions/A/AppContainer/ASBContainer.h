...
+ (char)CM_forContainerOfClass:(unsigned long long)a0 persona:(id)a1 onBehalfOf:(struct { unsigned int x0[8]; } *)a2 queryFlags:(unsigned long long)a3 error:(id *)a4 syncPerformBlock:(id /* block */)a5;
+ (id)containerForAppSigningId:(id)a0 error:(id *)a1;
+ (char)CM_forContainersOfClass:(unsigned long long)a0 persona:(id)a1 onBehalfOf:(struct { unsigned int x0[8]; } *)a2 queryFlags:(unsigned long long)a3 error:(id *)a4 syncIterateWithBlock:(id /* block */)a5;
+ (char)CM_forContainerAtURL:(id)a0 error:(id *)a1 syncPerformBlock:(id /* block */)a2;
+ (char)CM_forContainerWithIdentifier:(id)a0 ofClass:(unsigned long long)a1 persona:(id)a2 queryFlags:(unsigned long long)a3 error:(id *)a4 syncPerformBlock:(id /* block */)a5;
+ (id)_CM_currentPersonaUniqueStringForContainer;
+ (char)_CM_queryContainersWithIdentifier:(id)a0 ofClass:(unsigned long long)a1 persona:(id)a2 onBehalfOf:(struct container_client { } *)a3 queryFlags:(unsigned long long)a4 error:(id *)a5 syncPerformBlock:(id /* block */)a6;
...
- (char)setError:(id *)a0 message:(id)a1 forPath:(id)a2 withDomain:(id)a3 code:(long long)a4;
