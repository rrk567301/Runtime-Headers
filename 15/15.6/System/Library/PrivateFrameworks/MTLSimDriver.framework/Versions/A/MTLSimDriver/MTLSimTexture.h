...
@interface MTLSimTexture : MTLSimResource <MTLSerializerTexture, MTLSerializerResource, MTLTextureSPI, MTLTextureImplementation> {
    ...
    char _isInternalTextureView;
}

@property (retain, setter=_simSetParentTexture:) id<MTLTexture> parentTexture;
@property (getter=isShareable, setter=_simSetShareable:) char shareable;
...
- (id)initWithDescriptor:(id)a0 decompressedPixelFormat:(unsigned long long)a1 iosurface:(struct __IOSurface { } *)a2 plane:(unsigned long long)a3 textureRef:(unsigned int)a4 heap:(id)a5 device:(id)a6 shareable:(char)a7;
- (id)initWithTexture:(id)a0 device:(id)a1;
- (id)initWithTexture:(id)a0 pixelFormat:(unsigned long long)a1 decompressedPixelFormat:(unsigned long long)a2 textureRef:(unsigned int)a3 isInternalTextureView:(char)a4;
- (id)initWithTexture:(id)a0 pixelFormat:(unsigned long long)a1 decompressedPixelFormat:(unsigned long long)a2 textureType:(unsigned long long)a3 levels:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 slices:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5 swizzle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; })a6 textureRef:(unsigned int)a7 isInternalTextureView:(char)a8;
- (id)initWithTextureInternal:(id)a0 pixelFormat:(unsigned long long)a1 decompressedPixelFormat:(unsigned long long)a2 textureType:(unsigned long long)a3 levels:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 slices:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5 swizzle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; })a6 compressedView:(char)a7 textureRef:(unsigned int)a8 isInternalTextureView:(char)a9;
- (id)newTextureViewWithPixelFormatInternal:(unsigned long long)a0 isInternalTextureView:(char)a1;
