...
@property (readonly) char deserializerSupportsSharedEvents;
@property (readonly) char deserializerSupportsSharedTextures;
...
- (char)setResourcesPurgeableState:(id *)a0 newState:(unsigned long long)a1 oldState:(unsigned long long *)a2 count:(int)a3;
