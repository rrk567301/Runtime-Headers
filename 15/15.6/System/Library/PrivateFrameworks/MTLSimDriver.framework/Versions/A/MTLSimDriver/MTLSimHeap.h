...
- (id)newBufferWithLength:(unsigned long long)a0 options:(unsigned long long)a1 offset:(unsigned long long)a2 useOffset:(char)a3;
- (id)newTextureWithDescriptor:(id)a0 offset:(unsigned long long)a1 useOffset:(char)a2;
