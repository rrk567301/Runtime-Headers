...
- (void).cxx_destruct;
- (char)updateFileSize:(id *)a0;
- (char)parseFinderInfoAndResourceFork:(id *)a0;
...
- (char)createAttrHeaderIfNeeded:(id *)a0;
- (char)fillEmptyAppleDoubleFile:(id *)a0;
...
- (char)isXattrNameValid:(struct attr_entry { unsigned int x0; unsigned int x1; unsigned short x2; unsigned char x3; unsigned char x4[1]; } *)a0;
- (char)isXattrProtected:(const char *)a0;
...
- (char)parseAttrHeader:(id *)a0;
- (char)parseFileHeader:(id *)a0;
- (char)readRawHeader:(id *)a0;
- (void)removeXattrNamed:(id)a0 reply:(id /* block */)a1;
- (char)shiftDataDownAtOffset:(unsigned int)a0 length:(unsigned int)a1 delta:(unsigned long long)a2 error:(id *)a3;
- (char)shiftDataUpAtOffset:(unsigned int)a0 length:(unsigned int)a1 delta:(unsigned long long)a2 error:(id *)a3;
- (void)swapFileHeader;
- (void)updateFileSizeExplicit:(long long)a0;
- (char)writeHeaderToDiskUpToLength:(unsigned int)a0 error:(id *)a1;
