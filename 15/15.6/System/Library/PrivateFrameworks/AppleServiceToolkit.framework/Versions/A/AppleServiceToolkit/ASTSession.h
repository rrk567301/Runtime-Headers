...
@property (readonly, nonatomic) char shouldShowResults;
...
+ (void)sessionStatusForIdentities:(id)a0 ticketNumber:(id)a1 timeout:(double)a2 requestQueuedSuiteInfo:(char)a3 completionHandler:(id /* block */)a4;
...
- (char)sendAuthInfoResult:(id)a0 error:(id *)a1;
- (char)sendProfileResult:(id)a0 error:(id *)a1;
- (char)sendTestResult:(id)a0 error:(id *)a1;
...
- (char)shouldEvictCachedAssetForName:(id)a0;
