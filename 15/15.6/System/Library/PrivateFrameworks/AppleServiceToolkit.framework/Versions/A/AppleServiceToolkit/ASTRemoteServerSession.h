...
@property (nonatomic) char shouldContinueRequestLoop;
@property (nonatomic) char shouldUnenroll;
@property (nonatomic) char shouldAbort;
...
- (void)_endAndUnenrollIfNecessary:(char)a0;
- (char)_profile;
- (void)_protocolError;
...
- (char)_shouldAllowCellularForSealedSealablePayload:(id)a0;
- (char)_shouldAllowCellularForSealedTestResult:(id)a0;
...
- (char)_validateCommand:(long long)a0 clientStatus:(long long)a1;
