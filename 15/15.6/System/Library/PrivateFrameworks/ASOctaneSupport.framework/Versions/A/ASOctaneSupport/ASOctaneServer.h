...
- (id)changeAutoRenewStatus:(char)a0 transactionID:(unsigned long long)a1 bundleID:(id)a2;
- (id)clearOverridesForBundleID:(id)a0;
- (id)completeAskToBuyRequestWithResponse:(char)a0 transactionID:(unsigned long long)a1 forBundleID:(id)a2;
- (id)completePriceConsentRequestWithResponse:(char)a0 transactionIdentifier:(unsigned long long)a1 forBundleID:(id)a2;
- (id)deleteAllTransactionsForBundleID:(id)a0;
- (id)deleteTransactionWithIdentifier:(unsigned long long)a0 forBundleID:(id)a1;
- (id)expireOrRenewSubscriptionWithIdentifier:(id)a0 expire:(char)a1 forBundleID:(id)a2;
...
- (id)startPriceIncreaseForTransactionID:(unsigned long long)a0 bundleID:(id)a1 needsConsent:(char)a2;
