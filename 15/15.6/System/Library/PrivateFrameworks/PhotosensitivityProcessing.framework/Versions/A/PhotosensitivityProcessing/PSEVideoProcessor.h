...
@property (class, readonly, nonatomic) char needsProcessing;

@property (copy, nonatomic) id /* block */ validationCallback;
@property (nonatomic) char inTestingMode;

+ (void)initialize;

- (id)init;
- (void).cxx_destruct;
- (char)canProcessSurface:(struct __IOSurface { } *)a0;
