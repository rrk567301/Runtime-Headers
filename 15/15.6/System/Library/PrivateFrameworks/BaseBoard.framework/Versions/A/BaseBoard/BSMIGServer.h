...
- (id)init;
- (void).cxx_destruct;
- (id)initWithPortName:(id)a0 subsystem:(struct mig_subsystem { void /* function */ *x0; int x1; int x2; unsigned int x3; unsigned long long x4; struct routine_descriptor { void /* function */ *x0; void /* function */ *x1; unsigned int x2; unsigned int x3; struct *x4; unsigned int x5; } x5[1]; } *)a1 separateThread:(char)a2;
