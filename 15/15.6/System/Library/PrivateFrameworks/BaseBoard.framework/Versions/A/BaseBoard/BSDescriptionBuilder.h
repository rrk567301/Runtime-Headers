...
@property (readonly, nonatomic) char hasDebugStyle;
@property (readonly, nonatomic) char hasSuccinctStyle;
...
- (id)style;
- (id)build;
- (void)appendCollectionSection:(id)a0 withName:(id)a1 skipIfEmpty:(char)a2 objectTransformer:(id /* block */)a3;
...
- (void)appendCollectionSection:(id)a0 withName:(id)a1 multilinePrefix:(id)a2 skipIfEmpty:(char)a3;
- (void)appendCollectionSection:(id)a0 withName:(id)a1 multilinePrefix:(id)a2 skipIfEmpty:(char)a3 objectTransformer:(id /* block */)a4;
- (void)appendCollectionSection:(id)a0 withName:(id)a1 skipIfEmpty:(char)a2;
...
- (id)appendFlag:(long long)a0 withName:(id)a1 skipIfNotSet:(char)a2;
