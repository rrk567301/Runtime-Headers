...
@property (readonly, nonatomic) char supportsHaptics;
@property (readonly, nonatomic) char supportsLight;
...
- (id)allDpads;
- (id)allElements;
- (id)initWithName:(id)a0 persistentIdentifier:(id)a1 productCategoryKey:(id)a2 hidden:(char)a3 shareButton:(id)a4 buttons:(id)a5 dpads:(id)a6 logoSfSymbolsName:(id)a7 supportsHaptics:(char)a8 supportsLight:(char)a9 baseProfile:(id)a10 miscellaneous:(id)a11;
- (id)initDummy;
