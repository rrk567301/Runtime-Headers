...
@property (nonatomic) char downstreamRecursive;
@property (nonatomic) char innerRecursive;
...
@property (nonatomic) char cancelledOrCompleted;
@property (nonatomic) char outerFinished;
