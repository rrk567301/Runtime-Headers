...
- (char)addMappingsFromRemote:(id)a0 toLearningSession:(id)a1;
- (id)appleIRDeviceWithUID:(unsigned char)a0 create:(char)a1;
- (id)copyDevicePrefs:(id *)a0;
- (id)copyPrefsPropertyForUUID:(id)a0 UUIDKey:(id)a1 key:(id)a2;
- (char)deleteDevicePrefsWithUUID:(id)a0 UUIDKey:(id)a1;
- (id)getExistingDeviceWithType:(unsigned long long)a0 matching:(id)a1;
- (void)interface:(id)a0 receivedCommand:(id)a1;
- (char)mergePersistentMappingsFromSession:(id)a0 ofDevice:(id)a1;
- (void)migrateOldRemotes;
- (id)propertyForKey:(id)a0 error:(id *)a1;
- (char)saveDevicePrefsWithDict:(id)a0 error:(id *)a1;
- (char)setPairedAppleRemote:(id)a0 error:(id *)a1;
- (char)setPrefsPropertyForUUID:(id)a0 UUIDKey:(id)a1 object:(id)a2 key:(id)a3;
...
- (char)updatePersistentValue:(id)a0 forProperty:(id)a1 ofDevice:(id)a2;
