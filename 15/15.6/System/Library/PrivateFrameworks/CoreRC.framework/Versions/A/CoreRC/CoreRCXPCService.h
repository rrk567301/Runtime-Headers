...
- (char)checkEntitlement:(id)a0;
- (void)_performSetPowerStatus:(unsigned long long)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)cecBus:(id)a0 linkStateHasBeenUpdated:(char)a1;
...
- (void)_changeButtonCombinationAsync:(id)a0 delay:(double)a1 enabled:(char)a2 forDevice:(id)a3 reply:(id /* block */)a4;
...
- (void)_fakeSetCECBusLinkStateAsync:(id)a0 linkState:(char)a1 physicalAddress:(unsigned short)a2 reply:(id /* block */)a3;
...
- (void)_performActiveSourceAsync:(id)a0 withMenus:(char)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performDeckControlCommandAsync:(id)a0 controlMode:(unsigned long long)a1 targetDevice:(id)a2 allowRemoteDevice:(char)a3 reply:(id /* block */)a4;
- (void)_performDeckControlPlayAsync:(id)a0 playMode:(unsigned long long)a1 targetDevice:(id)a2 allowRemoteDevice:(char)a3 reply:(id /* block */)a4;
- (void)_performDeckControlRefreshStatusAsync:(id)a0 targetDevice:(id)a1 requestType:(unsigned long long)a2 allowRemoteDevice:(char)a3 reply:(id /* block */)a4;
...
- (void)_performInactiveSourceAsync:(id)a0 allowRemoteDevice:(char)a1 reply:(id /* block */)a2;
- (void)_performRefreshDevicesAsync:(id)a0 allowRemoteDevice:(char)a1 reply:(id /* block */)a2;
- (void)_performRefreshProperties:(id)a0 ofDevice:(id)a1 withDeviceAsync:(id)a2 allowRemoteDevice:(char)a3 reply:(id /* block */)a4;
...
- (void)_performRequestActiveSourceAsync:(id)a0 allowRemoteDevice:(char)a1 reply:(id /* block */)a2;
- (void)_performRequestAudioReturnChannelStatusChangeTo:(unsigned long long)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performRequestAudioStatusAsync:(id)a0 reply:(id /* block */)a1;
- (void)_performRequestSystemAudioModeStatusChangeTo:(unsigned long long)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetAudioMuteStatus:(char)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetAudioReturnChannelControlEnabled:(char)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetAudioVolumeStatus:(unsigned long long)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetSupportedAudioFormats:(id)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetSystemAudioControlEnabled:(char)a0 withDeviceAsync:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSetTrackAudioStatusEnabled:(char)a0 pressTimeout:(long long)a1 pollInterval:(long long)a2 withDeviceAsync:(id)a3 reply:(id /* block */)a4;
- (void)_performStandbyAsync:(id)a0 targetDevice:(id)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
- (void)_performSystemAudioModeRequestAsync:(id)a0 withDesiredState:(unsigned long long)a1 allowRemoteDevice:(char)a2 reply:(id /* block */)a3;
...
- (void)_setPairStateAsync:(char)a0 forAppleRemote:(id)a1 reply:(id /* block */)a2;
