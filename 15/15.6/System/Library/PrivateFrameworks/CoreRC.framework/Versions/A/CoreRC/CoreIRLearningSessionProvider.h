...
- (char)addMappingWithProtocolID:(unsigned char)a0 options:(unsigned char)a1 commandToMap:(unsigned long long)a2 commands:(unsigned long long *)a3 commandCount:(unsigned long long)a4 repeats:(unsigned long long *)a5 repeatCount:(unsigned long long)a6;
