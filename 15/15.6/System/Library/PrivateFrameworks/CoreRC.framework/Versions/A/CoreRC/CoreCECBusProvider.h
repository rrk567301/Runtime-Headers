...
@property (readonly, nonatomic) char deferLossOfLink;
...
- (char)_sendMessage:(id)a0 toDevice:(id)a1 withRetryCount:(unsigned char)a2 error:(id *)a3;
...
- (char)areMultipleCECBusses;
- (id)destinationExpectedForMessage:(id)a0;
- (void)didChangeLinkState:(char)a0 physicalAddress:(unsigned short)a1;
- (id)initWithBus:(id)a0;
- (id)initWithLinkState:(char)a0 physicalAddress:(unsigned short)a1;
