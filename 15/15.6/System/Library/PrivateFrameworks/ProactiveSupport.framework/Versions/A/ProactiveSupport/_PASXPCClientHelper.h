...
@interface _PASXPCClientHelper : NSObject {
    ...
    char _allowSystemToUserConnection;
}
...
- (id)initWithServiceName:(id)a0 allowlistedServerInterface:(id)a1 allowlistedClientInterface:(id)a2 serverInitiatedRequestHandler:(id)a3 allowSystemToUserConnection:(char)a4 interruptionHandler:(id /* block */)a5 invalidationHandler:(id /* block */)a6 logHandle:(id)a7;
