...
+ (char)isLazyPlistLikelyContainedInData:(id)a0 format:(unsigned long long *)a1;
+ (char)isLazyPlistLikelyContainedInFileAtPath:(id)a0 format:(unsigned long long *)a1;
