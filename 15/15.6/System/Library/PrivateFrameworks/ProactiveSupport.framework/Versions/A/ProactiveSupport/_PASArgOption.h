...
+ (id)optionWithName:(id)a0 shortName:(id)a1 argMetavar:(id)a2 help:(id)a3 required:(char)a4;
+ (id)optionWithName:(id)a0 shortName:(id)a1 help:(id)a2;

- (id)description;
- (void).cxx_destruct;
- (id)initWithName:(id)a0 shortName:(id)a1 argMetavar:(id)a2 help:(id)a3 required:(char)a4;
