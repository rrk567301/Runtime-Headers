...
+ (id)sharedInstance;
+ (void)_launchSiri;
+ (char)_shouldLaunchSiriForSource:(long long)a0 action:(long long)a1;
...
- (void).cxx_destruct;
- (void)_sendSiriNotification:(id)a0 launchingIfNotRunning:(char)a1 options:(id)a2 completion:(id /* block */)a3;
