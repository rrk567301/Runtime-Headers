...
+ (char)isNonSAECustomizedShortcut:(id)a0;
+ (char)isNonSAEPreDefinedHotKey:(id)a0;
+ (char)isSAEPreDefinedHotKey:(id)a0;
+ (id)sharedSiriSymbolicHotKeysDefaultsController;

- (void)setHotKeyValue:(id)a0;
- (void)disableHotKey:(char)a0;
- (id)hotKeyMigrationIfNeeded:(id)a0 saeEnabled:(char)a1;
- (id)hotKeyValue:(char)a0;
- (id)preSAEHotKey;
- (id)saeHotKey;
