...
@property (class, readonly, nonatomic) char _mutableCopyInputs;
...
+ (unsigned long long)indexAfterApplyingChanges:(id)a0 toIndex:(unsigned long long)a1 objectChanged:(out char *)a2;
...
+ (unsigned long long)indexAfterRevertingChanges:(id)a0 fromIndex:(unsigned long long)a1 objectChanged:(out char *)a2;
...
- (char)canPreserveIncrementalChangesWhenAddingChangeDetails:(id)a0;
...
- (char)isOnlyInsertionAtEnd:(char *)a0 orRemovalAtEnd:(char *)a1 countBeforeChange:(long long)a2 countAfterChange:(long long)a3;
