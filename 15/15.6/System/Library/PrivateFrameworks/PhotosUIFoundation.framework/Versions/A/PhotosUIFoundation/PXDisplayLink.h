...
@property (class, readonly, nonatomic) char highFramerateRequiresReasonAndRange;
@property (class, readonly) char supportsSpecificScreen;
...
- (id)initWithWeakTarget:(id)a0 selector:(SEL)a1 deferredStart:(char)a2;
...
- (id)initInternalWithWeakTarget:(id)a0 selector:(SEL)a1 deferredStart:(char)a2 runloopModes:(id)a3 preferredFramesPerSecond:(long long)a4 screen:(id)a5 queue:(id)a6;
- (id)initWithWeakTarget:(id)a0 selector:(SEL)a1 deferredStart:(char)a2 runloopModes:(id)a3 preferredFramesPerSecond:(long long)a4;
- (id)initWithWeakTarget:(id)a0 selector:(SEL)a1 deferredStart:(char)a2 runloopModes:(id)a3 preferredFramesPerSecond:(long long)a4 queue:(id)a5;
