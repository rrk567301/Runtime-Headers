...
@property (nonatomic) char isAnimatingScroll;
@property (nonatomic) char hasRampedUpForCurrentAnimatedScroll;
...
- (void)handleScrollEventVisibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 didEnd:(char)a1;
