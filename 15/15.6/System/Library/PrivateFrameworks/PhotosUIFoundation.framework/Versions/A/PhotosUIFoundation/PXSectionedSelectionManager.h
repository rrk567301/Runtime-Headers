...
@interface PXSectionedSelectionManager : PXObservable <PXSectionedDataSourceManagerObserver> {
    struct { char selectionSnapshot; } _needsUpdateFlags;
}
...
@property (nonatomic, setter=_setSelectionLimitReached:) char selectionLimitReached;
@property (nonatomic, setter=_setEmptySelectionAvoided:) char emptySelectionAvoided;
...
@property (nonatomic) char disableAssetTypeCounting;
...
- (void)setSelectedState:(char)a0 forIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a1;
- (void)setSelectedState:(char)a0 forIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a1 andUpdateCursorIndexPath:(char)a2;
- (void)setSelectedState:(char)a0 forIndexPathSet:(id)a1;
- (void)setSelectionLimitReached:(char)a0;
