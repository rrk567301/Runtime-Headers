...
@interface PXSelectionCoordinator : NSObject <PXChangeObserver, PXSectionedSelectionManagerSnapshotValidator> {
    ...
    struct { char willUpdateSelectedObjects; char didUpdateSelectedObjects; char rejectedCountLimitViolation; char selectionLimitStatusChanged; } _delegateRespondsTo;
}
...
@property (nonatomic) char selectionLimitReached;
...
- (char)modifySelectionWithRemovedOIDs:(id)a0 insertedOIDs:(id)a1;
- (char)test_validateInternalState;
