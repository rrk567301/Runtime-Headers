...
@property (nonatomic, setter=_setUpdateScheduled:) char _isUpdateScheduled;
...
- (void)didCompleteLoadOperationWithTrackingID:(id)a0 withSuccess:(char)a1 error:(id)a2;
- (void)didUpdateLoadOperationWithTrackingID:(id)a0 withProgress:(double)a1;
- (id)willBeginLoadOperationWithItemIdentifier:(id)a0;
- (void)_didUpdateLoadOperationWithTrackingID:(id)a0 withProgress:(double)a1 indeterminate:(char)a2;
