...
@property (nonatomic) char shouldStartPlaybackFromStartDate;
@property (nonatomic) char shouldDisplayChapterMarkers;
@property (nonatomic) char shouldShowDescriptionOnChapterSkip;
