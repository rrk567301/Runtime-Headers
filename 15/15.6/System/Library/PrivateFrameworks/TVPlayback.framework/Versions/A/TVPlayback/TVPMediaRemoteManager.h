...
@property (nonatomic) char artworkNeedsUpdate;
@property (nonatomic) char usingPlayerForCommandHandlerOnly;
...
- (void)_pushNowPlayingInfo:(char)a0 invalidateArtwork:(char)a1 pushImmediately:(char)a2;
