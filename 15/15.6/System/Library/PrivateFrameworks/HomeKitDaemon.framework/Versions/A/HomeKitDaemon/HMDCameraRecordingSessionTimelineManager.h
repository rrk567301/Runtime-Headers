...
- (void)handleMotionActive:(char)a0 didChangeAtDate:(id)a1;
- (id)initWithWorkQueue:(id)a0 fragmentDuration:(double)a1 fragmentCreationReferenceDate:(id)a2 logIdentifier:(id)a3;
- (char)isDoorbellTriggerActiveAtAnyTimeAfterOffset:(double)a0;
- (char)isDoorbellTriggerActiveAtAnyTimeAfterOffset:(double)a0 forDuration:(double)a1;
- (char)isMotionTriggerActiveAtAnyTimeAfterOffset:(double)a0;
- (char)isMotionTriggerActiveAtAnyTimeAfterOffset:(double)a0 forDuration:(double)a1;
