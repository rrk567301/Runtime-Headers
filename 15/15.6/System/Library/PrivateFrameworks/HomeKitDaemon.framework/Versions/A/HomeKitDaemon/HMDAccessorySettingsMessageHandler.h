...
- (char)_decodeUpdateValueMessagePayload:(id)a0 outValue:(id *)a1;
...
- (char)processReplaceConstraintMessage:(id)a0 outConstraintsToAdd:(id *)a1 outConstraintIdsToRemove:(id *)a2;
