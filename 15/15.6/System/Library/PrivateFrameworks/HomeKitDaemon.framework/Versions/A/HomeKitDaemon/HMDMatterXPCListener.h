...
- (char)connection:(id)a0 allowsOperationWithHome:(id)a1 operationType:(long long)a2 nodeId:(id)a3 commandId:(id)a4 endpointId:(id)a5 clusterId:(id)a6 attributeId:(id)a7;
- (char)connection:(id)a0 sendMessagePayloadToPrimaryResident:(id)a1 responseHandler:(id /* block */)a2 error:(id *)a3;
- (char)connection:(id)a0 sendMessagePayloadToPrimaryResident:(id)a1 responseHandler:(id /* block */)a2 timeout:(double)a3 error:(id *)a4;
...
- (char)sendMessage:(id)a0 homeUUID:(id)a1 error:(id *)a2;
- (char)sendMessage:(id)a0 homeUUID:(id)a1 timeout:(double)a2 error:(id *)a3;
