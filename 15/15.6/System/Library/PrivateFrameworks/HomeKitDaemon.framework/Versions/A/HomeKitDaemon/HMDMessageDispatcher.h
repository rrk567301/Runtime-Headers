...
+ (id)logCategory;
+ (id)destinationWithTarget:(id)a0 userID:(id)a1 destination:(id)a2 multicast:(char)a3;
+ (id)destinationWithTarget:(id)a0 userID:(id)a1 destination:(id)a2 multicast:(char)a3 accountRegistry:(id)a4;
...
- (id)messageRegistrationForReceiver:(id)a0 name:(id)a1 policies:(id)a2 selector:(SEL)a3;
- (id)sendMessageExpectingResponse:(id)a0;
- (void)_setRemoteAccessDevice:(id)a0 forHome:(id)a1 sendNotification:(char)a2;
