...
- (void)_scheduleAutoModeEvaluationWithRetryNeeded:(char)a0;
- (char)allowExternalUpdateOfPrimaryResidentTo:(id)a0 selectionTimestamp:(id)a1;
- (id)createResidentSelectionModeWithType:(unsigned long long)a0;
- (void)currentDeviceReadyAsAResident;
- (char)devicesInHomeSupportResidentSelection;
...
- (void)performSelectionInMode:(unsigned long long)a0 preferredPrimaryResident:(id)a1 requireAutoUpdate:(char)a2 reason:(unsigned long long)a3 completion:(id /* block */)a4;
...
- (char)residentIsLocallyReachable:(id)a0;
- (char)residentIsPresentInCurrentAccount:(id)a0;
...
- (char)weAreInResidentSelection;
- (char)weAreTheOnlyActingResident;
