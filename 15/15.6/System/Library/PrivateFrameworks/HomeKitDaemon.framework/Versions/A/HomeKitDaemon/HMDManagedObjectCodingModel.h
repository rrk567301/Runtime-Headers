...
@interface HMDManagedObjectCodingModel : NSObject {
    ...
    char _hasAnyReferenceRelationships;
...
@property (readonly) char hasOnlyParentChildRelationships;
...
- (char)encodeRootObject:(id)a0 withWriter:(id)a1;
- (char)encodeRootObject:(id)a0 withWriter:(id)a1 changes:(id)a2 conditions:(id)a3 userContext:(id)a4;
...
- (char)isRelevantChanges:(id)a0 withRootObject:(id)a1 conditions:(id)a2 userContext:(id)a3;
- (char)isValidCondition:(id)a0;
- (id)subentityOfDescription:(id)a0 withTypeID:(id)a1;
- (char)updateRootObject:(id)a0 fromReader:(id)a1;
