...
- (char)_residentStatusChannelNeededForBundleIdentifier:(id)a0 applicationState:(unsigned long long)a1;
- (char)_shouldAllowChannelManagement;
- (char)_shouldChannelBeRunning;
