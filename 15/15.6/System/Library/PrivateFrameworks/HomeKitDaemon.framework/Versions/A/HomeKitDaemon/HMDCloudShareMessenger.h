...
@property (getter=isConfigured) char configured;
...
- (void)handleShareInviteMessage:(id)a0;
- (void)handleShareRequestInviteMessage:(id)a0;
- (void)handleShareRevokeMessage:(id)a0;
...
- (void)notifyOfShareAccessRevocationForUser:(id)a0;
