@class NSUUID, NSString, NSArray, HMDHAPAccessory, HMDApplicationData, NSMutableDictionary, NSDictionary, HMFMessageDispatcher, NSObject, HMDBulletinBoardNotification, NSNumber;
...
@property (nonatomic) char powerManagementSupportedSleepCharRead;
...
@property (readonly, getter=isCustom) char custom;
...
+ (id)logCategory;
+ (char)_parseOperatingStateResponseValue:(id)a0 intoState:(id *)a1 abnormalReasons:(id *)a2;
+ (char)_processUpdateOnPowerManagementServiceForCharacteristicType:(id)a0 value:(id)a1 serviceType:(id)a2 accessory:(id)a3 accessoryTransaction:(id)a4;
+ (id)generateUUIDWithAccessoryUUID:(id)a0 serviceID:(id)a1;
+ (char)processUpdateForCharacteristicType:(id)a0 value:(id)a1 serviceType:(id)a2 service:(id)a3 serviceTransactionGetter:(id /* block */)a4 accessory:(id)a5 accessoryTransaction:(id)a6 accessoryTransactionChanged:(char *)a7;
+ (char)validateProvidedName:(id)a0;
...
- (void)_readRequiredCharacteristicValuesForceReadFWVersion:(char)a0;
...
- (id)configureWithService:(id)a0 accessory:(id)a1 shouldRead:(char)a2 added:(char)a3;
...
- (id)gatherRequiredReadRequestsForceReadFWVersion:(char)a0;
...
- (char)isReadingRequiredForBTLEServiceCharacteristic:(id)a0;
...
- (char)shouldIncludePresenceForDeviceWithDestination:(id)a0;
- (char)shouldUpdateLastSeenConfiguredName:(id)a0;
- (void)transactionObjectRemoved:(id)a0 message:(id)a1;
- (void)transactionObjectUpdated:(id)a0 newValues:(id)a1 message:(id)a2;
- (id)transactionWithObjectChangeType:(unsigned long long)a0;
- (char)updateAssociatedServiceType:(id)a0 error:(id *)a1;
- (char)updateCharacteristics:(id)a0;
