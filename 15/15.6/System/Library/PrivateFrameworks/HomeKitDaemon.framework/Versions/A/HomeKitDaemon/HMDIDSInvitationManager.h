...
- (char)_resolveAccountWithMergeID:(id)a0 fromAddress:(id)a1;
- (id)_sendOptions:(char)a0;
...
- (void)sendInvitationToDestination:(id)a0 expirationDate:(id)a1 dictionary:(id)a2 homeInvitationID:(id)a3 isRestrictedGuestInvitation:(char)a4 completionBlock:(id /* block */)a5;
