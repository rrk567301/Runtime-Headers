@class HMDTriggerConfirmationTimer, NSString, NSArray, HMDPredicateUtilities, NSPredicate, HMFTimer, NSMutableSet, NSMutableArray, HMDEventTriggerUserConfirmationSession, NSMapTable;
...
@property (nonatomic) char actionSetExecutionInProgress;
@property (nonatomic) char restoreInProgress;
@property (nonatomic) char executionCompleteCalled;
...
- (char)needsUserConfirmationForDevice:(id)a0;
...
- (void)_callExecutionComplete:(id)a0 callDelegate:(char)a1;
