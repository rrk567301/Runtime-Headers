...
- (id)_updatePredicate:(id)a0 staleCharacteristicInCurrentPredicate:(char *)a1 accessory:(id)a2 conditionModified:(char *)a3;
...
- (id)initWithHome:(id)a0 logIdentifier:(id)a1 homePresenceProvider:(id /* block */)a2;
- (id)predicateWithoutStaleCharacteristicsFromPredicate:(id)a0 accessory:(id)a1 conditionModified:(char *)a2;
...
- (id)rewritePredicate:(id)a0 forDaemon:(char)a1 message:(id)a2;
- (id)rewritePredicateForClient:(id)a0;
- (id)rewritePredicateForDaemon:(id)a0 message:(id)a1;
- (id)updatePredicate:(id)a0 currentCharacteristicInPredicate:(id *)a1 conditionModified:(char *)a2 removedCharacteristic:(id)a3 underService:(id)a4 underAccessory:(id)a5;
- (id)updatePredicate:(id)a0 removedUser:(id)a1 conditionModified:(char *)a2;
