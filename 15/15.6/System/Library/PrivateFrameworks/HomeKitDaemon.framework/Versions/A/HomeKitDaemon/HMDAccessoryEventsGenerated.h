...
+ (id)endpointAccessorySettingsTopicsForAccessoryUUID:(id)a0 homeUUID:(id)a1;
+ (id)forwardingTopicsForTopics:(id)a0 residentAccessoryUUID:(id)a1 homeUUID:(id)a2;
+ (id)homePodAccessorySettingsTopicsForAccessoryUUID:(id)a0 homeUUID:(id)a1;
+ (id)indexTopicForTopic:(id)a0;
+ (id)topicMap;
+ (char)topicSuffix:(id)a0 isPartOfIndex:(id)a1;
