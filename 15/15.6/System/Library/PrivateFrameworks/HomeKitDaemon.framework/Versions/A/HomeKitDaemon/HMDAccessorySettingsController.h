...
@property char isSettingOwner;
@property char isMigrationOwner;
@property char hasCreatedUnprocessedRootGroup;
...
@property (nonatomic) char didInitiateSettingsCreationForOlderSoftwareCounterpart;
...
- (char)canUser:(id)a0 editConstraintsForSetting:(id)a1;
- (char)canUser:(id)a0 editConstraintsForSettingWithKeyPath:(id)a1;
- (void)configureIsSettingOwner:(char)a0 home:(id)a1;
- (void)configureIsSettingOwner:(char)a0 home:(id)a1 legacySettingsAdaptor:(id)a2;
- (void)configureIsSettingOwner:(char)a0 migrationOwner:(char)a1 home:(id)a2 legacySettingsAdaptor:(id)a3;
...
- (id)initWithQueue:(id)a0 delegate:(id)a1 dataSource:(id)a2 parentUUID:(id)a3 codingKey:(id)a4 logEventSubmitter:(id)a5 settingOwner:(char)a6 migrationOwner:(char)a7 factory:(id)a8 rootGroup:(id)a9 notificationCenter:(id)a10;
- (id)languageValueList;
- (void)legacySettingsAdaptor:(id)a0 didLoadSettingKeyPath:(id)a1 boolValue:(char)a2;
...
- (void)legacySettingsAdaptor:(id)a0 didUpdateSettingKeyPath:(id)a1 boolValue:(char)a2;
...
- (void)onMessageReplaceConstraintsWithAdditions:(id)a0 constraintIdsToRemove:(id)a1 keyPath:(id)a2 senderProductClass:(long long)a3 isRemote:(char)a4 completion:(id /* block */)a5;
- (void)onMessageReplaceConstraintsWithAdditions:(id)a0 constraintIdsToRemove:(id)a1 settingIdentifier:(id)a2 senderProductClass:(long long)a3 isRemote:(char)a4 completion:(id /* block */)a5;
...
- (char)shouldEncodeForNonAdminSharedUserForSetting:(id)a0;
- (char)shouldEncodeForXPCTransportForSetting:(id)a0;
- (char)shouldEncodeSetting:(id)a0 withCoder:(id)a1 forAccessorySettingGroup:(id)a2;
- (void)updateSettingOwner:(char)a0;
