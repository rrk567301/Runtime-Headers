...
@property (readonly, nonatomic) char backgroundModeEntitled;
...
- (id)initWithRemoteObjectProxy:(id)a0 homeManager:(id)a1 pid:(int)a2 processInfo:(id)a3 backgroundModeEntitled:(char)a4 workQueue:(id)a5;
...
- (void)subscribeWithController:(id)a0 nodeId:(unsigned long long)a1 minInterval:(id)a2 maxInterval:(id)a3 params:(id)a4 shouldCache:(char)a5 completion:(id /* block */)a6;
