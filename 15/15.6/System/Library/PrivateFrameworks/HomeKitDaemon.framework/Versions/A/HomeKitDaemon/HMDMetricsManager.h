...
@property char metricsCollectionStarted;
...
@property (readonly, nonatomic) char isDemoModeConfigured;
...
@property (readonly) char isSubmissionEnabled;
...
@property (readonly, nonatomic) char isThisDeviceDesignatedFMFDevice;
...
- (void)addThresholdTrigger:(id)a0 forEventName:(id)a1 requestGroup:(id)a2 atThreshold:(unsigned long long)a3 uploadImmediately:(char)a4;
