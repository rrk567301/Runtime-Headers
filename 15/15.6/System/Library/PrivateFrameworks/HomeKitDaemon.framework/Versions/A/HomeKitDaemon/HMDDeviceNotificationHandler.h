...
@property (nonatomic) char delaySupported;
...
- (void)_beginCoalesce:(char)a0;
- (void)_dispatchNotification;
- (void)_dispatchNotificationUpdate:(id)a0;
- (id)_notificationUpdateWithRequestID:(id)a0 allowAdd:(char)a1;
- (id)initWithDestination:(id)a0 watchDevice:(char)a1 withRequestIdentifier:(id)a2 messageDispatcher:(id)a3 home:(id)a4;
- (id)initWithDestination:(id)a0 watchDevice:(char)a1 withRequestIdentifier:(id)a2 messageDispatcher:(id)a3 home:(id)a4 dataSource:(id)a5;
- (void)sendCoalescedRemoteNotificationForAccessories:(id)a0;
- (void)sendNotificationForActionSetResponses:(id)a0 notificationUpdateIdentifier:(id)a1;
