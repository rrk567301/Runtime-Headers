...
- (void)_updateLocationAuthorization:(long long)a0 withReason:(unsigned long long)a1 notifyDelegate:(char)a2;
- (void)_updateState:(unsigned long long)a0 withReason:(unsigned long long)a1 notifyDelegate:(char)a2;
