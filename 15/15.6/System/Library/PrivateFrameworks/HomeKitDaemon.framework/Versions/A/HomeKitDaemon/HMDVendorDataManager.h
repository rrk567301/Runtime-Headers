...
- (char)_loadDatabaseFromDictionary:(id)a0;
- (char)_loadDatabaseFromFilePath:(id)a0 fileDescription:(id)a1;
- (char)_loadDatabaseFromFileURL:(id)a0 fileDescription:(id)a1;
- (void)_loadDatabaseFromLocalFiles;
- (id)_modelsStringForManufacturer:(id)a0 model:(id)a1 dictionary:(id)a2 key:(id)a3;
- (char)_parseDatabaseFromDictionary:(id)a0 dataVersion:(long long *)a1 collectionsByManufacturer:(id *)a2 entriesByProductData:(id *)a3;
- (char)_parseManufacturersList:(id)a0 collectionsByManufacturer:(id *)a1 entriesByProductData:(id *)a2;
- (id)_parseVendorModelEntryForManufacturer:(id)a0 model:(id)a1 dictionary:(id)a2;
- (char)databaseContainsManufacturer:(id)a0;
