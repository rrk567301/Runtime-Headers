@class NSString, HMMDateProvider, HMFTimer, NSMutableDictionary, HMFWifiNetworkAssociation, HMDLogEventDailyScheduler, HMFWiFiManager, HMDEventCountersManager, NSNotificationCenter;
...
@property (nonatomic) char wifiAssociated;
