...
@property (readonly) char isPlaybackArchivePresent;
...
- (id)initWithIsPlaybackArchivePresent:(char)a0 playbackStateNumber:(id)a1 volumeNumber:(id)a2 sourceNumber:(id)a3 sourceClientName:(id)a4 accessories:(id)a5;
