...
- (id)_addOperation:(id)a0 finalizeClipOnError:(char)a1;
- (id)_createClip;
- (id)_createClipWithSignificantEvent:(id)a0;
- (void)_handleFatalOperationFailureDueToError:(id)a0;
- (char)_isCancelledError:(id)a0;
- (void)_operationCompleted:(id)a0 finalizeOnError:(char)a1 future:(id)a2;
- (void)_startNextOperation;
- (id)addNotificationForSignificantEvent:(id)a0;
- (id)addVideoInitData:(id)a0;
- (id)addVideoSegmentData:(id)a0 duration:(double)a1 timeOffsetWithinClip:(double)a2 clipFinalizedBecauseMaxDurationExceeded:(char)a3;
- (id)createClip;
- (char)hasAddedCreateClipOperation;
