...
@property (readonly, nonatomic) char activityShouldWake;
...
- (void).cxx_destruct;
- (id)initWithActivityName:(id)a0 definedInterval:(double)a1 activityShouldWake:(char)a2 timeSinceLastRun:(double)a3;
