...
@property (nonatomic) char hasExponentialBackoff;
...
- (id)initName:(id)a0 syncManager:(id)a1 initialDelay:(double)a2 initialBackoff:(double)a3 hasBackoff:(char)a4;
- (char)isInMaximumTimeInterval;
- (id)nextOperation;
- (id)operationsToCancel;
- (char)processFiredTimer:(id)a0;
