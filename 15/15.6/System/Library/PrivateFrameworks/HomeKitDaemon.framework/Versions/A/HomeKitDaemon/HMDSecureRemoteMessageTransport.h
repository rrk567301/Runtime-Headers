...
+ (id)shortDescription;
+ (id)logCategory;
+ (char)isDeviceValidDestination:(id)a0 error:(id *)a1;
...
- (char)_handleReceivedMessage:(id)a0 transport:(id)a1;
...
- (void)configureWithUserDeviceCapabilitiesRequestManager:(id)a0 deviceResidencyProvider:(id)a1 remoteMessageListener:(id)a2;
