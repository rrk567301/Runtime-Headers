...
@property (readonly, getter=isPrimaryResident) char primaryResident;
...
@property char canUseCachedCharacteristicValues;
...
@property (readonly, getter=isCameraConfiguredForRecording) char cameraConfiguredForRecording;
...
+ (char)isSupportedAudioCodec:(id)a0;
+ (char)isSupportedH264Profile:(id)a0;
+ (char)isSupportedVideoCodec:(id)a0;
...
- (char)_shouldReconfigureForChangedCharacteristic:(id)a0;
