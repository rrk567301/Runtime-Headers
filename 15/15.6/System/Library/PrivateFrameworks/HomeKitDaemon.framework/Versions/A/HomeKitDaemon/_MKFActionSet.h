...
- (id)createActionsRelationOfTypeMatterCommandActionWithModelID:(id)a0;
...
- (id)findActionsRelationOfTypeMatterCommandActionWithModelID:(id)a0;
...
- (id)materializeOrCreateActionsRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateActionsRelationOfTypeAppleMediaAccessoryPowerActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionsRelationOfTypeCharacteristicWriteActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionsRelationOfTypeMatterCommandActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionsRelationOfTypeMediaPlaybackActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionsRelationOfTypeNaturalLightingActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionsRelationOfTypeShortcutActionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateApplicationDataRelation:(char *)a0;
