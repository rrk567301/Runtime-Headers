...
@property (readonly, nonatomic) char primaryOnly;
...
- (id)initWithThreshold:(long long)a0 displayReason:(id)a1 radarTitle:(id)a2 componentName:(id)a3 componentVersion:(id)a4 componentID:(long long)a5 radarInitiator:(id)a6 primaryOnly:(char)a7 dataSource:(id)a8;
