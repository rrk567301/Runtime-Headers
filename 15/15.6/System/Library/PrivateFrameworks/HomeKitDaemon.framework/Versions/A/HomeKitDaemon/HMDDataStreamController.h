@class HMDHAPAccessory, NSString, HMFTimer, HMDService, HMDDataStream, HMDDataStreamSetupOperation, NSMutableArray, NSObject;
...
@property (nonatomic) char supportsDataStreamOverTCP;
@property (nonatomic) char supportsDataStreamOverHAP;
...
- (char)_isDataStreamConfigurationValid;
...
- (void)dataStreamInitializationSetupOperation:(id)a0 didCompleteSupportReadWithStatus:(char)a1;
...
- (id)initWithAccessory:(id)a0 transferManagementService:(id)a1 workQueue:(id)a2;
- (id)initWithAccessory:(id)a0 transferManagementService:(id)a1 workQueue:(id)a2 dataStreamFactory:(id /* block */)a3;
...
- (char)setupRequiresCharacteristicReads;
