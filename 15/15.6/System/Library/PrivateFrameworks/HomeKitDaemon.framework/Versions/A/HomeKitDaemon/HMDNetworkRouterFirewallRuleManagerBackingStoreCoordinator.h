...
+ (id)__jsonFromDeclarations:(id)a0 rawOutput:(char)a1 error:(id *)a2;
+ (id)__jsonFromPairedMetadata:(id)a0 rawOutput:(char)a1 error:(id *)a2;
+ (id)__jsonFromRecords:(id)a0 validateWithPublicKeys:(id)a1 rawOutput:(char)a2 error:(id *)a3;
+ (id)__jsonStringFromDictionary:(id)a0 rawOutput:(char)a1 error:(id *)a2;
...
- (void)_dumpCloudRecordsForProductGroup:(id)a0 productNumber:(id)a1 rawOutput:(char)a2 verifySignatures:(char)a3 completion:(id /* block */)a4;
...
- (void)_fetchCloudChangesWithQualityOfService:(long long)a0 ignoreLastFetchedAccessories:(char)a1 forceChangeNotifications:(char)a2 requiredRecordIDs:(id)a3 schedulerXpcActivity:(id)a4 completion:(id /* block */)a5;
- (id)_fetchNetworkDeclarationsForRecordIDs:(id)a0 options:(id)a1 ignoreOverrides:(char)a2 error:(id *)a3;
- (id)_fetchPairedMetadataForAccessories:(id)a0 options:(id)a1 ignoreOverrides:(char)a2 error:(id *)a3;
- (void)_listCloudRecordsForProductGroup:(id)a0 rawOutput:(char)a1 completion:(id /* block */)a2;
- (char)addOverrides:(id)a0 replace:(char)a1 error:(id *)a2;
- (void)cloudFetchSchedulerFired:(id)a0 completion:(id /* block */)a1;
- (void)dumpCloudRecordsForProductGroup:(id)a0 productNumber:(id)a1 rawOutput:(char)a2 listOnly:(char)a3 verifySignatures:(char)a4 completion:(id /* block */)a5;
- (id)dumpLocalRulesForProductGroup:(id)a0 productNumber:(id)a1 firmwareVersion:(id)a2 ignoreOverrides:(char)a3 rawOutput:(char)a4 error:(id *)a5;
- (id)dumpPairedMetadataForProductGroup:(id)a0 productNumber:(id)a1 firmwareVersion:(id)a2 ignoreOverrides:(char)a3 rawOutput:(char)a4 error:(id *)a5;
- (void)fetchCloudChangesWithQualityOfService:(long long)a0 ignoreLastFetchedAccessories:(char)a1 forceChangeNotifications:(char)a2 completion:(id /* block */)a3;
- (id)fetchPairedMetadataVersionConfigurationsForAccessories:(id)a0 qualityOfService:(long long)a1 ignoreOverrides:(char)a2 error:(id *)a3;
- (void)fetchRulesForAccessories:(id)a0 qualityOfService:(long long)a1 ignoreOverrides:(char)a2 completion:(id /* block */)a3;
...
- (char)removeAllLocalRulesWithError:(id *)a0;
- (char)removeAllOverridesWithError:(id *)a0;
- (char)removeOverridesForProductGroup:(id)a0 productNumber:(id)a1 error:(id *)a2;
