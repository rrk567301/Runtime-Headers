...
- (id)removeZonesWithID:(id)a0 isPrivate:(char)a1;
- (id)sharedZonesWithID:(id)a0 configuration:(id)a1 delegate:(id)a2 error:(id *)a3;
- (id)zonesWithID:(id)a0 isPrivate:(char)a1 shouldCreate:(char)a2 configuration:(id)a3 delegate:(id)a4 error:(id *)a5;
