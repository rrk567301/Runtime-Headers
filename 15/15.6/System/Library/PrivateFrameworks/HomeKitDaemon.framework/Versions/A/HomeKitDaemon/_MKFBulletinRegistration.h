@class NSUUID, NSString, NSDate, NSPredicate, NSSet, _MKFGuest, NSArray, Protocol, MKFBulletinRegistrationDatabaseID, _MKFUser;
...
- (id)materializeOrCreateConditionsRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
...
- (id)materializeOrCreateConditionsRelationOfTypePresenceBulletinConditionWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateConditionsRelationOfTypeTimePeriodBulletinConditionWithModelID:(id)a0 createdNew:(char *)a1;
