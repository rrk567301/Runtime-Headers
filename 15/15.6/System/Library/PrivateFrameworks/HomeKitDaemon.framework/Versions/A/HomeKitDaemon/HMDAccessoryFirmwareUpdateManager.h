...
@property (readonly) char supportsFirmwareUpdate;
...
- (char)_registerAccessory:(id)a0 source:(long long)a1 path:(id)a2;
...
- (id)changeAccessory:(id)a0 source:(long long)a1 path:(id)a2 documentationPath:(id)a3 userInitiatedStaging:(char)a4;
- (char)checkForUpdateForAccessory:(id)a0;
...
- (char)hasReachedMaximumFirmwareUpdateRetriesForAccessory:(id)a0 assetID:(id)a1;
- (id)initWithHomeManager:(id)a0 wingman:(id)a1;
- (char)isAccessoryRegistered:(id)a0;
- (char)isFirmwareUpdateRetryAllowedForAccessory:(id)a0 forAsset:(id)a1;
- (id)matterUARPController;
- (char)registerAccessory:(id)a0;
- (id)registerAndCreateSessionForAccessory:(id)a0 updateUARPParameters:(char)a1;
...
- (char)startUARPPacketCapture:(id)a0;
