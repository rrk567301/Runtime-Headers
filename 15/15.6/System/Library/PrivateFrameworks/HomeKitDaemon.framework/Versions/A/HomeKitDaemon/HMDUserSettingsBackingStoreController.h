...
- (void)_didFetchZonesWithResult:(id)a0 isOwnedZone:(char)a1 error:(id)a2;
...
- (void)runSettingTransaction:(id)a0 waitForCloudPush:(char)a1 completion:(id /* block */)a2;
- (void)runTransaction:(id)a0 waitForCloudPush:(char)a1 completion:(id /* block */)a2;
