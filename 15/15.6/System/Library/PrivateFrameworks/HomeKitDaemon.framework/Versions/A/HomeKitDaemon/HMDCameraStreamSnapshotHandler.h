...
@property (readonly, getter=isStreamAvailable) char streamAvailable;
@property (readonly, getter=isStreamSetupInProgress) char streamSetupInProgress;
...
- (void)setStreamSetupStatusForService:(id)a0 inProgress:(char)a1;
