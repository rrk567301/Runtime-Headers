...
@property (getter=isCurrentDevicePrimaryResident) char currentDevicePrimaryResident;
...
- (void)writeWithNaturalLightingEnabled:(char)a0 reason:(id)a1 completion:(id /* block */)a2;
