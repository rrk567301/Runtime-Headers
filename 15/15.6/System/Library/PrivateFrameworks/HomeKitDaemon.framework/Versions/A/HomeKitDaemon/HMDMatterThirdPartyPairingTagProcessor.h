...
- (void)processAccessoryTransport:(id)a0;
...
- (void)processPairingErrorCancelledEvent:(id)a0;
- (void)processPairingErrorEvent:(id)a0;
- (void)processPairingEventWindowOpenedSetupDuration:(id)a0;
...
- (void)processThreadSetupDuration:(id)a0;
