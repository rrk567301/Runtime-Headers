...
- (char)accountExistsForHandle:(id)a0;
- (id)accountForHandle:(id)a0 exists:(char *)a1;
- (void)accountInformationChanged:(id)a0;
- (void)addAccount:(id)a0 isLocal:(char)a1;
- (void)addDevice:(id)a0 toAccount:(id)a1;
- (void)addHandle:(id)a0 toAccount:(id)a1;
- (char)deviceExistsForDevice:(id)a0;
- (id)deviceForAddress:(id)a0;
- (id)deviceForDevice:(id)a0;
- (id)deviceForDevice:(id)a0 exists:(char *)a1;
- (id)deviceForHandle:(id)a0;
- (id)deviceForHandle:(id)a0 exists:(char *)a1;
...
- (id)fetchAccountsWithLocalFlag:(char)a0;
