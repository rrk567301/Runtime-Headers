@class NSString, NSDictionary, NSArray, HMDNetworkRouterFirewallRuleAccessoryIdentifier, NSDate;
...
+ (id)__decodeRuleConfigurationsFromJSONDictionary:(id)a0 baseAccessoryIdentifier:(id)a1 allowUnzippedData:(char)a2;

- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)attributeDescriptions;
- (id)initWithBaseAccessoryIdentifier:(id)a0 data:(id)a1;
- (id)initWithBaseAccessoryIdentifier:(id)a0 data:(id)a1 allowUnzippedData:(char)a2;
- (id)initWithBaseAccessoryIdentifier:(id)a0 name:(id)a1 lastModifiedTime:(id)a2 ruleConfigurationsByVersionString:(id)a3;
