...
- (void)_retrieveMetadataOnController:(id)a0 homeHasResident:(char)a1 completion:(id /* block */)a2;
- (void)_retrieveMetadataOnThreadCapableController:(id)a0 threadClient:(id)a1 homeHasResident:(char)a2 completion:(id /* block */)a3;
...
- (void)_validateOperationalDatasetWithTHClient:(id)a0 operationalDataset:(id)a1 storeCachedAOD:(char)a2 completion:(id /* block */)a3;
...
- (void)retrieveMetadata:(id)a0 homeHasResident:(char)a1 completion:(id /* block */)a2;
