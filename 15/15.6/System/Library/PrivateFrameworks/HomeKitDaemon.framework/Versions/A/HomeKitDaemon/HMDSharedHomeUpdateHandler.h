...
@property (nonatomic) char firstFetchComplete;
@property (getter=isSuspended) char suspended;
@property (nonatomic) char pendingRequestDataFromResident;
...
- (void)_receivedHomeDataFromSourceVersion:(id)a0 forceUpdateVersion:(char)a1 completion:(id /* block */)a2;
- (void)configureWithHome:(id)a0;
- (void)didCompleteHomeUpdateSession:(id)a0 withError:(id)a1;
- (void)receivedHomeDataFromSourceVersion:(id)a0 forceUpdateVersion:(char)a1 completion:(id /* block */)a2;
