...
@property (nonatomic) char hasAnyResident;
@property (retain) HMDResidentSelectionInfo *residentSelectionInfoToWrite;
@property char allowedToWriteResidentSelectionInfo;
...
- (char)_addDeviceIdentifiersIfNecessary:(id)a0 fromResidentDevice:(id)a1;
...
- (char)_shouldUpdateDeviceIdentifiersForResident:(id)a0 fromResidentDevice:(id)a1;
- (void)_updateHasAnyResident;
- (void)_writeResidentSelectionInfoToWorkingStore;
- (id)findResidents:(id)a0 outHasResidents:(char *)a1;
- (id)handleCloudResidentChange:(id)a0 currentResidents:(id)a1 isCurrentDevicePrimaryResident:(char)a2 currentDevice:(id)a3;
- (void)handleHomeDataReadyAfterBecomingPrimary:(id)a0;
- (char)hasResidentSelectionInfoUpdateInNotification:(id)a0;
- (id)initWithHome:(id)a0 appleAccountManager:(id)a1;
- (id)pruneDuplicateResidentModelsFrom:(id)a0;
- (char)residentModel:(id)a0 isTheSameAs:(id)a1;
