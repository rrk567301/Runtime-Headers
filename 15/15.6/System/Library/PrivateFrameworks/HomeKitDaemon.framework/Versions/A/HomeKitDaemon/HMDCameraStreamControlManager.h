...
- (char)_canReconfigureToHigherTier;
- (void)_reportErrorCode:(long long)a0;
- (void)_reportInternalErrorCode:(long long)a0;
- (id)initWithSessionID:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 isLocal:(char)a6;
