...
@property (readonly, getter=isTimeSensitive) char timeSensitive;
...
- (id)initWithTitle:(id)a0 body:(id)a1 threadIdentifier:(id)a2 dateOfOccurrence:(id)a3 userInfo:(id)a4 isTimeSensitive:(char)a5;
