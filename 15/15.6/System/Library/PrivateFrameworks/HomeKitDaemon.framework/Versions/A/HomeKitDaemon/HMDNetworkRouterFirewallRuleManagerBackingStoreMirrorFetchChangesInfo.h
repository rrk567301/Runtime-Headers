...
@property (readonly, nonatomic) char zonesHaveChanged;
@property (readonly, nonatomic) char zonesWereDeleted;
...
- (id)initWithActivity:(id)a0 options:(id)a1 databaseChangeToken:(id)a2 promise:(id)a3 xpcActivity:(id)a4 database:(id)a5 useAnonymousRequests:(char)a6 recordIDs:(id)a7 lastSynchronizedRecordIDs:(id)a8;
