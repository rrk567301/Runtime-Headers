...
+ (char)_importWeekDayScheduleRulesIntoLocalModel:(id)a0 fromCloudModel:(id)a1 localRelationship:(id)a2 cloudAttributeName:(id)a3 parentRelationshipName:(id)a4 context:(id)a5;
+ (char)_importYearDayScheduleRulesIntoLocalModel:(id)a0 fromCloudModel:(id)a1 localRelationship:(id)a2 cloudAttributeName:(id)a3 parentRelationshipName:(id)a4 context:(id)a5;

- (char)_exportAllowedAccessoriesRelationshipFromGuestLocalModel:(id)a0 context:(id)a1;
- (char)_exportGuestAccessCodeFromLocalModel:(id)a0 context:(id)a1;
- (char)_exportWeekDaySchedulesFromLocalModel:(id)a0 context:(id)a1;
- (char)_exportYearDaySchedulesFromLocalModel:(id)a0 context:(id)a1;
- (char)_importAllowedAccessoriesRelationshipIntoLocalModel:(id)a0 context:(id)a1;
- (char)_importGuestAccessCodeIntoLocalModel:(id)a0 context:(id)a1;
- (char)_importWeekDayScheduleRulesIntoLocalModel:(id)a0 context:(id)a1;
- (char)_importYearDayScheduleRulesIntoLocalModel:(id)a0 context:(id)a1;
