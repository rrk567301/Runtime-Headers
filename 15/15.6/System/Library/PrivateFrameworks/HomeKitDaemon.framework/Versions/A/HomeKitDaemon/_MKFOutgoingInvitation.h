...
- (id)materializeOrCreateAllowedAccessoriesRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateAllowedAccessoriesRelationOfTypeAirPlayAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateAllowedAccessoriesRelationOfTypeAppleMediaAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateAllowedAccessoriesRelationOfTypeHAPAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (char)populateWorkingStoreFromRestrictedGuestSchedule:(id)a0;
