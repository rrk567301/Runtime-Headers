...
- (id)_performReadRequests:(id)a0 withRetries:(char)a1;
- (id)_performWriteRequests:(id)a0 withRetries:(char)a1;
- (id)_readAccessCodeWithIdentifier:(id)a0 accessoryUUID:(id)a1;
- (id)_readAccessCodesFromAccessoriesWithUUIDs:(id)a0 withRetries:(char)a1;
- (id)_readAccessCodesFromAccessoriesWithUUIDs_HAP:(id)a0 withRetries:(char)a1;
- (id)_readAccessCodesFromAccessoriesWithUUIDs_Matter:(id)a0 withRetries:(char)a1;
- (id)_readAccessCodesFromAccessory_Matter:(id)a0 withRetries:(char)a1;
- (void)_readConstraintsAndAccessCodesFromAccessoriesWithUUIDs:(id)a0 completion:(id /* block */)a1;
- (id)_readConstraintsFromAccessoriesWithUUIDs:(id)a0 withRetries:(char)a1;
- (id)_readConstraintsFromAccessoriesWithUUIDs_HAP:(id)a0 withRetries:(char)a1;
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)a0 withRetries:(char)a1;
- (id)_readConstraintsFromAccessory_Matter:(id)a0 withRetries:(char)a1;
- (id)performAccessCodeModificationRequests:(id)a0 withRetries:(char)a1;
- (id)performAccessCodeModificationRequests_HAP:(id)a0 withRetries:(char)a1;
- (id)performAccessCodeModificationRequests_Matter:(id)a0 withRetries:(char)a1;
...
- (id)removeAllHAPAccessCodesWithValue:(id)a0 forSpecificAccessory:(id)a1;
