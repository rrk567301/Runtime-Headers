@class NSUUID, NSData, NSString, NSPredicate, NSSet, NSArray, MKFEventTriggerDatabaseID, NSDate, Protocol, NSNumber;
...
- (void)awakeFromFetch;
- (id)createEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)a0;
...
- (id)findEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)a0;
...
- (id)materializeOrCreateEventsRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateEventsRelationOfTypeCalendarEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeCharacteristicRangeEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeCharacteristicValueEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeDurationEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeLocationEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypePresenceEventWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEventsRelationOfTypeSignificantTimeEventWithModelID:(id)a0 createdNew:(char *)a1;
