...
@property char manuallyDisabled;
...
- (void)_notificationEnable:(char)a0 forType:(unsigned long long)a1;
- (char)_notificationEnabledForType:(unsigned long long)a0;
- (void)_notifyProfileSettingsUpdated:(id)a0;
- (void)_setNotifications:(char)a0 options:(unsigned long long)a1;
...
- (void)setNotifications:(char)a0 options:(unsigned long long)a1;
