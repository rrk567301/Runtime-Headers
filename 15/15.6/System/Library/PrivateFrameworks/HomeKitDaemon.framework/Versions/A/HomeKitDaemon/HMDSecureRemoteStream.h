...
- (void)setOpen:(char)a0;
- (void)setIdle:(char)a0;
- (id)logIdentifier;
...
- (id)initWithCurrentDevice:(id)a0 peerDevice:(id)a1 clientMode:(char)a2 sessionID:(id)a3 accountRegistry:(id)a4;
