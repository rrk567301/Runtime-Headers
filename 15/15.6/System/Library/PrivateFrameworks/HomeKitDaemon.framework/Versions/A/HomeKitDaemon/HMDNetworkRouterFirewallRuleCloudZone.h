...
+ (char)__verifyDataFromRecord:(id)a0 signatureVerificationPublicKeys:(id)a1 dataKey:(id)a2 dataAssetKey:(id)a3 maxDataSize:(unsigned long long)a4 signatureKey:(id)a5 signatureAssetKey:(id)a6 maxSignatureSize:(unsigned long long)a7 baseAccessoryIdentifier:(id *)a8 data:(id *)a9 error:(id *)a10;
+ (char)__verifyDigestDataAgainstSignatureFromRecord:(id)a0 digestData:(id)a1 signatureData:(id)a2 signatureVerificationPublicKeys:(id)a3 error:(id *)a4;
+ (char)verifyNetworkDeclarationsFromRecord:(id)a0 signatureVerificationPublicKeys:(id)a1 baseAccessoryIdentifier:(id *)a2 data:(id *)a3 error:(id *)a4;
+ (char)verifyNetworkDeclarationsFromRecord:(id)a0 signatureVerificationPublicKeys:(id)a1 error:(id *)a2;
+ (char)verifyPairedMetadataFromRecord:(id)a0 signatureVerificationPublicKeys:(id)a1 error:(id *)a2;

- (void).cxx_destruct;
- (id)attributeDescriptions;
- (id)fetchChangesWithToken:(id)a0 options:(id)a1;
- (void)startUpWithLocalZone:(id)a0;
- (void)__zoneFetchCompletedWithChangeToken:(id)a0 error:(id)a1 moreComing:(char)a2 fetchInfo:(id)a3;
- (char)__canRecoverFromError:(id)a0 fetchInfo:(id)a1;
- (char)__commitLocalChanges:(id)a0 error:(id *)a1;
...
- (id)initWithCloudDatabase:(id)a0 state:(id)a1 useAnonymousRequests:(char)a2 watchedRecordIDs:(id)a3 signatureVerificationPublicKeys:(id)a4;
