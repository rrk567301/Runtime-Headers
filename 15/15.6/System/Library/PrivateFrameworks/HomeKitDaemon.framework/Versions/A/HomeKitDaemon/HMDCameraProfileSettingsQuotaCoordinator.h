...
- (char)_requiresDisablingCloudStorageForAccessMode:(unsigned long long)a0 cameraHomePresence:(unsigned long long)a1;
- (void)_disableRecordingAccessModesWithCompletion:(id /* block */)a0;
- (void)_performOperationWithBlock:(id /* block */)a0;
- (char)_requiresEnablingCloudStorageForAccessMode:(unsigned long long)a0;
