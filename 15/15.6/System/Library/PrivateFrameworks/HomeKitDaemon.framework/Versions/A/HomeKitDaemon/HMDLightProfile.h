@class HMDNaturalLightingMatterCurveWriter, HMDNaturalLightingActiveTransitionContext, NSDate, HMDNaturalLightingCurve, HMDService, NSString, NSSet, HMDHAPAccessory, NSHashTable, HMLightProfileSettings, HMDNaturalLightingCurveWriter, HMDCharacteristic, HMDCharacteristicsAvailabilityListener, HMDNaturalLightingEnabledRetryContext;
...
@property (getter=isNaturalLightingSupported) char naturalLightingSupported;
...
- (char)enableNaturalLightingCharacteristicNotificationsForObserver:(id)a0;
...
- (void)handleSetNaturalLightingEnabled:(char)a0;
- (void)handleSetNaturalLightingEnabledMessage:(id)a0;
- (void)handleSetNaturalLightingEnabledMessageForMatterAccessory:(id)a0;
...
- (id)initWithUUID:(id)a0 workQueue:(id)a1 lightService:(id)a2 accessory:(id)a3 matterCurveWriter:(id)a4 dataSource:(id)a5;
...
- (void)readCharacteristics:(id)a0;
...
- (void)setNaturalLightingCharacteristicsNotificationEnabled:(char)a0 forObserver:(id)a1;
- (void)setNaturalLightingEnabled:(char)a0 completion:(id /* block */)a1;
- (void)setNaturalLightingEnabled:(char)a0 completion:(id /* block */)a1 retryContext:(id)a2;
- (id)setNaturalLightingEnabledForMatterLightProfile:(char)a0;
- (char)shouldRetrySetNaturalLightingEnabledWithError:(id)a0;
- (void)synchronizeCurveToAccessory;
- (char)updateActiveTransitionCountWithCharacteristic:(id)a0;
- (char)updateEnabledCharacteristicsNotifications;
...
- (void)updateSettingsWithNaturalLightingEnabled:(char)a0;
- (void)updateSettingsWithNaturalLightingSupported:(char)a0;
