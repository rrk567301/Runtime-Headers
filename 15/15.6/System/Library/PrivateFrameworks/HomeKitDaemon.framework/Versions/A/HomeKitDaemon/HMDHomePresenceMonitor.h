...
- (char)_setLocalActivityTimestampForUserUUID:(id)a0 timestamp:(id)a1;
- (char)_shouldWeUpdateWorkingStoreAfterUpdatingUserPresence:(id)a0 withNewestLocalActivityTimeStamp:(id)a1;
