...
@property (readonly, getter=isUsingCompanionForRemoteAccessDevice) char usingCompanionForRemoteAccessDevice;
@property (readonly, getter=isRemoteAccessDeviceReachable) char remoteAccessDeviceReachable;
