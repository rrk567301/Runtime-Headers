...
@property (readonly, nonatomic, getter=isMicrophonePresent) char microphonePresent;
@property (readonly, nonatomic, getter=isSpeakerPresent) char speakerPresent;
...
@property (readonly, nonatomic, getter=isCameraRecordingFeatureSupported) char supportsCameraRecordingFeature;
...
- (char)_areFaceClassificationsSuppressedForSignificantEvent:(id)a0;
- (void)_createCameraRecordingManager;
- (void)_handleNegotiateStreamRequest:(id)a0;
- (void)_handleStreamControlRequest:(id)a0;
- (void)_postLocalNotificationForUpdatedSignificantEvent:(id)a0;
...
- (char)_shouldNotifyForSignificantEvent:(id)a0;
