...
@property char cachedHasCurrentUserSeenNotification;
@property (readonly, weak) HMDUser *user;
@property (readonly) NSObject<OS_dispatch_queue> *workQueue;
@property (readonly) char hasCurrentUserSeenNotification;
@property (readonly, getter=isRMVEnabledForCurrentUser) char RMVEnabledForCurrentUser;
