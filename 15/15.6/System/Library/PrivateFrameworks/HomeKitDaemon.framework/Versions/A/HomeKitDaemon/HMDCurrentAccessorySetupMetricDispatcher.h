...
@property (readonly) char allStagesSubmitted;
...
- (void)markControllerHH2Mode:(char)a0 controllerHH2SentinelExists:(char)a1;
- (void)markCurrentDeviceConfirmedPrimaryResidentStatusDidChange:(char)a0;
- (void)markEventRouterPrimaryClientConnectMessageFailedWithError:(id)a0;
- (void)markEventRouterPrimaryClientConnectStatusChanged:(char)a0;
