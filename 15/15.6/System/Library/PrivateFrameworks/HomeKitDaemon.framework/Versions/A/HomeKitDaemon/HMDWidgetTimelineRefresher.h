...
- (char)_getRequestsFromMessage:(id)a0 outCharacteristicWriteValueByUUUIDs:(id *)a1 outExecuteActionSetUUUIDs:(id *)a2 outExecuteTurnOffActionSetUUIDs:(id *)a3;
...
- (char)_value:(id)a0 isApproximatelyEqualToValue:(id)a1 forMinimumValue:(id)a2 maximumValue:(id)a3;
- (id)accessoriesMonitoredForReachability;
- (char)actionSetIsOn:(id)a0;
...
- (void)didUpdateStateActionSetUUID:(id)a0 state:(char)a1;
- (char)evaluateActionSetStateOnPrimaryEnabledForHome:(id)a0;
