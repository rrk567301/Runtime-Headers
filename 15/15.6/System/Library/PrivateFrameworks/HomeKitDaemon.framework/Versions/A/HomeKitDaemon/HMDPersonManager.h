...
@property (readonly) char syncsPersonData;
@property (readonly) char sharesFaceClassifications;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, getter=isDataAvailable) char dataAvailable;
@property (readonly, getter=isCurrentDeviceAvailableResident) char currentDeviceAvailableResident;
...
- (id)initWithUUID:(id)a0 zoneManager:(id)a1 coreDataManager:(id)a2 dataInterfaces:(id)a3 workQueue:(id)a4;
- (char)manager:(id)a0 shouldShareWithUser:(id)a1;
- (id)performCloudPull;
- (id)personFaceCropWithUUID:(id)a0;
- (id)personsWithUUIDs:(id)a0;
- (id)removeAllAssociatedDataDueToHomeGraphObjectRemoval:(char)a0;
