...
@property (nonatomic) char firstAccessoryReachable;
@property (nonatomic) char pairingHomeLocationOverride;
...
- (char)_hasReachableAccessoriesExcludingMatter;
- (char)_needToExtractLocations;
- (void)_processPendingRegionStateUpdates;
- (void)_registerForMessages;
- (void)_registerForRegionUpdate;
- (void)_sendLocationUpdateToClients;
- (char)_shouldRegisterForSignificantRegion;
- (char)_shouldUpdateHomeLocation;
...
- (char)isDate:(id)a0 laterThanDate:(id)a1;
- (char)isLocation:(id)a0 closeToLocation:(id)a1;
- (char)isNewHomeLocationTooCloseToPreviousLocation:(id)a0 newLocation:(id)a1;
...
- (char)shouldAllowHomeLocationUpdateWithSource:(long long)a0 newLocation:(id)a1;
- (char)shouldUpdateFromSingleLocation;
- (char)shouldUpdateLocationFromLocationData:(id)a0;
