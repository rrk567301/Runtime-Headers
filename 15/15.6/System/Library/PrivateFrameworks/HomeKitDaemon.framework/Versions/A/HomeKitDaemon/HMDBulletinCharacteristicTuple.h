...
@property (readonly, nonatomic) char changedByThisDevice;

+ (id)tupleWithServiceContextID:(id)a0 currentType:(id)a1 targetValue:(id)a2 targetStateNumber:(id)a3 changedByThisDevice:(char)a4;

- (void).cxx_destruct;
- (id)initWithServiceContextID:(id)a0 currentType:(id)a1 targetValue:(id)a2 targetStateNumber:(id)a3 changedByThisDevice:(char)a4;
