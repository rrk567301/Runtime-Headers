...
@property (readonly, nonatomic) char supportsCurrentDeviceSymptoms;
...
@property (nonatomic) char supportsRegisteringAccessories;
...
+ (char)accessoryIsConfiguring:(id)a0;
...
- (id)initWithQueue:(id)a0 dataSource:(id)a1 supportsRegistering:(char)a2 supportsCurrentDeviceSymptoms:(char)a3 deviceDiscovery:(id)a4 companionLinkClient:(id)a5 wifiManager:(id)a6 notificationCenter:(id)a7 sharingClientFactory:(id /* block */)a8;
