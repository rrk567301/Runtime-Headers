...
- (void)_sendMessage:(id)a0 payload:(id)a1 target:(id)a2 force:(char)a3 responseHandler:(id /* block */)a4;
- (id)_stateDump;
- (void)_transmitCurrentDeviceMetricsToPrimaryResidentWithIsUrgent:(char)a0;
- (id)cameraRecordingAnalysisNodesForCameraAccessory:(id)a0;
- (id)initWithHomeManager:(id)a0 residentEnabled:(char)a1;
- (void)setMetricForCurrentDevice:(id)a0 withValue:(id)a1 isUrgent:(char)a2;
