...
@property (readonly, nonatomic) char needsToStop;
@property (readonly, nonatomic) char needsToScheduleRegister;
@property (readonly, nonatomic) char needsToScheduleStaging;
@property (readonly, nonatomic) char needsToScheduleApply;
@property (readonly, nonatomic, getter=isIdle) char idle;
@property (readonly, nonatomic, getter=isStagingInProgress) char stagingInProgress;
...
- (void)scheduleWithDelay:(char)a0;
