...
- (id)materializeOrCreateCharacteristicsRelationOfType:(id)a0 instanceID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateCharacteristicsRelationOfTypeCharacteristicWithInstanceID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateCharacteristicsRelationOfTypeFloatCharacteristicWithInstanceID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateCharacteristicsRelationOfTypeIntegerCharacteristicWithInstanceID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateCharacteristicsRelationOfTypeStringCharacteristicWithInstanceID:(id)a0 createdNew:(char *)a1;
