...
@interface HMDCoreData : HMFObject <HMFTimerDelegate, HMFLogging> {
    ...
    char _firstCloudKitImportComplete;
    char _usingLiveCloudKit;
    char _firstSetupEvent;
    char _firstSetupActivity;
...
@property (class, readonly, nonatomic) char isUsingProductionObjectModel;
@property (class, readonly, nonatomic) NSURL *managedObjectModelURL;
@property (class, readonly, copy, nonatomic) NSPersistentStoreDescription *cloudPrivateStoreDescription;
@property (class, readonly, copy, nonatomic) NSPersistentStoreDescription *cloudSharedStoreDescription;
@property (class, readonly, copy, nonatomic) NSPersistentStoreDescription *localStoreDescription;
...
+ (char)isDatabaseCorruptedFromError:(id)a0;
+ (char)isDiskFullFromError:(id)a0;
...
- (char)_shouldPruneWorkingStoreHistory;
...
- (char)_pruneStoreHistoryWhenHistoryPercentageOfStoreIsGreaterThan:(long long)a0 storeType:(unsigned long long)a1;
- (char)_shouldPruneCloudStoreHistory;
...
- (id)dumpCloudKitConfiguration:(char)a0 localConfiguration:(char)a1 workingConfiguration:(char)a2 includeFakeModels:(char)a3 context:(id)a4 error:(id *)a5;
- (id)dumpConfiguration:(id)a0 includeFakeModels:(char)a1 context:(id)a2 error:(id *)a3;
