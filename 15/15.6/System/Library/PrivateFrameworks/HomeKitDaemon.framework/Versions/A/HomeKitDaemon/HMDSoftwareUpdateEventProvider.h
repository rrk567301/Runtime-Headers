...
- (void)manager:(id)a0 didFinishDownload:(id)a1 willProceedWithInstallation:(char)a2 waitingForAdmissionControl:(char)a3;
- (void)manager:(id)a0 didFinishDownload:(id)a1 willProceedWithInstallation:(char)a2 waitingForAdmissionControl:(char)a3 denialReasons:(id)a4;
