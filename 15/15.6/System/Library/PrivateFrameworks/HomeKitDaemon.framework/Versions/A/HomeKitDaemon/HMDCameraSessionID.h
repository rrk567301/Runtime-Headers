...
@property (readonly, getter=isSPIClient) char spiClient;
...
- (id)initWithSessionID:(id)a0 hostProcessBundleIdentifier:(id)a1 isSPIClient:(char)a2 deviceSectionName:(id)a3 description:(id)a4;
