...
+ (id)lookForCharacteristicByAccessoryUUID:(id)a0 serviceID:(id)a1 characteristicID:(id)a2 inHome:(id)a3 checkForSupport:(char)a4 outError:(id *)a5 shouldLog:(char)a6;
