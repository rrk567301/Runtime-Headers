...
- (void)_fetchCloudChangesIgnoringLastFetchedAccessories:(char)a0 forceChangeNotifications:(char)a1 completion:(id /* block */)a2;
...
- (void)forceFetchCloudChangesAndForceChangeNotifications:(char)a0 completion:(id /* block */)a1;
