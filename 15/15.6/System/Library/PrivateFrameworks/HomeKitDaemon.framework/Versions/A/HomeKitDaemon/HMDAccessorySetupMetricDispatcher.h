...
@property (readonly) char didSendAddAccessoryRequestToPrimary;
@property (readonly, copy) NSError *addAccessoryOnPrimaryFailError;
@property (readonly) char didAddAccessoryLocally;
@property (readonly) char primaryResidentIdenticalToAccessoryBeingAdded;
@property (readonly) char primaryResidentAssignedInHomeWhenAddAccessory;
...
@property (readonly) char submitted;
