...
- (void).cxx_destruct;
- (char)_compareIPSignatures:(id)a0 secondSignature:(id)a1;
...
- (void)updateBrowseStatus:(char)a0 forAccessoryUUID:(id)a1;
- (void)updateSessionConnectivity:(char)a0 withSessionInfo:(id)a1 forAccessoryUUID:(id)a2;
