...
- (id)materializeOrCreateAllowedGuestsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)castIfAccessory;
- (void)addAllowedGuestsObject:(id)a0;
- (void)addHostedAccessoriesObject:(id)a0;
- (void)addOutgoingInvitationsObject:(id)a0;
...
- (id)findAllowedGuestsRelationWithModelID:(id)a0;
- (id)findOutgoingInvitationsRelationWithModelID:(id)a0;
- (char)hasRGCapableService;
- (id)materializeOrCreateApplicationDataRelation:(char *)a0;
- (id)materializeOrCreateOutgoingInvitationsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateSoftwareUpdateRelation:(char *)a0;
- (void)removeAllowedGuestsObject:(id)a0;
- (void)removeHostedAccessoriesObject:(id)a0;
- (void)removeOutgoingInvitationsObject:(id)a0;
