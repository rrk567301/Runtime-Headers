...
- (id)materializeOrCreateEndElementRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
...
- (id)materializeOrCreateEndElementRelationOfTypeSunriseSunsetTimeSpecificationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateEndElementRelationOfTypeTimeOfDayTimeSpecificationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateStartElementRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateStartElementRelationOfTypeSunriseSunsetTimeSpecificationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateStartElementRelationOfTypeTimeOfDayTimeSpecificationWithModelID:(id)a0 createdNew:(char *)a1;
