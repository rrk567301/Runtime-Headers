...
@property (readonly, nonatomic) char defaultValueSet;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithClass:(Class)a0 logging:(unsigned long long)a1 readOnly:(id)a2 unavailable:(id)a3 defaultSet:(char)a4 defaultValue:(id)a5 additonalDecodeClasses:(id)a6;
