...
@property (getter=isHomeAppForegrounded) char homeAppForegrounded;
...
- (id)_addNewAccessCode:(id)a0 forUserWithUUID:(id)a1 toAccessoriesWithUUIDs:(id)a2 withRetries:(char)a3;
...
- (id)_filterModificationRequestsForPrivilege:(id)a0;
...
- (char)_redispatchToResidentIfNeccesaryForMessage:(id)a0 withNewResponseHandler:(id /* block */)a1;
...
- (id)_updateAccessCode:(id)a0 toNewValue:(id)a1 onAccessoriesWithFetchResponses:(id)a2 withRetries:(char)a3;
...
- (id)addNewAccessCode:(id)a0 forUserWithUUID:(id)a1 toAccessoriesWithUUIDs:(id)a2 withRetries:(char)a3;
...
- (char)hasCurrentUserAccessCodeChangedWithChangedAccessCodes:(id)a0 home:(id)a1;
- (id)initWithContext:(id)a0 utilities:(Class)a1 accessoryReaderWriter:(id)a2 dataManager:(id)a3;
- (id)removeAccessCode:(id)a0 fromHAPAccessory:(id)a1;
