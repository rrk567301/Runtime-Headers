...
@property (readonly, getter=isDemoModeEnabled) char demoModeEnabled;
...
- (void).cxx_destruct;
- (void)configure;
- (char)areEncodedBrightnessLevelTransitionPointsValid:(id)a0;
...
- (id)initWithHome:(id)a0 demoModeEnabled:(char)a1;
- (id)initWithHome:(id)a0 workQueue:(id)a1 demoModeEnabled:(char)a2 logIdentifier:(id)a3 notificationCenter:(id)a4 dataSource:(id)a5;
- (void)initalizeCurve;
