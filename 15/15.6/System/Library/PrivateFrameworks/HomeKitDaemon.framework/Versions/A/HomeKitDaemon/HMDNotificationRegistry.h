...
- (id)characteristicsByDestinationForCharacteristics:(id)a0 applyChangeThresholding:(char)a1;
...
- (id)destinationsRegisteredForNotificationsForCharacteristics:(id)a0 applyChangeThresholding:(char)a1;
...
- (char)hasRegistrationsForActionSetUUID:(id)a0;
- (id)initWithPendingRequestsRetryTimer:(id)a0;
- (id)propertiesRegisteredForMediaProfileUniqueIdentifier:(id)a0;
- (char)removeRegistrationsForActionSetUUID:(id)a0;
- (void)removeRegistrationsForCharacteristics:(id)a0;
- (char)removeRegistrationsForMediaProfile:(id)a0;
- (void)reprocessEnabledCharacteristicRegistrations;
- (char)setNotificationsEnabled:(char)a0 user:(id)a1 deviceIdsDestination:(id)a2 characteristicsPayload:(id)a3 characteristicChangeThresholdsPayload:(id)a4 mediaPropertiesPayload:(id)a5 actionSetsPayload:(id)a6 matterNotificationPayload:(id)a7;
