@class NSUUID, HMDRemoteLoginAnisetteDataHandler, ACAccount, NSString, HMFMessageDispatcher, HMDRemoteLoginReceiver, NSObject, HMFStagedValue, HMDAppleMediaAccessory, HMDRemoteLoginInitiator, ACAccountStore;
...
@property (readonly) char targetSupportsAccounts;
...
- (id)initWithUUID:(id)a0 accessory:(id)a1 loggedInAccount:(id)a2 accountStore:(id)a3 targetSupportsAccounts:(char)a4;
