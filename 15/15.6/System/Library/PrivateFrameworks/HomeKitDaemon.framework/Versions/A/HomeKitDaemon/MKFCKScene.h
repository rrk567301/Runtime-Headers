...
- (id)decodeActionCommand:(id)a0 localModel:(id)a1 context:(id)a2;
...
- (id)encodeActionCommand:(id)a0 accessories:(id)a1 context:(id)a2;
- (id)encodeActionMediaPlayback:(id)a0 accessories:(id)a1 context:(id)a2;
- (id)encodeActionNaturalLight:(id)a0 accessories:(id)a1 shouldRemoveAction:(char *)a2 context:(id)a3;
