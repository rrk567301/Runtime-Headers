...
- (id)initWithHome:(id)a0 notificationCenter:(id)a1 persistence:(id)a2 logEventSubmitter:(id)a3 isResidentCapable:(char)a4 clientDataSource:(id)a5 serverDataSource:(id)a6;
