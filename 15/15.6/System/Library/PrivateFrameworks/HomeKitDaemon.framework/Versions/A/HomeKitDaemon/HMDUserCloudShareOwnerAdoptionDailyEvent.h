...
- (void).cxx_destruct;
- (id)initWithConfigureState:(long long)a0 isPrimaryResident:(char)a1 trustStatusCounts:(struct CloudShareTrustManagerTrustStatusCounts { long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; })a2;
