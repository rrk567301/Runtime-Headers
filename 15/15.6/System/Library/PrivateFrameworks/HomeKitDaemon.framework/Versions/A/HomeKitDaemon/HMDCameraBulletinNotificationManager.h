...
- (char)_shouldNotifyForActivityForSignificantEvent:(id)a0 remoteRegistration:(id)a1;
...
- (char)_filterPassesForCameraSignificantEvent:(id)a0 registration:(id)a1;
- (void)_handleCameraSignificantEventBulletinNotificationRegistration:(id)a0 removed:(char)a1;
...
- (void)_handleSignificantEvent:(id)a0 cameraProfile:(id)a1;
- (void)_handleSignificantEvent:(id)a0 remoteRegistration:(id)a1;
- (void)_handleSignificantEventWithUUID:(id)a0 reason:(unsigned long long)a1 dateOfOccurrence:(id)a2 confidenceLevel:(unsigned long long)a3 faceClassifications:(id)a4 cameraProfile:(id)a5;
...
- (char)_shouldNotifyForDoorbellPressForSignificantEvent:(id)a0 registration:(id)a1;
- (void)_synchronizeLocalRegistrationsWithPrimaryResident;
- (char)_updateLocalStoreWithCameraAccessModeBulletinRegistration:(id)a0 existingMKFLocalRegistration:(id)a1 enabled:(char)a2 moc:(id)a3;
- (char)_updateLocalStoreWithCameraReachabilityBulletinRegistration:(id)a0 existingMKFLocalRegistration:(id)a1 enabled:(char)a2 moc:(id)a3;
- (char)_updateLocalStoreWithCameraSignificantEventBulletinRegistration:(id)a0 existingMKFLocalRegistration:(id)a1 enabled:(char)a2 moc:(id)a3;
...
- (void)handleSignificantEvent:(id)a0 cameraProfile:(id)a1;
...
- (void)updateNotificationRegistrationsWithSettings:(id)a0 accessory:(id)a1 doorbellPressNotificationEnabled:(char)a2 completion:(id /* block */)a3;
