...
@property (readonly) char supportsCameraSnapshotRequestViaRelay;
@property (readonly, getter=isWatchDevice) char watchDevice;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

- (id)createLocalSnapshotSessionWithID:(id)a0 accessory:(id)a1 snapshotGetter:(id)a2 message:(id)a3 waitPeriod:(double)a4 reachabilityPath:(unsigned long long)a5 cameraLocallyReachable:(char)a6 snapshotForNotification:(char)a7;
