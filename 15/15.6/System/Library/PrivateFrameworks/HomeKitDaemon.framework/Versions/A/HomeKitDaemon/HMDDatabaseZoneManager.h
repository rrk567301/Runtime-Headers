...
- (void)configure;
- (id)logIdentifier;
- (char)_fetchExistingPrivateZonesWithConfiguration:(id)a0;
- (char)_fetchPrivateZonesWithConfiguration:(id)a0;
- (char)_fetchSharedZonesWithConfiguration:(id)a0;
- (char)_handleFetchZonesResult:(id)a0 configuration:(id)a1;
...
- (char)startWithConfiguration:(id)a0;
