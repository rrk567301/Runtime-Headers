...
@property (readonly, getter=isTargetDevice) char targetDevice;
...
- (char)addGroupDataForTargetDevice:(id)a0;
- (void)configureWithHome:(id)a0 currentAccessory:(char)a1;
- (id)dataSourceDestinationControllerWithIdentifier:(id)a0;
- (id)dataSourceRootDestinationManager;
- (id)dataSourceTargetAccessory;
- (id)initWithDestination:(id)a0 messageDispatcher:(id)a1 notificationCenter:(id)a2 backingStore:(id)a3 targetDevice:(char)a4 dataSource:(id)a5 delegate:(id)a6;
- (id)initWithDestination:(id)a0 messageHandler:(id)a1 backingStoreHandler:(id)a2 metricsDispatcher:(id)a3 targetDevice:(char)a4 dataSource:(id)a5 delegate:(id)a6;
...
- (char)updateTargetDeviceAudioGroupIdentifier:(id)a0;
