@class Protocol, NSArray, NSDate, NSPredicate, HMDAccountIdentifier, NSDictionary, MKFUserDatabaseID, HAPPairingIdentity, HMDAccountHandle, _MKFOutgoingInvitation, NSString, CKRecordID, _MKFUserAccessCode, NSSet, NSNumber, NSData, CKDeviceToDeviceShareInvitationToken, _MKFHome, NSUUID;
...
@property (retain, nonatomic) NSSet *userActivityStatuses_;
...
+ (id)findUserUsingReverseShareID:(id)a0 homeModelID:(id)a1 context:(id)a2;
+ (char)isOwnerOrAdminWithPrivilege:(unsigned long long)a0;
+ (char)isOwnerWithPrivilege:(unsigned long long)a0;
+ (char)isResidentSyncParticipantWithPrivilege:(unsigned long long)a0;
...
- (id)materializeOrCreateAccessCodeRelationWithModelID:(id)a0 createdNew:(char *)a1;
...
- (id)materializeOrCreateBulletinRegistrationsRelationOfTypeEventBulletinRegistrationWithModelID:(id)a0 createdNew:(char *)a1;
...
- (id)materializeOrCreatePersonsFromPhotosRelationWithModelID:(id)a0 createdNew:(char *)a1;
