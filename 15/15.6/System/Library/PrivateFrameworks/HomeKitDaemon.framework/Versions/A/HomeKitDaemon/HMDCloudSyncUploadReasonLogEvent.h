...
+ (id)uploadReason:(id)a0 acceptedHomeManagerZonePush:(char)a1;
+ (id)uploadReason:(id)a0 acceptedHomeZonePush:(char)a1;
+ (id)uploadReason:(id)a0 acceptedLegacyPush:(char)a1;
