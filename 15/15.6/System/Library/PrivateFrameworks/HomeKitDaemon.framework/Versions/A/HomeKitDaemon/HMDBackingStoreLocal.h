...
+ (id)logCategory;
+ (void)cleanDatastoreFilesAt:(id)a0 everything:(char)a1;
...
- (id)_instanceResources:(char)a0 migrate:(char)a1;
...
- (char)_selectArchiveWithIdentifier:(id)a0 archive:(id *)a1 controllerUserName:(id *)a2 error:(id *)a3;
...
- (id)initWithDB:(id)a0 migrate:(char)a1 error:(id *)a2;
