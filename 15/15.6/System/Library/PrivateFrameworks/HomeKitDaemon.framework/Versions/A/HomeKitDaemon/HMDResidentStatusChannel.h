...
@protocol OS_dispatch_queue, HMDStatusChannelProvider, HMMLogEventSubmitting, HMFTimerProvider;
...
@property (nonatomic) char domainDataCached;
@property (readonly, nonatomic) NSMutableDictionary *domainDataPairs;
@property (nonatomic) char domainPublishAllowed;
...
- (char)shouldAllowDomainPublishRequest;
