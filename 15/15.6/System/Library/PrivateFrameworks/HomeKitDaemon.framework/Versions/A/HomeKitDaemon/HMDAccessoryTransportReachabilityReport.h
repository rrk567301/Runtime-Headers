...
@property (readonly, nonatomic) char hasAdvertisement;
...
- (void).cxx_destruct;
- (id)initWithLinkType:(id)a0 hasAdvertisement:(char)a1 protocol:(id)a2 protocolVersion:(id)a3 reachable:(char)a4 reachableLastChangedTime:(id)a5 reason:(id)a6;
