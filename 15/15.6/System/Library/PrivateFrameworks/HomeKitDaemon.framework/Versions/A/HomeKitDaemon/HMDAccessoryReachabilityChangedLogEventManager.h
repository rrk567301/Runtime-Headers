...
- (void)_submitForAccessory:(id)a0 withTransportReport:(id)a1 reachable:(char)a2 changed:(char)a3;
- (void)handlePrimaryResidentUpdatedNotification:(id)a0;
- (id)logEventSubmitter;
- (void)runDailyTask;
- (void)submitForAccessory:(id)a0 withTransportReport:(id)a1 reachable:(char)a2;
