...
@property (readonly) char hasReachablePrimaryResidentSupportingLockNotificationContext;
...
- (void)sendLockOperationEventNotification:(id)a0 userUniqueID:(id)a1 lockOperationType:(id)a2 lockOperationSource:(id)a3 fabricIndex:(id)a4 accessory:(id)a5 timestamp:(id)a6 flow:(id)a7;
...
- (char)shouldResolveNotificationContextForCharacteristic:(id)a0;
