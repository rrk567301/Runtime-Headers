...
@property (readonly) char shouldShowProvideFeedbackButton;
...
- (id)initWithSignificantEvent:(id)a0 previewImageFilePathURL:(id)a1 dateOfOccurrence:(id)a2 camera:(id)a3 home:(id)a4 accessory:(id)a5 recordingService:(id)a6 shouldShowProvideFeedbackButton:(char)a7;
- (id)initWithSignificantEvents:(id)a0 previewImageNotificationUUID:(id)a1 previewImageFilePathURL:(id)a2 dateOfOccurrence:(id)a3 camera:(id)a4 home:(id)a5 accessory:(id)a6 recordingService:(id)a7 clipUUID:(id)a8 shouldShowProvideFeedbackButton:(char)a9;
- (id)initWithSignificantEvents:(id)a0 previewImageNotificationUUID:(id)a1 previewImageFilePathURL:(id)a2 dateOfOccurrence:(id)a3 camera:(id)a4 home:(id)a5 accessory:(id)a6 recordingService:(id)a7 requestIdentifier:(id)a8 clipUUID:(id)a9 shouldShowProvideFeedbackButton:(char)a10;
