...
@property char cloudFetchInProgress;
@property char cloudFetchCompleted;
...
- (void)_readDiagnosticsDataWithCloudKitMetadataRequirement:(char)a0 completion:(id /* block */)a1;
...
- (char)_isRequestSupported:(id)a0;
