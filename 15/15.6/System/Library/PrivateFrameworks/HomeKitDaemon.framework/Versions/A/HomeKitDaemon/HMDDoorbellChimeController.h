...
- (void)_notifyAllAccessoriesForDoorbellPressAndPlayChimeSound:(char)a0 attemptCloudPullIfNoPersonsFound:(char)a1;
...
- (void)notifyAccessoriesViaCoordinationFreePathWithDelay:(double)a0 home:(id)a1 shouldPlayChime:(char)a2 personIdentificationText:(id)a3 accessoriesToNotify:(id)a4 logEvent:(id)a5 accessoryUUID:(id)a6;
