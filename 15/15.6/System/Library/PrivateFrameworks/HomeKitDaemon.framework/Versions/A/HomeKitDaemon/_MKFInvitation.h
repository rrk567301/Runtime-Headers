...
- (id)materializeOrCreateWeekDayScheduleRulesRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateYearDayScheduleRulesRelationWithModelID:(id)a0 createdNew:(char *)a1;
