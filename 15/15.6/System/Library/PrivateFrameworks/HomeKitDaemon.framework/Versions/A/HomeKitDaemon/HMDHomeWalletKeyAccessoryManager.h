...
@property char canConfigureAccessories;
...
@property (readonly) char isPrimaryResidentOrSoleOwnerController;
...
- (id)_addIssuerKeyForUser:(id)a0 toMatterAccessory:(id)a1 flow:(id)a2;
- (id)_addIssuerKeyForUserIndex:(id)a0 toMatterAccessory:(id)a1 isUnifiedAccess:(char)a2 issuerKeyData:(id)a3 withFlow:(id)a4;
- (id)_addOrUpdateACWGIssuerKey:(id)a0 forUser:(id)a1 toMatterAccessory:(id)a2 flow:(id)a3;
- (void)_handleAddIssuerKeysToMatterV1AccessoriesMessage:(id)a0;
...
- (void)addIssuerKeysToMatterV1AccessoriesWithFlow:(id)a0;
- (id)addOrUpdateACWGIssuerKey:(id)a0 forUser:(id)a1 toMatterAccessory:(id)a2 flow:(id)a3;
- (id)addOrUpdateACWGIssuerKey:(id)a0 forUser:(id)a1 toMatterAccessory:(id)a2 withControllerType:(id)a3 flow:(id)a4;
- (void)auditKeysLocallyOrRedispatchWithAccessoryUUID:(id)a0 issuerKey:(id)a1 withFlow:(id)a2;
- (void)configureAccessories:(id)a0 withDeviceCredentialKey:(id)a1 ofType:(long long)a2 flow:(id)a3 completion:(id /* block */)a4;
- (void)configureAccessories:(id)a0 withDeviceCredentialKey:(id)a1 ofType:(long long)a2 forDeviceWithUUID:(id)a3 user:(id)a4 flow:(id)a5 completion:(id /* block */)a6;
...
- (void)configureAccessories_HH2:(id)a0 withDeviceCredentialKey:(id)a1 ofType:(long long)a2 forDeviceWithUUID:(id)a3 user:(id)a4 flow:(id)a5 completion:(id /* block */)a6;
- (void)configureAccessory:(id)a0 withDeviceCredentialKey:(id)a1 ofType:(long long)a2 flow:(id)a3 completion:(id /* block */)a4;
- (void)configureAccessoryWithNfcReaderKey:(id)a0 accessory:(id)a1 flow:(id)a2 completion:(id /* block */)a3;
- (void)configureAllAccessoriesWithDeviceCredentialKey:(id)a0 ofType:(long long)a1 flow:(id)a2 completion:(id /* block */)a3;
- (id)configureMatterAccessory:(id)a0 withDeviceCredentialKey:(id)a1 ofType:(long long)a2 forUser:(id)a3 flow:(id)a4;
...
- (id)configureReaderKey:(id)a0 onACWGAccessory:(id)a1 flow:(id)a2;
...
- (id)fetchMissingWalletKeysForAccessoryUUID:(id)a0 forUser:(id)a1 flow:(id)a2;
...
- (void)handleHMDHomeWalletKeyAccessoryManagerAddOrUpdateIssuerKeyMessage:(id)a0;
...
- (void)requestPrimaryResident:(id)a0 toConfigureAccessories:(id)a1 withDeviceCredentialKey:(id)a2 ofType:(long long)a3 flow:(id)a4 completion:(id /* block */)a5;
- (id)restoreMissingWalletKeys:(id)a0 onAccessory:(id)a1 flow:(id)a2;
- (void)sendIssuerKeyUpdateMessageToPhone:(id)a0 forAccessoryWithUUID:(id)a1 issuerKey:(id)a2 flow:(id)a3;
- (void)sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID:(id)a0 issuerKey:(id)a1 flow:(id)a2;
