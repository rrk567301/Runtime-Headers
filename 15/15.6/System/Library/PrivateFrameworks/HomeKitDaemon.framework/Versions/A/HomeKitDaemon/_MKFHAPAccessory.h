...
- (id)materializeOrCreateNaturalLightingActionsRelation:(char *)a0;
- (id)materializeOrCreateServicesRelationWithInstanceID:(id)a0 createdNew:(char *)a1;
...
- (char)supportsAnyMatterV1InPersonAccess;
