...
@property char internalDiscoveryRequest;
...
@property (nonatomic) char hasActiveWACPairing;
@property (nonatomic) char btlePowerState;
@property (nonatomic) char unitTestEnableWHB;
...
- (void)accessoryServer:(id)a0 didUpdateConnectionState:(char)a1 linkLayerType:(long long)a2 bookkeeping:(id)a3 withError:(id)a4;
- (void)accessoryServer:(id)a0 didUpdateConnectionState:(char)a1 linkLayerType:(long long)a2 withError:(id)a3;
- (void)accessoryServer:(id)a0 didUpdateConnectionState:(char)a1 sessionInfo:(id)a2 linkLayerType:(long long)a3 withError:(id)a4;
- (void)accessoryServer:(id)a0 didUpdateHasPairings:(char)a1;
- (void)accessoryServer:(id)a0 didUpdateName:(id)a1;
- (void)accessoryServer:(id)a0 didUpdateValuesForCharacteristics:(id)a1 stateNumber:(id)a2 broadcast:(char)a3;
...
- (void)accessoryServerBrowser:(id)a0 accessoryServer:(id)a1 didUpdateValuesForCharacteristics:(id)a2 stateNumber:(id)a3 broadcast:(char)a4;
- (void)accessoryServerBrowser:(id)a0 didChangeReachability:(char)a1 forAccessoryServerWithIdentifier:(id)a2;
- (void)accessoryServerBrowser:(id)a0 didFailToDiscoverAccessoryServerWithIdentifier:(id)a1;
- (void)accessoryServerBrowser:(id)a0 didFindAccessoryServer:(id)a1 stateChanged:(char)a2 stateNumber:(id)a3;
...
- (char)isServerLinkTypeBrowseable:(long long)a0;
...
- (void)_notifyDelegateOfReachabilityChange:(char)a0 forAccessoryWithIdentifier:(id)a1;
...
- (void)__inactivate;
- (char)__isAccessoryBrowsingRequested;
- (char)__isMediaAccessoryBrowsingRequested;
...
- (void)_associate:(char)a0 hapAccessoryWithAdvertisement:(id)a1;
- (void)_associateMediaAccessoryForServer:(id)a0;
- (void)_btleAccessoryReachabilityProbeTimer:(char)a0;
...
- (void)_continueAfterPPIDValidation:(char)a0 server:(id)a1;
...
- (char)_isAccessoryServerTombstoned:(id)a0;
- (char)_isHomeHubAvailableWithConfiguration:(id)a0;
- (char)_isHomeHubMatterSharedAdminPairingCapableWithConfiguration:(id)a0;
- (char)_isOwnerPairingAccessoryWithConfiguration:(id)a0;
- (char)_isPrimaryResidentReachableWithConfiguration:(id)a0;
...
- (void)_notifyDelegateOfAccessoryServer:(id)a0 didUpdateHasPairings:(char)a1;
- (void)_notifyDelegateOfAccessoryServer:(id)a0 didUpdateValuesForCharacteristics:(id)a1 stateNumber:(id)a2 broadcast:(char)a3;
...
- (void)_notifyDelegateOfNewPairedAccessoryServer:(id)a0 stateChanged:(char)a1 stateNumber:(id)a2;
- (void)_notifyDelegateOfReachabilityChangeChange:(char)a0 forBTLEAccessories:(id)a1;
...
- (char)_shouldAccessoryServerBeTombstoned:(id)a0;
...
- (void)_stopDiscoveringAccessoriesWithLinkType:(id)a0 force:(char)a1 error:(id)a2;
- (void)_stopDiscoveringMediaAccessories;
- (void)_stopDiscoveryForAccessoryServerBrowser:(id)a0;
- (void)_stopReconfirmTimer:(id)a0;
- (void)_tombstoneAccessoryServer:(id)a0 forceNotify:(char)a1;
...
- (void)accessoryServerBrowser:(id)a0 getLockedState:(char *)a1;
...
- (void)addUnassociatedAccessory:(id)a0 forDeviceSetup:(char)a1;
- (void)addUnassociatedMediaAccessory:(id)a0 forDeviceSetup:(char)a1;
...
- (char)areThereAnyAssociatedAirPlayAccessories;
- (char)areThereAnyPairedAccessories;
- (char)areThereAnyPairedBTLEAccessories;
- (char)areThereAnyPairedUnknownLinkTypeAccessories;
...
- (void)configureAccessory:(id)a0 trackState:(char)a1 connectionPriority:(char)a2;
...
- (void)didReceiveUserConsentResponseForSetupAccessoryDetail:(id)a0 consent:(char)a1;
...
- (char)isDiscoveringAccessoriesWithLinkType:(long long)a0;
- (char)isThreadAccessoryWithAccessoryServerIdentifier:(id)a0;
...
- (void)probeReachabilityForBTLEAccessoryServersWithIdentifiers:(id)a0 forceScan:(char)a1 withCompletion:(id /* block */)a2;
...
- (void)updateRemoteAccessoryBrowsing:(char)a0 whbScan:(char)a1;
