...
- (char)canEstablishConnectionForHMDHAPAccessory:(id)a0;
...
- (void)notifyUpdateRequestedForHMDHAPAccessory:(id)a0 isUserTriggered:(char)a1 isRetry:(char)a2;
...
- (char)updateUARPFirmwareVersionForAccessory:(id)a0 version:(id)a1;
