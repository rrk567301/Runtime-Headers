...
@property char lastKnownCameraReachability;
@property char currentCameraReachability;
@property char currentBridgedCameraReachability;
@property (nonatomic, getter=isCurrentDeviceConfirmedPrimaryResident) char currentDeviceConfirmedPrimaryResident;
@property (nonatomic, getter=isCurrentDeviceConnectedToNetwork) char currentDeviceConnectedToNetwork;
...
- (char)shouldHandleReachabilityChanges;
- (void)submitLogEventWithCurrentModel:(id)a0;
- (void)addCameraReachabilityEventWithReachability:(char)a0 dateOfOccurrence:(id)a1;
- (void)cleanUpEvents;
- (void)clipManagerDidStart:(id)a0;
- (void)clipManagerDidStop:(id)a0;
- (void)configureWithMessageDispatcher:(id)a0 currentSettings:(id)a1 isCurrentDeviceConfirmedPrimaryResident:(char)a2 isCurrentDeviceConnectedToNetwork:(char)a3;
...
- (void)handleUpdatedCameraReachability:(char)a0;
...
- (void)notifyRemoteSubscribersOfCameraReachabilityEventWithReachability:(char)a0;
- (void)notifyTransportOfUpdatedEvents:(id)a0 removedEventUUIDs:(id)a1;
- (id)performCloudPullWithLabel:(id)a0;
- (id)reachabilityEventModelWithReachability:(char)a0 dateOfOccurrence:(id)a1;
- (char)shouldAddInitialReachabilityEventWithReachability:(char)a0 mostRecentReachabilityEventModel:(id)a1;
- (void)startReachabilityChangeDebounceTimerWithReachability:(char)a0;
