...
+ (id)cloudFetchSyncOperationWithCloudConflict:(char)a0 block:(id /* block */)a1;
...
+ (id)cloudZoneFetchSyncOperation:(id)a0 cloudConflict:(char)a1 block:(id /* block */)a2 completion:(id /* block */)a3;
