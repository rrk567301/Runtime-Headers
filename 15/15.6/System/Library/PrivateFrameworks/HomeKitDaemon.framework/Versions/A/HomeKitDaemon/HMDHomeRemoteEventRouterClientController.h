...
@property (readonly, nonatomic) char isCachedEventSourceCurrentProcess;

- (void).cxx_destruct;
- (char)isNetworkAvailable;
- (void)client:(id)a0 connectDidFailWithError:(id)a1;
- (void)client:(id)a0 connectionStatusDidChange:(char)a1;
- (void)client:(id)a0 didReceiveFetchedCachedEvents:(id)a1;
- (id)client:(id)a0 forwardingTopicsForTopics:(id)a1;
- (char)client:(id)a0 isIdsIdentifier:(id)a1 ofAccessory:(id)a2;
...
- (char)isPrimaryResidentClientConnected;
...
- (char)routerClientShouldRestrictMessagingToLocalOnly:(id)a0;
- (char)routerClientSupportsFragmentMessageForServerIdentifier:(id)a0;
