...
@property (readonly) char badCDPState;
...
+ (char)transactionIsCloudStoreReset:(id)a0 context:(id)a1;
...
- (id)initWithCoreData:(id)a0 fakeRecordsEnabled:(char)a1 logEventSubmitter:(id)a2 userDefaults:(id)a3;
...
- (char)runTransformWithError:(id *)a0;
