...
@property (readonly) char assistantAccessControlActivityNotificationsEnabledForPersonalRequests;
...
- (void)handleAssistantAccessControlAccessoryUUIDsUpdated:(id)a0 activityNotificationsEnabledForPersonalRequests:(char)a1 completion:(id /* block */)a2;
