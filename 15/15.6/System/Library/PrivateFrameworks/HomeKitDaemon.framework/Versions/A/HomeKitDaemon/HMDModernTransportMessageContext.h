...
@property (nonatomic) char didFallback;
...
@property (readonly, nonatomic) char expectsResponse;
...
@property (readonly, nonatomic) char didSucceedSending;
@property (readonly, nonatomic) unsigned long long successfulResponseCount;
@property (nonatomic) char didNotifyDeviceReachability;
