...
- (char)_isAnyEventInAnalyzerEvents:(id)a0 includedInRecordingEventTriggers:(unsigned long long)a1;
- (char)_isAnyEventInAnalyzerFrameResults:(id)a0 includedInRecordingEventTriggers:(unsigned long long)a1;
...
- (char)isAnyEventInAnalyzerFragmentResult:(id)a0 includedInRecordingEventTriggers:(unsigned long long)a1;
