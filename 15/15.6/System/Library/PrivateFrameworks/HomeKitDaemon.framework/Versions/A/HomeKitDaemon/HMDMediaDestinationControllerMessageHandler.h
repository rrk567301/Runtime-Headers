...
- (id)initWithMessageTargetUUID:(id)a0 messageDispatcher:(id)a1 notificationCenter:(id)a2 metricsEventDispatcher:(id)a3 targetDevice:(char)a4 dataSource:(id)a5 delegate:(id)a6;
