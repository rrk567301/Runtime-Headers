...
@property (nonatomic) char managedNetworkEnabled;
@property (nonatomic) char staleClientIdentifiersResetNeeded;
@property (nonatomic) char staleClientIdentifiersResetInProgress;
@property (nonatomic) char startPending;
...
- (void)_createClientConfigurationForAccessory:(id)a0 credential:(id)a1 clientStatus:(id)a2 clientReconfigurationAllowed:(char)a3;
...
- (void)_migrateAccessory:(id)a0 withConfiguration:(id)a1 clientStatus:(id)a2 fromCredentialType:(long long)a3 toCredentialType:(long long)a4 rotate:(char)a5 completion:(id /* block */)a6;
- (void)_reconcileClientConfigurationForAccessory:(id)a0 clientStatus:(id)a1 networkRouterUUID:(id)a2 clientReconfigurationAllowed:(char)a3;
- (void)_reconcileClientConfigurationForReachableAccessory:(id)a0 clientReconfigurationAllowed:(char)a1;
- (void)_registerForChangesToManagedAccessory:(id)a0;
- (void)_registerForNetworkProtectionChangesToGroup:(id)a0;
- (void)_replaceClientConfigurationForAccessory:(id)a0 credential:(id)a1 clientStatus:(id)a2 clientReconfigurationAllowed:(char)a3;
- (void)_replaceNetworkClientIdentifierForAccessory:(id)a0 networkClientIdentifier:(id)a1 networkRouterUUID:(id)a2 clientStatus:(id)a3 clientReconfigurationAllowed:(char)a4;
- (void)_resetStaleClientIdentifiersBeforeStart;
- (void)_startManagingAccessory:(id)a0 initialHomeSetup:(char)a1;
- (id)_transactionBlockForAccessoriesWithStaleClientIdentifier;
- (void)_unregisterForNetworkProtectionChangesToGroup:(id)a0;
- (void)_updateClientConfiguration:(id)a0 forAccessory:(id)a1 protectionMode:(long long)a2 clientStatus:(id)a3 skipIfFingerprintMatches:(char)a4 clientReconfigurationAllowed:(char)a5;
- (void)_updateClientConfigurationForAllAccessoriesWithClientReconfigurationAllowed:(char)a0;
- (void)_updateExistingClientConfiguration:(id)a0 forAccessory:(id)a1 clientStatus:(id)a2 clientReconfigurationAllowed:(char)a3;
- (void)_updateOrCreateClientConfigurationForAccessory:(id)a0 preferReconcile:(char)a1 clientReconfigurationAllowed:(char)a2;
...
- (void)migrateAccessory:(id)a0 toCredentialType:(long long)a1 rotate:(char)a2 completion:(id /* block */)a3;
