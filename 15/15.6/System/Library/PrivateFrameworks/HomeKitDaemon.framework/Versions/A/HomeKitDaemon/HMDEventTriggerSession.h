@class NSUUID, NSString, HMFMessageDispatcher, HMDEventTrigger, NSObject, HMDDevice;
...
- (char)sendMessage:(id)a0 payload:(id)a1 device:(id)a2 responseHandler:(id /* block */)a3;
- (char)sendMessage:(id)a0 payload:(id)a1 device:(id)a2 target:(id)a3 responseHandler:(id /* block */)a4;
- (char)sendResidentMessage:(id)a0 payload:(id)a1 responseHandler:(id /* block */)a2;
