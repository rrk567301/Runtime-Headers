...
@property (readonly) char isTargetDevice;
...
- (char)hasSetDestinationRelatedToIdentifier:(id)a0;
- (id)initWithBackingStoreHandler:(id)a0 messageHandler:(id)a1 metricsEventDispatcher:(id)a2 targetDevice:(char)a3 dataSource:(id)a4 delegate:(id)a5;
- (id)initWithData:(id)a0 backingStore:(id)a1 messageDispatcher:(id)a2 notificationCenter:(id)a3 logEventSubmitter:(id)a4 dailyScheduler:(id)a5 targetDevice:(char)a6 dataSource:(id)a7 delegate:(id)a8;
