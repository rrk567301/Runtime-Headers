...
+ (id)auditAllowedAccessToRestrictedGuest:(id)a0 forAccessories:(id)a1 shouldRemoveScheduledOperations:(char)a2 parentFlow:(id)a3;
+ (id)auditProhibitedAccessToRestrictedGuest:(id)a0 forAccessories:(id)a1 shouldRemoveScheduledOperations:(char)a2 parentFlow:(id)a3;
...
+ (char)checkAndRaiseFaultIfHH2KeyIsMissing;
+ (char)didAuditTimeExpiredOnThisAccessory:(id)a0;
+ (char)didAuditTimeExpiredOnThisAirPlayAccessory:(id)a0;
...
+ (char)shouldWeAuditFromLastAudit:(id)a0;
