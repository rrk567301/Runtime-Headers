...
@interface HMDRapportMessaging : HMFObject <HMFLogging> {
    ...
    id /* block */ _bleRequestHandler;
    NSMutableArray *_bleRequestQueue;
...
- (void)_handleBleRequest:(id)a0 options:(id)a1 responseHandler:(id /* block */)a2;
...
- (void)_queueBLERequest:(id)a0 options:(id)a1 responseHandler:(id /* block */)a2;
...
- (void)_updateDevice:(id)a0 reachable:(char)a1;
- (void)configureDiscoveryClientWithCompletion:(id /* block */)a0;
- (id)initWithClientFactory:(id)a0;
- (char)isRapportDeviceDiscoveredWithIdentifier:(id)a0;
- (void)registerBLERequestHandler:(id /* block */)a0;
