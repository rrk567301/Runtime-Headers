...
@property (readonly, nonatomic) char uploadImmediately;
...
- (id)initWithThreshold:(long long)a0 windowSize:(long long)a1 counterName:(id)a2 uploadImmediately:(char)a3 ewsLogger:(id)a4;
- (id)initWithThreshold:(long long)a0 windowSize:(long long)a1 counterName:(id)a2 uploadImmediately:(char)a3 ewsLogger:(id)a4 timeSourceBlock:(id /* block */)a5;
