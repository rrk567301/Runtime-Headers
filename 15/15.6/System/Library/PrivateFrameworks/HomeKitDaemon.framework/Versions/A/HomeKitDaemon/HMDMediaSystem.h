...
+ (id)initalizeDataWithIdentifier:(id)a0 parentIdentifier:(id)a1 name:(id)a2 defaultName:(char)a3 components:(id)a4;
...
- (char)componentsSupportsHomeLevelLocationServiceSetting;
