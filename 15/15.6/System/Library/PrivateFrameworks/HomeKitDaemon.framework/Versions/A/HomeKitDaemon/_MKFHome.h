...
- (id)materializeOrCreateServiceGroupsRelationWithModelID:(id)a0 createdNew:(char *)a1;
...
- (id)materializeOrCreateAccessoriesRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateAccessoriesRelationOfTypeAirPlayAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateAccessoriesRelationOfTypeAppleMediaAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateAccessoriesRelationOfTypeHAPAccessoryWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateActionSetsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateApplicationDataRelation:(char *)a0;
- (id)materializeOrCreateGuestAccessCodesRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateGuestsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateInvitationsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateMatterControllerLocalKeyValuePairsRelationWithKey:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateNetworkProtectionGroupsRelation:(char *)a0;
- (id)materializeOrCreatePersonsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateRemovedAccessCodesRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateResidentSelectionsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateResidentsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateRoomsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateSettingsRelationOfTypeHomeMediaSetting:(char *)a0;
- (id)materializeOrCreateSettingsRelationOfTypeHomeNetworkRouterManagingDeviceSetting:(char *)a0;
- (id)materializeOrCreateSettingsRelationOfTypeHomeNetworkRouterSetting:(char *)a0;
- (id)materializeOrCreateSettingsRelationOfTypeHomePersonManagerSetting:(char *)a0;
- (id)materializeOrCreateSettingsRelationOfTypeHomeSoftwareUpdateSetting:(char *)a0;
- (id)materializeOrCreateThreadNetworkRelation:(char *)a0;
- (id)materializeOrCreateTriggersRelationOfType:(id)a0 modelID:(id)a1 createdNew:(char *)a2;
- (id)materializeOrCreateTriggersRelationOfTypeEventTriggerWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateTriggersRelationOfTypeTimerTriggerWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateUsersRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateZonesRelationWithModelID:(id)a0 createdNew:(char *)a1;
...
- (char)residentSyncClientDidSync;
