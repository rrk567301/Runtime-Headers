...
@property (nonatomic) char beingConfigured;
...
@property (readonly, nonatomic, getter=isCurrentLocationSimulated) char currentLocationSimulated;
...
- (void)beingConfigured:(char)a0 completionHandler:(id /* block */)a1;
