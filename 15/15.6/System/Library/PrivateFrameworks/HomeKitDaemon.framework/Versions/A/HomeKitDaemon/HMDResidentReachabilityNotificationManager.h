...
@property (readonly) char hasReachableResidents;
@property (readonly) char anyEnabledResidentSupportsReachabilityNotifications;
@property (readonly) char hasMultipleResidents;
...
@property (nonatomic) char isUserPreferredReachable;
...
- (void)_evaluateReachabilityBulletinAndPostponeUnreachableBulletin:(char)a0;
...
- (char)shouldPostUserPreferredReachableNotification;
- (char)shouldPostUserPreferredUnreachableNotification;
