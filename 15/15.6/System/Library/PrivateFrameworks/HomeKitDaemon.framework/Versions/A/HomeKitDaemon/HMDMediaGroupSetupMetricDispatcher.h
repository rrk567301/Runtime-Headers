...
- (id)setupLatencyLogEvent:(unsigned long long)a0 groupIdentifier:(id)a1 isController:(char)a2 isPrimaryResident:(char)a3 totalDuration:(unsigned long long)a4 setupSessionIdentifier:(id)a5 setupRequestOption:(unsigned long long)a6 totalDurationSinceSetupSessionStart:(unsigned long long)a7 errorStage:(id)a8;
