...
- (void)_cancelSessionWithIdentifier:(id)a0 reason:(unsigned short)a1 hadReceivedEof:(char)a2;
- (void)_closeAllSessionsWithError:(id)a0;
- (id)_createSessionCandidateWithRequestHeader:(id)a0 metadata:(id)a1;
...
- (void)_maybeSubmitMetricForDroppedOpenRequestOfType:(id)a0;
- (void)_notifyActiveStatusChangedFromPreviousValue:(char)a0;
- (void)_openSessionForFileType:(id)a0 reason:(id)a1 metadata:(id)a2 queue:(id)a3 callback:(id /* block */)a4;
...
- (void)_sendOpenResponseWithRequestHeader:(id)a0 payload:(id)a1 status:(unsigned short)a2;
...
- (void)asyncBulkSendSessionDidCancelSessionWithIdentifier:(id)a0 reason:(unsigned short)a1 hadReceivedEof:(char)a2;
...
- (void)openSessionForFileType:(id)a0 reason:(id)a1 metadata:(id)a2 queue:(id)a3 callback:(id /* block */)a4;
