...
@property (readonly, nonatomic) char isCachedEvent;
...
- (void).cxx_destruct;
- (id)initWithTopic:(id)a0 sourceDeviceType:(unsigned long long)a1 destinationDeviceType:(unsigned long long)a2 isCachedEvent:(char)a3 responseMessageType:(unsigned long long)a4;
