@class NSUUID, NSString, HMDMediaSessionState, NSArray, HMFTimer, NSMutableArray, NSObject, NSMutableSet, HMDMediaEndpoint;
...
@property (nonatomic, getter=isCurrentAccessorySession) char currentAccessorySession;
...
- (void)_registerForSessionUpdates:(char)a0;
...
- (void)registerForSessionUpdates:(char)a0;
