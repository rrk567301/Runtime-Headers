...
@property (nonatomic) char iCloudAvailable_INT;
@property (nonatomic) char IDSAvailable_INT;
@property (nonatomic) long long IDSRegistrationStatus_INT;
@property (nonatomic) long long IDSRegistrationError_INT;
@property (nonatomic) char manateeAvailable_INT;
@property (nonatomic) char networkAvailable_INT;
@property (nonatomic) char controllerInHH2_INT;
@property (nonatomic) char controllerHasSentinelZone_INT;
...
@property (nonatomic) char currentDeviceConfirmedPrimaryResident_INT;
