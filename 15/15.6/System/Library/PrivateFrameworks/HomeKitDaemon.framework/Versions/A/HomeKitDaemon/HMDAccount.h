...
@property (readonly, getter=isCurrentAccount) char currentAccount;
...
@property (readonly, nonatomic, getter=isPresentInContacts) char presentInContacts;
