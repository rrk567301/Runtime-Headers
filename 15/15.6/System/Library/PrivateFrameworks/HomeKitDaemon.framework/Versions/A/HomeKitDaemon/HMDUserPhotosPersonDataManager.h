...
@property (readonly) char supportsFaceClassification;
...
+ (id)logCategory;
+ (id)settingsModelFromSharedUserDataRoot:(id)a0;
...
- (id)initWithUser:(id)a0 messageDispatcher:(id)a1 backingStoreContext:(id)a2 cloudTransform:(id)a3 workQueue:(id)a4 supportsFaceClassification:(char)a5 notificationCenter:(id)a6 cloudPhotosSettingObserver:(id)a7;
- (id)initWithUser:(id)a0 messageDispatcher:(id)a1 backingStoreContext:(id)a2 workQueue:(id)a3;
...
- (void)removeCloudDataForZoneUUID:(id)a0 isDueToHomeGraphObjectRemoval:(char)a1;
- (id)settingsModelUUID;
- (char)shouldUseUserModelForSettings;
