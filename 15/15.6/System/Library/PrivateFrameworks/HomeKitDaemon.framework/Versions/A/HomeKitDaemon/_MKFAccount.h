@class NSUUID, NSString, NSDate, HMDAccountIdentifier, NSSet, NSArray, Protocol, _MKFHomeManager, NSNumber, MKFAccountDatabaseID;
...
- (id)castIfAccount;
- (id)materializeOrCreateDevicesRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateHandlesRelationWithModelID:(id)a0 createdNew:(char *)a1;
