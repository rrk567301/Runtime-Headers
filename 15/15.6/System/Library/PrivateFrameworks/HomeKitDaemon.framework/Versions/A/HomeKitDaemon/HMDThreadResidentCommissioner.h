...
- (void).cxx_destruct;
- (id)initInternal;
- (char)_overrideThreadOperationTimeout;
...
- (void)_informThreadLayerOfResidentChange:(char)a0 primaryResidentIsThreadCapable:(char)a1;
- (unsigned long long)_numPendingOperations;
- (void)_scheduleThreadOperation:(id)a0;
- (void)_setThreadOperationInProgress:(char)a0;
- (void)_startThreadAccessoryFirmwareUpdateWithExtendedMACAddress:(id)a0 isWedDevice:(char)a1 completion:(id /* block */)a2;
- (void)_startThreadAccessoryPairingWithExtendedMACAddress:(id)a0 isWedDevice:(char)a1 completion:(id /* block */)a2;
- (void)_startThreadNetworkWithID:(id)a0 completion:(id /* block */)a1;
- (void)_startThreadNetworkWithOperationalDataset:(id)a0 threadNetworkID:(id)a1 isOwnerUser:(char)a2 completion:(id /* block */)a3;
...
- (void)informThreadLayerOfResidentChange:(char)a0 primaryResidentIsThreadCapable:(char)a1;
- (id)initWithThreadRadioClient:(id)a0;
- (char)isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled;
- (void)setGeoAvailable:(char)a0;
- (void)startThreadAccessoryFirmwareUpdateWithExtendedMACAddress:(id)a0 isWedDevice:(char)a1 completion:(id /* block */)a2;
- (void)startThreadAccessoryPairingWithExtendedMACAddress:(id)a0 isWedDevice:(char)a1 completion:(id /* block */)a2;
- (void)startThreadNetworkWithID:(id)a0 completion:(id /* block */)a1;
- (void)startThreadNetworkWithOperationalDataset:(id)a0 threadNetworkID:(id)a1 isOwnerUser:(char)a2 completion:(id /* block */)a3;
