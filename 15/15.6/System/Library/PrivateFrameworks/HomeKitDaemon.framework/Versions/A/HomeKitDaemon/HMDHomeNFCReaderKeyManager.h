@class NSUUID, NAFuture, HMDHomeWalletKeyAccessoryManager, NSString, NSError, HMFMessageDispatcher, HMDDevice, NSMutableSet, NSObject, HMFFlow, HMDHome;
...
@property (class, nonatomic, readonly) double ckTimeout;
...
- (void)createReaderKeyInKeychainForHome:(id)a0 isForceUpdate:(char)a1 flow:(id)a2;
- (void)createReaderKeyKeychainItemForHome:(id)a0 isForceUpdate:(char)a1 flow:(id)a2 completion:(id /* block */)a3;
- (void)deleteKeychainItemForNFCReaderKeyIsForceUpdate:(char)a0 withFlow:(id)a1 completion:(id /* block */)a2;
- (id)fetchOrCreateReaderKeyForPairingWithFlow:(id)a0;
- (void)fetchOrCreateReaderKeyOnQueueWithRequiresPrivateKey:(char)a0 flow:(id)a1 completion:(id /* block */)a2;
- (void)fetchOrCreateReaderKeyWithRequiresPrivateKey:(char)a0 flow:(id)a1 completion:(id /* block */)a2;
...
- (void)pullFromKeychainWithFlow:(HMFFlow *)a0 completionHandler:(void (^)(NSError *))a1;
