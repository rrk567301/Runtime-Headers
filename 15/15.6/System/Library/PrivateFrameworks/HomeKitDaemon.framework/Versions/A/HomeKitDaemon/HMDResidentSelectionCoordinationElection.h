...
- (void)configureAsAResidentWithRunPrimaryEvaluation:(char)a0;
...
- (void)performSelectionWithPreferredPrimaryResident:(id)a0 requireAutoUpdate:(char)a1 reason:(unsigned long long)a2 completion:(id /* block */)a3;
