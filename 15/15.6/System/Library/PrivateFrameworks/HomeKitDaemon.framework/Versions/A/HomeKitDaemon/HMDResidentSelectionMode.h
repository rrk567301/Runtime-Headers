...
- (char)_isViableUserPreferredResident:(id)a0;
...
- (char)_allResidentsHaveSameLocationStatus:(unsigned long long)a0;
- (char)_currentDevicePreferredResidentsListIsPublished;
...
- (char)_preferredResidentsListFromElectorUpdated;
...
- (char)_shouldTakeOverBasedOnReachability;
...
- (char)_updateLocalPreferredResidentsList;
- (char)allResidentsAboveMeAreUnreachableIn:(id)a0;
...
- (char)hasViablePrimaryResidentWithSelectionInfo:(id)a0;
...
- (char)newPrimaryIsInREv2BasedOnTheirTimestamp:(id)a0 ourSelectionInfo:(id)a1;
...
- (void)selectPrimaryResidentFromResidents:(id)a0 requireAutoUpdate:(char)a1 completion:(id /* block */)a2;
- (void)sendSelectionMessageToResident:(id)a0 requireAutoUpdate:(char)a1 completion:(id /* block */)a2;
- (char)shouldRegeneratePreferredResidentsListBasedOnFoundResidents:(id)a0 residentLocationMap:(id)a1;
- (char)shouldTakeOverAsTheCurrentPrimaryWithSelectionInfo:(id)a0 isTimerTriggered:(char)a1;
- (char)takeOverIfConditionsAreMetWithIsTimerTriggered:(char)a0;
- (char)takeOverIfPrimaryIsNotViableWithIsTimerTriggered:(char)a0;
