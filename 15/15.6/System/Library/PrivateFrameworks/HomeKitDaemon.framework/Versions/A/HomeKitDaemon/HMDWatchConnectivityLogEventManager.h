...
@property (nonatomic) char hasCompleteReport;
...
- (struct HMDWatchConnectivityLogEventManagerSnapshot { char x0; unsigned long long x1; unsigned long long x2; })currentWatchConnectivitySnapshot;
