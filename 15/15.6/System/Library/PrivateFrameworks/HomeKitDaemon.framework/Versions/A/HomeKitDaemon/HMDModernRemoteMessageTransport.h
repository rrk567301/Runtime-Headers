...
@property (nonatomic, getter=isRapportLinkSlow) char rapportLinkSlow;
@property (readonly, nonatomic) char isWatch;
@property (nonatomic) char isHMModernMessagingInstance;
@property (nonatomic) char isHMModernMessagingEnergyInstance;
...
- (id)initWithAccountRegistry:(id)a0 rapportTransport:(id)a1 idsTransport:(id)a2 bleTransport:(id)a3 contextManager:(id)a4 systemDateProvider:(id)a5 idsDateProvider:(id)a6 timerProvider:(id)a7 isWatch:(char)a8 featuresDataSource:(id)a9;
- (id)startHMMM;
- (void)transport:(id)a0 idsIdentifier:(id)a1 didAppearReachable:(char)a2;
