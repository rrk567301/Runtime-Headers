...
- (void).cxx_destruct;
- (char)evaluateHouseholdActivityLogEventForSubmission:(id)a0;
- (char)evaluateMetricResponsesForSubmission:(id)a0;
...
- (void)runHouseholdMetricsDataCollectionAssociatedToDate:(id)a0 forceSubmit:(char)a1;
