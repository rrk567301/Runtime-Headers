@class NSString, NSDictionary, NSUUID, HMDEventCountersManager;
...
@property char cloudSyncLastDecryptionFailed;
@property char cloudSyncMaximumDelayReached;
...
@property unsigned long long residentSelectionPrimaryResidentChangedCount;
@property char v2ElectionCurrentDeviceInSecondaryCoordinationMesh;
