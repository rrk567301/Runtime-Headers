...
- (id)_untrustedInvitationContextForUser:(id)a0 shouldGrantWriteAccess:(char)a1;
- (id)fetchInvitationContextForUser:(id)a0 shouldGrantWriteAccess:(char)a1;
- (id)fetchInvitationToUser:(id)a0 shouldGrantWriteAccess:(char)a1;
...
- (char)isAcceptedParticipatingUser:(id)a0;
