...
@property (nonatomic, getter=isRapportIdentitiesChangedNotificationTokenValid) char rapportIdentitiesChangedNotificationTokenValid;
...
@property (readonly, nonatomic) char didProcessAccountSignOut;
@property (readonly, nonatomic) id<HMDIDSService> service;
@property (readonly, nonatomic) HMDIDSActivityMonitorBroadcaster *activityBroadcaster;
@property (retain) HMDAccount *account;
@property (readonly, nonatomic) HMFPromise *deviceAccountSettledPromise;
...
@property (readonly, getter=isLoggedInToPrimaryAccount) char loggedIn;
...
- (char)isModelCurrentAccount:(id)a0;
