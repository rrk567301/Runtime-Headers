...
- (id)hmd_modelsWithChangeType:(unsigned long long)a0 detached:(char)a1 error:(id *)a2;
- (id)materializeOrCreateAccountsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateHomesRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateIncomingInvitationsRelationWithModelID:(id)a0 createdNew:(char *)a1;
- (id)materializeOrCreateMetadataRelation:(char *)a0;
