...
@property (nonatomic) char curReport_threadNetworkUp;
...
@property (readonly, nonatomic) char dailyReportingRegistered;
...
- (id)logEventForHomeWithUUID:(id)a0 associatedWithDate:(id)a1 isDailySummary:(char)a2;
