...
@property (readonly) char isRepairSession;
...
@property (readonly) char accessoryInDefaultRoom;
@property (readonly) long long selectedHomeLocationStatus;
@property (readonly) char isUserAtOtherOwnedHome;
