...
- (char)_evaluateWithHomePresence:(id)a0 presenceType:(id)a1 users:(id)a2;
...
- (char)compatibleWithUser:(id)a0;
- (void)configure:(id)a0 messageDispatcher:(id)a1 queue:(id)a2 delegate:(id)a3;
- (id)createClientPayload;
- (id)createDaemonPayload;
- (id)createPresenceEventPayload:(char)a0;
- (void)didEndExecutionSession:(id)a0;
- (id)emptyModelObject;
- (char)evaluateWithHomePresence:(id)a0;
- (char)evaluateWithHomePresenceUpdate:(id)a0 presenceType:(id)a1;
- (char)evaluateWithUserPresence:(id)a0 presenceType:(id)a1;
