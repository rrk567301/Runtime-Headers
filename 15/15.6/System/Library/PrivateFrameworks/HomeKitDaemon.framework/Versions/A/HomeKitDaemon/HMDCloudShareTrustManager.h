...
@property (readonly, getter=isOwnedTrust) char ownedTrust;
...
- (char)canUseUntrustedAccountHandlesForParticipantManager:(id)a0;
...
- (id)initWithDatabase:(id)a0 isOwnedTrust:(char)a1 queue:(id)a2 shareMessenger:(id)a3 ownerCloudShareID:(id)a4 logEventSubmitter:(id)a5 dailyScheduler:(id)a6;
- (char)isFromOwner;
- (char)isFromOwnerForCloudShareTrustManagerMetricsEventDispatcher:(id)a0;
- (char)isTrustConfigured;
