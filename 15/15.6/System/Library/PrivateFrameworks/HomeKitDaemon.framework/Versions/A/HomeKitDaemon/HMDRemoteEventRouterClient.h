...
@property (nonatomic) char isNetworkAvailable;
...
@property (readonly) char isPrimaryResident;
...
- (void)configureIsPrimaryResident:(char)a0 networkAvailable:(char)a1 additionalPolicies:(id)a2;
...
- (void)client:(id)a0 fetchWithFilters:(id)a1 isMultiHop:(char)a2 completion:(id /* block */)a3;
- (id)client:(id)a0 forwardingTopicsForTopics:(id)a1;
- (char)client:(id)a0 isConnectionTerminatingError:(id)a1;
...
- (void)didChangeFetchAvailableCondition:(char)a0;
- (void)didChangeHasForegroundClient:(char)a0;
...
- (void)networkAvailabilityDidChange:(char)a0;
