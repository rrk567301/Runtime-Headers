@class NSMutableDictionary, NSDictionary, HMFMessageDispatcher, NSObject, NSMutableArray, HMDSnapshotRequestHandler, NSString, HMDSnapshotCacheRequestHandler, HMDHAPAccessory, HMDCameraStreamSnapshotHandler, HMDSnapshotLocalSession, HMFNetMonitor, HMDSnapshotSlotManager, HMDCameraSnapshotMonitorEvents, HMDCameraResidentMessageHandler, NSUUID;
...
- (void)streamSnapshotHandler:(id)a0 didChangeStreamSetupInProgress:(char)a1;
