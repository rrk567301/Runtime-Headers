...
+ (id)archiveDictionary:(id)a0 permittedClasses:(id)a1 strict:(char)a2 error:(id *)a3;
+ (id)unarchiveDictionaryFromData:(id)a0 error:(id *)a1;
+ (id)unarchiveDictionaryFromData:(id)a0 permittedClasses:(id)a1 error:(id *)a2;
+ (id)unarchiveDictionaryFromData:(id)a0 permittedClasses:(id)a1 strict:(char)a2 error:(id *)a3;
