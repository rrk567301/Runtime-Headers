...
+ (char)birthdayIsYearless:(id)a0;
+ (char)isCalendarIslamic:(id)a0;
+ (id)reputationForHandle:(id)a0 inStore:(id)a1;
+ (char)shouldPermitOrganizerEmailFromJunkChecks:(id)a0 inReputationStore:(id)a1;
+ (char)shouldPermitOrganizerPhoneNumberFromJunkChecks:(id)a0 inReputationStore:(id)a1;
...
- (char)contactAccessResolved;
- (char)contactIdentifierIsMe:(id)a0;
...
- (char)matchesOneOfMyEmails:(id)a0;
- (char)matchesOneOfMyPhoneNumbers:(id)a0;
...
- (id)unifiedMeContact;
- (char)urlMatchesOneOfMyEmails:(id)a0;
