...
+ (char)_line:(id)a0 matchesRegex:(id)a1 outFoundRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
...
- (char)supportsSerializingConferenceWithSource:(unsigned long long)a0;
