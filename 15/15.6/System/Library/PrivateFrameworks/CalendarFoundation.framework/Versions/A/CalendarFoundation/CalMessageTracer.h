...
+ (void)log:(id)a0 domain:(id)a1 signature:(id)a2 summarize:(char)a3;
...
+ (void)log:(id)a0 domain:(id)a1 signature:(id)a2 result:(int)a3 value:(id)a4 summarize:(char)a5;
...
+ (void)log:(id)a0 domain:(id)a1 signature:(id)a2 signature2:(id)a3 result:(int)a4 value:(id)a5 value2:(id)a6 value3:(id)a7 uid:(id)a8 uid2:(id)a9 wakeState:(id)a10 summarize:(char)a11;
+ (void)log:(id)a0 domain:(id)a1 signature:(id)a2 signature2:(id)a3 summarize:(char)a4;
+ (void)log:(id)a0 domain:(id)a1 summarize:(char)a2;
...
+ (void)traceWithDomain:(id)a0 signature:(id)a1 signature2:(id)a2 summarize:(char)a3;
+ (void)traceWithDomain:(id)a0 signature:(id)a1 summarize:(char)a2;
+ (void)traceWithDomain:(id)a0 value:(id)a1 summarize:(char)a2;
