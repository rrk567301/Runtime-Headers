...
@property (nonatomic) char runningUnitTests;
...
+ (char)accountIsDuplicate:(id)a0 inStore:(id)a1;
...
- (id)accountWithIdentifier:(id)a0 returnCachedVersion:(char)a1;
...
- (char)_bundleIDSupportsDataclassCalendars:(id)a0;
- (char)_bundleIDSupportsDataclassReminders:(id)a0;
- (id)_mainBundleID;
- (id)_providerForCalDAVAccount:(id)a0;
- (id)_supportedDataclassesForBundleID:(id)a0;
- (id)_supportedDataclassesForMainBundleID;
- (char)account:(id)a0 hasServerURL:(id)a1;
- (char)accountIsDuplicate:(id)a0;
- (id)accountsWithAccountTypeIdentifier:(id)a0 error:(id *)a1;
- (id)accountsWithServerURL:(id)a0;
- (id)accountsWithServerURL:(id)a0 username:(id)a1 returnCachedVersions:(char)a2;
...
- (char)removeAccount:(id)a0 withError:(id *)a1;
- (char)renewCredentialsForAccount:(id)a0;
- (char)renewCredentialsForAccount:(id)a0 forceRenewal:(char)a1;
- (void)renewCredentialsForAccount:(id)a0 forceRenewal:(char)a1 withCompletionHandler:(id /* block */)a2;
- (void)saveAccount:(id)a0 verify:(char)a1 withCompletionHandler:(id /* block */)a2;
- (char)saveAccount:(id)a0 verify:(char)a1 withError:(id *)a2;
- (char)saveAccount:(id)a0 withError:(id *)a1;
