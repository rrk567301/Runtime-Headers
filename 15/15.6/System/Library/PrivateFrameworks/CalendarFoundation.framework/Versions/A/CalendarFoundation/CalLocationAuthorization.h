...
@interface CalLocationAuthorization : NSObject <CLLocationManagerDelegate> {
    ...
    char _failedToInitializePrecision;
}
...
+ (id)authorizationForBundleIdentifier:(id)a0 bundle:(id)a1 createIfNecessary:(char)a2;
...
+ (char)preciseLocationAuthorizedForBundleIdentifier:(id)a0 bundle:(id)a1;
