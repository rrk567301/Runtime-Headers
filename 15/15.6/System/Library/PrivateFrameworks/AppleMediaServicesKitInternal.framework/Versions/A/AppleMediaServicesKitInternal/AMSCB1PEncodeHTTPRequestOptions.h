...
@interface AMSCB1PEncodeHTTPRequestOptions : NSObject {
    ...
    char _shouldAlwaysAddCacheBuster;
    char _shouldAlwaysSendDeviceGUID;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithURL:(id)a0 account:(id)a1 shouldAlwaysAddCacheBuster:(char)a2 anisetteType:(unsigned long long)a3 body:(id)a4 bodyEncoding:(unsigned long long)a5 cachePolicyHeader:(id)a6 headers:(id)a7 mescalType:(unsigned long long)a8 method:(unsigned long long)a9 shouldAlwaysSendDeviceGUID:(char)a10 bag:(id)a11 bundleInfo:(id)a12;
