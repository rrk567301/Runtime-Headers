...
- (id)resourceForKey:(id)a0 exclusive:(char)a1;
- (id)resourcesForKeys:(id)a0 exclusive:(char)a1;
- (void)stopWaiting:(id)a0;
- (unsigned long long)unregisterResourceForKey:(id)a0;
- (id)waitForResourcesForKeys:(id)a0 exclusive:(char)a1 delegateQueue:(id)a2 completionBlock:(id /* block */)a3;
