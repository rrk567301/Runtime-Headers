...
- (void)dataMessageQueue:(id)a0 needsToSendContents:(id)a1 shouldSkipTheLine:(char)a2 completion:(id /* block */)a3;
...
- (void)keepAliveTimerDidFire:(id)a0 fireCount:(unsigned long long)a1 isFinalFire:(char)a2;
...
- (void)tearDownWithError:(id)a0 shouldReportToRemote:(char)a1;
