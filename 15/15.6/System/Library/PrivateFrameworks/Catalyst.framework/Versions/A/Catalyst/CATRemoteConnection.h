...
- (void)delegateDidReceiveStreamData:(id)a0 moreComing:(char)a1;
...
- (void)messageParser:(id)a0 didParseResponseData:(id)a1 moreComing:(char)a2;
- (void)secureUsingClientIdentity:(struct __SecIdentity { } *)a0 trustedCertificates:(id)a1;
- (char)secureUsingIdentity:(struct __SecIdentity { } *)a0 trustedCertificates:(id)a1 isServer:(char)a2;
...
- (void)trustDecisionDidRespondWithDecisionToAllowUntrustedConnection:(char)a0;
- (void)tryEvaluatingPeerTrustWithStream:(id)a0;
- (char)trySendingDataWithContext:(id)a0 error:(id *)a1;
