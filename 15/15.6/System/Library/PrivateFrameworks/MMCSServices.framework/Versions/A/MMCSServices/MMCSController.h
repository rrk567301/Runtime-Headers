...
+ (id)parseContentHeaderAsDictionary:(id)a0 treatValuesAsArrays:(char)a1;
+ (void)preMMCSWarm;
...
- (char)_getTransfers:(id)a0 requestURL:(id)a1 requestorID:(id)a2 sourceAppID:(id)a3 token:(id)a4 error:(id *)a5;
- (void)_handleRegistrationForMMCSPutFile:(id)a0 preauthenticate:(char)a1 completionBlock:(id /* block */)a2;
...
- (char)_putTransfers:(id)a0 requestURL:(id)a1 requestorID:(id)a2 transferID:(id)a3 sourceAppID:(id)a4 token:(id)a5 error:(id *)a6;
- (void)_registerFiles:(id)a0 preauthenticate:(char)a1 completionBlock:(id /* block */)a2;
- (void)_registerTransfers:(id)a0 preauthenticate:(char)a1 completionBlock:(id /* block */)a2;
...
- (char)_unregisterTransfers:(id)a0;
...
- (void)putFiles:(id)a0 requestURL:(id)a1 requestorID:(id)a2 transferID:(id)a3 sourceAppID:(id)a4 authToken:(id)a5 preauthenticate:(char)a6 completionBlock:(id /* block */)a7;
- (void)registerFilesForDownload:(id)a0 completionBlock:(id /* block */)a1;
- (void)registerFilesForUpload:(id)a0 withPreauthentication:(char)a1 completionBlock:(id /* block */)a2;
- (char)unregisterFiles:(id)a0;
