...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ underMaintenance;
@property (nonatomic, readonly) void /* unknown type, empty encoding */ informationCard;
