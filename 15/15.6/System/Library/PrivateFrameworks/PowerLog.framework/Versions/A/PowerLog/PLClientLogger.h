...
@property char talkToPowerlogHelper;
@property char batchedTimerInFlight;
@property char forceBatching;
@property char batchDropMessages;
...
+ (id)sharedInstance;
+ (char)isMessageOnDeviceDisabled;
