...
- (id)init;
- (void).cxx_destruct;
- (char)_aggregateForClientID:(id)a0 eventName:(id)a1 eventDictionary:(id)a2 configuration:(id)a3;
- (id)_eventAggregate:(id)a0 eventName:(id)a1 aggregateKey:(id)a2 valueLabel:(id)a3;
- (void)_flushToPowerLog;
- (char)_isEventInputValid:(id)a0 configuration:(id)a1;
- (void)_scheduleFlushTimer;
- (char)_setEventAggregate:(id)a0 eventName:(id)a1 aggregateKey:(id)a2 valueLabel:(id)a3 value:(id)a4;
- (char)aggregateForClientID_async:(short)a0 eventName:(id)a1 eventDictionary:(id)a2 configuration:(id)a3;
- (void)cleanCache;
