...
- (char)deleteWithAssetKey:(id)a0 scope:(long long)a1 persona:(id)a2 error:(id *)a3;
- (char)hasAssetForAssetKey:(id)a0 scope:(long long)a1 persona:(id)a2;
- (char)storeACMEIdentityWithDirectoryURL:(id)a0 clientIdentifier:(id)a1 keySize:(unsigned long long)a2 keyType:(id)a3 hardwareBound:(char)a4 subject:(id)a5 subjectAltName:(id)a6 usageFlags:(unsigned long long)a7 extendedKeyUsage:(id)a8 attest:(char)a9 isUserEnrollment:(char)a10 assetKey:(id)a11 scope:(long long)a12 persona:(id)a13 error:(id *)a14;
- (char)storeSCEPIdentityWithUrl:(id)a0 caInstanceName:(id)a1 caFingerprint:(id)a2 caCapabilities:(id)a3 challenge:(id)a4 subject:(id)a5 keySize:(unsigned long long)a6 usageFlags:(unsigned long long)a7 subjectAltName:(id)a8 retries:(unsigned long long)a9 retryDelay:(unsigned int)a10 assetKey:(id)a11 scope:(long long)a12 persona:(id)a13 error:(id *)a14;
- (char)storeWithDerData:(id)a0 assetKey:(id)a1 scope:(long long)a2 persona:(id)a3 error:(id *)a4;
- (char)storeWithPassword:(id)a0 userName:(id)a1 assetKey:(id)a2 scope:(long long)a3 persona:(id)a4 error:(id *)a5;
- (char)storeWithPemData:(id)a0 assetKey:(id)a1 scope:(long long)a2 persona:(id)a3 error:(id *)a4;
- (char)storeWithPkcs12Data:(id)a0 password:(id)a1 assetKey:(id)a2 scope:(long long)a3 persona:(id)a4 error:(id *)a5;
- (char)unassignAllAssetsFromConfigurationKey:(id)a0 scope:(long long)a1 persona:(id)a2 error:(id *)a3;
