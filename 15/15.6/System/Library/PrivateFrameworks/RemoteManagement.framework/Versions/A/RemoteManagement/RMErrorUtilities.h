...
+ (id)_populateDescriptionInUserInfo:(id)a0 descriptionKey:(id)a1 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
+ (id)convertSwiftError:(id)a0;
+ (char)convertSwiftErrorReference:(id *)a0;
...
+ (id)createAssetTypeInvalidError:(id)a0;
...
+ (id)createInternalErrorWithDescription:(id)a0;
...
+ (id)createProfileCannotBeInstalledBySource:(id)a0 source:(id)a1;
+ (id)createProfileCannotFindRemoveProfile:(id)a0;
+ (id)createProfileCannotRemoveOtherProfile:(id)a0;
+ (id)createProfileCannotReplaceOtherProfile:(id)a0;
+ (id)createProfileInvalidErrorWithUnderlyingError:(id)a0;
+ (id)createProfilePayloadInvalidKey:(id)a0 key:(id)a1;
+ (id)createProfilePayloadInvalidKeyItems:(id)a0 key:(id)a1;
+ (id)createProfilePayloadMissingKey:(id)a0 key:(id)a1;
