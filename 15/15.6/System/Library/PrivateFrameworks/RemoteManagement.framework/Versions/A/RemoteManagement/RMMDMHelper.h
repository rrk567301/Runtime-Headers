...
+ (char)_unenrollDDMChannelWithController:(id)a0 enrollmentURL:(id)a1 enrollmentType:(long long)a2 error:(id *)a3;
+ (id)enrollmentURLForProfileIdentifier:(id)a0;
+ (char)isActiveForScope:(long long)a0;
+ (char)processDeclarativeManagementCommandWithProfileIdentifier:(id)a0 enrollmentType:(long long)a1 scope:(long long)a2 username:(id)a3 personaID:(id)a4 request:(id)a5 error:(id *)a6;
+ (void)setActive:(char)a0 scope:(long long)a1;
+ (char)unenrollWithProfileIdentifier:(id)a0 enrollmentType:(long long)a1 scope:(long long)a2 error:(id *)a3;
