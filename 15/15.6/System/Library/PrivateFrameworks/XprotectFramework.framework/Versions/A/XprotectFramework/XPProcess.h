...
@property (readonly, nonatomic) char notarized;
...
- (id)initWithPath:(id)a0 withCdhash:(id)a1 withSigningID:(id)a2 withTeamID:(id)a3 withSHA256Sum:(id)a4 withNotarization:(char)a5;
- (id)initWithURL:(id)a0 withCdhash:(id)a1 withSigningID:(id)a2 withTeamID:(id)a3 withSHA256Sum:(id)a4 withNotarization:(char)a5;
