...
@interface SWSystemSleepMonitor : NSObject <SWSystemSleepMonitorProvidingDelegate, SWActiveSystemActivityRegistryObserving, BSInvalidatable> {
    ...
    char _lock_systemActivitiesAreActive;
    char _allowsInvalidation;
}
...
- (id)initWithIdentifier:(id)a0 queue:(id)a1 allowsInvalidation:(char)a2 monitorProvider:(id)a3 sleepAssertionProvider:(id)a4 activeSystemActivityRegistry:(id)a5;
