...
@interface CMISmartStyleMetalRendererV1 : NSObject <CMISmartStyleMetalRenderer> {
    ...
    char _shouldUpsampleInputPersonMask;
    char _shouldCreateLTMGainMap;
    NSMutableSet *_texturesToPurge;
    NSDictionary *_hueSatLumLUTTexByCastTypeForVariant;
    char _useFaceBasedGlobalExposureBoostRatio;
}
...
- (int)_createGuideImageForInputTexture:(id)a0 outputGuideTexture:(id)a1 isInputLinear:(char)a2 isOutputLumaGuide:(char)a3;
...
- (id)_newBufferWithLength:(unsigned long long)a0 label:(id)a1 sharedAccess:(char)a2;
...
- (int)_runImageReductionAndUpdateBaseGain:(char)a0;
