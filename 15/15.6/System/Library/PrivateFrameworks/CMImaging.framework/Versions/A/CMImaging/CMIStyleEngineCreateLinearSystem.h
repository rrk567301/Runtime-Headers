...
@property (nonatomic) char targetIsLinear;
...
- (char)_setWeightPlane:(unsigned int)a0 term:(unsigned int)a1 priorScaleFactor:(float)a2;
...
- (char)setConstantPriorScaleFactor:(float)a0 forWeightPlane:(unsigned int)a1;
- (char)setLinearPriorScaleFactor:(float)a0 forWeightPlane:(unsigned int)a1;
- (char)setQuadraticPriorScaleFactor:(float)a0 forWeightPlane:(unsigned int)a1;
