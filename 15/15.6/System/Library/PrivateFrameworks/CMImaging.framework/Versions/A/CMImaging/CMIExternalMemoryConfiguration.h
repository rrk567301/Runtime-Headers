...
@property (readonly, nonatomic) char cmiResourceEnabled;
@property (readonly, nonatomic) NSDictionary *processorSpecificOptions;

- (id)description;
- (void).cxx_destruct;
- (id)initWithMaxInputDimensions:(struct { int x0; int x1; })a0 inputPixelFormat:(unsigned int)a1 maxOutputDimensions:(struct { int x0; int x1; })a2 cmiResourceEnabled:(char)a3 processorSpecificOptions:(id)a4;
