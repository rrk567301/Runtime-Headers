...
@property (nonatomic) char fastCoeffSampling;
...
- (id *)_applyComputePipelineStateWithConstantsIsFast:(char)a0 doManualInputYUVToRGBConversion:(char)a1 doManualOutputRGBToYUVConversion:(char)a2 isWithLumaGrad:(char)a3 doGenerateSyntheticNoise:(char)a4 applyDithering:(char)a5;
