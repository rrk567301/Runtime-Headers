...
@property (nonatomic) char shouldShutdown;
...
- (id)initWithBufferCount:(unsigned long long)a0 coefficientsSynchronization:(char)a1 andOptionalMetalCommandQueue:(id)a2;
