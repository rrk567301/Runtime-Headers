...
@interface FigRegWarpPPGPU : NSObject <CMIRegWarp> {
    ...
    struct { unsigned long long numberOfHistogramEntries; char histogramForAlpha; void /* unknown type, empty encoding */ minPixelValue; void /* unknown type, empty encoding */ maxPixelValue; } _mpsHistCfg;
    ...
    char _skipInitialDownsample;
    unsigned int _ransacMinNumInliers;
    BOOL _allocateBuffersWithAllocator;
    char _performHistEq;
    unsigned char _maxNumberOfPyramidLevels;
    char _useHalfPrecisionCornerResponse;
    char _normalizeCornerResponse;
    char _isShaderHarvesting;
}
