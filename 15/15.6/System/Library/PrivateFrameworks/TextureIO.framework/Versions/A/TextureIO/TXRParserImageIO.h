...
+ (char)exportImage:(id)a0 url:(id)a1 uttype:(struct __CFString { } *)a2 colorSpace:(struct CGColorSpace { } *)a3 orientation:(unsigned char)a4 error:(id *)a5;
+ (char)exportTexture:(id)a0 url:(id)a1 error:(id *)a2;
+ (char)handlesData:(id)a0;
+ (struct CGImage { } *)newCGImageFromImage:(id)a0 colorSpace:(struct CGColorSpace { } *)a1 error:(id *)a2;

- (void).cxx_destruct;
- (char)parseData:(id)a0 bufferAllocator:(id)a1 options:(id)a2 error:(id *)a3;
