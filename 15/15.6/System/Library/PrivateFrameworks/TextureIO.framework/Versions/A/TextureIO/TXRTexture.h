...
@property (readonly, nonatomic) char cubemap;
...
- (id)initWithDimensions:(SEL)a0 pixelFormat:(unsigned long long)a1 alphaInfo:(unsigned long long)a2 mipmapLevelCount:(unsigned long long)a3 arrayLength:(unsigned long long)a4 cubemap:(char)a5 bufferAllocator:(id)a6;
- (void)reformat:(unsigned long long)a0 gammaDegamma:(char)a1 bufferAllocator:(id)a2 error:(id *)a3;
