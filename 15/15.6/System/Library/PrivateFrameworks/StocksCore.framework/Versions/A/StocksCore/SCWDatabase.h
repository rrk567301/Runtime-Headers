...
- (void)_saveZoneToContainer:(id)a0 allowRecoveryAttempt:(char)a1 completion:(id /* block */)a2;
- (void)_saveZonesToContainer:(id)a0 allowRecoveryAttempt:(char)a1 completion:(id /* block */)a2;
...
- (char)t_flushChangesWithTimeout:(double)a0;
