...
@property (nonatomic) char loadedFromDisk;
...
@property (nonatomic) char havePendingChanges;
...
- (char)_reloadIfNeededFromFileURL:(id)a0;
- (void)_saveIfNeededToFileURL:(id)a0;
- (char)flushToDiskWithTimeout:(double)a0;
