@class FCForYouGroupsConfiguration, FCPeopleAlsoReadConfiguration, NSDictionary, FCPaidBundleViaOfferConfig, FCPaidBundleConfiguration, FCIAdConfiguration, NSString, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, FCPrefetchConfiguration, FCTopStoriesConfiguration, FCPuzzlesConfiguration, NSNumber, NSArray, FCVideoGroupsConfig, FCEmbedProxyConfiguration, NTPBDiscoverMoreVideosInfo;
...
@interface StocksCore.NewsCoreConfiguration : NSObject <FCNewsAppConfiguration, FCCoreConfiguration> {
    ...
    void /* unknown type, empty encoding */ paidBundleViaOfferConfiguration;
    void /* unknown type, empty encoding */ lazyPaidBundleConfig;
    void /* unknown type, empty encoding */ lazyPaidBundleViaOfferConfig;
    void /* unknown type, empty encoding */ lazyPersonalizationTreatment;
}

@property (nonatomic, readonly) char isOrderFeedEndpointEnabled;
@property (nonatomic, readonly) char useSecureConnectionForAssets;
@property (nonatomic, readonly) NSString *forYouRecordConfigID;
@property (nonatomic, readonly) char isPrivateDataEncryptionAllowed;
@property (nonatomic, readonly) char isPrivateDataEncryptionMigrationDesired;
@property (nonatomic, readonly) char isPrivateDataMigrationCleanupEnabled;
...
@property (nonatomic, readonly) char foodEnabled;
