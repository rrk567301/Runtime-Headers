...
- (char)_isPrivacyProxyDisabled;
- (char)_isPrivacyProxyRestrictedToOnlyTrackers;
- (char)_isTrackingPreventionDisabled;
- (void)_loadDataAndPopulatePopover;
- (void)_populatePopover;
- (id)_preventedTrackerBodyText;
- (void)_setKnownTrackingDomainsViewHidden:(char)a0;
- (id)_trackerBodyText;
