...
@property (readonly, nonatomic, getter=isRememberThisPasswordCheckboxVisible) char rememberThisPasswordCheckboxVisible;
...
- (void)displaySheet;
- (id)initWithChallenge:(id)a0 rememberThisPasswordCheckboxVisible:(char)a1 completionHandler:(id /* block */)a2;
- (char)isAuthenticationSheetRequest;
