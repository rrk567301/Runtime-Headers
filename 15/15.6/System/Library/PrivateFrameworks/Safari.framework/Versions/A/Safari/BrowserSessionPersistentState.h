...
- (id)initFromCurrentSessionIgnoringPrivateWindows:(char)a0 encryptionProvider:(id)a1;
...
- (void)restoreSessionMinimizingRestoredWindows:(char)a0 completion:(id /* block */)a1;
