...
@property (readonly, nonatomic) char skipScopeEnforcement;
@property (nonatomic, getter=isExtensionNavigation) char extensionNavigation;
...
- (char)_alwaysShowWindowWithDelay;
- (id)_attributedStringForInsecureText:(id)a0;
- (char)_canOpenURLInWebApp:(id)a0 forNavigationType:(long long)a1;
- (void)_handleWebViewAfterRedirect;
- (id)_initWithURL:(id)a0 forExtensionPageContent:(char)a1 webViewConfiguration:(id)a2 windowFeatures:(id)a3;
...
- (id)initWithURL:(id)a0 forExtensionPageContent:(char)a1;
