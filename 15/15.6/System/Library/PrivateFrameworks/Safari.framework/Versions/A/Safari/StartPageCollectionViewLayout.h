...
@property (nonatomic) char centerContentVerticallyIfPossible;
...
- (long long)_itemIndexForPoint:(struct CGPoint { double x0; double x1; })a0 inSectionDefinition:(id)a1 isInterItem:(char *)a2;
...
- (void)setIsSectionCollapsed:(char)a0 atIndex:(long long)a1;
