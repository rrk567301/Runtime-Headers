...
@property (readonly) char automaticallyOpensInTabs;
...
@property (readonly, nonatomic) char canAcceptLeafChildren;
...
- (id)_childrenIncludingFolders:(char)a0;
...
- (void)setAutomaticallyOpensInTabs:(char)a0 changeWasInteractive:(char)a1;
