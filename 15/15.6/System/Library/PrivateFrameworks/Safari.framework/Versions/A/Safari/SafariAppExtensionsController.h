...
- (void)openTabInWindow:(id)a0 withURL:(id)a1 forExtensionWithUUID:(id)a2 makeActiveIfPossible:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)setToolbarItem:(id)a0 forExtensionWithUUID:(id)a1 isEnabled:(char)a2;
- (void)setToolbarItem:(id)a0 forExtensionWithUUID:(id)a1 isEnabled:(char)a2 withBadgeText:(id)a3;
...
- (id)_browserTabForExtensionTab:(id)a0 includeHiddenTabs:(char)a1;
- (char)_canExtension:(id)a0 addHeadersToURL:(id)a1 inBrowserViewController:(id)a2;
- (char)_canExtensionWithUUID:(id)a0 accessBrowserContentViewController:(id)a1;
- (char)_canExtensionWithUUID:(id)a0 accessURL:(id)a1;
...
- (void)_connectToExtension:(id)a0 shareExtensionContext:(char)a1 reason:(long long)a2 completionHandler:(id /* block */)a3;
...
- (char)_extensionHasPopover:(id)a0;
...
- (void)_getAPIProxyForExtensionWithUUID:(id)a0 shareExtensionContext:(char)a1 reason:(long long)a2 completionHandler:(id /* block */)a3;
- (void)_grantRequestedPermissionsIfNecessaryForExtension:(id)a0;
- (void)_insertToolbarItemForExtensionIfNecessary:(id)a0;
- (char)_isBrowserViewController:(id)a0 visibleToExtensionWithUUID:(id)a1;
- (char)_isTab:(id)a0 inProfile:(id)a1 visibleToExtension:(id)a2;
- (char)_isTab:(id)a0 visibleToExtensionWithUUID:(id)a1;
- (char)_isTrustedDeveloperForExtensionStateSyncForExtension:(id)a0;
- (char)_isWindow:(id)a0 visibleToExtensionWithUUID:(id)a1;
...
- (char)canAnyExtensionsAddHeadersToURL:(id)a0 inBrowserViewController:(id)a1;
