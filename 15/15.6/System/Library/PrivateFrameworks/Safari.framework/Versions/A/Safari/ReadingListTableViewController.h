...
@property (nonatomic) char showsSearchFieldWrapperView;
@property (nonatomic) char showAsOffline;
...
@property (nonatomic, getter=isEditingTableView) char editingTableView;
...
- (char)tableView:(id)a0 shouldTypeSelectForEvent:(id)a1 withCurrentSearchString:(id)a2;
...
- (char)_isValidRowIndex:(long long)a0;
...
- (void)_updateItemsWithAnimation:(char)a0;
...
- (char)tableView:(id)a0 shouldEditOnDoubleClick:(id)a1 inRow:(long long)a2 tableColumn:(id)a3;
