...
- (void)togglePopoverForDomain:(id)a0 popoverIsForSafariWebExtension:(char)a1 relativeToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 ofView:(id)a3;
