...
@property (class, readonly, nonatomic) char canShowPopover;

@property (retain, nonatomic) NSPopover *popover;
@property (readonly, nonatomic, getter=isShowingPopover) char showingPopover;
...
- (void)_updateContentSizeAllowingSmallerWidth:(char)a0;
- (void)_updateContentSizeForDownloadsChange;
- (struct CGSize { double x0; double x1; })bestSizeAllowingSmallerWidth:(char)a0;
