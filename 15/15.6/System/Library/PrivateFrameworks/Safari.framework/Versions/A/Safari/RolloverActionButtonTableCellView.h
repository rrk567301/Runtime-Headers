...
@property (nonatomic) char updatesTitleTextFieldFrameWhenActionButtonVisibilityChanges;
...
- (void)_updateTitleTextFieldFrameAccountingForActionButtonBeingVisible:(char)a0;
- (void)_willShowActionButton;
- (void)updateTextFieldToAccountForButtonBeingVisible:(char)a0;
