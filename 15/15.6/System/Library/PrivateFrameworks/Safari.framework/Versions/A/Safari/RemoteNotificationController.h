...
@interface RemoteNotificationController : NSObject <SafariNotificationAgentProxy> {
    ...
    char _checkingSystemPreferencesPermissions;
}
...
- (char)_stageSafariIconAtRemoteNotificationPackagesDirectory;
...
- (char)isPermissionDisabledInSystemSettingsForOrigin:(id)a0;
