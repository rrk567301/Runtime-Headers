...
@property (readonly, nonatomic) char canTrustUserInteraction;
...
- (void)toggleSettingEnsuringTrustedUserInteraction:(char)a0 authorizationRight:(int)a1 toggleBlock:(id /* block */)a2 updateBlock:(id /* block */)a3;
