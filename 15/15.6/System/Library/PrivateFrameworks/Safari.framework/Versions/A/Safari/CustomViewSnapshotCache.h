...
- (char)_providerCanUseFastSnapshotPath:(id)a0;
- (void)_removeSnapshotProviderFromScheduledRequest:(id)a0;
- (void)_scheduleSnapshotRequestWithProvider:(id)a0 thumbnailViewType:(long long)a1 ifHasShownInWindowOnly:(char)a2;
- (id)_takeSnapshotWithProvider:(id)a0 requireFastPath:(char)a1 ifHasShownInWindowOnly:(char)a2;
...
- (void)takeSnapshotWithProvider:(id)a0 ifHasShownInWindowOnly:(char)a1;
