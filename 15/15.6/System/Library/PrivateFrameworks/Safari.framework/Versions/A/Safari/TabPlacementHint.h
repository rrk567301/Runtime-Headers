...
@property (readonly, nonatomic) char treatCurrentTabAsAncestorTabIfPossible;

- (id)init;
- (void).cxx_destruct;
- (id)initWithWindowController:(id)a0;
- (id)initWithWindowController:(id)a0 treatCurrentTabAsAncestorTabIfPossible:(char)a1;
