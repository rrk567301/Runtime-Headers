...
- (long long)handleNavigationToExternalURL:(id)a0 withTabDialogPresenter:(id)a1 sourceFrame:(id)a2 userInitiatedAction:(id)a3 inLockdownMode:(char)a4 browsingMode:(unsigned long long)a5;
