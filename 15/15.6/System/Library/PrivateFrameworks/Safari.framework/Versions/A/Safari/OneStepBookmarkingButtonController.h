...
- (void)_addBookmarkToReadingListWithoutAskingAndMakeDefault:(char)a0;
- (void)_addBookmarkWithoutAskingToFolder:(id)a0 andMakeDefault:(char)a1;
...
- (void)_didSelectOneStepBookmarkMenuItemWithIdentifier:(id)a0 makeDefault:(char)a1;
