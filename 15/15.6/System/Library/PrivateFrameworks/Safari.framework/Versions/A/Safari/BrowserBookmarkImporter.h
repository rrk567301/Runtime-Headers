...
@property (nonatomic) char hasBegunBookmarkTransaction;
...
- (void)_didFinishSuccessfully:(char)a0 withNumberOfSuccessfullyImportedBookmarks:(unsigned long long)a1;
...
- (char)_shouldImportBookmark:(id)a0 fromOrigin:(unsigned long long)a1;
- (void)_updateReimportedBookmarks;
- (char)bookmarkMergeDriver:(id)a0 shouldMergeTitlesOfBookmark:(id)a1 existingBookmark:(id)a2;
