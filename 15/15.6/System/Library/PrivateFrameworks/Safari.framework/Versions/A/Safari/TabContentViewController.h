...
@property (readonly, nonatomic) char shouldDisableTitlebarBlurringForCurrentContentView;
@property (readonly, nonatomic) char isShowingNativeViewController;
...
@property (nonatomic) char didFireCloseEvent;
@property (readonly, nonatomic) char isActiveWebViewMagnified;
@property (readonly, nonatomic, getter=isInContinuousMode) char inContinuousMode;
...
@property (readonly, nonatomic) char continuousPageViewIsHandlingPageTransitionOrLoadingPageItem;
...
@property (readonly, nonatomic) char thumbnailContentViewWasShownInWindow;
...
- (char)handleScrollWheelEvent:(id)a0;
...
- (void)uninstallReaderContainerViewController:(id)a0 closedByUser:(char)a1;
