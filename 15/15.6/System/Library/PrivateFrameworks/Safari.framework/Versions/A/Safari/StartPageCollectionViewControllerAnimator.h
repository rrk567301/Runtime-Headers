...
- (char)shouldSuppressBookmarkReloadsInStartPageCollectionSectionProvider:(id)a0;
- (char)startPageCollectionSectionProvider:(id)a0 canCollapseSection:(long long)a1;
...
- (void)startPageCollectionSectionProvider:(id)a0 didToggleCollapse:(char)a1;
- (void)startPageCollectionSectionProvider:(id)a0 enumerateItemsAtIndexPaths:(id)a1 usingBlock:(id /* block */)a2;
- (long long)startPageCollectionSectionProvider:(id)a0 firstSectionIndexForInsertion:(char)a1;
...
- (char)startPageCollectionSectionProvider:(id)a0 isCollapsedSection:(long long)a1;
...
- (void)startPageCollectionSectionProvider:(id)a0 updateVisibilityOfSectionsWithDataAvailable:(char)a1;
