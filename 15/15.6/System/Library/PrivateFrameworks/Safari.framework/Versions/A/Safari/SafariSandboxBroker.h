...
@property (readonly, nonatomic) char downloadLocationIsForced;
@property (readonly, nonatomic) char alwaysPromptForDownloadFolder;
...
- (void)dealloc;
- (void).cxx_destruct;
- (id)_URLsRelatedToURL:(id)a0 containingOriginalURL:(char *)a1;
...
- (char)_canHostWriteFileAtURL:(id)a0;
- (void)_clearDownloadIdentifiersNotIncludedIn:(id)a0 completionHandler:(id /* block */)a1;
- (void)_createDownloadBundleWithSuggestedFilename:(id)a0 inFolderAtURL:(id)a1 tagNames:(id)a2 allowsOverwrite:(char)a3 completionHandler:(id /* block */)a4;
...
- (char)_isValidDownloadLocation:(id)a0;
- (char)_isWebArchiveData:(id)a0;
...
- (void)createDownloadBundleWithSuggestedFilename:(id)a0 inFolderAtURL:(id)a1 tagNames:(id)a2 allowsOverwrite:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)setShouldAlwaysPromptForDownloadPath:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)writeFileWrapperToUniqueFileInDownloadsFolder:(id)a0 shouldSetPrivacySensitiveQuarantineProperties:(char)a1 completionHandler:(id /* block */)a2;
