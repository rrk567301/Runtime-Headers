...
@property (readonly, nonatomic) char shouldSaveUsernamesAndPasswords;
@property (readonly, nonatomic) char shouldSavePasswordsToCloudKeychain;
...
- (char)formCompletion:(void *)a0 fillFormWithSuggestedPassword:(id)a1 formMetadata:(id)a2;
- (void)formCompletion:(void *)a0 fillFormWithValues:(id)a1 autoFillType:(long long)a2;
- (void)formCompletion:(void *)a0 fillFormWithValues:(id)a1 fieldToFocus:(id)a2 autoFillType:(long long)a3 shouldSubmit:(char)a4;
- (void)formCompletion:(void *)a0 fillHideMyEmailRecord:(id)a1 formMetadata:(id)a2;
- (void)formCompletion:(void *)a0 fillOneTimeCodeFieldsWithValue:(id)a1 shouldSubmit:(char)a2;
