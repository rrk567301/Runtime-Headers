...
@property (nonatomic, getter=isMuteButtonVisible) char muteButtonVisible;
...
@property (nonatomic, getter=isCloseButtonVisible) char closeButtonVisible;
...
- (void)_setCloseButtonVisible:(char)a0 animated:(char)a1;
