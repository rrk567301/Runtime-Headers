...
@property (nonatomic) char shouldHideSectionWhenBaseFolderIsEmpty;
...
- (void)_openFolderHonoringKeyModifiers:(id)a0 withAnimation:(char)a1;
- (void)_reloadCellForBookmark:(id)a0 invalidatingIcon:(char)a1;
- (void)_reloadContent;
...
- (id)initWithSiteMetadataManager:(id)a0 tabGroup:(id)a1 shouldHideSectionWhenEmpty:(char)a2 usesCompactAppearance:(char)a3;
