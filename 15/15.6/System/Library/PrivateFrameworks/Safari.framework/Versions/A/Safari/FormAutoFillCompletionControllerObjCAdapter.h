...
@property (nonatomic) char _biometricAuthenticationStillInUse;
@property (readonly, nonatomic) LAContext *_currentOperationLAContext;
@property (readonly, nonatomic) char isAskingForBiometricAuthentication;
...
@property (readonly, nonatomic) char shouldShowStrongPasswordIntroductionViewController;
...
- (char)shouldShowAuthenticationSheetForCompletionListItem:(const void *)a0;
- (void)strongPasswordIntroductionViewController:(id)a0 shouldPerformAction:(unsigned long long)a1 willShowAdditionalView:(char)a2;
- (void)updateBiometricAvailabilityInCompletionList:(char)a0;
