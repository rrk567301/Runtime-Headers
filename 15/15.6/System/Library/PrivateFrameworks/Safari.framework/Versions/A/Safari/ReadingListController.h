...
@property (readonly, nonatomic) char hasOfflineReadingListItems;
...
- (void)_addItem:(id)a0 atIndex:(unsigned long long)a1 allowUndo:(char)a2 didCheckIfBookmarkEditingIsPermitted:(char)a3;
- (void)_addItemWithBookmark:(id)a0 addUserInteraction:(int)a1 allowUndo:(char)a2 didCheckIfBookmarkEditingIsPermitted:(char)a3;
...
- (char)_shouldSaveWebArchiveDataForItem:(id)a0;
...
- (void)addItemWithBookmark:(id)a0 addUserInteraction:(int)a1 allowUndo:(char)a2 didCheckIfBookmarkEditingIsPermitted:(char)a3;
- (void)addItemWithLinkTitle:(id)a0 linkLabel:(id)a1 linkURL:(id)a2 addUserInteraction:(int)a3 allowUndo:(char)a4;
- (void)addItemWithTitle:(id)a0 url:(id)a1 addUserInteraction:(int)a2 allowUndo:(char)a3;
- (void)addItemWithTitle:(id)a0 url:(id)a1 previewText:(id)a2 addUserInteraction:(int)a3 allowUndo:(char)a4;
- (char)addURLsFromPasteboard:(id)a0;
...
- (char)isReadingListItemArchiveURL:(id)a0;
- (char)isReadingListItemReaderizedPageArchiveURL:(id)a0;
- (id)itemForUUID:(id)a0;
- (id)liveOrArchiveURLForReadingListItem:(id)a0 pageURL:(id)a1;
- (void)markItem:(id)a0 asUnread:(char)a1;
