...
- (char)browserTabCompletionProvider:(id)a0 doesURLRepresentNativeContent:(id)a1;
- (char)browserTabCompletionProvider:(id)a0 shouldExtensionURLAppearAsSwitchToTabItem:(id)a1;
