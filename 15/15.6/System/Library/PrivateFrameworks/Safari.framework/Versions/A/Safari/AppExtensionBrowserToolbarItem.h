...
@property (readonly, nonatomic) char canBeDisabledByExtension;
...
- (char)_extensionNeedsAccessToCurrentURL;
...
- (void)setShowsActiveExtensionIcon:(char)a0;
- (void)setShowsNewExtensionBadge:(char)a0;
