@class NSUUID, NSString, NSArray, WBWindowState, NSSet, NSData, NSDictionary, NSDate, BrowserTabPersistentState;
...
@property (readonly, nonatomic, getter=isPrivateWindow) char privateWindow;
@property (readonly, nonatomic) NSUUID *windowUUID;
@property (readonly, nonatomic) WBWindowState *windowState;
@property (readonly, nonatomic) char hasTabsToRestore;
...
@property (nonatomic, getter=isMinimized) char minimized;
@property (readonly, nonatomic, getter=isPopupWindow) char popupWindow;
@property (readonly, nonatomic, getter=isTabBarHidden) char tabBarHidden;
@property (readonly, nonatomic, getter=isFavoritesBarHidden) char favoritesBarHidden;
@property (readonly, nonatomic) char prefersSidebarVisible;
@property (readonly, nonatomic) char containsAnyURLs;
@property (readonly, copy, nonatomic) NSData *windowRestorationArchiveData;
...
- (void).cxx_destruct;
- (char)_shouldRestoreTabStateInWindow:(id)a0;
...
- (char)containsTabStateWithUUID:(id)a0;
...
- (id)initWithBrowserWindowController:(id)a0 encryptionProvider:(id)a1 skipTabStates:(char)a2;
