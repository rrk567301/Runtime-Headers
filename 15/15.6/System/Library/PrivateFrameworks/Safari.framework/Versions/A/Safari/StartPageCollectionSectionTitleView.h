...
@property (nonatomic) char canCollapseSection;
@property (nonatomic) char isSectionCollapsed;
@property (nonatomic) char isShowMoreButtonVisible;
@property (nonatomic) char canGoBack;
