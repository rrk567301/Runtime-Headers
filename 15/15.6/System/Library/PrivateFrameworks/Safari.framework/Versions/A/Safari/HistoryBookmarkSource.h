...
- (char)contentItemCanBeSearchResult:(id)a0;
- (char)contentItemCanHaveChildren:(id)a0;
- (id)contentItemsToInitiallyExpand;
- (char)deleteContentItems:(id)a0;
- (char)deleteContentItems:(id)a0 withParentWindow:(id)a1 undoManager:(id)a2;
