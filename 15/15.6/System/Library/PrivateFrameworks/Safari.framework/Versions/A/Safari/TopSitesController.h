...
@interface TopSitesController : NSObject {
    ...
    char _didComputeFrequentlyVisitedSites;
...
@property (readonly, nonatomic, getter=isWarmingUp) char warmingUp;
...
- (id)_findNewTopSite;
- (char)_loadBannedURLStringsFromArray:(id)a0;
...
- (void)_buildDisplayedSitesInTopSites:(id)a0 preserveExistingRanks:(char)a1;
- (char)_candidate:(id)a0 isViableComputedTopSiteGivenDisplayedSiteURLStrings:(id)a1 updatingCandidateHostNames:(id)a2;
- (char)_candidateURLString:(id)a0 isViableComputedTopSiteGivenBannedURLStrings:(id)a1 pinnedURLStrings:(id)a2 updatingCandidateHostNames:(id)a3;
- (char)_candidateURLString:(id)a0 isViableDisplayedTopSiteGivenBannedURLStrings:(id)a1 pinnedURLStrings:(id)a2;
- (char)_candidateURLStringIsViableComputedTopSite:(id)a0 updatingCandidateHostNames:(id)a1;
...
- (char)_loadDisplayedSitesFromArray:(id)a0;
...
- (char)_shouldRecomputeFrequentlyVisitedAfterRemovingIndividualHistoryItems:(id)a0;
...
- (void)_updateURLMaps;
- (void)ban:(id)a0;
- (char)isSiteBannedWithURL:(id)a0;
