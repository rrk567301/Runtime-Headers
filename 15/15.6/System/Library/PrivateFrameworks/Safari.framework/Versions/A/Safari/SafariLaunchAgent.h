...
- (void)askDefaultBrowserToBeginAuthenticationSessionWithUUID:(id)a0 url:(id)a1 callbackURLScheme:(id)a2 usingEphemeralSession:(char)a3 jitEnabled:(char)a4 completionHandler:(id /* block */)a5;
- (void)askDefaultBrowserToBeginAuthenticationSessionWithUUID:(id)a0 url:(id)a1 callback:(id)a2 usingEphemeralSession:(char)a3 jitEnabled:(char)a4 additionalHeaderFields:(id)a5 customAnchorCertificatesData:(id)a6 shouldFailOnMDMProfileErrorResponse:(char)a7 completionHandler:(id /* block */)a8;
- (void)askDefaultBrowserToBeginAuthenticationSessionWithUUID:(id)a0 url:(id)a1 callbackURLScheme:(id)a2 usingEphemeralSession:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)_authenticationPromptTitle:(id *)a0 message:(id *)a1 defaultButtonText:(id *)a2 alternateButtonText:(id *)a3 cancelButtonText:(id *)a4 forAppName:(id)a5 domain:(id)a6 usingSafari:(char)a7 supportsEphemeralSession:(char)a8 browserName:(id)a9;
- (char)_doesBrowserWithCapabilities:(id)a0 supportRequestUsingEphemeralSession:(char)a1 callback:(id)a2 additionalHeaders:(id)a3;
