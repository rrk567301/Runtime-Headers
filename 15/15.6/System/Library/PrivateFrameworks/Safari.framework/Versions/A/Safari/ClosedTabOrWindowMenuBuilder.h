...
- (char)_shouldDeduplicateMenuItemForTopLevelMenu:(id)a0;
- (char)_shouldDeduplicateMenuItemForTopLevelMenuByURLString:(id)a0;
- (char)_tabStateIsShowingNativeContent:(id)a0;
