...
+ (char)modallyConfirmPageUnloadInBrowserContentViewController:(id)a0 reason:(long long)a1;
+ (id)pageWithVideoInPIPInBrowserTabs:(id)a0;
+ (char)shouldConfirmUnloadingPageWithBrowserContentViewController:(id)a0;
