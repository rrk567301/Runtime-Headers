...
+ (void)showAccessRequestPromptForExtension:(id)a0 forDomains:(id)a1 callingAPIName:(id)a2 showsSuppressionButton:(char)a3 responseBlock:(id /* block */)a4;
+ (void)showAccessRequestPromptForExtension:(id)a0 forPatterns:(id)a1 callingAPIName:(id)a2 showsSuppressionButton:(char)a3 responseBlock:(id /* block */)a4;
+ (void)showAccessRequestPromptForExtension:(id)a0 forURLs:(id)a1 callingAPIName:(id)a2 showsSuppressionButton:(char)a3 responseBlock:(id /* block */)a4;
...
+ (void)showPromptForOverridingNewTabWindowPagesWithExtensionOverridePage:(id)a0 forProfile:(id)a1 enableInAllProfiles:(char)a2 responseBlock:(id /* block */)a3;
