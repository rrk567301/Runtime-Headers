...
@property (readonly, nonatomic) char isGeneratedPassword;
...
- (id)initWithURL:(id)a0 usernameSuggestion:(id)a1 password:(id)a2 isGeneratedPassword:(char)a3 alertPresentationCompletionHandler:(id /* block */)a4;
