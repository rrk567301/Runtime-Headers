...
- (id)bookmarkSourceForProfileIdentifier:(id)a0 loadIfNeeded:(char)a1;
- (id)combinedFavoritesControllerForProfileIdentifier:(id)a0 loadIfNeeded:(char)a1;
- (id)topSitesControllerForProfileIdentifier:(id)a0 loadIfNeeded:(char)a1;
