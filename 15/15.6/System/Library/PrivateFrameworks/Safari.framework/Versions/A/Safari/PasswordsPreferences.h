...
@property (class, readonly, nonatomic) char canOpenGeneratedPasswords;
...
@property (readonly, nonatomic) char windowToSecureIsMainWindow;
...
- (void)_installViewController:(id)a0 postModuleBeingDisplayed:(char)a1;
