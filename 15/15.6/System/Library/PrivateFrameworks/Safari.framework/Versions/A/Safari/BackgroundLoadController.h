...
- (void)_commitBackgroundLoadNow:(id)a0 wasDeferred:(char)a1;
- (void)_commitBackgroundLoadNow:(id)a0 wasDeferred:(char)a1 usingTabViewItemSetUpBlock:(id /* block */)a2;
...
- (void)_triedToCloseDestinationContentViewControllerBeforeCommittingBackgroundLoad:(id)a0 canClose:(char)a1;
- (char)_tryToCloseDestinationContentViewControllerBeforeCommittingToBackgroundLoad:(id)a0;
...
- (char)canLoadURLInBackground:(id)a0;
