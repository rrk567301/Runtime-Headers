...
- (void)loadView;
- (id)panel:(id)a0 userEnteredFilename:(id)a1 confirmed:(char)a2;
...
- (void)_saveFileData:(id)a0 atURL:(id)a1 withTags:(id)a2 originURL:(id)a3 isWebArchive:(char)a4 canSavePrivacySensitiveData:(char)a5;
