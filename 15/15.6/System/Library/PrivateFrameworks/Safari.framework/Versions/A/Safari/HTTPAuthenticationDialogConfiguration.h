...
@property (readonly, nonatomic) char shouldOfferToRemember;
...
+ (id)authenticationDialogConfigurationWithChallenge:(id)a0 currentURL:(id)a1 shouldOfferToRemember:(char)a2;
