...
- (void).cxx_destruct;
- (void)endTransaction;
- (char)removeBookmarks:(id)a0;
- (char)moveBookmarks:(id)a0 to:(id)a1 startingIndex:(unsigned long long)a2;
...
- (char)_canMoveBookmark:(id)a0;
- (id)_cleanUpBookmarksByAddressForBookmarks:(id)a0;
- (id)_cleanUpBookmarksByNameForBookmarks:(id)a0;
- (id)_insertBookmarksFromPasteboard:(id)a0 inFolder:(id)a1 startingIndex:(unsigned long long)a2 undoTarget:(id)a3 selector:(SEL)a4 isCopy:(char)a5;
- (char)_moveBookmarks:(id)a0 to:(id)a1 startingIndex:(unsigned long long)a2 isCopy:(char)a3 undoTarget:(id)a4 selector:(SEL)a5 addedBookmarks:(id *)a6;
...
- (char)_shouldCopyPastedBookmarks:(id)a0 inFolder:(id)a1 isCopy:(char)a2;
...
- (char)changeAddressOfBookmark:(id)a0 to:(id)a1;
- (char)changePreviewTextOfBookmark:(id)a0 to:(id)a1 isUserCustomized:(char)a2;
- (char)changeTitleOfBookmark:(id)a0 to:(id)a1;
...
- (char)insertBookmark:(id)a0 atIndex:(unsigned long long)a1 inBookmarkFolder:(id)a2 allowDuplicateURLs:(char)a3;
- (char)insertBookmarks:(id)a0 startingAtIndex:(unsigned long long)a1 inBookmarkFolder:(id)a2;
...
- (id)replaceBookmarksWithUndoInfo:(id)a0 target:(id)a1 selector:(SEL)a2 reverseOrder:(char)a3;
- (void)setCurrentTransactionActionName:(id)a0;
- (char)toggleFolderAutomaticallyReplacesTabs:(id)a0;
