...
- (void)_offerToSaveSecurityCodeForCreditCardData:(id)a0 submittedToFrameInBrowserViewController:(id)a1 fromFrameInBrowserViewController:(id)a2 finishedSavingFormDataBlock:(id /* block */)a3 outdatedExpirationDate:(char)a4;
- (void)_offerToUpdateExpirationDateForCreditCardData:(id)a0 submittedToFrameInBrowserViewController:(id)a1 fromFrameInBrowserViewController:(id)a2 finishedSavingFormDataBlock:(id /* block */)a3 mergeSecurityCode:(char)a4;
- (char)_shouldDisplayVPANEnabledCards;
