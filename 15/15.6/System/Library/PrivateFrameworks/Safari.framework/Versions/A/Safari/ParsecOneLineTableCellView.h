...
- (void)_updateImageView:(id)a0 withImageURL:(id)a1 withSize:(struct CGSize { double x0; double x1; })a2 isTemplate:(char)a3;
- (void)configureUsingCompletionListItem:(void *)a0 session:(id)a1;
- (void)test_updateImageView:(id)a0 withImageURL:(id)a1 withSize:(struct CGSize { double x0; double x1; })a2 isTemplate:(char)a3;
