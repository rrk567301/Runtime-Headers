...
@interface StartPagePopoverViewController : NSViewController <WBTabGroupManagerObserver, CollectionViewPlusDelegate, NSCollectionViewDataSource, NSFilePromiseProviderDelegate, NSPopoverDelegate> {
    ...
    char _shouldShowTabGroupSections;
    NSArray *_suggestionsTogglesData;
    NSArray *_backgroundImageTogglesData;
    char _shouldShowSuggestionsSections;
    ...
    char _isShowingGeneratedBackgroundImage;
...
- (char)_hasGeneratedProfileSpecificImage;
...
- (char)_shouldUpdateStackViewWithSubviews;
