...
@property (readonly, nonatomic) char isBiometricAuthenticationAvailable;
...
- (id)authenticateWithReason:(id)a0 delegate:(id)a1 savedAccountMatch:(id)a2 tab:(id)a3 allowApplyingGracePeriod:(char)a4;
