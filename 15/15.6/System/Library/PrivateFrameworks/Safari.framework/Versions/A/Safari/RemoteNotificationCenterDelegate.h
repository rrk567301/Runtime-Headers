...
- (void)_deliverNotificationWithTitle:(id)a0 informativeText:(id)a1 buttonTitle:(id)a2 activationURLArguments:(id)a3 isRemote:(char)a4;
...
- (char)isNotificationPermissionDisabledInSystemSettings;
