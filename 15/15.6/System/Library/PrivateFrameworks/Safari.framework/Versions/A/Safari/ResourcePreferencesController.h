...
@property (readonly, nonatomic) char homePageIsForced;
...
- (id)homePageObtainingExtensionTokenIfNecessary:(char)a0;
- (id)homePageURLObtainingExtensionTokenIfNecessary:(char)a0;
