...
+ (void)setShouldCheckIntegrityOnOpen:(char)a0;
...
- (char)historyStoreShouldCheckDatabaseIntegrity:(id)a0;
- (char)historyStoreShouldScheduleMaintenance:(id)a0;
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 timeOfVisit:(double)a2 wasHTTPNonGet:(char)a3 wasFailure:(char)a4 increaseVisitCount:(char)a5 origin:(long long)a6 attributes:(unsigned long long)a7;
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 timeOfVisit:(double)a2 wasHTTPNonGet:(char)a3 wasFailure:(char)a4 increaseVisitCount:(char)a5 statusCode:(long long)a6 origin:(long long)a7 attributes:(unsigned long long)a8;
...
- (char)shouldOmitURLString:(id)a0;
