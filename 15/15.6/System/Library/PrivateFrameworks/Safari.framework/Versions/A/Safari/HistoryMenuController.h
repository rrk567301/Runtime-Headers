...
- (char)_addItemsForSession:(id)a0 toMenu:(id)a1 skip:(unsigned int)a2 limit:(unsigned int)a3;
...
- (char)validate__takeLocationFromHistoryEntry:(id)a0;
