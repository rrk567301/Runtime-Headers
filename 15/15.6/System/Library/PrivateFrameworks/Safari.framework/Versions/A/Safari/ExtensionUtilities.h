...
+ (id)userVisibleWebsiteAccessWithWebsiteAccessLevel:(int)a0 allowedDomains:(struct Vector<Safari::ExtensionDomainPattern, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct ExtensionDomainPattern *x0; unsigned int x1; unsigned int x2; })a1 allowedDomainsForHeaderInjection:(struct Vector<Safari::ExtensionDomainPattern, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct ExtensionDomainPattern *x0; unsigned int x1; unsigned int x2; })a2 hasInjectedContent:(char)a3 allowedInPrivateBrowsing:(char)a4;
+ (id)userVisibleWebsiteAccessWithWebsiteAccessLevel:(int)a0 allowedDomains:(struct Vector<Safari::ExtensionDomainPattern, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct ExtensionDomainPattern *x0; unsigned int x1; unsigned int x2; })a1 hasInjectedContent:(char)a2;
