...
@property (nonatomic, getter=isUnread) char unread;
@property (copy, nonatomic) NSDate *dateLastFetched;
@property (readonly, nonatomic) char needsInfoUpdated;
@property (nonatomic) char isFetchInProgress;
...
@property (readonly, nonatomic) char hasErrorDuringFetch;
@property (nonatomic) char isReaderAvailable;
@property (nonatomic) char isArchiveOnDisk;
@property (readonly, nonatomic) NSArray *urlStringsForAdditionalPages;
@property (nonatomic) char didUserExplicitlyRequestOfflineArchive;
@property (nonatomic) char didAttemptToFetchIconFromImageURL;
...
@property char lastRetrievedFallbackIconIsGenerated;
...
- (void)_setExtraNonSyncAttributeValue:(id)a0 forKey:(id)a1 shouldSuppressChangeNotification:(char)a2;
