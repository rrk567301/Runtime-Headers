...
@property (readonly, nonatomic) char hasPromptField;
@property (readonly, copy, nonatomic) NSString *promptFieldDefaultResponse;
@property (readonly, nonatomic) char hasSecurePromptField;
...
@property (readonly, nonatomic) char shouldHideTabContent;
...
- (void).cxx_destruct;
- (id)_initWithTitle:(id)a0 message:(id)a1 buttonLabels:(id)a2 originStringForAccessibility:(id)a3 hasPromptField:(char)a4 promptFieldDefaultResponse:(id)a5 customWidth:(id)a6 dialogType:(long long)a7;
- (id)_initWithTitle:(id)a0 message:(id)a1 buttonLabels:(id)a2 originStringForAccessibility:(id)a3 hasPromptField:(char)a4 promptFieldDefaultResponse:(id)a5 hasSecurePromptField:(char)a6 customWidth:(id)a7 dialogType:(long long)a8 presentationBlock:(id /* block */)a9 customLeftMostAction:(id /* block */)a10 tableData:(id)a11 tableDidSelectRowAction:(id /* block */)a12;
- (id)initWithTitle:(id)a0 message:(id)a1 buttonLabels:(id)a2 originStringForAccessibility:(id)a3 hasPromptField:(char)a4 promptFieldDefaultResponse:(id)a5 customWidth:(id)a6;
