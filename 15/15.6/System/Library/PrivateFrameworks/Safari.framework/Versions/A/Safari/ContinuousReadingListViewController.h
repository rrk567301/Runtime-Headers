...
@property (nonatomic, getter=isInReaderMode) char inReaderMode;
...
- (char)continuousPageView:(id)a0 canScrollDownPageView:(id)a1 pageItem:(id)a2;
- (char)continuousPageView:(id)a0 canScrollUpPageView:(id)a1 pageItem:(id)a2;
...
- (char)continuousPageView:(id)a0 pageViewHasFooterBanner:(id)a1 pageItem:(id)a2;
...
- (char)isCurrentContinuousReadingListPage:(struct Page { struct WKRetainPtr<const void *> { void *x0; } x0; })a0;
...
- (char)shouldIgnoreHistoryForAboutBlankForPage:(struct Page { struct WKRetainPtr<const void *> { void *x0; } x0; })a0;
