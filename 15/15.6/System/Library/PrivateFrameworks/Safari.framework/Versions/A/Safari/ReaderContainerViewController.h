...
@property (readonly, getter=isAnimatingActivation) char animatingActivation;
@property (readonly, getter=isAnimatingDeactivation) char animatingDeactivation;
...
- (void)_updateReaderWKViewFromFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 backgroundViewFromOpacity:(double)a2 toOpacity:(double)a3 animated:(char)a4 completionHandler:(id /* block */)a5;
- (void)activateWithAnimation:(char)a0 verticalScrollOffsetOfBrowserPage:(double)a1 completionBlock:(id /* block */)a2;
- (void)deactivateWithAnimation:(char)a0 completionBlock:(id /* block */)a1;
