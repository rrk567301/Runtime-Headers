...
- (char)_cleanlyCreateNotificationBundleForExtractedPackage:(id)a0 withDisplayName:(id)a1;
- (char)_createICNSFileInExtractedPackage:(id)a0 replaceIfExists:(char)a1;
- (char)_createNotificationBundleForExtractedPackage:(id)a0 atBundleDestination:(id)a1 withDisplayName:(id)a2;
...
- (char)_verifyManifestHashes:(id)a0 bundleVersion:(long long)a1;
- (void)_verifyReferrerURLAndAllowedDomains:(id)a0 completionHandler:(id /* block */)a1;
- (char)_verifySignature:(id)a0;
- (char)createLocalNotificationBundleFromWebsiteInfo:(id)a0;
