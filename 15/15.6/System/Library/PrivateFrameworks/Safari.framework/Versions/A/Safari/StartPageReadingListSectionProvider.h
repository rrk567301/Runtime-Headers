...
- (void)_navigateToReadingListItem:(id)a0 inBrowserWindowController:(id)a1 browserViewController:(id)a2 policy:(long long)a3 shouldNavigateToItemInCurrentWebView:(char)a4;
...
- (id)initWithCompactAppearance:(char)a0;
