...
- (void)_setUpNextImageViewWithImage:(id)a0 vibrancy:(char)a1;
...
- (void)setImage:(id)a0 withVibrancy:(char)a1 opacity:(double)a2;
- (void)setImage:(id)a0 withVibrancy:(char)a1 opacity:(double)a2 animationDuration:(double)a3;
