...
- (id)init;
- (void).cxx_destruct;
- (id)_addMenuItemsForBookmarkFolder:(id)a0 toMenu:(id)a1 indentationLevel:(unsigned long long)a2 shouldDisableMenuItems:(char)a3 disablingMenuItemsForDescendantsOfBookmarkFolder:(id)a4;
...
- (void)setUpMenu:(id)a0 disablingMenuItemsForDescendantsOfBookmarkFolder:(id)a1 enableTopLevelBookmarksFolderMenuItem:(char)a2;
