...
@property (nonatomic) char shouldUseRequestURLAsOriginURLIfNecessary;
@property (nonatomic) char didShowStorageManagerUI;
@property (readonly, nonatomic, getter=wasResumed) char resumed;
@property (readonly, nonatomic) char openWhenDone;
@property (readonly, nonatomic) char shouldAvoidPersistingIdentifyingInformation;
...
@property (readonly, nonatomic) char hasEnoughFreeDiskSpaceAtDownloadBundleLocation;
...
@property (readonly, nonatomic) char canAttemptReveal;
@property (readonly, nonatomic) char fileExists;
@property (readonly, nonatomic) char aliasFileExists;
@property (readonly, nonatomic) char canAttemptResume;
@property (readonly, nonatomic) char canResumeOrReload;
...
@property (readonly, nonatomic) char canStop;
@property (readonly, nonatomic) char canAttemptOpen;
...
- (char)_hasAnyFiles;
- (id)_initWithRequest:(id)a0 bytesLoaded:(long long)a1 bytesExpected:(long long)a2 error:(id)a3 download:(id)a4 downloadFile:(id)a5 postDownloadFile:(id)a6 downloadStage:(long long)a7 identifier:(id)a8 sandboxIdentifier:(id)a9 mayOpenWhenDone:(char)a10 shouldAvoidPersistingIdentifyingInformation:(char)a11 profileIdentifier:(id)a12;
...
- (void)_setDownloadStage:(long long)a0 shouldSendNotifications:(char)a1;
...
- (id)initWithWKDownload:(id)a0 navigatedWebView:(id)a1 suggestedFilename:(id)a2 mayOpenWhenDone:(char)a3 shouldAvoidPersistingIdentifyingInformation:(char)a4 profileIdentifier:(id)a5;
- (void)saveInitialStateToPList;
- (void)setDone:(char)a0 withResumeData:(id)a1;
