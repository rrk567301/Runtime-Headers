...
@property (nonatomic) char shouldAutomaticallyOpenInTabs;
@property (nonatomic) char canOpenInTabs;
@property (nonatomic) char selectingMultipleRows;
@property (nonatomic) char addFavoriteButtonStyleOptions;
@property (nonatomic) char bookmarkTitleIsHidden;
@property (nonatomic, getter=isShowingPreviewText) char showingPreviewText;
...
@property (nonatomic) char shouldStayInCurrentTabGroup;
