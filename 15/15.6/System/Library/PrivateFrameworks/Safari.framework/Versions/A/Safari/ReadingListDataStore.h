...
- (void)_postReadingListChangedNotificationWithAddedItems:(id)a0 removedItems:(id)a1 modifiedItems:(id)a2 forceRebuildUnreadItems:(char)a3;
- (void)_readingListModelDataWasReloaded:(id)a0;
- (void)_updateItemsFromReadingListFolderAndForceRebuildUnreadItems:(char)a0 completionHandler:(id /* block */)a1;
- (id)initWithStoredTitle:(id)a0;
- (void)insertItemWithUndo:(id)a0 atIndex:(unsigned long long)a1 didCheckIfBookmarkEditingIsPermitted:(char)a2;
- (id)itemForUUID:(id)a0;
- (void)itemsWereAdded:(id)a0 removed:(id)a1 modified:(id)a2 forceRebuildUnreadItems:(char)a3;
- (void)loadItems;
