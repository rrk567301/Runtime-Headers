...
@property (readonly, nonatomic) char isShowingPerSiteAccessPopup;
...
- (char)_requiresBadgeToBeShownForExtension:(id)a0 onPageWithURL:(id)a1;
...
- (id)toolbarItemForBrowserWindowController:(id)a0 forToolbar:(char)a1;
