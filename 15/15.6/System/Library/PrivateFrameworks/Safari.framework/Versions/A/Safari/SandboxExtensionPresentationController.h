...
- (char)_canReadFileAtURL:(id)a0;
- (char)_canWriteFileAtURL:(id)a0;
- (id)_createOpenPanel;
- (void)_createTokenForAccessibleURL:(id)a0 isSecurityScoped:(char)a1 permissions:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (id)_createTokenForAccessibleURL:(id)a0 isSecurityScoped:(char)a1 permissions:(unsigned long long)a2 error:(id *)a3;
