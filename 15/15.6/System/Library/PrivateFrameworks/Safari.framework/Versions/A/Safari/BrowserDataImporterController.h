...
@property (readonly, nonatomic) char canImportFromChrome;
@property (readonly, nonatomic) char canImportFromFirefox;
...
@property (readonly, nonatomic) char canResumeInterruptedImport;
@property (readonly, nonatomic) char isImporting;
...
- (void)_didCompleteImportingDataTypes:(unsigned long long)a0 success:(char)a1 numberOfImportedItems:(long long)a2;
...
- (void)_importHistoryFromURL:(id)a0 forChrome:(char)a1 completionHandler:(id /* block */)a2;
