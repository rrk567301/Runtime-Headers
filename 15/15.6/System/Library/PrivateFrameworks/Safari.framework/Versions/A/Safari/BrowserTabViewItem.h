...
@property (nonatomic) char userStartedTheaterMode;
...
@property (readonly, nonatomic, getter=isPlaceholderTab) char placeholderTab;
...
@property (readonly, nonatomic, getter=isShowingMonogram) char showingMonogram;
@property (readonly, nonatomic) char canBeRemovedInBrowserDocumentShouldClose;
...
@property (nonatomic, getter=isShowingMuteButton) char showingMuteButton;
...
@property (nonatomic) char tabViewedIndicatorVisible;
@property (nonatomic) char sessionStateNeedsSave;
...
@property (readonly, nonatomic) char shouldSelectOriginatingTabWhenClosed;
...
- (void)didSelect;
- (void)willUnselect;
- (void)_restoreBrowserTabStateOnBrowserViewController:(id)a0 allowJavaScript:(char)a1;
...
- (void)_internalSetPinned:(char)a0;
- (char)_isManagedByPinnedTabManager;
...
- (void)_transitionView:(id)a0 appearing:(char)a1 delay:(double)a2 size:(double)a3;
- (void)_tryToClose;
- (void)_tryToReload;
...
- (void)_willCloseDueToWindowClosing:(char)a0;
- (void)activateFromExtension;
- (void)addAccessoryView:(id)a0;
- (char)canShowAccessoryViewWhenTabIsNarrow:(id)a0;
...
- (char)isStateIdenticalToTabGroupTab:(id)a0;
- (void)loadContinuousReadingListPageItem:(id)a0;
- (void)loadURLFromAppExtension:(id)a0 waitInQueue:(char)a1;
...
- (void)restorePinnedState:(char)a0 pinnedPageURL:(id)a1 pinnedPageTitle:(id)a2;
...
- (void)updateSiteIconIgnoringPinnedTabState:(char)a0;
- (void)updateSiteIconNow;
- (void)updateSiteIconSoonIfNecessary;
- (void)updateTabGroupTabShouldPersist:(char)a0 usingBlock:(id /* block */)a1;
