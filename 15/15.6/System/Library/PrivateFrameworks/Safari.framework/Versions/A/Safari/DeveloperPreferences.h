...
- (void)_setCheckbox:(id)a0 checked:(char)a1;
- (void)_toggleAllowUnsignedExtensionsWithCompletionHandler:(id /* block */)a0;
- (void)_togglePropertyWithSecurePromptMessageText:(id)a0 currentPropertyState:(char)a1 toggleBlock:(id /* block */)a2 updateBlock:(id /* block */)a3;
...
- (void)_webDriverSecurePreferencesDidUpdate:(id)a0;
- (void)addTemporaryWebExtension:(id)a0;
- (char)addTemporaryWebExtensionWithURL:(id)a0;
- (void)openHelpPage:(id)a0;
- (id)safariHelpAnchor;
- (void)showErrorAlertForTemporaryExtensionForReload:(char)a0;
