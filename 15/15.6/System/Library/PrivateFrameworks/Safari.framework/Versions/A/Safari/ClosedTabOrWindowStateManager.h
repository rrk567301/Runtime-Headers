...
- (char)_registerTabStateForWindowIfNeeded:(id)a0;
- (void)_removeState:(id)a0;
- (void)_removeStatesInArray:(id)a0;
- (void)_removeTabPersistentState:(id)a0;
- (char)_restoreClosedTabPreservingTabGroupScopeWithTabState:(id)a0 atIndex:(unsigned long long)a1 inWindow:(id)a2;
- (void)_restoreClosedTabWithState:(id)a0 atIndex:(unsigned long long)a1 inWindowWithUUID:(id)a2 preservingTabGroupScope:(char)a3;
...
- (char)containsAnySavedStateForWindowUUID:(id)a0;
...
- (char)isClosingBrowserWindowController:(id)a0;
...
- (void)saveRestoredWindowState:(id)a0 discardAndRecreateWindowState:(char)a1;
