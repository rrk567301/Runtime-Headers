...
@interface StartPageCloudTabsSectionProvider : NSObject <StartPageFullDescriptionViewItemDelegate, StartPageViewItemDelegate, StartPageCollectionSectionProvider> {
    ...
    char _isBeingShownInSideBarSection;
    char _isShowingConsentUI;
    char _cloudTabsConsentObtained;
    ...
    char _isStandaloneCloudTabsStartPage;
...
- (void)didCollapse:(char)a0 section:(long long)a1;
- (void)goBackInSection:(long long)a0;
- (id)initWithCompactAppearance:(char)a0 forStandaloneStartPage:(char)a1 forProfileWithIdentifier:(id)a2 forSideBarSection:(char)a3;
