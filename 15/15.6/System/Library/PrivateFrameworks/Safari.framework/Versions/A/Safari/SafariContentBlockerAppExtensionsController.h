...
- (char)contentBlockerIsEnabledInCloudWithComposedIdentifier:(id)a0;
...
- (char)updateManagedContentBlockerStateForContentBlocker:(id)a0 composedIdentifier:(id)a1 startingState:(char)a2;
- (char)updateManagedPrivateBrowsingStateForContentBlocker:(id)a0 composedIdentifier:(id)a1 startingState:(char)a2;
...
- (char)_contentBlockerIsEnabledInAnyProfile:(id)a0;
