...
@interface ExtensionsPreferences : SecurePreferencesModule <ExtensionDropViewDelegate, WKScriptMessageHandlerWithReply, NSTableViewDataSource, NSTableViewDelegate> {
    ...
    char _permissionsWebViewLoaded;
    NSButton *_manageStorageButton;
    char _failedToCalculateAllExtensionStorage;
    char _updatingManageStorageVisibility;
    double _storageSize;
    NSMapTable *_dataRecords;
    NSMutableArray *_orderedExtensions;
    char _waitingForLockupViews;
...
- (void)_didToggleAllowUnsignedExtensions:(char)a0;
...
- (void)_setAllowedInPrivateBrowsing:(char)a0;
...
- (char)extensionDropView:(id)a0 didDropWebExtensionAtURL:(id)a1;
