...
+ (id)metricsForButton:(long long)a0 browsingMode:(unsigned long long)a1 embeddedInTabBar:(char)a2;
...
- (id)initForButton:(long long)a0 browsingMode:(unsigned long long)a1 embeddedInTabBar:(char)a2;
