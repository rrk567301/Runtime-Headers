...
@property (nonatomic) char hasEnclosingScrollView;
@property (weak) id<CollectionViewPlusDelegate> delegate;

- (void).cxx_destruct;
- (id)menu;
- (void)_setOpensDropInsertionGaps:(char)a0;
...
- (char)isScreenPointWithinBounds:(struct CGPoint { double x0; double x1; })a0;
