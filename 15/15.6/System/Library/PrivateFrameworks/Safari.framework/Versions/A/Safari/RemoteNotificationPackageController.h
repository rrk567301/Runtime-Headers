...
- (char)_notificationBundleExistsForIdentifier:(id)a0;
...
- (id)identifiersAddedBetweenDate:(id)a0 andDate:(id)a1 withAllowedPermissions:(char)a2 withDeniedPermissions:(char)a3;
