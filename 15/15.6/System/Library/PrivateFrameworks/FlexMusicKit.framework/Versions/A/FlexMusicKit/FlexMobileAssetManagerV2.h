...
@property (nonatomic) char includeArtworkInQueries;
@property (nonatomic) char XMLPresent;
...
+ (id)assetWithNewestContentVersionInAssets:(id)a0 preferInstalled:(char)a1;
...
- (char)_isDownloadingAsset:(id)a0;
- (char)_isPurgingAsset:(id)a0;
...
- (void)_updateExistingSong:(id)a0 usingAsset:(id)a1 metadataAsset:(id)a2 forceUpdate:(char)a3;
