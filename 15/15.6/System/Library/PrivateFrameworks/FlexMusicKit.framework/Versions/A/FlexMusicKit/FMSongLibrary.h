...
@property (nonatomic) char contactedCloud;
@property (retain, nonatomic) NSMutableDictionary *bundledSongs;
@property (readonly, nonatomic) char supportForCloud;
@property (readonly, nonatomic) char networkingIsDisabled;
...
- (void)_notifySongDownloadInProgressChanged:(char)a0;
