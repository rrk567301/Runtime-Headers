...
@property (nonatomic) char sliceable;
...
+ (char)canTransitionFromSegment:(id)a0 toSegment:(id)a1 fromBarIndex:(long long)a2 checkIfPrevented:(char)a3;
...
- (char)linkedPerBarTransitionsToSegmentNamed:(id)a0;
- (char)relinkAllTransitions;
- (void)removeTransitionToSegmentNamed:(id)a0 fromBarIndex:(long long)a1;
- (void)setLinkedPerBarTransitions:(char)a0 toSegmentNamed:(id)a1;
