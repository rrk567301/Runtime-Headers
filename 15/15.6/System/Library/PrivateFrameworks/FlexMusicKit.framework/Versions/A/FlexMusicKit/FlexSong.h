...
+ (char)_transitionIsPossibleFromSegment:(id)a0 toSegment:(id)a1 forBodyClipPlaylist:(id)a2;
...
- (char)_addBodySegmentsForAssemblyList:(id)a0 forDuration:(long long)a1 unusedDuration:(long long *)a2 testingContext:(id)a3 timedOut:(char *)a4;
- (char)_addIntroSegmentsToAssemblyList:(id)a0 forDuration:(long long)a1 testingContext:(id)a2;
- (char)_addOutroSegmentsToAssemblyList:(id)a0 forDuration:(long long)a1 allowTrim:(char)a2 testingContext:(id)a3;
- (char)_addSegment:(id)a0 withDuration:(long long)a1 toAssemblyList:(id)a2 indexOfNewSegment:(long long *)a3;
- (char)_addSegment:(id)a0 withDuration:(long long)a1 toAssemblyList:(id)a2 timeRemaining:(long long)a3 reusedSegment:(id *)a4 indexofNewSegment:(long long *)a5;
- (char)_buildIntroAndOutroOnlySegmentAssemblyList:(id)a0 forDuration:(long long)a1 testingContext:(id)a2;
- (char)_buildSegmentAssemblyList:(id)a0 forDuration:(long long)a1 withOptions:(id)a2 testingContext:(id)a3;
...
- (char)_rebuildBodySegmentsInAssemblyList:(id)a0 forDuration:(long long)a1 unusedDuration:(long long *)a2 testingContext:(id)a3;
- (void)_removeSegmentInfo:(id)a0 fromAssemblyList:(id)a1;
- (char)_removeUnpermittedTransitionsInAssemblyList:(id)a0 final:(char)a1 testingContext:(id)a2 removedIndexes:(id)a3;
- (char)_removeUnpermittedTransitionsInAssemblyList:(id)a0 final:(char)a1 testingContext:(id)a2 removedIndexes:(id)a3 conflictList:(id)a4;
...
- (char)_updateTransitionBodySegmentsForAssemblyList:(id)a0 usingNewSegment:(id)a1 indexOfNewTransitionSegment:(id)a2;
- (char)_validateAuthoringIssuesInRendition:(id)a0 failureReason:(id *)a1;
- (char)_validateStructureForRendition:(id)a0 failureReason:(id *)a1;
- (char)_validateTransitionsInRendition:(id)a0 failureReason:(id *)a1;
- (char)_verifyAssetsForSegment:(id)a0 withFailureReason:(id *)a1;
- (id)initCommonWithUID:(id)a0 songName:(id)a1 artistName:(id)a2 tagIDs:(id)a3 keywords:(id)a4 weightedKeywords:(id)a5 hidden:(char)a6 sampleRate:(long long)a7 mainSegments:(id)a8 crossFadeSegments:(id)a9 audioFileExtension:(id)a10 audioEncoderPresetName:(id)a11 metadataVersion:(long long)a12 customOptions:(id)a13;
- (id)initWithDictionary:(id)a0 assets:(id)a1;
- (id)initWithUID:(id)a0 songName:(id)a1 artistName:(id)a2 tagIDs:(id)a3 keywords:(id)a4 weightedKeywords:(id)a5 hidden:(char)a6 sampleRate:(long long)a7 mainSegments:(id)a8 crossFadeSegments:(id)a9 assets:(id)a10 audioFileExtension:(id)a11 audioEncoderPresetName:(id)a12 metadataVersion:(long long)a13 customOptions:(id)a14;
...
- (char)verifyAssetsWithFailureReason:(id *)a0;
