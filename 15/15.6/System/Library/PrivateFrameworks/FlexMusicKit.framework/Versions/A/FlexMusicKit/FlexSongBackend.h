...
@property (nonatomic) char recalled;
...
- (id)idealDurations;
- (char)_verifyKeyFrames:(id)a0 failureReason:(id *)a1;
- (char)_verifyClips:(id)a0 inRendition:(id)a1 failureReason:(out id *)a2;
- (id)existingAssetWithID:(id)a0;
- (id)initWithUID:(id)a0 songName:(id)a1 artistName:(id)a2 tagIDs:(id)a3 keywords:(id)a4 weightedKeywords:(id)a5 hidden:(char)a6 recalled:(char)a7 audioEncoderPresetName:(id)a8 metadataVersion:(long long)a9 songFormat:(id)a10 sampleRate:(long long)a11 customOptions:(id)a12;
...
- (void)updateSongArtist:(id)a0 title:(id)a1 tags:(id)a2 keywords:(id)a3 weightedKeywords:(id)a4 hidden:(char)a5 recalled:(char)a6 metadataVersion:(long long)a7;
- (void)updateUID:(id)a0;
- (char)verifyRendition:(id)a0 forDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 failureReason:(id *)a2;
