...
- (int)localSendAudioDataWithTimestamps:(id)a0 forHostTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 forSampleTime:(unsigned long long)a2 forDiscontinuity:(char)a3;
...
- (int)remoteSendAudioDataWithTimestamps:(id)a0 forHostTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 forSampleTime:(unsigned long long)a2 forDiscontinuity:(char)a3;
...
- (int)sendAudioDataWithTimestamps:(id)a0 forHostTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 forSampleTime:(unsigned long long)a2 forDiscontinuity:(char)a3;
