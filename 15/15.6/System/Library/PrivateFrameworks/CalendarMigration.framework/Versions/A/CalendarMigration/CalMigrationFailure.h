...
@property (readonly, nonatomic) char isFatal;
...
- (id)initWithDescription:(id)a0 stage:(unsigned long long)a1 underlyingError:(id)a2 relatedPath:(id)a3 isFatal:(char)a4;
