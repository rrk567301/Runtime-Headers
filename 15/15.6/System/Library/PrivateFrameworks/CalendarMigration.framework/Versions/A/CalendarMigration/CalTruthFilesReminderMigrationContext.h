...
- (char)_isURLSubpathOfExistingDirectoryToDelete:(id)a0;
...
- (void)recordMigrationFailureWithDescription:(id)a0 inStage:(unsigned long long)a1 underlyingError:(id)a2 relatedToURL:(id)a3 isFatal:(char)a4;
- (char)willFileBeDeleted:(id)a0;
