...
+ (void *)_attemptAccountCreationForDirectory:(id)a0 withContext:(id)a1 inPass:(unsigned long long)a2 accountType:(int *)a3 principalUid:(id *)a4 accountIdentifier:(id *)a5 ownerPrincipalUid:(id *)a6 shouldMigrateData:(char *)a7;
+ (void *)_attemptAccountMigrationForDirectory:(id)a0 withContext:(id)a1 shouldMigrateData:(char *)a2 inPass:(unsigned long long)a3 principalUid:(id *)a4 accountTypeOut:(int *)a5 migrationPrincipal:(id *)a6;
...
+ (char)_attemptGroupMigrationForDirectory:(id)a0 withContext:(id)a1;
+ (char)_attemptLocalCalendarMigrationForDirectory:(id)a0 withContext:(id)a1;
+ (char)_attemptMigrationForAccountInDirectory:(id)a0 withContext:(id)a1 inPass:(unsigned long long)a2;
...
+ (char)_importAlarmsIntoStore:(void *)a0 withPlistDictionary:(id)a1 fromDirectory:(id)a2 withContext:(id)a3 syncDefaultAlarms:(char)a4;
...
+ (char)_isCalDAVSubscribedCalendarWithNoEventsInDirectory:(id)a0 withPlistDictionary:(id)a1 isExchangeDirectory:(char)a2 context:(id)a3;
+ (char)_isDirectoryNaturalLanguageSuggestedEventsWithPlistDictionary:(id)a0;
+ (char)_isDirectorySuggestedEventsWithPlistDictionary:(id)a0;
...
+ (char)_removeTruthFilesAfterMigrationFromCalendarDirectory:(id)a0 withContext:(id)a1 deleteBackup:(char)a2;
+ (char)_shouldImportDirectoryAsCalendar:(id)a0 withContext:(id)a1 isBirthdayCalendar:(char *)a2 plistDictionary:(id *)a3;
...
- (char)attemptMigrationWithHomeDirectory:(id)a0 intoDestinationCalendarDirectory:(id)a1;
- (char)attemptMigrationWithHomeDirectory:(id)a0 intoDestinationCalendarDirectory:(id)a1 withCancellationToken:(id)a2;
- (char)attemptMigrationWithSourceCalendarDirectory:(id)a0 intoDestinationCalendarDirectory:(id)a1 withCancellationToken:(id)a2;
