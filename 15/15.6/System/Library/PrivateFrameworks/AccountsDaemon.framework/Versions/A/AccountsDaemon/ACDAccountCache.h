...
- (void)_caches_lock_cacheAccounts:(id)a0 forType:(id)a1 justActive:(char)a2;
- (void)_clearCacheIncludingRemote:(char)a0;
- (id)_expirerIdentifierForAccountTypeID:(id)a0;
- (void)_expirerScheduleForAccountIdentifier:(id)a0;
- (id)_keyForType:(id)a0 justActive:(char)a1;
...
- (void)cacheAccounts:(id)a0 forType:(id)a1 justActive:(char)a2;
...
- (id)cachedAccountsOfType:(id)a0 justActive:(char)a1;
- (id)cachedAccountsOfType:(id)a0 justActive:(char)a1 fetchBlock:(id /* block */)a2;
