...
- (id)_addAccountTypeWithIdentifier:(id)a0 displayName:(id)a1 visibility:(int)a2 supportedDataclasses:(id)a3 credentialType:(id)a4 supportsAuthentication:(char)a5 supportsMultipleAccounts:(char)a6;
- (id)_addAccountTypeWithIdentifier:(id)a0 displayName:(id)a1 visibility:(int)a2 supportedDataclasses:(id)a3 syncableDataclasses:(id)a4 credentialType:(id)a5 supportsAuthentication:(char)a6 supportsMultipleAccounts:(char)a7;
- (id)_addAccountTypeWithIdentifier:(id)a0 displayName:(id)a1 visibility:(int)a2 supportedDataclasses:(id)a3 syncableDataclasses:(id)a4 credentialType:(id)a5 supportsAuthentication:(char)a6 supportsMultipleAccounts:(char)a7 credentialProtectionPolicy:(id)a8;
...
- (void)_addCredentialType:(id)a0 toAccountType:(id)a1 supportsAuthentication:(char)a2;
...
- (char)_ensureAllDataclassesExist;
- (char)_ensureAllInternalAccountTypesExist:(char)a0;
...
- (char)updateDefaultContentIfNecessary:(id *)a0;
