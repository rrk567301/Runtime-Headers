...
+ (id)_credentialForAccountWithID:(id)a0 accountTypeID:(id)a1 credentialType:(id)a2 clientID:(id)a3 allowAdditionalAccountTypeSegment:(char)a4 options:(id)a5 error:(id *)a6;
+ (id)_fetchOptionsForAccount:(id)a0;
+ (id)_itemForServiceName:(id)a0 username:(id)a1 accessGroup:(id)a2 options:(id)a3 error:(id *)a4;
+ (void)_keychainLock_addItem:(id)a0 forServiceName:(id)a1 username:(id)a2 accessGroup:(id)a3 accessibility:(id)a4 syncable:(char)a5 requiresTouchID:(char)a6 error:(id *)a7;
+ (char)_keychainLock_removeItemForService:(id)a0 username:(id)a1 accessGroup:(id)a2 options:(id)a3 error:(id *)a4;
...
+ (char)_removeCredentialItemWithKey:(id)a0 forAccountWithID:(id)a1 username:(id)a2 accountTypeID:(id)a3 clientID:(id)a4 options:(id)a5 error:(id *)a6;
+ (void)_removeCredentialsForAccount:(id)a0 clientID:(id)a1 options:(id)a2 error:(id *)a3;
+ (char)_removeItemForService:(id)a0 username:(id)a1 accessGroup:(id)a2 options:(id)a3 error:(id *)a4;
+ (void)_saveCredential:(id)a0 forAccount:(id)a1 clientID:(id)a2 error:(id *)a3;
+ (void)_setCredentialForAccount:(id)a0 clientID:(id)a1 handleCredentialItemRemovals:(char)a2 error:(id *)a3;
+ (void)_setItem:(id)a0 forServiceName:(id)a1 username:(id)a2 accessGroup:(id)a3 accessibility:(id)a4 syncable:(char)a5 requiresTouchID:(char)a6 options:(id)a7 error:(id *)a8;
+ (void)_setNonPersistentCredentialTimerForAccount:(id)a0;
+ (char)_shouldSyncCredentialForAccount:(id)a0;
+ (char)accountSyncMigrated;
+ (id)accountSynciOSVersion;
+ (void)componentsFromKeychainServiceName:(id)a0 handler:(id /* block */)a1;
+ (char)createAccountSyncItemForAccount:(id)a0 clientID:(id)a1 properties:(id)a2 error:(id *)a3;
+ (char)createAccountSyncMigratedItemWithError:(id *)a0;
...
+ (char)removeAccountSyncItemForAccount:(id)a0 clientID:(id)a1 properties:(id)a2 error:(id *)a3;
