...
- (char)_accessGrantedForBundleID:(id)a0 onAccountTypeID:(id)a1;
- (char)_accessGrantedForClient:(id)a0 onAccountTypeID:(id)a1;
- (id)_appPermissionsForAccountTypeIdentifier:(id)a0;
- (char)_clientHasPermissionToAddAccount:(id)a0;
- (char)_isClientPermittedToAccessAccount:(id)a0;
- (char)_isClientPermittedToAccessAccountTypeWithIdentifier:(id)a0;
- (char)_isClientPermittedToRemoveAccount:(id)a0;
- (char)_wildCardAuthorizationMatchingForAccountTypeIdentifier:(id)a0;
- (id)initWithBackingAccountStore:(id)a0;
- (char)isClientEntitledToAccessAccountTypeWithIdentifier:(id)a0;
