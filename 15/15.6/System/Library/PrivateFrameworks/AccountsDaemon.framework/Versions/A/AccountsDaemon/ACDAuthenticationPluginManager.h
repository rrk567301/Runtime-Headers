...
- (void)_handleDiscoveryCompletionResult:(id)a0 forAccount:(id)a1 discoveryID:(id)a2 accountStore:(id)a3 shouldSave:(char)a4 error:(id)a5;
- (void)_handleRenewalCompletionResult:(long long)a0 forAccount:(id)a1 renewalID:(id)a2 accountStore:(id)a3 error:(id)a4;
- (void)_handleVerificationCompletionForAccount:(id)a0 verifiedAccount:(id)a1 error:(id)a2 store:(id)a3 shouldSave:(char)a4;
- (id)_pluginForAuthenticationType:(id)a0;
- (char)_renewalRequestIsWithinLimitsForAccount:(id)a0 accountStore:(id)a1;
