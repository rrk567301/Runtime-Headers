...
@property (class) char enableEngineTrace;
...
@property (readonly, getter=isOptimizationInProgress) char optimizationInProgress;
...
+ (char)_dbg_anyEngineContainsVariable:(id)a0;
+ (void)setLogOnInvalidUseFromBGThread:(char)a0;
...
- (char)exerciseAmbiguityInVariable:(id)a0;
- (char)hasValue:(double *)a0 forVariable:(id)a1;
...
- (char)valueOfVariableIsAmbiguous:(id)a0;
...
- (char)containsConstraintWithMarker:(id)a0;
...
- (char)hasObservableForVariable:(id)a0;
- (char)hasValue:(double *)a0 forExpression:(id)a1;
- (char)hasValueForPossiblyDeallocatedVariable:(id)a0;
- (double)integralizationAdjustmentForMarker:(id)a0;
- (char)isObservingChangesForVariable:(id)a0;
...
- (unsigned long long)replayCommandsData:(id)a0 verifyingIntegrity:(char)a1;
- (struct { unsigned long long x0; unsigned long long x1; unsigned int x2; unsigned int x3; unsigned int x4; struct *x5; } *)traceState;
- (char)tryToAddConstraintWithMarker:(id)a0 expression:(id)a1 integralizationAdjustment:(double)a2 mutuallyExclusiveConstraints:(id *)a3;
- (char)tryToAddConstraintWithMarker:(id)a0 expression:(id)a1 mutuallyExclusiveConstraints:(id *)a2;
- (char)tryToChangeConstraintSuchThatMarker:(id)a0 isReplacedByMarkerPlusDelta:(double)a1 undoHandler:(id /* block */)a2;
