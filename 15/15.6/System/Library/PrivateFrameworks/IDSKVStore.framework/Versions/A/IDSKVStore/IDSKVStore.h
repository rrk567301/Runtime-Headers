...
- (void)_onIvarQueue_performBlock:(id /* block */)a0 initializeStore:(char)a1;
- (void)_onIvarQueue_performBlock:(id /* block */)a0 initializeStore:(char)a1 waitUntilDone:(char)a2;
...
- (void)closeDatabaseSynchronously:(char)a0;
- (id)datasUpToLimit:(unsigned long long)a0 deleteContext:(id *)a1 error:(id *)a2;
- (char)deleteBatchWithContext:(id)a0 error:(id *)a1;
- (char)deleteEntriesBeforeDate:(id)a0 afterDate:(id)a1 error:(id *)a2;
- (char)persistData:(id)a0 forKey:(id)a1 error:(id *)a2;
