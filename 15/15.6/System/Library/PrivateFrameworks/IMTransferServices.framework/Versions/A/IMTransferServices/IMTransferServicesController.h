...
- (void)getNicknameWithRecordID:(id)a0 decryptionKey:(id)a1 wallpaperDataTag:(id)a2 wallpaperLowResDataTag:(id)a3 wallpaperMetadataTag:(id)a4 isKnownSender:(char)a5 completionBlock:(id /* block */)a6;
...
- (void)sendFilePath:(id)a0 topic:(id)a1 userInfo:(id)a2 transferID:(id)a3 encryptFile:(char)a4 progressBlock:(id /* block */)a5 completionBlock:(id /* block */)a6;
...
- (void)_sendFilePath:(id)a0 topic:(id)a1 userInfo:(id)a2 transferID:(id)a3 sourceAppID:(id)a4 encryptFile:(char)a5 retries:(int)a6 progressBlock:(id /* block */)a7 completionBlock:(id /* block */)a8;
...
- (void)sendFilePath:(id)a0 topic:(id)a1 transferID:(id)a2 encryptFile:(char)a3 progressBlock:(id /* block */)a4 completionBlock:(id /* block */)a5;
- (void)sendFilePath:(id)a0 topic:(id)a1 userInfo:(id)a2 transferID:(id)a3 sourceAppID:(id)a4 encryptFile:(char)a5 progressBlock:(id /* block */)a6 completionBlock:(id /* block */)a7;
