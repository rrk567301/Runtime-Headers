...
@interface SGDCloudKitSync : NSObject <APSConnectionDelegate> {
    ...
    char _accountInfoInFlight;
    _SGDCloudKitSyncPersistedState *_persistedState;
    long long _suspendCount;
    char _noZone;
    char _disabledBecauseOutOfDateSoftware;
    ...
    char _requestedFetchNewEntitiesWhileRequestAlreadyInFlight;
    NSError *_createZoneError;
    NSError *_deleteZoneError;
    NSError *_procureSaltError;
    char _processingStateChanges;
    char _pendingProcessStateChanges;
...
- (id)addWriteOperationForRecordGetter:(id /* block */)a0 deleteGetter:(id /* block */)a1 withRetries:(unsigned long long)a2 isFirstTry:(char)a3;
...
- (char)pauseIfNeededAndReturnRetryEligibilityForError:(id)a0;
- (id)privacySalt;
- (void)processStateChanges;
- (id)recordZoneId;
- (void)setDeleteAllSyncedItemsCallback:(id /* block */)a0;
- (void)setNewEntitiesCallback:(id /* block */)a0;
- (void)setReadyForNewEntities:(char)a0;
- (char)shouldRecreateZoneForRecordError:(id)a0 operationError:(id)a1;
