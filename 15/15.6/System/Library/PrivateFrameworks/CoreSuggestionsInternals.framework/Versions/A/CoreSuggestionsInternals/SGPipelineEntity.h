...
@interface SGPipelineEntity : SGEntity {
    char _flushExternalEnrichments;
    char _fullDownloadRequested;
    struct { struct { unsigned short bom; unsigned short tag; } _featureType; char hasInhumanHeaders; char inhumanEmailAddress; char inhumanAuthorName; char inhumanBody; char isTemplate; } _inhumanFeatures;
    struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } _dissectorLock;
    char _messageInhumannessChecked;
    struct _NSRange { unsigned long long location; unsigned long long length; } _dataDetectorsSignatureForTesting;
    char _overrideDataDetectorSignatureForTesting;
...
@property (readonly, nonatomic) struct { struct { unsigned short x0; unsigned short x1; } x0; char x1; char x2; char x3; char x4; char x5; } *inhumanFeatures;
@property (readonly, nonatomic) NSString *snippetsContent;
@property (nonatomic) char contactInformationExtracted;
...
@property (readonly, getter=hasFullDownloadBeenRequested) char fullDownloadRequested;
...
@property (nonatomic) char needsSourceVerification;
@property (nonatomic) char pendingVerification;
