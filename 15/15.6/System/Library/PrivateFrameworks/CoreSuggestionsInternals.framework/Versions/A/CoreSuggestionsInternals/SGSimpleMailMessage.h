@class NSData, SGSimpleNamedEmailAddress, NSString, NSArray, HVHtmlParser, _PASCachedResult, NSIndexSet, NSNumber;
...
@property (nonatomic) char hasInhumanHeaders;
@property (nonatomic) char isPartiallyDownloaded;
...
@property (readonly, nonatomic) char hasHumanHeaders;
@property (readonly, getter=mailCategories) NSNumber *mailCategories;

+ (char)supportsSecureCoding;
+ (id)parseRfc822:(id)a0 attachmentCallback:(id /* block */)a1;
+ (char)headersContainInhumanOnes:(id)a0 keys:(id)a1;
...
+ (id)decodeQuotedPrintable:(id)a0 charset:(unsigned long long)a1 rfc2047UnderscoreAsSpace:(char)a2;
+ (char)enumerateRfc822InNeXTMbox:(id)a0 tableOfContents:(id)a1 withBlock:(id /* block */)a2;
+ (id)formatFlowed:(id)a0 delSp:(char)a1;
+ (char)headerDictionaryContainsInhumanHeaders:(id)a0;
