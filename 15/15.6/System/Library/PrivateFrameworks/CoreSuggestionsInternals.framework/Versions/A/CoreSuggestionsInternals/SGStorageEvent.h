...
@property (readonly, nonatomic) char curated;
...
- (char)heuristicUpdatingEnabled;
- (id)initWithRecordId:(id)a0 duplicateKey:(id)a1 sourceKey:(id)a2 content:(id)a3 title:(id)a4 creationTimestamp:(struct SGUnixTimestamp_ { double x0; })a5 lastModifiedTimestamp:(struct SGUnixTimestamp_ { double x0; })a6 tags:(id)a7 when:(id)a8 locations:(id)a9 structuredData:(id)a10 state:(unsigned int)a11 curated:(char)a12;
- (char)isEqualToStorageEvent:(id)a0;
- (char)isFromDataDetectors;
- (char)isFromSuggestions;
- (id)urlFromTags;
