...
+ (id)duplicateKeyForWalletOrderIdentifier:(id)a0 parentKey:(id)a1;
+ (id)duplicateKeyForWalletPassIdentifier:(id)a0 parentKey:(id)a1;
+ (id)duplicateKeyForWebPageFromSource:(id)a0;
+ (char)serializationPassesBasicScrutiny:(id)a0;
...
- (id)interactionKey;
- (char)isEqualToDuplicateKey:(id)a0;
- (id)pseudoContactKey;
- (id)pseudoEventKey;
