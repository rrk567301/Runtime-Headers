...
@property (nonatomic) char hasCountUpTo8KB;
@property (nonatomic) unsigned int countUpTo8KB;
@property (nonatomic) char hasCount8KBTo32KB;
@property (nonatomic) unsigned int count8KBTo32KB;
@property (nonatomic) char hasCount32KBTo128KB;
@property (nonatomic) unsigned int count32KBTo128KB;
@property (nonatomic) char hasCount128KBTo512KB;
@property (nonatomic) unsigned int count128KBTo512KB;
@property (nonatomic) char hasCount512KBTo2MB;
@property (nonatomic) unsigned int count512KBTo2MB;
@property (nonatomic) char hasCountOver2MB;
