...
@interface SGDSuggestManager : NSObject <SGDSuggestManagerAllProtocol, HVContentAdmissionObserver, HVMailConsumer, HVInteractionConsumer> {
    ...
    char _persistRealtimeExtractions;
...
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(char)a1 keepPartialEvents:(char)a2;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(char)a1 keepPartialEvents:(char)a2 keepEventsFromOldDocuments:(char)a3;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(char)a1 keepPartialEvents:(char)a2 keepEventsFromOldDocuments:(char)a3 keepUnsupportedEventCategoryStatus:(char)a4;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(char)a1 keepPartialEvents:(char)a2 keepEventsFromOldDocuments:(char)a3 keepUnsupportedEventCategoryStatus:(char)a4 keepUnsupportedEventCategoryStatusForTextMessage:(char)a5;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(char)a1 keepPartialEvents:(char)a2 keepEventsFromOldDocuments:(char)a3 keepUnsupportedEventCategoryStatus:(char)a4 keepUnsupportedEventCategoryStatusForTextMessage:(char)a5 keepLLMExtractionForRealTime:(char)a6;
...
+ (char)titleSuggestionForMessageFeatureEnabled;
...
- (void)launchInfoForSuggestedEventWithUniqueIdentifier:(id)a0 sourceURL:(id)a1 clientLocale:(id)a2 ignoreUserActivitySupport:(char)a3 ignoreMailCheck:(char)a4 completion:(id /* block */)a5;
...
- (char)isSearchableItemPartOfReimport:(id)a0;
- (void)_harvestReservationsFromInteractions:(id)a0 bundleId:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
- (char)isSearchableItemPartOfReimportWithGetterBlock:(id /* block */)a0 bundleIdentifier:(id)a1;
...
- (char)_canBannerUseStoredDissection:(id)a0 options:(unsigned long long)a1;
- (void)_confirmReminderByRecordId:(id)a0 completion:(id /* block */)a1;
- (id)_emailContentCacheSalt;
- (void)_executeBoxTasks:(id)a0;
- (char)_harvestPeopleFromInteractions:(id)a0 bundleId:(id)a1;
- (char)_isContactInteresting:(id)a0 emailEntity:(id)a1 enrichments:(id)a2 hasContactCard:(unsigned long long)a3;
...
- (void)_performAction:(id)a0 onRecord:(id)a1 withParentConfirmation:(char)a2 confirmRejectUI:(int)a3 completion:(id /* block */)a4;
- (id)_pmlTraining;
...
- (void)_suggestionsFromMessage:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(char)a2 completionDelivery:(unsigned long long)a3 completionHandler:(id /* block */)a4;
- (void)_suggestionsFromSearchableItem:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(char)a2 processingType:(unsigned long long)a3 completionDelivery:(unsigned long long)a4 withCompletion:(id /* block */)a5;
- (void)_suggestionsFromSearchableItem:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(char)a2 withCompletion:(id /* block */)a3;
- (void)_suggestionsFromSingleSearchableItem:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(char)a2 processingType:(unsigned long long)a3 completionDelivery:(unsigned long long)a4 withCompletion:(id /* block */)a5;
...
- (void)batchSuggestionsFromSearchableItems:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(char)a2 processingType:(unsigned long long)a3 completionDelivery:(unsigned long long)a4 batchCompletion:(id /* block */)a5 writeBackCompletion:(id /* block */)a6 shouldStopSignal:(id /* block */)a7;
...
- (char)isSGEntity:(id)a0 duplicateOfEKEvent:(id)a1 withStore:(id)a2;
...
- (char)persistRealtimeExtractions;
- (void)realtimeSuggestionsForMailOrMessageWithHash:(id)a0 options:(unsigned long long)a1 completion:(id /* block */)a2 completionDelivery:(unsigned long long)a3 providedBy:(id /* block */)a4 searchableItem:(id)a5 dissectIfNecessary:(char)a6 isTextMessage:(char)a7;
- (void)realtimeSuggestionsForMailOrMessageWithHash:(id)a0 options:(unsigned long long)a1 completion:(id /* block */)a2 completionDelivery:(unsigned long long)a3 providedBy:(id /* block */)a4 searchableItem:(id)a5 dissectIfNecessary:(char)a6 processingType:(unsigned long long)a7 isTextMessage:(char)a8;
...
- (id)shortNamesAndRealtimeEventsFromEntity:(id)a0 message:(id)a1 enrichments:(id)a2 store:(id)a3 keepPastEvents:(char)a4 keepPartialEvents:(char)a5 keepEventsFromOldDocuments:(char)a6 keepUnsupportedEventCategoryStatus:(char)a7 keepUnsupportedEventCategoryStatusForTextMessage:(char)a8 keepLLMExtractionForRealtime:(char)a9;
