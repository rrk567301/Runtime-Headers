...
+ (char)caseInsensitiveContainsString:(id)a0 inCandidates:(id)a1;
...
- (id)initWithPlainText:(id)a0 category:(unsigned char)a1 dataDetectorMatches:(id)a2 enrichedTaggedCharacterRanges:(id)a3 modelOutput:(id)a4 fromSuggestTool:(char)a5;
