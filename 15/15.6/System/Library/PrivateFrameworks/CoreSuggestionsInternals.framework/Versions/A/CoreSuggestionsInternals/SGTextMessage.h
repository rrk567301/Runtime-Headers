...
@property char senderIsAccountOwner;
@property (retain) NSString *nickname;
@property (retain) NSString *photoPath;
@property (readonly) char senderIsBusinessChat;
@property (readonly) NSString *attachmentFilename;
@property (readonly, nonatomic) char isPotentialEventMessage;
@property (readonly, getter=isTapBack) char tapBack;
