...
@property (nonatomic) char hasTotalNumberOfEmailsProcessedForAttachmentDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) unsigned int totalNumberOfEmailsProcessedForAttachmentDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) char hasTotalNumberOfEmailsProcessedForRecipientDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) unsigned int totalNumberOfEmailsProcessedForRecipientDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) char hasTotalNumberOfEmailsProcessedForFollowUpDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) unsigned int totalNumberOfEmailsProcessedForFollowUpDetectionRoundedToClosestMultipleOf20;
@property (nonatomic) char hasNumberOfPredictedAttachmentOnLargeIncomingMailsWithAttachmentRoundedToClosestMultipleOf20;
...
@property (nonatomic) char hasNumberOfLargeIncomingMailsWithAttachmentRoundedToClosestMultipleOf20;
@property (nonatomic) unsigned int numberOfLargeIncomingMailsWithAttachmentRoundedToClosestMultipleOf20;
@property (nonatomic) char hasNumberOfPredictedAttachmentOnLargeOutgoingMailsWithAttachmentRoundedToClosestMultipleOf20;
...
@property (nonatomic) char hasNumberOfLargeOutgoingMailsWithAttachmentRoundedToClosestMultipleOf20;
