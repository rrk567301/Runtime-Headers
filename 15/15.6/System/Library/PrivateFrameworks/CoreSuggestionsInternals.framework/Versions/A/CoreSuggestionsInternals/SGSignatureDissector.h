...
- (char)_paragraphWithContent:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 exceedsLineLimit:(unsigned long long)a2 orCharacterLimit:(unsigned long long)a3;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfSenderName:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 restrictLength:(char)a2 forMessage:(id)a3;
...
- (char)shouldIgnoreSignature:(id)a0 signatureRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 isInhuman:(char *)a2;
