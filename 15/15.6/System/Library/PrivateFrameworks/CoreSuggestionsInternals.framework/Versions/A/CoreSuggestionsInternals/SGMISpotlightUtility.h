...
+ (char)queryFromDaysAgo:(unsigned long long)a0 throughDaysAgo:(unsigned long long)a1 limit:(unsigned long long)a2 withError:(id *)a3 handler:(id /* block */)a4;
+ (char)queryFromDaysAgo:(unsigned long long)a0 throughDaysAgo:(unsigned long long)a1 limit:(unsigned long long)a2 withError:(id *)a3 simulatedCSSIs:(id)a4 handler:(id /* block */)a5;
