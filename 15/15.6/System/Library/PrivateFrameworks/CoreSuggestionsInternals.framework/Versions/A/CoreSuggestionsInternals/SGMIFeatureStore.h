...
- (char)_applyCappingPolicy:(id)a0 shouldContinue:(id /* block */)a1 usingDatabase:(id)a2;
- (char)_areSubmodelsEmptyUsingDatabase:(id)a0;
...
- (char)_purgeTokensWhichLastUpdateWasBefore:(id)a0 shouldContinue:(id /* block */)a1 usingDatabase:(id)a2;
- (void)_runJournal;
- (id)_stringForFeatureName:(long long)a0;
- (id)_subModelsStatsWithShouldContinueBlock:(id /* block */)a0 usingDatabase:(id)a1;
- (char)_writeJournalCommand:(unsigned char)a0 blob:(id)a1;
- (char)applyCappingPolicy:(id)a0 shouldContinue:(id /* block */)a1;
...
- (void)incrementUserEngagement:(char)a0 forFollowUpWarning:(id)a1;
- (id)incrementUserEngagement:(char)a0 forWarning:(id)a1;
...
- (char)performMaintenanceWithShouldContinueBlock:(id /* block */)a0;
- (void)purgeOldNicknameMappingRecords;
- (char)purgeTokensWhichLastUpdateWasBefore:(id)a0 shouldContinue:(id /* block */)a1;
...
- (void)updateAttachmentDetectionStatsOnMailWithTextContent:(id)a0 attachments:(id)a1 warningRaised:(char)a2 attachmentPredicted:(char)a3 isIncomingMail:(char)a4;
- (void)updateFollowUpDetectionStatsWithWarning:(id)a0;
- (void)updateRecipientDetectionStatsWarningRaised:(char)a0;
- (long long)warningStatsCount;
- (id)warningStatsForLogging:(char)a0;
