...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithNameMappings:(id)a0 minimumConfidence:(int)a1 confidenceMapper:(id /* block */)a2 tokenToIgnore:(id)a3 forNameDetector:(char)a4;
- (id)initWithPlist:(id)a0 chunks:(id)a1 context:(id)a2;
- (char)isEqualToNameMappingTransformer:(id)a0;
- (char)isPossessive:(id)a0;
