...
+ (id)addParams:(id)a0 toParameterizedString:(id)a1 allowAlternatives:(char)a2;
+ (id)addressDictionaryToString:(id)a0;
+ (char)emailIsForwardOrReply:(id)a0;
...
- (char)checkCompletenessOfOutputEvent:(id)a0;
- (id)convertTextMessageToDUDocument:(id)a0;
- (id)jsonLdOutputFromPackedJSEntity:(id)a0;
- (id)DUFoundInEventResultForMail:(id)a0;
- (void)_addEnrichmentsToEntityForOutputItems:(id)a0 exceptions:(id)a1 jsMessageLogs:(id)a2 interaction:(id)a3 entity:(id)a4 startTime:(unsigned long long)a5 backPressureHazard:(int)a6 tagPartialEvent:(char)a7;
- (id)convertMailMessageToDUDocument:(id)a0;
- (char)requiredFieldsMissingForOutput:(id)a0;
...
- (char)_areAllOutputTemplatesSchemaOrg:(id)a0;
...
- (char)_isMailCategoryUnsupportedForLLMExtraction:(id)a0;
- (char)_shouldProcessMailMessage:(id)a0 havingSignificantSender:(char)a1;
- (char)_subjectResemblesForwardedMailSubjectForMail:(id)a0;
- (double)_timeIntervalAfterReceivingMessage:(id)a0;
- (char)_wasMessageReceivedMoreThanAWeekAgo:(id)a0;
...
- (char)checkHybridMLSupportForSenderOfMail:(id)a0;
- (char)checkMLExtractionSupportForMailLocale:(id)a0;
- (char)checkMLSupportForMailCategory:(unsigned char)a0;
- (char)checkMLSupportForMailWithEventClassification:(id)a0;
- (char)containsDateTextMessage:(id)a0;
...
- (id)entityForOutputItem:(id)a0 withSiblings:(id)a1 parentEntity:(id)a2 outputExceptions:(id)a3 outputInfos:(id)a4 interaction:(id)a5 tagPartialEvent:(char)a6;
...
- (char)exceedsMaxHTMLContentLength:(unsigned long long)a0;
- (id)extractMissingValueFromMLForMail:(id)a0 schema:(id)a1 fromSuggestTool:(char)a2 withFiEMLResults:(id)a3;
- (id)extractMissingValuesFromMLForMail:(id)a0 outputItems:(id)a1 fromSuggestTool:(char)a2;
- (id)extractMissingValuesFromMLForMail:(id)a0 outputItems:(id)a1 fromSuggestTool:(char)a2 withFiEMLResults:(id)a3;
- (id)extractSchemaFromMLForMail:(id)a0 fromSuggestTool:(char)a1 withEventClassification:(id)a2 withFiEMLResults:(id)a3;
- (void)fillReverseTemplateSchema:(id)a0 usingDUFoundInEvent:(id)a1 eventClassification:(id)a2 fromSuggestTool:(char)a3;
...
- (char)isMessageCandidateForExtraction:(id)a0;
- (char)isSenderRelevant:(id)a0;
...
- (char)mlExtractionEnabledForTextMessage;
...
- (char)requiredFieldsMissingForOutputItems:(id)a0;
...
- (char)shouldProcessTextMessage:(id)a0;
