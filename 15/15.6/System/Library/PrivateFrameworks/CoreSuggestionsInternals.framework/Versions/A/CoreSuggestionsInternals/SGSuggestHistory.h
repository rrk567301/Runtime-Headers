...
- (char)_anyHash:(id)a0 inSet:(id)a1;
- (id)hashesForOpaqueKey:(id)a0 forMatching:(char)a1;
- (id)keysForContactDetail:(id)a0 ofContact:(id)a1;
- (void)pushDontUpdate:(id)a0;
- (id)_canaryHash;
- (id)_hashesForConfirmedField:(id)a0 value:(id)a1 storageEvent:(id)a2 forMatching:(char)a3;
...
- (id)confirmHashesForOpaqueKey:(id)a0 withCreationTime:(struct SGUnixTimestamp_ { double x0; })a1 forMatching:(char)a2;
- (id)confirmHashesForOpaqueKeyWithoutTimestamp:(id)a0 forMatching:(char)a1;
- (id)confirmHashesForRemindersOpaqueKey:(id)a0 withCreationTime:(struct SGUnixTimestamp_ { double x0; })a1 forMatching:(char)a2;
...
- (char)hasConfirmedField:(id)a0 value:(id)a1 forStorageEvent:(id)a2;
- (char)hasContact:(id)a0;
- (char)hasContactDetail:(id)a0 forContact:(id)a1;
- (char)hasContactDetailKey:(id)a0;
- (char)hasStorageContact:(id)a0;
- (id)hashesByAddingCompatibilityHashesToHashes:(id)a0 forMatching:(char)a1;
- (id)hashesForContact:(id)a0 forMatching:(char)a1;
- (id)hashesForContactDetail:(id)a0 fromContact:(id)a1 forMatching:(char)a2;
- (id)hashesForCuratedContactDetail:(id)a0 fromContact:(id)a1 forMatching:(char)a2;
- (id)hashesForPseudoEventByKey:(id)a0 forMatching:(char)a1;
- (id)hashesForStorageContact:(id)a0 forMatching:(char)a1;
- (id)hashesForStrings:(id)a0 forMatching:(char)a1;
...
- (char)isConfirmedEvent:(id)a0;
- (char)isConfirmedEventWithoutTimeStamp:(id)a0;
- (char)isConfirmedReminder:(id)a0;
- (char)isRejectedEvent:(id)a0;
- (char)isRejectedReminder:(id)a0;
- (char)isUpdatableContact:(id)a0;
- (char)isValidCancelledEvent:(id)a0;
- (char)isValidNewEvent:(id)a0;
- (char)isValidNewReminder:(id)a0;
- (char)isValidSuggestion:(id)a0;
...
- (id)rejectHashesForOpaqueKey:(id)a0 forMatching:(char)a1;
