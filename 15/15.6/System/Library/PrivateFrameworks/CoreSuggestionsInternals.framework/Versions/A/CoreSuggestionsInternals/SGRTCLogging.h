...
+ (char)_createEmptyFileAtPath:(id)a0;
+ (id)_deepCopy:(id)a0;
...
- (char)incrementAndUpgradeInteractionSummaryForEventKey:(id)a0 interactionKey:(id)a1 parentEntity:(id)a2;
...
- (char)removeInteractionsSummaryLogsFromLogs:(id)a0;
- (char)resetExtractionLogs;
- (char)resetInteractionsLogs;
- (char)resetInteractionsSummaryLogs;
- (char)resetLogs;
