...
+ (char)_isStructuredEventEligibleForDonation:(id)a0;

- (void).cxx_destruct;
- (void)addEvent:(id)a0;
- (void)addEvents:(id)a0;
- (void)calendarDeleted;
- (void)_addEKEventToCalendar:(id)a0 storageEvent:(id)a1 ekStore:(id)a2 commit:(char)a3;
- (char)_cancelEKEvent:(id)a0 ekStore:(id)a1 error:(id *)a2;
- (id)_eventsAssociatedWithStorageEvent:(id)a0 store:(id)a1;
- (char)_isEKEventFromNLEventsCalendar:(id)a0 ekStore:(id)a1;
- (char)_isEKEventFromSuggestedCalendar:(id)a0 ekStore:(id)a1;
- (char)_newEventEligibleForDonation:(id)a0;
- (void)_removeEKEvent:(id)a0 store:(id)a1 commit:(char)a2;
- (void)_removeEvent:(id)a0 commit:(char)a1;
- (void)_runWithEKEventStore:(id /* block */)a0;
- (char)_updateEKEvent:(id)a0 withEvent:(id)a1 ekStore:(id)a2 error:(id *)a3;
...
- (void)addEvent:(id)a0 commit:(char)a1;
- (void)cancelEvent:(id)a0;
- (void)cancelEvent:(id)a0 commit:(char)a1;
