...
+ (char)isAddressContext:(id)a0;
+ (char)isBirthdayContext:(id)a0;
+ (char)isMaybeNameContext:(id)a0;
+ (char)isNameRequest:(id)a0;
+ (char)isTwoPersonConversation:(id)a0;
...
- (id)detectionFromBodyDDMatch:(id)a0 message:(id)a1 withSupervisionToFill:(id)a2 isUnlikelyPhone:(char)a3;
- (id)detectionFromSignatureDDMatch:(id)a0 message:(id)a1 detectedLabelRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2 lastClaimedLabelRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 isUnlikelyPhone:(char)a4;
