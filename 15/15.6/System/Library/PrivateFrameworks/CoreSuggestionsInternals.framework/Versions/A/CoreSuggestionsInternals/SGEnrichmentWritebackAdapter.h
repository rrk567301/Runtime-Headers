...
+ (id)_bundleIdentifierFromEvent:(id)a0;
+ (char)_isEligibleEvent:(id)a0;
+ (char)_isSupportedEntityTypes:(id)a0;

- (void)addEvent:(id)a0;
- (void)addEvents:(id)a0;
- (void)calendarDeleted;
- (id)_deleteEventsMatchingEvent:(id)a0 keepingNewerEvents:(char)a1;
