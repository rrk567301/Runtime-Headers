...
+ (char)personExistsInContacts:(id)a0 name:(id)a1 handle:(id)a2;

- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (char)numberMatchesContactsForm:(id)a0;
- (char)numberMatchesContactsForm:(id)a0 amongContactsWithIdentifiers:(id)a1;
