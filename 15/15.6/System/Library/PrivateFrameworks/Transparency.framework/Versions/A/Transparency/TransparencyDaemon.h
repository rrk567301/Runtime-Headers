...
- (void)insertResultForElement:(id)a0 samplesAgo:(id)a1 success:(char)a2 complete:(id /* block */)a3;
...
- (void)setOSUpdate:(char)a0 complete:(id /* block */)a1;
- (void)setOptInForURI:(id)a0 application:(id)a1 state:(char)a2 smtTimestamp:(id)a3 complete:(id /* block */)a4;
...
- (void)updateIDSRecommendation:(char)a0 complete:(id /* block */)a1;
