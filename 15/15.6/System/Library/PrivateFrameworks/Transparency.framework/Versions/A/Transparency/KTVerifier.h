...
- (unsigned long long)getDisplayStatusForResults:(id)a0 isSelfOptedIn:(char)a1;
- (char)ignoreFailureForResults:(id)a0 error:(id *)a1;
- (char)markFailureSeenForResults:(id)a0 error:(id *)a1;
- (void)batchQuery:(id)a0 userInitiated:(char)a1 block:(id /* block */)a2;
- (void)forceDutyCycle:(id /* block */)a0;
- (void)clearLogClientConfiguration:(id /* block */)a0;
- (char)clearPeerCache:(id)a0 error:(id *)a1;
...
- (void)getValidatePeerResult:(id)a0 uuid:(id)a1 fetchNow:(char)a2 completionBlock:(id /* block */)a3;
- (char)ignoreFailure:(id)a0 uuid:(id)a1 error:(id *)a2;
...
- (void)validatePeers:(id)a0 fetchNow:(char)a1 completionBlock:(id /* block */)a2;
