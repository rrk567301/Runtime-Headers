...
- (void)submitEventWithName:(id)a0 serviceName:(id)a1 uploadImmediately:(char)a2 payload:(id)a3;
- (void)removeCommonField:(id)a0;
- (id)sessionWithUUID:(id)a0 serviceName:(id)a1 uploadImmediately:(char)a2;
