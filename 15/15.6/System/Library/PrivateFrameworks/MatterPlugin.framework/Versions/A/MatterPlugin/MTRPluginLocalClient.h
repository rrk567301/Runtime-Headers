@class MTRPluginClient, NSMutableDictionary, NSMutableSet, NSSet, NSObject, NSString;
...
- (void)controller:(id)a0 suspendedChangedTo:(char)a1;
...
- (id)_deviceForControllerUUID:(id)a0 nodeID:(id)a1 requestedViaDelegate:(char)a2;
- (void)_registerDevice:(id)a0 addedViaDelegate:(char)a1;
