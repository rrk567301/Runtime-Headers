...
@property (getter=isTimedWrite) char timedWrite;

+ (id)writeAttributeMetricForDevice:(id)a0 homeID:(id)a1 clientType:(int)a2 endpointID:(id)a3 clusterID:(id)a4 attributeID:(id)a5 timedWrite:(char)a6 remoteMessageID:(id)a7;
