...
- (char)handleNewSessionSetupForMessage:(id)a0 transport:(id)a1 errorBlock:(id /* block */)a2;
- (char)invokeMessageHandlersForMessage:(id)a0 transport:(id)a1 errorBlock:(id /* block */)a2;
