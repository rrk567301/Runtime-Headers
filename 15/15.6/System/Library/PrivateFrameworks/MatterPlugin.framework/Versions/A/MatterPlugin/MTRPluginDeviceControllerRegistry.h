...
- (char)addDeviceController:(id)a0;
- (char)addDeviceController:(id)a0 forEntityWithIdentifier:(id)a1;
- (char)removeDeviceController:(id)a0;
...
- (void)_updateRunningMode:(long long)a0 forceUpdateControllerConfiguration:(char)a1 forHomeUUID:(id)a2;
