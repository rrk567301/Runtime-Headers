...
- (void)_sendMessageToHomeWithID:(id)a0 messageType:(int)a1 pbCodable:(id)a2 timeout:(double)a3 metric:(id)a4 errorBlock:(id /* block */)a5 replyBlock:(id /* block */)a6;
...
- (void)controller:(id)a0 isSuspended:(char)a1;
