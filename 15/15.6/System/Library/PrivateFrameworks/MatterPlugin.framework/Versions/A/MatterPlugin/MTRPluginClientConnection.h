...
@property int pid;
@property char backgroundModeEntitled;
...
- (char)_isRunning;
- (id)initWithClientConnection:(id)a0 backgroundModeEntitled:(char)a1 pid:(int)a2 context:(id)a3 delegate:(id)a4 delegateQueue:(id)a5;
...
- (void)_assignHomeUUIDIfUnassigned:(id)a0;
- (char)_deliverMessagePayloadToPrimaryResident:(id)a0 timeout:(double)a1 responseHandler:(id /* block */)a2;
