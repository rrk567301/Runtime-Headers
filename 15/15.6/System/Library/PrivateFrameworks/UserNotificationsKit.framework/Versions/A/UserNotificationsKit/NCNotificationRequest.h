@class NSDate, NCNotificationAlertOptions, NCNotificationContent, NSDictionary, DNDClientEventBehavior, NCNotificationSound, NSString, NSSet, UNNotification, NCNotificationOptions, NSArray, NCNotificationAction, NSUUID;
...
@property (readonly, nonatomic, getter=isUniqueThreadIdentifier) char threadIdentifierUnique;
...
@property (readonly, nonatomic) char isCollapsedNotification;
...
@property (readonly, nonatomic, getter=isCriticalAlert) char criticalAlert;
...
@property (nonatomic) char isPresentedAsBanner;
...
+ (id)notificationRequestWithNotificationId:(id)a0 requestDestinations:(id)a1 isCritical:(char)a2;
+ (id)notificationRequestWithNotificationId:(id)a0 requestDestinations:(id)a1 lockScreenPersistence:(unsigned long long)a2;
+ (id)notificationRequestWithNotificationId:(id)a0 requestDestinations:(id)a1 lockScreenPersistence:(unsigned long long)a2 alertOptionsSuppression:(unsigned long long)a3;
...
+ (id)notificationRequestWithSectionId:(id)a0 notificationId:(id)a1 threadId:(id)a2 subSectionIds:(id)a3 title:(id)a4 message:(id)a5 timestamp:(id)a6 destinations:(id)a7 options:(id)a8 alertOptions:(id)a9 uuid:(id)a10;
+ (id)notificationRequestWithSectionId:(id)a0 notificationId:(id)a1 threadId:(id)a2 subSectionIds:(id)a3 title:(id)a4 message:(id)a5 timestamp:(id)a6 destinations:(id)a7 options:(id)a8 uuid:(id)a9;
...
+ (id)notificationRequestWithSectionId:(id)a0 notificationId:(id)a1 threadId:(id)a2 title:(id)a3 message:(id)a4 timestamp:(id)a5 destination:(id)a6 uuid:(id)a7;
...
- (char)isCollapsibleWithNotificationRequest:(id)a0;
- (char)matchesThreadForRequest:(id)a0;
