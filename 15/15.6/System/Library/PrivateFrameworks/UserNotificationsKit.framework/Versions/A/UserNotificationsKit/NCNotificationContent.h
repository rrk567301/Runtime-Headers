...
@property (readonly, nonatomic, getter=isDateAllDay) char dateAllDay;
...
@property (readonly, nonatomic, getter=isMessagingType) char messagingType;
@property (readonly, nonatomic, getter=isCallType) char callType;
@property (readonly, nonatomic, getter=isCommunicationType) char communicationType;
