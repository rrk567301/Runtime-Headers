...
@property (nonatomic, getter=isUniqueThreadIdentifier) char threadIdentifierUnique;
...
- (void)setRelevanceScore:(float)a0;
- (void)setSourceInfo:(id)a0;
- (void)setEventBehavior:(id)a0;
- (void)setIsHighlight:(char)a0;
...
- (void)setIsRemoved:(char)a0;
- (void)setPriorityStatus:(unsigned long long)a0;
- (void)setSummaryStatus:(unsigned long long)a0;
- (void)setCollapsedNotificationsCount:(unsigned long long)a0;
- (void)setAlertOptions:(id)a0;
- (void)setCriticalAlert:(char)a0;
- (void)setHighestPrioritySubSectionIdentifier:(id)a0;
- (void)setInlineAction:(id)a0;
- (void)setIsCollapsedNotification:(char)a0;
- (void)setIsPresentedAsBanner:(char)a0;
...
- (void)setThreadIdentifierUnique:(char)a0;
