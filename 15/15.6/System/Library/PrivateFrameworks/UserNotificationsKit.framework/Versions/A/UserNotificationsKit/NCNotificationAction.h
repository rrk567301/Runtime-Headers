...
@property (readonly, nonatomic, getter=isSystemAction) char systemAction;
@property (readonly, nonatomic) char requiresAuthentication;
@property (readonly, nonatomic, getter=isDestructiveAction) char destructiveAction;
@property (readonly, nonatomic) char shouldDismissNotification;
@property (readonly, nonatomic) char isSiriActionCandidate;
