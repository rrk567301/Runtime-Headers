...
- (char)addRssiSample:(double)a0 channel:(unsigned int)a1 forPeer:(id)a2 peerDeviceModel:(id)a3 withError:(id *)a4;
...
- (void)stopInitiating;
- (void)stopProx;
- (char)trackNewBTPeer:(id)a0 withDviceModel:(id)a1 error:(id *)a2;
