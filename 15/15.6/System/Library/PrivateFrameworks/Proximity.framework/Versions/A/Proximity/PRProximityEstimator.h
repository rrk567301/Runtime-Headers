...
- (char)addRssiSample:(double)a0 channel:(unsigned int)a1 forPeer:(id)a2 withError:(id *)a3;
- (id)initSingleThresholdEstmatorWithDelegate:(id)a0 delegateQueue:(id)a1;
- (void)invokeDelegateBlock:(id /* block */)a0;
- (char)startEstimatingProximityFor:(id)a0 peerDeviceModel:(id)a1 withError:(id *)a2;
- (char)stopEstimatingProximityFor:(id)a0 withError:(id *)a1;
