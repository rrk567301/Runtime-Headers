...
- (void)startClient;
- (void)addOperationsToFetchMergeableDeltasFromDevice:(id)a0 isReciprocal:(char)a1;
- (id)buildBasePeerToPeerMessage;
- (id)buildDoneFetchingMergeableDeltasMessageToDevice:(id)a0 withIsReciprocal:(char)a1;
...
- (char)rapportManager:(id)a0 isDeviceSupported:(id)a1;
