...
@property (nonatomic) char delegatesComplete;
...
- (id)init;
- (void).cxx_destruct;
- (char)setTestMode:(id *)a0;
- (void)_invalidateObject;
- (void)reportProgress:(id)a0;
- (id)_waitForPendingDelegateMessages;
- (void)allStagedUpdatesWithCompletion:(id /* block */)a0;
- (void)cancelUpdateForStagedIdentifiers:(id)a0 completion:(id /* block */)a1;
- (void)checkCapabilities:(id)a0 withOptions:(id)a1 completion:(id /* block */)a2;
- (char)clearTestFlags:(unsigned long long)a0 withError:(id *)a1;
...
- (void)finalizeStagedInstallForIdentifier:(id)a0 returningResultInfo:(char)a1 completion:(id /* block */)a2;
- (void)getAppMetadataForApp:(id)a0 completion:(id /* block */)a1;
- (char)getTestModeEnabled:(char *)a0 outError:(id *)a1;
- (void)installParallelPlaceholderForStagedIdentifier:(id)a0 returningResultInfo:(char)a1 completion:(id /* block */)a2;
- (void)installURL:(id)a0 identity:(id)a1 targetingDomain:(unsigned long long)a2 withOptions:(id)a3 returningResultInfo:(char)a4 completion:(id /* block */)a5;
- (void)lookupUninstalledWithOptions:(id)a0 completion:(id /* block */)a1;
- (int)pidForTesting;
- (id)raiseException;
- (void)releaseTerminationAssertion;
- (char)setEligibilityTestOverrides:(id)a0 withError:(id *)a1;
- (char)setTestFlags:(unsigned long long)a0 withError:(id *)a1;
