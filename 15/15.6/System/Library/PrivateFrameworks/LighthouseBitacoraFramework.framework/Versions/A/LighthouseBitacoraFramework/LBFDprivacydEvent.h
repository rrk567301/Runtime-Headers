...
- (void).cxx_destruct;
- (id)initWithEventPhase:(int)a0 eventUUID:(id)a1 succeeded:(char)a2 error:(id)a3 aggregateFunction:(int)a4 count:(int)a5;
- (id)initWithEventPhase:(int)a0 eventUUID:(id)a1 succeeded:(char)a2 error:(id)a3;
