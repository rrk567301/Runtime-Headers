...
@property (nonatomic) char descriptionIsClipped;
...
@property (nonatomic) char showEditSettingsWithActionButtons;
...
- (id)playButtonTitle;
- (char)avatarsShouldBeHidden;
- (char)calloutAreaShouldBeHidden;
- (unsigned long long)currentFavoritedState;
- (char)descriptionCurrentlyClipping;
- (char)descriptionIsVisible;
...
- (id)ownBundle;
- (char)playButtonsShouldBeEnabled;
- (long long)selectedSettingsOption;
- (void)setTitle1AdornedString:(id)a0;
- (void)setUseArtwork16By9Ratio:(char)a0;
- (char)settingsButtonShouldBeHidden;
- (id)settingsButtonTitle;
- (char)settingsCalloutButtonShouldBeHidden;
- (id)settingsDropDownMenu;
- (void)setupMoreMask;
- (char)shouldHideSettingsDropDown;
- (char)showCollabActivationButton;
- (char)showCollabAttention;
- (char)showCollabManagementButton;
- (void)showFullDescription:(id)a0;
- (char)shuffleButtonShouldBeHidden;
- (char)starRatingShouldBeEditable;
- (char)starRatingShouldBeHidden;
- (char)subTitleShouldBeHidden;
- (id)tertitle;
- (char)tertitleIsActionable;
- (char)tertitleShouldBeHidden;
