...
@property (nonatomic) char targetAppIsActive;
...
@property (nonatomic) char targetingToConnect;
@property (nonatomic) char clickingToConnect;
...
- (char)_constraintIsNonRequired:(id)a0;
- (char)_constraintMatchesFocusedID:(id)a0;
...
- (void)addArrowTo:(id)a0 center:(struct CGPoint { double x0; double x1; })a1 tail:(struct CGPoint { double x0; double x1; })a2 invert:(char)a3 arrowSize:(double)a4;
