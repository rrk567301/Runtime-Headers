...
- (id)layoutAttributesForSection:(long long)a0 topRow:(long long)a1 bottomRow:(long long)a2 enclosingBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 includeHeader:(char)a4;
...
- (long long)rowInSection:(long long)a0 atYCoord:(double)a1 pinned:(char)a2;
