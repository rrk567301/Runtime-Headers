...
@property (nonatomic) char appearanceIsSystem;
@property (nonatomic) char appearanceIsInverted;
@property (nonatomic) char appearanceIsAlwaysDark;
...
- (void)visualizeSecondaryObject:(id)a0 activate:(char)a1;
