...
@property (nonatomic, readonly) char playButtonsShouldBeEnabled;
@property (nonatomic, readonly) char hideEditButton;
@property (nonatomic, readonly) char settingsButtonShouldBeHidden;
