...
- (void)refreshBackgroundOnRow:(long long)a0 animate:(char)a1;
- (id)ampTableView:(id)a0 menuForRows:(id)a1;
- (id)backgroundColorForTableRow:(long long)a0 section:(long long)a1 sectionRow:(long long)a2 currentRolloverTableRow:(long long)a3 isDark:(char)a4 isHighContrast:(char)a5;
...
- (char)shouldCreateCellsForModel:(id)a0;
