...
@property (nonatomic, readonly) char modelSupportsPlayback;
@property (nonatomic, readonly) char shouldHideRollOver;
@property (nonatomic, readonly) char shouldHidePreviewProgress;
@property (nonatomic, readonly) char shouldHideBouncyLines;
