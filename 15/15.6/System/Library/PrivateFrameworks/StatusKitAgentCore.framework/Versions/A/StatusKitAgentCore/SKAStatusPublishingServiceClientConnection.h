...
+ (id)logger;
+ (char)_connection:(id)a0 isEntitledForPublishingWithStatusTypeIdentifier:(id)a1;
+ (char)clientIsEntitledForAtLeastOnePublishingServiceType:(id)a0;

- (void)dealloc;
- (id)description;
- (void).cxx_destruct;
- (id)asynchronousRemoteDaemonDelegateWithErrorHandler:(id /* block */)a0;
- (char)clientIsEntitledForPublishingWithStatusTypeIdentifier:(id)a0;
