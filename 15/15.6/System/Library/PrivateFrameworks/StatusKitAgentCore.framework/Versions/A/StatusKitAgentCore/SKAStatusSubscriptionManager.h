...
- (char)_activeTransientAssertionsExist;
...
- (char)_activePresenceAssertionsExist;
- (id)_activePresenceSubscriptionsForClient:(id)a0;
- (id)_activeTransientSubscriptionsForClient:(id)a0;
- (char)_addPresenceSubscriptionAssertionForClient:(id)a0 subscriptionIdentifier:(id)a1;
- (char)_addTransientSubscriptionAssertionForClient:(id)a0 subscriptionIdentifier:(id)a1;
...
- (void)_removeActivePresenceSubscriptionsForClient:(id)a0;
- (void)_removeActiveTransientSubscriptionsForClient:(id)a0;
- (char)_removePresenceSubscriptionAssertionForClient:(id)a0 subscriptionIdentifier:(id)a1;
- (char)_removeTransientSubscriptionAssertionForClient:(id)a0 subscriptionIdentifier:(id)a1;
- (id)_sortAndDedupeSubscriptionIdentifiers:(id)a0;
- (id)_statusTypeIdentifiersRequiringSelfSubscription;
- (double)_subscriptionTTL;
- (char)activePresenceSubscriptionAssertionsExistForChannelIdentifier:(id)a0;
