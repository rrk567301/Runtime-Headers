...
- (void)allSubscriptionMetadatasForStatusTypeIdentifier:(id)a0 includingPersonalSubscription:(char)a1 completion:(id /* block */)a2;
...
- (char)_validateChannelIsKnownForSubscriptionIdentifier:(id)a0 statusTypeIdentifier:(id)a1 databaseContext:(id)a2;
- (void)accountIsStatusKitCapableWithCompletion:(id /* block */)a0;
- (char)channelMatchesClientStatusTypeIdentifier:(id)a0;
...
- (id)initWithXPCConnection:(id)a0 queue:(id)a1 delegate:(id)a2 databaseManager:(id)a3 subscriptionManager:(id)a4 encryptionManager:(id)a5 inTrafficMode:(char)a6;
