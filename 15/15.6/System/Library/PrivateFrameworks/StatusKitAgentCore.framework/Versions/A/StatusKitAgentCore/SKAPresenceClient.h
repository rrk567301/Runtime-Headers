@class SKAPresenceClientConnection, NSString, NSSet, SKPresencePayload, SKPresenceOptions, NSObject;
...
@property (nonatomic) char activeSubscription;
@property (retain, nonatomic) NSString *activeSubscriptionIdentifier;
@property (nonatomic) char activeAssertion;
...
- (char)presenceIdentifierMatchesClient:(id)a0;
