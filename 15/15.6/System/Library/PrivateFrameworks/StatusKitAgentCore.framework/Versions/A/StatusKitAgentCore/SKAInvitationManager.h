...
@property (nonatomic) char presenceEnabledByServer;
...
- (id)_ratchetEncryptionKeyForwardOrKeyRollForPersonalChannel:(id)a0 databaseContext:(id)a1 invitationWasSentViaKeyRoll:(char *)a2 error:(id *)a3;
- (char)_rollEncryptionKeyForChannel:(id)a0 databaseContext:(id)a1 error:(id *)a2;
- (char)_sendInvitationMessageForChannel:(id)a0 toInvitedUsers:(id)a1 subscriptionKeys:(id)a2 error:(id *)a3;
- (char)_sendInvitationMessageForPresenceChannel:(id)a0 toInvitedUsers:(id)a1 error:(id *)a2;
...
- (char)_validateInvitedHandle:(id)a0;
...
- (id)initWithMessagingProvider:(id)a0 databaseManager:(id)a1 accountProvider:(id)a2 channelManager:(id)a3 presenceManager:(id)a4 trafficMode:(char)a5;
...
- (void)outgoingMessageWithIdentifier:(id)a0 fromHandle:(id)a1 toHandle:(id)a2 didSendWithSuccess:(char)a3;
...
- (char)rollEncryptionKeyForPersonalChannelWithStatusTypeIdentifier:(id)a0 error:(id *)a1;
- (void)rollPersonalChannelWithStatusTypeIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)rollPresenceChannelWithPresenceIdentifier:(id)a0 isPersonal:(char)a1 completion:(id /* block */)a2;
...
- (void)sendSelfInvitationForPresenceChannelWithPresenceIdentifier:(id)a0 isPersonal:(char)a1 completion:(id /* block */)a2;
