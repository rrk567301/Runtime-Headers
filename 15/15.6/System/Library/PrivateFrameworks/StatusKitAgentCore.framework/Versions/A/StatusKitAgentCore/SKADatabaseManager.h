...
- (char)deleteRemovedUserWithHandle:(id)a0 presenceIdentifier:(id)a1 databaseContext:(id)a2;
...
- (id)_existingChannelsForChannelIdentifier:(id)a0 isPersonal:(char)a1 databaseContext:(id)a2;
- (id)_existingChannelsForDatabaseChannel:(id)a0 databaseContext:(id)a1;
- (id)_existingChannelsForPresenceIdentifier:(id)a0 isPersonal:(char)a1 databaseContext:(id)a2;
...
- (id)_existingReceivedInvitationsForChannelIdentifier:(id)a0 sortedByDateReceived:(char)a1 databaseContect:(id)a2;
...
- (id)_existingTransientSubscriptionHistoryWithLimit:(long long)a0 orderedByLastSubscriptionDateAscending:(char)a1 databaseContext:(id)a2;
- (id)allExistingChannelsForHandle:(id)a0 statusTypeIdentifier:(id)a1 databaseContext:(id)a2;
- (id)allExistingChannelsForStatusTypeIdentifier:(id)a0 includingPersonalChannel:(char)a1 databaseContext:(id)a2;
...
- (char)copyInvitedUsersFromChannel:(id)a0 toChannel:(id)a1 databaseContext:(id)a2;
...
- (char)createOrUpdateOrDeleteSubscribedLocalStatus:(id)a0 databaseContext:(id)a1 error:(id *)a2;
- (char)createOrUpdatePublishedLocalStatusDevices:(id)a0 databaseContext:(id)a1 error:(id *)a2;
- (char)createOrUpdatePublishedLocalStatuses:(id)a0 databaseContext:(id)a1 error:(id *)a2;
...
- (char)decomissionAllPersonalChannelsWithStatusTypeIdentifier:(id)a0 databaseContext:(id)a1;
- (char)decomissionChannelWithIdentifier:(id)a0 databaseContext:(id)a1;
- (char)deleteAllInvitedUsersForPersonalChannel:(id)a0 databaseContext:(id)a1;
- (char)deleteInvitedUserForHandle:(id)a0 personalChannel:(id)a1 databaseContext:(id)a2;
- (char)deleteInvitedUserForHandle:(id)a0 presenceChannel:(id)a1 databaseContext:(id)a2;
- (char)deletePendingPublishRequestWithWithUniqueIdentifier:(id)a0 databaseContext:(id)a1;
- (char)deletePersonalChannelForStatusTypeIdentifier:(id)a0 databaseContext:(id)a1;
- (char)deletePublishedLocalStatusDevices:(id)a0 databaseContext:(id)a1 error:(id *)a2;
- (char)deleteRemovedUserWithHandle:(id)a0 statusTypeIdentifier:(id)a1 databaseContext:(id)a2;
- (char)deleteSubscriptionAssertionWithSubscriptionIdentifier:(id)a0 applicationIdentifier:(id)a1 databaseContext:(id)a2;
...
- (id)existingChannelForPresenceIdentifier:(id)a0 isPersonal:(char)a1 databaseContext:(id)a2;
...
- (char)incrementPendingPublishRequestRetryCountWithUniqueIdentifier:(id)a0 databaseContext:(id)a1;
- (id)initWithDatabaseProvider:(id)a0 delegate:(id)a1;
- (id)receivedInvitationsForChannel:(id)a0 databaseContext:(id)a1;
- (char)setCurrentCheckpointForChannel:(id)a0 checkpoint:(unsigned long long)a1 databaseContext:(id)a2;
