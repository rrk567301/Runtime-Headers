...
@property (nonatomic) char accountCheckCompleted;
@property (nonatomic) char accountSupportsDeviceToDeviceEncryption;
@property (nonatomic) char hasInitialCloudKitImportOccurred;
@property (nonatomic) char cloudKitSetupCompleted;
...
- (char)overrideDeviceEncryptionCheck;
- (char)performInitialImportQueryWithContainer:(id)a0;
