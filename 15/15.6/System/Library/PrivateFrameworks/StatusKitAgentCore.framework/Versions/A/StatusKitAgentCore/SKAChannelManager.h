...
- (void)assertPresence:(id)a0 onChannel:(id)a1 membershipKey:(id)a2 serverKey:(id)a3 timestamp:(id)a4 withChannelToken:(id)a5 serviceIdentifier:(id)a6 isRefresh:(char)a7 completion:(id /* block */)a8;
...
- (void)publishData:(id)a0 onChannel:(id)a1 withChannelToken:(id)a2 publishInitiateTime:(id)a3 isPendingPublish:(char)a4 isScheduledPublish:(char)a5 retryCount:(unsigned long long)a6 completion:(id /* block */)a7;
