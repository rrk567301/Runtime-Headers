...
@interface APBonjourCacheManager : NSObject {
    ...
    char _isMonitoringKnownNetworkProfile;
    char _isPublicAirPlayNetwork;
}
...
- (void)_deviceFound:(id)a0 altPairedInfo:(id)a1 recheck:(char)a2 event:(long long)a3;
- (void)_ensureKnownNetworkProfileMonitoringStarted;
- (void)_flushCachedItems;
- (id)_getCacheDirectoryURLCreateIfNecessary:(char)a0 error:(id *)a1;
- (id)_getCacheFileURLCreateIfNecessary:(char)a0 error:(id *)a1;
- (void)_handleKnownNetworkProfileUpdate:(char)a0;
...
- (void)_removeIfDuplicatesFoundOrIfNoLongerCacheable:(unsigned long long)a0 identifier:(id)a1 serialNumber:(id)a2 manufacturer:(id)a3 isCacheable:(char)a4;
