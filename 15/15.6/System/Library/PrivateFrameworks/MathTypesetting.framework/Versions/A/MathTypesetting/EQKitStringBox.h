...
- (char)p_appendEntryToSpec:(void *)a0 run:(struct __CTRun { } *)a1 glyphRange:(struct { long long x0; long long x1; })a2 offset:(struct CGPoint { double x0; double x1; })a3;
