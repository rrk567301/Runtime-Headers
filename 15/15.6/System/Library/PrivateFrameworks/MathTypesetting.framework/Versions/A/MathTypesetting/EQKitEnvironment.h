...
@property (nonatomic, getter=isKerningEnabled) char kerningEnabled;
@property (readonly, nonatomic) NSData *data;
@property (copy, nonatomic) NSString *mathFontName;
@property (nonatomic) char usesLegacySTIXFonts;
@property (nonatomic) char sourceAttribution;
@property (nonatomic) char allowSingleLineHeight;
@property (readonly, nonatomic) char fontsLoadedCorrectly;
...
- (id)i_mathFontName;
- (char)i_requiresLegacySTIXFonts;
- (char)needsToReloadFontsWhenAddingFontNamed:(id)a0;
- (void)reloadFonts;
