...
@property (readonly, nonatomic) char _shouldHighlightEmoji;
...
@property (readonly, nonatomic) char supportsSkinToneVariants;
...
@property (readonly, nonatomic) char isCommon;
@property (readonly, nonatomic) char isNewEmoji;
...
- (char)isEqualIgnoringModifiers:(id)a0;
- (id)nameForType:(int)a0;
- (id)relatedEmojiTokens:(unsigned long long)a0;
- (char)supportsPresentationStyle:(int)a0;
