...
+ (struct __EmojiTokenWrapper { } *)_emojiTokenForDocumentID:(id)a0 usingLocaleData:(struct __EmojiLocaleDataWrapper { } *)a1;
...
- (id)emojiStringMatchesUsingEmojiLocaleData:(struct __EmojiLocaleDataWrapper { } *)a0;
