...
+ (id)matcherWithDirectories:(id)a0 initializeModelsPreemptively:(char)a1 error:(id *)a2;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)performFullCacheUpdateWithUserShortcuts:(id)a0 applicationInfos:(id)a1 error:(id *)a2;
- (char)deregisterApp:(id)a0 error:(id *)a1;
- (char)handleUserShortcutsDatabaseChanged:(id)a0 error:(id *)a1;
- (char)performFullCacheUpdate:(id)a0 error:(id *)a1;
- (char)registerApp:(id)a0 error:(id *)a1;
...
- (char)_performFullCacheUpdateInnerWithUserShortcuts:(id)a0 applicationInfos:(id)a1 error:(id *)a2;
