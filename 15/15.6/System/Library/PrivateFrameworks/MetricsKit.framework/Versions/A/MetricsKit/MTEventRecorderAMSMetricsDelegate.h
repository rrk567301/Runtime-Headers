...
@property (getter=isTransactionEnabled) char transactionEnabled;
@property long long flushMode;
@property double flushTimeInterval;
@property (getter=isFlushTimerEnabled) char flushTimerEnabled;
@property long long maximumBatchSize;
@property char personalizedWithItunesAccount;
