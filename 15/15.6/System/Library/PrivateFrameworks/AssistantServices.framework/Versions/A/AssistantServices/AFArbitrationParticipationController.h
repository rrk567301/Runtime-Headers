...
- (void)_updateUserFeedbackParticipationAllAdvertisements:(id)a0 session:(id)a1 ownRecord:(id)a2 won:(char)a3 triggerType:(id)a4 lastActivationTime:(double)a5 requestStartDate:(id)a6 voiceTriggerDate:(id)a7 scoreBoosters:(id)a8 deviceClass:(unsigned char)a9;
- (void)arbitrationDidUpdateWithContext:(id)a0 session:(id)a1 completion:(id /* block */)a2;
