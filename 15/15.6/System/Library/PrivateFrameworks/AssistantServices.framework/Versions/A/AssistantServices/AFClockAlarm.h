...
@property (readonly, nonatomic) char isSnoozed;
@property (readonly, copy, nonatomic) NSDate *firedDate;
@property (readonly, copy, nonatomic) NSDate *dismissedDate;
@property (readonly, copy, nonatomic) NSDate *lastModifiedDate;
@property (readonly) unsigned long long hash;
...
- (id)initWithAlarmID:(id)a0 alarmURL:(id)a1 isFiring:(char)a2 title:(id)a3 type:(unsigned long long)a4 hour:(unsigned long long)a5 minute:(unsigned long long)a6 repeatOptions:(unsigned long long)a7 isEnabled:(char)a8 isSnoozed:(char)a9 firedDate:(id)a10 dismissedDate:(id)a11 lastModifiedDate:(id)a12;
