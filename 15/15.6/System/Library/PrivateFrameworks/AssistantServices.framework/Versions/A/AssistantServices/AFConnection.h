...
@interface AFConnection : NSObject <NSXPCListenerDelegate, AFAudioPowerUpdaterDelegate, AFAccessibilityListening, AFDeviceRingerSwitchListening, AFInterstitialProviderDelegate> {
    ...
    char _connectionHadActiveNetwork;
...
+ (char)assistantIsSupportedForLanguageCode:(id)a0 error:(id *)a1;
+ (void)beginMonitoringAvailability;
+ (char)siriIsSupportedForLanguageCode:(id)a0 deviceProductVersion:(id)a1 error:(id *)a2;
+ (char)siriIsSupportedForLanguageCode:(id)a0 productName:(id)a1 productVersion:(id)a2 error:(id *)a3;
...
- (id)_cachedBulletins;
- (void)_checkAndSetIsCapturingSpeech:(char)a0;
...
- (void)_dispatchCommand:(id)a0 isInterstitial:(char)a1 interstitialPhase:(long long)a2 interstitialDelay:(double)a3 reply:(id /* block */)a4;
...
- (void)_requestDidEnd;
- (void)_requestWillBeginWithRequestClass:(id)a0 isSpeechRequest:(char)a1 speechRequestOptions:(id)a2 requestInfo:(id)a3 analyticsEventProvider:(id /* block */)a4;
- (void)_requestWillBeginWithRequestClass:(id)a0 isSpeechRequest:(char)a1 speechRequestOptions:(id)a2 requestInfo:(id)a3 isBackgroundRequest:(char)a4 analyticsEventProvider:(id /* block */)a5;
- (void)_scheduleRequestTimeoutForReason:(id)a0 durationInSeconds:(double)a1;
- (void)_setShouldSpeak:(char)a0;
- (char)_shouldEmitUEIRequestLinkForRequestInfo:(id)a0 speechRequestOptions:(id)a1;
- (id)_siriClientStateManager;
- (void)_speechRecordingDidFailWithError:(id)a0;
- (char)_startInputAudioPowerUpdatesWithXPCWrapper:(id)a0;
- (id)_startRequestMetricSettings;
- (void)_startRequestTimeoutTimerWithTimeInterval:(double)a0 reason:(id)a1;
- (void)_startRequestWithAceCommand:(id)a0 turnIdentifier:(id)a1 suppressAlert:(char)a2;
...
- (void)_tellDelegateAudioSessionDidBecomeActive:(char)a0;
- (void)_tellDelegateAudioSessionDidBeginInterruptionWithUserInfo:(id)a0;
- (void)_tellDelegateAudioSessionDidEndInterruption:(char)a0 userInfo:(id)a1;
- (void)_tellDelegateAudioSessionWillBecomeActive:(char)a0;
- (void)_tellDelegateCacheImage:(id)a0;
- (void)_tellDelegateDidDetectMusic;
- (void)_tellDelegateDidFinishAcousticIDRequestWithSuccess:(char)a0;
...
- (void)_tellDelegateShouldSpeakChanged:(char)a0;
...
- (void)_willStartRequestWithSpeech:(char)a0 speechRequestOptions:(id)a1 requestInfo:(id)a2 analyticsEventProvider:(id /* block */)a3;
...
- (void)adviseSessionArbiterToContinueWithPreviousWinner:(char)a0;
...
- (void)startSpeechRequestWithSpeechFileAtURL:(id)a0 isNarrowBand:(char)a1;
