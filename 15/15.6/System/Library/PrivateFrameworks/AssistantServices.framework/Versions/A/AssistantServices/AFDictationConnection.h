...
@interface AFDictationConnection : NSObject <AFNetworkAvailabilityObserver> {
    ...
    char _shouldClassifyIntent;
    char _shouldRecognizeCommands;
...
+ (char)dictationIsSupportedForLanguageCode:(id)a0 error:(id *)a1;
...
- (void)_connectionClearedForInterruption:(char)a0;
...
- (void)_tellSpeechDelegateLanguageDetected:(id)a0 confidenceScores:(id)a1 isConfident:(char)a2;
...
- (void)_tellSpeechDelegateSearchResultsReceived:(id)a0 recognitionText:(id)a1 stable:(char)a2 final:(char)a3;
...
- (char)dictationIsAvailableForLanguage:(id)a0;
- (char)dictationIsAvailableForLanguage:(id)a0 synchronous:(char)a1;
- (char)forcedOfflineDictationIsAvailableForLanguage:(id)a0;
- (char)forcedOfflineDictationIsAvailableForLanguage:(id)a0 synchronous:(char)a1;
...
- (void)startDictationWithSpeechFileAtURL:(id)a0 isNarrowBand:(char)a1 options:(id)a2 forLanguage:(id)a3;
...
- (void)startRecordedAudioDictationWithOptions:(id)a0 forLanguage:(id)a1 narrowband:(char)a2;
- (void)startRecordedAudioDictationWithOptions:(id)a0 forLanguage:(id)a1 narrowband:(char)a2 forceSampling:(char)a3;
