...
- (void)_fetchEligibleAnnouncementRequestTypesAndNotifyObserversAndShouldRelyOnCachedStateIfIneligble:(char)a0;
...
- (void)_updateAudioRouteAvailabilityAndBroadcast:(char)a0;
...
- (void)fetchEligibleAnnouncementRequestTypesAndNotifyObserversAndShouldRelyOnCachedStateIfIneligble:(char)a0;
