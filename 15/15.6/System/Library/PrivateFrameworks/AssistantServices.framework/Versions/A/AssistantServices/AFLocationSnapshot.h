...
- (id)initWithLatitude:(id)a0 longitude:(id)a1 altitude:(id)a2 direction:(id)a3 speed:(id)a4 verticalAccuracy:(id)a5 horizontalAccuracy:(id)a6 preciseLocationEnabled:(char)a7 accessState:(long long)a8;
