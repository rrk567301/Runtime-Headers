...
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 asChildrenOfItemWithIdentifier:(id)a3 isSupplemental:(char)a4 isImmersiveExperience:(char)a5 isPersistentAcrossInvocations:(char)a6;
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 atIndexPaths:(id)a3;
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 atIndexPaths:(id)a3 isSupplemental:(char)a4 isImmersiveExperience:(char)a5 isPersistentAcrossInvocations:(char)a6;
