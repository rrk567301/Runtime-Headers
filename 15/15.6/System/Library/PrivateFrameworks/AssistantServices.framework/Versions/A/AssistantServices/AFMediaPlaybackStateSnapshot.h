...
@property (readonly, nonatomic) char isProxyGroupPlayer;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
- (id)initWithPlaybackState:(long long)a0 nowPlayingTimestamp:(id)a1 mediaType:(id)a2 groupIdentifier:(id)a3 isProxyGroupPlayer:(char)a4;
