...
- (void)donateContext:(id)a0 withMetadata:(id)a1 pushToRemote:(char)a2;
- (void)donateContext:(id)a0 withMetadata:(id)a1 pushToRemote:(char)a2 completion:(id /* block */)a3;
