...
@interface _AFCompanionDeviceInfoMutation : NSObject <AFCompanionDeviceInfoMutating> {
    ...
    char _syncMetadataCapability;
    char _peerToPeerHandoffCapability;
    char _muxSupportCapability;
    char _meDevice;
...
- (void)setPeerToPeerHandoffCapability:(char)a0;
- (id)getSiriLanguage;
- (id)getSyncMetadata;
...
- (id)getIdsIdentifier;
- (char)getMeDevice;
- (char)getMuxSupportCapability;
- (char)getPeerToPeerHandoffCapability;
- (id)getProductPrefix;
- (id)getSpeechID;
- (char)getSyncMetadataCapability;
- (id)initWithBase:(id)a0;
- (void)setAceHost:(id)a0;
- (void)setMeDevice:(char)a0;
- (void)setMuxSupportCapability:(char)a0;
- (void)setProductPrefix:(id)a0;
- (void)setSiriLanguage:(id)a0;
- (void)setSpeechID:(id)a0;
- (void)setSyncMetadata:(id)a0;
- (void)setSyncMetadataCapability:(char)a0;
