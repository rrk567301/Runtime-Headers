...
- (oneway void)speechDidDetectLanguage:(id)a0 confidenceScores:(id)a1 isConfident:(char)a2;
...
- (oneway void)speechDidReceiveSearchResults:(id)a0 recognitionText:(id)a1 stable:(char)a2 final:(char)a3;
...
- (oneway void)speechDidRecognizePartialPackage:(id)a0 nluResult:(id)a1 usingSpeechModel:(id)a2;
...
- (oneway void)speechDidRecognizeVoiceCommandCandidatePackage:(id)a0 nluResult:(id)a1;
