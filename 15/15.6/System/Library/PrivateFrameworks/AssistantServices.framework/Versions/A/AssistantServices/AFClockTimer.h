...
- (id)initWithTimerID:(id)a0 timerURL:(id)a1 isFiring:(char)a2 title:(id)a3 state:(long long)a4 duration:(double)a5 type:(long long)a6 fireTimeInterval:(double)a7 fireDate:(id)a8 firedDate:(id)a9 dismissedDate:(id)a10 lastModifiedDate:(id)a11;
