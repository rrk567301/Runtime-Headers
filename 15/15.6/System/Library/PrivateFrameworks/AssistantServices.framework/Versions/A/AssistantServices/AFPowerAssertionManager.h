...
- (void)assertionCoordinator:(id)a0 didActivateAssertion:(id)a1 isFirstAssertion:(char)a2;
- (void)assertionCoordinator:(id)a0 didAddAssertion:(id)a1 isFirstAssertion:(char)a2;
- (void)assertionCoordinator:(id)a0 didDeactivateAssertion:(id)a1 isLastAssertion:(char)a2;
- (void)assertionCoordinator:(id)a0 didRemoveAssertion:(id)a1 isLastAssertion:(char)a2;
