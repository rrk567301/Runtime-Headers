...
@property (readonly, nonatomic) char isAudioSessionActive;
...
- (id)initWithCurrentOrUpNextDateInterval:(id)a0 isAudioSessionActive:(char)a1 localActiveAssertionContexts:(id)a2 localPendingAssertionContexts:(id)a3 remoteActiveAssertionContexts:(id)a4 remotePendingAssertionContexts:(id)a5 localDevice:(id)a6 remoteQualifiedInRangeDevices:(id)a7 remoteQualifiedOutOfRangeDevices:(id)a8 remoteDisqualifiedDevices:(id)a9;
