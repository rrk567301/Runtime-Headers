...
@property (readonly, nonatomic) char coordinationAllowed;
...
@property (readonly, nonatomic) char homepodInvolved;
@property (readonly, nonatomic) char previousDecision;
@property (readonly, nonatomic) double previousDecisionTime;
@property (readonly, nonatomic) unsigned char deviceGroup;
@property (readonly, nonatomic) char decision;
@property (readonly, nonatomic) char lateToElection;
