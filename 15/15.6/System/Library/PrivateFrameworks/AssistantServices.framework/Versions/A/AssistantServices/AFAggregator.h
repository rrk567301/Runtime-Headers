...
+ (void)noteSuccessOfRequest:(id)a0 inCar:(char)a1;

- (void)beginSessionRetryPreferringWWAN:(char)a0;
...
- (void)recordSuccessForConnectionType:(unsigned long long)a0 isWarm:(char)a1 forTimeInterval:(double)a2;
