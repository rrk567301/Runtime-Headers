...
- (void)updateTemporaryAuthorizationForAccurateLocation:(char)a0 completion:(id /* block */)a1;
- (void)updateTemporaryAuthorizationForAccurateLocation:(char)a0 timeout:(double)a1 completion:(id /* block */)a2;
