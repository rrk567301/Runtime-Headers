...
@property (nonatomic) char shouldAppendAutoAnswerTip;

- (id)init;
- (void).cxx_destruct;
- (id)initWithContacts:(id)a0;
- (id)_spokenTextForOneContact:(id)a0 callServiceSpeakableName:(id)a1 languageCode:(id)a2;
- (id)_addPhoneticEscapeIfNotEmptyNotNil:(id)a0 withStartEscape:(id)a1 withEndEscape:(id)a2;
