...
@property (readonly, nonatomic) char directUpload;
@property (readonly, nonatomic) char bitStringAlgorithm;
...
@property (readonly, nonatomic) char approvedForNonDNU;
@property (readonly, nonatomic) char telemetryAllowed;
