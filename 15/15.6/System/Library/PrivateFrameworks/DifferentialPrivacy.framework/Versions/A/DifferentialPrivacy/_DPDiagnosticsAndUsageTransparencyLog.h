...
+ (unsigned long long)inPlaceReplaceOccurrencesOf:(id)a0 with:(id)a1 inBytes:(char *)a2 bytesLength:(unsigned long long)a3 caseSensitiveSearch:(char)a4 repeat:(char)a5;
...
- (char)writeToDiskWithError:(id *)a0;
