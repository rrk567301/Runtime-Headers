...
+ (char)createDatabaseDirectory:(id)a0 error:(id *)a1;
...
+ (id)persistentStoreOptionsFor:(id)a0 readOnly:(char)a1;
+ (id)storageWithDirectory:(id)a0 databaseName:(id)a1 modelURL:(id)a2 readOnly:(char)a3;

- (id)init;
- (void).cxx_destruct;
- (id)persistentStoreCoordinatorFor:(id)a0;
- (unsigned long long)countObjectsForEntities:(id)a0 predicate:(id)a1;
- (char)deleteDatabaseForPSC:(id)a0 protectionClass:(id)a1 obliterate:(char)a2;
...
- (char)deleteStorageFor:(id)a0 obliterate:(char)a1;
...
- (void)handleDataProtectionChangeFor:(id)a0 willBeAvailable:(char)a1;
- (void)handleDatabaseErrors:(id)a0 forPSC:(id)a1 protectionClass:(id)a2;
- (id)initWithDirectory:(id)a0 databaseName:(id)a1 modelURL:(id)a2 readOnly:(char)a3;
