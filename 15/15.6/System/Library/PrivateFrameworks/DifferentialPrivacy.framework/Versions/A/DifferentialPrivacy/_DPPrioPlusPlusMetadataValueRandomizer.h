...
+ (id)randomizerWithEpsilon:(double)a0 dimensionality:(unsigned long long)a1 dynamicVectorSize:(char)a2;

- (id)init;
- (id)initWithEpsilon:(double)a0 dimensionality:(unsigned long long)a1 dynamicVectorSize:(char)a2;
