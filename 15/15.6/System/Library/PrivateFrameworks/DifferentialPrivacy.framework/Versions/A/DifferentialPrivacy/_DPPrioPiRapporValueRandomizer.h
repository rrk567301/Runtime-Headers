...
@property (readonly, nonatomic) char dynamicVectorSize;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (id)randomizerWithEpsilon:(double)a0 dimensionality:(unsigned long long)a1 dynamicVectorSize:(char)a2 piRapporPrime:(unsigned int)a3 piRapporAlpha0:(double)a4 piRapporAlpha1:(double)a5;
+ (id)shouldForwardToV2DelegateWithMetadata:(id)a0;
...
- (id)initWithEpsilon:(double)a0 dimensionality:(unsigned long long)a1 dynamicVectorSize:(char)a2 piRapporPrime:(unsigned int)a3 piRapporAlpha0:(double)a4 piRapporAlpha1:(double)a5;
- (id)minBatchSize;
...
- (id)v2MetadataFromMetadata:(id)a0;
- (id)v2Randomizer;
