...
+ (char)createRuntimeBlacklistDirectory:(id)a0;
...
+ (char)removeAllFilesFromDirectory:(id)a0;
+ (char)removeBlacklistFileWithKey:(id)a0 fromDirectory:(id)a1;
+ (char)saveBlacklist:(id)a0 forKey:(id)a1 runtimeDirectory:(id)a2;
+ (char)saveBlacklist:(id)a0 knownVersionByKey:(id)a1 systemDirectory:(id)a2 runtimeDirectory:(id)a3;
+ (char)saveBlacklist:(id)a0 systemDirectory:(id)a1 runtimeDirectory:(id)a2 memoryLimit:(unsigned long long)a3;
+ (char)validateBlacklist:(id)a0;
