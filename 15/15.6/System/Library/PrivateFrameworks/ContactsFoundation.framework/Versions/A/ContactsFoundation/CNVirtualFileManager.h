...
- (id)createDirectoryAtURL:(id)a0 withIntermediateDirectories:(char)a1 attributes:(id)a2;
- (char)fileExistsAtURL:(id)a0;
- (char)fileExistsAtURL:(id)a0 isDirectory:(char *)a1;
- (char)getValue:(id *)a0 forExtendendAttribute:(id)a1 url:(id)a2 error:(id *)a3;
