...
+ (id)dateFormatterWithYearFormat:(id)a0 hasLongFormat:(char)a1 locale:(id)a2;
...
+ (char)shouldUseChinaSpecificFormattersForLocale:(id)a0;
+ (char)shouldUseIslamicSpecificFormattersForLocale:(id)a0;
...
- (char)shouldUseArabicGregorianPlaceholderStringForLanguage:(id)a0;
- (char)shouldUseArabicIslamicPlaceholderStringForLanguage:(id)a0;
