...
+ (char)cropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 fitsWithinSize:(struct CGSize { double x0; double x1; })a1;
