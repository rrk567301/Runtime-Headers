...
- (id)appendName:(id)a0 boolValue:(char)a1;
...
- (id)appendNamesAndObjects:(id)a0 args:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
