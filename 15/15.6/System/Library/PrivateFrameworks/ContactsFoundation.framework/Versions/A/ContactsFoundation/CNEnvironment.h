...
@property (readonly, getter=isInternalBuild) char internalBuild;
@property (readonly, getter=isGreenTeaDevice) char greenTeaDevice;
@property (readonly, getter=isExtendedGreenTeaDevice) char extendedGreenTeaDevice;
@property (readonly, getter=getCurrentRegionCode) NSString *currentRegionCode;
@property (readonly, getter=isCommLimitsEnabled) char commLimitsEnabled;
@property (readonly, getter=isKeychainEnabled) char keychainEnabled;
@property (readonly, getter=isAquaSession) char aquaSession;
