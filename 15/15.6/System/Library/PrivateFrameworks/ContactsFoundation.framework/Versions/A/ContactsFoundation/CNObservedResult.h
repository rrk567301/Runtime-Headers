...
+ (char)rangeWouldOverflowWithTime:(unsigned long long)a0 tolerance:(unsigned long long)a1;
+ (char)rangeWouldUnderflowWithTime:(unsigned long long)a0 tolerance:(unsigned long long)a1;
