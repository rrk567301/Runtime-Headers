...
- (char)booleanResultForKey:(id)a0 error:(id *)a1;
...
- (void)setAuditToken:(struct { unsigned int x0[8]; })a0 allowsHighPriority:(char)a1;
...
- (void)setAuditToken:(struct { unsigned int x0[8]; })a0 isFirstOrSecondParty:(char)a1;
