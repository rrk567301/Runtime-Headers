...
@property (nonatomic) char serverMode;
...
- (void)_clientUDPNWPathNextWithEndpoint:(id)a0 nwInterface:(id)a1 selfMACData:(id)a2 usb:(char)a3 completion:(id /* block */)a4;
- (void)_clientUDPNWPathStartResponse:(id)a0 options:(id)a1 localEndpoint:(id)a2 nwInterface:(id)a3 selfIPString:(id)a4 usb:(char)a5 completion:(id /* block */)a6;
...
- (char)_startServerConnectionAndReturnError:(id *)a0;
