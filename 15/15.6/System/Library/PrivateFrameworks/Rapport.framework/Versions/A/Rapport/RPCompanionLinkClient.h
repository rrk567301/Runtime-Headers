...
@property (nonatomic) char reactivateCalled;
@property (nonatomic) char usingOnDemandConnection;
...
- (void)_registerEventID:(id)a0 options:(id)a1 reregister:(char)a2;
- (void)_registerProfileID:(id)a0 reregister:(char)a1 completion:(id /* block */)a2;
- (void)_registerRequestID:(id)a0 options:(id)a1 reregister:(char)a2;
...
- (void)_startNWActivity:(unsigned int)a0 options:(id)a1 result:(id /* block */)a2;
...
- (char)shouldReportDevice:(id)a0 toXPCConnectionWithLaunchInstanceID:(id)a1 outReason:(id *)a2;
