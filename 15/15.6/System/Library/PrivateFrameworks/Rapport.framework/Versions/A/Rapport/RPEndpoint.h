@class NSData, NSString, NSArray, NSDate, CUBonjourDevice, IDSDevice, SFDevice, NSDictionary, CBDevice;
...
@property (nonatomic) char cameraCapabilityRequestIsActive;
@property (nonatomic) char encodeSensitiveProperties;
...
@property (nonatomic) char inDiscoverySession;
...
- (char)removeSFDevice:(id)a0;
- (char)removeCBDevice:(id)a0;
- (id)bleTargetData;
- (char)compareWithDeviceIdentifier:(id)a0;
- (char)removeBonjourDevice:(id)a0;
- (void)setActivityLevel:(int)a0;
- (unsigned int)updateTrustStatusFlagsWithIdentity:(id)a0;
