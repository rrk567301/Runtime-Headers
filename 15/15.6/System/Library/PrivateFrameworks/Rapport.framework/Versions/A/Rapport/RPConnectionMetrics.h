...
- (void)logConnectionWithDeviceModelFrom:(id)a0 deviceModelTo:(id)a1 error:(id)a2 initiator:(id)a3 isOnDemand:(char)a4 isStereoPair:(char)a5 lifetime:(unsigned long long)a6 linkType:(int)a7;
