...
@interface RPConnection : NSObject <RPAuthenticatable> {
    ...
    struct { struct { unsigned char frameType; unsigned char frameLen[3]; } header; char receivingHeader; char readRequested; } _readFrame;
    struct { struct { unsigned char frameType; unsigned char frameLen[3]; } header; char receivingHeader; char readRequested; } _readFrameBTPipeHighPriority;
...
@property (nonatomic) char canDecode128bit;
...
@property (nonatomic) char flowControlReadEnabled;
...
@property (nonatomic) char invalidationHandled;
...
@property (nonatomic) char preAuthEnabled;
...
- (void)_serverPairSetupWithData:(id)a0 start:(char)a1;
...
- (void)_identityProofsAdd:(id)a0 update:(char)a1;
...
- (char)_pairVerifyVerifySignature:(id)a0 data:(id)a1 flags:(unsigned int)a2 error:(id *)a3;
- (void)_processSends;
- (void)_pskPrepare:(char)a0;
- (void)_receiveCompletion:(id)a0 readFrame:(struct { struct { unsigned char x0; unsigned char x1[3]; } x0; char x1; char x2; } *)a1 requestable:(id)a2;
- (void)_receiveStart:(id)a0 readFrame:(struct { struct { unsigned char x0; unsigned char x1[3]; } x0; char x1; char x2; } *)a1 requestable:(id)a2;
- (void)_receivedEvent:(id)a0 ctx:(struct { unsigned long long x0; char x1; } *)a1;
- (void)_receivedHeader:(const struct { unsigned char x0; unsigned char x1[3]; } *)a0 body:(id)a1 ctx:(struct { unsigned long long x0; char x1; } *)a2;
- (void)_receivedHeader:(const struct { unsigned char x0; unsigned char x1[3]; } *)a0 encryptedObjectData:(id)a1 ctx:(struct { unsigned long long x0; char x1; } *)a2;
- (void)_receivedObject:(id)a0 ctx:(struct { unsigned long long x0; char x1; } *)a1;
- (void)_receivedRequest:(id)a0 ctx:(struct { unsigned long long x0; char x1; } *)a1;
- (void)_receivedResponse:(id)a0 ctx:(struct { unsigned long long x0; char x1; } *)a1;
- (char)_receivedSystemInfo:(id)a0 xid:(id)a1;
...
- (void)_sendEncryptedResponse:(id)a0 options:(id)a1 error:(id)a2 xid:(id)a3 requestID:(id)a4 highPriority:(char)a5 isChatty:(char)a6 replyStartTime:(id)a7;
...
- (void)_serverPairVerifyWithData:(id)a0 start:(char)a1;
...
- (char)containsInUseProcess:(int)a0;
