...
- (char)signDataPtr:(const void *)a0 dataLen:(unsigned long long)a1 signatureBytes:(unsigned char[64])a2 error:(id *)a3;
- (char)verifySignature:(id)a0 data:(id)a1 error:(id *)a2;
- (char)verifySignaturePtr:(const void *)a0 signatureLen:(unsigned long long)a1 dataPtr:(const void *)a2 dataLen:(unsigned long long)a3 error:(id *)a4;
...
- (char)_equalsSEPPrivateKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a0;
...
- (char)verifyAuthTag:(id)a0 data:(id)a1 type:(int)a2 error:(id *)a3;
- (char)verifyAuthTagPtr:(const void *)a0 authTagLen:(unsigned long long)a1 dataPtr:(const void *)a2 dataLen:(unsigned long long)a3 type:(int)a4 error:(id *)a5;
