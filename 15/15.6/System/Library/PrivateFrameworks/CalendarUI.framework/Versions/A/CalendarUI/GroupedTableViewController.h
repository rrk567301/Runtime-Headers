...
@property char showsSummaryRow;
@property char summaryRowIsSelectable;
@property (retain) id emptyGroup;
@property (retain) NSArray *itemSortDescriptors;
@property (retain) NSArray *groupSortDescriptors;
@property char showsHeaderForSingularGroup;
@property char showsHeaderForFirstGroup;
...
- (char)isBlankRow:(long long)a0;
- (char)isGroupRow:(long long)a0;
- (char)isItemRow:(long long)a0;
- (char)isSummaryRow:(long long)a0;
...
- (void)setShowsSummaryRow:(char)a0 selectable:(char)a1;
