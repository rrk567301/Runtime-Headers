...
- (char)_cell:(id)a0 isLastSelectedInMatrix:(id)a1;
...
- (void)_openWithAnimation:(char)a0;
...
- (void)updateStateWithRecurrenceRule:(id)a0 startDate:(id)a1 timeZone:(id)a2 supportsMultipleDaysAndMonths:(char)a3 supportsYearlyIntervalChange:(char)a4;
