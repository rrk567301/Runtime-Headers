...
- (void).cxx_destruct;
- (id)_mainWindow;
- (char)_recentlyShowedPasswordPanelForAccount:(id)a0;
- (void)showPasswordPanelForAccountID:(id)a0;
- (void)showPasswordPanelForAccountID:(id)a0 userInitiated:(char)a1;
- (void)showPasswordPanelForSource:(id)a0;
- (void)showPasswordPanelForSource:(id)a0 userInitiated:(char)a1;
