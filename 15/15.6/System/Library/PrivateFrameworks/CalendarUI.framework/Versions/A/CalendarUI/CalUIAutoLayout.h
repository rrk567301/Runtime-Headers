...
+ (id)alignLeadingView:(id)a0 toTrailingView:(id)a1 spacing:(double)a2 minimum:(char)a3;
...
+ (void)spanWidthOfView:(id)a0 withView:(id)a1 inset:(double)a2;
+ (void)centerView:(id)a0 inView:(id)a1;
+ (void)fillView:(id)a0 withView:(id)a1;
+ (void)spanHeightOfView:(id)a0 withView:(id)a1;
+ (void)spanHeightOfView:(id)a0 withView:(id)a1 inset:(double)a2;
+ (void)spanWidthOfView:(id)a0 withView:(id)a1;
