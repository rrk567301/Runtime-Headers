...
@property char calendarDatePickerShown;
@property char userDismissedCalendarPicker;
...
@property char openingCalendarPicker;
@property char makeCalendarPickerKeyOnNextWindowUpdate;
...
- (void)setDateEnabled:(char)a0;
- (void)setTimeEnabled:(char)a0;
- (void)_calPickerChanged:(id)a0;
- (id)_calendar;
- (char)_datePickerCell:(id)a0 receivedKeyDown:(id)a1;
- (char)_datePickerCell:(id)a0 receivedMouseDown:(id)a1;
