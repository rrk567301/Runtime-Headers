...
@property char supportsScrubbing;
@property char supportsHovering;
...
- (id)_attributedMonthStringShortened:(char)a0;
...
- (id)_miniMonthDayCellForDate:(id)a0 isActive:(char)a1 isPrevMonth:(char)a2 isNextMonth:(char)a3;
- (void)_updateAttributesForDayCell:(id)a0 isPrevNextMonth:(char)a1;
...
- (void)backOneMonth;
- (void)backOneMonthAndNotify:(char)a0;
- (void)configureDayCells;
- (void)forwardOneMonthAndNotify:(char)a0;
...
- (void)updateWithDate:(id)a0 force:(char)a1;
