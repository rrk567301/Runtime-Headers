...
- (id)_titleFont;
- (void)updateLayer;
- (void)setDimmed:(char)a0;
- (void)_updateColors;
- (id)_attributedStringFromAttributedString:(id)a0 strikethrough:(char)a1;
- (id)_attributedStringFromString:(id)a0 strikethrough:(char)a1 font:(id)a2;
- (id)_monospacedSubtextFont;
- (id)_subtextFont;
- (void)_updateTextAndIconColors;
- (long long)_userInterfaceStyle;
- (id)initForDragPreview:(char)a0;
- (void)updateWithEvent:(id)a0 isMultiday:(char)a1 occurrenceStartDate:(id)a2;
