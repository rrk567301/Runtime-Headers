...
@property (readonly, nonatomic) char csuSensitiveLocation;
...
- (id)initWithKnowledgeGraphID:(id)a0 title:(id)a1 thumbnailURL:(id)a2 thumbnailAspectRatio:(float)a3 shortDescription:(id)a4 detailedDescription:(id)a5 webURL:(id)a6 knowledgeProperties:(id)a7 serializedDomainType:(long long)a8 serializedDomainResponse:(id)a9 csuQid:(unsigned long long)a10 csuIdType:(short)a11 csuLocalizedLabel:(id)a12 csuLocalizedLabelDictionary:(id)a13 csuConfidence:(double)a14 csuSensitiveLocation:(char)a15 csuCategory:(id)a16 csuVertical:(id)a17 csuLocalizedSynonyms:(id)a18 csuLongitute:(double)a19 csuLatitute:(double)a20 csuVersion:(int)a21;
