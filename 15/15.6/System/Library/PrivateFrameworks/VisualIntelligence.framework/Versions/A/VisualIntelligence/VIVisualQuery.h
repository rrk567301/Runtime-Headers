...
+ (id)queryWithPixelBuffer:(struct __CVBuffer { } *)a0 depthBuffer:(struct __CVBuffer { } *)a1 orientation:(unsigned int)a2 normalizedRegionOfInterest:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 textBlockAnnotation:(id)a4 queryContext:(id)a5;
