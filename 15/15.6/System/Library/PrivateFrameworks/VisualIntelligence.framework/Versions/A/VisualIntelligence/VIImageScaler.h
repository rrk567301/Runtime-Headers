...
- (int)cropScaleImageFromSource:(const struct __CVBuffer { } *)a0 destination:(const struct __CVBuffer { } *)a1 normalizedBoundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 bottomLeftBoxOrigin:(char)a3;
