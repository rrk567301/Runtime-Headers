...
@property (nonatomic) char enable_text_bounding_box_merge;
@property (nonatomic) float text_merge_iou_threshold;
@property (nonatomic) char enable_text_bounding_box_suppress;
@property (nonatomic) char enable_text_font_size_suppress;
@property (nonatomic) float font_size_suppress_threshold;
@property (nonatomic) char enable_text_confidence_suppress;
@property (nonatomic) float text_confidence_suppress_threshold;
@property (nonatomic) char enable_text_bbox_size_suppress;
@property (nonatomic) float text_bbox_size_suppress_threshold;
@property (nonatomic) char enable_text_negative_objects_suppress;
