...
@property (nonatomic) char enable_packaged_products;
@property (nonatomic) char enable_text_from_object_detection;
...
@property (nonatomic) char enable_visual_distance;
