@class NSArray, _TtC18VisualIntelligence23OntologyGraphCompatible;
...
- (id)parseCameraFrameCachedWithVisualQuery:(id)a0 cachedResults:(id)a1 completion:(id /* block */)a2;
...
- (id)encryptedSearchWithImage:(id)a0 visualUnderstanding:(id)a1 queryContext:(id)a2 completion:(id /* block */)a3;
- (id)encryptedSearchWithImage:(id)a0 visualUnderstanding:(id)a1 queryContext:(id)a2 domain:(id)a3 completion:(id /* block */)a4;
- (id)experimentalSearchWithImage:(id)a0 visualUnderstanding:(id)a1 queryContext:(id)a2 completion:(id /* block */)a3;
- (id)generateCachedResultsWithDetectorOutputs:(id)a0 imageSize:(struct CGSize { double x0; double x1; })a1 imageOrientation:(unsigned int)a2 normalizedRegionOfInterest:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
...
- (char)isEligibleForEncryptedSearchWithCachedResults:(id)a0;
...
- (id)searchCameraFrameWithImage:(id)a0 visualUnderstanding:(id)a1 queryContext:(id)a2 completion:(id /* block */)a3;
