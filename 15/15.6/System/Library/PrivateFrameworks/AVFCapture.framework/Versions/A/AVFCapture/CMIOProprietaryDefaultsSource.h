...
- (int)setObserveFrameSenderServerEndpoints:(char)a0;
- (int)unobserveChangesForKey:(id)a0;
- (int)updateCameraHistory:(id)a0 withCameraInfo:(id)a1 maxLength:(unsigned long long)a2 updateCameraHistoryDownplayOverrideList:(char)a3 cameraCanBeInOverrideList:(char)a4 outNewCameraHistory:(id *)a5;
- (int)updateCameraOverrideHistory:(id)a0 withCameraInfo:(id)a1 setEligibility:(char)a2 outOverrideHistoryChanged:(char *)a3 outNewCameraOverrideHistory:(id *)a4;
- (int)updateCameraOverrideHistory:(id)a0 withCameraInfo:(id)a1 setOverride:(char)a2 outOverrideChanged:(char *)a3 outNewCameraOverrideHistory:(id *)a4;
