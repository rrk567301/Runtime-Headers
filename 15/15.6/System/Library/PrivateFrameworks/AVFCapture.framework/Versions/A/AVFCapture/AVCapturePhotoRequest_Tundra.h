...
@property (readonly, nonatomic) char imageMirrored;
...
+ (id)requestWithDelegate:(id)a0 settings:(id)a1 imageOrientation:(long long)a2 imageMirrored:(char)a3;

- (void)dealloc;
- (id)initWithDelegate:(id)a0 settings:(id)a1 imageOrientation:(long long)a2 imageMirrored:(char)a3;
