...
- (id)_recommendedVideoOutputSettingsForConnection:(id)a0 sourceSettings:(id)a1 videoCodec:(id)a2 isIris:(char)a3 outputFileURL:(id)a4;
...
- (void)getTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a0 mirroredOut:(char *)a1 rollAdjustmentOut:(double *)a2 forConnection:(id)a3;
...
- (id)recommendedCinematicAudioOutputSettingsForConnection:(id)a0 fileType:(id)a1 isProResCapture:(char)a2;
- (id)recommendedOutputSettingsForConnection:(id)a0 sourceSettings:(id)a1 videoCodecType:(id)a2 fileType:(id)a3 isIris:(char)a4 outputFileURL:(id)a5;
