...
- (char)_filtersAreOptimized:(id)a0 exceptionReason:(id *)a1;
...
- (char)_setVideoPreviewFilters:(id)a0 checkForExceptionalInput:(char)a1 exceptionReason:(id *)a2;
...
- (char)_zoomPictureInPictureOverlaySupported;
...
- (char)isPortraitAutoSuggestEnabled;
- (char)isPortraitAutoSuggestSupported;
- (char)isSemanticStyleRenderingSupported;
- (char)isUnoptimizedFilterRenderingEnabled;
- (char)isZoomPictureInPictureOverlayEnabled;
- (char)isZoomPictureInPictureOverlaySupported;
...
- (void)setPortraitAutoSuggestEnabled:(char)a0;
...
- (void)setUnoptimizedFilterRenderingEnabled:(char)a0;
- (void)setVideoPreviewFilters:(id)a0;
- (void)setZoomPictureInPictureOverlayEnabled:(char)a0;
- (id)sinkID;
