...
@property (readonly, getter=isRawPhoto) char rawPhoto;
...
@property (readonly, getter=isConstantColorFallbackPhoto) char constantColorFallbackPhoto;
...
- (char)_isCompressedPhoto;
- (char)_isProRAWPhoto;
- (char)_isSushiRAWPhoto;
- (char)_isUncompressedYUVOrRGBPhoto;
