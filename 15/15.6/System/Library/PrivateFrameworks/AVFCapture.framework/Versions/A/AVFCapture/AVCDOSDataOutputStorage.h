...
- (void)dealloc;
- (char)hasAllExpectedSynchronizedDataForLeaderTimestamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (id)initWithDataOutput:(id)a0;
- (void)updateDelegateOverrideCallbackQueueQOSClass:(unsigned int)a0;
