...
@property (nonatomic, getter=isLensStabilizationEnabled) char lensStabilizationEnabled;
...
- (id)debugDescription;
- (id)description;
- (void)setAutoDualCameraFusionEnabled:(char)a0;
...
- (void)setAutoRedEyeReductionEnabled:(char)a0;
- (void)setAutoStillImageStabilizationEnabled:(char)a0;
- (void)setAutoVirtualDeviceFusionEnabled:(char)a0;
- (void)setEV0PhotoDeliveryEnabled:(char)a0;
