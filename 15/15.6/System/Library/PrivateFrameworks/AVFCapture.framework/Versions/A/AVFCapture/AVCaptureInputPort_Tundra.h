...
- (void)attachToAudioMixerNode:(int)a0 element:(unsigned int)a1 scope:(unsigned int)a2 isReadOnly:(char)a3;
- (unsigned int)audioMixerNodeElement;
- (void)detachFromAudioMixerNode;
- (id)initWithInput:(id)a0 mediaType:(id)a1 formatDescription:(struct opaqueCMFormatDescription { } *)a2 enabled:(char)a3 sourceDeviceType:(id)a4 sourceDevicePosition:(long long)a5;
