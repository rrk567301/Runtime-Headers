...
+ (id)faceIDReadinessObjectWithReady:(char)a0 coachingStatus:(long long)a1 userEngagementStatus:(long long)a2 input:(id)a3 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a4;
...
- (id)initWithReady:(char)a0 coachingStatus:(long long)a1 userEngagementStatus:(long long)a2 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a3 sourceCaptureInput:(id)a4;
