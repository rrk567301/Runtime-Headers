...
+ (id)discoverySessionWithDeviceTypes:(id)a0 mediaType:(id)a1 position:(long long)a2 allowIOSMacEnvironment:(char)a3;
...
- (id)_initWithDeviceTypes:(id)a0 mediaType:(id)a1 position:(long long)a2 allowIOSMacEnvironment:(char)a3 prefersUnsuspendedAndAllowsAnyPosition:(char)a4;
- (char)_isDeviceAlreadyDiscovered:(id)a0;
