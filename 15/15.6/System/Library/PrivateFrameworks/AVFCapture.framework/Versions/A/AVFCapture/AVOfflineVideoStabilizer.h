...
+ (void)initialize;
+ (id)offlineVideoStabilizerWithTargetFrameDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 dataProvider:(id)a1 destinationBufferPool:(struct __CVPixelBufferPool { } *)a2 stabilizationEnabled:(char)a3;

- (void)dealloc;
- (int)_validateSourcePixelBuffer:(struct __CVBuffer { } *)a0 withSampleTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 metadata:(id)a2 isEndOfData:(char *)a3;
...
- (int)_validateStabilizationMetadata:(id)a0 withSampleTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 isEndOfData:(char *)a2;
...
- (id)initWithTargetFrameDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 dataProvider:(id)a1 destinationBufferPool:(struct __CVPixelBufferPool { } *)a2 stabilizationEnabled:(char)a3;
