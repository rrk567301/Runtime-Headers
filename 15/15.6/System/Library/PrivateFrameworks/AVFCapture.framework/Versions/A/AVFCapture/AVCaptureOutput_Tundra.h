...
- (int)configureAudioSplitter:(int)a0 mixer:(int)a1 converter:(int)a2 forGraph:(struct OpaqueCMIOGraph { } *)a3 connection:(id)a4 withSettings:(id)a5 audioFileType:(unsigned int)a6 forceConverterToPassThru:(char)a7 setClientSequenceID:(char)a8;
...
- (char)getAudioSplitterNode:(int *)a0 andAudioMixerNode:(int *)a1 forConnection:(id)a2;
...
- (char)setEnabled:(char)a0 forConnection:(id)a1;
