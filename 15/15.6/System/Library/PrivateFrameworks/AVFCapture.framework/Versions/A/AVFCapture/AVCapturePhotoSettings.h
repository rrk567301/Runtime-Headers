...
- (id)_initWithFormat:(id)a0 processedFileType:(id)a1 rawPixelFormatType:(unsigned int)a2 rawFileType:(id)a3 burstQualityCaptureEnabled:(char)a4 uniqueID:(long long)a5 exceptionReason:(id *)a6;
...
- (char)isAutoSpatialPhotoCaptureEnabled;
...
- (void)setAutoDeferredProcessingEnabled:(char)a0;
- (void)setAutoSpatialOverCaptureEnabled:(char)a0;
- (void)setAutoSpatialPhotoCaptureEnabled:(char)a0;
...
- (void)setProcessedPhotoZoomWithoutUpscalingEnabled:(char)a0;
...
- (void)setTurboModeEnabled:(char)a0;
