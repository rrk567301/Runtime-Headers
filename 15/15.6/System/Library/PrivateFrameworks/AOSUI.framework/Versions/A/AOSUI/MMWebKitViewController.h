...
- (void)transitionToLoadingViewAnimated:(char)a0;
- (void)transitionToServerErrorViewWithTitle:(id)a0 image:(id)a1 animated:(char)a2;
- (void)transitionToWebViewAnimated:(char)a0;
