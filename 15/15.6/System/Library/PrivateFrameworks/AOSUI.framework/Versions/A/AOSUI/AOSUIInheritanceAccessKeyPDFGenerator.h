...
@interface AOSUIInheritanceAccessKeyPDFGenerator : NSObject {
...
- (void)_renderPDFInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (double)_renderRectBoxWithPageRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 yPosition:(double)a1;
