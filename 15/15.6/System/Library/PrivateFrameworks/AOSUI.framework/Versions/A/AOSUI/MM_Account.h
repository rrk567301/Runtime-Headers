...
+ (id)accountForACAccount:(id)a0 fetchAccountImage:(char)a1;
+ (id)accountWithID:(id)a0;
+ (id)accountWithID:(id)a0 fetchAccountImage:(char)a1;
...
- (void)_setProgressStringForAccount:(id)a0 service:(id)a1 starting:(char)a2;
- (void)didBecomeInactive;
- (void)didSelect;
- (void)didSignOutAccount;
- (void)didUnselect;
- (void)enableFailureSheetsAndShow:(char)a0;
- (id)getiCloudStorageUsageDict;
- (char)hasMailConfigured;
- (id)initWithACAccount:(id)a0 fetchAccountImage:(char)a1;
- (id)initWithAccountID:(id)a0 fetchAccountImage:(char)a1;
- (void)preflightDSEEnable:(id)a0 withCompletionHandler:(id /* block */)a1;
- (char)preflightDelete:(id *)a0 withWindow:(id)a1;
- (char)prepareForSignoutWithOptionsDict:(id *)a0 parentWindow:(id)a1;
