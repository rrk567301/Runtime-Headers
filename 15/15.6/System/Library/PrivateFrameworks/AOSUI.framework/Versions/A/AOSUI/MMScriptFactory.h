...
- (id)_functionScriptWithName:(id)a0 parameterCount:(unsigned long long)a1 shouldReturnPromise:(char)a2 callbackIndices:(id)a3;
...
- (id)_scriptWithSource:(id)a0 injectionTime:(long long)a1 forMainFrameOnly:(char)a2;
