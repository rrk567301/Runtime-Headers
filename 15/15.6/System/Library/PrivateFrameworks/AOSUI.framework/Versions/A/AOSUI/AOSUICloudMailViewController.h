...
- (id)_setupWindowWithContentViewController:(id)a0 isCustomDomainAvailable:(char)a1;
...
- (void)presentICloudMailOptions:(id)a0 mailEnabled:(char)a1 customDomainAvailable:(char)a2 completionHandler:(id /* block */)a3;
