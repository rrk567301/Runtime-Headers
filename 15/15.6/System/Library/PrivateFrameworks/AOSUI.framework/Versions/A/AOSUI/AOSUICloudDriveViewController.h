...
- (void)_dismiss;
- (id)_setupWindowWithContentViewController:(id)a0 driveEnabled:(char)a1;
- (void)optionsButtonPressed:(id)a0;
- (void)presentICloudDriveOptions:(id)a0 driveEnabled:(char)a1 completionHandler:(id /* block */)a2;
- (void)showSpinner:(char)a0;
