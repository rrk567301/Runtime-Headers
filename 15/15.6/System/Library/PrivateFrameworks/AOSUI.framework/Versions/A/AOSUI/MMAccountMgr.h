...
- (id)accountWithACAccount:(id)a0 createIfMissing:(char)a1;
- (id)accountWithACAccount:(id)a0 createIfMissing:(char)a1 fetchAccountImage:(char)a2;
- (id)accountWithID:(id)a0 createIfMissing:(char)a1;
- (id)accountWithID:(id)a0 createIfMissing:(char)a1 fetchAccountImage:(char)a2;
- (void)authenticateAccount:(id)a0 withPassword:(id)a1 delegatePlist:(id)a2;
- (char)completeSignin:(id)a0 withPassword:(id)a1 delegatePlist:(id)a2;
- (char)completeSignin:(id)a0 withPassword:(id)a1 withAuthContext:(id)a2 delegatePlist:(id)a3 mobileMePlist:(id)a4;
