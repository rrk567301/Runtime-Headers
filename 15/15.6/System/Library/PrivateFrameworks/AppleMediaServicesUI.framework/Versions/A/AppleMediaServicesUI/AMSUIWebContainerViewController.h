...
@protocol AMSUIWebPagePresenter, AMSUIWebPresentationDelegate, AMSUIWebPageProvider;
...
@property char didAppearOnce;
@property char dismissCalled;
@property char isAppearing;
...
@property (retain) id<AMSUIWebPageProvider> pageModel;
...
@property char shouldSkipInitialRefresh;
...
- (void)replaceContentWithViewController:(id)a0 animated:(char)a1 pageModel:(id)a2 completion:(id /* block */)a3;
...
- (void)_setupNavBarAnimated:(char)a0;
- (void)applyNavigationBarModel:(id)a0 toCommonNavigationController:(id)a1 animated:(char)a2;
- (void)applyNavigationModel:(id)a0;
- (void)cacheScrollViewPositionFor:(id)a0;
- (void)contentWasReplacedAnimated:(char)a0;
...
- (id)navigationItem;
- (void)setupToolbarAnimated:(char)a0;
- (void)updateRefreshControlForPageModel:(id)a0;
