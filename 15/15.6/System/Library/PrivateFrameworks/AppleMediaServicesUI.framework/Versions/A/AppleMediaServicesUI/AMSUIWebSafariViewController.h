...
@property char didHandleDismiss;
...
@property char performingNavigation;
...
@property char shouldDismissOnCallback;
@property char shouldSetPresentationDelegate;
...
- (void)_refresh:(id)a0;
- (void)_back:(id)a0;
- (char)_callActionHandlerWithURL:(id)a0 error:(id)a1;
- (void)_finishedLoadingWithSuccess:(char)a0;
- (void)_forward:(id)a0;
- (void)_handleDismiss;
- (void)_pop;
...
- (void)_setupSafariNavBarWithSpinner:(char)a0;
