...
@interface AMSUIWebViewController : AMSUICommonViewController <AMSUIWebActionRunnerDelegate, AMSUIWebPageViewControllerDelegate, AMSUIWebProtocolDelegate, AMSURLProtocolDelegate, NSURLSessionDelegate, AMSUIWebPresentationDelegate, AMSBagConsumer>
...
- (id)_handleAuthenticateCloudRequest:(id)a0 pauseTimeouts:(char)a1;
- (id)_handleAuthenticateRequest:(id)a0 pauseTimeouts:(char)a1;
- (id)_handleDialogRequest:(id)a0 pauseTimeouts:(char)a1;
- (id)_handleEngagementRequest:(id)a0 pauseTimeouts:(char)a1;
...
- (id)action:(id)a0 pauseTimeouts:(char)a1 handleAuthenticateCloudRequest:(id)a2;
- (id)action:(id)a0 pauseTimeouts:(char)a1 handleAuthenticateRequest:(id)a2;
- (id)action:(id)a0 pauseTimeouts:(char)a1 handleDialogRequest:(id)a2;
