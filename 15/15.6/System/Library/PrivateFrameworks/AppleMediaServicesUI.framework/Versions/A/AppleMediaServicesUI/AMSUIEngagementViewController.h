...
- (char)_isURLTrusted:(id)a0 inDomains:(id)a1;
...
- (char)dynamicViewController:(id)a0 handleDelegateAction:(id)a1 completionHandler:(id /* block */)a2;
- (char)dynamicViewControllerShouldDismiss:(id)a0;
