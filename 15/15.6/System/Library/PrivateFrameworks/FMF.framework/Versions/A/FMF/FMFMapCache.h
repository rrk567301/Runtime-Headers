...
@property (nonatomic) char fileProtectionDeactivated;
...
- (char)pendingMapImageForLocation:(id)a0 altitude:(double)a1 pitch:(double)a2 width:(double)a3 andHeight:(double)a4;
- (char)pendingMapImageForRequest:(id)a0;
