...
@property (getter=isLocatingInProgress) char locatingInProgress;
...
@property (nonatomic) char isBorderEnabled;
...
- (id)initWithHandle:(id)a0 locationType:(long long)a1 location:(id)a2 activityState:(long long)a3 label:(id)a4 locatingInProgress:(char)a5 shortAddress:(id)a6 longAddress:(id)a7 placemark:(id)a8;
- (char)isMoreRecentThan:(id)a0;
- (id)locationAge;
