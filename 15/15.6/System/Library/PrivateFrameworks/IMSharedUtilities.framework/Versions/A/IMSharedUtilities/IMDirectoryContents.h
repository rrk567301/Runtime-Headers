...
+ (char)isGroupPhotoPath:(id)a0;

- (void).cxx_destruct;
- (void)gather;
- (void)gatherLivePhotoBundleContentInfoAtPath:(id)a0;
- (id)initWithRootPath:(id)a0 attachmentsPath:(id)a1 syncAssetsPath:(id)a2 stickersPath:(id)a3;
- (char)isAttachmentPath:(id)a0;
- (char)isStickerPath:(id)a0;
- (char)isSyncAssetPath:(id)a0;
