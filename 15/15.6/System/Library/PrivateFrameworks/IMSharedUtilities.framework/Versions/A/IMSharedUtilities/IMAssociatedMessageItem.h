...
@property (nonatomic, readonly) char isAvailabilityReplySupported;
...
- (char)updateTemporaryFileTransferGUIDsWithPermanentFileTransferGUIDs:(id)a0;
- (char)_updateAssociatedMessagePartTextReplacingTemporaryFileTransferGUIDsWithPermanentFileTransferGUIDs:(id)a0;
