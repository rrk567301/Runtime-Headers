...
- (void)_synchronizeMutedChatList:(id)a0 syncToPairedDevice:(char)a1;
...
- (char)isMutedChatForChatIdentifier:(id)a0 chatStyle:(unsigned char)a1 groupID:(id)a2 participantIDs:(id)a3 lastAddressedHandleID:(id)a4 originalGroupID:(id)a5;
- (char)isMutedChatForMuteIdentifiers:(id)a0;
- (void)muteChatWithMuteIdentifiers:(id)a0 untilDate:(id)a1 syncToPairedDevice:(char)a2;
...
- (void)syncToPairedDeviceIncludingVersion:(char)a0;
- (void)unmuteChatWithMuteIdentifiers:(id)a0 syncToPairedDevice:(char)a1;
