...
- (void)_setSensitiveValue:(char)a0 forIdentifier:(id)a1;
- (char)_shouldForceSensitivityResult;
...
- (void)isSensitiveContent:(id)a0 contentAttachmentType:(long long)a1 useBlastDoor:(char)a2 withChatID:(id)a3 completionHandler:(id /* block */)a4;
