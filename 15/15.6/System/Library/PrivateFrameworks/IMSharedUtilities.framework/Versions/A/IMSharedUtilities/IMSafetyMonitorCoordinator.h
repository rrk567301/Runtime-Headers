...
- (void)informOfChangedGroupMembership:(id)a0;
...
- (void)informOfCancelledScheduledMessageSendWithMessageGUID:(id)a0 sentSuccessfully:(char)a1 error:(id)a2;
- (void)informOfChangedGroupDisplayName:(id)a0;
- (void)informOfChangedGroupPhoto:(id)a0;
...
- (void)informOfKickFromGroup:(id)a0;
- (void)informOfOutgoingMessageWithMessage:(id)a0 sentSuccessfully:(char)a1 error:(id)a2;
- (void)informOfScheduledMessage:(id)a0 sentSuccessfully:(char)a1 error:(id)a2;
...
- (char)shouldDisallowBasedOnRegulatoryDomain;
- (char)shouldDropIncomingCheckInMessageWithURL:(id)a0 senderHandle:(id)a1 isFromMe:(char)a2;
