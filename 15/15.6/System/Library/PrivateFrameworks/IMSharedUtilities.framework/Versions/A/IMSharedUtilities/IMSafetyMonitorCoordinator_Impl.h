...
@property (nonatomic, readonly) char shouldDisallowBasedOnRegulatoryDomain;

- (id)init;
- (void).cxx_destruct;
- (void)informOfScheduledMessageSendWithMessage:(id)a0 sentSuccessfully:(char)a1 error:(id)a2;
