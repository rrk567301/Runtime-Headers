...
@property (readonly, nonatomic) char shouldCollectPowerWifiStats;
...
- (char)_checkArgumentValidity:(id)a0 withFileName:(id)a1 withPredicate:(id)a2 withError:(id *)a3;
...
- (void)clearSyncStats;
- (void)dumpLogsToFolderAtPath:(id)a0 withFileName:(id)a1 lastHours:(int)a2 predicate:(id)a3 includeCKDebug:(char)a4 withCompletion:(id /* block */)a5;
