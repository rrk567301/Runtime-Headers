...
- (void)postCoreAutomationNotificationFinishedPeriodicSyncNotificationWithStartTime:(id)a0 chatsDidsync:(char)a1 messagesDidSync:(char)a2 attachmentsDidSync:(char)a3 recoverableMessagesDidSync:(char)a4;
- (void)postCoreAutomationNotificationFinishedPurgingAttachments:(id)a0 withErrorString:(id)a1;
- (void)postCoreAutomationNotificationFinishedTapToDownload:(id)a0 downloadedFromCloudKitSuccessfully:(char)a1;
- (void)postCoreAutomationNotificationPeriodicSyncUpdateNotification;
- (void)postCoreAutomationNotificationWithAction:(id)a0;
- (void)postCoreAutomationNotificationWithDictionary:(id)a0 withVerboseLogging:(char)a1;
