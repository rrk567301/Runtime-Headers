...
+ (void)generateAnimatedImagePreview:(id)a0 senderContext:(id)a1 destinationFileURL:(id)a2 maxPixelDimension:(double)a3 scale:(double)a4 maxFrameCount:(long long)a5 isSticker:(char)a6 withCompletionBlock:(id /* block */)a7;
...
+ (void)generateNickname:(id)a0 senderContext:(id)a1 forRecordID:(id)a2 wallpaperDataTag:(id)a3 wallpaperLowResDataTag:(id)a4 wallpaperMetadataTag:(id)a5 withKey:(id)a6 processImageFields:(char)a7 completionBlock:(id /* block */)a8;
