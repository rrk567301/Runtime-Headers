...
@property (nonatomic) char batchFetchingForLaunchCompleted;
...
@property (nonatomic) char shouldSkipMeContactLookup;
...
+ (char)_shouldAllowContactStoreLookup;
...
+ (char)isCNContactAKnownContact:(id)a0;
...
+ (void)logDictionary:(id)a0 checkAdditionalLoggingEnabled:(char)a1;
+ (void)logDictionary:(id)a0 inBatchesOfSize:(long long)a1;
+ (void)logHandleID:(id)a0;
+ (void)logHandleIDs:(id)a0 checkAdditionalLoggingEnabled:(char)a1;
...
- (void)_fetchContactsWithIdentifiers:(id)a0 usingCNID:(char)a1;
...
- (void)fetchCNContactsForHandlesWithIDs:(id)a0 isFinalBatch:(char)a1;
...
- (char)isContactWithIDAlreadyFetched:(id)a0;
- (char)isIDAKnownContact:(id)a0;
...
- (void)setBatchFetchingIsCompleted:(char)a0;
