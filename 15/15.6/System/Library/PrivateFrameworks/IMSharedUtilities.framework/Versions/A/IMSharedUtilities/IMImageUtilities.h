...
@property (class, readonly, getter=isCroppingAvoidanceEnabled) char croppingAvoidanceEnabled;
...
+ (struct CGImage { } *)_newUncroppedPreviewImageFromImage:(struct CGImage { } *)a0 maximumSizeInPx:(struct CGSize { double x0; double x1; })a1;
+ (char)imageIsSubjectLift:(struct CGImage { } *)a0;
...
+ (struct CGImage { } *)newUncroppedPreviewImageFromImage:(struct CGImage { } *)a0 isScreenshot:(char)a1 maximumSizeInPx:(struct CGSize { double x0; double x1; })a2 minimumSizeInPx:(struct CGSize { double x0; double x1; })a3;
+ (char)persistCPBitmapWithImage:(struct CGImage { } *)a0 url:(id)a1;
...
+ (double)scaleFactorForThumbnailWithSize:(struct CGSize { double x0; double x1; })a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; char x3; char x4; char x5; })a1 targetPxSize:(struct CGSize { double x0; double x1; })a2 shouldScaleUpPreview:(char)a3 maxUpScale:(double)a4;
+ (char)shouldCropImageOfSize:(struct CGSize { double x0; double x1; })a0 maximumSizeInPx:(struct CGSize { double x0; double x1; })a1 minimumSizeInPx:(struct CGSize { double x0; double x1; })a2;
