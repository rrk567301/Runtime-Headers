@class DNDGlobalConfigurationService, SKStatusPublishingService, NSObject, NSCache;
...
- (char)_isHandleIDEligibleToReceiveAutomaticInvitation:(id)a0;
- (void)_republishCurrentAvailabilityStatus;
- (void)_sharePersonalAvailabilityWithSKHandle:(id)a0 fromSKHandle:(id)a1 allowingInvitationOfRemovedUsers:(char)a2 completion:(id /* block */)a3;
