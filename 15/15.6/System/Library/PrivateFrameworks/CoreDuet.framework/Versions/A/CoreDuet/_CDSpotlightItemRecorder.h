@class NSMutableDictionary, _PASBloomFilterForWriting, BMSource, NSObject, _DKContactsPrivacyMaintainer, NSMutableArray, NSString, _PASLock, _CDUserActivityCache, _CDReceiverNotifier, _DKRateLimitPolicyEnforcer, _CDSpotlightCoalescedDeletionManager, _DKPrivacyPolicyEnforcer;
...
@interface _CDSpotlightItemRecorder : NSObject <SpotlightReceiver, CSSearchableIndexObserver> {
    ...
    char _registeredSpotlightReceiver;
