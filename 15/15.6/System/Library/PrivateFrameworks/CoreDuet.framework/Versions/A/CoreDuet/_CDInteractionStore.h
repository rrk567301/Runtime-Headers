...
@property (nonatomic) char readConcurrently;

+ (id)defaultDatabaseDirectory;
+ (id)predicateFilteringUsernameForPredicate:(id)a0;
+ (id)storeWithDirectory:(id)a0 knowledgeStore:(id)a1 readOnly:(char)a2;
...
- (char)_deleteMetadataForKey:(id)a0 moc:(id)a1;
- (void)_iterInteractionRecordsWithPredicate:(id)a0 fetchLimit:(unsigned long long)a1 batchSize:(unsigned long long)a2 updateTelemetry:(id /* block */)a3 withBlock:(id /* block */)a4;
...
- (id)appendMissingInformationForRecord:(id)a0 fromContact:(id)a1 cacheUpdateRequired:(char *)a2;
...
- (char)recordInteractions:(id)a0 error:(id *)a1;
- (char)recordInteractionsBatch:(id)a0 error:(id *)a1;
- (char)recordVersionNumber:(long long)a0;
...
- (void)updateCachedStatsForContactRecord:(id)a0 isSender:(char)a1 withInteraction:(id)a2;
- (char)updateInteractions:(id)a0 error:(id *)a1;
- (char)updateInteractionsBatch:(id)a0 error:(id *)a1;
