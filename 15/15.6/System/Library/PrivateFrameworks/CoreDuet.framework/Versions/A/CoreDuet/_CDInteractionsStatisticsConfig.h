...
@property (readonly, nonatomic) char shouldUseSuggestionEngaged;
...
- (id)initWithAnchorDate:(id)a0 leftBoundDate:(id)a1 rightBoundDate:(id)a2 fetchLimit:(unsigned long long)a3 maxComputationTime:(double)a4 featureNamesToSortWith:(id)a5 shouldUseSuggestionEngaged:(char)a6 statsDefaultValues:(id)a7;
- (id)initWithAnchorDate:(id)a0 leftBoundDate:(id)a1 rightBoundDate:(id)a2 fetchLimit:(unsigned long long)a3 maxComputationTime:(double)a4 featureNamesToSortWith:(id)a5 shouldUseSuggestionEngaged:(char)a6 statsDefaultValues:(id)a7 scenesBasedFeatures:(id)a8 scenesMinimumNumberOfTags:(id)a9;
