...
@property (readonly) char isHandlerAsynchronous;

+ (id)jobWithInterval:(double)a0 schedulerJobName:(id)a1 handler:(id /* block */)a2;
+ (id)jobWithInterval:(double)a0 schedulerJobName:(id)a1 queue:(id)a2 asynchronousHandler:(char)a3 handler:(id /* block */)a4;
+ (id)jobWithPeriod:(long long)a0 schedulerJobName:(id)a1 handler:(id /* block */)a2;

- (id)init;
- (void).cxx_destruct;
- (id)initWithPeriod:(long long)a0 interval:(double)a1 schedulerJobName:(id)a2 queue:(id)a3 asynchronousHandler:(char)a4 handler:(id /* block */)a5;
