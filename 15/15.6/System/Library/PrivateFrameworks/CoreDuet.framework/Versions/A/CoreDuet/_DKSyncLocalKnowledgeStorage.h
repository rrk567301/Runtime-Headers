...
- (char)deleteEventsWithEventIDs:(id)a0 error:(id *)a1;
...
- (char)saveEvents:(id)a0 error:(id *)a1;
- (char)saveSyncedDownWindows:(id)a0 peer:(id)a1 transportName:(id)a2 error:(id *)a3;
