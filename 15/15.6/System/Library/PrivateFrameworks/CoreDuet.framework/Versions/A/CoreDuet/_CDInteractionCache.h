...
- (void)_countConversationIDsForInteraction:(id)a0 deleted:(char)a1;
- (void)_deleteInteractions:(id)a0;
- (void)_forceRefetch;
- (void)_handleInteractionRemoval:(id)a0;
- (void)_rebuildMostRecentInteractions;
- (void)_refetch;
- (void)_updateMostRecentInteractionsWithInteraction:(id)a0 deleted:(char)a1;
- (void)cacheInteractionsForTesting:(id)a0;
- (char)containsUniqueCacheCandidate:(id)a0;
