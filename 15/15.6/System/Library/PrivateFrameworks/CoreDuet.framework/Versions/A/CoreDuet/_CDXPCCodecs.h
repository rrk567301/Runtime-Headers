...
+ (id)_log;
+ (char)addDeviceIDs:(id)a0 toDictionary:(id)a1 error:(id *)a2;
...
+ (id)keepAliveEventWithKeepAlive:(char)a0 error:(id *)a1;
+ (char)keepAliveFromKeepAliveEvent:(id)a0 error:(id *)a1;
...
+ (char)parseNotificationEvent:(id)a0 registrationIdentifier:(id *)a1 info:(id *)a2 error:(id *)a3;
