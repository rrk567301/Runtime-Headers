...
@property (nonatomic) char executeConcurrently;

+ (id)endDateSortDescriptorAscending:(char)a0;
+ (id)predicateForEventsWithBundleID:(id)a0;
+ (id)predicateForEventsWithSourceID:(id)a0;
+ (id)creationDateSortDescriptorAscending:(char)a0;
+ (id)executableQueryForQuery:(id)a0;
+ (id)localCreationDateSortDescriptorAscending:(char)a0;
...
+ (id)startDateSortDescriptorAscending:(char)a0;
