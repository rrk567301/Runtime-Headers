...
@property char enforceDataLimits;
@property char enforcePrivacy;
...
- (void)countContactsUsingPredicate:(id)a0 synchronous:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)countInteractionsUsingPredicate:(id)a0 synchronous:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)deleteInteractionsMatchingPredicate:(id)a0 synchronous:(char)a1 sortDescriptors:(id)a2 limit:(unsigned long long)a3 debuggingReason:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)deleteInteractionsWithBundleId:(id)a0 synchronous:(char)a1 account:(id)a2 completionHandler:(id /* block */)a3;
- (void)deleteInteractionsWithBundleId:(id)a0 synchronous:(char)a1 completionHandler:(id /* block */)a2;
- (void)deleteInteractionsWithBundleId:(id)a0 synchronous:(char)a1 domainIdentifier:(id)a2 completionHandler:(id /* block */)a3;
- (void)deleteInteractionsWithBundleId:(id)a0 synchronous:(char)a1 domainIdentifiers:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)queryContactsUsingPredicate:(id)a0 synchronous:(char)a1 sortDescriptors:(id)a2 limit:(unsigned long long)a3 completionHandler:(id /* block */)a4;
...
- (void)queryInteractionsUsingPredicate:(id)a0 synchronous:(char)a1 sortDescriptors:(id)a2 limit:(unsigned long long)a3 completionHandler:(id /* block */)a4;
- (char)recordInteraction:(id)a0;
- (char)recordInteractions:(id)a0;
- (void)recordInteractions:(id)a0 completionHandler:(id /* block */)a1;
- (char)recordInteractions:(id)a0 synchronous:(char)a1 completionHandler:(id /* block */)a2;
