...
@property (nonatomic) char enableBiomeMigrationDeletion;
@property (readonly, nonatomic) char localOnly;
...
+ (id)storageWithDirectory:(id)a0 readOnly:(char)a1 localOnly:(char)a2;
+ (id)storageWithShallowCopyFromStorage:(id)a0 clientIdentifier:(id)a1;
+ (id)storeWithDirectory:(id)a0 readOnly:(char)a1;
...
- (char)coreDataStorage:(id)a0 didAutoMigratePersistentStore:(id)a1 toManagedObjectModel:(id)a2 havingVersion:(unsigned long long)a3 error:(id *)a4;
- (id)coreDataStorage:(id)a0 needsManagedObjectModelNameForVersion:(unsigned long long)a1;
- (char)coreDataStorage:(id)a0 shouldCallDelegateAfterAutoMigrationToManagedObjectModelHavingVersion:(unsigned long long)a1;
- (char)coreDataStorage:(id)a0 shouldCallDelegateBeforeAutoMigrationFromManagedObjectModelHavingVersion:(unsigned long long)a1;
- (char)coreDataStorage:(id)a0 willAutoMigrateStoreAtURL:(id)a1 fromManagedObjectModel:(id)a2 havingVersion:(unsigned long long)a3 error:(id *)a4;
...
- (char)migrateDataToBiomeWithManagedObjectContext:(id)a0;
- (void)removeKnowledgeStorageEventNotificationDelegate:(id)a0;
- (char)saveChangeSetsForSync:(id)a0 error:(id *)a1;
...
- (char)saveSyncPeer:(id)a0 error:(id *)a1;
