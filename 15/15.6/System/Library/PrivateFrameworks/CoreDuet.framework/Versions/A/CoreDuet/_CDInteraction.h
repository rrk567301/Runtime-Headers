...
@property (readonly, nonatomic) char userIsSender;
@property (readonly, nonatomic) NSDate *timestamp;
@property (readonly, nonatomic) NSArray *peopleIdentifiers;
@property (readonly, nonatomic) NSString *title;
@property (readonly, nonatomic) char userIsThreadInitiator;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) char forcePersistInteraction;
@property (nonatomic) char mailShareSheetDeletionCandidate;
...
- (char)isGroupChat;
- (char)isInteractionMechanismCalls;
- (char)isUncachedSentinel;
- (char)isValidInteraction;
