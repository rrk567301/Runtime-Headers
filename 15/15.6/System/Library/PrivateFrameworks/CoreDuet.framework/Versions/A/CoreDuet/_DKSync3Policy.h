...
- (id)init;
- (void).cxx_destruct;
- (char)_anyFeaturePropertyValueWithKey:(id)a0 getterBlock:(id /* block */)a1;
- (unsigned long long)_maximumPropertyValueWithKey:(id)a0 policies:(id)a1 skipZeroValues:(char)a2;
- (unsigned long long)_minimumPropertyValueWithKey:(id)a0 policies:(id)a1 skipZeroValues:(char)a2;
