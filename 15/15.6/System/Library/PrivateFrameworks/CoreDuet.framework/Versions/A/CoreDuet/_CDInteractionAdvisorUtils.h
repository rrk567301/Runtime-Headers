...
+ (id)adviceBasedOnInteractions:(id)a0 forContacts:(id)a1 andRanker:(id)a2 ignoringContacts:(id)a3 withLimit:(unsigned long long)a4 aggregateByIdentifier:(char)a5 requireOneOutgoingInteraction:(char)a6;
+ (void)adjustForConsumerSettings:(id)a0 modelSettings:(id)a1 andRanker:(id)a2;
+ (char)adjustRanker:(id)a0 forModel:(unsigned long long)a1;
+ (char)contact:(id)a0 mayRepresentTheSamePersonAsOneOf:(id)a1;
