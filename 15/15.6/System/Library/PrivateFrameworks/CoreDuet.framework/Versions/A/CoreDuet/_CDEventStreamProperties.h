...
@property (readonly, nonatomic) char dataCollectionEnabled;
...
@property (readonly, nonatomic) char isInstant;
@property (readonly, nonatomic) char isHistorical;
@property (readonly, nonatomic) char shouldSaveCurrentEventOnShutdown;
@property (readonly, nonatomic) char setupOnDemand;
