...
+ (char)copyMetadata:(id)a0 toManagedObject:(id)a1;
...
+ (id)eventValueFromManagedObject:(id)a0 streamName:(id)a1 readMetadata:(char)a2 excludedMetadataKeys:(id)a3 cache:(id)a4;
+ (id)eventWithInteraction:(id)a0 bundleIdentifier:(id)a1 storeKeyImage:(char)a2;
...
+ (id)fromPBCodable:(id)a0 skipMetadata:(char)a1;
+ (char)isValidURL:(id)a0;
+ (id)metadataForInteraction:(id)a0 storeKeyImage:(char)a1;
...
+ (id)uncachedEventValueFromManagedObject:(id)a0 readMetadata:(char)a1 excludedMetadataKeys:(id)a2 cache:(id)a3;
...
- (id)relevantShortcut;
- (id)toPBCodable;
- (id)toPBCodableUseStructuredMetadata:(char)a0;
