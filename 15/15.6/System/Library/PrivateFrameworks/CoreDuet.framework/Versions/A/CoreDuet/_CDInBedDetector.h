...
- (id)detectInBedWithPolicyV2BetweenStartDate:(id)a0 endDate:(id)a1 error:(id *)a2 motionBased:(char)a3;
...
- (id)findMotionTerminusBetweenStartDate:(id)a0 endDate:(id)a1 latest:(char)a2 error:(id *)a3;
