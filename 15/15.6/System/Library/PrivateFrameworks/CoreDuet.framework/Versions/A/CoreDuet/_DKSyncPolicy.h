...
@property (readonly, nonatomic) char syncDisabled;
@property (readonly, nonatomic) char alwaysSyncUpAndDown;
...
@property (readonly, nonatomic) char pushTriggersSync;
...
@property (readonly, nonatomic) char forceSync;
...
- (id)queryStartDateFromLastDaySyncDates:(id)a0 lastSyncDate:(id)a1 isSingleDevice:(char)a2 isTriggeredSync:(char)a3;
