...
@property (nonatomic) char hasMaxEnrolled;
@property (nonatomic) double retrievalTimeout;
@property (nonatomic) char hasRetrievalTimeout;
@property (nonatomic) int maxEntityChars;
@property (nonatomic) char hasMaxEntityChars;
@property (nonatomic) int maxEntityWords;
@property (nonatomic) char hasMaxEntityWords;
@property (copy, nonatomic) NSArray *enabledTasks;
@property (nonatomic) int requestTask;
@property (nonatomic) char hasRequestTask;
