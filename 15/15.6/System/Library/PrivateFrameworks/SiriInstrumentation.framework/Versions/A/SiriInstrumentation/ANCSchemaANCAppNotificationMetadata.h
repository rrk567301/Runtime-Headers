...
@property (nonatomic) char hasCommsNotificationType;
@property (nonatomic) char isSmsEligible;
@property (nonatomic) char hasIsSmsEligible;
@property (nonatomic) char isAskWithSiriEnabled;
@property (nonatomic) char hasIsAskWithSiriEnabled;
