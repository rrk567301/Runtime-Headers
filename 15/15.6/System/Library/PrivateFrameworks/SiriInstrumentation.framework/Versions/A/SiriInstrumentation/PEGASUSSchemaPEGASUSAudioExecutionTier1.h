...
@property (nonatomic) char hasAudioLaunchId;
@property (copy, nonatomic) NSString *audioType;
@property (nonatomic) char hasAudioType;
...
@property (nonatomic) char hasAudioUnderstandingTier1;
@property (retain, nonatomic) PEGASUSSchemaPEGASUSAudioQueueStateInfoTier1 *audioQueueStateInfoTier1;
@property (nonatomic) char hasAudioQueueStateInfoTier1;
