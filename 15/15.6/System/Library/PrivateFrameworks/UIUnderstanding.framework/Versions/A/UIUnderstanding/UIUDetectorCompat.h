@interface UIUDetectorCompat : NSObject {
    ...
    void /* unknown type, empty encoding */ grouper;
...
- (id)init;
- (void).cxx_destruct;
- (id)getUIObjectsInScreen:(struct CGImage { } *)a0 addOCR:(char)a1 addIconRecognition:(char)a2 addClickability:(char)a3 addFocusElements:(char)a4 nmsThreshold:(float)a5 useAccurateOCR:(char)a6 error:(id *)a7;
