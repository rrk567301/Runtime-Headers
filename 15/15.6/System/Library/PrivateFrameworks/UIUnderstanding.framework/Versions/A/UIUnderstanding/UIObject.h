...
@property (readonly, nonatomic) char clickabilityDetection;
@property (readonly, nonatomic) float clickabilityConfidence;
@property (readonly, nonatomic) char focusDetection;
@property (readonly, nonatomic) float focusConfidence;
@property (readonly, nonatomic) NSArray *children;

- (void).cxx_destruct;
- (id)initWithCompat:(id)a0;
- (id)init:(long long)a0 confidence:(double)a1 text:(id)a2 boundingBox:(id)a3 children:(id)a4 clickable:(char)a5 focused:(char)a6;
