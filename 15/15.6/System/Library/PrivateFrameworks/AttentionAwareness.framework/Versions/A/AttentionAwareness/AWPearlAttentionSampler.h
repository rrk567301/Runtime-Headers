...
@interface AWPearlAttentionSampler : AWAttentionSampler <PearlCameraInterfaceMessaging> {
    ...
    char _enrollOrMatchOperationUnderway;
}
...
- (id)initForUnitTest:(BOOL)a0 useAVFoundation:(char)a1;
- (unsigned long long)minimumAttentionSamplerErrorRetryTime;
- (unsigned long long)nextSampleTimeForSamplingInterval:(unsigned long long)a0 ignoreDisplayState:(char)a1;
