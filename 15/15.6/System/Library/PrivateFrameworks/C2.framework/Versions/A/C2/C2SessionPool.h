...
@property (nonatomic) char cleanUp_running;
...
@property (nonatomic) char testBehavior_disableAutomaticCleanup;
...
- (void)_cleanUpEmptySessionGroup_job_withThreshold:(unsigned long long)a0;
- (char)_cleanUp_job;
- (void)_cleanUp_schedule;
- (void)_unsafe_didCreate:(id)a0;
- (char)_unsafe_isCreating:(id)a0;
...
- (char)testBehavior_cleanUp;
- (void)testBehavior_cleanUpWithThreshold:(unsigned long long)a0;
- (void)testBehavior_didCreate:(id)a0;
- (void)testBehavior_willCreate:(id)a0;
