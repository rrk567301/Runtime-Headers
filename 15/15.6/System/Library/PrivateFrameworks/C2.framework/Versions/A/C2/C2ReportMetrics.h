...
@property (nonatomic) char ignoreRequestThrottle;
...
+ (void)_c2FormatValueForRTC:(id)a0 keyPrefix:(id)a1 targetDictionary:(id)a2 multipleOperationGroups:(char)a3;
...
- (void)send;
- (id)initWithMetricRequest:(id)a0 metricRequestOptions:(id)a1 ignoreRequestThrottle:(char)a2 requestThrottleIdentifier:(id)a3 requestThrottleLimit:(unsigned long long)a4;
