...
@property (nonatomic, setter=_setShouldObserveLayout:) char _shouldObserveLayout;
...
- (id)initWithIntent:(id)a0 supportedExtensionTypes:(long long)a1 donateInteraction:(char)a2 groupIdentifier:(id)a3 remoteProxyProvider:(id /* block */)a4;
