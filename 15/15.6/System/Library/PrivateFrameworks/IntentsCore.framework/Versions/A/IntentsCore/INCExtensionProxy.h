...
@property (readonly, nonatomic, getter=_isExtensionBeingDebugged) char _extensionBeingDebugged;
...
@property (nonatomic) char shouldResetRequestAfterHandle;

+ (void)initialize;
+ (id)_errorAggregation:(id)a0 innerError:(id)a1;
...
- (char)_extensionProcessHasEntitlement:(id)a0;
- (id)_initWithConnection:(id)a0 extension:(id)a1 vendorRemote:(id)a2 auditTokenValue:(id)a3;
- (char)_isIntentRestrictedWhileProtectedDataUnavailableWithCompletionHandler:(id /* block */)a0;
...
- (char)_shouldForwardToAppWithIntent:(id)a0 intentResponse:(id)a1;
