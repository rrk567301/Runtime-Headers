...
+ (void)trackDirectionsEngagedForNotificationUsingTTLEventTracker:(id)a0 hypothesis:(id)a1 hasSuggestedLocation:(char)a2 isOnSharedCalendar:(char)a3;
+ (void)trackEmailEngagedForNotificationUsingTTLEventTracker:(id)a0 hypothesis:(id)a1 hasSuggestedLocation:(char)a2 isOnSharedCalendar:(char)a3;
