...
- (void).cxx_destruct;
- (char)removeIconWithIdentifier:(id)a0 error:(id *)a1;
- (char)_addIconWithIdentifier:(id)a0 toCacheAtPath:(id)a1;
- (char)_createCacheDirectoryIfNeeded;
- (char)addIconsWithIdentifiers:(id)a0 error:(id *)a1;
- (id)cachedIconPathForIconIdentifier:(id)a0;
- (char)forceRemoveAllCachedIconsWithError:(id *)a0;
