...
- (void)_handleNotificationActionForSourceClientIdentifier:(id)a0 acknowledgeAlarm:(char)a1 eventActions:(id /* block */)a2;
...
- (char)_shouldTriggerForAlertInfo:(id)a0;
- (char)_shouldWithdrawNotificationWithSourceClientIdentifier:(id)a0 event:(id)a1 alarmID:(id)a2;
- (void)acknowledgeEventWithSourceClientIdentifier:(id)a0 shouldMarkAsHavingReceivedLocation:(char)a1;
...
- (id)fetchTriggeredEventNotificationInfoWithSourceClientIdentifier:(id)a0 isProtectedDataAvailable:(char)a1;
...
- (char)shouldRemoveNotificationMetaDataWithEventID:(id)a0;
- (char)shouldRemoveTimeToLeaveRefreshTimerWithRefreshDate:(id)a0 eventID:(id)a1;
- (char)shouldWithdrawNotificationWithSourceClientIdentifier:(id)a0;
- (void)snoozeEventWithSourceClientIdentifier:(id)a0 snoozeType:(unsigned long long)a1;
- (void)travelEngine:(id)a0 authorizationChanged:(char)a1;
