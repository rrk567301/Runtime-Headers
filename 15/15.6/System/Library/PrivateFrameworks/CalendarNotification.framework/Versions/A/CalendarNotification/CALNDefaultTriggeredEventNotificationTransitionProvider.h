...
- (void).cxx_destruct;
- (char)_shouldAddNotificationForTravelAdviceReceivedForSourceClientIdentifier:(id)a0 sourceNotificationInfo:(id)a1 oldNotificationData:(id)a2;
- (char)_shouldModifyForAlarmFiredForSourceClientIdentifier:(id)a0 sourceNotificationInfo:(id)a1 oldNotificationData:(id)a2;
- (char)_shouldRemoveNotificationForTravelAdviceReceivedForSourceClientIdentifier:(id)a0 sourceNotificationInfo:(id)a1 oldNotificationData:(id)a2;
- (char)_timeToLeaveStateAlreadyDisplayedBasedOnSourceNotificationInfo:(id)a0 oldNotificationData:(id)a1;
