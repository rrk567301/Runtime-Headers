...
- (id)_contentForNotificationWithSourceClientIdentifier:(id)a0 shouldClearHypothesis:(char)a1;
...
- (char)_isNotificationMetaDataExpired:(id)a0 eventID:(id)a1;
- (char)_itemWithEventID:(id)a0 affectedByChangesToObjects:(id)a1;
- (id)_launchURLForResponse:(id)a0;
- (char)_mayCeaseRouteMonitoringForExistingNotificationData:(id)a0;
...
- (char)_notificationWithSourceClientIdentifier:(id)a0 affectedByChangesToObjects:(id)a1;
...
- (char)_shouldCeaseRouteMonitoringEventForSourceClientIdentifier:(id)a0;
- (char)_shouldRemoveNotificationMetaData:(id)a0 eventID:(id)a1;
- (char)_shouldRemoveStoredNotificationDataGivenShouldWithdrawNotification:(char)a0 hasExistingTravelInformation:(char)a1 mayCeaseRouteMonitoring:(char)a2;
- (char)_shouldRemoveTimeToLeaveRefreshTimerWithRefreshDate:(id)a0 eventID:(id)a1;
- (char)_shouldUpdateStoredNotificationDataGivenTransition:(unsigned long long)a0;
- (char)_sourceClientIdentifier:(id)a0 matchesEventForSourceClientIdentifier:(id)a1;
- (id)_sourceNotificationInfoForSourceClientIdentifier:(id)a0 notificationInfo:(id)a1 existingNotificationData:(id)a2 hypothesis:(id)a3 shouldClearHypothesis:(char)a4 isOffsetFromTravelTimeStart:(char)a5 isForContentCreation:(char)a6;
- (id)_sourceNotificationInfoForSourceClientIdentifier:(id)a0 shouldClearHypothesis:(char)a1 isForContentCreation:(char)a2;
- (void)_travelAdvisoryAuthorizationChanged:(char)a0;
...
- (void)_updateNotification:(id)a0 shouldClearHypothesis:(char)a1;
...
- (void)_updateTimeToLeaveRefreshTimerForSourceClientIdentifier:(id)a0 hypothesis:(id)a1 allowsLocationAlerts:(char)a2 travelAdvisoryDisabled:(char)a3;
- (id)_updatedLastFireTimeOfAlertOffsetFromTravelTimeGivenIsOffsetFromTravelTime:(char)a0;
...
- (id)contentForSourceClientIdentifier:(id)a0 sourceNotificationInfo:(id)a1 isProtectedDataAvailable:(char)a2;
- (void)dataSource:(id)a0 travelAdvisoryAuthorizationChanged:(char)a1;
...
- (char)migrateToStorage:(id)a0;
- (void)refreshNotifications:(id)a0;
- (void)snoozeTimerFiredForEvents:(id)a0;
- (char)sourceClientIdentifier:(id)a0 matchesEventForSourceClientIdentifier:(id)a1;
