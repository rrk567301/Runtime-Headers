...
- (id)description;
- (void).cxx_destruct;
- (id)initWithSourceClientIdentifier:(id)a0 launchURL:(id)a1 expirationDate:(id)a2 conflictDetails:(id)a3 eventInvitationNotification:(id)a4 eventRepresentationDictionary:(id)a5 eventURI:(id)a6 isDelegate:(char)a7 sourceTitle:(id)a8 sourceIdentifier:(id)a9;
