...
- (id)description;
- (void).cxx_destruct;
- (id)initWithSourceClientIdentifier:(id)a0 launchURL:(id)a1 expirationDate:(id)a2 eventInvitationNotification:(id)a3 eventRepresentationDictionary:(id)a4 isDelegate:(char)a5 sourceTitle:(id)a6 sourceIdentifier:(id)a7;
