...
+ (id)_filesToMigrate;
+ (id)_createNotificationStorageAtPath:(id)a0 protected:(char)a1;
+ (id)_createTimeToLeaveRefreshStorageAtPath:(id)a0;
+ (id)_createTriggeredEventNotificationDataStorageAtPath:(id)a0 protected:(char)a1;
...
- (void)activate;
- (void)deactivate;
- (void)_updateLocaleReloadIfDifferent:(char)a0;
