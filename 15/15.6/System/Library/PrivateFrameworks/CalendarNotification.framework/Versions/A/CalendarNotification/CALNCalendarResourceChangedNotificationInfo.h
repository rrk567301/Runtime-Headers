...
- (id)description;
- (void).cxx_destruct;
- (id)initWithSourceClientIdentifier:(id)a0 calendarNotification:(id)a1 changeType:(unsigned int)a2 date:(id)a3 allDay:(char)a4 timeZone:(id)a5 expirationDate:(id)a6 launchURL:(id)a7 isDelegate:(char)a8 sourceTitle:(id)a9 sourceIdentifier:(id)a10;
