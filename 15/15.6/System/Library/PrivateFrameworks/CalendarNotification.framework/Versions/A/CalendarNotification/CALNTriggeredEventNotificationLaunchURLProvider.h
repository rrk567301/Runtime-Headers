...
+ (id)_launchURLForEventID:(id)a0 hypothesis:(id)a1 isTravelLaunchURL:(char *)a2;
+ (id)_travelLaunchURLForEventID:(id)a0 hypothesis:(id)a1;
+ (id)launchURLForOptionalEventID:(id)a0 hypothesis:(id)a1 isTravelLaunchURL:(char *)a2;
