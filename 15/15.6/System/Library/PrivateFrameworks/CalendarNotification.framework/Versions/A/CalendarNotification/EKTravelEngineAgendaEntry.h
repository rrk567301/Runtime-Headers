...
@property (nonatomic) char geocodedEventEncountered;
@property (nonatomic) char hypothesizerSentAtLeastOneHypothesis;
...
- (void)_updateTravelTimeExceededThresholdStateUsingExceededValue:(char)a0;
