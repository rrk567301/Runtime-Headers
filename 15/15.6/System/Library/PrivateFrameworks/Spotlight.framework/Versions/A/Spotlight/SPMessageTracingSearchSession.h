...
@property (nonatomic) char hadQuery;
@property (nonatomic) char searchWindowDidExpand;
@property (nonatomic) char didEndByClearing;
@property (nonatomic) char didEnd;
...
- (void)parsecQuery:(id)a0 didFinishWithResultsCount:(long long)a1 sectionCount:(long long)a2 success:(char)a3;
