...
@interface SPCoreSpotlightQuery : SPMetadataQuery {
    ...
    char _priorityTimerFired;
    char _priorityResultsArrived;
}
...
- (char)_removedItems:(id)a0 forBundleID:(id)a1;
- (char)_updateGroupSection:(id)a0 withResults:(id)a1;
- (char)_updateGroupSections:(id)a0;
- (char)_updateResultSet:(id)a0 withSortedResults:(id)a1;
...
- (id)responseSections;
- (char)topHitNominatedByPommesScoringforBundleIdentifier:(id)a0;
