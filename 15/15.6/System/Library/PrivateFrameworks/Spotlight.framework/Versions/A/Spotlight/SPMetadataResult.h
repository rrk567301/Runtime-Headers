...
- (char)isAppSpellCorrectionCandidate:(id)a0;
- (char)isEqualToMetadataResult:(id)a0;
- (char)isLocalApplicationResult;
- (char)isMetadataResult;
- (char)isValidObjectTypeIfDateAttribute:(id)a0 value:(id)a1;
- (id)otherNames;
- (id)otherTypes;
