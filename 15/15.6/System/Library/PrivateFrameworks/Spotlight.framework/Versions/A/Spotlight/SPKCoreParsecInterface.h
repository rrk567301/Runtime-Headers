...
- (void)query:(id)a0 didFinishWithResults:(id)a1 withSuggestions:(id)a2 withCorrections:(id)a3 withAlternativeResults:(id)a4 suggestionsAreBlended:(char)a5;
