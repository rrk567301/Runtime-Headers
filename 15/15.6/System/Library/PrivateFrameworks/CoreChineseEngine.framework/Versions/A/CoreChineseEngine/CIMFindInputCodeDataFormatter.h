...
@property (nonatomic) char zhuyinChabaiMode;
@property (nonatomic, getter=isSimplifiedChinese) char simplifiedChinese;
...
- (id)_stringFromArray:(id)a0 colorString:(char)a1;
