...
@interface ATXHeroEntriesPb : PBCodable <NSCopying> {
    ...
    struct { char *list; unsigned long long count; unsigned long long size; } _isTouristApps;
...
@property (readonly, nonatomic) char *isTouristApps;
...
- (char)isTouristAppAtIndex:(unsigned long long)a0;
...
- (void)setIsTouristApps:(char *)a0 count:(unsigned long long)a1;
