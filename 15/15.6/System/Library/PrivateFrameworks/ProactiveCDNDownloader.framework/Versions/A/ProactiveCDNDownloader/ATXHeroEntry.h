...
@property (readonly, nonatomic) char isTouristApp;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)heroDataForLocation:(id)a0;
- (id)initWithAdamId:(unsigned long long)a0 urlHash:(id)a1 location:(struct CLLocationCoordinate2D { double x0; double x1; })a2 radiusInMeters:(unsigned long long)a3 rank:(unsigned long long)a4 isTouristApp:(char)a5 poiCategory:(id)a6 poiMuid:(id)a7;
- (char)isEqualToAppAndClipEntry:(id)a0;
