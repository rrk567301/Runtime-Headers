...
- (char)getPropertiesForDSID:(unsigned long long)a0 appleID:(id *)a1 altDSID:(id *)a2;
- (char)setAppleID:(id)a0 altDSID:(id)a1 forDSID:(unsigned long long)a2;
- (char)setAppleID:(id)a0 forDSID:(unsigned long long)a1;
