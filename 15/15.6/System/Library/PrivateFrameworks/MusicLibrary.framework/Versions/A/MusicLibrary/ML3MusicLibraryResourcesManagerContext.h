...
@property (readonly, nonatomic, getter=isRunningInDaemon) char runningInDaemon;
@property (readonly, nonatomic, getter=isMultiUserSupported) char multiUserSupported;
...
- (void).cxx_destruct;
- (id)_initWithResourcesService:(id)a0 accountInfo:(id)a1 libraryContainerIdentifier:(id)a2 accountChangeObserver:(id)a3 supportsMultiUsers:(char)a4 runningInDaemon:(char)a5;
