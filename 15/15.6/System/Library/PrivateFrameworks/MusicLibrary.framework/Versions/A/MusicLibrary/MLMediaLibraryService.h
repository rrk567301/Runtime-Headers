...
- (void)checkIntegrityOfDatabaseAtPath:(id)a0 repairFaults:(char)a1 withCompletionHandler:(id /* block */)a2;
- (id)clientImportServiceListenerEndpointWithError:(id *)a0;
- (char)endTransaction:(id)a0 shouldCommit:(char)a1 error:(id *)a2;
- (void)endTransaction:(id)a0 shouldCommit:(char)a1 withCompletionHandler:(id /* block */)a2;
...
- (char)performDatabaseOperation:(unsigned long long)a0 withAttributes:(id)a1 options:(id)a2 error:(id *)a3;
...
- (char)validateDatabaseAtPath:(id)a0 error:(id *)a1;
