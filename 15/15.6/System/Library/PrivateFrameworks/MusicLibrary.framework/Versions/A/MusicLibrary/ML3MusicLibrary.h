@class NSMutableDictionary, ML3AccountCacheDatabase, NSMapTable, NSDate, NSDictionary, NSObject, ML3DatabasePrivacyContext, ML3DatabaseMetadata, ML3LibraryNotificationManager, NSString, ML3Container, NSMutableSet, NSArray, NSNumber, ML3DatabaseConnectionPool, NSLock, ML3MusicLibraryResourcesManager;
...
@property (class, nonatomic) char autoFilledTracksArePurgeable;
@property (class, nonatomic) char shouldOptimizeStorage;
@property (class, nonatomic) long long minimumPurgeableStorage;
@property (class, readonly, nonatomic) char deviceSupportsASTC;
...
@property (nonatomic) char sagaNeedsFullUpdate;
@property (nonatomic) char sagaInitiateClientResetSync;
@property (nonatomic) char sagaPrefersToMergeWithCloudLibrary;
...
@property (nonatomic) char jaliscoHasCloudGeniusData;
@property (nonatomic) char jaliscoIsMusicGeniusUserEnabled;
@property (nonatomic) char jaliscoNeedsUpdateForTokens;
...
@property (nonatomic, getter=isAutoUpdatingSharedLibrary) char autoUpdatingSharedLibrary;
...
@property (readonly, nonatomic, getter=isLibraryEmpty) char libraryEmpty;
...
@property (readonly, nonatomic) char downloadOnAddToLibrary;
@property (nonatomic) char isUnitTesting;
...
@property (readonly, nonatomic) char hasUserPlaylists;
@property (readonly, nonatomic) char hasAddedToLibraryAppleMusicContent;
@property (readonly, nonatomic) char hasUserPlaylistsContainingAppleMusicContent;
...
+ (id)mediaFolderPath;
+ (id)_onGlobalQueue_shareableMusicLibraryWithResourcesManager:(id)a0 libraryFilePath:(id)a1;
+ (id)allLibraryContainerPaths;
+ (id)allPragmaSQL;
+ (id)allSchemaSQL;
+ (id)allTriggersSQL;
+ (id)artworkRelativePathFromToken:(id)a0;
+ (id)artworkRelativePathFromToken:(id)a0 variantType:(long long)a1;
...
+ (char)dropIndexesUsingConnection:(id)a0 tableNames:(const char *)a1;
...
+ (char)orderingLanguageMatchesSystemUsingConnection:(id)a0;
...
+ (char)updateTrackIntegrityOnConnection:(id)a0;
+ (char)userVersionMatchesSystemUsingConnection:(id)a0;
...
- (char)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4;
...
- (void)_autogenerateArtworkForRelativePath:(id)a0 artworkType:(long long)a1 mediaType:(unsigned int)a2 variantType:(long long)a3 completionHandler:(id /* block */)a4;
- (char)_canConfigureMediaLibraryDatabaseConnection:(id)a0;
- (long long)_clearAllCloudAssets;
- (char)_clearAllRowsFromTables:(id)a0;
...
- (long long)_clearPurgeableTracksOfAmount:(long long)a0 withUrgency:(unsigned long long)a1 includeAutoFilledTracks:(char)a2;
- (long long)_clearPurgeableTracksOfAmount:(long long)a0 withUrgency:(unsigned long long)a1 includeCloudAssets:(char)a2 includeAutoFilledTracks:(char)a3;
- (void)_closeAndLockCurrentDatabaseConnections;
- (long long)_cloudAssetsTotalSize;
- (char)_coalesceMismatchedCollectionClass:(Class)a0 usingConnection:(id)a1;
...
- (char)_determineAndUpdateBestArtworkTokensForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 retrievalTime:(double)a3 preserveExistingAvailableToken:(char)a4 usingConnection:(id)a5;
- (char)_determineAndUpdateBestArtworkTokensForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 retrievalTime:(double)a3 preserveExistingAvailableToken:(char)a4 variantType:(long long)a5 usingConnection:(id)a6;
...
- (void)_enumeratePurgeableTracksForUrgency:(unsigned long long)a0 includeAutoFilledTracks:(char)a1 includeCloudAssets:(char)a2 usingBlock:(id /* block */)a3;
- (id)_getPlaylistContentTasteChangesSinceRevision:(long long)a0 withGrappaID:(unsigned int)a1;
- (char)_insertArtworkRowWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 relativePath:(id)a3;
- (char)_insertArtworkRowWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 relativePath:(id)a4;
- (char)_insertArtworkRowWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 relativePath:(id)a4 usingConnection:(id)a5;
...
- (char)_prepareForAccountChange:(id *)a0;
...
- (id)_purgeableTrackPredicateWithUrgency:(unsigned long long)a0 includeAutoFilledTracks:(char)a1 includeCloudAssets:(char)a2;
- (long long)_purgeableTracksTotalSizeWithUrgency:(unsigned long long)a0 includeAutoFilledTracks:(char)a1;
- (char)_removeInvalidAvailableArtworkTokensUsingConnection:(id)a0;
- (char)_removeOrphanedArtworkAssetsUsingConnection:(id)a0;
- (char)_removeOrphanedArtworkMetadataUsingConnection:(id)a0;
- (char)_removeOrphanedArtworkTokensUsingConnection:(id)a0;
- (char)_removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 canonocalizeCollections:(char)a3 usingConnection:(id)a4 postNotifications:(char)a5;
- (void)_setupNotificationManager;
- (char)_shouldProcessAccountChanges;
- (char)_shouldPurgeManagedAlbumsTracksForUrgency:(unsigned long long)a0;
...
- (char)_unmanagedPurgeShouldPurgeKeepLocalTracksForUrgency:(unsigned long long)a0;
- (char)_updateBestArtworkTokensForArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 preserveExistingAvailableToken:(char)a4 usingConnection:(id)a5;
- (void)_updateSystemPlaylist:(id)a0 withName:(id)a1 usingConnection:(id)a2;
- (char)_validateDatabaseUsingConnection:(id)a0 error:(id *)a1;
- (void)accessSortKeyBuilder:(id /* block */)a0;
- (id)accountCacheDatabase;
- (id)albumArtistForEffectiveAlbumArtistName:(id)a0;
- (id)albumForAlbumArtistPersistentID:(long long)a0 albumName:(id)a1 feedURL:(id)a2 seasonNumber:(id)a3 compilation:(char)a4;
...
- (char)cleanupArtworkWithOptions:(unsigned long long)a0;
- (char)cleanupArtworkWithOptions:(unsigned long long)a0 usingConnection:(id)a1;
- (char)clearAllCloudKVSData;
- (char)clearAllGeniusData;
- (long long)clearAllRemovedTracks;
- (void)clearCachedCloudLibraryVersionsUsingConnection:(id)a0;
- (void)clearCachedPurchaseHistoryVersionsUsingConnection:(id)a0;
...
- (long long)clearPurgeableStorageAmount:(long long)a0 withUrgency:(unsigned long long)a1 includeAutoFilledTracks:(char)a2;
...
- (char)coalesceMismatchedCollectionsUsingConnection:(id)a0;
- (char)coerceValidDatabaseWithError:(id *)a0;
- (id)composerForComposerName:(id)a0;
- (void)connection:(id)a0 didEndDatabaseTransactionAndCommit:(char)a1;
...
- (void)databaseConnectionAllowingWrites:(char)a0 withBlock:(id /* block */)a1;
- (char)deleteArtworkToken:(id)a0;
...
- (long long)deleteAutoFilledTracksOfAtLeastTotalSize:(long long)a0 urgency:(unsigned long long)a1 respectSongMattress:(char)a2;
...
- (void)enumerateArtworkRelativePathsWithConnection:(id)a0 matchingRelativePathContainer:(id)a1 block:(id /* block */)a2;
...
- (void)enumerateArtworkTokensForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 usingBlock:(id /* block */)a4;
- (void)enumeratePersistentIDsAfterRevision:(long long)a0 revisionTrackingCode:(unsigned long long)a1 maximumRevisionType:(int)a2 forMediaTypes:(id)a3 inUsersLibrary:(char)a4 usingBlock:(id /* block */)a5;
...
- (void)generateArtworkForRelativePath:(id)a0 sizes:(id)a1 completionHandler:(id /* block */)a2;
...
- (char)hasOriginalArtworkForRelativePath:(id)a0;
...
- (void)importArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkToken:(id)a2 artworkType:(long long)a3 sourceType:(long long)a4 variantType:(long long)a5;
- (void)importArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkToken:(id)a2 artworkType:(long long)a3 sourceType:(long long)a4 variantType:(long long)a5 usingConnection:(id)a6;
- (char)importExistingOriginalArtworkWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 mediaType:(unsigned int)a3;
- (char)importExistingOriginalArtworkWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 mediaType:(unsigned int)a3 variantType:(long long)a4;
- (char)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4;
- (char)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(char)a5;
- (void)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(char)a5 completion:(id /* block */)a6;
- (char)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(char)a6;
- (void)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(char)a6 completion:(id /* block */)a7;
- (char)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(char)a5;
- (void)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(char)a5 completion:(id /* block */)a6;
- (char)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(char)a6;
- (void)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(char)a6 completion:(id /* block */)a7;
- (char)inTransactionUpdateSearchMapOnConnection:(id)a0;
- (char)inTransactionUpdateSortMapOnConnection:(id)a0 forceRebuild:(char)a1 forceUpdateOriginals:(char)a2;
- (char)inTransactionUpdateSortMapOnConnection:(id)a0 forceUpdateOriginals:(char)a1;
- (id)initWithClientIdentity:(id)a0 forUserAccount:(id)a1;
- (id)initWithClientIdentity:(id)a0 path:(id)a1;
- (id)initWithClientIdentity:(id)a0 path:(id)a1 readOnly:(char)a2 populateUnitTestTablesBlock:(id /* block */)a3;
- (id)initWithPath:(id)a0 isUnitTesting:(char)a1;
- (id)initWithPath:(id)a0 readOnly:(char)a1 populateUnitTestTablesBlock:(id /* block */)a2;
- (id)initWithResourcesManager:(id)a0;
- (long long)insertStringIntoSortMapNoTransaction:(id)a0;
- (id)insertStringsIntoSortMap:(id)a0;
- (id)insertStringsIntoSortMap:(id)a0 didReSortMap:(char *)a1;
- (char)isArtworkFetchableForPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 artworkSourceType:(long long)a3;
- (char)isArtworkTokenAvailable:(id)a0;
- (char)isArtworkTokenAvailable:(id)a0 forVariantType:(long long)a1;
- (id)libraryContainerPath;
- (id)libraryContainerPathByAppendingPathComponent:(id)a0;
- (id)libraryContainerRelativePath:(id)a0;
- (id)libraryEntityFilterPredicatesForContainerClass:(Class)a0;
- (id)libraryEntityFilterPredicatesForEntityClass:(Class)a0;
- (char)markSystemPurgeableMusicPath:(id)a0 forUrgency:(unsigned long long)a1;
- (id)mediaFolderPathByAppendingPathComponent:(id)a0;
...
- (char)performMainentanceTasksUsingActivity:(id)a0;
- (void)performReadOnlyDatabaseTransactionWithBlock:(id /* block */)a0;
- (char)persistentID:(long long)a0 changedAfterRevision:(long long)a1 revisionTrackingCode:(long long)a2;
- (char)prepareUnitTestDatabaseWithSQLFromContentsOfFile:(id)a0 error:(id *)a1;
- (long long)purgeableStorageSizeWithUrgency:(unsigned long long)a0;
- (long long)purgeableStorageSizeWithUrgency:(unsigned long long)a0 includeAutoFilledTracks:(char)a1;
- (void)reconnectToDatabase;
- (char)removeArtworkAssetWithToken:(id)a0;
...
- (void)removeCloudSourcesWithAttributes:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)removeOrphanedTracksOnlyInCaches:(char)a0;
- (void)removePlaylistsWithPersistentIDs:(id)a0 fromSource:(int)a1 usingConnection:(id)a2 withCompletionHandler:(id /* block */)a3;
- (char)removeSource:(int)a0 forImportOperation:(id)a1 usingConnection:(id)a2 postNotifications:(char)a3;
- (char)removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 canonocalizeCollections:(char)a3 usingConnection:(id)a4 postNotifications:(char)a5;
- (char)removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 usingConnection:(id)a3 postNotifications:(char)a4;
...
- (char)repairAlbumArtistRelationshipsWithConnection:(id)a0;
- (char)requiresNonSchemaUpdatesOnConnection:(id)a0;
- (char)requiresSchemaOnlyUpdatesOnConnection:(id)a0;
...
- (void)retrieveBestArtworkTokensForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 retrievalTime:(double)a4 completionHandler:(id /* block */)a5;
- (void)sanitizeDatabaseContentsUsingConnection:(id)a0 removeOrphanedAssets:(char *)a1;
- (char)sanitizeSortMapContentsUsingConnection:(id)a0 didSortMapEntries:(char *)a1;
- (void)savePlaylists;
...
- (id)securityScopedFileURLForItemPID:(unsigned long long)a0;
...
- (void)updateBestArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 retrievalTime:(double)a3 preserveExistingAvailableToken:(char)a4 usingConnection:(id)a5;
...
- (void)updateBestArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 retrievalTime:(double)a4 preserveExistingAvailableToken:(char)a5 usingConnection:(id)a6;
- (void)updateJaliscoExcludedMediaKindsWith:(id)a0 excludingMediaKindsInSet:(char)a1;
...
- (void)updatePurgeabilityForCachedArtworkWithAbsolutePath:(id)a0;
- (void)updatePurgeabilityForOriginalArtworkWithRelativePath:(id)a0;
- (void)updateRootArtworkPurgeability;
- (char)updateSortMap;
- (char)updateSortMapOnConnection:(id)a0;
- (char)updateSortMapOnConnection:(id)a0 forceUpdateOriginals:(char)a1;
- (char)updateSystemPlaylistNamesForCurrentLanguageUsingConnection:(id)a0;
...
- (char)validateItemTablesEntriesUsingConnection:(id)a0;
- (char)validateSortMapUnicodeVersionOnConnection:(id)a0;
