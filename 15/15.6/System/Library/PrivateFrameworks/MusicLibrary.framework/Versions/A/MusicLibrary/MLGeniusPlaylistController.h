...
- (id)init;
- (void).cxx_destruct;
- (char)_canIncludeTrackInGeniusContainer:(id)a0;
- (char)_createClusterPlaylistWithSeedTracks:(id)a0 error:(id *)a1;
- (id)_debugGetTracksStartingAtTrackWithPersistentID:(unsigned long long)a0 maxTracks:(unsigned long long)a1 stride:(int)a2;
- (char)_onBackgroundQueue_fakePopulateContainer:(id)a0 withSeedTrack:(id)a1 error:(id *)a2;
- (char)_onBackgroundQueue_populateContainer:(id)a0 seedTrack:(id)a1 error:(id *)a2;
