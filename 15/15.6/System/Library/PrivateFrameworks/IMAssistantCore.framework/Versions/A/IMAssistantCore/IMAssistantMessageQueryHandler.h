...
- (void)SPIQueryMessagesForChats:(id)a0 onlyUnread:(char)a1 limit:(long long)a2 completion:(id /* block */)a3;
- (void)SPIQueryMessagesForSenders:(id)a0 onlyUnread:(char)a1 limit:(long long)a2 completion:(id /* block */)a3;
- (void)SPIQueryMessagesWithRowIDs:(id)a0 completion:(id /* block */)a1;
- (void)SPIQueryMessagesForChatsWithIdentifiers:(id)a0 services:(id)a1 onlyUnread:(char)a2 limit:(long long)a3 completion:(id /* block */)a4;
...
- (char)messageIsFromBlackholedChat:(id)a0;
...
- (char)resolvePersons:(id)a0 forIntent:(id)a1 completionHandler:(id /* block */)a2;
