...
@property (nonatomic) char didRegisterForContactStoreChangeNotifications;
...
@property (readonly, nonatomic) char isInternationalSpamFilteringEnabled;
...
- (char)screentimeAllowedToShowChat:(id)a0 error:(id *)a1;
- (char)screentimeAllowedToShowConversationWithHandleIDs:(id)a0 error:(id *)a1;
