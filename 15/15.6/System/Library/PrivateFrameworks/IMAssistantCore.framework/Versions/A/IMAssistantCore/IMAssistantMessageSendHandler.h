...
- (char)canSendLocationMessageWithLocationManager:(id)a0 withError:(long long *)a1;
...
- (char)recipientHandleResolutionResultsAllowedByScreentime:(id)a0 error:(id *)a1;
...
- (char)sendMessageWithDraft:(id)a0 expressiveSendStyleID:(id)a1 idsIdentifier:(id)a2 executionContext:(long long)a3 sourceApplicationID:(id)a4 toChat:(id)a5;
- (void)sendMessagesWithText:(id)a0 currentLocation:(char)a1 sharedLinkURL:(id)a2 audioMessageAttachment:(id)a3 photoLibraryAttachment:(id)a4 fileAttachments:(id)a5 expressiveSendStyleID:(id)a6 idsIdentifier:(id)a7 executionContext:(long long)a8 shouldHideSiriAttribution:(char)a9 toChat:(id)a10 completion:(id /* block */)a11;
...
- (char)shouldContinueToExamineRelevantChatsWithMatches:(id)a0 nextChat:(id)a1;
- (char)updateSenderIdentityForNewlyCreatedChat:(id)a0;
