...
+ (id)sharedInstance;
+ (char)_isCheckInSupportedPlatform;
+ (char)_isCurrentLocationSupportedPlatform;

- (void).cxx_destruct;
- (char)_handleOperationalTrigger:(id)a0 localeIdentifier:(id)a1 bundleIdentifier:(id)a2 recipientNames:(id)a3 availableApps:(id)a4 limit:(unsigned long long)a5 explanationSet:(id)a6 results:(id)a7;
