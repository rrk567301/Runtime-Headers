...
+ (id)sharedInstance;
+ (char)_allowSingleCharacterContactsAutocompleteTriggerForLanguage:(id)a0;
...
+ (char)_shouldGenerateWordBoundaryPredictionsForContext:(id)a0 localeIdentifier:(id)a1;
+ (char)_zkwItemsContainsOnlyTextualResponses:(id)a0;
...
- (id)_maybeModifyTrigger:(id)a0 bundleIdentifier:(id)a1;
- (id)_responseKitPredictionsForContext:(id)a0 bundleIdentifier:(id)a1 conversationTurns:(id)a2 languageID:(id)a3 adaptationContextID:(id)a4 shouldDisableAutoCaps:(char)a5 maximumResponses:(unsigned long long)a6 isBlacklisted:(char)a7;
- (id)_rewriteMoneyAttributes:(id)a0;
- (id)_rkResponsesForContext:(id)a0 conversationTurns:(id)a1 languageID:(id)a2 maximumResponses:(unsigned long long)a3 shouldDisableAutoCaps:(char)a4 adaptationContextID:(id)a5;
