...
@property (nonatomic) char isBackgroundDecoration;
...
- (id)initWithElementKind:(id)a0 size:(id)a1 contentInsets:(struct CVCDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a2 containerAnchor:(id)a3 itemAnchor:(id)a4 zIndex:(long long)a5 registrationViewClass:(Class)a6 isBackgroundDecoration:(char)a7;
