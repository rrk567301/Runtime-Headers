...
- (id)snapshot;
- (char)_decrementSectionCount:(long long)a0 byCount:(long long)a1;
- (char)_deleteSection:(long long)a0;
- (char)_incrementSectionCount:(long long)a0 byCount:(long long)a1;
- (char)_decrementSectionCount:(long long)a0;
- (char)_deleteAllSections;
- (char)_incrementSectionCount:(long long)a0;
- (char)_insertSection:(long long)a0 withInitialCount:(long long)a1;
...
- (char)indexPathIsSectionAppendingInsert:(id)a0;
