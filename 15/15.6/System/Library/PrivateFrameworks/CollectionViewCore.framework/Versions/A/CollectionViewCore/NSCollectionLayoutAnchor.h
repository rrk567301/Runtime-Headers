...
@property (nonatomic) char offsetIsUnitOffset;
@property (readonly, nonatomic) char isAbsoluteOffset;
@property (readonly, nonatomic) char isFractionalOffset;
...
- (id)initWithEdges:(unsigned long long)a0 offset:(struct CGPoint { double x0; double x1; })a1 anchorPoint:(struct CGPoint { double x0; double x1; })a2 offsetIsUnitOffset:(char)a3;
