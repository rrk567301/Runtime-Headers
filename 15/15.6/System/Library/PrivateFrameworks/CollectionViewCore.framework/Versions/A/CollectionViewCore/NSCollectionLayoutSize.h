...
- (struct CGSize { double x0; double x1; })_effectiveSizeForContainer:(id)a0 displayScale:(double)a1 ignoringInsets:(char)a2;
- (char)_isEstimatedForAxis:(unsigned long long)a0;
- (char)isEstimated;
