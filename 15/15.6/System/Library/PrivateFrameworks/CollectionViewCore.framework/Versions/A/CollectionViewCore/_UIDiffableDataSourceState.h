...
- (char)containsItemIdentifier:(id)a0;
- (char)containsSectionIdentifier:(id)a0;
- (void)ensureOrderedSetsHaveGuaranteedPerformance;
- (id)initWithGenerationID:(id)a0 identifiers:(id)a1 sections:(id)a2 dataSourceSnapshot:(id)a3 identifiersHaveGuaranteedPerformance:(char)a4 sectionsHaveGuaranteedPerformance:(char)a5;
