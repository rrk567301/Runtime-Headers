...
+ (id)CRLFData;
+ (id)LFData;
+ (char)getHost:(id *)a0 port:(unsigned short *)a1 fromAddress:(id)a2;
...
- (char)acceptOnIPv4Socket:(int)a0 IPv6Socket:(int)a1 unixSocket:(int)a2 error:(id *)a3;
- (char)acceptOnInterface:(id)a0 port:(unsigned short)a1 error:(id *)a2;
- (void)readDataToData:(id)a0 withTimeout:(double)a1 tag:(long long)a2;
- (void)setIPv4Enabled:(char)a0;
- (char)autoDisconnectOnClosedReadStream;
- (void)lookup:(int)a0 didFail:(id)a1;
- (char)acceptOnIPv4Socket:(int)a0 IPv6Socket:(int)a1 unixSocket:(int)a2 interface:(id)a3 port:(unsigned short)a4 error:(id *)a5;
- (char)acceptOnPort:(unsigned short)a0 error:(id *)a1;
- (void)setDelegateQueue:(id)a0 synchronously:(char)a1;
- (void)setIPv6Enabled:(char)a0;
- (void)asyncQueuePacket:(id)a0;
- (id)badParamError:(id)a0;
- (void)completeCurrentRead;
- (void)completeCurrentWrite;
- (id)connectTimeoutError;
- (char)connectToAddress:(id)a0 error:(id *)a1;
- (char)connectToAddress:(id)a0 viaInterface:(id)a1 withTimeout:(double)a2 error:(id *)a3;
- (char)connectToAddress:(id)a0 withTimeout:(double)a1 error:(id *)a2;
- (char)connectToHost:(id)a0 onPort:(unsigned short)a1 error:(id *)a2;
- (char)connectToHost:(id)a0 onPort:(unsigned short)a1 viaInterface:(id)a2 withTimeout:(double)a3 error:(id *)a4;
- (char)connectToHost:(id)a0 onPort:(unsigned short)a1 withTimeout:(double)a2 error:(id *)a3;
- (char)connectWithAddress4:(id)a0 address6:(id)a1 error:(id *)a2;
- (id)connectedAddress;
- (id)connectedHost;
- (id)connectedHost4;
- (id)connectedHost6;
...
- (void)maybeStartTLS;
- (id)otherError:(id)a0;
- (char)preConnectWithInterface:(id)a0 error:(id *)a1;
...
- (void)setAutoDisconnectOnClosedReadStream:(char)a0;
- (void)setDelegate:(id)a0 delegateQueue:(id)a1;
- (void)setDelegate:(id)a0 delegateQueue:(id)a1 synchronously:(char)a2;
- (void)setDelegate:(id)a0 synchronously:(char)a1;
- (void)setPreferIPv4OverIPv6:(char)a0;
...
- (void)writeData:(id)a0 withTimeout:(double)a1 tag:(long long)a2 countBytesWritten:(char)a3;
- (void)writeSendfile:(id)a0 atOffset:(long long)a1 andLength:(long long)a2 withTimeout:(double)a3 tag:(long long)a4;
- (void)writeSendfile:(id)a0 atOffset:(long long)a1 andLength:(long long)a2 withTimeout:(double)a3 tag:(long long)a4 countBytesWritten:(char)a5;
