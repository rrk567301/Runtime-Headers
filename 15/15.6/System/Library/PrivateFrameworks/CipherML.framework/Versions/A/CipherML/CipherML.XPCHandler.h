...
- (void)constructPIRRequestWithKeyword:(NSData *)a0 withEvaluationKey:(char)a1 shardId:(NSString *)a2 pirConfig:(CMLPIRConfig *)a3 clientConfig:(CMLClientConfig *)a4 reply:(void (^)(NSData *, NSError *))a5;
