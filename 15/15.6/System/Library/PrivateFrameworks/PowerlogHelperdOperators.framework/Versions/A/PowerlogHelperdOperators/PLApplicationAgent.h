...
+ (char)getVisibilityFromProcessState:(id)a0;
...
- (char)appInformationChanged:(id)a0;
...
- (void)logEventForwardApplicationForDisplayID:(id)a0 withPid:(int)a1 withState:(unsigned int)a2 withVisibility:(char)a3 withReasons:(id)a4;
