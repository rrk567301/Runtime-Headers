@class PLStateTrackingComposition, NSString, NSDictionary, PLEntryNotificationOperatorComposition, NSDate, PLNSNotificationOperatorComposition;
...
- (void)getCoalitionInfoWithHFLFlag:(char)a0;
...
- (void)logCoalitionObjectMemory:(id)a0 shouldLogBatteryTableCadence:(char)a1;
- (void)logEventIntervalCoalitionIntervalWithHFLFlag:(char)a0;
...
- (void)logToCAProcessMemory:(id)a0 andAccumulatedMemory:(id)a1 dailyReport:(char)a2 systemUptime:(unsigned long long)a3;
- (id)processMemoryUsageWithPid:(int)a0 withLaunchdName:(id)a1 withRusage:(void *)a2 withJetsamInfo:(void *)a3 withLimitInfo:(struct process_memory_limit_info { int x0; char x1; char x2; char x3; } *)a4;
- (unsigned long long)readPropertyFromRegistry:(struct __CFString { } *)a0;
- (char)shouldLogCoalitionObject:(id)a0 withEndObject:(id)a1;
