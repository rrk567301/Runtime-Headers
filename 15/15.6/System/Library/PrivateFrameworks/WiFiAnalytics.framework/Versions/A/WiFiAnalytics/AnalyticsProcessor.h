...
- (void)processWAMessageMetric:(id)a0 data:(id)a1 andSave:(char)a2;
- (void)releaseBackgroundProcessingMOC;
- (char)saveAndResetManagedObjectContext;
...
- (char)unpackRssiSnrCCAFromRssiMetricField:(id)a0 unpackedRssi:(id *)a1 unpackedCca:(id *)a2 unpackedSnr:(id *)a3;
