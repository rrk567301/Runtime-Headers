...
+ (id)convertChannelList:(id)a0 log:(char)a1 For:(const char *)a2;
...
+ (id)neighborChannelsAsArray:(id)a0 log:(char)a1 For:(const char *)a2;
+ (id)rangeStringWithRssiLevel:(unsigned long long)a0;

- (void).cxx_destruct;
- (void)deriveBadRoams:(id)a0;
- (char)buildRoamCacheInfoForNetwork:(id)a0 bssid:(id)a1 numRoamSamples:(unsigned long long)a2;
- (char)buildRoamPoliciesForNetwork:(id)a0 bssid:(id)a1 numRoamSamples:(unsigned long long)a2 deploymentStatus:(char)a3;
- (void)checkForFrequentRoams:(unsigned long long)a0 date:(id)a1 motionState:(long long)a2;
- (char)checkForNewBSSAddition:(id)a0 bssid:(id)a1;
...
- (char)doWeHaveEnoughSamplesToBuildChanList:(unsigned long long)a0 numRoamSamples:(unsigned long long)a1;
- (char)doWeHaveEnoughSamplesToBuildRoamCache:(unsigned long long)a0 numRoamSamples:(unsigned long long)a1;
- (char)doWeHaveEnoughSamplesToDeriveRSSITrigger:(unsigned long long)a0 numRoamSamples:(unsigned long long)a1;
- (void)findDeploymentType:(unsigned long long)a0;
- (char)inRange:(long long)a0 high:(long long)a1 value:(long long)a2;
- (id)initWithAnalyticsStore:(id)a0;
- (char)isHomeEnvironment:(id)a0;
- (char)isNetworkQualifiedForAdaptiveRoaming:(id)a0;
- (char)isWorkEnvironment:(id)a0;
...
- (char)monitorDeploymentChanges:(id)a0 ssid:(id)a1 roamStatus:(unsigned long long)a2 originBssid:(id)a3 targetBssid:(id)a4;
