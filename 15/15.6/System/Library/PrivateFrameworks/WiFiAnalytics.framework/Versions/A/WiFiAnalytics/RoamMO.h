...
@property (nonatomic) char isLateRoam;
@property (nonatomic) char isPingPong;
...
@property (nonatomic) char targetDhcpFailed;
...
@property (nonatomic) char userInteractive;
...
+ (id)entityName;
+ (id)fetchRequest;
+ (unsigned long long)dwellTimeInBand:(id)a0 bandIs24:(char)a1 bssid:(id)a2 maxAgeInDays:(unsigned long long)a3 moc:(id)a4;
...
+ (id)fetchRoamProperties:(id)a0 lookForRoamStatus:(char)a1 fetchLimit:(unsigned long long)a2 properties:(id)a3 moc:(id)a4;
