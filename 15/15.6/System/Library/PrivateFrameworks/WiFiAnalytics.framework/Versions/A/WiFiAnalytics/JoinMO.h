...
@property (nonatomic) char dhcpSuccess;
@property (nonatomic) int ipv4Addr;
@property (nonatomic) int ipv4routerAddr;
@property (nonatomic) char isAutojoin;
...
+ (unsigned long long)joinCount:(id)a0 bssid:(id)a1 maxAgeInDays:(unsigned long long)a2 success:(char)a3 moc:(id)a4;
