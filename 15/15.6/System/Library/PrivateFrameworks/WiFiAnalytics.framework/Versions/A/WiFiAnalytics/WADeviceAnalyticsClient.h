...
- (char)dumpDeploymentGraphJSONFileWithCompletion:(id /* block */)a0;
- (id)dumpDeviceAnalyticsCSVsToFileWithBatchSize:(unsigned long long)a0 maxAge:(unsigned long long)a1;
- (char)dumpDeviceAnalyticsCSVsUsingBatchSizeToFileWithCompletion:(id /* block */)a0 batchSize:(unsigned long long)a1 maxAge:(unsigned long long)a2;
- (id)dumpDeviceAnalyticsToFile;
- (char)dumpDeviceAnalyticsToFileWithCompletion:(id /* block */)a0;
- (char)dumpDeviceAnalyticsToFileWithCompletion:(id /* block */)a0 fetchLimit:(unsigned long long)a1 maxAge:(unsigned long long)a2;
...
- (char)dumpDeviceAnalyticsUsingBatchSizeToFileWithCompletion:(id /* block */)a0 batchSize:(unsigned long long)a1 maxAge:(unsigned long long)a2;
...
- (void)processWAMessageMetric:(id)a0 data:(id)a1 andDeferSaveToDisk:(char)a2;
- (char)rawAccessCanWrite;
...
- (char)saveAndResetBackgroundProcessingMOC;
