...
@property (nonatomic) char isRepeatable;
...
- (id)_ownTypeAsString;
- (void)_throwIncorrecTypeExceptionForType:(long long)a0 isGet:(char)a1;
- (void)_throwIncorrectRepeatableStateExceptionAsFieldShouldBeRepeatable:(char)a0 isGet:(char)a1 forType:(long long)a2;
- (id)_typeAsString:(long long)a0;
- (void)addRepeatableBoolValue:(char)a0;
...
- (id)bytesValue;
- (id)initWithType:(long long)a0 isRepeatable:(char)a1 andKey:(id)a2 andTypeInfoForRepeatableSubmessage:(id)a3;
- (id)initWithType:(long long)a0 isRepeatable:(char)a1 key:(id)a2 repeatableValues:(id)a3 doubleValue:(double)a4 floatValue:(float)a5 int32Value:(int)a6 int64Value:(long long)a7 uint32Val:(unsigned int)a8 uint64Value:(unsigned long long)a9 boolValue:(char)a10 stringValue:(id)a11 bytesValue:(id)a12 subMessageValue:(id)a13 andTypeInfoForRepeatableSubmessage:(id)a14;
- (char)isNumerical;
- (id)repeatableValues;
