...
@property (readonly, nonatomic) char hasRole;
...
@property (nonatomic) char hasPeerCount;
@property (nonatomic) unsigned int peerCount;
@property (nonatomic) char hasPeersAdded;
@property (nonatomic) unsigned int peersAdded;
@property (nonatomic) char hasPeersRemoved;
