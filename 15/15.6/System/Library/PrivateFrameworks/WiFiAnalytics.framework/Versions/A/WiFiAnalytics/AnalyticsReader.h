...
- (char)isHistoricallyBadLinkQualityNetwork:(id)a0;
- (char)isMovingNetwork:(id)a0;
- (char)isNetworkWithinRangeOfLocation:(id)a0 range:(double)a1 location:(id)a2 count:(unsigned long long *)a3;
- (char)isOmnipresentNetwork:(id)a0;
...
- (char)parsedBeaconInfoIsStored:(id)a0 ssid:(id)a1;
