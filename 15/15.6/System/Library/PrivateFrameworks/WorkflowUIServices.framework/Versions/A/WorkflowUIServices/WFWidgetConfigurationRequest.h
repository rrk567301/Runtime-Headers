...
@property (readonly, nonatomic, getter=isWidgetExtensionInformationLoaded) char widgetExtensionInformationLoaded;
@property (readonly, nonatomic) NSColor *widgetPrimaryColor;
@property (readonly, nonatomic) NSColor *widgetTintColor;
@property (readonly, nonatomic) char usesWidgetAccentColor;
