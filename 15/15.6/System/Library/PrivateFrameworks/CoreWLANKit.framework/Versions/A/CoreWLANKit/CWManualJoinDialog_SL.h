...
@property char autoJoinPrompt;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (id)autoJoinPromptWithScanResults:(id)a0 remember:(char)a1;
+ (id)manualJoinDialogWithScanResults:(id)a0 remember:(char)a1;
...
- (id)initWithScanResults:(id)a0 remember:(char)a1;
