...
@property char supportsWPA3Personal;
...
- (void)removePreferredNetworksWithIndexSet:(id)a0 selectionIndexSet:(id)a1 requireUserConfirmation:(char)a2 modifierFlags:(unsigned long long)a3;
- (char)requiresAdminNetworkChange;
- (char)requiresAdminPowerToggle;
- (void)setAirPortID:(id)a0;
- (void)setAllowLegacyNetworks:(char)a0;
- (void)setAlwaysRemember:(char)a0;
- (void)setHasUnsavedChanges:(char)a0;
- (void)setRequiresAdminNetworkChange:(char)a0;
- (void)setRequiresAdminPowerToggle:(char)a0;
