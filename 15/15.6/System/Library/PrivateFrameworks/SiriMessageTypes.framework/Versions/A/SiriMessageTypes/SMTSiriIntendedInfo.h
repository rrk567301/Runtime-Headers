...
@property (readonly, nonatomic) char isGazeSignalPresent;
...
- (id)initWithOdldScore:(float)a0 aftmScore:(float)a1 spkrIdScore:(float)a2 lrnnScore:(float)a3 checkerScore:(float)a4 invocationType:(id)a5 lrnnThreshold:(float)a6 lrnnScale:(float)a7 lrnnOffset:(float)a8 gazeSignal:(char)a9;
