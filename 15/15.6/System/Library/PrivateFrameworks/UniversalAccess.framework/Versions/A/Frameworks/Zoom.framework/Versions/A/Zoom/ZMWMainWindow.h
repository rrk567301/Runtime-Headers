...
@property (readonly, nonatomic) char isInPreviewMode;
...
- (void)setZoomFactor:(double)a0 isSystemZoom:(char)a1;
...
- (void)showPreview:(char)a0 previewRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 animationDuration:(double)a2;
- (void)updateUserSettings;
- (struct CGPoint { double x0; double x1; })zoomCenterWindowPoint;
- (struct CGPoint { double x0; double x1; })zoomScreenFocusPoint;
- (char)zoomViewContainsPoint:(struct CGPoint { double x0; double x1; })a0;
