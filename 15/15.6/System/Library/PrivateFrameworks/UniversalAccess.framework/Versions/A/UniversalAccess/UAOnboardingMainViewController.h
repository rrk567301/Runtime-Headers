...
@property (nonatomic) char _isFirstTimeSeeingWelcomePane;
...
- (struct UAOnboardingAccessibilitySettings { char x0; char x1; char x2; char x3; char x4; })getCurrentSettings;
