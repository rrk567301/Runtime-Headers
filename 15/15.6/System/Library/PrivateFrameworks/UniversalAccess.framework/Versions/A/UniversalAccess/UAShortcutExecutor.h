...
- (id)init;
- (void).cxx_destruct;
- (void)workflowRunnerClient:(id)a0 didFinishRunningWorkflowWithError:(id)a1 cancelled:(char)a2;
...
- (void)_complete:(id)a0 success:(char)a1 cancelled:(char)a2 output:(id)a3 error:(id)a4;
