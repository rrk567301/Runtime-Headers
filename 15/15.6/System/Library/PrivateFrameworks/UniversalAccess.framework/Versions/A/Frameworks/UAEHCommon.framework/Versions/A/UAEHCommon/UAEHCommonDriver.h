...
@property (nonatomic) char _didRegisterForNotifications;
@property (nonatomic) char _notificationsPaused;
...
- (void)_showTransientHUDForCurrentStateOfFeature:(id)a0 enabled:(char)a1;
