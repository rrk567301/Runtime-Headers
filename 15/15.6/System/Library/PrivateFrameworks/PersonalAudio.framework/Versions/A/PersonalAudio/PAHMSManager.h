...
- (char)beamformingForAddress:(id)a0;
- (char)hearingAidEnabledForAddress:(id)a0;
- (double)noiseSupressorForAddress:(id)a0;
- (char)regionSupportedForHearingProtection:(id)a0;
...
- (void)setBeamforming:(char)a0 forAddress:(id)a1;
...
- (char)yodelEnabledForAddress:(id)a0;
