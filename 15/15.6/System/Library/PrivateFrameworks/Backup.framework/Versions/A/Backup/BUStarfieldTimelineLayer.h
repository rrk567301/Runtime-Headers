...
- (char)mouseDown:(id)a0 atLocation:(struct CGPoint { double x0; double x1; })a1;
- (char)mouseDragged:(id)a0 toLocation:(struct CGPoint { double x0; double x1; })a1;
- (void)mouseMoved:(id)a0 toLocation:(struct CGPoint { double x0; double x1; })a1;
- (char)mouseUp:(id)a0 atLocation:(struct CGPoint { double x0; double x1; })a1;
