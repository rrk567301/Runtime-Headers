...
+ (void)initialize;
+ (id)averageIntegerValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)getValue:(id)a0 ForField:(id)a1 ScaledByDuration:(char)a2;
+ (id)maximumIntegerValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)medianIntegerValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)minimumIntegerValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)modeValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)modesValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (id)sumIntegerValueForField:(id)a0 ScaledByDuration:(char)a1 OnSamples:(id)a2;
+ (void)updateConfig;
...
- (char)checkCriteriaBSSIDWithSample:(id)a0;
- (void)cleanUpStashedMedians;
- (void)clearOngoingCriteriaDates;
- (char)configureDataTriggeredCriteria;
- (char)endOngoingCriteria;
- (id)evaluateCriteriaWithStopUponFirstMatch:(char)a0;
