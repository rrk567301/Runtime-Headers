...
@property (readonly, nonatomic, getter=isMoving) char moving;
@property (readonly, nonatomic, getter=isSuspicious) char suspicious;
@property (readonly, nonatomic, getter=isPublic) char public;
@property (readonly, nonatomic, getter=isLowQuality) char lowQuality;
...
@property (nonatomic) char public;
@property (nonatomic) int qualityScoreValue;
@property (nonatomic) char suspicious;
