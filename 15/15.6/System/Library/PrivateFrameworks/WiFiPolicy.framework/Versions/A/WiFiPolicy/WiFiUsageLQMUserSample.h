...
@property (nonatomic) char isAnyAppInFG;
@property (nonatomic) char isFTactive;
@property (nonatomic) char isTimeSensitiveAppRunning;
...
@property (nonatomic) char isHighCCAFor2GHz;
...
@property (nonatomic) char isBSPActive;
@property (nonatomic) unsigned long long bspTimeToTST;
@property (nonatomic) char isScanActiveBSP;
@property (nonatomic) char isP2PActiveBSP;
...
- (char)isBspSampleDurationExpected:(unsigned long long)a0;
- (void)populateWithBspOverflowed:(char)a0 IsBSPActive:(char)a1 BspTimeToTST:(unsigned long long)a2 BspSampleDurationMS:(unsigned long long)a3 IsScanActiveBSP:(char)a4 IsP2PActiveBSP:(char)a5 BspTriggerCount:(unsigned long long)a6 BspMutePercentage:(unsigned long long)a7 BspMaxMuteMS:(unsigned long long)a8 BspAvgMuteMS:(unsigned long long)a9 BspErrorPercentage:(unsigned long long)a10 BspTimeOutPercentageOfTriggers:(unsigned long long)a11 BspRejectOrFailPercentageOfTriggers:(unsigned long long)a12 BspMaxConsecutiveFails:(unsigned long long)a13;
