...
@property (nonatomic) char cacheable;
...
+ (id)fetchRequestWithDescriptor:(id)a0 sourcePolicy:(unsigned long long)a1 cacheable:(char)a2;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (void)handleResponse:(id)a0;
- (char)doesLocalResultsSatisfyRequest:(id)a0;
- (void)handlePreferLocalResponse:(id)a0;
- (id)initWithDescriptor:(id)a0 sourcePolicy:(unsigned long long)a1 cacheable:(char)a2;
