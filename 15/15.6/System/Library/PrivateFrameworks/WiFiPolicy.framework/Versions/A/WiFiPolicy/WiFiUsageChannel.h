...
@property (nonatomic) char isDFSChannel;
...
- (id)initWithChannel:(unsigned long long)a0 flags:(unsigned long long)a1 band:(int)a2 width:(unsigned long long)a3 isDFS:(char)a4;
- (id)initWithChannel:(unsigned long long)a0 flags:(unsigned long long)a1 isDFS:(char)a2;
