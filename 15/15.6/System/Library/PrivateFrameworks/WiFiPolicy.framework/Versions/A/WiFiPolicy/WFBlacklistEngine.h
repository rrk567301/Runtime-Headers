...
- (char)_evaluateTriggersForBlacklisting:(id)a0 reason:(unsigned long long)a1 reasonData:(long long)a2 bssid:(id)a3 ssid:(id)a4 state:(unsigned long long)a5;
- (char)_evaluateTriggersForUnblacklisting:(id)a0 unblacklistReason:(unsigned long long)a1 ssid:(id)a2;
- (id)_findBlacklistNode:(id)a0;
- (char)_ignoreTriggersForDeviceProfile:(unsigned long long)a0 node:(id)a1;
- (char)_meetsThresholds:(unsigned long long)a0 count:(unsigned int)a1 perSsid:(char)a2 bssid:(id)a3 ssid:(id)a4;
- (void)_setBlacklistedState:(id)a0 state:(unsigned long long)a1 reason:(unsigned long long)a2 reasonData:(long long)a3;
- (char)changeBlacklistingThresholds:(unsigned long long)a0 value:(unsigned int)a1 perSsid:(char)a2;
...
- (id)denyListThreshold:(unsigned long long)a0 perSSID:(char)a1;
- (id)getBlacklist;
...
- (char)isNetworkBlacklistedForAutoJoinDueToTrigDisc:(id)a0 rssi:(long long *)a1 timestamp:(double *)a2;
- (char)isNetworkInBlacklistedState:(id)a0 state:(unsigned long long)a1;
- (void)networkPruned:(id)a0;
- (void)networkRemovedForSsid:(id)a0;
- (char)removeBlacklistedStateForNetworkWithReason:(id)a0 state:(unsigned long long)a1 reason:(unsigned long long)a2;
