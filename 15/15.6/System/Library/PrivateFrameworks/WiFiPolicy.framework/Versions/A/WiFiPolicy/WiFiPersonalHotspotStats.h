...
@property (readonly, nonatomic) char successfulJoinAttempt;
...
- (void)setJoinEndedEvent:(double)a0 successfulJoinAttempt:(char)a1 joinFailureCode:(long long)a2 failureReporter:(id)a3 band:(long long)a4 deviceName:(id)a5;
