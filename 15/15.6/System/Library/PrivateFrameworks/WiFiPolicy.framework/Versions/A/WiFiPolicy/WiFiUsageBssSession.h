...
@property (nonatomic) char supportsNeighborReport;
@property (nonatomic) char supportsFastTransition;
@property (nonatomic) char supportsBssTransitionManagement;
@property (nonatomic) char supportsAdaptiveFastTransition;
@property (nonatomic) char supportsFastlane;
@property (nonatomic) char supportsNetworkAssurance;
@property (nonatomic) char supportsAdaptiveRoaming;
...
@property (nonatomic) char roamInMotion;
...
@property (nonatomic) struct { long long valueByBand[3]; char valid[3]; } roamNeighsSmllstCurrentToBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[3]; char valid[3]; } roamNeighsLrgstCurrentToBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[3]; char valid[3]; } roamNeighsSmllstCurrentToNextBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[3]; char valid[3]; } roamNeighsLrgstCurrentToNextBestRssiByBand;
...
- (char)submitAnalytics;
- (void)updateRssi:(long long)a0 timeSinceLastUpdate:(double)a1;
- (void)awdlStateDidChange:(char)a0 inMode:(long long)a1;
- (void)bluetoothStateDidChange:(char)a0 connectedDeviceCount:(unsigned long long)a1 inA2dp:(char)a2 inSco:(char)a3;
...
- (void)motionStateDidChange:(char)a0 andVehicularState:(char)a1;
...
- (void)roamingStateDidChange:(char)a0 reason:(unsigned long long)a1 andStatus:(unsigned long long)a2 andLatency:(unsigned long long)a3 andRoamData:(id)a4 andPingPongNth:(char)a5;
