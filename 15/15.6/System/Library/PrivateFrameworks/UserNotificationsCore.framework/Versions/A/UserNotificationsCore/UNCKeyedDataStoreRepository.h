...
- (id)_addObject:(id)a0 mustReplace:(char)a1 atPath:(id)a2;
- (id)_addObject:(id)a0 toObjects:(id)a1 mustReplace:(char)a2 receipt:(id *)a3;
- (id)_dataAtPath:(id)a0;
- (char)_isReplacementSupported;
...
- (char)_saveObjects:(id)a0 atPath:(id)a1;
- (void)_setObjects:(id)a0 atPath:(id)a1;
- (char)_useReplacementToImport:(id)a0 into:(id)a1;
- (id)addObject:(id)a0 mustReplace:(char)a1 forKey:(id)a2;
