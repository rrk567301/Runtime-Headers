...
- (void)save:(id)a0 shouldRepost:(char)a1 apsMessageTimestamp:(id)a2 forBundleIdentifier:(id)a3;
- (void)save:(id)a0 targetRevisionNumber:(id)a1 shouldRepost:(char)a2 forBundleIdentifier:(id)a3 completionHandler:(id /* block */)a4;
