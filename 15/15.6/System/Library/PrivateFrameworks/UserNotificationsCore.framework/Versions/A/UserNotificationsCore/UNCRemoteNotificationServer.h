...
- (char)_queue_isApplicationForeground:(id)a0;
- (void)_queue_applicationDidTerminate:(id)a0;
- (char)_canMoveTopic:(id)a0 fromList:(unsigned long long)a1 toList:(unsigned long long)a2 connection:(id)a3;
- (void)_extensionQueue_modifyNotificationRequest:(id)a0 bundleIdentifier:(id)a1 message:(id)a2 extension:(id)a3 enforcePushType:(char)a4;
...
- (char)_queue_allowServiceExtensionFilteringForMessage:(id)a0;
...
- (char)_queue_canDeliverMessageToBundle:(id)a0;
...
- (void)_queue_deliverNotificationRequest:(id)a0 bundleIdentifier:(id)a1 message:(id)a2 enforcePushType:(char)a3;
- (void)_queue_deliverNotificationRequest:(id)a0 bundleIdentifier:(id)a1 message:(id)a2 enforcePushType:(char)a3 extensionStart:(id)a4 extensionEnd:(id)a5;
- (void)_queue_didChangeNotificationSettings:(id)a0 forBundleIdentifier:(id)a1;
- (void)_queue_didChangeProcessState:(id)a0 forBundleIdentifier:(id)a1;
- (void)_queue_didCompleteInitialization;
- (void)_queue_didReceiveIncomingMessage:(id)a0;
- (char)_queue_enforcePushTypeForMessage:(id)a0;
- (void)_queue_invalidateTokenForBundleIdentifier:(id)a0;
- (char)_queue_isApplicationRunning:(id)a0;
- (char)_queue_isBackgroundAppRefreshAllowedForBundleIdentifier:(id)a0;
- (char)_queue_isPushEnabledForApplication:(id)a0;
- (char)_queue_isUserNotificationEnabledForApplication:(id)a0;
- (char)_queue_isVisibleUserNotificationEnabledForApplication:(id)a0;
- (char)_queue_messageIsValidForDelivery:(id)a0;
...
- (char)_queue_shouldBoostTopicToEnabled:(id)a0;
- (void)_queue_tryToModifyNotificationRequest:(id)a0 bundleIdentifier:(id)a1 message:(id)a2 enforcePushType:(char)a3;
- (char)_requestContainsDisallowedPrivateUserInfo:(id)a0;
...
- (char)allowsRemoteNotificationsForBundleIdentifier:(id)a0;
...
- (void)didChangeProcessState:(id)a0 forBundleIdentifier:(id)a1;
