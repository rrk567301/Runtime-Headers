...
- (void)contentProtectionStateChangedForFirstUnlock:(char)a0;
...
- (void)saveNotificationRecord:(id)a0 shouldRepost:(char)a1 forBundleIdentifier:(id)a2 withCompletionHandler:(id /* block */)a3;
- (void)saveNotificationRecord:(id)a0 targetRevisionNumber:(id)a1 shouldRepost:(char)a2 forBundleIdentifier:(id)a3 withCompletionHandler:(id /* block */)a4;
- (void)saveNotificationRequest:(id)a0 shouldRepost:(char)a1 apsMessageTimestamp:(id)a2 forBundleIdentifier:(id)a3;
- (void)saveNotificationRequest:(id)a0 shouldRepost:(char)a1 withMessage:(id)a2 forBundleIdentifier:(id)a3;
