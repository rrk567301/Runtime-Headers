...
- (id)_queue_sectionInfoForSectionID:(id)a0 effective:(char)a1;
- (void)_queue_sortSectionIDs:(id)a0 usingGuideArray:(id)a1;
- (id)_queue_sortedSectionInfoForSectionIDs:(id)a0 effective:(char)a1;
- (id)activeSectionIDs;
- (void)addActiveSectionID:(id)a0;
- (id)allSortedActiveSections:(char)a0;
- (id)allSortedSectionInfo:(char)a0;
...
- (id)sectionInfoForSectionID:(id)a0 effective:(char)a1;
- (id)sectionInfosByIDForSectionIDs:(id)a0 effective:(char)a1;
...
- (id)sortedSectionIDs;
- (id)sortedSectionInfoForSectionIDs:(id)a0 effective:(char)a1;
