...
@property (readonly, nonatomic, getter=isGroupSummary) char groupSummary;
...
- (id)initWithBundleIdentifier:(id)a0 requestIdentifiers:(id)a1 spotlightIdentifier:(id)a2 groupSummary:(char)a3 content:(id)a4 threadIdentifier:(id)a5;
