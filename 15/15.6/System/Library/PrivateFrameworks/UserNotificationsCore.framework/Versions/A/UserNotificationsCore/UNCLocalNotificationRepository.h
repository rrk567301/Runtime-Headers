...
- (void)_queue_notifyObserversNotificationsDidAddNotifications:(id)a0 replaceNotifications:(id)a1 replacementNotifications:(id)a2 removedNotifications:(id)a3 shouldRepost:(char)a4 shouldSync:(char)a5 forBundleIdentifier:(id)a6;
...
- (char)_queue_saveNotificationRecord:(id)a0 targetRevisionNumber:(id)a1 shouldRepost:(char)a2 withOptions:(unsigned long long)a3 forBundleIdentifier:(id)a4;
...
- (char)_shouldPersistNotificationRecord:(id)a0 forBundleSettings:(id)a1 perTopicSettings:(id)a2;
