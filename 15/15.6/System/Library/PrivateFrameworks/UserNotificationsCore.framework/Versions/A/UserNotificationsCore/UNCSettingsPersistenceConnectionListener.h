...
- (void)allSortedActiveSections:(char)a0 withHandler:(id /* block */)a1;
- (void)allSortedSectionInfos:(char)a0 withHandler:(id /* block */)a1;
...
- (void)sectionInfoForSectionID:(id)a0 effective:(char)a1 withHandler:(id /* block */)a2;
- (void)sectionInfosForSectionIDs:(id)a0 effective:(char)a1 withHandler:(id /* block */)a2;
