...
@property (nonatomic, getter=isPrecomposed) char precomposed;
...
- (id)initWithFormat:(long long)a0 imageInfo:(id)a1 imageInfoType:(long long)a2 bundlePath:(id)a3 precomposed:(char)a4;
