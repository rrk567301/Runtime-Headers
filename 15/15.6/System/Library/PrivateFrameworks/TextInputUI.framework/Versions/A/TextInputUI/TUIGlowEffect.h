...
+ (char)adjustVisibilityForDarkMode:(char)a0 tintColor:(struct CGColor { } *)a1 alpha:(double)a2 outTintColor:(struct CGColor **)a3 outAlpha:(double *)a4;

- (void)dealloc;
- (void).cxx_destruct;
- (void)setTintColor:(struct CGColor { } *)a0 animated:(char)a1 duration:(double)a2;
- (void)animationDidStop:(id)a0 finished:(char)a1;
- (id)initWithLayer:(id)a0;
- (void)setTintColor:(struct CGColor { } *)a0 animated:(char)a1 duration:(double)a2 autoreverses:(char)a3 repeatCount:(double)a4;
...
- (void)setNonPulseRadius:(double)a0 animated:(char)a1 duration:(double)a2;
- (void)setupFilters;
- (void)updatePropertyForKeyPath:(id)a0 oldValue:(id)a1 newValue:(id)a2 animated:(char)a3 duration:(double)a4 autoreverses:(char)a5 repeatCount:(double)a6;
