...
- (void)_queueOnly_generateCandidatesForKeyboardState:(id)a0 requestToken:(id)a1 usesCandidateSelection:(char)a2;
- (id)_queueOnly_mergeKBDCorrections:(id)a0 withTextEffectsCorrections:(id)a1;
- (void)_queueOnly_performUpdatesToCandidateReceiverForRequest:(id)a0 type:(int)a1 didTimeout:(char)a2;
...
- (char)_queueOnly_willHandleDeliveryForCandidates:(id)a0 requestToken:(id)a1;
...
- (char)willHandleDeliveryForCandidates:(id)a0 requestToken:(id)a1;
