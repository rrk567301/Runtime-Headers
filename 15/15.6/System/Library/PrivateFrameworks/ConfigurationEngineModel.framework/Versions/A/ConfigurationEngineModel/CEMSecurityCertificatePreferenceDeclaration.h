...
+ (id)profileType;
+ (id)buildRequiredOnlyWithIdentifier:(id)a0 withName:(id)a1 withCertificateIdentifier:(id)a2;
+ (id)buildWithIdentifier:(id)a0 withName:(id)a1 withCertificateIdentifier:(id)a2;
