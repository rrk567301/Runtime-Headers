...
+ (id)buildWithIdentifier:(id)a0 withAllowMusicService:(id)a1 withAllowRadioService:(id)a2 withAllowMusicArtistActivity:(id)a3 withAllowMusicVideos:(id)a4 withAllowSharedLibraries:(id)a5 withAllowSpeakerVolumeLimitModification:(id)a6;
