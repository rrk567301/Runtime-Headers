@class NSSet, NSString, CEMApplicationControlDeclaration_InstallSchedule, CEMApplicationControlDeclaration_UpdateSchedule;
...
+ (id)buildWithIdentifier:(id)a0 withInstallSchedule:(id)a1 withUpdatePolicy:(id)a2 withUpdateSchedule:(id)a3;
