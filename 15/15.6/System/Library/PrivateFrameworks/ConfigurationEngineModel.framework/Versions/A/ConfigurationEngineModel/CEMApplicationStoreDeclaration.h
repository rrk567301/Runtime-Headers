...
+ (id)buildWithIdentifier:(id)a0 withAllowAppInstallation:(id)a1 withAllowAppClips:(id)a2 withAllowUIAppInstallation:(id)a3 withAllowAutomaticAppDownloads:(id)a4 withAllowSystemAppRemoval:(id)a5 withAllowAppRemoval:(id)a6 withAllowInAppPurchases:(id)a7 withForceITunesStorePasswordEntry:(id)a8 withAllowMarketPlaceAppInstallation:(id)a9;
+ (id)buildWithIdentifier:(id)a0 withAllowAppInstallation:(id)a1 withAllowAppClips:(id)a2 withAllowUIAppInstallation:(id)a3 withAllowAutomaticAppDownloads:(id)a4 withAllowSystemAppRemoval:(id)a5 withAllowAppRemoval:(id)a6 withAllowInAppPurchases:(id)a7 withForceITunesStorePasswordEntry:(id)a8 withAllowMarketplaceAppInstallation:(id)a9 withAllowWebDistributionAppInstallation:(id)a10;
