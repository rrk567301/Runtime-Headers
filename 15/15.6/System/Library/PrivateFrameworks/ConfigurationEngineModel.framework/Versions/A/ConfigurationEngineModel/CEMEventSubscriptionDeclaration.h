@class NSSet, NSString, NSArray, CEMEventSubscriptionDeclaration_Schedule;
...
+ (id)profileType;
+ (id)buildRequiredOnlyWithIdentifier:(id)a0 withEvents:(id)a1;
+ (id)buildWithIdentifier:(id)a0 withEvents:(id)a1 withSchedule:(id)a2;
