...
+ (id)buildWithIdentifier:(id)a0 withAllowGameCenter:(id)a1 withAllowMultiplayerGaming:(id)a2 withAllowAddingGameCenterFriends:(id)a3 withAllowGameCenterNearbyMultiplayer:(id)a4 withAllowGameCenterPrivateMessaging:(id)a5 withAllowGameCenterProfilePrivacyModification:(id)a6 withAllowGameCenterProfileModification:(id)a7 withAllowedGameCenterOtherPlayerTypes:(id)a8 withAllowGameCenterFriendsSharingModification:(id)a9;
