...
+ (id)profileType;
+ (id)buildRequiredOnlyWithIdentifier:(id)a0 withAppBundleIdentifier:(id)a1;
+ (id)buildWithIdentifier:(id)a0 withAppBundleIdentifier:(id)a1 withProviderBundleIdentifier:(id)a2 withProviderConfiguration:(id)a3;
