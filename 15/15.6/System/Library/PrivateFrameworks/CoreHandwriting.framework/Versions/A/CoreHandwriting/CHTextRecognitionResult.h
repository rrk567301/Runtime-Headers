...
@property (readonly) char isTextReplacement;

- (void).cxx_destruct;
- (id)initWithString:(id)a0 score:(double)a1 wordRanges:(id)a2 wordIDs:(id)a3 wordRecognitionScores:(id)a4 wordCombinedScores:(id)a5 wordStrokeSets:(id)a6 wordLexicalEntries:(id)a7 wordPatternEntries:(id)a8 rareWordIndexes:(id)a9 inappropriateWordIndexes:(id)a10 isTextReplacement:(char)a11;
- (id)mecabraCandidate;
