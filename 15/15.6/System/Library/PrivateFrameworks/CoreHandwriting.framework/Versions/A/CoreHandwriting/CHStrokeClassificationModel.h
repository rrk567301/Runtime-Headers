...
- (char)_isContentStroke:(long long)a0 withinSubtile:(long long)a1 withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 ofTotal:(long long)a3;
- (id)_subTilesForStrokeCount:(long long)a0;
- (char)classifyStrokes:(id)a0 outStrokeClassProbabilities:(void *)a1 cancellationBlock:(id /* block */)a2;
- (char)classifyStrokes:(id)a0 outTextStrokeProbabilities:(void *)a1 cancellationBlock:(id /* block */)a2;
