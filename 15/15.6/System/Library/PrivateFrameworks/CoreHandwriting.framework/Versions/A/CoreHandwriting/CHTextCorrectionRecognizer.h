@class NSArray, CHCornerDetector;
@protocol CHRecognizingText, CHRecognizingSketch;
...
@property (readonly, nonatomic) char isRemoteRecognition;
...
- (void).cxx_destruct;
- (id)initWithLocales:(id)a0 remoteRecognition:(char)a1 priority:(long long)a2;
- (id)textCorrectionResultForDrawing:(id)a0 targetContentInfo:(id)a1 originalDrawing:(id)a2 lastStroke:(id)a3 localTypedContextBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 normalizedDrawingScaleFactor:(double)a5 previousCorrectionResult:(id)a6 declaredVariables:(id)a7;
