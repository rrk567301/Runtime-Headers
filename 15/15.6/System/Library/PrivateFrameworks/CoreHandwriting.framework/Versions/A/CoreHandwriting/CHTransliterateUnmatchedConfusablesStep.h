...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)doesTransliterateAtIndexResolveUnmatchingCase:(id)a0 atIndex:(long long)a1 withString:(id)a2 unmatchingCase:(int)a3 shouldForceLocaleFormatNumber:(char)a4;
- (id)initWithCodemap:(id)a0;
- (id)process:(id)a0 options:(id)a1;
- (char)updateUnmatchingSymbol:(id)a0 unmatchingType:(int)a1 mode:(id)a2 shouldForceLocaleFormatNumber:(char)a3 outUpdatedPathTokens:(id)a4;
