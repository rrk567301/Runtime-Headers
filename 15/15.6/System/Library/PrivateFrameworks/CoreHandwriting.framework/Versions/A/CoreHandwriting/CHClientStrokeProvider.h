...
@property (nonatomic) char hasValidMathAnnotation;
...
- (id)initWithURL:(id)a0 version:(long long)a1 keepTextOnly:(char)a2;
- (id)initWithURL:(id)a0 version:(long long)a1 keepTextOnly:(char)a2 strokesFromSections:(id)a3 channels:(id)a4 sectionTypes:(id)a5;
- (void)loadStrokesBasedOnSectionTypeFrom:(id)a0 section:(id)a1 withTime:(char)a2 atTimestamp:(double)a3 channels:(id)a4 orderedStrokes:(id)a5;
- (void)loadStrokesBasedOnStrokeClassicationType:(id)a0 section:(id)a1 withTime:(char)a2 atTimestamp:(double)a3 channels:(id)a4 orderedStrokes:(id)a5;
- (void)loadStrokesBasedOnUnicodeFrom:(id)a0 section:(id)a1 withTime:(char)a2 atTimestamp:(double)a3 channels:(id)a4 orderedStrokes:(id)a5;
- (void)loadStrokesFrom:(id)a0 section:(id)a1 withTime:(char)a2 atTimestamp:(double)a3 channels:(id)a4 orderedStrokes:(id)a5;
- (void)loadStrokesFrom:(id)a0 withStrokes:(id)a1 types:(id)a2 withTime:(char)a3 atTimestamp:(double)a4 channels:(id)a5 orderedStrokes:(id)a6;
