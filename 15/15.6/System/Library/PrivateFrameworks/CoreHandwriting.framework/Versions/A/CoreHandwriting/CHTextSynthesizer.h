...
+ (long long)maxNumberOfSynthesizedCharactersForSize:(struct CGSize { double x0; double x1; })a0 withDecimalSeparator:(char)a1;
...
- (char)shouldAlwaysUseFastPathSynthesis;
