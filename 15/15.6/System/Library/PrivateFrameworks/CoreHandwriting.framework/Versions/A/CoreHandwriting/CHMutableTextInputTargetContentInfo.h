...
@property (nonatomic) char isCursorStrong;
@property (nonatomic) char containsCommittedStrokes;
...
@property (nonatomic) char isSingleLine;
@property (nonatomic) char supportsAutoLineBreaks;
...
- (void)setContainsCommittedStrokes:(char)a0;
- (void)setIsCursorStrong:(char)a0;
- (void)setIsSingleLine:(char)a0;
...
- (void)setSupportsAutoLineBreaks:(char)a0;
