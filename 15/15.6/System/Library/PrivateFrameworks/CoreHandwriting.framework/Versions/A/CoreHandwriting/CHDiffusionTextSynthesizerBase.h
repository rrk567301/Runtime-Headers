...
- (id).cxx_construct;
- (char)isLoaded;
- (id)alignAlphaShapes:(id)a0 original:(id)a1 allowAnisotropicScaling:(char)a2;
...
- (char)shouldAlignAlphaShapesForOriginalString:(id)a0 replacementString:(id)a1;
