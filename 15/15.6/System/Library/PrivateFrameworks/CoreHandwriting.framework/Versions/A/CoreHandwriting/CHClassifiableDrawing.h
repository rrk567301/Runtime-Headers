...
@property (readonly, nonatomic) char expandCodePoints;
...
- (void).cxx_destruct;
- (id)initWithDrawing:(id)a0 characterSet:(id)a1 expandCodePoints:(char)a2 normalizationContext:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 maxCandidateCount:(unsigned long long)a4;
