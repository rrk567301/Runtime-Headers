...
@property (readonly, nonatomic) char isNotDef;
...
- (id)initWithChunkValueForSynthesis:(id)a0 originalValue:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 isNotDef:(char)a3 synthesisSuggestion:(long long)a4;
