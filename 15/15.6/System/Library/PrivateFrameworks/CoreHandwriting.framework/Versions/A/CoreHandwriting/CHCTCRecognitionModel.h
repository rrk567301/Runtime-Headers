...
@property (nonatomic) char normalizeFeatures;
...
@property (nonatomic) char shouldUseCPPFeatureExtraction;
@property (nonatomic) char shouldUseArabicVisualOrderFeatureExtraction;
@property (nonatomic) char shouldUseStrokeDirectionFeature;
...
- (id)featureProviderForDrawing:(id)a0 initialVectorAnchorPoint:(struct CGPoint { double x0; double x1; })a1 normalizeFeatures:(char)a2 padFeatures:(char)a3 outStrokeEndings:(void *)a4 outInputSequenceLength:(long long *)a5 outOutputSequenceLength:(long long *)a6;
...
- (char)reachesActivationThreshold:(double)a0 inCharacterSet:(id)a1 resultArray:(id)a2 indexArray:(id)a3;
