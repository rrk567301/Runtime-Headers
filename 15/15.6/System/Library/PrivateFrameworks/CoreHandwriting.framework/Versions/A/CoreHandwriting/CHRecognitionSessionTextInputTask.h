...
- (id)initWithSessionMode:(long long)a0 locales:(id)a1 preferredLocales:(id)a2 strokeProvider:(id)a3 calculateDocumentProvider:(id)a4 inputResult:(id)a5 recognitionQOSClass:(unsigned int)a6 recognitionEnvironment:(long long)a7 isHighResponsivenessTask:(char)a8 strokeClassificationModel:(id)a9 strokeGroupingModel:(id)a10 strokeGroupingRequirement:(long long)a11 principalLineRequirement:(long long)a12 subjectStrokeIdentifiers:(id)a13 subjectStrokeClassificationResult:(id)a14 recognitionOptions:(id)a15 partialResultBlock:(id /* block */)a16 wantsAutoRefine:(char)a17;
