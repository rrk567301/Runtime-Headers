...
+ (void)_updatePrecedingAndTrailingSeparatorsForTopCandidate:(id)a0 history:(id)a1 textAfter:(id)a2 locale:(id)a3 outTrailingSeparator:(id *)a4 inFirstTokenHasPrecedingSpace:(char)a5 outFirstTokenHasPrecedingSpace:(char *)a6;
...
- (void)_calculateBestTranscriptionPaths:(id *)a0 scores:(id *)a1 fromTokenizedResult:(id)a2 pathCount:(long long)a3 history:(id)a4 skipLMRescoring:(char)a5;
...
- (id)_tokenizedTextResultFromResults:(id)a0 segmentGroup:(id)a1 offsetSegment:(long long)a2 decodedStrokeSets:(char)a3 spaceBehavior:(long long)a4;
...
- (char)isOVSString:(id)a0;
- (char)isRareChineseEntry:(id)a0;
