...
- (void).cxx_destruct;
- (id)initWithStrokeProvider:(id)a0 strokeGroupingModel:(id)a1 locales:(id)a2 isInlineContinuousMode:(char)a3 inlineContinuousModeTargets:(id)a4 isMathMode:(char)a5;
