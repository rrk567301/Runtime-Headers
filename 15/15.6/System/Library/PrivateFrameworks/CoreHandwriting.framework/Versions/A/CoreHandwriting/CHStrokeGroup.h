...
+ (char)isStrokeGroupSet:(id)a0 equivalentToStrokeGroupSet:(id)a1;
+ (id /* block */)strokeGroupAncestorComparator;
+ (id)strokeGroupClosestToPoint:(struct CGPoint { double x0; double x1; })a0 strokeGroups:(id)a1;
...
+ (void)strokeGroupsContainingPoint:(struct CGPoint { double x0; double x1; })a0 strokeGroups:(id)a1 groupProcessingBlock:(id /* block */)a2;
...
- (char)isEquivalentToStrokeGroup:(id)a0;
...
- (id)strokeGroupWithUpdatedStrategyIdentifier:(id)a0 classification:(long long)a1;
