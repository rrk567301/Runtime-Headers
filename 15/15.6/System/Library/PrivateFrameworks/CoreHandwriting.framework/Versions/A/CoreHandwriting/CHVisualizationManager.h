...
@property (nonatomic) char statusReportingEnabled;
...
+ (char)variableHeightForRecognitionSessionStatusKey:(id)a0;
...
- (char)isEnabledVisualizationForIdentifier:(id)a0;
- (void)recognitionSessionDidChangeStatus:(id)a0;
- (void)recognitionSessionDidUpdateRecognitionResult:(id)a0;
- (void)setEnabled:(char)a0 forVisualizationIdentifier:(id)a1;
