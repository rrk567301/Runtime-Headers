...
@interface CHRecognitionSession : NSObject <CHRecognitionSessionTaskDelegate, CHRecognitionSessionTextInputTaskDelegate, NSSecureCoding> {
    ...
    char _disableMathTextSwapping;
    char _leverageAllProvidedVariables;
    CHSessionStateTracker *_stateTracker;
    char __hasUnprocessedChanges;
    char __shouldForceFastGrouping;
    char __skipMathTransliterations;
    char __skipMathOperatorsInference;
    char __skipPopulatingStyleInventory;
    char __skipPrincipalLines;
    char __forceLocaleNumberFormat;
...
@property (nonatomic) char strokeGroupingOnly;
...
@property (nonatomic) char disableMathTextSwapping;
@property (nonatomic) char leverageAllProvidedVariables;
...
@property (nonatomic) char shouldForceFastGrouping;
@property (nonatomic) char skipMathOperatorsInference;
@property (nonatomic) char skipMathTransliterations;
@property (nonatomic) char skipPopulatingStyleInventory;
@property (nonatomic) char skipPrincipalLines;
@property (nonatomic) char forceLocaleNumberFormat;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly) char q_wantsAutoRefine;
@property (readonly) char q_needsForegroundRecognition;
...
+ (id)createMathRecognizerRunningRemote:(char)a0 priority:(long long)a1;
+ (id)createRecognizerForLocale:(id)a0 sessionMode:(long long)a1 remote:(char)a2 priority:(long long)a3;
+ (id)createRecognizerForLocales:(id)a0 sessionMode:(long long)a1 remote:(char)a2 priority:(long long)a3;
+ (id)effectiveLocalesFromLocales:(id)a0;
+ (char)shouldRunRecognitionLocallyWithEnvironment:(long long)a0;
...
- (id)lineWrapper;
- (char)loadSessionData:(id)a0 error:(id *)a1;
- (id)mathRecognizer;
...
- (void)runOnSessionQueueForTesting:(id /* block */)a0;
- (void)setActive;
- (void)setNeedsRecognitionUpdate;
- (void)setNeedsRecognitionUpdateImmediately:(char)a0;
...
- (char)textSynthesizerWithLocaleFallbackIsSupported;
