...
@property (readonly, nonatomic) char preferCharacterLevel;
@property (readonly, nonatomic) id<CHStroke> lastStroke;

+ (char)isDrawingCenterOnBlank:(id)a0 targetContentInfo:(id)a1 insertionLocation:(long long *)a2;
+ (char)isEditGestureForDrawing:(id)a0 targetContentInfo:(id)a1 tentativeResultType:(long long)a2;
+ (char)isVerticalBarShapeFromLineResult:(id)a0 originalDrawing:(id)a1 isDirectionDownward:(char *)a2;
...
+ (char)shouldReclassifyGestureType:(long long)a0;
...
- (void)getAffectedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a0 expandedToFullTokens:(char *)a1;
- (id)initWithGestureType:(long long)a0 targetContentInfo:(id)a1 locale:(id)a2 normalizedDrawing:(id)a3 originalDrawing:(id)a4 lastStroke:(id)a5 preferCharacterLevel:(char)a6;
- (id)textResult;
