...
@interface CHBottomUpStrokeGroupingStrategy : CHStrokeGroupingStrategy {
    ...
    char _shouldLimitDefaultWritingOrientationDeviation;
    char _shouldAdjustDeviationOfSmallGroups;
    char _shouldCoalesceLastSubstrokes;
}

@property (readonly, nonatomic) char isInlineContinuousMode;
@property (readonly, nonatomic) NSArray *textInputTargets;

- (void).cxx_destruct;
- (void)smoothLocalWritingOrientations:(void *)a0;
- (void)updateLocalWritingOrientationsForSubstrokes:(id)a0 useCoalescedCenter:(char)a1;
- (void)refineLocalWritingOrientationsForSubstrokes:(id)a0 useCoalescedCenter:(char)a1;
...
- (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct __compressed_pair<CGPoint *, std::allocator<CGPoint>> { struct CGPoint *x0; } x2; })flippedCenters:(const void *)a0 ofSubstrokes:(id)a1 maxStrokesGap:(long long)a2 begnning:(char)a3;
...
- (id)initWithStrokeProvider:(id)a0 defaultWritingOrientation:(long long)a1 locales:(id)a2 isInlineContinuousMode:(char)a3 inlineContinuousModeTargets:(id)a4;
- (void)mergeGroupsPostProcessing:(id)a0 createdGroups:(id)a1 deletedGroups:(id)a2 availableGroupingStrategies:(id)a3 allowOppositeOrientations:(char)a4 groupStatistics:(id)a5;
...
- (char)refineWritingOrientationAndResortSubstrokes:(id)a0 averageWritingOrientation:(struct CGVector { double x0; double x1; } *)a1;
...
- (id)strokeGroupFromStrokes:(id)a0 ancestorIdentifier:(long long)a1;
