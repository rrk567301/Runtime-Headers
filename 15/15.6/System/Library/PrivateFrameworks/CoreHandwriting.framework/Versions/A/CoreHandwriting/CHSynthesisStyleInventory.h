...
@property (nonatomic) char hasInventoryChanged;
...
- (char)_unsafeHasLowSampleCountForCharacters:(id)a0 minimumSampleCount:(long long)a1;
...
- (char)containsSampleWithStrokeIdentifiers:(id)a0;
- (char)containsSampleWithTranscription:(id)a0 strokeIdentifiers:(id)a1;
...
- (char)isPersonalizationAvailable;
- (char)isTokenAcceptable:(id)a0 script:(long long)a1;
...
- (char)needsStylePredictionUpdateForScript:(long long)a0;
