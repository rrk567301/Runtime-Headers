...
@property (readonly, nonatomic) char isOriginal;
@property (readonly, nonatomic) char isTopOriginal;
@property (readonly, nonatomic) char isTransliterated;
...
- (char)isEquivalentToToken:(id)a0;
- (char)isTopOriginal;
- (char)isTransliterated;
