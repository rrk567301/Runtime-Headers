...
@interface CHLexiconCorrectionStep : CHPostprocessingStep {
    ...
    char _shouldCreatePseudoTokens;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithAutoCapitalizationMode:(int)a0 shouldAutoCorrect:(char)a1 shouldAutoCapitalize:(char)a2 shouldCreatePseudoTokens:(char)a3 locale:(id)a4 staticLexicon:(struct _LXLexicon { } *)a5 customLexicon:(struct _LXLexicon { } *)a6 phraseLexicon:(struct _LXLexicon { } *)a7 customPhraseLexicon:(struct _LXLexicon { } *)a8 spellChecker:(id)a9 lmVocabulary:(void *)a10 ovsStringChecker:(id)a11 textReplacements:(id)a12;
