...
@property char canBecomeKeyWindow;
@property char canBecomeMainWindow;
...
- (char)_performKeyEquivalentWithRequest:(id)a0;
...
- (void)hideSharedWindow:(char)a0 atLocation:(struct CGPoint { double x0; double x1; })a1;
