...
@property (nonatomic) char shouldAutoClose;
...
+ (id)resultSetWithStatement:(id)a0 usingParentDatabase:(id)a1 shouldAutoClose:(char)a2;
...
- (void)_tryLogSqliteColumnError:(int)a0;
- (char)bindWithArray:(id)a0;
- (char)bindWithArray:(id)a0 orDictionary:(id)a1 orVAList:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
- (char)bindWithDictionary:(id)a0;
- (char)boolForColumn:(id)a0;
- (char)boolForColumnIndex:(int)a0;
- (int)columnIndexForName:(id)a0;
- (char)columnIndexIsNull:(int)a0;
- (char)columnIsNull:(id)a0;
