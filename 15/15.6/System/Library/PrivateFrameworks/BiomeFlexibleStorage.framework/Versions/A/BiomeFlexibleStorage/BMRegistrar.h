...
- (char)propagateDeletionOfEvents:(id)a0;
- (char)propagateDeletionOfEventsInStream:(id)a0 withIdentifiers:(id)a1;
- (char)registerClientWithBundleID:(id)a0 databaseURL:(id)a1 source:(id)a2;
