...
- (int)isEncryptedDiskForLogicalVolume:(id)a0 encrypted:(char *)a1 locked:(char *)a2 type:(id *)a3;
...
- (int)doCallDaemonForCoreStorage:(id)a0 inputDict:(id)a1 outputDict:(id *)a2 checkDelegate:(char)a3 sync:(char)a4;
...
- (int)isCompositeDiskForLogicalVolume:(id)a0 composite:(char *)a1;
- (int)isDamagedLogicalVolumeGroup:(id)a0 damaged:(char *)a1 how:(id *)a2;
- (int)isDiskLogicalVolumeWithDesignatedBootCampVolume:(struct __DADisk { } *)a0 bootCamp:(char *)a1;
- (int)isDiskSuitableForDecryption:(struct __DADisk { } *)a0 suitable:(char *)a1 why:(id *)a2 options:(id)a3;
- (int)isDiskSuitableForEncryption:(struct __DADisk { } *)a0 suitable:(char *)a1 why:(id *)a2 options:(id)a3;
- (int)isLogicalVolumeFamilyEncrypted:(id)a0 isFullyOrPartiallyEncrypted:(char *)a1 isFullyEncrypted:(char *)a2 encryptionType:(id *)a3 isLocked:(char *)a4;
- (int)isLogicalVolumeFamilyEncrypted:(id)a0 isFullyOrPartiallyEncrypted:(char *)a1 isLocked:(char *)a2;
- (int)isSparseLogicalVolumeGroup:(id)a0 sparse:(char *)a1;
