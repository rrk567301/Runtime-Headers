...
- (int)changeFilesystemSizeOnDisk:(struct __DADisk { } *)a0 toSize:(id)a1 fitPartition:(char)a2;
...
- (int)getFreespaceFollowingPartition:(struct __DADisk { } *)a0 skipBooter:(char)a1 gapSize:(id *)a2 reserveSize:(id *)a3 usableSize:(id *)a4;
...
- (int)mergePartitions:(id)a0 filesystem:(id)a1 name:(id)a2 erase:(char)a3;
- (int)mergePartitions:(id)a0 filesystem:(id)a1 name:(id)a2 erase:(char)a3 options:(id)a4;
- (int)partitionDisk:(struct __DADisk { } *)a0 withMap:(id)a1 formatVolumes:(char)a2;
- (int)partitionDisk:(struct __DADisk { } *)a0 withMap:(id)a1 formatVolumes:(char)a2 options:(id)a3;
- (int)removePartition:(struct __DADisk { } *)a0 wipe:(char)a1 options:(id)a2;
