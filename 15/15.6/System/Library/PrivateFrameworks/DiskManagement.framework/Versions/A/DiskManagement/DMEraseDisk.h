...
- (int)eraseOpticalAsync:(struct __DADisk { } *)a0 quick:(char)a1 format:(char)a2;
- (int)armWindowsInstallerPartitionRemoverOnBootCampWholeDisk:(struct __DADisk { } *)a0;
- (void)cancelCurrentOperation;
- (id)eraseDisk:(struct __DADisk { } *)a0 synchronous:(char)a1 filesystem:(id)a2 bootable:(char)a3 name:(id)a4 doNewfs:(char)a5;
- (id)eraseDisk:(struct __DADisk { } *)a0 synchronous:(char)a1 filesystem:(id)a2 bootable:(char)a3 name:(id)a4 doNewfs:(char)a5 doBooterCleanup:(char)a6;
...
- (int)wipeDisk:(struct __DADisk { } *)a0 level:(unsigned int)a1 count:(unsigned long long)a2 force:(char)a3;
