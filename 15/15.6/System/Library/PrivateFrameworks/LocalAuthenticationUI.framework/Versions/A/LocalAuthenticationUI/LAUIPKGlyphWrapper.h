...
@property (readonly, nonatomic) NSView<GlyphMethods> *glyphView;
@property (readonly, nonatomic) NSView<GlyphMethods> *idleTouchID;
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *glyphQueue;
@property (readonly, nonatomic) NSView *view;
@property (nonatomic) char fastAnimations;
@property (nonatomic) char grayedOut;
...
- (void)setState:(long long)a0 idleTouchID:(char)a1 animated:(char)a2 completionHandler:(id /* block */)a3;
