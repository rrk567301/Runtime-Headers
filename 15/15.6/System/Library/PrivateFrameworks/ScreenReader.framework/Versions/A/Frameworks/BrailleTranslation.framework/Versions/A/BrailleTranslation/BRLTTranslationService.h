...
@property (readonly, nonatomic, getter=isLoopback) char loopback;
@property (copy, nonatomic) id /* block */ invalidationHandler;

+ (id)connectionForServiceIdentifier:(id)a0;
+ (id)connectionsLock;
+ (id)connectionForLoopbackService:(id)a0;
+ (id)serviceForIdentifier:(id)a0 input:(char)a1;
+ (id)serviceForIdentifier:(id)a0 input:(char)a1 loopback:(char)a2;
