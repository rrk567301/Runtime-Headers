...
- (char)isUnassignedIdentifierAtIndex:(unsigned long long)a0 forDisplayWithToken:(int)a1;
- (id)modelIdentifierForDisplayWithToken:(int)a0;
- (char)moveIndex:(unsigned long long)a0 toIndex:(unsigned long long)a1 forDisplayWithToken:(int)a2;
