...
@interface SCROBrailleDisplay : NSObject <SCROBrailleDisplayCommandDispatcherDelegate, SCROBrailleDriverDelegate, BRLTBrailleStateManagerDelegate> {
    ...
    char _needsUpdating;
    char _needsPanUpdating;
    char _wordWrapEnabled;
    char _autoAdvanceEnabled;
    char _latinEscapeEnabled;
    ...
    char _kSCROBrailleLatinEscapeEnabled;
}
...
@property (readonly, nonatomic) char isInputEightDot;
@property (readonly, nonatomic) char isInputContracted;
...
@property (nonatomic) char inputShowEightDot;
@property (nonatomic) char outputShowEightDot;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (char)brailleDriverClassIsValid:(Class)a0;
...
- (void)updateBlinkingCursorTimer:(char)a0;
- (id)virtualStatus;
