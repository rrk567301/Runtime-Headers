...
@property (nonatomic, setter=_setMenuItemsReplaced:) char _menuItemsReplaced;
@property (nonatomic, setter=_setMenuTitleUpdated:) char _menuTitleUpdated;
@property (nonatomic, setter=_setShowContent:) char _showContent;
...
- (char)_shouldReplaceLastItemWhenAddingItems;
