...
+ (void)logBrailleRequests:(char)a0;
...
- (void)setDisplayDescriptorCallbackEnabled:(char)a0;
- (void)setExpandedStatusDisplayModeWithStatus:(id)a0;
- (void)setFocused:(char)a0 forToken:(long long)a1;
- (void)setInputTableIdentifier:(id)a0;
- (void)setKeepConnectionAlive:(char)a0;
