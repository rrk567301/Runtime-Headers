...
@property (nonatomic, setter=_setCursorEnabled:) char _cursorEnabled;
...
@property (nonatomic, setter=_setTrackpadMouseTrackingVOCursor:) char _trackpadMouseTrackingVOCursor;
@property (retain, nonatomic, setter=_setUserDefaults:) SCRCUserDefaults *_userDefaults;
@property (nonatomic) char cursorEnabled;
@property (nonatomic) char cursorHidden;
@property (nonatomic) char cursorFaded;
...
@property (nonatomic) char allowMouseCursorSync;
@property (nonatomic) char isMouseTriggered;
@property (nonatomic) char centerInMainScreen;
...
- (char)_isValidCursorRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
