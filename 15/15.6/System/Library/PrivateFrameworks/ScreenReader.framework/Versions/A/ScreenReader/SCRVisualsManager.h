...
@property (nonatomic) char activeVisualsEnabled;
...
@property (nonatomic) char screenCurtainEnabled;
@property (nonatomic) char tileVisualsEnabled;
...
- (void)_initializeVisualsWindowsWithUserDefaults:(id)a0 enableOutputVisuals:(char)a1;
- (void)_setVisualsEnabled:(char)a0;
- (void)_updateCursorIfNeededWithOptions:(id)a0;
- (void)_visualsFontSizeChanged:(id)a0;
- (void)drawCursorWithOptions:(id)a0;
- (id)initWithUserDefaults:(id)a0 enableOutputVisuals:(char)a1;
