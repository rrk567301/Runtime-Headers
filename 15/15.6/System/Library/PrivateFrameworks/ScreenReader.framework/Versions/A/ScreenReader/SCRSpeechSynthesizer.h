...
@property (nonatomic) char _wordCallBackRegistered;
@property (nonatomic) char synthPaused;
...
@property (nonatomic) char makeCallbacksOnTTSThread;
...
@property (readonly, nonatomic) char shouldPostWhenSpeechCompletes;
...
+ (void)_setShouldShortCircuitSpeechSynthesizer:(char)a0;
...
+ (char)localeHasSameLanguage:(id)a0 matchesLocale:(id)a1;
+ (char)makeVoiceForIdentifier:(struct __CFString { } *)a0 voiceSpec:(struct VoiceSpec { unsigned int x0; unsigned int x1; } *)a1;
+ (char)voiceIdentifier:(id)a0 matchesLocale:(id)a1;
...
- (void)_handleSpeechDoneCallback:(char)a0;
