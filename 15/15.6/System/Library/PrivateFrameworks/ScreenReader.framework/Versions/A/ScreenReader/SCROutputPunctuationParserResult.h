...
- (void).cxx_destruct;
- (id)initWithLength:(unsigned long long)a0 kind:(unsigned long long)a1 shouldPresent:(char)a2 punctuation:(id)a3 repeatCount:(unsigned long long)a4 punctuationVerbosityLevel:(long long)a5;
