...
@property (nonatomic) char isProcessingDFRGestureEvents;
...
@property (nonatomic) char _flickGestureRecognizerAborted;
@property (nonatomic) char _singleTapAndHoldGestureRecognizerAborted;
