...
- (char)_closeEnoughMatchForString:(id)a0 andString:(id)a1;
...
- (char)_isDraggingFromDock;
- (char)_isDroppingToDock;
- (char)_isMouseDown;
...
- (char)_verifyDragItem:(id)a0 destinationItem:(id)a1;
- (char)_verifyDragItemIsDroppedAfterDestination;
- (char)_verifyDragItemIsDroppedBeforeDestination;
