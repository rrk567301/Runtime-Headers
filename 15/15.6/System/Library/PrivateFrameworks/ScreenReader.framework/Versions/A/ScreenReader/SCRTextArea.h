...
@property (nonatomic, getter=isObservingSelectedTextChangedNotification) char observingSelectedTextChangedNotification;
@property (nonatomic, getter=isObservingTextValueChangedNotification) char observingTextValueChangedNotification;
...
- (char)_advanceInsertionPointWithDirection:(long long)a0 granularity:(long long)a1 uiElement:(id)a2 outputRequest:(id)a3;
...
- (char)_focusChangeIsLikelyDuringMove:(id)a0 targetFocusedElement:(id)a1;
- (char)_handleIndentationInTextChange:(id)a0 uiElement:(id)a1 request:(id)a2;
...
- (char)_isDeveloperDefinedFocusUpdateForUIElement:(id)a0;
...
- (void)_sendOutputRequest:(id)a0 processCursorMovement:(char)a1 updateBraille:(char)a2;
- (void)_syncVOCursorWithElementIfNeeded:(id)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 moveInsertionPoint:(char)a2 request:(id)a3;
...
- (char)advanceInsertionPointWithDirection:(long long)a0 granularity:(long long)a1 uiElement:(id)a2 outputRequest:(id)a3;
...
- (void)handleTextChangesWithUIElement:(id)a0 changes:(id)a1 secure:(char)a2;
...
- (char)wordEchoHelper:(id)a0 echoTextMarkerRangeForWord:(id)a1 additionalContent:(id)a2;
- (char)wordEchoHelper:(id)a0 textMarkerPrecedesOrEquals:(id)a1 textMarker:(id)a2;
