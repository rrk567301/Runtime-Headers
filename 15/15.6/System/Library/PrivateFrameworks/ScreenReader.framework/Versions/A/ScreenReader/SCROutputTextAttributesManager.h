...
- (id)_actionForString:(id)a0 targetComponent:(id)a1 encounteredKey:(long long)a2 encounteredAttribute:(id)a3 isLowerPitch:(char)a4;
...
- (id)_attributedStringFromAction:(id)a0 isBrailleComponent:(char)a1;
...
- (id)_copyOfAction:(id)a0 isBrailleComponent:(char)a1 withoutRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 orRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
- (id)_copyOfAction:(id)a0 withNewString:(id)a1 isBrailleComponent:(char)a2;
- (id)_deltaTextAttributesWithAttributes:(id)a0 previousAttributes:(id)a1;
- (id)_getContextStringFromAction:(id)a0 isBrailleComponent:(char)a1 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 limitRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
...
- (id)_stringDescribingAttributes:(id)a0 isSpeechComponent:(char)a1;
- (id)_stringFromAction:(id)a0 isBrailleComponent:(char)a1;
