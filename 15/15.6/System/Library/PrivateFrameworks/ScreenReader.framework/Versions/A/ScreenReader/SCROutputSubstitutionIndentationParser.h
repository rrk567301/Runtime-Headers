...
- (char)_isPosition:(unsigned long long)a0 atStartOfLineUsingContextInAction:(id)a1;
- (char)_isValidZeroIndentationAtPosition:(unsigned long long)a0 inAction:(id)a1;
