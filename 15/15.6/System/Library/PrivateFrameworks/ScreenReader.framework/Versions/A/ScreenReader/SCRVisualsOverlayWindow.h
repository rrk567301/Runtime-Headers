...
@property (nonatomic, setter=setVOCursorEnabled:) char voCursorEnabled;
@property (nonatomic) char cursorTemporarilyHidden;
@property (readonly, nonatomic) SCRVisualsHighlightCurtain *highlightCurtain;
@property (nonatomic) char highlightCurtainEnabled;
...
- (void)showEncircledPoint:(char)a0;
- (void)showHighlightCurtain:(char)a0;
