...
@property (nonatomic) char inProgress;
...
- (id)_searchResultMarkerForWebTextField:(id)a0 data:(id)a1 handled:(char *)a2;
...
- (char)enableFindTextModeWithRequest:(id)a0 element:(id)a1;
- (char)handleSearchOperationWithEvent:(id)a0 request:(id)a1 element:(id)a2;
- (void)handleSearchResultMarker:(id)a0 data:(id)a1;
- (char)handleTaggedOperationWithEvent:(id)a0 request:(id)a1 element:(id)a2;
...
- (long long)searchFromElement:(id)a0 inContainerElement:(id)a1 direction:(long long)a2 request:(id)a3 handleResult:(char)a4 withPredicate:(id /* block */)a5;
