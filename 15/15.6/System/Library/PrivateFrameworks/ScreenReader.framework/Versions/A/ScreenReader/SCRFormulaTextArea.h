...
- (char)_echoLastTypedWordInCompletionTokenTitle:(id)a0 restrictSearchToRangeOfLength:(unsigned long long)a1 request:(id)a2 prependPause:(char)a3;
...
- (char)wantsExpandedAttachmentsForItemName;
