...
@property (readonly, nonatomic) char immediateDescendants;
...
- (id)initWithStart:(id)a0 container:(id)a1 direction:(long long)a2 searchKeys:(id)a3 searchText:(id)a4 immediateDescendants:(char)a5;
