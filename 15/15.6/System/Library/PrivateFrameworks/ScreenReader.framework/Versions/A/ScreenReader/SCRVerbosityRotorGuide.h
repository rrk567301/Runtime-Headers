...
- (void)_addDescriptionToOutputRequest:(id)a0 withBraille:(char)a1;
- (char)_handleVerbosityZigzagEvent:(id)a0;
...
- (long long)verbosityRotorItemIndexForEvent:(id)a0 request:(id)a1 force:(char)a2;
