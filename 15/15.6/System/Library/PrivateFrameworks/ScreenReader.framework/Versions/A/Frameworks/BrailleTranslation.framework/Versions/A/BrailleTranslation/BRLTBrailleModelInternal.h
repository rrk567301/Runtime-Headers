...
@interface BRLTBrailleModelInternal : NSObject {
    ...
    void /* unknown type, empty encoding */ wasShowingSecureToken;
...
@property (nonatomic) void /* unknown type, empty encoding */ isShowingSecureToken;
...
@property (nonatomic, readonly) char isCandidateSelectionActive;
...
- (char)handleBrailleSelectionWithNSSelection:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)handleDeleteWithSilently:(char)a0;
