...
@property (class, nonatomic) char shouldShortCircuitSoundOutput;
...
@property (nonatomic, setter=_setCompletionCallbackNeedsSending:) char _completionCallbackNeedsSending;
@property (nonatomic) unsigned long long soundID;
@property (nonatomic) char ensureSingleCompletionCallbacks;
...
- (char)_audioFailed:(id)a0;
- (void)_audioSchedulingComplete;
- (void)_informDelegateOfCompletionIfNeeded:(char)a0;
