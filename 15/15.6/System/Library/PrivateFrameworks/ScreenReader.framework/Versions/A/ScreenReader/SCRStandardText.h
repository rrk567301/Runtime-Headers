...
- (char)_annotationDictionary:(id)a0 isAtRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)_containsAllWordBreakCharactersInRange:(id)a0;
...
- (id)_nextWordRangeFromPosition:(id)a0 searchingForward:(char)a1;
