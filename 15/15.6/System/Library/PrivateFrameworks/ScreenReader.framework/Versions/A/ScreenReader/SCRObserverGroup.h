...
@property (nonatomic, setter=_setRegistered:) char _registered;
@property (nonatomic, setter=_setValid:) char _isValid;
...
- (char)isObserving:(struct __CFString { } *)a0 forElement:(id)a1;
- (char)removeObserverWithTarget:(id)a0;
