...
@property (nonatomic, setter=_setNotificationsAreQueuedForOutput:) char _notificationsAreQueuedForOutput;
@property (copy, nonatomic, setter=_setPreviousSelectionChangeOutput:) NSString *_previousSelectionChangeOutput;
@property (nonatomic) char _didSendBrailleTextLine;
...
- (char)_hasNewOutput:(id)a0 comparedToCachedOutput:(id)a1;
...
- (char)addOutputRequestToSharedFocusQueue:(id)a0 withNotificationKey:(long long)a1;
