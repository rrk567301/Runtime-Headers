...
+ (id)_spokenStringForBrailleString:(id)a0 isDelete:(char)a1 speakLiterally:(out char *)a2 modifiers:(id)a3;
...
+ (id)spokenStringForDeletedBrailleString:(id)a0 speakLiterally:(out char *)a1;
+ (id)spokenStringForInsertedBrailleString:(id)a0 speakLiterally:(out char *)a1 modifiers:(id)a2;
