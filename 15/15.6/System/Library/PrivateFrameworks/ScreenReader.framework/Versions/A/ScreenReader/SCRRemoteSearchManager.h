...
+ (id)resultsWithSearchKeys:(id)a0 containerElement:(id)a1 searchDirection:(long long)a2 limit:(unsigned long long)a3 startResult:(id)a4 searchText:(id)a5 immediateDescendantsOnly:(char)a6;
+ (id)uiChildElementForSearchDirection:(long long)a0 containerElement:(id)a1 uiStartElement:(id)a2;
+ (id)uiChildElementInContainerElement:(id)a0 startResult:(id)a1 searchDirection:(long long)a2 maxItem:(unsigned long long)a3 batchSize:(unsigned long long)a4 immediateDescendantsOnly:(char)a5 searchPredicate:(id /* block */)a6;
...
+ (char)uiElementSupportsSearch:(id)a0;
