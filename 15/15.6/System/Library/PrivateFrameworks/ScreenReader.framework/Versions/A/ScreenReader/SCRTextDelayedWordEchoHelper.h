...
- (char)_echoWithAdditionalContent:(id)a0;
- (char)_shouldEchoPreviousWord:(id)a0;
- (char)_shouldEchoWordIfPunctuation:(id)a0;
- (char)_shouldEchoWordIfSymbol:(id)a0;
- (long long)_shouldEchoWordIfTypingChangeAtEndOfWord:(id)a0 wordTextMarkerRange:(id)a1;
- (char)_shouldEchoWordIfWhitespaceOrNewline:(id)a0;
