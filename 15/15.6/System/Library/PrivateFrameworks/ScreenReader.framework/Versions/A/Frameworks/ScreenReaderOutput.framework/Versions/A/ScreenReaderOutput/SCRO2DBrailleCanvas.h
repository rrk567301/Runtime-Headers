...
- (char)hasConsistentVerticalPinSpacing;
- (char)hasConsistentHorizontalPinSpacing;
...
- (char)skipPinBetweenCellsHorizontally;
- (void)_blitBMP;
- (void)_blitCell:(unsigned char)a0 AtX:(unsigned long long)a1 y:(unsigned long long)a2;
- (void)_blitText;
- (char)_canBlitCellAtX:(unsigned long long)a0 y:(unsigned long long)a1;
- (void)_clearCells;
...
- (char)skipPinBetweenCellsVertically;
- (char)supportsBrailleText;
