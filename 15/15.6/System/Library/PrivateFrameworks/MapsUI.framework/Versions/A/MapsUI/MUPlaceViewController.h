@class MUPlaceActionManager, MUPlaceViewControllerConfiguration, MKMapItemIdentifier, NSString, _MKPlaceViewController, MUPlaceCallToActionAppearance, MUPlaceCardAnalyticsController, GEOWalkingOptions, NSArray, GEOTransitOptions, MUPlaceInlineMapSectionController, _MKPlaceActionButtonController, MKPlaceActionEnvironment, GEOCyclingOptions, MKETAProvider, NSLayoutConstraint, MUScrollViewImpressionsCalculator, NSView, CLLocation, MUContactStore, CNContact, MUPlaceItemActionDataProvider, GEOAutomobileOptions, NSUUID, MKMapItem;
@protocol MUPlaceViewControllerDelegate, MULibraryAccessProviding, _MKPlaceItem, MUPlaceViewControllerMapsAppDelegate, MUPlaceViewControllerFeedbackDelegate, MUContentStackViewProtocol;
...
@interface MUPlaceViewController : _MKUIViewController <_MKPlaceViewControllerDelegate, _MKPlaceViewControllerFeedbackDelegate, MKPlaceCardActionControllerDelegate, MUPlaceSectionControllerDelegate, MKETAProviderDelegate, _MKPlaceViewControllerFeedbackDelegate, MKETAProviderObserver, MUVisibleItemsProvider, MUPlaceCardAnalyticsProvider, MUContactStoreObserver, _MKPlaceCardConforming, MUPlaceCardContentProtocol> {
    ...
    char _needsImpressionsLoggedOnAppearance;
...
@property (readonly, nonatomic) char supportsDynamicLayout;
@property (nonatomic) char showContactActions;
@property (readonly, nonatomic) char shouldStubPlacecard;
...
@property (nonatomic) char forceCaptureRevealEventOnNextBecomeActive;
...
- (char)_hasSerializedMapItemFile;
...
- (void)_openWebURL:(id)a0 forcePunchout:(char)a1;
...
- (void)_setMapItem:(id)a0 contact:(id)a1 updateOriginalContact:(char)a2;
- (void)_setPlaceItem:(id)a0 updateOriginalContact:(char)a1;
...
- (void)libraryAccessProvider:(id)a0 savedStateOfPlaceDidChange:(char)a1;
