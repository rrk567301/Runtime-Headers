...
@property (readonly, nonatomic) char deferLoggingRevealUntilRefinement;
...
- (void)disableDeferLoggingUntilRefinementWithShouldInvokeReveal:(char)a0;
...
- (char)instrumentRevealIfNeededWithImpressionsSessionId:(id)a0;
