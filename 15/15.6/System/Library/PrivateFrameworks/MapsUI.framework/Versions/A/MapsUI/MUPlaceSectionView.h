...
+ (id)cardShadowSectionViewForContentView:(id)a0 sectionHeaderViewModel:(id)a1 sectionFooterViewModel:(id)a2 alwaysInsetContentView:(char)a3;
...
- (id)initWithStyle:(long long)a0 alwaysHideSeparators:(char)a1;
- (id)initWithStyle:(long long)a0 alwaysHideSeparators:(char)a1 sectionHeaderViewModel:(id)a2 sectionFooterViewModel:(id)a3;
