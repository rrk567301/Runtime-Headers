...
@property char canUseCachingServer;
...
+ (id)sessionWithConfiguration:(id)a0 canUseCachingServer:(char)a1 locateOptions:(id)a2;
+ (id)sessionWithConfiguration:(id)a0 canUseCachingServer:(char)a1 locateOptions:(id)a2 delegate:(id)a3 delegateQueue:(id)a4;
...
- (void)_locateCachingServerForURL:(id)a0 isUpload:(char)a1 completionHandler:(id /* block */)a2;
- (void)_onqueue_addTask:(id)a0 forNSURLTask:(id)a1;
- (void)_onqueue_removeTaskForNSURLTask:(id)a0;
- (void)_onqueue_resumeTask:(id)a0;
- (void)_onqueue_task:(id)a0 willUseCachingServer:(char)a1 newRequest:(id)a2 completionHandler:(id /* block */)a3;
- (id)_onqueue_taskForNSURLTask:(id)a0;
- (id)_onqueue_uniqueTasks;
- (void)_removeTask:(id)a0;
- (char)_resumeData:(id)a0 toNSURLResumeData:(id *)a1 originalRequest:(id *)a2 currentRequest:(id *)a3 error:(id *)a4;
...
- (id)initWithConfiguration:(id)a0 canUseCachingServer:(char)a1 locateOptions:(id)a2 delegate:(id)a3 delegateQueue:(id)a4;
