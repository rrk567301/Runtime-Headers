...
- (void)debounceFired:(id)a0 maximumReached:(char)a1;
...
- (void)sensitiveCondition:(int)a0 endedAt:(unsigned long long)a1 ensureClockExists:(char)a2 completion:(id /* block */)a3;
- (void)sensitiveCondition:(int)a0 startedAt:(unsigned long long)a1 ensureClockExists:(char)a2 completion:(id /* block */)a3;
