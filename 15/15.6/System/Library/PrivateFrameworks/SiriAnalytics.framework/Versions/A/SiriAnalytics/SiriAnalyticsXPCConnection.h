...
- (oneway void)vendSandboxExtensionWithResource:(long long)a0 readonly:(char)a1 completion:(id /* block */)a2;
...
- (oneway void)_setKillSwitchEnabled:(char)a0 completion:(id /* block */)a1;
- (void)_vendResource:(long long)a0 readonly:(char)a1 completion:(id /* block */)a2;
- (void)_vendSandboxExtensionWithResource:(long long)a0 readonly:(char)a1 completion:(id /* block */)a2;
...
- (oneway void)setKillSwitchEnabled:(char)a0 completion:(id /* block */)a1;
- (oneway void)vendResource:(long long)a0 readonly:(char)a1 completion:(id /* block */)a2;
