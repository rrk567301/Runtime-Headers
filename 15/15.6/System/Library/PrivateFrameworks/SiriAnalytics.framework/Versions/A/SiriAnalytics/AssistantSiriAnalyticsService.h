...
- (void)handler:(id)a0 setKillSwitchEnabled:(char)a1 completion:(id /* block */)a2;
- (void)handler:(id)a0 unorderedMessagesReceived:(id)a1 topic:(id)a2;
- (void)handler:(id)a0 vendResource:(long long)a1 readonly:(char)a2 completion:(id /* block */)a3;
- (void)handler:(id)a0 vendSandboxExtensionWithResource:(long long)a1 readonly:(char)a2 completion:(id /* block */)a3;
