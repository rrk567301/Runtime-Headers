...
@interface TRIMaintenanceTask : TRIBaseTask <TRIRetryableTask, TRIMetricsProviding> {
    ...
    _PASLock *_lock;
    char _isFlatbufferReadEnabled;
    char _isFlatbufferWriteEnabled;
    char _isFlatbufferTreatmentReadEnabled;
    char _isFlatbufferTreatmentWriteEnabled;
}
...
- (id)_asPersistedTask;
- (char)_cleanupLocalTempStorageWithPaths:(id)a0;
- (char)_cleanupTreatmentWithTreatmentId:(id)a0 paths:(id)a1;
- (char)_cleanupUnusedContentWithContext:(id)a0 nextTasks:(id)a1;
