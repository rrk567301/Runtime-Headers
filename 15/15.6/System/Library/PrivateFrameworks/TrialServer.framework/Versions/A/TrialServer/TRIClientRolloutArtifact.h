...
+ (char)_isStructurallyValidWithRollout:(id)a0 deployment:(id)a1 namespaceNames:(id)a2 populations:(id)a3 deploymentDate:(id)a4;
+ (char)_signature:(id)a0 onData:(id)a1 isValidUsingPublicCertificate:(id)a2;
