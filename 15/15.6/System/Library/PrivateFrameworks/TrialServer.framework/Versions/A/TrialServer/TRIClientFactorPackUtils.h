...
+ (char)_enumerateAssetFactorLevelsInFactorPack:(id)a0 trialAssetBlock:(id /* block */)a1 maAssetBlock:(id /* block */)a2;
...
+ (char)enumerateMetadataForAssetsInFactorPack:(id)a0 flatbufferFactorLevels:(id)a1 assetStore:(id)a2 maProvider:(id)a3 aliasToUnaliasMap:(id)a4 subscribedFactors:(id)a5 ckBlock:(id /* block */)a6 maBlock:(id /* block */)a7;
