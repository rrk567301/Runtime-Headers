...
@interface TRIFetchFactorPackSetTask : TRIBaseTask <TRIRetryableTask, TRIMetricsProviding> {
    ...
    char _isCounterfactualTreatment;
...
+ (id)taskWithFactorPackSetId:(id)a0 treatmentId:(id)a1 isCounterfactualTreatment:(char)a2 taskAttribution:(id)a3 experimentDeployment:(id)a4;
...
- (id)_asPersistedTask;
- (void)_bmltFetchTelemetryIfApplicableWithSuccess:(char)a0 bmltRecord:(id)a1 serverContext:(id)a2;
- (char)_downloadAndSaveCKAssetsWithMetadata:(id)a0 artifactProvider:(id)a1 options:(id)a2 downloadNotificationKey:(id)a3 context:(id)a4 assetsDownloadSize:(unsigned long long *)a5 errorResult:(id *)a6 fetchError:(id *)a7;
- (char)_downloadAndSaveMAAssets:(id)a0 options:(id)a1 downloadNotificationKey:(id)a2 context:(id)a3 assetsDownloadSize:(unsigned long long *)a4 errorResult:(id *)a5 fetchError:(id *)a6;
...
- (char)_saveFactorPackSet:(id)a0 requiredAssetMap:(id)a1 context:(id)a2;
- (id)_subscribedOnDemandFactorsForAssets:(id)a0 factorPackSet:(id)a1 context:(id)a2;
- (id)_taskResultForStatus:(int)a0 reportResultToServer:(char)a1 earliestRetryDate:(id)a2;
- (id)_uniqueUninstalledAssets:(id)a0;
- (char)incompatibleNamespaceNameForBMLT:(id)a0 namespaceDescriptorProvider:(id)a1;
...
- (id)initWithFactorPackSetId:(id)a0 treatmentId:(id)a1 isCounterfactualTreatment:(char)a2 taskAttribution:(id)a3 experimentDeployment:(id)a4;
