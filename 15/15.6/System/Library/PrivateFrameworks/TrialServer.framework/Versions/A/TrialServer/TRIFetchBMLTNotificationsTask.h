...
- (id)_asPersistedTask;
- (void)_mlruntimeNotifiedTelemetryWithRecords:(char)a0 serverContext:(id)a1;
- (char)_processBMLTArtifact:(id)a0 bmltsProcessed:(id)a1 deactivatedBMLTs:(id)a2 targeter:(id)a3 context:(id)a4 taskQueue:(id)a5;
