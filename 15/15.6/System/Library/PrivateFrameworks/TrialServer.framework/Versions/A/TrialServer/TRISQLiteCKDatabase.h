...
- (char)_replaceArrayFieldWithKey:(id)a0 recordType:(id)a1 recordId:(id)a2 values:(id)a3 txn:(id)a4 error:(id *)a5;
- (id)_allRecordTypes;
...
- (char)_evalQueryOperationWithRecordType:(id)a0 predicate:(id)a1 sortDescriptors:(id)a2 offset:(unsigned long long)a3 resultsLimit:(unsigned long long)a4 desiredKeys:(id)a5 txn:(id)a6 error:(id *)a7 recordMatchedBlock:(id /* block */)a8;
- (id)_filenameForLocallyCopiedAsset:(id)a0 forRecordId:(id)a1 error:(id *)a2;
- (id)_keysForFieldsOfRecordType:(id)a0;
- (char)_parseArrayExpression:(id)a0 forRecordType:(id)a1 usingCTEName:(id)a2 toSQLCommonTableExpression:(id *)a3 paramBindings:(id *)a4 error:(id *)a5;
- (char)_parseDecimalString:(id)a0 value:(unsigned long long *)a1;
- (char)_parseDesiredKeys:(id)a0 recordType:(id)a1 unindexedFields:(id *)a2 indexedFields:(id *)a3 error:(id *)a4;
- (id)_parseIndexedFieldKey:(id)a0 indexRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1;
- (char)_parseScalarExpression:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (void)_processFetchRecordsOperation:(id)a0;
- (void)_processQueryOperation:(id)a0;
- (char)_translateAnyModifiedArrayRHSComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateAnyModifiedScalarComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateArrayRHSComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateCompoundPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateDirectModifiedArrayRHSComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateDirectModifiedScalarComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translatePredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_translateScalarComparisonPredicate:(id)a0 forRecordType:(id)a1 toSQLExpr:(id *)a2 paramBindings:(id *)a3 error:(id *)a4;
- (char)_upsertRecord:(id)a0 txn:(id)a1 error:(id *)a2;
