...
+ (id)taskWithExperimentId:(id)a0 deploymentId:(int)a1 failOnUnrecognizedExperiment:(char)a2 triggerEvent:(unsigned long long)a3 taskAttribution:(id)a4;
+ (id)taskWithExperimentId:(id)a0 deploymentId:(int)a1 startTime:(id)a2 failOnUnrecognizedExperiment:(char)a3 triggerEvent:(unsigned long long)a4 taskAttribution:(id)a5;
...
- (char)_purgeRolloutLayerIfNecessaryWithRecord:(id)a0 fromAppContainer:(id)a1 paths:(id)a2;
- (id)_asPersistedTask;
