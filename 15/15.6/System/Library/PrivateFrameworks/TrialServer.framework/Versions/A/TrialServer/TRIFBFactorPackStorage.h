...
- (char)removeUnreferencedFactorLevelsWithRemovedCount:(unsigned int *)a0;
...
- (char)saveFactorLevelsForFactorPack:(id)a0 populatingAssetsForFactorNames:(id)a1 aliasToUnaliasMap:(id)a2 factorLevelsByNamePath:(id *)a3 factorLevelsByIdPath:(id *)a4;
- (char)saveFactorPackToGlobal:(id)a0 forFactorNames:(id)a1 aliasToUnaliasMap:(id)a2;
- (char)updateSavedFactorLevelsWithFactorPackId:(id)a0 namespaceName:(id)a1 deletingAssetsWithFactorNames:(id)a2 inUseAssetBehavior:(unsigned char)a3;
- (char)updateSavedFactorLevelsWithFactorPackId:(id)a0 namespaceName:(id)a1 populatingAssetsForFactorNames:(id)a2 aliasToUnaliasMap:(id)a3;
...
- (void)useNamespaceIdInSchema:(char)a0;
