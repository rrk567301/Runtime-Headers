...
@protocol TRIPurgeableOnDemandFactorsEnumerating, TRIPaths, TRIPurgeableNamespacesProviding, TRIPurgeableExperimentAndRolloutProviding, TRITaskQueuing;
...
- (void)_logDeactivationsMetricWithConcludedInTime:(char)a0;
