...
- (char)_deleteOnDemandAssetsWithFactorNames:(id)a0 treatment:(id)a1 namespace:(id)a2 forRollouts:(char)a3;
...
- (char)_removeFactorsWithDescriptor:(id)a0 descriptorDir:(id)a1 treatmentLayer:(unsigned long long)a2 namespaceName:(id)a3;
...
- (char)_writeFactorLevelsToDisk:(id)a0 namespaceName:(id)a1 writeToPath:(id)a2;
