...
+ (char)isActivityDeferralError:(id)a0;
...
- (void)_fetchExperimentsWithCursor:(id)a0 withNamespaceNames:(id)a1 sinceDate:(id)a2 fetchRollbacksOnly:(char)a3 options:(id)a4 resultsHandler:(id /* block */)a5;
...
- (void)fetchExperimentNotificationsWithNamespaceNames:(id)a0 rollbacksOnly:(char)a1 lastFetchDateOverride:(id)a2 options:(id)a3 completion:(id /* block */)a4;
