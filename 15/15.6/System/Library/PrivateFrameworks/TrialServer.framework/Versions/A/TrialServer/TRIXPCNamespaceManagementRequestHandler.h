...
+ (void)_immediateDownloadForNamespaceNames:(id)a0 usingEntitlementWitness:(id)a1 serverContext:(id)a2 taskQueue:(id)a3 allowExpensiveNetworking:(char)a4 taskAttribution:(id)a5 completion:(id /* block */)a6;
...
+ (void)_removeAssetFactors:(id)a0 usingEntitlementWitness:(id)a1 serverContext:(id)a2 taskQueue:(id)a3 namespace:(id)a4 factorsState:(id)a5 removeImmediately:(char)a6 completion:(id /* block */)a7;
...
- (void)getSandboxExtensionTokensForIdentifierQueryWithCompletion:(id /* block */)a0;
- (void)immediateDownloadForNamespaceNames:(id)a0 allowExpensiveNetworking:(char)a1 completion:(id /* block */)a2;
...
- (void)removeLevelsForFactors:(id)a0 withNamespace:(id)a1 factorsState:(id)a2 removeImmediately:(char)a3 completion:(id /* block */)a4;
...
- (char)_validateNamespaceName:(id)a0 error:(id *)a1;
- (char)_validateSetPurgeabilityLevelRequestUsingFactorProviderChain:(id)a0 paths:(id)a1 purgeabilityLevelsForFactors:(id)a2 error:(id *)a3;
