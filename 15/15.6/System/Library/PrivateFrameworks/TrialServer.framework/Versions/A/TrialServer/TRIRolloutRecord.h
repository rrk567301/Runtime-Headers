...
+ (id)recordWithDeployment:(id)a0 rampId:(id)a1 activeFactorPackSetId:(id)a2 activeTargetingRuleIndex:(id)a3 targetedFactorPackSetId:(id)a4 targetedTargetingRuleIndex:(id)a5 status:(long long)a6 namespaces:(id)a7 isShadow:(char)a8 artifact:(id)a9;
...
- (id)initWithDeployment:(id)a0 rampId:(id)a1 activeFactorPackSetId:(id)a2 activeTargetingRuleIndex:(id)a3 targetedFactorPackSetId:(id)a4 targetedTargetingRuleIndex:(id)a5 status:(long long)a6 namespaces:(id)a7 isShadow:(char)a8 artifact:(id)a9;
