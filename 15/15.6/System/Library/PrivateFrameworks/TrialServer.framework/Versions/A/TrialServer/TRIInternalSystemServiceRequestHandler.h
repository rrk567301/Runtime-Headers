...
- (void)collectGarbageOlderThanNumScans:(unsigned int)a0 deletedAssetSize:(unsigned long long *)a1 ignoreRecentlyCreatedAssets:(char)a2 dryRun:(char)a3 includedCacheDeletableAssetIds:(id)a4 completion:(id /* block */)a5;
- (void)fixFileProtectionForAssetStoreWithCompletion:(id /* block */)a0;
- (void)getOnDemandReferenceCountsPerUserAtGlobalPath:(id)a0 completion:(id /* block */)a1;
...
- (void)referenceMAAutoAssetWithId:(id)a0 futurePath:(id)a1 currentPath:(id)a2 isFileFactor:(char)a3 sourceExtension:(id)a4 completion:(id /* block */)a5;
...
- (void)saveAssetWithIdentifier:(id)a0 sourcePath:(id)a1 flockWitness:(struct TRIFlockWitness_ { int x0; } *)a2 removeSourceOnFailure:(char)a3 sourceExtension:(id)a4 completion:(id /* block */)a5;
...
- (void)writeLowLevelExperimentsData:(id)a0 completion:(id /* block */)a1;
- (char)_getOnDemandReferenceCountsAtGlobalPath:(id)a0 onDemandFactorsPerUser:(id *)a1 error:(id *)a2;
- (char)_updateOnDemandReferenceCountsForUser:(id)a0 atGlobalPath:(id)a1 addingFactors:(id)a2 removingFactors:(id)a3 newlyUnreferencedFactors:(id *)a4;
