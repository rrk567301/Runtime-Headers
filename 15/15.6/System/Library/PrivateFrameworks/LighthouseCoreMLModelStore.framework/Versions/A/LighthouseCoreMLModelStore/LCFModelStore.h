...
- (id)getModelConfig:(id)a0;
- (char)deleteModel:(id)a0;
- (id)getBaseModelURL:(id)a0 modelConfig:(id)a1;
...
- (id)listModelNames;
- (char)markModelTrained:(id)a0;
- (char)setModelMetadata:(id)a0 key:(id)a1 value:(id)a2;
- (id)storeModel:(id)a0;
- (id)storeModel:(id)a0 modelConfig:(id)a1;
