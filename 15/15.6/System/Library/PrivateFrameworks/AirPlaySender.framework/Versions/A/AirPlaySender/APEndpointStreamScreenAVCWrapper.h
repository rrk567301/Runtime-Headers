...
- (void)screenCapture:(id)a0 screenDidClear:(char)a1;
...
- (id)initWithClientPID:(struct __CFNumber { } *)a0 hdrMode:(struct __CFString { } *)a1 presentationMode:(char)a2 hdrMirroringSupported:(char)a3 eventHandlers:(struct { void *x0; void /* function */ *x1; void /* function */ *x2; void /* function */ *x3; void /* function */ *x4; })a4 error:(int *)a5;
- (int)initializeNegotiatorWithMode:(struct __CFString { } *)a0 presentationMode:(char)a1 hdrMirroringSupported:(char)a2;
