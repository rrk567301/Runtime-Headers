...
- (id)networkVersion;
- (short)bindBuffers:(id)a0 toMap:(id)a1 isInput:(char)a2;
...
- (id)initWithMetalContext:(id)a0 url:(id)a1 inputNames:(id)a2 outputNames:(id)a3 tensorSwapNames:(id)a4 reshapeNetworkSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } *)a5 configuration:(id)a6 ANEConfig:(id)a7;
