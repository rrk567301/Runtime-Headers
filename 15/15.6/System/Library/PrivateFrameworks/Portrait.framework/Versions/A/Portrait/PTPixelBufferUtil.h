...
+ (char)isCompressed:(struct __CVBuffer { } *)a0;
+ (id)getMTLTextureFromPixelBuffer:(struct __CVBuffer { } *)a0 device:(id)a1;
+ (unsigned int)pixelBufferToLumaChroma:(id)a0 pixelBuffer:(struct __CVBuffer { } *)a1 outLuma:(id *)a2 outChroma:(id *)a3 read:(char)a4 write:(char)a5;
+ (id)createTextureFromPixelBuffer:(struct __CVBuffer { } *)a0 device:(id)a1 textureCache:(struct __CVMetalTextureCache { } *)a2 sRGB:(char)a3;
...
+ (unsigned int)createTexturesFromPixelBuffer:(struct __CVBuffer { } *)a0 device:(id)a1 outLuma:(id *)a2 outChroma:(id *)a3 read:(char)a4 write:(char)a5;
+ (unsigned int)createTexturesFromPixelBuffer:(struct __CVBuffer { } *)a0 device:(id)a1 textureCache:(struct __CVMetalTextureCache { } *)a2 outLuma:(id *)a3 outChroma:(id *)a4 read:(char)a5 write:(char)a6;
...
+ (char)isPixelBuffer10Bit:(struct __CVBuffer { } *)a0;
+ (char)isPixelBufferFullRange:(struct __CVBuffer { } *)a0;
+ (char)isRGB:(struct __CVBuffer { } *)a0;
...
- (int)writePixelBufferToFile:(id)a0 fileFormat:(id)a1 pixelBuffer:(struct __CVBuffer { } *)a2 pixelWidth:(unsigned int)a3 pixelHeight:(unsigned int)a4 scalingModeTrim:(char)a5;
