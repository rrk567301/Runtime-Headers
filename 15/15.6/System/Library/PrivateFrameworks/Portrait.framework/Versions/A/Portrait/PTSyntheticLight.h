...
@interface PTSyntheticLight : NSObject {
    ...
    char _subjectRelightingRunning;
...
- (id)initWithMetalContext:(id)a0 faceAttributesNetwork:(id)a1 effectUtil:(id)a2 msrColorPyramid:(id)a3 colorSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a4 prewarmOnly:(char)a5 sharedResources:(id)a6;
- (void)interpolateLightIntensity:(float)a0;
- (id)srlV2CoeffsBuffer;
- (void)updateSubjectRelighting:(struct __CVBuffer { } *)a0 inLuma:(id)a1 inChroma:(id)a2 inFaceRects:(struct FaceRectsWrapper { void /* unknown type, empty encoding */ x0[4]; int x1; })a3 runOnAsyncCommandQueue:(char)a4 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a5 dependentCommandBuffer:(id)a6;
