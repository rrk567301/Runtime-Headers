...
@property char outBackgroundReplacementPostProcessingBufferUpdated;
@property struct __CFDictionary { } *detectedObjects;
@property char focusOnAll;
...
@property char outColorBufferWriteSkipped;
@property (retain, nonatomic) id<MTLTexture> inBilbyAlphaMaskTexture;
@property unsigned long long presenterOverlayMode;
@property char suppressGestureTriggeredReactions;
@property char bilbyFloatingMode;
