...
+ (unsigned int)orientationFromTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 inverse:(char)a1;
+ (struct { void /* unknown type, empty encoding */ x0[4]; })perspectiveProjectionFieldOfView:(SEL)a0 aspectRatio:(float)a1 depthNearFar:(float)a2 reverseZ:(char)a3;
+ (struct { void /* unknown type, empty encoding */ x0[4]; })perspectiveProjectionFromIntrinsics:(SEL)a0 colorSize:(struct { void /* unknown type, empty encoding */ x0[3]; })a1 depthNearFar:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a2 reverseZ:(char)a3;
+ (struct { void /* unknown type, empty encoding */ x0[4]; })projectionMatrixForOrientation:(SEL)a0 intrinsics:(int)a1 fromImageSize:(struct { void /* unknown type, empty encoding */ x0[3]; })a2 viewportSize:(struct CGSize { double x0; double x1; })a3 reverseZ:(struct CGSize { double x0; double x1; })a4 depthNearFar:(char)a5;
...
- (int)renderDisparity:(id)a0 inDisparity:(id)a1 outYUV:(id)a2 region:(struct PTRegion { struct PTSize { unsigned short x0; unsigned short x1; } x0; })a3 drawLegend:(char)a4;
