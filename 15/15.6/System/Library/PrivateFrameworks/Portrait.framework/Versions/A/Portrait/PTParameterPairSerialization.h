...
+ (float)getFloatParameter:(unsigned short)a0 fromPairs:(const struct { unsigned short x0; unsigned short x1; union { float x0; int x1; unsigned int x2; } x2; } *)a1 numPairs:(unsigned int)a2 didFindValue:(char *)a3;
...
+ (unsigned int)getUIntParameter:(unsigned short)a0 fromPairs:(const struct { unsigned short x0; unsigned short x1; union { float x0; int x1; unsigned int x2; } x2; } *)a1 numPairs:(unsigned int)a2 didFindValue:(char *)a3;
+ (unsigned int)getUIntParameter:(unsigned short)a0 fromPairs:(const struct { unsigned short x0; unsigned short x1; union { float x0; int x1; unsigned int x2; } x2; } *)a1 numPairs:(unsigned int)a2 withDefault:(unsigned int)a3 didFindValue:(char *)a4;
