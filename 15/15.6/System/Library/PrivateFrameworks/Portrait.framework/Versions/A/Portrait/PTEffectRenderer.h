...
@interface PTEffectRenderer : NSObject {
    ...
    char _runCVMNetworkPreviousFrame;
    char _renderStudioLightPreviousFrame;
    char _renderSegmentationPreviousFrame;
    ...
    char _externalHandDetectionsAvailable;
    ...
    char _studiolightFromSegmentation;
}

@property long long effectQuality;

+ (char)useStudioLightFromSegmentation:(id)a0;
...
- (id)activeReactions;
- (char)isRenderRequiredForRequest:(id)a0;
...
- (id)initWithDescriptor:(id)a0 metalContext:(id)a1 useHighResNetwork:(char)a2 faceAttributesNetwork:(id)a3 humanDetections:(id)a4 prevTemporalState:(id)a5 asyncInitQueue:(id)a6 sharedResources:(id)a7;
...
- (int)render:(id)a0 waitUntilCompleted:(char)a1 gpuCompleted:(id /* block */)a2;
