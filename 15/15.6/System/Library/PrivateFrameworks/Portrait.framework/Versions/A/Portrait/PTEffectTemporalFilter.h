...
- (unsigned int)filter:(id)a0 inDisparity:(id)a1 inNormal:(id)a2 filterNormalSpatial:(char)a3 frameIndex:(int)a4 disparityScale:(float)a5;
- (unsigned int)filter:(id)a0 inDisparity:(id)a1 inNormal:(id)a2 inDiffuse:(id)a3 filterNormalSpatial:(char)a4 filterDiffuseSpatial:(char)a5 frameIndex:(int)a6 disparityScale:(float)a7;
