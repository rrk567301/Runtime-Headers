...
- (id)initWithFrameSize:(struct CGSize { double x0; double x1; })a0 sharedResources:(id)a1 asyncInitQueue:(id)a2 externalHandDetectionsEnabled:(char)a3;
- (char)runGestureDetectionForTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (void)updateWithFrame:(struct __CVBuffer { } *)a0 withTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 withRotationDegrees:(int)a2 withDetectedHands:(id)a3 withDetectedFaces:(id)a4 asyncWork:(id)a5;
