...
- (id)initWithUserBackgrounds:(char)a0;
...
- (id)asyncWorkerQueue;
- (char)copyAsFullsizeAndThumbnailFromPixelBuffer:(struct __CVBuffer { } *)a0 outputPathFullsize:(id)a1 outputPathThumbnail:(id)a2;
