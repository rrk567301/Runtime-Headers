@class PTMetalContext, PTGuidedFilter, PTMSRResize;
...
- (unsigned int)reset;
- (id)debugTextures;
- (id)initWithMetalContext:(id)a0 colorSize:(struct CGSize { double x0; double x1; })a1 msrColorPyramid:(id)a2 cvmNetwork:(id)a3 effectQuality:(long long)a4 prewarmOnly:(char)a5 sharedResources:(id)a6;
- (int)runPersonSegmentationToOutPersonSegmentationMatteBuffer:(id)a0 inRGBA:(struct __CVBuffer { } *)a1 outUpscaledSegmentation:(id)a2;
