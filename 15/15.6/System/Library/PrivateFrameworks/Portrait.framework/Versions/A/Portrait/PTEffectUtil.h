...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })rotateNormalizedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 inverse:(char)a2;
...
- (void)updateFocusObjectWithFaceRectCount:(int)a0 disparityFocusOffsetSDOF:(struct PTDisparityFocusOffset { float x0; float x1; })a1 disparityFocusOffsetReactions:(struct PTDisparityFocusOffset { float x0; float x1; })a2 disparityFocusOffsetStudioLight:(struct PTDisparityFocusOffset { float x0; float x1; })a3 exponentialMovingAverageSDOF:(float)a4 exponentialMovingAverageStudioLight:(float)a5 faceRectsState:(int *)a6 isFirstFrame:(char)a7 emitNewReaction:(char)a8 focusOnAll:(char)a9 lastFocus:(id)a10 inFaceDisparityArray:(id)a11 outDisparityModifiers:(id)a12 outDisparityFocus:(id)a13 outStudioLightEffectModifier:(id)a14 outUseDisparityBufferForReactions:(id)a15;
