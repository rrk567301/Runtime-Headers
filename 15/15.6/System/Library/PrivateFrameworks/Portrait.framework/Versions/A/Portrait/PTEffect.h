...
- (id)initWithFormat:(struct opaqueCMFormatDescription { } *)a0 metalCommandQueue:(id)a1 availableEffectTypes:(unsigned long long)a2 activeEffectType:(unsigned long long)a3 prewarmOnly:(char)a4 effectQuality:(long long)a5;
- (void)keepOldDelegateAlive:(id)a0;
- (void)removeAllActiveReactions;
- (int)renderReaction:(id)a0 effectRenderRequest:(id)a1;
- (int)updateEffectDelegate:(char)a0;
- (char)validPixelBuffer:(struct __CVBuffer { } *)a0;
- (int)validateRenderRequest:(id)a0 reactionOnly:(char)a1;
