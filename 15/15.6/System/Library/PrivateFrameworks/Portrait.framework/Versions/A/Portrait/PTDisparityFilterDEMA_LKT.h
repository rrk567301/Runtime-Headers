@class PTMetalContext, NSString, PTGlobalReduction, NSArray, PTOpticalFlow;
@protocol MTLComputePipelineState, MTLBuffer, MTLSamplerState;
...
- (id)initWithMetalContext:(id)a0 sensorPort:(id)a1;
