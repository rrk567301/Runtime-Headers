...
@interface PTCinematographyScript : NSObject {
    char _framesAreMutable;
    char _baseDecisionsAreMutable;
...
@property (nonatomic) char didInternalizeTracks;
...
- (char)focusOnGroupIdentifier:(long long)a0 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 strong:(char)a2;
- (char)focusOnTrack:(id)a0 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 strong:(char)a2;
- (char)focusOnTrackIdentifier:(long long)a0 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 strong:(char)a2;
...
- (void)_internalizeLoadedFrames:(id)a0 changesDictionary:(id)a1 reloading:(char)a2;
...
- (char)_isEditCreatedTrack:(id)a0;
...
- (char)_loadWithAsset:(id)a0 changesDictionary:(id)a1 error:(id *)a2;
...
- (char)_removeUserDecision:(id)a0;
- (char)_resolveIfGroupDecision:(id)a0;
- (char)_shouldAddTrackDecision:(id)a0 afterDecision:(id)a1;
...
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })_timeRangeOfTransitionfromDecision:(id)a0 toDecision:(id)a1 didShortenTransition:(char *)a2;
...
- (id)_userDecisionToFocusOnDetection:(id)a0 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 strong:(char)a2 group:(char)a3;
...
- (char)focusOnDetection:(id)a0 strong:(char)a1;
- (void)setBaseDecisionsAreMutable:(char)a0;
- (void)setFramesAreMutable:(char)a0;
