...
@property (readonly, nonatomic) char isReadyForReading;
...
- (id)nextFrame;
- (char)startReadingFrames:(unsigned long long)a0 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 error:(id *)a2;
...
- (char)startReadingFrames:(unsigned long long)a0 error:(id *)a1;
- (char)updateFormatPropertiesFromAsset:(id)a0;
