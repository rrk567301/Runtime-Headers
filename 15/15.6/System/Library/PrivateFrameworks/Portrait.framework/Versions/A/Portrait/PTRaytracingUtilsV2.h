...
+ (struct PTFocus { float x0; float x1; float x2; float x3; float x4; float x5; })createFocusObject:(SEL)a0 pyramidSamplingFraction:(id)a1 anamorphicFactor:(float)a2 rayCount:(float)a3 colorSize:(int)a4 doMacroApertureLimit:(char)a5;
