...
@interface PTHandGestureDetector : NSObject {
    ...
    char _useExternalHandDetections;
...
- (id)initWithFrameSize:(struct CGSize { double x0; double x1; })a0 asyncInitQueue:(id)a1 externalHandDetectionsEnabled:(char)a2;
- (char)detectGesturesFromBuffer:(struct __CVBuffer { } *)a0 timeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 withRotationDegrees:(int)a2 withDetectedHands:(id)a3 withDetectedFaces:(id)a4 asyncWork:(id)a5;
