...
@property (nonatomic) char needConversionBGRA2YUVA;
...
@property (nonatomic) char isBidirectional;
@property (nonatomic) char isInverse;
...
- (int)_computeOpticalFlow:(id)a0 computeFeatureI0:(char)a1 computeFeatureI1:(char)a2;
...
- (int)estimateFlowStreamTex:(id)a0 index:(int)a1 doOpticalFlow:(char)a2 commandBuffer:(id)a3;
