@class PTCinematographyFocusBlend, NSString, PTCinematographyDetection, NSArray, NSSet, NSNumber, NSDictionary;
...
@property (nonatomic, getter=isUserFocusStrong) char userFocusStrong;
@property (nonatomic, getter=isUserFocusGroup) char userFocusGroup;
@property (nonatomic, getter=isUserFocusEnd) char userFocusEnd;
...
- (char)_copyToFrameHeaderData_0:(struct FrameHeaderData_0 { unsigned long long x0; unsigned long long x1; unsigned long long x2; float x3; float x4; float x5; float x6; float x7; float x8; unsigned int x9; } *)a0;
...
- (char)_writeHeaderToAtomWriter:(id)a0 options:(id)a1;
