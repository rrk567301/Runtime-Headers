...
- (id)initWithMetalContext:(id)a0 faceAttributesNetwork:(id)a1 availableEffectTypes:(unsigned long long)a2 effectUtil:(id)a3 util:(id)a4 prewarmOnly:(char)a5 colorSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a6 msrColorPyramid:(id)a7 studiolightFromSegmentation:(char)a8 sharedResources:(id)a9;
