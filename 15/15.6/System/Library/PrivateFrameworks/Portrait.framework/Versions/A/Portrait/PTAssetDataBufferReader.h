...
@property (readonly, nonatomic) char isVector3Format;
...
- (id)globals;
- (char)_startReadingSequenceWithError:(id *)a0;
- (id)_copyNextFrame_movie;
- (id)_copyNextFrame_sequence;
- (struct __CVBuffer { } *)_copyPixelBufferFromURL:(id)a0;
- (id)_frameInstance;
- (char)_startReadingMovieWithError:(id *)a0;
- (id)copyNextFrame;
- (char)startReadingWithError:(id *)a0;
