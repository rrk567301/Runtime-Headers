...
- (struct OpaqueFigEndpoint { } *)copyEndpointWithDeviceID:(struct __CFString { } *)a0 isStreamID:(char)a1 managerType:(struct __CFString { } *)a2 routingContextUUID:(struct __CFString { } *)a3;
