...
+ (char)_isSelectionRectTheCursor:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
+ (char)_isValidSelectionRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (char)hasOpenEndedAdjust;
- (char)includeTextListMarkersInInlineResults;
...
- (char)panelShowsAnchor;
- (id)servicesMenuRequestor;
- (id)textInputClientAsync;
- (char)textViewWantsInlineEditing;
