...
@property (nonatomic) char needsSelectionTrackingAreaUpdate;
@property (nonatomic) char allowedToShow;
...
+ (char)mustEnterSelectionAreaFirstToShowDebug;
+ (char)mustPauseOnSelectionAreaToShowDebug;
...
- (void)fadeAffordanceViewWithIsFadeIn:(char)a0;
