...
+ (char)_delegateImplementsInsertionMethods:(id)a0;
+ (char)_delegateImplementsRemovalMethods:(id)a0;
...
- (void)updateIsTextVisible:(char)a0 forChunk:(id)a1 completion:(id /* block */)a2;
...
- (double)_widthRatioForIteration:(int)a0 isFinal:(char)a1;
- (void)beginPlaceholder;
- (void)endPlaceholderAndWillInsertText:(char)a0 completion:(id /* block */)a1;
