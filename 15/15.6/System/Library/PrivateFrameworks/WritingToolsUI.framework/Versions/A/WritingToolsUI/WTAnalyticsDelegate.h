...
@property char fromSmartReply;
@property char isEditableText;
...
- (id)initWithSmartReplyBool:(char)a0 smartReplyConfig:(id)a1 analyticsUUID:(id)a2 requestedTool:(long long)a3 isEditable:(char)a4;
- (void)sendWritingToolsOnlySignal:(id)a0 withPayload:(id)a1;
- (void)sendWritingToolsOrSmartReplySignal:(id)a0 withPayload:(id)a1;
- (void)writingToolsDidUpdateKeyboardPosition:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 preferredContentSizeChanging:(char)a1;
