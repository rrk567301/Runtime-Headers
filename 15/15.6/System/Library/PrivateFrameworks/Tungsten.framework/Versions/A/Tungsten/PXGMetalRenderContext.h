...
@property (nonatomic) char wantsUniformThreadgroups;
@property (readonly, nonatomic) id<MTLDevice> device;
@property (readonly, nonatomic) id<MTLLibrary> library;
@property (readonly, nonatomic) id<MTLCommandQueue> commandQueue;
@property (readonly, nonatomic) char supportsSharedTextures;
@property (readonly, nonatomic) char wantsMutableSharedTextures;

+ (id)privateContextWithDevice:(id)a0;
+ (id)privateContextWithDevice:(id)a0 commandQueue:(id)a1;
+ (char)deviceSupportsSharedTextures;
...
- (void)_blitFromTexture:(id)a0 toTexture:(id)a1 mipmapped:(char)a2;
