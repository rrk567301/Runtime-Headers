...
- (void)CSVoiceTriggerAssetDownloadMonitor:(id)a0 didInstallNewAsset:(char)a1;
...
- (id)initWithDisableOnDeviceCompilation:(char)a0;
- (id)initWithVoiceTriggerAssetDownloadMonitor:(id)a0 languageCodeUpdateMonitor:(id)a1 uafAssetDownloadMonitor:(id)a2 assetManager:(id)a3 uafAssetManager:(id)a4 disableOnDeviceCompilation:(char)a5;
