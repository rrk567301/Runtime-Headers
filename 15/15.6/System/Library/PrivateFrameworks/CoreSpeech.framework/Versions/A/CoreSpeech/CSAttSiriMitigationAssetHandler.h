...
@property (nonatomic) char overrideEnabled;
...
- (id)initWithAssetManager:(id)a0 withUAFAssetManager:(id)a1 withUAFDownloadMonitor:(id)a2 withLanguageCodeUpdateMonitor:(id)a3 withAssetOverrideFlag:(char)a4 withOverrideAssetPath:(id)a5;
- (id)initWithAssetManager:(id)a0 withUAFAssetManager:(id)a1 withUAFDownloadMonitor:(id)a2 withLanguageCodeUpdateMonitor:(id)a3 withAssetOverrideFlag:(char)a4 withOverrideAssetPath:(id)a5 disableOnDeviceCompilation:(char)a6;
