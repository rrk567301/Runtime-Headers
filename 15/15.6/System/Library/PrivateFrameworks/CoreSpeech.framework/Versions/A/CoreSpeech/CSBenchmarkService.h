...
+ (void)benchmarkOnDeviceCompilationCleanup:(id /* block */)a0;
+ (id)createBenchamrkXPCConnection;
+ (char)disableBenchmarkService;
+ (char)enableBenchmarkService;
...
+ (void)runNCModelWithConfig:(id)a0 completion:(id /* block */)a1;
