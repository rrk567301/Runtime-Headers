...
@interface CSSmartSiriVolume : NSObject <CSMediaPlayingMonitorDelegate, CSAudioStreamProvidingDelegate, CSAudioServerCrashMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSSmartSiriVolumeProcessor> {
    ...
    char _shouldPauseSSVProcess;
    char _shouldPauseLKFSProcess;
    char _alarmSoundIsFiring;
    char _timerSoundIsFiring;
    char _mediaIsPlaying;
...
- (void)prepareSoundLevelBufferFromSamples:(id)a0 soundType:(long long)a1 firedVoiceTriggerEvent:(char)a2 triggerStartTimeSampleOffset:(unsigned long long)a3 triggerEndTimeSampleOffset:(unsigned long long)a4;
