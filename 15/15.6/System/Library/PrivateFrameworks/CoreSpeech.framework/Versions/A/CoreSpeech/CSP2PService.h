...
- (char)fileURL:(id)a0 matchesFileNamePattern:(id)a1;
- (void)_compressFilesInDirectory:(id)a0 matchingPredicate:(id)a1 compressedFileAvailable:(id /* block */)a2;
- (void)_compressFilesInDirectory:(id)a0 matchingPredicate:(id)a1 sortedByCreationDate:(char)a2 compressedFileAvailable:(id /* block */)a3;
...
- (void)_sendGradingData:(id)a0 withFileName:(id)a1 toPeerId:(id)a2 withCompressedFlag:(char)a3 withUncompressedDataSize:(unsigned long long)a4 withBatchId:(id)a5 withRetainFileFlag:(char)a6 withFilePrefix:(id)a7;
- (id)_sendGradingData:(id)a0 withFileName:(id)a1 toPeerId:(id)a2 withCompressedFlag:(char)a3 withUncompressedDataSize:(unsigned long long)a4 withBatchId:(id)a5 withRetainFileFlag:(char)a6 withFilePrefix:(id)a7 withCompletion:(id /* block */)a8;
...
- (char)isHeadlessDeviceDataCollectionModeEnabled;
- (char)isInternalWithoutProfile;
...
- (char)shouldTransferVoiceTriggerLogFileWithURL:(id)a0;
