...
- (char)createRemoteVoiceProfileWithAudioFiles:(id)a0 aesKey:(id)a1 encryptedAudioSampleBypeDepth:(unsigned long long)a2 languageCode:(id)a3 completion:(id /* block */)a4;
...
- (char)isConnectedDeviceDarwin;
- (char)isConnectedDeviceGibraltar;
- (void)notifyBluetoothWirelessSplitterStateChanged:(unsigned long long)a0 shouldDisableSpeakerVerificationInSplitterMode:(char)a1;
...
- (void)setSelfTriggerEnable:(char)a0 withCompletion:(id /* block */)a1;
- (void)setUserSelectedVoiceTriggerPhraseType:(unsigned long long)a0;
- (void)setVoiceTriggerEnable:(char)a0 withCompletion:(id /* block */)a1;
- (char)transferInterstitialAudioFiles:(id)a0 interstitialLevel:(long long)a1 completion:(id /* block */)a2;
- (void)transferVoiceTriggerAsset:(id)a0 forLanguageCode:(id)a1 completion:(id /* block */)a2;
- (char)transferVoiceTriggerSpeakerModel:(id)a0 forAsset:(id)a1;
- (void)voiceTriggerEnabledWithCompletion:(id /* block */)a0;
- (char)waitingForConnection:(double)a0 error:(id *)a1;
