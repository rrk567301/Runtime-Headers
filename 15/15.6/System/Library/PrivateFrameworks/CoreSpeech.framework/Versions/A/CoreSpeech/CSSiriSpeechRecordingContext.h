@class CSAudioRecordContext, NSString, CSSiriRecordingInfo, NSURL, NSUUID, NSMutableDictionary, NSDictionary, CSSiriAudioMessageRequestClient, NSObject, NSMutableSet, CSSiriAudioFileWriter, CSFAudioRecordDeviceInfo;
...
@interface CSSiriSpeechRecordingContext : NSObject {
    ...
    char _voiceIdentificationTraining_allowsWithoutResultCandidate;
    ...
    char _stopRecordingInstrumented;
    char _shouldUseLocalFileWriter;
    CSSiriAudioMessageRequestClient *_audioMessageRequestClient;
}

@property (readonly, copy, nonatomic) NSString *sessionUUID;
@property (readonly, nonatomic) char wantsRecordedAudioBufferLogs;
...
- (char)allowContinuousConversation;
...
- (void)emitRequestLinkEventForRtsSessionId:(id)a0;
...
- (void)updateAccessToRecordedAudioForVoiceIdentificationTraining:(char)a0 forResultCandidateId:(id)a1 sharedUserId:(id)a2;
