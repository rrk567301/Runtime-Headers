...
- (id)initWithTotalAudioRecorded:(double)a0 endpointBufferHostTime:(unsigned long long)a1 featuresAtEndpoint:(id)a2 endpointerType:(long long)a3 asrFeatureLatencyDistribution:(id)a4 additionalMetrics:(id)a5 trailingSilenceDurationAtEndpoint:(double)a6 requestId:(id)a7 osdFeatures:(id)a8 asrFeatures:(id)a9 isRequestTimeOut:(char)a10 assetConfigVersion:(id)a11 blkHepAudioOrigin:(double)a12 vtExtraAudioAtStartInMs:(double)a13 firstAudioSampleSensorTimestamp:(unsigned long long)a14 isAnchorTimeBuffered:(char)a15 endpointHostTime:(unsigned long long)a16 audioDeliveryHostTimeDelta:(unsigned long long)a17;
