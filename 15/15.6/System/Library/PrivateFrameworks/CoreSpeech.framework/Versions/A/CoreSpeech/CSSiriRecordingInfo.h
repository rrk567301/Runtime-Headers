...
@property (readonly, nonatomic) char isDictation;
@property (readonly, nonatomic) char isFingerprintOnly;
@property (readonly, nonatomic) char isSecureOfflineOnly;
@property (readonly, nonatomic) long long audioAlertStyle;
@property (readonly, nonatomic) NSString *codec;
@property (readonly, nonatomic) char codecIsNarrowband;
...
@property (readonly, nonatomic) char isBluetooth;
...
@property (nonatomic) char isEndAlertInfo;
@property (nonatomic) char triggeredTwoShotBorealis;
...
- (void)_fetchBTInfo;
- (id)initWithDictation:(char)a0 codec:(id)a1;
- (id)initWithDictation:(char)a0 fingerprintOnly:(char)a1 secureOfflineOnly:(char)a2 audioAlertStyle:(long long)a3 recordSettings:(id)a4 recordRoute:(id)a5 recordDeviceInfo:(id)a6 playbackRoute:(id)a7 audioDeviceID:(unsigned int)a8 voiceTriggerEventInfo:(id)a9 activationAlertStartTimestamp:(double)a10 startRecordingTimestamp:(double)a11 firstBufferTimestamp:(double)a12 firstBufferHostTime:(unsigned long long)a13 estimatedSpeechEndHostTime:(unsigned long long)a14 deviceIdentifier:(id)a15 includeBTInfo:(char)a16 speechEvent:(long long)a17;
