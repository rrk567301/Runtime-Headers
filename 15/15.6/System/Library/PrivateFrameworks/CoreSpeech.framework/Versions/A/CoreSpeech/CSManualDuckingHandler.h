...
- (id)init;
- (void).cxx_destruct;
- (void)_audioDeviceDuckWithAudioDeviceID:(unsigned int)a0 duckedLevel:(float)a1 rampDuration:(float)a2;
- (void)defaultAudioRouteChangeMonitorMac:(id)a0 didReceivedInputAudioRouteChangeEvent:(char)a1;
- (void)defaultAudioRouteChangeMonitorMac:(id)a0 didReceivedOutputAudioRouteChangeEvent:(char)a1;
