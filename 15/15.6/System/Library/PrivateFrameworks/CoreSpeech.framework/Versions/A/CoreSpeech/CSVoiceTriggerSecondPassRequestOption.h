...
@property (readonly, nonatomic) char isSecondChanceRun;
...
- (void).cxx_destruct;
- (id)initWithFirstPassSource:(unsigned long long)a0 deviceId:(id)a1 audioProviderUUID:(id)a2 firstPassInfo:(id)a3 rejectionMHUUID:(id)a4 isSecondChanceRun:(char)a5 firstpassMetrics:(id)a6 rtModelRequestOptions:(id)a7;
