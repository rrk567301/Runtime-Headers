...
+ (id)generateEmptyPHash:(unsigned long long)a0 writeFile:(char)a1;
...
+ (char)writeHashResultIntoFile:(id)a0;
+ (char)writeHashlessResult:(unsigned long long)a0;
...
- (id)_generateMyriadInfo:(unsigned long long)a0 hsStart:(unsigned long long)a1 triggerEnd:(unsigned long long)a2 writeFile:(char)a3 score:(float)a4 triggerSource:(id)a5 channel:(unsigned long long)a6 audioProviderUUID:(id)a7 absoluteTime:(unsigned long long)a8;
- (double)_signalEstimate:(float *)a0 length:(unsigned long long)a1;
- (void)_surfacePsdWithAudioChunk:(id)a0;
- (id)cachedHash;
- (id)generatePHashFromExclaveVoiceTriggerInfo:(id)a0 writeFile:(char)a1;
- (id)generatePHashFromVoiceTriggerInfo:(id)a0 writeFile:(char)a1;
- (unsigned short)pHash:(float *)a0 length:(int)a1;
- (unsigned char)sigFrac:(double)a0;
- (unsigned char)sigNorm:(double)a0;
