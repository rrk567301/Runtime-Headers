...
- (void)_handleEnabledPolicyEventForAudioSourceType:(unsigned long long)a0 enabled:(char)a1;
- (void)_handleEnabledStatesUpdate:(id)a0;
- (id)initWithTargetQueue:(id)a0 audioTapProvider:(id)a1 avvcRefChannelAvailable:(char)a2;
