...
@property (nonatomic) char isAPHearstFirstPassEnabled;
...
- (void)_transitHearstAPEnable:(char)a0;
...
- (void)opportuneSpeakEventMonitor:(id)a0 didStreamStateChanged:(char)a1;
