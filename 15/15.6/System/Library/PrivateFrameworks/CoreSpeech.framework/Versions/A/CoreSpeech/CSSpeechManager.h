...
@property (nonatomic) char isExclaveHardware;
...
- (char)_isAVVCRefChannelAvailable;
- (void)_mapAssetToExclaveKit:(id)a0 completion:(id /* block */)a1;
- (id)_myriadSelfTriggerCoordinatorIfNeeded:(char)a0;
- (id)_preMyriadCoordinatorCreateIfNeeded:(char)a0;
- (char)_prepareForBluetoothDeviceWithDeviceType:(unsigned long long)a0;
...
- (id)_voiceTriggerEventNotifierCreateIfNeeded:(char)a0;
- (id)_voiceTriggerFileLoggerCreateIfNeeded:(char)a0;
...
- (id)initWithExclaveHardware:(char)a0 assetHandler:(id)a1;
