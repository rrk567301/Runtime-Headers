...
- (void)_stopAllRequests:(char)a0 completion:(id /* block */)a1;
- (void)_stopAllRequestsSynchronously;
- (void)_stopRequest:(id)a0 immediately:(char)a1;
...
- (void)stopAllRequests:(char)a0 completion:(id /* block */)a1;
- (void)stopAllRequestsSynchronously;
- (void)stopRequest:(id)a0 immediately:(char)a1;
