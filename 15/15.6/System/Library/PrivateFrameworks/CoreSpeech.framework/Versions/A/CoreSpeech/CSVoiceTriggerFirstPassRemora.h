...
- (void)_setIsSecondPassing:(char)a0 forDeviceId:(id)a1;
- (void)accessorySiriClientBehaviorMonitor:(id)a0 didStartStreamWithContext:(id)a1 successfully:(char)a2 option:(id)a3 withEventUUID:(id)a4 forAccessory:(id)a5;
