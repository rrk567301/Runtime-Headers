...
@property (nonatomic) char hasReceivedNDEAPIResult;
...
- (id)initWithAsset:(id)a0 assetConfig:(id)a1 firstPassSource:(unsigned long long)a2 activeChannel:(unsigned long long)a3 siriLanguage:(id)a4 shouldEnableShadowMicScore:(char)a5 rtmodelRequestOptions:(id)a6;
