...
- (void)_handleEndInterruption:(char)a0;
- (char)_prepareWithOptions:(unsigned long long)a0 error:(id *)a1;
...
- (void)handleEndInterruption:(char)a0;
...
- (void)stop:(char)a0 completion:(id /* block */)a1;
