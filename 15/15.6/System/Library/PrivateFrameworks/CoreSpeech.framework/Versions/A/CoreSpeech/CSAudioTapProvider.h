...
@interface CSAudioTapProvider : NSObject <CSAudioServerCrashMonitorDelegate, CSSystemDaemonStateMonitorDelegate, CSAudioStreamProviding> {
...
- (char)_setupRecordingAudioQueueIfNeededWithOption:(id)a0;
