...
- (char)_shouldIgnoreVoiceTriggerEvent:(id)a0;
...
- (char)_isVoiceTriggerFromHearst:(id)a0;
- (char)_isVoiceTriggerFromRemora:(id)a0;
...
- (void)_notifyRemoteTriggerEvent:(id)a0 myriadHash:(id)a1 remoteTriggerType:(unsigned long long)a2 remoteDeviceId:(id)a3 isTriggeredFromFullWake:(char)a4 completion:(id /* block */)a5;
...
- (void)voiceTriggerDidDetectKeyword:(id)a0 myriadHash:(id)a1 remoteTriggerType:(unsigned long long)a2 remoteDeviceId:(id)a3 isTriggeredFromFullWake:(char)a4 completion:(id /* block */)a5;
