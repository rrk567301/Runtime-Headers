...
@property (readonly, nonatomic, getter=isPurchased) char purchased;
@property (readonly, nonatomic, getter=isRingtone) char ringtone;
@property (readonly, nonatomic) NSString *artworkFile;
@property (readonly, nonatomic) double duration;
@property (readonly, nonatomic, getter=isProtectedContent) char protectedContent;
@property (readonly, nonatomic, getter=isPrivateTone) char privateTone;
