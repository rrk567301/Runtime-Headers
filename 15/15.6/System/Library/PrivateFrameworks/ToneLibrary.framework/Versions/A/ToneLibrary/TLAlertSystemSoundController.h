...
+ (id)_optionsForSystemSoundAlert:(id)a0 withSound:(id)a1 isDeemphasized:(char)a2;
+ (unsigned int)_soundBehaviorForAlert:(id)a0 withSound:(id)a1 isDeemphasized:(char)a2;
...
- (struct { long long x0; char x1; char x2; })_considerDeferringPlayingAlertForBacklightStatusResolution:(id)a0 alertSystemSoundContext:(id)a1;
...
- (void)_playAlert:(id)a0 alertSystemSoundContext:(id)a1 toneIdentifierForDeemphasizingAlert:(id)a2 backlightStatusResolutionDeferralContext:(struct { long long x0; char x1; char x2; })a3;
...
- (void)_removeAlert:(id)a0 alertSystemSoundContext:(id)a1 didFailToPrepareSound:(char)a2 appendingPlaybackCompletionContextToArray:(id)a3;
