...
@property (readonly, nonatomic, getter=isDeemphasized) char deemphasized;
@property (readonly, nonatomic) TLAlertSystemSoundContext *alertSystemSoundContext;

- (void).cxx_destruct;
- (id)initWithAlert:(id)a0 sound:(id)a1 isDeemphasized:(char)a2 alertSystemSoundContext:(id)a3;
