...
+ (char)_ensureTCCAccessPreflightAndCheckForFileExistenceAtPath:(id)a0;
...
- (id)_nameForToneIdentifier:(id)a0 isValid:(char *)a1;
...
- (id)_currentToneIdentifierForAlertType:(long long)a0 topic:(id)a1 allowsFallbackToDefaultPreferablyNonSilentToneForInvalidPersistedValue:(char)a2;
...
- (id)_filePathForToneIdentifier:(id)a0 isValid:(char *)a1;
...
- (char)_hasUnderlyingPlaybackArchiveForToneIdentifier:(id)a0;
- (unsigned long long)_installedTonesSize;
- (char)_loadITunesRingtoneInfoPlistAtPath:(id)a0;
...
- (void)_reloadTones;
- (char)_setToneIdentifierUsingService:(id)a0 keyedByTopic:(id)a1 forPreferenceKey:(id)a2;
...
- (id)_toneIdentifierForFileAtPath:(id)a0 isValid:(char *)a1;
- (id)_toneIdentifierWithUnderlyingPlaybackArchive:(id)a0;
- (id)_tonePreferencesFromService;
- (id)_toneWithIdentifier:(id)a0;
- (char)_toneWithIdentifierIsAlarmWakeUp:(id)a0;
- (char)_toneWithIdentifierIsDefaultRingtone:(id)a0;
- (char)_toneWithIdentifierIsITunesRingtone:(id)a0;
- (char)_toneWithIdentifierIsMediaPlaybackArchive:(id)a0;
- (char)_toneWithIdentifierIsNonDefaultAndNonEmbeddedSystemRingtone:(id)a0;
- (char)_toneWithIdentifierIsNonDefaultSystemRingtone:(id)a0;
- (char)_toneWithIdentifierIsSystemTone:(id)a0;
- (char)_toneWithIdentifierIsValid:(id)a0;
...
- (char)hasSpecificDefaultToneIdentifierForAlertType:(long long)a0 topic:(id)a1;
...
- (char)toneWithIdentifierIsValid:(id)a0;
