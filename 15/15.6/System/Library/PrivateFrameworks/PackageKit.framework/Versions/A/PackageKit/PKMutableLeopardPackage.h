...
- (char)_createUpdatePayloadAtPath:(id)a0 fromBaseline:(id)a1 toNew:(id)a2 currentPrefix:(id)a3 currentComponent:(id)a4 componentMap:(id)a5 tempDir:(id)a6 totalPayloadSize:(unsigned long long *)a7 didCreate:(char *)a8 error:(id *)a9;
...
- (void)_setGenerateBinaryPatches:(char)a0;
...
- (char)_writeBomToFile:(id)a0 error:(id *)a1 modifyOwnershipUsingBlock:(id /* block */)a2 modifyModeUsingBlock:(id /* block */)a3;
- (char)_writePayloadToFile:(id)a0 usingBom:(id)a1 tempDir:(id)a2 options:(id)a3 error:(id *)a4;
- (char)_writeRoot:(id)a0 toCompressedCPIO:(id)a1 usingBom:(id)a2 largeAndSegmented:(char)a3 options:(id)a4 error:(id *)a5;
- (char)_writeScriptsToFile:(id)a0 error:(id *)a1;
- (char)_writeToArchive:(id)a0 atPath:(id)a1 options:(id)a2 error:(id *)a3;
- (void)setBaselinePayloadRoot:(id)a0;
- (void)setGenerateBinaryPatches:(char)a0;
