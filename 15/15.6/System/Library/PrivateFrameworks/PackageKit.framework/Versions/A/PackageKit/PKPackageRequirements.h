...
- (char)metForPackageInfo:(id)a0 returningError:(id *)a1;
- (id)_checkDigestsForComponent:(id)a0 allPaths:(char)a1;
- (id)_encodedDigestForOnDiskFile:(id)a0;
- (char)_metForPackageData:(id)a0 returningError:(id *)a1;
