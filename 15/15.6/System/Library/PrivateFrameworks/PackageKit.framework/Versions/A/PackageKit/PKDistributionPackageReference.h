...
- (char)validatePkgRefIdentifier:(id *)a0 error:(id *)a1;
- (id)_pkgRefElements;
- (void)_addPkgRefElement:(id)a0;
- (id)_bundleVersionElementCreatingIfNeeded:(char)a0;
...
- (id)_pkgRefElementForWriting:(char)a0 passingBlock:(id /* block */)a1;
...
- (id)scriptForAttributeName:(id)a0 createIfNeeded:(char)a1;
