...
@property char inBackground;

- (void)dealloc;
- (id)init;
- (void)cancel;
- (void)startAsyncDownloadNotifyingOnQueue:(id)a0 withBytesReceivedHandler:(id /* block */)a1 withCompletionHandler:(id /* block */)a2;
- (id)_initWithURLRequest:(id)a0 withResumeData:(id)a1 withDestinationDirectory:(id)a2 inBackground:(char)a3 withAuthenticationHandler:(id /* block */)a4 withRedirectResponseHandler:(id /* block */)a5;
...
- (id)initWithResumeData:(id)a0 withDestinationDirectory:(id)a1 inBackground:(char)a2 withAuthenticationHandler:(id /* block */)a3 withRedirectResponseHandler:(id /* block */)a4;
- (id)initWithURLRequest:(id)a0 withDestinationDirectory:(id)a1 inBackground:(char)a2;
- (id)initWithURLRequest:(id)a0 withDestinationDirectory:(id)a1 inBackground:(char)a2 withAuthenticationHandler:(id /* block */)a3;
- (id)initWithURLRequest:(id)a0 withDestinationDirectory:(id)a1 inBackground:(char)a2 withAuthenticationHandler:(id /* block */)a3 withRedirectResponseHandler:(id /* block */)a4;
