...
- (char)startSynchronousDownloadReturningResponse:(id *)a0 withBytesReceivedHandler:(id /* block */)a1 withOutData:(id *)a2 withOutLocation:(id *)a3 withError:(id *)a4;
...
- (char)_startSynchronousDownloadNotifyingOnQueue:(id)a0 onThread:(id)a1 returningResponse:(id *)a2 withBytesReceivedHandler:(id /* block */)a3 withOutData:(id *)a4 withOutLocation:(id *)a5 withError:(id *)a6;
...
- (char)startSynchronousDownloadNotifyingOnQueue:(id)a0 returningResponse:(id *)a1 withBytesReceivedHandler:(id /* block */)a2 withOutData:(id *)a3 withOutLocation:(id *)a4 withError:(id *)a5;
- (char)startSynchronousDownloadNotifyingOnThread:(id)a0 returningResponse:(id *)a1 withBytesReceivedHandler:(id /* block */)a2 withOutData:(id *)a3 withOutLocation:(id *)a4 withError:(id *)a5;
