...
+ (id)_validIdentitiesMatchingPrefix:(id)a0 fromKeychain:(id)a1 forCodeSigning:(char)a2 didExcludeWrongIdentities:(char *)a3;
+ (id)allSigningIdentitiesWithPrefix:(id)a0 fromKeychain:(id)a1;
+ (id)allSigningIdentitiesWithPrefix:(id)a0 fromKeychain:(id)a1 forCodeSigning:(char)a2;
...
+ (id)bestSigningIdentityFromString:(id)a0 fromKeychain:(id)a1 forCodeSigning:(char)a2 error:(id *)a3;
...
- (id)_sha1AsString;
- (char)addIntermediateCertificateWithCommonName:(id)a0;
