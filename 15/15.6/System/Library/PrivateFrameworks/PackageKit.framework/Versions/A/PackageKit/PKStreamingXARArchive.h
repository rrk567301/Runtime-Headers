...
+ (char)_createStreamingPlaceholderAtPath:(id)a0 md5Hashes:(id)a1 hashedChunkSize:(unsigned long long)a2 resumptionOffset:(unsigned long long *)a3 error:(id *)a4;
+ (char)_streamingPlaceholderExistsAtPath:(id)a0 md5Hashes:(id)a1 hashedChunkSize:(unsigned long long)a2;
...
- (char)_verifyMD5Hash:(id)a0 forByteRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 error:(id *)a2;
