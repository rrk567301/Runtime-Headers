...
- (id)initWithNotifyQueue:(id)a0 withNotifyThread:(id)a1 withDestinationDirectory:(id)a2 inBackground:(char)a3 withAuthenticationHandler:(id /* block */)a4 withRedirectResponseHandler:(id /* block */)a5 withBytesReceivedHandler:(id /* block */)a6 usingBlock:(id /* block */)a7;
