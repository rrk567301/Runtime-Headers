...
- (char)_extractAllSpecifiersOnceAndReturnFailingSpecifier:(id *)a0 andError:(id *)a1;
- (char)_extractBomForPackageSpecifier:(id)a0 error:(id *)a1;
- (char)_extractPayloadForPackageSpecifier:(id)a0 error:(id *)a1;
- (char)_extractScriptsForPackageSpecifier:(id)a0 error:(id *)a1;
