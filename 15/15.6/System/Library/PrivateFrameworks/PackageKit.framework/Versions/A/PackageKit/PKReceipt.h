...
- (char)_isSecure;
- (id)_packageName;
- (char)_removeReceiptInDirectory:(id)a0 error:(id *)a1;
...
- (void)_setSecure:(char)a0;
- (char)_updateACLsOfItemAtPath:(id)a0 withFile:(id)a1;
- (char)_updateSHA1ChecksumOfItemAtPath:(id)a0 withFile:(id)a1;
