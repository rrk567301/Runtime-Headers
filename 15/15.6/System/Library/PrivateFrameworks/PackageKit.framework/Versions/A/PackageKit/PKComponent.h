...
@property char relocatable;
@property char versionChecked;
@property char strictIdentifier;
@property (retain) NSArray *subpaths;
@property PKPackage *package;
@property (retain) NSString *destinationPath;

+ (char)isInstallablePath:(id)a0;
+ (char)_bundleAtPath:(id)a0 matchesVersion:(id)a1;
+ (char)_componentPath:(id)a0 matchesDestination:(id)a1;
