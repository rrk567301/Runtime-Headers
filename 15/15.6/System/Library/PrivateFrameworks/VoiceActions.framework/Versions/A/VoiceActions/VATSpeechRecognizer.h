...
- (void)startRecognitionWithAutoStop:(char)a0 resultHandler:(id /* block */)a1;
- (id)initWithAssetPath:(id)a0 language:(id)a1;
- (void)startRecognitionWithAutoStop:(char)a0 pcmBuffer:(id)a1 resultHandler:(id /* block */)a2;
