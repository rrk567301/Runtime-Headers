...
@property (nonatomic) char audioDebuggingEnabled;
@property (nonatomic) char batchDecodeEnabled;
@property (nonatomic) VATSpeechRecognizer *recognizer;
@property (nonatomic) char secondPassEnabled;
@property (copy, nonatomic) NSString *customSecondPassModelPath;
@property (nonatomic) char preKeywordSilenceCheckEnabled;
@property (nonatomic) char duringKeywordSilenceCheckEnabled;
@property (nonatomic) char postKeywordSilenceCheckEnabled;

+ (id)pronounciationsFor:(id)a0 wordSeparator:(id)a1;
+ (id)pronounciationsFor:(id)a0 wordSeparator:(id)a1 prefixWithPhrase:(char)a2;
...
- (char)_isDetectionValidForResult:(void *)a0 reason:(id *)a1;
...
- (void)addAudioSamples:(const void *)a0 count:(int)a1 isFloat:(char)a2;
- (void)addAudioSamples:(const void *)a0 count:(int)a1 isFloat:(char)a2 filePath:(id)a3 byteCount:(long long)a4 currentDuration:(double)a5;
...
- (char)isValidRecognizer;
- (void)setSecondPassEnabled:(char)a0 customAssetPath:(id)a1;
