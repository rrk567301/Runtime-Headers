...
- (char)createDestinationDirectoryWithError:(id *)a0;
...
- (char)populateArchive:(struct archive { } *)a0 error:(id *)a1;
- (char)populateArchive:(struct archive { } *)a0 usingDisk:(struct archive { } *)a1 error:(id *)a2;
- (const char *)relativePathForPathOnDisk:(id)a0;
- (char)validateParametersWithError:(id *)a0;
- (char)writeArchiveOfDirectoryAtURL:(id)a0 toURL:(id)a1 error:(id *)a2;
- (char)writeDataForFTSEntry:(id)a0 toArchive:(struct archive { } *)a1 fileDescriptor:(int)a2 error:(id *)a3;
- (char)writeDataFromFileDescriptor:(int)a0 toArchive:(struct archive { } *)a1 usingBuffer:(id)a2 error:(id *)a3;
- (char)writeFTSEntry:(id)a0 toArchive:(struct archive { } *)a1 usingDisk:(struct archive { } *)a2 error:(id *)a3;
- (char)writeHeaderForFTSEntry:(id)a0 toArchive:(struct archive { } *)a1 usingDisk:(struct archive { } *)a2 fileDescriptor:(int)a3 error:(id *)a4;
