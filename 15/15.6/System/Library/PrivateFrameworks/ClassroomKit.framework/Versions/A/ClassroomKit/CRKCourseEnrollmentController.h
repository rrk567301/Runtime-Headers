@class NSHashTable, NSArray, CATRemoteTaskOperation, NSSet, NSString, NSDictionary, CRKSecureCodedUserDefaultsObject, NSNumber, CRKStudentDaemonProxy;
...
@property (readonly, nonatomic) char supportsRemoteLearning;
...
- (char)instructor:(id)a0 isForCourse:(id)a1;
- (id)instructorUsersForCourse:(id)a0;
- (void)invitationWithIdentifierDidFail:(id)a0 withLocalizedReason:(id)a1;
- (char)isInstructorWithIdentifier:(id)a0 activeForCourse:(id)a1;
- (char)isInstructorWithIdentifier:(id)a0 disconnectableForCourse:(id)a1;
- (char)isInstructorWithIdentifier:(id)a0 observingStudentScreenForCourse:(id)a1;
- (char)isStudentScreenBeingObservedForCourse:(id)a0;
- (void)notifyDaemonOfSettingsPaneActivationOperationDidFail:(id)a0;
