...
@property (readonly, nonatomic, getter=isWebClipHostApplication) char webClipHostApplication;
@property (readonly, nonatomic, getter=isSpecificWebClip) char specificWebClip;
