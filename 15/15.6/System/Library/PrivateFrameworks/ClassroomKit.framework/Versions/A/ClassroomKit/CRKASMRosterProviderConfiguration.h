...
+ (id)instructorRosterConfigurationWithCredentialStore:(id)a0 personaAdoption:(char)a1;
+ (char)userCachingEnabled;

- (void).cxx_destruct;
- (id)initWithUserCommonNamePrefix:(id)a0 trustedUserCommonNamePrefix:(id)a1 classKitFacade:(id)a2 rosterRequirements:(id)a3 credentialStore:(id)a4 maxCourseUsersCount:(long long)a5 maxCourseTrustedUsersCount:(long long)a6 rosterMutationTimeout:(double)a7 userCachingEnabled:(char)a8;
- (id)initWithUserCommonNamePrefix:(id)a0 trustedUserCommonNamePrefix:(id)a1 classKitFacade:(id)a2 rosterRequirements:(id)a3 credentialStore:(id)a4 maxCourseUsersCount:(long long)a5 maxCourseTrustedUsersCount:(long long)a6 rosterMutationTimeout:(double)a7 userCachingEnabled:(char)a8 osTransactionPrimitives:(id)a9 transactionReleaseDelay:(double)a10;
