...
+ (id)makePersonSortDescriptorsSortingGivenNameFirst:(char)a0;

- (id)init;
- (void).cxx_destruct;
- (void)executeQuery:(id)a0;
- (id)dataStore;
- (void)syncServerConfigWithCompletion:(id /* block */)a0;
...
- (id)makeInstructorQueryForSearchString:(id)a0 locationIDs:(id)a1 sortingGivenNameFirst:(char)a2 pageSize:(long long)a3;
- (id)makePredicateForObjectIDs:(id)a0;
- (id)makePredicatesForObjectIDs:(id)a0;
- (id)makeQueryForLocationsAllowingEasyStudentSignInForPersonID:(id)a0;
- (id)makeQueryForPersonsWithIdentifiers:(id)a0;
- (id)makeQueryForPersonsWithRole:(long long)a0 locationIDs:(id)a1 searchString:(id)a2 sortingGivenNameFirst:(char)a3 pageSize:(long long)a4;
- (id)makeStudentQueryForSearchString:(id)a0 locationIDs:(id)a1 sortingGivenNameFirst:(char)a2 pageSize:(long long)a3;
