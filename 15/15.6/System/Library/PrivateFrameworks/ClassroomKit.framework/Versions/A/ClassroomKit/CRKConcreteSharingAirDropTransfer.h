...
@property (readonly, nonatomic) char autoAccept;
@property (readonly, nonatomic) char hideProgress;
...
- (id)initWithAutoAccept:(char)a0 hideProgress:(char)a1 senderName:(id)a2 previewImageData:(id)a3 bundleID:(id)a4 sourceBundleID:(id)a5 itemsDescription:(id)a6 fileURLs:(id)a7 resultHandler:(id /* block */)a8;
- (void)propagateResultForIdentifier:(id)a0 withSuccess:(char)a1 error:(id)a2;
