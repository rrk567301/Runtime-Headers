...
@property (class, readonly) char anyInstallationExists;
...
+ (id)installationWithClassroomBundleIdentifier:(id)a0 bundleHasContentsFolder:(char)a1 instructordBundleIdentifier:(id)a2;
+ (id)instructorKitImagePathInBundle:(id)a0 hasContentsFolder:(char)a1;
