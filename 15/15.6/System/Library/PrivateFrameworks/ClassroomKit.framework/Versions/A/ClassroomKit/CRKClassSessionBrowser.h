...
@property (nonatomic) char allowInvitationSessions;
@property (nonatomic) char allowUnenrolledSessions;
@property (readonly, nonatomic, getter=isBrowsing) char browsing;
...
- (void)handleUntrustedClassSession:(id)a0 ASMInstructorIdentifier:(id)a1 decisionHandler:(id /* block */)a2;
- (void)handleUntrustedInvitationSession:(id)a0 decisionHandler:(id /* block */)a1;
- (char)hasConnectionToClassWithIdentifier:(id)a0;
...
- (void)session:(id)a0 encounteredUntrustedConnectionForASMInstructorIdentifier:(id)a1 decisionHandler:(id /* block */)a2;
