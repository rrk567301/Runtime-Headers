...
@property (readonly, nonatomic, getter=isForInstructor) char forInstructor;
...
@property (nonatomic) char generalObserverConstituentsRegistered;
...
- (id)initWithClassKitFacade:(id)a0 isForInstructor:(char)a1;
- (char)isForStudent;
