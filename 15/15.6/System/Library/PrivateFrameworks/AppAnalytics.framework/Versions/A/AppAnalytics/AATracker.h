...
- (void)clearStackEventType:(Class)a0 includeParentTrackers:(char)a1;
- (id)delayedSubmitEventType:(Class)a0;
- (id)delayedSubmitEventType:(Class)a0 completion:(id /* block */)a1;
- (id)delayedSubmitEventType:(Class)a0 onlyIfTimed:(char)a1;
- (id)delayedSubmitEventType:(Class)a0 onlyIfTimed:(char)a1 completion:(id /* block */)a2;
- (id)delayedSubmitRawEvent:(id)a0;
- (id)delayedSubmitRawEvent:(id)a0 completion:(id /* block */)a1;
- (id)delayedSubmitRawEvent:(id)a0 onlyIfTimed:(char)a1;
- (id)delayedSubmitRawEvent:(id)a0 onlyIfTimed:(char)a1 completion:(id /* block */)a2;
- (void)dynamicTransactionWithIdentifier:(id)a0 block:(id /* block */)a1;
- (void)enterGroupWithName:(id)a0;
- (void)explicitSubmitEvent:(Class)a0 onlyIfTimed:(char)a1 submitTime:(id)a2;
- (void)explicitSubmitEvent:(Class)a0 onlyIfTimed:(char)a1 submitTime:(id)a2 completion:(id /* block */)a3;
- (void)explicitSubmitEvent:(Class)a0 submitTime:(id)a1 completion:(id /* block */)a2;
- (void)explicitSubmitRawEvent:(id)a0 onlyIfTimed:(char)a1 submitTime:(id)a2;
- (void)explicitSubmitRawEvent:(id)a0 onlyIfTimed:(char)a1 submitTime:(id)a2 completion:(id /* block */)a3;
...
- (void)submitEventType:(Class)a0 onlyIfTimed:(char)a1;
- (void)submitEventType:(Class)a0 onlyIfTimed:(char)a1 completion:(id /* block */)a2;
- (void)submitRawEvent:(id)a0 completion:(id /* block */)a1;
- (void)submitRawEvent:(id)a0 onlyIfTimed:(char)a1;
- (void)submitRawEvent:(id)a0 onlyIfTimed:(char)a1 completion:(id /* block */)a2;
- (void)timeEventType:(Class)a0;
- (void)timeEventType:(Class)a0 startTime:(id)a1;
- (void)timeEventType:(Class)a0 submitAndRestartWithSession:(char)a1;
- (void)timeEventType:(Class)a0 submitAndRestartWithSession:(char)a1 startTime:(id)a2;
- (void)timeRawEvent:(id)a0;
- (void)timeRawEvent:(id)a0 startTime:(id)a1;
- (void)timeRawEvent:(id)a0 submitAndRestartWithSession:(char)a1;
- (void)timeRawEvent:(id)a0 submitAndRestartWithSession:(char)a1 startTime:(id)a2;
