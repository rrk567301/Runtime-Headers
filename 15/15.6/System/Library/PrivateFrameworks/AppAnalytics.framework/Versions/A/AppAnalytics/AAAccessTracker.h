...
- (void)explicitSubmitEventType:(Class)a0 onlyIfTimed:(char)a1 submitTime:(id)a2;
- (void)explicitSubmitEventType:(Class)a0 onlyIfTimed:(char)a1 submitTime:(id)a2 completion:(id /* block */)a3;
