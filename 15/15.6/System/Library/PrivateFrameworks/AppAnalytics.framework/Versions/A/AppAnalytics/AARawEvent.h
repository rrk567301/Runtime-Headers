...
- (id)initWithName:(id)a0 sessionGroup:(id)a1 requiresDiagnosticsConsent:(char)a2 timestampGranularity:(long long)a3 timeDurationGranularity:(long long)a4 properties:(id)a5;
