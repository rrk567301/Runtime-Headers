...
- (void)xpcSetStageManagerEnabled:(char)a0 completion:(id /* block */)a1;
- (void)xpcTakeWidgetRevealAssertion:(id)a0 withInclusions:(id)a1 animated:(char)a2 completion:(id /* block */)a3;
