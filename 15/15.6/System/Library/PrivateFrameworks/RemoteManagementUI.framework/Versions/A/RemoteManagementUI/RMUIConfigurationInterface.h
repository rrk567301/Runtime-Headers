...
- (id)initWithAccount:(id)a0 scope:(long long)a1 initialLoad:(char)a2;
- (id)initWithDeclarationsPayloadIdentifier:(id)a0 scope:(long long)a1;
- (id)initWithDeclarationsPayloadIdentifier:(id)a0 scope:(long long)a1 initialLoad:(char)a2;
- (id)initWithDeclarationsPayloadIdentifiers:(id)a0 scope:(long long)a1 initialLoad:(char)a2;
- (id)initWithMDMProfileIdentifier:(id)a0 scope:(long long)a1;
- (id)initWithMDMProfileIdentifier:(id)a0 scope:(long long)a1 initialLoad:(char)a2;
- (void)reloadNotificationPosted:(id)a0;
- (void)setConfigurationActivated:(char)a0 forViewModel:(id)a1 completionHandler:(id /* block */)a2;
