...
@property char autoCorrects;
@property char shouldLearnAcceptedCandidate;
...
- (char)addFacemarkCandidatesToResultSet:(id)a0 forInput:(id)a1;
...
- (void)performAccept:(void *)a0 isPartial:(char)a1;
- (void)performOperationAsync:(id)a0;
- (void)performOperationAsync:(id)a0 withBackgroundActivityAssertion:(char)a1;
...
- (void)setDebuggingLogEnabled:(char)a0;
- (void)setDisablePersonalData:(char)a0;
