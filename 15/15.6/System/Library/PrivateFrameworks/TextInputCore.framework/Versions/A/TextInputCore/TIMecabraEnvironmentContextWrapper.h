...
- (void)addContextCandidate:(void *)a0 accept:(char)a1;
...
- (id)contextString:(id)a0 forRightContext:(char)a1;
...
- (char)predictionCandidatesWithOptions:(unsigned long long)a0 maxNumberOfCandidates:(unsigned long long)a1;
