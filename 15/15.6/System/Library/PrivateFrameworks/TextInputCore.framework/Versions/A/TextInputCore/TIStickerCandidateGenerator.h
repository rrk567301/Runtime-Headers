...
- (void)_generateStickerCandidatesForGenerativeEmojiSearchableQueries:(id)a0 withRenderTraits:(id)a1 shouldAppend:(char)a2 language:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)generateStickerCandidatesForSearchableQueries:(id)a0 withRenderTraits:(id)a1 shouldAppend:(char)a2 language:(id)a3 completionHandler:(id /* block */)a4;
- (void)generateStickerCandidatesForTaxonomySearchableQueries:(id)a0 generativeEmojiSearchableQueries:(id)a1 withRenderTraits:(id)a2 shouldAppend:(char)a3 language:(id)a4 completionHandler:(id /* block */)a5;
- (id)generateStickerQueriesForText:(id)a0 tokenize:(char)a1;
- (id)generateStickerQueriesForText:(id)a0 tokenize:(char)a1 generativeEmojiSearchQueries:(char)a2;
