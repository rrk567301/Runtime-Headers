...
- (id)_ddsAssetsForAssetType:(id)a0 languageIdentifier:(id)a1 cachedOnly:(char)a2;
- (id)_ddsAssetsForLanguageIdentifier:(id)a0 cachedOnly:(char)a1;
- (id)_ddsContentItemsFromAssets:(id)a0 contentType:(id)a1 filteredWithRegion:(char)a2;
...
- (char)inputModeHasRegions:(id)a0;
...
- (char)requireMecabraDictionaryRapidUpdatesAssetsForLanguageIdentifier:(id)a0;
