...
@property (readonly, nonatomic) char isCompleting;
@property (readonly, nonatomic) char isComplete;
@property (readonly, nonatomic) char isDrawing;
@property (readonly, nonatomic) char shouldResample;
...
- (char)_canCompose;
- (id)_createDrawableTouchInputWithPoint:(struct CGPoint { double x0; double x1; })a0 timestamp:(double)a1 force:(double)a2 radius:(double)a3 touchStage:(int)a4 previousTouchInput:(id)a5 isInflectionPoint:(char)a6;
- (void)_updateSampledInputs;
- (void)_updateSampledInputsWithResampler:(const void *)a0 permanentlyFinalized:(char)a1;
...
- (id)initWithKeyboardLayout:(const void *)a0 rescaleKeyboardLayout:(const void *)a1 shouldResample:(char)a2;
