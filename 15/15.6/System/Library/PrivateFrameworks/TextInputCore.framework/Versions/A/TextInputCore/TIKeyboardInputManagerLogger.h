...
@property (nonatomic) char hadSecureText;
...
+ (char)createTypologyDirectoryAtURL:(id)a0;
...
- (char)allowTypologyLogForKeyboardState:(id)a0;
...
- (void)logKeyboardConfig:(id)a0 forAdjustedPhraseBoundaryInForwardDirection:(char)a1 granularity:(int)a2 keyboardState:(id)a3;
...
- (char)shouldWriteToSyslogForKeyboardState:(id)a0;
- (char)shouldWriteToTypologyLogForKeyboardState:(id)a0;
