...
+ (id)normalizedInputModeIdentifierGroupsFromInputModes:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (id)_createEventSpecForTextInputUserPreferenceChanges;
- (id)_createEventSpecForTextInputUserPreferenceState;
- (void)_dispatchEventPayloadWithPreferenceNameToChangesEvent:(id)a0 activeInputModes:(id)a1 currentValue:(id)a2 previousValue:(id)a3 changedAt:(id)a4 analyzedAt:(id)a5 buildAtChange:(id)a6 isFreshInstall:(char)a7 approxDateOfBuildInstall:(id)a8 buildAtLastAnalysis:(id)a9;
