...
- (void)adjustPhraseBoundaryInForwardDirection:(char)a0 granularity:(int)a1 keyboardState:(id)a2 completionHandler:(id /* block */)a3;
- (void)adjustPhraseBoundaryInForwardDirection:(char)a0 keyboardState:(id)a1 completionHandler:(id /* block */)a2;
