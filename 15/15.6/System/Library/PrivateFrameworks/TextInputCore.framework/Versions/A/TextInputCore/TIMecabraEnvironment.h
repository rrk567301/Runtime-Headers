...
@property (nonatomic) char shouldAdjustOnAnalyze;
...
@property (nonatomic) char canSuggestSupplementalItems;
...
+ (id)getWordFrom:(void *)a0 atIndex:(unsigned long long)a1 forSurface:(char)a2;
...
- (char)addNewCandidatesIfNecessary:(long long)a0;
...
- (void)analyzeCandidateContextWithSplit:(char)a0;
- (char)analyzeInput:(id)a0 options:(unsigned long long)a1;
- (char)analyzeString:(id)a0 options:(unsigned long long)a1;
- (void)canSuggestSupplementalItemsFlagDidChangeTo:(char)a0;
...
- (char)predictionAnalyzeWithOptions:(unsigned long long)a0 maxNumberOfCandidates:(unsigned long long)a1;
