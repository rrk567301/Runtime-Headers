...
- (id)_generateQueries:(id)a0 tokenize:(char)a1;
- (id)_generateQueryTokens:(id)a0;
- (id)_generateSearchableQueries:(id)a0 disablePhraseListCheck:(char)a1;
- (id)_generateTokens:(id)a0;
- (id)generateSearchableQueriesForText:(id)a0 tokenize:(char)a1 generativeEmojiSearchQueries:(char)a2;
