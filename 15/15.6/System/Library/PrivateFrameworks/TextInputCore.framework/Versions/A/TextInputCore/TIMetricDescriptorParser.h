...
- (id)parseBucketThresholdsFromConfig:(id)a0 isFeatureUsageDescriptor:(char)a1 errors:(id)a2;
- (id)parseBucketValuesFromConfig:(id)a0 forBucketThresholds:(id)a1 isFeatureUsageDescriptor:(char)a2 errors:(id)a3;
