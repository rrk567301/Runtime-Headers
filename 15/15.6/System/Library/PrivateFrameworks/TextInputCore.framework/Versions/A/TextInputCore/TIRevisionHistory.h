...
@property (nonatomic) char shouldReportRevisionToDP;
@property (nonatomic) char isDeletingBackwards;
@property (nonatomic) char isRapidDeleteActive;
...
- (void)acceptText:(id)a0 isAutocorrection:(char)a1 isAutoshifted:(char)a2;
...
- (char)isSelectionContainedByToken:(struct _TIRevisionHistoryTokenIterator { unsigned long long x0; unsigned long long x1; })a0;
- (char)isWordToken:(struct _TIRevisionHistoryTokenIterator { unsigned long long x0; unsigned long long x1; })a0;
- (struct _TIRevisionHistoryTokenIterator { unsigned long long x0; unsigned long long x1; })iteratorUpperBoundForSelectionStart;
- (char)matchesContextAfterSelection:(id)a0;
- (char)matchesContextBeforeSelection:(id)a0;
- (char)matchesDocumentState:(id)a0;
- (char)matchesSelectedText:(id)a0;
...
- (char)originalIterator:(struct _TIRevisionHistoryTokenIterator { unsigned long long x0; unsigned long long x1; })a0 matchesRevisedDocumentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 andTokenID:(struct TITokenID { unsigned int x0; unsigned int x1; })a2;
...
- (char)shouldValidateOriginalIterator:(struct _TIRevisionHistoryTokenIterator { unsigned long long x0; unsigned long long x1; })a0 withRevisedDocumentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 forRevision:(id)a2;
...
- (char)validateTokenizationForRevisedDocumentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 andTokenID:(struct TITokenID { unsigned int x0; unsigned int x1; })a1 forRevision:(id)a2;
