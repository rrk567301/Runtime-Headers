...
+ (char)isSensorKitSupported:(id)a0;
+ (id)makeMetricCollector:(id)a0 wordsThreshold:(unsigned long long)a1 isTesting:(char)a2;
...
- (void)_consumeInputsAndTouches:(id)a0 occurenceTime:(double)a1 emojiSearchMode:(char)a2;
- (void)_consumePathsAndPredictions:(id)a0 emojiSearchMode:(char)a1;
...
- (id)init:(id)a0 wordsThreshold:(unsigned long long)a1 accentedLanguage:(char)a2;
- (id)init:(id)a0 wordsThreshold:(unsigned long long)a1 accentedLanguage:(char)a2 skipTCCAuthorization:(char)a3;
...
- (char)publishIfSessionStatsHasWordCountMoreThanThreshold:(id)a0 withSessionStartTime:(char)a1;
