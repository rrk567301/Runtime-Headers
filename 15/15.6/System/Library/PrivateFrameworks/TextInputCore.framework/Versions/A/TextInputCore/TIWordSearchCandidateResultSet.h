...
- (void)addSyntheticMecabraCandidateWithSurface:(id)a0 input:(id)a1 isExtension:(char)a2;
- (void)addSyntheticMecabraCandidateWithSurface:(id)a0 input:(id)a1 isExtension:(char)a2 deleteCount:(unsigned long long)a3;
- (void)addSyntheticMecabraCandidateWithSurface:(id)a0 input:(id)a1 isExtension:(char)a2 deleteCount:(unsigned long long)a3 cursorMovement:(long long)a4;
- (void)addSyntheticMecabraCandidateWithSurface:(id)a0 input:(id)a1 isExtension:(char)a2 deleteCount:(unsigned long long)a3 cursorMovement:(long long)a4 annotation:(id)a5;
