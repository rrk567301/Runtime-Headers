...
@property (readonly, nonatomic) char isPointMetric;

+ (id)_makeMetric:(id)a0 type:(int)a1;
+ (id)_makeMetric:(id)a0 type:(int)a1 metricDef:(struct { double x0; } *)a2;
+ (id)_makeMetric:(id)a0 type:(int)a1 metricDef:(struct { double x0; } *)a2 isPointMetric:(char)a3;
+ (id)_makeMetric:(id)a0 type:(int)a1 metricDef:(struct { double x0; } *)a2 size:(unsigned long long)a3;
+ (id)_makeMetric:(id)a0 type:(int)a1 metricDef:(struct { double x0; } *)a2 size:(unsigned long long)a3 isPointMetric:(char)a4;
+ (id)metricDefinitions;
+ (double)pointsToMM:(double)a0;

- (void).cxx_destruct;
- (id)init:(id)a0 type:(int)a1 metricDef:(struct { double x0; } *)a2 size:(unsigned long long)a3 isPointMetric:(char)a4;
