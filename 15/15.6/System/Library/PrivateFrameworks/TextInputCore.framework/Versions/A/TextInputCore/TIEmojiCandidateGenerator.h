...
@interface TIEmojiCandidateGenerator : NSObject {
    ...
    char m_didAttemptTertiaryEmojiGeneratorLoad;
    ...
    char m_didAttemptTertiaryLocaleForEmojiLoad;
...
- (id)enumerateForEmojiCandidatesIn:(id)a0 forEmojiLocaleData:(struct __EmojiLocaleDataWrapper { } *)a1 asReplacementCandidate:(char)a2;
- (id)enumerateForEmojiCandidatesIn:(id)a0 forEmojiLocaleData:(struct __EmojiLocaleDataWrapper { } *)a1 asReplacementCandidate:(char)a2 matchedString:(id *)a3;
