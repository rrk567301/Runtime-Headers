...
+ (id)inferSecondaryInputModeForPrimary:(id)a0 enabled:(id)a1 isSimulation:(char)a2;
+ (id)inferSecondaryInputModeForPrimary:(id)a0 enabled:(id)a1 isSimulation:(char)a2 enabledExcludingPreferredLanguages:(id)a3;
...
- (char)bufferIsCompatibleWithContext:(const struct TITokenID { unsigned int x0; unsigned int x1; } *)a0 contextLength:(unsigned long long)a1;
- (char)didProbabilityChangeSignificantly;
- (char)didUpdatedInputModesChange:(id)a0;
- (id)dynamicallyDetectedInputModesForPrimaryInputMode:(id)a0 isSimulation:(char)a1;
...
- (void)updateActiveInputModesSuppressingNotification:(char)a0;
- (char)updateInputModeProbabilities;
