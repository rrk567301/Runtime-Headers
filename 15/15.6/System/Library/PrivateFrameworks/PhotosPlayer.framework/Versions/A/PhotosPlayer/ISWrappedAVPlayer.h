...
@interface ISWrappedAVPlayer : ISObservable <ISKVOProxyDelegate> {
    ...
    char _ivarQueue_suppressesAudioRendering;
    ...
    char _ivarQueue_itemHasEnabledAudio;
...
@property (readonly) char currentItemHasEnabledAudio;
@property char suppressesAudioRendering;
