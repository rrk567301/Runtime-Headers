...
- (long long)prepareIrisPlayerItemWithAsset:(id)a0 trimmedTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a1 photoTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 includeVideo:(char)a3 includeAudio:(char)a4 completion:(id /* block */)a5;
