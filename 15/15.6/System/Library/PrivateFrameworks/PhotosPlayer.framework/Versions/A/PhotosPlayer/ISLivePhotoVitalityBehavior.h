...
@property (nonatomic, getter=isPrepared, setter=_setPrepared:) char prepared;
@property (nonatomic, getter=_isPreparing, setter=_setPreparing:) char preparing;
@property (nonatomic, getter=isPlayingBeyondPhoto, setter=_setPlayingBeyondPhoto:) char playingBeyondPhoto;
@property (nonatomic, setter=_setShouldPlayAfterPreparation:) char _shouldPlayAfterPreparation;
...
@property (readonly, nonatomic) char pauseDuringTransition;
...
- (id)initWithInitialLayoutInfo:(id)a0 playbackEndTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 playDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 playRate:(float)a3 photoTransitionDuration:(double)a4 pauseDuringTransition:(char)a5 assetOptions:(unsigned long long)a6;
- (void)playVitality;
