...
@interface ISLivePhotoPlayer : ISBasePlayer <ISLivePhotoSettleBehaviorDelegate, ISChangeObserver> {
    ...
    struct { char scale; char apertureMode; } _isValid;
...
@property (nonatomic, setter=_setIsAttemptingToPlayback:) char isAttemptingToPlayback;
@property (nonatomic, setter=_setSettleAutomaticallyWhenReady:) char _settleAutomaticallyWhenReady;
@property (nonatomic, setter=_setShouldPrepareForVitalityWhenReady:) char _shouldPrepareForVitalityWhenReady;
@property (nonatomic, setter=_setShouldPlayVitalityWhenReady:) char _shouldPlayVitalityWhenReady;
@property (nonatomic, setter=_setShouldPrepareForHintWhenReady:) char _shouldPrepareForHintWhenReady;
@property (nonatomic, getter=isPlayingVitality, setter=_setPlayingVitality:) char playingVitality;
@property (nonatomic, getter=isHinting, setter=_setHinting:) char hinting;
@property (retain, nonatomic, setter=_setVitalityTimeoutDate:) NSDate *_vitalityTimeoutDate;
@property (readonly, nonatomic) char _canPlayVitality;
@property (readonly, nonatomic) NSSet *playbackFilters;
@property (retain, nonatomic) ISLivePhotoVitalityFilter *vitalityFilter;
@property (nonatomic) char immediatelyShowsPhotoWhenPlaybackEnds;
@property (nonatomic, getter=isPlaybackAllowed) char playbackAllowed;
...
- (char)_wantsAudioForPlaybackStyle:(long long)a0;
...
- (void)setIsAttemptingToPlayback:(char)a0;
- (void)setSeekTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 completion:(id /* block */)a1;
- (void)startPlaybackWithStyle:(long long)a0 settleAutomatically:(char)a1;
- (void)startPlaybackWithStyleWhenReady:(long long)a0;
- (void)startPlaybackWithStyleWhenReady:(long long)a0 settleAutomatically:(char)a1;
...
- (char)vitalityBehaviorShouldEndPlayingAtPhoto:(id)a0;
