...
+ (struct _NSRange { unsigned long long x0; unsigned long long x1; })revealRangeAtIndex:(unsigned long long)a0 selectedRanges:(id)a1 shouldUpdateSelection:(char *)a2;
