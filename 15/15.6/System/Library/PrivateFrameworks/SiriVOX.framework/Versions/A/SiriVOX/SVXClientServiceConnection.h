@class SVXClientDeviceService, NSString, NSXPCConnection, SVXClientKeepAliveService, SVXClientSpeechSynthesisService, SVXQueuePerformer, SVXClientAudioSystemService, AFInstanceContext, SVXXPCConnectionFactory, SVXClientAudioPowerService, SVXClientActivationService, SVXClientSessionService;
...
- (void)_clientServiceDidChange:(char)a0;
...
- (id)initWithQueuePerformer:(id)a0 activationService:(id)a1 audioSystemService:(id)a2 deviceService:(id)a3 inputAudioPowerService:(id)a4 outputAudioPowerService:(id)a5 sessionService:(id)a6 speechSynthesisService:(id)a7 keepAliveService:(id)a8 instanceContext:(id)a9 connectionFactory:(id)a10 delegate:(id)a11;
...
- (oneway void)notifyAudioSessionDidBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
- (oneway void)notifyAudioSessionWillBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
