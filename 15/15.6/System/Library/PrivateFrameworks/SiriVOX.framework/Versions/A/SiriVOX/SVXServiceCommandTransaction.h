...
- (void)_handler:(id)a0 didPrepareSuccessfully:(char)a1 context:(id)a2 completion:(id /* block */)a3;
...
- (void)handler:(id)a0 didPrepareSuccessfully:(char)a1 context:(id)a2 completion:(id /* block */)a3;
