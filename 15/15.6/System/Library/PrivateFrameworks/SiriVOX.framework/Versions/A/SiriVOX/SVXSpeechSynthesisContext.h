...
@property (nonatomic) char handledPresynthesizedAudioRequest;
@property (nonatomic) char handledSpeechRequest;
@property (nonatomic) char isStreamingSynthesisRequest;
