@class SVXInstrumentationUtilities, NSString, SVXSpeechSynthesizer, SVXSpeechSynthesisResultConverter, SVXSpeechSynthesisRequest;
...
- (id)initWithSpeechSynthesizer:(id)a0 performer:(id)a1 instrumentationUtils:(id)a2 synthesisResultConverter:(id)a3;
- (char)isCommandUUFR:(id)a0;
- (char)shouldDependOnCommand:(id)a0;
