...
- (void)handleAudioSessionDidBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
- (void)handleAudioSessionIDDidChange:(unsigned int)a0;
- (void)handleAudioSessionWillBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
