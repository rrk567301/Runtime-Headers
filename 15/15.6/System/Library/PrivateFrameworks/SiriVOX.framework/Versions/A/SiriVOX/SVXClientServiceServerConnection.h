@class NSUUID, NSString, NSXPCConnection, SVXSessionManager, SVXSynthesisManager, SVXInstanceInfoSupplier, SVXAudioServicesUtils, SVXDeviceSetupManager, NSMutableArray, SVXSpeechSynthesizer, SVXClientServiceRemoteDelegateSupplier;
...
- (void)audioSessionDidBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
- (void)audioSessionWillBecomeActive:(char)a0 activationContext:(id)a1 deactivationContext:(id)a2;
- (oneway void)cancelPendingSpeechSynthesisRequest:(id)a0;
- (void)configureWithDeviceSetupManager:(id)a0 sessionManager:(id)a1 speechSynthesizer:(id)a2 synthesisManager:(id)a3;
