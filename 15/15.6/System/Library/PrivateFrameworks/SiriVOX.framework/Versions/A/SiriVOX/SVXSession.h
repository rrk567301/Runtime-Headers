@class SVXAceViewSpeakableTextExtractor, AFAnalytics, SVXAFConnectionFactory, NSUserActivity, AFAnalyticsTurnBasedInstrumentationContext, SVXActivationContext, NSMutableSet, NSMutableArray, SRUIFStateFeedbackManager, SVXDeviceProblemsState, AFPreferences, AFDeviceContext, AFXPCWrapper, SVXServiceCommandHandler, SVXDeviceSetupContext, SVXDeactivationContext, AFHomeAccessoryInfo, SVXSpeechSynthesizer, SVXTapToRadarManager, AFModesConfiguration, SVXSessionUtils, SASetApplicationContext, SVXTaskTrackingCenter, AFSpeechRequestOptions, AFConnection, AFInstanceContext, SVXSoundUtils, SVXPowerLevelManager, NSMutableDictionary, NSString, SVXActivationInstrumentation, SVXSpeechSynthesisUtils, SVXAlarmAndTimerUtilities, NSUUID;
...
- (void)assistantConnectionAudioSessionDidEndInterruption:(id)a0 shouldResume:(char)a1;
- (void)_invalidateConnection;
- (void)assistantConnection:(id)a0 appLaunchFailedWithBundleIdentifier:(id)a1;
- (void)assistantConnection:(id)a0 audioSessionDidBecomeActive:(char)a1;
- (void)assistantConnection:(id)a0 audioSessionWillBecomeActive:(char)a1;
...
- (void)assistantConnection:(id)a0 shouldSpeak:(char)a1;
...
- (id)_connection:(char)a0;
- (void)_continuePendingSpeechRequest:(char)a0;
...
- (void)_handleAudioSessionDidBecomeActive:(char)a0;
- (void)_handleAudioSessionDidBeginInterruption;
- (void)_handleAudioSessionDidEndInterruption:(char)a0;
- (void)_handleAudioSessionWillBecomeActive:(char)a0;
...
- (void)_handleShouldSpeak:(char)a0;
...
- (void)_startRequestWithInfo:(id)a0 clearsContext:(char)a1 deviceSetupContext:(id)a2 taskTracker:(id)a3 completion:(id /* block */)a4;
- (void)_startSessionIdleTimerWithTimeInterval:(double)a0;
- (void)_startSpeechRequestWithOptions:(id)a0 clearsContext:(char)a1 deviceSetupContext:(id)a2 deviceProblemsState:(id)a3 localDeviceContext:(id)a4 taskTracker:(id)a5 completion:(id /* block */)a6;
...
- (void)endWaitingForMyriadDecisionWithToken:(id)a0 result:(char)a1;
