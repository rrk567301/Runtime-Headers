...
- (void)bindBoolValue:(char)a0 toParameterNamed:(id)a1;
- (void)bindDateValue:(id)a0 toParameterNamed:(id)a1;
- (void)bindBoolValue:(char)a0 toParameterAtIndex:(long long)a1;
...
- (char)bindJSONValue:(id)a0 toParameterAtIndex:(long long)a1 error:(id *)a2;
- (char)bindJSONValue:(id)a0 toParameterNamed:(id)a1 error:(id *)a2;
