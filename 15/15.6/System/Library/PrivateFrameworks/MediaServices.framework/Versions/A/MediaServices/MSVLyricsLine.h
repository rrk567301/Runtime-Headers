...
@property (nonatomic, getter=isInstrumentalBreak) char instrumentalBreak;
...
@property (nonatomic) char hasBackgroundVocal;
...
- (void).cxx_destruct;
- (id)agent;
- (char)containsTimeOffset:(double)a0 withErrorMargin:(double)a1;
