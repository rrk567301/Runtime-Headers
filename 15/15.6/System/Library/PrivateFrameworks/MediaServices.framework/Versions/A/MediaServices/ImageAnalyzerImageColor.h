...
@property (readonly, nonatomic) char isBackgroundLight;
@property (readonly, nonatomic) char isPrimaryColorLight;
@property (readonly, nonatomic) char isSecondaryColorLight;
...
- (char)isEqualToImageColor:(id)a0;
