...
- (char)addScoreForModelWithClientModelId:(id)a0 clientModelVersion:(id)a1 score:(id)a2;
...
- (char)registerModelWithClientModelId:(id)a0 clientModelVersion:(id)a1 normalizationParameters:(id)a2;
