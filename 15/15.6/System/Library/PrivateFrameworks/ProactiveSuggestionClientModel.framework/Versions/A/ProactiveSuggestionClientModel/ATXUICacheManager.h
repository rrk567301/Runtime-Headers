...
- (char)deleteCacheFileForConsumerSubType:(unsigned char)a0;
- (id)serializeLayout:(id)a0;
- (char)updateCachedLayout:(id)a0 consumerSubType:(unsigned char)a1;
- (char)writeSerializedDataToCacheFile:(id)a0 path:(id)a1;
