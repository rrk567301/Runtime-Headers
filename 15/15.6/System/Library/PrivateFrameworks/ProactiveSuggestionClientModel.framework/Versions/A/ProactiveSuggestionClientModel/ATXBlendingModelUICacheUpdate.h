...
- (id)jsonRawData;
- (char)checkAndReportDecodingFailureIfNeededForint:(int)a0 key:(id)a1 coder:(id)a2 errorDomain:(id)a3 errorCode:(long long)a4;
...
- (char)isEqualToATXBlendingModelUICacheUpdate:(id)a0;
- (id)protoForBiome;
