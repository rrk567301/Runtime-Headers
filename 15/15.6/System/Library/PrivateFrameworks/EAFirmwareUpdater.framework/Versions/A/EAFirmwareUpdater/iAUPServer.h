...
@property (nonatomic) char byteEscape;
@property (nonatomic) char ackAppReentry;
...
@property (readonly, nonatomic) char sleepWakeRequired;
@property (readonly, nonatomic) char urgentUpdate;
...
- (id)initInstanceWithByteEscape:(char)a0;
