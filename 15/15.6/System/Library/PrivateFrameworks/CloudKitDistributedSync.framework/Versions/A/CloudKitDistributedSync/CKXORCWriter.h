...
- (char)commitBatchIfNeededWithError:(id *)a0;
- (char)commitBatchWithError:(id *)a0;
- (void)commitStruct:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0;
- (char)createWriterWithError:(id *)a0;
...
- (char)growCurrentBatchToIncludeBatchOffset:(unsigned long long)a0;
- (char)growCurrentBatchToIncludeRow:(unsigned long long)a0;
