...
+ (char)header:(struct { unsigned char x0; struct { unsigned char x0; unsigned char x1; } x1; } *)a0 forStorage:(id)a1 error:(id *)a2;
...
+ (char)prefixStorage:(id)a0 withHeaderForVersion:(unsigned char)a1 error:(id *)a2;
...
- (id)_proxyWithListInstance:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })a0 mutable:(char)a1 cacheScope:(long long)a2;
- (id)_proxyWithStructInstance:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0 mutable:(char)a1 cacheScope:(long long)a2;
- (char)_setupBackingStoreForReadingWithError:(id *)a0;
- (char)_setupBackingStoreForWritingWithError:(id *)a0;
- (char)_validateVersion:(unsigned char)a0 isReader:(char)a1 error:(id *)a2;
...
- (char)referenceIsNull:(unsigned long long)a0 inStruct:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a1;
...
- (char)setReadableStorage:(id)a0 error:(id *)a1;
- (char)setWritableStorage:(id)a0 error:(id *)a1;
- (id)structListProxyForListReference:(unsigned long long)a0 inStructInstance:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a1 mutable:(char)a2;
...
- (id)structProxyForStructReference:(unsigned long long)a0 inStructInstance:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a1 mutable:(char)a2;
