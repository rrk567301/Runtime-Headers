...
@property (readonly, nonatomic) char hasAccessibilityContentSizeCategory;
...
- (struct __CTFont { } *)newFontForTextStyle:(struct __CFString { } *)a0 attributes:(struct __CFDictionary { } *)a1;
...
- (id)initWithAccessibilityButtonShapes:(unsigned long long)a0 accessibilityContrast:(unsigned long long)a1 displayRange:(unsigned long long)a2 displayScale:(unsigned char)a3 layoutDirection:(unsigned long long)a4 legibilityWeight:(unsigned long long)a5 localization:(id)a6 preferredContentSizeCategory:(unsigned long long)a7 tintColor:(struct CGColor { } *)a8 userInterfaceIdiom:(unsigned long long)a9 userInterfaceStyle:(unsigned long long)a10 textStylePlatform:(unsigned long long)a11;
