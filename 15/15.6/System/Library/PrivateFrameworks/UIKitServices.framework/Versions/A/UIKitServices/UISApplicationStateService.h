...
- (char)_isCurrentConnectionAuthorizedForApplicationBundleIdentifier:(id)a0 description:(id)a1;
- (char)_isCurrentConnectionAuthorizedForApplicationBundleIdentifier:(id)a0 description:(id)a1 legacyEntitlement:(id)a2;
