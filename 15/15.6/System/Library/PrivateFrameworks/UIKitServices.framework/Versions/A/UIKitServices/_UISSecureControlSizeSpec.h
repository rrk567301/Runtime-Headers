...
@property (readonly, nonatomic) char arrangeVertically;
...
- (char)isEquivalentToStyle:(id)a0 tag:(id)a1;
- (id)initWithCategory:(id)a0 arrangeVertically:(char)a1 accessibilityContrast:(unsigned long long)a2 displayScale:(unsigned char)a3 layoutDirection:(unsigned long long)a4 legibilityWeight:(unsigned long long)a5 localization:(id)a6 preferredContentSizeCategory:(unsigned long long)a7 userInterfaceIdiom:(unsigned long long)a8;
