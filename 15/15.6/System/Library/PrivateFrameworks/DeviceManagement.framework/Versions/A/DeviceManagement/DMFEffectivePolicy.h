...
@property (readonly, nonatomic) char downtimeEnforced;
...
- (id)initWithType:(id)a0 defaultPolicy:(long long)a1 currentPoliciesByIdentifier:(id)a2 defaultPriority:(unsigned long long)a3 prioritiesByIdentifier:(id)a4 excludedIdentifiers:(id)a5 downtimeEnforced:(char)a6;
