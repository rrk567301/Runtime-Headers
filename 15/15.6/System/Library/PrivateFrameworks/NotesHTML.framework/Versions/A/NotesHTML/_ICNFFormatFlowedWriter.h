...
@property (nonatomic) char addedTrailingSpaces;
...
- (id)init;
- (void).cxx_destruct;
- (unsigned long long)_findLineBreakInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 maxCharWidthCount:(unsigned long long)a1 endIsURL:(char)a2;
