...
+ (char)ispAccountInformationAvailableForDomain:(id)a0;
...
- (void).cxx_destruct;
- (void)emptyCache;
- (id)_deliveryAccountsSettingsForDomain:(id)a0 fetchIfNecessary:(char)a1;
- (char)_getAccountIsReceivingAccount:(char *)a0 isDeliveryAccount:(char *)a1 fromAccountSettings:(id)a2;
- (void)_loadISPAccountsIfNecessary;
- (void)_loadISPPlist:(id)a0 bundle:(id)a1 path:(id)a2;
- (void)_loadISPPlistsAtPath:(id)a0;
- (char)_persistISPPlist:(id)a0;
- (id)_persistanceFolderName;
- (id)_persistantAccountSettings:(id)a0;
- (id)_persistantISPAccountSettings:(id)a0;
- (id)_receivingAccountSettingsForDomain:(id)a0 fetchIfNecessary:(char)a1;
