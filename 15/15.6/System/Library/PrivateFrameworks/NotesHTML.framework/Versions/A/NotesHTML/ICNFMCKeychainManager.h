...
+ (char)canEncryptMessagesToAddress:(id)a0;
+ (char)canEncryptMessagesToAddresses:(id)a0 sender:(id)a1;
+ (char)canSignMessagesFromAddress:(id)a0;
+ (char)configureTLSCertificatesPopUp:(id)a0 usingPersistentReference:(char)a1 withOldIdentity:(id)a2 newIdentity:(id *)a3;
