...
@interface CVNLPCTCTextDecodingPath : CVNLPTextDecodingPath {
    ...
    char _hasExpanded;
    char _hasProblematicMixedScriptWords;
    char _hasCalculatedHasProblematicMixedScriptWords;
...
@property (readonly) char optimizingAlignment;
...
@property (readonly, nonatomic) char hasExpanded;
@property (readonly, nonatomic) id /* block */ scoringFunction;

+ (id)_getQueue;
+ (void)applyWordLanguageModelProbabilityToPath:(id)a0 stemmedFromPath:(id)a1 isCommittingToken:(char)a2;
...
- (id)tokensWithTimestep:(long long)a0 isFinalTimestep:(char)a1;
