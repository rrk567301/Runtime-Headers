...
@property (readonly, nonatomic) char hasPrecedingSpace;
...
- (void).cxx_destruct;
- (id)initWithString:(id)a0 score:(id)a1 activationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 hasPrecedingSpace:(char)a3;
