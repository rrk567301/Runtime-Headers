...
@property (readonly, nonatomic) char hasProblematicMixedScriptWords;
...
+ (id /* block */)defaultPathScoringFunctionPruneProblematicMixedScriptWordPaths:(char)a0;
+ (id /* block */)defaultPathScoringFunction;
+ (id /* block */)defaultPathScoringFunctionForLanguageResourceBundle:(id)a0;
+ (id /* block */)defaultPathScoringFunctionForLanguageResourceBundle:(id)a0 pruneProblematicMixedScriptWordPaths:(char)a1;

- (id)init;
- (void).cxx_destruct;
- (id)initWithCharacterLanguageModelLogProbability:(double)a0 wordLanguageModelLogProbability:(double)a1 lexiconScore:(double)a2 hasProblematicMixedScriptWords:(char)a3 string:(id)a4;
