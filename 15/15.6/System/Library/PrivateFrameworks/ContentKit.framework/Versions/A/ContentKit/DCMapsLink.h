...
@property (readonly, nonatomic) char canGetDirections;
...
@property (readonly, nonatomic) char showsTraffic;
@property (readonly, nonatomic) char showsTransit;
@property (readonly, nonatomic) char showsStreetView;
@property (readonly, nonatomic) char showsBicycling;
...
+ (void)createMapsLinkWithPlacemark:(id)a0 location:(id)a1 streetAddress:(id)a2 shiftingLocationIfNecessary:(char)a3 completionHandler:(id /* block */)a4;
...
+ (void)processLocation:(id)a0 shiftingIfNecessary:(char)a1 completionHandler:(id /* block */)a2;
