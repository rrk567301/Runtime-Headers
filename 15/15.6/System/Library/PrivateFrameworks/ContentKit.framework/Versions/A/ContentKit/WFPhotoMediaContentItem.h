...
- (void)generateAVAsset:(id /* block */)a0 networkAccessAllowed:(char)a1;
...
- (char)isPhotoType:(id)a0;
- (char)loadsListThumbnailAsynchronously;
- (id)metadataIfLocallyAvailable;
- (id)outputTypes;
- (id)photoTypes;
- (id)preferredAssetResourceForType:(id)a0;
- (void)retrieveAssetResource:(id)a0 withNetworkAccess:(char)a1 completionHandler:(id /* block */)a2;
