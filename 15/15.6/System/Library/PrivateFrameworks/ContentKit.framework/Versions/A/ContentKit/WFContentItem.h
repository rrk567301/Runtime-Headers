...
@property (class, readonly, nonatomic) char supportedTypesMustBeDeterminedByInstance;
...
@property (class, readonly, nonatomic) char canLowercaseTypeDescription;
...
@property (class, readonly, nonatomic) long long tableTemplateSubjectType;
...
+ (id)coercions;
+ (char)contentItems:(id)a0 haveContentProperties:(id)a1;
+ (id /* block */)contentPropertySubstitutor;
+ (char)errorIsBadCoercionError:(id)a0;
...
+ (id)itemWithRepresentation:(id)a0 attributionSet:(id)a1 includesDefaultAttributionSet:(char)a2;
...
+ (id)itemWithRepresentation:(id)a0 forType:(id)a1 attributionSet:(id)a2 includesDefaultAttributionSet:(char)a3;
+ (id)itemWithRepresentation:(id)a0 forType:(id)a1 attributionSet:(id)a2 includesDefaultAttributionSet:(char)a3 cachingIdentifier:(id)a4;
...
+ (char)supportedItemClassMustBeDeterminedByInstance:(Class)a0;
...
- (char)canEncodeWithCoder:(id)a0;
- (char)canGenerateIntermediaryRepresentationForItemClass:(Class)a0;
...
- (char)coercionOptions:(id)a0 allowCoercionsToItemClass:(Class)a1;
- (char)coercionOptions:(id)a0 allowCoercionsToType:(id)a1;
...
- (id)initWithRepresentation:(id)a0 forType:(id)a1 attributionSet:(id)a2 includesDefaultAttributionSet:(char)a3;
- (id)initWithRepresentation:(id)a0 forType:(id)a1 attributionSet:(id)a2 includesDefaultAttributionSet:(char)a3 cachingIdentifier:(id)a4;
- (id)initWithRepresentationsByType:(id)a0 forType:(id)a1 subItemsByClass:(id)a2 attributionSet:(id)a3 includesDefaultAttributionSet:(char)a4 cachingIdentifier:(id)a5;
...
- (char)loadsListContentAsynchronously;
