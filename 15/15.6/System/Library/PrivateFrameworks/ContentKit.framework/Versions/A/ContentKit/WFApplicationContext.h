...
@property (nonatomic) char canLoadShortcutsDatabaseEntitlementChecked;
...
@property (readonly, nonatomic) char canLoadShortcutsDatabase;
@property (readonly, nonatomic) char shouldReverseLayoutDirection;
@property (readonly, nonatomic) long long userInterfaceStyle;
@property (readonly, nonatomic) long long applicationState;
@property (nonatomic, getter=isIdleTimerDisabled) char idleTimerDisabled;
