...
@property (readonly, nonatomic) char mainScreenLoaded;
@property (readonly, nonatomic) char builtInScreenLoaded;
@property (readonly, nonatomic) NSString *serializationUUID;
@property (readonly, nonatomic) NSString *UUID;
@property (readonly, nonatomic) NSString *name;
@property (readonly, nonatomic) NSString *deviceName;
@property (readonly, nonatomic) WFImage *image;
@property (readonly, nonatomic) char isMainScreen;
@property (readonly, nonatomic) char isBuiltInScreen;
