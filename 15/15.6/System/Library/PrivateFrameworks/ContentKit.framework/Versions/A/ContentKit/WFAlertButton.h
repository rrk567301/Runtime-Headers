...
@property (readonly, nonatomic, getter=isPreferred) char preferred;

+ (id)buttonWithTitle:(id)a0 style:(long long)a1 handler:(id /* block */)a2;
+ (id)buttonWithTitle:(id)a0 style:(long long)a1 preferred:(char)a2 handler:(id /* block */)a3;
...
- (void).cxx_destruct;
- (id)initWithTitle:(id)a0 style:(long long)a1 handler:(id /* block */)a2 preferred:(char)a3;
