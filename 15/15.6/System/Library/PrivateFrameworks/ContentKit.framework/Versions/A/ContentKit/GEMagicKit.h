...
+ (id)magicForData:(id)a0 decompress:(char)a1;
+ (id)magicForFileAtPath:(id)a0;
+ (id)magicForFileAtPath:(id)a0 decompress:(char)a1;
+ (id)magicForFileAtURL:(id)a0;
+ (id)magicForFileAtURL:(id)a0 decompress:(char)a1;
+ (id)magicForObject:(id)a0 decompress:(char)a1;
