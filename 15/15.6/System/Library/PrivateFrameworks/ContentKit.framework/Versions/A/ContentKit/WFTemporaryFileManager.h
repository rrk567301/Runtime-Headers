...
+ (char)isTemporaryFile:(id)a0;
+ (void)markDirectoryAsPurgeableAtURL:(id)a0;
+ (id)proposedFileURLForFilename:(id)a0 atTheRootOfDirectory:(id)a1;
+ (id)proposedFileURLForFilename:(id)a0 atTheRootOfDirectory:(id)a1 isDirectory:(char)a2;
+ (id)proposedFileURLForFilename:(id)a0 inDirectory:(id)a1;
+ (id)proposedFileURLForFilename:(id)a0 inDirectory:(id)a1 isDirectory:(char)a2;
+ (id)proposedSharedTemporaryFileURLForFilename:(id)a0;
+ (id)proposedSharedTemporaryFileURLForFilename:(id)a0 isDirectory:(char)a1;
+ (id)proposedTemporaryFileURLForFilename:(id)a0;
+ (id)proposedTemporaryFileURLForFilename:(id)a0 isDirectory:(char)a1;
