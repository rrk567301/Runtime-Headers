...
@property (readonly) char discontinous;
@property (readonly) unsigned long long captureTimeInHostClock;
@property struct __CFDictionary { } *transportAttachments;

- (void)dealloc;
- (id)description;
- (char)appendDataToBlockBuffer:(id)a0 bytesPerRowAllignment:(unsigned long long)a1 error:(id *)a2;
- (char)appendNonAlignedDataToBlockBuffer:(id)a0 expectedBytesPerRowAllignment:(unsigned long long)a1 error:(id *)a2;
- (id)initWithBuffer:(void *)a0 presentationTimestamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 presentationDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 discontinous:(char)a3 captureTimeInHostClock:(unsigned long long)a4;
