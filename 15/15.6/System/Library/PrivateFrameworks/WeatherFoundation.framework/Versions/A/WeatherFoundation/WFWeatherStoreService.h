...
- (char)_cacheParsedForecastData:(id)a0 types:(unsigned long long)a1 location:(id)a2 date:(id)a3 requestIdentifier:(id)a4;
...
- (char)_handleDataTaskCompletionWithData:(id)a0 httpResponse:(id)a1 apiVersion:(id)a2 identifier:(id)a3 requestURL:(id)a4 dataTask:(id)a5 dataTaskError:(id)a6 startDate:(id)a7;
- (char)_isConnectivityAvailableForWeatherHost:(id *)a0;
