...
+ (char)removeObjectsFromCache:(id)a0 passingTest:(id /* block */)a1;
+ (id)wf_mainDomains;
...
- (char)_concurrentQueue_barrier_loadDomain:(id)a0;
...
- (void)cache:(id)a0 withinDomain:(id)a1 date:(id)a2 forKey:(id)a3 expiration:(id)a4 synchronous:(char)a5;
