...
- (char)addObjects:(id)a0 andRemoveObjects:(id)a1 fromArrayAtKeyPath:(id)a2 synchronous:(char)a3 responseQueue:(id)a4 withCompletion:(id /* block */)a5;
...
- (char)addObjects:(id)a0 toArrayAtKeyPath:(id)a1 synchronous:(char)a2 responseQueue:(id)a3 withCompletion:(id /* block */)a4;
...
- (id)lastModifiedDateForContextualKeyPath:(id)a0 synchronous:(char)a1 responseQueue:(id)a2 withCompletion:(id /* block */)a3;
...
- (id)objectForContextualKeyPath:(id)a0 synchronous:(char)a1 responseQueue:(id)a2 withCompletion:(id /* block */)a3;
...
- (char)removeObjects:(id)a0 fromArrayAtKeyPath:(id)a1 synchronous:(char)a2 responseQueue:(id)a3 withCompletion:(id /* block */)a4;
...
- (id)removeObjectsMatchingPredicate:(id)a0 fromArrayAtKeyPath:(id)a1 synchronous:(char)a2 responseQueue:(id)a3 withCompletion:(id /* block */)a4;
...
- (char)setObject:(id)a0 forContextualKeyPath:(id)a1 synchronous:(char)a2 responseQueue:(id)a3 withCompletion:(id /* block */)a4;
- (char)setObject:(id)a0 lastModifiedDate:(id)a1 forContextualKeyPath:(id)a2;
...
- (id)valuesForKeyPaths:(id)a0 synchronous:(char)a1 responseQueue:(id)a2 withCompletion:(id /* block */)a3;
