...
+ (id)modifiedDateKey;
+ (id)predicateForDoNotDisturbStatus:(char)a0;
+ (id)calleeHandleKey;
+ (id)clipBundleIDKey;
...
+ (id)predicateForAudioOutputStatus:(char)a0;
+ (id)predicateForBatteryLevel:(id)a0;
+ (id)predicateForBluetoothConnectedAndUserIsWearing:(char)a0;
+ (id)predicateForBluetoothConnectionStatus:(char)a0;
+ (id)predicateForCellConnectionAvailability:(char)a0;
+ (id)predicateForCircularLocationRegion:(id)a0;
+ (id)predicateForCircularLocationRegion:(id)a0 state:(long long)a1;
+ (id)predicateForInUseStatus:(char)a0;
+ (id)predicateForMDCSDevicesWithDeviceTypes:(unsigned long long)a0;
+ (id)predicateForPluginStatus:(char)a0;
...
+ (id)predicateForWiFiConnectionAvailability:(char)a0;
+ (id)predicateForWiredConnectionAvailability:(char)a0;
