...
- (char)_withMOFromEntityWithName:(id)a0 andUniqunessPredicate:(id)a1 insert:(char)a2 update:(id /* block */)a3;
- (void)deleteAllData;
- (void)deleteDataCreatedBefore:(id)a0;
- (void)deleteRegistration:(id)a0;
- (char)fromEntityWithName:(id)a0 deleteObjectsMatching:(id)a1;
- (char)fromEntityWithName:(id)a0 fetchAllObjectsMatchingPredicate:(id)a1 handlingMOs:(id /* block */)a2;
- (id)getMOC;
...
- (char)withMOFromEntityWithName:(id)a0 andUniqunessPredicate:(id)a1 insertOrUpdate:(id /* block */)a2;
- (char)withMOFromEntityWithName:(id)a0 andUniqunessPredicate:(id)a1 update:(id /* block */)a2;
