...
- (char)setObject:(id)a0 forKeyedSubscript:(id)a1;
- (void)deregisterCallback:(id)a0;
- (void)registerCallback:(id)a0;
- (id)propertiesForContextualKeyPath:(id)a0;
- (char)setObject:(id)a0 forContextualKeyPath:(id)a1;
- (void)addCallback:(id)a0 forKeyPath:(id)a1;
- (char)addObjects:(id)a0 andRemoveObjects:(id)a1 fromArrayAtKeyPath:(id)a2;
- (id)addObjects:(id)a0 andRemoveObjects:(id)a1 fromArrayAtKeyPath:(id)a2 valueDidChange:(char *)a3;
- (char)addObjects:(id)a0 toArrayAtKeyPath:(id)a1;
- (id)allRegistrations;
- (char)evaluatePredicate:(id)a0 date:(id)a1;
- (void)evalutateRegistrationPredicatesWithPreviousContextValue:(id)a0 date:(id)a1 keyPath:(id)a2;
- (char)hasKnowledgeOfContextualKeyPath:(id)a0;
...
- (char)removeObjects:(id)a0 fromArrayAtKeyPath:(id)a1;
...
- (id)unsafe_addObjects:(id)a0 andRemoveObjects:(id)a1 fromArrayAtKeyPath:(id)a2 valueDidChange:(char *)a3;
