...
- (char)terminatePlugInAtURL:(id)a0 withError:(id *)a1;
...
- (char)releaseHold:(id)a0 flags:(unsigned long long)a1 withError:(id *)a2;
- (void)releaseHold:(id)a0 reply:(id /* block */)a1;
- (char)releaseHold:(id)a0 withError:(id *)a1;
