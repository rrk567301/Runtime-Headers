...
- (void)checkIn;
- (void)_prepareToRunUsingServiceListener:(char)a0;
- (char)_processDefaultSubsystemName:(id)a0;
...
- (id)discoverSubsystemNamed:(id)a0 options:(id)a1 required:(char)a2;
...
- (void)runUsingServiceListener:(char)a0;
- (void)scheduleTermination:(double)a0;
- (char)unregisterPersonality:(id)a0;
