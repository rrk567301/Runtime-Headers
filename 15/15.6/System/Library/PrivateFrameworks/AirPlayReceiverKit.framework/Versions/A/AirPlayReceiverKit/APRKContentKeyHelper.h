...
@property (nonatomic) char forwardsFPSSecureStopData;
...
- (void)_performContentKeyRequest:(id)a0 isRenewalRequest:(char)a1;
- (void)forgetAllActiveContentKeyRequests;
- (char)isHandlingContentKeyRequestWithURLString:(id)a0;
