...
@property (nonatomic) char needsSharingAlert;
...
- (void)abort;
- (char)populateMenu:(id)a0 forSharableObjects:(id)a1 sharingParams:(id)a2;
...
- (char)populateMenu:(id)a0 forSharableObjects:(id)a1 sharingParams:(id)a2 allowedLatency:(double)a3 completion:(id /* block */)a4;
