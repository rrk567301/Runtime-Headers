...
@property (readonly, nonatomic) char canProvideImage;
@property (readonly, nonatomic) char canProvideMovie;
@property (readonly, nonatomic) char shouldDelayShowingPrepareProgressUntilNonZeroProgress;
