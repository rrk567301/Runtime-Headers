...
+ (char)createScreenshot:(id)a0 properties:(id)a1 queue:(id)a2 handler:(id /* block */)a3 error:(id *)a4;
...
- (char)updateFilter:(id)a0 error:(id *)a1;
- (char)updateProperties:(id)a0 error:(id *)a1;
