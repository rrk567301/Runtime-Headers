...
- (char)commitBrightnessPolicy:(id *)a0;
- (id)controllerWithId:(unsigned int)a0;
- (char)getFloat:(float *)a0 withKey:(const char *)a1 fromReply:(id)a2;
- (char)getWhitePointMatrix:(struct { float x0[9]; } *)a0 withKey:(const char *)a1 fromReply:(id)a2;
