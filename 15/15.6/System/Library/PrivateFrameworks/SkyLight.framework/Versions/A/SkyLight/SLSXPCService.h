...
- (id)initConnectionWithName:(id)a0 notificationQueue:(id)a1 withAutoreconnect:(char)a2 errorHandler:(id /* block */)a3 notificationBlock:(id /* block */)a4;
