...
- (void)orderWindow:(int)a0 relativeToID:(unsigned int)a1 relativeTo:(id)a2 orderGroup:(char)a3;
- (void)removeFromParent;
- (void)setFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 forceAsync:(char)a1;
