...
+ (id)vrrMapWithStaticParameters:(struct _WarpStaticParameters { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; float x1; float x2; float x3; float x4; BOOL x5; })a0 withDynamicParameters:(struct _WarpDynamicParameters { float x0; float x1; })a1 clampRateMaxCenter:(char)a2 outputRateMaxRectInPhysical:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; } *)a3 withDevice:(id)a4;

- (void)dealloc;
- (id)initWithLibrary:(id)a0 destinationPixelFormat:(unsigned long long)a1;
- (void)warpFromTexture:(id)a0 toTexture:(id)a1 withVRRMap:(id)a2 withCommandBuffer:(id)a3 withOptions:(struct _WarpRenderOptions { char x0; char x1; })a4;
