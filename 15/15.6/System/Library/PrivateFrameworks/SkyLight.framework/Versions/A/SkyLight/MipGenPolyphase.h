...
+ (struct _MipGenPolyphaseOptions { char x0; char x1; })defaultOptions;

- (void)dealloc;
- (void)copyAndGenerateMipmapsFromTexture:(id)a0 toTexture:(id)a1 withComputeEncoder:(id)a2;
- (void)copyAndGenerateMipmapsFromTexture:(id)a0 toTexture:(id)a1 withComputeEncoder:(id)a2 withOptions:(struct _MipGenPolyphaseOptions { char x0; char x1; })a3;
- (void)generateMipmapsForTexture:(id)a0 withComputeEncoder:(id)a1;
- (void)generateMipmapsForTexture:(id)a0 withComputeEncoder:(id)a1 withOptions:(struct _MipGenPolyphaseOptions { char x0; char x1; })a2;
