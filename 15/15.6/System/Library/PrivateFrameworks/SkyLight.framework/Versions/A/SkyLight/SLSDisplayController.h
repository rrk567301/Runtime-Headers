...
@property (nonatomic) char brightnessAvailable;
@property (nonatomic) char whitePointAvailable;
@property (nonatomic) char whitePointD50XYZ;
@property (nonatomic, getter=isOnline) char online;
...
- (char)abortContrastEnhancerRamp:(float *)a0 error:(id *)a1;
- (char)abortWhitePointRamp:(struct { float x0[9]; } *)a0 error:(id *)a1;
- (char)commitBrightness:(id *)a0;
- (char)commitBrightnessTimeouts:(id *)a0;
- (id)displayInfo;
...
- (char)setContrastEnhancer:(float)a0 rampDuration:(double)a1 error:(id *)a2;
