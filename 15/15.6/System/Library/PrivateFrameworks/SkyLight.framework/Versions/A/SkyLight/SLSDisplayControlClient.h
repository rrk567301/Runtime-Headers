...
- (char)isTypeOfClass:(id)a0 aClass:(Class)a1 error:(int *)a2;
...
- (id)registerDaemonClient:(id)a0 withAutoreconnect:(char)a1 error:(id *)a2 notifyQueue:(id)a3 notificationType:(unsigned long long)a4 notificationBlock:(id /* block */)a5;
