...
- (void)setBool:(char)a0 forKey:(char)a1;
- (void)removeAll;
- (char)getBool:(char *)a0 forKey:(char)a1;
...
- (id)initWithBools:(const char *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (void)removeBoolForKey:(char)a0;
