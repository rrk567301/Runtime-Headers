...
- (void)removeAll;
- (void)setInt32:(int)a0 forKey:(char)a1;
...
- (char)getInt32:(int *)a0 forKey:(char)a1;
- (id)initWithInt32s:(const int *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (void)removeInt32ForKey:(char)a0;
