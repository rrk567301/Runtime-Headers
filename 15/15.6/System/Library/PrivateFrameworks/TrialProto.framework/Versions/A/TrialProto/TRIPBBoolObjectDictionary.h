...
- (id)initWithObjects:(const id *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (id)objectForKey:(char)a0;
- (void)removeObjectForKey:(char)a0;
- (void)setObject:(id)a0 forKey:(char)a1;
- (char)isInitialized;
- (void)removeAll;
