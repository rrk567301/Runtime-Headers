...
- (void)setBool:(char)a0 forKey:(long long)a1;
- (void)removeAll;
- (char)getBool:(char *)a0 forKey:(long long)a1;
...
- (id)initWithBools:(const char *)a0 forKeys:(const long long *)a1 count:(unsigned long long)a2;
