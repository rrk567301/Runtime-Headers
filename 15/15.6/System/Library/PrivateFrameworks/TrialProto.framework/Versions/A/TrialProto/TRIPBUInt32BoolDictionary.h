...
- (void)setBool:(char)a0 forKey:(unsigned int)a1;
- (void)removeAll;
- (char)getBool:(char *)a0 forKey:(unsigned int)a1;
...
- (id)initWithBools:(const char *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
