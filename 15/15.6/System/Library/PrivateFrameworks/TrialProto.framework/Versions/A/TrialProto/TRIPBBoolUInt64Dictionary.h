...
- (char)getUInt64:(unsigned long long *)a0 forKey:(char)a1;
- (id)initWithUInt64s:(const unsigned long long *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (void)removeUInt64ForKey:(char)a0;
...
- (void)setUInt64:(unsigned long long)a0 forKey:(char)a1;
