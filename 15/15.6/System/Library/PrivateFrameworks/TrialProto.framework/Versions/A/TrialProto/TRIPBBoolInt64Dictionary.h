...
- (void)removeAll;
- (void)setInt64:(long long)a0 forKey:(char)a1;
...
- (char)getInt64:(long long *)a0 forKey:(char)a1;
- (id)initWithInt64s:(const long long *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (void)removeInt64ForKey:(char)a0;
