...
- (void)setDouble:(double)a0 forKey:(char)a1;
- (void)removeAll;
...
- (char)getDouble:(double *)a0 forKey:(char)a1;
- (id)initWithDoubles:(const double *)a0 forKeys:(const char *)a1 count:(unsigned long long)a2;
- (void)removeDoubleForKey:(char)a0;
