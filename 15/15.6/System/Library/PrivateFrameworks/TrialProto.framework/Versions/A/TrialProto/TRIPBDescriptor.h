...
@property (readonly, nonatomic, getter=isWireFormat) char wireFormat;
...
- (id)initWithClass:(Class)a0 file:(id)a1 fields:(id)a2 storageSize:(unsigned int)a3 wireFormat:(char)a4;
