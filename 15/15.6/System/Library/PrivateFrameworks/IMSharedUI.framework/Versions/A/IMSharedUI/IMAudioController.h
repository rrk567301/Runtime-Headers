...
@property (nonatomic) char shouldUseSpeaker;
@property (nonatomic) char shouldStopPlayingWhenSilent;
@property (nonatomic) char shouldDuckOthers;
@property (nonatomic) char shouldUseAVPlayer;
...
- (void)_notifyPlayerDidPrepareAudioURL:(id)a0 successfully:(char)a1;
...
- (void)audioPlayerDidPrepareAudioToPlay:(id)a0 successfully:(char)a1;
