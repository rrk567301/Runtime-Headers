@class NSString, CALayer, CAReplicatorLayer, NSColor;
...
@property (class, readonly, nonatomic) char supportsTypingIndicatorAnimation;

@property (readonly, nonatomic) NSColor *defaultBubbleColor;
@property (readonly, nonatomic) NSColor *defaultThinkingDotColor;
...
@property (copy, nonatomic) NSColor *bubbleColor;
@property (copy, nonatomic) NSColor *thinkingDotColor;
@property (nonatomic) double bubbleOpacity;
@property (nonatomic) double thinkingDotOpacity;
@property (copy, nonatomic) NSColor *customBubbleColor;
...
- (void)_forceImmediateRedrawOnLayer:(id)a0;
