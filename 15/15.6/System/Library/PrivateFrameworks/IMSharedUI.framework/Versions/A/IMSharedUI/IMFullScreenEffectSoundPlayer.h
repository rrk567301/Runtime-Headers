...
@property (readonly, nonatomic) char hasHapticTrack;
@property (nonatomic) float currentVolume;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (weak) id<IMFullScreenEffectSoundPlayerDelegate> delegate;

- (void).cxx_destruct;
- (void)_didPrepare;
- (void)audioController:(id)a0 didChangeProgressForContentAtURL:(id)a1 currentTime:(double)a2 duration:(double)a3;
- (void)audioController:(id)a0 didPrepareToPlayContentAtURL:(id)a1 successfully:(char)a2;
...
- (void)_didStart;
- (void)_didStop;
- (id)initWithSoundURL:(id)a0 hasHapticTrack:(char)a1;
