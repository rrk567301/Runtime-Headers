...
@property (readonly, nonatomic) char usesAVPlayer;
...
+ (id)audioPlayerWithContentsOfURL:(id)a0 shouldUseAVPlayer:(char)a1;
...
- (id)initWithContentsOfURL:(id)a0 shouldUseAVPlayer:(char)a1;
- (void)internalAVAudioPlayerDidPrepareAudioForPlaying:(id)a0 successfully:(char)a1;
- (void)internalAudioPlayerDidFinishPlaying:(id)a0 successfully:(char)a1;
