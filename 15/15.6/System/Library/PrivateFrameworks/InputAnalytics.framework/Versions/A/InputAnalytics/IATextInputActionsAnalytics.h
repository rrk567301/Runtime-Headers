...
@interface IATextInputActionsAnalytics : NSObject {
    ...
    char _useAnalyticsDaemon;
    char _useLocalAnalytics;
...
- (void)didDictationBegin:(char)a0 usesMultiModalDictation:(char)a1;
...
- (void)_didDeleteBackwardCount:(unsigned long long)a0 withType:(long long)a1 shouldOverrideInputActionCountToZero:(char)a2 withInputMode:(id)a3 forceNotMarkedText:(char)a4;
- (void)_didDeleteBackwardText:(id)a0 withType:(long long)a1 shouldOverrideInputActionCountToZero:(char)a2 withInputMode:(id)a3 forceNotMarkedText:(char)a4;
- (void)_didDeleteBackwardTextDetails:(id)a0 withType:(long long)a1 shouldOverrideInputActionCountToZero:(char)a2 withInputMode:(id)a3 forceNotMarkedText:(char)a4;
...
- (void)_didReplacementForText:(id)a0 withText:(id)a1 allowNilText:(char)a2 allowEmptyText:(char)a3 allowNilReplacement:(char)a4 withSource:(long long)a5 withType:(long long)a6 withInputActionCount:(long long)a7;
