...
@property (readonly, nonatomic) char changedContent;
@property (readonly, nonatomic) char isCapableOfTextInsertion;
...
+ (char)shouldSeparatelyTrackKeystrokesForSource:(long long)a0 type:(long long)a1;

- (id)description;
- (void).cxx_destruct;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (char)isMergeableWith:(id)a0;
