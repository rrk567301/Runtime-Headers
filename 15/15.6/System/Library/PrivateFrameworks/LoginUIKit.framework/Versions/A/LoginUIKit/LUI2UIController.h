...
@property char hasAuthorizationPluginView;
...
@property (getter=isPasswordRequired) char passwordRequired;
...
- (void)_updateControllersWithIncreaseContrast:(char)a0 image:(id)a1 displayID:(unsigned int)a2;
- (void)_updateKeyViews:(id)a0;
- (void)_updateUserNameLabelContraint;
- (id)_viewForPopover:(int)a0;
- (id)currentPopover;
- (char)escapePressed:(id)a0;
- (void)hidePopover;
- (id)initWithAuthorizationPluginView:(id)a0;
- (char)isShowingMultiUserLayout;
