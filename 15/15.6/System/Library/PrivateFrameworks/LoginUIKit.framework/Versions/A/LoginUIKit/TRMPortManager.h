...
@property (nonatomic) char matchingNotificationsStarted;
...
@property (readonly) char hasRestrictedPorts;
...
- (char)_startMatchingNotifications;
- (void)_stopMatchingNotifications;
- (void)_stopMatchingNotificationsAndQueueAllowingQueueDrain:(char)a0;
