...
+ (char)shouldRunBackstopUpload:(id)a0 currentDate:(id)a1 errorOut:(id *)a2;
+ (char)updateUploadSessionDateFromContainer:(id)a0 toDate:(id)a1 errorOut:(id *)a2;
...
- (void)_ckQueueDownstreamOnly_uploadInFlightWithTransaction:(id)a0 xpcActivity:(id)a1 ckHelper:(id)a2 isExpedited:(char)a3 completionBlock:(id /* block */)a4;
...
- (char)_connectionHasEntitlement:(id)a0;
- (char)_enableDataGatheringQueryPassesRandomRejection;
- (void)_finishReportingStatsSessionWithActivity:(id)a0 withState:(long long)a1 transaction:(id)a2 endResultString:(id)a3;
- (void)_finishUploadSessionWithActivity:(id)a0 withState:(long long)a1 isExpedited:(char)a2 transaction:(id)a3 completedSuccessfully:(char)a4 endResultString:(id)a5 completionBlock:(id /* block */)a6;
...
- (char)_persistEnableLogGatheringResult:(id)a0 workingContext:(id)a1;
...
- (void)_runCloudKitUploadWorkSessionWithTransaction:(id)a0 xpcActivity:(id)a1 isExpedited:(char)a2 completionBlock:(id /* block */)a3;
- (void)_runReportingSessionWithTransaction:(id)a0 xpcActivity:(id)a1;
- (char)_saveDampeningManagerErrorOut:(id *)a0;
- (void)_sendAdminRequestReply:(char)a0 rejectionReason:(const char *)a1 requestMessage:(id)a2;
...
- (char)_syncConfigurationToDisk:(id)a0;
...
- (char)clearUploadSessionDate:(id *)a0;
- (void)deactivateService;
- (void)handleRequest:(id)a0 state:(id)a1;
- (char)shouldRunBackstopUpload:(id *)a0;
- (char)updateUploadSessionDate:(id *)a0;
