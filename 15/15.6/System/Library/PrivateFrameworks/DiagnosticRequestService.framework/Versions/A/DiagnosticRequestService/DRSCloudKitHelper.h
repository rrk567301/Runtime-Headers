...
- (char)_handleRAPIDRequests:(id)a0 xpcActivity:(id)a1 errorsOut:(id)a2;
...
- (void)uploadRequests:(id)a0 contactDecisionServer:(char)a1 xpcActivity:(id)a2 remainingUploadQuota:(unsigned long long)a3 backingPersistentContainer:(id)a4 completionHandler:(id /* block */)a5;
