...
@property (readonly, nonatomic) char logTelemetry;
@property (readonly, nonatomic) char reportToDecisionServer;
...
+ (char)_isValidState:(unsigned char)a0 completionType:(unsigned long long)a1 receivedDate:(id)a2 appliedDate:(id)a3 completedDate:(id)a4 completionDescription:(id)a5;

- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)jsonDictionaryRepresentation;
- (id)_ON_CONTEXT_QUEUE_initWithConfigMetadataMO:(id)a0;
- (id)_ON_CONTEXT_QUEUE_moRepresentationInContext:(id)a0 createIfMissing:(char)a1 errorOut:(id *)a2;
- (char)_updateContextWithMORepresentation:(id)a0 errorOut:(id *)a1;
- (id)_uuidPredicate;
- (id)initWithTeamID:(id)a0 configUUID:(id)a1 state:(unsigned char)a2 completionType:(unsigned long long)a3 receivedDate:(id)a4 appliedDate:(id)a5 completedDate:(id)a6 completionDescription:(id)a7 config:(id)a8 logTelemetry:(char)a9 reportToDecisionServer:(char)a10;
