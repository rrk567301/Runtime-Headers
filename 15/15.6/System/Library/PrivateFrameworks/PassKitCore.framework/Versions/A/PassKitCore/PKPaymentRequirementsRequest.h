...
- (void)_cardDictionaryForDeviceData:(id)a0 inWebService:(id)a1 includingDeviceScore:(char)a2 withCompletion:(id /* block */)a3;
- (void)_deviceScoreUsingWebService:(id)a0 withCompletion:(id /* block */)a1;
- (void)_encryptedDataWithDeviceData:(id)a0 certChain:(id)a1 devSigned:(char)a2 includeDeviceScore:(char)a3 inWebService:(id)a4 withCompletion:(id /* block */)a5;
