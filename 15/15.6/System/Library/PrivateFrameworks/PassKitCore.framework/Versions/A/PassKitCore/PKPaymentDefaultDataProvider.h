...
@property (readonly, nonatomic) char isDeviceInRestrictedMode;
@property (readonly, nonatomic) NSString *secureElementIdentifier;
@property (readonly, nonatomic) char secureElementIsProductionSigned;
@property (retain, nonatomic) NSString *defaultPaymentPassIdentifier;
@property (readonly, nonatomic) char isPaymentHandoffDisabled;
@property (readonly, nonatomic) char isOrderManagementDisabled;
@property (readonly, nonatomic) char isOrderManagementNotificationsDisabled;
...
- (char)hideCardBenefitPayLater;
- (char)hideCardBenefitRewards;
- (char)hidePayLaterOptions;
...
- (void)setHideCardBenefitPayLater:(char)a0;
- (void)setHideCardBenefitRewards:(char)a0;
- (void)setHidePayLaterOptions:(char)a0;
- (void)setOrderManagementDisabled:(char)a0;
- (void)setOrderManagementNotificationsDisabled:(char)a0;
- (void)setPaymentHandoffDisabled:(char)a0;
...
- (char)supportsInAppPaymentsForPass:(id)a0;
- (char)supportsLowPowerExpressMode;
- (char)supportsMessagesForPass:(id)a0;
- (char)supportsNotificationsForPass:(id)a0;
- (char)supportsTransactionsForPass:(id)a0;
- (void)tilesForPassWithUniqueIdentifier:(id)a0 context:(long long)a1 completion:(id /* block */)a2;
- (void)transactionCountByPeriodForRequest:(id)a0 calendar:(id)a1 calendarUnit:(unsigned long long)a2 includePurchaseTotal:(char)a3 completion:(id /* block */)a4;
