...
- (void)usingSynchronousProxy:(char)a0 meetsProvisioningRequirements:(id)a1 completion:(id /* block */)a2;
...
- (void)getProvisioningDataIncludingDeviceMetadata:(char)a0 withCompletion:(id /* block */)a1;
