...
@property (readonly, nonatomic) char possibleIntraAccountSharing;
...
@property (nonatomic) char isManagingTimeConfiguration;
@property (nonatomic) char isManagingEntitlementConfiguration;
...
- (void)setEnabled:(char)a0 notifyIfRoot:(char)a1;
