...
- (char)_evaluateTrust:(struct __SecTrust { } *)a0;
...
- (void)performRequest:(id)a0 taskIdentifier:(unsigned long long)a1 cacheResponse:(char)a2 completionHandler:(id /* block */)a3;
- (void)performRequest:(id)a0 taskIdentifier:(unsigned long long)a1 completionHandler:(id /* block */)a2;
- (void)performRequest:(id)a0 taskIdentifier:(unsigned long long)a1 retries:(unsigned long long)a2 authHandling:(char)a3 cacheResponse:(char)a4 completionHandler:(id /* block */)a5;
- (void)performRequest:(id)a0 taskIdentifier:(unsigned long long)a1 retries:(unsigned long long)a2 authHandling:(char)a3 completionHandler:(id /* block */)a4;
