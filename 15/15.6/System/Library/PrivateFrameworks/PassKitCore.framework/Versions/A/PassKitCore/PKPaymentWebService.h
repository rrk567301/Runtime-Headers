...
@interface PKPaymentWebService : PKWebService <NSURLSessionDownloadDelegate> {
    ...
    char _handlingApplePayTrustReRegister;
}

@property (nonatomic) char sharedService;
...
@property (readonly) char registrationSetupSupportedInRegion;
...
- (unsigned long long)createVehicleKeyShareWithRequest:(id)a0 passTypeIdentifier:(id)a1 completion:(id /* block */)a2;
...
- (char)_canRegisterForPeerPayment;
...
- (void)_deviceProvisioningDataIncludingDeviceMetadata:(char)a0 withCompletion:(id /* block */)a1;
...
- (void)_handleRemoteAssetDownloadForManifestItem:(id)a0 taskPassURL:(id)a1 data:(id)a2 shouldWriteData:(char)a3;
- (void)_handleRemoteCloudStoreAssetForRecordName:(id)a0 taskRecord:(id)a1 data:(id)a2 shouldWriteData:(char)a3;
...
- (char)_needsRegistrationShouldCheckSecureElementOwnership:(char)a0;
...
- (unsigned long long)accountReportDeviceEventWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (void)backgroundDownloadPassesForPushTopic:(id)a0 sinceLastUpdatedTag:(char)a1;
- (void)backgroundDownloadPassesSinceLastUpdatedTag:(char)a0;
...
- (unsigned long long)devicePassesSinceLastUpdatedTag:(char)a0 withCompletion:(id /* block */)a1;
...
- (char)isChinaRegionIdentifier:(id)a0;
...
- (char)needsConfigurationWithSupportedRegionTimeInterval:(double)a0 unsupportedRegionTimeInterval:(double)a1;
...
- (unsigned long long)registerMerchantTokenPublicKeyWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (unsigned long long)retrieveMerchantTokensUnifiedListWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (id)supportedRegionFeatureOfType:(long long)a0 didFailOSVersionRequirements:(char *)a1;
...
- (unsigned long long)vpanPaymentCredentialsForPaymentPass:(id)a0 vpanIdentifier:(id)a1 nonce:(id)a2 encryptionFields:(id)a3 merchantHost:(id)a4 regenerate:(char)a5 completion:(id /* block */)a6;
