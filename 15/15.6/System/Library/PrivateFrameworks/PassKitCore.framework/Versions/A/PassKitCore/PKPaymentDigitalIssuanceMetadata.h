@class NSString, NSArray, NSDictionary, NSSet, PKDigitalIssuanceServiceProviderProduct;
...
@property (readonly, nonatomic, getter=isPurchaseBased) char purchaseBased;
