...
- (void)_requestProvisioning:(id)a0 externalizedAuth:(id)a1 cloudStoreCoordinatorDelegate:(id)a2 downloadPasses:(char)a3 resolveEnableRequirements:(char)a4 onStartPassDownload:(id /* block */)a5 sid:(id)a6 completion:(id /* block */)a7;
...
- (void)requestProvisioning:(id)a0 externalizedAuth:(id)a1 cloudStoreCoordinatorDelegate:(id)a2 onStartPassDownload:(id /* block */)a3 sid:(id)a4 requireZoneCreationSuccess:(char)a5 completion:(id /* block */)a6;
