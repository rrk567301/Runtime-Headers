...
- (void)_receivedMessage:(id)a0 isRequest:(char)a1 service:(id)a2 account:(id)a3 fromID:(id)a4 context:(id)a5;
...
- (void)_setProtobufAction:(SEL)a0 target:(id)a1 messageType:(unsigned short)a2 isRequest:(char)a3 queue:(id)a4;
- (void)registerListenerForMessageType:(unsigned short)a0 isRequest:(char)a1 referenceObject:(id)a2 onMessageReceived:(id /* block */)a3;
- (void)registerListenerForMessageType:(unsigned short)a0 isRequest:(char)a1 referenceObject:(id)a2 queue:(id)a3 onMessageReceived:(id /* block */)a4;
