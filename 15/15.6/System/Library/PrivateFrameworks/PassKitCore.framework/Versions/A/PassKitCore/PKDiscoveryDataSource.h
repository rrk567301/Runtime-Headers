...
- (char)_queue_updateArticleLayouts:(id)a0;
...
- (void)displayedDiscoveryItem:(id)a0 isWelcomeCard:(char)a1 afterSwipingToCard:(char)a2 multipleStoryCardsAvailable:(char)a3 callToAction:(long long)a4 cardSize:(long long)a5;
