...
@property (readonly, nonatomic) char isOwnable;
@property (readonly, nonatomic) char isProductionSigned;
@property (readonly, nonatomic) char isInRestrictedMode;
@property (readonly, nonatomic) char isDeletingAllApplets;
...
+ (char)supportsExpressMode:(id)a0 byHardware:(char *)a1;
...
+ (char)hardwareSupportsExpressForAutomaticSelectionTechnologyType:(long long)a0;
+ (char)hardwareSupportsExpressForAutomaticSelectionTechnologyType:(long long)a0 outError:(id *)a1;
+ (char)hardwareSupportsExpressMode:(id)a0;
...
+ (char)supportsExpressForAutomaticSelectionTechnologyType:(long long)a0 byHardware:(char *)a1;
+ (char)supportsExpressForAutomaticSelectionTechnologyType:(long long)a0 byHardware:(char *)a1 outError:(id *)a2;
...
- (void)_executeSecureElementSessionHandlersWithPriority:(char)a0 session:(id)a1;
...
- (void)connectToServerWithPushTopic:(id)a0 performSECleanup:(char)a1 completion:(id /* block */)a2;
...
- (void)deleteFidoKeyForRelyingParty:(id)a0 relyingPartyAccountHash:(id)a1 fidoKeyHash:(id)a2 completion:(id /* block */)a3;
...
- (void)initializeSecureElementQueuingServerConnection:(char)a0 withCompletion:(id /* block */)a1;
...
- (char)queueConnectionToServerForAppletIdentifiers:(id)a0;
- (char)queueConnectionToServerWithPushTopic:(id)a0;
- (void)remoteAdminCleanupProgress:(double)a0;
- (void)secureElement:(id)a0 didChangeRestrictedMode:(char)a1;
- (char)setOwnerUserUUID:(id)a0 keybagUUID:(id)a1;
- (void)setOwnerUserUUID:(id)a0 keybagUUID:(id)a1 withCompletion:(id /* block */)a2;
- (char)setRegistrationInformation:(id)a0 primaryRegionTopic:(id)a1;
...
- (char)supportsExpressModeForExpressPassType:(long long)a0;
- (void)updateAliroCredentialDocumentStatusWithSubcredentialIdentifier:(id)a0 documentType:(unsigned long long)a1 isDocumentPresent:(BOOL)a2 signedDate:(id)a3 withCompletion:(id /* block */)a4;
