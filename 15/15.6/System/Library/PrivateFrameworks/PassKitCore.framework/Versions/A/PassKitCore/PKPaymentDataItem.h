...
@property (class, readonly, nonatomic) char supportsMultipleItems;

@property (weak, nonatomic) PKPaymentAuthorizationDataModel *model;
@property (nonatomic) long long type;
@property (nonatomic) long long status;
@property (readonly, nonatomic) long long context;
@property (readonly, nonatomic, getter=isRejected) char rejected;
...
+ (long long)dataType;
+ (char)validateBillingAddressForItem:(id)a0 billingAddress:(id)a1 outError:(id *)a2;
