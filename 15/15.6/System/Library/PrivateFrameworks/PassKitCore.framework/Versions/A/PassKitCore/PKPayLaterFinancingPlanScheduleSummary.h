...
- (id)currencyAmountOfPaymentIdentifierAffectingOtherInstallments:(id)a0 relativeInstallmentIdentifier:(id)a1 installmentsAreInOrder:(char *)a2 countOfInstallments:(long long *)a3;
- (id)firstInstallmentIdentifierAffectedByPaymentIdentifier:(id)a0;
- (char)hasPaymentsOrInstallmentsAfterInstallmentDueDate:(id)a0;
- (long long)installmentNumberForInstallmentIdentifier:(id)a0;
- (id)installmentsAffectedByPaymentIdentifier:(id)a0;
- (char)isEqualToPayLaterScheduleSummary:(id)a0;
- (id)lastPayment;
- (id)nextDueInstallment;
- (char)paymentIdentifierDidPayoffFinancingPlan:(id)a0;
