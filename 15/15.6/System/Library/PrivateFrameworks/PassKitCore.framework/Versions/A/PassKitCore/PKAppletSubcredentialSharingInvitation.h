...
@property (nonatomic, getter=isForWatch) char forWatch;
...
@property (readonly, nonatomic) char isThirdPartyCrossPlatformInvitation;
...
- (char)isEqualToInvitation:(id)a0;
- (char)isSameInvitationAsInvitation:(id)a0;
