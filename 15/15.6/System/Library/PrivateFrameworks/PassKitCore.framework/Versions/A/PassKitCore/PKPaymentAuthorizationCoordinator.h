...
@property (nonatomic) char didPresent;
...
@property (nonatomic) char remotePaymentRequestPromised;
...
+ (char)_canMakePaymentsUsingNetworks:(id)a0 capabilities:(unsigned long long)a1 webDomain:(id)a2 paymentRequestType:(id)a3;
+ (char)canMakePaymentsUsingNetworks:(id)a0 capabilities:(unsigned long long)a1 webDomain:(id)a2;
+ (char)canMakePaymentsUsingNetworks:(id)a0 webDomain:(id)a1;
+ (char)supportsDisbursements;
+ (char)supportsDisbursementsUsingNetworks:(id)a0;
+ (char)supportsDisbursementsUsingNetworks:(id)a0 capabilities:(unsigned long long)a1;
...
- (void)_invokeCallbackWithSuccess:(char)a0;
...
- (id)initWithPaymentRequest:(id)a0 remotePaymentRequestPromised:(char)a1;
