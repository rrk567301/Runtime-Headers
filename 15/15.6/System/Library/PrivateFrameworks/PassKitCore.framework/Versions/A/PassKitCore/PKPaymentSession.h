...
+ (id)STSCredentialForPaymentApplication:(id)a0 subcredential:(id)a1 onSecureElementPass:(id)a2;
...
+ (BOOL)useSTSForPaymentApplication:(id)a0 subcredential:(id)a1 onSecureElementPass:(id)a2;
