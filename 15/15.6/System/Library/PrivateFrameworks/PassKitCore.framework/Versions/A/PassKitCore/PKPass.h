...
@property (readonly, nonatomic) char silenceRequested;
...
@property (readonly, nonatomic) char hasFlightDetails;
...
@property (nonatomic, getter=isRemotePass) char remotePass;
...
@property (nonatomic) char hasStoredValue;
@property (readonly, nonatomic) char shouldRampBacklight;
...
@property (nonatomic) char liveRenderedBackground;
@property (nonatomic) char supportsCategoryVisualization;
...
@property (nonatomic) char liveRenderingRequiresEnablement;
...
@property (readonly, nonatomic) char isPersonalizable;
@property (readonly, nonatomic) char isValid;
@property (nonatomic) char muteReadyForUseNotification;
@property (nonatomic) char supportsLifecycleUpdates;
@property (readonly, nonatomic) char supportsIssuerBinding;
...
- (char)isPastRelevancy;
- (char)supportsSyncing;
...
- (char)isExpiredBasedOnSigningDate;
...
- (id)stripImage;
- (char)supportsFeature:(unsigned long long)a0 forDevice:(id)a1 version:(id)a2;
...
- (id)venueMapImage;
- (char)wasAchivedInCloudStoreWithIdentifier:(id)a0;
