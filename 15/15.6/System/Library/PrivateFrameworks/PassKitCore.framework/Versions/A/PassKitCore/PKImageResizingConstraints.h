...
@property (nonatomic) char outputMirrored;
...
- (char)_getPixelCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 pixelOutputSize:(struct CGSize { double x0; double x1; } *)a1 forImageSize:(struct CGSize { double x0; double x1; })a2 scale:(double)a3;
- (char)_reasonable;
- (char)getPixelCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 pixelOutputSize:(struct CGSize { double x0; double x1; } *)a1 forImage:(id)a2;
