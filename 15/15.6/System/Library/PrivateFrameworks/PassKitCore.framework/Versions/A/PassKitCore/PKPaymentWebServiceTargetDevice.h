...
- (char)areUnifiedAccessPassesSupported;
...
- (char)_willPassWithUniqueIdentifierAutomaticallyBecomeDefault:(id)a0;
...
- (char)areAliroAccessPassesSupported;
...
- (char)isCarKeySharingBlockedForSecureElementPass:(id)a0;
...
- (void)noteForegroundVerificationObserverActive:(char)a0;
...
- (char)paymentWebService:(id)a0 canProvisionPaymentPassWithPrimaryAccountIdentifier:(id)a1;
...
- (char)paymentWebService:(id)a0 hasPassesOfType:(unsigned long long)a1;
...
- (void)paymentWebService:(id)a0 provisioningDataIncludingDeviceMetadata:(char)a1 withCompletionHandler:(id /* block */)a2;
...
- (char)paymentWebServiceSupportsAccounts:(id)a0;
- (char)paymentWebServiceSupportsPeerPaymentRegistration:(id)a0;
...
- (char)secureElementSupportsExpressMode;
- (void)serviceProviderDataForSecureElementPass:(id)a0 encrypted:(char)a1 completion:(id /* block */)a2;
...
- (void)startRequiringUpgradedPasscodeWithPasscodeMeetsPolicy:(char)a0;
...
- (char)supportsCheckingProvisioningRequirements;
- (char)supportsCredentialType:(long long)a0;
- (char)supportsExpressForAutomaticSelectionTechnologyType:(long long)a0;
- (char)supportsLowPowerExpressMode;
- (char)supportsSharingInAChain;
