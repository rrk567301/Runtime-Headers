...
+ (char)isCarKeySupportedForManufacturerIdentifier:(id)a0 issuerIdentifier:(id)a1 productPlanIdentifier:(id)a2;
...
- (void)revokeSharesWithGroupIdentifiers:(id)a0 shouldCascade:(char)a1 credential:(id)a2 completion:(id /* block */)a3;
