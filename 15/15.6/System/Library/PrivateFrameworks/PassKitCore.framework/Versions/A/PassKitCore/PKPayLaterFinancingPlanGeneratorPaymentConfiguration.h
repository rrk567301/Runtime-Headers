...
@property (nonatomic) char payOffRestOfLoanBalance;
...
@property (nonatomic) char forDispute;
...
+ (id)paymentConfigurationWithPaymentType:(unsigned long long)a0 amount:(id)a1 relativeToInstallmentNumber:(long long)a2 daysPriorToRelativeInstallmentNumber:(long long)a3 fundingSources:(unsigned long long)a4;
