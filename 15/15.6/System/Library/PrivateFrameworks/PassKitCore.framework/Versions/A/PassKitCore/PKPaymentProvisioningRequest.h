@class NSData, NSString, NSArray, PKPaymentEligibilityResponse, PKPaymentDeviceMetadata, PKDSPContext, NSNumber, NSMapTable;
...
@property (readonly, nonatomic, getter=isDeviceProvisioningDataExpected) char deviceProvisioningDataExpected;
@property (nonatomic) char disableDeviceScore;
@property (nonatomic) char sendReducedDeviceData;
