...
- (char)_hasRequiredDataForProvisioning;
- (void)_extendableDescription:(id)a0;
- (id)initWithProvisioningCredentialIdentifier:(id)a0 sharingInstanceIdentifier:(id)a1 cardConfigurationIdentifier:(id)a2 cardTemplateIdentifier:(id)a3 requiresSimultaneousRequestRouting:(char)a4 preview:(id)a5;
