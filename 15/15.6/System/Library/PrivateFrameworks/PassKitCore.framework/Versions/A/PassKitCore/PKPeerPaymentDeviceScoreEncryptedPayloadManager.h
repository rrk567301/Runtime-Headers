...
+ (id)keyForDeviceScoreEncryptedPayloadVersion:(unsigned long long)a0 endpointIdentifier:(id)a1 recipientAddress:(id)a2 quoteDestinationType:(unsigned long long)a3;
...
- (void)provideSessionFeedbackWithIngested:(char)a0;
