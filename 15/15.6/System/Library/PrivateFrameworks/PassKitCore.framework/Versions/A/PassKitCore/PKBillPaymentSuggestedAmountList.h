...
- (void).cxx_destruct;
- (id)_boundaryAmount;
- (char)canAddCategory:(unsigned long long)a0;
- (char)_addSuggestedAmount:(id)a0 force:(char)a1;
...
- (char)_suggestedAmountIsRequiredCategory:(id)a0;
- (id)_suggestedAmountThatIsNotRequired:(id)a0 suggestedAmount2:(id)a1;
- (void)_updateValues;
- (char)addSuggestedAmount:(id)a0;
...
- (char)canAddAmount:(id)a0;
- (char)canAddAmount:(id)a0 andCategory:(unsigned long long)a1;
- (id)initWithCurrencyCode:(id)a0 remainingMinimumPayment:(id)a1 remainingStatementBalance:(id)a2 currentBalance:(id)a3;
- (char)isValidWithUnableReason:(unsigned long long *)a0;
...
- (char)suggestedAmount:(id)a0 isAdjoiningSuggestedAmount:(id)a1;
