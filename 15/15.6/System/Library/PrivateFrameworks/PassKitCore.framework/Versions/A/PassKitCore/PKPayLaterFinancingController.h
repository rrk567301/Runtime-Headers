...
@property (readonly, nonatomic) unsigned long long payLaterPassEligibility;
...
@property (nonatomic) char autoPaymentOn;
...
@property (readonly, nonatomic) char canShowPayLaterTab;
@property (nonatomic) char hasSeenLanguageNotice;
...
- (char)_eligibleToFetchFinancingOptionsWithPayLaterAccount:(id)a0 transactionAmount:(id)a1;
...
- (char)_updateStateWithResponse:(id)a0;
