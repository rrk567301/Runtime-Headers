...
@property (nonatomic) char supportsLocalStorage;
...
@property (nonatomic) char hasDynamicSecurityCode;
...
- (char)isEqualToSafariEntryWithPrimaryAccountNumber:(id)a0 expirationDate:(id)a1;
