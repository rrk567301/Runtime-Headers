...
- (void)_reloadDataIncludeOrderings:(char)a0 includeBehavior:(char)a1 includeMerchants:(char)a2 completion:(id /* block */)a3;
- (void)_triggerUpdateHandlers;
- (char)dataIsWithinThresholdForCooldownLevel:(unsigned long long)a0;
...
- (void)updateDataWithCooldownLevel:(unsigned long long)a0 ignoreErrorBackoff:(char)a1 completion:(id /* block */)a2;
