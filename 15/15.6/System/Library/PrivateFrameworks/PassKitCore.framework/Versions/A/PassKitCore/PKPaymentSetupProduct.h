...
@property (nonatomic) char isServerDriven;
...
@property (nonatomic) char meetsAgeRequirements;
...
@property (nonatomic) char preventsFeatureApplication;
...
@property (readonly, nonatomic) char suppressPendingPurchases;
@property (readonly, nonatomic) char allowOnManagedAccount;
...
- (char)supportsDeviceOS:(id)a0;
- (char)supportsOSVersion:(id)a0 deviceClass:(id)a1;
- (char)supportsSetupProductMethodForType:(unsigned long long)a0;
