@class PKAccountEvent, NSDecimalNumber, PKAccountWebServiceSchedulePaymentRequest, PKAccountServiceTransferRequest, NSObject, PKPaymentAuthorizationCoordinator, NSString, PKAccount, PKPaymentPass, NSMutableSet, NSArray, PKPaymentService, PKPaymentWebService, NSError, PKAccountService;
...
@interface PKAccountBillPaymentController : NSObject <PKPaymentAuthorizationCoordinatorDelegate, PKPaymentAuthorizationCoordinatorPrivateDelegate> {
    ...
    char _dismissedBillPayment;
    char _completedBillPayment;
    char _fetchingData;
...
- (void)_updateUseApplePayCashSetting:(char)a0;
