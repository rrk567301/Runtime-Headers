...
- (char)_categoryIsCurrentBalanceType:(unsigned long long)a0;
- (char)_categoryIsPaymentPlan:(unsigned long long)a0;
...
- (char)_suggestedAmountListIsValidAfterPurgeIfNecessary:(id)a0;
...
- (id)generateAmountSuggestionListWithFinHealth:(char)a0;
