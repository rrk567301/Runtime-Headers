...
@property (nonatomic, getter=isSharedService) char sharedService;
...
- (char)_isValidResponse:(id)a0 error:(id)a1;
- (void)_peerPaymentDeviceMetadataWithCompletion:(id /* block */)a0;
- (void)_provideDeviceScoreFeedbackIfNeededForEndpoint:(id)a0 recipientAddress:(id)a1 quoteDestinationType:(unsigned long long)a2 ingested:(char)a3;
...
- (unsigned long long)peerPaymentEncryptionCertificateForDestination:(unsigned long long)a0 withCompletion:(id /* block */)a1;
- (unsigned long long)peerPaymentFailureDiagnosticWithRequest:(id)a0 withCompletion:(id /* block */)a1;
