...
@property (nonatomic) char hasLocalizedTitleAndMessage;
...
+ (id)errorWithTitle:(id)a0 message:(id)a1 severity:(unsigned long long)a2 recoveryTitle:(id)a3 recoveryURL:(id)a4;
