...
@interface PKPaymentOffersController : NSObject {
    ...
    char _hasFetchedCatalogFromServer;
...
- (char)_eligibleToFetchPaymentOfferCatalog;
...
- (char)_paymentOfferCriteriaToKeep:(id)a0;
...
- (char)hasAnyEligiblePaymentOfferCriteriaOfType:(unsigned long long)a0;
- (char)hasFetchedCatalogFromServer;
- (char)hasSeenLanguageDisclosureForCriteriaForIdentifier:(id)a0;
