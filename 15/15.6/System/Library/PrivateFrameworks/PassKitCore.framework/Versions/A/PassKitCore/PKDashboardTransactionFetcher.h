...
@property (nonatomic) char allowSynchronousFetch;
...
- (void)_addCashbackTransactions:(id)a0 synchronous:(char)a1 currentMonthOnly:(char)a2 completion:(id /* block */)a3;
- (void)_addInstantWidthdrawalTransactionsWithCompletion:(id /* block */)a0;
- (void)_commonSetup;
- (char)_containsFrequentTransactionType:(id)a0;
- (id)_feeTotalForTransaction:(id)a0;
- (void)_processPaymentPassTransactionsWithTransactions:(id)a0 synchronous:(char)a1 currentMonthOnly:(char)a2 sendTransactionsBlock:(id /* block */)a3;
- (void)_sendUpdatedTransactions;
- (id)_sortedTransactions:(id)a0 ascending:(char)a1 limit:(unsigned long long)a2;
...
- (void)filterDisputesOnly:(char)a0;
...
- (void)reloadTransactionsWithAllowSynchronous:(char)a0 completion:(id /* block */)a1;
