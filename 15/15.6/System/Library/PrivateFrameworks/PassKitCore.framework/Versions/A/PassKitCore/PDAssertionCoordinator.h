...
@property (nonatomic) char isForegroundApplication;
...
- (void)assertionOfType:(unsigned long long)a0 withIdentifier:(id)a1 shouldInvalidateWhenBackgrounded:(char)a2;
- (void)assertionRequestDidTimeout:(id)a0;
- (id)assertionsOfType:(unsigned long long)a0;
- (void)cancelPendingAssertionRequests;
- (char)hasAssertionsOfType:(unsigned long long)a0;
