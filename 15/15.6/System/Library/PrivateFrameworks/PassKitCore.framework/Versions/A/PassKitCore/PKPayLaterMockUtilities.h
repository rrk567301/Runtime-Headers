...
+ (id)_bnplFinancingOptionsDictionaryWithRelevantDates:(char)a0;
+ (id)_bnplFinancingPlan1WithRelevantDates:(char)a0;
+ (id)_bnplPreliminaryAssessmentDictionary;
+ (id)_bnplProductAssessmentDictionary;
+ (id)_bnplProductAssessmentDictionary2;
+ (id)_loanFinancingOptionDictionaryWithRelevantDates:(char)a0;
