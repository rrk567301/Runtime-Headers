...
- (id)_initWithLocalizationKey:(id)a0 isOwner:(char)a1 shareability:(unsigned long long)a2 manageability:(unsigned long long)a3 visibility:(unsigned long long)a4;
- (id)initWithIntRole:(unsigned short)a0;
- (id)initWithLocalizedName:(id)a0 isOwner:(char)a1 shareability:(unsigned long long)a2 manageability:(unsigned long long)a3 visibility:(unsigned long long)a4;
