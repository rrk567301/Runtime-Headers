...
@property (readonly, nonatomic) char isDeferredPayment;
@property (readonly, nonatomic) char isAMPPaymentToken;
@property (readonly, nonatomic) char isAppleCashPaymentToken;
@property (readonly, nonatomic) NSURL *issuerServiceURL;
@property (readonly, copy, nonatomic) NSString *issuerName;
@property (readonly, nonatomic) char disallowUserRevoke;
@property (readonly, copy, nonatomic) NSData *currentMerchantTokenPublicKeyHash;
@property (readonly, nonatomic) char needsMerchantTokenPublicKey;
...
- (id)initWithMerchantTokenId:(id)a0 appleMerchantId:(id)a1 merchantName:(id)a2 merchantIconURL:(id)a3 merchantTokenManagementURL:(id)a4 tokenCategory:(id)a5 isDeferredPayment:(char)a6;
- (id)initWithMerchantTokenId:(id)a0 appleMerchantId:(id)a1 merchantName:(id)a2 merchantIconURL:(id)a3 merchantTokenManagementURL:(id)a4 tokenCategory:(id)a5 isDeferredPayment:(char)a6 issuerServiceURL:(id)a7 disallowUserRevoke:(char)a8;
