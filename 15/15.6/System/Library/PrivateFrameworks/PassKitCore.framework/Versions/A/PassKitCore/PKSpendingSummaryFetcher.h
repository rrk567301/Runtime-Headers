...
+ (id)_sortedTransactions:(id)a0 ascending:(char)a1;
...
- (void)_addInterestToSummaryIfNecessary:(id)a0 withLastPeriodChange:(char)a1 completion:(id /* block */)a2;
- (id)_cacheForType:(unsigned long long)a0;
- (id)_cachedSpendingSummaryStartingWithDate:(id)a0 type:(unsigned long long)a1 withLastPeriodChange:(char)a2;
...
- (void)_spendingSummaryStartingWithDate:(id)a0 endDate:(id)a1 type:(unsigned long long)a2 withLastPeriodChange:(char)a3 completion:(id /* block */)a4;
...
- (void)spendingSummaryStartingWithDate:(id)a0 type:(unsigned long long)a1 includingLastPeriodChange:(char)a2 completion:(id /* block */)a3;
