...
+ (id)_statusAnnotationForTransaction:(id)a0 overloadAnnotation:(char *)a1;
+ (void)_transferFundingSourceInformationForTransaction:(id)a0 primaryString:(id *)a1 secondaryString:(id *)a2;
+ (unsigned long long)iconTypeForTransaction:(id)a0 ignoreLogoURL:(char)a1;
...
+ (id)secondaryFundingSourceDescriptionForTransaction:(id)a0 secondarySource:(id)a1 includeBankAccountSuffix:(char)a2 useGenericNameIfNoDescriptionAvailable:(char)a3;
+ (id)staticIconNameForTransaction:(id)a0;
+ (char)transactionIsPaymentForPayLaterFinancingPlan:(id)a0;
