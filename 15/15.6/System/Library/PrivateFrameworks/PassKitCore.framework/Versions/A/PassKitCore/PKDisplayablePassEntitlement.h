...
@property (nonatomic) char clearGroupWhenSelected;
...
+ (void)localizedEntitlementsFromDisplayableEntitlements:(id)a0 pass:(id)a1 useCachedTemplates:(char)a2 completion:(id /* block */)a3;
+ (void)localizedEntitlementsFromEntitlements:(id)a0 pass:(id)a1 useCachedTemplates:(char)a2 completion:(id /* block */)a3;
