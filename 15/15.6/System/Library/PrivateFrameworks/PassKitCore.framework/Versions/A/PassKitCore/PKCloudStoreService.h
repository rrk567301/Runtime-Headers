...
- (void)allItemsOfItemType:(unsigned long long)a0 storeLocally:(char)a1 completion:(id /* block */)a2;
- (void)applePayContainerItemsFromDate:(id)a0 toDate:(id)a1 completion:(id /* block */)a2;
- (void)changeHistoryForContainerIdentifier:(id)a0 completion:(id /* block */)a1;
...
- (void)performBackgroundRecordChangesSyncWithCompletion:(id /* block */)a0;
...
- (void)removeAllItems:(unsigned long long)a0 inZoneName:(id)a1 containerName:(id)a2 storeLocally:(char)a3 completion:(id /* block */)a4;
...
- (void)simulatePassProvisioningForPassUniqueIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)updateCloudStoreWithLocalItemsWithConfigurations:(id)a0 completion:(id /* block */)a1;
- (void)uploadTransaction:(id)a0 forTransactionSourceIdentifier:(id)a1 includeServerData:(char)a2 completion:(id /* block */)a3;
