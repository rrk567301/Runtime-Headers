...
@property (nonatomic) char ignoreFuturePayments;
...
+ (id)configurationWithProductType:(unsigned long long)a0 apr:(id)a1 totalPrincipal:(id)a2 installmentCount:(long long)a3 daysSinceTransactionStart:(long long)a4 merchant:(unsigned long long)a5 fundingSources:(unsigned long long)a6 payments:(id)a7;
