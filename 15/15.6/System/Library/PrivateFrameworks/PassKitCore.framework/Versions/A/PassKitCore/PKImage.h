...
@property (readonly, nonatomic) char tiles;
@property (readonly, nonatomic) char stretches;
...
- (char)isEqualToImage:(id)a0;
- (char)_isTiledWhenStretchedToSize:(struct CGSize { double x0; double x1; })a0;
