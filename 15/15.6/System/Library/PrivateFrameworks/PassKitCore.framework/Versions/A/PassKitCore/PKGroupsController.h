...
@property (nonatomic) char reorderingEnabled;
@property (readonly, nonatomic) char filteringEnabled;
...
@property (nonatomic) char shouldSeparatePaymentPasses;
...
- (void)_moveGroup:(id)a0 fromIndex:(unsigned long long)a1 toIndex:(unsigned long long)a2 notify:(char)a3;
- (char)containsExpiredPassWithUniqueID:(id)a0;
...
- (void)suppressRemoteUpdates:(char)a0;
