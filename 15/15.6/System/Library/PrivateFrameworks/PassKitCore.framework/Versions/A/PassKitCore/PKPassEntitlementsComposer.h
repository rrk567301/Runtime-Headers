...
@property (readonly, nonatomic) char preferDetailedCapabilityDisplay;
...
- (id)initWithSharedEntitlements:(id)a0 availableEntitlements:(id)a1 editable:(char)a2;
- (id)initWithSharedEntitlements:(id)a0 availableEntitlements:(id)a1 predefinedSharedEntitlements:(id)a2 editable:(char)a3;
