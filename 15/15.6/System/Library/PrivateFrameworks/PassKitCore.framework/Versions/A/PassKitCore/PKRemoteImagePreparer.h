...
- (void)fetchRemoteImage:(id)a0 preheatBitmap:(char)a1 completion:(id /* block */)a2;
- (void)fetchRemoteImage:(id)a0 scaleToSize:(struct CGSize { double x0; double x1; })a1 preheatBitmap:(char)a2 completion:(id /* block */)a3;
