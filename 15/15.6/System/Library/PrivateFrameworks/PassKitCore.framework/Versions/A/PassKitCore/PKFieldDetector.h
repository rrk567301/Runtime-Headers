...
- (void)_setPersistentFieldDetectionEnabled:(char)a0;
...
- (void)requestPersistentFieldDetectionEnabled:(char)a0 withReason:(unsigned long long)a1;
- (void)setPersistentFieldDetectionEnabled:(char)a0;
