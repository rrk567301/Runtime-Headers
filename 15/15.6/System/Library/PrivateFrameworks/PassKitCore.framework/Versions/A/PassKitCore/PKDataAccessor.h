...
@property (readonly, nonatomic) char remoteAssetsDownloaded;
...
- (id)imageSetForType:(long long)a0 displayProfile:(id)a1 preheat:(char)a2;
- (void)imageSetForType:(long long)a0 displayProfile:(id)a1 preheat:(char)a2 withCompletion:(id /* block */)a3;
- (id)imageSetForType:(long long)a0 screenScale:(double)a1 suffix:(id)a2 displayProfile:(id)a3 preheat:(char)a4;
- (void)imageSetForType:(long long)a0 screenScale:(double)a1 suffix:(id)a2 displayProfile:(id)a3 preheat:(char)a4 withCompletion:(id /* block */)a5;
- (void)noteShared;
- (id)passLocalizedStringForKey:(id)a0;
- (id)remoteAssetManagerForSEIDs:(id)a0;
- (char)remoteAssetsDownloadedForScreenScale:(double)a0 suffix:(id)a1;
