...
@property (nonatomic) char requiresUnifiedAccessCapableDevice;
...
- (id)initWithProvisioningCredentialIdentifier:(id)a0 sharingInstanceIdentifier:(id)a1 passThumbnailImage:(struct CGImage { } *)a2 ownerDisplayName:(id)a3 localizedDescription:(id)a4 accountHash:(id)a5 templateIdentifier:(id)a6 relyingPartyIdentifier:(id)a7 requiresUnifiedAccessCapableDevice:(char)a8;
