...
- (id)_preparePaymentDeviceResponseForRequestingDevice:(id)a0 userDisabled:(char)a1;
...
- (char)_queue_deviceIsRegistered:(id)a0;
...
- (void)_queue_sendDeviceDiscoveryRequestToAllDevicesWithProximity:(char)a0;
- (void)_queue_sendDeviceDiscoveryRequestWithProximity:(char)a0 devices:(id)a1;
...
- (void)discoverRemoteDevicesWithProximity:(char)a0;
