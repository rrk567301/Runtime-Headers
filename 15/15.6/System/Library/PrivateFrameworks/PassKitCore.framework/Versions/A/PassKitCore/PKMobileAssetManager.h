...
- (void)fetchMarketNotificationAssetsForIdentifier:(id)a0 isDiscretionary:(char)a1 completionHandler:(id /* block */)a2;
- (void)fetchRPIdentifierMappingDiscretionary:(char)a0 localOnly:(char)a1 completionHandler:(id /* block */)a2;
