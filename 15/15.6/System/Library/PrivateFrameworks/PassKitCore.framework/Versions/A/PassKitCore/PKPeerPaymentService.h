...
- (void)counterpartImageDataForTransactionWithIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)counterpartImageDataWithCompletion:(id /* block */)a0;
- (void)counterpartImageDataWithIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)deleteAccountWithCompletion:(id /* block */)a0;
- (void)deleteAllCounterpartImageDataWithCompletion:(id /* block */)a0;
...
- (void)encryptData:(id)a0 usingCertificateWithDestination:(unsigned long long)a1 completion:(id /* block */)a2;
- (void)encryptionCertificateForDestination:(unsigned long long)a0 forceUpdate:(char)a1 completion:(id /* block */)a2;
- (char)hasRecurringPayments;
- (void)initalizeCloudStoreIfNecessaryWithHandler:(id /* block */)a0;
- (void)insertOrUpdateDeviceOriginatedNearbyPeerPaymentTransactionWithIdentifier:(id)a0 memo:(id)a1 counterpartAppearanceData:(id)a2 completion:(id /* block */)a3;
- (void)insertOrUpdateNearbyPeerPaymentSetupNotificationWithTransactionIdentifier:(id)a0 amount:(id)a1 currency:(id)a2 senderName:(id)a3 completion:(id /* block */)a4;
- (void)insertOrUpdatePeerPaymentPendingRequests:(id)a0 shouldScheduleNotifications:(char)a1;
...
- (void)presentReceiverFlowWithOrientation:(id)a0 host:(unsigned long long)a1 completion:(id /* block */)a2;
...
- (void)presentSenderFlowWithHost:(unsigned long long)a0 userInfo:(id)a1 completion:(id /* block */)a2;
...
- (void)registerDeviceWithForceReregister:(char)a0 completion:(id /* block */)a1;
- (void)registerDeviceWithRegistrationURL:(id)a0 pushToken:(id)a1 forceReregister:(char)a2 completion:(id /* block */)a3;
...
- (void)reportFailureDiagnostic:(id)a0 completion:(id /* block */)a1;
