...
+ (id)_paymentsForConfigs:(id)a0 installmentDueDates:(id)a1 planIdentifier:(id)a2 transactionDate:(id)a3 installmentAmountWithInterest:(id)a4 installmentAmountWithoutInterest:(id)a5 installmentInterest:(id)a6 totalAmountWithInterest:(id)a7 totalAmountWithoutInterest:(id)a8 totalInterest:(id)a9 currency:(id)a10 ignoreFutureDates:(char)a11 paymentIdentifiersForDispute:(id *)a12;
...
+ (void)_processLoanAdjustmentWithPayment:(id)a0 installmentIndex:(long long)a1 installments:(id)a2 disputes:(id)a3 currency:(id)a4;
...
+ (id)payLaterFinancingPlanFundingSourcesForOptions:(unsigned long long)a0;
+ (id)payLaterMerchantForType:(unsigned long long)a0;
+ (id)payLaterPaymentFundingSourcesForOptions:(unsigned long long)a0;
