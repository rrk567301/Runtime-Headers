...
@property (readonly, nonatomic, getter=isSecureElementPassActivationAvailable) char secureElementPassActivationAvailable;
...
+ (char)contactlessInterfaceCanBePresentedFromSource:(long long)a0;
+ (char)contactlessInterfaceCanBePresentedFromSource:(long long)a0 deviceUILocked:(char)a1;
...
- (void)_fetchContentForUniqueID:(id)a0 usingSynchronousProxy:(char)a1 withCompletion:(id /* block */)a2;
- (void)_fetchImageSetContainerForUniqueID:(id)a0 ofType:(long long)a1 displayProfile:(id)a2 suffix:(id)a3 usingSynchronousProxy:(char)a4 withCompletion:(id /* block */)a5;
- (void)_fetchImageSetForUniqueID:(id)a0 ofType:(long long)a1 displayProfile:(id)a2 suffix:(id)a3 usingSynchronousProxy:(char)a4 withCompletion:(id /* block */)a5;
- (void)_getGroupsControllerSnapshotWithOptions:(id)a0 synchronously:(char)a1 retries:(unsigned long long)a2 handler:(id /* block */)a3;
- (void)_getPassesAndCatalogOfPassTypes:(unsigned long long)a0 synchronously:(char)a1 limitResults:(char)a2 withRetries:(unsigned long long)a3 handler:(id /* block */)a4;
...
- (char)_setSetting:(unsigned long long)a0 enabled:(char)a1 forPass:(id)a2;
...
- (char)canAddPassOfType:(unsigned long long)a0;
- (char)canAddPaymentPassWithPrimaryAccountIdentifier:(id)a0;
...
- (char)canAddSecureElementPassWithConfiguration:(id)a0 outError:(id *)a1;
- (char)canAddSecureElementPassWithPrimaryAccountIdentifier:(id)a0;
...
- (id)defaultPaymentPassesWithRemotePasses:(char)a0;
...
- (void)getGroupsControllerSnapshotWithOptions:(id)a0 synchronously:(char)a1 handler:(id /* block */)a2;
- (void)getMetadataForFieldWithProperties:(id)a0 withHandler:(id /* block */)a1;
- (void)getPassesAndCatalog:(char)a0 synchronously:(char)a1 withHandler:(id /* block */)a2;
- (void)getPassesAndCatalog:(char)a0 withHandler:(id /* block */)a1;
- (void)getPassesAndCatalogOfPassTypes:(unsigned long long)a0 synchronously:(char)a1 withHandler:(id /* block */)a2;
- (void)getPassesWithUniqueIdentifiers:(id)a0 handler:(id /* block */)a1;
- (void)hasInAppPaymentPassesForNetworks:(id)a0 capabilities:(unsigned long long)a1 issuerCountryCodes:(id)a2 isMultiTokensRequest:(char)a3 withHandler:(id /* block */)a4;
- (void)hasInAppPaymentPassesForNetworks:(id)a0 capabilities:(unsigned long long)a1 issuerCountryCodes:(id)a2 paymentRequestType:(id)a3 isMultiTokensRequest:(char)a4 withHandler:(id /* block */)a5;
...
- (void)hasInAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)a0 issuerCountryCodes:(id)a1 isMultiTokensRequest:(char)a2 withHandler:(id /* block */)a3;
- (void)hasInAppPrivateLabelPaymentPassesForWebDomain:(id)a0 issuerCountryCodes:(id)a1 isMultiTokensRequest:(char)a2 withHandler:(id /* block */)a3;
- (char)hasPassesInExpiredSection;
- (char)hasPassesOfType:(unsigned long long)a0;
- (char)hasPassesWithSupportedNetworks:(id)a0 merchantCapabilities:(unsigned long long)a1 issuerCountryCodes:(id)a2 webDomain:(id)a3;
- (char)hasPassesWithSupportedNetworks:(id)a0 merchantCapabilities:(unsigned long long)a1 issuerCountryCodes:(id)a2 webDomain:(id)a3 paymentRequestType:(id)a4 isMultiTokensRequest:(char)a5;
- (char)hasSecureElementPassesOfType:(long long)a0;
- (char)iPadSupportsPasses;
...
- (id)inAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)a0 issuerCountryCodes:(id)a1 isMultiTokensRequest:(char)a2;
- (id)inAppPrivateLabelPaymentPassesForWebDomain:(id)a0 issuerCountryCodes:(id)a1 isMultiTokensRequest:(char)a2;
...
- (char)isPaymentPassActivationAvailable;
- (char)isRemovingPassesOfType:(unsigned long long)a0;
- (char)isWatchIssuerAppProvisioningSupported;
...
- (void)longTermPrivacyKeyForCredentialGroupIdentifier:(id)a0 reuseExisting:(char)a1 completion:(id /* block */)a2;
- (id)manifestHashForPassWithUniqueID:(id)a0;
- (void)meetsProvisioningRequirements:(id)a0 completion:(id /* block */)a1;
- (char)meetsProvisioningRequirements:(id)a0 missingRequirements:(id *)a1;
- (char)migrateDataWithDidRestoreFromBackup:(char)a0;
...
- (char)replacePassWithPass:(id)a0;
- (void)replaceUnsignedPassAtURL:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)requestIssuerBoundPassesWithBindingWithData:(id)a0 automaticallyProvision:(char)a1 withCompletion:(id /* block */)a2;
...
- (char)resetApplePayWithDiagnosticReason:(id)a0;
- (void)resetApplePayWithDiagnosticReason:(id)a0 completion:(id /* block */)a1;
- (char)resetSettingsForPass:(id)a0;
- (char)sendRKEPassThroughMessage:(id)a0 forSessionIdentifier:(id)a1 error:(id *)a2;
- (void)sendUserEditedCatalog:(id)a0;
- (void)serviceProviderDataForSecureElementPass:(id)a0 completion:(id /* block */)a1;
- (char)setAutomaticPresentationEnabled:(char)a0 forPass:(id)a1;
- (char)setAutomaticUpdatesEnabled:(char)a0 forPass:(id)a1;
- (void)setBackupMetadata:(id)a0;
- (unsigned long long)setLiveRenderingEnabled:(char)a0 forPassUniqueID:(id)a1;
- (char)setNotificationServiceUpdatesEnabled:(char)a0 forPass:(id)a1;
- (char)setShowInLockScreenEnabled:(char)a0 forPass:(id)a1;
- (void)setSortingState:(long long)a0 forObjectWithUniqueID:(id)a1 withCompletion:(id /* block */)a2;
- (char)setSuppressNotificationsEnabled:(char)a0 forPass:(id)a1;
- (char)setSuppressPromotionsEnabled:(char)a0 forPass:(id)a1;
...
- (char)supportsSearchForPassUniqueID:(id)a0;
