...
@property char devSigned;
@property (readonly, getter=isRegistered) char registered;
...
@property char transactionServiceDisabled;
@property char messageServiceDisabled;
@property char ignoreProvisioningEnablementPercentage;
...
@property (readonly, nonatomic) char hasPeerPaymentAccount;
...
- (char)contextMeetsProvisioningEnablementPercentageThresholdForRegion:(id)a0;
- (id)TSMPushTopics;
...
- (char)contextMeetsDeviceUpgradeTasksEnablementThresholdForRegion:(id)a0;
- (char)contextMeetsMarketGeoNotificationThresholdForRegion:(id)a0 paymentNetwork:(long long)a1;
