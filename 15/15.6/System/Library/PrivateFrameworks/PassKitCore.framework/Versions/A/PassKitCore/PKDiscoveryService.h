...
- (void)discoveryItemWithIdentifier:(id)a0 callToAction:(long long)a1 isScrollable:(char)a2;
- (void)discoveryItemWithIdentifier:(id)a0 callToAction:(long long)a1 wasScrolledToTheBottom:(char)a2;
...
- (void)dismissDialogRequestWithIdentifier:(id)a0 forPlacement:(id)a1 completion:(id /* block */)a2;
...
- (void)displayedDiscoveryItemWithIdentifier:(id)a0 isWelcomeCard:(char)a1 afterSwipingToCard:(char)a2 multipleStoryCardsAvailable:(char)a3 callToAction:(long long)a4 cardSize:(long long)a5;
...
- (void)expandedDiscoveryItemWithIdentifier:(id)a0 callToAction:(long long)a1 afterSwipingToCard:(char)a2 multipleStoryCardsAvailable:(char)a3 cardSize:(long long)a4;
