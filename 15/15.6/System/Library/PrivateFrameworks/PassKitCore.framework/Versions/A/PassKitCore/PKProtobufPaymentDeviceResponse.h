...
@property (nonatomic) char hasLocked;
@property (nonatomic) char locked;
@property (retain, nonatomic) NSMutableArray *paymentInstruments;
@property (nonatomic) char hasDefaultPaymentInstrumentIndex;
...
@property (nonatomic) char hasDeviceDisabled;
...
@property (nonatomic) char hasSupportsFaceID;
