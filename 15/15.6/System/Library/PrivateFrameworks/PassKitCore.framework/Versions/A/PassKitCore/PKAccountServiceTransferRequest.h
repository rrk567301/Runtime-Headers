...
@property (readonly, nonatomic) char supportsSplitPayment;
@property (nonatomic) unsigned long long initialAction;
@property (nonatomic) char userWasShownAPCTransferSpeed;
...
- (char)isEqualToAccountServicePaymentRequest:(id)a0;
