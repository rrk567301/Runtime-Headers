...
@property (nonatomic, getter=isSecureText) char secureText;
@property (nonatomic, getter=isSecureVisibleText) char secureVisibleText;
@property (nonatomic, getter=isNumeric) char numeric;
@property (nonatomic, getter=isNumericFractional) char numericFractional;
@property (nonatomic, getter=useLuhnCheck) char luhnCheck;
@property (copy, nonatomic) NSString *displayFormatPlaceholder;
@property (copy, nonatomic) NSString *currencyCode;
@property (nonatomic) char keepPaddingCharactersForSubmission;
...
- (id)_stringByApplyingCurrencyFormatter:(id)a0 allowPartialFractional:(char)a1;
...
- (id)stringByApplyingDisplayFormat:(id)a0 allowPartialFractional:(char)a1;
