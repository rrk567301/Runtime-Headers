...
@property (nonatomic) char nextSequenceNumberHasWrapped;
...
- (id)pingPacketWithType:(unsigned char)a0 payload:(id)a1 requiresChecksum:(char)a2;
...
- (char)validatePing4ResponsePacket:(id)a0 sequenceNumber:(unsigned short *)a1;
- (char)validatePing6ResponsePacket:(id)a0 sequenceNumber:(unsigned short *)a1;
- (char)validatePingResponsePacket:(id)a0 sequenceNumber:(unsigned short *)a1;
- (char)validateSequenceNumber:(unsigned short)a0;
