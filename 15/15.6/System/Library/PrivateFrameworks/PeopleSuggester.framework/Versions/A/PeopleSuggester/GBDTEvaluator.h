...
- (id)_evaluateResultWithGradients:(id)a0 questions:(id)a1 inputVectors:(id)a2 reportGradientsBothSidesOfSplit:(char)a3 reportNodeSumGradients:(char)a4 reportPerFeatureResultDifference:(char)a5 reportPerNodeResultDifference:(char)a6;
