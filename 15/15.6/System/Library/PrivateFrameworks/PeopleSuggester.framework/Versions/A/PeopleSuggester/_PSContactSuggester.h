...
- (id)gameCenterSuggestionsWithMaxSuggestions:(long long)a0 interactionDomains:(id)a1 appleUsersOnly:(char)a2 includeGroupSuggestions:(char)a3 excludeContactsByIdentifiers:(id)a4;
...
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 contactKeysTofetch:(id)a1 interactionDomains:(id)a2 appleUsersOnly:(char)a3;
...
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 excludeContactsByIdentifiers:(id)a1 lookBackDays:(long long)a2 interactions:(id)a3 modeAvocado:(char)a4;
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 excludeContactsByIdentifiers:(id)a1 lookBackDays:(long long)a2 interactions:(id)a3 modeAvocado:(char)a4 interactionHistoryCap:(long long)a5;
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 excludeContactsWithIdentifiers:(id)a1;
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 interactionDomains:(id)a1 appleUsersOnly:(char)a2;
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 interactionDomains:(id)a1 referenceDate:(id)a2 appleUsersOnly:(char)a3 includeGroups:(char)a4;
- (id)contactSuggestionsWithMaxSuggestions:(long long)a0 interactionDomains:(id)a1 referenceDate:(id)a2 appleUsersOnly:(char)a3 includeGroups:(char)a4 excludeContactsByIdentifiers:(id)a5;
- (id)contactsWithMaxSuggestions:(long long)a0 contactKeysTofetch:(id)a1 interactionDomains:(id)a2 referenceDate:(id)a3 appleUsersOnly:(char)a4;
...
- (id)gameCenterSuggestionsWithMaxSuggestions:(long long)a0 interactionDomains:(id)a1 appleUsersOnly:(char)a2;
