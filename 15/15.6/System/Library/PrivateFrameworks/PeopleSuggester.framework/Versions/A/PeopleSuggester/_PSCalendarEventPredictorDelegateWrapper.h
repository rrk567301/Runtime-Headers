...
- (id)initWithCalendarEventPredictor:(id)a0 startSecondsFromQuery:(double)a1 endSecondsFromQuery:(double)a2 maxParticipants:(unsigned long long)a3 isEnabled:(char)a4 defaultConfidenceCategory:(long long)a5;
