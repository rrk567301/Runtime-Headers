...
@property (nonatomic) char boostGroups;
@property (nonatomic) char outgoingOnly;
@property (nonatomic) char boostIndividualFavorites;
...
- (id)initWithRegularityThreshold:(double)a0 intensityThreshold:(double)a1 regularityWeight:(double)a2 intensityWeight:(double)a3 minimalInteration:(long long)a4 minimalUniqueDaysInteracted:(long long)a5 interactionStore:(id)a6 lookbackWindow:(double)a7 outgoingOnly:(char)a8;
- (char)loadPSConfig;
