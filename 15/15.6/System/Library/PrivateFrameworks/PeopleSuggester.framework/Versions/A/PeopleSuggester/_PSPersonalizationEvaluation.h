...
@property (nonatomic) char evaluateIsInvokedOnce;
...
- (char)cloneAdaptableModel:(id)a0 toFilePath:(id)a1 originalXgboostModelName:(id)a2 clonedXgboostModelName:(id)a3;
...
- (id)loadDefaultModel;
- (char)performPrerequisitesBeforeAdaptationWithFeaturesConfigDeployPath:(id)a0;
- (id)processDataWithQuery:(id)a0 balanceNeed:(char)a1;
