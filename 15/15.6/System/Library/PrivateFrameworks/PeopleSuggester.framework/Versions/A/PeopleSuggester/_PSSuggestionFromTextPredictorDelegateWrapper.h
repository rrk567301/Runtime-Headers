...
- (id)initWithDelegateType:(long long)a0 textPredictor:(id)a1 startSecondsFromQuery:(double)a2 endSecondsFromQuery:(double)a3 priorScoreThreshold:(float)a4 isEnabled:(char)a5 defaultConfidenceCategory:(long long)a6;
