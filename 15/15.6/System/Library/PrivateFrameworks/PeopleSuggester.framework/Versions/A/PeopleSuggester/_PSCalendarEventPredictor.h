...
+ (char)currentUserIsEligibleForEvent:(id)a0;
...
+ (char)hasFaceTimeSignalInEvent:(id)a0;
+ (char)isCorecipientParticipant:(id)a0 seedRecipients:(id)a1 contactsMap:(id)a2;
+ (char)isEligibleParticipant:(id)a0 context:(id)a1 contactsMap:(id)a2;
+ (char)isMaybeFaceTimeEvent:(id)a0 earliestStartDate:(id)a1 latestStartDate:(id)a2 maxParticipants:(unsigned long long)a3;
