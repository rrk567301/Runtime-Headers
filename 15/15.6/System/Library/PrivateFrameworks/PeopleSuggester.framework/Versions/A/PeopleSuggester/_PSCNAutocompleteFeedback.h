...
@property (nonatomic) char isImplicit;
...
+ (id)createTypedHandleFeedbackWithBundleIdentifier:(id)a0 contact:(id)a1 viaContactPicker:(char)a2;
+ (id)createVendedSuggestionsFeedbackWithBundleIdentifier:(id)a0 suggestions:(id)a1;
+ (id)createVendedSuggestionsFeedbackWithBundleIdentifier:(id)a0 suggestions:(id)a1 isImplicit:(char)a2;

- (void).cxx_destruct;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)serialize;
- (id)initWithBundleIdentifier:(id)a0 feedbackType:(long long)a1 isImplicit:(char)a2 entered:(id)a3 exited:(id)a4 vendedSuggestions:(id)a5 tappedSuggestion:(id)a6 typedHandle:(id)a7 erasedHandle:(id)a8;
- (id)initWithDataVersion:(unsigned int)a0 reportTime:(id)a1 userIdentifier:(id)a2 bundleIdentifier:(id)a3 sourceBundleIdentifier:(id)a4 isImplicit:(char)a5 feedbackType:(long long)a6 entered:(id)a7 exited:(id)a8 vendedSuggestions:(id)a9 tappedSuggestion:(id)a10 typedHandle:(id)a11 erasedHandle:(id)a12;
