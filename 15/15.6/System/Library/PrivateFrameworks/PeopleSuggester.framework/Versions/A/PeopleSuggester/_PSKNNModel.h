@class CNContactStore, NSArray, NSDictionary, _CDInteractionStore, _PSContactResolver, _CDInteractionCache;
...
- (id)_rankedZkwSuggestionsWithPredictionContext:(id)a0 bundleId:(id)a1 maxSuggestions:(unsigned long long)a2 frequencyOnly:(char)a3 interactions:(id)a4 interactionCache:(id)a5;
- (id)candidatePropertyFromCandidates:(id)a0;
- (double)distanceOfNeighbor:(id)a0 fromReference:(id)a1;
- (id)extractNearestNeighborLabelsForQueryResult:(id)a0 andNeighbors:(id)a1 frequencyOnly:(char)a2 rankerType:(long long)a3 contactsOnly:(char)a4 reason:(id)a5;
- (id)extractNearestNeighborsForMapsQueryResult:(id)a0 andNeighbors:(id)a1 frequencyOnly:(char)a2;
...
- (id)filterShareInteractions:(id)a0 minimumOccurencesByMechanism:(id)a1 contextBundleId:(id)a2 filterOutNonMatchingSourceBundleIDs:(char)a3;
...
- (id)interactionLabelsForQueryResult:(id)a0 queryPoint:(id)a1 rankerType:(long long)a2 frequencyOnly:(char)a3 contactsOnly:(char)a4;
...
- (id)rankedGlobalSuggestionsWithPredictionContext:(id)a0 maxSuggestions:(unsigned long long)a1 contactsOnly:(char)a2 interactions:(id)a3 contactIdIsInStoreBlock:(id /* block */)a4;
- (id)rankedHandlesFromCandidateHandles:(id)a0;
- (id)rankedLabelsFromInteractionsForPhoneCallsWithInteractions:(id)a0 andDistances:(id)a1;
- (id)rankedLabelsFromInteractionsMaintainRecipientsArray:(id)a0 andDistances:(id)a1 freqOnly:(char)a2;
- (id)rankedLabelsFromInteractionsSingleRecipientArray:(id)a0 andDistances:(id)a1 freqOnly:(char)a2 contactsOnly:(char)a3 scoreLikeShareSheet:(char)a4;
- (id)rankedLabelsFromInteractionsSiriNLWithInteractions:(id)a0 andDistances:(id)a1 freqOnly:(char)a2;
...
- (id)rankedNameSuggestionsWithPredictionContext:(id)a0 forName:(id)a1 contactsOnly:(char)a2;
- (id)rankedNonMessagesAutocompleteSuggestionsWithPredictionContext:(id)a0 bundleId:(id)a1 candidates:(id)a2 performSecondarySearch:(char)a3;
- (id)rankedPhoneCallAutocompleteSuggestionsWithPredictionContext:(id)a0 candidates:(id)a1;
- (id)rankedSiriMLCRHandles:(id)a0 context:(id)a1;
- (id)rankedSuggestionsWithPredictionContext:(id)a0 bundleId:(id)a1 maxSuggestions:(unsigned long long)a2 frequencyOnly:(char)a3 interactions:(id)a4;
- (id)rankedZkwSuggestionsWithPredictionContext:(id)a0 modelConfiguration:(id)a1 maxSuggestions:(unsigned long long)a2;
- (id)recipientsForChat:(id)a0;
...
- (char)suggestedRecipientHandles:(id)a0 differFromFetchedRecipientHandles:(id)a1;
...
- (id)suggestionProxiesBasedOnSharingInteractionsWithPredictionContext:(id)a0 withOnlyTopShares:(char)a1 withFilterOutNonMatchingSourceBundleIDs:(char)a2;
- (id)suggestionProxiesWithPredictionContext:(id)a0;
- (id)suggestionsByUpdatingGroupNamesFromSuggestions:(id)a0 imCoreTimeBudget:(double)a1;
