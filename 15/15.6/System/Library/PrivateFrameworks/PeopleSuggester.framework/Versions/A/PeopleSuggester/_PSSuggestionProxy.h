@class NSString, NSArray, INImage, NSNumber;
...
@property (readonly, nonatomic) char useGroupsWhenFindingRecipient;
...
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 handle:(id)a3 reason:(id)a4 reasonType:(id)a5 useGroupsWhenFindingRecipient:(char)a6;
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 handles:(id)a3 reason:(id)a4 reasonType:(id)a5 useGroupsWhenFindingRecipient:(char)a6 groupName:(id)a7 image:(id)a8;
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 handles:(id)a3 reason:(id)a4 reasonType:(id)a5 useGroupsWhenFindingRecipient:(char)a6 groupName:(id)a7 image:(id)a8 modelScore:(id)a9;
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 reason:(id)a3 reasonType:(id)a4;
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 reason:(id)a3 reasonType:(id)a4 modelScore:(id)a5;
