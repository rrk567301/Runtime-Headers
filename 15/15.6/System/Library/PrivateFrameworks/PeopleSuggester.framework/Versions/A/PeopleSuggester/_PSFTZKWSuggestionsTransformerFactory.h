...
- (id)formatWithSuggestion:(id)a0 bundleIdsForGroupMatching:(id)a1 checkForMessagesGroupIdentifier:(char)a2;
- (id)initWithInteractionStore:(id)a0;
- (char)isEligibleRecipient:(id)a0;
- (id /* block */)mapRecipientsToContactsWithUnmapped:(char)a0;
