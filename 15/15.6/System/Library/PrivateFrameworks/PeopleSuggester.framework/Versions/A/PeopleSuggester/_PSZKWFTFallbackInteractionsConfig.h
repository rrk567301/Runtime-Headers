...
- (void).cxx_destruct;
- (id)initWithIsEnabled:(char)a0 defaultConfidenceCategory:(long long)a1 mechanisms:(id)a2 interactionCountMaxDepths:(id)a3 interactionHistoryRelativeStartDates:(id)a4 bundleIds:(id)a5 modelType:(long long)a6 clusterPruneThreshold:(unsigned long long)a7 maxSuggestions:(unsigned long long)a8;
- (id)initWithIsEnabled:(char)a0 defaultConfidenceCategory:(long long)a1 modelType:(long long)a2;
