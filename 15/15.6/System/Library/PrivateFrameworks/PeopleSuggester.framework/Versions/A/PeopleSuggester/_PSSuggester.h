...
@property (class) char hasInitializedCache;
...
- (id)contactStore;
- (id)rankedGlobalSuggestionsFromContext:(id)a0 contactsOnly:(char)a1;
...
- (id)initWithConfiguration:(id)a0 feedbackRecording:(char)a1;
- (id)initWithDaemonUsingConfiguration:(id)a0;
- (char)interactionAvailableForHandle:(id)a0;
- (char)interactionAvailableForHandle:(id)a0 interactionStoreDB:(id)a1;
...
- (char)isTransportBundleIDSupported:(id)a0;
...
- (char)reportShareSheetTimeoutWithError:(id *)a0;
