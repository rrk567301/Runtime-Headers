...
@property (readonly, nonatomic) char familySuggestion;
@property (retain, nonatomic) INImage *image;
@property (nonatomic) char isAdaptedModelCreated;
@property (nonatomic) char isAdaptedModelUsed;
...
@property (readonly, nonatomic) char isReturnToSender;
...
- (id)initWithBundleID:(id)a0 conversationIdentifier:(id)a1 groupName:(id)a2 recipients:(id)a3 derivedIntentIdentifier:(id)a4 image:(id)a5 reason:(id)a6 reasonType:(id)a7 score:(id)a8 familySuggestion:(char)a9;
...
- (id)initWithBundleID:(id)a0 recipients:(id)a1;
