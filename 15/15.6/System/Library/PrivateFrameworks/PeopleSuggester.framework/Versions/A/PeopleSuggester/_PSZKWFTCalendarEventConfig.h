...
- (void).cxx_destruct;
- (id)initWithIsEnabled:(char)a0 defaultConfidenceCategory:(long long)a1;
- (id)initWithIsEnabled:(char)a0 defaultConfidenceCategory:(long long)a1 startSecondsFromQuery:(double)a2 endSecondsFromQuery:(double)a3 urlDomainsToSkip:(id)a4 maxOtherParticipants:(unsigned long long)a5;
