...
+ (id)interactionsFromStore:(id)a0 referenceDate:(id)a1 withMechanisms:(id)a2 withAccount:(id)a3 withBundleIds:(id)a4 withTargetBundleIds:(id)a5 withDirections:(id)a6 singleRecipient:(char)a7 fetchLimit:(unsigned long long)a8;
+ (id)interactionsFromStore:(id)a0 startDate:(id)a1 tillDate:(id)a2 withMechanisms:(id)a3 withAccount:(id)a4 withBundleIds:(id)a5 withTargetBundleIds:(id)a6 withDirections:(id)a7 singleRecipient:(char)a8 fetchLimit:(unsigned long long)a9;
+ (id)interactionsFromStore:(id)a0 startDate:(id)a1 tillDate:(id)a2 withMechanisms:(id)a3 withAccount:(id)a4 withBundleIds:(id)a5 withTargetBundleIds:(id)a6 withDirections:(id)a7 withNsUserName:(id)a8 singleRecipient:(char)a9 excludeAnonymousTemporaryRecipients:(char)a10 fetchLimit:(unsigned long long)a11 fetchOffset:(unsigned long long)a12 sortAscending:(char)a13;
+ (id)interactionsFromStore:(id)a0 startDate:(id)a1 tillDate:(id)a2 withMechanisms:(id)a3 withAccount:(id)a4 withBundleIds:(id)a5 withTargetBundleIds:(id)a6 withDirections:(id)a7 withNsUserName:(id)a8 singleRecipient:(char)a9 fetchLimit:(unsigned long long)a10;
...
+ (id)interactionsMatchingAnyHandles:(id)a0 directions:(id)a1 mechanisms:(id)a2 interactionDuration:(double)a3 store:(id)a4 fetchLimit:(unsigned long long)a5;
...
+ (id)interactionsMatchingAnyHandlesOrDomainIds:(id)a0 account:(id)a1 directions:(id)a2 bundleIds:(id)a3 store:(id)a4 fetchLimit:(unsigned long long)a5 singleRecipientOnly:(char)a6;
...
+ (id)interactionsMatchingAnyHandlesOrDomainIds:(id)a0 store:(id)a1 fetchLimit:(unsigned long long)a2 messageInteractionCache:(id)a3;
+ (id)interactionsMatchingAnySender:(id)a0 store:(id)a1 fetchLimit:(unsigned long long)a2 messageInteractionCache:(id)a3;
...
+ (id)mostRecentInteractionWithRecipientMatchingContactIdentifier:(id)a0 bundleIds:(id)a1 store:(id)a2 singleRecipient:(char)a3;
+ (id)mostRecentInteractionWithSenderOrRecipientMatchingContactIdentifier:(id)a0 bundleIds:(id)a1 store:(id)a2 singleRecipient:(char)a3;
