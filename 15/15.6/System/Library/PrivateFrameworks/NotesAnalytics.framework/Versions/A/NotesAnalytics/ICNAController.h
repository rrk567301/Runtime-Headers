...
@property (class, readonly, nonatomic) char audioTranscriptEnabled;
@property (class, readonly, nonatomic) char audioSummaryEnabled;
@property (class, readonly, nonatomic) char bioAuthEnabled;
@property (class, readonly, nonatomic) char handwritingAutoRefineEnabled;
@property (class, readonly, nonatomic) char localNotesEnabled;
@property (class, readonly, nonatomic) char mathTextEnabled;
@property (class, readonly, nonatomic) char mathHandwritingEnabled;
...
- (id)aaTrackerForWindowIdentifier:(id)a0;
...
- (void)calendarDayChanged:(id)a0;
- (void)clearSessionForWindowIdentifier:(id)a0;
- (void)endSessionSynchronously:(char)a0 endReason:(long long)a1;
- (void)endSessionSynchronously:(char)a0 forSessionType:(long long)a1 endReason:(long long)a2;
- (void)endSessionSynchronously:(char)a0 forSessionType:(long long)a1 endReason:(long long)a2 successHandler:(id /* block */)a3;
- (void)endWindowSessionSynchronously:(char)a0 forSessionType:(long long)a1 endReason:(long long)a2 window:(id)a3;
- (void)endWindowSessionSynchronously:(char)a0 forSessionType:(long long)a1 endReason:(long long)a2 window:(id)a3 successHandler:(id /* block */)a4;
- (void)enterGroupWithSubtracker:(id)a0;
- (void)generatePrivateSessionIDIfNecessary;
- (char)killEndSessionBackgroundTaskIfNecessary;
- (void)leaveGroupWithSubtracker:(id)a0;
- (void)leaveGroupWithSubtracker:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)performOnInstrumentationQueueWaitUntilDone:(char)a0 block:(id /* block */)a1;
...
- (void)pushDataObject:(id)a0 unique:(char)a1 onlyOnce:(char)a2 subTracker:(id)a3;
- (void)pushDataObjects:(id)a0 unique:(char)a1 onlyOnce:(char)a2 subTracker:(id)a3;
...
- (void)pushSessionLevelDataIntoSessionManager:(id)a0 withSessionType:(long long)a1;
- (void)pushSessionLevelDataIntoSessionManager:(id)a0 withSessionType:(long long)a1 isGlobalSession:(char)a2;
- (void)pushToSessionManager:(id)a0 data:(id)a1 forKey:(id)a2 traits:(id)a3;
- (void)pushUniqueDataObject:(id)a0 tracker:(id)a1;
- (id)referralData;
- (void)restartAppSession;
- (id)sessionDataWithType:(long long)a0 isGlobalSession:(char)a1;
- (id)sessionManagerForWindowIdentifier:(id)a0;
- (id)sessionTrackerForWindowIdentifier:(id)a0;
- (void)startAppAndGlobalSessionIfNecessaryWithReferralURL:(id)a0 referralApplication:(id)a1;
- (void)startSessionWithReferralURL:(id)a0 referralApplication:(id)a1;
- (void)startSessionWithReferralURL:(id)a0 referralApplication:(id)a1 startingSessionType:(long long)a2;
- (void)startSessionWithType:(long long)a0;
- (void)startWindowSessionWithType:(long long)a0 window:(id)a1;
