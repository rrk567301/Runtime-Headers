@class NSManagedObjectContext, NSNumber, ICNAHistogramManager;
...
@property char isPerformingSnapshot;
...
- (char)killMiniSnapshotBackgroundTaskIfNecessary;
...
- (void)reallyPerformSnapshotWithCompletionHandler:(id /* block */)a0;
- (void)scheduleSnapshotIfNecessary;
- (void)setupContextsIfNecessary;
- (char)shouldRunSnapshotManually;
- (char)shouldScheduleSnapshot;
