...
- (void)start;
- (void)stop;
- (char)setClientIdentity:(struct __SecIdentity { } *)a0 certificates:(id)a1;
- (char)configureSecProtocol:(struct EAPBoringSSLSessionParameters_s { struct __SecIdentity *x0; struct __CFArray *x1; unsigned short x2; unsigned short x3; void /* function */ *x4; void /* function */ *x5; unsigned int x6; struct *x7; } *)a0;
...
- (char)getSessionResumed;
- (int)handshake;
- (void)readApplicationData;
- (void)setSecProtocolMetadata;
- (char)setup:(struct EAPBoringSSLSessionParameters_s { struct __SecIdentity *x0; struct __CFArray *x1; unsigned short x2; unsigned short x3; void /* function */ *x4; void /* function */ *x5; unsigned int x6; struct *x7; } *)a0 clientContext:(void *)a1;
