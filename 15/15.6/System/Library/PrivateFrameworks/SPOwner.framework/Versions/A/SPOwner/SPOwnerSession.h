...
- (void)disableUTAppAlert:(char)a0 completion:(id /* block */)a1;
...
- (void)readAISMetadataFromMACAddress:(id)a0 useOwnerControlPoint:(char)a1 completion:(id /* block */)a2;
- (void)readRawAISMetadataFromBeaconIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)readRawAISMetadataFromMACAddress:(id)a0 useOwnerControlPoint:(char)a1 completion:(id /* block */)a2;
...
- (void)setFindMyNetworkStatusForMACAddress:(id)a0 status:(char)a1 completion:(id /* block */)a2;
- (void)setInvalidationBlock:(id /* block */)a0;
- (void)setLocationUpdateBlock:(id /* block */)a0;
- (void)simulateAccessoryPairing:(id)a0 name:(id)a1 isAirPods:(char)a2 completion:(id /* block */)a3;
