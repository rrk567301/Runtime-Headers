...
- (id)initWithName:(id)a0 roleId:(long long)a1 roleEmoji:(id)a2 keyStatus:(id)a3 collaborativeKeyC3:(id)a4 signatureS4:(id)a5 isZeus:(char)a6 batteryLevel:(long long)a7;
