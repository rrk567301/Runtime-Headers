...
@property (nonatomic) char managedByFindMy;
...
- (id)initWithUserIdentifier:(id)a0 beaconIdentifier:(id)a1 groupIdentifier:(id)a2 name:(id)a3 partIdentifier:(unsigned char)a4 serialNumber:(id)a5 managedByFindMy:(char)a6 primaryIndex:(unsigned long long)a7 ltkIndexMap:(id)a8 lastConnectedLEMAC:(id)a9 allowedSessions:(id)a10 keyAddressPairs:(id)a11;
- (id)initWithUserIdentifier:(id)a0 beaconIdentifier:(id)a1 groupIdentifier:(id)a2 name:(id)a3 partIdentifier:(unsigned char)a4 serialNumber:(id)a5 managedByFindMy:(char)a6 primaryIndex:(unsigned long long)a7 ltkIndexMap:(id)a8 lastConnectedLEMAC:(id)a9 allowedSessions:(id)a10 longTermKeyMap:(id)a11;
