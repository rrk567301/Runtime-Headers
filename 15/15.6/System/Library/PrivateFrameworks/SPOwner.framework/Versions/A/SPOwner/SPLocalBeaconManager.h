@class FMXPCServiceDescription, NSUUID, NSDate, NSData, FMXPCActivity, NSString, NSDictionary, FMXPCSession, SPMacBeaconConfig, NSObject, SPBLEStateMonitor, SPMonitorsWrapper;
...
@property (retain, nonatomic) FMXPCServiceDescription *spdUserAgentServiceDescription;
...
@property (nonatomic) char schedulePeriodicActionXpcActivity;
...
@property (nonatomic) char currentBeaconingState;
@property (nonatomic) char forceBeaconingOff;
@property (nonatomic) unsigned char currentStatus;
@property (nonatomic) long long cachedLocalBeaconManagerState;
@property (nonatomic) char initialStateChangeSent;
@property (nonatomic) char beaconFromNVRAM;
...
@property (nonatomic) char alreadyPoisonedLocalBeacon;
...
- (void)notifyStateChange:(char)a0;
...
- (void)stateDidChange:(char)a0 powerState:(unsigned long long)a1;
