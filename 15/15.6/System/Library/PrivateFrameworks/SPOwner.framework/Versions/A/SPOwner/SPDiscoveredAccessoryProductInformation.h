...
@property (nonatomic) char eligibleForPairing;
@property (nonatomic) char hidden;
@property (nonatomic) char isHELEAccessory;
@property (nonatomic) char isManagedAccessory;
@property (nonatomic) char supportBeaconGroupInfo;
...
@property (nonatomic) char isAirTag;
