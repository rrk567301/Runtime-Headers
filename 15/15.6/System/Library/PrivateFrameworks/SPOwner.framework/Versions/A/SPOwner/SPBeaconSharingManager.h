...
- (void)downloadKeysWithCircleIdentifier:(id)a0 fromBookmark:(char)a1 completion:(id /* block */)a2;
...
- (void)uploadKeysWithCircleIdentifier:(id)a0 isInitialUpload:(char)a1 completion:(id /* block */)a2;
