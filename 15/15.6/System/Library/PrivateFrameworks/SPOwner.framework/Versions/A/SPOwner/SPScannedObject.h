...
@property (nonatomic) char nearOwner;
...
- (id)initWithAdvertisementType:(long long)a0 poshNetwork:(unsigned char)a1 nearOwner:(char)a2 vendorPayload:(id)a3 scanDate:(id)a4 address:(id)a5 advertisement:(id)a6 status:(unsigned char)a7 ek:(unsigned char)a8 hint:(id)a9 rssi:(long long)a10 indexInformation:(id)a11 acccessoryInformation:(id)a12;
