...
- (void)start;
- (id)remoteInterface;
- (void)allBeaconingKeysForUUID:(id)a0 dateInterval:(id)a1 forceGenerate:(char)a2 completion:(id /* block */)a3;
- (void)allBeaconsOfType:(id)a0 completion:(id /* block */)a1;
- (void)allBeaconsOfTypes:(id)a0 completion:(id /* block */)a1;
- (void)allBeaconsOfTypes:(id)a0 includeDupes:(char)a1 includeHidden:(char)a2 completion:(id /* block */)a3;
...
- (void)createDuplicateBeaconsForBeacon:(id)a0 skipGroupIdentifier:(char)a1 count:(long long)a2 completion:(id /* block */)a3;
...
- (void)setSuppressLPEMBeaconing:(char)a0 completion:(id /* block */)a1;
- (void)setUserHasAcknowledgedFindMy:(char)a0 completion:(id /* block */)a1;
