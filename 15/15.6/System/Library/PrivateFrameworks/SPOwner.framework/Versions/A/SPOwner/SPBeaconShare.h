...
@property (nonatomic) char delegationStatus;
...
- (id)initWithIdentifier:(id)a0 beaconIdentifier:(id)a1 sharingCircleIdentifier:(id)a2 peerTrustIdentifier:(id)a3 owner:(id)a4 sharee:(id)a5 state:(long long)a6 creationDate:(id)a7 expirationDate:(id)a8 delegationStatus:(char)a9;
- (id)initWithIdentifier:(id)a0 beaconIdentifier:(id)a1 sharingCircleIdentifier:(id)a2 peerTrustIdentifier:(id)a3 owner:(id)a4 sharee:(id)a5 state:(long long)a6 creationDate:(id)a7 expirationDate:(id)a8 visitorCount:(long long)a9 delegationStatus:(char)a10;
