...
@property (readonly, nonatomic) char useSqlite;
...
- (id)init:(id)a0 url:(id)a1 useSqlite:(char)a2;
- (char)pruneFrom:(id)a0 endDate:(id)a1 option:(unsigned long long)a2;
- (char)updateFeatureSet:(id)a0;
- (char)updateFeatureSet:(id)a0 featureVestion:(id)a1 featureValues:(id)a2;
