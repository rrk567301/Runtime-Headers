...
- (id)readData:(id)a0 endDate:(id)a1 reversed:(char)a2;
- (id)readDataWithTimestamp:(id)a0 endDate:(id)a1 reversed:(char)a2;
- (id)readTimeStamps:(id)a0 endDate:(id)a1 reversed:(char)a2;
