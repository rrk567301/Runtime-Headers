...
@property char isLiveSystemInfoPrimed;
...
@property char addBackupsOnPrime;
...
- (char)doesBackupContainAnyHitsForTargets:(id)a0 backup:(id)a1;
...
- (id)mapScopeKind:(long long)a0 locations:(id)a1 toBackup:(id)a2 homeTarget:(id)a3 isTagSearch:(char)a4;
