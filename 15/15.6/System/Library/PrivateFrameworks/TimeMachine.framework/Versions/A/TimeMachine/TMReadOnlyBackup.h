...
+ (id)expectedBackupURLForDate:(id)a0 backupDataVolumeUUID:(id)a1 inUnitTest:(char)a2;
+ (id)expectedBackupURLForTimestamp:(id)a0 backupDataVolumeUUID:(id)a1 inUnitTest:(char)a2;
...
+ (char)validateSnapshotName:(id)a0;
