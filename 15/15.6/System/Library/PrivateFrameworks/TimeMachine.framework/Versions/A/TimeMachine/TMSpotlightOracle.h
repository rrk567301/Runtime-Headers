...
@property char indexTrustable;

+ (id)oracleForMountPoint:(id)a0;
+ (id)oracleForMountPoint:(id)a0 device:(int)a1;
+ (id)oracleForMountPoint:(id)a0 device:(int)a1 findStickyExclusionsUsingSpotlight:(char)a2;
...
- (char)pathIsExcludedFromIndexing:(const char *)a0;
