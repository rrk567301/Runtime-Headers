...
+ (char)deleteBackupAtURL:(id)a0 bytesDeleted:(unsigned long long *)a1 willUnlinkBlock:(id /* block */)a2 cancelBlock:(id /* block */)a3 error:(id *)a4;

- (void).cxx_destruct;
- (long long)compare:(id)a0;
- (char)isMounted;
- (char)finishBrowsing:(id *)a0;
...
- (char)_setLegacySnapshotStateFromBackupState:(unsigned long long)a0 error:(id *)a1;
- (id)backupVersion;
...
- (char)isNewerThanSnapshot:(id)a0;
- (id)moveUnderURL:(id)a0 newParent:(id)a1 error:(id *)a2;
- (id)readyForBrowsingWithOptions:(unsigned long long)a0 error:(id *)a1;
- (char)setBackupState:(unsigned long long)a0 error:(id *)a1;
- (char)setBackupVersion:(id)a0 error:(id *)a1;
- (char)setSnapshotNumber:(id)a0;
- (id)snapshotNumber;
- (id)snapshotURLForVolumeUUID:(id)a0;
- (id)totalBytesCopied;
- (char)updateMaximumFileID:(id *)a0;
