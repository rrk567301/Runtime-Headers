...
@property (readonly) char isLegacyConnection;
...
- (id)_initForServiceNamed:(id)a0 legacyConnection:(char)a1;
- (id)_newConnectionListenerWithName:(id)a0 legacyConnection:(char)a1;
