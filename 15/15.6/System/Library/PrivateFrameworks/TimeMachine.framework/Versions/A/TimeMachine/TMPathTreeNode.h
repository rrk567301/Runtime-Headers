...
- (void)_enumerateTree:(id /* block */)a0 path:(id)a1 depth:(long long)a2 outStop:(char *)a3;
- (void)addChildNode:(id)a0;
- (char)containsChildNodeNamed:(id)a0;
