...
- (char)deleteFromDisk:(id *)a0;
- (char)finishBrowsing:(id *)a0;
- (char)_deleteBackupFromDisk:(id *)a0;
- (char)_deleteLocalSnapshotFromDisk:(id *)a0;
- (char)_finishBrowsingBackup:(id *)a0;
- (char)_finishBrowsingLocalSnapshot:(id *)a0;
