...
@property (readonly) char isTombstone;
...
- (id)initWithName:(id)a0 date:(id)a1 dateOfPrecedingBackup:(id)a2 minimumFileID:(unsigned long long)a3 maximumFileID:(unsigned long long)a4 expectedBackupURL:(id)a5 kind:(unsigned long long)a6 isTombstone:(char)a7;
