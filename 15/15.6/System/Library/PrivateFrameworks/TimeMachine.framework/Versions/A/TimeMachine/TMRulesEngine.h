...
@property char systemFilesExcluded;
...
+ (id)rulesEngineForStandardBackupOfVolumes:(id)a0 pathExclusions:(id)a1 excludedVolumeUUIDs:(id)a2 findStickyExclusionsUsingSpotlight:(char)a3 qos:(long long)a4 error:(id *)a5 cancelBlock:(id /* block */)a6;
+ (id)rulesEngineUsingBOM:(id)a0 findStickyExclusionsUsingSpotlight:(char)a1 qos:(long long)a2 cancelBlock:(id /* block */)a3;
+ (id)rulesEngineUsingBaseRuleSet:(unsigned int)a0 sourceVolumes:(id)a1 pathExclusions:(id)a2 excludedVolumeUUIDs:(id)a3 findStickyExclusionsUsingSpotlight:(char)a4 qos:(long long)a5 cancelBlock:(id /* block */)a6;
