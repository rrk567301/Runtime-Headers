...
@property unsigned long long smbConversionState;
...
@property (copy) NSString *diskImageCreatedByBuild;

+ (char)extractInfoFromAliasData:(id)a0 isNetworkDestination:(out char *)a1 networkURL:(out id *)a2 volumeName:(out id *)a3;
...
- (char)resemblesOtherDestination:(id)a0;
