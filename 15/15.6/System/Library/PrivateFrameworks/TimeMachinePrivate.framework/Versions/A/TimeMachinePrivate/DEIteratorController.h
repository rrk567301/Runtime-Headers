...
@property char reportIdenticalItems;
@property char printDifferences;
...
@property (readonly) char foundDifferences;
...
- (char)differenceEngine:(id)a0 shouldSkipNewItem:(id)a1;
- (char)differenceEngine:(id)a0 shouldSkipOldItem:(id)a1;
