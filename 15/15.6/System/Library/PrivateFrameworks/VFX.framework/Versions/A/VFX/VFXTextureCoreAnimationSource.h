...
- (void)_resizeLayer:(id)a0 toSize:(struct CGSize { double x0; double x1; })a1 updateLayer:(char)a2 updateTransform:(char)a3 caRenderer:(id)a4;
- (float)clearValue;
