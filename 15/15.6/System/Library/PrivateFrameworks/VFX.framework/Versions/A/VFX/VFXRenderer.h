...
@interface VFXRenderer : NSObject <VFXMTLRenderContextCommandBufferStatusMonitor, VFXMTLRenderContextResourceManagerMonitor, VFXWorldRenderer> {
    ...
    char _customRenderGraphEnabled;
...
- (void)setForceAsyncShaderCompilation:(char)a0;
...
- (char)_isNodeInsideFrustum:(SEL)a0 withPointOfView:(id)a1 viewport:(id)a2;
- (void)_jitterAtStep:(unsigned long long)a0 updateMainFramebuffer:(char)a1 redisplay:(char)a2 jitterer:(id)a3;
...
- (char)renderMovieToURL:(id)a0 size:(struct CGSize { double x0; double x1; })a1 antialiasingMode:(unsigned long long)a2 attributes:(id)a3 error:(id *)a4;
...
- (void)setRendersContinuously:(char)a0;
- (void)setVertexAmplificationEnabled:(char)a0;
- (void)set_aspectRatio:(float)a0;
- (void)set_collectCompilationErrors:(char)a0;
...
- (char)vertexAmplificationEnabled;
...
- (id)_initWithDevice:(id)a0 options:(id)a1 isPrivateRenderer:(char)a2 privateRendererOwner:(id)a3 clearsOnDraw:(char)a4;
- (char)_legacyAdditiveWritesToAlpha;
...
- (void)_setLegacyAdditiveWritesToAlpha:(char)a0;
- (char)_shouldForwardWorldRendererDelegationMessagesToPrivateRendererOwner;
- (char)_triggersEnabled;
- (void)_updateProbes:(id)a0 progress:(id)a1 completionHandler:(id /* block */)a2;
- (char)_viewportDidChange;
- (char)_wantsWorldRendererDelegationMessages;
- (void)_willRenderWorld:(id)a0;
- (char)canRecycleParticleBuffers;
- (unsigned long long)debugUIOptions;
- (void)drawStatisticsIfNeeded;
- (char)hasImGuiFrameStarted;
