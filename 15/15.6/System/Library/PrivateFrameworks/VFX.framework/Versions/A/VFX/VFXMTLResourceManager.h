...
- (id)latlongTextureForCubemap:(id)a0 pixelFormat:(unsigned long long)a1 renderContext:(id)a2 needsMipmap:(char)a3;
...
- (char)_copyImage:(struct __CFXImage { } *)a0 toTexture:(id)a1 desc:(id)a2 textureOptions:(int)a3 needsMipMapGeneration:(char)a4;
...
- (id)_computePipelineStateForKernel:(id)a0 constants:(id)a1 constantsHash:(id)a2 threadGroupSizeIsMultipleOfThreadExecutionWidth:(char)a3;
...
- (void)_enqueueCopyFromTexture:(id)a0 toTexture:(id)a1 blitEncoder:(struct VFXMTLBlitCommandEncoder { id x0; id x1; } *)a2 generateMipMaps:(char)a3;
...
- (id)_textureDescriptorFromImage:(struct __CFXImage { } *)a0 needsMipMap:(char)a1 textureOptions:(int)a2;
...
- (id)computePipelineStateForKernel:(id)a0 threadGroupSizeIsMultipleOfThreadExecutionWidth:(char)a1;
...
- (id)copyTextureByConvertingToCubeMapIfApplicable:(id)a0 engineContext:(struct __CFXEngineContext { } *)a1 needsMipmap:(char)a2;
- (id)defaultCubeTexture;
- (id)defaultLightingEnvironmentIrradianceTexture;
- (id)defaultLightingEnvironmentRadianceTexture;
- (struct __CFXFXProgram { } *)defaultProgramUsingTessellation:(char)a0;
- (id)defaultTexture;
- (id)defaultTexture3D;
- (id)getUniqueStageDescriptor:(id)a0;
- (char)hasCommonProfilePrecompiledFunctions;
...
- (id)newCubemapTextureForLatlongTexture:(id)a0 pixelFormat:(unsigned long long)a1 engineContext:(struct __CFXEngineContext { } *)a2 needsMipmap:(char)a3;
- (id)newRadianceTextureForEnvironmentTexture:(id)a0 engineContext:(struct __CFXEngineContext { } *)a1 cpuAccessible:(char)a2 commandBuffer:(id)a3;
