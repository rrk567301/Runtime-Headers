...
@interface VFXMTLDeformerStack : NSObject <VFXMTLDeformerInitComputeContext, VFXMTLDeformerUpdateComputeContext> {
    ...
    char _isValid;
    char _reliesOnTransforms;
    char _reliesOnFrustum;
    ...
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _initialPositionStageInputOutputDescriptorInfo;
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _initialNormalStageInputOutputDescriptorInfo;
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _initialTangentStageInputOutputDescriptorInfo;
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _deformPositionStageInputOutputDescriptorInfo;
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _deformNormalStageInputOutputDescriptorInfo;
    struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } _deformTangentStageInputOutputDescriptorInfo;
...
- (void)setupFinalMeshWithMesh:(struct __CFXMesh { } *)a0 entityName:(struct __CFString { } *)a1 info:(struct { char x0; char x1; char x2; char x3; })a2 usingDrawIndirect:(char)a3;
- (void)setupInitialBuffersWithBaseMesh:(struct __CFXMesh { } *)a0 entityName:(struct __CFString { } *)a1 info:(struct { char x0; char x1; char x2; char x3; char x4; char x5; })a2;
