...
@property (nonatomic) char drivenByDefaultNavigationCameraController;
...
@property (nonatomic) void /* unknown type, empty encoding */ up;
...
@property (nonatomic) char automaticTarget;
@property (nonatomic) void /* unknown type, empty encoding */ worldUp;
@property (nonatomic) char inertiaEnabled;
@property (nonatomic) float inertiaFriction;
@property (readonly, nonatomic, getter=isInertiaRunning) char inertiaRunning;
...
- (char)_isLocationValid:(struct CGPoint { double x0; double x1; })a0 inViewport:(struct CGSize { double x0; double x1; })a1;
...
- (void)clearRoll;
- (void)continueInteraction:(struct CGPoint { double x0; double x1; })a0 withViewport:(struct CGSize { double x0; double x1; })a1 sensitivity:(float)a2;
...
- (void)setPointOfView:(id)a0 updateUpTransform:(char)a1;
- (void)stopInertia;
