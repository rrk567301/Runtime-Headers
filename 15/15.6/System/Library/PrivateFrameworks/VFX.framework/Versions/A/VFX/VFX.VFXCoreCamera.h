...
@property (nonatomic) char isOrthographic;
@property (nonatomic) struct { void /* unknown type, empty encoding */ x0[4]; } worldTransform;
@property (nonatomic) struct { void /* unknown type, empty encoding */ x0[4]; } lastFrameWorldTransform;
...
@property (nonatomic, readonly) char reverseZ;
