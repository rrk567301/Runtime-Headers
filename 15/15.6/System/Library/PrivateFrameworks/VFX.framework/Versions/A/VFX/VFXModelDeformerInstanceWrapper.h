...
@interface VFXModelDeformerInstanceWrapper : NSObject <VFXModelDeformerInitComputeContext, VFXModelDeformerUpdateComputeContext> {
    ...
    struct { struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } srcPositions; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dstPositions; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } srcNormals; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dstNormals; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } srcTangents; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dstTangents; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency0Positions; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency0Normals; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency0Tangents; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency1Positions; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency1Normals; struct { char isActive; unsigned long long bufferAttributeFormat; unsigned long long bufferAttributeOffset; unsigned long long bufferLayoutStride; } dependency1Tangents; } _stageInputOutputDescriptors;
...
- (void)setStageInputOutputBuffersToComputeEncoder:(struct VFXMTLComputeCommandEncoder { id x0; id x1; struct VFXMTLBufferPool *x2; unsigned int x3; } *)a0;
