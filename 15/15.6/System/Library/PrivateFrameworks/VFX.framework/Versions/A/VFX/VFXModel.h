...
@interface VFXModel : NSObject <VFXBehaviorSupport, VFXAnimatable, VFXBoundingBox, VFXShadable, VFXBehaviorSupport, NSCopying, NSSecureCoding> {
    ...
    struct { char enableVertexWeldingAtImport; unsigned char boundaryInterpolationRule; unsigned char faceVaryingInterpolationRule; unsigned char normalSmoothingMode; } _subdivisionSettings;
...
@property (nonatomic) char wantsAdaptiveSubdivision;
...
- (struct { char x0; unsigned char x1; unsigned char x2; unsigned char x3; })_subdivisionSettings;
...
- (char)parseSpecialKey:(id)a0 withPath:(id)a1 intoDestination:(id *)a2 remainingPath:(id *)a3;
...
- (void)set_subdivisionSettings:(struct { char x0; unsigned char x1; unsigned char x2; unsigned char x3; })a0;
