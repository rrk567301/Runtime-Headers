...
- (char)deferredBindingEnabled;
- (id)fragmentBufferBoundAt:(unsigned long long)a0;
- (id)initWithEncoder:(id)a0;
- (char)isCullModeLocked;
- (char)isFillModeLocked;
- (void)loadWithCommandBuffer:(id)a0 renderPassDescriptor:(id)a1;
- (void)rg_setLineWidth:(float)a0;
- (void)setDeferredBindingEnabled:(char)a0;
- (void)setEncoder:(id)a0 alreadyUsed:(char)a1;
- (void)setLockCullMode:(char)a0;
- (void)setLockFillMode:(char)a0;
