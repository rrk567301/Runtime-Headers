...
@property (nonatomic) char automaticallyAdjustsShadowProjection;
@property (nonatomic) float maximumShadowDistance;
@property (nonatomic) char forcesBackFaceCasters;
@property (nonatomic) char sampleDistributedShadowMaps;
...
@property (nonatomic) char parallaxCorrectionEnabled;
...
@property (nonatomic) char drawsArea;
...
- (void)setBaked:(char)a0;
- (void)setShouldBakeDirectLighting:(char)a0;
- (void)setShouldBakeIndirectLighting:(char)a0;
