...
+ (id)meshSourceWithData:(id)a0 semantic:(id)a1 vectorCount:(long long)a2 floatComponents:(char)a3 componentsPerVector:(long long)a4 bytesPerComponent:(long long)a5 dataOffset:(long long)a6 dataStride:(long long)a7;
