...
@property (nonatomic) char wantsScreenSpaceReflection;
...
- (id)_physicsWorldCreateIfNeeded:(char)a0;
...
- (void)set_allowsDefaultLightingEnvironmentFallback:(char)a0;
- (void /* unknown type, empty encoding */)upAxis;
- (char)writeToURLWithUSDKit:(id)a0;
- (id)stateManager;
...
- (void)_setRootNode:(id)a0 immediate:(char)a1;
- (char)allowRemoteEdition;
...
- (char)initializeCoreEntityManagerWithInfo:(id)a0 error:(id *)a1;
- (char)load:(id)a0 options:(id)a1 error:(id *)a2;
- (char)loadCoreEntityManagerFromURL:(id)a0 options:(id)a1 infoOut:(id)a2 error:(id *)a3;
- (void)loadMDLAsset:(id)a0 options:(id)a1 context:(id)a2;
- (void)loadSCN:(id)a0 options:(id)a1 error:(id *)a2;
- (char)migrateCoreEntityManagerWithInfo:(id)a0 error:(id *)a1;
- (long long)presentationEntityFromModel:(long long)a0;
- (id)presentationScene;
- (char)reloadFromURL:(id)a0 error:(id *)a1;
- (id)remapTable;
...
- (void)setAllowRemoteEdition:(char)a0;
...
- (char)writeToURL:(id)a0 options:(id)a1 progressHandler:(id /* block */)a2;
