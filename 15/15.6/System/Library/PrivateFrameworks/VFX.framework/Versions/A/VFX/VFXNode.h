...
+ (id)localRightValue;
+ (char)VFXUID_rangeForFloatProperty:(id)a0 min:(float *)a1 max:(float *)a2;
+ (id)localFrontValue;
...
- (char)_childNodesPassingTest:(id /* block */)a0 recursively:(char)a1 output:(id)a2;
- (void *)__CFObject;
- (void)__removeObjectFromChildNodesAtIndex:(unsigned long long)a0;
- (id)__skinner;
- (char)getBoundingSphereCenter:(void *)a0 radius:(float *)a1;
- (char)isJoint;
- (void)_childNodesWithAttribute:(Class)a0 output:(id)a1 recursively:(char)a2;
- (void)_dump:(id)a0;
...
- (void)_syncObjCModel;
- (char)canAddChildNode:(id)a0;
- (id)childNodeWithName:(id)a0;
- (id)childNodeWithName:(id)a0 recursively:(char)a1;
- (id)childNodesPassingTest:(id /* block */)a0;
- (id)childNodesPassingTest:(id /* block */)a0 recursively:(char)a1;
- (id)childNodesWithAttribute:(Class)a0 recursively:(char)a1;
- (id)flattenedCopy;
- (id)getBoundingBox;
...
- (id)objectInChildNodesWithAttribute:(id)a0 firstOnly:(char)a1;
...
- (void)setGizmo:(char)a0;
- (char)_enumerateChildNodesUsingBlock:(id /* block */)a0;
- (void)addAudioPlayer:(id)a0;
- (void)lookAt:(SEL)a0;
- (id)_audioPlayers;
- (void)_bakeNodes:(id)a0 folderPath:(id)a1 inVertex:(char)a2 bakeAO:(char)a3 quality:(float)a4 attenuation:(float)a5 geomSetter:(id /* block */)a6 terminateSetter:(id /* block */)a7;
...
- (void)_setPausedOrPausedByInheritance:(char)a0;
...
- (id)flattenedClone;
- (char)getFrustum:(SEL)a0 withViewport:(struct { struct { } x0[6]; } *)a1;
...
- (void)setHittable:(char)a0;
- (void)setIsJoint:(char)a0;
- (void)setUsesDepthPrePass:(char)a0;
...
- (void)_customEncodingOfVFXNode:(id)a0 usePresentationObject:(char)a1;
