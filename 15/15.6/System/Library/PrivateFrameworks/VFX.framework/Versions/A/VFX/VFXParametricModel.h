...
@property (nonatomic, getter=isHemispheric) char hemispheric;
...
- (char)getBoundingSphereCenter:(void *)a0 radius:(float *)a1;
- (void)_syncObjCModel;
- (char)getBoundingBoxMin:(void *)a0 max:(void *)a1;
