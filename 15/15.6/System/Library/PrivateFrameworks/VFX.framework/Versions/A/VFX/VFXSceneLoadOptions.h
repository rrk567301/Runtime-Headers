...
@property (nonatomic) void /* unknown type, empty encoding */ isAuthoringWorld;
...
@property (nonatomic, weak) void /* unknown type, empty encoding */ world;
...
@property (nonatomic) char enableDeferredRendering;
...
@property (nonatomic) void /* unknown type, empty encoding */ counterStorage;
...
- (id)init;
- (void).cxx_destruct;
- (void)registerVFX2AuthoringSystems:(char)a0;
