...
@property (nonatomic) char selectionIsReadonly;
@property (readonly, nonatomic) char selecting;
@property (readonly, nonatomic) VFXManipulator *manipulator;
@property (readonly, nonatomic) VFXNode *authoringOverlayLayer;
@property (nonatomic) char shouldSnapOnGrid;
@property (nonatomic) char shouldSnapToAlign;
@property (nonatomic) char graphicalSelectionEnabled;
@property (nonatomic) char surroundToSelect;
...
+ (id)authoringEnvironmentForWorldRenderer:(id)a0 createIfNeeded:(char)a1;
