...
@property (readonly, nonatomic) char viewportDependant;
...
- (char)matchesDescription:(SEL)a0 size:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9[4]; } *)a1 arrayLength:(unsigned long long)a2;
