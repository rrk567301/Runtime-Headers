...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 wasSuccessful:(char)a1 clientInitTime:(id)a2 clientOpenSocketCompletionTime:(id)a3 daemonOpenSocketTime:(id)a4 daemonOpenSocketCompletionTime:(id)a5 firstPacketReceiveTime:(id)a6 connectionInitTime:(id)a7;
