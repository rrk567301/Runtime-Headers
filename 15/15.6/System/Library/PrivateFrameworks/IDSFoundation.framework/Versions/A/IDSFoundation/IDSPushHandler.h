...
@property (nonatomic) char shouldWaitToSetTopics;
...
- (id)init;
- (void).cxx_destruct;
- (void)connection:(id)a0 didChangeConnectedStatus:(char)a1;
...
- (void)_updateTopics;
- (char)_validateHandler:(id)a0 withSelector:(SEL)a1 topic:(id)a2 command:(id)a3;
