...
@property (nonatomic) char isSentToClient;
@property (nonatomic) char isGeneratedLocally;
...
- (id)initWithKeyMaterial:(id)a0 keySalt:(id)a1 keyIndex:(id)a2 groupID:(id)a3 isGeneratedLocally:(char)a4 createdAt:(id)a5 generationCounter:(unsigned int)a6 participantID:(unsigned long long)a7;
- (id)initWithKeyMaterial:(id)a0 keySalt:(id)a1 keyIndex:(id)a2 groupID:(id)a3 isGeneratedLocally:(char)a4 createdAt:(id)a5 generationCounter:(unsigned int)a6 participantID:(unsigned long long)a7 shortKeyIndexLength:(unsigned char)a8;
- (id)initWithKeyMaterial:(id)a0 keySalt:(id)a1 keyIndex:(id)a2 groupID:(id)a3 participantID:(unsigned long long)a4;
- (char)isEqualToRealTimeEncryptionKeyMaterial:(id)a0;
