...
- (void)avcReceiveMKMTime:(double)a0 forMKI:(id)a1 isGeneratedLocally:(char)a2;
...
- (void)linkConnectedWithH2FallbackEnabled:(char)a0;
...
- (void)sendMKMToAVC:(id)a0 isGeneratedLocally:(char)a1;
