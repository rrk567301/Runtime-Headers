...
@property (readonly, nonatomic) char isToDefaultPairedDevice;
...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 isToDefaultPairedDevice:(char)a1 closeError:(unsigned long long)a2 socketError:(unsigned long long)a3 bytesSent:(unsigned long long)a4 packetsSent:(unsigned long long)a5 bytesReceived:(unsigned long long)a6 packetsReceived:(unsigned long long)a7;
