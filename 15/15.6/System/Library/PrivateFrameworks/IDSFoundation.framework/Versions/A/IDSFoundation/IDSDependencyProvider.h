...
- (id)apsConnectionWithEnvironmentName:(id)a0 namedDelegatePort:(id)a1 enablePushDuringSleep:(char)a2 queue:(id)a3;
...
- (char)getKeychainData:(id *)a0 service:(id)a1 account:(id)a2 accessGroup:(id)a3 error:(int *)a4;
- (id)loadServiceDictionaries;
- (id)placeholderMachPort;
- (void)registerObject:(id)a0 forProtocol:(id)a1;
- (id)registeredObjectForProtocol:(id)a0;
- (char)removeKeychainDataOnService:(id)a0 account:(id)a1 error:(int *)a2;
- (char)setKeychainData:(id)a0 service:(id)a1 account:(id)a2 accessGroup:(id)a3 allowSync:(char)a4 error:(int *)a5;
