...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 isToDefaultPairedDevice:(char)a1 messageSize:(unsigned long long)a2 linkType:(unsigned long long)a3 deliveryError:(unsigned long long)a4 RTT:(unsigned long long)a5 priority:(unsigned long long)a6;
