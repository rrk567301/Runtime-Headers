...
@property (readonly, nonatomic) char isHeartbeatRegister;
...
- (void).cxx_destruct;
- (id)initWithGuid:(id)a0 success:(char)a1 connectionType:(unsigned int)a2 resultCode:(unsigned int)a3 registrationType:(unsigned int)a4 isHeartbeatRegister:(char)a5 heartbeatDelay:(id)a6 genericError:(id)a7 URLError:(id)a8 POSIXError:(id)a9;
