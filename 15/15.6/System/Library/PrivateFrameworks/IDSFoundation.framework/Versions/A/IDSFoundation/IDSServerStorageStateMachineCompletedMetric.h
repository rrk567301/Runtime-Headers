...
@property (readonly, nonatomic) char wasPrimary;
...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 linkType:(long long)a1 wasPrimary:(char)a2 timeTaken:(double)a3 numberProcessed:(long long)a4;
