...
@interface IDSMessageContext : NSObject {
    ...
    char _wantsAppAck;
    char _isDirectMessage;
    char _usedEngram;
    char _isFromTrustedSender;
}
...
@property (nonatomic) char usedEngram;
...
@property (nonatomic) char wantsManualAck;
@property (nonatomic) char fromServerStorage;
@property (nonatomic) char messageHadEncryptedData;
@property (nonatomic) char isDirectMessage;
...
@property (readonly, nonatomic) char deviceBlackedOut;
...
@property (readonly, nonatomic) char isFromTrustedSender;
...
- (void)setIsFromTrustedSender:(char)a0;
