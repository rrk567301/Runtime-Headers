...
@property (readonly, nonatomic) char isInterestingRegion;
...
- (id)initWithControlRegistrationType:(long long)a0 registrationControlStatus:(long long)a1 isInterestingRegion:(char)a2;
