...
- (void)requestIDStatusForURIs:(id)a0 service:(id)a1 lightQuery:(char)a2 allowQuery:(char)a3 completionBlock:(id /* block */)a4;
- (void)sendAccountSyncMessage:(id)a0 messageID:(id)a1 queueOneIdentifier:(id)a2 allowCloudFallback:(char)a3 completionBlock:(id /* block */)a4;
