...
- (char)_write:(char *)a0 outputLength:(int *)a1 dropLowerPriorityFields:(char)a2;
- (char)getAttribute:(long long)a0 attribute:(struct IDSGlobalLinkAttribute { unsigned short x0; unsigned short x1; union { struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x0; unsigned short x1; unsigned int x2; unsigned long long x3; struct IDSGLAttrBinaryData_ { int x0; unsigned char x1[1024]; } x4; } x2; } *)a1;
- (id)initWithCommand:(long long)a0;
- (char)read:(char *)a0 inputLength:(int)a1;
- (char)verifyHMacDigestWithKey:(id)a0 inputBuffer:(char *)a1 inputLength:(int)a2;
- (char)write:(char *)a0 outputLength:(int *)a1;
