...
- (id)sealMessage:(id)a0 authenticatedData:(id)a1 messageType:(long long)a2 guid:(id)a3 sendingURI:(id)a4 sendingPushToken:(id)a5 receivingURI:(id)a6 receivingPushToken:(id)a7 forceSizeOptimizations:(char)a8 resetState:(char)a9 withEncryptedAttributes:(id)a10 signedByFullIdentity:(id)a11 usedIdentityWithIdentifier:(id *)a12 error:(id *)a13 additionalResult:(id *)a14;
