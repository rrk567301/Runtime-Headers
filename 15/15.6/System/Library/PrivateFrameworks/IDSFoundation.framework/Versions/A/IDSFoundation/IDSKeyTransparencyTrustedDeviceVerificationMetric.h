...
@property (readonly, nonatomic) char cloudKitSuccess;
...
@property (readonly, nonatomic) char accountKeySuccess;
...
- (void).cxx_destruct;
- (id)initWithKeyTransparencyVersion:(unsigned long long)a0 cloudKitSuccess:(char)a1 cloudKitErrorDomain:(id)a2 cloudKitErrorCode:(long long)a3 cloudKitUnderlyingErrorDomain:(id)a4 cloudKitUnderlyingErrorCode:(long long)a5 cloudKitOperationTimeInterval:(double)a6 accountKeySuccess:(char)a7 accountKeyErrorDomain:(id)a8 accountKeyErrorCode:(long long)a9 accountKeyUnderlyingErrorDomain:(id)a10 accountKeyUnderlyingErrorCode:(long long)a11 accountKeyOperationTimeInterval:(double)a12 numberOfTotalDevices:(unsigned long long)a13 numberOfCandidateDevices:(unsigned long long)a14 numberOfMatchesFromCloudKit:(unsigned long long)a15 numberOfMatchesFromAccountKey:(unsigned long long)a16;
