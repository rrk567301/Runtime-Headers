...
@property (readonly, nonatomic) char fromStorage;
...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 accountType:(id)a1 fromStorage:(char)a2 serverTimestamp:(double)a3 localTimeDelta:(double)a4;
