...
@property (readonly, nonatomic) char supportsDiscreteLifetimes;
@property (readonly, nonatomic, getter=isDrivingActivity) char drivingActivity;
@property (readonly, nonatomic, getter=isSleepActivity) char sleepActivity;
