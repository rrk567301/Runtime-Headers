...
@interface FCActivityManager : NSObject <DNDModeSelectionServiceListener, DNDLifetimeDetailsProviderDelegate> {
    ...
    char _activeModeAssertionIsValid;
}
...
@property (readonly, nonatomic, getter=isDefaultConfiguration) char defaultConfiguration;
@property (readonly, copy, nonatomic) NSString *localizedTerminationDescriptionForActiveActivity;
@property (nonatomic, getter=isLifetimeDescriptionsUpdatingEnabled) char lifetimeDescriptionsUpdatingEnabled;
...
- (char)_doesActivity:(id)a0 identifySameModeAsActivity:(id)a1;
- (void)_invalidateActiveModeAssertion;
- (char)_isSyncedAssertion:(id)a0;
...
- (char)isActivityLocalUserInitiated:(id)a0;
...
- (void)setActivity:(id)a0 active:(char)a1 reason:(id)a2;
- (void)setActivity:(id)a0 active:(char)a1 withLifetime:(id)a2 reason:(id)a3;
- (char)shouldActivityShowStatusPill:(id)a0;
