...
- (id)frequencybasedSuggestionsWitMaxSuggestions:(unsigned long long)a0 events:(id)a1 useScenes:(char)a2;
...
- (id)timeBasedSuggestionsWithMaxSuggestions:(unsigned long long)a0 referenceDate:(id)a1 fallBackToFrequency:(char)a2;
