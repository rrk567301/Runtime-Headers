...
- (char)deleteInteractionsWithBundleId:(id)a0 error:(id *)a1;
- (id)initWithKnowledgeStore:(id)a0;
- (void)deleteEventWithIdentifier:(id)a0 completionHandler:(id /* block */)a1;
- (char)deleteEventWithIdentifier:(id)a0 error:(id *)a1;
