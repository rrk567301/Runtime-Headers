...
- (char)_didLocalizationChange:(unsigned short)a0;
- (char)_didTriggerMigration:(id /* block */)a0 reason:(unsigned short)a1;
- (void)_enumerateLocalInstancesOfSet:(id)a0 hasDelta:(char *)a1 fromBookmark:(char *)a2;
- (char)_enumerateLocalInstancesOfSet:(id)a0 priorBookmark:(id)a1 newBookmark:(id *)a2 hasDelta:(char *)a3 addedInstancesBlock:(id /* block */)a4;
...
- (char)_isClearRequiredForSet:(id)a0 installedAppBundleIds:(id)a1;
- (char)_isDeleteRequiredForSet:(id)a0 installedAppBundleIds:(id)a1;
- (char)_isSet:(id)a0 excludedFromInstalledAppBundleIds:(id)a1;
- (char)_loadOrCreateTaskInfo;
...
- (char)clearAllState;
- (void)enableSimulatedTasks:(char)a0;
- (char)handleTask:(unsigned short)a0 reason:(unsigned short)a1 shouldDefer:(id /* block */)a2 completion:(id /* block */)a3;
