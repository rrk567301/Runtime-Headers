...
- (void)_triggerMigration:(char)a0 completeAfterTrigger:(char)a1 completion:(id /* block */)a2;
- (long long)beginEvaluation:(id)a0 options:(unsigned short)a1;
...
- (long long)executeEvaluationTask:(unsigned short)a0;
...
- (id)simulateEventHandling:(char)a0;
- (void)triggerMaintenance:(id /* block */)a0;
- (void)triggerMigration:(id /* block */)a0;
- (void)triggerMigration:(char)a0 completion:(id /* block */)a1;
