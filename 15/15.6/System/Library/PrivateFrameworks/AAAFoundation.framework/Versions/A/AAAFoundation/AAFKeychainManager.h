...
- (void)_unsafe_addKeychainItem:(id)a0 shouldAttemptUpdate:(char)a1 error:(id *)a2;
- (char)_unsafe_deleteKeychainItemWithDescriptor:(id)a0 error:(id *)a1;
...
- (char)_unsafe_updateKeychainItemWithDescriptor:(id)a0 newItem:(id)a1 error:(id *)a2;
