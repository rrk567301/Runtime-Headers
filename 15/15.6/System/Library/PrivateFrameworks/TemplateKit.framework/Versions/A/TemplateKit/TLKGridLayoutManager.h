...
@property (nonatomic) char tableContainsRowHeaders;
...
+ (double)leadingSectionSpacingForView:(id)a0 view2:(id)a1 index:(unsigned long long)a2 alignmentSchema:(id)a3 allEqual:(char)a4;
