...
@property (readonly) char isDark;
@property (readonly) char isVibrant;
...
+ (id)appearanceWithVibrancyEnabled:(char)a0 isDark:(char)a1;
...
+ (char)viewHasOverriddenAppearance:(id)a0;
