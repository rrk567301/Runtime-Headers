...
@property (nonatomic, getter=isPaddingDisabled) char paddingDisabled;
@property (nonatomic, getter=isSelectionEnabled) char selectionEnabled;
@property (nonatomic) char useGridAlignment;
