...
+ (struct CGSize { double x0; double x1; })maxThumbnailSizeIsCompactWidth:(char)a0;
+ (char)widthIsCompact:(double)a0;
+ (void)applyRowBoundedSizingToImageView:(id)a0 isCompactWidth:(char)a1;
