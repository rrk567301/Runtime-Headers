...
- (id)domainFromItemID:(id)a0 checkInvalidation:(char)a1 reason:(unsigned long long *)a2;
...
- (id)providerWithIdentifier:(id)a0 checkInvalidation:(char)a1 reason:(unsigned long long *)a2;
...
- (void)synchronousProviderUpdate:(char)a0;
