...
@interface FPDFilePresenter : NSObject <FPXEnumeratorObserver, FPDLifetimeExtender> {
    ...
    FPItem *_currentItem;
    char _isRunning;
    char _isFetchingChanges;
    char _shouldRefetchChanges;
    char _presenterWantsUbiqitousAttributes;
    char _passivePresenterRequested;
}
...
@property (nonatomic) char isEnumeratorActive;
...
- (void)_fetchUpdates;
- (id)_presentedItemDescription:(char)a0;
