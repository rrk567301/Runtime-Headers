...
- (void)_recursivelyDownloadItem:(id)a0 forceDiskIteration:(char)a1 skipAlreadyDownloadedItems:(char)a2 downloader:(id)a3 request:(id)a4 perItemCompletion:(id /* block */)a5 completion:(id /* block */)a6;
