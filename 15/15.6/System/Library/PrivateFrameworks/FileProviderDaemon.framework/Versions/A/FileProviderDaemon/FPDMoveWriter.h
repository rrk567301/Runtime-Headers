...
- (void)performCopyOfItem:(id)a0 to:(id)a1 as:(id)a2 sourceMaterializeOption:(unsigned long long)a3 targetMaterializeOption:(unsigned long long)a4 useDiskWriter:(char)a5 completion:(id /* block */)a6;
- (void)performCreateFolder:(id)a0 inside:(id)a1 as:(id)a2 useDiskWriter:(char)a3 completion:(id /* block */)a4;
- (void)performMoveOfFolder:(id)a0 to:(id)a1 as:(id)a2 sourceMaterializeOption:(unsigned long long)a3 targetMaterializeOption:(unsigned long long)a4 atomically:(char)a5 useDiskWriter:(char)a6 completion:(id /* block */)a7;
- (void)performMoveOfItem:(id)a0 to:(id)a1 as:(id)a2 sourceMaterializeOption:(unsigned long long)a3 targetMaterializeOption:(unsigned long long)a4 useDiskWriter:(char)a5 completion:(id /* block */)a6;
- (void)setProgress:(id)a0 forRoot:(id)a1;
- (void)startDownloadOfItem:(id)a0 shouldMaterializeRecursively:(char)a1 completionHandler:(id /* block */)a2;
