...
- (void)fetchDefaultContainerForBundleIdentifier:(id)a0 defaultName:(id)a1 inDomainIdentifier:(id)a2 lookupOnly:(char)a3 reply:(id /* block */)a4;
- (void)fetchHierarchyForItemID:(id)a0 recursively:(char)a1 ignoreAlternateContentURL:(char)a2 reply:(id /* block */)a3;
...
- (void)singleItemChange:(id)a0 changedFields:(unsigned long long)a1 bounce:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)updateIgnoreStateOfItemWithIdentifiers:(id)a0 ignoreState:(char)a1 completionHandler:(id /* block */)a2;
