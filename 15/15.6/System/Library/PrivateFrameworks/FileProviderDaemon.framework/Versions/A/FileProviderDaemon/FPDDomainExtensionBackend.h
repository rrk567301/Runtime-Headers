...
- (void)fetchFPCKTelemetryWithCompletionHandler:(id /* block */)a0;
...
- (void)launchFeedbackForDomain:(id)a0 itemIdentifier:(id)a1 triggeringError:(id)a2 when:(id)a3 useDiagnostic:(char)a4 completionHandler:(id /* block */)a5;
