...
@property (readonly, nonatomic) char isLibraryConfigured;
@property (readonly, nonatomic) char isDefaultVolumeForCurrentPersona;
@property (readonly, nonatomic) char supportsEAPFS;
...
+ (char)getProviderDomainID:(id)a0 location:(unsigned int)a1 foundDomainID:(id *)a2 error:(id *)a3;
...
- (char)isInLowDiskSpaceState;
- (char)monitorLowDiskSpaceRecovery;
...
- (id)supportPathForDomain:(id)a0 failIfNotExisting:(char)a1 error:(id *)a2;
- (id)temporaryDirectoryURL:(id)a0 error:(id *)a1;
- (char)writeDomainsProperties:(id)a0 underDirectoryAtURL:(id)a1 error:(id *)a2;
