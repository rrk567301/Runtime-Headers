@class NSArray, NSString, NSSet, NSMutableDictionary, NSObject, NSHashTable;
...
@property (readonly, nonatomic) char trialClientLoadedSuccessfully;
...
@property (readonly, nonatomic) char hasUpcallExecutionTimeLimits;
...
@property (readonly, nonatomic) char hangingDownloadCancellationPromptEnabled;
@property (readonly, nonatomic) int maxFPCKDatabaseChecks;
@property (readonly, nonatomic) int maxFPCKDatabaseChecksDiagnostic;
@property (readonly, nonatomic) char avoidNilErrorItemsForDetailedPayload;
...
@property (readonly, nonatomic) char externalFeedbackAllowed;
