...
- (void)coordinateAtURL:(id)a0 recursively:(char)a1 request:(id)a2 handler:(id /* block */)a3;
...
- (void)resolveItem:(id)a0 recursively:(char)a1 request:(id)a2 andCoordinateWithHandler:(id /* block */)a3;
- (void)resolveItemOrURL:(id)a0 recursively:(char)a1 coordinateIfExport:(char)a2 request:(id)a3 handler:(id /* block */)a4;
- (void)resolveItemOrURL:(id)a0 recursively:(char)a1 request:(id)a2 andCoordinateWithHandler:(id /* block */)a3;
