...
- (void)sim_pkgLookup:(id)a0 name:(id)a1 acceptDemotedPkg:(char)a2 detection:(unsigned int)a3 completionHandler:(id /* block */)a4;
...
- (void)sim_unlinkAt:(id)a0 path:(id)a1 flag:(long long)a2 recursive:(char)a3 completionHandler:(id /* block */)a4;
