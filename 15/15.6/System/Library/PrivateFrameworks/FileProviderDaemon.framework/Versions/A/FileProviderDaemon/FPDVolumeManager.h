...
- (id)getGenstoreVersionsRootURL:(id)a0 volumeIgnoringOwnership:(char)a1;
...
- (id)libraryForVolume:(id)a0 createIfNeeded:(char)a1 error:(id *)a2;
- (void)loadAdditionalVolumesWithCompletion:(id /* block */)a0;
- (char)loadEnterpriseVolumeWithError:(id *)a0;
- (char)loadHomeVolume;
...
- (char)loadVolumeWithURL:(id)a0 role:(unsigned int)a1 error:(id *)a2;
- (void)registerDiskPendingUnmountConfirmationAtURL:(id)a0;
- (void)registerVersionsFileCoordinatorForVolume:(id)a0 volumeIgnoringOwnership:(char)a1;
- (char)shouldMountAdditionalVolume;
