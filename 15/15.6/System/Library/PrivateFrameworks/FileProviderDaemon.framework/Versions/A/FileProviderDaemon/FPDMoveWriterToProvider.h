...
- (void)_postImportStepForItem:(id)a0 sourceURL:(id)a1 targetURL:(id)a2 tempFolder:(id)a3 wasCopyRequested:(char)a4 error:(id)a5 completion:(id /* block */)a6;
- (id)_targetSession;
...
- (void)performMoveOfFolder:(id)a0 to:(id)a1 as:(id)a2 sourceMaterializeOption:(unsigned long long)a3 targetMaterializeOption:(unsigned long long)a4 atomically:(char)a5 completion:(id /* block */)a6;
