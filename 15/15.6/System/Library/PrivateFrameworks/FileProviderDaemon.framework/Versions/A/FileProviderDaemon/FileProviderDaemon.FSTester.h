...
- (void)configureFileTreeWithLabel:(id)a0 atRootURL:(id)a1 wharfURL:(id)a2 bundleBitPackageDetection:(char)a3 completion:(id /* block */)a4;
- (void)createItemOfKind:(long long)a0 parentID:(long long)a1 filename:(id)a2 content:(id)a3 isResurrected:(char)a4 uniqueFPID:(id)a5 completion:(id /* block */)a6;
...
- (void)moveItemWithHandle:(id)a0 underParent:(id)a1 filename:(id)a2 replaceTarget:(char)a3 completion:(id /* block */)a4;
