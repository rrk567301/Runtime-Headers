...
- (char)authenticate:(struct gss_cred_id_t_desc_struct { } *)a0 toServer:(id)a1 returningToken:(id *)a2 andError:(id *)a3;
- (char)changePasswordForUPN:(id)a0 realm:(id)a1 withOldPassword:(id)a2 withNewPassword:(id)a3 withError:(id *)a4;
...
- (char)getPACForCred:(struct gss_cred_id_t_desc_struct { } *)a0 pac:(id *)a1;
- (char)validatePassword:(id)a0 forUser:(id)a1;
