...
@property char networkChangePending;
...
- (char)checkForValidKerberosTGT:(id)a0;
...
- (char)isNetworkConnectedForRealm:(id)a0;
- (char)isRealmConfiguredForKerberosExtension:(id)a0;
