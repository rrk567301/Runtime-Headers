...
@property char completionCalled;
...
- (void).cxx_destruct;
- (void)disconnect;
- (void)connectToLDAPServer:(id)a0 andPort:(unsigned short)a1 andBundleIdentifier:(id)a2 andRequireTLSForLDAP:(char)a3 completion:(id /* block */)a4;
- (void)connectToLDAPService:(id)a0 requireTLSForLDAP:(char)a1 bundleIdentifier:(id)a2 inBackground:(char)a3 completion:(id /* block */)a4;
...
- (void)setupLDAPconnection:(id)a0 andPort:(unsigned short)a1 andRequireTLSForLDAP:(char)a2 andBundleIdentifier:(id)a3;
