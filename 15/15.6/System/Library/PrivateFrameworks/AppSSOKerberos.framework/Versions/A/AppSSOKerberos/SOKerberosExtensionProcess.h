...
- (char)checkSourceAppACLWithContext:(id)a0;
...
- (void)handleLogout:(id)a0 removeRealm:(char)a1;
- (void)handleLogoutWithContext:(id)a0 removeRealm:(char)a1;
...
- (id)settingsForContext:(id)a0 includeSiteCodeCache:(char)a1;
