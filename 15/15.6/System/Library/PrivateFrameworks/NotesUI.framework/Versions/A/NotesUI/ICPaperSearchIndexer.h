...
- (void)updateIndexForAttachment:(NSManagedObjectID *)a0 userInitiated:(char)a1 managedObjectContext:(NSManagedObjectContext *)a2 completionHandler:(void (^)(void))a3;
- (void)updateIndexForAttachments:(NSSet *)a0 userInitiated:(char)a1 managedObjectContext:(NSManagedObjectContext *)a2 completionHandler:(void (^)(void))a3;
