...
@property (nonatomic, readonly) char isPreviewingResult;

- (id)init;
- (void).cxx_destruct;
- (id)initWithNote:(id)a0;
- (void)commitPreviewedResultAtRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 asLiteral:(char)a1;
