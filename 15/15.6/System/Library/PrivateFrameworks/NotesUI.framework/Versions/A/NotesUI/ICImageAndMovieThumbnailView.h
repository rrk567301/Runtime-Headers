...
@property (nonatomic) char showMovieDuration;
...
@property (nonatomic) char hairlineWidthUnitIsInPoint;
...
@property (nonatomic) char forceSquareImageAspectRatio;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 showMovieDuration:(char)a1;
- (void)setHairlineColor:(id)a0 forEdges:(unsigned long long)a1;
- (void)setupMovieFooter;
- (void)updateDurationLabel;
- (void)updateHairline;
- (void)updateHairlineFrames;
- (char)usesSeparateLayerForHairlineEdge:(unsigned long long)a0;
