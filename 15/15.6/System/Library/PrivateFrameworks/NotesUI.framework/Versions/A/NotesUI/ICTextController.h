...
@property (nonatomic) char shouldMergeNoteAfterScrolling;
@property (nonatomic) char isAutoListInsertionDisabled;
...
@property char userChangedWritingDirection;
...
@property (nonatomic) char trackAddedExtraNewlineRanges;
@property (nonatomic) char isConvertingTables;
...
+ (double)indentForStyle:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 attributedString:(id)a2 textView:(id)a3 todoZoomFactor:(double)a4;
...
+ (char)shouldRetainFirstListStyleForFilteredAttributedSubstring:(id)a0 fromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;

- (id)init;
- (void).cxx_destruct;
- (long long)setTextStyle:(unsigned int)a0 removeExtraStyling:(char)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 inTextStorage:(id)a3 inTextView:(id)a4;
...
- (id)addTableAttachmentWithNSTextTable:(id)a0 attributedString:(id)a1 filterPastedAttributes:(char)a2 isReadingSelectionFromPasteboard:(char)a3;
- (void)addToTagsInTextView:(id)a0 forRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)attachmentsExistInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 textStorage:(id)a1;
- (char)canAddToTagsInTextView:(id)a0 forRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)canChangeStyleForSelectedRanges:(id)a0 inTextStorage:(id)a1;
- (char)canConvertInlineAttachmentToTextInTextView:(id)a0 forRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)canIndentTextView:(id)a0 byDelta:(long long)a1;
- (char)canIndentTextView:(id)a0 byDelta:(long long)a1 forRanges:(id)a2;
...
- (char)containsOnlyStyle:(unsigned int)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextStorage:(id)a2;
...
- (void)convertNSTablesToICTables:(id)a0 pasteboardTypes:(id)a1 filterPastedAttributes:(char)a2 isReadingSelectionFromPasteboard:(char)a3;
...
- (char)deleteBackwardForSpecialCasesInTextView:(id)a0;
- (char)deleteWordBackwardForSpecialCasesInTextView:(id)a0;
- (void)ensureUniqueParagraphStyleUUIDsInTextStorage:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })extendedSelectionRangeForCollapsedSectionHeadingWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 textView:(id)a1;
...
- (void)indentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 byAmount:(long long)a1 inTextStorage:(id)a2 textView:(id)a3 forceUpdateAttributes:(char)a4;
- (char)inlineAttachmentInTextView:(id)a0 atIndex:(unsigned long long)a1 outAttachment:(id *)a2;
- (void)insertNewlineAtCharacterIndex:(unsigned long long)a0 textStorage:(id)a1;
- (char)insertNewlineForSpecialCasesInTextView:(id)a0;
- (char)insertedSpaceInTextView:(id)a0 replacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (void)insertedText:(id)a0 replacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextView:(id)a2 hashtagController:(id)a3 mentionsController:(id)a4 languageHasSpaces:(char)a5 parentAttachment:(id)a6;
- (void)insertedText:(id)a0 replacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextView:(id)a2 languageHasSpaces:(char)a3;
- (char)isForPrint;
- (char)isTodoDoneRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextStorage:(id)a1;
...
- (void)p_populateTable:(id)a0 withNSTextTable:(id)a1 attributedString:(id)a2 filterPastedAttributes:(char)a3 isReadingSelectionFromPasteboard:(char)a4;
- (struct { unsigned long long x0; unsigned long long x1; })p_setCellsInTable:(id)a0 fromAttributedString:(id)a1 textTable:(id)a2 atCellOffset:(struct { unsigned long long x0; unsigned long long x1; })a3 filterPastedAttributes:(char)a4 isReadingSelectionFromPasteboard:(char)a5;
...
- (unsigned int)paragraphStyleForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextView:(id)a1 inTextStorage:(id)a2 ignoreTypingAttributes:(char)a3;
...
- (char)removeListStyleBeforeDeletingParagraphContentIfNecessaryForTextView:(id)a0 textStorage:(id)a1 rangeToBeDeleted:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 blockBeforeEndEditing:(id /* block */)a3;
- (char)removeListStyleForDeletingEmptyParagrahIfNecessaryForTextView:(id)a0 textStorage:(id)a1 paragraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 andLocation:(unsigned long long)a3;
...
- (char)selectionContainsBlockQuoteAndOthers:(id)a0;
- (char)setDone:(char)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextStorage:(id)a2;
- (void)setIsForPrint:(char)a0;
- (void)setNote:(id)a0 stylingTextUsingSeparateTextStorageForRendering:(char)a1 withLayoutManager:(id)a2;
- (void)setNote:(id)a0 stylingTextUsingSeparateTextStorageForRendering:(char)a1 withLayoutManager:(id)a2 firstVisibleCharLocation:(unsigned long long)a3;
...
- (long long)setTextStyle:(unsigned int)a0 removeExtraStyling:(char)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 inTextStorage:(id)a3;
- (void)setTypingAttributesForUndo:(id)a0;
- (void)setTypingTextStyle:(unsigned int)a0 textView:(id)a1;
- (char)shouldChangeTextInTextStorage:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 replacementString:(id)a2;
- (char)shouldHighlightStyleAsLink:(unsigned int)a0;
- (char)shouldUpdateIndentFor:(id)a0;
...
- (id)tabStopsForAttributedString:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (void)updateCellInTable:(id)a0 atColumnIndex:(unsigned long long)a1 rowIndex:(unsigned long long)a2 fromAttributedString:(id)a3 andTextTableBlock:(id)a4 filterPastedAttributes:(char)a5 isReadingSelectionFromPasteboard:(char)a6;
