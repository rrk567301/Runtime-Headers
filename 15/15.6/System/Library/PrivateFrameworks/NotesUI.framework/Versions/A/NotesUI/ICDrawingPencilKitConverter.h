...
@property (nonatomic) char isThrowaway;
@property (readonly, nonatomic) NSArray *failedSketches;

+ (id)sharedConverter;
+ (unsigned long long)countOfUpdatableDrawingsInNote:(id)a0;
+ (char)canUpdateFullscreenSketchAttachment:(id)a0;
+ (char)canUpdateInlineDrawingAttachment:(id)a0;
+ (id)newThrowawayConverter;

- (id)init;
- (void).cxx_destruct;
- (void)convertAllSketchesWithProgress:(id)a0;
- (id)addOperationForAttachment:(id)a0 automatic:(char)a1;
- (void)canAutoUpdateDrawingsInAccount:(id)a0 completion:(id /* block */)a1;
- (char)compareDrawingAttachment:(id)a0 withConvertedDrawing:(id)a1;
...
- (void)convertDrawingsInNote:(id)a0 waitUntilFinished:(char)a1;
...
- (char)shouldAutoConvertNote:(id)a0;
- (char)shouldConvertAllDrawingsIfNeeded;
