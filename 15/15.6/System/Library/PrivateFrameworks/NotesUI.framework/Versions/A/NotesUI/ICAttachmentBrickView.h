...
@property (nonatomic) char waitingForMetadata;
@property (readonly, nonatomic) char isMetadataComplete;
@property (nonatomic) char hasPerformedInitialLayout;
...
+ (char)usesSmallSizeForAttachment:(id)a0 withMetadata:(id)a1 type:(unsigned long long)a2 insideSystemPaper:(char)a3;
+ (struct CGSize { double x0; double x1; })defaultBrickSize;
+ (struct CGSize { double x0; double x1; })sizeForAttachment:(id)a0 usesSmallSize:(char)a1;
