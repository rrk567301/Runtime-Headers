...
@property (nonatomic) char prefersSheet;
@property (copy, nonatomic) NSString *title;
@property (copy, nonatomic) NSString *message;
@property (copy, nonatomic) NSString *actionTitle;
@property (nonatomic) char actionIsDestructive;
...
+ (id)incorrectCustomPasswordInfoAlertWithObject:(id)a0 showHint:(char)a1;
...
+ (char)shouldPresentSwitchToDevicePasswordPromptForAccount:(id)a0;
