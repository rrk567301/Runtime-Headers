@class NSString, NSAttributedString, NSValue, ICSearchResultConfiguration, NSDictionary, NSTextCheckingResult, NSRegularExpression, ICSearchResultRegexMatchFinder;
...
@property (nonatomic) char isDisplayingParticipantMatch;
...
@property (nonatomic, getter=isMathNote) char mathNote;
...
+ (id)attributedStringWithMatchHighlighted:(id)a0 optionalAttributedHighlightedString:(id)a1 textCheckingResult:(id)a2 highlightColor:(id)a3 insideFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 finishingUpRegexMatchFinder:(id)a5;
+ (id)attributedStringWithMatchHighlighted:(id)a0 optionalAttributedHighlightedString:(id)a1 textCheckingResult:(id)a2 usingAttributes:(id)a3 highlightColor:(id)a4 insideFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 isSnippetForParticipantMatch:(char)a6 finishingUpRegexMatchFinder:(id)a7;
+ (id)attributedStringWithMatchHighlighted:(id)a0 textCheckingResult:(id)a1 highlightColor:(id)a2 insideFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 finishingUpRegexMatchFinder:(id)a4;
...
+ (char)canFitAttributedString:(id)a0 ellipses:(id)a1 shouldPrefixWithEllipses:(char)a2 insideFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 centered:(char)a4;
