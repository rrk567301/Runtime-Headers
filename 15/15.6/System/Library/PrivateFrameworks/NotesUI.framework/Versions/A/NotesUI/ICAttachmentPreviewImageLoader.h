...
@property (nonatomic) char delayLoadingURLs;
...
- (void)loadData;
- (char)canLoadImage;
- (id)initWithOriginalImage:(id)a0 orientedImage:(id)a1 data:(id)a2 scale:(double)a3 previewImageURLs:(id)a4 delayLoadingURLs:(char)a5;
- (id)loadImage;
