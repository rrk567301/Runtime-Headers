...
- (id)reallyZoomAttributedString:(id)a0 zoomDirection:(char)a1;
- (id)reallyZoomAttributes:(id)a0 zoomDirection:(char)a1;
- (id)reallyZoomFontInAttributes:(id)a0 zoomDirection:(char)a1;
