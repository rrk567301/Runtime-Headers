@class ICThumbnailKey, NSString, ICAppearanceInfo, NSColor;
...
@property (readonly, nonatomic) char hasBorder;
@property (copy, nonatomic) id /* block */ fallbackBlock;
@property (readonly, nonatomic) char prepareThumbnail;

- (id)debugDescription;
- (void).cxx_destruct;
- (id)initForAttachment:(id)a0 preferredSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 appearanceInfo:(id)a3;
- (id)initForAvatarWithParticipants:(id)a0 preferredSize:(struct CGSize { double x0; double x1; })a1 hasBorder:(char)a2;
- (id)initForNoteGalleryWithNote:(id)a0 preferredSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 appearanceInfo:(id)a3;
...
- (id)initWithThumbnailType:(long long)a0 associatedObject:(id)a1 associatedObjectIdentifier:(id)a2 associatedObjectTitle:(id)a3 accountIdentifier:(id)a4 cacheLevel:(long long)a5 preferredSize:(struct CGSize { double x0; double x1; })a6 scale:(double)a7 appearanceInfo:(id)a8 backgroundColor:(id)a9 hasBorder:(char)a10;
- (id)initWithThumbnailType:(long long)a0 uniqueKey:(id)a1 associatedObject:(id)a2 associatedObjectIdentifier:(id)a3 associatedObjectTitle:(id)a4 accountIdentifier:(id)a5 cacheLevel:(long long)a6 preferredSize:(struct CGSize { double x0; double x1; })a7 scale:(double)a8 appearanceInfo:(id)a9 backgroundColor:(id)a10 hasBorder:(char)a11;
- (void)performAsCurrentAppearance:(id /* block */)a0;
