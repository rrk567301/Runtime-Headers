...
@property (nonatomic) char isSetupForChangePassword;
@property (nonatomic) char didAuthenticateWithBiometrics;
@property (readonly, nonatomic) char isSetupForInitialPassword;
@property (readonly, nonatomic) char passwordAndVerifyTextFieldsMatch;
@property (nonatomic) char didAttemptToSubmitWithoutHint;
...
- (id)disclaimerWarningStringAndHasMultiplePasswordCapableAccounts:(char)a0;
...
- (void)setUpForChangePasswordWithAccount:(id)a0 didAuthenticateWithBiometrics:(char)a1;
