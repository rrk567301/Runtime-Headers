...
@property (nonatomic) char checklistsOnly;
@property (nonatomic) char pinnedOnly;
@property (nonatomic) char passwordProtectedOnly;
@property (nonatomic) char nonPasswordProtectedOnly;
...
- (void)setShouldIncludeOutlineParentItems:(char)a0;
- (void)willIndex;
