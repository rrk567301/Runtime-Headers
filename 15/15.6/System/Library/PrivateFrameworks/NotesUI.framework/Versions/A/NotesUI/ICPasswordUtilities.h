...
+ (void)setTouchIDEnabledForSharedPassword:(char)a0 account:(id)a1 displayWindow:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)showPasswordChangeSheetForAccount:(id)a0 didAuthenticateWithBiometrics:(char)a1 displayWindow:(id)a2 completionHandler:(id /* block */)a3;
