...
@property (nonatomic) char setSelectionToEndAfterLoad;
@property (nonatomic) char startEditingAfterLoad;
...
@property (nonatomic) char adjustFrameForToolbar;
...
@property (nonatomic, getter=isInsideSiriSnippet) char insideSiriSnippet;
...
- (void)scrollSelectionToVisible:(char)a0;
...
- (char)_webView:(id)a0 focusShouldStartInputSession:(id)a1;
...
- (void)setEnableAttachments:(char)a0;
- (void)setEnableShiftNewlinesInSmartLists:(char)a0;
- (void)setEnableSmartLists:(char)a0;
