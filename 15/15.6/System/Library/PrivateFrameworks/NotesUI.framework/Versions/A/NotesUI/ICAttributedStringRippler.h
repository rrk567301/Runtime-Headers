...
+ (char)canAnimateString:(id)a0;

- (void).cxx_destruct;
- (void)start;
- (id)currentColorForGlyphIndex:(unsigned long long)a0 numberOfGlyphs:(unsigned long long)a1 timeIndex:(unsigned long long)a2;
- (unsigned long long)currentIndexForGlyphIndex:(unsigned long long)a0 numberOfGlyphs:(unsigned long long)a1 timeIndex:(unsigned long long)a2 isFinished:(char *)a3;
...
- (char)finishedForTimeIndex:(unsigned long long)a0;
