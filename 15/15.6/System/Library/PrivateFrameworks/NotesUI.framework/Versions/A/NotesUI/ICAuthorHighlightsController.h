@class ICNote, ICTTTextEditGrouper, CADisplayLink, NSDate, NSTextLayoutManager, NSMutableSet, ICTTTextStorage, NSCache;
...
@property (nonatomic) struct _NSRange { unsigned long long location; unsigned long long length; } invalidHighlightsRange;
...
@property (nonatomic) char allowsAnimations;
@property (nonatomic) char coalesceAuthorHighlightUpdates;
...
- (id)attributesForHighlightingTextLineFragment:(id)a0 characterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 defaultRenderingAttributes:(id)a2 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a3 textView:(id)a4;
...
- (void)extendHighlightsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextStorage:(id)a1 reverse:(char)a2;
...
- (char)isPerformingHighlightUpdatesForTextStorage:(id)a0;
...
- (char)rangeHasOrNeedsHighlights:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextStorage:(id)a1;
...
- (void)setTextHighlightValue:(double)a0 highlightColor:(id)a1 blendsTextColor:(char)a2 forRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 inTextStorage:(id)a4;
- (char)shouldAnimateInTextStorage:(id)a0;
