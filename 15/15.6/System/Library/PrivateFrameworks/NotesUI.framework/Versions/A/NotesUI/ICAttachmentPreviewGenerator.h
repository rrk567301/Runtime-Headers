@class NSManagedObjectContext, NSString, ICAttachmentPreviewGeneratorOperationQueue, NSMutableDictionary, NSObject, NSMutableSet, NSMutableOrderedSet, NSMapTable;
...
@property (class, readonly, nonatomic) char docCamOCRGenerationEnabled;
@property (class, readonly, nonatomic) char imageOCRGenerationEnabled;
@property (class, readonly, nonatomic) char imageClassificationEnabled;
...
@property (nonatomic) _Atomic char shouldGenerateAttachmentsWhenReachable;
@property (readonly, nonatomic) char previewOperationsIdle;
...
+ (void)setImageClassificationTemporarilyDisabled:(char)a0;
+ (char)universalSearchProcessingLibraryEnabled;
...
- (void)beginPostProcessingAfterDelayIfNecessaryWithForceDelay:(char)a0;
...
- (char)isPreviewGenerationSupported;
