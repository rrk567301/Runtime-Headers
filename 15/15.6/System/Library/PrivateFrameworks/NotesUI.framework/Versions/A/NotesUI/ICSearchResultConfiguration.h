...
@property (readonly, nonatomic) char isTopHit;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithSearchString:(id)a0 searchSuggestionType:(unsigned long long)a1 isTopHit:(char)a2 foundAttachmentObjectID:(id)a3 sortableSearchableItem:(id)a4;
