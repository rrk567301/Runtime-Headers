...
@property (nonatomic) char disableAutomaticUpdates;
...
- (char)hideSearchResultsForIdentifier:(id)a0;
...
- (char)hideSearchResultsForObjects:(id)a0;
...
- (char)passesVisibilityTesting:(id)a0 forSearchResult:(id)a1;
- (id)removeSearchResultAtRow:(long long)a0 section:(unsigned long long)a1;
- (char)removeSearchResultWithIdentifier:(id)a0 forHiding:(char)a1;
- (char)removeSearchResultWithIdentifier:(id)a0 fromSection:(unsigned long long)a1 forHiding:(char)a2;
- (unsigned long long)removeSearchResultsWithIdentifiers:(id)a0 forHiding:(char)a1;
- (char)replaceSearchResultObject:(id)a0 withObject:(id)a1;
