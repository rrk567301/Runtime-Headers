@class ICNotesCrossProcessChangeCoordinator, NSManagedObjectID, NSPersistentStoreCoordinator, ICNoteContext, NSManagedObjectContext;
...
@property (nonatomic, readonly) char resolvedPrefersViewContext;
...
- (id)legacyAttachmentWithIdentifier:(id)a0;
