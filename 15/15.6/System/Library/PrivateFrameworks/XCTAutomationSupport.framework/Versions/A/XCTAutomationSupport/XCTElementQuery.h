...
@property char useLegacyElementType;
...
@property char suppressAttributeKeyPathAnalysis;
...
- (id)initWithRootElement:(id)a0 transformers:(id)a1 options:(unsigned long long)a2 isMacOS:(char)a3;
- (id)initWithRootElement:(id)a0 transformers:(id)a1 options:(unsigned long long)a2 isMacOS:(char)a3 timeoutControls:(id)a4;
