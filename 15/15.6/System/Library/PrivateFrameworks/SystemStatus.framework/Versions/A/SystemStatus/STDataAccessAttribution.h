...
@property (readonly, nonatomic, getter=isRecent) char recent;
@property (readonly, nonatomic) char hasSatisfiedMinimumOnTime;
...
- (id)initWithLocationAttribution:(id)a0 recent:(char)a1 startTimestamp:(double)a2 endTimestamp:(double)a3;
- (id)initWithAudioRecordingActivityAttribution:(id)a0 recent:(char)a1 startTimestamp:(double)a2 endTimestamp:(double)a3;
- (id)initWithCameraCaptureAttribution:(id)a0 recent:(char)a1 startTimestamp:(double)a2 endTimestamp:(double)a3;
- (id)initWithDataAccessAttribution:(id)a0;
- (id)initWithDataAccessType:(unsigned long long)a0 microphoneRecordingAttribution:(id)a1 cameraCaptureAttribution:(id)a2 locationAttribution:(id)a3 recent:(char)a4 startTimestamp:(double)a5 endTimestamp:(double)a6;
- (id)initWithMicrophoneRecordingAttribution:(id)a0 recent:(char)a1 startTimestamp:(double)a2 endTimestamp:(double)a3;
