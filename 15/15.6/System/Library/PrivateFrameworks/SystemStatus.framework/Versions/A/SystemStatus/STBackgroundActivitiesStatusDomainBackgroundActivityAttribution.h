...
@property (readonly, nonatomic) char showsWhenForeground;
...
- (id)initWithBackgroundActivityIdentifier:(id)a0 activityAttribution:(id)a1 showsWhenForeground:(char)a2;
