...
@property (readonly, nonatomic, getter=isSystemService) char systemService;
...
- (id)initWithExecutableIdentity:(id)a0 systemService:(char)a1;
...
- (id)initWithExecutableIdentity:(id)a0 userIdentity:(id)a1 website:(id)a2 systemService:(char)a3;
- (id)initWithExecutableIdentity:(id)a0 userIdentity:(id)a1 website:(id)a2 systemService:(char)a3 localizedDisplayName:(id)a4 localizedExecutableDisplayName:(id)a5;
- (id)initWithExecutableIdentity:(id)a0 website:(id)a1;
- (id)initWithExecutableIdentity:(id)a0 website:(id)a1 systemService:(char)a2;
- (id)initWithExecutableIdentity:(id)a0 website:(id)a1 systemService:(char)a2 localizedDisplayName:(id)a3 localizedExecutableDisplayName:(id)a4;
- (char)matchesAttributedEntity:(id)a0;
