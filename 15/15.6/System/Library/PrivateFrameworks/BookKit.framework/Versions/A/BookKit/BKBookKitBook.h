...
@property (getter=isSample) char sample;
@property (getter=isLocked) char locked;
@property (getter=isProof) char proof;
@property (getter=isCompressed) char compressed;
...
@property char hasPendingUpdate;
...
+ (char)isSupplementalPDFFromBookMetadata:(id)a0;
