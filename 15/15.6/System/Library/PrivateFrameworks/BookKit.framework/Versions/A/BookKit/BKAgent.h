...
@property (readonly, nonatomic) char libraryOnline;
...
- (id)_startupService;
- (void)setUseriCloudSetting:(char)a0 withReply:(id /* block */)a1;
...
- (void)examineBook:(id)a0 includeCover:(char)a1 withReply:(id /* block */)a2;
...
- (void)migrateBook:(id)a0 withMetadata:(id)a1 withCopy:(char)a2 withReply:(id /* block */)a3;
...
- (void)setUserDefaultsEnabled:(char)a0 reply:(id /* block */)a1;
...
- (void)updateUseriCloudSetting:(char)a0 withReply:(id /* block */)a1;
