...
@property (readonly, nonatomic) char isNoveltyVoice;
@property (readonly, nonatomic) char isPersonalVoice;
@property (nonatomic) char isSystemVoice;
@property (readonly, nonatomic) char isDefault;
@property (nonatomic) char canBeDownloaded;
...
+ (id)siriLocalizedNameForName:(id)a0 identifier:(id)a1 includeSiri:(char)a2;
...
- (char)memoryPeakExceedsActiveJetsamLimit;
- (id)nameAndFootprintForLanguage:(id)a0;
- (char)shouldFilterResourceFromUI;
