...
+ (id)sharedInstance;
+ (char)_componentIsEqual:(struct AudioComponentDescription { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })a0 to:(struct AudioComponentDescription { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })a1;
+ (void)freeSharedInstance;
+ (void)registerFirstPartyInProcessAudioUnits;
+ (void)resetInMemoryCache;
+ (char)synthesizerHasEntitlement:(id)a0 entitlement:(const char *)a1;

- (id)init;
- (void).cxx_destruct;
- (void)_loadVoicesForComponentRecord:(id)a0 dispatchGroup:(id)a1;
- (char)_loadVoicesForComponentWithTimeout:(id)a0 timeout:(double)a1 timedOut:(char *)a2;
