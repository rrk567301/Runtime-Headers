...
+ (char)spaceCheck:(id)a0;
+ (id)installedAssetForLanguage:(id)a0 gender:(long long)a1 footprint:(long long)a2 voiceName:(id)a3 voiceType:(long long)a4;
+ (id)_assetFilterForLanguage:(id)a0 gender:(long long)a1 footprint:(long long)a2 voiceName:(id)a3 voiceType:(long long)a4 locallyAvailable:(char)a5;
+ (id)_assetTechnologyForVoiceType:(long long)a0;
+ (id)_assetTypesForVoiceType:(long long)a0;
+ (id)_assetsForLanguage:(id)a0 voiceType:(long long)a1 installedOnly:(char)a2;
...
+ (id)_siriAssetForLanguage:(id)a0 gender:(long long)a1 footprint:(long long)a2 voiceName:(id)a3 voiceType:(long long)a4 locallyAvailable:(char)a5;
