...
@property (nonatomic) char shouldRebuildAudioQueue;
@property (readonly) char audioQueueActive;
...
@property (nonatomic) char needsParameterSync;
@property (nonatomic) char needsPropertySync;
...
- (void)scheduleBuffer:(id)a0 completionHandler:(id /* block */)a1 lastBuffer:(char)a2;
