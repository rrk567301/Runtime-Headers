...
@property (nonatomic) char isTombstone;
...
- (void).cxx_destruct;
- (id)initWithCollectionDescription:(id)a0 curatedCollectionIdentifier:(unsigned long long)a1 image:(id)a2 imageUrl:(id)a3 isTombstone:(char)a4 lastFetchedDate:(id)a5 lastSignificantChangeDate:(id)a6 placesCount:(int)a7 positionIndex:(long long)a8 publisherAttribution:(id)a9 resultProviderIdentifier:(int)a10 title:(id)a11 titleLocale:(id)a12;
- (id)initWithObject:(id)a0 store:(id)a1 lazyLoad:(char)a2;
- (id)initWithStore:(id)a0 collectionDescription:(id)a1 curatedCollectionIdentifier:(unsigned long long)a2 image:(id)a3 imageUrl:(id)a4 isTombstone:(char)a5 lastFetchedDate:(id)a6 lastSignificantChangeDate:(id)a7 placesCount:(int)a8 positionIndex:(long long)a9 publisherAttribution:(id)a10 resultProviderIdentifier:(int)a11 title:(id)a12 titleLocale:(id)a13;
