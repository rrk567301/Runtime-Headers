...
- (void)flushChanges;
- (id)initWithCommunityIdentifier:(id)a0 expired:(char)a1 positionIndex:(long long)a2 usedCount:(long long)a3;
- (id)initWithObject:(id)a0 store:(id)a1 lazyLoad:(char)a2;
- (id)initWithStore:(id)a0 communityIdentifier:(id)a1 expired:(char)a2 positionIndex:(long long)a3 usedCount:(long long)a4;
