...
- (void)startScanningForType:(long long)a0 data:(id)a1 mask:(id)a2 peers:(id)a3 scanMode:(long long)a4 rssi:(id)a5 duplicates:(char)a6 scanCache:(char)a7 useCaseList:(id)a8;
...
- (void)startScanningForType:(long long)a0 data:(id)a1 mask:(id)a2 peers:(id)a3 scanMode:(long long)a4 rssi:(id)a5 duplicates:(char)a6;
- (void)startScanningForType:(long long)a0 data:(id)a1 mask:(id)a2 peers:(id)a3 scanMode:(long long)a4 rssi:(id)a5 duplicates:(char)a6 scanCache:(char)a7;
