...
@property (nonatomic) char readReceiptsGloballyEnabled;
...
@property (readonly, nonatomic, getter=isReplicating) char replicating;
...
- (void)setBlockIdleStatus:(char)a0;
...
- (void)acceptSubscriptionRequest:(char)a0 from:(id)a1;
...
- (char)_alwaysAllowMarkingSent;
- (void)_autoReconnectTimer:(id)a0;
- (id)_autoReplier;
- (void)_blastDoorProcessingWithIMMessageItem:(id)a0 chat:(id)a1 account:(id)a2 fromToken:(id)a3 fromIDSID:(id)a4 fromIdentifier:(id)a5 toIdentifier:(id)a6 participants:(id)a7 groupName:(id)a8 groupID:(id)a9 isFromMe:(char)a10 isLastFromStorage:(char)a11 isFromStorage:(char)a12 hideLockScreenNotification:(char)a13 wantsCheckpointing:(char)a14 needsDeliveryReceipt:(id)a15 messageBalloonPayloadAttachmentDictionary:(id)a16 inlineAttachments:(id)a17 attributionInfoArray:(id)a18 nicknameDictionary:(id)a19 availabilityVerificationRecipientChannelIDPrefix:(id)a20 availabilityVerificationRecipientEncryptionValidationToken:(id)a21 availabilityOffGridRecipientSubscriptionValidationToken:(id)a22 availabilityOffGridRecipientEncryptionValidationToken:(id)a23 idsService:(id)a24 messageContext:(id)a25 isFromTrustedSender:(char)a26 isFromSnapTrustedSender:(char)a27 completionBlock:(id /* block */)a28;
...
- (char)_canHandleTransferAccept:(id)a0;
- (char)_canInsertDisplayNameUpdateItemForChat:(id)a0;
- (char)_canMarkMessageAsSent:(id)a0;
- (char)_canUpgradeExistingMessageItem:(id)a0 replacementReplicatedMessageItem:(id)a1;
...
- (char)_didReceiveMessageDeliveryReceiptForMessageID:(id)a0 attempts:(long long)a1 date:(id)a2 account:(id)a3;
...
- (void)_didReceiveMessageSavedForMessageID:(id)a0 ofType:(long long)a1 forChat:(id)a2 fromHandle:(id)a3 fromMe:(char)a4 date:(id)a5 attempts:(long long)a6 account:(id)a7 completionBlock:(id /* block */)a8;
- (void)_doLoginIgnoringProxy:(char)a0;
- (void)_doLoginIgnoringProxy:(char)a0 withAccount:(id)a1;
...
- (char)_isMessageSWYSpamMessage:(id)a0 inChat:(id)a1;
- (char)_isTransferAvailableForDownload:(id)a0;
...
- (char)_messageDowngradesWhenSentFromCurrentService:(id)a0;
- (void)_messageStoreCompletion:(char)a0 inputMessage:(id)a1 outputMessage:(id)a2 originalMessage:(id)a3 completionBlock:(id /* block */)a4;
- (char)_messageUpgradesWhenSentFromCurrentService:(id)a0;
...
- (char)_shouldBlackholeGroupChatFromSender:(id)a0 toRecipient:(id)a1 withOtherParticipants:(id)a2 forAccount:(id)a3;
- (char)_shouldBroadcastSendFailures;
- (char)_shouldConvergeChatParticipants:(id)a0 withHandleInfo:(id)a1;
- (char)_shouldDropSendingMessage;
- (char)_shouldShowSWYQuickActionForMessage:(id)a0 outAppName:(id *)a1 outBundleID:(id *)a2;
- (char)_storeMessage:(id)a0 chatIdentifier:(id)a1 localChat:(id)a2 style:(unsigned char)a3 account:(id)a4 messagesToPostArray:(id)a5;
...
- (void)_updateNetworkMonitorFromAccountDefaultsIgnoringProxy:(char)a0;
...
- (char)acceptsIncomingReplicatedMessagesFromAccount:(id)a0 toIdentifier:(id)a1 isSOS:(char)a2;
- (void)accountDefaultsChanged:(id)a0;
- (char)allowedToOverwriteOriginalGroupIDForChat:(id)a0;
...
- (id)broadcasterForChatListenersWithBlackholeStatus:(char)a0;
...
- (char)chatCanMergeWithSuperChat:(id)a0;
...
- (void)closeSessionChatID:(id)a0 identifier:(id)a1 didDeleteConversation:(char)a2 style:(unsigned char)a3;
- (void)closeSessionForChat:(id)a0 chatGUID:(id)a1 didDeleteConversation:(char)a2 style:(unsigned char)a3;
...
- (id)didChangeMemberStatus:(int)a0 forHandle:(id)a1 fromHandle:(id)a2 unformattedNumber:(id)a3 countryCode:(id)a4 forChat:(id)a5 style:(unsigned char)a6 account:(id)a7 destinationCallerID:(id)a8 messageTime:(id)a9 messageID:(id)a10 silently:(char)a11;
- (id)didChangeMemberStatus:(int)a0 forHandle:(id)a1 fromHandle:(id)a2 unformattedNumber:(id)a3 countryCode:(id)a4 forChat:(id)a5 style:(unsigned char)a6 account:(id)a7 destinationCallerID:(id)a8 messageTime:(id)a9 silently:(char)a10;
...
- (void)didJoinChat:(id)a0 style:(unsigned char)a1 displayName:(id)a2 groupID:(id)a3 handleInfo:(id)a4 account:(id)a5 isBlackholed:(char)a6;
...
- (void)didReceiveError:(unsigned int)a0 forMessageID:(id)a1 forceError:(char)a2;
- (void)didReceiveError:(unsigned int)a0 forMessageID:(id)a1 forceError:(char)a2 account:(id)a3;
...
- (char)didReceiveMessageDeliveryReceiptForMessageID:(id)a0 date:(id)a1;
- (char)didReceiveMessageDeliveryReceiptForMessageID:(id)a0 date:(id)a1 account:(id)a2;
...
- (void)didReceiveMessageSavedForMessageID:(id)a0 ofType:(long long)a1 forChat:(id)a2 fromHandle:(id)a3 fromMe:(char)a4 date:(id)a5 account:(id)a6 completionBlock:(id /* block */)a7;
- (char)didReceiveMessages:(id)a0 forChat:(id)a1 style:(unsigned char)a2 account:(id)a3 fromIDSID:(id)a4;
- (void)didReceiveOffGridStatus:(char)a0 forID:(id)a1 messageGUID:(id)a2 account:(id)a3;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 handleInfo:(id)a5 account:(id)a6 isBlackholed:(char)a7;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 lastAddressedHandle:(id)a5 lastAddressedSIMID:(id)a6 handleInfo:(id)a7 account:(id)a8 isBlackholed:(char)a9;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 originalGroupID:(id)a5 lastAddressedHandle:(id)a6 lastAddressedSIMID:(id)a7 handleInfo:(id)a8 account:(id)a9 category:(long long)a10 spamExtensionName:(id)a11 isBlackholed:(char)a12;
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 originalGroupID:(id)a5 lastAddressedHandle:(id)a6 lastAddressedSIMID:(id)a7 handleInfo:(id)a8 account:(id)a9 isBlackholed:(char)a10;
...
- (char)isOutgoingReplicationEnabled;
...
- (char)messageServiceNamed:(id)a0 canProcessMessagesFromServiceNamed:(id)a1;
...
- (void)notifyDidSendMessageID:(id)a0 account:(id)a1 shouldNotify:(char)a2;
- (void)notifyDidSendMessageID:(id)a0 account:(id)a1 shouldNotify:(char)a2 wasDowngraded:(char)a3;
- (void)notifyDidSendMessageID:(id)a0 account:(id)a1 shouldNotify:(char)a2 wasDowngraded:(char)a3 wasInterworked:(char)a4;
- (void)notifyDidSendMessageID:(id)a0 shouldNotify:(char)a1;
- (id)otcUtilities;
- (id)outgoingReplicationCallerIDForChat:(id)a0;
- (void)overwritePerChatReadReceiptSettingsWithGlobalValue:(char)a0;
...
- (void)processMessageForSending:(id)a0 toChat:(id)a1 style:(unsigned char)a2 allowWatchdog:(char)a3 account:(id)a4 completionBlock:(id /* block */)a5;
- (void)processMessageForSending:(id)a0 toChat:(id)a1 style:(unsigned char)a2 allowWatchdog:(char)a3 account:(id)a4 didReplaceMessageBlock:(id /* block */)a5 completionBlock:(id /* block */)a6;
- (void)processMessageForSending:(id)a0 toChat:(id)a1 style:(unsigned char)a2 allowWatchdog:(char)a3 completionBlock:(id /* block */)a4;
- (void)processNetworkDataAvailabilityChange:(char)a0;
- (id)property:(id)a0 ofBuddy:(id)a1;
- (void)recoverChatsForCommandDictionary:(id)a0;
- (char)reflectMarkUnreadToPeerDevicesForMessageGUID:(id)a0;
- (char)reflectRecoverChatToPeerDevicesForMessageGUID:(id)a0;
- (void)refreshServiceCapabilities;
- (void)registerChat:(id)a0 style:(unsigned char)a1;
- (void)registerChat:(id)a0 style:(unsigned char)a1 displayName:(id)a2 groupID:(id)a3 originalGroupID:(id)a4 lastAddressedHandle:(id)a5 lastAddressedSIMID:(id)a6 handleInfo:(id)a7 account:(id)a8 isBlackholed:(char)a9;
...
- (void)requestGroupPhotoIfNecessary:(id)a0 incomingParticipantVersion:(long long)a1 incomingGroupPhotoCreationTime:(id)a2 toIdentifier:(id)a3 fromIdentifier:(id)a4 messageIsFromStorage:(char)a5;
...
- (void)retryGroupPhotoUpload:(id)a0 toChatID:(id)a1 identifier:(id)a2 style:(unsigned char)a3 account:(id)a4 isPhotoRefresh:(char)a5;
...
- (void)sendLazuliSpamReport:(id)a0 isBot:(char)a1 spamType:(unsigned long long)a2;
- (void)sendLocationSharingInfo:(id)a0 toID:(id)a1 completionBlock:(id /* block */)a2;
- (void)sendLogDumpMessageAtFilePath:(id)a0 toRecipient:(id)a1 shouldDeleteFile:(char)a2 withCompletion:(id /* block */)a3;
...
- (char)sendNicknameUpdatesToPeerDevices:(id)a0 toDestinations:(id)a1;
...
- (void)sendReadReceiptForMessage:(id)a0 toChatID:(id)a1 identifier:(id)a2 style:(unsigned char)a3 reflectOnly:(char)a4;
...
- (char)shouldSendReadReceiptsForChat:(id)a0 style:(unsigned char)a1;
...
- (char)testOverrideTextValidationDidFail;
- (void)updateBalloonPayload:(id)a0 attachments:(id)a1 bundleID:(id)a2 forMessage:(id)a3;
- (void)updateChatGUID:(id)a0 withLastReadTimeStamp:(long long)a1 withLastSeenMessageGUID:(id)a2 fromMe:(char)a3;
...
- (char)warnIfPortBlocked:(int)a0 forAction:(id)a1;
