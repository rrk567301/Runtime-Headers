...
- (void).cxx_destruct;
- (char)_participantsContainBizID:(id)a0;
- (char)_shouldDropMessageGroupID:(id)a0 participants:(id)a1 fromIdentifier:(id)a2 toIdentifier:(id)a3;
- (id)initWithChatRegistry:(id)a0;
- (id)runIndividuallyWithInput:(id)a0;
- (char)shouldDropDueToGroupSize:(id)a0;
