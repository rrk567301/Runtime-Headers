...
- (void)_notifyPSYWithResult:(char)a0;
- (void)_quickSwitchCompleted:(char)a0;
- (void)_sendDBVersionResponse:(long long)a0;
- (char)_sendIDSFile:(id)a0 withCommand:(long long)a1;
- (char)_sendIDSMessage:(id)a0;
- (void)_sendQuickSwitchCompletedWithResult:(char)a0;
- (void)_sendRecentsRequest;
- (char)_sendZippedFileAtPath:(id)a0 withCommand:(long long)a1;
- (char)_truncateDBToPath:(id)a0;
- (void)dummyMethod;
