...
@property (nonatomic) char alreadyCapturedErrorWithAutoBugCapture;
@property (nonatomic) char allowsWritingToDisk;
@property (nonatomic, getter=isDeviceLowOnDiskSpace) char deviceLowOnDiskSpace;
@property (nonatomic) char isUsingCentralizedModel;
@property char isUpdatingAttachmentFileSizes;
...
- (char)_deviceConditionsAllowsAttachmentFileSizeUpdateForActivity:(id)a0;
...
- (char)_shouldFetchNextBatch:(unsigned long long)a0 totalTransfers:(id)a1;
- (void)batchCompletedWithTransfers:(id)a0;
- (char)canMarkPurgeableIfIsRichLinkForTransferGUID:(id)a0;
- (char)canWriteFileOfEstimatedSize:(unsigned long long)a0 refreshCachedValue:(char)a1;
...
- (char)shouldDownloadAssetsOfSize:(unsigned long long)a0 refreshCachedValue:(char)a1;
