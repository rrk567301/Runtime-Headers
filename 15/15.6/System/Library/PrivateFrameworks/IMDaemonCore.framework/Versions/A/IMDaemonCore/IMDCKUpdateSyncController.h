...
@property (nonatomic) char fetchedChatsDuringLastSync;
...
- (void)_onRecordZoneFetchComplete:(id)a0 token:(id)a1 tokenData:(id)a2 moreComing:(char)a3 error:(id)a4;
- (void)_onWriteT1Complete:(long long)a0 error:(id)a1 shouldWriteMore:(char)a2 activity:(id)a3 completion:(id /* block */)a4;
- (void)_onWriteT2Complete:(long long)a0 error:(id)a1 shouldWriteMore:(char)a2 activity:(id)a3 completion:(id /* block */)a4;
