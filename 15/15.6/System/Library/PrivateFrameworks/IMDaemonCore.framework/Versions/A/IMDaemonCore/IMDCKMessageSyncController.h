...
@property (nonatomic) char encounteredIncompatibleMessage;
...
- (char)_doesAnyRecordZoneIDHavePendingArchivedRecords:(long long)a0;
- (void)_fetchArchivedRecordsIfNeeded:(char)a0 currentBatchCount:(long long)a1 maxNumberOfBatches:(long long)a2 activity:(id)a3 withCompletionBlock:(id /* block */)a4;
...
- (char)_isCoreDuetSyncForMaxBatchCount:(long long)a0 activity:(id)a1;
- (char)_isDiskSpaceAvailableForSyncType:(long long)a0 currentBatchCount:(long long)a1;
- (char)_isValidCKRecordToSync:(id)a0;
...
- (void)_processArchivedRecordsFetchCompletionZoneID:(id)a0 serverChangeToken:(id)a1 moreComing:(char)a2 currentBatchCount:(long long)a3 maxNumberOfBatches:(long long)a4 activity:(id)a5 error:(id)a6 completionBlock:(id /* block */)a7;
...
- (void)_processModifyRecordsCompletion:(id)a0 deletedRecordIDs:(id)a1 operationError:(id)a2 isLastBatchOfWrite:(char)a3 activity:(id)a4 writeCompletionBlock:(id /* block */)a5;
...
- (void)_processRecordZoneFetchCompletionZoneID:(id)a0 serverChangeToken:(id)a1 clientChangeTokenData:(id)a2 moreComing:(char)a3 NSError:(id)a4 syncType:(long long)a5 currentBatchCount:(long long)a6 maxNumberOfBatches:(long long)a7 shouldFetchArchivedRecords:(char)a8 activity:(id)a9 completionBlock:(id /* block */)a10;
- (id)_recordsToSave;
- (void)_resetArvchivedRecordSyncToken;
- (id)_sharedIMDMessageStore;
- (char)_shouldDeferCoreDuetMessagesSyncWithActivity:(id)a0;
- (char)_shouldFetchArchivedRecords:(id)a0;
