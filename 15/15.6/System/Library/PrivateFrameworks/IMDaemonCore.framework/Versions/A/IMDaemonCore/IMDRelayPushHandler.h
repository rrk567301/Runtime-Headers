...
@property (nonatomic) char registeredForPush;
...
- (char)_messageRequestsServiceForSendingBypass:(id)a0;
- (unsigned long long)_routingBehaviorsForCommand:(long long)a0;
- (unsigned long long)_routingBehaviorsForLocalMessageType:(id)a0;
- (void)_service:(id)a0 account:(id)a1 incomingData:(id)a2 fromID:(id)a3 context:(id)a4 isBeingReplayed:(char)a5;
- (void)_service:(id)a0 account:(id)a1 incomingTopLevelMessage:(id)a2 fromID:(id)a3 messageContext:(id)a4 isBeingReplayed:(char)a5;
