...
@property (nonatomic) char hasSpamExtensionUpdated;
...
- (void)_executeSpamCompletionBlockForMessageGuid:(id)a0 category:(long long)a1 subCategory:(long long)a2 receivedViaRelay:(char)a3;
- (id)_getSpamExtensionID;
- (id)_getSpamExtensionName;
- (char)_isMessageCategorized:(long long)a0;
- (char)_isSpamFilteringEnabled;
...
- (char)_storeSpamCompletionBlock:(id /* block */)a0 forMessageGUID:(id)a1;
