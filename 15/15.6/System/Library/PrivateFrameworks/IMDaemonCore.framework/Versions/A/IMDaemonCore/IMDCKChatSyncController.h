...
- (char)_lockRecordHadConflict:(id)a0;
...
- (void)_processRecordZoneFetchCompletion:(id)a0 zoneID:(id)a1 clientChangeTokenData:(id)a2 moreComing:(char)a3 error:(id)a4;
- (void)_resolveChatConflictUsingCKRecord:(id)a0 localGUID:(id)a1;
- (char)_shouldMarkAllChatsAsNeedingSync;
- (char)_shouldResyncChatsForError:(id)a0;
- (void)_syncChatsWithCloudKitWithCompletionType:(long long)a0 activity:(id)a1 syncChatsCompletionBlock:(id /* block */)a2;
- (void)_updateChatUsingCKRecord:(id)a0 onRead:(char)a1 didSucceed:(char)a2 dispatchToMain:(char)a3;
