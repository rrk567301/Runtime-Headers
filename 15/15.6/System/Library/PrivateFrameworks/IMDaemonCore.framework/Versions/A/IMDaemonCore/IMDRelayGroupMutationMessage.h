...
@property (nonatomic) char fromMe;
...
- (id)_initWithType:(unsigned long long)a0 sender:(id)a1 service:(id)a2 groupID:(id)a3 originalGroupID:(id)a4 guid:(id)a5 destinationCallerID:(id)a6 fromMe:(char)a7;
