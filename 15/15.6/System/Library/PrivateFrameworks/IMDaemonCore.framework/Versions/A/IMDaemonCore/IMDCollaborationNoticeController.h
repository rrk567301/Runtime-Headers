...
@property (nonatomic) char hasPopulatedHighlightTracking;
...
- (void)_generateParticipantChangeNoticesForChat:(id)a0 highlight:(id)a1 participant:(id)a2 noticeType:(long long)a3 checkedPrivileges:(char)a4 messageGUID:(id)a5;
- (void)_generateParticipantChangeNoticesForChat:(id)a0 highlights:(id)a1 participants:(id)a2 noticeType:(long long)a3;
- (char)_hasAdministrativePrivilegesForHighlight:(id)a0 chatGUID:(id)a1;
- (char)_highlightEligibleForSuggestAddingUser:(id)a0;
