...
- (void)timerDidFire;
- (void)didSendMessage:(id)a0 forChat:(id)a1 style:(unsigned char)a2 account:(id)a3 forceDate:(id)a4 itemIsComingFromStorage:(char)a5;
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 lastAddressedHandle:(id)a5 lastAddressedSIMID:(id)a6 handleInfo:(id)a7 account:(id)a8 category:(long long)a9 spamExtensionName:(id)a10 isBlackholed:(char)a11;
- (void)handleMessageDidReplace:(id)a0 newMessage:(id)a1;
- (void)informOfCancelledMessageWithMessageGUID:(id)a0 success:(char)a1 cancelType:(unsigned long long)a2 error:(id)a3;
- (id)initWithServiceSession:(id)a0;
- (id)processMessageForSending:(id)a0 toChat:(id)a1 style:(unsigned char)a2 allowWatchdog:(char)a3 account:(id)a4;
