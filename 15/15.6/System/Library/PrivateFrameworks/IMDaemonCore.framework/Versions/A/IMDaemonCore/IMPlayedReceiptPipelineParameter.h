...
@property (readonly, nonatomic) char isFromDefaultPairedDevice;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithDefusedMessage:(id)a0 idsTrustedData:(id)a1 isFromDefaultPairedDevice:(char)a2;
- (id)initWithIdsTrustedData:(id)a0 GUID:(id)a1 timestamp:(id)a2 isFromStorage:(char)a3 isLastFromStorage:(char)a4 isFromDefaultPairedDevice:(char)a5;
