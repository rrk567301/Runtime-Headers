...
+ (id)_copyItemAtURL:(id)a0 toTemporaryDirectoryWithName:(id)a1 isDirectory:(char)a2 error:(id *)a3;
...
- (void)_acceptMomentShareIfNecessaryForContext:(id)a0 isRetry:(char)a1;
- (id)_assetUUIDToUnfinishedTransferMapFromTransfers:(id)a0;
- (id)_contextForMomentShareURL:(id)a0 forMessage:(id)a1 inChat:(id)a2 createIfNeeded:(char)a3;
...
- (char)messageHasUnfinishedTransfers:(id)a0;
- (void)regenerateTransfersForMessage:(id)a0 inChat:(id)a1 addingAssetWithUUID:(id)a2;
- (void)registerAndAcceptMomentShareForMessage:(id)a0 inChat:(id)a1 resetAssetTransfers:(char)a2;
