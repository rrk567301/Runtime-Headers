@class IMDRecordZoneManager, IMDCKMessageSyncCKOperationFactory, NSObject;
...
- (void)_onWriteComplete:(long long)a0 error:(id)a1 shouldWriteMore:(char)a2 activity:(id)a3 completion:(id /* block */)a4;
