...
- (char)_hasCancellableScheduledMessageForChat:(id)a0;
- (id)_incomingChatWithChatRecord:(id)a0;
- (id)_incomingChatsWithChatRecords:(id)a0;
- (id)_loadChatsIncludingAllChats:(char)a0;
- (id)_lockRecord;
- (void)_markAllChatsAsNeedingSync;
- (unsigned long long)_maxFetchChatAttempts;
- (void)_performOrScheduleSpotlightIndexingOfAddedMessageWithGUID:(id)a0 chat:(id)a1 shouldDeferIndexing:(char)a2;
- (void)_processIncomingChat:(id)a0;
- (char)_shouldMarkAllChatsAsNeedingSync;
- (char)_storeChat:(id)a0 updateProtectedProperties:(char)a1;
- (void)_updateHasCancellableScheduledMessageForChat:(id)a0;
- (void)_updateModificationDate;
- (void)addMessageWithGUID:(id)a0 toChat:(id)a1;
- (void)addMessageWithGUID:(id)a0 toChat:(id)a1 deferSpotlightIndexing:(char)a2;
...
- (id)chatsFilteredUsingPredicate:(id)a0 sortedUsingLastMessageDateAscending:(char)a1 olderThan:(id)a2 limit:(unsigned long long)a3;
...
- (char)storeChat:(id)a0;
- (id)syncTokenStore;
- (void)unblackholeChat:(id)a0;
- (unsigned long long)unreadCountForChat:(id)a0;
- (char)updateHandle:(id)a0 sourceMessage:(id)a1 personCentricID:(id)a2 onService:(id)a3;
- (char)updatePersonCentricIDForHandlesInChatWithMessage:(id)a0 fromIdentifier:(id)a1 personCentricID:(id)a2 chat:(id)a3;
