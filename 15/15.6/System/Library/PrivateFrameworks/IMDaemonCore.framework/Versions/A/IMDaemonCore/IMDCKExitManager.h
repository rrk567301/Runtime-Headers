...
@property (nonatomic) char fetchedExitDateOnLaunch;
...
- (void)_submitCloudKitMetricWithOperationGroupName:(id)a0 record:(id)a1 ignoreZoneNotFoundError:(char)a2 completion:(id /* block */)a3;
