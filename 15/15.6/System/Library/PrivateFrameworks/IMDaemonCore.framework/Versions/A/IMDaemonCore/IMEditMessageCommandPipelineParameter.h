...
@property (readonly, nonatomic) char shouldRetractMessageSubject;
@property (readonly, nonatomic) char hasEditTypeAndPartIndex;
...
- (id)initWithIdsTrustedData:(id)a0 editCommandGUID:(id)a1 timestamp:(id)a2 isFromStorage:(char)a3 isLastFromStorage:(char)a4 editedMessageGUID:(id)a5 editedMessagePartIndex:(long long)a6 editType:(unsigned long long)a7 editedMessagePartBody:(id)a8 editedMessagePartFileTransferGUIDs:(id)a9 shouldRetractMessageSubject:(char)a10 hasEditTypeAndPartIndex:(char)a11;
