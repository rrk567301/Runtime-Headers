...
- (id)initWithChangeType:(unsigned long long)a0 changedParticipants:(id)a1 sender:(id)a2 service:(id)a3 groupID:(id)a4 originalGroupID:(id)a5 guid:(id)a6 destinationCallerID:(id)a7 failed:(char)a8 fromMe:(char)a9;
