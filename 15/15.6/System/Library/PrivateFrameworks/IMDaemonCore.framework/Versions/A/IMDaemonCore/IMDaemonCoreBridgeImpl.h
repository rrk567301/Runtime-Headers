...
+ (char)isExpectedChatIDForItem:(id)a0 chatID:(id)a1;
...
+ (char)hasFinishedAssetDownloadSync;
+ (char)isBackwardCompatibilityForItem:(id)a0 parentChatID:(id)a1;
+ (char)isCompatibleWithMiCForItem:(id)a0;
+ (void)moveMessagePartForGUID:(id)a0 deleteDate:(id)a1 partBody:(id)a2;
+ (id)primaryAccountCountryCode;
+ (char)registerGuid:(id)a0 forLocalURL:(id)a1;
+ (void)reloadDatabase;
+ (void)removeTransferFromBackup:(id)a0;
+ (void)setSortIDForItem:(id)a0 parentChatID:(id)a1;
+ (char)shouldStoreMessageForItem:(id)a0;
+ (char)storeAttachmentWithTransfer:(id)a0 withChatGUID:(id)a1;
