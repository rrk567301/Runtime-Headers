...
@property (nonatomic) char isSendEnabled;
...
@property (nonatomic) char wasRelayed;
@property (retain, nonatomic) NSString *groupID;
@property (retain, nonatomic) NSString *originalGroupID;
@property (retain, nonatomic) NSString *displayName;
@property (readonly, nonatomic) char isGroupMessagingEnabled;
@property (readonly, nonatomic) char isGroupChat;
