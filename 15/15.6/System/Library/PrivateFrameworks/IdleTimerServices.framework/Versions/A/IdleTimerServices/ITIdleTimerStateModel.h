...
@property (readonly, getter=isIdleTimerServiceAvailable) char idleTimerServiceAvailable;
...
- (char)handleIdleEvent:(unsigned long long)a0 usingConfigurationWithIdentifier:(id)a1;
