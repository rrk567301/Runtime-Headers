...
@property (nonatomic) char enteredAfterFailedCDPRecovery;
...
- (id)initWithValidator:(id)a0 rpdLedger:(id)a1 cdpContext:(id)a2 showCancel:(char)a3 delegate:(id)a4;
