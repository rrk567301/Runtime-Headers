...
@property (nonatomic) char viewBasedUI;
...
- (void)cdpContext:(id)a0 promptForICSCWithIsNumeric:(char)a1 numericLength:(id)a2 isRandom:(char)a3 validator:(id)a4;
...
- (void)cdpContext:(id)a0 promptForRemoteSecretWithDevices:(id)a1 offeringRemoteApproval:(char)a2 validator:(id)a3;
...
- (void)_configureEnrollViewWithContext:(id)a0 devices:(id)a1 offeringRemoteApproval:(char)a2 validator:(id)a3;
- (void)_extractPasswordFromData:(id)a0 context:(id)a1 completion:(id /* block */)a2;
- (char)_hasEntitlementsToShowLocalAuthenticationSecretPrompt;
