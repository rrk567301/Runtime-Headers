...
@property (nonatomic) char isQuotaScreenDisabled;

- (id)init;
- (void).cxx_destruct;
- (void)setDelegate:(id)a0;
- (id)initWithAppleAccount:(id)a0 url:(id)a1 urlRequest:(id)a2 hook:(id)a3;
- (void)setIsNetworkErrorPresented:(char)a0 resetConfirmationAlertCompletion:(id /* block */)a1;
- (void)setIsQuotaScreenPresented:(char)a0;
- (void)setIsRPDSuccessScreenPresented:(char)a0 resetConfirmationAlertCompletion:(id /* block */)a1;
