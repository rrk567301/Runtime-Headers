...
@property char localUserPassword;
...
@property (setter=setCodeEditable:) char isCodeEditable;
...
@property (setter=setHasReachedAttemptLimit:) char hasReachedAttemptLimit;
@property char shouldShowPassword;
@property char promptForICSC;
@property char isNumeric;
@property char isRandom;
@property char offeringRemoteApproval;
@property char offeringToUseRecoveryKey;
@property char offeringToUseCustodianRecovery;
@property (nonatomic) char offeringToUseEDPRecoveryToken;
@property (copy, nonatomic) id /* block */ cdpRecoverySuccessFromEDPContinuationHandler;
@property char offeringToUseResetProtectedData;
@property char makeSheetCritical;
@property char shouldWaitForApproval;
@property char isFollowup;
@property (nonatomic) char isWalrusEnabled;
@property (nonatomic) char rpdProbationDuration;
...
- (void)_handleCustodianChoiceFromReturnCode:(long long)a0 shouldReset:(char)a1;
- (void)_handleSkipRecoveryKeyChoiceFromReturnCode:(long long)a0 resetEligible:(char)a1;
...
- (char)_resetEligible;
- (id)_sendHandleSkipRecoveryKeyPresentedEventWithResetEligible:(char)a0;
...
- (void)_showStorageAppListViewWithExtraChecks:(char)a0;
- (void)_startNativeRPDFlow;
- (void)_startRPDConfirmationFlow;
- (char)_supportsEscapeOfferSkip;
...
- (void)beginEDPRecoveryTokenFlowAfterFailedCDPRecovery:(char)a0 showCancel:(char)a1;
...
- (void)hideMainUIElements:(char)a0;
...
- (void)resetConfirmationWithExtraChecks:(char)a0;
- (void)setEnabledForCancel:(char)a0;
- (void)showCustodianCodeEntry;
- (void)showCustodianOSPicker;
- (void)showDevicePickerView:(char)a0;
...
- (char)supportsCustodianRecovery;
