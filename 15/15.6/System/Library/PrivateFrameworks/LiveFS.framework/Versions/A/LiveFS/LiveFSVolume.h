...
@property (readonly) char renameChangesFileID;
@property (readonly) char hasPersistentFileIDs;
...
- (void)blockmapFile:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 flags:(unsigned int)a2 operationID:(unsigned long long)a3 reply:(id /* block */)a4;
...
- (void)createIn:(id)a0 named:(id)a1 attributes:(id)a2 andClient:(unsigned long long)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
...
- (void)lookupin:(id)a0 name:(id)a1 forClient:(unsigned long long)a2 usingFlags:(unsigned int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeCloneOf:(id)a0 named:(id)a1 inDirectory:(id)a2 attributes:(id)a3 usingFlags:(unsigned int)a4 andClient:(unsigned long long)a5 requestID:(unsigned long long)a6 reply:(id /* block */)a7;
- (void)makeDirectoryIn:(id)a0 named:(id)a1 attributes:(id)a2 andClient:(unsigned long long)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeLinkOf:(id)a0 named:(id)a1 inDirectory:(id)a2 andClient:(unsigned long long)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeSymLinkIn:(id)a0 named:(id)a1 contents:(id)a2 attributes:(id)a3 andClient:(unsigned long long)a4 requestID:(unsigned long long)a5 reply:(id /* block */)a6;
...
- (void)readDirectory:(id)a0 amount:(unsigned long long)a1 requestedAttributes:(unsigned long long)a2 cookie:(unsigned long long)a3 verifier:(unsigned long long)a4 requestID:(unsigned long long)a5 reply:(id /* block */)a6;
...
- (void)readDirectory:(id)a0 intoBuffer:(id)a1 requestedAttributes:(unsigned long long)a2 cookie:(unsigned long long)a3 verifier:(unsigned long long)a4 requestID:(unsigned long long)a5 reply:(id /* block */)a6;
...
- (void)setUpdateInterest:(id)a0 interest:(char)a1 forClient:(unsigned long long)a2 requestID:(unsigned long long)a3 reply:(id /* block */)a4;
