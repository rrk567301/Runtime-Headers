...
- (void)lookupIn:(id)a0 name:(id)a1 usingFlags:(unsigned int)a2 requestID:(unsigned long long)a3 reply:(id /* block */)a4;
...
- (void)renameItemIn:(id)a0 named:(id)a1 item:(id)a2 toDirectory:(id)a3 newName:(id)a4 toItem:(id)a5 usingFlags:(unsigned int)a6 requestID:(unsigned long long)a7 reply:(id /* block */)a8;
...
- (void)setUpdateInterest:(id)a0 interest:(char)a1 requestID:(unsigned long long)a2 reply:(id /* block */)a3;
