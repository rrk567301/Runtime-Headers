...
@property (readonly, nonatomic) char supportsNonLinearRunning;
@property (readonly, nonatomic) char supportsModularAttention;
@property (readonly, nonatomic) unsigned long long maxContextLength;
@property (readonly, nonatomic) unsigned long long maxTokenTreeCount;
@property (readonly, nonatomic) unsigned long long vocabularyCount;

+ (id)log;
+ (char)compileModelAtPath:(id)a0 modelType:(long long)a1 error:(id *)a2;
+ (char)compileModelWithConfiguration:(id)a0 error:(id *)a1;
...
+ (char)doesModelRequireCompilationAtPath:(id)a0 modelType:(long long)a1;
+ (char)doesModelRequireCompilationWithConfiguration:(id)a0;
+ (char)doesModelRequireCompilationWithConfiguration:(id)a0 bundleCachePath:(id)a1;
...
- (void)runTokens:(id)a0 tokenTreeIndexes:(id)a1 tokenMask:(id)a2 outputBlock:(id /* block */)a3;
- (char)setKVCacheEntry:(id)a0 startIndex:(long long)a1 error:(id *)a2;
