...
@property (readonly, nonatomic) char isHoldingWriteTransaction;
...
- (char)_isHoldingWriteTransaction;
...
- (id)parsecStoreId;
- (id)readSiriCategoryFrom:(id)a0 recursive:(char)a1 autoBugCaptureBlock:(id /* block */)a2;
