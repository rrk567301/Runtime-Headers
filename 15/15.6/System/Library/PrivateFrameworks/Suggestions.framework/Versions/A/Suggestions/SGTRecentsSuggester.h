...
+ (void)_checkInDefaultsGlobal:(char)a0 saveName:(id)a1;
+ (id)_checkOutDefaultsGlobal:(char)a0 saveName:(id)a1;
+ (void)_globalChangeNotification:(id)a0;
+ (char)_isThisUserInfoForThisProcess:(id)a0;
...
- (id)initWithSaveName:(id)a0 global:(char)a1;
