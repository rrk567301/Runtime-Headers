...
@property (readonly, nonatomic) char offerDidYouMeanSuggestion;
...
- (id)_parseResultForGroup:(id)a0 queryCanceled:(char *)a1;
...
- (void)commonInitWithAttributeNames:(id)a0 canUseSimpleTokens:(char)a1;
...
- (char)hasMenuForSuggestion:(id)a0;
- (char)hasScopeMenuForSuggestion:(id)a0;
