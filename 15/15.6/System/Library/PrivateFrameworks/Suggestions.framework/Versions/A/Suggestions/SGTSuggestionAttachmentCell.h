...
- (id)_componentColor:(long long)a0 state:(long long)a1 isDark:(char)a2;
...
- (char)popScopeMenuInControlView:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
