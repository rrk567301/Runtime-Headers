...
@property char matchesFinderFilesOnly;
@property char matchesSupportFiles;
...
- (void)searchQueryCollector:(id)a0 processQueryResults:(id)a1 processSuggestions:(id)a2 context:(id)a3 intermediateResults:(char)a4;
- (void)setImagesForTags:(id)a0;
- (void)setInput:(id)a0 withGroup:(id)a1;
- (void)setRunWarmingQuery:(char)a0;
