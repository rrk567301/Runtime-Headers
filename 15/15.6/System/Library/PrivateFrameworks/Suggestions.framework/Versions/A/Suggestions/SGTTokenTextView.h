...
@property (readonly, nonatomic) char programmaticTextChange;
...
- (void)_updateCompletionWithRangeOfCompletion:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 selectedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 byTyping:(char)a2;
