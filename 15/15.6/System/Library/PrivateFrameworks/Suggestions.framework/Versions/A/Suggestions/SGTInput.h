...
- (id)initWithSuggestion:(id)a0 filterQueryString:(id)a1 validatedSuggestionScopes:(id)a2 searchFieldUsesTokens:(char)a3 rangeInSearchField:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4;
