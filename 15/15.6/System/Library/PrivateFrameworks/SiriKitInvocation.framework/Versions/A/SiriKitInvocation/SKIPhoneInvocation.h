...
+ (id)announceIncomingCallerRequestForCallID:(id)a0 callProviderIdentifier:(id)a1 callProviderBundleId:(id)a2 callerContactIdentifiers:(id)a3 handle:(id)a4 isVideo:(char)a5 isCallerIDBlocked:(char)a6 isBobbleCapableAnnouncement:(char)a7;
+ (id)announceIncomingCallerRequestForCallUUID:(id)a0 callProviderIdentifier:(id)a1 callProviderBundleId:(id)a2 callerContactIdentifiers:(id)a3 handle:(id)a4 isVideo:(char)a5 isCallerIDBlocked:(char)a6;
