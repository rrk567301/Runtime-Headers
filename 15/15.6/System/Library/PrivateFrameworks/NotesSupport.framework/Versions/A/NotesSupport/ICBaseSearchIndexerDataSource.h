...
@property (nonatomic, getter=isObservingChanges) char observingChanges;
@property char needsReindexing;
...
- (char)isFolderWithServerShareChanged:(id)a0;
...
- (char)isPaperKitOrSynapseAttachment:(id)a0;
...
- (char)_loadStateDictionaryWithFileManager:(id *)a0 fileURL:(id *)a1 NSError:(id *)a2 fileExists:(char *)a3 savedDictionary:(id *)a4;
- (char)addNewObjectsForProcessing:(id)a0;
...
- (char)saveStateDictionary:(id)a0;
