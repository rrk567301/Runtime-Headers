...
+ (id)titleForAttributedContent:(id)a0 truncated:(char *)a1 attributedTitleIfNecessary:(id *)a2;
+ (id)attributedStringByRemovingTitle:(id)a0 fromAttributedString:(id)a1;
+ (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeForTitleInContent:(id)a0 truncated:(char *)a1;
