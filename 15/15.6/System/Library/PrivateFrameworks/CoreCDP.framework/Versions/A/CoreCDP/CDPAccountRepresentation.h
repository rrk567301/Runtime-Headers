...
@property (readonly, nonatomic) char isBeneficiary;
@property (readonly, nonatomic) char isICDPEnabled;
@property (readonly, nonatomic) char isSilentEscrowRecordRepairEnabled;
@property (readonly, nonatomic) char isSilentEscrowRecordRepairEnabledV2;
@property (readonly, nonatomic) char isSilentBurnCDPRepairEnabled;
@property (readonly, nonatomic) char shouldPerformSilentEscrowRecordRepair;
...
- (id)_cachedPropertyValueOfClass:(Class)a0 forKey:(id)a1 staleModifiedDate:(id)a2 account:(id)a3 isStale:(char *)a4;
- (id)_cachedPropertyValueOfClass:(Class)a0 forKey:(id)a1 valueProducer:(id /* block */)a2;
- (id)_cachedPropertyValueOfClass:(Class)a0 forKey:(id)a1 valueProducer:(id /* block */)a2 checkForStale:(char)a3 account:(id)a4;
- (id)_cachedPropertyValueOfClass:(Class)a0 forKey:(id)a1 valueProducer:(id /* block */)a2 checkForStale:(char)a3 account:(id)a4 saveHandler:(id /* block */)a5;
...
- (char)isICDPEnabledByCheckingWithServer:(char)a0;
