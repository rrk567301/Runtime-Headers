...
- (char)_isInSOSCircleWithContext:(id)a0;
- (char)_isSOSTrustAndSyncingEnabled;
...
- (void)recoverOctagonUsingCustodianInfo:(id)a0 withContext:(id)a1 completion:(id /* block */)a2;
- (void)validateRecoveryKey:(id)a0 withContext:(id)a1 completion:(id /* block */)a2;
- (char)verifyRecoveryKeyObservingSystemsHaveMatchingStateWithContext:(id)a0 error:(id *)a1;
