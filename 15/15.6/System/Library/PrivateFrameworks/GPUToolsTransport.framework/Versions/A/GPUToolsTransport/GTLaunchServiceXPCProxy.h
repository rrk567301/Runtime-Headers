...
- (void).cxx_destruct;
- (char)foregroundService:(unsigned long long)a0 error:(id *)a1;
- (id)initWithConnection:(id)a0 remoteProperties:(id)a1;
- (char)launchReplayService:(id)a0 error:(id *)a1;
- (void)processStateForService:(unsigned long long)a0 completionHandler:(id /* block */)a1;
- (char)resumeService:(unsigned long long)a0 error:(id *)a1;
