...
@protocol OS_os_log, OS_dispatch_group, OS_dispatch_queue;
...
- (char)uploadChunk:(id)a0 forHandle:(unsigned long long)a1 isFinalChunk:(char)a2 error:(id *)a3;
