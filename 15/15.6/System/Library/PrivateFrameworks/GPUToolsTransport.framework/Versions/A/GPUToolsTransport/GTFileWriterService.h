...
@protocol OS_dispatch_semaphore, OS_os_log, GTConnectionProvider, OS_dispatch_queue, GTURLAccessProvider;
...
- (char)_finishSession:(unsigned long long)a0 error:(id *)a1;
...
- (id)initWithConnectionProvider:(id)a0 deviceUDID:(id)a1 urlAccessProvider:(id)a2;
