...
@protocol MTLSamplerState, MTLLibrary, MTLTexture, MTLBuffer, MTLDeviceSPI;
...
- (void)fillScalingTable_YUVTM:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; BOOL x22; int x23; } *)a0 targetwhite:(float)a1 targetblack:(float)a2 satBoost:(float)a3 scalingFactor:(char)a4 sdrOnly:(char)a5;
- (unsigned int)getPackagingColorFormatFromDictionary:(id)a0 withDefaultValue:(unsigned int)a1;
- (id)getRenderPipelineStateForShader:(id)a0;
- (int)getTVIndex:(char)a0;
- (void)handleMetaInsertion:(char)a0 encoder:(id)a1 widthScale:(int)a2 payloadLength:(unsigned int)a3;
...
- (int)pixelNumPerThreadFullScreen:(char)a0 videoInput:(struct __IOSurface { } *)a1 UI:(struct __IOSurface { } *)a2 Output:(struct __IOSurface { } *)a3 widthScaling:(char)a4;
- (long long)setAccessibilityMatrix:(struct { float x0[3][3]; } *)a0;
- (void)setupMetal;
- (void)setupTexturesWithInput:(struct __IOSurface { } *)a0 VideoSRGB:(char)a1 UI:(struct __IOSurface { } *)a2 UISRGB:(char)a3 Output:(struct __IOSurface { } *)a4 PixelPerThread:(int)a5 ptvMode:(char)a6;
- (char)updateConfigFromMetadata:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; BOOL x22; int x23; } *)a0 uiScaleFactor:(float)a1 width:(int)a2 background:(struct { double x0; double x1; double x2; double x3; } *)a3 hdrVideoOnly:(char)a4 hdr10TV:(char)a5 sdrOnly:(char)a6;
- (void)updateUniformUIScaleForVideo:(char)a0 forTV:(char)a1 videoPeakBrightnessInNits:(int)a2 uiHWDegamma:(char)a3 dovi50toHDR10TVMode:(unsigned int)a4;
