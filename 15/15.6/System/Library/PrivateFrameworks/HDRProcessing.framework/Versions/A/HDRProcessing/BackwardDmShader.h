...
+ (id)createShaderWithVertexName:(id)a0 fragmentName:(id)a1 colorFormat:(unsigned long long)a2 useCustomMatrix:(char)a3 p3CSC:(char)a4 applyYGamma:(char)a5;
...
- (id)initShaderWithVertexName:(id)a0 fragmentName:(id)a1 colorFormat:(unsigned long long)a2 useCustomMatrix:(char)a3 p3CSC:(char)a4 applyYGamma:(char)a5;
