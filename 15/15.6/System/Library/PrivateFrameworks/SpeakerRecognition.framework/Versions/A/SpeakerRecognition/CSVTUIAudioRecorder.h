...
- (char)isRecordingWithStreamHandleId:(unsigned long long)a0;
- (char)prepareAudioStreamRecordWithStreamHandleId:(unsigned long long)a0 error:(id *)a1;
...
- (char)startAudioStreamWithStreamHandleId:(unsigned long long)a0 error:(id *)a1;
- (char)stopAudioStreamWithStreamHandleId:(unsigned long long)a0 error:(id *)a1;
