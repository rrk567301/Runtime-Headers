...
@property (readonly, nonatomic) char satModelAvailable;

+ (id)createVoiceScorersWithVoiceProfiles:(id)a0 withConfigFile:(id)a1 withResourceFile:(id)a2 withOffsetsType:(unsigned long long)a3 forRetraining:(char)a4;
...
- (id)initWithProfileID:(id)a0 withModelFile:(id)a1 withConfigFile:(id)a2 withResourceFile:(id)a3 configData:(id)a4 memoryIndex:(id)a5 withOffsetsType:(unsigned long long)a6 forRetraining:(char)a7;
- (id)initWithProfileID:(id)a0 withModelFile:(id)a1 withConfigFile:(id)a2 withResourceFile:(id)a3 withOffsetsType:(unsigned long long)a4 forRetraining:(char)a5;
- (float)normalizedScoreFromRawScore:(float)a0 forScoreType:(unsigned long long)a1;
- (char)resetScorerWithModelFilePath:(id)a0;
