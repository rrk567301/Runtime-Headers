...
@property (readonly, nonatomic) char implicitTrainingRequired;
...
- (void)_emitVoiceProfileOnboardedSelfLogWithExplicitScores:(id)a0 withProfilePitch:(float)a1;
