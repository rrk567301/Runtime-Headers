...
@property (readonly, nonatomic) char profileLocallyAvailable;
...
- (char)_isSATMarkedWithMarker:(id)a0;
- (char)_markSATEnrollmentWithMarker:(id)a0;
...
- (char)deleteModelForSpidType:(unsigned long long)a0 recognizerType:(unsigned long long)a1;
