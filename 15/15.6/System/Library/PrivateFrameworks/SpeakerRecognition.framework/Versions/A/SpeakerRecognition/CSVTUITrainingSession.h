@class NSUUID, NSString, NSTimer, SFSpeechAudioBufferRecognitionRequest, NSDictionary, SFSpeechRecognitionTask, NSMutableArray, SFSpeechRecognizer, NSObject, CSVTUITrainingSessionHelper, CSAudioZeroCounter;
...
@interface CSVTUITrainingSession : NSObject <SFSpeechRecognitionTaskDelegate, CSVTUIAudioSessionDelegate, CSVTUIEndPointDelegate> {
    ...
    char _resultReported;
    char _sessionProcess;
    char _sessionSuspended;
    char _ASRErrorOccured;
    char _speechStartDetected;
...
- (void)closeSessionWithStatus:(int)a0 successfully:(char)a1 complete:(id /* block */)a2;
- (void)closeSessionWithStatus:(int)a0 successfully:(char)a1 voiceTriggerEventInfo:(id)a2 completeWithResult:(id /* block */)a3;
...
- (char)resultAlreadyReported;
- (void)resumeTraining;
- (char)setupPhraseSpotter;
