@class SSRVoiceProfileStorePrefs, NSObject;
...
- (char)_checkIfRetrainingRequiredForProfile:(id)a0;
- (id)_deleteUserVoiceProfile:(id)a0;
- (id)_enrolledVoiceProfiles;
- (id)_getTopScoringProfileIdFromScores:(id)a0;
- (void)_logVoiceProfileConfusionWithCleanup:(char)a0;
- (void)_retrainLiveOnOnboardedProfilesForLanguage:(id)a0 withForceRetrain:(char)a1 withCompletion:(id /* block */)a2;
...
- (char)checkIfVoiceProfile:(id)a0 needsUpdatedWith:(id)a1 withCategory:(unsigned long long)a2;
...
- (char)evaluateImplicitAdditionPolicyWithScores:(id)a0 forProfile:(id)a1 withImplicitThreshold:(float)a2 withDeltaThreshold:(float)a3;
- (id)initStore;
- (void)isImplicitTrainingRequiredToVoiceProfile:(id)a0 withAsset:(id)a1 completion:(id /* block */)a2;
- (id)loadCurrentVoiceProfiles;
- (void)logVoiceProfileConfusionWithCleanup:(char)a0;
...
- (void)saveVoiceProfiles:(id)a0 completion:(id /* block */)a1;
- (id)updateVoiceProfile:(id)a0 withUserName:(id)a1 withBasePathExclave:(id)a2;
