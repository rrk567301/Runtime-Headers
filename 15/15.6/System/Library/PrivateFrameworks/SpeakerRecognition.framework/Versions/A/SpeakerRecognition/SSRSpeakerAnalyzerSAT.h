...
- (id)_updateScoreCardForFinalResult:(char)a0;
- (id)_getAnalyzedResult;
- (id)_getSuperVectorWithEndPoint:(unsigned long long)a0;
- (id)_processSuperVector:(id)a0 withSize:(unsigned long long)a1 processedAudioDurationMs:(unsigned long long)a2 isFinal:(char)a3;
