...
- (char)isSATEnrolledForSiriProfileId:(id)a0 forLanguageCode:(id)a1;
...
- (void)_addUtterances:(id)a0 toProfile:(id)a1 withContext:(id)a2 doUtteranceDonation:(char)a3 withCompletion:(id /* block */)a4;
- (char)_checkIfDownloadRequiredForProfileId:(id)a0;
- (void)_copyExplicitEnrollmentFilesFromPath:(id)a0 toPath:(id)a1 withCompletion:(id /* block */)a2;
- (id)_createAndSetNewEnrollmentId;
- (char)_decryptFileForPHSMigrationAt:(id)a0 andSaveTo:(id)a1 error:(id *)a2;
...
- (char)_isLegacyEnrollmentMarkedWith:(id)a0 forLanguageCode:(id)a1;
- (char)_isMarkedForVoiceProfileTrainingSyncForLanguage:(id)a0;
...
- (void)emitMetricEnrollmentId:(id)a0 isVoiceProfileiCloudSyncSuccess:(char)a1 failureReasonIfAny:(id)a2 forLocale:(id)a3;
...
- (char)hasVoiceProfileIniCloudForLanguageCode:(id)a0 withBackupMetaBlob:(id)a1;
- (void)importVoiceProfile:(id)a0 appDomain:(id)a1 withSharedUserId:(id)a2 withLocale:(id)a3 withAsset:(id)a4 doUtteranceDonation:(char)a5 withCompletion:(id /* block */)a6;
...
- (char)isSATEnrollmentMigratedForSiriProfileId:(id)a0 forLanguageCode:(id)a1;
- (void)isVoiceProfileUploadedToiCloudForLanguageCode:(id)a0 withCompletionBlock:(id /* block */)a1;
- (char)isVoiceTriggerRepromptRequired;
