...
@protocol SSRVTUITrainingServiceDelegate, SSRVTUITrainingAudioSessionDelegate;
...
- (void)startRMS;
- (void)trainUtteranceViaXPC:(long long)a0 shouldUseASR:(char)a1 completion:(id /* block */)a2;
- (void)trainUtteranceViaXPC:(long long)a0 shouldUseASR:(char)a1 mhUUID:(id)a2 completionWithResult:(id /* block */)a3;
