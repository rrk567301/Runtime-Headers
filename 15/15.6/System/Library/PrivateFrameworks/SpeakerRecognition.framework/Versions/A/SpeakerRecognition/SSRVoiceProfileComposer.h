...
- (char)addUtterance:(id)a0 toProfile:(id)a1;
- (char)addUtterance:(id)a0 toProfile:(id)a1 withAsset:(id)a2;
- (char)addUtterance:(id)a0 toProfile:(id)a1 withAsset:(id)a2 withDonationInfo:(id)a3;
