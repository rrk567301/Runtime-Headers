...
+ (id)timeStampString;
+ (unsigned long long)convertToEnrollmentTriggerPhraseWithPhId:(unsigned long long)a0;
+ (id)convertToUtteranceDataWithDonationString:(id)a0;
...
+ (id)concatenateDonationId:(id)a0 triggerPhraseId:(unsigned long long)a1;
+ (id)convertSchemaTypeWithLocale:(id)a0;
+ (int)convertToSchemaEnumWithPhId:(unsigned long long)a0;
+ (id)createAVAudioPCMBufferWithNSData:(id)a0 audioFormat:(unsigned long long)a1 sampleRate:(float)a2 numOfChannel:(unsigned int)a3 isInterleaved:(char)a4;
+ (void)createDirectoryIfDoesNotExist:(id)a0;
+ (void)decryptAndReadAudioChunk:(id)a0 withCallback:(id /* block */)a1;
+ (unsigned long long)deviceCategoryFromString:(id)a0;
+ (void)dumpFilesInDirectory:(id)a0;
+ (char)encryptFileAt:(id)a0 andSaveTo:(id)a1 error:(id *)a2;
...
+ (char)isCurrentDeviceCompatibleWithNewerVoiceProfileAt:(id)a0;
+ (char)isCurrentDeviceCompatibleWithVoiceProfileAt:(id)a0;
+ (char)isMphVTUIKeywordDetectorSupportedPlatform;
+ (char)isSpeakerRecognitionSupportedInLocale:(id)a0;
...
+ (void)segmentVoiceTriggerFromAudioFile:(id)a0 withVTEventInfo:(id)a1 withStorePayloadPortion:(char)a2 withCompletion:(id /* block */)a3;
