...
- (char)loadCard:(id)a0 withCompletionHandler:(id /* block */)a1;
...
- (char)performNextCardCommand:(id)a0 forCardViewController:(id)a1;
- (char)performReferentialCommand:(id)a0 forCardViewController:(id)a1;
...
- (char)_loadCard:(id)a0 withCompletionHandler:(id /* block */)a1;
...
- (char)shouldSurpressBackground;
- (void)siriDidStartSpeakingWithIdentifier:(id)a0;
- (void)siriDidStopSpeakingWithIdentifier:(id)a0 speechQueueIsEmpty:(char)a1;
