...
- (id)init;
- (void).cxx_destruct;
- (char)_compareObject:(id)a0 toObject:(id)a1 usingBlock:(id /* block */)a2;
- (id)_createDebugViewControllerForAceObject:(id)a0;
- (char)_listItem:(id)a0 isEqualToListItem:(id)a1;
- (char)_listItem:(id)a0 isPreferredOverListItem:(id)a1;
