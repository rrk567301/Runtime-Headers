...
- (id)imageTaskWithHTTPGetRequest:(id)a0 client:(id)a1 fitToSize:(struct CGSize { double x0; double x1; })a2 incremental:(char)a3 progressHandler:(id /* block */)a4 fillColor:(id)a5;
- (id)imageTaskWithHTTPGetRequest:(id)a0 client:(id)a1 fitToSize:(struct CGSize { double x0; double x1; })a2 incremental:(char)a3 progressHandler:(id /* block */)a4 fillColor:(id)a5 userAgent:(id)a6;
