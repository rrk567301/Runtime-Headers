@class NSMutableData, NSColor, NSObject;
...
- (void)dealloc;
- (void).cxx_destruct;
- (id)initWithFitToSize:(struct CGSize { double x0; double x1; })a0 progressHandler:(id /* block */)a1 incremental:(char)a2 client:(id)a3 fillColor:(id)a4;
