...
- (void)attemptedToSaveConversation:(id)a0 withResult:(char)a1;
...
- (void)saeViewController:(id)a0 setStatusViewHidden:(char)a1;
...
- (char)saeViewModelControllerShouldAlwaysShowRecognizedSpeech:(id)a0;
