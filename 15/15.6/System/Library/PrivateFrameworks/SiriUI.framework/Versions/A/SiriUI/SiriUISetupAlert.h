...
@property char showsPrivacyInformation;
@property char showsLanguageSelection;
...
- (id)initEnableHeySiriAudioDevice:(char)a0 withAskSiri:(char)a1;
- (id)initEnableHeySiriBuiltInWithAskSiri:(char)a0;
