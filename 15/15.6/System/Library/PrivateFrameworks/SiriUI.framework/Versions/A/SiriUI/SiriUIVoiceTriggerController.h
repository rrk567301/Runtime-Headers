...
@interface SiriUIVoiceTriggerController : NSViewController <VTUITrainingViewControllerDelegate, SiriUISAEVoiceTrainingControllerDelegate> {
    ...
    char _bottomButtonConstraintEnabled;
    ...
    char _trainingForRemoteDarwinVoiceTrigger;
}
...
@property (nonatomic) char saeEnabled;
...
- (void)_updateViewForClamshellMode:(char)a0;
...
- (void)setTrainingForRemoteDarwinVoiceTrigger:(char)a0 remoteDarwinDeviceIdentifiersForTraining:(id)a1;
