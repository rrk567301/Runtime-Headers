...
+ (void)forceAvailabilityStateAvailable:(char)a0;
...
- (void)assistantConnection:(id)a0 didFinishAcousticIDRequestWithSuccess:(char)a1;
...
- (void)assistantConnection:(id)a0 setReplayEnabled:(char)a1;
...
- (char)speechRequestHandlerShouldRollBackRequestForSpeechCancellation:(id)a0;
...
- (char)_shouldLinkPreviousTurnIDWithInvocationSource:(int)a0;
...
- (void)attendingStatusChanged:(char)a0;
...
- (char)isEmittedOnServiceStart:(long long)a0;
