...
- (void)emitDialogOutputEventWith:(id)a0 canUseServerTTS:(char)a1 spokenDialogOutput:(id)a2 displayedDialogOutput:(id)a3;
- (void)emitFinalSpeechTranscriptionEventWith:(id)a0;
- (void)emitInstrumentationEvent:(id)a0 requiresNewTurn:(char)a1 previousTurnId:(id)a2;
