...
+ (char)formatSizeIsShortSide:(long long)a0;
+ (struct CGSize { double x0; double x1; })scaledSizeForSize:(struct CGSize { double x0; double x1; })a0 format:(long long)a1 capLength:(char)a2;
