...
- (char)closeAndDeletePhotoLibraryAtURL:(id)a0 error:(id *)a1;
...
- (char)closePhotoLibraryAtURL:(id)a0 error:(id *)a1;
- (char)overrideSystemPhotoLibraryURL:(id)a0 error:(id *)a1;
- (char)removePhotoLibraryURL:(id)a0 error:(id *)a1;
- (char)resetSyndicationLibrary:(id *)a0;
