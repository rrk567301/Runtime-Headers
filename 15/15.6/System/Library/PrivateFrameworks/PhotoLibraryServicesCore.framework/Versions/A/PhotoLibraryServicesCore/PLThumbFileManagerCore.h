...
+ (id)thumbnailPathForThumbIdentifier:(id)a0 withPathManager:(id)a1 recipeID:(unsigned int)a2 forDelete:(char)a3;
...
- (char)setImageForEntry:(id)a0 withIdentifier:(id)a1 orIndex:(unsigned long long)a2 photoUUID:(id)a3 options:(id)a4;
...
- (void)obtainAccessAndWaitWithFileWithAssetUUID:(id)a0 urlHandler:(id /* block */)a1;
