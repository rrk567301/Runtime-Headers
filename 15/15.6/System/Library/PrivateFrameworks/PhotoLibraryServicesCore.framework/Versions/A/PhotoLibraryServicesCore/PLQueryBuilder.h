...
- (void)addIsFavoriteQuery:(char)a0;
...
- (void)_addDateUnitQueryForKey:(int)a0 withValue:(id)a1 withType:(int)a2 withUnit:(int)a3 exclude:(char)a4;
...
- (char)_isValidCircularRegionComparator:(int)a0;
- (char)_isValidDateKey:(int)a0;
- (char)_isValidNumericComparator:(int)a0;
- (char)_isValidStringComparator:(int)a0;
- (char)_validIsEmptyQueryKey:(int)a0;
- (void)addApertureQuery:(double)a0 comparator:(int)a1;
- (void)addApertureRangeQueryBetweenValue:(double)a0 andValue:(double)a1;
- (void)addAssetTypeQuery:(int)a0 exclude:(char)a1;
...
- (void)addFlashQuery:(char)a0;
- (void)addFpsQuery:(double)a0 comparator:(int)a1;
- (void)addHasLocationQuery:(char)a0;
- (void)addInTheLastDaysQueryKey:(int)a0 withCount:(long long)a1 exclude:(char)a2;
- (void)addInTheLastMonthsQueryKey:(int)a0 withCount:(long long)a1 exclude:(char)a2;
- (void)addInTheLastSecondsQueryKey:(int)a0 withCount:(long long)a1 exclude:(char)a2;
- (void)addInTheLastWeeksQueryKey:(int)a0 withCount:(long long)a1 exclude:(char)a2;
- (void)addInTheLastYearsQueryKey:(int)a0 withCount:(long long)a1 exclude:(char)a2;
- (void)addIsAdjustedQuery:(char)a0;
- (void)addIsDateQueryKey:(int)a0 withDate:(id)a1 exclude:(char)a2;
- (void)addIsEmptyQueryForKey:(int)a0 isEmpty:(char)a1;
- (void)addIsHiddenQuery:(char)a0;
- (void)addIsInAlbumQuery:(id)a0;
- (void)addIsInAnyAlbumQuery;
- (void)addIsProResQuery:(char)a0;
- (void)addIsRawQuery:(char)a0;
- (void)addIsReferencedMediaQuery:(char)a0;
- (void)addIsoQuery:(long long)a0 comparator:(int)a1;
- (void)addIsoRangeQueryBetweenValue:(long long)a0 andValue:(long long)a1;
- (void)addKeywordQuery:(id)a0 exclude:(char)a1;
