...
+ (id)resolveSecurityScopedBookmark:(id)a0 isStale:(char *)a1 error:(id *)a2;
...
- (id)newSandboxExtensionDataForClient:(struct { unsigned int x0[8]; })a0 path:(id)a1 writable:(char)a2;
