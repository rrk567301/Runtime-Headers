...
@property (class, readonly, nonatomic) struct __CFString { } *colorSpaceName;

@property (nonatomic) char formatIsCropped;
...
- (char)validateData:(id)a0 withToken:(id)a1;
