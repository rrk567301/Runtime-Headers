...
@property char shouldCheckForExistingFiles;
...
- (char)_ensureDirectoryExists:(id)a0;
...
- (void)_saveUserInfo;
- (id)_subDirURLForNumber:(unsigned long long)a0 create:(char)a1 didCreate:(char *)a2;
