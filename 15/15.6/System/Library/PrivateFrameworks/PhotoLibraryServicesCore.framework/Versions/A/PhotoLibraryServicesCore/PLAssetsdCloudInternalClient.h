...
- (void)fetchShareFromShareURL:(id)a0 ignoreExistingShare:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)isReadyForAnalysisCPLInitialDownloadCompleted;
- (char)isReadyForAnalysisQuickCheck;
...
- (void)setCloudPhotoLibraryEnabledStateSync:(char)a0;
...
- (char)shouldAutoEnableiCPLOnOSXWithError:(id *)a0;
...
- (char)overrideSystemBudgetsForSyncSession:(char)a0 pauseReason:(id)a1 systemBudgets:(unsigned long long)a2 error:(id *)a3;
- (void)synchronouslySetCloudPhotoLibraryPauseState:(char)a0 reason:(short)a1;
