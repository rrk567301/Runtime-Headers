...
+ (char)sendChangesRequest:(id)a0 usingProxyFactory:(id)a1 error:(id *)a2;
+ (void)sendChangesRequest:(id)a0 usingProxyFactory:(id)a1 reply:(id /* block */)a2;
+ (void)setInTransactionProxy:(char)a0 queue:(id)a1;
...
- (char)cancelReservedCloudIdentifiersWithEntityName:(id)a0 error:(id *)a1;
- (id)getUUIDsForAssetObjectIDs:(id)a0 filterPredicate:(id)a1 context:(id)a2 error:(id *)a3;
- (char)processUniversalSearchJITForAssetUUID:(id)a0 processingTypes:(unsigned long long)a1 error:(id *)a2;
...
- (char)resetStateForMediaProcessingTaskID:(unsigned long long)a0 assetUUIDs:(id)a1 resetOptions:(unsigned long long)a2 error:(id *)a3;
