...
@property (nonatomic) char invalidatingPlaybackQueue;
@property (retain, nonatomic) MRPlayerPath *playerPath;
@property (nonatomic) char canBeNowPlayingPlayer;
...
@property (readonly, nonatomic) char hasReceivedCommandRecently;
@property (nonatomic, getter=isPictureInPictureEnabled) char pictureInPictureEnabled;
...
- (char)removePendingPlaybackSessionMigrateEvent:(id)a0;
