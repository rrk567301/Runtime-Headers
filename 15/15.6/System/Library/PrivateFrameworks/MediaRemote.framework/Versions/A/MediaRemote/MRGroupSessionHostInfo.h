...
@property (readonly, nonatomic, getter=isLockScreenAffordanceAllowed) char lockScreenAffordanceAllowed;
@property (readonly, nonatomic, getter=isInAppBannerAllowed) char inAppBannerAllowed;
