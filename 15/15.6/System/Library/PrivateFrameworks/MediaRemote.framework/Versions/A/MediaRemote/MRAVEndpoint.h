...
@property (readonly, nonatomic) char groupContainsDiscoverableGroupLeader;
...
@property (readonly, nonatomic, getter=isLocalEndpoint) char localEndpoint;
@property (readonly, nonatomic, getter=isCompanionEndpoint) char companionEndpoint;
...
@property (readonly, nonatomic) char isEligibleForHostingGroupSessionExcludingAcknowledgements;
...
+ (void)_notifyVolumeMutedDidChange:(char)a0 outputDevice:(id)a1 endpoint:(id)a2;
...
- (void)addOutputDevices:(id)a0 initiator:(id)a1 fadeAudio:(char)a2 withReplyQueue:(id)a3 completion:(id /* block */)a4;
...
- (void)setOutputDevices:(id)a0 initiator:(id)a1 fadeAudio:(char)a2 withReplyQueue:(id)a3 completion:(id /* block */)a4;
...
- (char)containsOutputDeviceWithUID:(id)a0;
...
- (char)effectivelyEqual:(id)a0;
- (char)hasPotentialGroupLeader;
...
- (void)muteOutputDeviceVolume:(char)a0 outputDevice:(id)a1 details:(id)a2 queue:(id)a3 completion:(id /* block */)a4;
- (void)muteOutputDeviceVolume:(char)a0 outputDevice:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
- (void)muteVolume:(char)a0 details:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
- (void)muteVolume:(char)a0 queue:(id)a1 completion:(id /* block */)a2;
...
- (void)removeOutputDevices:(id)a0 initiator:(id)a1 fadeAudio:(char)a2 withReplyQueue:(id)a3 completion:(id /* block */)a4;
...
- (void)setIsMuted:(char)a0 queue:(id)a1 completion:(id /* block */)a2;
- (void)setListeningMode:(id)a0 outputDeviceUID:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
- (void)setOutputDeviceIsMuted:(char)a0 outputDevice:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (char)volumeMutedForOutputDeviceUID:(id)a0;
