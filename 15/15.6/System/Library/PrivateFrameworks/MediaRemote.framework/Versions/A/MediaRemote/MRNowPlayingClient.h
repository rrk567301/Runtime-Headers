...
@interface MRNowPlayingClient : NSObject <MRNowPlayingClientState> {
    ...
    char _isForeground;
    char _canBeNowPlaying;
    double _canBeNowPlayingTimestamp;
    char _perPlayerCanBeNowPlaying;
    NSObject<OS_dispatch_queue> *_replayQueue;
    NSMutableArray *_commandQueue;
    NSObject<OS_dispatch_queue> *_avscQueue;
}

@property (nonatomic) char canBeNowPlaying;
@property (nonatomic) char perPlayerCanBeNowPlaying;
...
@property (nonatomic) char useMediaRemoteActivePlayerHeuristic;
...
- (char)canBeNowPlayingForPlayer:(id)a0;
