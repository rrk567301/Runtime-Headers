...
- (id)deviceDebugName;
- (char)sendMessage:(id)a0 type:(id)a1 destination:(id)a2 session:(id)a3 options:(id)a4 priority:(long long)a5 response:(id /* block */)a6;
...
- (char)_sendMessage:(id)a0 type:(id)a1 destination:(id)a2 session:(id)a3 options:(id)a4 priority:(long long)a5 replyID:(id)a6 response:(id /* block */)a7;
...
- (char)sendMessage:(id)a0 type:(id)a1 destination:(id)a2 session:(id)a3 options:(id)a4 priority:(long long)a5;
