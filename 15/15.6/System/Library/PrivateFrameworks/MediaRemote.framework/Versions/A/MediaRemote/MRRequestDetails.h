...
@property (readonly, nonatomic) char initiatorWasInferred;

+ (char)_isCLIBundleID:(id)a0;
+ (id)_inferInitatorForBundleID:(id)a0;
+ (char)_isSiriBundleID:(id)a0;
...
- (id)initWithInitiator:(id)a0 requestID:(id)a1 reason:(id)a2 userInitiated:(char)a3;
- (id)initWithInitiator:(id)a0 requestID:(id)a1 reason:(id)a2 userInitiated:(char)a3 originatingBundleID:(id)a4;
- (id)initWithName:(id)a0 requestID:(id)a1 reason:(id)a2;
- (id)initWithName:(id)a0 requestID:(id)a1 reason:(id)a2 userInitiated:(char)a3;
