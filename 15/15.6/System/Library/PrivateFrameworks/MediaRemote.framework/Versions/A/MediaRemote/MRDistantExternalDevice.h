...
@interface MRDistantExternalDevice : MRExternalDevice <MRAVDistantExternalDeviceClientProtocol> {
    ...
    char _hasEverAtteptedToConnectWhileInvalid;
...
@property (readonly, nonatomic) char hasEverAttemptedToConnect;
...
- (void)hostedExternalDeviceIsMutedDidChange:(char)a0 forOutputDevice:(id)a1;
...
- (void)setWantsEndpointChangeNotifications:(char)a0;
- (void)setWantsNowPlayingArtworkNotifications:(char)a0;
- (void)setWantsNowPlayingNotifications:(char)a0;
- (void)setWantsOutputDeviceNotifications:(char)a0;
- (void)setWantsSystemEndpointNotifications:(char)a0;
- (void)setWantsVolumeNotifications:(char)a0;
