...
@property (nonatomic) char useWeakMatching;
@property (nonatomic) char returnPartialResults;
@property (nonatomic) char waitForCompleteClusters;
@property (nonatomic) char shouldWaitForUnanimousEndpoints;
