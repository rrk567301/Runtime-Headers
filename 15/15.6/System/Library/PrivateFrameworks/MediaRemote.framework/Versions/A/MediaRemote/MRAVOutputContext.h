...
@property (readonly, nonatomic) char supportsVolumeControl;
...
@property (nonatomic, getter=isVolumeMuted) char volumeMuted;
@property (readonly, nonatomic) char supportsMultipleBluetoothOutputDevices;
...
- (void)addOutputDevices:(id)a0 initiator:(id)a1 fadeAudio:(char)a2 withCallbackQueue:(id)a3 block:(id /* block */)a4;
...
- (char)containsOutputDevice:(id)a0;
- (char)containsOutputDeviceUID:(id)a0;
...
- (void)removeOutputDevices:(id)a0 initiator:(id)a1 fadeAudio:(char)a2 withCallbackQueue:(id)a3 block:(id /* block */)a4;
...
- (void)setOutputDevices:(id)a0 initiator:(id)a1 password:(id)a2 fadeAudio:(char)a3 withCallbackQueue:(id)a4 block:(id /* block */)a5;
