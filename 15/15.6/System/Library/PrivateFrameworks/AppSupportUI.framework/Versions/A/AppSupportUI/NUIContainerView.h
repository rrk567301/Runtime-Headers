...
@interface NUIContainerView : NSView {
    ...
    struct map<NSView *, _NUIContainerViewArrangedSubview, std::less<NSView *>, std::allocator<std::pair<NSView *const, _NUIContainerViewArrangedSubview>>> { struct __tree<std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, std::__map_value_compare<NSView *, std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, std::less<NSView *>>, std::allocator<std::__value_type<NSView *, _NUIContainerViewArrangedSubview>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<NSView *, std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, std::less<NSView *>>> { unsigned long long __value_; } __pair3_; } __tree_; } _arrangedSubviewInfo;
...
@property (class, nonatomic) char enableAPIMisuseAssertions;

@property (nonatomic, getter=isDebugBoundingBoxesEnabled) char debugBoundingBoxesEnabled;
...
@property (nonatomic, getter=isLayoutMarginsRelativeArrangement) char layoutMarginsRelativeArrangement;
@property (nonatomic, getter=hasBaselineRelativeLayoutMarginsForArrangement) char baselineRelativeLayoutMarginsForArrangement;
...
- (void)assertNotInLayoutPass:(char)a0;
...
- (char)setNeedsInvalidation:(long long)a0;
