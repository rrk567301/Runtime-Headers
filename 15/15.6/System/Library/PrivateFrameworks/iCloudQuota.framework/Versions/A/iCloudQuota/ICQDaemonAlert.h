...
@property (nonatomic) char showOnlyInSpringboard;
@property (nonatomic) char handleActionsBeforeCallingCompletionHandler;

+ (void)dismissAlertsWithNotificationID:(id)a0;
+ (char)shouldShowForDaemonOffer:(id)a0;
...
- (char)showAlertWithCompletion:(id /* block */)a0;
