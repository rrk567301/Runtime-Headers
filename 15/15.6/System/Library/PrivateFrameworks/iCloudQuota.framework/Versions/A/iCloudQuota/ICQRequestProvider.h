...
+ (char)_keyIsEligibleForURLStringReplacement:(id)a0;
+ (id)_newAccountBagKeyForOldKey:(id)a0;
+ (void)addEntriesToPostDictionary:(id)a0 forStub:(id)a1;
+ (char)attemptSetRequest:(id)a0 toPostWithJSONDict:(id)a1;
...
- (char)willUseNewKey:(id)a0 offerID:(id)a1 notificationID:(id)a2;
