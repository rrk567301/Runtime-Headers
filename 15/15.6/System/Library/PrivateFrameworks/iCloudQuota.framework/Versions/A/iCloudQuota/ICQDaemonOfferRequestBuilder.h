...
- (id)requestWithQuotaKey:(id)a0 reason:(id)a1 offerStub:(id)a2 notificationID:(id)a3 contextDictionary:(id)a4 mlDaemonExtraFields:(id)a5 sourceIsServerSample:(char)a6;
