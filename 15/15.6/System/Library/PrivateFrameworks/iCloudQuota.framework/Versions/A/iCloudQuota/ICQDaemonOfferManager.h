...
@property (nonatomic) char shouldDirectToStorageManagement;
@property (nonatomic, getter=isBuddyOfferEnabled) char buddyOfferEnabled;
@property (nonatomic, getter=isSimulatedDeviceStorageAlmostFull) char simulatedDeviceStorageAlmostFull;
@property (retain, nonatomic) NSNumber *simulatedPhotosLibrarySize;
@property (nonatomic, getter=isLegacyDeviceStorageLevelNotificationEnabled) char legacyDeviceStorageLevelNotificationEnabled;
...
- (void)_teardownCachedOffersAndNotify:(char)a0;
...
- (void)_coalescedReconsiderOffersForAccount:(id)a0 isForBuddy:(char)a1 quotaReason:(id)a2 options:(id)a3 choiceHandler:(id /* block */)a4 completion:(id /* block */)a5;
...
- (void)_fetchDaemonOfferStubsForAccount:(id)a0 isForBuddy:(char)a1 quotaReason:(id)a2 completion:(id /* block */)a3;
...
- (char)_isCacheValidForRequestType:(long long)a0 offerStubs:(id)a1;
- (char)_isCachedDaemonOfferValid:(id)a0 forAccount:(id)a1;
- (void)_logErrorsForFetchOfferResultWithOffer:(id)a0 error:(id)a1 isForBuddy:(char)a2;
...
- (void)_postFollowupForDaemonOffer:(id)a0 replaceExisting:(char)a1 completion:(id /* block */)a2;
- (void)_postOfferType:(id)a0 isForBuddy:(char)a1;
- (void)_postStorageManagementFollowup;
- (void)_postUserNotification:(id)a0 replaceExisting:(char)a1 offerID:(id)a2 completion:(id /* block */)a3;
...
- (void)_reconsiderOffersForAccount:(id)a0 isForBuddy:(char)a1 quotaReason:(id)a2 choiceHandler:(id /* block */)a3 completion:(id /* block */)a4;
- (void)_reconsiderOffersForAccount:(id)a0 isForBuddy:(char)a1 quotaReason:(id)a2 options:(id)a3 choiceHandler:(id /* block */)a4 completion:(id /* block */)a5;
...
- (void)_teardownCachedDefaultOfferAndNotify:(char)a0;
- (void)_teardownCachedEventOfferAndNotify:(char)a0;
- (void)_teardownCachedOfferAndNotify:(char)a0;
- (void)_teardownCachedPremiumOfferAndNotify:(char)a0;
...
- (char)_useFetchOffersDataDirectly;
...
- (void)reconsiderOffersWithReason:(id)a0 reuseLocalOffers:(char)a1 completion:(id /* block */)a2;
