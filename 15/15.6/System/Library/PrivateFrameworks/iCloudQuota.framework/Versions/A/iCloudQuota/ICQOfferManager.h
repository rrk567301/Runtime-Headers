...
+ (char)_legacyBuddyOfferMightNeedPresenting;
+ (char)buddyOfferMightNeedPresenting;
+ (id)ckBackupDeviceID;
...
- (char)_offerTypeMatchesRequestOptions:(id)a0 offer:(id)a1;
...
- (char)_shouldUseOffer:(id)a0 forBundleIdentifier:(id)a1;
...
- (char)didDismissRecommendationForBundleId:(id)a0;
- (void)dismissRecommendationForBundleId:(id)a0;
- (char)fetchOfferIfNeeded;
...
- (char)isBuddyOfferEnabled;
- (char)isDeviceStorageAlmostFull;
- (char)isSimulatedDeviceStorageAlmostFull;
