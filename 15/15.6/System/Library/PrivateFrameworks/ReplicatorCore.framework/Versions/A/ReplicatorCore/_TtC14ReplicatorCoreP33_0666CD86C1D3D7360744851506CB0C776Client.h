...
- (id)init;
- (void).cxx_destruct;
- (char)addRecordsWithParameters:(id)a0 error:(id *)a1;
...
- (char)registerClientWithParameters:(id)a0 error:(id *)a1;
- (char)removeRecordsWithParameters:(id)a0 error:(id *)a1;
- (void)sendMessageExpectingResponseWithParameters:(id)a0 completion:(id /* block */)a1;
- (char)sendMessageWithParameters:(id)a0 error:(id *)a1;
- (char)syncAndReturnError:(id *)a0;
- (char)unregisterClientWithParameters:(id)a0 error:(id *)a1;
