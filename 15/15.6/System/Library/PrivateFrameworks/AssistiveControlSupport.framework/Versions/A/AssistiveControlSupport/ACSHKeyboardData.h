...
@property (class, readonly, nonatomic) char _shouldCacheBestGuessKeyboardDataByPanel;
...
@property (readonly, nonatomic) char _isBestSystemKeyboard;
@property (readonly, nonatomic) char _isSystemKeyboardLayout;
...
@property (readonly, nonatomic, getter=isLargeKeyboard) char largeKeyboard;
...
+ (char)_panel:(id)a0 hasMostOfKeyCodes:(id)a1;
+ (void)_recursivelyIterateButtonsInPanelElement:(id)a0 withBlock:(id /* block */)a1;
+ (id)bestGuessKeyboardDataForPanel:(id)a0;
+ (id)keyboardDataForHardwareKeyboardID:(unsigned char)a0 keyboardPhysicalType:(unsigned int)a1 allowLargeKeyboards:(char)a2;
...
- (char)_panelHasMostOfKeyCodesInSystemKeyboardPanel:(id)a0;
...
- (char)panelHasFunctionKeys:(id)a0;
