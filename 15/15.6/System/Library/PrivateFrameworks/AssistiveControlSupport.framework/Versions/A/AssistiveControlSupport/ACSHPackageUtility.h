...
+ (char)loadPackageWithFileWrapper:(id)a0 atURL:(id)a1 panelCollection:(id *)a2 resourceCollection:(id *)a3 packageInfo:(id *)a4 isSystem:(char)a5 error:(id *)a6 undoManager:(id)a7;
