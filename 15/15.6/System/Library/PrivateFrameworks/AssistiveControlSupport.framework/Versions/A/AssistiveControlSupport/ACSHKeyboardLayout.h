...
- (char)macKeyCodeIsModifiedByCapsLock:(unsigned long long)a0 modifiers:(unsigned long long)a1 deadKeyState:(unsigned int)a2;
- (id)stringFromMacKeyCode:(unsigned long long)a0 modifiers:(unsigned int)a1 deadKeyState:(unsigned int)a2 isDeadKey:(char *)a3;
- (id)stringFromUSBKeyCode:(unsigned long long)a0 modifiers:(unsigned int)a1 deadKeyState:(unsigned int)a2 isDeadKey:(char *)a3;
- (void)updateInputSource;
- (char)usbKeyCodeIsModifiedByCapsLock:(unsigned long long)a0 modifiers:(unsigned long long)a1 deadKeyState:(unsigned int)a2;
