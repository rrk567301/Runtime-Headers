...
@property (nonatomic) char showButtonLabels;
...
@property (nonatomic) char nonProportionalResizingEnabled;
...
- (void).cxx_destruct;
- (id)colorForTheme:(unsigned long long)a0 attributeColor:(unsigned long long)a1 baseColor:(id)a2 prioritizeAdjustedColor:(char)a3;
...
- (id)colorForAttributeColor:(unsigned long long)a0 baseColor:(id)a1 prioritizeAdjustedColor:(char)a2;
...
- (void)setViewingZoomNonProportionalFactor:(double)a0 horizontalNotVertical:(char)a1 forPanelUUID:(id)a2;
...
- (double)viewingZoomNonProportionalFactorForPanelUUID:(id)a0 returningHorizontalNotVertical:(char *)a1;
- (double)viewingZoomScaleForPanelUUID:(id)a0;
- (char)viewingZoomScaleIsDefaultForPanelUUID:(id)a0;
