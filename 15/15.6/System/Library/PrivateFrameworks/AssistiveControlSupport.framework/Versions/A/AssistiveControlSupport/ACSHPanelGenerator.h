...
+ (id)_fullWidthPanelForLocalizedName:(id)a0 label:(id)a1 placeholderActionType:(unsigned long long)a2 fontSize:(double)a3 height:(double)a4 panelToMergeInto:(id)a5 sizingPanel:(id)a6 forTemplate:(char)a7;
...
+ (id)hoverTextPanelForMergingIntoPanel:(id)a0 sizingPanel:(id)a1 forTemplate:(char)a2;
...
+ (char)substitutePlaceholdersForChildElement:(id)a0 ofPanelElement:(id)a1;
+ (id)suggestionsPanelForMergingIntoPanel:(id)a0 sizingPanel:(id)a1 forTemplate:(char)a2;
