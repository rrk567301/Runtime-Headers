...
- (void)_registerAssetsFromResourceCollection:(id)a0 override:(char)a1;
...
- (id)addAssetImage:(id)a0 name:(id)a1 systemImageName:(id)a2 systemImageSymbolName:(id)a3 mask:(char)a4;
...
- (id)nameForAssetWithIdentifier:(id)a0 isSystemImage:(char *)a1 isSymbolImage:(char *)a2;
- (void)overrideAssetsFromResourceCollection:(id)a0;
- (unsigned long long)propertiesForAssetWithIdentifier:(id)a0;
- (char)registerAssets:(id)a0 withDirectoryFileWrapper:(id)a1;
