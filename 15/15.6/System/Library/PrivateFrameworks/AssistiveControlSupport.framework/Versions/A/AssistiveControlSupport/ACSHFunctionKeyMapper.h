...
@property (nonatomic) char fnKeyMode;
@property (readonly, nonatomic) char fKeysShouldBeStandardFunctionKeysByDefault;
...
+ (id)_systemActionTypeByFKeyMacKeyCodeMapForDevice:(unsigned int)a0 addingDFR:(char)a1;
+ (id)_systemActionTypesByHIDCode;
+ (char)deviceIsKeyboard:(unsigned int)a0;
