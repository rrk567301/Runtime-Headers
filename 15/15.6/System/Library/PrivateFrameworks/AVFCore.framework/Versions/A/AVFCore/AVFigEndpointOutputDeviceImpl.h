...
- (id)initWithFigEndpoint:(struct OpaqueFigEndpoint { } *)a0 volumeController:(struct OpaqueFigVolumeControllerState { } *)a1 routingContextFactory:(id)a2 useRouteConfigUpdatedNotification:(char)a3;
