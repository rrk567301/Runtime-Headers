...
- (struct __CVBuffer { } *)copyPixelBufferForItemTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 remove:(char)a1 itemTimeForDisplay:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a2;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })earliestAvailablePixelBufferItemTime;
- (char)hasNewPixelBufferForItemTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
...
- (void)setSuppressesPlayerRendering:(char)a0;
- (char)setUpWithOutputSettings:(id)a0 outputSettingsArePixelBufferAttributes:(char)a1 withExceptionReason:(id *)a2;
