...
+ (char)_assetCreationOptionsPrefersSandboxedOption:(id)a0;
+ (char)_assetCreationOptionsRequiresInProcessOperation:(id)a0;
+ (id)assetProxyWithPropertyList:(id)a0;
+ (id)assetWithURL:(id)a0;
+ (id)assetWithURL:(id)a0 figPlaybackItem:(struct OpaqueFigPlaybackItem { } *)a1 trackIDs:(id)a2 dynamicBehavior:(char)a3;
