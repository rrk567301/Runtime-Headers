...
- (id)_addMutableTrackWithMediaType:(id)a0 preferredTrackID:(int)a1 fireKVO:(char)a2;
- (id)_initWithComposition:(id)a0;
- (id)_newTrackForIndex:(long long)a0;
- (void)_notifyTracksThatSegmentsDidChange:(id)a0 successfully:(char)a1;
- (void)_notifyTracksThatSegmentsWillChange:(id)a0;
- (void)_removeTrack:(id)a0 fireKVO:(char)a1;
...
- (char)insertTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 ofAsset:(id)a1 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 error:(id *)a3;
