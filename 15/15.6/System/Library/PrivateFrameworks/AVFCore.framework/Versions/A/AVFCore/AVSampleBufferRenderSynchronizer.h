...
@property (nonatomic) char delaysRateChangeUntilHasSufficientMediaData;
...
- (char)_addRenderer:(id)a0 error:(id *)a1;
- (long long)_addedAudioRendererCount;
- (long long)_addedAudioRendererCountInternal;
- (char)_canAddRendererInternal:(id)a0 error:(id *)a1;
...
- (char)_rendererConfigurationIsValid:(id *)a0;
- (char)_scheduleTimedRendererRemovalAtTime:(id)a0 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 withClientCompletionHandler:(id /* block */)a2;
...
- (char)setRate:(float)a0 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 atHostTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 error:(id *)a3;
