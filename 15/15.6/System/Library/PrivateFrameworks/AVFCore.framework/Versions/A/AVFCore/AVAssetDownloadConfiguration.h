@class NSMutableDictionary, NSString, NSArray, AVURLAsset, NSURL, NSData, AVAssetDownloadContentConfiguration;
...
@interface AVAssetDownloadConfiguration : NSObject <NSSecureCoding> {
    ...
    char optimizesAuxiliaryContentConfigurations;
...
@property (nonatomic) char optimizesAuxiliaryContentConfigurations;
@property (nonatomic) char downloadsInterstitialAssets;
...
- (void)setInterstitialMediaSelectionCriteria:(id)a0 forMediaCharacteristic:(id)a1;
