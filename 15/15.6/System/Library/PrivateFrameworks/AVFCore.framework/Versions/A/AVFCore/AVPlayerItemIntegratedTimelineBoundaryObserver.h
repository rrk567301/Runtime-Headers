...
- (char)_ensureItemTimeOffsetLiesInSegment:(id)a0 item:(id)a1;
- (char)_isItemCurrentTimeWithinZeroOffsetBoundaryThreshold:(id)a0 offset:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
