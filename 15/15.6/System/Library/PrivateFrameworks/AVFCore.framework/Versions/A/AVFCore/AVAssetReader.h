...
@property (nonatomic, getter=_readSingleSample, setter=_setReadSingleSample:) char readSingleSample;
...
- (char)startReading;
- (char)_canAddOutput:(id)a0 exceptionReason:(id *)a1;
...
- (char)preparesMediaDataForRealTimeConsumption;
- (void)setPreparesMediaDataForRealTimeConsumption:(char)a0;
