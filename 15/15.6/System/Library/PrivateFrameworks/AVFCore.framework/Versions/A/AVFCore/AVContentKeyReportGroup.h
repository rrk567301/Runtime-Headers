...
- (char)_associateRequestWithGroupWithRequestID:(unsigned long long)a0 error:(id *)a1;
- (id)_contentKeySession;
- (char)_destroyContentKeyGroupWithError:(id *)a0;
- (struct OpaqueFigContentKeySession { } *)_figContentKeySession;
...
- (char)_setAuthorizationToken:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
- (char)associateContentKeyRequest:(id)a0;
...
- (char)hasProtector;
- (id)initWithKeySystem:(id)a0 keySession:(id)a1 contentKeyBoss:(struct OpaqueFigContentKeyBoss { } *)a2 useContentKeyBoss:(char)a3 groupID:(unsigned long long)a4 storageDirectoryAtURL:(id)a5;
