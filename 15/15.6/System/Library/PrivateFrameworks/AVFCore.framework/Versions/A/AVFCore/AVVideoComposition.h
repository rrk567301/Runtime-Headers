...
- (char)_copyFigVideoCompositor:(const void **)a0 andSession:(id *)a1 recyclingSession:(id)a2 forFigRemaker:(char)a3 error:(id *)a4;
- (id)_deepCopy;
- (char)_hasLayerAsAuxiliaryTrack;
- (char)_hasPostProcessingLayers;
- (char)_isValidReturningExceptionReason:(id *)a0;
...
- (char)isValidForAsset:(id)a0 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a1 validationDelegate:(id)a2;
- (char)isValidForTracks:(id)a0 assetDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 validationDelegate:(id)a3;
