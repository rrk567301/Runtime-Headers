...
@property (nonatomic) char preferSandboxedParsing;
...
+ (char)canParseExtendedMIMEType:(id)a0;
...
- (char)_ICYIsAllowed;
- (char)_MPEG2TSIsAllowed;
- (char)_MovieFragmentStreamIsAllowed;
- (char)_WebVTTIsAllowed;
...
- (void)setShouldProvideMediaData:(char)a0 forTrackID:(int)a1;
- (char)shouldProvideMediaDataForTrackID:(int)a0;
