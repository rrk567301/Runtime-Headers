...
+ (id)_objectWithItemProviderFileURL:(id)a0 typeIdentifier:(id)a1 isInPlace:(char)a2 error:(id *)a3;
...
+ (char)isPlayableExtendedMIMEType:(id)a0;
...
+ (char)isPlayableExtendedMIMEType:(id)a0 options:(id)a1;
...
- (char)_clientURLLoadingRepresentsAccurateNetworkStatistics;
