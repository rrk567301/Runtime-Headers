...
+ (char)_colorPropertiesAreSetInVideoComposition:(id)a0;
...
- (char)_validateRequiredPixelBufferAttributesForRenderContext:(id)a0 andReturnException:(id *)a1;
- (char)_validateSourcePixelBufferAttributes:(id)a0 andReturnException:(id *)a1;
- (void)_willDeallocOrFinalize;
- (char)commitCustomVideoCompositorPropertiesAndReturnError:(id *)a0;
