...
- (char)_setHelper:(id)a0 ifCurrentHelper:(id)a1;
- (char)_setHelper:(id)a0 ifCurrentHelper:(id)a1 withBlock:(id /* block */)a2;
- (char)_supportsSampleReferencesReturningError:(id *)a0;
