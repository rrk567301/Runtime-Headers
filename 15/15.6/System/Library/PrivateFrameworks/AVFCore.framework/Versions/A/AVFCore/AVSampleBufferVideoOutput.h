...
- (void)dealloc;
- (id)init;
- (char)hasNewPixelBufferForSourceTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
- (char)_configureWithVideoQueue:(struct OpaqueFigVideoQueue { } *)a0;
