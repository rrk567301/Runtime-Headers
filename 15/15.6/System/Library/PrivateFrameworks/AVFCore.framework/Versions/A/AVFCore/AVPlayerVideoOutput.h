...
- (char)_attachToPlayer:(id)a0 exceptionReason:(id *)a1;
- (struct OpaqueCMTaggedBufferGroup { } *)_copyTaggedBufferGroupForHostTimeInternal:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 doNotConsume:(char)a1 presentationTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a2 activeConfiguration:(id *)a3 lastSeenTaggedBufferGroup:(struct OpaqueCMTaggedBufferGroup **)a4;
...
- (char)_setupWithOutputSpecification:(id)a0 exceptionReasonOut:(id *)a1;
- (id)attachedPlayer;
...
- (char)hasNewTaggedBufferGroupForHostTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
