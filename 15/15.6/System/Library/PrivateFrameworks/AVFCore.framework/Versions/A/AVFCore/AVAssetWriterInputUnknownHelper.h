...
- (char)_canAddTrackAssociationWithTrackOfInput:(id)a0 type:(id)a1 exceptionReason:(id *)a2;
- (char)_validateLanguageCode:(id)a0;
- (void)addTrackAssociationWithTrackOfInput:(id)a0 type:(id)a1;
- (char)canAddTrackAssociationWithTrackOfInput:(id)a0 type:(id)a1;
...
- (void)setExpectsMediaDataInRealTime:(char)a0;
...
- (void)setPerformsMultiPassEncodingIfSupported:(char)a0;
