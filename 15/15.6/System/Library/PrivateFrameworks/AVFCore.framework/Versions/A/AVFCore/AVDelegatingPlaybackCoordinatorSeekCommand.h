...
- (id)initWithCoordinator:(id)a0 originator:(id)a1 expectedCurrentItemIdentifier:(id)a2 commandOrderIndex:(long long)a3 itemTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a4 shouldPause:(char)a5 shouldBufferInAnticipationOfPlayback:(char)a6 anticipatedPlaybackRate:(float)a7 completionDueDate:(id)a8;
