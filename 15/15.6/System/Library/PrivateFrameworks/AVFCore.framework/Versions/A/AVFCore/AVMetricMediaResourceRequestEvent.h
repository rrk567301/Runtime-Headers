...
@property (readonly, getter=wasReadFromCache) char readFromCache;
...
- (id)initWithDate:(id)a0 mediaTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 sessionID:(id)a2 url:(id)a3 serverAddress:(id)a4 requestStartTime:(id)a5 requestEndTime:(id)a6 responseStartTime:(id)a7 responseEndTime:(id)a8 byteRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a9 readFromCache:(char)a10 errorEvent:(id)a11 networkTransactionMetrics:(id)a12;
