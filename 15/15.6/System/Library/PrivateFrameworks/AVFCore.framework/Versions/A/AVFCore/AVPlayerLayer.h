...
- (void)setForScrubbingOnly:(char)a0;
...
- (void)_applyCurrentItemPresentationSizeChangeAndForceUpdate:(char)a0;
...
- (void)_handleIsDisplayingClosedCaptionsDidChange:(char)a0 player:(id)a1;
- (void)_handleNonForcedSubtitleDisplayDidChange:(char)a0 player:(id)a1;
...
- (void)_setPlayer:(id)a0 forPIP:(char)a1;
- (void)_setPreventsChangesToSublayerHierarchy:(char)a0;
- (void)_setShowInterstitialInstead:(char)a0;
- (void)_setShowInterstitialInstead:(char)a0 afterDelay:(double)a1;
- (void)_setSublayersForPIP:(id)a0;
- (void)_setSublayersPreventChangesToSublayerHierarchy:(char)a0;
- (void)_setWillManageSublayersAsSwappedLayers:(char)a0;
