...
- (id)_common_init;
- (struct OpaqueFigAsset { } *)_createDuplicateFigAssetFromAVAsset:(id)a0 options:(id)a1;
...
- (int)_setFileFigAsset:(struct OpaqueFigAsset { } *)a0 options:(id)a1;
...
- (char)ensureProgressTimerIsRunningOnQueueWithError:(id *)a0;
