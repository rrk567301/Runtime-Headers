...
- (long long)status;
- (void)flush;
- (char)checkConfigurationToOutputSegmentDataReturningDebugDescription:(id *)a0;
...
- (char)areAllInputsPreferredMediaChunkAlignmentEqualTo:(long long)a0;
- (void)cancelWriting;
- (char)checkAVAssetWriterInputConfigurationToOutputSegmentDataForFragmentedMPEG4FileTypeProfile:(id)a0 preferredOutputSegmentInterval:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 returningDebugDescription:(id *)a2;
