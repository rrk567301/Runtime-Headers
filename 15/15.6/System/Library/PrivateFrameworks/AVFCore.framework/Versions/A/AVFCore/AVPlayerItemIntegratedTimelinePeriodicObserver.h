...
- (void)dealloc;
- (void).cxx_destruct;
- (char)_doesTimeResideInItemIntegratedTimelineOffsets:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 withOffsets:(id)a1 timeMappingOut:(struct { struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } x0; struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } x1; } *)a2;
...
- (char)hasObserverBeenScheduledYet;
