...
@property (readonly, getter=_markAsFinishedCalled) char markAsFinishedCalled;
...
- (char)_appendPixelBuffer:(struct __CVBuffer { } *)a0 withPresentationTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
- (long long)_appendSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 error:(id *)a1;
- (char)_appendTaggedPixelBufferGroup:(struct OpaqueCMTaggedBufferGroup { } *)a0 withPresentationTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
- (id)_attachedAdaptor;
- (void)_didStartInitialSession;
- (char)_prepareForWritingWithFigAssetWriter:(struct OpaqueFigAssetWriter { } *)a0 mediaFileType:(id)a1 error:(id *)a2;
- (void)_prepareToEndSession;
- (char)_prepareToFinishWritingReturningError:(id *)a0;
...
- (char)appendSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
...
- (void)setWritesMediaDataToBeginningOfFile:(char)a0;
