...
@property (nonatomic) char existingAccount;
@property (nonatomic) char ignoreLockAssertErrors;
...
@property (nonatomic) char shouldAutomaticallySaveSignInResults;
...
- (void)_backgroundSaveAccount:(id)a0 withDataclassEnablement:(char)a1 completion:(id /* block */)a2;
...
- (char)_isDuplicateAccountError:(long long)a0;
- (void)_loginAndUpdateiCloudWithAuthResults:(id)a0 iCloudAccount:(id)a1 withCompletion:(id /* block */)a2;
- (id)_nameForCloudService;
- (char)_newSignInReauth;
...
- (void)_onqueue_delegate_saveAccount:(id)a0 withDataclassEnablement:(char)a1 completion:(id /* block */)a2;
...
- (void)_onqueue_saveAccount:(id)a0 withAuthResults:(id)a1 withCDPEnablement:(char)a2 withAllDataclassesEnabledIfPossibleWithCompletion:(id /* block */)a3;
- (void)_onqueue_saveAccount:(id)a0 withDataclassEnablement:(char)a1 completion:(id /* block */)a2;
...
- (void)_onqueue_verifyLoginResponseForiCloudAccount:(id)a0 withAuthResults:(id)a1 withSuccess:(char)a2 error:(id)a3 completion:(id /* block */)a4;
- (void)_preflightSaveWithAuthResults:(id)a0 account:(id)a1 withCompletion:(id /* block */)a2;
- (void)_registerAndVerifyLoginForiCloudAccount:(id)a0 authResults:(id)a1 withCompletion:(id /* block */)a2;
- (void)_saveAccount:(id)a0 withAuthResults:(id)a1 withCDPEnablement:(char)a2 withAllDataclassesEnabledIfPossibleWithCompletion:(id /* block */)a3;
- (char)_shouldEnableDataclassesForAccount:(id)a0;
- (char)_shouldStashLoginResponse;
- (void)_stashLoginResponseWithAuthenticationResults:(id)a0 appleAccount:(id)a1;
- (char)_termsAreRequired;
...
- (void)_verifyLoginResponseForiCloudAccount:(id)a0 withAuthResults:(id)a1 withSuccess:(char)a2 error:(id)a3 completion:(id /* block */)a4;
