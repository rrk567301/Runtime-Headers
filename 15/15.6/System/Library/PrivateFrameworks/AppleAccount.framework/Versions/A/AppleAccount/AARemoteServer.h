...
- (id)_initRequiringUrlCache:(char)a0;
...
- (void)_startRequest:(id)a0 responseClass:(Class)a1 mainThread:(char)a2 completion:(id /* block */)a3;
- (void)loginDelegates:(id)a0 parameters:(id)a1 completion:(id /* block */)a2;
- (void)registerAccount:(id)a0 withHSA:(char)a1 completion:(id /* block */)a2;
