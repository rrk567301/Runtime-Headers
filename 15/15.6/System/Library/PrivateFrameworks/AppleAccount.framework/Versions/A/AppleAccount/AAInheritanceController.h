...
- (void)removeAccessCodeForContactInfo:(id)a0 completion:(id /* block */)a1;
...
- (void)respondToInvitation:(id)a0 accepted:(char)a1 completion:(id /* block */)a2;
...
- (void)updateAccessCodeForContactInfo:(id)a0 completion:(id /* block */)a1;
