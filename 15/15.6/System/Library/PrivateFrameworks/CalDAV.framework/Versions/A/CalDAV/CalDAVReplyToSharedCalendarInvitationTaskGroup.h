...
@property (nonatomic) char acceptInvitation;
...
- (id)initWithInvitation:(id)a0 acceptInvitation:(char)a1 atCalendarHomeURL:(id)a2 accountInfoProvider:(id)a3 taskManager:(id)a4;
- (void)startTaskGroup;
