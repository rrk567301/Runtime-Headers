...
@property (nonatomic) char attendeesCanManageDropBox;
...
+ (id)dropboxACEItemsForPrincipalURLs:(id)a0 baseURL:(id)a1 writable:(char)a2;
...
- (id)initWithAccountInfoProvider:(id)a0 dropboxURL:(id)a1 attachments:(id)a2 contentTypes:(id)a3 attendeePrincipalURLs:(id)a4 attendeesCanManageDropBox:(char)a5 taskManager:(id)a6;
- (void)startTaskGroup;
