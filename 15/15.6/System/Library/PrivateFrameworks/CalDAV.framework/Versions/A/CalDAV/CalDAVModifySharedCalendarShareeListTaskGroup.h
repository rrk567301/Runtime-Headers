...
@property char muteNotifications;
...
- (id)initWithShareesToSet:(id)a0 shareesToRemove:(id)a1 muteNotifications:(char)a2 summary:(id)a3 atCalendarURL:(id)a4 accountInfoProvider:(id)a5 taskManager:(id)a6;
- (void)startTaskGroup;
