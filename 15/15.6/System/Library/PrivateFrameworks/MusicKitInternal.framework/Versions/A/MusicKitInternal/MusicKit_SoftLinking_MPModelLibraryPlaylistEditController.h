...
@property (nonatomic) char addInsertedTracksToLibrary;
...
@property (readonly, nonatomic, getter=isUndoAvailable) char undoAvailable;
@property (readonly, nonatomic, getter=isRedoAvailable) char redoAvailable;
