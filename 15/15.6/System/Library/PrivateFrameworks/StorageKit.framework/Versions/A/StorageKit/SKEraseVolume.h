...
@property (nonatomic) char forceUnmount;
...
+ (id)eraseVolumeWithAPFSContainerDisk:(id)a0 descriptor:(id)a1 error:(id *)a2;
+ (id)eraseVolumeWithAPFSStoreDisk:(id)a0 descriptor:(id)a1 error:(id *)a2;
