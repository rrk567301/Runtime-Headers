...
- (char)retrieveDIInfoWithParams:(id)a0 error:(id *)a1;
- (unsigned long long)diResize:(id)a0 error:(id *)a1;
- (char)attachBeforeResizeWithStdinPass:(char)a0 error:(id *)a1;
...
- (char)resizeWithParams:(id)a0 progress:(id)a1 error:(id *)a2;
