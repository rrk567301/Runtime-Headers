...
+ (char)isMountPointWithPath:(id)a0;
+ (id)sharedManagerWithBindingsSafety:(char)a0;
...
- (char)compositeDisks:(id)a0 volumeName:(id)a1 progressBlock:(id /* block */)a2 callbackBlock:(id /* block */)a3;
...
- (id)filesystemWithSKType:(id)a0 isCaseSensitive:(char)a1 isEncrypted:(char)a2;
- (id)formatableFileSystems;
- (id)initWithBindingSafety:(char)a0;
...
- (id)knownDiskForDictionary:(id)a0 waitingForDaemon:(char)a1;
- (id)knownDiskForDictionary:(id)a0 waitingForDaemon:(char)a1 fromSet:(id)a2;
- (id)knownDisksForDictionaries:(id)a0;
- (id)knownDisksForDictionaries:(id)a0 waitingForDaemon:(char)a1;
- (id)knownDisksForDictionaries:(id)a0 waitingForDaemon:(char)a1 fromSet:(id)a2;
