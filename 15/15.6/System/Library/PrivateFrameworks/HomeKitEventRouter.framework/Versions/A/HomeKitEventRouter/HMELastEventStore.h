...
- (id)initWithFileName:(id)a0 useWal:(char)a1;
- (void)resetBeforeReferenceTimestamp:(double)a0;
- (void)resetTopic:(id)a0;
- (char)writer:(id)a0 saveEventIfAllowed:(id)a1 topic:(id)a2;
- (char)writer:(id)a0 saveEventIfDifferent:(id)a1 topic:(id)a2;
