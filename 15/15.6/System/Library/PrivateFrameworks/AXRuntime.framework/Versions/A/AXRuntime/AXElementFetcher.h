...
@property (nonatomic, getter=isFetchingElements) char fetchingElements;
@property (retain, nonatomic) NSArray *currentApps;
@property (nonatomic, getter=isEventManagementEnabled) char eventManagementEnabled;
...
@property (nonatomic) char shouldIncludeNonScannerElements;
@property (nonatomic, getter=isGroupingEnabled) char groupingEnabled;
...
- (char)_fetchEventCanBeManaged:(unsigned long long)a0;
- (void)_fetchEventOccurred:(unsigned long long)a0;
- (char)_fetchGroups:(char)a0;
...
- (id)_findElementsMatchingBlock:(id /* block */)a0 internalRequest:(char)a1;
...
- (void)_notifyObserversDidFetchElementsForEvent:(unsigned long long)a0 foundNewElements:(char)a1;
...
- (void)_sendFakeScreenChangeIfNecessaryForGroups:(id)a0 orElements:(id)a1 appsDidChange:(char)a2;
- (void)_setCurrentApplications:(id)a0;
- (char)_shouldConsiderCacheAsInvalid;
- (id)_siblingOfGroupable:(id)a0 forDirection:(char)a1 didWrap:(char *)a2;
...
- (id)initWithDelegate:(id)a0 fetchEvents:(unsigned long long)a1 enableEventManagement:(char)a2 enableGrouping:(char)a3 shouldIncludeNonScannerElements:(char)a4 beginEnabled:(char)a5;
- (id)nextSiblingOfElement:(id)a0 didWrap:(char *)a1;
- (id)previousSiblingOfElement:(id)a0 didWrap:(char *)a1;
- (id)previousSiblingOfGroupable:(id)a0 didWrap:(char *)a1;
