...
- (void)_createCache:(char)a0;
- (id)_elementsWithParameter:(long long)a0 parameters:(id)a1 prefetchAttributes:(char)a2;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_lineRangeWithFaultTolerance:(long long)a0 forward:(char)a1;
