...
- (id)_flattenHierarchyForGroup:(id)a0 rootLevel:(char)a1;
- (char)_frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isApproximatelySameSizeAsFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (id)_groupRemovingImpossibleGroups:(id)a0 isRootLevel:(char)a1;
