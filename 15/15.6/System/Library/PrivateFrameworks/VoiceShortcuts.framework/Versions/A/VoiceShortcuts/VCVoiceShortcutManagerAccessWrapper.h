...
- (void)drawGlyphs:(id)a0 withBackgroundColorValues:(id)a1 padding:(double)a2 rounded:(char)a3 intoContext:(id)a4 completion:(id /* block */)a5;
...
- (void)describeSyncStateIncludingDeleted:(char)a0 completion:(id /* block */)a1;
...
- (char)isLNActionExecutionAllowedInDropletWithBundleIdentifier:(id)a0 actionIdentifier:(id)a1;
...
- (void)setTrustedToRunScripts:(char)a0 forReference:(id)a1 onDomain:(id)a2 completion:(id /* block */)a3;
