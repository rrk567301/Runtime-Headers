...
+ (char)shouldRunTrigger:(id)a0 forEvent:(id)a1 runEvents:(id)a2 error:(id *)a3;
...
- (char)deleteTriggerEvent:(id)a0 error:(id *)a1;
- (void)didFinishRunningWithError:(id)a0 cancelled:(char)a1 trigger:(id)a2 runEvent:(id)a3;
- (void)enqueueTriggerWithIdentifier:(id)a0 eventInfo:(id)a1 force:(char)a2 completion:(id /* block */)a3;
...
- (char)isTriggerEventStale:(id)a0;
...
- (unsigned long long)numberOfEventsInQueueWithConfirmationOnly:(char)a0;
...
- (char)shouldRunEmailOrMessageTrigger:(id)a0 forEvent:(id)a1 runEvents:(id)a2 error:(id *)a3;
- (id)triggerEventForConfiguredTrigger:(id)a0 eventInfo:(id)a1 confirmed:(char)a2 error:(id *)a3;
