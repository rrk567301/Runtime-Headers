...
- (void)setSiriAutoShortcutsEnablement:(char)a0 forBundleIdentifier:(id)a1 completion:(id /* block */)a2;
...
- (void)drawGlyphs:(id)a0 withBackgroundColorValues:(id)a1 padding:(double)a2 rounded:(char)a3 intoContext:(id)a4;
...
- (char)isPhraseUsable:(id)a0 inDatabase:(id)a1 error:(id *)a2;
- (void)logHomescreenFastPathRunEventForShortcutWithWebClip:(id)a0;
- (char)phraseHasHomeKitConflict:(id)a0;
