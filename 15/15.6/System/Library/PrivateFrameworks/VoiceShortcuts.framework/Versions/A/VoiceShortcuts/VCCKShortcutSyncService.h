...
- (void)handleNameConflictsForFetchedWorkflowRecord:(id)a0 identifier:(id)a1 shouldMarkFetchedRecordAsTombstone:(char *)a2;
...
- (id)initWithContainer:(id)a0 database:(id)a1 applicationObserver:(id)a2 automaticSyncEnabled:(char)a3 logger:(id)a4;
- (id)libraryRecordForRecordID:(id)a0;
- (char)mergeLocalOrderingChangesWithRemoteOrderingChangesFromOrderingRecord:(id)a0;
