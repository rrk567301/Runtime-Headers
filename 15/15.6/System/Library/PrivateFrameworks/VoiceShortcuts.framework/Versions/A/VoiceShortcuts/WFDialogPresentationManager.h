...
@property (nonatomic) char completePersistentModeAwaitingRemoteAlertReactivationSuccess;
...
- (void)dismissPersistentChromeInDialog:(id)a0 success:(char)a1 customAttribution:(id)a2 completionHandler:(id /* block */)a3;
