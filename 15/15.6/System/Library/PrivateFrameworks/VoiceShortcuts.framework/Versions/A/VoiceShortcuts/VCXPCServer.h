@class VCCKShortcutSyncCoordinator, NSXPCInterface, SwiftVCDaemonXPCEventHandler, WFTopHitsAppShortcutsUpdater, NSXPCListenerEndpoint, NSString, WFWorkflowRunCoordinator, WFContextualActionSpotlightSyncService, WFTriggerManager, WFTriggerRegistrar, NSXPCListener, VCVoiceShortcutManager;
...
@property (readonly, nonatomic) char skipEntitlementsCheck;
