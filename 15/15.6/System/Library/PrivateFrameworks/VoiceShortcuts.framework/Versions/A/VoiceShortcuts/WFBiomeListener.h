...
- (void)fireTriggerWithIdentifier:(id)a0 force:(char)a1 eventInfo:(id)a2 completion:(id /* block */)a3;
- (id)initWithEventQueue:(id)a0;
- (char)isTransactionEventDuplicate:(id)a0 forTrigger:(id)a1 withSeenTransactionIdentifiers:(id)a2;
- (void)queue_fireTriggerWithIdentifier:(id)a0 force:(char)a1 eventInfo:(id)a2 completion:(id /* block */)a3;
