...
+ (void)_fillIdentifiersToRemove:(id *)a0 referencesToIndex:(id *)a1 withMaximumUpdatedItems:(long long)a2 references:(id)a3 localState:(id)a4;

- (id)init;
- (void).cxx_destruct;
- (void)start;
- (void)cleanupAndExitWithRequestToRelaunch:(char)a0;
...
- (id)initWithReferences:(id)a0 forceFullResync:(char)a1 spotlightIndex:(id)a2 localState:(id)a3 transaction:(id)a4;
- (void)saveLocalState;
