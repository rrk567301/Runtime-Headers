...
@property (nonatomic) char hostAddressIsIPv6;
...
- (char)isValidIPv4PingResponsePacket:(id)a0 isForMe:(char *)a1 sequence:(unsigned short *)a2 isBadPacket:(char *)a3;
- (char)isValidIPv6PingResponsePacket:(id)a0 isForMe:(char *)a1 sequence:(unsigned short *)a2 isBadPacket:(char *)a3;
...
- (void)startICMPPingTestTo:(id)a0 hostName:(id)a1 interface:(unsigned int)a2 pingCount:(long long)a3 interPingInterval:(double)a4 burstCount:(long long)a5 interBurstInterval:(double)a6 timeout:(double)a7 stopTestOnFirstSuccess:(char)a8;
- (void)startPing:(id)a0 hostName:(id)a1 interface:(unsigned int)a2 pingCount:(long long)a3 interPingInterval:(double)a4 burstCount:(long long)a5 interBurstInterval:(double)a6 timeout:(double)a7 stopTestOnFirstSuccess:(char)a8 withCompletion:(id /* block */)a9;
- (char)startRunLoop;
