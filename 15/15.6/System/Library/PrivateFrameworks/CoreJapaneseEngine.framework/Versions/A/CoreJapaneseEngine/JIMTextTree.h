...
@property char noRebuild;
@property char generatedByKanaTyping;
@property char hasCompleteChars;
@property char hasIncompleteChars;
@property char hasIncompleteEnd;
...
- (long long)_insertRomajiArrayToArray:(id)a0 atIndex:(long long)a1 fromString:(id)a2 transliteration:(unsigned long long)a3 completeFlag:(char)a4;
- (void)_rebuildSurfaceTextArray:(char)a0;
