...
+ (id)assetFromPath:(id)a0 withIdentifier:(id)a1 createIfAbsent:(char)a2;
...
- (id)fullPath;
- (id)consumedDate;
- (struct { unsigned int x0; double x1; double x2; double x3; double x4; double x5; int x6; char x7; long long x8; long long x9; long long x10; long long x11; long long x12; char x13[0]; } *)createFlattenedAsset:(long long *)a0;
- (id)downloadCompletionDate;
- (id)downloadStartDate;
- (id)initWithFlattenedAsset:(struct { unsigned int x0; double x1; double x2; double x3; double x4; double x5; int x6; char x7; long long x8; long long x9; long long x10; long long x11; long long x12; char x13[0]; } *)a0;
