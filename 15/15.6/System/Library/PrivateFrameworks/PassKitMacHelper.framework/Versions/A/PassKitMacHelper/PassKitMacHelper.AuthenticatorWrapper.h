@interface PassKitMacHelper.AuthenticatorWrapper : NSObject <PKAuthenticatorDelegate, AKSignInViewControllerDelegate> {
...
- (char)signInViewController:(id)a0 shouldContinueWithAuthenticationResults:(id)a1 error:(id)a2 forContext:(id)a3;
