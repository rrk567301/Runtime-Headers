@interface PassKitMacHelper.PaymentAuthorizationServiceDelegate : NSObject <PKPaymentAuthorizationServiceProtocol> {
...
- (void)handleHostApplicationWillResignActive:(char)a0;
