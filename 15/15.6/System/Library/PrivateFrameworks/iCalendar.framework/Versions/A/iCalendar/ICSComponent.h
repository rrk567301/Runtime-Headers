@class ICSTrigger, NSString, NSArray, NSURL, NSSet, NSMutableDictionary, ICSDate, ICSDuration, NSMutableArray, ICSStructuredLocation, ICSUserAddress;
...
@property char x_apple_suggestionInfoChangesAcknowledged;
