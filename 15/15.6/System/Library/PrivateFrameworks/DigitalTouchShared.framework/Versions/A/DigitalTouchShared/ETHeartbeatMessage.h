...
@property (readonly, nonatomic, getter=isBroken) char broken;
...
- (void)_displayInScene:(id)a0 useDuration:(char)a1;
- (void)_displayInScene:(id)a0 useDuration:(char)a1 fastStart:(char)a2;
...
- (void)startHeartbeat:(id)a0 fastStart:(char)a1;
