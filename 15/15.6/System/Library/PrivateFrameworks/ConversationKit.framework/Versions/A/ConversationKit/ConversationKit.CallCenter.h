...
- (void)conversationManager:(id)a0 remoteScreenShareAttributesChanged:(id)a1 isLocallySharing:(char)a2;
...
- (void)conversationManager:(id)a0 screenSharingAvailableChanged:(char)a1;
