...
- (id)init;
- (void).cxx_destruct;
- (void)captionsClient:(id)a0 didDetectGibberish:(char)a1;
- (void)captionsClient:(id)a0 didDisableCaptions:(char)a1 error:(id)a2;
- (void)captionsClient:(id)a0 didEnableCaptions:(char)a1 error:(id)a2;
