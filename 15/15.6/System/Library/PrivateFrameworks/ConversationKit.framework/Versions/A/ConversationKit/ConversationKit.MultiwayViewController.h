...
@property (nonatomic, readonly) char shouldShowTranscriptDrawer;
...
@property (nonatomic, readonly) char isShowingReactions;
...
@property (nonatomic, readonly) char wantsApplicationDismissalStyle;
@property (nonatomic) void /* unknown type, empty encoding */ deviceOrientation;
@property (nonatomic, readonly) char wantsPIPRotationForLocalPreview;
...
@property (nonatomic, readonly) char isInVideoMessageFlow;
@property (nonatomic, readonly) char isShowingHUD;
...
@property (nonatomic, readonly) char isShownAboveCoverSheet;
...
@property (nonatomic) char isCaptioningEnabled;
@property (nonatomic, readonly) char isPipped;
...
@property (nonatomic, readonly) char isOneToOneModeEnabled;
@property (nonatomic, readonly) char shouldDisconnectOnDismissal;
...
- (id)audioRouteMenu;
- (char)axShouldDisableAutoHidingControls;
...
- (void)toggleVideoMuteWithShouldPauseIfStopped:(char)a0;
