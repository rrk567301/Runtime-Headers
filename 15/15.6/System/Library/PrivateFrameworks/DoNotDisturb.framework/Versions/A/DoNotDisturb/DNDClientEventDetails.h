...
@property (readonly) char notifyAnyway;
...
@property (readonly) char shouldAlwaysInterrupt;
...
- (id)_initWithIdentifier:(id)a0 bundleIdentifier:(id)a1 platform:(unsigned long long)a2 type:(unsigned long long)a3 urgency:(unsigned long long)a4 sender:(id)a5 threadIdentifier:(id)a6 filterCriteria:(id)a7 notifyAnyway:(char)a8 behavior:(unsigned long long)a9 forwardingBehavior:(id)a10 title:(id)a11 subtitle:(id)a12 body:(id)a13;
- (char)shouldAlwaysInterrupt;
