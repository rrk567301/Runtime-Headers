...
- (char)_queue_registerForSettingsUpdatesIfRequired;
- (char)addSettingsUpdateListener:(id)a0 error:(id *)a1;
...
- (char)removeSettingsUpdateListener:(id)a0 error:(id *)a1;
- (char)setBehaviorSettings:(id)a0 error:(id *)a1;
- (char)setBehaviorSettings:(id)a0 returningError:(id *)a1;
- (char)setConfiguration:(id)a0 forModeIdentifier:(id)a1 error:(id *)a2;
- (char)setPhoneCallBypassSettings:(id)a0 error:(id *)a1;
- (char)setPhoneCallBypassSettings:(id)a0 returningError:(id *)a1;
- (char)setScheduleSettings:(id)a0 error:(id *)a1;
- (char)setScheduleSettings:(id)a0 returningError:(id *)a1;
