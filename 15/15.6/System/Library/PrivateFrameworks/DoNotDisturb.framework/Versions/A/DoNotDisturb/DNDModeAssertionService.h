...
- (char)addAssertionUpdateListener:(id)a0 error:(id *)a1;
...
- (char)invalidateAllActiveModeAssertionsWithError:(id *)a0;
...
- (char)removeAssertionUpdateListener:(id)a0 error:(id *)a1;
