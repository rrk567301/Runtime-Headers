...
@property (readonly, getter=isSupportedConfiguration) char supportedConfiguration;
...
- (char)_containsSecureTriggers:(id)a0;
...
- (id)initWithMode:(id)a0 configuration:(id)a1 triggers:(id)a2 impactsAvailability:(unsigned long long)a3 dimsLockScreen:(unsigned long long)a4 created:(id)a5 lastModified:(id)a6 automaticallyGenerated:(char)a7 compatibilityVersion:(long long)a8 lastModifiedByVersion:(struct { long long x0; long long x1; long long x2; })a9 lastModifiedByDeviceID:(id)a10;
