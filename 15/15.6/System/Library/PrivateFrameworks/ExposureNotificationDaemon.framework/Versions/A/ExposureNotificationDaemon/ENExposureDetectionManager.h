...
@property (nonatomic) char enableNativeExposureDetection;
@property (nonatomic) char scheduleDetectionAutomatically;
...
- (id)createScheduler;
- (char)_applyRegionalConfigurationToDetectionSession:(id)a0 delegate:(id)a1 error:(id *)a2;
...
- (char)_scheduleNativeExposureDetection;
- (void)_scheduleNativeExposureDetectionForced:(char)a0;
...
- (void)scheduleNativeExposureDetectionForced:(char)a0;
