...
- (id)initWithRPI:(id)a0 encryptedAEM:(id)a1 timestamp:(double)a2 scanInterval:(unsigned short)a3 typicalRSSI:(char)a4 maxRSSI:(char)a5 saturated:(char)a6 counter:(unsigned char)a7;
