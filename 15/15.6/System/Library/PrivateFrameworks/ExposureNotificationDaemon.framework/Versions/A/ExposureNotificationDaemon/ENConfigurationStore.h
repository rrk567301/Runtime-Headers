...
@property (nonatomic) char developerServerConfiguration;
...
- (char)_saveRegionConfiguration:(id)a0 error:(id *)a1;
...
- (char)_removeSubdivisionListForRegion:(id)a0 error:(id *)a1;
- (char)_saveCountrySubdivisionList:(id)a0 country:(id)a1 error:(id *)a2;
- (char)_saveRegionHash:(id)a0 region:(id)a1 error:(id *)a2;
- (char)_saveServerConfigurationResponse:(id)a0 error:(id *)a1;
...
- (char)regionSupportsSubdivisions:(id)a0;
- (char)removeConfigurationsForRegion:(id)a0 includingSubdivisions:(char)a1 error:(id *)a2;
- (char)removeConfigurationsForRegionCode:(id)a0 error:(id *)a1;
- (char)removeSubdivisionListForRegion:(id)a0 error:(id *)a1;
- (void)resetStore;
- (char)saveCountrySubdivisionList:(id)a0 region:(id)a1 error:(id *)a2;
- (char)saveRegionConfiguration:(id)a0 error:(id *)a1;
- (char)saveRegionHash:(id)a0 region:(id)a1 error:(id *)a2;
- (char)saveServerConfigurationResponse:(id)a0 error:(id *)a1;
- (char)saveTemporaryCountrySubdivisionList:(id)a0 region:(id)a1 error:(id *)a2;
- (char)saveTemporaryServerConfigurations:(id)a0 error:(id *)a1;
