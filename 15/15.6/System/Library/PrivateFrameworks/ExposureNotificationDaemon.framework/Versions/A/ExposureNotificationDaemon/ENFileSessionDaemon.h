...
- (char)_resetAndAdvanceArchive:(id)a0 toPathWithExtension:(id)a1 error:(id *)a2;
- (char)activateWithArchiveFD:(int)a0 error:(id *)a1;
- (char)activateWithFileFD:(int)a0 signatureData:(id)a1 error:(id *)a2;
