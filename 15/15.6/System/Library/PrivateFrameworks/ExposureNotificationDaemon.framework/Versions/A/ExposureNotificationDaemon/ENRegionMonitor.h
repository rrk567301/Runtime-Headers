...
@property (nonatomic) char monitoringEnabled;
...
- (char)purgeAllRegionHistoryWithError:(id *)a0;
...
- (char)_purgeAllRegionHistoryWithError:(id *)a0;
- (char)_purgeRegionsOlderThanDate:(id)a0 error:(id *)a1;
...
- (char)purgeRegionsOlderThanDate:(id)a0 error:(id *)a1;
