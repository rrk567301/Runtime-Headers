...
+ (char)checkValidNonce:(id)a0 size:(unsigned long long)a1;
...
- (id)_createSessionWithVerificationCode:(id)a0 proxyEnabled:(char)a1 region:(id)a2 maxRetryTime:(unsigned long long)a3 error:(id *)a4;
- (id)_createURLSessionWithSecondaryIdentifier:(char)a0;
- (void)_deactivateAutomatedChaffing;
- (id)_existingSessionForVerificationCode:(id)a0 region:(id)a1;
- (void)_finishSessionWithUUID:(id)a0 userDidConsent:(char)a1 metadata:(id)a2 completionHandler:(id /* block */)a3;
- (char)_getRevisionToken:(id *)a0 forSession:(id)a1 error:(id *)a2;
- (id)_getTemporaryExposureKeysForUpload:(char)a0 requireConsentForRegion:(id)a1 error:(id *)a2;
...
- (char)_setRevisionToken:(id)a0 forSession:(id)a1 error:(id *)a2;
...
- (void)_startTestVerficationSessionWithCode:(id)a0 proxyEnabled:(char)a1 region:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)finishSessionWithUUID:(id)a0 userDidConsent:(char)a1 metadata:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)startTestVerficationSessionWithCode:(id)a0 proxyEnabled:(char)a1 region:(id)a2 completionHandler:(id /* block */)a3;
