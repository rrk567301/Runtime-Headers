...
@property (nonatomic) char hasPresenceAssertion;
@property (nonatomic) char hasTransientSubscription;
...
@property (readonly, nonatomic) char isPersonal;
...
- (char)_isHandleInvited:(id)a0 fromSenderHandle:(id)a1;
...
- (id)initWithPresenceIdentifier:(id)a0 isPersonal:(char)a1;
...
- (char)isHandleInvited:(id)a0 fromSenderHandle:(id)a1;
- (char)isHandleInvitedFromPrimaryAccountHandle:(id)a0;
