...
- (id)_hexDump:(id)a0 offset:(int)a1 indicator:(char)a2;
- (id)formatArm32ThreadState:(id)a0 index:(int)a1;
- (id)formatArm64ThreadState:(id)a0 index:(int)a1;
- (id)formatCallstacks:(id)a0 withImages:(id)a1 macosStyle:(char)a2;
- (id)formatFrame:(id)a0 withImages:(id)a1 macosStyle:(char)a2;
- (id)formatImages:(id)a0 macosStyle:(char)a1;
...
- (char)prepareTemplate:(id)a0 forLogType:(id)a1 error:(id *)a2;
- (char)transformJSON:(id)a0 header:(id)a1 error:(id *)a2 streamingBlock:(id /* block */)a3;
- (char)transformLines:(id)a0 withDefinitions:(id)a1 body:(id)a2 header:(id)a3 error:(id *)a4 streamingBlock:(id /* block */)a5;
