...
+ (void)purgeLogs:(id)a0 withReason:(const char *)a1 includeRetired:(char)a2 deleteOnRetire:(char)a3 usingPredicate:(id /* block */)a4;
+ (char)randomlySelectForRetention:(id)a0;
...
- (char)isReasonableSize:(long long)a0 forRouting:(id)a1;
