...
@property (readonly) char factoryDevice;
@property (readonly) char carrierInstall;
@property (readonly) char multiUserMode;
@property (readonly) char submissionsDisabled;
...
- (char)isAllowed:(id)a0 forDomain:(id)a1;
- (char)isComputeController;
- (char)isComputeNode;
- (char)isConfigEnabled:(id)a0;
- (char)isWhitelisted:(id)a0 forDomain:(id)a1;
...
- (id)seedGroup;
- (char)setPrefsKey:(id)a0 value:(id)a1 forDomain:(id)a2 withSync:(char)a3;
