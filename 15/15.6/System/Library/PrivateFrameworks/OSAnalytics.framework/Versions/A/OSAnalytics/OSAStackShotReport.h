...
@property (nonatomic) char includeSyslog;
...
- (void)useStackshotBuffer:(const void *)a0 size:(unsigned int)a1 frontmostPids:(id)a2 atTime:(double)a3 machTime:(unsigned long long)a4 sequence:(unsigned int)a5 isSnapshotDead:(char)a6;
