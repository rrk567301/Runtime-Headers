...
@property (readonly, nonatomic, getter=isInitializing) char initializing;
...
- (char)_attemptToChangeStatusTo:(unsigned long long)a0;
- (char)_ensureDataBuffer:(id)a0 toCapacity:(unsigned long long)a1;
...
- (char)_setWaveformSample:(float)a0 atIndex:(unsigned long long)a1 outError:(id *)a2;
- (char)_shouldContinueLoading;
- (char)_statusIsMutableToStatus:(unsigned long long)a0;
