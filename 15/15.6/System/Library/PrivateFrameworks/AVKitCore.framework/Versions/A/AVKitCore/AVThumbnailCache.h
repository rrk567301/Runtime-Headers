...
- (id)init;
- (void).cxx_destruct;
- (char)_ensureDirectoryExistsAtPath:(id)a0;
- (id)_cacheDirectoryPath;
- (id)_randomDataOfLength:(unsigned long long)a0;
- (unsigned long long)_directorySize:(id)a0;
- (char)_cleanUpCacheDirectoryExcludingAssetCachesDirectoryPath:(id)a0;
...
- (char)_saveThumbnail:(id)a0 inDirectory:(id)a1 encryptionKey:(id)a2;
- (char)_storeDateInExtendedFileAttributeOfFileAtPath:(id)a0 date:(id)a1;
- (char)_storeExtendedFileAttributeOfFileAtPath:(id)a0 data:(id)a1 attributeName:(id)a2;
- (char)_storeUUIDInExtendedFileAttribute:(id)a0 filePath:(id)a1 UUID:(id)a2;
- (char)cacheThumbnail:(id)a0 assetURL:(id)a1;
