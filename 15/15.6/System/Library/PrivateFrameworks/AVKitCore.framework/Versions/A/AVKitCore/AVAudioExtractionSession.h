...
@property (readonly) char requiresAllSamples;
@property (readonly) unsigned long long status;
@property (readonly) NSError *error;

+ (id)extractionSessionForTrack:(id)a0 preferredChunkCount:(unsigned long long)a1 requiresAllSamples:(char)a2;
+ (id)extractionSessionForTrack:(id)a0 requiresAllSamples:(char)a1;
+ (id)extractionSessionForTrack:(id)a0 samplesPerChunk:(unsigned long long)a1 requiresAllSamples:(char)a2;
...
- (void)cancel;
- (void)_startSession;
- (char)_processSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
...
- (char)_copyAudioBufferListForSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 audioBufferList:(struct AudioBufferList **)a1 backingBuffer:(struct OpaqueCMBlockBuffer **)a2;
- (char)_ensureExtractionSampleRateMatchesSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
- (void)_extract;
...
- (char)_verifySampleBufferCompatibility:(struct opaqueCMSampleBuffer { } *)a0;
- (id)initWithTrack:(id)a0 preferredChunkCount:(unsigned long long)a1 requiresAllSamples:(char)a2;
- (id)initWithTrack:(id)a0 requiresAllSamples:(char)a1;
- (id)initWithTrack:(id)a0 samplesPerChunk:(unsigned long long)a1 requiresAllSamples:(char)a2;
