...
- (id)startObserving:(id)a0 keyPaths:(id)a1 includeInitialValue:(char)a2 observationHandler:(id /* block */)a3;
- (id)startObserving:(id)a0 keyPath:(id)a1 includeInitialValue:(char)a2 observationHandler:(id /* block */)a3;
...
- (id)startObserving:(id)a0 keyPaths:(id)a1 includeInitialValue:(char)a2 includeChanges:(char)a3 observationHandler:(id /* block */)a4;
