...
- (void)_registerOrUnregisterForActivities:(char)a0;
- (void)_registerOrUnregisterForBackgroundTaskWithRequest:(id)a0 withSelector:(SEL)a1 requiresMiLoEnabled:(char)a2 isRegister:(char)a3;
...
- (id)exportDatabase;
- (id)getRecordingTriggerUUIDAndRequestMicroLocationRecordingScanWithAdditionalInformation:(id)a0 shouldForceRecording:(char)a1 handler:(id /* block */)a2 clientId:(id)a3;
