...
- (char)batchTransferRecordsUsingBatchSize:(unsigned long long)a0 andLimit:(unsigned long long)a1 usingDistinctRecords:(char)a2 intoTargetStore:(id)a3 withCancelFunc:(struct function<bool ()> { struct __value_func<bool ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a4;
- (char)deleteMeasurementsFromRecordingUUIDs:(const void *)a0;
