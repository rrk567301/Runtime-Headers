...
@property (nonatomic) char migrateAllData;
...
- (char)_migrateData:(struct ULMiloSqliteDatabase { struct CLSqliteDatabase *x0; } *)a0;
- (char)_migrateTableUsingPaging:(struct ULMiloSqliteDatabase { struct CLSqliteDatabase *x0; } *)a0 tableName:(const char *)a1 migrationLimit:(unsigned int)a2 pageSize:(unsigned int)a3 copyPageBlock:(id /* block */)a4;
...
- (char)migrateCLDatabaseFromPath:(id)a0;
