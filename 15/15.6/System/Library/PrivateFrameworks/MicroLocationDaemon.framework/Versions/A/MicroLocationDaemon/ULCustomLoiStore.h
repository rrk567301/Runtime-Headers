...
- (char)addServiceToCustomLoiMapping:(const struct uuid { unsigned char x0[16]; } *)a0 loiId:(const struct uuid { unsigned char x0[16]; } *)a1;
- (char)deleteAllCustomLoiOfDeletedServices;
...
- (char)removeServiceToCustomLoiMapping:(const struct uuid { unsigned char x0[16]; } *)a0 loiId:(const struct uuid { unsigned char x0[16]; } *)a1;
- (char)updateAllCustomLoiIdsWithMatchingServiceUUID:(const struct uuid { unsigned char x0[16]; } *)a0 withNewServiceUUID:(const struct uuid { unsigned char x0[16]; } *)a1;
