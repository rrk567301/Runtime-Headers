...
@property (readonly, nonatomic) char hasWiredConnection;
@property (readonly, nonatomic) char hasWirelessConnection;
...
- (id)copyNumberFromDevice:(struct _AMDevice { } *)a0 domain:(struct __CFString { } *)a1 key:(struct __CFString { } *)a2 shouldCopyFromKeyValueStore:(char)a3;
...
- (id)copyStringFromDevice:(struct _AMDevice { } *)a0 domain:(struct __CFString { } *)a1 key:(struct __CFString { } *)a2 shouldCopyFromKeyValueStore:(char)a3;
- (id)copyStringFromDevice:(struct _AMDevice { } *)a0 key:(struct __CFString { } *)a1;
- (id)copyValueFromDevice:(struct _AMDevice { } *)a0 domain:(struct __CFString { } *)a1 key:(struct __CFString { } *)a2 shouldCopyFromKeyValueStore:(char)a3;
