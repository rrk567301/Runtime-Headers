...
- (id)initWithStyleSheetId:(id)a0 frameId:(id)a1 sourceURL:(id)a2 origin:(long long)a3 title:(id)a4 disabled:(char)a5 isInline:(char)a6 startLine:(double)a7 startColumn:(double)a8;
