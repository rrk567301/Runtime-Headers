...
- (void)filteredImageFromImage:(struct CGImage { } *)a0 filterInfo:(id)a1 size:(struct CGSize { double x0; double x1; })a2 contentsScale:(double)a3 waitForCPUSynchronization:(char)a4 logKey:(id)a5 completion:(id /* block */)a6;
