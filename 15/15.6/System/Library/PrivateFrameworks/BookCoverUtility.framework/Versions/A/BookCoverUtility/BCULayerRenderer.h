...
- (id)initWithSuspended:(char)a0;
- (id)newOperationWithPriority:(float)a0 renderLayer:(id /* block */)a1 completion:(id /* block */)a2;
- (id)newOperationWithPriority:(float)a0 waitForCPUSynchronization:(char)a1 logKey:(id)a2 renderLayer:(id /* block */)a3 completion:(id /* block */)a4;
