...
@property (readonly, nonatomic, getter=isPermitted) char permitted;
@property (readonly, nonatomic) char shouldMakeRecord;
...
- (char)shouldMakeRecordWithFrequency:(unsigned long long)a0;
