...
@property (readonly, nonatomic) char originReturnRouteEnabled;
@property (readonly, nonatomic) char parsecReturnRouteEnabled;
@property (readonly, nonatomic) char dediscoReturnRouteEnabled;
