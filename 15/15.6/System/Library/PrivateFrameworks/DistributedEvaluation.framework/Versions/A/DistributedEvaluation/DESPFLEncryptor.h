...
- (id)encryptAndPrivatizeDataWithRecipe:(id)a0 numbers:(float *)a1 count:(unsigned long long)a2 inPlace:(char)a3 error:(id *)a4;
...
- (id)initWithRecipeUserInfo:(id)a0 writeToSubmissionLogs:(char)a1;
- (char)pluginShouldAddNoiseAndEncryptResult;
