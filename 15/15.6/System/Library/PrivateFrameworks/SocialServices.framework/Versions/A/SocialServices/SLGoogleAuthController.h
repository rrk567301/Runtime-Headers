...
+ (id)_identityFromUsername:(id)a0 displayName:(id)a1 token:(id)a2 refreshToken:(id)a3 idToken:(id)a4 grantedDataclasses:(id)a5;
...
- (id)_initWithAccount:(id)a0 accountStore:(id)a1 username:(id)a2 youTube:(char)a3 emailOnly:(char)a4 clientID:(id)a5 presentationBlock:(id /* block */)a6 completion:(id /* block */)a7;
- (id)_redirectPathForURI:(id)a0;
- (id)initWithClientID:(id)a0 emailOnlyScope:(char)a1 presentationBlock:(id /* block */)a2;
- (id)initWithEmailOnlyScope:(char)a0 presentationBlock:(id /* block */)a1;
