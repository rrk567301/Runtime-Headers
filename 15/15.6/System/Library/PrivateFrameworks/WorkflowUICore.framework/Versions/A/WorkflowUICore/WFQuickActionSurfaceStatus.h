...
+ (char)availabilityOfSurface:(id)a0;
...
- (char)setVisibility:(char)a0 ofReference:(id)a1 inQuickActionSurface:(id)a2;
- (char)visibilityOfReference:(id)a0 inQuickActionSurface:(id)a1;
