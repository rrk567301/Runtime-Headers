...
@property struct function<bool (FI_TNewAliasOperation *, TFENodeVector &&)> { struct __value_func<bool (FI_TNewAliasOperation *, TFENodeVector &&)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } processAliases;
