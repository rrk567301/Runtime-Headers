...
@interface FI_TStdAlertSheetController : NSObject {
    ...
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _notifySuppression;
}
...
+ (void)stdAlertSheetWithClient:(id)a0 parentWindow:(id)a1 mainText:(id)a2 subText:(id)a3 okStr:(id)a4 cancelStr:(id)a5 otherStr:(id)a6 alertStyle:(unsigned long long)a7 defaultButton:(int)a8 customIcon:(id)a9 showSuppressionButton:(BOOL)a10 suppressionButtonTitle:(const void *)a11 notifySuppression:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a12 optionalHelpURL:(const void *)a13 actionIsDestructive:(BOOL)a14;
