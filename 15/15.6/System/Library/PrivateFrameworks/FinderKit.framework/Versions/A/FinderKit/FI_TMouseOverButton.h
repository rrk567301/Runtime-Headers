...
@property (nonatomic) struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } anchorPointUpdater;
