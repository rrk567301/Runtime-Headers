...
@interface FI_TPreviewOptions : NSObject <TPreviewOptionsGroupSettingsDelegate> {
    ...
    struct function<void (FI_TPreviewOptions *)> { struct __value_func<void (FI_TPreviewOptions *)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _saveOptionsCallback;
}
...
- (void)setSaveOptionsCallback:(struct function<void (FI_TPreviewOptions *)> { struct __value_func<void (FI_TPreviewOptions *)> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a0;
