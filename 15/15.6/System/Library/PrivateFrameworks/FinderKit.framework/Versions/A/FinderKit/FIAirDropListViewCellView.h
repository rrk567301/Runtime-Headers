...
@property (nonatomic) struct function<bool (FIAirDropListViewCellView *)> { struct __value_func<bool (FIAirDropListViewCellView *)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } ignoreClickHandler;
@property (nonatomic) struct function<void (FIAirDropListViewCellView *)> { struct __value_func<void (FIAirDropListViewCellView *)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } clickHandler;
