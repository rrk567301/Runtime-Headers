...
@interface FI_TGoToAutoCompletionController : NSObject <NSCopying> {
    ...
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _updatePathHandler;
    struct function<void (NSArray<id<TGoToItemProtocol>> *)> { struct __value_func<void (NSArray<id<TGoToItemProtocol>> *)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _suggestionsHandler;
    struct function<TString (const TString &)> { struct __value_func<TString (const TString &)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _autoCompleteHandler;
    struct function<void (const TFENode &, const TString &)> { struct __value_func<void (const TFENode &, const TString &)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _completionHandler;
}
...
+ (id)filteredSuggestedItemsForResult:(const struct TGoToAutoCompletionResult { id x0; id x1; char x2; } *)a0 delegate:(id)a1 path:(const void *)a2;
...
- (void)autoCompletePath:(id)a0 relativeToItem:(id)a1 allowLeftoverLastPathComponent:(BOOL)a2 updatePathHandler:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a3 suggestionsHandler:(struct function<void (NSArray<id<TGoToItemProtocol>> *)> { struct __value_func<void (NSArray<id<TGoToItemProtocol>> *)> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a4;
- (void)autoCompletePath:(const void *)a0 relativeToNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1 allowLeftoverLastPathComponent:(BOOL)a2 updatePathHandler:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a3 autoCompleteHandler:(struct function<TString (const TString &)> { struct __value_func<TString (const TString &)> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a4 completionHandler:(struct function<void (const TFENode &, const TString &)> { struct __value_func<void (const TFENode &, const TString &)> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a5;
