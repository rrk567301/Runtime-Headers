...
@property struct function<bool (FI_TNewFolderOperation *, const TFENode &)> { struct __value_func<bool (FI_TNewFolderOperation *, const TFENode &)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } processNewFolder;
