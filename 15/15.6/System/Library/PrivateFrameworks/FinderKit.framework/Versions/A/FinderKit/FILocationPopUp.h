...
@interface FILocationPopUp : NSPopUpButton {
    ...
    double _scaleFactor;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _iCloudLoginChangeObserver;
    FILocationMenuFactory *_menuFactory;
}

@property (weak) id<FILocationPopUpDelegate> delegate;
@property (retain) NSURL *directoryURL;
@property (nonatomic) char shouldIncludeAncestors;
@property (nonatomic) char shouldShowDevices;
@property (nonatomic) char shouldShowFavorites;
@property (nonatomic) char shouldShowCloud;
@property (nonatomic) char shouldAllowTargetingCloud;
@property (nonatomic) char shouldShowKeyEquivalents;
