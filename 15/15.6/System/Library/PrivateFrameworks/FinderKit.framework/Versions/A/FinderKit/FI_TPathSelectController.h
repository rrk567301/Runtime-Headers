...
@interface FI_TPathSelectController : NSObject <NSMenuDelegate, TCoalescingNodeObserverProtocol, TMarkTornDown> {
    ...
    struct function<bool (const TFENode &)> { struct __value_func<bool (const TFENode &)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _shouldShowNode;
}
...
- (char)menu:(id)a0 updateItem:(id)a1 atIndex:(long long)a2 shouldCancel:(char)a3;
