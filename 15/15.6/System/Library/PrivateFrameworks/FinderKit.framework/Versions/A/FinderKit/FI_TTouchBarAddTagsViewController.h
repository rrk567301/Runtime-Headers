...
@interface FI_TTouchBarAddTagsViewController : FI_TTouchBarScrollingStackViewController <TCoalescingNodeObserverProtocol> {
    struct function<void (FI_TTagInfo *, bool)> { struct __value_func<void (FI_TTagInfo *, bool)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _buttonAction;
    ...
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _tagRegistryObserver;
