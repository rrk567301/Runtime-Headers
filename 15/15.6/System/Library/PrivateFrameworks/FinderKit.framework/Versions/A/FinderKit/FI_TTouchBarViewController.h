...
@interface FI_TTouchBarViewController : FI_TViewController <TMarkTornDown> {
    ...
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _viewWillAppearCallback;
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _viewWillDisappearCallback;
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _viewDidDisappearCallback;
}
