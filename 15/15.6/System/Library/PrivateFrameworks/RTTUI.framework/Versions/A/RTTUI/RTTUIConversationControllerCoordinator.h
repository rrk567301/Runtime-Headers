...
@property (nonatomic) char processingUtteranceBuffer;
...
- (void)_registerForTranscriptionUpdatesForCall:(id)a0;
...
- (id)conversationControllerForCallUUID:(id)a0;
...
- (char)realtimeTextDidChange:(id)a0 forUtterance:(id)a1 lastRowPath:(id)a2;
