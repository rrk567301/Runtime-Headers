...
+ (char)_validRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (void)_scrollToIndexPathIfNecessary:(id)a0 animated:(char)a1;
...
- (id)addTranscriptionText:(id)a0 isNew:(char)a1;
...
- (id)inputTextView;
- (char)isCurrentCallConnected;
- (char)isCurrentCallOnHold;
- (char)isCurrentCallReceivingOnHold;
- (char)isIncomingScreeningCall;
...
- (void)showCallEnded;
- (char)showTextViewForCurrentCall;
- (id)textViewUtterance;
- (void)updateCallDowngradeStatus;
- (void)updateDeviceLockStatus:(char)a0;
- (void)updateGAButton;
- (void)updateInputEnabled;
- (void)updateTableViewSizeAnimated:(char)a0;
