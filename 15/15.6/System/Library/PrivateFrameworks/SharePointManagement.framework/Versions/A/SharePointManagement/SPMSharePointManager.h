...
- (char)addSharePoint:(id)a0 error:(id *)a1;
- (char)removeSharePoint:(id)a0 error:(id *)a1;
- (char)updateSharePoint:(id)a0 error:(id *)a1;
- (char)_addSharePointNamed:(id)a0 withInfo:(id)a1;
- (void)_fetchSharePoints;
- (void)_handleListChangeNotification:(id)a0;
- (void)_invalidateAndNotifyObservers;
- (id)_records;
- (char)_removeSharePointNamed:(id)a0;
