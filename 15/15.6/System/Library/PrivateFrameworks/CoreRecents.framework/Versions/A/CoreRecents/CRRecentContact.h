...
- (void)appendSanitizedDescriptionTo:(id)a0;
...
- (void)insertDate:(id)a0 atIndex:(unsigned long long)a1 required:(char)a2;
- (unsigned long long)insertionIndexForDate:(id)a0 wouldBeUnique:(char *)a1;
- (void)lazilyCreateRecentDates;
- (void)recordRecentEventForDate:(id)a0 userInitiated:(char)a1;
