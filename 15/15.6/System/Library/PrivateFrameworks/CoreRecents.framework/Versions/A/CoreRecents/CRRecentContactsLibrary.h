...
- (void)recordContactEvents:(id)a0 recentsDomain:(id)a1 sendingAddress:(id)a2 userInitiated:(char)a3;
- (id)_searchRecentsUsingQuery:(id)a0 error:(id *)a1;
- (int)_daemonProcessID;
- (void)_recordContactEvents:(id)a0 recentsDomain:(id)a1 sendingAddress:(id)a2 source:(id)a3 userInitiated:(char)a4 completion:(id /* block */)a5;
- (void)_removeAllRecentContactsWithCompletion:(id /* block */)a0;
- (id)_removeRecentContactsMatchingQuery:(id)a0;
- (char)_removeRecentContactsWithRecentIDs:(id)a0 syncKeys:(id)a1 recentsDomain:(id)a2 error:(out id *)a3;
...
- (id)recentContactsForQuery:(id)a0 error:(id *)a1;
- (void)recordContactEvents:(id)a0 recentsDomain:(id)a1 sendingAddress:(id)a2;
- (void)recordContactEvents:(id)a0 recentsDomain:(id)a1 sendingAddress:(id)a2 source:(id)a3 userInitiated:(char)a4;
- (char)removeRecentContacts:(id)a0 error:(out id *)a1;
- (char)removeRecentContactsWithRecentIDs:(id)a0 recentsDomain:(id)a1 error:(out id *)a2;
- (void)requestRecentsUsingPredicate:(id)a0 inDomains:(id)a1 comparator:(id /* block */)a2 queue:(id)a3 completion:(id /* block */)a4;
- (id)restorePreviouslyDeletedRecentContacts:(id)a0;
