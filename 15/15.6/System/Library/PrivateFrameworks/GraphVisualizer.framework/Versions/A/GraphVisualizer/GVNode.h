...
- (char)hasEdgeFrom:(id)a0;
- (char)hasEdgeTo:(id)a0;
- (void)removeEdgeTo:(id)a0;
- (void)traversePostorder:(int)a0 withCallback:(id /* block */)a1 stopper:(id /* block */)a2 randomize:(char)a3;
- (void)traversePreorder:(int)a0 withCallback:(id /* block */)a1 randomize:(char)a2;
