...
@property (nonatomic) char betaApp;
...
@property (nonatomic) char hasSiriIntegration;
@property (nonatomic) char hidden;
@property (nonatomic) char isMacApp;
@property (nonatomic) char isNanoApp;
...
@property (nonatomic) char supportsUniversalSearchSubscription;
