...
@property (nonatomic) char enableSortingOnReset;
...
- (void)_searchUsingFilters:(id)a0 handleAdditions:(char)a1;
- (void)_searchUsingFilters:(id)a0 handleAdditions:(char)a1 withCompletionHandler:(id /* block */)a2;
