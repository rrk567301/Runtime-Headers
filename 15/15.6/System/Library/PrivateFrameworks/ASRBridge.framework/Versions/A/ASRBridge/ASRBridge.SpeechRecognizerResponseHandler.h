...
- (id)init;
- (void).cxx_destruct;
- (void)localSpeechRecognizerClient:(id)a0 didAcceptedEagerResultWithRequestId:(id)a1 rcId:(unsigned long long)a2 mitigationSignal:(char)a3 featuresToLog:(id)a4;
...
- (void)localSpeechRecognizerClient:(id)a0 receivedMultiUserTRPCandidatePackage:(id)a1;
- (void)localSpeechRecognizerClient:(id)a0 receivedPartialResultWithRequestId:(id)a1 language:(id)a2 speechPackage:(id)a3 metadata:(id)a4;
...
- (void)localSpeechRecognizerClient:(id)a0 receivedVoiceCommandCandidateWithRequestId:(id)a1 speechPackage:(id)a2 metadata:(id)a3;
- (void)localSpeechRecognizerClient:(id)a0 receivedVoiceIdScoreCard:(id)a1;
- (void)localSpeechRecognizerClient:(id)a0 requestAttentionAssetDownload:(char)a1;
