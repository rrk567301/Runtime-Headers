...
@interface SKSetupCaptiveNetworkJoinServer : SKSetupBase {
    ...
    char _captiveNetworkWebSheetActive;
    char _captiveNetworkWebSheetCompleted;
    char _cfuCleared;
...
- (void)_captiveDetectedNotificationUpdate:(char)a0;
- (void)_captiveNetworkIPAssign:(id /* block */)a0;
