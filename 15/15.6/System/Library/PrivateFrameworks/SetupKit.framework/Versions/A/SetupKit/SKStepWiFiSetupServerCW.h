@class NSError, NSString, CUBonjourAdvertiser, SKSetupBase, NSData, CUReachabilityMonitor, NSObject, CWFScanResult, CWFInterface;
...
@interface SKStepWiFiSetupServerCW : NSObject <CULabelable, SKStepable> {
    ...
    char _internetReachabilityEnabled;
