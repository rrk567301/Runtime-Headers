...
- (void)_pskPrepareClientMode:(char)a0;
...
- (void)_serverPairSetupContinueWithData:(id)a0 start:(char)a1;
- (void)_serverPairVerifyContinueWithData:(id)a0 start:(char)a1;
