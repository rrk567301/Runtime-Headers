...
@property char enrollmentPhaseTwo;
...
@property char UIDSet;
@property unsigned int userid;
@property char inBuddy;
@property char cancelForRestart;
@property char enrollmentSkipped;
...
- (void)operation:(id)a0 presenceStateChanged:(char)a1;
...
- (void)extendEnroll:(id)a0 hasUpdated:(char)a1;
...
- (void)_cancelEnrollmentAndRestart:(char)a0;
...
- (void)_setHidden:(id)a0 hidden:(char)a1;
...
- (void)_startInitialTutorial:(char)a0;
