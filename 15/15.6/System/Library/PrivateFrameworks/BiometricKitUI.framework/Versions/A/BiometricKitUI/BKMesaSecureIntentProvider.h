...
- (void)_getSecureIntentForAccessory:(id)a0 enrollmentOperation:(id)a1 showErrorToRetry:(char)a2 withCompletionHandler:(id /* block */)a3;
- (void)_handleTouchIDEventWithParameters:(id)a0;
- (char)_isMonitoringPowerButton;
...
- (id)initWithAlertWindow:(id)a0 inBuddy:(char)a1;
