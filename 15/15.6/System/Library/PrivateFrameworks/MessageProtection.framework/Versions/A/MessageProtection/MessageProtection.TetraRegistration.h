...
- (id)initWithTetraRegistrationData:(id)a0 ecdhPublicKey:(id)a1 version:(unsigned int)a2 timestamp:(double)a3 signedBy:(id)a4 isEncrypting:(char)a5 error:(id *)a6;
