...
+ (id)unwrapWrappedSeed:(id)a0 legacy:(char)a1 using:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a2 error:(id *)a3;
+ (id)wrapSeed:(id)a0 to:(id)a1 legacy:(char)a2 error:(id *)a3;
