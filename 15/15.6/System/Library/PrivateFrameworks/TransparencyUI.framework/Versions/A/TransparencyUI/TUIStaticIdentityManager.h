...
@property (readonly, nonatomic) char accountKeysDisplayed;
@property (readonly, nonatomic) char conversationVerified;
@property (readonly, nonatomic) char sasCodeRefreshRequired;
@property (readonly, nonatomic) unsigned long long sasCodeValidMinutes;
@property (readonly, nonatomic) char sasCodeValid;
...
- (void)dealloc;
- (void).cxx_destruct;
- (void)postNotificationName:(id)a0 object:(id)a1 userInfo:(id)a2 deliverImmediately:(char)a3;
