...
@interface TUIOptInFlowControllerImpl : NSObject <iCloudWebViewDelegate, TUIOptInFlowController> {
    char _ineligibleDevicesRemoteUIViewUnexpectedState;
}
...
- (char)_iCloudAccountMatchesiMessageAccount;
- (char)_ineligibleDevicesRemoteUIFeatureEnabled;
...
- (void)_showOptInResultError:(char)a0 error:(id)a1;
