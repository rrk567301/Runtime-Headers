...
@property (readonly, nonatomic) char referenceLocationSummary;
...
- (id)initWithDateInterval:(id)a0 lookbackInterval:(double)a1 spatialGranularity:(unsigned long long)a2 referenceLocation:(id)a3 referenceLocationSummary:(char)a4 distance:(double)a5;
