...
- (void)setRoutineEnabled:(char)a0;
...
- (id)initWithRestorationIdentifier:(id)a0 targertUserSession:(char)a1;
- (id)initWithTargetUserSession:(char)a0;
