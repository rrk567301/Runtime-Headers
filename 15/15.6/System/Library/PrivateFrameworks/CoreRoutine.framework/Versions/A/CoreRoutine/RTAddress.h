...
@property (readonly, nonatomic) char isIsland;
...
+ (id)_encodeGeoAddressObject:(id)a0 compress:(char)a1;
+ (id)_decodeGeoAddressObjectFromData:(id)a0 decompress:(char)a1;
...
- (id)initWithIdentifier:(id)a0 geoAddressObject:(id)a1 subPremises:(id)a2 isIsland:(char)a3 creationDate:(id)a4 expirationDate:(id)a5 iso3166CountryCode:(id)a6 iso3166SubdivisionCode:(id)a7;
- (id)geoAddressObject;
...
- (id)initWithIdentifier:(id)a0 geoAddressData:(id)a1 subPremises:(id)a2 isIsland:(char)a3 creationDate:(id)a4 expirationDate:(id)a5 iso3166CountryCode:(id)a6 iso3166SubdivisionCode:(id)a7;
