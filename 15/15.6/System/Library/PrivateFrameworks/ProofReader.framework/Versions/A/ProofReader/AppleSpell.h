...
@interface AppleSpell : NSObject {
    ...
    char _foundNamesProhibited;
    char _supplementalLexiconEnabled;
}
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })spellServer:(id)a0 findMisspelledWordInString:(id)a1 language:(id)a2 wordCount:(long long *)a3 countOnly:(char)a4;
...
- (char)spellServer:(id)a0 canChangeCaseOfFirstLetterInString:(id)a1 toUpperCase:(char)a2 language:(id)a3;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })spellServer:(id)a0 findMisspelledWordInString:(id)a1 language:(id)a2 wordCount:(long long *)a3 countOnly:(char)a4 correction:(id *)a5;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })spellServer:(id)a0 findMisspelledWordInString:(id)a1 languages:(id)a2 wordCount:(long long *)a3 countOnly:(char)a4 correction:(id *)a5;
...
- (void)_addGuessesForWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 minAutocorrectionLength:(unsigned long long)a5 previousLetter:(unsigned short)a6 nextLetter:(unsigned short)a7 basicOnly:(char)a8 toGuesses:(id)a9;
- (char)_addLanguageModelCompletionsForPartialWordRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 languageObject:(id)a1 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a2 sender:(id)a3 tagger:(id)a4 appIdentifier:(id)a5 waitForLanguageModel:(char)a6 allowTransformer:(char)a7 candidates:(id)a8 scoreDictionary:(id)a9 tryTransliteration:(char *)a10;
- (id)normalizedStringInString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (void)_addSpaceInsertionGuessesForWord:(id)a0 sender:(id)a1 buffer:(char *)a2 length:(unsigned long long)a3 languageObject:(id)a4 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a5 isCapitalized:(char)a6 checkUser:(char)a7 oneLetterWords:(const char *)a8 twoLetterWords:(const char *)a9 candidateList:(id)a10;
- (void)resetDataBundlesForAllLanguages;
- (id)spellServer:(id)a0 _retainedAlternativesForPinyinInputString:(id)a1 extended:(char)a2;
- (id)wordLanguageModelForLanguageObject:(id)a0 appIdentifier:(id)a1 waitForResult:(char)a2;
- (id)_NLPLanguageModelWithType:(long long)a0 forLanguageObject:(id)a1 waitForResult:(char)a2;
- (id)_accentCorrectionResultForString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inString:(id)a2 offset:(unsigned long long)a3 languageObject:(id)a4 onlyAtInsertionPoint:(char)a5 capitalize:(char)a6 keyEventArray:(id)a7 selectedRangeValue:(id)a8;
- (char)_acceptWithoutAccentForString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inString:(id)a2 languageObject:(id)a3;
...
- (void)_addLanguageModelCompletionsForPrefix:(id)a0 languageModel:(id)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 capitalized:(char)a5 candidates:(id)a6;
- (void)_addTwoLetterWordGuessesForWord:(id)a0 buffer:(char *)a1 length:(unsigned long long)a2 languageObject:(id)a3 isCapitalized:(char)a4 isAllCaps:(char)a5 twoLetterWords:(const char *)a6 candidateList:(id)a7;
- (char)shouldBlockWord:(id)a0 languageObject:(id)a1;
...
- (id)_correctionResultForWord:(id)a0 replacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inString:(id)a2 offset:(unsigned long long)a3 languageObject:(id)a4 capitalize:(char)a5 isCapitalized:(char)a6 isSecondCapitalized:(char)a7 hasCurlyApostrophe:(char)a8 appendCorrectionLanguage:(char)a9 capitalizationLocale:(id)a10 proposedCorrection:(id)a11;
...
- (id)_lexiconsForLanguage:(id)a0 loadType:(long long)a1;
- (id)_lexiconsForLanguageObject:(id)a0;
- (id)_loadLexiconsForLanguage:(id)a0 localization:(id)a1 cachedOnly:(char)a2 onQueue:(id)a3;
- (id)_loadNERTaggerOnQueue:(id)a0;
...
- (char)_permitCorrection:(id)a0 languageObject:(id)a1 flags:(unsigned long long)a2 isCapitalized:(char)a3 typologyCorrection:(id)a4;
- (id)_phraseCapitalizationResultForString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 currentWordRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 inString:(id)a3 offset:(unsigned long long)a4 languageObject:(id)a5 onlyAtInsertionPoint:(char)a6 keyEventArray:(id)a7 selectedRangeValue:(id)a8;
- (id)_phraseLexiconPathForLanguage:(id)a0;
- (id)_phraseLexiconsForLanguage:(id)a0;
- (id)_phraseLexiconsForLanguage:(id)a0 waitForResult:(char)a1;
...
- (char)_prohibitCorrectionBasedOnCountsForString:(id)a0 lowercaseString:(id)a1 appIdentifier:(id)a2 languageObject:(id)a3 typologyCorrection:(id)a4;
- (char)_prohibitCorrectionForLanguageObject:(id)a0 lastKeyboardLanguageObject:(id)a1;
- (id)_rankedCandidatesForCandidateList:(id)a0 languageObject:(id)a1 tagger:(id)a2 appIdentifier:(id)a3 parameterBundles:(id)a4;
- (id)_rankedCandidatesForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 candidates:(id)a1 languageObject:(id)a2 tagger:(id)a3 appIdentifier:(id)a4 allowTransformer:(char)a5 scoreDictionary:(id)a6;
...
- (id)_spaceInsertionCorrectionForWord:(id)a0 buffer:(char *)a1 length:(unsigned long long)a2 languageObject:(id)a3 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a4 flags:(unsigned long long)a5 isCapitalized:(char)a6 typologyCorrection:(id)a7;
- (char)_spellServer:(id)a0 canChangeCaseOfFirstLetterInString:(id)a1 toUpperCase:(char)a2 languageObject:(id)a3;
...
- (id)_stringForCompletion:(id)a0 languageModel:(id)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 prefix:(id)a5 capitalized:(char)a6;
- (id)_stringForTokenIDs:(const unsigned int *)a0 tokenCount:(unsigned long long)a1 entryString:(id)a2 languageModel:(id)a3 languageObject:(id)a4 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a5 sender:(id)a6 prefix:(id)a7 capitalized:(char)a8;
- (id)_taggerForOrthoIndex:(unsigned long long)a0;
- (unsigned int)_tokenIDForString:(id)a0 languageModel:(id)a1 languageObject:(id)a2 createIfAbsent:(char)a3 terminatorTokenID:(unsigned int)a4;
...
- (char)_useAlternateLanguageForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 ofString:(id)a1 languageObject:(id)a2 tagger:(id)a3 alternateLanguageObject:(id)a4 alternateTagger:(id)a5 appIdentifier:(id)a6;
- (char *)_validatedGuessWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 checkUser:(char)a5 additionalBuffer:(char *)a6;
- (unsigned long long)acceptabilityOfWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 forPrediction:(char)a3 alreadyCapitalized:(char)a4;
- (unsigned long long)acceptabilityOfWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 forPrediction:(char)a3 alreadyCapitalized:(char)a4 depth:(unsigned long long)a5;
- (void)addAlternateDataBundleURL:(id)a0;
- (void)addGuessesForKoreanWord:(id)a0 includeAdditionalGuesses:(char)a1 toGuesses:(id)a2;
- (void)addLexiconGuessesForWord:(id)a0 buffer:(char *)a1 length:(unsigned long long)a2 languageObject:(id)a3 minCorrectionLength:(unsigned long long)a4 minExtendedCorrectionLength:(unsigned long long)a5 isCapitalized:(char)a6 stopAfterFreeInsertions:(char)a7 toGuesses:(id)a8;
...
- (void)addSpecialModifiedPinyinToArray:(id)a0 inBuffer:(char *)a1 length:(unsigned long long)a2 atEnd:(char)a3;
...
- (id)characterLanguageModelForLanguageObject:(id)a0 waitForResult:(char)a1;
- (char)checkNameWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 globalOnly:(char)a3;
- (char)checkNegativeWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2;
- (char)checkNegativeWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 alreadyCapitalized:(char)a3;
- (char)checkNoCapAbbreviationWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2;
- (char)checkSpecialPrefixesForWordBuffer:(char *)a0 length:(unsigned long long)a1;
- (char)checkWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 index:(unsigned long long)a3;
...
- (void)enumerateLexiconEntriesForWord:(id)a0 language:(id)a1 usingBlock:(id /* block */)a2;
...
- (char)getCharacterModelConditionalProbabilityForString:(id)a0 context:(id)a1 language:(id)a2 probability:(double *)a3;
- (char)getConditionalProbabilityForWord:(id)a0 context:(id)a1 language:(id)a2 probability:(double *)a3;
- (char)getMetaFlagsForWord:(id)a0 inLexiconForLanguage:(id)a1 metaFlags:(unsigned int *)a2 otherMetaFlags:(unsigned int *)a3;
- (char)getMetaFlagsForWord:(id)a0 inLexiconForLanguageObject:(id)a1 metaFlags:(unsigned int *)a2 otherMetaFlags:(unsigned int *)a3;
...
- (char)getTransformerModelConditionalProbabilityForString:(id)a0 context:(id)a1 language:(id)a2 probability:(double *)a3;
- (id)globalDictionaryArray;
- (id)guessesDictionaryForLanguageObject:(id)a0;
- (char)inputStringIsFullOrAbbreviatedPinyin:(id)a0;
- (char)inputStringIsPinyin:(id)a0 allowPartialLastSyllable:(char)a1;
- (id)internalStringForKoreanExternalString:(id)a0;
- (void)invalidateTagger:(id)a0;
...
- (id)lexiconsForLanguageObject:(id)a0;
...
- (id)nerTaggerWaitForResult:(char)a0;
- (char)noSuggestForCompletion:(id)a0 languageObject:(id)a1 appIdentifier:(id)a2 alreadyCapitalized:(char)a3;
...
- (id)regionalCorrectionsDictionaryForLanguageObject:(id)a0;
...
- (id)sentencePieceLanguageModelForLanguageObject:(id)a0 waitForResult:(char)a1;
...
- (void)spellServer:(id)a0 checkSentenceCorrectionInString:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 languageObject:(id)a3 offset:(unsigned long long)a4 keyEventArray:(id)a5 selectedRangeValue:(id)a6 autocorrect:(char)a7 checkGrammar:(char)a8 ignoreTermination:(char)a9 mutableResults:(id)a10;
- (void)spellServer:(id)a0 checkSentenceCorrectionInString:(id)a1 rangeInParagraph:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 languageObject:(id)a3 locale:(id)a4 tagger:(id)a5 offset:(unsigned long long)a6 keyEventArray:(id)a7 selectedRangeValue:(id)a8 autocorrect:(char)a9 checkGrammar:(char)a10 ignoreTermination:(char)a11 mutableResults:(id)a12;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })spellServer:(id)a0 findMisspelledWordInString:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 languages:(id)a3 topLanguages:(id)a4 orthography:(id)a5 checkOrthography:(char)a6 mutableResults:(id)a7 offset:(unsigned long long)a8 autocorrect:(char)a9 onlyAtInsertionPoint:(char)a10 initialCapitalize:(char)a11 autocapitalize:(char)a12 keyEventArray:(id)a13 appIdentifier:(id)a14 selectedRangeValue:(id)a15 parameterBundles:(id)a16 wordCount:(long long *)a17 countOnly:(char)a18 appendCorrectionLanguage:(char)a19 correction:(id *)a20;
...
- (id)spellServer:(id)a0 regionalCorrectionForWord:(id)a1 language:(id)a2;
- (char)spellServer:(id)a0 shouldBlockWord:(id)a1 language:(id)a2 offensiveOnly:(char)a3;
...
- (char)supportSentenceCorrectionForLanguageObject:(id)a0 appIdentifier:(id)a1;
- (id)taggerForLanguageObject:(id)a0 string:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
- (char)testTurkishSuffixationPattern:(id)a0;
- (id)transformerLanguageModelForLanguageObject:(id)a0 waitForResult:(char)a1;
- (id)transformerOrSiriLanguageModelForLanguageObject:(id)a0 appIdentifier:(id)a1 waitForResult:(char)a2;
...
- (char)useCharacterLanguageModelForLanguageObject:(id)a0 tagger:(id)a1 appIdentifier:(id)a2;
- (char)useSentencePieceLanguageModelForLanguageObject:(id)a0 tagger:(id)a1 appIdentifier:(id)a2;
- (char)useTransformerLanguageModelForLanguageObject:(id)a0 tagger:(id)a1 appIdentifier:(id)a2;
- (char)useUnigramProbabilityForLanguageObject:(id)a0;
- (char)useWordLanguageModelForLanguageObject:(id)a0 tagger:(id)a1 appIdentifier:(id)a2;
- (char)validateAbbreviationOrNumberWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4;
- (char)validateAdditionalWord:(id)a0 inLexiconForLanguage:(id)a1;
- (char)validateAdditionalWord:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateDiacriticInsensitiveWord:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateNoCapAbbreviation:(id)a0 inLexiconForLanguage:(id)a1;
- (char)validateNoCapAbbreviation:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateUntilLearnedWord:(id)a0 inLexiconForLanguage:(id)a1;
- (char)validateUntilLearnedWord:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateVariantWord:(id)a0 inLexiconForLanguage:(id)a1;
- (char)validateVariantWord:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateWord:(id)a0 inLexicon:(id)a1;
- (char)validateWord:(id)a0 inLexiconForLanguage:(id)a1;
- (char)validateWord:(id)a0 inLexiconForLanguageObject:(id)a1;
- (char)validateWord:(id)a0 inLexicons:(id)a1 forLanguage:(id)a2 requiredMetaFlags:(unsigned int)a3 alternativeRequiredMetaFlags:(unsigned int)a4 prohibitedMetaFlags:(unsigned int)a5 caseInsensitive:(char)a6;
- (char)validateWord:(id)a0 inLexiconsForLanguageObject:(id)a1 requiredMetaFlags:(unsigned int)a2 alternativeRequiredMetaFlags:(unsigned int)a3 prohibitedMetaFlags:(unsigned int)a4 caseInsensitive:(char)a5;
- (char)validateWordBuffer:(char *)a0 length:(unsigned long long)a1 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a2;
- (char)validateWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 checkBase:(char)a5 checkDict:(char)a6 checkNames:(char)a7 checkHyphens:(char)a8 checkIntercaps:(char)a9 checkOptions:(char)a10 depth:(unsigned long long)a11;
- (char)validateWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 checkBase:(char)a5 checkDict:(char)a6 checkTemp:(char)a7 checkNames:(char)a8 checkHyphens:(char)a9 checkIntercaps:(char)a10 checkOptions:(char)a11 depth:(unsigned long long)a12;
- (char)validateWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 checkBase:(char)a5 checkDict:(char)a6 checkTemp:(char)a7 checkUser:(char)a8 checkNames:(char)a9 checkHyphens:(char)a10 checkIntercaps:(char)a11 checkOptions:(char)a12 depth:(unsigned long long)a13;
- (char)validateWordBuffer:(char *)a0 length:(unsigned long long)a1 languageObject:(id)a2 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a3 sender:(id)a4 checkBase:(char)a5 checkDict:(char)a6 checkTemp:(char)a7 checkUser:(char)a8 checkNames:(char)a9 checkHyphens:(char)a10 checkIntercaps:(char)a11 checkOptions:(char)a12 forCorrection:(char)a13 depth:(unsigned long long)a14;
- (char)validateWordPrefixBuffer:(char *)a0 length:(unsigned long long)a1 connection:(struct _PR_DB_IO { unsigned char x0; unsigned char x1; struct _PR_DOC_FORMAT { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned short x6; unsigned short x7; } x2; unsigned short x3; unsigned short x4; unsigned int *x5; unsigned char x6; short x7; short x8; short x9; short x10; unsigned short x11; struct _PR_DBINIT { struct _PR_FILE *x0[1]; struct _PR_FILE *x1; struct _PR_FILE *x2; struct _PR_FILE *x3; struct _PR_FILE *x4; } x12; struct _RULEFILE *x13[1]; struct _PR_STATUS { unsigned int x0; int x1; unsigned short x2; } x14; } *)a2;
- (id)vietnameseModificationForWord:(id)a0;
- (char)wordIsAlreadyAccented:(id)a0;
- (id)wordLanguageModelForLanguage:(id)a0 appIdentifier:(id)a1 waitForResult:(char)a2;
