...
+ (id)lexiconWithLocalization:(id)a0 unigramsPath:(id)a1 cachedOnly:(char)a2;
...
- (char)getProbabilityForString:(id)a0 probability:(double *)a1;
- (char)getProbabilityForTokenID:(unsigned int)a0 probability:(double *)a1;
...
- (id)initWithLocalization:(id)a0 unigramsPath:(id)a1 cachedOnly:(char)a2;
