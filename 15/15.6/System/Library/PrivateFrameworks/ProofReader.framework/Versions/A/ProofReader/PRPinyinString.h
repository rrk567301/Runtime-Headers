...
- (id)initWithString:(id)a0 syllableCount:(unsigned long long)a1 lastSyllableIsPartial:(char)a2 score:(unsigned long long)a3 originalLength:(unsigned long long)a4 modificationType:(unsigned long long)a5 originalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a6 finalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a7;
- (id)initWithString:(id)a0 syllableCount:(unsigned long long)a1 lastSyllableIsPartial:(char)a2 score:(unsigned long long)a3 originalLength:(unsigned long long)a4 modificationType:(unsigned long long)a5 originalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a6 finalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a7 originalSyllableRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a8;
- (id)initWithString:(id)a0 syllableCount:(unsigned long long)a1 lastSyllableIsPartial:(char)a2 score:(unsigned long long)a3 originalLength:(unsigned long long)a4 modificationType:(unsigned long long)a5 originalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a6 finalModificationRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a7 originalSyllableRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a8 originalAdditionalSyllableRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a9;
- (id)initWithString:(id)a0 syllableCount:(unsigned long long)a1 lastSyllableIsPartial:(char)a2 score:(unsigned long long)a3 originalLength:(unsigned long long)a4 originalCheckedLength:(unsigned long long)a5 numberOfModifications:(unsigned long long)a6 modificationTypes:(unsigned long long *)a7 originalModificationRanges:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a8 finalModificationRanges:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a9 originalSyllableRanges:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a10 originalAdditionalSyllableRanges:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a11;
