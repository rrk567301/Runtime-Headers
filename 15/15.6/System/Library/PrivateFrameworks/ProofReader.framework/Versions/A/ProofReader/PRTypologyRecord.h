...
+ (id)openTypologyRecordWithString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 languageObject:(id)a2 languages:(id)a3 topLanguages:(id)a4 autocorrect:(char)a5 initialCapitalize:(char)a6 autocapitalize:(char)a7 keyEventArray:(id)a8 appIdentifier:(id)a9 selectedRangeValue:(id)a10;
...
- (id)initWithString:(id)a0 offset:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 languageObject:(id)a3 languages:(id)a4 topLanguages:(id)a5 autocorrect:(char)a6 initialCapitalize:(char)a7 autocapitalize:(char)a8 keyEventArray:(id)a9 appIdentifier:(id)a10 selectedRangeValue:(id)a11;
