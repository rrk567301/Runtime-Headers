...
- (id)initWithPattern:(id)a0 name:(id)a1 type:(int)a2 postponesApostrophe:(char)a3;
- (unsigned long long)matchingIndexInBuffer:(char *)a0 length:(unsigned long long)a1 followedByLetter:(unsigned char)a2 matchWithNameOnly:(char *)a3;
