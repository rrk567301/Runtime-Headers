...
@property (nonatomic) char isProcessingRequest;
@property char nextButtonEnabled;
@property char backButtonEnabled;
...
- (id)initWithProvisioningController:(id)a0 didPreflight:(char)a1 context:(long long)a2 setupAssistantContext:(id)a3 setupDelegate:(id)a4;
