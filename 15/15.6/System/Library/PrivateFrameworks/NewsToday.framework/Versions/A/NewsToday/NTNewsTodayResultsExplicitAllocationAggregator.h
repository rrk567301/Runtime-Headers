...
- (id)init;
- (void).cxx_destruct;
- (id)_itemsForSection:(id)a0 items:(id)a1 withBudgetInfo:(id)a2 previouslyChosenItems:(id)a3 priorClusterIDsInOtherSections:(id)a4 sectionItemsLimit:(unsigned long long)a5 otherArticleIDs:(id)a6 remainingSlots:(double)a7 slotsUsed:(double *)a8 noMoreItemsToGive:(char *)a9 noRoomForMoreItems:(char *)a10;
