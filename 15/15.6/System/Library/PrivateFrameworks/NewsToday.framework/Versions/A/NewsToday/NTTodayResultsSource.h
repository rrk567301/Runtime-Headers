...
@property (nonatomic, getter=hasFlushingBeenEnabled) char flushingHasBeenEnabled;
...
- (void)_fetchTodayModuleDescriptorsWithContentRequest:(id)a0 requireRefreshedAppConfig:(char)a1 qualityOfService:(long long)a2 completion:(id /* block */)a3;
