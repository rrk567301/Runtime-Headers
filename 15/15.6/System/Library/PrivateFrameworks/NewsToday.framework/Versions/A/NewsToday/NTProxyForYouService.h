...
- (void)fetchForYouWithRequest:(NTForYouRequest *)a0 configuration:(id<FCNewsAppConfiguration>)a1 fetchDate:(NSDate *)a2 completionHandler:(void (^)(NSArray *, NSDictionary *, char, NSError *))a3;
