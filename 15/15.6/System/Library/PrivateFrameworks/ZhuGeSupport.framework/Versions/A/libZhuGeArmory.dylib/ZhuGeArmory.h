...
- (char)checkDependency:(id)a0 withError:(id *)a1;
- (char)convertReturnValue:(id *)a0 ByItselfAndError:(id)a1 AndRevalues:(id)a2;
...
- (char)updateChangeablePropertiesForKey:(id)a0 andOption:(id)a1 withError:(id *)a2;
- (char)verifyDependencyWithError:(id *)a0;
