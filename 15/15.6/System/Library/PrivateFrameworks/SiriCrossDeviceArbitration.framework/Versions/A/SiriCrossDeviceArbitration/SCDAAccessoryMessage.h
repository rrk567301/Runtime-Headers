...
@property (readonly, nonatomic) char isSane;
@property (readonly, nonatomic, getter=usesSerializedProtocol) char serializedProtocol;
...
+ (char)isMyriadRequestMessage:(id)a0;
+ (id)messageKey;
...
- (id)initElectionDecisionMessageWithSessionId:(unsigned long long)a0 decision:(char)a1 accessoryId:(id)a2;
