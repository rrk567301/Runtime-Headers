@class SCDAArbitrationParticipationController, CDASchemaCDAScoreBoosters, NSObject;
...
- (void)logCDAElectionDecisionMadeDebug:(int)a0 withCrossDeviceArbitrationAllowed:(char)a1 advertisementData:(id)a2 withDeviceGroup:(unsigned int)a3 withCdaId:(id)a4 withTimestamp:(unsigned long long)a5;
...
- (void)updateIsTrump:(char)a0 withReason:(int)a1;
- (void)logCDAElectionAdvertisingStarting:(int)a0 withDelay:(float)a1 withInterval:(float)a2 withVoiceTriggerLatency:(float)a3 withCdaId:(id)a4 withTimestamp:(unsigned long long)a5;
- (void)userFeedbackPublishArbitrationParticipationContext:(id)a0;
