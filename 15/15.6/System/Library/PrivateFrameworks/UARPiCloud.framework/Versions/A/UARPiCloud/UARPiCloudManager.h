...
- (void)performRemoteFetchForSupportedAccessoriesMetadata:(id)a0 batchRequest:(char)a1;
...
- (char)fetchVerificationCertificateInContainer:(id)a0;
...
- (char)handleRemoteFetchRequestForCHIPAccessoriesMetadata:(id)a0 batchRequest:(char)a1;
- (void)handleRemoteFetchRequestForCHIPAttestationCertificates:(id)a0;
- (char)handleRemoteFetchRequestSyncForCHIPAccessoriesMetadata:(id *)a0 productGroup:(id)a1 batchRequest:(char)a2;
...
- (char)processCHIPAccessoriesRecord:(id)a0;
- (void)processCHIPAccessoriesRecords:(id)a0 isComplete:(char)a1 productGroup:(id)a2;
- (char)processCHIPAttestationCertificateRecord:(id)a0 subjectKeyIdentifier:(id)a1;
...
- (char)validateCHIPFirmwareRecord:(id)a0 inContainer:(id)a1 forAccessory:(id)a2;
- (char)validateSignatureForUARPAccessoryRecord:(id)a0 inContainer:(id)a1;
