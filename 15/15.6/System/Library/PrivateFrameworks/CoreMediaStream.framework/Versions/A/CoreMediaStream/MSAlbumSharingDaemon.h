...
- (void)refreshResetSync:(char)a0 personID:(id)a1 info:(id)a2;
...
- (void)markAlbumGUIDAsViewed:(id)a0 personID:(id)a1 moveLastViewedAssetCollectionMarker:(char)a2 info:(id)a3;
...
- (void)refreshCommentsForAssetCollectionWithGUID:(id)a0 resetSync:(char)a1 personID:(id)a2;
- (void)refreshCommentsForAssetCollectionWithGUID:(id)a0 resetSync:(char)a1 personID:(id)a2 info:(id)a3;
- (void)refreshContentOfAlbumWithGUID:(id)a0 resetSync:(char)a1 personID:(id)a2;
- (void)refreshContentOfAlbumWithGUID:(id)a0 resetSync:(char)a1 personID:(id)a2 info:(id)a3;
- (void)refreshResetSync:(char)a0 personID:(id)a1;
...
- (void)setMultipleContributorsEnabled:(char)a0 forAlbumWithGUID:(id)a1 personID:(id)a2 completionBlock:(id /* block */)a3;
- (void)setMultipleContributorsEnabled:(char)a0 forAlbumWithGUID:(id)a1 personID:(id)a2 info:(id)a3 completionBlock:(id /* block */)a4;
- (void)setPublicAccessEnabled:(char)a0 forAlbumWithGUID:(id)a1 personID:(id)a2 completionBlock:(id /* block */)a3;
- (void)setPublicAccessEnabled:(char)a0 forAlbumWithGUID:(id)a1 personID:(id)a2 info:(id)a3 completionBlock:(id /* block */)a4;
- (void)shutDown;
...
- (char)isInRetryState;
- (void)mapQueueShutDownStateMachineInMap:(id)a0 personIDs:(id)a1 index:(unsigned long long)a2 forDestruction:(char)a3 completionBlock:(id /* block */)a4;
...
- (void)shutDownStateMachine:(id)a0 forDestruction:(char)a1 completionBlock:(id /* block */)a2;
