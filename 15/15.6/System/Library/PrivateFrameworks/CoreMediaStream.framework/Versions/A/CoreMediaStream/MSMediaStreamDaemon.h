...
- (char)dequeueAssetCollectionWithGUIDs:(id)a0 personID:(id)a1 outError:(id *)a2;
...
- (void)didUnidle;
- (char)enqueueAssetCollection:(id)a0 personID:(id)a1 outError:(id *)a2;
- (char)hasOutstandingActivity;
- (char)isInRetryState;
- (char)mayDownloadPersonID:(id)a0;
- (char)personIDHasOutstandingPublications:(id)a0;
