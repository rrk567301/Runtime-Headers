...
- (char)dbQueueCheckToClearUnviewedStateOnAssetCollectionWithGUID:(id)a0 info:(id)a1;
- (void)markAlbumGUIDAsViewed:(id)a0 moveLastViewedAssetCollectionMarker:(char)a1 info:(id)a2;
...
- (char)MSASStateMachine:(id)a0 didQueryIsAssetCollectionWithGUIDInModel:(id)a1;
...
- (char)dbQueueAccessControlWithGUID:(id)a0 outObject:(id *)a1 outAlbumGUID:(id *)a2 outEmail:(id *)a3 outUserInfoData:(id *)a4;
- (id)dbQueueAccessControlsForAlbumWithGUID:(id)a0;
- (void)dbQueueAddCommentCheckOperation:(id)a0;
- (id)dbQueueAlbumGUIDs;
- (char)dbQueueAlbumMetadataWithAlbumGUID:(id)a0 key:(id)a1 outValue:(id *)a2;
- (char)dbQueueAlbumWithGUID:(id)a0 outObject:(id *)a1 outName:(id *)a2 outCtag:(id *)a3 outForeignCtag:(id *)a4 outURLString:(id *)a5 outUserInfoData:(id *)a6 outClientOrgKey:(id *)a7;
- (char)dbQueueAssetCollectionContainsCommentsFromMeAssetCollectionGUID:(id)a0;
- (id)dbQueueAssetCollectionGUIDsInAlbumWithGUID:(id)a0;
- (char)dbQueueAssetCollectionMetadataWithAssetCollectionGUID:(id)a0 key:(id)a1 outValue:(id *)a2;
- (char)dbQueueAssetCollectionWithGUID:(id)a0 outObject:(id *)a1 outCtag:(id *)a2 outAlbumGUID:(id *)a3 outBatchDate:(id *)a4 outPhotoDate:(id *)a5 outPhotoNumber:(long long *)a6 outUserInfoData:(id *)a7;
- (char)dbQueueCheckToClearUnviewedStateOnAlbumWithGUID:(id)a0 info:(id)a1;
- (char)dbQueueCommentWithGUID:(id)a0 outObject:(id *)a1 outID:(unsigned long long *)a2 outTimestamp:(id *)a3 outAssetCollectionGUID:(id *)a4 outIsCaption:(char *)a5 outUserInfoData:(id *)a6;
- (char)dbQueueCommentWithID:(int)a0 assetCollectionGUID:(id)a1 outObject:(id *)a2 outGUID:(id *)a3 outTimestamp:(id *)a4 outIsCaption:(char *)a5 outUserInfoData:(id *)a6;
...
- (char)dbQueueInvitationWithAlbumGUID:(id)a0 outObject:(id *)a1 outInvitationGUID:(id *)a2 outEmail:(id *)a3 outUserInfoData:(id *)a4;
- (char)dbQueueInvitationWithGUID:(id)a0 outObject:(id *)a1 outAlbumGUID:(id *)a2 outEmail:(id *)a3 outUserInfoData:(id *)a4;
...
- (void)dbQueueSetUnviewedState:(char)a0 onAlbumWithGUID:(id)a1 info:(id)a2;
- (void)dbQueueSetUnviewedState:(char)a0 onAssetCollectionWithGUID:(id)a1 info:(id)a2;
...
- (char)errorIsCancellation:(id)a0;
...
- (char)isAlbumWithGUIDMarkedAsUnviewed:(id)a0;
- (char)isAssetCollectionWithGUIDMarkedAsUnviewed:(id)a0;
...
- (void)refreshCommentsForAssetCollectionWithGUID:(id)a0 resetSync:(char)a1;
- (void)refreshCommentsForAssetCollectionWithGUID:(id)a0 resetSync:(char)a1 info:(id)a2;
- (void)refreshContentOfAlbumWithGUID:(id)a0 resetSync:(char)a1;
- (void)refreshContentOfAlbumWithGUID:(id)a0 resetSync:(char)a1 info:(id)a2;
- (void)refreshResetSync:(char)a0;
- (void)refreshResetSync:(char)a0 info:(id)a1;
...
- (void)setMultipleContributorsEnabled:(char)a0 forAlbumWithGUID:(id)a1 completionBlock:(id /* block */)a2;
- (void)setMultipleContributorsEnabled:(char)a0 forAlbumWithGUID:(id)a1 info:(id)a2 completionBlock:(id /* block */)a3;
- (void)setPublicAccessEnabled:(char)a0 forAlbumWithGUID:(id)a1 completionBlock:(id /* block */)a2;
- (void)setPublicAccessEnabled:(char)a0 forAlbumWithGUID:(id)a1 info:(id)a2 completionBlock:(id /* block */)a3;
