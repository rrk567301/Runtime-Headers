...
- (void)_actionDidFinishWithError:(id)a0 album:(id)a1;
...
- (id)_albumForRequestFromParams:(id)a0;
...
- (void)checkForChangesResetSync:(char)a0 info:(id)a1;
- (void)checkForCommentChanges:(id)a0 inAlbumWithGUID:(id)a1 withClientOrgKey:(id)a2;
- (void)checkForUpdatesInAlbums:(id)a0 resetSync:(char)a1 info:(id)a2;
...
- (void)setMultipleContributorsEnabled:(char)a0 forAlbum:(id)a1 info:(id)a2 completionBlock:(id /* block */)a3;
- (void)setPendingRootCtag:(id)a0;
- (void)setPersistentObject:(id)a0 forKey:(id)a1;
- (void)setPublicAccessEnabled:(char)a0 forAlbum:(id)a1 info:(id)a2 completionBlock:(id /* block */)a3;
...
- (char)workQueueEndCommandWithError:(id)a0 command:(id)a1 params:(id)a2 albumGUID:(id)a3 assetCollectionGUID:(id)a4;
