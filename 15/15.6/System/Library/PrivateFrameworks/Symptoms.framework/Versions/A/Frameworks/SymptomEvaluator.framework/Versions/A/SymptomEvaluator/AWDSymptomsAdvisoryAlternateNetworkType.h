...
@property (nonatomic) char hasAdvice;
@property (nonatomic) int advice;
@property (nonatomic) char hasBailOutOf;
@property (nonatomic) int bailOutOf;
@property (nonatomic) char hasAdviceHeldForSecs;
@property (nonatomic) unsigned long long adviceHeldForSecs;
@property (nonatomic) char hasKernelProbingActivated;
@property (nonatomic) char kernelProbingActivated;
@property (nonatomic) char hasIngressTrigger;
@property (nonatomic) int ingressTrigger;
@property (nonatomic) char hasIngressTriggerOn;
@property (nonatomic) int ingressTriggerOn;
@property (nonatomic) char hasIngressTriggerMultiplier;
@property (nonatomic) unsigned int ingressTriggerMultiplier;
@property (nonatomic) char hasIngressTriggerPercentagex100;
@property (nonatomic) unsigned int ingressTriggerPercentagex100;
@property (nonatomic) char hasEgressTrigger;
@property (nonatomic) int egressTrigger;
@property (nonatomic) char hasEgressTriggerOn;
@property (nonatomic) int egressTriggerOn;
@property (nonatomic) char hasEgressTriggerMultiplier;
@property (nonatomic) unsigned int egressTriggerMultiplier;
@property (nonatomic) char hasEgressTriggerPercentagex100;
