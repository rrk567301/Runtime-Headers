...
@property (nonatomic) char isHelper;
...
- (char)predicateFullyAllowsEvaluation:(id)a0;
- (void)_saveAndUnloadAllState;
- (void)clientEvent:(id)a0 isAddEvent:(char)a1;
- (void)clientTransactionsRelease;
- (id)entityDictionaryFromObject:(id)a0 attributeKeys:(id)a1 relationshipKeys:(id)a2 includeObjectID:(char)a3;
