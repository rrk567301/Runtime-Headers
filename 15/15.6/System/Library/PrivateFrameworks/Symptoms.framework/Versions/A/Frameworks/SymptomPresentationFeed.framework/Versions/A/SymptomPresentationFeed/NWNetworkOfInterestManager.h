...
- (void)_commonFinalizeRequestFor:(id)a0 orPredicate:(id)a1 options:(id)a2 isStaged:(char)a3;
- (void)_commonTrackRequestFor:(unsigned char)a0 isAny:(char)a1 isBuiltin:(char)a2 options:(id)a3 isCustom:(id)a4;
- (void)_unloadState;
...
- (void)proxyHaveNOIs:(id)a0 tornDown:(char)a1;
