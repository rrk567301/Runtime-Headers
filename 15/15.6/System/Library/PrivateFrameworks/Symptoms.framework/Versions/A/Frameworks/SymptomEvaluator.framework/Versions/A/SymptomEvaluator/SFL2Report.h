...
@property (nonatomic) char cellularSliceActive;
@property (nonatomic) char cellularBand;
...
@property (nonatomic) char cellularOutranksWiFi;
...
@property (nonatomic) char wifiIsHotspot;
@property (nonatomic) char wifiIsApplePersonalHotspot;
