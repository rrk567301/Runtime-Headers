...
- (void)shutdown;
- (void)assertFactString:(id)a0 module:(id)a1 asSymptom:(char)a2 reply:(id /* block */)a3;
...
- (char)assertEntitlement:(id)a0 entitlement:(unsigned long long)a1 orWaiveOnIntent:(id)a2;
- (void)clientTransactionsRelease;
- (id)initWithQueue:(id)a0 noiEngine:(id)a1 isHelper:(char)a2;
