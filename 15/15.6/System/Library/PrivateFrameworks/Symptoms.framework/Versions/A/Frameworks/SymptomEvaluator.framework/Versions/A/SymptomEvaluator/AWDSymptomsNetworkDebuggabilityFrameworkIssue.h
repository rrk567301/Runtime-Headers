...
@property (nonatomic) char hasNdfCount;
@property (nonatomic) unsigned long long ndfCount;
@property (nonatomic) char hasNdfDuration;
@property (nonatomic) unsigned long long ndfDuration;
@property (nonatomic) char hasNdfDampeningFactor;
@property (nonatomic) unsigned long long ndfDampeningFactor;
@property (nonatomic) char hasNdfTriggerType;
