...
- (id)_clientNOIEvent:(id)a0 forNOIs:(id)a1 isAddEvent:(char)a2;
- (void)_collectBasicFieldsForRRCMetric:(id)a0 durationUsecs:(unsigned long long)a1;
- (void)_collectDataUsageFieldsForRRCMetric:(id)a0 layer2EgressMetric:(id)a1 underrun:(char *)a2;
...
- (void)_coreNOIMembershipChangeOn:(id)a0 forNOIs:(id)a1 isAddEvent:(char)a2;
...
- (void)clientEvent:(id)a0 isAddEvent:(char)a1;
