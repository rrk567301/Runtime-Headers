...
- (id)eventPayload;
- (void)_populateNetworkPropertiesOnCellRelay:(id)a0 isIngress:(char)a1;
- (void)_populateNetworkPropertiesOnWiFiRelay:(id)a0 isIngress:(char)a1;
- (void)_populateWifiPropertiesToCAPayload:(id)a0 isIngress:(char)a1;
- (void)populateNetworkPropertiesOnWiFiRelay:(id)a0 cellRelay:(id)a1 isIngress:(char)a2;
- (BOOL)postCAEvent;
