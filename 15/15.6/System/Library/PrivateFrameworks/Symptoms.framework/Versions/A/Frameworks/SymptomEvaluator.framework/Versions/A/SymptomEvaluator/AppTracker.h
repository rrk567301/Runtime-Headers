...
@property char isADaemon;
@property char sentFlowCountExceededPolicySymptom;
@property char sentThunderingHerdFlowCountExceededPolicySymptom;
...
- (void)sendFlowCount:(unsigned long long)a0 exceededPolicyThreshold:(unsigned long long)a1 isLikelyThunderingHerd:(char)a2;
