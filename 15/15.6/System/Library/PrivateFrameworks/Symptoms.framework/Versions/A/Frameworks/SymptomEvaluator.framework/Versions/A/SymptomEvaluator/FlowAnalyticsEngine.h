...
+ (char)appBundleIdentifierIsWebBrowser:(id)a0;
...
- (char)_appBundleIdentifierIsWebBrowser:(id)a0;
- (id)_appExperienceForApp:(id)a0 forTime:(id)a1;
- (void)_applyCountsTo:(id)a0 fromLiveUsage:(id)a1 mustReset:(char)a2;
- (void)_appsWithFlowsPassingTest:(id /* block */)a0 replyQueue:(id)a1 reply:(id /* block */)a2;
- (char)_bundleBackgroundAudioCapable:(id)a0;
...
- (char)_requiresUserValidationPredicateForEntity:(id)a0;
- (void)_saveAndUnloadSelectState;
- (void)_sendStatisticsReport:(id)a0;
- (void)_setupDailyMaintenanceActivity;
- (char)_setupLocalCache;
- (void)_setupNotificationCenterAndRelayObservers;
- (char)_setupObjectAnalyticsWorkspaces:(id)a0;
- (void)_setupPrefsStoreObserving;
- (char)_setupSignalHandling;
- (char)_shouldProcessDomainInfoForBundleID:(id)a0 implicit:(id *)a1 knownToLaunchServices:(char *)a2 ignoredInLaunchServices:(char *)a3 isWebBrowser:(char *)a4;
- (char)_shouldSendStatisticsReport:(id)a0;
- (void)_startFlowMonitoring;
- (void)_startMonitoringNetworkInterface:(int)a0 usingThreshold:(unsigned long long)a1;
- (void)_updateLiveUsage:(id)a0 wifiIn:(long long)a1 wifiOut:(long long)a2 cellIn:(long long)a3 cellOut:(long long)a4 wiredIn:(long long)a5 wiredOut:(long long)a6 btIn:(long long)a7 btOut:(long long)a8 xIn:(long long)a9 xOut:(long long)a10 isJumboFlow:(char)a11 isExpensive:(char)a12 closing:(char)a13;
- (id)getOption:(id)a0;
