...
+ (unsigned long long)uniqStallCountForInterfaceType:(long long)a0 stallType:(unsigned long long)a1 foregroundOnly:(char)a2 since:(id)a3;
...
- (void)processStall:(id)a0 procName:(id)a1 endpoint:(id)a2 foreground:(char)a3 interfaceType:(long long)a4 stallType:(unsigned long long)a5;
