...
@property (nonatomic) char hasInternetDNS;
...
+ (id)epochWithPrimaryKey:(id)a0 interfaceName:(id)a1 isCell:(BOOL)a2 maxBars:(int)a3 roamingEvent:(BOOL)a4 roamingAttrs:(long long)a5 supportsIPv4:(char)a6 supportsIPv6:(char)a7 inWorkspace:(id)a8 andQueue:(id)a9;
...
- (id)_initWithPrimaryKey:(id)a0 interfaceName:(id)a1 isCell:(BOOL)a2 maxBars:(int)a3 roamingEvent:(BOOL)a4 roamingAttrs:(long long)a5 supportsIPv4:(char)a6 supportsIPv6:(char)a7 inWorkspace:(id)a8 andQueue:(id)a9;
...
- (id)establishPartials:(id)a0 withFlag:(char)a1;
