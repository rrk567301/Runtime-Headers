...
- (id)_getUsageKeyWithProcess:(id)a0 bundleID:(id)a1 extension:(id)a2 isProcNameKey:(char)a3 showExtension:(char)a4;
- (id)_performRollUp:(unsigned int)a0 andMetadata:(unsigned int)a1 from:(id)a2 until:(id)a3;
- (id)_composeLiveUsagePredicateWithNames:(id)a0 kind:(id)a1 isProcNameKey:(char)a2 isSweep:(BOOL *)a3;
...
- (id)createEndpointEntryFrom:(id)a0 withKey:(id)a1 showDetails:(char)a2;
