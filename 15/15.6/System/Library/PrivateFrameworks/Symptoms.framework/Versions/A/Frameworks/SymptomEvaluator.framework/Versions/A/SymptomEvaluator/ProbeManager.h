...
- (void)icmpPingProbe:(id)a0 echoRequestSent:(id)a1 success:(char)a2;
- (void)icmpPingProbe:(id)a0 echoResponseReceived:(id)a1 success:(char)a2;
...
- (void)bonjourServiceAdded:(id)a0 isUpdatedService:(char)a1;
