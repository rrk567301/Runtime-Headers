...
@property (readonly, nonatomic) unsigned long long currentDBSizeInBytes;
@property (readonly, nonatomic) unsigned long long fileSystemSizeInBytes;
...
+ (id)workspaceWithName:(id)a0 atPath:(id)a1 objectModelName:(id)a2 objectModelBundle:(id)a3 useReadOnly:(char)a4 legacyDBContainerPathToMigrate:(id)a5;
