...
- (char)addModuleNamed:(id)a0 withConstruct:(id)a1;
- (char)addNewConstruct:(id)a0;
- (void *)addObjectToEnvironment:(id)a0;
- (void *)assertFactString:(id)a0 moduleName:(id)a1;
- (char)conservePrettyPrintMemory:(char)a0;
- (id)consoleBuffer;
...
- (char)loadConstructsForModule:(id)a0;
- (id)loadDataSection:(id)a0;
- (void)logFacts:(long long)a0;
- (void)logMemoryStatistics:(id)a0;
- (void)logMemoryStatistics:(id)a0 verboseOnly:(char)a1;
...
- (void)unloadConstructsForModule:(id)a0 unconditionally:(char)a1;
