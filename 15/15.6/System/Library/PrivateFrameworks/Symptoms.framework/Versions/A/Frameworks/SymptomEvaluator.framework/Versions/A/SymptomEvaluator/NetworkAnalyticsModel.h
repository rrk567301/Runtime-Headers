@class NSCalendar, NSString, AnalyticsWorkspace, NSArray, NSDate, NSObject, ImpoExpoService;
...
+ (double)fetchPredictionErrorForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4;
+ (id)fetchPredictionsForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4 error:(id *)a5;
+ (double)fetchTrainingProgressForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4;
...
- (double)_fetchPredictionErrorForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4;
- (id)_fetchPredictionsForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4 error:(id *)a5;
- (double)_fetchTrainingProgressForInterfaceType:(long long)a0 isAny:(char)a1 isBuiltin:(char)a2 scopedToLOI:(long long)a3 hasCustomSignature:(id)a4;
