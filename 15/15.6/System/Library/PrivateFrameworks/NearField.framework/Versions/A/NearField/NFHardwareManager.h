...
@property (readonly, nonatomic) char isBackgroundTagReadingAvailable;
@property (nonatomic) char suspendBackgroundTagReading;
...
- (char)hasCard;
- (char)areFeaturesSupported:(unsigned long long)a0 outError:(id *)a1;
- (unsigned int)checkUserBlessing:(id)a0;
- (unsigned int)checkUserBlessing:(id)a0 hasCards:(char *)a1;
- (void)didChangeRadioState:(char)a0;
...
- (char)setFieldDetectEnabled:(char)a0;
...
- (id)disableHeadless;
- (char)refreshSecureElementsWithError:(id *)a0;
- (id)startContactlessPaymentSession:(id /* block */)a0;
- (void)configureReaderModeRFForTransitPartner:(char)a0 transitPartner:(unsigned int)a1 callback:(id /* block */)a2;
...
- (id)_startLoyaltyAndContactlessPaymentSession:(id /* block */)a0 force:(char)a1;
...
- (id)configureHeadlessFactoryMode:(char)a0;
...
- (char)isExpressAppletTypeSupported:(unsigned char)a0;
...
- (id)rfSettings;
- (char)secureElementBootHistory:(id *)a0;
- (id)secureElementWithIdentifier:(id)a0;
- (void)secureElementWithIdentifier:(id)a0 didChangeRestrictedMode:(char)a1;
...
- (id)setChipscope:(char)a0;
- (id)setRadioEnabledSetting:(char)a0;
...
- (id)startSecureElementManagerSessionWithPriority:(char)a0 callback:(id /* block */)a1;
...
- (char)triggerCrash:(unsigned short)a0;
- (char)triggerDelayedWake:(unsigned char)a0;
