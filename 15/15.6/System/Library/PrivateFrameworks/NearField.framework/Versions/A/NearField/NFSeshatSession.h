...
+ (char)isTransientError:(struct { unsigned int x0; unsigned int x1; })a0;
...
- (struct { unsigned int x0; unsigned int x1; })authorizeUpdate:(char)a0 slotIndex:(unsigned char)a1 userToken:(id)a2 outWriteCount:(unsigned int *)a3;
- (struct { unsigned int x0; unsigned int x1; })authorizeUpdate:(char)a0 slotIndex:(unsigned char)a1 userToken:(id)a2 outWriteCount:(unsigned int *)a3 trackingError:(id *)a4;
