...
- (id)initWithSourceURLs:(id)a0 destinationURL:(id)a1 overwrite:(char)a2 useFallback:(char)a3 sourceEntityDataPayloads:(id)a4 sourceEntityDataContentTypes:(id)a5 sourceEntityETags:(id)a6 accountInfoProvider:(id)a7 taskManager:(id)a8;
- (void)startTaskGroup;
