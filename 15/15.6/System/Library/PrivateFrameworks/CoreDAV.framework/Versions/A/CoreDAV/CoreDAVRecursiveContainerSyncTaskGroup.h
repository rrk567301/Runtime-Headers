...
- (id)initWithFolderURL:(id)a0 previousCTag:(id)a1 previousPTag:(id)a2 previousSyncToken:(id)a3 actions:(id)a4 syncItemOrder:(char)a5 context:(id)a6 accountInfoProvider:(id)a7 taskManager:(id)a8;
...
- (char)shouldSyncChildWithResourceType:(id)a0;
- (void)syncAway;
