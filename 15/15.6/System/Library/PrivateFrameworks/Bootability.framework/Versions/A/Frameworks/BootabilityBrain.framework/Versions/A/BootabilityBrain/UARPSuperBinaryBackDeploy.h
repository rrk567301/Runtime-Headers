@class NSData, NSString, NSMutableDictionary, NSMutableString, UARPAssetVersionBackDeploy, NSObject, NSMutableArray, NSNumber;
...
- (void).cxx_destruct;
- (void)log:(id)a0;
- (char)expandMetaData:(struct UARPSuperBinaryHeader { unsigned int x0; unsigned int x1; unsigned int x2; struct UARPVersion { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; } *)a0;
- (id)generatePersonalizedSuperBinary;
- (id)getTlvs;
- (char)preparePayload:(struct UARPPayloadHeader2 { unsigned int x0; struct UARP4ccTag { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; } x1; struct UARPVersion { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; } *)a0;
- (id)composeTSSRequest:(unsigned long long)a0 asMeasurement:(char)a1;
- (char)expandSuperBinary;
- (char)expandTLVs;
...
- (char)generateTatsuMeasurements:(unsigned long long)a0 relativeURL:(id)a1;
...
- (id)personalizeSuperBinary:(unsigned long long)a0 signingServer:(id)a1 ssoOnly:(char)a2;
