...
@property char interactive;
@property (retain) LAContext *context;
@property char successfullyEvaluated;

- (void).cxx_destruct;
- (id)_recoveryUserGUIDForUsername:(id)a0 volume:(id)a1;
- (unsigned int)_uidForUsername:(id)a0;
- (id)evaluateWithError:(id *)a0;
- (id)initWithUsername:(id)a0 password:(id)a1 localAuthenticationContext:(id)a2 volumeGroupUUID:(id)a3 interactive:(char)a4;
