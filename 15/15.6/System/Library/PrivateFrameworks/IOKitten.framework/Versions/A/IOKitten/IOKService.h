...
- (char)isServiceAuthorizedForOpenAllowInteraction:(char)a0;
- (char)matchesPropertyTable:(id)a0 error:(id *)a1;
- (char)requestProbeWithOptions:(unsigned int)a0 error:(id *)a1;
