...
- (oneway void)_client_coordinatorDidCompleteSuccessfullyWithUUID:(id)a0 forAppAtURL:(id)a1;
...
- (void)registerAppInstallCoordinatorForUpdates:(id)a0 notifyDaemon:(char)a1;
- (void)registerDataPromiseForUpdates:(id)a0 notifyDaemon:(char)a1;
