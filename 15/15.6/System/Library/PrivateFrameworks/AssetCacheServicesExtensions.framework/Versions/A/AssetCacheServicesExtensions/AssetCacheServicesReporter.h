...
- (char)doRanges:(id)a0 containAddress:(id)a1;
- (id)keyPath:(id)a0 byAppendingKey:(id)a1;
- (id)locateServersWithOptions:(id)a0;
- (id)prettyRanges:(id)a0;
- (void)reportCachedPublicIPAddressRangesAndFavoredServerRangesWithKeyPath:(id)a0 routing:(id)a1;
- (void)reportCachedServersWithKeyPath:(id)a0 routing:(id)a1;
- (void)reportFreshPublicIPAddressRangesAndFavoredServerRangesWithKeyPath:(id)a0 routing:(id)a1;
- (void)reportFreshServersWithKeyPath:(id)a0 routing:(id)a1;
- (void)reportMightHaveWithKeyPath:(id)a0 routing:(id)a1;
