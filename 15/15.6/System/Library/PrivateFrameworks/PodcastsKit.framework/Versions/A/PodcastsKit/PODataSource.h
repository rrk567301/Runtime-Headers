...
@property char constructingData;
...
- (void)constructRevisionFromDictionary:(id)a0 isPodcastCollections:(char)a1 isDelete:(char)a2;
- (void)constructRevisionsFromDictionary:(id)a0 isPodcastCollections:(char)a1;
