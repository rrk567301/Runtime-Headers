...
- (id)initWithApplicationID:(struct __CFString { } *)a0 storeID:(struct __CFString { } *)a1 shared:(char)a2 additionalSource:(char)a3 containerPath:(struct __CFString { } *)a4;
...
- (id)initWithApplicationID:(struct __CFString { } *)a0 shared:(char)a1;
- (id)initWithApplicationID:(struct __CFString { } *)a0 storeID:(struct __CFString { } *)a1 shared:(char)a2;
- (id)initWithApplicationID:(struct __CFString { } *)a0 storeID:(struct __CFString { } *)a1 shared:(char)a2 additionalSource:(char)a3;
- (id)initWithApplicationID:(struct __CFString { } *)a0 storeID:(struct __CFString { } *)a1 shared:(char)a2 additionalSource:(char)a3 containerPath:(struct __CFString { } *)a4 storeType:(long long)a5;
- (id)objectForKey:(id)a0 error:(id *)a1;
- (char)removeObjectForKey:(id)a0 error:(id *)a1;
- (void)scheduleRemoteSynchronization;
- (void)setDefaultsConfiguration:(id)a0;
- (char)setObject:(id)a0 forKey:(id)a1 error:(id *)a2;
