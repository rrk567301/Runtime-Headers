...
@property (nonatomic) char didLogFaultForEntitlements;
@property char needsChangeDictionaryFromDaemon;
@property (retain, nonatomic) NSMutableDictionary *cachedObjects;
@property (retain, nonatomic) NSLock *cacheLock;
@property (nonatomic) char hasFullCachedDictionary;
@property (readonly, nonatomic) char isSyncingWithCloud;
@property unsigned long long syncingWithCloudCounter;
@property (nonatomic) char useTestServer;
...
+ (id)connectionUsingTestServer:(char)a0;
...
+ (char)hasPerformedAppLaunchSyncForStoreIdentifier:(id)a0;
...
+ (void)setUseTestServerByDefault:(char)a0;
...
- (unsigned char)_synchronize:(char)a0;
...
- (char)getObject:(id *)a0 forKey:(id)a1 error:(id *)a2;
- (unsigned char)hasExternalChanges;
- (id)initWithStoreConfiguration:(id)a0;
- (char)isUIFrameworkLinkedInDaemon;
