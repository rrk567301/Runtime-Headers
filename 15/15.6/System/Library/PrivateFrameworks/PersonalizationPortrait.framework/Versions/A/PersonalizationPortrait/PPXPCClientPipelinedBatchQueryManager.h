...
- (void)handleReplyWithName:(id)a0 batch:(id)a1 isLast:(char)a2 error:(id)a3 queryId:(unsigned long long)a4 completion:(id /* block */)a5;
- (char)syncExecuteQueryWithName:(id)a0 error:(id *)a1 queryInitializer:(id /* block */)a2 handleBatch:(id /* block */)a3;
