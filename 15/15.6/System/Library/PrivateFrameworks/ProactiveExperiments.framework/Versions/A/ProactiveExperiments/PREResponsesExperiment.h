@class _PASLock, RKMessageResponseManager, _PASLRUCache, PREPredictionExemptTermsDetector, TIPreferencesController, NSUserDefaults;
...
@property (nonatomic) char registerDisplayed;
@property (nonatomic) char includeCannedResponses;
@property (nonatomic) char includeCustomResponses;
@property (nonatomic) char includeResponsesToRobots;
@property (nonatomic) char useResponseKitAsFallback;

+ (id)sharedManager;
+ (char)_isStringEmpty:(id)a0;
...
+ (char)_isPreferredLocaleValid:(id)a0;
+ (int)_preInputMethodFrom:(id)a0;
+ (id)_rawStringsForMessages:(id)a0 excludingTapBacks:(char)a1;
+ (char)_shouldInsertSuggestion:(id)a0 forExistingSuggestions:(id)a1;
...
- (id)fullNonEditableSuggestionsListForMessage:(id)a0 context:(id)a1 additionalSenderMessages:(id)a2 date:(id)a3 keyboardLanguageID:(id)a4 keyboardLanguageLastChangedDate:(id)a5 recipients:(id)a6 includeDynamicSuggestions:(char)a7;
- (void)fullNonEditableSuggestionsListForMessage:(id)a0 context:(id)a1 additionalSenderMessages:(id)a2 date:(id)a3 keyboardLanguageID:(id)a4 keyboardLanguageLastChangedDate:(id)a5 recipients:(id)a6 includeDynamicSuggestions:(char)a7 completion:(id /* block */)a8;
...
- (id)nonEditableSuggestionsForMessage:(id)a0 messageDate:(id)a1 senderID:(id)a2 recipientHandles:(id)a3 outgoingMessageHistory:(id)a4 keyboardLanguageID:(id)a5 keyboardLanguageLastChangedDate:(id)a6 includeDynamicSuggestions:(char)a7;
- (void)nonEditableSuggestionsForMessage:(id)a0 messageDate:(id)a1 senderID:(id)a2 recipientHandles:(id)a3 outgoingMessageHistory:(id)a4 keyboardLanguageID:(id)a5 keyboardLanguageLastChangedDate:(id)a6 includeDynamicSuggestions:(char)a7 completion:(id /* block */)a8;
- (id)nonEditableSuggestionsForMessage:(id)a0 messageDate:(id)a1 senderID:(id)a2 recipients:(id)a3 outgoingMessageHistory:(id)a4 keyboardLanguageID:(id)a5 keyboardLanguageLastChangedDate:(id)a6 includeDynamicSuggestions:(char)a7;
- (void)nonEditableSuggestionsForMessage:(id)a0 messageDate:(id)a1 senderID:(id)a2 recipients:(id)a3 outgoingMessageHistory:(id)a4 keyboardLanguageID:(id)a5 keyboardLanguageLastChangedDate:(id)a6 includeDynamicSuggestions:(char)a7 completion:(id /* block */)a8;
...
- (void)predictionsForRequest:(id)a0 heads:(id)a1 completion:(id /* block */)a2;
- (void)predictionsForRequest:(id)a0 plistPath:(id)a1 espressoBinPath:(id)a2 vocabPath:(id)a3 heads:(id)a4 completion:(id /* block */)a5;
- (void)primeResponsesExperimentsIfNeeded;
- (void)registerGenerationWithPreResponseItems:(id)a0 language:(id)a1 isCached:(char)a2 responseTimePerf:(unsigned long long)a3 promptMessage:(id)a4 generationStatus:(int)a5;
...
- (char)shouldUseDefaultRKTreatmentForLanguage:(id)a0;
