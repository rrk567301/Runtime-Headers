...
- (char)interfaceRequest:(id)a0 bRequestType:(unsigned long long)a1 direction:(int)a2 selector:(unsigned long long)a3 entityID:(unsigned long long)a4 error:(id *)a5;
- (char)parseCSDescriptorsForInterface;
- (char)parseConfigurationDescriptor;
