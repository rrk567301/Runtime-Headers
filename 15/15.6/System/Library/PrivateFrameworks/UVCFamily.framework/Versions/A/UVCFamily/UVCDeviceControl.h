...
- (char)setCurrentValue:(id)a0 error:(id *)a1;
- (void)handleInterruptData:(id)a0 attributes:(unsigned char)a1;
- (id)autoControls;
- (id)parseControl;
- (char)setControlInfo:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 2; })a0 error:(id *)a1;
