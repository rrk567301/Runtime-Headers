...
- (char)changeFrameInterval:(unsigned long long)a0 error:(id *)a1;
...
- (char)doBulkEndpointRead:(id)a0 error:(id *)a1;
- (char)doBulkStream:(unsigned long long)a0 error:(id *)a1;
- (char)doCommitControl:(id)a0 error:(id *)a1;
- (char)doIsochEndpointRead:(id)a0 frameListBuffer:(id)a1 numberOfPacketsPerRequest:(unsigned long long)a2 bInterval:(unsigned char)a3 bufferSize:(unsigned long long)a4 error:(id *)a5;
- (char)doIsochStream:(unsigned long long)a0 streamFormat:(id)a1 frameInterval:(unsigned long long)a2 error:(id *)a3;
- (char)doProbeControl:(id)a0 frameRate:(unsigned long long)a1 probeData:(id *)a2 error:(id *)a3;
