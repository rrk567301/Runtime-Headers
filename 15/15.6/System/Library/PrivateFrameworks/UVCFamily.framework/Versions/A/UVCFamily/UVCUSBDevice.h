...
- (char)createDeviceInterface:(id)a0 configurationDescriptor:(const struct IOUSBConfigurationDescriptor { unsigned char x0; unsigned char x1; unsigned short x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; } *)a1;
- (char)createDeviceInterfaces:(id)a0;
...
- (char)parseCurrentConfigurationForHostDevice:(id)a0;
- (char)parseDevice:(unsigned int)a0;
- (char)setupDeviceForInterface:(unsigned int)a0;
- (char)setupWithAssociation:(id)a0 hostDevice:(id)a1;
