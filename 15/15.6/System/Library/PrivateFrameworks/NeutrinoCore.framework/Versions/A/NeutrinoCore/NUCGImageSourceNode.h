...
@protocol OS_dispatch_queue, NUSemanticStyleProperties;
...
- (char)_loadSemanticStylesProperties:(out id *)a0;
- (char)_setAuxiliaryImagePropertiesFromCGProperties:(id)a0 error:(out id *)a1;
- (char)_setGeometryFromProperties:(id)a0 error:(out id *)a1;
...
- (char)supportsPipelineState:(id)a0 error:(out id *)a1;
- (char)useEmbeddedPreview;
