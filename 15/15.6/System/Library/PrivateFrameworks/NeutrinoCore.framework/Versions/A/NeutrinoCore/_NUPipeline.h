...
- (char)bind:(id)a0 to:(id)a1 error:(out id *)a2;
- (char)bindInputChannel:(id)a0 to:(id)a1 error:(out id *)a2;
- (char)bindInputPort:(id)a0 to:(id)a1 error:(out id *)a2;
- (char)canConnectInputPort:(id)a0 toOutputPort:(id)a1 error:(out id *)a2;
- (char)connect:(id)a0 input:(id)a1 to:(id)a2 error:(out id *)a3;
- (char)connect:(id)a0 input:(id)a1 to:(id)a2 key:(id)a3 error:(out id *)a4;
- (char)connect:(id)a0 input:(id)a1 to:(id)a2 output:(id)a3 error:(out id *)a4;
- (char)connect:(id)a0 to:(id)a1 output:(id)a2 error:(out id *)a3;
- (char)connectInputPort:(id)a0 toOutputPort:(id)a1 error:(out id *)a2;
...
- (char)validateInputPort:(id)a0 error:(out id *)a1;
- (char)validateOutputPort:(id)a0 error:(out id *)a1;
