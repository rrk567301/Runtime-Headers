...
- (char)_registerSchema:(id)a0 error:(out id *)a1;
- (char)_registerVersion:(id)a0 withOriginalIdentifier:(id)a1 error:(out id *)a2;
- (id)_schemaWithIdentifier:(id)a0;
- (id)latestVersionWithNamespace:(id)a0 name:(id)a1;
- (char)registerSchema:(id)a0 error:(out id *)a1;
- (char)registerSchemas:(id)a0 error:(out id *)a1;
