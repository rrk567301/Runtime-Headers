...
+ (char)usingSharedStyleEngineForUsage:(id)a0 withMetalCommandQueue:(id)a1 configuration:(id)a2 tuningParams:(id)a3 perform:(id /* block */)a4;
...
- (char)matchesTuningParameters:(id)a0;
- (char)matchesUsage:(id)a0 metalCommandQueue:(id)a1 configuration:(id)a2 tuning:(id)a3;
- (id)memoryDescriptor;
- (void)resetProcessor;
- (char)setupProcessor;
