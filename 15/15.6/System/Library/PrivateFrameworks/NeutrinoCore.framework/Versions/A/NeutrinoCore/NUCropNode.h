...
@property (readonly) char resetCleanAperture;
...
- (id)initWithRect:(struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })a0 input:(id)a1 resetCleanAperture:(char)a2 settings:(id)a3;
...
- (char)scaledCropOrigin:(struct CGPoint { double x0; double x1; } *)a0 error:(out id *)a1;
