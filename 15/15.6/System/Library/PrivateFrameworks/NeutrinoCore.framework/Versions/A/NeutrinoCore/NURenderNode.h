...
@property (getter=isCached) char cached;
...
@property (readonly) char isGeometryNode;
...
- (id)geometryNode;
- (char)hasCyclicalDependencyForInput:(id)a0;
...
- (char)isEqualToSettingsAndInputs:(id)a0;
