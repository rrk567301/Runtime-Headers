...
@property (nonatomic) char styleDataIsFloat16;
...
+ (id)legacySemanticStylePropertiesFromData:(id)a0 fromVideo:(char)a1 keyTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 error:(out id *)a3;
+ (id)semanticStylePropertiesFromData:(id)a0 fromVideo:(char)a1 keyTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 error:(out id *)a3;
