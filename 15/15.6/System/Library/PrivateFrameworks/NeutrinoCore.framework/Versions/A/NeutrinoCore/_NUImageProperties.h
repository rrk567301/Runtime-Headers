...
@property (readonly) char hasGainMap;
...
+ (char)getGainMapHeadroom:(double *)a0 fromMetadata:(struct CGImageMetadata { } *)a1;
+ (char)setGainMapHeadroom:(double)a0 toMakerNote:(id)a1;
+ (void)_computeMeteorPlusGain:(double *)a0 gainMapValue:(double *)a1 forContentHeadroom:(double)a2;
+ (char)getGainMapHeadroom:(double *)a0 fromMakerNote:(id)a1;
+ (char)setGainMapHeadroom:(double)a0 toMetadata:(struct CGImageMetadata { } *)a1;
