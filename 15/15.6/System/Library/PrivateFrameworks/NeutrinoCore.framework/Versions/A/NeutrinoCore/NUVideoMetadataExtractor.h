...
+ (char)canProvideMetadataForAVAsset:(id)a0;
...
- (char)interpolatedFrameFromMetadata:(const struct { unsigned short x0; float x1[9]; unsigned long long x2; unsigned long long x3; unsigned char x4; char x5; unsigned char x6; char x7[13]; } *)a0;
- (char)interpolatedFrameValidFromMetadata:(const struct { unsigned short x0; float x1[9]; unsigned long long x2; unsigned long long x3; unsigned char x4; char x5; unsigned char x6; char x7[13]; } *)a0;
