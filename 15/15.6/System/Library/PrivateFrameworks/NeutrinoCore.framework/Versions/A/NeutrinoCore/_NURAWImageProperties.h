...
@property char isAppleProRaw;
@property char isSensorRawCapture;
@property char isUnifiedBracketingHDRCapture;
@property char isDeepFusion;
@property char hasLensCorrection;
