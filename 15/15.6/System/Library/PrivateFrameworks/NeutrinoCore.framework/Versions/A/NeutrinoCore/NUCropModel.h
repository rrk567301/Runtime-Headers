...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })getCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 newCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 pitch:(double)a2 yaw:(double)a3 roll:(double)a4 constrainWithAnchorPoint:(struct CGPoint { double x0; double x1; })a5 strict:(char)a6 aspectRatioIsFreeForm:(char)a7 hitVertexId:(unsigned long long *)a8;
