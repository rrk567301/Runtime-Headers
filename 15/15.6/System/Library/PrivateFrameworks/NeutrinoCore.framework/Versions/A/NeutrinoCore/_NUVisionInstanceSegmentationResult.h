...
- (id)initWithObservation:(id)a0 usingTargetPoints:(char)a1 observationOrientation:(long long)a2 observationScale:(struct CGSize { double x0; double x1; })a3 perInstanceProperties:(id)a4;
