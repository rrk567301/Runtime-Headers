...
- (long long)fillBufferWithPattern8:(unsigned long long)a0;
- (char)isValidInRect:(struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })a0;
- (char)isValidInRegion:(id)a0;
