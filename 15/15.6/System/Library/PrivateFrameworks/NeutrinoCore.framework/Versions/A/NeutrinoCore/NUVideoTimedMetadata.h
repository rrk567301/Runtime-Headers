...
@property (readonly) char interpolatedFrameValid;
@property (readonly) char interpolatedFrame;
...
- (void)setInterpolatedFrame:(char)a0;
- (void)setInterpolatedFrameValid:(char)a0;
