...
@property (class, readonly, nonatomic) char supportsPacked10BitsFormats;
@property (class, readonly, nonatomic) char supportsUniversalCompressionFormats;
@property (class, readonly, nonatomic) char supportsRenderingToCompressedFormats;
@property (class, readonly, nonatomic) NUPixelFormat *RG16;
@property (class, readonly, nonatomic) NUPixelFormat *R16;
@property (class, readonly, nonatomic) NUPixelFormat *R16h;
@property (class, readonly, nonatomic) NUPixelFormat *R32f;
...
@property (readonly, nonatomic) char isYCC;
...
@property (readonly, nonatomic) char supportsExtendedRange;
