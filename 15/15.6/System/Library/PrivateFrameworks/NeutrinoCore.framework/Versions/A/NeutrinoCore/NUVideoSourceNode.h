@class AVAudioMixInputParameters, AVAsset, NSDictionary, NSURL, NSData, NSObject, NSArray;
...
- (id)_settingsForPipelineState:(id)a0;
- (id)asset:(out id *)a0;
- (id)initWithVideoData:(id)a0 identifier:(id)a1 options:(id)a2;
- (char)loadAudioMixParameters:(out id *)a0;
- (char)loadAuxiliaryVideoTrackProperties:(out id *)a0;
