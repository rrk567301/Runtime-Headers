...
+ (char)asset:(id)a0 containsDuplicatePTSSamples:(char *)a1 assetTrack:(id)a2 error:(out id *)a3;
+ (char)assetIsCinematicAudio:(id)a0;
+ (id)assetReaderAudioSettingsForTrackType:(char)a0;
+ (id)assetWriterAudioSettingsForAudioTrackFormatDescription:(struct opaqueCMFormatDescription { } *)a0;
+ (id)assetWriterAudioSettingsForTrackWithSampleRate:(double)a0 isAmbisonic:(char)a1;
+ (char)audioTrackIsCinematicAudio:(id)a0;
...
+ (struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })cleanApertureOfTrack:(id)a0 oriented:(char)a1;
...
+ (char)compositionInstructions:(id)a0 areEqualToCompositionInstructions:(id)a1;
...
+ (id)defaultExportCodecForHDRVideo:(char)a0;
...
+ (struct { long long x0; long long x1; })encodedPixelSizeOfTrack:(id)a0 oriented:(char)a1;
...
+ (char)isAVAssetDolbyProfile5:(id)a0 error:(out id *)a1;
+ (char)isAVAssetHDR:(id)a0 error:(out id *)a1;
+ (char)isAssetUnsupportedCorruptPortraitVideo:(id)a0;
+ (char)isAssetUnsupportedLegacyPortraitVideo:(id)a0;
+ (char)isMetadataTrackStillImageDisplayTimeMarkerInLivePhoto:(id)a0;
+ (char)isMetadataTrackWithLivePhotoInfo:(id)a0;
+ (char)isMetadataTrackWithStillImageDimensionsInLivePhoto:(id)a0;
+ (char)isMetadataTrackWithStillImageTransformInLivePhoto:(id)a0;
+ (char)metadataTrack:(id)a0 containsIdentifier:(id)a1;
+ (char)metadataTrack:(id)a0 containsIdentifiers:(id)a1;
+ (char)metadataTrackContainsCinematicAudioData:(id)a0;
+ (char)metadataTrackContainsLegacyCinematicAudioData:(id)a0;
+ (char)metadataTrackContainsPortraitVideoData:(id)a0;
+ (char)metadataTrackContainsSemanticStyleData:(id)a0;
...
+ (struct { long long x0; long long x1; })naturalSizeOfTrack:(id)a0 oriented:(char)a1;
...
+ (char)readFromReader:(id)a0 andWriteToWriter:(id)a1 stillImageTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 createCustomMetadata:(char)a3 geometryTransform:(id)a4 inputSize:(struct CGSize { double x0; double x1; })a5 outputSize:(struct CGSize { double x0; double x1; })a6 progress:(id)a7 error:(out id *)a8;
...
+ (char)track:(id)a0 hasSamplesForEachSampleInTrack:(id)a1;
+ (char)trimCompositionTracks:(id)a0 toRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a1 error:(out id *)a2;
+ (char)updateVideoMetadataAtURL:(id)a0 withItems:(id)a1 stillImageTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 error:(out id *)a3;
+ (id)urlOfAVAsset:(id)a0;
+ (id)validateAsset:(id)a0 error:(out id *)a1;
+ (char)validateMainVideoTrack:(id)a0 potentiallyCorruptedRange:(out struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } *)a1 error:(out id *)a2;
...
+ (char)videoTrackContainsDolbyVisionMetadata:(id)a0;
