...
- (void)_updateExtent;
- (id)ciImageTiled:(char)a0 closed:(char)a1 pressureMode:(long long)a2;
- (id)ciImageTiled:(char)a0 closed:(char)a1 pressureMode:(long long)a2 filled:(char)a3;
- (char)isEqualToBrushStroke:(id)a0;
- (void)nu_updateDigest:(id)a0;
- (void)writeToTIFFAtPath:(id)a0 closed:(char)a1 pressureMode:(long long)a2;
