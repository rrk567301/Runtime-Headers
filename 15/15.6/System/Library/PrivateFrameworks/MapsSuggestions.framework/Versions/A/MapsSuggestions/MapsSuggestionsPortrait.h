...
- (void).cxx_destruct;
- (char)currentTripsWithHandler:(id /* block */)a0;
- (char)fetchConnectionEntriesWithHandler:(id /* block */)a0;
- (char)fetchLocationEntriesForTray:(char)a0 currentLocation:(id)a1 queue:(id)a2 handler:(id /* block */)a3;
