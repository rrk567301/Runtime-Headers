...
- (id)initWithName:(id)a0 startState:(char)a1 behavior:(unsigned long long)a2 triggers:(id)a3 conditions:(id)a4;
- (id)initWithName:(id)a0 startState:(char)a1 triggers:(id)a2 conditions:(id)a3;
- (id)objectForJSON;
