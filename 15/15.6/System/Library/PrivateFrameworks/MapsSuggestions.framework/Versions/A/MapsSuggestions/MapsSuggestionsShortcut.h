@class GEOMapItemStorage, NSArray, NSString, NSUUID, NSDate;
...
@property (readonly, nonatomic) char isBackedPlaceholder;
@property (readonly, nonatomic) char isSetupPlaceholder;
@property (nonatomic) char derivedFromMeCard;
...
- (id)initWithType:(long long)a0 identifier:(id)a1 geoMapItem:(id)a2 customName:(id)a3 contacts:(id)a4 isHidden:(char)a5 originatingAddress:(id)a6;
- (char)isEqualToFavoriteItem:(id)a0;
- (char)isEqualToShortcut:(id)a0;
