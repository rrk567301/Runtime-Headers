...
- (id)initWithLocation:(id)a0 radius:(double)a1 onEnter:(char)a2 minUpdateTime:(double)a3 locationUpdater:(id)a4 forcingLocationUpdater:(id)a5;
- (char)withinRange:(id)a0;
