...
@property (readonly, nonatomic) char isMoreToLoad;
...
- (void)_replaceItems:(id)a0 skipCallToItemsDidChange:(char)a1;
...
- (void)assignSortIDsToItems:(id)a0 shouldRecalculateSortIDForAllMessages:(char)a1;
