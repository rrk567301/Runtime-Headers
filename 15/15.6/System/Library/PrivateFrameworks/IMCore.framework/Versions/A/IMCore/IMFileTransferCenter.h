...
@property (nonatomic) char disconnectionListenerSetUp;
...
@property (readonly, nonatomic) char hasPendingFileTransfers;
@property (nonatomic, getter=shouldIssueSandboxEstensionsForTransfers) char issueSandboxEstensionsForTransfers;
...
- (id)transferForGUID:(id)a0 includeRemoved:(char)a1;
...
- (void)_addSpotlightProperties:(id)a0 sender:(id)a1 recipients:(id)a2 incoming:(char)a3;
...
- (void)_handleFileTransferFinishedRemoteIntentDownload:(id)a0;
...
- (void)acceptTransfer:(id)a0 withPath:(id)a1 autoRename:(char)a2 overwrite:(char)a3;
...
- (void)createNewOutgoingFileTransferWithTransferGUID:(id)a0 localFileURL:(id)a1;
- (id)createNewOutgoingGroupPhotoTransferWithLocalFileURL:(id)a0;
- (id)createNewOutgoingTransferWithLocalFileURL:(id)a0;
- (char)doesLocalURLRequireArchiving:(id)a0 toHandle:(id)a1;
...
- (char)isActiveTransfer:(id)a0;
- (char)isFileTransfer:(id)a0 preauthorizedWithDictionary:(id)a1;
...
- (void)setAuxImageForTransfer:(id)a0 value:(char)a1;
- (void)setAuxVideoForTransfer:(id)a0 value:(char)a1;
- (void)setCommSafetySensitiveForTransfer:(id)a0 value:(long long)a1;
- (id)transferForGUID:(id)a0;
- (id)transfersForAccount:(id)a0;
- (char)wasFileTransferPreauthorized:(id)a0;
