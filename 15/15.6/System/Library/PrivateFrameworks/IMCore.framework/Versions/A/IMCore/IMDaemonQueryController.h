...
- (void)_completeQuery:(id)a0 success:(char)a1 error:(id)a2 userInfo:(id)a3;
...
- (void)performQueryWithKey:(id)a0 expectsSynchronousResult:(char)a1 block:(id /* block */)a2;
- (void)performQueryWithKey:(id)a0 expectsSynchronousResult:(char)a1 block:(id /* block */)a2 completionHandler:(id /* block */)a3;
