...
@property (nonatomic) char disableItemInserts;
...
@property (nonatomic) char hasRecentMessagesToLoad;
...
- (void)insertHistoricalMessages:(id)a0 queryID:(id)a1 hasMessagesBefore:(char)a2 hasMessagesAfter:(char)a3 isReplacingItems:(char)a4;
- (char)itemMatchesThread:(id)a0;
