@class IMChat, NSString, IMMessage, NSArray, NSURL, DDScannerResult, IMPluginPayload, NSData, NSMutableSet, LPLinkMetadata, NSAttributedString, IMPluginDataSourceStagingContext;
...
@property (nonatomic, setter=setShowingLatestMessageAsBreadcrumb:) char isShowingLatestMessageAsBreadcrumb;
...
@property (nonatomic) char hasInvalidatedSize;
@property (nonatomic) char payloadInShelf;
...
@property (nonatomic) char initialMessageIsFromMe;
@property (nonatomic) char parentChatHasAllUnknownRecipients;
...
@property (nonatomic, setter=setLast:) char isLast;
@property (weak, nonatomic) id<IMBalloonPluginDataSourceDelegate> pluginDataSourceDelegate;
@property (readonly, nonatomic, getter=isShowingLatestMessageAsBreadcrumb) char showingLatestMessageAsBreadcrumb;
...
@property (readonly, nonatomic) char supportsDynamicSize;
...
@property (readonly, nonatomic) char wantsReplyFromContentView;
...
+ (char)isPayloadServiceManatee:(id)a0;
...
- (char)_senderIsSameBetweenPayload:(id)a0 andOtherPayload:(id)a1;
- (id)_summaryText;
