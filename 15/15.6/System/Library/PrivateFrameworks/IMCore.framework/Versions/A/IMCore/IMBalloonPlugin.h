...
@property (readonly, nonatomic) char showInSendMenu;
@property (readonly, nonatomic) char showInBrowser;
@property (readonly, nonatomic) char showableInBrowser;
@property (readonly, nonatomic) char isLaunchProhibited;
@property (readonly, nonatomic) char allowsPresentationWithSendLater;
@property (readonly, nonatomic) char isEnabled;
@property (readonly, nonatomic) char shouldHideAppSwitcher;
@property (readonly, nonatomic) char hideAttributionInformation;
@property (readonly, nonatomic) char shouldBalloonHideAppIcon;
@property (readonly, nonatomic) char shouldBreadcrumbHideAppIcon;
...
@property (readonly, nonatomic, getter=isBetaPlugin) char betaPlugin;
...
- (id)adamID;
- (id)attributionInfo;
- (char)_canRemoveControllerFromCachedDatasource;
...
- (char)shouldShowForRecipients:(id)a0;
