...
- (id)init;
- (void).cxx_destruct;
- (id)sendMessage:(id)a0 destinationID:(id)a1 filePaths:(id)a2 isAudioMessage:(char)a3 groupID:(id)a4 bundleID:(id)a5 attributionInfoName:(id)a6 service:(id)a7 timeOut:(double)a8 threadIdentifier:(id)a9 error:(id *)a10;
- (id)_sendIMMessage:(id)a0 chat:(id)a1 service:(id)a2 timeOut:(double)a3 resultDict:(id)a4 error:(id *)a5;
- (id)appendFilePathsWithGUIDs:(id)a0 withText:(id)a1;
- (id)clearAttachmentsUploadedToCloudkit;
- (id)copyFilePathsToTmpLocation:(id)a0;
- (id)createIMMessageToSendWithMessage:(id)a0 filePaths:(id)a1 bundleID:(id)a2 attributionInfoName:(id)a3 isAudioMessage:(char)a4 threadIdentifier:(id)a5;
