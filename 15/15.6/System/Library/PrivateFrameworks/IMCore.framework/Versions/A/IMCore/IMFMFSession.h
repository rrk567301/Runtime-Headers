...
@property (readonly, nonatomic) char restrictLocationSharing;
@property (readonly, nonatomic) char disableLocationSharing;
...
- (void)didUpdateHidingStatus:(char)a0;
...
- (char)_canShareLocationWithFMLHandle:(id)a0 isFromGroup:(char)a1;
...
- (void)_startRefreshingLocationForFMLHandles:(id)a0 priority:(long long)a1 isFromGroup:(char)a2;
...
- (void)_stopTrackingLocationForFMLHandles:(id)a0 priority:(long long)a1 isFromGroup:(char)a2;
- (void)_updateActiveDevice;
- (char)allChatParticipantsFollowingMyLocation:(id)a0;
- (char)allChatParticipantsSharingLocationWithMe:(id)a0;
- (char)chatHasParticipantsFollowingMyLocation:(id)a0;
- (char)chatHasParticipantsSharingLocationWithMe:(id)a0;
- (char)chatHasSiblingParticipantsSharingLocationWithMe:(id)a0;
- (void)didReceiveLocationForHandle:(id)a0;
- (char)findMyHandleIsFollowingMyLocation:(id)a0;
- (char)findMyHandleIsSharingLocationWithMe:(id)a0;
...
- (char)handleIsFollowingMyLocation:(id)a0;
- (char)handleIsSharingLocationWithMe:(id)a0;
