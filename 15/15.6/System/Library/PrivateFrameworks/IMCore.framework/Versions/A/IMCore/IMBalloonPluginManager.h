...
@property (class, nonatomic) char isRunningPPT;

@property (retain, nonatomic) IMBalloonPluginManagerModel *model;

+ (id)sharedInstance;
+ (char)_allowExtensionWithIdentifier:(id)a0;
+ (id)_extensionBlocklist;
+ (char)_isExtensionBlocklisted:(id)a0;
+ (char)_isServerBlocklistedBundleIdentifier:(id)a0 serverBag:(id)a1;
+ (char)_shouldAddFindMyToBlockList;
+ (char)_shouldAddGenPlaygroundToBlockList;
+ (char)_shouldAddSafetyMonitorToBlockList;
...
- (char)_shouldSkipUpdatingPluginBundleIdentifier:(id)a0;
...
- (void)setPluginEnabled:(char)a0 identifier:(id)a1;
- (id)signpostLogHandle;
