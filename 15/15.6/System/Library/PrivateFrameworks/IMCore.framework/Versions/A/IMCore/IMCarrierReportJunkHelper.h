...
+ (char)canReportJunkOverCellularServiceOfMessageItem:(id)a0;
...
+ (char)isRCSServiceName:(id)a0;
+ (char)isReportJunkServiceAllowedForMessageItem:(id)a0 junkChatStyle:(unsigned char)a1;
...
+ (char)userInHomeCountryWithDestinationCallerID:(id)a0;
+ (char)validateReportJunkCarrierAddress:(id)a0;
+ (char)wifiCallingEnabledForDestinationCallerID:(id)a0;
