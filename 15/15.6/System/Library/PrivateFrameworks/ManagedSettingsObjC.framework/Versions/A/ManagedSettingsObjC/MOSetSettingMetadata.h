...
- (id)initWithSettingName:(id)a0 defaultSet:(id)a1 combineOperator:(long long)a2 maximumCount:(unsigned long long)a3 isPublic:(char)a4 scope:(id)a5 isPrivacySensitive:(char)a6;
