...
- (char)_isAcceptablePersistedArrayElement:(id)a0;
- (char)_isAcceptableStringValue:(id)a0;
- (id)combinePersistableValue:(id)a0 with:(id)a1;
- (id)initWithSettingName:(id)a0 defaultDictionary:(id)a1 persistableKeyClass:(Class)a2 combineOperator:(long long)a3 rankedAllowedValues:(id)a4 maximumCount:(unsigned long long)a5 isPublic:(char)a6 scope:(id)a7 isPrivacySensitive:(char)a8;
