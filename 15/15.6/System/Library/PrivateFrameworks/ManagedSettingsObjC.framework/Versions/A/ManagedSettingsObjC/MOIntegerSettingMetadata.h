...
- (id)initWithSettingName:(id)a0 defaultInt:(long long)a1 combineOperator:(long long)a2 lowerBound:(long long)a3 upperBound:(long long)a4 isPublic:(char)a5 scope:(id)a6 isPrivacySensitive:(char)a7;
