...
+ (char)saveSettings:(id)a0 toURL:(id)a1;
+ (char)settingAndGroupStringsFromSettingKey:(id)a0 outGroup:(id *)a1 outSetting:(id *)a2;
+ (id)settingKeyFromSetting:(id)a0 group:(id)a1;

- (void).cxx_destruct;
- (id)valueForUndefinedKey:(id)a0;
- (id)initStore;
- (char)hasSensitiveDataInSettings:(id)a0;
- (id)metadataForSettingKey:(id)a0;
- (char)setValue:(id)a0 forSettingKey:(id)a1 outError:(id *)a2;
