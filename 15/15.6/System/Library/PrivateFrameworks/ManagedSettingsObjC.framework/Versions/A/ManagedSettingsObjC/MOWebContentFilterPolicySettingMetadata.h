...
- (id)initWithSettingName:(id)a0 defaultPolicy:(id)a1 maximumAutoAllowCount:(unsigned long long)a2 maximumNeverAllowCount:(unsigned long long)a3 maximumOnlyAllowCount:(unsigned long long)a4 isPublic:(char)a5 scope:(id)a6 isPrivacySensitive:(char)a7;
