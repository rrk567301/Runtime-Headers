...
- (id)initWithSettingName:(id)a0 defaultPolicy:(id)a1 interventionCombineOperator:(long long)a2 rankedInterventionTypes:(id)a3 maximumApplicationCount:(unsigned long long)a4 isPublic:(char)a5 scope:(id)a6 isPrivacySensitive:(char)a7;
