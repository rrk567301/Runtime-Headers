...
- (id)initWithSettingName:(id)a0 defaultString:(id)a1 combineOperator:(long long)a2 rankedAllowedValues:(id)a3 isPublic:(char)a4 scope:(id)a5 isPrivacySensitive:(char)a6;
