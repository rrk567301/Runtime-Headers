@class MOWebDomainCategoryShieldPolicy;
...
- (id)initWithSettingName:(id)a0 defaultPolicy:(id)a1 maximumCategoryCount:(unsigned long long)a2 maximumActivityCount:(unsigned long long)a3 isPublic:(char)a4 scope:(id)a5 isPrivacySensitive:(char)a6;
