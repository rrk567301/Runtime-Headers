...
@interface SRUIFInstrumentationManager : NSObject <AFAnalyticsDialogIdentifierAssociationProvider> {
    ...
    char _shouldInstrument;
    char _potentialBargeInDetected;
...
@property (nonatomic) char hasNotYetEmittedLaunchContextEnd;
...
- (void)processSessionEvent:(long long)a0 isSpeechSynthesisSpeaking:(char)a1 machAbsoluteTime:(double)a2;
...
- (char)_hasDismissedForTurnContext:(id)a0;
...
- (void)emitVRXInstrumentationEvent:(id)a0 aceViewId:(id)a1 cardEngagementProcessed:(char)a2;
