@class SRUIFDialogPhase, NSUUID, AceObject, NSString, SRUIFDataStore;
...
- (id)initWithIdentifier:(id)a0 type:(long long)a1 aceObject:(id)a2 dialogPhase:(id)a3 presentationState:(long long)a4 aceCommandIdentifier:(id)a5 virgin:(char)a6 transient:(char)a7 supplemental:(char)a8 immersiveExperience:(char)a9 associatedDataStore:(id)a10;
