@class NSUUID, NSString, NSMutableDictionary, SRUIFTreeNode;
...
@property (retain, nonatomic, getter=_rootNode, setter=_setRootNode:) SRUIFTreeNode *rootNode;
@property (retain, nonatomic, setter=_setLastRestoredItem:) id<SRUIFConversationStorable> lastRestoredItem;
@property (readonly, copy, nonatomic) NSUUID *identifier;
@property (readonly, copy, nonatomic) NSString *languageCode;
@property (nonatomic, getter=isSynchronizedWithServer) char synchronizedWithServer;
...
- (id)_indexPathForItemWithIdentifier:(id)a0 ignoreNonExistent:(char)a1;
...
- (char)_nodeContainsProvisionalItems:(id)a0;
...
- (char)containsItemForAceViewWithIdentifier:(id)a0;
- (char)containsItemWithIdentifier:(id)a0;
- (id)dialogPhaseForItemAtIndexPath:(id)a0;
- (char)hasItemWithIdentifier:(id)a0;
...
- (char)itemAtIndexPathIsVirgin:(id)a0;
...
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 asChildrenOfItemWithIdentifier:(id)a3 isSupplemental:(char)a4 isImmersiveExperience:(char)a5;
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 atIndexPaths:(id)a3 isSupplemental:(char)a4 isImmersiveExperience:(char)a5;
- (id)itemsRelatedToIdentifier:(id)a0;
