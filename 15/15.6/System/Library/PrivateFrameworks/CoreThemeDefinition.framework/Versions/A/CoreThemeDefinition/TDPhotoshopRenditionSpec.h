...
- (char)_sliceRectanglesForPSDImage:(id)a0 rowsPerRendition:(int *)a1 columnsPerRendition:(int *)a2 originalColumnWidth:(int *)a3 newColumnWidth:(int *)a4 originalRowHeight:(int *)a5 newRowHeight:(int *)a6 originalColumnX:(int *)a7 originalRowY:(int *)a8 newRenditionSize:(struct { int x0; int x1; } *)a9 newSliceCount:(int *)a10 renditionRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a11 throwawaySliceRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a12;
...
- (id)createCSIRepresentationFromGradientPSDImage:(id)a0 withCompression:(char)a1 colorSpaceID:(unsigned long long)a2;
- (id)createCSIRepresentationFromPSDImage:(id)a0 withCompression:(char)a1 colorSpaceID:(unsigned long long)a2;
- (id)createCSIRepresentationFromPSDImage:(id)a0 withCompression:(char)a1 edgeMetricsMask:(id)a2 textMetricsMask:(id)a3 baselineMetricsMask:(id)a4 auxiliary1MetricsMask:(id)a5 auxiliary2MetricsMask:(id)a6 colorSpaceID:(unsigned long long)a7 allowsPaletteImageCompression:(char)a8 allowsHevcCompression:(char)a9 allowsDeepmapImageCompression:(char)a10 allowsDeepmap2ImageCompression:(char)a11;
...
- (id)imageFromPSDPreviewImage:(id)a0;
