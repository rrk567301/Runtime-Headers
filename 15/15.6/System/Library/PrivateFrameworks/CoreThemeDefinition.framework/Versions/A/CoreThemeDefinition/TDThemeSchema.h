...
+ (char)loadThemeConstantsForEntity:(id)a0 inContext:(id)a1;
...
- (void)_addSchemaPartDefinitionsForStandardElement:(const struct { char *x0; char *x1; char x2; long long x3; struct { char *x0; char *x1; struct _renditionkeytoken { unsigned short x0; unsigned short x1; } x2[5]; long long x3; long long x4; struct { char *x0; char *x1; long long x2; unsigned long long x3; } x5[12]; } x4[8]; } *)a0 withElement:(id)a1;
- (void)_loadConstantForEntity:(id)a0 withDescriptor:(const struct _themeconstant { long long x0; char *x1; char *x2; } *)a1;
- (char)_renditionKey:(const struct _renditionkeytoken { unsigned short x0; unsigned short x1; } *)a0 isEqualToKeyIgnoringLook:(const struct _renditionkeytoken { unsigned short x0; unsigned short x1; } *)a1;
...
- (void)_sanityCheckObjectsWithEntityName:(id)a0 globalDescriptor:(void *)a1 matchIdentifierOnly:(char)a2;
