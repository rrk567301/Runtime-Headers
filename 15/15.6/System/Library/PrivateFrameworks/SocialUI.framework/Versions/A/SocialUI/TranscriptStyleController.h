...
@property char requiresCSSRebuild;
...
- (id)_styleElement;
- (char)applyCSSSelector:(id)a0 fromDictionary:(id)a1;
- (char)applyCSSSelector:(id)a0 property:(id)a1 value:(id)a2;
- (char)applyCSSSelector:(id)a0 property:(id)a1 value:(id)a2 priority:(id)a3;
...
- (void)dimTranscriptWithAnimation:(char)a0;
...
- (void)showPictures;
- (void)undimTranscriptWithAnimation:(char)a0;
