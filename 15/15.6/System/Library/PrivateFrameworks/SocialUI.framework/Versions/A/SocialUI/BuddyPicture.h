...
@property (nonatomic) char pictureIsIcon;
...
- (id)dataWithMaxSize:(struct CGSize { double x0; double x1; })a0 minSize:(struct CGSize { double x0; double x1; })a1 maxDataSize:(float)a2 allowAnimated:(char)a3;
- (void)drawInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 operation:(unsigned long long)a1 fraction:(float)a2 firstFrameOnly:(char)a3 scaled:(char)a4;
