...
@property (getter=isChangingFirstResponder) char changingFirstResponder;
@property char suppressErrorDisplay;
...
- (char)_showContactCardForIMHandle:(id)a0;
...
- (char)isNewComposeForTokenAttachmentCell:(id)a0;
...
- (char)tokenAttachmentCell:(id)a0 doubleClickedInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 ofView:(id)a2;
- (void)tokenAttachmentCell:(id)a0 willBeDestroyedWithRepresentedObject:(id)a1;
- (id)tokenAttachmentCellEffectiveAppearance:(id)a0;
- (char)tokenAttachmentCellHasErrorState:(id)a0;
- (char)tokenAttachmentCellShouldShowDecidingBackground:(id)a0;
- (void)tokenFieldCellDidBeginDropOperation:(id)a0;
- (void)tokenFieldCellDidEndDropOperation:(id)a0;
- (char)tokenFieldShouldPreventAdditionalTyping:(id)a0;
