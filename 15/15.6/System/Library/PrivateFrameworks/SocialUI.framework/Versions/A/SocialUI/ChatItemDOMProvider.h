...
@property (nonatomic) char animateReceiptChanges;
@property (nonatomic) char createDebugElements;
...
- (char)_appendBigEmojiDivIfNeededForText:(id)a0 chatItem:(id)a1 messageTextElement:(id)a2;
