...
@property (nonatomic) char isAnimatingReceipt;
@property (nonatomic) char allowsPlugins;
...
- (void)_visitDOMNode:(id)a0 stop:(char *)a1 visitor:(id /* block */)a2;
...
- (void)setNameStyle;
- (void)setWatchMessageAddressing:(char)a0;
- (void)showMyPicture;
- (void)showNames;
