...
- (id)_hostView;
- (void)_scrollRectToVisible:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 animated:(char)a1;
- (void)endChanges;
...
- (void)_scrollToIndexPath:(id)a0 animated:(char)a1;
- (void)_scrollToLastItemAnimated:(char)a0;
- (double)distanceFromBottom;
- (char)lastMessageIsVisible;
- (void)processChatItemChanges:(id)a0;
- (void)reloadDataAndScrollToEnd:(char)a0;
