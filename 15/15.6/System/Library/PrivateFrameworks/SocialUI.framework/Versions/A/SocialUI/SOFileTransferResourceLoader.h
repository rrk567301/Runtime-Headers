...
- (void)_blurImageFileTransfer:(id)a0 toMaxSize:(double)a1 saveToLocation:(id)a2 blocking:(char)a3;
...
- (char)mapsGeneratedForGUID:(id)a0;
- (char)mapsGeneratedForMapFileURL:(id)a0;
