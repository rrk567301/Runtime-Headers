...
@property (readonly, getter=isDisplayingAcknowledgmentPicker) char displayingAcknowledgmentPicker;
@property (readonly) IMAggregateAcknowledgmentChatItem *groupAcknowledgmentsPoll;
@property (readonly, nonatomic) char shouldPinToBottom;
...
+ (char)classIsRegistered:(Class)a0;
...
- (char)canShowAcknowledgmentPickerForChatItemGUID:(id)a0;
...
- (void)dismissAcknowledgmentsWithAnimation:(char)a0;
...
- (void)scrollToEndSmoothly:(char)a0;
