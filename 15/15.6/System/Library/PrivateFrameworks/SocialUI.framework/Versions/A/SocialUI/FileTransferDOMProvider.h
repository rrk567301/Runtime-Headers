...
@property char altFunction;
@property char singleOptionPressed;
...
- (void)fileTransferUpdated:(id)a0 inlineMedia:(char)a1;
- (char)isResponsibleForTransfer:(id)a0;
- (char)isThemeableTranscriptResource:(id)a0;
- (id)parseAudioMessageWithChatItem:(id)a0 transfer:(id)a1 listenedTo:(char)a2;
- (id)parseFileTransferGUID:(id)a0 filename:(id)a1 forChatItem:(id)a2;
- (id)parseFileTransferGUID:(id)a0 filename:(id)a1 width:(double)a2 height:(double)a3 forChatItem:(id)a4 outWillFillBubble:(char *)a5;
- (id)parseMap:(id)a0;
- (id)parsePass:(id)a0;
- (void)setSourceForInlineMedia:(id)a0 forFileTransfer:(id)a1;
- (void)updateClassName:(id)a0 forTransfer:(id)a1;
- (void)updateDOMElement:(id)a0 forDarkAppearance:(char)a1;
