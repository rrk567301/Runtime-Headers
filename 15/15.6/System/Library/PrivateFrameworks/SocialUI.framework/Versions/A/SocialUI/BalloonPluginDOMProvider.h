...
- (char)setupGeneralInvisibleInk:(id)a0;
- (char)setupHandwritingInvisibleInk:(id)a0;
- (char)setupInvisibleInkChatItem:(id)a0 withContainerElement:(id)a1;
- (char)setupInvisibleInkChatItemIsHandwritingPlugin:(char)a0 withContainerElement:(id)a1;
