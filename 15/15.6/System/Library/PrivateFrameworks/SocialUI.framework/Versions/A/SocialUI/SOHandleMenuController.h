...
@property char showingMenu;
@property (copy) id /* block */ handleBlock;
@property (weak) SOChatDisplayController *chatDisplayController;
@property char hideAlternateHandles;
@property (retain) NSMenu *menu;
@property char includeHandleAlternatives;
...
- (id)_alternativeHandlesIncludingABCombinations:(char)a0;
