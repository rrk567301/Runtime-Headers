...
+ (id)_newCustomEWSExtendedPropertyWithName:(id)a0 boolValue:(char)a1;
+ (id)_newCustomEWSSetItemWithPropertyName:(id)a0 boolValue:(char)a1;
...
+ (id)newEWSItemFromMessage:(id)a0 data:(id)a1 flags:(long long)a2 sender:(id)a3 recipientsByHeaderKey:(id)a4 categories:(id)a5 existingProperties:(id)a6 useSenderInsteadOfFrom:(char)a7;
+ (id)newMessageWithEWSItemType:(id)a0;
+ (id)propertiesToGetBeforeUpdatingMessageFlags:(id)a0 forMessageType:(char)a1 includesReadReceipts:(char *)a2;
