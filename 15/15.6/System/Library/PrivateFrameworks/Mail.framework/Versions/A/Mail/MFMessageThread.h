...
- (id)_changeDictionaryForTaskID:(id)a0 toModify:(char)a1;
...
- (char)commitPendingChangesForTaskID:(id)a0;
- (char)conversationFlagsHaveChanged;
...
- (char)willBeDeletedIfMessagesAreDeleted:(id)a0;
