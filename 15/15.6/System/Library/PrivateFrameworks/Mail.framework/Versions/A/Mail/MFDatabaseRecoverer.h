...
@property (readonly) char fileLocked;
@property (readonly) char aRemoteApplicationIsAccessingTheDatabase;
@property (readonly) char lockFileFound;

+ (char)moveDatabaseFromPath:(id)a0 toPath:(id)a1;
