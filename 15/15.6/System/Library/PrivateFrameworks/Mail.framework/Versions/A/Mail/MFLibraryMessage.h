...
@property char hasRetriedDownload;
@property char isCompacted;
@property (readonly) char shouldIndexAttachmentsForSpotlight;
@property (readonly, nonatomic) char shouldSnipAttachmentData;
...
@property (readonly, nonatomic) char isJournaled;
@property (readonly, nonatomic, getter=isMessageContentLocallyAvailable) char messageContentLocallyAvailable;
...
+ (id)_addMessageToResidentMessages:(id)a0 overridingPreviousMessage:(char)a1;
...
- (char)loadOptionsSuffice:(unsigned int)a0;
...
- (void)setColorHasBeenEvaluated:(char)a0;
...
- (char)updateSubjectFromEncryptedContent;
