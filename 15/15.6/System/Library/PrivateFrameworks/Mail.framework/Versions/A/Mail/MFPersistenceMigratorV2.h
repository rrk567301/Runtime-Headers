...
@property (nonatomic) char isTrackingCleanupProgress;
...
- (char)fileManager:(id)a0 shouldRemoveItemAtPath:(id)a1;
- (void)migrate;
- (id)_accountPrefixes;
- (char)_directoryExistsAtPath:(id)a0;
- (void)_handleAttachmentsMigrationResult:(char)a0 error:(id)a1 message:(id)a2 libraryID:(long long)a3;
...
- (char)_path:(id)a0 hasPrefixInArray:(id)a1;
- (id)_prefixOfString:(id)a0 fromSet:(id)a1;
- (char)_shouldIgnoreFilename:(id)a0;
- (char)_string:(id)a0 hasPrefixInSet:(id)a1;
- (char)_string:(id)a0 hasSuffixInSet:(id)a1;
