...
- (void)_refreshAccounts:(id)a0 clearingStatus:(char)a1;
- (id)_registeredAccountsForClient:(id)a0 onlyWithUnknownStatus:(char)a1;
...
- (void)refreshAndClearStatus:(char)a0;
- (void)refreshStatusForClient:(id)a0 forceRefresh:(char)a1;
