...
@property char suspendSmartMailboxUnreadCountCalculations;
...
- (char)_isMessageIndexed:(id)a0;
- (char)_isObservingSmartMailbox:(id)a0;
...
- (void)_watchMessages:(id)a0 withUnreadState:(char)a1 onDate:(id)a2;
...
- (void)updateMailboxesUnreadCountUsingSpotlight:(id)a0 cancelExistingQuery:(char)a1;
