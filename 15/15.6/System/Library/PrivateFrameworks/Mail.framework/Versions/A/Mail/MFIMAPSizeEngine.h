...
- (char)_changeUsageInfo:(struct { long long x0; unsigned long long x1; } *)a0 forMailbox:(id)a1 refetchQuotas:(char)a2;
- (void)_getSizeForMailbox:(id)a0;
- (void)_mailboxBecameInvalid:(id)a0;
- (void)_runWorkerThread;
- (id)copyMailboxesForQuotaName:(id)a0;
- (char)mailbox:(id)a0 usesQuotaName:(id)a1;
- (char)shouldStartWorkerThread;
