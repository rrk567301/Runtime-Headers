...
@property (nonatomic) char placeSignatureAboveQuotedText;
...
- (void)configurePopUpButton:(id)a0 forAccount:(id)a1 defaultSignature:(id)a2 selectionMethod:(long long)a3 showAccount:(char)a4;
