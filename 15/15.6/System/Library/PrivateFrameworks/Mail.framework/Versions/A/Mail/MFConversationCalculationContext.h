...
@property (nonatomic) char hasReferences;
...
@property (readonly, nonatomic) char didTearDown;
@property (nonatomic) char conversationsWereReset;
...
@property (readonly, nonatomic) char messageHasReferences;
@property (readonly, nonatomic) char messageHasMessageID;
...
- (char)_descendant:(long long)a0 belongsToSameConversationAsAncestor:(long long)a1;
...
- (char)automatedConversationTypeIsConsistentForConversation:(long long)a0;
