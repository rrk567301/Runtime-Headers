...
- (char)_addRecipientsForLibraryID:(long long)a0 recipients:(id)a1 recipientType:(char)a2 position:(int)a3 cache:(id)a4;
- (char)_addRecipientsForLibraryIDFromMessage:(id)a0 libraryID:(long long)a1 cache:(id)a2;
