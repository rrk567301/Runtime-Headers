...
- (void)processAttachmentsIfNecessaryAtFileURL:(id)a0 isDirectory:(char)a1 skipDescendantsBlock:(id /* block */)a2 resultsBlock:(id /* block */)a3;
...
- (char)updateAttachmentsWithAttachmentIDUpgradeStep:(id)a0 isDirectoryForFileURL:(id)a1;
