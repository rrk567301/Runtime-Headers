...
- (void)_saveData:(id)a0 forMessage:(id)a1 isPartial:(char)a2 updateMetadata:(char)a3;
- (void)_saveOfflineCache;
- (void)addError:(id)a0 withHandler:(id)a1;
- (void)addOfflineToRealEWSIdStrings:(id)a0 forRequest:(id)a1;
- (id)appendMessage:(id)a0 withData:(id)a1 toEWSFolderWithIdString:(id)a2 messageType:(char)a3 flags:(long long)a4 sender:(id)a5 recipientsByHeaderKey:(id)a6 send:(char)a7 errorHandler:(id)a8;
...
- (char)deleteMailboxWithEWSFolderIdString:(id)a0 error:(id *)a1;
- (void)deleteMessagesWithEWSItemIds:(id)a0 fromFolderWithEWSIdString:(id)a1 synchronously:(char)a2;
- (id)fetchDistinguishedFolderIdsWithConnection:(id)a0;
- (id)fetchMimeDataForMessage:(id)a0 errorHandler:(id)a1;
- (char)fetchUsageInfo:(struct { long long x0; unsigned long long x1; } *)a0 forEWSFolderIdString:(id)a1;
- (void)getOofSettings;
- (char)moveMailboxWithEWSFolderIdString:(id)a0 to:(id)a1 error:(id *)a2;
- (char)playbackRequestsFromOfflineCacheWithConnection:(id)a0 error:(id *)a1;
- (void)removeMessageAndDataFromOfflineCacheForEWSItemIdString:(id)a0;
- (char)renameMailboxWithEWSFolderIdString:(id)a0 to:(id)a1 error:(id *)a2;
...
- (char)writeMessageToOfflineCache:(id)a0 data:(id)a1 forItemIdString:(id)a2;
