...
+ (void)_setLabelsOnAction:(long long)a0 labels:(id)a1 add:(char)a2 connection:(id)a3;
+ (void)_addActionMessagesForActionID:(long long)a0 uids:(id)a1 uidsAreReal:(char)a2 mailboxID:(long long)a3 connection:(id)a4;
...
+ (char)accountHasLegacyOfflineOperations:(id)a0;
+ (void)upgradeOperationsForIMAPAccount:(id)a0 fetchSeparatorIfNecessary:(char)a1;
