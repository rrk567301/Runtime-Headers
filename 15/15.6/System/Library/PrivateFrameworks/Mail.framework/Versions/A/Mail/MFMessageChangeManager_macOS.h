...
- (void)applyVIPStatus:(char)a0 toMessagesInDatabase:(id)a1;
...
- (char)haveCompleteMIMEForMessage:(id)a0;
...
- (char)mailboxIsAllMail:(id)a0;
- (char)mailboxPartOfAllMail:(id)a0;
...
- (char)persistNewMessages:(id)a0 mailboxURL:(id)a1 oldMessagesByNewMessage:(id)a2 fromSyncing:(char)a3;
