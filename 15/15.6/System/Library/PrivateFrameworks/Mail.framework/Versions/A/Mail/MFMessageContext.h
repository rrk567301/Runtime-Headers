...
- (void)async_setFlagWithKey:(id)a0 state:(char)a1 forMessages:(id)a2 reason:(long long)a3;
...
- (void)setFlagWithKey:(id)a0 state:(char)a1 forMessages:(id)a2 reason:(long long)a3;
