...
- (long long)_globalIDForMessageIDHeaderHash:(id)a0 categorizationResult:(id)a1 globalMessageIDsCache:(id)a2 cacheIsExhaustive:(char)a3;
- (char)_insertRecipientsWithMessageID:(long long)a0 recipients:(id)a1 recipientType:(char)a2 position:(unsigned long long)a3 addressRowIDsCache:(id)a4 cacheIsExhaustive:(char)a5;
- (long long)_rowIDForAddress:(id)a0 comment:(id)a1;
- (long long)_rowIDForAddressText:(id)a0 cache:(id)a1 cacheIsExhaustive:(char)a2;
- (long long)_rowIDForSubject:(id)a0 subjectRowIDsCache:(id)a1 cacheIsExhaustive:(char)a2;
- (void)bindFieldsToPreparedStatement:(id)a0 isUpdate:(char)a1;
...
- (char)insertRecpientsWithMessageID:(long long)a0 fromMessage:(id)a1 addressRowIDsCache:(id)a2 cacheIsExhaustive:(char)a3;
- (char)insertReferencesWithMessageID:(long long)a0;
...
- (char)updateFieldsFromMessage:(id)a0 subjectRowIDsCache:(id)a1 globalMessageIDsCache:(id)a2 addressRowIDsCache:(id)a3 cacheIsExhaustive:(char)a4 addressesNeedingBusinessMetadata:(id *)a5;
