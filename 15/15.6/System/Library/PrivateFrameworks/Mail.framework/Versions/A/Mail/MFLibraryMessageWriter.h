...
@property (nonatomic) char fetchBodies;
@property (nonatomic) char isInitialImport;
@property (nonatomic) char isMailboxRebuild;
...
- (char)_canUseEmlxFileWhenCopyingMessage:(id)a0 fromAccount:(id)a1 toAccount:(id)a2;
...
- (char)_isLibraryMessage:(id)a0;
- (char)_isLocalAccount:(id)a0;
- (char)_isRemoteStoreAccount:(id)a0;
