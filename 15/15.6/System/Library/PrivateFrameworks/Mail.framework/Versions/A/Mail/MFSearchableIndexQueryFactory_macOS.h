...
- (id)init;
- (void).cxx_destruct;
- (id)expressionForAllMailboxesWithExpression:(id)a0 excludedMailboxesExpression:(id)a1 forUnreadCount:(char)a2 includeAttachmentCriterion:(char)a3;
- (id)expressionFromExpression:(id)a0 includeAttachmentCriterion:(char)a1;
- (id)queryStringForAllMailboxesWithQueryString:(id)a0 excludedMailboxesQueryString:(id)a1 forUnreadCount:(char)a2 includeAttachmentCriterion:(char)a3;
