...
- (id)init;
- (void).cxx_destruct;
- (char)removeStoreAtURL:(id)a0 error:(out id *)a1;
...
- (char)migrateFromApplicationStore:(id)a0 toApplicationStore:(id)a1 error:(id *)a2;
- (char)migrateFromPlistStoreAtURL:(id)a0 toSqliteStoreAtURL:(id)a1 error:(id *)a2;
