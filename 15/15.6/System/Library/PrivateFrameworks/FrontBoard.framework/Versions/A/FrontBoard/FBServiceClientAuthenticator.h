...
+ (char)authenticateAuditToken:(struct { unsigned int x0[8]; })a0 forEntitlement:(id)a1 error:(out id *)a2;
...
- (char)authenticateAuditToken:(id)a0;
- (char)authenticateAuditToken:(id)a0 error:(out id *)a1;
- (char)authenticateAuditToken:(id)a0 forEntitlement:(id)a1 error:(out id *)a2;
...
- (char)authenticateClient:(id)a0;
- (char)authenticateClient:(id)a0 error:(out id *)a1;
