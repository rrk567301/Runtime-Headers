...
@interface FBProcessObserver : NSObject <FBProcessObserver, FBApplicationProcessObserver> {
    ...
    char _supportsWillExit;
    char _supportsDidExit;
    char _supportsStateDidChange;
    char _supportsApplicationDidExit;
    char _supportsApplicationWillLaunch;
    char _supportsApplicationDidLaunch;
    char _supportsApplicationDebugState;
    int _invalidated;
    int _calledWillExit;
    int _calledDidExit;
