...
@interface FBScene : NSObject <FBSSceneObserver, FBSceneHost, BSDescriptionProviding, FBSSceneExtensible> {
    ...
    char _contentStateIsChanging;
    char _legacy;
    char _deactivating;
    char _invalidated;
    char _legacyActivated;
    char _midUpdate;
    char _finishedInit;
    char _newlyReparented;
    char _updateShouldActivate;
    char _componentInit;
    char _configuringParameters;
    char _updatePendingFinalize;
    FBSceneWorkspace *_workspace;
}

@property (readonly, nonatomic) unsigned long long _transactionID;
@property (readonly, nonatomic, getter=_isInTransaction) char _inTransaction;
...
- (char)executeWhenMutable:(id /* block */)a0;
...
- (char)updateWhenMutable:(id /* block */)a0;
