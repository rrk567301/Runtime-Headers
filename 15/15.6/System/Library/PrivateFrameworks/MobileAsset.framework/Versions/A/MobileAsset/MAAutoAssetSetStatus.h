...
@property (nonatomic) char latestDownloadedAtomicInstanceFromPreSUStaging;
...
@property (nonatomic) char haveReceivedLookupResponse;
@property (nonatomic) char vendingAtomicInstanceForConfiguredEntries;
...
- (id)summary;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withAtomicInstancesDownloaded:(id)a2 withNewerAtomicInstanceDiscovered:(id)a3 withNewerDiscoveredAtomicEntries:(id)a4 withLatestDownloadedAtomicInstance:(id)a5 withLatestDowloadedAtomicInstanceEntries:(id)a6 withAllDownloadedAtomicInstanceEntries:(id)a7 withCurrentNotifications:(id)a8 withCurrentNeedPolicy:(id)a9 withSchedulerPolicy:(id)a10 withStagerPolicy:(id)a11 withDownloadUserInitiated:(char)a12 withDownloadProgress:(id)a13 withDownloadedNetworkBytes:(long long)a14 withDownloadedFilesystemBytes:(long long)a15 withCurrentLockUsage:(id)a16 withSelectorsForStaging:(id)a17 withAvailableForUseError:(id)a18 withNewerVersionError:(id)a19;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDowloadedAtomicInstanceEntries:(id)a11 withCurrentNotifications:(id)a12 withCurrentNeedPolicy:(id)a13 withSchedulerPolicy:(id)a14 withStagerPolicy:(id)a15 withDownloadUserInitiated:(char)a16 withDownloadProgress:(id)a17 withDownloadedNetworkBytes:(long long)a18 withDownloadedFilesystemBytes:(long long)a19 withCurrentLockUsage:(id)a20 withSelectorsForStaging:(id)a21 withAvailableForUseError:(id)a22 withNewerVersionError:(id)a23;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDowloadedAtomicInstanceEntries:(id)a11 withDownloadedCatalogCachedAssetSetID:(id)a12 withDownloadedCatalogDownloadedFromLive:(id)a13 withDownloadedCatalogLastTimeChecked:(id)a14 withDownloadedCatalogPostedDate:(id)a15 withCurrentNotifications:(id)a16 withCurrentNeedPolicy:(id)a17 withSchedulerPolicy:(id)a18 withStagerPolicy:(id)a19 havingReceivedLookupResponse:(char)a20 vendingAtomicInstanceForConfiguredEntries:(char)a21 withDownloadUserInitiated:(char)a22 withDownloadProgress:(id)a23 withDownloadedNetworkBytes:(long long)a24 withDownloadedFilesystemBytes:(long long)a25 withCurrentLockUsage:(id)a26 withSelectorsForStaging:(id)a27 withAvailableForUseError:(id)a28 withNewerVersionError:(id)a29;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDowloadedAtomicInstanceEntries:(id)a11 withDownloadedCatalogCachedAssetSetID:(id)a12 withDownloadedCatalogDownloadedFromLive:(id)a13 withDownloadedCatalogLastTimeChecked:(id)a14 withDownloadedCatalogPostedDate:(id)a15 withCurrentNotifications:(id)a16 withCurrentNeedPolicy:(id)a17 withSchedulerPolicy:(id)a18 withStagerPolicy:(id)a19 havingReceivedLookupResponse:(char)a20 withDownloadUserInitiated:(char)a21 withDownloadProgress:(id)a22 withDownloadedNetworkBytes:(long long)a23 withDownloadedFilesystemBytes:(long long)a24 withCurrentLockUsage:(id)a25 withSelectorsForStaging:(id)a26 withAvailableForUseError:(id)a27 withNewerVersionError:(id)a28;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDowloadedAtomicInstanceEntries:(id)a11 withDownloadedCatalogCachedAssetSetID:(id)a12 withDownloadedCatalogDownloadedFromLive:(id)a13 withDownloadedCatalogLastTimeChecked:(id)a14 withDownloadedCatalogPostedDate:(id)a15 withCurrentNotifications:(id)a16 withCurrentNeedPolicy:(id)a17 withSchedulerPolicy:(id)a18 withStagerPolicy:(id)a19 withDownloadUserInitiated:(char)a20 withDownloadProgress:(id)a21 withDownloadedNetworkBytes:(long long)a22 withDownloadedFilesystemBytes:(long long)a23 withCurrentLockUsage:(id)a24 withSelectorsForStaging:(id)a25 withAvailableForUseError:(id)a26 withNewerVersionError:(id)a27;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDowloadedAtomicInstanceEntries:(id)a11 withPreviouslyVendedLockedAtomicInstance:(id)a12 withDownloadedCatalogCachedAssetSetID:(id)a13 withDownloadedCatalogDownloadedFromLive:(id)a14 withDownloadedCatalogLastTimeChecked:(id)a15 withDownloadedCatalogPostedDate:(id)a16 withCurrentNotifications:(id)a17 withCurrentNeedPolicy:(id)a18 withSchedulerPolicy:(id)a19 withStagerPolicy:(id)a20 havingReceivedLookupResponse:(char)a21 vendingAtomicInstanceForConfiguredEntries:(char)a22 withDownloadUserInitiated:(char)a23 withDownloadProgress:(id)a24 withDownloadedNetworkBytes:(long long)a25 withDownloadedFilesystemBytes:(long long)a26 withCurrentLockUsage:(id)a27 withSelectorsForStaging:(id)a28 withAvailableForUseError:(id)a29 withNewerVersionError:(id)a30;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDownloadedAtomicInstanceFromPreSUStaging:(char)a11 withLatestDowloadedAtomicInstanceEntries:(id)a12 withDownloadedCatalogCachedAssetSetID:(id)a13 withDownloadedCatalogDownloadedFromLive:(id)a14 withDownloadedCatalogLastTimeChecked:(id)a15 withDownloadedCatalogPostedDate:(id)a16 withCurrentNotifications:(id)a17 withCurrentNeedPolicy:(id)a18 withSchedulerPolicy:(id)a19 withStagerPolicy:(id)a20 havingReceivedLookupResponse:(char)a21 vendingAtomicInstanceForConfiguredEntries:(char)a22 withDownloadUserInitiated:(char)a23 withDownloadProgress:(id)a24 withDownloadedNetworkBytes:(long long)a25 withDownloadedFilesystemBytes:(long long)a26 withCurrentLockUsage:(id)a27 withSelectorsForStaging:(id)a28 withAvailableForUseError:(id)a29 withNewerVersionError:(id)a30;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDownloadedAtomicInstanceFromPreSUStaging:(char)a11 withLatestDowloadedAtomicInstanceEntries:(id)a12 withPreviouslyVendedLockedAtomicInstance:(id)a13 withDownloadedCatalogCachedAssetSetID:(id)a14 withDownloadedCatalogDownloadedFromLive:(id)a15 withDownloadedCatalogLastTimeChecked:(id)a16 withDownloadedCatalogPostedDate:(id)a17 withCurrentNotifications:(id)a18 withCurrentNeedPolicy:(id)a19 withSchedulerPolicy:(id)a20 withStagerPolicy:(id)a21 havingReceivedLookupResponse:(char)a22 vendingAtomicInstanceForConfiguredEntries:(char)a23 withDownloadUserInitiated:(char)a24 withDownloadProgress:(id)a25 withDownloadedNetworkBytes:(long long)a26 withDownloadedFilesystemBytes:(long long)a27 withCurrentLockUsage:(id)a28 withSelectorsForStaging:(id)a29 withAvailableForUseError:(id)a30 withNewerVersionError:(id)a31;
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withNewerAtomicInstanceDiscovered:(id)a4 withNewerDiscoveredAtomicEntries:(id)a5 withLatestDownloadedAtomicInstance:(id)a6 withLatestDowloadedAtomicInstanceEntries:(id)a7 withAllDownloadedAtomicInstanceEntries:(id)a8 withCurrentNotifications:(id)a9 withCurrentNeedPolicy:(id)a10 withSchedulerPolicy:(id)a11 withStagerPolicy:(id)a12 withDownloadUserInitiated:(char)a13 withDownloadProgress:(id)a14 withDownloadedNetworkBytes:(long long)a15 withDownloadedFilesystemBytes:(long long)a16 withCurrentLockUsage:(id)a17 withSelectorsForStaging:(id)a18 withAvailableForUseError:(id)a19 withNewerVersionError:(id)a20;
