...
- (void)ids_didStartBugSessionWithInfo:(id)a0 forID:(id)a1;
- (void)ids_startBugSessionWithIdentifier:(id)a0 configuration:(id)a1 caller:(id)a2 target:(id)a3;
- (void)incomingDeviceReceived:(id)a0;
- (char)sendMessage:(int)a0 withData:(id)a1 forDevices:(id)a2 isResponse:(BOOL)a3;
- (char)sendMessage:(int)a0 withData:(id)a1 forIDSDeviceID:(id)a2 isResponse:(BOOL)a3;
- (char)sendMessage:(int)a0 withData:(id)a1 forIDSDeviceIDs:(id)a2 isResponse:(BOOL)a3;
- (char)sendMessage:(int)a0 withData:(id)a1 forIDSDeviceIDs:(id)a2 localIDSDeviceIDs:(id)a3 isResponse:(BOOL)a4;
