...
- (void)_logOperations;
- (void)_startDiagnosticWithIdentifier:(id)a0 parameters:(id)a1 session:(id)a2 runSetup:(char)a3;
- (void)_streamOperationStatus;
- (void)_syncSessionStatusWithSession:(id)a0 withIdentifiers:(char)a1;
- (void)_syncSessionStatusWithSessionID:(id)a0 withIdentifiers:(char)a1;
...
- (void)configureForEmbedded:(char)a0;
