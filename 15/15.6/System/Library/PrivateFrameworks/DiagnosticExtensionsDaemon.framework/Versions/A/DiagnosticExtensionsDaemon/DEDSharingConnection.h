...
@property char listenForClients;
...
- (void)_configureService:(id)a0 withLabel:(id)a1 needsSetup:(char)a2 actionType:(unsigned char)a3 completion:(id /* block */)a4;
...
- (void)_verifyPairingForSession:(id)a0 holdForPIN:(char)a1 completion:(id /* block */)a2;
...
- (void)configureListenForClients:(char)a0;
- (void)configureSharingInbound:(id)a0;
- (void)createSharingSessionForSFDevice:(id)a0 holdForPIN:(char)a1 fromInbound:(id)a2 completion:(id /* block */)a3;
