...
@property char finisherDidCommit;
...
- (void)_prepareForStartDiagnosticExtensionWithDEDIdentifier:(id)a0 parameters:(id)a1 newCollectRemovedPendingKill:(char *)a2 completion:(id /* block */)a3;
...
- (void)cleanupFinishedUploads:(char)a0;
...
- (char)shouldCollectDiagnosticWithId:(id)a0;
