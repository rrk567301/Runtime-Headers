...
+ (id)sharedManager;
+ (char)digitFromCharacter:(unsigned short)a0 digit:(unsigned int *)a1;
...
- (char)handleInputCharacter:(unsigned short)a0 forUserAuthorizationRequest:(id)a1 error:(id *)a2;
- (char)removeUserAuthorizationRequest:(id)a0 error:(id *)a1;
- (char)removeAllUserAuthorizationRequests:(id *)a0;
