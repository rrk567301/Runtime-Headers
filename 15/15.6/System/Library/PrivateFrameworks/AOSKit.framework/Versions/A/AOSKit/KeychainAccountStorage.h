...
+ (char)_isValidKeychainItem:(struct __SecKeychainItem { } *)a0;
...
+ (char)_storeInfo:(id)a0 forDSID:(id)a1 withKey:(id)a2;
+ (char)_storeKey:(id)a0 forDSID:(id)a1 service:(id)a2 primaryAppleID:(id)a3 andAccount:(struct AOSAccount { } *)a4;
+ (id)_storedInfoForDSID:(id)a0 withKey:(id)a1;
+ (id)_storedKeyForDSID:(id)a0 andAccount:(struct AOSAccount { } *)a1;
+ (char)_updateAlias:(id)a0 forDSID:(id)a1;
+ (char)_updateAliases:(id)a0 forDSID:(id)a1;
+ (id)configuredAccountIdentifiers;
+ (void)removeInfoForAccount:(struct AOSAccount { } *)a0;
+ (char)storeInfo:(id)a0 forAccount:(struct AOSAccount { } *)a1;
