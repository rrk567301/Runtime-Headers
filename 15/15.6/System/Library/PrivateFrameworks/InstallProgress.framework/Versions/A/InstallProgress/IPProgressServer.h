...
- (id)_progressForIdentity:(id)a0 createIfMissing:(char)a1;
- (id)_queue_progressForIdentity:(id)a0 createIfMissing:(char)a1;
...
- (char)serverBehavior:(id)a0 shouldAcceptConnection:(id)a1;
