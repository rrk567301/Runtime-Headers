...
- (char)_willAlarm:(id)a0 fireFrom:(double)a1 to:(double)a2;
- (char)isEventInterestingForSettingAlarm:(id)a0;
- (char)shouldShowSuggestionForEarlyEvent:(id)a0 alarms:(id)a1 environment:(id)a2;
