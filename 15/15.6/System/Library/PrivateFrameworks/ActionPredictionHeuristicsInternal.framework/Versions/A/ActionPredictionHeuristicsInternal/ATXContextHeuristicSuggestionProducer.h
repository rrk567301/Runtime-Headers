...
+ (id)_dummyUiSpecWithTitle:(id)a0 subtitle:(id)a1 predictionReason:(id)a2 shouldClearOnEngagement:(char)a3 predictionReasons:(unsigned long long)a4;
...
+ (id)_uiSpecWithTitle:(id)a0 subtitle:(id)a1 predictionReason:(id)a2 shouldClearOnEngagement:(char)a3 predictionReasons:(unsigned long long)a4 dateInterval:(id)a5;
+ (id)createSuggestionFromShortcutsAction:(id)a0 predictionReasons:(unsigned long long)a1 localizedReason:(id)a2 title:(id)a3 subtitle:(id)a4 score:(double)a5 shouldClearOnEngagement:(char)a6 dateInterval:(id)a7;
...
+ (id)navigationToDestination:(id)a0 title:(id)a1 subtitle:(id)a2 transportType:(unsigned long long)a3 destinationName:(id)a4 predictionReasons:(unsigned long long)a5 localizedReason:(id)a6 score:(double)a7 shouldClearOnEngagement:(char)a8 validStartDate:(id)a9 validEndDate:(id)a10 dateInterval:(id)a11;
