...
+ (char)allowNavigationSuggestionForLocation:(id)a0 maxDistance:(unsigned long long)a1;
...
+ (char)isAtLocation:(id)a0 maxDistance:(unsigned long long)a1;
+ (char)isDestinationTooCloseToNavigate:(id)a0;
+ (id)locationFromEvent:(id)a0 schemaType:(unsigned long long)a1;
+ (id)navigationSubtitleForType:(unsigned long long)a0;
+ (id)navigationSuggestionActionForDestination:(id)a0 event:(id)a1 transportType:(id)a2 schemaForEvent:(id)a3 predictionReasons:(unsigned long long)a4 heuristicDevice:(id)a5 score:(double)a6 shouldClearOnEngagement:(char)a7 validStartDate:(id)a8 validEndDate:(id)a9;
