...
- (id)suggestionForNavigationToDestination:(id)a0 transportType:(unsigned long long)a1 destinationName:(id)a2 subtitle:(id)a3 predictionReasons:(unsigned long long)a4 score:(double)a5 shouldClearOnEngagement:(char)a6 validStartDate:(id)a7 validEndDate:(id)a8;
