...
- (void)_expediteBBAssertionBGAppActive_sync:(char)a0 handler:(id /* block */)a1;
...
- (void)expediteBBAssertionBGAppActive:(char)a0 handler:(id /* block */)a1;
- (void)expediteCellularForReason:(BOOL)a0 reason:(id)a1;
- (void)getMLPredictedThroughput:(id /* block */)a0 options:(id)a1;
- (void)getProximityLinkRecommendation:(char)a0 recommendation:(id /* block */)a1;
