...
@interface AKASAuthorizationProvider : NSObject <AKAuthorizationPasswordAuthenticationDelegate, AKAlertHandlerUIProvider, _ASAuthenticationProvider> {
    ...
    NSString *_appName;
    char _didFailWithErrorRequiringPasswordAuth;
}
...
- (void).cxx_destruct;
- (char)alertHandlerShowAlert:(id)a0 primaryAction:(id /* block */)a1 altAction:(id /* block */)a2;
...
- (char)_shouldContinueWithPasswordForError:(id)a0;
