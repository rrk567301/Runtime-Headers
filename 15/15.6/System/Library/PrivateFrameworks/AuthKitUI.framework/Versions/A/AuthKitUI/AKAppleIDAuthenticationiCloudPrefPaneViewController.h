...
@property (nonatomic, setter=setCreateEnabled:) char isCreateEnabled;
@property (nonatomic, setter=setUsernameEditable:) char isUsernameEditable;
...
- (void)setPasswordFieldHidden:(char)a0 animated:(char)a1;
