...
@property (nonatomic) char needsSmoothAnimationMomentaryToggle;
...
- (void)viewDidLayout;
- (void)viewDidLoad;
- (void)_delegate_willShowViewController:(id)a0 animated:(char)a1;
- (void)_performSmoothAnimation;
- (void)_prepareForSmoothAnimation;
- (void)_removeViewController:(id)a0;
- (void)_showBarItemsOfViewController:(id)a0 animated:(char)a1;
- (void)_showViewController:(id)a0 animated:(char)a1;
- (void)_transitionFromViewController:(id)a0 toViewController:(id)a1 animated:(char)a2;
