...
@property (nonatomic) char isPasswordEditable;
...
@property (nonatomic) char hideCreateButton;
...
@property (nonatomic) char showRememberPasswordCheckbox;
@property (nonatomic) char rememberPassswordCheckedByDefault;
@property (copy, nonatomic) NSString *rememberPasswordCheckboxString;
@property (nonatomic) char preventSignIn;
...
- (void)configureButtonActionsIncludingCreateButton:(char)a0 withLoginCompletion:(id /* block */)a1;
