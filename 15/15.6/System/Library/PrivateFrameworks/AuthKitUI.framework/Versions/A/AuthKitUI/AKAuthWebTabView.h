...
@property (nonatomic) char isButtonBarShown;
@property (nonatomic) char isResizeAvailible;
@property (nonatomic) char isWebClientIsReadyCalled;
@property (nonatomic) char isWebClientHasLoadedCalled;
@property (copy, nonatomic) id /* block */ defaultAction;
@property (retain, nonatomic) NSImage *displayImage;
@property (nonatomic) char loadContentImmediately;
@property (nonatomic) char contentLoaded;
...
- (void)setPageImageIsHidden:(char)a0;
- (void)setPageSubTitle:(id)a0;
- (void)setPageSymbol:(id)a0;
- (void)setRightNavButton:(id)a0 callback:(id)a1;
- (char)shouldSelectToLocation:(id)a0 toSection:(id)a1;
- (char)shouldShowButtonBar:(id)a0;
...
- (void)updateContinueButton:(char)a0;
