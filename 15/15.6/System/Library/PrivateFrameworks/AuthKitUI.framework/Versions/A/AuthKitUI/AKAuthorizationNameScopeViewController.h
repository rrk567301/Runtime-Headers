...
@property (nonatomic) char hasClearButton;
...
@property (nonatomic) char internalIsEditingName;
...
- (void)_delegate_didSelectEditClear:(char)a0;
...
- (id)_newTextField;
- (id)_newValueLabelEditable:(char)a0;
- (void)_setEditingNameAlphaValue:(double)a0 animated:(char)a1;
- (void)_setupEditValueLabels:(unsigned long long)a0;
- (void)_setupValueLabelEditable:(char)a0;
