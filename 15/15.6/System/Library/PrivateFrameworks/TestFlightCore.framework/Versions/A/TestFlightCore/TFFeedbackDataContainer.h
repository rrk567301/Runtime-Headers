...
- (char)isEntryWithIdentifierLoading:(id)a0;
- (char)isGroupWithIdentifierIncluded:(id)a0;
- (id)numberForIdentifier:(id)a0;
- (void)overwriteWithContentsOfDataContainer:(id)a0;
- (void)performBatchUpdates:(id /* block */)a0 suppressingNotifications:(char)a1;
- (void)prepareInitialValuesForForm:(id)a0;
- (void)setEntryLoadingForIdentifier:(id)a0 toValue:(char)a1;
- (void)setGroupInclusionForIdentifier:(id)a0 toValue:(char)a1;
