...
- (void)showHowToWithTitle:(id)a0 subtitle:(id)a1 screenshotImageDict:(id)a2 primaryButtonTitle:(id)a3 primaryButtonEvent:(unsigned long long)a4 secondaryButtonTitle:(id)a5 secondaryButtonEvent:(unsigned long long)a6 animated:(char)a7;
- (void)showLoadingAnimated:(char)a0;
- (void)showTestNotesWithTitle:(id)a0 lockup:(id)a1 testNotesTitle:(id)a2 testNotesText:(id)a3 primaryButtonTitle:(id)a4 primaryButtonEvent:(unsigned long long)a5 animated:(char)a6 fetchingOnImageFetcher:(id)a7;
