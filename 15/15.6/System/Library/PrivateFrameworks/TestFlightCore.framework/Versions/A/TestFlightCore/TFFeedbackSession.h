...
@property (nonatomic) char didSnapshot;
@property (nonatomic, getter=isWaitingOnAggregatorForSubmission) char waitingOnAggregatorForSubmission;
...
@property (nonatomic) char forcePrefilledEmailViewVariant;
