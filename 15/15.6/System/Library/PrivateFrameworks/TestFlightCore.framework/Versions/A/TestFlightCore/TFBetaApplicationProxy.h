...
- (char)isBetaAppLaunchScreenEnabledForInstalledVersion;
- (char)isProactiveFeedbackEnabledForInstalledVersion;
...
- (void)setBetaAppLaunchScreenEnabled:(char)a0 forVersion:(id)a1 build:(id)a2;
- (void)setProactiveFeedbackEnabled:(char)a0 forVersion:(id)a1 build:(id)a2;
