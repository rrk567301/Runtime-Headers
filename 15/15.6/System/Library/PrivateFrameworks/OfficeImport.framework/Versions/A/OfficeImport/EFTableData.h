...
- (void)dealloc;
- (id)table;
- (id)initWith:(struct EFStrTok { id x0; int x1; union EFData { struct { unsigned long long x0; unsigned long long x1; char x2; } x0; struct { unsigned long long x0; void *x1; } x1; struct { unsigned int x0; unsigned int x1; char x2; char x3; } x2; } x2; } *)a0;
- (id)reference;
