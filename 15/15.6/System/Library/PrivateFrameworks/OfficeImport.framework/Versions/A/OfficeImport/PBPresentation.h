...
+ (void)readFrom:(void *)a0 to:(id)a1 cancel:(id)a2 asThumbnail:(char)a3 delegate:(id)a4;
...
+ (void)readSlides:(id)a0 masterLayoutMap:(id)a1 slideIdMap:(id)a2 state:(id)a3 isThumbnail:(char)a4 delegate:(id)a5;
