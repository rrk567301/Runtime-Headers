...
- (void)getListLevel:(char *)a0 andListIndex:(int *)a1 foundListLevel:(char *)a2 foundListIndex:(char *)a3 fromParagraphProperties:(id)a4;
- (void)getListLevel:(char *)a0 andListIndex:(int *)a1 foundListLevel:(char *)a2 foundListIndex:(char *)a3 fromStyle:(id)a4;
- (char)getListLevel:(char *)a0 andListIndex:(int *)a1 fromStyleOnly:(char)a2;
- (id)initWithWDParagraph:(id)a0 parent:(id)a1 isInTextFrame:(char)a2;
