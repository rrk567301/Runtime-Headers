...
+ (void)addShapeForTransition:(id)a0 relativeBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 rotation:(float)a2 state:(id)a3;
+ (char)map1NodeWithState:(id)a0;
+ (char)map2NodeWithState:(id)a0;
