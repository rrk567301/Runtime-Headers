...
+ (void)addStopsFromArray:(const struct OAVGradientStop { id x0; float x1; } *)a0 stopCount:(int)a1 inverted:(char)a2 startPos:(float)a3 endPos:(float)a4 toGradientFill:(id)a5 manager:(id)a6;
