...
+ (id)_parseFontName:(id)a0 nameContainsBold:(char *)a1 nameContainsItalic:(char *)a2;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithEDStyle:(id)a0 type:(int)a1 columnWidth:(unsigned long long)a2 contentWidth:(unsigned long long)a3 truncateContents:(char)a4;
