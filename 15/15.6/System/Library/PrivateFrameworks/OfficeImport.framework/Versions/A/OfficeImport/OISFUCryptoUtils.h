...
+ (char)checkKey:(id)a0 againstPassphraseVerifier:(id)a1;
...
+ (char)generateRandomDataInBuffer:(char *)a0 length:(unsigned long long)a1;
+ (id)generateRandomSalt;
+ (id)generateRandomSaltWithLength:(unsigned long long)a0;
+ (id)hashForPassphrase:(id)a0 withSalt:(id)a1;
+ (char)isEncryptionVersionAndFormatSupportedInPassphraseVerifier:(id)a0;
+ (unsigned int)iterationCountFromPassphraseVerifier:(id)a0;
+ (id)newBufferedInputStreamForDecryptingFile:(id)a0 key:(id)a1 isDeflated:(char)a2 zipStream:(id *)a3;
+ (id)newBufferedInputStreamForDecryptingZippedBundle:(id)a0 key:(id)a1 zipArchive:(id)a2 isDeflated:(char)a3 zipStream:(id *)a4;
+ (id)saltForSageFiles;
