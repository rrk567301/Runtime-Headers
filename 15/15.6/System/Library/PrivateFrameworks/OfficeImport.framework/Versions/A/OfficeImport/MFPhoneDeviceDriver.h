...
- (id)createPatternBrush:(id)a0 usePaletteForBilevel:(char)a1;
- (id)createPen;
...
- (void)drawBezierPath:(id)a0 dc:(id)a1 fill:(char)a2 stroke:(char)a3;
