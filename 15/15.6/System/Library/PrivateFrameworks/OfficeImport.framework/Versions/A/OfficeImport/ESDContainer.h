...
- (id)containerChildOfType:(unsigned short)a0 instance:(short)a1 mustExist:(char)a2;
- (id)containerFromObject:(id)a0 mustExist:(char)a1;
- (void *)eshContainer;
- (void *)eshGroup;
...
- (id)firstContainerChildOfType:(unsigned short)a0 mustExist:(char)a1;
