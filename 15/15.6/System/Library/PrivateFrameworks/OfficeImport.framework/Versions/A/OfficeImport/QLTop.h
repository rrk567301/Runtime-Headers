...
- (void).cxx_destruct;
- (id)documentWithFile:(id)a0 orData:(id)a1 isXML:(char)a2 archiver:(id)a3;
...
- (void)readerDidReadElement:(id)a0 atIndex:(unsigned long long)a1 inDocument:(id)a2 isLastElement:(char)a3;
