@class EDRowBlocks, NSMutableDictionary, EDFormula, EDName, OITSUPointerKeyDictionary, EDSheet;
...
- (BOOL)cleanArea:(unsigned int)a0 updateSheet:(char)a1;
...
- (BOOL)cleanRef:(unsigned int)a0 updateSheet:(char)a1;
...
- (char)doesNameIndexContainCircularReferences:(unsigned int)a0 sheetIndex:(unsigned long long)a1 previousNameIndexes:(void *)a2;
- (char)isArrayedFormulaSupported:(id)a0 allowSimpleRanges:(char)a1 formulasBeingEvaluated:(id)a2;
