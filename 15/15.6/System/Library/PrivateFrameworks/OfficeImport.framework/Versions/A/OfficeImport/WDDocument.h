...
- (void)setAutoHyphenate:(char)a0;
- (void)setBookFold:(char)a0;
- (void)setBorderSurroundFooter:(char)a0;
- (void)setBorderSurroundHeader:(char)a0;
...
- (void)setEvenAndOddHeaders:(char)a0;
...
- (void)setKinsokuStrict:(char)a0;
- (void)setMirrorMargins:(char)a0;
- (void)setNoTabForHangingIndents:(char)a0;
- (void)setShowComments:(char)a0;
- (void)setShowFormatting:(char)a0;
- (void)setShowInsertionsAndDeletions:(char)a0;
- (void)setShowMarkup:(char)a0;
- (void)setShowRevisionMarksOnScreen:(char)a0;
