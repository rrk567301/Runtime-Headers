...
+ (void)addStopsFromArray:(const struct OABGradientStop { id x0; float x1; } *)a0 stopCount:(int)a1 inverted:(char)a2 startPos:(float)a3 endPos:(float)a4 toStopArray:(id)a5 fillPropertiesManager:(id)a6;
