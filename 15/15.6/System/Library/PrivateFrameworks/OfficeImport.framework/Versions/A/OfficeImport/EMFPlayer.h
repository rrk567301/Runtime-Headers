...
- (int)playAngleArc:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
...
- (int)playExtTextOut:(unsigned int)a0 in_pRecord:(const char *)a1 wideChars:(char)a2;
...
- (int)playPolyBezier:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyBezierTo:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyDraw:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyLine:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyLineTo:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyPolyLine:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolyPolygon:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
- (int)playPolygon:(unsigned int)a0 in_pRecord:(const char *)a1 in_is16bit:(char)a2;
...
- (int)playStrokeAndFillPath:(unsigned int)a0 in_pRecord:(const char *)a1 in_stroke:(char)a2 in_fill:(char)a3;
...
- (void)setIgnoreEMFPlusRecords:(char)a0;
- (void)setIgnoreEMFRecords:(char)a0;
