...
+ (void)writeShapePathPoint:(struct OADAdjustPoint { struct OADAdjustCoord { char x0; int x1; } x0; struct OADAdjustCoord { char x0; int x1; } x1; })a0 origin:(struct CsPoint<int> { int x0[2]; })a1 to:(id)a2;
