...
+ (void)readParagraphProperties:(id)a0 paragraphProperty:(void *)a1 bulletStyle:(struct PptParaProperty9 { struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; } x0; short x1; BOOL x2; struct PptTextAutoNumberScheme { unsigned char x0 : 6; short x1; } x3; } *)a2 isMaster:(char)a3 state:(id)a4;
