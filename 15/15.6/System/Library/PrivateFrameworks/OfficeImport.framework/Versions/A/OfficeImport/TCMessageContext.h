...
+ (void)reportObjectOrPlaceholder:(id)a0 withWarning:(id)a1 parameters:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
...
+ (void)setIsFileStructuredStorage:(char)a0;
...
- (void)reportWarningForObject:(id)a0 warning:(id)a1 parameterList:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
- (void)reportWarningsToDelegate;
