...
- (int)createPatternBrush:(id)a0 index:(unsigned int)a1 usePaletteForBilevel:(char)a2;
...
- (int)realizePalette;
- (id)recolor:(id)a0 fill:(char)a1;
- (id)recolor:(unsigned char)a0 in_green:(unsigned char)a1 in_blue:(unsigned char)a2 fill:(char)a3;
