...
+ (int)presetIdFromFlyMethod:(int)a0 isEntrance:(char)a1;
...
+ (char)readClientTextBoxFromShape:(id)a0 toGraphic:(id)a1 clientData:(id)a2 state:(id)a3;
...
+ (char)readOleFromClientDataHolder:(id)a0 toGraphic:(id)a1 tgtClientData:(id)a2 state:(id)a3;
+ (char)readPlaceholderInfo:(id)a0 clientData:(id)a1 toGraphic:(id)a2 presentationState:(id)a3;
+ (char)readRecolorInfoFromClientDataHolder:(id)a0 toClientData:(id)a1 state:(id)a2;
