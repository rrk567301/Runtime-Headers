...
+ (char)isAnchorRelative:(id)a0;

- (id)worksheetMapper;
- (struct CGPoint { double x0; double x1; })anchorMarkerToPosition:(struct EDCellAnchorMarker { int x0; float x1; int x2; float x3; })a0 rowGrid:(double *)a1 columnGrid:(double *)a2 start:(char)a3 relative:(char)a4;
- (id)getImageBounds;
