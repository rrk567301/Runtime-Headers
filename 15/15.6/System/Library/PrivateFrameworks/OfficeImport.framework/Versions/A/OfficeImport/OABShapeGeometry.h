...
+ (void)appendAdjustPoint:(struct OADAdjustPoint { struct OADAdjustCoord { char x0; int x1; } x0; struct OADAdjustCoord { char x0; int x1; } x1; })a0 toPathParams:(void *)a1;
+ (int)actualPathCommandForPathCommand:(int)a0 index:(unsigned short)a1;
+ (struct OADAdjustCoord { char x0; int x1; })adjustCoordWithComputedValue:(struct EshComputedValue { BOOL x0; int x1; })a0;
+ (struct EshComputedValue { BOOL x0; int x1; })computedValueWithAdjustCoord:(struct OADAdjustCoord { char x0; int x1; })a0;
