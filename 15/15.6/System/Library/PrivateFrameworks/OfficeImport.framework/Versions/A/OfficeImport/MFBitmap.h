...
- (char)parseHeader:(const char *)a0 in_headerSize:(unsigned int)a1;
- (unsigned int)pixelDataOffset:(const char *)a0 in_headerSize:(unsigned int)a1 in_usage:(int)a2;
- (char)processDIBHeader:(id)a0 in_header:(const char *)a1 in_headerSize:(unsigned int)a2 in_usage:(int)a3;
