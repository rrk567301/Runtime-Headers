...
@property (readonly, nonatomic) char fingerPresent;
@property (readonly, nonatomic) char passcodeActive;
@property (readonly, nonatomic) char passphraseActive;
@property (readonly, nonatomic) char passcodeWasPresented;
...
+ (char)canPerformPSD2StyleBuyForAccessControlRef:(struct __SecAccessControl { } *)a0;
