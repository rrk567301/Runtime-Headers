...
- (char)_addFileToIndex:(const char *)a0 error:(id *)a1;
- (char)_buildSingleFileIndex:(id *)a0;
...
- (char)_readArchiveMetadata:(id *)a0;
- (char)addReferenceToIndex:(id)a0 error:(id *)a1;
...
- (void)enumerateEntriesInRange:(struct os_timesync_range_s { struct os_trace_uuid_map_s *x0; unsigned long long x1; unsigned long long x2; unsigned char x3[0][16]; } *)a0 options:(unsigned int)a1 usingCatalogFilter:(id)a2 catalogCacheSize:(unsigned int)a3 dataCacheSize:(unsigned int)a4 usingBlock:(id /* block */)a5;
- (void)enumerateFilesUsingBlock:(id /* block */)a0;
- (id)initWithCollection:(id)a0 buildLocalIndex:(char)a1;
