...
- (char)containsProcessID:(id)a0;
- (char)containsProcessLookupSubstr:(id)a0;
- (char)containsSenderLookupSubstr:(id)a0;
- (char)containsSubsystemSubstr:(id)a0;
- (char)containsUUID:(id)a0;
