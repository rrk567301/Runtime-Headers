...
- (id)_readBaseImageFromDataProvider:(struct CGDataProvider { } *)a0 providerSource:(id)a1 baseWasValid:(char *)a2;
- (id)_readDataFromTagAtPath:(id)a0 inMetadata:(struct CGImageMetadata { } *)a1;
- (char)readAnnotationsFromArchivedModelData:(id)a0 toController:(id)a1;
- (id)readArchivedModelDataFromImageData:(id)a0;
- (id)readArchivedModelDataFromImageURL:(id)a0;
- (id)readBaseImageFromData:(id)a0 baseWasValid:(char *)a1;
- (id)readBaseImageFromImageAtURL:(id)a0 baseWasValid:(char *)a1;
