...
+ (char)_shouldUseAKAnnotation:(id)a0 toRepresentCGPDFAnnotation:(struct CGPDFAnnotation { } *)a1;
...
+ (void)addTextOfAnnotation:(id)a0 toDictionary:(id)a1 forKey:(id)a2 canUsePlaceholder:(char)a3;
