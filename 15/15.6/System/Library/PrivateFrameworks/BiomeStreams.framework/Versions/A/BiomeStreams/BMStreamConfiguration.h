...
@property (readonly, nonatomic) char enableSubscriptions;
@property (readonly, nonatomic) char enableSubscriptionSubstream;
@property (readonly, nonatomic) char enableTombstoneSubstream;
