...
+ (char)_atLeastOneSegmentFileInDirectory:(id)a0 fileManager:(id)a1;
...
- (id)publishersForAccounts:(id)a0 deviceTypes:(unsigned long long)a1 includeLocal:(char)a2 options:(id)a3 useCase:(id)a4 pipeline:(id /* block */)a5;
