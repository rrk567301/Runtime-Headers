...
- (char)checkAndReportDecodingFailureIfNeededForCFAbsoluteTime:(double)a0 key:(id)a1 coder:(id)a2 errorDomain:(id)a3 errorCode:(long long)a4;
- (char)checkAndReportDecodingFailureIfNeededForid:(id)a0 key:(id)a1 coder:(id)a2 errorDomain:(id)a3 errorCode:(long long)a4;
- (char)checkAndReportDecodingFailureIfNeededForuint32_t:(unsigned int)a0 key:(id)a1 coder:(id)a2 errorDomain:(id)a3 errorCode:(long long)a4;
...
- (id)initWithAbsoluteTime:(double)a0 bundleId:(id)a1 sourceId:(id)a2 intentClass:(id)a3 intentVerb:(id)a4 intentType:(long long)a5 intentHandlingStatus:(long long)a6 interaction:(id)a7 itemID:(id)a8 donatedBySiri:(char)a9 interactionDirection:(long long)a10;
- (id)initWithAbsoluteTime:(double)a0 bundleId:(id)a1 sourceId:(id)a2 intentClass:(id)a3 intentVerb:(id)a4 intentType:(long long)a5 intentHandlingStatus:(long long)a6 interaction:(id)a7 itemID:(id)a8 donatedBySiri:(char)a9 interactionDirection:(long long)a10 groupIdentifier:(id)a11;
