...
+ (char)isStreamIdentifierValid:(id)a0;
+ (char)isStreamInfoValidForIdentifier:(id)a0 basePath:(id)a1 streamType:(unsigned long long)a2;
+ (char)isStreamTypeInValidRange:(unsigned long long)a0;
