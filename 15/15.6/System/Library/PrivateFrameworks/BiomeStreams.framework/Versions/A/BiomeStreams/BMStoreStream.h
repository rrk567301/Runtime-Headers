...
- (id)_publishersForDevices:(id)a0 includeLocal:(char)a1 options:(id)a2;
- (char)deleteStoreEvent:(id)a0;
...
- (char)pruneEventsOfRemote:(id)a0 withReason:(unsigned long long)a1 policyID:(id)a2 error:(id *)a3 predicateBlock:(id /* block */)a4;
...
- (id)publisherWithStartTime:(id)a0 withEndTime:(id)a1 withMaxEvents:(id)a2 reversed:(char)a3;
- (id)publishersForDevices:(id)a0 startTime:(id)a1 endTime:(id)a2 maxEvents:(id)a3 lastN:(id)a4 reversed:(char)a5 includeLocal:(char)a6 pipeline:(id /* block */)a7;
- (id)publishersForDevices:(id)a0 startTime:(double)a1 includeLocal:(char)a2 pipeline:(id /* block */)a3;
- (id)publishersForDevices:(id)a0 withUseCase:(id)a1 startTime:(id)a2 endTime:(id)a3 maxEvents:(id)a4 lastN:(id)a5 reversed:(char)a6 includeLocal:(char)a7 pipeline:(id /* block */)a8;
- (id)publishersForDevices:(id)a0 withUseCase:(id)a1 startTime:(double)a2 includeLocal:(char)a3 pipeline:(id /* block */)a4;
