...
- (id)init;
- (void).cxx_destruct;
- (id)initWithName:(id)a0 dataType:(long long)a1 requestOnly:(char)a2 fieldNumber:(long long)a3 protoDataType:(long long)a4 convertedType:(long long)a5;
- (id)initWithName:(id)a0 dataType:(long long)a1 requestOnly:(char)a2 fieldPath:(id)a3 protoDataType:(long long)a4 convertedType:(long long)a5;
