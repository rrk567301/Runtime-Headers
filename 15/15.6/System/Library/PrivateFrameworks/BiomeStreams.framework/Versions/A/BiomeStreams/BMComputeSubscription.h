...
@property (nonatomic) char pendingDemand;
@property (retain, nonatomic) NSXPCConnection *connection;
@property (readonly, nonatomic, getter=isUnclaimed) char unclaimed;
...
- (id)XPCEvent;
- (id)initWithIdentifier:(id)a0 client:(id)a1 createdAt:(id)a2 waking:(char)a3 DSLGraph:(id)a4 subscriber:(id)a5 block:(id /* block */)a6;
- (id)initWithIdentifier:(id)a0 client:(id)a1 waking:(char)a2 DSLGraph:(id)a3 block:(id /* block */)a4;
