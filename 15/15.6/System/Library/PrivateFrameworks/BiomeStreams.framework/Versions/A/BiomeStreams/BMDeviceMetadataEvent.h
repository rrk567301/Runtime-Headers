...
@property (readonly, nonatomic) char rapidSecurityResponsePreReboot;
...
- (id)initWithName:(id)a0 build:(id)a1 supplementalBuild:(id)a2 platform:(long long)a3 rapidSecurityResponsePreReboot:(char)a4;
