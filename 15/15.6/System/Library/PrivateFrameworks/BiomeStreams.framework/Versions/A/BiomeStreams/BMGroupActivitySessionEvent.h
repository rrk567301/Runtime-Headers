...
- (id)initWithIsActive:(char)a0 sourceBundleID:(id)a1 activitySessionID:(id)a2 activityID:(id)a3 messagesChatGuid:(id)a4 participantHandles:(id)a5 memberHandles:(id)a6 experienceType:(id)a7;
