...
@property (readonly, nonatomic) char isClient;
...
- (char)checkActiveSubscriptionMarkerForStream:(id)a0;
- (char)checkExistenceOfBookmarkForSubscriptionWithIdentifier:(id)a0 client:(id)a1;
...
- (id)initWithUseCase:(id)a0 domain:(unsigned long long)a1 isClient:(char)a2;
