...
- (id)initWithUniqueId:(id)a0 domainId:(id)a1 personaId:(id)a2 absoluteTimestamp:(double)a3 accountIdentifier:(id)a4 messageIdentifier:(id)a5 fromHandle:(id)a6 toHandles:(id)a7 ccHandles:(id)a8 bccHandles:(id)a9 headers:(id)a10 subject:(id)a11 htmlContent:(id)a12 textContent:(id)a13 isFullyDownloaded:(char)a14 securityMethod:(id)a15 accountHandles:(id)a16 replyTo:(id)a17 mailboxIdentifiers:(id)a18 listId:(id)a19 accountType:(id)a20 attachments:(id)a21 contentProtection:(id)a22;
