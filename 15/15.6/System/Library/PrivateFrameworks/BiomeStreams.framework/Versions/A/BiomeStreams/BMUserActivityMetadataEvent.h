...
- (id)initWithAbsoluteTimestamp:(double)a0 userActivityData:(id)a1 title:(id)a2 activityType:(id)a3 associatedBundleId:(id)a4 associatedURLString:(id)a5 modeIdentifier:(id)a6 topics:(id)a7 hasAssociatedImageRepresentation:(char)a8 uuid:(id)a9;
