...
+ (char)setSQLiteValueIn:(id)a0 withFieldNumber:(long long)a1 typeRawValue:(long long)a2 convertedTypeRawValue:(long long)a3 sqliteContext:(void *)a4 error:(id *)a5;
+ (char)setSQLiteValueIn:(id)a0 withFieldPath:(id)a1 typeRawValue:(long long)a2 convertedTypeRawValue:(long long)a3 sqliteContext:(void *)a4 error:(id *)a5;
