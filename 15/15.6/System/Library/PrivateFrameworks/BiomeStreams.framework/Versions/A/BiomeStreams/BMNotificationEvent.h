...
- (id)initWithUniqueID:(id)a0 absoluteTimestamp:(double)a1 usageType:(unsigned long long)a2 bundleID:(id)a3 notificationID:(id)a4 deviceID:(id)a5 title:(id)a6 subtitle:(id)a7 badge:(unsigned long long)a8 threadID:(id)a9 categoryID:(id)a10 sectionID:(id)a11 contactIDs:(id)a12 isGroupMessage:(char)a13;
