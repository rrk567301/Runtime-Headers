...
- (char)checkIfName:(id)a0 notInList:(id)a1;
- (char)commandParse:(id)a0 commandIndex:(unsigned int)a1;
- (id)fullUsageWithPrefix:(id)a0;
- (char)parseSubCommand:(id)a0 commandIndex:(unsigned int)a1;
- (char)parseUsingDocopt:(id)a0;
- (id)shortUsageWithPrefix:(id)a0;
- (id)subCommandsUsageWithPrefix:(id)a0;
- (char)verifyArgumentsForClass;
- (char)verifyCommandStructure;
- (char)verifyInputs;
- (char)verifyNoArgumentDuplications;
- (char)verifySingleArgName:(id)a0 ofType:(unsigned long long)a1;
