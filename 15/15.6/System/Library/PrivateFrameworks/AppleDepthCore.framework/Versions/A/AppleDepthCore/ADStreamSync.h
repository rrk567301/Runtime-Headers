...
@interface ADStreamSync : NSObject {
    ...
    BOOL *_autoAggregation;
}

@property double allowedMatchTimeInterval;

+ (unsigned long long)expectedNumberOfFramesForObject:(id)a0;
...
- (char)areOldestMatchingObjectsInAllowedInterval:(unsigned long long)a0;
- (id)checkForMatch;
- (char)checkOnceForMatch:(id *)a0;
- (id)createAndPopulateMatch;
- (char)dropOldFramesFromStream:(unsigned long long)a0 belowTimestampThreshold:(double)a1;
...
- (char)streamContainsMinimalFrameCount:(unsigned long long)a0;
