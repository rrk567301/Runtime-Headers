...
+ (char)prepareDataBuffer:(struct __CVBuffer { } *)a0 forLength:(int)a1;
+ (char)prepareDataBuffer:(struct __CVBuffer { } *)a0 forLength:(int)a1 additionalDataSize:(unsigned long long)a2;
...
- (char)pointCloudToCSV:(id)a0 atomically:(char)a1;
- (char)pointCloudToImageFile:(id)a0 uti:(id)a1 atomically:(char)a2;
- (char)pointCloudToJSPP:(id)a0 atomically:(char)a1;
