...
- (id)listForKey:(id)a0;
- (void)registerUpdateHandlerForKeys:(id)a0 invokeOnRegistration:(char)a1 scopeObject:(id)a2 handlerBlock:(id /* block */)a3;
- (char)createPropertyForKey:(id)a0;
