...
+ (char)isEqualPolynomials:(const struct ADDistortionPolynomials { float x0[8]; float x1[8]; } *)a0 otherPolynomials:(const struct ADDistortionPolynomials { float x0[8]; float x1[8]; } *)a1;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (char)isEqual:(id)a0;
- (id)initWithDictionary:(id)a0;
- (void)scale:(float)a0;
- (id)dictionaryRepresentation:(char)a0;
...
- (void)distortPixels:(unsigned long long)a0 undistortedPixels:(const struct CGPoint { double x0; double x1; } *)a1 withPixelSize:(float)a2 referenceDimensions:(struct CGSize { double x0; double x1; })a3 outDistortedPixels:(struct CGPoint { double x0; double x1; } *)a4;
...
- (void)undistortPixels:(unsigned long long)a0 distortedPixels:(const struct CGPoint { double x0; double x1; } *)a1 withPixelSize:(float)a2 referenceDimensions:(struct CGSize { double x0; double x1; })a3 outUndistortedPixels:(struct CGPoint { double x0; double x1; } *)a4;
