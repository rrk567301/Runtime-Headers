...
- (char)containsLegacySetting:(unsigned long long)a0;
- (char)containsProperty:(SEL)a0;
- (char)containsPropertyFromExtension:(Class)a0;
- (char)containsSetting:(id)a0;
- (char)containsSettingNamed:(id)a0;
