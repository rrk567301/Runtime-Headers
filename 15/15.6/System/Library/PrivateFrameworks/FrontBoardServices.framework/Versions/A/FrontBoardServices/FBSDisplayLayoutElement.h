...
@property (nonatomic) char fillsDisplayBounds;
@property (nonatomic, getter=isUIApplicationElement) char UIApplicationElement;
@property (copy, nonatomic) NSString *bundleIdentifier;
@property (nonatomic) char hasKeyboardFocus;
