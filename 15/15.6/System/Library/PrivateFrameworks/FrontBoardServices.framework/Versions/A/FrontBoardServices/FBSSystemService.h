...
- (char)canOpenApplication:(id)a0 reason:(long long *)a1;
...
- (void)terminateApplication:(id)a0 forReason:(long long)a1 andReport:(char)a2 withDescription:(id)a3;
- (void)terminateApplicationGroup:(long long)a0 forReason:(long long)a1 andReport:(char)a2 withDescription:(id)a3;
