...
- (char)addSubscriptions:(id)a0;
- (id)allSubscriptions;
- (char)removeSubscription:(id)a0;
- (id)allSubscriptionIdentifiers;
- (id)deviceIdentifiersWithActiveSubscriptions;
- (char)removeAllSubscriptionsMadeBySubscribingDevice:(id)a0;
- (char)removeSubscriptionWithIdentifier:(id)a0 fromSubscribingDevice:(id)a1 onSubscribedDevice:(id)a2;
- (void)saveToStorage;
