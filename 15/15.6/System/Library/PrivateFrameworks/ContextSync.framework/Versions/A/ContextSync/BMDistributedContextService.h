...
@property (nonatomic) char rebootNotificationDelivered;
...
- (void)assertLocalSubscriptionsToDevice:(id)a0 shouldSendIfNoSubscriptions:(char)a1;
...
- (void)logMetricsForSubscription:(id)a0 uponReboot:(char)a1;
...
- (char)registerForUpdates:(id)a0 withIdentifier:(id)a1 withOptions:(unsigned long long)a2 forDeviceTypes:(long long)a3 withError:(id *)a4;
- (char)registerForUpdates:(id)a0 withIdentifier:(id)a1 withOptions:(unsigned long long)a2 forDevices:(id)a3 withError:(id *)a4;
- (char)registerRemoteDSLSubscription:(id)a0 withRemoteIdentifier:(id)a1 withOptions:(unsigned long long)a2 forDevices:(id)a3;
...
- (char)sendIDSMessageWithContent:(id)a0 asWaking:(char)a1 toDevice:(id)a2 error:(id *)a3;
...
- (char)unregisterForUpdates:(id)a0 withIdentifier:(id)a1 forDevices:(id)a2 withError:(id *)a3;
...
- (char)unregisterRemoteDSLSubscription:(id)a0 withRemoteIdentifier:(id)a1 forDevices:(id)a2;
