...
- (char)_formatStorageKeyArrayBytes:(void *)a0 length:(unsigned long long)a1 fromKey:(const struct _renditionkeytoken { unsigned short x0; unsigned short x1; } *)a2;
...
- (char)getFontName:(id *)a0 baselineOffset:(double *)a1 forFontType:(id)a2;
...
- (char)hasPhysicalColorWithName:(id)a0;
- (char)imageNamedShouldFlip:(id)a0;
...
- (char)localizationWorkaroundForKeyList:(const struct _renditionkeytoken { unsigned short x0; unsigned short x1; } *)a0 withLocale:(id)a1;
