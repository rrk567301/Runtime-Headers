...
+ (char)assetExistsForRenditionKey:(id)a0 fromTheme:(unsigned long long)a1;
...
- (char)_canGetRenditionForKey:(id)a0 withDrawingLayer:(long long)a1;
...
- (id)_initWithSystemRenditionKeyList:(struct _renditionkeytoken { unsigned short x0; unsigned short x1; } *)a0;
- (char)_isButtonGlyph;
- (id)_rendition;
- (id)_renditionForSpecificKey:(id)a0;
- (void)_setHasCheckedButtonGlyph:(char)a0;
- (void)_setIsButtonGlyph:(char)a0;
...
- (void)_updateSpecificRenditionKey:(id)a0 isFocused:(char *)a1 owner:(id)a2 userInfo:(id)a3;
...
- (char)hitTestAtPoint:(struct CGPoint { double x0; double x1; })a0 inFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 owner:(id)a2 userInfo:(id)a3;
