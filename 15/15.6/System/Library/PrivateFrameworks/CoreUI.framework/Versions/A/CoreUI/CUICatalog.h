...
+ (struct CGColor { } *)newColorByAdjustingLightnessOfColor:(struct CGColor { } *)a0 darker:(char)a1;
...
+ (char)isValidLCRWithBytes:(const void *)a0 length:(unsigned long long)a1;
...
- (char)containsLookupForName:(id)a0;
...
- (char)hasCustomizedAppearanceForWidget:(id)a0;
- (char)hasCustomizedAppearanceForWidget:(id)a0 variant:(id)a1;
- (char)hasStylePresetWithName:(id)a0 styleConfiguration:(id)a1;
...
- (char)drawGlyphs:(const unsigned short *)a0 atPositions:(const struct CGPoint { double x0; double x1; } *)a1 inContext:(struct CGContext { } *)a2 withFont:(struct __CTFont { } *)a3 count:(unsigned long long)a4 stylePresetName:(id)a5 styleConfiguration:(id)a6 foregroundColor:(struct CGColor { } *)a7;
...
- (char)_doStyledQuartzDrawingInContext:(struct CGContext { } *)a0 inBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 stylePresetName:(id)a2 styleConfiguration:(id)a3 drawingHandler:(id /* block */)a4;
- (char)_effectStyle:(unsigned long long *)a0 state:(long long *)a1 presentationState:(long long *)a2 value:(long long *)a3 resolution:(unsigned long long *)a4 dimension1:(unsigned long long *)a5 appearance:(long long *)a6 fromStyleConfiguration:(id)a7;
...
- (id)allImageNames;
- (char)canGetShapeEffectRenditionWithKey:(id)a0;
...
- (char)fillStyledPath:(struct CGPath { } *)a0 inContext:(struct CGContext { } *)a1 stylePresetName:(id)a2 styleConfiguration:(id)a3;
- (char)fillStyledRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inContext:(struct CGContext { } *)a1 stylePresetName:(id)a2 styleConfiguration:(id)a3;
...
- (char)hasStylePresetWithName:(id)a0;
...
- (char)strokeStyledPath:(struct CGPath { } *)a0 inContext:(struct CGContext { } *)a1 stylePresetName:(id)a2 styleConfiguration:(id)a3;
