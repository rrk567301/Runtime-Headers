...
@property (readonly, nonatomic) struct { float x0; float x1; float x2; float x3; float x4; char x5; char x6; } *hueSaturation;
@property (nonatomic) unsigned long long colorOverlayCount;
@property (readonly, nonatomic) struct { unsigned int x0; float x1; float x2; float x3; float x4; char x5; } *colorOverlay;
...
- (struct CGImage { } *)_newFlattenedImageFromShapeCGImage:(struct CGImage { } *)a0 withScale:(double)a1 ciContext:(id)a2 blendOverImage:(char)a3;
...
- (void)adjustEffectColorsToTemperature:(int)a0 onlyTintableColors:(char)a1;
- (void)applyCustomForegroundColor:(struct CGColor { } *)a0;
- (void)applyCustomForegroundColor:(struct CGColor { } *)a0 tintEffectColors:(char)a1;
- (id)cacheKey;
- (int)cgBlendModeForOutputBlending;
- (float)colorOverlayOpacity;
- (id)compositeEffectStackWithShapeImage:(id)a0 withScale:(double)a1 blendOntoImage:(char)a2;
...
- (id)effectPreset;
- (char)expressableByColorFillCheckingOutputBlending:(char)a0;
- (char)hasBevelEmboss;
- (char)hasEffects;
...
- (id)imageWithColorOverlayOfImage:(id)a0 effect:(struct { unsigned int x0; float x1; float x2; float x3; float x4; char x5; })a1;
...
- (id)imageWithHueSaturationOfImage:(id)a0 effect:(struct { float x0; float x1; float x2; float x3; float x4; char x5; char x6; })a1;
...
- (struct CGImage { } *)newFlattenedImageFromShapeCGImage:(struct CGImage { } *)a0 withScale:(double)a1 cache:(char)a2;
...
- (id)processedImageFromShapeImage:(id)a0 withScale:(double)a1 invertShadows:(char)a2;
...
- (void)scaleBrightnessOfEffectColorsByAmount:(double)a0 onlyTintableColors:(char)a1;
- (void)scaleEffectParametersBy:(double)a0;
- (void)setBypassColorFills:(char)a0;
- (id)standardEffectCompositeWithShapeImage:(id)a0 blendOntoImage:(char)a1;
