...
@interface CSIGenerator : NSObject {
    ...
    char _vectorContainsMulticolorLayers;
    char _vectorContainsHierarchicalLayers;
...
@property (nonatomic, getter=isExcludedFromContrastFilter) char excludedFromContrastFilter;
@property (nonatomic) char optOutOfThinning;
@property (nonatomic) char preserveForArchiveOnly;
@property (nonatomic) char preservedVectorRepresentation;
...
@property (nonatomic) char allowsDeepmapImageCompression;
@property (nonatomic) char allowsDeepmap2ImageCompression;
...
@property (nonatomic, getter=isInterpolatable) char interpolatable;
@property (nonatomic) long long vectorGlyphRenderingMode;
@property (nonatomic) char vectorContainsMulticolorLayers;
@property (nonatomic) char vectorContainsHierarchicalLayers;
...
- (id)CSIRepresentationWithCompression:(char)a0;
...
- (id)initWithTextureImageWithSize:(struct CGSize { double x0; double x1; })a0 forPixelFormat:(long long)a1 cubeMap:(char)a2;
