...
- (void)addColorFillWithRed:(unsigned int)a0 green:(unsigned int)a1 blue:(unsigned int)a2 opacity:(double)a3 blendMode:(unsigned int)a4 tintable:(char)a5;
...
- (void)addHueSaturationWithColorRed:(unsigned int)a0 green:(unsigned int)a1 blue:(unsigned int)a2 angle:(int)a3 width:(int)a4 tintable:(char)a5;
