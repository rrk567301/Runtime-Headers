...
- (id)initWithColorStops:(id)a0 colorMidpoints:(id)a1 opacityStops:(id)a2 opacityMidpoints:(id)a3 smoothingCoefficient:(double)a4 fillColor:(struct _psdGradientColor { double x0; double x1; double x2; double x3; })a5 dither:(char)a6;
- (char)isDithered;
