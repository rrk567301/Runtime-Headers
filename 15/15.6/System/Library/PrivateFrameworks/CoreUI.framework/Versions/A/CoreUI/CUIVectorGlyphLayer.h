...
@property (readonly, nonatomic) char needsWideGamut;
...
@property (readonly, nonatomic) char alwaysPulses;
@property (readonly, nonatomic) char alwaysRotates;
@property (readonly, nonatomic) char alwaysBreathes;
@property (readonly, nonatomic) double opacity;
@property (readonly, nonatomic) double valueThreshold;
@property (readonly, nonatomic) char isEraserLayer;
...
+ (char)_classesContainRenderModeClass:(id)a0;
...
+ (char)_indexFromStyleSuffix:(id)a0 integer:(unsigned long long *)a1;
...
- (id)path;
- (struct CGPath { } *)shape;
- (id)__initGroupWithName:(id)a0 index:(unsigned long long)a1 sublayers:(id)a2 attributes:(struct CGSVGAttributeMap { } *)a3 style:(struct CGSVGAttributeMap { } *)a4 passthrough:(char)a5 delegate:(id)a6;
...
- (char)_anyLayerAlwaysPulses;
- (char)_anyLayerAlwaysRotates;
...
- (void)_setAllLayersAlwaysPulse:(char)a0;
- (void)_setAllLayersAlwaysRotate:(char)a0;
- (void)_setAlwaysPulses:(char)a0;
- (void)_setAlwaysRotates:(char)a0;
- (char)anyLayerNeedsWideGamutColor;
