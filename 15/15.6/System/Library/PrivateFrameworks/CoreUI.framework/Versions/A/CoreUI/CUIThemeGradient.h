...
- (id)initWithColors:(id)a0 colorlocations:(id)a1 colorMidpoints:(id)a2 opacities:(id)a3 opacityLocations:(id)a4 opacityMidpoints:(id)a5 smoothingCoefficient:(double)a6 fillColor:(id)a7 colorSpace:(struct CGColorSpace { } *)a8 dither:(char)a9;
- (char)isDithered;
- (id)opacityLocations;
- (id)opacityStops;
