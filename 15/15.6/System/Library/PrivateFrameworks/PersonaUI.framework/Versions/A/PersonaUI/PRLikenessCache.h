...
@property (retain) NSURL *cacheDirectory;
@property char useMemory;
@property char useFilesystem;
@property char renderIfNeeded;

+ (id)sharedInstance;
+ (char)_purgeOldCacheFilesInDirectory:(id)a0;
+ (id)_applicationCacheDirectory;
+ (char)_ensureExistenceOfDirectory:(id)a0;
+ (id)_imageAtURL:(id)a0;
+ (id)_propertyValueForURL:(id)a0 forKey:(id)a1;
+ (char)_removeImageAtURL:(id)a0;
+ (id)_staticRepresentationCacheURL;
+ (char)_writeImage:(id)a0 toURL:(id)a1;
