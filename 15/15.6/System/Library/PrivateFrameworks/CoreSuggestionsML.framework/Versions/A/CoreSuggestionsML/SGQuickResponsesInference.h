...
+ (id)proactiveTriggerForDynamicLabel:(id)a0 context:(id)a1 language:(id)a2 useContactNames:(char)a3;
+ (id)quickResponsesForMessage:(id)a0 context:(id)a1 time:(id)a2 maxResponses:(unsigned long long)a3 locale:(id)a4 recipientHandles:(id)a5 chunkPath:(id)a6 plistPath:(id)a7 espressoBinFilePath:(id)a8 vocabFilePath:(id)a9 includeCustomResponses:(char)a10 includeResponsesToRobots:(char)a11;
+ (id)quickResponsesForMessage:(id)a0 conversationTurns:(id)a1 maxResponses:(unsigned long long)a2 localeIdentifier:(id)a3 recipientHandles:(id)a4 chunkPath:(id)a5 plistPath:(id)a6 espressoBinFilePath:(id)a7 vocabFilePath:(id)a8 useContactNames:(char)a9 includeCustomResponses:(char)a10 includeResponsesToRobots:(char)a11;
+ (void)registerDisplayedQuickResponses:(id)a0 plistPath:(id)a1 vocabPath:(id)a2;
+ (void)registerResponse:(id)a0 position:(id)a1 isCanned:(char)a2 isUsingQuickResponses:(char)a3 locale:(id)a4 plistPath:(id)a5 vocabPath:(id)a6;
...
- (id)quickResponsesForMessage:(id)a0 maximumResponses:(unsigned long long)a1 conversationHistory:(id)a2 context:(id)a3 time:(id)a4 language:(id)a5 locale:(id)a6 recipients:(id)a7 useContactNames:(char)a8 includeCustomResponses:(char)a9 includeResponsesToRobots:(char)a10;
- (id)quickResponsesFromReplyPositions:(id)a0 isConfident:(char)a1 config:(id)a2;
...
- (id)signpostedQuickResponsesForMessage:(id)a0 maximumResponses:(unsigned long long)a1 conversationHistory:(id)a2 context:(id)a3 time:(id)a4 language:(id)a5 locale:(id)a6 recipients:(id)a7 useContactNames:(char)a8 includeCustomResponses:(char)a9 includeResponsesToRobots:(char)a10;
