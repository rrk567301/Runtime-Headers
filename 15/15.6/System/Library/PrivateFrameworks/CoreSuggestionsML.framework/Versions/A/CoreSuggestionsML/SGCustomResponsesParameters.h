...
@property (readonly, nonatomic) char isCustomResponsesEnabled;
...
@property (readonly, nonatomic) char allowProfanity;
@property (readonly, nonatomic) unsigned long long compatibilityVersion;
@property (readonly, nonatomic) char useNonNegativeClassesOnly;
