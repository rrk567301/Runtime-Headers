...
+ (void)warmup;
+ (id)instanceInMemory;
+ (char)isProfane:(id)a0 inLocales:(id)a1;
...
- (void)addWrittenToResponse:(id)a0 language:(id)a1 isMatch:(char)a2;
- (char)addingMessageExceedsBatchLimit:(unsigned long long)a0 tableLimit:(unsigned long long)a1 message:(id)a2 language:(id)a3 prompt:(id)a4 recipientHandle:(id)a5 sentAt:(id)a6;
...
- (char)deltaForResponsesOnRow:(id /* block */)a0 completion:(id /* block */)a1;
...
- (id)nearestCustomResponsesAndScoresToPromptEmbedding:(id)a0 recipient:(id)a1 limit:(unsigned long long)a2 withinRadius:(float)a3 responseCountExponent:(float)a4 minimumDecayedCount:(float)a5 compatibilityVersion:(unsigned long long)a6 language:(id)a7 locale:(id)a8 allowProfanity:(char)a9 minimumTimeInterval:(double)a10 usageSpreadExponent:(float)a11;
...
- (void)resetCustomResponsesAndResetMessages:(char)a0;
- (void)resetCustomResponsesForEval:(id)a0;
- (char)resetDbIfNeededCompareWithCompatibilityVersion:(unsigned long long)a0;
