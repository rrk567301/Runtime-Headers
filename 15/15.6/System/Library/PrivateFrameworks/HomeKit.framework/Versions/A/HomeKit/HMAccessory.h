...
@property (readonly, nonatomic, getter=isFirmwareUpdateAvailable) char firmwareUpdateAvailable;
...
@property (readonly) char supportsHomeLevelLocationServiceSetting;
...
@property (readonly, nonatomic) char supportsAudioAnalysis;
@property (readonly, nonatomic) char supportsDropIn;
...
@property (readonly) char supportsCoordinationDoorbellChime;
...
@property (readonly, getter=isDemoAccessory) char demoAccessory;
@property (readonly) char supportsAccessCodes;
...
@property (readonly, nonatomic) char mfiCertifiedACWG;
@property (readonly, nonatomic) char supportsAudioGroup;
@property (readonly, nonatomic) char suspendCapable;
@property (readonly, nonatomic) long long productColor;
@property (readonly) char supportsMessagedHomePodSettings;
...
@property (readonly) char supportsMediaContentProfile;
@property (readonly) NSDictionary *bulletinBoardNotificationByEndpoint;
@property (readonly) char supportsStereoOdeonTTSUBypassingPrimary;
...
@property (readonly) char knownToSystemCommissioner;
...
@property (getter=isCurrentAccessory) char currentAccessory;
...
@property (nonatomic) char supportsTargetController;
@property (nonatomic) char targetControllerHardwareSupport;
...
@property (nonatomic) char supportsDiagnosticsTransfer;
...
@property char supportsThirdPartyMusic;
@property char supportsPreferredMediaUser;
@property char supportsDoorbellChime;
@property (readonly) char supportsUserMediaSettings;
@property char supportsCoordinationDoorbellChime;
@property unsigned long long preferredUserSelectionType;
@property (copy) NSUUID *preferredMediaUserUUID;
@property char supportsAccessCodes;
@property (nonatomic) unsigned long long suspendedState;
@property (nonatomic) char suspendCapable;
@property (nonatomic) char demoAccessory;
@property (copy, nonatomic) NSString *assistantIdentifier;
@property (copy) NSString *pendingConfigurationIdentifier;
@property char supportsManagedConfigurationProfile;
@property char supportsMessagedHomePodSettings;
@property char supportsSoftwareUpdateV2;
@property char supportsPrimaryUserInfoSubscription;
@property char supportsRMVonAppleTV;
@property char supportsJustSiri;
@property char supportsMediaContentProfile;
@property (copy) NSUUID *peerIdentifier;
@property char hasSymptomsHandler;
@property (retain) NSDictionary *bulletinBoardNotificationByEndpoint;
@property char supportsStereoOdeonTTSUBypassingPrimary;
@property char hh1EOLEnabled;
@property char supportsHomeLevelLocationServiceSetting;
...
@property (nonatomic, getter=isFirmwareUpdateAvailable) char firmwareUpdateAvailable;
...
@property (nonatomic) char supportsMediaAccessControl;
@property char supportsCHIP;
@property char supportsNativeMatter;
@property char knownToSystemCommissioner;
...
@property char hasOnboardedForNaturalLighting;
...
@property (nonatomic) char supportsUWBUnlock;
...
@property (readonly, nonatomic, getter=isAdditionalSetupRequired) char additionalSetupRequired;
@property (readonly, nonatomic, getter=isCalibrating) char calibrating;
...
@property (readonly, nonatomic, getter=isBridged) char bridged;
...
+ (id)televisionProfilesForAccessoryServices:(id)a0 isSPIEntitled:(char)a1;
...
- (id)mediaProfile;
- (void)pairingIdentityWithPrivateKey:(char)a0 attemptToReadFromKeychain:(char)a1 completionHandler:(id /* block */)a2;
...
- (id)_handleMultipleCharacteristicsUpdated:(id)a0 message:(id)a1 informDelegate:(char)a2;
...
- (void)_invokeDidUpdateSupportsUWBUnlockDelegate:(char)a0;
- (void)_invokeDidUpdateSupportsWalletKeyDelegate:(char)a0;
- (void)_listPairingsWithCompletionHandler:(id /* block */)a0;
- (char)_mergeBulletinBoardNotificationByEndpoint:(id)a0;
- (char)_mergeControlTargetUUIDs:(id)a0;
- (char)_mergeRemoteLoginHandler:(id)a0;
...
- (void)_setNotifyValue:(char)a0 forCharacteristic:(id)a1;
- (void)_unconfigure;
...
- (char)_updateFromAccessory:(id)a0;
- (char)_updateHasSymptomsHandler:(char)a0;
...
- (void)pairingIdentityWithPrivateKey:(char)a0 completionHandler:(id /* block */)a1;
- (void)postConfigure;
...
- (void)setCHIPPairingModeActive:(char)a0 withCompletion:(id /* block */)a1;
- (void)setControllable:(char)a0;
- (void)setHH1EOLEnabled:(char)a0;
...
- (void)setSupportsIdentify:(char)a0;
- (void)setSupportsUserMediaSettings:(char)a0;
...
- (void)updateSettingsAdapterSettingReflected:(char)a0;
- (void)updateShouldProcessTransactionRemovalWithValue:(char)a0 completion:(id /* block */)a1;
