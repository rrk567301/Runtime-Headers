...
@property char didReceiveAccountInfo;
...
@property (readonly, nonatomic, getter=isSessionInProgress) char sessionInProgress;
...
- (char)_configureAccessoryInfoDataProviderIfNeeded;
