...
@property (readonly, nonatomic) char supported;
...
- (void).cxx_destruct;
- (id)initWithLinkQualitySupported:(char)a0 linkLayerType:(unsigned long long)a1 macAddress:(id)a2 networkName:(id)a3 linkQuality:(unsigned long long)a4;
