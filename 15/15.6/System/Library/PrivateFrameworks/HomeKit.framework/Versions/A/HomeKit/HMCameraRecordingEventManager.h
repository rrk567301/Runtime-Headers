@class HMCameraClipManager, NSMapTable, _HMContext, NSString, HMCameraRecordingReachabilityEventManager;
...
- (void)fetchEventsWithDateInterval:(id)a0 limit:(unsigned long long)a1 shouldOrderAscending:(char)a2 completion:(id /* block */)a3;
- (void)fetchEventsWithDateInterval:(id)a0 quality:(long long)a1 limit:(unsigned long long)a2 shouldOrderAscending:(char)a3 completion:(id /* block */)a4;
- (id)initWithContext:(id)a0 clipManager:(id)a1 reachabilityEventManager:(id)a2;
- (id)mergedRecordingEventsWithRecordingEvents1:(id)a0 recordingEvents2:(id)a1 limit:(unsigned long long)a2 shouldOrderAscending:(char)a3;
