...
@property char rampFeatureEnabledOnServer;
...
+ (id)shortDescription;
+ (id)softwareUpdateFromDescriptor:(id)a0;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithStatus:(long long)a0 error:(id)a1 documentationMetadata:(id)a2 version:(id)a3 downloadSize:(unsigned long long)a4 humanReadableUpdateName:(id)a5 rampFeatureEnabledOnServer:(char)a6;
