...
+ (id)shortDescription;
+ (char)doDaysOfTheWeek:(unsigned long long)a0 containWeekday:(id)a1;
+ (char)isDate:(id)a0 inTimeZone:(id)a1 withinAllowedWeekDayScheduleRules:(id)a2;
+ (char)isDate:(id)a0 withinAllowedTimeForSchedule:(id)a1 forHomeInTimeZone:(id)a2;
+ (char)isDate:(id)a0 withinAllowedYearDayScheduleRules:(id)a1;
