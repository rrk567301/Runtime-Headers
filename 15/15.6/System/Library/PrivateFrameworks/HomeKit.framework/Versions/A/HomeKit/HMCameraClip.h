...
@property (readonly, getter=isDonated) char donated;
...
- (id)initWithUniqueIdentifier:(id)a0 startDate:(id)a1 duration:(double)a2 targetFragmentDuration:(double)a3 isComplete:(char)a4 isDonated:(char)a5 quality:(long long)a6 streamingAssetVersion:(id)a7 encryptionContext:(id)a8 videoSegments:(id)a9 significantEvents:(id)a10;
