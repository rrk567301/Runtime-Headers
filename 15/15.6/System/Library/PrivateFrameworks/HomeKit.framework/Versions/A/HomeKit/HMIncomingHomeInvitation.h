...
@property (readonly, nonatomic) char homeHasCameras;
@property (readonly, nonatomic, getter=isInviteeRestrictedGuest) char inviteeRestrictedGuest;
...
- (char)isForPKSharingMessageInvitationWithAppleSharingDict:(id)a0;
