...
- (void)callCompletion:(id /* block */)a0 error:(id)a1 boolValue:(char)a2 array:(id)a3;
...
- (void)callCompletion:(id /* block */)a0 eventTrigger:(id)a1 error:(id)a2;
- (void)callCompletion:(id /* block */)a0 home:(id)a1 error:(id)a2;
- (void)callCompletion:(id /* block */)a0 invitations:(id)a1 error:(id)a2;
- (void)callCompletion:(id /* block */)a0 isUsingHomeKit:(char)a1 isUsingCloudServices:(char)a2 error:(id)a3;
...
- (void)callCompletion:(id /* block */)a0 timerTrigger:(id)a1 error:(id)a2;
- (void)callCompletion:(id /* block */)a0 user:(id)a1 error:(id)a2;
- (void)callCompletion:(id /* block */)a0 value:(char)a1 conflictName:(id)a2 error:(id)a3;
- (void)callCompletion:(id /* block */)a0 value:(char)a1 error:(id)a2;
