@class NSUUID, NSString, NSDate, HMAccessory, HMSoftwareUpdateDocumentationMetadata, HMSoftwareUpdateDocumentation, _HMContext, NSObject, HMFSoftwareVersion;
...
@property (readonly, getter=isDocumentationAvailable) char documentationAvailable;
