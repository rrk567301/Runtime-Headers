...
- (void)fetchClipsWithDateInterval:(id)a0 limit:(unsigned long long)a1 shouldOrderAscending:(char)a2 completion:(id /* block */)a3;
- (void)fetchClipsWithDateInterval:(id)a0 quality:(long long)a1 limit:(unsigned long long)a2 shouldOrderAscending:(char)a3 completion:(id /* block */)a4;
...
- (void)fetchSignificantEventsWithDateInterval:(id)a0 limit:(unsigned long long)a1 shouldOrderAscending:(char)a2 completion:(id /* block */)a3;
...
- (void)setCloudStorageEnabled:(char)a0 completion:(id /* block */)a1;
