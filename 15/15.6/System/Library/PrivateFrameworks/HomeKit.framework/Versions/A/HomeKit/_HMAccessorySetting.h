...
@property (readonly, getter=isReflected) char reflected;
...
- (void)configureWithAccessorySettings:(id)a0 context:(id)a1 shouldHandleUpdatedValue:(char)a2;
