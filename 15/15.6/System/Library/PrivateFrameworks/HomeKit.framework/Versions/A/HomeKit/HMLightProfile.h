...
- (void)setNaturalLightingEnabled:(char)a0 completionHandler:(id /* block */)a1;
- (void)setNaturalLightingEnabled:(char)a0 shouldRetryOnFailure:(char)a1 completion:(id /* block */)a2;
