...
@property (readonly, nonatomic, getter=isCompatible) char compatible;
...
- (char)_mergeApplicationDataWithNewMediaSystem:(id)a0;
- (char)_mergeComponentsWithNewMediaSystem:(id)a0;
- (char)_mergeLegacySettingsWithNewMediaSystem:(id)a0;
- (char)_mergeNameWithNewMediaSystem:(id)a0;
- (char)_mergeSettingsWithNewMediaSystem:(id)a0;
- (char)_mergeWithNewMediaSystem:(id)a0 isFromSerializedData:(char)a1;
...
- (char)configureSettingsAdaptorIfNeeded;
- (id)initWithHome:(id)a0 uuid:(id)a1 name:(id)a2 configuredName:(id)a3 compatible:(char)a4 components:(id)a5 settings:(id)a6;
- (char)mergeAudioDestinationWithNewMediaSystem:(id)a0;
- (char)mergeFromNewObject:(id)a0;
- (char)mergeFromNewObject:(id)a0 isFromSerializedData:(char)a1;
- (char)mergeSupportsMessagedHomepodSettingsWithNewMediaSystem:(id)a0;
