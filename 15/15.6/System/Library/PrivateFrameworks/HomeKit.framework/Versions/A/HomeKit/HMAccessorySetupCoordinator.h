...
+ (char)isCHIPSetupPayloadURL:(id)a0;
+ (char)isHAPSetupPayloadURL:(id)a0;
+ (char)isSetupPayloadURL:(id)a0;
+ (char)isSetupPayloadURLString:(id)a0;
...
- (void)stageCHIPAccessoryPairingInStepsWithPayload:(id)a0 delegate:(id)a1 scanningNetworks:(char)a2 completionHandler:(id /* block */)a3;
