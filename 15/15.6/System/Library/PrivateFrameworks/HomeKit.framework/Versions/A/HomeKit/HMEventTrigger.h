...
@property (readonly, nonatomic) char executeOnce;
...
+ (char)isActionAffectedByEndEvents:(id)a0;
...
- (void)_removeEventsForAccessory:(id)a0;
- (id)_serializeForAdd;
- (void)_updateCharacteristicReference;
- (char)_updateCharacteristicReferenceInNewEvent:(id)a0;
- (void)_updateEvents:(id)a0 endEvent:(char)a1 completionHandler:(id /* block */)a2;
- (void)_updateEventsFromResponse:(id)a0 responsePayload:(id)a1;
- (void)_updateExecuteOnce:(char)a0 completionHandler:(id /* block */)a1;
...
- (char)containsSharedTriggerActivationBits;
- (id)copyAsBuilder;
...
- (void)updateExecuteOnce:(char)a0 completionHandler:(id /* block */)a1;
