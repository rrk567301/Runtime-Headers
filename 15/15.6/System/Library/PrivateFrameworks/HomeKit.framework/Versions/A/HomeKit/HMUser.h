...
@property (readonly) char settingsInitialized;
...
- (void)_handleRGAllowedPeriodEnded:(id)a0;
- (void)_handleRGAllowedPeriodStarted:(id)a0;
- (void)_handleSharedUserProfileMetadataUpdated;
- (void)_handleSharedUserProfileMetadataUpdatedMessage:(id)a0;
...
- (void)fetchProfilePhoto:(id /* block */)a0;
- (void)fetchProfilePhotoAndCropRect:(id /* block */)a0;
...
- (char)mergePendingAccessoryInvitationsWithOutgoingInvitation:(id)a0;
...
- (void)setNeedsiTunesMultiUserRepair:(char)a0 completion:(id /* block */)a1;
...
- (void)updateHomeAccessControl:(char)a0 remoteAccess:(char)a1 announceAccess:(char)a2 camerasAccess:(id)a3;
