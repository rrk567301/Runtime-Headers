...
+ (char)isBuiltinActionSetType:(id)a0;
...
- (char)_doRemoveActionWithUUID:(id)a0 completionHandler:(id /* block */)a1;
- (char)_handleActionRemovedFromPayload:(id)a0 completion:(id /* block */)a1;
- (void)_handleActionSetExecutedNotification:(id)a0;
- (char)_handleActionSetRenameFromPayload:(id)a0 completion:(id /* block */)a1;
- (void)_handleActionSetStartExecutionNotification:(id)a0;
- (char)_handleActionUpdatedFromResponse:(id)a0 completion:(id /* block */)a1;
- (void)_recomputeAssistantIdentifier;
- (void)_registerNotificationHandlers;
- (void)_removeAction:(id)a0 completionHandler:(id /* block */)a1;
- (void)_removeActionsForAccessory:(id)a0;
- (void)_unconfigure;
...
- (id)copyAsBuilder;
- (void)didUpdateIsExecuting:(char)a0;
- (id)encodeAsProtoBuf;
