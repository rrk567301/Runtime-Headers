@class HMFActivity, NSUUID, _HMContext, NSDictionary, NSString, NSMutableArray, NSObject;
...
- (char)_moveToState:(long long)a0;
- (char)_needsClosing;
- (void)cleanUpSession;
...
- (id)initWithRole:(long long)a0 context:(id)a1 identifier:(id)a2 delegate:(id)a3;
- (id)initWithRole:(long long)a0 identifier:(id)a1 delegate:(id)a2;
