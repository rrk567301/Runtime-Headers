...
@property char didReceiveFirstUpdateEvent;
@property char settingsReflected;
...
+ (id)defaultSettings;
+ (id)logCategory;
+ (char)defaultSettingsContainsKeyPath:(id)a0;
+ (char)isKeyPathForBooleanSettingType:(id)a0;
+ (id)availableLanguagesKeyPath;
+ (id)defaultSettingsAllKeyPaths;
+ (id)defaultSettingsConstraintsForKeyPath:(id)a0;
+ (char)isKeyPathForConstrainedNumberSettingType:(id)a0;
+ (char)isKeyPathForTapAssistanceSelectionSettingType:(id)a0;
...
- (char)booleanSettingValueWithKeyPath:(id)a0;
- (id)languageSelectionItemFromValue:(id)a0;
- (char)_addOrUpdateLanguageSetting:(id)a0 availableLanguagesSetting:(id)a1;
...
- (char)_handleLanguageSettingUpdate:(id)a0;
...
- (char)isValidSelectionItemNumberConstraintValue:(id)a0 min:(id)a1 max:(id)a2 step:(id)a3;
- (id)legacyLanguageSettingFromSelectedSetting:(id)a0 selections:(id)a1 settingsReflected:(char)a2;
- (id)numberSettingValueWithKeyPath:(id)a0;
- (id)settingKeyFromKeyPath:(id)a0;
- (char)settingReflected:(id)a0;
...
- (char)transformSelectionToInteger:(id)a0 integerValue:(long long *)a1;
- (void)unconfigure;
- (char)updateBooleanSettingWithKeyPath:(id)a0 value:(char)a1;
- (char)updateNumberSettingWithKeyPath:(id)a0 value:(id)a1;
- (void)updateSettingsReflected:(char)a0;
- (char)updateTapAssistanceSelectionSettingWithKeyPath:(id)a0 value:(id)a1;
