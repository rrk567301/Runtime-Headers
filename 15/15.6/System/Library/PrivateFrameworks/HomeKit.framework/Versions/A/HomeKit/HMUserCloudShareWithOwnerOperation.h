...
@property (readonly, nonatomic) char allowWriteAccess;
...
- (void)main;
- (id)logIdentifier;
- (id)initWithShare:(id)a0 container:(id)a1 ownerUser:(id)a2 allowWriteAccess:(char)a3 currentUser:(id)a4;
...
- (id)initWithShare:(id)a0 container:(id)a1 ownerUser:(id)a2 allowWriteAccess:(char)a3 currentUser:(id)a4 analyticsEventSender:(id /* block */)a5;
