...
- (id).cxx_construct;
- (id)evaluate:(id)a0;
- (char)fit:(id)a0 numberOfBatches:(unsigned int)a1 outputNames:(id)a2 batchCallback:(id /* block */)a3;
- (float)fit:(id)a0 numberOfBatches:(unsigned int)a1 withProgress:(id /* block */)a2;
- (char)fit:(id)a0 numberOfEpochs:(int)a1 outputNames:(id)a2 batchCallback:(id /* block */)a3;
...
- (id)initWithModelDef:(id)a0 optimizerDef:(id)a1 extractor:(id)a2 needWeightsInitialization:(char)a3;
...
- (char)moveToGPU:(int)a0 error:(id *)a1;
...
- (char)runBatches:(id)a0 numberOfBatches:(unsigned int)a1 outputNames:(id)a2 batchCallback:(id /* block */)a3;
- (char)runInference:(id)a0 outputNames:(id)a1 batchCallback:(id /* block */)a2;
