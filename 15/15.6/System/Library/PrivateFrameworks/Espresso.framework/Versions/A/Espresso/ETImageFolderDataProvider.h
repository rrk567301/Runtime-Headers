...
- (id)initWithFolder:(id)a0 forImageTensor:(id)a1 andLabelTensor:(id)a2 shuffleBeforeEachEpoch:(char)a3 shuffleRandomSeed:(id)a4 withImagePreprocessParams:(id)a5;
