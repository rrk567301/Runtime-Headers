...
@property (nonatomic) char useGPUScaler;
...
- (void)autoResizeForAspectRatio:(float)a0 useLowPriorityMode:(char)a1 gpuPriority:(unsigned int)a2;
- (void)autoSetupNetBaseName:(id)a0 weights:(id)a1 scaleConfig:(int)a2 setupMode:(int)a3 computePath:(int)a4 autoAspectRatio:(float)a5 forceReset:(char)a6 useLowPriorityMode:(char)a7 gpuPriority:(unsigned int)a8;
...
- (void)processBlobNoRotation:(const void *)a0 tex:(id)a1 doBGRA2RGBA:(char)a2;
...
- (void)processVimageNoRotation:(const struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 tex:(id)a1 doBGRA2RGBA:(char)a2;
- (int)resizerCount;
