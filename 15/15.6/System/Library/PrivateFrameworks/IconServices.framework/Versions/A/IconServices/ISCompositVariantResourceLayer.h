...
- (void).cxx_destruct;
- (char)isActiveAtSize:(long long)a0;
- (char)applyToContext:(struct CGContext { } *)a0 size:(unsigned long long)a1 scale:(unsigned long long)a2;
- (char)drawResource:(id)a0 context:(struct CGContext { } *)a1 size:(unsigned long long)a2 scale:(unsigned long long)a3;
...
- (char)maskWithResource:(id)a0 context:(struct CGContext { } *)a1 size:(unsigned long long)a2 scale:(unsigned long long)a3;
