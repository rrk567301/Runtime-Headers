...
- (void).cxx_destruct;
- (char)addResourceWithResourceURL:(id)a0 namePrefix:(id)a1 error:(id *)a2;
- (char)addResourceWithURL:(id)a0 error:(id *)a1;
- (char)drawInContext:(struct CGContext { } *)a0 withScale:(unsigned long long)a1 error:(id *)a2;
