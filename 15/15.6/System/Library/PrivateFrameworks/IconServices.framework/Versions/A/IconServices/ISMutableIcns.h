...
+ (int)_iconIndexSmallerThanSize:(struct CGSize { double x0; double x1; })a0 scale:(unsigned int)a1 template:(char)a2;
+ (struct CGImage { } *)_scaledCGImage:(struct CGImage { } *)a0 forICSNSizeAtScale:(unsigned int)a1 template:(char)a2 scaleToFit:(char)a3;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)initWithData:(id)a0;
- (id)initWithType:(unsigned int)a0;
- (char)addCGImage:(struct CGImage { } *)a0 scale:(unsigned int)a1 error:(id *)a2;
- (void)setVariant:(id)a0 named:(id)a1;
- (id)_initWithType:(unsigned int)a0 scaleToFit:(char)a1 imageProviderBlock:(id /* block */)a2;
- (char)addImageData:(id)a0 iconIndex:(int)a1;
