...
@property (nonatomic) char enableColorEnhancementInDarkImage;
@property (nonatomic) char enableRecoloringSingleForegroundColorWithGradientBackgroundInDarkImage;
