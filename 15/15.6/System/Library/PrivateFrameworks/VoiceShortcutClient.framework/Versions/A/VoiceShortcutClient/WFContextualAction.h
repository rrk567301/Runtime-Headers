...
@property (readonly, nonatomic) char definesDisplayOrder;
...
@property (readonly, nonatomic) char availableFromLockedContext;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy, nonatomic) NSString *actionIdentifier;
@property (readonly, nonatomic) char actionShowsUserInterface;
...
@property (readonly, nonatomic) char showsUserInterfaceWhenRunning;
@property (readonly, nonatomic) char outputsFiles;
@property (readonly, nonatomic, getter=isReversible) char reversible;
...
@property (readonly, nonatomic, getter=isAlternate) char alternate;
...
- (id)initWithIdentifier:(id)a0 wfActionIdentifier:(id)a1 associatedAppBundleIdentifier:(id)a2 parameters:(id)a3 displayString:(id)a4 title:(id)a5 subtitle:(id)a6 icon:(id)a7 accessoryIcon:(id)a8 actionShowsUserInterface:(char)a9 actionHasResult:(char)a10 isReversible:(char)a11;
- (id)initWithIdentifier:(id)a0 wfActionIdentifier:(id)a1 type:(unsigned long long)a2 correspondingSystemActionType:(unsigned long long)a3 associatedAppBundleIdentifier:(id)a4 resultFileOperation:(long long)a5 alternate:(char)a6 filteringBehavior:(id)a7 parameters:(id)a8 displayString:(id)a9 title:(id)a10 subtitle:(id)a11 icon:(id)a12;
- (id)initWithIdentifier:(id)a0 wfActionIdentifier:(id)a1 type:(unsigned long long)a2 correspondingSystemActionType:(unsigned long long)a3 associatedAppBundleIdentifier:(id)a4 resultFileOperation:(long long)a5 alternate:(char)a6 filteringBehavior:(id)a7 parameters:(id)a8 displayString:(id)a9 title:(id)a10 subtitle:(id)a11 icon:(id)a12 accessoryIcon:(id)a13 actionShowsUserInterface:(char)a14 isReversible:(char)a15;
