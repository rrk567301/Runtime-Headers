...
+ (long long)linkMeasurementUnitTypeFromWorkflowUnitType:(id)a0;
+ (id)linkValueTypeFromWorkflowUnitType:(id)a0;
+ (id)localizedStringForUnitType:(id)a0;
+ (Class)unitClassForUnitType:(id)a0;
+ (id)unitFromString:(id)a0 unitType:(id)a1 caseSensitive:(char)a2;
+ (id)unitTypeForUnitClass:(Class)a0;
+ (id)unitTypeFromIntentSlotValueType:(long long)a0;
+ (id)unitTypeFromLinkMeasurementUnitType:(long long)a0;
+ (id)unitTypeMap;
+ (char)usesMetricSystemForUnitType:(id)a0;
