...
@property (readonly, nonatomic) char allowsAnimated;
@property (readonly, nonatomic) char hasValidImage;
...
+ (id)glyphNamed:(id)a0 pointSize:(double)a1 symbolSize:(unsigned long long)a2 scaleFactor:(double)a3 rightToLeft:(char)a4 appearanceName:(id)a5;
+ (id)glyphNamed:(id)a0 pointSize:(double)a1 symbolSize:(unsigned long long)a2 symbolWeight:(long long)a3 scaleFactor:(double)a4 rightToLeft:(char)a5 appearanceName:(id)a6 inCatalogs:(id)a7;
...
+ (id)imageWithData:(id)a0 scale:(double)a1 allowAnimated:(char)a2;
...
- (id)initWithData:(id)a0 scale:(double)a1 allowAnimated:(char)a2;
