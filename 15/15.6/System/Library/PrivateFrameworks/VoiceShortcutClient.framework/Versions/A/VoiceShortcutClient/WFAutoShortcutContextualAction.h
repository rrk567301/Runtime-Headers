...
@property (readonly, nonatomic) char isTopHitEligible;
@property (readonly, nonatomic) NSArray *searchKeywords;
@property (readonly, nonatomic, getter=isEligibleForProminentDisplay) char eligibleForProminentDisplay;
...
- (id)workflowRunKind;
- (id)actionBySettingEligibilityForProminentDisplay:(char)a0;
- (id)actionForRunningFromSpotlight;
- (char)availableFromLockedContext;
- (char)definesDisplayOrder;
