...
- (void)requestSandboxExtensionForToolKitIndexingWithCompletionHandler:(id /* block */)a0;
...
- (char)requestSandboxExtensionForRunningActionWithAccessResources:(id)a0 error:(id *)a1;
- (void)resignIssuedExtensionsWithReason:(id)a0;
- (char)retakeResignedExtensionsWithReason:(id)a0 error:(id *)a1;
