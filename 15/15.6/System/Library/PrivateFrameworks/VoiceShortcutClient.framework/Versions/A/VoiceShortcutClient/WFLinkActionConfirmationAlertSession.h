...
@property (readonly, nonatomic) char shouldShowPrompt;
...
- (id)initWithAppBundleIdentifier:(id)a0 actionMetadata:(id)a1 shouldShowPrompt:(char)a2 dialog:(id)a3 dialogString:(id)a4 viewSnippet:(id)a5 confirmationActionName:(id)a6;
