@class NSObject, NSArray, NSMutableArray, WFDispatchSourceTimer;
...
@property (nonatomic) char blocksTransitionsOnInvalidation;
@property (nonatomic) char silentlyDropInvalidTransitions;

- (id)init;
- (void).cxx_destruct;
- (void)invalidate;
- (void)lock_addTransitionEventToHistoryWithState:(id)a0 reason:(id)a1 valid:(char)a2;
- (void)lock_cancelPendingTimers;
- (char)lock_prepareForInvalidation;
- (id)lock_printedStateHistory;
- (char)transitionToState:(id)a0 withReason:(id)a1;
