...
@property (readonly, nonatomic) char hasSystemAperture;
@property (readonly, nonatomic) char hasPairedAndSetUpWatch;
@property (readonly, nonatomic) char isChineseRegionDevice;
@property (readonly, copy, nonatomic) NSString *wfName;

+ (char)deviceIsChinaSKU;
+ (char)deviceIsGreenTea;
...
- (char)idiomSupportsPosters:(long long)a0;
