...
@property (nonatomic) char isAutomation;
...
- (void)reset;
- (void)stop;
- (char)resumeRunningWithRequest:(id)a0 error:(out id *)a1;
...
- (char)runActionWithRunRequestData:(id)a0 error:(out id *)a1;
- (void)runToolWithInvocation:(id)a0;
- (char)runWorkflowWithDescriptor:(id)a0 request:(id)a1 error:(out id *)a2;
- (oneway void)runnerDidPunchToShortcutsJr;
- (oneway void)runnerWillExit;
- (id)runnerWithError:(out id *)a0 synchronous:(char)a1 reason:(id)a2;
