...
- (void)loadFileURLWithItemProviderRequestMetadata:(id)a0 type:(id)a1 openInPlace:(char)a2 completion:(id /* block */)a3;
...
- (id)asynchronousRemoteDataStoreWithErrorHandler:(id /* block */)a0 synchronous:(char)a1;
...
- (id)drawIconsForServicesWorkflows:(id)a0 atSize:(struct CGSize { double x0; double x1; })a1 drawBackground:(char)a2 error:(id *)a3;
...
- (void)fireTriggerWithIdentifier:(id)a0 force:(char)a1 completion:(id /* block */)a2;
...
- (id)getIconForServicesWorkflow:(id)a0 atSize:(struct CGSize { double x0; double x1; })a1 drawBackground:(char)a2 useCache:(char)a3 error:(id *)a4;
...
- (char)requestDataMigration:(id *)a0;
- (char)resetAutomationConfirmationStatusWithError:(id *)a0;
...
- (void)setSpotlightAutoShortcutsEnablement:(char)a0 forBundleIdentifier:(id)a1 completion:(id /* block */)a2;
- (void)setSpotlightAutoShortcutsEnablement:(char)a0 forBundleIdentifier:(id)a1 phraseSignature:(id)a2 completion:(id /* block */)a3;
...
- (char)userHasAutomationsWithError:(id *)a0;
