...
@property (readonly, nonatomic) char hasPaletteGradient;
...
- (char)getRed:(double *)a0 green:(double *)a1 blue:(double *)a2 alpha:(double *)a3;
...
- (char)isCloseToColor:(id)a0;
- (void)getHue:(double *)a0 saturation:(double *)a1 value:(double *)a2 alpha:(double *)a3;
- (id)paletteGradientFallingBackToDefaultGradient:(char)a0;
