...
- (char)_updateSelectedIndexForDSID:(id)a0 isManaged:(char)a1;
- (void)notifyServerOfScreenTimeEnabled:(char)a0 forUser:(id)a1;
- (char)updateSelectedIndexForChildDSID:(id)a0;
- (char)updateSelectedIndexForDSID:(id)a0;
