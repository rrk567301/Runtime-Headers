...
@property (readonly) char canRecoveryAuthenticate;

+ (void)sendPasscodeActivityToParentsWithCompletionHandler:(id /* block */)a0;

- (void).cxx_destruct;
- (id)initWithUser:(id)a0;
- (char)_authenticateWithPIN:(id)a0 forUser:(id)a1 allowPasscodeRecovery:(char)a2 error:(id *)a3;
- (void)_beginTimeoutUntilDate:(id)a0;
- (char)_isPINValid:(id)a0;
- (char)_saveChangesForUser:(id)a0 error:(id *)a1;
- (void)_setNewPIN:(id)a0 currentPIN:(id)a1 recoveryAppleIDPrompt:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (char)_setPasscode:(id)a0 recoveryAppleID:(id)a1 forUser:(id)a2 error:(id *)a3;
- (id)_timeoutEndDateForAttemptNumber:(long long)a0;
- (void)authenticateWithPIN:(id)a0 allowPasscodeRecovery:(char)a1 completionHandler:(id /* block */)a2;
- (void)authenticateWithPIN:(id)a0 completionHandler:(id /* block */)a1;
- (char)authenticateWithPIN:(id)a0 error:(id *)a1;
