...
@property (nonatomic) char invertUsageLimit;
@property (copy, nonatomic) NSString *identifier;
@property (copy, nonatomic) NSDate *creationDate;
@property (copy, nonatomic) NSDate *modificationDate;
@property (copy, nonatomic) NSString *type;
@property (nonatomic) char enabled;
@property (nonatomic) char limitEnabled;
...
+ (char)deleteUsageLimitWithIdentifier:(id)a0 user:(id)a1 managedObjectContext:(id)a2 error:(id *)a3;
...
+ (id)_cemPredicateWithDowntimeOverride:(id)a0 shouldUseGracePeriod:(char)a1 dateFormater:(id)a2 calendar:(id)a3;
...
+ (char)_isStateChangeValid:(long long)a0 forState:(long long)a1;
...
+ (char)_updateConfiguration:(id)a0 withDeclaration:(id)a1 context:(id)a2 error:(id *)a3;
+ (id)_updatedDowntimeForUser:(id)a0 startTime:(id)a1 endTime:(id)a2 scheduleByWeekdayIndex:(id)a3 enabled:(char)a4 behaviorType:(unsigned long long)a5 error:(id *)a6;
...
+ (id)blueprintTypeForDeclarationType:(id)a0;
...
+ (char)deleteManagedUserBlueprintForUser:(id)a0 error:(id *)a1;
+ (char)disableManagedUserBlueprintForUser:(id)a0 error:(id *)a1;
+ (char)disableRestrictionsBlueprintForUser:(id)a0 error:(id *)a1;
...
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 fromOrganization:(id)a1 includeTombstones:(char)a2;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 ofType:(id)a1 fromOrganization:(id)a2 includeTombstones:(char)a3;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 ofType:(id)a1 withIdentifier:(id)a2 fromOrganization:(id)a3 includeTombstones:(char)a4;
...
+ (char)removeFixedDurationOnDemandDowntimeForUserID:(id)a0 context:(id)a1 error:(id *)a2;
+ (char)saveAlwaysAllowListForUser:(id)a0 withBundleIDs:(id)a1 error:(id *)a2;
+ (char)saveAlwaysAllowListForUser:(id)a0 withBundleIDs:(id)a1 overwriteExistingList:(char)a2 error:(id *)a3;
+ (char)saveDefaultAlwaysAllowListIfNecessaryForUser:(id)a0 error:(id *)a1;
+ (char)saveDowntimeForUser:(id)a0 startTime:(id)a1 endTime:(id)a2 scheduleByWeekdayIndex:(id)a3 enabled:(char)a4 behaviorType:(unsigned long long)a5 error:(id *)a6;
+ (char)saveManagedUserBlueprintForUser:(id)a0 error:(id *)a1;
+ (char)saveRestrictionsBlueprintWithValuesForPresetRestrictions:(id)a0 forUser:(id)a1 error:(id *)a2;
+ (char)saveUsageLimitWithIdentifier:(id)a0 user:(id)a1 bundleIdentifiers:(id)a2 webDomains:(id)a3 categoryIdentifiers:(id)a4 dailyBudgetLimit:(double)a5 budgetLimitByWeekday:(id)a6 enabled:(char)a7 behaviorType:(unsigned long long)a8 error:(id *)a9;
+ (id)scheduleTextWithLocale:(id)a0 weekdayScheduleComparator:(id /* block */)a1 scheduleTimeGetter:(id /* block */)a2;
+ (char)shouldUseGracePeriodForDowntimeOverride:(id)a0 configuration:(id)a1;
...
- (void)_limitedApplicationsDidChange:(id)a0;
- (void)_reportCoreAnalyticsEventForDowntimeOverride:(id)a0 currentDate:(id)a1;
- (void)_updateActiveOverrideAfterScheduleChange;
- (char)_validateBlueprintConfiguration:(id)a0;
- (char)_validateBlueprintIdentifier:(id)a0;
- (char)_validateNumberOfBlueprints:(id)a0;
- (char)_validateType:(id)a0;
- (char)_validateUsersOnBlueprint:(id)a0;
...
- (char)removeFixedDurationOnDemandDowntimeWithError:(id *)a0;
