...
- (char)_computeStartBoundaries:(id *)a0 endBoundaries:(id *)a1 forCreationDate:(id)a2 calendar:(id)a3;
- (char)_computeNextStartDate:(id *)a0 nextEndDate:(id *)a1 afterDate:(id)a2 forDay:(long long)a3 usingCalendar:(id)a4;
- (void)_datePairForDay:(long long)a0 startDate:(id *)a1 endDate:(id *)a2;
- (char)_validateBlueprint:(id)a0;
- (id)computeNextOverrideEndDateForState:(long long)a0 creationDate:(id)a1 inCalendar:(id)a2;
- (id)computeNextScheduleBoundaryAfterDate:(id)a0 inCalendar:(id)a1 isStartDate:(char *)a2;
- (char)isActiveAtDate:(id)a0 inCalendar:(id)a1;
