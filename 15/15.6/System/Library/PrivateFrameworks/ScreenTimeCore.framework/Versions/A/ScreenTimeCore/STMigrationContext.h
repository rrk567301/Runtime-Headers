...
- (char)deleteLocalObjectWithUniqueIdentifier:(id)a0 managedObjectContext:(id)a1 error:(id *)a2;
- (char)initializeCachesWithManagedObjectContext:(id)a0 withCloudStore:(id)a1 andLocalStore:(id)a2 error:(id *)a3;
