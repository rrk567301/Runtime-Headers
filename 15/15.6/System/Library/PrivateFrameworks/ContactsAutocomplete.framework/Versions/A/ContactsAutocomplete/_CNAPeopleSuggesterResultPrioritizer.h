...
- (id)partitionCandidatesForRanking:(id)a0 givenPrefixes:(id)a1;
- (char)resultIdentifierIsValidMessagesChatGuid:(id)a0;
- (char)resultMatchesPrefix:(id)a0 inNameComponentsOfResult:(id)a1;
