...
- (id)MAIDResultWithDisplayName:(id)a0 value:(id)a1 nameComponents:(id)a2 userInfo:(id)a3;
...
- (id)frequentRecentResultWithDisplayName:(id)a0 value:(id)a1 lastSendingAddress:(id)a2 date:(id)a3 group:(char)a4 completesChosenGroup:(char)a5;
- (id)infrequentRecentResultWithDisplayName:(id)a0 value:(id)a1 lastSendingAddress:(id)a2 dateCount:(unsigned long long)a3 date:(id)a4 group:(char)a5 completesChosenGroup:(char)a6;
...
- (id)recentResultWithDisplayName:(id)a0 value:(id)a1 lastSendingAddress:(id)a2 dateCount:(unsigned long long)a3 date:(id)a4 group:(char)a5 completesChosenGroup:(char)a6;
