...
@property char hasPreferredDomain;
...
+ (char)isSourceTypeConsideredSuggestion:(unsigned long long)a0;
...
- (char)shouldUseGroupNamingForResult;
- (char)shouldUseGroupNamingForSource;
