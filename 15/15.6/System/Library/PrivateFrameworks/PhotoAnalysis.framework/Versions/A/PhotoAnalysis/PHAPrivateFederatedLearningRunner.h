...
+ (id)_firstAttachmentURLWithSuffixOfName:(id)a0 attachments:(id)a1 expectedDirectory:(char)a2 error:(id *)a3;
...
- (char)_isValidInputDimensionForCoreMLModel:(id)a0 error:(id *)a1;
