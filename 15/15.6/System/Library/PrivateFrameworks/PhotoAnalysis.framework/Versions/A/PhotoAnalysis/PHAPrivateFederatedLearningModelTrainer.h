...
- (char)_trueLabelTensor:(id)a0 isEqualToPredictionTensor:(id)a1;
...
- (id)trainForNumberOfEpochs:(unsigned long long)a0 layersToTrain:(id)a1 verbose:(char)a2 error:(id *)a3;
