...
- (void).cxx_destruct;
- (int)accuracyForProbability:(struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a0 isPositiveData:(char)a1 atIndex:(int)a2 andOperatingPoint:(float)a3;
- (id)evaluateModelAtPath:(id)a0 labelIndex:(int)a1 labelOperatingPoint:(float)a2 isPositiveData:(char)a3 evaluationData:(id)a4 error:(id *)a5;
...
- (id)getDefaultEvaluationResultForModelPath:(id)a0 isPositiveData:(char)a1;
