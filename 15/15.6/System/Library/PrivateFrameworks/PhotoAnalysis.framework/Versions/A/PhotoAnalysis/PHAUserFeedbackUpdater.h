...
- (char)_deleteWallpaperTopSuggestionsOfPersonsForLocalIdentifiers:(id)a0;
- (char)_demoteFeaturedMemories;
...
- (char)_neverFeatureMemories:(id)a0 error:(id *)a1;
...
- (void)_reloadWallpaperSuggestionsWithRejectedPersonsForLocalIdentifiers:(id)a0 forceReload:(char)a1;
- (char)_retireAndUnfeatureSuggestions:(id)a0 didUnfeatureSuggestions:(char *)a1;
- (id)_suggestionsToRetire;
- (char)_unfeaturePersonMagicSlotSuggestionWithNegativeFeedbackPersonUUIDs:(id)a0;
- (char)_unfeatureSocialGroupMagicSlotSuggestionWithNegativeFeedbackPersonUUIDs:(id)a0;
...
- (char)updateFeatureContentWithPersonUUIDs:(id)a0 error:(id *)a1;
