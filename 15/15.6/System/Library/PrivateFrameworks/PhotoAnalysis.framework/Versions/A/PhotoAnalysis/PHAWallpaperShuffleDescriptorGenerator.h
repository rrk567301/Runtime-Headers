...
- (id)shufflePosterDescriptorForShuffleSubtype:(unsigned short)a0 personLocalIdentifiers:(id)a1 suggestionUUIDsToAvoid:(id)a2 requireMinimumShuffleCount:(char)a3;
