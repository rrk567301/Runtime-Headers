...
- (void).cxx_destruct;
- (char)_isFingerprintVersionSupported:(long long)a0;
...
- (id)_layerConfigForName:(id)a0 modelConfig:(id)a1 attributeName:(id)a2 useEquality:(char)a3 error:(id *)a4;
- (id)_sizeForLayerName:(id)a0 modelShape:(id)a1 error:(id *)a2;
- (id)initWithEspressoModelURL:(id)a0 espressoModelShapeURL:(id)a1;
- (char)isValidWithFingerprintVersionName:(id)a0 modelInputName:(id)a1 modelOutputName:(id)a2 labelName:(id)a3 labelPolicyName:(id)a4 lossName:(id)a5 layersToTrain:(id)a6 error:(id *)a7;
