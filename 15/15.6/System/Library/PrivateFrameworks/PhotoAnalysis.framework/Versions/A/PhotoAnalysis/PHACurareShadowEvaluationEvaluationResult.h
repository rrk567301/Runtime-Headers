...
- (void).cxx_destruct;
- (id)initWithModelPath:(id)a0 isPositiveData:(char)a1 numberOfTotalSamples:(id)a2 numberOfCorrectSamples:(id)a3 meanPredictionValue:(id)a4 stddevPredictionValue:(id)a5;
