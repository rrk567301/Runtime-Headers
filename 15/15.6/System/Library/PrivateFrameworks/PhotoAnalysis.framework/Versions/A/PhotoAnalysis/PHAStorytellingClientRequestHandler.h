...
+ (char)_isMeaningInferenceFromEventLabelingModel:(id)a0 meaningEdgeDomain:(unsigned short)a1 configuration:(id)a2;
...
- (void)requestConfidenceByMomentLocalIdentifierForMeaning:(id)a0 useAlternativeMeaningEdge:(char)a1 onlyHighPrecision:(char)a2 context:(id)a3 reply:(id /* block */)a4;
...
- (char)validateSelector:(SEL)a0 forConnection:(id)a1;
- (id)_assetCollectionForRelatedIdentifier:(id)a0;
- (id)_asssetLocalIdentifiersByCityNameForKeyAssetOnly:(char)a0;
...
- (id)_utilityAssetLocalIdentifiersForKeyAssetOnly:(char)a0;
