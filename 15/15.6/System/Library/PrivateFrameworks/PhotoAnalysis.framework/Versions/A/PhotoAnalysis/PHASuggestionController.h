@class NSMutableArray, NSArray, NSMutableSet, PHPhotoLibrary, PGManager, NSObject;
@protocol OS_os_log;
...
- (char)existingSuggestion:(id)a0 matchesSuggestion:(id)a1;
- (id)existingSuggestionByKeyAssetUUIDWithType:(unsigned short)a0 subtypes:(id)a1;
- (id)generateAmbientSuggestionsWithOptions:(id)a0 progress:(id /* block */)a1;
- (id)generateCameraStyleableSuggestionsWithOptions:(id)a0 progress:(id /* block */)a1;
...
- (void)processSuggestions:(id)a0 forRecyclingWithExistingSuggestionByKeyAssetUUID:(id)a1 resultBlock:(id /* block */)a2;
...
- (char)shouldDeleteSuggestion:(id)a0 atDate:(id)a1;
- (char)shouldRetireSuggestion:(id)a0 atDate:(id)a1;
