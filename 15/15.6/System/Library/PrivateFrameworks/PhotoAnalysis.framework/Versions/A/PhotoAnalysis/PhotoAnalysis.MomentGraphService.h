...
- (void)generateMagicSlotSuggestionsWithOptions:(NSDictionary *)a0 reply:(void (^)(char, NSError *))a1;
...
- (void)requestSearchableAssetUUIDsBySocialGroupForAssetCollectionUUIDs:(NSArray *)a0 ofType:(unsigned long long)a1 isFullAnalysis:(char)a2 operationID:(NSString *)a3 reply:(void (^)(NSDictionary *, NSError *))a4;
