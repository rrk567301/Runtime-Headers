...
- (char)enumerateBuiltInSystemContentWithBlock:(id /* block */)a0 error:(id *)a1;
- (char)enumerateCryptexContentWithBlock:(id /* block */)a0 error:(id *)a1;
- (void)triggerRegistrationForContainerizedContentWithOptions:(id)a0 completion:(id /* block */)a1;
- (char)triggerRegistrationForContainerizedContentWithOptions:(id)a0 withError:(id *)a1;
