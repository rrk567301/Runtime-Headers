...
@property (readonly, nonatomic) char allowDeletableSystemApps;
...
@property (readonly, nonatomic) char allowsInternalSecurityPolicy;
@property (readonly, nonatomic) char hasInternalContent;
@property (readonly, nonatomic) NSString *primaryPersonaString;
@property (readonly, nonatomic) char isSharediPad;
@property (readonly, nonatomic) char hasEAPFSVolumeSplit;
