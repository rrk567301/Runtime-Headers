...
- (char)_errorImpliesCloudRelay:(id)a0;
...
- (char)_isVoiceShortcutsRemoteExecutionUnavailable:(id)a0;
- (void)_logEventWithType:(long long)a0 context:(id)a1 contextNoCopy:(char)a2;
- (void)_logPrewarmDidEndWithCommand:(id)a0 applicationIdentifier:(id)a1 wasPrewarmed:(char)a2 completionHandler:(id /* block */)a3;
- (char)_prewarmExtensionWithIntent:(id)a0 applicationIdentifier:(id)a1 command:(id)a2 completionHandler:(id /* block */)a3;
- (void)_requiresHandlingCommand:(id)a0 completion:(id /* block */)a1;
- (char)_shouldPrepareAudioSessionForCommand:(id)a0 intent:(id)a1;
- (id)_updatedEventContextWithExtensionLoadType:(id)a0 wasPrewarmed:(char)a1;
- (id)analytics:(id)a0 contextDictionaryForCommand:(id)a1;
- (id)analytics:(id)a0 contextDictionaryForError:(id)a1;
- (void)analytics:(id)a0 needsToLogEventWithType:(long long)a1 context:(id)a2 contextNoCopy:(char)a3;
