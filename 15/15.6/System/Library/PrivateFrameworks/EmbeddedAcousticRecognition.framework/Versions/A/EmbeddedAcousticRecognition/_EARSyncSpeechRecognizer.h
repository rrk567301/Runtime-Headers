...
- (id)initWithConfiguration:(id)a0 memoryLock:(char)a1;
- (void)resetWithSamplingRate:(unsigned int)a0 language:(id)a1 taskType:(id)a2 userId:(id)a3 sessionId:(id)a4 deviceId:(id)a5 farField:(char)a6 atypicalSpeech:(char)a7 maxAudioBufferSizeSeconds:(unsigned int)a8;
- (void)resetWithSamplingRate:(unsigned int)a0 language:(id)a1 taskType:(id)a2 userId:(id)a3 sessionId:(id)a4 deviceId:(id)a5 farField:(char)a6 audioSource:(id)a7 maxAudioBufferSizeSeconds:(unsigned int)a8;
