...
- (id)adjustSpaceForTokens:(id)a0 currTokenIndex:(unsigned long long)a1 endsOfSentencePunctuations:(id)a2 isPotentialCommandRecognition:(char)a3;
- (id)granularizedRecognition;
- (id)oneBestAlignedToTokens:(id)a0;
- (id)potentialCommandRecognition;
- (id)potentialPrecedingRecognition;
- (id)splitRecognitionWithPotentialCommandRecognition:(char)a0;
