...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithModelURLs:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2;
...
- (id)initWithModelURL:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2;
- (id)initWithModelURL:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2 translatorCacheSize:(long long)a3;
- (id)initWithModelURL:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2 translatorCacheSize:(long long)a3 useGlobalTranslationQueue:(char)a4;
- (id)initWithModelURLs:(id)a0 task:(id)a1;
- (id)initWithModelURLs:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2 translatorCacheSize:(long long)a3;
- (id)initWithModelURLs:(id)a0 task:(id)a1 skipNonFinalToCatchup:(char)a2 translatorCacheSize:(long long)a3 useGlobalTranslationQueue:(char)a4;
- (BOOL)isCompileRequiredFrom:(id)a0 to:(id)a1;
...
- (void)translateTokens:(id)a0 isFinal:(char)a1 completion:(id /* block */)a2;
- (void)translateTokens:(id)a0 isFinal:(char)a1 spans:(id)a2 completion:(id /* block */)a3;
- (void)translateTokens:(id)a0 isFinal:(char)a1 spans:(id)a2 options:(id)a3 completion:(id /* block */)a4;
- (void)translateTokens:(id)a0 isFinal:(char)a1 spans:(id)a2 overrides:(id)a3 completion:(id /* block */)a4;
