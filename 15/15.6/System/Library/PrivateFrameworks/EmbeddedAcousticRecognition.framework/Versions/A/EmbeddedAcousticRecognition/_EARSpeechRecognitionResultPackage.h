...
@property (readonly, nonatomic) char hasNonEmptyToken;
@property (nonatomic) char firstResultAfterResume;
@property (nonatomic) char recognitionPaused;
...
@property (readonly, nonatomic) char recognitionIsFormatted;
...
- (void).cxx_destruct;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4 audioAnalytics:(id)a5;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4 audioAnalytics:(id)a5 utteranceStart:(double)a6;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4 audioAnalytics:(id)a5 utteranceStart:(double)a6 latticeMitigatorResult:(id)a7;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4 audioAnalytics:(id)a5 utteranceStart:(double)a6 latticeMitigatorResult:(id)a7 nBestVoiceCommandInterpretations:(id)a8 preITNNBestVoiceCommandInterpretations:(id)a9 recognitionPaused:(char)a10;
- (id)_initWithRecognition:(id)a0 preITNRecognition:(id)a1 unrepairedRecognition:(id)a2 recognitionIsFormatted:(char)a3 isFinal:(char)a4 audioAnalytics:(id)a5 utteranceStart:(double)a6 latticeMitigatorResult:(id)a7 nBestVoiceCommandInterpretations:(id)a8 preITNNBestVoiceCommandInterpretations:(id)a9 recognitionPaused:(char)a10 firstResultAfterResume:(char)a11 endOfSentenceLikelihood:(id)a12;
