...
+ (char)createEmptyArtifact:(id)a0 version:(id)a1 locale:(id)a2 saveTo:(id)a3;
+ (char)createPhraseCountsArtifact:(id)a0 version:(id)a1 locale:(id)a2 rawPhraseCountsPath:(id)a3 customPronunciationsPath:(id)a4 saveTo:(id)a5;
+ (id)loadLmHandleFromArtifactAt:(id)a0 configPath:(id)a1;
+ (id)loadLmHandleFromArtifactAt:(id)a0 configPath:(id)a1 ncsRoot:(id)a2;
+ (id)transitionArtifactAt:(id)a0 toStage:(unsigned long long)a1 configPath:(id)a2 dataRoot:(id)a3 estimationRoot:(id)a4 minimize:(char)a5;
+ (char)transitionArtifactAt:(id)a0 toStage:(unsigned long long)a1 configPath:(id)a2 dataRoot:(id)a3 estimationRoot:(id)a4 minimize:(char)a5 saveTo:(id)a6;
+ (id)transitionArtifactAt:(id)a0 toStage:(unsigned long long)a1 configPath:(id)a2 ncsRoot:(id)a3 dataRoot:(id)a4 estimationRoot:(id)a5 minimize:(char)a6;
+ (char)transitionArtifactAt:(id)a0 toStage:(unsigned long long)a1 configPath:(id)a2 ncsRoot:(id)a3 dataRoot:(id)a4 estimationRoot:(id)a5 minimize:(char)a6 saveTo:(id)a7;
...
- (char)isAdaptableToSpeechModelVersion:(id)a0 locale:(id)a1;
