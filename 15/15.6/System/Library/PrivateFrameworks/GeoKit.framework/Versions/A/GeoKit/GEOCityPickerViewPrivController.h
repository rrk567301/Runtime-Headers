...
- (char)_comboBoxSelectionIsEmpty;
- (id)_comboBoxStringValueOnTheLeftOfTheTextCursor;
- (char)_doesUserInput:(id)a0 matchCityName:(id)a1;
- (char)_doesUserInput:(id)a0 matchCountryName:(id)a1;
- (char)_doesUserInput:(id)a0 matchString:(id)a1;
