...
@property (nonatomic) char showTimeZone;
@property (nonatomic) char showSelectedCity;
@property (retain, nonatomic) GEOCity *selectedCity;
@property (readonly) NSManagedObjectContext *geoContext;
@property (readonly) NSOperationQueue *operationQueue;
@property char isBusy;
@property char isSearchingByName;
@property (retain) NSString *nameToSearch;
@property char pulseSelectedCity;
