...
- (void)_currentModeUUID:(id *)a0 userModeName:(id *)a1 modeType:(int *)a2 confidenceScore:(double *)a3 origin:(int *)a4 originBundleId:(id *)a5 serializedTrigger:(id *)a6 allowsSmartEntry:(char *)a7 guardedData:(id)a8;
- (char)_isUserWorkingFromHomeWithAggregateFeatures:(id)a0;
...
- (void)currentModeUUID:(id *)a0 userModeName:(id *)a1 modeType:(int *)a2 confidenceScore:(double *)a3 origin:(int *)a4 originBundleId:(id *)a5 serializedTrigger:(id *)a6 allowsSmartEntry:(char *)a7;
...
- (void)updateWithFeatureSet:(id)a0 immediately:(char)a1 reply:(id /* block */)a2;
