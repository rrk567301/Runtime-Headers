...
- (char)isAvailableLocationOfInterestType:(long long)a0;
- (char)isLocationNearKnownTypeLocationOfInterest:(id)a0;
- (char)isNearFrequentLocationOfInterest;
...
- (id)_currentLocationAndNeedsUpdate_RequestPreciseLocation:(char)a0;
...
- (void)didChangeLocationEnabled:(char)a0;
- (void)didChangePreciseLocationEnabled:(char)a0;
- (void)getCurrentLocationWithCompletionHandler:(id /* block */)a0;
- (id)getCurrentLocation_RequestPreciseLocation:(char)a0;
- (unsigned long long)getCurrentRoutineModeWithCurrentDate:(id)a0;
- (void)gotState:(id)a0;
- (void)invalidateLocationOfInterestCache;
- (char)isNearKnownTypeLocationOfInterest;
- (char)isNearKnownTypeOrFrequentLocationOfInterest;
- (char)isTouristWithCurrentDate:(id)a0;
