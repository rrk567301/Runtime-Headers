...
@property (readonly, nonatomic) char hasAnyCredentialData;
@property (readonly, nonatomic) char hasPasswordWithConflicts;
...
+ (char)safariCredentialURLHasPasskey:(id)a0;
...
- (char)_hasPasskeyData;
- (id)_encryptionInformationWithNewKey;
- (char)_hasPasswordData;
