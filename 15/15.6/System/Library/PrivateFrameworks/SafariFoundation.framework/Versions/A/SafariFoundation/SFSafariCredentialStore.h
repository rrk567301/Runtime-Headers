...
+ (char)_appIsEntitledWebBrowser:(id)a0;
...
+ (void)_fetchKeychainCredentialsIfRequiredForAppID:(id)a0 withSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 webFrameIdentifier:(id)a3 isEntitledWebBrowser:(char)a4 completion:(id /* block */)a5;
+ (void)_getAllowedActionForAppCredentialsWithAppID:(id)a0 websiteURL:(id)a1 user:(id)a2 password:(id)a3 shouldAnalyzeExistingCredentials:(char)a4 completionHandler:(id /* block */)a5;
...
+ (void)_getCredentialsForAppWithAppID:(id)a0 approvedAndValidSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 isEntitledWebBrowser:(char)a3 hasPasskeyRequest:(char)a4 completionHandler:(id /* block */)a5;
+ (void)_getCredentialsForAppWithAppID:(id)a0 approvedAndValidSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 webFrameIdentifier:(id)a3 isEntitledWebBrowser:(char)a4 hasPasskeyRequest:(char)a5 completionHandler:(id /* block */)a6;
...
+ (void)_getExternalCredentialsForAppID:(id)a0 matchingSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 isEntitledWebBrowser:(char)a3 hasPasskeyRequest:(char)a4 completion:(id /* block */)a5;
+ (id)_highLevelDomainsFromDatabaseEntries:(id)a0;
+ (char)_savedAccount:(id)a0 isRelatedToEntryHighLevelDomains:(id)a1 andWebsiteURL:(id)a2;
