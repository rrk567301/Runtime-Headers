...
@interface SFAppAutoFillOneTimeCodeProvider : NSObject {
    ...
    char _isOneTimeCodeAutoDeletionEnabled;
...
@property (nonatomic) char isOneTimeCodeAutoDeletionEnabled;
...
- (char)_appWithAppIdentifierIsWebBrowser:(id)a0;
- (id)_associatedDomainEntriesForAppWithIdentifier:(id)a0;
- (void)_consumeOneTimeCode:(id)a0;
- (long long)_domainBindingForRecievedOneTimeCode:(id)a0 forAppWithIdentifier:(id)a1 websiteURL:(id)a2 hasDomainBinding:(char *)a3;
...
- (char)_shouldIgnoreOneTimeCode:(id)a0;
