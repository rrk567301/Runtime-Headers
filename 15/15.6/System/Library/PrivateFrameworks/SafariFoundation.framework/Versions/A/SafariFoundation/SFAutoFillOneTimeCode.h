...
@property (readonly, nonatomic) char domainStrictMatch;
...
- (long long)_matchURL:(id)a0 withBoundDomainURL:(id)a1 strict:(char)a2;
...
- (id)initWithTOTPGenerator:(id)a0 user:(id)a1 highLevelDomain:(id)a2 lastUsedDateOfAssociatedSavedAccount:(id)a3;
