...
- (id)_GSHeadersForAccount:(id)a0 forceReprovisioning:(char)a1 avoidUI:(char)a2;
- (id)_accountHeadersFor:(id)a0 forceReprovisioning:(char)a1 avoidUI:(char)a2;
- (id)_appleIDSesssion;
- (id)_baaManager;
- (id)_deviceProductType;
- (id)_storeLocale;
- (id)_userAgentWithBundleID:(id)a0;
- (id)accountHeadersFor:(id)a0 forceReprovisioning:(char)a1 avoidUI:(char)a2;
