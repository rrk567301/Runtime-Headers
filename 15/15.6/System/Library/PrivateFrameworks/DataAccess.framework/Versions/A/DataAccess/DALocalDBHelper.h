...
- (id)init;
- (void).cxx_destruct;
- (char)calCloseDatabaseForAccountID:(id)a0 save:(char)a1;
...
- (char)calSaveDatabaseAndFlushCachesForAccountID:(id)a0;
- (char)calSaveDatabaseForAccountID:(id)a0;
- (char)calCloseDatabaseForAuxDatabaseRef:(void *)a0 save:(char)a1;
...
- (char)calSaveDatabaseForAuxDatabaseRef:(void *)a0;
