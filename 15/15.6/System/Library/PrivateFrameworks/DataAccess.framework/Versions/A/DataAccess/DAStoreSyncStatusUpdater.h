...
+ (char)_isCanceledError:(id)a0;
+ (id)_mappedAccountErrorFromError:(id)a0;
+ (void)_updateStatusForCalendar:(id)a0 lastSyncStartDate:(id)a1 lastSyncEndDate:(id)a2 lastSyncError:(id)a3 canceled:(char)a4;
+ (void)_updateStatusForCalendarWithExternalID:(id)a0 sourceExternalID:(id)a1 lastSyncStartDate:(id)a2 lastSyncEndDate:(id)a3 lastSyncError:(id)a4 canceled:(char)a5;
+ (void)_updateStatusForSource:(id)a0 lastSyncStartDate:(id)a1 lastSyncEndDate:(id)a2 lastSyncError:(id)a3 canceled:(char)a4;
+ (void)_updateStatusForStoreWithExternalID:(id)a0 lastSyncStartDate:(id)a1 lastSyncEndDate:(id)a2 lastSyncError:(id)a3 canceled:(char)a4;
