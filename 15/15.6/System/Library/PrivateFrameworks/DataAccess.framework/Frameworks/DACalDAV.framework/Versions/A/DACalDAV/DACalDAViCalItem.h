...
@property (nonatomic) char isMigrate;
@property (readonly, nonatomic) char invitationStatusCleared;
@property (nonatomic) char prohibitLocalCreationOfServerID;
...
+ (char)_checkOccurrencesForEvent:(id)a0 fromDate:(id)a1 toDate:(id)a2;
+ (char)_shouldApplyEvent:(id)a0 instanceWithStartDate:(id)a1 startRange:(id)a2 endRange:(id)a3;
+ (char)_shouldApplyEventFromSyncReport:(id)a0 startDate:(id)a1 endDate:(id)a2;
...
- (char)deleteFromContainer:(void *)a0;
- (char)loadLocalItemWithAccount:(id)a0;
- (char)saveServerIDToExistingItem;
- (char)saveWithLocalObject:(void *)a0 toContainer:(void *)a1 shouldMergeProperties:(char)a2 outMergeDidChooseLocalProperties:(char *)a3 account:(id)a4;
- (char)_addOrModifyEvent:(id)a0 inICSCalendar:(id)a1 withContainer:(void *)a2 shouldMergeProperties:(char)a3 outMergeDidChooseLocalProperties:(char *)a4 inMobileCalendar:(id)a5;
- (char)_addOrModifyTask:(id)a0 inICSCalendar:(id)a1 withContainer:(void *)a2 shouldMergeProperties:(char)a3 outMergeDidChooseLocalProperties:(char *)a4 inMobileCalendar:(id)a5;
...
- (char)saveToContainer:(void *)a0 shouldMergeProperties:(char)a1 outMergeDidChooseLocalProperties:(char *)a2 account:(id)a3 mobileCalendar:(id)a4 outRecurrenceSets:(id *)a5;
