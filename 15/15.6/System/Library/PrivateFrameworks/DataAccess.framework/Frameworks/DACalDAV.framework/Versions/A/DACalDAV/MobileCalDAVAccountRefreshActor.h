...
@interface MobileCalDAVAccountRefreshActor : NSObject <CalDAVAccountPropertyRefreshDelegate, CalDAVCalendarPropertyRefreshDelegate, CalDAVCalendarSyncDelegate, CalDAVAccountDelegatesRefreshDelegate> {
    ...
    char _didForceDefaultCalendarRefetch;
}
...
@property (nonatomic) char refreshFoundUpdatedTaskContainer;
@property (nonatomic) char refreshFoundUpdatedSpecialCalendar;
@property (nonatomic) char refreshFoundDeletedContainerURL;
...
@property (readonly, nonatomic) char needsRemindersSync;
...
- (char)calendarRefreshShouldRetryMkCalendarForPrincipal:(id)a0 calendar:(id)a1 error:(id)a2;
