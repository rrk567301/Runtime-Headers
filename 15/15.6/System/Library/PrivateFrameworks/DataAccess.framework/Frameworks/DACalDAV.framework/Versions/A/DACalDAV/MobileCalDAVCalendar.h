...
@property (readonly, nonatomic) char mustCalendarBeReadOnly;
@property (readonly, nonatomic) char shouldCalendarBeHidden;
...
@property (nonatomic) char needsIsAffectingAvailabilityUpdate;
@property (nonatomic) char becameDefaultSchedulingCalendar;
...
+ (char)clearCalendarChanges:(struct __CFArray { } *)a0 forPrincipal:(id)a1 changeTrackingClient:(id)a2;
...
+ (char)shouldSkipAddedCalendar:(void *)a0;
+ (char)shouldSkipCalendar:(void *)a0 withChangeType:(int)a1;
+ (char)shouldSkipModifiedCalendar:(void *)a0;
...
- (void)_clearChanges:(id)a0 shouldClearAttachmentChanges:(char)a1;
- (void)_clearChangesFromItem:(id)a0;
- (void)_clearChangesFromItem:(id)a0 shouldClearAttachmentChanges:(char)a1;
...
- (id)_createActionsForItems:(id)a0 withAction:(int)a1 alreadySentItems:(id)a2 createServerIDs:(char)a3 shouldSave:(char *)a4;
...
- (char)_isDeleted:(id)a0;
- (char)_isItemJunk:(void *)a0;
...
- (void *)getCalCalendar;
- (char)hasCalendarErrorOfType:(unsigned long long)a0;
