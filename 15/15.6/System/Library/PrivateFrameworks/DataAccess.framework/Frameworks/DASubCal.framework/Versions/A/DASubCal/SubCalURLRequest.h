...
@property (nonatomic) char sendDataUpdateCallback;
...
@property (nonatomic) char useFileCache;
...
@property (nonatomic) char useShortTimeoutInterval;
...
- (id)initWithURL:(id)a0 wasUserRequested:(char)a1;
