...
@property (nonatomic) char foundBeginVCal;
@property (nonatomic) char foundCalName;
...
@property (nonatomic) char performQuickValidation;
@property (nonatomic) char useShortTimeout;
...
- (void)performTask;
- (void)willFinish;
- (char)_isInvalidVCalBeginningForData:(id)a0;
