...
+ (char)_shouldAccount:(id)a0 syncWhenSyncingParentAccountWithID:(id)a1;
...
- (void)loadAgents;
- (void)releaseAgents;
- (char)resumeMonitoringAccountID:(id)a0 folderIDs:(id)a1;
- (void)scheduleAgentStartOrStopBlock:(id /* block */)a0;
- (char)startMonitoringAccountID:(id)a0 folderIDs:(id)a1;
