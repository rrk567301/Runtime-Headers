...
+ (id)predicateForGroupsConformingToProtocol:(id)a0;
+ (id)predicateForGroupsContainingGroup:(id)a0;
+ (id)predicateForType;
+ (id)validateGroupSpecificationWithType:(id)a0 identifier:(id)a1 name:(id)a2 properties:(id)a3 members:(id)a4;
