...
@property (readonly) char isiCloudPrinter;
...
+ (char)printerLookupWithName:(id)a0 andTimeout:(double)a1;
...
- (void)cancelUnlock;
- (void)finalizeJob:(char)a0 completionHandler:(id /* block */)a1;
...
- (id)papersForDocumentWithSize:(struct CGSize { double x0; double x1; })a0 andDuplex:(char)a1;
