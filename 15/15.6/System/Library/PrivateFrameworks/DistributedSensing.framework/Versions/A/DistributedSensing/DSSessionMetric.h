...
@interface DSSessionMetric : NSObject {
    ...
    char _unterminatedSession;
    char _isSessionStartUnsuccessful;
}
...
- (void)dsSessionStartedWithDeviceRole:(int)a0 numPotentialProviders:(unsigned long long)a1 unterminatedSession:(char)a2;
