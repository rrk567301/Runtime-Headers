...
+ (struct PISegmentationClockOverlapResult { id x0; unsigned long long x1; double x2; double x3; })computeClockLayerOrderWithVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 segmentationMatte:(id)a1 layoutConfiguration:(id)a2 context:(id)a3 interactive:(char)a4;
+ (double)computeHeadroomZoomFactorWithVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 zoomTowardsTop:(char *)a1 matte:(id)a2 layoutConfiguration:(id)a3 context:(id)a4;
+ (struct PISegmentationInactiveResult { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; })computeInactiveFrameWithVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 imageSize:(struct CGSize { double x0; double x1; })a1 canUpdateVisibleRect:(char)a2 considerHeadroom:(char)a3 segmentationMatte:(id)a4 layoutConfiguration:(id)a5 context:(id)a6;
...
+ (char)matteHistogramIndicatesSubjectDetected:(id)a0;
...
+ (char)topEdgeHasNoContactWithInspectionMatte:(id)a0 context:(id)a1;
