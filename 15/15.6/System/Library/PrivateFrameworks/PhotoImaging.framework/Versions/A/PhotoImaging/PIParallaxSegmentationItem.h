...
@property (readonly, nonatomic) char isSettlingEffectAvailable;
@property (readonly, nonatomic) char settlingEffectFailedAnyGating;
@property (readonly, nonatomic) char settlingEffectHasInterestingMotion;
...
@property (readonly, nonatomic) char supportsSegmentedStyles;
@property (readonly, nonatomic) char supportsBackgroundlessStyles;
@property (readonly, nonatomic) unsigned long long version;
@property (readonly, nonatomic) char supportsManualClockIntersectionTolerance;
...
+ (char)writeImageBuffer:(id)a0 toURL:(id)a1 error:(out id *)a2;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)init;
- (void).cxx_destruct;
- (char)loadFromURL:(id)a0 error:(out id *)a1;
- (char)saveToURL:(id)a0 error:(out id *)a1;
- (void)_invalidateCachedData;
- (id)contentsDictionary;
- (char)_loadSegmentationDataFromURL:(id)a0 error:(out id *)a1 matteImageLoadingBlock:(id /* block */)a2 backgroundImageLoadingBlock:(id /* block */)a3 settingEffectDataLoadingBlock:(id /* block */)a4;
...
- (char)loadContentsFromDictionary:(id)a0 hasMatte:(char *)a1 hasBackground:(char *)a2 error:(out id *)a3;
- (char)loadSegmentationDataFromURL:(id)a0 error:(out id *)a1;
- (void)resetSettlingEffectGatingFailure;
- (char)saveAssetResourceToURL:(id)a0 error:(out id *)a1;
- (char)saveSegmentationDataToURL:(id)a0 error:(out id *)a1;
