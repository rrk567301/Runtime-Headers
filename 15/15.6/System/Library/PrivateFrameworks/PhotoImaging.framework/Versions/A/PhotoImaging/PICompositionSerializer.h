...
+ (id)_serializeComposition:(id)a0 versionInfo:(id)a1 skipMetadata:(char)a2 error:(out id *)a3;
+ (char)_validateValueTypesForKeys:(id)a0 requiredKeys:(id)a1 inDictionary:(id)a2 error:(out id *)a3;
+ (id)adjustmentInformationForComposition:(id)a0 error:(out id *)a1;
+ (id)adjustmentInformationForComposition:(id)a0 skipMetadata:(char)a1 error:(out id *)a2;
...
+ (void)disableApertureEffects:(char)a0;
+ (id)serializeComposition:(id)a0 versionInfo:(id)a1 error:(out id *)a2;
+ (char)validateAdjustmentsEnvelope:(id)a0 error:(out id *)a1;
+ (char)validateCompositionWithMissingSource:(id)a0 error:(out id *)a1;
