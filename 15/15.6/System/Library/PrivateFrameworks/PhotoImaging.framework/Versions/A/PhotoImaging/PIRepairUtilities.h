...
+ (char)applyRepairMLStrokeToMutableBuffer:(id)a0 brushStroke:(id)a1 detectedFaces:(id)a2 context:(id)a3 error:(out id *)a4;
+ (void)applyRepairStrokeToMutableBuffer:(id)a0 brushStroke:(id)a1 sourceOffset:(struct CGPoint { double x0; double x1; })a2 repairEdges:(char)a3;
...
+ (char)transcodePixelBuffer:(id)a0 toBuffer:(id)a1 error:(out id *)a2;
