...
@property (readonly, nonatomic) char shouldUseInteractiveSettlingEffectGating;
...
@property (nonatomic) char disableRendering;
@property (nonatomic) char disableSettlingEffect;
@property (retain, nonatomic) id<PIPosterLayoutProvider> layoutProvider;
@property (nonatomic) char disableCache;
@property (nonatomic) char allowCachedLayoutConfigurationMismatch;
@property (nonatomic) unsigned long long role;
@property (nonatomic) char performMediaAnalysisInProcess;
@property (nonatomic) long long settlingEffectGatingLevel;
@property (nonatomic) char loadFirstResourceOnly;
@property (nonatomic) char preferFullResolutionResource;
@property (nonatomic) char disableDownload;
@property (nonatomic) char disableHeadroomLayout;
...
+ (char)clientIsMobileSlideShow;
+ (char)currentDeviceSupportsSettlingEffect;
+ (void)freeResources;
+ (id)generateLayerStackForItem:(id)a0 style:(id)a1 layout:(id)a2 options:(unsigned long long)a3 enableSettlingEffect:(char)a4 completion:(id /* block */)a5;
...
+ (char)saveSegmentationItem:(id)a0 compoundLayerStack:(id)a1 style:(id)a2 toWallpaperURL:(id)a3 error:(id *)a4;
...
+ (char)saveSegmentationItem:(id)a0 toURL:(id)a1 error:(id *)a2;
...
- (char)_isValidSegmentationMatteHistogramForDepth:(id)a0;
- (void)_loadAssetResource:(long long)a0 allowNetworkAccess:(char)a1 options:(id)a2 completion:(id /* block */)a3;
...
- (void)_loadAssetResourceForProxy:(char)a0 completion:(id /* block */)a1;
...
- (char)_shouldEnableSegmentationByDefault;
- (char)_shouldEnableSettlingEffectByDefault;
- (char)_shouldLoadSettlingEffectForItem:(id)a0;
