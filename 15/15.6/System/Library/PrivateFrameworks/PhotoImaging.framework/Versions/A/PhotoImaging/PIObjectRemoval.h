...
+ (void)initialize;
+ (char)loadAndRegisterRefinementModel:(out id *)a0;
+ (void)warmUpResources;
+ (id)_instancesForOperation:(id)a0;
+ (id)_instancesFromMaskIdentifier:(id)a0;
+ (char)_loadAndRegisterModelForKey:(id)a0 error:(out id *)a1;
...
+ (char)_operationIsBrushStroke:(id)a0;
...
+ (char)brushStrokeExceedsSizeLimit:(id)a0 imageSize:(struct CGSize { double x0; double x1; })a1 closeAndFillStroke:(char)a2;
...
+ (char)loadAndRegisterInpaintModel:(out id *)a0;
+ (char)loadAndRegisterModelForKey:(id)a0 error:(out id *)a1;
+ (char)mask:(id)a0 containsPoint:(struct CGPoint { double x0; double x1; })a1;
+ (char)mask:(id)a0 intersectsDiskWithOrigin:(struct CGPoint { double x0; double x1; })a1 radius:(double)a2;
+ (id)maskIdentifierForSegmentIndex:(unsigned long long)a0;
+ (id)maskIdentifierForSegmentIndices:(id)a0;
+ (char)maskIdentifierIsDeclutter:(id)a0;
+ (char)maskIsMostlyWithinFace:(id)a0 imageSize:(struct { long long x0; long long x1; })a1 imageOrientation:(long long)a2 intAreaOverMaskAreaThreshold:(double)a3 intAreaOverFaceAreaThreshold:(double)a4 detectedFaces:(id)a5;
+ (char)objectMasksExceedSizeLimit:(id)a0 imageSize:(struct CGSize { double x0; double x1; })a1;
...
+ (char)strokeIsEntirelyWithinFace:(id)a0 imageSize:(struct { long long x0; long long x1; })a1 imageOrientation:(long long)a2 detectedFaces:(id)a3;
