...
- (char)setImageVariation:(id)a0 properties:(id)a1 error:(id *)a2;
- (char)setPhotoFeatureFlags:(id)a0 properties:(id)a1 error:(id *)a2;
- (char)setPhotoProcessingFlags:(id)a0 properties:(id)a1 error:(id *)a2;
