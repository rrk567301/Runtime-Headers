...
@interface SubjectSelectionSession : NSObject {
    ...
    char _singleSubjectSelection;
    char _currentProcessIsCameraCaptureDaemon;
...
@property (nonatomic) char singleSubjectSelection;
@property (nonatomic) char enableGazeSelection;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithCurrentProcessIsCameraCaptureDaemon:(char)a0;
...
- (char)gazeSubjectSelection;
- (void)setGazeSubjectSelection:(char)a0;
