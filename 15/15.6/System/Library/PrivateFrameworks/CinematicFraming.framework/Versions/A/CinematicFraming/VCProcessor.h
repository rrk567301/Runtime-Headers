...
@property (nonatomic) char centerStagePassthrough;
...
@property (nonatomic) char orientationCorrectionEnabled;
@property (nonatomic) char rollCorrectionEnabled;
@property (nonatomic) char confineOutputCamera;
@property (nonatomic) char fisheyeEffectEnabled;
@property (nonatomic) float videoZoomFactor;
@property (nonatomic) char attachMetadataToOutputPixelBuffer;
@property (readonly, nonatomic) char outputCameraResetCompleted;
@property (readonly, nonatomic) char oneShotFramingCompleted;
@property (nonatomic) float manualFramingDefaultVideoZoomFactor;
@property (nonatomic) void /* unknown type, empty encoding */ outputCameraDefaultRotation;
@property (readonly, nonatomic) NSDictionary *manualFramingStateMetadata;
@property (nonatomic) char autoFramingEnabled;
@property (nonatomic) char autoRestoreManualFramingState;
...
- (struct { void /* unknown type, empty encoding */ x0[4]; })getPhysicalCameraToVirtualCameraTransform;
- (int)purgeResources;
...
- (int)_confineOutputCameraToInputCameraFrustum:(char)a0;
