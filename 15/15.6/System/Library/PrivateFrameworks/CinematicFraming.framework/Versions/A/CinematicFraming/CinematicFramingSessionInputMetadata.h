...
@interface CinematicFramingSessionInputMetadata : NSObject <NSSecureCoding> {
    char _calibrationDistortionCoefficientsSupported;
    char _calibrationValidMaxRadiusSupported;
}
