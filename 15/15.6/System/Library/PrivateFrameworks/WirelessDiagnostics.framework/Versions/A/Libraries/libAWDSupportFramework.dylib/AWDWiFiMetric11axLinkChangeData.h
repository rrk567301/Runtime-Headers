...
@property (readonly, nonatomic) char hasHeCapabilitiesIE;
@property (retain, nonatomic) NSData *heCapabilitiesIE;
@property (readonly, nonatomic) char hasHeOperationIE;
@property (retain, nonatomic) NSData *heOperationIE;
@property (readonly, nonatomic) char hasHeBSSLoadIE;
@property (retain, nonatomic) NSData *heBSSLoadIE;
@property (readonly, nonatomic) char hasMuEDCAParametersIE;
@property (retain, nonatomic) NSData *muEDCAParametersIE;
@property (nonatomic) char hasHeMacCapSubfields;
@property (nonatomic) unsigned int heMacCapSubfields;
@property (nonatomic) char hasHePhyCapSubfields;
@property (nonatomic) unsigned int hePhyCapSubfields;
@property (nonatomic) char hasHeRxTxMcsMap;
@property (nonatomic) unsigned int heRxTxMcsMap;
@property (nonatomic) char hasHeOpsParams;
@property (nonatomic) unsigned int heOpsParams;
@property (nonatomic) char hasHeBssMcsNss;
@property (nonatomic) unsigned int heBssMcsNss;
@property (nonatomic) char hasHeStaCnt;
@property (nonatomic) unsigned int heStaCnt;
@property (nonatomic) char hasHeUtilization;
@property (nonatomic) unsigned int heUtilization;
@property (nonatomic) char hasHeBEParamRecord;
@property (nonatomic) unsigned int heBEParamRecord;
@property (nonatomic) char hasHeBKParamRecord;
@property (nonatomic) unsigned int heBKParamRecord;
@property (nonatomic) char hasHeVIParamRecord;
@property (nonatomic) unsigned int heVIParamRecord;
@property (nonatomic) char hasHeVOParamRecord;
