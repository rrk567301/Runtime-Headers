...
@interface AWDFaceTimeCallCancelSent : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char cancelCode : 1; unsigned char errorCode : 1; unsigned char isVideo : 1; unsigned char onLockScreen : 1; unsigned char sendDuration : 1; } _has;
}
...
@property (nonatomic) char hasCancelCode;
