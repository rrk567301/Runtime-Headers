...
@property (nonatomic) char hasTxDutyCycle;
@property (nonatomic) unsigned int txDutyCycle;
@property (nonatomic) char hasTxPowerBackoff;
@property (nonatomic) int txPowerBackoff;
@property (nonatomic) char hasNumActiveChains;
...
@property (nonatomic) char hasCltmIndex;
@property (nonatomic) unsigned int cltmIndex;
@property (nonatomic) char hasPpm;
@property (nonatomic) unsigned int ppm;
@property (nonatomic) char hasUpdateCount;
