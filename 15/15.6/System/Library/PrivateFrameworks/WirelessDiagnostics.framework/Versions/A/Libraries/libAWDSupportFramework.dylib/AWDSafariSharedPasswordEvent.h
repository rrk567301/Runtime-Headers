...
@property (nonatomic) char hasInitiatedSharePasswordOutcome;
@property (nonatomic) int initiatedSharePasswordOutcome;
@property (nonatomic) char hasReceivedSharedPasswordOutcome;
@property (nonatomic) int receivedSharedPasswordOutcome;
@property (nonatomic) char hasPasswordSharingMechanism;
