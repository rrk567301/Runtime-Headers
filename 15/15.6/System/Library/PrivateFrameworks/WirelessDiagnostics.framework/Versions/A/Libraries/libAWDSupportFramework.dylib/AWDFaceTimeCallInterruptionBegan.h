...
@interface AWDFaceTimeCallInterruptionBegan : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char isAudioInterrupted : 1; unsigned char isVideo : 1; unsigned char isVideoInterrupted : 1; unsigned char linkQuality : 1; unsigned char onLockScreen : 1; } _has;
}
