...
@interface AWDIDSRegistrationOperation : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char connectionType : 1; unsigned char genericError : 1; unsigned char heartbeatDelay : 1; unsigned char heartbeatRegister : 1; unsigned char pOSIXError : 1; unsigned char registrationError : 1; unsigned char resultCode : 1; unsigned char success : 1; unsigned char uRLError : 1; } _has;
}
...
@property (nonatomic) char hasHeartbeatRegister;
@property (nonatomic) unsigned int heartbeatRegister;
@property (nonatomic) char hasHeartbeatDelay;
