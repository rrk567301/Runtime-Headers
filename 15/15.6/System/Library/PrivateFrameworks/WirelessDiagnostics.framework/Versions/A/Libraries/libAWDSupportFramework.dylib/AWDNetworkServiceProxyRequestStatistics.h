...
@property (readonly, nonatomic) char hasFirstPartyServiceName;
...
@property (nonatomic) char hasRequestFailedCount;
@property (nonatomic) unsigned int requestFailedCount;
@property (nonatomic) char hasDirectConnectionCount;
@property (nonatomic) unsigned int directConnectionCount;
@property (nonatomic) char hasDirectConnectionFailedCount;
