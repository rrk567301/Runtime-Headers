...
@property (nonatomic) char hasDataInKB;
@property (nonatomic) long long dataInKB;
@property (nonatomic) char hasDataOutKB;
@property (nonatomic) long long dataOutKB;
@property (nonatomic) char hasSecondaryFlowSuccessCount;
@property (nonatomic) int secondaryFlowSuccessCount;
@property (nonatomic) char hasSecondaryFlowFailureCount;
@property (nonatomic) int secondaryFlowFailureCount;
@property (nonatomic) char hasPostConnectTcpFallbackCount;
@property (nonatomic) char postConnectTcpFallbackCount;
