...
- (id)pfVideoAdjustmentsDictionaryForString:(id)a0;
- (id)photosAdjustmentsDictionaryForAdjustmentsFileAtPath:(id)a0;
...
- (char)processConversionOptionKey:(id)a0 valueString:(id)a1;
