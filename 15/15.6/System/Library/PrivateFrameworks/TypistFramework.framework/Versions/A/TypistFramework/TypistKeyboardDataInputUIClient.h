...
+ (char)connectToRemoteKeyboard:(double)a0;
...
+ (struct { void /* unknown type, empty encoding */ x0[4]; })getKeyboardScaleTransform;
...
+ (char)isExtendedCandidateViewMode;
+ (id)removeKeyboards:(id)a0;
+ (id)setKeyboardUISettings:(id)a0;
+ (id)setTIPreferences:(id)a0;
+ (char)switchToKeyboard:(id)a0;
+ (char)switchToPlane:(id)a0;
+ (void)tryConnection;
