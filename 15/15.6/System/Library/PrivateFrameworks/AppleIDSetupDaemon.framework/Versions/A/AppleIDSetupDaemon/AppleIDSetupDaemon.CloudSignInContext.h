...
- (id)init;
- (void).cxx_destruct;
- (void)signInFlowController:(AASignInFlowController *)a0 enableFindMyWithAction:(unsigned long long)a1 completion:(void (^)(char))a2;
- (void)signInFlowController:(AASignInFlowController *)a0 presentGenericTermsUIForAccount:(ACAccount *)a1 completion:(void (^)(char, ACAccount *, NSError *))a2;
- (void)signInFlowController:(AASignInFlowController *)a0 presentProgressViewForAccount:(ACAccount *)a1 completion:(void (^)(char))a2;
