...
@property (nonatomic, getter=isInFullscreen) char inFullscreen;
...
- (char)_canExitFullscreen;
- (char)_canUseTransitionType:(unsigned long long)a0 forTransitionWithContext:(id)a1;
- (void)_completeExitTransitionIfPossible;
- (void)_ensureTransitionContextWithDefaultType:(unsigned long long)a0;
- (char)_hasTransitionContext;
