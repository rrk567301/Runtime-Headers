...
@property (nonatomic, getter=isPresented) char presented;
@property (nonatomic, getter=isTransitioning) char transitioning;
...
@property (nonatomic) char hidesSourceWindowWhileInFullscreen;
