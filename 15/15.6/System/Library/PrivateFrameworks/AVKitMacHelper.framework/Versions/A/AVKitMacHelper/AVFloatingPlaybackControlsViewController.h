...
@property (nonatomic) char canUpdateControlsState;
...
- (void)_animateViewsIfNeeded:(id)a0 toHiddenState:(char)a1 withCompletionHandler:(id /* block */)a2;
...
- (void)_updateShowsControlsBaselineView:(char)a0;
- (void)_updateShowsControlsCenterLineView:(char)a0;
- (void)_updateShowsPlayButtonBaselineView:(char)a0;
- (void)_updateShowsViewBackgrounds:(char)a0;
