...
@property char hasRoundedCorners;
...
- (void)_startOrStopUpdatingPlayheadApplicationIsActive:(char)a0;
...
- (char)touchBarScrubberWillStartTracking:(id)a0;
