...
@interface BKSWindowServerHitTestSecurityAnalysis : NSObject <BSDescriptionStreamable, BSProtobufSerializable, NSCopying, NSMutableCopying> {
    ...
    char _hasInsecureFilter;
    char _parentsHaveInsecureLayerProperties;
...
@property (readonly, nonatomic) char hasInsecureFilter;
@property (readonly, nonatomic) char parentsHaveInsecureLayerProperties;
