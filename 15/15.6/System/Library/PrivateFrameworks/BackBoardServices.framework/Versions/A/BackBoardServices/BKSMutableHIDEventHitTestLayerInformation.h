...
@property (nonatomic) char hasInsecureFilter;
@property (nonatomic) char detectedOcclusion;
@property (nonatomic) char backgroundStatisticsValid;
...
- (void)setDetectedOcclusion:(char)a0;
- (void)setHasInsecureFilter:(char)a0;
