...
@property (nonatomic) char capsLockKeyHasLanguageSwitchLabel;
@property (nonatomic) char globeKeyLabelHasGlobeSymbol;
...
- (void)setGlobeKeyLabelHasGlobeSymbol:(char)a0;
- (void)setCapsLockKeyHasLanguageSwitchLabel:(char)a0;
- (void)setExclusivityIdentifier:(id)a0;
- (void)setPlatformInputModeConfiguration:(id)a0;
