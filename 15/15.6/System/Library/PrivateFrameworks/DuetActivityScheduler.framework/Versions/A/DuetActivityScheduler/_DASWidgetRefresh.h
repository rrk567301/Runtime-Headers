...
@property (nonatomic) char isDASInitiated;
...
- (id)initWithRateLimitConfigurationName:(id)a0 budgetID:(id)a1 extensionBundleID:(id)a2 refreshDate:(id)a3 initiatedByDAS:(char)a4;
