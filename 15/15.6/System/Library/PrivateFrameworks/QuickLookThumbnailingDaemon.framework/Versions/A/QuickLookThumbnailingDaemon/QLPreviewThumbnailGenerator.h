...
@property char resultIsLowQuality;
@property char wantsLowQuality;
...
@property char resultHasIconModeApplied;
...
- (id)initWithGeneratorRequest:(id)a0 lowQuality:(char)a1 thumbnailItem:(id)a2;
