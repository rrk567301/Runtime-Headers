...
- (id)initWithSize:(float)a0 iconMode:(char)a1 badgeType:(unsigned long long)a2;
- (id)initWithSize:(float)a0 iconMode:(char)a1 badgeType:(unsigned long long)a2 externalGeneratorDataHash:(unsigned long long)a3;
