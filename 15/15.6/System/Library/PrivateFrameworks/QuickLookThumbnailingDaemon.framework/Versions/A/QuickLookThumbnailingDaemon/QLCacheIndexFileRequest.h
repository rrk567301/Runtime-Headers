...
- (char)allSizes;
- (void)appendSize:(float)a0 minimumSize:(float)a1 withIconMode:(unsigned char)a2 lowQuality:(char)a3 badgeType:(unsigned long long)a4 iconVariant:(long long)a5 interpolationQuality:(int)a6 externalGeneratorDataHash:(unsigned long long)a7;
