...
- (char)downloadThumbnails:(id)a0 forProvider:(id)a1;
...
- (void)_cacheThumbnailData:(id)a0 forRequest:(id)a1 imageSource:(struct CGImageSource { } *)a2 actualSize:(struct CGSize { double x0; double x1; })a3 resultSize:(struct CGSize { double x0; double x1; })a4 fromGenStore:(char)a5 completionHandler:(id /* block */)a6;
- (void)_callCompletionHandler:(id /* block */)a0 ofThumbnailRequestBatch:(id)a1;
- (char)_canUseAdditionToProvideThumbnail:(id)a0 forThumbnailRequest:(id)a1 taggedLogicalURL:(id)a2;
...
- (void)_notifyGenerationHandlerOfThumbnailGenerationForRequest:(id)a0 images:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 iconFlavor:(int)a4 thumbnailRepresentation:(long long)a5 clientShouldTakeOwnership:(char)a6 error:(id)a7;
- (void)_removeRequestFromPendingRequests:(id)a0;
- (void)_saveLargeThumbnailForDocumentAtURL:(id)a0 toGenstoreWithImage:(struct CGImage { } *)a1 automaticallyGenerated:(char)a2;
- (void)_saveLargeThumbnailToGenstoreWithData:(id)a0 url:(id)a1;
- (char)_saveResultForThumbnailRequest:(id)a0 withImage:(id)a1 error:(id *)a2;
...
- (void)addImageData:(id)a0 withBitmapFormat:(id)a1 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 hasIconModeApplied:(char)a3 flavor:(int)a4 extensionBadge:(id)a5 metadata:(id)a6 toCacheAndCompleteRequest:(id)a7;
...
- (void)completeThumbnailRequest:(id)a0 bitmapData:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 thumbnailRepresentation:(long long)a4 iconFlavor:(int)a5 format:(id)a6 clientShouldTakeOwnership:(char)a7;
- (void)completeThumbnailRequest:(id)a0 images:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 thumbnailRepresentation:(long long)a4 iconFlavor:(int)a5 clientShouldTakeOwnership:(char)a6;
...
- (void)generateThumbnailForThumbnailRequest:(id)a0 shouldUpdateGenstore:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)processLargeThumbnailData:(id)a0 withContentType:(id)a1 isAppContainer:(char)a2 forRequest:(id)a3 fromGenStore:(char)a4 completionHandler:(id /* block */)a5;
- (id)processedPNGAppIconDataForData:(id)a0 ofType:(id)a1 size:(struct CGSize { double x0; double x1; })a2 scale:(double)a3;
- (void)queueThumbnailRequest:(id)a0 tryCache:(char)a1 tryAdditionsFirst:(char)a2;
- (void)sendResultForThumbnailRequest:(id)a0 images:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 iconFlavor:(int)a4 thumbnailRepresentation:(long long)a5 clientShouldTakeOwnership:(char)a6 reenqueueRequest:(char)a7 error:(id)a8;
