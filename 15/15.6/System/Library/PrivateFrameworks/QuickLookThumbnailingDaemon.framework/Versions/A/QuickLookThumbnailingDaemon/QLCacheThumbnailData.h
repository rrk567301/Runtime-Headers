...
@property (readonly, nonatomic) char iconMode;
...
- (char)setState:(unsigned long long)a0;
- (id)initWithCacheId:(unsigned long long)a0 fileIdentifier:(id)a1 version:(id)a2 size:(float)a3 iconMode:(char)a4 iconVariant:(long long)a5 interpolationQuality:(int)a6 badgeType:(unsigned long long)a7 externalGeneratorDataHash:(unsigned long long)a8 hitCount:(unsigned long long)a9 lastHitDate:(id)a10;
- (id)initWithCacheId:(unsigned long long)a0 fileIdentifier:(id)a1 version:(id)a2 size:(float)a3 iconMode:(char)a4 iconVariant:(long long)a5 interpolationQuality:(int)a6 hitCount:(unsigned long long)a7 lastHitDate:(id)a8 bitmapFormat:(id)a9 bitmapData:(id)a10 metadata:(id)a11 flavor:(int)a12 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a13 badgeType:(unsigned long long)a14 externalGeneratorDataHash:(unsigned long long)a15;
...
- (char)setState:(unsigned long long)a0 changedState:(char *)a1;
