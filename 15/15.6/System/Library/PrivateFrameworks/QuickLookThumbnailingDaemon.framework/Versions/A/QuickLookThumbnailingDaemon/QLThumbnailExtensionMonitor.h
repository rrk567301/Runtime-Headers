...
- (id)bestExtensionFor:(id)a0 shouldUseRestrictedExtension:(char)a1 matching:(long long)a2;
- (char)canGenerateThumbnailWith:(id)a0 at:(struct CGSize { double x0; double x1; })a1;
