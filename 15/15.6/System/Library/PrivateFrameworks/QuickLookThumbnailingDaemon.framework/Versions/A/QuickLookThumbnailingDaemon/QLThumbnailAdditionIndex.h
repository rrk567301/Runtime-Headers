...
+ (void)setUpCleanupXPCActivitySynchronously:(char)a0;
...
- (id)initForTesting;
- (id)allEntries;
- (void)hasThumbnailForURLWrapper:(id)a0 updateLastHitDate:(char)a1 andSize:(unsigned long long)a2 completion:(id /* block */)a3;
...
- (char)removeDatabaseAtURL:(id)a0 error:(id *)a1;
...
- (char)addThumbnailForURL:(id)a0 lastHitDate:(id)a1 size:(unsigned long long)a2;
- (char)addThumbnailForURL:(id)a0 size:(unsigned long long)a1;
...
- (char)dispatchSyncOnDatabaseQueue:(id /* block */)a0;
- (id)entriesEnumerator;
- (void)enumerateCacheEntriesWithHandler:(id /* block */)a0;
- (char)hasThumbnailForURL:(id)a0 updateLastHitDate:(char)a1 andSize:(unsigned long long)a2;
...
- (char)removeThumbnailForURL:(id)a0;
- (void)setUpDatabase:(id)a0;
- (char)updateFileSize:(unsigned long long)a0 ofThumbnailForURL:(id)a1;
- (char)updateLastHitDate:(id)a0 ofThumbnailForURL:(id)a1;
