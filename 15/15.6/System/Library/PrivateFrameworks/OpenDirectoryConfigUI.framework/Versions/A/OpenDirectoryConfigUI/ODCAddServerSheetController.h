...
@property char isForcedJoin;
@property char showODInstructionsLabel;
@property (retain) NSData *certificateData;
@property char trustCACert;
...
- (void)getInfoForEnteredServer:(char)a0;
- (void)getInfoForEnteredServerTimer:(id)a0;
- (void)handleOtherActionError:(id)a0;
- (id)initWithMainWindow:(id)a0 authView:(id)a1 allowADBinding:(char)a2 parentController:(id)a3;
- (id)odClientCompID;
