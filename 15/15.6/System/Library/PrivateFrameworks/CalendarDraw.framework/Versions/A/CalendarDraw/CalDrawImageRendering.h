...
+ (id)imageForSymbolName:(id)a0 style:(long long)a1 foregroundColor:(id)a2 backgroundColor:(id)a3 selected:(char)a4 pointSize:(double)a5;
...
+ (double)backGroundAlphaDark:(char)a0;
+ (double)backgroundAlphaForCalendarColor:(id)a0 darkBackground:(char)a1;
+ (id)backgroundColorForColor:(id)a0 opaque:(char)a1 isDark:(char)a2;
