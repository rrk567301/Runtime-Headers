...
- (char)_nts_getValidatedDomain:(id *)a0 idnaDomain:(id *)a1 avoidReparse:(char)a2;
- (char)_nts_getValidatedLocalPart:(id *)a0 domain:(id *)a1 idnaDomain:(id *)a2 displayName:(id *)a3;
- (char)_nts_isValid;
