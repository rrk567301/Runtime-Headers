...
+ (id)encryptedDataFromContentData:(id)a0 senderCertificate:(struct __SecCertificate { } *)a1 senderCapabilities:(id)a2 recipients:(id)a3 outIsAuthenticated:(char *)a4 outError:(id *)a5;
+ (id)oidsForEncryptWithGCM:(char)a0 encryptSubject:(char)a1;
