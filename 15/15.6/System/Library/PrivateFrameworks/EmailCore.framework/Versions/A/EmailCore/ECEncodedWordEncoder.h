...
- (char)_getBytesWithoutSplittingComposedCharacters:(void *)a0 targetQEncodedTextLength:(unsigned long long)a1 usedLength:(unsigned long long *)a2 splitComposedCharacterSequence:(char *)a3 usedQEncodedTextLength:(unsigned long long *)a4 extraLength:(unsigned long long *)a5 extraQEncodedTextLength:(unsigned long long *)a6 fromString:(id)a7 stringEncoding:(unsigned long long)a8 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a9 remainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a10;
