...
@property (nonatomic) char shouldIncludeDisplayName;
...
- (id)_stringFromEmailAddress:(id)a0 includeDisplayName:(char)a1;
- (id)_stringFromEmailAddressConvertible:(id)a0 includeDisplayName:(char)a1;
- (id)_stringFromEmailAddressList:(id)a0 includeDisplayName:(char)a1;
- (id)_stringFromGroupEmailAddress:(id)a0;
- (id)_stringFromMailboxAddress:(id)a0 includeDisplayName:(char)a1;
