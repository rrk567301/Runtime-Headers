...
+ (char)_indicatorDataHasValidSVGProfile:(id)a0;
+ (id)_locationFromLocationHeader:(id)a0 evidenceLocation:(id *)a1;
+ (id)_locationFromScanner:(id)a0 evidenceLocation:(id *)a1;
+ (id)_scanToNextTagForScanner:(id)a0 allowSemicolonSeparator:(char)a1 value:(id *)a2;
+ (id)_scanToNextTagForScanner:(id)a0 url:(id *)a1;
+ (char)_versionIsValidWithScanner:(id)a0;
