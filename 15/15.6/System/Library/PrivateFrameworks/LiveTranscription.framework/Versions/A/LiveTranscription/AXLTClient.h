...
- (char)startTranscribing:(long long)a0 client:(id)a1 callbackBlock:(id /* block */)a2 error:(id *)a3;
- (char)startTranscribing:(long long)a0 targetPID:(int)a1 client:(id)a2 callbackBlock:(id /* block */)a3 error:(id *)a4;
- (char)stopTranscribing:(long long)a0 client:(id)a1 error:(id *)a2;
- (char)stopTranscribing:(long long)a0 targetPID:(int)a1 client:(id)a2 error:(id *)a3;
