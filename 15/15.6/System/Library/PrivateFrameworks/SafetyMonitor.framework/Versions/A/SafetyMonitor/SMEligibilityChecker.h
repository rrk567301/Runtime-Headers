@class IDSIDQueryController, NSString, NSObject, IDSService;
...
- (char)checkRecipientAccountIsUnique:(id)a0;
- (id)initWithQueue:(id)a0 IDSIDQueryController:(id)a1 iMessageIDSService:(id)a2 iCloudIDSService:(id)a3;
