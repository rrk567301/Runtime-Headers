...
@property (nonatomic) char cloudkitShareZoneCleanedUpSuccessfully;
...
@property (nonatomic) char wasCacheReleased;
@property (nonatomic) char wasScheduledSendTriggered;
@property (nonatomic) char lockState;
