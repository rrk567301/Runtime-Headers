...
@property (readonly, nonatomic) char isResumedSessionState;
...
- (id)initWithIdentifier:(id)a0 sessionIdentifier:(id)a1 location:(id)a2 activityType:(unsigned long long)a3 locationType:(long long)a4 swimmingLocationType:(long long)a5 sessionState:(unsigned long long)a6 isResumedSessionState:(char)a7 date:(id)a8;
