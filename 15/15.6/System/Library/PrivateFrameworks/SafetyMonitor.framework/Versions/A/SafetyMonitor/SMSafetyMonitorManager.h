...
- (char)shouldDropMessage:(id)a0 from:(id)a1 fromMe:(char)a2;
...
- (id)_proxyForServicingSelector:(SEL)a0 asynchronous:(char)a1 withErrorHandler:(id /* block */)a2;
...
- (void)processStateForHeartbeat:(id)a0 forActiveDevice:(char)a1 withError:(id)a2;
