...
@property (readonly, nonatomic) char isSOSTrigger;
...
- (id)initWithSessionID:(id)a0 triggerDate:(id)a1 locationOfTrigger:(id)a2 triggerType:(unsigned long long)a3 safetyCacheKey:(id)a4 safetyCacheToken:(id)a5 sessionType:(unsigned long long)a6 destinationType:(unsigned long long)a7 isSOSTrigger:(char)a8 lowPowerModeWarningState:(long long)a9;
- (id)outputToDictionary;
- (id)summaryText;
- (id)initWithDate:(id)a0 messageID:(id)a1 sessionID:(id)a2 triggerDate:(id)a3 locationOfTrigger:(id)a4 triggerType:(unsigned long long)a5 safetyCacheKey:(id)a6 safetyCacheToken:(id)a7 sessionType:(unsigned long long)a8 destinationType:(unsigned long long)a9 isSOSTrigger:(char)a10 lowPowerModeWarningState:(long long)a11;
