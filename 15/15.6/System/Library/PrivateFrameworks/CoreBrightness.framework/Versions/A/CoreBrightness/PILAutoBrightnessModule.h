...
- (char)isPILBrightnessRamping;
- (id)newStatusInfo;
- (char)rampPILBrightness:(float)a0 withLength:(float)a1 properties:(id)a2;
- (BOOL)removeHIDServiceClient:(struct __IOHIDServiceClient { } *)a0;
- (char)requestPILBrightnessTransitionStop;
- (void)sendNotificationForKey:(id)a0 withValue:(id)a1;
- (void)setManualBrightness:(float)a0 periodOverride:(char)a1 period:(float)a2 properties:(id)a3;
