...
- (void)sanityCheck;
- (char)shouldUpdateEDRForRequestedHeadroom:(float)a0 targetHeadroom:(float *)a1;
- (char)shouldUpdateEDRForRequestedHeadroom:(float)a0 targetHeadroom:(float *)a1 rampTime:(double *)a2;
- (char)shouldUpdateEDRForRequestedHeadroom:(float)a0 targetHeadroom:(float *)a1 rampTime:(double *)a2 durationPerStop:(float)a3;
