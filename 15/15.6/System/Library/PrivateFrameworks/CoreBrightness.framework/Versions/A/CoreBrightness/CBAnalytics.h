...
+ (void)nightShiftSunSchedulePermitted:(char)a0;
...
+ (void)autoBrightnessEnabled:(char)a0 byUser:(char)a1;
+ (void)autoBrightnessUserChange:(char)a0 lowPower:(char)a1;
...
+ (void)harmonyEnabled:(char)a0 byUser:(char)a1;
+ (void)hdrSession:(char)a0;
+ (void)illuminanceHistogram:(id)a0;
+ (void)luminanceHistogram:(id)a0 withName:(id)a1;
+ (void)nightShiftCCT:(long long)a0;
+ (void)nightShiftEnabled:(char)a0 withOption:(int)a1;
...
+ (void)sendBool:(id)a0 withField:(const char *)a1 andValue:(char)a2;
