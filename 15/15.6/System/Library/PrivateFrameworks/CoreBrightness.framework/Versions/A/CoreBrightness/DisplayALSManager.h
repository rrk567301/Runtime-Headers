...
- (void)setAutoBrightnessEnabled:(char)a0;
...
- (char)updateDynamicSlider:(float)a0;
- (void)updateDynamicSliderConfiguration:(id)a0;
- (char)updateDynamicSliderState:(char)a0 battery:(char)a1;
- (char)updateDynamicSliderWithLux:(float)a0 force:(char)a1;
