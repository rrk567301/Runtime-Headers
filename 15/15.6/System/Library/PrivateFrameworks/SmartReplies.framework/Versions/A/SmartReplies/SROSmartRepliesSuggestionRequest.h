...
@property (nonatomic) char includeLowConfidenceSuggestions;
@property (nonatomic) char skipPopulatingMetadata;
@property (copy, nonatomic) NSString *context;
@property (copy, nonatomic) NSString *languageCode;
@property (copy, nonatomic) NSDate *languageLastChangedDate;
@property (nonatomic) char includesDynamicSuggestions;
