...
+ (char)verifyHMACWithPermanentInfoData:(id)a0 permanentInfoSig:(id)a1 stableInfoData:(id)a2 stableInfoSig:(id)a3 dynamicInfoData:(id)a4 dynamicInfoSig:(id)a5 hmacKey:(id)a6 hmacSig:(id)a7;
...
- (id)initWithPermanentInfo:(id)a0 stableInfo:(id)a1 dynamicInfo:(id)a2 checkSig:(char)a3 error:(id *)a4;
