...
@property (nonatomic) char isGestureEvent;
@property (nonatomic) char isDockControl;
@property (nonatomic) char isFluidTouchGesture;
...
@property (nonatomic) char symbolicHotKeyTreatAsKeyDown;

+ (char)isGestureEvent:(struct __CGEvent { } *)a0;
