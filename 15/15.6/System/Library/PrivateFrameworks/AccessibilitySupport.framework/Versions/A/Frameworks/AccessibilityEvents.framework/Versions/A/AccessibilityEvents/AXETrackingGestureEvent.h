...
- (id)initWithNSEvent:(id)a0 eventSource:(unsigned long long)a1 isSynthetic:(char)a2 previousGestureEvent:(id)a3;
- (id)initWithTouches:(id)a0 eventSource:(unsigned long long)a1 isSynthetic:(char)a2;
- (id)initWithTouches:(id)a0 eventSource:(unsigned long long)a1 isSynthetic:(char)a2 previousGestureEvent:(id)a3;
