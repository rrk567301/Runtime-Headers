...
+ (char)marker:(id)a0 precedesMarker:(id)a1 uiElement:(id)a2;
+ (char)marker:(id)a0 precedesOrEqualsMarker:(id)a1 uiElement:(id)a2;
...
- (char)isCompatibleWithMarker:(id)a0;
- (char)isValidForUIElement:(id)a0;
- (char)isVisuallyEquivalentToTextMarker:(id)a0 uiElement:(id)a1;
