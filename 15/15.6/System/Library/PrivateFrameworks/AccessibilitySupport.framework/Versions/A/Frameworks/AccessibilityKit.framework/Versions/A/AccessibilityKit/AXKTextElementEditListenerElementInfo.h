...
@property (nonatomic) char hasActiveInlineSession;
@property (nonatomic) char isPreFetchInfo;
@property (nonatomic) char isLastLineNewLine;
...
@property (nonatomic) char isPasswordField;
