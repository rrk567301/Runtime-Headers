...
@property (nonatomic) char hasHighlightOutline;
...
@property (nonatomic) char screenShotWhileScaled;
@property (nonatomic) char centeredInMainScreen;
...
- (char)_isValidHighlightFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (char)_setBoundingFrameFromShape:(struct _CGSBoundingShape { } *)a0;
