...
@property (readonly, nonatomic) char _isCurrentIndexAtStartOfWord;
@property (readonly, nonatomic) char _isCurrentIndexAtEndOfWord;
@property (nonatomic) long long _wordTokenizerUnit;
@property (nonatomic) char _hasCustomWordTokenizer;
...
+ (char)_shouldExtendCandidateWord:(id)a0 withSuffix:(id)a1;
