...
@property (nonatomic, setter=_setInResizeMode:) char _inResizeMode;
...
@property (nonatomic) char showBorder;
...
+ (char)_draggingAllowedForMouseOverRegion:(unsigned long long)a0 allowedResizeTargets:(unsigned long long)a1;
...
+ (int)_mouseCursorTypeForMouseOverRegion:(unsigned long long)a0 mouseButtonDown:(char)a1;
