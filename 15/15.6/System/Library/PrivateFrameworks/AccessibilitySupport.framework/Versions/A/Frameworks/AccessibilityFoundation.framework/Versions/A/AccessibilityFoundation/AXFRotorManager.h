...
@property (nonatomic) char shouldGoUpHierarchy;

- (id)init;
- (void).cxx_destruct;
- (id)_customRotorItemResultsForProvider:(id)a0 withPredicate:(id)a1;
- (id)_customRotorNamesForElement:(id)a0 shouldGoUpHierarchy:(char)a1;
- (id)_customRotorsForElement:(id)a0 shouldGoUpHierarchy:(char)a1;
