...
- (char)_hasLayoutObserverWithKey:(id)a0;
...
- (void)_updateObservers:(char)a0;
- (void)_updateWindow:(id)a0;
- (char)_updateWindowNotificationObservers;
...
- (void)dispatchUpdateWindow:(unsigned int)a0 insert:(char)a1;
