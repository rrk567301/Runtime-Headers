...
- (char)_errorIfInvalidRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (char)containsAnyIndexesInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
