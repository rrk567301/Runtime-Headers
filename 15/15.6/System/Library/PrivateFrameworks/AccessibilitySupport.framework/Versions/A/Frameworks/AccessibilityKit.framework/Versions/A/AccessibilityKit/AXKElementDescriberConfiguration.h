...
@property (nonatomic) char shouldDescribeEmptyElementWithRoleDescription;
...
- (char)isAttributeIncluded:(id)a0;
- (char)isMarkupIncluded:(unsigned long long)a0;
- (char)isRoleDescriptionIncludedForRole:(id)a0;
