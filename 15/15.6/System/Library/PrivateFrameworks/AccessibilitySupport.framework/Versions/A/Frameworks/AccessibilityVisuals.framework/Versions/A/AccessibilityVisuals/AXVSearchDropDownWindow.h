...
@property (nonatomic) char dropDownEnabled;
...
- (char)containsSectionInDropDown:(id)a0;
- (void)hideDropDown;
...
- (id)initWithContentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 dropDownHeight:(double)a1 backing:(unsigned long long)a2 defer:(char)a3;
- (id)initWithContentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 dropDownHeight:(double)a1 backing:(unsigned long long)a2 defer:(char)a3 screen:(id)a4;
