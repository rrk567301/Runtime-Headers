...
@property (nonatomic) char namesMode;
...
- (id)_findLabeledElementsThatIntersectLabelRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 fromLabeledElement:(id)a1 justLabelRect:(char)a2 additionalElements:(id)a3;
