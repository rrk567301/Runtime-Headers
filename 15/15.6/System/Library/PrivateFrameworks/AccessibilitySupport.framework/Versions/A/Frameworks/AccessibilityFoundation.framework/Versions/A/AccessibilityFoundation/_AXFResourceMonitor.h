...
- (char)_checkResourceExceedLimitForProcess:(id)a0 criteria:(id)a1;
- (id)_processInfoForPID:(int)a0;
- (char)_resourceExceedDuration:(double)a0 criteria:(id)a1;
- (char)_resourceExceedLimitForProcess:(id)a0 criteria:(id)a1;
