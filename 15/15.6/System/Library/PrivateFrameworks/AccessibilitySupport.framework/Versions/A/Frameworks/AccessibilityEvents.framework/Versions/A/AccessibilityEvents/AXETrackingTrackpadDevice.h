...
@property (nonatomic) char _eventCaptureStarted;
...
@property (nonatomic) char swallowAllGestureEvents;
@property (nonatomic) char ignorePalmEevnts;
...
- (char)_isDelegateTrackingEvent:(id)a0;
- (char)_isPalmEventWithRadius:(double)a0;
...
- (char)_shouldProcessUpEvent:(id)a0;
