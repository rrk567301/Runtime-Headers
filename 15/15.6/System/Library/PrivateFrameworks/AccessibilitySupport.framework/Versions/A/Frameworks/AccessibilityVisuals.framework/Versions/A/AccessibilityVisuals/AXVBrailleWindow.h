...
@property (nonatomic, setter=_setBrailleDisplayingAnnouncement:) char _brailleDisplayingAnnouncement;
...
- (char)_brailleMarkers:(id)a0 containsRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (char)_updateStatusCellAlertForPosition:(long long)a0;
