...
@property (nonatomic) char _trackingIndividualScreenCursor;
...
- (id)_screenInScreens:(id)a0 closestToPoint:(struct CGPoint { double x0; double x1; })a1 horizontally:(char)a2;
