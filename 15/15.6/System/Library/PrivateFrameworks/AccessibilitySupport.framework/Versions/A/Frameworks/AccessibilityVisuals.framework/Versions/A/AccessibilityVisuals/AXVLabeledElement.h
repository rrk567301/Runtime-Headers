...
@property (nonatomic) char hasBeenCollected;
@property (nonatomic) unsigned long long desiredArrowOrientation;
@property (retain, nonatomic) id textMarkerRange;

+ (struct CGSize { double x0; double x1; })sizeOfNumberedBadgeForLabel:(id)a0 arrowOrientation:(unsigned long long)a1 useFixedWidthNumerals:(char)a2;
...
- (void)updateLabelRectangleForLabelMode:(unsigned long long)a0 useFixedWidthNumerals:(char)a1;
