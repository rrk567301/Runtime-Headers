...
+ (void)_addElement:(id)a0 atRowIndex:(unsigned long long)a1 inRows:(id)a2 atColumnIndex:(unsigned long long)a3 inColumns:(id)a4 withRowCount:(unsigned long long *)a5 forceSplit:(char)a6 addToTopRow:(char)a7;
...
+ (char)_shouldElementBeIgnoredInNavigationMap:(id)a0;
+ (id)orderingForChildrenInBothDirections:(id)a0;
+ (char)shouldElementBeIgnoredInNavigationMap:(id)a0;
