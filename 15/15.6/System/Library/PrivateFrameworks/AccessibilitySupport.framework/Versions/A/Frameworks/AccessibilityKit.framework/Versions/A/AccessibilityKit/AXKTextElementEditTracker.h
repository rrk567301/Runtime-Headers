...
@property (nonatomic) char _isEditable;
...
@property (nonatomic) char _singleLineMode;
...
+ (char)_isCurrentLineNewLine:(id)a0 textElement:(id)a1;
+ (id)_lineRangeForElement:(id)a0 centeredAroundLine:(long long)a1 numberOfLines:(long long)a2;
+ (id)_rangeForElement:(id)a0 centerAroundRange:(id)a1 withNumberOfLines:(long long)a2 shouldTrimNewline:(char)a3;
...
+ (id)_textElement:(id)a0 attributedStringForRange:(id)a1 shouldTrimNewline:(char)a2 withElementInfo:(id)a3;
...
+ (char)isEditableTextElement:(id)a0;
+ (char)isEditableTextUIElement:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (void)registerListener:(id)a0;
- (id)_characterAfterSelectionForElement:(id)a0 elementInfo:(id)a1;
- (id)_completedWordForElement:(id)a0 info:(id)a1 requireWordDelimiter:(char)a2;
...
- (char)_findListener:(id)a0 inListeners:(id)a1;
...
- (char)_shouldRegisterNotificationsFromApplication:(id)a0;
- (char)_shouldSignalForElement:(id)a0;
- (void)_signalDelegatesInfoChangedForElement:(id)a0 infoBeforeChange:(id)a1 infoAfterChange:(id)a2;
- (void)_signalForElement:(id)a0 cursorTraversedString:(id)a1 selectionRange:(id)a2 editTracker:(id)a3 isEditable:(char)a4;
- (void)_signalForElement:(id)a0 selectionChanged:(id)a1 selectionRange:(id)a2 editTracker:(id)a3 isEditable:(char)a4;
- (void)_signalForElement:(id)a0 stringDeleted:(id)a1 differenceFromPreviousString:(id)a2 wasSelected:(char)a3 editTracker:(id)a4;
- (void)_signalForElement:(id)a0 stringDeleted:(id)a1 wasSelected:(char)a2 editTracker:(id)a3;
