...
- (void).cxx_destruct;
- (void)registerListener:(id)a0 listenOnly:(char)a1 forEventMask:(unsigned long long)a2;
- (void)unregisterListener:(id)a0 listenOnly:(char)a1 forEventMask:(unsigned long long)a2;
- (void)registerMouseEventListener:(id)a0 listenOnly:(char)a1;
- (void)unregisterMouseEventListener:(id)a0 listenOnly:(char)a1;
- (void)unregisterListenerForAllEvents:(id)a0;
- (id)_createEventTapWithEventsOfInterest:(unsigned long long)a0 listenOnly:(char)a1;
...
- (void)_recreateEventTapAsNeededForListenerWrappers:(id)a0 listenOnly:(char)a1;
- (void)_unregisterListener:(void *)a0 listenOnly:(char)a1 forEventMask:(unsigned long long)a2;
...
- (void)registerGestureEventListener:(id)a0 listenOnly:(char)a1;
- (void)registerKeyboardEventListener:(id)a0 listenOnly:(char)a1;
- (void)unregisterGestureEventListener:(id)a0 listenOnly:(char)a1;
- (void)unregisterKeyboardEventListener:(id)a0 listenOnly:(char)a1;
