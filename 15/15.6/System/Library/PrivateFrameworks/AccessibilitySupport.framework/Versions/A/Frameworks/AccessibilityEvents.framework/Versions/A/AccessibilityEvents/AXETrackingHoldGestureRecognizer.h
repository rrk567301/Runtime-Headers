...
@property (readonly, nonatomic) char allowInstabilityBeforeHold;
...
- (id)initWithFingerCount:(unsigned long long)a0 preHoldTapCount:(unsigned long long)a1 maximumHoldDeviation:(double)a2 minimumHoldDuration:(double)a3 minimumPreStabilizationDuration:(double)a4 allowInstabilityBeforeHold:(char)a5;
...
- (id)initWithPreHoldTapCount:(unsigned long long)a0 maximumHoldDeviation:(double)a1 minimumHoldDuration:(double)a2 minimumPreStabilizationDuration:(double)a3 allowInstabilityBeforeHold:(char)a4;
