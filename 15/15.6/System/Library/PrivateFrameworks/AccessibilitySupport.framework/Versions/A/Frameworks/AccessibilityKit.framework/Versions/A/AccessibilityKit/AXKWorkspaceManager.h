...
@property (nonatomic) char enableThreadingAssertions;
@property (nonatomic) char trackOpenedMenus;
@property (nonatomic) char trackFocusedElement;
@property (nonatomic) char trackFocusedWindow;
...
- (char)_updateCacheWithApplicationElements:(id)a0 applicationControllers:(id)a1;
...
- (char)setApplicationControllerForTests:(id)a0 forApplicationElement:(id)a1;
