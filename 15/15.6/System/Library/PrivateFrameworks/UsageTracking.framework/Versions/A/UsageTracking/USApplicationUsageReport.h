...
@property (readonly) char applicationUsageTrusted;
...
- (void)_usApplicationUsageReportCommonInitWithCanonicalBundleIdentifier:(id)a0 applicationUsageTrusted:(char)a1 totalUsageTime:(double)a2 applicationUsageByBundleIdentifier:(id)a3 webUsageByDomain:(id)a4 userNotificationsByBundleIdentifier:(id)a5 pickupsByBundleIdentifier:(id)a6;
- (id)initWithBundleIdentifier:(id)a0 totalUsageTime:(double)a1 applicationUsageTime:(double)a2 webUsageByDomain:(id)a3;
- (id)initWithCanonicalBundleIdentifier:(id)a0 applicationUsageTrusted:(char)a1 totalUsageTime:(double)a2 applicationUsageByBundleIdentifier:(id)a3 webUsageByDomain:(id)a4 userNotificationsByBundleIdentifier:(id)a5 pickupsByBundleIdentifier:(id)a6;
