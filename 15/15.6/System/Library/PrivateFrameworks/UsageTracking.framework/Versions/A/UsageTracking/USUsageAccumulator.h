...
@property (getter=isStandByEnabled) char standByEnabled;
@property (getter=isDeviceBacklit) char deviceBacklit;
...
- (void)_accumulateApplication:(id)a0 timestamp:(id)a1 starting:(char)a2 isUsageTrusted:(char)a3;
- (void)_accumulateDeviceBacklight:(id)a0 timestamp:(id)a1;
- (void)_accumulateDeviceBacklightWithIsBacklit:(char)a0 timestamp:(id)a1;
- (void)_accumulateMediaNowPlaying:(id)a0 timestamp:(id)a1;
- (void)_accumulateMediaNowPlayingWithTimestamp:(id)a0 starting:(char)a1;
- (void)_accumulateNotificationUsage:(id)a0;
- (void)_accumulateWebDomain:(id)a0 bundleIdentifier:(id)a1 timestamp:(id)a2 starting:(char)a3 isUsageTrusted:(char)a4;
