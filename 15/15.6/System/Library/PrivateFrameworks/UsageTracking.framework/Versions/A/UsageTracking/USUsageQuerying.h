@class _DKKnowledgeStore, BMCoreDuetStream;
@protocol _CDUserContext;

@interface USUsageQuerying : NSObject

@property (class, readonly) _DKKnowledgeStore *userKnowledgeStore;
...
+ (id)_chronologicalPublisherWithOptions:(id)a0 eventStreams:(id)a1;
+ (void)_completion:(id)a0 options:(id)a1;
...
- (id)_computeScreenTime:(char)a0 withEvents:(id)a1 intersectingScreenTimeIntervalsByDevice:(id *)a2 longestSessionByDevice:(id *)a3 timeZoneByDevice:(id)a4 lastEventDateByDevice:(id)a5 partition:(id)a6 referenceDate:(id)a7;
...
- (double)_computeUsageForApplications:(id)a0 webDomains:(id)a1 categories:(id)a2 applicationUsageEvents:(id)a3 webUsageEvents:(id)a4 nowPlayingEvents:(id)a5 videoUsageEvents:(id)a6 categoryByBundleIdentifier:(id)a7 categoryByWebDomain:(id)a8 interval:(id)a9 referenceDate:(id)a10 focalOnly:(char)a11;
- (void)_computeUsageWithDisplayBacklitEvents:(id)a0 applicationUsageEvents:(id)a1 webUsageEvents:(id)a2 nowPlayingEvents:(id)a3 videoUsageEvents:(id)a4 notificationEvents:(id)a5 categoryByBundleIdentifier:(id)a6 categoryByWebDomain:(id)a7 interval:(id)a8 partitionInterval:(double)a9 referenceDate:(id)a10 focalOnly:(char)a11 completionHandler:(id /* block */)a12;
- (id)_computeWebUsageWithEvents:(id)a0 timeZoneByDevice:(id)a1 lastEventDateByDevice:(id)a2 categoryUsageIntervalsByDevice:(id)a3 aggregatedApplicationUsageIntervalsByDevice:(id)a4 aggregatedWebUsageIntervalsByDevice:(id)a5 categoryByWebDomain:(id)a6 partition:(id)a7 referenceDate:(id)a8 focalOnly:(char)a9;
...
- (void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)a0 referenceDate:(id)a1 focalOnly:(char)a2 block:(id /* block */)a3;
- (void)_enumerateCurrentVideoUsageIntervalsDuringInterval:(id)a0 referenceDate:(id)a1 block:(id /* block */)a2;
- (void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)a0 referenceDate:(id)a1 focalOnly:(char)a2 block:(id /* block */)a3;
...
- (id)_getBundleIdentiersFromApplicationUsageEvents:(id)a0 videoUsageEvents:(id)a1 interval:(id)a2 referenceDate:(id)a3 focalOnly:(char)a4;
- (id)_getWebDomainsFromWebUsageEvents:(id)a0 videoUsageEvents:(id)a1 interval:(id)a2 referenceDate:(id)a3 focalOnly:(char)a4;
- (void)_updateApplicationUsageWithInterval:(id)a0 unboundInterval:(id)a1 bundleIdentifier:(id)a2 trustedApplicationUsage:(char)a3 deviceIdentifier:(id)a4 event:(id)a5 applicationUsageIntervalsByDevice:(id)a6 unboundApplicationUsageIntervalsByDevice:(id)a7 categoryUsageIntervalsByDevice:(id)a8 aggregatedApplicationUsageIntervalsByDevice:(id)a9 categoryByBundleIdentifier:(id)a10 timeZoneByDevice:(id)a11 lastEventDateByDevice:(id)a12;
...
- (void)_updateNotificationsWithEvent:(id)a0 bundleIdentifier:(id)a1 trustedNotification:(char)a2 deviceIdentifier:(id)a3 notificationsByDevice:(id)a4 timeZoneByDevice:(id)a5 lastEventDateByDevice:(id)a6;
...
- (void)_updateWebUsageWithInterval:(id)a0 webDomain:(id)a1 trustedWebUsage:(char)a2 deviceIdentifier:(id)a3 event:(id)a4 webUsageIntervalsByDevice:(id)a5 categoryUsageIntervalsByDevice:(id)a6 aggregatedApplicationUsageIntervalsByDevice:(id)a7 aggregatedWebUsageIntervalsByDevice:(id)a8 categoryByWebDomain:(id)a9 timeZoneByDevice:(id)a10 lastEventDateByDevice:(id)a11;
...
- (id)queryForApplications:(id)a0 webDomains:(id)a1 categories:(id)a2 interval:(id)a3 focalOnly:(char)a4 error:(id *)a5;
...
- (void)queryUsageDuringInterval:(id)a0 partitionInterval:(double)a1 focalOnly:(char)a2 completionHandler:(id /* block */)a3;
