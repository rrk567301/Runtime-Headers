...
@property (readonly, nonatomic) char usingStashedContext;
...
- (void)setupWithCompletion:(char)a0 completion:(id /* block */)a1;
- (char)_verifyContext:(void *)a0;
- (char)_createAttribute:(void **)a0 enableStashing:(char *)a1;
- (id)_createContext:(void **)a0 requestStashed:(char *)a1;
...
- (void)_setupNewContext:(char)a0 withCompletion:(id /* block */)a1;
