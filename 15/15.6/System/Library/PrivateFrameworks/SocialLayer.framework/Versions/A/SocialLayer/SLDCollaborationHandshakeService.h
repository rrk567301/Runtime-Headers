...
- (long long)_acquireSandboxHandleData:(id)a0 ForFileProviderDocumentURL:(id)a1 clientConnection:(id)a2 error:(id *)a3;
- (char)_connection:(id)a0 hasPermissionForFileURL:(id)a1;
- (char)_doesMetadata:(id)a0 containAllOf:(id)a1;
- (char)_doesMetadata:(id)a0 containAnyOf:(id)a1;
- (char)_fileURLHasFileProvider:(id)a0 error:(id *)a1;
