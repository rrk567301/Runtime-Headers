...
+ (id)collaboratorsStringForTag:(id)a0 prefixingWith:(char)a1;
...
- (struct CGImage { } *)newAvatarImageForConversationDrawingMetadata:(id)a0 allowSnowglobe:(char)a1 allowMonogram:(char)a2;
- (struct CGImage { } *)newAvatarImageForRecipientDrawingMetadata:(id)a0 allowMonogram:(char)a1;
...
- (char)shouldShowGenericIconIfApplicableForVariant:(long long)a0;
- (char)shouldShowLabels;
- (char)shouldShowMonogramIfApplicableForVariant:(long long)a0;
- (char)shouldShowSnowglobeIfApplicableForVariant:(long long)a0;
- (char)shouldShowSubtitle;
