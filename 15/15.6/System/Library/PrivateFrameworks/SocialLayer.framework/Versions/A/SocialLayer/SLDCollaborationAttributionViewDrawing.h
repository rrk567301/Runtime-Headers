@class UISSlotStyle, NSString, SLDCollaborationAttributionViewSlotTag;

@interface SLDCollaborationAttributionViewDrawing : NSObject <UISDrawing>

@property (retain, nonatomic) UISSlotStyle *slotStyle;
@property (retain, nonatomic) SLDCollaborationAttributionViewSlotTag *tag;
@property (nonatomic) char forRemote;
...
- (id)initWithStyle:(id)a0 tag:(id)a1 forRemote:(char)a2;
