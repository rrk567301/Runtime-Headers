...
@property (nonatomic, readonly) char hasValidMetricsForDrawing;
...
@property (nonatomic, readonly) char useDoubleLinedLabel;
...
@property (nonatomic, readonly) char shouldDisplayPin;
