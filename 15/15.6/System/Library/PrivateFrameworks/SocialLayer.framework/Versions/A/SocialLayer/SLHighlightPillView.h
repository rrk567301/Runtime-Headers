...
@property (nonatomic) char shouldDrawBackgroundBlur;
...
- (id)getContextMenu;
- (id)initWithHighlight:(id)a0 maxWidth:(double)a1 variant:(unsigned long long)a2 shouldDrawBlur:(char)a3;
...
- (char)shouldShowReplyContextMenu;
