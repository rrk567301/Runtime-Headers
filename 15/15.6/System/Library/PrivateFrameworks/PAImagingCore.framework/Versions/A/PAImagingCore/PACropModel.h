...
@property (nonatomic) char isAutoCrop;
...
- (char)canGrowCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 constrainWithAnchorPoint:(struct CGPoint { double x0; double x1; })a1 strict:(char)a2 withTol:(double)a3;
- (unsigned long long)constrainedMoveCropRectBy:(struct CGVector { double x0; double x1; })a0;
- (unsigned long long)constrainedMoveCropRectBy:(struct CGVector { double x0; double x1; })a0 strict:(char)a1;
- (unsigned long long)constrainedMoveCropRectBy:(struct CGVector { double x0; double x1; })a0 strict:(char)a1 startRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
- (char)imageContainsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withTol:(double)a1;
...
- (unsigned long long)setCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 newCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 constrainWithAnchorPoint:(struct CGPoint { double x0; double x1; })a2 strict:(char)a3;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })getCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 newCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 straightenAngle:(double)a2 constrainWithAnchorPoint:(struct CGPoint { double x0; double x1; })a3 strict:(char)a4 hitVertexId:(unsigned long long *)a5;
