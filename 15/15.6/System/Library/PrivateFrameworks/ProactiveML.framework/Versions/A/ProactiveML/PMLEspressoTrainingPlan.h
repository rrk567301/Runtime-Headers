...
+ (id)_calculateTrainingMetricsWithSamplingProb:(double)a0 groundTruthProvider:(id)a1 predictionsProvider:(id)a2 trueLabelName:(id)a3 trainingOutputName:(id)a4 lossValueName:(id)a5 probThreshold:(double)a6 includeSummableOnly:(char)a7;
...
+ (char)isValidGradient:(id)a0 error:(id *)a1;
...
- (char)isEqualToEspressoTrainingPlan:(id)a0;
