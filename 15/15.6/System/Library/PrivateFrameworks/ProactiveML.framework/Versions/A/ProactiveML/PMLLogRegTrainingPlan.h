...
@property (readonly, nonatomic) char useOnlyAppleInternalSessions;
@property (readonly, nonatomic) char isMultiLabel;
@property (readonly, nonatomic) unsigned long long positiveLabel;
@property (readonly, nonatomic) char intercept;
@property (readonly, nonatomic) unsigned long long evaluationLevel;
@property (readonly, nonatomic) char reportScale;
