...
- (id)initWithMaxIterationCount:(int)a0 noiseScaleFactors:(struct { float x0; float x1; })a1 minimumMagnitude:(float)a2 noiseMechanism:(long long)a3 inplaceNorm:(char)a4;
- (id)initWithMaxIterationCount:(int)a0 noiseScaleFactors:(struct { float x0; float x1; })a1 minimumMagnitude:(float)a2 seed:(int)a3 noiseMechanism:(long long)a4 inplaceNorm:(char)a5;
- (struct _PMLPreNoiseScaleFactorAndNoiseSampler { id x0; float x1; })samplerWithScaleFactorFor:(id)a0 usingNorm:(char)a1;
