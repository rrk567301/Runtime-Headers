...
+ (void)sparseVectorWithLength:(unsigned long long)a0 numberOfNonZeroValues:(unsigned long long)a1 isSparseIndexInt64:(char)a2 sparseIndices:(const void *)a3 sparseValues:(const float *)a4 toDenseValues:(float *)a5 withLength:(unsigned long long)a6;
