...
- (id)runParallelPlansWithPlanId:(id)a0 tracker:(id)a1 noiseScaleFactors:(struct { float x0; float x1; })a2 noiseMinimumMagnitude:(float)a3 weights:(id)a4 serverIteration:(unsigned long long)a5 useIntercept:(char)a6 noiseMechanism:(long long)a7 usingRandomlySelected:(unsigned long long)a8;
