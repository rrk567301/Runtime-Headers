...
- (id)initWithPlanId:(id)a0 store:(id)a1 sessionDescriptor:(id)a2 maxSessionsLimit:(unsigned long long)a3 sessionsInBatch:(unsigned long long)a4 labelAndWeights:(id)a5 modelClassName:(id)a6 intercept:(char)a7 evaluationPoints:(id)a8 tracker:(id)a9 evaluationLevel:(unsigned long long)a10;
