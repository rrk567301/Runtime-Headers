...
- (id)initWithStore:(id)a0 tracker:(id)a1 planId:(id)a2 sessionDescriptor:(id)a3 maxSessionsLimit:(unsigned long long)a4 sessionsInBatch:(unsigned long long)a5 currentModelWeights:(id)a6 intercept:(char)a7 skew:(double)a8 threshold:(double)a9 isMultiLabel:(char)a10 positiveLabel:(unsigned long long)a11 evaluationLevel:(unsigned long long)a12;
