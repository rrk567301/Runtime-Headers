...
- (char)intercept;
- (id)toChunk;
- (id)initWithChunk:(id)a0 intercept:(char)a1;
- (id)initWithFloatsNoCopy:(const float *)a0 count:(int)a1 intercept:(char)a2;
- (id)initWithWeights:(id)a0 intercept:(char)a1;
