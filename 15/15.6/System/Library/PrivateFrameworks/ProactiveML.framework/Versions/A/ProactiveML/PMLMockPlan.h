...
@property (readonly, nonatomic) char didRun;
...
- (id)initWithPlanId:(id)a0 store:(id)a1 version:(unsigned long long)a2 returningAfterRunning:(char)a3;
- (id)initWithPlanId:(id)a0 version:(unsigned long long)a1;
- (id)initWithPlanId:(id)a0 version:(unsigned long long)a1 returningAfterRunning:(char)a2;
