...
@property (nonatomic) char intercept;
...
- (id)initWithLearningRate:(float)a0 minIterations:(unsigned long long)a1 stoppingThreshold:(float)a2 weights:(id)a3 intercept:(char)a4 gradientCalculator:(id /* block */)a5 predictionCalculator:(id /* block */)a6 batchPredictionCalculator:(id /* block */)a7;
- (void)solve;
