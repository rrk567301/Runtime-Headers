...
- (char)containsIdentifier:(unsigned long long)a0;
- (const void *)bitmap;
...
- (char)intersectsIdentifierSet:(id)a0;
- (id)initWithBitmap:(const void *)a0;
- (id)prefix:(unsigned long long)a0;
- (char)containsIdentifierSet:(id)a0;
...
- (char)isEqualToElementIdentifierSet:(id)a0;
- (char)isSubsetOfIdentifierSet:(id)a0;
