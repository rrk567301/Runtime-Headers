...
- (char)hasEdgeFromNode:(id)a0;
- (char)hasEdgeTowardNode:(id)a0;
...
- (char)hasEdgeWithLabel:(id)a0 domain:(unsigned short)a1;
- (char)hasEqualPropertiesToNode:(id)a0;
...
- (char)conformsToNodeSchema:(id)a0;
...
- (char)hasEdge:(id)a0 isIn:(char *)a1;
- (char)hasEdgeWithNode:(id)a0;
- (char)isOrphan;
- (char)matchesNode:(id)a0 includingProperties:(char)a1;
- (id)neighborNodes;
...
- (id)shortestPathToNode:(id)a0 directed:(char)a1;
- (id)visualString;
