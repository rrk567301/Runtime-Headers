...
- (void)enumerateIdentifiersSortedByDoublePropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateIdentifiersSortedByIntegerPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateIdentifiersSortedByStringPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateIdentifiersSortedByUnsignedIntegerPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
