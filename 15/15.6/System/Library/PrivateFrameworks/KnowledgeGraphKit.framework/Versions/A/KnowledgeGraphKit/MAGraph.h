@class KGStoredGraph, MAGraphSpecification, NSUUID, NSMutableDictionary, MAGraphReference;
...
@property (readonly, nonatomic) char usesClassADataProtection;
@property (readonly, nonatomic) char usesClassBDataProtection;
@property (readonly, nonatomic) char usesClassCDataProtection;
@property (nonatomic) unsigned long long version;
@property (readonly) MAGraphReference *graphReference;

+ (void)initialize;
+ (id)graph;
+ (char)copyPersistentStoreFromURL:(id)a0 toURL:(id)a1 error:(id *)a2;
+ (id)defaultSpecification;
+ (char)destroyPersistentStoreAtURL:(id)a0 error:(id *)a1;
+ (id)graphWithVisualString:(id)a0 error:(id *)a1;
+ (char)migratePersistentStoreFromURL:(id)a0 toURL:(id)a1 error:(id *)a2;
...
+ (id)graphWithMergedGraphs:(id)a0 strictNodes:(char)a1 strictEdges:(char)a2;
+ (id)persistentStoreFileExtension;
+ (char)populateGraph:(id)a0 withDefinitions:(id)a1 constraints:(id)a2 error:(id *)a3;
+ (id)scanGraphConstraintString:(id)a0 error:(id *)a1;
+ (char)scanGraphElementOptionsString:(id)a0 minimum:(unsigned long long *)a1 maximum:(unsigned long long *)a2 error:(id *)a3;
+ (char)scanGraphElementString:(id)a0 type:(unsigned long long *)a1 optionalName:(id *)a2 label:(id *)a3 optionalDomains:(id *)a4 optionalProperties:(id *)a5 error:(id *)a6;
+ (char)scanMatchString:(id)a0 definitions:(id *)a1 constraints:(id *)a2 forCreation:(char)a3 error:(id *)a4;
...
- (char)copyPersistentStoreToURL:(id)a0 error:(id *)a1;
...
- (void)addUniqueNode:(id)a0 didInsert:(char *)a1;
- (id)addUniqueNodeWithLabel:(id)a0 domain:(unsigned short)a1 weight:(float)a2 properties:(id)a3 didCreate:(char *)a4;
- (id)addUniquelyIdentifiedNodeWithLabel:(id)a0 domain:(unsigned short)a1 weight:(float)a2 properties:(id)a3 didCreate:(char *)a4;
...
- (char)findAndResolveUniqueEdge:(id)a0;
- (char)findAndResolveUniqueNode:(id)a0;
- (id)initWithPersistentStoreURL:(id)a0 options:(long long)a1 error:(id *)a2;
- (void)leaveBatch;
...
- (void)persistModelProperties:(id)a0 forEdgeWithIdentifier:(unsigned long long)a1 clobberExisting:(char)a2;
- (void)persistModelProperties:(id)a0 forNodeWithIdentifier:(unsigned long long)a1 clobberExisting:(char)a2;
...
- (char)writeDataToURL:(id)a0 error:(id *)a1;
...
- (char)_matchNode:(id)a0 usingAbstractNode:(id)a1 fromEdge:(id)a2 atIteration:(unsigned long long)a3 withDefinitions:(id)a4 constraints:(id)a5 unusedConstraints:(id)a6 andSubGraph:(id)a7 matchingNodeQueue:(id)a8;
...
- (void)breadthFirstSearchFromNode:(id)a0 directed:(char)a1 usingBlock:(id /* block */)a2;
- (char)compareWithPersistedState;
- (char)conformsToGraphSchema:(id)a0;
- (void)depthFirstSearchFromNode:(id)a0 directed:(char)a1 usingBlock:(id /* block */)a2;
...
- (void)enumerateNodeIdentifiers:(id)a0 sortedByDoublePropertyForName:(id)a1 ascending:(char)a2 usingBlock:(id /* block */)a3;
- (void)enumerateNodeIdentifiers:(id)a0 sortedByIntegerPropertyForName:(id)a1 ascending:(char)a2 usingBlock:(id /* block */)a3;
- (void)enumerateNodeIdentifiers:(id)a0 sortedByStringPropertyForName:(id)a1 ascending:(char)a2 usingBlock:(id /* block */)a3;
- (void)enumerateNodeIdentifiers:(id)a0 sortedByUnsignedIntegerPropertyForName:(id)a1 ascending:(char)a2 usingBlock:(id /* block */)a3;
...
- (void)enumerateUnsignedLongLongPropertyValuesForKey:(id)a0 ofEdgesWithIdentifiers:(id)a1 usingBlock:(id /* block */)a2;
- (void)enumerateUnsignedLongLongPropertyValuesForKey:(id)a0 ofNodesWithIdentifiers:(id)a1 usingBlock:(id /* block */)a2;
- (id)graphNode;
- (char)hasPendingRead;
- (id)initWithDataURL:(id)a0 error:(id *)a1;
...
- (id)mergeWithGraph:(id)a0 strictNodes:(char)a1 strictEdges:(char)a2;
- (void)mergeWithGraph:(id)a0 strictNodes:(char)a1 strictEdges:(char)a2 createdNodes:(out id *)a3 createdEdges:(out id *)a4;
- (id)mergeWithGraph:(id)a0 strictNodes:(char)a1 strictEdges:(char)a2 saveToDatabase:(char)a3;
- (void)mergeWithGraph:(id)a0 strictNodes:(char)a1 strictEdges:(char)a2 saveToDatabase:(char)a3 createdNodes:(out id *)a4 createdEdges:(out id *)a5;
- (char)migratePersistentStoreToURL:(id)a0 error:(id *)a1;
...
- (id)shortestPathFromNode:(id)a0 toNode:(id)a1 directed:(char)a2;
...
- (char)updateGraphWithVisualString:(id)a0;
- (void)waitUntilQuiescentUsingBlock:(id /* block */)a0;
- (char)writeGraphJSONToURL:(id)a0 error:(id *)a1;
- (char)writeGraphMLToURL:(id)a0 error:(id *)a1;
