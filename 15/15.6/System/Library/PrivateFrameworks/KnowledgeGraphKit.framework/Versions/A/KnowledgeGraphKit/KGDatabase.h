...
+ (void)initialize;
+ (char)emptyDatabaseExistsAtURL:(id)a0 error:(id *)a1;
...
- (char)appendNodeIdentifiersOfEdgesWithIdentifiers:(id)a0 sourceNodeIdentifiers:(id)a1 targetNodeIdentifiers:(id)a2 error:(id *)a3;
...
- (id)edgeIdentifiersSortedByPropertyForName:(id)a0 dataType:(long long)a1 ascending:(char)a2 limit:(long long)a3 edgeIdentifiers:(id)a4 error:(id *)a5;
...
- (id)intersectionOfEdgesForEdgeTable:(const void *)a0 withLabels:(id)a1 filterEdgeIdentifiers:(id)a2 overrideIndex:(char)a3 error:(id *)a4;
...
- (id)intersectionOfNodesForNodeTable:(const void *)a0 withLabels:(id)a1 filterNodeIdentifiers:(id)a2 overrideIndex:(char)a3 error:(id *)a4;
...
- (char)labelIdentifiers:(void *)a0 forLabels:(id)a1 foundAll:(char *)a2 error:(id *)a3;
...
- (id)nodeIdentifiersSortedByPropertyForName:(id)a0 dataType:(long long)a1 ascending:(char)a2 limit:(long long)a3 nodeIdentifiers:(id)a4 error:(id *)a5;
...
- (char)removeEdge:(unsigned long long)a0 error:(id *)a1;
- (char)removeEdges:(id)a0 error:(id *)a1;
- (char)removeNode:(unsigned long long)a0 error:(id *)a1;
- (char)removeNodes:(id)a0 error:(id *)a1;
- (id)reportLabelIdentifiersByName;
- (id)reportLabelNamesByIdentifier;
- (char)setEdgeProperties:(id)a0 forIdentifier:(unsigned long long)a1 error:(id *)a2;
- (char)setNodeProperties:(id)a0 forIdentifier:(unsigned long long)a1 error:(id *)a2;
...
- (struct Bitmap { unsigned long long x0; unsigned long long x1; struct vector<degas::BitsetPtr, std::allocator<degas::BitsetPtr>> { struct BitsetPtr *x0; struct BitsetPtr *x1; struct __compressed_pair<degas::BitsetPtr *, std::allocator<degas::BitsetPtr>> { struct BitsetPtr *x0; } x2; } x2; BOOL x3; })upsertLabels:(id)a0 error:(id *)a1;
- (char)validateLabelReferencesWithError:(id *)a0;
