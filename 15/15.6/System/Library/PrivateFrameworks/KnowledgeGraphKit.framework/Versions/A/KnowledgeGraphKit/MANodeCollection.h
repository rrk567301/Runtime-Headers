...
- (void)enumerateNodesAsCollectionsSortedByDoublePropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
...
- (void)enumerateNodesAsCollectionsSortedByIntegerPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateNodesAsCollectionsSortedByStringPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
- (void)enumerateNodesAsCollectionsSortedByUnsignedIntegerPropertyForName:(id)a0 ascending:(char)a1 usingBlock:(id /* block */)a2;
