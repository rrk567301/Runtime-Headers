...
@property (readonly) char isDirected;
...
- (id)initWithLabel:(id)a0 sourceNode:(id)a1 targetNode:(id)a2 domain:(unsigned short)a3 weight:(float)a4 minimum:(unsigned long long)a5 maximum:(unsigned long long)a6 directed:(char)a7;
