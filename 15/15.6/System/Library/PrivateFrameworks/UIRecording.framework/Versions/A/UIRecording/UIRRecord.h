...
@property (nonatomic) char isPlayingBack;
@property (copy) NSDictionary *playbackErrorInfo;
@property char userCanceledPlayback;
...
- (void)addEvent:(id)a0;
- (void)stopPlayback;
- (void)playbackRecordingWithTimeout:(double)a0 forEachEvent:(char)a1 targetingPSN:(struct ProcessSerialNumber { unsigned int x0; unsigned int x1; })a2;
