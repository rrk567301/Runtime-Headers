...
@property (nonatomic) char avoidsEmptySelection;
@property (nonatomic) char loopsSelection;
@property (readonly, nonatomic) char canSelectNext;
@property (readonly, nonatomic) char canSelectPrevious;
@property (readonly, nonatomic, getter=isUserEditable) char userEditable;
