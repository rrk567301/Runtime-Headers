...
- (void)dealloc;
- (void).cxx_destruct;
- (void)finishWithSuccess:(char)a0 error:(id)a1;
- (void)removeObservers;
- (void)cloudKitEventNotificationManager:(id)a0 didPerformAdditionalStorageRequiredCheck:(char)a1 additionalStorageRequired:(unsigned long long)a2 forAccountId:(id)a3 error:(id)a4;
- (void)addObservers;
