...
@property char suspendAllListeners;
@property char oneTimeFire;
@property double customInterval;
@property char changesOccuredDuringBatch;
...
- (void)_createTimerWithInterval:(double)a0 custom:(char)a1;
...
- (void)_resumeActiveTimersAndFireTimerImmediately:(char)a0;
- (void)_resumeTimersForGroup:(id)a0 fireTimerImmediately:(char)a1;
