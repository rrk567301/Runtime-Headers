...
@property (readonly, nonatomic) char _registered;
...
@property (readonly, nonatomic) char isInAddressBook;
...
@property (readonly, nonatomic) char isCompany;
...
+ (void)_setCachedQueriesEnabled:(char)a0;
+ (id)existingABPeopleWithInstantMessageAddress:(id)a0 onServices:(id)a1 allowSubstringMatch:(char)a2;
...
+ (id)existingABPersonWithInstantMessageAddress:(id)a0 onServices:(id)a1 allowSubstringMatch:(char)a2;
+ (id)personWithABPerson:(id)a0;
+ (char)shouldPurgeCacheForIMPerson:(id)a0;
...
- (char)containsHandle:(id)a0 forServiceProperty:(id)a1;
- (id)emailHandlesForService:(id)a0;
- (id)emailHandlesForService:(id)a0 includeBaseEmail:(char)a1;
- (id)initWithABPerson:(id)a0;
- (char)isEqualToIMPerson:(id)a0;
