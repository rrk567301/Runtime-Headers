...
@property (nonatomic) char shouldRestoreSelection;
...
@property (readonly, nonatomic) char isSelectionValid;
@property (readonly, nonatomic) EMMailbox *predictedMoveMailbox;
@property (nonatomic, getter=isMultipleSelectionActive) char multipleSelectionActive;
@property (readonly, nonatomic) NSMutableSet *itemsToDeselectAfterMultipleSelection;
@property (nonatomic, getter=isPerformingDataSourceUpdates) char performingDataSourceUpdates;
...
- (char)_allChildrenSelected:(id)a0;
- (void)_scheduleMailboxPredictionUpdate;
- (char)_trackItemIDs:(id)a0 updateCount:(char)a1;
- (void)_untrackAllItemIDs;
- (char)_untrackItemIDs:(id)a0 updateCount:(char)a1;
- (id)cascadedItemIDsForItemID:(id)a0 isSelecting:(char)a1;
