...
@property (nonatomic) char inScroll;
@property (nonatomic) char adjustHeightForPinning;
@property (nonatomic) char adjustScrollForPinning;
...
@property (nonatomic) char changingSupplementaryViewHeight;
...
- (char)_scrollToNextCell:(id)a0 contiguously:(char)a1;
...
- (char)_scrollToPreviousCell:(id)a0 contiguously:(char)a1;
...
- (char)_useInsetLayoutAtIndex:(unsigned long long)a0;
...
- (void)scrollToCellAtIndex:(unsigned long long)a0 constrainScroll:(char)a1;
- (void)scrollToTopConstrainingScroll:(char)a0;
- (void)selectCellsAtIndexes:(id)a0 byExtendingSelection:(char)a1;
