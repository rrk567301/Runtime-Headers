...
- (void).cxx_destruct;
- (long long)addItemIDs:(id)a0 after:(id)a1 snapshot:(id)a2 section:(id)a3 validateOtherSections:(char)a4;
- (long long)addItemIDs:(id)a0 before:(id)a1 snapshot:(id)a2 section:(id)a3 validateOtherSections:(char)a4;
