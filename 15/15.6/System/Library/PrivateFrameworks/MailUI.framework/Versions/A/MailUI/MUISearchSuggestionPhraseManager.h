...
@property (readonly, nonatomic) char hasPhraseOrSuggestions;
...
+ (id)phraseManagerWithPhrase:(id)a0 updatedSuggestion:(id)a1 filterQuery:(id)a2 inputLanguages:(id)a3 customFlags:(id)a4 feedbackQueryID:(long long)a5;

- (void).cxx_destruct;
- (id)initWithPhrase:(id)a0 selectedSuggestions:(id)a1 vipManager:(id)a2 updatedSuggestion:(id)a3 scopeIdentifierForPeopleSuggestions:(id)a4 inputLanguages:(id)a5 implicitSuggestions:(id)a6 filterQuery:(id)a7 excludedMailboxes:(id)a8 customFlags:(id)a9 feedbackQueryID:(long long)a10;
