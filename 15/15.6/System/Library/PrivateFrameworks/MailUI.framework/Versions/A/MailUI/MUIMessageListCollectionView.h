...
- (char)mui_isIndexPathVisible:(id)a0;
- (void)mui_scrollToItemAtIndexPath:(id)a0 atScrollPosition:(long long)a1 animated:(char)a2;
- (void)mui_selectItemAtIndexPath:(id)a0 animated:(char)a1 scrollPosition:(long long)a2;
