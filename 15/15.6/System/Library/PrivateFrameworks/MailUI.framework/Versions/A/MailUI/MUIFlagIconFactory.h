...
+ (id)_iconForFlag:(char)a0 tint:(char)a1 imageScale:(long long)a2 accessibilityDescription:(id)a3;
...
+ (id)iconForFlag:(char)a0 tint:(char)a1 imageScale:(long long)a2;
