...
- (void)_commonInit;
- (id)_addressCommentForAddressList:(id)a0 preferFullDisplayName:(char)a1;
- (id)_attributedAddressCommentForAddressList:(id)a0 preferFullDisplayName:(char)a1;
...
- (id)stringFromAddressAddressList:(id)a0 preferFullDisplayName:(char)a1;
- (id)stringFromEmailAddressList:(id)a0 preferFullDisplayName:(char)a1;
