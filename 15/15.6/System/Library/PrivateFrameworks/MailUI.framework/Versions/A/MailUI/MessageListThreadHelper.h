...
- (char)_isNextItemAnExpandedItemID:(id)a0 snapshot:(id)a1;
- (char)_isNextItemAnExpandedThreadItemID:(id)a0 snapshot:(id)a1;
...
- (char)isThreadExpandingWithItemID:(id)a0;
...
- (char)needsFlushSeparatorForItemID:(id)a0 snapshot:(id)a1;
