...
@property (nonatomic) char hasAdditionalSections;
...
- (void)resumeUpdates;
- (void)suspendUpdates;
- (char)anyExpandedThreadContainsItemID:(id)a0;
...
- (void)applyFilterPredicate:(id)a0 userFiltered:(char)a1 ignoreMessagesPredicate:(id)a2 section:(id)a3;
- (void)applyMessageListDataSourceUpdate:(id)a0;
- (void)deleteItemsWithIDs:(id)a0 animated:(char)a1 immediateCompletion:(char)a2 completion:(id /* block */)a3;
...
- (char)isExpandedThread:(id)a0;
- (char)isMessagesSection:(id)a0;
- (char)isMessagesSectionAtIndex:(long long)a0;
- (char)isSection:(id)a0 atIndex:(long long)a1;
- (char)isSection:(id)a0 atRow:(long long)a1;
- (char)isSectionHeaderAtRow:(long long)a0;
...
- (void)messageListSectionDataSource:(id)a0 performUpdateAnimated:(char)a1 cleanSnapshot:(char)a2 prepare:(id /* block */)a3 update:(id /* block */)a4 completion:(id /* block */)a5;
- (char)messageListSectionIsVisible:(id)a0;
...
- (void)reloadVisibleCellsInvalidatingCache:(char)a0;
- (void)removeMessageListSection:(id)a0 animated:(char)a1;
- (long long)sectionIndexForSection:(id)a0;
- (char)shouldDisplaySupplementaryKind:(id)a0 forSectionAtIndex:(long long)a1;
- (char)shouldReloadMessageListSectionDataSource:(id)a0;
- (void)showMessageListSection:(id)a0 animated:(char)a1;
