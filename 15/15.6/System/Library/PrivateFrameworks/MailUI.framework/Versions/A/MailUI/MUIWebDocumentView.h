...
@property (nonatomic) char preparingToLayoutSynchronously;
...
@property (nonatomic) char shouldPaintToBounds;
...
- (char)canExportAttachmentsToApplication:(id)a0;
...
- (void)saveAttachments:(id)a0 toDirectory:(id)a1 makePathsUnique:(char)a2;
- (void)saveAttachmentsWithPanel:(id)a0;
- (void)setAttachments:(id)a0 asHidden:(char)a1 completionHandler:(id /* block */)a2;
- (void)setWebDocument:(id)a0 forPrinting:(char)a1;
- (char)shouldHandleClickForURL:(id)a0;
