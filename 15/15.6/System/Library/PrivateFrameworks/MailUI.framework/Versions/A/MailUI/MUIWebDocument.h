...
@property (nonatomic) char hasBlockedMessageContent;
...
@property (nonatomic) char directlyLoadURLsWhichFailedToLoadThroughProxy;
...
@property (nonatomic) char extensionRequestedContentBlocking;
@property (copy, nonatomic) NSString *localizedRemoteContentBlockingReason;
@property (nonatomic) char disallowUsersToLoadRemoteContent;
