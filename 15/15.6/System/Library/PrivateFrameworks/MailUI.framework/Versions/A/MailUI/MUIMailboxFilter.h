...
@property (nonatomic) char hasMailboxPredicate;
...
- (id)initWithType:(long long)a0 name:(id)a1 description:(id)a2 iconImageName:(id)a3 iconTintColor:(id)a4 predicate:(id)a5 hasMailboxPredicate:(char)a6;
- (char)isEqualToFilter:(id)a0;
- (char)isEquivalentToPredicate:(id)a0;
