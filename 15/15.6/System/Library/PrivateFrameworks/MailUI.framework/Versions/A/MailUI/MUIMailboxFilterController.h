...
- (void).cxx_destruct;
- (id)initWithMailboxes:(id)a0 focus:(id)a1 baseStoragePath:(id)a2 defaultsRepresentationProvider:(id /* block */)a3 filterRepresentationProvider:(id /* block */)a4 mailboxFilterClass:(Class)a5 filterProviderClass:(Class)a6 isFilteringAvailable:(char)a7;
