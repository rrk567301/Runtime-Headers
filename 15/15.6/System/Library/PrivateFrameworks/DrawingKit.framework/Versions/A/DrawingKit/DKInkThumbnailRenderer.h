...
+ (char)_drawDebugPatternInGLContext:(id)a0 inSize:(struct CGSize { double x0; double x1; })a1;
...
+ (id)imageForDrawing:(id)a0 fittingInSize:(struct CGSize { double x0; double x1; })a1 backingScale:(double)a2 color:(id)a3 highFidelity:(char)a4;
+ (id)imageForDrawing:(id)a0 fittingInSize:(struct CGSize { double x0; double x1; })a1 color:(id)a2 highFidelity:(char)a3;
