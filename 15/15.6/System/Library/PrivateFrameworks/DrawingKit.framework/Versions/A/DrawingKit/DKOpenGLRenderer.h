...
@property (nonatomic, getter=isUndoEnabled) char undoEnabled;
@property (nonatomic) char ignoreFirstUndoItem;
@property (nonatomic) double backingScale;
@property (nonatomic) char drawingEnabled;
@property (nonatomic) char allowWetComposite;
...
- (void)didResize;
- (void)drawComposite;
- (void)drawContiguousVertexStorageImmediatelyWithLayeredBlending:(char)a0;
- (char)initGL;
...
- (id)initWithBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 scale:(double)a1 bufferSize:(int)a2 sharedContext:(char)a3;
- (void)initializeFrameBuffers;
- (void)redrawEntireDrawingImmediatelyWithLayeredBlending:(char)a0;
...
- (void)renderToComposite:(char)a0;
...
- (void)updateDryCycleIncludingComposite:(char)a0;
- (void)updateDryForcefully;
- (void)updateVertexControllerWithData:(struct vector<Vertex, std::allocator<Vertex>> { struct Vertex *x0; struct Vertex *x1; struct __compressed_pair<Vertex *, std::allocator<Vertex>> { struct Vertex *x0; } x2; })a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 allowWet:(char)a2;
- (void)updateVertexControllerWithDataRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 allowWet:(char)a1;
- (void)updateWet;
