...
+ (char)setCurrentGLContext:(id)a0;
+ (void)setProjectionMatrixForWidth:(float)a0 height:(float)a1 flipped:(char)a2 matrix:(struct { void /* unknown type, empty encoding */ x0[4]; } *)a3;
