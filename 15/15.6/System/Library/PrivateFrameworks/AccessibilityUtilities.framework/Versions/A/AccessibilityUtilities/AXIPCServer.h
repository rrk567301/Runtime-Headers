...
- (void)_addPossibleRequiredEntitlementsToMessageWithKey:(int)a0 first:(id)a1 vothers:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
- (char)__slowpath__clientWithAuditToken:(struct { unsigned int x0[8]; })a0 hasRequiredEntitlementFromSet:(id)a1;
- (void)_applyCustomQueueSize;
- (char)_clientHasEntitlementWithPort:(unsigned int)a0 auditToken:(struct { unsigned int x0[8]; })a1 message:(id)a2 completion:(id /* block */)a3;
...
- (char)_handleErrorWithMessage:(id)a0 outError:(id *)a1;
...
- (char)_hasEntitlement:(id)a0 entitlements:(id)a1 clientPort:(unsigned int)a2 auditToken:(struct { unsigned int x0[8]; })a3 message:(id)a4 completion:(id /* block */)a5;
...
- (id)initWithServiceName:(id)a0 perPidService:(char)a1;
...
- (void)setHandlerWithTarget:(id)a0 selector:(SEL)a1 async:(char)a2 forKey:(int)a3;
- (void)setHandlerWithTarget:(id)a0 selector:(SEL)a1 async:(char)a2 forKey:(int)a3 possibleRequiredEntitlements:(id)a4;
...
- (char)startServerWithError:(id *)a0;
- (char)stopServerWithError:(id *)a0;
