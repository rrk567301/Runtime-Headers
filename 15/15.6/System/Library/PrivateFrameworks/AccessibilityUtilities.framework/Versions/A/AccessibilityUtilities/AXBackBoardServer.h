...
@property (nonatomic) char inCheckerBoardMode;
@property (nonatomic) char preferenceRetrievalRequiresValidConnection;
...
- (char)isGuidedAccessSelfLockedToApp:(id)a0;
...
- (void)postEvent:(id)a0 systemEvent:(char)a1;
...
- (void)setCapsLockLightOn:(char)a0;
- (void)setHearingAidControlIsVisible:(char)a0;
- (void)setInvertColorsEnabled:(char)a0;
- (void)setIsSpeakScreenHighlightVisible:(char)a0;
- (void)setLockScreenDimTimerEnabled:(char)a0;
- (void)setSessionIsLoginSession:(char)a0;
- (void)setSwitchControlHasScreenSwitch:(char)a0;
- (void)setSwitchControlRendersDeviceUnusable:(char)a0;
