...
@property (nonatomic, getter=isHandlingDisplayRefresh) char handlingDisplayRefresh;
@property (nonatomic) unsigned long long warmUpModeRequirementsCount;
@property (readonly, nonatomic, getter=isWarmUpModeEnabled) char warmUpModeEnabled;
