...
@property (nonatomic) char _unitTest_didUpdateForLocaleChange;
...
+ (char)voiceOverSupportedInCurrentLanguage;
...
- (id)_dialectsThatCanSpeak:(id /* block */)a0 dialectIsSecondary:(id /* block */)a1 overridePreferredLanguages:(id)a2 preferOverrides:(char)a3;
- (id)_exemplarCharacterSetFromLanguages:(id)a0;
- (id)_loadLangMaps;
- (id)_preferredOverrideDialectsThatCanSpeak:(id /* block */)a0 dialectIsSecondary:(id /* block */)a1 overridePreferredLanguages:(id)a2 preferOverrides:(char)a3;
...
- (id)dialectsThatCanSpeakCharacter:(unsigned short)a0 overridePreferredLanguages:(id)a1 allowTransliteration:(char)a2;
- (id)dialectsThatCanSpeakCharacter:(unsigned short)a0 overridePreferredLanguages:(id)a1 allowTransliteration:(char)a2 preferOverrides:(char)a3;
- (id)dialectsThatCanSpeakString:(id)a0 overridePreferredLanguages:(id)a1;
- (char)didUpdateForLocaleChange;
