...
@property (readonly, nonatomic) char hasAmbigiousDialects;
...
@property (nonatomic) char createdFromNewline;

+ (id)tagWithDialects:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 content:(id)a2 predictedByTagger:(char)a3;
...
- (char)canBeSpokenByDialect:(id)a0;
- (char)canBeSpokenByLanguage:(id)a0;
