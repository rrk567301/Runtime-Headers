...
- (char)_accessibilityShouldIgnoreHIDServiceForContinuity:(struct __IOHIDServiceClient { } *)a0;
...
- (void)_installEventTap:(id)a0 skipDeviceMatching:(char)a1 filterEvents:(id)a2;
- (void)_installHIDFilter:(id)a0 skipDeviceMatching:(char)a1 filterEvents:(id)a2;
- (void)_installSystemEventTap:(id)a0;
- (void)_passivelyPeakAtHIDEventWithTarget:(void *)a0 tapPair:(id)a1 sender:(void *)a2 event:(struct __IOHIDEvent { } *)a3 axEventRep:(id)a4 didHandle:(char)a5;
- (char)_processHIDEvent:(struct __IOHIDEvent { } *)a0 taskPort:(unsigned int)a1 bundleId:(id)a2;
...
- (id)installEventTap:(id /* block */)a0 identifier:(id)a1 type:(int)a2 skipDeviceMatching:(char)a3 filterEvents:(id)a4 matchingServiceHandler:(id /* block */)a5;
...
- (void)sendEvent:(id)a0 afterTap:(id)a1 useGSEvent:(char)a2 namedTaps:(id)a3 options:(unsigned long long)a4;
- (void)sendHIDSystemEvent:(id)a0 repostCreatorHIDEvent:(char)a1 senderID:(unsigned long long)a2;
