...
- (void)_serverDied;
- (char)disconnectWithError:(id *)a0;
...
- (char)_handleErrorWithMessage:(id)a0 machError:(int)a1 outError:(id *)a2;
- (char)_handleErrorWithMessage:(id)a0 outError:(id *)a1;
- (char)_prepareToSendMessage:(id)a0 withError:(id *)a1 prepSuccessHandler:(id /* block */)a2;
- (void)_registerWithServer;
- (void)_sendRegistrationMessageWithRetries:(int)a0;
- (char)_verifyConnectionWithError:(id *)a0;
- (char)connectWithError:(id *)a0;
- (void)establishConnectionWithTimeout:(double)a0 completion:(id /* block */)a1;
- (char)sendAsyncMessage:(id)a0 replyOnQueue:(id)a1 replyHandler:(id /* block */)a2;
- (char)sendAsyncMessage:(id)a0 withReplyHandler:(id /* block */)a1;
- (id)sendMessage:(id)a0 withError:(id *)a1;
- (void)sendSimpleMessage:(id)a0;
- (char)sendSimpleMessage:(id)a0 synchronizationPort:(unsigned int)a1 error:(id *)a2;
- (char)sendSimpleMessage:(id)a0 withError:(id *)a1;
