...
@property char receivedServerInfo;
...
@property char mUnverifiedServerMessageDisplayed;
...
@property char scaleFactorEnqueued;
@property char serverSupportsLaunchpad;
@property char serverSupportsShowDesktop;
@property char serverSupportsMissionControl;
@property char serverSupportsFrontApplicationWindows;
@property char rejectedEncoding;
@property char mediaStreamMessage1Received;
...
@property char videoStream1Supports60FPS;
@property char videoStream2Supports60FPS;
...
@property (nonatomic) char serverSupportsDynamicDrag;
@property (nonatomic) char appWantsProModeInterface;
@property (nonatomic) unsigned int dragDataInflatedSize;
@property (nonatomic) unsigned int *cursorPixelMap;
@property (nonatomic) char remoteCursorIsVisible;
@property (nonatomic) char receivedAudioRTCPMessage;
...
@property char exitingDynamicResolutionMode;
...
@property char isUsingSSHTunnel;
...
@property char isAutoPasteboardEnabled;
...
@property char assistModeWasEnabled;
@property char assistModeActive;
@property unsigned int assistModeFlags;
@property char receivedFullScreen;
...
@property (nonatomic) char useAVCMediaStreamsWithAppleID;
@property char encodingsWereSet;
@property char clientShouldSetCurtainMode;
@property char keyboardSourceShared;
@property char serverSecureInput;
...
@property (nonatomic) char cursorAlwaysVisible;
@property (retain) NSData *dragData;
@property (nonatomic) char processUserDragInfo;
...
- (void)stream:(id)a0 didStartSynchronizer:(char)a1 error:(id)a2;
...
- (id)activeFileCopies;
- (char)addressIsAppleIDOnlyDomain:(id)a0;
