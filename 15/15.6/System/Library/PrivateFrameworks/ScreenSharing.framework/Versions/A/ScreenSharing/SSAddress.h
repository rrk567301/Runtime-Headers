...
@property char inviterAppIsMessages;
...
- (id)addressCopy;
- (id)canonicalURLWithStrippedUser:(char)a0 passwordBullets:(char)a1;
- (id)contactForABPersonID:(id)a0;
- (id)contactForAppleID:(id)a0;
- (char)foundBonjourInString:(id)a0;
- (char)foundIPv4InString:(id)a0;
- (char)foundIPv6InString:(id)a0;
- (char)foundPhoneNumber:(id)a0;
