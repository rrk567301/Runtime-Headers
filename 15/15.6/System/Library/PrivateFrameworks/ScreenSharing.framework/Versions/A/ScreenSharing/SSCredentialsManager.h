...
- (void)_endRequestForRequester:(id)a0 closeNetAuth:(char)a1;
...
- (void)returnUsername:(id)a0 password:(id)a1 authtype:(id)a2 label:(id)a3 serverSupportsSRP:(char)a4 forCompositeKey:(id)a5 withStatus:(int)a6;
