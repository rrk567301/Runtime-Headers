...
@property (nonatomic) char mUnverifiedServerMessageDisplayed;
@property (retain) MessageTracerInfo *messageTracerInfo;
@property (copy) NSSet *pseudoEncodings;
@property char hasUnfulfilledPasteboardPromises;
@property (nonatomic) double connectTimeout;
@property char canToggleCurtainMode;
@property char serverInLoginWindowLockScreen;
@property char serverAtLoginWindow;
@property (getter=isOnConsole) char onConsole;
...
@property (nonatomic) char scaleFactorEnqueued;
@property (nonatomic) char serverSupportsLaunchpad;
@property (nonatomic) char serverSupportsShowDesktop;
@property (nonatomic) char serverSupportsMissionControl;
@property (nonatomic) char serverSupportsFrontApplicationWindows;
...
@property (nonatomic) char sharePlaySessionConnected;
...
@property (readonly, nonatomic, getter=isControlling) char controlling;
...
@property (nonatomic) char curtained;
@property (nonatomic) char isUsingSSHTunnel;
...
@property (nonatomic) char isAutoPasteboardEnabled;
...
@property (nonatomic) char assistModeEnabled;
@property (nonatomic) char assistModeWasEnabled;
@property (nonatomic) char assistModeActive;
@property (nonatomic) unsigned int assistModeFlags;
@property (nonatomic) char receivedFullScreen;
...
@property (nonatomic) char encodingsWereSet;
@property (nonatomic) char clientShouldSetCurtainMode;
@property (nonatomic) char keyboardSourceShared;
@property (nonatomic) char serverSecureInput;
@property (nonatomic) char clientChangedCurtainMode;
...
- (void)delegateCursorVisibilityUpdated:(char)a0;
...
- (void)delegateSessionAllowsControl:(char)a0;
...
- (char)doesServerSupportFeature:(int)a0;
...
- (void)handleCursorVisibility:(char)a0;
...
- (void)handleDisplayInfo2b:(unsigned short)a0 screenFlags:(unsigned int)a1 screenConfiguration:(id)a2 newSelectedScreen:(id)a3 displayCountChanged:(char)a4;
...
- (void)logConnectionFailureToMessageTracer:(char)a0 withFailureReason:(id)a1;
...
- (char)recordRemotePasteboardData:(id)a0 toLocalPasteboard:(id)a1 uncompressedSize:(unsigned int)a2;
...
- (char)setScalingFactor:(double)a0 forced:(char)a1;
...
- (void)stCorePostMouseEventWithX:(unsigned short)a0 withY:(unsigned short)a1 withButtonMask:(unsigned char)a2 withFrameBufferCoords:(struct SSPoint { long long x0; long long x1; })a3 withClickCount:(long long)a4 active:(char)a5 framePercent:(struct CGPoint { double x0; double x1; })a6 withTimestamp:(unsigned long long)a7;
...
- (void)stResetSessionVariablesForNewConnection:(char)a0;
...
- (void)turnAssistModeOff:(char)a0;
...
- (char)validateAndAdjustMouseCoordinatesForServer:(struct SSPoint { long long x0; long long x1; })a0 withXOut:(unsigned short *)a1 withYOut:(unsigned short *)a2;
