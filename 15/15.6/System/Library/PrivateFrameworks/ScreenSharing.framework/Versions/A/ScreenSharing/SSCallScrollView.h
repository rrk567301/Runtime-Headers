...
@property (nonatomic) char modifiedSystemCursor;
@property (nonatomic) char drawCursorInLayer;
@property SSCallTrackingWindow *delegate;
@property (retain) id<SSInputEventConsumer> inputEventConsumer;
@property (nonatomic) char allowsDragAndDropFileCopyToRemote;
@property (nonatomic) char allowsDragAndDropFileCopyFromRemote;
...
- (void)cursorVisibilityChanged:(char)a0;
- (void)drawLocalCursorInLayer:(char)a0;
...
- (void)updateObserveFlagIfNecessary:(char)a0;
