...
@property char isIOSinvitation;
@property (readonly) IDSService *currentIDSService;
@property char idsInviteAcceptedOnScreensharingQRService;
...
+ (char)isAppleIDOnlyDomain:(id)a0;
...
- (char)addIDSServiceMessageObserver:(id)a0 forSession:(id)a1;
...
- (char)foundBTMMInString:(id)a0;
- (char)isLocal:(struct in6_addr { union { unsigned char x0[16]; unsigned short x1[8]; unsigned int x2[4]; } x0; })a0;
- (char)isLocal:(struct in6_addr { union { unsigned char x0[16]; unsigned short x1[8]; unsigned int x2[4]; } x0; })a0 withPort:(long long)a1;
