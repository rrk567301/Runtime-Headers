...
+ (struct __SecKeychain { } *)openKeychainWithPath:(const char *)a0 private:(char)a1;
...
+ (char)saveRSAPublicKey:(id)a0 label:(id)a1;
...
- (void)freeKeys;
- (char)generateKeyPairWithKeySize:(id)a0;
- (char)loadAndVerifyKeys;
- (char)makeKeysWithKeySize:(id)a0;
