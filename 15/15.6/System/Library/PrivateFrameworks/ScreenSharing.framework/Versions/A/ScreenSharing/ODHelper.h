...
- (void)cleanup;
- (id)openSearchNode;
- (void)setARDPrivileges:(unsigned int)a0 forUserRecord:(id)a1;
- (char)authenticateWithUser:(id)a0 password:(id)a1 error:(id *)a2;
...
- (id)localUserRecordByShortName:(id)a0;
- (id)localUserUIDs;
- (void)newLocalUserWithName:(id)a0 attributes:(id)a1 password:(id)a2;
- (char)nodeIsLocal:(id)a0;
