@interface IFDPackageRep : NSObject <NSCopying> {
    struct IFDPackageRep_Private { id x0; id x1; id x2; int x3; id x4; id x5; id x6; id x7; id x8; id x9; char x10; } *_private;
}
...
- (void)setSelfContained:(char)a0;
- (void)setShouldBackRev:(char)a0;
- (void)setValidatedDigest:(id)a0 replace:(char)a1;
