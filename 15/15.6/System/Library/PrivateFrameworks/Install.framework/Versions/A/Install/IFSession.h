...
- (id)endOfInstallJob;
- (char)_checkPackageIntegrity:(id)a0 againstRealPackage:(id)a1;
...
- (char)installPackages:(id)a0 withOptions:(id)a1 inSession:(id)a2;
- (int)metaCount;
- (char)preauthorizeForRights:(int)a0;
- (char)preauthorizeForRights:(int)a0 withCompletion:(id /* block */)a1 onRunLoop:(struct __CFRunLoop { } *)a2;
- (id)qAtMetaIndex:(int)a0;
- (id)queueElementForActionsGroup:(id)a0;
- (void)runContinue;
- (void)setCurrentMediaHasFinishedInstalling:(char)a0;
- (void)stepInto;
- (void)stepOutOf;
- (void)stepOver;
