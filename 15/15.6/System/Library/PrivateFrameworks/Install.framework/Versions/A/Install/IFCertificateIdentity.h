@interface IFCertificateIdentity : NSObject {
    struct IFCertificateIdentity_Private { struct __SecTrust *x0; struct __SecCertificate *x1; unsigned int x2; id x3; id x4; char x5; int x6; int x7; } *_private;
}
...
- (char)_handleTrustResult:(unsigned int)a0 forTrustRef:(struct __SecTrust { } *)a1;
- (struct __SecPolicy { } *)_createInstallerPolicy;
- (struct __SecPolicy { } *)_createPolicyForType:(int)a0 withAnchorCerts:(id *)a1;
- (id)_readCerts:(id)a0;
- (char)_validateTrust;
- (char)_verifySignedData:(id)a0 withData:(id)a1 andCert:(struct __SecCertificate { } *)a2;
