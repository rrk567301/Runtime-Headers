...
- (char)_readDataAndDeflateWithRawLength:(unsigned long long)a0 andFinalLength:(unsigned long long)a1 intoBuffer:(char *)a2;
- (char)extractDataWithRawLength:(unsigned long long)a0 andFinalLength:(unsigned long long)a1 withCompressionType:(int)a2 fromOffset:(long long)a3 toFd:(int)a4;
- (char)extractInlineCPIOAtOffset:(long long)a0 withLength:(unsigned long long)a1 toPath:(id)a2;
- (id)intWithFile:(id)a0;
- (char)mapDataFromOffset:(long long)a0 withLength:(unsigned long long)a1 intoData:(id *)a2;
- (unsigned short)read16;
- (unsigned int)read32;
- (unsigned long long)read64;
- (unsigned char)read8;
- (unsigned char)read8AtOffset:(long long)a0;
- (void)readDataAsNetworkByteOrder:(char)a0;
- (char)readDataWithRawLength:(unsigned long long)a0 andFinalLength:(unsigned long long)a1 withCompressionType:(int)a2 fromOffset:(long long)a3 intoBuffer:(char *)a4;
