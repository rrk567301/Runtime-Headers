...
@property char requiresRosettaTranslation;
...
- (char)hasInstallWarning:(id *)a0;
- (id)initWithDestinationPath:(id)a0 displayName:(id)a1 displayVersion:(id)a2 sourceManager:(id)a3 sandboxPath:(id)a4 installingOS:(char)a5 isFNI:(char)a6 minTrustLevel:(int)a7 restartAction:(int)a8 translocationFileHandle:(id)a9;
- (id)packageReps;
