...
+ (id)packageFileTypes;
+ (char)pantherReceiptCompatibiliy:(id)a0 withObject:(id)a1;
...
- (char)_addBundleVersionCheckingToPlan:(id)a0;
- (struct _BOMBom { } *)_bom;
- (id)_bomPath;
...
- (char)_isMetapackage;
- (void)_loadBom:(id)a0;
- (char)_loadBundle:(id)a0 error:(id *)a1;
- (char)_loadComponent;
...
- (id)_requirementsFromInfoDictionary:(char *)a0;
...
- (char)validateContents:(id *)a0 deepscan:(char)a1;
- (char)verifyDirectoryForPath:(id)a0 withCreating:(char)a1 andAttributes:(id)a2;
