...
@interface ADLKTOpticalFlow : NSObject {
    ...
    char _useNonLocalRegularization;
    int _nlreg_radius;
    int _nlreg_padding;
...
+ (struct { unsigned long long x0; id x1; char x2; int x3; int x4; float x5; float x6; float x7; })defaultConfig;
...
- (char)_createImagePyramidWithCommandBuffer:(id)a0 inOutPyramidsArray:(id)a1 error:(id *)a2;
- (char)_createImagePyramidWithCommandBuffer:(id)a0 in_BGRATex:(id)a1 outPyramidsArray:(id)a2 error:(id *)a3;
...
- (char)_setupBufferAndReturnErrorWithDevice:(id)a0 error:(id *)a1;
...
- (id)initWithDevice:(id)a0 inputSize:(struct CGSize { double x0; double x1; })a1 config:(struct { unsigned long long x0; id x1; char x2; int x3; int x4; float x5; float x6; float x7; })a2;
