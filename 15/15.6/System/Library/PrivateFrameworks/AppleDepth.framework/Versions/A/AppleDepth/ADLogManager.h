...
@interface ADLogManager : NSObject {
    ...
    char _forceAllPriorities;
}

@property (nonatomic) unsigned long long loggingPriority;
@property (nonatomic) char humanReadableFormat;
...
- (void)toggleByClass:(Class)a0 enable:(char)a1;
- (void)toggleHandler:(id)a0 enable:(char)a1;
