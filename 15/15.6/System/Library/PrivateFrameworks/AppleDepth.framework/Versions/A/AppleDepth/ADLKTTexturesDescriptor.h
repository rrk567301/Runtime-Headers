...
@property (readonly, nonatomic) struct { unsigned long long scales; NSMutableArray *nwarpings; char useNonLocalRegularization; int nlreg_radius; int nlreg_padding; float nlreg_sigma_l; float nlreg_sigma_c; float nlreg_sigma_w; } opticalFlowConfig;

- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initForSupportedSizes:(id)a0 config:(struct { unsigned long long x0; id x1; char x2; int x3; int x4; float x5; float x6; float x7; })a1;
