...
+ (char)updatePixelBufferAllocationWithNewSize:(struct CGSize { double x0; double x1; })a0 pixelFormat:(unsigned int)a1 pixelBuffer:(struct __CVBuffer **)a2;
...
+ (long long)filterInvalidsFromFloatImage:(struct __CVBuffer { } *)a0 minValue:(float)a1 maxValue:(float)a2 clampToMinMax:(char)a3;
...
+ (long long)scaleConvertRotateImage:(struct __CVBuffer { } *)a0 rotateBy:(unsigned char)a1 cropBy:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 scaleInto:(struct __CVBuffer { } *)a3 intermediateScalingBuffer:(struct __CVBuffer **)a4 intermediateRotatingBuffer:(struct __CVBuffer **)a5 useVT:(char)a6;
