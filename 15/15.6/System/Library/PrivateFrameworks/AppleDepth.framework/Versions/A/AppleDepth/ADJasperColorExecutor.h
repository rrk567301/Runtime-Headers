...
@interface ADJasperColorExecutor : ADExecutor {
    ...
    char _firstTimeExecution;
    char _opticalFlowEnabled;
...
- (long long)prepareForEngineType:(unsigned long long)a0 roi:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 exifOrientation:(unsigned int)a2 useTemporalConsistency:(char)a3;
- (long long)prepareForEngineType:(unsigned long long)a0 roi:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 exifOrientation:(unsigned int)a2 useTemporalConsistency:(char)a3 rotationPreference:(unsigned long long)a4;
