...
+ (char)isColorFrameValid:(struct __CVBuffer { } *)a0 withMetadata:(id)a1;
+ (char)isPearlFrameValid:(struct __CVBuffer { } *)a0 withMetadata:(id)a1;
+ (char)isPearlFrameValid:(struct __CVBuffer { } *)a0 withMetadata:(id)a1 andPipelineParameters:(id)a2;
+ (char)isPearlMaskExpectedFor:(int)a0;
+ (char)isValidDepthAboveThreshold:(struct __CVBuffer { } *)a0 threshold:(float)a1 invalid:(unsigned short)a2 validDepthPercentage:(float *)a3;
+ (char)isZUsedFor:(int)a0;
...
- (char)isPearlFrameValid:(struct __CVBuffer { } *)a0;
- (char)isPearlMaskExpected;
