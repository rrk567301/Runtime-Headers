...
+ (char)getAndVerifySizesFromConfig:(id)a0 inDictionary:(id)a1 forKey:(id)a2 sizes:(id)a3 layout:(unsigned long long *)a4;
+ (id)getConfigFolderForNetwork:(id)a0;
+ (id)getDefaultPathForNetwork:(id)a0 allowPrecompiledModel:(char)a1;
...
- (id)bufferNameForType:(id)a0 isInput:(char)a1;
- (id)descriptorForBuffer:(id)a0 isInput:(char)a1 pixelFormat:(unsigned int)a2;
- (id)descriptorForBufferOfType:(id)a0 isInput:(char)a1 pixelFormat:(unsigned int)a2;
...
- (char)processConfig:(id)a0 inDictionary:(id)a1 forLayout:(unsigned long long)a2;
