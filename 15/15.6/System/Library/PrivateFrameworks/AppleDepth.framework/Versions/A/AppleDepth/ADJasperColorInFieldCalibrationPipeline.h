...
+ (char)isColorFrameValid:(struct __CVBuffer { } *)a0 withMetadata:(id)a1 andPipelineParameters:(id)a2;
...
+ (char)isJasperFrameValid:(id)a0 andPipelineParameters:(id)a1;
...
- (char)isAngularVelocityValid:(id)a0;
- (char)isJasperFrameValid:(id)a0;
- (char)isSDF:(id)a0;
