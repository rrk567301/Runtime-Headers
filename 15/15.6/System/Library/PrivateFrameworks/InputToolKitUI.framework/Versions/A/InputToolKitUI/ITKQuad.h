@class NSString, NSArray, NSBezierPath;
...
@property (readonly, nonatomic) char containsIntersectingLines;
@property (readonly, nonatomic) struct ITKQuadSideLength { double x0; double x1; double x2; double x3; } sideLength;
...
@property (readonly, nonatomic) ITKQuad *quadByAdjustingOrientation;
...
- (id)quadByConvertingFromView:(id)a0 toView:(id)a1 isNormalized:(char)a2;
...
- (char)isCompletelyInsideRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (double)minimumDistanceToPoint:(struct CGPoint { double x0; double x1; })a0;
