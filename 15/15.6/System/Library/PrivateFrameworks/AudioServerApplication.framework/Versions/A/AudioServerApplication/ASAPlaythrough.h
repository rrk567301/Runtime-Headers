...
- (id)initWithDevices:(id)a0 usingMainDevice:(id)a1 andClockDevice:(id)a2 withName:(id)a3 isPrivate:(char)a4 usingChannelMapping:(id)a5;
- (id)initWithDevices:(id)a0 usingMainDevice:(id)a1 andClockDeviceUID:(id)a2 withName:(id)a3 isPrivate:(char)a4 usingChannelMapping:(id)a5;
- (id)initWithDevices:(id)a0 usingMasterDevice:(id)a1 andClockDevice:(id)a2 withName:(id)a3 isPrivate:(char)a4 usingChannelMapping:(id)a5;
- (id)initWithDevices:(id)a0 usingMasterDevice:(id)a1 andClockDeviceUID:(id)a2 withName:(id)a3 isPrivate:(char)a4 usingChannelMapping:(id)a5;
