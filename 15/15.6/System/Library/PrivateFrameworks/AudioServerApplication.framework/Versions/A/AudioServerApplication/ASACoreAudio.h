...
- (id)pluginObjectIDs;
- (void)_setDefaultInputAudioDeviceObjectID:(unsigned int)a0 transient:(char)a1;
- (void)_setDefaultOutputAudioDeviceObjectID:(unsigned int)a0 transient:(char)a1;
- (void)_setDefaultSystemOutputAudioDeviceObjectID:(unsigned int)a0 transient:(char)a1;
