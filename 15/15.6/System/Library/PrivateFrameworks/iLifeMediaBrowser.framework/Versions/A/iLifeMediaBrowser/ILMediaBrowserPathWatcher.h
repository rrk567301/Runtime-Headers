...
- (char)startFSEventStream:(id)a0;
- (void)stopFSEventStream;
- (void)watchForCreationPath:(id)a0 observer:(id)a1;
- (char)watchForCreationPathIsUnique:(id)a0 observer:(id)a1;
...
- (char)watchUnmountedPathIsUnique:(id)a0 observer:(id)a1;
