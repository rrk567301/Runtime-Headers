...
- (void)setVerticalMotionCanBeginDrag:(char)a0;
...
- (id)playButtonImage;
- (void)selectMediaObjectIndexes:(id)a0 byExtendingSelection:(char)a1;
...
- (char)matrix:(id)a0 writeCells:(id)a1 toPasteboard:(id)a2;
...
- (char)imageBrowser:(id)a0 shouldSelectCellAtIndex:(unsigned long long)a1;
- (char)isCustomFolder:(id)a0 forBrowser:(unsigned long long)a1;
...
- (char)outlineView:(id)a0 removeItems:(id)a1;
...
- (void)selectMediaGroup:(id)a0 byExtendingSelection:(char)a1;
- (void)selectMediaGroupIndexes:(id)a0 byExtendingSelection:(char)a1;
- (void)selectMediaObject:(id)a0 byExtendingSelection:(char)a1;
- (char)selectedGroupsContainPodcasts;
- (char)selectedGroupsContainRatings;
- (void)setAllowsUserAddedCustomFolders:(char)a0;
...
- (void)setSingleWindowModeEnabled:(char)a0;
...
- (void)showClipboard;
- (char)showDisplayMessageForSelectedGroupNodes:(id)a0;
