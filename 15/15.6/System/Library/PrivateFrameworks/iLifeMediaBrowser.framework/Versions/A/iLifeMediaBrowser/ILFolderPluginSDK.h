...
+ (char)_isSupportedAudioExtension:(id)a0 orFileType:(unsigned int)a1;
+ (char)_isSupportedAudioFileBySpotlightDict:(id)a0;
+ (char)_isSupportedImageExtension:(id)a0 orFileType:(unsigned int)a1;
+ (char)_isSupportedImageFileBySpotlightDict:(id)a0;
+ (char)_isSupportedMovieExtension:(id)a0 orFileType:(unsigned int)a1;
+ (char)_isSupportedMovieFileBySpotlightDict:(id)a0;
...
- (id)uniqueID;
- (id)displayImage;
- (id)_createAudioMediaObjectForPath:(id)a0 isAlias:(char)a1 spotlightAttributesDict:(id)a2;
- (id)_checkForiMovieProjectAtPath:(id)a0 alias:(char)a1 infoRecFlags:(unsigned long long)a2;
- (id)_createFolderMediaGroupForPath:(id)a0 currentLoadAliases:(id)a1;
- (id)_createMediaObjectForPath:(id)a0 alias:(char)a1 infoRecFlags:(unsigned long long)a2;
- (id)_createMediaObjectForURL:(id)a0 isAlias:(char)a1 resolvedAliasPath:(id)a2 dstInfoRec:(struct LSItemInfoRecord { unsigned int x0; unsigned int x1; unsigned int x2; struct __CFString *x3; } *)a3;
...
- (id)_createGBMediaObjectForPath:(id)a0 isAlias:(char)a1 resolvedAliasPath:(id)a2 spotlightAttributesDict:(id)a3;
- (id)_createImageMediaObjectWithPath:(id)a0 isAlias:(char)a1 resolvedAliasPath:(id)a2 spotlightAttributesDict:(id)a3;
- (id)_createMediaObjectForPath_V2:(id)a0 isAlias:(char)a1 resolvedAliasPath:(id)a2 dstInfoRec:(struct LSItemInfoRecord { unsigned int x0; unsigned int x1; unsigned int x2; struct __CFString *x3; } *)a3;
- (id)_createMovieMediaObjectForPath:(id)a0 isAlias:(char)a1 resolvedAliasPath:(id)a2 spotlightAttributesDict:(id)a3;
- (char)_cyclicDependency:(id)a0 parentPath:(id)a1;
- (id)performLoadData;
...
- (char)loadShouldIgnoreThisPath:(id)a0;
