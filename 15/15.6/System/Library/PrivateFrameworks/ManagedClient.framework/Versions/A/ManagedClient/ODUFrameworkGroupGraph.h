...
- (void)filterWithAllowList:(id)a0 withDenyList:(id)a1 forLocalUsers:(char)a2;
...
- (id)groupMCXRecords:(char)a0;
- (char)hasParentWithUUIDStringInList:(id)a0 withWildcardString:(id)a1;
- (id)initWithMCXRecord:(id)a0;
- (id)mcxRecord;
- (id)mcxSettingsMCXRecords:(char)a0;
- (id)nextGraph;
- (id)orderedArray:(char)a0;
- (id)orderedMCXRecords:(char)a0;
- (char)recordIsEquivalent:(id)a0;
- (char)recordIsEquivalentToName:(id)a0 withType:(id)a1 withUUID:(id)a2;
- (void)removeParentAtIndex:(unsigned long long)a0;
- (void)setNextGraph:(id)a0;
- (id)workgroupMCXRecords:(char)a0;
