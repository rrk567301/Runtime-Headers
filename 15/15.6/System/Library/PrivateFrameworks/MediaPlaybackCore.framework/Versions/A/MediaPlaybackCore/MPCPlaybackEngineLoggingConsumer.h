...
@interface MPCPlaybackEngineLoggingConsumer : NSObject <MPCPlaybackEngineEventConsumer> {
    ...
    struct _MPCLoggingConsumerChartStatus { char userExpectsAudio; char waitingInteruptEnd; long long timeControlStatus; } _chartStatus;
}
...
- (void).cxx_destruct;
- (char)_logAccountEvent:(id)a0 subscription:(id)a1 cursor:(id)a2;
