...
- (char)getRequestingImmediatePlaybackFromSetPlaybackSessionCommandEvent:(id)a0;
...
- (void)performSetQueueWithEvent:(MPSetPlaybackQueueCommandEvent *)a0 installQueueBeforeLoaded:(char)a1 donatedStartPlayerItem:(MPAVItem *)a2 completion:(void (^)(NSError *))a3;
- (void)performSetSessionWithEvent:(MPSetPlaybackSessionCommandEvent *)a0 completion:(void (^)(NSError *))a1;
- (char)sonicStageCondition:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
