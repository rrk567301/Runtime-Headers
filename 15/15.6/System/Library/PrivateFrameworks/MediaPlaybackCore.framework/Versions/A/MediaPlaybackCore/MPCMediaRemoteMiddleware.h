...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, nonatomic) char skippedMetadata;
...
- (struct { double x0; double x1; double x2; double x3; double x4; float x5; float x6; char x7; char x8; char x9; })playerItemDuration:(struct { double x0; double x1; double x2; double x3; double x4; float x5; float x6; char x7; char x8; char x9; })a0 atIndexPath:(id)a1 chain:(id)a2;
...
- (char)playerItemIsFavoritable:(char)a0 atIndexPath:(id)a1 chain:(id)a2;
- (char)playerItemIsPlaceholder:(char)a0 atIndexPath:(id)a1 chain:(id)a2;
...
- (char)playerItemShouldDisableJumpToItem:(char)a0 atIndexPath:(id)a1 boundsCheck:(char)a2 chain:(id)a3;
...
- (char)playerVocalsControlActive:(char)a0 chain:(id)a1;
- (char)playerVocalsControlContinuous:(char)a0 chain:(id)a1;
...
- (char)sectionIsAutoPlaySection:(char)a0 atIndex:(long long)a1 chain:(id)a2;
