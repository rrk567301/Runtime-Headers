@class ICSharedListeningQueue, MPCPlaybackRequestEnvironment, NSDictionary, NSMutableArray, ICLiveLink, NSString, NSHashTable, MPPropertySet, AVPlayerPlaybackCoordinator, NSMutableSet, NSArray, MPCModelGenericAVItemUserIdentityPropertySet, MPRequestResponseController;
...
@property (nonatomic) char joiningAsInitiator;
...
- (void)_emitEventsForParticipants:(id)a0 localUserIdentity:(id)a1;
...
- (void)_reloadCacheDataWithOptions:(unsigned long long)a0;
- (id)_sectionObjectForSharedListeningContainerID:(id)a0;
- (id)_sectionedCollectionForQueue:(id)a0;
- (char)_useItemPlaceholderForContentItemID:(id)a0;
- (char)_useItemPlaceholderForItemID:(id)a0;
