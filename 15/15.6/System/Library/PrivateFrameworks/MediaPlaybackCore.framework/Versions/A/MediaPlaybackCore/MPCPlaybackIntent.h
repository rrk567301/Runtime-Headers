...
@property (nonatomic) char prefersEnqueuingUsingAirPlay;
...
+ (void)setAppExtensionTracklistDataSource:(Class)a0;
...
- (void)getSharedListeningTracklistWithCompletion:(id /* block */)a0;
