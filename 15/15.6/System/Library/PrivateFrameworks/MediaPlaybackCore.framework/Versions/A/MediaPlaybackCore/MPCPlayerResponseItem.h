...
@property (readonly, nonatomic, getter=isAutoPlay) char autoPlay;
...
@property (readonly, nonatomic) struct { double snapshotTime; double startTime; double endTime; double duration; double elapsedDuration; float rate; float defaultRate; char isLiveContent; char isLoading; char isInTransition; } duration;
...
- (id)_initWithContentItemID:(id)a0 autoPlay:(char)a1;
- (char)_isDisliked;
- (char)_isDislikedValueForSong:(id)a0;
- (char)_isFavoriteEligible;
- (char)_isFavoriteValueForSong:(id)a0;
- (char)_isFavorited;
