...
@property (readonly, nonatomic, getter=isStoringSamples) char storingSamples;
...
- (id)flushSamplesToCSVDataWithHeader:(char)a0;
- (id)initWithRecordID:(id)a0 modelID:(id)a1 firstFailureDetector:(id)a2 shouldStoreSamples:(char)a3 delegate:(id)a4;
