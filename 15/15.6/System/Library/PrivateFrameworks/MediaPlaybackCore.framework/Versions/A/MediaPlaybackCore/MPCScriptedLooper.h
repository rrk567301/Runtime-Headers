...
@property (class, nonatomic, getter=isScriptedLoopingDisabled) char scriptedLoopingDisabled;
...
@property (nonatomic, getter=isExecutingPauseScene) char executingPauseScene;
@property (nonatomic, getter=isSceneExecutionPaused) char sceneExecutionPaused;
