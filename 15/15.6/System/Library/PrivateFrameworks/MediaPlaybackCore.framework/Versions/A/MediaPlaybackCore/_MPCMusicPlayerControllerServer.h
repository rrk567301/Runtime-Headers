...
@interface _MPCMusicPlayerControllerServer : NSObject <MPMusicPlayerControllerSystemServer, MPMusicPlayerControllerApplicationServer, NSXPCListenerDelegate, _MPCPlaybackEngineEventObserving> {
    ...
    char _waitingForAdditionalPlaybackContexts;
    char _resumed;
...
- (void)setDisableAutoPlay:(char)a0;
- (void)setDisableAutomaticCanBeNowPlaying:(char)a0;
- (void)setDisableRepeat:(char)a0;
- (void)setDisableShuffle:(char)a0;
