...
@interface _MPCMediaRemotePublisher : NSObject <MPNowPlayingPlaybackQueueDataSourcePrivate, MPRemoteCommandCenterDelegate, MPCPlaybackEngineEventObserving, MPCPlaybackAccountManagerObserver, MPCQueueControllerPublisher> {
    NSArray *_accounts;
    char _activeAccountAllowsSubscriptionPlayback;
    char _activeAccountRequiresAuthorizationTokensForPlayback;
    NSString *_activeAccountStoreFrontIdentifier;
    char _hasBeganFastForward;
    char _hasBeganRewind;
...
@property (nonatomic, getter=hasInitializedSupportedCommands) char initializedSupportedCommands;
@property (nonatomic, getter=isEngineRestoringState) char engineRestoringState;
@property (nonatomic, getter=isMediaServerAvailable) char mediaServerAvailable;
...
- (void)_enqueueFallbackIntentIfNeededForCommandEvent:(id)a0 play:(char)a1 completion:(id /* block */)a2;
