...
+ (char)isValidInsertionIntent:(id)a0 atPosition:(int)a1 forDestination:(long long)a2 supportedQueueTypes:(unsigned long long)a3 supportedCustomDataQueueIdentifiers:(id)a4;
+ (char)isValidReplaceIntent:(id)a0 forDestination:(long long)a1 supportedQueueTypes:(unsigned long long)a2 supportedCustomDataQueueIdentifiers:(id)a3;

- (void).cxx_destruct;
- (void)didStartLiveLink:(id)a0;
- (void)liveLink:(id)a0 didEncounterError:(id)a1 willRetry:(char)a2;
