...
@interface MPCVocalAttenuationProcessorImplementation : NSObject {
    ...
    struct ComponentInstanceRecord { long long x0[1]; } *_processingAU;
...
- (id)init;
- (void).cxx_destruct;
- (char)_setupAudioUnitWithModel:(id)a0 error:(id *)a1;
- (void)_applyAttenuationLevelToAudioUnit;
- (char)_createAudioUnit:(id *)a0;
- (char)_initializeAudioUnit:(id *)a0;
...
- (char)isCompatibleWithAudioFormat:(struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; })a0 maxFrames:(unsigned int)a1;
- (void)prepareWithModel:(id)a0 completion:(id /* block */)a1;
- (char)processAudioBuffer:(struct AudioBufferList { unsigned int x0; struct AudioBuffer { unsigned int x0; unsigned int x1; void *x2; } x1[1]; } *)a0 sampleIndex:(long long)a1 numberFrames:(unsigned int)a2 error:(id *)a3;
- (void)resetAudioUnit;
