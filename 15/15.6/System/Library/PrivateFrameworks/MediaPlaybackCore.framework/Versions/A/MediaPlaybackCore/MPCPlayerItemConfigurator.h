@class MPPlaybackEQSetting, NSString, MPCModelGenericAVItem, MPCAudioAssetTypeSelector, MPCPlayerAudioRoute, NSObject, MPCPlaybackEngine, MPAVRoutingController;
...
- (void)_setupPlayer;
- (char)_setupQueueItemForEnhancedAudioHLSPlayback:(id)a0 playerItem:(id)a1 metadataWaitTime:(double *)a2 error:(id *)a3;
...
- (char)configureQueueItem:(id)a0 playerItem:(id)a1 error:(id *)a2;
...
- (char)updateCurrentAudioRouteWithPickedRouteIfNeeded:(id)a0;
