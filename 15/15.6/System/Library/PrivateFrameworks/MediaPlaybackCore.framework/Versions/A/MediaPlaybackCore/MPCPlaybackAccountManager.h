...
@interface MPCPlaybackAccountManager : NSObject <ICEnvironmentMonitorObserver> {
    ...
    char _needsRefreshDueToTimeout;
    char _needsRefreshDueToMissingBag;
...
@property (readonly, nonatomic) char hasLoadedInitialAccounts;
...
- (void)_setNeedsRefreshDueToMissingBag:(char)a0;
