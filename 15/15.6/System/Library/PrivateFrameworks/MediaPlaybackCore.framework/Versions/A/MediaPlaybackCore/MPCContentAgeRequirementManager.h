...
@property (class, readonly, nonatomic) MPCContentAgeRequirementManager *sharedManager;
...
- (char)_askPlaybackAuthorizationForItem:(id)a0 reason:(long long)a1;
...
- (char)_shouldAskPlaybackAuthorizationForItem:(id)a0 reason:(long long)a1;
- (void)_updateAuthorizationStatusWithAuthorizationState:(id)a0 forItem:(id)a1;
- (char)isItemAuthorized:(id)a0;
- (char)isItemAuthorized:(id)a0 shouldAskForAuthorization:(char)a1;
