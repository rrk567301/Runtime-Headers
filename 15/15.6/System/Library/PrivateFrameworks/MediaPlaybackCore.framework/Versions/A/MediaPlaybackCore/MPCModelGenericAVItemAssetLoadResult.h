...
@property (nonatomic) char allowsAssetCaching;
@property (nonatomic) char allowsAssetInfoCaching;
...
@property (nonatomic) char isHomeSharingAsset;
@property (nonatomic) char isHLSAsset;
@property (nonatomic) char isCloudStreamingAsset;
...
@property (nonatomic, getter=isiTunesStoreStream) char iTunesStoreStream;
@property (copy, nonatomic) id /* block */ willBecomeActivePlayerItemHandler;
@property (readonly, nonatomic) char hasValidAsset;
@property (nonatomic) long long audioAssetType;
@property (nonatomic, getter=isDownloadedAsset) char downloadedAsset;
