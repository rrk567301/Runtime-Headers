...
@interface MPCModelStorePlaybackItemsRequestOperation : MPAsyncOperation {
    ...
    char _hasReceivedFinalResponse;
    char _hasCalledResponseHandler;
    char _requiresFollowupRequest;
...
- (void)_handleItemMetadataBatchRequestCompletedWithAccumulator:(id)a0 previousResponse:(id)a1 error:(id)a2 isFinalResponse:(char)a3;
- (id)_localStoreAdamIDToEquivalencySourceStoreAdamIDMap:(id)a0;
- (void)_runPersonalizationWithSectionCollection:(id)a0 localEquivalencyMapping:(id)a1 expirationDate:(id)a2 error:(id)a3 isFinalResponse:(char)a4 isInvalidForPersonalization:(char)a5 performanceMetrics:(id)a6;
