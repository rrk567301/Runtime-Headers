...
+ (char)isSupportedSessionType:(id)a0 forEngine:(id)a1 reason:(id *)a2;
...
- (id)_contentItemIDWithOffset:(long long)a0 fromItemID:(id)a1 mode:(long long)a2 didReachEnd:(char *)a3;
...
- (char)_playerItemDidBecomeActiveWithContentItemID:(id)a0;
...
- (char)_withRestorableBehavior:(id /* block */)a0;
- (char)_withTransportableBehavior:(id /* block */)a0;
...
- (char)canNextTrackForContentItemID:(id)a0 reason:(id *)a1;
- (char)canPreviousTrackForContentItemID:(id)a0 reason:(id *)a1;
- (id)contentItemIDAtIndex:(long long)a0;
- (id)contentItemIDWithCurrentItemOffset:(long long)a0 mode:(long long)a1 didReachEnd:(char *)a2;
...
- (char)isExportableSessionType:(id)a0 forContentItemID:(id)a1 reason:(id *)a2;
- (id)itemForContentItemID:(id)a0;
- (id)itemForContentItemID:(id)a0 allowReuse:(char)a1;
