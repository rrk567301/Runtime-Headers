...
- (void)_completeSignInSignpost:(struct { unsigned long long x0; unsigned long long x1; })a0 forService:(id)a1 context:(id)a2 success:(char)a3 error:(id)a4;
...
- (void)signInToAllServicesInBackground:(char)a0 usingContext:(id)a1 completion:(id /* block */)a2;
