...
- (void)requestFeatureWithId:(id)a0 ignoreCache:(char)a1 completion:(id /* block */)a2;
- (void)requestGeoClassificationFor:(id)a0 bundleID:(id)a1 altDSID:(id)a2 ignoreCache:(char)a3 completion:(id /* block */)a4;
- (void)revalidateCFU;
