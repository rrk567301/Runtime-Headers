...
+ (void)requestGeoClassificationForFeatureID:(id)a0 bundleID:(id)a1 ignoreCache:(char)a2 completion:(id /* block */)a3;
...
+ (void)requestGeoClassificationForFeatureID:(id)a0 bundleID:(id)a1 altDSID:(id)a2 ignoreCache:(char)a3 completion:(id /* block */)a4;
+ (void)revalidateCFU;
+ (void)revalidateCFUWithCompletionHandler:(void (^)(NSError *))a0;
+ (char)shouldShowRSVPDataDetectors;
