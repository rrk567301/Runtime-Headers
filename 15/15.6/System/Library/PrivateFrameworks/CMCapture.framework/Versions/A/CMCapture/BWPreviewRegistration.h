...
@interface BWPreviewRegistration : NSObject {
    ...
    char _excludeStaticComponentFromAlignmentShifts;
}
...
- (id)initWithCameraInfoByPortType:(id)a0 sensorBinningFactor:(struct { int x0; int x1; })a1 registrationType:(int)a2 metalCommandQueue:(id)a3 excludeStaticComponentFromAlignmentShifts:(char)a4;
- (void)registerWiderCamera:(struct opaqueCMSampleBuffer { } *)a0 narrowerCamera:(struct opaqueCMSampleBuffer { } *)a1 widerToNarrowerCameraScale:(double)a2 isMacroScene:(char)a3 macroTransitionType:(int)a4 completionHandler:(id /* block */)a5;
