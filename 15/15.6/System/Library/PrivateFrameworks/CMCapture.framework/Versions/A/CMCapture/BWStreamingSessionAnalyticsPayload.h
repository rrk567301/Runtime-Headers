...
@property (nonatomic) char backgroundBlurApertureChanged;
...
@property (nonatomic) char studioLightingIntensityChanged;
...
@property (nonatomic) char backgroundReplacementPixelBufferChanged;
...
@property (nonatomic) char hitPortraitInPhotoPreviewThermalPressure;
