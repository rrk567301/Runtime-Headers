...
- (void)dealloc;
- (id)initWithConfiguration:(id)a0 videoSourceCaptureOutput:(id)a1 audioSourceCaptureOutput:(id)a2 audioSourceCinematicAudioCaptureOutput:(id)a3 smartCameraInferenceOutput:(id)a4 detectedObjectBoxedMetadataOutputs:(id)a5 objectDetectionSourceOutput:(id)a6 metadataSourcePipelineOutputs:(id)a7 graph:(id)a8 parentPipeline:(id)a9 inferenceScheduler:(id)a10 captureDevice:(id)a11 audioSourceDelegate:(id)a12 fileCoordinatorStatusDelegate:(id)a13 irisRequestDelegate:(id)a14 masterClock:(struct OpaqueCMClock { } *)a15 workgroup:(id)a16 videoGreenGhostMitigationEnabled:(char)a17;
