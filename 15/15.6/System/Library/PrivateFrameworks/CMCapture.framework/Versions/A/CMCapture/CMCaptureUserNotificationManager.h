...
@property (readonly, nonatomic) char responseWasDefault;
@property (readonly, nonatomic) char responseWasAlternate;
@property (readonly, nonatomic) char responseWasOther;
@property (readonly, nonatomic) char responseWasCancelled;
