...
- (char)discontinuityExistsBetweenCurrentPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 previousPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
- (void)enqueueSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 forMediaTypeWithIndex:(long long)a1;
- (void)enqueueVideoBufferTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 nativeTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 isBracketFrame:(char)a2 isSISFrame:(char)a3;
- (id)initWithMediaTypes:(id)a0 visMotionMetadataPreloadingEnabled:(char)a1 generateIFrames:(char)a2 attachedMediaKeysToPreserve:(id)a3;
