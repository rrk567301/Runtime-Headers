...
@property (readonly, nonatomic) char stillImagesAreOptimizedForOfflineVideoStabilization;
...
@property (nonatomic) char videoStabilizationOverscanCropEnabled;

- (void)dealloc;
- (id)initWithStillImageSinkPipeline:(id)a0 cameraSourcePipeline:(id)a1 previewSinkNode:(id)a2 pixelConverter:(id)a3 colorInfo:(id)a4 stillImagesAreOptimizedForOfflineVideoStabilization:(char)a5 videoStabilizationOverscanCropMultiplier:(float)a6 preparedBracket:(id)a7 stillImageConnectionConfiguration:(id)a8;
