...
@interface BWStillImageCoordinatorNode : BWNode <BWFigVideoCaptureStreamStillImageCaptureDelegate, BWStillImageProcessingStatusDelegate> {
    ...
    char _isMomentCaptureProcessingBeforeCommitted;
    ...
    char _responsiveShutterEnabledViaAPI;
...
- (void)dealloc;
- (id)nodeType;
- (void)setFastCapturePrioritizationEnabled:(char)a0;
- (int)stillImageCapturePipeliningMode;
- (void)_configureCurrentCaptureRequestStateForFigCaptureStillImageSettings;
- (int)_enqueueRequestWithSettings:(id)a0 serviceRequestsIfNecessary:(char)a1;
...
- (void)clientReceivedPayloadForSettings:(id)a0 status:(int)a1 clientIsMidStillImageGraph:(char)a2;
...
- (void)setResponsiveShutterEnabled:(char)a0;
- (void)setResponsiveShutterEnabledViaAPI:(char)a0;
- (void)setStillImageCapturePipeliningMode:(int)a0;
- (void)willStopGraph:(char)a0;
