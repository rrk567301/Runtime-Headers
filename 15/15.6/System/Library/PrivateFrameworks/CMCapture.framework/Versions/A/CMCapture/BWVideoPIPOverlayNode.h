...
@interface BWVideoPIPOverlayNode : BWNode {
    ...
    char _useGPUForDrawing;
    float _overCaptureTargetRatio;
    char _overCaptureTargetRatioSmoothingEnabled;
    int _zoomPIPWidth;
    ...
    float _frameRate;
    char _secondaryCameraStreamingEnabled;
    ...
    char _highQualitySamplingEnabled;
    char _isDeviceBravoVariant;
}

@property (nonatomic) char releasesResourcesAtEndOfData;
...
- (id)initWithDelegate:(id)a0 metalCommandQueue:(id)a1 secondaryCameraStreamingEnabled:(char)a2 secondaryCameraFrameRate:(float)a3 maxLossyCompressionLevel:(int)a4 isDeviceBravoVariant:(char)a5 baseZoomFactorsByPortType:(id)a6;
- (id)nodeSubType;
