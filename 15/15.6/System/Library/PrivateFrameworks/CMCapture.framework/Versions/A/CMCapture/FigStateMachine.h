...
@interface FigStateMachine : NSObject {
    ...
    struct FigStateMachineStateConfiguration { char x0; id x1; id x2; id x3; } *_stateConfigurations;
    char _stateCount;
    NSString *_label;
}
...
- (void)dealloc;
- (id)description;
- (char)transitionToState:(unsigned int)a0;
...
- (char)transitionToState:(unsigned int)a0 errorStatus:(int)a1;
- (char)transitionToState:(unsigned int)a0 fromState:(unsigned int)a1;
- (char)transitionToState:(unsigned int)a0 fromStates:(unsigned int)a1;
