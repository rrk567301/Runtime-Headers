...
- (id)initWithAccelerometer:(char)a0 gravityZ:(char)a1 fusedMotion:(char)a2 accelUpdateInterval:(float)a3 fusedMotionUpdateInterval:(float)a4 motionCallbackThreadPriority:(id)a5;
...
- (void)updateDeviceCallback:(char)a0 fusedMotionUpdateInterval:(float)a1;
