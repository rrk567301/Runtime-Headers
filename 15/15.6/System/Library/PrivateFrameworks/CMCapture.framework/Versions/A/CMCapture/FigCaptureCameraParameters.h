...
@property (readonly, nonatomic) char portraitTapToRefocusPrevented;
...
- (char)chromaticDefringingEnabledForSlomoForPortType:(id)a0 sensorIDString:(id)a1;
- (char)chromaticDefringingEnabledForVideoForPortType:(id)a0 sensorIDString:(id)a1;
...
- (char)deepZoomTransferWithZoomedImageEnabledForPortType:(id)a0 sensorIDString:(id)a1;
...
- (char)panoramaRequiresLTMLockingForPortType:(id)a0 sensorIDString:(id)a1;
- (int)personSemanticsVersion;
- (char)portraitPreviewForegroundBlurEnabledForPortType:(id)a0 sensorIDString:(id)a1 zoomFactor:(float)a2;
