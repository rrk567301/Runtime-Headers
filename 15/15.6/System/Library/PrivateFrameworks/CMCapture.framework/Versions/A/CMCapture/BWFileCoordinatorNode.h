...
@interface BWFileCoordinatorNode : BWNode {
    ...
    char _currSettingsIsIrisMovieRecording;
    ...
    char _haveSetupWaitingForRecordingStopState;
...
- (void)setFlagsLastFrameForVideoCompressor:(char)a0;
...
- (void)stopRecordingWithErrorCode:(int)a0 setupToAllowWaitingForRecordingToStop:(char)a1;
- (char)updateStopPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 audioOffset:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 previousStopPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a2 previousAudioOffset:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a3;
