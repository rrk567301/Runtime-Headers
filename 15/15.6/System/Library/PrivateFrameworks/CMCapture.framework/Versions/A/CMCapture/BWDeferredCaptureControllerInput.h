...
@interface BWDeferredCaptureControllerInput : BWStillImageProcessorControllerInput {
    ...
    char _proxyBufferReady;
    char _depthDataGenerationFailed;
...
@property (readonly, nonatomic) char skipInferences;
...
- (void)_addInferenceBuffer:(struct __CVBuffer { } *)a0 metadata:(id)a1 inferenceAttachedMediaKey:(id)a2 portType:(id)a3;
...
- (void)canProcessEnhancedResolution:(char)a0 skipInferences:(char)a1;
- (void)depthDataGenerationFailed;
- (void)encounteredProcessingError:(int)a0;
- (void)proxyReadyWithFPNREnabled:(char)a0;
