...
- (void)fileWriter:(id)a0 writerPipelineIndex:(unsigned long long)a1 stoppedRecordingForSettings:(id)a2 withError:(int)a3 thumbnailSurface:(struct __IOSurface { } *)a4 irisMovieInfo:(id)a5 debugMetadataSidecarFileURL:(id)a6 recordingSucceeded:(char)a7;
...
- (void)imageQueueSinkNode:(id)a0 didAttemptToEnqueuePreviewSampleBuffer:(struct opaqueCMSampleBuffer { } *)a1 withSuccess:(char)a2;
- (void)imageQueueSinkNodeDidDisplayFirstFrame:(id)a0 atHostTime:(long long)a1;
- (void)imageQueueSinkNodeDidDisplayFirstFrame:(id)a0 timedOut:(char)a1;
...
- (void)previewStitcher:(id)a0 didApplyWiderShift:(struct CGPoint { double x0; double x1; })a1 widerScaleFactor:(float)a2 forWiderPortType:(id)a3 narrowerShift:(struct CGPoint { double x0; double x1; })a4 narrowerScaleFactor:(float)a5 forNarrowerPortType:(id)a6 inSuperWideMacroMode:(char)a7 widerShiftAtBaseZoom:(struct CGPoint { double x0; double x1; })a8;
...
- (void)stillImageCoordinator:(id)a0 didResolveStillImagePTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 forSettings:(id)a2 isPreBracketedEV0:(char)a3;
...
- (void)stillImageCoordinator:(id)a0 willPrepareStillImageCaptureWithSettings:(id)a1 clientInitiated:(char)a2;
