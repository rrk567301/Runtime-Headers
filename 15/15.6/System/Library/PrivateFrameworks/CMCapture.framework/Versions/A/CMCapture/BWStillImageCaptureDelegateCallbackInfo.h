...
@property (readonly, nonatomic) char isPreBracketFrame;

- (id)initWithFlag:(unsigned int)a0;
- (id)initWithFlag:(unsigned int)a0 pts:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 isPreBracketFrame:(char)a2;
