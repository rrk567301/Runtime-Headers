...
- (id)initWithCaptureDevice:(id)a0 processingQueuePriority:(unsigned int)a1 timeMachineCapacity:(int)a2 smartCameraMotionDetectionEnabled:(char)a3 sinkID:(id)a4;
- (id)nodeSubType;
