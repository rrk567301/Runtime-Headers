...
- (id)description;
- (char)dimensionsAreEqualToDimensions:(struct { int x0; int x1; })a0;
- (id)initWithDimensions:(struct { int x0; int x1; })a0 deferredPhotoProxyDimensions:(struct { int x0; int x1; })a1 isPrivate:(char)a2 flavor:(int)a3 maxUpscalingDimensions:(struct { int x0; int x1; })a4;
