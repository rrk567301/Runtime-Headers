...
@property (readonly, nonatomic) char requiresDepthMap;
@property (readonly, nonatomic) char requiresFaceLandmarks;
...
+ (void)initialize;
+ (char)containsFilterRequiringFaceLandmarks:(id)a0;
