...
- (char)hasBufferForType:(unsigned long long)a0 portType:(id)a1;
- (char)hasInference:(id)a0 portType:(id)a1;
- (char)hasInferenceBuffer:(id)a0 portType:(id)a1;
- (id)initWithApplicationID:(id)a0 captureRequestIdentifier:(id)a1 baseFolderURL:(id)a2 openForPeeking:(char)a3 err:(int *)a4;
