...
@property (readonly, nonatomic, getter=isDisplayConnected) char displayConnected;
@property (readonly, nonatomic) FigCaptureDisplayLayout *currentLayout;
@property (readonly, nonatomic, getter=isOnHomeScreen) char onHomeScreen;
@property (readonly, nonatomic, getter=isOnLockScreen) char onLockScreen;
