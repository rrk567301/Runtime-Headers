...
@interface FigObjectDetectionMetadataGenerator : NSObject {
    ...
    char _objectDetectionIsRunning;
...
@property char humanFaceEyeDetectionEnabled;
@property char humanFaceSmileDetectionEnabled;
@property char humanFaceBlinkDetectionEnabled;
...
- (void)dealloc;
- (id)init;
- (id)getCurrentDetectedObjectsAndPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; } *)a0;
