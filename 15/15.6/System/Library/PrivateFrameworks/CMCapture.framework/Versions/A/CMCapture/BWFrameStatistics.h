...
@property (readonly, nonatomic) char aeLimitsReached;
@property (readonly, nonatomic) char aeStable;
@property (readonly, nonatomic) char aeLocked;
@property (readonly, nonatomic) int motionFromAEMatrix;
@property (readonly, nonatomic) NSDictionary *aeStatistics;
@property (readonly, nonatomic) char hrEnabled;
@property (readonly, nonatomic) float sifrGain;
@property (readonly, nonatomic) int afStatus;
@property (readonly, nonatomic) char afLocked;
...
@property (readonly, nonatomic) char awbStable;
@property (readonly, nonatomic) char awbLocked;
...
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; float x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; float x7; float x8; double x9; unsigned int x10; unsigned int x11; unsigned int x12; float x13; float x14; float x15; double x16; unsigned int x17; unsigned int x18; unsigned int x19; char x20; char x21; char x22; int x23; char x24; float x25; int x26; char x27; int x28; int x29; int x30; int x31; int x32; int x33; int x34; int x35; float x36; id x37; unsigned int x38; float x39; int x40; char x41; char x42; unsigned short x43; unsigned short x44; unsigned short x45; unsigned short x46; unsigned short x47; unsigned short x48; unsigned short x49; unsigned short x50; unsigned short x51; unsigned int x52; unsigned int x53; } *)frameStatisticsStorage;
