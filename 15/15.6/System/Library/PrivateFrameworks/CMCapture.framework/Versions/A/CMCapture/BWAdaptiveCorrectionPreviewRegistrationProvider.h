...
- (id)initWithCameraInfoByPortType:(id)a0 excludeStaticComponentFromAlignmentShifts:(char)a1;
- (struct { struct { char x0; struct CGPoint { double x0; double x1; } x1; } x0[3]; })registerWiderCamera:(struct opaqueCMSampleBuffer { } *)a0 narrowerCamera:(struct opaqueCMSampleBuffer { } *)a1 widerToNarrowerCameraScale:(double)a2 isMacroScene:(char)a3 macroTransitionType:(int)a4;
