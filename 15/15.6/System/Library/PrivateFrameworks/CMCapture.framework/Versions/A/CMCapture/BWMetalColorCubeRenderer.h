...
@interface BWMetalColorCubeRenderer : NSObject <BWFilterRenderer> {
    ...
    char _mixingColorCubesInGammaDomain;
    float _previousInterpolationFractionComplete;
}

@property (readonly, nonatomic) char mixingColorCubesInGammaDomain;
...
- (id)initWithMetalCommandQueue:(id)a0 mixInGammaDomain:(char)a1;
