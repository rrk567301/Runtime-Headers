@class NSDictionary, BWInferenceResultRingBuffers, BWStereoVideoCaptureAnalyticsPayload, NSMutableArray, BWIrisMovieGenerator, BWIrisStillImageMovieMetadataCache, BWMovieFileOutputAnalyticsPayload, NSString, BWObjectRingBuffer, BWObjectRingBufferThreadSafe, NSArray, NSMutableDictionary, FigCaptureMovieFileRecordingSettings, BWMovingWindowStats, NSObject, BWMedianStats, BWVideoOrientationTimeMachine, BWLimitedGMErrorLogger, BWVideoStabilizationAnalyticsPayload, BWIrisMovieInfo, BWStats, NSNumber, BWVideoQualityMetrics;
...
@interface BWQuickTimeMovieFileSinkNode : BWFileSinkNode {
    ...
    char _recordingIsForExternalCamera;
    ...
    char _collectedAnalyticsForModuleAndCalibrationValidationStatuses;
    ...
    struct BWCoreAnalyticsMovieRecordingVideoSTFStatistics { char videoSTFEnabled; NSString *cancelReason; float videoSTFAppliedFrameCountPercentage; float largestMaxCorrectionLevel; int version; unsigned int lowMeanCorrectionLevelFrameCount; unsigned int moderateMeanCorrectionLevelFrameCount; unsigned int highMeanCorrectionLevelFrameCount; unsigned int veryHighMeanCorrectionLevelFrameCount; unsigned int extremeMeanCorrectionLevelFrameCount; } _videoSTFStats;
    ...
    char _videoStabilizationAnalyticsExtracted;
...
@property (nonatomic) char irisMovieProcessingSuspended;
...
- (void)setIrisSampleReferenceMoviesEnabled:(char)a0;
