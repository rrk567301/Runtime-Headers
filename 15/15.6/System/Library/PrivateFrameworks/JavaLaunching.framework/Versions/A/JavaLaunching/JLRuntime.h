...
+ (id)preferredRuntimeForTool:(id)a0 fallbackOnSupported:(char)a1 error:(id *)a2;
...
- (int)spawnTool:(id)a0 arguments:(id)a1 setExec:(char)a2 error:(id *)a3;
- (char)supportsTool:(id)a0;
