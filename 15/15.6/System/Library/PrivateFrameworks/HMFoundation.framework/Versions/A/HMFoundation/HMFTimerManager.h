...
- (char)_cancelTimerManagerIfEmpty;
...
- (void)notifyDidFireForTimerContexts:(id)a0 shouldDispatch:(char)a1;
- (void)refreshTimerManager;
- (void)refreshTimerManagerWithShouldDispatchNotifications:(char)a0;
- (id)startTimerWithTimeInterval:(double)a0 andReplaceObject:(id)a1;
- (id)startTimerWithTimeInterval:(double)a0 object:(id)a1;
- (id)startTimerWithTimeInterval:(double)a0 object:(id)a1 shouldReplace:(char)a2;
