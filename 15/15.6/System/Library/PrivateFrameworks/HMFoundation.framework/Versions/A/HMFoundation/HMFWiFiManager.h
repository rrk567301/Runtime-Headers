...
@property (readonly, getter=isCaptive) char captive;
...
- (char)currentNetworkRequiresPassword;
- (void)dataSource:(id)a0 didChangeLinkAvailability:(char)a1;
- (void)dataSource:(id)a0 didChangeWoWState:(char)a1;
