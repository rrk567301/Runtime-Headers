...
@protocol HMFSystemInfoMigrationDataSource, HMFSystemInfoSoftwareVersionDataSource, HMFSystemInfoNameDataSource, HMFSystemInfoProductInfoDataSource, HMFSystemInfoProductColorDataSource, HMFSystemInfoSerialNumberDataSource, HMFSystemInfoMarketingInformationDataSource, HMFSystemInfoBluetoothLEDataSource, HMFSystemInfoWiFiDataSource;
...
@property (readonly, getter=isMigrating) char migrating;
...
- (void).cxx_destruct;
- (void)dataSource:(id)a0 didUpdateMigrating:(char)a1;
