...
- (id)_createDelegateMetadataForACAccount:(id)a0 delegateKey:(id)a1 email:(id)a2 fullname:(id)a3 readOnly:(char)a4;
- (id)_loadAccountsMetadataFromDatabase;
- (id)_updateAccountMetadataForACAccount:(id)a0;
- (char)_updateDelegateMetadataForDelegateKey:(id)a0 enabledClasses:(unsigned long long)a1;
- (char)_updateDelegateMetadataForDelegateKey:(id)a0 sourceIdentifier:(id)a1;
...
- (id)createDelegateMetadataForACAccount:(id)a0 delegateKey:(id)a1 email:(id)a2 fullname:(id)a3 readOnly:(char)a4;
- (id)exchangeSyncDirectory;
- (void)fillAuditCacheFromDBUsingConnection:(id)a0;
- (id)loadAccountsMetadataFromDatabase;
- (char)metadataExistsForACAccount:(id)a0;
- (void)migrateToPerAccountDatabases;
- (char)persistAuditLogItemOfType:(long long)a0 timestamp:(id)a1 initiatedBy:(id)a2 description:(id)a3 result:(id)a4 accountID:(long long)a5 changeSourceID:(id)a6 itemID:(long long)a7 usingDBConnection:(id)a8;
...
- (char)updateDelegateMetadataForDelegateKey:(id)a0 enabledClasses:(unsigned long long)a1;
- (char)updateDelegateMetadataForDelegateKey:(id)a0 sourceIdentifier:(id)a1;
