...
@property char networkIsReachable;
...
- (void)fireNetworkReachabilityChanged:(char)a0;
- (char)_accountNeedsCalendarDataMigration:(long long)a0;
- (char)_accountNeedsDelegatePermissionCheck:(char)a0;
...
- (char)startupWithPermissionCheck:(char)a0 migratedData:(char *)a1;
