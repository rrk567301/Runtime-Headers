...
@property (nonatomic) char uploadSuppressed;

+ (id)log;
+ (id)createAttachmentFromPropertiesDictionary:(id)a0;
+ (id)createEXSAttachmentWithName:(id)a0 identifier:(id)a1 contentType:(id)a2 contentID:(id)a3 contentLocation:(id)a4 shouldInline:(char)a5 lastModifiedTime:(id)a6 attachmentSize:(long long)a7 optionalURLString:(id)a8 andConsumerUUID:(id)a9;
