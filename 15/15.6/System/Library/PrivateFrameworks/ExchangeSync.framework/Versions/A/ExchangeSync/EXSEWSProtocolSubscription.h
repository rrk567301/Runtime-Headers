...
@property (nonatomic) char isDelegateAccount;
...
- (id)initSubscriptionWithAccount:(id)a0 delegate:(id)a1 folderIDs:(id)a2 isDelegateAccount:(char)a3;
- (char)shouldListenToAllStreamingSubscriptionResponses;
- (char)shouldSyncUponReceivingResponse:(id)a0;
