...
@property (nonatomic) char pendingResync;
...
- (char)sendGetGrantedDelegatesRequest:(id)a0;
...
- (char)sendGrantedDelegateRequest:(id)a0;
- (char)sendSearchDirectoryRequest:(id)a0;
