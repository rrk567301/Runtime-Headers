...
- (id)_addDelegateForOwningACAccount:(id)a0 delegateEmail:(id)a1 delegateFullname:(id)a2 readOnly:(char)a3;
- (char)_arePushPollOptionsEqualForACAccount:(id)a0 with:(id)a1;
...
- (char)exchangeAccountIsTracked:(id)a0;
