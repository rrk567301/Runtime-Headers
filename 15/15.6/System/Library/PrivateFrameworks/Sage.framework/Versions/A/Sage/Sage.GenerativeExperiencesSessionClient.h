...
- (void)sessionDidProduceCompletionResponseFor:(id)a0 element:(id)a1 isComplete:(char)a2;
- (void)sessionDidProduceDocumentRegistrationStatusFor:(id)a0 documentID:(long long)a1 registrationStatus:(id)a2 isComplete:(char)a3;
