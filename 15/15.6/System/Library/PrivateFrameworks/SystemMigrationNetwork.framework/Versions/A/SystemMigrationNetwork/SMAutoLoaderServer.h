...
@property char networkServerShouldBeUp;
...
+ (char)canGenerateValidTXTRecordForSourcePath:(id)a0;
...
- (id)initWithName:(id)a0 usingSourcePath:(id)a1 type:(id)a2 usingSSL:(char)a3;
