...
@property char receivedEOAMarker;
...
- (char)_readCompletelyFromFd:(int)a0 buffer:(void *)a1 length:(unsigned long long)a2;
- (char)_writeCompletelyToFd:(int)a0 buffer:(const void *)a1 length:(unsigned long long)a2;
...
- (void)receivedEOA;
- (char)shouldPreserveProtectionClassesForDestinationPath:(id)a0;
- (char)shouldSkip:(const char *)a0 ofType:(int)a1;
