...
@property char upstreamReadClosed;
@property char upstreamWriteClosed;
@property char downstreamReadClosed;
@property char downstreamWriteClosed;
...
- (char)changeMode:(unsigned long long)a0;
...
- (void)closeDownwardWrite:(char)a0;
- (void)closeUpwardRead:(char)a0;
...
- (char)readDictionary:(id *)a0 error:(id *)a1 shouldDecodeClasses:(id)a2;
- (void)setReadHandleClosed;
- (void)setReadHandleClosed:(char)a0;
- (void)setWriteHandleClosed;
- (void)setWriteHandleClosed:(char)a0;
