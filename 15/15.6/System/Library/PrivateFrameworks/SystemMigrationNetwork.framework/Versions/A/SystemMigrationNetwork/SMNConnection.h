...
@property char secretPasswordValidated;
...
- (void)startSampling;
- (char)startWithTimeout:(char)a0;
- (void)registerActivity;
- (char)readCommandFromControl:(unsigned int *)a0 payload:(id *)a1;
...
- (char)doLegacyControlHandshake:(char)a0;
- (void)doLegacySample;
- (void)externalRegisterActivity;
- (char)handshakeControl;
- (id)initWithSocketFileHandle:(id)a0 forSession:(id)a1 asServer:(char)a2 connectionName:(id)a3 forRemoteSystemType:(unsigned long long)a4;
...
- (char)samplingAfterWaitingForCompletionUpTo:(double)a0;
...
- (char)writeCommandToControl:(unsigned int)a0 payload:(id)a1;
