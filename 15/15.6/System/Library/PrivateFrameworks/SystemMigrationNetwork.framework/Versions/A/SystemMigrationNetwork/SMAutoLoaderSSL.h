...
+ (void)persistKeychainAndCertificates:(char)a0;
+ (void)deleteKeychain;
...
+ (char)doSynchronousPairingWithPasscode:(unsigned long long)a0;
+ (struct __SecCertificate { } *)generateSelfSignedCertificate:(id)a0 forSSLServer:(char)a1;
