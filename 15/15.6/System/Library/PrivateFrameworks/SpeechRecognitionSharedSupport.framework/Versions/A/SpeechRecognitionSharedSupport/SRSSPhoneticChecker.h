...
- (char)_loadConfusionMatrixFromJsonFile:(id)a0;
- (char)_loadConfusionMatrixWithModelPath:(id)a0 localization:(id)a1;
...
- (id)initWithLocaleIdentifier:(id)a0 modelPath:(id)a1 syncronously:(char)a2;
