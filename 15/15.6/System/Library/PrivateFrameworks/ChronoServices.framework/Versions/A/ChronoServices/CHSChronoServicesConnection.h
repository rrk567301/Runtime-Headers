...
@interface CHSChronoServicesConnection : NSObject <CHSChronoWidgetServiceClientInterface> {
    ...
    char _queue_connectionIsActive;
...
- (id)_initWithMachServiceName:(id)a0 listenForReconnect:(char)a1;
...
- (id)_queue_remoteTargetCreatingConnectionIfNecessary:(char)a0;
...
- (char)reloadTimeline:(id)a0 error:(id *)a1;
