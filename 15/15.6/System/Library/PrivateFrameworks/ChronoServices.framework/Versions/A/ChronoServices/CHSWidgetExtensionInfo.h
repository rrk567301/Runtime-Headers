...
@property (readonly, nonatomic) char disablesImplicitDiscovery;
@property (readonly, nonatomic) char isDevelopmentExtension;
@property (readonly, nonatomic) char wantsLocation;
@property (readonly, copy, nonatomic) NSArray *availableLocalizations;
@property (readonly, nonatomic) char allowsMixedLocalizations;
