...
- (char)reloadRemoteWidgetsWithError:(id *)a0;
- (char)remoteWidgetsEnabled;
- (char)toggleRemoteWidgetsEnabled:(char)a0 error:(id *)a1;
- (char)unpairDevice:(id)a0 error:(id *)a1;
