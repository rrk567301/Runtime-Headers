...
@property (nonatomic) char disablesImplicitDiscovery;
@property (nonatomic) char isDevelopmentExtension;
@property (nonatomic) char wantsLocation;
@property (copy, nonatomic) NSArray *availableLocalizations;
@property (nonatomic) char allowsMixedLocalizations;
...
- (void)setAllowsMixedLocalizations:(char)a0;
...
- (void)setDisablesImplicitDiscovery:(char)a0;
- (void)setEffectiveContainerBundleIdentifier:(id)a0;
- (void)setIsDevelopmentExtension:(char)a0;
