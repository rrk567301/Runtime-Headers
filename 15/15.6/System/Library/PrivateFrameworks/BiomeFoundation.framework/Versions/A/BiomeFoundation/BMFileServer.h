...
- (char)isPrimaryDaemon;
- (char)allowedToAccessStream:(id)a0 withMode:(int)a1 error:(id *)a2;
- (void)createDirectoryAtPath:(id)a0 reply:(id /* block */)a1;
- (id)currentUseCase;
- (char)entitledToAccessClientCompute:(id)a0 error:(id *)a1;
- (char)entitledToAccessSharedSyncWithError:(id *)a0;
