...
+ (id)stringFromSize:(struct { double x0; char x1; double x2; char x3; })a0;
...
+ (struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; char x1; double x2; char x3; } x1; })rectFromString:(id)a0;
+ (struct { double x0; char x1; double x2; char x3; })sizeFromString:(id)a0;
+ (id)stringFromRect:(struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; char x1; double x2; char x3; } x1; })a0;
...
+ (struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; double x1; char x2; char x3; } x1; })lineFromString:(id)a0;
+ (id)stringFromLine:(struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; double x1; char x2; char x3; } x1; })a0;
...
+ (struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; char x1; double x2; char x3; } x1; })ellipseFromString:(id)a0;
...
+ (struct CGPoint { double x0; double x1; })physicalPointForRelativePoint:(struct { double x0; double x1; char x2; char x3; })a0 inScaledRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 scale:(double)a2;
+ (struct { double x0; char x1; double x2; char x3; double x4; char x5; double x6; char x7; })physicalRectInsetForRelativeRectInset:(struct { double x0; char x1; double x2; char x3; double x4; char x5; double x6; char x7; })a0 inScaledRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 scale:(double)a2;
+ (struct CGSize { double x0; double x1; })physicalSizeForRelativeSize:(struct { double x0; char x1; double x2; char x3; })a0 inScaledRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 scale:(double)a2;
+ (struct { double x0; double x1; char x2; char x3; })pointFromString:(id)a0;
...
+ (struct { double x0; char x1; double x2; char x3; double x4; char x5; double x6; char x7; })rectInsetFromString:(id)a0;
...
+ (char)size:(struct CGSize { double x0; double x1; })a0 isLargerThanSize:(struct CGSize { double x0; double x1; })a1;
...
+ (id)stringFromEllipse:(struct { struct { double x0; double x1; char x2; char x3; } x0; struct { double x0; char x1; double x2; char x3; } x1; })a0;
+ (id)stringFromPoint:(struct { double x0; double x1; char x2; char x3; })a0;
+ (id)stringFromRectInset:(struct { double x0; char x1; double x2; char x3; double x4; char x5; double x6; char x7; })a0;
