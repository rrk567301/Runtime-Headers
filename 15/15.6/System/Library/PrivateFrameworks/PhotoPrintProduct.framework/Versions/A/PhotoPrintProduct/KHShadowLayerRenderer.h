...
@interface KHShadowLayerRenderer : KHLayerRenderer {
    ...
    struct { double x; double y; char isRelativeX; char isRelativeY; } _offset;
    double _blur;
    char _isInnerShadow;
    struct { double width; char isRelativeWidth; double height; char isRelativeHeight; } _choke;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _upperLeftShadowOffset;
    double _upperLeftShadowRadius;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _upperRightShadowOffset;
    double _upperRightShadowRadius;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _lowerLeftShadowOffset;
    double _lowerLeftShadowRadius;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _lowerRightShadowOffset;
    double _lowerRightShadowRadius;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _leftBend;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _rightBend;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _topBend;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _bottomBend;
}
