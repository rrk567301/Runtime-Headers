...
@property (readonly, nonatomic) char needsPlaceholderImage;
@property (readonly, nonatomic) NSMutableArray *backfillOperations;
@property (readonly, nonatomic) NSLock *backfillOperationsLock;
@property (readonly, nonatomic) struct { double x0; double x1; char x2; char x3; } adjustedPhotoPan;
...
@property (nonatomic) struct { double top; char isTopRelative; double left; char isLeftRelative; double bottom; char isBottomRelative; double right; char isRightRelative; } bleedInsets;
...
@property (nonatomic) char panArrowsHidden;
