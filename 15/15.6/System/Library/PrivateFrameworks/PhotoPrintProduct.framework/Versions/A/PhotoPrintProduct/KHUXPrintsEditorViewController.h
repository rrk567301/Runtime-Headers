...
@property (nonatomic) char didShowAlertAboutCroppedPhotos;
@property char prefetchAllowed;
...
- (void)dismissCheckoutViewControllerForSuccess:(char)a0;
- (void)dismissForSuccess:(char)a0;
- (id)initWithProjectBundleController:(id)a0;
- (void)payload:(id)a0;
- (void)removePhotoLayouts:(id)a0 confirm:(char)a1;
