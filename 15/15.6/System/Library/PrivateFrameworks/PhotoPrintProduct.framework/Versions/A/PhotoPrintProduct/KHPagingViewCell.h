...
@property (nonatomic) char adjustingContentInset;
@property (nonatomic) char zoomingToRectForTextEditing;
...
- (void)liveZoomToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 animated:(char)a1;
...
- (char)shouldBeginInteractiveTransitionAtPoint:(struct CGPoint { double x0; double x1; })a0;
