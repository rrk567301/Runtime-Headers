...
@property char useRealMetrics;
@property char honorFlipped;
...
- (void)_setFrameSize:(struct CGSize { double x0; double x1; })a0 forceScroll:(char)a1;
...
- (void)setNeedsDisplayInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 avoidAdditionalLayout:(char)a1;
...
- (char)shouldHandlePoint:(struct CGPoint { double x0; double x1; })a0;
