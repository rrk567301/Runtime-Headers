...
@property (nonatomic) char generateThumbnails;
...
+ (char)writeImage:(struct CGImage { } *)a0 toPath:(id)a1 option:(id)a2;

- (void)dealloc;
- (void).cxx_destruct;
- (id)initWithProject:(id)a0;
- (char)generateBitmapImageAtPath:(id)a0 forLayout:(id)a1;
