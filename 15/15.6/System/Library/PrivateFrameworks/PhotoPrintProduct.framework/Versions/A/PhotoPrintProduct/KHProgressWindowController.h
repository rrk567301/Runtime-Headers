...
- (void)_updateLabel;
- (void)windowDidLoad;
- (char)windowShouldZoom:(id)a0 toFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
...
- (void)driveControllerWithIndeterminateProgress:(id)a0 showCancelButton:(char)a1;
