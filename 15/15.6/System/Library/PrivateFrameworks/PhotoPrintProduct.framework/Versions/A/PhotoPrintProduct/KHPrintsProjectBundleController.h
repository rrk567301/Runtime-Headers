...
+ (char)canOrderPrintsForPhotos:(id)a0 error:(id *)a1;
...
- (void)warmUpCaches;
- (char)hasProjectGroup;
- (void)removeForReuse:(char)a0;
...
- (char)_canAddNumberOfPrints:(unsigned long long)a0 error:(id *)a1;
...
- (void)_notifyProjectBundleResetForReuse:(char)a0;
- (void)_notifyWillChangeContent;
- (id)_photosInProjectSubgroup:(id)a0;
- (id)_projectSubgroupForProductSubgroup:(id)a0 createIfNecessary:(char)a1;
...
- (char)addProjectLayouts:(id)a0 toProductSubgroup:(id)a1 error:(id *)a2;
- (void)borderOptionsDidChange;
- (char)canAddPhotos:(id)a0 error:(id *)a1;
- (char)canAddSizeForPhotosInProjectSubgroup:(id)a0 error:(id *)a1;
- (char)canAddSizeForProjectLayouts:(id)a0 error:(id *)a1;
...
- (char)hasProjects;
- (char)hasProvisionalProductSubgroup;
