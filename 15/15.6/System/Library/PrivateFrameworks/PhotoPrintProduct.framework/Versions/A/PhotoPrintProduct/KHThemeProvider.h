...
@property (readonly) char isThemeLocal;
@property (readonly) char isThemePreviewLocal;
@property (readonly) char isThemeValid;
@property (readonly) char isThemePreviewValid;
...
+ (id)_bulkDownload:(char)a0 forThemeProviders:(id)a1 completionBlock:(id /* block */)a2;
