...
@interface KHArtLayerRenderer : KHLayerRenderer {
    ...
    KHAsset *_asset;
    char _stretch;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _location;
    struct { double width; char isRelativeWidth; double height; char isRelativeHeight; } _size;
    char _relative;
    char _mirrorX;
    char _mirrorY;
}
