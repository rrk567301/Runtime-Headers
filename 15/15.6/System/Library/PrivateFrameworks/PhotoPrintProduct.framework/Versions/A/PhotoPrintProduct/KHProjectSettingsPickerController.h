...
@property char allowsAppleLogoButton;
@property char allowsPageNumberControl;
@property (nonatomic) char allowsAutoLayoutButton;
@property (nonatomic) char allowsChangeProductButton;
