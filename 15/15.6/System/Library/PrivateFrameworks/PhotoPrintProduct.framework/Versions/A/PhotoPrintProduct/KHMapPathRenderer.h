...
+ (char)_isThemeIdForTexturesAndShadowsEnabled:(id)a0;
+ (id)mapStyleConfigurationIdForThemeId:(id)a0;
+ (id)themeIdForMapStyleConfigurationId:(id)a0 texturesAndShadowsEnabled:(char)a1;
...
- (id)_treatmentForStyleKey:(unsigned long long)a0 themeId:(id)a1 quickRender:(char)a2;
- (id)availableThemeIds;
- (void)renderIntoContext:(struct CGContext { } *)a0 contextRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 contextRectScale:(double)a2 paths:(id)a3 themeId:(id)a4 styleKey:(unsigned long long)a5 quickRender:(char)a6;
