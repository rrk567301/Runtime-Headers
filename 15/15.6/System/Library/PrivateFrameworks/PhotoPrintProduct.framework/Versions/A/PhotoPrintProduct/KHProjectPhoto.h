...
+ (char)hasUnplacedPhotosInProject:(id)a0;
...
- (char)isProjectModel;
- (id)photoInfo;
- (void)setIsExtra:(char)a0 notify:(char)a1;
...
- (void)undoRedoSetIsExtra:(char)a0;
- (void)undoRedoSetIsExtra:(char)a0 notify:(char)a1;
