...
@interface KHBookGridLayout : UXCollectionViewLayout {
    ...
    char _needsDelegateFlagsUpdate;
}
...
- (id)_layoutAttributesForElementsInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 includeSpacing:(char)a1;
- (id)_verticalLayoutAttributesForIndexPaths:(id)a0;
- (char)indexPathIsLeading:(id)a0;
- (char)indexPathIsLeft:(id)a0;
