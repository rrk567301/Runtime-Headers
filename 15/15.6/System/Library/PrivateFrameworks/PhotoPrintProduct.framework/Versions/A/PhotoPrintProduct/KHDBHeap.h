...
@property (nonatomic) char sortAscending;
@property (nonatomic) char useLocking;
...
- (id)topObject;
- (id)removeTopObject;
- (char)valueForOption:(unsigned int)a0;
...
- (void)setValue:(char)a0 forOption:(unsigned int)a1;
