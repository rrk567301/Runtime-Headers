...
@property (nonatomic) char selectionShouldStealFocus;
...
@property (nonatomic) char updatingSelection;
@property (nonatomic) char updatingContent;
@property (nonatomic) char requiresContentUpdateOnAppear;
...
@property (nonatomic) char canDeleteContents;
@property (nonatomic) char shouldHandleDraggingEvents;
...
- (char)collectionView:(id)a0 shouldBeginDraggingSessionWithClickedItemAtIndexPath:(id)a1;
...
- (void)markPhoto:(id)a0 transitioning:(char)a1;
...
- (void)updateSelectionWithPhotos:(id)a0 scroll:(char)a1 animated:(char)a2;
