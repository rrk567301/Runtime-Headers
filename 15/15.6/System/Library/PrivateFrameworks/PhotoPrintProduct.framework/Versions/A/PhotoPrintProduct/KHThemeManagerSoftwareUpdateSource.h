...
@property (readonly, nonatomic) char sourceIsLocal;
...
- (id)_URLForThemeProvider:(id)a0 preview:(char)a1;
- (id)_bulkPrepareThemeProvidersForUse:(id)a0 isPreview:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_tearDownXPC;
- (id)_themeProvidersForCatalog:(id)a0 forcedProductCodes:(id)a1 onlyLocalThemes:(char)a2;
- (id)_themeProvidersWithinCatalog:(char)a0;
...
- (char)isThemeLocal:(id)a0;
- (char)isThemePreviewLocal:(id)a0;
- (char)isThemePreviewValid:(id)a0;
- (char)isThemeValid:(id)a0;
