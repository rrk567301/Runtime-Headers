...
- (void)setBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withInset:(char)a1;
- (void)setPosition:(struct CGPoint { double x0; double x1; })a0 withInset:(char)a1;
