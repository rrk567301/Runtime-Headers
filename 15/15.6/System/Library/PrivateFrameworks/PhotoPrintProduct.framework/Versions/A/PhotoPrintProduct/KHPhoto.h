...
- (char)pageLayoutImageHasBorderEffects;
...
- (char)pageLayoutImageExists;
- (char)pageLayoutImageExistsSuitableForSize:(struct CGSize { double x0; double x1; })a0;
- (char)pageLayoutImageHasColorAdjustments;
- (char)pageLayoutImageHasLightAdjustments;
- (char)pageLayoutImageHasRedEyeAdjustments;
...
- (char)pageLayoutImageValid;
- (char)pageLayoutImageValidSuitableForSize:(struct CGSize { double x0; double x1; })a0;
