...
@property (readonly, nonatomic) char storeIsAvailable;
@property (readonly, nonatomic) char cartNeedsReset;
@property (readonly, nonatomic) char shouldDisplayShippingCosts;
@property (readonly, nonatomic) char shouldConfirmStoreCountry;
