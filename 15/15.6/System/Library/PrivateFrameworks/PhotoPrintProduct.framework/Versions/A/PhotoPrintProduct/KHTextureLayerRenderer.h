...
- (void)dealloc;
- (id)asset;
- (struct CGSize { double x0; double x1; })_calculateTileSizeInDrawRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 scale:(double)a1 isPDFDestination:(char)a2;
- (void)_cgPatternFillInContext:(struct CGContext { } *)a0 scale:(double)a1 isPDFDestination:(char)a2 drawPath:(struct CGPath { } *)a3;
...
- (void)_hiResLayerFillInContext:(struct CGContext { } *)a0 scale:(double)a1 isPDFDestination:(char)a2 drawPath:(struct CGPath { } *)a3;
