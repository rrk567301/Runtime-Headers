...
- (void)showAtPoint:(struct CGPoint { double x0; double x1; })a0 animated:(char)a1;
- (void)showWithText:(id)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 animated:(char)a2;
