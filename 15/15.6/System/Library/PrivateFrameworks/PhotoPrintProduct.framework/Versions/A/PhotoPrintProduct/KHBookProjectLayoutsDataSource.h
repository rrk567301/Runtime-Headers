...
- (id)title;
- (id)undoManager;
- (char)_canMoveLayoutsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 toIndex:(long long)a1;
- (id)indexPathForProjectLayoutIndex:(unsigned long long)a0;
- (char)_addLayoutAtIndexPath:(id)a0 spread:(char)a1;
- (char)_isSoftcoverProductType;
- (char)_placementIsCoverOrFlapForLayoutAtIndexPath:(id)a0;
- (char)_shouldExchangeLayoutAtIndex:(long long)a0 withProposedIndex:(long long)a1;
...
- (char)addSpreadLayoutAtIndexPath:(id)a0;
- (char)adjustDensitySetting:(unsigned long long)a0 createDatabaseObjects:(char)a1;
...
- (char)removeLayoutsAtIndexPaths:(id)a0;
