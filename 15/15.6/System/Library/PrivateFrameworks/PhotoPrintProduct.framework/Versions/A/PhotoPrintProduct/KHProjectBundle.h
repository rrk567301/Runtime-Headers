...
@property (readonly, nonatomic) char previewImageExists;
...
- (id)databaseActivityWithReason:(id)a0 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
...
- (void)notifyResetForReuse:(char)a0;
...
- (id)previewImageWithSize:(struct CGSize { double x0; double x1; })a0 hash:(unsigned long long)a1 ignorePlaceholder:(char)a2;
