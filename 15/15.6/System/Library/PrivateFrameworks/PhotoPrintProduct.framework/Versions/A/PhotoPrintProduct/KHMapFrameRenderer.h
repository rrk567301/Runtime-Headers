...
- (void)dealloc;
- (void)clearCache;
- (void)_centerAndZoomMapAroundMarkers:(char)a0;
...
- (char)_updateMapMarkerConnectors:(id)a0 scale:(double)a1;
...
- (struct CGPoint { double x0; double x1; })centerLatLongWithPan:(struct { double x0; double x1; char x2; char x3; })a0;
...
- (char)refreshMapFrameDefaultMarkers;
- (void)refreshMapHUD;
