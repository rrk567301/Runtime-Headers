...
@interface PIEPhotoGroupAnalyzer : NSObject {
    ...
    char _geoDistanceRangeCalculated;
...
- (id)_dynamicProgrammingByPhotoAffinityWithHoleCounts:(id)a0 photos:(id)a1 startIndex:(unsigned long long)a2 length:(unsigned long long)a3 minSlices:(unsigned long long)a4 maxSlices:(unsigned long long)a5 allowDroppingPhotos:(char)a6 favoredHoleCountCycle:(id)a7 segmentationMap:(id)a8 holeCountFavorabilityMap:(id)a9;
...
- (char)_photoContainsFacesOfAnyPersonsOfInterest:(id)a0;
