...
@property (nonatomic) char isVault;
@property (nonatomic) char useSetForColumnMethod;
...
+ (void)setDefaultDatabase:(id)a0 forModelClass:(Class)a1 overwriteExisting:(char)a2;
...
- (void)closeDatabaseForQuit:(char)a0;
