...
@property (nonatomic) char shouldIgnoreDrawingBadges;
@property (nonatomic) char shouldIgnoreDrawingTexts;
@property (nonatomic) char shouldIgnorePlaceholderText;
...
- (char)hasThumbnailForLayout:(id)a0;
...
- (void)saveCacheForProject:(id)a0 waitUntilFinished:(char)a1;
