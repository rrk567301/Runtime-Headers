...
- (void)setDetailViewController:(id)a0 animated:(char)a1;
- (void)setDisplayState:(unsigned long long)a0 animated:(char)a1 completion:(id /* block */)a2;
- (void)setMasterViewController:(id)a0 animated:(char)a1;
