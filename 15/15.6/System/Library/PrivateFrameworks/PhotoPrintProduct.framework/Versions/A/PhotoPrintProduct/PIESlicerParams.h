...
@property (nonatomic) char preservePhotoOrder;
@property (nonatomic) char performSpreadAlignment;
...
- (char)isValidHoleCount:(unsigned long long)a0 forIndex:(unsigned long long)a1;
- (char)isValidHoleCount:(unsigned long long)a0 forReverseIndex:(unsigned long long)a1;
