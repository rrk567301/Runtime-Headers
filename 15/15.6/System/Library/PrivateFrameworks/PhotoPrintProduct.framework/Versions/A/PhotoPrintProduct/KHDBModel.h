...
@property (nonatomic) char isInCache;
@property (nonatomic) char isOpen;
@property (nonatomic) char skipChangeEntries;
@property (nonatomic) char wasRecentlyUsed;

+ (char)modelExistsInModels:(id)a0 where:(id)a1 args:(id)a2;
...
+ (char)modelExistsFromDatabase:(id)a0 where:(id)a1;
+ (char)modelExistsFromDatabase:(id)a0 where:(id)a1 args:(id)a2;
+ (char)modelExistsFromQuery:(id)a0;
+ (char)modelExistsInModels:(id)a0 fromQuery:(id)a1;
+ (char)modelExistsInModels:(id)a0 where:(id)a1;
...
+ (char)reportBackTraceToFileName:(id)a0 directory:(id)a1 reason:(id)a2;
+ (char)sample:(long long)a0 samplingIntervalinMilliseconds:(long long)a1 fileName:(id)a2 directory:(id)a3 reason:(id)a4;
+ (char)sample:(long long)a0 samplingIntervalinMilliseconds:(long long)a1 fileName:(id)a2 reason:(id)a3;
...
- (char)modelFlagForFlag:(unsigned int)a0;
...
- (void)setIsDeleted;
- (void)setIsPersisted;
- (void)setModelFlagTo:(char)a0 forFlag:(unsigned int)a1;
- (char)setNotifyOfChanges:(char)a0;
