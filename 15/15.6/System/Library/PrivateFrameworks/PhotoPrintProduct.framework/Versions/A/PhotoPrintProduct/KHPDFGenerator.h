...
- (char)_createWithPath:(id)a0 components:(id)a1 pageCount:(long long)a2 error:(id *)a3;
- (id)_newComponentGeneratorForComponent:(id)a0 project:(id)a1;
- (id)_pdfHeaderDictionaryWithPath:(id)a0;
- (void)_retrieveGPUInfo;
- (char)createPreviewWithPath:(id)a0 error:(id *)a1;
- (char)createWithPath:(id)a0 error:(id *)a1;
- (id)pdfCreator;
