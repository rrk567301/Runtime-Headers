...
- (void)_hydrate;
- (id)_imageWithSize:(struct CGSize { double x0; double x1; })a0 cache:(char)a1;
- (id)_loadFullImageFromProviderSync;
- (id)_loadImageWithSize:(struct CGSize { double x0; double x1; })a0;
- (id)_loadImageWithSize:(struct CGSize { double x0; double x1; })a0 cache:(char)a1;
- (id)_loadPreviewImageWithSize:(struct CGSize { double x0; double x1; })a0 cache:(char)a1;
