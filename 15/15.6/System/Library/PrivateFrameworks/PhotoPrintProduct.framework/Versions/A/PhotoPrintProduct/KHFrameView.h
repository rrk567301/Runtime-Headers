...
@interface KHFrameView : UXView <KHPhotoContentLayerDelegate, KHFrameContentLayerProvider, NSGestureRecognizerDelegate, NSDraggingDestination, NSDraggingSource> {
    ...
    struct { double x; double y; char isRelativeX; char isRelativeY; } _initialPan;
...
@property (nonatomic) char boundsVisible;
@property (nonatomic) char contentWarningVisible;
@property char contentWarningNeedsUpdate;
@property (nonatomic) char updatingFrameViews;
...
@property (readonly, nonatomic) char hasZoomableFrameObject;
...
@property (nonatomic, getter=isHoverVisible) char hoverVisible;
@property (readonly, nonatomic, getter=isRendering) char rendering;
@property (nonatomic, getter=isContentChangeDisabled) char contentChangeDisabled;
@property (nonatomic, getter=isContextualMenuDisabled) char contextualMenuDisabled;
...
- (char)_canHandleLongClickGesture;
- (char)_canHandlePanGesture;
...
- (void)_handleSelection:(char)a0;
- (void)_performDoubleClick;
- (void)_resetPanGestureRecognizer;
- (void)_selectWithEvent:(id)a0;
- (char)_shouldTearForGestureLocation:(struct CGPoint { double x0; double x1; })a0;
...
- (char)frameRenderLayer:(id)a0 setDrawingScale:(double)a1;
- (char)frameRenderLayer:(id)a0 setFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)frameRenderLayerDidLayoutSublayers:(id)a0;
- (id)frameViewForFrameObject:(id)a0;
- (id)frameViews;
- (char)geometryFlippedForPhotoContentLayer:(id)a0;
...
- (char)isFrameSelectionKeyEvent:(id)a0;
...
- (char)photoContentLayer:(id)a0 shouldRequestImageWithQuality:(unsigned long long)a1;
- (id)photoEffectsForPhotoContentLayer:(id)a0;
- (void)recycleFrameViews;
- (char)removeContentLayerForFrameRenderLayer:(id)a0;
