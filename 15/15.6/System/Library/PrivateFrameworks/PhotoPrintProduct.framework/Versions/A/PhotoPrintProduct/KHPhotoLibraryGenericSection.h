...
@property (readonly, nonatomic) char needsHydration;
@property (readonly, nonatomic) NSString *identifier;
@property (readonly, nonatomic) id iconImage;
@property (readonly, nonatomic) char hydrating;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly) NSString *pageLayoutLocalizedTitle;
@property (readonly) char pageLayoutDisplayContentsOfSingleGroup;
