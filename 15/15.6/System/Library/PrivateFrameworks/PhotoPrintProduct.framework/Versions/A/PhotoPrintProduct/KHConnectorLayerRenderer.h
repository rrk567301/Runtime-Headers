...
@interface KHConnectorLayerRenderer : KHLayerRenderer {
    ...
    float _endGapRadius;
    struct { double width; char isRelativeWidth; double height; char isRelativeHeight; } _arrowheadSize;
    long long _arrowheadAssetId;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _arrowheadAnchorPoint;
    struct { double x; double y; char isRelativeX; char isRelativeY; } _arrowheadTipPoint;
