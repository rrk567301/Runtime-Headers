...
- (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })orientationTransformForLayerBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 flipped:(char)a1;
- (id)scaledImageWithPixelSize:(struct CGSize { double x0; double x1; })a0;
- (char)writeImageRepresentationForType:(id)a0 toURL:(id)a1 options:(id)a2;
- (char)writeJPEGRepresentationToURL:(id)a0;
- (char)writePNGRepresentationToURL:(id)a0;
