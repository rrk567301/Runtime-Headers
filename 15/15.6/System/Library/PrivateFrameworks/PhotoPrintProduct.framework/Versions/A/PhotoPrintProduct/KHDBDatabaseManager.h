...
@property char isCorrupt;
@property (nonatomic) char logsErrors;
@property (nonatomic) char crashOnErrors;
@property (nonatomic) char throwExceptionOnError;
@property (nonatomic) char traceExecution;
@property (nonatomic) char profileTraceExecution;

+ (id)sqliteLibVersion;
+ (void)setLogErrorsEnabled:(char)a0;
...
- (id)commitSql;
- (char)createIndexOnTable:(id)a0 columnName:(id)a1;
- (char)createIndexOnTable:(id)a0 columnNames:(id)a1 named:(id)a2;
...
- (char)onDbQueue;
- (char)openAsReadOnly:(char)a0 attemptJournalCleanup:(char)a1;
...
- (void)setBackgroundWritingEnabled:(char)a0;
- (void)setCommitNoticeBlock:(id /* block */)a0;
- (void)setLockingModeToExclusive:(char)a0;
...
- (char)updateSync:(id)a0 withArgs:(id)a1;
