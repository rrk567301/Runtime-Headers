...
+ (id)gatherArgsForSql:(id)a0 varArgs:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1] *)a1;
...
- (id)sql;
- (id)databaseManager;
- (void)profileTraceExecution:(id)a0 isUpdate:(char)a1;
- (char)updateWithArgs:(id)a0;
- (long long)bindArguments:(id)a0;
- (void)expandSqlForArgs:(id)a0;
- (id)expandedSql;
- (void)finalizeSql;
- (void)finalizeSqlNoLock;
- (id)gatherArgsFromVarArgs:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1] *)a0;
- (char)hasMultibindPoints;
- (id)initWithDB:(id)a0 sql:(id)a1 prepare:(char)a2;
- (unsigned long long)numberOfBindPoints;
- (char)prepareOnThisThread;
