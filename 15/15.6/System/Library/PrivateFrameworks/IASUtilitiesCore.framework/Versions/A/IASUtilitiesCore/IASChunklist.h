...
@property char requireSignature;
@property char allowDevSignature;
@property char allowNoSignature;
...
- (char)validateData:(id)a0 forChunk:(unsigned long long)a1;
...
- (char)validateData:(id)a0;
- (char)validateData:(id)a0 progressDelegate:(id)a1;
