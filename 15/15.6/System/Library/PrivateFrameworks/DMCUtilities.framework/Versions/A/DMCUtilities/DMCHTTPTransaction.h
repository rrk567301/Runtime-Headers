@class NSError, NSString, NSArray, NSURL, NSData, NSURLSession, NSDictionary, NSMutableDictionary, NSMutableData;
...
@property (nonatomic) char pinningRevocationCheckRequired;
@property (retain, nonatomic) id<DMCHTTPAuthenticator> authenticator;
@property (nonatomic) char ignoreAuthenticatorError;
...
- (char)_shouldAllowTrust:(struct __SecTrust { } *)a0 forHost:(id)a1;
- (char)_shouldAllowTrustWithPinning:(struct __SecTrust { } *)a0 forHost:(id)a1;
