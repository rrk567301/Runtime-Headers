...
@property (nonatomic, getter=shouldDismissLandingPagePostPurchase) char dismissLandingPagePostPurchase;
...
- (id)initWithSubscriptionButtonType:(unsigned long long)a0 trialText:(id)a1 nonTrialText:(id)a2 buttonColor:(id)a3 buttonTextColor:(id)a4 targetType:(unsigned long long)a5 postPurchaseActionType:(unsigned long long)a6 postPurchaseURL:(id)a7 landingPageArticleID:(id)a8 dismissLandingPagePostPurchase:(char)a9;
