@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCFeedPersonalizedItemScoreProfile, FCColor, FCContentArchive, NTPBIssueRecord, FCInterestToken, NSString, FCContentManifest, NSArray, NSData, FCAssetHandle;
...
- (id)initWithIdentifier:(id)a0 type:(long long)a1 title:(id)a2 publicationDate:(id)a3 coverDate:(id)a4 metadataJSONAssetHandle:(id)a5 coverImageAssetHandle:(id)a6 coverImageAspectRatio:(double)a7 coverImagePrimaryColor:(id)a8 coverImageBackgroundColor:(id)a9 coverImageTextColor:(id)a10 coverImageAccentColor:(id)a11 layeredCoverJSON:(id)a12 layeredCoverAspectRatio:(double)a13 layeredCoverPrimaryColor:(id)a14 isCurrent:(char)a15 isDraft:(char)a16 isPaid:(char)a17 minimumNewsVersion:(long long)a18 allArticleIDs:(id)a19 coverArticleID:(id)a20 allowedStorefrontIDs:(id)a21 blockedStorefrontIDs:(id)a22 topicTagIDs:(id)a23 sourceChannel:(id)a24 notificationDescription:(id)a25 issueDescription:(id)a26 sortDate:(id)a27;
