...
@property (readonly, nonatomic) char deviceIsiPad;
@property (readonly, nonatomic) id<FCPPTContext> pptContext;
@property (readonly, nonatomic) char isPrivateDataEncryptionEnabled;
@property (readonly, nonatomic) char isPrivateDatabaseStartingUp;
@property (readonly, nonatomic) char isPrivateDatabaseOnline;
@property (readonly, nonatomic) char isPrivateDatabaseTemporarilySuspended;
...
- (id)initWithConfiguration:(id)a0 configurationManager:(id)a1 contentHostDirectory:(id)a2 privateDataHostDirectory:(id)a3 privateDataActionProvider:(id)a4 networkBehaviorMonitor:(id)a5 appActivityMonitor:(id)a6 desiredHeadlineFieldOptions:(unsigned long long)a7 feedUsage:(long long)a8 lockStoreFrontIfNeeded:(char)a9 deviceIsiPad:(char)a10 backgroundTaskable:(id)a11 privateDataSyncAvailability:(id)a12 pptContext:(id)a13;
- (id)initWithConfiguration:(id)a0 configurationManager:(id)a1 contentHostDirectory:(id)a2 privateDataHostDirectory:(id)a3 privateDataActionProvider:(id)a4 networkBehaviorMonitor:(id)a5 networkReachability:(id)a6 appActivityMonitor:(id)a7 desiredHeadlineFieldOptions:(unsigned long long)a8 feedUsage:(long long)a9 deviceIsiPad:(char)a10 backgroundTaskable:(id)a11 privateDataSyncAvailability:(id)a12 pptContext:(id)a13 options:(long long)a14;
...
- (char)shouldAssetKeyManagerSimulateUnauthorizedAssetKeys:(id)a0;
