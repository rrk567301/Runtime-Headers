...
- (id)_notificationEntitiesWithChannelIDs:(id)a0 isPaid:(char)a1 paidBundleSubscriptionStatus:(unsigned long long)a2 editorialChannelID:(id)a3;
- (id)_notificationEntityWithChannelIDs:(id)a0 isPaid:(char)a1 paidBundleSubscriptionStatus:(unsigned long long)a2 notificationType:(int)a3;
