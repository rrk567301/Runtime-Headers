...
@property (nonatomic) char webAccessOptIn;
...
- (id)initWithEntryID:(id)a0 tagID:(id)a1 purchaseID:(id)a2 productID:(id)a3 bundleID:(id)a4 webAccessOptIn:(char)a5 appAdamID:(id)a6 storeExternalVersion:(id)a7 vendorIdentifier:(id)a8 purchaseInitiatedTime:(id)a9 price:(id)a10;
