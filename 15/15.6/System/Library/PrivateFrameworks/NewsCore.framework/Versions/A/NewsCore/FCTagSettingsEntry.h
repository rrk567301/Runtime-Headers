...
@property (readonly, nonatomic) char webAccessOptIn;
@property (readonly, nonatomic) CKRecord *asCKRecord;

- (void).cxx_destruct;
- (id)initWithEntryID:(id)a0 tagID:(id)a1 fontMultiplier:(id)a2 fontMultiplierMacOS:(id)a3 contentScale:(id)a4 contentScaleMacOS:(id)a5 accessToken:(id)a6 webAccessOptIn:(char)a7;
