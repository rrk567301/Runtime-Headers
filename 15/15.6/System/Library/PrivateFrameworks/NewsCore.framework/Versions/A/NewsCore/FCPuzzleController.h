...
- (id)init;
- (void).cxx_destruct;
- (id)_cachedPuzzleForPuzzleID:(id)a0 fastCacheOnly:(char)a1;
- (id)_cachedPuzzlesForPuzzleIDs:(id)a0 fastCacheOnly:(char)a1;
...
- (id)createPuzzleForPuzzleType:(id)a0 identifier:(id)a1 title:(id)a2 subtitle:(id)a3 puzzleDescription:(id)a4 dataResourceID:(id)a5 authors:(id)a6 behaviorFlags:(long long)a7 publishDate:(id)a8 isPaid:(char)a9 difficulty:(long long)a10 difficultyDescription:(id)a11 relatedPuzzleIDs:(id)a12 thumbnailLargeURL:(id)a13 loadDate:(id)a14 teaserClue:(id)a15 teaserAnswer:(id)a16 teaserInfo:(id)a17 teaserDirection:(id)a18 teaserNumber:(id)a19 language:(id)a20 blockedStorefrontIDs:(id)a21 allowedStorefrontIDs:(id)a22 minimumNewsVersion:(id)a23 isDeprecated:(char)a24 isDraft:(char)a25 lastModifiedDate:(id)a26;
