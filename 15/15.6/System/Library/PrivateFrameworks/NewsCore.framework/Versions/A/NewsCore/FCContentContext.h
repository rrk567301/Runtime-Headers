...
- (id)initWithConfiguration:(id)a0 configurationManager:(id)a1 contentDatabase:(id)a2 contentHostDirectory:(id)a3 networkBehaviorMonitor:(id)a4 networkReachability:(id)a5 setupCustomURLProtocols:(char)a6 desiredHeadlineFieldOptions:(unsigned long long)a7 feedUsage:(long long)a8 assetKeyManagerDelegate:(id)a9 appActivityMonitor:(id)a10 backgroundTaskable:(id)a11 pptContext:(id)a12;
