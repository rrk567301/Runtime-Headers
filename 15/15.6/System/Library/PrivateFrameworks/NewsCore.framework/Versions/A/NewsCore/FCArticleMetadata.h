@class NSString, NSDictionary, NSArray, NSDate, NSURL, FCHeadlineThumbnailMetadata;
...
@property (readonly, nonatomic) char isTreatedAsNew;
...
@property (readonly, nonatomic) char isPaid;
