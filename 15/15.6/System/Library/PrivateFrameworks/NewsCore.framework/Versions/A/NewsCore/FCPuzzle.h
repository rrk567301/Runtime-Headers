...
@property (readonly, nonatomic, getter=isDeprecated) char deprecated;
@property (readonly, nonatomic, getter=isDraft) char draft;
...
@property (readonly, nonatomic) char showInfoModalOnFirstPlay;
@property (readonly, nonatomic) char ignoreFromStatsAndStreaks;
...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 title:(id)a1 subtitle:(id)a2 puzzleDescription:(id)a3 puzzleType:(id)a4 dataResourceID:(id)a5 authors:(id)a6 publishDate:(id)a7 isPaid:(char)a8 difficulty:(long long)a9 difficultyDescription:(id)a10 relatedPuzzleIDs:(id)a11 thumbnailSmallImageAssetHandle:(id)a12 thumbnailLargeImageAssetHandle:(id)a13 loadDate:(id)a14 teaserClue:(id)a15 teaserAnswer:(id)a16 teaserInfo:(id)a17 teaserDirection:(id)a18 teaserNumber:(id)a19 language:(id)a20 blockedStorefrontIDs:(id)a21 allowedStorefrontIDs:(id)a22 minimumNewsVersion:(long long)a23 showInfoModalOnFirstPlay:(char)a24 ignoreFromStatsAndStreaks:(char)a25 isDeprecated:(char)a26 isDraft:(char)a27 lastModifiedDate:(id)a28;
