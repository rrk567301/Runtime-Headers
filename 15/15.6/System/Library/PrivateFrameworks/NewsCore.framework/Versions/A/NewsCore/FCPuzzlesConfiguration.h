...
@property (readonly, nonatomic) char puzzlesEnabled;
@property (readonly, nonatomic) char puzzlesArchiveAPIEnabled;
@property (readonly, nonatomic) char puzzleLeaderboardsEnabled;
...
@property (readonly, nonatomic) char allowLowerProgressOnCompletedPuzzles;
