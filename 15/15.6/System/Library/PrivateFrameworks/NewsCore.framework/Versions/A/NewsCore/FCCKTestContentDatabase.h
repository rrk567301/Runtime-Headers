...
@property (nonatomic) char simulateNetworkError;
...
- (id)initWithContainerIdentifier:(id)a0 productionEnvironment:(char)a1 networkBehaviorMonitor:(id)a2 configurationManager:(id)a3;
