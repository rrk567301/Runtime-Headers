...
@protocol FCNativeAdProviding, FCHeadlineProviding, FCHeadlineStocksFields, FCHeadlineMetadata, FCChannelProviding;
...
@property (readonly, nonatomic, getter=isDisplayingAsNativeAd) char displayAsNativeAd;
...
@property (readonly, nonatomic, getter=isAIGenerated) char aiGenerated;
...
@property (readonly, nonatomic) char usesImageOnTopLayout;
...
@property (readonly, nonatomic) char showSubscriptionRequiredText;
...
- (void).cxx_destruct;
- (id)initWithHeadline:(id)a0 overrideMetadata:(id)a1 configuration:(id)a2;
