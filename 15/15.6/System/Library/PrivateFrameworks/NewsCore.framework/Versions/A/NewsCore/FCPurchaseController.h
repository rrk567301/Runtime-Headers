...
- (char)hasRenewalNoticeShownForTagID:(id)a0;
- (id)initWithCloudContext:(id)a0 entitlementService:(id)a1;
- (char)isPaidSubscriberFromWeb;
- (char)isTagIDPurchased:(id)a0;
- (void)performEntitlementCheckWithIgnoreCache:(char)a0 callbackQueue:(id)a1 completion:(id /* block */)a2;
...
- (void)removeWebPurchaseForTagID:(id)a0 userInitiated:(char)a1;
- (void)renewalNoticeShownForPurchasedChannelsListWithTagIDs:(id)a0;
- (void)shouldShowSignedInWithDifferentiTunesAccountAlertWithiTunesAccountName:(id)a0 iTunesAccountDSID:(id)a1 isUserSignedIntoiTunes:(char)a2 isBundleSubscriber:(char)a3 completion:(id /* block */)a4;
- (void)shouldShowiTunesSignedOutAlertWithiTunesAccountName:(id)a0 iTunesAccountDSID:(id)a1 isUserSignedIntoiTunes:(char)a2 isBundleSubscriber:(char)a3 completion:(id /* block */)a4;
...
- (void)userInfo:(id)a0 didRemoveAccessTokenForTagID:(id)a1 userInitiated:(char)a2;
