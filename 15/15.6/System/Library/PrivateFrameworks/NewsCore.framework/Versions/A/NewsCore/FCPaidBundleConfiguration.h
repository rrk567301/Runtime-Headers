@class NSString, NSDictionary, NSArray, NSMutableDictionary, NSDate, NFUnfairLock;

@interface FCPaidBundleConfiguration : NSObject <NSCopying>

@property (readonly, nonatomic, getter=isFreeBadgeEnabled) char freeBadgeEnabled;
@property (readonly, nonatomic, getter=isPaidBadgeEnabled) char paidBadgeEnabled;
...
@property (readonly, nonatomic, getter=isPaidBundleVisible) char paidBundleVisible;
@property (readonly, nonatomic, getter=isTemporaryAccessEnabled) char temporaryAccessEnabled;
@property (readonly, nonatomic, getter=isSharingIssuesEnabled) char sharingIssuesEnabled;
@property (readonly, nonatomic, getter=areMagazinesEnabled) char magazinesEnabled;
@property (readonly, nonatomic, getter=isFamilySharingSetupEnabled) char familySharingSetupEnabled;
...
@property (readonly, nonatomic) char forYouIncludePaidSectionFeedsForFreeUsers;
@property (readonly, nonatomic) char forYouIncludePaidSectionFeedsForPaidUsers;
...
@property (readonly, nonatomic, getter=isFreeBadgeEnabledForNonSubscribers) char freeBadgeEnabledForNonSubscribers;
@property (readonly, nonatomic, getter=isPaidBadgeEnabledForNonSubscribers) char paidBadgeEnabledForNonSubscribers;
@property (readonly, nonatomic, getter=isFreeBadgeEnabledForSubscribers) char freeBadgeEnabledForSubscribers;
@property (readonly, nonatomic, getter=isPaidBadgeEnabledForSubscribers) char paidBadgeEnabledForSubscribers;
...
@property (readonly, nonatomic, getter=isCategoriesDownloadButtonEnabled) char categoriesDownloadButtonEnabled;
...
@property (readonly, nonatomic) char appLaunchUpsellLastSeenDateSyncEnabled;
@property (readonly, nonatomic) char appLaunchUpsellLastShownCampaignIDSyncEnabled;
@property (readonly, nonatomic) long long appLaunchUpsellBehaviorFlags;
@property (readonly, nonatomic, getter=isNarrativeAudioEnabled) char narrativeAudioEnabled;
...
@property (readonly, nonatomic) char audioRefreshForceWakeEnabled;
...
@property (readonly, nonatomic) char requiresHardPaywallForIssuesToC;
@property (readonly, nonatomic) long long appLaunchUpsellPresentationDelay;
@property (readonly, nonatomic) char widgetUpsellFeaturesEnabled;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (char)arePaywallConfigsEqualToOtherPaidBundleConfig:(id)a0;
