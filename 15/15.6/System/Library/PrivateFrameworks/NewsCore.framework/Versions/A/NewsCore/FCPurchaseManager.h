...
- (id)fetchPurchaseMetadataForPurchaseID:(id)a0 restorePurchase:(char)a1;
...
- (char)isPurchaseOngoingForTagID:(id)a0;
...
- (void)startPurchaseWithTagID:(id)a0 purchase:(id)a1 webAccessOptIn:(char)a2 error:(id *)a3;
