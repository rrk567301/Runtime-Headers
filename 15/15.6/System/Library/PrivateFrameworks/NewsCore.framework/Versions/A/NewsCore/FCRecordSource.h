...
+ (char)recognizesRecordID:(id)a0 inRecordIDPrefixes:(id)a1;
...
- (void)fetchCoordinator:(id)a0 filterKeysToFetch:(id)a1 isFirstAttempt:(char)a2 context:(id)a3;
...
- (char)isRecordStale:(id)a0 withCachePolicy:(id)a1;
