...
@property (readonly, nonatomic) char canSubscribe;
@property (readonly, nonatomic) char canUnsubscribe;
@property (readonly, nonatomic) char includeUserVector;
@property (readonly, nonatomic) char includeBundleSubscribedVector;
@property (readonly, nonatomic) char includeSportsVector;
...
- (char)canSubscribeToNewsletter:(long long)a0;
...
- (char)isEligibleForIssues;
- (char)isOptedIntoIssues;
- (char)isSignedIntoEmailAccount;
