...
@property (readonly, nonatomic) char externalOverridesEnabled;
...
- (id)initWithPaywallType:(unsigned long long)a0 title:(id)a1 descriptionTrial:(id)a2 descriptionNonTrial:(id)a3 learnMoreTitle:(id)a4 learnMoreURL:(id)a5 offersLinkTitle:(id)a6 offersLinkURL:(id)a7 offersLinkTargetType:(unsigned long long)a8 externalOverridesEnabled:(char)a9 subscriptionButtonConfig:(id)a10 visualSpecConfig:(id)a11 paywallTopOffsetConfig:(id)a12;
