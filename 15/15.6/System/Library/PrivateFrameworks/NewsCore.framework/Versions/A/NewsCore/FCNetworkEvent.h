...
@property (readonly, nonatomic) char isProxyConnection;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithType:(int)a0 URL:(id)a1 operationID:(id)a2 requestUUID:(id)a3 responseMIMEType:(id)a4 HTTPStatusCode:(unsigned long long)a5 HTTPMethod:(id)a6 HTTPResponseHeaders:(id)a7 containerName:(id)a8 isProxyConnection:(char)a9 error:(id)a10 startTime:(double)a11 dnsDuration:(double)a12 connectDuration:(double)a13 requestDuration:(double)a14 responseDuration:(double)a15 requestSize:(double)a16 responseSize:(double)a17 smarterFetchSources:(id)a18 smarterFetchStrategy:(id)a19;
