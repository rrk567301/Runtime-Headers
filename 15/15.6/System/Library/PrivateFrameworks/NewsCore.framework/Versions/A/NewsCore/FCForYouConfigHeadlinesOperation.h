...
@protocol FCContentContext, FCCoreConfiguration, FCBundleSubscriptionManagerType, FCFeedPersonalizing;
...
@property (nonatomic) char shouldFetchEditorialSectionTags;
