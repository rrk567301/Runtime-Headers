@class NSDictionary, NTPBPublisherPaidDescriptionStrings, FCTagBanner, NSString, FCContentArchive, NTPBTagRecord, NSArray, FCHeadlineTemplate, FCAssetManager, FCContentManifest, FCSectionSupergroupKnobs, FCPaywallConfiguration, FCInterestToken, NSData, FCAssetHandle, FCColorGradient, FCTextInfo, FCColor, FCSportsRecommendationMappings, NTPBFeedConfiguration, NFLazy, FCContentColorMap, NSDate;
...
@property (readonly, nonatomic) char supportsNotifications;
@property (readonly, nonatomic) char isWhitelisted;
...
@property (readonly, nonatomic) char isFoodSection;
...
- (id)initWithTagMetadata:(id)a0 assetManager:(id)a1 isSports:(char)a2;
- (id)initWithTagRecord:(id)a0 assetManager:(id)a1 interestToken:(id)a2 specialTagFeedType:(unsigned long long)a3;
