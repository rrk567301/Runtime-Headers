...
- (id)createPaymentQueueWithProductID:(id)a0 purchaseID:(id)a1 bundleID:(id)a2 webAccessOptIn:(char)a3 appAdamID:(id)a4 storeExternalVersion:(id)a5;
...
- (void)startPurchaseWithTagID:(id)a0 productID:(id)a1 purchaseID:(id)a2 bundleID:(id)a3 appAdamID:(id)a4 storeExternalVersion:(id)a5 price:(id)a6 webAccessOptIn:(char)a7 payment:(id)a8;
