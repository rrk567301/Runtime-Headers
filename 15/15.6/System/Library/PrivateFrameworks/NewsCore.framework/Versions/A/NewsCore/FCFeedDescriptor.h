...
- (char)hasNotificationsEnabledWithSubscriptionController:(id)a0;
- (char)isSubscribedToWithSubscriptionController:(id)a0;
- (id)latestHeadlineResultsWithContext:(id)a0;
- (id)streamOfHeadlinesWithIDs:(id)a0 context:(id)a1 cachedOnly:(char)a2 maxCachedAge:(double)a3;
