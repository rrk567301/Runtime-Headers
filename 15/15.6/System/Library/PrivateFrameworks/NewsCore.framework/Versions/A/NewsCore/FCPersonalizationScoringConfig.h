...
@property (nonatomic) char respectHalfLifeOverride;
...
@property (nonatomic) char nicheContentBoostOnlyAboveBaselineMembership;
@property (nonatomic) double nicheContentBaselineMembershipMultiplier;
@property (nonatomic) char nicheContentManagedTopicBoostAllTags;
@property (nonatomic) double nicheContentDefaultFlowRate;
@property (nonatomic) double nicheContentDefaultSubscriptionRate;
@property (nonatomic) char nicheContentExcludeNonGroupableTopics;
@property (nonatomic) char nicheContentShouldBoostPublisher;
...
@property (nonatomic) char dampenerEnabled;
@property (nonatomic) char multiplierEnabled;
