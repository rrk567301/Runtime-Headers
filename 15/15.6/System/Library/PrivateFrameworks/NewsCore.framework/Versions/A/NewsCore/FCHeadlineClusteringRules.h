...
@property (readonly, nonatomic) char enforcePublisherCap;
...
+ (id)rulesWithTreatment:(id)a0 configurationSet:(long long)a1 deviceIsiPad:(char)a2 limitUnpaidArticles:(char)a3 enforcePublisherCap:(char)a4 minClusterSizeiPhone:(long long)a5 maxClusterSizeiPhone:(long long)a6 minClusterSizeiPad:(long long)a7 maxClusterSizeiPad:(long long)a8 todayFeedEnabled:(char)a9;
+ (id)rulesWithTreatment:(id)a0 configurationSet:(long long)a1 deviceIsiPad:(char)a2 limitUnpaidArticles:(char)a3 enforcePublisherCap:(char)a4 todayFeedEnabled:(char)a5;
+ (id)rulesWithTreatment:(id)a0 deviceIsiPad:(char)a1 limitUnpaidArticles:(char)a2 enforcePublisherCap:(char)a3 minClusterSizeiPhone:(long long)a4 maxClusterSizeiPhone:(long long)a5 minClusterSizeiPad:(long long)a6 maxClusterSizeiPad:(long long)a7 todayFeedEnabled:(char)a8;
+ (id)rulesWithTreatment:(id)a0 deviceIsiPad:(char)a1 limitUnpaidArticles:(char)a2 enforcePublisherCap:(char)a3 todayFeedEnabled:(char)a4;

- (id)init;
- (id)initWithMinClusterSize:(unsigned long long)a0 maxClusterSize:(unsigned long long)a1 minIdealClusterSize:(unsigned long long)a2 maxIdealClusterSize:(unsigned long long)a3 minClusterSizeAutoFavorite:(unsigned long long)a4 maxClusterSizeAutoFavorite:(unsigned long long)a5 minIdealClusterSizeAutoFavorite:(unsigned long long)a6 maxIdealClusterSizeAutoFavorite:(unsigned long long)a7 maxPublisherOccurrences:(unsigned long long)a8 enforcePublisherCap:(char)a9 maxUnpaidArticles:(unsigned long long)a10 maxEvergreenArticles:(unsigned long long)a11 topicDiversityThreshold:(double)a12 maxNativeAdCount:(unsigned long long)a13 thumbnailMinHammingDistance:(unsigned long long)a14;
