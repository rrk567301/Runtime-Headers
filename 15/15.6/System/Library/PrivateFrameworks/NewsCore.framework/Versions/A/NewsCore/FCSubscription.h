...
@property (readonly, nonatomic) char notificationsEnabled;
...
@property (readonly, nonatomic) char canRetry;
...
+ (id)subscriptionWithSubscriptionID:(id)a0 tagID:(id)a1 type:(unsigned long long)a2 order:(id)a3 origin:(unsigned long long)a4 groupID:(id)a5 dateAdded:(id)a6 notificationsEnabled:(char)a7 zone:(unsigned long long)a8;
...
- (id)initWithSubscriptionID:(id)a0 tagID:(id)a1 groupID:(id)a2 dateAdded:(id)a3 subscriptionType:(unsigned long long)a4 order:(id)a5 origin:(unsigned long long)a6 notificationsEnabled:(char)a7 zone:(unsigned long long)a8;
