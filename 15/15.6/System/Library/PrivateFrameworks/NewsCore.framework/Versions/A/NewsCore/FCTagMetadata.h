...
@property (readonly, nonatomic) char isArticleMetadata;
...
@property (readonly, nonatomic) char isAthlete;
@property (readonly, nonatomic) char isLocalNews;

- (id)init;
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 tagType:(unsigned long long)a1 dictionary:(id)a2;
