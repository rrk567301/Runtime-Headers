...
- (void)fetchChangesForRecordZoneID:(id)a0 changeToken:(id)a1 desiredKeys:(id)a2 fetchAllChanges:(char)a3 qualityOfService:(long long)a4 completionHandler:(id /* block */)a5;
