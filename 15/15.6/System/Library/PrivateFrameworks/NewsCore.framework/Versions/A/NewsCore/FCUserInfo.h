...
@property (readonly, nonatomic) char isUsingPlaceholderFSID;
...
@property (readonly, nonatomic) char useParsecResults;
@property (readonly, nonatomic) char shouldShowDefaultForYou;
@property (readonly, nonatomic) unsigned long long progressivePersonalization;
@property (nonatomic) char hasShownProgressivePersonalizationWelcomeBrick;
@property (nonatomic) char userHasCompletedFavoritesSetup;
...
@property (nonatomic) char marketingNotificationsEnabled;
@property (nonatomic) char newIssueNotificationsEnabled;
@property (nonatomic) char endOfAudioTrackNotificationsEnabled;
...
@property (readonly, nonatomic) char puzzleNotificationsEnabled;
...
@property (readonly, nonatomic) char mightNeedToUpdateOnboardingVersion;
...
- (void)accessTokenRemovedForTagID:(id)a0 userInitiated:(char)a1;
...
- (void)resetSportsID;
- (void)resetUserIDs;
- (void)setPuzzleNotificationsEnabled:(char)a0 userTriggered:(char)a1;
