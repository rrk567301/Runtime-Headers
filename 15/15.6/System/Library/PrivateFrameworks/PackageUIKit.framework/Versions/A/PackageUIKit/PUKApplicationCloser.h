...
@property char ignoreOtherUsers;
@property char ignoreNoisyQuittingCheck;
...
- (char)_checkForAppsAndPluginsForOtherUsers:(id)a0;
...
- (void)_sendAppleQuitEventUsingPid:(int)a0 userCanceled:(char *)a1;
- (void)_sendAsyncAppleQuitEventUsingPid:(int)a0 completion:(id /* block */)a1;
- (void)_switchUser;
- (void)_terminateAppsAndPlugInsShouldFailWithImmortalApps:(char)a0 completion:(id /* block */)a1;
