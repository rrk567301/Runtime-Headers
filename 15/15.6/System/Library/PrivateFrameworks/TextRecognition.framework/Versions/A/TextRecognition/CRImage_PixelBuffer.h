...
+ (struct __CVBuffer { } *)_convertPixelBuffer:(struct __CVBuffer { } *)a0 toFormat:(unsigned int)a1 iosurfaceBacking:(char)a2;
...
- (id)imageByConvertingToColorSpace:(int)a0 forceDataCopy:(char)a1;
- (id)imageByCorrectingFromOrientation:(unsigned int)a0;
- (id)imageByCroppingRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 iosurfaceBacking:(char)a1;
- (id)imageByCroppingRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toSurface:(struct __IOSurface **)a1;
...
- (id)imageByPaddingToRatioAndScalingToWidth:(unsigned long long)a0 height:(unsigned long long)a1 paddingMode:(unsigned long long)a2 alignCenter:(char)a3;
...
- (struct __CVBuffer { } *)pixelBufferWithScale:(double)a0 paddedToSize:(struct CGSize { double x0; double x1; })a1 adjustedToSize:(struct CGSize { double x0; double x1; } *)a2 paddingMode:(unsigned long long)a3 format:(unsigned int)a4 hardwareAcceleration:(char)a5 iosurfaceBacking:(char)a6;
- (struct __CVBuffer { } *)pixelBufferWithScale:(double)a0 paddedToSize:(struct CGSize { double x0; double x1; })a1 adjustedToSize:(struct CGSize { double x0; double x1; } *)a2 paddingMode:(unsigned long long)a3 format:(unsigned int)a4 hardwareAcceleration:(char)a5 toSurface:(struct __IOSurface **)a6;
