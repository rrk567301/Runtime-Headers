...
+ (id)runFutharkOnImage:(id)a0 recognizeFeatures:(char)a1 options:(id)a2;
+ (id)runFutharkOnImage:(id)a0 recognizeFeatures:(char)a1 withMaxNumScales:(unsigned long long)a2 withThresholdingAlgorithm:(long long)a3 options:(id)a4 withProgressHandler:(id /* block */)a5;
