...
@interface CRRecognizerConfiguration : NSObject {
    ...
    char _optimizeGroupsForStability;
...
@property (readonly) char falsePositiveFilteringDisabled;
@property (readonly) char scriptDetectionDisabled;
@property (readonly) char skipRecognition;
@property (readonly) int colorSpace;
@property (readonly) char rectifyPolygons;
