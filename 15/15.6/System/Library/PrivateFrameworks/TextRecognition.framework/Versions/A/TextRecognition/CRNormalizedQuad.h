...
- (char)containsDenormalizedPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)containsNormalizedPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (char)overlapsDenormalizedQuad:(id)a0;
- (char)overlapsNormalizedQuad:(id)a0;
- (id)rotated180;
