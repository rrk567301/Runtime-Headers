...
- (struct vector<float, std::allocator<float>> { float *x0; float *x1; struct __compressed_pair<float *, std::allocator<float>> { float *x0; } x2; })normalizedLineRegions:(id)a0 numConfigurationRegions:(long long)a1 usingMinMaxNorm:(char)a2;
