...
+ (void)_saveAllDebugImagesForRegions:(id)a0 image:(id)a1 afterPostProcessing:(char)a2;
+ (void)_saveDebugImageForRegions:(id)a0 image:(id)a1 suffix:(id)a2 displayTypes:(char)a3;
...
- (char)shouldRunDetectionForDocument:(id)a0;
