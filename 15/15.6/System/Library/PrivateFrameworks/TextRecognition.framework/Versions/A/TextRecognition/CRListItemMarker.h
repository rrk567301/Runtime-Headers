...
+ (id)hyphensSet;
+ (id)listItemMarkerForText:(id)a0 requiresAdjacentText:(char)a1;
+ (id)nonMarkerNumericConstructSeparatorSet;
+ (id)startOfMarkerSet;

- (void).cxx_destruct;
- (long long)integerValue;
- (char)_canCompositeDecimalBeSucceededByCompositeDecimal:(id)a0;
...
- (char)canBeSucceededByMarker:(id)a0;
