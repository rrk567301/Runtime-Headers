...
+ (id)characterRangesForTokens:(id)a0 fromActivation:(id)a1 usingCharacterTokens:(char)a2;
+ (id)filteredTokensFromTokens:(id)a0 falsePositiveFiltering:(char)a1 keepWhitespaceToken:(char)a2;
...
+ (id)tokenDelimiterRangesForTokens:(id)a0 usingCharacterTokens:(char)a1;
+ (id)tokenSequenceStringForTokens:(id)a0 usingCharacterTokens:(char)a1;
+ (char)validateProbability:(id)a0 precisionThreshold:(double)a1 withLM:(char)a2;
