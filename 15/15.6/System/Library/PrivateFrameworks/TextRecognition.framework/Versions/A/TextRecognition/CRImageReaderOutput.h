...
+ (unsigned long long)confidenceLevelForConfidenceScore:(double)a0 confidenceThresholds:(id)a1;
...
- (id)initWithType:(id)a0 outputRegion:(id)a1 isTitle:(char)a2;
- (id)initWithType:(id)a0 outputRegion:(id)a1 isTitle:(char)a2 withCandidates:(char)a3;
- (char)isEqualToImageReaderOutput:(id)a0;
