...
@interface CRImageReaderTrackingSession : NSObject {
    char _usesGroupedRegions;
    char _debuggingSession;
    char _ocrInProgress;
    char _useLumaInput;
    char _wasLastFrameUnstableForFirstAcquisition;
...
@property char shouldIncludeLinesInTrackingResult;
@property char didDispatchOCROnFrame;
@property char didRunAssociationOnFrame;
@property unsigned long long ocrUpdateMode;
@property double lowFrequencyOCRElapsedTimeAboveMinimumStability;
@property (readonly) char usesGroupedRegions;
@property (retain) CRImageReaderTrackingResult *latestResult;
@property (readonly) char wasLatestFrameUnstableForFirstAcquisition;
...
- (id)initWithTrackingLevel:(unsigned long long)a0 debuggingSession:(char)a1;
