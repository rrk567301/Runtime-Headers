...
+ (char)convertVImage:(const struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 inColorSpace:(int)a1 toVImage:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a2 toColorSpace:(int)a3;
...
- (id)initWithCVPixelBuffer:(struct __CVBuffer { } *)a0 toColorSpace:(int)a1 forceDataCopy:(char)a2;
...
- (id)initY8WithCVPixelBuffer:(struct __CVBuffer { } *)a0 forceDataCopy:(char)a1;
...
- (void)runBlockWithARGB8888Image:(id /* block */)a0 blockOwnsMemory:(char)a1;
