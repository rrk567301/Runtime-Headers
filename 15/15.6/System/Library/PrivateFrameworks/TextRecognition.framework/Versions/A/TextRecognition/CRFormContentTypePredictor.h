...
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)_decodeCoreMLOutput:(id)a0 forFields:(id)a1 updateExternal:(char)a2;
- (void)_decodeEspressoOutput:(const struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a0 forFields:(id)a1 locale:(id)a2 updateExternal:(char)a3;
- (id)_modelInputWithFields:(id)a0 fieldsAndRegions:(id)a1 locale:(id)a2;
- (char)_predictAndAssignContentTypesForFields:(id)a0 fieldsAndRegions:(id)a1 locale:(id)a2 updateExternal:(char)a3;
- (char)predictAndAssignContentTypesForFields:(id)a0 fieldsAndRegions:(id)a1 locale:(id)a2 updateExternal:(char)a3;
