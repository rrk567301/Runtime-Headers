...
@property (nonatomic) char shouldUseLM;
@property (nonatomic) char shouldUseFalsePositiveFiltering;
@property (readonly, nonatomic) char shouldUseModernizedDecoder;
@property (readonly, nonatomic) char shouldReverseActivationMatrix;
...
- (char)_decodeFeaturesWithInfo:(id)a0 imageSize:(struct CGSize { double x0; double x1; })a1 error:(id *)a2;
- (char)_decodeSingleFeatureWithInfo:(id)a0 decodingLocale:(id)a1 greedyDecoder:(id)a2 greedyConfig:(id)a3 beamSearchConfig:(id)a4 imageSize:(struct CGSize { double x0; double x1; })a5 useCharacterBoxes:(char)a6 lmConfig:(id)a7 error:(id *)a8;
- (char)_shouldUseCharacterDecodingToken;
- (char)_wordLMShouldFilterCandidate:(id)a0 inLocale:(id)a1 lmConfig:(id)a2;
