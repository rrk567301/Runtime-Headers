...
- (id)correctTextFeature:(id)a0 inImage:(id)a1 withTextPieces:(id)a2 withMaxWidthPerRegion:(double)a3 withMedianCharSpacing:(double)a4 withBreakpoints:(const void *)a5 segmenter:(void *)a6 options:(id)a7 numCharCandidates:(int)a8 downscaleSpaceRatio:(char)a9 latticePresetIdx:(int)a10 latticeResults:(id)a11;
- (struct _LXLexicon { } *)createDynamicLexiconForLocale:(id)a0 error:(id *)a1;
...
- (char)isLanguageCorrectionSupportedForLanguage:(id)a0 revision:(unsigned long long)a1;
- (void)loadCharacterNgramModel:(id)a0;
- (char)preferAllLowercase:(id)a0;
- (char)preferAllUppercase:(id)a0;
