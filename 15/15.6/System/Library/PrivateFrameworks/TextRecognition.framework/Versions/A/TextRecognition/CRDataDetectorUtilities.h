...
+ (char)_shouldGroupAllEntitiesFor:(id)a0 lines:(id)a1;
+ (id)_stringByRemovingNamePrefixes:(id)a0;
+ (id)computeDataDetectorRegionsForText:(id)a0 locale:(id)a1 transcriptComponents:(id)a2 ddQOS:(int)a3;
+ (id)computeGroupRegionsWithDataDetectorRegions:(id)a0 inRegion:(id)a1;
+ (void)debugDataDetectorForRegion:(id)a0 withImage:(id)a1 ddQOS:(int)a2;
