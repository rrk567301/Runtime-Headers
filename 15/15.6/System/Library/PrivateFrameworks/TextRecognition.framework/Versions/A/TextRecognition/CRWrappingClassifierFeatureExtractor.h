...
+ (void)_extractLexicalFeaturesTo:(void *)a0 string1:(id)a1 string2:(id)a2 configuration:(id)a3 forCJK:(char)a4;
...
+ (id)_tokenizeString:(id)a0 usingWordUnits:(char)a1 excludeWhitespace:(char)a2;
