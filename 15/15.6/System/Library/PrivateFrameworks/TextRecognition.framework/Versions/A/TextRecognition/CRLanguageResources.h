...
@property (readonly, nonatomic) char isCustomWordsSupported;
...
+ (char)isCharLMForLanguageAvailableInTextRecognition:(id)a0;
+ (char)isCustomWordsSupportedForLanguageIdentifier:(id)a0;
+ (char)isLanguageSupported:(id)a0;
