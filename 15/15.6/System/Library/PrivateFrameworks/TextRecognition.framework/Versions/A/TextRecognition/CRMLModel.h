...
- (id)decodeActivations:(void *)a0 blank:(unsigned short)a1 ctcAllowGarbage:(char)a2 numResultNeeded:(long long)a3;
- (id)initRestrictingToCPU:(char)a0;
- (id)initWithURL:(id)a0 restrictToCPU:(char)a1 error:(id *)a2;
