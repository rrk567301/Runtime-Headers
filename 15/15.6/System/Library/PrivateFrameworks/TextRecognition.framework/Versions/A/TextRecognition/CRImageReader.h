...
+ (char)preheatModelsForOptions:(id)a0 revision:(long long)a1 error:(id *)a2;
...
+ (char)languageIsArabic:(id)a0;
+ (char)languageIsChinese:(id)a0;
+ (char)languageIsCyrillic:(id)a0;
+ (char)languageIsFrench:(id)a0;
+ (char)languageIsJapanese:(id)a0;
+ (char)languageIsKorean:(id)a0;
+ (char)languageIsLatin:(id)a0;
+ (char)languageIsNorwegian:(id)a0;
+ (char)languageIsVietnamese:(id)a0;
+ (id)languageSetFromOptionsDictionary:(id)a0;
+ (char)languageSupportsFullWidthPunctuation:(id)a0;
+ (char)preheatModelsForOptions:(id)a0 revision:(long long)a1 extendedTimeoutBlock:(id /* block */)a2 error:(id *)a3;
...
- (char)configureImageReaderWithOptions:(id)a0 error:(id *)a1;
