...
@interface CRTrackedRegionGroup : NSObject <CRTrackingAssociatable> {
    char _isInlineGroup;
    char _isTextLeftJustified;
    char _isTextRightJustified;
...
@property (readonly) char isInlineGroup;
@property char trackNeedsReplacement;
...
- (char)addGroupRegionIfValid:(id)a0 context:(id)a1;
- (char)addInlineGroupIfValid:(id)a0;
