...
- (void)markTracksNotConformingSameHomographyUsingGroupsAtOCRDispatch:(char)a0 ransacReprojError:(float)a1 markedQuadArea:(double)a2;
- (id)resultByUpdatingWithDocument:(id)a0 sceneHomography:(struct { void /* unknown type, empty encoding */ x0[3]; })a1 usesGroupedRegions:(char)a2;
