...
@property (nonatomic) char isInCloudDocsZone;
...
+ (void)initialize;
+ (char)canMoveFilesWithoutDownloadingFromContainer:(id)a0 toContainer:(id)a1;
...
+ (void)_generateOSXIconsForMangledID:(id)a0 usingBundle:(struct __CFBundle { } *)a1 generatedIcons:(id)a2;
...
+ (id)containerInRepositoryURL:(id)a0 createIfMissing:(char)a1 error:(id *)a2;
...
+ (char)isDocumentScopePublicWithProperties:(id)a0 mangledID:(id)a1;
...
+ (char)versionOfBundle:(id)a0 changedFromVersion:(id)a1;
...
- (id)shortDescription;
- (id)icon;
- (void)_accessDataRepresentation:(id)a0 inBlock:(id /* block */)a1;
- (void)_accessPurgeableDataRepresentation:(id)a0 inBlock:(id /* block */)a1;
- (void)_accessRebuiltPurgeableDataRepresentation:(id)a0 inBlock:(id /* block */)a1;
- (id)_containerRepositoryURL;
- (id)_imageDataForSize:(struct CGSize { double x0; double x1; })a0 scale:(long long)a1 isiOSIcon:(char *)a2 shouldTransformToAppIcon:(char *)a3;
...
- (char)_updateMetadataOnDiskWithProperties:(id)a0;
- (void)accessDataRepresentationInBlock:(id /* block */)a0;
- (void)accessPropertiesInBlock:(id /* block */)a0;
- (id)bestFittingImageDataForSize:(struct CGSize { double x0; double x1; })a0 shouldTransformToAppIcon:(char *)a1;
- (id)bundleIDVersions;
- (id)computedProperties;
- (char)containsExcludedDocumentsOnTheFSWithExcludedButPreservedFilename:(id)a0 excludedButPreservedExtensions:(id)a1 andStampUploadedAppWithXattr:(char)a2;
- (id)copyDataRepresentation;
- (char)deleteAllContentsOnClientAndServer:(id *)a0;
- (char)deleteAllContentsOnClientAndServer:(char)a0 error:(id *)a1;
- (void)forceRefreshWithCompletion:(id /* block */)a0;
- (char)hasIconWithName:(id)a0;
- (id)iconGeneratorVersion;
- (id)iconMetadata;
- (id)iconURLs;
- (id)imageDataForSize:(struct CGSize { double x0; double x1; })a0 scale:(long long)a1;
- (id)imageDataForSize:(struct CGSize { double x0; double x1; })a0 scale:(long long)a1 isiOSIcon:(char *)a2;
- (id)imageDataForSize:(struct CGSize { double x0; double x1; })a0 scale:(long long)a1 shouldTransformToAppIcon:(char *)a2;
...
- (char)registerCurrentProcessAsPriorityHintWithError:(id *)a0;
- (void)setUrlRoot:(id)a0;
- (id)trashRestoreStringForURL:(id)a0;
- (char)updateMetadataWithExtractorProperties:(id)a0 iconPaths:(id)a1 bundleID:(id)a2;
- (char)updateMetadataWithRecordData:(id)a0 iconPaths:(id)a1;
