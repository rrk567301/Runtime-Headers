...
@property (readonly, nonatomic) char editedSinceShared;
...
@property (readonly, nonatomic) char fromRelativePath;
...
@property (readonly, nonatomic, getter=isTopLevelSharedItem) char topLevelSharedItem;
@property (readonly, nonatomic, getter=isContentZoneRoot) char contentZoneRoot;
@property (readonly, copy) NSString *fileSystemFilename;
@property (readonly, nonatomic, getter=isExcludedFromSync) char excludedFromSync;
...
@property (readonly) char isCollaborationInvitation;
...
+ (id)askDaemonQueryItemForURL:(id)a0 andFakeFSEvent:(char)a1 error:(id *)a2;
+ (id)containerItemForContainer:(id)a0 forceScan:(char)a1;
...
- (char)isEqualToQueryItem:(id)a0;
- (char)isHiddenExt;
- (char)isTopLevel;
- (id)localizedFileNameIfDesktopOrDocuments;
- (void)markDead;
- (void)merge:(id)a0 allowMergingFileObjectIDIfPossible:(char)a1;
