...
@interface BRItemCollectionGatherer : NSObject <FPItemCollectionItemIDBasedDelegate> {
    ...
    char _finishedInitialGathering;
    ...
    char _finishedLookingUpAppLibraries;
...
- (char)_buildCollectionOnItemIfPossible:(id)a0;
- (char)_canWatchItem:(id)a0;
- (id)_getAppLibraryURLFromConfig:(id)a0;
- (id)_getDeletedItems;
- (id)_getUpdatedItems;
- (void)_invalidateAndNotifyDelegate:(char)a0;
- (char)_isItemOwnedByAnyCollection:(id)a0;
...
- (char)_shouldFilterEvaluatedItem:(id)a0 collectionRootItem:(id)a1;
- (char)_signalDelegateIfNeededOnFinishGathering;
