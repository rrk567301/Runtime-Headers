...
- (id)description;
- (void).cxx_destruct;
- (id)initWithURL:(id)a0 physicalURL:(id)a1 size:(id)a2 extension:(id)a3 etag:(id)a4 hasThumbnail:(char)a5 displayName:(id)a6 lastEditorDeviceName:(id)a7 lastEditorNameComponents:(id)a8 modificationDate:(id)a9 versionsStore:(id)a10;
