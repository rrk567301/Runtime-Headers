...
@property (readonly, nonatomic) char isForManeuver;
...
- (id)initWithID:(id)a0 isForManeuver:(char)a1 lanes:(id)a2 titles:(id)a3 instructions:(id)a4 variableOverrides:(id)a5 distanceDetailLevel:(long long)a6 composedGuidanceEventIndex:(int)a7;
