...
@property (readonly, nonatomic) char isAllowedToSwitchTransportTypes;
...
@property (nonatomic) char isConnectedToCarplay;
...
- (void)_startGuidanceAllowMidRouteStart:(char)a0 announcementsToIgnore:(id)a1;
...
- (void)audioManager:(id)a0 didActivateAudioSession:(char)a1;
...
- (void)forceReroute;
- (void)guidanceManager:(id)a0 announce:(id)a1 isImportant:(char)a2 shortPromptType:(unsigned long long)a3 stage:(unsigned long long)a4 completionBlock:(id /* block */)a5;
...
- (void)guidanceManager:(id)a0 usePersistentDisplay:(char)a1;
...
- (char)guidanceManagerIsRerouting;
- (void)idleTimerUpdater:(id)a0 shouldEnableIdleTimer:(char)a1;
...
- (char)vibrateForPrompt:(unsigned long long)a0;
