...
- (void)setGuidancePromptsEnabled:(char)a0;
...
- (void)acceptReroute:(char)a0 forTrafficIncidentAlert:(id)a1;
...
- (void)setIsDisplayingNavigationTray:(char)a0;
...
- (void)setTraceIsPlaying:(char)a0;
