@class MNDisplayETAInfo, GEODirectionsResponse, MNArrivalInfo, NSString, GEOComposedWaypoint, MNObserverHashTable, NSArray, MNNavigationClientProxy, MNNavTrayGuidanceEvent, NSMutableDictionary, MNUserOptions, GEOResumeRouteHandle, NSSet, MNGuidanceLaneInfo, MNRouteDistanceInfo, MNVehicleParkingInfo, MNNavigationServiceRemoteProxy, MNBatteryChargeInfo, GEOComposedRoute, NSUUID, MNNavigationDetails, MNLocation, GEODirectionsRequest;
...
@property (class, readonly, nonatomic) char supportsNavigation;
...
@property (nonatomic) char guidancePromptsEnabled;
...
@property (readonly, nonatomic) char isTrackingCurrentLocation;
@property (readonly, nonatomic) char isInPreArrivalState;
...
@property (readonly, nonatomic) char isDetour;
...
@property (readonly, nonatomic, getter=isNavigatingFromTrace) char navigatingFromTrace;
@property (nonatomic) char traceIsPlaying;
...
- (void)_navigationServiceCallback_DidChangeVoiceGuidanceLevel:(id)a0;
- (void)_navigationServiceCallback_DidEndNavigation:(id)a0;
...
- (void)_navigationServiceCallback_DidUpdateNavTrayGuidance:(id)a0;
- (void)_navigationServiceCallback_DidUpdateResumeRouteHandle:(id)a0;
- (void)_navigationServiceCallback_DidUpdateStepIndex:(id)a0;
- (void)_navigationServiceCallback_DidUpdateTargetLegIndex:(id)a0;
- (void)_navigationServiceCallback_DidUpdateUpcomingAnchorPointIndex:(id)a0;
...
- (void)_navigationServiceCallback_WillEndNavigation:(id)a0;
- (void)_navigationServiceCallback_WillStartNavigation:(id)a0;
- (void)_resetDetails;
...
- (void)forceReroute;
- (char)isOpenForClient:(id)a0;
- (void)navigationServiceProxy:(id)a0 didActivateAudioSession:(char)a1;
...
- (void)navigationServiceProxy:(id)a0 didEnableGuidancePrompts:(char)a1;
...
- (void)navigationServiceProxy:(id)a0 displayPrimaryStep:(id)a1 instructions:(id)a2 shieldType:(int)a3 shieldText:(id)a4 drivingSide:(int)a5 maneuverStepIndex:(unsigned long long)a6 isSynthetic:(char)a7;
...
- (void)navigationServiceProxy:(id)a0 usePersistentDisplay:(char)a1;
...
- (char)startNavigationWithDetails:(id)a0 error:(out id *)a1;
