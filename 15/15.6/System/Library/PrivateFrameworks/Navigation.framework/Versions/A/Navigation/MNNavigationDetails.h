...
@property (readonly, nonatomic) char isServer;
...
@property (nonatomic) char isApproachingWaypoint;
...
@property (nonatomic) char isDetour;
...
- (id)initForServer:(char)a0;
- (char)isFollowingOriginalRoute;
