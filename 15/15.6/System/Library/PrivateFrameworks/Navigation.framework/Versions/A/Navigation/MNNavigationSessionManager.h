...
- (void)navigationSession:(id)a0 didActivateAudioSession:(char)a1;
...
- (void)navigationSession:(id)a0 didDismissTrafficIncidentAlert:(id)a1;
...
- (void)navigationSession:(id)a0 didUpdateBackgroundWalkingRoute:(id)a1;
...
- (void)navigationSession:(id)a0 didUpdateVehicleParkingInfo:(id)a1;
- (void)navigationSession:(id)a0 displayManeuverAlertForAnnouncementStage:(unsigned long long)a1;
- (void)navigationSession:(id)a0 displayPrimaryStep:(id)a1 instructions:(id)a2 shieldType:(int)a3 shieldText:(id)a4 drivingSide:(int)a5 maneuverStepIndex:(unsigned long long)a6 isSynthetic:(char)a7;
...
- (void)navigationSession:(id)a0 usePersistentDisplay:(char)a1;
