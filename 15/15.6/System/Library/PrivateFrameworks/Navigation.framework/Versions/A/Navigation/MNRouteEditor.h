...
- (void).cxx_destruct;
- (void)endSession;
- (char)_checkAnchorPointCount:(unsigned long long)a0 action:(unsigned long long)a1 finishedHandler:(id /* block */)a2;
...
- (id)initWithTraceRecordingEnabled:(char)a0;
