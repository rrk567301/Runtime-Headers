...
- (char)_pathsDivergeBetweenRoute:(id)a0 from:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 andRoute:(id)a2 from:(struct PolylineCoordinate { unsigned int x0; float x1; })a3 withinDistance:(double)a4;
- (char)_pointMeetsConvergenceThreshold:(const struct _MNRouteConvergencePoint { struct { double x0; double x1; double x2; } x0; struct { double x0; double x1; double x2; } x1; struct { double x0; double x1; double x2; } x2; struct PolylineCoordinate { unsigned int x0; float x1; } x3; struct PolylineCoordinate { unsigned int x0; float x1; } x4; char x5; char x6; } *)a0 withOtherPoint:(const struct _MNRouteConvergencePoint { struct { double x0; double x1; double x2; } x0; struct { double x0; double x1; double x2; } x1; struct { double x0; double x1; double x2; } x2; struct PolylineCoordinate { unsigned int x0; float x1; } x3; struct PolylineCoordinate { unsigned int x0; float x1; } x4; char x5; char x6; } *)a1 outRouteCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a2 outRouteCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a3 outDistance:(out double *)a4;
- (void)_populateConvergencePoints:(void *)a0 route:(id)a1 range:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a2 isRouteA:(char)a3;
