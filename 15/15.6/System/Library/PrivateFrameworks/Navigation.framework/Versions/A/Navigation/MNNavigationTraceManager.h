@class NSString, MNTracePlayer, NSBundle, MNTraceRecorder, MNTraceNetworkEvent;
...
@property (readonly, nonatomic) char isAuthorized;
...
- (id)_defaultTraceNameForDestination:(id)a0 isSimulation:(char)a1;
...
- (void)openForRecordingWithTraceRecordingData:(id)a0 traceName:(id)a1 selectedRouteIndex:(unsigned long long)a2 isReconnecting:(char)a3 isSimulation:(char)a4;
