...
@property (nonatomic) char isInPreArrivalState;
@property (nonatomic) char shouldShowChargingInfo;
...
- (char)repeatLastGuidanceAnnouncement:(id)a0;
- (double)_adjustedVehicleSpeed;
- (unsigned long long)_announcementStageForEvent:(id)a0;
...
- (char)_considerArrivalAnnouncements;
- (char)_considerChargingAnnouncements;
- (char)_considerGetOnRouteAnnouncements;
- (void)_considerHaptics;
- (void)_considerJunctionViewGuidance;
- (void)_considerLaneGuidance;
- (void)_considerNavTrayGuidance;
- (char)_considerOtherSpecialAnnouncements;
- (void)_considerPersistence;
- (void)_considerSignGuidance;
- (char)_considerStartingAnnouncements;
...
- (id)_evaluatedStringsForEvent:(id)a0 signStrings:(id)a1 shouldUpdateFormatStrings:(char)a2 argumentHandler:(id /* block */)a3;
- (char)_eventWasSpoken:(id)a0;
...
- (char)_isEVChargingEvent:(id)a0;
- (char)_isInArrivalState;
...
- (void)_notifySpeechEvent:(id)a0 waypointCategory:(int)a1 startingVariantIndex:(unsigned long long)a2;
...
- (id)_serverStringDictionaryForEvent:(id)a0 distance:(double)a1 validDistance:(double)a2 spoken:(char)a3 waypoints:(id)a4;
- (id)_signForGuidanceEvent:(id)a0 isPrimary:(char)a1 shouldOverridePrimaryDistances:(char)a2 distance:(out double *)a3;
- (id)_sortedSignEventsFromValidSignEvents:(id)a0;
- (id)_specialAREvents:(int)a0 forLeg:(unsigned long long)a1;
- (id)_specialNavTrayEvents:(int)a0 forLeg:(unsigned long long)a1;
...
- (id)_spokenStringForEvent:(id)a0 waypointCategory:(int)a1;
...
- (char)_updateDisplayStringArgument:(id)a0 event:(id)a1;
- (char)_updateSpokenStringArgument:(id)a0 event:(id)a1;
- (id)_validEventsForARGuidance;
- (id)_validEventsForSignGuidance:(out char *)a0;
- (double)durationOfEvent:(id)a0 announcementIndex:(unsigned long long)a1 distance:(double)a2;
- (id)initWithNavigationSessionState:(id)a0 audioManager:(id)a1 isReconnecting:(char)a2 announcementsToIgnore:(id)a3;
