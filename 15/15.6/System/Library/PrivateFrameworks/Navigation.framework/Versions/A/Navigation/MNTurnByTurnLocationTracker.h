...
- (char)_allowRerouteForLocation:(id)a0 outError:(out id *)a1;
...
- (char)_isLocation:(id)a0 nearOrigin:(id)a1;
- (char)_isRoadFeatureInOppositeDirection:(id)a0 ofCoordinate:(struct { double x0; double x1; })a1 course:(double)a2;
...
- (char)_shouldAdvanceGuidanceToRouteMatch:(id)a0;
...
- (char)hasArrivedAtFinalDestination;
...
- (void)trafficIncidentAlertUpdater:(id)a0 didDismissAlert:(id)a1 withReroute:(char)a2;
