...
@property (readonly, nonatomic) char supportsMagus;
...
- (id)initWithStopRecordingReason:(unsigned long long)a0 expectedStopHostTime:(unsigned long long)a1 trailingSilenceDurationAtEndpoint:(double)a2 holdRequest:(id)a3 supportsMagus:(char)a4;
- (id)xpcObject;
...
- (id)initWithStopRecordingReason:(unsigned long long)a0 expectedStopHostTime:(unsigned long long)a1 trailingSilenceDurationAtEndpoint:(double)a2 holdRequest:(id)a3 supportsMagus:(char)a4 requestId:(id)a5;
