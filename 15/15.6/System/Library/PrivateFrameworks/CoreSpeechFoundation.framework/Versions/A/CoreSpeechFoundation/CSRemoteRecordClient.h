...
- (char)startRecordingWithOptions:(id)a0 error:(id *)a1;
- (char)stopRecording:(id *)a0;
- (id)initWithQueue:(id)a0 IsRemoteRecording:(char)a1;
- (char)isRemoteDeviceDarwin;
- (char)isRemoteDeviceGibraltar;
