...
@property (readonly, nonatomic) char useGazeSignal;
...
@property (readonly, nonatomic) char isMagusSupported;
@property (readonly, nonatomic) float eagerMitigationDurationThreshold;
@property (readonly, nonatomic) char isJSSupported;
...
@property (readonly, nonatomic) char progCheckerShadowMode;
...
+ (char)isLeftConfigVersion:(id)a0 newerThanRightConfigVersion:(id)a1;
+ (id)overrideAssetForVoiceTrigger;
+ (unsigned long long)parseCompatibilityFromConfigVersion:(id)a0;

- (id)description;
- (void).cxx_destruct;
- (char)getBoolForKey:(id)a0 category:(id)a1 default:(char)a2;
- (id)assetHashInResourcePath:(id)a0;
- (char)containsCategory:(id)a0;
...
- (char)isCompactVersion;
- (char)isEqualAsset:(id)a0;
- (void)logAssetVersionForInsight;
- (id)mitigationConfigFileForCategory:(id)a0;
- (char)shouldRunCAROverrideForCategory:(id)a0;
...
- (char)containsKey:(id)a0 category:(id)a1;
...
- (char)isHSVoiceTrigger:(id)a0;
- (char)isJSVoiceTrigger:(id)a0;
- (id)mitigatonConfigFile;
- (id)nldaConfigFile;
- (id)nldaConfigFileForCategory:(id)a0;
- (char)shouldRunSpkrIdForCategory:(id)a0;
