...
+ (char)decodeUseKeywordSpotting:(id)a0 fromCategory:(id)a1;
+ (char)decodeUseRecognizerCombination:(id)a0 fromCategory:(id)a1;
+ (id)decodeWearerDetectionConfig:(id)a0 fromCategory:(id)a1;
+ (char)decodeuseTimeBasedTriggerLength:(id)a0 fromCategory:(id)a1;
