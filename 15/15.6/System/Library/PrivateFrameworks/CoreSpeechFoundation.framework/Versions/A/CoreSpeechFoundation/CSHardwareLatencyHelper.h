...
- (char)_valuesAreMinimalyValidForInfoDictionary:(id)a0 type:(unsigned long long)a1;
- (char)addHWLatencyToOption:(id)a0 withCorrection:(double)a1 streamHandle:(unsigned long long)a2 voiceController:(id)a3;
