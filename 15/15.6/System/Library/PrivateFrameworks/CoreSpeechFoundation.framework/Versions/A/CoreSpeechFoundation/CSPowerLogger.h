...
@property (nonatomic) char selfTriggerSuppressionIsPhoneCallConnected;
...
- (void)powerLogSelfTriggerSuppressionDetectedWithSpeakerType:(unsigned long long)a0 withAudioSource:(unsigned long long)a1 atTime:(double)a2 isPhoneCall:(char)a3;
- (void)powerLogSelfTriggerSuppressionStartWithSpeakerType:(unsigned long long)a0 withAudioSource:(unsigned long long)a1 atTime:(double)a2 isPhoneCall:(char)a3;
- (void)powerLogSelfTriggerSuppressionStopAtTime:(double)a0;
- (void)powerLogSiriConfigWithVoiceTriggerEnabled:(char)a0 withLanguage:(id)a1 withModelVersion:(id)a2;
