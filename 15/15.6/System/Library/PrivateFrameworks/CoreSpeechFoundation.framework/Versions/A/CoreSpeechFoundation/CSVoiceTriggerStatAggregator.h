...
- (void)logFalseWakeUp:(char)a0 withPhrase:(id)a1;
- (void)logSecondPassResult:(int)a0 eventInfo:(id)a1 triggerAPWakeUp:(char)a2;
- (void)logTimeBasedTriggerLengthSampleCountStatistics:(unsigned long long)a0 withAOPVTTriggerLengthSampleCount:(unsigned long long)a1;
