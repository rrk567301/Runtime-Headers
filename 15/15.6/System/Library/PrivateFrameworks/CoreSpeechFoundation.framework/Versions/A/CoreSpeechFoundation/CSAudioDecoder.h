...
- (void)dealloc;
- (void).cxx_destruct;
- (void)addPackets:(id)a0 audioStreamHandleId:(unsigned long long)a1 remoteVAD:(id)a2 timestamp:(unsigned long long)a3 arrivalTimestampToAudioRecorder:(unsigned long long)a4 wasBuffered:(char)a5 receivedNumChannels:(unsigned int)a6;
