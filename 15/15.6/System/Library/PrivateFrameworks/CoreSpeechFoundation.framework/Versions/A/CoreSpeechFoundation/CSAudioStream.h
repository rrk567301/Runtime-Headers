...
@property (nonatomic, setter=setScheduledFutureSample:) char scheduledFutureSample;
...
@property (nonatomic) char isWeakStream;
@property (readonly, nonatomic) NSHashTable *tandemStreams;
@property (nonatomic) char needsBoost12dB;
...
- (char)isNarrowBand;
- (char)isStreaming;
- (char)prepareAudioStreamSyncWithRequest:(id)a0 error:(id *)a1;
- (id)recordSettings;
