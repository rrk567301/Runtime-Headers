...
@property (nonatomic) char graphIsMapped;
...
+ (struct { void *x0; unsigned long long x1; })_compileWithMilFile:(id)a0 bnnsIrPath:(id)a1 separateWeight:(id)a2 compilationConfig:(id)a3 isBnnsIrMapped:(char *)a4 errOut:(id *)a5;
...
- (char)_populateModelInterfaceParameters;
