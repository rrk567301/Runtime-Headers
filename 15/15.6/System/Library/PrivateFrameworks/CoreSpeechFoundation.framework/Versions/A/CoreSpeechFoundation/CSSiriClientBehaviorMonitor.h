...
- (void)notifyDidStartStreamWithContext:(id)a0 successfully:(char)a1 option:(id)a2 withEventUUID:(id)a3;
...
- (void)notifyFetchedSiriClientAudioStream:(id)a0 successfully:(char)a1;
- (void)notifyPreparedSiriClientAudioStream:(id)a0 successfully:(char)a1;
