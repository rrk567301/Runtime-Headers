...
- (void)logSiriSetupPHSEnrollmentDigitalZeroDetectionCompletedWithSiriSetupID:(id)a0 withPageNumber:(int)a1 withPhId:(id)a2 withMaxNumContinuousZeros:(int)a3 withMaxNumAllowedContinuousZeros:(int)a4 withIsMaxNumContinuousZerosOverThreshold:(char)a5 withLocale:(id)a6 withVTAssetConfigVersion:(id)a7 withStageStatus:(int)a8 didDetectSpeechStart:(char)a9 didUseTwoPassDetector:(char)a10 didFirstPassTrigger:(char)a11;
