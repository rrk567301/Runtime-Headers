...
- (char)tableViewCaptureDeleteKeyPress:(id)a0;
...
- (id)_selectedItemChanged:(char *)a0;
- (void)_setGeneralAlertMessage:(id)a0;
- (void)_setLastSelectedItem:(id)a0;
- (char)_setLocaleIdentifier:(id)a0;
- (void)_setupAccessibilityIdentifiers;
- (void)_undoItemWithIdentifier:(id)a0 dictionary:(id)a1 locale:(id)a2 select:(char)a3;
- (void)_updateControlStatesBasedOnCurrentSelection;
- (void)_updateGeneralWarning;
- (char)_updateItem:(id)a0 withDictionary:(id)a1;
- (char)_updateItem:(id)a0 withDictionary:(id)a1 locale:(id)a2;
...
- (void)setAddRemoveBarHidden:(char)a0;
- (void)setLocalePopupHidden:(char)a0;
