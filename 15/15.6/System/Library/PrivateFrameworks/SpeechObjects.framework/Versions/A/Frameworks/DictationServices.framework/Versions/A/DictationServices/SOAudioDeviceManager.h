...
@property (class, readonly, nonatomic) char isClamshellClosed;
@property (class, readonly, nonatomic) unsigned int defaultInputDeviceID;

@property (readonly, nonatomic) char isClamShellModeOn;
...
- (void)monitorDeviceVolume:(id)a0 forInput:(char)a1;
