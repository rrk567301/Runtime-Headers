...
@property (nonatomic) char prefersNoArrowBadge;

+ (void)assignNumbersToLabeledElements:(id)a0 startingNumberedLabelsAtIndex:(unsigned long long)a1 randomize:(char)a2;
...
- (id)_findLabeledElementsThatIntersectsLabelRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 fromLabeledElement:(id)a1 justLabelRect:(char)a2 additionalElements:(id)a3;
