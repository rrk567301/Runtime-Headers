...
- (void)dealloc;
- (void).cxx_destruct;
- (char)containsNumber:(unsigned long long)a0;
- (void)_initializeGridViewWithRows:(unsigned long long)a0 columns:(unsigned long long)a1;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 startingNumber:(unsigned long long)a1 drawBadges:(char)a2 borderedChiclet:(char)a3 rows:(unsigned long long)a4 columns:(unsigned long long)a5 screenOrigin:(struct CGPoint { double x0; double x1; })a6;
