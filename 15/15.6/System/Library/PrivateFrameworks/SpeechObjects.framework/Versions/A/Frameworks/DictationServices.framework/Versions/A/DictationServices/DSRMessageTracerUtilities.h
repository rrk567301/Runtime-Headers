...
@property (nonatomic) char touchBarActivation;
@property (nonatomic) char touchBarDeactivation;
@property (nonatomic) char recordingTimedOut;
@property (nonatomic) char usingOffline;
...
@property (nonatomic) char dictationModelClient;
