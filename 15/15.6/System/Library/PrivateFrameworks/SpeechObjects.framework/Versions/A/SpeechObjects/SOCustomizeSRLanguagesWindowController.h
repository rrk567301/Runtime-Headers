...
- (void)_rebuildList;
- (void)_setRowStatusFieldView:(id)a0 variantPopUpButton:(id)a1 speechItem:(id)a2 isSelected:(char)a3;
- (void)_updateButtonStatesOnlyIfDownloadRequired:(char)a0;
...
- (void)showSheetForWindow:(id)a0 networkSupportedLocaleIdentifiers:(id)a1 requiredLocaleIdentifier:(id)a2 supportDownloads:(char)a3 showOnlyNetworkSupportedItems:(char)a4;
