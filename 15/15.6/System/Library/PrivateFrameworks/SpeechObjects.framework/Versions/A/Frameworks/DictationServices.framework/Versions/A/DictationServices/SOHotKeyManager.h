...
- (void)gotoKbdPref;
- (char)registerVirtualKeyCode:(unsigned short)a0 modifierKeyFlags:(unsigned int)a1 target:(id)a2 selector:(SEL)a3 userInfo:(id)a4;
- (unsigned int)sharedCGSConnectionID;
- (char)stickyKeysIsEnabled;
- (char)unregisterAllHotKeys;
- (char)unregisterVirtualKeyCode:(unsigned short)a0 modifierKeyFlags:(unsigned int)a1;
