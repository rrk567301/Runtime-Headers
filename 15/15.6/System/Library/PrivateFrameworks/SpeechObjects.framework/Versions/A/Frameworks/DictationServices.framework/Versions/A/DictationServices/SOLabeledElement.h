...
@property (readonly, nonatomic) char isSpacer;

+ (id)numberFormatter;
+ (struct CGSize { double x0; double x1; })sizeOfNumberedBadgeForLabel:(id)a0 arrowOrientation:(long long)a1 useFixedWidthNumerals:(char)a2;
