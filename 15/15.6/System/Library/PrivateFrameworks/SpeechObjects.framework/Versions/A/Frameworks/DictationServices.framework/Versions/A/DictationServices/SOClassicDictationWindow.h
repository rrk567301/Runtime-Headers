...
+ (struct CGPoint { double x0; double x1; })pointForCenteredSourceSize:(struct CGSize { double x0; double x1; })a0 destSize:(struct CGSize { double x0; double x1; })a1 verticallyCentered:(char)a2;
