...
- (char)_containsGridNumber:(unsigned long long)a0;
- (char)_containsNumber:(unsigned long long)a0;
- (char)_needsZoomForSize:(struct CGSize { double x0; double x1; })a0;
