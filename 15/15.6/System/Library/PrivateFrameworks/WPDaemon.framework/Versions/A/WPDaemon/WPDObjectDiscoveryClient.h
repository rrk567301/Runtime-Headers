...
- (void)completeSPBeaconingWithSuccess:(char)a0;
...
- (void)notifyClientStateChange:(long long)a0 Restricted:(char)a1;
- (void)sendRegisteredWithDaemonAndContinuingSession:(char)a0;
