...
@property char listeningToBluetoothBandwdith;
...
@property char entitledForZones;
@property char entitledForObjectDiscovery;
@property char entitledForRanging;
...
@property char scanDenylisted;
@property char scansOff;
...
@property char isObjectDiscovery;
@property (readonly) char supportsObjectDiscovery;
@property (readonly) char supportsRanging;
...
@property char isTestModeClient;
@property char canDisableScans;
