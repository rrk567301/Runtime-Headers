...
@property char allowCompoundAdvertisements;
@property (retain) NSMutableDictionary *preallocatedServices;
@property (readonly, nonatomic) char isRanging;
...
- (id)addXPCDelayTiming:(id)a0 IsMetricOnly:(char)a1 UseCase:(unsigned long long)a2 timeStamp:(unsigned long long)a3;
- (char)addressChangeNotificationNeeded:(id)a0 advertiserTypeString:(id)a1;
- (id)advertisingRules;
- (id)clientForAdvRequest:(id)a0;
- (void)enableRanging:(char)a0 forClient:(id)a1;
- (id)generateStateDumpStrings;
- (id)getCharacteristicForClient:(id)a0;
- (id)getClientUUIDsForCharacteristic:(id)a0;
- (id)getCurrentAdvertisers;
- (id)getManager;
- (char)heySiriAdvertActive:(char)a0;
- (char)heySiriAdvertActiveAllDevices;
...
- (id)removeAdvertisingRequest:(id)a0 forClient:(id)a1 shouldUpdate:(char)a2;
...
- (id)requestFromAdvertisingDataFromInstance:(long long)a0 AddressChangeNotificationNeeded:(char)a1;
