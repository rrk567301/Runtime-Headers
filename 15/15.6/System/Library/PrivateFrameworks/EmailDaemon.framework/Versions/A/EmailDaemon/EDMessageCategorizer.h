...
- (char)_categorizeMessages:(id)a0 senderAttributes:(id)a1 signpostID:(unsigned long long)a2 results:(id)a3 reason:(long long)a4;
- (char)_categorizeMessages:(id)a0 signpostID:(unsigned long long)a1 results:(id *)a2 reason:(long long)a3;
