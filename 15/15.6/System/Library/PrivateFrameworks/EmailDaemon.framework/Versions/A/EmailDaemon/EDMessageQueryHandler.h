@class NSMutableDictionary, EMCollectionItemIDStateCapturer, NSString, EDMessageQueryHelper, NSObject, EFDebouncer;
...
@property (nonatomic) char didFindRequestedItemForInitialBatch;
@property (nonatomic) char isInitialized;
@property (nonatomic) char hasEverReconciledJournal;
...
@property (nonatomic) char hasUrgentPredicate;
