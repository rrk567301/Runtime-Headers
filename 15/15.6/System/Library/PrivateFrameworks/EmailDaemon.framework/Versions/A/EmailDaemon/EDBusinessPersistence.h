...
+ (id)log;
+ (char)_shouldUseSimpleAddressForHighLevelDomain:(id)a0 displayName:(id)a1 grouping:(long long)a2;
+ (id)_brandIDFromInteger:(long long)a0;
+ (id)_commonDomains;
+ (char)_hasCommonDomain:(id)a0;
+ (char)_shouldUseGroupingSimpleAddressForEmailAddress:(id)a0 grouping:(long long)a1;
...
- (id)_addressesNeedingUpdateStatementOnlyCounts:(char)a0;
...
- (id)_businessExternalIDForEmailAddress:(id)a0 addressID:(long long)a1 brandID:(id)a2 grouping:(long long)a3 shouldForceUpdate:(char)a4 businessIDsToCombine:(id *)a5;
...
- (char)_combineBusinesses:(id)a0 connection:(id)a1 newBusinessID:(long long *)a2;
- (char)_completedBCSSyncforAddressID:(id)a0 connection:(id)a1;
- (char)_deleteBusinessAddressEntryForAddressID:(id)a0 connection:(id)a1;
- (char)_deleteBusinessEntryForBusinessID:(id)a0 connection:(id)a1;
...
- (long long)_findOrCreateBusinessIDForAddress:(id)a0 addressID:(long long)a1 businessMetadata:(id)a2 shouldForceUpdate:(char)a3 connection:(id)a4;
- (id)_groupingTrieForHighLevelDomain:(id)a0;
- (char)_hasCompletedRecentBCSSyncForAddressID:(long long)a0 connection:(id)a1;
...
- (char)_insertOrUpdateBusiness:(long long)a0 forAddress:(long long)a1 connection:(id)a2;
- (char)_insertOrUpdateBusinessCategoriesCategoryColumnForBusinessID:(long long)a0 category:(unsigned long long)a1 connection:(id)a2;
...
- (char)_removeOldBusinessIDs:(id)a0 connection:(id)a1;
- (char)_removeUserOverrideForAddressIDs:(id)a0 timestamp:(id)a1 originator:(unsigned long long)a2 userInitiated:(char)a3 connection:(id)a4;
- (char)_removeUserOverrideForBusinessID:(long long)a0 timestamp:(id)a1 originator:(unsigned long long)a2 userInitiated:(char)a3 connection:(id)a4;
- (void)_reportIncorrectBusinessForAddressID:(long long)a0 businessID:(long long)a1 isBusinessConnectGrouping:(char)a2 fromClassName:(id)a3;
- (char)_setUserOverrideForBusinessID:(long long)a0 category:(unsigned long long)a1 userInitiated:(char)a2 connection:(id)a3 timestamp:(id)a4;
- (char)_updateBrandNamesForBusinessID:(long long)a0 brandNames:(id)a1 connection:(id)a2;
- (char)_updateBusinessAddressesCategoryColumnForAddressIDs:(id)a0 category:(unsigned long long)a1 connection:(id)a2 timestamp:(id)a3;
- (char)_updateBusinessAddressesTableforBusinessID:(id)a0 newBusinessID:(id)a1 connection:(id)a2;
- (char)_updateBusinessIDForAddress:(id)a0 addressID:(long long)a1 businessMetadata:(id)a2 connection:(id)a3;
- (char)_updateDisplayNameForBusinessID:(long long)a0 displayName:(id)a1 connection:(id)a2;
...
- (long long)findOrCreateBusinessIDForAddress:(id)a0 addressID:(long long)a1 connection:(id)a2 businessMetadataNeedsRefreshing:(char *)a3;
...
- (void)insertOrUpdateUserOverrideForBusinessIDs:(id)a0 category:(unsigned long long)a1 userInitiated:(char)a2 timestamp:(id)a3;
...
- (void)removeUserOverrideForAddressIDs:(id)a0 timestamp:(id)a1 originator:(unsigned long long)a2 userInitiated:(char)a3;
- (void)removeUserOverridesForBusinessIDs:(id)a0 timestamp:(id)a1 originator:(unsigned long long)a2 userInitiated:(char)a3;
- (void)repopulateBusinessesTables;
- (void)reportIncorrectBusinessForAddress:(id)a0 isBusinessConnectGrouping:(char)a1 fromClassName:(id)a2;
- (void)test_tearDown;
