...
@property (nonatomic) char keepMessagesInListOnBucketChange;
...
- (void)_messagesWereAdded:(id)a0 toInitialBatch:(char)a1;
- (void)_messagesWereChanged:(id)a0 previousMessages:(id)a1 forKeyPaths:(id)a2 deleted:(char)a3;
- (void)_notifyObserversOfInsertedSenders:(id)a0 senderItemIDsBySection:(id)a1 previousSender:(id)a2 includePrecachedSenders:(char)a3 notifyBlock:(id /* block */)a4;
- (void)_notifyObserversOfMovedSenders:(id)a0 previousSender:(id)a1 includePrecachedSenders:(char)a2 notifyBlock:(id /* block */)a3;
- (void)_notifyResultsObserverOfChangesToVisibleGroupedSendersFrom:(id)a0 to:(id)a1 forChangedGroups:(id)a2 itemIDsWithSectionChanges:(id)a3 includePrecachedSenders:(char)a4 logMessage:(id)a5;
- (void)_persistenceDidFinishMergingBusinesses;
- (char)_queryHelperIsCurrent:(id)a0;
...
- (id)groupedSenderForObjectID:(id)a0 isPersisted:(char *)a1 error:(id *)a2;
- (id)initWithQuery:(id)a0 messagePersistence:(id)a1 senderPersistence:(id)a2 businessPersistence:(id)a3 businessCloudStorage:(id)a4 hookRegistry:(id)a5 remindMeNotificationController:(id)a6 observer:(id)a7 observationIdentifier:(id)a8 keepMessagesInListOnBucketChange:(char)a9;
...
- (void)queryHelper:(id)a0 didFindMessages:(id)a1 forInitialBatch:(char)a2;
