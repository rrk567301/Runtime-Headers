...
- (char)executeSQL:(id)a0 errorHandler:(id /* block */)a1;
- (char)executeSQL:(id)a0 indexBindings:(id)a1 errorHandler:(id /* block */)a2;
- (char)executeSelectSQL:(id)a0 bindings:(id /* block */)a1 errorHandler:(id /* block */)a2 rowHandler:(id /* block */)a3;
- (long long)executeUpdateSQL:(id)a0 bindings:(id /* block */)a1 errorHandler:(id /* block */)a2;
