...
@property (nonatomic) char isReconciling;
@property (readonly, nonatomic) EFLocked *reconciliationMergeHandlers;
@property (readonly, nonatomic) char supportsJournaling;
...
+ (char)_isRecoverableError:(id)a0;
+ (unsigned long long)_resultForConnection:(id)a0 success:(char)a1 error:(id)a2 errorMessage:(id)a3;
...
- (char)_attachProtectedDatabaseToConnection:(id)a0 withSchema:(id)a1 error:(id *)a2;
...
- (char)_initializeDatabase:(id)a0 withConnection:(id)a1 schema:(id)a2 error:(id *)a3;
- (char)_isJournalMalformedForSchema:(id)a0 connection:(id)a1;
...
- (char)_performOnDemandReconciliationForConnection:(id)a0 withSchema:(id)a1;
- (unsigned long long)_reconcileJournalsWithSchema:(id)a0 connection:(id)a1;
- (char)_removeExistingDatabaseIDs:(id)a0 withColumn:(id)a1 connection:(id)a2;
- (unsigned long long)_runReconciliationWithSchema:(id)a0 connection:(id)a1;
- (char)_updateSqliteSequenceForDatabase:(id)a0 schema:(id)a1 withConnection:(id)a2 error:(id *)a3;
- (char)_upgradeJournalWithConnection:(id)a0 schema:(id)a1 error:(id *)a2;
