...
+ (id)log;
+ (id)_commonDomains;
+ (char)_deleteExistingBusinessesWithConnection:(id)a0 error:(id *)a1;
+ (id)_getGroupableAndUngroupableAddresses:(id *)a0 connection:(id)a1 error:(id *)a2;
+ (id)_groupAddresses:(id)a0;
+ (char)_persistBusinesses:(id)a0 connection:(id)a1 error:(id *)a2;
+ (void)_resetGroupingDefault;
+ (char)_shouldUseSimpleAddressForHighLevelDomain:(id)a0 displayName:(id)a1;
