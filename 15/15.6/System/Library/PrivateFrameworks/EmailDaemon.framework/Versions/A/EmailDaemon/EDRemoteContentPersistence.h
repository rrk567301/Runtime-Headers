...
@property (readonly, nonatomic) char useAdditionalTable;
...
- (char)addRemoteContentLinks:(id)a0 newLinks:(id *)a1;
- (char)_addRemoteContentLinks:(id)a0 withDate:(id)a1 toTable:(id)a2 withConnection:(id)a3 newLinks:(id *)a4;
...
- (id)_getRemoteContentURLInfoForTable:(id)a0 orderedBy:(long long)a1 inReverseOrder:(char)a2 limit:(long long)a3 connection:(id)a4 error:(id *)a5;
...
- (id)getRemoteContentURLInfoOrderedBy:(long long)a0 inReverseOrder:(char)a1 limit:(long long)a2 error:(id *)a3;
- (id)initWithDatabase:(id)a0 useAdditionalTable:(char)a1;
- (char)pruneAllRemoteContentLinksWithMinimumCount:(unsigned long long)a0;
- (id)remoteContentLinksBelowCount:(unsigned long long)a0 limit:(unsigned long long)a1;
- (void)test_tearDown;
- (char)updateRequestCountForRemoteContentLinks:(id)a0 updateLastSeen:(char)a1;
