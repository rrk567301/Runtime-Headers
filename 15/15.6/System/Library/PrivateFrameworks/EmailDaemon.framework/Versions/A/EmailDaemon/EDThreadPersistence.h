...
- (void).cxx_destruct;
- (char)_addThreadScopeToDatabase:(id)a0 withMailboxDatabaseID:(long long)a1 filterPredicate:(unsigned long long)a2 needsUpdate:(char)a3 lastViewedDate:(id)a4 updateThreadScopeManager:(char)a5 connection:(id)a6;
- (char)_deleteSendersFromThreadWithDatabaseID:(id)a0 messageThreadExpression:(id)a1;
...
- (void)_addPersistedMessages:(id)a0 journaled:(char)a1 generationWindow:(id)a2;
- (char)_addThreadScopeToDatabase:(id)a0 needsUpdate:(char)a1 lastViewedDate:(id)a2 updateThreadScopeManager:(char)a3;
- (char)_addThreadScopeToDatabaseWithMailboxType:(id)a0 filterPredicate:(unsigned long long)a1 needsUpdate:(char)a2 lastViewedDate:(id)a3 connection:(id)a4;
...
- (char)_deleteMailboxesFromWrappedMessages:(id)a0 fromThreadWithDatabaseID:(id)a1 messageThreadExpression:(id)a2;
- (char)_deleteRecipientsOfType:(unsigned long long)a0 fromThreadWithDatabaseID:(id)a1 messageThreadExpression:(id)a2;
- (id)_deleteWrappedMessages:(id)a0 fromThreadWithObjectID:(id)a1 threadScopeDatabaseID:(long long)a2 generationWindow:(id)a3;
- (char)_enumerateThreadObjectIDsForThreadScope:(id)a0 filterClause:(id)a1 sortDescriptors:(id)a2 batchBlock:(id /* block */)a3;
...
- (char)_isThreadScopePrecomputed:(id)a0 shouldMigrate:(char *)a1;
...
- (char)_messagesAreJournaledForThreadWithObjectID:(id)a0;
...
- (char)_recalculateNewestMessageForThreadObjectID:(id)a0 threadScopeDatabaseID:(long long)a1;
- (char)_recalculateNewestReadMessageForThreadObjectID:(id)a0 threadScopeDatabaseID:(long long)a1;
...
- (id)_statementForOldestThreadInMailbox:(id)a0 threadScope:(id)a1 createMailboxDatabaseIDIfNecessary:(char)a2;
...
- (char)_updateNewestReadMessageWithWrappedMessage:(id)a0 threadExpression:(id)a1;
...
- (void)_writeThreadedMessages:(id)a0 withChangedKeyPaths:(id)a1 journaled:(char)a2 generationWindow:(id)a3;
- (char)addThreadScopeToDatabase:(id)a0 needsUpdate:(char)a1 lastViewedDate:(id)a2;
- (char)addThreadsDuringMigration:(id)a0;
- (id)beginMigratingThreadScope:(id)a0;
- (id)changeForThreadWithObjectID:(id)a0 changedKeyPaths:(id)a1;
- (char)deleteThreadsWithObjectIDs:(id)a0;
- (char)endMigratingThreadScope:(id)a0;
...
- (void)persistenceIsAddingMessages:(id)a0 journaled:(char)a1 generationWindow:(id)a2;
...
- (unsigned long long)persistenceStateForThreadScope:(id)a0 wantsPrecomputed:(char)a1;
...
- (char)setPriorityForDisplayMessageSenderForThreadObjectID:(id)a0;
...
- (char)threadScopeManager:(id)a0 evictThreadScopesWithDatabaseIDs:(id)a1 completionBlock:(id /* block */)a2;
- (void)threadScopeManager:(id)a0 gatherStatisticsForThreadScopesWithDatabaseIDs:(id)a1 block:(id /* block */)a2;
- (char)threadScopeManager:(id)a0 isValidMailboxObjectID:(id)a1;
- (char)threadScopeManager:(id)a0 mailboxScopeExists:(id)a1;
