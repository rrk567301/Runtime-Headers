...
@property (nonatomic) char isPreparingFirstBatch;
@property (nonatomic) char hasEverReconciledJournal;
@property (nonatomic) char isPaused;
@property (nonatomic) char hasChangesWhilePaused;
...
- (id)_extraInfoForThreadObjectIDs:(id)a0 isMove:(char)a1;
...
- (void)_restartHelper;
- (void)collection:(id)a0 didMergeInThreadsForMove:(char)a1 newObjectIDs:(id)a2 existingObjectID:(id)a3 hasChanges:(char *)a4;
...
- (char)collection:(id)a0 reportChanges:(id)a1;
- (char)collection:(id)a0 reportChanges:(id)a1 reloadSummaries:(char)a2;
- (char)collection:(id)a0 reportDeletes:(id)a1;
