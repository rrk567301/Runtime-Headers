...
- (void).cxx_destruct;
- (unsigned long long)_performRequests:(unsigned long long)a0 unconditionally:(char)a1 withDeferBlock:(id /* block */)a2 completedCount:(unsigned long long *)a3;
- (void)_addRemoteContentLinks:(id)a0 andVerify:(char)a1 WithParsedLinks:(id)a2 defaultCharsetName:(id)a3;
- (double)_getTimeout;
...
- (unsigned long long)_requestRemoteLinksInBackground:(unsigned long long)a0 unconditionally:(char)a1 hasMoreLinks:(char *)a2 deferBlock:(id /* block */)a3;
- (id)_requestSchedulerWithInterval:(double)a0;
- (void)_scheduleBackgroundRequests;
- (void)_scheduleRequestForLinks:(unsigned long long)a0 unconditionally:(char)a1 withDelay:(double)a2 completionHandler:(id /* block */)a3;
- (void)_updateScheduling;
- (void)_updateTimeoutSettingDefaultIfNeeded:(char)a0;
...
- (void)addRemoteContentLinks:(id)a0 requiredParsing:(char)a1;
...
- (char)shouldAddRemoteContentLinksForMessage:(id)a0 logMessage:(id *)a1;
- (char)shouldAddRemoteContentLinksForMessageWithDateReceived:(id)a0;
- (char)shouldVerifyRemoteLinks;
- (void)test_tearDown;
