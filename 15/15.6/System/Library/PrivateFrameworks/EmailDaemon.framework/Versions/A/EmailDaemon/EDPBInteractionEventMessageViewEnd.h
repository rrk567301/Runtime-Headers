@interface EDPBInteractionEventMessageViewEnd : PBCodable <EDPBDataSetters, EDPBBaseMessageFields, NSCopying> {
    struct { unsigned char accountId : 1; unsigned char conversationId : 1; unsigned char duration : 1; unsigned char mailboxId : 1; unsigned char messageId : 1; unsigned char mailboxType : 1; unsigned char scrolledToEnd : 1; } _has;
}
...
@property (nonatomic) char hasScrolledToEnd;
@property (nonatomic) char scrolledToEnd;
