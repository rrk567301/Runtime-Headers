...
- (void).cxx_destruct;
- (void)_iteratePersistedMessagesDroppingLockForMatchingQuery:(id)a0 limit:(long long)a1 batchSize:(long long)a2 cancelationToken:(id)a3 requireProtectedData:(char)a4 handler:(id /* block */)a5 completion:(id /* block */)a6;
