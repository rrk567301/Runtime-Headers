...
- (char)_ensureTempMessagesView;
- (id)_mailboxDatabaseIDsForWrappedMessages;
- (void)addKeyPathsForDisplayMessageChangeToKeyPaths:(id)a0;
- (char)addMailboxes;
- (char)addRecipients:(id)a0 ofType:(unsigned long long)a1;
- (char)addRecipientsForType:(unsigned long long)a0;
- (char)addSenders;
- (char)addSenders:(id)a0;
- (unsigned long long)currentSenderCounts;
- (id)initWithMessages:(id)a0 threadDatabaseID:(long long)a1;
- (char)recipientDatabaseIDsAndDatesForRecipientType:(unsigned long long)a0 recipients:(id *)a1;
- (char)senderDatabaseIDsAndDates:(id *)a0;
- (char)setPriorityForDisplayMessageSender;
- (char)updateDisplayMessageWithUnreadWrappedMessages:(id)a0;
- (id)updateNewestReadAndDisplayMessage;
- (char)updateNewestReadMessage:(id)a0;
