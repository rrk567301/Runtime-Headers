...
- (char)_canPerformIncrementalIndexForIdentifier:(id)a0 indexingType:(long long)a1;
...
- (id)messagesWhere:(id)a0 useSearchableRebuildTable:(char)a1 limit:(long long)a2;
