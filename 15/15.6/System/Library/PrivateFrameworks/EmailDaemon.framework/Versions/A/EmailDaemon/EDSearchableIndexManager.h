...
@property (class, readonly, nonatomic) char shouldCancelSearchQuery;
@property (class, readonly) NSObject<OS_os_log> *log;

@property (nonatomic) char needsToRedonate;
@property (nonatomic) char needsToScheduleRecurringActivity;
...
- (void)enableIndexingAndBeginScheduling:(char)a0;
- (void)enableIndexingAndBeginScheduling:(char)a0 budgetConfiguration:(id)a1;
