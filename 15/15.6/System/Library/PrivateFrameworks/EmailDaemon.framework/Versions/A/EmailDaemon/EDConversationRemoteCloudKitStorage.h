...
@property (nonatomic, getter=isMigratedFromKVSStorage) char migratedFromKVSStorage;
...
- (void)_removeConversationInfoWithObjectId:(id)a0 save:(char)a1 managedObjectContext:(id)a2;
...
- (void)setMigratedFromKVSStorage:(char)a0;
- (id)storageName;
