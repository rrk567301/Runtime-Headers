...
- (char)_addNewSendersForEmailAddresses:(id)a0 toBucket:(long long)a1 connection:(id)a2 newSenders:(id *)a3;
- (char)_addAddressesWithDatabaseIDs:(id)a0 toSenderWithDatabaseID:(id)a1 connection:(id)a2 error:(id *)a3;
- (char)_addNewSender:(id)a0 toCategoryType:(unsigned long long)a1 connection:(id)a2;
- (char)_addNewSenderWithAddressIDs:(id)a0 contactIdentifier:(id)a1 toBucket:(long long)a2 categoryType:(unsigned long long)a3 connection:(id)a4 senderDatabaseID:(long long *)a5;
- (char)_addNewSenderWithAddressIDs:(id)a0 contactIdentifier:(id)a1 toBucket:(long long)a2 connection:(id)a3 senderDatabaseID:(long long *)a4;
- (char)_addNewSendersForEmailAddresses:(id)a0 toBucket:(long long)a1 categoryType:(unsigned long long)a2 connection:(id)a3 newSenders:(id *)a4;
...
- (char)_blockOrUnblockSendersForAddresses:(id)a0 block:(char)a1 blockedAddressDatabaseIDs:(id)a2 connection:(id)a3 addressesToUpdate:(id *)a4;
...
- (char)_moveSenderWithDatabaseID:(long long)a0 toBucket:(long long)a1 connection:(id)a2;
- (char)_moveSenderWithDatabaseID:(long long)a0 toCategoryType:(unsigned long long)a1 connection:(id)a2;
- (void)_moveSenderWithEmailAddresses:(id)a0 toBucket:(long long)a1 sync:(char)a2 userInitiated:(char)a3;
- (id)_moveSenderWithSimpleEmailAddresses:(id)a0 toBucket:(long long)a1 sync:(char)a2 userInitiated:(char)a3 transactionGeneration:(long long *)a4;
- (id)_moveSendersWithSimpleEmailAddresses:(id)a0 toCategoryType:(unsigned long long)a1 sync:(char)a2 userInitiated:(char)a3 transactionGeneration:(long long *)a4;
...
- (void)_setIsBlocked:(char)a0 forAddresses:(id)a1;
...
- (char)bucketForSenderAddress:(id)a0 bucket:(long long *)a1;
- (char)bucketsForSenderAddresses:(id)a0 buckets:(id *)a1;
