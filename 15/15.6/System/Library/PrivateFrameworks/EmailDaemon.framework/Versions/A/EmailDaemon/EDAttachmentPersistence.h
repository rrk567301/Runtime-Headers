...
- (char)insertMessageAttachmentMetadata:(id)a0;
- (void)insertMimePartAttachments:(id)a0 forGlobalMessageID:(long long)a1;
- (char)messageAttachmentExistsForGlobalMessageID:(long long)a0 mimePartNumber:(id)a1 hasAttachmentEntry:(char *)a2;
- (char)messageAttachmentExistsForGlobalMessageID:(long long)a0 remoteURL:(id)a1 hasAttachmentEntry:(char *)a2;
- (id)messageAttachmentMetadataForMessageID:(long long)a0;
- (char)removeAttachments:(id)a0;
- (id)uniqueAttachmentDataForHash:(id)a0;
- (char)updateAttachmentIDForMessageAttachment:(id)a0;
