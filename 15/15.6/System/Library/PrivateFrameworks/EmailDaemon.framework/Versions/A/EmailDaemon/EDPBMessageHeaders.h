@interface EDPBMessageHeaders : PBCodable <NSCopying> {
    ...
    struct { char *list; unsigned long long count; unsigned long long size; } _bccIsVips;
    ...
    struct { char *list; unsigned long long count; unsigned long long size; } _ccIsVips;
    ...
    struct { char *list; unsigned long long count; unsigned long long size; } _toIsVips;
...
@property (nonatomic) char hasMessageIsForwarded;
@property (nonatomic) char messageIsForwarded;
...
@property (nonatomic) char hasListId;
...
- (char)bccIsVipAtIndex:(unsigned long long)a0;
...
- (void)setBccIsVips:(char *)a0 count:(unsigned long long)a1;
...
- (void)setCcIsVips:(char *)a0 count:(unsigned long long)a1;
...
- (void)setToIsVips:(char *)a0 count:(unsigned long long)a1;
