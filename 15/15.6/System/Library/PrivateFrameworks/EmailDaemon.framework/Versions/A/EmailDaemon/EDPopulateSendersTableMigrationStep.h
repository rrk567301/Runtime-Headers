...
+ (char)_clearSendersAddressesTableWithConnection:(id)a0;
+ (char)_clearSendersTableWithConnection:(id)a0;
+ (id)_combineDictionary:(id)a0 withDictionary:(id)a1;
+ (char)_insertGroupedSendersWithoutContact:(id)a0 withConnection:(id)a1;
+ (char)_insertSenderWithAddresses:(id)a0 contact:(id)a1 connection:(id)a2 error:(id *)a3;
+ (char)_insertSendersGroupedByContact:(id)a0 withConnection:(id)a1;
...
+ (char)runWithConnection:(id)a0 sentMailboxURLs:(id)a1 contactStore:(id)a2;
