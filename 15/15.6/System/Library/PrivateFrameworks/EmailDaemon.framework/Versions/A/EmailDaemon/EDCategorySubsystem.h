@class EDBiomeInteractionEventLog, EDCategoryPersistence, EDInteractionLogger, EDMessagePersistence, EDMessageCategorizer, EDCoreAnalyticsBiomeInteractionEventLog, NSObject, EDBusinessPersistence, EDActivityPersistence, NSString, EDPETInteractionEventLog, EDCategoryCoreAnalyticsLogger, EDMessageAuthenticator;
