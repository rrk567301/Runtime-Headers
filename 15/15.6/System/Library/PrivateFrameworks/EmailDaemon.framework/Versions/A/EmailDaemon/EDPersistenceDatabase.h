...
@property (readonly, nonatomic) char databaseIsCorrupt;
@property (readonly, nonatomic) char enforceDataProtection;
@property char setupIsComplete;
@property (readonly, nonatomic) char isNestedDatabaseCall;
@property (readonly, nonatomic) char writersAreWaiting;
...
@property (readonly, nonatomic) char protectedDatabaseIsAvailable;
...
- (char)__performReadWithCaller:(id)a0 usingBlock:(id /* block */)a1;
- (char)__performWriteWithCaller:(id)a0 usingBlock:(id /* block */)a1;
...
- (char)performDatabaseSetupUsingTransaction:(char)a0 block:(id /* block */)a1;
