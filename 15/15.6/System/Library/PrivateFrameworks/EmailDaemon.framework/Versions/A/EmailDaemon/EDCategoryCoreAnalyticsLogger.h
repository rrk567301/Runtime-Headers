...
- (id)_emSharedModelMetadataWithScheduledHour:(char)a0;
...
- (int)_hourInUTC;
- (char)_isMailAccountBucketBarHidden:(id)a0;
- (void)_logAccountPersonalPreferenceForBucketBar;
- (void)_logAccountPersonalPreferenceForScheduledHour;
- (void)_logAccountPersonalPreferenceWithEventName:(id)a0 scheduledHour:(id)a1 includeReceivingAccountDomain:(char)a2;
- (void)_logBucketBarChanges;
- (long long)_loggingCategoryTypeFromType:(unsigned long long)a0 isHighImpact:(char)a1;
- (long long)_loggingPredecitedCategoryTypeFromType:(unsigned long long)a0 isHighImpact:(char)a1;
...
- (void)bucketBarConfigurationController:(id)a0 isHidden:(char)a1 forMailboxes:(id)a2;
...
- (void)logRecategorizationEventForMessages:(id)a0 categoryType:(unsigned long long)a1 categoryPersistence:(id)a2 isHighImpactFlagChange:(char)a3;
