...
- (char)persistCategorizationResult:(id)a0 forGlobalID:(long long)a1 categorizationVersion:(long long)a2 connection:(id)a3;
- (char)persistCategorizationResultMap:(id)a0 userInitiated:(char)a1;
