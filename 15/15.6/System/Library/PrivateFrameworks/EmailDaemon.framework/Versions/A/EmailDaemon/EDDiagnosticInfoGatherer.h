...
- (void).cxx_destruct;
- (char)_copyFromDatabase:(struct sqlite3 { } *)a0 intoDatabase:(struct sqlite3 { } *)a1;
- (char)_compressDatabaseAtURL:(id)a0 intoDirectoryURL:(id)a1;
- (char)_compressDirectoryAtURL:(id)a0 intoArchiveWithURL:(id)a1;
- (char)_copyDatabaseFromURL:(id)a0 intoDatabaseAtURL:(id)a1;
