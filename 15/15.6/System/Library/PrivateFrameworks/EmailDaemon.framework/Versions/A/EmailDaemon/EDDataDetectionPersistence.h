...
- (void).cxx_destruct;
- (char)_addDataDetectionResults:(id)a0 withGlobalMessageID:(long long)a1 toTable:(id)a2 withConnection:(id)a3;
- (id)_getPersistedMessagesFromGlobalMessageID:(long long)a0;
- (char)_hookResponderRespondsToRequiredMethods:(id)a0;
- (char)addDataDetectionResults:(id)a0 globalMessageID:(long long)a1;
