...
- (id)_performMessageTransferActionToSpecialMailbox:(id)a0 returnUndoAction:(char)a1;
...
- (id)_performMessageFollowUpDate:(id)a0 persistedMessages:(id)a1 returnUndoAction:(char)a2;
...
- (id)_changeFlagsForPersistedMessages:(id)a0 flagChange:(id)a1 returnUndoAction:(char)a2;
...
- (void)_logRecategorizeAnalyticsWithPersistedMessages:(id)a0 isRestoreModelCategory:(char)a1 categoryChangeAction:(id)a2;
...
- (id)_performBlockSender:(char)a0 persistedMessages:(id)a1 returnUndoAction:(char)a2;
...
- (id)_performConversationIDs:(id)a0 conversationNotificationLevel:(long long)a1 returnUndoAction:(char)a2;
- (id)_performMessageConversationFlagChangeAction:(id)a0 returnUndoAction:(char)a1;
- (void)_performMessageDeleteAction:(id)a0;
- (id)_performMessageFlagChangeAction:(id)a0 returnUndoAction:(char)a1;
- (void)_performMessageFlagChangeAllAction:(id)a0;
- (id)_performMessageFollowUpAction:(id)a0 returnUndoAction:(char)a1;
- (id)_performMessageReadLaterAction:(id)a0 returnUndoAction:(char)a1;
- (id)_performMessageReadLaterDate:(id)a0 persistedMessages:(id)a1 returnUndoAction:(char)a2;
- (id)_performMessageTransferAction:(id)a0 returnUndoAction:(char)a1;
...
- (id)_performSenderBlockingAction:(id)a0 returnUndoAction:(char)a1;
...
- (id)_persistedMessagesForObjectIDs:(id)a0 includeDuplicates:(char)a1;
...
- (void)getRemoteContentURLInfoOrderedBy:(long long)a0 inReverseOrder:(char)a1 limit:(long long)a2 completionHandler:(id /* block */)a3;
...
- (void)performMessageChangeAction:(id)a0 requestID:(unsigned long long)a1 returnUndoAction:(char)a2 completionHandler:(id /* block */)a3;
- (void)performMessageHighImpactChangeAction:(id)a0;
- (void)performOneTimeCodeMessageDeletionWithObjectID:(id)a0 requestID:(unsigned long long)a1 returnUndoAction:(char)a2 afterDelay:(double)a3 completionHandler:(id /* block */)a4;
