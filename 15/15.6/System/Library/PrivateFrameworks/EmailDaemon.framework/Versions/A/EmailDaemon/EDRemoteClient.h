@class EDActivityRegistry, NSXPCListenerEndpoint, EDDaemonInterfaceFactory, NSObject, EDInteractionLogger, EDOutgoingMessageRepository, EDDiagnosticInfoGatherer, EDSenderRepository, EDFetchController, EDMailboxRepository, EDClientResumer, NSString, EDAccountRepository, EDClientState, EDMessageRepository, NSXPCConnection, NSXPCInterface, EDSearchableIndex;
...
- (void)dealloc;
- (void).cxx_destruct;
- (void)checkInMailAppEndpoint:(id)a0 completion:(id /* block */)a1;
...
- (void)requestMailAppEndpointWithCompletion:(id /* block */)a0;
- (void)setAllowsBackgroundResume:(char)a0;
- (void)test_tearDown;
