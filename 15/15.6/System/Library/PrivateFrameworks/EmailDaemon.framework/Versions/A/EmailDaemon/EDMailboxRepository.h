...
- (void).cxx_destruct;
- (char)_performCreateMailboxChangeAction:(id)a0;
- (char)_performDeleteMailboxChangeAction:(id)a0;
- (char)_performMoveMailboxChangeAction:(id)a0;
- (char)_performRenameMailboxChangeAction:(id)a0;
