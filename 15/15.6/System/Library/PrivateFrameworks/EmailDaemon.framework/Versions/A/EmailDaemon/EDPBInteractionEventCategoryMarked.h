@interface EDPBInteractionEventCategoryMarked : PBCodable <EDPBDataSetters, EDPBBaseMessageFields, NSCopying> {
    struct { unsigned char accountId : 1; unsigned char conversationId : 1; unsigned char mailboxId : 1; unsigned char messageId : 1; unsigned char categoryType : 1; unsigned char mailboxType : 1; unsigned char positive : 1; unsigned char removeAllUserOverrides : 1; } _has;
}
...
@property (nonatomic) char hasRemoveAllUserOverrides;
@property (nonatomic) char removeAllUserOverrides;
