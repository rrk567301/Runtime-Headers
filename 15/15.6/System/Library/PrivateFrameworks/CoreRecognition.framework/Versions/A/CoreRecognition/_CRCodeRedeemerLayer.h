...
@property (nonatomic) char foundBoundingBox;
@property (nonatomic) char isRectangleMoving;
@property (nonatomic) int isCaptureModeOnly;
@property (nonatomic) char isBatchModeOnly;
@property (nonatomic) char isActiveRedeemer;
@property (nonatomic) char isFirstBoxDetection;
@property (nonatomic) char isLastCapture;
@property (nonatomic) char isContinuousCapture;
@property (nonatomic) char isCaptureUpsideDown;
@property (nonatomic) char isReadyForProcessing;
@property (nonatomic) char sessionIsRunning;
@property (nonatomic) char redeemerShowsMessageError;
...
@property char videoQueueSuspended;
