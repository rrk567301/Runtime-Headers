...
@property char exposureAdjustmentInProgress;
@property int exposureAdjustmentInProgressTimeoutCount;
@property char runningManualExposure;
...
@property char enableMetadataOutput;
...
- (void)startRunning;
- (char)switchToCamera:(long long)a0;
- (id)backFacingCamera;
...
- (struct CGPoint { double x0; double x1; })convertCameraPoint:(struct CGPoint { double x0; double x1; })a0 toLayer:(id)a1 flipped:(char)a2;
- (struct CGPoint { double x0; double x1; })convertCameraPointOCR:(struct CGPoint { double x0; double x1; })a0 toLayer:(id)a1 flipped:(char)a2;
...
- (char)switchToCameraWithDeviceID:(id)a0;
