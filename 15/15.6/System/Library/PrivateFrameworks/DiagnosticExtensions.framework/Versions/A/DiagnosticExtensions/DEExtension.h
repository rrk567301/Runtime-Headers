...
@property char isFetchingExtensionHostContext;
@property char adoptsExtensionTrackerFlow;
...
@property (readonly, nonatomic) char isLoggingEnabled;
...
- (char)requiresDataClassBAccessToRun;
