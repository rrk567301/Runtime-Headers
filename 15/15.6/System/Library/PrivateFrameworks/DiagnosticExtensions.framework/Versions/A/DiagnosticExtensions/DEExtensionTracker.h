...
+ (char)hasInactiveLoggingSession:(id)a0;
...
+ (char)shouldSetupWithIdentifier:(id)a0 session:(id)a1 expirationDate:(id)a2;
+ (char)shouldTeardownWithIdentifier:(id)a0 session:(id)a1;
