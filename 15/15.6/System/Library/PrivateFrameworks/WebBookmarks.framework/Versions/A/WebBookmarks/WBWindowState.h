...
@property (readonly, nonatomic) char isFavoritesBarHidden;
@property (readonly, nonatomic) char isMinimized;
@property (readonly, nonatomic) char isPopupWindow;
@property (readonly, nonatomic) char isPrivateWindow;
@property (readonly, nonatomic) char isTabBarHidden;
...
- (char)isEqualToWindowState:(id)a0;
- (id)localOrUnnamedTabGroupForRestoration:(char)a0 inProfileWithIdentifier:(id)a1 deviceIdentifier:(id)a2;
