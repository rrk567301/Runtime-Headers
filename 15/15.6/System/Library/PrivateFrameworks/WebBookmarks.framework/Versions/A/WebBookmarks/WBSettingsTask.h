...
@property (readonly, nonatomic) char clearAllProfiles;

+ (id)taskWithType:(long long)a0;
+ (id)taskForDeletingAllWebsiteDataInProfileWithIdentifier:(id)a0;
+ (id)taskForDeletingHistoryAfterDate:(id)a0 beforeDate:(id)a1 forProfileIdentifier:(id)a2 clearAllProfiles:(char)a3;
+ (id)taskForDeletingIndividualWebsiteDataWithRecord:(id)a0;

- (void).cxx_destruct;
- (id)initWithType:(long long)a0 afterDate:(id)a1 beforeDate:(id)a2 profileIdentifier:(id)a3 clearAllProfiles:(char)a4;
