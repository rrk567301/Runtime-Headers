...
- (void)clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 profileIdentifiers:(id)a2 options:(long long)a3 clearAllSpotlightHistoryForProfile:(char)a4 completionHandler:(id /* block */)a5;
