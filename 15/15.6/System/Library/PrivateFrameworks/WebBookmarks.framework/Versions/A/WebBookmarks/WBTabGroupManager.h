...
@property (readonly, nonatomic) char enableSharedTabGroupsFastSyncPresence;
@property (readonly, nonatomic) char hasSharedTabGroups;
@property (readonly, nonatomic) char isBroadcastingPresenceUpdates;
...
- (void)deleteScopedBookmarkWithUUID:(id)a0 notify:(char)a1;
...
- (void)insertScopedBookmark:(id)a0 inScopedBookmarkFolderWithID:(int)a1 afterBookmarkWithUUID:(id)a2 notify:(char)a3;
- (id)insertTabGroup:(id)a0 afterTabGroup:(id)a1;
- (id)insertUnnamedTabGroup:(id)a0;
- (char)isTab:(id)a0 childOfPinnedTabGroupOfNamedProfileOfUnnamedTabGroup:(id)a1;
...
- (void)reorderScopedBookmarkWithUUID:(id)a0 afterBookmarkWithUUID:(id)a1 notify:(char)a2;
...
- (id)updateProfileWithIdentifier:(id)a0 persist:(char)a1 usingBlock:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (void)updateScopedBookmarkWithUUID:(id)a0 title:(id)a1 address:(id)a2 notify:(char)a3;
- (void)updateTabGroupWithUUID:(id)a0 persist:(char)a1 usingBlock:(id /* block */)a2;
- (void)updateTabWithUUID:(id)a0 persist:(char)a1 notify:(char)a2 usingBlock:(id /* block */)a3;
...
- (void)updateTabsInTabGroupWithUUID:(id)a0 persist:(char)a1 usingBlock:(id /* block */)a2;
...
- (char)_didLocallyCreateUnnamedTabGroup:(id)a0;
...
- (id)_profiles;
- (void)_reloadProfilesAndTabGroupsAndNotify:(char)a0 withCompletionHandler:(id /* block */)a1;
...
- (char)_shouldBeginDevicePresenceReporting;
- (char)_shouldEndDevicePresenceReporting;
...
- (void)deleteScopedBookmarkWithUUID:(id)a0 notify:(char)a1 completionHandler:(id /* block */)a2;
