...
- (id)_cyclerRepresentationOfTabGroupFavorite:(id)a0;
- (id)_cyclerRepresentationOfTopScopedBookmarkListForTabGroup:(id)a0;
...
- (void)_startMonitoringTabGroupUpdateExpectingMigration:(char)a0 completionHandler:(id /* block */)a1;
...
- (id)_tabGroupFavoriteBeforeIndex:(unsigned long long)a0 inList:(id)a1;
