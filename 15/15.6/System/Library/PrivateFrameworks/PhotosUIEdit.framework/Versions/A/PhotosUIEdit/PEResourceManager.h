...
- (id)compositionControllerWithoutSource:(id)a0 originalComposition:(char)a1 editorBundleID:(id *)a2;
- (void)loadResourceForAsset:(id)a0 requireLocalResources:(char)a1 forceRunAsUnadjustedAsset:(char)a2 progressHandler:(id /* block */)a3 resultHandler:(id /* block */)a4;
- (id)originalCompositionControllerWithoutSource:(id)a0 reconstructIfMissing:(char)a1;
