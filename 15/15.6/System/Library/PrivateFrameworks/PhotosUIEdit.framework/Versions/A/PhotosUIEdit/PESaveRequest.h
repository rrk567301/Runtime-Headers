...
@property (readonly, nonatomic) char supportsProgress;
@property (readonly, nonatomic) double progress;

- (id)init;
- (void).cxx_destruct;
- (void)_finishWithSuccess:(char)a0 error:(id)a1;
...
- (id)initWithPhoto:(id)a0 compositionController:(id)a1 contentEditingOutput:(id)a2 livePhotoState:(unsigned short)a3 applyVideoOrientationAsMetadata:(char)a4;
- (id)initWithPhoto:(id)a0 contentEditingOutput:(id)a1 livePhotoState:(unsigned short)a2 applyVideoOrientationAsMetadata:(char)a3;
- (id)initWithPhotoToRevertToOriginal:(id)a0 applyVideoOrientationAsMetadata:(char)a1;
