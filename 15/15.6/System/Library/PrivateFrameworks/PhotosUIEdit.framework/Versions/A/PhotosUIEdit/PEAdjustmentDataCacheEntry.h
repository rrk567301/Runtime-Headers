...
- (void).cxx_destruct;
- (void)_load:(id)a0 networkAccessAllowed:(char)a1 originalAdjustmentData:(char)a2;
- (void)deliverOn:(id)a0 completion:(id /* block */)a1;
- (id)initWithAsset:(id)a0 networkAccessAllowed:(char)a1 originalAdjustmentData:(char)a2;
