...
@property (nonatomic) char cachedStrokeMaskFilled;

- (id)init;
- (void).cxx_destruct;
- (void)_analyzeSegmentationResult:(id)a0 forStroke:(id)a1 treatStrokeAsFilledCircle:(char)a2 maskContext:(id)a3 compositionController:(id)a4 geometry:(id)a5 usingTargetPoints:(char)a6 userSettings:(id)a7 completion:(id /* block */)a8;
- (void)_analyzeStrokeMaskIntersections:(id)a0 treatStrokeAsFilledCircle:(char)a1 usingMaskContext:(id)a2 useTargetPoints:(char)a3 compositionController:(id)a4 geometry:(id)a5 userSettings:(id)a6 completion:(id /* block */)a7;
...
- (id)_maskForStroke:(id)a0 imageSize:(struct CGSize { double x0; double x1; })a1 maskSize:(struct CGSize { double x0; double x1; })a2 filled:(char)a3;
- (char)_strokeAppearsToBeClosedShape:(id)a0 imageToScreenSpaceScale:(double)a1 lassoDistance:(double)a2;
- (id)_strokeToNormalizedSampledPointArray:(id)a0 maxPointCount:(long long)a1 originalImageSize:(struct CGSize { double x0; double x1; })a2 treatStrokeAsFilledCircle:(char)a3;
...
- (char)shouldChooseSegment:(id)a0;
