...
@property (nonatomic) char shouldBypassGating;
@property (copy, nonatomic) NUComposition *sourceAssetComposition;

+ (char)isAssetTypeEligibleForSmartPaste:(id)a0;
+ (char)isCompositionControllerEligibleForSmartPaste:(id)a0;
...
- (char)_shouldPerformSmartPasteOnAsset:(id)a0;
