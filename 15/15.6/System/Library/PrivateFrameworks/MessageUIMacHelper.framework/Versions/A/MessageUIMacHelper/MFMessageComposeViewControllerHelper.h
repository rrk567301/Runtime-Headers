...
+ (char)canPerformMessageSharingService;
...
- (void)_setCanEditRecipients:(char)a0;
- (void)_setShouldIgnoreEmailsWhenSending:(char)a0;
- (char)addAttachmentURL:(id)a0 withAlternateFilename:(id)a1;
