...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (char)mergeUserInfo:(id)a0 error:(id *)a1;
- (id)replaceItemAtURL:(id)a0 error:(id *)a1;
- (char)setOptions:(unsigned long long)a0 error:(id *)a1;
- (char)refreshWithError:(id *)a0;
- (char)markSavedConflictAsResolved:(char)a0 error:(id *)a1;
- (id)_initWithStorage:(id)a0 andDictionary:(id)a1;
- (char)copyAdditionContentToURL:(id)a0 error:(id *)a1;
- (void)_refreshWithDictionary:(id)a0;
- (id)displayNameWithError:(id *)a0;
- (char)internalStat:(struct stat { int x0; unsigned short x1; unsigned short x2; unsigned long long x3; unsigned int x4; unsigned int x5; int x6; struct timespec { long long x0; long long x1; } x7; struct timespec { long long x0; long long x1; } x8; struct timespec { long long x0; long long x1; } x9; struct timespec { long long x0; long long x1; } x10; long long x11; long long x12; int x13; unsigned int x14; unsigned int x15; int x16; long long x17[2]; } *)a0;
- (id)originalPOSIXNameWithError:(id *)a0;
- (char)setDisplayName:(id)a0 error:(id *)a1;
- (char)setNameSpace:(id)a0 error:(id *)a1;
