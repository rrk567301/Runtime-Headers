...
- (void)ack:(id)a0 result:(char)a1 error:(id)a2;
...
- (void)handleConnection:(char)a0 from:(id)a1;
- (void)handleFile:(id)a0 from:(id)a1 metadata:(id)a2;
- (void)handleMessage:(id)a0 from:(id)a1;
- (char)isFilenameReasonable:(id)a0;
- (void)listDevices:(id /* block */)a0;
- (void)receivedReport:(id)a0 from:(id)a1 metadata:(id)a2;
