...
+ (id)netSessionConnectionFailedWithError:(id)a0 connectionMode:(id)a1 sessionType:(id)a2 sessionState:(id)a3 isDormant:(char)a4 snConnectionAnalysisInfo:(id)a5;
