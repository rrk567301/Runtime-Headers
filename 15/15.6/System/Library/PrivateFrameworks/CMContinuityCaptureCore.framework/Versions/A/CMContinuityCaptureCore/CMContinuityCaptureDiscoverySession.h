...
@interface CMContinuityCaptureDiscoverySession : NSObject <CMContinuityCaptureProximityMonitorDelegate> {
    ...
    char _useCachedCapabilitiesIfApplicable;
...
- (void)device:(id)a0 isNearby:(char)a1;
...
- (char)isSessionInitiatedOnCommunalDevice;
- (char)isUserSelectedDeviceIfApplicable:(id)a0;
...
- (char)validateSessionInfoForEvent:(id)a0;
