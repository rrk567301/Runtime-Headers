...
@interface CMContinuityCaptureAudioInputProvider : NSObject <NSXPCListenerDelegate, CMContinuityCaptureAudioInputProviderObject> {
    ...
    char _firstDeviceDiscoveryFinished;
...
@property (nonatomic) char firstDeviceDiscoveryFinished;
...
- (char)_shouldPrintSampleBufferLog:(long long)a0;
- (void)_stopStreamingForAllAvailableDevices;
- (char)_waitUntilFirstDeviceDiscoveryFinishWithTimeout:(double)a0;
...
- (void)updateNetworkClockWithSynchronizedNetworkTime:(unsigned long long)a0 forSampleTime:(unsigned long long)a1 networkClockIdentifier:(unsigned long long)a2 transportTypeIsUSB:(char)a3 forAudioDeviceUID:(id)a4;
- (void)updateUSBActive:(char)a0 forAudioDeviceUID:(id)a1;
