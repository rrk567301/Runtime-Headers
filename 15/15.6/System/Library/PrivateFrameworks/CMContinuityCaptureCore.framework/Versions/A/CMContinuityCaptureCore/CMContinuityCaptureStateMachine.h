...
- (char)postEventWithName:(id)a0 data:(id)a1;
- (char)postSameStateAction:(id)a0 transition:(id)a1 event:(id)a2;
- (char)postStateChangeAction:(id)a0 transition:(id)a1 event:(id)a2;
