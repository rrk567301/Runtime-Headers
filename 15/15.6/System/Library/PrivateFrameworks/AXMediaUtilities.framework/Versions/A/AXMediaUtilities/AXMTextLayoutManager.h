...
- (id)documentWithTextFeatures:(id)a0 canvasSize:(struct CGSize { double x0; double x1; })a1 preferredLocales:(id)a2 applySemanticAnalysis:(char)a3 error:(id *)a4;
- (id)envelopeWithTextFeatures:(id)a0 canvasSize:(struct CGSize { double x0; double x1; })a1 preferredLocales:(id)a2 applySemanticAnalysis:(char)a3 error:(id *)a4;
...
- (char)hasConsecutiveCharacters:(id)a0 withLength:(unsigned long long)a1;
- (char)hasConsecutiveDigits:(id)a0 withLength:(unsigned long long)a1;
...
- (char)isBoundary:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withinBoundary:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 withNormalizedThreshold:(double)a2;
- (char)isBoundary:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withinNormalizedDistance:(double)a1 ofBoundary:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
...
- (id)processReceiptText:(id)a0 foundMerchantName:(char *)a1 preferredLocales:(id)a2;
...
- (char)verifyTable:(id)a0 sortedColumns:(id)a1;
