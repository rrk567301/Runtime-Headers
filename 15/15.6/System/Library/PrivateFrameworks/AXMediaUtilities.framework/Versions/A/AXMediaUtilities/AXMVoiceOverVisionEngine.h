...
- (id)configuredOptionsDisableAllDetectors:(id /* block */)a0 elementOptions:(unsigned int)a1 textRecognitionLevel:(id /* block */)a2 textDetectionLocales:(id /* block */)a3 preferringFullCaptions:(char)a4;
