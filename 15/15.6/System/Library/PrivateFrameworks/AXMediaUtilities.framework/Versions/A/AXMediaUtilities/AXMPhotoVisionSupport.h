...
+ (id)_collectLabelsIncludingLeafNodes:(char)a0 nonLeafNodes:(char)a1;
+ (id)_deniedVoiceOverObjectClassificationLabels;
+ (id)_deniedVoiceOverSceneClassificationLabels;
+ (char)_validatePhotosFormatSoftLinkSymbols;
+ (char)axmIsSceneClassId:(unsigned int)a0 childOfSceneClassId:(unsigned int)a1;
