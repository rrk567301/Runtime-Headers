...
- (void)triggerWithImage:(id)a0 photoLibraryURL:(id)a1 options:(id)a2 cacheKey:(id)a3 resultHandler:(id /* block */)a4;
...
- (void)triggerWithImageAssetLocalIdentifier:(id)a0 photoLibraryURL:(id)a1 usePHAsset:(char)a2 options:(id)a3 cacheKey:(id)a4 resultHandler:(id /* block */)a5;
