...
- (char)_allTabGroupsHaveSingleSubfeature:(id)a0;
...
- (char)_hasXOverlap:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 obj2:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (char)_hasYOverlap:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 obj2:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)_improveFeatureFrames:(id)a0;
- (char)_isInTopBar:(id)a0;
...
- (char)_shouldBeTabBar:(char)a0 groupedTabButtons:(id)a1;
