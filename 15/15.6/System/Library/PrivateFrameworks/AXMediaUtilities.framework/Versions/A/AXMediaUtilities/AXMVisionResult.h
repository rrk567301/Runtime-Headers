...
@property (readonly, nonatomic) char includesNSFWFeatures;
@property (readonly, nonatomic) NSArray *sensitiveContentForCaptionFeatures;
@property (readonly, nonatomic) char captionMayContainSensitiveContent;
@property (readonly, nonatomic) char includesFeaturesForImageExploration;
...
- (char)isEqualToAXMVisionResult:(id)a0;
