...
- (void)setShouldProcessRemotely:(char)a0;
- (void)triggerWithSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 interfaceOrientation:(long long)a1 mirrored:(char)a2 options:(id)a3 userContext:(id)a4;
