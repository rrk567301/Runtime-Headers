...
+ (struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)loadVImageBufferFromData:(id)a0 isRaw:(char)a1 lumaOnly:(char)a2 error:(id *)a3;
+ (struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)loadVImageBufferFromURL:(id)a0 lumaOnly:(char)a1 error:(id *)a2;
...
+ (struct CGImage { } *)rotateImage:(struct CGImage { } *)a0 withAngle:(float)a1 andXFlip:(char)a2 andYFlip:(char)a3;
...
+ (char)writeImage:(struct CGImage { } *)a0 toFile:(id)a1 error:(id *)a2;
