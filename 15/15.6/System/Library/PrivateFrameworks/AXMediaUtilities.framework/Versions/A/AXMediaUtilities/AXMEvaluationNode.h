...
@property (class, readonly, nonatomic, getter=isANEDeviceAvailable) char ANEDeviceAvailable;
...
- (char)shouldEvaluate:(id)a0;
- (id)_diagnosticNameForRequests:(id)a0 metrics:(id)a1;
- (void)boostEffectivePriority;
- (void)evaluate:(id)a0 metrics:(id)a1;
- (char)evaluateRequests:(id)a0 withContext:(id)a1 requestHandlerOptions:(id)a2 metrics:(id)a3 error:(id *)a4;
- (void)nodeInitialize;
