...
- (id)_filteredLocalesToInstallFromAvailableLocales:(id)a0 requestedLocales:(id)a1 fallBackToBaseLanguageIfNeeded:(char)a2;
...
- (void)installOfflineTranslationModelForLocales:(id)a0 fallBackToBaseLanguageIfNeeded:(char)a1 forceReinstall:(char)a2 progress:(id /* block */)a3 completion:(id /* block */)a4;
- (void)installedTranslationLocales:(id /* block */)a0;
- (void)translateText:(id)a0 toLocale:(id)a1 respectAllowList:(char)a2 completion:(id /* block */)a3;
- (id)translateText:(id)a0 toLocale:(id)a1 respectAllowList:(char)a2 metrics:(id)a3 error:(id *)a4;
