...
@property (nonatomic) char shouldProcessRemotely;
@property (readonly, nonatomic) NSArray *resultHandlers;
@property (readonly, nonatomic) struct CGSize { double x0; double x1; } size;
@property (readonly, nonatomic) char sourceProvidesResults;
@property (readonly, nonatomic) char visionImageRequestHandlerIsLoaded;
...
@property (nonatomic) char shouldCallCompletionHandlersForEngineBusyError;
@property (nonatomic) char shouldCallCompletionHandlersForEmptyResultSet;
@property (nonatomic) char evaluationExclusivelyUsesVisionFramework;
...
- (id)sceneObservation;
- (char)_addSignificantEventFeatureGateIfNeededToFeature:(id)a0 category:(id)a1 minimumConfidence:(double)a2;
- (void)_commonInitWithDiagnosticsEnabled:(char)a0;
