...
@property (nonatomic) char needsRenderSonification;
...
@property (readonly, nonatomic) char isEndingScrubbing;
@property (readonly, nonatomic) char isInLiveContinuousToneSession;
...
@property (nonatomic) char usesBinauralPanning;
@property (readonly, nonatomic) int dataMode;
@property (readonly, nonatomic) id /* block */ function;
@property (readonly, nonatomic) char shouldPlayInStereo;
...
- (char)series:(id)a0 hasContinuousPitchDataForTimePosition:(double)a1;
...
- (char)shouldIncrementToPitch:(double)a0 by:(double)a1;
- (void)stopScrubbing;
