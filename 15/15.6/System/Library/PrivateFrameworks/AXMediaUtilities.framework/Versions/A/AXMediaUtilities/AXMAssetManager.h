...
- (id)_modelAssetNamesOfType:(unsigned long long)a0 sources:(unsigned long long)a1 compiled:(char)a2;
- (id)_modelAssetURLForModelNamed:(id)a0 ofType:(unsigned long long)a1 sources:(unsigned long long)a2 compiled:(char)a3;
- (id)_modelAssetURLsOfType:(unsigned long long)a0 sources:(unsigned long long)a1 compiled:(char)a2;
- (id)_modelsDirectoryForType:(unsigned long long)a0 compiled:(char)a1;
...
- (id)modelWithName:(id)a0 ofType:(unsigned long long)a1 sources:(unsigned long long)a2 compileIfNeeded:(char)a3 persistCompiledModel:(char)a4 error:(id *)a5;
