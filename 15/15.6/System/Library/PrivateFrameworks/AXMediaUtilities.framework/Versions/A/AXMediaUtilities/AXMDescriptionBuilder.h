...
@property (nonatomic) char isNSFW;
@property (nonatomic) char shouldModifyCaptionForSensitiveContent;
...
- (void)_addCaptionInformationToDescription:(id)a0 didConsumeDetectedFaceInfo:(char *)a1;
...
- (char)_shouldPersonalizeCaptionWithKnownPeople;
