...
@property (readonly, nonatomic) char isSemanticallyComplete;
...
- (void)addIsInLexionMarker:(char)a0 withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
