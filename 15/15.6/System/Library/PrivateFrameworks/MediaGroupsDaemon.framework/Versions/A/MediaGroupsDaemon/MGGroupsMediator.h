...
@property (nonatomic, getter=hasPendingChanges) char pendingChanges;
@property (readonly, nonatomic) NSUUID *identifier;
@property (readonly, weak, nonatomic) MGGroupsQueryAgent *queryAgent;
@property (nonatomic) char allowsClientEdits;
...
- (void)removeGroup:(id)a0 ifExists_unsafe:(char *)a1;
