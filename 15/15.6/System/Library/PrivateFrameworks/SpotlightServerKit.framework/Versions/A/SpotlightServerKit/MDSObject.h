...
- (BOOL)blocksShutdown;
- (id)initWithDeferredShutdown:(char)a0;
...
- (void)registerForWakeUp:(id)a0 powerNap:(char)a1 delay:(long long)a2 gracePeriod:(long long)a3 callbackBlock:(id /* block */)a4;
...
- (unsigned long long)startupOnMain:(char)a0 group:(id)a1;
- (char)token:(int *)a0 forDarwinNotification:(id)a1;
