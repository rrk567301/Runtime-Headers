...
- (char)registerForDeadNameNotification:(unsigned int)a0 withBlock:(id /* block */)a1;
- (char)registerForDeadNameNotification:(unsigned int)a0 withSelector:(SEL)a1 andObject:(id)a2;
- (char)registerForNoSendersNotification:(unsigned int)a0 withSelector:(SEL)a1 andObject:(id)a2;
