...
+ (id)complexValueWithValue:(id)a0 label:(id)a1 isPrimary:(char)a2;
...
+ (id)resultWithProperty:(id)a0 value:(id)a1 label:(id)a2 isPrimary:(char)a3;
+ (id)unknownPropertyWithName:(id)a0 line:(id)a1;
+ (id)version21DataUsingAdapter:(id)a0;
+ (char)version21DataUsingAdapter:(id)a0 containsData:(id)a1;
+ (char)version30CardForPerson:(id)a0 containsLine:(id)a1;
+ (char)version30CardForPerson:(id)a0 containsString:(id)a1;
+ (id)version30DataUsingAdapter:(id)a0;
+ (char)version30DataUsingAdapter:(id)a0 containsData:(id)a1;
