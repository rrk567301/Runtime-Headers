...
@property (readonly, nonatomic) char hasAccountsConfigured;
...
+ (char)doesAddressList:(id)a0 containAddressInSet:(id)a1;
...
- (char)isMyEmailAddressContainedInAddressList:(id)a0;
- (id)_accountsEmailAddresses;
- (id)_contactEmailAddresses;
- (char)_isMyEmailAddressContainedInAddressStrings:(id)a0;
- (id)contactWithKeysToFetch:(id)a0;
- (char)hasAccountConfigured;
