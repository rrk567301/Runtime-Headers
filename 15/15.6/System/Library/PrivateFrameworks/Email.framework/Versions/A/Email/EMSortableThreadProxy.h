...
- (id)_setValueFromThreadAndReturnIfChanged:(id)a0 keyPath:(id)a1 isPrimary:(char)a2;
...
- (void)updateFromThread:(id)a0 addingAdditionalInformation:(char)a1 query:(id)a2;
