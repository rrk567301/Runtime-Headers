...
+ (id)simpleMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 countOfItemsToPrecache:(unsigned long long)a3 shouldUpdateDisplayDate:(char)a4 sortDescriptors:(id)a5 transformPredicate:(id /* block */)a6;
+ (id)simpleMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 shouldUpdateDisplayDate:(char)a3;
+ (id)threadedMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 countOfItemsToPrecache:(unsigned long long)a3 shouldUpdateDisplayDate:(char)a4 sortDescriptors:(id)a5 sectionPredicates:(id)a6 transformPredicate:(id /* block */)a7;
+ (id)threadedMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 shouldUpdateDisplayDate:(char)a3;
...
- (char)_threadIsExpanded:(id)a0;
- (char)_threadIsExpandedForItemID:(id)a0;
...
- (void)finishRecovery;
- (id)initWithMailboxes:(id)a0 repository:(id)a1 sortDescriptors:(id)a2 sectionPredicates:(id)a3 transformPredicate:(id /* block */)a4 targetClass:(Class)a5 additionalQueryOptions:(unsigned long long)a6 countOfItemsToPrecache:(unsigned long long)a7 shouldUpdateDisplayDate:(char)a8 labelPrefix:(id)a9;
