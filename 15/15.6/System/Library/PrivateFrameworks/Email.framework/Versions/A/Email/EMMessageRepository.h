...
- (id)_messageListItemsForObjectIDs:(id)a0 observationIdentifier:(id)a1 checkCache:(char)a2;
- (id)persistentIDForMessageObjectID:(id)a0;
- (void)resetAllPrecomputedThreadScopes;
- (id)_addPrecachedItemsFromExtraInfoIfNeeded:(id)a0;
- (char)_anyObserver:(id)a0 containsObjectID:(id)a1;
...
- (id)_observedCachedItemForItem:(id)a0 itemDescriptionForLogging:(id)a1 validationBlock:(id /* block */)a2;
- (void)_removeItemsFromObservedItemsCacheIfNotObservedByObservers:(id)a0;
- (char)_shouldActionUpdateObserversForDeletedObjectIDs:(id)a0;
