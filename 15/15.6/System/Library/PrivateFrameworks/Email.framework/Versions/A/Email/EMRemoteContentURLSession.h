...
- (id)dataTaskWithRequest:(id)a0 isSynthetic:(char)a1 allowProxying:(char)a2 failOpen:(char)a3 completionHandler:(id /* block */)a4;
- (void)invalidateAndCancel:(char)a0;
- (void)_createURLSession;
- (id)dataTaskWithRequest:(id)a0 isSynthetic:(char)a1 completionHandler:(id /* block */)a2;
