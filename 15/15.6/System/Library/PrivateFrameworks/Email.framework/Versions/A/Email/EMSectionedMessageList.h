...
@property (readonly, nonatomic) char isThreaded;
...
- (void)_collection:(id)a0 addedItemIDs:(id)a1 toThreadWithItemID:(id)a2 before:(char)a3 existingItemID:(id)a4 notifyObserverBlock:(id /* block */)a5;
- (void)_collection:(id)a0 addedItemIDs:(id)a1 toThreadWithItemID:(id)a2 before:(char)a3 existingItemID:(id)a4 unreadItemIDs:(id)a5;
- (void)_collection:(id)a0 movedItemIDs:(id)a1 before:(char)a2 existingItemID:(id)a3;
...
- (id)filteredMessageListWithPredicate:(id)a0 userFiltered:(char)a1;
...
- (id)messageListItemForItemID:(id)a0 ifAvailable:(char)a1;
- (id)messageListItemsForItemIDs:(id)a0;
- (id)messageListItemsForItemIDs:(id)a0 ifAvailable:(char)a1;
- (id)objectIDForItemID:(id)a0;
- (char)recentlyCollapsedThreadContainsItemID:(id)a0;
