...
@property (class) char cachedMailAppIsInstalled;
...
@property char allowsBackgroundResume;
...
- (id)_initByAdoptingConnection:(id)a0 useNegotiatedConnection:(char)a1 configureBlockedSenderManager:(char)a2;
- (void)checkInMailAppEndpoint:(id)a0;
- (id)connectionForProtocol:(id)a0;
- (void)handleDaemonAvailability;
- (id)initAndConfigureBlockedSenderManager:(char)a0;
- (void)launchDaemon;
