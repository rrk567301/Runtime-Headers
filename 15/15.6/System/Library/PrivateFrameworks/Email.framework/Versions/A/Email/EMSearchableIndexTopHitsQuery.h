...
@property (nonatomic) char generateSuggestions;
...
- (id)initWithSearchString:(id)a0 filterQueries:(id)a1 bundleID:(id)a2 keyboardLanguage:(id)a3 updatedSuggestion:(id)a4 generateSuggestions:(char)a5 logDescription:(id)a6 resultLimit:(unsigned long long)a7 suggestionLimit:(unsigned long long)a8 customFlags:(id)a9 feedbackQueryID:(long long)a10;
