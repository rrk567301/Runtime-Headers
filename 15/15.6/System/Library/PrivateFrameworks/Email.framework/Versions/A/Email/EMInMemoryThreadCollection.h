@class EFOrderedDictionary, EMQuery, EFMutableOrderedDictionary, EFLazyCache, NSMutableDictionary, EFLocked, NSObject, NSMutableOrderedSet, EMThreadScope;
...
@property (nonatomic) char limitedCache;
...
- (id)initWithQuery:(id)a0 mailboxTypeResolver:(id)a1 dataSource:(id)a2 delgate:(id)a3 scheduler:(id)a4 logClient:(id)a5 limitedCache:(char)a6;
...
- (void)messagesWereChanged:(id)a0 forKeyPaths:(id)a1 deleted:(char)a2;
...
- (char)removeThreadProxies:(id)a0 forMove:(char)a1;
