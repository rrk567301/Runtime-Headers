...
@property (nonatomic) char includeCachedMetadataJSON;
@property (nonatomic) char requestAllHeaders;
...
+ (id)optionsWithRequestedRepresentationType:(id)a0 networkUsage:(long long)a1 includeSuggestionItems:(char)a2;
