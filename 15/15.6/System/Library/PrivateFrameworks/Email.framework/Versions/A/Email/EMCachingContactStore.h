...
- (char)contactExistsForEmailAddress:(id)a0;
...
- (id)_fetchDisplayNameForEmailAddress:(id)a0 abbreviated:(char)a1;
...
- (id)displayNameForEmailAddress:(id)a0 abbreviated:(char)a1;
