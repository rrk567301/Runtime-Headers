...
- (id)_calculateChangesAfterRemovingMessages:(id)a0 applyingChanges:(id)a1 threadIsEmpty:(char *)a2;
...
- (char)_isSortedByDate:(id)a0;
- (id)_newestDisplayDate;
- (void)_recalculateDisplayMessage;
- (unsigned long long)_totalMessageSize;
- (id)changeMessages:(id)a0 forKeyPaths:(id)a1 threadIsEmpty:(char *)a2;
- (id)removeMessages:(id)a0 threadIsEmpty:(char *)a1;
