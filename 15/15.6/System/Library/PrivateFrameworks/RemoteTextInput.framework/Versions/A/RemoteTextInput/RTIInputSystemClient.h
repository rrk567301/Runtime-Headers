...
@property (readonly, nonatomic, getter=isEnvironmentEnabled) char environmentEnabled;
...
- (void)_beginAllActiveSessionsForServices:(id)a0 force:(char)a1;
- (void)_beginSessionWithID:(id)a0 forServices:(id)a1 force:(char)a2;
- (void)_configureConnection:(id)a0 withMachName:(id)a1;
- (void)_didIntializeConnection:(id)a0 withMachName:(id)a1;
- (void)_endAllActiveSessionsAnimated:(char)a0 completion:(id /* block */)a1;
- (void)_endAllActiveSessionsForServices:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
...
- (void)_modifyTextEditingAllowedForReason:(id)a0 notify:(char)a1 animated:(char)a2 modifyAllowancesBlock:(id /* block */)a3 completion:(id /* block */)a4;
...
- (void)enumerateConnections:(id)a0 force:(char)a1 withBlock:(id /* block */)a2;
- (void)enumerateServices:(id)a0 force:(char)a1 withBlock:(id /* block */)a2;
- (char)hasActiveSessionWithID:(id)a0;
- (void)invalidateConnections;
- (void)notifyServiceOfPause:(char)a0 withReason:(id)a1;
...
- (void)setEnvironmentEnabled:(char)a0 withReason:(id)a1;
