...
+ (char)canUseLastFrameOfAsset:(id)a0 withResources:(id)a1;
...
- (int)generateDistanceDescriptor:(id *)a0 withDescriptorClass:(Class)a1 forAsset:(id)a2 withResources:(id)a3 lastFrame:(char)a4;
