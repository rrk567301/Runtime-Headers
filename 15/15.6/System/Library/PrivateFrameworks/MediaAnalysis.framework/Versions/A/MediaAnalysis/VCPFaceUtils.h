...
+ (char)isBestResourceForFaceProcessing:(id)a0 fromResources:(id)a1;
...
+ (id)resourceForFaceProcessing:(id)a0 allowStreaming:(char)a1;
+ (id)resourceForFaceProcessingWithAsset:(id)a0 allowStreaming:(char)a1;
