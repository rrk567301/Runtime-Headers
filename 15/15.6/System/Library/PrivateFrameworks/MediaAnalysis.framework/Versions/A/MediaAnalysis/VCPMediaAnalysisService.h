...
- (int)requestPersonPromoterStatusWithAdvancedFlag:(char)a0 photoLibraryURL:(id)a1 progressHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
...
- (int)requestUpdateKeyFacesOfPersonsWithLocalIdentifiers:(id)a0 forceUpdate:(char)a1 photoLibraryURL:(id)a2 progessHandler:(id /* block */)a3 completionHandler:(id /* block */)a4;
...
- (int)requestBackgroundAnalysisForAssets:(id)a0 fromPhotoLibraryWithURL:(id)a1 realTime:(char)a2 progessHandler:(id /* block */)a3 completionHandler:(id /* block */)a4;
- (int)requestBackgroundAnalysisForAssets:(id)a0 realTime:(char)a1 progessHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
...
- (char)requestDeferredProcessingTypes:(id)a0 assets:(id)a1 error:(id *)a2;
...
- (int)requestMediaAnalysisDatabaseBackupForPhotoLibraryURL:(id)a0 completionHandler:(id /* block */)a1 options:(id)a2;
