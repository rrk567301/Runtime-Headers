...
- (char)_deleteAllVerifiedPersonsWithError:(id *)a0;
- (void)_finalizeSuggestionsLog;
- (void)_logFaceToSuggestionsLog:(id)a0;
- (void)_openSuggestionsLoggingSession;
- (void)_startAndSyncClusterCacheWithLibrary:(char)a0 reply:(id /* block */)a1;
...
- (void)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)a0 forceUpdate:(char)a1 context:(id)a2 cancelOrExtendTimeoutBlock:(id /* block */)a3 reply:(id /* block */)a4;
