@class MADVITextLookupRequest, NSString, VCPMADServiceImageAsset, NSObject;
@protocol OS_dispatch_queue, MTLDevice, VICancellable;

@interface VCPMADVITextLookupTask : NSObject <VCPMADServiceImageProcessingSubtaskProtocol, VCPMADTaskProtocol> {
