...
- (char)optInStatus:(id)a0 error:(id *)a1;
- (char)optInUserPickedPerson:(id)a0 error:(id *)a1 extendTimeoutBlock:(id /* block */)a2 cancelBlock:(id /* block */)a3;
