...
+ (id)analyzeWithLightweightOption:(char)a0 aspectRatio:(id)a1 computationAccuracy:(unsigned int)a2 forceCPU:(char)a3 sharedModel:(char)a4 flushModel:(char)a5 cancel:(id /* block */)a6;
...
- (id)initWithLightweightOption:(char)a0 aspectRatio:(id)a1 computationAccuracy:(unsigned int)a2 forceCPU:(char)a3 sharedModel:(char)a4 flushModel:(char)a5 cancel:(id /* block */)a6;
- (int)preferredInputFormat:(int *)a0 height:(int *)a1 format:(unsigned int *)a2;
- (int)prepareWithLightweightOption:(char)a0 aspectRatio:(id)a1 forceCPU:(char)a2 sharedModel:(char)a3 flushModel:(char)a4;
- (int)prepareWithLightweightOption:(char)a0 aspectRatio:(id)a1 numLevels:(int)a2 startLevel:(int)a3 cancel:(id /* block */)a4;
- (int)reInitModel;
