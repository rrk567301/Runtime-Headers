...
+ (char)heuristicHeart:(id)a0 andRightHand:(id)a1 rotationInDegrees:(int)a2 relax:(char)a3;
+ (char)heuristicIsIndexMiddleTooClose:(id)a0 rotationInDegrees:(int)a1;
+ (char)heuristicIsThumbOpenWide:(id)a0 rotationInDegrees:(int)a1 isRelaxed:(char)a2;
+ (char)isFistClosedTight:(id)a0 rotationInDegrees:(int)a1 scalingFactor:(float)a2;
+ (char)isFistClosedTightOccluded:(id)a0 rotationInDegrees:(int)a1 scalingFactor:(float)a2 palmScale:(float)a3;
