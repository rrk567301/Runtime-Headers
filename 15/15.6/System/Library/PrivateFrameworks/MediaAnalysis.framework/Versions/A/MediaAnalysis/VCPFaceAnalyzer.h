...
+ (char)_downsampleBeforeFaceProcessing;
+ (char)_faceprintFastMode;
...
- (int)_performAnalysis:(id *)a0 withRequestHandler:(id)a1 quickMode:(char)a2 sourceWidth:(unsigned long long)a3 sourceHeight:(unsigned long long)a4;
...
- (int)_refineAnalysis:(id *)a0 requestHandler:(id)a1 forAsset:(id)a2 resource:(id)a3 isBestResource:(char)a4 orientedWidth:(unsigned long long)a5 orientedHeight:(unsigned long long)a6;
- (int)analyzeAsset:(id)a0 withResource:(id)a1 resourceURL:(id)a2 isBestResource:(char)a3 quickMode:(char)a4 results:(id *)a5;
