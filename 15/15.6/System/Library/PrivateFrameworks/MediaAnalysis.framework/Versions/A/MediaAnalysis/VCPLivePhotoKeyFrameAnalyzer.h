...
- (int)analyzeLivePhotoKeyFrame:(id)a0 irisPhotoOffsetSec:(float)a1 originalIrisPhotoOffsetSec:(float)a2 photoTextureScore:(float)a3 hadFlash:(char)a4 cancel:(id /* block */)a5;
...
- (int)reportLivePhotoKeyFrameAnalysisResults:(char)a0 selectedKeyFrame:(id)a1 originalStillKeyFrame:(id)a2 stillScore:(float)a3 stillFQScore:(float)a4 stillTimestamp:(float)a5 useSemanticOnly:(char)a6 isKeyFrameSuggested:(char)a7;
