...
- (char)cancelAnalysisWithRequestID:(int)a0;
...
- (id)_addEmbeddingToHighlightResults:(id)a0;
- (id)_addFaceIDToHighlightResults:(id)a0 forAsset:(id)a1;
- (id)_addHumanActionIDToHighlightResults:(id)a0;
- (id)_addMetadataToHighlightResults:(id)a0 forAsset:(id)a1;
- (id)_addSceneIDToHighlightResults:(id)a0;
- (id)_analyzeOndemand:(id)a0 forAnalysisTypes:(unsigned long long)a1 withExistingAnalysis:(id)a2 andOptions:(id)a3 storeAnalysis:(char)a4 cancelBlock:(id /* block */)a5;
- (void)_checkDuplicate:(id)a0 withAsset:(id)a1 duplicate:(long long *)a2;
- (id)_databaseForPhotoLibrary:(id)a0;
- (id)_getCaptionFor:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 withCaptions:(id)a1 hasSegment:(char)a2;
...
- (id)_queryDistanceDescriptor:(Class)a0 ofAsset:(id)a1 withExistingAnalysis:(id)a2 andDatabase:(id)a3 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a4 lastFeature:(char)a5 isDegraded:(char *)a6;
...
- (id)curateMovieAssetsForCollection:(id)a0 withAlreadyCuratedAssets:(id)a1 andDesiredCount:(unsigned long long)a2 allowOnDemand:(char)a3;
...
- (int)requestAnalysesForAssets:(id)a0 analysisTypes:(unsigned long long)a1 allowOndemand:(char)a2 progressHandler:(id /* block */)a3 completionHandler:(id /* block */)a4;
...
- (id)requestAnalysisTypes:(unsigned long long)a0 forAssets:(id)a1 allowOndemand:(char)a2 progressHandler:(id /* block */)a3 error:(id *)a4;
...
- (id)requestLivePhotoEffectsForAssets:(id)a0 allowOnDemand:(char)a1 flags:(unsigned long long)a2;
- (id)requestMovieHighlightsForAssets:(id)a0 withOptions:(id)a1;
- (id)requestSearchResultsForAssets:(id)a0 forPhotoLibraryURL:(id)a1 withQueryEmbeddings:(id)a2 matchingScoreOnly:(char)a3 options:(id)a4;
- (id)requestSearchResultsForAssets:(id)a0 forPhotoLibraryURL:(id)a1 withQueryEmbeddings:(id)a2 options:(id)a3;
- (id)searchForQuery:(id)a0 forAssets:(id)a1 withOptions:(id)a2 matchingScoreOnly:(char)a3 isURLAsset:(char)a4 analyses:(id)a5;
