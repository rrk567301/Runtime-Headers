...
- (char)isJunkTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 basedOnResults:(id)a1;
...
- (char)checkCameraZoom:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 cameraMotionResults:(id)a1;
- (int)generateLivePhotoRecommendationForResults:(id)a0 andPrivateResults:(id)a1 usingFaceAction:(char)a2;
- (char)hasMeaningfulSceneSegment:(id)a0 withFpsRate:(float)a1;
