...
- (id)initWithAnalysisTypes:(unsigned long long)a0 withPreferredTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 withFocalLengthInPixels:(float)a2 withAnalysisQueue:(id)a3 withTurbo:(char)a4;
...
- (char)updatePreferredTransform:(const struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a0 properties:(id)a1;
