...
@property char optimizeForDistance;
...
- (int)convertSingleResultToDict:(struct CGPoint { double x0; double x1; }[21])a0 keypointConfidence:(float *)a1 box:(id)a2 handHoldsObjectConfidence:(float)a3 results:(id)a4;
- (long long)getClosestAspectRatio:(id)a0;
- (id)initWithKeypointsOption:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 enableHandDetection:(char)a3 enableANSTHandDetection:(char)a4 enableRejectHandsNearBoundaries:(char)a5 enableHandObject:(char)a6 sourceWidth:(int)a7 sourceHeight:(int)a8 modelName:(id)a9 revision:(int)a10 options:(id)a11;
- (char)keypointsOutsideInset:(struct CGPoint { double x0; double x1; }[21])a0 handRegion:(id)a1;
