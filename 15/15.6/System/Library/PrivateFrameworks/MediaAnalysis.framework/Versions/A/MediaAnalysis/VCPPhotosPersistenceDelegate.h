...
@property (nonatomic) char personBuilderMergeCandidatesDisabled;
...
- (char)_cleanupMergeCandidatesForVerifiedPersons:(id)a0 minimumFaceGroupSize:(unsigned long long)a1 cancelOrExtendTimeoutBlock:(id /* block */)a2 error:(id *)a3;
- (char)_completePersonBuildingWithPersonsToUpdate:(id)a0 facesToRemoveByPerson:(id)a1 facesToAddByPerson:(id)a2 updateFaceGroup:(id)a3 newMergeCandidatePairs:(id)a4 newInvalidMergeCandidatePairs:(id)a5 faceInFaceGroupByCSN:(id)a6 personCache:(id)a7 keyFaceUpdateBlock:(id /* block */)a8 cancelOrExtendTimeoutBlock:(id /* block */)a9 context:(id)a10 error:(id *)a11;
...
- (char)_resetFaceClusterSequenceNumberOfFacesInFetchResult:(id)a0 inPhotoLibrary:(id)a1 cancelOrExtendTimeoutBlock:(id /* block */)a2 error:(id *)a3;
- (char)_ungroupFaceClusterSequenceNumbers:(id)a0 cancelOrExtendTimeoutBlock:(id /* block */)a1 error:(id *)a2;
...
- (char)cleanupGroupedFacesWithClusterSequenceNumberSetToZero:(id /* block */)a0 error:(id *)a1;
- (char)cleanupMergeCandidatesWithMinimumFaceGroupSize:(unsigned long long)a0 cancelOrExtendTimeoutBlock:(id /* block */)a1 error:(id *)a2;
- (char)cleanupUngroupedFacesWithNonZeroClusterSequenceNumbers:(id /* block */)a0 error:(id *)a1;
...
- (char)deleteEmptyGroupsAndReturnError:(id *)a0;
...
- (id)performSocialGroupsIdentifiersWithPersonClusterManager:(id)a0 forPersons:(id)a1 overTheYearsComputation:(char)a2 updateBlock:(id /* block */)a3;
- (char)persistChangesToAlgorithmicFaceGroups:(id)a0 l1ClustersByFaceCSNRepresentingFaceGroup:(id)a1 l0ClustersByFaceCSNRepresentingFaceGroup:(id)a2 faceCSNByLocalIdentifierForNewlyClusteredFaces:(id)a3 faceCSNsOfUnclusteredFaces:(id)a4 localIdentifiersOfUnclusteredFaces:(id)a5 persistenceCompletionBlock:(id /* block */)a6 cancelOrExtendTimeoutBlock:(id /* block */)a7 error:(id *)a8;
- (char)removeAutoAssignedFacesFromVerifiedPersonsAndPrepareForPersonBuilding:(id)a0 cancelOrExtendTimeoutBlock:(id /* block */)a1 error:(id *)a2;
- (char)resetLibraryClustersWithCancelOrExtendTimeoutBlock:(id /* block */)a0 error:(id *)a1;
- (id)unclusteredClusteringEligibleFaceLocalIdentifiers:(id *)a0;
- (char)ungroupFaceClusterSequenceNumbers:(id)a0 batchSizeForUnclusteringFaces:(unsigned long long)a1 cancelOrExtendTimeoutBlock:(id /* block */)a2 error:(id *)a3;
- (char)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)a0 forceUpdate:(char)a1 cancelOrExtendTimeoutBlock:(id /* block */)a2 error:(id *)a3;
