...
+ (id)detector:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 inputConfig:(id)a3 revision:(int)a4;
...
- (int)drawLine:(char *)a0 width:(int)a1 height:(int)a2 stride:(int)a3 point0:(struct CGPoint { double x0; double x1; })a4 point1:(struct CGPoint { double x0; double x1; })a5 drawPoint:(unsigned int)a6;
...
- (id)initWithMaxNumRegions:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 inputConfig:(id)a3 revision:(int)a4;
