...
+ (char)_includeDMF;
+ (char)_includeDO;
+ (char)_includeDocument;
+ (char)_includeIVS;
+ (char)_includeLM;
+ (char)_includeMeme;
+ (char)_includeNSFW;
+ (char)_includePA;
+ (char)_includeRotation;
+ (char)_includeSDG;
+ (char)_includeSE;
+ (char)_includeSO;
+ (char)_includeWP;
+ (char)_isMovieWithMediaType:(long long)a0;
+ (char)_isPanoWithMediaType:(long long)a0 andMediaSubtypes:(unsigned long long)a1;
+ (char)_isSDOFWithMediaType:(long long)a0 andMediaSubtypes:(unsigned long long)a1;
...
- (void)_parsePhotosTaxonomyClassificationObservations:(id)a0 toClassificationResults:(id)a1 andDetectorSceneClassIds:(id)a2 isEntityNet:(char)a3;
...
- (int)_performBlurAnalysis:(id *)a0 withLumaPixelBuffer:(struct __CVBuffer { } *)a1 abnormalDimension:(unsigned long long)a2 isSDOF:(char)a3;
- (int)_performBlurAnalysis:(id *)a0 withPixelBuffer:(struct __CVBuffer { } *)a1 usingAnalyzer:(id)a2;
- (int)_performEmbeddingAnalysis:(id *)a0 withColorPixelBuffer:(struct __CVBuffer { } *)a1;
