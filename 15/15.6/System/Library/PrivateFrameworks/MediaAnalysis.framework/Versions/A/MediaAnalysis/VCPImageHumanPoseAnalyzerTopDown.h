@class VCPANSTHandsBodyDetector, VCPCNNPersonKeypointsDetector, NSMutableArray;
...
- (id)initWithMaxNumRegions:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 inputConfig:(id)a3;
