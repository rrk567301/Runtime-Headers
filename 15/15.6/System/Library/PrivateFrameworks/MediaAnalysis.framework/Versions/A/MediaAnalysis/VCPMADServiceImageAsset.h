@class NSString, NSArray, NSData, CLLocation, NSNumber;

@interface VCPMADServiceImageAsset : NSObject

@property (readonly, nonatomic) char hasValidSceneProcessing;
...
@property (readonly, nonatomic) char hasCachedParseData;
