...
- (void)dealloc;
- (void).cxx_destruct;
- (int)anstDetection:(struct __CVBuffer { } *)a0 rotationInDegrees:(id)a1 detectingFullbody:(char)a2 detectingHands:(char)a3 handsRegions:(id)a4 personRegions:(id)a5 cancel:(id /* block */)a6;
