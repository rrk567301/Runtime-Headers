...
+ (id)applyL2Norm:(id)a0 isFP16:(char)a1;
+ (id)convertFloat32ToFloat16:(id)a0;
+ (id)convertToCSEmbedding:(id)a0 isFP16:(char)a1;
+ (id)sharedModel:(id)a0 identifier:(id)a1 outputNames:(id)a2 inputNames:(id)a3 functionName:(id)a4;
+ (char)useCSULanguageEncoder;

- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (id)textEmbeddingForQuery:(id)a0 useFP16:(char)a1;
