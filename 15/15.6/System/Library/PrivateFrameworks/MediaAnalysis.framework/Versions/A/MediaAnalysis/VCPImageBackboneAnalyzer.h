...
- (id)initWithRequestedAnalyses:(unsigned long long)a0 andRevision:(id)a1 useSharedModel:(char)a2;
- (int)prepareInput:(struct __CVBuffer { } *)a0 withChannels:(int)a1 settling:(char)a2;
