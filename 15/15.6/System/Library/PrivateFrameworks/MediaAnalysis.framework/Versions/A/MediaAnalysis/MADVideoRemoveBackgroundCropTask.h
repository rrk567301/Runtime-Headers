...
- (char)exportFutureSamples:(id)a0 sequenceWriter:(id)a1 progress:(id)a2 error:(id *)a3;
- (char)exportPastSamples:(id)a0 sequenceWriter:(id)a1 progress:(id)a2 error:(id *)a3;
...
- (char)isAnimatedStickerPreferredWithPastSamples:(id)a0 futureSamples:(id)a1;
