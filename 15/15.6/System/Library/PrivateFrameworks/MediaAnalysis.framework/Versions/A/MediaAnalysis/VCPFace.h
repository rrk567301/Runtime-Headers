...
@property struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } torsoBounds;
...
- (unsigned long long)flagsForOrientation:(char)a0 width:(unsigned long long)a1 height:(unsigned long long)a2;
