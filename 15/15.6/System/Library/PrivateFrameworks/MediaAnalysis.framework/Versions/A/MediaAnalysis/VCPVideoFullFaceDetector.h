@class GDVUStreamingGallery, NSArray, NSMutableDictionary, VCPCNNPoseEstimator, NSMutableArray, VCPCNNSmileDetector;
...
- (int)clusterFaces;
- (char)compareFace:(id)a0 withFace:(id)a1;
- (int)detectFaces:(struct __CVBuffer { } *)a0 faces:(id)a1 torsos:(id)a2 frameStats:(id)a3;
- (int)detectTrackFacesInFrame:(struct __CVBuffer { } *)a0 withTimestamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 faces:(id)a2 torsos:(id)a3 frameStats:(id)a4;
- (id)faceRanges;
...
- (id)frameFaceResults;
- (id)initWithTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 withExistingFaceprints:(id)a1;
- (char)locationChange:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 relativeTo:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 landscape:(char)a2;
