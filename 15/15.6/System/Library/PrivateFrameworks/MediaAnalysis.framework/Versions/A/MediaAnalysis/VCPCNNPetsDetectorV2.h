...
+ (id)detector:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 revision:(int)a3;
...
- (id)initWithMaxNumRegions:(int)a0 forceCPU:(char)a1 sharedModel:(char)a2 revision:(int)a3;
