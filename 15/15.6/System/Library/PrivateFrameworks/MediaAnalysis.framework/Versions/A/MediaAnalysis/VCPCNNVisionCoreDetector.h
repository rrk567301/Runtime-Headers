...
- (int)getBodyRegions:(id)a0 fromVisionCorePostProcessingOutput:(id)a1 imageWidth:(int)a2 imageHeight:(int)a3 extendRatio:(float)a4 portrait_mode:(char)a5;
- (int)getHandsRegions:(id)a0 fromVisionCorePostProcessingOutput:(id)a1 imageWidth:(int)a2 imageHeight:(int)a3 extendRatio:(float)a4 portrait_mode:(char)a5;
