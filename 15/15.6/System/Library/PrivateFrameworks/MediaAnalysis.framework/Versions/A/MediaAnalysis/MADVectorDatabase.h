...
- (int)rebuildWithForce:(char)a0 cancelBlock:(id /* block */)a1 extendTimeoutBlock:(id /* block */)a2;
...
- (id)searchWithEmbeddings:(id)a0 localIdentifiers:(id)a1 attributeFilters:(id)a2 limit:(int)a3 fullScan:(char)a4 includePayload:(char)a5 numberOfProbes:(id)a6 batchSize:(id)a7 numConcurrentReaders:(id)a8 error:(id *)a9;
