...
@interface VCPMovieHighlightAnalyzer : NSObject {
    ...
    char _isMaxTrim;
    char _requestBestTrim;
    char _requestFullResult;
...
- (id)adjustHighlightWithContext:(id)a0;
- (int)analyzeMotionStability:(struct array<float, 6UL> { float x0[6]; })a0 motionParamDiff:(struct array<float, 6UL> { float x0[6]; })a1;
- (float)analyzeOverallQuality:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 isSettlingEffect:(char)a1 isAnimatedSticker:(char)a2;
...
- (char)checkCameraZoom:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
...
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })computeQualityTrimFor:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 withKeyFrame:(char)a1;
...
- (id)findBestHighlightSegment:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 targetTrim:(char)a1;
...
- (id)getHighlightAttributes:(id)a0 withHighlightResults:(id)a1;
- (float)highlightScoreForTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 average:(char)a1;
- (id)highlightScoreResults;
- (id)initWithAnalysisType:(unsigned long long)a0 isLivePhoto:(char)a1 photoOffset:(float)a2 hadFlash:(char)a3 hadZoom:(char)a4 settlingHadZoom:(char)a5 isTimelapse:(char)a6 preferredTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a7 asset:(id)a8;
- (id)initWithPostProcessOptions:(id)a0 asset:(id)a1;
- (char)isGoodQuality:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
- (float)junkScoreForTimerange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 lengthScale:(char)a1;
...
- (id)postProcessMovieHighlight:(id)a0 frameSize:(struct CGSize { double x0; double x1; })a1;
...
- (char)updateCropHeatMap:(float *)a0 withResults:(id)a1 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 resultsKey:(id)a3;
