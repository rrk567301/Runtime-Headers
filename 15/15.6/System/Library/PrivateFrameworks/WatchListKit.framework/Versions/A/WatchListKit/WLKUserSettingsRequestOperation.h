...
- (id)_initWithAction:(unsigned long long)a0 userSettings:(id)a1 caller:(id)a2 dsid:(id)a3 isMigration:(char)a4;
...
- (id)initWithAction:(unsigned long long)a0 userSettings:(id)a1 dsid:(id)a2 isMigration:(char)a3;
