...
@property (nonatomic) char isFetchingAllStatusInProgress;
@property (retain, nonatomic) NSMutableDictionary *ongoingUpdateOperations;

+ (id)defaultManager;

- (void).cxx_destruct;
- (char)isEnabledForType:(unsigned long long)a0;
...
- (char)_hasPreviousPreferenceAsDisableAutoPlay;
...
- (void)_performUserSettingsAction:(unsigned long long)a0 settings:(id)a1 dsid:(id)a2 isMigration:(char)a3 completion:(id /* block */)a4;
