...
- (void)requestAuthorizationWithForcedPrompt:(char)a0;
- (id)_cachedDictionary:(char)a0;
...
- (char)_isIgnorableLocationError:(id)a0;
- (char)_isLastKnownLocation:(id)a0 freshForMaxAge:(double)a1 fromNewTimestamp:(double)a2;
- (char)_isLastKnownLocation:(id)a0 significantlyOlderThanNewLocation:(id)a1;
- (char)_isLastKnownLocationFresh:(id)a0;
...
- (char)_shouldLastKnownLocation:(id)a0 beUpdatedTo:(id)a1;
- (long long)_statusForCLAuthorizationStatus:(int)a0;
- (void)_updateLocationIfNeeded;
- (char)isAuthorizationApproved;
- (char)isAuthorizationDenied;
