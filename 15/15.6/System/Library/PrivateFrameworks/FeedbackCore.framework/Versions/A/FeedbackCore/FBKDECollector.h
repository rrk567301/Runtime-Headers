...
@property char loadingBugSession;
@property char alreadyHandledURL;
...
- (char)hasUnmetRequirements;
- (id)initWithRequirements:(id)a0 forDevice:(id)a1 filerForm:(id)a2 extensionsFromURL:(id)a3 listener:(id)a4 shouldGetSessionStatus:(char)a5 shouldCheckDeferredLogs:(char)a6 attachmentDescriptors:(id)a7;
- (id)processAlreadyCollectedGroups:(id)a0 withRequirements:(id)a1;
- (id)processOngoingDECollections:(id)a0 withRequirements:(id)a1 isDeferred:(char)a2;
