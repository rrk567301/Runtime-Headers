...
+ (void)_getSessionForForm:(id)a0 device:(id)a1 isAdoptingSession:(char)a2 shouldGetSessionStatus:(char)a3 completion:(id /* block */)a4;
+ (void)_getSessionWithIdentifier:(id)a0 configuration:(id)a1 dedDevice:(id)a2 getDetails:(char)a3 shouldGetSessionStatus:(char)a4 completion:(id /* block */)a5;
+ (void)_getSessionWithIdentifier:(id)a0 configuration:(id)a1 device:(id)a2 getDetails:(char)a3 shouldGetSessionStatus:(char)a4 completion:(id /* block */)a5;
+ (id)_seedPortal;
+ (id)_seedingHost;
+ (void)_startSessionByFirstPairingWithConfig:(id)a0 device:(id)a1 grouped:(id)a2 identifier:(id)a3 shouldGetDetails:(char)a4 shouldGetSessionStatus:(char)a5 completion:(id /* block */)a6;
...
+ (void)getSessionForForm:(id)a0 device:(id)a1 shouldGetSessionStatus:(char)a2 completion:(id /* block */)a3;
