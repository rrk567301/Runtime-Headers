...
@property (nonatomic, readonly) char hasAttachmentsForUpload;
...
@property (nonatomic) char addedCurrentDeviceNeedsMatcherPredicateEvaluation;
...
+ (char)device:(id)a0 matchesAnyPredicate:(id)a1 fromCollection:(id)a2 formPlatform:(id)a3;
+ (id)filteredMatcherPredicatesForMatchers:(id)a0 ignoredMatcherPredicates:(id)a1;
+ (id)matchersForDevice:(id)a0 withGivenMatchers:(id)a1 canMatchVisibleDevices:(char)a2 fromCollection:(id)a3 formPlatform:(id)a4;
...
- (id)initWithDeviceManager:(id)a0 delegate:(id)a1 filerForm:(id)a2 pendingFileUrls:(id)a3 pendingURLExtensions:(id)a4 draftDeviceIds:(id)a5 attachmentDescriptors:(id)a6 autoGathersDiagnosticExtensions:(char)a7;
...
- (void)attachmentManager:(id)a0 didStartBugSessionsForDevice:(id)a1 success:(char)a2;
...
- (void)finishInitializationWithChosenDevices:(id)a0 matcherPredicates:(id)a1 pendingFileUrls:(id)a2 pendingURLExtensions:(id)a3 shouldGetSessionStatus:(char)a4 shouldCheckForDeferredDiagnostics:(char)a5;
- (id)generateSectionIdentifierGroupsWithDeviceSectionPrefix:(id)a0 deferredDeviceSectionPrefix:(id)a1;
- (id)generateSnapshotIdentifiersTrackingLastDevice:(char)a0;
- (char)hasAnyAttachments;
- (char)hasAttachmentsCollecting;
