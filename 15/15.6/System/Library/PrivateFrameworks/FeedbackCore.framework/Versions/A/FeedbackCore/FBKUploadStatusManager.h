...
@property (nonatomic) char shouldLogProgress;
...
- (void)didFailToGetUploadUpdatesForUploadTask:(id)a0 shouldTryServerUpdates:(char)a1;
...
- (void)pollDEDForSessionsStateOnActiveSession:(id)a0 uploadTask:(id)a1 isCurrentDeviceSession:(char)a2;
- (void)pollDEDForSessionsStateOnActiveSession:(id)a0 uploadTask:(id)a1 isCurrentDeviceSession:(char)a2 totalQueryCount:(unsigned long long)a3 lastState:(long long)a4 lastInfo:(id)a5;
- (void)pollDEDForSessionsStateOnTask:(id)a0 sessions:(id)a1;
- (char)shouldGiveUpOnUploadWithPromises:(id)a0;
- (char)shouldGiveUpOnUploadWithPromises:(id)a0 stalenessDate:(id)a1;
