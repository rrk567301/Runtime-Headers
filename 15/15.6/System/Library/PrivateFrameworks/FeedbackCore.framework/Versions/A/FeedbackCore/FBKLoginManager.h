...
@property char loggedInAsSomeoneElse;
...
- (void)interactiveStartupUsingSystemAccount:(char)a0 completion:(id /* block */)a1;
- (void)logOutIfNeededAndRun:(id /* block */)a0;
- (void)loginAsUnauthenticatedUserWithCompletion:(id /* block */)a0;
- (void)loginWithAppleConnectToken:(id)a0 completion:(id /* block */)a1;
...
- (void)_completeAuthenticationWith:(id)a0 credentialToken:(id)a1 completion:(id /* block */)a2;
- (void)_drainLogOutTaskQueue;
- (void)_drainLoginTaskQueue;
- (char)_errorIncludesNotAParticipant:(id)a0;
- (char)_errorIncludesOutdatedVersion:(id)a0;
- (char)_hasInternalDeviceToken;
...
- (void)autoLoginUsingSystemAccount:(char)a0 completion:(id /* block */)a1;
- (void)autoLoginWithUserID:(id)a0 userName:(id)a1 deviceToken:(id)a2 usesSystemAccount:(char)a3 completion:(id /* block */)a4;
...
- (void)handleInteractiveLoginWithError:(id)a0 success:(char)a1 completion:(id /* block */)a2;
- (id)initWithAPI:(id)a0;
- (void)interactiveStartupUsingAppleConnect:(id /* block */)a0;
