...
@property (nonatomic) char spamDebugLogs;
...
@property char isSubmitting;
@property char useInlineChoices;
...
- (char)answer:(id)a0 isValidForQuestion:(id)a1;
...
- (id)generateSnapshotIdentifiers:(char)a0;
- (id)identifierForVisibleQuestion:(id)a0 hasAttemptedSubmission:(char)a1;
- (id)indexPathForQuestion:(id)a0;
- (id)initWithFBKData:(id)a0;
- (char)isQuestionVisible:(id)a0;
