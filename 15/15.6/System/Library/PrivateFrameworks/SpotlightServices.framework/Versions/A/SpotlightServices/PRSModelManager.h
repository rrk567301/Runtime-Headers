...
@property (nonatomic) char trialEnabled;
...
@property (nonatomic) char disablePolicy;
...
+ (char)loadModelsWithDirectory:(id)a0 intoModelDict:(id)a1;
...
- (void)triggerUpdate;
- (char)loadModels;
- (float *)computeL2ScoresForVectors:(id)a0 secondVector:(id)a1 withServerFeatures:(id)a2 withBundleFeatures:(id)a3 experimentalWeight1:(double)a4 experimentalWeight2:(double)a5 shouldCancel:(char *)a6 clientBundle:(id)a7;
- (float *)computeScoresForFeatures:(id)a0 withBundleFeatures:(id)a1 serverBundleFeatures:(id)a2 usingModelContext:(id)a3 qos:(unsigned int)a4 shouldCancel:(char *)a5 filterBundle:(id)a6;
...
- (char)otherModelsAvailable;
- (double)testL2WithData:(id)a0 experimental:(char)a1;
- (void)updateModelsAccordingToHierarchy;
- (void)updateModelsAccordingToHierarchy:(id)a0 updateEnabled:(char)a1 disablePendingUpdates:(char)a2;
