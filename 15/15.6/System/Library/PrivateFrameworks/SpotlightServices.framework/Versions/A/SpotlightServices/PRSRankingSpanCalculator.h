...
@property (nonatomic) char pathExists;
@property (nonatomic) char n2Exists;
@property (nonatomic) char n3Exists;

+ (char)doesOrderedSpanExistWithArrayOfIndexArrays:(unsigned long long **)a0 arrayOfIndexArraysCounts:(unsigned long long *)a1 arrayOfIndexArraysCount:(unsigned long long)a2 orderedSpan:(long long *)a3 firstTermPosition:(unsigned long long *)a4 queryTermCount:(unsigned long long)a5;
+ (char)doesOrderedSpanExistWithArrayOfIndexArrays:(unsigned long long **)a0 arrayOfIndexArraysCounts:(unsigned long long *)a1 arrayOfIndexArraysCount:(unsigned long long)a2 queryTermCount:(unsigned long long)a3 kTermCount:(unsigned long long)a4;
