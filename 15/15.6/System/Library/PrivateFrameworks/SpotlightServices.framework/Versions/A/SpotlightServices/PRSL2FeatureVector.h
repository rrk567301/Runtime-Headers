...
@property (nonatomic) char displayNameFuzzySpecialInsertion;
@property (nonatomic) char isSiriAction;
@property (nonatomic) char isAppInDock;
@property (readonly, nonatomic) char vipSenderMatchesQuery;
@property (readonly, nonatomic) char senderIsVip;
@property (readonly, nonatomic) char receiverIsVip;
...
- (char)serializeToJSON:(void *)a0 options:(long long)a1;
- (id)_dictionaryRepresentationWithoutDefaultValues:(char)a0;
