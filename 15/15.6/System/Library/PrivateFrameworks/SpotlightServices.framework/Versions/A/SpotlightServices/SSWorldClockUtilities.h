...
+ (void)getFormattedWorldClockResultsFromTimeZoneLocations:(id)a0 shouldEmphasizeTimeZone:(char)a1 completionHandler:(id /* block */)a2;
...
+ (void)parseQueryForWorldClock:(id)a0 forceLoad:(char)a1 completionHandler:(id /* block */)a2;
+ (void)sendResultsForQuery:(id)a0 detectedLocations:(id)a1 shouldEmphasizeTimeZone:(char)a2 completionHandler:(id /* block */)a3;
