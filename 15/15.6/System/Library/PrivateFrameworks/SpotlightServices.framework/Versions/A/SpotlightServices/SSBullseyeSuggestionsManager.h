...
@property (readonly, nonatomic) char enabledSuggestionsOverrides;
@property (readonly, nonatomic) char enabledSuggestionsBlending;
@property (readonly, nonatomic) char enabledFullSuggestionsBlending;
@property (readonly, nonatomic) char enabledAboveFoldResults;
@property (readonly, nonatomic) char ignoreMaxCount;
...
- (id)intentBasedSuggestionBlending:(id)a0 suggestions:(id)a1;
- (void)loadBlendingModelWithPath:(id)a0 forceLoad:(char)a1;
- (void)loadDefaultsWithOptions:(id)a0;
- (id)release2022_blendingByPolicyWithQueryContext:(id)a0 filters:(id)a1 entityFilters:(id)a2 contactFilters:(id)a3 userSuggestion:(id)a4 userWebSuggestion:(id)a5 shortcutSuggestionResults:(id)a6 actionSuggestionResults:(id)a7 contactSuggestionResults:(id)a8 serverSuggestionResults:(id)a9 localSuggestionResults:(id)a10 options:(id)a11;
- (id)release2023_blendingByPolicyWithQueryContext:(id)a0 filters:(id)a1 entityFilters:(id)a2 contactFilters:(id)a3 userSuggestion:(id)a4 userWebSuggestion:(id)a5 actionSuggestionResults:(id)a6 contactSuggestionResults:(id)a7 serverSuggestionResults:(id)a8 localSuggestionResults:(id)a9 options:(id)a10;
- (id)release2023_blendingWithQueryContext:(id)a0 filters:(id)a1 entityFilters:(id)a2 contactFilters:(id)a3 userSuggestion:(id)a4 userWebSuggestion:(id)a5 shortcutSuggestionResults:(id)a6 actionSuggestionResults:(id)a7 contactSuggestionResults:(id)a8 serverSuggestionResults:(id)a9 localSuggestionResults:(id)a10 options:(id)a11;
