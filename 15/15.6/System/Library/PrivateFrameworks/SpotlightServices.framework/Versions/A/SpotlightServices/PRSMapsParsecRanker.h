...
- (id)initWithRankerEnabled:(char)a0 visitCountThreshold:(double)a1 visitCountGivenLocationThreshold:(double)a2 lastVisitDaysThreshold:(double)a3 entityRelevanceThreshold:(double)a4 enableEntityRelevance:(char)a5;
- (char)isResultCandidateForPromotion:(id)a0;
