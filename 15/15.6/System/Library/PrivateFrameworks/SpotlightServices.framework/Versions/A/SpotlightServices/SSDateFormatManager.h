...
+ (id)allFormatters;
+ (char)date:(id)a0 isBetweenDate:(id)a1 andDate:(id)a2;
...
+ (id)dynamicStringFromDate:(id)a0 isCompact:(char)a1;
+ (id)fullDateTimeStringsFromDate:(id)a0;
+ (char)hasRelativeFormatForDate:(id)a0;
+ (id)icalConformingStringFromDate:(id)a0;
+ (char)isDate:(id)a0 withinTimeInterval:(double)a1 includePast:(char)a2;
+ (char)isDateWithinMonthsTime:(id)a0;
+ (char)isDateWithinWeeksTime:(id)a0;
...
+ (id)shortDateTimeStringFromDate:(id)a0 isAllDay:(char)a1;
+ (id)shortDateTimeStringFromDate:(id)a0 isAllDay:(char)a1 showAllDayString:(char)a2;
+ (id)stringFromBirthdayComponents:(id)a0;
+ (id)stringsFromDate:(id)a0 toDate:(id)a1 isAllDay:(char)a2;
