...
- (void).cxx_destruct;
- (void)updateScoresForItems:(id)a0 withSectionBundle:(id)a1 userQuery:(id)a2 queryID:(long long)a3 currentTime:(double)a4 collectL2Signals:(char)a5 keyboardLanguage:(id)a6 onlyEmbeddingResults:(char)a7 isCardSearch:(char)a8 isDocumentSearch:(char)a9;
...
- (void)updatePhotosRankingItemScore:(id)a0 userQuery:(id)a1 currentTime:(double)a2 collectL2Signals:(char)a3 keyboardLanguage:(id)a4 uniqueSessionID:(id)a5 onlyEmbeddingResults:(char)a6 amlInputs:(id)a7 isCardSearch:(char)a8 isDocumentSearch:(char)a9;
