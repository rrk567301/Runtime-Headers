...
+ (char)isServerResult:(id)a0;
+ (char)_demoteParsecForIntent:(id)a0 section:(id)a1 config:(id)a2;
+ (id)_determineIntentAndStrength:(id)a0;
+ (id)_getParsecMapsDetailedIdentifier:(id)a0;
+ (char)_hasMapsPOIResults:(id)a0;
+ (id)_intentForQueryContext:(id)a0 sections:(id)a1 topHitSection:(id)a2;
+ (int)_intentForSection:(id)a0 withTopHit:(char)a1;
+ (char)_isJaJP:(id)a0;
+ (char)_isParsecSection:(id)a0;
...
+ (char)isPhotosRelatedIntent:(int)a0;
