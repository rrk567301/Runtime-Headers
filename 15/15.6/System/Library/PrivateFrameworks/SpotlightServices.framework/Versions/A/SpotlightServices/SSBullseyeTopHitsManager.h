...
- (void).cxx_destruct;
- (id)tagOrFilterHiddenSectionsForClient:(id)a0 isCommittedSearch:(char)a1 maxVisibleSections:(long long)a2 maxTopHitsCount:(int)a3 minThresholdForBigResult:(double)a4 topHitSection:(id *)a5;
- (id)initWithQueryId:(long long)a0 categoryToResultMapping:(id)a1 currentTopHitSection:(id)a2 queryContext:(id)a3 ranker:(id)a4;
- (id)bullseyeSectionForTopHit:(id)a0 initiallyHidden:(char)a1 checkForTopHit:(char)a2 thresholdCounter:(int)a3;
- (id)bullseyeTopHitSection;
- (id)bullseyeTopHitSections:(id)a0 maxTopHitsCount:(int)a1 minThresholdForBigResult:(double)a2 needExceptionForSafariSection:(char)a3;
