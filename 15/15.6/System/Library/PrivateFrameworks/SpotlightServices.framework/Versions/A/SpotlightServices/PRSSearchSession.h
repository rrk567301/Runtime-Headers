...
@property char configuredSession;
...
@property (readonly, nonatomic) char disableAsTypedSuggestion;
...
- (void)setParsecFeedbackAllowed:(char)a0;
...
- (void)getCachedQueries:(id *)a0 results:(id *)a1 webSearch:(char)a2;
