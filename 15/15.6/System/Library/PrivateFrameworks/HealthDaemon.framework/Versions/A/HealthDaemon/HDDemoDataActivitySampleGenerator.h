...
- (char)_isDemoPersonCoolingDown:(id)a0 atTime:(double)a1;
- (char)_isDemoPersonInWorkoutRecovery:(id)a0 atTime:(double)a1;
- (char)_isDemoPersonSedentary:(id)a0 atTime:(double)a1;
- (char)_isDemoPersonWalking:(id)a0 atTime:(double)a1 samplePeriod:(double)a2;
