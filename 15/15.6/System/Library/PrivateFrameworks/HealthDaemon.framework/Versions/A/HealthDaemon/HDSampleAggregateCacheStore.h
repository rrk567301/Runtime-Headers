...
- (char)deleteCachesForIndexes:(id)a0 generationNumber:(long long)a1 error:(id *)a2;
- (char)enumerateForInterval:(id)a0 cachedClass:(Class)a1 anchorAfterDatabaseScan:(long long *)a2 error:(id *)a3 cacheHandler:(id /* block */)a4;
- (char)enumerateForInterval:(id)a0 cachedClass:(Class)a1 anchorAfterDatabaseScan:(long long *)a2 nowDate:(id)a3 calendar:(id)a4 error:(id *)a5 cacheHandler:(id /* block */)a6;
...
- (char)saveCaches:(id)a0 generationNumber:(long long)a1 error:(id *)a2;
