...
@interface HDQueryServer : NSObject <HKQueryServerInterface, HDDataObserver, HDDatabaseProtectedDataObserver, HDAssociationObserver, HDTaskServer> {
    ...
    char _shouldTakeObservationAssertions;
    char _observingData;
    char _isCollectingData;
