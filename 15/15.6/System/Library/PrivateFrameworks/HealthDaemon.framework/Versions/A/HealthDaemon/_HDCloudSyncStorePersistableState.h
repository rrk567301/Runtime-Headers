...
@property (readonly, nonatomic) char hasEncounteredGapInCurrentEpoch;
@property (readonly, nonatomic) int syncProtocolVersion;
@property (readonly, nonatomic) char pendingFullSync;
...
- (id)stateWithGapEncountered:(char)a0;
- (id)stateWithPendingFullSync:(char)a0;
