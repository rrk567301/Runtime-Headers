...
@property (nonatomic) char ignoreEntityClassAdditionalPredicateForEnumeration;
@property (nonatomic) char improveJoinOrderingForStartDateIndexSelection;
...
- (char)enumerateInTransaction:(id)a0 error:(id *)a1 handler:(id /* block */)a2;
- (char)enumerateIncludingDeletedObjects:(char)a0 error:(id *)a1 handler:(id /* block */)a2;
- (char)enumerateSampleTimesIncludingDeletedObjects:(char)a0 error:(id *)a1 handler:(id /* block */)a2;
- (char)enumerateWithError:(id *)a0 handler:(id /* block */)a1;
