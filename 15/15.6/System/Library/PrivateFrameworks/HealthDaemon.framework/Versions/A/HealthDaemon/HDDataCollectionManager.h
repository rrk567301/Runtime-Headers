...
@interface HDDataCollectionManager : NSObject <HDDiagnosticObject, HDProfileReadyObserver, HDAssertionObserver, HDPeriodicActivityDelegate> {
    ...
    char unitTest_hasSetPendingSaveCoalescingInterval;
...
@property (readonly, nonatomic) char hasAccessToFitnessData;
...
- (char)sensorDataArrayReceived:(id)a0 deviceEntity:(id)a1 error:(id *)a2;
