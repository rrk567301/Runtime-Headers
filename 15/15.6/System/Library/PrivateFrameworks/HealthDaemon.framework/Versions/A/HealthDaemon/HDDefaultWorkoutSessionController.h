@class HDWorkoutEventsManager, NSString, _TtC12HealthDaemon13HDSwimTracker, HDWorkoutSessionConfiguration, NSSet, HDBiomeInterface, HDProfile, NSObject, HDSessionAssertionGroup, HKWorkoutActivity;
