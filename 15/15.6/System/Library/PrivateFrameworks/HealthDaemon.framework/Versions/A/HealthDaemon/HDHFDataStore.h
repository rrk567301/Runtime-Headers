...
- (char)_createNewStore:(id *)a0;
- (char)accessStoreWithError:(id *)a0 block:(id /* block */)a1;
- (struct unique_ptr<health::DataStore, std::default_delete<health::DataStore>> { struct __compressed_pair<health::DataStore *, std::default_delete<health::DataStore>> { struct DataStore *x0; } x0; })dataStoreAtURL:(id)a0 filesystem:(const void *)a1 allowCheckpoint:(char)a2 error:(id *)a3;
- (char)deleteHFDAt:(id)a0 error:(id *)a1;
- (long long)deleteSQLiteMigrationArchive:(id *)a0;
- (char)discardStoreWithError:(id *)a0;
- (void)flushForInvalidation:(char)a0;
...
- (char)moveHFDAsideWithoutOverwritingFrom:(id)a0 to:(id)a1 error:(id *)a2;
