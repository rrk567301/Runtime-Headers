...
@interface HDOntologyConceptManager : NSObject <HDHealthDaemonReadyObserver, HDOntologyShardImporterObserver> {
    ...
    char _attributeIdentifierByCodingSystemURNIsReady;
}

@property (copy, nonatomic) id /* block */ unitTesting_didResetAttributeIdentifierMap;
@property (readonly, nonatomic) char unitTesting_attributeIdentifierByCodingSystemURNMapIsReady;
...
+ (char)enumerateConceptsMatchingPredicate:(id)a0 options:(unsigned long long)a1 limit:(unsigned long long)a2 transaction:(id)a3 error:(id *)a4 enumerationHandler:(id /* block */)a5;
+ (char)enumerateConceptsMatchingPredicate:(id)a0 profile:(id)a1 error:(id *)a2 enumerationHandler:(id /* block */)a3;
+ (char)enumerateRelationshipsMatchingPredicate:(id)a0 options:(unsigned long long)a1 transaction:(id)a2 error:(id *)a3 enumerationHandler:(id /* block */)a4;
+ (char)followRelationshipsWithTypes:(id)a0 startingIdentifier:(id)a1 options:(unsigned long long)a2 ontologyTransaction:(id)a3 conceptOut:(id *)a4 deletedRelationshipVersionOut:(long long *)a5 error:(id *)a6;
...
+ (id)predicateForConceptsWithoutAttributeType:(long long)a0 attributeValue:(id)a1;
...
+ (id)predicateMatchingConceptsWithAttributeType:(long long)a0 beingsWithAttributeValue:(id)a1;
