...
+ (char)deleteNonIndexedConceptsWithTransaction:(id)a0 error:(id *)a1;
+ (char)enumerateAdHocConceptWithRawIdentifiers:(id)a0 options:(unsigned long long)a1 profile:(id)a2 error:(id *)a3 enumerationHandler:(id /* block */)a4;
