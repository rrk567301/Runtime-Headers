...
+ (char)_validateEntityWithEnumerator:(id)a0 error:(id *)a1 validationErrorHandler:(id /* block */)a2;
...
+ (void)deleteSamplesWithPredicate:(id)a0 limit:(unsigned long long)a1 generateDeletedObjects:(char)a2 transaction:(id)a3 profile:(id)a4 recursiveDeleteAuthorizationBlock:(id /* block */)a5 completionHandler:(id /* block */)a6;
...
+ (char)validateEntitiesOfTypes:(id)a0 profile:(id)a1 error:(id *)a2 validationErrorHandler:(id /* block */)a3;
