...
@interface HDQuantitySampleSeriesDataEnumerator : NSObject {
    ...
    char _hasFetchedAllData;
    char _hasDeterminedSeriesVersion;
    char _isVersion1;
    char _hasDuration;
    long long _index;
...
- (id).cxx_construct;
- (void)_unitTesting_addToBufferTimestamp:(double)a0 value:(double)a1 duration:(float)a2 isLastDatum:(char)a3;
- (char)enumerateDataToTime:(double)a0 error:(id *)a1 handler:(id /* block */)a2;
...
- (char)primeEnumeratorWithError:(id *)a0;
