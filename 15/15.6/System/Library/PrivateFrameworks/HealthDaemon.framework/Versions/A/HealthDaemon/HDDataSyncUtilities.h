...
+ (char)insertDeletedObjectsFromCodableObjectCollection:(id)a0 syncEntityClass:(Class)a1 syncStore:(id)a2 profile:(id)a3 error:(id *)a4;
+ (char)insertObjectsFromCodableObjectCollection:(id)a0 syncEntityClass:(Class)a1 syncStore:(id)a2 profile:(id)a3 error:(id *)a4;
