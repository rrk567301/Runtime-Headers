...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithMessageIdentifier:(id)a0 creationDate:(id)a1 receivedDate:(id)a2 modificationDate:(id)a3 sendingDeviceName:(id)a4 sendingDeviceInfo:(id)a5 action:(long long)a6 clientIdentifier:(id)a7 categoryIdentifier:(id)a8 expirationDate:(id)a9 criteria:(id)a10 isInvalid:(char)a11;
