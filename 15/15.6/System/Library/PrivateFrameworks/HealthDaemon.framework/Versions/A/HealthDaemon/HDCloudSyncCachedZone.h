...
- (char)deleteRecordID:(id)a0 error:(id *)a1;
- (char)deleteZoneWithError:(id *)a0;
...
- (char)recordsForClass:(Class)a0 epoch:(long long)a1 error:(id *)a2 enumerationHandler:(id /* block */)a3;
- (id)recordsForClass:(Class)a0 error:(id *)a1;
- (id)recordsForClass:(Class)a0 error:(id *)a1 filter:(id /* block */)a2;
- (char)resetZoneServerChangeTokenWithError:(id *)a0;
- (id)serverChangeTokenWithError:(id *)a0;
- (char)setServerChangeToken:(id)a0 fetchComplete:(char)a1 error:(id *)a2;
