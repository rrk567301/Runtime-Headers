...
@property (readonly, nonatomic) char hasLinksData;
...
@property (readonly, nonatomic) char hasOntologyLocalizedEducationContent;
...
@property (readonly, nonatomic) char hasTypeData;
