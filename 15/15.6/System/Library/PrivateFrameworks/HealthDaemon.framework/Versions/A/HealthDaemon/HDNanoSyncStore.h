...
@property (readonly, nonatomic, getter=isRestoreComplete) char restoreComplete;
...
@property (nonatomic) char needsSyncOnUnlock;
@property (readonly, getter=isInvalidated) char invalidated;
@property (readonly, getter=isMaster) char master;
...
@property (readonly, getter=isAltAccount) char altAccount;
...
+ (id)nanoSyncStoreWithProfile:(id)a0 device:(id)a1 delegate:(id)a2 tinkerPaired:(char)a3;
+ (id)orderedSyncEntitiesForProfile:(id)a0 protocolVersion:(int)a1 companion:(char)a2;
...
- (char)resetProvenanceWithError:(id *)a0;
...
- (char)validatePairingUUIDsWithIncomingMessage:(id)a0;
