...
@property (readonly, nonatomic) char canPerformRecentRecordRoll;
...
+ (void)_containerIdentifiersWithEncryptionSupportEnabled:(char)a0 accountManateeEnabled:(char)a1 resultHandler:(id /* block */)a2;
...
- (char)setShareOwnerParticipant:(id)a0 error:(id *)a1;
...
- (char)persistRestoreCompletionDate:(id)a0 error:(id *)a1;
...
- (id)setupSharingToAccountWithIdentityLookupInfo:(id)a0 requireExistingRelationship:(char)a1 requireZoneDeviceMode:(id)a2 completion:(id /* block */)a3;
...
- (void)unitTest_setIsChild:(char)a0;
- (void)unitTest_setSupportsRebase:(char)a0;
