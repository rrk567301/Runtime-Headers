...
- (id)init;
- (void).cxx_destruct;
- (void)syncDidFinishWithSuccess:(char)a0 error:(id)a1;
...
- (char)requiresSyncForChangesFromAnchorRangeMap:(id)a0;
- (void)sendChanges:(id)a0 completion:(id /* block */)a1;
- (char)shouldOverrideCycleTrackingSymptomsForBackwardsCompatibilty;
- (char)syncDidBeginWithProfile:(id)a0 error:(id *)a1;
- (void)syncWillBegin;
- (char)transactionDidEndWithError:(id *)a0;
