...
@interface HDAllowedCountriesDataSourceWithNanoRegistryFallback : NSObject <HDAllowedCountriesDataSource> {
    ...
    char _shouldReturnLocalAvailabilityForNilDeviceRegions;
}
...
- (void).cxx_destruct;
- (id)initWithDaemon:(id)a0 allowedCountriesDataSource:(id)a1 availableRegionsDevicePropertyName:(id)a2 loggingCategory:(id)a3 shouldReturnLocalAvailabilityForNilDeviceRegions:(char)a4;
