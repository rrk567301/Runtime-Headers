...
+ (char)deleteSeriesWithID:(id)a0 deleteSeriesData:(char)a1 insertDeletedObject:(char)a2 profile:(id)a3 transaction:(id)a4 error:(id *)a5;
...
+ (char)replaceObjectID:(id)a0 replacementObjectID:(id)a1 deleteOriginalSeriesData:(char)a2 insertDeletedObject:(char)a3 profile:(id)a4 transaction:(id)a5 error:(id *)a6;
