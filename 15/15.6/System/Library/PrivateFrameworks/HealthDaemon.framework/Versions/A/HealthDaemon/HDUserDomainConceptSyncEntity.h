...
+ (char)enumerateCodableObjectsForPredicate:(id)a0 limit:(long long)a1 orderingTerms:(id)a2 profile:(id)a3 transaction:(id)a4 error:(id *)a5 handler:(id /* block */)a6;
...
+ (char)receiveSyncObjects:(id)a0 version:(struct { int x0; int x1; })a1 syncProvenance:(long long)a2 profile:(id)a3 error:(id *)a4;
...
+ (char)supportsSpeculativeNanoSyncChanges;
