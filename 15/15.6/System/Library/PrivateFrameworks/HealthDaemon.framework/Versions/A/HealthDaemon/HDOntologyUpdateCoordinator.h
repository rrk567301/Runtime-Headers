...
- (char)performOntologyTransactionForWrite:(char)a0 databaseTransaction:(id)a1 error:(id *)a2 transactionHandler:(id /* block */)a3;
...
- (char)updateOntologyWithShardIdentifier:(id)a0 schemaType:(id)a1 schemaVersion:(long long)a2 localShardURL:(id)a3 shardVersion:(long long)a4 error:(id *)a5;
- (void)updateOntologyWithShardIdentifier:(id)a0 schemaType:(id)a1 schemaVersion:(long long)a2 shardURL:(id)a3 shardVersion:(long long)a4 shouldPruneOldShard:(char)a5 reason:(long long)a6 completion:(id /* block */)a7;
