...
@interface HDNotificationInstructionManager : NSObject <HDDatabaseProtectedDataObserver, HDDiagnosticObject, HDProfileReadyObserver> {
    ...
    char _queue_hasInstructionsToInvalidate;
    char _queue_hasEnqueuedMaintenanceWork;
...
- (char)invalidateNotificationInstructionsWithMessageIdentifiers:(id)a0 error:(id *)a1;
- (void)database:(id)a0 protectedDataDidBecomeAvailable:(char)a1;
- (char)enumerateValidNotificationInstructionsForClientIdentifier:(id)a0 action:(long long)a1 error:(id *)a2 enumerationBlock:(id /* block */)a3;
- (id)initWithProfile:(id)a0 unitTest_nowDate:(id)a1 unitTest_didEvaluateIfMaintenanceWorkIsNeeded:(id /* block */)a2;
- (void)insertNotificationInstruction:(id)a0 completion:(id /* block */)a1;
- (char)obliterateNotificationInstructionsWithError:(id *)a0;
