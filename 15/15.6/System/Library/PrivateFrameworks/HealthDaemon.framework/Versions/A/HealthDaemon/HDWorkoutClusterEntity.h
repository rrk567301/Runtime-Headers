...
+ (char)deleteWorkoutClusterWithUUID:(id)a0 profile:(id)a1 error:(id *)a2;
+ (id)entityForClusterUUID:(id)a0 transaction:(id)a1 error:(id *)a2;
+ (id)insertWorkoutCluster:(id)a0 profile:(id)a1 error:(id *)a2;
+ (id)privateSubEntities;
+ (id)uniquedColumns;
+ (char)updateWorkoutClusterWithUUID:(id)a0 relevanceValue:(id)a1 lastWorkoutUUID:(id)a2 bestWorkoutUUID:(id)a3 workoutUUIDsToAssociate:(id)a4 workoutUUIDsToRemove:(id)a5 profile:(id)a6 error:(id *)a7;
+ (char)updateWorkoutClusterWithUUID:(id)a0 routeLabel:(id)a1 profile:(id)a2 error:(id *)a3;
+ (char)updateWorkoutClusterWithUUID:(id)a0 routeSnapshot:(id)a1 profile:(id)a2 error:(id *)a3;
...
- (char)modelPropertiesWithTransaction:(id)a0 error:(id *)a1 handler:(id /* block */)a2;
