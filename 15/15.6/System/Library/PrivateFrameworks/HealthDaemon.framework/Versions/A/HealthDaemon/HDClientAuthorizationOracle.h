...
@interface HDClientAuthorizationOracle : NSObject {
    ...
    char _clientHasPrivateEntitlement;
...
@property (readonly) char clientHasAuthorizationForAllTypes;

- (id)init;
- (void).cxx_destruct;
- (void)invalidate;
- (char)isAuthorizedToReadObject:(id)a0 error:(id *)a1;
...
- (void)enqueueObjectAuthorizationRequestWithContext:(id)a0 sourceEntity:(id)a1 promptIfNeeded:(char)a2 authorizationNeededHandler:(id /* block */)a3 completion:(id /* block */)a4;
...
- (char)hasAuthorizationBypassToReadType:(id)a0;
- (id)initWithSourceBundleIdentifier:(id)a0 entitlements:(id)a1 profile:(id)a2;
- (char)isAuthorizationStatusDeterminedForTypes:(id)a0 error:(id *)a1;
...
- (char)performReadAuthorizationTransactionWithError:(id *)a0 handler:(id /* block */)a1;
