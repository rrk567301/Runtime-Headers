...
- (void).cxx_destruct;
- (struct { double x0; double x1; double x2; BOOL x3; long long x4; })attenuateSample:(struct { double x0; double x1; double x2; BOOL x3; long long x4; })a0;
- (char)delegateLoadingWasSuccessful:(id *)a0;
