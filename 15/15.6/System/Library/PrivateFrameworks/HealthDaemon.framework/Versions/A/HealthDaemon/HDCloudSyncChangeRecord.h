...
@property (readonly, nonatomic) char finalForSequence;
...
+ (char)isChangeRecord:(id)a0 inSequence:(id)a1;
+ (char)isChangeRecordID:(id)a0;
+ (id)nonAssetKeys;
...
- (id)initWithSyncAnchorRangeMap:(id)a0 changeIndex:(long long)a1 changesetAsset:(id)a2 changeSize:(long long)a3 protocolVersion:(int)a4 finalForSequence:(char)a5 sequenceRecordID:(id)a6 record:(id)a7 schemaVersion:(long long)a8;
- (id)initWithSyncAnchorRangeMap:(id)a0 finalForSequence:(char)a1 changesetArchiveFileHandle:(id)a2 sequenceRecord:(id)a3 protocolVersion:(int)a4;
- (id)printDescription;
