...
+ (char)enumerateConcreteIdentitiesWithTransaction:(id)a0 error:(id *)a1 enumerationHandler:(id /* block */)a2;
...
+ (id)uniquedColumns;
+ (id)updateIsChild:(char)a0 concreteIdentity:(id)a1 transaction:(id)a2 error:(id *)a3;
