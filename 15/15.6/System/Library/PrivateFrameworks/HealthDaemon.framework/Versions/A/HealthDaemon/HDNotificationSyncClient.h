...
- (char)markPendingNotificationInstructionsAsProcessed:(id)a0 error:(id *)a1;
...
- (char)sendNewDeviceNotificationWithMessageKind:(long long)a0 error:(id *)a1;
- (char)sendNotificationInstruction:(id)a0 criteria:(id)a1 error:(id *)a2;
