...
@property (readonly, nonatomic) char hasGeneratedObjectCollection;
@property (retain, nonatomic) HDCodableGeneratedObjectCollection *generatedObjectCollection;
@property (readonly, nonatomic) char hasProvenance;
...
- (char)unitTest_isEquivalentToObjectCollection:(id)a0;
