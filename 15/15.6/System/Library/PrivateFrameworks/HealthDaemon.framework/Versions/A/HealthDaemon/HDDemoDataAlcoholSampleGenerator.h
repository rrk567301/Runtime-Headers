...
- (char)generateObjectsForDemoPerson:(id)a0 fromTime:(double)a1 toTime:(double)a2 currentDate:(id)a3 foodSampleGenerator:(id)a4 statisticsSampleGenerator:(id)a5 bodySampleGenerator:(id)a6 objectCollection:(id)a7;
