...
- (char)addJournalEntries:(id)a0 profile:(id)a1 error:(id *)a2;
...
- (char)mergeWithProfile:(id)a0 activity:(id)a1 shouldContinueHandler:(id /* block */)a2;
- (char)mergeWithProfile:(id)a0 shouldContinueHandler:(id /* block */)a1;
- (char)performMergeTransactionWithProfile:(id)a0 transactionContext:(id)a1 error:(id *)a2 block:(id /* block */)a3;
