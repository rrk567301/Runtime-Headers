...
@interface HDWorkoutCondenser : NSObject <HDPeriodicActivityDelegate> {
    ...
    char _onLockWorkoutCondensationInProgress;
...
+ (id)workoutEntitiesRequiringCondensationWithProfile:(id)a0 limit:(long long)a1 allowRecondensation:(char)a2 error:(id *)a3;
...
- (char)condenseWorkout:(id)a0 error:(id *)a1;
