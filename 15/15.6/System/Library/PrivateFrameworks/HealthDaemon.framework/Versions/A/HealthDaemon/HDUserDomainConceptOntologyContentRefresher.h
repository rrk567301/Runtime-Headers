...
+ (char)_determineIfEligibleForRefreshAndPerformRefreshOperationForConcept:(id)a0 profile:(id)a1 ontologyTransaction:(id)a2 outRefreshedUserDomainConcept:(id *)a3 error:(id *)a4;
