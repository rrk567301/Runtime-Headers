...
@property (nonatomic) char doNotCompress;
@property (nonatomic) char queueOnly1;
@property (nonatomic) char forceLocalDelivery;
@property (nonatomic) char nonWaking;

+ (id)activationRequestWithRestore:(id)a0 syncStore:(id)a1 profile:(id)a2;
+ (id)changeRequestWithChangeSet:(id)a0 status:(id)a1 syncStore:(id)a2 profile:(id)a3;
+ (id)requestWithMessageID:(unsigned short)a0 participant:(id)a1;
+ (id)speculativeChangeRequestWithChangeSet:(id)a0 syncStore:(id)a1 profile:(id)a2;
