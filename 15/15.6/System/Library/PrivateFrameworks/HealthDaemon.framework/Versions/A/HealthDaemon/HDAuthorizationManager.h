...
@property (nonatomic) char suppressAuthorizationPrompt;
...
- (id)_builtInSchemas;
- (char)_hasRequiredAuthorizationStatusesForBundleIdentifier:(id)a0 requiredReadTypes:(id)a1 error:(id *)a2;
...
- (id)enqueueObjectAuthorizationRequestForBundleIdentifier:(id)a0 context:(id)a1 promptIfNeeded:(char)a2 authorizationNeededHandler:(id /* block */)a3 completion:(id /* block */)a4;
...
- (long long)objectAuthorizationRecordForSource:(id)a0 objectUUID:(id)a1 resolveAssociations:(char)a2 error:(id *)a3;
