...
- (char)insertAttachmentReferences:(id)a0 attachment:(id)a1 fileHandle:(id)a2 encrypt:(char)a3 error:(id *)a4;
...
- (char)attachmentReferencesForAttachment:(id)a0 error:(id *)a1 enumerationHandler:(id /* block */)a2;
- (char)attachmentReferencesForObjectIdentifier:(id)a0 schemaIdentifier:(id)a1 error:(id *)a2 enumerationHandler:(id /* block */)a3;
- (id)fileHandleForAttachment:(id)a0 error:(id *)a1;
- (char)insertAttachmentReferences:(id)a0 attachment:(id)a1 error:(id *)a2;
- (char)insertAttachmentReferences:(id)a0 attachment:(id)a1 fileData:(id)a2 encrypt:(char)a3 error:(id *)a4;
- (void)profileDidBecomeReady:(id)a0;
- (char)readAuthorizationForObjectIdentifier:(id)a0 schemaIdentifier:(id)a1 client:(id)a2 error:(id *)a3;
- (id)readerForAttachment:(id)a0 error:(id *)a1;
- (char)removeAllReferencesWithAttachmentIdentifier:(id)a0 objectIdentifier:(id)a1 schemaIdentifier:(id)a2 error:(id *)a3;
- (char)removeAttachmentReferences:(id)a0 error:(id *)a1;
- (char)removeAttachmentReferencesWithObjectIdentifier:(id)a0 schemaIdentifier:(id)a1 error:(id *)a2;
- (char)removeAttachmentReferencesWithObjectIdentifier:(id)a0 schemaIdentifier:(id)a1 transaction:(id)a2 error:(id *)a3;
- (char)replaceReferencesWithObjectIdentifier:(id)a0 replacementIdentifier:(id)a1 schemaIdentifier:(id)a2 error:(id *)a3;
...
- (char)writeAuthorizationForObjectIdentifier:(id)a0 schemaIdentifier:(id)a1 client:(id)a2 error:(id *)a3;
