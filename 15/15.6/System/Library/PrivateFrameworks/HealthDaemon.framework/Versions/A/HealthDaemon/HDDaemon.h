...
@property (nonatomic) char shouldEnqueueMaintenanceWork;
...
@property (readonly, nonatomic) char isTerminating;
...
- (id)createApplicationStateMonitorWithBundleIDs:(id)a0 states:(unsigned int)a1 elevatedPriority:(char)a2;
- (id)createRBSProcessStateProvider;
- (id)daemonExtensionWithIdentifier:(id)a0;
- (id)daemonExtensionsConformingToProtocol:(id)a0;
- (void)exitClean:(char)a0 reason:(id)a1;
...
- (void)terminateClean:(char)a0 reason:(id)a1;
