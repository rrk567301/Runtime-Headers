...
@interface HDJournalChapterEnumerator : NSObject {
    ...
    char _hasLoadedPersistedJournalNames;
...
@property (readonly, nonatomic) char hasJournalChapters;
...
@property (readonly, nonatomic, getter=hasMoreJournalChapters) char moreJournalChapters;
...
- (char)loadSortedJournalChaptersWithError:(id *)a0;
