...
+ (char)enumerateRoutePointsForClusterUUID:(id)a0 workoutSelection:(unsigned long long)a1 timestampAnchor:(double)a2 limit:(unsigned long long)a3 profile:(id)a4 error:(id *)a5 dataHandler:(id /* block */)a6;
+ (char)generateSyncObjectsForSession:(id)a0 syncAnchorRange:(struct HDSyncAnchorRange { long long x0; long long x1; })a1 profile:(id)a2 messageHandler:(id)a3 error:(id *)a4;
...
+ (char)pruneRaceRouteClustersWithEligibleEntities:(id)a0 transaction:(id)a1 error:(id *)a2;
...
+ (id)uniquedColumns;
+ (char)unitTest_deleteAllClusterAndBackingDataInTransaction:(id)a0 error:(id *)a1;
