...
- (id)keyValueDomain;
- (char)deleteUserDomainConcepts:(id)a0 error:(id *)a1;
- (char)updateUserDomainConcepts:(id)a0 error:(id *)a1;
...
- (char)deleteUserDomainConcept:(id)a0 error:(id *)a1;
- (char)enumerateUserDomainConceptsWithPredicate:(id)a0 enumerationOptions:(unsigned long long)a1 limit:(long long)a2 orderingTerms:(id)a3 error:(id *)a4 enumerationHandler:(id /* block */)a5;
- (char)enumerateUserDomainConceptsWithPredicate:(id)a0 enumerationOptions:(unsigned long long)a1 limit:(long long)a2 orderingTerms:(id)a3 transaction:(id)a4 error:(id *)a5 enumerationHandler:(id /* block */)a6;
- (char)enumerateUserDomainConceptsWithPredicate:(id)a0 error:(id *)a1 enumerationHandler:(id /* block */)a2;
- (char)enumerateUserDomainConceptsWithPredicate:(id)a0 limit:(long long)a1 orderingTerms:(id)a2 error:(id *)a3 enumerationHandler:(id /* block */)a4;
- (char)modifyUserDomainConcepts:(id)a0 method:(long long)a1 error:(id *)a2;
- (char)modifyUserDomainConcepts:(id)a0 method:(long long)a1 syncProvenance:(long long)a2 syncIdentity:(long long)a3 syncVersion:(struct { int x0; int x1; })a4 error:(id *)a5;
...
- (char)updateUserDomainConcept:(id)a0 error:(id *)a1;
