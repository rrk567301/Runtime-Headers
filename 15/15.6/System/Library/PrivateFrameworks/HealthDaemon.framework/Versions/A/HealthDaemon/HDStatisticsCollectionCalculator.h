...
- (char)addSampleValue:(double)a0 startTime:(double)a1 endTime:(double)a2 sourceID:(long long)a3 error:(id *)a4;
...
- (char)invalidateInterval:(id)a0 error:(id *)a1;
- (char)performAddSampleTransaction:(id /* block */)a0 error:(id *)a1;
- (char)performInitialStatisticsTransaction:(id /* block */)a0 error:(id *)a1;
- (char)queryForInitialStatisticsWithError:(id *)a0;
- (char)setMaskedIntervals:(id)a0 error:(id *)a1;
