...
+ (char)_removeObjectWithPersistentID:(long long)a0 database:(id)a1 error:(id *)a2;
...
+ (void)deleteDataObjects:(id)a0 restrictedSourceEntities:(id)a1 failIfNotFound:(char)a2 profile:(id)a3 recursiveDeleteAuthorizationBlock:(id /* block */)a4 completionHandler:(id /* block */)a5;
+ (id)deleteStatementsForRelatedEntitiesWithTransaction:(id)a0;
+ (id)entityEncoderForProfile:(id)a0 transaction:(id)a1 purpose:(long long)a2 encodingOptions:(id)a3 authorizationFilter:(id /* block */)a4;
+ (id)entityEnumeratorWithProfile:(id)a0;
+ (char)enumerateAssociatedObjectsForIdentifier:(long long)a0 inDatabase:(id)a1 error:(id *)a2 associatedObjectHandler:(id /* block */)a3;
+ (char)generateSyncObjectsForSession:(id)a0 syncEntityClass:(Class)a1 predicate:(id)a2 syncAnchorRange:(struct HDSyncAnchorRange { long long x0; long long x1; })a3 profile:(id)a4 messageHandler:(id)a5 error:(id *)a6;
...
+ (char)journalObjects:(id)a0 insertionContext:(id)a1 profile:(id)a2 error:(id *)a3;
