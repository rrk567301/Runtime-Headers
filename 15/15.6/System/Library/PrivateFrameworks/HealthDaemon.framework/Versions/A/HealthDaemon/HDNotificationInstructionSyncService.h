...
@property (nonatomic) char unitTest_sendOnEmptyDestinationSet;
...
- (char)sendNotificationInstructionMessage:(id)a0 identifier:(id *)a1 error:(id *)a2;
- (void)service:(id)a0 didReceiveMessage:(id)a1 fromDevice:(id)a2 messageContext:(id)a3;
- (void)service:(id)a0 didSendWithSuccess:(char)a1 identifier:(id)a2 error:(id)a3;
