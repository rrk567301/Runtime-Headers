...
@property (readonly, nonatomic) char hasOpenSequence;
...
- (void).cxx_destruct;
- (void)finishProgress;
- (char)addChangeData:(id)a0 changes:(id)a1 sessionIdentifier:(id)a2 outError:(id *)a3;
- (id)initWithChangedSyncEntityCount:(unsigned long long)a0 profile:(id)a1;
- (char)resetInvalidArchiveCreatorWithSessionUUID:(id)a0 error:(id *)a1;
