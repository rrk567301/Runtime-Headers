...
- (void).cxx_destruct;
- (id)initWithState:(struct { double x0; unsigned long long x1; long long x2; char x3; struct { double x0; double x1; double x2; BOOL x3; long long x4; } x4[128]; })a0;
...
- (struct { double x0; unsigned long long x1; long long x2; char x3; struct { double x0; double x1; double x2; BOOL x3; long long x4; } x4[128]; })exportCurrentState;
- (char)fetchFinalOverlapSamplesWithErrorOut:(id *)a0 handler:(id /* block */)a1;
- (char)fetchOverlapProcessSamplesFrom:(struct { double x0; double x1; double x2; BOOL x3; long long x4; })a0 setAnchorTime:(char)a1 errorOut:(id *)a2 handler:(id /* block */)a3;
