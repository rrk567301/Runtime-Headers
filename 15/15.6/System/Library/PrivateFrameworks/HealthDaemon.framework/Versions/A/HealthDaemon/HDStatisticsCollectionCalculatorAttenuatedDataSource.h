...
- (char)_attenuationSamplesWindowContainsSample:(struct { double x0; double x1; double x2; BOOL x3; long long x4; })a0;
- (char)_attenuationSamplesWindowContainsSampleStart:(struct { double x0; double x1; double x2; BOOL x3; long long x4; })a0;
