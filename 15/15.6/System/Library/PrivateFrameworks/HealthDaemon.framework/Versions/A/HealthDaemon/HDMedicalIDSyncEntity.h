...
+ (char)incrementSyncAnchorWithProfile:(id)a0 error:(id *)a1;
...
+ (char)setSyncProvenance:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)supportsSyncStore:(id)a0;
+ (id)syncEntityDependenciesForSyncProtocolVersion:(int)a0;
+ (char)touchSyncAnchorIfNecessaryWithProfile:(id)a0 error:(id *)a1;
