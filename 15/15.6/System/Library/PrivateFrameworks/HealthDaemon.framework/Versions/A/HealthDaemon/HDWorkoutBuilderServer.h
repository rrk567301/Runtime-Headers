...
@interface HDWorkoutBuilderServer : HDStandardTaskServer <HDWorkoutDataAccumulator, HKDataFlowLinkProcessor, HKStateMachineDelegate, HKWorkoutBuilderServerInterface, HDWorkoutDataDestination, HDTaskServerObserver> {
    ...
    char _lock_isAssociatedToSession;
...
+ (char)finishAllDetachedWorkoutBuildersExcludingSessions:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)finishAllWorkoutBuildersForClient:(id)a0 profile:(id)a1 error:(id *)a2;
...
- (void)remote_setShouldCollectEvents:(char)a0;
...
- (char)enumerateQuantitiesOfType:(id)a0 error:(id *)a1 handler:(id /* block */)a2;
- (char)enumerateSamplesOfTypes:(id)a0 error:(id *)a1 handler:(id /* block */)a2;
