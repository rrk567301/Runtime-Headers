...
@property (nonatomic) char canRepromptOnSameBuild;
...
- (void)promptIfRequiredForReason:(id)a0 success:(char)a1 error:(id)a2;
- (char)unitTest_setLastPromptBuild:(id)a0 error:(id *)a1;
- (char)unitTest_setLastPromptDate:(id)a0 error:(id *)a1;
