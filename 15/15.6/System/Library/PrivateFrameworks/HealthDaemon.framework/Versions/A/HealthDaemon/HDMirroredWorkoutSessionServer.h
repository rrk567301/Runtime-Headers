...
- (char)shouldStopPreviousSession;
- (char)endCurrentActivityOnDate:(id)a0 error:(id *)a1;
- (void)syncCurrentActivity:(id)a0 completion:(id /* block */)a1;
- (void)_enqueueClientUpdate:(id /* block */)a0 launchClient:(char)a1 waitForClientSetup:(char)a2;
...
- (char)_queue_clientApplicationCanStartWorkoutSessionWithError:(id *)a0;
- (void)_schedulePeriodicRuntime;
- (void)_setupProcessStateManagerObserver;
- (char)beginNewActivityWithConfiguration:(id)a0 date:(id)a1 metadata:(id)a2 error:(id *)a3;
...
- (char)setTargetState:(long long)a0 date:(id)a1 error:(id *)a2;
