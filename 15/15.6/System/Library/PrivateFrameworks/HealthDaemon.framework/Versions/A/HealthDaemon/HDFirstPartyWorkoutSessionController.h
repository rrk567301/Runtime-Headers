...
+ (char)supportsWorkoutConfiguration:(id)a0 clientApplicationIdentifier:(id)a1;
...
- (char)enableAutomaticDetectionForActivityConfigurations:(id)a0;
...
- (char)startActivityWithDate:(id)a0 error:(id *)a1;
- (char)stopActivityWithDate:(id)a0 error:(id *)a1;
- (char)storeSessionControllerState:(id)a0 forRecoveryIdentifier:(id)a1 error:(id *)a2;
