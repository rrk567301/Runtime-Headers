...
- (void)submitHeartBeatFailuresWithCoordinator:(id)a0 numOfHeartbeatFailures:(long long)a1 workoutDuration:(double)a2 isFirstParty:(char)a3;
- (void)submitMirroringMetricsWithCoordinator:(id)a0 isFirstParty:(char)a1;
