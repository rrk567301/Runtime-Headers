...
@property (nonatomic) char insertDeletedObjects;
@property (nonatomic) char preserveExactStartAndEndDates;
@property (nonatomic) char callWillDeleteWithProfileTransaction;
...
- (void).cxx_destruct;
- (void)finish;
- (struct _HDObjectDeletionInfo { char x0; long long x1; long long x2; long long x3; })deleteInfoForObjectWithUUID:(id)a0 error:(id *)a1;
- (char)deleteObjectWithPersistentID:(long long)a0 entityClass:(Class)a1 error:(id *)a2;
- (char)deleteObjectWithPersistentID:(long long)a0 objectUUID:(id)a1 entityClass:(Class)a2 objectType:(id)a3 provenanceIdentifier:(id)a4 deletionDate:(id)a5 deletedSampleIntervals:(id)a6 error:(id *)a7;
