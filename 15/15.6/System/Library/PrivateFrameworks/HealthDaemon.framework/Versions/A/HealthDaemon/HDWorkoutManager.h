...
@interface HDWorkoutManager : NSObject <HDDevicePowerObserver, HDDiagnosticObject, HDProfileReadyObserver, HDWorkoutDataAccumulatorObserver, HDWorkoutSessionObserver> {
    ...
    char _hasPerformedPostLaunchSessionRecovery;
...
@property (readonly, nonatomic) char isInHeartRateRecovery;
...
- (char)allowBackgroundStartForApplicationIdentifier:(id)a0;
- (char)currentActivityRequiresExtendedMode;
- (id)currentWorkoutClient;
- (id)currentWorkoutConfiguration;
- (id)currentWorkoutSessionServer;
- (void)devicePowerMonitor:(id)a0 primaryPowerSourceIsCharging:(char)a1;
- (void)endHeartRateRecovery;
- (char)finishAllWorkoutsForClient:(id)a0 error:(id *)a1;
