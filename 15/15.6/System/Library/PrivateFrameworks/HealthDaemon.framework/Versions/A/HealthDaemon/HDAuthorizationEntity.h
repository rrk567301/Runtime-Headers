...
+ (char)resetAllAuthorizationStatusesWithProfile:(id)a0 error:(id *)a1;
+ (char)resetAuthorizationStatusesForBundleIdentifier:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)setAuthorizationStatuses:(id)a0 authorizationRequests:(id)a1 authorizationModes:(id)a2 sourceEntity:(id)a3 options:(unsigned long long)a4 profile:(id)a5 error:(id *)a6;
+ (char)setAuthorizationStatuses:(id)a0 sourceEntity:(id)a1 profile:(id)a2 error:(id *)a3;
+ (id)uniquedColumns;
