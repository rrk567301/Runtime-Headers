...
@interface HDWorkoutSessionServer : NSObject <HKDataFlowLinkProcessor, HKStateMachineDelegate, HDWorkoutSessionStateController, HDWorkoutDataSource> {
    ...
    char _sendHeartBeatFailureAnalytics;
}
...
@property (readonly, nonatomic) char isGymKit;
...
@property (nonatomic) char clientDidSetupSession;
...
@property (readonly, nonatomic) char isMirroring;
...
+ (char)finishAllWorkoutSessionsForClient:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)finishAllWorkoutsExcludingSessions:(id)a0 profile:(id)a1 error:(id *)a2;
...
- (char)enableAutomaticDetectionForActivityConfigurations:(id)a0 error:(id *)a1;
...
- (char)unitTest_updateLatestActivityDate:(id)a0;
