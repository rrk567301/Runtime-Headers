...
+ (id)contributorEntityWithUUID:(id)a0 profile:(id)a1 includeDeleted:(char)a2 error:(id *)a3;
+ (id)contributorForReference:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)deleteContributorWithUUID:(id)a0 profile:(id)a1 error:(id *)a2;
...
+ (id)insertWithUUID:(id)a0 appleID:(id)a1 callerID:(id)a2 primaryUser:(char)a3 profile:(id)a4 error:(id *)a5;
+ (id)insertWithUUID:(id)a0 appleID:(id)a1 callerID:(id)a2 primaryUser:(char)a3 syncProvenance:(long long)a4 syncIdentity:(long long)a5 transaction:(id)a6 error:(id *)a7;
...
- (char)deletedInProfile:(id)a0 error:(id *)a1;
- (id)modificationDateInProfile:(id)a0 error:(id *)a1;
- (id)syncAnchorInProfile:(id)a0 error:(id *)a1;
- (char)updateAppleID:(id)a0 profile:(id)a1 error:(id *)a2;
- (char)updateCallerID:(id)a0 profile:(id)a1 error:(id *)a2;
