...
@interface HDProfile : NSObject <HKAnalyticsHealthDataSource, HKFeatureAvailabilityHealthDataSource, HDCloudSyncRepositoryProfile, HDHealthDaemonReadyObserver> {
    ...
    char _hasNotifiedProfileInitializedObservers;
    char _hasNotifiedProfileReadyObservers;
...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) char testModeEnabled;
...
@property (readonly, nonatomic) char hasNotifiedProfileReadyObservers;
...
- (char)fetchDisplayFirstName:(id *)a0 lastName:(id *)a1 error:(id *)a2;
...
- (char)setDisplayFirstName:(id)a0 lastName:(id)a1 error:(id *)a2;
- (char)setDisplayImageData:(id)a0 error:(id *)a1;
- (char)setPairedGuardianParticipant:(id)a0 error:(id *)a1;
- (char)setPairedGuardianUserInfo:(id)a0 error:(id *)a1;
