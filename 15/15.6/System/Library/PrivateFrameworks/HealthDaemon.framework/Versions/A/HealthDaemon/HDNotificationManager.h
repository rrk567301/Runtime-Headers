...
@property (readonly, nonatomic) char areHealthNotificationsAuthorized;
@property (readonly, nonatomic) char areHealthCriticalAlertsAuthorized;
...
- (char)incrementBadgeForDomain:(long long)a0 count:(long long)a1 error:(id *)a2;
