...
+ (char)resetAllObjectAuthorizationRecordsForProfile:(id)a0 error:(id *)a1;
+ (char)resetAuthorizationForObjects:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)resetObjectAuthorizationRecordsForSource:(id)a0 profile:(id)a1 error:(id *)a2;
+ (char)setObjectAuthorizationRecords:(id)a0 syncProvenance:(long long)a1 syncIdentity:(long long)a2 profile:(id)a3 error:(id *)a4;
+ (id)uniquedColumns;
