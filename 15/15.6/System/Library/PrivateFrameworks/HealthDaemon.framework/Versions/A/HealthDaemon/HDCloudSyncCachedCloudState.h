...
- (char)addDatabaseWithContainerIdentifier:(id)a0 databaseScope:(long long)a1 error:(id *)a2;
- (char)addZoneWithIdentifier:(id)a0 error:(id *)a1;
- (id)attachmentZoneForContainerID:(id)a0 error:(id *)a1;
- (id)contextSyncZoneForContainerID:(id)a0 error:(id *)a1;
- (id)initWithRepository:(id)a0 accessibilityAssertion:(id)a1;
- (id)privateMetadataZoneForContainerID:(id)a0 error:(id *)a1;
- (char)resetServerChangeTokenForContainerIdentifier:(id)a0 databaseScope:(long long)a1 error:(id *)a2;
- (id)serverChangeTokenForContainerIdentifier:(id)a0 databaseScope:(long long)a1 error:(id *)a2;
- (char)setServerChangeToken:(id)a0 containerIdentifier:(id)a1 databaseScope:(long long)a2 error:(id *)a3;
- (id)unifiedSyncZoneForContainerID:(id)a0 error:(id *)a1;
- (char)unitTest_deleteDatabaseWithContainerIdentifier:(id)a0 databaseScope:(long long)a1 error:(id *)a2;
...
- (id)zonesByIdentifierForContainers:(id)a0 error:(id *)a1 filter:(id /* block */)a2;
