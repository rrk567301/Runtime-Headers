...
- (char)_isActiveParticipant:(id)a0;
- (id)_removeInvalidSharesOperationWithError:(id *)a0;
- (char)_updateOwnerParticipantForParticipantRecord:(id)a0 zone:(id)a1 error:(id *)a2;
- (char)_updateShareForAllNonOwnerParticipantsInZone:(id)a0 error:(id *)a1;
- (char)_validateCloudStateForParticipantRecord:(id)a0 error:(id *)a1;
- (char)_validateParticipantRecordCloudStateWithError:(id *)a0;
