...
- (void).cxx_destruct;
- (void)invalidate;
- (id)createQueryServerEndpointForIdentifier:(id)a0 queryUUID:(id)a1 configuration:(id)a2 forceReactivation:(char)a3 error:(id *)a4;
...
- (void)queryServer:(id)a0 requestsAuthorizationWithContext:(id)a1 promptIfNeeded:(char)a2 completion:(id /* block */)a3;
