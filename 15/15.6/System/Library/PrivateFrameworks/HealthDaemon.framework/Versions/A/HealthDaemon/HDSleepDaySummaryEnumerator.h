...
- (id)initWithProfile:(id)a0 cachingSession:(id)a1 gregorianCalendar:(id)a2 morningIndexRange:(struct { long long x0; long long x1; })a3 ascending:(char)a4 options:(unsigned long long)a5 debugIdentifier:(id)a6;
