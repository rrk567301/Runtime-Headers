...
- (id)description;
- (void).cxx_destruct;
- (void)abandonUnsentChangesForError:(id)a0;
...
- (char)sendCodableChange:(id)a0 resultAnchor:(long long)a1 sequence:(long long)a2 done:(char)a3 error:(id *)a4;
- (char)sendCodableChange:(id)a0 version:(struct { int x0; int x1; })a1 resultAnchor:(long long)a2 sequence:(long long)a3 done:(char)a4 error:(id *)a5;
