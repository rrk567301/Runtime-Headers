...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)_couldSampleEverResolveToDeterminateValue:(struct HDRawQuantitySample { double x0; double x1; double x2; long long x3; BOOL x4; BOOL x5; })a0;
- (id)_predicateForSamplesStartingWithinDateInterval:(id)a0 sourceID:(long long)a1 isIntervalStartDateInclusive:(char)a2;
- (char)_primeBaselineCalculatorWithPriorSamplesForSample:(struct HDRawQuantitySample { double x0; double x1; double x2; long long x3; BOOL x4; BOOL x5; })a0 baselineCompatibilityID:(id)a1 error:(id *)a2;
- (char)_shouldContinueWithError:(id *)a0;
- (char)_supplementCalculatorWithSubsequentSamplesForSample:(struct HDRawQuantitySample { double x0; double x1; double x2; long long x3; BOOL x4; BOOL x5; })a0 baselineCompatibilityID:(id)a1 error:(id *)a2;
