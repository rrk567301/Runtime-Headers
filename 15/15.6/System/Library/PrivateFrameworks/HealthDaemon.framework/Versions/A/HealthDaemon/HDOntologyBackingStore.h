...
- (char)obliterateWithReason:(id)a0 error:(id *)a1;
- (char)performOntologyTransactionForWrite:(char)a0 profile:(id)a1 databaseTransaction:(id)a2 error:(id *)a3 transactionHandler:(id /* block */)a4;
