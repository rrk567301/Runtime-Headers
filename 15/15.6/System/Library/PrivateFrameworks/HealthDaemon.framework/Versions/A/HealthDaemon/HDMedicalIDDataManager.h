...
- (char)deleteMedicalIDDataWithError:(id *)a0;
...
- (char)obliterateMedicalIDDataWithReason:(id)a0 error:(id *)a1;
...
- (char)unitTest_persistMedicalIDData:(id)a0;
- (char)updateMedicalIDWithLocalData:(id)a0 error:(id *)a1;
- (char)updateMedicalIDWithSyncedData:(id)a0 provenance:(id)a1 error:(id *)a2;
