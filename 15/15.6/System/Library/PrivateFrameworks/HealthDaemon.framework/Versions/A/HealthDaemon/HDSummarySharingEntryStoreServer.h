...
- (void)remote_beginObservingReachabilityStatusForIdentifiers:(id)a0 isInitialQuery:(char)a1;
...
- (void)remote_updateAuthorizationIdentifiersForInvitationUUID:(id)a0 sharingAuthorizationsToAdd:(id)a1 sharingAuthorizationsToDelete:(id)a2 deleteOnCommit:(char)a3 completion:(id /* block */)a4;
