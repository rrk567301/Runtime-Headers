...
- (char)scheduleEventIfRequiredForDateComponents:(id)a0 eventIdentifier:(id)a1 error:(id *)a2;
- (void)_queue_clearDueEvents:(id)a0;
- (char)_unitTest_didReceiveDueEvents:(id)a0;
- (char)_unitTest_scheduleTransparencyAlertIfRequiredForBirthdate:(id)a0 error:(id *)a1;
...
- (char)removeAllEventsWithError:(id *)a0;
