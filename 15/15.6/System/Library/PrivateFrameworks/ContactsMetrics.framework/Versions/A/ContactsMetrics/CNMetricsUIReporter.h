...
- (void)logSearchResultsFetchedforApplication:(id)a0 fromSuggestions:(char)a1;
- (void)logSearchResultsSelectedforApplication:(id)a0 fromSuggestions:(char)a1;
- (void)logSearchUsageforApplication:(id)a0;
- (id)eventKeyPrefix;
- (void)logSearchActionWithDictionary:(id)a0;
- (void)logUnknownContactGeminiViewDifferentChannelSelected:(char)a0;
