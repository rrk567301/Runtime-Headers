...
@property (nonatomic, getter=hasOutstandingProbe) char outstandingProbe;
@property (readonly, nonatomic, getter=hasOutstandingRequest) char outstandingRequest;
@property (nonatomic, getter=hasPendingPing) char pendingPing;
