...
@property (nonatomic) char handlersRegistered;
...
- (char)_isActiveState:(long long)a0;
...
- (id)_electionInfoByDiffingCurrentElectionInfo:(id)a0;
...
- (void)_updateKnownDiscovery:(id)a0;
