...
@property (nonatomic) char presenceAsserted;
...
- (void)_informObserver:(id)a0 aboutRecord:(id)a1 added:(char)a2;
- (void)_informObserversAboutDevice:(id)a0 added:(char)a1;
- (id)_recordForDevice:(id)a0;
- (void)_retrainSubscriptionWithRetryCounter:(unsigned long long)a0;
- (void)_synchronizeInitiate;
- (void)_synchronizePresence:(char)a0;
