@class NSString, NSArray, COHomeHubAdapter, NSSet, NSMutableDictionary, NSDictionary, COMTActionDirector, COHomeKitAdapter, MTTimerManager, COTimerReadRequest;
...
- (char)_isTimer:(id)a0 targetingAccessory:(id)a1;
- (char)_isTimer:(id)a0 targetingAccessoryIdentifiers:(id)a1;
...
- (id)_timersForAccessoryIdentifier:(id)a0 allowLocalStorage:(char)a1;
