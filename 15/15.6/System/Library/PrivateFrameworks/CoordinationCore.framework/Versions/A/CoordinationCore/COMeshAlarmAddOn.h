@class NSString, NSArray, COHomeHubAdapter, NSSet, NSMutableDictionary, NSDictionary, COMTActionDirector, NSObject, COHomeKitAdapter, COAlarmReadRequest, MTAlarmManager;
...
@property (readonly, nonatomic) char performsLocalActions;
...
- (id)_alarmsForAccessory:(id)a0 allowLocalStorage:(char)a1 usingLeader:(char)a2 member:(id)a3 client:(id)a4;
- (void)_broadcastMerge:(id)a0 withTruth:(id)a1;
...
- (void)_finishMerge:(id)a0;
- (char)_isAlarm:(id)a0 targetingAccessory:(id)a1;
- (char)_isAlarm:(id)a0 targetingAccessoryIdentifiers:(id)a1;
- (void)_primeMerge:(id)a0 withNodes:(id)a1;
- (void)_processQueuedCommands;
- (void)_reaperFired;
- (void)_reloadIndexWithCompletion:(id /* block */)a0;
...
- (void)interestTracker:(id)a0 setInterests:(id)a1 forMember:(id)a2 callback:(id /* block */)a3;
- (void)interestTrackerTriggerReset:(id)a0;
...
- (void)setInterests:(id)a0 asAccessory:(id)a1 withCallback:(id /* block */)a2;
