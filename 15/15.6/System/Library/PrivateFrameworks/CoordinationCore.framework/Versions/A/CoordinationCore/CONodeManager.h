...
@property (nonatomic) char isInElection;
...
- (void)_informDelegateAboutNodeAddition:(id)a0 oldState:(long long)a1;
- (void)_informDelegateAboutNodeRemoval:(id)a0 oldState:(long long)a1;
...
- (void)_resetBallot;
- (char)_updateBallot:(id)a0;
- (id)activeNodesWithSelfNode:(char)a0;
- (void)backedOffNodeMovedOutOfElection:(id)a0;
- (void)fast_fold_nodeController:(id)a0 didReceiveElectionCmd:(id)a1 withCompletionHandler:(id /* block */)a2;
