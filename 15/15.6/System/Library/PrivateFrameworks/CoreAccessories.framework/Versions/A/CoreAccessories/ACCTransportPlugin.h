...
- (char)connectedThroughAdapter:(id)a0;
...
- (id)createEndpointWithTransportType:(int)a0 andProtocol:(int)a1 andIdentifier:(id)a2 forConnectionWithUUID:(id)a3 publishConnection:(char)a4;
...
- (char)routeOutgoingData:(id)a0 forEndpointWithUUID:(id)a1 connectionUUID:(id)a2;
- (char)sendOutgoingData:(id)a0 forEndpointWithUUID:(id)a1 connectionUUID:(id)a2;
- (char)setAccessoryInfo:(id)a0 forEndpointWithUUID:(id)a1;
- (char)setAuthenticationStatus:(int)a0 andCertificateData:(id)a1 authCTA:(BOOL)a2 forConnectionWithUUID:(id)a3;
...
- (char)setSupervisedTransportsRestricted:(char)a0 forConnectionWithUUID:(id)a1;
- (void)startPlugin;
