...
- (void)destinationSharingStatus:(char)a0 forDestinationUUID:(id)a1 supportedParams:(id)a2 forUUID:(id)a3;
...
- (void)sendGPRMCDataStatus:(char)a0 ValueV:(char)a1 ValueX:(char)a2 forAccessoryUUID:(id)a3;
