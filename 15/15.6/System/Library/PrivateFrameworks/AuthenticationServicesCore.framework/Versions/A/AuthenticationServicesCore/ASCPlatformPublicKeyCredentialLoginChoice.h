...
@property (readonly, nonatomic) char isExternal;
...
- (id)_initAsRegistrationChoice:(char)a0 withName:(id)a1 displayName:(id)a2 customTitle:(id)a3 identifier:(id)a4 userHandle:(id)a5 relyingPartyIdentifier:(id)a6 publicKeyCredentialOperationUUID:(id)a7 externalCredentialProviderName:(id)a8 externalCredentialProviderBundleID:(id)a9 supportedAlgorithms:(id)a10 excludedCredentials:(id)a11 groupID:(id)a12;
