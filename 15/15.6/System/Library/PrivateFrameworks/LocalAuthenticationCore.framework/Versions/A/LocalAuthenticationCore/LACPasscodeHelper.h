...
- (long long)verifyPasscodeUsingAKS:(id)a0 acmContext:(id)a1 userId:(id)a2 policy:(long long)a3 options:(id)a4 bioLockoutRecovery:(char)a5;
...
- (char)_shouldUseODVerifierForUserId:(id)a0 policy:(long long)a1 options:(id)a2;
- (char)_shouldUsePAMVerifierForUserId:(id)a0 policy:(long long)a1 options:(id)a2;
...
- (char)_verifyPasscodeUsingOD:(id)a0 acmContext:(id)a1 userId:(id)a2 options:(id)a3;
