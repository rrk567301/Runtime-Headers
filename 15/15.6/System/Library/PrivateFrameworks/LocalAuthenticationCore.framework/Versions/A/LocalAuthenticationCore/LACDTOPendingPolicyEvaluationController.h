...
@interface LACDTOPendingPolicyEvaluationController : NSObject <LACDarwinNotificationCenterObserver, LACDTONotificationManagerDelegate, LACDTOPendingPolicyEvaluationController, LACDTOPolicyEvaluationControllerObserver, LACDTOEventHandler> {
    ...
    char _shouldPostRestartRatchetPrompt;
...
- (char)_canFinishPendingEvaluationsForRatchetState:(id)a0;
- (void)_cancelPreviousNotificationForPendingEvaluationRecord:(id)a0 scheduledOnly:(char)a1;
...
- (char)_hasPendingEvaluationRecordForRequest:(id)a0;
- (char)_isRatchetRestartRequest:(id)a0;
...
- (char)_shouldPrunePendingEvaluation:(id)a0 uuid:(id)a1;
