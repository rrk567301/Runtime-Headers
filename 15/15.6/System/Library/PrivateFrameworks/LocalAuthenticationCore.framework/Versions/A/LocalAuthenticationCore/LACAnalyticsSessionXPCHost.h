...
- (void).cxx_destruct;
- (char)_checkQueueAndSessionWithAction:(id)a0 replyOnFailure:(id /* block */)a1;
- (void)authenticationAction:(long long)a0 failing:(char)a1 reply:(id /* block */)a2;
...
- (id)initWithSession:(id)a0 contextUUID:(id)a1 connected:(char)a2 workQueue:(id)a3;
