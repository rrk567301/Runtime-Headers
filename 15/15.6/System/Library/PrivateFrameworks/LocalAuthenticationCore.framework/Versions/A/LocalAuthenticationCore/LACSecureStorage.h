...
+ (char)isKeyAvailable:(long long)a0;
+ (Class)classForKey:(long long)a0;
+ (char)isKeyAvailableForDataExchange:(long long)a0;
...
+ (char)checkKey:(long long)a0 supportsOperation:(long long)a1;
+ (char)isKeyAvailable:(long long)a0 operation:(long long)a1;
...
- (char)_checkEntitlementForKey:(long long)a0 operation:(long long)a1 value:(id)a2 connection:(id)a3 failureHandler:(id /* block */)a4;
