...
- (void)_enableFeatureActivatingGracePeriod:(char)a0 completion:(id /* block */)a1;
...
- (void)_setFeatureStrictModeEnabled:(char)a0 context:(id)a1 connection:(id)a2 completion:(id /* block */)a3;
