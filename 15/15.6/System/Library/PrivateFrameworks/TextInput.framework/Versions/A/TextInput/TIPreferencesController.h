...
@property (nonatomic) char ignoreNextSyncNotification;
@property (nonatomic) char isInternalInstall;
@property (nonatomic) char inhibitGlobalNotification;
@property (copy, nonatomic) NSArray *inputModeSelectionSequence;
@property (nonatomic) char predictionEnabled;
@property (nonatomic) char autocorrectionEnabled;
@property (nonatomic) char automaticMinimizationEnabled;
@property (nonatomic) char keyboardShownByTouch;
...
- (void)_configureKey:(id)a0 domain:(id)a1 defaultValue:(id)a2 fallbackKey:(id)a3 isAnalyzed:(char)a4;
- (void)_configureKey:(id)a0 domain:(id)a1 defaultValue:(id)a2 fallbackKey:(id)a3 isAnalyzed:(char)a4 isCloudSetting:(char)a5;
- (void)_configureKey:(id)a0 domain:(id)a1 defaultValue:(id)a2 fallbackKey:(id)a3 isAnalyzed:(char)a4 isCloudSetting:(char)a5 isWatchSync:(char)a6;
- (void)_configureKey:(id)a0 domain:(id)a1 defaultValue:(id)a2 isCloudSetting:(char)a3;
- (void)_configureKey:(id)a0 domain:(id)a1 fallbackKey:(id)a2;
- (void)_configureKey:(id)a0 domain:(id)a1 fallbackKey:(id)a2 isCloudSetting:(char)a3;
...
- (char)isKeyLockedDown:(int)a0;
- (char)isPreferenceKeyLockedDown:(id)a0;
- (void)managedKeyboardSettingDidChange:(id)a0;
- (void)migrateInputModes:(id)a0;
- (char)oneTimeActionCompleted:(id)a0;
...
- (void)setValue:(id)a0 forPreferenceKey:(id)a1 asyncIfManaged:(char)a2;
- (void)setautocorrectionEnabled:(char)a0;
...
- (void)updateEnableProKeyboard:(char)a0;
...
- (void)updateKeyboardIsFloating:(char)a0;
- (void)updateKeyboardIsSplit:(char)a0 locked:(char)a1;
