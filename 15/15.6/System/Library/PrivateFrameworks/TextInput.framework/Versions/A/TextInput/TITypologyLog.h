...
+ (char)isTraceLogFilename:(id)a0;
+ (char)isTypologyLogFilename:(id)a0;
...
- (char)_writeToTraceLogFile:(id)a0 error:(id *)a1;
- (char)_writeToTypologyLogFile:(id)a0 withAccessibilityInfo:(id)a1 includeTraceLogContent:(char)a2 error:(id *)a3;
...
- (char)loggedRecordOfClass:(Class)a0;
...
- (char)writeToTypologyLogFile:(id)a0 andTraceLogFile:(id)a1 withAccessibilityInfo:(id)a2 error:(id *)a3;
