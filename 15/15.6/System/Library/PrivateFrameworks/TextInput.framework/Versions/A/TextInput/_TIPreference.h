...
@property (nonatomic) char isAnalyzed;
@property (nonatomic) char isCloudSetting;
@property (nonatomic) char isWatchSync;
...
+ (id)preferenceWithKey:(id)a0 domain:(id)a1 defaultValue:(id)a2 fallbackKey:(id)a3 isAnalyzed:(char)a4;
