...
@property char userModelRateLimitingDisabled;
...
@property (readonly) char explicitTearDown;
...
- (id)initWithInputMode:(id)a0 userModelDataStore:(id)a1 weeklyMetricKeys:(id)a2 fromDate:(id)a3 explicitTearDown:(char)a4;
- (void)loadSettings;
