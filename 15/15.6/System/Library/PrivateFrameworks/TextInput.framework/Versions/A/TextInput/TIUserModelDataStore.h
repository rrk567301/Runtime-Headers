...
- (char)setDurableValue:(id)a0 forKey:(id)a1 forDate:(id)a2;
- (id)getAllKnownInputModesSinceDate:(id)a0;
- (char)_updateDurableValue:(id)a0 forKey:(id)a1 forDate:(id)a2 withUpdateQuery:(const char *)a3;
- (char)addValue:(id)a0 andSecondaryValue:(id)a1 andRealValue:(id)a2 andProperties:(id)a3 forKey:(id)a4 forInputMode:(id)a5 forDate:(id)a6;
...
- (char)purgeDataForKey:(id)a0 forInputMode:(id)a1 beforeDate:(id)a2;
- (char)purgeDataForKeyPrefix:(id)a0 forInputMode:(id)a1 beforeDate:(id)a2;
- (char)purgeDurableDataForKeyPrefix:(id)a0;
...
- (char)updateDurableValue:(id)a0 forKey:(id)a1 forDate:(id)a2;
