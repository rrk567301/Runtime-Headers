...
@property (readonly, nonatomic) char mostRecentTextEntryIsByMe;
...
+ (char)nameComponentsAreEmpty:(id)a0;
...
- (id)_addEntry:(id)a0;
- (id)senderIdentifier;
- (char)validateForSmartReplyGeneration;
