...
- (char)createFWAssetInfoInternal;
...
- (char)getEarlyBootList:(id)a0;
- (char)getEarlyBootListInternal:(id)a0;
...
- (char)isFWDownloadNeeded:(id)a0;
- (void)readCriticalEarlyBootEntries;
- (char)registerForPendingEarlyBootAccessories;
- (char)registerForPendingEarlyBootAccessoriesInternal;
- (long long)sendFDRData:(unsigned int)a0;
- (char)shouldSkipImage4Download;
