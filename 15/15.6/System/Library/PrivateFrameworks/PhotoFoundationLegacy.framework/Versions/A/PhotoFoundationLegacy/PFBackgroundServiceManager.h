...
+ (char)registerClient:(id)a0 forResource:(id)a1;
...
- (char)client:(id)a0 isRegisteredForResource:(id)a1;
- (char)_registerClient:(id)a0 forResource:(id)a1 isToken:(char)a2;
- (void)_unregisterClient:(id)a0 forResource:(id)a1 isToken:(char)a2;
- (void)addManualWorkContext:(id)a0;
- (void)addedItemsToWorkContext:(id)a0;
...
- (id)resourceContextForResource:(id)a0 create:(char)a1;
- (void)resumeWork:(id)a0;
