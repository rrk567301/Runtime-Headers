...
- (void)distributeBOOL:(char)a0;
- (void)distribute:(id)a0;
- (void)distribute:(id)a0 boolArg:(char)a1;
...
- (void)distribute:(id)a0 objectArg:(id)a1 BOOLArg:(char)a2;
- (void)distribute:(id)a0 objectArg:(id)a1 BOOLArg:(char)a2 BOOLArg:(char)a3;
