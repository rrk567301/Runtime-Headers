...
- (void)continueBlurWithIdentityLayerTransformAfterDelay:(double)a0 animate:(char)a1;
- (void)continueBlurWithIdentityLayerTransformAfterDelay:(double)a0 animate:(char)a1 currentMediaTime:(double)a2;
