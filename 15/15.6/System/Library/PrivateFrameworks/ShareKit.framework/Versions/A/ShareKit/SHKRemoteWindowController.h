...
@property char disableServiceWindowPresentation;
@property char noSourceWindow;
...
- (id)initWithRemoteWindow:(id)a0 hostWindow:(id)a1 remoteViewController:(id)a2 marzipanRemoteViewController:(id)a3 noSourceWindow:(char)a4 disableServiceWindowPresentation:(char)a5 service:(id)a6;
- (void)requestClientWindowFrameWithCompletionBlock:(id /* block */)a0;
- (void)setAnimatesDimAndBlur:(char)a0;
- (void)setHostWindowFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withClientWindowSync:(char)a1 blurAndShadowSync:(char)a2;
...
- (void)startSharingTransitionOutWithSuccess:(char)a0 duration:(double)a1;
