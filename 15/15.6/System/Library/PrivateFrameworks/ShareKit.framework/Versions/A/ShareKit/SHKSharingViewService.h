...
@property char animatesLikeMarkup;
@property char animateMarkupWithoutImageCopy;
@property char disableDragging;
@property char serviceUsesAutoLayout;
...
- (void)_setServiceWindowFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withClientWindowSync:(char)a1 animation:(id /* block */)a2 completion:(id /* block */)a3;
...
- (void)animateClosingOfEditorServiceWithSuccess:(char)a0 finishedBlock:(id /* block */)a1;
- (void)animateClosingWithSuccess:(char)a0 finishedBlock:(id /* block */)a1;
- (id)animatingItemsAndSetHasAtLeastOneFinalImage:(char *)a0;
...
- (void)proceedWithSharingTransitionOutWithSuccess:(char)a0 duration:(double)a1;
...
- (char)viewControllerSupportsAnimation:(id)a0;
