...
@property (readonly, nonatomic) char isCollaborationMode;
...
- (void).cxx_destruct;
- (id)initWithCollaborationMode:(char)a0 collaborationItem:(id)a1 cloudSharingResult:(id)a2 collaborationService:(id)a3;
