...
@property char animatesTransitions;
...
- (void)continueTransitionInWithIdentityLayerTransformAfterDelay:(double)a0 animate:(char)a1;
- (void)continueTransitionInWithIdentityLayerTransformAfterDelay:(double)a0 animate:(char)a1 currentMediaTime:(double)a2;
- (void)ensureGroupLayerInitialized;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 noSourceWindow:(char)a1;
