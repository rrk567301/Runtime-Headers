...
@property char isCollaborationMode;
...
@property char hasActionServices;
@property (retain) NSArray *menuItems;
@property char menuItemsComplete;
@property char usesMetricsAppearance;
...
@property char didSelectService;
@property char didLoadMetadata;
@property char isWaitingForSendCopyLoad;
...
- (id)_itemsForSharingService:(id)a0 collaborative:(char)a1;
- (char)_itemsNeedPromptToMoveFile;
- (char)_itemsSupportsCollaboration;
...
- (id)_placeholderItemsForCollaborative:(char)a0;
...
- (char)_presentAddParticipantsViewController;
- (char)_promptToMoveFileIfNecessaryForService:(id)a0;
...
- (char)_shouldDefaultToCollaboration;
- (char)_shouldUseCollaborationItemsForService:(id)a0;
...
- (void)_updateOptionsForCollaborationItem:(id)a0 skipInitialUpdate:(char)a1;
- (void)_updatePopoverHeaderMetadataIfNecessary;
- (void)_updateRestrictedSharingServices;
- (void)_updateShareSheetServicesForCollaborative:(char)a0;
- (id)_urlItems;
...
- (id)menuItemFromService:(id)a0 includeImage:(char)a1;
...
- (char)peopleSuggestionsSupported;
- (id)pickerMenuItemsForShareExtensions:(id)a0 actionExtensions:(id)a1 menuItemServices:(id *)a2 enforceOnMainQueue:(char)a3;
- (id)pickerServicesForServices:(id)a0 withMask:(unsigned long long)a1 enforceOnMainQueue:(char)a2;
- (id)pickerServicesForServices:(id)a0 withMask:(unsigned long long)a1 forPopover:(char)a2 forCollaborationMode:(char)a3 enforceOnMainQueue:(char)a4;
- (void)queryPickerMenuItemsAndServicesWithCompletion:(id /* block */)a0;
- (void)setupMenuLatencyMeasurement;
- (id)sharingMenuItemsForShareServices:(id)a0 menuItemsServices:(id *)a1 enforceOnMainQueue:(char)a2;
