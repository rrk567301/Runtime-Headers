...
@property char audioIsActive;
@property char headsetIsPlayingAudio;
...
- (id)activeRoute;
- (void)addDefaultAudioDeviceListener:(char)a0;
- (id)buildCallBack:(id)a0 withGroup:(char)a1 withHandler:(id /* block */)a2;
...
- (char)initDefaultAudioDevice:(char)a0;
...
- (char)shouldModelAudioPowerSpeakerTemp;
