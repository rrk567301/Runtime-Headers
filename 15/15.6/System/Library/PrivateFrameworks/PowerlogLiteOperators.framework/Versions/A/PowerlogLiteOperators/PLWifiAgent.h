...
- (char)hasWiFi;
- (void)logEventBackwardWifiProperties:(char)a0;
- (void)logFromWiFiNoAvailableCallback:(id)a0 withAvailability:(char)a1 withWakeParams:(id)a2;
...
- (void)logEventBackwardWifiProperties:(id)a0 withNetworkProperties:(id)a1 shallModelPower:(char)a2;
- (void)logEventBackwardWifiPropertiesMac:(char)a0;
