...
@property (nonatomic) char needsUpdateApps;
@property (nonatomic) int registrationToken;
@property (retain, nonatomic) VSAppSettingsViewModel *mvpdAppSettingsViewModel;
@property (nonatomic) char needsPresentationOfMVPDAppInstallPromptIfAvailable;
...
- (void)presentMVPDAppInstallPromptFromViewController:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
- (void)setNeedsUpdateApps;
- (char)shouldShowMVPDAppInstallPrompt;
- (char)shouldShowMVPDAppInstallPromptFromViewController:(id)a0;
