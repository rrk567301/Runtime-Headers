...
@property (nonatomic) char canRequireSystemTrust;
@property (nonatomic) char shouldAllowRemoteInspection;
...
- (char)appContext:(id)a0 validateDOMDocument:(id)a1 inContext:(id)a2 error:(id *)a3;
