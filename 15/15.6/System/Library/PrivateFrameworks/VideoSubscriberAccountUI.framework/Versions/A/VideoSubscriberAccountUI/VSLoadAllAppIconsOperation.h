...
@property (nonatomic) char shouldPrecomposeIcon;
...
- (id)initWithApps:(id)a0 shouldPrecomposeIcon:(char)a1;
- (id)initWithApps:(id)a0 shouldPrecomposeIcon:(char)a1 preferredSize:(struct CGSize { double x0; double x1; })a2;
