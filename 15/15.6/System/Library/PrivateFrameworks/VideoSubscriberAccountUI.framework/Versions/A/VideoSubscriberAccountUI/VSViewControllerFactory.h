...
- (id)viewControllerForPlaybackActivityReportingFromAppsWithBundleIDs:(id)a0 grantingVouchers:(char)a1 appleAccountName:(id)a2 identityProvider:(id)a3 completionHandler:(id /* block */)a4;
