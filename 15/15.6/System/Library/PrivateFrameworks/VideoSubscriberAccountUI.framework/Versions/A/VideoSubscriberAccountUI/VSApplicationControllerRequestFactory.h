...
+ (id)_authNRequestSAMLStringWithAuthenticationToken:(id)a0 forced:(char)a1 error:(id *)a2;
...
- (id)authenticationApplicationControllerRequestWithAuthenticationToken:(id)a0 forcedAuthentication:(char)a1;
- (id)logoutApplicationControllerRequestWithAuthenticationToken:(id)a0;
- (id)silentAuthenticationApplicationControllerRequest;
- (id)silentAuthenticationApplicationControllerRequestWithAuthenticationToken:(id)a0 forcedAuthentication:(char)a1;
