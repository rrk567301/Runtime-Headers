...
@property (nonatomic) char applicationMustSelfValidate;
@property (nonatomic) char allowUI;
...
- (void)_applicationReadyWithSuccess:(char)a0 javascriptErrorValue:(id)a1;
...
- (void)_notifyDidUpdateLogoViewModel:(id)a0;
...
- (void)appDocumentController:(id)a0 didUpdateLogoViewModel:(id)a1;
