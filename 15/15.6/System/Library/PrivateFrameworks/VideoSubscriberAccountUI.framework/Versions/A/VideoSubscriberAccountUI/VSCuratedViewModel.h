...
@property (nonatomic, getter=isBeginValidationButtonEnabled) char beginValidationButtonEnabled;
...
@property (nonatomic) char showFooter;
@property (copy, nonatomic) NSString *footerText;
@property (retain, nonatomic) NSItemProvider *logoProvider;
@property (retain, nonatomic) UIImage *logo;
@property (nonatomic) struct CGSize { double width; double height; } preferredLogoSize;
@property (nonatomic) char logoFinishedLoading;
