...
@property (nonatomic) char forceDSIDlessInstall;
@property (readonly, copy, nonatomic) NSString *storeName;
@property (retain, nonatomic) VSOptional *voucher;
@property (readonly, nonatomic) char canChangePrivacyAccess;
@property (nonatomic, getter=isAccessGranted) char accessGranted;
@property (readonly, nonatomic) char canRevokeVoucher;
@property (readonly, nonatomic, getter=isDecided) char decided;
