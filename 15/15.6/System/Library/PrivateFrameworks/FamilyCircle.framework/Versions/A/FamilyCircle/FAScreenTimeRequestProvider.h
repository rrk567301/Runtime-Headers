...
- (char)isScreenTimeSetupForDSID:(id)a0;
- (void)updateScreenTimeServerFlagSettingsForDSID:(id)a0 ephemeralAuthResults:(id)a1 enabled:(char)a2 completionHandler:(id /* block */)a3;
