...
@property (readonly, nonatomic) char allInviteesDidRespond;
@property int matching;
@property (retain) NSDictionary *inviteesByUserID;
@property (nonatomic) char serverHosted;
@property (nonatomic) char canPromptTapToRadar;
...
@property (nonatomic) char nearbyDiscoverySetup;
...
@property (nonatomic) char generatingCompatiblityHashes;
...
+ (char)canPlayMultiplayerGameWithPlayers:(id)a0;
...
- (void)handleMatchRequest:(id)a0 forCurrentMatch:(id)a1 hostedCurrentPlayerCount:(long long)a2 serverHosted:(char)a3 rematchID:(id)a4 devicePushToken:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)invitePlayersWithRequest:(id)a0 serverHosted:(char)a1 devicePushTokenMap:(id)a2 completionHandler:(id /* block */)a3;
- (void)invitePlayersWithRequest:(id)a0 serverHosted:(char)a1 onlineConnectionData:(id)a2 devicePushTokenMap:(id)a3 isNearbyInvite:(char)a4 completionHandler:(id /* block */)a5;
- (void)inviteeAccepted:(id)a0 userInfo:(id)a1 allResponded:(char)a2;
...
- (char)isEntitledToUseGroupActivities;
...
- (void)sendMatchmakingRequest:(id)a0 forMatch:(id)a1 rematchID:(id)a2 serverHosted:(char)a3 playerCount:(long long)a4 completionHandler:(id /* block */)a5;
- (void)sendProfileResponseToDevice:(id)a0;
- (void)setNearbyDevice:(id)a0 reachable:(char)a1;
...
- (void)setShareInvitees:(id)a0 forMatch:(id)a1 propagateToDaemon:(char)a2;
- (void)setShareInvitees:(id)a0 propagateToDaemon:(char)a1;
...
- (char)shouldRunGroupActivityWithDescription:(id)a0;
