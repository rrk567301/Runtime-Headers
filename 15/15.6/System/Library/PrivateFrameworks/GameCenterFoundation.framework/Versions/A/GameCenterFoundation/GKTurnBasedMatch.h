...
+ (void)loadMatchesIncludingCompatibleBundleID:(char)a0 withCompletionHandler:(id /* block */)a1;
+ (void)loadMatchesWithCompletionHandler:(id /* block */)a0;
+ (void)loadTurnBasedMatchDetailsForMatchIDs:(id)a0 loadGameData:(char)a1 withCompletionHandler:(id /* block */)a2;
+ (void)loadTurnBasedMatchSummaries:(id /* block */)a0;
+ (void)loadTurnBasedMatchSummariesIncludingCompatibleBundleID:(char)a0 withCompletionHandler:(id /* block */)a1;
