...
@property (readonly, nonatomic) char isInContacts;
...
- (void)loadCommonFriends:(char)a0 asPlayersWithCompletionHandler:(id /* block */)a1;
...
- (void)loadGamesPlayedIncludingInstalledGames:(char)a0 completionHandler:(id /* block */)a1;
- (void)loadProfileDiscardingStaleData:(char)a0 completionHandler:(id /* block */)a1;
