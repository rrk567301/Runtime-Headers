@interface GKMultiplayerActivityReporter : NSObject {
    void /* unknown type, empty encoding */ matchDataDelegate;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithLocalPlayerID:(id)a0 matchDataDelegate:(id)a1 apiReporter:(id)a2;
...
- (void)onInviteSentWithApproach:(unsigned long long)a0 isHosted:(char)a1 recipients:(id)a2 transportContext:(id)a3;
