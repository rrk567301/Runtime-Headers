...
@interface GKFastSyncTransport : NSObject <GKTransportProtocol> {
    ...
    void /* unknown type, empty encoding */ atomicLobbyChannel;
    void /* unknown type, empty encoding */ atomicGameChannel;
    ...
    void /* unknown type, empty encoding */ syncLocalParticipantHandle;
}
...
- (char)connectToGuestPlayer:(id)a0 withHostPlayer:(id)a1;
...
- (void)handleRelayPushData:(id)a0 onlyIfPreemptive:(char)a1;
- (id)initWithClientDelegate:(id)a0 reporter:(id)a1 daemonProxy:(id)a2;
- (void)localConnectionDataWithCompletionHandler:(void (^)(NSData *, NSError *))a0;
- (void)preemptRelay:(id)a0;
- (char)sendScopedData:(id)a0 toPlayers:(id)a1 dataMode:(long long)a2 dataScope:(long long)a3 transportContext:(id)a4 error:(id *)a5;
- (char)sendScopedDataToAll:(id)a0 dataMode:(long long)a1 dataScope:(long long)a2 transportContext:(id)a3 error:(id *)a4;
