...
@protocol GKBulletinService, GKMultiplayerServicePrivate, GKChallengeServicePrivate, GKAccountService, GKFriendServicePrivate, GKTurnBasedServicePrivate, GKGameService, GKMultiplayerService, GKGameStatServicePrivate, GKChallengeService, GKGameStatService, GKFriendService, GKUtilityServicePrivate, GKGameServicePrivate, GKProfileServicePrivate, GKGameKitDirectoryServicePrivate, GKTurnBasedService, GKUtilityService, GKBulletinServicePrivate, GKProfileService, GKAccountServicePrivate;
...
- (char)needsBuildUpServiceLookup;
