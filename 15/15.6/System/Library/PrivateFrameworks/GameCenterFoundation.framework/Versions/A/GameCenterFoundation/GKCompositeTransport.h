...
@protocol GKTransportProtocol, GKTransportClientDelegate, GKMultiplayerDaemonProxy;
...
@property (nonatomic) char hasPromptedTTR;
...
- (oneway void)fileMultiplayerTTRWith:(id)a0;
- (void)handleRelayPushData:(id)a0 onlyIfPreemptive:(char)a1;
- (id)initWithClientDelegate:(id)a0 matchDataDelegate:(id)a1 reporter:(id)a2 transportContext:(id)a3;
