...
@property (nonatomic) char healthMonitorEnabled;
...
@property (nonatomic) char validTransportSelected;
...
- (char)allowEarlyConnection;
- (id)defaultTransportWithForceEnabledTransports:(id)a0 forceDisabledTransports:(id)a1 andHealthMonitorEnabled:(char)a2;
...
- (char)inviteeShouldAwaitInviteUpdate;
...
- (char)shouldDelayConnectionForMatchResponse:(id)a0;
- (char)shouldFilterGuestWhenSendingToAll;
- (char)shouldSendInviteUpdate;
- (id)supportedTransportVersions;
- (char)supportsTransportRequiredInTheInvite:(id)a0;
- (char)supportsTransportVersion:(id)a0;
...
- (void)updateForMatchResponse:(id)a0 serverHosted:(char)a1;
- (void)updateWithForceEnabledTransports:(id)a0 forceDisabledTransports:(id)a1 andHealthMonitorEnabled:(char)a2;
