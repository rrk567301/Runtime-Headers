...
@property (nonatomic) char fastStartStateActive;
@property (nonatomic) char initiallyStarted;
...
@property (nonatomic) char recentlyBecameActive;
...
- (void)connectToPlayers:(id)a0 version:(unsigned char)a1 invitedByLocalPlayer:(char)a2 completionHandler:(id /* block */)a3;
- (id)connectedPlayers;
...
- (id)playerFromID:(id)a0 includingLocal:(char)a1;
- (id)playerIDs;
...
- (void)reportInviteSentWithApproach:(unsigned long long)a0 isHosted:(char)a1 recipients:(id)a2;
- (void)retryLimitHit;
- (void)sendConnectingStateCallbackToDelegate:(id)a0 forPlayers:(id)a1;
- (char)sendData:(id)a0 toPlayers:(id)a1 dataMode:(long long)a2 error:(id *)a3;
- (char)sendData:(id)a0 toPlayers:(id)a1 withDataMode:(long long)a2 error:(id *)a3;
- (char)sendDataToAllPlayers:(id)a0 withDataMode:(long long)a1 error:(id *)a2;
...
- (char)sendPacketDataToAll:(id)a0 packetType:(unsigned char)a1 dataMode:(long long)a2 error:(id *)a3;
...
- (void)withEventQueueForPlayer:(id)a0 createIfNeeded:(char)a1 perform:(id /* block */)a2;
