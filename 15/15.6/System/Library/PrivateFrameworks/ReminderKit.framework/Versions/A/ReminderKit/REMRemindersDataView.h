...
+ (id)remindersFromAccountStorages:(id)a0 listStorages:(id)a1 reminderStorages:(id)a2 store:(id)a3 showMarkedForDeleteObjects:(char)a4;
...
- (id)fetchObjectIDsOfRemindersWithParentReminderID:(id)a0 includeIncomplete:(char)a1 includeCompleted:(char)a2 isUnsupported:(char)a3 error:(id *)a4;
...
- (id)fetchRemindersWithListID:(id)a0 includingSubtasks:(char)a1 error:(id *)a2;
...
- (long long)fetchSubtasksMasksWithParentReminderID:(id)a0 includingConcealed:(char)a1 error:(id *)a2;
