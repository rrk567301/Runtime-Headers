...
@property (readonly, nonatomic) char remindersICSDisplayOrderChanged;
...
@property (readonly, nonatomic) char daIsEventOnlyContainer;
@property (readonly, nonatomic) char daIsReadOnly;
@property (readonly, nonatomic) char daIsImmutable;
@property (readonly, nonatomic) char daIsNotificationsCollection;
...
+ (char)isOwnedByMeWithSharingStatus:(long long)a0;
+ (char)isSharedWithShareeCount:(unsigned long long)a0 sharingStatus:(long long)a1;
