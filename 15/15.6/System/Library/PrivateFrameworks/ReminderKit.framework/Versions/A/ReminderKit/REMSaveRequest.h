...
@property (nonatomic, getter=isSaved) char saved;
...
@property (nonatomic) char updateLastModifiedDates;
@property (nonatomic) char saveIsNoopIfNoChangedKeys;
@property (nonatomic) char cloneCompletedRecurrentRemindersAtSave;
@property (nonatomic) char applyCRDTsWithoutMerging;
@property (nonatomic) char syncToCloudKit;
...
- (char)saveSynchronouslyWithError:(id *)a0;
- (id)updateList:(id)a0;
- (id)addListWithName:(id)a0 toAccountChangeItem:(id)a1;
- (id)addReminderWithTitle:(id)a0 toListChangeItem:(id)a1;
- (void)updateReminderChangeItem:(id)a0 fromICSTodo:(id)a1 icsCalendar:(id)a2 isNew:(char)a3 withOptions:(id)a4;
...
- (void)_populateReminderChangeItem:(id)a0 withICSTodoItem:(id)a1 icsCalendar:(id)a2 isNew:(char)a3 withOptions:(id)a4;
...
- (id)advanceForwardRecurrenceAndCreateCompletedCloneWithoutRecurrenceRulesAndSubtasksAfterDate:(id /* block */)a0;
...
- (void)notifyChangeDelegateForSaveSuccess:(char)a0;
...
- (char)updateReminderChangeItem:(id)a0 fromICSData:(id)a1 isNew:(char)a2 withOptions:(id)a3 error:(id *)a4;
