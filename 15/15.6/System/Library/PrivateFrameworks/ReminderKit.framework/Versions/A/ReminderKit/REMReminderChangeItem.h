...
@property (readonly, nonatomic) char isOverdue;
@property (readonly, nonatomic) char isRecurrent;
...
- (void)addAlarm:(id)a0 updateDisplayDate:(char)a1;
...
- (char)canSetAlternativeDisplayDateDateForCalendar;
- (void)cleanupDuplicate:(id)a0 markAsCompleted:(char)a1;
- (void)clearAlternativeDisplayDateDateForCalendarIfInvalid;
- (void)clearAlternativeDisplayDateDateForCalendarWithReason:(id)a0;
...
- (void)removeAlarm:(id)a0 updateDisplayDate:(char)a1;
...
- (void)setAlarms:(id)a0 updateDisplayDate:(char)a1;
- (void)setAlternativeDisplayDateDateForCalendarToPreviousRecurrentDateBefore:(id)a0 recurrenceRules:(id)a1;
- (void)setAlternativeDisplayDateDateForCalendarWithDateComponents:(id)a0;
- (void)setAlternativeDisplayDateDateForCalendarWithNormalizedDate:(id)a0;
