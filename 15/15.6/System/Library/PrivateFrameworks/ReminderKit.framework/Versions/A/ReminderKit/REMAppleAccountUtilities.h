...
@property (nonatomic) char cachedICloudACAccountsAreValid;
...
- (char)isCurrentPersonaDataSeparated;
- (void)performBlockInPersonaContextForAccountIdentifier:(id)a0 block:(id /* block */)a1;
- (void)saveDidChooseToMigrate:(char)a0 didFinishMigration:(char)a1 toACAccount:(id)a2 inStore:(id)a3 completionHandler:(id /* block */)a4;
