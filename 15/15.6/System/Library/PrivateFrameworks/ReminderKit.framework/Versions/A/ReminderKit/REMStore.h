...
@property (nonatomic) char assertOnMainThreadFetches;
...
+ (char)destroyIsolatedStoreContainerWithToken:(id)a0 error:(id *)a1;
...
- (void)updateAccountWithAccountID:(id)a0 restartDA:(char)a1 completion:(id /* block */)a2;
...
- (void)_enumerateAllListsIncludingGroups:(char)a0 withBlock:(id /* block */)a1;
...
- (char)containsCustomSmartListForTipKitWithError:(id *)a0;
- (char)containsHashtagsForTipKitWithError:(id *)a0;
- (char)containsListWithCustomBadgeForTipKitWithError:(id *)a0;
...
- (char)deleteSharedGroceryList:(id)a0 error:(id *)a1;
...
- (id)fetchAccountsIncludingInactive:(char)a0 error:(id *)a1;
...
- (id)fetchAssignmentsWithObjectIDs:(id)a0 includeConcealedObjects:(char)a1 error:(id *)a2;
...
- (id)fetchHashtagsWithObjectIDs:(id)a0 includeConcealedObjects:(char)a1 error:(id *)a2;
...
- (char)hasActiveCloudKitAccountForTipKitWithError:(id *)a0;
- (id)initUserInteractive:(char)a0;
- (id)initWithDaemonController:(id)a0;
- (id)initWithDaemonController:(id)a0 storeContainerToken:(id)a1;
- (void)notifyOfInteractionWithPeople:(id)a0 force:(char)a1 completion:(id /* block */)a2;
- (void)nukeDatabase;
...
- (void)requestToUpdateClientConnectionsAsynchronously:(char)a0 shouldKeepAlive:(char)a1 completion:(id /* block */)a2;
...
- (char)saveSaveRequest:(id)a0 accountChangeItems:(id)a1 listChangeItems:(id)a2 listSectionChangeItems:(id)a3 smartListChangeItems:(id)a4 smartListSectionChangeItems:(id)a5 templateChangeItems:(id)a6 templateSectionChangeItems:(id)a7 reminderChangeItems:(id)a8 author:(id)a9 replicaManagerProvider:(id)a10 error:(id *)a11;
...
- (char)test_revertImageAttachmentsToUnDeduped:(id)a0 error:(id *)a1;
- (void)test_setupForManualHashtagLabelRefreshing;
- (void)triggerCloudKitOnlySyncWithReason:(id)a0 discretionary:(char)a1 completion:(id /* block */)a2;
- (void)triggerSyncForDataAccessAccountsWithAccountIDs:(id)a0;
- (void)triggerThrottledSyncWithReason:(id)a0 discretionary:(char)a1 completion:(id /* block */)a2;
- (void)updateAccountWithAccountID:(id)a0 completion:(id /* block */)a1;
- (void)updateAccountsAndSync:(char)a0 completion:(id /* block */)a1;
