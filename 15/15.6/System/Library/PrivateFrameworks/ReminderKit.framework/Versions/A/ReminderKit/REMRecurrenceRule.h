...
+ (id)nextRecurrentDueDateAfter:(id)a0 dueDate:(id)a1 timeZone:(id)a2 allDay:(char)a3 recurrenceRules:(id)a4;
+ (id)previousRecurrentDueDateBefore:(id)a0 dueDate:(id)a1 timeZone:(id)a2 allDay:(char)a3 recurrenceRules:(id)a4;
+ (id)recurrenceGeneratorConfiguredForDueDate:(id)a0 timeZone:(id)a1 allDay:(char)a2 recurrenceRule:(id)a3;
