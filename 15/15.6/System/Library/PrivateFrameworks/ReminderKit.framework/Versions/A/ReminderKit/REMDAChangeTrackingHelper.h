...
+ (char)shouldIgnoreChangeOfModelClassProperties:(Class)a0 withChangeObject:(id)a1;
...
- (id)_changedModelObjectsOfClass:(Class)a0 ofChangeTypes:(long long)a1 shouldOutputFetchedModels:(char)a2;
- (id)_debug_currentChangeTokenWithError:(id *)a0;
- (void)_debug_resetCaches;
- (void)_debug_setMockChangeSet:(id)a0;
- (id)_fetchModelObjectOfClass:(Class)a0 withObjectID:(id)a1 includeConcealedObjects:(char)a2;
