...
- (void)_lowLevelAddMergeableOrderingNodeToOrdering:(id)a0 atIndexOfSibling:(id)a1 isAfter:(char)a2 withParentMergeableOrderingNode:(id)a3;
...
- (char)canCopyReminderLosslesslyToAccountChangeItem:(id)a0;
...
- (id)initWithSaveRequest:(id)a0 storage:(id)a1 capabilities:(id)a2 observeInitialValues:(char)a3;
- (void)insertListChangeItem:(id)a0 afterListChangeItem:(id)a1;
- (void)insertListChangeItem:(id)a0 beforeListChangeItem:(id)a1;
- (void)insertMergeableOrderingNode:(id)a0 adjacentToMergeableOrderingNode:(id)a1 isAfter:(char)a2 withParentMergeableOrderingNode:(id)a3;
