...
@property (nonatomic) char moveClock;
...
- (id)_insertObject:(id)a0 withIdentifier:(id)a1 atIndex:(unsigned long long)a2 forUndo:(char)a3;
...
- (void)removeObjectAtIndex:(unsigned long long)a0 forUndo:(char)a1;
