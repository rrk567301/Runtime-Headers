...
+ (id)shortNaturalLanguageDescriptionForFrequency:(long long)a0 interval:(long long)a1 daysOfTheWeek:(id)a2 daysOfTheMonth:(id)a3 monthsOfTheYear:(id)a4 setPositions:(id)a5 date:(id)a6 timeZone:(id)a7 lowercase:(char)a8;
+ (id)shortNaturalLanguageDescriptionForRecurrenceRule:(id)a0 date:(id)a1 timeZone:(id)a2 lowercase:(char)a3;
