...
- (char)disableEventBroadcaster:(id *)a0;
- (char)enableFetchSandboxExtensions:(id *)a0;
...
- (char)openDatabase:(unsigned long long)a0 forKind:(unsigned long long)a1 error:(id *)a2;
