...
- (char)handleGetServerProtocolVersion:(unsigned int)a0 withConnection:(id)a1 protocolVersion:(id *)a2;
- (void)handleOpenMediaDomains:(id)a0 withConnection:(id)a1 withReply:(id /* block */)a2;
- (char)handleReconnectionToLibrary:(id)a0;
- (char)handleRegisterLibraryClient:(unsigned int)a0 withConnection:(id)a1 error:(id *)a2;
