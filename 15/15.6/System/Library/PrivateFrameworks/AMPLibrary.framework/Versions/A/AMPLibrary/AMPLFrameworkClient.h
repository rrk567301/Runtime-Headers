...
- (void)storageInfoForDomains:(unsigned long long)a0 withMediaKinds:(unsigned long long)a1 ignorePurgeable:(char)a2 withReply:(id /* block */)a3;
...
- (char)handleReconnectionToLibrary:(id)a0;
- (char)handleRegisterClientName:(id)a0 withConnection:(id)a1 error:(id *)a2;
- (char)handleSynchronousOpenMediaDomains:(id)a0 error:(id *)a1 withResponseDict:(id *)a2;
...
- (void)playlistsForDomains:(unsigned long long)a0 withMediaKinds:(unsigned long long)a1 withDeviceCapabilities:(unsigned long long)a2 withItems:(char)a3 withReply:(id /* block */)a4;
...
- (void)synchronousDistinguishedPlaylistForDomains:(unsigned long long)a0 withDistinguishedKind:(unsigned long long)a1 withItems:(char)a2 withReply:(id /* block */)a3;
...
- (char)synchronousOpenMediaDomains:(id *)a0;
- (char)synchronousOpenMediaDomains:(id *)a0 withResponseDict:(id *)a1;
- (void)synchronousParentalPreferencesWithReply:(id /* block */)a0;
- (void)synchronousPlaylistsForDomains:(unsigned long long)a0 withMediaKinds:(unsigned long long)a1 withDeviceCapabilities:(unsigned long long)a2 withItems:(char)a3 withReply:(id /* block */)a4;
...
- (void)synchronousStorageInfoForDomains:(unsigned long long)a0 withMediaKinds:(unsigned long long)a1 ignorePurgeable:(char)a2 withReply:(id /* block */)a3;
