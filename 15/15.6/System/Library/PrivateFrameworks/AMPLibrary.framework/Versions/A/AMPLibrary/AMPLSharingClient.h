...
- (char)handleRegisterSharingClientID:(unsigned int)a0 withConnection:(id)a1 error:(id *)a2;
- (char)handleSynchronousOpenMediaDomains:(id)a0 error:(id *)a1;
- (id)initWithClientInfo:(id)a0 withClientID:(unsigned int)a1 error:(id *)a2;
- (id)newClientConnection:(int)a0 clientIPAddress:(id)a1;
- (void)setPlaylistIsShared:(char)a0 forPlaylist:(unsigned long long)a1 withReply:(id /* block */)a2;
- (void)setPublicSharingState:(char)a0 withReply:(id /* block */)a1;
- (void)setShareAllPlaylists:(char)a0 withUpdatedPlaylists:(id)a1 withReply:(id /* block */)a2;
- (void)setSharedLibraryPassword:(char)a0 withPassword:(id)a1 withReply:(id /* block */)a2;
- (char)synchronousOpenMediaDomainsSharingConnections:(id *)a0;
- (void)updatePlayCounts:(char)a0 withReply:(id /* block */)a1;
