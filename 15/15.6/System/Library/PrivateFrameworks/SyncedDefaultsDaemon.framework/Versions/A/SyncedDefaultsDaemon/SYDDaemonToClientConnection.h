...
@property (nonatomic) char didRefreshBundleMap;
@property (readonly, nonatomic) char supportsTesting;
...
- (char)_isEntitledForStoreConfiguration:(id)a0;
...
- (char)isCloudSyncEnablementEntitledForStoreIdentifier:(id)a0;
- (char)isEntitledForStoreConfiguration:(id)a0;
- (char)isKnownStore:(id)a0;
- (char)isPerformingManualSync;
...
- (char)shouldEnforceQuotaForStoreConfiguration:(id)a0;
