...
- (void)_receiveFileTransfer:(id)a0 topic:(id)a1 path:(id)a2 requestURLString:(id)a3 ownerID:(id)a4 signature:(id)a5 allowReauthorize:(char)a6 fileSize:(unsigned long long)a7 sourceAppID:(id)a8 progressBlock:(id /* block */)a9 completionBlock:(id /* block */)a10;
...
- (char)_shouldRetryUploadGivenMMCSError:(id)a0 retryAttemptCount:(unsigned long long)a1;
...
- (void)sendFilePath:(id)a0 encrypt:(char)a1 topic:(id)a2 transferID:(id)a3 sourceAppID:(id)a4 userInfo:(id)a5 progressBlock:(id /* block */)a6 completionBlock:(id /* block */)a7;
- (void)warm;
