...
- (void)getNicknameWithRecordID:(id)a0 decryptionKey:(id)a1 wallpaperDataTag:(id)a2 wallpaperLowResDataTag:(id)a3 wallpaperMetadataTag:(id)a4 knownSender:(char)a5 shouldDecodeImageFields:(char)a6 queue:(id)a7 completionBlock:(id /* block */)a8;
