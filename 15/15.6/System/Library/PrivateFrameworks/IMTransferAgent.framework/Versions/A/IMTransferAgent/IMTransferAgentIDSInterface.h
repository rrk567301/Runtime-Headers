...
- (char)_sendIDSMessage:(id)a0 topic:(id)a1 localPath:(id)a2;
- (void)_sendUploadRequest:(id)a0 topic:(id)a1 transferID:(id)a2 sourceAppID:(id)a3 allowReauthorize:(char)a4;
- (void)_sendUploadResponse:(id)a0 topic:(id)a1 success:(char)a2 error:(id)a3 ownerID:(id)a4 signature:(id)a5 requestURLString:(id)a6 transferID:(id)a7;
