...
@property (nonatomic, readonly) char hasVariationCoord;
...
- (char)runFpgm:(id)a0 error:(id *)a1;
- (char)runGlyf:(id)a0 zone:(id)a1 error:(id *)a2;
- (char)runPrep:(id)a0 error:(id *)a1;
- (void)setCVT:(const int *)a0 count:(long long)a1;
- (void)setScaleFactorsWithXStretch:(int)a0 yStretch:(int)a1 unitsPerEm:(short)a2 pointSize:(int)a3 isRotated:(char)a4 isStretched:(char)a5;
