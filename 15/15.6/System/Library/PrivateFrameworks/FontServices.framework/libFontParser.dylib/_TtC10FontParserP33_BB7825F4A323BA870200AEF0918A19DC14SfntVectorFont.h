...
@interface _TtC10FontParserP33_BB7825F4A323BA870200AEF0918A19DC14SfntVectorFont : FontParser.AnyVectorFont {
    ...
    void /* unknown type, empty encoding */ cachedPostScriptName;
    void /* unknown type, empty encoding */ glyphMap;
    void /* unknown type, empty encoding */ postTable;
    void /* unknown type, empty encoding */ $__lazy_storage_$_lastResortPostScriptName;
}

@property (nonatomic, readonly) char isSFNT;
...
@property (nonatomic, readonly) char isBitmapOnly;
@property (nonatomic, readonly) char isSuitcase;
...
@property (nonatomic, readonly) char isNamedInstance;
@property (nonatomic, readonly) NSString *instanceName;
@property (nonatomic, readonly) unsigned short instanceNameID;
@property (nonatomic, readonly) char hasNamedInstanceWithOpticalSize;
@property (nonatomic, readonly) NSArray *variationScalars;

- (id)init;
- (void).cxx_destruct;
- (char)canCreatePostScriptSubsetWithFormat:(long long)a0;
...
- (struct CGFloat2 { double x0; double x1; })getIdealAdvanceAndSideBearingWithGlyph:(unsigned int)a0 vertical:(char)a1;
...
- (char)getTrueTypeEncodingWithPlatform:(unsigned short)a0 script:(unsigned short)a1 indexMap:(void *)a2;
