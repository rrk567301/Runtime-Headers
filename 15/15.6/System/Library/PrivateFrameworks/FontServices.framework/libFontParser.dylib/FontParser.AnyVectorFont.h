...
- (id)init;
- (char)getGlyphsWithCids:(const unsigned short *)a0 glyphs:(unsigned short *)a1 count:(long long)a2;
...
- (char)getCIDsWithGlyphs:(const unsigned short *)a0 cids:(unsigned short *)a1 count:(long long)a2;
...
- (char)getGlyphsWithCharacterRange:(struct { long long x0; long long x1; })a0 glyphs:(unsigned short *)a1;
- (char)getGlyphsWithCharacterRange:(struct { long long x0; long long x1; })a0 longGlyphs:(unsigned int *)a1;
...
- (char)getRegistryOrderingSupplement:(id *)a0 :(id *)a1 :(int *)a2;
- (char)getStemsInto:(struct CGFloat2 { double x0; double x1; } *)a0;
- (char)getStrikeoutInto:(struct CGFloat2 { double x0; double x1; } *)a0;
- (char)getSubscriptInto:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0;
- (char)getSuperscriptInto:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0;
- (char)getTrueTypeEncodingWithPlatform:(unsigned short)a0 script:(unsigned short)a1 indexMap:(void *)a2;
- (char)getTypoMetricsInto:(struct CGFloat3 { double x0; double x1; double x2; } *)a0;
...
- (char)getWindowsMetricsInto:(struct CGFloat2 { double x0; double x1; } *)a0;
