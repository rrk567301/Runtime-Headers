...
- (char)hasAssertion:(id)a0;
- (char)hasAssertionsForOriginator:(id)a0;
- (char)hasAssertionsForOriginator:(id)a0 exceedingCount:(unsigned long long)a1;
- (char)hasResolvedAssertion:(id)a0;
