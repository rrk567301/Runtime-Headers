...
@interface RBContainerManager : NSObject <RBContainerManaging> {
    ...
    struct OptionalUID { char set; unsigned int uid; } _queryUID;
...
- (struct OptionalUID { char x0; unsigned int x1; })_fetchCacheUIDChoice:(id)a0;
- (id)_lookupContainerPathForIdentity:(id)a0 context:(id)a1 persona:(id)a2 containerIdentifier:(id)a3 retry:(char)a4 error:(id *)a5;
...
- (id)_sandboxContainerURLForExtensionContext:(id)a0 containerOverrideIdentifier:(id)a1;
- (id)containerPathForIdentity:(id)a0 context:(id)a1 persona:(id)a2 error:(id *)a3;
- (char)containerRequiredForServiceDict:(id)a0;
- (id)initWithPersonaManager:(id)a0;
- (id)sandboxContainerURLForExtensionContext:(id)a0 containerOverrideIdentifier:(id)a1;
