...
- (char)_canTerminateProcess:(id)a0 withContext:(id)a1 error:(out id *)a2;
- (void)_enqueueGuaranteedRunningLaunchForIdentity:(id)a0 atTime:(double)a1;
- (id)_executeLaunchRequest:(id)a0 withError:(out id *)a1;
- (void)_executeLifecycleEventForIdentity:(id)a0 sync:(char)a1 withBlock:(id /* block */)a2;
...
- (id)_processForIdentifier:(id)a0 withAuditToken:(id)a1 forceStartTracking:(char)a2;
...
- (void)executeLaunchRequest:(id)a0 withCompletion:(id /* block */)a1;
...
- (void)systemPreventIdleSleepStateDidChange:(char)a0;
