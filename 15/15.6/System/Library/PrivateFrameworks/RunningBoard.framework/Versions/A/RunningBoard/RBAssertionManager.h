...
- (id)captureState;
- (id)allEntitlements;
- (char)invalidateAssertionsDueToCPUUsageViolationForProcessIdentifier:(id)a0;
...
- (id)_concreteTargetForTarget:(id)a0 allowAbstractTarget:(char)a1;
- (char)_decreaseInFlightOperationsForOriginator:(id)a0;
- (void)_decreaseInFlightOperationsForTargetIdentities:(id)a0;
- (char)_increaseInFlightOperationsForOriginator:(id)a0 andSuspendIfNeeded:(id)a1;
- (void)_increaseInFlightOperationsForTargetIdentities:(id)a0;
- (char)_invalidateAssertion:(id)a0 sync:(char)a1;
...
- (char)_lock_batchContextInvalidatesSynchronously:(id)a0;
...
- (char)_lock_enforceAssertionLimitIfNecessaryForBatchContext:(id)a0 originatorProcess:(id)a1 error:(id *)a2;
- (void)_lock_enqueueAssertionsForRemoval:(id)a0;
- (void)_lock_finalizeRemovingAssertions:(id)a0;
- (char)_lock_hasStartTimeDefiningAssertionsForTargetProcessIdentity:(id)a0;
...
- (void)_lock_invalidateAssertions:(id)a0 forceSync:(char)a1;
...
- (char)_lock_originatorHasExited:(id)a0;
...
- (char)_lock_validateDescriptor:(id)a0 originatorProcess:(id)a1 originatorState:(id)a2 concreteTarget:(id)a3 targetProcess:(id)a4 targetIdentity:(id)a5 targetIdentifier:(id)a6 targetState:(id)a7 acquisitionContext:(id)a8 error:(out id *)a9;
- (char)_lock_willExceedAssertionLimitForOriginatorProcess:(id)a0 withIncomingCount:(unsigned long long)a1;
...
- (char)addSavedEndowment:(id)a0 forProcess:(id)a1;
...
- (char)hasAssertionWithIdentifier:(id)a0;
- (char)hasAssertionWithIdentifierForTarget:(id)a0 identifier:(id)a1;
...
- (char)invalidateAssertion:(id)a0;
- (char)invalidateAssertionFromOriginator:(id)a0 sync:(char)a1 withIdentifier:(id)a2;
- (char)invalidateAssertionFromOriginator:(id)a0 withIdentifier:(id)a1;
- (char)invalidateAssertionWithIdentifier:(id)a0;
- (char)isProcessForeground:(id)a0;
