@interface SiriKitRuntime.ServiceBridgeErrorHandlingProxy : _TtCs12_SwiftObject <SKRServiceBridge> {
    void /* unknown type, empty encoding */ wrappedProxy;
}
...
- (void)closeWithExecutionOutput:(id)a0 needsUserInput:(char)a1;
- (void)fallbackToInfoDomainResultsForResultCandidateId:(id)a0;
- (void)fallbackToServerForResultCandidateId:(id)a0;
- (void)fetchContextsFor:(id)a0 includesNearByDevices:(char)a1 completion:(id /* block */)a2;
