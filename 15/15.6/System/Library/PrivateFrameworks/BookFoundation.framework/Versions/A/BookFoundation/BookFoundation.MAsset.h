...
@property (nonatomic, readonly) char hasSupplementalContent;
@property (nonatomic, readonly) char isSG;
@property (nonatomic, readonly) NSURL *bookSampleDownloadURL;
@property (nonatomic, readonly) NSString *pageProgressionDirection;
@property (nonatomic, readonly) char pagesAreRTL;
@property (nonatomic, readonly) NSString *version;
@property (nonatomic, readonly) char supportsUnifiedProductPage;
...
@property (nonatomic, readonly) char isBook;
