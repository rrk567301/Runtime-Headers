...
@property (readonly, nonatomic) BOOL xpcBundle;
...
- (void).cxx_destruct;
- (id)initWithLabel:(id)a0 instance:(id)a1 requestedJetsamPriority:(int)a2 additionalProperties:(id)a3 program:(id)a4 processType:(unsigned int)a5 keepAlive:(BOOL)a6 runAtLoad:(BOOL)a7 enableTransactions:(BOOL)a8 endpoints:(id)a9 serviceType:(long long)a10 path:(id)a11 xpcBundle:(BOOL)a12 hostPID:(int)a13;
