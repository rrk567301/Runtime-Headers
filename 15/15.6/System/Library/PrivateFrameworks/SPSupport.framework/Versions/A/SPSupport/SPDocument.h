...
- (id)_attributedStringForItem:(id)a0 dataType:(id)a1 indentation:(float)a2 isUnit:(char)a3;
...
- (id)_stringForItem:(id)a0 dataType:(id)a1 indentation:(int)a2 isUnit:(char)a3;
...
- (char)uploadToURL:(id)a0 usingCompression:(char)a1;
