...
- (void)informSiriVoiceSubscriptionsWithVoiceId:(id)a0 addition:(char)a1;
- (void)refreshAssetCatalogForPolicy:(id)a0 withOverrideTimeout:(id)a1 forceCatalogRefresh:(char)a2;
- (void)runFirstBootTasks:(char)a0;
