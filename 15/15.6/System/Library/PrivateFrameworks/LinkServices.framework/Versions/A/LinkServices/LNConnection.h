...
- (char)isPerformActionOperationPending;
...
- (void)connectUsingListenerEndpoint:(id)a0 auditToken:(struct { unsigned int x0[8]; })a1 setupWithAssertions:(char)a2;
- (char)connectUsingProcessIdentifierWithOptions:(id)a0 setupWithAssertions:(char)a1;
...
- (void)setIdleTimer;
- (void)setUpConnectionContextWithAssertions:(char)a0 completionHandler:(id /* block */)a1;
- (char)shouldRefreshWithOptions:(id)a0;
- (char)targetIsBeingDebugged;
