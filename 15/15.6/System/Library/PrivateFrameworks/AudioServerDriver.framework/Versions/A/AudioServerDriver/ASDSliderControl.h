...
+ (id)sliderControlWithValue:(unsigned int)a0 andRange:(struct _ASDSliderRange { unsigned int x0; unsigned int x1; })a1 isSettable:(char)a2 forElement:(unsigned int)a3 inScope:(unsigned int)a4 withPlugin:(id)a5;
...
- (id)initWithValue:(unsigned int)a0 andRange:(struct _ASDSliderRange { unsigned int x0; unsigned int x1; })a1 isSettable:(char)a2 forElement:(unsigned int)a3 inScope:(unsigned int)a4 withPlugin:(id)a5;
- (id)initWithValue:(unsigned int)a0 andRange:(struct _ASDSliderRange { unsigned int x0; unsigned int x1; })a1 isSettable:(char)a2 forElement:(unsigned int)a3 inScope:(unsigned int)a4 withPlugin:(id)a5 andObjectClassID:(unsigned int)a6;
