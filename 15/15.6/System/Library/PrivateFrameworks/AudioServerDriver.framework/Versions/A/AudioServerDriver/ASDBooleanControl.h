...
+ (id)invertControlWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4;
+ (id)jackControlWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4;
+ (id)muteControlWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4;
+ (id)phantomPowerControlWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4;

- (void).cxx_destruct;
- (char)value;
- (void)setValue:(char)a0;
...
- (id)initWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4;
- (id)initWithValue:(char)a0 isSettable:(char)a1 forElement:(unsigned int)a2 inScope:(unsigned int)a3 withPlugin:(id)a4 andObjectClassID:(unsigned int)a5;
