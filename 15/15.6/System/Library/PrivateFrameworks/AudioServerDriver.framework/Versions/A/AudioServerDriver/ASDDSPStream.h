...
@property (nonatomic) char keepGraphInitialized;
@property (readonly, nonatomic) char isRunning;
@property (nonatomic) char bypassMode;
...
- (char)graphStructureIsValid:(id)a0 clientID:(unsigned long long)a1;
- (char)addHardwareDSP:(id)a0;
- (id)driverClassName;
...
- (char)addClientDSP:(id)a0 forClient:(unsigned int)a1;
- (char)addClientDSP:(id)a0 withKey:(unsigned long long)a1;
- (char)changePhysicalFormat:(id)a0;
...
- (char)enableBasicDSPCaptureOnGraph:(id)a0 withLevel:(id)a1 andDebugType:(long long)a2;
- (char)enableBasicDSPCaptureOnGraph:(id)a0 withLevel:(id)a1 andDebugType:(long long)a2 andMode:(long long)a3;
...
- (char)removeClientDSPForClient:(unsigned int)a0;
- (char)removeClientDSPwithKey:(unsigned long long)a0;
