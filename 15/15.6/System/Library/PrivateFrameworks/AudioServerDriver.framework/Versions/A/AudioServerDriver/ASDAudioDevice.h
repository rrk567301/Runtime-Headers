...
@property (nonatomic) char canBeDefaultDevice;
@property (nonatomic) char canBeDefaultInputDevice;
@property (nonatomic) char canBeDefaultOutputDevice;
@property (nonatomic) char canBeDefaultSystemDevice;
@property (nonatomic) char allowAutoRoute;
@property (nonatomic) char wantsDisplayRouting;
@property (nonatomic, getter=isHidden) char hidden;
@property (nonatomic) char canChangeDeviceName;
...
@property (nonatomic) char clockIsStable;
...
@property (nonatomic) char supportsIsolatedIO;
...
- (char)changeClientDescription:(id)a0;
- (char)changeDeviceName:(id)a0;
