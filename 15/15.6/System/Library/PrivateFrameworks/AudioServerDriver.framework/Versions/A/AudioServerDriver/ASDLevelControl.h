...
+ (id)volumeControlWithDecibelValue:(float)a0 minimumValue:(float)a1 maximumValue:(float)a2 isSettable:(char)a3 forElement:(unsigned int)a4 inScope:(unsigned int)a5 withPlugin:(id)a6;
...
- (char)changeDecibelValue:(float)a0;
- (char)changeScalarValue:(float)a0;
...
- (id)initWithDecibelValue:(float)a0 minimumValue:(float)a1 maximumValue:(float)a2 isSettable:(char)a3 forElement:(unsigned int)a4 inScope:(unsigned int)a5 withPlugin:(id)a6;
- (id)initWithDecibelValue:(float)a0 minimumValue:(float)a1 maximumValue:(float)a2 isSettable:(char)a3 forElement:(unsigned int)a4 inScope:(unsigned int)a5 withPlugin:(id)a6 andObjectClassID:(unsigned int)a7;
