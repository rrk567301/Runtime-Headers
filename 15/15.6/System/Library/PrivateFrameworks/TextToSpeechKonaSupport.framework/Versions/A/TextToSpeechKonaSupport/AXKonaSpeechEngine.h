...
@property (nonatomic) char highQualityMode;
@property (nonatomic) char abbreviationDictionary;
@property (nonatomic) char phrasePrediction;
@property (nonatomic) char preferCommunityDictionary;
...
- (char)_initializeWrappedEngineForVoice:(id)a0;
- (id)_konaCrashPatterns;
- (char)_loadDictionaryAtPath:(id)a0 type:(long long)a1 handle:(void *)a2;
