...
- (void)indexAppKitMenu:(id)a0 withParentMenu:(id)a1 resultGRLs:(id)a2 isRootMenu:(char)a3 systemHelpMenu:(id)a4 withDepth:(long long)a5;
- (void)indexCarbonMenu:(struct OpaqueMenuRef { } *)a0 withParentMenu:(id)a1 resultGRLs:(id)a2 isRootMenu:(char)a3 systemHelpMenu:(struct OpaqueMenuRef { } *)a4 withDepth:(long long)a5;
- (void)indexExternalApp:(id)a0;
- (void)indexMenuBar:(id)a0;
- (void)indexMenuBarDynamically;
- (char)isInUpdate;
- (id)keysForLocalizedString:(id)a0;
- (char)matchLocalizedString:(id)a0 forKeys:(id)a1;
