...
- (char)isEqualRevisionOfAssetHandle:(id)a0 differencesDescription:(id *)a1;
- (char)isEqualToAssetHandle:(id)a0 keys:(id)a1 optionalKeys:(id)a2 differencesDescription:(id *)a3;
- (char)mayBeEvicted;
