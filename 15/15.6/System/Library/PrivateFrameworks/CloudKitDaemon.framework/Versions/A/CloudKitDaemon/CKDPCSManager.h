...
@protocol OS_dispatch_queue, CKDContainerScopedUserIDProvider;
...
@property (readonly, nonatomic) char useZoneWidePCS;
...
- (char)_addPublicIdentityForService:(unsigned long long)a0 toSharePCS:(struct _OpaquePCSShareProtection { } *)a1 withError:(id *)a2;
- (char)_checkAndClearPCSTestOverrideForKey:(id)a0;
- (char)_checkPCSTestOverrideForKey:(id)a0;
- (char)_checkUnitTestOverridesForDecryptionFailuresWithState:(char)a0 error:(id *)a1;
- (void)_createPCSFromData:(id)a0 ofType:(unsigned long long)a1 usingPCSServiceType:(unsigned long long)a2 tryDecryptingWithOtherServices:(char)a3 withSyncKeyRegistryRetry:(char)a4 lastModifiedDate:(id)a5 requestorOperationID:(id)a6 completionHandler:(id /* block */)a7;
- (char)_isAllowlistedKeyRollingContainerID:(id)a0;
- (char)_isKeyRollingUnitTestContainerID:(id)a0;
- (void)_lockedGlobalPerUserBoundaryKeyDataWithCompletionHandler:(id /* block */)a0;
- (void)_locked_createPCSFromData:(id)a0 ofType:(unsigned long long)a1 usingPCSServiceType:(unsigned long long)a2 tryDecryptingWithOtherServices:(char)a3 withSyncKeyRegistryRetry:(char)a4 lastModifiedDate:(id)a5 keySyncAnalytics:(id)a6 requestorOperationID:(id)a7 completionHandler:(id /* block */)a8;
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(char)a0 requestorOperationID:(id)a1 keySyncAnalytics:(id)a2 completionHandler:(id /* block */)a3;
...
- (char)addRandomShareeToPCS:(struct _OpaquePCSShareProtection { } *)a0;
- (char)addSharePCS:(struct _OpaquePCSShareProtection { } *)a0 toRecordPCS:(struct _OpaquePCSShareProtection { } *)a1 error:(id *)a2;
- (char)addSharePCS:(struct _OpaquePCSShareProtection { } *)a0 toRecordPCS:(struct _OpaquePCSShareProtection { } *)a1 permission:(unsigned long long)a2 error:(id *)a3;
...
- (char)availableIdentityForService:(unsigned long long)a0 error:(id *)a1;
...
- (id)createNewSharePCSDataForShareWithID:(id)a0 withPublicSharingKey:(id)a1 addDebugIdentity:(char)a2 error:(id *)a3;
...
- (struct _OpaquePCSShareProtection { } *)createPCSObjectFromData:(id)a0 ofType:(unsigned long long)a1 sharedToPCS:(struct _OpaquePCSShareProtection { } *)a2 logFailure:(char)a3 error:(id *)a4;
- (struct _OpaquePCSShareProtection { } *)createPCSObjectFromData:(id)a0 ofType:(unsigned long long)a1 sharedToPCS:(struct _OpaquePCSShareProtection { } *)a2 logFailure:(char)a3 trusts:(id)a4 error:(id *)a5;
...
- (struct _OpaquePCSShareProtection { } *)createRecordPCSWithEncryptedZonePCS:(struct __CFData { } *)a0 sharePCS:(struct _OpaquePCSShareProtection { } *)a1 createLite:(char)a2 error:(id *)a3;
- (struct _OpaquePCSShareProtection { } *)createRecordPCSWithZonePCS:(struct _OpaquePCSShareProtection { } *)a0 sharePCS:(struct _OpaquePCSShareProtection { } *)a1 createLite:(char)a2 error:(id *)a3;
...
- (struct _OpaquePCSShareProtection { } *)createSharePCSFromData:(id)a0 ofType:(unsigned long long)a1 withService:(unsigned long long)a2 logFailure:(char)a3 error:(id *)a4;
...
- (struct _OpaquePCSShareProtection { } *)createSharePCSFromData:(id)a0 sharingIdentity:(struct _PCSIdentityData { } *)a1 logFailure:(char)a2 error:(id *)a3;
...
- (void)createZonePCSWithRequestorOperationID:(id)a0 completionHandler:(id /* block */)a1;
- (void)createZonePCSWithSyncKeyRegistryRetry:(char)a0 requestorOperationID:(id)a1 completionHandler:(id /* block */)a2;
...
- (char)decryptSharedZonePCSData:(id)a0 withInvitedPCS:(struct _OpaquePCSShareProtection { } *)a1 error:(id *)a2;
...
- (id)generateAnonymousCKUserIDForCurrentUserInShare:(id)a0 containerID:(id)a1 acceptA2AShareUsingVersionOneAnonymousIdentifier:(char)a2;
...
- (char)isPCSSizeTooBigForKeyRoll:(unsigned long long)a0;
- (char)isPCSTooBigForKeyRoll:(struct _OpaquePCSShareProtection { } *)a0;
- (char)isPreviouslyUndecryptablePCS:(id)a0;
- (char)isSinglyWrappedRemindersZone:(struct _OpaquePCSShareProtection { } *)a0;
...
- (id)keyRollIfNeededForPerRecordPCS:(id)a0 needsRollAndCounterSign:(char)a1 forOperation:(id)a2 didRoll:(char *)a3;
...
- (char)recordProtectionDataNeedsCounterSign:(id)a0 error:(id *)a1;
...
- (char)removePublicKeys:(id)a0 fromPCS:(struct _OpaquePCSShareProtection { } *)a1;
- (char)removeSharePCS:(struct _OpaquePCSShareProtection { } *)a0 fromRecordPCS:(struct _OpaquePCSShareProtection { } *)a1 error:(id *)a2;
...
- (id)rollIdentityForSharePCS:(struct _OpaquePCSShareProtection { } *)a0 ofType:(unsigned long long)a1 removeAllExistingPrivateKeys:(char)a2 error:(id *)a3;
- (id)rollMasterKeyForRecordPCS:(struct _OpaquePCSShareProtection { } *)a0 forOperation:(id)a1;
- (id)rollMasterKeyForRecordPCS:(struct _OpaquePCSShareProtection { } *)a0 isZoneishRecord:(char)a1 bypassAllowlistedContainers:(char)a2 forOperation:(id)a3;
- (void)sendCoreAnalyticsEventForKeySync:(id)a0;
- (char)serviceTypeIsManatee:(unsigned long long)a0;
...
- (char)sharingFingerprintsContainPublicKeyWithData:(id)a0 error:(id *)a1;
...
- (void)synchronizeUserKeyRegistryForServiceType:(unsigned long long)a0 shouldThrottle:(char)a1 context:(id)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
...
- (char)updateSigningIdentityOnPCS:(struct _OpaquePCSShareProtection { } *)a0 usingSignedPCS:(struct _OpaquePCSShareProtection { } *)a1;
- (id)updateZoneIdentityForRecordPCS:(struct _OpaquePCSShareProtection { } *)a0 usingZonePCS:(struct _OpaquePCSShareProtection { } *)a1 isZoneishRecord:(char)a2 bypassAllowlistedContainers:(char)a3;
- (char)validateFullPublicKeySignature:(id)a0 forSignedData:(id)a1 error:(id *)a2;
- (char)validateSignature:(id)a0 forSignedData:(id)a1 usingIdentityType:(unsigned long long)a2 error:(id *)a3;
...
- (char)zonePCSNeedsKeyRolled:(struct _OpaquePCSShareProtection { } *)a0;
- (char)zonePCSNeedsKeyRolled:(struct _OpaquePCSShareProtection { } *)a0 isZoneishZone:(char)a1 bypassAllowlistedContainers:(char)a2;
- (char)zonePCSNeedsUpdate:(struct _OpaquePCSShareProtection { } *)a0;
