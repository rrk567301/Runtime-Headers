...
@protocol OS_dispatch_group, CKFetchRecordVersionsOperationCallbacks, CKDOperationCallbackProxy;
...
- (id)activityCreate;
- (int)operationType;
- (void)_handleRecordVersionsFetchedForID:(id)a0 isDeleted:(char)a1 versions:(id)a2 responseCode:(id)a3;
