...
@property (readonly, nonatomic) char isNewEmptyCache;
@property (readonly, nonatomic) NSString *fileDownloadPath;

+ (id)_sharedCachesByDirectory;
+ (id)_sharedCachesQueue;
+ (id)assetCacheWithApplicationBundleID:(id)a0 directoryContext:(id)a1 database:(id)a2 didInit:(char *)a3 error:(id *)a4;
...
- (id)_evictAllFilesForced:(char)a0;
...
- (char)startTrackingGetAssetHandles:(id)a0 operationType:(long long)a1 error:(id *)a2;
- (char)startTrackingRegisterOrPutAssetHandles:(id)a0 operationType:(long long)a1 error:(id *)a2;
...
- (char)updateAssetHandlesForGetMMCSItems:(id)a0 cloneItems:(char)a1 error:(id *)a2;
- (char)updateAssetHandlesForPutMMCSItems:(id)a0 cloneItems:(char)a1 error:(id *)a2;
