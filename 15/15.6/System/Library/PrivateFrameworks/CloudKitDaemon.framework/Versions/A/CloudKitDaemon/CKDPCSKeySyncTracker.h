...
@property (nonatomic, getter=isManatee) char manatee;
...
@property (nonatomic) char KRSReturnedExistingIdentity;
@property (copy, nonatomic) NSString *requestorOperationID;
@property (nonatomic) char racedWithGuitarfishRepairCallback;
