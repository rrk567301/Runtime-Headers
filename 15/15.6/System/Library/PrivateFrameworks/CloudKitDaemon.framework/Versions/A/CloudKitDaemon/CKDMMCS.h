...
@property (nonatomic) char didDrop;
...
- (char)_getRegisteredItemsGreaterThan:(unsigned long long)a0 itemIds:(unsigned long long *)a1 itemCount:(unsigned long long *)a2 error:(id *)a3;
- (void)_logMMCSOptions:(id)a0;
- (id)_referenceIdentifierFromAssetKey:(id)a0;
- (void)_unregisterItemIDs:(id)a0;
- (id)getItemGroupSet:(id)a0 operation:(id)a1 shouldFetchAssetContentInMemory:(char)a2 options:(id)a3 progress:(id /* block */)a4 command:(id /* block */)a5 completionHandler:(id /* block */)a6;
...
- (char)isTrackingItemID:(unsigned long long)a0;
...
- (char)registeredItemCount:(unsigned long long *)a0 error:(id *)a1;
