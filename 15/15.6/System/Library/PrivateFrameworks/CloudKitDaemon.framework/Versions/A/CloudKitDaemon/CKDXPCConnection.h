...
- (char)canRunGivenAvailabilityState:(unsigned long long)a0;
...
- (void)getLogicalDeviceScopedClientProxyCreatorForTestDeviceReference:(id)a0 synchronous:(char)a1 completionHandler:(id /* block */)a2;
- (void)getProcessScopedClientProxyCreatorSynchronous:(char)a0 completionHandler:(id /* block */)a1;
