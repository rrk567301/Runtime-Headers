...
- (char)willOpenItemReaderWriter:(id)a0 error:(id *)a1;
- (void)_cleanupMMCSItems;
- (void)_cleanupMMCSRegisterItems;
- (char)_setupGetMMCSItemsWithError:(id *)a0;
- (char)_setupMMCSItemsWithError:(id *)a0;
- (char)_setupPutMMCSItemsWithError:(id *)a0;
- (char)_setupRegisterMMCSItemsWithError:(id *)a0;
- (void)_startTrackingMMCSItems:(id)a0;
- (void)_stopTrackingMMCSItems:(id)a0;
- (id)conformingOperation;
- (void)didCloseItemReaderWriter:(id)a0 result:(char)a1 error:(id)a2;
...
- (void)didOpenItemReaderWriter:(id)a0 result:(char)a1 error:(id)a2;
- (void)didPutSectionWithSignature:(id)a0 results:(id)a1;
- (char)didReadFromItemReaderWriter:(id)a0 offset:(unsigned long long)a1 bytes:(char *)a2 length:(unsigned long long)a3 bytesRead:(unsigned long long *)a4 error:(id *)a5;
...
- (char)shouldFetchAssetContentUsingAssetDownloadStagingManager;
- (char)shouldFetchAssetContentWithReaderWriter;
...
- (char)willCloseItemReaderWriter:(id)a0 error:(id *)a1;
- (char)willGetFileMetadataItemReaderWriter:(id)a0 error:(id *)a1;
- (char)willReadFromItemReaderWriter:(id)a0 offset:(unsigned long long)a1 bytes:(char *)a2 length:(unsigned long long)a3 bytesRead:(unsigned long long *)a4 error:(id *)a5;
