...
- (void)logRequestWithRequestUUID:(NSString *)a0 request:(NSURLRequest *)a1 url:(NSURL *)a2 method:(NSString *)a3 messageClass:(NSString *)a4 parsingStandaloneMessage:(char)a5 completionHandler:(void (^)(void))a6;
