...
- (id)init;
- (void).cxx_destruct;
- (id)initWithAdopterProcessType:(long long)a0 containingBundleID:(id)a1 applicationContainerPath:(id)a2 entitlements:(id)a3 clientSDKVersion:(unsigned int)a4 isClientMainBundleAppleExecutable:(char)a5;
