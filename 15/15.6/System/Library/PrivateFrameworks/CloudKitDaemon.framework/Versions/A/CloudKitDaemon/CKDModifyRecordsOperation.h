...
@interface CKDModifyRecordsOperation : CKDDatabaseOperation {
    ...
    char _hasRecordsToSave;
    char _hasRecordsToDelete;
...
@property (nonatomic) char haveOutstandingHandlers;
...
@property (nonatomic) char requestNeedsUserPublicKeys;
...
@property (nonatomic) char includeMergeableDeltasInModifyRecordsRequest;
...
@property (nonatomic) char trustProtectionData;
...
+ (char)_claimPackagesInRecord:(id)a0 error:(id *)a1;
...
- (char)_hasHandlerInState:(unsigned long long)a0;
- (void)_markRecordHandlersAsUploaded;
- (char)_needsSigningPCS;
...
- (char)_shouldToposortInContainerID:(id)a0;
