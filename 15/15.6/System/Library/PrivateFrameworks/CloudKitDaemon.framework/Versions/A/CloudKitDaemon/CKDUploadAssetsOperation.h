...
- (char)_didFetchUploadTokensForAssetTokenRequest:(id)a0 error:(id)a1 newError:(id *)a2;
...
- (char)_planPackageSectionItemsForMMCSItems:(id)a0;
- (char)_planSectionsForPackage:(id)a0 error:(id *)a1;
