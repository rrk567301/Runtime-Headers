...
@property (readonly, nonatomic, getter=isContentDiscarded) char contentDiscarded;
...
- (void)clearInvalidatedPCSSQLCacheEntriesWithSkipZonePCS:(char)a0 completionHandler:(id /* block */)a1;
- (void)clearPCSCaches;
