...
- (char)canBeUsedForOperation:(id)a0;
- (char)canBeUsedForPendingFetch:(id)a0;
...
- (char)dependentOperationListContainsOperationID:(id)a0;
- (char)dependentOperationListContainsRunningFetch:(id)a0;
