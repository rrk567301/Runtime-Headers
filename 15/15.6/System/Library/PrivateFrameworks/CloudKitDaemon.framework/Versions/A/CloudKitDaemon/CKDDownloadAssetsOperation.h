...
- (void)_didDownloadMMCSItem:(id)a0 inMemory:(char)a1 error:(id)a2;
- (void)_didDownloadMMCSItems:(id)a0 inMemory:(char)a1 error:(id)a2;
...
- (void)_didMakeProgressForMMCSItem:(id)a0 inMemory:(char)a1;
- (void)_didMakeProgressForMMCSSectionItem:(id)a0 task:(id)a1;
- (void)_didPrepareAsset:(id)a0;
- (char)_download;
- (void)_downloadMMCSItems:(id)a0 downloadTasksByPackages:(id)a1 shouldFetchAssetContentInMemory:(char)a2;
...
- (void)_downloadTranscodedAsset:(id)a0 inMemory:(char)a1;
- (char)_postProcess;
...
- (char)shouldDownloadAssetFromTranscoder:(id)a0;
