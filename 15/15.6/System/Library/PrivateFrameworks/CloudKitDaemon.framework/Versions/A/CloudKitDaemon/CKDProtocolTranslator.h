...
@property (readonly, nonatomic) char addDatabaseScopeToZoneIDs;
...
@property char dontCreateValidatingParentReferences;
...
- (char)_isDefaultUserNameFromClient:(id)a0;
- (char)_isDefaultUserNameFromServer:(id)a0;
- (id)_pRecordFromRecordSansValues:(id)a0 forCache:(char)a1;
- (char)_valueTypeIsAnEncryptedBytesTypeForField:(id)a0;
...
- (id)deltaPRecordFromRecord:(id)a0 withAllFields:(char)a1 outDeletedMergeFields:(id *)a2 outKeysToSend:(id *)a3;
...
- (id)fieldValueFromObject:(id)a0 forCache:(char)a1;
- (id)fieldValueOfType:(int)a0 withObject:(id)a1;
- (id)fieldValueOfType:(int)a0 withObject:(id)a1 forCache:(char)a2;
- (int)fieldValueTypeFromEncryptedDataObject:(id)a0 isInList:(char)a1;
- (int)fieldValueTypeFromObject:(id)a0;
- (char)haveDownloadPreauthorizations;
- (id)identityFromPUser:(id)a0;
- (id)initInternalWithContainerScopedUserID:(id)a0 orgAdminUserID:(id)a1 packageStagingDirectory:(id)a2 databaseScope:(long long)a3 addDatabaseScopeToZoneIDs:(char)a4 pcsManager:(id)a5;
- (id)initWithContainer:(id)a0 databaseScope:(long long)a1;
- (id)initWithContainer:(id)a0 databaseScope:(long long)a1 requireContainerScopedUserID:(char)a2;
...
- (id)mergeableValueIDFromPMergeableValueIdentifier:(id)a0 recordName:(id)a1 fieldName:(id)a2 encrypted:(char)a3 error:(id *)a4;
- (id)notificationFromPPushMessage:(id)a0;
- (char)objectIsAnEncryptedType:(id)a0;
...
- (id)pFieldWithKey:(id)a0 value:(id)a1 forCache:(char)a2;
...
- (id)pShareFromShare:(id)a0 forCache:(char)a1;
...
- (id)pStreamingAssetFromStreamingAsset:(id)a0 forCache:(char)a1;
...
- (id)shareParticipantFromPParticipant:(id)a0 shareID:(id)a1 shouldMatchCurrentUserParticipantByPublicKey:(char)a2 error:(id *)a3;
