...
@property (nonatomic) char didRollRecordPCSMasterKey;
...
@property (nonatomic) char saveCompletionBlockCalled;
@property (readonly, nonatomic) char isShare;
@property (nonatomic) char needsRefetch;
@property (retain, nonatomic) CKDZonePCSData *sharedZonePCSData;
@property (nonatomic) char didAttemptZoneWideShareKeyRoll;
...
- (char)_createPublicSharingKeyWithError:(id *)a0;
- (char)_encryptMergeableDeltasInRecordValueStore:(id)a0 shareProtection:(struct _OpaquePCSShareProtection { } *)a1;
...
- (char)_prepareAsset:(id)a0 recordKey:(id)a1 mergeableDeltaID:(id)a2 record:(id)a3 error:(id *)a4;
...
- (char)_useZoneishPCS;
- (char)_wrapEncryptedData:(id)a0 withPCS:(struct _OpaquePCSShareProtection { } *)a1 forField:(id)a2 recordID:(id)a3;
- (char)_wrapEncryptedDataForRecordValueStore:(id)a0 withPCS:(struct _OpaquePCSShareProtection { } *)a1;
- (char)_wrapEncryptedDataOnRecord:(id)a0;
