...
@protocol CKDOperationCallbackProxy, CKFetchShareMetadataOperationCallbacks;
...
@property (nonatomic) char clientWillDisplaySystemAcceptPrompt;
...
@property (nonatomic) char errorOnOON;
...
- (char)_currentUserIsOONForShareMetadata:(id)a0;
