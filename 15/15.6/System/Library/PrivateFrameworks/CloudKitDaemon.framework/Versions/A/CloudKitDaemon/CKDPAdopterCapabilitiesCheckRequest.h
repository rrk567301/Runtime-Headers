...
@property (readonly, nonatomic) char hasExcludeZoneAccessBefore;
@property (retain, nonatomic) CKDPDate *excludeZoneAccessBefore;
@property (nonatomic) char hasExcludeDevicesWithoutCapabilityCheckingSupport;
@property (nonatomic) char excludeDevicesWithoutCapabilityCheckingSupport;
