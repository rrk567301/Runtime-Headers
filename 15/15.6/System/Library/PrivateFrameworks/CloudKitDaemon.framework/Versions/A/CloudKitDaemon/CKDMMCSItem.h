...
@property (nonatomic) char isPackageManifest;
...
@property (nonatomic) char downloadLooksOkay;
...
@property (nonatomic) char shouldReadAssetContentUsingClientProxy;
@property (nonatomic) char usesAssetDownloadStagingManager;
@property (nonatomic) char isAlreadyRegistered;
@property (nonatomic) char isReaderReadFrom;
...
- (id)initWithAsset:(id)a0 temporary:(char)a1;
- (id)initWithPackage:(id)a0 temporary:(char)a1;
