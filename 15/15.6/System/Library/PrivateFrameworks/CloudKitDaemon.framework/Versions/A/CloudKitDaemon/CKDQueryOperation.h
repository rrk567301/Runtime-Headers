...
@protocol OS_dispatch_group, OS_dispatch_queue, CKDOperationCallbackProxy, CKQueryOperationCallbacks;
...
@property (nonatomic) char hasCalledQueryCursorUpdatedBlock;
