...
@property (readonly, nonatomic) char isPrimaryAccount;
@property (readonly, nonatomic) char isAccountSuspended;
@property (readonly, nonatomic) char canSuspendedAccountRenewCredentials;
@property (readonly, nonatomic) NSString *suspendedAccountIdentifier;
@property (readonly, nonatomic) long long accountType;
@property (readonly, nonatomic) char isPrimaryEmailVerified;
...
+ (void)deviceCountForAccount:(id)a0 ignoreCache:(char)a1 completionHandler:(id /* block */)a2;
+ (id)deviceCountQueue;
...
- (id)privateCodeServiceURLPreferringGateway:(char)a0;
...
- (id)urlForDataclass:(id)a0 preferringGateway:(char)a1;
