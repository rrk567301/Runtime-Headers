...
@property char shouldDropAllConfigurations;
...
- (void)_fetchContainerSpecificInfoForOperation:(id)a0 requireUserIDs:(char)a1 completionHandler:(id /* block */)a2;
- (void)_fetchGlobalConfigForOperation:(id)a0 completionHandler:(id /* block */)a1;
- (void)_reallyDropAllConfigurations;
- (char)_validateContainerServerInfo:(id)a0 requireUserIDs:(char)a1 requireEnvironment:(char)a2 error:(id *)a3;
...
- (void)containerServerInfoForOperation:(id)a0 requireUserIDs:(char)a1 requireEnvironment:(char)a2 completionHandler:(id /* block */)a3;
- (void)expireConfigurationForContainer:(id)a0;
- (void)expireGlobalConfiguration;
- (id)lastKnownServerConfiguration;
- (char)systemAvailabilityChanged:(unsigned long long)a0;
