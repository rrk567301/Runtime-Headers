...
- (void)_handleDeviceCapabilitiesResultForContainer:(id)a0 savedCapabilities:(id)a1 skipErrorMitigation:(char)a2 withError:(id)a3;
- (void)_handleOperationCompletedForContainerLookupName:(id)a0 containerID:(id)a1;
- (void)_handleShareUsageResultForContainer:(id)a0 shareID:(id)a1 date:(id)a2 skipErrorMitigation:(char)a3 withError:(id)a4;
- (void)_handleZoneUsageResultForContainer:(id)a0 zoneID:(id)a1 date:(id)a2 skipErrorMitigation:(char)a3 withError:(id)a4;
...
- (char)isObsoleteCapabilities:(id)a0 operation:(id)a1;
- (char)isObsoleteUsage:(id)a0 operation:(id)a1;
