...
@interface GEOAPServiceManager : NSObject <GEOAPServiceProxy> {
    ...
    char _eventCollectionIsDisabledForCurrentProcess;
    char _usageCountCollectionIsDisabledForCurrentProcess;
...
@property (readonly, nonatomic) char evDirectionsFeedbackAuth;
@property (nonatomic) char evDirectionsFeedbackAllowed;
@property (nonatomic) char directionsFeedbackAllowed;
@property (readonly, nonatomic) char eventCollectionIsDisabledForCurrentProcess;
@property (readonly, nonatomic) char usageCountCollectionIsDisabledForCurrentProcess;
@property (readonly, nonatomic) char evalModeEnabled;
