@class NSString, NSArray, AXAuditCaseResult, AXAuditCategoryResult, NSMutableArray, NSSet;
...
- (char)localIssueShouldRun:(id)a0;
- (char)shouldRunAuditTestType:(id)a0;
- (char)supportAuditGroup:(unsigned long long)a0;
- (char)supportsAuditTestType:(id)a0;
