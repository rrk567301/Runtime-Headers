...
@property (nonatomic) char enforceSecureTransport;
...
- (void)registerTransportInfoMasquerade:(id)a0 encodeOnly:(char)a1;
...
- (char)validateSupportedConnectionSecureTransport:(id)a0;
