...
@property (nonatomic) char _runningContinuousAudit;
@property (nonatomic) struct __AXObserver { } *_axEventObserver;
@property (nonatomic) char _registeredForNotifications;
...
@property (nonatomic) char runContinuousAudit;
...
- (char)runningContinuousAudit;
- (char)runningSingleAudit;
