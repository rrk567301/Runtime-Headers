...
- (id)humanReadableDescriptionForAuditIssueTestType:(id)a0;
- (id)humanReadableDescriptionForAuditTestType:(id)a0;
- (char)isContrastTypeIssue:(long long)a0;
- (id)shortTitleForAuditIssue:(id)a0;
- (id)suggestionDescriptionForAuditIssue:(id)a0;
- (id)suggestionDescriptionForAuditIssue:(id)a0 suggestedColors:(id)a1;
