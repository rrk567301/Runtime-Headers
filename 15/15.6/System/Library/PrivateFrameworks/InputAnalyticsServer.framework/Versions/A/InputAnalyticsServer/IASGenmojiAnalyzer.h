...
@property (nonatomic) char fatalError;
...
+ (char)isSessionStartSignal:(id)a0;
...
- (char)checkForInteractionWithImage:(id)a0;
- (void)deepReset;
...
- (void)handleDidPersonalizeStatusSignal:(id)a0 isInitialImage:(char)a1;
- (char)handleImageGeneratedSignal:(id)a0 isInitialImage:(char)a1;
- (char)handleImageGenerationStartedSignal:(id)a0 isInitialImage:(char)a1;
- (char)handleImageNotGenerated:(id)a0;
