...
- (char)checkAndLogErrorForFeatureDetailsForSignal:(id)a0 updateFeatureDetailsOnMismatch:(char)a1;
...
- (void)handleAttachmentsModifiedSignal:(id)a0 isForSlotForm:(char)a1;
...
- (void)handleResultsRequestedForMontara:(id)a0 isInitialRequest:(char)a1;
