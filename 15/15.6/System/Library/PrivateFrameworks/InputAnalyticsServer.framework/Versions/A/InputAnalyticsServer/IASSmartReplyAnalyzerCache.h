@class NSNumber, NSString, NSArray, NSMutableSet, IASignalAnalyticsObject, NSDate, NSMutableArray;
...
@property (nonatomic) char questionnaireRequestedSignalSeen;
@property (nonatomic) char questionnaireNotShownSignalSeen;
...
@property (nonatomic) char initialResponseCompletedSignalSeen;
