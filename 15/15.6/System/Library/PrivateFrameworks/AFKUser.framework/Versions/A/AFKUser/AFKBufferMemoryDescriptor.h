...
- (id)initWithManager:(id)a0 capacity:(unsigned long long)a1 buffer:(char)a2;
- (int)releaseControl:(char)a0 withOffset:(unsigned long long)a1 andSize:(unsigned long long)a2;
