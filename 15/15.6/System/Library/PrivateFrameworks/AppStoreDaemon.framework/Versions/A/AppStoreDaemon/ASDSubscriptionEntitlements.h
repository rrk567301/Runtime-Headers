...
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)a0 ignoreCaches:(char)a1 isBackground:(char)a2 requestingBundleId:(id)a3 withCacheInfoResultHandler:(id /* block */)a4;
...
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)a0 ignoreCaches:(char)a1 requestingBundleId:(id)a2 withCacheInfoResultHandler:(id /* block */)a3;
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)a0 ignoreCaches:(char)a1 withCacheInfoResultHandler:(id /* block */)a2;
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)a0 ignoreCaches:(char)a1 withResultHandler:(id /* block */)a2;
- (void)getSubscriptionEntitlementsIgnoreCaches:(char)a0 forActiveAccountWithResultHandler:(id /* block */)a1;
