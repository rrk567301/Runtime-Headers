...
- (char)isFeedbackEnabledForBundleID:(id)a0;
- (char)isFeedbackEnabledForBundleURL:(id)a0;
- (char)isLaunchScreenEnabledForBundleID:(id)a0;
- (char)isLaunchScreenEnabledForBundleURL:(id)a0;
- (void)setFeedbackEnabled:(char)a0 forVersion:(id)a1 withCompletionHandler:(id /* block */)a2;
- (void)setLaunchInfo:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)setLaunchScreenEnabled:(char)a0 forVersion:(id)a1 withCompletionHandler:(id /* block */)a2;
