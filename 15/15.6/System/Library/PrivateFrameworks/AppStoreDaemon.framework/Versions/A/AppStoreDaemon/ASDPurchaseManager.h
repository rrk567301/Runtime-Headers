...
- (void)adoptionStatus:(char)a0 withReplyHandler:(id /* block */)a1;
...
- (void)renewReceiptForApplicationAtURL:(id)a0 withAppleID:(id)a1 password:(id)a2 forceSandbox:(char)a3 withCompletionHandler:(id /* block */)a4;
