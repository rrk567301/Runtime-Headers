...
+ (char)isLegalEmailAddress:(id)a0;
...
+ (char)addressIsEmptyGroup:(id)a0;
+ (id)displayNameFromAddress:(id)a0;
+ (id)displayNameFromAddress:(id)a0 cacheResults:(char)a1;
+ (id)idnaDecodedAddressForAddress:(id)a0;
+ (id)idnaEncodedAddressForAddress:(id)a0;
+ (void)insertPreviousRoute:(unsigned short *)a0 ofLength:(unsigned long long)a1 toBuffer:(unsigned short **)a2 ofLength:(unsigned long long)a3 atPosition:(unsigned short *)a4 addSpace:(char)a5;
...
+ (id)rawAddressFromFullAddress:(id)a0 cacheResults:(char)a1;
