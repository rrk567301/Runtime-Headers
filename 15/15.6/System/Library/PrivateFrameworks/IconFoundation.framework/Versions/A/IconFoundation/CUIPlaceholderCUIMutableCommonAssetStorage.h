...
@property (nonatomic) char useBitmapIndex;

- (void)dealloc;
- (void)setUuid:(id)a0;
- (id)initWithPath:(id)a0;
- (char)_saveBitmapInfo;
- (void)setEnableLargeCarKeyWorkaround:(char)a0;
...
- (char)removeAssetName:(id)a0;
- (char)removeAssetNameKey:(const void *)a0 withLength:(unsigned long long)a1;
- (void)setAppearanceIdentifier:(unsigned short)a0 forName:(id)a1;
- (char)setAsset:(id)a0 forKey:(id)a1;
- (char)setAsset:(id)a0 forKey:(const void *)a1 withLength:(unsigned long long)a2;
- (void)setAssociatedChecksum:(unsigned int)a0;
- (void)setAuthoringTool:(id)a0;
- (void)setCatalogGlobalData:(id)a0;
- (void)setColor:(struct _rgbquad { unsigned char x0 : 8; unsigned char x1 : 8; unsigned char x2 : 8; unsigned char x3 : 8; })a0 forName:(const char *)a1 excludeFromFilter:(char)a2;
...
- (char)updateBitmapInfo;
- (char)writeToDisk;
- (char)writeToDiskAndCompact:(char)a0;
