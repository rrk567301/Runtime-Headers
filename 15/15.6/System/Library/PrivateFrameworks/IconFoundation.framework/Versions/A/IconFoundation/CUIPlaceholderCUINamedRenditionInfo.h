...
- (char)containsVectorGlyphInterpolationSources;
- (char)containsVectorGlyphWithWeight:(long long)a0 size:(long long)a1;
- (char)contentEqualForAttribute:(int)a0 withRenditionInfo:(id)a1;
- (char)contentPresentForAttribute:(int)a0;
- (void)decrementValue:(long long *)a0 forAttribute:(int)a1;
- (char)diverseContentPresentForAttribute:(int)a0;
...
- (char)isEqualToNamedRenditionInfo:(id)a0;
