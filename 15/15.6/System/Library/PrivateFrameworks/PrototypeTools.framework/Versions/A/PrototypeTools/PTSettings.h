...
+ (char)_supportsArchivingCustomClass:(Class)a0;
+ (char)_supportsArchivingStructType:(id)a0;
...
- (char)_applyArchiveValue:(id)a0 forKeyPath:(id)a1 error:(id *)a2;
- (char)_applyArchiveValue:(id)a0 forLeafKey:(id)a1 error:(id *)a2;
...
- (void)_enumerateLeafValuesWithBlock:(id /* block */)a0;
- (void)_enumerateOutletsWithBlock:(id /* block */)a0;
- (char)_getChild:(id *)a0 create:(char)a1 leafKey:(id *)a2 forKeyPath:(id)a3 error:(id *)a4;
...
- (void)_setObservationEnabled:(char)a0;
