...
@property (nonatomic) char shouldIgnoreInMemoryCaching;
...
- (char)shouldCacheToDiskForSessionTask:(id)a0;
- (void)storeCachedResponseData:(id)a0 forSessionTask:(id)a1;
