...
@property (nonatomic) char alwaysShowIntro;
@property (nonatomic) char contentHasLoaded;
@property (nonatomic) char updatingContent;
@property (nonatomic) char appInBackground;
...
- (void)updateContent;
- (void)networkStateDidChange:(char)a0;
...
- (char)hasLocalVariant:(id)a0;
- (char)isAccessoriesSection:(id)a0;
- (char)isAppleWatchSection:(id)a0;
- (char)isExploreHardwareSection:(id)a0;
- (void)logInvalidSharedTipDisplayed:(id)a0;
- (void)logSharedTipDisplayed:(id)a0 isEligible:(char)a1;
- (id)mainUserGuide;
...
- (id)tipForIdentifier:(id)a0 includingCorrelation:(char)a1;
