...
- (void)fetchWidgetAssetsForDocument:(id)a0 preferCacheIfAvailable:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)updateWidgetDocumentWithDocumentsMap:(id)a0 documentsDeliveryInfoMap:(id)a1 deliveryInfoMap:(id)a2 preferHardwareWelcome:(char)a3 completionHandler:(id /* block */)a4;
- (void)widgetAssetsForDocument:(id)a0 preferCacheIfAvailable:(char)a1 userInterfaceStyle:(long long)a2 completionHandler:(id /* block */)a3;
