...
@property (nonatomic) char dataCacheDirty;
...
@property (nonatomic) char backgroundOriginUpdate;
...
- (char)isDataCacheValid:(id)a0;
- (char)isURLValid:(id)a0;
- (id)newDataCache;
- (void)removeAllDataCache;
- (void)removeCacheForIdentifier:(id)a0;
- (void)removeDataCache:(id)a0;
- (void)removeDataCache:(id)a0 updateCache:(char)a1;
