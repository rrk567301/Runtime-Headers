...
@property (readonly, nonatomic, getter=isChecklist) char checklist;
@property (nonatomic, getter=isTopFeatured) char topFeatured;
@property (nonatomic) char containsIntroTip;
@property (nonatomic) char containsOutroTip;
