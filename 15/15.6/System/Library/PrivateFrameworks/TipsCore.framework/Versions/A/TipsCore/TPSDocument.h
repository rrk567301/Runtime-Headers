...
@property (readonly, nonatomic, getter=isWelcome) char welcome;
@property (readonly, nonatomic, getter=isHardwareWelcome) char hardwareWelcome;
@property (readonly, nonatomic, getter=isSoftwareWelcome) char softwareWelcome;
@property (readonly, nonatomic, getter=isSwitcherWelcome) char switcherWelcome;
