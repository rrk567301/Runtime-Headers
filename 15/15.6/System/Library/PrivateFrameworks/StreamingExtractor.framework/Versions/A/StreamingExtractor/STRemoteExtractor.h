...
@property (nonatomic) char isPrepared;
@property (nonatomic) char isInvalid;
@property (nonatomic) char dataStreamStarted;
@property (nonatomic) char finalBytesSent;
...
@property (readonly, nonatomic) char suppressCompletionsDuringShutdown;
...
- (char)setSourceDirectory:(id)a0 sandboxExtension:(id)a1;
