...
- (id)_episodeForSyncID:(long long)a0 assumeExists:(char)a1;
- (void)_addDeleteChange:(id)a0 syncID:(long long)a1;
- (void)_addInsertOrUpdateEpisodeSyncID:(long long)a0 isInsert:(char)a1 playMetadata:(id)a2;
- (void)_addInsertOrUpdatePlaylistSyncID:(long long)a0 isInsert:(char)a1;
- (void)_addInsertOrUpdateShowSyncID:(long long)a0 isInsert:(char)a1;
- (id)_artworkForSyncID:(long long)a0 cache:(id)a1 artworkLoader:(id /* block */)a2;
- (id)_entityForSyncID:(long long)a0 cache:(id)a1 entityLoader:(id /* block */)a2 assumeExists:(char)a3;
- (id)_episodesForSyncIDs:(id)a0;
- (char)_hasExistingDeleteForSyncID:(long long)a0;
- (char)_hasExistingInsertForSyncID:(long long)a0;
- (char)_hasExistingInsertOrDeleteForSyncID:(long long)a0;
- (char)_hasExistingInsertWithArtworkForShowID:(long long)a0;
