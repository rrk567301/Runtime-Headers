...
- (char)_isAnchorValid:(struct CGPoint { double x0; double x1; })a0;
...
- (void)_updateTargetAreaWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 force:(char)a1;
...
- (unsigned long long)setViewCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 anchor:(struct CGPoint { double x0; double x1; })a1 configuration:(id)a2 force:(char)a3 viewConstraint:(unsigned long long)a4;
- (unsigned long long)setViewCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 anchor:(struct CGPoint { double x0; double x1; })a1 force:(char)a2 viewConstraint:(unsigned long long)a3;
