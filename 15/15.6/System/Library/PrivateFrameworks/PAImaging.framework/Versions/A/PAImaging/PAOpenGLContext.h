...
- (void)drawTextLine:(id)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 flipped:(char)a2;
...
- (void)setupForDrawingInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 flip:(char)a1;
