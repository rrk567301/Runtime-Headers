...
- (void)_allocateBuffer:(long long)a0 clear:(char)a1;
- (int)_calculateBytesPerRow:(long long)a0;
- (void)_makeGLTexture:(struct _CGLContextObject { } *)a0 textureRange:(char)a1;
- (void)allocateBuffer;
...
- (id)initWithSize:(struct PFIntSize_st { unsigned long long x0; unsigned long long x1; })a0 colorSpace:(struct CGColorSpace { } *)a1 opaque:(char)a2 device:(id)a3;
- (id)initWithSize:(struct PFIntSize_st { unsigned long long x0; unsigned long long x1; })a0 colorSpace:(struct CGColorSpace { } *)a1 opaque:(char)a2 flipped:(char)a3 bitsPerComponent:(unsigned long long)a4 internalFormat:(int)a5 format:(unsigned int)a6 type:(unsigned int)a7 device:(id)a8;
- (struct CGContext { } *)newBitmapContext:(long long)a0 colorspace:(struct CGColorSpace { } *)a1 clear:(char)a2;
