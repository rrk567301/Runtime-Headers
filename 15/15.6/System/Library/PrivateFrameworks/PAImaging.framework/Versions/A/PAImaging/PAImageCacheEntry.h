...
@property int format;
@property (nonatomic) char endAccessOnDealloc;
...
- (id)initWithImageRequest:(id)a0 cacheKey:(id)a1 invalidationKey:(id)a2 buffer:(id)a3 scaled:(char)a4 cgImageProperties:(id)a5 colorProfile:(id)a6 masterToRasterOrientation:(long long)a7 rasterToDisplayOrientation:(long long)a8 requestedSubsampleFactor:(unsigned long long)a9 error:(id)a10;
