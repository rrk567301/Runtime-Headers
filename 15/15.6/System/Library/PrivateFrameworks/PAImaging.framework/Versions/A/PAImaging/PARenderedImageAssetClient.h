...
- (void)_imageReady:(id)a0 display:(id)a1 orientation:(struct { long long x0; long long x1; })a2 updateNumber:(long long)a3 isBackfill:(char)a4 zoomImageIsFullExtent:(char)a5;
...
- (void)_notifyDidPrepareRenderForUpdate:(unsigned long long)a0 isCurrent:(char)a1;
...
- (void)compositionChanged:(id)a0 orientation:(struct { long long x0; long long x1; })a1 updateNumber:(long long)a2 isInteractive:(char)a3;
- (void)didChangeEnableHDR;
- (void)didPrepareRenderForUpdate:(unsigned long long)a0 isCurrent:(char)a1;
