...
+ (id)adjustmentForOperation:(id)a0 isForRAW:(char)a1 autoSettingsStorage:(id)a2;
+ (id)compositionKeyForOperationIdentifier:(id)a0;
+ (id)operationForAdjustment:(id)a0 isForRAW:(char)a1 autoSettingsStorage:(id)a2;
+ (id)operationIdentifierForAdjustmentIdentifier:(id)a0;
+ (void)testConversionOnOperation:(id)a0 isForRAW:(char)a1;
+ (void)testConversionOnOperations:(id)a0 isForRAW:(char)a1;
