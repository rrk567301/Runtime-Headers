...
@property (nonatomic) char newUserAccount;
...
+ (id)migratorFromVersion:(id)a0 toVersion:(id)a1 platform:(unsigned long long)a2 newUserAccount:(char)a3;

- (void).cxx_destruct;
- (id)performMigrationForPreferences:(id)a0;
- (id)performMigrationForUserPreferences:(id)a0 systemPreferences:(id)a1;
- (char)previousVersionIsOlderThanMacOS:(id)a0 iOS:(id)a1 watchOS:(id)a2 tvOS:(id)a3;
