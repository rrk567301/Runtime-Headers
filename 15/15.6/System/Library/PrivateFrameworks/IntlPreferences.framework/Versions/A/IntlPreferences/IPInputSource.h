...
@property (readonly, nonatomic) char isInputMode;
@property (readonly, nonatomic) char isChineseHandwriting;
@property (readonly, nonatomic) char isPluginIM;
@property (readonly, nonatomic) char isSystemProvided;
...
@property (readonly, nonatomic) char supportDirectionRightToLeft;
@property (readonly, nonatomic) char allowToChangeEnablingState;
@property (readonly, nonatomic) char shouldGrayOutInputSourceItem;
