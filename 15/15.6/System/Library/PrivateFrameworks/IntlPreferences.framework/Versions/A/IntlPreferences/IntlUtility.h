...
+ (char)isYearlessDate:(id)a0 forCalendar:(id)a1;
...
+ (char)canCapitalizeAutonymForLanguage:(id)a0;
...
+ (id)displayNameForNumberingSystemWithIdentifier:(id)a0 localeIdentifier:(id)a1 short:(char)a2;
...
+ (char)isLunarCalendarDefaultOnForLanguage:(id)a0 locale:(id)a1;
...
+ (id)localeForCalendarID:(id)a0 andLocale:(id)a1 preferredLanguages:(id)a2;
...
- (id)displayNameForLocale:(id)a0 displayLanguage:(id)a1 capitalization:(unsigned long long)a2 short:(char)a3;
...
- (id)displayNameForRegion:(id)a0 displayLanguage:(id)a1 capitalization:(unsigned long long)a2 short:(char)a3;
