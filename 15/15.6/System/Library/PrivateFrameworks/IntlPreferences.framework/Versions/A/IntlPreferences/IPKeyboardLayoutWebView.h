...
@property char isKeyboardLayoutDocumentTrackpadHandwriting;
...
- (char)hasKeyboardLayoutIdentifierForInputSourceID:(id)a0 withOptionalInputSourceLanguageCode:(id)a1;
- (void)loadResource;
