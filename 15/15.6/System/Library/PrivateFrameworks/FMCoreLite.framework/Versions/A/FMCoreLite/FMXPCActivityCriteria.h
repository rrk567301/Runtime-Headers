...
@property (nonatomic) char repeating;
...
- (id)initWithPriority:(long long)a0 repeating:(char)a1 delay:(long long)a2 gracePeriod:(long long)a3 interval:(long long)a4 options:(unsigned long long)a5;
- (id)xpcDictionary;
