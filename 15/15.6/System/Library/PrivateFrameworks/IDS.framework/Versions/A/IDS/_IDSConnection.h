...
- (char)sendInvitation:(id)a0 toDestination:(id)a1 priority:(long long)a2 options:(id)a3 identifier:(id *)a4 error:(id *)a5;
- (id)_activeDevice;
...
- (char)_canServiceNameAcceptMessagesInTransientRegistrationState:(id)a0;
...
- (char)_isDestinationSingleLocalAddress:(id)a0;
...
- (char)_shouldAcceptIncomingType:(id)a0 forTopic:(id)a1 localURI:(id)a2 remoteURI:(id)a3 validateAliases:(char)a4 guid:(id)a5;
...
- (void)connection:(id)a0 incomingAckWithIdentifier:(id)a1 forTopic:(id)a2 toIdentifier:(id)a3 fromIdentifier:(id)a4 hasBeenDeliveredWithContext:(id)a5 isAppAck:(char)a6;
...
- (void)didCancelMessageWithSuccess:(char)a0 onAccount:(id)a1 error:(id)a2 identifier:(id)a3;
...
- (id)initWithAccount:(id)a0 commands:(id)a1 indirectDelegateCallouts:(char)a2 delegateContext:(id)a3;
- (void)messageIdentifier:(id)a0 alternateCallbackID:(id)a1 forAccount:(id)a2 updatedWithResponseCode:(long long)a3 error:(id)a4 lastCall:(char)a5 context:(id)a6;
- (void)messageIdentifier:(id)a0 forTopic:(id)a1 toURI:(id)a2 fromURI:(id)a3 hasBeenDeliveredWithContext:(id)a4;
- (void)messageIdentifierInner:(id)a0 alternateCallbackID:(id)a1 forAccount:(id)a2 updatedWithResponseCode:(long long)a3 error:(id)a4 lastCall:(char)a5 context:(id)a6 isDirectMessage:(char)a7;
...
- (char)sendInvitationUpdate:(id)a0 toDestination:(id)a1 priority:(long long)a2 options:(id)a3 identifier:(id *)a4 error:(id *)a5;
- (char)sendProtobuf:(id)a0 toDestinations:(id)a1 priority:(long long)a2 options:(id)a3 identifier:(id *)a4 error:(id *)a5;
- (char)sendServerMessage:(id)a0 command:(id)a1;
