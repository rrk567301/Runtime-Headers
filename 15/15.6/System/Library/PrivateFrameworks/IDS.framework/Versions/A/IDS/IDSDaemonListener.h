@class NSProtocolChecker, NSString, NSMutableDictionary, NSHashTable, NSData, IDSInternalQueueController, NSObject;
...
- (id)_updateService:(id)a0 withTinkerDevice:(id)a1 shouldAdd:(char)a2 shouldSwitch:(char)a3;
...
- (void)connectionComplete:(char)a0 withResponse:(id)a1;
...
- (unsigned long long)restrictionReasonForService:(id)a0;
