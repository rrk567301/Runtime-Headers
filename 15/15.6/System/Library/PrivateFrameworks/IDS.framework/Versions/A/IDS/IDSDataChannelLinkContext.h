...
@property char directConnectionReady;
...
@property (readonly) char isQUICPod;
...
- (id)initWithAttributes:(struct { unsigned char x0[16]; unsigned char x1[16]; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned short x10; unsigned short x11; unsigned int x12; unsigned int x13; unsigned short x14; unsigned short x15; unsigned short x16; unsigned short x17; char x18; unsigned char x19[16]; unsigned char x20; char x21[16]; unsigned short x22; unsigned char x23; } *)a0 maxBitrate:(unsigned int)a1 relayServerProvider:(long long)a2 relaySessionToken:(id)a3 relaySessionKey:(id)a4 hbhEncryptionkey:(id)a5 hbhDecryptionkey:(id)a6 relayProtocolStackDescription:(id)a7 qrExperiments:(id)a8 estimatedPerPacketConstantOverhead:(unsigned short)a9;
- (id)initWithDummyInformation;
- (void)setDelegateLinkID:(unsigned char)a0;
- (void)setIsVirtualRelayLink:(char)a0;
