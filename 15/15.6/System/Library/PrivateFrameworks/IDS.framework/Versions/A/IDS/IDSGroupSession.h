...
+ (void)keyValueDeliveryForSessionID:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)initWithAccount:(id)a0 destinations:(id)a1 options:(id)a2 delegate:(id)a3 queue:(id)a4;
- (id)initWithAccount:(id)a0 options:(id)a1;
- (id)initWithAccount:(id)a0 options:(id)a1 delegate:(id)a2 queue:(id)a3;
...
- (void)setCallScreeningMode:(char)a0;
- (void)setForceTCPFallbackOnCellUsingReinitiate:(char)a0;
- (void)setForceTCPFallbackOnWiFiUsingReinitiate:(char)a0;
...
- (void)updateMembers:(id)a0 withContext:(id)a1 messagingCapabilities:(id)a2 triggeredLocally:(char)a3;
- (void)updateMembers:(id)a0 withContext:(id)a1 triggeredLocally:(char)a2;
- (void)updateParticipantData:(id)a0 withContext:(id)a1;
- (void)updateParticipantInfo:(id)a0;
- (void)updateParticipantType:(unsigned short)a0 members:(id)a1 withContext:(id)a2 triggeredLocally:(char)a3;
- (void)updateParticipantType:(unsigned short)a0 members:(id)a1 withContext:(id)a2 triggeredLocally:(char)a3 timestamp:(double)a4 identifier:(unsigned long long)a5;
