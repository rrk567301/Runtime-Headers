...
- (void)_noteCanceledFetchForIdentifier:(id)a0 success:(char)a1 error:(id)a2;
- (void)_noteReceivedStopResponseForIdentifier:(id)a0 success:(char)a1 error:(id)a2;
- (void)_noteSentFetchForIdentifier:(id)a0 success:(char)a1 error:(id)a2;
- (void)_noteSentStopForIdentifier:(id)a0 success:(char)a1 error:(id)a2;
