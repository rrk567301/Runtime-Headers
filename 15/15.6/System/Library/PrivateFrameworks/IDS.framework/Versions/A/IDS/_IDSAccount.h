...
@property (readonly, nonatomic) char isInTransientRegistrationState;
@property (readonly, nonatomic) char isTransientAllowlistedAccount;
@property (readonly, nonatomic) char isFirstGDRAllowlistedAccount;
...
- (char)_isInvisibleAlias:(id)a0;
- (char)_isMagnoliaService;
- (char)_isRemoteWidgetService;
