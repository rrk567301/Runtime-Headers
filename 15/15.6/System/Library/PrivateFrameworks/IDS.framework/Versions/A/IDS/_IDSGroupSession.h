...
@interface _IDSGroupSession : NSObject <IDSDaemonListenerProtocol, IDSBaseSocketPairConnectionDelegate> {
    ...
    char _startAsUPlusOneSession;
    char _callScreeningMode;
...
@property (readonly) char isLightweightParticipant;
...
- (void)_setupSession:(id)a0 destinations:(id)a1 options:(id)a2 delegateContext:(id)a3;
...
- (id)initWithAccount:(id)a0 destinations:(id)a1 options:(id)a2 delegateContext:(id)a3 delegate:(id)a4 queue:(id)a5;
...
- (void)session:(id)a0 didReceiveActiveParticipants:(id)a1 success:(char)a2;
- (void)session:(id)a0 didReceiveBlockedParticipantIDs:(id)a1 withCode:(unsigned int)a2 withType:(unsigned short)a3 isTruncated:(char)a4;
...
- (void)session:(id)a0 didReceiveJoinedParticipantID:(unsigned long long)a1 withContext:(id)a2;
- (void)session:(id)a0 didReceiveKeyMaterial:(id)a1;
- (void)session:(id)a0 didReceiveLeftParticipantID:(unsigned long long)a1 withContext:(id)a2;
...
- (void)session:(id)a0 didReceiveParticipantUpdateParticipantID:(unsigned long long)a1 withContext:(id)a2;
- (void)session:(id)a0 didReceiveQueryBlockedParticipantIDs:(id)a1 withCode:(unsigned int)a2 isTruncated:(char)a3;
...
- (void)session:(id)a0 didRemoveParticipantIDs:(id)a1 withCode:(unsigned int)a2 isTruncated:(char)a3;
...
- (void)sessionDidReceiveParticipantUpgrade:(id)a0 participantType:(unsigned short)a1 requestIdentifier:(unsigned long long)a2 error:(id)a3;
