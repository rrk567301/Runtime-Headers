...
@property (nonatomic) char syncOntoMain;
...
@property (nonatomic) char forSyncMessaging;
...
- (id)_initWithQueue:(id)a0 syncOntoMain:(char)a1 takingOverAndResumingConnection:(id)a2 forSyncMessaging:(char)a3;
- (id)initForSyncMessagingWithQueue:(id)a0 takingOverAndResumingConnection:(id)a1;
- (id)initWithQueue:(id)a0 remoteObject:(id)a1;
- (id)initWithQueue:(id)a0 syncOntoMain:(char)a1 takingOverAndResumingConnection:(id)a2;
