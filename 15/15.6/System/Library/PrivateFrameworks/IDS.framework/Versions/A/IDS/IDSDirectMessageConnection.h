@class NSString, _IDSDeviceConnection, IDSServiceProperties, NSMutableDictionary, NSDictionary, IDSDevice, NSMutableArray, NSObject, IMPowerAssertion;
...
@property (nonatomic) char connectionSetupInProgress;
...
@property (nonatomic) char upgradedTrafficClass;
@property (retain, nonatomic) NSString *peerID;
@property (nonatomic) char connectionIsIncoming;
@property (nonatomic) char pendingAckTimerSuspended;
@property (nonatomic) char directMessagingAllowed;
...
@property (nonatomic) char directMessagingSupported;
@property (nonatomic) unsigned int trafficClassToUse;
@property (nonatomic) long long idsPriorityToUse;
@property (nonatomic) char trafficClassInitialized;
@property (nonatomic) long long trafficClassApplied;
@property (nonatomic) char trafficClassTLVProcessed;
@property (nonatomic) char peerIsConnected;
@property (nonatomic) char peerIsNearby;
...
@property (nonatomic) char peerSupportsDeviceConnection;
@property (nonatomic) char conciseACKSupported;
...
+ (char)isDirectMessagingRequested:(id)a0;
...
- (char)canUseDirectMessaging;
- (void)cancelPendingAckTimer;
- (void)clearPowerAssertion;
- (id)createDispatchDataForMessageSend:(id)a0 isAck:(char)a1 ackMessageId:(unsigned int)a2;
...
- (char)isMessageEligible:(id)a0 options:(id)a1 destinationDevice:(id)a2;
