...
- (char)_actionOnAccountOfType:(unsigned long long)a0 onService:(unsigned long long)a1 actionBlock:(id /* block */)a2;
...
- (char)_isServiceCurrentlyEnabled:(id)a0;
- (void)_scheduleValidationAfter:(double)a0 forAccountID:(id)a1 allowFuzz:(char)a2 signOut:(char)a3;
...
- (void)signInUsername:(id)a0 onService:(unsigned long long)a1 waitUntilRegistered:(char)a2 withCompletion:(id /* block */)a3;
- (void)signInUsername:(id)a0 withProvidedCredential:(id)a1 onService:(unsigned long long)a2 waitUntilRegistered:(char)a3 completion:(id /* block */)a4;
