...
+ (char)checkMessageSize:(unsigned long long)a0 priority:(long long)a1;
+ (id)removeSentinelFromAliases:(id)a0;
+ (void)serviceWithIdentifier:(id)a0 commands:(id)a1 manuallyAckMessages:(char)a2 completion:(id /* block */)a3;
...
- (void)setNeedsLaunchOnNearbyDevicesChanged:(char)a0;
- (id)aliases;
...
- (id)initWithService:(id)a0 commands:(id)a1 manuallyAckMessages:(char)a2;
- (id)initWithService:(id)a0 manuallyAckMessages:(char)a1;
...
- (char)needsLaunchOnNearbyDevicesChanged;
...
- (char)sendAheadGroup:(id)a0 priority:(long long)a1 options:(id)a2 identifier:(id *)a3 error:(id *)a4;
...
- (char)sendInvitation:(id)a0 toDestination:(id)a1 options:(id)a2 identifier:(id *)a3 error:(id *)a4;
- (char)sendInvitationUpdate:(id)a0 toDestination:(id)a1 options:(id)a2 identifier:(id *)a3 error:(id *)a4;
- (char)sendMessage:(id)a0 fromAccount:(id)a1 toDestinations:(id)a2 options:(id)a3 identifier:(id *)a4 error:(id *)a5;
...
- (void)setPretendingToBeFull:(char)a0;
