...
@property (readonly, nonatomic) char didMitigate;
...
- (void).cxx_destruct;
- (id)initWithScore:(float)a0 decision:(char)a1 decisionLevel:(double)a2 detailedResults:(id)a3 extractedFeats:(id)a4;
