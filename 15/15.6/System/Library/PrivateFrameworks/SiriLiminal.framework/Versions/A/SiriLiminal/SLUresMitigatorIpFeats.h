...
@property (nonatomic) char didDetectSpeechActivity;
@property (nonatomic) char didDetectVisualActivity;
@property (nonatomic) char didDetectGazeAtOrb;
@property (nonatomic) char didDetectAttention;
@property (nonatomic) char isAirpodsConnected;
...
@property (nonatomic) char isConversational;
