...
- (char)_shouldPerformFullReloadForFeedEntriesChangeNotifications:(id)a0 commentsChangeNotifications:(id)a1;
...
- (char)hasEnoughCloudFeedAssetEntriesToDisplay;
...
- (char)reconfigureToIncludeCloudFeedEntry:(id)a0;
