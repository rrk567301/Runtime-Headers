...
+ (void)_handleResult:(id /* block */)a0 success:(char)a1 error:(id)a2;
...
+ (void)performSwipingInScrollView:(id)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 count:(long long)a2 speed:(unsigned long long)a3 direction:(long long)a4 roundTrip:(char)a5 completionHandler:(id /* block */)a6;
+ (id)swipeSpeedFactor:(unsigned long long)a0;
