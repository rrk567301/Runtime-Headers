...
@property (readonly, nonatomic) char shouldPresentNaming;
@property (readonly, nonatomic) char shouldPresentPostNaming;
@property (nonatomic) unsigned long long namingResultType;
@property (readonly, nonatomic) char hasNextViewController;
@property (readonly, nonatomic) UXViewController<PXPeopleFlowViewController> *nextViewController;
@property (readonly, nonatomic) char hasPreviousViewController;
...
- (char)shouldPresentConfirmationForPerson:(id)a0;
