...
@property (nonatomic, getter=hasRequestedSuggestedPerson) char requestedSuggestedPerson;
@property (nonatomic, getter=hasRequestedMeContact) char requestedMeContact;
