...
@interface PXEngineDrivenAssetsTilingLayout : PXAssetsTilingLayout {
    ...
    struct { char respondsToEngineDrivenLayoutReferenceSizeDidChange; char respondsToEngineDrivenLayoutAspectRatioForItemAtIndexPath; char respondsToEngineDrivenLayoutZPositionForItemAtIndexPath; char respondsToEngineDrivenLayoutContentsRectForItemAtIndexPathForAspectRatio; char respondsToEngineDrivenLayoutPlayButtonSizeForItemAtIndexPathForAspectRatio; } _delegateFlags;
}
...
- (char)getAdditionalTileIdentifier:(struct PXTileIdentifier { unsigned long long x0; unsigned long long x1[10]; } *)a0 group:(unsigned long long *)a1 layoutGeometryKind:(unsigned long long)a2 indexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a3;
