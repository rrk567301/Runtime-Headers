...
@interface PXStoryClipKenBurnsEffectFactory : NSObject {
    ...
    struct NSEdgeInsets { double x0; double x1; double x2; double x3; } *_clipSafeAreaInsets;
    ...
    char _shouldFitSourceAndTargetIndependently;
...
+ (void)genericFactoryForSpec:(id)a0 assetContentSize:(struct CGSize { double x0; double x1; })a1 handler:(id /* block */)a2;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })assetRectForClipIndex:(long long)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })clipFrameForClipIndex:(long long)a0;
...
- (void)getParameters:(out struct { struct { struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x0; } x0; struct { struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x0; } x1; } *)a0 forVerticallyPanningPreferredRectMovingTowardsVerticalEdge:(unsigned int)a1;
