...
- (id)description;
- (void).cxx_destruct;
- (id)initWithImage:(id)a0 assetObjectID:(id)a1 assetLocalIdentifier:(id)a2 faceRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 isCropped:(char)a4 isDegraded:(char)a5 options:(id)a6;
