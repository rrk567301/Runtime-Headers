...
@interface PXCuratedLibraryAssetsDataSourceManager : PXAssetsDataSourceManager <PXCuratedLibraryMutableAssetsDataSourceManager, PXAssetsDataSourceManagerObserver> {
    struct { char isSelectingAssets; char visibleAssetCollections; char willTransitionFromZoomLevelToZoomLevel; char didTransitionFromZoomLevelToZoomLevel; char dominantAssetCollectionReferenceForZoomLevel; char transitionTypeFromZoomLevelToZoomLevel; } _delegateRespondsTo;
    NSDictionary *_dataSourceManagerByZoomLevel;
    char _isForcingSections;
...
@property (nonatomic) char canLoadData;
...
@property (readonly, nonatomic) char canIncludeUnsavedSyndicatedAssets;
@property (readonly, nonatomic) char enableDays;
...
- (char)forceAccurateSectionsIfNeeded:(id)a0 inZoomLevel:(long long)a1;
- (char)forceAllPhotosAccurateIfNeeded;
...
- (void)setCanIncludeUnsavedSyndicatedAssets:(char)a0;
