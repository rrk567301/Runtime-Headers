@class PXExtendedTraitCollection, NSColor, PXLayoutMetricInterpolator;
...
@property (readonly, nonatomic) char shouldInsetAllContent;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } layoutInsets;
@property (readonly, nonatomic) double fixedColumnWidth;
@property (readonly, nonatomic) char shouldUseAccessibilityLayout;
@property (readonly, nonatomic) NSColor *backgroundColor;
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } accessoryViewInset;

+ (double)sectionHeaderHeightForStyle:(unsigned long long)a0 dividerHidden:(char)a1;
+ (double)sectionHeaderTitleBottomSpacingForStyle:(unsigned long long)a0;
+ (double)sectionHeaderTitleHeightForStyle:(unsigned long long)a0 dividerHidden:(char)a1;
+ (double)sectionHeaderTopSpacingForStyle:(unsigned long long)a0;

- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })acccessoryViewInsetForTraitCollection:(id)a0;
...
- (char)isEqualToGadgetSpec:(id)a0;
- (char)shouldInsetContentForTraitCollection:(id)a0;
