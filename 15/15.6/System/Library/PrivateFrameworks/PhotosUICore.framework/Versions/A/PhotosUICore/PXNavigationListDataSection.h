...
- (id)initWithCollectionsDataSection:(id)a0 indentationLevel:(long long)a1 childDataSections:(id)a2 childIndexHints:(id)a3 skipAssetCountFetches:(char)a4;
