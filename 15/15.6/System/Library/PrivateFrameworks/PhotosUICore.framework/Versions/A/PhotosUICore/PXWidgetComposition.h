...
@interface PXWidgetComposition : PXTilingControllerComposition <PXWidgetCompositionElementObserver, PXWidgetCompositionElementDelegate, PXScrollViewControllerObserver> {
    struct { char respondsToHasContentAbove; char respondsToShouldUseEdgeToEdgeLayoutForWidget; char respondsToLoadingPriorityForWidget; char respondsToWidgetTransitionToViewControllerWithTransitionType; char respondsToRequestViewControllerDismissalAnimated; char respondsToDidUpdateCompositionWithDefaultAnimationOptions; char respondsToPresentationEnvironment; } _delegateFlags;
    char _isPerformingWidgetLoadingChange;
    struct { char elementsToLoad; } _needsUpdateFlags;
}
...
@property (nonatomic, setter=_setDidLayoutWidgets:) char _didLayoutWidgets;
...
@property (nonatomic) char shouldLoadVisibleWidgets;
@property (nonatomic) char shouldLoadAllWidgets;
@property (nonatomic) char shouldUnloadAllWidgets;
...
- (char)_shouldFocusOnTilingController:(id)a0;
...
- (char)_shouldUseEdgeToEdgeLayoutForWidget:(id)a0;
...
- (char)element:(id)a0 requestViewControllerDismissalAnimated:(char)a1;
- (char)element:(id)a0 transitionToViewController:(id)a1 withTransitionType:(long long)a2;
