...
@property (nonatomic) char hasFace;
@property (nonatomic) char hasVoice;
@property (nonatomic) char hasMusic;
...
- (id)initWithTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 score:(float)a1 bestPlaybackRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 normalizationData:(id)a3 face:(char)a4 voice:(char)a5 music:(char)a6 loudness:(float)a7 peak:(float)a8 audioScore:(float)a9;
