...
@property (nonatomic) char isAssetCollectionFinal;
...
@property (readonly, nonatomic) char shouldAvoidSynchronousProductions;
@property (retain, nonatomic) id<PXStoryAssetsProducer> assetsProducer;
@property (readonly, nonatomic) char requiresAssetsSynchronously;
...
@property (readonly, nonatomic) char requiresPersistableRecipeSynchronously;
...
@property (nonatomic) char hasInitialPersistableRecipeBeenProduced;
@property (retain, nonatomic) id<PXStorySongsProducer> curatedSongsProducer;
@property (readonly, nonatomic) char requiresSongsSynchronously;
...
@property (readonly, nonatomic) char requiresMovieHighlightsSynchronously;
...
@property (nonatomic) char haveFinalMovieHighlightsBeenProduced;
...
@property (readonly, nonatomic) char requiresDetailedSaliencySynchronously;
...
@property (nonatomic) char hasFinalDetailedSaliencyBeenProduced;
@property (retain, nonatomic) id<PXStoryChapterCollectionProducer> chapterCollectionProducer;
@property (readonly, nonatomic) char requiresChapterCollectionSynchronously;
...
@property (nonatomic) char hasFinalChapterCollectionBeenProduced;
...
@property (readonly, nonatomic) char requiresInitialStyleSynchronously;
...
@property (nonatomic) char hasInitialStyleBeenProduced;
@property (retain, nonatomic) id<PXStoryStylesProducer> autoEditStylesProducer;
@property (readonly, nonatomic) char requiresAutoEditStylesSynchronously;
...
@property (readonly, nonatomic) char requiresAutoEditDecisionListsSynchronously;
...
@property (readonly, nonatomic) char wantsAutoEditResults;
...
@property (readonly, nonatomic) char isRecipeFinal;
...
- (void)_applyManuallyCuratedAssets:(id)a0 setAsCustomUserAssets:(char)a1;
