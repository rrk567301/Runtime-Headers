...
+ (id)locKeyForHasHumans:(char)a0 hasPets:(char)a1 key:(id)a2;
+ (id)_daysDictionary;
+ (id)peopleArrayFromFastEnumeration:(id)a0;
+ (char)_hasRecentlyHandledBootstrapOrSuggestionForPerson:(id)a0;
+ (char)_isPhotosProcess;
...
+ (char)canShowSuggestionForPerson:(id)a0;
...
+ (char)isDetectionTypeHuman:(short)a0;
+ (char)isFavoritePerson:(id)a0;
+ (char)isGreenTeaAndContactsAccessDenied;
+ (char)isPersonHiddenFromPeopleHome:(id)a0;
...
+ (char)mergePersons:(id)a0 withPerson:(id)a1;
+ (void)people:(id)a0 hasHumans:(char *)a1 hasPets:(char *)a2;
...
+ (char)shouldShowBootstrapForPerson:(id)a0;
+ (char)shouldShowBootstrapForPerson:(id)a0 context:(id)a1;
