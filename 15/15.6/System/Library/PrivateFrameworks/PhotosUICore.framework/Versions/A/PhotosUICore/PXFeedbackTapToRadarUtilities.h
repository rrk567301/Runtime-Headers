...
+ (void)fileRadarWithTitle:(id)a0 description:(id)a1 classification:(id)a2 componentID:(id)a3 componentName:(id)a4 componentVersion:(id)a5 keyword:(id)a6 attachmentURLs:(id)a7 includeSysDiagnose:(char)a8 completionHandler:(id /* block */)a9;
+ (void)fileRadarWithTitle:(id)a0 description:(id)a1 classification:(id)a2 componentID:(id)a3 componentName:(id)a4 componentVersion:(id)a5 keyword:(id)a6 screenshotURLs:(id)a7 attachmentURLs:(id)a8 includeSysDiagnose:(char)a9 includeInternalRelease:(char)a10 additionalExtensionIdentifiers:(id)a11 completionHandler:(id /* block */)a12;
