...
- (char)shouldEnableActionType:(id)a0 onAsset:(id)a1;
...
- (char)canPerformAssetVariationActions;
- (void)registerPerformerClass:(Class)a0 forType:(id)a1;
- (void)_handleActionPerformerComplete:(id)a0 success:(char)a1 error:(id)a2;
