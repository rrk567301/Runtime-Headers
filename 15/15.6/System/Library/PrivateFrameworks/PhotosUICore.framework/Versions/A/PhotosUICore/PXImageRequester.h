...
@interface PXImageRequester : PXObservable <PXMutableImageRequester, PXRegionOfInterestImage> {
    struct { char targetSize; char imageRequest; char isInCloud; } _needsUpdateFlags;
}
...
@property (nonatomic, setter=_setHasFullQuality:) char hasFullQuality;
@property (nonatomic, setter=_setIsInCloud:) char isInCloud;
