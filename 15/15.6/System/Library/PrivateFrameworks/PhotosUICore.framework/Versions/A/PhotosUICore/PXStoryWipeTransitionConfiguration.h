...
@interface PXStoryWipeTransitionConfiguration : NSObject {
    ...
    struct { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; char x3; unsigned long long x4; struct CGPoint { double x0; double x1; } x5; } *_primaryDividerInfos;
    struct { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; char x3; unsigned long long x4; struct CGPoint { double x0; double x1; } x5; } *_secondaryDividerInfos;
    long long _capacity;
    long long _count;
}
