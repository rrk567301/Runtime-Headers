...
@property (readonly, nonatomic) NSColor *feedBackgroundColor;
@property (readonly, nonatomic) NSColor *selectionHighlightColor;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } feedEntryEdgeInsets;
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } layoutInsets;
@property (readonly, nonatomic) char feedShouldAllowHeaders;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } favoriteBadgeInset;
@property (readonly, nonatomic) struct CGPoint { double x; double y; } highlightedSectionHeaderOffset;
@property (readonly, nonatomic) char shouldRemoveHighlightOnScroll;
@property (readonly, nonatomic) double bottomShadowPadding;
@property (readonly, nonatomic) double feedAdditionalContentThreshold;
@property (readonly, nonatomic) NSFont *tabTitleFont;
@property (readonly, nonatomic) NSColor *tabTitleTextColor;
