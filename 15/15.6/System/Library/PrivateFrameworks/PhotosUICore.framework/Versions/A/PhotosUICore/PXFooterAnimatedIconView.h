...
@property (nonatomic) char isPlayerHidden;
@property (nonatomic) char isPlayerPaused;
@property (nonatomic) char wantsGridCycleTimeObservation;
@property (nonatomic) long long style;
@property (readonly, nonatomic) char isObscured;
