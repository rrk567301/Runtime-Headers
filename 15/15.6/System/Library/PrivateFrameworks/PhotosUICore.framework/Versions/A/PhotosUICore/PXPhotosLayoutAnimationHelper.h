...
@property (readonly, nonatomic) char wantsFromSnapshot;
@property (readonly, nonatomic) char wantsToSnapshot;
@property (readonly, nonatomic) char wantsPresentationAdjustment;
@property (readonly, nonatomic) char wantsDoubleSidedAnimations;
@property (readonly, nonatomic) char wantsAnimationWithSpriteTransfer;
