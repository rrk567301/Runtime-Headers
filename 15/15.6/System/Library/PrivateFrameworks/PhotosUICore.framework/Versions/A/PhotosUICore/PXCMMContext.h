@class NSDate, NSString, NSArray, PXCMMActionManager, PXAssetsDataSourceManager, PXUIMediaProvider, NSDictionary, PXRecipient, PXPeopleSuggestionsDataSourceManager;
...
@property (nonatomic) char hideActionMenu;
@property (nonatomic) char disableOneUp;
...
@property (nonatomic) char ppt_presentComposeRecipientView;
@property (nonatomic) char ppt_scrollComposeRecipientsView;
