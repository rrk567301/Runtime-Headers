...
@property (readonly, nonatomic) char useSaliency;
...
- (id)initWithExtendedTraitCollection:(id)a0 options:(unsigned long long)a1 availableThumbnailSizes:(id)a2 gridStyle:(long long)a3 itemAspectRatio:(double)a4 userDefaults:(id)a5 forceSaliency:(char)a6 preferredUserInterfaceStyle:(long long)a7 additionalAspectFitEdgeMargins:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a8 overrideDefaultNumberOfColumns:(long long)a9;
