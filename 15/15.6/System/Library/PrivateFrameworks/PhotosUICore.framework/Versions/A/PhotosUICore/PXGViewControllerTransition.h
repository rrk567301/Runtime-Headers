...
@property (readonly, nonatomic) char isVerticalOnly;
...
+ (id)_transitionWithDetailViewController:(id)a0 createIfNeeded:(char)a1 verticalOnly:(char)a2;
...
- (void)setIsVerticalOnly:(char)a0;
