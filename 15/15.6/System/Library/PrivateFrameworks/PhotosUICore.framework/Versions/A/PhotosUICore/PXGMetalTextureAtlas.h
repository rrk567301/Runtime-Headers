...
@property (readonly) char isUnused;
...
@property (readonly, nonatomic) char mipmapped;
@property (nonatomic) char mipmapsDirty;
...
- (id)initWithThumbnailSize:(struct CGSize { double x0; double x1; })a0 pixelFormat:(unsigned long long)a1 capacity:(unsigned int)a2 mipmapped:(char)a3 colorProgram:(id)a4 context:(id)a5 layoutQueue:(id)a6;
