...
@property (nonatomic) char isPreloaded;
...
- (void)focusOnGeotaggablesAnimated:(char)a0;
- (void)focusOnMapRect:(struct { struct { double x0; double x1; } x0; struct { double x0; double x1; } x1; })a0 animated:(char)a1;
- (void)focusOnProvidedAssetsAnimated:(char)a0;
