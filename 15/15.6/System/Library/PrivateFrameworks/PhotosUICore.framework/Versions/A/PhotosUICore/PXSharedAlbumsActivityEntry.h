...
@property (readonly, nonatomic) char cloudOwnerIsAllowlisted;
...
+ (id)_activitiesFromCloudFeedEntries:(id)a0 inMostRecentOrder:(char)a1 photoLibrary:(id)a2 plPhotoLibrary:(id)a3;
+ (id)_assetsAddedActivitiesFromCloudFeedAssetsEntry:(id)a0 inMostRecentOrder:(char)a1 inAlbum:(id)a2 photoLibrary:(id)a3;
...
- (id)debugDescription;
- (void).cxx_destruct;
- (id)initWithPhotoLibrary:(id)a0 uuid:(id)a1 date:(id)a2 type:(long long)a3 isFromMe:(char)a4 contributors:(id)a5 avatarConfigurations:(id)a6 albumGUID:(id)a7 albumName:(id)a8 cloudOwnerIsAllowlisted:(char)a9 message:(id)a10 keyAssetUUIDs:(id)a11 keyAssets:(id)a12 relatedCommentUUID:(id)a13 relatedUUIDs:(id)a14 underlyingObject:(id)a15;
