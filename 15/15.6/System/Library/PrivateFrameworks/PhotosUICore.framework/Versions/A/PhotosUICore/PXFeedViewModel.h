...
@property (readonly, nonatomic) char wantsEmbeddedScrollView;
...
- (id)initWithDataSourceManager:(id)a0 specManager:(id)a1 itemLayoutFactory:(id)a2 placeholderFactory:(id)a3 wantsEmbeddedScrollView:(char)a4 visibleRectChangeObserver:(id /* block */)a5;
