...
@interface PXStoryConcreteSubtimelineScanner : NSObject {
    ...
    char _firstDisplayAssetIsSameAsKey;
...
@property (readonly, nonatomic) char isAtBeginning;
...
- (void)_addTitles:(unsigned long long)a0 toTimeline:(id)a1;
