...
@interface PXAssetsSectionLayout : PXGSplitLayout <PXChangeObserver, PXGShadowSource, PXGViewSource, PXGDisplayAssetSource, PXGGeneratedLayoutDelegate, PXGItemsLayoutDelegate, PXCuratedLibraryRowBasedLayout> {
    ...
    char _isUpdatingLocalSprites;
    char _showAllButtonConfigurationIsValid;
    char _selectAllButtonConfigurationIsValid;
...
@property (nonatomic) char isLastSection;
@property (nonatomic) char allowsPositionDependentHeaderContentOpacity;
...
@property (readonly, nonatomic) char presentedSkimming;
...
@property (nonatomic) char automaticallyUpdatesPadding;
...
@property (nonatomic) char itemCaptionsVisible;
...
@property (nonatomic) char disableConfigurators;
@property (nonatomic) char isSelecting;
@property (nonatomic) char canStartSelecting;
@property (nonatomic) long long numberOfPrecedingAssets;
@property (nonatomic) char wantsShadow;
...
@property (nonatomic, getter=isFaceModeEnabled) char faceModeEnabled;
...
@property (nonatomic) char removesHeaderLayoutWhenEmpty;
@property (nonatomic) char removesContentLayoutWhenEmpty;
@property (retain, nonatomic) NSString *axLocalizedBaseLabel;
@property (nonatomic) char showsSkimmingSlideshow;
@property (nonatomic) char showsSkimmingInteraction;
...
+ (struct CGSize { double x0; double x1; })estimatedSizeWithReferenceSize:(struct CGSize { double x0; double x1; })a0 assetCollection:(id)a1 numberOfAssets:(long long)a2 isCurated:(char)a3 zoomLevel:(long long)a4 spec:(id)a5;
...
- (char)_shouldAnchorOnAssetCollection;
...
- (void)setBodyContentLayout:(id)a0 wantsDecoration:(char)a1;
