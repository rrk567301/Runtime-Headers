...
@interface PXGadgetDataSourceManager : PXSectionedDataSourceManager <PXGadgetProviderDelegate, PXGadgetDelegate> {
    ...
    char _dataSourceNeedsUpdate;
}

@property (class, readonly) NSObject<OS_os_log> *gadgetDataSourceManagerLog;

@property (copy, nonatomic) NSArray *cachedProviders;
@property (nonatomic) char hasLoadedPriorities;
@property (nonatomic) char loadingInitialGadgets;
@property (nonatomic) char needsToLoadAllProviders;
...
@property (readonly, nonatomic) char didLoadRemainingGadgets;
@property (nonatomic) char canLoadRemainingDataForProviders;
...
- (void)dismissGadgetViewController:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
...
- (char)gadget:(id)a0 transitionToViewController:(id)a1 animated:(char)a2 completion:(id /* block */)a3;
...
- (void)presentGadgetViewController:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
