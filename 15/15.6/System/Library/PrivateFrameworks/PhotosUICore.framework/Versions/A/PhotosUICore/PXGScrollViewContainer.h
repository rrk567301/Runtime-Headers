...
@interface PXGScrollViewContainer : NSView <PXChangeObserver, PXScrollViewControllerObserver, PXGReusableView> {
    struct { char willBeginScrolling; char didScroll; char willEndScrollingWithVelocityTargetContentOffsetCurrentContentOffset; char didEndScrolling; char focusItemsInRect; } _delegateRespondsTo;
    char _isUpdatingScrollViewController;
}

@property (readonly, nonatomic) PXUpdater *updater;
@property (readonly, nonatomic) PXScrollViewSpeedometer *speedometer;
@property (readonly, nonatomic) char isRTL;
@property (readonly, nonatomic) char shouldFlipContentOffset;
