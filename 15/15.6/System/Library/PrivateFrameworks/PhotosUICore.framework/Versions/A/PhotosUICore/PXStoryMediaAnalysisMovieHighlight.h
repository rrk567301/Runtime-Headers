@class NSData, NSDictionary, NSCache;
...
@property (readonly, nonatomic) char hasVoice;
@property (readonly, nonatomic) char hasFace;
@property (readonly, nonatomic) char hasMusic;
...
+ (id)defaultHighlightFromMediaAnalysis:(id)a0 timeRangeCache:(id)a1;
...
+ (id)fullMovieFromMediaAnalysis:(id)a0 timeRangeCache:(id)a1;
+ (id)livePhotoFromMediaAnalysis:(id)a0 timeRangeCache:(id)a1;
+ (id)movieHighlightsFromMediaAnalysis:(id)a0 timeRangeCache:(id)a1;
+ (id)movieSummaryFromMediaAnalysis:(id)a0 timeRangeCache:(id)a1;

- (id)description;
- (id)init;
- (void).cxx_destruct;
- (char)hasFaceInRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
- (id)analysisResults;
...
- (id)faceResults;
- (char)hasMusicInRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
- (char)hasVoiceInRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
- (id)initWithMediaAnalysis:(id)a0 movieHighlightIndex:(long long)a1 timeRangeCache:(id)a2;
