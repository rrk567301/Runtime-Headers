...
@property (nonatomic) char canDisplayLoadingIndicator;
@property (nonatomic) char isDisplayingFullQualityContent;
@property (nonatomic) char disableImageRequestsOnResize;
...
@property (nonatomic, getter=isAnimatedContentEnabled) char animatedContentEnabled;
@property (nonatomic) char toneMapVideoToStandardDynamicRange;
