...
@property (class, nonatomic) char forceAccessibilityEnabled;
...
@property (nonatomic) char isFocusFastScrolling;
@property (nonatomic) char isAnimatingScrollTowardsEdge;
...
@property (nonatomic) char isAccessibilityEnabled;
@property (nonatomic) char isSceneResumingFromBackground;
...
@property (readonly, nonatomic) char hasExtendedColorDisplay;
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } hitTestPadding;
@property (nonatomic) char showDebugHUD;
@property (nonatomic) char showPerspectiveDebug;
...
@property (nonatomic) char contentShouldBeObscured;
@property (nonatomic) unsigned long long offscreenEffectQuality;
@property (nonatomic) char shouldScrollViewContentInsetAlwaysAdjustToAvoidSafeArea;
@property (nonatomic) char shouldReleaseResourcesWhenInvisible;
@property (nonatomic) char shouldWorkaround18475431;
@property (nonatomic) char resizesDrawableManually;
...
@property (nonatomic) char isBeingFullPageSnapshotted;
@property (nonatomic) char avoidSnapshotOnHeightChanges;
@property (nonatomic) char managesScrollableAxisExternally;
@property (retain, nonatomic) PXGLayout *rootLayout;
@property (nonatomic) char lowMemoryModeEnabled;
@property (nonatomic) char enableUnderlaySupport;
...
- (char)exportDebugHierarchyToURL:(id)a0 error:(id *)a1;
- (id)feedHitTestResultAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (id)feedHitTestResultAtPoint:(struct CGPoint { double x0; double x1; })a0 ignoringOverlayContent:(char)a1;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 allowedPresentationTypes:(id)a1 displayConfiguration:(struct { char x0; unsigned long long x1; unsigned long long x2; })a2;
- (void)installAnimationRenderingCompletionHandler:(id /* block */)a0;
- (void)installRenderingCompletionHandler:(id /* block */)a0;
- (char)isObjectReference:(id)a0 visuallyBeforeObjectReference:(id)a1;
- (id)layout:(id)a0 viewForSpriteIndex:(unsigned int)a1;
- (void)notifyContentFullyLoadedWithTimeout:(double)a0 block:(id /* block */)a1;
- (void)ppt_cleanUpAfterTest:(id)a0 isScrollTest:(char)a1;
- (void)ppt_prepareForTest:(id)a0 withOptions:(id)a1 isScrollTest:(char)a2;
