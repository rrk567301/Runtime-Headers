...
@interface PXPhotosLayout : PXGStackLayout <PXChangeObserver, PXPhotosSectionHeaderLayoutProviderInvalidationDelegate, PXGStringSource, PXGNamedImageSource, PXScrollablePageSource, PXGSolidColorSource, PXGStackLayoutSublayoutAlignmentDelegate, PXGItemPlacementController> {
    ...
    char _managesHeaderSprites;
    char _managesOnlyLegibilityGradientSprites;
    char _presentedVisibility;
    PXPhotosSectionedLayout *_sectionedLayout;
    char _footerHasAppearedInitially;
    ...
    char _topHeaderLayoutShouldFloat;
    NSString *_dynamicDateInterval;
    NSString *_dynamicLocationName;
    struct { char createTopHeaderLayoutForDataSource; char topHeaderLayoutDidChangeDataSource; char configureTopHeaderLayout; } _headerProviderRespondsTo;
}
...
@property (nonatomic, readonly) char canScrollToInitialPosition;
...
@property (nonatomic) char wantsHeaderInSafeArea;
@property (nonatomic) char alignsHeaderTitleWithLayoutMargins;
...
- (void)_invalidateHeaderAnimated:(char)a0;
...
- (char)stackLayout:(id)a0 shouldAlignSublayoutToVisibleBottomEdge:(id)a1;
- (char)stackLayout:(id)a0 shouldAlignSublayoutToVisibleTopEdge:(id)a1;
