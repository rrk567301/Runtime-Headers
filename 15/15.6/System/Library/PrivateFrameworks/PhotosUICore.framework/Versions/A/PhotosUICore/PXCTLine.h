...
@property (readonly, nonatomic, getter=isEndOfString) char endOfString;
...
- (id)initWithLine:(struct __CTLine { } *)a0 origin:(struct CGPoint { double x0; double x1; })a1 frame:(id)a2 referenceAttributedString:(id)a3 truncated:(char)a4;
