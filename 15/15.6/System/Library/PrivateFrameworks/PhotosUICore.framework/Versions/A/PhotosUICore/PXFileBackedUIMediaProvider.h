...
@property (readonly, nonatomic, getter=isCachingEnabled) char cachingEnabled;
...
- (id)initWithCachingEnabled:(char)a0;
...
- (id)_resizeImageAtURL:(id)a0 imageUTI:(id)a1 targetSize:(struct CGSize { double x0; double x1; })a2 preferHDR:(char)a3 bakeInOrientation:(char)a4 error:(id *)a5;
