...
@property (class, nonatomic) char shouldDisableLaunchOptimizations;

@property (nonatomic) char isInitialLoad;
@property (nonatomic) char performedInitialLoad;
...
- (char)allowsSublayoutUpdateCycleAssertions;
...
- (char)layout:(id)a0 shouldPreventFaultOutOfSublayout:(id)a1;
...
- (char)prefersDominantHeroForZoomLevel:(long long)a0;
...
- (void)setPrefersDominantHero:(char)a0 forZoomLevel:(long long)a1;
