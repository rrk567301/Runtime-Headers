@class PXAssetCollectionReference, PXPhotosEnvironmentReference, PXAssetsDataSourceManager, PXDisplayTitleInfo, PHAssetCollection, PXAssetReference, NSDictionary, PHFetchResult;
