...
@property (readonly, nonatomic) char isDaysMonthsYearsStructureEnabled;
@property (readonly, nonatomic) char isDevicePlugged;
...
- (void)setIsDaysMonthsYearsStructureEnabled:(char)a0;
- (void)setIsDevicePlugged:(char)a0;
