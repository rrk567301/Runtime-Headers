...
- (void)_handleDownloaderFinishedForAsset:(id)a0 success:(char)a1 error:(id)a2;
- (void)_queue_cancelRequest:(long long)a0;
- (void)_queue_handleDownloaderFinishedForAsset:(id)a0 success:(char)a1 error:(id)a2;
