...
- (char)addAudioFromVideoHighlightAsset:(id)a0 fromTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 atStoryTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 volume:(float)a3 fadeIn:(double)a4 fadeOut:(double)a5 shouldDuck:(char)a6 error:(id *)a7;
- (char)addMusicAsset:(id)a0 withAudioMix:(id)a1 preferredVolume:(float)a2 error:(id *)a3;
