...
- (void)_handleAssetQueryCallbackWithAsset:(id)a0 error:(id)a1 userInitiated:(char)a2;
- (void)_handleInstallMobileAssetCallbackWithAsset:(id)a0 UTI:(id)a1 codecName:(id)a2 completionHandler:(id /* block */)a3;
- (void)_installMobileAssetAsUserInitiated:(char)a0 timeout:(double)a1 completionHandler:(id /* block */)a2;
