...
@property (readonly, nonatomic) char inGridViewMode;
@property (nonatomic) char shouldScrollGridToPlaybackPosition;
...
- (char)photosViewController:(id)a0 didPickAssetReference:(id)a1;
...
- (char)photosContentController:(id)a0 presentViewController:(id)a1;
- (char)photosContentController:(id)a0 pushViewController:(id)a1;
