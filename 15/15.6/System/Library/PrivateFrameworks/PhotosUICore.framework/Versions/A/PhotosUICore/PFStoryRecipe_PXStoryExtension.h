...
+ (char)_recipe:(id)a0 isReferencingPHPhotoLibrary:(id)a1;
+ (char)_recipe:(id)a0 setPHPhotoLibrary:(id)a1 error:(id *)a2;
+ (char)addDisplayAssets:(id)a0 toRecipe:(id)a1 withCategory:(long long)a2 error:(id *)a3;
+ (char)addPHAssets:(id)a0 toRecipe:(id)a1 withCategory:(long long)a2 error:(id *)a3;
+ (char)addSyntheticAssets:(id)a0 toRecipe:(id)a1 withCategory:(long long)a2 error:(id *)a3;
...
+ (char)recipeContainsAnyDisplayAsset:(id)a0;
