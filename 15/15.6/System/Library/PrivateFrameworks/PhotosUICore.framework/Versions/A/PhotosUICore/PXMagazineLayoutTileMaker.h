...
- (char)_generateTilesWithInputs:(id)a0 atIndex:(unsigned long long)a1 forMaxY:(unsigned long long)a2 reserveNumberForPadding:(unsigned long long)a3 outArray:(id)a4;
