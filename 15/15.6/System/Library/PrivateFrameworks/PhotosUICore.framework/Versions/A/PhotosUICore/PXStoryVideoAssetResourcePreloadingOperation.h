...
@property (readonly, nonatomic) char isExporting;
@property (readonly, nonatomic) char isInline;
...
- (id)initWithVideoAssetResource:(id)a0 mediaProvider:(id)a1 downloadTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 videoSessionManager:(id)a3 isExporting:(char)a4 isInline:(char)a5;
- (void)px_start;
