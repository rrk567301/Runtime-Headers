...
@property (readonly, nonatomic) char allowsResourceDownload;
@property (readonly, nonatomic) char exportAsMaster;
@property (readonly, nonatomic) char stripLocation;
...
+ (char)assetRequiresFullSize:(id)a0;
+ (id)dataForObject:(id)a0 exportAsMaster:(char)a1 stripLocation:(char)a2;
+ (id)dataForObject:(id)a0 exportAsMaster:(char)a1 stripLocation:(char)a2 allowsResourceDownload:(char)a3;
...
- (id)initWithAsset:(id)a0 exportAsMaster:(char)a1 stripLocation:(char)a2 allowsResourceDownload:(char)a3;
