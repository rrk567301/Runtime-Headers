...
- (double)costForFittingLayoutItemInputs:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 ofTotalItemCount:(long long)a2 normalizedWeights:(in double *)a3 useSaliency:(char)a4;
