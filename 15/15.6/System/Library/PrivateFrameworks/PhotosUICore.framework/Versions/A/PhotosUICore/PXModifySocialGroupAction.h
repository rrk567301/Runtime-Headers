...
- (id)initWithOriginalSocialGroup:(id)a0 newKeyAsset:(id)a1 newCustomTitle:(id)a2 customTitleWasDeleted:(char)a3 peopleToBeAdded:(id)a4 peopleToBeRemoved:(id)a5;
