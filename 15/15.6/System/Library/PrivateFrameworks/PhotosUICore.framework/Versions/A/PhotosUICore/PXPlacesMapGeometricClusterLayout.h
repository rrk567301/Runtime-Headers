...
- (char)_shapeAtCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 overlapsShapeAtCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a1 forViewPort:(id)a2;
