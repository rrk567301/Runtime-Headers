...
@property (readonly, nonatomic) char _shouldCrossfade;
...
@property (nonatomic) char treatRemovalsAsDeletes;
@property (nonatomic) char delayInsertions;
