...
+ (void)collectAnalyticsForExportEndWithConfiguration:(id)a0 analyticsToken:(id)a1 model:(id)a2 withSuccess:(char)a3 error:(id)a4;
+ (char)collectAnalyticsForFixationWithAppleMusicAsset:(id)a0 configuration:(id)a1;
+ (void)collectDataContinuationAnalyticsForExportWithConfiguration:(id)a0 withSuccess:(char)a1 error:(id)a2;
