...
- (id)description;
- (void).cxx_destruct;
- (id)initWithDataSection:(id)a0 indexDelta:(long long)a1 expandedIndex:(long long)a2 indentationLevel:(long long)a3 externalStartIndex:(long long)a4 skipAssetCountFetches:(char)a5;
