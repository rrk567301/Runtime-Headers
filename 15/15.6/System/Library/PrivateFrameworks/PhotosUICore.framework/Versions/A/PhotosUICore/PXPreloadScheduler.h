...
@property (nonatomic, setter=_setActive:) char _isActive;
@property char didFinishExtendedLaunch;
@property char waitForExtendedLaunch;
...
- (char)_shouldExecutePendingBlock;
