...
@property (readonly, nonatomic) char canPushViewController;
...
- (char)pushViewController:(id)a0 animated:(char)a1;
- (char)popToViewController:(id)a0 animated:(char)a1;
...
- (void)dismissViewController:(id)a0 animated:(char)a1 completionHandler:(id /* block */)a2;
- (id)presentAlertWithConfigurationHandler:(id /* block */)a0;
- (void)presentViewController:(id)a0 animated:(char)a1 completionHandler:(id /* block */)a2;
