...
@property (readonly, nonatomic) char wantsScrollIndicators;
...
@property (readonly, nonatomic) char wantsSafeAreaInsets;
@property (readonly, nonatomic) char wantsFirstItemFullscreen;
@property (readonly, nonatomic) double overlayFeedPeekDistance;
@property (readonly, nonatomic) char wantsItemHoverEvents;
...
@property (readonly, nonatomic) char allowsAutoplayContent;
