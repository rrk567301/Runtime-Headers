...
@interface PXPhotosGridAssetDecorationSource : NSObject <PXGShadowSource, PXLoadingStatusManagerObserver, PXPreferencesObserver, PXGAssetBadgeDecorationSource, PXGAssetBackgroundDecorationSource, PXGCaptionDecorationSource, PXGSelectionDecorationSource, PXGDragDecorationSource, PXGTapbackDecorationSource, PXGViewDecorationSource, PXGDebugDecorationSource, PXGDisplayAssetSource, PXGDisplayAssetRequestObserver> {
    ...
    char _forceBadgesOnAllAssets;
    char _isGettingLoadStatus;
...
@property (nonatomic, getter=isSelectionLimitReached) char selectionLimitReached;
@property (readonly, nonatomic) char isSharedLibraryBadgeEnabled;
@property (readonly, nonatomic) char isStacksBadgeEnabled;
...
@property (nonatomic) char durationAlwaysHidden;
@property (nonatomic) char hidesInteractiveFavoriteBadges;
...
@property (nonatomic) char wantsSharedLibraryDecorations;
@property (nonatomic) char wantsStacksDecorations;
...
@property (nonatomic) char enableDebugDecoration;
@property (nonatomic) char enableDebugBadgeColors;
@property (nonatomic) char enableSpatialBadges;
...
- (void).cxx_destruct;
- (void)update;
- (char)wantsTapbackDecorationInLayout:(id)a0;
...
- (char)hasTapbacksForSpriteIndex:(unsigned int)a0 inLayout:(id)a1;
...
- (void)observeIsInCloud:(char)a0 forDisplayAsset:(id)a1;
...
- (char)shouldShowSavedToLibraryBadgeForAsset:(id)a0 inLayout:(id)a1;
...
- (char)wantsBackgroundForZeroInset;
- (char)wantsCaptionDecorationsInLayout:(id)a0;
- (char)wantsDebugDecorationInLayout:(id)a0;
