...
- (id)_queue_oidsForFacts:(unsigned long long)a0 allowFetch:(char)a1;
- (id)_predicateForFact:(unsigned long long)a0;
- (id)_queue_fetchResultForFact:(unsigned long long)a0 allowFetch:(char)a1;
- (char)getAssetCounts:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } *)a0 guestAssetCounts:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } *)a1 forFetchResult:(id)a2 allowFetch:(char)a3;
