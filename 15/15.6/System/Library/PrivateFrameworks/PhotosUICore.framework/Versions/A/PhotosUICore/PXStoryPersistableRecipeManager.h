...
@property (nonatomic) char isOriginalPersistableRecipeValid;
@property (retain, nonatomic) id<PFStoryRecipe> originalPersistableRecipe;
@property (nonatomic) char hasUserExperiencedPlayback;
@property (nonatomic) char hasUserExperiencedFirstPlaybackEver;
@property (nonatomic) char isPreparedForUserChanges;
@property (nonatomic) long long persistencePermission;
@property (readonly, nonatomic) PXUpdater *updater;
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *workQueue;
@property (retain, nonatomic) NSProgress *progress;
@property (readonly, nonatomic) NSString *diagnosticDescription;
@property (readonly, nonatomic) char isReadyToProducePersistableRecipe;
@property (readonly, nonatomic) char isProducingPersistableRecipe;
...
- (void)_invalidatePersistableRecipeForUserActionKind:(long long)a0;
...
- (void)setIsProducingPersistableRecipe:(char)a0;
- (void)setIsReadyToProducePersistableRecipe:(char)a0;
