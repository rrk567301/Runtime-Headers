...
+ (double)_playButtonPaddingForFontSet:(long long)a0 specSet:(long long)a1 variant:(long long)a2 deviceMargin:(double)a3 forHeaderTile:(char)a4;
+ (id)_titleFontNameByFontSet;
+ (double)baselineDistanceForFontSet:(long long)a0 specSet:(long long)a1 variant:(long long)a2 size:(struct CGSize { double x0; double x1; })a3 shouldScale:(char)a4;
...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })paddingForFontSet:(long long)a0 specSet:(long long)a1 variant:(long long)a2 layoutMargins:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a3 width:(double)a4 shouldScale:(char)a5 forHeaderTile:(char)a6;
...
+ (id)textAttributesForFontSet:(long long)a0 specSet:(long long)a1 labelKind:(long long)a2 variant:(long long)a3 size:(struct CGSize { double x0; double x1; })a4 shouldScale:(char)a5;

- (void).cxx_destruct;
- (id)_initWithIdentifier:(struct PXMemoryFontsSpecIdentifier { long long x0; long long x1; long long x2; struct CGSize { double x0; double x1; } x3; double x4; char x5; })a0;
