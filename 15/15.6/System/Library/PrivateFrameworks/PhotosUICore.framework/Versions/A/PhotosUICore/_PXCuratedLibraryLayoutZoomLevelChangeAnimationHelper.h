@class PXCuratedLibraryLayoutSnapshotGeometryDescriptor, NSArray, NSView, PXVisualPositionsChangeDetails, PXCuratedLibrarySectionGeometryDescriptor;
...
@interface _PXCuratedLibraryLayoutZoomLevelChangeAnimationHelper : PXCuratedLibraryLayoutAnimationHelper {
    ...
    char _shouldAlwaysFadeDecoration;
}
...
- (char)wantsPresentationAdjustment;
