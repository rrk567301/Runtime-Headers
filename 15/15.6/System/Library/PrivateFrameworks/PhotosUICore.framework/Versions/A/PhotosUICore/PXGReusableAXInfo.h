...
@property (nonatomic) char axAccessibleWhenTransparent;
@property (nonatomic) char allowDecorations;
...
@property (readonly, nonatomic) char axIsSelected;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (char)_assetHasContentSourceInLayout:(id)a0 atSpriteIndex:(unsigned int)a1;
...
- (char)_fillForKind:(long long)a0 withLayout:(id)a1 spriteIndex:(unsigned int)a2;
...
- (char)_performScrollToVisibleAction;
...
- (char)fillContentForContentKind:(long long)a0 inLayout:(id)a1 atIndex:(unsigned int)a2;
