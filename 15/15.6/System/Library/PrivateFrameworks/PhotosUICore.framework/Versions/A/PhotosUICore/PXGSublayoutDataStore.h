...
- (void)enumerateSublayoutsAtPoint:(struct CGPoint { double x0; double x1; })a0 usingBlock:(id /* block */)a1;
...
- (void)moveSublayoutsFromIndexes:(struct __CFArray { } *)a0 toIndexes:(id)a1;
...
- (unsigned int)spriteIndexOriginForSublayoutIndex:(long long)a0;
