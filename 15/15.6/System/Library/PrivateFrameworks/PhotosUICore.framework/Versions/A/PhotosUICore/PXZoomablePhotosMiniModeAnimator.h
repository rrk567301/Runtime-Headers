...
@property (readonly, nonatomic) char isContentAnimating;
...
- (void)_applyAnimationValue:(struct { double x0; double x1; double x2; long long x3; double x4; char x5; })a0 toAnimator:(id)a1 animateImmediately:(char)a2;
...
- (void)performAnimated:(char)a0 changes:(id /* block */)a1;
- (void)setIsContentAnimating:(char)a0;
