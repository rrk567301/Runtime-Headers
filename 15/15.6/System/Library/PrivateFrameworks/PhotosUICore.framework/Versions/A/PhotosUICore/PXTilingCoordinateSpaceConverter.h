...
+ (id)defaultConverter;
+ (char)_canConvertBetweenCoordinateSpace:(id)a0 andCoordinateSpace:(id)a1;
+ (char)canConvertBetweenCoordinateSpaceIdentifier:(void *)a0 andCoordinateSpaceIdentifier:(void *)a1;
