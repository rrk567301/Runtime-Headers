...
@property (nonatomic) char usesBadgeSelection;
@property (nonatomic) char usesLargeMargins;
@property (nonatomic) char showsIdentifyButton;
@property (nonatomic) char showsRemoveButtonOnHover;
