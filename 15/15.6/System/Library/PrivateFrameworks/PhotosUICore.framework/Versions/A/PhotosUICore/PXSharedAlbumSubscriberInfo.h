...
+ (id)_allSubscribersForAlbum:(id)a0 includeMyself:(char)a1;
+ (id)allSubscribersForAlbum:(id)a0;
+ (id)allSubscribersForAlbumWithObjectID:(id)a0 includingCurrentUser:(char)a1 managedObjectContext:(id)a2;

- (id)init;
- (void).cxx_destruct;
- (id)initWithInvitationRecord:(id)a0 identifier:(id)a1 email:(id)a2 phone:(id)a3 firstName:(id)a4 lastName:(id)a5 displayName:(id)a6 isOwner:(char)a7;
