...
@property (nonatomic) char isFooterShown;
@property (readonly, nonatomic) char shouldAlternateTitleWithAnimatedGridCycle;
...
+ (id)_titleWithOptionalDescription:(id *)a0 progress:(float *)a1 forMode:(long long)a2 itemCountsController:(id)a3 analysisStatus:(id)a4 cplUIStatus:(id)a5 inRebuild:(char)a6 reason:(id)a7;
+ (char)hasAnalysisProgressForMode:(long long)a0 analysisStatus:(id)a1 cplUIStatus:(id)a2 userDefaults:(id)a3 outAnimatedIconMode:(long long *)a4 outProgress:(float *)a5 outTitle:(id *)a6 outDescription:(id *)a7;
