...
- (id)init;
- (void).cxx_destruct;
- (void)_requestTextureForAttributedString:(id)a0 attributedStringBoundingSize:(struct CGSize { double x0; double x1; })a1 string:(id)a2 withAttributes:(id)a3 targetSize:(struct CGSize { double x0; double x1; })a4 drawingOptions:(long long)a5 drawingContext:(id)a6 userInterfaceDirection:(unsigned long long)a7 verticalAlignment:(long long)a8 screenScale:(double)a9 textureRequestID:(int)a10 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a11;
- (char)_shouldRedrawForViewEnvironmentChange:(id)a0;
