...
+ (char)_shouldCacheResultForOptions:(id)a0 isDegraded:(char)a1 isCropped:(char)a2 isForCleanup:(char)a3;
+ (char)_change:(id)a0 containsVisibleChangesToAssetWithOID:(id)a1;
...
+ (id)_fetchQueue;
+ (char)_isFinalForIsDegraded:(char)a0 isCropped:(char)a1;
+ (char)_shouldTakeSquareCropForFace:(id)a0 cropFactor:(long long)a1 outNormalizedFaceCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })cropRectWithAspectRatioFittingAroundEyeLevelForAspectRatio:(double)a0 pixelFaceCrop:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 eyelinePoint:(struct CGPoint { double x0; double x1; })a2;
...
- (void)_invalidateCacheForLocalIdentifiers:(id)a0 wantsNotificationPosted:(char)a1 userInfoKey:(id)a2;
...
- (char)isRequestActiveWithRequestID:(int)a0;
