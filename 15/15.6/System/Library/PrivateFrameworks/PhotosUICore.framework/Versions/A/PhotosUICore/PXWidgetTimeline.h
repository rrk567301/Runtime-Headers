...
+ (char)_requesWidgetTimelineReloadForWidgetKind:(id)a0 withError:(id *)a1;
+ (char)requestAlbumWidgetTimelineReloadWithError:(id *)a0;
+ (char)requestForYouWidgetTimelineReloadWithError:(id *)a0;
