...
@interface PXMessagesStackItemsLayout : PXGItemsLayout <PXGItemsGeometry> {
    struct { unsigned long long needsUpdate; unsigned long long updated; char isPerformingUpdate; char willPerformUpdate; } _preItemLoadingFlags;
    ...
    char _signalDelegateForPrimaryItemChange;
    char _scrollToBeginning;
    ...
    char _higherPageDirectionTolerance;
...
@property (nonatomic) char isSettling;
@property (nonatomic) char keepItemAspectRatioConstant;
...
- (char)getHorizontalOffsetForObjectReference:(id)a0 outOffset:(double *)a1;
...
- (char)shouldDecorateUndefinedMediaKind;
