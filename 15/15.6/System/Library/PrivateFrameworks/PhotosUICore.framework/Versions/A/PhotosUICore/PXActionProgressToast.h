...
- (void)_dismissAnimated:(char)a0;
- (void)_dismissAnimated:(char)a0 afterDelay:(double)a1;
...
- (void)finishProgressMarkingAsComplete:(char)a0;
- (void)finishProgressMarkingAsComplete:(char)a0 updatedLocalizedTitle:(id)a1 updatedLocalizedDescription:(id)a2;
