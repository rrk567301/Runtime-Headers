...
@interface PXStoryScrubberContentLayout : PXStoryModelTimelineLayout <PXGSolidColorSource, PXGViewSource, PXChangeObserver, PXGAXResponder> {
    ...
    char _didUpdateTimelineTranslationXAnimatorOnce;
    char _isWaitingForFocusableViewUserDataUpdate;
...
@property (nonatomic) char containsFocus;
...
- (char)_handleScrollTimeline:(id)a0 inGroup:(id)a1;
...
- (char)shouldSetContentSizeToReferenceSize;
