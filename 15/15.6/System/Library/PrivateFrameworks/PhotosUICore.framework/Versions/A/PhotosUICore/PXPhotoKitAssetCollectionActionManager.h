@class NSString, PXPhotosEnvironmentReference, PXAssetsDataSource, PXAssetCollectionActionPerformer, NSDictionary, PXAssetReference, PHAssetCollection, PHFetchResult;
...
- (Class)_possiblePerformerClassForActionType:(id)a0 assetCollectionReference:(id)a1 requireThatPerformerCanPerformAction:(char)a2;
...
- (char)canPerformActionType:(id)a0 assetCollectionReference:(id)a1;
