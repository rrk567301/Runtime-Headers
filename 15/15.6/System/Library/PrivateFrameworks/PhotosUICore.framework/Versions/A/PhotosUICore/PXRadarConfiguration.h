...
@property (nonatomic) char attachmentsIncludeAnyUserAsset;
@property (nonatomic) char wantsSystemDiagnostics;
@property (nonatomic) char wantsPhotosDiagnostics;
@property (nonatomic) char isProgressUIAllowed;
