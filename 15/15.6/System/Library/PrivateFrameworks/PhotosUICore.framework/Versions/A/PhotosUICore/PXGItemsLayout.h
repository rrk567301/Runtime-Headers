...
@interface PXGItemsLayout : PXGLayout {
    struct { unsigned long long needsUpdate; unsigned long long updated; char isPerformingUpdate; char willPerformUpdate; } _loadedItemsUpdateFlags;
    ...
    struct { unsigned long long needsUpdate; unsigned long long updated; char isPerformingUpdate; char willPerformUpdate; } _accessoryItemsUpdateFlags;
...
@property (readonly, nonatomic) char isApplyingItemChanges;
...
- (char)delegateRespondsTo:(unsigned long long)a0;
...
- (void)setItem:(long long)a0 forStylableType:(long long)a1 animated:(char)a2;
...
- (char)shouldInvalidateDecorationForModifiedSprites;
...
- (char)spriteIndexIsAccessoryItem:(unsigned int)a0;
- (char)spriteIndexIsItem:(unsigned int)a0;
