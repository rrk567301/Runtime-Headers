...
@property (readonly, nonatomic) char isChangeProcessingPaused;
...
+ (id)recentlySharedDataSectionManagerForLibrary:(id)a0 context:(id)a1;
+ (id)recentlyViewedDataSectionManagerForLibrary:(id)a0 context:(id)a1;
...
- (char)moveGroupItem:(id)a0 afterGroupItem:(id)a1;
...
- (void)setExpanded:(char)a0 forItem:(id)a1;
