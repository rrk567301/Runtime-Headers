...
@property (readonly, nonatomic) char shouldUseUnifiedButtonLayout;
@property (readonly, nonatomic) char canShowCloseButton;
@property (readonly, nonatomic) char canShowMuteToggleButton;
@property (readonly, nonatomic) char canShowManagePhotosAction;
@property (readonly, nonatomic) char wantsEdgeTapToChangeCurrentSegment;
@property (readonly, nonatomic) char wantsSwipeDownGestureToDismiss;
...
@property (readonly, nonatomic) char shouldHorizontallyCenterPlayButton;
@property (readonly, nonatomic) char shouldVerticallyCenterPlayButton;
...
@property (readonly, nonatomic) char onlyShowReplayEndButtonAtTopOfTitle;
...
@property (readonly, nonatomic) char shouldUseAssetCollectionForTitleAndSubtitle;
...
@property (readonly, nonatomic) char browseGridAllowsDragGesture;
...
@property (readonly, nonatomic) char shouldHideChromeItemsWhenRelatedOverlayIsScrolledIntoView;
...
@property (readonly, nonatomic) char styleSwitcherCanShowEditButtons;
...
@property (readonly, nonatomic) char bufferingIndicatorWantsBackground;
@property (readonly, nonatomic) char insideCollectionDetailsView;
