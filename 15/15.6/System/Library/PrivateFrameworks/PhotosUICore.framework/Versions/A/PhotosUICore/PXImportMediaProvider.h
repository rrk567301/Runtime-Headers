...
@property (nonatomic) char hasBeenIdle;
...
- (double)idleTimeOut;
- (long long)imageOfSize:(unsigned long long)a0 forModel:(id)a1 localCacheOnly:(char)a2 priority:(unsigned char)a3 completion:(id /* block */)a4;
...
- (char)thumbnailExistsForModel:(id)a0;
