...
- (void)_generateAdditionalEntriesWithOldDataSource:(id)a0 startingIndex:(unsigned long long)a1 sync:(char)a2;
...
- (void)generateAdditionalEntriesWithOldDataSource:(id)a0 startingIndex:(unsigned long long)a1 sync:(char)a2;
