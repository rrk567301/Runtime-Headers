...
@property (readonly, nonatomic) char dividerLineVisible;
@property (readonly, nonatomic) char minimizeTitleBottomPadding;
@property (readonly, nonatomic) char titleShouldFadeOnScroll;
@property (readonly, nonatomic) char filterButtonLayoutForSearch;
