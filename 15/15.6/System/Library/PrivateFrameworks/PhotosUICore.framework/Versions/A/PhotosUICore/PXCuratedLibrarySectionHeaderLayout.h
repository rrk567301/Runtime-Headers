...
@interface PXCuratedLibrarySectionHeaderLayout : PXGLayout <PXGTitleSubtitleSource, PXGViewSource, PXGNamedImageSource, PXChangeObserver, PXLibrarySummaryOutputPresenter> {
    ...
    char _presentedTitleVisibility;
...
@property (nonatomic) char controlStackButtonSelected;
@property (nonatomic) char usesCompactToggleAspectFitButton;
...
@property (nonatomic) char wantsOverBackgroundAppearance;
@property (nonatomic) char showsBackgroundGradient;
@property (nonatomic) char showsDebugDescription;
...
@property (nonatomic) char ellipsisButtonHighlighted;
@property (nonatomic) char filterButtonHighlighted;
...
@property (nonatomic) char wantsDisclosureIndicator;
@property (readonly, nonatomic) char wantsLocationNames;
...
- (id)_configurationForButton:(unsigned long long)a0 overBackgroundVariant:(char)a1;
