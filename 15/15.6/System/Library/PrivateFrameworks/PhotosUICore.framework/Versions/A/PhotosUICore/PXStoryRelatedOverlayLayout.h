@class NSTimer, PXStoryChromeButtonConfiguration, PXStoryRelatedLayoutGenerator, NSString, PXNumberAnimator, PXStoryRelatedOverlayItemDecorationSource, PXStoryScrollContentLayout, PXGenerativeStoryInWatchNextController, PXGScrollLayout, PXStoryViewModel;
...
@interface PXStoryRelatedOverlayLayout : PXGAbsoluteCompositeLayout <PXGStringSource, PXGNamedImageSource, PXGSublayoutProvider, PXChangeObserver, PXStoryScrollContentLayoutDelegate, PXGScrollLayoutDelegate> {
    ...
    char _shouldIgnoreContentScrollOffsetChanges;
...
@property (nonatomic) char isRelatedOverlayScrolledIntoView;
@property (nonatomic) char shouldCountDown;
...
@property (nonatomic) char wantsNavigationButton;
...
@property (nonatomic) char wasAnimatingScrollOffsetForNavigation;
...
- (void)_navigateToRelatedMemoryAtIndex:(long long)a0;
- (char)_needsRTLFlip;
- (long long)_offsetForRelatedIndex:(long long)a0;
- (long long)_relatedModelIndexOffsetByMemoryCreation:(long long)a0;
...
- (void)showOrHideFullRelated:(char)a0;
