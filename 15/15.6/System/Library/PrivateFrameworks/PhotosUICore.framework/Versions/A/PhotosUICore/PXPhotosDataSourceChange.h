...
@interface PXPhotosDataSourceChange : NSObject {
    ...
    char _changesAreNoOp;
}

@property (readonly) char hasIncrementalChanges;
@property (readonly) char changesAreNoOp;
...
- (char)_shouldPerformFullReloadForCollectionListChangeNotifications:(id)a0 collectionChangeNotifications:(id)a1;
- (char)affectsSectionsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
