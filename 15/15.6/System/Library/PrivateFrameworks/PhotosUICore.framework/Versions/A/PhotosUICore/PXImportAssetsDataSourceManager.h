...
@property (nonatomic) char needsFilterUpdate;
...
@property (nonatomic) char dispatchesDataSourceUpdatesOnMainQueue;
@property (copy, nonatomic) NSSet *visibleImportAssetIdentifiers;
@property (nonatomic) char showAlreadyImportedItems;
@property (nonatomic) char showNotYetImportedItems;
@property (nonatomic) char alreadyImportedItemsSelectable;
@property (nonatomic) char dataSourcesStartAtEnd;

+ (void)addModels:(id)a0 toAssetCollections:(id)a1 assetCollectionsById:(id)a2;
+ (char)assetCollectionsArray:(id)a0 isEqualToAssetCollectionsArray:(id)a1;
