...
@property (class, readonly) PXVisualIntelligenceManager *sharedManager;
@property (class, readonly, nonatomic) unsigned long long supportedAnalysisTypes;
@property (class, readonly, nonatomic) char isLiveTextSupported;
@property (class, readonly, nonatomic) char isVisualSearchSupported;
@property (class, readonly, nonatomic) char isMRCSupported;
@property (class, readonly, nonatomic) char isAppClipSupported;
@property (class, readonly, nonatomic) char isImageSegmentationSupported;
