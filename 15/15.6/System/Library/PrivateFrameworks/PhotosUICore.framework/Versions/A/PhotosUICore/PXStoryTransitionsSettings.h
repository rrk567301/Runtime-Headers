...
@property (nonatomic) char suppressUnsupportedTransitionErrors;
@property (nonatomic) char suppressInvalidTransitionErrors;
@property (nonatomic) char suppressInterruptedTransitionErrors;
...
@property (nonatomic) char useSplitWipeTransitionsFromOneUp;
...
@property (nonatomic) char disableUnsupportedTransitionsAtChapterBoundary;
