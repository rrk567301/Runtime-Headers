...
@interface PXVideoSessionManager : PXObservable <PXChangeObserver, PXAVResourceReclamationObserver> {
    ...
    char _ivarQueue_canStoreReusablePlayers;
}
...
+ (char)isLivePhotoStabilizationEnabled;
...
- (id)contentProviderForAsset:(id)a0 withOptions:(id)a1 mediaProvider:(id)a2 requestURLOnly:(char)a3;
