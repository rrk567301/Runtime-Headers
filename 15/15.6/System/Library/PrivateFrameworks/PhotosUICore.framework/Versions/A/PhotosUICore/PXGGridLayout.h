...
@property (nonatomic) char enableEffects;
@property (nonatomic) char enablePerItemCornerRadius;
@property (nonatomic) char enablePerItemMargin;
@property (nonatomic) char enablePerItemInsets;
...
@property (nonatomic) double accessoryAlpha;
@property (nonatomic) char fillSafeAreaTopInset;
@property (nonatomic) char supportsAutomaticContentRotation;
@property (readonly, nonatomic) double rowHeight;
@property (nonatomic) long long visualItemShift;
@property (nonatomic, getter=isLazy) char lazy;
@property (nonatomic) char hideIncompleteLastRowOrColumn;
@property (nonatomic) char mediaTargetSizeIgnoresSpacing;
...
- (char)shouldUpdateDecorationMediaTargetSizes;
