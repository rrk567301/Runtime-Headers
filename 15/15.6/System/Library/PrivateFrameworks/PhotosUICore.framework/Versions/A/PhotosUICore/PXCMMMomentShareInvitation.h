...
@property (readonly, nonatomic) char px_isEmpty;
@property (readonly, nonatomic) char px_isFavorite;
@property (readonly, nonatomic) char px_canPerformFavoriteAction;
...
+ (char)supportsSavingAssetsForInvitations:(id)a0 numberOfAssetsToSave:(unsigned long long *)a1 assetsToSaveMediaType:(long long *)a2;
