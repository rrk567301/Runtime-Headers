...
@interface PXCuratedLibraryLayout : PXGSplitLayout <PXLibrarySummaryDataSource, PXChangeObserver, PXAssetsDataSourceManagerObserver, PXCuratedLibraryViewModelPresenter, PXGNamedImageSource, PXGAnchorDelegate, PXSettingsKeyObserver, PXCuratedLibraryLayoutAssetCollectionReferenceProvider, PXScrollablePageSource, PXGSolidColorSource, PXGCaptureSpriteSource> {
    ...
    char _isPerformingInitialUpdate;
}
...
@property (nonatomic) char canHandleVisibleRectRejection;
...
- (double)_adjustedTargetVisibleTopToAccomodateFromBottomPaddedAreaVisibility:(char)a0 proposedVisibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
...
- (void)_noteAnimation:(id)a0 isRunning:(char)a1;
...
- (char)curatedLibrarySummaryHelperShouldUpdateImmediately:(id)a0;
...
- (id)offscreenEffectForCapturedSnapshotAtIndex:(unsigned int)a0 inLayout:(id)a1;
...
- (id)topMostAssetCollectionInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 ignoreChapterHeaders:(char)a1;
