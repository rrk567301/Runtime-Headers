...
@property (readonly, nonatomic) char isSingletonPersonResult;
@property (readonly, nonatomic) char isOCRStringMatchedResult;
...
- (unsigned long long)_plCategoryForPlSearchResult:(id)a0;
