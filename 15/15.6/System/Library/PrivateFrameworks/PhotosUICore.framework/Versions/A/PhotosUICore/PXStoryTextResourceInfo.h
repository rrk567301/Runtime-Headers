...
@property (nonatomic) char hasForcedPositioning;
...
+ (id)_subtitleFontForKind:(unsigned long long)a0 scale:(double)a1 hasExtendedCharacterSet:(char)a2 internationalStyle:(long long)a3;
...
+ (id)_titlePrimaryAttributesForStylePairing:(long long)a0 scale:(double)a1 kind:(unsigned long long)a2 layoutScheme:(long long)a3 allowHyphenation:(char)a4 internationalStyle:(long long)a5;
+ (long long)stylePairingFromTitleCategory:(id)a0 string:(id)a1 kind:(unsigned long long)a2 layoutScheme:(long long)a3;
...
+ (id)titleFontDescriptorForStylePairing:(long long)a0 kind:(unsigned long long)a1;
+ (char)titleShouldBeUppercasedForStylePairing:(long long)a0 kind:(unsigned long long)a1;

- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (char)_isKashidaText:(id)a0;
...
- (double)_paddingLeadingMinimumForKind:(unsigned long long)a0 orientationIsLandscape:(char)a1;
...
- (double)_paddingLeftOrRightAlignmentLeadingScaleForKind:(unsigned long long)a0 orientationIsLandscape:(char)a1;
