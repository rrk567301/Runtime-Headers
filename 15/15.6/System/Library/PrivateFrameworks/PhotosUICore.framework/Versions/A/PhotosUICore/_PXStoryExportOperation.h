...
@interface _PXStoryExportOperation : NSOperation <PXGEngineDelegate, PXStoryDiagnosticHUDDataSource, PXStoryPacingCueSource, PXStoryExportRequest_Internal> {
    ...
    char _stateQueue_hasAudioForExport;
    ...
    char _storyQueue_hasEncounteredDriftError;
}
...
@property (readonly, nonatomic) char storyQueue_isWaitingForResources;
...
@property (nonatomic, setter=_setHasAudioForExport:) char hasAudioForExport;
...
- (char)_waitForStoryStateWhileExportingCanContinueByWatchingChanges:(unsigned long long)a0 timeout:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 verificationBlock:(id /* block */)a2;
- (char)_waitWhileExportingCanContinueForSemaphore:(id)a0 timeout:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
