...
@property (readonly, nonatomic) char clientQueue_isPerformingChanges;
...
@property (nonatomic) char layoutQueue_isAppInactive;
...
@property (nonatomic) char layoutQueue_pendingProposedSizeWasDelayed;
...
- (void)_dispatchFrame:(id)a0 async:(char)a1 toObserver:(id)a2;
...
- (id)addPresenter;
- (char)engine:(id)a0 shouldRenderLayout:(id)a1 sprites:(id)a2;
...
- (char)layoutQueue_acceptSize:(id)a0;
