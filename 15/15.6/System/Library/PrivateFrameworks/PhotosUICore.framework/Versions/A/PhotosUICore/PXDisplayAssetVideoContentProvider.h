...
@interface PXDisplayAssetVideoContentProvider : PXVideoContentProvider <PXDisplayAssetVideoContentProviderRequestDelegate, PXAVResourceReclamationObserver> {
    ...
    NSArray *_strategies;
    char _requestURLOnly;
    char _mayContainAudio;
...
@property (readonly, nonatomic) char needsPostprocessing;
...
- (char)_loadingQueue_needsNewRequestForPriority:(long long)a0;
