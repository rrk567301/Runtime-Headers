...
@property (nonatomic) char viewCanBeEnabled;
...
@property (nonatomic) char skipLayoutUpdates;
...
- (char)_isEventWithinZoomRange:(id)a0;
- (char)_isTickWithinActiveTrackRange:(double)a0;
...
- (void)addFocusEvent:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 userInitiated:(char)a1 shouldAnimate:(char)a2;
- (void)enableUIForCinematographyScriptLoad:(char)a0;
- (void)handleEventSelectedAtLocation:(struct CGPoint { double x0; double x1; })a0;
- (void)objectTrackingFinishedWithSuccess:(char)a0;
...
- (void)updateObjectTrackingProgressAtTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 shouldStop:(char *)a1;
- (void)updateTimeline;
