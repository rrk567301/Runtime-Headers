...
@interface PXStoryRelatedLayoutGenerator : PXLayoutGenerator {
    ...
    struct NSEdgeInsets { double top; double left; double bottom; double right; } _scrollableOutsets;
    char _isContentScrolledIntoView;
    long long _capacity;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } scrollableOutsets;
@property (readonly, nonatomic) char isContentScrolledIntoView;

+ (long long)_preferredNumberOfItemsForUserInterfaceIdiom:(long long)a0;
+ (char)isExpectedKeyItemAtIndex:(long long)a0;
...
- (void)adjustTargetScrollOffset:(inout struct CGPoint { double x0; double x1; } *)a0 forVelocity:(struct CGPoint { double x0; double x1; })a1 currentScrollOffset:(struct CGPoint { double x0; double x1; })a2 shouldHideContent:(out char *)a3;
