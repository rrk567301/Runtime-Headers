...
@property (nonatomic) char suggestionsPresented;
@property (nonatomic) char showTypeDebugColor;
@property (readonly) PXPeopleSuggestionManager *suggestionManager;
@property (retain, nonatomic) PXAnimatedCountView *countView;
@property (readonly) char isSummaryViewShowing;
