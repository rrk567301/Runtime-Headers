...
@interface PXTilingControllerCompositionEngine : NSObject <PXScrollControllerUpdateDelegate, PXTilingControllerObserver, PXTilingControllerCompositionObserver, PXTilingControllerCompositionInput, PXTilingControllerCompositionOutput> {
    ...
    char _isUpdatingComposition;
    struct { char scrollControllerMetrics; char composition; } _needsUpdateFlags;
}
...
+ (id)compositionEngineForScrollController:(id)a0 createIfNeeded:(char)a1;
...
- (char)_updateCompositionIfNeeded;
...
- (void)setReferenceSize:(struct CGSize { double x0; double x1; })a0 contentInset:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1 forTilingController:(id)a2;
