...
@property (nonatomic) char isTouching;
...
@property (nonatomic) char disableGestures;
...
- (char)_canNavigateToSelectedRelated;
- (void)_changeColorGrade;
- (void)_changeOverallDuration:(long long)a0;
- (void)_changeStyle;
- (void)_editCurrentChapter;
- (char)_handlePrimaryInteractionAtPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (void)_moveLeftAfterEdgeTap:(char)a0;
- (void)_moveRightAfterEdgeTap:(char)a0;
- (void)_navigateToSelectedRelated;
- (void)_skipToSegmentWithOffset:(long long)a0 afterEdgeTap:(char)a1;
