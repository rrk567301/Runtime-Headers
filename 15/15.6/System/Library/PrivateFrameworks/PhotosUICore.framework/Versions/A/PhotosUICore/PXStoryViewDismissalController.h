@class UXView, PXGItemPlacement, PXGViewControllerTransition, PXSwipeDownTracker, PXNumberAnimator, PXUpdater, PXPointAnimator, NSString, PXStoryViewModel;
...
@property (retain, nonatomic) UXView *referenceView;
...
@property (nonatomic) char targetCancelled;
