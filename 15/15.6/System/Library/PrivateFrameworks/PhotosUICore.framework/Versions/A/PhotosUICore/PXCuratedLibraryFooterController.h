...
@interface PXCuratedLibraryFooterController : PXObservable <PXMutableCuratedLibraryFooterController, PXChangeObserver, PXScrollViewControllerObserver, PXPhotosGlobalFooterViewDelegate, PXCuratedLibraryFooterViewModelPresentationDelegate> {
    ...
    char _isUpdatingFooter;
    char _needsFooterFrameChangeAnimation;
}
...
@property (readonly, nonatomic) char isGridViewVisible;
@property (readonly, nonatomic) char isPullingFooter;
@property (nonatomic) char wantsFooter;
@property (nonatomic) char isFooterVisible;
@property (nonatomic) char hasAppearedOnce;
@property (nonatomic) char footerNeedsReveal;
...
@property (readonly, nonatomic) char hasAppeared;
...
- (char)_shouldRevealPhotosFooterView;
- (char)_shouldShowFooterForGridViewState;
- (char)_shouldShowFooterForPresentedZoomLevel;
...
- (double)footerVisibleAmountIncludingSafeAreaInsets:(char)a0;
...
- (void)setWantsFooterMask:(char)a0;
