...
@property (nonatomic) char canDeliverThumbnailData;
...
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { char x0; float x1; char x2; })a1 adjustment:(id)a2 forRequestID:(int)a3;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { char x0; float x1; char x2; })a1 adjustment:(id)a2 isDegraded:(char)a3 forRequestID:(int)a4;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { char x0; float x1; char x2; })a1 forRequestID:(int)a2;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { char x0; float x1; char x2; })a1 isDegraded:(char)a2 forRequestID:(int)a3;
...
- (void)providePixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { char x0; float x1; char x2; })a1 adjustment:(id)a2 forRequestID:(int)a3;
- (void)providePixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { char x0; float x1; char x2; })a1 forRequestID:(int)a2;
