...
@property (nonatomic) char isTargetTimelineFinal;
@property (readonly, nonatomic) char requiresUpdatedTargetTimelineImmediately;
...
@property (readonly, nonatomic) char isTimelineFinal;
...
- (void)setIsTimelineFinal:(char)a0;
- (void)setTimelineAttributes:(unsigned long long)a0;
- (void)setVisibleSegmentIdentifiers:(id)a0;
- (void)setVisibleSegmentIdentifiers:(id)a0 afterUpdatePass:(char)a1;
