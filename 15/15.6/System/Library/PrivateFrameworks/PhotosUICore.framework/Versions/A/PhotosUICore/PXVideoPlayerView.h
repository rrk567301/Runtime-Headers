...
@property (readonly, nonatomic, getter=isDisplayingPlaceHolder) char displayingPlaceholder;
@property (nonatomic) long long videoViewContentMode;
@property (nonatomic) char allowsEdgeAntialiasing;
...
- (void)_setDisplayingPlaceholder:(char)a0 requestID:(long long)a1;
