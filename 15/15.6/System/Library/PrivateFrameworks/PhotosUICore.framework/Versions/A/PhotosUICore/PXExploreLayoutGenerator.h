...
@property (readonly, nonatomic) char canReorderItemsAcrossRows;
...
- (struct CGSize { double x0; double x1; })_estimatedSizeForSevenColumnLayoutWithOptions:(unsigned long long)a0;
...
- (char)_isShortRowNextFollowedByLargeHero;
- (void)_parseFourColumnHeroRowWithType:(long long)a0 heroItemType:(long long)a1 numberOfItems:(long long)a2;
- (char)_parseFourColumnLayoutWithOptions:(unsigned long long)a0;
- (void)_parseFourColumnShortRowWithNumberOfItems:(long long)a0;
- (void)_parseSevenColumnHeroRowWithNumberOfItems:(long long)a0 heroItemType:(long long)a1 subsequentShortRowItems:(long long)a2 options:(unsigned long long)a3;
- (char)_parseSevenColumnLayoutWithOptions:(unsigned long long)a0;
- (void)_parseSevenColumnShortRowWithNumberOfItems:(long long)a0;
...
- (char)_parseSixColumnLayoutWithOptions:(unsigned long long)a0;
- (void)_parseSixColumnShortRowWithNumberOfItems:(long long)a0;
- (void)_parseThreeColumnHeaderRowWithNumberOfItems:(long long)a0;
- (char)_parseThreeColumnLayoutWithOptions:(unsigned long long)a0;
...
- (char)canUseSingleSevenColumnHeroRowForNumberOfRemainingItems:(long long)a0;
...
- (char)isAcceptableLargeHeroNextItemAtIndex:(long long)a0;
...
- (char)nextItems:(long long)a0 areAll:(unsigned long long)a1;
- (char)nextItems:(long long)a0 isAny:(unsigned long long)a1;
...
- (long long)numberOfItemsInSevenColumnHeroRowForNumberOfRemainingItems:(long long)a0;
- (long long)numberOfItemsInSevenColumnShortRowForNumberOfRemainingItems:(long long)a0;
...
- (char)parseFourColumnGroupWithShortRowFollowedByLargeHero;
- (char)parseFourColumnRowWithType:(long long)a0 numberOfItems:(long long)a1;
- (char)parseMacLayout;
- (char)parsePadLandscapeLayout;
- (char)parsePadPortraitLayout;
- (char)parsePhoneLandscapeLayout;
- (char)parsePhonePortraitLayout;
- (char)parseSevenColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 options:(unsigned long long)a2;
- (char)parseSevenColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 subsequentShortRowItems:(long long)a2 options:(unsigned long long)a3;
- (char)parseSixColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 options:(unsigned long long)a2;
- (char)parseSixColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 subsequentShortRowItems:(long long)a2 options:(unsigned long long)a3;
- (char)parseThreeColumnGroupWithFiveItems;
- (char)parseThreeColumnGroupWithShortRowFollowedByLargeHero;
- (char)parseThreeColumnGroupWithThreeItemsFollowedByOneItemAllowingLargeHeroAtEnd:(char)a0;
- (char)parseThreeColumnMediumHeroRowWithPano;
- (char)parseThreeColumnRowWithType:(long long)a0 numberOfItems:(long long)a1;
- (char)parseThreeColumnShortRowWithPano;
- (long long)preferredRowTypeAfterRowWithType:(long long)a0;
- (char)prepareNextItems:(long long)a0 withLargeHeroIndex:(long long)a1;
