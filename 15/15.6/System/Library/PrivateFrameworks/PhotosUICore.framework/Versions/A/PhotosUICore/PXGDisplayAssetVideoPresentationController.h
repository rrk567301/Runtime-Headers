...
@property (readonly, nonatomic) char shouldRewindOnBackAction;
...
@property (nonatomic) char shouldFadeVolumeChange;
...
@property (readonly, nonatomic) char shouldDisplayPreviousNonNullPixelBuffer;
@property (readonly, nonatomic) char shouldDisableAutomaticPixelBufferUpdates;
@property (readonly, nonatomic) char isReadyForImmediatePlayback;
@property (readonly, nonatomic) char isVisible;
@property (readonly, nonatomic) char resetsDesiredPlayStateOnHide;
...
@property (readonly, nonatomic) char isLoopingEnabled;
@property (readonly, nonatomic) char isCrossfadingFromStillToVideoEnabled;
@property (readonly, nonatomic) char isCleanApertureCompensationEnabled;
@property (readonly, nonatomic) NSString *audioSessionCategory;
@property (readonly, nonatomic) char isDuckingOtherAudioEnabled;
@property (readonly, nonatomic) char isMixingAudioWithOthersEnabled;
...
- (void)setIsReadyForImmediatePlayback:(char)a0;
...
- (char)isPendingSeekScheduled;
- (id)pixelBufferSourceWithMediaProvider:(id)a0;
- (id)placeholderImageWithMediaProvider:(id)a0;
...
- (void)setIsCleanApertureCompensationEnabled:(char)a0;
- (void)setIsCrossfadingFromStillToVideoEnabled:(char)a0;
- (void)setIsDuckingOtherAudioEnabled:(char)a0;
- (void)setIsLoopingEnabled:(char)a0;
- (void)setIsMixingAudioWithOthersEnabled:(char)a0;
...
- (void)setResetsDesiredPlayStateOnHide:(char)a0;
- (void)setShouldDisableAutomaticPixelBufferUpdates:(char)a0;
- (void)setShouldDisplayPreviousNonNullPixelBuffer:(char)a0;
...
- (void)synchronouslySeekToDesiredTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 updatePixelBufferSource:(char)a1;
