...
@property (nonatomic) char private_wantsInternalUI;
...
@property (nonatomic) char showLibraryFilterTip;
...
@property (nonatomic) char hideWIPAlerts;
@property (nonatomic) char showWIPAlertRadar;
...
- (id)parentSettings;
- (char)canShowInternalUI;
- (void)setCanShowInternalUI:(char)a0;
