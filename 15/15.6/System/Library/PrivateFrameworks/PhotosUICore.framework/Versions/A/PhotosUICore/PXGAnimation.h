...
@property (nonatomic) char supportsSpriteTransfer;
@property (nonatomic, setter=setDoubleSided:) char isDoubleSided;
@property (nonatomic) char supportsPresentationAdjustment;
