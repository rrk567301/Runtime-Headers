...
@property (readonly, nonatomic) char toneMapToStandardDynamicRange;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithVideoSession:(id)a0 toneMapToStandardDynamicRange:(char)a1 placeholderImage:(id)a2;
