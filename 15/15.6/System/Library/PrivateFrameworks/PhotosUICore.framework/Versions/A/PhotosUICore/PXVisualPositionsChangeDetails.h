...
+ (id)changeDetailsWithCountBeforeChanges:(long long)a0 anchorIndexBeforeChanges:(long long)a1 headerIndexesBeforeChanges:(id)a2 countAfterChanges:(long long)a3 anchorIndexAfterChanges:(long long)a4 headerIndexesAfterChanges:(id)a5 reloadAllIncludingAnchor:(char)a6;
...
- (id)init;
- (void).cxx_destruct;
- (id)arrayChangeDetailsWithItemsChanged:(char)a0;
...
- (struct { long long x0; long long x1; char x2; })visualPositionAfterApplyingChangesToIndex:(long long)a0;
- (struct { long long x0; long long x1; char x2; })visualPositionAfterRevertingChangesFromIndex:(long long)a0;
