...
@property (readonly, nonatomic) char useAsynchronousLoad;
...
@property (getter=isDisclosed) char disclosed;
...
- (id)initWithName:(id)a0 objectsReloadBlock:(id /* block */)a1 asynchronousLoad:(char)a2 callbackDelegate:(id)a3;
