...
@interface PXBrowserSummaryController : PXObservable <PXMutableBrowserSummaryController, PXInfoUpdaterObserver, PXInfoProvider> {
    struct { char containerTitle; char localizedContainerItemsCount; char containerDateInterval; char selectionSnapshot; char filteringContainerContent; char attributedPrimaryTitle; char secondaryTitle; char tertiaryTitle; char navigationTitle; char attributedSelectionTitle; char stackedAssets; } _needsUpdateFlags;
    struct { char containerTitle; char localizedContainerItemsCount; char containerDateInterval; char visibleContentSnapshot; char selectionSnapshot; char filteringContainerContent; char useAssetImportDate; char shouldUpdateImmediately; } _dataSourceRespondsTo;
}
...
@property (nonatomic, getter=isFilteringContainerContent) char filteringContainerContent;
...
@property (nonatomic) char wantsVerboseLogging;
...
@property (nonatomic) char shouldUseSubtitles;
@property (nonatomic) char shouldUseNavigationTitle;
@property (nonatomic) char shouldUseAbbreviatedDates;
@property (nonatomic) char shouldShowLocationNames;
