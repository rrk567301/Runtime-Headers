...
@property (nonatomic) char areStylesFinal;
@property (nonatomic) unsigned long long selectionDataSourceStylesAttributes;
@property (nonatomic) char areSelectionDataSourceStylesFinal;
...
@property (readonly, nonatomic) char isCurrentStyleFinal;
...
@property (readonly, nonatomic) char focusedStyleIsCurrentStyle;
...
- (void)setIsCurrentStyleFinal:(char)a0;
