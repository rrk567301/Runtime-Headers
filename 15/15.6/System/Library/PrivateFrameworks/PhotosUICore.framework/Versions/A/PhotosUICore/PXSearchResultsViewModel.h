@class NSArray, PXSearchResultsSectionedDataSourceManager, PXSearchQueryMatchInfo, PXSearchTopAssetsResult;
...
- (char)hasNoResults;
- (char)isValidSection:(long long)a0;
...
- (char)_resultsAreWordEmbeddingsOnly;
- (char)_sectionIsTopAssetsSection:(long long)a0;
...
- (void)fetchImageForPerson:(id)a0 targetSize:(struct CGSize { double x0; double x1; })a1 displayScale:(double)a2 completion:(id /* block */)a3;
- (char)hasDisplayableSuggestions;
...
- (char)sectionIsExpandable:(long long)a0;
- (char)sectionIsExpanded:(long long)a0;
- (unsigned long long)sectionTypeForSection:(long long)a0;
- (char)shouldDisplayHeaderViewForSection:(long long)a0;
- (char)shouldShowTableFooterView;
...
- (char)topAssetsExistForSection:(long long)a0;
