...
@interface PXGViewMouseSession : NSObject {
    ...
    char _unmodifiedMouseDownInAlreadySelectedItem;
    char _dragSelectShouldModifyExistingSelection;
}
...
@property (readonly, nonatomic) char allowsMultipleSelection;
...
@property (nonatomic) char allowsSelectionModification;
...
- (char)addIndexPathToDeselect:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0;
- (char)addIndexPathToSelect:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0;
- (void)autoscrollAndDragSelectWithLastNonPeriodicEvent;
- (void)autoscrollTimerFired:(id)a0;
- (void)deselectAllNow;
- (char)extendRangeSelectionToIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0;
...
- (char)canAddIndexPathToSelect:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0;
