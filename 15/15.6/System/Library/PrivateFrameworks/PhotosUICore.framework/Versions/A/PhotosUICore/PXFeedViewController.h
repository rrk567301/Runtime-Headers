...
@interface PXFeedViewController : UXViewController <PXGViewMouseSessionDelegate, NSStandardKeyBindingResponding, PXSectionedDirectionSelectionDelegate, PXSelectionContainerProvider, PXFeedViewActionPerformer, PXAssetCollectionActionPerformerDelegate, PXGViewControllerTransitionEndPoint, PXChangeObserver, PXSectionedDataSourceManagerObserver, PXFeedTestElement, PXTapToRadarDiagnosticProvider, PXFeedViewController, PXProgrammaticNavigationParticipant> {
    struct { char handlePrimaryActionOnItemAtIndexPathInDataSourceFromViewController; char navigateToObjectReferenceFromViewControllerAnimatedWillPresentHandlerCompletionHandler; char contextMenuForSelectionPresentationEnvironment; char contextMenuForObjectReferenceInDataSourceSuggestedActions; char deleteItemsInSelectionUndoManager; } _actionPerformerRespondsTo;
}
...
- (char)actionPerformer:(id)a0 transitionToViewController:(id)a1 transitionType:(long long)a2;
...
- (void)_checkCanNavigate:(char *)a0 toDestination:(id)a1 iterator:(id)a2;
- (void)_createMouseSession;
- (void)_deleteItemsInCurrentSelection;
- (void)_extendSelectionInDirection:(unsigned long long)a0;
- (void)_handleCanNavigate:(char)a0 toDestination:(id)a1 objectReference:(id)a2 completionHandler:(id /* block */)a3;
...
- (char)actionPerformer:(id)a0 dismissViewController:(id)a1 completionHandler:(id /* block */)a2;
...
- (char)handlePrimaryActionOnItemAtIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0 inDataSource:(id)a1;
- (char)handleSelectActionOnItemAtIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0 inDataSource:(id)a1;
...
- (char)mouseSession:(id)a0 itemIsControlForHitTestResult:(id)a1;
