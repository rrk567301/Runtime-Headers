...
@property (readonly, nonatomic) char hasImportantInformation;
@property (readonly, nonatomic) char useBlankActionSeparator;
@property (readonly, nonatomic) long long subtitle1Style;
@property (readonly, nonatomic) char isProcessing;
@property (readonly, nonatomic) char showBadge;
...
- (void)setHasImportantInformation:(char)a0;
- (void)setInternalMessageSubtitle:(id)a0;
- (void)setIsProcessing:(char)a0;
- (void)setShowBadge:(char)a0;
- (void)setSubtitle1Style:(long long)a0;
- (void)setUseBlankActionSeparator:(char)a0;
