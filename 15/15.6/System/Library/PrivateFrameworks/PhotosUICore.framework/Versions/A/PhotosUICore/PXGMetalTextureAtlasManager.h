...
@property (nonatomic) char mipmapped;
...
- (id)initWithThumbnailSize:(struct CGSize { double x0; double x1; })a0 pixelFormat:(unsigned long long)a1 capacityPerAtlas:(unsigned int)a2 mipmapped:(char)a3 requestQueue:(id)a4 layoutQueue:(id)a5 colorProgram:(id)a6 context:(id)a7;
