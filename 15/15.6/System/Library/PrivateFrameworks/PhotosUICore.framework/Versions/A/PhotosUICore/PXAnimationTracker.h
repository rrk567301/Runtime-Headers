...
+ (void)_scrollAnimationOccurred:(long long)a0 isBegin:(char)a1;
+ (void)_transitionAnimationOccurred:(long long)a0 fromOrigin:(long long)a1 transitionObject:(id)a2 isBegin:(char)a3;
+ (void)_transitionPreparationOccurred:(long long)a0 fromOrigin:(long long)a1 transitionObject:(id)a2 isBegin:(char)a3;
