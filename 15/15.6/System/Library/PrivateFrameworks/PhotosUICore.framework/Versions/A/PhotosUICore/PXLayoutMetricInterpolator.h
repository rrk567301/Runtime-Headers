...
@interface PXLayoutMetricInterpolator : NSObject {
    struct { char referenceValuesByMetricsOrder; } _needsUpdateFlags;
}
...
+ (double)locketGadgetColumnWidthForLayoutWidth:(struct CGSize { double x0; double x1; })a0 layoutMargins:(double)a1 interSpacing:(double)a2 isPhone:(char)a3;
