@class PXGViewEnvironment, PXAssetsSectionLayout, PXGDecoratingLayout, NSMutableArray, PXGSublayoutDataStore, NSString, NSMutableSet, PXGBasicAXGroup, PXGDataSourceChange, PXGItemsLayout, PXMediaProvider, PXGAnchor, NSArray, NSObject, NSView, PXGEntityManager, PXGSpriteDataStore, PXGSpriteMetadataStore, PXGLayoutSpriteModifier, NSIndexSet, NSHashTable;
@protocol PXGLayoutFocusDelegate, PXGDisplayAssetSource, PXAnonymousCoordinateSpace, PXGLayoutContentSource, PXGLayoutViewDelegate, PXGLayoutScrollDelegate, PXGLayoutVisibleRectDelegate, PXGLayoutSnapshotDataSource, OS_dispatch_queue, PXGAXResponder, PXGLayoutUpdateDelegate;

@interface PXGLayout : NSObject <PXGAXGroupSource, PXGAXInfoSource, PXGAXResponder, PXGDataSourceDrivenLayout, PXGSpriteIndexReferencing, PXGDiagnosticsProvider> {
    ...
    char _isRequestingVisibleRect;
    char _isUpdating;
    char _isUpdatingSpriteStyling;
    char _isUpdatingAnchoring;
    char _isPropagatingAdjustedReferencedHiddenSpriteIndexes;
    char _isLastVisibleAreaAnchoringInformationInvalidated;
    char _isPerformingWithLocalUpdate;
...
@property (readonly, nonatomic) char hasPointReferences;
...
@property (readonly, nonatomic) char shouldInvalidateDecorationForModifiedSprites;
@property (readonly, nonatomic) char shouldUpdateDecorationMediaTargetSizes;
@property (readonly, nonatomic) char shouldDecorateUndefinedMediaKind;
...
@property (readonly, nonatomic) char axShouldSearchLeafsInSubgroups;
@property (readonly, nonatomic) char axShouldBeConsideredAsSubgroup;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } flexibleRegionInsets;
@property (readonly, weak, nonatomic) id<PXGDisplayAssetSource> displayAssetSource;
@property (readonly, nonatomic) struct { char supportedDisplayAssetPresentationStylesInLayout; char minSpriteSizeForPresentationStyle; char displayAssetRequestObserverForSpritesInRangeInLayout; char videoPresentationControllerForDisplayAssetSpriteIndexInLayout; char adjustmentForDisplayAssetSpriteIndexInLayout; char presentationIntentForSpritesInRangeInLayout; char customMediaProviderForDisplayAssetsInLayout; char customPixelBufferSourcesProviderForDisplayAssetsInLayout; char useLowMemoryDecodeInLayout; char shouldApplyCleanApertureCropToStillImagesInLayout; } displayAssetSourceRespondsTo;
@property (readonly, nonatomic) struct { char stringDrawingOptionsForSpriteAtIndexInLayout; char paddingForSpriteAtIndexInLayout; char drawingContextForSpriteAtIndexInLayout; char attributedStringBoundingSizeForSpriteAtIndexInLayout; } stringSourceRespondsTo;
...
@property (readonly, nonatomic) char appliesAlphaToSublayouts;
...
@property (readonly, nonatomic) char allowsDanglingUpdatesAssertions;
@property (readonly, nonatomic) char allowsSublayoutUpdateCycleAssertions;
@property (readonly, nonatomic) char hasSublayoutsRemainingToBeUpdated;
@property (readonly, nonatomic) NSIndexSet *localHiddenSpriteIndexes;
@property (nonatomic) struct CGSize { double width; double height; } contentSize;
@property (readonly, nonatomic) char disableDebugAssertionForAnchorUpdatesWithZeroContentSize;
@property (readonly, nonatomic) char disableDebugAssertionForSublayoutUpdates;
...
@property (readonly, nonatomic) char isUpdatingSpriteStyling;
...
@property (readonly, nonatomic) char canHandleVisibleRectRejection;
...
@property (readonly, nonatomic) char allowsObjectReferenceSpriteIndexLookup;
@property (readonly, nonatomic) NSHashTable *pointReferences;
@property (readonly, nonatomic) char definesContextForPointReferences;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } fullPageSnapshotFloatingInsets;
...
- (void)_invalidateDecorationForSpriteRange:(struct _PXGSpriteIndexRange { unsigned int x0; unsigned int x1; })a0 inLayout:(id)a1 invalidateSprites:(char)a2;
...
- (id)createAnchorForScrollingSpriteAtIndex:(unsigned int)a0 toScrollPosition:(unsigned long long)a1 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2;
...
- (id)_createAnchorWithAnchor:(id)a0 resetPriority:(char)a1;
...
- (void)_enumerateSpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x0; unsigned int x1; })a0 transform:(struct { struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x0; double x1; })a1 spriteOffset:(unsigned int)a2 stop:(char *)a3 usingBlock:(id /* block */)a4;
...
- (void)_setNeedsUpdateExternally:(char)a0;
...
- (char)changeVisibleRectToProposedVisibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (id)createAnchorForScrollingSpriteForObjectReference:(id)a0 toScrollPosition:(unsigned long long)a1 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2;
...
- (id)createAnchorForScrollingSpriteForSpriteReference:(id)a0 toScrollPosition:(unsigned long long)a1 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2;
- (id)createAnchorForScrollingSpriteForSpriteReference:(id)a0 toScrollPosition:(unsigned long long)a1 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2 customOffset:(id /* block */)a3;
- (id)createAnchorForScrollingToContentEdges:(unsigned long long)a0 padding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1;
...
- (id)createAnchorFromSuperlayoutWithSublayoutIndex:(long long)a0 sublayoutPositionEdges:(unsigned long long)a1 ignoringScrollingAnimationAnchors:(char)a2;
...
- (unsigned long long)fullyVisibleEdgesWithEdgeTolerances:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a0;
...
- (char)isDescendantOfLayout:(id)a0;
...
- (char)shouldApplyItemChangeDetailsToSublayout:(id)a0;
- (char)shouldApplySpriteTransformToSublayouts;
...
- (id)sublayoutAtIndex:(long long)a0 loadIfNeeded:(char)a1;
