...
@property (nonatomic) char ignorePastResults;
...
@property (nonatomic) char wordEmbeddingsRequested;
...
- (char)isSectionExpandable:(long long)a0;
- (char)isSectionExpanded:(long long)a0;
- (char)isTopAssetsSection:(long long)a0;
- (void)mergePendingChanges;
- (long long)numberOfVisibleSearchResultsInSection:(long long)a0;
- (char)searchIsFinished:(id)a0;
