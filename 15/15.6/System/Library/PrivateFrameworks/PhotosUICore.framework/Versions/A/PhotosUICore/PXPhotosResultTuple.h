...
@property (readonly, nonatomic) char fetchedWithReverseSortOrder;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithFetchResult:(id)a0 fetchedWithReverseSortOrder:(char)a1 curatedFetchResult:(id)a2 curatedRefetchCondition:(id /* block */)a3 keyAssetsFetchResult:(id)a4 filterPredicate:(id)a5;
