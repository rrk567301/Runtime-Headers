...
@protocol OS_dispatch_queue, OS_os_log, PXStoryMovieHighlightsCollection, PXDisplayAssetCollection, PXStoryChapterCollection, PXDisplayAssetFetchResult;
...
+ (struct { long long x0; long long x1; })audioModeDecisionForAsset:(id)a0 minimumAudioScore:(float)a1 playbackStyle:(long long)a2 movieHighlight:(id)a3 storyConfiguration:(id)a4;
...
- (void)_audioCutsFromClip:(id)a0 toClip:(id)a1 useJCut:(char *)a2 useLCut:(char *)a3;
- (char)_canOverlapAudioFromClip:(id)a0 withNextClip:(id)a1;
- (char)_canOverlapAudioFromClip:(id)a0 withPreviousClip:(id)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_clipRangeForMoment:(id)a0 inClips:(id)a1;
...
- (char)handlesDiagnosticTextForHUDType:(long long)a0;
