...
+ (char)isAnySmartAlbumAvailableInPhotoLibrary:(id)a0;
...
- (id)initWithPhotoLibrary:(id)a0 changeObserver:(id)a1 registerForPhotoLibraryChanges:(char)a2 centerMedia:(id)a3;
- (void)setupPreviewAssets;
- (char)shouldIncludeCenterMediaWithPreviewAssets:(id)a0;
