...
@property (readonly, nonatomic) char hasPrimaryImageContent;
@property (copy, nonatomic) NSString *label;
@property (nonatomic) char backgroundExtendsUnderLabel;
@property (copy, nonatomic) NSString *badgeSystemImageName;
@property (copy, nonatomic) NSArray *badgeSystemImageColors;
@property (readonly, nonatomic) char hasBadgeImageContent;
...
@property (nonatomic) char applyTintColorAsHierarchicalColor;
@property (nonatomic) char backgroundColorAdaptsToHoveredState;
