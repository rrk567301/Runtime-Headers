...
@property (readonly, nonatomic) char isLemonadeHome;
...
@property (readonly, nonatomic) char renderAlbumAssetsWithDeferredProcessing;
@property (readonly, nonatomic) char displayAlbumOptions;
@property (readonly, nonatomic, getter=isTargetingAsset) char targetingAsset;
@property (readonly, nonatomic, getter=isTargetingAlbum) char targetingAlbum;
@property (readonly, nonatomic) char wantsEditMode;
@property (readonly, copy, nonatomic) NSString *completionKey;
@property (readonly, copy, nonatomic) NSString *libraryViewMode;
@property (readonly, nonatomic) char shouldExcludeSidebar;
...
- (char)isEqualToNavigationDestination:(id)a0;
...
- (char)isEquivalentToNavigationDestination:(id)a0;
