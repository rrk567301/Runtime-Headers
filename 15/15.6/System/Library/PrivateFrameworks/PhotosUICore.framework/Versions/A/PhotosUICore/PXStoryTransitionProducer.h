...
+ (char)isSupportedTransitionWithKind:(char)a0 betweenSegmentWithClipComposition:(struct { long long x0; char x1; long long x2; double x3; long long x4; })a1 andSegmentWithClipComposition:(struct { long long x0; char x1; long long x2; double x3; long long x4; })a2;
+ (char)isSupportedTransitionWithKind:(char)a0 fromSegmentIdentifier:(long long)a1 toSegmentIdentifier:(long long)a2 inTimeline:(id)a3;
