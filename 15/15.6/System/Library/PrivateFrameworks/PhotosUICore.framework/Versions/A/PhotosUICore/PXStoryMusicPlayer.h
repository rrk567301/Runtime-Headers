...
@property (nonatomic) char shouldDuckForCurrentTouch;
...
@property (readonly, nonatomic) char targetDurationMatchesTimeline;
@property (readonly, nonatomic) float volume;
@property (nonatomic) char isDucked;
...
- (id)initWithModel:(id)a0 targetDurationMatchesTimeline:(char)a1;
