...
@property (nonatomic) char stateQueue_isPreparingToPlay;
@property (nonatomic) char stateQueue_hasSeekedOrPlayed;
@property (nonatomic) char stateQueue_shouldPlayWhenPrepared;
...
- (void)_handlePlayerPreparedToPlay:(char)a0 error:(id)a1;
- (void)_handlePlayerTransactionDeclinedWithError:(id)a0;
- (void)_stateQueue_handlePlayerPreparedToPlay:(char)a0 error:(id)a1;
