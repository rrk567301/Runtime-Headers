...
@interface PXStoryResourcesPreloader : PXObservable <PXStoryMutableResourcesPreloader, PXStoryQueueParticipant> {
    char _stateQueue_isLoadingLikelyToKeepUpWithPlaybackWasSet;
    char _stateQueue_isLoadingLikelyToKeepUpWithPlayback;
    ...
    char _estimationQueue_sessionStarted;
...
@property (readonly, nonatomic) char isLoadingLikelyToKeepUpWithPlayback;
...
- (id)previousRequest;
- (void)_accumulateLoadedTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 moreExpected:(char)a1;
...
- (void)_stateQueue_accumulateLoadedTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 moreExpected:(char)a1;
...
- (id)initWithMediaProvider:(id)a0 displayScale:(double)a1 videoSessionManager:(id)a2 loadingStatusReporter:(id)a3 storyQueue:(id)a4 isExporting:(char)a5 isInline:(char)a6;
- (long long)lagsCount;
- (void)setIsLoadingLikelyToKeepUpWithPlayback:(char)a0;
