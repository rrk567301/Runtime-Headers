...
@property (readonly, nonatomic) char selectionEnabled;
@property (readonly, nonatomic) char oneUpDisabled;
...
@property (readonly, nonatomic) char shouldShowPlaceholder;
@property (readonly, nonatomic) char containsUnverifiedPersons;
@property (readonly, nonatomic, getter=isLoadingPeopleSuggestions) char loadingPeopleSuggestions;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
- (void)setShouldShowPlaceholder:(char)a0;
