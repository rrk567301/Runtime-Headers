...
@property (readonly, nonatomic) char applyCleanApertureCrop;

- (void).cxx_destruct;
- (id)initWithDisplayAssetFetchResult:(id)a0 observer:(id)a1 presentationStyles:(unsigned long long)a2 targetSize:(struct CGSize { double x0; double x1; })a3 screenScale:(double)a4 screenMaxHeadroom:(double)a5 adjustment:(id)a6 intent:(unsigned long long)a7 useLowMemoryDecode:(char)a8 applyCleanApertureCrop:(char)a9 mediaProvider:(id)a10;
