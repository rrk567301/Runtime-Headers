...
- (void)_getTitle:(id *)a0 buttonTitle:(id *)a1 assetCollectionReference:(id *)a2 forDataSource:(id)a3 sectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a4;
...
- (void)sectionedLayout:(id)a0 headerLayout:(id)a1 didChangeDataSource:(id)a2 sectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a3 hasSectionChanges:(char)a4;
