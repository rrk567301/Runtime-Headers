...
- (void)imageForIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)imageForModel:(id)a0 ofSize:(unsigned long long)a1 allowLowerResolutions:(char)a2 completion:(id /* block */)a3;
- (id)imageForModel:(id)a0 ofSize:(unsigned long long)a1 allowLowerResolutions:(char)a2 foundSize:(unsigned long long *)a3;
