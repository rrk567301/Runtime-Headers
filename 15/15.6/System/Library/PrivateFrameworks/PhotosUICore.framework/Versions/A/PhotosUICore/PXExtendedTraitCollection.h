...
@interface PXExtendedTraitCollection : PXObservable <PXMutableExtendedTraitCollection> {
    struct { char viewSize; char layoutReferenceSize; char traitCollection; char layoutSizeClass; char layoutDirection; char layoutOrientation; char contentSizeCategory; char displayScale; char safeAreaInsets; char peripheryInsets; char layoutMargins; char userInterfaceIdiom; char userInterfaceFeature; char userInterfaceStyle; char userInterfaceLevel; char windowReferenceSize; char windowOrientation; } _needsUpdateFlags;
}
...
@property (nonatomic, readonly) char insideCollectionDetailsView;
