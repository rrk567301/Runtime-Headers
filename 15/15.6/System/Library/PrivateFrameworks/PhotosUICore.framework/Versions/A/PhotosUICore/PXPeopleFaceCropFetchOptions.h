...
@property (class, readonly, nonatomic) char shouldUseLemonadeRoundedCorners;
...
@property (nonatomic) char wantsFlippedContentsRect;
@property (nonatomic) long long deliveryMode;
@property (nonatomic) char isSynchronous;
@property (nonatomic) char shouldCacheResult;
@property (nonatomic) char wantsSmallFaceRect;
...
- (char)areFetchParametersEqualtoFetchParametersOfOptions:(id)a0;
