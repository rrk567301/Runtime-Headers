...
+ (char)_isSupportedTransitionWithKind:(char)a0 forClipWithResourceKind:(long long)a1;
...
- (char)_canStartTransitionWithKind:(char)a0;
...
- (void)setCurrentSegmentIdentifier:(long long)a0 allowTransitions:(char)a1;
