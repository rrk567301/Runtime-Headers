...
@interface PXPhotosSectionedLayout : PXGStackLayout <PXGSublayoutProvider, PXChangeObserver, PXGSublayoutFaultingDelegate, PXAssetsSectionLayoutDelegate, PXPhotosSectionBodyLayoutProviderInvalidationDelegate, PXPhotosSectionHeaderLayoutProviderInvalidationDelegate, PXBlurrableSectionsSource, PXGCaptureSpriteSource> {
    ...
    char _isRecreatingContentLayouts;
    char _shouldRecreateHeaderLayouts;
    char _shouldRecreateBodyLayouts;
    char _isUpdatingSublayouts;
    struct { char invalidationDelegate; char floatingHeaderSnapshot; char configureSectionHeaderLayout; } _headerProviderRespondsTo;
...
- (id)axSpriteIndexes;
- (char)_configureSectionLayout:(id)a0 sectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a1;
...
- (char)_shouldFaultInSection:(long long)a0 inDataSource:(id)a1;
