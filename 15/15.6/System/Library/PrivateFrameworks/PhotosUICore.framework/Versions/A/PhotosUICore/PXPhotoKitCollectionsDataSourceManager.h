...
@property (nonatomic) char isChangeProcessingPaused;
...
- (char)_needsFetchResultForCollection:(id)a0;
- (void)startBackgroundFetchingIfNeeded;
- (void)_cancelAllBackgroundFetches;
- (id)_changedSubCollectionIndexesBySections;
- (char)_containsAnyAlbumsWithAssets:(id)a0;
- (char)_containsAnyAssets:(id)a0;
...
- (char)_isImportsAssetCollection:(id)a0;
- (char)_isPlacesAlbumAssetCollection:(id)a0;
- (id)_keyAssetFetchResultForSubCollection:(id)a0 fetchIfNeeded:(char)a1;
- (char)_needsKeyAssetsFetchResultForCollection:(id)a0;
- (id)_newDataSource;
...
- (char)_shouldIncludeCollection:(id)a0;
- (id)_subitemChangeDetailsByItemBySection;
- (char)_updateCachedSubCollectionFetchResultsForChange:(id)a0 fetchResultChangeDetails:(id)a1;
...
- (id)assetsFetchResultForCollection:(id)a0 fetchIfNeeded:(char)a1;
- (char)canDeleteCollection:(id)a0;
- (char)canRenameCollection:(id)a0;
- (char)canReorderCollection:(id)a0;
...
- (char)containsAnyAssets:(id)a0;
- (id)customFetchOptionsForCollection:(id)a0;
- (id)displayableAssetsForCollectionList:(id)a0 maximumCount:(long long)a1 useCache:(char)a2 correspondingCollections:(out id *)a3;
- (long long)estimatedCountForAssetCollection:(id)a0;
- (id)fetchResultForSubCollection:(id)a0;
- (void)getDisplayableAssets:(id *)a0 indexes:(id *)a1 forCollection:(id)a2 maximumCount:(long long)a3 useCache:(char)a4;
- (char)hasAssetsFetchResultForCollection:(id)a0;
- (unsigned long long)indexOfFirstReorderableCollection;
- (id)indexPathForCollection:(id)a0;
- (char)isBackgroundFetching;
- (char)isCachedFetchResultOutdatedForCollection:(id)a0;
- (id)keyAssetsFetchResultForCollection:(id)a0;
- (id)keyAssetsFetchResultForCollection:(id)a0 fetchIfNeeded:(char)a1;
