...
@property (readonly, nonatomic) char isTopSafeAreaFullyCovered;
@property (readonly, nonatomic) char allowsPaginatedScrollingInYearsAndMonths;
@property (readonly, nonatomic) char allowsSlideshowInYears;
...
@property (readonly, nonatomic) char wantsStatusBarGradient;
@property (readonly, nonatomic) char wantsBlurredSecondaryToolbarTransition;
@property (readonly, nonatomic) char wantsBlurredBackground;
...
- (char)shouldExcludeNonLibraryRelatedActionsFromTopLevelEllipsisMenuForZoomLevel:(long long)a0;
