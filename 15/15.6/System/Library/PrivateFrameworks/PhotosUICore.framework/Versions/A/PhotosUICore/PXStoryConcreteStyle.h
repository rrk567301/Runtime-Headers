...
@property (readonly, nonatomic) struct { unsigned long long croppingOptions; char preferStillKeySegment; } styleOptions;
...
+ (id)bestClipCompositionFromClipCompositions:(id)a0 forKeyAsset:(id)a1 contentInfo:(const struct { struct CGSize { double x0; double x1; } x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x3; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x4; } *)a2 playbackStyle:(long long)a3 spec:(id)a4 croppingContext:(id)a5 options:(unsigned long long)a6 loggingOptions:(unsigned long long)a7;

- (id)description;
- (void).cxx_destruct;
- (id)createRandomNumberGenerators;
- (id)initWithCustomColorGradeKind:(long long)a0 originalColorGradeCategory:(id)a1 songResource:(id)a2 cueSource:(id)a3 autoEditDecisionList:(id)a4 styleOptions:(struct { unsigned long long x0; char x1; })a5 isCustomized:(char)a6 storyConfiguration:(id)a7;
