...
- (void)_getTitle:(id *)a0 subtitle:(id *)a1 isNew:(char *)a2 forDataSource:(id)a3 sectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a4;
