...
@interface PXAutoScroller : NSObject {
    struct { char didAutoscrollWithTimestamp; } _delegateRespondsTo;
}
...
@property (nonatomic, getter=_isRepeating, setter=_setRepeating:) char _repeating;
...
- (char)autoscrollWithOffset:(struct CGPoint { double x0; double x1; })a0;
