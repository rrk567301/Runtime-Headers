...
@property (nonatomic) char disableDisplayCompositing;
@property (readonly, nonatomic) struct { char allowHDR; unsigned long long requiredColorSpace; unsigned long long requiredPixelFormat; } displayConfiguration;
...
@property (readonly, nonatomic) char canSetColorSpace;
...
- (void).cxx_destruct;
- (void)present;
- (id)initWithDisplayConfiguration:(struct { char x0; unsigned long long x1; unsigned long long x2; })a0;
