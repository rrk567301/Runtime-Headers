...
@interface _PXCuratedLibraryLayoutAssetsSnapshot : NSObject {
    ...
    struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; float x1; char x2; } *_spriteSnapshots;
}
