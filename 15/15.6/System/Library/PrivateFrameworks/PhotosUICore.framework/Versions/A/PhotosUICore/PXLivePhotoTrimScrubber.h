@class UXView, AVVideoComposition, PXTrimScrubberLayoutHelper, NSArray, PXExtendedTraitCollection, PXLivePhotoTrimScrubberLoupeView, NSImage, PXLivePhotoTrimScrubberHiddenAnimationHelper, UXImageView, PXLivePhotoTrimScrubberSpec, AVAsset;
...
@interface PXLivePhotoTrimScrubber : UXView {
    ...
    struct { char respondsToDidTapElement; char respondsToDidBeginInteractivelyEditingElement; char respondsToCanBeginInteractivelyEditingElement; char respondsToDidEndInteractivelyEditingElement; char respondsToDidChangeTimeForElement; char respondsToAssetDurationDidChange; char respondsToDidChangeLoupeRect; char respondsToDidZoomToMinimumValueMaximumValue; char respondsToDidUnzoom; char respondsToPausePlayer; char respondsToDidLayoutSubviews; char respondsToDebugStartRect; char respondsToDebugEndRect; char respondsToDebugStartOffset; char respondsToDebugEndOffset; } _delegateFlags;
...
@property (class, readonly, nonatomic) NSImage *trimStartImage;
@property (class, readonly, nonatomic) NSImage *trimStartHighlightedImage;
@property (class, readonly, nonatomic) NSImage *trimEndImage;
@property (class, readonly, nonatomic) NSImage *trimEndHighlightedImage;
@property (class, readonly, nonatomic) NSImage *trimStartImageMini;
@property (class, readonly, nonatomic) NSImage *trimStartHighlightedImageMini;
@property (class, readonly, nonatomic) NSImage *trimEndImageMini;
@property (class, readonly, nonatomic) NSImage *trimEndHighlightedImageMini;
...
@property (readonly, nonatomic) UXView *_preTrimOverlayView;
@property (readonly, nonatomic) UXView *_postTrimOverlayView;
...
@property (readonly, nonatomic) UXImageView *trimStartHandle;
@property (readonly, nonatomic) UXImageView *trimEndHandle;
@property (nonatomic) char showVideoScrubberDebugOverlay;
...
@property (readonly, nonatomic, getter=isAssetDurationLoaded) char assetDurationLoaded;
...
@property (nonatomic) char useMiniScrubber;
@property (nonatomic) char allowZoom;
...
- (char)isValidKeyTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
...
- (void)_setKeyTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 canHaveImpact:(char)a1 forElement:(long long)a2;
- (void)_setPhotoLoupeHidden:(char)a0 animated:(char)a1;
- (void)_setTrimControlsHidden:(char)a0 animated:(char)a1;
- (void)_setupZoom;
...
- (void)handleEndTracking:(char)a0;
...
- (void)setPlayheadStyle:(unsigned long long)a0 animate:(char)a1;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })timeAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)tryZoomAtTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
