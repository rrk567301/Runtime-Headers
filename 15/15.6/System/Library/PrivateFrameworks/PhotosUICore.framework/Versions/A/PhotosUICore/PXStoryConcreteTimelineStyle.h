@class PXStoryConfiguration, NSArray, NSMutableDictionary, PXStoryRecipeClipMotionStyleProvider, PXStoryRecipeClipTransitionProvider, PXStoryMultipartPanoramaParameters, PFStoryAutoEditConfiguration;
...
@interface PXStoryConcreteTimelineStyle : NSObject <PXStoryTimelineStyle> {
    ...
    long long _songPace;
    struct { unsigned long long croppingOptions; char preferStillKeySegment; } _styleOptions;
    unsigned long long _keyAssetCroppingOptions;
    unsigned long long _otherAssetsCroppingOptions;
    char _allowsDefaultTransitions;
    char _allowsRandomTransitionFallback;
    NSArray *_possibleFallbackTransitionKinds;
    char _allowsDefaultSeparatorEffects;
    char _allowsRandomSeparatorEffectsFallback;
    char _allowsDefaultKenBurns;
    char _allowsRandomKenBurnsFallback;
    ...
    char _didInitializeDefaultMultipartPanoramaParameters;
...
@property (readonly, nonatomic) char allowsKenBurnsAnimations;
...
@property (readonly, nonatomic) char allowsIncompleteTimelines;

- (id)init;
- (void).cxx_destruct;
- (id)_clipForDisplayAsset:(id)a0;
- (id)_clipForDisplayAssets:(id)a0;
- (struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; struct { long long x0; int x1; unsigned int x2; long long x3; } x2; struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; long long x1; } x3; char x4; })_durationInfoForClip:(id)a0 startTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 croppingContext:(id)a2;
- (void)_ensureDefaultMultipartPanoramaParameters;
- (void)_getOneUpKenBurnsParameters:(struct { struct { struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x0; } x0; struct { struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x0; } x1; } *)a0 forDisplayAsset:(id)a1 motionInfo:(const struct { long long x0; union { struct { unsigned long long x0; unsigned long long x1; } x0; struct { unsigned long long x0; } x1; struct { unsigned long long x0; } x2; } x1; } *)a2 motionParameters:(const struct { double x0; double x1; double x2; double x3; } *)a3 factory:(id)a4;
- (struct { double x0; double x1; double x2; double x3; })_kenBurnsMotionParametersForDuration:(double)a0;
- (struct { char x0; unsigned char x1; struct { long long x0; int x1; unsigned int x2; long long x3; } x2; char x3; union { char x0; char x1; char x2; char x3; } x4; union { double x0; double x1; char x2; } x5; })_transitionInfoForClip:(id)a0 isKeyAsset:(char)a1;
...
- (char)allowsMultipartPanoramaForDisplayAsset:(id)a0 startTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
...
- (struct { long long x0; int x1; unsigned int x2; long long x3; })durationForVerticallyPanningPortraitAsset:(id)a0 atSpeed:(double)a1 motionInfo:(struct { long long x0; union { struct { unsigned long long x0; unsigned long long x1; } x0; struct { unsigned long long x0; } x1; struct { unsigned long long x0; } x2; } x1; })a2 minimumDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a3 croppingContext:(id)a4;
...
- (id)initWithSpec:(id)a0 audioAsset:(id)a1 cueSource:(id)a2 overallDurationInfo:(struct { long long x0; struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; struct { long long x0; int x1; unsigned int x2; long long x3; } x2; } x1; })a3 autoEditDecisionList:(id)a4 autoEditConfiguration:(id)a5 allowedKeyAssetClipCompositions:(id)a6 allowedClipCompositions:(id)a7 randomNumberGenerators:(id)a8 errorReporter:(id)a9 allowsIncompleteTimelines:(char)a10 styleOptions:(struct { unsigned long long x0; char x1; })a11 storyConfiguration:(id)a12;
- (char)isOriginalPlaybackStyleAllowedInNUp:(long long)a0;
