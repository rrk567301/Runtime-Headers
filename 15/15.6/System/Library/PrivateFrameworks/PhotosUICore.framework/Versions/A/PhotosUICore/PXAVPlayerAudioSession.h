...
@property (readonly, nonatomic) char isPreparingToPlay;
@property (readonly, nonatomic) char isPlaybackDesired;
@property (readonly, nonatomic) float playerRate;
@property (nonatomic) char playerTimeHasChangedSinceSeeking;
...
- (void)setIsPlaybackDesired:(char)a0;
- (void)setIsPreparingToPlay:(char)a0;
