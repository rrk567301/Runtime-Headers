...
+ (void)didAdjustSprites:(struct { unsigned int x0; struct *x1; struct *x2; struct *x3; struct *x4; })a0 forAnimation:(id)a1 appearing:(char)a2;
...
+ (void)willAdjustSprites:(struct { unsigned int x0; struct *x1; struct *x2; struct *x3; struct *x4; })a0 forAnimation:(id)a1 appearing:(char)a2;
