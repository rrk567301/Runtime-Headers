...
- (void).cxx_destruct;
- (void)_requestTextureForImageWithName:(id)a0 inBundle:(id)a1 isSystemImage:(char)a2 tintColor:(id)a3 imageConfiguration:(id)a4 userInterfaceDirection:(unsigned long long)a5 screenScale:(double)a6 requestID:(int)a7;
