...
@property (readonly, nonatomic) char shouldFloat;
@property (readonly, nonatomic) char shouldAbbreviateMonth;
...
@property (readonly, nonatomic) char shouldAlwaysShowFloatingVersion;
