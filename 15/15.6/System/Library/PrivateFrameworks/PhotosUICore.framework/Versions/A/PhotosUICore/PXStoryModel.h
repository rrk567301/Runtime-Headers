@class PXVideoSessionManager, PXNumberAnimator, PXStoryStyleManager, NSUndoManager, AVAudioSession, PXAssetReference, PXStoryAnimationController, NSMutableArray, PXStoryTimelineManager, NSString, NSMutableSet, PXStoryLayoutSpecManager, PXStoryResourcesDataSourceManager, NSObject, NSSet, PXUpdater, PXStoryViewModeTransition, PXStoryLoadingStatusReporter, PXDisplayRect, PXStoryChapterCollectionManager, PXExtendedTraitCollection, PXStoryRecipeManager, PXStoryConfiguration, NSDate, NSMapTable, NSIndexSet, NSHashTable;
...
@property (nonatomic) char didReachOutroOnce;
@property (nonatomic) char didPrerequestPersistencePermission;
...
@property (readonly, nonatomic) char isActuallyPlaying;
...
@property (readonly, nonatomic) char shouldAutoplayThumbnail;
...
@property (readonly, nonatomic) char shouldUseInactiveImageFilter;
...
@property (readonly, nonatomic) char shouldAspectFitCurrentSegment;
@property (readonly, nonatomic) PXStoryViewModeTransition *viewModeTransition;
@property (readonly, nonatomic) char prefersExportLayoutMatchesPlayback;
...
@property (readonly, nonatomic) char allowsScrolling;
@property (readonly, nonatomic) char isTouching;
@property (readonly, nonatomic) char isHovering;
@property (readonly, nonatomic) char isPresentingAssetPicker;
@property (readonly, nonatomic) char isPresentingMusicEditor;
@property (readonly, nonatomic) char isPresentingColorGradeEditor;
@property (readonly, nonatomic) char isPerformingViewControllerTransition;
@property (readonly, nonatomic) char isPresentingAnyAlert;
...
@property (readonly, nonatomic) char isFirstSegmentVisible;
@property (readonly, nonatomic) char isLastSegmentVisible;
...
@property (readonly, nonatomic) char currentAssetCollectionIsFavorite;
@property (readonly, nonatomic) id<PXStoryChapter> currentChapter;
@property (readonly, nonatomic) char currentChapterTitleIsVisible;
...
@property (readonly, nonatomic) char isAsync;
@property (readonly, nonatomic) char isInline;
@property (readonly, nonatomic) char inLiveResize;
@property (readonly, nonatomic) char shouldPauseTransitions;
...
@property (readonly, nonatomic) char isHUDVisible;
...
@property (readonly, nonatomic) char wantsMusicDucked;
...
- (void)didEndPresentingAlertWithToken:(id)a0;
- (void)performWithPrerequestedPersistencePermission:(id /* block */)a0 forUserActionKind:(long long)a1;
...
- (void)_completePersistenceRequestsWithSuccess:(char)a0 error:(id)a1;
...
- (char)_isPlaceholderPresentInSegmentWithIdentifier:(long long)a0;
...
- (void)flickedPastEnd;
- (char)getMainVisibleClipIdentifier:(out long long *)a0 assetReferece:(id *)a1;
...
- (void)performedUserActionKind:(long long)a0;
- (id)photoKitAssetContainerWithAssetCollection:(id)a0;
...
- (void)requestPersistencePermissionForUserActionKind:(long long)a0 completionHandler:(id /* block */)a1;
- (void)requestPersistencePermissionForUserActionKind:(long long)a0 withTimeout:(double)a1 completionHandler:(id /* block */)a2;
- (void)restartPlaybackFromBeginning;
- (char)rewindToBeginningOfCurrentSegment;
...
- (void)setCurrentAssetCollectionIsFavorite:(char)a0;
...
- (char)setCurrentSegmentIdentifier:(long long)a0 timeIntoSegment:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 timeLeftInSegment:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 changeSource:(unsigned long long)a3;
...
- (void)setInactiveImageFilterIntensity:(double)a0;
- (void)setIsActuallyPlaying:(char)a0;
- (void)setIsAtPlaybackEnd:(char)a0;
- (void)setIsHUDVisible:(char)a0;
- (void)setIsPerformingViewControllerTransition:(char)a0;
- (void)setIsPresentingAnyAlert:(char)a0;
- (void)setIsPresentingAssetPicker:(char)a0;
- (void)setIsPresentingColorGradeEditor:(char)a0;
- (void)setIsPresentingMusicEditor:(char)a0;
- (void)setIsTouching:(char)a0;
...
- (void)setPersistedAssetCollection:(id)a0;
...
- (void)setPrefersExportLayoutMatchesPlayback:(char)a0;
...
- (void)setShouldAspectFitCurrentSegment:(char)a0;
- (void)setShouldAutoplayThumbnail:(char)a0;
- (void)setShouldPauseTransitions:(char)a0;
...
- (void)setWantsMusicDucked:(char)a0;
