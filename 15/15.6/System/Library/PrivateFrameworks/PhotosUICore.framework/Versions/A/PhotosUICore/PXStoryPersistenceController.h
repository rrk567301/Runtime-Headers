...
@property (nonatomic) char persisted;
...
- (void)_ensureWriter;
- (void)_handleWriteSuccess:(char)a0 createdAssetCollection:(id)a1 error:(id)a2 forPersistableRecipe:(id)a3 recipeAssetEdits:(id)a4;
