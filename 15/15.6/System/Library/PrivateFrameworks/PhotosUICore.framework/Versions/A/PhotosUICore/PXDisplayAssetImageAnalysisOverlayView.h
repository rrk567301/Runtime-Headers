...
@property (nonatomic) char shouldHideTextHighlights;
...
+ (char)changedImageAnalysisOverlayNeededForViewModelChange:(unsigned long long)a0;
+ (char)isImageAnalysisOverlayNeededForViewModel:(id)a0;
...
- (char)imageAnalysisOverlay:(id)a0 shouldHandleKeyDownEvent:(id)a1;
...
- (char)_isPointInside:(struct CGPoint { double x0; double x1; })a0;
