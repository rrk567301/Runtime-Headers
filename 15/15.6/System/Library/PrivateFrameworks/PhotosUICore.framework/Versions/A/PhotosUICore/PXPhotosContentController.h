...
@property (readonly, nonatomic) char needsCountsInitially;
@property (readonly, nonatomic) char needsFooterStatusController;
...
@property (nonatomic) char shouldEnablePlaybackDuringAnimatedScroll;
...
- (char)canPlay:(id)a0;
- (char)canSelectObjectAtIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0 inDataSource:(id)a1;
- (void)contentViewDidAppear:(char)a0;
- (void)contentViewDidDisappear:(char)a0;
- (void)contentViewDidScrollToInitialPosition;
- (void)contentViewWillAppear:(char)a0;
...
- (char)isDisplayAssetEligibleForPlaybackWithSettlingEffect:(id)a0;
- (char)isScrolledAtOrAboveDetent:(id)a0;
...
- (void)scrollToDetent:(id)a0 animated:(char)a1;
- (void)scrollToInitialPositionAnimated:(char)a0 withCompletionHandler:(id /* block */)a1;
- (void)scrollToNeighboringSectionInDirection:(unsigned long long)a0 animated:(char)a1;
...
- (char)shouldEnablePlaybackFor:(id)a0;
...
- (void)swift_contentViewDidAppear:(char)a0;
- (void)swift_contentViewDidDisappear:(char)a0;
- (void)swift_contentViewDidScrollToInitialPosition;
- (void)swift_contentViewWillAppear:(char)a0;
- (void)swift_init;
