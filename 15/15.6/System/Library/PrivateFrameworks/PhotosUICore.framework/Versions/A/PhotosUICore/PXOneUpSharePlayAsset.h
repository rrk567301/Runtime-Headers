...
@property (nonatomic) char isSpatialPresentation;
...
- (id)initWithUUID:(id)a0 mediaType:(long long)a1 mediaSubtypes:(unsigned long long)a2 spatialMediaType:(short)a3 isSpatialPresentation:(char)a4 playbackStyle:(long long)a5 pixelWidth:(unsigned long long)a6 pixelHeight:(unsigned long long)a7 duration:(double)a8 hdrGain:(id)a9 focalLength:(id)a10 focalLengthIn35mm:(id)a11 photoIrisStillDisplayTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a12 photoIrisVideoDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a13 localizedGeoDescription:(id)a14 creationDate:(id)a15;
- (char)isPartOfStack;
