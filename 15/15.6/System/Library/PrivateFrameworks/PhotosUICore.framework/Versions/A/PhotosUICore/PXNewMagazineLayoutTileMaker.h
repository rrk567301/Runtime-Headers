...
@property (nonatomic) char layoutFromRightToLeft;
...
- (char)_findNextTileWithInputs:(id)a0 atIndex:(unsigned long long)a1 baseIndex:(unsigned long long)a2 coordinator:(id)a3;
...
- (id)_generateLastTilesWithInputs:(id)a0 baseIndex:(unsigned long long)a1 returnFallback:(char)a2;
- (char)_generateNextChunkWithInputs:(id)a0 fromIndex:(unsigned long long)a1 maxY:(unsigned long long)a2 reserveNumberForPadding:(unsigned long long)a3 context:(id)a4;
...
- (char)_isSameRectsArray:(id)a0 otherArray:(id)a1;
...
- (char)checkAndPrintResults:(char)a0;
- (char)convertRects:(struct PXMagazineRect { struct PXMagazineOrigin { long long x0; long long x1; } x0; struct PXMagazineSize { long long x0; long long x1; } x1; } *)a0 outFrames:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1 count:(unsigned long long)a2 forReferenceSize:(struct CGSize { double x0; double x1; })a3;
