...
- (void).cxx_destruct;
- (id)_setupTitleFont;
- (char)_isSupportedCharacterSetForFontDescriptor:(id)a0 fontSize:(double)a1 string:(id)a2 supportedCharacterAttributes:(id)a3 leading:(double)a4;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_languageAwareOutsetsForFont:(id)a0;
- (id)_setupSubtitleAttributesWithAllCharactersSupported:(char)a0;
- (id)_setupSubtitleFont;
- (id)_setupTitleAttributesWithAllCharactersSupported:(char)a0;
