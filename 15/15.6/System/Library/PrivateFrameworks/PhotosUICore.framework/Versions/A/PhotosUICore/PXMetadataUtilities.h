...
+ (char)isVisionProAsset:(id)a0;
+ (id)localizedFileFormatForItem:(id)a0;
+ (id)megaPixelsDisplayStringForItem:(id)a0 isAccessibility:(char)a1;
...
+ (id)resolutionDisplayStringForItem:(id)a0 isAccessibility:(char)a1;
