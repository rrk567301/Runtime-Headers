...
@property (readonly, nonatomic) char thumbnailChromeShowsPlayButton;
...
@property (readonly, nonatomic) char thumbnailChromeShowsActionMenuButton;
@property (readonly, nonatomic) char thumbnailChromeShowsFavoriteButton;
@property (readonly, nonatomic) char thumbnailMenuIncludesFavoriteAction;
@property (readonly, nonatomic) char thumbnailMenuIncludesFeatureLessAction;
@property (readonly, nonatomic) char canScaleWhenPressed;
...
@property (readonly, nonatomic) char styleSwitcherWantsChromeButtonsTitleCenterAligned;
@property (readonly, nonatomic) char styleSwitcherShowsRestartButton;
...
@property (readonly, nonatomic) char styleSwitcherShowsTitle;
