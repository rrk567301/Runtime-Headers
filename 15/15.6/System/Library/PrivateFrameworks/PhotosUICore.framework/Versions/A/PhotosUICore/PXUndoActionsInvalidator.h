...
@property (nonatomic, getter=isObservingApplicationState) char observingApplicationState;
@property (nonatomic) char applicationIsActive;
@property (retain, nonatomic) NSTimer *undoClearingTimer;
@property (nonatomic) char timerDidClearUndoStack;
