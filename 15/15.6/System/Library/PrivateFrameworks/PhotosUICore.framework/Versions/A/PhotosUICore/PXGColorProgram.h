...
@property (readonly, nonatomic) char needsHDRToSDRConversion;
...
- (char)_compactProgramWithConversionInfo:(struct CGColorConversionInfo { } *)a0 cubeSize:(int)a1 cubeOnly:(char)a2;
- (char)_generateProgram;
