...
@interface PXFeedSectionContentLayout : PXGCompositeLayout <PXGSublayoutProvider, PXGLayoutContentSource, PXChangeObserver, PXTapToRadarDiagnosticProvider> {
    ...
    struct { char setItemLayoutShouldAutoplayContentVideoTimeRange; char setItemLayoutIsTouched; char setItemLayoutIsHovered; char shouldReloadItemLayoutForChangedItemFromIndexPathInDataSourceToIndexPathInDataSource; char configureItemLayoutForChangedItemFromIndexPathInDataSourceToIndexPathInDataSource; char decorationOverlayAnchorSpriteIndexForItemLayout; char itemPlacementControllerForItemReferenceItemLayout; } _itemLayoutFactoryRespondsTo;
}
...
- (char)_handlePresentMenuActionForIndex:(long long)a0 atLocation:(struct CGPoint { double x0; double x1; })a1 inView:(id)a2;
- (char)_handlePrimaryActionForItemAtIndex:(long long)a0;
...
- (char)axShouldSearchLeafsInSubgroups;
...
- (char)wantsCustomAlphaForSublayouts;
