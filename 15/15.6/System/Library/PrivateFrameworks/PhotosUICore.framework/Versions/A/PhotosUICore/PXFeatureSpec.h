@class PXExtendedTraitCollection, NSColor, PXLayoutMetricInterpolator, NSArray, NSCache;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } curatedLibraryEdgeToEdgeContentDefaultPadding;
...
@property (readonly, nonatomic) char _shouldUseMiniMargins;
...
@property (readonly, nonatomic) char shouldInsetAllPhotoDetailsContent;
...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_fullscreenContentInsetsForWidth:(double)a0;
- (id)collectionTileImageOverlayColorHighlighted;
- (void)configureViewSpec:(id)a0;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })contentGuideInsetsForScrollAxis:(long long)a0;
