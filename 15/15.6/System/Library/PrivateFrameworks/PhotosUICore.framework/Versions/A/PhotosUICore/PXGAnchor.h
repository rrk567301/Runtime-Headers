...
@interface PXGAnchor : NSObject <PXGSpriteIndexReferencing, PXGDiagnosticsProvider> {
    struct { char visibleRectOriginForProposedVisibleRectForLayout; } _delegateRespondsTo;
}
...
@property (readonly, nonatomic, getter=isAutoInvalidated) char autoInvalidated;
@property (readonly, nonatomic) unsigned long long anchoredContentEdges;
@property (readonly, nonatomic) char shouldFaultInContentAtAnchoredContentEdges;
@property (readonly, nonatomic) char isScrollingAnimationAnchor;
@property (readonly, nonatomic) char canBeReused;
