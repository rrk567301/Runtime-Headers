...
+ (char)canRegisterFileRepresentationsFor:(id)a0 contentType:(id)a1 configuration:(id)a2;

- (id)init;
- (void).cxx_destruct;
- (id)registeredFileRepresentationWithContentType:(id)a0 uuid:(id)a1 identifierCode:(id)a2 libraryIdentifier:(id)a3 itemType:(unsigned long long)a4 encodingPolicy:(long long)a5 hasLimitedVisibility:(char)a6;
