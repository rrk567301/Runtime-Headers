...
@property (nonatomic) char isTapSpawned;
@property (nonatomic) char isHighPriority;
@property unsigned long long sourceObservationId;

+ (id)fromTrack:(struct shared_ptr<ft::Track> { struct Track *x0; struct __shared_weak_count *x1; })a0 isHighPriority:(char)a1;
