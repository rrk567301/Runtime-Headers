...
- (char)_unsafeMeanFillAndScaleSourceBuffer:(SEL)a0 destinationBuffer:(struct __CVBuffer { } *)a1 sourceRect:(struct __CVBuffer { } *)a2 meanPixel:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 scaler:(id)a4;
- (char)_updateHighPriorityTrackWithRect:(struct Rect<double> { double x0; double x1; double x2; double x3; })a0 confidence:(double)a1 isTapToTrack:(char)a2;
- (char)_validatePostProcessingInvocation;
...
- (id)opDescription;
- (char)postProcessExemplarOutputs:(id)a0 forTargetRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (char)postProcessInstanceOutputs:(id)a0;
- (char)preProcessExemplarInputFromSourceBuffer:(SEL)a0 toDestinationBuffer:(struct __CVBuffer { } *)a1 forTargetRect:(struct __CVBuffer { } *)a2 meanPixel:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 scaler:(id)a4;
- (char)preProcessInstanceInputFromSourceBuffer:(SEL)a0 toDestinationBuffer:(struct __CVBuffer { } *)a1 meanPixel:(struct __CVBuffer { } *)a2 scaler:(id)a3;
