...
- (char)setPropertyValue:(id)a0 forHardwareAddress:(id)a1 qualifier:(id)a2 controller:(id)a3 error:(id *)a4;
- (char)hasProperty:(id)a0;
- (char)isPropertySettable:(id)a0;
- (id)propertyValueForHardwareAddress:(id)a0 error:(id *)a1;
- (id)propertyValueForHardwareAddress:(id)a0 qualifier:(id)a1 error:(id *)a2;
- (char)setName:(id)a0 controller:(id)a1 error:(id *)a2;
- (char)setPropertyValue:(id)a0 forHardwareAddress:(id)a1 controller:(id)a2 error:(id *)a3;
