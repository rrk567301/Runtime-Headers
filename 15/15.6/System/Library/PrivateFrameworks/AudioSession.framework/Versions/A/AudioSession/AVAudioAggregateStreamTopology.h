...
@property (readonly, nonatomic) char hasCustomChannelMappings;
...
- (char)setChannelLayout:(id)a0 port:(id)a1 error:(id *)a2;
- (char)setChannelMap:(id)a0 port:(id)a1 error:(id *)a2;
