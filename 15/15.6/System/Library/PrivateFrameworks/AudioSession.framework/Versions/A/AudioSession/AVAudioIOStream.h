...
- (char)setAudioStreamTag:(id)a0 error:(id *)a1;
- (char)setDSPFlavor:(unsigned int)a0 error:(id *)a1;
- (char)setPort:(id)a0 error:(id *)a1;
- (char)setStreamTopology:(id)a0 error:(id *)a1;
