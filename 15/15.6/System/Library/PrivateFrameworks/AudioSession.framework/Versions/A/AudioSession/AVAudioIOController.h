...
@property (readonly, nonatomic) char supportsDynamicLatency;
...
- (char)setIOPeriod:(struct AVAudioIOPeriod { double x0; double x1; unsigned long long x2; float x3; })a0 error:(id *)a1;
- (char)configureIOControllerWithRoute:(id)a0 error:(id *)a1;
...
- (char)setMasterClock:(id)a0 error:(id *)a1;
