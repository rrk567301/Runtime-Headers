...
+ (void)requestViewControllerWithRemoteAppID:(id)a0 remoteLocalizedAppName:(id)a1 remoteUnlocalizedAppName:(id)a2 externallyVerifiedAndApprovedSharedWebCredentialsDomains:(id)a3 autoFillMode:(unsigned long long)a4 explicitAutoFillMode:(char)a5 completion:(id /* block */)a6;

- (void).cxx_destruct;
- (void)cancel;
- (id)exportedInterface;
- (id)serviceViewControllerInterface;
- (void)setExplicitAutoFillMode:(char)a0;
