...
- (char)_appCanSupportOneTimeCodeModeDeliveredCodesOnly;
- (void)updatePartialUsername:(id)a0 inWindow:(id)a1;
- (char)_appCanSupportAutoFill;
- (void)_dismissCurrentSheetWindow;
- (void)_observeNotificationsForTextField:(id)a0 keyWindow:(id)a1 isForOneTimeCode:(char)a2;
...
- (void)_updateWindowVisibility:(char)a0 inWindow:(id)a1;
