...
- (id)_personImageWithDSID:(id)a0 fullName:(id)a1 appleID:(id)a2 forceFetch:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)fetchPersonImageWithDSID:(id)a0 fullName:(id)a1 appleID:(id)a2 forceFetch:(char)a3 completionHandler:(id /* block */)a4;
