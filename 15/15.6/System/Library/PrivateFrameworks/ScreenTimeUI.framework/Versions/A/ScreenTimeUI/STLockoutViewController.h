...
@property (nonatomic, getter=isForSnapshot) char forSnapshot;
@property (copy, nonatomic) NSString *bundleIdentifier;
@property (readonly, nonatomic) char didFinishDismissing;
...
@property (nonatomic) char okButtonAlwaysHidden;
@property (nonatomic) char mainButtonAlwaysHidden;
...
- (void)setDidFinishDismissing:(char)a0;
