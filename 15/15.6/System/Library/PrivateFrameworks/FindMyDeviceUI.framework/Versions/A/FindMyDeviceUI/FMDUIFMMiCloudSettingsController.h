...
@property (nonatomic) char findMyMacEnabled;
@property (nonatomic) char offlineFindingQueried;
@property (nonatomic) char offlineFindingEnabled;
@property (nonatomic) char offlineFindingDisabledDueToNotHSA2;
...
- (void)_setFindMyMacConfigurationActive:(char)a0;
- (void)_setSearchPartyConfigurationActive:(char)a0;
- (void)_showEnableOfflineFindingOption:(char)a0 forceRefresh:(char)a1;
- (void)_showHSA2UpgradeAlert;
- (void)_showOfflineFindingAlertWhenTurningOff;
- (void)_updateEnableFindMyMacStatusWithForceRefresh:(char)a0;
