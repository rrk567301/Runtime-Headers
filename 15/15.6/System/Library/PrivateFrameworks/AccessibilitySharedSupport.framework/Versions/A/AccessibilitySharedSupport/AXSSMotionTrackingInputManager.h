...
@property (readonly, nonatomic) char _supportsHIDInputs;
...
@property (readonly, nonatomic) char _supportsCameraInputs;
...
- (void)_inputUpdated;
- (char)_supportsMotionTrackingType:(unsigned long long)a0;
