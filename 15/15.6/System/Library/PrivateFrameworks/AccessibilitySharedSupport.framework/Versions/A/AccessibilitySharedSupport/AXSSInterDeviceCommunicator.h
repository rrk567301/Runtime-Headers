...
@property (readonly, nonatomic) char isReceivingSwitchEvents;
@property (readonly, nonatomic) char isForwardingSwitchEvents;
@property (readonly, nonatomic) char isSearching;
@property (readonly, nonatomic) char isIdle;
@property (readonly, nonatomic) char canSearch;
@property (readonly, nonatomic) NSArray *searchResults;
@property (readonly, nonatomic) char hasPeers;
...
- (id)_messageForSelection:(char)a0 settings:(id)a1;
