...
+ (char)_expressionIsActive:(unsigned long long)a0 usingExclaveOutput:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; })a1 expressionConfiguration:(id)a2;
...
+ (char)_jawOpenStartingWithValue:(float)a0 mouthClose:(float)a1 expressionConfiguration:(id)a2;
...
- (char)isEqualToMotionTrackingExpressionConfiguration:(id)a0;
