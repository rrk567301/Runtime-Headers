...
@property (readonly, nonatomic) char createdFromNewline;
@property (retain, nonatomic) NSMutableOrderedSet *predictedSecondaryDialects;

- (id)description;
- (void).cxx_destruct;
- (void)addPredictedSecondaryDialects:(id)a0;
- (id)initWithDialect:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 content:(id)a2 createdFromNewline:(char)a3;
