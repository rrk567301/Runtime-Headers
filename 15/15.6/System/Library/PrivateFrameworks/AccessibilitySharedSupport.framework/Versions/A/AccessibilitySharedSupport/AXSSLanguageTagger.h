...
+ (id)_allLangIDs;
+ (struct { int x0; float x1; } *)_createLanguageHintWithHighProbInDefault:(id)a0;
+ (struct { int x0; float x1; } *)_createLanguageHintsEvenlyDistributedWithProbability:(float)a0 excludingHints:(id)a1;
+ (struct { int x0; float x1; } *)_createLanguageHintsForContent:(id)a0 probInSystemLanguage:(float)a1;
+ (id)_createTagForContent:(id)a0 tokenRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 document:(id)a2 createdFromNewline:(char)a3;
...
+ (void)_tagRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 document:(id)a1 tags:(id)a2 createdFromNewline:(char)a3;
+ (void *)_taggerForContent:(id)a0 tagScheme:(id)a1;
+ (void *)_tokenTaggerForContent:(id)a0;
+ (id)combineLanguageProbability:(struct { int x0; float x1; } *)a0 primaryLanguageID:(int)a1 secondaryLanguageID:(int)a2 dialectMap:(id)a3;
+ (char)isSupportedLanguage:(id)a0;
...
+ (id)primaryLanguageForContent:(id)a0 hints:(struct { int x0; float x1; } *)a1;
+ (id)primaryLanguageWithHigherProbInDefaultLanguage:(id)a0;
+ (void)setSystemLocale:(id)a0;
