...
@property (readonly, nonatomic) char handlesBothDownAndUp;
...
- (void).cxx_destruct;
- (id)_initWithHandler:(id /* block */)a0 downHandler:(id /* block */)a1 upHandler:(id /* block */)a2 handlesBothDownAndUp:(char)a3;
