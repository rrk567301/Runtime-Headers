...
- (char)validateWithPayloadSize:(const void *)a0 skeletonCount:(unsigned long long)a1 vertexCount:(unsigned long long)a2 simplifiedVertexCount:(unsigned long long)a3 error:(id *)a4;
