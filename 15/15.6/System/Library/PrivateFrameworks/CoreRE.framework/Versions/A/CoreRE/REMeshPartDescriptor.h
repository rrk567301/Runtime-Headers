...
- (char)validateAttribute:(id)a0 withName:(id)a1 payloadSize:(struct FixedInlineArray<unsigned long, 8UL> { unsigned long long x0[8]; })a2 required:(char)a3 error:(id *)a4;
