...
@property (readonly, nonatomic) char preventPlaybackUntilReady;

+ (char)supportsSecureCoding;

- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)initWithAudioInputMode:(id)a0 reverbSendLevel:(SEL)a1 diffuseSpillMapDimensions:(unsigned char)a2 specularSpillMapDimensions:(float)a3 diffuseSpillBlurSigma:(int)a4 specularSpillBlurSigma:(int)a5 desiredViewingMode:(unsigned char)a6 preventPlaybackUntilReady:(char)a7;
