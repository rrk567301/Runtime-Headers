...
- (id)initWithBuffer:(id)a0 format:(id)a1 length:(unsigned int)a2 inputMode:(unsigned char)a3 referenceLevel:(float)a4 loopCount:(int)a5 mixGroupName:(id)a6 streaming:(char)a7 normalizationMode:(int)a8 calibrationMode:(int)a9 calibrationLevel:(double)a10 layoutTag:(unsigned int)a11 taskToken:(unsigned int)a12 audioAssetID:(unsigned long long)a13;
- (id)initWithFileBuffer:(id)a0 format:(id)a1 length:(unsigned int)a2 bufferSize:(unsigned long long)a3 inputMode:(unsigned char)a4 referenceLevel:(float)a5 loopCount:(int)a6 mixGroupName:(id)a7 streaming:(char)a8 normalizationMode:(int)a9 calibrationMode:(int)a10 calibrationLevel:(double)a11 layoutTag:(unsigned int)a12 taskToken:(unsigned int)a13 audioAssetID:(unsigned long long)a14;
- (id)initWithFilePath:(id)a0 inputMode:(unsigned char)a1 referenceLevel:(float)a2 loopCount:(int)a3 mixGroupName:(id)a4 streaming:(char)a5 normalizationMode:(int)a6 calibrationMode:(int)a7 calibrationLevel:(double)a8 layoutTag:(unsigned int)a9 taskToken:(unsigned int)a10 targetLUFS:(double)a11 audioAssetID:(unsigned long long)a12;
