...
@property (readonly, nonatomic, getter=isShareable) char shareable;
...
- (id)initWithPayload:(id)a0 privatePayload:(id)a1 parts:(id)a2 models:(id)a3 instances:(id)a4 skeletons:(id)a5 isLimitedRenderAsset:(char)a6;
