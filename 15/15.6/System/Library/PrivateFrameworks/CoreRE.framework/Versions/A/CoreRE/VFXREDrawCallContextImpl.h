...
@property (nonatomic) char _isDrawingBlur;
@property (nonatomic) char _isDepthOnly;
...
@property (readonly, nonatomic) char isDrawingDepthOnly;
@property (readonly, nonatomic) char isDrawingBlur;
...
@property (readonly, nonatomic) char useDitherFade;
@property (readonly, nonatomic) char enableClipping;
@property (readonly, nonatomic) char renderForBlur;
@property (readonly, nonatomic) char enableBreakthrough;
@property (readonly, nonatomic) char enableNearFieldVignetting;
@property (readonly, nonatomic) int portalClippingMode;
@property (readonly, nonatomic) float fadeOpacity;
@property (readonly, nonatomic) char depthOnly;
