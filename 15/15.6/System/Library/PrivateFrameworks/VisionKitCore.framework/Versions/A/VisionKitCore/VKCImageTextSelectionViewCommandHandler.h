...
@property (nonatomic) char isExtendingRange;
...
- (void)adjustSelectionWithType:(unsigned long long)a0 direction:(unsigned long long)a1 extendSelection:(char)a2;
- (void)clearStartRangeIfNecessaryForSelectedRangeChange;
- (char)handleCommandForSelector:(SEL)a0;
