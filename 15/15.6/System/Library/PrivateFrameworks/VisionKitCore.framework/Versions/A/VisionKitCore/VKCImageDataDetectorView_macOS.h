...
- (double)angleOfQuad:(id)a0 LTR:(char)a1;
- (struct CGSize { double x0; double x1; })buttonImageSizeFromQuad:(id)a0 baseline:(struct CGPoint { double x0; double x1; } *)a1 LTR:(char)a2 finalIsLTR:(char *)a3;
...
- (char)highlightedElementContainsPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)needsRotationOffsetForElementQuad:(id)a0 buttonQuad:(id)a1 isLTR:(char)a2;
- (id)pathForDataDetectorElement:(id)a0;
- (id)quadAddingButtonQuad:(id)a0 toElementQuad:(id)a1 LTR:(char)a2;
