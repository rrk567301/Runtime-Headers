@class NSBezierPath, CIContext, NSObject, VKCImageAnalysisResult, VKCImageSubjectGlowLayer, CALayer, NSImage, CAPackage, VKCImageSubjectContext, VKCRemoveBackgroundRequestHandler, NSIndexSet, CAShapeLayer, NSValue;
...
@property (retain) NSImage *_cachedSubject;
...
@property (nonatomic) char glowLayerActive;
@property (nonatomic) char inhibitDimmingAndLiftView;
...
@property (readonly, nonatomic) NSBezierPath *normalizedSubjectPath;
...
- (void)configureMaskForCurrentSubjectContextWithLayer:(id)a0 animated:(char)a1;
...
- (void)sendSubjectAnalyticsEventWithEventType:(long long)a0 interactionType:(long long)a1 subjectFound:(char)a2 processingDuration:(double)a3;
- (void)setActiveSubjectIndexSet:(id)a0 animated:(char)a1;
- (void)setCachedSubject:(id)a0 forIndexSet:(id)a1;
- (void)showPulseAnimationWithViewScale:(double)a0;
- (char)subjectExistsAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (void)updateForImageBoundsChangeIfNecessary;
- (void)updateGlowLayerForActiveSubjectIndexSet;
- (void)updateMaskForCurrentSubjectIndexesAnimated:(char)a0;
