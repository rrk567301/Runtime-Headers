@class NSDate, NSString, NSURL, NSArray, VKCImageAnalysis, NSImage, CIImage, CLLocation;
...
@property (nonatomic) char isMultiPartAnalysis;
...
@property (nonatomic) char _wantsRectangleDetection;
...
@property (nonatomic) char _wantsFormFieldDetection;
...
- (char)isPhotosAssetRequest;
- (id)madRequests;
- (id)processedBarcodeSymbologies;
- (id)requestIDValue;
- (char)saveAssetsToFeedbackAttachmentsFolder:(id)a0 error:(id *)a1;
