...
@property (nonatomic) char didAddLeadingItem;
@property (nonatomic) char didAddTrailingItem;
@property (nonatomic) char animateItemVisibilityChanges;
@property (readonly, nonatomic) double remainingWidth;
@property (nonatomic) char showingMoreButton;
