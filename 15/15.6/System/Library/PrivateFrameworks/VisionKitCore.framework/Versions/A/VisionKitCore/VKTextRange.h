...
@property (readonly, nonatomic) char isNSNotFound;
@property (readonly, nonatomic) char containsMultipleRanges;
...
- (char)containsTextPosition:(id)a0;
- (char)intersectsNSRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
