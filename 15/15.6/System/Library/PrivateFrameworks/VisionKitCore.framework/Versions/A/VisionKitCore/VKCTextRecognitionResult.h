@class NSDate, NSString, NSArray, NSAttributedString, NSIndexSet, VNRecognizedTextBlockObservation, NSDictionary, VKTextRange, VKCImageAnalyzerRequest, CROutputRegion, VNDocumentObservation, CRDocumentOutputRegion;
...
- (id)_selectionRectsForRange:(id)a0 documentView:(id)a1 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 addTranscript:(char)a3;
- (id)createLocaleMap;
...
- (char)containsRichPasteboardElementsForRange:(id)a0;
...
- (id)proposedFormRegionForPoint:(struct CGPoint { double x0; double x1; })a0 existingFormFields:(id)a1;
...
- (id)selectionRectsForRange:(id)a0 documentView:(id)a1 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 addTranscript:(char)a3;
- (char)shouldShowTextMarkerForMarkerType:(long long)a0;
