...
@property (nonatomic) char isShowingVisualResultsPane;
@property (retain, nonatomic) NSString *currentRVItemID;
@property (nonatomic) char observingInteractionDidFinish;
@property (nonatomic) char didProcessResult;
@property (nonatomic) char shouldShowResultWhenVisible;
