...
@property (nonatomic) char changesSelectionAsPrimaryAction;
@property (nonatomic) char showsMenuAsPrimaryAction;
...
@property (nonatomic) char isMoreButton;
