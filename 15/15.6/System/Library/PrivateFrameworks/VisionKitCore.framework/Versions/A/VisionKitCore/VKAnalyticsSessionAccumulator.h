...
@property (nonatomic) char didSelectText;
...
@property (nonatomic) char didActivateHighlightAll;
@property (nonatomic) char didActivateRegex;
@property (nonatomic) double sessionDuration;
@property (nonatomic) char isPerformingAutomatedTest;
