...
@property (readonly, nonatomic) char hasAnyRequests;
...
- (int)_performMADRequest:(id)a0 forRequest:(id)a1 pixelBuffer:(struct __CVBuffer { } *)a2 cgImage:(struct CGImage { } *)a3 useCGForMad:(char)a4 withCompletion:(id /* block */)a5;
- (int)_performMultiStageMADRequest:(id)a0 forRequest:(id)a1 pixelBuffer:(struct __CVBuffer { } *)a2 cgImage:(struct CGImage { } *)a3 useCGForMad:(char)a4 withCompletion:(id /* block */)a5;
...
- (void)didShowVisualSearchCachedResultsForQueryID:(unsigned long long)a0 cachedResultQueryID:(unsigned long long)a1 item:(id)a2;
- (void)didShowVisualSearchHintsForRequest:(id)a0 invocationType:(long long)a1;
...
- (id)madSuggestionTypeFromItems:(id)a0;
- (id)mrcDDElementsFromRequests:(id)a0 didParse:(char *)a1 durations:(id)a2;
...
- (unsigned long long)sfViewAppearEventFromInvocationType:(long long)a0 request:(id)a1;
