...
@property (class, readonly, nonatomic) char sceneAwareLookupEnabled;
...
- (char)containsSelectedTextAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)containsTextAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)imageContainsPoint:(struct CGPoint { double x0; double x1; })a0;
- (void)performHighlightSelectableTextAnimated:(char)a0;
