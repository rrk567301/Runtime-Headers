@class VKCImageAnalysis, MADVIVisualSearchGatingResultItem, NSString, MADVIVisualSearchResultItem, MADVIVisualSearchGatingDomainInfo, NSMenu;
...
@property (readonly, nonatomic) char shouldPlaceInCorner;
