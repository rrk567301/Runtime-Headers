@class NSArray, VKCImageSubjectContextInstance, VKCRemoveBackgroundResult, NSIndexSet, NSNumber, VKCRemoveBackgroundRequest;
...
@property (readonly, nonatomic) char allSubjectsSelected;
@property (readonly, nonatomic) NSNumber *animatedStickerScore;

- (void).cxx_destruct;
- (id)normalizedPathForSubjectWithIndexSet:(id)a0 contentsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 topLevelOnly:(char)a2;
- (char)containsSubjectAtNormalizedPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (id)normalizedPathForActiveSubjectsWithContentsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 topLevelOnly:(char)a1;
- (id)normalizedPathForSubjectAtIndex:(id)a0 contentsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 topLevelOnly:(char)a2;
...
- (char)subjectIndexes:(id)a0 equivalentToIndexes:(id)a1;
