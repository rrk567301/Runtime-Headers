...
- (id)formRegionsExcluding:(id)a0 updateExcludedFields:(char)a1;
...
- (void)generateDataDetectorInfoWithTypes:(unsigned long long)a0 unfiltered:(char)a1;
- (id)initWithAnalysisResult:(id)a0;
- (char)writeSecureCodedArchiveToURL:(id)a0 error:(id *)a1;
