...
@property (nonatomic) char analysisButtonActive;
...
- (id)initWithEventType:(long long)a0 analysis:(id)a1 source:(long long)a2 interactionTypes:(unsigned long long)a3 buttonActive:(char)a4 customIdentifier:(id)a5;
