...
@property (nonatomic) char shouldAutomaticallyShowVisualSearchResult;
...
- (char)_shouldShowPulsingDot:(id)a0;
...
- (void)updateUIForVisualSearchResultsClearExistingResults:(char)a0 includeNotVisibleItems:(char)a1;
...
- (id)vsMenuItemForVisualSearchItem:(id)a0 showLookup:(char)a1;
