...
- (id)_groupsForPrimaryAccount:(id)a0 secondaryAccounts:(id)a1 simpleAccountGrouping:(char)a2;
...
- (void)mapItems:(id)a0 toGroups:(id)a1 unknownGroup:(id)a2 deviceGroup:(id)a3 simpleAccountGrouping:(char)a4;
