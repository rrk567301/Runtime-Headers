...
- (char)clearNotificationForItem:(id)a0 error:(id *)a1;
- (char)clearPendingFollowUpItems:(id *)a0;
- (char)clearPendingFollowUpItemsWithUniqueIdentifiers:(id)a0 error:(id *)a1;
- (id)initWithClientIdentifier:(id)a0;
- (id)pendingFollowUpItems:(id *)a0;
- (char)postFollowUpItem:(id)a0 error:(id *)a1;
