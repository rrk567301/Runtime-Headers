...
@interface SUICEdgeLightMaskMetalLayer : CAMetalLayer <CAAnimationDelegate> {
    ...
    char _animating;
    char _useRound2Pipeline;
    char _burstModeHasBeenSet;
    char _shouldBurst;
    char _iPadReduceMotionBoost;
...
+ (void)prewarm;
+ (char)currentIdiomDefaultsToFullBorder;
