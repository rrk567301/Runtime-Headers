...
+ (id)editScriptFromString:(id)a0 toString:(id)a1 chunkSize:(long long)a2 orderAtomsAscending:(char)a3 operationPrecedence:(long long)a4 options:(long long)a5;
...
- (id)initWithOperationPrecedence:(long long)a0 dataClass:(Class)a1 chunkSize:(long long)a2 stringA:(id)a3 stringB:(id)a4 orderAtomsAscending:(char)a5 options:(long long)a6;
- (void)initializeCurrentScriptAtom;
- (void)removeAnyOverlapBetweenIndexOfFirstDifference:(long long *)a0 andReverseIndexOfLastDifference:(long long *)a1 shouldShortenFirstDifference:(char)a2;
