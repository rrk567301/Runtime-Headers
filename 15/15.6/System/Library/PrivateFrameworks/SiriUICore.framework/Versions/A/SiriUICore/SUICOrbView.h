...
@interface SUICOrbView : MTKView {
    ...
    char _fullyThinkingModeNow;
    char _drawingVeryLastFrame;
    char _resetOnNextFrame;
    char _reduceMotion;
    char _reallocTextures;
    char _movedToWindowWithNilScreen;
    float _powerLevel;
...
@property (nonatomic) char suppressTTSAnimations;
@property (nonatomic) char reduceThinkingModeFramerate;
