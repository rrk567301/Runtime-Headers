...
@property (nonatomic) char showEditTextImage;
...
@property (nonatomic) char vibrantAppearance;
...
- (void)setWords:(id)a0 showEditImage:(char)a1 useCarouselAnimation:(char)a2;
...
- (id)_createGlyphImage:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 glyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 layoutManager:(id)a2 isUnderlined:(char)a3;
...
- (char)_isViewInDarkMode;
- (void)_renderByWord;
- (void)_setShowEditTextImageWithoutRelayout:(char)a0;
