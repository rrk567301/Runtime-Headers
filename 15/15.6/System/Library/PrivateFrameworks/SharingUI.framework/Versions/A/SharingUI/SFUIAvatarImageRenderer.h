...
- (id)avatarImageForContacts:(id)a0 pointSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 rightToLeft:(char)a3 style:(unsigned long long)a4 backgroundStyle:(unsigned long long)a5;
