...
@property (nonatomic) char recordZoneOperationInProgress;
@property (nonatomic) char subscriptionOperationInProgress;
...
- (void)setupAccountDidChange:(char)a0;
- (void)setupRecordZoneWithCompletionHandler:(id /* block */)a0 ignoreDefaults:(char)a1;
