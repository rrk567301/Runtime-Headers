...
@property (nonatomic) char ckMigrationStatusOnCloud;
...
- (void)_updateSyncCount:(unsigned long long)a0 success:(char)a1;
...
- (void)pushMigrationStatusToCloud:(char)a0;
- (void)queryCloudIfFirstPullOrAccountChanged:(char)a0;
