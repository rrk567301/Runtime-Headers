...
- (id)init;
- (void).cxx_destruct;
- (void)sendFamilyInviteInteractionEventWithAction:(id)a0 inviteState:(id)a1 isReceiver:(char)a2;
- (void)sendFamilyInviteStatusUpdateEventWithUpdateStatus:(id)a0 success:(char)a1;
- (void)sendFamilySuggestionsEventWithFamilySuggestionsProactiveCount:(long long)a0 familySuggestionsDisplayedCount:(long long)a1 hasBoostedContacts:(char)a2 proactiveModelUsed:(long long)a3 serverRequestedModel:(id)a4;
