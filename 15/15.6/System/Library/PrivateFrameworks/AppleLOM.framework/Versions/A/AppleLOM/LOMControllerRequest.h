...
- (void)executeRequest:(id)a0 addressList:(id)a1 secure:(char)a2 completion:(id /* block */)a3;
- (void)executeRequestForAddress:(id)a0 address:(id)a1 secure:(char)a2 completion:(id /* block */)a3;
- (id)initWithAttributes:(id)a0 queue:(id)a1;
- (void)sendWOLPacket;
- (void)setupStateMachine;
- (void)transferData:(char)a0;
