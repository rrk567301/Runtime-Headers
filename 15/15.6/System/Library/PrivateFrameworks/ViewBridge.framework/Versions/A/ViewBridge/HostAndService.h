...
- (char)event:(struct __CGEvent { } *)a0 isCloseEnoughTo:(struct __CGEvent { } *)a1;
- (char)lostKeyFocus;
- (void)releaseKeyFocus:(const char *)a0;
- (void)stealKeyFocus:(const char *)a0 wantsAggressiveKeyboardFocusTheftCancellation:(char)a1;
- (char)stoleKeyFocus;
