...
+ (void)_endpointForListenerNamed:(id)a0 fromServiceNamed:(id)a1 instanceIdentifier:(id)a2 queue:(id)a3 async:(char)a4 completion:(id /* block */)a5;
...
+ (id)endpointCache;
+ (void)endpointForListenerNamed:(id)a0 fromServiceNamed:(id)a1 instanceIdentifier:(id)a2 queue:(id)a3 async:(char)a4 completion:(id /* block */)a5;
...
- (char)shouldAcceptNewConnection:(id)a0 forListenerNamed:(id)a1;
