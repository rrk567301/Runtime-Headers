...
@interface NSRemoteViewMarshal : NSObject <NSRemoteViewMarshal, NSVBRedactedProtocol, NSScrollViewSeparatorTrackingAdapter> {
    ...
    struct { unsigned long long identifier; char isSuspended; char isAccessoryView; char isInServiceWindow; } _serviceFirstResponder;
    ...
    struct { char immediate; char ultimate; } _lastKnownHostWindowKeyness;
...
@property char hasScrolledContentsUnderTitlebar;
...
- (char)window:(id)a0 isUltimatelySpawnedFrom:(id)a1;
- (void)__vbWithLockPerform:(id /* block */)a0;
- (char)_topmostAppModalSessionHasRendezvousWindowIdentifier:(id)a0;
...
- (void)beginSheet:(id)a0 modalForWindow:(id)a1 windowBase:(unsigned char)a2 size:(struct CGSize { double x0; double x1; })a3 isCritical:(char)a4 listenerEndpoint:(id)a5 withReply:(id /* block */)a6;
...
- (void)serviceHasFirstResponder:(struct { unsigned long long x0; char x1; char x2; char x3; })a0 inDirection:(unsigned long long)a1 withReply:(id /* block */)a2;
...
- (void)serviceWindowHasScrolledContentsUnderTitlebar:(char)a0;
