...
+ (void)allowSettingMousePointerImageInBackground:(char)a0 whilePerformingActions:(id /* block */)a1;
...
+ (char)flushCoreAnimationTransaction;
+ (id)hostAppClientParametersClasses;
+ (char)hostAppIsActive:(char)a0;
