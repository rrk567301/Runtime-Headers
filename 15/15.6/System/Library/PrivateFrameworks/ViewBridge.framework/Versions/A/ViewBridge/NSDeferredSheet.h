...
- (void)dealloc;
- (id)initWithChildIdentifier:(id)a0 parentIdentifier:(id)a1 windowBase:(unsigned char)a2 size:(struct CGSize { double x0; double x1; })a3 isCritical:(char)a4 listenerEndpoint:(id)a5 withReply:(id /* block */)a6;
