...
@property (readonly) char _isAssociated;
...
+ (void)initAll;
+ (char)_appModalSessionWouldBeSafe:(char)a0;
+ (id)_remoteViewForIdentifier:(id)a0;
+ (char)allowSetObjectForKey:(id)a0 bridge:(id)a1 bridgePhase:(unsigned char)a2 withReply:(id /* block */)a3;
+ (char)anyRemoteViewAttachedToWindow:(id)a0;
+ (char)classIsRendezvousWindow:(Class)a0;
+ (void)deferBlockOntoMainThread:(id /* block */)a0;
+ (id)endAppModalSession:(id)a0;
+ (char)isFakeEvent:(id)a0;
...
+ (char)shouldEnsureAuxServiceAwareOfHostAppDueToInitialize;
...
- (char)advanceToConfigPhaseIfNeeded:(id /* block */)a0;
- (char)advanceToRunPhaseIfNeeded;
- (char)advanceToRunPhaseIfNeeded:(id /* block */)a0;
...
- (void)setTrustsServiceKeyEvents:(char)a0;
...
- (void)_addChildWindow:(id)a0 parameters:(const struct { long long x0; char x1; struct { unsigned long long x0; unsigned char x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; unsigned int x3; unsigned long long x4; } x2; } *)a1 listenerEndpoint:(id)a2 reply:(id /* block */)a3;
...
- (void)_associate;
- (id)_associateMouseAndMouseCursorPosition:(char)a0;
- (char)_associateWithHostWindow:(id)a0 withKeyness:(struct { char x0; char x1; })a1 isFirstResponder:(char)a2 atLevel:(long long)a3 isFunctionRow:(char)a4 withBlock:(id /* block */)a5;
- (void)_auxiliaryProxyWithSemaphore:(id)a0 attemptingTo:(const char *)a1 withCompletion:(id /* block */)a2;
- (void)_awaitInvalidation;
- (char)_becameInvalidWhileFinishingAdvanceToConfigPhase:(const char *)a0;
...
- (void)_beginSheet:(id)a0 modalForWindow:(id)a1 windowBase:(unsigned char)a2 size:(struct CGSize { double x0; double x1; })a3 isCritical:(char)a4 listenerEndpoint:(id)a5 withReply:(id /* block */)a6;
- (void)_beginSheet:(id)a0 windowBase:(unsigned char)a1 modalForWindow:(id)a2 size:(struct CGSize { double x0; double x1; })a3 isCritical:(char)a4 listenerEndpoint:(id)a5 completion:(id /* block */)a6;
...
- (char)_evaluateKeynessForWindow:(id)a0;
...
- (char)_hasFriendlyKeyFocusThief:(int)a0;
- (char)_hasValidKeyViewInDirection:(unsigned long long)a0;
...
- (char)_informAuxServiceOfMostRecentlyReportedFrameInScreenCoords:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (int)_maintainFirstResponder:(struct { unsigned long long x0; char x1; char x2; char x3; })a0 inDirection:(unsigned long long)a1;
- (void)_maintainWindowNotifications:(char)a0;
...
- (void)_serviceRequestsFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 serviceWindowBackgroundColor:(id)a1 animate:(char)a2 async:(char)a3 transaction:(id)a4 completion:(id /* block */)a5;
- (void)_serviceRequestsResize:(struct CGSize { double x0; double x1; })a0 animate:(char)a1 async:(char)a2 completion:(id /* block */)a3;
- (void)_serviceRequestsResizeInProgress:(struct CGSize { double x0; double x1; })a0;
- (char)_serviceValidatesAction:(id)a0 menuItem:(struct { char x0; char x1; } *)a1 userInterfaceItem:(struct { char x0; char x1; } *)a2 targetIdentifier:(id *)a3 sender:(id)a4;
...
- (void)_setServiceWindowKeyness:(char)a0;
...
- (char)_shouldImposeVibrancySupport:(id)a0;
- (char)_shouldNotifyServiceOfChangeToHostOriginOrSize;
- (char)_shouldSpelunkTouchBarsProactively;
- (void)_showTouchBarPopover:(id)a0 fromItem:(id)a1 withOverlayIdentifier:(id)a2 withCloseButton:(char)a3 withControlStrip:(char)a4 withOptions:(id)a5;
...
- (id)_touchBars:(char)a0;
- (id)_touchBarsDescription;
- (void)_updateAccessibilityConnection:(id)a0 force:(char)a1 legend:(const char *)a2;
...
- (char)_waitOnSemaphore:(id)a0;
- (char)_waitOnSemaphore:(id)a0 withPatience:(double)a1;
- (char)_windowSupportsVibrancy:(id)a0;
...
- (void)enqueueChildWindow:(id)a0 parameters:(const struct { long long x0; char x1; struct { unsigned long long x0; unsigned char x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; unsigned int x3; unsigned long long x4; } x2; } *)a1 listenerEndpoint:(id)a2 reply:(id /* block */)a3;
...
- (char)hasAccessoryViewWhichCanBecomeKeyView;
- (void)hostWindowDidBecomeKey:(id)a0;
- (void)hostWindowDidResignKey:(id)a0;
- (void)invalidateTrackingArea;
- (id)keyTestWindow;
- (void)maintainAppWideNotifications:(char)a0;
- (char)maintainAssociation;
- (char)maintainAssociationForcingDisassociation:(char)a0;
- (void)maintainContainingWindowNotifications:(char)a0;
- (void)maintainFirstResponderInProgress:(id /* block */)a0;
- (void)maintainKeyTestWindowNotifications:(char)a0;
- (void)maintainProcessNotificationEventMonitor:(char)a0;
- (void)maintainScrollViewSeparatorTrackingAdapterForWindow:(char)a0;
- (void)maintainWindowEventMonitor:(unsigned int)a0;
- (void)potentialCommandEquivalentHitServiceApp:(id)a0 eventOwner:(unsigned int)a1 fullDispatch:(char)a2 reply:(id /* block */)a3;
...
- (void)serviceAccessoryViewIsFirstResponder:(char)a0 inDirection:(unsigned long long)a1;
- (id)serviceListenerEndpoint;
- (id)serviceMarshalConnection;
- (id)serviceMarshalForRemoteViewWindow:(id)a0;
- (void)serviceRequestsFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 serviceWindowBackgroundColor:(id)a1 animate:(char)a2 async:(char)a3 transaction:(id)a4 completion:(id /* block */)a5;
...
- (void)setShouldMaskToBounds:(char)a0;
- (void)setSynchronizesImplicitAnimations:(char)a0;
- (void)setWantsAggressiveKeyboardFocusTheftCancellation:(char)a0;
- (void)setWindow:(id)a0 styleMask:(unsigned long long)a1;
- (char)shouldInformServiceOfKeynessChange:(id)a0;
