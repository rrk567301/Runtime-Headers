...
+ (char)appModalSessionInProgressForAnyHostOtherThan:(struct { unsigned int x0[8]; })a0;
+ (char)appModalSessionsOutlawed;
+ (struct _NSModalSession { } *)beginServiceAppModalSessionForWindow:(id)a0;
+ (char)bootstrapForExtensionKitWithDelegate:(id)a0 error:(id *)a1;
+ (int)bootstrapKind;
+ (id)bootstrapSharedServiceListener;
+ (void)cacheMainBundleAsServiceBundle;
+ (char)commonBootstrapForExtensionWithError:(id *)a0;
...
+ (char)windowIsBeginningAppModalSession:(id)a0;
...
- (char)_eventIsToxic:(id)a0;
- (void)_lookupHotKey:(id)a0;
- (char)_modalSession:(struct _NSModalSession { } *)a0 wouldBeepGivenFakeEvent:(id)a1;
- (char)_shouldFakeMainWindow;
- (id)_withToxicEventMonitorPerform:(id /* block */)a0;
- (char)appModalSessionInProgressForAnyHostOtherThan:(struct { unsigned int x0[8]; })a0;
- (char)beginHostAppModalSession:(id)a0 forWindow:(id)a1 withSize:(struct CGSize { double x0; double x1; })a2 withReply:(id /* block */)a3;
- (char)beginHostAppModalSessionForWindow:(id)a0 withLocalSession:(struct _NSModalSession { } *)a1;
- (char)beginHostAppModalSessionForWindow:(id)a0 withLocalSession:(struct _NSModalSession { } *)a1 relativeToWindow:(id)a2;
...
- (id)eventSending;
- (char)hotKeyIsToxic:(long long)a0;
- (void)raiseIfDeferredException:(id)a0;
- (char)respondsToAction:(SEL)a0 fromTask:(struct { unsigned int x0[8]; })a1;
- (void)sendEvent:(id)a0 withForwarding:(char)a1;
- (void)sendEventWithoutCatch:(id)a0 withForwarding:(char)a1;
- (id)vbNextEventMatchingMask:(unsigned long long)a0 untilDate:(id)a1 inMode:(id)a2 dequeue:(char)a3;
