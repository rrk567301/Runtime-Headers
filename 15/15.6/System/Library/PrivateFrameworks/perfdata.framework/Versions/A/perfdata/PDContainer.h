...
- (char)enumerateAggregatedMeasurementsIgnoringVariables:(id)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
- (char)enumerateAggregatedMeasurementsMatchingFilter:(id)a0 ignoringVariables:(id)a1 error:(id *)a2 usingBlock:(id /* block */)a3;
- (char)enumerateAggregatedMeasurementsMatchingNullableFilter:(id)a0 ignoringVariables:(id)a1 error:(id *)a2 usingBlock:(id /* block */)a3;
- (char)enumerateMeasurementsMatchingFilter:(id)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
- (char)enumerateMeasurementsMatchingNullableFilter:(id)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
- (char)enumerateMeasurementsWithError:(id *)a0 usingBlock:(id /* block */)a1;
