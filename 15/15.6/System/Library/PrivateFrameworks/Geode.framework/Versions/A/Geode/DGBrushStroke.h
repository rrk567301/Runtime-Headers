...
- (void)_updateExtent;
- (id)ciImageTiled:(char)a0 closed:(char)a1 pressureMode:(int)a2;
...
- (void)rasterizeToMask:(struct PFIntRect_st { struct PFIntPoint_st { long long x0; long long x1; } x0; struct PFIntSize_st { unsigned long long x0; unsigned long long x1; } x1; })a0 maskPtr:(char *)a1 maskPtrRowBytes:(long long)a2 close:(char)a3 startIndex:(long long)a4 lastStampedIndex:(long long *)a5 pressureMode:(int)a6;
- (void)rasterizeToMask:(struct PFIntRect_st { struct PFIntPoint_st { long long x0; long long x1; } x0; struct PFIntSize_st { unsigned long long x0; unsigned long long x1; } x1; })a0 maskPtr:(char *)a1 maskPtrRowBytes:(long long)a2 close:(char)a3 startIndex:(long long)a4 lastStampedIndex:(long long *)a5 pressureMode:(int)a6 legacySpacing:(char)a7;
- (void)rasterizeToMaskWithProcessor:(id)a0 ROI:(struct PFIntRect_st { struct PFIntPoint_st { long long x0; long long x1; } x0; struct PFIntSize_st { unsigned long long x0; unsigned long long x1; } x1; })a1 maskPtr:(char *)a2 maskPtrRowBytes:(long long)a3 close:(char)a4 startIndex:(long long)a5 lastStampedIndex:(long long *)a6;
