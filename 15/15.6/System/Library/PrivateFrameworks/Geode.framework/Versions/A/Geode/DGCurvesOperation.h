...
- (void)_insertCurvePoint:(struct { double x0; double x1; })a0 select:(char)a1 type:(int)a2;
...
- (void)insertCurvePoint:(struct { double x0; double x1; })a0 select:(char)a1 type:(int)a2;
...
- (char)reverseCurveRGB:(float *)a0 withCurveTable:(float *)a1 reconstructedInput:(float *)a2;
- (char)reverseCurve_:(float)a0 withCurveTable:(float *)a1 reconstructedInput:(float *)a2;
- (float *)rgbValues;
- (id)selectedPointAtIndex:(int)a0 index:(long long)a1;
- (void)setControlPointSelected:(char)a0 atIndex:(long long)a1 type:(int)a2;
