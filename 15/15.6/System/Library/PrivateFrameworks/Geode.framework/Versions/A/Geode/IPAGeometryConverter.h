...
- (char)isValidInputPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)isValidInputRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (char)isValidOutputPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)isValidOutputRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
