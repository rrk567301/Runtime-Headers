...
- (id)_addOptionsForImageSource:(struct CGImageSource { } *)a0 sizePolicy:(id)a1 orientation:(long long)a2 createThumbnail:(char)a3;
...
- (char)_needsTiles:(id)a0 outputSize:(struct CGSize { double x0; double x1; })a1;
...
- (struct CGImage { } *)_newCGImageForRequest:(id)a0 error:(id *)a1 createThumbnail:(char)a2 applyTransform:(char)a3 orientation:(long long)a4;
...
- (char)_prepareURL:(id)a0;
- (char)_renderCGImage:(struct CGImage { } *)a0 intoBuffer:(id)a1 request:(id)a2 canceler:(id)a3 error:(id *)a4;
- (char)_renderEntireCGImage:(struct CGImage { } *)a0 extent:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 orientation:(long long)a2 interpolationQuality:(int)a3 intoContiguousBuffer:(id)a4 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 error:(id *)a6;
- (char)_renderEntireCGImage:(struct CGImage { } *)a0 intoContiguousBuffer:(id)a1 canceler:(id)a2 error:(id *)a3;
- (char)_renderTiledCGImage:(struct CGImage { } *)a0 intoTiledBuffer:(id)a1 canceler:(id)a2 error:(id *)a3;
