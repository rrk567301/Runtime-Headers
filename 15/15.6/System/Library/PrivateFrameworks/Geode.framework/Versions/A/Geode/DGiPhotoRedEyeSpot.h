...
+ (id)spotWithCenter:(struct CGPoint { double x0; double x1; })a0 radius:(double)a1 isAuto:(char)a2 interocularDistance:(double)a3 maxFaceWidth:(double)a4 currentFaceWidth:(double)a5 eyeIndex:(long long)a6;
