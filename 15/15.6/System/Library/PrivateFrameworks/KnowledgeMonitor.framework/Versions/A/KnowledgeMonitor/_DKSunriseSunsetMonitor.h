...
@property (nonatomic) char awaitingLocationAfterDisabledAirplaneMode;
...
- (char)currentSunriseSunsetTimes:(id)a0 differsFromPreviousTimes:(id)a1 byInterval:(double)a2;
- (char)isAirplaneModeEnabledWithPreferences:(struct __SCPreferences { } *)a0;
