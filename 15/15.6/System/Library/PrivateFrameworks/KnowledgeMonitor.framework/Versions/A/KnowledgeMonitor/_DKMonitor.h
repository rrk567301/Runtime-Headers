...
- (void)stop;
- (void)update;
- (void)setCurrentEvent:(id)a0 inferHistoricalState:(char)a1;
- (void)synchronouslyReflectCurrentValue;
- (id)loadState;
- (void)saveState;
- (char)instantMonitorNeedsDeactivation;
- (char)_instantMonitorNeedsActivation;
- (char)_instantMonitorNeedsDeactivation;
- (void)endCurrentEvent:(id)a0;
- (char)historicalStateHasChanged:(id)a0;
