...
+ (id)entitlements;
+ (id)eventStream;
+ (id)_bmEventWithDKEvent:(id)a0 outputDevices:(id)a1 biomeEventMetadata:(id)a2 excludeFromSuggestions:(char)a3;
...
- (void)saveBMEventWithCurrent:(id)a0 outputDevices:(id)a1 artistStoreIdentifier:(id)a2 albumStoreIdentifier:(id)a3 excludeFromSuggestions:(char)a4;
