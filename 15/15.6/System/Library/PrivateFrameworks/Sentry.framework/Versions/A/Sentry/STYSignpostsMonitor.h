...
- (char)monitorAppLaunchSignposts;
- (char)monitorSignposts:(char)a0;
- (char)monitorWorkflowsWithDailyLogLimit:(int)a0 perPeriodLogLimit:(int)a1 periodLengthSec:(int)a2;
