...
- (char)isAnimationScenarioWhitelisted:(id)a0 error:(id *)a1;
- (char)isResponsivenessScenarioWhitelisted:(id)a0 error:(id *)a1;
- (id)issueCategoryForSignpostInterval:(id)a0;
- (char)kpiIsLatency:(id)a0;
...
- (char)processWhitelisted:(id)a0 error:(id *)a1;
...
- (char)scenarioWhitelisted:(id)a0 error:(id *)a1;
- (void)setupBundleIdWhitelists:(id)a0 bundles:(id)a1;
- (char)setupScenarioTitles:(id)a0 bundles:(id)a1;
- (char)setupWhitelistedAnimationScenarios:(id)a0 bundles:(id)a1;
- (char)setupWhitelistedResponsivenessScenarios:(id)a0 bundles:(id)a1;
- (char)setupWhitelistedScenarios:(id)a0 bundles:(id)a1;
