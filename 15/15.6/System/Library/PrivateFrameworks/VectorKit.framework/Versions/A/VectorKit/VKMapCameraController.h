...
@property (nonatomic) char tourShouldResumeWhenDoneGesturing;
...
- (void)rotateToYaw:(double)a0 withPoint:(const void *)a1 animated:(char)a2;
...
- (void)_animateToPosition:(struct Matrix<double, 3, 1> { double x0[3]; })a0 pitch:(double)a1 yaw:(double)a2 duration:(double)a3 timingCurve:(id /* block */)a4 forceDestination:(char)a5 completion:(id /* block */)a6;
...
- (void)clampZoomLevelIfNecessaryAnimated:(char)a0;
...
- (void)flyoverTourAnimation:(id)a0 animateToStart:(char)a1 labelChanged:(id /* block */)a2 stateChange:(id /* block */)a3;
...
- (void)rotateToPitch:(double)a0 withPoint:(const void *)a1 preserveAltitude:(char)a2 animated:(char)a3 exaggerate:(char)a4 maxPitch:(double)a5;
...
- (void)setCenterCoordinate:(struct { double x0; double x1; })a0 altitude:(double)a1 yaw:(double)a2 pitch:(double)a3 duration:(double)a4 animationStyle:(long long)a5 timingCurve:(id /* block */)a6 forceDestination:(char)a7 completion:(id /* block */)a8;
- (char)snapMapIfNecessary:(char)a0;
- (void)startFlyoverTourAnimation:(unsigned long long)a0 animateToStart:(char)a1 labelChanged:(id /* block */)a2 stateChange:(id /* block */)a3;
