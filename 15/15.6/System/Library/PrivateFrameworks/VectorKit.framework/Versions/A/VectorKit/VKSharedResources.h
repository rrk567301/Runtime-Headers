...
@interface VKSharedResources : NSObject {
    ...
    struct unique_ptr<md::GeoidModel, std::default_delete<md::GeoidModel>> { struct __compressed_pair<md::GeoidModel *, std::default_delete<md::GeoidModel>> { struct GeoidModel *__value_; } __ptr_; } _undulationModel;
...
@property (nonatomic) char snapshotterIsInService;
