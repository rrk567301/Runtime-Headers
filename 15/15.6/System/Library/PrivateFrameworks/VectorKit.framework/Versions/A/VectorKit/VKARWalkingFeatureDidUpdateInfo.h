...
@property (readonly, nonatomic) char isDirectlyBehind;
@property (readonly, nonatomic) double screenHeading;

- (id)description;
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithFeature:(id)a0 featureLabelIdentifier:(unsigned long long)a1 featureSet:(id)a2 labelPosition:(const void *)a3 updateTypes:(long long)a4 isVisible:(char)a5 isDirectlyBehind:(char)a6 screenHeading:(struct Unit<geo::DegreeUnitDescription, double> { double x0; })a7;
