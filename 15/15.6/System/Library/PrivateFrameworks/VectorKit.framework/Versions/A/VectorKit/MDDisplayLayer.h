...
- (void)setNeedsDisplayOnBoundsChange:(char)a0;
...
- (void)_prepareTexture:(const void *)a0 isDrawable:(char)a1;
...
- (id)initWithContentScale:(double)a0 useMultisampling:(char)a1 extraColorFormats:(const void *)a2 shouldRasterize:(char)a3 allowBlitToDrawable:(char)a4 taskContext:(const void *)a5 device:(void *)a6 sharedResources:(id)a7 services:(void *)a8 signpostId:(unsigned long long)a9;
...
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)a0 isDrawable:(char)a1;
