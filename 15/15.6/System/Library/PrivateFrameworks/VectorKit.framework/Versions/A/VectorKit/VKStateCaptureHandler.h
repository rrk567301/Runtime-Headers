...
@interface VKStateCaptureHandler : NSObject {
    ...
    struct function<NSString *()> { struct __value_func<NSString *()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } _callback;
}
...
- (id)initWithQueue:(id)a0 withName:(id)a1 withCallback:(struct function<NSString *()> { struct __value_func<NSString *()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a2;
