...
- (char)isGlobalFeature;
- (void)setAnnotationText:(id)a0 locale:(id)a1;
- (void)setPlaceholderIconWithSize:(struct CGSize { double x0; double x1; })a0 anchorPoint:(struct CGPoint { double x0; double x1; })a1 isRound:(char)a2;
