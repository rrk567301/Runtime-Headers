...
- (char)isFullyPitched;
- (void)moveTo:(struct { double x0; double x1; })a0 height:(double)a1 useHeight:(char)a2 zoom:(double)a3 rotation:(double)a4 tilt:(double)a5 duration:(double)a6 timingCurve:(id /* block */)a7 completion:(id /* block */)a8;
...
- (void)moveToZoomOutZoomInTransition:(struct { double x0; double x1; })a0 height:(double)a1 useHeight:(char)a2 zoom:(double)a3 rotation:(double)a4 tilt:(double)a5 duration:(double)a6 timingCurve:(id /* block */)a7 completion:(id /* block */)a8;
...
- (void)tiltTo:(double)a0 animated:(char)a1 exaggerate:(char)a2;
