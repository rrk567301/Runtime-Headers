...
@property (readonly, nonatomic) char hasRouteEta;
@property (readonly, nonatomic) char hasRouteLegEtas;
...
- (void)_decodeVisualInfos:(id)a0 withRouteEtaType:(long long)a1 into:(id)a2 needsDescription:(char)a3;
- (char)_isHikingRoute;
- (char)_isReRoute;
