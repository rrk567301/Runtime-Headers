...
@property (readonly) char canProvideVectorData;
...
- (char)areResourcesRequired;
- (char)canDrawKey:(const struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } *)a0;
- (char)canDrawKey:(const struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } *)a0 withData:(id)a1;
- (char)canPossiblyDrawKey:(const struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } *)a0;
...
- (void)didEnterKey:(const struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } *)a0 withFallback:(char)a1;
...
- (char)shouldUseMetalTexture;
- (id)vectorData;
- (void)vectorOverlayNeedsDisplay:(id)a0 needsFullInvalidate:(char)a1;
