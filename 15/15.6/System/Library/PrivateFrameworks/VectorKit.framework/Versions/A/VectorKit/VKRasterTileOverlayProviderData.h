...
@property (readonly, nonatomic) char crossfadeKeyframes;
...
- (void)dealloc;
- (void).cxx_destruct;
- (id)initWithProviderID:(unsigned int)a0 tileSize:(unsigned int)a1 minimumZ:(unsigned int)a2 maximumZ:(unsigned int)a3 keyframesCount:(unsigned short)a4 duration:(double)a5 crossfadeKeyframes:(char)a6;
