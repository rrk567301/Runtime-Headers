...
- (void)splitGradientTrafficSegmentationAndAddTo:(id)a0 with:(void *)a1 shouldSnap:(char)a2;
- (void)splitTrafficSegmentationAndAddTo:(id)a0 with:(void *)a1 shouldSnap:(char)a2 isGradientTraffic:(char)a3;
