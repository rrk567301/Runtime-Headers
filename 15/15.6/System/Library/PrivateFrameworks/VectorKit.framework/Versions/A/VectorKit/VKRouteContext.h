...
@interface VKRouteContext : NSObject {
    char _hasContextChangedForLabels;
    NSHashTable *_labelObservers;
    char _hasContextChangedForRouteLine;
    NSHashTable *_routeLineObservers;
    char _hasContextChangedForAlternateRouteLines;
...
@property (nonatomic) char snappingToTransitLines;
...
- (void)_setHasContextChangedForObserverType:(unsigned char)a0 withValue:(char)a1;
