...
- (void)didReceiveMemoryWarning:(char)a0;
- (void)cancelLoad;
...
- (void)loadScene;
- (void)renderSceneWithEngine:(void *)a0 completion:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a1;
