...
@property (nonatomic) char isPitchEnabled;
@property (nonatomic) char isRotateEnabled;
@property (nonatomic) char staysCenteredDuringPinch;
@property (nonatomic) char staysCenteredDuringRotation;
@property (readonly, nonatomic) char canPitch;
@property (readonly, nonatomic) char canRotate;
...
- (char)centerCoordinate:(struct { double x0; double x1; } *)a0 andDistanceFromCenter:(double *)a1 forMapRegion:(id)a2;
