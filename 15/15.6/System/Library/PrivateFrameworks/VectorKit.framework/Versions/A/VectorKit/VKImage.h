...
- (id)initWithCGImage:(struct CGImage { } *)a0 scale:(double)a1 usedAsTextureAndImage:(char)a2 resourceStore:(struct weak_ptr<mre::GraphicsResourceStore> { struct GraphicsResourceStore *x0; struct __shared_weak_count *x1; })a3;
...
- (id)initWithData:(id)a0 scale:(double)a1 usedAsTextureAndImage:(char)a2 resourceStore:(struct weak_ptr<mre::GraphicsResourceStore> { struct GraphicsResourceStore *x0; struct __shared_weak_count *x1; })a3;
