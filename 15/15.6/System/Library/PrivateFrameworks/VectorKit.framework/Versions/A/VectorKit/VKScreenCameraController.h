...
@interface VKScreenCameraController : VKCameraController <VKAnnotationTrackingCameraController, VKGesturingCameraController> {
    ...
    char _zoomAnimationCanBeInterrupted;
}

@property (nonatomic) char userChangedZoomSinceLastProgrammaticRegionChange;
...
@property (nonatomic) struct { char shouldZoomToFit; double idealCenterCoordinateDistance; char shouldPreserveUserSpecifiedZoomLevel; char resetAfterTracking; } annotationTrackingBehavior;
...
@property (readonly, nonatomic) char isAnimatingToTrackAnnotation;
@property (readonly, nonatomic) char isTrackingHeading;
