...
@property (nonatomic) char showsTintBands;
@property (nonatomic) char showsVenues;
@property (nonatomic) char showsGlobe;
...
- (void)cancelFlushingTileDecodes:(char)a0;
...
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 homeQueue:(id)a2 signpostId:(unsigned long long)a3 mapType:(int)a4 mapDisplayStyles:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; char x5; } *)a5 mapDisplayStylesCount:(unsigned long long)a6 auditToken:(id)a7 useMultisampling:(char)a8 withError:(out id *)a9;
...
- (void)setClearFontCache:(char)a0;
