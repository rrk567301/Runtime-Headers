...
@property (nonatomic) struct { char shouldZoomToFit; double idealCenterCoordinateDistance; char shouldPreserveUserSpecifiedZoomLevel; char resetAfterTracking; } behavior;
@property (nonatomic) void *elevationLogic;
@property (nonatomic) long long headingAnimationDisplayRate;
@property (nonatomic) char hasUserSpecifiedZoomLevel;
@property (nonatomic) char hasVehicleHeading;
@property (readonly, nonatomic) char shouldForceZoomToFit;
@property (readonly, nonatomic) id<VKTrackableAnnotation> annotation;
@property (readonly, nonatomic, getter=isTrackingHeading) char trackingHeading;
