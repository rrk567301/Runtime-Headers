...
@property (readonly, nonatomic) char sRGB;
...
- (id)initWithDevice:(struct shared_ptr<ggl::MetalDevice> { struct MetalDevice *x0; struct __shared_weak_count *x1; })a0 sRGB:(char)a1;
