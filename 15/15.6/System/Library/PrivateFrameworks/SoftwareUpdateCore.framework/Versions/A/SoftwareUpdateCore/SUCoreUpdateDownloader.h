...
@property (readonly, nonatomic) char shouldDownloadSplat;
...
@property (nonatomic) char shouldReportDownloadFailureIfCanceled;
...
- (char)_shouldStageOptionalPSUSAssets;
