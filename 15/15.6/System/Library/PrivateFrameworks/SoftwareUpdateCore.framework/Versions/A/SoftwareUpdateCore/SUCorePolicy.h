...
@property (nonatomic) char performPreflightEncryptedCheck;
@property (nonatomic) char performPreflightSnapshotCheck;
...
@property (nonatomic) char disableAlternateUpdate;
...
+ (char)getAllowSameProductVersionPredicateResultWithAssetOSVersion:(id)a0 assetBuildVersion:(id)a1 prerequisiteProductVersion:(id)a2 prerequisiteBuildVersion:(id)a3;
+ (char)getNoAllowSameProductVersionPredicateResultWithAssetOSVersion:(id)a0 assetBuildVersion:(id)a1 prerequisiteProductVersion:(id)a2 prerequisiteBuildVersion:(id)a3;
...
- (char)isSplatPolicy;
- (char)isSupervisedAndRequestingInvalidOS:(id *)a0;
