...
@property (nonatomic) char performingOperation;
@property (nonatomic) char cancelingPrepare;
@property (nonatomic) char removingPrepared;
@property (nonatomic) float nextProgressThreshold;
@property (nonatomic) char prepareProgressFinal;
@property (nonatomic) char applyProgressFinal;
