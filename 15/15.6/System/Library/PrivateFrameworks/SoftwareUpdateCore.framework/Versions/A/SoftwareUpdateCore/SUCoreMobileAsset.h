...
@property (nonatomic) char downloadingAsset;
@property (nonatomic) char checkedDownloadState;
@property (nonatomic) char assetDownloaded;
@property (nonatomic) char removingAsset;
@property (nonatomic) char assetRemoved;
...
+ (char)downloadConfig:(id)a0 isEqualToConfig:(id)a1;
+ (void)_callReloadCompletion:(id /* block */)a0 withDescriptor:(id)a1 suError:(id)a2 docError:(id)a3;
+ (id)_reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(char)a2 skipMSU:(char)a3 defaultValues:(id)a4 pSUReloadError:(id *)a5 pDocReloadError:(id *)a6;
...
+ (void)reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(char)a2 completion:(id /* block */)a3;
+ (void)reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(char)a2 defaultValues:(id)a3 completion:(id /* block */)a4;
+ (void)reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(char)a2 skipMSU:(char)a3 defaultValues:(id)a4 completion:(id /* block */)a5;
