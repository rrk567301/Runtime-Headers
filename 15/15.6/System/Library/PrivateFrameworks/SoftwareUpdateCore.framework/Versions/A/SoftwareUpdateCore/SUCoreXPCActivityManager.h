...
- (id)description;
- (void).cxx_destruct;
- (char)isActivityTrackedButUnsheduled:(id)a0;
- (id)_getActivityForNameInternal:(id)a0;
- (char)_isActivityTrackedButUnsheduledInternal:(id)a0;
- (char)addActivityInfoToPersistedState:(id)a0;
...
- (char)isActivityScheduled:(id)a0;
- (char)isActivityScheduledInternal:(id)a0;
- (char)removeActivityFromPersistedState:(id)a0;
