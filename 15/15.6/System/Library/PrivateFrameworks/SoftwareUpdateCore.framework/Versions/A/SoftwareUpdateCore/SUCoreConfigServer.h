...
- (void)_stateSafeSendInstalledEventWithSuccess:(char)a0 error:(id)a1;
- (void)_stateSafeSendNewEvent:(id)a0 success:(char)a1 error:(id)a2;
- (void)_stateSafeSendScheduledEventWithSuccess:(char)a0 error:(id)a1;
