...
@property (nonatomic) char bobbleNotificationShown;
...
@property (readonly, nonatomic) char routed;
...
- (char)updateWithCBDevice:(id)a0;
- (void)setBluetoothAddressData:(id)a0;
- (char)setDefaultConfigurationsIfNeeded;
- (char)updateWithAADeviceInfo:(id)a0;
