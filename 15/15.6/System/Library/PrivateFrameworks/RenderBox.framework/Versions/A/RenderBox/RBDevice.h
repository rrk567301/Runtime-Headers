...
@property (class, readonly, getter=isRunningInBackground) char runningInBackground;
@property (class) char allowsRenderingInBackground;
...
- (char)compileShader:(id)a0 error:(id *)a1;
