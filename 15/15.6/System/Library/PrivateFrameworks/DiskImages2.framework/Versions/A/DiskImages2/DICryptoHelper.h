...
+ (char)createPublicKeyHeaderWithBackendXPC:(id)a0 publicKeyHeader:(void *)a1 error:(id *)a2;
...
+ (char)getPassphraseUsingSaksWithBackendXPC:(id)a0 passPhrase:(char *)a1 error:(id *)a2;
+ (char)getPrivateKeyWithHeader:(void *)a0 privateKey:(struct __SecKey **)a1 error:(id *)a2;
+ (char)getPublicKeyWithCertificate:(id)a0 key:(struct __SecKey **)a1 error:(id *)a2;
+ (char)validateWithPubKeyHeader:(void *)a0;
