...
+ (char)_transformForImage:(struct CGImage { } *)a0 isCropped:(char)a1 captureOrientation:(int)a2 sizeInOut:(struct CGSize { double x0; double x1; } *)a3 contextSizeOut:(struct CGSize { double x0; double x1; } *)a4 transformOut:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a5;
...
- (id)_thumbnailData;
- (id)initWithContentsOfFile:(id)a0 format:(unsigned short)a1 readOnly:(char)a2;
- (id)initWithData:(id)a0 format:(unsigned short)a1 readOnly:(char)a2;
