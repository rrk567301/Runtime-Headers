...
+ (char)isResetAfterRebuildRequiredWithLibrary:(id)a0;
+ (char)resetResumeMarkerForActionClass:(Class)a0 pathManager:(id)a1 error:(id *)a2;
...
- (char)isCancelledWithResumeMarker:(id)a0 error:(id *)a1;
- (id)resumeMarker;
