...
+ (id)entityName;
+ (id)_originalTypes;
+ (id)cloudMasterWithGUID:(id)a0 inMomentShare:(id)a1 prefetchResources:(char)a2 inManagedObjectContext:(id)a3;
+ (id)cloudMasterWithScopedIdentifier:(id)a0 prefetchResources:(char)a1 inLibrary:(id)a2;
...
- (id)scopeIdentifier;
- (char)allOriginalsAreLocallyAvailableForAssetUuid:(id)a0 useOriginalAltInsteadOfOriginal:(char)a1;
...
- (char)hasResourcesOtherThanForAssetUuid:(id)a0;
