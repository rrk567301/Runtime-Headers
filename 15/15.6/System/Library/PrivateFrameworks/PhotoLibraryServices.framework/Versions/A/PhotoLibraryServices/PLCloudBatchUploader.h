...
@property char initialUpload;
@property char shouldGenerateDerivatives;

- (void).cxx_destruct;
- (id)pop;
- (id)initWithLibraryServicesManager:(id)a0;
- (char)_validateAsset:(id)a0 onRelatedObject:(id)a1;
- (void)_addAsset:(id)a0 toAssetChanges:(id)a1 isInsert:(char)a2 seenAssetUuid:(id)a3;
...
- (id)_fetchChangesFromLocalEvent:(id)a0 shouldTriggerPrefetch:(char *)a1 inLibrary:(id)a2;
...
- (char)_hasUnuploadedResourceForAsset:(id)a0 resourceType:(unsigned long long)a1 cloudMaster:(id)a2;
...
- (void)_processPendingObjects:(id)a0 forEntityName:(id)a1 withBatchManager:(id)a2 inLibrary:(id)a3;
- (void)_processQuarantineRecordsCommitError:(id)a0 inUploadBatch:(id)a1 forRecords:(id)a2 uploadTracker:(id)a3 inLibrary:(id)a4;
- (char)_processRepushAlbumError:(id)a0 inUploadBatch:(id)a1 forRecords:(id)a2 orderKeyManager:(id)a3 inLibrary:(id)a4;
- (void)_promptForNilAssetUUID:(id)a0 isInsert:(char)a1;
...
- (void)_sortData:(id)a0 isInsert:(char)a1 forUploadChanges:(id)a2 shouldTriggerPrefetch:(char *)a3 inManagedObjectContext:(id)a4;
- (void)_sortRelationshipData:(id)a0 forUploadChanges:(id)a1 inManagedObjectContext:(id)a2;
- (id)_syncDescriptionForObject:(id)a0;
- (char)_updateDeletionRecordListForKey:(id)a0 removingRecordID:(id)a1;
- (char)_validateAdditionalAssetAttributes:(id)a0 onRelatedObject:(id)a1;
...
- (void)handleUploadBatchesFromLocalEvent:(id)a0 outInsertedPhotoCount:(unsigned long long *)a1 outInsertedVideoCount:(unsigned long long *)a2 shouldTriggerPrefetch:(char *)a3 withUploadTracker:(id)a4 inLibrary:(id)a5;
