...
- (char)_isValidForDateCreatedOverwriteWithSource:(id)a0;
- (char)_isValidForOverwriteWithSourceProperty:(id)a0 targetProperty:(id)a1;
- (char)_isValidForTimezoneOverwriteWithSource:(id)a0;
- (char)_isValidForTitleOverwriteWithSource:(id)a0;
- (char)_isValidManagedObject:(id)a0 forEntityName:(id)a1;
...
- (void)_mergeIPTCDataFromSource:(id)a0;
...
- (void)_resourcePropertyCopyCurrentSleetCastFromSource:(id)a0;
...
- (char)isRecentlyModifiedSourceAsset:(id)a0;
- (id)mergePropertyMap;
- (char)transferPropertiesFromSourceAsset:(id)a0 propertyMergeType:(long long)a1 error:(id *)a2;
