...
- (char)_groupIsValidForSuggestionGeneration:(id)a0 suggestionType:(unsigned long long)a1;
- (char)_groupWithAssetCountMeetsAssetMatchThreshold:(unsigned long long)a0 assetSearchResultsCount:(unsigned long long)a1;
- (char)_isEligibleIndexCategory:(unsigned long long)a0 forSuggestionWithType:(unsigned long long)a1;
