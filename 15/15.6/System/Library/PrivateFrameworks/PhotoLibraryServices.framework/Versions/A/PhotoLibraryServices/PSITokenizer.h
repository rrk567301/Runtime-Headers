...
+ (id)fts5StringFromString:(id)a0 useWildcard:(char)a1;
+ (id)fts5StringFromString:(id)a0 useWildcard:(char)a1 leadingAnchored:(char)a2;
+ (id)ftsTokenizerName;
...
- (id)initWithLocale:(id)a0 useCache:(char)a1;
