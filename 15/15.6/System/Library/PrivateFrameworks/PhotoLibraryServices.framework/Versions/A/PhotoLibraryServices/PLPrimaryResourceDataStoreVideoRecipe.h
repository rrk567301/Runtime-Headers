...
- (id)description;
- (id)uti;
- (void)_generateAndStoreUsingMediaConversionServicesForAsset:(id)a0 version:(unsigned int)a1 conversionClient:(id)a2 conversionServiceOptions:(id)a3 isHighPriority:(char)a4 progress:(id *)a5 reason:(id)a6 completion:(id /* block */)a7;
- (id)_mediaConversionServiceOptionsForAsset:(id)a0 conversionServiceOptions:(id)a1 adjustmentData:(id)a2 largeAdjustmentData:(id)a3 isHighPriority:(char)a4 reason:(id)a5;
