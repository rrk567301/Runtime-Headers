...
@property (nonatomic, getter=isSuccess) char success;
@property (nonatomic) char ignoreProgressUpdates;
...
- (void)_initialLog;
- (void)_performActionWithName:(id)a0 ifRequired:(struct { char x0; })a1 recordTimedCoreAnalyticsEvent:(id)a2 coreAnalyticsEventKey:(id)a3 block:(id /* block */)a4;
...
- (void)performActionWithName:(id)a0 ifRequired:(struct { char x0; })a1 block:(id /* block */)a2;
- (void)performActionWithName:(id)a0 ifRequired:(struct { char x0; })a1 recordTimedCoreAnalyticsEvent:(id)a2 coreAnalyticsEventKey:(id)a3 block:(id /* block */)a4;
