...
- (char)argument:(id)a0 isValidDouble:(double *)a1;
...
- (void)leaveGroup;
- (char)libraryProcessOption:(int)a0 arg:(id)a1;
- (id)photosCtl;
- (id)plPhotoLibrary;
- (id)processBooleanOptionArg:(id)a0;
- (char)processOption:(int)a0 arg:(id)a1;
- (int)runOnAssetArgumentsAllowAll:(char)a0 additionalPredicate:(id)a1 block:(id /* block */)a2;
- (int)runOnManagedObjectArgumentsWithEntityName:(id)a0 identifierPropertyKey:(id)a1 allowAll:(char)a2 additionalPredicate:(id)a3 sortDescriptors:(id)a4 block:(id /* block */)a5;
- (int)runOnManagedObjectArgumentsWithEntityName:(id)a0 identifierPropertyKey:(id)a1 allowAll:(char)a2 additionalPredicate:(id)a3 sortDescriptors:(id)a4 relationshipKeyPathsForPrefetching:(id)a5 block:(id /* block */)a6;
- (int)runOnManagedObjectArgumentsWithEntityName:(id)a0 identifierPropertyKey:(id)a1 block:(id /* block */)a2;
- (int)runOnPhotoKitAssetArgumentsAllowAll:(char)a0 propertySets:(id)a1 additionalPredicate:(id)a2 block:(id /* block */)a3;
- (void)setArgumentRangeForRunOnManagedObjects:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (int)setValueString:(id)a0 forKey:(id)a1 onManagedObject:(id)a2;
- (int)traverseRelationshipsForRootManagedObject:(id)a0 keys:(id)a1 targetObject:(id *)a2;
