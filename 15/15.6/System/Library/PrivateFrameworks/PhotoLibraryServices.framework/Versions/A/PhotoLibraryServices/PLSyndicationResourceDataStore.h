...
+ (char)_markSyndicationResourceAsLocallyAvailableWithURL:(id)a0 resource:(id)a1 inode:(unsigned long long)a2 error:(id *)a3;
+ (void)_provideFileURLAndUnwrapLivePhotoIfNeededForBundleID:(id)a0 syndicationIdentifier:(id)a1 typeIdentifier:(id)a2 isLivePhoto:(char)a3 options:(long long)a4 completionHandler:(id /* block */)a5;
...
+ (char)_safeCopyItemAtURL:(id)a0 toURLAndReplaceIfNeeded:(id)a1 error:(id *)a2;
+ (char)_shouldUseDataInterfaceForBundleID:(id)a0;
+ (char)_unpackPVTBundleAtURL:(id)a0 primaryURL:(id *)a1 secondaryURL:(id *)a2 error:(id *)a3;
+ (unsigned short)keyLengthWithDataPreview:(unsigned char)a0;
+ (char)markResource:(id)a0 purgeableAndLocallyAvailableWithFileURL:(id)a1 error:(id *)a2;
...
- (char)dataStoreSubtypeIsDownloadable:(long long)a0;
- (char)canMarkAsynchronousLocalRenderAsOptionalForProgress:(id)a0;
...
- (char)storeExternalResource:(id)a0 forAsset:(id)a1 options:(id)a2 error:(id *)a3 resultingResource:(id *)a4;
- (char)_copyAndMarkAsLocallyAvailablePairedLivePhotoResourceForRequestedResource:(id)a0 requestedVideoComplement:(char)a1 sourceURL:(id)a2 error:(id *)a3;
- (char)_copyAndMarkPurgeableItemAtURL:(id)a0 withPathManager:(id)a1 destFileIdentifier:(id)a2 inode:(unsigned long long *)a3 error:(id *)a4;
- (id)_errorForUnderlyingError:(id)a0;
- (id)_getDestinationURLAndFixLocalAvailabilityIfNeededForResource:(id)a0 fileIdentifier:(id *)a1 isLocallyAvailable:(char *)a2 error:(id *)a3;
- (id)_requestLocalAvailabilityChangeForSyndicationOriginalResource:(id)a0 options:(id)a1 completion:(id /* block */)a2;
- (char)canStoreExternalResource:(id)a0;
- (char)canStreamResource:(id)a0;
...
- (char)videoResource:(id)a0 matchesOrExceedsQualityLevel:(unsigned int)a1;
