...
- (char)transferPersonWithUuid:(id)a0 error:(id *)a1;
- (void)_setRelationship:(id)a0 origin:(id)a1 target:(id)a2;
- (char)transferFaceCropWithUuid:(id)a0 error:(id *)a1;
- (char)_copyFileFrom:(id)a0 to:(id)a1 error:(id *)a2;
- (char)_copyFilesFromSourceAsset:(id)a0 toDestinationAsset:(id)a1 objectMap:(id)a2 filesCopied:(id)a3 error:(id *)a4;
- (char)_copyMasterThumbnailFrom:(id)a0 toDestinationAsset:(id)a1 filesCopied:(id)a2 error:(id *)a3;
...
- (char)_loadLibrariesWithError:(id *)a0;
...
- (char)_shouldSkipRelationship:(id)a0;
- (char)_shouldSkipTransferWithSourceAsset:(id)a0 destinationAsset:(id)a1;
...
- (char)transferAssetWithUuid:(id)a0 error:(id *)a1;
