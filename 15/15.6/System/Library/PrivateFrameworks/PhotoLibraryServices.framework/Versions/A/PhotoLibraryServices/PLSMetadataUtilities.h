...
+ (id)_detailsForAsset:(id)a0 includingLocal:(char)a1 includingFingerprints:(char)a2;
+ (id)_normalizeObjectForJSON:(id)a0;
+ (char)_writeDetails:(id)a0 forEntityNamed:(id)a1 toFilepath:(id)a2 withDefaultFilename:(id)a3;
+ (void)_writeJSONForObjectDetails:(id)a0 toFile:(id)a1;
+ (id)allAlbumsDetailsWriteToPath:(id)a0 inLibrary:(id)a1;
+ (id)allAssetsDetailsWriteToPath:(id)a0 includingLocal:(char)a1 includingFingerprints:(char)a2 forAlbumTitled:(id)a3 library:(id)a4;
...
+ (char)initializeJSONFileAtPath:(id)a0;
