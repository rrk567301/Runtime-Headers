...
- (void)fetchShareWithURL:(id)a0 ignoreExistingShare:(char)a1 reply:(id /* block */)a2;
...
- (void)overrideSystemBudgetsForSyncSession:(char)a0 pauseReason:(id)a1 systemBudgets:(unsigned long long)a2 reply:(id /* block */)a3;
...
- (void)setCloudPhotoLibraryEnabledState:(char)a0;
