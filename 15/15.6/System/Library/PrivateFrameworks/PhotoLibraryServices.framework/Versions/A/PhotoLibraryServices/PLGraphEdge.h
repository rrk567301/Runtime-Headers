...
+ (char)managedObjectConformsToProtocolPLGraphEdgeReferenceRecipient:(id)a0;
...
- (id)edgeValueWithName:(id)a0 createIfMissing:(char)a1;
- (char)hasLabel:(id)a0;
- (char)hasLabelWithCode:(unsigned int)a0;
