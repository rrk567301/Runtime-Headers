...
@property (readonly, nonatomic) char isLightweightMigrationManager;
@property (nonatomic) char shouldPerformLightweightValidation;
@property (nonatomic) long long previousValidatedModelVersion;
@property (nonatomic) char previousValidationSucceeded;
...
+ (void)initialize;
+ (char)isManagedObjectContextMomentarilyBlessed:(id)a0;
...
- (char)_batchDeleteForEntityName:(id)a0 error:(id *)a1;
- (id)_currentHomeAddressDictionary;
- (char)_deleteAllObjectsForEntityName:(id)a0 error:(id *)a1;
- (void)_finalizeInit;
...
- (char)cameraIsActive;
- (char)deleteAllHighlightsWithError:(id *)a0;
- (char)deleteAllMomentsWithError:(id *)a0;
...
- (id)momentsBetweenDate:(id)a0 andDate:(id)a1 sorted:(char)a2 excludeExternal:(char)a3;
...
- (void)performBlock:(id /* block */)a0 synchronously:(char)a1 completionHandler:(id /* block */)a2;
- (void)performBlock:(id /* block */)a0 synchronously:(char)a1 priority:(long long)a2 completionHandler:(id /* block */)a3;
- (void)performDataTransaction:(id /* block */)a0 synchronously:(char)a1 completionHandler:(id /* block */)a2;
- (void)performDataTransaction:(id /* block */)a0 synchronously:(char)a1 priority:(long long)a2 completionHandler:(id /* block */)a3;
