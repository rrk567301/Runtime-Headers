...
+ (id)dictionaryWithManagedObjectContext:(id)a0 forMigrationHistory:(char)a1;
+ (id)fetchGlobalKeyValueForKey:(id)a0 withManagedObjectContext:(id)a1 createIfMissing:(char)a2;
...
+ (void)populateWithDictionary:(id)a0 managedObjectContext:(id)a1 replaceExisting:(char)a2;
