...
@property (nonatomic) char scopedSearchEnabled;
...
@property (nonatomic) char isFullTextToken;
@property (nonatomic) char belongsToSearchText;
@property (nonatomic) unsigned long long userCategory;
@property (copy, nonatomic) NSIndexSet *searchedCategories;
@property (readonly, nonatomic) char containsMarker;
...
@property (nonatomic) char userControlledCategoriesUseWildcard;
@property (nonatomic) char usesWordEmbeddings;
@property (nonatomic) char isFilterTypeToken;
...
@property (readonly, nonatomic) char isTextSearchable;
...
- (id)initWithText:(id)a0 userCategory:(unsigned long long)a1 searchCategories:(id)a2 matchType:(unsigned long long)a3 assetCount:(unsigned long long)a4 collectionCount:(unsigned long long)a5;
