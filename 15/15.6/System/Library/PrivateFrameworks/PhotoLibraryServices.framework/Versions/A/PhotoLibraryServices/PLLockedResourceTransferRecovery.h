...
+ (char)isStaleResourceURL:(id)a0 asset:(id)a1 resource:(id)a2 pathManager:(id)a3;
...
+ (char)updateAssetPropertiesAndSaveForAsset:(id)a0 moveToDestinationScope:(unsigned short)a1 library:(id)a2 error:(id *)a3;
+ (void)validateAssetWithUUID:(id)a0 inLibrary:(id)a1;

- (void).cxx_destruct;
- (id)initWithTransferImportAsset:(id)a0 destinationDirectoryURL:(id)a1;
- (char)recoverFromInProgressLockedTransferForImportAsset:(id)a0 pathManager:(id)a1;
