...
+ (char)_statsForStatementAreInteresting:(struct PLFetchRecordingFileNormalizedStatementHeader { unsigned char x0; unsigned char x1[32]; double x2; double x3; unsigned int x4; unsigned int x5; unsigned int x6; double x7; double x8; double x9; double x10; unsigned short x11; unsigned short x12; unsigned short x13; unsigned short x14; unsigned short x15; unsigned char x16; unsigned char x17; } *)a0 totalPages:(unsigned int)a1;
...
+ (char)deleteRecording:(id)a0 error:(id *)a1;
...
- (char)recordStatementWithNormalizedSQL:(id)a0 bindVariablesAsString:(id)a1 multiInCounts:(id)a2 contextName:(id)a3 pagesHit:(unsigned int)a4 pagesMissed:(unsigned int)a5 rowCount:(unsigned int)a6 duration:(double)a7 QOS:(unsigned int)a8;
- (char)remap;
