...
- (void)_deleteNotificationsForAssetWithUUID:(id)a0 shouldDeleteCommentsOrLikeNotifications:(char)a1 shouldDeletePhotosAddedToAlbumNotifications:(char)a2;
...
- (char)_isMyEmailAddress:(id)a0;
- (id)_memoryNotificationFromDictionaryRepresentation:(id)a0;
- (char)_notificationType:(long long)a0 matchesCommentsOrLikeNotifications:(char)a1 andPhotosAddedToAlbumNotifications:(char)a2;
...
- (char)_shouldAllowAlertsFromContactWithEmail:(id)a0;
...
- (void)sendResponse:(char)a0 toPhotoStreamInvitationForAlbumWithCloudGUID:(id)a1;
- (void)setEnableTemporaryDebugMode:(char)a0;
