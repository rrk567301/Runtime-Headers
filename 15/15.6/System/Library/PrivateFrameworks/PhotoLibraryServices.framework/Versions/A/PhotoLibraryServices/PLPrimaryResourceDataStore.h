...
+ (char)bailOutOfVideoFinalizationForAsset:(id)a0 taskIdentifier:(id)a1 error:(id *)a2;
...
- (char)_lock_taskIsPendingDownloadWithIdentifier:(id)a0;
...
- (char)isCPLSyncableLibraryStore;
