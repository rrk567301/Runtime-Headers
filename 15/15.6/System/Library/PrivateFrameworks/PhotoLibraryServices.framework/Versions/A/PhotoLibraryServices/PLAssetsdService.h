...
@property (readonly, nonatomic) char isPhotosClient;
...
- (id)_photoLibrary;
- (char)_prepareToRunDaemonJob:(id)a0 error:(id *)a1;
...
- (void)runDaemonJob:(id)a0 isSerial:(char)a1;
- (void)runDaemonJob:(id)a0 isSerial:(char)a1 withReply:(id /* block */)a2;
