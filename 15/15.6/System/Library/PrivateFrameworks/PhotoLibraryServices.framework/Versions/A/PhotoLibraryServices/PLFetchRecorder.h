...
+ (char)_isRecordingFileFromURL:(id)a0;
...
+ (char)isCurrentProcessEnabledForRecordingBundle:(id)a0;
+ (id)sqlFromGeneralizedSQL:(id)a0 bindVars:(id)a1 multiInCounts:(id)a2 error:(id *)a3;
