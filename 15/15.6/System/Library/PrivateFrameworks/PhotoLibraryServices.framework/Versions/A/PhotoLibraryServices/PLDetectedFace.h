...
@property (readonly, nonatomic) char isTrainingFace;
...
@property (nonatomic) short cloudLocalState;
@property (readonly, nonatomic) char assetVisible;
...
+ (id)fetchDetectedFacesForAssetObjectID:(id)a0 managedObjectContext:(id)a1;
+ (id)findExistingFaceMatchingDimension:(id)a0 inFaces:(id)a1 ignoreSourceAssetDimensions:(char)a2;
+ (id)personIDsByAssetForPersonsVisibleWithPersonIDs:(id)a0 inContext:(id)a1;
...
- (id)associatedAssetForFaceOrTorso:(char)a0 orTemporal:(char)a1;
- (id)associatedPersonForFaceOrTorso:(char)a0 orTemporal:(char)a1;
...
- (char)_isFaceAndTorso;
- (char)_isTemporalFace;
- (void)_updatePersonForFaceDetectionTypeIfNeededWithPossibleNewPerson:(id)a0;
- (double)photosFaceRepresentationCenterY;
- (double)photosFaceRepresentationCenterX;
- (double)photosFaceRepresentationQuality;
- (id)syncDescription;
- (char)_faceIsDeletedBecauseAssetForFaceIsDeleted;
- (void)_fixUpTemporalRelationships;
- (char)_hasBodyHeightChange;
- (char)_hasBodyWidthChange;
- (char)_hasPersonForFaceChangeWithoutCommittedPersonForFace:(id)a0 oldAssociatedPerson:(id)a1;
- (char)_hasSizeChange;
- (char)_hasSizeOrTorsoDimensionChangeWithAssociatedAssetAndPerson;
- (char)_isFaceOnly;
- (char)_isInsertedWithAssociatedAssetAndPerson;
- (char)_isNeitherFaceNorTorso;
- (void)_recordAssetPersonEdgeAndContainmentUpdateForAsset:(id)a0 inContext:(id)a1;
- (void)_recordAssetPersonEdgeUpdatesAndSocialGroupUpdatesIfNeededWithChangedValues:(id)a0;
- (char)_startTimeAndDurationAreValid;
- (void)_touchPersonForPersistenceIfNeeded;
- (void)_updateFaceGroupIfNeeded;
- (char)_validateForOperation:(id)a0 error:(id *)a1;
