...
@property (readonly) char offerToReportAsJunk;
...
- (id)_initWithCommentsCount:(long long)a0 commentDate:(id)a1 firstCommentGUID:(id)a2 toAssetWithUUID:(id)a3 photosBatchID:(id)a4 mainAssetIsMine:(char)a5 mainAssetIsVideo:(char)a6 inAlbumWithTitle:(id)a7 albumUUID:(id)a8 albumCloudGUID:(id)a9 assetUUIDs:(id)a10 placeholderAssetUUIDs:(id)a11 lowResThumbAssetUUIDs:(id)a12;
- (id)_initWithLikesCount:(long long)a0 commentDate:(id)a1 firstCommentGUID:(id)a2 toAssetWithUUID:(id)a3 photosBatchID:(id)a4 mainAssetIsMine:(char)a5 mainAssetIsVideo:(char)a6 inAlbumWithTitle:(id)a7 albumUUID:(id)a8 albumCloudGUID:(id)a9 assetUUIDs:(id)a10 placeholderAssetUUIDs:(id)a11 lowResThumbAssetUUIDs:(id)a12 senderNames:(id)a13 forMultipleAsset:(char)a14 allMultipleAssetIsMine:(char)a15 isMixedType:(char)a16;
...
- (char)assetWithUUID:(id)a0 didChangePlaceholderKindTo:(short)a1 fromOldKind:(short)a2;
