...
- (void)_setIsTakingPhoto:(char)a0;
- (void)deletePhotoStreamData;
- (void)queuePhotoStreamJobDictionary:(id)a0;
- (void)requestAsynchronousImageForAssetOID:(id)a0 withFormat:(int)a1 allowPlaceholder:(char)a2 wantURLOnly:(char)a3 networkAccessAllowed:(char)a4 trackCPLDownload:(char)a5 completionBlock:(id /* block */)a6;
- (id)requestSynchronousImageForAssetOID:(id)a0 withFormat:(int)a1 allowPlaceholder:(char)a2 wantURLOnly:(char)a3 networkAccessAllowed:(char)a4 trackCPLDownload:(char)a5 outImageDataInfo:(id *)a6 outCPLDownloadContext:(id *)a7;
