...
+ (char)hasEntitlementsForCacheDelete;
...
- (void)_notifyDiskAvailabilityRequestCompletionHandler:(id /* block */)a0 withSuccess:(char)a1 numBytesPurged:(long long)a2 additionalBytesRequired:(long long)a3 error:(id)a4;
