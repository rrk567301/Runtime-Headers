@class NURenderContext, NUPriority, NSDictionary, PICompositionController, NUComposition, PLEditSource;
...
+ (id)rendererForVideoURL:(id)a0 livePhotoStillURL:(id)a1 adjustmentData:(id)a2 formatIdentifier:(id)a3 formatVersion:(id)a4;
...
+ (id)newImageDataFromCGImage:(struct CGImage { } *)a0 withCompressionQuality:(double)a1 metadataSourceImageURL:(id)a2 preserveRegionsInMetadata:(char)a3;
...
- (void)applySourceChangesToComposition:(id)a0 source:(id)a1 withBlock:(id /* block */)a2 executeSynchronously:(char)a3 completionBlock:(id /* block */)a4;
...
- (id)initWithEditSource:(id)a0 renderPriority:(long long)a1;
- (id)newExporter;
