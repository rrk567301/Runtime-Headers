...
- (char)_shouldTryToPropagateResultsToMomentWithInclusiveMatchedConditions:(id)a0;
- (char)evaluateAssetObjectIDs:(id)a0 simulate:(char)a1 predicateToFetchAssetsToEvaluate:(id)a2 withResultEnumerationBlock:(id /* block */)a3;
- (char)evaluateAssetObjectIDs:(id)a0 simulate:(char)a1 withResultEnumerationBlock:(id /* block */)a2;
- (char)evaluateAssetObjectIDs:(id)a0 withResultEnumerationBlock:(id /* block */)a1;
- (char)evaluateFaceObjectIDs:(id)a0 simulate:(char)a1 withResultEnumerationBlock:(id /* block */)a2;
- (char)evaluateFaceObjectIDs:(id)a0 withResultEnumerationBlock:(id /* block */)a1;
