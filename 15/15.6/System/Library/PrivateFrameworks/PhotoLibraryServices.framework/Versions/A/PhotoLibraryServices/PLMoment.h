...
+ (id)allAssetsIncludedInMomentsInManagedObjectContext:(id)a0 IDsOnly:(char)a1 error:(id *)a2;
+ (void)_recalculateAssetCountsForMoment:(id)a0;
+ (id)allAssetsInManagedObjectContext:(id)a0 predicate:(id)a1 IDsOnly:(char)a2 error:(id *)a3;
...
+ (id)allMomentsInManagedObjectContext:(id)a0 predicate:(id)a1 idsOnly:(char)a2 error:(id *)a3;
