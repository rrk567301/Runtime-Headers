...
+ (char)_disambiguationQueryTextIsExactMatchOfGroup:(id)a0 disambiguation:(id)a1 normalizedQueryText:(id)a2;
+ (char)_disambiguationQueryTextIsSubstringMatchOfGroup:(id)a0 disambiguation:(id)a1 normalizedQueryText:(id)a2;
