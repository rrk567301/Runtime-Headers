...
+ (char)enumerateAssetSearchEntitiesForLibrary:(id)a0 error:(id *)a1 withBlock:(id /* block */)a2;
...
- (char)_matchesLabel:(id)a0 type:(unsigned long long)a1 identifier:(id)a2;
