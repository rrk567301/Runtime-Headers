...
- (char)_isMasterRecordUploaded:(id)a0;
- (void)_setBatchUploadStateForTrackedMasters:(id)a0 withState:(char)a1;
- (void)_stopTrackingResourceWithScopedIdentifier:(id)a0 fileSize:(unsigned long long)a1 type:(int)a2;
- (char)_trackingMasterForScopedIdentifier:(id)a0;
...
- (void)resetIfNeededWithLibrary:(id)a0 isInitialUpload:(char)a1;
- (void)setupFromCPLManager:(id)a0;
- (void)setupFromLibrary:(id)a0 isInitialUpload:(char)a1;
...
- (void)uploadFinishedForMasterRecordWithScopedIdentifier:(id)a0 didUpdateStatus:(char *)a1;
- (void)uploadFinishedForMasterResourceWithScopedIdentifier:(id)a0 fileSize:(unsigned long long)a1 type:(int)a2 withError:(char)a3;
