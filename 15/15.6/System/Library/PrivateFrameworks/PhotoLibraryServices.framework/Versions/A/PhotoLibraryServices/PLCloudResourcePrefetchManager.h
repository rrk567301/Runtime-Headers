...
+ (char)_hasAssetsNeedingOneTimeThumbRebuildInContext:(id)a0;
+ (char)_prefetchIsEnabledForPhase:(unsigned long long)a0 givenMode:(long long)a1 andInitialSyncDate:(id)a2;
...
+ (void)resourcesToPrefetchWithPrefetchPhase:(unsigned long long)a0 prefetchMode:(long long)a1 prefetchOptimizeMode:(long long)a2 initialSyncDate:(id)a3 lastCompletePrefetchDate:(id)a4 initialBudget:(long long)a5 excludeDynamicCPLResources:(char)a6 prefetchConfiguration:(id)a7 photoLibrary:(id)a8 applyPerPrefetchLimit:(char)a9 completionHandler:(id /* block */)a10;
...
- (char)_canPrefetchInLibrary:(id)a0;
...
- (char)_isInflightResourceIdentifier:(id)a0;
- (char)_isPrefetchDisabled;
- (id)_lastCompletePrefetchDateInLibrary:(id)a0;
- (void)_prefetchComputeSyncResources:(id)a0 photoLibrary:(id)a1 prefetchPhase:(unsigned long long)a2 shouldAutoPrefetchNextBatch:(char)a3;
- (char)_prefetchIsEnabledForPhase:(unsigned long long)a0;
- (long long)_prefetchOptimizeModeBasedOnLibrarySize;
- (void)_prefetchResources:(id)a0 photoLibrary:(id)a1 prefetchPhase:(unsigned long long)a2 shouldAutoPrefetchNextBatch:(char)a3;
- (id)_prefetchStatusForDebug:(char)a0;
...
- (id)_resourcesToPrefetchWithPrefetchPhase:(unsigned long long)a0 photoLibrary:(id)a1 applyPerPrefetchLimit:(char)a2 initialBudget:(long long *)a3;
...
- (id)prefetchStatusForDebug:(char)a0;
