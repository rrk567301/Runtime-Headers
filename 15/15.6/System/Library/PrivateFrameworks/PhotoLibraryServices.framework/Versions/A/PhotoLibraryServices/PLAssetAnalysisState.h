...
+ (char)_bulkUpdateAnalysisStatesTo:(int)a0 predicate:(id)a1 library:(id)a2 error:(id *)a3;
+ (id)_countOfAnalysisStatesByWorkerTypeWithPredicate:(id)a0 analysisState:(int)a1 forDeletedAssets:(char)a2 inContext:(id)a3 error:(id *)a4;
...
+ (char)cleanupInvalidIgnoreUntilDatesInLibraryAtURL:(id)a0 error:(id *)a1;
+ (char)clearIgnoreUntilDatesInLibraryAtURL:(id)a0 error:(id *)a1;
...
+ (char)isUnitTestWorker:(short)a0;
...
+ (char)markStatesProcessedForWorkerType:(short)a0 library:(id)a1 error:(id *)a2;
+ (void)removeAnalysisRecordsForDeletedAssetUUIDs:(id)a0 forWorkerType:(short)a1 library:(id)a2;
+ (void)removeAnalysisRecordsWithNoAssetOrUUIDUseMaintenanceMode:(char)a0 library:(id)a1;
...
+ (char)resetFaceCropAnalysisStateInLibraryAtURL:(id)a0 error:(id *)a1;
+ (char)resetPendingStatesInLibraryAtURL:(id)a0 error:(id *)a1;
