...
@property (nonatomic) char allowsAuthorizationWithPhotoKitEntitlement;
@property (copy, nonatomic) NSArray *requiredEntitlements;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (char)_isAuthorizedViaTCCWithContext:(id)a0;
- (id)_verifyEntitlementsWithContext:(id)a0;
- (id)_errorForMissingEntitlements:(id)a0 withContext:(id)a1;
- (char)_isAuthorizedForReadWriteWithContext:(id)a0;
- (char)_isAuthorizedForWriteOnlyWithContext:(id)a0;
- (char)_isAuthorizedViaPhotoKitEntitlementWithContext:(id)a0;
