...
- (void).cxx_destruct;
- (id)chooseResourceWithLoadingMode:(long long *)a0 needsAdjustmentData:(char *)a1 error:(id *)a2;
...
- (char)_checkIsReallyLocallyAvailableAndAddToRepairListIfNeeded:(id)a0;
