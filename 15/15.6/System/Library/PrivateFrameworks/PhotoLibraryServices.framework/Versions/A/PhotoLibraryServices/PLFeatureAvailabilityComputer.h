...
+ (id)_predicateForAllAssetsAllowedForProcessingForSceneAnalysis:(char)a0;
+ (id)_predicateForAllCuratedAssetsForSceneAnalysis:(char)a0;
...
+ (id)_savedAssetTypePredicateForSceneAnalysis:(char)a0;

- (void).cxx_destruct;
- (void)_readLastFullModeClusterDateWithPhotoLibrary:(id)a0 completionHandler:(id /* block */)a1;
- (char)_addAnalysisStatusForMediaTaskID:(unsigned long long)a0 toProcessingSnapshot:(id)a1 managedObjectContext:(id)a2 error:(id *)a3;
- (char)_addAssetCountsToProcessingSnapshot:(id)a0 managedObjectContext:(id)a1 forSceneAnalysis:(char)a2 error:(id *)a3;
...
- (char)_addCaptioningStatusToProcessingSnapshot:(id)a0 managedObjectContext:(id)a1 error:(id *)a2;
...
- (char)_addEmbeddingVectorIndexingStatusToProcessingSnapshot:(id)a0 managedObjectContext:(id)a1 error:(id *)a2;
- (char)_addHighlightStatusToProcessingSnapshot:(id)a0 managedObjectContext:(id)a1 error:(id *)a2;
...
- (char)_addSpotlightSearchIndexingStatusToProcessingSnapshot:(id)a0 forTaskID:(unsigned long long)a1 completedCount:(long long)a2 totalCount:(long long)a3 error:(id *)a4;
...
- (char)_clearAvailabilityForPhotoLibrary:(id)a0 error:(id *)a1;
- (id)_computeAvailabilityForSnapshot:(id)a0 photoLibrary:(id)a1 shouldPersist:(char)a2 error:(id *)a3;
- (char)_failAvailabilityForPhotoLibrary:(id)a0 error:(id *)a1;
...
- (void)_onDemandAvailabilityUpdateWithChanges:(id)a0 forPhotoLibrary:(id)a1 completionHandler:(id /* block */)a2;
...
- (char)clearAvailabilityStateForPhotoLibrary:(id)a0 error:(id *)a1;
- (void)computeAvailabilityForPhotoLibrary:(id)a0 shouldPersist:(char)a1 completionHandler:(id /* block */)a2;
- (void)computeSnapshotForPhotoLibrary:(id)a0 completionHandler:(id /* block */)a1;
- (char)didDropSearchIndexForPhotoLibrary:(id)a0 error:(id *)a1;
- (char)didFinishSearchIndexRebuidForPhotoLibrary:(id)a0 error:(id *)a1;
- (char)failAvailabilityForPhotoLibrary:(id)a0 error:(id *)a1;
...
- (void)onDemandAvailabilityUpdateWithChanges:(id)a0 forPhotoLibrary:(id)a1 completionHandler:(id /* block */)a2;
