...
+ (char)_candidateHasLastUsedDateOfToday:(id)a0 calendar:(id)a1 todayDateComponents:(id)a2 calendarUnits:(unsigned long long)a3;
+ (void)_populateBuckets:(id)a0 candidates:(id)a1 shouldTryToExcludeCandidatesUsedToday:(char)a2 suggestionLimit:(unsigned long long)a3 locale:(id)a4;
