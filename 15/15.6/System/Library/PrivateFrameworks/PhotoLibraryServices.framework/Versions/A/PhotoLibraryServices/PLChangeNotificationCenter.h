...
- (char)_isInterestedInUpdatesOfObject:(id)a0;
...
- (id)_takeSnapshotOfObject:(id)a0 useCommitedValues:(char)a1;
- (void)_takeSnapshotsFromContext:(id)a0 forRemoteContextSaveNotification:(id)a1 usingObjectIDs:(char)a2;
...
- (void)managedObjectContext:(id)a0 didProcessRemoteContextSave:(id)a1 usingObjectIDs:(char)a2;
- (void)managedObjectContext:(id)a0 willProcessRemoteContextSave:(id)a1 usingObjectIDs:(char)a2 isCoalescedEvent:(char)a3;
- (void)managedObjectContextWasOverloaded:(id)a0 withNotificationData:(id)a1 usingObjectIDs:(char)a2;
- (void)managedObjectContextWillBeOverloaded:(id)a0 withNotificationData:(id)a1 usingObjectIDs:(char)a2;
