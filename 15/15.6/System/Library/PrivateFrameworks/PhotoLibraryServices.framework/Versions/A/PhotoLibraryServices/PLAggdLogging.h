...
+ (void)_configureEnumeratorForLibrarySummaryLogging:(id)a0 cloudPhotoLibraryEnabled:(char)a1 dataForCA:(id)a2 libraryServicesManager:(id)a3;
...
+ (void)configureEnumeratorForHyperionLocalResourcesLogging:(id)a0 cloudPhotoLibraryEnabled:(char)a1 dataForCA:(id)a2 dataForCK:(id)a3;
+ (void)configureEnumeratorForLibrarySizeLogging:(id)a0 cloudPhotoLibraryEnabled:(char)a1 dataForCA:(id)a2 dataForCK:(id)a3;
+ (void)configureEnumeratorForLibrarySummaryForLibraryEnumerator:(id)a0 withSyndicationLibraryEnumerator:(id)a1 cloudPhotoLibraryEnabled:(char)a2 dataForCA:(id)a3 libraryServicesManager:(id)a4;
+ (void)performCMMSummaryLogging:(id)a0 cloudPhotoLibraryEnabled:(char)a1;
