...
- (void)beginDownloadForResource:(id)a0 clientBundleID:(id)a1 highPriority:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)reportSetting:(id)a0 hasBeenEnabled:(char)a1;
