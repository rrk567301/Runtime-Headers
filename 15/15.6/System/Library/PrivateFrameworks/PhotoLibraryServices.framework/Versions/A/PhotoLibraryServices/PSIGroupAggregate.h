...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_rangeOfString:(id)a0 inGroup:(id)a1 useNormalizedString:(char)a2 extendingSearchRange:(char)a3 matchingFullToken:(char)a4 excludingRanges:(id)a5;
...
- (char)pushGroup:(id)a0 disableWildcardMatchesForUserControlledCategories:(char)a1;
