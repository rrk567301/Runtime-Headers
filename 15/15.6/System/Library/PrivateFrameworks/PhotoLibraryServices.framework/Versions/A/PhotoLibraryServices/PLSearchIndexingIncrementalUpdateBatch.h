...
@property (readonly, nonatomic) char hasDonations;
...
- (char)_flagsAreAmbiguous;
- (char)_flagsAreIncompatible;
...
- (void)inPerformTransaction_cleanUpWithSuccess:(char)a0 library:(id)a1;
