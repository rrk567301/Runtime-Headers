...
+ (char)isUserCreatedMemoryWithUserActionOptions:(unsigned short)a0;
...
+ (char)_isGenerativeMemoryWithUserActionOptions:(unsigned short)a0;
...
+ (char)_shouldPrefetchMemoryMovieCuratedAssetsInPhotoLibrary:(id)a0 prefetchConfiguration:(id)a1;
...
- (char)promoteToUserEditedMemoryWithError:(id *)a0;
- (id)scopedIdentifier;
- (void)setKeyAsset:(id)a0;
- (short)sharingComposition;
- (void)calculateSyndicatedContentState;
- (id)cplMemoryChange;
- (char)_attachGeneratedMemoryToNearestUserEditMemory;
- (char)_attachUserEditToNearestSourceMemory;
...
- (char)updateWithCPLMemoryChange:(id)a0 inPhotoLibrary:(id)a1;
