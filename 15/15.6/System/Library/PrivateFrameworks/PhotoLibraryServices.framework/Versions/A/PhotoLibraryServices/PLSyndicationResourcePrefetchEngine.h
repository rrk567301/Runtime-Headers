...
- (void)_handleDownloadFinishedWithSuccess:(char)a0 error:(id)a1 resource:(id)a2 downloadThrottlingDate:(id)a3 networkAccessAllowed:(char)a4 managedObjectContext:(id)a5;
