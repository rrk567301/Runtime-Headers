...
+ (id)entityName;
+ (void)batchFetchScenesByAssetObjectIDWithAssetObjectIDs:(id)a0 library:(id)a1 includeTemporalClassifications:(char)a2 sceneClassificationTypePredicate:(id)a3 completion:(id /* block */)a4;
...
+ (char)isUtilityAssetForSharedLibrary:(id)a0;
+ (unsigned long long)_pool_countOfOrphanedSceneClassificationsWithLimit:(unsigned long long)a0 inContext:(id)a1 error:(id *)a2;
+ (void)batchFetchScenesByAssetObjectIDWithAssetObjectIDs:(id)a0 library:(id)a1 includeTemporalClassifications:(char)a2 completion:(id /* block */)a3;
...
- (char)_validateInterpropertyValues:(id *)a0;
- (id)debugLogDescription;
- (char)isDocumentClassification;
- (char)isScreenshotClassification;
