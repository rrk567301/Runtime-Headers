...
+ (char)_isValidExtensionForSidecar:(id)a0 context:(id)a1;

- (id)init;
- (void).cxx_destruct;
- (void)reset;
- (id)collectSidecarURLsForAssetFilename:(id)a0 inDirectory:(id)a1 context:(id)a2 removeWhenDone:(char)a3;
