...
- (void).cxx_destruct;
- (void)_closePhotoLibraryAtURL:(id)a0 delete:(char)a1 reply:(id /* block */)a2;
- (char)_validateClientPermissionsToCloseLibraryAtURL:(id)a0 delete:(char)a1 error:(id *)a2;
- (void)closeAndDeletePhotoLibraryAtURL:(id)a0 sandboxExtension:(id)a1 reply:(id /* block */)a2;
