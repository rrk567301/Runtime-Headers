...
+ (char)_guestAssetSyncStatusIsSet:(long long)a0 inLibrary:(id)a1;
...
+ (char)didIngestGuestAssetsInLibrary:(id)a0;
...
- (char)_deleteAssetWithUuid:(id)a0 syndicationIdentifier:(id)a1 fromLibrary:(id)a2;
- (void)_finishProcessingWorkItemManagedObjectID:(id)a0 library:(id)a1 error:(id)a2 completion:(id /* block */)a3;
- (char)_inTransaction_deleteAssetWithUuid:(id)a0 syndicationIdentifier:(id)a1 fromLibrary:(id)a2;
