...
@interface PLDuplicateDetectorExactPixel : NSObject <PLDuplicateDetector> {
    ...
    char _enableScreenshotProcessing;
    char _disablePostProcessing;
...
- (char)_postProcessDuplicateWithPhotoLibrary:(id)a0 resultContainer:(id)a1 error:(id *)a2;
- (id)_postProcessFetchMetadataWithPhotoLibrary:(id)a0 resultContainer:(id)a1 error:(id *)a2;
- (char)_postProcessIsValidDateSource:(long long)a0;
