...
+ (id)_actionDictionaryWithLogArchive:(char)a0 networkInfo:(char)a1 crashAndSpinLogs:(char)a2 diagnosticExtensions:(char)a3;
...
+ (void)_registerCompletedReportForType:(id)a0 subType:(id)a1 subtypeContextBase:(id)a2 success:(char)a3;
+ (id)_sThrottleLock_untilDates;
+ (char)_shouldThrottleReportForType:(id)a0 subType:(id)a1 subtypeContextBase:(id)a2;
