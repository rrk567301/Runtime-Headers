...
- (void).cxx_destruct;
- (id)initWithUUID:(id)a0 sortToken:(double)a1 addedDate:(id)a2 hidden:(char)a3 visibilityState:(short)a4 trashedState:(short)a5 avalanchePickType:(int)a6 savedAssetType:(short)a7 thumbnailIdentifier:(id)a8 pathManager:(id)a9;
