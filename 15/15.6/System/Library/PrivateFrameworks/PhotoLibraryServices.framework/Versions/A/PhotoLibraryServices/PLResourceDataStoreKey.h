...
+ (char)refreshSandboxExtensionForURL:(id)a0 assetID:(id)a1 error:(id *)a2;
+ (char)refreshSandboxExtensionForURL:(id)a0 libraryID:(id)a1 assetUUID:(id)a2 error:(id *)a3;
