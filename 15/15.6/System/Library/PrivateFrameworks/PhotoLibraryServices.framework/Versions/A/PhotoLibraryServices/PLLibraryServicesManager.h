...
@property (nonatomic, getter=isFinalizing) char finalizing;
...
@property (readonly, getter=isCreateMode) char createMode;
...
- (char)isCPLSyncablePhotoLibrary;
...
- (void)setICloudPhotosEnabledInternal:(char)a0;
...
- (void)_awaitLibraryState:(long long)a0 sync:(char)a1 completionHandler:(id /* block */)a2;
- (char)_canTransitionToState:(long long)a0 error:(id *)a1;
...
- (char)_enqueueOperation:(id)a0 error:(id *)a1;
...
- (void)_setCameraRollCountedInQuota:(char)a0;
...
- (char)awaitLibraryState:(long long)a0 error:(id *)a1;
...
- (char)disableiCPLForLibraryDeletionWithError:(id *)a0;
- (char)enqueueOperation:(id)a0 error:(id *)a1;
- (char)enqueueOperationWithName:(id)a0 requiredState:(long long)a1 executionBlock:(id /* block */)a2;
- (char)finalize:(id *)a0;
...
- (char)isAppPhotoLibrary;
- (char)isSearchIndexingEnabled;
- (char)isSyndicationPhotoLibrary;
...
- (void)setCreateMode:(char)a0 options:(id)a1;
- (char)transitionToState:(long long)a0 error:(id *)a1;
- (char)updateGreenTeaSavedContactsAuthorizationIfNeeded;
- (char)updateSavedLocaleIfNeeded;
- (char)willBecomeNonSyncablePhotoLibrary:(id *)a0;
