...
+ (char)_findAndReplaceLatitudeLongitudeKeyInQuery:(id)a0;
...
+ (char)_isTextComparator:(int)a0;
+ (char)_isTextFieldQuery:(int)a0;
+ (char)_needEqualityForDoubleQuery:(int)a0;
+ (char)_needToNegateQueryForComparator:(int)a0;
...
+ (char)fixUserQueryDataInQuery:(id)a0;
+ (char)hasMatchingFetchingAlbumForSingleQuery:(id)a0 outKind:(int *)a1;
