...
+ (char)fetchPageCountsOfPersistentHistoryTablesFromDatabase:(id)a0 intoStats:(id)a1;
+ (char)fetchEarliestTransactionDateFromDatabase:(id)a0 intoStats:(id)a1;
+ (char)fetchTotalPageCountFromDatabase:(id)a0 intoStats:(id)a1;
+ (char)fetchTransactionCountFromDatabase:(id)a0 intoStats:(id)a1;
+ (char)fetchUnusedPageCountFromDatabase:(id)a0 intoStats:(id)a1;
