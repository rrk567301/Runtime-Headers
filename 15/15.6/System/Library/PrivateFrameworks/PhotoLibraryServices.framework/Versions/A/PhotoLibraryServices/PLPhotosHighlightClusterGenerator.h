...
- (id)_recentMoments;
- (id)_remainingHighlightClustersWithClusters:(id)a0 intersectingMoments:(id)a1 allowExternalSplits:(char)a2;
- (id)_remainingMomentsFromMoments:(id)a0 includeAllTripHighlightClusters:(char)a1;
- (id)_tripHighlightClustersForMoments:(id)a0 tripType:(unsigned long long)a1;
- (id)_tripsInMoments:(id)a0;
- (id)highlightClustersIntersectingMoments:(id)a0 includeAllTripHighlightClusters:(char)a1;
