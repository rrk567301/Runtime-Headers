...
+ (char)groupDuplicateOrSynonymExistsForGroup:(id)a0 inGroups:(id)a1;
+ (void)intersectGroups:(id)a0 searchResultTypes:(unsigned long long)a1 shouldGenerateCompletionCandidates:(char)a2 query:(id)a3 completion:(id /* block */)a4;
...
+ (char)shouldUseExactMatchResultsForGroups:(id)a0;
