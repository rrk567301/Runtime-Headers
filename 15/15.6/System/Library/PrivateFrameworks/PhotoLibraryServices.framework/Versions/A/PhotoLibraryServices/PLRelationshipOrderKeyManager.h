...
- (id)init;
- (void).cxx_destruct;
- (void)_getAndResetEnqueuedOrderValueUpdatesForFolders:(id *)a0 albums:(id *)a1 conflictDetected:(char *)a2;
- (id)_locked_enqueuedAlbumAssetsOrderValueUpdates;
- (id)_locked_enqueuedFolderAlbumsOrderValueUpdates;
- (id)_locked_locationsCache;
- (id)_locked_spiSafeContextGivenPassedInContext:(id)a0 andName:(const char *)a1;
...
- (id)_orderingStateForRelationship:(id)a0 onObjectWithID:(id)a1 invalidateCache:(char)a2 usingSPISafeContext:(id)a3;
- (id)_orderingStateForRelationship:(id)a0 onObjectWithID:(id)a1 usingSPISafeContext:(id)a2;
- (void)_setConflictDetected:(char)a0;
...
- (void)migration_fixupOrderKeys:(id)a0 usingOrderValuePropertyKey:(id)a1 enforceSingletonAlbumReservedKeySpace:(char)a2;
...
- (id)objectIDsAndOrderValuesForRelationship:(id)a0 onObjectWithID:(id)a1 invalidateCache:(char)a2 inContext:(id)a3;
- (id)parentFolderOrderValueForAlbum:(id)a0 inManagedObjectContext:(id)a1;
- (void)stashAlbumAssetsLocationValue:(long long)a0 forAssetWithID:(id)a1 inAlbumWithID:(id)a2 atIndex:(unsigned long long)a3 usingContext:(id)a4;
- (void)stashFolderAlbumsLocationValue:(long long)a0 forAlbumWithID:(id)a1 inFolderWithID:(id)a2 atIndex:(unsigned long long)a3 usingContext:(id)a4;
- (void)updateAlbumAssetsUsingTransientOrdersByAlbumOID:(id)a0 inLibrary:(id)a1;
- (char)writeStashedLocationValuesInContext:(id)a0 error:(id *)a1;
