...
- (char)shouldAcceptConnectionsFromClientWithContext:(id)a0;
- (char)shouldAcceptMetadataChangesFromClientWithContext:(id)a0;
...
- (char)_restrictedLockedContentAccessAllowedForContext:(id)a0;
