...
+ (char)duplicateDetectorCompletedDateBackgroundMigrationAction:(id)a0;
+ (char)duplicateDetectorCompletedPerceptualHashProcessingWithManagedObjectContext:(id)a0 pathManager:(id)a1;
+ (id)duplicateDetectorExcludeZeroByteStableHashPredicateWithProperty:(id)a0;
