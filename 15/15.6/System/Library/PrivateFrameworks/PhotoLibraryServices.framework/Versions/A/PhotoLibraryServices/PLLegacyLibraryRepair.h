...
+ (char)_setPostLegacyMigrationRepairMarkerWithValue:(unsigned char)a0 pathManager:(id)a1;
+ (void)addPostLegacyMigrationRepairMarkerWithPathManager:(id)a0;
+ (char)checkPostLegacyMigrationRepairIsRequiredWithPathManager:(id)a0;
...
+ (char)isLegacyMigrationRecoveryCompletedWithPathManager:(id)a0;
+ (char)isLegacyMigrationRecoveryEnabledWithPathManager:(id)a0;

- (void).cxx_destruct;
- (char)isCancelled;
- (char)_processInternalResourceProperties:(id)a0 resourceFingerprint:(id)a1 fileURL:(id)a2;
- (void)_applyFilePersistenceMetadataWithPropertyMap:(id)a0;
- (void)_applyInternalResourceCorrectionsForAssetUuids:(id)a0;
- (char)_archiveFilePath:(id)a0;
- (id)_buildFingerprintInternalResourcePropertyMap;
- (char)_cleanupEmptyDirectory:(id)a0 fileExtensionPredicate:(id)a1 progress:(id)a2;
- (char)_cloneOrMoveSourcePath:(id)a0 destPath:(id)a1 move:(char)a2;
- (id)_internalResourcesFromFingerprint:(id)a0 url:(id)a1;
- (char)_isValidFileURL:(id)a0;
- (char)_moveItemWithSourceURL:(id)a0 uuid:(id)a1 uti:(id)a2 resourceType:(unsigned int)a3 destinationURL:(id *)a4;
- (char)_processAvailabilityCheckAndUpdateResourceFileWithInternalResourceProperty:(id)a0 resourceFingerprint:(id)a1 fileURL:(id)a2 move:(char)a3;
- (char)_processFileResourceWithURL:(id)a0 uuid:(id)a1 uti:(id)a2;
- (char)_processFileURL:(id)a0 uti:(id)a1;
...
- (char)_relocateMediaFromOriginalsRelocatedURL:(id)a0;
- (char)_removeLegacyResourceFileWithURL:(id)a0;
