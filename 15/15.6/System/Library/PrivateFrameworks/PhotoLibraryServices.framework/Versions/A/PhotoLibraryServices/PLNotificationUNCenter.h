...
+ (id)_invitationsCategoryWithJunkAction:(char)a0;
...
- (void)sendNotificationForNotification:(id)a0 withAttachmentURL:(id)a1 forceToSound:(char)a2;
...
- (id)_notificationContentWithNotification:(id)a0 withImageURL:(id)a1 sound:(char)a2;
