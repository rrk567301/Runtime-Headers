...
+ (char)_groupIsMePerson:(id)a0 mePersonUUID:(id)a1;
...
+ (id)_templateCandidatesForFirstRankedGroup:(id)a0 secondRankedGroup:(id)a1 allTemplates:(id)a2 assetIdsByDateFilter:(id)a3 scopedAssetIdsCount:(unsigned long long)a4 templateProvider:(id)a5 mePersonExists:(char)a6 minResultCountPerSuggestion:(unsigned long long)a7;
+ (id)_templateCandidatesFromRankedGroups:(id)a0 assetIdsByDateFilter:(id)a1 scopedAssetIds:(struct __CFArray { } *)a2 templateProvider:(id)a3 mePersonExists:(char)a4 minResultCountPerSuggestion:(unsigned long long)a5 suggestionStyleType:(unsigned long long)a6;
