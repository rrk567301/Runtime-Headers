...
+ (char)_populateObjectDictionary:(id)a0 withObject:(id)a1 currentKeyPath:(id)a2 usingModelProperties:(id)a3 payloadClass:(Class)a4 info:(id)a5;
...
+ (char)shouldPersistForChangedKeys:(id)a0 entityName:(id)a1;
...
- (char)_applyModelProperties:(id)a0 toPayloadAttributes:(id)a1 andNilAttributes:(id)a2 fromSourceObject:(id)a3 changedKeys:(id)a4 info:(id)a5;
...
- (char)_comparePayloadAttributes:(id)a0 toObjectDictionary:(id)a1 currentKeyPath:(id)a2 usingModelProperties:(id)a3 errorDescriptions:(id)a4;
- (char)_decodePayloadAttributesFromData:(id)a0 error:(id *)a1;
...
- (char)comparePayloadToObjectDictionary:(id)a0 usingModelProperties:(id)a1 errorDescriptions:(id)a2;
...
- (char)payloadVersionIsLessThanVersion:(unsigned int)a0 forKey:(id)a1 inUpdatePayloads:(id)a2;
