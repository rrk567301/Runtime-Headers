...
+ (char)_deleteAllSearchableItemsForSystemPhotoLibraryWithError:(out id *)a0;
...
+ (void)handleUniversalSearchPhotoLibraryEligibilityChangeWithDetectedPathChange:(char)a0;
...
- (void)_signPostIntervalForOperationType:(unsigned long long)a0 searchableItemCount:(unsigned long long)a1 isBegin:(char)a2;
...
- (void)setSpotlightOperationQueueSuspended:(char)a0;
