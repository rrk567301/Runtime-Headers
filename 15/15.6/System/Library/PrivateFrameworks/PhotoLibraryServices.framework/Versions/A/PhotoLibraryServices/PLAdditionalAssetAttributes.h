...
@property (nonatomic) char allowedForAnalysis;
...
@property (nonatomic) char sceneAnalysisIsFromPreview;
...
+ (id)predicateToIncludeOnlyAllowedForAnalysisAndProcessedToFaceVersion:(id)a0 noindex:(char)a1;
+ (id)predicateToIncludeOnlyAllowedForAnalysisAndProcessedToLatestFaceVersionWithNoindex:(char)a0;
+ (id)predicateToIncludeOnlyAllowedForAnalysisAndProcessedToLatestSceneVersionWithNoindex:(char)a0;
+ (id)predicateToIncludeOnlyAllowedForAnalysisWithNoindex:(char)a0;
+ (char)shouldPersistImportedByDisplayName:(id)a0;
...
+ (id)predicateToIncludeOnlyAllowedForAnalysisAndProcessedToSceneVersion:(id)a0 noindex:(char)a1;
...
- (void)setShiftedLocationIsValid:(char)a0;
...
- (char)containsDuplicateDetectorPerceptualProcessingState:(unsigned short)a0;
- (void)correctOriginalOrientationIfRequired;
- (id)duplicateSortPropertyNames;
- (id)duplicateSortPropertyNamesSkip;
- (char)hasCloudRecoveryStateFlagSet:(unsigned long long)a0;
- (char)hasConsistentCloudState;
- (char)hasDuplicateMatchingData;
