...
- (char)_commentIsBatchCaption:(id)a0;
...
- (id)_firstEntryRelativeToDate:(id)a0 ascending:(char)a1 includeSameDate:(char)a2;
...
- (char)_shouldIgnoreAsset:(id)a0;
- (char)_shouldIgnoreComment:(id)a0;
- (char)_shouldIgnoreInvitationRecord:(id)a0;
- (char)_shouldMergeAsset:(id)a0 intoEntry:(id)a1;
...
- (char)_tryMergingComment:(id)a0 withEntry:(id)a1;
- (char)_wasAssetPublishedBeforeSubscription:(id)a0;
- (char)_wasCommentPublishedBeforeSubscription:(id)a0;
