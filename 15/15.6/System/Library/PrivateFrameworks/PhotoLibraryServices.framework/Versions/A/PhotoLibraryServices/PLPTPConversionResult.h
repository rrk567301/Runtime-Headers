...
@property (readonly) char requiresConversion;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithRequiresConversion:(char)a0 pathExtension:(id)a1 estimatedFileLength:(unsigned long long)a2 inputVideoCodec:(unsigned int)a3 inputContentType:(id)a4 outputVideoCodec:(unsigned int)a5 outputContentType:(id)a6;
