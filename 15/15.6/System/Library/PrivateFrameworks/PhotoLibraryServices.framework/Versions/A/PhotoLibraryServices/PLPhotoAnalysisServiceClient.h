...
- (char)requestGenerateDefaultRulesForLibraryScopeWithLocalIdentifier:(id)a0 withOptions:(id)a1 error:(id *)a2;
...
- (char)requestInvalidatePersistentCaches:(id *)a0;
- (char)requestInvalidateTransientCaches:(id *)a0;
...
- (char)requestTitleForAssetCollectionWithLocalIdentifier:(id)a0 format:(long long)a1 title:(id *)a2 subtitle:(id *)a3 error:(id *)a4;
- (char)requestTitleForCollectionMomentListWithLocalIdentifier:(id)a0 format:(long long)a1 title:(id *)a2 subtitle:(id *)a3 error:(id *)a4;
- (char)requestTitleForPersonLocalIdentifiers:(id)a0 format:(long long)a1 title:(id *)a2 subtitle:(id *)a3 error:(id *)a4;
...
- (long long)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)a0 forceUpdate:(char)a1 completion:(id /* block */)a2;
- (char)reportMetricsWithOptions:(id)a0 error:(id *)a1;
...
- (void)_resetServicesIncludingConnection:(char)a0;
...
- (char)rebuildPersonsWithOptions:(id)a0 error:(id *)a1;
- (char)reclusterFacesWithOptions:(id)a0 error:(id *)a1;
...
- (id)requestConfidenceByMomentLocalIdentifierForMeaning:(id)a0 useAlternativeMeaningEdge:(char)a1 onlyHighPrecision:(char)a2 error:(id *)a3;
...
- (char)requestSetDefaultsObject:(id)a0 forKey:(id)a1 withError:(id *)a2;
...
- (char)requestSyndicationLibraryRevGeocodingWithError:(id *)a0;
...
- (char)resetFaceClassificationModel:(id *)a0;
