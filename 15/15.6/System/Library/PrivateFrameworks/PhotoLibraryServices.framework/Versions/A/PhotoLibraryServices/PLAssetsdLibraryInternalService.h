...
- (unsigned long long)_assetCountInManagedObjectContext:(id)a0 forSyncedAssets:(char)a1;
...
- (void)availabilityStateShouldPersist:(char)a0 reply:(id /* block */)a1;
...
- (void)getLibrarySizesFromDB:(char)a0 reply:(id /* block */)a1;
