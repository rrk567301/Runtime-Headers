...
+ (void)photoIrisPairingDidSucceed:(char)a0 fileIndicatorPath:(id)a1 photoAsset:(id)a2 photoLibrary:(id)a3;
+ (id)_assetUUIDFromIncomingFilename:(id)a0;
+ (id)_assetAdjustmentsFromCameraAdjustmentData:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 assetType:(short)a3 applySemanticEnhance:(char)a4 sourceURL:(id)a5;
+ (id)_assetAdjustmentsFromCameraAdjustments:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 assetType:(short)a3 applySemanticEnhance:(char)a4 sourceURL:(id)a5;
+ (id)_fetchPhotoAssetForUUID:(id)a0 moc:(id)a1;
+ (char)_hasPrimaryAssetAndAdjustmentsFilesWithType:(short)a0 inIncomingFilenames:(id)a1 forAssetUUID:(id)a2;
+ (id)_pathsByAssetUUIDFromIncomingCrashRecoveryPaths:(id)a0;
+ (char)_requiresAssetUUIDForJobType:(id)a0;
+ (char)_requiresCrashRecoveryForJobType:(id)a0;
+ (char)_requiresIndicatorFileForJobType:(id)a0;
+ (void)_signalBackgroundProcessingNeededForAsset:(id)a0 reason:(id)a1;
+ (id)assetAdjustmentsFromCameraAdjustmentData:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 applySemanticEnhance:(char)a3;
+ (id)assetAdjustmentsFromCameraAdjustmentData:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 applySemanticEnhance:(char)a3 assetType:(short)a4;
+ (id)assetAdjustmentsFromCameraAdjustmentData:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 applySemanticEnhance:(char)a3 assetType:(short)a4 sourceURL:(id)a5;
...
+ (id)assetAdjustmentsFromCameraAdjustments:(id)a0 cameraMetadata:(id)a1 exportProperties:(id)a2 applySemanticEnhance:(char)a3;
...
+ (char)isDeferredPhotoPreviewURL:(id)a0;
+ (char)isSpatialOverCaptureURL:(id)a0;
+ (id)pathComponentForIncomingHoldingDirectory;
+ (id)semanticEnhancePreviewDestinationURLForPrimaryAssetURL:(id)a0;
+ (char)semanticEnhanceSceneIsValid:(long long)a0;
+ (char)setAdjustmentsForNewPhoto:(id)a0 mainFileMetadata:(id)a1 cameraAdjustmentData:(id)a2 adjustmentDataPath:(id)a3 filteredImagePath:(id)a4 cameraMetadata:(id)a5 finalAssetSize:(struct CGSize { double x0; double x1; })a6 isSubstandardRender:(char)a7;
...
- (char)_enterAtomicCrashRecoveryJobProcessing;
...
- (char)_hasNonCrashRecoveryJobsEnqueued;
- (void)_incrementJobCount:(id)a0;
- (char)_isHighPriorityJob:(id)a0;
...
- (char)_retryPairedVideoJob:(id)a0 pairingType:(id)a1 pairingIdentifier:(id)a2 retryMax:(unsigned long long)a3;
- (char)_transferVideoFromIncomingPath:(id)a0 toDestinationPath:(id)a1 shouldRemoveIncoming:(char *)a2 error:(id *)a3;
- (char)canEnqueueJob:(id)a0;
- (void)enqueueAutoDeleteEmptyAlbumJobWithAlbumID:(id)a0;
- (char)enqueueJob:(id)a0;
- (char)imageWriterJob:(id)a0 hasValidPathsWithConnection:(id)a1;
