...
- (id)importFileSystemAssetsWithReason:(id)a0 force:(char)a1 reply:(id /* block */)a2;
...
- (void)updateThumbnailsForPhotos:(id)a0 assignNewIndex:(char)a1 forceRefresh:(char)a2 reply:(id /* block */)a3;
