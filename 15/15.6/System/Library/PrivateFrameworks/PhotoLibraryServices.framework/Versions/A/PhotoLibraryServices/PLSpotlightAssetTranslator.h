...
+ (char)_indexLocalDateCreated;
+ (id)_jsonRepresentationForCSPersons:(id)a0;
+ (id)_jsonRepresentationForScenesFromAsset:(id)a0 fetchHelper:(id)a1 indexingContext:(id)a2 isSensitiveLocation:(out char *)a3;
...
+ (id)_privateEncryptedComputeScenesForAsset:(id)a0 fetchHelper:(id)a1 csuTaxonomyObjectStore:(id)a2 locale:(id)a3 isSensitiveLocation:(out char *)a4;
...
+ (id)jsonDictionaryFromAsset:(id)a0 libraryIdentifier:(long long)a1 graphData:(id)a2 indexingContext:(id)a3 includeEmbeddingData:(char)a4 redacted:(char)a5;
