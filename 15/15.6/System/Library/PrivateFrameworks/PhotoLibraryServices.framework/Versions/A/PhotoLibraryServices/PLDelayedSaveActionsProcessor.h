...
- (void)_processAssetIDsByPersonUUIDNeedingContainmentUpdates:(id)a0 assetIDsNeedingContainmentUpdates:(id)a1 pendingMemberIDsOfSocialGroupsNeedingContainmentUpdates:(char)a2 library:(id)a3 transaction:(id)a4;
...
- (void)_processDelayedAlbumTrashUpdates:(id)a0 library:(id)a1 transaction:(id)a2;
- (void)_processDelayedAlbumWidgetTimelineReload:(char)a0 library:(id)a1 transaction:(id)a2;
...
- (void)_processDelayedFeaturedContentUpdateAndWidgetTimelineReload:(char)a0 withPersonUUIDs:(id)a1 shouldReloadWidgetTimeline:(char)a2 library:(id)a3 transaction:(id)a4;
- (void)_processDelayedForYouWidgetTimelineReload:(char)a0 library:(id)a1 transaction:(id)a2;
...
- (void)_processDelayedLibraryScopeRulesUpdate:(char)a0 library:(id)a1 transaction:(id)a2;
...
- (void)_processMembersOfSocialGroupsNeedingDeduplication:(id)a0 pendingSocialGroupIDsNeedingDeduplication:(char)a1 library:(id)a2 transaction:(id)a3;
