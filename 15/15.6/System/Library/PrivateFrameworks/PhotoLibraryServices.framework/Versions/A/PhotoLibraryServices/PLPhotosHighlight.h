...
@interface PLPhotosHighlight : PLManagedObject <PLSearchableManagedObject, PLPhotosHighlightData> {
    char _waitingForSharedAssetContainerRecalc;
}
...
@property (readonly, nonatomic) char missingKeyAssetForKindPrivate;
@property (readonly, nonatomic) char missingKeyAssetForKindShared;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
- (int)_cachedAssetCountForCountKey:(id)a0 collectionKey:(id)a1 isShared:(char)a2;
...
- (char)_needsRecalculateCollageAssets;
