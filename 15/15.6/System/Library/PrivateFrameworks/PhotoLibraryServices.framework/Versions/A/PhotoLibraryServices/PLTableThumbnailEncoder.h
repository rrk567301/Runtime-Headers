...
+ (struct CGImage { } *)_createDownscaledImageFromSource:(struct CGImageSource { } *)a0 toSize:(struct CGSize { double x0; double x1; })a1 cropped:(char)a2;
+ (struct CGImage { } *)_createDownscaledImageFromSourceImage:(struct CGImage { } *)a0 toSize:(struct CGSize { double x0; double x1; })a1 cropped:(char)a2;
