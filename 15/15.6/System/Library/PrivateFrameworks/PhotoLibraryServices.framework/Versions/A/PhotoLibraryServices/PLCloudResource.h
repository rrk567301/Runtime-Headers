...
+ (char)_countOfLocalCloudResourcesOfType:(unsigned long long)a0 inManagedObjectContext:(id)a1 forMediumSized:(char)a2 localCount:(unsigned long long *)a3 unavailableCount:(unsigned long long *)a4 error:(id *)a5;
...
+ (char)countOfLocalCloudResourcesOfType:(unsigned long long)a0 inManagedObjectContext:(id)a1 localCount:(unsigned long long *)a2 unavailableCount:(unsigned long long *)a3 error:(id *)a4;
+ (char)countOfMediumOriginalLocalCloudResourcesInManagedObjectContext:(id)a0 localCount:(unsigned long long *)a1 unavailableCount:(unsigned long long *)a2 error:(id *)a3;
+ (id)duplicateCloudResource:(id)a0 forAsset:(id)a1 withFilePath:(id)a2 inManagedObjectContext:(id)a3;
+ (id)insertIntoPhotoLibrary:(id)a0 forAsset:(id)a1 withCPLResource:(id)a2 adjusted:(char)a3 withCreationDate:(id)a4;
+ (id)legacyCloudResourceForResourceType:(unsigned long long)a0 forAsset:(id)a1;
+ (char)legacyCreateNewResourcesIn:(id)a0 inManagedObjectContext:(id)a1 forAsset:(id)a2;
...
- (id)cplResourceIncludeFile:(char)a0;
- (void)repairCloudPlaceholderKindForVideoAsset:(id)a0;
- (void)setIsLocallyAvailable:(char)a0;
