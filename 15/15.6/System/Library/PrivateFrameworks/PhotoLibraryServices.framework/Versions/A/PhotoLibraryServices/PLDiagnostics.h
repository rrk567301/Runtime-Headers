...
+ (void)_tapToRadarKitDraftWithTitle:(id)a0 description:(id)a1 radarComponent:(long long)a2 isUserInitiated:(char)a3 displayReason:(id)a4 attachments:(id)a5;
...
+ (char)shouldSuppressRadarUserNotificationWithMessage:(id)a0 radarTitle:(id)a1;
+ (char)tapToRadarKitDisabled;
+ (void)tapToRadarWithTitle:(id)a0 description:(id)a1 radarComponent:(long long)a2 isUserInitiated:(char)a3 displayReason:(id)a4 attachments:(id)a5;
