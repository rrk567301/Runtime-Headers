...
- (char)appendSnapshotWithJournal:(id)a0 usingManagedObjectContext:(id)a1 changedKeys:(id)a2 entryLimit:(unsigned long long)a3 error:(id *)a4;
- (char)createSnapshotWithJournal:(id)a0 createOnlyIfNecessary:(char)a1 usingManagedObjectContext:(id)a2 entryLimit:(unsigned long long)a3 error:(id *)a4;
...
- (char)saveHistoryToken:(id)a0 error:(id *)a1;
