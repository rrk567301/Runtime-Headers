...
- (void).cxx_destruct;
- (void)invalidate;
- (char)takeReservedCloudIdentifierWithEntityName:(id)a0 uuid:(id)a1 clientBundleIdentifier:(id)a2 error:(id *)a3;
- (id)_lock_reservedIdentifiersForEntityName:(id)a0 clientBundleIdentifier:(id)a1;
- (char)cancelReservedCloudIdentifiersWithEntityName:(id)a0 clientBundleIdentifier:(id)a1 error:(id *)a2;
