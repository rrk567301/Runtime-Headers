...
- (char)generatePosterFrameExportForVideoURL:(id)a0 outputData:(id *)a1 maximumSize:(struct CGSize { double x0; double x1; })a2 error:(id *)a3;
- (id)requestForOriginalAtPath:(id)a0 isVideo:(char)a1 imageDimensions:(struct CGSize { double x0; double x1; })a2 originalPairingIdentifier:(id)a3;
- (id)requestForPath:(id)a0 isVideo:(char)a1 imageDimensions:(struct CGSize { double x0; double x1; })a2;
...
- (id)sourceForPath:(id)a0 isVideo:(char)a1 imageDimensions:(struct CGSize { double x0; double x1; })a2;
