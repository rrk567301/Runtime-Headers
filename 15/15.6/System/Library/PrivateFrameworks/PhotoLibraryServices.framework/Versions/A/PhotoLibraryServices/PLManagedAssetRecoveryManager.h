...
- (char)_fixIrisWithZeroVideoComplementDuration:(id)a0 usingExistingVideoComplementAtPath:(id)a1 error:(id *)a2;
...
- (char)_fixRawUTIForAsset:(id)a0 error:(id *)a1;
...
- (id)_newPhotoLibraryWithName:(const char *)a0 nonSyncable:(char)a1;
...
- (void)startRecoveryUsingCloudPhotoLibraryManager:(id)a0 transaction:(id)a1 shouldIdentifyInconsistentAssets:(char)a2;
