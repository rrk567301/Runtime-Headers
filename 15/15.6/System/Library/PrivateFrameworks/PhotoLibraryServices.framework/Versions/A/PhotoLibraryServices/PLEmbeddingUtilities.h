...
+ (id)averageTop:(unsigned long long)a0 forEmbeddingCompareObjectsByAssetUUID:(id)a1 sortAscending:(char)a2;
...
+ (id)fetchAssetsForCLIPGenerationFromPhotoLibrary:(id)a0 limitToExtendedAssets:(char)a1 assetFetchLimit:(unsigned long long)a2 error:(out id *)a3;
...
+ (id)sortCompareObjects:(id)a0 sortAscending:(char)a1;
