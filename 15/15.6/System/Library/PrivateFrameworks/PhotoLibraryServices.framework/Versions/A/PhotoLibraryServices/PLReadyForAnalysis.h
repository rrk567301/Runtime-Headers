...
@property (readonly) char isReadyForAnalysis;
@property (readonly) char isReadyForAnalysisQuickCheck;
@property (readonly) char isReadyForAnalysisInitialDownloadCompleted;
...
- (char)_lock_isReadyForAnalysisState:(unsigned short)a0;
