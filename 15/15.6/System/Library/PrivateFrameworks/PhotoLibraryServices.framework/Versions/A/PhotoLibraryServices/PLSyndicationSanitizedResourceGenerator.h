...
- (char)_handleGenerateCompletionWithGenerateError:(id)a0 storedRecipes:(id)a1 sourceMetadata:(id)a2 targetRecipe:(id)a3 assetObjectID:(id)a4 managedObjectContext:(id)a5 timeZoneLookup:(id)a6 error:(id *)a7;
