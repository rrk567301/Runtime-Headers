...
+ (char)_isCurrentMomentOutlierWithPreviousMoment:(id)a0 currentMoment:(id)a1 nextMoment:(id)a2;
+ (char)_isTimeDeltaViableForDistanceDeltaBetweenPreviousMoment:(id)a0 currentMoment:(id)a1;
...
+ (char)tripsEligibleForMoments:(id)a0 frequentLocations:(id)a1;
