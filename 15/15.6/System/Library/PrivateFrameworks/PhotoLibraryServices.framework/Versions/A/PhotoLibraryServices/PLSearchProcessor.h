...
- (char)_categoryMaskIsCombinable:(unsigned long long)a0;
...
- (char)_shouldOmitSectionForCategoryMask:(unsigned long long)a0;
...
- (void)performQuery:(id)a0 disableWildcardMatchesForUserControlledCategories:(char)a1 withResultsHandler:(id /* block */)a2;
...
- (id)searchResultSectionsForQuery:(id)a0 withAssetResults:(id)a1 assetResultsForCompletions:(id)a2 collectionResults:(id)a3 combineAssetSections:(char)a4;
