...
+ (id)_chooseFileReservationForLargeDisplayableImageFileForAsset:(id)a0 format:(id)a1 forceLarge:(char)a2 allowMetadataSnapshot:(char)a3 outFilePath:(id *)a4 outImageType:(long long *)a5;
+ (long long)_fileResourceTypeForCloudResourceType:(unsigned long long)a0 hasAdjustments:(char)a1 requiresUnadjustedVersion:(char)a2;
...
+ (id)fileReservationForLargeDisplayableImageFileForAsset:(id)a0 format:(id)a1 allowMetadataSnapshot:(char)a2 forceLarge:(char)a3 outFilePath:(id *)a4 outImageType:(long long *)a5;
