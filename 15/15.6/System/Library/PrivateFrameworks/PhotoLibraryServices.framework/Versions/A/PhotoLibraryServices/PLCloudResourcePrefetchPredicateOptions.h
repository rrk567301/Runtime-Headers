...
@property (nonatomic) char excludeDynamicResources;
@property (retain, nonatomic) PLPrefetchConfiguration *prefetchConfiguration;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (id)initWithPrefetchMode:(long long)a0 prefetchOptimizeMode:(long long)a1 excludeDynamicResources:(char)a2 prefetchConfiguration:(id)a3;
