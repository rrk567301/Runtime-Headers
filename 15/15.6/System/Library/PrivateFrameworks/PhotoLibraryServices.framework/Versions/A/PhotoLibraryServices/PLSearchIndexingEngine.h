...
- (char)hasRebuildWorkToDoForLibrary:(id)a0;
...
- (char)supportsPSI;
- (char)supportsSpotlightClientState;
- (char)supportsSpotlightDelete;
- (char)supportsSpotlightDonate;
