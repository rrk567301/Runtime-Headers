...
- (char)_readFromFileHandle:(id)a0 decodePayload:(char)a1 payloadClass:(Class)a2 error:(id *)a3;
...
- (char)readFromFileHandle:(id)a0 decodePayload:(char)a1 payloadClass:(Class)a2 entryOffset:(unsigned long long *)a3 error:(id *)a4;
- (void)writeBytes:(const void *)a0 length:(unsigned long long)a1 toFileHandle:(id)a2 checksumContext:(id)a3;
- (char)writeToFileHandle:(id)a0 checksumContext:(id)a1 error:(id *)a2;
