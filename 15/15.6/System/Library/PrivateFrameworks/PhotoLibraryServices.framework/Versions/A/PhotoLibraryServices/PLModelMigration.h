...
@property (readonly) char allowRebuild;
@property (readonly) char didCreateSqliteErrorIndicator;
...
- (id)migrationContext;
- (void)registerActionClass:(Class)a0 onCondition:(char)a1;
- (void)registerPostRepairActionClass:(Class)a0 onCondition:(char)a1;
- (void)registerPreRepairActionClass:(Class)a0 onCondition:(char)a1;
- (void)registerStagedActionClass:(Class)a0 onCondition:(char)a1;
- (void)resetBackgroundActionClass:(Class)a0 onCondition:(char)a1;
