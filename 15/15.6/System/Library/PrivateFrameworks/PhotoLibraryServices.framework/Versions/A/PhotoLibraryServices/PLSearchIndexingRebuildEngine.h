...
@interface PLSearchIndexingRebuildEngine : NSObject {
    ...
    char _lock_isRunning;
    char _lock_isPausing;
...
+ (char)hasRebuildWorkToDoForLibrary:(id)a0 identifier:(long long)a1 sceneTaxonomyDigests:(id)a2;
+ (char)requiresImmediateDropIndexForLibrary:(id)a0 reasons:(unsigned long long *)a1;
...
- (char)_inq_isValidForCoreAnalyticsCaptureWithRebuildReason:(unsigned long long)a0;
- (void)_inq_rebuildAnalyticsCompletedWithResult:(id)a0;
- (char)_inq_rebuildAnalyticsEventIsValid;
