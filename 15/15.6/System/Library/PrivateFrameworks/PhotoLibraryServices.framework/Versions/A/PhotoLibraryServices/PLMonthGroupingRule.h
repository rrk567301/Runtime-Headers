...
- (unsigned long long)_extendedAssetsCountThresholdForHighlightItem:(id)a0;
...
- (char)highlightItem:(id)a0 belongsToHighlightItemList:(id)a1;
- (char)highlightItemHasMinimumRequirementToBePromoted:(id)a0 withSharingConsideration:(long long)a1;
- (char)highlightItemList:(id)a0 canBeMergedWithOtherHighlightItemList:(id)a1;
...
- (void)titlesForHighlightItemList:(id)a0 dateRangeTitleGenerator:(id)a1 forceUpdateLocale:(char)a2 resultBlock:(id /* block */)a3;
