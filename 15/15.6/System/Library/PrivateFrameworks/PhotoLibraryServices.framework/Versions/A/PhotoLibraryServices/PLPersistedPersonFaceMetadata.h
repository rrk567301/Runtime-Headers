...
@property (nonatomic, getter=isRepresentative) char representative;
@property (nonatomic, getter=isClusterRejected) char clusterRejected;
@property (nonatomic) int nameSource;
@property (nonatomic) int cloudNameSource;
@property (nonatomic) int faceAlgorithmVersion;
@property (readonly, nonatomic, getter=isHidden) char isHidden;
...
+ (id)_persistedFaceMetadataWithDetectedFace:(id)a0 isKeyFace:(char)a1 isClusterRejected:(char)a2;
...
- (id)_insertDeferredRebuildFaceFromDataInManagedObjectContext:(id)a0 personUUID:(id)a1 isRejected:(char)a2;
- (char)isDeferrable;
- (char)matchesEntityInLibraryBackedByManagedObjectContext:(id)a0 forConfirmedPersonUUID:(id)a1 diff:(id *)a2;
- (char)matchesEntityInLibraryBackedByManagedObjectContext:(id)a0 forRejectedPersonUUID:(id)a1 diff:(id *)a2;
