...
@property (nonatomic) char didCallBeginGeneration;
...
+ (id)_bestAssetInAssets:(id)a0 fallback:(char)a1;
...
+ (char)_shouldUpdateKeyAssetForParentHighlight:(id)a0 withPrivateKeyAssetObjectID:(id)a1 andSharedKeyAssetObjectID:(id)a2;
...
+ (char)assetEligibleForCuration:(id)a0;
+ (char)assetEligibleForRecents:(id)a0;
...
+ (void)updateTitleForHighlights:(id)a0 forKind:(unsigned short)a1 forceUpdateLocale:(char)a2 dateRangeTitleGenerator:(id)a3;
...
- (char)_highlightShouldNotBeVisible:(id)a0 sharingConsideration:(long long)a1;
- (id)_highlightToReuseForMoments:(id)a0;
- (char)_highlightTypeSupportsVisibilityStateDayOnly:(unsigned short)a0;
...
- (char)_setVisibilityStateForHighlight:(id)a0 shouldForceUpdate:(char)a1 sharingConsideration:(long long)a2;
- (void)_updateDayGroupHighlight:(id)a0 withNewAssets:(id)a1;
- (void)_updateDayHighlight:(id)a0 withNewAssets:(id)a1;
- (char)_updateHighlightProperties:(id)a0 fromHighlightCluster:(id)a1;
...
- (void)generateHighlightsForUpsertedMoments:(id)a0 frequentLocationsDidChange:(char)a1;
...
- (char)setVisibilityStateForHighlight:(id)a0 shouldForceUpdate:(char)a1;
- (char)shouldForceVisibilityStateUpdateForHighlight:(id)a0 highlightCluster:(id)a1;
