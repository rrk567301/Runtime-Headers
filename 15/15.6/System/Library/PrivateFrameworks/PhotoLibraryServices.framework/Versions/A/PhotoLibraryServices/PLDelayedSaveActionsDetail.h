...
@property (readonly, nonatomic) char shouldHandleMoments;
...
@property (nonatomic) char shouldUpdateFeaturedContent;
...
@property (nonatomic) char libraryScopeRulesUpdated;
