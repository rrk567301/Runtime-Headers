...
+ (char)compositionController:(id)a0 isCropConstraintEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isDepthIntensityEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isEffectFilterEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isEffectFilterIntensityEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isGeometryEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isPortraitEqualToCompositionController:(id)a1;
+ (char)compositionController:(id)a0 isPortraitIntensityEqualToCompositionController:(id)a1;
...
+ (char)compositionControllerHasAnyAutoEnhancement:(id)a0;
+ (id)defaultValueForAdjustmentKey:(id)a0 settingKey:(id)a1;
+ (id)identityValueForAdjustmentKey:(id)a0 settingKey:(id)a1;
+ (char)isIdentityCompositionController:(id)a0;
+ (char)isIdentityCompositionController:(id)a0 forKeys:(id)a1;
+ (char)isKeyOnlyAdjustmentForCompositionController:(id)a0 key:(id)a1;
