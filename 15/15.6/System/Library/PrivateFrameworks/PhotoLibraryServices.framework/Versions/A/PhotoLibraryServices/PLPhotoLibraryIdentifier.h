...
@property (readonly) char isImagePlaygroundDefaultLibraryIdentifier;

+ (id)photoLibraryIdentifierWithPhotoLibraryURL:(id)a0 createIfMissing:(char)a1 error:(id *)a2;
+ (id)_addWellKnownIdentifierFromIdentifierMap:(id)a0 updateLibraryURL:(id)a1;
...
+ (char)_isValidLibraryURL:(id)a0 identifierMap:(id)a1;
...
- (char)setValuesForName:(id)a0 userDescription:(id)a1 error:(id *)a2;
