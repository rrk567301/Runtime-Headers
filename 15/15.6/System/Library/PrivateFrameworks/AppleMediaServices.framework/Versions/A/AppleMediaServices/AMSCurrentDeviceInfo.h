...
@property (readonly, getter=isRunningInStoreDemoMode) char runningInStoreDemoMode;
@property (readonly) NSNumber *screenScale;
@property (readonly) NSNumber *screenHeight;
@property (readonly) NSNumber *screenWidth;
@property (readonly, getter=isSecureElementAvailable) char secureElementAvailable;
@property (readonly) NSString *serialNumber;
@property (readonly) NSString *uniqueDeviceId;
@property (readonly) char deviceIsBundle;
...
@property (readonly) char deviceIsAppleTV;
@property (readonly) char deviceIsAppleTVSimulator;
@property (readonly) char deviceIsAppleWatch;
@property (readonly) char deviceIsAppleWatchSimulator;
@property (readonly) char deviceIsAudioAccessory;
@property (readonly) char deviceIsComputeModule;
@property (readonly) char deviceIsiPad;
@property (readonly) char deviceIsiPadSimulator;
@property (readonly) char deviceIsiPhone;
@property (readonly) char deviceIsiPhoneSimulator;
@property (readonly) char deviceIsiPod;
@property (readonly) char deviceIsiPodSimulator;
@property (readonly) char deviceIsMac;
@property (readonly) char deviceIsRealityDevice;
@property (readonly) char deviceIsRealityDeviceSimulator;
