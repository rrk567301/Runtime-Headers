...
@property char ignoreRegistrationDenyList;
@property char lightweightCheckOnly;
...
- (char)_isDeviceGroupRegistrationAllowed;
- (char)_isEligibilityCallsAllowed;
- (char)_isRegistrationAllowed;
