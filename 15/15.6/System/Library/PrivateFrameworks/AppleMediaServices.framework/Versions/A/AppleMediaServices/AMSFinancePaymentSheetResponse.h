...
+ (id)_attributedStringForSalableInfoStringArray:(id)a0 account:(id)a1 shouldUppercase:(char)a2;
+ (id)_attributedStringForSalableInfoStyledStringArray:(id)a0 account:(id)a1 shouldUppercase:(char)a2;
+ (id)_attributedStringForStringArray:(id)a0 useGrey:(char)a1 account:(id)a2 shouldUppercase:(char)a3;
+ (long long)_confirmationTitleForString:(id)a0;
+ (id)_createMerchantSessionFromDictionary:(id)a0;
+ (id)_flexListDictionaryForValues:(id)a0 styles:(id)a1 account:(id)a2 shouldUppercaseText:(char)a3 designVersion:(id)a4;
...
+ (id)_salableInfoDictionaryForValues:(id)a0 styles:(id)a1 account:(id)a2 shouldUppercaseText:(char)a3 designVersion:(id)a4;
+ (id)_salableInfoForKey:(id)a0 inDictionary:(id)a1 shouldUppercase:(char)a2;
+ (id)_styleDictionaryWithName:(id)a0 styles:(id)a1;
+ (id)attributedStringWithString:(id)a0 styles:(id)a1;
+ (id)createRequestFromDictionary:(id)a0 confirmationOnly:(char)a1 delegateAuthenticationRequired:(char)a2 biometricSignatureRequired:(char)a3 authenticateResponse:(id)a4 taskInfo:(id)a5 account:(id)a6;
...
- (id)initWithResponseDictionary:(id)a0 confirmationOnly:(char)a1 delegateAuthenticationRequired:(char)a2 biometricSignatureRequired:(char)a3 taskInfo:(id)a4;
