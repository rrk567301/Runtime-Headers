...
@property char anonymizeMetrics;
...
+ (char)shouldDeleteNotificationForPayload:(id)a0 outIdentifier:(id *)a1 scheduledOnly:(char *)a2;
+ (id)_cachedImagePathForIdentifier:(id)a0 assetURL:(id)a1;
+ (char)_canParseNotificationWithIdentifier:(id)a0 userInfo:(id)a1;
...
+ (char)shouldHandleServiceExtensionNotificationRequest:(id)a0;
