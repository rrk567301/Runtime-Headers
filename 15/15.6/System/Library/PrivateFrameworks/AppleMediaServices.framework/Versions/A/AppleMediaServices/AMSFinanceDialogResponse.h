...
@property (readonly) char containsCommerceUIURL;
...
+ (char)_credentialSource:(unsigned long long)a0 satisfiesAuthenticationType:(unsigned long long)a1;
...
+ (char)_shouldSendOverIDS:(id)a0 taskInfo:(id)a1;
...
- (char)_isCommerceUIURL:(id)a0 actionType:(long long)a1 URLType:(long long)a2;
