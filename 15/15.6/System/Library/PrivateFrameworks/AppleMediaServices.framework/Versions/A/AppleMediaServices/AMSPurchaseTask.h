...
+ (char)shouldPreauthenticatePurchaseWithInfo:(id)a0;
...
- (char)_shouldAttemptCardEnrollment;
- (char)_shouldFinalizeBlindedDataWithResponseDictionary:(id)a0;
- (char)_shouldGenerateAFDSWithPurchaseInfo:(id)a0;
- (char)_shouldSendBlindedData;
