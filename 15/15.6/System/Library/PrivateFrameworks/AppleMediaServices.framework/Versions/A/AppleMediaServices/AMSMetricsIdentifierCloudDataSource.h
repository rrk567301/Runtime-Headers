...
+ (id)_sharedQueue;
+ (id)_database;
+ (id)_saveCloudObject:(id)a0 intoDatabase:(id)a1 isServerRecord:(char)a2;
+ (id)_saveIdInfo:(id)a0 intoDatabase:(id)a1 isServerRecord:(char)a2;
+ (id)_saveStoreInfo:(id)a0 intoDatabase:(id)a1 isServerRecord:(char)a2;
...
- (void)saveRecord:(id)a0 isServerRecord:(char)a1;
