...
+ (char)deleteKeyPairWithOptions:(id)a0 error:(id *)a1;
...
+ (char)_generateLegacyKeypairForOptions:(id)a0 error:(id *)a1;
...
+ (char)deleteCertificateChainWithOptions:(id)a0 error:(id *)a1;
+ (id)keychainLabelForOptions:(id)a0;
+ (id)legacyAttestationForOptions:(id)a0 error:(id *)a1;
+ (char)performForwardKeyMigrationForDSID:(id)a0 forceMigration:(char)a1;
...
+ (char)stashResumptionHeaders:(id)a0 error:(id *)a1;
+ (char)storePrimaryCert:(struct __SecCertificate { } *)a0 intermediateCert:(struct __SecCertificate { } *)a1 privateKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a2 options:(id)a3 error:(id *)a4;
