...
@property char shouldRetry;
@property (retain) AMSURLTaskInfo *taskInfo;
@property char tidContinue;
...
+ (id)_URLForCommerceUIFromURL:(id)a0 taskInfo:(id)a1 tidContinue:(char)a2;
+ (id)_bodyObjectFromRequest:(id)a0;
+ (id)_deepLinkForURL:(id)a0 taskInfo:(id)a1 gotoType:(long long)a2 isAccountURL:(char)a3 tidContinue:(char)a4;
+ (char)_isModernURL:(id)a0 taskInfo:(id)a1;
+ (id)_presentEngagementForURL:(id)a0 taskInfo:(id)a1;
+ (char)_stashTIDContinueHeadersForTaskInfo:(id)a0;
...
+ (id)handleGotoURL:(id)a0 taskInfo:(id)a1 gotoType:(long long)a2 accountURL:(char)a3 tidContinue:(char)a4 retryOnSuccess:(char)a5;
