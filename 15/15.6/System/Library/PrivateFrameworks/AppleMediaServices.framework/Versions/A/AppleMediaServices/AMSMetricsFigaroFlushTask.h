...
@property (readonly, nonatomic) char includeMMeClientInfoAndDeviceHeaders;
...
+ (char)_shouldClearEventsDespiteError:(id)a0 result:(id)a1;
...
- (id)_postBatch:(id)a0;
- (id)initWithDataSource:(id)a0 bag:(id)a1 maxRequestCount:(unsigned long long)a2 maxEventsPerBatch:(unsigned long long)a3 topic:(id)a4 includeMMeClientInfoAndDeviceHeaders:(char)a5 metricsSigningFlavour:(unsigned long long)a6;
- (id)initWithDataSource:(id)a0 bag:(id)a1 maxRequestCount:(unsigned long long)a2 maxEventsPerBatch:(unsigned long long)a3 topic:(id)a4 includeMMeClientInfoAndDeviceHeaders:(char)a5 metricsSigningFlavour:(unsigned long long)a6 maxBatchSizeOverride:(id)a7 postBatchBlock:(id /* block */)a8;
- (id)performFlush;
