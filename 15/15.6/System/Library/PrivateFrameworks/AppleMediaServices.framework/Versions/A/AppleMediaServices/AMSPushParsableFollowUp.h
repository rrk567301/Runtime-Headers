...
@property (class, readonly) char shouldSkipAccountCheck;
...
+ (char)_shouldAllowFollowUp:(id)a0 bag:(id)a1;
+ (char)_shouldClearFollowUpFromPayload:(id)a0;
+ (id)createBagForSubProfile;
+ (void)handleNotificationPayload:(id)a0 config:(id)a1 bag:(id)a2;
+ (char)isDeviceOfferNotification:(id)a0;
