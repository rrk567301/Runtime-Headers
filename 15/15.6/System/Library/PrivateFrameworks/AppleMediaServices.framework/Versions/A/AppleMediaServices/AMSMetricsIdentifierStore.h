...
@property char includeAccountMatchStatus;
@property char isActiveITunesAccountRequired;
@property double resetInterval;
@property char shouldEmitDiagnosticFields;
@property char shouldEmitPreviousUserId;
...
+ (id)_identifierStoreInfoForKeys:(id)a0 inDatabase:(id)a1 date:(id)a2 needsToSync:(char *)a3 account:(id)a4 clientInfo:(id)a5 domain:(id)a6 resetInterval:(double)a7 error:(id *)a8;
...
- (id)_identifierInfoForKey:(id)a0 storeInfo:(id)a1 period:(long long)a2 inDatabase:(id)a3 date:(id)a4 setValue:(id)a5 lastSyncDate:(id)a6 needsToSync:(char *)a7 error:(id *)a8;
...
- (char)isAccountValidForKey:(id)a0 activeItunesAccountDSID:(inout id *)a1;
