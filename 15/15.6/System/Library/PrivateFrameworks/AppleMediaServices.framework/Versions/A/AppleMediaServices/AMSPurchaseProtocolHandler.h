...
- (char)_isEquivalentURL:(id)a0 toURL:(id)a1;
- (id)_shouldRedirectWithPurchaseInfo:(id)a0 bag:(id)a1 urlAction:(id)a2 currentURL:(id)a3;
- (char)_shouldRetryForFailureAction:(id)a0 response:(id)a1 task:(id)a2 decodedObject:(id)a3 responseDictionary:(id)a4;
...
- (void)reconfigureNewRequest:(id)a0 originalTask:(id)a1 redirect:(char)a2 completionHandler:(id /* block */)a3;
