...
- (id)_initWithDataSource:(id)a0 persistence:(id)a1 persistenceQueue:(id)a2 updateHandlers:(id)a3 shouldConfigureDataSourceHandlers:(char)a4;
- (void)_loadAndPersistBag;
- (void)_persistBagDictionary:(id)a0 withIdentifier:(id)a1 partialIdentifier:(id)a2 expirationDate:(id)a3 onlyIfPreExisting:(char)a4;
...
- (id)initWithDataSource:(id)a0 persistenceDirectoryURL:(id)a1 persistenceQueue:(id)a2 changeHandlerQueue:(id)a3 shouldConfigureDataSourceHandlers:(char)a4;
- (id)initWithDataSource:(id)a0 shouldConfigureDataSourceHandlers:(char)a1;
