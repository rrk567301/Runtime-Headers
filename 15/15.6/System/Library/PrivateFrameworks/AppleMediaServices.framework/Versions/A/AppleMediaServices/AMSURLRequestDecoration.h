...
+ (id)_addGUIDParameterToRequest:(id)a0 fromPromise:(id)a1 shouldPreserveEncoding:(char)a2;
+ (char)_shouldSendGUIDForRequest:(id)a0 patterns:(id)a1 schemes:(id)a2;
+ (id)addAbsintheHeadersToRequest:(id)a0 buyParams:(id)a1 bag:(id)a2 shouldUseRemoteSigningIfAvailable:(char)a3;
...
+ (id)addGUIDParameterToRequest:(id)a0 bag:(id)a1 preservingQueryEncoding:(char)a2;
