...
@property (readonly, nonatomic) char usingAccessControlIdentifier;
...
- (id)initWithClientIdentifier:(id)a0 keychainAccessGroup:(id)a1 usingAccessControlIdentifier:(char)a2;
