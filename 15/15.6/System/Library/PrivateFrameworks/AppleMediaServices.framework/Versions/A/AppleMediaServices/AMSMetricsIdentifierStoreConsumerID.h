...
+ (id)_identifierInfoForKey:(id)a0 storeInfo:(id)a1 inDatabase:(id)a2 setValue:(id)a3 needsToSync:(char *)a4 serverProvidedAt:(id)a5 resetInterval:(double)a6 error:(id *)a7;
+ (id)_identifierStoreInfoForKeys:(id)a0 inDatabase:(id)a1 date:(id)a2 started:(id)a3 updateStarted:(char)a4 needsToSync:(char *)a5 account:(id)a6 clientInfo:(id)a7 domain:(id)a8 resetInterval:(double)a9 error:(id *)a10;
...
+ (id)_sunsetIdentifierInfoForKey:(id)a0 storeInfo:(id)a1 inDatabase:(id)a2 needsToSync:(char *)a3 resetInterval:(double)a4 consumerIDResetInterval:(double)a5 error:(id *)a6;
