...
+ (char)_isGroupedLogicSupported;
+ (char)_isRepeatedPromptsSupported;
...
+ (char)_shouldLogNewSessionWithLastLoggedTimeStamp:(id)a0 currentTime:(id)a1 sessionInterval:(long long)a2;
+ (char)_shouldPromptReviewForStoreReviewMetrics:(id)a0 currentTime:(id)a1 sessionCount:(long long)a2 promptInterval:(long long)a3;
+ (char)_shouldPromptReviewForStoreReviewMetrics:(id)a0 sessionCount:(long long)a1;
...
- (char)shouldAttemptPromptReview;
