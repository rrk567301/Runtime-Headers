...
- (id)init;
- (void).cxx_destruct;
- (char)_generateSubscriptionBagRequestWithAccountIdentifier:(id)a0 transactionType:(unsigned int)a1 machineIDData:(id)a2 returningSubscriptionBagData:(id *)a3 error:(id *)a4;
