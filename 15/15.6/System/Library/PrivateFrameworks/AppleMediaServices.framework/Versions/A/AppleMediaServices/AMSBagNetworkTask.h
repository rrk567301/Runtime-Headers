...
+ (char)_shouldReloadDataForOriginalCookies:(id)a0 newCookies:(id)a1;
...
- (char)_shouldRetryForResult:(id)a0 cookieNames:(id)a1 urlCookies:(id)a2 responseStorefront:(id)a3;
