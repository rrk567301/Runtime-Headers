...
+ (id)localizedStringPromiseForKey:(id)a0 bundle:(id)a1 table:(id)a2 bag:(id)a3;
+ (id)localizedStringPromiseForKey:(id)a0 bundle:(id)a1 table:(id)a2 languageCode:(id)a3;
