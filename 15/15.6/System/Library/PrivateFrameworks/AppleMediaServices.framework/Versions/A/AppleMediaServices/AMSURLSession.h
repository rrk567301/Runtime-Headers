...
- (char)_protocolHandler:(id)a0 canUseAlternateImplementationOfSelector:(SEL)a1;
- (id)_reconfigureNewRequest:(id)a0 originalTask:(id)a1 protocolHandler:(id)a2 redirect:(char)a3;
