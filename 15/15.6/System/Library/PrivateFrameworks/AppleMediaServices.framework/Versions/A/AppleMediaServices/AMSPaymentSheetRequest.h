...
@property char isDelegateAuthentication;
...
@property (getter=isApplePayClassic) char applePayClassic;
...
@property (readonly) char requiresDelegateAuthentication;
...
- (id)_replaceImagePlaceholderTag:(id)a0 withImageData:(id)a1 scale:(float)a2 tint:(char)a3 forAttributedString:(id)a4;
- (char)_shouldDrawGrayBorderForMaskedImageWithDesignVersion:(id)a0;
...
- (char)isDesignVersionEqual:(id)a0;
- (char)isDesignVersionEqualOrGreaterThan:(id)a0;
- (char)isDesignVersionLessThan:(id)a0;
