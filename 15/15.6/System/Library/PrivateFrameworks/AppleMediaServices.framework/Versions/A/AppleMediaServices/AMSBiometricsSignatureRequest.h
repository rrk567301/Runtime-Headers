...
@property (getter=isDualAction) char dualAction;
@property (readonly) AMSKeychainOptions *keychainOptions;
@property (readonly) NSDictionary *localAuthOptions;
@property (getter=shouldUseApplePayClassic) char useApplePayClassic;
@property (getter=shouldUseAutoEnrollment) char useAutoEnrollment;
