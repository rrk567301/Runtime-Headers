...
@property (class, readonly) char deviceSupportsAFDSValues;
@property (class, readonly) char deviceSupportsODIValues;
...
+ (char)deviceSupportsFreeODIWithBag:(id)a0 logKey:(id)a1;
