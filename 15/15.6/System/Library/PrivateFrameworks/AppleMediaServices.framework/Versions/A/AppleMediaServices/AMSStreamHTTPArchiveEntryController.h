...
+ (void)initialize;
+ (id)_createNewFileNameForCombining:(char)a0 extension:(id)a1;
...
+ (char)_shouldWriteEntryDirectlyToDiskForURLString:(id)a0;
+ (void)_streamToDiskWithEntries:(id)a0;
+ (void)_updateMaxBufferSize;
+ (char)_writeData:(id)a0 enumeratingBytesToStream:(id)a1;
+ (void)_writeEntries:(id)a0 toStream:(id)a1;
+ (char)_writeFooterToStream:(id)a0;
+ (char)_writeHeaderToStream:(id)a0;
