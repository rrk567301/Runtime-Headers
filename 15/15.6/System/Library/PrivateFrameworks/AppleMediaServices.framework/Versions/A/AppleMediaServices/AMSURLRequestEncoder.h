...
@property char alwaysIncludeAuthKitHeaders;
@property (nonatomic) char alwaysIncludeMMeClientInfoAndDeviceHeaders;
@property char excludeIdentifierHeadersForAccount;
@property (nonatomic) char preserveQueryParameterEncoding;
@property (nonatomic) char shouldSetStorefrontHeader;
@property (nonatomic) char shouldSetCookieHeader;
