...
+ (char)didExceededSyncDuration:(double)a0 lastTimestamp:(double)a1 currentTimestamp:(double)a2;
+ (double)durationOfSyncRestrictedRegionValueFromBag:(id)a0;
+ (char)hasCachedRestrictedRegionsValueFromAccount:(id)a0 cachedTimestamp:(double *)a1;
+ (char)storefrontContainsRestrictedRegionsValueFromBag:(id)a0;
