...
@property (nonatomic) char isOpening;
...
- (void)presentEditorWindowForWindow:(id)a0 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 edge:(unsigned long long)a2 useScaling:(char)a3;
