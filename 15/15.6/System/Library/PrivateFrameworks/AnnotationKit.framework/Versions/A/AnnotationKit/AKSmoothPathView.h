...
@property char applyModelBaseScaleFactorToStroke;
@property (nonatomic) char startedTouchDrawing;
...
- (char)_catchUpAccumulatedTouchesForRecognizer:(id)a0;
...
- (void)_setupFilterChainWithBitmapFifo:(char)a0;
