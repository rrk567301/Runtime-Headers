...
- (void)addIntersectionsWithPath:(id)a0 to:(id)a1 allIntersections:(char)a2 reversed:(char)a3;
- (void)appendBezierPath:(id)a0 fromSegment:(long long)a1 t:(double)a2 toSegment:(long long)a3 t:(double)a4 withoutMove:(char)a5;
