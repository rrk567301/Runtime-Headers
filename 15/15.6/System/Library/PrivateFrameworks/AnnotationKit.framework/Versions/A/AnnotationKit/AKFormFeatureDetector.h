...
- (id)_defaultFeatureForPoint:(struct CGPoint { double x0; double x1; })a0 onPage:(id)a1 snapToVerticalEdges:(char)a2;
...
- (unsigned long long)_findLineEdgeTypeOnLeft:(char)a0 startingAt:(float *)a1 withPageLeftEdge:(float *)a2 withPageWidth:(long long)a3 andFormHeight:(unsigned long long)a4;
- (struct { char x0; double x1; char x2; double x3; })_findVerticalEdgesAtPoint:(struct CGPoint { double x0; double x1; })a0 extent:(long long)a1 onPage:(id)a2;
- (char)_floatPixelBufferForCGContext:(struct CGContext { } *)a0 imageBuffer:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a1;
- (id)_formFieldAtPoint:(struct CGPoint { double x0; double x1; })a0 onPage:(id)a1 enforceMaxWidth:(char)a2 pageBitmap:(struct CGContext { } *)a3;
- (id)_lineAtPoint:(struct CGPoint { double x0; double x1; })a0 onPage:(id)a1 useVerticalCenter:(char)a2;
