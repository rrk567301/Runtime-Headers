...
+ (struct CGPoint { double x0; double x1; })intersectRayStartingAt:(struct CGPoint { double x0; double x1; })a0 ending:(struct CGPoint { double x0; double x1; })a1 withEllipseOfRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 farthestResult:(char)a3;
+ (struct CGPoint { double x0; double x1; })_alignedPointForPoint:(struct CGPoint { double x0; double x1; })a0 alignToContent:(char)a1 alignToScreenUsingPageController:(id)a2 orAlignToBitmapContext:(struct CGContext { } *)a3 usingAnnotation:(id)a4;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_alignedStableRectForRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 alignToContent:(char)a1 alignToScreenUsingPageController:(id)a2 orAlignToBitmapContext:(struct CGContext { } *)a3 usingAnnotation:(id)a4;
...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_rectForRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 alignToContent:(char)a1 alignToScreenUsingPageController:(id)a2 orAlignToBitmapContext:(struct CGContext { } *)a3 usingAnnotation:(id)a4 withAlignmentBlock:(id /* block */)a5;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_strokeAlignedRectForRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withStrokeWidth:(double)a1 shouldAlignStrictlyToScreen:(char)a2 alignToScreenUsingPageController:(id)a3 orAlignToBitmapContext:(struct CGContext { } *)a4 usingAnnotation:(id)a5;
...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })convertRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 fromViewToScreenPixels:(id)a1 useNativeScale:(char)a2;
...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })effectiveDrawingBoundsForAnnotation:(id)a0 forDisplay:(char)a1 pageControllerOrNil:(id)a2 outScaleFactor:(double *)a3;
...
+ (char)exifOrientationHasFlip:(long long)a0;
...
+ (struct CGPoint { double x0; double x1; })intersectLineSegmentStartingAt:(struct CGPoint { double x0; double x1; })a0 ending:(struct CGPoint { double x0; double x1; })a1 withCircleWithCenter:(struct CGPoint { double x0; double x1; })a2 andRadius:(double)a3 farthestResult:(char)a4;
+ (struct CGPoint { double x0; double x1; })intersectLineSegmentStartingAt:(struct CGPoint { double x0; double x1; })a0 ending:(struct CGPoint { double x0; double x1; })a1 withEllipseOfRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 farthestResult:(char)a3;
...
+ (struct CGPoint { double x0; double x1; })intersectRayStartingAt:(struct CGPoint { double x0; double x1; })a0 ending:(struct CGPoint { double x0; double x1; })a1 withCircleWithCenter:(struct CGPoint { double x0; double x1; })a2 andRadius:(double)a3 farthestResult:(char)a4;
+ (long long)inverseExifOrientation:(long long)a0;
+ (char)isPoint:(struct CGPoint { double x0; double x1; })a0 onEllipse:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
+ (char)isPointOnLeft:(struct CGPoint { double x0; double x1; })a0 ofRayWithFirstPoint:(struct CGPoint { double x0; double x1; })a1 andSecondPoint:(struct CGPoint { double x0; double x1; })a2;
+ (char)isUnpresentablePoint:(struct CGPoint { double x0; double x1; })a0;
+ (char)isUnpresentableRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
+ (char)isUnpresentableSize:(struct CGSize { double x0; double x1; })a0;
...
+ (char)rectHasZeroSize:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
+ (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })rotationTransformForRectangularAnnotation:(id)a0 hasRotation:(char *)a1;
+ (double)scaleOfTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0;
+ (struct CGPoint { double x0; double x1; })snapVector:(struct CGPoint { double x0; double x1; })a0 toDiagonalForAspectRatio:(double)a1 ignoreWidth:(char)a2 ignoreHeight:(char)a3;
...
+ (id)verticesOfPolygonWithPointCount:(unsigned long long)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 rotation:(double)a2 flippedVertically:(char)a3;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })annotationLayerFrameForAnnotation:(id)a0 layerIsClipped:(char *)a1;
