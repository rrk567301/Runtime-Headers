...
+ (char)_point:(struct CGPoint { double x0; double x1; })a0 isInCircleWithRadius:(double)a1 atPoint:(struct CGPoint { double x0; double x1; })a2;
+ (char)_point:(struct CGPoint { double x0; double x1; })a0 isInRectWithSize:(double)a1 atPoint:(struct CGPoint { double x0; double x1; })a2;
