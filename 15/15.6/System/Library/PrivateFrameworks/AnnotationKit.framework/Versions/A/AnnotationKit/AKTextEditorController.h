...
@interface AKTextEditorController : NSObject <NSTextStorageDelegate, NSTextViewDelegate> {
    char _wantsTextViewBecomeFirstResponder;
}
...
@property char isInEndEditing;
@property char isInAdjustAnnotationFrameToFitText;
...
- (void)_beginEditingAnnotation:(id)a0 withPageController:(id)a1 selectAllText:(char)a2 withPencil:(char)a3;
- (void)_commitToModelWithoutEndingEditing;
- (char)_doHandleBackTab;
- (char)_doHandleTab;
...
- (void)beginEditingAnnotation:(id)a0 withPageController:(id)a1 selectAllText:(char)a2;
- (void)beginEditingAnnotation:(id)a0 withPageController:(id)a1 selectAllText:(char)a2 withPencil:(char)a3;
