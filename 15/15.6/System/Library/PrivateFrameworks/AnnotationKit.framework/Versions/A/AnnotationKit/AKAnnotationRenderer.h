...
+ (char)_concretePointIsOnBorder:(struct CGPoint { double x0; double x1; })a0 ofAnnotation:(id)a1 minimumBorderThickness:(double)a2;
+ (char)_concretePointIsOnInside:(struct CGPoint { double x0; double x1; })a0 ofAnnotation:(id)a1;
...
+ (void)_concreteRenderAnnotation:(id)a0 intoContext:(struct CGContext { } *)a1 forDisplay:(char)a2 pageControllerOrNil:(id)a3;
...
+ (void)_testRenderAnnotation:(id)a0 intoContext:(struct CGContext { } *)a1 forDisplay:(char)a2 pageControllerOrNil:(id)a3;
+ (void)_transformContextToModelCoordinates:(struct CGContext { } *)a0 forAnnotation:(id)a1 forDisplay:(char)a2 pageControllerOrNil:(id)a3;
+ (char)annotationShouldAvoidRedrawDuringLiveResize:(id)a0;
...
+ (char)pointIsOnBorder:(struct CGPoint { double x0; double x1; })a0 ofAnnotation:(id)a1 minimumBorderThickness:(double)a2;
+ (char)pointIsOnInside:(struct CGPoint { double x0; double x1; })a0 ofAnnotation:(id)a1;
...
+ (void)renderAnnotation:(id)a0 intoContext:(struct CGContext { } *)a1 forDisplay:(char)a2 pageControllerOrNil:(id)a3;
