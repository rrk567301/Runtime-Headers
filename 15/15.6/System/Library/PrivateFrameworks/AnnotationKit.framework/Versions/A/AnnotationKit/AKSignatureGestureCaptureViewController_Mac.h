...
@property char isCursorHidden;
@property char isInTrackpadInputMode;
...
- (void)_setCursorAssociated:(char)a0;
- (void)_setSignatureAreaShowsRecordingIndicator:(char)a0;
- (void)_setViewMode:(unsigned long long)a0;
- (void)_setupForTrackpadInput;
- (void)descriptionViewController:(id)a0 willHide:(char)a1;
