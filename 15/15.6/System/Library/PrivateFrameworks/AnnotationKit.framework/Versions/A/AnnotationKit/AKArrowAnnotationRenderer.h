...
+ (struct CGPath { } *)_newLinePathForArrow:(id)a0 withHeads:(char)a1 fromBezierParameter:(double)a2 toBezierParameter:(double)a3 optionalPageController:(id)a4 optionalContext:(struct CGContext { } *)a5;
