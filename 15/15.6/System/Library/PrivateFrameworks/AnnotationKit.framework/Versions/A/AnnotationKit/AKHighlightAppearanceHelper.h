...
+ (char)highlightColor:(id)a0 isEquivalentToHighlightColor:(id)a1;
+ (id)menuImageForHighlightAttributeWithTag:(long long)a0 withAdornment:(id)a1;
+ (id)titleForHighlightAttributeOrToolWithTag:(long long)a0;
