...
@property char isObservingModel;
@property double currentScaleFactor;
@property (nonatomic) char shouldPixelate;
@property (nonatomic) char adornmentsHidden;
...
- (void)_applyUpdatesWithScale:(double)a0 toLayers:(id)a1 isLiveUpdate:(char)a2 forceUpdate:(char)a3;
...
- (void)updateScaleFactor:(double)a0 isLiveUpdate:(char)a1 forceUpdate:(char)a2;
