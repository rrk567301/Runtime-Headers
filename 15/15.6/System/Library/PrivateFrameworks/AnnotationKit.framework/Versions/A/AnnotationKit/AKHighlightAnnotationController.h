...
- (char)_adaptExistingHighlightsToNewHighlight:(id)a0 onPageController:(id)a1 firstModifiedHighlight:(id *)a2;
- (char)_clearHighlightsWithStyleMatchingMask:(unsigned long long)a0 except:(id)a1 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 onPageController:(id)a3;
