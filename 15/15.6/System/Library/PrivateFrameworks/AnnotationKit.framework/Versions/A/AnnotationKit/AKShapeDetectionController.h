...
@property (readonly, nonatomic) char isShowingCandidatePicker;
...
@property char isPreviousCandidateAnnotationUndecided;
...
+ (char)drawingIsValidForRecognition:(id)a0 withPath:(struct CGPath { } *)a1;
...
- (id)_createDoodleShapeResultWithPath:(struct CGPath { } *)a0 withDrawingCenter:(struct CGPoint { double x0; double x1; })a1 pathIsPrestroked:(char)a2;
...
- (char)_isResultVeryHighConfidence:(id)a0;
- (void)_performRecognitionOnDrawing:(id)a0 withInkDrawing:(id)a1 orWithDoodlePath:(struct CGPath { } *)a2 boundsInInputView:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 center:(struct CGPoint { double x0; double x1; })a4 isPrestroked:(char)a5 optionalAnnotation:(id)a6;
- (void)_shouldDismissNotification:(id)a0;
- (void)_showCandidatePickerWithTypes:(id)a0 forDrawingInInputView:(id)a1 shouldSurfaceDoodle:(char)a2;
...
- (void)performRecognitionOnDrawing:(id)a0 withPath:(struct CGPath { } *)a1 boundsInInputView:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 center:(struct CGPoint { double x0; double x1; })a3 isPrestroked:(char)a4;
