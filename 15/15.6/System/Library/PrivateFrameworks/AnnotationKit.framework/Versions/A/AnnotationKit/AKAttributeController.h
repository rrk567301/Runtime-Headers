...
- (void)_allAnnotations:(id)a0 all:(char *)a1 atLeastOneShare:(char *)a2 attributeFromTag:(long long)a3;
- (long long)_allAnnotations:(id)a0 shareAttributeFromTag:(long long)a1;
- (char)_isEnabledForSender:(id)a0 segment:(long long)a1 withSelectedAnnotations:(id)a2;
...
- (char)_updateStateOnSender:(id)a0 segment:(long long)a1 fromSelectedAnnotations:(id)a2;
- (void)_updateStateOnSenderFromSelf:(id)a0 segment:(long long)a1;
- (void)annotationEditingDidEndWithCompletion:(id /* block */)a0;
- (void)forceHideRuler;
- (void)forceShowRuler;
- (char)isAttributeSenderEnabled:(id)a0 segment:(long long)a1;
...
- (void)setDefaultInk;
- (char)strokeColorIsEqualTo:(id)a0;
- (void)syncFillColorOnSelectionToUI;
- (void)syncStrokeColorOnSelectionToUI;
- (void)toggleRuler;
- (void)updateAttributeSenderState:(id)a0 segment:(long long)a1 enabled:(char)a2;
