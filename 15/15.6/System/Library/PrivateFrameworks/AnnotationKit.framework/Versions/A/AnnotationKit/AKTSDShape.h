...
- (double)lineEndScale;
- (void)p_computeAngle:(double *)a0 point:(struct CGPoint { double x0; double x1; } *)a1 cutSegment:(long long *)a2 cutT:(double *)a3 forLineEndAtHead:(char)a4;
- (void)p_drawLineEndForHead:(char)a0 withDelta:(struct CGPoint { double x0; double x1; })a1 inContext:(struct CGContext { } *)a2 useFastDrawing:(char)a3;
