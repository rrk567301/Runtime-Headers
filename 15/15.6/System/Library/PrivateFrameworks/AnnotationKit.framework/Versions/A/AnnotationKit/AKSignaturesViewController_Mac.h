...
- (void)viewDidLoad;
- (id)signatures;
- (void)_animate:(char)a0 toContentView:(id)a1 startingSize:(struct CGSize { double x0; double x1; })a2 destinationSize:(struct CGSize { double x0; double x1; })a3;
...
- (void)captureController:(id)a0 willHide:(char)a1;
...
- (void)switchToViewMode:(long long)a0 animated:(char)a1;
