...
- (void)addVisitWithURLString:(id)a0 visitTime:(double)a1 title:(id)a2 loadSuccessful:(char)a3 httpGet:(char)a4 redirectSourceURLString:(id)a5 redirectSourceVisitTime:(double)a6 visitCount:(unsigned long long)a7;
