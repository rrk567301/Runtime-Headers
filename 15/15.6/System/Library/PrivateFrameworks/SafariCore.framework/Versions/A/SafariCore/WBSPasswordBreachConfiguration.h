...
@property (readonly, nonatomic) char shouldRefillBagWhenEmpty;
@property (readonly, nonatomic) char verboseSensitiveLoggingEnabled;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (id)initWithDictionary:(id)a0;
- (id)initWithDictionary:(id)a0 protocolClasses:(id)a1 allowValuesForTesting:(char)a2;
