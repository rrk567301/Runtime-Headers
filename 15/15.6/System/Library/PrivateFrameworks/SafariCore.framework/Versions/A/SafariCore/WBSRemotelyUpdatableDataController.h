...
@property (nonatomic) char shouldAttemptToUpdateConfiguration;
@property (nonatomic) char shouldAttemptToDownloadConfiguration;
@property (nonatomic) char dataIsUsedByMultipleProcesses;
@property (nonatomic) char shouldKeepBuiltInSnapshotLoaded;
