...
@property (readonly, nonatomic) char wasGeneratedInPrivateBrowsingSession;
...
- (id)initWithPassword:(id)a0 protectionSpace:(id)a1 generationDate:(id)a2 wasGeneratedInPrivateBrowsingSession:(char)a3;
- (id)keychainDictionaryRepresentationWithPassword:(id)a0;
