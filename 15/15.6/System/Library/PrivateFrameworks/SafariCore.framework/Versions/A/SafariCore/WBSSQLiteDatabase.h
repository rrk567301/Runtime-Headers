...
- (id)checkIntegrity;
- (char)enableWAL:(id *)a0;
- (id)initWithURL:(id)a0 queue:(id)a1;
- (char)openWithAccessType:(long long)a0 error:(id *)a1;
- (char)openWithAccessType:(long long)a0 protectionType:(long long)a1 vfs:(id)a2 error:(id *)a3;
- (char)openWithAccessType:(long long)a0 vfs:(id)a1 error:(id *)a2;
- (char)reportErrorWithCode:(int)a0 query:(id)a1 error:(id *)a2;
- (char)reportErrorWithCode:(int)a0 statement:(struct sqlite3_stmt { } *)a1 error:(id *)a2;
- (void)setBusyTimeout:(double)a0;
- (char)tryToPerformTransactionInBlock:(id /* block */)a0;
...
- (char)_openWithFlags:(int)a0 useLock:(char)a1 vfs:(id)a2 error:(id *)a3;
