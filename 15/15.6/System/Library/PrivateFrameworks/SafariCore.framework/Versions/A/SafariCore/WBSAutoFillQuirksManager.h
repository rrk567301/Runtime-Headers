...
@property (nonatomic) char shouldAttemptToDownloadConfiguration;
...
- (char)isAutomaticLoginDisallowedOnURL:(id)a0;
- (char)isDomainKnownToAskForCredentialsForOtherServicesWhenEmbeddedAsThirdParty:(id)a0;
...
- (char)_isURL:(id)a0 containedInQuirks:(id /* block */)a1;
...
- (char)isDomainKnownToDoSameDocumentNavigationInTextEditingCallback:(id)a0;
- (char)isStreamlinedLoginDisallowedOnURL:(id)a0;
