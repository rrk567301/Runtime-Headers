...
@property (readonly, nonatomic) char queryShouldOmitAutoFillPasskeyMatches;
@property (readonly, nonatomic) char queryShouldReturnSavedAccountsMatchingHighLevelAndSimplifiedDomains;
@property (readonly, nonatomic) char queryShouldReturnSavedAccountsMatchingAssociatedDomains;
@property (readonly, nonatomic) char queryShouldReturnSavedAccountsWithEmptyUsernames;
@property (readonly, nonatomic) char queryShouldIncludePasskeyMatchesForNonAutoFillContext;
@property (readonly, nonatomic) char queryShouldIncludeSavedAccountsWithDoNotSaveMarkers;
@property (readonly, nonatomic) char queryShouldOnlyIncludePasswordsWithoutWebsites;
...
- (id)urlWithoutWWWSubdomainFromURL:(id)a0;
