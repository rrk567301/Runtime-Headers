...
@property (readonly, nonatomic) char hasLoadedGroups;
...
- (void)_performTaskEnsuringGroupsAreLoadedOnQueue:(id)a0 shouldForceUpdate:(char)a1 task:(id /* block */)a2;
- (void)_updateCachedPermissionLevelsForCurrentUser;
- (id)cachedGroupWithID:(id)a0;
- (char)canCurrentUserEditSavedAccountsInGroupWithID:(id)a0;
