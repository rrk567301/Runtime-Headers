...
- (char)_isArchiveFileURL:(id)a0;
- (void)_processFileForURL:(id)a0 isInUnarchivedFolder:(char)a1 completionHandler:(id /* block */)a2;
- (void)_scanImportedURL:(id)a0 isInUnarchivedFolder:(char)a1;
