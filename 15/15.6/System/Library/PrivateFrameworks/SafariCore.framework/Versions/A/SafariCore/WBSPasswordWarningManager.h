...
@interface WBSPasswordWarningManager : NSObject <WBSRemotelyUpdatableDataControllerDelegate> {
    ...
    char _shouldInitializePasswordEvaluationCache;
...
@property (readonly, nonatomic) char hasUnacknowledgedHighPriorityWarnings;
...
- (void)_getBreachResultRecordsForPasswords:(id)a0 startSessionIfNecessary:(char)a1 withCompletionHandler:(id /* block */)a2;
- (char)_historyContainsItemForDomain:(id)a0;
- (unsigned long long)_issuesForPassword:(id)a0 withWeakPasswordEvaluation:(id)a1 passwordIsReused:(char)a2 breachResultRecord:(id)a3 websiteMetadataEntry:(id)a4;
...
- (void)getAllWarningsForcingUpdate:(char)a0 completionHandler:(id /* block */)a1;
...
- (char)savedAccountsFromGroup:(id)a0 containsPasswordFromSavedAccount:(id)a1;
