...
+ (char)passwordLooksLikePasswordManagerGeneratedMoreTypablePassword:(id)a0;
+ (char)passwordLooksLikePasswordManagerGeneratedPassword:(id)a0;
...
- (id)_generated15CharacterAlphanumericPasswordRejectingUnwantedWords:(char)a0;
- (id)_generatedPasswordMatchingRequirements:(id)a0 rejectUnwantedWords:(char)a1;
- (void)_lexiconEnumerateEntries:(struct _LXLexicon { } *)a0 forString:(id)a1 completionHandler:(id /* block */)a2;
- (id)_moreTypeablePassword;
- (char)_tokensContainUnwantedWords:(id)a0;
...
- (char)manualPasswordGenerationIsDisallowedByRequirements:(id)a0;
- (char)passwordGenerationIsDisallowedByRequirements:(id)a0;
