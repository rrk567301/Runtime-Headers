...
@property (readonly, nonatomic, getter=isLockedOrAboutToLock) char lockedOrAboutToLock;
@property (readonly, nonatomic, getter=isKeyBagEnabled) char keyBagEnabled;
