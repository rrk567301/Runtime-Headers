...
- (void)clearLocalDataIncludingMigrationState:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)scheduleCloudBackgroundImageSaveWithURL:(id)a0 isLightAppearance:(char)a1 successCompletionHandler:(id /* block */)a2;
...
- (void)dumpCloudKitDataPrintByDates:(char)a0 liveOnly:(char)a1 printTree:(char)a2 printPlist:(char)a3 writeToFile:(char)a4 atFileURL:(id)a5 completionHandler:(id /* block */)a6;
