...
+ (char)isValidDisclosureName:(id)a0;
...
- (char)isValidName:(id)a0;
- (char)resetDomain:(id)a0 error:(id *)a1;
...
- (char)addProfilePayload:(id)a0 error:(id *)a1;
...
- (char)commitProfilePayloadsAndReturnError:(id *)a0;
...
- (void)disableFeature:(id)a0 domain:(id)a1 level:(long long)a2 transient:(char)a3;
- (void)disableFeature:(id)a0 domain:(id)a1 levelIndex:(unsigned long long)a2;
- (void)disableFeature:(id)a0 domain:(id)a1 levelIndex:(unsigned long long)a2 transient:(char)a3;
...
- (void)enableFeature:(id)a0 domain:(id)a1 level:(long long)a2 transient:(char)a3;
- (void)enableFeature:(id)a0 domain:(id)a1 levelIndex:(unsigned long long)a2;
- (void)enableFeature:(id)a0 domain:(id)a1 levelIndex:(unsigned long long)a2 transient:(char)a3;
...
- (char)isFeatureHidden:(id)a0 domain:(id)a1;
- (char)isSafeMode;
- (char)isValidDisclosureName:(id)a0;
- (void)loadAllData;
...
- (char)writeCombinedUpdates:(id *)a0;
- (char)writeCombinedUpdatesAtLevelIndex:(unsigned long long)a0 error:(id *)a1;
- (char)writeDisclosureUpdates:(id *)a0;
- (char)writeDisclosureUpdatesAtlevelIndex:(unsigned long long)a0 error:(id *)a1;
- (char)writeDomainUpdates:(id *)a0;
- (char)writeFeatureSetUpdates:(id *)a0;
- (char)writeFeatureSetUpdatesAtLevelIndex:(unsigned long long)a0 withError:(id *)a1;
- (char)writeSubscriptionUpdates:(id *)a0;
- (char)writeSubscriptionUpdatesAtLevelIndex:(unsigned long long)a0 withError:(id *)a1;
