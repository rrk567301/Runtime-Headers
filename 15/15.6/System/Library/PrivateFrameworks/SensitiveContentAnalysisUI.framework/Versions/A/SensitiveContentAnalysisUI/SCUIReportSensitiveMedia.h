...
@property (readonly) char wasImpetusOfReport;

- (unsigned long long)hash;
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithURL:(id)a0 UTIType:(id)a1 identifier:(id)a2 dateReceived:(id)a3 isSensitive:(id)a4 wasImpetusOfReport:(char)a5;
