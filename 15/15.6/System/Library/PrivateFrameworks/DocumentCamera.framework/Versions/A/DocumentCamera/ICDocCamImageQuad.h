...
@property (readonly, nonatomic) char isConvex;
@property (readonly, nonatomic) char containsIntersectingLines;
@property (readonly, nonatomic) char containsPointsLessThanDistanceThreshold;
@property (readonly, nonatomic) char containsPointOutsideOfExtendedImageBounds;
@property (readonly, nonatomic) char containsAngleOutOfValidThreshold;
