...
+ (id)colorDocument:(id)a0 orientation:(long long)a1 constantColor:(char)a2;
...
+ (id)filteredImage:(id)a0 imageFilterType:(short)a1 constantColor:(char)a2;
+ (id)filteredImage:(id)a0 orientation:(long long)a1 imageFilterType:(short)a2;
+ (id)filteredImage:(id)a0 orientation:(long long)a1 imageFilterType:(short)a2 constantColor:(char)a3;
