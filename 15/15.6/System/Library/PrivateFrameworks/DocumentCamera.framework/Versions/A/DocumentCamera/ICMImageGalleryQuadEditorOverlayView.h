...
@property (readonly, nonatomic) char isDraggingKnob;
@property (readonly, nonatomic) char isQuadValid;
...
- (void)updateOutlineAndKnobColorForIsValid:(char)a0;
