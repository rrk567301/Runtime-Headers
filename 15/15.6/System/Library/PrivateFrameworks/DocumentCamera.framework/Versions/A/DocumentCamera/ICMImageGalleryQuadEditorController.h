...
@property (nonatomic) char didAdjustQuad;
@property (nonatomic) char stickyZoomToFit;
...
@property (readonly, nonatomic) char canScaleUp;
@property (readonly, nonatomic) char canScaleDown;
@property (readonly, nonatomic) char canScaleToActualSize;
...
- (id)displayedQuad;
- (char)hitTestIsValidForOverlay:(struct CGPoint { double x0; double x1; })a0;
...
- (void)resizeToAspectFitIfNecessaryAnimated:(char)a0;
...
- (void)setStickyZoomToFit:(char)a0 animated:(char)a1;
- (id)uiRect;
