...
+ (id)createInfoService:(id)a0 model:(id)a1 manufacturer:(id)a2 serialNumber:(id)a3 instanceID:(unsigned long long)a4 endpointID:(id)a5 nodeID:(id)a6 legacyInstanceIDAssignment:(char)a7;
