...
+ (char)isCredentialTypeAliro:(id)a0;
...
- (void)getUserWithParams:(id)a0 includeAliroCredentials:(char)a1 temporaryCachedAliroCredentials:(id)a2 flow:(id)a3 completion:(id /* block */)a4;
