...
@property (nonatomic, getter=isCurrentDevicePrimaryResident) char currentDevicePrimaryResident;
...
- (void)handleUpdateNotificationsEnabled:(char)a0 forFabric:(id)a1 keepAliveOnly:(char)a2;
