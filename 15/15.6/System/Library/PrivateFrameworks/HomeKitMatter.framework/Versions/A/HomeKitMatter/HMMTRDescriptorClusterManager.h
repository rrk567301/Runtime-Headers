...
- (void)fetchHAPServicesAtCHIPEndpoint:(id)a0 deviceTopology:(id)a1 endpointDeviceTypes:(id)a2 accessoryInfo:(id)a3 hapToCHIPClusterMappingArray:(id)a4 device:(id)a5 isBridge:(char)a6 bridgeAggregateNodeEndpoint:(id)a7 isComposedDevice:(char)a8 server:(id)a9 callbackQueue:(id)a10 completionHandler:(id /* block */)a11;
- (void)fetchHAPServicesForEndpoints:(id)a0 endpointDeviceTypes:(id)a1 device:(id)a2 nodeId:(id)a3 isBridge:(char)a4 bridgeAggregateNodeEndpoint:(id)a5 server:(id)a6 topology:(id)a7 hapAccessoryInfo:(id)a8 callbackQueue:(id)a9 completionHandler:(id /* block */)a10;
