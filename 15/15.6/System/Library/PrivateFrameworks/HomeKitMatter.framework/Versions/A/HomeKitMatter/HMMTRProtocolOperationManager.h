...
- (char)_isBasicClusterOperationForBridgedDevice:(Class)a0 endpointID:(unsigned long long)a1;
...
- (char)handleSpecialCaseCharacteristicWithOperation:(id)a0 accessoryServer:(id)a1 clientQueue:(id)a2 operationResponseHandler:(id /* block */)a3 updatedAttributesHandler:(id /* block */)a4;
