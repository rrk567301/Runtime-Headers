...
@property (nonatomic) char generatingKeyPair;
...
@property (readonly, nonatomic) char shouldSkipAttestationCertificateValidation;
...
- (void)_buildV1KeyFromV0KeyAllowingNew:(char)a0;
- (void)_buildV1KeyWithPrivateKey:(struct __SecKey { } *)a0 operationalKey:(struct __SecKey { } *)a1 ipk:(id)a2 rootCert:(id)a3 operationalCert:(id)a4 updatingMTSKeyValueStore:(char)a5;
- (void)_buildV1KeyWithV0KeyPair:(id)a0;
- (char)_checkAndUpdateValidityPeriodOfV1Keypair:(id)a0 newKeyPair:(id *)a1;
- (char)_findFabricRecordInMTSKeyValueStoreMatchingKeyPair:(id)a0 ipk:(id *)a1 rootCert:(id *)a2 operationalKey:(id *)a3 operationalCert:(id *)a4;
...
- (char)fetchControllerParamsAllowingNew:(char)a0 nocSigner:(id *)a1 controllerWrapper:(id *)a2;
...
- (char)v1KeypairIsEquivalentTo:(id)a0;
