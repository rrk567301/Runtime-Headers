...
+ (char)supportedLinkLayerTypesContainsEthernet:(id)a0;
+ (char)supportedLinkLayerTypesContainsThread:(id)a0;
+ (char)supportedLinkLayerTypesContainsWiFi:(id)a0;
