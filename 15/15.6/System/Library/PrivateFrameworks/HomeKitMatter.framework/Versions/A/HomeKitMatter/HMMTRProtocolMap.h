...
+ (char)checkIfCharacteristicsIsOfTypeTemp:(id)a0;
...
- (id /* block */)_buildValueMapper:(id)a0 characteristicsDict:(id)a1 operation:(unsigned long long)a2 forMTRCluster:(char)a3;
- (id)_characteristicDescriptionForCharacteristicWithUUID:(id)a0 characteristicsDict:(id)a1 chipClusterName:(id)a2 operationType:(unsigned long long)a3 value:(id)a4 forMTRCluster:(char)a5;
...
- (id)_chipClusterFunctionNameForOperationType:(unsigned long long)a0 operationDictionary:(id)a1 value:(id)a2 forMTRCluster:(char)a3;
- (id)_chipParamsDictionaryForOperationType:(unsigned long long)a0 operationDictionary:(id)a1 value:(id)a2;
- (id)_descriptionForCharacteristicUUID:(id)a0 operation:(unsigned long long)a1 value:(id)a2 forMTRCluster:(char)a3 endpointID:(unsigned long long)a4 clusterIDCharacteristicMap:(id)a5;
- (char)_isValidCharacteristicValue:(id)a0 value:(id)a1;
...
- (char)isRequiresOptionalMatterAttributeForCharacteristic:(id)a0;
...
- (char)optionalServiceLabelIndexIncludedInService:(id)a0;
