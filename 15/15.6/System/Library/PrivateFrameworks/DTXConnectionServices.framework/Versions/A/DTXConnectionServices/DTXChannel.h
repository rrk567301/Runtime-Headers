...
@interface DTXChannel : NSObject <DTXMessenger> {
    ...
    struct { NSObject<OS_dispatch_queue> *userDispatchQueue; id<DTXAllowedRPC> dispatchTarget; id /* block */ messageHandler; id /* block */ dispatchValidator; } _channelGuarded;
}
...
- (char)sendMessageAsync:(id)a0 replyHandler:(id /* block */)a1;
