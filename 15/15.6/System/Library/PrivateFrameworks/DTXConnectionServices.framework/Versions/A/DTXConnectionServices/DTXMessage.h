...
@property (readonly, nonatomic) char deserialized;
@property (readonly, nonatomic) char isDispatch;
@property (readonly, nonatomic) char isBarrier;
@property (readonly, nonatomic) unsigned long long cost;
@property (retain, nonatomic) NSError *error;
@property (nonatomic) unsigned int errorStatus;
@property (nonatomic) char expectsReply;
...
- (void)_appendTypesAndValues:(unsigned int)a0 withKey:(id)a1 list:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
...
- (void)_setPayloadBuffer:(const char *)a0 length:(unsigned long long)a1 shouldCopy:(char)a2 destructor:(id /* block */)a3;
...
- (id)initWithSelector:(SEL)a0 firstArg:(id)a1 remainingObjectArgs:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
...
- (char)shouldInvokeWithTarget:(id)a0;
