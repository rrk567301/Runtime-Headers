...
+ (char)_isMessageWithinDateRange:(id)a0;
+ (char)applicationContext:(id)a0 allowsPresentationForPolicyGroup:(long long)a1 withLastDisplayTime:(id)a2;
...
- (char)_didCacheResourcesForMessageIfRequired:(id)a0;
- (char)_doesPresentationPolicyAllowPresentationOfMessage:(id)a0;
- (char)_evaluateCompoundRule:(id)a0 forMessageEntry:(id)a1;
- (char)_evaluateCondition:(id)a0 forMessageEntry:(id)a1;
- (char)_evaluateRule:(id)a0 forMessageEntry:(id)a1;
