...
- (char)enableAllPaths:(id *)a0;
- (char)disableAllPaths:(id *)a0;
- (char)disablePath:(id)a0 error:(id *)a1;
- (char)enablePath:(id)a0 error:(id *)a1;
...
- (char)isPathEnabled:(id)a0 error:(id *)a1;
- (void)rebuildPropertiesFromEntry;
- (char)setAlgorithm:(unsigned int)a0 error:(id *)a1;
- (char)setBatchCount:(unsigned int)a0 error:(id *)a1;
