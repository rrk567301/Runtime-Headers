...
- (char)isCollaborationLocallyInitiatedForConversation:(id)a0;
- (void)notifyDelegateOfHighlightChanged:(id)a0 onConversation:(id)a1;
- (void)participant:(id)a0 addedHighlightToConversation:(id)a1 highlightIdentifier:(id)a2 oldHighlightIdentifier:(id)a3 isFirstAdd:(char)a4;
