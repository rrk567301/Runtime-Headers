...
@property (nonatomic) char hasReceivedInitialState;
@property (nonatomic) char shouldHandleServerDisconnect;
...
@property (readonly, nonatomic, getter=isServerLocal) char serverLocal;
@property (nonatomic) char hasServerLaunched;
...
- (id)initWithQueue:(id)a0 callCenter:(id)a1 wantsCallNotifications:(char)a2;
...
- (void)performBlockOnQueue:(id /* block */)a0 andWait:(char)a1;
- (void)pickRouteWithUniqueIdentifier:(id)a0 shouldWaitUntilAvailable:(char)a1 forRouteController:(id)a2;
...
- (oneway void)setDownlinkMuted:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setEmergencyMediaItems:(id)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setHasEmergencyVideoStream:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setIsSendingVideo:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setLiveVoicemailUnavailableReason:(long long)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setMixesVoiceWithMedia:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
...
- (oneway void)setSharingScreen:(char)a0 attributes:(id)a1 forCallWithUniqueProxyIdentifier:(id)a2;
- (oneway void)setSharingScreen:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setTTYType:(int)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)setUplinkMuted:(char)a0 forCallWithUniqueProxyIdentifier:(id)a1;
- (oneway void)shouldAllowRingingCallStatusIndicator:(char)a0;
- (char)shouldRestrictAddresses:(id)a0 forBundleIdentifier:(id)a1 performSynchronously:(char)a2;
- (oneway void)shouldSuppressInCallStatusBar:(char)a0;
