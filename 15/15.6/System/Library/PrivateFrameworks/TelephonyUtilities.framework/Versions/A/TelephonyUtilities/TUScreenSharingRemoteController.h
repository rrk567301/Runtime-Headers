...
@property char presenterAllowsRequestingControl;
...
@property char clientSideCursorAvailable;
...
- (void)remoteControlProvider:(id)a0 clientSideCursorUpdated:(char)a1;
...
- (void)remoteControlProvider:(id)a0 presenterAllowsRequestingControlChanged:(char)a1;
