...
@property (readonly, nonatomic) char serverCertValidationEnabled;
...
- (id)initWithConnectionRetryIntervalMillis:(unsigned long long)a0 connectionMaxAttempts:(unsigned long long)a1 rpcStreamRetryIntervalMillis:(unsigned long long)a2 rpcStreamMaxAttempts:(unsigned long long)a3 serverCertValidationEnabled:(char)a4 serverCertHostnameOverride:(id)a5 serverCertLeafMarkerOIDOverride:(id)a6;
- (char)isEqualToConversationVirtualParticipantConfig:(id)a0;
