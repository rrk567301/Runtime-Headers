...
- (void)_initializeAsynchronousStateWithCall:(id)a0 cacheOnly:(char)a1;
...
- (id)initWithCall:(id)a0 contactIdentifier:(id)a1 serialQueue:(id)a2 cacheOnly:(char)a3;
- (id)initWithCall:(id)a0 contactIdentifier:(id)a1 serialQueue:(id)a2 contactsDataSource:(id)a3;
- (id)initWithCall:(id)a0 contactIdentifier:(id)a1 serialQueue:(id)a2 contactsDataSource:(id)a3 cacheOnly:(char)a4;
- (id)initWithDisplayContext:(id)a0 call:(id)a1 serialQueue:(id)a2;
- (id)initWithDisplayContext:(id)a0 call:(id)a1 serialQueue:(id)a2 cacheOnly:(char)a3;
