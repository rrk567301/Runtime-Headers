...
@property (nonatomic, getter=isCameraBlurEnabled) char cameraBlurEnabled;
...
- (void)cameraZoomAvailabilityDidChange:(char)a0;
...
- (char)supportsCameraBlurForDevice:(id)a0;
