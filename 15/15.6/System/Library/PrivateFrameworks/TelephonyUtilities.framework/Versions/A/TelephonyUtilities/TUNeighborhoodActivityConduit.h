...
@property (class, readonly, nonatomic, getter=isConduitAvailable) char conduitAvailable;
...
@property (nonatomic) char isRingingFaceTimeCallsOnConnectedTVDevice;
...
- (char)canPullBackConversation:(id)a0;
...
- (void)isRingingFaceTimeCallsOnConnectedTVDeviceChanged:(char)a0;
