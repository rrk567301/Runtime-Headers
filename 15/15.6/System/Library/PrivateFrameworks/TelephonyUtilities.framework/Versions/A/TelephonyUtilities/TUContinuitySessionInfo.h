...
@property (readonly, nonatomic) char isDedicatedSession;
...
- (id)initWithDevice:(id)a0 calls:(id)a1 activeConversations:(id)a2 recentCalls:(id)a3 recentCallsContacts:(id)a4 isDedicatedSession:(char)a5 favorites:(id)a6 recentCallsInfos:(id)a7 callBlockedStates:(id)a8;
