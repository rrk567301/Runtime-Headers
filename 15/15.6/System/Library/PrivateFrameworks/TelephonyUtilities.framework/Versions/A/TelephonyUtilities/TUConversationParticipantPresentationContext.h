...
@property (readonly, nonatomic) char isInCanvas;

- (id)description;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)initWithParticipantIdentifier:(unsigned long long)a0 videoQuality:(unsigned long long)a1 visibility:(id)a2 prominence:(id)a3 spatialPosition:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 isInCanvas:(char)a5;
