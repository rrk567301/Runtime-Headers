...
@property (readonly, nonatomic) char wantsCallNotifications;
...
- (id)initWithNotificationCenter:(id)a0 wantsCallNotifications:(char)a1;
...
- (void)mediaPropertiesChangedForCall:(id)a0 remoteAspectRatioDidChange:(char)a1 remoteCameraOrientationDidChange:(char)a2;
