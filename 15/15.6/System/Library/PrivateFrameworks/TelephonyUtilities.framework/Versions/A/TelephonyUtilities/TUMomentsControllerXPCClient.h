...
- (oneway void)didFinishRecordingMedia:(id)a0;
- (oneway void)didReceiveLocallyRequestedMomentDescriptor:(id)a0;
- (oneway void)didReceiveMediaRecordingError:(id)a0;
...
- (void)registerStreamToken:(long long)a0 requesterID:(id)a1 remoteIDSDestinations:(id)a2 remoteMomentsAvailable:(char)a3 completion:(id /* block */)a4;
