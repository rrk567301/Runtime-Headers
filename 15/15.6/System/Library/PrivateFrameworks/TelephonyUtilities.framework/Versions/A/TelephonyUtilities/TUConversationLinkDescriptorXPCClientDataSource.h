...
- (char)addConversationLinkDescriptors:(id)a0 error:(id *)a1;
- (void)addOrUpdateConversationLinkDescriptors:(id)a0 completion:(id /* block */)a1;
- (char)addOrUpdateConversationLinkDescriptors:(id)a0 error:(id *)a1;
...
- (void)setActivated:(char)a0 withRevision:(long long)a1 forConversationLinkDescriptorsWithPredicate:(id)a2 completion:(id /* block */)a3;
- (unsigned long long)setActivated:(char)a0 withRevision:(long long)a1 forConversationLinkDescriptorsWithPredicate:(id)a2 error:(id *)a3;
