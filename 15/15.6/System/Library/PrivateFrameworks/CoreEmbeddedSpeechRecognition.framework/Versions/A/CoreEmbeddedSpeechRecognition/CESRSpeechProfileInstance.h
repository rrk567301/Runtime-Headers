...
- (char)remove:(id *)a0;
- (char)updateOptions:(unsigned char)a0 error:(id *)a1;
- (id)_changeRegistryFilename;
- (char)_updateOptions:(unsigned char)a0 error:(id *)a1;
- (id)_updateVersion:(id)a0 forKeys:(id)a1 logKey:(id)a2;
- (id)initWithSpeechProfileSiteURL:(id)a0 create:(char)a1 locale:(id)a2 options:(unsigned char)a3 error:(id *)a4;
- (char)isEqualToInstance:(id)a0;
