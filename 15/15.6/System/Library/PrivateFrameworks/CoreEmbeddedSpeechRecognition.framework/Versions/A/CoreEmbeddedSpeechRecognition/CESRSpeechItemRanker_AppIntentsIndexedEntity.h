...
@interface CESRSpeechItemRanker_AppIntentsIndexedEntity : CESRSpeechItemRanker {
    ...
    char _appEntityIngestionEnabled;
    NSMutableSet *_codepathIds;
    unsigned long long _numTotalEnrolled;
}

+ (char)_appEntityIngestionEnabledForFeatureFlagStatus:(char)a0 overallAppEntityLimit:(unsigned long long)a1;
...
+ (char)_isEntityAllowListed:(id)a0 bundleId:(id)a1 appEntityConfig:(id)a2;
...
+ (char)_shouldAcceptEntity:(id)a0 bundleId:(id)a1 appEntityConfig:(id)a2 entityTypes:(id)a3 numEntitiesRejected:(unsigned long long *)a4 numEmptyDisplayRepresentations:(unsigned long long *)a5;
...
- (id)sets;
- (char)hasSets;
- (char)_interactionStoreContainsAppEntity:(id)a0;
- (void)_setAppEntityConfig:(id)a0;
- (void)_setAppEntityIngestionEnabled:(char)a0;
