...
+ (unsigned long long)updateModeForSet:(id)a0 speechProfileInstance:(id)a1 isSetNew:(char *)a2;
+ (unsigned long long)updateModeForSets:(id)a0 speechProfileInstance:(id)a1 speechProfileSite:(id)a2 isAnySetNew:(char *)a3;
+ (id)updaterForInstance:(id)a0 atSpeechProfileSite:(id)a1;

- (void).cxx_destruct;
- (char)removeProfile:(id *)a0;
...
- (char)_errorRequiresCleanRebuild:(id)a0;
- (id)_versionForCategory:(id)a0 error:(id *)a1;
- (id)categoriesToRebuildForAllSets:(id)a0;
- (char)detectCategoriesToRebuild:(id *)a0 error:(id *)a1;
- (id)initWithInstance:(id)a0 speechProfileSite:(id)a1 builder:(id)a2;
- (char)rebuildCategoryGroup:(id)a0 withSets:(id)a1 version:(id)a2 error:(id *)a3;
