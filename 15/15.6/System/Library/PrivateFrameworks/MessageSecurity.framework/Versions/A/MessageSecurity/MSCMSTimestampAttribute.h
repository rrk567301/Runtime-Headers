@class MSCMSTimestampAttributeInternal, MSCMSSignerInfo, NSArray, NSURL, MSOID, NSDate;
...
@property char certChainRequested;
...
- (id)initWithServerURL:(id)a0 chainRequested:(char)a1;
- (id)initWithTimestampToken:(id)a0;
- (char)verifyTimestamps:(id)a0 error:(id *)a1;
