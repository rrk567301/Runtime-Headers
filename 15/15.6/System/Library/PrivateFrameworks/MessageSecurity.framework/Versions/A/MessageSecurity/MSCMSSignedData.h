...
+ (char)isImplementedInObjectiveC;

- (void).cxx_destruct;
- (id)encodeMessageSecurityObject:(id *)a0;
- (id)initWithDataContent:(id)a0 isDetached:(char)a1 signer:(id)a2 additionalCertificates:(id)a3 error:(id *)a4;
- (char)verifySignatures:(id *)a0;
- (char)verifySignaturesAndSignersWithPolicies:(id)a0 verifyTime:(id)a1 error:(id *)a2;
- (id)initWithDataContent:(id)a0 isDetached:(char)a1 signer:(id)a2 error:(id *)a3;
- (void)removeSignersWithIndexes:(id)a0 error:(id *)a1;
- (char)addCertificatesForSigner:(id)a0 mode:(unsigned long long)a1 error:(id *)a2;
...
- (char)addSigner:(id)a0 withChainMode:(unsigned long long)a1 error:(id *)a2;
- (id)calculateContentDigestWithAlgorithm:(id)a0 error:(id *)a1;
- (char)checkSignedPerRFC5652:(id *)a0;
...
- (id)initWithDataContent:(id)a0 isDetached:(char)a1 signer:(id)a2 signerChainMode:(unsigned long long)a3 error:(id *)a4;
...
- (char)verifySignaturesAndSignersWithPolicies:(id)a0 verifyTime:(id)a1 anchorCertificates:(id)a2 error:(id *)a3;
