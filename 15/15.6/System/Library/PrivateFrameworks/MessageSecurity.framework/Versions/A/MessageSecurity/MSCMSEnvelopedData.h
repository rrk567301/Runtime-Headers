...
@property char legacyASN1Encoding;
...
- (char)addRecipient:(id)a0 error:(id *)a1;
- (id)bulkEncryptDecrypt:(unsigned int)a0 algorithm:(unsigned int)a1 mode:(unsigned int)a2 key:(id)a3 iv:(id)a4 error:(id *)a5;
- (char)checkDecryptionResult:(id)a0;
- (id)decryptContent:(id)a0 error:(id *)a1;
- (char)encodeEncryptionParameters:(id *)a0;
...
- (id)generateEncryptionKey:(id *)a0;
- (id)getRecipients;
