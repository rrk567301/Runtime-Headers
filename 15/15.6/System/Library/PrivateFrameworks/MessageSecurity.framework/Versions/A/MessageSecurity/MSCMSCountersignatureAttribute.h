...
- (char)verifyCountersignatures:(id)a0 error:(id *)a1;
- (char)verifyCountersignaturesAndCountersignersWithPolicies:(id)a0 verifyTime:(id)a1 anchorCertificates:(id)a2 signature:(id)a3 error:(id *)a4;
