...
@property (readonly, nonatomic) char useManateeContainer;

- (void).cxx_destruct;
- (id)_recordsWithCloudHistoryVisits:(id)a0;
- (void)_batchSaveRecords:(id)a0 useLongLivedOperation:(char)a1 longLivedOperationPersistenceCompletion:(id /* block */)a2 completion:(id /* block */)a3;
...
- (char)_shouldTryToResetRecordZoneForError:(id)a0;
...
- (id)initWithConfiguration:(id)a0 useManateeContainer:(char)a1;
