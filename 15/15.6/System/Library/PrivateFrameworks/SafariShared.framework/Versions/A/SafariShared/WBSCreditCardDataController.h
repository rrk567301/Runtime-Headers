...
@interface WBSCreditCardDataController : NSObject <WBSCreditCardImporterDelegate> {
    ...
    char _isQueueOfVirtualCardsToFetchDetailsForBeingProcessed;
}
...
- (void)getVirtualCardCredentialsWithExternalizedContext:(id)a0 shouldIncludeVPANCards:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)isCreditCardDataSaved:(id)a0;
...
- (char)shouldAddCardWithNumber:(id)a0;
- (char)shouldNeverSaveCardWithNumber:(id)a0;
...
- (char)test_shouldReplaceExistingCard:(id)a0 withImportedCard:(id)a1;
