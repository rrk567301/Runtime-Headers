...
- (void)clearAllHistoryInsertingTombstoneUpToDate:(id)a0 clearAllSpotlightHistoryForProfile:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 clearAllSpotlightHistoryForProfile:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)dispatchEvent:(id)a0 listenersToIgnore:(id)a1 persistForDelayedDispatching:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)getHighLevelHTTPFamilyDomainsVisitedAfterDate:(id)a0 beforeDate:(id)a1 onlyFromThisDevice:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)recordVisitWithIdentifier:(id)a0 sourceVisit:(id)a1 title:(id)a2 wasHTTPNonGet:(char)a3 loadSuccessful:(char)a4 origin:(long long)a5 attributes:(unsigned long long)a6 statusCode:(long long)a7 completionHandler:(id /* block */)a8;
...
- (void)startImportHistorySessionWithVisitTimePrecision:(unsigned long long)a0 completionHandler:(id /* block */)a1;
...
- (void)visitIdentifiersMatchingExistingVisits:(id)a0 desiredVisitTimePrecision:(unsigned long long)a1 completionHandler:(id /* block */)a2;
