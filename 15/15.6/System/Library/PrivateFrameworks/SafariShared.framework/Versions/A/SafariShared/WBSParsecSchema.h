...
+ (id)schemaForArrayWithElementSchema:(id)a0 associatedError:(id)a1 isOptional:(char)a2;
+ (id)schemaForDictionaryWithStructure:(id)a0;
+ (id)schemaForDictionaryWithStructure:(id)a0 associatedError:(id)a1;
+ (id)schemaForDictionaryWithStructure:(id)a0 associatedError:(id)a1 isOptional:(char)a2;
...
+ (id)schemaWithExpectedClass:(Class)a0 associatedError:(id)a1 isOptional:(char)a2;

- (void).cxx_destruct;
- (char)_validateChild:(id)a0 ofParent:(id)a1 withParentAssociatedError:(id)a2 errorHandler:(id /* block */)a3;
- (id)_initWithExpectedClass:(Class)a0 associatedError:(id)a1 isOptional:(char)a2;
