...
+ (char)storeExistsForProfileWithIdentifier:(id)a0;
...
- (char)_createDatabaseSchemaIfNeeded;
...
- (char)_openDatabaseIfNeededFallingBackToInMemory:(char)a0;
- (long long)_schemaVersion;
- (char)_tryOpenDatabase:(id *)a0;
