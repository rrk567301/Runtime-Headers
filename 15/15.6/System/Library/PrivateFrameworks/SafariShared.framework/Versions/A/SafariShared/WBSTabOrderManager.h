...
@property (readonly, nonatomic) char newTabPositionAppliesToSpawnedTabs;
@property (readonly, nonatomic) char newBlankTabPositionAppliesToAllBlankTabs;
@property (readonly, nonatomic) char suppressRelatingNewBlankTabs;
...
- (id)_nextNonClosedTabAdjacentToIndex:(unsigned long long)a0 inAscendingOrder:(char)a1;
- (unsigned long long)_relationConsideringUserPreferenceForRelation:(unsigned long long)a0 isBlankTab:(char)a1;
- (char)_tab:(id)a0 isRelatedOrEqualToTab:(id)a1;
...
- (id)_tabInsertionHintForPosition:(unsigned long long)a0 isBlankTab:(char)a1;
- (unsigned long long)_userPreferredNewBlankTabPositionInCurrentContext:(char)a0;
- (unsigned long long)_userPreferredNewSpawnedTabPosition;
- (id)simplifiedIdentifierForDisplayInTabTitle:(id)a0;
- (char)tab:(id)a0 isInSameSetAsTab:(id)a1;
...
- (id)tabToSelectBeforeClosingTabs:(id)a0;
