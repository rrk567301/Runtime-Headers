...
- (void)_enforceRules:(id)a0 reportOnlyPreexistingViolationsAsLeaks:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)checkForLeaksSynchronously:(char)a0;
- (void)runWithConfigJSONPath:(id)a0 reportLeaksToSystemLogs:(char)a1;
