...
@property (readonly, nonatomic, getter=wasHTTPNonGet) char httpNonGet;
@property (readonly, nonatomic, getter=isSynthesized) char synthesized;
...
- (void).cxx_destruct;
- (double)_weight;
- (char)hasAttributes:(unsigned long long)a0;
...
- (id)initWithHistoryItem:(id)a0 visitTime:(double)a1 loadWasSuccesful:(char)a2 wasHTTPNonGet:(char)a3 origin:(long long)a4 attributes:(unsigned long long)a5;
- (void)recomputeScore;
