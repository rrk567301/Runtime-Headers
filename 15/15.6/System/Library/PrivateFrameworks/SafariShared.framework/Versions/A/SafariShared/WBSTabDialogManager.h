...
- (id)_queueForTabID:(unsigned long long)a0 createIfNeeded:(char)a1;
- (id)_setForWebProcessID:(int)a0 createIfNeeded:(char)a1;
...
- (void)enqueueOrPresentDialogInSlot:(struct { int x0; unsigned long long x1; })a0 presentationBlock:(id /* block */)a1 dismissalBlock:(id /* block */)a2 blocksWebProcessUntilDismissed:(char)a3;
