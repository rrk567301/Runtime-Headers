...
- (char)_addAutocompleteTrigger:(id)a0 forURL:(id)a1 error:(id *)a2;
- (id)_addOrModifyObjects:(id)a0;
- (void)_checkpointWriteAheadLog;
- (id)_clearAllHistoryInsertingTombstoneUpToDate:(id)a0 clearAllSpotlightHistoryForProfile:(char)a1;
- (id)_clearHistoryItems:(id)a0 afterDate:(id)a1 beforeDate:(id)a2 tombstoneMode:(unsigned long long)a3;
- (id)_clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 clearAllSpotlightHistoryForProfile:(char)a3;
...
- (char)_commitPendingItems:(id)a0;
- (void)_commitPendingUpdates;
- (char)_commitPendingVisits:(id)a0;
...
- (void)_dispatchEvent:(id)a0 listenersToIgnore:(id)a1 persistForDelayedDispatching:(char)a2 completionHandler:(id /* block */)a3;
- (void)_ensureDatabaseIsSynced;
- (id)_ensureLatestVisitsAreComputed;
- (id)_executePlan:(void *)a0 outDeletedItemCount:(unsigned long long *)a1 outDeletedVisitCount:(unsigned long long *)a2 clearAllSpotlightHistoryForProfile:(char)a3;
...
- (void)_updateItem:(long long)a0 visitCountScore:(long long)a1 dailyVisitCounts:(id)a2 weeklyVisitCounts:(id)a3 shouldRecomputeDerivedVisitCounts:(char)a4;
