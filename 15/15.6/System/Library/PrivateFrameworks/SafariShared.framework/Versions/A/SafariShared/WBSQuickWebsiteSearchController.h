...
@property char quickWebsiteSearchProvidersLoadedFromDisk;
...
- (char)_quickWebsiteSearchProviderHasSearchURLTemplateStringOnAccessQueue:(id)a0;
...
- (char)_shouldRemoveQuickWebsiteSearchProvider:(id)a0;
