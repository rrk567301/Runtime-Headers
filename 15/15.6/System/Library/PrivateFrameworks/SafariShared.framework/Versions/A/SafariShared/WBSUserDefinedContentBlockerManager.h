...
@property (readonly, nonatomic) char didLoadGlobalContentBlockerActions;
@property (readonly, nonatomic) char hasContentBlockerWithActions;
...
- (void)contentBlockerForHost:(id)a0 createIfNeeded:(char)a1 completionHandler:(id /* block */)a2;
