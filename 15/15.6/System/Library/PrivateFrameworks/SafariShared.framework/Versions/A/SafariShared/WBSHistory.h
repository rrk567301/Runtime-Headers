...
@property (readonly, nonatomic) char hasAnyHistoryItems;
...
- (void)_addItem:(id)a0 addToStringsForUserTypedDomainExpansions:(char)a1;
...
- (void)_dispatchHistoryItemDidChange:(id)a0 byUserInitiatedAction:(char)a1;
- (void)_dispatchHistoryItemsAdded:(id)a0 byUserInitiatedAction:(char)a1;
...
- (char)_isStringForUserTypedDomainExpansionInHistory:(id)a0;
- (void)_loadHistory;
...
- (char)canRecordRedirectFromVisit:(id)a0 to:(id)a1;
...
- (id)historyStore:(id)a0 itemForURLString:(id)a1 createIfNeeded:(char)a2;
...
- (id)itemForURLString:(id)a0 createIfNeeded:(char)a1;
...
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 timeOfVisit:(double)a2 wasHTTPNonGet:(char)a3 wasFailure:(char)a4 increaseVisitCount:(char)a5 origin:(long long)a6;
...
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 timeOfVisit:(double)a2 wasHTTPNonGet:(char)a3 wasFailure:(char)a4 increaseVisitCount:(char)a5 statusCode:(long long)a6 origin:(long long)a7;
...
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 wasHTTPNonGet:(char)a2 wasFailure:(char)a3 increaseVisitCount:(char)a4;
- (id)itemVisitedAtURLString:(id)a0 title:(id)a1 wasHTTPNonGet:(char)a2 wasFailure:(char)a3 increaseVisitCount:(char)a4 statusCode:(long long)a5;
