...
- (char)_deleteFromAllTables;
- (void)_getActionsForContentBlockerID:(long long)a0 isGlobal:(char)a1 completionHandler:(id /* block */)a2;
- (void)_getAllContentBlockerActionsWithType:(id)a0 excludeHost:(id)a1 isGlobal:(char)a2 completion:(id /* block */)a3;
...
- (int)_insertContentBlockerWithType:(long long)a0 host:(id)a1 excludeGlobal:(char)a2;
- (int)_migrateToCurrentSchemaVersionIfNecessary;
- (char)_migrateToSchemaVersion:(int)a0;
- (int)_migrateToSchemaVersion_2;
- (void)_openDatabase;
- (void)_openDatabaseIfNecessary;
- (char)_tryToPerformTransactionInBlock:(id /* block */)a0;
...
- (void)getAllContentBlockerActionsWithType:(id)a0 excludeHost:(id)a1 isGlobal:(char)a2 completion:(id /* block */)a3;
...
- (void)getPerSiteContentBlockerForHost:(id)a0 createIfNeeded:(char)a1 completionHandler:(id /* block */)a2;
