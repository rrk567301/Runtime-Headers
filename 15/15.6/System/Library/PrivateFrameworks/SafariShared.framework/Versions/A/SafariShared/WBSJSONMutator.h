...
- (id)_mutatedArrayField:(id)a0 shouldProtectRootObject:(char)a1;
- (id)_mutatedCollectionField:(id)a0;
- (id)_mutatedDictionaryField:(id)a0 shouldProtectRootObject:(char)a1;
...
- (id)mutatedJSONProtectingRootObject:(char)a0;
