...
- (void)_indexCoreSpotlightData:(id)a0 filterDeletedHistoryItems:(char)a1 completionHandler:(id /* block */)a2;
- (void)_indexCoreSpotlightData:(id)a0 filterDeletedHistoryItems:(char)a1 onDispatchQueue:(id)a2 completionHandler:(id /* block */)a3;
- (void)_indexHistoryItemsToCoreSpotlight:(id)a0 filterDeletedHistoryItems:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)donateTextInWebView:(id)a0 extractedReaderText:(id)a1 canDonateFullPageText:(char)a2 profileIdentifier:(id)a3 personalizationData:(id)a4 extractInnerText:(id /* block */)a5;
