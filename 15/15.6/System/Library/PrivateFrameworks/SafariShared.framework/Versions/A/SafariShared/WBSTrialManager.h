...
- (char)getBoolFactor:(id)a0 forCF:(char)a1 forDefault:(char)a2;
- (unsigned long long)_weightedRandomIdentifier;
- (void)fetchFactorsInNamespace:(id)a0;
- (id)getFactorValueAsString:(id)a0;
- (double)getFloatFactor:(id)a0 forCF:(char)a1 forDefault:(double)a2;
- (long long)getIntFactor:(id)a0 forCF:(char)a1 forDefault:(long long)a2;
- (id)getNumberFactorWithName:(id)a0;
- (id)getRetrievalFactorName:(id)a0 forCF:(char)a1;
- (char)inExperiment;
- (char)isCFEnabled;
- (void)performDelayedLaunchOperations;
- (id)prepareLogDictionary:(char)a0 withExperimentId:(id)a1 withTreatmentId:(id)a2 isCounterFactualSearch:(char)a3 withFactorData:(id)a4;
