...
@property (readonly, nonatomic) char stopAccessingRequestURLWhenDone;
...
- (id)initWithExtensions:(id)a0 requestURL:(id)a1 stopAccessingRequestURLWhenDone:(char)a2 queue:(id)a3 error:(id *)a4;
