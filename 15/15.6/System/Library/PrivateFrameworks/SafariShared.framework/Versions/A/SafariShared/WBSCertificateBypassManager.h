...
- (char)_didCertificatExceptionsApplySuccessfully:(id)a0 protectionSpace:(id)a1;
...
- (char)didInvalidCertificateExceptionsApplySuccessfullyForProtectionSpace:(id)a0 inPrivateBrowsing:(char)a1;
- (void)rememberCertificateBypassForProtectionSpace:(id)a0 inPrivateBrowsing:(char)a1;
