@class WBSCyclerProfileRepresentation, WBSCyclerItemListRepresentation, NSString;
...
- (char)_isItemPrefixed:(id)a0;
- (char)_isItemValid:(id)a0;
- (id)filterOutItemsWithoutTitlePrefixInList:(id)a0;
- (id)randomDescendantOfList:(id)a0 enforcingTitlePrefixValidity:(char)a1 passingTest:(id /* block */)a2;
