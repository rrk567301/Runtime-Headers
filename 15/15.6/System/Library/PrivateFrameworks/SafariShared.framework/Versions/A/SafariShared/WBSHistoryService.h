...
- (char)_connectionIsEntitledToUseUserDatabase:(id)a0;
- (id)_copyAndRedactHistoryDatabaseWithURL:(id)a0 databaseDestinationFileURL:(id)a1;
- (id)_openOrReuseExistingDatabaseWithOptions:(id)a0 createIfNeeded:(char)a1 error:(id *)a2;
...
- (void)openDatabaseWithID:(id)a0 createIfNeeded:(char)a1 completionHandler:(id /* block */)a2;
