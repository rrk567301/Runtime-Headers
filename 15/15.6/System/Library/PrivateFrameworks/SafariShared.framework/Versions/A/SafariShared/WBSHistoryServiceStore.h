...
@property (readonly, nonatomic) char isUsingInMemoryDatabase;
...
- (void)_addOrUpdateItemsOnDatabaseQueue:(id)a0 userInitiated:(char)a1;
...
- (char)_ensureItemHasID:(id)a0;
- (char)_ensureVisitHasID:(id)a0;
...
- (void)itemsWereAdded:(id)a0 byUserInitiatedAction:(char)a1;
- (void)itemsWereModified:(id)a0 byUserInitiatedAction:(char)a1;
...
- (void)tagsWithIdentifiers:(id)a0 type:(unsigned long long)a1 level:(long long)a2 creatingIfNecessary:(char)a3 withTitles:(id)a4 completionHandler:(id /* block */)a5;
