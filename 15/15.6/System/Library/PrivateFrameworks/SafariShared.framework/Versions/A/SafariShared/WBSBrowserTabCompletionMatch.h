...
@property (nonatomic, getter=isHighlyRelevant) char highlyRelevant;
...
@property (readonly, nonatomic, getter=isLessRelevant) char lessRelevant;

- (void).cxx_destruct;
- (id)initWithTabInfo:(id)a0 userTypedString:(id)a1 alternativeDisplayTextForURL:(id)a2 forQueryID:(long long)a3;
