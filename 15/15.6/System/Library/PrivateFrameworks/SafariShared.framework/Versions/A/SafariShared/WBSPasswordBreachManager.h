...
@property (class, nonatomic, getter=isPasswordBreachDetectionOn) char passwordBreachDetectionOn;
...
- (void).cxx_destruct;
- (void)performNextSessionLookupIgnoringMinimumDelay:(char)a0 completionHandler:(id /* block */)a1;
- (void)_addRecentlyBreachedNotificationIfNecessaryWithCompletionHandler:(id /* block */)a0;
- (char)_canPerformSessionIgnoringMinimumDelay:(char)a0;
- (id)_checker;
