...
@property (nonatomic) char tableOfContentsAvailable;
...
@property (readonly, nonatomic) char remoteContentAvailableForFetching;
@property (readonly, nonatomic) char remoteContentReady;
