...
- (void)resetToDefault;
- (id)_migrateUnknownSectionIdentifiersIntoCurrentSections:(id)a0 didChangeSections:(char *)a1;
- (void)reorderSectionsToMatchOrderedIdentifiers:(id)a0;
- (void)saveSections:(id)a0 andUpdateInMemoryCache:(char)a1;
- (void)setSectionIdentifier:(id)a0 enabled:(char)a1;
