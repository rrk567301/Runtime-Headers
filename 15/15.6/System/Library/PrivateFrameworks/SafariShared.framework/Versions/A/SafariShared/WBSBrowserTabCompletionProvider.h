...
- (char)_isOperationValidForQuery:(id)a0 tabInfos:(id)a1 selectedTabInfo:(id)a2;
- (id)_matchesForQuery:(id)a0 tabInfos:(id)a1 selectedTabInfo:(id)a2 forQueryID:(long long)a3;
- (void)_prepareQueue;
- (id)bestTabCompletionMatchFromMatches:(id)a0 withTopHitURL:(id)a1;
- (id)bestTabCompletionMatchWithTopHitURL:(id)a0;
