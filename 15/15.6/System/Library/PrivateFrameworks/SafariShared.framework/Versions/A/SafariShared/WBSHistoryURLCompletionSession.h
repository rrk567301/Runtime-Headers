...
@property (readonly, nonatomic, getter=isEnumeratingBookmarkMatches) char enumeratingBookmarkMatches;
@property (readonly, nonatomic, getter=isEnumeratingHistoryMatches) char enumeratingHistoryMatches;
...
- (id)fakeBookmarkMatchDataWithURLString:(id)a0 title:(id)a1 shouldPreload:(char)a2;
