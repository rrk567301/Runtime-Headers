...
- (id)debugDescription;
- (void).cxx_destruct;
- (id)initWithSelector:(id)a0 type:(id)a1 isGlobal:(char)a2;
- (void)_readExtraAttributesWithData:(id)a0;
- (void)addHostWhereActionHasApplied:(id)a0 selectors:(id)a1;
- (id)extraAttributesData;
- (id)initWithDatabaseID:(long long)a0 selector:(id)a1 type:(id)a2 extraAttributesData:(id)a3 isGlobal:(char)a4;
