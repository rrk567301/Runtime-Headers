...
@property (class, readonly, nonatomic) char shouldShowConsentCard;
@property (class, readonly, nonatomic) char hasUserConsent;
@property (class, nonatomic) long long userConsentState;
@property (class, readonly, nonatomic) char isAvailableInCurrentLocale;
...
@property (readonly, nonatomic, getter=isSummaryAvailable) char summaryAvailable;
...
- (id)init;
- (void).cxx_destruct;
- (char)_checkAssistantAvailabilityForPageLocale:(id)a0;
...
- (char)_shouldContinueFetchingRemoteContent:(id)a0;
