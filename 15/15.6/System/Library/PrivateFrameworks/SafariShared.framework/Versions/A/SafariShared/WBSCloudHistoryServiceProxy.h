...
- (void)fetchAndMergeChangesBypassingThrottler:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)saveChangesBypassingThrottler:(char)a0 completionHandler:(id /* block */)a1;
