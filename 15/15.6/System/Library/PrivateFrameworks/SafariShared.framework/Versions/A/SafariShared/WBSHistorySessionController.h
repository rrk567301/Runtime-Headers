...
- (void)_addItemsToSessionCache:(id)a0 shouldPostChangeNotification:(char)a1;
- (void)_clearSessionCache;
- (void)_dispatchHistorySessionsDidChangeNotification;
- (char)_getKey:(id *)a0 forDate:(double)a1;
- (void)_historWasClearedWithInterval:(id)a0;
- (void)_historyItemsWereAdded:(id)a0;
- (void)_historyItemsWereRemoved:(id)a0;
- (void)_historyWasSignificantlyChanged:(id)a0;
...
- (void)orderedSessionsWithCompletionHandler:(id /* block */)a0;
