...
@property (class, readonly, nonatomic) char isBiomeStreamDonationAvailable;
...
- (void)_donateWebPagePerformanceEventWithEvent:(int)a0 domain:(id)a1 webPageLoadedOverPrivateRelay:(char)a2;
...
- (void)donateAutoPlayEventWithSignal:(long long)a0 domain:(id)a1 countryCode:(id)a2 webPageLoadedOverPrivateRelay:(char)a3;
...
- (void)donateBrowsingAssistantUserInteractionDetectedWithWebPageID:(id)a0 componentType:(long long)a1 componentIdentifier:(id)a2 tableOfContentsArrayLength:(id)a3 tableOfContentsTextIndex:(id)a4 readerSectionExpanded:(char)a5;
...
- (char)donateForDiagnosticLoggingKey:(id)a0 value:(id)a1 webPageLoadedOverPrivateRelay:(char)a2;
- (void)donateMemoryFootprint:(unsigned long long)a0 withDomain:(id)a1 pageCount:(unsigned long long)a2 processLifetime:(double)a3 inForeground:(char)a4 wasPrivateRelayed:(char)a5 canSuspend:(char)a6;
- (void)donateNavigationWithURL:(id)a0 userAgent:(long long)a1 wasPrivateRelayed:(char)a2 privateRelayVendorName:(id)a3 statusCode:(long long)a4;
- (void)donatePageLoadWithUserAgent:(long long)a0 wasSearch:(char)a1 wasPrivateBrowsing:(char)a2 wasActualized:(char)a3 provenance:(long long)a4;
- (void)donateWebAppInFocusEventWithStarting:(char)a0 date:(id)a1 webAppType:(long long)a2 identifier:(id)a3 name:(id)a4 manifestId:(id)a5;
