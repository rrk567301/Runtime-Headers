...
@interface WBSSearchContextManager : NSObject {
    ...
    char _needsCounterfactualSearchData;
    char contextsNeedUpdating;
}
...
@property (readonly, nonatomic) char needsCounterfactualSearchData;
...
- (char)runCounterfactualForContext:(long long)a0;
