...
- (void)_doSearch:(id)a0 atRootNode:(struct _WBSSearchSuggestionCandidate { unsigned int x0; unsigned int x1; char x2; id x3; } *)a1;
- (char)_findRootNodeForPrefix:(id)a0 rootNode:(struct _WBSSearchSuggestionCandidate { unsigned int x0; unsigned int x1; char x2; id x3; } *)a1;
- (id)_loadModel;
- (void)reloadModel;
