...
@property (readonly, nonatomic) char matchLocationIsInURL;
...
@property (nonatomic) char isTabCompletionItem;
@property (readonly, nonatomic) char wasPromotedAsSearchResultTopHitWithTitleMatch;
