...
- (void)getLockdownModeEnabledForDomain:(id)a0 withTimeout:(double)a1 fallbackEnabledState:(char)a2 usingBlock:(id /* block */)a3;
- (id)localizedStringForValue:(id)a0 inPreference:(id)a1;
- (id)offValueForPreference:(id)a0;
- (id)onValueForPreference:(id)a0;
- (char)preferenceDoesNotHaveForOtherWebsitesDefault:(id)a0;
- (id)preferenceNameForPreference:(id)a0;
- (void)setLockdownModeEnabled:(char)a0 forDomain:(id)a1;
