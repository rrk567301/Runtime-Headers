...
- (void)setBool:(char)a0 forKey:(id)a1 completionHandler:(id /* block */)a2;
- (void)setObject:(id)a0 forKey:(id)a1 completionHandler:(id /* block */)a2;
- (char)_boolForKeyOnInternalQueue:(id)a0;
- (id)_encodedURLForDefaults:(id)a0;
- (char)_isPreferenceMigratedToSecureDefaults:(id)a0;
- (void)_loadDefaultsDictionary:(id *)a0 migratedKeysSet:(id *)a1;
- (void)_migrateKeychainItemIfNeeded;
- (id)_objectForKeyOnInternalQueue:(id)a0 performingMigrationToSecureDefaultsIfNecessary:(char)a1;
...
- (char)safari_shouldTrustValueForKey:(id)a0;
