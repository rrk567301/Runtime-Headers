...
@property (nonatomic, getter=isCloudHistoryEnabled) char cloudHistoryEnabled;
@property (nonatomic) char removedHistoryItemsArePendingSave;
...
- (void)_enumerateDatabasesWithProfileLocalIdentifiers:(id)a0 createIfNeeded:(char)a1 enumerationBlock:(id /* block */)a2 completionBlock:(id /* block */)a3;
...
- (void)_postSaveChangesAttemptCompletedNotificationWithAllPendingDataSaved:(char)a0;
- (long long)_priorityForSaveWithVisits:(id)a0 tombstones:(id)a1 bypassingThrottler:(char)a2;
...
- (void)_saveVisits:(id)a0 tombstones:(id)a1 toCloudHistoryBypassingThrottler:(char)a2 longLivedOperationPersistenceCompletion:(id /* block */)a3 withCallback:(id /* block */)a4;
- (void)_serverBackoffTimerFired:(id)a0;
- (void)_setCachedNumberOfDevicesInSyncCircle:(unsigned long long)a0;
- (void)_setPushNotificationAreInitialized:(char)a0;
- (void)_setServerChangeToken:(id)a0;
- (char)_shouldSyncProfiles;
