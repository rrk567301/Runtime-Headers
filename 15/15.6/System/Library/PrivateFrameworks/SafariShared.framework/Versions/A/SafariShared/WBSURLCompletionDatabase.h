...
+ (char)_isMatchURLString:(id)a0 equivalentToBaseURLString:(id)a1;
+ (char)_matchIsNotURLMatchAndTitleLooksLikeURLForBookmarkAndHistoryCompletionMatch:(const void *)a0;
+ (char)_matchMistookErrorTitleForPageTitleForBookmarkAndHistoryCompletionMatch:(const void *)a0;
+ (char)_redirectionChainsOfCompletionMatchData:(id)a0 containURLString:(id)a1;
+ (char)_shouldPreloadTopHit:(void *)a0 forTypedString:(id)a1 withSearchParameters:(id)a2;
...
- (void)_getSortedMatchesForTypedString:(id)a0 filterResultsUsingProfileIdentifier:(id)a1 topHits:(void *)a2 historyMatches:(void *)a3 historyLimit:(unsigned long long)a4 bookmarkMatches:(void *)a5 bookmarkLimit:(unsigned long long)a6 searchParameters:(id)a7 prefixMatchesOnly:(char)a8;
...
- (void)clearBookmarkMatchesCachesKeepingEmptyValues:(char)a0;
