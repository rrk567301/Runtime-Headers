...
- (void)_createTokenWithExtensions:(id)a0 requestURL:(id)a1 includeRequestURL:(char)a2 isRequestURLSecurityScoped:(char)a3 completionHandler:(id /* block */)a4;
- (id)_extensionForURL:(id)a0 bookmarkData:(id)a1 permissions:(long long)a2 error:(id *)a3;
- (id)_fileExtensionForURL:(id)a0;
- (id)_resolveBookmarkData:(id)a0 isStale:(char *)a1 error:(id *)a2;
