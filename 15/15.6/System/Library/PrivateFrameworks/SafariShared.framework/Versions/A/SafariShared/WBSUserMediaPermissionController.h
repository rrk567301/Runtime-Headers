...
- (void)_cachedSettingsDidChangeAndWriteImmediately:(char)a0 completionHandler:(id /* block */)a1;
- (char)_captureDevicesAreAllDefaultsGivenPermission:(unsigned long long)a0;
...
- (char)_removePreferenceValuesForDomains:(id)a0 fromPreference:(id)a1;
...
- (char)_setValue:(id)a0 ofPreference:(id)a1 forDomain:(id)a2;
