...
- (char)saveCheckpoint:(id)a0;
- (char)startNewSession;
- (id)_defaultSessionLogParentDirectory;
- (id)_defaultSessionLogPath;
- (char)_writeToSessionLog:(id)a0 fields:(id)a1;
- (char)endSessionWithLogFileName:(id)a0 parentDirectory:(id)a1;
- (char)endSessionWithLogPath:(id)a0;
