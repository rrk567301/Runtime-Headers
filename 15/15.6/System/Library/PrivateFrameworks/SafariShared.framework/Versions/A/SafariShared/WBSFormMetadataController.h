...
+ (char)convertNumber:(id)a0 toFormMetadataRequestType:(unsigned long long *)a1;
+ (id)formMetadataClassificationJS;
+ (char)manualAutoFillButtonWillFitInFieldWithMetadata:(id)a0;
...
- (void)autoFillFormInFrame:(id)a0 withValues:(id)a1 fillSynchronously:(char)a2 setAutoFilled:(char)a3 focusFieldAfterFilling:(char)a4 fieldToFocus:(id)a5 fieldsToObscure:(id)a6 fillAllCharactersAtOnce:(char)a7 submitForm:(char)a8;
- (char)autoFillFrameIsValid:(id)a0;
- (void)autoFillOneTimeCodeFieldsInFrame:(id)a0 withValue:(id)a1 shouldSubmit:(char)a2;
...
- (void)finishedAutoFillingForm:(id)a0 inFrame:(id)a1 shouldSubmit:(char)a2;
- (void)finishedAutoFillingOneTimeCode:(id)a0 inFrame:(id)a1 shouldSubmit:(char)a2;
...
- (id)formSubmissionURLStringForSearchTextField:(id)a0 inFrame:(id)a1 useStrictDetection:(char)a2;
...
- (id)metadataForForm:(id)a0 inFrame:(id)a1 requestType:(unsigned long long)a2 addUserEditedStateForUserNameAndPasswordFields:(char)a3;
- (void *)metadataForFrame:(id)a0 requestType:(unsigned long long)a1;
- (char)pageWithMainFrameMeetsEditedFormTextWarningCriteria:(id)a0;
- (void)recursivelyClearMetadataForFrames:(id)a0;
- (char)recursivelyCollectAncestorFramesOfFrame:(id)a0 startingFromFrame:(id)a1 ancestorFrames:(id)a2;
...
- (void)removeAutomaticPasswordElementsInFrame:(id)a0 focusedPasswordControlUniqueID:(id)a1 passwordControlUniqueIDs:(id)a2 blurAfterRemoval:(char)a3;
...
- (void)setAutoFillSpinnerVisibility:(char)a0 textFieldMetadata:(id)a1 frame:(id)a2;
- (void)setFormControls:(id)a0 inFrame:(id)a1 asAutoFilled:(char)a2;
- (void)setStrongPasswordElementViewableIfAppropriate:(BOOL)a0 frame:(id)a1 passwordControlUniqueIDs:(id)a2;
- (id)substitutePasswordElementsWithAutomaticPasswordElementsInFrame:(id)a0 formID:(double)a1 focusedPasswordControlUniqueID:(id)a2 passwordControlUniqueIDs:(id)a3 automaticPassword:(id)a4 blurAfterSubstitution:(char)a5;
...
- (unsigned long long)userEditedTextControlCountInArray:(struct OpaqueJSValue { } *)a0 context:(struct OpaqueJSContext { } *)a1 expectTextFieldsRatherThanTextAreas:(char)a2;
