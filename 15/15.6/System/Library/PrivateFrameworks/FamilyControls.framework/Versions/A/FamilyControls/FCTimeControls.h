...
+ (char)extension:(id)a0 isFromDate:(id)a1;
...
+ (int)yesterdayRolloverSecondsForExtensions:(id)a0 date:(id)a1 clip:(char)a2;
...
- (char)allowanceIsInEffect:(id)a0;
- (char)curfewBlocksDate:(id)a0;
