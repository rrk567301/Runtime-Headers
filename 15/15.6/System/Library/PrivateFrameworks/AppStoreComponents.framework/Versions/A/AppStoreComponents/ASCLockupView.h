...
@property (nonatomic) char automaticallyGeneratesAppearMetrics;
...
@property (nonatomic) char automaticallyPresentsProductDetails;
@property (nonatomic, getter=isHighlighted) char highlighted;
@property (nonatomic) char showsPlaceholderContent;
