...
- (id)openApplicationWithBundleIdentifier:(id)a0 payloadURL:(id)a1 universalLinkRequired:(char)a2;
- (id)openApplicationWithBundleIdentifier:(id)a0 payloadURL:(id)a1 universalLinkRequired:(char)a2 workspace:(id)a3;
