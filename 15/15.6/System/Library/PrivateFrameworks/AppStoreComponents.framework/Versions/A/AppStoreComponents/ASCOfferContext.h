...
@property (readonly, nonatomic) char supportsDSIDLessInstall;
@property (readonly, nonatomic) char shouldInstallParentApp;
...
@property (readonly, nonatomic) char universalLinkRequired;
