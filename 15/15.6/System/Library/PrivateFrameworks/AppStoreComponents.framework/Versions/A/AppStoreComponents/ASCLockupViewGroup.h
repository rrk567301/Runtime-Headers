...
@property (nonatomic) char hasScheduledBatchRequest;
...
- (void)_lockupFromMediaAPIResponse:(id)a0 withContext:(id)a1 completionBlock:(id /* block */)a2;
- (void)_lockupRequestForBundleID:(id)a0 withContext:(id)a1 enableAppDistribution:(char)a2 completionBlock:(id /* block */)a3;
