...
+ (id)offerIconLayoutForSize:(id)a0 imageView:(id)a1 titleView:(id)a2 subtitleView:(id)a3 hasTrailingSubtitle:(char)a4 shouldTopAlign:(char)a5 topPadding:(double)a6 shouldTrailingAlign:(char)a7;
+ (double)offerProgressDiameterForSize:(id)a0;
+ (id)offerTextLayoutForSize:(id)a0 titleBackgroundView:(id)a1 titleView:(id)a2 subtitleView:(id)a3 hasTrailingSubtitle:(char)a4 shouldTopAlign:(char)a5 topPadding:(double)a6 shouldExpandBackground:(char)a7;
