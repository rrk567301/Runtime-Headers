...
@property int sockfd;
@property (getter=isReading) char reading;
...
- (char)handleCompletionMessage:(struct nstat_msg_hdr { unsigned long long x0; unsigned int x1; unsigned short x2; unsigned short x3; } *)a0 length:(unsigned int)a1;
...
- (char)addAllForProvider:(int)a0 filter:(unsigned long long)a1 events:(unsigned long long)a2 pid:(int)a3 uuid:(unsigned char[16] *)a4;
- (char)addAllRoute;
- (char)addAllRoute:(unsigned long long)a0;
- (char)addAllTCP:(unsigned long long)a0;
- (char)addAllTCP:(unsigned long long)a0 events:(unsigned long long)a1 pid:(int)a2 uuid:(unsigned char[16] *)a3;
- (char)addAllUDP:(unsigned long long)a0;
- (char)addAllUDP:(unsigned long long)a0 events:(unsigned long long)a1 pid:(int)a2 uuid:(unsigned char[16] *)a3;
- (char)addSource:(id)a0 request:(struct nstat_msg_add_src { struct nstat_msg_hdr { unsigned long long x0; unsigned int x1; unsigned short x2; unsigned short x3; } x0; unsigned int x1; unsigned char x2[4]; unsigned char x3[0]; } *)a1 length:(unsigned long long)a2;
...
- (char)handleCompletion:(unsigned long long)a0 message:(struct nstat_msg_hdr { unsigned long long x0; unsigned int x1; unsigned short x2; unsigned short x3; } *)a1 length:(unsigned int)a2;
...
- (void)handleSystemInformationCounts:(struct nstat_sysinfo_counts { unsigned int x0; unsigned int x1; struct nstat_sysinfo_keyval { unsigned int x0; unsigned int x1; union { long long x0; double x1; unsigned char x2[24]; } x2; unsigned int x3; unsigned char x4[4]; } x2[0]; } *)a0;
- (char)performQuery:(unsigned int)a0 sourceRef:(unsigned long long)a1 completion:(id /* block */)a2;
- (char)queryAll:(id /* block */)a0;
- (void)queryAllDescriptions:(id /* block */)a0;
- (void)querySource:(id)a0 completion:(id /* block */)a1;
- (void)removeSourceInternal:(unsigned long long)a0 isFromClient:(char)a1;
- (void)reportInternalCounts;
- (char)sendMessage:(struct nstat_msg_hdr { unsigned long long x0; unsigned int x1; unsigned short x2; unsigned short x3; } *)a0 length:(long long)a1;
