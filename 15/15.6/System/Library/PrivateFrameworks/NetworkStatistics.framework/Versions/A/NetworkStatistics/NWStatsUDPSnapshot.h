...
@property (readonly, nonatomic) char isSubFlow;
...
- (char)interfaceCompanionLinkBluetooth;
- (char)isKnownListener;
- (unsigned long long)uniqueProcessID;
- (char)interfaceCellularViaAnyFallback;
- (char)isKnownOutbound;
