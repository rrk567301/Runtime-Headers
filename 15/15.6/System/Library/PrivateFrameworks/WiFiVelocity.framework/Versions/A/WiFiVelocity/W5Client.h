...
- (id)__collectBusyFallbackLogsWithReason:(id)a0 compress:(char)a1;
- (id)__collectJetsamFallbackLogsWithReason:(id)a0 compress:(char)a1;
- (id)__eventCallbackSignatureForEventID:(long long)a0 peer:(id)a1;
- (void)__log:(id)a0 timestamp:(char)a1 reply:(id /* block */)a2;
- (void)__logsCollectedWithTemporaryURL:(id)a0 outputURL:(id)a1 keepParent:(char)a2 compress:(char)a3 reply:(id /* block */)a4;
...
- (char)__tarballWithSource:(id)a0 destination:(id)a1 error:(id *)a2;
...
- (id)localPeer;
- (void)log:(id)a0 timestamp:(char)a1;
...
- (char)registerRemoteDiagnosticEventsForPeer:(id)a0 configuration:(id)a1 error:(out id *)a2;
...
- (char)setDebugConfiguration:(id)a0 peer:(id)a1 error:(out id *)a2;
...
- (char)startMonitoringFaultEventsForPeer:(id)a0 eventHandler:(id /* block */)a1 error:(out id *)a2;
...
- (char)stopMonitoringFaultEventsForPeer:(id)a0 error:(out id *)a1;
- (void)stopPeerDiscoveryWithUUID:(id)a0;
- (char)submitFaultEvent:(id)a0 error:(out id *)a1;
- (char)unregisterRemoteDiagnosticEventsForPeer:(id)a0 configuration:(id)a1 error:(out id *)a2;
