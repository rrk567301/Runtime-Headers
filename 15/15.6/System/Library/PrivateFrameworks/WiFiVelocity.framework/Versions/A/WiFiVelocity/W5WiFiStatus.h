@class W5WiFiScanResult, NSString, NSArray, NSData, W5WiFiChannel, W5WiFiPreferredNetwork;
...
@property (nonatomic) char smartCCADesenseUSBPresence;
@property (nonatomic) char isSnifferSupported;
...
- (char)isEqualToWiFiStatus:(id)a0;
