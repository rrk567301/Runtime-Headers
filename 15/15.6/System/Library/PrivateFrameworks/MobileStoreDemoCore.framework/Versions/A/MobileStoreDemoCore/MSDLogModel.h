...
- (char)enableLogToFile:(id)a0;
- (char)enableLogToFilesUnder:(id)a0 prefix:(id)a1 expireDays:(long long)a2;
- (id)fileNameForTodayUnder:(id)a0 prefix:(id)a1;
- (void)logWithFormat:(id)a0 andArgs:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
