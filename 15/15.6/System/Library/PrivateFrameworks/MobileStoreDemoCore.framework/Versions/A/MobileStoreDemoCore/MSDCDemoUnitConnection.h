...
- (char)trustDAServer:(struct __SecTrust { } *)a0;
- (char)validateAccountsArrayFromDU:(id)a0;
- (char)validateUserEnteredPassword:(id)a0 getRetryCount:(unsigned long long *)a1 forDeviceID:(id)a2;
