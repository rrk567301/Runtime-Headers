...
@property (nonatomic) char requiresParticipants;
...
- (void)_performWithAddParticipantsAllowed:(char)a0;
...
- (id)initWithCollaborationItem:(id)a0 activityType:(id)a1 requiresParticipants:(char)a2 deviceScreenScale:(double)a3;
