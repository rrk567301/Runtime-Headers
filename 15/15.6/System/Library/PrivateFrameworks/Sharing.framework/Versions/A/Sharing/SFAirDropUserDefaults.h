...
@interface SFAirDropUserDefaults : NSObject {
    ...
    void /* unknown type, empty encoding */ _boopToCollaborateEnabled;
    ...
    void /* unknown type, empty encoding */ _helloFeatureFlagsEnabled;
    ...
    void /* unknown type, empty encoding */ _verboseWalkAway;
    void /* unknown type, empty encoding */ _nearFieldSharingEnabled;
    void /* unknown type, empty encoding */ _cellularUsageEnabled;
...
@property (nonatomic, readonly) char objcPrivateContactDiscoveryEnabled;
@property (nonatomic, readonly) char objcSystemLevelProgressEnabled;
@property (nonatomic, readonly) char objcMoveToAppEnabled;
@property (nonatomic, readonly) char objcAskToAirDropEnabled;
@property (nonatomic) char objcNearFieldSharingEnabled;
@property (nonatomic) char objcCellularUsageEnabled;
