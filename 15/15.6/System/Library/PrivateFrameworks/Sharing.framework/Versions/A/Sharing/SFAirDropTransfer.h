...
@property (nonatomic) char willOpenInMRQL;
@property (copy, nonatomic) NSArray *completedURLs;
@property (readonly, nonatomic) char isJustFiles;
...
- (void)setUpProgress;
- (void)setUpProgressToBroadcast:(char)a0;
- (char)updateUsingCoder:(id)a0;
- (void)updateWithInformation:(id)a0;
- (char)updateWithTransfer:(id)a0;
