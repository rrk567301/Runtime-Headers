@class NSUUID, SFCollaborationCloudSharingResult, NSArray, SFPendingCollaboration, NSItemProvider, NSString, SFCollaborationMetadata, NSError, LPLinkMetadata, _SWCollaborationShareOptions, NSNumber;

@interface _SFSWYCollaborationItem : SFCollaborationItem <SFCollaborationSWYItem>

@property (nonatomic) char isURLProviderSupported;
...
- (id)initWithItemProvider:(id)a0 activityItem:(id)a1 isURLProviderSupported:(char)a2;
