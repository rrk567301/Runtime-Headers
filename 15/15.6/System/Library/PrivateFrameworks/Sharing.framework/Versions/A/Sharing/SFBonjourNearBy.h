...
@interface SFBonjourNearBy : NSObject {
    ...
    char _shouldRestartBrowsing;
    char _shouldRestartAdvertising;
    char _isStopAdvertisingInProgress;
    char _isStopBrowsingInProgress;
...
- (id)_handleConnection:(id)a0 isAdvToBrowserConnection:(char)a1;
- (void)_reportCachedDiscoveryResults;
- (void)_sendAdvMessageWithData:(id)a0 isStart:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)isLocalEndpoint:(id)a0;
- (id)randomUUID;
- (void)restartDiscovery;
- (char)sendData:(id)a0 toDevice:(id)a1 completionHandler:(id /* block */)a2;
- (void)startAdvertisingWithData:(id)a0 completionHandler:(id /* block */)a1;
- (char)startDiscovery;
- (char)stopAdvertisingForData:(id)a0 completionHandler:(id /* block */)a1;
- (void)stopDiscovery;
