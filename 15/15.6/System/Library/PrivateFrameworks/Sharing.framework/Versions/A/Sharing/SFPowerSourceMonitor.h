...
@property (nonatomic) char skipCoalescing;
...
- (char)powerSourcesListWithOutInfo:(const void **)a0 outSources:(const struct __CFArray **)a1 outSourcesCount:(long long *)a2;
