...
@property (nonatomic) char rssiLog;
@property (nonatomic) char rssiLogStdOut;
...
- (char)_updateCounterpart:(id)a0;
- (void)_updateRescanTimer;
- (void)_updateTrackedPeers;
- (id)_useCasesToString:(id)a0;
- (char)_watchSetupParseData:(id)a0 fields:(id)a1;
...
- (char)pairingUpdatePairedInfo:(id)a0 fields:(id)a1 bleDevice:(id)a2;
- (char)pairingUpdatePairedInfoIOBT:(id)a0 fields:(id)a1 bleDevice:(id)a2;
- (char)pairingUpdatePairedInfoMB:(id)a0 fields:(id)a1 bleDevice:(id)a2;
