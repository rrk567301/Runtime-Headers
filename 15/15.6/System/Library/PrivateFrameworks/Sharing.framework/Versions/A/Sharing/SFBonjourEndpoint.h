...
@property char initiatedConnection;
...
@property (readonly) char isAdvToBrowserConnection;
...
- (void).cxx_destruct;
- (void)cancel;
- (id)_getServerRemoteUUIDFromConnectionMetadata:(id)a0 isAdvToBrowserConnection:(char)a1;
- (void)_handleUUIDHeaders;
- (void)_startConnection;
- (id)initWithConnection:(id)a0 isAdvToBrowserConnection:(char)a1 localUniqueID:(id)a2 withQueue:(id)a3;
