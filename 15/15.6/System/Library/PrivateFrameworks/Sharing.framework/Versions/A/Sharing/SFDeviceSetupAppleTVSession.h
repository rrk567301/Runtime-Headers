...
- (int)_runBasicConfig;
- (void)_homeKitUpdateiCloudSwitchState:(char)a0;
- (char)_isPreflightError:(id)a0;
- (void)_reportError:(id)a0 label:(id)a1;
- (void)_reportErrorMetrics:(id)a0 errorLabel:(id)a1 isFatal:(char)a2;
