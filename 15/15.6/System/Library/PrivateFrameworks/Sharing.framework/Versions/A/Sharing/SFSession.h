@class CUPairedPeer, NSMutableDictionary, NSMutableData, SFDevice, NSDictionary, NSObject, SFAppleIDContactInfo, CUAppleIDClient, SDStatusMonitor, CUPairingSession, NSString, TRSession, NSXPCListenerEndpoint, CUMessageSession, CUMessageSessionServer, NSXPCConnection, NSUUID;
...
@property (nonatomic) char touchRemoteEnabled;
...
- (void)sendExternalIO:(id)a0;
- (void)_activated;
- (void)_activatedIfReady:(id)a0;
- (char)_appleIDAddProof:(id)a0 error:(id *)a1;
- (id)_appleIDVerifyProof:(id)a0 error:(id *)a1;
- (void)_deregisterRequestID:(id)a0;
- (void)_fetchInfo;
- (void)_hearbeatTimer;
- (void)_pairSetup:(id)a0 start:(char)a1;
- (void)_pairSetupCompleted:(int)a0;
- (void)_pairSetupWithFlags:(unsigned int)a0 completion:(id /* block */)a1 isServer:(char)a2;
- (void)_pairVerify:(id)a0 start:(char)a1;
...
- (void)_serviceInitiatedPairSetup:(id)a0;
- (void)_sessionReceivedEncryptedData:(id)a0 type:(unsigned char)a1;
- (char)_sessionReceivedEvent:(id)a0 flags:(unsigned int)a1;
- (void)_sessionReceivedObject:(id)a0 flags:(unsigned int)a1;
- (char)_sessionReceivedRegisteredRequestID:(id)a0 flags:(unsigned int)a1 xidKey:(id)a2 xidValue:(id)a3;
- (char)_sessionReceivedRequest:(id)a0 flags:(unsigned int)a1 responseHandler:(id /* block */)a2;
...
- (void)pairSetupWithFlags:(unsigned int)a0 completion:(id /* block */)a1 isServer:(char)a2;
- (char)pairingContainsACL:(id)a0;
- (id)pairingDeriveKeyForIdentifier:(id)a0 keyLength:(unsigned long long)a1;
- (void)registerForExternalIO:(id)a0;
...
- (void)sessionReceivedFragmentData:(id)a0 last:(char)a1;
