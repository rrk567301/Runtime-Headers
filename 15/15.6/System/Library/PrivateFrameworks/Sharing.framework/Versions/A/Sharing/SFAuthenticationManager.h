...
- (char)checkDynamicStoreForType:(unsigned long long)a0;
- (void)completedAuthenticationSessionWithID:(id)a0;
- (void)completedUnlockWithDevice:(id)a0;
- (char)declinedToEnableForType:(unsigned long long)a0;
...
- (char)isSupportedForType:(unsigned long long)a0;
...
- (char)osFeatureEnabledForType:(unsigned long long)a0;
