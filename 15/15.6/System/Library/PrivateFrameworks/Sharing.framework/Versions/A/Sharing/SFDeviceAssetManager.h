...
@property (nonatomic) char useProcessLocalCache;
...
- (void)addQueryResultToLocalCache:(id)a0 url:(id)a1 isFallback:(char)a2;
- (id)cacheDirectory;
...
- (void)onqueue_findAssetBundleForAssetQuery:(id)a0 ucat:(struct LogCategory { int x0; int x1; char *x2; unsigned int x3; char *x4; char *x5; int x6; struct LogCategory *x7; struct LogOutput *x8; struct LogOutput *x9; unsigned long long x10; unsigned long long x11; unsigned int x12; unsigned int x13; char *x14; struct LogCategoryPrivate *x15; } *)a1 queryType:(id)a2 fallback:(char)a3 retryAttempt:(char)a4 withCompletionHandler:(id /* block */)a5;
