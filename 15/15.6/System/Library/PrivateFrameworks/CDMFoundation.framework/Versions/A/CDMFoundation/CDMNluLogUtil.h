...
+ (id)getLogBasePath;
+ (id)loadCdmPlannerRequestFromProtobuf2File:(id)a0 error:(id *)a1;
+ (id)loadDataFromProtobuf2File:(id)a0 error:(id *)a1;
+ (id)loadOverrideSpansFromProtobuf2File:(id)a0 error:(id *)a1;
+ (id)loadRequestFromProtobuf2File:(id)a0 error:(id *)a1;
+ (id)loadSubwordEmbeddingRequestFromProtobuf2File:(id)a0 error:(id *)a1;
+ (void)populateErrorWithUserInfo:(id *)a0 errorMessage:(id)a1 errorCode:(long long)a2;
+ (id)prettyPrintProtoResponse:(id)a0;
+ (id)prettyPrintResponse:(id)a0;
+ (char)saveCLIResult:(id)a0 protobufFile:(id)a1 preprocess:(char)a2 saveBinary:(char)a3 error:(id *)a4;
+ (char)saveCdmPlannerResponseJson:(id)a0 toFile:(id)a1 error:(id *)a2;
+ (char)savePreprocessingWrapperJson:(id)a0 toFile:(id)a1 error:(id *)a2;
+ (char)saveProtoFile:(id)a0 protobufFile:(id)a1 error:(id *)a2;
+ (char)saveResponseToProtobuf2:(id)a0 protobufFile:(id)a1 error:(id *)a2;
+ (char)saveResponseToProtobuf:(id)a0 protobufFile:(id)a1 error:(id *)a2;
+ (char)saveSpanMatchResponseToProtobuf:(id)a0 protobufFile:(id)a1 error:(id *)a2;
+ (char)saveString:(id)a0 toFile:(id)a1 error:(id *)a2;
+ (char)saveSubwordEmbeddingResponseJson:(id)a0 toFile:(id)a1 error:(id *)a2;
