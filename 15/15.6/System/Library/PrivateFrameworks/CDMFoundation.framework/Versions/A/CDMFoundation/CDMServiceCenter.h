...
- (char)handleXPCActivity:(id)a0 fromIdentifier:(id)a1 withRegister:(id)a2;
- (char)handleXPCEvent:(id)a0 fromStream:(id)a1 withRegister:(id)a2;
- (char)isServiceNotReady:(id)a0 withServiceStateMap:(id)a1;
