...
+ (char)areFactorsValid:(id)a0 inKnownFactors:(id)a1;
...
+ (char)isNLAssetValid:(id)a0 forLocale:(id)a1;
+ (char)isNLAssetValid:(id)a0 forLocale:(id)a1 withFolders:(id)a2 useFileManager:(id)a3 withAssetAvailabilityType:(long long)a4;
+ (id)loadAssetMetadataFromAsset:(id)a0;
+ (char)registerWithAssetsDelegate:(id)a0 withCDMAssetsInfo:(id)a1 withType:(long long)a2 withLocale:(id)a3;
+ (char)registerWithAssetsDelegate:(id)a0 withType:(long long)a1 withLocale:(id)a2;
