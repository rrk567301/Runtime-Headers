...
- (char)handleXPCActivity:(id)a0 fromIdentifier:(id)a1 withAssetCollection:(id)a2 withSelfMetadata:(id)a3;
- (char)handleXPCEvent:(id)a0 fromStream:(id)a1 currentConfig:(id)a2 withSelfMetadata:(id)a3;
