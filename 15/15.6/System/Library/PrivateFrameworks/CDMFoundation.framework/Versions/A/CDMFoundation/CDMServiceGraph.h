...
+ (char)isServiceRequiredForSetup:(id)a0;
...
+ (char)shouldSkipNode:(id)a0 service:(id)a1;
...
- (id)addNodeWithName:(id)a0 aneEnabled:(char)a1 requestId:(id)a2 block:(id /* block */)a3;
- (id)addNodeWithName:(id)a0 bindService:(id)a1 aneEnabled:(char)a2 requestId:(id)a3 block:(id /* block */)a4;
