...
+ (void)enumerateTokenChain:(id)a0 useNormalizedValues:(char)a1 withCallback:(id /* block */)a2;
+ (char)isTrailingSpanAdjacent:(id)a0 secondSpan:(id)a1 tokenChain:(id)a2;
