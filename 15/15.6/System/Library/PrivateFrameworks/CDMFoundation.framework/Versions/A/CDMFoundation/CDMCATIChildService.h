...
@interface CDMCATIChildService : NSObject {
    ...
    NSString *_usoVerb;
    NSString *_usoEdge;
    char _multiturnEnabled;
    int _expectedPositiveUtterances;
    char _invocationWeightsEnabled;
    char _invocationOverridesEnabled;
    char _multiturnWeightsEnabled;
    char _isLegacyCATIOverrideSystem;
    char _isFlatbuffersCATIOverrideSystem;
}
...
- (char)checkFBBloomFilter:(id)a0 contains:(id)a1;
...
- (char)getInvocationOverridesEnabled;
...
- (char)isMultiTurnEnabled;
- (id)runCATIModelInferenceWithWeights:(id)a0;
- (void)setInvocationWeightsEnabled:(char)a0;
- (void)setMultiturnConfidenceThreshold:(float)a0;
- (void)setMultiturnEnabled:(char)a0;
- (void)setMultiturnWeightsEnabled:(char)a0;
- (void)setUsoEdge:(id)a0;
- (void)setUsoEntity:(id)a0;
- (id)setup:(id)a0 assetVersion:(long long)a1;
- (char)shouldSuppressCATIInvocationDueTo:(id)a0;
