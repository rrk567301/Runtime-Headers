...
@protocol OS_dispatch_queue, NLAsset;
...
+ (void)handleFetchVoiceShortcutsTimeout:(double)a0 transactionPtr:(id *)a1;
...
- (char)executeMatcherRequestBlockWithTimeout:(id /* block */)a0;
