...
+ (char)isSamePosition:(id)a0 spanB:(id)a1 asrMapA:(id)a2 asrMapB:(id)a3 cdmTokenChainA:(id)a4 cdmTokenChainB:(id)a5;
+ (char)isSpanOnlyForExternalParsers:(id)a0;
+ (char)matcherNameIsSupportedForAsrAlternative:(id)a0;
