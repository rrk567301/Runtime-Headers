...
- (id)setup:(id)a0;
- (id)handle:(id)a0;
- (char)shouldSpanComboProduceParse:(id)a0 prefixSpans:(id)a1 suffixSpans:(id)a2 tokenChain:(id)a3;
...
- (char)hasAutoShortcutIdentifier:(id)a0;
- (char)isPhrase:(id)a0 inDenyList:(id)a1;
