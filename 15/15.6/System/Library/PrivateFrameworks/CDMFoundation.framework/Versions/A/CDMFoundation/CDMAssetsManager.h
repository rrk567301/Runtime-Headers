...
- (char)areAssetsAvailableForCDMAssetsInfo:(id)a0 factorToAsset:(id)a1 withError:(id *)a2;
- (char)areAssetsAvailableForCDMAssetsInfo:(id)a0 factorToAsset:(id)a1 withError:(id *)a2 withSelfMetadata:(id)a3 withSelfContextId:(id)a4 withDataDispatcherContext:(id)a5;
...
- (id)getNSFileManager;
- (char)isAssetAvailableForCDMAssetsFactorConfig:(id)a0 factorToAsset:(id)a1 withError:(id *)a2;
...
- (char)registerForCDMAssetsInfo:(id)a0 withLocale:(id)a1 withAssetsDelegate:(id)a2 selfContextId:(id)a3 selfMetadata:(id)a4 dataDispatcherContext:(id)a5 withAssetAvailabilityType:(long long)a6 withError:(id *)a7;
- (void)setupForLocale:(id)a0 cdmAssetsInfo:(id)a1 error:(id *)a2;
- (char)shouldReSetupForLocale:(id)a0 cdmAssetsInfo:(id)a1;
