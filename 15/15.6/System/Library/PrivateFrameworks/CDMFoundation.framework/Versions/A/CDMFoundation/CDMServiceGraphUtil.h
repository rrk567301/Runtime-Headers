...
+ (id)mergeDateTimeSpans:(id)a0 regexSpans:(id)a1 siriVocabularySpans:(id)a2 vocSpans:(id)a3;
...
+ (id)runCcqrService:(id)a0 nluRequest:(id)a1 tokenResponse:(id)a2 previousTurnTokenizationResponseCommand:(id)a3 rdResponse:(id)a4 requestLink:(id)a5 locale:(id)a6;
+ (char)runUaaPNLProtoService:(id)a0 requestId:(id)a1 utterance:(id)a2 locale:(id)a3 tokenChain:(id)a4 matchingSpans:(id)a5 embeddingTensor:(id)a6 currentTurn:(id)a7 outUaapProtoRequest:(id *)a8 outUaapProtoResponse:(id *)a9 outError:(id *)a10;
+ (char)spanHasMatcherName:(int)a0 matchingSpan:(id)a1;
