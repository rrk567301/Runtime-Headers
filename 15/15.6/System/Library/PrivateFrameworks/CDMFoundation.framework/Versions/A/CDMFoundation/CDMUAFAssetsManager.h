...
+ (char)validateFactors:(id)a0 inAssetSet:(id)a1 forLocale:(id)a2 withAssetSetName:(id)a3;

- (void).cxx_destruct;
- (id)initManager;
- (char)registerForCDMAssetsInfo:(id)a0 withLocale:(id)a1 withAssetsDelegate:(id)a2 useFileManager:(id)a3 withSelfContextId:(id)a4 withSelfMetadata:(id)a5 withDataDispatcherContext:(id)a6 withAssetAvailabilityType:(long long)a7 withError:(id *)a8;
