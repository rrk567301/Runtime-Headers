...
@property (nonatomic) char IsAllDayEventSpecified;
...
@property (nonatomic) char IsMeetingSpecified;
@property (nonatomic) char IsCancelled;
@property (nonatomic) char IsCancelledSpecified;
...
@property (nonatomic) char MeetingRequestWasSentSpecified;
...
@property (nonatomic) char ConflictingMeetingCountSpecified;
@property (nonatomic) long long AdjacentMeetingCount;
@property (nonatomic) char AdjacentMeetingCountSpecified;
...
@property (nonatomic) char AppointmentSequenceNumberSpecified;
@property (nonatomic) long long AppointmentState;
@property (nonatomic) char AppointmentStateSpecified;
...
@property (nonatomic) char ConferenceTypeSpecified;
@property (nonatomic) char AllowNewTimeProposal;
@property (nonatomic) char AllowNewTimeProposalSpecified;
@property (nonatomic) char IsOnlineMeeting;
@property (nonatomic) char IsOnlineMeetingSpecified;
...
@property (nonatomic) char IsAssociatedSpecified;
