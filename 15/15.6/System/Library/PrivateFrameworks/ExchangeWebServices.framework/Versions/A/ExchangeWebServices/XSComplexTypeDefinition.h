...
- (void)addElementWithName:(id)a0 namespaceURI:(id)a1 type:(Class)a2 maxOccurs:(unsigned long long)a3 minOccurs:(unsigned long long)a4 flattenMultiValue:(char)a5;
