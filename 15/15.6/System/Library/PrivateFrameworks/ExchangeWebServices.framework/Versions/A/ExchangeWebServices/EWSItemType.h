...
@property (nonatomic) char IsSubmittedSpecified;
@property (nonatomic) char IsDraft;
@property (nonatomic) char IsDraftSpecified;
@property (nonatomic) char IsFromMe;
@property (nonatomic) char IsFromMeSpecified;
@property (nonatomic) char IsResend;
@property (nonatomic) char IsResendSpecified;
@property (nonatomic) char IsUnmodified;
@property (nonatomic) char IsUnmodifiedSpecified;
...
@property (nonatomic) char ReminderIsSetSpecified;
@property (nonatomic) long long ReminderMinutesBeforeStart;
@property (nonatomic) char ReminderMinutesBeforeStartSpecified;
