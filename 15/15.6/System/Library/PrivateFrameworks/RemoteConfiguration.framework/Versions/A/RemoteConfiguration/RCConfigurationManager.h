...
- (char)_areAllConfigurationResourcesAvailable:(id)a0 requestKeys:(id)a1;
- (char)_areAllConfigurationResourcesInvalid:(id)a0 allowedToReachEndpoint:(char)a1 configurationSettings:(id)a2 requestKeys:(id)a3;
...
- (char)_isAllowedToReachEndpointWithSettings:(id)a0 configurationResource:(id)a1 endpointURL:(id)a2;
- (char)_isValidConfigurationResource:(id)a0 allowedToReachEndpoint:(char)a1 useBackgroundRefreshRate:(char)a2 userID:(id)a3 storefrontID:(id)a4 cachePolicy:(id)a5;
