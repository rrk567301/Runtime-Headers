...
@property (nonatomic) char internalUseBackgroundRefreshRate;
...
@property (nonatomic) char useBackgroundRefreshRate;
...
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6;
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6 backgroundFetchConfiguration:(id)a7 requestMode:(unsigned long long)a8 endpointConfig:(id)a9 endpointTimeoutDuration:(double)a10 fallbackTimeoutDuration:(double)a11;
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6 backgroundFetchConfiguration:(id)a7 requestMode:(unsigned long long)a8 endpointTimeoutDuration:(double)a9 fallbackTimeoutDuration:(double)a10;
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6 requestMode:(unsigned long long)a7;
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6 requestMode:(unsigned long long)a7 endpointTimeoutDuration:(double)a8;
- (id)initWithRequestInfos:(id)a0 userID:(id)a1 storefrontID:(id)a2 bundleID:(id)a3 deviceInfo:(id)a4 debugOverrides:(id)a5 useBackgroundRefreshRate:(char)a6 requestMode:(unsigned long long)a7 endpointTimeoutDuration:(double)a8 fallbackTimeoutDuration:(double)a9;
...
- (id)initWithRequestKey:(id)a0 responseKey:(id)a1 fallbackURL:(id)a2 userID:(id)a3 storefrontID:(id)a4 bundleID:(id)a5 deviceInfo:(id)a6 debugOverrides:(id)a7 useBackgroundRefreshRate:(char)a8;
- (id)initWithRequestKey:(id)a0 responseKey:(id)a1 fallbackURL:(id)a2 userID:(id)a3 storefrontID:(id)a4 bundleID:(id)a5 deviceInfo:(id)a6 debugOverrides:(id)a7 useBackgroundRefreshRate:(char)a8 backgroundFetchConfiguration:(id)a9 requestMode:(unsigned long long)a10 endpointConfig:(id)a11 endpointTimeoutDuration:(double)a12 fallbackTimeoutDuration:(double)a13;
- (id)initWithRequestKey:(id)a0 responseKey:(id)a1 fallbackURL:(id)a2 userID:(id)a3 storefrontID:(id)a4 bundleID:(id)a5 deviceInfo:(id)a6 debugOverrides:(id)a7 useBackgroundRefreshRate:(char)a8 backgroundFetchConfiguration:(id)a9 requestMode:(unsigned long long)a10 endpointTimeoutDuration:(double)a11 fallbackTimeoutDuration:(double)a12;
- (id)initWithRequestKey:(id)a0 responseKey:(id)a1 fallbackURL:(id)a2 userID:(id)a3 storefrontID:(id)a4 bundleID:(id)a5 deviceInfo:(id)a6 debugOverrides:(id)a7 useBackgroundRefreshRate:(char)a8 requestMode:(unsigned long long)a9 endpointTimeoutDuration:(double)a10;
