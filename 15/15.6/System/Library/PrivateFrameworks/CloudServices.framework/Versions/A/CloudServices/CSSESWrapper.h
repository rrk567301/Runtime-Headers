...
@property (readonly) char useAppleIDPassword;
...
- (id)initWithDSID:(id)a0 escrowRecordContents:(id)a1 recoveryPassphrase:(id)a2 recordID:(id)a3 recordLabel:(id)a4 useAppleIDPassword:(char)a5 appleIDPasswordMetadata:(id)a6 reqVersion:(int)a7;
- (id)initWithRequest:(id)a0 reqVersion:(int)a1;
- (id)initWithRequest:(id)a0 validate:(char)a1 reqVersion:(int)a2;
...
- (char)validatePassphrasePresentOrPending;
