@class NSData, NSString, NSDate, NSError, CSSESWrapper, NSUUID, NSDictionary, AppleIDPasswordMetadata, NSObject, NSNumber, EscrowPrerecord;
...
@property (nonatomic) char deleteAll;
...
@property (nonatomic) char emcsMode;
...
@property (nonatomic) char excludeiCDPRecords;
...
@property (nonatomic) char silent;
@property (copy, nonatomic) NSNumber *specifiedFederation;
@property (nonatomic) char stingray;
@property (nonatomic) char synchronize;
@property (nonatomic) char useCachedPassphrase;
@property (nonatomic) char useRecoveryPET;
@property (nonatomic) char usesMultipleiCSC;
@property (nonatomic) char usesRandomPassphrase;
@property (nonatomic) char usesRecoveryKey;
...
@property (nonatomic) char suppressServerFiltering;
@property (nonatomic) char deleteDoubleOnly;
@property (nonatomic) char nonViableRepair;
@property (nonatomic) char sosCompatibleEscrowSorting;
...
@property (nonatomic) char silentDoubleRecovery;
...
- (id)recoverSilentWithCDPContext:(id)a0 allRecords:(id)a1 altDSID:(id)a2 flowID:(id)a3 deviceSessionID:(id)a4 error:(id *)a5;
- (id)recoverWithCDPContext:(id)a0 escrowRecord:(id)a1 altDSID:(id)a2 flowID:(id)a3 deviceSessionID:(id)a4 error:(id *)a5;
- (BOOL)removeRecoveryKeyFromBackup:(id *)a0;
- (void)restoreKeychainAsyncWithPassword:(id)a0 keybagDigest:(id)a1 haveBottledPeer:(char)a2 viewsNotToBeRestored:(id)a3 error:(id *)a4;
...
- (void)fetchStingrayAccountStatus:(id /* block */)a0;
