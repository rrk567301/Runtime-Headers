@class _LTTranslationParagraph, FTMutableBatchTranslationRequest, _LTBatchedParagraphsHolder, NSString, NSLocale, NSURL, NSUUID;
...
@property (nonatomic) char hasFinalServerResponse;
@property (nonatomic) char completionHandlerCalled;
