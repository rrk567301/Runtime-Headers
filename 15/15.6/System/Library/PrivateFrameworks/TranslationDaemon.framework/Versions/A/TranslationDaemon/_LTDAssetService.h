...
@property (class, nonatomic) char needsCatalogRefresh;
...
+ (char)_isCatalogRefreshWaitExpired;
+ (char)_isObsoleteCatalogType:(id)a0;
...
+ (void)assetsForLocales:(id)a0 includeTTS:(char)a1 completion:(id /* block */)a2;
+ (id)assetsForLocales:(id)a0 includeTTS:(char)a1 error:(id *)a2;
...
+ (char)preflightCheckForLocalePair:(id)a0 withModelURLs:(id)a1;
