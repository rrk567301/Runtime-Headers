...
@property (class, readonly) char onDeviceModeSupported;
...
+ (void)setInstalledLocales:(id)a0 useCellular:(char)a1 progress:(id /* block */)a2 completion:(id /* block */)a3;
+ (void)startLanguageStatusSession:(id)a0 observationType:(unsigned long long)a1 progress:(char)a2 observations:(id /* block */)a3 completion:(id /* block */)a4;
