...
- (id)initWithFlatbuffData:(id)a0 root:(const struct GraphemeToPhonemeResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
...
- (void)aot_token_prons_enumerateObjectsUsingBlock:(id /* block */)a0;
- (id)aot_token_prons_objectAtIndex:(unsigned long long)a0;
- (unsigned long long)jit_token_prons_count;
- (void)jit_token_prons_enumerateObjectsUsingBlock:(id /* block */)a0;
- (id)jit_token_prons_objectAtIndex:(unsigned long long)a0;
