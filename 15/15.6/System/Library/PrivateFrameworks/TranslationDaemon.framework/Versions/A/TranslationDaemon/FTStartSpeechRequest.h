...
- (id)initWithFlatbuffData:(id)a0 root:(const struct StartSpeechRequest { unsigned char x0[1]; } *)a1 verify:(char)a2;
- (unsigned long long)multi_user_parameters_count;
- (void)multi_user_parameters_enumerateObjectsUsingBlock:(id /* block */)a0;
- (id)multi_user_parameters_objectAtIndex:(unsigned long long)a0;
