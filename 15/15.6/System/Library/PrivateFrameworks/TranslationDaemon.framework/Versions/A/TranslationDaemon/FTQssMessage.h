@class FTDisableSessionLog, FTBlazarMultilingualMessage, FTApgPronGuessMessage, FTAsrTextNormalizationMessage, FTBlazarBatchTranslationMessage, FTNlShortcutFuzzyMatchMessage, FTBlazarMultiUserMessage, FTBlazarTextToSpeechRouterMessage, FTAsrRecognitionMessage, FTAsrGraphemeToPhonemeMessage, FTTtsTextToSpeechStreamingMessage, FTAsrCorrectionsValidatorMessage, FTAsrErrorBlamerMessage, NSMutableDictionary, FTLmtLmScorerMessage, FTErrorMessage, NSObject, NSData, FTBlazarSpeechTranslationMessage, FTTtsTextToSpeechMessage, FTTtsTextToSpeechSpeechFeatureMessage, FTSlsLanguageDetectionMessage, FTNapgCreateLanguageProfileMessage, FTAsrPostItnHammerMessage, FTAsrItnMessage, FTBlazarServiceDiscoveryMessage, FTMtTranslationMessage, FTBlazarTextToSpeechRouterStreamingMessage, FTAsrKeywordFinderMessage;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct QssMessage { unsigned char x0[1]; } *)a1 verify:(char)a2;
