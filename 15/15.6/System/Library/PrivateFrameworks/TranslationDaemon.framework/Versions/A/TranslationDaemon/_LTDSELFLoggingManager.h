...
- (void)invocationTranslationTTSPlayedWithInvocationId:(id)a0 sourceOrTargetLanguage:(long long)a1 isAutoplayTranslation:(char)a2 ttsPlaybackSpeed:(long long)a3 audioChannel:(long long)a4;
