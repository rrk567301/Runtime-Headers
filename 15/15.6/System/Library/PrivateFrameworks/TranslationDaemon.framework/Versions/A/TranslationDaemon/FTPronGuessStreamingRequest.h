@class NSData, NSMutableDictionary, FTCancelRequest, FTFinishAudio, FTAudioPacket, NSObject, FTStartPronGuessRequest;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct PronGuessStreamingRequest { unsigned char x0[1]; } *)a1 verify:(char)a2;
