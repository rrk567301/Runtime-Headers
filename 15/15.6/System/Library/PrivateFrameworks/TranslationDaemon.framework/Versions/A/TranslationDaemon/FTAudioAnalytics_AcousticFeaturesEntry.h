@class NSString, NSMutableDictionary, NSData, FTAcousticFeature;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct AcousticFeaturesEntry { unsigned char x0[1]; } *)a1 verify:(char)a2;
