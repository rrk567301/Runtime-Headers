@class NSString, NSArray, NSData, FTTextToSpeechFeature, NSMutableDictionary;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct PartialTextToSpeechStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
