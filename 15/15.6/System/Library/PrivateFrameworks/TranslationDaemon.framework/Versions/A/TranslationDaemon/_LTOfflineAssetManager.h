...
- (void)_downloadPassthroughAssetForLocale:(id)a0 userInitiated:(char)a1 completion:(id /* block */)a2;
...
- (void)downloadAssetsForLanguagePair:(id)a0 userInitiated:(char)a1 completion:(id /* block */)a2;
...
- (void)purgeAllAssetsExcludingConfig:(char)a0 completion:(id /* block */)a1;
- (void)purgeAssetForLanguagePair:(id)a0 userInitiated:(char)a1 completion:(id /* block */)a2;
