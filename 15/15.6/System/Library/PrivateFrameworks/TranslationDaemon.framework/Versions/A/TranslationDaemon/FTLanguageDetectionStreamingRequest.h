@class NSData, NSMutableDictionary, FTStartLanguageDetectionRequest, FTAudioPacket, FTFinishAudio, NSObject;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct LanguageDetectionStreamingRequest { unsigned char x0[1]; } *)a1 verify:(char)a2;
