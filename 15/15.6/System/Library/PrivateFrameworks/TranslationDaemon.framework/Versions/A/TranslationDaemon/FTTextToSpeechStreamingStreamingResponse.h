@class FTQssAckResponse, FTPartialTextToSpeechStreamingResponse, NSMutableDictionary, FTBeginTextToSpeechStreamingResponse, NSData, FTFinalTextToSpeechStreamingResponse, NSObject;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct TextToSpeechStreamingStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
