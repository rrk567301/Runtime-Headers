@class NSMutableDictionary, FTLanguageDetectionResponse, NSData, NSObject;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct LanguageDetectionStreamingResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
