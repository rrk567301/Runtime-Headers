@class FTTextToSpeechResponse, NSString, NSMutableDictionary, NSData;
...
- (id)initWithFlatbuffData:(id)a0 root:(const struct SpeechTranslationTextToSpeechResponse { unsigned char x0[1]; } *)a1 verify:(char)a2;
