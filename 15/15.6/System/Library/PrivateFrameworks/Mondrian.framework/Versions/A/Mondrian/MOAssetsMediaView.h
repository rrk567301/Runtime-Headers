...
- (char)collectionView:(id)a0 layout:(id)a1 shouldShowFooterAtIndexPath:(id)a2;
- (char)collectionView:(id)a0 layout:(id)a1 shouldShowHeaderAtIndexPath:(id)a2;
...
- (char)shouldShowMainFooterForCollectionView:(id)a0 layout:(id)a1 includingWhenInBounds:(char *)a2;
- (char)shouldShowMainHeaderForCollectionView:(id)a0 layout:(id)a1;
