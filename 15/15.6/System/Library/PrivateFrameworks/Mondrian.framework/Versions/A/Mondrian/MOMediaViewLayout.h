...
@property char showHeaders;
@property char showFooters;
@property char enableStickiness;

- (id)init;
- (void).cxx_destruct;
- (char)validateValue:(id *)a0 forKeyPath:(id)a1 error:(id *)a2;
...
- (id)_debuggingLayoutOptionsPresetFileNamesAllowingCreation:(char)a0;
- (id)_debuggingLayoutOptionsPresetFilePathsAllowingCreation:(char)a0;
...
- (id)_debuggingLayoutOptionsPresetsPathAllowingCreation:(char)a0;
- (char)_debuggingLayoutOptionsUserAllowsDeletingPresetAtPath:(id)a0;
