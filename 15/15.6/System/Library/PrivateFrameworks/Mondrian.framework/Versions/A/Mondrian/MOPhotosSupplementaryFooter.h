...
@property (nonatomic) char highlightInformation;
@property (copy, nonatomic) id /* block */ action;
@property (nonatomic) double progress;
@property (nonatomic) char progressDisabled;
...
- (char)isOpaque;
- (id)_newTextField;
- (char)_isAttributedStringA:(id)a0 equalToAttributedStringB:(id)a1;
- (id)_newCenteringStackView;
- (id)_newInformationTextView;
- (id)_newProgressIndicator;
- (id)_newSubtitleTextView;
- (void)_updateTextViewConfiguration:(id)a0 highlighted:(char)a1;
