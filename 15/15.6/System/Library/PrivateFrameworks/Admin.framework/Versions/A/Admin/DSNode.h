...
+ (char)nodeIsDefaultLocalNode:(unsigned int)a0;
...
- (int)_authenticateNodeWithName:(id)a0 password:(id)a1 oldPassword:(id)a2 data:(id)a3 method:(const char *)a4 doAuthentication:(char)a5;
...
- (char)setHashedPassword:(id)a0 forUser:(id)a1;
- (long long)setPassword:(id)a0 oldPassword:(id)a1 forUser:(id)a2;
- (long long)setPasswordAsRoot:(id)a0 forUser:(id)a1;
- (char)setPasswordScheme:(const char *)a0 forUser:(id)a1 password:(id)a2;
