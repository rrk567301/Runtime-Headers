...
- (id)analyzeFeatures:(id)a0 messageUnit:(id)a1 checkPolarity:(char)a2 polarity:(unsigned long long)a3;
...
- (char)dataFeatures:(id)a0 containDateOlderThan:(id)a1 preciseTimeOnly:(char)a2;
- (id)dataFeaturesInTheFutureFromDataFeatures:(id)a0 messageUnitSentDate:(id)a1;
- (id)decoratedTitle:(id)a0 withSubtitles:(id)a1;
- (id)decoratedTitleFromEventType:(id)a0 title:(id)a1 sender:(id)a2 recipients:(id)a3 isSent:(char)a4 isTitleSenderDecorated:(char *)a5;
...
- (char)isDateAroundNoon:(id)a0;
- (char)isDateRoundedTo5Minutes:(id)a0;
- (char)isEventProposalOrConfirmationFromFeatures:(id)a0 fromFeatureAtIndex:(unsigned long long)a1 messageUnit:(id)a2 eventIsTenseDependent:(char)a3 extractedFromSubject:(char)a4 extractedPolarity:(unsigned long long *)a5 polarityInfluencedByIpsosPlistRef:(char *)a6;
...
- (void)scanEventsInMessageUnits:(id)a0 synchronously:(char)a1 completionHandler:(id /* block */)a2;
