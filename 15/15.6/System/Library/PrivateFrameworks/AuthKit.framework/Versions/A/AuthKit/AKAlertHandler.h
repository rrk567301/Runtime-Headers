...
- (char)_shouldShowAlertForManagedAccount:(id)a0 error:(id)a1;
...
- (char)showAlert:(id)a0 primaryAction:(id /* block */)a1 altAction:(id /* block */)a2;
- (char)showAlert:(id)a0 primaryAction:(id /* block */)a1 altAction:(id /* block */)a2 cancelAction:(id /* block */)a3;
