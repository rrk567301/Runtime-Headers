...
+ (id)sharedController;
+ (char)_matchURLProcessingSet:(id)a0 url:(id)a1;
+ (unsigned long long)appSSORequestTypeForURL:(id)a0;
+ (id)appleOwnedDomains;
+ (char)canPerformAuthorization;
+ (char)isURLFromAppleOwnedDomain:(id)a0;
+ (char)shouldProcessURL:(id)a0;
...
- (char)_shouldOverrideProxiedBundleIDForContext:(id)a0;
