...
- (id)_urlBagFromCache:(char)a0 altDSID:(id)a1 withError:(id *)a2;
...
- (char)deleteAuthorizationDatabaseWithAltDSID:(id)a0 error:(id *)a1;
...
- (char)isDevicePasscodeProtected:(id *)a0;
...
- (char)performEdpCompleteKeyDropWithAltDSID:(id)a0 error:(id *)a1;
- (char)performEdpMigrationWithAltDSID:(id)a0 error:(id *)a1;
- (void)performPasswordResetWithContext:(id)a0 completion:(id /* block */)a1;
- (char)performRemoveEdpTokenWithAltDSID:(id)a0 error:(id *)a1;
...
- (char)revokeAuthorizationForApplicationWithClientID:(id)a0 error:(id *)a1;
- (void)setAppleIDWithAltDSID:(id)a0 inUse:(char)a1 forService:(long long)a2;
- (void)setAppleIDWithDSID:(id)a0 inUse:(char)a1 forService:(long long)a2;
- (void)setConfigurationInfo:(id)a0 forIdentifier:(id)a1 forAltDSID:(id)a2 completion:(id /* block */)a3;
- (char)shieldSignInOrCreateFlowsWithError:(id *)a0;
- (void)synchronizeFollowUpItemsForContext:(id)a0 completion:(id /* block */)a1;
- (char)synchronizeFollowUpItemsForContext:(id)a0 error:(id *)a1;
