...
- (id)init;
- (void).cxx_destruct;
- (id)_accountCreationRequestBodyFromResponseDictionary:(id)a0 shouldIncludePhoneNumber:(char)a1 shouldIncludeForSecurityCode:(char)a2;
...
- (id)_promptForVerificationCodeWithSecureEntry:(char)a0 forTrustedNumber:(id)a1;
...
- (void)setNeedsNewAppleID:(char)a0;
