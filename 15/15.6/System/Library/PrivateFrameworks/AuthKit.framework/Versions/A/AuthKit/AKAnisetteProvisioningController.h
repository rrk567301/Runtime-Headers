...
- (id)_fetchAnisetteDataAndProvisionIfNecessary:(char)a0 error:(id *)a1;
- (void)_fetchAnisetteDataAndProvisionIfNecessary:(char)a0 withCompletion:(id /* block */)a1;
...
- (id)fetchAnisetteDataAndProvisionIfNecessary:(char)a0 error:(id *)a1;
