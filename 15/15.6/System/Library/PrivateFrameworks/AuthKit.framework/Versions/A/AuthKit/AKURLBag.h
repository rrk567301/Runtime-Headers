...
@property (readonly, nonatomic) char isPasskeyCleanupDisabled;
@property (readonly, nonatomic) char isFirstPartyURLEntitlementCheckDisabled;
@property (readonly, nonatomic) char isTokenCacheDisabled;
@property (readonly, nonatomic) char isMIDDriftTTRDisabled;
...
@property (readonly, nonatomic, getter=isPhoneNumberSupportedConfig) char phoneNumberSupportedConfig;
@property (readonly, nonatomic, getter=IsInlineFlowSupportedConfig) char inlineFlowSupportedConfig;
@property (readonly, nonatomic, getter=isBackgroundiCloudSignInEnabled) char backgroundiCloudSignInEnabled;
@property (readonly, nonatomic, getter=isSettingsInlineLogoViewDisabled) char settingsInlineLogoViewDisabled;
@property (readonly, nonatomic, getter=isEasyStudentSignInDisabled) char easyStudentSignInDisabled;
...
@property (readonly, nonatomic) char disablePSCreateAndForgetLink;
...
@property (readonly, nonatomic) char isTrustedDeviceListHashDisabled;
@property (readonly, nonatomic) char isClientBackoffDisabled;
@property (readonly, nonatomic) char isDeviceBAADisabled;
@property (readonly, nonatomic) char isVMBAADisabled;
@property (readonly, nonatomic) char isIDSBAADisabled;
...
+ (char)looksLikeiForgotURLKey:(id)a0;
+ (id)sharedBag;

- (void).cxx_destruct;
- (id)initWithAltDSID:(id)a0;
- (void)urlForKey:(id)a0 fromCache:(char)a1 completion:(id /* block */)a2;
- (id)_configurationsFromCache:(char)a0 withError:(id *)a1;
- (void)_fetchURLBagFromCache:(char)a0 withCompletion:(id /* block */)a1;
- (id)_requestEnvironmentsWithError:(id *)a0;
- (id)_requestNewURLBagIfNecessaryWithError:(id *)a0;
- (id)_urlAtKey:(id)a0;
- (id)_urlAtKey:(id)a0 fromURLBag:(id)a1;
- (id)_urlBagFromCache:(char)a0 withError:(id *)a1;
- (id)configurationAtKey:(id)a0;
- (id)configurationAtKey:(id)a0 fromCache:(char)a1;
- (void)configurationValueForKey:(id)a0 completion:(id /* block */)a1;
- (void)configurationValueForKey:(id)a0 fromCache:(char)a1 completion:(id /* block */)a2;
...
- (char)isBaaEnabledForKey:(id)a0;
- (void)requestNewURLBagIfNecessaryWithCompletion:(id /* block */)a0;
- (char)requestNewURLBagIfNecessaryWithError:(id *)a0;
