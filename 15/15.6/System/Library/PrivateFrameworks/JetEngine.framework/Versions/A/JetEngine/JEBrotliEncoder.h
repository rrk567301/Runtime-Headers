...
- (void)dealloc;
- (id)init;
- (char)compressStreamWithOperation:(long long)a0 availableIn:(unsigned long long *)a1 nextIn:(const char **)a2 availableOut:(unsigned long long *)a3 nextOut:(char **)a4;
