...
@property (readonly, nonatomic) char updatable;
...
- (id)initWithSpecification:(const void *)a0 isUpdatable:(char)a1 modelParameters:(id)a2 classLabelsPerFunction:(id)a3 error:(id *)a4;
