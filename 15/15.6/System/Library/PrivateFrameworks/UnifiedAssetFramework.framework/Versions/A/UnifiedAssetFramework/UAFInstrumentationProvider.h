...
+ (void)logDownloadTriggerEventWithLanguage:(id)a0 hasExistingAssets:(char)a1 retryCount:(unsigned int)a2;
+ (id)logSubscriptionsStatus;
+ (void)logUAFAssetSetDailyStatus:(id)a0 assetSetArrived:(char)a1;
