...
+ (id)defaultManager;
+ (id)_getManagerReadOnly:(char)a0;
+ (id)getSerialQueue;
+ (id)writeManager;
...
- (char)_isUsageLimitExceeded:(id)a0;
- (char)_moveDatabase;
- (id)_openDatabaseFile:(id)a0 existed:(char *)a1;
- (int)_performDbUpgrade:(int)a0;
- (char)_removeAllSubscriptions;
- (char)_removeAllSystemAssetSetUsages;
...
- (char)_subscribeSubscription:(id)a0 subscriptionName:(id)a1 assetSetSubscription:(id)a2 expires:(id)a3;
- (id)_subscriptionTime:(id)a0;
- (id)_systemAssetSetUsagesFromData:(id)a0;
- (id)_uafAssetSetSubscriptionFromData:(id)a0;
- (char)_unsubscribeSubscription:(id)a0 subscription:(id)a1;
...
- (char)clearSystemAssetSetUsages:(id)a0;
- (int)doDatabaseOperation:(id /* block */)a0 useTransaction:(char)a1 logDescription:(id)a2 error:(id *)a3;
...
- (id)getSubscriptions:(id)a0 error:(id *)a1;
- (id)getSystemAssetSetUsages:(id)a0;
- (id)getSystemConfigurationForKey:(id)a0;
- (id)initWithDbDirPath:(id)a0 dbName:(id)a1;
- (id)initWithDbDirPath:(id)a0 dbName:(id)a1 readOnly:(char)a2 allowCreate:(char)a3;
- (char)performDbUpgradeToVersion:(int)a0;
- (id)readData:(struct sqlite3_stmt { } *)a0 col:(int)a1;
- (char)removeAllSubscriptions;
- (char)removeAllSystemAssetSetUsages;
- (void)setSystemConfigurationForKey:(id)a0 withValue:(id)a1;
- (char)subscribe:(id)a0 subscriptions:(id)a1 expires:(id)a2;
- (char)unsubscribe:(id)a0 subscriptions:(id)a1;
