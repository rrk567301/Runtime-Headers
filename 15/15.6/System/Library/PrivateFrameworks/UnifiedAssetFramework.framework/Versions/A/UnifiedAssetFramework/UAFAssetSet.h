...
@property (readonly, nonatomic) char experimentationEnabled;
...
- (char)markAssetsPromoted:(id)a0 error:(id *)a1;
- (char)markAssetsProvisional:(id)a0 error:(id *)a1;
- (id)_createAssetFromTrialInfo:(id)a0 assetName:(id)a1 fallback:(char)a2 validPathOnly:(char)a3;
- (id)applyAssetTransformations:(id)a0;
- (id)applyMinVersions:(id)a0;
- (id)applyOSCompatibility:(id)a0;
- (id)assetNamed:(id)a0 withUsage:(id)a1 disableExperimentation:(char)a2;
- (id)assetSetIdForSELF:(char)a0 stagedDuringSU:(char *)a1;
- (id)createAssetFromMAAsset:(id)a0 assetName:(id)a1 experimentationEnabled:(char)a2 experimentId:(id)a3;
- (id)createAssetFromPreinstalledWithAutoAssetInfo:(id)a0 assetName:(id)a1 experimentationEnabled:(char)a2 experimentId:(id)a3;
...
- (id)initWithAssetSet:(id)a0 usages:(id)a1 configurationDirURLs:(id)a2 disableExperimentation:(char)a3 consistencyToken:(id)a4;
- (id)initWithAssetSet:(id)a0 usages:(id)a1 disableExperimentation:(char)a2;
