...
@property (readonly, nonatomic) char experimentActivated;
@property (retain, nonatomic) NSString *catalogAssetSetID;
@property (retain, nonatomic) NSString *atomicInstance;

+ (id)getClientName;
+ (id)autoAssetEntryToAsset:(id)a0 withAssetName:(id)a1 experimentationEnabled:(char)a2 experimentId:(id)a3;
...
- (id)loadAutoAssets:(id)a0 experiment:(id)a1 experimentActivated:(char *)a2;
- (char)lockAutoAssets:(id)a0 error:(id *)a1;
