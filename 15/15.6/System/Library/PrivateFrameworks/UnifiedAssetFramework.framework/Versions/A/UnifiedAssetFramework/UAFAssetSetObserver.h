...
+ (int)listenForUAFNotificationsForAssetSet:(id)a0 forRoot:(char)a1 queue:(id)a2 updateHandler:(id /* block */)a3;
+ (id)notificationForAssetSet:(id)a0 forRoot:(char)a1;
+ (char)sendUAFNotificationForAssetSet:(id)a0 forRoot:(char)a1;
...
- (id)initWithAssetSet:(id)a0 ignoreMobileAssetStartup:(char)a1 configurationDirURLs:(id)a2 queue:(id)a3 updateHandler:(id /* block */)a4;
- (char)namespaceHasChanged:(id)a0;
