...
+ (void)_logDailyStatusEventForAssetSetArrived:(id)a0 entries:(id)a1 assetSetArrived:(char)a2;
...
+ (char)autoAssetExistsWithEntries:(id)a0;
...
+ (id)configureAssetSet:(id)a0 specifiers:(id)a1 changed:(char *)a2 downloaded:(char *)a3 currentPolicy:(id *)a4;
+ (void)configureAutoAssetsFromAssetSetUsages:(id)a0 subscriptions:(id)a1 configurationManager:(id)a2 lockIfUnchanged:(char)a3 userInitiated:(char)a4;
+ (id)currentLockURLForAssetSet:(id)a0;
+ (id)defaultCheckPolicy;
+ (void)eliminateAssetType:(id)a0;
+ (id)fileLockPolicy;
+ (id)forceRemoveAutoAssetSet:(id)a0;
+ (id)getAutoAssetSet:(id)a0 specifiers:(id)a1 addEntries:(char)a2 configured:(char *)a3 downloaded:(char *)a4 currentPolicy:(id *)a5;
...
+ (id)latestAtomicInstanceForClients:(id)a0 OSSupported:(char *)a1 error:(id *)a2;
...
+ (id)manageAssetSet:(id)a0 specifiers:(id)a1 lockIfUnchanged:(char)a2 userInitiated:(char)a3 experiment:(id)a4;
+ (void)observeAllAssetSets;
+ (void)observeAssetSet:(id)a0;
+ (void)observeAssetSetExperimentalNamespace:(id)a0;
+ (char)releaseIncompatibleAssetSet:(id)a0 specifiers:(id)a1 configuration:(id)a2;
+ (void)removeAutoAssetSet:(id)a0 completion:(id /* block */)a1;
+ (void)removeUnusedAutoAssetSets:(id)a0 usedAutoAssetSets:(id)a1;
+ (char)sendNotificationForAssetSet:(id)a0;
+ (void)setBackgroundNeedPolicy:(id)a0 configuration:(id)a1;
+ (id)setLatestAtomicInstance:(id)a0 autoAssetSet:(id)a1;
+ (char)shouldCheckAssetSet:(id)a0 autoAssetSet:(id)a1 changed:(char)a2 downloaded:(char)a3 experiment:(id)a4 locked:(char *)a5 userInitiated:(char *)a6 removalNeeded:(char *)a7;
+ (char)shouldWaitForMobileAssetStart:(id)a0;
...
+ (void)updateAutoAssetsFromAssetSetUsages:(id)a0 configurationManager:(id)a1 expensiveNetworking:(char)a2 progress:(id /* block */)a3 requestId:(id)a4 completion:(id /* block */)a5;
