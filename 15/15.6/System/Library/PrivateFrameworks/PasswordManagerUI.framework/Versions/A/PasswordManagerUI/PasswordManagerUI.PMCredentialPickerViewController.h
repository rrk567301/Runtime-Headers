...
- (void)confirmButtonSubPaneDidFailBiometry:(id)a0 allowingPasscodeFallback:(char)a1;
...
- (char)validateReadyForAuthorization:(id)a0;
...
- (id)initWithPresentationContext:(id)a0 shouldExpandOtherLoginChoices:(char)a1 activity:(id)a2;
