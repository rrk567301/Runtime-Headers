...
@interface PMAuthorizationViewController : NSViewController <ASCredentialRequestPaneViewControllerDelegate, ASPasswordAuthenticationPaneViewControllerDelegate> {
    ...
    char _biometricsEnabled;
    char _includePasskeySymbolInTitleView;
    char _hasInternalAndExternalPasskeyLoginChoices;
...
- (id)_initialViewControllerForPresentationContext:(id)a0 expandingOtherLoginChoices:(char)a1;
...
- (void)_replaceRequestPaneViewControllerWithExpandedLoginChoiceList:(char)a0;
...
- (char)_shouldPresentCABLEAsInitialViewControllerForRequestTypes:(unsigned long long)a0 shouldAllowSecurityKeysFromCABLEView:(char)a1;
