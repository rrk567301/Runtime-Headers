...
- (id)initWithPersona:(long long)a0 appID:(id)a1 credentialTypes:(long long)a2 serviceNameHintStrings:(id)a3 domainNameHintStrings:(id)a4 savedAccountStore:(id)a5 suggestedDomainForNewAccount:(id)a6 suggestedLabelForNewAccount:(id)a7 bundleIDForFallbackIconForNewAccount:(id)a8 autoFillQuirksManager:(id)a9 shouldShowAutoFillPasskeys:(char)a10 currentWebFrameIdentifierForAutoFillPasskeys:(id)a11 connectedAppAuditToken:(struct { unsigned int x0[8]; })a12 isConnectedAppAWebBrowser:(char)a13 initialSearchQuery:(id)a14 shouldAllowAddingNewPasswords:(char)a15 bypassLockoutPolicy:(char)a16 authenticatedContext:(id)a17 savedAccountContext:(id)a18 didSelectAccountHandler:(id /* block */)a19 didSelectTextToInsertHandler:(id /* block */)a20;
