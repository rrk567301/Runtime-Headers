...
- (void).cxx_destruct;
- (void)loadView;
- (id)initWithPersona:(long long)a0 appID:(id)a1 credentialTypes:(long long)a2 serviceNameHintStrings:(id)a3 domainNameHintStrings:(id)a4 bypassLockoutPolicy:(char)a5 savedAccountStore:(id)a6 autoFillQuirksManager:(id)a7 shouldShowAutoFillPasskeys:(char)a8 currentWebFrameIdentifierForAutoFillPasskeys:(id)a9 connectedAppAuditToken:(struct { unsigned int x0[8]; })a10 isConnectedAppAWebBrowser:(char)a11 initialSearchQuery:(id)a12 shouldAllowAddingNewPasswords:(char)a13 suggestedDomainForNewAccount:(id)a14 suggestedLabelForNewAccount:(id)a15 bundleIDForFallbackIconForNewAccount:(id)a16 authenticatedContext:(id)a17 savedAccountContext:(id)a18 didSelectAccountHandler:(id /* block */)a19 didSelectTextToInsertHandler:(id /* block */)a20;
