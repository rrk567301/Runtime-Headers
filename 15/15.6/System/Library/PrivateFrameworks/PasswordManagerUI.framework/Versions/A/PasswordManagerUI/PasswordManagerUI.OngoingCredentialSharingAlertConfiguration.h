...
+ (id)alertTitleAndSubtitleForMovingSavedAccounts:(id)a0 toGroupWithName:(id)a1 isDragAndDropOperation:(char)a2;
...
+ (id)declineGroupInvitationAlertTitleForGroupWithName:(id)a0 fromKnownSender:(char)a1;
