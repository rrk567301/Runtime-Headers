...
@property (nonatomic) char currentEditorIsEditing;
...
- (void)updateTemplateContentsAnimated:(char)a0;
...
- (void)slotTemplateView:(id)a0 deletePressedOnSlotWithIdentifier:(id)a1 allowResettingValue:(char)a2;
...
- (char)slotTemplateView:(id)a0 shouldChangeText:(id)a1 forSlotWithIdentifier:(id)a2;
- (char)slotTemplateView:(id)a0 shouldTapTextAttachment:(id)a1 inSlotWithIdentifier:(id)a2;
...
- (char)slotTemplateView:(id)a0 typingDoCommandBySelector:(SEL)a1;
- (void)slotTemplateView:(id)a0 willBeginTypingInSlotWithIdentifier:(id)a1 usingTextEntry:(id)a2 allowMultipleLines:(char *)a3;
