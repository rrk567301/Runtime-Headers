...
@property (readonly, nonatomic, getter=isPopulated) char populated;
@property (copy, nonatomic) NSAttributedString *contentAttributedString;
@property (nonatomic) char prefersNoWrapping;
@property (nonatomic) char standaloneTextAttachment;
@property (nonatomic) long long userInputInsertionIndex;
@property (nonatomic) char preferContextMenu;
