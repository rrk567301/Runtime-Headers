...
@property (nonatomic) char isLayoutManagerForTextView;
@property (nonatomic) char extendSlotBackgroundOffEdges;
...
- (char)layoutManager:(id)a0 shouldBreakLineByWordBeforeCharacterAtIndex:(unsigned long long)a1;
- (char)layoutManager:(id)a0 shouldSetLineFragmentRect:(inout struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1 lineFragmentUsedRect:(inout struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2 baselineOffset:(inout double *)a3 inTextContainer:(id)a4 forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5;
- (long long)layoutManager:(id)a0 shouldUseAction:(long long)a1 forControlCharacterAtIndex:(unsigned long long)a2;
- (void)drawGradientInEnclosingRect:(id)a0 enclosingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1 lineFragmentPadding:(double)a2 runsOffLeft:(char)a3 runsOffRight:(char)a4;
- (void)enumerateEnclosingRectsForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 insetForBackground:(char)a1 standaloneTextAttachment:(char)a2 usingBlock:(id /* block */)a3;
- (void)enumerateEnclosingRectsForSlot:(id)a0 includeInsideSpacing:(char)a1 insetForBackground:(char)a2 usingBlock:(id /* block */)a3;
...
- (char)shouldDrawTextAttachment:(id)a0 atCharacterIndex:(unsigned long long)a1;
