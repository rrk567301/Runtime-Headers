...
@property (nonatomic) char typingAllowsMultipleLines;
...
@property (nonatomic) char interpretedKeyEvent;
@property (nonatomic) char menuIsPresented;
...
- (void)_deselectSlotAndNotifyDelegate:(char)a0 completionHandler:(id /* block */)a1;
- (void)_selectSlot:(id)a0 notifyDelegate:(char)a1;
...
- (id)configureMenuAtLocation:(struct CGPoint { double x0; double x1; })a0 wasTriggeredByTap:(char)a1;
- (void)deselectSlot;
...
- (id)selectedSlot;
- (void)setContents:(id)a0 animated:(char)a1;
- (void)setDisabledSlotTitleColor:(id)a0 backgroundColor:(id)a1 animated:(char)a2;
- (void)setupTextEntry;
- (char)shouldRecognizeTapOnTextAttachment:(id)a0 inSlotWithIdentifier:(id)a1;
- (char)showContextMenuForEvent:(id)a0;
...
- (char)startEditingHighlightedSlot;
