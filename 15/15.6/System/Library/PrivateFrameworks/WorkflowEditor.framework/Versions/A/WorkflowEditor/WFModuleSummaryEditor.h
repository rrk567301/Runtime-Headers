...
@property (nonatomic) char returnToKeyboardOnComplete;
...
@property (readonly, nonatomic, getter=isProcessing) char processing;
...
@property (nonatomic) char allowsPickingVariables;
...
+ (char)supportsEditingTextAttachment:(id)a0 inSlotWithIdentifier:(id)a1;

- (void).cxx_destruct;
- (void)beginEditingSlotWithIdentifier:(id)a0 presentationAnchor:(id)a1;
- (void)cancelEditingWithCompletionHandler:(id /* block */)a0;
- (id)initWithParameter:(id)a0 arrayIndex:(unsigned long long)a1 processing:(char)a2;
...
- (char)canTypeAlongsideVariables;
- (id)clearButtonMenuItemForSlotWithIdentifier:(id)a0;
- (void)commitAuxiliaryState:(id)a0 forKey:(id)a1;
...
- (char)menuElementsContainDeferredElement:(id)a0 withEstimatedCountGreaterThan:(long long)a1;
...
- (char)variableMenuSupportsVariableSelectionForSlotWithIdentifier:(id)a0;
