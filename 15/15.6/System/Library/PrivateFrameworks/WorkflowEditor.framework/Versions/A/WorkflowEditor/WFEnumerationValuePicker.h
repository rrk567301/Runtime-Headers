...
@property (nonatomic) char suppressAutomaticCancellation;
...
+ (id)presentWithParameter:(id)a0 state:(id)a1 slotIdentifier:(id)a2 initialCollection:(id)a3 variableProvider:(id)a4 variableUIDelegate:(id)a5 allowsPickingVariables:(char)a6 processing:(char)a7 presentationAnchor:(id)a8 cancelHandler:(id /* block */)a9 completionHandler:(id /* block */)a10;

- (void).cxx_destruct;
- (void)popoverWillClose:(id)a0;
- (void)dismissWithCompletionHandler:(id /* block */)a0;
- (void)cancelOperationCommittingState:(char)a0;
