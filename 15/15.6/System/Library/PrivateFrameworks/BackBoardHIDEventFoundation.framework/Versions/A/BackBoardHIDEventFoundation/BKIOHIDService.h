...
@property (nonatomic, getter=isBuiltIn) char builtIn;
...
@property (readonly, nonatomic) char isVirtualService;
...
- (id)_initForTestingWithSenderID:(unsigned long long)a0 setUpInitialProperties:(char)a1;
...
- (char)claimsToConformToUsagePage:(unsigned short)a0 usage:(unsigned short)a1;
