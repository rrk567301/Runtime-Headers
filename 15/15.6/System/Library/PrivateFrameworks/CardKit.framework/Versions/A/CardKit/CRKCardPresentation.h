@class _CRKCardSectionViewLoader, NSString, NSViewController, CRKCardPresentationConfiguration, CRProtocolRestrictedInvocationChain;
...
@property (nonatomic) char debugModeEnabled;
@property (weak, nonatomic) id<CRKCardPresentationDelegate> delegate;
@property (readonly, nonatomic) NSViewController<CRKCardViewControlling> *cardViewController;
...
- (void)_configureWithRequestedCard:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
- (void)_establishParsecSessionIfNeeded:(id /* block */)a0;
- (void)_fullyConfigureWithRequestedCard:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
- (void)_loadAndRegisterBundleProviders:(id /* block */)a0;
- (void)_updateViewConfigurationsDebugMode:(char)a0;
- (double)boundingWidthForProvider:(id)a0;
- (char)cardSectionDisplayRequiresUserConsentForProvider:(id)a0;
...
- (void)setConfiguration:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
