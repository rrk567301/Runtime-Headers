...
@property (readonly, nonatomic) struct { double x0; double x1; double x2; double x3; struct CGPoint { double x0; double x1; } x4; double x5; double x6; unsigned char x7; unsigned int x8; char x9; } *activePoints;
...
- (void)_pressButtonEventForIndex:(long long)a0 down:(char)a1;
...
- (struct __IOHIDEvent { } *)_createIOSButtonHIDEventWithButtonType:(long long)a0 down:(char)a1;
- (struct __IOHIDEvent { } *)_createIOSButtonHIDEventWithPage:(unsigned int)a0 usage:(unsigned int)a1 down:(char)a2;
- (unsigned long long)_currentMachTime;
- (void)_delayBetweenMove:(int)a0 elapsedTime:(double)a1;
- (void)_dragWithStartPoint:(struct CGPoint { double x0; double x1; })a0 mask:(unsigned long long)a1 endPoint:(struct CGPoint { double x0; double x1; })a2 mask:(unsigned long long)a3 duration:(double)a4 tapAndWait:(double)a5 lift:(char)a6 pressure:(double)a7 radius:(double)a8;
...
- (void)_hoverAtPoints:(struct CGPoint { double x0; double x1; } *)a0 touchCount:(unsigned long long)a1 pressure:(double)a2 radius:(double)a3 edgeMaskOptions:(const struct { unsigned int x0; char x1; } *)a4 withEventType:(long long)a5 withZPosition:(double)a6 withAzimuthAngle:(double)a7 withRollAngle:(double)a8 withAltitudeAngle:(double)a9;
- (void)_initScreenProperties;
- (char)_isEdgePoint:(struct CGPoint { double x0; double x1; })a0 getMask:(unsigned int *)a1;
...
- (void)dragWithStartPoint:(struct CGPoint { double x0; double x1; })a0 endPoint:(struct CGPoint { double x0; double x1; })a1 duration:(double)a2 tapAndWait:(double)a3 lift:(char)a4;
- (void)dragWithStartPoint:(struct CGPoint { double x0; double x1; })a0 endPoint:(struct CGPoint { double x0; double x1; })a1 duration:(double)a2 tapAndWait:(double)a3 lift:(char)a4 pressure:(double)a5;
- (void)dragWithStartPoint:(struct CGPoint { double x0; double x1; })a0 endPoint:(struct CGPoint { double x0; double x1; })a1 duration:(double)a2 tapAndWait:(double)a3 lift:(char)a4 pressure:(double)a5 radius:(double)a6;
- (void)dragWithStartPoint:(struct CGPoint { double x0; double x1; })a0 endPoint:(struct CGPoint { double x0; double x1; })a1 duration:(double)a2 tapAndWait:(double)a3 lift:(char)a4 radius:(double)a5;
...
- (void)flipRingerSwitchToValue:(char)a0;
...
- (void)peekAndPop:(struct CGPoint { double x0; double x1; })a0 commit:(char)a1 duration:(double)a2;
- (void)peekAndPop:(struct CGPoint { double x0; double x1; })a0 commit:(char)a1 duration:(double)a2 pressure:(double)a3 radius:(double)a4;
- (void)peekAndPop:(struct CGPoint { double x0; double x1; })a0 commit:(char)a1 duration:(double)a2 presure:(double)a3;
- (void)peekAndPop:(struct CGPoint { double x0; double x1; })a0 commit:(char)a1 duration:(double)a2 radius:(double)a3;
...
- (void)sendUnicodeString:(id)a0 synthesizePerCharacterEvents:(char)a1 durationBetweenEvents:(double)a2;
...
- (void)touchSensitiveButtonClickWithPage:(id)a0 withUsage:(id)a1 withTouch:(unsigned int)a2 withNormalizedPositionY:(double)a3 withNormalizedPositionDeltaY:(double)a4;
- (void)touchSensitiveButtonEngagedWithDuration:(double)a0 withPage:(id)a1 withUsage:(id)a2 withTouch:(unsigned int)a3 withNormalizedPositionY:(double)a4 withNormalizedPositionDeltaY:(double)a5;
- (void)touchSensitiveButtonEngagedWithLiftWithDuration:(double)a0 withPage:(id)a1 withUsage:(id)a2 withTouch:(unsigned int)a3 withNormalizedPositionY:(double)a4 withNormalizedPositionDeltaY:(double)a5;
- (void)touchSensitiveButtonEngagedWithPage:(id)a0 withUsage:(id)a1 withTouch:(unsigned int)a2 withNormalizedPositionY:(double)a3 withNormalizedPositionDeltaY:(double)a4;
- (void)touchSensitiveButtonHoldWithDuration:(double)a0 withPage:(id)a1 withUsage:(id)a2 withTouch:(unsigned int)a3 withNormalizedPositionY:(double)a4 withNormalizedPositionDeltaY:(double)a5;
- (void)touchSensitiveButtonHoldWithPage:(id)a0 withUsage:(id)a1 withTouch:(unsigned int)a2 withNormalizedPositionY:(double)a3 withNormalizedPositionDeltaY:(double)a4;
- (void)touchSensitiveButtonIntermediatePressWithDuration:(double)a0 withPage:(id)a1 withUsage:(id)a2 withTouch:(unsigned int)a3 withNormalizedPositionY:(double)a4 withNormalizedPositionDeltaY:(double)a5;
- (void)touchSensitiveButtonIntermediatePressWithPage:(id)a0 withUsage:(id)a1 withTouch:(unsigned int)a2 withNormalizedPositionY:(double)a3 withNormalizedPositionDeltaY:(double)a4;
- (void)touchSensitiveButtonLiftWithPage:(id)a0 withUsage:(id)a1;
- (void)touchSensitiveButtonReleaseHoldWithPage:(id)a0 withUsage:(id)a1 withTouch:(unsigned int)a2 withNormalizedPositionY:(double)a3 withNormalizedPositionDeltaY:(double)a4;
