@class FUSeparator, FULabel, FUFlightLeg, FUFlightProgressView, FUStyleProvider, NSLayoutConstraint, NSButton, NSMapTable, FUFlight;
...
@property (weak, nonatomic) NSButton *flightButton;
@property (weak, nonatomic) FUFlightProgressView *progressView;
@property (nonatomic) unsigned long long style;

+ (id)flightViewForStyle:(unsigned long long)a0 compact:(char)a1;

- (void)dealloc;
- (void).cxx_destruct;
- (void)awakeFromNib;
- (void)updateDelayInfo;
- (void)addDateTimeAttributesToString:(id)a0 striked:(char)a1 alignment:(long long)a2;
- (void)flightButtonTapped:(id)a0;
- (id)formattedDurationForDuration:(double)a0;
- (void)setFlight:(id)a0 legIndex:(unsigned long long)a1 multiFlights:(char)a2 spotlightMode:(char)a3;
- (void)setupLabelStylesWithStyle:(unsigned long long)a0;
- (void)updateAirlineInformation;
- (void)updateDateTimeForDeparture:(char)a0;
- (void)updateFlightButtonIcon;
- (void)updateFlightDates;
- (void)updateFlightProgressView;
- (void)updateFlightStatus;
- (void)updateFlightTerminalInfo;
- (void)updateForFollowupContent:(char)a0;
