...
- (void)dealloc;
- (void).cxx_destruct;
- (char)backupDatabaseFromPath:(id)a0 toPath:(id)a1 context:(id)a2;
- (void)collect:(id)a0;
- (void)collectMovedAsideDatabase:(id)a0;
- (char)collectMovedAsideDatabaseWithoutRedacting:(id)a0;
...
- (char)redactAndCollectMovedAsideDatabase:(id)a0;
- (char)redactAndCompress:(id)a0 context:(id)a1;
