...
@property (readonly, nonatomic) char randomize;
...
- (id)initWithEntityType:(int)a0 filters:(id)a1 calendars:(id)a2 limit:(long long)a3 randomize:(char)a4;
...
- (id)initWithEntityType:(int)a0 filters:(id)a1 calendars:(id)a2 source:(id)a3 limit:(long long)a4 randomize:(char)a5;
