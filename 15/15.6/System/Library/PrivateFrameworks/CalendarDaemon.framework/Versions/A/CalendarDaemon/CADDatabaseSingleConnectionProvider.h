...
@interface CADDatabaseSingleConnectionProvider : NSObject <CalCalendarDatabaseIntegrityErrorReportingDelegate, CalCalendarDatabaseRestoreGenerationChangedDelegate, CADDatabaseConnectionProvider> {
...
- (char)performWithConfiguration:(id)a0 priority:(unsigned long long)a1 databaseID:(int)a2 block:(id /* block */)a3;
