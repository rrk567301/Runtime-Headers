...
@interface CADNotificationGatheringContext : NSObject {
    ...
    char _excludingDelegateSources;
...
- (id)initWithConnection:(id)a0 afterDate:(id)a1 forSourceWithExternalIdentifier:(id)a2 excludingDelegateSources:(char)a3 excludingUncheckedCalendars:(char)a4 filteredByShowsNotificationsFlag:(char)a5 expanded:(char)a6;
- (char)isEventTimeSensitiveForFocus:(void *)a0;
- (id)nearestProposedTimeForEvent:(void *)a0;
- (char)shouldSkipNotificationForCalendar:(void *)a0;
