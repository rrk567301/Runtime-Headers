...
@property (nonatomic) char failDeleteSearchableItemsWithDomainIdentifiers;
@property (nonatomic) char failIndexSearchableItems;
@property (nonatomic) char failDeleteAllSearchableItemsForBundleID;
