...
@property (readonly, nonatomic) char redactLogs;
...
- (id)initWithConnection:(id)a0 token:(unsigned int)a1 options:(long long)a2 trafficLogsCollectionMode:(unsigned long long)a3;
- (id)loadLogCollectors;
- (void)logWithLevel:(unsigned char)a0 formatString:(id)a1 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
