...
@interface CADDatabaseConnectionPool : NSObject <CalCalendarDatabaseIntegrityErrorReportingDelegate, CADDatabaseConnectionProvider> {
    ...
    char _needCheckAuxDatabaseSequenceAndRestoreGeneration;
...
- (void)_checkGenerationAndAuxDatabaseSequence:(char *)a0;
- (id)_openDatabases;
- (id)_pools;
...
- (char)performASAPWithConfiguration:(id)a0 databaseID:(int)a1 block:(id /* block */)a2;
