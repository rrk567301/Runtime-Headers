...
- (char)loadVoiceResource:(id)a0;
- (void)unloadAllVoiceResources;
- (char)unloadVoiceResource:(id)a0;
- (char)_addPathDictionaryEntriesForDirectory:(id)a0;
- (void)_deinitializeEngine;
- (char)_initializeEngine;
- (char)_initializeVoiceDataFiles;
- (char)_loadVoiceResource:(id)a0;
- (id)_nextBuffer;
...
- (char)queue_unloadVoiceResource:(id)a0;
- (void)setTrimEndingSilences:(char)a0;
