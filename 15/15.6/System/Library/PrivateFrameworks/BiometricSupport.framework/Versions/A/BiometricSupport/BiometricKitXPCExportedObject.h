...
- (void)terminate;
- (id)clients;
- (void)setProtectedConfiguration:(id)a0 user:(unsigned int)a1 options:(id)a2 async:(char)a3 client:(unsigned long long)a4 replyBlock:(id /* block */)a5;
...
- (void)detectPresenceWithOptions:(id)a0 async:(char)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
...
- (void)enableBackgroundFdet:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
- (void)enableMatchAutoRetry:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
- (void)enroll:(int)a0 user:(unsigned int)a1 options:(id)a2 async:(char)a3 client:(unsigned long long)a4 replyBlock:(id /* block */)a5;
...
- (void)getLogs:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
...
- (void)match:(id)a0 options:(id)a1 async:(char)a2 client:(unsigned long long)a3 replyBlock:(id /* block */)a4;
- (void)notifyAppIsBackground:(char)a0 client:(unsigned long long)a1;
- (void)notifyAppIsInactive:(char)a0 client:(unsigned long long)a1;
- (void)pauseFaceDetectTimer:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
...
- (void)pullDebugImageData:(char)a0 rotated:(char)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
- (void)pullMatchPolicyInfoData:(unsigned long long)a0 replyBlock:(id /* block */)a1;
- (void)queryIdentityMigrationFailureForUser:(unsigned int)a0 clear:(char)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
- (void)registerDSID:(unsigned long long)a0 options:(id)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
- (void)registerDelegate:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
- (void)registerStoreToken:(id)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
- (void)removeAllIdentitiesForUser:(unsigned int)a0 options:(id)a1 async:(char)a2 client:(unsigned long long)a3 replyBlock:(id /* block */)a4;
- (void)removeIdentity:(id)a0 options:(id)a1 async:(char)a2 client:(unsigned long long)a3 replyBlock:(id /* block */)a4;
- (void)removePeriocularTemplatesWithOptions:(id)a0 async:(char)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
- (void)resetAppleConnectCounter:(unsigned long long)a0 replyBlock:(id /* block */)a1;
- (void)setDebugImages:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
- (void)setPreferencesValue:(id)a0 forKey:(id)a1 client:(unsigned long long)a2 replyBlock:(id /* block */)a3;
- (void)setSystemProtectedConfiguration:(id)a0 options:(id)a1 async:(char)a2 client:(unsigned long long)a3 replyBlock:(id /* block */)a4;
...
- (void)suspendEnrollment:(char)a0 client:(unsigned long long)a1 replyBlock:(id /* block */)a2;
...
- (void)updateIdentity:(id)a0 options:(id)a1 async:(char)a2 client:(unsigned long long)a3 replyBlock:(id /* block */)a4;
- (unsigned int)hashClientName:(id)a0;
- (long long)clientThrottleRatio:(id)a0;
- (id)entitlementsNeededForPermissionGroup:(int)a0;
- (char)isClient:(unsigned long long)a0 entitled:(int)a1 forMethod:(const char *)a2;
