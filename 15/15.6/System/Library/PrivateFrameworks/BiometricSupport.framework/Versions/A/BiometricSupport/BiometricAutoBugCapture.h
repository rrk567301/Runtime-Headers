...
@property (readonly, nonatomic) char serialLogEnabled;
...
- (char)sendAutoBugCaptureEvent:(unsigned long long)a0;
- (void)sendAutoBugCaptureEvent:(unsigned long long)a0 withContext:(id)a1 replyBlock:(id /* block */)a2;
- (char)sendSignature:(id)a0 withDuration:(double)a1;
- (void)sendSignature:(id)a0 withDuration:(double)a1 replyBlock:(id /* block */)a2;
