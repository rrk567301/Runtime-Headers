@class VCWCMClient, VCRecommendedNetworkSettings, VCConnectionManager, NSObject, WRMClient;
...
@property (nonatomic) char isLocalCellular;
@property (nonatomic) char isVideoPaused;
@property char shouldSendFeedbackControllerReport;
...
- (void)setRSSIThresholdEnabled:(char)a0;
