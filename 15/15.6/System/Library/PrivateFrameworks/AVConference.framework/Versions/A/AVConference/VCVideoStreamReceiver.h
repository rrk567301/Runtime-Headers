...
- (void)dealloc;
- (id)initWithConfig:(struct tagVCVideoStreamReceiverConfig { struct tagHANDLE *x0; id x1; struct tagVCVideoReceiverDelegateRealtimeInstanceVTable { void /* function */ *x0; void /* function */ *x1; } x2; struct opaqueRTCReporting *x3; unsigned int x4; int x5; id x6; char x7; void *x8; void /* function */ *x9; id x10; } *)a0;
- (void)setJitterBufferMode:(int)a0;
- (int)processVideoRTP;
- (char)canDequeue:(struct opaqueCMBufferQueue { } *)a0 forTimestamp:(unsigned int)a1;
- (int)createDecodeSession:(struct opaqueCMFormatDescription { } *)a0;
- (int)decodeFrame:(struct opaqueCMSampleBuffer { } *)a0 showFrame:(char)a1;
...
- (void)stopVideo;
- (id)syncSource;
- (void)teardownDecodeSession:(char)a0;
...
- (void)updateVideoStallStatus:(char)a0;
