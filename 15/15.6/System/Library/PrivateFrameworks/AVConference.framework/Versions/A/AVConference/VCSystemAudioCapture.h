@class VCAudioHALPluginRemoteDeviceInfo, VCCannedAudioInjector, NSObject;
...
@interface VCSystemAudioCapture : VCObject {
    ...
    char _firstAudioBufferReceived;
...
- (char)startAudioHALPlugInSource:(unsigned int)a0;
- (char)stopAudioHALPlugInSource:(unsigned int)a0;
- (char)stopAudioQueue;
