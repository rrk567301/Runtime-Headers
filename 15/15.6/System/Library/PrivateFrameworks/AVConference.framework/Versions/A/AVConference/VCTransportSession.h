...
@interface VCTransportSession : NSObject {
    ...
    char _didAddNetworkAssertion;
}

@property (readonly, nonatomic) int detailedErrorCode;
@property (readonly, nonatomic) char isHandoverSupported;
@property (readonly, nonatomic) char isRemoteOSPreLion;
...
@property (nonatomic, setter=setCallActive:) char isCallActive;
@property (retain, nonatomic) id<VCConnectionProtocol> registeredConnection;
@property (nonatomic) char shouldSetupNWMonitor;
...
@property (nonatomic) char shouldIgnoreConnectionRefusedError;
