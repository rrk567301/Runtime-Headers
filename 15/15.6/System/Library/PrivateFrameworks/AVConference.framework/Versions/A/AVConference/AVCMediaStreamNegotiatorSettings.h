...
@property (readonly, nonatomic) char rtcpTimeOutEnabled;
...
@property (readonly, nonatomic) char shouldSetJitterBufferMode;
...
@property (readonly, nonatomic) char shouldApply16AlignedAdjustment;
@property (readonly, nonatomic) char blackFrameOnClearScreenEnabledDefault;
@property (readonly, nonatomic) char blackFrameOnClearScreenEnabled;
@property (readonly, nonatomic) char foveationIsSupported;
