...
@interface VCMediaRecorderHistory : NSObject <VCMediaRecorderHistoryBufferDelegate> {
    ...
    char _retainPixelBufferEnabled;
...
+ (char)isRecordingOnlyMediaType:(unsigned char)a0;
...
- (void)invokeStartCompletionHandler:(id /* block */)a0 withErrorCode:(int)a1 ontoRecordingQueue:(char)a2;
- (void)registerDirectoryWithURL:(id)a0;
- (void)setCompletionHandler:(id /* block */)a0 forTransactionID:(id)a1;
- (char)setUpAudioBuffers;
