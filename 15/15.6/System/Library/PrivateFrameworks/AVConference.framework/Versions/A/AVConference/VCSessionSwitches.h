...
- (void)setFeature:(unsigned long long)a0 isEnabled:(char)a1;
- (char)trialEnablementWithClient:(id)a0 Context:(struct { id x0; id x1; id x2; id x3; unsigned long long x4; } *)a1 normalizedRandom:(double)a2;
