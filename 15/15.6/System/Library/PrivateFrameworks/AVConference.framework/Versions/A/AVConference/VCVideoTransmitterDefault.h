...
- (void)setIsEndToEndBasedBandwidthProbingEnabled:(char)a0;
- (void)setIsServerBasedBandwidthProbingEnabled:(char)a0;
- (void)setKeyFrameOnlyStreamID:(unsigned short)a0;
- (void)setRtxEnabled:(char)a0;
...
- (void)setUpAspectRatios:(char)a0;
