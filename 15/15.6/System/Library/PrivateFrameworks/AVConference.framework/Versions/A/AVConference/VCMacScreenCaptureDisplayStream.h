...
- (char)createDisplayStreamPropertiesFromConfig:(id)a0 displayProperties:(struct __CFDictionary **)a1;
...
- (char)setupColorInfoWithSourceConfig:(id)a0 displayStreamProperties:(struct __CFDictionary { } *)a1;
