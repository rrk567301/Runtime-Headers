...
- (char)isPreferredVideoRule:(id)a0 preferredFormat:(id)a1;
- (char)setupH264Rules;
- (char)setupHEVCRules;
- (char)setupRules;
- (char)setupVideoRulesForPayload:(int)a0 transportType:(unsigned char)a1 encodingType:(unsigned char)a2 formatList:(struct _VCVideoFormat { unsigned int x0; unsigned int x1; unsigned int x2; } *)a3 formatListCount:(unsigned int)a4 preferredFormat:(id)a5 supportsHighDef:(char *)a6;
