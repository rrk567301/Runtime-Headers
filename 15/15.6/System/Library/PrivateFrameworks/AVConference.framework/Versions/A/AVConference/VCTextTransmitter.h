...
@interface VCTextTransmitter : NSObject <VCTextSender> {
    struct _VCTextTransmitterConfiguration { struct tagHANDLE *rtpHandle; unsigned int sampleRate; char isRedEnabled; unsigned int numRedundantPayloads; float txIntervalMin; } _config;
...
- (char)start;
- (void)stop;
- (id)initWithConfiguration:(struct _VCTextTransmitterConfiguration { struct tagHANDLE *x0; unsigned int x1; char x2; unsigned int x3; float x4; } *)a0;
- (void)heartbeat;
