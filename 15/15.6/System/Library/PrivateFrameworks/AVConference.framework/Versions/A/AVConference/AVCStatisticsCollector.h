...
@interface AVCStatisticsCollector : NSObject {
    ...
    char _resetRemoteAudioPacketReceived;
    struct _opaque_pthread_rwlock_t { long long __sig; char __opaque[192]; } _statisticsCollectionLock;
    char _l4SHighDataRateEnabled;
    struct __CFAllocator { } *_statisticsChangeHandlerEntryAllocator;
    unsigned int _nextChangeHandlerIdentifier;
    struct _VCSingleLinkedList { struct _VCSingleLinkedListEntry *head; BOOL initialized; void /* function */ *compare; unsigned long long countEntries; } _statisticsChangeHandlers[15];
...
@property (readonly, nonatomic) char fastSuddenBandwidthDetectionEnabled;
