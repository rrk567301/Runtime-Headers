...
- (int)createVFD:(int *)a0 realSocket:(int)a1 sockAddr:(struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } *)a2 length:(unsigned int *)a3 isUsable:(char *)a4;
