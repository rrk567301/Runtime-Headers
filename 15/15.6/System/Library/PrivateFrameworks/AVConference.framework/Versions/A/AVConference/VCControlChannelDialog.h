...
@interface VCControlChannelDialog : VCObject {
    char _handshakeEnabled;
    char _isHandshakeMode;
    char _isHandshakeCommenced;
    unsigned int _sessionID;
    id<VCControlChannelTransactionDelegate> _weakTransactionDelegate;
    char _shouldFinishHandshake;
...
- (char)sendReliableMessage:(id)a0 withTopic:(id)a1 timeout:(id)a2 withOptions:(id)a3;
- (char)sendReliableMessageInternal:(id)a0 withTopic:(id)a1 timeout:(id)a2 useFastRetries:(char)a3 withOptions:(id)a4;
- (char)sendUnreliableMessage:(id)a0 withTopic:(id)a1 sessionID:(unsigned int)a2 participantID:(id)a3 transactionDelegate:(id)a4;
