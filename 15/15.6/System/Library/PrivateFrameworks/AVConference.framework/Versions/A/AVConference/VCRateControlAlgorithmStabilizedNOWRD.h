...
@interface VCRateControlAlgorithmStabilizedNOWRD : VCRateControlAlgorithmBase {
    ...
    char _isStable;
    char _shouldRampUpSkipNOWRDStabilization;
    ...
    char _basebandNotificationFromNWConnection;
    char _allowRampUpBasedOnBytesInFlight;
    unsigned int _bytesInFlight;
    unsigned int _bytesInFlightThreshold;
    char _bytesInFlightAdaptationEnabled;
