...
- (void)addTopic:(id)a0 associatedStrings:(id)a1 allowConcurrent:(char)a2 receiveHandler:(id /* block */)a3;
- (void)addTopic:(id)a0 associatedStrings:(id)a1 allowConcurrent:(char)a2 requireReliable:(char)a3 sendMessageDictionaryCompletionHandler:(id /* block */)a4 receiveMessageDictionaryHandler:(id /* block */)a5;
- (void)addTopic:(id)a0 associatedStrings:(id)a1 allowConcurrent:(char)a2 sendCompletionHandler:(id /* block */)a3 receiveHandler:(id /* block */)a4;
- (void)addTopic:(id)a0 associatedStrings:(id)a1 allowConcurrent:(char)a2 sendMessageDictionaryCompletionHandler:(id /* block */)a3 receiveMessageDictionaryHandler:(id /* block */)a4;
...
- (void)controlChannel:(id)a0 sendReliableMessage:(id)a1 didSucceed:(char)a2 toParticipant:(id)a3;
...
- (char)sendReliableMessage:(id)a0 withTopic:(id)a1 participantID:(unsigned long long)a2 withOptions:(id)a3 completion:(id /* block */)a4;
- (void)startMessaging;
- (void)stopMessaging;
