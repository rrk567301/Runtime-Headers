...
- (void)dealloc;
- (int)sendData:(id)a0 messageType:(unsigned int)a1 encrypted:(char)a2;
- (int)convertData:(id)a0 toEncryptedData:(id *)a1 encrypted:(char)a2;
- (int)convertEncryptedData:(id)a0 toData:(id *)a1 encrypted:(char)a2;
- (id)initWithLocalCallID:(unsigned int)a0 remoteCallID:(unsigned int)a1 isCaller:(char)a2 sharedSecret:(id)a3 error:(id *)a4;
- (int)setupWithSharedSecret:(id)a0 isCaller:(char)a1 error:(id *)a2;
