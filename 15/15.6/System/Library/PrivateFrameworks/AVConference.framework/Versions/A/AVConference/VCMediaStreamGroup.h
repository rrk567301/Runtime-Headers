@class AVCStatisticsCollector, NSArray, NSString, VCNetworkFeedbackController, NSDictionary, NSObject, VCMediaRecorder, TimingCollection, VCMediaKeyIndex;
...
@property (nonatomic, getter=isEnabledAtStart) char enabledAtStart;
...
- (char)containsStreamWithIDSStreamID:(unsigned short)a0;
...
- (id)setPauseOnMediaStreams:(char)a0;
...
- (char)setupStreamsWithConfig:(id)a0;
