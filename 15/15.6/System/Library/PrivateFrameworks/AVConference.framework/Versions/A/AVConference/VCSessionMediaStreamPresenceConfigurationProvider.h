...
+ (id)defaultOneToOneTierTable:(unsigned int)a0 redundancyEnabled:(char)a1;
+ (unsigned int)defaultRemainingBitrateSplit:(unsigned int)a0;
+ (id)fdatGroupDisabled;
+ (id)foregroundCameraOneToOneTierTable:(unsigned int)a0 redundancyEnabled:(char)a1;
+ (unsigned int)foregroundCameraRemainingBitrateSplit:(unsigned int)a0;
+ (id)ftxtGroupDisabled;
+ (id)oneToOneTierTableForStreamGroupID:(unsigned int)a0 splitType:(unsigned int)a1 redundancyEnabled:(char)a2;
...
- (void)dealloc;
- (char)setupAudioRulesWithPList:(id)a0 audioStreamConfig:(id)a1 supportedAudioRules:(id)a2;
- (char)addPayload:(int)a0 audioStreamConfig:(id)a1 supportedAudioRules:(id)a2;
- (char)checkEncoderSupportForCodecType:(long long)a0;
- (char)checkEncoderSupportForConfig:(id)a0;
- (id)defaultEndToEndStreamGroupConfigurationForStreamGroup:(unsigned int)a0;
...
- (id)newVideoStreamGroupStreamConfigWithPList:(id)a0 streamIDGenerator:(id)a1 ssrc:(unsigned int)a2 groupID:(unsigned int)a3 shouldSkip:(char *)a4;
- (id)newVideoStreamInputConfigurationWithPList:(id)a0;
- (unsigned short)setParentStreamID:(unsigned short)a0 videoConfig:(id)a1;
- (char)setupAudioRedWithPlist:(id)a0 audioStreamConfig:(id)a1 supportedAudioRules:(id)a2;
- (char)setupAudioStreamGroupStreams:(id)a0 streamGroupConfig:(id)a1 supportedAudioRules:(id)a2 streamIDGenerator:(id)a3;
- (char)setupRedFactorsWithPList:(id)a0 audioStreamConfig:(id)a1;
- (char)setupVideoStreamGroupStreams:(id)a0 streamGroupConfig:(id)a1 streamIDGenerator:(id)a2;
