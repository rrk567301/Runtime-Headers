@class NSString, VCMediaNegotiatorResults, VCMediaNegotiatorResultsAudio, VCMediaNegotiatorResultsVideo, NSMutableDictionary, NSMutableArray, VCMediaNegotiatorLocalConfiguration, VCMediaNegotiatorResultsMediaRecorder, VCMediaNegotiatorResultsFaceTimeSettings;
...
+ (char)isAudioStreamGroup:(unsigned int)a0;
+ (char)isU1StreamGroup:(unsigned int)a0;
+ (id)negotiateVideoMaxResolutionWithEncodeRules:(id)a0 decodeRules:(id)a1 isEncoder:(char)a2;
...
+ (char)selectBestVideoRuleForTransport:(unsigned char)a0 payload:(int)a1 encodingType:(unsigned char)a2 videoSettings:(id)a3 localVideoRuleCollection:(id)a4 remoteVideoRuleCollection:(id)a5;
