...
- (char)isPayloadTimestampWithinThreshold:(struct tagVCAudioRedPayload { int x0; char *x1; int x2; unsigned int x3; unsigned int x4; BOOL x5; unsigned char x6; unsigned char x7; unsigned char x8; } *)a0 forTimestamp:(unsigned int)a1;
...
- (char)redundantPayloads:(id)a0 containsPointer:(void *)a1;
...
- (void)resetShortREDHistoryAndPrimaryPayloadHistory:(char)a0;
