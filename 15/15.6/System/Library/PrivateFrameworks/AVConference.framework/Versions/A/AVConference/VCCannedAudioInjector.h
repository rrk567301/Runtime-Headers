...
@interface VCCannedAudioInjector : VCObject {
    ...
    double _loopLength;
    char _forceVoiceActive;
}

@property char isReadyToInject;
...
+ (char)isAudioAvailable:(id)a0 fileName:(id)a1;
...
- (char)setupAssetInjectionWithConfig:(id)a0;
