...
- (char)sendAllocateMsg:(id *)a0;
- (char)sendChannelBindingMsgWithDict:(id)a0 error:(id *)a1;
- (char)sendRefreshMsg:(unsigned int)a0 error:(id *)a1;
- (void)sendTCPData:(const void *)a0 bufSize:(int)a1;
- (void)unbindChannel;
- (void)vcArg:(id)a0 sendControlData:(id)a1 isTypeSSL:(char)a2 withTimeout:(float)a3 withDetail:(long long)a4;
