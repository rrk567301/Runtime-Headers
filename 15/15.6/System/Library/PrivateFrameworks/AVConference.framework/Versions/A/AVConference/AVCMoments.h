...
- (char)avcMediaRecorderRequestDidEndRequest:(id)a0 withError:(id *)a1;
- (char)avcMediaRecorderRequestDidRejectRequest:(id)a0 withError:(id *)a1;
- (char)avcMediaRecorderRequestDidStartRequest:(id)a0 withError:(id *)a1;
- (char)connectWithConfiguration:(id)a0;
- (char)connectWithStreamToken:(long long)a0;
...
- (char)setupDelegate:(id)a0 dispatchQueue:(id)a1;
