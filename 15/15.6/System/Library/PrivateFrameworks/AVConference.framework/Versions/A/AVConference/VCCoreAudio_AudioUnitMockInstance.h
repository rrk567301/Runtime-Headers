...
@property char isReconfiguring;
@property (nonatomic) char audioSessionIDSet;
@property (nonatomic) char bufferFrameSizeSet;
...
- (char)reallocAudioBuffer:(struct AudioBufferList **)a0 withFormat:(const struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; } *)a1;
