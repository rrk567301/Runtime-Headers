...
- (unsigned int)getByteCountWithIndex:(unsigned char)a0 isOutgoing:(char)a1;
- (unsigned int)getPacketCountWithIndex:(unsigned char)a0 isOutgoing:(char)a1;
- (id)getPrimaryConnectionToBeCompared;
- (id)getSecondaryConnectionToBeCompared;
- (int)nominateConnection:(id)a0 asPrimary:(char)a1 interfaceMask:(int)a2 demote:(int *)a3 connectionPriority:(int *)a4 replaceOnly:(int *)a5;
- (int)removeConnectionWithIPPort:(struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } *)a0 isLocalInterface:(char)a1;
- (int)removeConnectionWithIPPortInternal:(struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } *)a0 isLocalInterface:(char)a1;
- (void)reportConnection:(id)a0 isInitialConnection:(char)a1;
- (void)reportLinkProbingStatsWithDuplicationJustStarted:(char)a0;
- (void)setUpVTable;
- (char)shouldAcceptDataFromSourceDestinationInfo:(struct tagVCSourceDestinationInfo { int x0; union { struct { struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x0; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x1; struct { BOOL x0; unsigned short x1; } x2; } x0; struct { int x0; int x1; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x2; int x3; } x1; struct { unsigned int x0; struct { char x0; unsigned short x1; unsigned char x2; unsigned short x3; unsigned char x4; } x1; BOOL x2; } x2; struct { id x0; } x3; } x1; unsigned int x2; struct tagVCSourceDestinationInfo *x3; void *x4; } *)a0;
...
- (char)shouldNominateConnection:(id)a0;
- (void)updateAllBitrateCapsForConnection:(id)a0;
- (void)updateCellularMTU:(int)a0;
- (void)updateCellularTech:(int)a0 forLocalInterface:(char)a1;
...
- (int)updateStateWithCurrentConnection:(id)a0 asPrimary:(char)a1 interfaceMask:(int)a2 demote:(int *)a3 replaceOnly:(int *)a4;
