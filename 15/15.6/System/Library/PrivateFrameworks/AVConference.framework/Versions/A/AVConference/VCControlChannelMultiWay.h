...
@interface VCControlChannelMultiWay : VCControlChannel <VCControlChannelTransactionDelegate> {
    ...
    char _didSubmitCCReliableDataNotReceivedSymptom;
}
...
- (void)initializeSRTPInfo:(struct tagSRTPINFO { int x0; int x1; struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x2; struct _opaque_pthread_cond_t { long long x0; char x1[40]; } x3; unsigned int x4; unsigned int x5; unsigned short x6; unsigned short x7; unsigned short x8; unsigned int x9; unsigned int x10; unsigned long long x11; int x12; int x13; unsigned char x14[32]; unsigned char x15[14]; unsigned char x16[32]; unsigned char x17[14]; unsigned char x18[32]; struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x19; void *x20; void *x21; unsigned int x22; unsigned int x23; struct os_unfair_lock_s { unsigned int x0; } x24; struct tagSRTPCryptContext { struct _CCCryptor *x0; } x25; struct tagSRTPTransformPolicy { int x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; unsigned int x8; } x26; unsigned int x27; BOOL x28; } *)a0;
- (char)isParticipantActive:(unsigned long long)a0;
- (id)lastUsedMKIBytes;
- (void)messageReceived:(id)a0 participantInfo:(struct tagVCIDSChannelDataFormat { unsigned short x0[12]; unsigned char x1; BOOL x2; unsigned short x3; unsigned char x4; BOOL x5; BOOL x6; unsigned long long x7; BOOL x8; BOOL x9; BOOL x10; unsigned short x11; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x12; BOOL x13; BOOL x14; BOOL x15; unsigned long long x16; BOOL x17; unsigned short x18; BOOL x19; BOOL x20; BOOL x21; BOOL x22; } *)a1;
- (void)periodicTask:(void *)a0;
- (void)processParticipantRemoval:(id)a0;
- (int)protocolVersionforParticipantID:(id)a0;
- (void)registerPeriodicTask;
- (id)remoteParticipantIDFromChannelDataFormat:(struct tagVCIDSChannelDataFormat { unsigned short x0[12]; unsigned char x1; BOOL x2; unsigned short x3; unsigned char x4; BOOL x5; BOOL x6; unsigned long long x7; BOOL x8; BOOL x9; BOOL x10; unsigned short x11; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x12; BOOL x13; BOOL x14; BOOL x15; unsigned long long x16; BOOL x17; unsigned short x18; BOOL x19; BOOL x20; BOOL x21; BOOL x22; } *)a0;
...
- (char)sendReliableMessage:(id)a0 withTopic:(id)a1 participantID:(unsigned long long)a2 timeout:(unsigned int)a3 withOptions:(id)a4 completion:(id /* block */)a5;
- (char)sendReliableMessageAndWait:(id)a0 withTopic:(id)a1 participantID:(unsigned long long)a2;
- (char)sendReliableMessageAndWait:(id)a0 withTopic:(id)a1 participantID:(unsigned long long)a2 timeout:(id)a3 withOptions:(id)a4;
