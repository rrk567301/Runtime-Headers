...
@interface VCTransportSessionIDS : VCTransportSession {
    ...
    int _dataPath;
    char _useIDSLinkSuggestionFeatureFlag;
    unsigned int _linkPreferSuggestionFromDefaults;
    char _sessionBasedServerExperimentsProcessed;
}
...
- (char)getConnectionSetupData:(id *)a0 withOptions:(id)a1 error:(id *)a2;
...
- (id)initWithCallID:(unsigned int)a0 requireEncryptionInfo:(char)a1 reportingAgent:(id)a2 notificationQueue:(id)a3;
- (id)initWithCallID:(unsigned int)a0 requireEncryptionInfo:(char)a1 reportingAgent:(id)a2 notificationQueue:(id)a3 dataPath:(int)a4;
- (char)isIPv6;
