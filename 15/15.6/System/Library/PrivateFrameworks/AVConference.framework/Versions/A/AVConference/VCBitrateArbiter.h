...
- (void)updateMaxAllowedBitrate:(unsigned int *)a0 key:(struct __CFString { } *)a1 type:(id)a2 isAudio:(char)a3 carrierBundleBitrates:(struct __CFDictionary { } *)a4;
...
- (unsigned int)maxAllowedBitrateForConnectionType:(int)a0 arbiterMode:(unsigned char)a1;
- (unsigned int)maxAllowedBitrateForVCConnection:(id)a0 forLocalInterface:(char)a1;
- (unsigned int)maxAllowedBitrateForVCConnection:(id)a0 forLocalInterface:(char)a1 arbiterMode:(unsigned char)a2 encodeRule:(id)a3;
- (unsigned int)maxAllowedBitrateForVCConnection:(id)a0 forLocalInterface:(char)a1 encodeRule:(id)a2;
