...
@interface VCRedundancyControllerVideo : NSObject <VCRedundancyControllerProtocol> {
    ...
    int _type;
    char _isNWConnectionEnabled;
    int _btNotificationHandlerIndex;
    char _isUsingInternalStatisticsCollector;
}
...
- (void)dealloc;
- (id)initWithDelegate:(id)a0 mode:(unsigned int)a1 parameters:(struct VCRedundancyControllerVideoParameters_t { id x0; unsigned int x1; char x2; unsigned char x3; })a2;
