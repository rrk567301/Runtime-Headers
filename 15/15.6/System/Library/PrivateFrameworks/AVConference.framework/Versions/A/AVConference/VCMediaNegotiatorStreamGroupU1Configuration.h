...
+ (char)ssrcForStreamGroup:(unsigned int)a0 localConfig:(id)a1 ssrc:(unsigned int *)a2;
+ (void)updateBodyDataU1Config:(id)a0 bodyDataConfiguration:(id)a1;
+ (void)updateCameraU1Config:(id)a0 cameraConfiguration:(id)a1;
+ (char)updateCommonNegotiatedVideoSettings:(id)a0 localU1Config:(id)a1 remoteU1Config:(id)a2;
...
+ (char)updateVideoPayloadsAndParametersForU1Config:(id)a0;
