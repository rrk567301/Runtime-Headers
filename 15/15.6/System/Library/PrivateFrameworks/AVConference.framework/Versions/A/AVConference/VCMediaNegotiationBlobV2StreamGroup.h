...
@property (nonatomic) char hasStreamGroup;
...
@property (readonly, nonatomic) char hasSettingsU1;
...
+ (char)isValidStreamGroupIDFromConfig:(id)a0 defaultConfig:(id)a1;
+ (Class)payloadsType;
...
- (char)appendStreamsToStreamGroupConfig:(id)a0 streamGroupID:(unsigned int)a1 rtpSampleRates:(id)a2;
- (void)appendV2PayloadsToStreamConfig:(id)a0 streamGroupConfig:(id)a1;
- (void)clearPayloads;
- (unsigned char)codecIndexForType:(long long)a0 inPayloadConfigurations:(id)a1;
...
- (char)isDefaultPayloadConfigsWithStreamGroupConfig:(id)a0;
- (char)isUsedPayloadConfigAtIndex:(id)a0 streamGroupConfig:(id)a1 rtpTimestampRate:(unsigned int *)a2;
- (id)payloadsAtIndex:(unsigned long long)a0;
- (unsigned long long)payloadsCount;
- (void)printWithLogFile:(void *)a0 prefix:(id)a1;
- (char)setupPayloadsWithGroupConfig:(id)a0;
- (char)setupStreamsWithGroupConfig:(id)a0;
- (unsigned long long)streamsCount;
- (void)updateDefaultPayloadConfigsWithConfig:(id)a0 rtpSampleRates:(id)a1;
- (char)updatePayloadConfigsWithStreamGroupConfig:(id)a0 rtpSampleRates:(id)a1;
