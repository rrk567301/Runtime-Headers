...
- (char)clientProcessDiedWithXPCArguments:(id)a0 result:(id *)a1 error:(id *)a2;
...
- (char)getServerPidWithXPCArguments:(id)a0 result:(id *)a1 error:(id *)a2;
- (char)initializeStreamInputWithXPCArguments:(id)a0 result:(id *)a1 error:(id *)a2;
- (id)newStreamInputID;
- (char)pushSampleBufferWithXPCArguments:(id)a0 result:(id *)a1 error:(id *)a2;
...
- (char)terminateStreamInputWithXPCArguments:(id)a0 result:(id *)a1 error:(id *)a2;
