...
- (id)init;
- (id)destinations;
- (char)setupDatagramChannel:(id)a0 eventHandler:(id /* block */)a1 writeCompletionHandler:(id /* block */)a2 error:(id *)a3;
...
- (char)isEmulatedDatagramChannelEnabledViaDefaults;
