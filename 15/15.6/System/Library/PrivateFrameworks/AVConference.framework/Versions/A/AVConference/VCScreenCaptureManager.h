@class VCScreenShare, SCStream, VCScreenCapturePicker, NSString, NSMutableDictionary, NSObject, SCContentFilter;
...
- (char)isPickerClientProcessId:(id)a0;
...
- (void)pickerCancelled:(id)a0 forStream:(id)a1;
- (void)registerBlocksForService;
- (void)removePickerClientScreenShare:(id)a0;
- (void)screenCaptureStartFor:(id)a0 didSucceed:(char)a1 withError:(id)a2;
- (void)screenCaptureStopFor:(id)a0 didSucceed:(char)a1 withError:(id)a2;
- (id)screenShareDictionary:(id)a0;
- (char)shouldUpdateFilter:(id)a0;
