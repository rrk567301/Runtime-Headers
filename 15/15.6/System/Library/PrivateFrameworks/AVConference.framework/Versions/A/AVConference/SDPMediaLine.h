...
@property (readonly, nonatomic) char allowRTCPFB;
...
- (char)supportImage:(id)a0 width:(int)a1 height:(int)a2 rate:(int)a3;
...
- (char)videoDisplayAttribute:(int *)a0 withHeight:(int *)a1;
