...
- (char)dispatchedUnregisterListenerWithCellularTapType:(id)a0 powerSpectrumMeter:(id)a1 error:(id *)a2;
...
- (char)registerListenerWithCellularTapType:(id)a0 clientProcessId:(id)a1 enableAsyncTapStart:(char)a2 powerSpectrumMeter:(id)a3 powerSpectrumMeterKey:(id)a4 resultDictionary:(id *)a5 error:(id *)a6;
- (char)registerListenerWithStreamToken:(id)a0 powerSpectrumKey:(id)a1 powerSpectrumMeter:(id)a2 error:(id *)a3;
- (id)registerStreamTokenForCellularTapType:(id)a0 clientProcessId:(int)a1 enableAsyncTapStart:(char)a2 error:(id *)a3;
- (void)serverDidDie;
