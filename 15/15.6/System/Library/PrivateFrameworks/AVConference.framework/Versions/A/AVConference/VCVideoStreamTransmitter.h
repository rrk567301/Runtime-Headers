...
- (char)isKeyFrame:(struct opaqueCMSampleBuffer { } *)a0;
- (char)prependSPSPPS:(unsigned long long *)a0 dataPointer:(char *)a1 sampleBuffer:(struct opaqueCMSampleBuffer { } *)a2;
