@class NSObject, NSString, NSDictionary, NSLock, VCMockIDSDataChannelLinkContext;
...
@interface VCMockIDSDatagramChannel : IDSDatagramChannel {
    ...
    char _doNotDropNackOrRetransmitted;
    ...
    struct { unsigned int options_flags; unsigned long long participantID; unsigned short probeGroupID; unsigned char channelPriority; char streamIDCount; unsigned short streamIDs[12]; unsigned char generationCounterLSB; unsigned short statsID; struct { unsigned short serverTimestamp; unsigned short serverPacketInterval; unsigned short totalServerPacketReceived; unsigned short totalServerPacketSent; unsigned short uplinkBandwidth; } statsPayload; double arrivalTime; unsigned long long expireTimestamp; char encryptedHBH; unsigned long long encryptionSequenceNumber; unsigned char packetUUID[16]; char retransmittedPacket; char nonRetransmittablePacket; } _packetDatagramOptions[2048];
    char _isServerStatsCached;
    struct { unsigned int options_flags; unsigned long long participantID; unsigned short probeGroupID; unsigned char channelPriority; char streamIDCount; unsigned short streamIDs[12]; unsigned char generationCounterLSB; unsigned short statsID; struct { unsigned short serverTimestamp; unsigned short serverPacketInterval; unsigned short totalServerPacketReceived; unsigned short totalServerPacketSent; unsigned short uplinkBandwidth; } statsPayload; double arrivalTime; unsigned long long expireTimestamp; char encryptedHBH; unsigned long long encryptionSequenceNumber; unsigned char packetUUID[16]; char retransmittedPacket; char nonRetransmittablePacket; } _datagramOptionsCached;
    NSObject<OS_dispatch_queue> *_directPathReadQueue;
    NSObject<OS_dispatch_queue> *_directPathRTXQueue;
    char _isSourceParticipantIDOnFanOutPacketsEnabled;
    char _isWrongParticipantIDOnFanOutPacketsEnabled;
    char _isECNEnabled;
    char _isShortMKIEnabled;
    NSString *_destination;
    char _isTestNetworkRouterEnabled;
    char _isTwoWayFaceTimeTestUsingSocketsEnabled;
    struct tagVCRealTimeThread { unsigned int x0; unsigned int x1; struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x2; id x3; void /* function */ *x4; void *x5; struct OpaqueFigThread *x6; int x7; char x8[60]; unsigned int x9; unsigned int x10; } *_packetReceiveThread;
    _Atomic BOOL _isReceiveThreadTerminating;
}

@property (readonly) char idsUPlusOneMode;
...
- (void)setUPlusOneMode:(char)a0 isInitiator:(char)a1;
...
- (void)addMediaPacketToBuffer:(char *)a0 length:(unsigned long long)a1 datagramOptions:(struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; })a2;
- (struct _VCMockIDSDatagramChannelPacket { struct _VCSingleLinkedListEntry { struct _VCSingleLinkedListEntry *x0; } x0; unsigned char x1[1500]; unsigned long long x2; char x3; struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } x4; unsigned long long x5; } *)constructPacket:(struct _VCMockIDSDatagramChannelPacket { struct _VCSingleLinkedListEntry { struct _VCSingleLinkedListEntry *x0; } x0; unsigned char x1[1500]; unsigned long long x2; char x3; struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } x4; unsigned long long x5; } *)a0 datagram:(const void *)a1 datagramSize:(unsigned int)a2 datagramOptions:(struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } *)a3;
- (char)createSocketWithSourcePort:(short)a0;
- (void)dequeueDatagramPacket:(id /* block */)a0;
- (int)drainUnderlyingFileDescriptor;
- (id)encryptionInfoEventWithIsLocalKey:(char)a0;
- (char)enqueueDatagramPacket:(const void *)a0 datagramSize:(unsigned int)a1 options:(struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } *)a2 error:(id *)a3;
- (void)flushDatagramPacketsList;
- (void)flushDatagramPacketsListDIrectIDSPath;
- (void)handlePacket:(struct _VCMockIDSDatagramChannelPacket { struct _VCSingleLinkedListEntry { struct _VCSingleLinkedListEntry *x0; } x0; unsigned char x1[1500]; unsigned long long x2; char x3; struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } x4; unsigned long long x5; } *)a0 packetHandler:(id /* block */)a1 shouldDropThisPacket:(char)a2;
- (id)initCreateSocketRequiresOptions:(char)a0 dataPath:(int)a1 destination:(id)a2;
- (id)initRequiresOptions:(char)a0;
- (char)isControlChannelDatagram:(struct _VCMockIDSDatagramChannelPacket { struct _VCSingleLinkedListEntry { struct _VCSingleLinkedListEntry *x0; } x0; unsigned char x1[1500]; unsigned long long x2; char x3; struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } x4; unsigned long long x5; } *)a0;
- (char)isMediaPacket:(char *)a0 length:(unsigned long long)a1;
- (char)isNACKPacket:(char *)a0 length:(unsigned long long)a1;
- (char)isRTCPPacket:(char *)a0 length:(unsigned long long)a1;
- (char)isVideoPacket:(char *)a0 length:(unsigned long long)a1;
...
- (char)setupMockIDSDatagramChannelRequiresOptions:(char)a0 sourcePort:(short)a1;
- (id)shortMKIPrefixLength;
- (char)shouldReadPacket:(struct _VCMockIDSDatagramChannelPacket { struct _VCSingleLinkedListEntry { struct _VCSingleLinkedListEntry *x0; } x0; unsigned char x1[1500]; unsigned long long x2; char x3; struct { unsigned int x0; unsigned long long x1; unsigned short x2; unsigned char x3; char x4; unsigned short x5[12]; unsigned char x6; unsigned short x7; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x8; double x9; unsigned long long x10; char x11; unsigned long long x12; unsigned char x13[16]; char x14; char x15; } x4; unsigned long long x5; } *)a0;
