...
- (char)enqueueSampleBuffer:(struct __CVBuffer { } *)a0 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1;
- (void)registerBlocksForNotifications;
- (char)setupRemoteReceiverQueueWithSenderQueue:(id)a0;
