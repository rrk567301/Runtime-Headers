...
@interface VCImageQueue : NSObject <VCStreamOutputSource> {
    ...
    char _lastEffectsEnabled;
    int _cameraFacing;
}

@property unsigned int frameRate;
@property char imageQueueProtected;
@property long long streamToken;
@property (readonly) char usingRemoteQueue;
@property (nonatomic, getter=isLayerHostMode) char layerHostMode;
@property (nonatomic, getter=isLowLatencyEnabled) char lowLatencyEnabled;
@property (nonatomic, getter=isTransformForRemoteVideoOrientationEnabled) char transformForRemoteVideoOrientationEnabled;
@property (nonatomic) char isExternalCamera;
...
- (id)initWithFrameRate:(unsigned char)a0 imageQueueProtected:(char)a1;
- (id)initWithFrameRate:(unsigned char)a0 imageQueueProtected:(char)a1 vcImageQueueConfig:(const struct tagVCImageQueueConfig { char x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; char x2; char x3; int x4; } *)a2;
