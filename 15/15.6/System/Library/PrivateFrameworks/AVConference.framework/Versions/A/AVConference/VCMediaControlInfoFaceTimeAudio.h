@interface VCMediaControlInfoFaceTimeAudio : VCMediaControlInfo {
    ...
    struct { unsigned short timeStamp; unsigned short bandwithEstimation; unsigned short videoBurstLoss; unsigned short videoReceviedPkts; unsigned short audioBurstLoss; unsigned short audioReceviedPkts; unsigned int totalReceivedKBytes; unsigned int receiveQueueTarget; unsigned int queuingDelay; unsigned short sendTimestamp; unsigned int owrd; unsigned int connectionStatsBuffer; unsigned short ecnECT1Count; unsigned short ecnCECount; } _controlFeedbackParameter;
    unsigned short _controlInfoSequenceNumber;
    char _controlInfoIsDuplicatePacket;
    char _controlInfoIsReceivedOnPrimary;
    unsigned char _controlInfoECNByte;
    char _isFeedbackReceivedOnRelay;
}

@property (readonly) unsigned long long feedbackSize;
@property char videoEnabled;
@property char ecnEnabled;

- (id)description;
- (id)init;
- (unsigned long long)serializedSize;
- (int)configureWithBuffer:(const char *)a0 length:(unsigned long long)a1 optionalControlInfo:(struct { double x0; int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned short x7; BOOL x8; BOOL x9; unsigned char x10; BOOL x11; } *)a2;
...
- (int)handleOptionalControlInfo:(struct { double x0; int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned short x7; BOOL x8; BOOL x9; unsigned char x10; BOOL x11; } *)a0;
- (char)hasInfoType:(unsigned int)a0;
- (id)initWithBuffer:(const char *)a0 length:(unsigned long long)a1 optionalControlInfo:(struct { double x0; int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned short x7; BOOL x8; BOOL x9; unsigned char x10; BOOL x11; } *)a2 version:(unsigned char)a3;
