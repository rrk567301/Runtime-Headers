...
@property (readonly, nonatomic) char supportVCPDecoderHEVC;
@property (readonly, nonatomic) char supportVCPEncoderHEVC;
@property (readonly, nonatomic) char vcpInitializedForHEVC;
