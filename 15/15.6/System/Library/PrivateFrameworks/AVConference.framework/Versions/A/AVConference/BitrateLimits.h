...
- (unsigned long long)defaultValueForNetwork:(char)a0;
- (id)initWithOperatingMode:(unsigned char)a0 withBitrateCap:(unsigned long long)a1 useCaseWatchContinuity:(char)a2;
