...
@interface VCMacScreenCaptureScreenCaptureKit : VCObject <SCStreamDelegate, SCStreamOutput, VCMacScreenCaptureSource> {
    ...
    char _useScreenCaptureKitPicker;
...
- (char)addAudioOutputWithConfig:(id)a0;
- (void)callbackWithEventString:(id)a0;
- (char)createPixelTransferSessionFromConfig:(id)a0;
...
- (char)updateSystemAudioWithConfig:(id)a0;
