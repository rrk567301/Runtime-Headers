...
@interface VCMediaStreamSendGroup : VCMediaStreamGroup {
    ...
    char _shouldSynchronizeWithSourceRTPTimestamps;
    ...
    char _isSourceTimestampInfoAvailable;
...
- (char)dispatchedEnableRedundancy:(char)a0;
- (id)dispatchedMediaStreamInfosForEndToEndConnection:(char)a0;
...
- (void)dispatchedUpdateStreamsWithActiveConnection:(id)a0;
...
- (char)setStreamGroupMode:(unsigned int)a0;
- (char)setupStreamGroupWithConfig:(id)a0;
- (char)shouldCompoundListIgnoreStream:(id)a0 streamConfig:(id)a1 activeStreamIds:(id)a2;
- (char)shouldSubscribeToStreamID:(id)a0 peerSubscribedStreams:(id)a1;
...
- (char)updateConfig:(id)a0 forMode:(unsigned int)a1;
- (void)updateEnabledState;
- (void)updateEncryptionInformationWithConfig:(id)a0;
- (char)updatePeerSubscribedStreams:(id)a0 containsRepairStreams:(char)a1;
...
- (char)updateUplinkStreamsForPeerSubscribedStreams:(id)a0;
- (char)v2PayloadsAllowed;
