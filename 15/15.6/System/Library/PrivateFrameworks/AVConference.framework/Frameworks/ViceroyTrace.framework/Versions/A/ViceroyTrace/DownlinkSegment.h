...
@property char isRTXTelemetryAvailable;
...
@property char serverPacketRetransmissionsForVideoEnabled;
@property char serverPacketRetransmissionsExtraDelayBudgetEnabled;
...
@property char rtcpPSFBForLossFeedbackEnabled;
@property char rtcpPSFBForLtrAckEnabled;
...
@property char reportNetworkCapabilities;
@property char isUplinkRetransmissionEnabled;
...
- (void)processVideoDegraded:(char)a0 forParticipant:(id)a1 streamGroup:(id)a2 timestamp:(double)a3;
