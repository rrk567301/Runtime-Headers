@class VCReportingHistogram, NSString, CallSegment, VCDurationHistogram, NSSet;
...
@interface VCAggregatorFaceTime : VCAggregator <VCAdaptiveLearningDelegate> {
    ...
    char _didSwitchFromOneToOne;
    char _didSwitchFromGFT;
    ...
    char _localAlertActive;
    char _remoteAlertActive;
    ...
    char rtcpPSFBForLossFeedbackEnabled;
    char rtcpPSFBForLtrAckEnabled;
...
- (void)processWindowMode:(id)a0 responseCode:(int)a1;
...
- (void)dispatchedUpdateRoleModeTransport:(unsigned short)a0 deviceRole:(unsigned short)a1 transportType:(unsigned short)a2 isInitiator:(char)a3 isWalkieTalkieMode:(char)a4;
- (void)flushCurrentSegment;
- (void)flushCurrentSegment:(id)a0;
- (id)initWithDelegate:(id)a0 nwParentActivity:(id)a1 conversationTimeBase:(id)a2;
- (char)isDuplicationChangedForEventType:(unsigned short)a0;
- (double)markHandshakeCompletion:(id)a0;
- (void)markHandshakeStart:(id)a0;
- (void)processBackgroundReplacementStatus:(id)a0;
...
- (void)processEventTriggerForNewSegment:(id)a0;
...
- (void)processThermalLevelChange:(id)a0 withTime:(double)a1;
- (void)saveCallSegmentHistory;
- (void)setNWActivityReportingEnabled:(BOOL)a0;
- (void)setupAdaptiveLearningWithParameters:(id)a0;
- (char)shouldReportWithCallErrorCode:(unsigned int)a0;
- (void)startNewSegment:(id)a0;
- (void)transferActiveSegmentStatus:(id)a0;
...
- (void)updateConnectionSubTimes:(id)a0;
- (void)updateConnectionTelemetry:(id)a0;
- (void)updateCoreMotionActivityWithPayload:(id)a0;
- (void)updateCurrentMediaBitratesWithPayload:(id)a0;
