...
@interface VCAggregator : VCReportingCommon <VCAdaptiveLearningDelegate> {
    ...
    char _useNwActivitySubmitMetrics;
    NSDate *_conversationTimeBase;
    int _startDate;
    long long _onceAggregatedReportsToken;
    char _isNWActivityReportingEnabled;
    NSMutableArray *_idsReportingBlobs;
    char _reportRateControlExperiment;
    ...
    char _serverPacketRetransmissionsForVideoEnabled;
    char _serverPacketRetransmissionsExtraDelayBudgetEnabled;
    ...
    int _transportType;
    char _shouldReportLowLatencyInterfaceStatistics;
    char _rtcpPSFBForLossFeedbackEnabled;
    char _rtcpPSFBForLtrAckEnabled;
    char _fecEnabled;
    char _isQUICPod;
    char _isRemoteQUICPod;
    char _isTLEABTestEnabled;
    char _isInitiator;
...
@property (readonly) char isOneToOneMode;
...
- (char)didUpdateStringFrom:(id *)a0 toString:(id)a1;
...
- (char)hasQRServerPrefix:(id)a0;
- (char)hasQRServerSessionPrefix:(id)a0;
...
- (char)isApplePersonalHotspotAndUpdatePhyMode;
- (char)isLocalInterfaceTypeForSegment:(id)a0 equalTo:(id)a1;
...
- (char)serverPacketRetransmissionsExtraDelayBudgetEnabled;
- (char)serverPacketRetransmissionsForVideoEnabled;
