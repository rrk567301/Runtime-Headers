...
@property char reportRateControlExperiment;
@property char lastUsableLinkReceivedAfterReconnect;
@property unsigned long long reconnectCount;
@property char isDuplicationPossible;
...
@property char isLocalCelltechDirty;
...
@property char shouldReportBIFPercentage;
...
@property char isApplePersonalHotspot;
@property (copy) NSString *localPHYMode;
@property char isQUICPod;
@property char isRemoteQUICPod;
@property char isTLEABTestEnabled;
...
- (void)endDataModeDuration:(unsigned int *)a0 totalTime:(unsigned int *)a1 time:(double)a2 hasStartedCalculating:(char *)a3;
...
- (void)startDataModeDuration:(unsigned int *)a0 totalTime:(unsigned int *)a1 time:(double)a2 hasStartedCalculating:(char *)a3;
