@class VCReportingHistogram, NSString, VCReportingHistogram2D, VCDurationHistogram, NSSet, NSMutableDictionary, NSDictionary, NSDate, NSObject, NSNumber;
...
@property char remoteFaceTimeSwitchesAvailable;
...
@property char spatialAudioSupported;
...
- (void)updateRelayedCallTypeForSegment:(id)a0;
