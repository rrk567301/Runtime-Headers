...
@property char callStarted;
@property char RTStatsReceived;
...
- (id)computeLossRate:(unsigned int)a0 totalPackets:(unsigned int)a1;
- (double)computeMax:(id)a0;
...
- (char)sendAnalyticsAudioDistortionRadioHistogramEvent:(id)a0;
- (char)sendAnalyticsAudioDistortionStatisticsEvent:(id)a0;
- (char)sendAnalyticsAudioDistortionSummaryEvent:(id)a0;
- (char)sendAnalyticsAudioFrameCountStatisticsEvent:(id)a0;
- (char)sendAnalyticsDetailedVoiceCallEvent;
- (char)sendAnalyticsSummaryVoiceCallEvent;
...
- (char)wifiCallingAddSamplesGenerateAndSendCallEndReport:(id)a0;
