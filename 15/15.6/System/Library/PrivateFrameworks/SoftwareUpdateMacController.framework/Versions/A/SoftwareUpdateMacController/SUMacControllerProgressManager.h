...
@property (nonatomic) char performingBridgeOSUpdate;
@property (nonatomic) char performingSFRUpdate;
@property (nonatomic) char performingRecoveryOSUpdate;
...
- (id)initWithCommand:(id)a0 clientID:(id)a1 descriptor:(id)a2 performingBridgeOSUpdate:(char)a3 performingSFRUpdate:(char)a4 performingRecoveryOSUpdate:(char)a5;
- (id)lastReportedSUCoreProgress;
- (char)phaseShowsEstimatedTime:(id)a0;
- (char)phaseShowsExtrapolatedPrepareEstimatedTimeRemaining:(id)a0;
...
- (id)progressTable;
- (id)reportProgressForPhase:(id)a0 portionComplete:(float)a1 disableVerboseLogging:(char)a2 desc:(id)a3;
- (id)reportProgressForPhase:(id)a0 portionComplete:(float)a1 fromProgress:(id)a2 disableVerboseLogging:(char)a3 desc:(id)a4;
