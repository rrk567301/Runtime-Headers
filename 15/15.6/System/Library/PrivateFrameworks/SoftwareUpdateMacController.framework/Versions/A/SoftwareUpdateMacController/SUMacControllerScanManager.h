...
- (char)_processMajorRosettaUpdateResult:(char)a0 version:(id)a1 underlyingError:(id)a2 eventInfo:(id)a3;
- (char)_processMinorRosettaUpdateResult:(char)a0 version:(id)a1 underlyingError:(id)a2 eventInfo:(id)a3;
...
- (float)_progressPercentForPhase:(int)a0 atStart:(char)a1;
