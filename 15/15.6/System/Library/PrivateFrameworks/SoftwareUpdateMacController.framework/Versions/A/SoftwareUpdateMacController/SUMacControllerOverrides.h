...
@property (nonatomic) char allowSameSplatRestoreVersion;
@property (nonatomic) char checkAvailableSpace;
...
@property (nonatomic) char usesSFRSoftwareUpdates;
@property (nonatomic) char usesRosettaUpdates;
@property (nonatomic) char usesRecoveryOSUpdates;
@property (nonatomic) char usesSplatComboUpdates;
...
@property (nonatomic) char requirePreparePackageRosettaUpdates;
@property (nonatomic) char attemptPreparePackageRosettaUpdates;
...
@property (nonatomic) char bridgeOSAllowTestMode;
@property (nonatomic) char bridgeOSStagedUpdatesOnly;
@property (nonatomic) char bridgeOSAllowAnyCatalogCertificate;
@property (nonatomic) char bridgeOSIgnoreMinimumVersionCheck;
...
@property (nonatomic) char enableEmbeddedOSInstall;
@property (nonatomic) char enableBridgeOSInstall;
@property (nonatomic) char enableOSPersonalization;
...
@property (nonatomic) char skipVolumeSealing;
@property (nonatomic) char cancelUpdateOnClientDisconnect;
@property (nonatomic) long long qualityOfService;
@property (nonatomic) char disableRootVolumeSealCheck;
