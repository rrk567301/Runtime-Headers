...
+ (char)recoveryOSUpdateSupportedWithOverrides:(id)a0 coreDescriptor:(id)a1;
...
- (void)_callCompletion:(id /* block */)a0 success:(char)a1 required:(char)a2 updateInfo:(id)a3 error:(id)a4;
