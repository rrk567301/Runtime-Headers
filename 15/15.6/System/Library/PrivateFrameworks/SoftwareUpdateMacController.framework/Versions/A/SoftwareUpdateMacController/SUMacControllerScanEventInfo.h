...
@property (nonatomic) char performSplatUpdate;
@property (nonatomic) char performMajorBridgeOSUpdate;
@property (nonatomic) char performMinorBridgeOSUpdate;
@property (nonatomic) char performMajorRosettaUpdate;
@property (nonatomic) char performMinorRosettaUpdate;
...
@property (nonatomic) char performMajorRecoveryOSUpdate;
@property (nonatomic) char performMinorRecoveryOSUpdate;
@property (nonatomic) char majorRecoveryOSUpdateRequired;
@property (nonatomic) char minorRecoveryOSUpdateRequired;
...
@property (nonatomic) char scanFailed;
