...
- (id)summary;
- (void)_callDownloadCompletion:(id /* block */)a0 success:(char)a1 error:(id)a2;
- (void)_callDownloadProgressBlock:(id /* block */)a0 withProgress:(id)a1;
- (void)_callScanCompletion:(id /* block */)a0 performUpdate:(char)a1 version:(id)a2 withError:(id)a3;
