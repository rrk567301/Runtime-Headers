...
@property (nonatomic, getter=isStartDiscoveringPending) char startDiscoveringPending;
@property (nonatomic, getter=isStopDiscoveringPending) char stopDiscoveringPending;
...
- (void)_didDeterminePairingStateForAccessory:(id)a0 isPaired:(char)a1 completion:(id /* block */)a2;
