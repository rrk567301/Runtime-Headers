...
@property (nonatomic) char startPairingRequested;
@property (nonatomic) char pairingFeaturesRead;
@property (nonatomic) unsigned long long pairingFeatureFlags;
@property (retain, nonatomic) HAPSecuritySession *securitySession;
@property (nonatomic, getter=isSecuritySessionOpening) char securitySessionOpening;
...
@property (nonatomic, getter=isDisconnecting) char disconnecting;
@property (nonatomic) char unpairedIdentifyRequested;
@property (copy, nonatomic) id /* block */ unpairedIdentifyCompletionBlock;
@property (nonatomic) char removeOnDisconnect;
...
+ (id)deserializeCharacteristicReadData:(id)a0 characteristicFormat:(unsigned long long)a1 supportsAdditionalAuthentication:(char)a2 error:(id *)a3;
+ (id)serializeCharacteristicWriteValue:(id)a0 characteristicFormat:(unsigned long long)a1 supportsAdditionalAuthentication:(char)a2 authenticationData:(id)a3 error:(id *)a4;
...
- (void)_addPairingWithIdentifier:(id)a0 publicKey:(id)a1 admin:(char)a2 queue:(id)a3 completion:(id /* block */)a4;
...
- (void)_enqueueOperation:(long long)a0 identifier:(id)a1 publicKey:(id)a2 admin:(char)a3 queue:(id)a4 completion:(id /* block */)a5;
...
- (void)_handlePairingsReadForCharacteristic:(id)a0 readError:(id)a1 removing:(char)a2 queue:(id)a3 completion:(id /* block */)a4;
- (void)_handlePairingsWriteForCharacteristic:(id)a0 writeError:(id)a1 removing:(char)a2 queue:(id)a3 completion:(id /* block */)a4;
...
- (char)_parseBTLECharacteristicDescriptor:(id)a0 existingDescriptors:(id)a1 characteristics:(id)a2;
