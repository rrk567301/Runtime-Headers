...
@property (readonly, nonatomic) char hasDiscoveryAdvertisement;
...
@property (nonatomic) char hasDiscoveryAdvertisement;
...
- (void)handleLostDiscoveryAdvertisementWithWillSleep:(char)a0;
