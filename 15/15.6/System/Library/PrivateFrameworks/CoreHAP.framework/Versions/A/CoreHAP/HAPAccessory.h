...
@property (nonatomic) char shouldDisconnectOnIdle;
...
+ (char)isAccessoryPairedWithIdentifier:(id)a0;
+ (char)isAccessoryPrimaryWithUniqueIdentifier:(id)a0;
...
- (char)updateForAccessoryInformationService;
