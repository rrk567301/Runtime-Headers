...
@property (nonatomic) char stateChanged;
...
- (id)initWithPeripheral:(id)a0 name:(id)a1 pairingUsername:(id)a2 statusFlags:(id)a3 stateNumber:(id)a4 stateChanged:(char)a5 connectReason:(unsigned char)a6 configNumber:(id)a7 category:(id)a8 setupHash:(id)a9 connectionIdleTime:(unsigned char)a10 browser:(id)a11 keyStore:(id)a12 whbStableIdentifier:(id)a13;
- (char)isReadyForOperation:(long long)a0;
- (id)readAndResetHAPMetrics:(char)a0;
- (void)updateConnectionIdleTime:(unsigned char)a0;
- (void)updatePeripheral:(id)a0;
- (char)updatePeripheralIdentifier:(id *)a0 isPairing:(char)a1;
- (char)updateResumeSessionID:(unsigned long long)a0;
