...
@property (nonatomic, getter=isInternallyPaired) char internallyPaired;
...
@property (nonatomic, getter=shouldSkipUserConsent) char skipUserConsent;
...
@property (nonatomic, getter=shouldDiscoverAccessoriesOncePaired) char discoverAccessoriesOncePaired;
...
- (char)_hap2CharacteristicTuplesForHAPCharacteristics:(id)a0 tuples:(id *)a1 error:(id *)a2;
- (id)_hapIdentifierForAccessory:(id)a0;
- (void)_informDelegateOfUpdatedAccessories:(id)a0 error:(id)a1;
- (char)_isActiveServer:(id)a0;
...
- (void)setSessionInfoWithNumIPsResolved:(unsigned long long)a0 numIPsTried:(unsigned long long)a1 numBonjourNames:(unsigned long long)a2 ipAddress:(id)a3 serviceName:(id)a4 resolveAttempted:(char)a5;
- (void)setShouldBePaired:(char)a0;
- (id)setupHash;
