...
- (void)resetSession;
- (id)logIdentifier;
- (void)_handleAuthExchangeData:(id)a0 withHeader:(char)a1;
- (void)_handleTokenResponse:(id)a0 withHeader:(char)a1;
- (void)_handleTokenUpdateResponse:(id)a0 withHeader:(char)a1;
- (void)_reportAuthFailure;
- (void)_resetSession;
- (void)_sendTokenRequest;
- (void)_sendTokenUpdateRequest:(id)a0;
- (void)continueAuthAfterValidation:(char)a0;
- (char)getToken:(id *)a0 uuid:(id *)a1;
- (void)handleAuthExchangeData:(id)a0 withHeader:(char)a1;
