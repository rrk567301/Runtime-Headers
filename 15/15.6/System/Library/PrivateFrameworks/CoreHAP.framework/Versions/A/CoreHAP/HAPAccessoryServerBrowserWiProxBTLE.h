...
@property char scanInBackground;
...
- (void)_startTrackingHAPBLEAccessoriesWithIdentifiers:(id)a0 restartScan:(char)a1;
- (void)_stopBrowsingForHAPBLEAccessories:(char)a0;
- (void)_stopScanning;
...
- (char)removeTrackedPeripheralWithStableIdentifier:(id)a0;
- (void)resetLastSeenForTrackedAccessories:(id)a0;
- (void)restartScans;
- (void)retrieveStateForTrackedAccessoryWithIdentifier:(id)a0 stateNumber:(id *)a1 isReachable:(char *)a2 linkQuality:(unsigned long long *)a3 lastSeen:(id *)a4;
- (void)startBrowsingForHAPBLEAccessories;
- (void)startTrackingHAPBLEAccessoriesWithIdentifiers:(id)a0;
- (void)stopBrowsingForHAPBLEAccessories:(char)a0;
