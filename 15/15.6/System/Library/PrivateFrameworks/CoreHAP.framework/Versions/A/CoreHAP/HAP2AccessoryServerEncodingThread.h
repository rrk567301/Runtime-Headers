...
- (id)readRequestForAttributeDatabaseWithEncryption:(char)a0 error:(id *)a1;
- (id)readRequestForCharacteristics:(id)a0 shouldEncrypt:(char)a1 error:(id *)a2;
...
- (id)writeRequestForCharacteristics:(id)a0 shouldEncrypt:(char)a1 error:(id *)a2;
