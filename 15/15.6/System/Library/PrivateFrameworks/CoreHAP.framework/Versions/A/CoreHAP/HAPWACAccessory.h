...
@property (readonly, nonatomic) char supportsLegacyWAC;
@property (readonly, nonatomic) char supportsWAC2;
@property (readonly, nonatomic) char supportsTokenAuth;
@property (readonly, nonatomic) char supportsCertAuth;
@property (readonly, nonatomic) char requiresOwnershipToken;
@property (readonly, nonatomic) char isHomeKitAccessory;
@property (readonly, nonatomic) char isAirPlayAccessory;
@property (readonly, nonatomic) unsigned long long supportedWiFiBands;
@property (readonly, nonatomic) char homeKitPaired;
@property (readonly, nonatomic) char pairSetupWAC;
