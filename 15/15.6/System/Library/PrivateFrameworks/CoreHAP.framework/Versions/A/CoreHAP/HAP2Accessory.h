...
+ (char)validateAccessoryInformationService:(id)a0;
+ (char)validateDiscoveredServices:(id)a0 isPrimary:(char)a1;
+ (char)validateProtocolInformationService:(id)a0;
...
- (char)updateDiscoveredServices:(id)a0;
