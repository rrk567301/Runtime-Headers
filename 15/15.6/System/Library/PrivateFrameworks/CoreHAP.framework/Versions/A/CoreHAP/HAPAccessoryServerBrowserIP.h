...
- (id)serverWithIdentifier:(id)a0 ignoreLPM:(char)a1;
...
- (void)_invalidateAccessoryServers:(char)a0;
...
- (int)_purgePendingBonjourEvents:(id)a0 withProcessing:(char)a1;
- (int)_server:(id *)a0 forBonjourDevice:(id)a1;
- (void)_setReachability:(char)a0 forServer:(id)a1;
...
- (void)stopDiscoveringWACAccessoryServersWithInvalidation:(char)a0;
