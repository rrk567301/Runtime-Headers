...
@property (nonatomic, getter=isConfirming) char confirming;
...
- (void)_updateArraysForDiscoveredAccessoryServer:(id)a0 paired:(char)a1 lost:(id *)a2 existing:(id *)a3;
...
- (char)onDemandConnectionsAreEnabled;
