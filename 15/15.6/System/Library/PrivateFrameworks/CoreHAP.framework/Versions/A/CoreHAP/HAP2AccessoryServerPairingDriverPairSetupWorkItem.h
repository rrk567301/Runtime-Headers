...
@property (nonatomic, getter=isInvalidSetupCode) char invalidSetupCode;
...
- (char)pairSetupSession:(id)a0 didPairWithPeer:(id)a1 error:(id *)a2;
- (char)pairSetupSession:(id)a0 didReceiveBackoffRequestWithTimeInterval:(double)a1;
