...
@property (readonly, nonatomic, getter=isContinuationPacket) char continuationPacket;
...
- (id)initWithControlType:(unsigned char)a0 transactionIdentifier:(id)a1 continuationPacket:(char)a2 packetPayload:(id)a3 maximumLength:(unsigned long long)a4;
