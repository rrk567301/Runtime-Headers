...
@property (readonly, nonatomic) char hasPairings;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithDeviceID:(id)a0 hasPairings:(char)a1 protocolVersion:(id)a2 name:(id)a3 model:(id)a4 category:(unsigned long long)a5 stateNumber:(unsigned short)a6 configNumber:(unsigned short)a7 setupHash:(id)a8;
