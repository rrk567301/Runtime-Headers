...
@property (nonatomic) char hasValidCache;
...
@property (nonatomic, getter=isBadSetupCode) char badPairSetupCode;
@property (copy, nonatomic) id /* block */ setupCodeCompletionHandler;
@property (nonatomic, getter=isPairing) char pairing;
...
@property (readonly, nonatomic) char hasBeenDiscovered;
...
+ (id)logCategory;
+ (char)parseWriteResponse:(id)a0 value:(id *)a1 error:(id *)a2;
+ (id)signatureRequestForCharacteristic:(id)a0 requiresAuthentication:(char)a1 error:(id *)a2;
+ (id)configurationRequestForCharacteristic:(id)a0 isBroadcasted:(char)a1 interval:(unsigned long long)a2 error:(id *)a3;
...
+ (char)isHAPDescriptor:(id)a0;
+ (char)isHAPService:(id)a0;
+ (char)parseCharacteristicConfigurationResponse:(id)a0 error:(id *)a1;
+ (char)parseProtocolConfigurationResponse:(id)a0 key:(id *)a1 stateNumber:(id *)a2 error:(id *)a3;
+ (char)parseReadResponse:(id)a0 value:(id *)a1 notificationContext:(id *)a2 error:(id *)a3;
...
+ (id)signatureRequestForService:(id)a0 characteristic:(id)a1 requiresAuthentication:(char)a2 error:(id *)a3;
...
- (void)_enableBroadcastEvent:(char)a0 interval:(unsigned long long)a1 forCharacteristic:(id)a2 completionHandler:(id /* block */)a3;
- (void)_enableEvent:(char)a0 forCharacteristic:(id)a1 withCompletionHandler:(id /* block */)a2 queue:(id)a3;
- (void)_enableEvent:(char)a0 toCharacteristic:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)_enqueueRequest:(id)a0 shouldPrioritize:(char)a1;
...
- (char)_parsePairingFeaturesCharacteristic:(id)a0 authMethod:(unsigned long long *)a1 error:(id *)a2;
- (id)_parseService:(id)a0 error:(id *)a1;
- (id)_pendingRequestForCharacteristic:(id)a0;
- (id)_pendingResponseForRequest:(id)a0;
- (void)_performEnableEvent:(char)a0 toCharacteristic:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)_sendRequest:(id)a0 shouldPrioritize:(char)a1 responseHandler:(id /* block */)a2;
- (id)_serviceCacheFromHAPService:(id)a0 serviceOrder:(unsigned long long)a1;
- (id)_serviceForCBService:(id)a0;
- (char)_shouldIgnoreRetryDiscoveryError:(id)a0;
...
- (char)isHAPCharacteristic:(id)a0;
...
- (char)removePairingForCurrentControllerOnQueue:(id)a0 completion:(id /* block */)a1 serverPairingCompletion:(id /* block */)a2;
...
- (void)setHasBeenDiscovered:(char)a0;
- (void)setSecuritySessionOpen:(char)a0;
- (char)shouldVerifyHAPCharacteristic:(id)a0;
- (char)shouldVerifyHAPService:(id)a0;
