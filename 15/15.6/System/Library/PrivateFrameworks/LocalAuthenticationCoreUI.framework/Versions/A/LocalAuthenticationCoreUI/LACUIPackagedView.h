...
@property (nonatomic) char setInitialStateWhenMovedToWindow;
...
- (void)setStateNamed:(id)a0 animated:(char)a1;
- (void)setStateNamed:(id)a0 animated:(char)a1 completion:(id /* block */)a2;
