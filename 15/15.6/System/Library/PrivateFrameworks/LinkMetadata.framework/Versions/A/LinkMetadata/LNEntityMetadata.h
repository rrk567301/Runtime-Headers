...
- (id)initWithIdentifier:(id)a0 transient:(char)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 displayRepresentation:(id)a5 properties:(id)a6 customIntentTypeClassName:(id)a7;
- (id)initWithIdentifier:(id)a0 transient:(char)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 displayRepresentation:(id)a5 properties:(id)a6 customIntentTypeClassName:(id)a7 availabilityAnnotations:(id)a8;
- (id)initWithIdentifier:(id)a0 transient:(char)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 displayRepresentation:(id)a5 properties:(id)a6 customIntentTypeClassName:(id)a7 availabilityAnnotations:(id)a8 requiredCapabilities:(id)a9 systemProtocolMetadata:(id)a10 attributionBundleIdentifier:(id)a11;
...
- (id)initWithIdentifier:(id)a0 transient:(char)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 displayRepresentation:(id)a5 properties:(id)a6 customIntentTypeClassName:(id)a7 availabilityAnnotations:(id)a8 systemProtocolMetadata:(id)a9;
...
- (id)initWithIdentifier:(id)a0 transient:(char)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 displayTypeName:(id)a5 properties:(id)a6 customIntentTypeClassName:(id)a7;
