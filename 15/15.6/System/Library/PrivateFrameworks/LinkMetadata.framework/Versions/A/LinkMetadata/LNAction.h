...
@property (readonly, nonatomic) char openAppWhenRun;
...
- (id)authenticationPolicyAllowingImplicit:(char)a0;
- (id)actionWithParameters:(id)a0;
- (id)actionWithURL:(id)a0;
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 outputFlags:(id)a3 systemProtocols:(id)a4 parameters:(id)a5;
- (id)initWithMetadata:(id)a0 mangledName:(id)a1 parameters:(id)a2;
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 outputFlags:(id)a3 outputType:(id)a4 systemProtocols:(id)a5 parameters:(id)a6;
- (id)actionWithOpenWhenRun:(char)a0;
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 parameters:(id)a3;
- (id)_initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 explicitAuthenticationPolicy:(id)a3 outputFlags:(id)a4 outputType:(id)a5 systemProtocols:(id)a6 parameters:(id)a7 metadata:(id)a8;
- (id)_initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 outputFlags:(id)a3 outputType:(id)a4 systemProtocols:(id)a5 parameters:(id)a6;
...
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 explicitAuthenticationPolicy:(id)a3 outputFlags:(id)a4 outputType:(id)a5 systemProtocols:(id)a6 parameters:(id)a7;
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 openAppWhenRun:(char)a2 outputFlags:(id)a3 outputType:(id)a4 parameters:(id)a5;
