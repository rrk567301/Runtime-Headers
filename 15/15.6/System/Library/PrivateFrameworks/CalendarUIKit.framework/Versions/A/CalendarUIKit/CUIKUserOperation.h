...
@property (nonatomic) char inverseOperationPrecomputed;
@property (nonatomic) char createdAsInverseOfAnotherOperation;
...
- (char)executeWithUndoDelegate:(id)a0;
- (id)initWithObjects:(id)a0 span:(long long)a1 createdAsInverseOfAnotherOperation:(char)a2;
- (id)inverseOperation;
