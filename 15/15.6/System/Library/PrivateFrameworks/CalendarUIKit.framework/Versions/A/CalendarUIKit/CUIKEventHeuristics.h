...
+ (char)_shouldFilterEvent:(id)a0 filterOptions:(unsigned long long)a1;
...
+ (id)upcomingEventsInCalendars:(id)a0 onlyReturnFirstEvents:(char)a1 filterOptions:(unsigned long long)a2 sortMethod:(unsigned long long)a3 eventStore:(id)a4;
