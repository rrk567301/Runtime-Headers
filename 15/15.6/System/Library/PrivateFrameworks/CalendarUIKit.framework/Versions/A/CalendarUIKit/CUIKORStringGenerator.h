...
+ (double)_naturalHeightForPrimaryTextUsingSmallText:(char)a0 sizeClass:(long long)a1;
...
+ (double)minNaturalTextHeightForEvent:(id)a0 usingSmallText:(char)a1 sizeClass:(long long)a2;
+ (double)minimumNaturalHeightForPrimaryTextUsingSmallText:(char)a0 sizeClass:(long long)a1;
+ (double)naturalHeightForPrimaryTextUsingSmallText:(char)a0 sizeClass:(long long)a1;
