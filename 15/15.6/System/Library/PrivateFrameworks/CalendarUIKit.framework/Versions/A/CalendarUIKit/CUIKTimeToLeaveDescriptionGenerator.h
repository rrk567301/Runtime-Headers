...
+ (id)_travelTimeDrivingSubstringWithEta:(id)a0 location:(id)a1 includeTransportType:(char)a2;
+ (id)_travelTimeDrivingSubstringWithEta:(id)a0 location:(id)a1 routeName:(id)a2 includeTransportType:(char)a3;
...
+ (id)_travelTimeLeaveNowDrivingSubstringWithEta:(id)a0 location:(id)a1 includeTransportType:(char)a2;
+ (id)_travelTimeLeaveNowDrivingSubstringWithEta:(id)a0 location:(id)a1 routeName:(id)a2 includeTransportType:(char)a3;
...
+ (id)timeToLeaveStringWithEta:(double)a0 transportType:(int)a1 runningLate:(char)a2;
