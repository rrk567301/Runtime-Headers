...
@property (readonly, nonatomic) char timeProposals;
@property (readonly, nonatomic) EKCalendarEventInvitationNotificationAttendee *importantAttendee;

- (void).cxx_destruct;
- (id)initWithTitles:(id)a0 bodyStrings:(id)a1 comments:(long long)a2 timeProposals:(char)a3 importantAttendee:(id)a4;
