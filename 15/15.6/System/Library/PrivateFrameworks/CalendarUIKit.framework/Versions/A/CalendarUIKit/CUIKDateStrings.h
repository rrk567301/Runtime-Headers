...
+ (id)summaryStringForEventDateWithOptions:(int)a0 withEvent:(id)a1 withWideSpacing:(char)a2 inTimeZone:(id)a3;
...
+ (id)_summaryStringForEventDate:(id)a0 startTimeZone:(id)a1 endDate:(id)a2 endTimeZone:(id)a3 isAllDay:(char)a4 inTimeZone:(id)a5 options:(int)a6 withWideSpacing:(char)a7;
...
+ (id)summaryStringForEventDate:(id)a0 startTimeZone:(id)a1 endDate:(id)a2 endTimeZone:(id)a3 isAllDay:(char)a4 inTimeZone:(id)a5;
+ (char)supportsOverlayCalendarWithIdentifier:(id)a0;
