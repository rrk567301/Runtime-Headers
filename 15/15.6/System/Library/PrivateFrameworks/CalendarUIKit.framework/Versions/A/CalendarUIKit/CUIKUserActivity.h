...
+ (char)_boolFromDictionary:(id)a0 key:(id)a1 error:(char *)a2;
+ (double)_doubleFromDictionary:(id)a0 key:(id)a1 error:(char *)a2;
+ (long long)_integerFromDictionary:(id)a0 key:(id)a1 error:(char *)a2;
+ (id)_stringFromDictionary:(id)a0 key:(id)a1 error:(char *)a2;
+ (unsigned long long)_typeFromDictionary:(id)a0;
+ (unsigned long long)_unsignedIntegerFromDictionary:(id)a0 key:(id)a1 error:(char *)a2;
