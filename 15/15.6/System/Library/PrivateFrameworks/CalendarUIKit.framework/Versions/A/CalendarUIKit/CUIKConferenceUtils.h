...
+ (unsigned long long)_buttonTypeForApplicationRecord:(id)a0 URL:(id)a1 isBroadcast:(char)a2;
+ (void)_displayDetailsForURL:(id)a0 isBroadcast:(char)a1 completionHandler:(id /* block */)a2;
+ (id)_imageForApplicationRecord:(id)a0 URL:(id)a1 isBroadcast:(char)a2;
...
+ (id)synchronousOutlineIconForURL:(id)a0 isBroadcast:(char)a1 outImageName:(id *)a2 incomplete:(char *)a3;
+ (id)synchronousTitleForURL:(id)a0 incomplete:(char *)a1;
