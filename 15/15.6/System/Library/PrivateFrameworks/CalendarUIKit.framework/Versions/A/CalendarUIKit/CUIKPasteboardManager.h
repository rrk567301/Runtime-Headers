...
- (char)_calendarIsPasteableTo:(id)a0 allCalendars:(id)a1;
- (void)_copyEvents:(id)a0 toDict:(id)a1;
- (void)_cutEvents:(id)a0 editor:(id)a1;
- (id)_eventsFromPasteboard:(id)a0;
- (void)_pasteEvents:(id)a0 atDate:(id)a1 dateMode:(unsigned long long)a2 pasteDelegate:(id)a3 duplicate:(char)a4;
- (void)_saveNewEventsOrOpenEditor:(id)a0 pasteDelegate:(id)a1 duplicate:(char)a2;
