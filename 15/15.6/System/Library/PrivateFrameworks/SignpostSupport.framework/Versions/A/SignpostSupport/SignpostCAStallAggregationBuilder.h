...
- (char)_isOverThreshold:(id)a0;
- (void)_processDurationNs:(unsigned long long)a0 type:(unsigned char)a1 processExecutablePath:(id)a2 pid:(int)a3 aggregateForSystem:(char)a4;
