...
@property (readonly, nonatomic) char hasRenderServerUpdateOnly;
...
@property (readonly, nonatomic) char lifetimeIsLong;
@property (readonly, nonatomic) char hidLatencyIsLong;
@property (readonly, nonatomic) char renderIntervalIsLong;
@property (readonly, nonatomic) char frameLatencyIsLong;
...
@property (readonly, nonatomic) char mayBeFirstFrame;
...
- (void).cxx_destruct;
- (unsigned int)_displayID;
- (id)_glitchIntervalWithRoundingUp:(char)a0 previousMCT:(unsigned long long)a1;
- (char)_hasDisplayID;
- (id)_inProcessGlitchIntervalWithRoundingUp:(char)a0 targetMCT:(unsigned long long)a1 previousMCT:(unsigned long long)a2;
- (char)_isLongMCT:(unsigned long long)a0 expectedFrameLatency:(unsigned char)a1;
