...
@property (readonly, nonatomic) char telemetryEnabled;

+ (id)_sumOfGroup0:(id)a0 group1:(id)a1 errorOut:(id *)a2;
...
- (id)_initWithName:(id)a0 count:(unsigned long long)a1 countUnit:(id)a2 telemetryEnabled:(char)a3;
