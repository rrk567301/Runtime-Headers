...
@property (nonatomic) char _hasTotalSkyLightCompositeCount;
@property (nonatomic) unsigned long long _totalSkyLightCompositeCount;
@property (nonatomic) char isAnimationStart;
...
@property (readonly, nonatomic) char overridesTime;
@property (readonly, nonatomic) char _overridesOwnTime;
...
@property (nonatomic) char isGenerated;
...
@property (readonly, nonatomic) char overridesBeginTime;
@property (readonly, nonatomic) char overridesEndTime;
@property (readonly, nonatomic) char overridesEmitTime;
...
@property (readonly, nonatomic) char isSyntheticIntervalEvent;
...
- (void)_adjustTimeStruct:(struct timeval { long long x0; int x1; } *)a0 asBegin:(char)a1;
