...
@property (nonatomic) char isConciseFormat;
...
+ (char)filterPassesRequiredSCForCAInstrumentation:(id)a0;
+ (char)filterPassesRequiredSCForCAMetalInstrumentation:(id)a0;
...
- (void)_handleFrameLifetimeBegin:(id)a0 isLong:(char)a1;
...
- (char)handleSignpostEvent:(id)a0;
- (char)handleSignpostInterval:(id)a0;
