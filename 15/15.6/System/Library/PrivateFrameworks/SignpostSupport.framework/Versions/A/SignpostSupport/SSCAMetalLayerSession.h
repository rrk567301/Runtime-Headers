...
@property (readonly, nonatomic) char includeTimelines;
...
- (double)startMs;
- (id)_dictionaryRepresentation:(char)a0;
...
- (double)endSeconds;
- (id)initWithID:(unsigned long long)a0 includeTimelines:(char)a1 timebaseRatio:(double)a2;
