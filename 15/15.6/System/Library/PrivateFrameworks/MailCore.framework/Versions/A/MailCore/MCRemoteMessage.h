...
@property (nonatomic) char isPartial;
@property (nonatomic) char partsHaveBeenCached;
...
@property (readonly, nonatomic) char isServerSearchResult;
@property (readonly, nonatomic) ECMessageFlags *flags;
@property (readonly, nonatomic, getter=isPartOfExistingThread) char partOfExistingThread;
