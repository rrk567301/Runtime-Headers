...
@property (readonly, nonatomic) char messageIsFromMicrosoft;
...
+ (void)initialize;
+ (char)isURLHeaderKey:(id)a0;
+ (char)isAddressHeaderKey:(id)a0;
+ (char)isMessageIDHeaderKey:(id)a0;
+ (id)basicHeaderKeys;
...
+ (char)isHumanReadableHeaderKey:(id)a0;
...
- (void)appendHeaderData:(id)a0 recipients:(id)a1 recipientsByHeaderKey:(id)a2 expandGroups:(char)a3 includeComment:(char)a4;
- (id)firstAddressForKey:(id)a0;
- (char)hasHeaderForKey:(id)a0;
- (id)initWithHeaderData:(id)a0 encodingHint:(unsigned long long)a1;
- (id)urlListForKey:(id)a0;
- (id)_sender;
- (id)_headersForKey:(id)a0;
- (id)_htmlHeaderKey:(id)a0 useBold:(char)a1 useGray:(char)a2;
...
- (id)_htmlValueWithKey:(id)a0 value:(id)a1 useBold:(char)a2;
...
- (void)_resetSender;
- (id)_rfc2047DecodedStringWithSender:(id)a0 headerData:(id)a1 headerBytes:(const char *)a2 start:(const char *)a3 end:(const char *)a4 detectOtherEncodings:(char)a5;
- (void)_setCapitalizedKey:(id)a0 forKey:(id)a1;
- (id)htmlStringUseBold:(char)a0 useGray:(char)a1;
