...
@property (nonatomic) char shouldPreserveFidelity;
...
- (char)_hasPrivateImageMetadata:(id)a0;
...
- (char)getCompressedData:(id *)a0 compressedFileURL:(id *)a1 archiveType:(long long *)a2 error:(id *)a3;
- (id)initWithMailInternalData:(id)a0;
- (char)isAnimatedImageForAccessLevel:(long long)a0;
