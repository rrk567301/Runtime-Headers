...
+ (char)messageColorIsValid:(struct { unsigned char x0; unsigned char x1; unsigned char x2; })a0;
...
+ (id)messageWithRFC822Data:(id)a0 sanitizeData:(char)a1 decoder:(id)a2;
...
- (char)answered;
- (char)flagged;
- (id)bestAlternativePart:(char *)a0;
- (id)bestAlternativePartAsData:(char *)a0 usingEncoding:(unsigned long long)a1;
- (void)addGmailLabels:(id)a0;
- (id)bodyFetchIfNotAvailable:(char)a0 updateFlags:(char)a1 allowPartial:(char)a2 decodeContext:(id)a3;
- (id)_searchableItemWithHTML:(id)a0 messageBody:(id)a1 updatableAttributesOnly:(char)a2 outOrderedAttachments:(id *)a3;
...
- (id)bodyFetchIfNotAvailable:(char)a0 updateFlags:(char)a1 allowPartial:(char)a2 skipSignatureVerification:(char)a3 decodeContext:(id)a4;
- (char)calculateAttachmentInfoFromTopLevelMimePart:(id)a0 numberOfAttachments:(unsigned int *)a1 isSigned:(char *)a2 isEncrypted:(char *)a3;
...
- (void)setColor:(id)a0 hasBeenEvaluated:(char)a1 flags:(long long)a2 mask:(long long)a3;
...
- (void)setPrimitiveColor:(id)a0 hasBeenEvaluated:(char)a1 flags:(long long)a2 mask:(long long)a3;
...
- (id)_URLStringWithHeaders:(id)a0 fetchIfNotAvailable:(char)a1;
- (id)_bccFetchIfNotAvailable:(char)a0;
- (char)_calculateAttachmentInfoFromTopLevelMimePart:(id)a0 numberOfAttachments:(unsigned int *)a1 isSigned:(char *)a2 isEncrypted:(char *)a3 force:(char)a4;
...
- (id)_uniqueIdentifierForSearchableItemUsingIdentifier:(id)a0 useHeadersIfNecessary:(char)a1;
- (void)_updateAttributeSet:(id)a0 includingHTML:(char)a1 withMessageBody:(id)a2 orderedAttachments:(id *)a3;
- (id)bodyDataAndHeaderDataIfReadilyAvailable:(id *)a0 fetchIfNotAvailable:(char)a1 allowPartial:(char)a2;
