...
@property char reassignTasksWillRun;
@property char hasActivity;
...
@property (readonly, nonatomic) char isInSerializationQueue;
...
@property (readonly, nonatomic) char networkIsLimited;
