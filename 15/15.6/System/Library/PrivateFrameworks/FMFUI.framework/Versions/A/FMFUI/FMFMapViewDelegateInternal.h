...
@property (nonatomic) char pressureActionEnabled;
...
@property (nonatomic) char isMapCenteringDisabled;
...
- (void)mapView:(id)a0 regionWillChangeAnimated:(char)a1;
...
- (char)canSelectAnnotation:(id)a0;
- (void)endTouches;
- (id)fmfOverlayColor;
...
- (void)doubleClickGestureEnabled:(char)a0;
...
- (char)regionIsValid:(struct { struct CLLocationCoordinate2D { double x0; double x1; } x0; struct { double x0; double x1; } x1; })a0;
...
- (void)zoomToFitAnnotationsForMapView:(id)a0 includeMe:(char)a1 duration:(double)a2;
