...
@property (nonatomic) char alwaysShowAccuracy;
@property (nonatomic) char wasToolbarPreviouslyHidden;
...
@property char shouldZoomToFitNewLocations;
@property char shouldZoomToFitMeAndLocations;
@property char showFloatingMapLocationButton;
...
- (id)annotationImageForAnnotation:(id)a0 andHandle:(id)a1 large:(char)a2;
...
- (char)isLocationAlreadyOnMap:(id)a0;
- (double)liveAnimationDuration;
- (void)loadCachedLocationsForHandles;
- (id)locationOnMapForHandle:(id)a0 enforceServerId:(char)a1;
...
- (void)updateMapWithNewLocation:(id)a0 animated:(char)a1;
- (void)updateNoLocationView:(char)a0;
