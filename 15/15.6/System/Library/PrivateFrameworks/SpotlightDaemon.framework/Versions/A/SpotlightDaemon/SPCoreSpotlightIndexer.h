...
+ (void)cooldown;
+ (void)deviceStateWillChange:(char)a0;
...
+ (char)writeDiagnostic:(id)a0 bundleID:(id)a1 identifier:(id)a2 logQuery:(BOOL)a3;
...
- (void)_enumerateIndexersWithProtectionClasses:(id)a0 forBundleIds:(id)a1 inferSpecialIndexes:(char)a2 block:(id /* block */)a3;
- (void)_enumerateIndexersWithProtectionClasses:(id)a0 forQueryWithContext:(id)a1 forBundleIds:(id)a2 inferSpecialIndexes:(char)a3 block:(id /* block */)a4;
- (void)_enumerateIndexersWithProtectionClasses:(id)a0 inferSpecialIndexes:(char)a1 block:(id /* block */)a2;
...
- (void)_migrateIndexExtensionsWithEnumerator:(id)a0 forced:(char)a1 migratedBundleIds:(id)a2 completionHandler:(id /* block */)a3;
- (int)_openIndex:(char)a0 forInit:(char)a1 readOnly:(char)a2;
...
- (void)asyncOpenIndex:(char)a0 forInit:(char)a1 readOnly:(char)a2;
...
- (void)deleteAllSearchableItemsWithBundleID:(id)a0 fromClient:(id)a1 protectionClass:(id)a2 shouldGC:(char)a3 completionHandler:(id /* block */)a4;
...
- (void)indexFromBundle:(id)a0 protectionClass:(id)a1 personaID:(id)a2 options:(long long)a3 items:(id)a4 itemsText:(id)a5 itemsHTML:(id)a6 clientState:(id)a7 expectedClientState:(id)a8 clientStateName:(id)a9 deletes:(id)a10 canCreateNewIndex:(char)a11 completionHandler:(id /* block */)a12;
...
- (id)indexServiceName;
- (char)isForegroundFileProviderBundleID:(id)a0;
...
- (void)issueDuplicateOidCheckWithGroup:(id)a0 protected:(char)a1;
- (id)issueHeartbeat;
...
- (void)lockedCx;
- (void)lockingCx;
- (void)markIndexPurgeable:(char)a0;
- (void)mergeWithProtectionClasses:(id)a0 completionHandler:(id /* block */)a1;
- (void)mergeWithProtectionClasses:(id)a0 power:(char)a1;
- (void)mergeWithProtectionClasses:(id)a0 power:(char)a1 completionHandler:(id /* block */)a2;
- (void)mergeWithProtectionClasses:(id)a0 power:(char)a1 inferSpecialIndexes:(char)a2 completionHandler:(id /* block */)a3;
- (void)migrateForced:(char)a0;
- (void)moveBackMailToClassA;
- (void)moveMailToClassC;
- (void)moveMailToClassCWithoutClone;
- (int)openIndex:(char)a0;
- (int)openIndex:(char)a0 forInit:(char)a1 readOnly:(char)a2;
- (int)openIndex:(char)a0 readOnly:(char)a1;
...
- (unsigned long long)purgeVectorIndex:(char)a0;
- (unsigned long long)purgeableIndexSize:(id)a0;
- (unsigned long long)purgeableVectorIndexSize:(char)a0;
- (id)queryForWord:(id)a0 matchingAttributes:(id)a1 prefixMatch:(char)a2;
...
- (void)revokeExpiredItems:(id)a0 activity:(id)a1 protected:(char)a2;
- (void)rewriteFirstPassQueryWithQueryString:(id)a0 context:(id)a1 trimmedSearchStringTokens:(id)a2 populateDateSynonyms:(char)a3;
...
- (id)writeUISearchEnabled:(char)a0;
