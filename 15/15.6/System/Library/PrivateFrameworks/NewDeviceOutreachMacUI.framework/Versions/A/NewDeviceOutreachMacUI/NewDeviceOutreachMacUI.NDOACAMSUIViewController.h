...
- (char)webViewController:(id)a0 handleDelegateAction:(id)a1 completion:(id /* block */)a2;
...
- (id)initWith:(id)a0 serialNumber:(id)a1 source:(id)a2 isMultiCall:(char)a3 agsULUrl:(id)a4 ulSalesURL:(id)a5 deeplinkParams:(id)a6 purchaseBody:(id)a7;
