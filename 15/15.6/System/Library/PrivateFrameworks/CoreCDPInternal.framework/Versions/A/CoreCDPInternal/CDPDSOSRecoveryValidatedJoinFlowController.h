...
- (unsigned long long)_escapeOfferForDevices:(id)a0 remoteApproval:(char)a1 forMultipleICSC:(char)a2;
...
- (id)_makeRemoteApprovalCompletedEventWithContext:(id)a0 didApprove:(char)a1 error:(id)a2;
...
- (void)sendRemoteApprovalCompletedEventWithContext:(id)a0 didApprove:(char)a1 error:(id)a2;
