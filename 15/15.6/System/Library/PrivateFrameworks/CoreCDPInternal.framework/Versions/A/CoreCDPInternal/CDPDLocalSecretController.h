...
- (void)_createContextForSecret:(char)a0 withCompletion:(id /* block */)a1;
- (void)_handleCompletionStatus:(char)a0 preRecord:(char)a1;
...
- (void)_sendiCSCUpdateFinishEvent:(id)a0 didUpdate:(char)a1 error:(id)a2;
