...
@property (nonatomic) char attemptedCDPEnable;
...
- (char)_needsSOSRepair;
- (void)reportCDPEntryEventWithContext:(id)a0;
- (void)_enableSOSViews;
- (id)_predicateForRecordUpgradeCheck;
- (void)_attemptBackupRecoveryByPromptingForRemoteSecretWithLocalSecret:(id)a0 localSecretType:(unsigned long long)a1 useSecureBackupCachedSecret:(char)a2 circleJoinResult:(id)a3 completion:(id /* block */)a4;
- (void)_attemptBackupRecoveryWithLocalSecret:(id)a0 type:(unsigned long long)a1 useSecureBackupCachedSecret:(char)a2 circleJoinResult:(id)a3 completion:(id /* block */)a4;
...
- (char)_checkSecureBackupCachedSecretValue;
...
- (void)_continueShouldPerformRepairWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
- (void)_disableRecoveryKeyWithCompletion:(id /* block */)a0;
- (char)_eligibleForSilentAuthenticatedRepair;
- (char)_eligibleToSkipAuth;
...
- (char)_localDeviceHasLocalSecret;
...
- (id)_makeSOSCompatibilityModeEnableEvent:(char)a0 error:(id)a1;
...
- (void)_populateBaseFinishEvent:(id)a0 didSucceed:(char)a1 error:(id)a2 shouldCompleteSignIn:(char)a3 context:(id)a4 octagonCliqueStatus:(long long)a5 cdpdAccount:(id)a6;
- (id)_populateBaseStartEvent:(id)a0 withContext:(id)a1 cdpdAccount:(id)a2;
- (void)_postEDPRepairFinishEventWithContext:(id)a0 didSucceed:(char)a1 error:(id)a2 shouldCompleteSignIn:(char)a3 octagonCliqueStatus:(long long)a4 cdpdAccount:(id)a5;
...
- (void)_shouldPerformAuthenticatedRepairWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
- (char)_shouldRejoinCircleAfterPerformingRPDType:(unsigned long long)a0;
- (void)_updateCDPEnableEventWithError:(id)a0 error:(id)a1 didEnable:(char)a2;
