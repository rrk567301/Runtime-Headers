@class CDPDevice, NSString, NSMutableDictionary, CDPContext, NSMutableSet;
...
@property (nonatomic) char isUsingMultipleICSC;
...
- (char)_isFailedSecret:(id)a0 forDevice:(id)a1;
- (char)_isInvalidICSCError:(id)a0;
- (void)_performSingleiCSCRecoveryWithSecret:(id)a0 type:(unsigned long long)a1 completion:(id /* block */)a2;
- (char)_shouldInjectEDPStateRepairForResult:(id)a0 error:(id)a1;
- (char)_validSecretHandlerShouldBeWrappedWithEDPFlow;
