...
@property (nonatomic) char fakeNearlyDepletedRecords;
...
- (void)_getBackupRecordDevicesIncludingUnrecoverableRecords:(char)a0 completion:(id /* block */)a1;
- (id)_recoverBackupDictionaryWithContext:(id)a0 fallbackState:(unsigned long long)a1 error:(id *)a2;
- (id)_recoveryInfoDictionaryFromContext:(id)a0 usePreviouslyCachedSecret:(char)a1;
- (char)_shouldUseSBDCacheWithSecureBackupContext:(id)a0 fallbackState:(unsigned long long)a1;
...
- (void)checkForExistingRecordMatchingPredicate:(id)a0 forceFetch:(char)a1 completion:(id /* block */)a2;
- (void)checkForExistingRecordWithPeerId:(id)a0 completion:(id /* block */)a1;
- (void)clearAccountInfoCache;
- (void)getBackupRecordDevicesWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
