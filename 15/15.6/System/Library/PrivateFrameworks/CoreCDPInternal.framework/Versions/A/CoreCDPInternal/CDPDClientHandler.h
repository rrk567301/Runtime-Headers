...
- (oneway void)fetchEscrowRecordDevicesWithContext:(id)a0 usingCache:(char)a1 completion:(id /* block */)a2;
...
- (void)generateEscrowRecordStatusReportForContext:(id)a0 usingCache:(char)a1 withCompletion:(id /* block */)a2;
...
- (void)isICDPEnabledForDSID:(id)a0 checkWithServer:(char)a1 completion:(id /* block */)a2;
...
- (void)shouldPerformAuthenticatedRepairForContext:(id)a0 forceFetch:(char)a1 completion:(id /* block */)a2;
- (void)shouldPerformRepairForContext:(id)a0 forceFetch:(char)a1 completion:(id /* block */)a2;
- (oneway void)shouldPerformSilentEscrowRecordRepairWithContext:(id)a0 usingCache:(char)a1 completion:(id /* block */)a2;
...
- (char)_shouldForceUseSecureBackupCachedPassphraseWithContext:(id)a0 clientType:(unsigned long long)a1;
- (void)_startObservingConnectionStateForRepairWithStateMachine:(id)a0 context:(id)a1;
- (void)_updateSOSCompatibilityMode:(char)a0 context:(id)a1;
