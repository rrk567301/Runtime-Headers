...
@property (nonatomic) char isSimulateNonViableEscrowRecordEnabled;
@property (nonatomic) char simulateEPThrottle;
...
- (char)_validateSOSRecoveryKey:(id)a0 config:(id)a1;
...
- (char)_disableSecureBackup:(id *)a0;
- (char)_disableSecureBackupWithEnableInfo:(id)a0 error:(id *)a1;
- (char)_disableThenEnableWithInfo:(id)a0 error:(id *)a1;
...
- (void)_getOctagonEscrowBackupRecordDevicesWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
...
- (char)_isInSOSCircle;
- (char)_isRecoveryKeySetInOctagonWithConfig:(id)a0;
- (char)_isRecoveryKeySetInSOSWithConfig:(id)a0;
- (char)_isSOSEnabled;
- (id)_makeRecoveryKeyVerifyEventWithError:(id)a0 result:(char)a1;
...
- (char)_validateOctagonRecoveryKeyWithConfig:(id)a0 recoveryKey:(id)a1;
...
- (char)authenticatedEnableSecureBackupWithRecoveryKey:(id)a0 error:(id *)a1;
...
- (void)fetchAllEscrowRecordsWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
- (void)fetchEscrowRecordsWithOptionForceFetch:(char)a0 completion:(id /* block */)a1;
...
- (char)recordIsEmpty:(id)a0;
- (void)recoverSecureBackupWithContext:(id)a0 completion:(id /* block */)a1;
- (char)supportsRecoveryKeyWithError:(id *)a0;
- (char)supportsWalrusRecoveryKeyWithError:(id *)a0;
