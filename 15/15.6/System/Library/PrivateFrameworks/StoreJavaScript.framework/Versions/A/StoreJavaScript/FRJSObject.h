...
@property (nonatomic) char isBundleObject;
...
- (id)doAction:(id)a0;
- (void)protect;
- (void)_addFunction:(id)a0 sendMessage:(char)a1;
- (void)_addProperty:(id)a0 sendMessage:(char)a1;
- (void)_setProperty:(id)a0 toValue:(id)a1 sendMessage:(char)a2;
