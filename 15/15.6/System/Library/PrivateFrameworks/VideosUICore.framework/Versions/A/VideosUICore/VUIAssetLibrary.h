...
+ (id)sharedInstance;
+ (void)initializeAssetLibraryWithCachePath:(id)a0 purgeCacheOnLoad:(char)a1;
+ (void)_initializeAssetLibraryWithCachePath:(id)a0 purgeCacheOnLoad:(char)a1;

- (void).cxx_destruct;
- (void)_setImageAsset:(id)a0 forKey:(id)a1 inGroupOfType:(long long)a2 expiryDate:(id)a3 overWrite:(char)a4 tags:(id)a5;
...
- (id)initWithCachePath:(id)a0 purgeCacheOnLoad:(char)a1;
...
- (void)setImageAsset:(id)a0 forKey:(id)a1 inGroupOfType:(long long)a2 expiryDate:(id)a3 overWrite:(char)a4;
