...
+ (id)URLFromSource:(id)a0 extension:(id)a1 p3Specifier:(id)a2 cropCode:(id)a3 imageSize:(struct CGSize { double x0; double x1; })a4 displayScaleIsPointMultiplier:(char)a5 centerGrowth:(char)a6 focusSizeIncrease:(double)a7;
