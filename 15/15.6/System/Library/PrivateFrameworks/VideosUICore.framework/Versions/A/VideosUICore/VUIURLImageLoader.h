...
@property (readonly, nonatomic) char useMinimalSessionImageLoading;
@property (nonatomic, getter=isImageRotationEnabled) char imageRotationEnabled;
...
+ (id)sharedInstance;
+ (id)sharedInstanceWithMinimalSession:(char)a0;
...
- (id)initWithMinimalSessionImageLoading:(char)a0;
