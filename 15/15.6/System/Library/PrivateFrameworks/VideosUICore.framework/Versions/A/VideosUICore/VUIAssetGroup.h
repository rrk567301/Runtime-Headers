...
@property (nonatomic, getter=isManifestDirty) char manifestDirty;
...
- (void)_removeAssetInfoForKey:(id)a0 removeFile:(char)a1;
- (void)_saveManifest;
- (void)_updateManifestWithChange:(id /* block */)a0;
- (id)assetInfoForKey:(id)a0 queue:(id)a1;
- (id)infoForAllAssetsWithQueue:(id)a0;
- (id)initWithGroupType:(long long)a0 baseCachePath:(id)a1 folderName:(id)a2 maxCacheSize:(unsigned long long)a3 purgeOnLoad:(char)a4;
