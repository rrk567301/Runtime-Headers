...
@property (nonatomic, getter=_isDeferredUpdate, setter=_setDeferredUpdate:) char deferredUpdate;
...
@property (readonly, nonatomic, getter=_focusRedirectedByGuide) char focusRedirectedByGuide;
...
- (char)_isFilteredToGroup;
- (char)_isValidInFocusSystem:(id)a0;
- (id)_publicRegionMapSnapshots;
- (void)_restoreRestrictedFocusMovementWithMovement:(id)a0;
- (void)_setFocusRedirectedByGuide:(char)a0;
