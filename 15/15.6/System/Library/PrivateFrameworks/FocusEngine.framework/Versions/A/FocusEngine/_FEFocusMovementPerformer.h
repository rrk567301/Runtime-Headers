...
- (void).cxx_destruct;
- (id)__findFocusCandidateInEnvironment:(id)a0 container:(id)a1 forRequest:(id)a2 minimumSearchArea:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 isLoadingScrollableContainer:(char)a4;
...
- (char)_isMovementValidForFocusSequences:(id)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_minimumSearchAreaForContainer:(id)a0 inCoordinateSpace:(id)a1 shouldLoadScrollableContainer:(char)a2;
- (id)_nextLinearCandidateLoadingScrollableContentForRequest:(id)a0;
- (id)contextForFocusMovement:(id)a0;
- (char)performFocusMovement:(id)a0;
