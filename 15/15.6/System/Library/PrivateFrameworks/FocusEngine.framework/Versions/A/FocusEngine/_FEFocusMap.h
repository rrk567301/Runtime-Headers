...
@interface _FEFocusMap : NSObject {
    ...
    char _ignoresRootContainerClippingRect;
...
- (id)initWithFocusSystem:(id)a0 rootContainer:(id)a1 coordinateSpace:(id)a2 searchInfo:(id)a3 ignoresRootContainerClippingRect:(char)a4;
- (id)initWithFocusSystem:(id)a0 rootEnvironment:(id)a1;
- (id)initWithFocusSystem:(id)a0 rootEnvironment:(id)a1 coordinateSpace:(id)a2 searchInfo:(id)a3 ignoresRootContainerClippingRect:(char)a4;
- (char)verifyFocusabilityForItem:(id)a0;
