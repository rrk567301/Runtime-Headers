...
@interface _FEFocusItemFrameReporter : NSObject {
    ...
    char _hasStagedFocusFrameUpdate;
}
...
- (char)_rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 differsFromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 lowerThreshold:(double)a2 upperThreshold:(double)a3;
