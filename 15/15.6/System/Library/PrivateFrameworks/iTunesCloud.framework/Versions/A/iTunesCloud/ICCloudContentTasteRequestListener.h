...
- (void)updateContentTasteForMediaItemsAndInvalidateLocalCache:(char)a0 configuration:(id)a1 withCompletionHandler:(id /* block */)a2;
- (void)updateContentTasteForMediaItemsAndInvalidateLocalCache:(char)a0 withCompletionHandler:(id /* block */)a1;
