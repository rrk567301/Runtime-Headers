...
@property (nonatomic) char useAMSBag;
@property (nonatomic) char useRawPayload;
...
- (void)getBagAndURLMetricsForRequestContext:(id)a0 forceRefetch:(char)a1 withCompletionHandler:(id /* block */)a2;
- (void)getBagForRequestContext:(id)a0 forceRefetch:(char)a1 withCompletionHandler:(id /* block */)a2;
