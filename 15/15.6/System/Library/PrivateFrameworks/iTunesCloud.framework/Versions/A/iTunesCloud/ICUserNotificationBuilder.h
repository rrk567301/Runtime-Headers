...
@property (nonatomic) char displaysActionButtonOnLockScreen;
@property (nonatomic) char displaysAsTopMost;
@property (nonatomic) char forcesModalAppearance;
...
- (id)init;
- (void).cxx_destruct;
- (void)_setBoolValue:(char)a0 forKey:(struct __CFString { } *)a1;
