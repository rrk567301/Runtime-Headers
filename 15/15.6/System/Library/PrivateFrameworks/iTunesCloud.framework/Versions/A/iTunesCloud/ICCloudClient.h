...
@property (nonatomic) char serverIsSetup;
...
- (void)enableCloudLibraryWithPolicy:(long long)a0 startInitialImport:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)handleAutomaticDownloadPreferenceChangedForMediaKindMusic:(char)a0 withCompletionHandler:(id /* block */)a1;
...
- (void)updateSubscribedPlaylistsWithSagaIDs:(id)a0 ignoreMinRefreshInterval:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_enableCloudLibraryWithPolicy:(long long)a0 startinitialImport:(char)a1 isExplicitUserAction:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)authenticateAndStartInitialImport:(char)a0 completionHandler:(id /* block */)a1;
- (void)authenticateWithCompletionHandler:(id /* block */)a0;
- (char)createMusicNotificationFromAMSDialogRequest:(id)a0 error:(id *)a1;
...
- (char)musicPurchasesDisabledForJaliscoLibrary;
