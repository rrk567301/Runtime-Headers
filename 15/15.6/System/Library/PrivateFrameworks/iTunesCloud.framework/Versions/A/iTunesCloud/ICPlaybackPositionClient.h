...
- (void)persistPlaybackPositionEntity:(id)a0 isCheckpoint:(char)a1 completionBlock:(id /* block */)a2;
...
- (void)synchronizePlaybackPositionsForLibraryWithIdentifier:(id)a0 forDomain:(id)a1 isCheckpoint:(char)a2;
