...
@property (readonly, nonatomic) char canPostKeybagSyncData;
...
- (char)shouldAppendDeviceGUIDForURL:(id)a0;
- (char)shouldAppendMachineDataHeadersForURL:(id)a0;
