...
@property (readonly, nonatomic, getter=isContinueListeningAvailable) char continueListeningAvailable;
...
- (char)shouldIncludeHTTPHeaderField:(id)a0 forRequestURL:(id)a1;
