...
@property (nonatomic, getter=isContinuityCameraUsed) char continuityCameraUsed;
...
@property (nonatomic, getter=isCollaborativePlaylist) char collaborativePlaylist;
...
@property (nonatomic, getter=isInternalBuild) char internalBuild;
...
- (void)setCollaborativePlaylist:(char)a0;
- (void)setContinuityCameraUsed:(char)a0;
