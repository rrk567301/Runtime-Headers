...
@property (readonly, nonatomic) char hasCellularDataCapability;
@property (readonly, nonatomic) char hasTelephonyCapability;
@property (readonly, nonatomic) char hasWiFiCapability;
@property (readonly, nonatomic) char hasWAPICapability;
@property (readonly, nonatomic) char has720pCapability;
@property (readonly, nonatomic) char has1080pCapability;
@property (readonly, nonatomic, getter=isPhoneNumberAccessRestricted) char phoneNumberAccessRestricted;
...
@property (readonly, nonatomic) char isIPod;
@property (readonly, nonatomic) char isWatch;
@property (readonly, nonatomic) char isAudioAccessory;
@property (readonly, nonatomic) char isMac;
@property (readonly, nonatomic) char isROSDevice;
...
@property (readonly, nonatomic, getter=isSeedBuild) char seedBuild;
...
@property (readonly, nonatomic) char supportsSideLoadedMediaContent;
@property (readonly, nonatomic) char supportsMusicStreaming;
@property (readonly, nonatomic) char supportsMultipleITunesAccounts;
