...
@property (nonatomic) char includeKeybagSyncData;
@property (nonatomic) char includeSubscriptionKeybagSyncData;
@property (nonatomic, getter=isPlaybackRequest) char playbackRequest;
@property (nonatomic, getter=isStreamingRental) char streamingRental;
@property (nonatomic) char usePrioritizedURLSession;
