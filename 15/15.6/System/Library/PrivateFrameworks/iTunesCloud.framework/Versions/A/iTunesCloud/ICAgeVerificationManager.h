...
- (char)_bagHasValidKeys:(id)a0;
- (void)_runAgeVerificationForUserIdentity:(id)a0 completion:(id /* block */)a1;
- (void)_updateAgeVerificationStateAndSendNotification:(char)a0 completion:(id /* block */)a1;
- (void)_updateAgeVerificationStateForUserIdentity:(id)a0 sendNotification:(char)a1 completion:(id /* block */)a2;
