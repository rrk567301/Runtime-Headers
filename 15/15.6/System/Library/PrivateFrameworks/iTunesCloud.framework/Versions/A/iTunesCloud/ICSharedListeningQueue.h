...
@property (readonly, nonatomic) char hasActiveRadioStation;
@property (readonly, nonatomic) char isAutoPlayAvailable;
@property (readonly, nonatomic) char isAutoPlayEnabled;
...
- (void)setAutoPlayEnabled:(char)a0 completion:(id /* block */)a1;
