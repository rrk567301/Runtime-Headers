@class NSArray, NSDictionary, ICStorePlatformMetadata, NSDate, ICStoreHLSAssetInfo;
...
@property (readonly, nonatomic, getter=isSkippable) char skippable;
@property (readonly, nonatomic) long long trackType;
@property (readonly, nonatomic) char hasStartTime;
