...
@property (readonly, nonatomic, getter=isInitialCheckboxValue) char initialCheckboxValue;
@property (readonly, nonatomic, getter=isBiometricAuthenticationAllowed) char biometricAuthenticationAllowed;
