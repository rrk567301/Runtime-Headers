...
@property (nonatomic) char processingAction;
...
@property (nonatomic) char receivedDisconnectionNotice;
...
@property (nonatomic) char expectingToJoinAsInitiator;
@property (readonly, nonatomic) char isExpectingToJoinWithStartItem;
...
- (void)expectingToJoinWithStartItem:(id)a0 asInitiator:(char)a1;
