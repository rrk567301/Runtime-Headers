...
@property (readonly, nonatomic, getter=isFamilySubscription) char familySubscription;
@property (readonly, nonatomic) NSError *error;
@property (readonly, nonatomic) NSString *SMSSessionIdentifier;
@property (readonly, nonatomic) double delayInterval;
@property (readonly, nonatomic) char wantsDelayedRetry;
...
@property (readonly, nonatomic) char needsHeaderEnrichment;
@property (readonly, nonatomic) char needsSilentSMS;
