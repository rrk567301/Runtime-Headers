@class AVTSnapshotHelper, AVTRenderer, AVTAvatar, NSObject, AVTStickerConfigurationReversionContext;
...
+ (void)applyViewTransitionConfiguration:(id)a0 forLateAdditionOfComponentAssetNode:(id)a1 ofAvatar:(id)a2;
...
- (void)stickerImageWithConfiguration:(id)a0 correctClipping:(char)a1 completionHandler:(id /* block */)a2;
