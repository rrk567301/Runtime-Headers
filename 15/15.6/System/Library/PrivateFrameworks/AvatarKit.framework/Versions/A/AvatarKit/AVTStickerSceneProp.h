...
- (id)initWithRootNode:(id)a0 scale:(SEL)a1 position:(id)a2 rotation:(char)a3 renderLast:(id)a4 palettesDescriptions:(id)a5 modifiers:(id)a6 adjustments:(void /* unknown type, empty encoding */)a7;
