...
- (id)_addAnimationToAvatar:(id)a0 options:(unsigned long long)a1 transitionInDuration:(double)a2 transitionOutDuration:(double)a3 isTransient:(char)a4 completionQueue:(id)a5 completionHandler:(id /* block */)a6;
...
- (id)addToAvatar:(id)a0 useStaticPhysicsState:(char)a1;
- (id)addToAvatar:(id)a0 useStaticPhysicsState:(char)a1 transitionDuration:(double)a2;
