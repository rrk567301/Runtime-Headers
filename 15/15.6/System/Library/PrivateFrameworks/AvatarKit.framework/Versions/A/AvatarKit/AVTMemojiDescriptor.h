...
+ (id)colorPresetFromColorData:(id)a0 forCategory:(long long)a1 colorIndex:(unsigned long long)a2 version:(unsigned short)a3 didFail:(char *)a4 error:(id *)a5;
+ (id)presetsDictionaryFromRecipe:(id)a0 didFail:(char *)a1 error:(id *)a2;
+ (id)randomDescriptor;
...
- (void)_decode:(id)a0 isResettingToDefault:(char)a1 error:(id *)a2;
...
- (id)initWithDictionaryRepresentation:(id)a0 error:(id *)a1 isResettingToDefault:(char)a2;
