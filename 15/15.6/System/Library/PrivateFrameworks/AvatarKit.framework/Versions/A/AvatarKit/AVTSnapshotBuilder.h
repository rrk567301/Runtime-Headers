...
- (id)_imageWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 options:(id)a2 useACopy:(char)a3;
...
- (void)setupAvatarWithOptions:(id)a0 useACopy:(char)a1;
