...
@property (nonatomic, getter=isWarmingUp) char warmingUp;
...
@property (nonatomic) char usesReverseZ;
...
- (id)technique;
- (id)_initWithOptions:(id)a0 isPrivateRenderer:(char)a1 privateRendererOwner:(id)a2 clearsOnDraw:(char)a3 context:(void *)a4 renderingAPI:(unsigned long long)a5;
...
- (char)deprecated_ntk_isPaused;
- (void)deprecated_ntk_setPaused:(char)a0;
