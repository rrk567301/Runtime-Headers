...
@interface AVTMemoji : AVTAvatar {
    ...
    char _hairPhysicsShouldIgnoreUpperNodes;
...
- (float)arScale;
- (id)facialhairColor;
- (void)setPreset:(id)a0 forCategory:(long long)a1 animated:(char)a2;
- (double)skinTextureSize;
- (void)_addHandsComponentInstanceIfNeeded;
- (char)_addTorsoComponentInstanceIfNeeded;
...
- (id)_assetNodesForComponentType:(long long)a0 includingBuiltInAssetNodes:(char)a1 includingComponentAssetNode:(char)a2;
- (id)_componentInstanceAssetNodesForDependencyOfType:(long long)a0 isAssetSpecific:(char)a1;
...
- (void)_setAssetSpecificVariantDependenciesEnabled:(char)a0 forPreset:(id)a1 dirtyComponents:(unsigned long long)a2;
- (void)_setMorphWeight:(float)a0 forDependencyVariant:(id)a1 ofType:(long long)a2 isAssetSpecific:(char)a3;
- (void)_setVariantDependenciesEnabled:(char)a0 forPreset:(id)a1 dirtyComponents:(unsigned long long)a2;
- (void)_updateAO;
...
- (void)addComponent:(id)a0 animated:(char)a1;
...
- (void)componentDidChangeForType:(long long)a0 animated:(char)a1;
