...
@property (readonly, nonatomic) char forceDoubleSided;
...
- (void)applyToMatchedMaterialsOfAvatar:(id)a0 inHierarchy:(id)a1 options:(id)a2 reversionContext:(id)a3;
...
- (id)initWithEntryPoint:(id)a0 nodeNames:(id)a1 data:(id)a2 properties:(id)a3 forceDoubleSided:(char)a4;
