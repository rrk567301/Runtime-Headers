...
@property (readonly, nonatomic) char orientToCamera;
@property (readonly, nonatomic) char renderLast;
...
+ (char)getOrientToCameraInDictionary:(id)a0;
+ (void /* unknown type, empty encoding */)getPositionInDictionary:(id)a0;
+ (char)getRenderLastInDictionary:(id)a0;
...
- (id)initWithSize:(id)a0 scale:(SEL)a1 position:(struct CGSize { double x0; double x1; })a2 renderLast:(char)a3 orientToCamera:(char)a4 rotation:(id)a5 palettesDescriptions:(id)a6 shaderModifiers:(id)a7 adjustments:(void /* unknown type, empty encoding */)a8;
