...
+ (void)registerBundle:(id)a0 withTemplateDir:(id)a1;
+ (id)getMorphunPaths;
+ (char)downloadMorphunDataByLocale:(id)a0;
+ (char)downloadMorphunDataByLocales:(id)a0;
...
+ (id)filterProfanity:(id)a0 locale:(id)a1;
...
+ (id)getDialogAssetsVersion:(id)a0 enableUpdates:(char)a1;
...
+ (id)getFallbackLocales:(id)a0;
+ (id)getFallbackLocales:(id)a0 includingNonSiriLocales:(char)a1;
+ (void)registerBundleId:(id)a0 withTemplateDir:(id)a1;
+ (id)resolve:(id)a0 propName:(id)a1 parameters:(id)a2 completion:(id /* block */)a3;
+ (char)runTests:(id)a0;
+ (char)runTests:(id)a0 forLocale:(id)a1;
