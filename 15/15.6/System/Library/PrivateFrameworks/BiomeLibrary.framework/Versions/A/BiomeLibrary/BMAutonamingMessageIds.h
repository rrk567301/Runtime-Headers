...
@property (nonatomic) char hasProtoVersion;
...
@property (nonatomic) char hasIsDeletion;
@property (readonly, nonatomic) char containsImageAttachment;
@property (nonatomic) char hasContainsImageAttachment;
