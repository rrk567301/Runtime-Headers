...
@property (readonly, nonatomic) char isFreshTier;
@property (nonatomic) char hasIsFreshTier;
@property (readonly, nonatomic) char isBatchTier;
@property (nonatomic) char hasIsBatchTier;
