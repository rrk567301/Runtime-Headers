...
@property (readonly, nonatomic) char isBreakthrough;
@property (nonatomic) char hasIsBreakthrough;
@property (readonly, nonatomic) char isBlackPearlEnabled;
@property (nonatomic) char hasIsBlackPearlEnabled;
...
@property (nonatomic) char hasIsThread;
@property (readonly, nonatomic) NSString *senderId;
@property (readonly, nonatomic) int receivingAccountDomain;
@property (readonly, nonatomic) char hasIcloudAccountEnabled;
@property (nonatomic) char hasHasIcloudAccountEnabled;
