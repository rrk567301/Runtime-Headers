...
@interface BMAppleIntelligenceAvailability : BMEventBase <BMStoreData> {
    char _hasRaw_datePostedAppleIntelligenceCFU;
...
@property (readonly, nonatomic) char isAppleIntelligenceToggleEnabled;
@property (nonatomic) char hasIsAppleIntelligenceToggleEnabled;
@property (readonly, nonatomic) char hasEngagedWithAppleIntelligenceCFU;
@property (nonatomic) char hasHasEngagedWithAppleIntelligenceCFU;
