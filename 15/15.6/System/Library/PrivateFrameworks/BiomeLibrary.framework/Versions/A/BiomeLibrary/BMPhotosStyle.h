...
@property (nonatomic) char hasFaceSizeRatio;
@property (readonly, nonatomic) char isSunsetSunrise;
@property (nonatomic) char hasIsSunsetSunrise;
@property (readonly, nonatomic) char isOutdoor;
@property (nonatomic) char hasIsOutdoor;
@property (readonly, nonatomic) char isFood;
@property (nonatomic) char hasIsFood;
...
@property (nonatomic) char hasBrightnessValue;
@property (readonly, nonatomic) unsigned int stillImageProcessingFlags;
@property (nonatomic) char hasStillImageProcessingFlags;
@property (readonly, nonatomic) unsigned int camera;
@property (nonatomic) char hasCamera;
@property (readonly, nonatomic) unsigned int stillImageCaptureType;
@property (nonatomic) char hasStillImageCaptureType;
...
@property (nonatomic) char hasPetCount;
