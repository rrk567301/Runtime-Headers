...
@property (readonly, nonatomic) char duEnabled;
@property (nonatomic) char hasDuEnabled;
...
@property (readonly, nonatomic) char isInternalTest;
@property (nonatomic) char hasIsInternalTest;
