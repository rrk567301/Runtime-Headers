@class NSString, BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval;
...
@property (nonatomic) char hasUserAggregationIdRotationTimestampInMs;
@property (readonly, nonatomic) unsigned long long userAggregationIdExpirationTimestampInMs;
@property (nonatomic) char hasUserAggregationIdExpirationTimestampInMs;
