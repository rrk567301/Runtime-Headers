...
@property (nonatomic) char hasAmbientLightColorComponent0;
@property (readonly, nonatomic) double ambientLightColorComponent1;
@property (nonatomic) char hasAmbientLightColorComponent1;
@property (readonly, nonatomic) double ambientLightColorComponent2;
@property (nonatomic) char hasAmbientLightColorComponent2;
