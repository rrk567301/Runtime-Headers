...
@property (nonatomic) char hasIsTimeSensitive;
@property (readonly, nonatomic) char isCritical;
@property (nonatomic) char hasIsCritical;
@property (readonly, nonatomic) char isCommunicationNotification;
@property (nonatomic) char hasIsCommunicationNotification;
