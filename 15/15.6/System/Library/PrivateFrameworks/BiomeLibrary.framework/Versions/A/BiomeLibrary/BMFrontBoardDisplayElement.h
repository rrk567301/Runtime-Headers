...
@property (nonatomic) char hasLayoutRole;
@property (readonly, nonatomic) long long level;
@property (nonatomic) char hasLevel;
@property (readonly, nonatomic) char hasKeyboardFocus;
@property (nonatomic) char hasHasKeyboardFocus;
@property (readonly, nonatomic) char isUIApplicationElement;
@property (nonatomic) char hasIsUIApplicationElement;
