...
@property (readonly, nonatomic) char fromPill;
@property (nonatomic) char hasFromPill;
@property (readonly, nonatomic) NSString *gesture;
@property (readonly, nonatomic) char gestureOn;
@property (nonatomic) char hasGestureOn;
