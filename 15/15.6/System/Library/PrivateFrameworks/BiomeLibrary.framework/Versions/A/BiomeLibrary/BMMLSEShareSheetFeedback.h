...
@property (nonatomic) char hasVisiblePeopleSuggestionCount;
@property (readonly, nonatomic) unsigned int visibleAppSuggestionCount;
@property (nonatomic) char hasVisibleAppSuggestionCount;
@property (readonly, nonatomic) char airdropPeopleSuggestionShown;
@property (nonatomic) char hasAirdropPeopleSuggestionShown;
