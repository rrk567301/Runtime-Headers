...
@property (class, nonatomic, getter=isEngramEnabled) char enableEngram;
@property (class, nonatomic, getter=isLiveDeliveryWarmUpEnabled) char enableLiveDeliveryWarmUp;
@property (class, nonatomic) long long phoneNumberValidationMode;
@property (class, readonly, nonatomic) char trustAnyCredential;
@property (class, copy, nonatomic) NSString *phoneNumberValidationPreflightTestData;
@property (class, readonly, nonatomic) char isWritePushPayloadsToDiskEnabled;
@property (class, readonly, nonatomic) char isWriteBlastDoorPayloadsToDiskEnabled;
@property (class, readonly, nonatomic) NSString *writePushPayloadsToDiskPath;
@property (class, readonly, nonatomic) char shouldDisableFailFastWhenSatelliteIsAvailable;
...
- (char)appBoolByHostForKey:(id)a0;
- (char)appBoolForKey:(id)a0;
...
- (void)setAppBool:(char)a0 byHostForKey:(id)a1;
- (void)setAppBool:(char)a0 forKey:(id)a1;
