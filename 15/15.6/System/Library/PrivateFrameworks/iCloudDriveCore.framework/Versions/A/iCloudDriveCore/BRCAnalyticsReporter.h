...
+ (void)_updateCachedEnabled:(char)a0;
+ (void)_updateCachedEnabled:(char)a0 updateLastFetchDate:(char)a1;
...
- (char)_shouldDeferForExistingSnapshot;
...
- (char)_resumePausedTreeConsistencyCheckOperationWithActivity:(id)a0;
...
- (void)createUserDownloadEventForOperationID:(id)a0 isRecursive:(char)a1 isForBackup:(char)a2;
