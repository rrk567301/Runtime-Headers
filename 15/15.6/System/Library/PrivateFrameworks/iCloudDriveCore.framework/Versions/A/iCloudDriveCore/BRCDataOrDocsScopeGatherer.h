...
- (id)initWithNotificationPipe:(id)a0 appLibraries:(id)a1 startingRank:(unsigned long long)a2 maxRank:(unsigned long long)a3 withDeadItems:(char)a4 gatherReply:(id /* block */)a5;
