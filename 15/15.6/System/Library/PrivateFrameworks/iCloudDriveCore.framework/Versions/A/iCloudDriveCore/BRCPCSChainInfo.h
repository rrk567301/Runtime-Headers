...
@property (readonly, nonatomic) char aliasTargetZoneIsShared;

- (void).cxx_destruct;
- (id)initWithItemID:(id)a0 parentID:(id)a1 structuralCKInfo:(id)a2 contentCKInfo:(id)a3 itemType:(char)a4 aliasTargetZoneIsShared:(char)a5 chainState:(unsigned int)a6;
