...
- (void)checkIfHasWork;
- (void)computeStamps:(struct throttle_stamps { unsigned int x0; int x1; long long x2; long long x3; long long x4; } *)a0 forJobID:(id)a1 throttle:(id)a2 shouldBackoff:(char)a3;
...
- (char)haveActiveJobsMatching:(id)a0;
...
- (char)setState:(int)a0 forJobID:(id)a1;
- (char)setState:(int)a0 forJobsMatching:(id)a1;
