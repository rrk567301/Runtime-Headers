...
- (void).cxx_destruct;
- (void)close;
- (char)_isGenericUntitledFileName:(id)a0;
...
- (char)analyzeServerBouncingOfItem:(id)a0 withServerItem:(id)a1;
- (char)analyzeServerBouncingOriginalRecord:(id)a0 savedRecord:(id)a1;
