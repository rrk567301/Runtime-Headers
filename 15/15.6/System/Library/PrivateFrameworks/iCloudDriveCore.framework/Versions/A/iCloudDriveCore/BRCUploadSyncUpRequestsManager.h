...
- (char)cancelRequestForIdentifier:(id)a0 error:(id *)a1;
- (void)dumpToContext:(id)a0;
- (char)finishRequestForIdentifer:(id)a0 finishError:(id)a1 error:(id *)a2;
...
- (char)registerRequestForIdentifier:(id)a0 requestType:(short)a1 requestSource:(id)a2 progress:(id)a3 finishBlock:(id /* block */)a4 error:(id *)a5;
