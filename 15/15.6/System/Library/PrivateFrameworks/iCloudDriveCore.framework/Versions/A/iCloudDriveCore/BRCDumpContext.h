...
@property (nonatomic) char onlyActiveStuff;
@property (nonatomic) char dumpTrackedPendingDownloads;
@property (retain, nonatomic) brc_task_tracker *taskTracker;
@property (nonatomic) char newLineAfterWrite;
...
+ (id)stringFromByteCount:(long long)a0 showActualByteCount:(char)a1 suffix:(id)a2 context:(id)a3;
+ (id)stringFromCount:(long long)a0 context:(id)a1;
+ (id)stringFromCount:(long long)a0 showActualCount:(char)a1 suffix:(id)a2 isByteCount:(char)a3 context:(id)a4;
+ (id)stringFromDueDate:(id)a0 allowsPast:(char)a1 context:(id)a2;
+ (id)stringFromDueStamp:(long long)a0 allowsPast:(char)a1 context:(id)a2;
...
- (void)popIndentation;
- (char)shouldKeepDumpingWithItemCount:(unsigned int)a0 includeAllItems:(char)a1;
- (void)writeEmptyLine;
