...
- (char)_checkIfShouldDedicateOpToPCSChainingItem:(id)a0;
- (char)_checkIfShouldDedicateOpToSaltingBasehashItem:(id)a0;
...
- (char)_recoverItemIDChangedWhileUploadingIfNecessary:(id)a0;
- (char)_validateSharedDocumentFieldsForRecord:(id)a0 item:(id)a1;
...
- (char)checkIfSyncAllowedInSharedZoneForItem:(id)a0;
