...
- (char)saveChangedRecords:(id)a0 deletedRecordIDs:(id)a1 deletedShareRecordIDs:(id)a2 clientChangeToken:(unsigned long long)a3 serverChangeToken:(id)a4 caughtUp:(char)a5 pendingChanges:(id)a6;
