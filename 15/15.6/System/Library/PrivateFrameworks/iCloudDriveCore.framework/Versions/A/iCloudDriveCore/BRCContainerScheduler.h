@class BRCDeadlineScheduler, BRCDeadlineSource, APSConnection, NSObject, BRCAccountSession, _BRCOperation, BRCContainerMetadataSyncPersistedState, BRCFairSource, BRCSideCarSyncPersistedState, BRCSyncOperationThrottle, NSString, BRCPeriodicSyncScheduler, BRCMigrateZonePCSOperation, BRCZoneHealthSyncPersistedState, BRCSyncBudgetThrottle, BRCSideCarSyncDownHandler, NSMutableArray, NSData, NSError;
@protocol BRCOperationSubclass, OS_dispatch_workloop;
...
- (void)dumpToContext:(id)a0 includeAllItems:(char)a1 db:(id)a2;
...
- (void)scheduleSyncDownForSharedDatabaseImmediately:(char)a0;
