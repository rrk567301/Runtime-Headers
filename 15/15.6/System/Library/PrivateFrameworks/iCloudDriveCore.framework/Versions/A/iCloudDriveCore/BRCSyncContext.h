...
+ (id)_contextIdentifierForMangledID:(id)a0 metadata:(char)a1;
...
- (char)_cancelBgSystemTaskIfNeededForCKOperation:(id)a0;
- (void)_cancelOperation:(id)a0 underlyingError:(id)a1;
- (id)_get_foregroundStateQueue;
- (void)_notifyContainerBeingNowForeground;
- (void)_notifyFrameworkContainersMonitorWithState:(char)a0;
- (void)_preventConcurrentModifyRecordsOperations:(id)a0 nonDiscretionary:(char)a1;
- (void)_setupCKOperationConfiguration:(id)a0 allowsCellularAccess:(id)a1 nonDiscretionary:(id)a2;
- (void)_updateSubmittedBGSystemTasksWithState:(char)a0;
- (void)_updateSubmittedBGSystemTasksWithState:(char)a0 submittedBGSystemTaskIdentifiers:(id)a1;
- (void)_updateWifiOnlyBGSystemTaskWithCancelledTaskIdentifiers:(id)a0 inexpensiveNetworkConnectivity:(char)a1;
...
- (void)addOperation:(id)a0 nonDiscretionary:(char)a1;
...
- (id)initWithSession:(id)a0 contextIdentifier:(id)a1 isShared:(char)a2;
