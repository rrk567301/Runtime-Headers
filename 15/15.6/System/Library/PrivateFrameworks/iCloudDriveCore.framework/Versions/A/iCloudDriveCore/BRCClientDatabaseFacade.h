...
- (id)allItemsSortedByDepthDescendingInZoneRowID:(id)a0 descending:(char)a1 isSharedZone:(char)a2 parentItemID:(id)a3 itemBuilder:(id)a4;
- (id)clientChildCountWithParentID:(id)a0 zoneRowID:(id)a1;
- (char)clientStateData:(id *)a0 clientStateDictionary:(id *)a1 silent:(char)a2;
- (id)clientStateDictionary;
- (id)clientStateDictionaryWithSilent:(char)a0;
- (char)containsNonRejectedChildWithParentID:(id)a0 zoneRowID:(id)a1;
...
- (char)existsByParentID:(id)a0 andLogicalName:(id)a1 excludingItemGlobalID:(id)a2 zoneRowID:(id)a3;
...
- (char)zoneHasItemsWithInflightDiffsInZoneRowID:(id)a0;
