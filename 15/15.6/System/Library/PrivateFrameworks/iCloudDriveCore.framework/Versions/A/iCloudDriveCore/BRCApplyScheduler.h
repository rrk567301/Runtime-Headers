...
- (void)_didSyncDownZone:(id)a0 requestID:(unsigned long long)a1 upToRank:(long long)a2 caughtUpWithServer:(char)a3 isFixingState:(char)a4;
- (void)_handleWatchingFaults;
- (char)_rescheduleItemsParentedToItemGlobalID:(id)a0 flags:(unsigned int)a1;
...
- (void)didSyncDownZone:(id)a0 requestID:(unsigned long long)a1 upToRank:(long long)a2 caughtUpWithServer:(char)a3;
- (void)fixAndAcknowledgeSyncDown:(id)a0 requestID:(unsigned long long)a1 upToRank:(long long)a2 caughtUpWithServer:(char)a3;
- (id)initWithAccountSession:(id)a0;
- (void)monitorFaultingForZone:(id)a0;
- (unsigned long long)recoverAndReportMissingJobs;
- (unsigned int)recoverMissingJobsAndReport:(char)a0;
