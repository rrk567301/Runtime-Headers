...
@property (readonly, nonatomic) char encounteredErrorOnPCSChainedItem;
@property (nonatomic) char throttledItemInBatch;
...
- (char)_handlePermissionErrorForItem:(id)a0 inZone:(id)a1;
...
- (char)_performMetadataSaltingOperationIfNecessaryWithCompletion:(id /* block */)a0;
- (void)_performModifyRecordsOrBatchOperationWithCompletion:(id /* block */)a0;
- (char)_performPCSChainOperationIfNecessaryWithCompletion:(id /* block */)a0;
...
- (char)_recordIsIWorkShareable:(id)a0;
...
- (void)_setSharingFieldsOnContentRecord:(id)a0 withProtectionData:(id)a1 baseToken:(id)a2 routingKey:(id)a3 forceOverwrite:(char)a4;
- (id)initWithZone:(id)a0 sessionContext:(id)a1 syncUpCallback:(id)a2;
- (void)performShareUpdate:(id /* block */)a0;
- (char)prepareWithMaxCost:(float)a0 retryAfter:(unsigned long long *)a1;
