...
+ (char)modeFromImportObject:(id)a0 isPackageFault:(char)a1;
...
- (id)initAsShareAcceptFaultWithName:(id)a0 mode:(char)a1 isDirectory:(char)a2;
...
- (void)updateFromImportObject:(id)a0 onlyContentDependentProperties:(char)a1;
- (void)updateWithFileSystemFlags:(unsigned long long)a0 ignoreExecutable:(char)a1;
