...
+ (void)fillStructureRecord:(id)a0 inZone:(id)a1 itemID:(id)a2 ckInfo:(id)a3 parentID:(id)a4 targetItemID:(id)a5 targetZone:(id)a6 diffs:(unsigned long long)a7 isFolderShare:(char)a8 beingDeadInServerTruth:(char)a9 shouldPCSChainStatus:(unsigned char)a10;
+ (id)targetReferenceWithItemID:(id)a0 targetZone:(id)a1 isFolderShare:(char)a2;
...
- (id)structureRecordBeingDeadInServerTruth:(char)a0 stageID:(id)a1 shouldPCSChainStatus:(unsigned char)a2;
