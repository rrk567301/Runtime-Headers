...
@property char manuallyTriggered;
@property (retain) NSUUID *migrationUUID;
@property (retain) NSString *domainID;
@property char isDesktopEnabled;
@property (retain, nonatomic) NSError *lastError;
@property unsigned long long errorOriginatorId;
@property char errorOverriden;
@property (retain) NSString *crashReporterKey;
@property char sideFaultsBelowThreshold;
@property char nonSideFaultsCompletelyMigrated;
@property unsigned long long expectedAmountOfItemsMigrated;
@property unsigned long long itemsThatAreNotMigrated;
@property struct BRTypesField { union { int types; struct { unsigned char doc : 1; unsigned char alias : 1; unsigned char symlink : 1; unsigned char folder : 1; unsigned char fault : 1; unsigned char root : 1; unsigned char bookmark : 1; unsigned char bookmarkfault : 1; unsigned char shareacceptfault : 1; unsigned char package : 1; } ; } ; } typeOfNotMigrated;
@property struct BRTypesField { union { int types; struct { unsigned char doc : 1; unsigned char alias : 1; unsigned char symlink : 1; unsigned char folder : 1; unsigned char fault : 1; unsigned char root : 1; unsigned char bookmark : 1; unsigned char bookmarkfault : 1; unsigned char shareacceptfault : 1; unsigned char package : 1; } ; } ; } typeOfMigrated;
