...
+ (void)initialize;
+ (id)addOrModifyUsersForDisk:(id)a0 doOnlyUser:(id)a1 useExistingAdminInfo:(char)a2 usersAndAttributes:(id)a3 adminUsers:(id)a4;
...
+ (int)copyFileFromPath:(id)a0 toDirAtPath:(id)a1 newName:(id)a2 interimDirs:(char)a3 recursive:(char)a4 preDelete:(char)a5 flags:(unsigned int)a6 copyFileErr:(int *)a7;
+ (void)copyIfExistsFromPath:(id)a0 toDirAtPath:(id)a1 abortOnErr:(char)a2 didTry:(char *)a3 setErrIfErr:(int *)a4 shouldAbort:(char *)a5;
