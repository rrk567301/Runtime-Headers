...
@interface MTLDebugCommandBuffer : MTLToolsCommandBuffer {
    ...
    char _didAddRenderTargetAttachments;
...
- (void)addObject:(id)a0 retained:(char)a1 purgeable:(char)a2;
- (void)addPurgeableObject:(id)a0;
- (void)addReferencedObject:(id)a0 internallyRetained:(char)a1;
...
- (void)removeAllReferencedObjects:(char)a0;
...
- (char)testObjectReferenced:(id)a0 wasInternallyRetained:(char *)a1;
