...
- (void)accumTextureDistribution:(id)a0 category:(unsigned long long)a1 pixelFormat:(unsigned long long)a2 baseAddr:(unsigned long long)a3 rowBytes:(unsigned long long)a4 isLinear:(char)a5;
