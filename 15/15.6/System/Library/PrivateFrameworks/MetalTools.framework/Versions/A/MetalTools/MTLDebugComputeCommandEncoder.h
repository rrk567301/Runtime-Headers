...
@interface MTLDebugComputeCommandEncoder : MTLToolsComputeCommandEncoder {
    struct MTLDebugFunctionArgument { char isValid; char hasBeenUsed; unsigned long long type; baseLevel *object; unsigned long long x0; unsigned long long bufferLength; unsigned long long bufferOffset; unsigned long long bufferAttributeStride; unsigned long long threadgroupMemoryLength; unsigned long long threadgroupMemoryOffset; char hasLodClamp; float lodMinClamp; float lodMaxClamp; } _buffers[31];
    struct MTLDebugFunctionArgument { char isValid; char hasBeenUsed; unsigned long long type; baseLevel *object; unsigned long long x0; unsigned long long bufferLength; unsigned long long bufferOffset; unsigned long long bufferAttributeStride; unsigned long long threadgroupMemoryLength; unsigned long long threadgroupMemoryOffset; char hasLodClamp; float lodMinClamp; float lodMaxClamp; } _textures[128];
    struct MTLDebugFunctionArgument { char isValid; char hasBeenUsed; unsigned long long type; baseLevel *object; unsigned long long x0; unsigned long long bufferLength; unsigned long long bufferOffset; unsigned long long bufferAttributeStride; unsigned long long threadgroupMemoryLength; unsigned long long threadgroupMemoryOffset; char hasLodClamp; float lodMinClamp; float lodMaxClamp; } _samplers[16];
    struct MTLDebugFunctionArgument { char isValid; char hasBeenUsed; unsigned long long type; baseLevel *object; unsigned long long x0; unsigned long long bufferLength; unsigned long long bufferOffset; unsigned long long bufferAttributeStride; unsigned long long threadgroupMemoryLength; unsigned long long threadgroupMemoryOffset; char hasLodClamp; float lodMinClamp; float lodMaxClamp; } _threadgroupMemoryLengths[31];
    ...
    char _encodingVirtualSubstream;
    int _currentVirtualSubstreamIndex;
    char _encodedVirtualSubstreamDispatch;
}
