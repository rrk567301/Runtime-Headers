...
@property (readonly) char loadValidationEnabled;
@property (readonly) char storeValidationEnabled;
@property (readonly) char relaxedTextureArrayBindingsEnabled;
...
- (void)validateResourceOptions:(unsigned long long)a0 isTexture:(char)a1 isIOSurface:(char)a2 context:(struct _MTLMessageContext { long long x0; char *x1; unsigned int x2; id x3; long long x4; id x5; char *x6; } *)a3;
