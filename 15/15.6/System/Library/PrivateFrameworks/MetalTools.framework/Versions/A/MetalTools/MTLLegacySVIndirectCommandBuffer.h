...
@property (readonly, nonatomic) char mayContainDrawMeshes;
@property (readonly, nonatomic) unsigned long long commandByteStride;
@property (readonly, nonatomic) char inheritsPipelineState;
@property (readonly, nonatomic) char inheritsBuffers;
