@class NSArray, NSString, MTLLegacySVImageData, NSObject, MTLDebugInstrumentationData;
@protocol OS_dispatch_data, MTLDevice;

@interface MTLLegacySVDynamicLibrary : MTLToolsDynamicLibrary <MTLDynamicLibrarySPI>

@property (readonly, nonatomic) MTLLegacySVImageData *imageData;
...
@property (readonly, nonatomic) char shaderValidationEnabled;
