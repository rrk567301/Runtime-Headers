...
+ (char)_isFactorRecordFileType:(id)a0;
...
+ (char)sysdiagnoseInfoToDir:(id)a0 error:(id *)a1;
...
- (char)deregisterNamespaceName:(id)a0 error:(id *)a1;
...
- (char)registerNamespaceName:(id)a0 compatibilityVersion:(unsigned int)a1 defaultsFileURL:(id)a2 applicationGroup:(id)a3 cloudKitContainerId:(int)a4 error:(id *)a5;
- (id)levelForFactor:(id)a0 withNamespaceName:(id)a1;
- (void)setLogger:(id)a0;
- (id)newTrackingId;
- (char)trialIdentifiersWithNamespaceName:(id)a0 experimentId:(id *)a1 deploymentId:(int *)a2 treatmentId:(id *)a3;
...
- (char)hasCounterfactualsForNamespace:(id)a0;
- (char)hasDownloadedNamespaceWithName:(id)a0;
...
- (char)_hasAppropriatePermissionsForNamespaceName:(id)a0;
- (void)_invalidateFactors;
- (void)_lazyInit;
- (void)_logBMLTCustomTargetingWithResult:(char)a0;
...
- (char)enumerateCounterfactualsWithNamespace:(id)a0 error:(id *)a1 usingBlock:(id /* block */)a2;
- (char)evaluateBMLTTargetingExpression:(id)a0 withParameters:(id)a1 error:(id *)a2;
...
- (id)newTrackingIdWithTreatmentRefresh:(char)a0;
- (char)promoteFactorsForNamespace:(id)a0 error:(id *)a1;
...
- (char)setFactorsProvisionalForNamespace:(id)a0 error:(id *)a1;
- (char)setPurgeabilityLevelsForFactors:(id)a0 withNamespaceName:(id)a1;
