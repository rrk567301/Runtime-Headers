...
@property (readonly, nonatomic) char promotable;
...
- (id)factorLevels;
- (id)initWithParentId:(id)a0 deploymentId:(int)a1 promotable:(char)a2;
- (id)initWithPath:(id)a0 parentId:(id)a1 deploymentId:(int)a2 treatmentId:(id)a3 promotable:(char)a4;
