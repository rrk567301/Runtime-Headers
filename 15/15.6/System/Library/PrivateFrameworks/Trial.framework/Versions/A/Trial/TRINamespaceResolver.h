...
- (char)_prepareFactorsStateForExperimentsOnTreatmentPathForDeployment:(id)a0;
...
- (char)_hasBMLTFactorsState;
- (char)_hasCounterfactualFactorsState;
- (char)_hasExperimentFactorsState;
- (char)_hasRolloutFactorsState;
- (char)_prepareFactorsState:(id)a0;
- (char)_prepareFactorsStateForCounterfactualsForFactorsState:(id)a0;
- (char)_prepareFactorsStateForExperimentsOnFactorPackSetPathForDeployment:(id)a0;
...
- (id)resolveFactorProviderChainForNamespaceName:(id)a0 faultOnMissingInstalledFactors:(char)a1 installedFactorsAccessible:(char *)a2;
