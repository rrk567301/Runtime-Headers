...
- (void)createKernel;
- (id)forward:(id)a0 input:(id)a1 labels:(id)a2 runInference:(char)a3;
...
- (id)seqForward:(id)a0 input:(id)a1 dataBatch:(id)a2 runInference:(char)a3;
- (id)seqForward:(id)a0 inputMatrix:(id)a1 dataBatch:(id)a2 runInference:(char)a3;
- (id)seqInferenceForward:(id)a0 inputMatrix:(id)a1 dataBatch:(id)a2;
- (id)seqTrainingForward:(id)a0 inputMatrix:(id)a1 dataBatch:(id)a2 computeLossGradient:(char)a3;
- (id)seqTrainingForward:(id)a0 subMatrix:(id)a1 reductionSumResults:(id)a2 alphaVec:(id)a3 labels:(id)a4 rowOffset:(unsigned long long)a5 computeNRows:(unsigned long long)a6 computeLossGradient:(char)a7;
