...
- (void)createKernel;
- (void)exportWeightsWithWeightMatrix:(id)a0 weightID:(unsigned long long)a1 destination:(float *)a2 recurrent:(char)a3;
...
- (void)updateSourceMatrix:(id)a0 inference:(char)a1;
