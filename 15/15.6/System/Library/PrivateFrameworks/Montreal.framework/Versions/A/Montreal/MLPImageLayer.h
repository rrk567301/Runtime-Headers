...
- (void)updateInputToFirstKernel:(id)a0 index:(id)a1 inference:(char)a2;
- (void)updateInputToFirstKernel:(id)a0 inference:(char)a1;
- (void)updateInputToSecondKernel:(id)a0 index:(id)a1 inference:(char)a2;
- (void)updateInputToSecondKernel:(id)a0 inference:(char)a1;
- (void)updatePrimaryCurrentState:(id)a0 index:(id)a1 inference:(char)a2;
- (void)updatePrimaryCurrentState:(id)a0 inference:(char)a1;
- (void)updateSecondaryCurrentState:(id)a0 index:(id)a1 inference:(char)a2;
- (void)updateSecondaryCurrentState:(id)a0 inference:(char)a1;
