...
- (void).cxx_destruct;
- (void)finishWriting;
- (id)initWithVisualizer:(id)a0 fileHandle:(struct __sFILE { char *x0; int x1; int x2; short x3; short x4; struct __sbuf { char *x0; int x1; } x5; int x6; void *x7; void /* function */ *x8; void /* function */ *x9; void /* function */ *x10; void /* function */ *x11; struct __sbuf { char *x0; int x1; } x12; struct __sFILEX *x13; int x14; unsigned char x15[3]; unsigned char x16[1]; struct __sbuf { char *x0; int x1; } x17; int x18; long long x19; } *)a1 closeWhenDone:(char)a2 error:(id *)a3;
- (void)writeAllUnitsInTable:(unsigned int)a0 block:(id /* block */)a1;
- (char)fwrite:(const void *)a0 size:(unsigned long long)a1 numberOfItems:(unsigned long long)a2 error:(id *)a3;
...
- (char)writeDictionary:(id)a0 error:(id *)a1;
- (char)writeMetadata:(id)a0 forStore:(struct __CSStore { } *)a1 error:(id *)a2;
