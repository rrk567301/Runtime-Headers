...
+ (char)operatorIsNumeric:(unsigned long long)a0;
...
- (char)evaluateNumerically:(id)a0;
- (char)getRanges:(void *)a0 inDescription:(id)a1 options:(unsigned long long)a2 limit:(unsigned long long)a3 searchedInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a4;
