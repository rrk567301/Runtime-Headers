...
+ (char)getUnit:(unsigned int *)a0 inTable:(unsigned int *)a1 fromURL:(id)a2;
...
+ (char)unitDescription:(id)a0 referencesUnit:(unsigned int)a1 inTable:(unsigned int)a2;
...
- (id)initWithStore:(struct __CSStore { } *)a0 useStandardTableFunctions:(char)a1;
...
- (id)iconForUnit:(unsigned int)a0 inTable:(unsigned int)a1;
- (id)initWithStore:(struct __CSStore { } *)a0 useStandardTableHandlers:(char)a1;
