...
+ (char)encodeDataAndRecord:(id)a0 dataTypeContent:(id)a1 baseKey:(id)a2 errorOut:(id *)a3;
+ (char)encodeDataArrayAndRecord:(id)a0 dataTypeContent:(id)a1 baseKey:(id)a2 errorOut:(id *)a3;
+ (id)createWithDataTypeContent:(id)a0 possibleError:(id *)a1;
+ (char)encodeDataAndRecord:(id)a0 dataTypeContent:(id)a1 metadata:(id)a2 baseKey:(id)a3 errorOut:(id *)a4;
+ (id)encodeDataArray:(id)a0 dataTypeContent:(id)a1 resultType:(unsigned long long *)a2 errorOut:(id *)a3;
+ (char)encodeDataArrayAndRecord:(id)a0 dataTypeContent:(id)a1 metadata:(id)a2 baseKey:(id)a3 errorOut:(id *)a4;
+ (char)record:(id)a0 metadata:(id)a1 baseKey:(id)a2;
