...
@property (nonatomic) char supportsDelegateTokens;
...
@property (nonatomic) char accessibilityEnabled;
...
- (char)shouldCheckTreeDumpCacheForRequestType:(unsigned long long)a0;
