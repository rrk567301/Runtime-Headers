...
- (char)_shouldPostProcessSubstituteRemoteRepresentationWithObject:(id)a0 forAttribute:(unsigned long long)a1;
- (char)_synthesizeMouseClick:(unsigned int)a0;
...
- (char)performNotifyVoiceOverAnnouncementCompletionWithValue:(id)a0;
