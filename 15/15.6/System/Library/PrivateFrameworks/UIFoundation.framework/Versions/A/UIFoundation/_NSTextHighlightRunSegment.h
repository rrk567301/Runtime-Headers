...
- (char)anyRunHasBottomBorderOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
- (char)anyRunHasTopBorderOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
...
- (char)doesAnySegmentHaveBottomBorderOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
- (char)doesAnySegmentHaveTopBorderOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
- (char)nextSegmentInCurrentRunIsOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
- (char)previousSegmentInCurrentRunIsOnPoint:(struct CGPoint { double x0; double x1; })a0 withLeftCornerExtensionDistance:(double *)a1 withRightCornerExtensionDistance:(double *)a2;
