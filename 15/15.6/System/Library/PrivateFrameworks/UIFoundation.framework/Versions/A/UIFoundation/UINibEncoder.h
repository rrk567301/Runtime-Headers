...
@property (nonatomic, getter=isUnorderedCollectionSortingEnabled) char unorderedCollectionSortingEnabled;
...
- (id)nextGenericKey;
- (char)object:(id)a0 encodesAsMemberAndWithCoderOfClass:(Class)a1;
- (char)object:(id)a0 encodesWithCoderFromClass:(Class)a1;
- (id)objectIDForObject:(id)a0;
- (char)previouslyCodedObject:(id)a0;
- (id)replacementObjectForObject:(id)a0 forKey:(id)a1;
- (void)serializeDictionary:(id)a0;
- (void)serializeSet:(id)a0;
- (char)shouldUniqueObjectByValue:(id)a0;
