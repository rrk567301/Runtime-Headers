...
- (void)invalidateTextLayoutFragmentsInTextRange:(id)a0 adjustTextRange:(char)a1;
- (void)invalidateTextLayoutFragmentsInTextRange:(id)a0 delta:(long long)a1;
- (long long)offsetDeltaForLastTextLayoutFragment;
- (char)revalidateLayoutFragmentRangeForLocation:(id)a0;
- (void)setTextLayoutFragments:(id)a0;
- (id)textLayoutFragmentForTextLocation:(id)a0 allowsTrailingEdge:(char)a1;
