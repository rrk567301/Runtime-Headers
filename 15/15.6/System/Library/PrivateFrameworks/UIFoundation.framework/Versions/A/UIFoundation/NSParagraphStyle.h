...
@property (readonly) char usesDefaultHyphenation;
...
- (char)isFullyJustified;
- (void)_allocExtraData;
- (char)_alignmentFollowsWritingDirection;
- (id)_initWithParagraphStyle:(id)a0;
- (char)_isSuitableForFastStringDrawingWithAlignment:(long long *)a0 mirrorsTextAlignment:(char)a1 lineBreakMode:(unsigned long long *)a2 tighteningFactorForTruncation:(double *)a3;
