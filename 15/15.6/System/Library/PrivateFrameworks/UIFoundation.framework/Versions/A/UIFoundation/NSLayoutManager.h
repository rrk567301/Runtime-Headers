...
@property (readonly, getter=isScrolling) char scrolling;
...
- (void)_setMirrorsTextAlignment:(char)a0;
...
- (long long)getLineFragmentInsertionPointArraysForCharacterAtIndex:(unsigned long long)a0 inDisplayOrder:(char)a1 positions:(double **)a2 characterIndexes:(unsigned long long **)a3 count:(unsigned long long *)a4 alternatePositions:(double **)a5 characterIndexes:(unsigned long long **)a6 count:(unsigned long long *)a7;
- (unsigned long long)getLineFragmentInsertionPointsForCharacterAtIndex:(unsigned long long)a0 alternatePositions:(char)a1 inDisplayOrder:(char)a2 positions:(double *)a3 characterIndexes:(unsigned long long *)a4;
- (unsigned int)glyphAtIndex:(unsigned long long)a0 isValidIndex:(char *)a1;
...
- (void)invalidateLayoutForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isSoft:(char)a1 actualCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
- (char)isValidGlyphIndex:(unsigned long long)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })lineFragmentRectForGlyphAtIndex:(unsigned long long)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 withoutAdditionalLayout:(char)a2;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })lineFragmentUsedRectForGlyphAtIndex:(unsigned long long)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 withoutAdditionalLayout:(char)a2;
...
- (void)setUsesScreenFonts:(char)a0;
...
- (id)textContainerForGlyphAtIndex:(unsigned long long)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 withoutAdditionalLayout:(char)a2;
...
- (unsigned short)CGGlyphAtIndex:(unsigned long long)a0 isValidIndex:(char *)a1;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })lineFragmentUsedRectForGlyphAtIndex:(unsigned long long)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 allowLayout:(char)a2;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_blockRowRangeForCharRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 completeRows:(char *)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_blockRowRangeForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 completeRows:(char *)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_boundingRectForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextContainer:(id)a1 fast:(char)a2 fullLineRectsOnly:(char)a3;
...
- (char)_doOptimizedLayoutStartingAtGlyphIndex:(unsigned long long)a0 forCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextContainer:(id)a2 lineLimit:(unsigned long long)a3 nextGlyphIndex:(unsigned long long *)a4;
...
- (void)_drawLineForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inContext:(struct CGContext { } *)a1 from:(double)a2 to:(double)a3 at:(double)a4 thickness:(double)a5 lineOrigin:(struct CGPoint { double x0; double x1; })a6 breakForDescenders:(char)a7;
- (void)_drawLineForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inContext:(struct CGContext { } *)a1 from:(double)a2 to:(double)a3 at:(double)a4 thickness:(double)a5 lineOrigin:(struct CGPoint { double x0; double x1; })a6 breakForDescenders:(char)a7 flipped:(char)a8;
...
- (void)_fillLayoutHoleForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 desiredNumberOfLines:(unsigned long long)a1 isSoft:(char)a2;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_firstPassGlyphRangeForBoundingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inTextContainer:(id)a1 okToFillHoles:(char)a2;
- (void)_forceDisplayToBeCorrectForViewsWithUnlaidGlyphs;
- (char)_forcesTrackingFloor;
- (unsigned int)_glyphAtIndex:(unsigned long long)a0 characterIndex:(unsigned long long *)a1 glyphInscription:(unsigned long long *)a2 isValidIndex:(char *)a3;
- (id)_glyphDescription;
- (id)_glyphHoleDescription;
- (unsigned long long)_glyphIndexForCharacterIndex:(unsigned long long)a0 startOfRange:(char)a1 okToFillHoles:(char)a2;
- (unsigned long long)_glyphIndexForCharacterIndex:(unsigned long long)a0 startOfRange:(char)a1 okToFillHoles:(char)a2 considerNulls:(char)a3;
- (id)_glyphLocationDescription;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_glyphRangeForBoundingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inTextContainer:(id)a1 fast:(char)a2 okToFillHoles:(char)a3;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_glyphRangeForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 actualCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 okToFillHoles:(char)a2;
- (id)_glyphTreeDescription;
- (void)_growCachedRectArrayToSize:(unsigned long long)a0;
- (double)_hyphenationFactor;
- (unsigned long long)_indexOfFirstGlyphInTextContainer:(id)a0 okToFillHoles:(char)a1;
- (void)_insertGlyphs:(unsigned int *)a0 elasticAttributes:(char *)a1 count:(unsigned long long)a2 atGlyphIndex:(unsigned long long)a3 characterIndex:(unsigned long long)a4;
...
- (void)_invalidateGlyphsForExtendedCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 changeInLength:(long long)a1 includeBlocks:(char)a2;
- (void)_invalidateInsertionPoint;
- (void)_invalidateLayoutForExtendedCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isSoft:(char)a1;
- (void)_invalidateLayoutForExtendedCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isSoft:(char)a1 invalidateUsage:(char)a2;
...
- (id)_lineFragmentDescription:(char)a0;
- (id)_lineFragmentDescriptionForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includeGlyphLocations:(char)a1;
- (void)_lineGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 type:(long long)a1 lineFragmentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 lineFragmentGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 containerOrigin:(struct CGPoint { double x0; double x1; })a4 isStrikethrough:(char)a5;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)_rectArrayForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withinSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 rangeIsCharRange:(char)a2 singleRectOnly:(char)a3 fullLineRectsOnly:(char)a4 inTextContainer:(id)a5 rectCount:(unsigned long long *)a6 rangeWithinContainer:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a7 glyphsDrawOutsideLines:(char *)a8;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)_rectArrayForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withinSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 rangeIsCharRange:(char)a2 singleRectOnly:(char)a3 fullLineRectsOnly:(char)a4 inTextContainer:(id)a5 rectCount:(unsigned long long *)a6 rangeWithinContainer:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a7 glyphsDrawOutsideLines:(char *)a8 rectArray:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a9 rectArrayCapacity:(unsigned long long)a10;
...
- (id)_rowArrayCache;
- (void)_setAlwaysDrawsActive:(char)a0;
- (void)_setCachedTextContainer:(id)a0 isVertical:(char)a1;
...
- (void)_setDrawsDebugBaselines:(char)a0;
- (void)_setDrawsUnderlinesLikeWebKit:(char)a0;
...
- (void)_setForcesTrackingFloor:(char)a0;
...
- (void)_setHasSeenRightToLeft:(char)a0;
- (void)_setHyphenationFactor:(double)a0;
- (void)_setNeedToFlushGlyph:(char)a0;
...
- (void)_simpleInsertGlyph:(unsigned int)a0 atGlyphIndex:(unsigned long long)a1 characterIndex:(unsigned long long)a2 elastic:(char)a3;
- (unsigned long long)_smallEncodingGlyphIndexForCharacterIndex:(unsigned long long)a0 startOfRange:(char)a1 okToFillHoles:(char)a2;
- (unsigned long long)_smallEncodingGlyphIndexForCharacterIndex:(unsigned long long)a0 startOfRange:(char)a1 okToFillHoles:(char)a2 considerNulls:(char)a3;
...
- (unsigned long long)getGlyphsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 glyphs:(unsigned int *)a1 characterIndexes:(unsigned long long *)a2 glyphInscriptions:(unsigned long long *)a3 elasticBits:(char *)a4;
...
- (char)notShownAttributeForGlyphAtIndex:(unsigned long long)a0;
...
- (void)setDrawsOutsideLineFragment:(char)a0 forGlyphAtIndex:(unsigned long long)a1;
- (void)setEllipsisGlyphAttribute:(char)a0 forGlyphAtIndex:(unsigned long long)a1;
...
- (void)setIgnoresAntialiasThreshold:(char)a0;
- (void)setIgnoresViewTransformations:(char)a0;
...
- (void)setLocation:(struct CGPoint { double x0; double x1; })a0 forStartOfGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 coalesceRuns:(char)a2;
...
- (void)setNotShownAttribute:(char)a0 forGlyphAtIndex:(unsigned long long)a1;
- (void)setSynchronizesAlignmentToDirection:(char)a0;
