...
@interface NSTextContainer : NSObject <NSTextLayoutOrientationProvider, NSSecureCoding> {
    ...
    char _textViewSupportsDowngrade;
    char _textViewHasDefaultParagraphStyle;
    char _textViewHasLinkTextAttributes;
    char _textViewHasHighlightAttributes;
...
@property (readonly, getter=isSimpleRectangularTextContainer) char simpleRectangularTextContainer;
@property char widthTracksTextView;
@property char heightTracksTextView;
...
- (char)_hasLayoutManager:(id)a0;
- (void)_setContainerObservesTextViewFrameChanges:(char)a0;
- (unsigned long long)_textLength;
- (char)_textViewAllowsMigratingToLayoutManager;
