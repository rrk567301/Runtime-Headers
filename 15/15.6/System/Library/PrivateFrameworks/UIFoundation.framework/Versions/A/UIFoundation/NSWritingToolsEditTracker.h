...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfSuggestionWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 UUID:(id)a1 applyDelta:(char)a2;
