...
+ (void)initialize;
+ (id)_createChildElementsFromAttributedString:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 indentLevel:(long long)a2 includesTextListMarkers:(char)a3 effectiveRange:(out struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a4 textListElementInstantiationCallback:(id /* block */)a5;
+ (id)_createElementWithChildElements:(id)a0 textList:(id)a1 nestingLevel:(long long)a2;
+ (id)_createTextListElementFromAttributedString:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 indentLevel:(long long)a2 includesTextListMarkers:(char)a3 effectiveRange:(out struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a4 textListElementInstantiationCallback:(id /* block */)a5;
...
+ (struct _NSRange { unsigned long long x0; unsigned long long x1; })_textListElementContentsRangeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inAttributedString:(id)a1 hadMarker:(out char *)a2;
...
- (void)dealloc;
- (void).cxx_destruct;
- (id)locationForCharacterIndex:(long long)a0 dataSourceLocationsOnly:(char)a1 actualRange:(out struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
- (char)_appendsParagraphSeparator;
...
- (char)isRepresentedElement;
- (long long)itemNumber;
- (id)markerAttributedString;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeForLocation:(id)a0 allowsTrailingEdge:(char)a1;
