...
@property (class, readonly) NSArray *defaultTextHighlightStyles;
@property (class, readonly) NSArray *defaultTextHighlightColorSchemes;
...
- (void)_popState;
- (void)_pushState;
- (void)_setCurrentBorderEdge:(unsigned long long)a0 isTable:(char)a1;
