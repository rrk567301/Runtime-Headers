...
+ (void)_setHasCustomSettings:(char)a0;
...
- (void)drawTextContainer:(id)a0 withRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 graphicsContext:(struct CGContext { } *)a2 baselineMode:(char)a3 scrollable:(char)a4 padding:(double)a5;
- (id)layoutManager;
...
- (void)_setBaselineMode:(char)a0;
- (void)_setForceWordWrapping:(char)a0;
- (void)_setWrappedByCluster:(char)a0;
- (char)_wrappedByCluster;
- (void)drawTextContainer:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 withRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 graphicsContext:(struct CGContext { } *)a3 baselineMode:(char)a4 scrollable:(char)a5 padding:(double)a6;
- (void)fontSetChanged;
- (void)processEditing;
