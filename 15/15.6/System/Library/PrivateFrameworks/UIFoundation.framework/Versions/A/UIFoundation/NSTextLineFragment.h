...
- (void)_processCaretGlyphRunForTextSelectionProvider:(id)a0 baseLocation:(id)a1 runRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 glyphOffset:(double)a3 positionsCache:(inout double **)a4 positionsCacheSize:(inout unsigned long long *)a5 stop:(inout char *)a6 usingBlock:(id /* block */)a7;
...
- (char)_selectionColorShouldOverrideColor:(id)a0;
...
- (char)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x0; double x1; })a0 context:(struct CGContext { } *)a1;
- (char)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x0; double x1; })a0 context:(struct CGContext { } *)a1 adjustmentCallback:(id /* block */)a2;
- (char)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x0; double x1; })a0 graphicsContext:(id)a1;
- (char)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x0; double x1; })a0 graphicsContext:(id)a1 adjustmentCallback:(id /* block */)a2;
...
- (char)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x0; double x1; })a0 graphicsContext:(id)a1 backgroundOnly:(char)a2 adjustmentCallback:(id /* block */)a3;
...
- (void)enumerateTextSegmentBoundsInTextRange:(id)a0 dataSourceLocationsOnly:(char)a1 usingBlock:(id /* block */)a2;
