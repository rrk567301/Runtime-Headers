...
- (char)_closeBlocksForParagraphStyle:(id)a0 atIndex:(unsigned long long)a1 inString:(id)a2;
- (char)_closeListsForParagraphStyle:(id)a0 atIndex:(unsigned long long)a1 inString:(id)a2;
...
- (void)_generateHTML;
- (void)_generateHTMLForWebKit:(char)a0;
...
- (void)_openListsForParagraphStyle:(id)a0 atIndex:(unsigned long long)a1 inString:(id)a2 isStrict:(char)a3;
- (unsigned long long)_paragraphClassforParagraphStyle:(id)a0 presentationIntent:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 isEmpty:(char)a3 isCompletelyEmpty:(char)a4 headerString:(id *)a5 alignmentString:(id *)a6 directionString:(id *)a7 forWebKit:(char)a8;
- (id)_prefixDown;
- (id)_prefixUp;
- (void)_prepareString:(id)a0 forConversionToEncoding:(unsigned long long)a1;
- (id)_resourceForFileWrapper:(id)a0 filename:(id *)a1;
- (unsigned long long)_spanClassForAttributes:(id)a0 inParagraphClass:(unsigned long long)a1 spanClass:(unsigned long long)a2 flags:(unsigned long long *)a3 forWebKit:(char)a4;
