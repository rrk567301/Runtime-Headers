...
@property (readonly) char _hasTextAttachmentViewCell;
...
@property char allowsTextAttachmentView;
@property (readonly) char usesTextAttachmentView;
...
- (char)_isEmojiImage;
- (void)_setAllocatesTextContainer:(char)a0;
