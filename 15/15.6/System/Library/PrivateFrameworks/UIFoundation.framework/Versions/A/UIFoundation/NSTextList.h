...
@property (readonly, getter=isOrdered) char ordered;

+ (void)initialize;
+ (id)_standardMarkerAttributesForAttributes:(id)a0;
+ (char)includesTextListMarkers;
...
- (id)_markerForMarkerFormat:(id)a0 itemNumber:(long long)a1 isNumbered:(char *)a2 substitutionStart:(unsigned long long *)a3 end:(unsigned long long *)a4 specifierStart:(unsigned long long *)a5 end:(unsigned long long *)a6;
- (id)_markerSpecifier;
