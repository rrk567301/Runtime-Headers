...
- (void)setLimitsLayoutForSuspiciousContents:(char)a0;
...
- (char)_layoutLineFragmentStartingWithGlyphAtIndex:(unsigned long long *)a0 characterIndex:(unsigned long long *)a1 atPoint:(struct CGPoint { double x0; double x1; } *)a2 renderingContext:(id *)a3;
...
- (void)_setBaselineRenderingMode:(char)a0;
...
- (char)shouldBreakLineByHyphenatingBeforeCharacterAtIndex:(unsigned long long)a0;
- (char)shouldBreakLineByWordBeforeCharacterAtIndex:(unsigned long long)a0;
