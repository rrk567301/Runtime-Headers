...
@property char bidiProcessingEnabled;
...
- (void)_setForceOriginalFontBaseline:(char)a0;
- (void)_setLineBreakModeOverridden:(char)a0;
...
- (void)endParagraph;
- (char)finalizeLineFragmentRect:(inout struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 lineFragmentUsedRect:(inout struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1 baselineOffset:(inout double *)a2 forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
- (unsigned long long)getGlyphsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 glyphs:(unsigned int *)a1 characterIndexes:(unsigned long long *)a2 glyphInscriptions:(unsigned long long *)a3 elasticBits:(char *)a4 bidiLevels:(char *)a5;
...
- (void)setDrawsOutsideLineFragment:(char)a0 forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (void)setHardInvalidation:(char)a0 forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (void)setNotShownAttribute:(char)a0 forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
