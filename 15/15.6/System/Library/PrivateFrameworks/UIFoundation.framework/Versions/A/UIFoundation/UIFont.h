...
+ (id)_fontWithDescriptor:(id)a0 size:(double)a1 textStyleForScaling:(id)a2 pointSizeForScaling:(double)a3 maximumPointSizeAfterScaling:(double)a4 forIB:(char)a5 legibilityWeight:(long long)a6;
+ (char)_isSupportedDynamicFontTextStyle:(id)a0;
...
+ (double)_pointSize:(double)a0 scaledLikeTextStyle:(id)a1 maximumPointSize:(double)a2 compatibleWithTraitCollection:(id)a3 roundSize:(char)a4;
...
- (id)htmlMarkupDescriptionForWebKit:(char)a0;
...
- (id)_fontScaledLikeTextStyle:(id)a0 maximumPointSize:(double)a1 compatibleWithTraitCollection:(id)a2 forIB:(char)a3;
- (char)_isTextStyleFont;
- (double)_scaledValueForValue:(double)a0;
- (double)_scaledValueForValue:(double)a0 useLanguageAwareScaling:(char)a1;
- (id)_textStyle;
- (id)familyNameForCSSFontFamilyValueForWebKit:(char)a0;
- (id)htmlMarkupDescription;
- (id)initWithMarkupDescription:(id)a0;
- (char)isIBFontMetricsScaledFont;
- (char)isIBTextStyleFont;
- (id)markupDescription;
- (id)markupDescriptionForWebKit:(char)a0 pointSize:(float)a1 sizeUnit:(id)a2;
