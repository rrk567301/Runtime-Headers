@class NSFont, NSString, _NSLineBreakerNodePool, NSMutableSet, _NSLineMetrics, NSAttributedString, NSParagraphStyle;

@interface _NSOptimalLineBreaker : NSObject {
    char _lineBreaksValid;
    char _wrappingValid;
    char _linesValid;
    double _tolerance;
...
@property (nonatomic) char usesHangingPunctuation;
@property (nonatomic) char usesStretchClasses;
@property (nonatomic) char avoidsRivers;
@property (nonatomic) char compressesLeftAlignedText;
@property (nonatomic) char expandsGlyphs;
...
@property (nonatomic) char breaksWithinCJWords;
@property (nonatomic) char usesCFStringTokenizerForLineBreaks;
@property (nonatomic) char hyphenatesBetweenMorphemesFreely;
@property (nonatomic) char hyphenatesAsLastResort;
