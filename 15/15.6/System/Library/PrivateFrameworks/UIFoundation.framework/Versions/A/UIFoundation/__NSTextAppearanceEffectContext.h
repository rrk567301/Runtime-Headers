@class NSString, CUIStyleEffectConfiguration, CUICatalog, NSFont, NSColor;
...
- (id)initWithTextEffectName:(id)a0 catalog:(id)a1 styleEffectConfiguration:(id)a2 font:(id)a3 color:(id)a4 applicationFrameworkContext:(long long)a5 useSimplifiedEffect:(char)a6;
