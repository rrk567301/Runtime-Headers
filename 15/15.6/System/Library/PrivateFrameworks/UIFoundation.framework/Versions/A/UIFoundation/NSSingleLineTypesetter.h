...
- (id)createRenderingContextForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 typesetterBehavior:(long long)a1 usesScreenFonts:(char)a2 hasStrongRight:(char)a3 maximumWidth:(double)a4;
- (id)createRenderingContextForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 typesetterBehavior:(long long)a1 usesScreenFonts:(char)a2 hasStrongRight:(char)a3 syncDirection:(char)a4 mirrorsTextAlignment:(char)a5 maximumWidth:(double)a6;
