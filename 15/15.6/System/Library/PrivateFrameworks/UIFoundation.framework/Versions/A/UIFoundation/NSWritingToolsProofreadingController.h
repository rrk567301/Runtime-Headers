...
@property char acceptOpenSuggestionsInFinish;
...
- (void)finish:(char)a0 completion:(id /* block */)a1;
...
- (char)replaceCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 attributedString:(id)a1 state:(long long)a2 identifier:(id)a3 completion:(id /* block */)a4;
