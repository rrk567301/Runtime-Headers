...
- (char)loadResourceWithRequest:(id)a0 reason:(long long)a1;
- (void)addResource:(id)a0 forCacheKey:(id)a1;
- (id)cachedResourcesForCacheKey:(id)a0;
- (char)canGoFromOldLoadReason:(long long)a0 toNewLoadReason:(long long)a1;
...
- (char)isIdleForReason:(long long)a0;
- (char)isIdleForReasons:(id)a0;
...
- (void)updateLoadReason:(long long)a0 forOperation:(id)a1 requestKey:(id)a2 onlyIfHigherPriority:(char)a3;
