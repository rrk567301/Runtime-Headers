...
@property (nonatomic, readonly) char isUnderThirteen;
@property (nonatomic, readonly) NSNumber *userAgeIfAvailable;
@property (nonatomic, readonly) char isFitnessAppInstallationAllowed;
@property (nonatomic, readonly) char isOnDevicePersonalizationEnabled;
