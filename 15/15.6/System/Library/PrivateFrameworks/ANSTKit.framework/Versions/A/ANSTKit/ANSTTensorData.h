...
- (char)performDataAccessWithOptions:(unsigned long long)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
- (char)performMutableDataAccessWithOptions:(unsigned long long)a0 usingBlock:(id /* block */)a1 error:(id *)a2;
