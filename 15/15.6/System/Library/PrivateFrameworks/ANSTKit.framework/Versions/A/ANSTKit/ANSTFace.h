...
@property (readonly, nonatomic) char poseEstimateExists;
@property (readonly, nonatomic) char skinToneEstimateExists;
@property (readonly, nonatomic) char smileEstimateExists;
@property (readonly, nonatomic) char eyeBlinkEstimateExists;
@property (readonly, nonatomic) char eyeRectEstimateExists;
@property (readonly, nonatomic, getter=isFrontal) char frontal;
