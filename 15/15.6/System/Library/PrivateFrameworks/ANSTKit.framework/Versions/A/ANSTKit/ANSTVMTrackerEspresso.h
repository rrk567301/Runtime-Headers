...
- (char)runUpdateModel:(struct __CVBuffer { } *)a0;
- (id)_expectedMaskNetworkFileName;
- (id)_expectedMemoryNetworkFileName;
- (id)_expectedUpdateNetworkFileName;
- (id)_maskNetworkName;
- (id)_memoryNetworkName;
- (char)_setInitialMaskWithValue:(float)a0;
- (id)_updateNetworkName;
- (char)initNetwork;
- (char)runInferenceModel:(struct __CVBuffer { } *)a0;
- (char)runInitializerModel:(struct __CVBuffer { } *)a0;
