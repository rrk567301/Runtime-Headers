...
@property (readonly) char hasSeenWSUpdate;
...
- (void)_logNumSlowWSUpdates:(char)a0;
...
- (void)logIntervalData:(char)a0;
- (void)markIntervalTransition:(id)a0 transitionType:(int)a1 atCGSTimestampInSec:(double)a2 withContext:(id)a3 isWSIntervalTransition:(char)a4;
- (char)markOperationEndTruncatedByDuration:(double)a0;
- (void)markOperationStart;
- (void)markSlowFrameFrame:(struct __CFBoolean { } *)a0 withIntervalRange:(id)a1;
- (double)operationDurationInMs;
- (id)operationKey;
- (char)setContextProcessingConfiguration:(id)a0 forIntervalType:(id)a1;
