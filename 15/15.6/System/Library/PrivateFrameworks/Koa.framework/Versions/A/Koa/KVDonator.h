...
+ (char)_isXPCDonationEnabledForItemType:(long long)a0;
+ (id)donatorWithItemType:(long long)a0 originAppId:(id)a1 deviceId:(id)a2 userId:(id)a3 error:(id *)a4;
+ (id)donatorWithServiceProvider:(id)a0 isExternalClient:(char)a1 cascadeItemType:(unsigned short)a2 originAppId:(id)a3 userId:(id)a4 error:(id *)a5;
...
- (id)initWithCascadeItemType:(unsigned short)a0 originAppId:(id)a1 userId:(id)a2 serviceProvider:(id)a3 isExternalClient:(char)a4;
