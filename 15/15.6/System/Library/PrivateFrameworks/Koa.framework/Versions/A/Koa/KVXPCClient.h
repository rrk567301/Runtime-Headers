...
- (id)_remoteObjectProxy:(char)a0 errorCompletion:(id /* block */)a1;
- (void)serviceRequest:(char)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
- (void)serviceVersionRespondingRequest:(char)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
...
- (void)serviceOptionsRespondingRequest:(char)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
