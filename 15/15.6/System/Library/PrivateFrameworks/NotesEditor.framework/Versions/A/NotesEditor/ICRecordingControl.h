...
@property (nonatomic) char didBuildSublayers;
...
- (char)_hasOuterRingLayer;
- (struct CGPath { } *)_interactionPath;
- (char)_isInsideForLocation:(struct CGPoint { double x0; double x1; })a0;
...
- (struct CGPath { } *)_ringLozengePath:(char)a0;
- (struct CGPath { } *)_ringLozengePathWithHeight:(double)a0 extraWidth:(double)a1;
- (double)_ringOpacityForState:(long long)a0;
- (struct CGPath { } *)_ringPath:(char)a0;
- (struct CGPath { } *)_ringPathForState:(long long)a0;
- (struct CGPath { } *)_ringPathForState:(long long)a0 includingStrokeThickeness:(char)a1;
- (struct CGPath { } *)_squarePath;
- (void)_styleView;
- (void)_syncLongPressGestureRecognizerEnablement;
- (void)_updateVisibilityOfNamedStateLabel:(char)a0 animated:(char)a1;
- (void)_updateVisualState:(char)a0 fromState:(long long)a1;
- (void)crossfadePauseLayer:(char)a0 animated:(char)a1;
- (void)crossfadeText:(id)a0 color:(id)a1 animated:(char)a2;
- (void)fadeOutPauseAndInText:(char)a0;
...
- (void)setRecordingControlState:(long long)a0 animated:(char)a1 force:(char)a2;
