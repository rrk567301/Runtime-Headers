...
@property (readonly, nonatomic) char allowsLinks;
...
@property (readonly, nonatomic) char isAutoCompletionViewVisible;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (char)hasAcceleratorTextInTextStorage:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (char)attemptSelectionConfirmation;
...
- (void)insertLink:(id)a0 toTextView:(id)a1 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 viaAutoComplete:(char)a3;
- (void)insertLinkAttachment:(id)a0 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 viaAutoComplete:(char)a2;
- (void)performArrowDown;
- (void)performArrowUp;
- (void)performEscapeKey;
- (void)updateAutoCompletionView:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 textView:(id)a2 requiredWidth:(double)a3 isShowingNewNoteRow:(char)a4 hasNotesSectionHeader:(char)a5 acceleratorString:(id)a6 writingDirection:(long long)a7;
