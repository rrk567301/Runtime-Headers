...
@property (readonly, nonatomic) char isTableRightToLeft;
...
- (void)moveCurrentColumnOrRow:(char)a0 toIndex:(unsigned long long)a1;
- (void)addColumnAfter;
- (void)addRowAbove;
- (void)addRowBelow;
...
- (char)cellIsEditingAtColumnID:(id)a0 rowID:(id)a1;
...
- (char)isHeaderCellAtColumnID:(id)a0 rowID:(id)a1;
