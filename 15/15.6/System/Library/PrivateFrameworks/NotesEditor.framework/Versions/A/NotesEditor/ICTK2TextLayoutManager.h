...
- (id)tableViewControllerForAttachment:(id)a0 createIfNeeded:(char)a1;
...
- (id)viewProviderForTextAttachment:(id)a0 parentView:(id)a1 location:(id)a2 ignoreCache:(char)a3;
