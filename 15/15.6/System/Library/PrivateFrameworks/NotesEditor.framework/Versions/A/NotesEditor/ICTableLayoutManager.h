@class NSMutableDictionary, ICTableColumnWidthManager, ICSearchResultRegexMatchFinder, ICTable, NSObject, NSString;
...
- (void)setYPosition:(double)a0 forRow:(id)a1 shouldInvalidate:(char)a2;
