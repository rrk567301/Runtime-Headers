...
@property (nonatomic) char isHoveringOutlineDisclosureButton;
...
- (id)initWithNote:(id)a0 size:(struct CGSize { double x0; double x1; })a1 insideSystemPaper:(char)a2 linkDelegate:(id)a3 insideSiriSnippet:(char)a4;
