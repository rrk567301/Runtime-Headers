...
@property (readonly, nonatomic) char dfrBIUEnabled;
...
@property (nonatomic) char isSelectingTextWithMouse;
...
@property (nonatomic) char isChangingFont;
...
- (id)textView:(id)a0 selectedRanges:(id)a1 withLocation:(struct CGPoint { double x0; double x1; })a2 stillSelecting:(char)a3;
- (void)touchBarController:(id)a0 biuButtonPressedWithStyle:(unsigned long long)a1 toggleOn:(char)a2;
