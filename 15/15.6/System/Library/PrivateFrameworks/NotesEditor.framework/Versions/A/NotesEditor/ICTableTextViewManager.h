...
@property (nonatomic, getter=isUpdatingTiles) char updatingTiles;
...
- (double)addColumn:(id)a0 atEnd:(char)a1;
- (double)addRow:(id)a0 atEnd:(char)a1;
- (void)adjustOnscreenPositions;
- (char)cellContainingPoint:(struct CGPoint { double x0; double x1; })a0 columnID:(id *)a1 rowID:(id *)a2;
...
- (double)ensureChunkOfPopulatedRowsForRow:(id)a0 shouldForce:(char)a1;
...
- (id)textViewForColumn:(id)a0 createIfNeeded:(char)a1;
- (void)updateAuthorHighlights;
- (struct CGPoint { double x0; double x1; })updateTilesWithViewport:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 redrawAll:(char)a1;
