...
- (void)recursivelyUpdateLayer:(id)a0 toColor:(struct CGColor { } *)a1 ignoreIfClear:(char)a2;
- (void)setHorizontalLinePosition:(id)a0 forKey:(id)a1;
- (char)splitStroke:(id)a0 atRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
