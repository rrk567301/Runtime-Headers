...
@property (readonly, nonatomic, getter=isAuxiliaryEditor) char auxiliaryEditor;
@property (readonly, nonatomic, getter=isEditingOnSecureScreen) char editingOnSecureScreen;
@property (readonly, nonatomic, getter=isEditingOnSystemPaper) char editingOnSystemPaper;
