@class NSManagedObjectContext, ICTextAttachmentLocationCache, NSString, NSSet, NSMutableDictionary, NSDictionary, ICSelectorDelayer, ICSearchResultRegexMatchFinder;
...
@property (nonatomic) char isZooming;
@property (nonatomic) char isUpdatingForAttachmentViewTypeChange;
@property (nonatomic) char lineHeightIncludeParagraphSpacing;
@property (nonatomic) char shouldManuallyRenderSeparateSubviews;
@property (nonatomic) char shouldAdjustTodoButtonFramesForPrinting;
@property (nonatomic) char isRenderingPreviewForDragAndDrop;
@property (nonatomic) char shouldIgnoreCachedOriginUpdates;
@property (nonatomic) char isRenderingImageForPrint;
...
@property (nonatomic) char needsClearRemovedAttachments;
...
- (void)drawGlyphsForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 atPoint:(struct CGPoint { double x0; double x1; })a1 updateAttachments:(char)a2;
...
- (id)initForTemporaryProcessing:(char)a0;
...
- (id)supplementalViewForIdentifier:(id)a0 allowHiddenViews:(char)a1;
...
- (char)unhideSupplementalView:(id)a0 forIdentifier:(id)a1;
...
- (id)viewControllerForTextAttachment:(id)a0 createIfNeeded:(char)a1;
