...
@interface ICAttachmentView : ICBaseAttachmentView <NSAccessibilityImage, NSGestureRecognizerDelegate, ICAttachmentViewContentFrame, ICAttachmentViewInitializing, ICAttachmentViewOpening>

@property (readonly, nonatomic) NSString *icaxTypeDescription;
@property (readonly, nonatomic) char shouldIncludeAttachmentTitleInAXLabel;
...
@property (readonly, nonatomic) char insideSystemPaper;
@property (nonatomic) char finishedInit;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
- (char)alertAboutUnsupportedAttachmentIfNecessary;
...
- (void)macPresentReportAConcernFor:(id)a0 withPositiveFeedback:(char)a1 withVC:(id)a2;
- (void)openAttachment;
...
- (char)shouldOpenAttachmentOnDoubleClick;
- (char)shouldSelectOnClick;
