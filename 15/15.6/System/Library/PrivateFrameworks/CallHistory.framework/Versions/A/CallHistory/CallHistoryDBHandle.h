...
- (id)fetchWithPredicate:(id)a0 forEntity:(id)a1 withLimit:(char)a2;
...
- (char)handleSaveForCallRecordContext:(id)a0 error:(id *)a1;
...
- (char)performSaveWithBackgroundTaskAssertion:(id)a0 error:(id *)a1;
- (void)postTimersChangedNotification;
- (char)resetAllTimers;
- (char)saveTimers:(id /* block */)a0;
- (id)timerIncoming;
- (id)timerLastReset;
- (id)timerLifetime;
- (id)timerOutgoing;
