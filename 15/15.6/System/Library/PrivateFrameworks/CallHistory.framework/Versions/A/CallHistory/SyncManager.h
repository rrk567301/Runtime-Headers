...
- (void)deleteObjectsWithUniqueIds:(id)a0 withTransaction:(char)a1;
...
- (void)insert:(id)a0 withTransaction:(char)a1;
...
- (long long)setRead:(char)a0 forCallsWithPredicate:(id)a1 error:(id *)a2;
- (double)timerIncoming;
- (double)timerLifetime;
- (double)timerOutgoing;
- (void)updateAllObjects:(id)a0;
- (void)updateObjectsWithCalls:(id)a0 withTransactions:(char)a1;
