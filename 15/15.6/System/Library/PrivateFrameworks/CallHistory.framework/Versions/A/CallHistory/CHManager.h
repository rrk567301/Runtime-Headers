...
@property (nonatomic) char generateSyncTransactions;
...
+ (unsigned int)CHCallStatusForCallWithDuration:(double)a0 isOriginated:(char)a1 isAnswered:(char)a2;
...
- (void)setRead:(char)a0 forCallsWithPredicate:(id)a1 completion:(id /* block */)a2;
...
- (long long)setRead:(char)a0 forCallsWithPredicate:(id)a1;
