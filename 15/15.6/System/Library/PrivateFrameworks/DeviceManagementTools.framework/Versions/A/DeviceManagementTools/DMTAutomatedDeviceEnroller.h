...
@property (nonatomic, getter=isFinalized) char finalized;
...
- (void)activateDevice;
- (void)activationCompleteWithSuccess:(char)a0 error:(id)a1;
- (void)activationStatusFetchComplete:(char)a0 error:(id)a1;
- (void)beginAutomatedDeviceEnrollment;
- (void)checkActivationStatus;
- (void)checkIfAlreadyEnrolled;
- (void)didDisassociateFromNetworkWithSuccess:(char)a0 error:(id)a1;
- (void)didJoinNetworkWithSuccess:(char)a0 error:(id)a1;
...
- (void)setNetworkCredential:(id)a0 networkPayload:(id)a1 enrollmentNonce:(id)a2 postEnrollmentBehavior:(long long)a3 organizationName:(id)a4 organizationType:(long long)a5 mdmServerName:(id)a6 networkConfiguration:(long long)a7;
