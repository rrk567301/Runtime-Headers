...
@property (readonly, nonatomic) char isScanning;
@property (nonatomic, getter=isJoining) char joining;
...
@property (readonly, nonatomic) char wifiInterfacesAvailable;
...
- (char)scanForWiFiNetworksOperation:(id)a0 didFindNetworks:(id)a1;
