...
@property (nonatomic) char shouldTransitionToEnrollment;
...
@property (nonatomic) char isForwardNavigateItemHidden;
@property (nonatomic) char isBackwardNavigateItemHidden;
@property (nonatomic) char isLinkNavigateItemHidden;
...
@property (getter=isObservingBroadcaster) char observingBroadcaster;
