...
- (void)dismissBasicLoginUIWithCompletion:(void (^)(char, NSError *))a0;
- (void)dismissKeepUsingUIWithCompletion:(void (^)(char, NSError *))a0;
- (void)dismissNativeRecoveryUIWithCompletion:(void (^)(char, NSError *))a0;
- (void)dismissSecondFactorUIWithCompletion:(void (^)(char, NSError *))a0;
- (void)dismissServerProvidedUIWithCompletion:(void (^)(char, NSError *))a0;
...
- (void)presentKeepUsingUIForAppleID:(NSString *)a0 completion:(void (^)(char, NSError *))a1;
