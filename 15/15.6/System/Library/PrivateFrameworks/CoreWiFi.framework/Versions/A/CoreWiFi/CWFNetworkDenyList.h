...
- (char)_evaluateTriggersForDenyListRemove:(id)a0 denyListRemoveReason:(unsigned long long)a1 SSID:(id)a2;
- (char)_evaluateTriggersForDenyListing:(id)a0 reason:(unsigned long long)a1 reasonData:(long long)a2 BSSID:(id)a3 SSID:(id)a4 state:(unsigned long long)a5;
- (id)_findNetworkDenyListItem:(id)a0;
- (id)_findNetworkDenyListItemsForSSID:(id)a0;
- (char)_ignoreTriggersForDeviceProfile:(unsigned long long)a0 denyListItem:(id)a1;
- (char)_meetsThresholds:(unsigned long long)a0 count:(unsigned int)a1 forSSIDThresholds:(char)a2 BSSID:(id)a3 SSID:(id)a4;
- (void)_printDenyList;
...
- (long long)denyListThresholdForReason:(unsigned long long)a0 forSSIDThresholds:(char)a1;
...
- (char)isNetworkDenyListedForAutoJoinDueToTrigDisc:(id)a0 RSSI:(long long *)a1 timestamp:(double *)a2;
- (char)isNetworkInDenyListedState:(unsigned long long)a0 scanResult:(id)a1;
- (char)isNetworkTemporarilyDenyListedForAutoJoin:(id)a0;
...
- (void)setDenyListingThresholds:(unsigned long long)a0 value:(unsigned int)a1 forSSIDThresholds:(char)a2;
