...
- (void)__addJoinStatusWithScanResult:(id)a0 knownNetworkProfile:(id)a1 isAutoJoin:(char)a2 interfaceName:(id)a3;
- (void)__addKnownNetwork:(id)a0 XPCConnection:(id)a1;
- (char)__allowXPCRequestWithoutAvailableInterface:(id)a0;
- (id)__apple80211WithInterfaceName:(id)a0;
- (id)__apple80211WithVirtualInterfaceRole:(int)a0 parentInterfaceName:(id)a1;
- (void)__autoJoinEndedWithResult:(char)a0 interfaceName:(id)a1;
...
- (id)__currentScanResultWithInterfaceName:(id)a0 forceNoCache:(char)a1;
- (void)__currentScanResultWithInterfaceName:(id)a0 forceNoCache:(char)a1 reply:(id /* block */)a2;
- (int)__defaultInterfaceRoleForRequestType:(long long)a0;
- (id)__deviceUUID;
- (char)__didFindMatching80211InterfaceForXPCRequest:(id)a0;
...
- (void)__updateMonitoring:(char)a0 eventIDs:(id)a1;
...
- (char)isNon80211InterfaceName:(id)a0;
