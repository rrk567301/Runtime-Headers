...
@property (readonly) char isCodesignedByApple;
...
- (id)__addXPCRequestWithType:(long long)a0 info:(id)a1 requestParams:(id)a2 parentRequestUUID:(id)a3 isParentRequest:(char)a4 reply:(id /* block */)a5;
- (void)__addXPCRequestWithType:(long long)a0 info:(id)a1 requestParams:(id)a2 reply:(id /* block */)a3;
- (char)__allowAlreadyPendingRequest:(id)a0;
- (char)__allowXPCRequestWithType:(long long)a0 error:(id *)a1;
...
- (char)__hasPendingRequestWithType:(long long)a0;
- (char)__isUserPrivacySensitiveRequestType:(long long)a0;
...
- (id)__privacyFilteredScanResult:(id)a0 allowSSID:(char)a1 allowBSSID:(char)a2 allowCountryCode:(char)a3;
- (char)__shouldCoalesceEventTypeWhileSuspended:(long long)a0;
- (char)__shouldDropEventTypeWhileSuspended:(long long)a0;
...
- (void)reportQuickProbeResult:(char)a0 networkProfile:(id)a1 requestParams:(id)a2 reply:(id /* block */)a3;
...
- (void)setPower:(char)a0 requestParams:(id)a1 reply:(id /* block */)a2;
...
- (void)setPrivateMACAddressUserJoinFailureUIState:(char)a0 networkProfile:(id)a1 requestParams:(id)a2 reply:(id /* block */)a3;
- (void)setProcessState:(id)a0;
- (void)setRangeable:(char)a0 peerList:(id)a1 requestParams:(id)a2 reply:(id /* block */)a3;
...
- (void)setUserAutoJoinState:(char)a0 requestParams:(id)a1 reply:(id /* block */)a2;
