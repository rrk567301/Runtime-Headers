...
@property (nonatomic) char interestSet;
...
@property (nonatomic) char periodicCheckEnabled;
...
- (void)lockAndHandOffCanBlock:(char)a0;
- (id)lockAutoAssetWithReason:(id)a0 isBlocking:(char)a1;
