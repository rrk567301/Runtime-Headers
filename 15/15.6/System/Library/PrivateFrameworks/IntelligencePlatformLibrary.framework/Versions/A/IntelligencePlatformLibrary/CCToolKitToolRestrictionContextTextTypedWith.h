...
@property (readonly, nonatomic) char multilineAllowed;
@property (nonatomic) char hasMultilineAllowed;
@property (readonly, nonatomic) char smartQuotesEnabled;
@property (nonatomic) char hasSmartQuotesEnabled;
@property (readonly, nonatomic) char smartDashesEnabled;
@property (nonatomic) char hasSmartDashesEnabled;
