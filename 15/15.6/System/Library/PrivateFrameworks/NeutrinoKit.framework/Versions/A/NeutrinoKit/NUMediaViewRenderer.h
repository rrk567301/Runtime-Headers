@class NUComposition, NUSurfaceRenderClient, NULivePhotoRenderClient, NUVideoRenderClient, NUAVPlayerController, NUObservatory, NSObject, NUResponse, NUPixelFormat, NSString, NUCoalescer, NUMediaView, NSArray, NSView, NUColorSpace;
...
@property (nonatomic, getter=_isVideoEnabled, setter=_setVideoEnabled:) char _videoEnabled;
@property (nonatomic) char livePhotoViewIsScrubbing;
...
@property (readonly, nonatomic, getter=isZoomedToFit) char zoomedToFit;
...
@property (readonly, nonatomic) char canUpdateDisplayHeadroom;
...
+ (char)_forceUpdateForNewVideoComposition:(id)a0 previousComposition:(id)a1 newAsset:(id)a2 previousAsset:(id)a3 isPlaying:(char)a4;
...
- (void)endPanning;
- (void)seekToTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 exact:(char)a1;
- (void)seekToTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 exact:(char)a1 forceSeek:(char)a2;
...
- (void)_coalesceBackfillRenderForComposition:(id)a0;
...
- (void)_updateCoalescedBackfillRenderWithComposition:(id)a0;
...
- (void)_updateVideoWithResult:(id)a0 sourceChanged:(char)a1;
...
- (id)renderClient;
- (void)seekToTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 toleranceBefore:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 toleranceAfter:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 forceSeek:(char)a3;
