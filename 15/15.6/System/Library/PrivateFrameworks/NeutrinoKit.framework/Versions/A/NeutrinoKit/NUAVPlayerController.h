...
@interface NUAVPlayerController : NSObject {
    ...
    struct { char registeredPlayer; } _playerControllerKVOFlags;
...
- (void)_notifyExternalPlaybackChange:(char)a0;
...
- (id)_playerItemsWithVideoAsset:(id)a0 videoComposition:(id)a1 audioMix:(id)a2 loopsVideo:(char)a3;
- (void)_removePlayerItemKVO:(id)a0;
- (void)_removePlayerItemKVO:(id)a0 removeFromArray:(char)a1;
...
- (char)prepareWithAVAsset:(id)a0 videoComposition:(id)a1 audioMix:(id)a2 loopsVideo:(char)a3 seekToTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a4;
...
- (void)seek:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 toleranceBefore:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 toleranceAfter:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 forceSeek:(char)a3;
- (void)seek:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 toleranceBefore:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 toleranceAfter:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 forceSeek:(char)a3 completionHandler:(id /* block */)a4;
- (void)seekBack;
- (void)updateAppliesPerFrameHDRDisplayMetadata:(char)a0;
