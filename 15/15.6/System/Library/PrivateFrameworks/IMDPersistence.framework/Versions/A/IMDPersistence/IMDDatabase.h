...
+ (id)_databaseServer;
+ (id)_databaseClient;
+ (id)_newSyndicationRangeForCMMMessageItem:(id)a0 syndicationIdentifier:(id)a1 shouldHideFromSyndication:(char)a2;
...
- (void)_fetchChatRecordsWithHandles:(id)a0 allowSubsetMatching:(char)a1 serviceName:(id)a2 displayName:(id)a3 groupID:(id)a4 style:(unsigned char)a5 useOriginalGroupID:(char)a6 completionHandler:(id /* block */)a7;
- (void)_fetchMessageRecordsForChatRecordWithGUID:(id)a0 filteredUsingPredicate:(id)a1 sortedUsingDescriptors:(id)a2 parentedOnly:(char)a3 limit:(unsigned long long)a4 completionHandler:(id /* block */)a5;
- (id)_loadAttributedBodyTextForMessageWithGUID:(id)a0;
- (id)_loadRecoverableMessagePartsMetadataForChatGUID:(id)a0;
- (id)_messageKeyPathsToColumnsQueryingChatJoinTable:(char)a0;
...
- (void)_updateMessageItemSyndicationRanges:(id)a0 messagePartDescriptor:(id)a1 shouldHideFromSyndication:(char)a2;
...
- (char)_updateSyndicatedMessageItem:(id)a0 newMessageItem:(id)a1 newSyndicationRange:(id)a2;
...
- (id)chatRecordsWithHandles:(id)a0 serviceName:(id)a1 displayName:(id)a2 groupID:(id)a3 style:(unsigned char)a4 useOriginalGroupID:(char)a5;
...
- (void)fetchChatRecordsFilteredUsingPredicate:(id)a0 sortedUsingLastMessageDateAscending:(char)a1 limit:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (void)fetchChatRecordsFilteredUsingPredicate:(id)a0 sortedUsingLastMessageDateAscending:(char)a1 olderThan:(id)a2 limit:(unsigned long long)a3 completionHandler:(id /* block */)a4;
...
- (void)fetchMessageRecordWithGUID:(id)a0 excludeRecoverableMessages:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)fetchMessageRecordsFilteredUsingPredicate:(id)a0 sortedUsingDescriptors:(id)a1 parentedOnly:(char)a2 limit:(unsigned long long)a3 completionHandler:(id /* block */)a4;
...
- (void)updateAttachmentSyndicationRanges:(id)a0 shouldHideFromSyndication:(char)a1;
- (void)updateAttachmentsSyncStatusTo:(long long)a0 forGUIDs:(id)a1;
- (void)updateChatsSyncStatusTo:(long long)a0 forGUIDs:(id)a1;
- (void)updateMessageSyndicationRanges:(id)a0 shouldHideFromSyndication:(char)a1;
