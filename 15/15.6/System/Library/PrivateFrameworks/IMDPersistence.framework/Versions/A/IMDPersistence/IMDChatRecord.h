...
@property (readonly, nonatomic, getter=isArchived) char archived;
@property (readonly, copy, nonatomic) NSString *lastAddressedHandle;
@property (readonly, copy, nonatomic) NSString *displayName;
@property (readonly, copy, nonatomic) NSString *groupName;
@property (readonly, copy, nonatomic) NSString *groupID;
@property (readonly, nonatomic) char successfulQuery;
...
@property (readonly, copy, nonatomic) NSString *cloudKitRecordID;
@property (readonly, copy, nonatomic) NSString *lastAddressedSIMID;
@property (readonly, nonatomic, getter=isBlackholed) char blackholed;
...
@property (readonly, nonatomic, getter=isRecovered) char recovered;
@property (readonly, nonatomic, getter=isDeletingIncomingMessages) char deletingIncomingMessages;
