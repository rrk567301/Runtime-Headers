...
@property (readonly, nonatomic) char hideAttachment;
...
@property (readonly, nonatomic, getter=isSticker) char sticker;
@property (readonly, nonatomic, getter=isAdaptiveImageGlyph) char adaptiveImageGlyph;
...
@property (readonly, nonatomic, getter=isCommSafetySensitive) char commSafetySensitive;
