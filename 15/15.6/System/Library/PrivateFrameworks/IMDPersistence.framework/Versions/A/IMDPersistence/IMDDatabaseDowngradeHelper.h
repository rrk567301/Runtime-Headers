...
- (char)readRowCountForTable:(id)a0 resultBlock:(id /* block */)a1;
- (char)revertTransaction:(id /* block */)a0;
- (char)runArrayOfQueries:(id)a0 resultBlock:(id /* block */)a1;
- (char)runSimpleQuery:(id)a0 resultBlock:(id /* block */)a1;
- (char)writeDatabaseVersion:(long long)a0 resultBlock:(id /* block */)a1;
