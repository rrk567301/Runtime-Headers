...
- (char)_isAttachmentType:(id)a0;
- (char)_isLNKTypeMessage:(id)a0;
...
- (char)_shouldDonateToSharedWithYou:(id)a0 lpLinkMetadata:(id)a1;
...
- (char)chatDictionary:(id)a0 matchesFaceTimeConversation:(id)a1;
