...
@property (readonly, nonatomic) char hasDdResults;
@property (readonly, copy, nonatomic) NSString *service;
@property (readonly, nonatomic, getter=isArchive) char archive;
...
@property (readonly, nonatomic, getter=isReply) char reply;
@property (readonly, nonatomic) long long partCount;
@property (readonly, nonatomic, getter=isAssociatedMessage) char associatedMessage;
@property (readonly, nonatomic, getter=isDelivered) char delivered;
@property (readonly, nonatomic, getter=isFinished) char finished;
@property (readonly, nonatomic, getter=isEmote) char emote;
@property (readonly, nonatomic, getter=isFromMe) char fromMe;
@property (readonly, nonatomic, getter=isEmpty) char empty;
@property (readonly, nonatomic, getter=isDelayed) char delayed;
@property (readonly, nonatomic, getter=isAutoReply) char autoReply;
@property (readonly, nonatomic, getter=isPrepared) char prepared;
@property (readonly, nonatomic, getter=isRead) char read;
@property (readonly, nonatomic, getter=isSystemMessage) char systemMessage;
@property (readonly, nonatomic, getter=isSent) char sent;
@property (readonly, nonatomic) char hasDataDetectorResults;
@property (readonly, nonatomic, getter=isServiceMessage) char serviceMessage;
@property (readonly, nonatomic, getter=isForward) char forward;
@property (readonly, nonatomic) char wasDowngraded;
@property (readonly, nonatomic, getter=isArchived) char archived;
@property (readonly, nonatomic) char cacheHasAttachments;
@property (readonly, nonatomic) char wasDataDetected;
@property (readonly, nonatomic) char wasDeduplicated;
@property (readonly, nonatomic, getter=isAudioMessage) char audioMessage;
@property (readonly, nonatomic, getter=isPlayed) char played;
@property (readonly, copy, nonatomic) NSString *destinationCallerID;
@property (readonly, nonatomic, getter=isPendingSatelliteSend) char pendingSatelliteSend;
