...
- (id)fileURLForSearchableIndex:(id)a0 itemIdentifier:(id)a1 typeIdentifier:(id)a2 inPlace:(char)a3 error:(out id *)a4;
...
- (id)fileURLForSearchableIndex:(id)a0 itemIdentifier:(id)a1 typeIdentifier:(id)a2 inPlace:(char)a3 allowDownload:(char)a4 error:(out id *)a5;
...
- (id)errorAnalyzer;
- (id)fileURLForSearchableIndex:(id)a0 itemIdentifier:(id)a1 typeIdentifier:(id)a2 allowDownload:(char)a3 error:(out id *)a4;
