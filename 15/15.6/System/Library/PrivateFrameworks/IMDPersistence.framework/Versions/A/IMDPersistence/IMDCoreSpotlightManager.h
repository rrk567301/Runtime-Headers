...
- (unsigned long long)_batchSizeForTargetBatchSize:(unsigned long long)a0 lastIndexedRowID:(unsigned long long)a1 lastBatch:(char *)a2;
...
- (void)_indexSearchableChatItems:(id)a0 withReason:(long long)a1 index:(id)a2 blocking:(char)a3;
- (void)_indexSearchableItems:(id)a0 rejectedItems:(id)a1 clientState:(id)a2 lastIndexedRowID:(unsigned long long)a3 messagesInBatch:(unsigned long long)a4 messagesWithItemsGeneratedCount:(unsigned long long)a5 batchSize:(unsigned long long)a6 lastBatch:(char)a7 withIndex:(id)a8 reason:(long long)a9;
- (id)_newSearchableChatItemsForChats:(id)a0;
- (id)_personIdentityQueue;
- (void)_postProcessIndexingForItem:(id)a0 chatDictionary:(id)a1 isReindexing:(char)a2;
- (void)_resolvedURLForItems:(id)a0;
- (void)_sanitizeIndexesForCurrentVersionIfNeeded:(id /* block */)a0;
- (id)_scrutinyMessagesQueue;
- (void)_setNeedsDeferredIndexing:(char)a0;
- (void)_setNeedsIndexing:(char)a0;
- (char)_shouldBypassForTesting;
- (char)_shouldIndexNextBatchForBatchSize:(unsigned long long)a0;
- (char)_shouldSkipMessagePartPrefixingForItemDictionary:(id)a0;
...
- (id)newSearchableItemsForMessage:(id)a0 reindexing:(char)a1 rejectedItems:(id)a2;
- (id)newSearchableItemsForMessageGUID:(id)a0 reindexing:(char)a1 rejectedItems:(id)a2;
- (id)newSearchableItemsForMessageItemDictionary:(id)a0 chatDictionary:(id)a1 reindexing:(char)a2 rejectedItems:(id)a3;
