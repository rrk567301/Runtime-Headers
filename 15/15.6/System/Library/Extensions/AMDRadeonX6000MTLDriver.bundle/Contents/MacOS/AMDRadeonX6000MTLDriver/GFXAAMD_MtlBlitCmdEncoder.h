@class NSString, __end_cap_, GFXAAMD_MtlCmdBuffer, MTLIOAccelResource, __end_;
@protocol MTLDevice;

@interface GFXAAMD_MtlBlitCmdEncoder : MTLIOAccelBlitCommandEncoder <MTLBlitCommandEncoder, AmdPrivateCommandEncoder> {
    struct AMD_BlitCmdEncoderMembersRec { GFXAAMD_MtlCmdBuffer *cmdBuffer; struct AMD_UBMInterfaceRec *ubmInterface; struct AMD_HwCmdBufInfoRec *pHwCmdBufInfo; struct AMDBitVectorRec *knownExpandedVec; struct AMD_DeviceMembersRec *deviceBaseMembers; MTLIOAccelResource *scratchBuffer; struct vector<MTLIOAccelResource *, std::allocator<MTLIOAccelResource *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<MTLIOAccelResource **, std::allocator<MTLIOAccelResource *>> { id *__value_; } x1; } tmpRsrcVec; struct AMD_ResourceBindInfoRec { MTLIOAccelResource *rsrc; unsigned int index; unsigned int usageFlags; } currentResources[10]; struct GFXAAMD_MtlStatistics *statsMgr; unsigned char inSegment : 1; unsigned char untrackedRsrcUsed : 1; unsigned char currentChannel : 3; unsigned char usedChannelsMask : 8; unsigned char counterSampling : 3; unsigned short reserved : 16; struct vector<std::pair<MTLIOAccelResource *, unsigned char>, std::allocator<std::pair<MTLIOAccelResource *, unsigned char>>> { void *__begin_; void *__end_; struct __compressed_pair<std::pair<MTLIOAccelResource *, unsigned char> *, std::allocator<std::pair<MTLIOAccelResource *, unsigned char>>> { void *__value_; } __end_cap_; } vectorMap; void *apiLayerData; unsigned long long rgpEventType; unsigned long long cmdBufGlblTraceObjID; struct __IOAccelDevice *amdMtlDeviceRef; } m_members;
}
