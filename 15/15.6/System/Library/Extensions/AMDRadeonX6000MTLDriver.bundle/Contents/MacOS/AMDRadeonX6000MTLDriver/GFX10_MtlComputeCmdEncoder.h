@class NSString, MTLIOAccelResource, GFX10_MtlCmdBuffer, GFX10_MtlComputePipelineState;
@protocol MTLDevice;

@interface GFX10_MtlComputeCmdEncoder : MTLIOAccelComputeCommandEncoder <MTLComputeCommandEncoderSPI, AmdPrivateCommandEncoder> {
    struct GFX10_ComputeCmdEncoderMembersRec { GFX10_MtlCmdBuffer *cmdBuffer; struct AMD_HwCmdBufInfoRec *cmdBufInfo; struct GFX10_RsrcMgrRec *rsrcMgr; struct AMDBitVectorRec *knownExpandedVec; GFX10_MtlComputePipelineState *computePipelineState; struct AMD_ComputePipelineStateMembersRec *computePipelineStateMembers; struct AMD_ComputeVariantMembersRec *computeVariantMembers; struct GFX10_ComputeVariantMembersRec *gfx10_computeVariantMembers; BOOL isCurrPsoUseIndirectCmdBuffer; struct AMD_ResourceBindInfoRec { MTLIOAccelResource *rsrc; unsigned int index; unsigned int usageFlags; } computeResources[180]; unsigned int dynamicThreadgroupMemoryLength[32]; struct { struct { unsigned long long x; unsigned long long y; unsigned long long z; } origin; struct { unsigned long long width; unsigned long long height; unsigned long long depth; } size; } stageInRegion; unsigned char counterSampling : 3; unsigned char icbTracing : 1; unsigned char dispatchIssued : 1; unsigned char isError : 1; unsigned int reserved : 26; struct GFX10_MtlStatistics *statsMgr; struct AMD_MtlThreadTrace *pThreadTrace; struct AMD_MtlSPMTrace *pSpmTrace; unsigned long long cmdBufGlblTraceObjID; struct __IOAccelDevice *amdMtlDeviceRef; unsigned long long dispatch_Type; MTLIOAccelResource *shaderRsrc; MTLIOAccelResource *tempBufRsrc; MTLIOAccelResource *cmdBufRsrc; unsigned long long shaderOffset; unsigned long long tempOffset; unsigned long long cmdBufOffset; void *apiLayerData; struct vector<AMDMtlCmdBufJumpElem, std::allocator<AMDMtlCmdBufJumpElem>> { struct AMDMtlCmdBufJumpElem *__begin_; struct AMDMtlCmdBufJumpElem *__end_; struct __compressed_pair<AMDMtlCmdBufJumpElem *, std::allocator<AMDMtlCmdBufJumpElem>> { struct AMDMtlCmdBufJumpElem *__value_; } __end_cap_; } scopeStack; unsigned int cntConcurrentDispatch; } m_members;
}
