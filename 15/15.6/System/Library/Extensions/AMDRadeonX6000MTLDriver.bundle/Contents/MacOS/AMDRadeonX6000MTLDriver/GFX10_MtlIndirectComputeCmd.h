...
@interface GFX10_MtlIndirectComputeCmd : NSObject <GFXAAMD_MtlIndirectCmd, MTLIndirectComputeCommandSPI> {
    struct GFX10_IndirectComputeCmdMembers { GFXAAMD_MtlIndirectCmdBuffer *icb; struct IndirectCommandBufferHeader *icbHeader; GFX10_MtlDevice *device; unsigned long long cmdBuf; unsigned long long tblBuf; unsigned int cmdIndex; } m_members;
}
