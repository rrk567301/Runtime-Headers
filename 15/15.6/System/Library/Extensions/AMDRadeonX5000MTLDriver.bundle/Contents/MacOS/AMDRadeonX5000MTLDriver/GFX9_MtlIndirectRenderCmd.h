...
@interface GFX9_MtlIndirectRenderCmd : MTLIOAccelIndirectRenderCommand <GFX9AMD_MtlIndirectCmd, MTLIndirectRenderCommandSPI> {
    struct GFX9_IndirectRenderCmdMembers { GFX9AMD_MtlIndirectCmdBuffer *icb; struct IndirectCommandBufferHeader *icbHeader; GFX9_MtlDevice *device; unsigned long long cmdBuf; unsigned int cmdIndex; } m_members;
}
