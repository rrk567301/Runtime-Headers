@class NSString, GFX9AMD_MtlIndirectCmdBuffer, GFX9_MtlDevice;

@interface GFX9_MtlIndirectComputeCmd : NSObject <GFX9AMD_MtlIndirectCmd, MTLIndirectComputeCommandSPI> {
    struct GFX9_IndirectComputeCmdMembers { GFX9AMD_MtlIndirectCmdBuffer *icb; struct IndirectCommandBufferHeader *icbHeader; GFX9_MtlDevice *device; unsigned long long cmdBuf; unsigned long long tblBuf; unsigned int cmdIndex; } m_members;
}
