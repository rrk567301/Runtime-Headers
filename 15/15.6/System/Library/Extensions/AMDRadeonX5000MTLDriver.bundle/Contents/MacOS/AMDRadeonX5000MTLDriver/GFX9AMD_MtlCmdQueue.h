...
@interface GFX9AMD_MtlCmdQueue : MTLIOAccelCommandQueue <MTLCommandQueueSPI> {
    struct AMD_CmdQueueMembersRec { struct GFX9AMD_MtlStatistics *statsMgr; NSArray *requestedCounters; void *apiLayerData; } m_members;
}
