@class _MTLIndirectArgumentBufferLayout, NSString, GFX9AMD_MtlBuffer;
@protocol MTLDevice;

@interface GFX9AMD_MtlIndirectArgumentBufferEncoder : MTLIOAccelIndirectArgumentEncoder <MTLIndirectArgumentEncoderSPI> {
    struct AMD_MtlIndirectArgumentBufferEncoderMembers { GFX9AMD_MtlBuffer *IABBuffer; unsigned long long IABoffset; struct AMD_IndirectArgumentBufferLayoutMembers *layout; unsigned long long encodedLength; unsigned char usingHardwareRT : 1; unsigned int unused : 31; } _amd;
}
