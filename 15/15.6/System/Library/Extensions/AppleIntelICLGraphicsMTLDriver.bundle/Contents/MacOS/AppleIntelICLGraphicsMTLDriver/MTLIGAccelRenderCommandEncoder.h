...
- (id)initWithCommandBuffer:(id)a0 descriptor:(id)a1 stateDescriptor:(struct IGContextStateDescriptor { struct IntelStateHeaps *x0; struct IntelState *x1; struct ChalContext *x2; union IGContextStateDescriptorFlags { unsigned int x0; struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 3; } x1; } x3; } *)a2;
