@class NSString, MTLIGAccelBuffer;
@protocol MTLHeap, MTLBuffer, MTLDevice;

@interface MTLIGAccelVisibleFunctionTable : MTLIOAccelVisibleFunctionTable <MTLVisibleFunctionTableSPI> {
    struct Header { unsigned long long x0[31]; unsigned int x1; unsigned int x2; } *functionTableHeader;
    MTLIGAccelBuffer *functionTableObject;
    unsigned long long *functionTableMemory;
    unsigned int functionCount;
    MTLIGAccelBuffer *functionTableGlobalBuffer;
    unsigned long long functionTableGlobalBufferOffset;
}

@property (readonly) MTLIGAccelBuffer *buffer;
@property (readonly) unsigned long long bufferOffset;
@property (readonly) unsigned long long indirectionIndex;
