...
@interface BronzeMtlTexture : MTLIOAccelTexture <MTLTextureImplementation> {
    struct BronzeTextureMembersRec { struct ATIMipmapBufferHeader *mipHeaders; unsigned char atiFormat : 8; unsigned char numLevels : 5; unsigned char samplesLog2 : 3; unsigned char hasStencilMipHeaders : 1; unsigned char sRGB : 1; unsigned char isTexView : 1; unsigned char canDeferExpand : 1; unsigned char expandOnTexBind : 1; unsigned char stencilMipHeaderIdx : 5; unsigned char shaderRead : 1; unsigned char shaderWrite : 1; unsigned char renderTarget : 1; unsigned char pixelFormatView : 1; unsigned char is24to32f : 1; unsigned char canDeferSync : 1; unsigned char isCube : 1; unsigned char isCubeArray : 1; unsigned char stencilOnlySupport : 1; unsigned char isRsrcIndexReserved : 1; unsigned char isShared : 1; unsigned int reserved : 27; unsigned short viewBaseSlice; unsigned short viewLastSlice; unsigned short viewBaseLevel; unsigned short viewLastLevel; unsigned short numBaseLevels; unsigned short numBaseSlices; unsigned short baseSwizzle; unsigned short renderTargetId; struct BronzeCompressionMgrRec *mgr; void *apiLayerData; struct BronzeTextureHTileInfoRec *hTileInfo; struct BronzeTextureDccInfoRec *dccInfo; struct BronzeTextureCMaskInfoRec *cMaskInfo; struct BronzeTextureFMaskInfoRec *fMaskInfo; unsigned long long rsrcIndex; } m_members;
}
...
- (id)initTiledWithBuffer:(id)a0 descriptor:(id)a1 offset:(unsigned int)a2 rowBytes:(unsigned int)a3;
- (id)initWithBuffer:(id)a0 descriptor:(id)a1 offset:(unsigned int)a2 rowBytes:(unsigned int)a3;
