...
@interface BronzeMtlIndirectRenderCmd : MTLIOAccelIndirectRenderCommand <MTLIndirectRenderCommandSPI> {
    struct BronzeMtlIndirectRenderCmdMembers { BronzeMtlBuffer *icb; struct IndirectCommandBufferHeader *icbHeader; BronzeMtlDevice *device; unsigned long long cmdBuf; unsigned long long tblBuf; unsigned int cmdIndex; } m_members;
}
