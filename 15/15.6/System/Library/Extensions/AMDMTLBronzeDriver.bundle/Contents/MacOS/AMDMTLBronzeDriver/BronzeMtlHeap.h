...
@interface BronzeMtlHeap : MTLIOAccelHeap <MTLHeapSPI> {
    struct BronzeHeapMembersRec { unsigned int baseAlign; unsigned short renderTargetId; union { unsigned int bits; struct { unsigned char placementHeap : 1; unsigned char rtidValid : 1; unsigned int reserved : 30; } ; } flags; } m_members;
}
