...
@interface BronzeMtlBuffer : MTLIOAccelBuffer <MTLBuffer> {
    struct BronzeBufferMembersRec { BronzeMtlDevice *device; void *apiLayerData; } m_members;
}
...
- (id)initWithMasterBuffer:(id)a0 heapIndex:(short)a1 bufferIndex:(short)a2 bufferOffset:(int)a3 length:(unsigned long long)a4;
