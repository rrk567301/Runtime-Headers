...
+ (char)isBadCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 forCGImageRef:(struct CGImage { } *)a1;
+ (char)isCGFloatValueApproximateZero:(double)a0;
