...
- (void)editorDidFinish:(id)a0 withLikenessResult:(id)a1 cancelled:(char)a2;
- (void)editorDidFinish:(id)a0 withLikenessResult:(id)a1 memojiMetadata:(id)a2 cancelled:(char)a3;
