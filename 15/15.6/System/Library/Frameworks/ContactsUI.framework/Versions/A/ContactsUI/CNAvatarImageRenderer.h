...
- (id)renderAvatarsForContacts:(id)a0 scope:(id)a1 includePlaceholder:(char)a2 imageHandler:(id /* block */)a3;
...
- (id)renderAvatarsForContacts:(id)a0 scope:(id)a1 includePlaceholder:(char)a2 workScheduler:(id)a3 imageHandler:(id /* block */)a4;
...
- (id)renderedLikenessesForContacts:(id)a0 scope:(id)a1 placeholder:(char)a2 workScheduler:(id)a3;
