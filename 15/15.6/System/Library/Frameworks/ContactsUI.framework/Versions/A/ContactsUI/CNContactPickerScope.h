...
@property (readonly) char shouldShowSelectedContact;

- (void).cxx_destruct;
- (id)initWithInternalResponseDelegate:(id)a0 contactListController:(id)a1 searchController:(id)a2 contactCardViewController:(id)a3 pickerView:(id)a4 shouldShowSelectedContact:(char)a5;
