...
- (void)configurePickerWith:(id)a0 cropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 memojiMetadataData:(id)a2 initialMonogramText:(id)a3 showsAsCompany:(char)a4 canSaveInitialImage:(char)a5 likenessType:(long long)a6;
- (void)setAllowEditingMemojiAndMonogramOnly:(char)a0;
- (void)setIsRunningInBuddy:(char)a0;
