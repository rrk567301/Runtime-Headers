...
+ (id)addToWhitelistOptionsMenuWithTarget:(id)a0 addFromFamilyMemberContactsAction:(SEL)a1 addFromLocalContactsItemAction:(SEL)a2 newContactItemAction:(SEL)a3 familyMember:(id)a4 addFromFamilyMemberContactsEnabled:(char)a5;
