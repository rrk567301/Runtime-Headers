...
@property char ignoreOutlineViewSelectionChangeNotifications;
...
- (void)configureSourceDisplayViewConstraintsIsBuddy:(char)a0;
...
- (char)itemHasChildren:(id)a0;
- (id)mediaLibraryViewController;
- (void)setBuddyControlsHidden:(char)a0;
- (void)setDimensionsForSidebarVisiblity:(char)a0;
- (void)setExistingUserImage:(id)a0 withKeepAction:(id /* block */)a1;
- (void)setSidebarHidden:(char)a0;
...
- (void)zoomSliderShouldShow:(char)a0;
