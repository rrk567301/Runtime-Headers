...
@property (readonly, nonatomic, getter=shouldShowSelectedContact) char showSelectedContact;
@property (readonly, nonatomic, getter=shouldHighlightSelectedContact) char highlightSelectedContact;
@property (readonly, nonatomic, getter=shouldAllowMultipleSelection) char allowMultipleSelection;
...
@property (nonatomic, getter=isEditingSelectedContact) char editingSelectedContact;
...
- (id)initWithShowSelectedContact:(char)a0 highlightSelectedContact:(char)a1;
...
- (void)setAllowsNamePicking:(char)a0;
