...
@property char isFullAvatar;
@property char overrideIsMe;
...
@property char shouldInvalidateCache;
@property char alwaysAcceptDrop;
...
+ (id)_fallbackMonogramStringForContact:(id)a0 fallbackToDefaultString:(char)a1;
+ (id)_monogramStringForContact:(id)a0;
+ (id)_monogramStringWithFallbackForContact:(id)a0 fallbackToDefaultString:(char)a1;
+ (id)_popoverAnimationControllerWithContents:(id)a0 anchorView:(id)a1 vibrant:(char)a2;
+ (id)_quicklookURLForContact:(id)a0;
+ (char)canCreateMonogramForContact:(id)a0;
...
- (void)editorDidFinish:(id)a0 withLikenessResult:(id)a1 memojiMetadata:(id)a2 userSetupMemojiRecords:(id)a3 cancelled:(char)a4;
