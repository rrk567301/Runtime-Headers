...
- (void)configureInitialDisplayForLikeness:(id)a0 monogramText:(id)a1 isMe:(char)a2 imageSource:(long long)a3;
- (void)configureInitialDisplayForLikeness:(id)a0 monogramText:(id)a1 showsAsCompany:(char)a2 isMe:(char)a3 imageSource:(long long)a4;
