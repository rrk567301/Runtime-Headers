...
- (void)imageForSubCollection:(id)a0 atIndex:(long long)a1 size:(struct CGSize { double x0; double x1; })a2 useMaxSize:(char)a3 resultHandler:(id /* block */)a4 progressHandler:(id /* block */)a5;
- (void)imageForType:(long long)a0 atIndex:(long long)a1 size:(struct CGSize { double x0; double x1; })a2 resultHandler:(id /* block */)a3;
- (void)imageForType:(long long)a0 atIndex:(long long)a1 size:(struct CGSize { double x0; double x1; })a2 useMaxSize:(char)a3 resultHandler:(id /* block */)a4 progressHandler:(id /* block */)a5;
- (void)requestImageForAsset:(id)a0 targetSize:(struct CGSize { double x0; double x1; })a1 useMaxSize:(char)a2 resultHandler:(id /* block */)a3 progressHandler:(id /* block */)a4;
