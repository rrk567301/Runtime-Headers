...
+ (char)isPregnancyDurationPhysiologicallyPossibleForPregnancyStartDate:(id)a0;
+ (char)isPregnancyDurationPhysiologicallyPossibleForPregnancyStartDate:(id)a0 pregnancyEndDate:(id)a1;
