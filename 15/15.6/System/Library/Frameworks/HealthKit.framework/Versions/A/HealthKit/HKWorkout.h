@class HKQuantity, NSArray, NSDictionary, NSString, HKWorkoutActivity;
...
@property (nonatomic, getter=_isWatchWorkout, setter=_setIsWatchWorkout:) char isWatchWorkout;
...
+ (char)_validateObjects:(id)a0 forClass:(Class)a1 error:(out id *)a2;
+ (char)_workoutWithActivityType:(unsigned long long)a0 acceptsSubActivityType:(unsigned long long)a1;
...
- (id)_validateWorkoutActivities:(id)a0 withConfiguration:(struct HKObjectValidationConfiguration { unsigned long long x0; unsigned long long x1; })a1;
- (id)_validateWorkoutEvents:(id)a0 withConfiguration:(struct HKObjectValidationConfiguration { unsigned long long x0; unsigned long long x1; })a1;
- (char)acceptsAssociationWithObject:(id)a0;
- (id)statisticsForType:(id)a0;
- (id)subObjectFromUUID:(id)a0;
