...
- (char)_validateInputWithObject:(id)a0 contentType:(id)a1 URL:(id)a2 error:(id *)a3;
...
- (void)clientRemote_streamDataForAttachment:(id)a0 dataChunk:(id)a1 error:(id)a2 done:(char)a3;
