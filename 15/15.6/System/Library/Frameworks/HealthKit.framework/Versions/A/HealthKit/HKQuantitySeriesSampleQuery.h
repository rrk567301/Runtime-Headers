...
@interface HKQuantitySeriesSampleQuery : HKQuery <HKQuantitySeriesSampleQueryClientInterface> {
    ...
    char _hasMaximumReceivedStartTime;
...
@property (nonatomic) char includeSample;
@property (nonatomic) char orderByQuantitySampleStartDate;
...
- (void)client_deliverEnumerationResults:(id)a0 isFinal:(char)a1 query:(id)a2;
- (void)client_deliverQuantitySeries:(id)a0 seriesAnchor:(long long)a1 isFinal:(char)a2 query:(id)a3;
