...
- (id)remoteInterface;
- (char)_changeStateForFinishWithError:(out id *)a0;
- (id)_queue_clientErrorForFatalError;
- (char)_changeStateForInsertWithError:(out id *)a0;
- (void)unitTest_discardWithCompletion:(id /* block */)a0;
- (char)_changeStateForDiscardWithError:(out id *)a0;
...
- (char)_insertQuantity:(id)a0 dateInterval:(id)a1 error:(id *)a2;
...
- (char)_validateDateInterval:(id)a0 error:(out id *)a1;
- (char)_validateQuantity:(id)a0 error:(out id *)a1;
...
- (char)insertQuantity:(id)a0 date:(id)a1 error:(id *)a2;
- (char)insertQuantity:(id)a0 dateInterval:(id)a1 error:(id *)a2;
