...
@property (nonatomic) char hasDisplayStrings;
...
- (id)initWithIdentifier:(id)a0 name:(id)a1 OID:(id)a2 type:(unsigned long long)a3 synonyms:(id)a4 hasDisplayStrings:(char)a5;
