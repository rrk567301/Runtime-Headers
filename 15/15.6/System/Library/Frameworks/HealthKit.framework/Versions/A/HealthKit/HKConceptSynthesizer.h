...
+ (id)_popValueForString:(id)a0 startingFromSubstring:(id)a1 untilSubstring:(id)a2 outRemainderString:(id *)a3 outEndOfString:(char *)a4 error:(id *)a5;
+ (id)_substringsInBetweenSequentialDelimiters:(id)a0 poppableString:(id)a1 outReachedEndOfString:(char *)a2 outStringRemainder:(id *)a3 error:(id *)a4;
