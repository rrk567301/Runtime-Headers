...
- (id)initWithUUID:(id)a0 primaryContactIdentifier:(id)a1 allContactIdentifiers:(id)a2 firstName:(id)a3 lastName:(id)a4 userWheelchairMode:(long long)a5 type:(long long)a6 status:(long long)a7 notificationStatus:(long long)a8 direction:(unsigned long long)a9 modificationDate:(id)a10 dateAccepted:(id)a11 dateInvited:(id)a12 profileIdentifier:(id)a13 CNContactIdentifier:(id)a14 isPaused:(char)a15;
