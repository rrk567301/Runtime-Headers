...
@property (readonly) char notPerformed;
...
+ (id)_newProcedureRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 sortDate:(id)a9 country:(id)a10 state:(unsigned long long)a11 procedureCodingCollection:(id)a12 performers:(id)a13 executionStartDate:(id)a14 executionEndDate:(id)a15 notPerformed:(char)a16 statusCoding:(id)a17 categoryCodingCollection:(id)a18 reasonCodingCollections:(id)a19 reasonsNotPerformedCodingCollections:(id)a20 outcomeCodingCollection:(id)a21 complicationsCodingCollections:(id)a22 followUpsCodingCollections:(id)a23 bodySitesCodingCollections:(id)a24 config:(id /* block */)a25;
+ (id)cachedConceptRelationshipKeyPaths;
+ (id)defaultDisplayString;
+ (char)groupsByUserDomainConcept;
+ (id)indexableConceptKeyPaths;
+ (id)procedureRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 country:(id)a9 state:(unsigned long long)a10 procedureCodingCollection:(id)a11 performers:(id)a12 executionStartDate:(id)a13 executionEndDate:(id)a14 notPerformed:(char)a15 statusCoding:(id)a16 categoryCodingCollection:(id)a17 reasonCodingCollections:(id)a18 reasonsNotPerformedCodingCollections:(id)a19 outcomeCodingCollection:(id)a20 complicationsCodingCollections:(id)a21 followUpsCodingCollections:(id)a22 bodySitesCodingCollections:(id)a23;
+ (id)procedureRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 sortDate:(id)a9 country:(id)a10 state:(unsigned long long)a11 procedureCodingCollection:(id)a12 performers:(id)a13 executionStartDate:(id)a14 executionEndDate:(id)a15 notPerformed:(char)a16 statusCoding:(id)a17 categoryCodingCollection:(id)a18 reasonCodingCollections:(id)a19 reasonsNotPerformedCodingCollections:(id)a20 outcomeCodingCollection:(id)a21 complicationsCodingCollections:(id)a22 followUpsCodingCollections:(id)a23 bodySitesCodingCollections:(id)a24;
