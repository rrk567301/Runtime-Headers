...
- (void).cxx_destruct;
- (void)discard;
- (void)_resourceQueue_addHeartbeatWithTimeIntervalSinceSeriesStartDate:(double)a0 precededByGap:(char)a1 completion:(id /* block */)a2;
- (void)_resourceQueue_addMetadata:(id)a0 completion:(id /* block */)a1;
- (void)_resourceQueue_finishSeriesWithCompletion:(id /* block */)a0;
- (void)addHeartbeatWithTimeIntervalSinceSeriesStartDate:(double)a0 precededByGap:(char)a1 completion:(id /* block */)a2;
