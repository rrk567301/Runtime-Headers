...
@property (readonly) char deactivating;
...
+ (id)predicateForMedicationDoseEventWithLogOrigin:(long long)a0;
+ (id)predicateForMedicationDoseEventWithLogOrigins:(id)a0;
...
+ (id)predicateForMedicationDoseEventWithMedicationUUID:(id)a0;
+ (id)predicateForMedicationDoseEventWithMedicationUUIDs:(id)a0;
...
+ (id)predicateForMedicationDoseEventWithScheduledDate:(id)a0;
+ (id)predicateForMedicationDoseEventWithScheduledDates:(id)a0;
+ (id)predicateForMedicationDoseEventWithScheduledStartDate:(id)a0 endDate:(id)a1;
...
+ (id)predicateForSamplesWithStartDate:(id)a0 endDate:(id)a1 inclusiveEndDates:(char)a2 options:(unsigned long long)a3;
...
+ (id)predicateForStatesOfMindWithAssociation:(long long)a0;
+ (id)predicateForStatesOfMindWithAssociations:(id)a0;
+ (id)predicateForStatesOfMindWithKind:(long long)a0;
+ (id)predicateForStatesOfMindWithLabel:(long long)a0;
+ (id)predicateForStatesOfMindWithLabels:(id)a0;
+ (id)predicateForStatesOfMindWithValence:(double)a0 operatorType:(unsigned long long)a1;
...
+ (id)predicateForWorkoutEffortSamplesRelatedToWorkout:(id)a0 activity:(id)a1;
...
- (void)_queue_activateWithHealthStore:(id)a0 activationUUID:(id)a1 isReactivating:(char)a2 completion:(id /* block */)a3;
- (char)_queue_deactivateWithError:(id)a0;
...
- (char)hasQueryUUID:(id)a0;
- (id)initWithQueryDescriptors:(id)a0;
- (void)queue_deactivate;
- (void)queue_deliverError:(id)a0;
- (void)queue_dispatchToClientForUUID:(id)a0 shouldDeactivate:(char)a1 block:(id /* block */)a2;
- (void)queue_populateConfiguration:(id)a0;
- (void)queue_queryDidDeactivate:(id)a0;
- (void)queue_queryDidFinishActivation:(id)a0 success:(char)a1 error:(id)a2;
