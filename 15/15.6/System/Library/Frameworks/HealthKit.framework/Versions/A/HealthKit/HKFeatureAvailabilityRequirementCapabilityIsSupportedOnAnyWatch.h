...
@property (readonly, nonatomic, getter=isSupportedOnLocalDevice) char supportedOnLocalDevice;
...
- (id)initWithNanoRegistryCapability:(id)a0 supportedOnLocalDevice:(char)a1;
