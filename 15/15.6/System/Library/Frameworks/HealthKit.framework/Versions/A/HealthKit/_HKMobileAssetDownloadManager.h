...
@property (nonatomic) char shouldQueryLocalAssetsFirst;
@property (nonatomic) char shouldAutoDownloadRemoteAssets;
...
- (void)_queue_fetchAssetsWithLocalInformation:(char)a0 shouldRequery:(char)a1 queryParams:(id)a2 returnTypes:(long long)a3;
- (void)_queue_fetchAssetsWithQuery:(id)a0 onlyLocal:(char)a1 completion:(id /* block */)a2;
- (void)downloadAssetsWithQueryParams:(id)a0;
- (void)downloadMobileAssets:(id)a0 completion:(id /* block */)a1;
- (void)fetchAssetsWithQueryParams:(id)a0 onlyLocal:(char)a1 completion:(id /* block */)a2;
- (void)fetchAssetsWithQueryParams:(id)a0 onlyLocal:(char)a1 returnTypes:(long long)a2 completion:(id /* block */)a3;
