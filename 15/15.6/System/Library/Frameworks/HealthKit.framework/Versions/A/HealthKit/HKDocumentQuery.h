...
@property (readonly) char includeDocumentData;
...
- (id)initWithDocumentType:(id)a0 predicate:(id)a1 limit:(unsigned long long)a2 sortDescriptors:(id)a3 includeDocumentData:(char)a4 resultsHandler:(id /* block */)a5;
