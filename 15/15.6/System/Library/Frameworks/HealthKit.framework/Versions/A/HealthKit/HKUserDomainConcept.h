...
@property (readonly, nonatomic) char canRequestSyncUponInsertion;
...
- (id)descriptionAllowedForPublic:(char)a0;
- (id)firstAdhocCoding;
...
- (char)isAdHocUserDomainConcept;
- (char)isSemanticallyEquivalent:(id)a0;
- (id)modificationCopy;
