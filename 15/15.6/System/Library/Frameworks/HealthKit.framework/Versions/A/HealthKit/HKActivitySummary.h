...
@property (nonatomic, getter=_isDataLoading, setter=_setDataLoading:) char dataLoading;
@property (readonly, nonatomic, getter=_hasMoveGoal) char hasMoveGoal;
@property (readonly, nonatomic, getter=_hasEnergyBurnedGoal) char hasEnergyBurnedGoal;
@property (readonly, nonatomic, getter=_hasAppleMoveMinutesGoal) char hasAppleMoveMinutesGoal;
@property (readonly, nonatomic, getter=_isStandalonePhoneSummary) char isStandalonePhoneSummary;
...
+ (char)_validateActivitySummaryDateComponents:(id)a0 errorMessage:(id *)a1;
+ (char)_validateActivitySummaryDateComponentsRange:(id)a0 endDateComponents:(id)a1 errorMessage:(id *)a2;
