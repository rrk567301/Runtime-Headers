...
- (id)valueInRangeWithReferenceRanges:(id)a0 includeUnitString:(char)a1;
- (id)valueInRangeWithReferenceRanges:(id)a0 includeUnitString:(char)a1 allowsNullRange:(char)a2;
