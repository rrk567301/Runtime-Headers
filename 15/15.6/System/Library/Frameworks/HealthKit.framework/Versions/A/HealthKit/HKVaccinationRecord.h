...
@property (readonly) char notGiven;
@property (readonly) char patientReported;
...
+ (id)_newVaccinationRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 sortDate:(id)a9 country:(id)a10 state:(unsigned long long)a11 vaccinationCodings:(id)a12 expirationDate:(id)a13 doseNumber:(id)a14 doseQuantity:(id)a15 lotNumber:(id)a16 performer:(id)a17 bodySiteCodings:(id)a18 reaction:(id)a19 notGiven:(char)a20 administrationDate:(id)a21 statusCoding:(id)a22 patientReported:(char)a23 routeCodings:(id)a24 reasonsCodings:(id)a25 reasonsNotGivenCodings:(id)a26 config:(id /* block */)a27;
+ (id)cachedConceptRelationshipKeyPaths;
+ (id)defaultDisplayString;
+ (char)groupsByUserDomainConcept;
+ (id)indexableConceptKeyPaths;
+ (char)supportsEquivalence;
+ (id)vaccinationRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 country:(id)a9 state:(unsigned long long)a10 vaccinationCodings:(id)a11 expirationDate:(id)a12 doseNumber:(id)a13 doseQuantity:(id)a14 lotNumber:(id)a15 performer:(id)a16 bodySiteCodings:(id)a17 reaction:(id)a18 notGiven:(char)a19 administrationDate:(id)a20 statusCoding:(id)a21 patientReported:(char)a22 routeCodings:(id)a23 reasonsCodings:(id)a24 reasonsNotGivenCodings:(id)a25;
+ (id)vaccinationRecordWithType:(id)a0 note:(id)a1 enteredInError:(char)a2 modifiedDate:(id)a3 originIdentifier:(id)a4 locale:(id)a5 extractionVersion:(long long)a6 device:(id)a7 metadata:(id)a8 sortDate:(id)a9 country:(id)a10 state:(unsigned long long)a11 vaccinationCodings:(id)a12 expirationDate:(id)a13 doseNumber:(id)a14 doseQuantity:(id)a15 lotNumber:(id)a16 performer:(id)a17 bodySiteCodings:(id)a18 reaction:(id)a19 notGiven:(char)a20 administrationDate:(id)a21 statusCoding:(id)a22 patientReported:(char)a23 routeCodings:(id)a24 reasonsCodings:(id)a25 reasonsNotGivenCodings:(id)a26;
...
- (void)_setNotGiven:(char)a0;
- (void)_setPatientReported:(char)a0;
