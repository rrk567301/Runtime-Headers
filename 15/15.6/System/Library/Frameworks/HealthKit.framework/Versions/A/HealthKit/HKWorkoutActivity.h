...
@property (readonly, nonatomic, getter=_startsPaused) char startsPaused;
...
- (char)_filterAndSetWorkoutEvents:(id)a0;
- (id)_initWithUUID:(id)a0 workoutConfiguration:(id)a1 startDate:(id)a2 endDate:(id)a3 workoutEvents:(id)a4 startsPaused:(char)a5 duration:(double)a6 metadata:(id)a7 statisticsPerType:(id)a8;
...
- (char)unitTest_isEqualToActivity:(id)a0 includingStatistics:(char)a1;
