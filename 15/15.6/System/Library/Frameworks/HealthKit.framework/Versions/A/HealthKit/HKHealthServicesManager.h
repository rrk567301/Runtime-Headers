...
- (void)_setHealthPeripheralsStatus:(id)a0 status:(char)a1 withCompletion:(id /* block */)a2;
...
- (void)clientRemote_deliverDiscoveryHealthService:(id)a0 toClient:(unsigned long long)a1 finished:(char)a2 withError:(id)a3;
- (void)clientRemote_deliverSessionCharacteristics:(id)a0 forService:(id)a1 toClient:(unsigned long long)a2 withError:(id)a3;
- (void)clientRemote_deliverSessionHealthServiceStatus:(long long)a0 toClient:(unsigned long long)a1 finished:(char)a2 withError:(id)a3;
...
- (void)setEnabledStatus:(char)a0 forPeripheral:(id)a1 withCompletion:(id /* block */)a2;
