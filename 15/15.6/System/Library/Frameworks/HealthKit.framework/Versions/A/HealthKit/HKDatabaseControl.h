...
- (void)deletedSampleDetailWithReferenceDate:(id)a0 matchingPredicatesOnly:(char)a1 sampleUUID:(id)a2 completion:(id /* block */)a3;
- (void)deletedSampleInfoWithReferenceDate:(id)a0 completion:(id /* block */)a1;
- (void)deletedSamplesDetailWithReferenceDate:(id)a0 matchingPredicatesOnly:(char)a1 anchor:(long long)a2 limit:(long long)a3 completion:(id /* block */)a4;
...
- (void)showWithReferenceDate:(id)a0 deletedSamplesOnly:(char)a1 completion:(id /* block */)a2;
