...
- (void).cxx_destruct;
- (char)_comparisonPredicateContainsStrictStartOrEndDateComparisonPredicate:(id)a0;
- (char)_predicateContainsStrictStartOrEndDateComparisonPredicate:(id)a0;
...
- (void)client_deliverStatisticsBatch:(id)a0 resetStatistics:(char)a1 isFinal:(char)a2 anchor:(id)a3 query:(id)a4;
