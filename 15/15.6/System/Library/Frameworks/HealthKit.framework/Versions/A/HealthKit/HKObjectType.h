...
@property (readonly, nonatomic) char sharingAuthorizationAllowed;
@property (readonly, nonatomic) char readingAuthorizationAllowed;
...
@property (readonly, nonatomic) char isClinicalType;
@property (readonly, nonatomic) char supportsExport;
...
+ (char)_allowAuthorizationForReadingWithTypes:(id)a0 entitlements:(id)a1 disallowedTypes:(id)a2;
+ (char)_allowAuthorizationForSharing:(char)a0 types:(id)a1 entitlements:(id)a2 disallowedTypes:(id)a3;
+ (char)_allowAuthorizationForSharingWithTypes:(id)a0 entitlements:(id)a1 disallowedTypes:(id)a2;
...
+ (id)scoredAssessmentTypeForIdentifier:(id)a0;
...
- (char)isHealthRecordsType;
- (char)requiresPerObjectAuthorization;
