...
@property (readonly, nonatomic) char isBuilderPaused;
...
- (long long)state;
- (id)_initWithSessionIdentifier:(id)a0 workoutConfiguration:(id)a1 sessionServerState:(long long)a2 isBuilderPaused:(char)a3 applicationIdentifier:(id)a4 elapsedTime:(double)a5 snapshotDate:(id)a6 builderStartDate:(id)a7;
