...
@property (readonly, nonatomic) char allowCellular;
...
- (id)initWithChangesSyncRequest:(id)a0 contextSyncRequest:(id)a1 stateSyncRequest:(id)a2 medicalIDSyncRequest:(id)a3 summarySharingSyncRequest:(id)a4 allowCellular:(char)a5 qualityOfService:(long long)a6;
- (id)initWithContextSyncRequest:(id)a0;
- (id)initWithIdentifier:(id)a0 changesSyncRequest:(id)a1 contextSyncRequest:(id)a2 stateSyncRequest:(id)a3 medicalIDSyncRequest:(id)a4 summarySharingSyncRequest:(id)a5 allowCellular:(char)a6 qualityOfService:(long long)a7;
- (id)initWithMedicalIDSyncRequest:(id)a0;
- (id)initWithStateSyncRequest:(id)a0;
- (id)initWithSummarySharingSyncRequest:(id)a0;
- (char)matchesFilter:(unsigned long long)a0;
