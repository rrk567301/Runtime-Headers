...
@property (readonly) char isRawSource;
...
- (id)outputNativeSize;
- (id)rawOptions;
- (id)rawOptionsWithSubsampling:(char)a0;
...
- (void)setInputDisableHighlightRecovery:(id)a0;
...
- (id)transformedImageIgnoringOrientation:(char)a0 andIgnoringScaleFactor:(char)a1;
