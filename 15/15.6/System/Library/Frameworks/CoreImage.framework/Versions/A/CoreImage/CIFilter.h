...
+ (id)filterWithName:(id)a0 setDefaults:(char)a1;
...
+ (char)wrapClassIfNeeded:(Class)a0;
+ (id)xRayFilter;
+ (id)zoomBlurFilter;
...
- (void)_crashed_when_dealloc_called_setValue_nil_forKey_probably_because_the_subclass_already_released_it:(id)a0 className:(const char *)a1 overridesDealloc:(char)a2;
- (char)_filterClassInCategory:(id)a0;
- (char)_isIdentity;
- (void)_prepend:(id)a0;
