...
+ (id)imageWithTexture:(unsigned int)a0 size:(struct CGSize { double x0; double x1; })a1 flipped:(char)a2 colorSpace:(struct CGColorSpace { } *)a3;
+ (id)nullImage;
+ (id)emptyImage;
...
+ (id)imageWithImageProvider:(id)a0 userInfo:(id)a1 size:(struct CGSize { double x0; double x1; })a2 format:(int)a3 flipped:(char)a4 colorSpace:(struct CGColorSpace { } *)a5;
...
+ (id)imageWithTexture:(unsigned int)a0 size:(struct CGSize { double x0; double x1; })a1 flipped:(char)a2 options:(id)a3;
...
- (id)initWithTexture:(unsigned int)a0 size:(struct CGSize { double x0; double x1; })a1 flipped:(char)a2 colorSpace:(struct CGColorSpace { } *)a3;
...
- (id)autoRotateFilterFFT:(id)a0 image:(struct CGImage { } *)a1 inputRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 minTiltAngle:(float)a3 maxTiltAngle:(float)a4 detectVerticalLines:(char)a5 thrVertAngle:(float)a6 thrDomAngleDiff:(float)a7;
...
- (id)getAutoRotateFilter:(id)a0 ciImage:(id)a1 inputRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 rotateCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3 minTiltAngle:(float)a4 maxTiltAngle:(float)a5 detectVerticalLines:(char)a6 thrVertAngle:(float)a7 thrDomAngleDiff:(float)a8;
...
- (id)imageByApplyingTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 highQualityDownsample:(char)a1;
...
- (id)imageByInsertingIntermediate:(char)a0;
...
- (id)initWithImageProvider:(id)a0 userInfo:(id)a1 size:(struct CGSize { double x0; double x1; })a2 format:(int)a3 flipped:(char)a4 colorSpace:(struct CGColorSpace { } *)a5;
...
- (id)initWithTexture:(unsigned int)a0 size:(struct CGSize { double x0; double x1; })a1 flipped:(char)a2 options:(id)a3;
...
- (id)localLightStatisticsWithProxy:(char)a0;
