...
- (struct CGPoint { double x0; double x1; })threadCentroid:(struct { int x0; int x1; int x2; float x3; float x4; int x5; char x6; char x7; char x8; int x9; int x10; float x11; float x12; float x13; float x14; struct { float x0; float x1; float x2; float x3; } x15; struct { float x0; float x1; float x2; float x3; } x16; float x17; int x18; int x19; } *)a0;
...
- (void)printThreadsOnlyClosed:(char)a0 message:(char *)a1;
- (id)repairWithSide:(int)a0;
- (int)addPoint:(struct CGPoint { double x0; double x1; })a0 toHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1;
- (int)addPoint:(struct CGPoint { double x0; double x1; })a0 toShapePoints:(struct { int x0; int x1; struct *x2; int x3; int x4; int x5; } *)a1;
- (int)analyzeMask:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a0 usingConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1 producingOptimizedMask:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a2;
...
- (struct CGPoint { double x0; double x1; })centroidWithConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
- (int)closeThreadIndex:(int)a0 usingVectorField:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a1;
- (int)color:(struct { float x0; float x1; float x2; float x3; } *)a0 underConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1 saturated:(struct { float x0; float x1; float x2; float x3; } *)a2;
...
- (int)convexHull:(struct **)a0 ofOriented:(char)a1 shape:(struct { int x0; int x1; struct *x2; int x3; int x4; int x5; } *)a2;
- (int)convexHull:(struct **)a0 ofOriented:(char)a1 threadIndex:(int)a2;
...
- (char)edgePoint:(struct CGPoint { double x0; double x1; } *)a0 withBitmap:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a1 center:(struct CGPoint { double x0; double x1; })a2 perp:(struct CGPoint { double x0; double x1; })a3;
...
- (char)gatherFaceStatistics:(struct { float x0; float x1; float x2; float x3; float x4; float x5; } *)a0;
- (int)gatherThreadInfo:(struct { int x0; int x1; int x2; float x3; float x4; int x5; char x6; char x7; char x8; int x9; int x10; float x11; float x12; float x13; float x14; struct { float x0; float x1; float x2; float x3; } x15; struct { float x0; float x1; float x2; float x3; } x16; float x17; int x18; int x19; } *)a0;
...
- (char)hopperElement:(struct { int x0; float x1; float x2; float x3; float x4; float x5; float x6; } *)a0 isMoreScleraThanElement:(struct { int x0; float x1; float x2; float x3; float x4; float x5; float x6; } *)a1;
- (int)improvedShape:(struct **)a0 withShape:(struct { int x0; int x1; struct *x2; int x3; int x4; int x5; } *)a1;
- (void)initBitmaps;
- (char)initGridWithBitmap:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a0 scale:(int)a1;
- (int)initHull:(struct **)a0 withOrientation:(char)a1;
...
- (int)insertPoint:(struct CGPoint { double x0; double x1; })a0 andDirection:(struct CGPoint { double x0; double x1; })a1 intoGrid:(char)a2;
...
- (char)isBlurryWithFocusStats:(struct { double x0; int x1; })a0;
- (char)isConvex:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
...
- (void)measureHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0 majorAxis:(struct CGPoint { double x0; double x1; } *)a1 majorTo:(struct CGPoint { double x0; double x1; } *)a2 majorDiameter:(float *)a3 minorAxis:(struct CGPoint { double x0; double x1; } *)a4 minorTo:(struct CGPoint { double x0; double x1; } *)a5 minorDiameter:(float *)a6;
- (id)mutableCopyOfArray:(id)a0;
- (int)newShape:(struct **)a0;
- (int)newThread:(struct **)a0;
- (int)nextPointIndexWithPointIndex:(int)a0;
- (char)openRepairDictionary:(id)a0 convexHull:(struct **)a1 facts:(struct { struct { float x0; float x1; float x2; float x3; } x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; } *)a2;
- (int)packGlobalRepairDictionary:(id *)a0 withConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1 facts:(struct { struct { float x0; float x1; float x2; float x3; } x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; } *)a2;
- (void)point:(struct CGPoint { double x0; double x1; })a0 toGridRow:(int *)a1 column:(int *)a2;
- (int)prepareBitmapsWithString:(char *)a0;
- (int)prepareMasksWithConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
...
- (int)renderConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0 distance:(float)a1 fieldToBitmap:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a2;
- (int)renderEyePolygonToBitmap:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a0;
- (int)renderHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0 toBitmap:(struct { char *x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; float x8; } *)a1;
- (id)repairArray;
...
- (int)saveRepairDictionary:(id *)a0 withConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1 facts:(struct { struct { float x0; float x1; float x2; float x3; } x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; } *)a2;
...
- (void)termBitmaps;
- (void)termGrid;
- (void)termHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
- (void)termShapePoints:(struct { int x0; int x1; struct *x2; int x3; int x4; int x5; } *)a0;
- (float)threadSignedArea:(struct { int x0; int x1; int x2; float x3; float x4; int x5; char x6; char x7; char x8; int x9; int x10; float x11; float x12; float x13; float x14; struct { float x0; float x1; float x2; float x3; } x15; struct { float x0; float x1; float x2; float x3; } x16; float x17; int x18; int x19; } *)a0 centroid:(struct CGPoint { double x0; double x1; })a1;
- (void)transformConvexHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0 withTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
...
- (char)trimConcaveFromHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
- (char)trimEndPointFromHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
- (char)trimStartPointFromHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a0;
- (char)unpackToGlobalRepairDictionary:(id)a0 convexHull:(struct **)a1 facts:(struct { struct { float x0; float x1; float x2; float x3; } x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; } *)a2;
...
- (int)widenedHull:(struct **)a0 withHull:(struct { char x0; int x1; int x2; struct CGPoint *x3; } *)a1 by:(float)a2;
