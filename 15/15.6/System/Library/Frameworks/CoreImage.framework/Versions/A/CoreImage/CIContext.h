...
+ (char)loadArchiveWithName:(id)a0 fromURL:(id)a1;
+ (char)loadArchiveWithURL:(id)a0;
...
- (struct CGImage { } *)createCGImage:(id)a0 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 format:(int)a2 colorSpace:(struct CGColorSpace { } *)a3 deferred:(char)a4;
...
- (struct CGImage { } *)_createCGImage:(id)a0 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 format:(int)a2 premultiplied:(char)a3 colorSpace:(struct CGColorSpace { } *)a4 deferred:(struct Trilean { char x0; })a5 renderCallback:(id)a6;
- (id)_createClone;
- (id)_dataRepresentationOfImage:(id)a0 UTIType:(id)a1 format:(int)a2 premultiplied:(char)a3 colorSpace:(struct CGColorSpace { } *)a4 options:(id)a5 addAuxData:(char)a6 keysToMerge:(id)a7 error:(id *)a8;
...
- (id)_startTaskToRender:(id)a0 toDestination:(id)a1 forPrepareRender:(char)a2 forClear:(char)a3 error:(id *)a4;
...
- (struct CGImage { } *)createCGImage:(id)a0 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 format:(int)a2 premultiplied:(char)a3 colorSpace:(struct CGColorSpace { } *)a4 deferred:(char)a5 renderCallback:(id /* block */)a6;
...
- (char)measureRequirementsOf:(id)a0 query:(int)a1 :(id *)a2 results:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3;
- (struct CGSize { double x0; double x1; })outputImageMaximumSize;
- (char)prepareRender:(id)a0 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 toDestination:(id)a2 atPoint:(struct CGPoint { double x0; double x1; })a3 error:(id *)a4;
...
- (char)testArchive:(id)a0;
- (char)writeHEIF10RepresentationOfImage:(id)a0 toURL:(id)a1 colorSpace:(struct CGColorSpace { } *)a2 options:(id)a3 error:(id *)a4;
- (char)writeHEIFRepresentationOfImage:(id)a0 toURL:(id)a1 format:(int)a2 colorSpace:(struct CGColorSpace { } *)a3 options:(id)a4 error:(id *)a5;
- (char)writeJPEGRepresentationOfImage:(id)a0 toURL:(id)a1 colorSpace:(struct CGColorSpace { } *)a2 options:(id)a3 error:(id *)a4;
- (char)writeOpenEXRRepresentationOfImage:(id)a0 toURL:(id)a1 options:(id)a2 error:(id *)a3;
- (char)writePNGRepresentationOfImage:(id)a0 toURL:(id)a1 format:(int)a2 colorSpace:(struct CGColorSpace { } *)a3 options:(id)a4 error:(id *)a5;
- (char)writeTIFFRepresentationOfImage:(id)a0 toURL:(id)a1 format:(int)a2 colorSpace:(struct CGColorSpace { } *)a3 options:(id)a4 error:(id *)a5;
