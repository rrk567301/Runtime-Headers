@class PHRelationshipChangeRequestHelper, NSDictionary, NSString, NSDate, PHPhotosHighlight, NSManagedObjectID;
...
- (id)_mutableKeyAssetObjectIDsAndUUIDsForShared:(char)a0 userEdited:(char)a1;
...
- (void)setKeyAssetPrivate:(id)a0 userEdited:(char)a1;
- (void)setKeyAssetShared:(id)a0;
- (void)setKeyAssetShared:(id)a0 userEdited:(char)a1;
