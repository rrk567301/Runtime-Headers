...
@interface PHQuery : NSObject <NSPredicateVisitor, NSCopying> {
    ...
    char _containsToManySelfInPredicate;
...
@property (nonatomic, setter=_setIncludesCameraRoll:) char _includesCameraRoll;
...
+ (char)_isKindOfMomentOrAlbumEntity:(id)a0;
...
+ (char)_validateLocalIdentifiers:(id)a0 compatibilityWithFetchType:(id)a1;
+ (id)defaultSortDescriptorForFetchType:(id)a0 predicate:(id)a1 ascending:(char)a2;
...
+ (char)isToManySelfInPredicate:(id)a0;
...
+ (id)queryForAssetsCaptured:(char)a0 orEdited:(char)a1 onThisCameraSinceDate:(id)a2 options:(id)a3;
...
+ (id)queryForAssetsWithCurrentUserAsLibraryScopeContributor:(char)a0 inLibraryScope:(id)a1 options:(id)a2;
...
- (id)executeQuery;
- (id)_createFetchRequestIncludingBasePredicate:(char)a0;
- (id)_effectiveDefaultSortDescriptorReversingOrder:(char)a0;
...
- (id)effectivePredicateForPHClass:(Class)a0 includingBasePredicate:(char)a1;
...
- (char)overrideResultClassWithFetchType;
