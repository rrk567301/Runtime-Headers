...
- (char)_recordCaptionAndEmbeddingAnalysisToAvailability:(id)a0 error:(id *)a1;
- (char)_recordFaceAndSceneAnalysisToAvailability:(id)a0 error:(id *)a1;
- (char)addAnalysisStateToAvailabilityStatus:(id)a0 error:(id *)a1;
- (char)addGraphAvailabilityToAvailabilityStatus:(id)a0 error:(id *)a1;
- (char)addIndexingStateToAvailabilityStatus:(id)a0 error:(id *)a1;
