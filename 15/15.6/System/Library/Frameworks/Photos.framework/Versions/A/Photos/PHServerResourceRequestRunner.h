...
- (char)_resourceQualifiesForCacheMetricsCollection:(id)a0 isLivePhoto:(char)a1;
...
- (char)currentSystemSupportsProMotionDisplay;
...
- (id)startDownloadForRequest:(id)a0 backingResource:(id)a1 clientBundleID:(id)a2 shouldReturnAdjustmentInfo:(char)a3 needsDownload:(char)a4 shouldApplyTimeRange:(char)a5 reply:(id /* block */)a6;
- (void)startWalrusTimeRangeDownloadForRequest:(id)a0 backingResource:(id)a1 clientBundleID:(id)a2 shouldReturnAdjustmentInfo:(char)a3 partialVideoURL:(id)a4 reply:(id /* block */)a5;
- (id)videoResourceChoiceForAsset:(id)a0 context:(id)a1 loadingMode:(long long *)a2 request:(id)a3 shouldReturnAdjustmentInfo:(char *)a4 error:(id *)a5;
