...
+ (char)_hasInvalidMemoryTriggerForMemory:(id)a0;
+ (char)_isAcceptableUserFeedbackForMemory:(id)a0 keyAsset:(id)a1 userFeedbackCalculator:(id)a2;
+ (char)_isMomentFetchResult:(id)a0 overlappingWithFetchResults:(id)a1;
...
+ (char)isMomentFetchResult:(id)a0 overlappingWithFetchResult:(id)a1;
