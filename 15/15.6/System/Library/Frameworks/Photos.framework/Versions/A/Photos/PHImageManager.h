...
+ (char)_allowVideoAccessForAsset:(id)a0 options:(id)a1;
+ (id)_videoAVObjectBuilderFromVideoURL:(id)a0 info:(id)a1 options:(id)a2 playbackOnly:(char)a3;
...
- (char)_canStreamVideoForAsset:(id)a0;
- (void)_handleResultForContentEditingInput:(id)a0 request:(id)a1 options:(id)a2 asset:(id)a3 completionHandler:(id /* block */)a4;
- (void)_prepareLivePhotoResultWithImage:(struct CGImage { } *)a0 uiOrientation:(long long)a1 shouldIncludeVideo:(char)a2 videoURL:(id)a3 info:(id)a4 photoTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a5 asset:(id)a6 completion:(id /* block */)a7;
