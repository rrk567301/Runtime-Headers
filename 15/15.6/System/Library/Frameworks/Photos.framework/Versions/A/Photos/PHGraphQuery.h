...
+ (char)_shouldExcludeSocialGroupWithVerifiedType:(short)a0 inSocialGroupContext:(long long)a1;
...
+ (id)graphQueryForKeyAssetForSocialGroup:(id)a0 createIfNeeded:(char)a1 options:(id)a2;
...
- (void).cxx_destruct;
- (id)executeQuery;
- (char)_graphQueryIntersectsWithChange:(id)a0;
...
- (char)requiresFullRefetchForChange:(id)a0;
