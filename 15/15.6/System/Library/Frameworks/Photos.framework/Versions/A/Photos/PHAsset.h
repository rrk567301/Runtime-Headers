@class NSURL, PHAssetPhotosSmartStyleExtendedProperties, CLLocation, NSDate, NSManagedObjectContext, NSString, NSSet, NSManagedObjectID, PHPhotoLibrary, NSArray, NSData, NSNumber, PLLazyObject, NSValue;
...
@property (readonly, nonatomic) char hasPhotoColorAdjustments;
...
@property (readonly, nonatomic) char hasKeywords;
...
@property (readonly, nonatomic) char faceAnalysisVersionWasFetched;
@property (nonatomic) char assetDescriptionWasSet;
@property char canUseLocationCoordinateForLocation;
...
@property (readonly, nonatomic) char isHDRVideo;
...
@property (readonly, nonatomic) char hasPhotoStreamTagID;
...
@property (readonly, nonatomic) char isGuestAsset;
@property (readonly, nonatomic) char isRecoveredAsset;
@property (readonly, nonatomic) char isSyndicatedAssetSavedToUserLibrary;
@property (readonly, nonatomic) char isOffline;
@property (readonly, nonatomic) char isCloudPlaceholder;
...
@property (readonly, nonatomic) char isRAWPlusJPEG;
...
@property (readonly, nonatomic) char isAnimatedGIF;
@property (readonly, nonatomic) char isPartOfBurst;
@property (readonly, nonatomic) char isHEICSequence;
...
@property (readonly, nonatomic) char hasEditableDepth;
@property (readonly, nonatomic) char is60PlusFPS;
@property (readonly, nonatomic) char hasSpatialAudio;
@property (readonly, nonatomic) char isStyleable;
...
@property (readonly, nonatomic) char canPlayAutoloop;
@property (readonly, nonatomic) char canPlayMirror;
@property (readonly, nonatomic) char canPlayLongExposure;
@property (readonly, nonatomic) char canPlayLoopingVideo;
@property (readonly, nonatomic) char isTimelapsePlaceholder;
@property (readonly, nonatomic) char isIncludedInMoments;
@property (readonly, nonatomic) char isIncludedInCloudFeeds;
@property (readonly, nonatomic, getter=isTrashed) char trashed;
@property (readonly, nonatomic) char canPerformSharingAction;
...
@property (readonly, nonatomic) char isLocalVideoKeyFrameValid;
@property (readonly, nonatomic) unsigned short videoCpVisibilityState;
@property (readonly, nonatomic) char participatesInLibraryScope;
...
@property (readonly, nonatomic, getter=isSyncFailureHidden) char syncFailureHidden;
...
+ (id)fetchKeyAssetForEachSuggestion:(id)a0 options:(id)a1 useSuggestionsSortOrder:(char)a2;
...
+ (char)_isLivePhotoWithPhotoIris:(char)a0 hasAdjustments:(char)a1 videoCpDuration:(long long)a2 videoCPVisibility:(unsigned short)a3 sourceType:(unsigned long long)a4;
+ (char)_libraryScopeAssetContributedByCurrentUser:(id)a0;
+ (id)_requestCuratedAssetInAssetCollection:(id)a0 referenceAsset:(id)a1 referencePersons:(id)a2 fetchOptions:(id)a3 onlyKey:(char)a4;
...
+ (id)fetchAssetsCapturedOrEdited:(char)a0 onThisCameraSinceDate:(id)a1 options:(id)a2;
...
+ (id)fetchAssetsWithCurrentUserAsLibraryScopeContributor:(char)a0 inLibraryScope:(id)a1 options:(id)a2;
+ (id)fetchAssetsWithMediaType:(long long)a0 options:(id)a1;
+ (id)fetchAssetsWithSyndicationIdentifiers:(id)a0 options:(id)a1;
+ (id)fetchAssetsWithSyndicationIdentifiers:(id)a0 options:(id)a1 includeRejected:(char)a2;
...
+ (id)fetchKeyAssetForSocialGroup:(id)a0 createIfNeeded:(char)a1 options:(id)a2;
...
+ (id)fetchSummaryCurationForHighlight:(id)a0 fetchOptions:(id)a1 allowsOnDemand:(char)a2 error:(id *)a3;
+ (id)fetchSyndicatedAssetsWithOptions:(id)a0;
+ (id)fetchSyndicatedAssetsWithOptions:(id)a0 includeRejected:(char)a1;
+ (id)fetchType;
...
+ (id)internalSortDescriptorsWithCreationDateAscending:(char)a0;
+ (char)isOriginalKnownUnsupportedFormatForAsset:(id)a0 failureInfo:(id *)a1;
+ (char)isOriginalVideoComplementKnownUnsupportedFormatForAsset:(id)a0 failureInfo:(id *)a1;
...
- (long long)_baseVersionForAdjustmentData:(id)a0 canHandleAdjustmentData:(char)a1;
- (char)_canHandleAdjustmentData:(id)a0 withOptions:(id)a1;
...
- (void)_requestRenderedVideoForVideoURL:(id)a0 adjustmentData:(id)a1 canHandleAdjustmentData:(char)a2 resultHandler:(id /* block */)a3;
...
- (char)hasAdjustments;
- (char)hasContentEqualTo:(id)a0;
- (char)hasLegacyAdjustments;
- (id)iconicScoreProperties;
- (id)importProperties;
- (id)initWithFetchDictionary:(id)a0 propertyHint:(unsigned long long)a1 photoLibrary:(id)a2;
- (char)isInFlight;
- (char)isIncompleteLivePhotoMissingVideoComplement;
...
- (char)shouldUseRAWResourceWithOriginalResourceChoice:(unsigned long long)a0;
