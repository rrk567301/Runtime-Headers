...
- (void).cxx_destruct;
- (char)_addBatchRangeAtIndex:(unsigned long long)a0 toOutError:(id *)a1;
...
- (char)_hasMoreBatchesAtIndex:(unsigned long long)a0;
...
- (char)_performChangesAndWaitStartingAtIndex:(unsigned long long)a0 error:(id *)a1;
...
- (char)performChangesAndWait:(id *)a0;
