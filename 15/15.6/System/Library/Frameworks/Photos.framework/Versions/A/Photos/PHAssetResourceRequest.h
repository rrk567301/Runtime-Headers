@class NSError, NSString, PHAssetResourceRequestOptions, NSDictionary, PHAssetResource, PHProgressContainerForRetryableRequest, NSProgress, PLProgressFollower;
...
@property (nonatomic) char loadURLOnly;
...
- (void)_assetsdMakeAvailableRequestRepliedWithSuccess:(char)a0 url:(id)a1 data:(id)a2 info:(id)a3 error:(id)a4;
- (void)_finishAsyncWithFileURL:(id)a0 didBecomeAvailable:(char)a1 error:(id)a2;
- (void)_finishWithFileURL:(id)a0 didBecomeAvailable:(char)a1 error:(id)a2;
...
- (void)_updateAssetResourceWithLocallyAvailable:(char)a0 fileURL:(id)a1;
