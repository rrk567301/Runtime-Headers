...
- (id)initWithCollectionList:(id)a0 keyAssets:(id)a1 childCollectionsFetchResult:(id)a2 keyAssetFetchByCollectionID:(id)a3 identifier:(id)a4 options:(id)a5 registerIfNeeded:(char)a6;
