...
@property (readonly, nonatomic) char libraryScopeInLocalMode;
...
+ (id)_estimatedAssetCountToMoveForExitRetentionPolicyContributedOnly:(char)a0 options:(id)a1 error:(id *)a2;
+ (id)entityKeyMap;
+ (unsigned long long)estimatedAssetCountToMoveForExitRetentionPolicyContributedOnly:(char)a0 imageCount:(unsigned long long *)a1 videoCount:(unsigned long long *)a2 audioCount:(unsigned long long *)a3 itemCount:(unsigned long long *)a4 options:(id)a5 error:(id *)a6;
+ (id)fetchActiveLibraryScopeWithOptions:(id)a0;
+ (void)fetchLibraryScopeFromShareURL:(id)a0 ignoreExistingShare:(char)a1 photoLibrary:(id)a2 completionHandler:(id /* block */)a3;
...
+ (char)removePersonRulesOnActiveLibraryScopeWithPhotoLibrary:(id)a0 error:(id *)a1;
...
- (void)refreshLibraryScopeWithCompletion:(id /* block */)a0;
