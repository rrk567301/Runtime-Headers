...
@property (class, readonly) PHSynchronousPhotoLibraryExecutionContext *synchronousExecutionContext;
...
- (void)callTransactionCompletionHandler:(id /* block */)a0 withSuccess:(char)a1 error:(id)a2;
