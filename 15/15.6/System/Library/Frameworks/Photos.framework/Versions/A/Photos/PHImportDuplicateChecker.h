...
- (id)_checkForDuplicate:(id)a0 considerItemsInTheTrash:(char)a1;
- (id)_filterDuplicatesForItem:(id)a0 duplicateSet:(id)a1 considerItemsInTrash:(char)a2;
- (char)_findFingerprint:(id)a0 forItem:(id)a1 inCache:(id)a2 considerTrash:(char)a3;
...
- (void)findDuplicatesOfItems:(id)a0 considerItemsInTrash:(char)a1 forEach:(id /* block */)a2 atEnd:(id /* block */)a3;
