...
@property (nonatomic, getter=isRegisteredForChangeNotificationDeltas) char registeredForChangeNotificationDeltas;
...
@property (nonatomic) char preventsClearingOIDCache;
...
+ (id)pl_fetchResultContainingAssetContainer:(id)a0 photoLibrary:(id)a1 includeTrash:(char)a2;
...
- (id)objectIDs;
- (id)initWithQuery:(id)a0 registerIfNeeded:(char)a1;
- (char)_canCreateFetchedPropertyObjectsWithClass:(Class)a0;
...
- (id)initWithQuery:(id)a0 oids:(id)a1 registerIfNeeded:(char)a2 usingManagedObjectContext:(id)a3;
