...
@property (readonly, nonatomic, getter=isInPersonNamingModel) char inPersonNamingModel;
...
+ (id)_personSuggestionMarkedAsConfirmed:(char)a0 fromPersonSuggestion:(id)a1;
...
+ (long long)updateKeyFacesOfPersons:(id)a0 forceUpdate:(char)a1 completion:(id /* block */)a2;
