...
+ (char)hasCSAttributedEntityTypePhotosMemoriesTripKeyInAttributedQueryString:(id)a0;
+ (char)isAllTimeWithAttributedQueryString:(id)a0;
+ (char)isTripWithAttributedQueryString:(id)a0;
