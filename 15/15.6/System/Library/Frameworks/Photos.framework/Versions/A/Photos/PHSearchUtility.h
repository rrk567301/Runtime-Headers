...
+ (char)_locationExists:(unsigned long long)a0 forString:(id)a1;
...
+ (char)_shouldOfferCompletionSuggestionsInQueryString:(id)a0 atLocation:(unsigned long long)a1 parsedQueryTokens:(id)a2;
+ (char)_tokenHasSuggestion:(id)a0;
...
+ (char)locationDisambiguationSpansFullLengthOfString:(id)a0;
...
+ (char)rangeExists:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forString:(id)a1;
