...
@property (nonatomic) char importInProgress;
...
+ (id)sharedInstance;
+ (char)isDeviceVolumeAtURL:(id)a0;
+ (char)isValidFolderAtURL:(id)a0;

- (id)init;
- (void).cxx_destruct;
- (id)supportedTypes;
- (void)deviceBrowser:(id)a0 didAddDevice:(id)a1 moreComing:(char)a2;
- (void)deviceBrowser:(id)a0 didRemoveDevice:(id)a1 moreGoing:(char)a2;
