...
@property (nonatomic) char assetMetadataRetrievalAttempted;
...
@property (nonatomic) char shouldSendTimingIntervalsToAnalytics;
...
+ (id)assetExportLog;
+ (char)errorIsLowDiskSpaceRelated:(id)a0;
...
- (void)handleResultWithFileURLs:(id)a0 cancelled:(char)a1 withError:(id)a2 forAsset:(id)a3 withOptions:(id)a4 progress:(id)a5 processingUnitCount:(long long)a6 completionHandler:(id /* block */)a7;
...
- (char)reassembleAdjustmentsPropertyListIfNeeded:(id)a0 toOutputDirectory:(id)a1 outputURL:(id *)a2 error:(id *)a3;
- (void)sendPreparationCompletedEventWithPreparationTimingInfo:(id)a0 forActivityType:(id)a1 preparationOptions:(id)a2 withError:(id)a3 didCancel:(char)a4;
