...
@interface PHAssetCreationRequestPlaceholderSupport : PHAssetCreationRequest {
    ...
    char _downloadSourceMode_shouldBakeInAdjustments;
    char _downloadSourceMode_shouldFlattenLivePhoto;
    char _downloadSourceMode_shouldCopyLocationData;
}
...
- (char)_regenerateResourcesWithLocationDataRemoved:(id)a0 sourceExternalResources:(id)a1 photoLibrary:(id)a2 error:(id *)a3;
