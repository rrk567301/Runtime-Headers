...
@property (nonatomic) char allowHints;
@property (nonatomic) char allowChoosingNonLocalVideoKeyFrameResource;
@property (nonatomic) char isCloudSharedMode;
...
+ (unsigned long long)_chooserSourceOptionsFromBehaviorSpec:(id)a0 allowHints:(char)a1;
+ (id)_resourceVersionsFromImageRequestVersion:(long long)a0 assetHasAdjustments:(char)a1;
...
- (char)_resourceInfoPassesTestForImageDerivativeOfVideo:(id)a0;
