...
@property (nonatomic) char isRearFacingCamera;
@property (nonatomic) char isExpectingPairedVideo;
...
- (id)initWithCameraMetadataPath:(id)a0 isCameraRearFacing:(char)a1 isExpectingPairedVideo:(char)a2 finalAssetHeight:(double)a3 finalAssetWidth:(double)a4 dbgFilePath:(id)a5 previewImgSurfaceRef:(void *)a6 creationDate:(id)a7 jobType:(id)a8 placeholderHeight:(double)a9 placeholderWidth:(double)a10 previewImageData:(id)a11 deferredIdentifier:(id)a12 captureID:(id)a13;
- (char)isEligibleForQuickFaceAnalysis;
