@class NSMutableDictionary, NSString, NSMutableArray, PHImportResults, PHPhotoLibrary, PHImportSource, NSMutableSet, NSProgress, PHImportOptions, PLCacheDeleteClient, NSObject;
...
+ (id)removeItemAtPath:(id)a0 type:(unsigned long long)a1 recursive:(char)a2;
...
- (char)handleErrorsForRecord:(id)a0 batch:(id)a1 file:(char *)a2 line:(int)a3;
...
- (char)shouldImportRecordAsReference:(id)a0;
- (char)shouldIngestInPlace:(id)a0;
