...
+ (id)fetchAnsweredQuestionsWithOptions:(id)a0 validQuestionsOnly:(char)a1;
+ (id)fetchAnsweredYesOrNoQuestionsWithOptions:(id)a0 validQuestionsOnly:(char)a1;
+ (id)fetchInvalidatedQuestionsWithOptions:(id)a0;
+ (id)fetchQuestionsWithLocalIdentifiers:(id)a0 options:(id)a1 validQuestionsOnly:(char)a2;
+ (id)fetchQuestionsWithOptions:(id)a0 validQuestionsOnly:(char)a1;
+ (id)fetchType;
+ (id)fetchUnansweredQuestionsWithOptions:(id)a0 validQuestionsOnly:(char)a1;
+ (id)identifierCode;
