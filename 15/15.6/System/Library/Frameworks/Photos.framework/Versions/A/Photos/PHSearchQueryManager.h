...
@property (nonatomic) char isTestingConfiguration;
...
+ (char)_isValidQueryText:(id)a0;
+ (char)currentSpotlightVersionSupportsExactMatchBehavior;
+ (char)currentSpotlightVersionSupportsExactMatchBehaviorWithEmbeddingOnlyResults;
