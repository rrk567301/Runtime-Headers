...
@property (readonly, nonatomic) char supportsFastKeyAssetCuration;
@property (readonly, nonatomic) int plAlbumKind;
@property (readonly, nonatomic) NSString *transientSubtitle;
@property (readonly, nonatomic) char transientKeyAssetsAtEnd;
@property (readonly, nonatomic) PHQuery *query;
@property (readonly, nonatomic) NSArray *assetOids;
@property (readonly, nonatomic) NSArray *assets;
@property (nonatomic, getter=_canShowCloudComments, setter=_setCanShowCloudComments:) char _canShowCloudComments;
...
@property (readonly, nonatomic) char isTrashBin;
@property (readonly, nonatomic) char isPlacesAlbum;
...
@property (readonly, nonatomic) char containsPrivateContent;
...
+ (char)_defaultKeyAssetsAtEndForType:(long long)a0 subtype:(long long)a1;
...
+ (id)graphOptionsForTransientAssetCollection:(id)a0 needsCompleteMomentsInfo:(char)a1 options:(id)a2;
+ (id)identifierCode;
+ (id)managedEntityName;
+ (char)managedObjectSupportsTrashedState;
+ (id)pl_PHAssetCollectionForAssetContainer:(id)a0 photoLibrary:(id)a1;
+ (id)pl_PHAssetCollectionForAssetContainer:(id)a0 photoLibrary:(id)a1 includeTrash:(char)a2;
...
- (id)_initTransientWithAssets:(id)a0 orFetchResult:(id)a1 orQuery:(id)a2 title:(id)a3 subtitle:(id)a4 titleFontName:(id)a5 identifier:(id)a6 keyAssetsAtEnd:(char)a7 albumKind:(int)a8 type:(long long)a9 subtype:(long long)a10 startDate:(id)a11 endDate:(id)a12 photoLibrary:(id)a13;
- (char)_shouldFetchDatesIfNeeded;
- (char)alwaysRecalculateCounts;
