...
- (char)_hasPeopleForSceneClassifications:(id)a0 sceneAnalysisVersion:(short)a1;
- (char)_hasPetsForSceneClassifications:(id)a0 sceneAnalysisVersion:(short)a1;
- (char)_isPeopleSceneIdentifier:(unsigned long long)a0;
- (char)_isSceneConfidenceAboveThresholdForSceneClassification:(id)a0 sceneAnalysisVersion:(short)a1;
