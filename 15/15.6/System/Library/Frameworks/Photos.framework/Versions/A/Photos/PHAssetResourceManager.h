...
- (int)_nextRequestID;
- (int)_requestForAssetResource:(id)a0 loadURLOnly:(char)a1 options:(id)a2 urlReceivedHandler:(id /* block */)a3 dataReceivedHandler:(id /* block */)a4 completionHandler:(id /* block */)a5;
