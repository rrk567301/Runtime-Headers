...
@property (readonly, nonatomic) char isCloudShared;
...
- (void).cxx_destruct;
- (id)initWithAsset:(id)a0 desiredSize:(struct CGSize { double x0; double x1; })a1 requestedScale:(float)a2 allowedResourceVersions:(id)a3 behaviorSpec:(id)a4 cloudSharedMode:(char)a5 fallbackRequestedScaleIfPreferredResourceNotLocallyAvailable:(double)a6 loggingPrefix:(id)a7;
