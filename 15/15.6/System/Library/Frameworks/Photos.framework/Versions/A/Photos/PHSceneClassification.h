...
+ (id)_fetchSceneClassificationsGroupedByAssetLocalIdentifierForAssets:(id)a0 includeTemporalClassifications:(char)a1 sceneClassificationTypePredicate:(id)a2;
+ (id)fetchSceneClassificationsGroupedByAssetLocalIdentifierForAssets:(id)a0;
+ (id)fetchSceneClassificationsGroupedByAssetLocalIdentifierForAssets:(id)a0 includeTemporalClassifications:(char)a1;
+ (id)fetchSceneClassificationsGroupedByAssetLocalIdentifierForAssets:(id)a0 sceneClassificationType:(long long)a1;
+ (id)fetchSceneClassificationsGroupedByAssetLocalIdentifierForAssets:(id)a0 sceneClassificationType:(long long)a1 includeTemporalClassifications:(char)a2;
...
- (char)_validateStartTime:(double)a0 duration:(double)a1 classificationType:(long long)a2;
...
- (char)isEqualToSceneClassification:(id)a0;
