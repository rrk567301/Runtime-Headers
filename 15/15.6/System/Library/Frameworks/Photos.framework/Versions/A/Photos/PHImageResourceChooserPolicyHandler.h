...
+ (char)_passesSquareTableThumbnailTestWithKey:(id)a0 pixelSize:(struct CGSize { double x0; double x1; })a1 storeClassID:(unsigned short)a2 loadingOptions:(unsigned long long)a3;
