...
@property (readonly, nonatomic) char hasChangeRequests;
...
- (char)_isSupportedLimitedLibraryChangeRequest:(id)a0;
...
- (void)didSendChangesToServiceWithResult:(char)a0;
