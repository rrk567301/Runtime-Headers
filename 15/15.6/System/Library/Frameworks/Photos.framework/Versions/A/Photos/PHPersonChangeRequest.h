...
@interface PHPersonChangeRequest : PHChangeRequest <PHInsertChangeRequest, PHUpdateChangeRequest> {
    ...
    char _didUnsetUserFeedback;
    char _didUnsetAutonamingUserFeedbacks;
...
@property (nonatomic, getter=isInPersonNamingModel) char inPersonNamingModel;
...
+ (char)_allPersonsAreGraphPersons:(id)a0;
...
- (char)_ensureModelConsistencyForVerifiedTypePromotion:(id)a0 originalVerifiedType:(int)a1 error:(id *)a2;
...
- (char)_hasMutationForVerifiedType:(int *)a0;
...
- (char)_removeObjects:(id)a0 fromArray:(id)a1;
- (void)_setGraphDedupePersons:(id)a0;
- (void)_setKeyFace:(id)a0 forCluster:(char)a1 pickSource:(short)a2;
- (void)_setNominalMergeTargetUUID:(id)a0;
- (char)_shouldPromotePerson:(id)a0 toVerifiedType:(int *)a1;
- (char)_validateMergePerson:(id)a0 withPersonUUIDs:(id)a1 error:(id *)a2;
- (void)addFaces:(id)a0;
...
- (void)addRejectedFaces:(id)a0 forCluster:(char)a1;
...
- (void)setKeyFace:(id)a0 forCluster:(char)a1;
- (void)setKeyFaceForUserPick:(id)a0;
- (void)setKeyFaceForUserPick:(id)a0 forCluster:(char)a1;
- (void)setManualOrder:(unsigned long long)a0 verified:(char)a1;
