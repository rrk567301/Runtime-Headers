...
@property (readonly, nonatomic, getter=hasInterleavedIndicesChannels) char interleavedIndicesChannels;
...
+ (id)geometryElementWithBuffer:(id)a0 primitiveType:(long long)a1 primitiveCount:(long long)a2 indicesChannelCount:(long long)a3 interleavedIndicesChannels:(char)a4 bytesPerIndex:(long long)a5;
+ (id)geometryElementWithData:(id)a0 primitiveType:(long long)a1 primitiveCount:(long long)a2 indicesChannelCount:(long long)a3 interleavedIndicesChannels:(char)a4 bytesPerIndex:(long long)a5;
...
- (void)_printData;
- (id)initWithBuffer:(id)a0 primitiveType:(long long)a1 primitiveCount:(long long)a2 indicesChannelCount:(long long)a3 interleavedIndicesChannels:(char)a4 bytesPerIndex:(long long)a5;
- (id)initWithData:(id)a0 primitiveType:(long long)a1 primitiveCount:(long long)a2 indicesChannelCount:(long long)a3 interleavedIndicesChannels:(char)a4 bytesPerIndex:(long long)a5;
