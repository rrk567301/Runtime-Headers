...
+ (id)SCNUID_constantToStringForProperty:(id)a0;
...
- (void)setAdjustsShadowProjection:(char)a0;
- (void)setBaked:(char)a0;
- (void)setForceBackFaceCasters:(char)a0;
...
- (void)setUsesDeferredShadows:(char)a0;
- (void)setUsesModulatedMode:(char)a0;
