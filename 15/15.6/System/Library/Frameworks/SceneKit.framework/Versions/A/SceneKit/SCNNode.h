...
@property (readonly, nonatomic) char hasActions;
...
+ (char)SCNUID_rangeForFloatProperty:(id)a0 min:(double *)a1 max:(double *)a2;
...
- (void)_customEncodingOfSCNNode:(id)a0 usePresentationInstance:(char)a1;
...
- (char)getFrustum:(SEL)a0 withViewport:(struct { union { struct { float x0; float x1; float x2; float x3; } x0; } x0[6]; } *)a1;
...
- (void)setAuthoringEnvironmentNode:(char)a0;
...
- (char)simdGetBoundingSphereCenter:(void *)a0 radius:(float *)a1;
