...
- (char)_copyImage:(struct __C3DImage { } *)a0 toTexture:(id)a1 desc:(id)a2 textureOptions:(int)a3 needsMipMapGeneration:(char)a4;
- (id)newRenderPipelineStateWithDesc:(struct { struct { struct __C3DFXMetalProgram *x0; struct __C3DMaterial *x1; struct __C3DGeometry *x2; struct __C3DFXPass *x3; struct __C3DFXPass *x4; struct __C3DBlendStates *x5; struct __C3DNode *x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; id x11; unsigned long long x12; unsigned char x13; unsigned char x14; id x15; struct { unsigned char x0; id /* block */ x1; } x16; unsigned long long x17; } x0; id x1; struct { unsigned long long x0[8]; unsigned long long x1; unsigned long long x2; unsigned char x3; } x2; struct __C3DBlendStates *x3; unsigned long long x4[8]; unsigned char x5; id x6; id x7; id x8; id x9; id x10; id x11; id /* block */ x12; unsigned char x13; BOOL x14; BOOL x15; BOOL x16; })a0;
...
- (void)_createPipelineStateWithDescriptor:(id)a0 desc:(struct { struct { struct __C3DFXMetalProgram *x0; struct __C3DMaterial *x1; struct __C3DGeometry *x2; struct __C3DFXPass *x3; struct __C3DFXPass *x4; struct __C3DBlendStates *x5; struct __C3DNode *x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; id x11; unsigned long long x12; unsigned char x13; unsigned char x14; id x15; struct { unsigned char x0; id /* block */ x1; } x16; unsigned long long x17; } x0; id x1; struct { unsigned long long x0[8]; unsigned long long x1; unsigned long long x2; unsigned char x3; } x2; struct __C3DBlendStates *x3; unsigned long long x4[8]; unsigned char x5; id x6; id x7; id x8; id x9; id x10; id x11; id /* block */ x12; unsigned char x13; BOOL x14; BOOL x15; BOOL x16; })a1 pipeline:(id)a2;
- (void)_deformerStackDidChange:(id)a0;
- (void)_deformerStackWillDie:(id)a0;
- (void)_enqueueCopyFromTexture:(id)a0 toTexture:(id)a1 blitEncoder:(struct SCNMTLBlitCommandEncoder { id x0; id x1; } *)a2 generateMipMaps:(char)a3;
...
- (id)copyTextureByConvertingToCubeMapIfApplicable:(id)a0 engineContext:(struct __C3DEngineContext { } *)a1 needsMipmap:(char)a2;
- (id)defaultCubeTexture;
- (id)defaultLightingEnvironmentIrradianceTexture;
- (id)defaultLightingEnvironmentRadianceTexture;
- (struct __C3DFXMetalProgram { } *)defaultProgramUsingTessellation:(char)a0;
- (id)defaultTexture;
- (id)defaultTexture3D;
...
- (id)newCubemapTextureForLatlongTexture:(id)a0 pixelFormat:(unsigned long long)a1 engineContext:(struct __C3DEngineContext { } *)a2 needsMipmap:(char)a3;
- (id)newRadianceTextureForEnvironmentTexture:(id)a0 engineContext:(struct __C3DEngineContext { } *)a1 cpuAccessible:(char)a2 commandBuffer:(id)a3;
...
- (id)renderResourceForProgramDesc:(struct { struct __C3DFXMetalProgram *x0; struct __C3DMaterial *x1; struct __C3DGeometry *x2; struct __C3DFXPass *x3; struct __C3DFXPass *x4; struct __C3DBlendStates *x5; struct __C3DNode *x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; id x11; unsigned long long x12; unsigned char x13; unsigned char x14; id x15; struct { unsigned char x0; id /* block */ x1; } x16; unsigned long long x17; })a0 renderPassDescriptor:(id)a1;
