...
- (void)setupFinalMeshFromBaseMeshWithInfo:(struct { char x0; char x1; char x2; char x3; })a0;
- (void)setupFinalMeshFromMeshlessBaseGeometryWithInfo:(struct { char x0; char x1; char x2; char x3; })a0;
- (void)setupInitialBuffersWithBasePositionSourceProvider:(id /* block */)a0 baseNormalSourceProvider:(id /* block */)a1 baseTangentSourceProvider:(id /* block */)a2 info:(struct { char x0; char x1; char x2; char x3; char x4; char x5; })a3;
