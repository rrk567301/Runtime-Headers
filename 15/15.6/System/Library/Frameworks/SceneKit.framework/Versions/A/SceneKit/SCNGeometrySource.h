...
+ (id)dataWithVector3Array:(const struct SCNVector3 { double x0; double x1; double x2; } *)a0 count:(long long)a1 bytesPerComponent:(long long *)a2;
+ (id)geometrySourceWithData:(id)a0 semantic:(id)a1 vectorCount:(long long)a2 floatComponents:(char)a3 componentsPerVector:(long long)a4 bytesPerComponent:(long long)a5 dataOffset:(long long)a6 dataStride:(long long)a7;
+ (id)geometrySourceWithNormals:(const struct SCNVector3 { double x0; double x1; double x2; } *)a0 count:(long long)a1;
+ (id)geometrySourceWithTextureCoordinates:(const struct CGPoint { double x0; double x1; } *)a0 count:(long long)a1;
+ (id)geometrySourceWithVertices:(const struct SCNVector3 { double x0; double x1; double x2; } *)a0 count:(long long)a1;
+ (id)geometrySourceWithColorData:(id)a0 colorSpace:(struct CGColorSpace { } *)a1 vectorCount:(long long)a2 floatComponents:(char)a3 componentsPerVector:(long long)a4 bytesPerComponent:(long long)a5 dataOffset:(long long)a6 dataStride:(long long)a7;
...
+ (id)geometrySourceWithColorComponents:(const float *)a0 count:(long long)a1 hasAlpha:(char)a2 colorSpace:(struct CGColorSpace { } *)a3;
...
- (id)initWithData:(id)a0 semantic:(id)a1 colorSpace:(struct CGColorSpace { } *)a2 vectorCount:(long long)a3 floatComponents:(char)a4 componentsPerVector:(long long)a5 bytesPerComponent:(long long)a6 dataOffset:(long long)a7 dataStride:(long long)a8;
...
- (void)set_encodeDataAsHalf:(char)a0;
