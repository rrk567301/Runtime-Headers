...
- (void)applyForce:(struct SCNVector3 { double x0; double x1; double x2; })a0 atPosition:(struct SCNVector3 { double x0; double x1; double x2; })a1 impulse:(char)a2;
- (void)applyForce:(struct SCNVector3 { double x0; double x1; double x2; })a0 impulse:(char)a1;
- (void)applyTorque:(struct SCNVector4 { double x0; double x1; double x2; double x3; })a0 impulse:(char)a1;
- (void)clearAllForces;
