@class NSString, NSArray, NSColor, SCNOrderedDictionary, SCNGeometry, NSDictionary, NSMutableDictionary;
...
@interface SCNParticleSystem : NSObject <NSCopying, NSSecureCoding, SCNAnimatable> {
    ...
    struct SCNVector3 { double x; double y; double z; } _emittingDirection;
    struct SCNVector3 { double x; double y; double z; } _orientationDirection;
    struct SCNVector3 { double x; double y; double z; } _acceleration;
    ...
    struct SCNVector4 { double x; double y; double z; double w; } _particleColorVariation;
...
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } emittingDirection;
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } orientationDirection;
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } acceleration;
...
@property (nonatomic) struct SCNVector4 { double x0; double x1; double x2; double x3; } particleColorVariation;
...
@property (nonatomic, getter=isBlackPassEnabled) char blackPassEnabled;
@property (nonatomic) long long orientationMode;
@property (nonatomic) long long sortingMode;
@property (nonatomic, getter=isLightingEnabled) char lightingEnabled;
...
- (void)setPhysicsCollisionsEnabled:(char)a0;
- (void)setReferenceName:(id)a0;
- (void)setSoftParticlesEnabled:(char)a0;
