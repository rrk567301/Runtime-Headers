...
+ (char)_shouldCacheWithOptions:(id)a0;
...
- (char)_appendToEntries:(id)a0 entriesWithType:(unsigned long long)a1 passingTest:(id /* block */)a2 entryObjectConstructor:(id /* block */)a3;
