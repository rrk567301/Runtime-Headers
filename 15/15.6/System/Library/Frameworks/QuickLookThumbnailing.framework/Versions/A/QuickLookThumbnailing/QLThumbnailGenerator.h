...
- (id)init;
- (void).cxx_destruct;
- (char)canGenerateThumbnailsForContentType:(id)a0 atSize:(struct CGSize { double x0; double x1; })a1;
...
- (char)__finishRequestIfInvalid:(id)a0;
- (char)__finishRequestIfNeeded:(id)a0;
...
- (char)__requestWithUUIDIsStillRunning:(id)a0;
...
- (char)_cancelRequestIfNeeded:(id)a0;
...
- (char)_finishRequestIfInvalid:(id)a0;
- (char)_finishRequestIfNeeded:(id)a0;
- (void)_finishRequestWithoutError:(id)a0;
- (void)_handleThumbnailGenerationCompletionWithUUID:(id)a0 images:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 iconFlavor:(int)a4 thumbnailType:(long long)a5 clientShouldTakeOwnership:(char)a6 error:(id)a7;
- (char)_isBuildingBatch;
...
- (void)_prepareThumbnailRequestForQueueOrSending:(id)a0 synchronous:(char)a1;
- (void)_queueIconGenerationForRequestIfNeeded:(id)a0;
- (char)_queueThumbnailGenerationForRequestIfNeeded:(id)a0;
- (void)_queueThumbnailRequest:(id)a0;
- (char)_requestRepresentationTypeIsMoreRepresentative:(id)a0 thanType:(long long)a1;
...
- (void)didGenerateThumbnailForRequestWithUUID:(id)a0 images:(id)a1 metadata:(id)a2 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 iconFlavor:(int)a4 thumbnailType:(long long)a5 clientShouldTakeOwnership:(char)a6;
...
- (void)saveBestRepresentationForRequest:(id)a0 toFileAtURL:(id)a1 asContentType:(id)a2 allowingThumbnailDownloads:(char)a3 completionHandler:(id /* block */)a4;
- (void)saveBestRepresentationForRequest:(id)a0 toFileAtURL:(id)a1 asContentType:(id)a2 completionHandler:(id /* block */)a3;
- (void)saveBestRepresentationForRequest:(id)a0 toFileAtURL:(id)a1 withContentType:(id)a2 allowingThumbnailDownloads:(char)a3 completionHandler:(id /* block */)a4;
- (void)saveBestRepresentationForRequest:(id)a0 toFileAtURL:(id)a1 withContentType:(id)a2 completionHandler:(id /* block */)a3;
- (void)saveBestRepresentationForRequest:(id)a0 toFileHandle:(id)a1 asContentType:(id)a2 allowingThumbnailDownloads:(char)a3 completionHandler:(id /* block */)a4;
- (void)saveBestRepresentationForRequest:(id)a0 toFileHandle:(id)a1 withContentType:(id)a2 allowingThumbnailDownloads:(char)a3 completionHandler:(id /* block */)a4;
