...
- (char)supportsGradientForSourceIndex:(unsigned long long)a0;
...
- (id)encodeToCommandBuffer:(id)a0 sourceArrays:(id)a1 resultState:(id *)a2 outputStateIsTemporary:(char)a3;
...
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 destinationArray:(id)a3;
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 resultState:(id)a3 destinationArray:(id)a4 kernelDAGObject:(id)a5;
