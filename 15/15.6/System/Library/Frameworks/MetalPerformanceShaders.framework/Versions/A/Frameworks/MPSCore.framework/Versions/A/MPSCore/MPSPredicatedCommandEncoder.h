...
@interface MPSPredicatedCommandEncoder : NSObject <MTLComputeCommandEncoder> {
    ...
    struct UserBufferBindingData_s { id<MTLBuffer> userBoundBuffer; char userBoundBuffer_set; void *userBoundBytes; unsigned long long userBoundBytes_length; char userBoundBytes_set; unsigned long long userBoundOffset; } _userBinding1;
    struct UserBufferBindingData_s { id<MTLBuffer> userBoundBuffer; char userBoundBuffer_set; void *userBoundBytes; unsigned long long userBoundBytes_length; char userBoundBytes_set; unsigned long long userBoundOffset; } _userBinding2;
    struct UserBufferBindingData_s { id<MTLBuffer> userBoundBuffer; char userBoundBuffer_set; void *userBoundBytes; unsigned long long userBoundBytes_length; char userBoundBytes_set; unsigned long long userBoundOffset; } _userBinding3;
}
