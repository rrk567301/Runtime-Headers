...
@property (readonly, nonatomic) char isFullyConnected;
@property (readonly, nonatomic) char isConvolutionTranspose;

- (void)dealloc;
- (id)initWithKernelWidth:(unsigned long long)a0 kernelHeight:(unsigned long long)a1 inputFeatureChannels:(unsigned long long)a2 outputFeatureChannels:(unsigned long long)a3 strideInPixelsX:(unsigned long long)a4 strideInPixelsY:(unsigned long long)a5 groups:(unsigned long long)a6 dilationRateX:(unsigned long long)a7 dilationRateY:(unsigned long long)a8 channelMultiplier:(unsigned long long)a9 subPixelScaleFactor:(unsigned long long)a10 isFullyConnected:(char)a11 isConvolutionTranspose:(char)a12 fusedNeuronDescriptor:(id)a13;
