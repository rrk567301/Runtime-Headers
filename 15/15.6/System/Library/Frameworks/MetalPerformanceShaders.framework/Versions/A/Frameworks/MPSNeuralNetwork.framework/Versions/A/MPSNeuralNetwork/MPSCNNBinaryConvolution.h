...
- (void)createBuffersFromkernelWeights:(const unsigned int *)a0 inputBiasTerms:(const float *)a1 inputScaleTerms:(const float *)a2 outputBiasTerms:(const float *)a3 outputScaleTerms:(const float *)a4 useHalfPrecision:(char)a5;
