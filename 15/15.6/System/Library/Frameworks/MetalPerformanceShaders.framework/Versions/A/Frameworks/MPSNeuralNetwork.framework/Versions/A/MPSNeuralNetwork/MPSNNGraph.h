...
@property (nonatomic) char outputStateIsTemporary;
@property (retain, nonatomic) id<MPSImageAllocator> destinationImageAllocator;
@property (nonatomic) unsigned long long format;
@property (readonly, nonatomic) char resultImageIsNeeded;
...
+ (id)graphWithDevice:(id)a0 resultImage:(id)a1 resultImageIsNeeded:(char)a2;
+ (id)graphWithDevice:(id)a0 resultImages:(id)a1 resultsAreNeeded:(char *)a2;
...
- (id)initWithDevice:(id)a0 resultImage:(id)a1 resultImageIsNeeded:(char)a2;
- (id)initWithDevice:(id)a0 resultImages:(id)a1 resultsAreNeeded:(char *)a2;
