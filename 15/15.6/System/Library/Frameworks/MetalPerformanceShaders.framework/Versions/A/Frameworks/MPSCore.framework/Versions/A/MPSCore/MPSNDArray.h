...
- (void)copyDataWithCommandBuffer:(id)a0 images:(id)a1 offset:(struct MPSImageCoordinate { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a2 imageToArray:(char)a3;
...
- (id)initWithBufferImpl:(id)a0 offset:(unsigned long long)a1 descriptor:(id)a2 isForNDArrayAlias:(char)a3 isUserBuffer:(char)a4;
- (id)initWithDevice:(id)a0 descriptor:(id)a1 isTextureBacked:(char)a2;
