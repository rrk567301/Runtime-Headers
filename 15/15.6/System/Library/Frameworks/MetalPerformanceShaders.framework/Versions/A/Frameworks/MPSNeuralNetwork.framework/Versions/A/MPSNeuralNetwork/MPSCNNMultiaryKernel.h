...
- (id)encodeToCommandBuffer:(id)a0 sourceImages:(id)a1 destinationState:(id *)a2 destinationStateIsTemporary:(char)a3;
...
- (id)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceImages:(id)a2 destinationState:(id *)a3 destinationStateIsTemporary:(char)a4;
