...
@property (nonatomic) char applyGradientClipping;
...
+ (id)optimizerDescriptorWithLearningRate:(float)a0 gradientRescale:(float)a1 applyGradientClipping:(char)a2 gradientClipMax:(float)a3 gradientClipMin:(float)a4 regularizationType:(unsigned long long)a5 regularizationScale:(float)a6;

- (id)initWithLearningRate:(float)a0 gradientRescale:(float)a1 applyGradientClipping:(char)a2 gradientClipMax:(float)a3 gradientClipMin:(float)a4 regularizationType:(unsigned long long)a5 regularizationScale:(float)a6;
