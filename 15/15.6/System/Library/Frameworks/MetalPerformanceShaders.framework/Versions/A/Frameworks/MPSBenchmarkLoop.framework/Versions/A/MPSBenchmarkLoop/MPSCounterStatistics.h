...
@interface MPSCounterStatistics : NSObject {
    ...
    char _workloadEcoderRunningStatsValid;
...
- (id)initWithCounters:(id)a0 withExtraRequestedCounter:(id)a1 forWorkload:(id)a2 userSpecifiedIterations:(char)a3 includingBlitSamples:(char)a4;
- (id)initializeWithPassList:(id)a0 numberOfEncodersInCurrentWorkload:(unsigned long long)a1 numEncodesPerCommandBuffer:(unsigned long long)a2 extraRequestedCounter:(id)a3 userSpecifiedIterations:(char)a4 vendor:(unsigned long long)a5 useGRC:(char)a6;
