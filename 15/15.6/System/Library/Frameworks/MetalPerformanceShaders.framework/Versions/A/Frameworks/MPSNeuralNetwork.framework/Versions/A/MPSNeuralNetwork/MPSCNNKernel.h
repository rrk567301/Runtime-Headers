...
@property (readonly, nonatomic) char isBackwards;
@property (readonly, nonatomic) char isStateModified;
...
- (id)encodeBatchToCommandBuffer:(id)a0 sourceImages:(id)a1 sourceStates:(id)a2 destinationStates:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeBatchToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceImages:(id)a2 destinationStates:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeBatchToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceImages:(id)a2 sourceStates:(id)a3 destinationStates:(id *)a4 destinationStateIsTemporary:(char)a5;
...
- (id)encodeToCommandBuffer:(id)a0 sourceImage:(id)a1 sourceState:(id)a2 destinationState:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceImage:(id)a2 destinationState:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceImage:(id)a2 sourceState:(id)a3 destinationState:(id *)a4 destinationStateIsTemporary:(char)a5;
