...
@property (readonly, nonatomic) char isSecondarySourceFilter;

+ (id)nodeWithSourceGradient:(id)a0 sourceImage:(id)a1 gradientState:(id)a2 isSecondarySourceFilter:(char)a3;

- (id)initWithGradientImages:(id)a0 forwardFilter:(id)a1 isSecondarySourceFilter:(char)a2;
- (id)initWithSourceGradient:(id)a0 sourceImage:(id)a1 gradientState:(id)a2 isSecondarySourceFilter:(char)a3;
