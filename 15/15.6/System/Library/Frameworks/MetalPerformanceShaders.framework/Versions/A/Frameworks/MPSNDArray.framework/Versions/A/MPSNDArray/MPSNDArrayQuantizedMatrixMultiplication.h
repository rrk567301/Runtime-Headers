...
+ (long long)getDQuantMinValIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
+ (long long)getDQuantScaleIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
+ (long long)getLUTIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
...
+ (long long)getMinValIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
...
+ (long long)getScaleIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
+ (long long)getZeroPointIndexWithLeftQuantizationDescriptor:(id)a0 rightQuantizationDescriptor:(id)a1 isForLeft:(char)a2;
+ (char)supportsDestinationQuantizationWithDescriptor:(id)a0 device:(void *)a1;
+ (char)supportsSourceQuantizationWithDescriptor:(id)a0 atIndex:(unsigned long long)a1 device:(void *)a2;
