...
- (char)encodeToCommandBuffer:(id)a0 inPlacePrimaryTexture:(id *)a1 secondaryTexture:(id)a2 fallbackCopyAllocator:(id /* block */)a3;
- (char)encodeToCommandBuffer:(id)a0 primaryTexture:(id)a1 inPlaceSecondaryTexture:(id *)a2 fallbackCopyAllocator:(id /* block */)a3;
