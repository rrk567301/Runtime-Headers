...
@property (nonatomic) char serializeWeightsAndBiases;
...
- (id)initWithDevice:(id)a0 weights:(id)a1 convolutionTranspose:(char)a2;
- (id)initWithDevice:(id)a0 weights:(id)a1 fullyConnected:(char)a2;
- (void)initialize:(id)a0 convDesc:(id)a1 weights:(void *)a2 dataType:(unsigned int)a3 weightsLayout:(unsigned int)a4 fullyConnected:(char)a5 convolutionTranspose:(char)a6 preferredWeightsDataType:(unsigned int)a7;
- (void)initialize:(id)a0 weights:(id)a1 fullyConnected:(char)a2 convolutionTranspose:(char)a3;
