...
@property (nonatomic) char propagateFullRecurrentRows;
...
@property (nonatomic) char storeAllIntermediateStates;
@property (nonatomic) char recurrentOutputIsTemporary;
@property (nonatomic) char trainingStateIsTemporary;
@property (nonatomic) char accumulateWeightGradients;
...
- (void)encodeCopyWeightsToCommandBuffer:(id)a0 weights:(id)a1 matrixId:(unsigned long long)a2 matrix:(id)a3 copyFromWeightsToMatrix:(char)a4 matrixOffset:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a5;
...
- (id)recurrentStateForBatchSize:(unsigned long long)a0 forGradientPass:(char)a1;
- (id)temporaryRecurrentStateForCommandBuffer:(id)a0 batchSize:(unsigned long long)a1 forGradientPass:(char)a2;
