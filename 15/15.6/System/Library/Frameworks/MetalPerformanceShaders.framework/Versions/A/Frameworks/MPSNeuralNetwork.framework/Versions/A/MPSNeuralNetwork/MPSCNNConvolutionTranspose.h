...
- (id)encodeBatchToCommandBuffer:(id)a0 sourceImages:(id)a1 destinationStates:(id *)a2 destinationStateIsTemporary:(char)a3;
...
- (id)encodeBatchToCommandBuffer:(id)a0 sourceImages:(id)a1 convolutionGradientStates:(id)a2 destinationStates:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeToCommandBuffer:(id)a0 sourceImage:(id)a1 convolutionGradientState:(id)a2 destinationState:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeToCommandBuffer:(id)a0 sourceImage:(id)a1 destinationState:(id *)a2 destinationStateIsTemporary:(char)a3;
- (id)exportWeightsAndBiasesWithCommandBuffer:(id)a0 resultStateCanBeTemporary:(char)a1;
