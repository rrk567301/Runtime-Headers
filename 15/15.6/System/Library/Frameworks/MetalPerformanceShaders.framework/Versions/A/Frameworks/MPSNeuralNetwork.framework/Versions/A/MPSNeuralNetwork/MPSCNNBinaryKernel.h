...
- (id)encodeBatchToCommandBuffer:(id)a0 primaryImages:(id)a1 secondaryImages:(id)a2 destinationStates:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeBatchToCommandEncoder:(id)a0 commandBuffer:(id)a1 primaryImages:(id)a2 secondaryImages:(id)a3 destinationStates:(id *)a4 destinationStateIsTemporary:(char)a5;
...
- (id)encodeToCommandBuffer:(id)a0 primaryImage:(id)a1 secondaryImage:(id)a2 destinationState:(id *)a3 destinationStateIsTemporary:(char)a4;
...
- (id)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 primaryImage:(id)a2 secondaryImage:(id)a3 destinationState:(id *)a4 destinationStateIsTemporary:(char)a5;
