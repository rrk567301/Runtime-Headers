...
@interface MPSRayIntersector : MPSKernel <NSSecureCoding, NSCopying> {
    ...
    char _useMultipleThreadsPerRay;
...
- (void)setUseMultipleThreadsPerRay:(char)a0;
