...
- (char)PrepareAndLoadData:(id)a0 dataType:(unsigned int)a1 weightsLayout:(unsigned int)a2 weights:(const void *)a3 biases:(const float *)a4 quantizationType:(int)a5 ranges:(const void *)a6 lookUpTable:(const float *)a7 convertFloat32Weights:(char)a8;
...
- (id)initWithDevice:(id)a0 weights:(id)a1 fullyConnected:(char)a2 convolutionTranspose:(char)a3;
