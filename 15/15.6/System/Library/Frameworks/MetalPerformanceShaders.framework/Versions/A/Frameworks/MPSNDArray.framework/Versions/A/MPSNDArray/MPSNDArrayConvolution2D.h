...
@property (nonatomic) char logNextAutoTuneParams;
...
+ (char)supportsPostfixForDevice:(void *)a0;
+ (char)supportsPostfixForDevice:(void *)a0 convolutionDescriptor:(id)a1 sourceTensorDescriptor:(struct MPSNDArrayDataTensorDescriptor { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned int x5; } *)a2 destinationTensorDescriptor:(struct MPSNDArrayDataTensorDescriptor { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned int x5; } *)a3 weightsTensorDescriptor:(struct MPSNDArrayWeightsTensorDescriptor { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned int x5; } *)a4;
+ (char)supportsPrefixForDevice:(void *)a0;
