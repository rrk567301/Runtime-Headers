...
- (id)initWithDevice:(id)a0 conversion:(struct CGColorConversionInfo { } *)a1 functionName:(id)a2 sourceRange:(const struct { } *)a3 options:(unsigned long long)a4 error:(id *)a5;
