...
- (void)didShareImageData:(id)a0 confirmDataIsValidTIFFData:(char)a1;
- (id)initWithItems:(id)a0 includeEditorServices:(char)a1 client:(struct WebSharingServicePickerClient { void /* function */ **x0; id x1; } *)a2 style:(long long)a3;
