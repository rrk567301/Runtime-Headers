...
@property char shouldClipToVisibleRect;
@property char shouldExpandToViewHeightForAutoLayout;
@property (readonly, getter=isUsingUISideCompositing) char usingUISideCompositing;
...
@property char allowsBackForwardNavigationGestures;
...
- (void)_setIgnoresNonWheelMouseEvents:(char)a0;
...
- (void)_dismissContentRelativeChildWindowsWithAnimation:(char)a0;
...
- (char)canChangeFrameLayout:(struct OpaqueWKFrame { } *)a0;
...
- (void)setAllowsLinkPreview:(char)a0;
