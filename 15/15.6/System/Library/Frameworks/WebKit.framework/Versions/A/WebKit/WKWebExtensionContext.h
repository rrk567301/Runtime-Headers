...
@property (nonatomic) char hasRequestedOptionalAccessToAllHosts;
@property (nonatomic) char hasAccessToPrivateData;
...
@property (readonly, nonatomic) char hasAccessToAllURLs;
@property (readonly, nonatomic) char hasAccessToAllHosts;
...
- (char)hasAccessToURL:(id)a0 inTab:(id)a1;
- (char)hasActiveUserGestureInTab:(id)a0;
- (char)hasInjectedContentForURL:(id)a0;
...
- (char)performCommandForEvent:(id)a0;
