...
- (char)webView:(id)a0 runJavaScriptConfirmPanelWithMessage:(id)a1 initiatedByFrame:(id)a2;
...
- (void)webView:(id)a0 setResizable:(char)a1;
- (void)webView:(id)a0 setStatusBarVisible:(char)a1;
- (void)webView:(id)a0 setStatusText:(id)a1;
- (void)webView:(id)a0 setToolbarsVisible:(char)a1;
...
- (char)webViewAreToolbarsVisible:(id)a0;
...
- (char)webViewIsResizable:(id)a0;
- (char)webViewIsStatusBarVisible:(id)a0;
