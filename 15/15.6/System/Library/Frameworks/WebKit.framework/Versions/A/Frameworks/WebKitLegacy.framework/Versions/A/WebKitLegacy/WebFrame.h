...
@property (readonly, nonatomic) char hasRichlyEditableDragCaret;
...
- (char)_allowsFollowingLink:(id)a0;
...
- (void)_drawRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 contentsOnly:(char)a1;
...
- (char)_getVisibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0;
- (struct OpaqueJSContext { } *)_globalContextForScriptWorld:(id)a0;
- (char)_hasSelection;
- (id)_initWithWebFrameView:(id)a0 webView:(id)a1;
- (void)_insertParagraphSeparatorInQuotedContent;
- (id)_internalLoadDelegate;
- (char)_isDescendantOfFrame:(id)a0;
...
- (void)_replaceSelectionWithFragment:(id)a0 selectReplacement:(char)a1 smartReplace:(char)a2 matchStyle:(char)a3;
- (void)_replaceSelectionWithMarkupString:(id)a0 baseURLString:(id)a1 selectReplacement:(char)a2 smartReplace:(char)a3;
- (void)_replaceSelectionWithNode:(id)a0 selectReplacement:(char)a1 smartReplace:(char)a2 matchStyle:(char)a3;
- (void)_replaceSelectionWithText:(id)a0 selectReplacement:(char)a1 smartReplace:(char)a2;
...
- (void)_setShouldCreateRenderers:(char)a0;
...
- (id)_stringByEvaluatingJavaScriptFromString:(id)a0 forceUserGesture:(char)a1;
...
- (void)setEnhancedAccessibility:(char)a0;
