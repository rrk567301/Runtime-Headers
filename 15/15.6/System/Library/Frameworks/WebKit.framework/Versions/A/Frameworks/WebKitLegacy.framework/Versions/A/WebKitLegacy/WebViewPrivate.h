...
@interface WebViewPrivate : NSObject {
    ...
    char _canCreateTouchBars;
    char _isUpdatingTextTouchBar;
    char _startedListeningToCustomizationEvents;
    char _isCustomizingTouchBar;
    char _isDeferringTextTouchBarUpdates;
    char _needsDeferredTextTouchBarUpdate;
    ...
    char hasInitializedLookupObserver;
    ...
    char shouldMaintainInactiveSelection;
    char allowsUndo;
    ...
    struct WebScriptDebugDelegateImplementationCache { char didParseSourceExpectsBaseLineNumber; char exceptionWasRaisedExpectsHasHandlerFlag; void /* function */ *didParseSourceFunc; void /* function */ *failedToParseSourceFunc; void /* function */ *exceptionWasRaisedFunc; } scriptDebugDelegateImplementations;
