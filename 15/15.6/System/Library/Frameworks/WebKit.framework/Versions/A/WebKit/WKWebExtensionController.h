...
@property (nonatomic, getter=_inTestingMode, setter=_setTestingMode:) char _testingMode;
...
- (char)loadExtensionContext:(id)a0 error:(id *)a1;
- (void)removeDataOfTypes:(id)a0 fromDataRecords:(id)a1 completionHandler:(id /* block */)a2;
- (char)unloadExtensionContext:(id)a0 error:(id *)a1;
