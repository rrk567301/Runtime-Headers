...
@interface WKWebsiteDataStore : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebsiteDataStore> { struct type { unsigned char __lx[528]; } data; } _websiteDataStore;
...
@property (nonatomic, setter=_setResourceLoadStatisticsEnabled:) char _resourceLoadStatisticsEnabled;
@property (nonatomic, setter=_setResourceLoadStatisticsDebugMode:) char _resourceLoadStatisticsDebugMode;
...
@property (nonatomic, setter=_setAllowsCellularAccess:) char _allowsCellularAccess;
@property (nonatomic, setter=_setProxyConfiguration:) NSDictionary *_proxyConfiguration;
@property (nonatomic, setter=_setAllowsTLSFallback:) char _allowsTLSFallback;
@property (nonatomic, setter=_setStorageSiteValidationEnabled:) char _storageSiteValidationEnabled;
...
+ (void)_setNetworkProcessSuspensionAllowedForTesting:(char)a0;
...
- (void)_fetchDataOfTypes:(id)a0 completionHandler:(id /* block */)a1;
...
- (char)_networkProcessHasEntitlementForTesting:(id)a0;
...
- (void)_runningOrTerminatingServiceWorkerCountForTesting:(id /* block */)a0;
...
- (void)_setPrivateClickMeasurementDebugModeEnabled:(char)a0;
- (void)_setPrivateClickMeasurementDebugModeEnabledForTesting:(char)a0;
...
- (void)_setThirdPartyCookieBlockingMode:(char)a0 onlyOnSitesWithoutUserInteraction:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_synthesizeAppIsBackground:(char)a0;
