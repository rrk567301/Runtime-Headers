...
- (id)_getRulesWithRuleIDs:(id)a0 errorMessage:(id *)a1;
...
- (void)getRulesWithRuleIDs:(id)a0 completionHandler:(id /* block */)a1;
- (id)initWithUniqueIdentifier:(id)a0 storageType:(BOOL)a1 directory:(id)a2 usesInMemoryDatabase:(char)a3;
