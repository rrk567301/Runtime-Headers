...
@interface WKURLSchemeTaskImpl : NSObject <WKObject, WKURLSchemeTaskPrivate> {
    struct ObjectStorage<WebKit::WebURLSchemeTask> { struct type { unsigned char __lx[552]; } data; } _urlSchemeTask;
}
...
@property (readonly, nonatomic) char _requestOnlyIfCached;
