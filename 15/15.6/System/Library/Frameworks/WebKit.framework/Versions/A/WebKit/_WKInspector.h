...
@property (readonly, nonatomic) char isFront;
@property (readonly, nonatomic) char isProfilingPage;
@property (readonly, nonatomic) char isElementSelectionActive;
...
- (void)_openURLExternallyForTesting:(id)a0 useFrontendAPI:(char)a1;
