...
@interface WKWebView : NSView <WebViewImplDelegate, NSUserInterfaceValidations, NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSScrollViewSeparatorTrackingAdapter, WKShareSheetDelegate, WTWritingToolsDelegate, NSTextInputTraits> {
    ...
    struct optional<signed char> { union { char __null_state_; char __val_; } ; BOOL __engaged_; } _resolutionForShareSheetImmediateCompletionForTesting;
    ...
    char _writingToolsTextReplacementsFinished;
    ...
    char _didAccessBackForwardList;
    char _dontResetTransientActivationAfterRunJavaScript;
...
@property (readonly, nonatomic) char _isContentFromNetwork;
...
@property (readonly, nonatomic) char _isBlockedByScreenTime;
...
@property (readonly, nonatomic, getter=_isPlayingAudio) char _playingAudio;
@property (nonatomic, setter=_setUserContentExtensionsEnabled:) char _userContentExtensionsEnabled;
...
@property (nonatomic, getter=_isEditable, setter=_setEditable:) char _editable;
@property (readonly, nonatomic) char _negotiatedLegacyTLS;
...
@property (nonatomic, setter=_setAllowsRemoteInspection:) char _allowsRemoteInspection;
@property (copy, nonatomic, setter=_setRemoteInspectionNameOverride:) NSString *_remoteInspectionNameOverride;
@property (readonly, nonatomic) char _isBeingInspected;
...
@property (nonatomic, setter=_setAddsVisitedLinks:) char _addsVisitedLinks;
...
@property (readonly, nonatomic, getter=_isShowingNavigationGestureSnapshot) char _showingNavigationGestureSnapshot;
...
@property (nonatomic, setter=_setBackgroundExtendsBeyondPage:) char _backgroundExtendsBeyondPage;
...
@property (nonatomic, setter=_setPaginationBehavesLikeColumns:) char _paginationBehavesLikeColumns;
...
@property (nonatomic, setter=_setPaginationLineGridEnabled:) char _paginationLineGridEnabled;
...
@property (readonly, nonatomic, getter=_isDisplayingPDF) char _displayingPDF;
@property (readonly, nonatomic, getter=_isDisplayingStandaloneImageDocument) char _displayingStandaloneImageDocument;
@property (readonly, nonatomic, getter=_isDisplayingStandaloneMediaDocument) char _displayingStandaloneMediaDocument;
@property (nonatomic, setter=_setScrollPerformanceDataCollectionEnabled:) char _scrollPerformanceDataCollectionEnabled;
@property (readonly, nonatomic) NSArray *_scrollPerformanceData;
@property (nonatomic, getter=_allowsMediaDocumentInlinePlayback, setter=_setAllowsMediaDocumentInlinePlayback:) char _allowsMediaDocumentInlinePlayback;
@property (nonatomic, setter=_setFullscreenDelegate:) id<_WKFullscreenDelegate> _fullscreenDelegate;
@property (readonly, nonatomic) char _isInFullscreen;
...
@property (readonly, nonatomic) char _isSuspended;
@property (readonly, nonatomic) char _canTogglePictureInPicture;
@property (readonly, nonatomic) char _canToggleInWindow;
@property (readonly, nonatomic) char _canEnterFullscreen;
@property (readonly, nonatomic) char _isPictureInPictureActive;
@property (readonly, nonatomic) char _isInWindowActive;
@property (nonatomic, setter=_setCanUseCredentialStorage:) char _canUseCredentialStorage;
...
@property (readonly, nonatomic) char _allowsAnyAnimationToPlay;
@property (readonly, nonatomic) NSURL *_requiredWebExtensionBaseURL;
@property (readonly, nonatomic) char _hasActiveNowPlayingSession;
@property (nonatomic, setter=_setDontResetTransientActivationAfterRunJavaScript:) char _dontResetTransientActivationAfterRunJavaScript;
...
@property (readonly, nonatomic) char _wirelessVideoPlaybackDisabled;
@property (nonatomic, setter=_setScrollingUpdatesDisabledForTesting:) char _scrollingUpdatesDisabledForTesting;
...
@property (readonly, nonatomic) char _hasServiceWorkerBackgroundActivityForTesting;
@property (readonly, nonatomic) char _hasServiceWorkerForegroundActivityForTesting;
@property (readonly, nonatomic) char _isLoggerEnabledForTesting;
@property (readonly, nonatomic) char _hasAccessibilityActivityForTesting;
...
@property (readonly, nonatomic) char _hasActiveVideoForControlsManager;
@property (nonatomic, setter=_setIgnoresNonWheelEvents:) char _ignoresNonWheelEvents;
@property (nonatomic, setter=_setIgnoresMouseMoveEvents:) char _ignoresMouseMoveEvents;
@property (nonatomic, setter=_setClipsToVisibleRect:) char _clipsToVisibleRect;
...
@property (nonatomic, setter=_setAutomaticallyAdjustsContentInsets:) char _automaticallyAdjustsContentInsets;
@property (nonatomic, setter=_setWindowOcclusionDetectionEnabled:) char _windowOcclusionDetectionEnabled;
@property (readonly, nonatomic) long long _spellCheckerDocumentTag;
@property (nonatomic, setter=_setShouldExpandContentToViewHeightForAutoLayout:) char _shouldExpandContentToViewHeightForAutoLayout;
...
@property (nonatomic, setter=_setAlwaysShowsHorizontalScroller:) char _alwaysShowsHorizontalScroller;
@property (nonatomic, setter=_setAlwaysShowsVerticalScroller:) char _alwaysShowsVerticalScroller;
...
@property (nonatomic, setter=_setIgnoresAllEvents:) char _ignoresAllEvents;
@property (nonatomic, setter=_setUsePlatformFindUI:) char _usePlatformFindUI;
@property (readonly, nonatomic) double minimumMagnification;
@property (nonatomic, setter=_setWantsMediaPlaybackControlsView:) char _wantsMediaPlaybackControlsView;
@property (readonly, nonatomic) id _mediaPlaybackControlsView;
@property (readonly, nonatomic) char _hasActiveVideoForControlsManager;
@property (readonly, nonatomic) char _shouldRequestCandidates;
@property (readonly, nonatomic) char _allowsInlinePredictions;
@property (readonly, nonatomic) NSMenu *_activeMenu;
@property (readonly, nonatomic) char _secureEventInputEnabledForTesting;
@property (nonatomic, setter=_setHasActiveNowPlayingSession:) char _hasActiveNowPlayingSession;
...
@property (nonatomic) char allowsLinkPreview;
...
+ (char)_willUpgradeToHTTPS:(id)a0;
+ (char)automaticallyNotifiesObserversOfUnderPageBackgroundColor;
+ (char)handlesURLScheme:(id)a0;
...
- (void)_setDrawsTransparentBackground:(char)a0;
- (char)_web_superPerformKeyEquivalent:(id)a0;
- (void)_dataTaskWithRequest:(id)a0 runAtForegroundPriority:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_addAppHighlightInNewGroup:(char)a0 originatedInApp:(char)a1;
- (void)_addEventAttributionWithSourceID:(unsigned char)a0 destinationURL:(id)a1 sourceDescription:(id)a2 purchaser:(id)a3 reportEndpoint:(id)a4 optionalNonce:(id)a5 applicationBundleID:(id)a6 ephemeral:(char)a7;
...
- (char)_allMediaPresentationsClosed;
- (char)_allowAnimationControls;
...
- (char)_canChangeFrameLayout:(id)a0;
...
- (void)_didUpdateCandidateListVisibility:(char)a0;
...
- (void)_enterInWindow;
- (void)_evaluateJavaScript:(id)a0 asAsyncFunction:(char)a1 withSourceURL:(id)a2 withArguments:(id)a3 forceUserGesture:(char)a4 inFrame:(id)a5 inWorld:(id)a6 completionHandler:(id /* block */)a7;
...
- (void)_evaluateJavaScript:(id)a0 withSourceURL:(id)a1 inFrame:(id)a2 inContentWorld:(id)a3 withUserGesture:(char)a4 completionHandler:(id /* block */)a5;
...
- (char)_hasFlagsChangedEventMonitorForTesting;
- (char)_hasSleepDisabler;
- (void)_hideFindUI;
- (char)_holdWindowResizeSnapshotIfNeeded;
...
- (void)_internalDoAfterNextPresentationUpdate:(id /* block */)a0 withoutWaitingForPainting:(char)a1 withoutWaitingForAnimatedResize:(char)a2;
...
- (id)_loadRequest:(id)a0 shouldOpenExternalURLs:(char)a1;
...
- (void)_loadServiceWorker:(id)a0 usingModules:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)_recalculateViewportSizesWithMinimumViewportInset:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a0 maximumViewportInset:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1 throwOnInvalidInput:(char)a2;
...
- (struct optional<signed char> { union { char x0; char x1; } x0; BOOL x1; })_resolutionForShareSheetImmediateCompletionForTesting;
- (void)_restoreAndScrollToAppHighlight:(id)a0;
- (void)_restoreAppHighlights:(id)a0;
- (void)_restoreFromSessionStateData:(id)a0;
- (id)_restoreSessionState:(id)a0 andNavigate:(char)a1;
...
- (void)_setConnectedToHardwareConsoleForTesting:(char)a0;
- (void)_setContinuousSpellCheckingEnabledForTesting:(char)a0;
...
- (void)_setGamepadsRecentlyAccessed:(char)a0;
- (void)_setGrammarCheckingEnabledForTesting:(char)a0;
...
- (void)_setPrivateClickMeasurementOverrideTimerForTesting:(char)a0 completionHandler:(id /* block */)a1;
- (void)_setSelectedColorForColorPicker:(id)a0;
- (void)_setShareSheetCompletesImmediatelyWithResolutionForTesting:(char)a0;
- (void)_setShouldSuppressFirstResponderChanges:(char)a0;
- (void)_setStatisticsCrossSiteLoadWithLinkDecorationForTesting:(id)a0 withToHost:(id)a1 withWasFiltered:(char)a2 withCompletionHandler:(id /* block */)a3;
- (void)_setSystemAudioCaptureState:(long long)a0 completionHandler:(id /* block */)a1;
- (void)_setSystemCanPromptForGetDisplayMediaForTesting:(char)a0;
- (void)_setSystemPreviewCompletionHandlerForLoadTesting:(id /* block */)a0;
- (void)_setThrottleStateForTesting:(int)a0;
- (void)_setTopContentInset:(double)a0 immediate:(char)a1;
- (void)_setupPageConfiguration:(void *)a0 withPool:(void *)a1;
- (char)_shouldBypassGeolocationPromptForTesting;
...
- (char)_tryClose;
- (char)_tryToSwipeWithEvent:(id)a0 ignoringPinnedState:(char)a1;
...
- (void)_web_didPerformDragOperation:(char)a0;
- (void)_web_didRemoveMediaControlsManager;
- (void)_web_dismissContentRelativeChildWindows;
- (void)_web_dismissContentRelativeChildWindowsWithAnimation:(char)a0;
...
- (char)_web_hasActiveIntelligenceTextEffects;
...
- (void)intelligenceTextEffectCoordinator:(id)a0 updateTextVisibilityForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 visible:(char)a2 identifier:(id)a3 completion:(id /* block */)a4;
...
- (void)setAllMediaPlaybackSuspended:(char)a0 completionHandler:(id /* block */)a1;
