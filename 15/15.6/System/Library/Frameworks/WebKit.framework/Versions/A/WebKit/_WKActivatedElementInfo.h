...
@interface _WKActivatedElementInfo : NSObject {
    ...
    char _animatedImage;
    char _isImage;
    char _isUsingAlternateURLForImage;
}
...
@property (readonly, nonatomic) char _isImage;
@property (readonly, nonatomic) char _isUsingAlternateURLForImage;
