...
@property (readonly, nonatomic) char useDefaultHighlight;
...
- (char)revealContext:(id)a0 shouldUseDefaultHighlightForItem:(id)a1;
- (void)revealContext:(id)a0 stopHighlightingItem:(id)a1;
- (id)initWithHighlightRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 useDefaultHighlight:(char)a1 attributedString:(id)a2 clearTextIndicatorCallback:(void *)a3;
