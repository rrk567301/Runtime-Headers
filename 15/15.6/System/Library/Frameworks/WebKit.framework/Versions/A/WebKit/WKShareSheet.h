...
+ (char)applyQuarantineSandboxAndDownloadFlagsToFileAtPath:(id)a0;
+ (id)createRandomSharingDirectoryForFile:(id)a0;
+ (char)setQuarantineInformationForFilePath:(id)a0;
...
- (char)dismissIfNeededWithReason:(unsigned char)a0;
