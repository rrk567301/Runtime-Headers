...
@property (readonly, nonatomic) char _isLocalFrame;
@property (readonly, nonatomic) char _isFocused;
@property (readonly, nonatomic) char _errorOccurred;
@property (readonly, copy, nonatomic) NSString *_title;
@property (readonly, nonatomic) char _isScrollable;
...
@property (readonly, nonatomic, getter=isMainFrame) char mainFrame;
