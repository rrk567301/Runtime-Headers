...
@property (nonatomic, readonly) char hasActiveEffects;
...
- (void)requestReplacementWithProcessedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 finished:(char)a1 characterDelta:(long long)a2 operation:(void (^)(void (^)(void)))a3 completion:(void (^)(void))a4;
- (void)restoreSelectionAcceptedReplacements:(char)a0 completion:(void (^)(void))a1;
