...
@property (nonatomic, getter=_isCookieStoragePartitioningEnabled, setter=_setCookieStoragePartitioningEnabled:) char _cookieStoragePartitioningEnabled;
...
+ (char)_isMetalDebugDeviceEnabledInGPUProcessForTesting;
+ (char)_isMetalShaderValidationEnabledInGPUProcessForTesting;
+ (char)_lockdownModeEnabledGloballyForTesting;
+ (id)_networkingProcessInfo;
+ (void)_setCaptivePortalModeEnabledGloballyForTesting:(char)a0;
+ (void)_setEnableMetalDebugDeviceInNewGPUProcessesForTesting:(char)a0;
+ (void)_setEnableMetalShaderValidationInNewGPUProcessesForTesting:(char)a0;
...
- (char)_requestWebProcessTermination:(int)a0;
- (id)_resumeDownloadFromData:(id)a0 websiteDataStore:(id)a1 path:(id)a2 originatingWebView:(id)a3;
- (void)_seedResourceLoadStatisticsForTestingWithFirstParty:(id)a0 thirdParty:(id)a1 shouldScheduleNotification:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)_setCanHandleHTTPSServerTrustEvaluation:(char)a0;
...
- (void)_setUseSeparateServiceWorkerProcess:(char)a0;
- (void)_setUsesOnlyHIDGamepadProviderForTesting:(char)a0;
