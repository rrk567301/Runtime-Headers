...
- (id)_accessibilityChildrenFromIndex:(unsigned long long)a0 maxCount:(unsigned long long)a1 returnPlatformElements:(char)a2;
...
- (id)_accessibilityHitTest:(struct CGPoint { double x0; double x1; })a0 returnPlatformElements:(char)a1;
...
- (char)accessibilityInsertText:(id)a0;
