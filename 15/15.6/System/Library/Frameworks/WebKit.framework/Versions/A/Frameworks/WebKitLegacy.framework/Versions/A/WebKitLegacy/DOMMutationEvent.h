...
- (void)initMutationEvent:(id)a0 :(char)a1 :(char)a2 :(id)a3 :(id)a4 :(id)a5 :(id)a6 :(unsigned short)a7;
- (void)initMutationEvent:(id)a0 canBubble:(char)a1 cancelable:(char)a2 relatedNode:(id)a3 prevValue:(id)a4 newValue:(id)a5 attrName:(id)a6 attrChange:(unsigned short)a7;
