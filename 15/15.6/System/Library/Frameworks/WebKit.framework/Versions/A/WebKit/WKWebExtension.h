...
@interface WKWebExtension : NSObject <WKObject> {
    struct ObjectStorage<WebKit::WebExtension> { struct type { unsigned char __lx[432]; } data; } _webExtension;
}

@property (readonly, nonatomic) void *_webExtension;
@property (readonly, nonatomic) char _hasServiceWorkerBackgroundContent;
@property (readonly, nonatomic) char _hasModularBackgroundContent;
@property (readonly, nonatomic) char _hasSidebar;
...
@property (readonly, nonatomic) char hasBackgroundContent;
@property (readonly, nonatomic) char hasPersistentBackgroundContent;
@property (readonly, nonatomic) char hasInjectedContent;
@property (readonly, nonatomic) char hasOptionsPage;
@property (readonly, nonatomic) char hasOverrideNewTabPage;
@property (readonly, nonatomic) char hasCommands;
@property (readonly, nonatomic) char hasContentModificationRules;
...
- (char)supportsManifestVersion:(double)a0;
