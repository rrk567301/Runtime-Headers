...
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)reloadIgnoringCache:(char)a0 userAgent:(id)a1 injectedScript:(id)a2 completionHandler:(id /* block */)a3;
- (void)createTabWithName:(id)a0 tabIconURL:(id)a1 sourceURL:(id)a2 completionHandler:(id /* block */)a3;
- (void)evaluateScript:(id)a0 frameURL:(id)a1 contextSecurityOrigin:(id)a2 useContentScriptContext:(char)a3 completionHandler:(id /* block */)a4;
