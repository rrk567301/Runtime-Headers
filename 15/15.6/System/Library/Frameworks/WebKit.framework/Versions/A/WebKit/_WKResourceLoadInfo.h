@class NSUUID, NSString, NSURL, NSDate, _WKFrameHandle;

@interface _WKResourceLoadInfo : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<API::ResourceLoadInfo> { struct type { unsigned char __lx[160]; } data; } _info;
}
...
@property (readonly, nonatomic) char loadedFromCache;
