...
- (id)currentForm;
- (id)documentSource;
- (char)elementDoesAutoComplete:(id)a0;
- (char)elementIsPassword:(id)a0;
...
- (id)searchForLabels:(id)a0 beforeElement:(id)a1 resultDistance:(unsigned long long *)a2 resultIsInCellAbove:(char *)a3;
