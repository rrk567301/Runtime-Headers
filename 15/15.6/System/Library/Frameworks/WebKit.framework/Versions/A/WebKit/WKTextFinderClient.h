...
- (void)replaceMatches:(id)a0 withString:(id)a1 inSelectionOnly:(char)a2 resultCollector:(id /* block */)a3;
- (void)scrollFindMatchToVisible:(id)a0;
- (void)selectFindMatch:(id)a0 completionHandler:(id /* block */)a1;
- (void)didFindStringMatchesWithRects:(const void *)a0 didWrapAround:(char)a1;
- (void)didGetImageForMatchResult:(void *)a0;
- (void)getImageForMatchResult:(id)a0 completionHandler:(id /* block */)a1;
- (id)initWithPage:(struct NakedRef<WebKit::WebPageProxy> { struct WebPageProxy *x0; })a0 view:(id)a1 usePlatformFindUI:(char)a2;
