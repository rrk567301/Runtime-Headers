...
@property (readonly, nonatomic) char isExclusion;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initExclusion:(char)a0 forAttribute:(id)a1 value:(id)a2;
- (id)initExclusion:(char)a0 forClass:(id)a1;
- (id)initExclusion:(char)a0 forElement:(id)a1;
