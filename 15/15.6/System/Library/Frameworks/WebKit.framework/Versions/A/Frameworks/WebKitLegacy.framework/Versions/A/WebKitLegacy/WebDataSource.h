...
+ (void)initialize;
+ (id)_repTypesAllowImageTypeOmission:(char)a0;
+ (Class)_representationClassForMIMEType:(id)a0 allowingPlugins:(char)a1;
...
- (void)_replaceSelectionWithArchive:(id)a0 selectReplacement:(char)a1;
- (id)_responseMIMEType;
- (void)_revertToProvisionalState;
- (void)_setAllowToBeMemoryMapped;
- (void)_setDeferMainResourceDataLoad:(char)a0;
