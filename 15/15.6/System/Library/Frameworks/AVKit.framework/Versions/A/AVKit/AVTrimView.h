...
- (char)_isTracking;
- (char)_isZooming;
- (char)canHandleEvent:(id)a0;
- (char)_canStartTracking;
- (char)_canZoom;
- (void)_fireStopTrackingTimer:(id)a0;
- (char)_isZoomed;
- (double)_maximumPossibleOffset;
- (unsigned long long)_partForLocation:(struct CGPoint { double x0; double x1; })a0 shouldJumpToLocation:(char *)a1;
- (void)_scroll:(id)a0;
...
- (void)_startTrackingWithPart:(unsigned long long)a0 location:(struct CGPoint { double x0; double x1; })a1 shouldJumpToLocation:(char)a2;
