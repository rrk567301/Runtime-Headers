...
@property (readonly, nonatomic) char hasDevicesWithErrors;
...
- (char)_addDevice:(id)a0 forMediaType:(id)a1 excludingMediaType:(id)a2 error:(id *)a3;
- (void)_addVideoDevice:(id)a0;
- (id)_addedDevicesWithConnectionsForMediaType:(id)a0;
- (char)_attemptToReAddDevice:(id)a0 error:(id *)a1;
- (id)_audioDevices;
