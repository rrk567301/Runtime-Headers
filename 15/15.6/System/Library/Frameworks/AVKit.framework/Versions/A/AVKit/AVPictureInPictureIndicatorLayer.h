...
- (id)initWithDisplayScale:(double)a0 placeholderImage:(struct CGImage { } *)a1 opaque:(char)a2 videoRectWhenPIPBegan:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
