...
+ (char)captureDevice:(id)a0 canBeUsedForInputSourceType:(unsigned long long)a1;

- (id)description;
- (unsigned long long)hash;
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithDevice:(id)a0 inputSource:(id)a1 type:(unsigned long long)a2 builtIn:(char)a3;
