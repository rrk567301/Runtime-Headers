...
@property (nonatomic) char shouldSkipForwardOrBackwardWhenTapped;
@property (nonatomic) char showsElapsedTime;
@property (nonatomic) char keepsExpandedKnobWithinBounds;
