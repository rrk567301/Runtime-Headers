...
- (char)_matchesConfiguration:(id)a0;
- (char)_matchesSize:(struct CGSize { double x0; double x1; })a0;
- (char)reconfigureWithConfiguration:(id)a0 error:(id *)a1;
- (char)reconfigureWithSizeInPixels:(struct CGSize { double x0; double x1; })a0 error:(id *)a1;
