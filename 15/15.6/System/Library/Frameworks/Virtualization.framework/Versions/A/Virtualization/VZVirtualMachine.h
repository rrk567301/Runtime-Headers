...
@interface VZVirtualMachine : NSObject {
    ...
    char __guestDidStopSeenDuringOperation;
}

@property (class, readonly) char _supportsNestedVirtualization;
@property (class, readonly, getter=isSupported) char supported;
...
@property (readonly) char _canCreateCore;
...
@property (readonly) char canStop;
...
- (char)requestStopWithError:(id *)a0;
