...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)write:(id)a0 error:(id *)a1;
- (id)peekIntoReadBuffers:(unsigned long long)a0 error:(id *)a1;
- (id)readBuffers;
- (id)readBytes:(unsigned long long)a0 error:(id *)a1;
- (char)readBytesInto:(void *)a0 length:(unsigned long long)a1 error:(id *)a2;
- (void)returnToQueue;
- (char)writeData:(void *)a0 length:(unsigned long long)a1 error:(id *)a2;
