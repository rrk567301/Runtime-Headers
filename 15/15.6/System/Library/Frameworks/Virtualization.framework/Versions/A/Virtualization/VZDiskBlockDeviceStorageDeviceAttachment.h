...
- (id)_initWithURL:(id)a0 readOnly:(char)a1 synchronizationMode:(long long)a2 error:(id *)a3;
- (id)_localFileSystemResources;
- (struct Expected<NSDictionary *, NSError *> { union storage<NSDictionary *, NSError *> { char x0; id x1; id x2; } x0; BOOL x1; })encodeWithEncoder:(id)a0;
- (id)initWithFileHandle:(id)a0 readOnly:(char)a1 synchronizationMode:(long long)a2 error:(id *)a3;
