...
@interface _VZCustomMMIODevice : NSObject <_VZCustomMMIODeviceInterface, NSXPCListenerDelegate> {
    ...
    _Atomic char _write_synchronously;
}
...
+ (char)shouldAcceptConnection:(id)a0 delegate:(id)a1;
...
- (void)initDevice:(unsigned long long)a0 mmioLength:(unsigned long long)a1 writeSynchronously:(char)a2 RAMRegions:(id)a3;
...
- (void)setIRQ:(unsigned long long)a0 value:(char)a1;
