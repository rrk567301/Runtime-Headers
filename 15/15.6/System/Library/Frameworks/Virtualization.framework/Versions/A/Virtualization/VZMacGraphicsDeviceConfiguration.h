...
@interface VZMacGraphicsDeviceConfiguration : VZGraphicsDeviceConfiguration {
    ...
    char _enableProcessIsolation;
    long long _deviceFeatureLevel;
    char _implicitlyAddsVideoToolboxDevice;
}

@property (setter=_setPrefersLowPower:) char _prefersLowPower;
@property (setter=_setEnableProcessIsolation:) char _enableProcessIsolation;
@property (setter=_setDeviceFeatureLevel:) long long _deviceFeatureLevel;
@property (setter=_setImplicitlyAddsVideoToolboxDevice:) char _implicitlyAddsVideoToolboxDevice;
