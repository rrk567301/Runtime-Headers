...
@property (readonly, nonatomic) char databaseWasCreated;
@property (nonatomic) char removeWhenClosed;
@property (readonly, nonatomic) unsigned long long options;

+ (void)initialize;
+ (id)databaseArchiveWithObject:(id)a0 error:(id *)a1;
+ (char)databaseDidDealloc:(id)a0 timeout:(double)a1;
...
- (id)openExistingDatabase:(char)a0;
...
- (char)tableGroupWasPreviouslyValidated:(id)a0;
- (id)tocTableGroup;
- (void)traceSQL;
