...
- (id)init;
- (void).cxx_destruct;
- (void)gateResponseAction:(long long)a0 isRetry:(char)a1;
- (void)gateResponseAction:(long long)a0 isRetry:(char)a1 currentTime:(double)a2;
- (double)throttleTimeForCount:(long long)a0 isRetry:(char)a1;
