...
@property (nonatomic) char firstInvocation;
...
- (void)persistDelayedSyncForRecordName:(id)a0 withDate:(id)a1 increasingCount:(char)a2;
- (void)persistRepairRecord:(id)a0;
- (void)persistSyncEngineMetadata:(id)a0;
- (void)readDatabase:(id /* block */)a0 async:(char)a1 withCompletionHandler:(id /* block */)a2;
- (void)readWriteDatabase:(id /* block */)a0 async:(char)a1 withCompletionHandler:(id /* block */)a2;
