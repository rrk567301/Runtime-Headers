...
@property char hasValidProcessScopedDaemonProxyCreator;
...
- (void)_getProcessScopedDaemonProxyCreatorSynchronous:(char)a0 completionHandler:(id /* block */)a1;
- (void)_getProcessScopedDaemonProxySynchronous:(char)a0 errorHandler:(id /* block */)a1 daemonProxyHandler:(id /* block */)a2;
