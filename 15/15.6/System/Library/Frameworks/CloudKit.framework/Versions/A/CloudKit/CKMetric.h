...
@property (readonly, nonatomic) char walrusEnabled;
...
- (id)initWithStartDate:(id)a0 duration:(double)a1 queueing:(double)a2 executing:(double)a3 bytesUploaded:(unsigned long long)a4 bytesDownloaded:(unsigned long long)a5 connections:(unsigned long long)a6 connectionsCreated:(unsigned long long)a7 bytesFulfilledByPeers:(unsigned long long)a8 bytesFulfilledLocally:(unsigned long long)a9 bytesResumed:(unsigned long long)a10 totalBytesByChunkProfile:(id)a11 chunkCountByChunkProfile:(id)a12 fileCountByChunkProfile:(id)a13 walrusEnabled:(char)a14 zoneishKeysRolled:(unsigned long long)a15 perRecordKeysRolled:(unsigned long long)a16 zoneKeysRolled:(unsigned long long)a17 shareKeysRolled:(unsigned long long)a18 keyRollsSkippedBySizeCheck:(unsigned long long)a19 zoneKeysRemoved:(unsigned long long)a20 zoneishKeysRemoved:(unsigned long long)a21 recordKeysRemoved:(unsigned long long)a22 keysNotRemoved:(unsigned long long)a23;
