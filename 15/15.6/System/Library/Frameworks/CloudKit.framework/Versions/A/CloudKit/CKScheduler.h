...
- (char)hasPendingActivityWithActivityIdentifier:(id)a0;
- (id)initInternal;
- (char)isXPCActivityPending:(id)a0;
- (void)performAsyncOnQueue:(id /* block */)a0;
- (void)registerActivityIdentifier:(id)a0 replaceExistingHandler:(char)a1 handler:(id /* block */)a2;
