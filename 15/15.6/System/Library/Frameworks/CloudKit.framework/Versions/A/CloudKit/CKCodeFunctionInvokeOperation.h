...
- (id)initWithServiceName:(id)a0 functionName:(id)a1 serializedParameters:(id)a2 local:(char)a3;
- (id)initWithServiceName:(id)a0 functionName:(id)a1 serializedRequest:(id)a2;
- (id)initWithServiceName:(id)a0 functionName:(id)a1 serializedRequest:(id)a2 local:(char)a3;
