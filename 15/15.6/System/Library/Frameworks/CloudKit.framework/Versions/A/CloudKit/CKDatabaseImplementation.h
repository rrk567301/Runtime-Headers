...
- (void)_addOperation:(id)a0 wrappingDatabase:(id)a1 convenienceConfiguration:(id)a2 isConvenience:(char)a3;
...
- (void)fetchPCSFromCacheForZoneWithID:(id)a0 localCacheOnly:(char)a1 unitTestOverrides:(id)a2 completionHandler:(id /* block */)a3;
