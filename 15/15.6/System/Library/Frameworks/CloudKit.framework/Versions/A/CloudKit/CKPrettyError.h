...
+ (id)errorForSQLite:(struct sqlite3 { } *)a0 message:(id)a1 args:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
...
+ (id)errorWithDomain:(id)a0 code:(long long)a1 userInfo:(id)a2 error:(id)a3 format:(id)a4 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a5;
