...
@property (nonatomic, getter=isImmediatePushSyncEnabled) char immediatePushSyncEnabled;
...
@property (nonatomic) char continueSendingChangesAfterFailure;
@property (nonatomic) char allowFetchAndModifyConcurrently;
@property (retain, nonatomic) NSObject<OS_xpc_object> *xpcActivityCriteriaOverrides;
@property (nonatomic) char useOpportunisticPushTopic;
...
@property char automaticallySync;
