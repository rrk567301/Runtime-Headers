@class CKSQLite, NSString, NSData, NSArray, CKPackageReference, CKAssetTransferOptions, CKDMMCSItem, CKRecord, NSIndexSet;
...
@property (nonatomic) char shouldReadRawEncryptedData;
...
@property (readonly) char useMMCSEncryptionV2;
...
+ (id)clonedPackageWithRecordID:(id)a0 databaseScope:(long long)a1 fieldName:(id)a2 signature:(id)a3 error:(id *)a4;
...
- (id)_getFromPackagesDBValueForKey:(id)a0;
...
- (void)_setPackagesDBForKey:(id)a0 data:(id)a1;
- (char)addSection:(id)a0;
- (char)claimOwnershipWithError:(id *)a0;
...
- (char)handleChangeStateAction:(long long)a0 error:(id *)a1;
- (unsigned long long)itemCountWithError:(id *)a0;
- (id)itemEnumerator;
- (id)itemEnumeratorForSectionAtIndex:(unsigned long long)a0;
- (char)movePackagesDatabaseInDirection:(char)a0 error:(id *)a1;
- (id)performTransactionBlock:(id /* block */)a0;
- (char)prepareDBWithError:(id *)a0;
- (void)releaseDB;
- (void)releaseDBWithRemove:(char)a0;
- (void)removeDB;
- (char)removeDBAndDeleteFilesWithError:(id *)a0;
- (char)setArchiverInfo:(id)a0 error:(id *)a1;
- (id)testAddSectionConstraintViolation:(id)a0;
- (char)updateItemAtIndex:(long long)a0 withFileURL:(id)a1;
- (char)updateItemAtIndex:(long long)a0 withSignature:(id)a1 size:(unsigned long long)a2 paddedSize:(unsigned long long)a3 itemID:(unsigned long long)a4 sectionIndex:(unsigned long long)a5;
- (char)updateItemsAtIndexes:(id)a0 fileURLs:(id)a1;
