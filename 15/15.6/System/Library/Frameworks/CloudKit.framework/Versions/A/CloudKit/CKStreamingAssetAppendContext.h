...
@property (nonatomic, getter=isAppending) char appending;
@property (nonatomic, getter=isCurrentAppendCancelled) char currentAppendCancelled;
...
@property (nonatomic) char fakeMissingUploadReceipt;
...
- (char)appendSegmentWithData:(id)a0 error:(id *)a1;
- (char)appendSegmentWithData:(id)a0 newStreamingAsset:(id *)a1 error:(id *)a2;
