...
- (char)clockVector_hasTimestampsNotInVector:(id)a0 withExpansionState:(unsigned char)a1;
- (char)clockVector_includesTimestamp:(id)a0;
...
- (id)descriptionWithStringSiteIdentifiers:(char)a0;
