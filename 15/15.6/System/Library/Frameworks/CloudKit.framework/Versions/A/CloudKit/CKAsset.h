...
@property char shouldReadRawEncryptedData;
...
@property (readonly) char isConstructedAsset;
...
@property (readonly, nonatomic) char shouldReadAssetContentUsingClientProxy;
@property char exposeAssetKey;
...
@property char uploaded;
@property char downloaded;
...
+ (id)_openUnencryptedWithOpenInfo:(id)a0 genCountCheck:(char)a1 error:(id *)a2;
+ (char)_templateURLRequiresAssetKey:(id)a0;
