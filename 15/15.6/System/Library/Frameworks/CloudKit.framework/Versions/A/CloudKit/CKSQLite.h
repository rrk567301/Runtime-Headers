...
@property (nonatomic) char shouldVacuum;
...
- (char)deleteExactObject:(id)a0;
- (void)executeSQL:(id)a0 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
- (id)handleDatabaseError:(id)a0;
- (id)handleDatabaseError:(id)a0 args:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
