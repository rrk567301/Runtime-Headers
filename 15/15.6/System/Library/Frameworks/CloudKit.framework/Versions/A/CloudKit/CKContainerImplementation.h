...
@interface CKContainerImplementation : NSObject <CKXPCContainerScopedClient, NSDiscardableContent> {
    ...
    char _hasValidContainerScopedDaemonProxyCreator;
...
@property (nonatomic) char isPersonaOverrideSet;
...
- (char)__preflightAccountAccessAuthorization:(long long *)a0;
...
- (void)handleSharingUIUpdatedShare:(id)a0 recordID:(id)a1 isDeleted:(char)a2 error:(id)a3 reply:(id /* block */)a4;
...
- (void)serverPreferredPushEnvironmentSynchronous:(char)a0 withCompletionHandler:(id /* block */)a1;
