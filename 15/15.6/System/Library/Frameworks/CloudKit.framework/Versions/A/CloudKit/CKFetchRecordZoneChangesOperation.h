...
@property (nonatomic) char shouldReportAllPerItemFailures;
...
- (void)handleChangeSetCompletionForRecordZoneID:(id)a0 serverChangeToken:(id)a1 clientChangeTokenData:(id)a2 recordChangesStatus:(long long)a3 hasPendingArchivedRecords:(char)a4 syncObligationZoneIDs:(id)a5 error:(id)a6 reply:(id /* block */)a7;
