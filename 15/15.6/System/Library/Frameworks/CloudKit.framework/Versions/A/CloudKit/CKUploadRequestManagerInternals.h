...
@property (nonatomic) char hasRegisteredActivity;
...
@property (readonly, nonatomic) char ignoringSystemConditions;
...
- (void)dispatchEvent:(long long)a0 synchronously:(char)a1;
- (void)fetchRepairContainerMetadata;
- (void)fetchServerChanges:(id /* block */)a0;
- (void)finishSchedulerCallbackWithDeferral:(char)a0;
...
- (void)invokeCallbackForOverridePoint:(long long)a0 withError:(id)a1 onCallbackQueue:(char)a2;
- (char)isRepairRecordActionable:(id)a0;
...
- (void)respondToStateMachineAction:(long long)a0 isRetry:(char)a1;
- (void)respondToStateMachineChangeState:(long long)a0 enter:(char)a1;
- (void)scheduleNextSync;
- (void)scheduleOrInvokeRepairsNow;
- (void)scheduleRecordRepair:(id)a0 withDelay:(double)a1 increasingCount:(char)a2;
