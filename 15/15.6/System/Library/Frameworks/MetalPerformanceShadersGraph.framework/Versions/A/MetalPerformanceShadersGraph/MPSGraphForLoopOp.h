...
- (char)recurseFromBlock:(id)a0 onEscaped:(id)a1 withAutodiff:(void *)a2;
- (char)recurseOnBlocksFromOutput:(id)a0 withAutodiff:(void *)a1;
- (char)recurseOutFromBlockInput:(id)a0 withAutodiff:(void *)a1;
