...
- (id)initWithGraph:(id)a0 inputTensors:(id)a1 controlDependencies:(id)a2 layout:(unsigned long long)a3 normalizeCoordinates:(char)a4 relativeCoordinates:(char)a5 alignCorners:(char)a6 paddingMode:(long long)a7 samplingMode:(unsigned long long)a8 nearestRoundingMode:(unsigned long long)a9 name:(id)a10;
