...
+ (id)descriptorWithResizeWidth:(unsigned long long)a0 resizeHeight:(unsigned long long)a1 normalizeCoordinates:(char)a2 spatialScale:(float)a3 resizeMode:(unsigned long long)a4 samplingMode:(unsigned long long)a5 coordinateMode:(unsigned long long)a6;
