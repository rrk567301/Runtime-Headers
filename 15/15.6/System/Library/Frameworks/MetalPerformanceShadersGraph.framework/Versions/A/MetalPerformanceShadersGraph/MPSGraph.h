...
- (id)argSortWithTensor:(id)a0 axis:(long long)a1 descending:(char)a2 name:(id)a3;
...
- (id)resizeNearestWithTensor:(id)a0 sizeTensor:(id)a1 nearestRoundingMode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 name:(id)a5;
- (id)resizeTensor:(id)a0 size:(id)a1 mode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 layout:(unsigned long long)a5 name:(id)a6;
...
- (id)depthToSpace2DTensor:(id)a0 widthAxisTensor:(id)a1 heightAxisTensor:(id)a2 depthAxisTensor:(id)a3 blockSize:(unsigned long long)a4 usePixelShuffleOrder:(char)a5 name:(id)a6;
...
- (id)quantizedGatherWithUpdatesTensor:(id)a0 indicesTensor:(id)a1 scaleTensor:(id)a2 zeroPointTensor:(id)a3 minTensor:(id)a4 dequantDataType:(unsigned int)a5 axis:(unsigned long long)a6 batchDimensions:(unsigned long long)a7 name:(id)a8;
...
- (id)argSortWithTensor:(id)a0 axisTensor:(id)a1 descending:(char)a2 name:(id)a3;
...
- (id)batchToSpaceTensor:(id)a0 spatialAxes:(id)a1 batchAxis:(long long)a2 blockDimensions:(id)a3 usePixelShuffleOrder:(char)a4 name:(id)a5;
- (id)batchToSpaceTensor:(id)a0 spatialAxesTensor:(id)a1 batchAxisTensor:(id)a2 blockDimensionsTensor:(id)a3 usePixelShuffleOrder:(char)a4 name:(id)a5;
...
- (id)bufferToTensorWithTensor:(id)a0 name:(id)a1;
- (id)bufferToTensorWithTensor:(id)a0 shape:(id)a1 type:(unsigned int)a2 interleave:(id)a3 isTensorBufferOp:(BOOL)a4 isChannelAndInterleaveSame:(BOOL)a5 name:(id)a6;
- (id)callSymbolName:(id)a0 inputTensors:(id)a1 outputTypes:(id)a2 name:(id)a3;
- (id)callWithInputTensors:(id)a0 outputTypes:(id)a1 symbolName:(id)a2 inliningOption:(unsigned long long)a3 name:(id)a4;
- (id)callWithInputTensors:(id)a0 outputTypes:(id)a1 symbolName:(id)a2 name:(id)a3;
...
- (id)concatTensors:(id)a0 dimension:(long long)a1 interleave:(char)a2 name:(id)a3;
...
- (id)costVolumeWithRefTensor:(id)a0 inputTensor:(id)a1 coordinatesTensor:(id)a2 windowSizes:(id)a3 layout:(unsigned long long)a4 normalizeCoordinates:(char)a5 relativeCoordinates:(char)a6 coordinateIs1DInWidth:(char)a7 similarityType:(unsigned long long)a8 name:(id)a9;
- (id)createTexture:(id)a0 withPixelFormat:(unsigned long long)a1 isCompressed:(char)a2 name:(id)a3;
...
- (id)cumulativeMaximumReturnIndicesWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMaximumWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMaximumWithTensor:(id)a0 axis:(long long)a1 name:(id)a2;
- (id)cumulativeMaximumWithTensor:(id)a0 axisTensor:(id)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMaximumWithTensor:(id)a0 axisTensor:(id)a1 name:(id)a2;
- (id)cumulativeMinimumReturnIndicesWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMinimumWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMinimumWithTensor:(id)a0 axis:(long long)a1 name:(id)a2;
- (id)cumulativeMinimumWithTensor:(id)a0 axisTensor:(id)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeMinimumWithTensor:(id)a0 axisTensor:(id)a1 name:(id)a2;
- (id)cumulativeProductWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeProductWithTensor:(id)a0 axisTensor:(id)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeProductWithTensor:(id)a0 axisTensor:(id)a1 name:(id)a2;
- (id)cumulativeSumWithTensor:(id)a0 axis:(long long)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
- (id)cumulativeSumWithTensor:(id)a0 axisTensor:(id)a1 exclusive:(char)a2 reverse:(char)a3 name:(id)a4;
...
- (id)depthToSpace2DTensor:(id)a0 widthAxis:(unsigned long long)a1 heightAxis:(unsigned long long)a2 depthAxis:(unsigned long long)a3 blockSize:(unsigned long long)a4 usePixelShuffleOrder:(char)a5 name:(id)a6;
...
- (id)dequantizeTensor:(id)a0 LUTTensor:(id)a1 axis:(long long)a2 name:(id)a3;
- (id)dequantizeTensor:(id)a0 LUTTensor:(id)a1 name:(id)a2;
...
- (id)dequantizeTensor:(id)a0 scaleTensor:(id)a1 dataType:(unsigned int)a2 name:(id)a3;
...
- (id)dequantizeTensor:(id)a0 scaleTensor:(id)a1 zeroPointTensor:(id)a2 dataType:(unsigned int)a3 name:(id)a4;
...
- (id)dequantizeTensor:(id)a0 scaleTensor:(id)a1 zeroPointTensor:(id)a2 minTensor:(id)a3 dataType:(unsigned int)a4 name:(id)a5;
...
- (id)fixCastIntTensor:(id)a0 toSignedness:(char)a1 name:(id)a2;
...
- (id)nonMaximumSuppressionWithBoxesTensor:(id)a0 scoresTensor:(id)a1 IOUThreshold:(float)a2 scoreThreshold:(float)a3 perClassSuppression:(char)a4 coordinateMode:(unsigned long long)a5 name:(id)a6;
- (id)nonMaximumSuppressionWithBoxesTensor:(id)a0 scoresTensor:(id)a1 classIndicesTensor:(id)a2 IOUThreshold:(float)a3 scoreThreshold:(float)a4 perClassSuppression:(char)a5 coordinateMode:(unsigned long long)a6 name:(id)a7;
...
- (id)reciprocalSquareRootWithTensor:(id)a0 name:(id)a1;
...
- (id)resizeBilinearWithGradientTensor:(id)a0 input:(id)a1 centerResult:(char)a2 alignCorners:(char)a3 layout:(unsigned long long)a4 name:(id)a5;
...
- (id)resizeBilinearWithTensor:(id)a0 sizeTensor:(id)a1 centerResult:(char)a2 alignCorners:(char)a3 layout:(unsigned long long)a4 name:(id)a5;
- (id)resizeBilinearWithTensor:(id)a0 sizeTensor:(id)a1 centerResult:(char)a2 alignCorners:(char)a3 name:(id)a4;
...
- (id)resizeNearestWithGradientTensor:(id)a0 input:(id)a1 nearestRoundingMode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 layout:(unsigned long long)a5 name:(id)a6;
...
- (id)resizeNearestWithTensor:(id)a0 sizeTensor:(id)a1 nearestRoundingMode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 layout:(unsigned long long)a5 name:(id)a6;
...
- (id)resizeTensor:(id)a0 sizeTensor:(id)a1 mode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 layout:(unsigned long long)a5 name:(id)a6;
- (id)resizeTensor:(id)a0 sizeTensor:(id)a1 mode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 name:(id)a5;
- (id)resizeTensor:(id)a0 sizeTensor:(id)a1 mode:(unsigned long long)a2 nearestRoundingMode:(unsigned long long)a3 centerResult:(char)a4 alignCorners:(char)a5 layout:(unsigned long long)a6 name:(id)a7;
- (id)resizeTensor:(id)a0 sizeTensor:(id)a1 mode:(unsigned long long)a2 nearestRoundingMode:(unsigned long long)a3 centerResult:(char)a4 alignCorners:(char)a5 name:(id)a6;
...
- (id)resizeWithGradientTensor:(id)a0 input:(id)a1 mode:(unsigned long long)a2 centerResult:(char)a3 alignCorners:(char)a4 layout:(unsigned long long)a5 name:(id)a6;
- (id)resizeWithGradientTensor:(id)a0 input:(id)a1 mode:(unsigned long long)a2 nearestRoundingMode:(unsigned long long)a3 centerResult:(char)a4 alignCorners:(char)a5 layout:(unsigned long long)a6 name:(id)a7;
...
- (id)runInternalWithMPSCommandBuffer:(id)a0 feeds:(id)a1 targetTensors:(id)a2 targetOperations:(id)a3 resultsDictionary:(id)a4 executionDescriptor:(id)a5 mpsGraphOwnedCommandBuffer:(char)a6;
...
- (id)sampleGridDataGradientWithIncomingGradientTensor:(id)a0 coordinateTensor:(id)a1 outputShape:(id)a2 normalizeCoordinates:(char)a3 relativeCoordinates:(char)a4 paddingMode:(long long)a5 samplingMode:(unsigned long long)a6 name:(id)a7;
- (id)sampleGridDataGradientWithIncomingGradientTensor:(id)a0 coordinateTensor:(id)a1 outputShapeTensor:(id)a2 normalizeCoordinates:(char)a3 relativeCoordinates:(char)a4 paddingMode:(long long)a5 samplingMode:(unsigned long long)a6 name:(id)a7;
- (id)sampleGridWithSourceTensor:(id)a0 coordinateTensor:(id)a1 layout:(unsigned long long)a2 normalizeCoordinates:(char)a3 relativeCoordinates:(char)a4 alignCorners:(char)a5 paddingMode:(long long)a6 nearestRoundingMode:(unsigned long long)a7 constantValue:(double)a8 name:(id)a9;
- (id)sampleGridWithSourceTensor:(id)a0 coordinateTensor:(id)a1 layout:(unsigned long long)a2 normalizeCoordinates:(char)a3 relativeCoordinates:(char)a4 alignCorners:(char)a5 paddingMode:(long long)a6 samplingMode:(unsigned long long)a7 constantValue:(double)a8 name:(id)a9;
- (id)sampleGridWithSourceTensor:(id)a0 coordinateTensor:(id)a1 layout:(unsigned long long)a2 normalizeCoordinates:(char)a3 relativeCoordinates:(char)a4 alignCorners:(char)a5 paddingMode:(long long)a6 samplingMode:(unsigned long long)a7 nearestRoundingMode:(unsigned long long)a8 constantValue:(double)a9 name:(id)a10;
- (id)sampleGridWithSourceTensor:(id)a0 coordinateTensor:(id)a1 normalizeCoordinates:(char)a2 relativeCoordinates:(char)a3 paddingMode:(long long)a4 samplingMode:(unsigned long long)a5 constantValue:(double)a6 name:(id)a7;
- (id)scaledDotProductAttentionWithQueryTensor:(id)a0 keyTensor:(id)a1 valueTensor:(id)a2 maskTensor:(id)a3 scale:(float)a4 name:(id)a5;
- (id)scaledDotProductAttentionWithQueryTensor:(id)a0 keyTensor:(id)a1 valueTensor:(id)a2 scale:(float)a3 name:(id)a4;
...
- (id)sliceGradientTensor:(id)a0 fwdInShapeTensor:(id)a1 startTensor:(id)a2 endTensor:(id)a3 strideTensor:(id)a4 startMask:(unsigned int)a5 endMask:(unsigned int)a6 squeezeMask:(unsigned int)a7 name:(id)a8;
- (id)sliceGradientTensor:(id)a0 fwdInShapeTensor:(id)a1 startTensor:(id)a2 sizeTensor:(id)a3 squeezeMask:(unsigned int)a4 name:(id)a5;
...
- (id)sliceTensor:(id)a0 startTensor:(id)a1 endTensor:(id)a2 strideTensor:(id)a3 startMask:(unsigned int)a4 endMask:(unsigned int)a5 squeezeMask:(unsigned int)a6 name:(id)a7;
- (id)sliceTensor:(id)a0 startTensor:(id)a1 sizeTensor:(id)a2 squeezeMask:(unsigned int)a3 name:(id)a4;
...
- (id)sliceUpdateDataTensor:(id)a0 updateTensor:(id)a1 starts:(id)a2 ends:(id)a3 strides:(id)a4 name:(id)a5;
- (id)sliceUpdateDataTensor:(id)a0 updateTensor:(id)a1 starts:(id)a2 ends:(id)a3 strides:(id)a4 startMask:(unsigned int)a5 endMask:(unsigned int)a6 squeezeMask:(unsigned int)a7 name:(id)a8;
- (id)sliceUpdateDataTensor:(id)a0 updateTensor:(id)a1 startsTensor:(id)a2 endsTensor:(id)a3 stridesTensor:(id)a4 name:(id)a5;
- (id)sliceUpdateDataTensor:(id)a0 updateTensor:(id)a1 startsTensor:(id)a2 endsTensor:(id)a3 stridesTensor:(id)a4 startMask:(unsigned int)a5 endMask:(unsigned int)a6 squeezeMask:(unsigned int)a7 name:(id)a8;
...
- (id)sortWithTensor:(id)a0 axis:(long long)a1 descending:(char)a2 name:(id)a3;
- (id)sortWithTensor:(id)a0 axis:(long long)a1 name:(id)a2;
- (id)sortWithTensor:(id)a0 axisTensor:(id)a1 descending:(char)a2 name:(id)a3;
- (id)spaceToBatchTensor:(id)a0 spatialAxes:(id)a1 batchAxis:(long long)a2 blockDimensions:(id)a3 usePixelShuffleOrder:(char)a4 name:(id)a5;
- (id)spaceToBatchTensor:(id)a0 spatialAxesTensor:(id)a1 batchAxisTensor:(id)a2 blockDimensionsTensor:(id)a3 usePixelShuffleOrder:(char)a4 name:(id)a5;
- (id)spaceToDepth2DTensor:(id)a0 widthAxis:(unsigned long long)a1 heightAxis:(unsigned long long)a2 depthAxis:(unsigned long long)a3 blockSize:(unsigned long long)a4 usePixelShuffleOrder:(char)a5 name:(id)a6;
- (id)spaceToDepth2DTensor:(id)a0 widthAxisTensor:(id)a1 heightAxisTensor:(id)a2 depthAxisTensor:(id)a3 blockSize:(unsigned long long)a4 usePixelShuffleOrder:(char)a5 name:(id)a6;
...
- (id)tensorToBufferWithTensor:(id)a0 name:(id)a1;
- (id)tensorToBufferWithTensor:(id)a0 shape:(id)a1 type:(unsigned int)a2 interleave:(id)a3 isTensorBufferOp:(BOOL)a4 isChannelAndInterleaveSame:(BOOL)a5 name:(id)a6;
...
- (id)varFromTensorWithTensor:(id)a0 name:(id)a1;
- (id)variableFromTensorWithTensor:(id)a0 name:(id)a1;
- (id)variableOps;
