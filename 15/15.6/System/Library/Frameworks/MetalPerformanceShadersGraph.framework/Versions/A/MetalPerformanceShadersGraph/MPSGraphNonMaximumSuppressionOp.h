@interface MPSGraphNonMaximumSuppressionOp : MPSGraphOperation {
    ...
    char _perClassSuppression;
    unsigned long long _coordinateMode;
}

- (id)initWithGraph:(id)a0 inputTensors:(id)a1 controlDependencies:(id)a2 iouThreshold:(float)a3 scoreThreshold:(float)a4 perClassSuppression:(char)a5 coordinateMode:(unsigned long long)a6 name:(id)a7;
