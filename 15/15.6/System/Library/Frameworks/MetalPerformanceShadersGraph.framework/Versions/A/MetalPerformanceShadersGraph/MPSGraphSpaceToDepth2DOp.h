@interface MPSGraphSpaceToDepth2DOp : MPSGraphOperation {
    ...
    char _pixelShuffleOrder;
}

- (id)initWithGraph:(id)a0 inputTensors:(id)a1 controlDependencies:(id)a2 blockSize:(unsigned long long)a3 usePixelShuffleOrder:(char)a4 name:(id)a5;
