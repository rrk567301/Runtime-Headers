...
- (id)undoManager;
- (char)usesTabs;
- (void)_fixAttributesInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forceExtended:(char)a1;
- (void)setIndentWidth:(unsigned long long)a0;
- (id)_firstLayoutManager;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })findString:(id)a0 previousFindRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 limitRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 options:(unsigned long long)a3 matchStyle:(int)a4 wrap:(char)a5;
...
- (void)setIndentsWrappedLines:(char)a0;
- (void)setTabWidth:(unsigned long long)a0;
- (void)setUsesTabs:(char)a0;
- (void)setWrapsLines:(char)a0;
