...
@property (readonly, getter=isCompiled) char compiled;
...
- (char)compileAndReturnError:(id *)a0;
...
- (char)writeToURL:(id)a0 ofType:(id)a1 usingStorageOptions:(unsigned long long)a2 error:(id *)a3;
