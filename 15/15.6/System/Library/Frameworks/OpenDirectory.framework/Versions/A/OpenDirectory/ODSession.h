...
- (char)addConfiguration:(id)a0 authorization:(id)a1 error:(id *)a2;
- (id)configurationAuthorizationAllowingUserInteraction:(char)a0 error:(id *)a1;
- (id)configurationDictionaryForNodename:(id)a0;
- (id)configurationForNodename:(id)a0;
- (char)deleteConfiguration:(id)a0 authorization:(id)a1 error:(id *)a2;
- (char)deleteConfigurationWithNodename:(id)a0 authorization:(id)a1 error:(id *)a2;
- (char)externalizedAuthorizationForm:(struct { char x0[32]; } *)a0 authorization:(id)a1 node:(id)a2 error:(id *)a3;
