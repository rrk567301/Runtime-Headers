...
@property char trustUsesMutualAuthentication;
@property char trustUsesKerberosKeytab;
@property char trustUsesSystemKeychain;
...
@property char hideRegistration;
...
@property char manInTheMiddleProtection;
...
- (void)dealloc;
- (id)init;
- (char)addTrustType:(id)a0 trustAccount:(id)a1 trustPassword:(id)a2 username:(id)a3 password:(id)a4 joinExisting:(char)a5 error:(id *)a6;
- (id)initWithSession:(id)a0;
- (void)packageModules:(id)a0 intoConfiguration:(id)a1 forCategory:(id)a2;
- (char)removeTrustUsingUsername:(id)a0 password:(id)a1 deleteTrustAccount:(char)a2 error:(id *)a3;
- (char)saveUsingAuthorization:(id)a0 error:(id *)a1;
