...
@property (readonly, nonatomic, getter=isNumber) char number;
@property (readonly, nonatomic, getter=isIntegerNumber) char integerNumber;
@property (readonly, nonatomic, getter=isFloatingPointNumber) char floatingPointNumber;
@property (readonly, nonatomic, getter=isObject) char object;
