...
@property char logAcmeCSR;
@property char permitLocalIssuer;
@property char requireAttestation;
...
- (id)createKeyPair;
- (char)deviceAttestationSupported;
...
- (id)serialNumber;
- (char)valueForBooleanDefault:(id)a0;
