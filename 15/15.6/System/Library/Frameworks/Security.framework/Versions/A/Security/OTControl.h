...
- (void)clearCliqueFromAccount:(id)a0 resetReason:(long long)a1 isGuitarfish:(char)a2 reply:(id /* block */)a3;
...
- (void)healthCheck:(id)a0 skipRateLimitingCheck:(char)a1 repair:(char)a2 reply:(id /* block */)a3;
...
- (void)performCKServerUnreadableDataRemoval:(id)a0 isGuitarfish:(char)a1 altDSID:(id)a2 reply:(id /* block */)a3;
- (void)postCDPFollowupResult:(id)a0 success:(char)a1 type:(id)a2 error:(id)a3 reply:(id /* block */)a4;
...
- (void)resetAndEstablish:(id)a0 resetReason:(long long)a1 idmsTargetContext:(id)a2 idmsCuttlefishPassword:(id)a3 notifyIdMS:(BOOL)a4 accountSettings:(id)a5 isGuitarfish:(char)a6 reply:(id /* block */)a7;
...
- (void)setUserControllableViewsSyncStatus:(id)a0 enabled:(char)a1 reply:(id /* block */)a2;
