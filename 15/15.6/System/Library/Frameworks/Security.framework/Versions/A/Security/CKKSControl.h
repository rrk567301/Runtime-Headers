...
@property char synchronous;
@property (retain) NSXPCConnection *connection;

+ (id)CKKSControlObject:(char)a0 error:(id *)a1;
...
- (void)fetchSEViewKeyHierarchy:(id)a0 forceFetch:(char)a1 reply:(id /* block */)a2;
- (void)fetchSEViewKeyHierarchy:(id)a0 reply:(id /* block */)a1;
- (void)initialSyncStatus:(id)a0 reply:(id /* block */)a1;
...
- (void)rpcStatus:(id)a0 fast:(char)a1 waitForNonTransientState:(unsigned long long)a2 reply:(id /* block */)a3;
