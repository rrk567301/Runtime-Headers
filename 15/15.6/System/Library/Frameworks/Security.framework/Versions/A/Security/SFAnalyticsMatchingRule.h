...
- (char)isSubsetMatch:(id)a0 target:(id)a1;
- (id)lastMatchTimeKey;
- (char)matchAttributes:(id)a0 eventClass:(long long)a1 processName:(id)a2 logger:(id)a3;
- (char)valueMatch:(id)a0 target:(id)a1;
