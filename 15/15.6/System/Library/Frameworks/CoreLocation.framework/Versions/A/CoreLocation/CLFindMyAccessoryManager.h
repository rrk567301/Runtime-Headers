...
- (void)fetchTxPowerFromDevice:(id)a0 asOwner:(char)a1;
...
- (void)fetchUserStatsWithPersistence:(char)a0 fromDevice:(id)a1;
...
- (void)setUnauthorizedPlaySoundRateLimit:(char)a0 forDevice:(id)a1;
- (void)setWildConfiguration:(id)a0 onDevice:(id)a1;
- (void)stageTADetection:(id)a0 deviceType:(id)a1 detailsBitmask:(id)a2;
