...
- (char)isCourseValid;
- (char)isDenseUrbanSignalEnvironment;
- (char)isFoliageSignalEnvironment;
- (char)isGPSLocationType;
- (char)isGoodGPSFix;
- (char)isGoodGPSFixWithGoodCourse;
- (char)isInertialIntegrated;
- (char)isLinearInterpolated;
- (char)isLoiLocationType;
- (char)isMapMatched;
- (char)isOriginalLocationType;
- (char)isRuralSignalEnvironment;
- (char)isSpeedValid;
- (char)isUrbanSignalEnvironment;
- (char)isWiFiLocationType;
- (void)setCLRoadID:(unsigned long long)a0;
