...
- (id)initWithTripSegmentID:(id)a0 isFinalPart:(char)a1 startDate:(id)a2 endDate:(id)a3 duration:(double)a4 modeOfTransport:(long long)a5 distance:(double)a6 distanceUnc:(double)a7 tripLocations:(id)a8 routeRoads:(id)a9;
