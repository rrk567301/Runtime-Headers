...
@property (readonly, nonatomic, getter=isGeocoding) char geocoding;
...
- (void)reverseGeocodeLocation:(id)a0 heading:(double)a1 localResultsOnly:(char)a2 completionHandler:(id /* block */)a3;
- (void)reverseGeocodeLocation:(id)a0 localResultsOnly:(char)a1 completionHandler:(id /* block */)a2;
- (void)reverseGeocodeLocation:(id)a0 preferredLocale:(id)a1 completionHandler:(id /* block */)a2;
- (void)reverseGeocodeLocation:(id)a0 preferredLocale:(id)a1 heading:(double)a2 localResultsOnly:(char)a3 completionHandler:(id /* block */)a4;
