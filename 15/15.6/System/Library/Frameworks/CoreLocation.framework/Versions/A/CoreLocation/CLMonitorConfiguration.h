...
@property (nonatomic) char useMonitorQueue;
...
- (id)initWithName:(id)a0 path:(id)a1 onQueue:(id)a2 eventHandler:(id /* block */)a3;
- (id)initWithName:(id)a0 path:(id)a1 onQueue:(id)a2 eventHandler:(id /* block */)a3 useMonitorQueueForVendingMonitor:(char)a4 vendingHandler:(id /* block */)a5;
- (id)initWithName:(id)a0 path:(id)a1 onSilo:(id)a2 eventHandler:(id /* block */)a3 useMonitorQueueForVendingMonitor:(char)a4 vendingHandler:(id /* block */)a5;
