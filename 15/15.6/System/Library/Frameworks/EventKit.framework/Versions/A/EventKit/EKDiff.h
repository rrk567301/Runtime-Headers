...
+ (void)_populateIdentityKeysForDiff:(id)a0 keysToIgnore:(id)a1;
+ (void)_populateImmutableKeysForDiff:(id)a0 keysToIgnore:(id)a1;
+ (void)_populateMultiValueRelationshipKeysForDiff:(id)a0 keysToIgnore:(id)a1 fetchKeysToIgnoreBlock:(id /* block */)a2;
+ (void)_populateSingleValueKeysForDiff:(id)a0 keysToIgnore:(id)a1 fetchKeysToIgnoreBlock:(id /* block */)a2;
+ (void)_populateSingleValueRelationshipKeysForDiff:(id)a0 keysToIgnore:(id)a1 fetchKeysToIgnoreBlock:(id /* block */)a2;
+ (id)_summaryKeyForMultiValueChange:(id)a0 ofPropertyKey:(id)a1;
+ (id)diffBetweenObject:(id)a0 andObject:(id)a1;
+ (id)diffBetweenObject:(id)a0 andObject:(id)a1 compareUIVisiblePropertiesOnly:(char)a2;
+ (id)diffBetweenObject:(id)a0 andObject:(id)a1 fetchKeysToIgnoreBlock:(id /* block */)a2;
+ (id)keysToIgnoreForComparingUIVisiblePropertiesOfObject:(id)a0 andObject:(id)a1;
...
- (id)changeSetForDiff;
- (id)copyOfObject:(id)a0 alreadyCopiedObjects:(id)a1 madeNewCopy:(char *)a2;
- (id)differentKeys;
