...
@property (readonly, nonatomic) char shouldValidateObjectIDs;
...
- (void)CADClientReceiveDiagnosticsCollectionResults:(id)a0 forToken:(unsigned int)a1 finished:(char)a2;
- (void)CADClientReceiveOccurrenceCacheSearchResults:(id)a0 forSearchToken:(unsigned int)a1 finished:(char)a2;
...
- (id)operationForToken:(unsigned int)a0 respondingToSelector:(SEL)a1 finished:(char)a2;
