...
- (char)_doITIPFileImport;
- (char)_doImportFiles;
- (id)_existingEventFromICSEvent:(id)a0 calendar:(id)a1;
...
- (char)_isAnyAttendeeAddressFrom:(id)a0 organizer:(id)a1 equivalentTo:(id)a2;
- (id)_matchingAttendeeAddressesFrom:(id)a0 organizer:(id)a1 inSource:(id)a2;
- (char)_message:(id)a0 hasNewSelfOrganizedEventForCalendar:(id)a1;
- (unsigned long long)_separateFilesForImport:(id)a0;
- (char)_separateICalFilesForITIP;
- (char)_sortFilesByImportCalendar;
- (void)asyncImportWithCompletion:(id /* block */)a0;
- (void)callCompletionWithSuccess:(char)a0;
...
- (char)shouldImportContinueGivenDecision:(int)a0 eventsAffected:(unsigned long long)a1;
