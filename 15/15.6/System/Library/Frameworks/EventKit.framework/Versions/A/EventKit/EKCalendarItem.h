...
+ (char)_shouldDeleteAndAddForMoveFromCalendar:(id)a0 toCalendar:(id)a1;
+ (id)adjustDateFromUTC:(id)a0 allDay:(char)a1 timeZone:(id)a2;
...
+ (id)preferredLocationWithClientLocation:(id)a0 structuredLocation:(id)a1;
...
- (id)_customObjectForKey:(id)a0 local:(char)a1;
- (id)_dataFromStructuredDataDictionary:(id)a0 local:(char)a1;
- (void)_deletePersistentItemAndDetachedItems:(id)a0 forSavingItem:(id)a1;
- (void)_deleteSelfAndDetached;
- (char)_excludeAlarmDueToConnectionTrigger:(id)a0;
- (id)_generateNewUniqueID;
- (char)_hadAttendees;
- (char)_hadRecurrenceRules;
...
- (void)_setCustomObject:(id)a0 forKey:(id)a1 local:(char)a2;
- (void)_setSelfAttendee:(id)a0;
- (id)_structuredDataDictionaryFromData:(id)a0 local:(char)a1;
...
- (char)_validateDeletableBySharedCalendarShareeWithError:(id *)a0;
- (char)_validateDeletableDueToAccessConsent:(id *)a0;
- (char)_validateDeletableInCalendarWithError:(id *)a0;
- (void)_willSave;
...
- (char)canMoveToCalendar:(id)a0 error:(id *)a1;
...
- (char)hasAttachment;
- (char)hasCalendarChangeThatRequiresDeleteAndAdd;
- (char)hasComplexRecurrence;
- (char)hasRecurrenceRuleAdditionOrRemoval;
- (long long)indexForAlarm:(id)a0;
- (char)isAlarmAcknowledgedPropertyDirty;
- (char)isNewItemThatFailedToPut;
- (char)isOnlyAlarmAcknowledgedPropertyDirty;
...
- (void)setDefaultAlarmWasDeleted:(char)a0;
...
- (void)setSuppressNotificationForChanges:(char)a0;
...
- (char)suppressNotificationForChanges;
- (id)syncError;
- (id)travelStartLocation;
- (void)updateWithAppLink:(id)a0 usedSelectedText:(char *)a1;
