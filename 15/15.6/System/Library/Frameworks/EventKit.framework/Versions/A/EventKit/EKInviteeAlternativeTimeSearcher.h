...
@property (nonatomic) char internalSearchingForMoreTimesWhenAllAttendeesCanAttend;
@property (nonatomic) char internalSearchingForMoreTimesWhenSomeAttendeesCanAttend;
...
@property (readonly, nonatomic) char searchingForMoreTimesWhenAllAttendeesCanAttend;
@property (readonly, nonatomic) char searchingForMoreTimesWhenSomeAttendeesCanAttend;
@property (nonatomic) char noConflictRequired;
...
+ (char)_span:(id)a0 hasSameConflictedParticipantsAsSpan:(id)a1;
...
- (void)_haltSearchWithError:(char)a0;
