...
- (void).cxx_destruct;
- (void)cancel;
- (id)initWithEventStore:(id)a0 searchString:(id)a1 maximumResultCount:(unsigned long long)a2 ignoreScheduledEvents:(char)a3 initialEvent:(id)a4 pasteboardItemProvider:(id)a5 completionHandler:(id /* block */)a6;
- (char)_shouldReturnResultForEvent:(id)a0 considerReadonlyEvents:(char)a1;
