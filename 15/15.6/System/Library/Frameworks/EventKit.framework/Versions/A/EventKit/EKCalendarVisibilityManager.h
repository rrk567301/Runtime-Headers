...
- (void)activate;
- (void)deactivate;
- (id)_calendarsThatAreVisible:(char)a0 filteredByIdentity:(char)a1;
...
- (id)initWithEventStore:(id)a0 limitedToSource:(id)a1 visibilityChangedCallback:(id /* block */)a2 queue:(id)a3 activate:(char)a4;
