...
@property char finishedCompletionHandlerCalled;
@property (retain) EKAutocompleteSearchResult *lastDefaultReminderResult;

+ (void)adjustTimeForUIAndApplyToAutocompleteResults:(id)a0 usingCurrentStartDate:(id)a1 currentEndDate:(id)a2 timeImplicitlySet:(char)a3 calendar:(id)a4;
