...
- (char)_commit:(id *)a0 error:(id *)a1;
...
- (id /* block */)completionBlockForFetchRequestToken:(id)a0 remove:(char)a1;
...
- (char)saveObject:(id)a0 withFrozenObject:(id)a1 error:(id *)a2;
