...
@property (readonly, nonatomic) char variableLengthSequences;
@property (readonly, nonatomic) char isFloatingPoint;
...
@property (readonly, nonatomic) char sortedSequences;
...
+ (id)descriptorWithShape:(id)a0 sequenceLengths:(id)a1 sortedSequences:(char)a2 dataType:(int)a3;
...
- (id)initTensorWithShape:(id)a0 stride:(id)a1 sequenceLengths:(id)a2 sortedSequences:(char)a3 fanIn:(unsigned long long)a4 fanOut:(unsigned long long)a5 dataType:(int)a6;
- (id)newShapeWithCount:(unsigned long long)a0;
