...
+ (char)compileWithDevice:(id)a0 deviceOps:(id)a1 sourceTensors:(id)a2 resultTensor:(id)a3 convolutionTranspose:(char)a4;
+ (id)createBNNSNDArrayDescriptorForDescriptor:(id)a0 biasDelta:(id)a1 dataType:(int)a2;
+ (id)createBNNSNDArrayDescriptorForDescriptor:(id)a0 weightsDelta:(id)a1 fullyConnected:(char)a2 dataType:(int)a3;
