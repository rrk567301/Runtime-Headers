...
@property (nonatomic) char inferenceOnly;
...
@property (nonatomic) char computeWeightsAndBiasOnly;
...
@property (nonatomic) char isFusedBNNSFilter;
@property (retain, nonatomic) NSData *poolingIndicesBuffer;
@property (nonatomic) int paddingPolicy;
@property (nonatomic) char useSourceGradientDeviceMemoryForResultGradientTensor;
@property (nonatomic) char useSourceGradientDeviceMemoryForSecondaryResultGradientTensor;
@property (nonatomic) float lossWeight;
@property (nonatomic) char binaryOperation;
@property (nonatomic) char hasBias;
@property (nonatomic) unsigned long long softmaxDimension;
@property (nonatomic) char transposeX;
@property (nonatomic) char transposeY;
@property (nonatomic) char leftIsAWeight;
@property (nonatomic) char rightIsAWeight;
@property (copy, nonatomic) NSNumber *paddingIndex;
@property (copy, nonatomic) NSArray *embeddingParams;
@property (nonatomic) char scaleGradientByFrequency;
