...
- (void)createBNNSDesc2DForLSTMWeights:(id)a0 tensorParameters:(id)a1 deviceOptimizers:(id)a2 isInputWeight:(char)a3;
...
- (void)optimizerStepForSingleParameterLSTM:(id)a0 tensorParameters:(id)a1 parameterForGateDesc:(struct { unsigned int x0; unsigned int x1; unsigned long long x2[8]; unsigned long long x3[8]; void *x4; unsigned int x5; void *x6; unsigned int x7; float x8; float x9; } *)a2 gradientsForGateDesc:(struct { unsigned int x0; unsigned int x1; unsigned long long x2[8]; unsigned long long x3[8]; void *x4; unsigned int x5; void *x6; unsigned int x7; float x8; float x9; } *)a3 parameterMomentumDescData:(id)a4 gateIndex:(unsigned long long)a5 deviceOptimizers:(id)a6 isStackedInputWeight:(char)a7;
...
- (id)readFromDevice:(id)a0 deviceIndex:(unsigned long long)a1 allocateData:(char)a2 batchSize:(unsigned long long)a3;
- (id)readTensor:(id)a0;
...
- (void)saveOrRestoreLSTMBiasesAndAccumulators:(id)a0 auxParameter:(id)a1 auxAccumulators:(id)a2 mlcIndex:(unsigned long long)a3 auxIndex:(unsigned long long)a4 saveParameter:(char)a5;
...
- (void)writeToAllDevices:(id)a0 allocateData:(char)a1 batchSize:(unsigned long long)a2;
