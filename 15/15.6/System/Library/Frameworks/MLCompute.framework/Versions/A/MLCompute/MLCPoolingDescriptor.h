...
@property (readonly, nonatomic) char countIncludesPadding;

+ (id)averagePoolingDescriptorWithKernelSizes:(id)a0 strides:(id)a1 paddingPolicy:(int)a2 paddingSizes:(id)a3 countIncludesPadding:(char)a4;
+ (id)maxPoolingDescriptorWithKernelSizes:(id)a0 strides:(id)a1 paddingPolicy:(int)a2 paddingSizes:(id)a3;
+ (id)averagePoolingDescriptorWithKernelSizes:(id)a0 strides:(id)a1 dilationRates:(id)a2 paddingPolicy:(int)a3 paddingSizes:(id)a4 countIncludesPadding:(char)a5;
