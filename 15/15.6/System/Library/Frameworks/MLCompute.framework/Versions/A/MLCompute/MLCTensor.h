...
+ (char)canConvertValue:(float)a0 toDataType:(int)a1;
...
+ (id)tensorWithSequenceLengths:(id)a0 sortedSequences:(char)a1 featureChannelCount:(unsigned long long)a2 batchSize:(unsigned long long)a3 data:(id)a4;
+ (id)tensorWithSequenceLengths:(id)a0 sortedSequences:(char)a1 featureChannelCount:(unsigned long long)a2 batchSize:(unsigned long long)a3 randomInitializerType:(int)a4;
...
- (char)bindAndWriteData:(id)a0 toDevice:(id)a1;
- (char)bindOptimizerData:(id)a0 deviceData:(id)a1;
...
- (char)copyDataFromDeviceMemoryToBytes:(void *)a0 length:(unsigned long long)a1 synchronizeWithDevice:(char)a2;
- (char)dataContainsScalarWhere:(id /* block */)a0;
