...
@property (nonatomic) char appliesGradientClipping;
...
- (id)initWithLearningRate:(float)a0 gradientRescale:(float)a1 applyGradientClipping:(char)a2 gradientClipMax:(float)a3 gradientClipMin:(float)a4 regularizationScale:(float)a5 regularizationType:(int)a6;
- (id)initWithLearningRate:(float)a0 gradientRescale:(float)a1 applyGradientClipping:(char)a2 gradientClipMax:(float)a3 gradientClipMin:(float)a4 regularizationScale:(float)a5 regularizationType:(int)a6 gradientClippingType:(int)a7 maximumClippingNorm:(float)a8 customGlobalNorm:(float)a9;
