...
+ (id)optimizerWithDescriptor:(id)a0 momentumScale:(float)a1 alpha:(float)a2 epsilon:(float)a3 isCentered:(char)a4;
+ (id)optimizerWithDescriptor:(id)a0;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (char)compileForDevice:(id)a0;
- (id)initWithDescriptor:(id)a0 momentumScale:(float)a1 alpha:(float)a2 epsilon:(float)a3 centered:(char)a4;
