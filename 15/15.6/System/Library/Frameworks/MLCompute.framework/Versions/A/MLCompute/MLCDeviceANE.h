...
- (char)allocateDeviceMemoryForSourceAndResultTensorsOfLayer:(id)a0 tensorLabelToIOSurfaceMap:(id *)a1;
...
- (char)compileOptimizerDeviceOps:(id)a0;
...
- (id)imageReshapeWithWidth:(unsigned long long)a0 height:(unsigned long long)a1 alignCorners:(char)a2;
...
- (id)optimizerAdamWithDescriptor:(id)a0 beta1:(double)a1 beta2:(double)a2 epsilon:(float)a3 amsgrad:(char)a4 timeStep:(unsigned long long)a5 isAdamW:(char)a6;
...
- (char)postProcessCompiledGraph:(id)a0 compilerOptions:(unsigned long long)a1;
- (char)procedureInformationWithModelAttributes:(id)a0 procedureName:(id)a1 procedureID:(unsigned long long *)a2 procedureInputSymbols:(id *)a3 procedureInputSymbolIndices:(id *)a4 procedureOutputSymbols:(id *)a5 procedureOutputSymbolIndices:(id *)a6;
- (id)readTensor:(id)a0;
...
- (char)updateTensorsForFusedLayers:(id)a0 ofInferenceGraph:(id)a1;
