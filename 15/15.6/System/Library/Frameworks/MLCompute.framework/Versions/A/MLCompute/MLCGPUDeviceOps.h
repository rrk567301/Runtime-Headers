...
@property (nonatomic) char isMPSKernel;
@property (nonatomic) char isMPSGraph;
...
@property (nonatomic) char countIncludesPadding;
...
@property (nonatomic) char recomputeResultTensor;
