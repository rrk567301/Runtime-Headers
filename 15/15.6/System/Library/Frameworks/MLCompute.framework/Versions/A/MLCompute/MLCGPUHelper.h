...
+ (id)allocateMPSImageBatchForTensor:(id)a0 commandBuffer:(id)a1 kernel:(id)a2 batchSize:(unsigned long long)a3 heapAllocator:(id)a4 imageBatchIsTemporary:(char)a5;
