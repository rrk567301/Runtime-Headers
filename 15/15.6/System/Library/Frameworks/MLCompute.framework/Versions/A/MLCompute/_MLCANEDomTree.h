...
- (void).cxx_destruct;
- (char)doesSubgraph:(id)a0 dominatesSubgraph:(id)a1;
- (char)doesLayer:(id)a0 dominates:(id)a1;
- (char)doesLayer:(id)a0 dominatesSubgraph:(id)a1;
- (char)doesSubgraph:(id)a0 dominatesLayer:(id)a1;
