...
@property (nonatomic) char mhaHasBias;
@property (nonatomic) char mhaHasAttnBias;
@property (retain, nonatomic) NSArray *mhaAttentionBiasTensors;
@property (nonatomic) char mhaHasZeroAttention;
@property (nonatomic) char mhaHasKeyMask;
@property (nonatomic) char mhaHasAttentionMask;
