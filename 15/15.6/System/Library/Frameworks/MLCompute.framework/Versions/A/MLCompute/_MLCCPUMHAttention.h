...
+ (id)layerWithDevice:(id)a0 descriptor:(id)a1 weights:(id)a2 bias:(id)a3 attnBias:(id)a4 inferenceOnly:(char)a5;
...
- (id)initWithDevice:(id)a0 descriptor:(id)a1 weights:(id)a2 bias:(id)a3 attnBias:(id)a4 inferenceOnly:(char)a5;
