...
- (id)description;
- (char)addInputs:(id)a0;
- (char)addOutputs:(id)a0;
- (char)addInputs:(id)a0 lossLabels:(id)a1;
- (char)compileWithOptions:(unsigned long long)a0 device:(id)a1;
- (char)executeWithInputsData:(id)a0 batchSize:(unsigned long long)a1 options:(unsigned long long)a2 completionHandler:(id /* block */)a3;
...
- (char)executeWithInputsData:(id)a0 outputsData:(id)a1 batchSize:(unsigned long long)a2 options:(unsigned long long)a3 completionHandler:(id /* block */)a4;
