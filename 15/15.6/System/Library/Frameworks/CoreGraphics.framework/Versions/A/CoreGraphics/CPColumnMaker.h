...
- (void)anchorImages;
- (void)callOuts;
- (char)canSafelyAdd:(id)a0 to:(id)a1;
- (id)chunkAbove:(id)a0 in:(id)a1;
- (char)closeImagesBetween:(id)a0 and:(id)a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
- (char)column:(id)a0 isLinkedBelowTo:(id)a1;
- (char)cuttingShapeBetween:(id)a0 and:(id)a1;
...
- (char)paragraph:(id)a0 isAbove:(id)a1;
- (char)paragraph:(id)a0 isBelow:(id)a1;
- (char)paragraph:(id)a0 isLinkedBelowTo:(id)a1;
- (char)paragraph:(id)a0 notOnSameShapeAs:(id)a1;
