...
+ (char)guideSeparates:(id)a0 from:(id)a1;
+ (char)gutterSeparates:(id)a0 from:(id)a1;
...
- (void)dispose;
- (id)gutters;
- (char)addStripTo:(id)a0 bottom:(double)a1 left:(double)a2 top:(double)a3 right:(double)a4;
- (void)findGuides;
- (void)findGutters;
