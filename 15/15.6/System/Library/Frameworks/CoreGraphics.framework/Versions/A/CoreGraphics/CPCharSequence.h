...
- (char)map:(void /* function */ *)a0 whereNeighborsWith:(id)a1 passing:(void *)a2;
...
- (char)map:(void /* function */ *)a0 passing:(void *)a1;
- (char)mapToPairs:(void /* function */ *)a0 passing:(void *)a1;
- (char)mapToPairsWithIndex:(void /* function */ *)a0 passing:(void *)a1;
- (char)mapWithIndex:(void /* function */ *)a0 from:(unsigned int)a1 length:(unsigned int)a2 passing:(void *)a3;
- (char)mapWithIndex:(void /* function */ *)a0 passing:(void *)a1;
...
- (char)removeSubsequences:(id)a0 whereTrue:(void /* function */ *)a1 passing:(void *)a2;
- (char)removeToSubsequence:(id)a0 ifTrue:(void /* function */ *)a1 passing:(void *)a2;
