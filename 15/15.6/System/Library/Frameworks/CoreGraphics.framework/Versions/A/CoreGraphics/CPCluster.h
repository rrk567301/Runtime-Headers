@interface CPCluster : NSObject <CPDisposable> {
    const struct { double x0; unsigned int x1; double x2; double x3; unsigned int x4; double x5; double x6; char x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; double x17; double x18; char x19; } *profile;
    unsigned int xCount;
    double *x;
    double *dx;
...
- (char)applyDifferenceHints:(struct { unsigned int x0; double x1; double x2; double x3; } *)a0 count:(unsigned int)a1;
...
- (char)coalesceFrom:(unsigned int)a0 to:(unsigned int)a1;
...
- (void)findClustersFromCharacterSequence:(id)a0 withSpaceHint:(char)a1;
- (void)findClustersFromDifferences:(double *)a0 count:(unsigned int)a1;
- (void)findDensityClusters:(double *)a0 count:(unsigned int)a1;
- (id)initWithProfile:(const struct { double x0; unsigned int x1; double x2; double x3; unsigned int x4; double x5; double x6; char x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; double x17; double x18; char x19; } *)a0;
- (char)joinClosestLevelPairFrom:(unsigned int)a0 to:(unsigned int)a1;
- (char)joinLevelsFrom:(unsigned int)a0 to:(unsigned int)a1;
...
- (char)splitLevelAtIndex:(unsigned int)a0 betweenValue:(double)a1 andValue:(double)a2;
