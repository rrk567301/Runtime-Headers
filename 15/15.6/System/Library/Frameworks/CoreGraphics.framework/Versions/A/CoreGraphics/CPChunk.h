...
- (char)boundsEqualsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 accuracy:(double)a1;
...
- (char)geometricallyContains:(id)a0;
- (long long)insertionOrder;
- (char)intersectsChild:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (id)newTakeChildrenAmong:(id)a0;
- (float)opticalLeading;
- (void)orderedInsert:(id)a0 usingSelector:(SEL)a1;
- (char)overlapsHorizontallyWith:(id)a0;
- (char)overlapsVerticallyWith:(id)a0;
...
- (void)setShrinksWithChildren:(char)a0;
- (char)shrinksWithChildren;
