...
- (id)descendantsOfClass:(Class)a0 deep:(char)a1;
...
- (void)map:(SEL)a0 target:(id)a1 childrenOfClass:(Class)a2 last:(char)a3;
- (void)map:(SEL)a0 target:(id)a1 last:(char)a2;
