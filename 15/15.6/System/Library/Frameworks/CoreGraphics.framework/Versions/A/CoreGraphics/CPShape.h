...
- (void)accept:(id)a0;
- (char)canCombineWith:(id)a0;
- (void)recomputeBounds;
- (void)addShape:(id)a0;
- (struct CGPDFObject { } *)fillObject;
- (char)hasSamePathAs:(id)a0;
- (char)hasStroke;
- (id)initWithPDFShape:(struct CPPDFShape { struct CPPDFObject { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; unsigned int x2; unsigned int x3; } x0; unsigned int x1; struct CPPDFStyle *x2; int x3; struct CGPath *x4; char x5; struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x6; struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } x7; long long x8; } *)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })innerBounds;
- (char)isStrokeFor:(id)a0;
- (char)isUprightRectangle;
- (int)lineJoin;
