...
- (void)findClickableObjects:(char)a0;
- (id)findObjectIn:(id)a0 at:(struct CGPoint { double x0; double x1; })a1 count:(int *)a2;
- (char)hitTestGraphicObject:(id)a0 point:(struct CGPoint { double x0; double x1; })a1;
- (char)hitTestParagraph:(id)a0 point:(struct CGPoint { double x0; double x1; })a1;
