...
@interface NLEmbedding : NSObject {
    void *_embedding;
    NLModel *_nlModel;
    char _usesUntokenizedSentences;
}
...
+ (char)_writeEmbeddingForDictionary:(id)a0 language:(id)a1 revision:(unsigned long long)a2 toURL:(id)a3 orData:(id)a4 error:(id *)a5;
+ (char)assetsAvailableForEmbeddingType:(id)a0 language:(id)a1;
...
+ (char)writeEmbeddingForDictionary:(id)a0 language:(id)a1 revision:(unsigned long long)a2 toURL:(id)a3 error:(id *)a4;
+ (char)writeEmbeddingMLModelForDictionary:(id)a0 language:(id)a1 revision:(unsigned long long)a2 toURL:(id)a3 options:(id)a4 error:(id *)a5;

- (void)dealloc;
- (void).cxx_destruct;
- (char)containsString:(id)a0;
...
- (char)getVector:(float *)a0 forString:(id)a1;
...
- (void)setUsesUntokenizedSentences:(char)a0;
- (char)usesUntokenizedSentences;
