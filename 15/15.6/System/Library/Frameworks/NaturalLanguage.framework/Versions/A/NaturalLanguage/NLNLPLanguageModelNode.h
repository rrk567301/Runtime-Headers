...
+ (id)conditionalProbabilitiesForStrings:(id)a0 modelState:(void *)a1 copyRequired:(char)a2;
...
- (void)_evaluateChildrenWithModelState:(void *)a0 copyRequired:(char)a1 probability:(double)a2 dictionary:(id)a3;
