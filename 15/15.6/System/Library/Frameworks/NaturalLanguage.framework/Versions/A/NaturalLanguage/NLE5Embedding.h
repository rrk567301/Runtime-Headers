...
+ (id)logCategory;
+ (char)compileEmbeddingModelWithModelPath:(id)a0 useANE:(char)a1 adapters:(id)a2;
+ (id)embeddingModelWithModelPath:(id)a0 useANE:(char)a1 adapters:(id)a2;
+ (char)isCompiledEmbeddingModelWithModelPath:(id)a0 useANE:(char)a1 adapters:(id)a2 error:(id *)a3;
...
- (char)_loadFunction:(const char *)a0;
- (void)_setInputFragments:(int *)a0 count:(unsigned long long)a1;
- (id)_tokenIDsForText:(id)a0 addBOS:(char)a1;
...
- (char)isAdapterLoaded:(id)a0;
- (char)isBackboneLoaded;
- (char)loadAdapter:(id)a0;
- (char)loadBackbone;
