...
- (id)locatorsWithIndex:(unsigned long long)a0 parameters:(struct _NLConstraintParameters { char x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; })a1 tagger:(id)a2 tokenizer:(struct __CFStringTokenizer { } *)a3;
