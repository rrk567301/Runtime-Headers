...
- (char)_calculateHomographicWarpTransform:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a0 ofFloatingImagePixelBuffer:(struct __CVBuffer { } *)a1 ontoReferenceImagePixelBuffer:(struct __CVBuffer { } *)a2 usingImageRegistrationContext:(struct ImageRegistrationCtx_s { } *)a3 seededWithPreviousWarpTransform:(const struct { void /* unknown type, empty encoding */ x0[3]; } *)a4 error:(id *)a5;
...
- (char)_createN:(unsigned long long)a0 CVPixelBuffers:(struct __CVBuffer **)a1 withPixelFormat:(unsigned int)a2 width:(unsigned long long)a3 height:(unsigned long long)a4 error:(id *)a5;
