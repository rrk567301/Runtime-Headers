...
- (char)_createLowResMaskFromLowResImage:(struct __CVBuffer { } *)a0 outMaskPixelBuffer:(struct __CVBuffer **)a1 outInstanceMaskPixelBuffer:(struct __CVBuffer **)a2 outNumComponents:(unsigned long long *)a3 outConfidenceScore:(float *)a4 error:(id *)a5;
- (char)_filterUsingConnectedComponentsFromSegmentation:(struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a0 outInstanceMask:(struct __CVBuffer **)a1 numComponents:(unsigned long long *)a2;
