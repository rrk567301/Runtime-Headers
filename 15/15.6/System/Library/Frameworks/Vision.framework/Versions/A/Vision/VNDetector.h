...
+ (char)areExistingInitializationOptions:(id)a0 compatibleWithOptions:(id)a1;
...
+ (char)loadedInstanceWithBoundComputeStageDevices:(id)a0 canBeUsedForRequestedComputeStageDevices:(id)a1;
+ (char)loadedInstanceWithComputeDevice:(id)a0 boundToComputeStage:(id)a1 canBeUsedForProcessingDeviceBridge:(id)a2;
+ (char)producesObservationsForMultipleRequestClasses;
+ (void)recordDefaultConfigurationOptionsInDictionary:(id)a0;
+ (char)runSuccessReportingBlockSynchronously:(id /* block */)a0 detector:(id)a1 qosClass:(unsigned int)a2 error:(id *)a3;
...
- (char)getOptionalCanceller:(id *)a0 inOptions:(id)a1 error:(id *)a2;
...
- (char)useGPU;
- (char)validateImageBuffer:(id)a0 error:(id *)a1;
- (id)validatedImageBufferFromOptions:(id)a0 error:(id *)a1;
- (char)warmUpSession:(id)a0 withOptions:(id)a1 error:(id *)a2;
