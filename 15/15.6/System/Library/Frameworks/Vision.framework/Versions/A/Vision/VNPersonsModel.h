...
+ (char)readObjectForModelVersion:(unsigned long long)a0 tag:(unsigned int)a1 fromInputStream:(id)a2 intoObjectDictionary:(id)a3 md5Context:(struct CC_MD5state_st { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6[16]; int x7; } *)a4 error:(id *)a5;
...
- (char)dropCurrentFaceModelAndReturnError:(id *)a0;
...
- (char)updateInternalConfigurationWithModelFaceprintRequestRevision:(unsigned long long)a0 error:(id *)a1;
