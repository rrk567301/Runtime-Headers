...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)bindOutputConfidenceBuffersAndReturnError:(id *)a0;
- (char)validateMaskForBlobName:(id)a0 options:(id)a1 maskConfidence:(float *)a2 maskAcceptable:(char *)a3 error:(id *)a4;
