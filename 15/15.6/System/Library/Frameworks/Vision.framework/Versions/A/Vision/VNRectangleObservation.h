...
- (void)getTopLeftPoint:(struct CGPoint { double x0; double x1; } *)a0 topRightPoint:(struct CGPoint { double x0; double x1; } *)a1 bottomRightPoint:(struct CGPoint { double x0; double x1; } *)a2 bottomLeftPoint:(struct CGPoint { double x0; double x1; } *)a3 inTopLeftOrigin:(char)a4 orientation:(unsigned int)a5;
