@class VNBGRBilinearUpsampler, VNMetalContext, VNEspressoResources;
...
- (char)_removeBackgroundFromPixelBuffer:(SEL)a0 toPixelBuffer:(struct __CVBuffer { } *)a1 usingMask:(struct __CVBuffer { } *)a2 offset:(struct __CVBuffer { } *)a3 error:(id *)a4;
- (char)_runInitializerModelWithLockedPixelBuffer:(struct __CVBuffer { } *)a0 forState:(id)a1 error:(id *)a2;
- (char)_runUpdateModelWithLockedPixelBuffer:(struct __CVBuffer { } *)a0 forState:(id)a1 outputQualityEspressoBuffer:(struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a2 error:(id *)a3;
