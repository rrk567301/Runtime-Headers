...
- (char)_createImagePyramidWithCommandBuffer:(id)a0 in_pixelbuf:(struct __CVBuffer { } *)a1 I_idx:(int)a2 error:(id *)a3;
...
- (char)_setupBufferAndReturnError:(id *)a0;
- (char)_setupPipelinesReturnError:(id *)a0;
