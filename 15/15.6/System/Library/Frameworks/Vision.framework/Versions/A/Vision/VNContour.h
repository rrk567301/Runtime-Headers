...
- (struct CGPath { } *)normalizedPathInTopLeftOrigin:(char)a0 orientation:(unsigned int)a1;
- (const void *)normalizedPointsInTopLeftOrigin:(char)a0 orientation:(unsigned int)a1;
