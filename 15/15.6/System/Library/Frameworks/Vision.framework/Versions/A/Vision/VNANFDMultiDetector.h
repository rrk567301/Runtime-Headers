@class NSArray, NSDictionary, VNShotflowDetector, VNFaceBBoxAligner;
...
+ (id)defaultFilterThresholdsForOptions:(id)a0 error:(id *)a1;
...
- (id)applicableOptionKeyToShotflowKeyMappingsForOptions:(id)a0 error:(id *)a1;
...
- (id)filterThresholdsForOptions:(id)a0 error:(id *)a1;
