...
- (char)applyEspressoMask:(const struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a0 toImage:(struct __CVBuffer { } *)a1 highResMaskBuffer:(struct __CVBuffer { } *)a2;
- (char)applyPixelBufferMask:(struct __CVBuffer { } *)a0 toImage:(struct __CVBuffer { } *)a1 highResMaskBuffer:(struct __CVBuffer { } *)a2;
- (char)applyTextureMask:(id)a0 toImage:(struct __CVBuffer { } *)a1 highResMaskBuffer:(struct __CVBuffer { } *)a2;
- (id)computePipelineStateFor:(id)a0;
- (char)handlePostProcessingRequest:(struct { struct __CVBuffer *x0; struct *x1; struct __CVBuffer *x2; } *)a0;
