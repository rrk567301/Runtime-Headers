...
- (char)_performOrderedRequests:(id)a0 inContext:(id)a1 error:(id *)a2;
- (char)_performRequests:(id)a0 onBehalfOfRequest:(id)a1 inContext:(id)a2 error:(id *)a3;
- (char)_validateAndPrepareRequests:(id)a0 error:(id *)a1;
...
- (char)performDependentRequests:(id)a0 onBehalfOfRequest:(id)a1 inContext:(id)a2 error:(id *)a3;
- (char)performRequests:(id)a0 inContext:(id)a1 error:(id *)a2;
