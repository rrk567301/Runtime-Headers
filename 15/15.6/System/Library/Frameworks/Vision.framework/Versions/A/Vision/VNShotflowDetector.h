...
- (id)detect:(const struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 inputIsBGR:(char)a1;
- (id)detectAndProcessObjects:(const struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 filterThresholds:(id)a1 inputIsBGR:(char)a2;
