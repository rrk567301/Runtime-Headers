...
- (struct __CVBuffer { } *)createProbabilityImageOfFaceSegment:(unsigned long long)a0 region:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 normalize:(char)a2 error:(id *)a3;
