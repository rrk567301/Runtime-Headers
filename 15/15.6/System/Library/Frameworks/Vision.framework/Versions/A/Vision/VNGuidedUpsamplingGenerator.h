...
- (char)_renderCIImage:(id)a0 toBuffer:(void *)a1 width:(unsigned long long)a2 height:(unsigned long long)a3 rowBytes:(unsigned long long)a4 format:(unsigned int)a5 vnciContextManager:(id)a6 error:(id *)a7;
