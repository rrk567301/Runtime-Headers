...
+ (id)emptyFaceprintDataForRevision:(unsigned long long)a0;
...
- (id)initWithRawData:(const void *)a0 confidence:(float)a1 requestRevision:(unsigned long long)a2;
- (id)initWithRawData:(const void *)a0 elementCount:(unsigned long long)a1 elementType:(unsigned long long)a2 lengthInBytes:(unsigned long long)a3 confidence:(float)a4 requestRevision:(unsigned long long)a5;
- (char)isEquivalentToVNEntityIdentificationModelPrint:(id)a0;
