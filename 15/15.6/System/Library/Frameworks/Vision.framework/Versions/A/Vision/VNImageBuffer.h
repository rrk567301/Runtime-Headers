...
- (char)getPixelFocalLengthIfAvailable:(float *)a0;
...
- (char)getCameraIntrinsicsAvailable:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a0;
- (char)getCameraOpticalCenterIfAvailable:(struct CGPoint { double x0; double x1; } *)a0;
