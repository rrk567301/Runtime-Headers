...
- (void).cxx_destruct;
- (char)_addInstanceMaskBuffersForCategory:(id)a0 instanceFeatures:(id)a1 toInstanceMaskArray:(id)a2 connectedComponentResult:(const void *)a3 featureInstanceMaskMap:(id)a4 categoryInstanceMaskMap:(id)a5 options:(id)a6 error:(id *)a7;
...
- (char)_instanceMask:(struct __CVBuffer { } *)a0 containsTargetPoints:(id)a1;
...
- (char)_validatePoints:(id)a0 error:(id *)a1;
