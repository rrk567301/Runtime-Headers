...
@property (readonly, nonatomic) char isGS1DataCarrier;
@property (readonly, nonatomic) char isColorInverted;
...
- (char)_propertyAllowedForRevision;
...
- (id)initWithOriginatingRequestSpecifier:(id)a0 symbology:(id)a1 descriptor:(id)a2 mrcDescriptor:(struct __MRCDescriptor { } *)a3 topLeft:(struct CGPoint { double x0; double x1; })a4 topRight:(struct CGPoint { double x0; double x1; })a5 bottomRight:(struct CGPoint { double x0; double x1; })a6 bottomLeft:(struct CGPoint { double x0; double x1; })a7;
