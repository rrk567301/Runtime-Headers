...
- (void).cxx_destruct;
- (void)_calculateTilesHorizontally:(char)a0 vertically:(char)a1 tileAspectRatio:(double)a2 overlapPercentage:(double)a3 tileOverflowCount:(unsigned long long)a4 addTileBlock:(id /* block */)a5 columnCount:(unsigned long long *)a6 rowCount:(unsigned long long *)a7;
