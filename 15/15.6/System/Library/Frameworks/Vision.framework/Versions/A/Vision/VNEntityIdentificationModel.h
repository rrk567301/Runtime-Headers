...
+ (char)readObjectForVersion1Tag:(unsigned int)a0 fromInputStream:(id)a1 intoObjectDictionary:(id)a2 md5Context:(struct CC_MD5state_st { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6[16]; int x7; } *)a3 error:(id *)a4;
+ (id)supportedReadVersions;
+ (id)supportedRequestSpecifiers;
+ (id)supportedWriteVersions;
+ (char)validateAceptableObservation:(id)a0 forEntityPrintOriginatingRequestSpecifier:(id)a1 error:(id *)a2;
+ (char)validateConfiguration:(id)a0 error:(id *)a1;

- (void).cxx_destruct;
- (char)writeToURL:(id)a0 options:(id)a1 error:(id *)a2;
- (char)dropTrainedModelAndReturnError:(id *)a0;
- (id)observationCountsForAllEntities;
- (char)convertToAlgorithm:(id)a0 error:(id *)a1;
...
- (char)writeReadOnlyVersion1ToOutputStream:(id)a0 options:(id)a1 md5Context:(struct CC_MD5state_st { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6[16]; int x7; } *)a2 error:(id *)a3;
- (char)writeToStream:(id)a0 options:(id)a1 error:(id *)a2;
- (char)writeVersion1ToOutputStream:(id)a0 options:(id)a1 md5Context:(struct CC_MD5state_st { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6[16]; int x7; } *)a2 error:(id *)a3;
