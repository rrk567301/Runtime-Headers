...
+ (char)createSingleNetworkPlanFromModelPath:(id)a0 forComputeDevice:(id)a1 lowPriorityMode:(char)a2 priority:(int)a3 inputBlobNames:(id)a4 outputBlobNames:(id)a5 networkConfiguration:(id)a6 explicitNetworkLayersStorageType:(int)a7 memoryPoolId:(unsigned long long)a8 espressoResources:(id *)a9 error:(id *)a10;
+ (char)createSingleNetworkPlanFromModelPath:(id)a0 forComputeDevice:(id)a1 lowPriorityMode:(char)a2 priority:(int)a3 inputBlobNames:(id)a4 outputBlobNames:(id)a5 networkConfiguration:(id)a6 memoryPoolId:(unsigned long long)a7 espressoResources:(id *)a8 error:(id *)a9;
+ (int)espressoDeviceIDForComputeDevice:(id)a0;
+ (int)espressoStorageTypeForComputeDevice:(id)a0;
+ (char)feedForwardEspressoBufferForNetwork:(struct { void *x0; int x1; } *)a0 fromBufferWithName:(id)a1 toBufferWithName:(id)a2 firstFrame:(char)a3 error:(id *)a4;
+ (char)getWidth:(unsigned long long *)a0 height:(unsigned long long *)a1 ofBlobNamed:(id)a2 forNetworkModelFileWithPath:(id)a3 error:(id *)a4;
