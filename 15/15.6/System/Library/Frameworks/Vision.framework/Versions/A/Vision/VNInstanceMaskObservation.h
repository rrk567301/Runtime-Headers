...
- (struct __CVBuffer { } *)createMattedImageForInstances:(id)a0 fromRequestHandler:(id)a1 inPlace:(char)a2 croppedToInstancesExtent:(char)a3 error:(id *)a4;
- (struct __CVBuffer { } *)createMattedImageOfInstances:(id)a0 fromRequestHandler:(id)a1 croppedToInstancesExtent:(char)a2 error:(id *)a3;
- (struct __CVBuffer { } *)generateMaskedImageOfInstances:(id)a0 fromRequestHandler:(id)a1 croppedToInstancesExtent:(char)a2 error:(id *)a3;
- (struct __CVBuffer { } *)generateMaskedImageOfInstances:(id)a0 fromRequestHandler:(id)a1 inPlace:(char)a2 croppedToInstancesExtent:(char)a3 error:(id *)a4;
- (struct __CVBuffer { } *)generateMaskedImageOfInstances:(id)a0 fromRequestHandler:(id)a1 inPlace:(char)a2 croppedToInstancesExtent:(char)a3 returnCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a4 error:(id *)a5;
- (struct __CVBuffer { } *)generateMaskedImageOfInstances:(id)a0 imageBuffer:(id)a1 inPlace:(char)a2 croppedToInstancesExtent:(char)a3 error:(id *)a4;
- (struct __CVBuffer { } *)generateScaledMaskForImageForInstances:(id)a0 fromRequestHandler:(id)a1 error:(id *)a2;
- (struct __CVBuffer { } *)generateScaledMaskForImageForInstances:(id)a0 imageBuffer:(id)a1 croppedToInstancesExtent:(char)a2 error:(id *)a3;
