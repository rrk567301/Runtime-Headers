...
- (char)_saveFaceAttributes:(void *)a0 toFaceObservation:(id)a1 options:(id)a2 error:(id *)a3;
- (char)_saveFaceprint:(struct shared_ptr<vision::mod::ImageDescriptorBufferAbstract> { struct ImageDescriptorBufferAbstract *x0; struct __shared_weak_count *x1; })a0 toFaceObservation:(id)a1 options:(id)a2 error:(id *)a3;
