...
+ (char)getRequiredObject:(id *)a0 ofClass:(Class)a1 forKey:(id)a2 inOptions:(id)a3 error:(id *)a4;
...
+ (char)supportsAnyRevision:(unsigned long long)a0;
+ (char)supportsPrivateRevision:(unsigned long long)a0;
+ (char)supportsRevision:(unsigned long long)a0;
...
- (id)warnings;
- (char)setRevision:(unsigned long long)a0 error:(id *)a1;
...
- (char)cancellationTriggeredAndReturnError:(id *)a0;
...
- (char)internalCancelInContext:(id)a0 error:(id *)a1;
...
- (char)performInContext:(id)a0 error:(id *)a1;
...
- (void)setAsyncStatus:(char)a0 error:(id)a1;
- (void)setComputeDevice:(id)a0 forComputeStage:(id)a1;
- (void)setProcessedResults:(id)a0;
- (void)setResults:(id)a0 assignedWithOriginatingSpecifier:(char)a1;
...
- (char)validateImageBuffer:(id)a0 ofNonZeroWidth:(unsigned long long *)a1 andHeight:(unsigned long long *)a2 error:(id *)a3;
- (id)valueForWarning:(id)a0;
- (char)wantsSequencedRequestObservationsRecording;
- (char)warmUpApplicableDetectorInSession:(id)a0 error:(id *)a1;
- (char)warmUpSession:(id)a0 error:(id *)a1;
