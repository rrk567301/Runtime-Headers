...
+ (char)computeDevice:(id)a0 isOneTypeOfTypes:(unsigned long long)a1;
...
+ (char)isCPUComputeDevice:(id)a0;
+ (char)isGPUComputeDevice:(id)a0;
+ (char)isNeuralEngineComputeDevice:(id)a0;
