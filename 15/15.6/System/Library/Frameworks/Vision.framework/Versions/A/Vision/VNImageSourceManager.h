...
- (struct CGImageSource { } *)_cgImageSourceAtAddress:(struct CGImageSource **)a0 forSubSampleFactor:(unsigned int)a1 protectedWithUnfairLock:(struct os_unfair_lock_s { unsigned int x0; } *)a2 operatingInLowPriority:(char)a3 error:(id *)a4;
