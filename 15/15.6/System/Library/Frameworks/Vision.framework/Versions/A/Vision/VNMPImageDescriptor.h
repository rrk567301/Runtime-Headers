...
- (char)computeConvnetDescriptorForImageData:(id)a0 context:(id)a1 error:(id *)a2;
- (char)computeDescriptorForImageData:(id)a0 context:(id)a1 error:(id *)a2;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)a0 andSceneClassifierDistance:(float)a1;
- (char)computeRegistrationFeaturesForImageData:(id)a0 context:(id)a1 error:(id *)a2;
