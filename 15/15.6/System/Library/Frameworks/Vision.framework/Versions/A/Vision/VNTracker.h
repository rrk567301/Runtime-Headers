...
- (char)_updateTrackerWithModifiedBBoxForImageBuffer:(id)a0 error:(id *)a1;
- (char)_visionBBoxToTrackerBBox:(id)a0 trackedObjects:(void *)a1 imageSize:(struct CGSize { double x0; double x1; })a2 results:(id)a3 error:(id *)a4;
