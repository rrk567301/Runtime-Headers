...
- (char)getLandmarkErrorEstimates:(void *)a0 forRequestConstellation:(unsigned long long)a1 error:(id *)a2;
- (char)getLandmarkPoints:(void *)a0 forRequestConstellation:(unsigned long long)a1 error:(id *)a2;
...
- (char)requestConstellation:(unsigned long long *)a0 cvmlConstellation:(int *)a1 fromOptions:(id)a2 error:(id *)a3;
- (char)translateAndNormalizeLandmarkPointsWrtLLCofAlignedFaceBBox:(void *)a0 imageBuffer:(id)a1 outputFace:(id)a2 error:(id *)a3;
