@class VNFaceRegionMap, VNFaceScreenGaze, VNFaceprint, NSDictionary, VNFaceTorsoprint, VNFaceLandmarks2D, VNFaceSegments, VNTorsoprint, VNFaceLegacyFaceCore, VNFaceAttributes, VNFaceLandmarks3D, NSArray, NSData, NSNumber, VNFaceGaze, VNRequestSpecifier;
...
@property (readonly, nonatomic, getter=isBoundingBoxAligned) char boundingBoxAligned;
...
+ (char)computeYawPitchRollFromPoseMatrix:(struct { void /* unknown type, empty encoding */ x0[4]; })a0 outputYaw:(float *)a1 outputPitch:(float *)a2 outputRoll:(float *)a3;
...
+ (char)_exifOrientationFromFaceRollAngle:(float)a0 exifOrientation:(int *)a1 error:(id *)a2;
...
+ (id)faceObservationWithRequestRevision:(unsigned long long)a0 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 roll:(id)a2 yaw:(id)a3 pitch:(id)a4 isBoundingBoxAligned:(char)a5 alignedBoundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 landmarks:(id)a7 landmarks65:(id)a8 landmarkScore:(float)a9 isBlinking:(char)a10 blinkScore:(float)a11;
+ (id)faceObservationWithRequestRevision:(unsigned long long)a0 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 roll:(id)a2 yaw:(id)a3 pitch:(id)a4 isBoundingBoxAligned:(char)a5 alignedBoundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 landmarks:(id)a7 landmarks65:(id)a8 landmarkScore:(float)a9 isBlinking:(char)a10 blinkScore:(float)a11 faceOrientationIndex:(float)a12 faceJunkinessIndex:(float)a13;
...
- (char)getComputedRectifyingTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a0;
...
- (id)faceTorsoprint;
- (id)faceprint;
- (char)getFaceEXIFOrientation:(int *)a0 error:(id *)a1;
- (id)initWithRequestRevision:(unsigned long long)a0;
- (char)isBlinking;
- (char)isRevision1DetectedRectanglesCompatible;
- (float)landmarkScore;
- (void)setBlinkScore:(float)a0;
- (void)setBoundingBoxAligned:(char)a0;
- (void)setExpressionsAndScores:(id)a0;
- (void)setFaceCaptureQuality:(float)a0 originatingRequestSpecifier:(id)a1;
...
- (void)setFaceTorsoprint:(id)a0;
- (void)setFaceprint:(id)a0;
- (void)setGaze:(id)a0;
- (void)setIsBlinking:(char)a0;
...
- (id)torsoprint;
- (void)updateFaceCaptureQuality:(id)a0;
- (id)vn_cloneObject;
