...
@interface VNImageAnalyzerMultiDetector : VNDetector {
    ...
    char _hasherInitialized;
}

@property (readonly) char hasObjDetNet;
@property (readonly) char hasSliderNet;

+ (char)_getAssociatedBoundingBoxGeneratorClass:(Class *)a0 options:(id *)a1 forConfigurationOptions:(id)a2 error:(id *)a3;
