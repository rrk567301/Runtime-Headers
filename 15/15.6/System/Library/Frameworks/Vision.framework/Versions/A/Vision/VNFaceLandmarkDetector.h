...
@interface VNFaceLandmarkDetector : VNEspressoModelFileBasedDetector <VNDetectorKeyProviding> {
    ...
    char _requireFaceAttributesPupilRefiner;
...
- (char)detectBlinkOnFaceImage:(const struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 faceObservation:(id)a1 lumaRec2DInImageCoordinates:(struct _Geometry2D_rect2D_ { struct _Geometry2D_point2D_ { float x0; float x1; } x0; struct _Geometry2D_size2D_ { float x0; float x1; } x1; } *)a2 landmarks:(const void *)a3 warningRecorder:(id)a4 error:(id *)a5;
- (char)loadRefinersAndReturnError:(id *)a0;
- (char)postprocessLandmarkResultsForLandmarks:(const void *)a0 imageBuffer:(id)a1 outputFace:(id)a2 options:(id)a3 warningRecorder:(id)a4 error:(id *)a5;
