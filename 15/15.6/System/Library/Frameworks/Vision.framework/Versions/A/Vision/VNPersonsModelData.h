...
- (char)_addUniqueFaceObservations:(id)a0 toPersonWithUniqueIdentifier:(id)a1 error:(id *)a2;
...
- (id)_uniqueFaceObservationsWithRegistrationState:(char)a0 forFaceObservations:(id)a1 withExpectedFaceprintRequestRevision:(unsigned long long)a2 ofPersonWithUniqueIdentifier:(id)a3 error:(id *)a4;
