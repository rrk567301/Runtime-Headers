...
@property (readonly, nonatomic) char supportsProfileCapability;
@property (readonly, nonatomic) char supportsPropertyCapability;
...
- (char)disableProfile:(id)a0 onChannel:(unsigned char)a1 error:(id *)a2;
- (char)enableProfile:(id)a0 onChannel:(unsigned char)a1 error:(id *)a2;
...
- (char)toggleProfile:(id)a0 onChannel:(unsigned char)a1 enabling:(char)a2 error:(id *)a3;
