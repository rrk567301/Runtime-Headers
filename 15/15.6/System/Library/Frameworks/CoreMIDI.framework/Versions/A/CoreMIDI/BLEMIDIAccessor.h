...
+ (char)deviceIsOnline:(unsigned int)a0;
+ (unsigned int)localPeripheral;
+ (char)deviceIsLocalPeripheral:(unsigned int)a0;
+ (char)deviceIsNullDevice:(unsigned int)a0;
+ (char)deviceIsRemotePeripheral:(unsigned int)a0;
...
+ (unsigned int)midiDeviceForUUID:(id)a0 isLocalPeripheral:(char)a1 isRemotePeripheral:(char)a2;
+ (id)nameForMIDIDevice:(unsigned int)a0;
+ (unsigned int)nullDevice;
+ (unsigned short)reconstructWithHighByte:(unsigned char)a0 lowByte:(unsigned char)a1 overflow:(char)a2;
