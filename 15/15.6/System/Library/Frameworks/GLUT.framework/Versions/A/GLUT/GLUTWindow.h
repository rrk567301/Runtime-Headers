...
- (void)zoom:(id)a0;
- (char)isFullscreen;
- (void)printOperationDidRun:(id)a0 success:(char)a1 contextInfo:(id)a2;
...
- (id)initWithContentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 pixelFormat:(id)a1 windowID:(int)a2 gameMode:(char)a3 treatAsSingle:(char)a4;
