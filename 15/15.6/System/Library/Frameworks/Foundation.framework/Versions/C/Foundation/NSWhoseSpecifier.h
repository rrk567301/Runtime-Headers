...
+ (char)_canCreateCollapsedSpecifierFromAbsolutePositionRecord:(id)a0;
+ (char)_canCreateCollapsedSpecifierFromRangeRecord:(id)a0;
...
- (char)_setEndSubelementFromDescriptor:(id)a0;
- (char)_setStartSubelementFromDescriptor:(id)a0;
