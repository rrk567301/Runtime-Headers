...
@interface NSFileAttributes : NSDictionary {
    ...
    struct { unsigned int creatorCode; unsigned int fileTypeCode; NSDate *creationDate; struct _fields { unsigned char creatorCode : 1; unsigned char fileTypeCode : 1; unsigned char extensionHidden : 1; unsigned char creationDate : 1; unsigned char fileBusy : 1; unsigned int reserved : 27; } validFields; char extensionHidden; char fileBusy; char _padding[2]; } catInfo;
    NSDictionary *extendedAttrs;
    int fileProtectionClass;
}

+ (id)_attributesAtPath:(id)a0 partialReturn:(char)a1 filterResourceFork:(char)a2 error:(id *)a3;
+ (id)_attributesAtURL:(id)a0 partialReturn:(char)a1 filterResourceFork:(char)a2 error:(id *)a3;
+ (char)_populateCatInfo:(struct { unsigned int x0; unsigned int x1; id x2; struct _fields { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned int x5 : 27; } x3; char x4; char x5; char x6[2]; } *)a0 forURL:(id)a1 statInfo:(struct stat { int x0; unsigned short x1; unsigned short x2; unsigned long long x3; unsigned int x4; unsigned int x5; int x6; struct timespec { long long x0; long long x1; } x7; struct timespec { long long x0; long long x1; } x8; struct timespec { long long x0; long long x1; } x9; struct timespec { long long x0; long long x1; } x10; long long x11; long long x12; int x13; unsigned int x14; unsigned int x15; int x16; long long x17[2]; } *)a2 error:(id *)a3;
+ (id)attributesAtPath:(id)a0 traverseLink:(char)a1;
