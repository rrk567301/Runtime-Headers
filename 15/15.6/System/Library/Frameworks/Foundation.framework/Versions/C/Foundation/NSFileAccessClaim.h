...
@property char shouldEnableMaterializationDuringAccessorBlock;

+ (char)canNewWriteOfItemAtLocation:(id)a0 options:(unsigned long long)a1 safelyOverlapExistingWriteOfItemAtLocation:(id)a2 options:(unsigned long long)a3;
+ (char)canReadingItemAtLocation:(id)a0 options:(unsigned long long)a1 safelyOverlapNewWriting:(char)a2 ofItemAtLocation:(id)a3 options:(unsigned long long)a4;
...
- (void)_protectIfNecessaryFileAtURL:(id)a0 withOptions:(unsigned long long)a1 forReading:(char)a2;
- (void)_setupWithClaimID:(id)a0 purposeID:(id)a1 originatingReactorQueueID:(id)a2;
- (char)_writeArchiveOfDirectoryAtURL:(id)a0 toURL:(id)a1 error:(id *)a2;
...
- (char)canAccessLocations:(id)a0 forReading:(char)a1 error:(id *)a2;
- (void)cancelled;
- (char)checkIfSymbolicLinkAtURL:(id)a0 withResolutionCount:(long long *)a1 andIfSoThenReevaluateSelf:(id /* block */)a2;
- (id)claimerError;
- (char)claimerInvokingIsBlockedByReactorWithID:(id)a0;
- (id)client;
...
- (void)invokeClaimer;
- (char)isBlockedByClaimWithPurposeID:(id)a0;
...
- (void)makePresentersOfItemAtLocation:(id)a0 orContainedItem:(char)a1 relinquishUsingProcedureGetter:(id /* block */)a2;
...
- (char)shouldInformProvidersAboutEndOfWriteWithOptions:(unsigned long long)a0;
- (char)shouldMakeProviderProvideItemAtLocation:(id)a0 withOptions:(unsigned long long)a1;
- (char)shouldReadingWithOptions:(unsigned long long)a0 causePresenterToRelinquish:(id)a1;
- (char)shouldWritingWithOptions:(unsigned long long)a0 causePresenterToRelinquish:(id)a1;
