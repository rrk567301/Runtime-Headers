...
+ (id)_copyByArchiving:(id)a0;
+ (char)_evaluateCycleSecurityRules:(struct NSKeyedUnarchiverCycleEvaluationRules { char x0; char x1; char x2; char x3; char x4; } *)a0;
...
- (char)_decodingCyclesIsAllowed;
- (void)_enforceExplicitPlistTypes;
- (void)_enforceSubclassesMustBeExplicitlyMentionedWhenDecoded;
- (id)_initForReadingFromData:(id)a0 error:(id *)a1 throwLegacyExceptions:(char)a2;
...
- (char)_validateAllowedClassesContainsClassOfReference:(id)a0 forKey:(id)a1;
- (char)_willEnforceExplicitPlistTypes;
- (Class)classForClassName:(id)a0;
