...
- (id)_dateFormat;
- (id)_getLocaleAlreadyLocked:(char)a0;
...
- (void)_reset;
- (void)_setDateFormat:(id)a0 alreadyLocked:(char)a1;
- (void)_setIsLenient:(char)a0;
...
- (id)initWithDateFormat:(id)a0 allowNaturalLanguage:(char)a1;
