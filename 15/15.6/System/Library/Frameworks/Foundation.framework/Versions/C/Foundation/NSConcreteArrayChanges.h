...
@interface NSConcreteArrayChanges : NSArrayChanges {
    struct { isMutable *objects; char x0; struct { struct _NSOrderedChange *buffer; unsigned long long availableIndex; unsigned long long capacity; unsigned long long changesIndex; unsigned long long lastIndex; unsigned long long count; } list; } _changes;
}
...
- (void)_enumerateChanges:(unsigned long long)a0 stop:(char *)a1 usingBlock:(id /* block */)a2;
