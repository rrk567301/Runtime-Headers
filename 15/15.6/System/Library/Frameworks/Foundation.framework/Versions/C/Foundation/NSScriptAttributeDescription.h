...
- (id)initWithKey:(id)a0 type:(id)a1 access:(unsigned long long)a2 appleEventCode:(unsigned int)a3 isHidden:(char)a4 presentableDescription:(id)a5 name:(id)a6 synonymDescriptions:(id)a7 accessGroupDescriptions:(id)a8;
- (id)initWithKey:(id)a0 type:(id)a1 isReadOnly:(char)a2 appleEventCode:(unsigned int)a3 presentableDescription:(id)a4 nameOrNames:(id)a5;
