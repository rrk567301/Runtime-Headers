...
@property char usesMainThreadDuringReliquishing;
...
- (char)allowedForURL:(id)a0;
- (void)disconnect;
- (void)forwardRelinquishmentForWritingClaim:(char)a0 withID:(id)a1 purposeID:(id)a2 subitemURL:(id)a3 options:(unsigned long long)a4 completionHandler:(id /* block */)a5;
...
- (void)observePresenterChange:(char)a0 atSubitemURL:(id)a1;
...
- (char)shouldSendObservationMessageWithPurposeID:(id)a0;
