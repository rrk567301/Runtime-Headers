...
@property (readonly) char containsDotDotPathComponents;
...
+ (id)_stringWithFormat:(id)a0 locale:(id)a1 options:(id)a2 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a3;
...
+ (unsigned long long)stringEncodingForData:(id)a0 encodingOptions:(id)a1 convertedString:(id *)a2 usedLossyConversion:(char *)a3;
...
- (char)ls_matchesStringForPluginQuery:(id)a0;
- (id)ls_cleanForPluginQuery;
- (char)ls_isRecursiveKey;
- (char)ls_matchesForPluginQuery:(id)a0;
- (id)ls_updatedKey;
...
- (id)initWithFormat:(id)a0 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a1;
- (int)intValue;
- (char)isNSString__;
...
- (id)dataUsingEncoding:(unsigned long long)a0 allowLossyConversion:(char)a1;
...
- (id)stringByApplyingTransform:(id)a0 reverse:(char)a1;
...
- (char)__oldnf_containsCharFromSet:(id)a0;
- (char)__oldnf_containsString:(id)a0;
...
- (char)matchesPattern:(id)a0 caseInsensitive:(char)a1;
- (id)__escapeString5991;
- (char)__oldnf_containsChar:(char)a0;
- (void)__oldnf_copyToUnicharBuffer:(unsigned short **)a0 saveLength:(long long *)a1;
- (char)__swiftFillFileSystemRepresentationWithPointer:(char *)a0 maxLength:(long long)a1;
...
- (void)_getBlockStart:(unsigned long long *)a0 end:(unsigned long long *)a1 contentsEnd:(unsigned long long *)a2 forRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 stopAtLineSeparators:(char)a4;
...
- (char)_getBytesAsData:(id *)a0 maxLength:(unsigned long long)a1 usedLength:(unsigned long long *)a2 encoding:(unsigned long long)a3 options:(unsigned long long)a4 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5 remainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a6;
- (id)_getCharactersAsStringInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)_initWithBytesOfUnknownEncoding:(char *)a0 length:(unsigned long long)a1 copy:(char)a2 usedEncoding:(unsigned long long *)a3;
...
- (id)_initWithFormat:(id)a0 options:(id)a1 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2;
...
- (id)_initWithValidatedFormat:(id)a0 validFormatSpecifiers:(id)a1 options:(id)a2 error:(id *)a3 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a4;
- (char)_matchesCharacter:(unsigned short)a0;
...
- (char)_web_hasCaseInsensitivePrefix:(id)a0;
- (char)_web_hasCountryCodeTLD;
- (char)_web_isCaseInsensitiveEqualToString:(id)a0;
- (char)_web_isFileURL;
...
- (id)_web_parseAsKeyValuePairHandleQuotes_nowarn:(char)a0;
...
- (unsigned long long)completePathIntoString:(id *)a0 caseSensitive:(char)a1 matchesIntoArray:(id *)a2 filterTypes:(id)a3;
...
- (char)getBytes:(char *)a0 maxLength:(unsigned long long)a1 filledLength:(unsigned long long *)a2 encoding:(unsigned long long)a3 allowLossyConversion:(char)a4 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a5 remainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a6;
...
- (char)getExternalRepresentation:(id *)a0 extendedAttributes:(id *)a1 forWritingToURLOrPath:(id)a2 usingEncoding:(unsigned long long)a3 error:(id *)a4;
...
- (id)initWithValidatedFormat:(id)a0 validFormatSpecifiers:(id)a1 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a2 error:(id *)a3;
...
- (char)localizedCaseInsensitiveContainsString:(id)a0;
- (long long)localizedCompare:(id)a0;
- (char)localizedHasPrefix:(id)a0;
- (char)localizedHasSuffix:(id)a0;
- (id)localizedLowercaseString;
- (char)localizedStandardContainsString:(id)a0;
...
- (char)writeToFile:(id)a0 atomically:(char)a1 encoding:(unsigned long long)a2 error:(id *)a3;
- (char)writeToURL:(id)a0 atomically:(char)a1;
- (char)writeToURL:(id)a0 atomically:(char)a1 encoding:(unsigned long long)a2 error:(id *)a3;
