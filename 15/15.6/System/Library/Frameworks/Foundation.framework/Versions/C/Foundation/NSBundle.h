...
- (id)_localizedStringForKey:(id)a0 value:(id)a1 table:(id)a2 localizations:(id)a3;
...
- (int)_preferredExecutableArchitecture;
- (id)_regionsArray;
- (char)_searchForLocalizedString:(id)a0 foundKey:(id *)a1 foundTable:(id *)a2;
...
- (char)preflightAndReturnError:(id *)a0;
