...
- (id)_childrenExcludingExcessNodes:(char)a0 excludingReactors:(char)a1;
- (void)_forEachRelevantAccessClaimExcludingClaimsFromSuperarbiter:(char)a0 performProcedure:(id /* block */)a1;
- (char)_mayContainCriticalDebuggingInformationExcludingReactors:(char)a0;
...
- (id)descendantAtPath:(id)a0 componentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 create:(char)a2;
- (id)descendantAtPath:(id)a0 componentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 forAddingLeafNode:(id)a2 create:(char)a3;
- (id)descendantForFileURL:(id)a0;
- (id)descriptionWithIndenting:(id)a0 excludingExcessNodes:(char)a1 excludingReactors:(char)a2;
...
- (char)itemIsInItemAtLocation:(id)a0;
- (char)itemIsItemAtLocation:(id)a0;
