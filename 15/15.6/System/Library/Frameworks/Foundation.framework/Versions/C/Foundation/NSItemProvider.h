...
- (id)initWithContentsOfURL:(id)a0 contentType:(id)a1 openInPlace:(char)a2 coordinated:(char)a3 visibility:(long long)a4;
- (id)loadDataRepresentationForContentType:(id)a0 completionHandler:(id /* block */)a1;
- (id)loadFileRepresentationForContentType:(id)a0 openInPlace:(char)a1 completionHandler:(id /* block */)a2;
- (void)registerDataRepresentationForContentType:(id)a0 visibility:(long long)a1 loadHandler:(id /* block */)a2;
- (void)registerFileRepresentationForContentType:(id)a0 visibility:(long long)a1 openInPlace:(char)a2 loadHandler:(id /* block */)a3;
...
- (void)_commonInitGenerateUUID:(char)a0;
- (char)_hasRepresentationConformingToType:(id)a0;
- (char)_hasRepresentationOfType:(id)a0;
- (void)_loadItemOfClass:(Class)a0 forTypeIdentifier:(id)a1 options:(id)a2 coerceForCoding:(char)a3 completionHandler:(id /* block */)a4;
- (void)_loadItemOfClass:(Class)a0 withLoadHandler:(id /* block */)a1 options:(id)a2 coerceForCoding:(char)a3 completionHandler:(id /* block */)a4;
- (id)_loadObjectOfClass:(Class)a0 options:(id)a1 completionHandler:(id /* block */)a2;
- (void)_loadPreviewImageOfClass:(Class)a0 options:(id)a1 coerceForCoding:(char)a2 completionHandler:(id /* block */)a3;
...
- (char)hasItemConformingToTypeIdentifier:(id)a0;
- (char)hasRepresentationConformingToTypeIdentifier:(id)a0 fileOptions:(long long)a1;
