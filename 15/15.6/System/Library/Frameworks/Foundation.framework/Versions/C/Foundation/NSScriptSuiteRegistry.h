...
- (id)_classDescriptionForName:(id)a0 suiteName:(id)a1 isValid:(char *)a2;
...
- (id)_objectTypeDescriptionForClassAppleEventCode:(unsigned int)a0 isValid:(char *)a1;
...
- (id)_typeDescriptionForName:(id)a0 suiteName:(id)a1 isValid:(char *)a2;
