...
@interface NSScriptSuiteDescription : NSObject {
    struct { NSBundle *bundle; unsigned int appleEventCode; NSArray *classDescriptions; NSArray *commandDescriptions; NSArray *typeDescriptions; NSString *presentableDescription; NSObject *presentableNameOrNames; char isHidden; NSArray *accessGroupDescriptions; } _properties;
...
- (id)initWithProperties:(const struct { id x0; unsigned int x1; id x2; id x3; id x4; id x5; id x6; char x7; id x8; } *)a0 classExtensionDescriptions:(id)a1;
- (id)initWithProperties:(const struct { id x0; unsigned int x1; id x2; id x3; id x4; id x5; id x6; char x7; id x8; } *)a0 suiteName:(id)a1 usesUnnamedArguments:(char)a2 classSynonymDescriptions:(id)a3;
