...
- (void)dealloc;
- (id)description;
- (char)_acceptSentenceTerminatorRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 paragraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 tokens:(struct _NSLTToken { unsigned short x0; unsigned char x1; unsigned char x2; unsigned int x3; union { void *x0; struct { unsigned char x0; unsigned char x1; } x1; } x4; } *)a2 count:(unsigned long long)a3 tokenIndex:(unsigned long long)a4;
...
- (id)_tokenDataForParagraphAtIndex:(unsigned long long)a0 paragraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 requireLemmas:(char)a2 requirePartsOfSpeech:(char)a3 requireNamedEntities:(char)a4;
...
- (id)_tokenDataForParagraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 requireLemmas:(char)a1 requirePartsOfSpeech:(char)a2 requireNamedEntities:(char)a3;
- (void)_tokenizeParagraphAtIndex:(unsigned long long)a0 requireLemmas:(char)a1 requirePartsOfSpeech:(char)a2 requireNamedEntities:(char)a3;
