...
- (char)date:(id)a0 matchesComponents:(id)a1;
...
- (char)isDate:(id)a0 equalToDate:(id)a1 toUnitGranularity:(unsigned long long)a2;
- (char)isDate:(id)a0 inSameDayAsDate:(id)a1;
- (char)isDateInToday:(id)a0;
- (char)isDateInTomorrow:(id)a0;
- (char)isDateInWeekend:(id)a0;
- (char)isDateInYesterday:(id)a0;
...
- (char)nextWeekendStartDate:(id *)a0 interval:(double *)a1 options:(unsigned long long)a2 afterDate:(id)a3;
...
- (char)rangeOfUnit:(unsigned long long)a0 startDate:(id *)a1 interval:(double *)a2 forDate:(id)a3;
- (char)rangeOfWeekendStartDate:(id *)a0 interval:(double *)a1 containingDate:(id)a2;
