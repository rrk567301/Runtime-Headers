...
+ (id)_components;
+ (id)_componentsWithString:(id)a0 encodingInvalidCharacters:(char)a1;
+ (id)_componentsWithUrl:(id)a0 resolvingAgainstBaseURL:(char)a1;
...
+ (id)_parseString:(id)a0 encodingInvalidCharacters:(char)a1 compatibility:(unsigned char)a2;
+ (id)componentsWithString:(id)a0;
+ (id)componentsWithString:(id)a0 encodingInvalidCharacters:(char)a1;
+ (id)componentsWithURL:(id)a0 resolvingAgainstBaseURL:(char)a1;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)init;
- (id)URLRelativeToURL:(id)a0;
- (id)initWithString:(id)a0;
- (id)initWithURL:(id)a0 resolvingAgainstBaseURL:(char)a1;
