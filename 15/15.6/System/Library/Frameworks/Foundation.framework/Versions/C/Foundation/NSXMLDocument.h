...
+ (void)_setInstancesShouldLoadExternalEntities:(char)a0;
...
- (id)_canonicalXMLStringPreservingComments:(char)a0 namespaceString:(id)a1 relationships:(id)a2;
- (id)_children;
...
- (id)_tidyWithData:(id)a0 error:(id *)a1 isXML:(char)a2 detectedEncoding:(unsigned int)a3;
- (char)_validateWithSchemaAndReturnError:(id *)a0;
- (void)addChild:(id)a0;
...
- (void)setStringValue:(id)a0 resolvingEntities:(char)a1;
