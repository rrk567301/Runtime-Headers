...
- (char)_addPresenter:(id)a0 ofItemAtURL:(id)a1 watchingFile:(char)a2 withLastEventID:(id)a3;
- (char)_addProvider:(id)a0 ofItemsAtURL:(id)a1;
...
- (void)_handleDiskEvent:(unsigned long long)a0 forDisk:(struct __DADisk { } *)a1 volumeURL:(struct __CFURL { } *)a2 alreadyOnQueue:(char)a3;
...
- (void)_revokeAccessClaimForID:(id)a0 fromLocal:(char)a1;
- (void)_startArbitratingItemsAtURLs:(id)a0 withSuperarbitrationServer:(id)a1;
- (void)_uninstallImposterFirmlinksWithUUID:(id)a0;
- (void)_updateNodesForRemovedGroup:(id)a0 andNewGroup:(id)a1 alreadyOnQueue:(char)a2;
...
- (void)getDebugInformationIncludingEverything:(char)a0 withString:(id)a1 fromPid:(int)a2 thenContinue:(id /* block */)a3;
...
- (id)initWithQueue:(id)a0 isSubarbiter:(char)a1 listener:(id)a2;
...
- (void)provideSubarbiterDebugInfoIncludingEverything:(char)a0 completionHandler:(id /* block */)a1;
