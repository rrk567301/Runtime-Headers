...
@property (readonly, getter=isWellFormed) char wellFormed;
...
+ (char)_getReceiversSpecifierOrUnnamedArgument:(id *)a0 fromEvent:(id)a1 usingDescription:(id)a2;
+ (id)currentCommand;
...
- (char)_allowsAccessForEvent:(id)a0;
- (char)_allowsAccessForEventParameters:(id)a0 givenSenderAccessGroups:(id)a1;
- (char)_allowsAccessToSpecifier:(id)a0 writable:(char)a1 givenAccessGroups:(id)a2;
...
- (char)_setAdditionalThingsFromEvent:(id)a0;
