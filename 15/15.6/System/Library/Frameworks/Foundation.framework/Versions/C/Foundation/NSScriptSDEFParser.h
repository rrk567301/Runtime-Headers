...
- (char)_booleanValueForAttributeKey:(id)a0 fromElement:(id)a1;
- (char)_booleanValueForCocoaAttributeKey:(id)a0 fromElement:(id)a1;
...
- (id)_implementationAttribute:(id)a0 fromElement:(id)a1 withName:(id)a2 capitalizing:(char)a3;
...
- (id)_typeNameFromElement:(id)a0 isOptional:(char)a1;
...
- (void)setParsesCocoaElements:(char)a0;
