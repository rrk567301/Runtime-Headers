...
- (char)_bindNamespaceName:(id)a0 URI:(id)a1;
...
- (void)_setQNamesAreResolved:(char)a0;
...
- (void)normalizeAdjacentTextNodesPreservingCDATA:(char)a0;
...
- (char)validateName:(id *)a0 error:(id *)a1;
