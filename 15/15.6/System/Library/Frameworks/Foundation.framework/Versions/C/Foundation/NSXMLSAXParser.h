...
- (id)initWithData:(id)a0 isSingleDTDNode:(char)a1 options:(unsigned long long)a2 error:(id *)a3;
- (id)initWithData:(id)a0 options:(unsigned long long)a1 error:(id *)a2;
- (id)parse;
- (id)root;
- (void)setAfterEntityLookup:(char)a0;
- (void)setContent:(id)a0;
- (void)setCurrent:(id)a0;
- (void)setError:(long long)a0 info:(id)a1 fatal:(char)a2;
- (void)setRoot:(id)a0;
