...
- (int)__decodeXPCObject:(id)a0 allowingSimpleMessageSend:(char)a1 outInvocation:(id *)a2 outArguments:(id *)a3 outArgumentsMaxCount:(unsigned long long)a4 outMethodSignature:(id *)a5 outSelector:(SEL *)a6 isReply:(char)a7 replySelector:(SEL)a8;
...
- (int)_decodeMessageFromXPCObject:(id)a0 allowingSimpleMessageSend:(char)a1 outInvocation:(id *)a2 outArguments:(id *)a3 outArgumentsMaxCount:(unsigned long long)a4 outMethodSignature:(id *)a5 outSelector:(SEL *)a6;
...
- (char)_testClass:(Class)a0 isAllowedByAllowList:(id)a1;
- (void)_validateAllowedClass:(Class)a0 forKey:(id)a1 allowingInvocations:(char)a2;
