...
@property (readonly, getter=isMacCatalystApp) char macCatalystApp;
@property (readonly, getter=isiOSAppOnMac) char iOSAppOnMac;
...
- (id)bs_jobLabel;
- (char)hasPerformanceProfile:(long long)a0;
- (char)isDeviceCertifiedFor:(long long)a0;
- (void)dealloc;
