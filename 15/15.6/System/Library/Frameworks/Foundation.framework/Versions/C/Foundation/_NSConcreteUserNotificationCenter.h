...
- (void)_addScheduledNotification:(id)a0 immediate:(char)a1;
...
- (id)_retrieveServerArrayForMessageType:(int)a0 timedOut:(char *)a1;
- (char)_reverseDeliveredNotifications;
- (void)_sendAsyncMessage:(int)a0 withBlock:(id /* block */)a1;
- (void)_sendDelegateMessage:(SEL)a0 sendToAppDelegate:(char)a1 withNotificationFromMessage:(id)a2;
- (void)_sendDelegateMessage:(SEL)a0 sendToAppDelegate:(char)a1 withObject:(id)a2;
...
- (void)_setPreventApplicationLaunching:(char)a0;
- (void)_setProgress:(double)a0 forNotificationWithIdentifier:(id)a1;
- (void)_setReverseDeliveredNotifications:(char)a0;
