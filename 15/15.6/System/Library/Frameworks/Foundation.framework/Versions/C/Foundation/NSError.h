...
+ (id)rbs_errorClientNotEntitled:(id)a0 permanent:(char)a1;
...
+ (void)_setFileNameLocalizationEnabled:(char)a0;
...
- (char)rbs_isPermanentFailure;
- (id)initWithIOAccelError:(long long)a0;
- (char)isBSServiceConnectionError;
...
- (char)_web_errorIsInDomain:(id)a0;
