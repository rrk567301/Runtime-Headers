...
- (id)_initWithProperties:(const struct { id x0; id x1; unsigned int x2; unsigned int x3; id x4; id x5; id x6; id x7; char x8; id x9; id x10; id x11; } *)a0;
- (id)_initWithProperties:(const struct { id x0; id x1; unsigned int x2; unsigned int x3; id x4; id x5; id x6; id x7; char x8; id x9; id x10; id x11; } *)a0 commandName:(id)a1 resultTypeAppleEventCode:(unsigned int)a2;
- (id)_initWithSuiteName:(id)a0 commandName:(id)a1 implDeclaration:(id)a2 presoDeclaration:(id)a3;
- (char)_isFromSDEF;
- (char)_isHidden;
- (char)_matchesAppleEventCode:(unsigned int)a0 classCode:(unsigned int)a1;
...
- (char)isOptionalArgumentWithName:(id)a0;
