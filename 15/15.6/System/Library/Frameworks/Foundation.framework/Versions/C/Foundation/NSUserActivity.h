...
@property (getter=_isEligibleForUserActivityHandoff, setter=_setEligibleForUserActivityHandoff:) char _eligibleForUserActivityHandoff;
@property (getter=_isEligibleForUserActivityIndexing, setter=_setEligibleForUserActivityIndexing:) char _eligibleForUserActivityIndexing;
@property (getter=_isEligibleForUserActivityReminders, setter=_setEligibleForUserActivityReminders:) char _eligibleForUserActivityReminders;
@property (getter=_isEligibleForUserActivityPublicIndexing, setter=_setEligibleForUserActivityPublicIndexing:) char _eligibleForUserActivityPublicIndexing;
...
+ (char)_currentUserActivityUUIDWithOptions:(id)a0 completionHandler:(id /* block */)a1;
...
- (char)_createUserActivityDataWithOptions:(id)a0 completionHandler:(id /* block */)a1;
...
- (char)_createUserActivityStringsWithOptions:(id)a0 completionHandler:(id /* block */)a1;
