...
- (char)_appendWord:(in bycopy id)a0 toDictionary:(in bycopy id)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_findMisspelledWordInString:(in id)a0 language:(in bycopy id)a1 learnedDictionaries:(in bycopy id)a2 wordCount:(out long long *)a3 countOnly:(in char)a4;
- (char)_forgetWord:(in bycopy id)a0 inDictionary:(in bycopy id)a1;
- (oneway void)_invalidateDictionary:(in bycopy id)a0 newTime:(in long long)a1;
- (char)_isWord:(in bycopy id)a0 inDictionary:(in bycopy id)a1;
- (char)_learnWord:(in bycopy id)a0 inDictionary:(in bycopy id)a1;
...
- (id)autocorrectionDictionaryForLanguage:(id)a0 isGerman:(char *)a1;
...
- (struct __CFSet { } *)createDictHashTable:(char)a0;
- (char)isWord:(id)a0 inDictionaries:(id)a1 caseSensitive:(char)a2;
- (char)isWordInUserDictionaries:(id)a0 caseSensitive:(char)a1;
- (void)normalizeUserDictionary:(id)a0;
- (id)openUserDictionary:(id)a0;
- (char)registerLanguage:(id)a0 byVendor:(id)a1;
