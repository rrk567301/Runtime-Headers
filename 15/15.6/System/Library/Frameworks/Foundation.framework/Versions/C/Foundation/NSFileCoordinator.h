...
+ (char)_itemHasPresentersAtURL:(id)a0;
...
+ (void)_setAutomaticFileProviderReregistrationDisabled:(char)a0;
...
- (char)_isValidUbiquityAttribute:(id)a0;
...
- (id)_willStartWriteWithIntents:(id)a0 async:(char)a1;
- (void)_withAccessArbiter:(id)a0 invokeAccessor:(id /* block */)a1 orDont:(char)a2 andRelinquishAccessClaim:(id)a3;
- (void)cancel;
