...
@property (nonatomic) char automaticTerminationSupportEnabled;
@property (nonatomic, readonly) long long thermalState;
@property (nonatomic, readonly) char lowPowerModeEnabled;
...
@property (nonatomic, readonly) char macCatalystApp;
@property (nonatomic, readonly) char iOSAppOnMac;
...
- (char)isOperatingSystemAtLeastVersion:(struct { long long x0; long long x1; long long x2; })a0;
- (char)isiOSAppOnMac;
- (char)macCatalystVersionIsAtLeastVersion:(struct { long long x0; long long x1; long long x2; })a0;
