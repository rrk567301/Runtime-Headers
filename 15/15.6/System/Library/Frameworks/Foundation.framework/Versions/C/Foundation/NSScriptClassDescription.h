...
- (id)_initWithProperties:(const struct { id x0; id x1; unsigned int x2; id x3; id x4; id x5; id x6; id x7; id x8; id x9; id x10; char x11; id x12; id x13; } *)a0 defaultSubcontainerAttributeKey:(id)a1 inverseRelationshipKeys:(id)a2;
- (id)_initWithProperties:(const struct { id x0; id x1; unsigned int x2; id x3; id x4; id x5; id x6; id x7; id x8; id x9; id x10; char x11; id x12; id x13; } *)a0 primitiveType:(id)a1;
- (id)_initWithSuiteName:(id)a0 className:(id)a1 implDeclaration:(id)a2 presoDeclaration:(id)a3;
- (char)_isFromSDEF;
- (char)_isHidden;
- (char)_isSynonym;
- (char)_isToManyRelationshipOrderedForKey:(id)a0;
...
- (id)_propertyDescriptionForAppleEventCode:(unsigned int)a0 checkSubclasses:(char)a1;
- (id)_propertyDescriptionForAppleEventCode:(unsigned int)a0 checkSubclasses:(char)a1 superclasses:(char)a2;
- (id)_propertyDescriptionForKey:(id)a0 checkSubclasses:(char)a1;
- (id)_propertyDescriptionForKey:(id)a0 checkSubclasses:(char)a1 superclasses:(char)a2;
- (id)_propertyDescriptionForPresentableName:(id)a0 checkSubclasses:(char)a1 superclasses:(char)a2;
...
- (char)_shouldByDefaultInsertAtBeginningOfRelationshipForKey:(id)a0;
...
- (char)hasOrderedToManyRelationshipForKey:(id)a0;
- (char)hasPropertyForKey:(id)a0;
- (char)hasReadablePropertyForKey:(id)a0;
- (char)hasWritablePropertyForKey:(id)a0;
- (id)initWithSuiteName:(id)a0 className:(id)a1 dictionary:(id)a2;
- (id)inverseForRelationshipKey:(id)a0;
- (char)isLocationRequiredToCreateForKey:(id)a0;
- (char)isReadOnlyKey:(id)a0;
- (id)keyWithAppleEventCode:(unsigned int)a0;
- (char)matchesAppleEventCode:(unsigned int)a0;
- (SEL)selectorForCommand:(id)a0;
- (char)supportsCommand:(id)a0;
