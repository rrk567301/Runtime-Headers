...
- (id)initWithDictionary:(id)a0 copyItems:(char)a1;
...
- (unsigned long long)internalSaveTo:(id)a0 removeBackup:(char)a1 errorHandler:(id)a2;
- (unsigned long long)internalSaveTo:(id)a0 removeBackup:(char)a1 errorHandler:(id)a2 temp:(id)a3 backup:(id)a4;
- (unsigned long long)internalWritePath:(id)a0 errorHandler:(id)a1 remapContents:(char)a2 hardLinkPath:(id)a3;
...
- (unsigned long long)saveToDocument:(id)a0 removeBackup:(char)a1 errorHandler:(id)a2;
- (id)serialize:(void **)a0 length:(unsigned long long *)a1;
- (id)setPackage:(char)a0;
...
- (unsigned long long)writePath:(id)a0 docInfo:(id)a1 errorHandler:(id)a2 remapContents:(char)a3 markBusy:(char)a4 hardLinkPath:(id)a5;
