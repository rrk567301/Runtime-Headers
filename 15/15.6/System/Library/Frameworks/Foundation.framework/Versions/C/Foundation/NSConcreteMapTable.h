...
- (void)assign:(unsigned long long)a0 key:(const void *)a1 value:(const void *)a2 isNew:(char)a3;
- (void)checkCount:(const char *)a0;
- (char)containsKeys:(const void **)a0 values:(const void **)a1 count:(unsigned long long)a2;
- (id)dump;
...
- (char)mapMember:(const void *)a0 originalKey:(const void **)a1 value:(const void **)a2;
