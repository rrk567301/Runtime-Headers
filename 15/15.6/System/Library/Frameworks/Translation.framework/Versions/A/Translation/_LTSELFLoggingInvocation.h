...
@property (nonatomic) char endSent;
@property (readonly, nonatomic) NSUUID *invocationId;

+ (void)translationTTSPlayedWithInvocationId:(id)a0 sourceOrTargetLanguage:(long long)a1 isAutoplayTranslation:(char)a2 ttsPlaybackSpeed:(long long)a3 audioChannel:(long long)a4;
