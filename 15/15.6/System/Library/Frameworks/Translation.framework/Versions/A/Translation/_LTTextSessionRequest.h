...
@property (readonly, nonatomic) char isForDownloadRequest;
...
- (void)_cleanUp;
- (void)didComplete;
- (id)_initWithBatch:(id)a0 sourceLocale:(id)a1 targetLocale:(id)a2 isForDownloadRequest:(char)a3 itemHandler:(id /* block */)a4 completionHandler:(id /* block */)a5;
