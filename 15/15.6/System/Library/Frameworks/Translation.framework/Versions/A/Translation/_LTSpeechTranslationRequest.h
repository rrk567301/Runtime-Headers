...
- (void)_appendAudioSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 simulateRealtime:(char)a1;
...
- (void)append:(struct opaqueCMSampleBuffer { } *)a0 simulateRealtime:(char)a1;
