...
@property (readonly, nonatomic) char useDedicatedMachPort;
...
- (void)cancel;
- (void)_start;
- (id)initWithObservationType:(unsigned long long)a0 useDedicatedMachPort:(char)a1 observations:(id /* block */)a2;
