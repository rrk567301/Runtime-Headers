...
+ (void)languagesForText:(id)a0 usingModel:(unsigned long long)a1 strategy:(unsigned long long)a2 useDedicatedTextMachPort:(char)a3 completion:(id /* block */)a4;
...
+ (void)_downloadAssetForLanguagePair:(id)a0 userInitiated:(char)a1 completion:(id /* block */)a2;
...
+ (void)_getTextServiceProxyWithDelegate:(id)a0 useDedicatedTextMachPort:(char)a1 errorHandler:(id /* block */)a2 block:(id /* block */)a3;
+ (void)_offlineLanguageStatus:(id /* block */)a0;
+ (void)_purgeAllAssets:(id /* block */)a0;
+ (void)_purgeAllAssetsExcludingConfig:(char)a0 completion:(id /* block */)a1;
+ (void)_purgeAssetForLanguagePair:(id)a0 userInitiated:(char)a1 completion:(id /* block */)a2;
+ (void)_updateAllAssets:(id /* block */)a0;
+ (void)_updateHotfix:(id /* block */)a0;
+ (void)addLanguages:(id)a0 useCellular:(char)a1;
...
+ (void)availableLocalePairsForTask:(long long)a0 useDedicatedMachPort:(char)a1 completion:(id /* block */)a2;
...
+ (void)languagesForText:(id)a0 usingModel:(unsigned long long)a1 useDedicatedTextMachPort:(char)a2 completion:(id /* block */)a3;
+ (void)modalitiesPerLocaleWithCompletion:(id /* block */)a0;
+ (void)onDeviceModeEnabled:(id /* block */)a0;
+ (void)onDeviceModeEnabledWithDedicatedMachPort:(char)a0 completion:(id /* block */)a1;
...
+ (void)shouldPresentSystemFirstUseConsentWithDedicatedMachPort:(char)a0 completion:(id /* block */)a1;
...
- (void)translate:(id)a0 useDedicatedTextMachPort:(char)a1;
