...
@property (readonly, nonatomic) char wasProvisionedDataclassesReset;
@property (copy, nonatomic) ACMutableTrackedSet *trackedEnabledDataclasses;
@property (readonly, nonatomic) char wasEnabledDataclassesReset;
...
- (char)isEnabledToSyncDataclass:(id)a0;
