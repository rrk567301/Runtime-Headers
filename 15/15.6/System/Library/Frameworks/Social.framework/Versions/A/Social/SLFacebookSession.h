...
- (char)uploadPost:(id)a0;
- (char)uploadPost:(id)a0 forPID:(int)a1;
- (void)uploadPost:(id)a0 suppressAlerts:(char)a1 withPostCompletion:(id /* block */)a2;
- (char)uploadProfilePicture:(id)a0 error:(id *)a1;
