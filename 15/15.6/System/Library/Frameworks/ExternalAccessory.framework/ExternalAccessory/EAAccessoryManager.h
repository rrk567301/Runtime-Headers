...
- (void)sendGPRMCDataStatus:(char)a0 ValueV:(char)a1 ValueX:(char)a2 forUUID:(id)a3;
...
- (void)_removeAlliAPAccessoriesFromArray:(id)a0 notifyClients:(char)a1;
...
- (char)appDeclaresProtocol:(id)a0;
...
- (char)destinationInformation:(id)a0 forAccessoryUUID:(id)a1;
...
- (char)processIDIsUsingAccessory:(struct __CFString { } *)a0;
...
- (void)setAreLocationAccessoriesEnabled:(char)a0;
- (void)setShouldAllowCppRuntime:(char)a0;
- (void)setShouldAllowInternalProtocols:(char)a0;
