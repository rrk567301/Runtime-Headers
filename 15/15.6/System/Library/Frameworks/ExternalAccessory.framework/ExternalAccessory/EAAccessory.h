...
- (char)getEphemerisExpirationInterval:(double *)a0;
- (id)protocolDetails;
...
- (void)_setNotPresentInIAPAccessoriesArray:(char)a0;
...
- (id)cameraComponents;
- (id)certSerial;
- (char)containsSameProtocolsAsiAPAccessoryProtocols:(id)a0;
- (id)coreAccessoriesPrimaryUUID;
- (char)createdByCoreAccessories;
- (id)dictionaryWithLowercaseKeys:(id)a0;
- (char)getEphemerisRecommendRefreshInterval:(double *)a0;
- (char)getEphemerisURL:(id *)a0;
- (void)getIAPTimeSyncInfo:(id)a0 completionHandler:(id /* block */)a1;
- (char)getNMEASentence:(id *)a0;
...
- (char)sendDestinationInformation:(id)a0 identifier:(id)a1;
- (void)sendDeviceIdentifierNotification:(id)a0 usbIdentifier:(id)a1;
- (char)sendEphemeris:(id)a0;
- (char)sendEphemerisPointDataGpsWeek:(unsigned long long)a0 gpsTOW:(double)a1 latitude:(double)a2 longitude:(double)a3 accuracy:(unsigned short)a4;
- (char)sendGPRMCDataStatusValueA:(char)a0 ValueV:(char)a1 ValueX:(char)a2;
- (char)sendGpsWeek:(unsigned long long)a0 gpsTOW:(double)a1;
- (char)sendPointOfInterestInformation:(id)a0 identifier:(unsigned short)a1;
...
- (char)setNMEASentencesToFilter:(id)a0;
- (void)setPointOfInterestHandoffEnabled:(char)a0;
