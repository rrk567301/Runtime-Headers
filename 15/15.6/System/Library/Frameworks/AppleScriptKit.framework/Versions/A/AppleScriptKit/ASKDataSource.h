...
- (id)sortColumn;
- (void)setSorted:(char)a0;
- (char)sorted;
- (id)columnWithName:(id)a0;
- (void)_setContents:(id)a0 removeExisting:(char)a1;
...
- (void)setContentsAsRecords:(char)a0;
- (void)setDraggedItems:(id)a0;
- (void)setLocalizedSort:(char)a0;
- (void)setShouldUpdateViews:(char)a0;
- (void)setUseSortIndicators:(char)a0;
