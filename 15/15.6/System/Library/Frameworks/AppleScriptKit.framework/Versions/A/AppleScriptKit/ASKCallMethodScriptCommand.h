...
- (char)isPointType:(id)a0;
- (char)isRangeType:(id)a0;
- (char)isRectType:(id)a0;
- (char)isSizeType:(id)a0;
- (char)isValueType:(id)a0 equalTo:(id)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })rectFromArray:(id)a0;
- (char)setArgumentOfInvocation:(id)a0 atIndex:(unsigned long long)a1 withParameter:(id)a2 ofType:(char)a3;
