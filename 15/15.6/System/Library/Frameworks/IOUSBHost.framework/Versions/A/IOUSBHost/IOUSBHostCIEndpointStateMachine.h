...
- (id)description;
- (void).cxx_destruct;
- (char)enqueueTransferCompletionForMessage:(const struct IOUSBHostCIMessage { unsigned int x0; unsigned int x1; unsigned long long x2; } *)a0 status:(int)a1 transferLength:(unsigned long long)a2 error:(id *)a3;
...
- (char)processDoorbell:(unsigned int)a0 error:(id *)a1;
