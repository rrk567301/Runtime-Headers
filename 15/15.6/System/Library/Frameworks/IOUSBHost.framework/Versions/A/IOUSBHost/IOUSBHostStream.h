...
- (char)enqueueIORequestWithData:(id)a0 error:(id *)a1 completionHandler:(id /* block */)a2;
...
- (char)sendIORequestWithData:(id)a0 bytesTransferred:(unsigned long long *)a1 error:(id *)a2;
