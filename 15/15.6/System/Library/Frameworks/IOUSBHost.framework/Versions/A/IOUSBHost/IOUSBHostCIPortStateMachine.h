...
@property (nonatomic) char powered;
@property (nonatomic) char connected;
@property (nonatomic) char overcurrent;
...
- (char)processCommand:(const struct IOUSBHostCIMessage { unsigned int x0; unsigned int x1; unsigned long long x2; } *)a0 readonly:(char)a1 commandResult:(int)a2 error:(id *)a3;
...
- (char)updateLinkState:(int)a0 speed:(int)a1 inhibitLinkStateChange:(char)a2 error:(id *)a3;
