...
@property (nonatomic, getter=isBeats1) char beats1;
@property (nonatomic, getter=isLive) char live;
@property (nonatomic, getter=containsVideo) char containsVideo;
...
@property (nonatomic) char allowsItemLiking;
