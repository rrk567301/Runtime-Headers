...
@property (readonly, nonatomic, getter=isPlaylistItemsQuery) char playlistItemsQuery;
...
+ (id)podcastsQuery;
+ (void)setFilteringDisabled:(char)a0;
+ (id)songsQuery;
+ (id)tvShowsQuery;
...
- (void)_enumerateCollectionPersistentIDsInOrder:(char)a0 usingBlock:(id /* block */)a1;
- (void)_enumerateCollectionPersistentIDsUsingBlock:(id /* block */)a0;
- (void)_enumerateCollectionsInOrder:(char)a0 usingBlock:(id /* block */)a1;
- (void)_enumerateCollectionsUsingBlock:(id /* block */)a0;
- (void)_enumerateItemPersistentIDsInOrder:(char)a0 usingBlock:(id /* block */)a1;
- (void)_enumerateItemPersistentIDsUsingBlock:(id /* block */)a0;
- (void)_enumerateItemsInOrder:(char)a0 usingBlock:(id /* block */)a1;
...
- (char)_updatePredicateForProperty:(id)a0 withPropertyPredicate:(id)a1;
