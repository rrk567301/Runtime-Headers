...
@property (readonly, nonatomic, getter=isMainThreadBound) char mainThreadBound;
...
@property (getter=isLoadingRepresentation) char loadingRepresentation;
...
@property (readonly, nonatomic) char hasImageOnDisk;
@property (nonatomic) char allowsVideoConstrainedNetworkAccess;
@property (nonatomic) long long preferredVideoFormat;
@property (readonly, nonatomic) MPArtworkImageAttachments *imageAttachments;
@property (readonly, nonatomic) char hasExportableArtworkProperties;
...
+ (void)_setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 requestingContext:(id)a2;
+ (void)_setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 requestingContext:(id)a2 representationKind:(long long)a3;
...
+ (void)setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 cacheReference:(id)a2;
+ (void)setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 cacheReference:(id)a2 representationKind:(long long)a3;
+ (void)setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 requestingContext:(id)a2;
+ (void)setCachePurgesWhenEnteringBackground:(char)a0 forCacheIdentifier:(id)a1 requestingContext:(id)a2 representationKind:(long long)a3;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (void)_updateWithRepresentation:(id)a0 isBestRepresentation:(char)a1 modelRevisionID:(long long)a2;
...
- (void)_setDestination:(id)a0 isMainThreadBound:(char)a1;
- (void)_setDestination:(id)a0 isMainThreadBound:(char)a1 forRepresentationKinds:(unsigned long long)a2 configurationBlock:(id /* block */)a3;
...
- (char)isArtworkVisuallyIdenticalToCatalog:(id)a0;
