...
@property (readonly, nonatomic, getter=isExplicitItem) char explicitItem;
...
@property (readonly, nonatomic, getter=hasProtectedAsset) char protectedAsset;
...
@property (readonly, nonatomic, getter=isPreorder) char preorder;

+ (char)supportsSecureCoding;
+ (id)dynamicProperties;
+ (id)ULIDPropertyForGroupingType:(long long)a0;
+ (void)_createFilterableDictionary;
+ (char)_isValidItemProperty:(id)a0;
