...
@interface MPMusicPlayerController : NSObject <MPArtworkDataSource, MPVolumeControllerDelegate, MPMusicPlayerControllerClient, MPMediaPlayback> {
    ...
    char _serverValidated;
    char _mediaServiceLost;
...
@property (readonly, nonatomic) char isNowPlayingItemFromGeniusMix;
@property (nonatomic) unsigned long long currentChapterIndex;
@property (nonatomic) unsigned long long nowPlayingUID;
@property (nonatomic) char userQueueModificationsDisabled;
...
- (void)_handleMediaServicesLost:(id)a0;
- (void)_handleMediaServicesReset:(id)a0;
...
- (void)_wakeServerIfConnectedForReason:(id)a0;
...
- (char)isGeniusAvailableForSeedItems:(id)a0;
...
- (void)onServerAsync:(id /* block */)a0 errorHandler:(id /* block */)a1 timeout:(double)a2 retryEnabled:(char)a3;
...
- (char)setQueueWithSeedItems:(id)a0;
...
- (void)volumeController:(id)a0 mutedStateDidChange:(char)a1;
