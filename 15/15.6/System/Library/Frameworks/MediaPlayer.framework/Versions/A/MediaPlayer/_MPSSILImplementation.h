@class MPRandomDistribution, NSMutableArray, NSArray;
...
- (char)_isSequentialSection:(id)a0 withExclusiveAccessToken:(id)a1;
- (void)_reverseEnumeratorWillStartAtEnd:(id)a0 withExclusiveAccessToken:(id)a1;
- (void)_updateOrderedSectionIDsWithExclusiveAccessToken:(id)a0;
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 afterItem:(id)a3 inSection:(id)a4;
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 afterTailOfSection:(id)a3;
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 beforeTailOfSection:(id)a3;
- (void)addDataSourceAtEnd:(id)a0 section:(id)a1 sequentially:(char)a2;
- (void)addDataSourceAtStart:(id)a0 section:(id)a1 sequentially:(char)a2;
