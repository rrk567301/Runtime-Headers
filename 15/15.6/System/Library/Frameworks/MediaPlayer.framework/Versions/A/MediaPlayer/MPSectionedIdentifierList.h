@class NSString, NSArray, NSSet, NSMutableDictionary, MPSectionedIdentifierListEntry, NSDictionary, NSObject, NSMutableArray;
...
@property (nonatomic) char automaticallyReversesNonDestructiveDataSourceEdits;
...
- (id)_firstSectionIDBeforePosition:(id)a0 withExclusiveAccessToken:(id)a1;
...
- (char)hasItem:(id)a0 inSection:(id)a1;
- (char)hasSection:(id)a0;
- (char)isDeletedItem:(id)a0 inSection:(id)a1;
...
- (char)performWithExclusiveAccessAndReturnBOOL:(id /* block */)a0;
