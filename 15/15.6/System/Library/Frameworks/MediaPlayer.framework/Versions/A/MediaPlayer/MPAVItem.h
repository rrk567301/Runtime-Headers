@class MPQueueFeeder, NSDate, NSDictionary, NSObject, AVAsset, MPMediaLibraryPrivacyContext, MPModelPlayEvent, MPModelGenericObject, AVPlayerItemAccessLog, MPMediaItem, NSString, AVPlayerItem, AVPlayerItemMetadataOutput, NSMutableArray, NSMutableSet, ICMusicSubscriptionLeaseStatus, NSArray, NSNumber, MPNowPlayingContentItem, NSError;
...
@interface MPAVItem : NSObject {
    ...
    char _hasLoadedHasProtectedContent;
...
@property (class, readonly, nonatomic, getter=isPlaceholder) char placeholder;

@property (nonatomic) char isAssetLoaded;
...
@property (readonly, nonatomic) char shouldPreventPlayback;
@property (nonatomic) char isStartItem;
@property (nonatomic) char isHostingSharedSession;
...
@property (readonly, nonatomic) char requiresLoadedAssetForAirPlayProperties;
@property (nonatomic, getter=_currentPlaybackRate, setter=_setCurrentPlaybackRate:) float _currentPlaybackRate;
@property (readonly, nonatomic) char hasFinishedDownloading;
@property (nonatomic) char hasPerformedErrorResolution;
@property (copy, nonatomic) NSDictionary *playbackInfo;
@property (retain, nonatomic) AVPlayerItem *playerItem;
@property (readonly, nonatomic) struct OpaqueCMTimebase { } *timebase;
@property (nonatomic, getter=isActiveItem) char activeItem;
@property (readonly, copy, nonatomic) NSString *storeFrontIdentifier;
@property (nonatomic, getter=hasExternalDisplay) char externalDisplay;
...
@property (readonly, nonatomic) char didReachEnd;
@property (readonly, nonatomic) char canUseLoadedAsset;
@property (readonly, nonatomic) char isPreloadedAsset;
@property (nonatomic, getter=isInOverlappedTransition) char inOverlappedTransition;
@property (nonatomic) double overlappedTransitionDuration;
@property (readonly, nonatomic) char isInTransition;
@property (readonly, nonatomic) char supportsFastForward;
@property (readonly, nonatomic) char supportsRewind;
@property (readonly, nonatomic) char supportsRateChange;
...
@property (nonatomic, getter=isAutoPlayItem) char autoPlayItem;
@property (nonatomic, getter=isSharedListeningItem) char sharedListeningItem;
...
@property (nonatomic, getter=isConfiguredForVocalAttenuation) char configuredForVocalAttenuation;
@property (readonly, nonatomic) NSArray *adjunctErrors;
@property (weak, nonatomic) id<MPAVItemObserver> observer;
@property (readonly, nonatomic, getter=isAssetLoaded) char assetLoaded;
@property (readonly, nonatomic, getter=isAssetURLValid) char assetURLValid;
...
@property (readonly, nonatomic, getter=isAlwaysLive) char alwaysLive;
@property (readonly, nonatomic) char usesBookmarking;
...
@property (readonly, nonatomic, getter=isArtistUploadedContent) char artistUploadedContent;
...
@property (readonly, nonatomic, getter=isExplicitTrack) char explicitTrack;
...
@property (readonly, nonatomic, getter=isLikedStateEnabled) char likedStateEnabled;
@property (readonly, nonatomic) char supportsLikedState;
@property (readonly, nonatomic) NSString *lyrics;
@property (readonly, nonatomic) NSString *libraryLyrics;
@property (readonly, nonatomic) char hasStoreLyrics;
...
@property (readonly, nonatomic, getter=isStreamable) char streamable;
...
@property (readonly, nonatomic) char mediaItemNeedsLoading;
@property (nonatomic) float loudnessInfoVolumeNormalization;
@property (nonatomic) float soundCheckVolumeNormalization;
@property (readonly, nonatomic) char supportsRating;
@property (readonly, nonatomic) char prefersSeekOverSkip;
@property (readonly, nonatomic) char hasProtectedContent;
@property (readonly, nonatomic, getter=isRadioItem) char radioItem;
@property (readonly, nonatomic) char stationAllowsItemLiking;
...
- (void)_loadAssetAndPlayerItemWithTask:(id)a0 completion:(id /* block */)a1;
- (void)_loadAssetProperties;
- (void)_performContentItemUpdate:(id /* block */)a0 debounceWithIdentifier:(id)a1;
- (long long)_persistedLikedState;
- (void)_pickupContentItemFrom:(id)a0;
...
- (char)isSupportedDefaultPlaybackSpeed:(long long)a0;
