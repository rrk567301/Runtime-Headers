...
- (id)_artworkRepresentationWithImageFromData:(id)a0 forURLResponse:(id)a1 catalog:(id)a2 size:(struct CGSize { double x0; double x1; })a3 immediateImageDecompressionAllowed:(char)a4;
...
- (id)_existingRepresentationFromURLCacheForArtworkCatalog:(id)a0 immediateImageDecompressionAllowed:(char)a1;
- (id)_existingRepresentativeObjectForArtworkCatalog:(id)a0 kind:(long long)a1 handler:(id /* block */)a2;
- (char)_isRepresentationSize:(struct CGSize { double x0; double x1; })a0 validForCatalog:(id)a1;
...
- (char)_subclassImplementsSelector:(SEL)a0;
...
- (char)shouldLookForLargerImageRepresentationsWhenBestRepresentationIsUnavailable;
