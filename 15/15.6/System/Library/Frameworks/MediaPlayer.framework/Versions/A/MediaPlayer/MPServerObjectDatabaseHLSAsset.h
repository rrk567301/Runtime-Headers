...
@property (readonly, nonatomic, getter=isiTunesStoreStream) char iTunesStoreStream;

- (void).cxx_destruct;
- (id)_initWithIdentifier:(id)a0 hashedPersonID:(id)a1 playlistURL:(id)a2 keyCertificateURL:(id)a3 keyServerURL:(id)a4 keyServerAdamID:(id)a5 keyServerProtocolType:(id)a6 isiTunesStoreStream:(char)a7;
