...
@property (class, nonatomic) long long initialCandidateDequeueQuota;
@property (class, nonatomic) long long enumerationCandidateDequeueQuota;
...
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 afterItem:(id)a3 inSection:(id)a4 completion:(id /* block */)a5;
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 afterTailOfSection:(id)a3 completion:(id /* block */)a4;
- (void)addDataSource:(id)a0 section:(id)a1 sequentially:(char)a2 beforeTailOfSection:(id)a3 completion:(id /* block */)a4;
- (void)addDataSourceAtEnd:(id)a0 section:(id)a1 completion:(id /* block */)a2;
- (void)addDataSourceAtEnd:(id)a0 section:(id)a1 sequentially:(char)a2 completion:(id /* block */)a3;
- (void)addDataSourceAtStart:(id)a0 section:(id)a1 completion:(id /* block */)a2;
- (void)addDataSourceAtStart:(id)a0 section:(id)a1 sequentially:(char)a2 completion:(id /* block */)a3;
