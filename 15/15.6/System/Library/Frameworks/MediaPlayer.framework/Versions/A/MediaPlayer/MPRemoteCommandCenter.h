...
@interface MPRemoteCommandCenter : NSObject {
    ...
    char _commandHandlersRegistered;
...
@property (readonly, nonatomic) char commandHandlersRegistered;
@property (readonly, nonatomic) char canBeNowPlayingApplication;
...
@property (nonatomic) char wantsSerializedEventDelivery;
...
- (void)_scheduleSupportedCommandsChanged:(char)a0;
