...
@property (nonatomic, getter=isCuratorPlaylist) char curatorPlaylist;
@property (nonatomic, getter=isOwner) char owner;
@property (nonatomic, getter=isPublicPlaylist) char publicPlaylist;
@property (nonatomic, getter=isVisiblePlaylist) char visiblePlaylist;
...
@property (nonatomic) char isFavoriteSongsPlaylist;
...
@property (nonatomic, getter=isCollaborationJoinRequestPending) char collaborationJoinRequestIsPending;
@property (nonatomic) unsigned long long collaboratorStatus;
@property (readonly, nonatomic) char favoriteSongsPlaylist;
@property (readonly, copy, nonatomic) NSDate *downloadedDate;
@property (readonly, nonatomic) unsigned long long parentPersistentID;
