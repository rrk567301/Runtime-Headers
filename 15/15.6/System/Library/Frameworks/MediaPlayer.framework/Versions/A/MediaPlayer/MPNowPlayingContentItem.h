...
@property (nonatomic, getter=isSharableItem) char sharableItem;
...
@property (nonatomic, getter=isAlwaysLiveItem) char alwaysLiveItem;
...
@property (nonatomic) char hasArtwork;
...
@property (nonatomic) char hasLanguageOptions;
@property (nonatomic) char hasLyrics;
...
- (void)setHasTranscriptAlignments:(char)a0;
