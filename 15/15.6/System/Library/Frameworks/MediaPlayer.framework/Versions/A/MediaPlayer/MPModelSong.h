...
@property (nonatomic, getter=isExplicitSong) char explicitSong;
@property (nonatomic, getter=isArtistUploadedContent) char artistUploadedContent;
...
@property (nonatomic) char supportsExtendedLyricsAttribute;
@property (nonatomic) char hasCredits;
