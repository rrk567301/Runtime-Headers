...
- (id)initWithLegacyModelObjectType:(long long)a0 itemKind:(id)a1 allowedItemIdentifiers:(id)a2 allowedItemIdentifierSets:(id)a3 itemSortDescriptors:(id)a4 itemFilterText:(id)a5 itemPropertyFilters:(id)a6 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a7 filteringOptions:(struct { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; })a8 mediaLibrary:(id)a9;
- (id)initWithLegacyModelObjectType:(long long)a0 sectionLegacyModelObjectType:(long long)a1 itemKind:(id)a2 sectionKind:(id)a3 allowedItemIdentifiers:(id)a4 allowedSectionIdentifiers:(id)a5 allowedItemIdentifierSets:(id)a6 allowedSectionIdentifierSets:(id)a7 scopedContainers:(id)a8 itemSortDescriptors:(id)a9 sectionSortDescriptors:(id)a10 itemFilterText:(id)a11 sectionFilterText:(id)a12 itemPropertyFilters:(id)a13 sectionPropertyFilters:(id)a14 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a15 filteringOptions:(struct { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; })a16 mediaLibrary:(id)a17;
