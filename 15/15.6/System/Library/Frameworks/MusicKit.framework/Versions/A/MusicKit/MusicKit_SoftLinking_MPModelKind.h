...
+ (id)_curatorKindForVariants:(unsigned long long)a0;
...
+ (id)_sanitizeKind:(id)a0;
+ (id)_sanitizePlaylistEntryKind:(id)a0;
+ (id)_sanitizeSongKind:(id)a0;
...
+ (char)shouldShowAllExtendedVideoContent;
