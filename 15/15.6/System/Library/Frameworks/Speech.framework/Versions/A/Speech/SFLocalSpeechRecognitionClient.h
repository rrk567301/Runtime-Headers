...
- (void)installedLanguagesForAssetType:(unsigned long long)a0 synchronous:(char)a1 completion:(id /* block */)a2;
- (void)lmeThresholdWithCompletion:(id /* block */)a0;
- (oneway void)localSpeechRecognitionDidDownloadAssetsWithProgress:(unsigned long long)a0 isStalled:(char)a1;
...
- (void)setPurgeabilityForAssetWithConfig:(id)a0 purgeable:(char)a1 clientID:(id)a2 completion:(id /* block */)a3;
