...
+ (char)isOverrideSupportedForAssetType:(unsigned long long)a0;
+ (char)isSubscribedToAssetWithConfig:(id)a0 regionId:(id)a1 subscriberId:(id)a2;
...
+ (void)setPurgeabilityForAssetWithConfig:(id)a0 purgeable:(char)a1 completionHandler:(id /* block */)a2;
...
- (id)_installationStatusForLanguagesWithAssetType:(unsigned long long)a0 includeDetailedStatus:(char)a1 subscriberId:(id)a2;
- (id)_installedAssetWithConfig:(id)a0 regionId:(id)a1 shouldSubscribe:(char)a2 subscriberId:(id)a3 expiration:(id)a4;
...
- (id)installedAssetWithConfig:(id)a0 regionId:(id)a1 shouldSubscribe:(char)a2 subscriberId:(id)a3 expiration:(id)a4;
