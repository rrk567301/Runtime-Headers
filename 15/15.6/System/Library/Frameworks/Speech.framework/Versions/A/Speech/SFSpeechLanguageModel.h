...
+ (void)prepareCustomLanguageModelForUrl:(id)a0 clientIdentifier:(id)a1 configuration:(id)a2 ignoresCache:(char)a3 completion:(id /* block */)a4;
...
- (char)addProns:(id)a0 forWord:(id)a1;
...
- (char)trainFromPlainTextAndWriteToDirectory:(id)a0;
