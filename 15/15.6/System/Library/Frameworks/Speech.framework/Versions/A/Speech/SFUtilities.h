...
+ (id)defaultClientID;
+ (id)aneSubType;
+ (char)canAccessPathAt:(id)a0 methodName:(id)a1 error:(id *)a2;
+ (id)speechProfilePathsWithLanguage:(id)a0;
+ (void)supportedLocalesWithCompletion:(id /* block */)a0;
+ (char)isANETypeAtLeastVersion:(int)a0 prefix:(id)a1;
...
+ (char)isCacheDirInternal;
+ (char)isGeneralASRSupportedOnDevice;
+ (char)isSpeechXPCEnabled;
