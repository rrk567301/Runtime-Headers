@class _SFSearchRequest, NSString, NSDictionary, NSURL, NSArray, SFSpeechLanguageModelConfiguration;
...
@property (nonatomic, getter=_forceOfflineRecognition, setter=_setForceOfflineRecognition:) char _forceOfflineRecognition;
...
@property (nonatomic, getter=_forceUseSiriProcess, setter=_setForceUseSiriProcess:) char _forceUseSiriProcess;
@property (retain, nonatomic) NSString *taskIdentifier;
@property (nonatomic) long long taskHint;
@property (nonatomic) char shouldReportPartialResults;
@property (copy, nonatomic) NSArray *contextualStrings;
@property (copy, nonatomic) NSString *interactionIdentifier;
@property (nonatomic) char requiresOnDeviceRecognition;
@property (nonatomic) char addsPunctuation;
