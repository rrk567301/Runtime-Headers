...
@property (readonly, nonatomic) char keepANEModelLoaded;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)initWithPriority:(long long)a0 aneContext:(id)a1 cpuContext:(id)a2 gpuContext:(id)a3 keepANEModelLoaded:(char)a4;
