...
- (void)addPeer:(id)a0 isAdvertising:(char)a1;
...
- (void)session:(id)a0 didFinishReceivingResourceWithName:(id)a1 fromPeer:(id)a2 atURL:(id)a3 withError:(id)a4 propagate:(char *)a5;
- (void)session:(id)a0 didReceiveData:(id)a1 fromPeer:(id)a2 propagate:(char *)a3;
- (void)session:(id)a0 didReceiveStream:(id)a1 withName:(id)a2 fromPeer:(id)a3 propagate:(char *)a4;
- (void)session:(id)a0 didStartReceivingResourceWithName:(id)a1 fromPeer:(id)a2 withProgress:(id)a3 propagate:(char *)a4;
- (void)session:(id)a0 peer:(id)a1 didChangeState:(long long)a2 propagate:(char *)a3;
