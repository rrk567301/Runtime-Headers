...
- (long long)_prepPanel:(struct __SecTrust { } *)a0 showGroup:(char)a1;
- (char)_rowContainsLeaf:(long long)a0;
- (char)_runAsSheet;
...
- (void)_setEditableTrust:(char)a0;
...
- (void)beginSheetForWindow:(id)a0 modalDelegate:(id)a1 didEndSelector:(SEL)a2 contextInfo:(void *)a3 certificates:(id)a4 showGroup:(char)a5;
- (void)beginSheetForWindow:(id)a0 modalDelegate:(id)a1 didEndSelector:(SEL)a2 contextInfo:(void *)a3 trust:(struct __SecTrust { } *)a4 showGroup:(char)a5;
- (char)editableTrust;
- (long long)runModalForCertificates:(id)a0 showGroup:(char)a1;
- (long long)runModalForTrust:(struct __SecTrust { } *)a0 showGroup:(char)a1;
