...
- (void)setShowsHelp:(char)a0;
- (void)set_panel:(id)a0;
- (char)showsHelp;
- (char)tableView:(id)a0 shouldEditTableColumn:(id)a1 row:(int)a2;
...
- (void)_discloseCertificates:(char)a0;
...
- (void)setCertificatesDisclosed:(char)a0;
