...
- (void)_forceAdminTrust:(char)a0;
- (id)_iconView;
- (id)_localizedAppName;
- (void)_okClicked:(id)a0;
- (id)_plainAttributedString:(id)a0;
- (long long)_prepPanel:(struct __SecTrust { } *)a0 message:(id)a1 showGroup:(char)a2;
- (id)_reserved_SFCertificateTrustPanel;
...
- (void)setShowsCertButton:(char)a0;
- (void)setShowsTrustButton:(char)a0;
