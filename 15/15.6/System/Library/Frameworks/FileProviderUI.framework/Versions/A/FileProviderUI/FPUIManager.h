...
+ (id)createFPUIActionWithIdentifier:(id)a0 uiActionProviderIdentifier:(id)a1 fileProviderIdentifier:(id)a2 displayName:(id)a3 predicate:(id)a4 displayInline:(char)a5 isNonUIAction:(char)a6 fpProviderDomain:(id)a7;
...
+ (char)isAction:(id)a0 eligibleForItems:(id)a1;
+ (id)uiActionsForProviderDomain:(id)a0;
+ (id)valueForKey:(id)a0 inActionPlist:(id)a1;
