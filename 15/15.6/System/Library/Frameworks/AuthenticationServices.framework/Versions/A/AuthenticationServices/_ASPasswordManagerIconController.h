...
@interface _ASPasswordManagerIconController : NSObject {
    char _hasLoadedHistory;
    char _canEnableIconDownload;
...
- (void)_fetchIconWithName:(id)a0 highLevelDomain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 shouldUseOneTimeRequest:(char)a3 requestID:(id)a4 responseHandler:(id /* block */)a5;
- (unsigned long long)_optionsWithHighLevelDomain:(id)a0;
- (void)_privacyProxyStateInitialized;
- (void)_requestIconWithName:(id)a0 highLevelDomain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 options:(unsigned long long)a3 shouldUseOneTimeRequest:(char)a4 requestID:(id)a5 responseHandler:(id /* block */)a6;
- (char)_shouldTryFetchingIconWithHistoryForTouchIconResponse:(id)a0 withOptions:(unsigned long long)a1;
...
- (char)historyShouldScheduleMaintenance:(id)a0;
