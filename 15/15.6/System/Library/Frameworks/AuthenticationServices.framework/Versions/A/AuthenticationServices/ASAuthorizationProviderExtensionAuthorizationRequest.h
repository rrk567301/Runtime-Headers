...
@property (readonly, nonatomic, getter=isCallerManaged) char callerManaged;
...
@property (readonly, nonatomic, getter=isUserInterfaceEnabled) char userInterfaceEnabled;
