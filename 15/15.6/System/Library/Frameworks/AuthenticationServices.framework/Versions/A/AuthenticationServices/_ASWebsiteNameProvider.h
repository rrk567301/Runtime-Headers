...
@property (nonatomic) char isForTesting;
...
+ (char)_candidateWebsiteNameHasObviousFlaw:(id)a0;
+ (id)_commonTitleDelimiters;
+ (id)_siteNameFromOpenGraphSiteName:(id)a0 withURL:(id)a1;
+ (id)_siteNameFromTitle:(id)a0 withURL:(id)a1;
+ (id)_siteNameFromTitleLikeString:(id)a0 withURL:(id)a1 useHostAndTitlePrefixMatch:(char)a2;
...
- (char)_canRefreshDataForDateLastRefreshed:(id)a0;
- (void)_fetchDataForDomainIfNeeded:(id)a0 metadataEntry:(id)a1;
- (id)_initWithShouldLoadQuirksList:(char)a0;
- (void)_privacyProxyDidChange:(id)a0;
- (void)_processMetadataEntryFetchedFromKeychain:(id)a0 forDomain:(id)a1 allowRefreshingDataFromNetwork:(char)a2;
