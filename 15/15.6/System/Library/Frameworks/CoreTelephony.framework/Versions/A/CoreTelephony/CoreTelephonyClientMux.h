...
- (void)_computeNotificationSet_sync:(char)a0 completion:(id /* block */)a1;
- (void)_connect_sync;
- (void)_ensureConnectionSetup_sync;
- (void)_ensureConnectionSetup_sync:(char)a0;
- (unsigned long long)_getAssertionTypeId;
- (void)_initializeConnection_sync;
- (void)_registerForNotifications_sync:(id)a0 shouldForce:(char)a1 completion:(id /* block */)a2;
