...
- (char)isEmergencyNumber:(id)a0 number:(id)a1 error:(id *)a2;
- (void)isPrivateNetworkSIM:(id)a0 completion:(id /* block */)a1;
- (void)set2GUserPreference:(char)a0 completion:(id /* block */)a1;
...
- (char)sendComposingIndicatorForContext:(id)a0 to:(id)a1 messageID:(id)a2 indication:(id)a3 error:(id *)a4;
- (void)setMaxDataRate:(id)a0 rate:(long long)a1 completion:(id /* block */)a2;
- (id)setSupportDynamicDataSimSwitch:(char)a0;
- (char)acknowledgeIncomingMessages:(id)a0 withMessageIDList:(id)a1 withError:(id *)a2;
- (void)activateStewieEmergencyTryOutWithCompletion:(id /* block */)a0;
- (void)activateTurboMode:(id /* block */)a0;
- (void)addLowLatencyFilter:(id)a0 pdp:(int)a1 queueSetId:(unsigned long long)a2 uplink:(char)a3 completion:(id /* block */)a4;
- (char)addParticipants:(id)a0 toGroupChat:(id)a1 withParticipantsToAdd:(id)a2 withOperationID:(id)a3 withError:(id *)a4;
...
- (char)changeIcon:(id)a0 forGroupChat:(id)a1 withNewIcon:(id)a2 withOperationID:(id)a3 withError:(id *)a4;
...
- (char)changeSubject:(id)a0 forGroupChat:(id)a1 withNewSubject:(id)a2 withOperationID:(id)a3 withError:(id *)a4;
- (struct { long long x0; long long x1; })checkCellularDiagnosticsStatusDetails:(id *)a0;
- (id)checkEmbeddedSimHealthWithError:(id *)a0;
- (void)checkForUpdatedBundlesWithAutoInstall:(char)a0 completion:(id /* block */)a1;
...
- (id)context:(id)a0 canSetCapability:(id)a1 allowed:(char *)a2 with:(id *)a3;
...
- (id)context:(id)a0 getCapability:(id)a1 status:(char *)a2 with:(id *)a3;
...
- (char)context:(id)a0 isMandatoryDisabledVoLTE:(id *)a1;
...
- (id)context:(id)a0 mandatoryDisableVoLTE:(char)a1;
...
- (id)context:(id)a0 setCapability:(id)a1 enabled:(char)a2 with:(id)a3;
- (void)context:(id)a0 setCapability:(id)a1 enabled:(char)a2 with:(id)a3 completion:(id /* block */)a4;
...
- (void)copyCarrierBundleValues:(id)a0 keyHierarchies:(id)a1 defaultValues:(id)a2 bundleType:(id)a3 withFallbackBundleCheck:(char)a4 completion:(id /* block */)a5;
- (id)copyCarrierBundleValues:(id)a0 keyHierarchies:(id)a1 defaultValues:(id)a2 bundleType:(id)a3 withFallbackBundleCheck:(char)a4 error:(id *)a5;
- (void)copyCarrierBundleValues:(id)a0 keys:(id)a1 defaultValues:(id)a2 bundleType:(id)a3 withFallbackBundleCheck:(char)a4 completion:(id /* block */)a5;
- (id)copyCarrierBundleValues:(id)a0 keys:(id)a1 defaultValues:(id)a2 bundleType:(id)a3 withFallbackBundleCheck:(char)a4 error:(id *)a5;
...
- (char)create:(id)a0 groupChat:(id)a1 withOperationID:(id)a2 withError:(id *)a3;
...
- (char)deleteChat:(id)a0 chat:(id)a1 withError:(id *)a2;
- (void)deleteHiddenSims:(id /* block */)a0;
- (void)deleteLowLatencyFilter:(id)a0 pdp:(int)a1 queueSetId:(unsigned long long)a2 uplink:(char)a3 completion:(id /* block */)a4;
- (id)deletePersonalWallet:(id)a0;
- (void)deletePersonalWallet:(id)a0 completion:(id /* block */)a1;
- (char)disableBusinessMessaging:(id)a0 withError:(id *)a1;
- (char)disableLazuli:(id)a0 withError:(id *)a1;
- (void)dispatchBlockToClientAsync:(id /* block */)a0;
- (char)enableBusinessMessaging:(id)a0 withError:(id *)a1;
- (char)enableLazuli:(id)a0 withError:(id *)a1;
- (id)enterLoopBackMode;
- (void)evaluateMobileSubscriberIdentity:(id)a0 identity:(id)a1 completion:(id /* block */)a2;
- (char)exit:(id)a0 groupChat:(id)a1 withOperationID:(id)a2 withError:(id *)a3;
- (void)exitStewieWithContext:(id)a0 completion:(id /* block */)a1;
- (void *)fDataAssertion;
- (id)fetchBasebandTicket:(char)a0 withError:(id *)a1;
...
- (char)fetchRemoteCapabilities:(id)a0 forDestination:(id)a1 withOptions:(id)a2 withOperationID:(id)a3 withError:(id *)a4;
- (char)fetchRenderInformation:(id)a0 forChatBot:(id)a1 withOperationID:(id)a2 withError:(id *)a3;
...
- (char)get2GSwitchEnabledSync:(id *)a0;
- (void)get2GUserPreference:(id /* block */)a0;
- (char)get2GUserPreferenceSync:(id *)a0;
...
- (char)getInternationalDataAccessStatusSync:(id *)a0;
- (char)getInternationalDataAccessSync:(id)a0 error:(id *)a1;
...
- (struct { char x0; char x1; })getPrivacyProxyState:(id)a0 error:(id *)a1;
...
- (char)getSupportDynamicDataSimSwitchOnBBCallSync:(id *)a0;
- (char)getSupportDynamicDataSimSwitchSync:(id *)a0;
...
- (char)interfaceCostExpensive:(id)a0 error:(id *)a1;
- (id)isAnySimReadyWithError:(id *)a0;
- (void)isAttachApnSettingAllowed:(id)a0 completion:(id /* block */)a1;
- (char)isAttachApnSettingAllowed:(id)a0 error:(id *)a1;
...
- (char)isEmergencyNumberWithWhitelistIncluded:(id)a0 number:(id)a1 error:(id *)a2;
- (long long)isEsimFor:(id)a0 error:(id *)a1;
- (id)isFactoryDebugEnabled:(id *)a0;
- (char)isHighDataModeSupported:(id)a0 error:(id *)a1;
...
- (id)loadGSMASettings:(id)a0 state:(char)a1;
- (char)lowDataMode:(id)a0 error:(id *)a1;
- (char)overriddenInterfaceCostInexpensive:(id *)a0;
- (void)performNetworkAccessFlowIfAllowed:(id)a0 ignoreForeground:(char)a1 completion:(id /* block */)a2;
...
- (id)private_setPacketContextActiveByServiceType:(id)a0 connectionType:(int)a1 active:(char)a2;
...
- (char)releaseBootstrapDataService:(id *)a0;
- (struct { char x0; char x1; })reliableNetworkFallback:(id)a0 error:(id *)a1;
- (char)removeGeofenceProfile;
- (char)removeParticipants:(id)a0 fromGroupChat:(id)a1 withParticipantsToRemove:(id)a2 withOperationID:(id)a3 withError:(id *)a4;
...
- (char)reportChatbotSpam:(id)a0 forChatbot:(id)a1 withSpamReportInfo:(id)a2 andOperationID:(id)a3 withError:(id *)a4;
- (char)reportLazuliSpamWithContext:(id)a0 destination:(id)a1 spamReportInfo:(id)a2 operationID:(id)a3 error:(id *)a4;
...
- (char)requestBootstrapDataService:(id *)a0;
...
- (char)restoreToSystemBundles:(id *)a0;
- (id)retrieveAllIncomingMessageIDs:(id)a0 withError:(id *)a1;
- (id)retrieveMessage:(id)a0 withMessageID:(id)a1 withError:(id *)a2;
- (char)revokeMessage:(id)a0 withRevokeData:(id)a1 withMessageID:(id)a2 withError:(id *)a3;
- (id)saveCallBarringValue:(id)a0 facility:(int)a1 callClass:(int)a2 enabled:(char)a3 password:(id)a4;
- (void)saveCallBarringValue:(id)a0 facility:(int)a1 callClass:(int)a2 enabled:(char)a3 password:(id)a4 completion:(id /* block */)a5;
- (id)saveCallForwardingValue:(id)a0 value:(id)a1;
- (void)saveCallForwardingValue:(id)a0 value:(id)a1 completion:(id /* block */)a2;
- (id)saveCallWaitingValue:(id)a0 callClass:(int)a1 enabled:(char)a2;
- (void)saveCallWaitingValue:(id)a0 callClass:(int)a1 enabled:(char)a2 completion:(id /* block */)a3;
...
- (char)saveDataMode:(id)a0 error:(id *)a1;
- (void)savePhonebookEntry:(id)a0 atIndex:(int)a1 withContactName:(id)a2 contactNumber:(id)a3 completion:(id /* block */)a4;
- (void)saveSIMLockValue:(id)a0 enabled:(char)a1 pin:(id)a2 completion:(id /* block */)a3;
- (void)saveSIMLockValue:(id)a0 enabled:(char)a1 pin:(id)a2 error:(id *)a3;
...
- (char)sendComposingIndicator:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withIndication:(id)a3 withError:(id *)a4;
- (id)sendDeadPeerDetection;
- (void)sendDeadPeerDetection:(id /* block */)a0;
- (char)sendDeviceAction:(id)a0 to:(id)a1 withMessageID:(id)a2 withAction:(id)a3 withError:(id *)a4;
- (char)sendDeviceSettings:(id)a0 to:(id)a1 withMessageID:(id)a2 withSetting:(id)a3 withError:(id *)a4;
- (char)sendDispositionNotificationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withDisposition:(long long)a3 forMessageID:(id)a4 withError:(id *)a5;
- (char)sendFileTransferMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withFileInformation:(id)a3 withError:(id *)a4;
- (char)sendFileTransferMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withFileInformation:(id)a3 withError:(id *)a4;
- (char)sendGeolocationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withError:(id *)a4;
- (char)sendGeolocationMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withError:(id *)a4;
- (char)sendGroupDispositionNotificationMessage:(id)a0 toGroup:(id)a1 to:(id)a2 withMessageID:(id)a3 withDisposition:(long long)a4 forMessageID:(id)a5 withError:(id *)a6;
- (char)sendOneToManyFileTransferMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withDescriptor:(id)a3 withError:(id *)a4;
- (char)sendOneToManyGeolocationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withError:(id *)a4;
- (char)sendOneToManyTextMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withError:(id *)a4;
- (char)sendResponseForSuggestedAction:(id)a0 to:(id)a1 withMessageID:(id)a2 response:(id)a3 withError:(id *)a4;
- (char)sendResponseForSuggestedReply:(id)a0 to:(id)a1 withMessageID:(id)a2 response:(id)a3 withError:(id *)a4;
- (void)sendTaggedInfo:(id)a0 type:(unsigned long long)a1 payload:(id)a2 completion:(id /* block */)a3;
- (char)sendTextMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withError:(id *)a4;
- (char)sendTextMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withError:(id *)a4;
...
- (void)setCoalescing:(char)a0 udp:(char)a1 completion:(id /* block */)a2;
...
- (id)setInterfaceCost:(id)a0 expensive:(char)a1;
- (void)setInternationalDataAccess:(id)a0 status:(char)a1 completion:(id /* block */)a2;
- (id)setInternationalDataAccessStatus:(char)a0;
- (void)setInternationalDataAccessStatus:(char)a0 completion:(id /* block */)a1;
- (id)setInternationalDataAccessSync:(id)a0 status:(char)a1;
- (id)setInternetActive:(char)a0;
- (void)setInternetActive:(char)a0 completion:(id /* block */)a1;
...
- (id)setLowDataMode:(id)a0 enable:(char)a1;
- (id)setMaxDataRate:(id)a0 rate:(long long)a1;
- (id)setOverriddenInterfaceCostInexpensive:(char)a0;
- (id)setPacketContextActiveByServiceType:(id)a0 connectionType:(int)a1 active:(char)a2;
- (void)setPacketContextActiveByServiceType:(id)a0 connectionType:(int)a1 active:(char)a2 completion:(id /* block */)a3;
...
- (id)setPrivacyProxyState:(id)a0 enabled:(char)a1;
...
- (id)setReliableNetworkFallback:(id)a0 enable:(char)a1;
- (void)setRemotePolicies:(id)a0 completion:(id /* block */)a1;
- (id)setSaveDataMode:(id)a0 enable:(char)a1;
- (id)setShouldShowBrandedCallingInfo:(char)a0;
- (id)setSmartDataMode:(id)a0 enable:(char)a1;
- (id)setStewieBlocked:(BOOL)a0;
- (void)setStewieBlocked:(BOOL)a0 completion:(id /* block */)a1;
- (void)setSupportDynamicDataSimSwitch:(char)a0 completion:(id /* block */)a1;
- (void)setSupportDynamicDataSimSwitch:(char)a0 forIccid:(id)a1 completion:(id /* block */)a2;
- (id)setSupportDynamicDataSimSwitchOnBBCall:(char)a0;
- (void)setSupportDynamicDataSimSwitchOnBBCall:(char)a0 completion:(id /* block */)a1;
- (id)setSupports5GStandalone:(id)a0 enabled:(char)a1;
- (id)setTetheringActive:(char)a0;
- (void)setTetheringActive:(char)a0 completion:(id /* block */)a1;
- (void)setUIConfiguredApns:(id)a0 apns:(id)a1 completion:(id /* block */)a2;
- (void)setUsageCollectionEnabled:(char)a0 completion:(id /* block */)a1;
...
- (void)setVinylTestMode:(char)a0 completion:(id /* block */)a1;
- (void)setVirtualSimMode:(char)a0 completion:(id /* block */)a1;
- (void)setVirtualSimMode:(char)a0 withDualSim:(char)a1 completion:(id /* block */)a2;
- (id)setVisualVoicemailState:(id)a0 subscribed:(char)a1;
...
- (char)shouldShowUserWarningWhenDialingCallOnContext:(id)a0 error:(id *)a1;
- (void)simulateDataStall:(char)a0 pdp:(int)a1 completion:(id /* block */)a2;
- (char)smartDataMode:(id)a0 error:(id *)a1;
- (char)supportsCellular;
- (char)supportsEmbeddedSIM;
- (char)supportsRequestWithSelector:(SEL)a0;
- (char)supportsSelector:(SEL)a0 withContext:(id)a1 error:(id *)a2;
...
- (char)updateGeofenceProfile:(id)a0;
- (id)updatePrivateNetworkProfile:(id)a0 setProfileAside:(char)a1;
