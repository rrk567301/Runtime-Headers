...
@property (nonatomic) char rightAlignWhenOverflowingRight;
...
@property (nonatomic) char updatePositionOnEachKeyPress;
...
- (char)canFitWindowInLocation:(unsigned long long)a0 textFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frameOfCurrentlyVisibleScreenUsingConstrainedFrame:(char)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })inlineFrameWithClient:(id)a0;
- (char)isUsingPositioningCorrection;
