...
@property (nonatomic) char canScroll;
...
@property (nonatomic) char respondsToMouseInteraction;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 scrollable:(char)a1;
...
- (void)setDocumentSize:(struct CGSize { double x0; double x1; })a0 resetCandidates:(char)a1;
- (void)setHasRubberBandEffect:(char)a0;
- (void)setHorizontalSelectionKeysWithHighlighted:(char)a0;
