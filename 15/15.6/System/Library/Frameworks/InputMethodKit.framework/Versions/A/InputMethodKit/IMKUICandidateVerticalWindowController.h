...
@property (nonatomic) char annotationMarginCalculated;
...
@property (nonatomic) char hasAnnotations;
@property (retain, nonatomic) IMKUISingleCandidateListView *listView;
@property (nonatomic) char updatingCandidates;
@property (retain, nonatomic) NSArray *visibleLineIndices;
@property (nonatomic) char changesSizeWhenScrolling;
