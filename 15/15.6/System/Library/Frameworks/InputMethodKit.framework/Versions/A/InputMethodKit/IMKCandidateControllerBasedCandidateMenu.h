...
@property (readonly, nonatomic) char isShown;
...
- (unsigned long long)panelTypeForCandidateStyle:(unsigned long long)a0 isTouchBar:(char)a1;
- (char)selectCandidateNumbered:(unsigned long long)a0;
