...
@property (nonatomic) char expandedContent;
...
@property (nonatomic) char showsNoCandidatesMessage;
...
@property (nonatomic) char showsScrollBars;
...
- (char)viewNeedsToExpandWithFirstLine:(unsigned long long)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })groupViewFrameWithVisibility:(char)a0;
- (void)removeAllLines;
