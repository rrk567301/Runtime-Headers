...
@property (nonatomic) char primaryCandidatesShownByScrubbing;
...
@property (nonatomic) char sInvalidateIMKTextOrientation;
@property (nonatomic) char sInvalidateIsIncrementalSearchInputContext;
@property (nonatomic) char sInvalidateIncrementalSearchClientGeometry;
@property (nonatomic) char touchBarCandidatesDidPresent;
...
@property (readonly, nonatomic) char isVerticalLayout;
@property (readonly, nonatomic) char isIncrementalSearchInputContext;
@property (readonly, nonatomic) unsigned long long incrementalSearchClientGeometry;
@property (nonatomic) char automaticallyShowPrimaryCandidatesInSecondaryController;
...
- (char)selectDisplayMethod:(id)a0;
