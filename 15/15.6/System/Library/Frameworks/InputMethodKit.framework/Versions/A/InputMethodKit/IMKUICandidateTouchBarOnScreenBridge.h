...
@property (readonly, nonatomic) char onscreenCandidatesCorrespondToTouchBarCandidates;
...
@property (nonatomic) char onscreenCandidatesReflectedInTouchBar;
@property (nonatomic) char scrubbingInTouchBarUpdatesOnscreenCandidates;
@property (nonatomic) char shouldRouteTouchBarSelectionEventsToInputController;
...
- (void)onscreenCandidateSelectionDidChange:(id)a0 committed:(char)a1;
