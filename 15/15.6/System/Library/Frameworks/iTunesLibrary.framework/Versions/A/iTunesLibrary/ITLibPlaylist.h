...
@property (readonly, nonatomic, getter=isAllItemsPlaylist) char allItemsPlaylist;
@property (readonly, retain, nonatomic) NSArray *items;
@property (readonly, nonatomic, getter=isMaster) char master;
...
- (char)containsMediaKind:(unsigned long long)a0;
