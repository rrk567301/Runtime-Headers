...
@property (nonatomic, getter=isCompilation) char compilation;
...
@property (nonatomic, getter=isRatingComputed) char ratingComputed;
@property (nonatomic, getter=isGapless) char gapless;
