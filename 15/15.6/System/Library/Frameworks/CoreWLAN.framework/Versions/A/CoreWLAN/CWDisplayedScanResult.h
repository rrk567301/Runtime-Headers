...
+ (id)displayedScanResultsWithNetworks:(id)a0 anqpElements:(id)a1 tetherDevices:(id)a2 cachedTetherDevices:(id)a3 filterCurrentNetworkWithInterface:(id)a4 noBSSID:(char)a5;
...
- (char)isEqualToDisplayedScanResult:(id)a0;
