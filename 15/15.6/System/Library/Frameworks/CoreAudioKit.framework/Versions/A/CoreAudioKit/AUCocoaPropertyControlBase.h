...
+ (char)property:(unsigned int)a0 withSize:(unsigned int)a1 supportedForAU:(struct OpaqueAudioComponentInstance { } *)a2;
+ (char)propertyIsWritable:(unsigned int)a0 supportedForAU:(struct OpaqueAudioComponentInstance { } *)a1;
