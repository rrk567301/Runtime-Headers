...
@property char showsExpertParameters;
...
- (void)createParameterClumpsIsThreaded:(char)a0 atPoint:(struct CGPoint { double x0; double x1; })a1;
- (void)createParameterStripsIsThreaded:(char)a0;
- (void)createScheduledUpdatesTimer;
- (void)destroyView;
- (float)displayParameterClumpsForSegment:(int)a0 fromSegmentChangeEvent:(char)a1;
...
- (void)setFilteredParameterList:(id)a0 exclude:(char)a1;
...
- (void)sizeHeaderComponentsToSize:(struct CGSize { double x0; double x1; })a0 andHeader:(char)a1;
