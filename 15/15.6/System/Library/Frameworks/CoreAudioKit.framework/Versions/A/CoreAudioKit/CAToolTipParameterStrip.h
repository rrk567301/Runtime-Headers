...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 parameter:(unsigned int)a1 label:(id)a2 minValue:(float)a3 maxValue:(float)a4 unitLabel:(id)a5 editable:(char)a6;
