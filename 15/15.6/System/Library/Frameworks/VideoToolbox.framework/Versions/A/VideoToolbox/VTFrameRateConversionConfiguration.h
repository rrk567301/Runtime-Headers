@class NSIndexSet, NSArray, NSDictionary, NSString, VEFrameRateConversionConfiguration;
...
@property (readonly, nonatomic) char usePrecomputedFlow;
...
- (void)dealloc;
- (id)veConfiguration;
- (id)initWithFrameWidth:(long long)a0 frameHeight:(long long)a1 usePrecomputedFlow:(char)a2 qualityPrioritization:(long long)a3 revision:(long long)a4;
