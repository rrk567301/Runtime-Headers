...
- (void)deviceInquiryTableViewInquiryComplete:(id)a0 error:(int)a1 aborted:(char)a2;
- (int)discover:(id *)a0;
...
- (void)enableRefreshServicesButton:(char)a0;
- (void)enableSelect:(char)a0;
- (id)getResults;
- (void)getSDPInfoForDevice:(id)a0 ignoreCache:(char)a1;
