...
- (id)initWithBaseImage:(struct __CVBuffer { } *)a0 sketchImage:(struct __CVBuffer { } *)a1 sketchMask:(struct __CVBuffer { } *)a2 baseImageRatio:(double)a3 sketchComplexityMeasure:(double)a4 generateCaptionFromImage:(char)a5 drawOnImageAssignmentOptions:(long long)a6;
- (id)initWithBaseImage:(struct __CVBuffer { } *)a0 sketchImage:(struct __CVBuffer { } *)a1 sketchMask:(struct __CVBuffer { } *)a2 baseImageRatio:(double)a3 sketchComplexityMeasure:(double)a4 generateCaptionFromImage:(char)a5 sanitizationCategory:(long long)a6 drawOnImageAssignmentOptions:(long long)a7;
