...
@property (nonatomic) char synthesizerShouldReset;
@property (nonatomic) char processIsVo;
...
@property (nonatomic) char characterLiteralMode;
...
@property (nonatomic) char speechActive;
@property (nonatomic) char speechPaused;
...
- (void)speechSynthesizer:(id)a0 didFinishSpeakingRequest:(id)a1 successfully:(char)a2 phonemesSpoken:(id)a3 withError:(id)a4;
