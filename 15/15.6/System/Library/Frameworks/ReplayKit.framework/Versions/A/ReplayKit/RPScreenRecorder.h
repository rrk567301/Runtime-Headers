...
@property (nonatomic) char hasUserConsentForCamera;
@property (nonatomic) char hasUserConsentForMicrophone;
...
@property (nonatomic) char systemRecording;
...
@property (nonatomic, getter=isCameraEnabled) char cameraEnabled;
...
- (char)checkContextID:(id)a0 withHandler:(id /* block */)a1;
...
- (char)isConnectionInterruptedOrInvalid:(id)a0;
...
- (void)registerAppForStateChangeSetRotationLock:(char)a0;
- (void)removePipView;
...
- (void)setWindowRotationLocked:(char)a0;
...
- (void)startRecordingWithMicrophoneEnabled:(char)a0 handler:(id /* block */)a1;
...
- (void)updateStateWithActive:(char)a0 error:(id)a1;
