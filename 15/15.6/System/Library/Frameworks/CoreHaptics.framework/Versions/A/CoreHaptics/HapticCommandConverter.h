...
- (unsigned long long)continuousHapticEventTypeForDefaultSharpness:(char)a0;
- (unsigned long long)continuousHapticEventTypeFromSharpness:(float)a0 sustained:(char)a1;
...
- (id)eventForEventEntry:(id)a0 engine:(id)a1 privileged:(char)a2;
...
- (unsigned long long)eventTypeForBuiltInAudioEventType:(unsigned long long)a0;
- (id)initWithServerConfig:(id)a0;
- (float)limitDynamicParameter:(id)a0 value:(float)a1 parameter:(id)a2;
- (float)limitEventParameter:(id)a0 value:(float)a1 parameter:(id)a2 eventType:(id)a3;
