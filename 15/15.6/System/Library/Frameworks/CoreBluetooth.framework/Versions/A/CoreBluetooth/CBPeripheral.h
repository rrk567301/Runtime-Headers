...
@property char canSendWriteWithoutResponse;
@property char ancsAuthorized;
...
@property (readonly) char visibleInSettings;
@property (readonly, nonatomic, getter=isConnectedToSystem) char connectedToSystem;
...
@property (readonly) char managedByFindMy;
...
- (void)setHighPriorityStream:(char)a0 duration:(id)a1;
...
- (void)enableFastLeConnection:(char)a0 withInfo:(id)a1 completion:(id /* block */)a2;
- (id)extendedDescription;
- (void)handleAttributeEvent:(id)a0 args:(id)a1 attributeSelector:(SEL)a2 delegateSelector:(SEL)a3 delegateFlag:(char)a4;
- (void)handleCharacteristicDescriptorsDiscovered:(id)a0;
- (void)handleCharacteristicEvent:(id)a0 characteristicSelector:(SEL)a1 delegateSelector:(SEL)a2 delegateFlag:(char)a3;
...
- (void)handleConnectionStateUpdated:(char)a0;
- (void)handleDescriptorEvent:(id)a0 descriptorSelector:(SEL)a1 delegateSelector:(SEL)a2 delegateFlag:(char)a3;
...
- (void)handleServiceEvent:(id)a0 serviceSelector:(SEL)a1 delegateSelector:(SEL)a2 delegateFlag:(char)a3;
...
- (void)setBroadcastValue:(char)a0 forCharacteristic:(id)a1;
- (void)setNotifyValue:(char)a0 forCharacteristic:(id)a1;
- (void)setOrphan;
- (void)setPeripheralName:(id)a0;
- (void)setVisibleInSettings:(char)a0;
