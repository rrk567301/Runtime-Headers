...
@property (nonatomic) char enableEPAForLEAdvertisement;
...
- (char)_parseProximityPairingBattery2:(const char **)a0;
- (char)changedTypesContainCBDiscovery:(id)a0;
- (char)_parseProximityPairingBattery1:(const char **)a0;
- (char)_parseProximityPairingBattery3:(const char **)a0;
...
- (char)_parseProximityPairingColor1:(const char **)a0;
- (void)_parseProximityPairingFindMyAccessoryStatusPtr:(const char *)a0 end:(const char *)a1;
- (char)_parseProximityPairingMisc1:(const char **)a0 deviceFlags:(unsigned long long *)a1;
...
- (char)_parseProximityPairingPID2:(const char **)a0;
- (void)_parseProximityPairingPtr:(const char *)a0 end:(const char *)a1;
- (char)_parseProximityPairingStatus1:(const char **)a0 deviceFlags:(unsigned long long *)a1;
- (char)_parseProximityPairingStatus3:(const char **)a0 deviceFlags:(unsigned long long *)a1;
...
- (char)changedTypesContainTypes:(const struct { unsigned char x0[6]; } *)a0;
- (char)changedTypesNeedsIdentify;
- (void)changedTypesRemoveAll;
- (void)decryptApplePayloadWithIdentity:(id)a0 forType:(unsigned char)a1 error:(id *)a2;
- (char)decryptNearbyInfoV2PayloadPtr:(const char *)a0 payloadLength:(unsigned long long)a1 key:(const char *)a2 keyLength:(unsigned long long)a3 decryptedPtr:(void *)a4;
- (void)decryptNearbyInfoV2PayloadWithIdentity:(id)a0 error:(id *)a1;
- (char)discoveryTypesContainCBDiscovery:(id)a0;
- (char)discoveryTypesContainType:(int)a0;
- (char)discoveryTypesContainTypes:(const struct { unsigned char x0[6]; } *)a0;
- (id)getSpatialInteractionDeviceTimestampArrayForClientID:(id)a0;
- (id)initWithXPCEventRepresentation:(id)a0 error:(id *)a1;
- (char)isEquivalentToCBDevice:(id)a0 compareFlags:(unsigned int)a1;
