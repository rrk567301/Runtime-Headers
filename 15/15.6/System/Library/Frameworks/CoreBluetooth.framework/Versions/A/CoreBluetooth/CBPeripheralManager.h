...
@property (readonly, nonatomic) char readyForUpdates;
@property (readonly, nonatomic) char waitingForReady;
...
@property (readonly, nonatomic, getter=supportsMultipleAdvertising) char isSupportingMultipleAdvertising;
@property (weak, nonatomic) id<CBPeripheralManagerDelegate> delegate;

+ (long long)authorizationStatus;
+ (char)supportsFeatures:(unsigned long long)a0;
...
- (void)publishL2CAPChannel:(unsigned short)a0 requiresEncryption:(char)a1;
...
- (void)publishL2CAPChannel:(unsigned short)a0 requiresEncryption:(char)a1 options:(id)a2;
- (void)publishL2CAPChannel:(unsigned short)a0 requiresEncryption:(char)a1 priority:(long long)a2;
- (void)publishL2CAPChannelWithEncryption:(char)a0;
- (void)publishL2CAPChannelWithEncryption:(char)a0 priority:(long long)a1;
- (void)publishPacketL2CAPChannel:(unsigned short)a0 requiresEncryption:(char)a1 withIncomingMTU:(unsigned short)a2 options:(id)a3;
...
- (char)updateValue:(id)a0 forCharacteristic:(id)a1 onSubscribedCentrals:(id)a2;
