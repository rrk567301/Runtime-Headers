...
@property (nonatomic) char denyLowPowerModeScans;
@property (nonatomic) char denyScreenLockedScans;
@property (nonatomic) unsigned char deviceSetupState;
@property (nonatomic) char disabledActive;
@property (nonatomic) char disabledPending;
...
@property (nonatomic) char xpcReportCompleteDevice;
...
- (char)updateWithCBDiscovery:(id)a0;
