...
@property (nonatomic) char tccComplete;
@property (nonatomic) char tccApproved;
@property (nonatomic) char tccRequired;
...
- (char)sendDebugMsg:(unsigned short)a0 args:(id)a1;
- (id)sendDebugSyncMsg:(unsigned short)a0 args:(id)a1;
- (char)sendMsg:(unsigned short)a0 args:(id)a1;
- (char)sendMsg:(unsigned short)a0 args:(id)a1 withReply:(id /* block */)a2;
- (char)sendRawCommand:(unsigned short)a0 data:(id)a1 completionHandler:(id /* block */)a2;
