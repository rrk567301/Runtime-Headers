...
+ (char)ardRunning;
+ (char)bluetoothModificationAllowed;
...
+ (char)safeToPowerOffBluetooth;
+ (char)setBluetoothModificationAllowed:(char)a0 error:(id *)a1;
+ (void)setOfflineAdvertisingParams:(id)a0;
+ (char)systemHasOnlyBluetoothPointingDevices;
+ (char)writePrefKey:(id)a0 value:(id)a1 error:(id *)a2;
...
- (void)setLowPowerModeWithParams:(int)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)setLowPowerModeWithReason:(int)a0 completion:(id /* block */)a1;
- (char)setLowPowerModeWithReason:(int)a0 error:(id *)a1;
