...
+ (char)isAppleVID:(unsigned short)a0 forVIDSrc:(unsigned char)a1;
+ (char)isDeviceSupported:(id)a0;
+ (char)isDeviceSupportedOnWatchOS:(id)a0;
+ (char)isDeviceSupportedOnXROS:(id)a0;
+ (char)isDeviceSupportedWithType:(unsigned char)a0 VIDsrc:(unsigned char)a1 VID:(unsigned short)a2 PID:(unsigned short)a3;
+ (char)isWatchOS;
+ (char)isXROS;
