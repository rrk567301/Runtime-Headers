...
@property (nonatomic, readonly) char supportsUnlimitedPlayers;
...
- (id)initWithIdentifier:(id)a0 groupIdentifier:(id)a1 title:(id)a2 details:(id)a3 supportPartyCode:(char)a4 fallbackURL:(id)a5 maxPlayers:(id)a6 minPlayers:(id)a7 defaultProperties:(id)a8 imageURL:(id)a9 playStyle:(long long)a10 associatedLeaderboardIDs:(id)a11 associatedAchievementDescriptionIDs:(id)a12;
