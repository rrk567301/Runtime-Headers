...
- (id)initWithActivityDefinition:(id)a0 partyCode:(id)a1 creator:(id)a2 initiatedByApple:(char)a3 referralLeaderboard:(id)a4 referralAchievement:(id)a5 support:(id)a6 error:(id *)a7;
- (id)initWithIdentifier:(id)a0 activityDefinition:(id)a1 properties:(id)a2 state:(unsigned long long)a3 partyCode:(id)a4 creationDate:(id)a5 startDate:(id)a6 lastResumeDate:(id)a7 endDate:(id)a8 duration:(double)a9 achievements:(id)a10 leaderboardScores:(id)a11 creator:(id)a12 initiatedByApple:(char)a13 referralLeaderboard:(id)a14 referralAchievement:(id)a15 participants:(id)a16 participantStates:(id)a17 shortGroupID:(id)a18 consumptionState:(id)a19 support:(id)a20 error:(id *)a21;
