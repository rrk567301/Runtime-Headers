...
@property (readonly, nonatomic) char clientHasAccessTokenEntitlement;
...
- (id)initWithClientBundleID:(id)a0 clientName:(id)a1 clientConnection:(id)a2 clientHasAccessTokenEntitlement:(char)a3 tokenID:(id)a4 providerBundleID:(id)a5 providerName:(id)a6 correlationID:(id)a7;
