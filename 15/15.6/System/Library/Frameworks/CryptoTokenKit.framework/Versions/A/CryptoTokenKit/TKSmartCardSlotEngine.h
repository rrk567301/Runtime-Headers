...
@property char apduSentSinceLastReset;
...
- (char)setProtocol:(unsigned long long)a0;
- (void)terminate;
- (void)_changeStateTo:(id)a0 forClient:(id)a1;
- (id)_findReservation:(id)a0 connection:(id)a1;
- (id)_getReservationId;
- (char)_setupWithName:(id)a0 delegate:(id)a1;
- (char)canSimulateCardReinsertion;
- (void)cardPresent:(char)a0;
- (void)changeStateTo:(long long)a0 powerState:(long long)a1;
- (char)connectCardSessionWithParameters:(id)a0;
...
- (void)powerDownWithEject:(char)a0;
- (void)reserveProtocols:(id)a0 reservationId:(id)a1 exclusive:(char)a2 reply:(id /* block */)a3;
...
- (char)setupWithName:(id)a0 delegate:(id)a1;
