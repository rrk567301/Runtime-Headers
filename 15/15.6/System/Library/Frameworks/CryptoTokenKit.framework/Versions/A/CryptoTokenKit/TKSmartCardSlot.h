...
- (void)invalidate;
- (id)screen;
- (void)connectToEndpoint:(id)a0 synchronous:(char)a1 reply:(id /* block */)a2;
...
- (char)simulateCardReinsertionWithError:(id *)a0;
- (id)slotParameters;
- (id)synchronous:(char)a0 remoteSlotWithErrorHandler:(id /* block */)a1;
