...
- (void)auditAuthOperation:(id)a0 auditToken:(struct { unsigned int x0[8]; })a1 success:(char)a2;
- (void)beginAuthForOperation:(long long)a0 constraint:(id)a1 reply:(id /* block */)a2;
- (void)beginRequest;
- (void)bumpKey:(id)a0 reply:(id /* block */)a1;
- (char)checkOperation:(long long)a0 usingKey:(id)a1 algorithm:(id)a2 parameters:(id)a3;
- (void)commitKey:(id)a0 reply:(id /* block */)a1;
- (void)createObjectWithAttributes:(id)a0 reply:(id /* block */)a1;
- (void)decapsulateSharedKey:(id)a0 usingKey:(id)a1 algorithm:(id)a2 reply:(id /* block */)a3;
...
- (void)evaluateAuthOperation:(id)a0 tokenOperation:(long long)a1 retry:(char)a2 reply:(id /* block */)a3;
...
- (void)getAttributesOfObject:(id)a0 isCertificate:(char)a1 reply:(id /* block */)a2;
