...
@property (readonly) char validateExtensionPoints;
...
+ (id)translateAppexptDictionary:(id)a0 definitionURL:(id)a1 isCatalyst:(char)a2;
...
- (char)validateExtensionPointIdentifier:(id)a0 sdkDictionary:(id)a1;
