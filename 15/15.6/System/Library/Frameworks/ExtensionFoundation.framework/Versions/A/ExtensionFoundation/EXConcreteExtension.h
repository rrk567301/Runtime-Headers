...
@property (nonatomic, getter=_isObservingHostAppStateChanges, setter=_setObservingHostAppStateChanges:) char observingHostAppStateChanges;
...
+ (char)_evaluateActivationRule:(id)a0 withDictionaryIfItMatchesActiveWebPageAlternative:(id)a1 matchResult:(out long long *)a2;
+ (char)_evaluateActivationRule:(id)a0 withInputItemsIfTheyMatchActiveWebPageAlternative:(id)a1 matchResult:(out long long *)a2;
+ (char)_genericValuesMatchActiveWebPageAlternativeWithExtensionItems:(id)a0 attachmentsLens:(id /* block */)a1 registeredTypeIdentifiersLens:(id /* block */)a2 isActiveWebPageAttachmentCheck:(id /* block */)a3;
+ (id)_inputItemsByApplyingActiveWebPageAlternative:(id)a0 ifNeededByActivationRule:(id)a1;
+ (char)_inputItemsMatchActiveWebPageAlternative:(id)a0;
+ (char)_matchingDictionaryMatchesActiveWebPageAlternative:(id)a0;
+ (void)extensionsWithMatchingAttributes:(id)a0 synchronously:(char)a1 completion:(id /* block */)a2;
...
- (char)_beginUsingAndCreateExtensionAssertionWithRequest:(id)a0 error:(id *)a1;
...
- (void)_reallyBeginExtensionRequest:(id)a0 synchronously:(char)a1 completion:(id /* block */)a2;
- (void)_resetExtensionState;
- (void)_safelyBeginUsingSynchronously:(char)a0 request:(id)a1 readyHandler:(id /* block */)a2;
...
- (char)makeExtensionContextAndXPCConnectionForRequest:(id)a0 error:(id *)a1;
