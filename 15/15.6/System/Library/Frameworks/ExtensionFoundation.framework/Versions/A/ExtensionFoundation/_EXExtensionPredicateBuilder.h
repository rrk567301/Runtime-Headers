...
@property (readonly) char strictMatchingSpecified;
@property (readonly) char usesStrictMatching;
...
- (void).cxx_destruct;
- (id)makePredicate;
- (id)applyRuleWithRuleName:(id)a0 acceptRule:(id)a1 rejectRule:(id)a2 types:(id)a3 exceptTypes:(id)a4 parentType:(id)a5 children:(id)a6 parentAccepted:(char)a7 accepted:(char *)a8 acceptedTypesInSubtree:(id *)a9 exceptTypesInSubtree:(id *)a10;
- (id)gatherChildrenPredicateWithRuleDictionary:(id)a0 parentType:(id)a1 parentAccepted:(char)a2 acceptedChildTypes:(id *)a3 exceptChildTypes:(id *)a4;
