...
- (void)_handshake:(char)a0;
- (void)beginExtensionRequestWithUserInfo:(id)a0;
- (char)hasConfigureSheet;
- (id)initWithExtension:(id)a0 isPreview:(char)a1;
...
- (id)loadViewForFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isPreview:(char)a1 completionBlock:(id /* block */)a2;
