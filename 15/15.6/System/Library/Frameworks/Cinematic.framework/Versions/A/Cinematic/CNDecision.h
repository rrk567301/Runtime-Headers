...
@property (readonly, getter=isUserDecision) char userDecision;
@property (readonly, getter=isGroupDecision) char groupDecision;
@property (readonly, getter=isStrongDecision) char strongDecision;
...
- (id)initWithTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 detectionGroupID:(long long)a1 strong:(char)a2;
- (id)initWithTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 detectionID:(long long)a1 strong:(char)a2;
