...
- (char)startTrackingAt:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 within:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3;
