...
- (void)dealloc;
- (void).cxx_destruct;
- (char)_encodeRenderToCommandBuffer:(id)a0 frameAttributes:(id)a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3 destinationTexture:(id)a4;
- (char)encodeRenderToCommandBuffer:(id)a0 frameAttributes:(id)a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3 destinationImage:(struct __CVBuffer { } *)a4;
- (char)encodeRenderToCommandBuffer:(id)a0 frameAttributes:(id)a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3 destinationLuma:(id)a4 destinationChroma:(id)a5;
- (char)encodeRenderToCommandBuffer:(id)a0 frameAttributes:(id)a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3 destinationRGBA:(id)a4;
