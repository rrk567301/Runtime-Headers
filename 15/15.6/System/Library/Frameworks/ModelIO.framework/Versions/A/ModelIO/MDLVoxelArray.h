...
@property (readonly, nonatomic) char isValidSignedShellField;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)voxelExistsAtIndex:(SEL)a0 allowAnyX:(char)a1 allowAnyY:(char)a2 allowAnyZ:(char)a3 allowAnyShell:(char)a4;
