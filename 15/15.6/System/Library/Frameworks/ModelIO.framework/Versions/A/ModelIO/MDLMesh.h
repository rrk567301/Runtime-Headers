...
+ (id)newBoxWithDimensions:(id)a0 segments:(SEL)a1 geometryType:(long long)a2 inwardNormals:(char)a3 allocator:(id)a4;
+ (id)newCapsuleWithHeight:(SEL)a0 radii:(float)a1 radialSegments:(unsigned long long)a2 verticalSegments:(unsigned long long)a3 hemisphereSegments:(unsigned long long)a4 geometryType:(long long)a5 inwardNormals:(char)a6 allocator:(id)a7;
+ (id)newCylinderWithHeight:(SEL)a0 radii:(float)a1 radialSegments:(unsigned long long)a2 verticalSegments:(unsigned long long)a3 geometryType:(long long)a4 inwardNormals:(char)a5 allocator:(id)a6;
+ (id)newEllipsoidWithRadii:(SEL)a0 radialSegments:(unsigned long long)a1 verticalSegments:(unsigned long long)a2 geometryType:(long long)a3 inwardNormals:(char)a4 hemisphere:(char)a5 allocator:(id)a6;
+ (id)newEllipticalConeWithHeight:(SEL)a0 radii:(float)a1 radialSegments:(unsigned long long)a2 verticalSegments:(unsigned long long)a3 geometryType:(long long)a4 inwardNormals:(char)a5 allocator:(id)a6;
+ (id)newIcosahedronWithRadius:(float)a0 inwardNormals:(char)a1 allocator:(id)a2;
+ (id)newIcosahedronWithRadius:(float)a0 inwardNormals:(char)a1 geometryType:(long long)a2 allocator:(id)a3;
...
- (char)generateAmbientOcclusionTextureWithQuality:(float)a0 attenuationFactor:(float)a1 objectsToConsider:(id)a2 vertexAttributeNamed:(id)a3 materialPropertyNamed:(id)a4;
- (char)generateAmbientOcclusionVertexColorsWithQuality:(float)a0 attenuationFactor:(float)a1 objectsToConsider:(id)a2 vertexAttributeNamed:(id)a3;
- (char)generateLightMapTextureWithQuality:(float)a0 lightsToConsider:(id)a1 objectsToConsider:(id)a2 vertexAttributeNamed:(id)a3 materialPropertyNamed:(id)a4;
- (char)generateLightMapVertexColorsWithLightsToConsider:(id)a0 objectsToConsider:(id)a1 vertexAttributeNamed:(id)a2;
- (id)initWithBufferAllocator:(id)a0;
- (id)initIcosahedronWithExtent:(SEL)a0 inwardNormals:(char)a1 geometryType:(long long)a2 allocator:(id)a3;
...
- (void)_enumerateSubmeshesUsingBlock:(id /* block */)a0 stopPointer:(char *)a1;
...
- (char)generateAmbientOcclusionTextureWithSize:(SEL)a0 raysPerSample:(long long)a1 attenuationFactor:(float)a2 objectsToConsider:(id)a3 vertexAttributeNamed:(id)a4 materialPropertyNamed:(id)a5;
- (char)generateAmbientOcclusionVertexColorsWithRaysPerSample:(long long)a0 attenuationFactor:(float)a1 objectsToConsider:(id)a2 vertexAttributeNamed:(id)a3;
- (char)generateLightMapTextureWithTextureSize:(SEL)a0 lightsToConsider:(id)a1 objectsToConsider:(id)a2 vertexAttributeNamed:(id)a3 materialPropertyNamed:(id)a4;
- (id)initBoxWithExtent:(id)a0 segments:(SEL)a1 inwardNormals:(char)a2 geometryType:(long long)a3 allocator:(id)a4;
- (id)initCapsuleWithExtent:(id)a0 cylinderSegments:(SEL)a1 hemisphereSegments:(unsigned long long)a2 inwardNormals:(char)a3 geometryType:(long long)a4 allocator:(id)a5;
- (id)initConeWithExtent:(id)a0 segments:(SEL)a1 inwardNormals:(char)a2 cap:(char)a3 geometryType:(long long)a4 allocator:(id)a5;
- (id)initCylinderWithExtent:(id)a0 segments:(SEL)a1 inwardNormals:(char)a2 topCap:(char)a3 bottomCap:(char)a4 geometryType:(long long)a5 allocator:(id)a6;
- (id)initHemisphereWithExtent:(id)a0 segments:(SEL)a1 inwardNormals:(char)a2 cap:(char)a3 geometryType:(long long)a4 allocator:(id)a5;
...
- (id)initSphereWithExtent:(id)a0 segments:(SEL)a1 inwardNormals:(char)a2 geometryType:(long long)a3 allocator:(id)a4;
...
- (char)makeVerticesUniqueAndReturnError:(id *)a0;
