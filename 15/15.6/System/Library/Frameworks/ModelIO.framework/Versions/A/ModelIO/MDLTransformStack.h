...
@property (nonatomic) char resetsTransform;
...
- (id)animatedMatrix4x4WithName:(id)a0 shouldCreateIfMissing:(char)a1;
- (id)animatedQuaternionWithName:(id)a0 shouldCreateIfMissing:(char)a1;
- (id)animatedScalarWithName:(id)a0 shouldCreateIfMissing:(char)a1;
- (id)animatedValueWithName:(id)a0;
- (id)animatedVector3WithName:(id)a0 shouldCreateIfMissing:(char)a1;
- (id)animatedVector4WithName:(id)a0 shouldCreateIfMissing:(char)a1;
