...
@property (nonatomic) char isCube;
@property (nonatomic) char hasAlphaValues;
...
- (id)texelDataWithTopLeftOriginAtMipLevel:(long long)a0 create:(char)a1;
- (struct CGImage { } *)imageFromTexture;
- (id)initWithData:(SEL)a0 topLeftOrigin:(id)a1 name:(char)a2 dimensions:(id)a3 rowStride:(long long)a4 channelCount:(unsigned long long)a5 channelEncoding:(long long)a6 isCube:(char)a7;
...
- (void)loadDataWithBottomLeftOriginAtMipLevel:(long long)a0 create:(char)a1 selector:(SEL)a2;
- (void)loadDataWithTopLeftOriginAtMipLevel:(long long)a0 create:(char)a1 selector:(SEL)a2;
...
- (id)texelDataWithBottomLeftOriginAtMipLevel:(long long)a0 create:(char)a1;
...
- (char)writeToURL:(id)a0 level:(unsigned long long)a1;
- (char)writeToURL:(id)a0 type:(struct __CFString { } *)a1;
- (char)writeToURL:(id)a0 type:(struct __CFString { } *)a1 level:(unsigned long long)a2;
