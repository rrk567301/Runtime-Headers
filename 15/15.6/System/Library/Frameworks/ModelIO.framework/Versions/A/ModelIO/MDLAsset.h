...
+ (char)canImportFileExtension:(id)a0;
+ (char)canExportFileExtension:(id)a0;
...
- (char)exportAssetToURL:(id)a0 error:(id *)a1;
- (id)initThroughSCNKitBridgeWithURL:(id)a0 options:(id)a1 error:(id)a2;
- (id)initThroughSCNKitBridgeWithURL:(id)a0 preserveTopology:(char)a1 error:(id)a2;
- (id)initWithBufferAllocator:(id)a0;
- (void)loadTextures;
- (void)resolveTextures;
- (void)_conformVertexBuffers:(id)a0 error:(id *)a1;
- (struct { })boundingBoxAtTime:(double)a0;
- (void)enumerateChildObjectsOfClass:(Class)a0 usingBlock:(id /* block */)a1 stopPointer:(char *)a2;
- (char)exportAssetToURL:(id)a0;
- (id)initWithData:(id)a0 name:(id)a1 vertexDescriptor:(id)a2 bufferAllocator:(id)a3 preserveTopology:(char)a4 error:(id *)a5;
- (id)initWithURL:(id)a0 bufferAllocator:(id)a1 preserveIndexing:(char)a2 error:(id *)a3;
- (id)initWithURL:(id)a0 bufferAllocator:(id)a1 preserveIndexing:(char)a2 options:(id)a3 error:(id *)a4;
- (id)initWithURL:(id)a0 vertexDescriptor:(id)a1 bufferAllocator:(id)a2;
- (id)initWithURL:(id)a0 vertexDescriptor:(id)a1 bufferAllocator:(id)a2 preserveTopology:(char)a3 error:(id *)a4;
