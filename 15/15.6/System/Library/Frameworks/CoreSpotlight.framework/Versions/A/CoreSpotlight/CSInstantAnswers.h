...
+ (void)_intentForSearchStringTokens:(id)a0 hasFlightIntent:(char *)a1 hasHotelIntent:(char *)a2;
+ (char)_isNoInstantAnswerQuery:(id)a0;
...
+ (char)eventHasValidRequiredFields:(id)a0;
+ (char)eventIsInFarFuture:(id)a0 queryDate:(id)a1;
+ (id)flightIntentTokens;
+ (id)flightTriggerPhrases;
+ (id)hotelIntentTokens;
+ (id)hotelStopWords;
+ (id)hotelTriggerPhrases;
+ (id)instantAnswersFallbackQueries:(id)a0 queryComponents:(id)a1 isCJK:(char)a2;
+ (id)instantAnswersMailboxes:(id)a0;
+ (char)isInstantAnswerTriggerQuery:(id)a0 isCJK:(char)a1 isSearchTool:(char)a2;
+ (char)isInstantAnswersTriggeringQuery:(id)a0 isCJK:(char)a1 instantAnswerQueryMinLengthNonCJK:(long long)a2 instantAnswerQueryMinLengthCJK:(long long)a3 isSearchTool:(char)a4;
+ (id)noInstantAnswersQueries;
+ (char)overrideParsedQuery:(id)a0;
+ (id)overrideTokens;
+ (id)selectInstantAnswersEventsWithFoundEvents:(id)a0;
+ (id)selectInstantAnswersEventsWithFoundEvents:(id)a0 forDate:(id)a1 isSearchToolQuery:(char)a2;
...
- (id)initFlightAnswerWithItem:(id)a0 answerAttributes:(id)a1;
- (id)initHotelAnswerWithItem:(id)a0 answerAttributes:(id)a1;
- (id)initRestaurantAnswerWithItem:(id)a0 answerAttributes:(id)a1;
- (void)initWithMessageId:(id)a0 groupId:(id)a1 fallbackGroupId:(id)a2 mailMessageId:(id)a3 answerAttributes:(id)a4;
