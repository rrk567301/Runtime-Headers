...
- (id)initWithAttributedParses:(id)a0 outputTokenInfo:(id)a1 embedding:(id)a2 embeddingScale:(float)a3 embeddingBias:(float)a4 isUnsafeQuery:(char)a5 error:(struct __CFError { } *)a6;
