...
@property char noIndex;
@property char isAppEntity;
@property (readonly) char needsPriority;
@property (readonly) char needsSummary;
@property unsigned __int128 score;
@property char allowTextStore;
@property char shouldSetSpotlightMailMessageAttributes;
@property unsigned long long machTime;
@property (copy) NSString *bundleID;
@property (copy) NSString *protection;
@property (readonly) char isFile;
...
- (char)_hasAttributesOfType:(id)a0;
- (char)_isFullyFormed;
...
- (char)_standardizeExternalAnalysisTags:(id)a0 forAttributeSet:(id)a1 primaryAttribute:(id)a2 analysisAttributes:(id)a3 specializedAttributes:(id)a4 standardizeBlock:(id /* block */)a5;
...
- (char)_standardizeNumericAnalysisTags:(id)a0 forAttributeSet:(id)a1 primaryAttribute:(id)a2 analysisAttributes:(id)a3 specializedAttributes:(id)a4 standardizeBlock:(id /* block */)a5;
