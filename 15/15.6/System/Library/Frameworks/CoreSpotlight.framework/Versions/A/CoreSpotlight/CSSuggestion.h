...
- (void)commonInitWithUserString:(id)a0 currentSuggestionToken:(id)a1 previousSuggestionTokens:(id)a2 updatedSuggestionTokens:(id)a3 enableFragments:(char)a4;
- (id)currentSuggestionToken;
- (id)currentToken;
- (id)currentTokens;
- (char)hasAttachmentsRelatedSearchString;
- (char)hasSuggestionTokenWithType:(long long)a0;
...
- (id)initWithUserString:(id)a0 previousSuggestionTokens:(id)a1 displayString:(id)a2 attributeValues:(id)a3 attributeStrings:(id)a4 enableFragements:(char)a5 options:(id)a6;
- (char)isEqualToSuggestion:(id)a0;
- (void)mergeSuggestionAndUpdateLocalizedAttributedString:(id)a0 queryContextScopeIsToPerson:(char)a1;
...
- (void)setEnableFragments:(char)a0;
...
- (void)updateSuggestFragments:(char)a0;
- (void)updateSuggestionTokens:(id)a0;
- (void)updateUpdatedFlag:(char)a0;
