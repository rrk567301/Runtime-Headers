...
@interface _CSSuggestionToken : NSObject <NSSecureCoding, NSCopying> {
    ...
    char _personIsUser;
    char _personIsImportant;
    char _personIsMailingList;
    char _shouldDisplayNameAndEmail;
    char _personNameIsMissing;
    char _isMailIntent;
    char _hasRecentActivity;
    char _hasUsedDate;
    double _age;
    NSString *_personIdentifier;
    CSSearchableItem *_personItem;
    double _megadomeCompositeScore;
    char _isMegadomeToken;
...
+ (id)suggestionTokenWithUserString:(id)a0 displayText:(id)a1 queryString:(id)a2;
...
- (void)setHasUsedDate:(char)a0;
- (char)isEqualToToken:(id)a0;
- (char)isMegadomeToken;
- (void)setAge:(double)a0;
- (void)addTokenScope:(id)a0 tokenText:(id)a1 queryString:(id)a2;
- (void)commonInitWithUserString:(id)a0 displayString:(id)a1 score:(id)a2;
- (char)hasRecentActivity;
- (char)hasUsedDate;
...
- (id)initWithUserString:(id)a0 displayString:(id)a1 queryString:(id)a2;
...
- (char)isImportant;
- (char)isMailingList;
- (char)isMessageWithAttachmentsToken;
- (char)isUser;
...
- (char)nameAndEmailRenderableWithName:(id)a0 emails:(id)a1;
