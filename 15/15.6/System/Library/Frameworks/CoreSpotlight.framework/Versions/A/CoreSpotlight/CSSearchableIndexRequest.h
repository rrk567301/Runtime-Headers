...
@property (nonatomic) char shouldThrottle;
...
- (id)initWithSearchableIndex:(id)a0 label:(id)a1 critical:(char)a2;
- (id)initWithSearchableIndex:(id)a0 label:(id)a1 critical:(char)a2 cost:(unsigned long long)a3;
