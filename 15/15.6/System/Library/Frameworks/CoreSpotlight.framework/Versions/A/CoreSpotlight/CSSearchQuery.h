...
@interface CSSearchQuery : NSObject <MDSearchQueryResultProcessor> {
    ...
    char _requireQueryParse;
    struct __MDQuery { } *_mdQuery;
    char _mdQueryCompletions;
    char _mdQueryCompleted;
...
@property (nonatomic) char isKeyboardCJK;
...
@property (nonatomic) char privateIndex;
@property (nonatomic) char userFSIndex;
@property (nonatomic) char suspended;
@property (retain, nonatomic) NSString *privateBundleID;
@property (nonatomic) char privateQuery;
...
- (void)filterMegadomePeopleSuggestions:(id)a0 isShortQuery:(char)a1 completionHandler:(id /* block */)a2;
- (char)grouped;
...
- (char)addOrUpdateLiveOID:(long long)a0 bundleID:(id)a1 identifier:(id)a2;
...
- (void)filterRankedItems:(id)a0 maxCount:(unsigned long long)a1 bundle:(id)a2 userQuery:(id)a3 queryID:(long long)a4 privateQuery:(char)a5 rankingConfiguration:(id)a6 currentTime:(double)a7 clientBundle:(id)a8 ranker:(id)a9;
...
- (void)prepareSearch;
- (void)processAttributesData:(id)a0 update:(char)a1 protectionClass:(id)a2;
...
- (id)rankBatch:(id)a0 withRanker:(id)a1 withBundle:(id)a2 maxCount:(unsigned long long)a3 rankingConfiguration:(id)a4 isCJK:(char)a5 isKeyboardCJK:(char)a6 queryContext:(id)a7;
- (char)removeLiveOID:(long long)a0 outBundleID:(id *)a1 outIdentifier:(id *)a2;
- (void)removeSuggestionCountQuery:(id)a0;
- (char)removeUserFSLiveOID:(long long)a0 outBundleID:(id *)a1 outIdentifier:(id *)a2;
