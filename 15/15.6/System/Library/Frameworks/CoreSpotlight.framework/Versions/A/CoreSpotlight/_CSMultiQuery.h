...
@property (nonatomic) char simple;
@property (retain, nonatomic) NSMutableArray *simpleQueryTokens;
@property (retain, nonatomic) NSArray *queries;
@property (retain, nonatomic) NSMutableArray *results;

+ (void)initialize;
+ (id)countingQueryForEmailsArrays:(id)a0 scope:(unsigned long long)a1 context:(id)a2 contextualFilterQueries:(id)a3 includeSecondaryRecipients:(char)a4 completionHandler:(id /* block */)a5;
