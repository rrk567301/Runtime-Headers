...
@property (nonatomic) char isPhotosPerson;
...
- (id)initWithDisplayName:(id)a0 handles:(id)a1 handleIdentifier:(id)a2 photosPersonIdentifier:(id)a3 isPhotosPerson:(char)a4 personType:(long long)a5 nameAlternatives:(id)a6 faceAttributes:(id)a7;
