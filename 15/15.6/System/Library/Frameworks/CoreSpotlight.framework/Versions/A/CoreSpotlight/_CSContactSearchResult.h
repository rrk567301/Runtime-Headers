...
@property (readonly, nonatomic) char contact;
@property (readonly, nonatomic) char recent;
@property (nonatomic) unsigned long long scope;

+ (id)generateQueryStringForContact:(id)a0 filterQueries:(id)a1 includeSecondaryRecipients:(char)a2 inputScope:(unsigned long long)a3;
