...
@interface CSSearchQueryContext : NSObject <NSSecureCoding, NSCopying> {
    ...
    char _attribute;
    char _lowPriority;
    char _parseUserQuery;
    char _enableSuggestionTokens;
    char _enableRecentSuggestions;
    char _enableResultCountsPerSuggestion;
    char _fsOnly;
    char _playback;
    char _includeUserActivities;
    char _disableBlockingOnIndex;
    char _advancedQuery;
    char _hasFreeTextQuery;
...
@property char disableResultStreaming;
...
@property (nonatomic) char pommesSuggestions;
@property (nonatomic) char pommesZKW;
@property (nonatomic) char lowPriority;
@property (nonatomic) char parseUserQuery;
@property (nonatomic) char disableNLP;
...
@property (nonatomic) char enableInstantAnswers;
@property (nonatomic) char filterTopHits;
@property (nonatomic) char privateQuery;
@property (nonatomic) char fsOnly;
@property (nonatomic) char playback;
@property (nonatomic) char includeUserActivities;
@property (nonatomic) char disableBlockingOnIndex;
@property (nonatomic) char fetchl2Signals;
@property (nonatomic) char priorityIndexQuery;
@property (nonatomic) char advancedQuery;
@property (nonatomic) char hasFreeTextQuery;
@property (nonatomic) char filterOutHiddenApps;
...
@property (nonatomic) char includeMDResults;
@property (retain, nonatomic) NSArray *fileScopes;
@property (nonatomic) char matchesSupportFiles;
@property (nonatomic) char matchesOnlyFinderFiles;
@property (nonatomic) unsigned long long maxPerGroup;
@property (nonatomic) char ignoreTopNForAggregation;
...
- (void)setDisableSafetyCheck:(char)a0;
- (void)setEmbeddingGenerationTimeout:(long long)a0;
- (void)setEnablePhotosEntitySearch:(char)a0;
- (void)setEnableRecentSuggestions:(char)a0;
- (void)setEnableResultCountsPerSuggestion:(char)a0;
- (void)setInstantAnswersOverrideDate:(id)a0;
- (void)setIsDateQueryContext:(char)a0;
