...
- (char)sendACMPCommandMessage:(id)a0 completionHandler:(id /* block */)a1;
- (char)sendACMPMessage:(id)a0 error:(id *)a1;
- (char)sendACMPResponseMessage:(id)a0 error:(id *)a1;
- (char)sendACMPSyncCommandMessage:(id)a0 completionHandler:(id /* block */)a1;
- (char)setHandler:(id)a0 forEntityID:(unsigned long long)a1;
