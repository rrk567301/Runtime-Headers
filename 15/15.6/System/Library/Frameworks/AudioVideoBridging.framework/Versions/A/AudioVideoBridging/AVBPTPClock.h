...
@interface AVBPTPClock : AVBClock {
    struct { char syncInfoValid; unsigned char syncFlags; unsigned long long timeSyncTime; struct IOAVB_U128 { unsigned long long lo; unsigned long long hi; } domainTime; unsigned long long cumulativeScaledRate; unsigned long long inverseCumulativeScaledRate; unsigned long long grandmasterID; unsigned short localPortNumber; } _timeInfo[8];
