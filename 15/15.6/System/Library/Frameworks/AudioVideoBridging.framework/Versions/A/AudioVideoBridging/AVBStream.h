...
- (char)changeDestinationMAC:(id)a0 error:(id *)a1;
- (char)deregisterAsyncCallbackWithError:(id *)a0;
- (id)initWithStreamID:(unsigned long long)a0 onInterfaceNamed:(id)a1;
- (char)registerAsyncCallback:(void /* function */ *)a0 withRefcon:(void *)a1 error:(id *)a2;
- (char)resetStreamWithError:(id *)a0;
