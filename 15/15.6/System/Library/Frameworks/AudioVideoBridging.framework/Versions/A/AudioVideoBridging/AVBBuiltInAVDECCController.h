...
@property (nonatomic) char maxTransitTimeTuningEnabled;
...
- (char)connectEntityWithEntityID:(unsigned long long)a0 onInterface:(id)a1;
...
- (char)disconnectEntityWithEntityID:(unsigned long long)a0 onInterface:(id)a1;
- (char)entityIsSupported:(id)a0 onInterface:(id)a1;
- (char)entityShouldBeIgnored:(id)a0 onInterface:(id)a1;
...
- (char)respectGeneralControllerIgnoreForEntity:(id)a0;
