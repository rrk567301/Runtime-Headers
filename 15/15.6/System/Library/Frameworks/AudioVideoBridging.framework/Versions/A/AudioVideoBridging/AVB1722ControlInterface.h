...
- (char)addControlRoutingID:(unsigned long long)a0;
- (id)commandsQueue;
...
- (char)removeControlRoutingID:(unsigned long long)a0;
- (char)sendControlFrameWithInfo:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned short x5; unsigned long long x6; unsigned char x7[6]; unsigned char x8[6]; } *)a0 andPayload:(char *)a1 error:(id *)a2;
