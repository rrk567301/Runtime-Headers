...
@interface AVBMediaClockInputStream : AVBInputStream {
    ...
    char _hasExpectedSequenceNumber;
    char *_presentationTimestampValid;
...
+ (char)destroyClockInputStreamWithStreamID:(unsigned long long)a0 onInterface:(id)a1 error:(id *)a2;

- (void)dealloc;
- (void).cxx_destruct;
- (char)changeFormat:(id)a0 andSamplingRate:(id)a1 error:(id *)a2;
...
- (char)startStreamingWithError:(id *)a0;
- (char)stopStreamingWithError:(id *)a0;
