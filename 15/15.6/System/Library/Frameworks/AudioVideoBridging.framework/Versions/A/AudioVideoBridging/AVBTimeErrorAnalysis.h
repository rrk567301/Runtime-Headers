...
- (id)variableName;
- (char)exportTimeErrorsToDirectoryURL:(id)a0 withFilename:(id)a1 relativeToFirstTimestamp:(char)a2;
- (id)initWithTimeErrorSequence:(id)a0;
- (char)writeAnalysisToDirectoryURL:(id)a0 withTitle:(id)a1 csvFilename:(id)a2 plotFilename:(id)a3 scriptFilename:(id)a4;
- (char)writeAnalysisToDirectoryURL:(id)a0 withTitle:(id)a1 csvFilename:(id)a2 plotFilename:(id)a3 scriptFilename:(id)a4 fromStartWindowSize:(long long)a5 toEndWindowSize:(long long)a6 stepSize:(long long)a7;
