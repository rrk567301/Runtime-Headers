...
+ (unsigned long long)organisationIdentifierForEUI64:(unsigned long long)a0 ouiType:(long long *)a1 uniquePart:(unsigned long long *)a2 expandedFromEUI48:(char *)a3;
...
+ (id)organisationNameForEUI64:(unsigned long long)a0 ouiType:(long long *)a1 uniquePart:(unsigned long long *)a2 expandedFromEUI48:(char *)a3;
