...
- (char)discoverEntity:(unsigned long long)a0;
- (char)addLocalEntity:(id)a0 error:(id *)a1;
- (char)changeEntityWithEntityID:(unsigned long long)a0 toNewGPTPGrandmasterID:(unsigned long long)a1 error:(id *)a2;
- (void)cleanupIOKit;
- (char)discoverEntities;
- (void)entityDiscoveryTerminated;
- (void)primeIterators;
- (char)removeLocalEntity:(unsigned long long)a0 error:(id *)a1;
