...
- (char)processAudioUnit:(id)a0 inConfiguration:(id)a1 withOldNewMappings:(id)a2 ofEntityModel:(id)a3 withLocalToRemoteMappings:(id)a4 andRemoteToLocalMappings:(id)a5;
- (char)processClockSource:(id)a0 inConfiguration:(id)a1 withOldNewMappings:(id)a2 ofEntityModel:(id)a3 withLocalToRemoteMappings:(id)a4 andRemoteToLocalMappings:(id)a5;
- (char)processVideoUnit:(id)a0 inConfiguration:(id)a1 withOldNewMappings:(id)a2 ofEntityModel:(id)a3 withLocalToRemoteMappings:(id)a4 andRemoteToLocalMappings:(id)a5;
- (void)removeMappingForObject:(id)a0 fromOldNewMappings:(id)a1;
- (id)sensorUnitForSensorUnit:(id)a0 addToMappings:(id)a1;
- (id)streamForStream:(id)a0 hasAudio:(char)a1 hasVideo:(char)a2;
