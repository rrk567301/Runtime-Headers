...
@property (nonatomic) char persistentAcquire;
@property (nonatomic) char releaseAcquisition;
...
- (char)persistentAcquire;
- (char)releaseAcquisition;
- (void)setAcquiredControllerID:(unsigned long long)a0;
- (void)setDescriptorIndex:(unsigned short)a0;
- (void)setPersistentAcquire:(char)a0;
- (void)setReleaseAcquisition:(char)a0;
