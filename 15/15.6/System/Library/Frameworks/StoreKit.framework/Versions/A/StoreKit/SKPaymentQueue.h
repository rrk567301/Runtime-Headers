...
- (void)_checkServerQueueForced:(char)a0;
...
- (void)_notifyObserversAboutChanges:(id)a0 sendUpdatedDownloads:(char)a1;
...
- (void)_updatedTransactions:(id)a0 restored:(char)a1;
...
- (char)shouldContinueTransaction:(id)a0 inNewStorefront:(id)a1;
