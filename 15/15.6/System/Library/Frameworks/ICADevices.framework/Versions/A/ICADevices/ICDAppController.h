...
- (void)addSelectorToInterface:(id)a0 selectorString:(id)a1 origin:(char)a2;
...
- (char)checkPlatformBinary:(struct { unsigned int x0[8]; })a0 clientPID:(int)a1;
- (char)checkTCCAccess:(struct { unsigned int x0[8]; })a0 clientPID:(int)a1;
...
- (void)processResult:(id)a0 onQueue:(id)a1 sync:(char)a2 completion:(id /* block */)a3;
...
- (void)setClientWithPID:(id)a0 usingDevice:(char)a1;
