...
@property (readonly, nonatomic, getter=isSeamless) char seamless;

+ (id)noiseMapWithNoise:(id)a0;
+ (id)noiseMapWithNoise:(id)a0 size:(SEL)a1 origin:(id)a2 sampleCount:(char)a3 seamless:(void /* unknown type, empty encoding */)a4;
...
- (id)initWithNoise:(id)a0 size:(SEL)a1 origin:(id)a2 sampleCount:(char)a3 seamless:(void /* unknown type, empty encoding */)a4;
