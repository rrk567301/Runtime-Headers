...
@property (nonatomic, getter=isCyclical) char cyclical;

+ (id)pathWithFloat3Points:(void *)a0 count:(unsigned long long)a1 radius:(float)a2 cyclical:(char)a3;
+ (id)pathWithGraphNodes:(id)a0 radius:(float)a1;
+ (id)pathWithPoints:(void *)a0 count:(unsigned long long)a1 radius:(float)a2 cyclical:(char)a3;
...
- (id)initWithFloat3Points:(void *)a0 count:(unsigned long long)a1 radius:(float)a2 cyclical:(char)a3;
- (id)initWithGraphNodes:(id)a0 radius:(float)a1;
- (id)initWithPoints:(void *)a0 count:(unsigned long long)a1 radius:(float)a2 cyclical:(char)a3;
- (void)set_cyclical:(char)a0;
