...
- (void)addConnection:(id)a0 bidirectional:(char)a1;
- (void)addConnectionsToNodes:(id)a0 bidirectional:(char)a1;
- (void *)cGraphNode;
...
- (void)removeConnectionsToNodes:(id)a0 bidirectional:(char)a1;
