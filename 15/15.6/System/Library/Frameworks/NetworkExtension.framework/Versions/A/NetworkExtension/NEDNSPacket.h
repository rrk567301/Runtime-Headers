...
@property (readonly) char isAuthoritativeAnswer;
@property (readonly) char isTruncated;
@property (readonly) char isRecursionDesired;
@property (readonly) char isRecursionAvailable;
