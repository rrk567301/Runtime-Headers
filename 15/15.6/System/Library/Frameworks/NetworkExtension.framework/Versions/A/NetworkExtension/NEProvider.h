...
+ (char)isNEProviderBundle:(id)a0 forExtensionPoint:(id)a1;
...
- (id)createTCPConnectionToEndpoint:(id)a0 enableTLS:(char)a1 TLSParameters:(id)a2 delegate:(id)a3;
- (long long)_callSwiftHandleNewUDPFlow:(id)a0 initialRemoteFlowEndpoint:(id)a1;
- (id)createUDPSessionToEndpoint:(id)a0 fromEndpoint:(id)a1;
- (void)displayMessage:(id)a0 completionHandler:(id /* block */)a1;
- (id)initAllowUnentitled:(char)a0;
