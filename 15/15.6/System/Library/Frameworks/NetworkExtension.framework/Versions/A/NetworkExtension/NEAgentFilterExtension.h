...
+ (char)authenticateFlowWithState:(struct cfil_crypto_state { struct ccdigest_info *x0; unsigned char x1[32]; } *)a0 crypto_key:(id)a1 flow:(id)a2 salt:(unsigned int)a3 isKernelSocket:(char)a4;
