...
+ (char)shouldPromptForLocalAuthentication;
...
- (id)initAndShowAlertWithHeader:(id)a0 message:(id)a1 alternateMessage:(id)a2 defaultMessage:(id)a3 noBoldDefault:(char)a4 usePrivacyIcon:(char)a5 extensionItem:(id)a6 callbackQueue:(id)a7 callbackHandler:(id /* block */)a8;
