...
- (id)initWithName:(id)a0 delegate:(id)a1 shouldCreateKernelChannel:(char)a2;
- (char)setDefaultInputHandler:(struct nw_protocol { unsigned char x0[16]; struct nw_protocol_identifier *x1; struct nw_protocol_callbacks *x2; struct nw_protocol *x3; void *x4; struct nw_protocol *x5; void *x6; } *)a0;
- (void)setRemotePacketProxy:(id)a0;
- (char)setUseFlowswitch:(char)a0;
