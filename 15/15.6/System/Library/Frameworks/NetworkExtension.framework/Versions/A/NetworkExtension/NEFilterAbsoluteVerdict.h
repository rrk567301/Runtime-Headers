...
- (id)initWithDrop:(char)a0 inboundPassOffset:(unsigned long long)a1 inboundPeekOffset:(unsigned long long)a2 outboundPassOffset:(unsigned long long)a3 outboundPeekOffset:(unsigned long long)a4;
