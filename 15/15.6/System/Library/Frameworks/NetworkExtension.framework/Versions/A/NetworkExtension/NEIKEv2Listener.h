...
- (id)initWithListenerIKEConfig:(id)a0 kernelSASessionName:(id)a1 listenerUDPPort:(id)a2 listenerQueue:(id)a3 delegate:(id)a4 delegateQueue:(id)a5 includeP2P:(char)a6;
