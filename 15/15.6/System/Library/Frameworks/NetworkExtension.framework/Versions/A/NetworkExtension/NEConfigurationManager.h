...
@property (nonatomic) char appGroupsChanged;
...
- (id)copyAppGroupMapDidChange:(char *)a0;
...
- (void)repopulateNetworkPrivacyConfigurationResetAll:(char)a0;
...
- (void)saveConfigurationToDisk:(id)a0 currentSignature:(id)a1 userUUID:(id)a2 isUpgrade:(char)a3 completionQueue:(id)a4 completionHandler:(id /* block */)a5;
- (void)setChangedQueue:(id)a0 andHandler:(id /* block */)a1;
- (void)showLocalNetworkAlertForApp:(id)a0 pid:(int)a1 uuid:(id)a2 query:(id)a3 hasEntitlement:(char)a4 completionQueue:(id)a5 handler:(id /* block */)a6;
- (void)showLocalNetworkAlertForApp:(id)a0 withCompletionQueue:(id)a1 handler:(id /* block */)a2;
- (void)showLocalNetworkAlertForApp:(id)a0 withCompletionQueue:(id)a1 query:(id)a2 hasEntitlement:(char)a3 handler:(id /* block */)a4;
