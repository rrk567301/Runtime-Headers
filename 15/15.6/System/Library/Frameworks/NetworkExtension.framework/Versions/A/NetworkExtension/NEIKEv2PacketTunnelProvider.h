@class NWPath, NEIKEv2Session, NSArray, NWPathEvaluator, NEIKEv2Server, NSDictionary, NEIKEv2MOBIKE, NSObject, NEUserNotification, NWResolver, NEIKEv2CompanionDatapath, NEIKEv2Rekey;
...
@interface NEIKEv2PacketTunnelProvider : NEPacketTunnelProvider {
    char _isIfCellular;
    char _isIfCompanion;
    char _companionHasOutboundPath;
    char _hasNAT;
    char _dispose;
