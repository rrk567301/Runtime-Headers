...
- (void)assertEquivalence:(char)a0 ofIdentifiers:(struct __CFArray { } *)a1 containers:(struct __CFArray { } *)a2 cloudConfigurationURLs:(struct __CFArray { } *)a3;
- (void)assertEquivalence:(char)a0 ofIdentifiers:(struct __CFArray { } *)a1 users:(struct __CFArray { } *)a2 hosts:(struct __CFArray { } *)a3 containers:(struct __CFArray { } *)a4 managedFlags:(struct __CFArray { } *)a5 cloudFlags:(struct __CFArray { } *)a6;
...
- (void)resetPreferences:(char)a0;
- (void)setDaemonCacheEnabled:(char)a0 identifier:(struct __CFString { } *)a1 user:(struct __CFString { } *)a2 host:(struct __CFString { } *)a3 container:(struct __CFString { } *)a4;
