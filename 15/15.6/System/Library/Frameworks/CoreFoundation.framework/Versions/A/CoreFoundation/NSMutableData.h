...
- (char)decompressUsingAlgorithm:(long long)a0 error:(id *)a1;
- (char)_compressUsingCompressionAlgorithm:(int)a0 error:(id *)a1;
- (char)_decompressUsingCompressionAlgorithm:(int)a0 error:(id *)a1;
- (char)compressUsingAlgorithm:(long long)a0 error:(id *)a1;
