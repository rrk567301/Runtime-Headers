...
- (char)_onqueue_validateToken:(struct __CFData { } *)a0 forRequestingApp:(struct { unsigned int x0[8]; })a1;
- (char)_showCurrentApprovalDialogAndWaitForReply;
...
- (void)remotePasteboardAvailable:(char)a0;
