...
- (char)_containsPort:(id)a0 forMode:(id)a1;
...
- (char)containsPort:(id)a0 forMode:(id)a1;
- (char)containsTimer:(id)a0 forMode:(id)a1;
...
- (char)runBeforeDate:(id)a0;
- (void)runLoopScheduledWithAction:(id)a0;
- (char)runMode:(id)a0 beforeDate:(id)a1;
- (char)runMode:(id)a0 untilDate:(id)a1;
