...
+ (id)orderedSetWithArray:(id)a0 copyItems:(char)a1;
+ (id)orderedSetWithArray:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
+ (id)orderedSetWithArray:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 copyItems:(char)a2;
...
+ (id)orderedSetWithOrderedSet:(id)a0 copyItems:(char)a1;
+ (id)orderedSetWithOrderedSet:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 copyItems:(char)a2;
+ (id)orderedSetWithSet:(id)a0;
+ (id)orderedSetWithSet:(id)a0 copyItems:(char)a1;
