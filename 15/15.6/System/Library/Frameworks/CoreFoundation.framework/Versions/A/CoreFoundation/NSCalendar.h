...
- (char)date:(id)a0 isSameDayAsDate:(id)a1;
- (char)date:(id)a0 isSameYearAsDate:(id)a1;
...
- (char)nextWeekendStartDate:(out id *)a0 interval:(out double *)a1 options:(unsigned long long)a2 afterDate:(id)a3;
...
- (char)rangeOfWeekendStartDate:(out id *)a0 interval:(out double *)a1 containingDate:(id)a2;
