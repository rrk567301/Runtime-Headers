...
+ (id)newWithContentsOf:(id)a0 immutable:(char)a1;
...
+ (id)newWithContentsOf:(id)a0 immutable:(char)a1 error:(id *)a2;
...
+ (id)arrayWithArray:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 copyItems:(char)a2;
+ (id)arrayWithArray:(id)a0;
+ (id)array;
+ (id)arrayWithArray:(id)a0 copyItems:(char)a1;
...
+ (id)arrayWithOrderedSet:(id)a0 copyItems:(char)a1;
+ (id)arrayWithOrderedSet:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
+ (id)arrayWithOrderedSet:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 copyItems:(char)a2;
+ (id)arrayWithSet:(id)a0;
+ (id)arrayWithSet:(id)a0 copyItems:(char)a1;
...
- (char)_validateValue:(inout id *)a0 forKeyPath:(id)a1 ofObjectAtIndex:(unsigned long long)a2 error:(out id *)a3;
...
- (char)_EX_boolAtIndex:(unsigned long long)a0;
- (char)_EX_boolAtIndex:(unsigned long long)a0 defaultValue:(char)a1;
...
- (char)containsObject:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)containsObjectIdenticalTo:(id)a0;
- (char)containsObjectIdenticalTo:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
