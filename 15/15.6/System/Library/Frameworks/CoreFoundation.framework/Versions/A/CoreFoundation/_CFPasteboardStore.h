...
+ (id)pasteboardStoreWithName:(struct __CFString { } *)a0 createIfNecessary:(char)a1;
...
- (void)_onqueue_handleNewRegularEntries:(struct __CFArray { } *)a0 forMessage:(id)a1 withSourceAuditToken:(struct { unsigned int x0[8]; })a2 shouldInvalidateClientMetadata:(char *)a3;
- (void)_onqueue_handleNewSecurityScopeEntries:(struct __CFArray { } *)a0 forMessage:(id)a1 withSourceAuditToken:(struct { unsigned int x0[8]; })a2 shouldInvalidateClientMetadata:(char *)a3;
...
- (char)_onqueue_isManagedPromiseDragWithCache:(id)a0 forGeneration:(unsigned long long)a1 itemIdentifier:(unsigned long long)a2;
...
- (void)getUserApproval:(id)a0 inApp:(char)a1 withCompletion:(id /* block */)a2;
- (void)handleAllowExtensionProcess:(id)a0;
- (void)handleBeginGeneration:(id)a0;
- (void)handleCreate:(id)a0;
- (void)handleDeadClientWithUUID:(struct __CFUUID { } *)a0 allowPasteboardDeletion:(char)a1;
