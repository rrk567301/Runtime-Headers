...
+ (id)_currentLocaleWithBundleLocalizations:(id)a0 disableBundleMatching:(char)a1;
...
+ (id)_newLocaleAsIfCurrent:(id)a0 overrides:(const struct __CFDictionary { } *)a1 disableBundleMatching:(char)a2;
+ (id)_newLocaleWithIdentifier:(id)a0;
+ (id)_numberingSystemForLocaleIdentifier:(id)a0;
+ (id)_preferredLanguagesForCurrentUser:(char)a0;
+ (void)_resetCurrent;
