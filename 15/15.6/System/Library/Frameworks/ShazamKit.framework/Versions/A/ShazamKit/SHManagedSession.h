...
@property (class, readonly) char isLiveActivityAvailable;
...
@property char sendNotifications;
@property (readonly) char isMatching;
@property (weak) id<SHManagedSessionDelegate> delegate;
@property char enableLiveActivity;
...
- (char)isUsingCustomCatalog:(id)a0;
...
- (char)session:(id)a0 shouldAttemptToMatchSignature:(id)a1;
