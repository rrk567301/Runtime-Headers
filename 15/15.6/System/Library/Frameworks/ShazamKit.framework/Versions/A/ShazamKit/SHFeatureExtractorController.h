...
- (char)configureSpectralPeaksExtractorWithClipStype:(long long)a0 maximumSeconds:(double)a1 sampleRate:(double)a2 error:(id *)a3;
...
- (char)flowBuffer:(id)a0 throughExtractor:(id)a1 error:(id *)a2;
