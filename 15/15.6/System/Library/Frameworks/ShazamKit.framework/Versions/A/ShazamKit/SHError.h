...
+ (char)remapErrorToClientErrorPointer:(id *)a0;
+ (id)messageForCode:(long long)a0;
+ (char)annotateClientError:(id *)a0 code:(long long)a1 underlyingError:(id)a2;
+ (char)annotateClientError:(id *)a0 code:(long long)a1 underlyingError:(id)a2 keyOverrides:(id)a3;
