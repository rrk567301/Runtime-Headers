...
- (char)hasConfigurationWithIdentifier:(id)a0;
- (id)IPCObjectWithIdentifier:(id)a0;
- (void)_onqueue_registerLogicalDevice:(id)a0;
- (char)acceptIncomingDriverConnection:(id)a0;
...
- (char)addConfiguration:(id)a0 replaceExisting:(char)a1;
- (id)configurationWithIdentifier:(id)a0;
- (void)deviceManager:(id)a0 deviceDidDisconnect:(id)a1;
- (void)driverCheckIn;
- (char)getLastGeneratedName:(id *)a0 directoryHandle:(id *)a1 url:(id *)a2;
