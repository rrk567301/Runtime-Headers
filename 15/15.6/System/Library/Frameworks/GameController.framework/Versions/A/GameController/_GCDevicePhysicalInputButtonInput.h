...
@property (readonly, getter=isAnalog) char analog;
@property (readonly) char canWrap;
...
@property (readonly, getter=isPressed) char pressed;
...
- (char)_setPressedDidChangeHandler:(id /* block */)a0;
