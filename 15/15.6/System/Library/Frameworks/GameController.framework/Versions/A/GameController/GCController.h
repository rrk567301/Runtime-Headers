...
@property (class, nonatomic) char shouldMonitorBackgroundEvents;
...
@property (nonatomic) char physicalDeviceUsesCompass;
...
@property (nonatomic, getter=areAllHIDDevicesConnected) char allHIDDevicesConnected;
...
@property (readonly, nonatomic, getter=isAttachedToDevice) char attachedToDevice;
...
+ (void)__open__;
+ (char)_settingsSupportedForBLEDevice:(id)a0 settingsStore:(id)a1;
+ (char)_settingsSupportedForBTClassicDevice:(id)a0 settingsStore:(id)a1;
+ (void)_startWirelessControllerDiscoveryWithBTClassic:(char)a0 btle:(char)a1 completionHandler:(id /* block */)a2;
+ (void)_startWirelessControllerDiscoveryWithCompanions:(char)a0 btClassic:(char)a1 btle:(char)a2 completionHandler:(id /* block */)a3;
+ (id)controllerWithExtendedGamepad;
+ (id)controllerWithMicroGamepad;
+ (char)settingsSupportedForCBDevice:(id)a0;
+ (id)snapshotWithProfile:(id)a0;
+ (void)startWirelessControllerDiscoveryWithCompletionHandler:(id /* block */)a0;
+ (char)supportsHIDDevice:(struct __IOHIDDevice { } *)a0;
+ (char)userHasPairedGameController;
+ (char)userHasPairedGameControllerSupportingInteractionProfile:(id)a0;
...
- (id)hapticEngines;
- (char)hasServiceRef:(struct __IOHIDServiceClient { } *)a0;
