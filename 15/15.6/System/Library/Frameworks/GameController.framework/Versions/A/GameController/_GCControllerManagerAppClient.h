...
@interface _GCControllerManagerAppClient : NSObject <GCSystemGestureXPCProxyServiceClient, GCSystemGestureXPCProxyServiceRemoteClientInterface, GCGameIntentXPCProxyServiceClient, GCGameIntentXPCProxyServiceRemoteClientInterface, GCSettingsXPCProxyServiceClient, GCSettingsXPCProxyServiceRemoteClientInterface, GCBatteryXPCProxyServiceClient, GCBatteryXPCProxyServiceRemoteClientInterface, GCMotionXPCProxyServiceClient, GCMotionXPCProxyServiceRemoteClientInterface, GCAdaptiveTriggersXPCProxyServiceClient, GCAdaptiveTriggersXPCProxyServiceRemoteClientInterface, GCLightXPCProxyServiceClient, GCLightXPCProxyServiceRemoteClientInterface, GCPlayerIndicatorXPCProxyServiceClient, GCPlayerIndicatorXPCProxyServiceRemoteClientInterface, GCControllerServiceRemoteClientInterface, _GCImplicitIPCObject, _GCIPCObjectRegistry, _GCIPCServiceRegistry, _GCIPCObjectMaterializationContext, _GCHIDEventSource, GCDeviceSessionDeviceProvider, _GCAppClientInterface> {
    ...
    char _bufferingStartPending;
    char _bufferingStarted;
    char _shouldStartBufferingOnForeground;
...
- (void)stopVideoRecordingWithClipBuffering:(char)a0 controller:(id)a1;
