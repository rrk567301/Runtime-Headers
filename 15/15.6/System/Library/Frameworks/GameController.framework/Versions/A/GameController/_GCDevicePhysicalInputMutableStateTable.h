...
- (char)testAndSetObjectValue:(id)a0 atIndex:(unsigned int)a1 policy:(unsigned long long)a2 compareObjects:(char)a3 previous:(id *)a4;
- (char)testAndSetPrimitiveValue:(unsigned long long)a0 atIndex:(unsigned int)a1 previous:(unsigned long long *)a2;
