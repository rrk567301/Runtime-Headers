...
@property (readonly, nonatomic) char sensorsRequireManualActivation;
@property (nonatomic) char sensorsActive;
@property (readonly, nonatomic) char hasGravityAndUserAcceleration;
...
@property (readonly, nonatomic) char hasAttitudeAndRotationRate;
@property (readonly, nonatomic) char hasAttitude;
@property (readonly, nonatomic) char hasRotationRate;
...
- (void)_setHasAttitude:(char)a0;
- (void)_setHasRotationRate:(char)a0;
