...
@interface _GCControllerGestureAwareButtonInput : GCControllerButtonInput {
    ...
    char _useActualSystemGestureState;
...
@property (nonatomic, getter=isLongPressMuted) char longPressMuted;
@property (nonatomic, getter=isDoublePressMuted) char doublePressMuted;
@property (nonatomic, getter=isSinglePressMuted) char singlePressMuted;
@property (nonatomic, getter=isEnabled) char enabled;
@property (nonatomic) char inputDisabledBySystem;
...
- (char)isDoublePressGestureRecognizerEnabled;
- (char)isLongPressGestureRecognizerEnabled;
- (char)isSinglePressGestureRecognizerEnabled;
