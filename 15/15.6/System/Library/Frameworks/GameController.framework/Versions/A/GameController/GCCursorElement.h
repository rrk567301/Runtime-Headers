...
- (char)_setPositionDidChangeHandler:(id /* block */)a0;
...
- (char)update:(void *)a0 forMouseEvent:(struct { unsigned long long x0; unsigned long long x1; union { struct { float x0; float x1; } x0; long long x1; } x2; })a1 withTimestamp:(double)a2;
