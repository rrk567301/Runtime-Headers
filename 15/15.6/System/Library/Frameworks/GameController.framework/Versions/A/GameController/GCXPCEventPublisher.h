...
@property (nonatomic) char receivedInitialBarrier;
@property (nonatomic, getter=isStatefulEventPublisher) char statefulEventPublisher;

- (void).cxx_destruct;
- (void)sendEvent:(id)a0;
- (void)handleEventWithAction:(unsigned int)a0 token:(unsigned long long)a1 descriptor:(id)a2;
- (id)initWithStreamName:(id)a0;
- (id)initWithStreamName:(id)a0 isStatefulEventPublisher:(char)a1;
