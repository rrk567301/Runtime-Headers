...
- (char)sendEvent:(id)a0 withPayloadBuilder:(id /* block */)a1;
- (void)sendEvent:(id)a0 withXPCPayload:(id)a1;
- (char)sendEvent:(id)a0 withXPCPayloadBuilder:(id /* block */)a1;
...
- (void)sendSettingsCustomizationsToggledEventForBundleID:(id)a0 productCategory:(id)a1 toggledOn:(char)a2;
