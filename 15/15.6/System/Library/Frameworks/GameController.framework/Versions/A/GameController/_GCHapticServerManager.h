...
@property (nonatomic) char activeEvents;
...
- (char)acceptNewConnection:(id)a0 fromHapticsEnabledApp:(id)a1;
- (void)enterRunloop;
...
- (char)playersHaveImpendingCommandsForStartTime:(double)a0 endTime:(double)a1;
