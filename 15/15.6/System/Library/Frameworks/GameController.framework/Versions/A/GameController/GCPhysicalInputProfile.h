...
@interface GCPhysicalInputProfile : NSObject <_GCGamepadEventSink, GCNamedProfile, GCControllerComponent> {
    ...
    char _launchpadGestureSettingsInitialized;
    char _lauchpadGestureEnabled;
...
@property (nonatomic) char hasRemappedElements;
...
- (id)_buttonWithInfo:(struct { id x0; char x1; char x2; union { struct { int x0; char x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; char x5; char x6; char x7; id x8; id x9; id x10; })a0;
- (id)_cursorWithInfo:(struct { id x0; char x1; char x2; union { struct { int x0; char x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; char x5; char x6; char x7; id x8; id x9; id x10; })a0;
- (id)_directionPadWithDescription:(id)a0;
- (id)_directionPadWithInfo:(struct { id x0; char x1; char x2; union { struct { int x0; char x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; char x5; char x6; char x7; id x8; id x9; id x10; })a0;
- (id)_keyboardButtonWithInfo:(struct { id x0; char x1; char x2; union { struct { int x0; char x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; char x5; char x6; char x7; id x8; id x9; id x10; })a0;
...
- (id)_touchpadWithInfo:(struct { id x0; char x1; char x2; union { struct { int x0; char x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; char x5; char x6; char x7; id x8; id x9; id x10; })a0;
...
- (char)settingsProfile:(id)a0 differsFrom:(id)a1;
