...
@property (nonatomic) char reportsAbsoluteTouchSurfaceValues;
...
- (char)setDigitizerX:(float)a0 digitizerY:(float)a1 touchDown:(char)a2 queue:(id)a3;
- (void)setValueForXAxis:(float)a0 yAxis:(float)a1 touchDown:(char)a2 buttonValue:(float)a3;
