...
- (void).cxx_destruct;
- (void)_onqueue_registerDefaultConfigurationForDevice:(id)a0 replaceExisting:(char)a1;
- (void)_onqueue_checkAndHideDuplicateDevice:(id)a0;
- (void)_onqueue_registerPhysicalDevice:(id)a0 serviceInfo:(id)a1 checkForDuplicateDevice:(char)a2;
- (void)_onqueue_relinquishHIDDevice:(id)a0;
- (char)acceptDriverConnection:(id)a0 forHIDService:(id)a1;
- (char)acceptFilterConnection:(id)a0 forHIDService:(id)a1;
