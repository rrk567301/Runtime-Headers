...
- (void).cxx_destruct;
- (void)_stopAnimation;
- (void)_doAnimation:(char)a0;
- (void)_resizeWindow:(id)a0 toFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 display:(char)a2;
