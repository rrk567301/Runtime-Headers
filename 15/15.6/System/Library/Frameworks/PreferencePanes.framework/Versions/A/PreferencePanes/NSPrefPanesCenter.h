...
+ (id)prefPanesDirectoriesIncludingSystem:(char)a0;
...
- (id)_verifyAndReadSystemCacheSynchronous:(char)a0;
- (void)_writeCache:(id)a0 isSystemCache:(char)a1 synchronous:(char)a2;
- (id)arrayOfPrefPaneIdentifiers;
- (id)buildCache:(char)a0;
