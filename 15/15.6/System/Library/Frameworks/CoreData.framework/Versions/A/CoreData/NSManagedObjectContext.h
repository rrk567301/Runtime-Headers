...
@property (nonatomic) char _isSwiftBound;
...
@property char shouldDeleteInaccessibleFaults;
...
@property (nonatomic) char automaticallyMergesChangesFromParent;
...
- (void)_setDisableDiscardEditing:(char)a0;
- (char)commitEditing;
...
- (void)_forgetObject:(id)a0 propagateToObjectStore:(char)a1 removeFromRegistry:(char)a2;
- (char)_isSwiftBound;
- (void)_managedObjectContextEditor:(id)a0 didCommit:(char)a1 contextInfo:(struct { id x0; SEL x1; void *x2; } *)a2;
...
- (char)_parentObtainPermanentIDsForObjects:(id)a0 context:(id)a1 error:(id *)a2;
- (char)_performImmediate:(id /* block */)a0;
...
- (void)_setAllowAncillaryEntities:(char)a0;
- (char)_setChangeTrackingTokenFromToken:(id)a0 error:(id *)a1;
- (void)_setFaultingError:(id)a0;
- (char)_setQueryGenerationFromToken:(id)a0 error:(id *)a1;
...
- (char)_updateLocationsOfObjectsToLocationByOrderKey:(id)a0 inRelationshipWithName:(id)a1 onObjectWithID:(id)a2 error:(id *)a3;
- (id)databaseStatistics;
- (void)detectConflictsForObject:(id)a0;
- (char)evictFuture:(id)a0 withError:(id *)a1;
...
- (char)setQueryGenerationFromToken:(id)a0 error:(id *)a1;
- (void)setShouldPerformSecureOperation:(char)a0;
- (void)setShouldRefreshAfterSave:(char)a0;
- (void)setTrackSQLiteDatabaseStatistics:(char)a0;
- (void)set_isSwiftBound:(char)a0;
- (char)shouldHandleInaccessibleFault:(id)a0 forObjectID:(id)a1 triggeredByProperty:(id)a2;
- (char)shouldPerformSecureOperation;
- (char)shouldRefreshAfterSave;
- (char)trackSQLiteDatabaseStatistics;
