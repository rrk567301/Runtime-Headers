...
- (char)checkForObjectsNeedingExportInStore:(id)a0 andReturnCount:(unsigned long long *)a1 withManagedObjectContext:(id)a2 error:(id *)a3;
- (char)processAnalyzedHistoryInStore:(id)a0 inManagedObjectContext:(id)a1 error:(id *)a2;
