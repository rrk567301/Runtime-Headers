...
+ (int)debugDefault;
+ (char)dropPersistentHistoryforPersistentStoreWithURL:(id)a0 options:(id)a1 error:(id *)a2;
...
+ (Class)rowCacheClass;
+ (void)setColoredLoggingDefault:(char)a0;
...
- (void)_setHasAncillaryModels:(char)a0;
- (char)_unload:(id *)a0;
