...
- (void)dealloc;
- (char)canModifyManagedObjectsInStore:(id)a0;
...
- (char)assignManagedObjects:(id)a0 toCloudKitRecordZone:(id)a1 inPersistentStore:(id)a2 error:(id *)a3;
- (char)canDeleteRecordForManagedObjectWithID:(id)a0;
- (char)canUpdateRecordForManagedObjectWithID:(id)a0;
...
- (char)initializeCloudKitSchemaWithOptions:(unsigned long long)a0 error:(id *)a1;
