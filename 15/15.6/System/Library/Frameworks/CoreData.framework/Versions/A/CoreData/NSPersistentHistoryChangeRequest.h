...
- (id)initWithDate:(id)a0 delete:(char)a1;
- (id)initWithDate:(id)a0 delete:(char)a1 percentageOfDB:(unsigned long long)a2;
- (id)initWithToken:(id)a0;
- (id)initWithToken:(id)a0 delete:(char)a1;
- (id)initWithToken:(id)a0 delete:(char)a1 percentageOfDB:(unsigned long long)a2;
- (id)initWithTransactionID:(id)a0 delete:(char)a1 transactionOnly:(char)a2 percentageOfDB:(unsigned long long)a3;
...
- (id)propertiesToFetchForEntity:(id)a0 includeTransactionStrings:(char)a1;
- (unsigned long long)requestType;
- (void)setUseQueryGenerationToken:(char)a0;
- (id)transactionIDs;
