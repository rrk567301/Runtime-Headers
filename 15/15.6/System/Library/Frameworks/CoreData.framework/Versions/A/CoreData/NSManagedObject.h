...
@property (class, readonly) char contextShouldIgnoreUnmodeledPropertyChanges;
...
@property (readonly, nonatomic, getter=isUpdated) char updated;
...
+ (char)_classShouldAlwaysRegisterSelectorNamed:(const char *)a0;
+ (id)entityName;
+ (id)entity;
+ (id)fetchRequest;
+ (id)fetchRequest;
...
- (void)didSave;
- (char)_defaultValidation:(id *)a0 error:(id *)a1;
...
- (char)_updateLocationsOfObjectsToLocationByOrderKey:(id)a0 inRelationshipWithName:(id)a1 error:(id *)a2;
...
- (char)hasFaultForRelationshipNamed:(id)a0;
- (char)isRelationshipForKeyFault:(id)a0;
