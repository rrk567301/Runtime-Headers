...
@property (nonatomic, getter=isFromCurrentDevice) char fromCurrentDevice;
@property (nonatomic) long long deviceCategory;
@property (retain, nonatomic) NSString *deviceName;
@property (nonatomic) unsigned long long keychainItemHash;
@property (nonatomic) char isDeveloperCreated;
