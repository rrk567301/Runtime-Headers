...
@property char needsUpdateCachedFirstAccount;
...
- (id)init;
- (void).cxx_destruct;
- (void)_fetchAccountsSimulatingExpiredToken:(char)a0 forProviderIDs:(id)a1 completion:(id /* block */)a2;
- (char)_insertAccount:(id)a0 inContext:(id)a1 error:(id *)a2;
