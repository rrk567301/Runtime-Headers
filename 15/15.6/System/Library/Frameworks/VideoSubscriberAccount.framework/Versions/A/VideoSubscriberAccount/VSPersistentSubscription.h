...
- (char)validateModificationDate:(id *)a0 error:(id *)a1;
- (void)_deriveValuesFromProvidedInfo:(id)a0;
- (void)_updateDerivedSubscriptionInfo;
- (char)_validateNullableValue:(id *)a0 forKey:(id)a1 error:(id *)a2;
...
- (char)validateAccessLevel:(id *)a0 error:(id *)a1;
- (char)validateBillingIdentifier:(id *)a0 error:(id *)a1;
- (char)validateCreationDate:(id *)a0 error:(id *)a1;
- (char)validateExpirationDate:(id *)a0 error:(id *)a1;
- (char)validateSubscriberIdentifierHash:(id *)a0 error:(id *)a1;
- (char)validateTierIdentifiers:(id *)a0 error:(id *)a1;
