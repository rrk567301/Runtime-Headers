...
- (void /* function */ *)_copySigningIdentifier;
- (struct __SecTask { } *)_taskRef;
- (char)getValue:(id *)a0 forEntitlement:(id)a1 error:(id *)a2;
...
- (char)shouldAllowAccessForBooleanEntitlement:(id)a0;
- (char)shouldAllowAccessToSubscriberIdentifierHashModifier:(id)a0;
