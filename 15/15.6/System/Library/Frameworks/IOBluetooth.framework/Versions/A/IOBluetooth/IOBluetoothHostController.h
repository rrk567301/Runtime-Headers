...
- (int)enableRemoteWake:(char)a0;
- (unsigned int)featureFlags;
- (int)getControllerManufacturerName;
- (id)getDeviceForHCIRequestID:(unsigned int)a0 removeIfFound:(char)a1;
...
- (unsigned int)requestWithTimeout:(int)a0 isSynchronous:(char)a1 device:(id)a2;
