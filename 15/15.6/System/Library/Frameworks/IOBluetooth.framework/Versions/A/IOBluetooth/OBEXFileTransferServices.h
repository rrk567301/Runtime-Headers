...
- (void)GetFileHandler:(id)a0 isEnd:(char)a1 errorCode:(int)a2 transferProgress:(id)a3;
...
- (void)PutFileHandler:(id)a0 isEnd:(char)a1 errorCode:(int)a2 transferProgress:(id)a3;
...
- (void)setActionInProgress:(char)a0;
- (void)startCommand;
