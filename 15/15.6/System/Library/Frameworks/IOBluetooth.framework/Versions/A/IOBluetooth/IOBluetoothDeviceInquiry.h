...
@property (nonatomic) char searchesUntilCancelled;
@property (nonatomic) char returnDuplicates;
...
@property char updateNewDeviceNames;
...
- (void)inquiryStateChanged:(char)a0;
