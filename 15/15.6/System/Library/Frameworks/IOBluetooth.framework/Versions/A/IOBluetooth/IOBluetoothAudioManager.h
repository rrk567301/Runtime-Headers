...
+ (void)call:(id)a0 isIncoming:(char)a1;
...
+ (unsigned int)defaultDeviceIDForOutput:(char)a0;
+ (void)disconnectAudioDevice:(id)a0;
+ (void)getDefaults:(id /* block */)a0;
+ (char)isBluetoothDevice:(unsigned int)a0;
+ (void)removeAudioDevice:(id)a0;
+ (void)resetDefaults;
+ (unsigned int)serviceForAddressString:(id)a0;
+ (char)setAudioDevice:(unsigned int)a0 isOutput:(char)a1;
