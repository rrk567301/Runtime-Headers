...
@property (nonatomic) char isTransmissionPaused;
@property char isOpeningRFCOMM;
...
- (int)write:(void *)a0 length:(unsigned short)a1 sleep:(char)a2;
- (int)writeAsync:(void *)a0 length:(unsigned short)a1 refcon:(void *)a2;
- (int)writeSimple:(void *)a0 length:(unsigned short)a1 sleep:(char)a2 bytesSent:(unsigned int *)a3;
