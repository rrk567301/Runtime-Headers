...
@property char previousOutputMuted;
...
@property (getter=isSMSEnabled) char SMSEnabled;
@property (nonatomic) int handsFreeState;
@property char connectSCOAfterSLCConnected;
@property char disconnectAfterDisconnectingSCO;
@property char xaplSent;
...
@property (readonly, getter=isConnected) char connected;
...
- (id)decodeNumber:(id)a0 isSCA:(char)a1 type:(unsigned int *)a2;
- (id)decodePDU:(id)a0;
