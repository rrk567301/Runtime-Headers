...
@property (nonatomic) char initializedProperties;
@property (readonly, nonatomic) char supportsAnimatedImages;
@property (readonly, nonatomic) struct CGSize { double x0; double x1; } ptSize;
@property (readonly, copy, nonatomic) UTType *utType;
@property (readonly, nonatomic) char containsMultipleFrames;
...
- (char)typeSupportsAnimatedImages;
