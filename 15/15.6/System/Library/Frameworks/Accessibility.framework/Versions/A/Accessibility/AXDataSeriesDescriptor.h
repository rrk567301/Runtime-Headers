...
- (void)_commonInitWithContinuous:(char)a0 dataPoints:(id)a1;
- (id)initWithAttributedName:(id)a0 isContinuous:(char)a1 dataPoints:(id)a2;
- (id)initWithName:(id)a0 isContinuous:(char)a1 dataPoints:(id)a2;
