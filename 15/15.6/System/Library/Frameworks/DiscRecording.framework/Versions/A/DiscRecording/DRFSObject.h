...
- (id)mangledNameForFilesystem:(id)a0;
- (id)mangledNames;
- (id)propertiesForFilesystem:(id)a0 mergeWithOtherFilesystems:(char)a1;
- (id)propertyForKey:(id)a0 inFilesystem:(id)a1 mergeWithOtherFilesystems:(char)a2;
