...
- (void)evaluateStartingAtIndex:(unsigned long long)a0 probeUUID:(id)a1 probeWasSuccessful:(char)a2;
- (char)matchesNetworkDescriptionArray:(id)a0 endpoint:(id)a1 parameters:(id)a2;
