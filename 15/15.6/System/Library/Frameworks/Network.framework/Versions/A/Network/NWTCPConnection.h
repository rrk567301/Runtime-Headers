...
@property (nonatomic, getter=isViable) char viable;
@property (nonatomic) char hasBetterPath;
...
@property (readonly, nonatomic) char TFOSucceeded;
@property (readonly, nonatomic) char isMultipath;
