...
@property char useOverviewImageAsFinalImage;
...
@property char usesThresholdForBlackAndWhiteScanning;
...
- (id)currentSettings;
- (void)setScanInProgress:(char)a0;
- (id)scanner;
- (void)setBackgroundGrayValue:(unsigned char)a0;
- (void)setOverviewScanInProgress:(char)a0;
