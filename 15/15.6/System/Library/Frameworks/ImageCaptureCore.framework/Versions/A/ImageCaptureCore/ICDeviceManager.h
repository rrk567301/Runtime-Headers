...
@property (nonatomic) char deviceOperationQueueSuspended;
...
@property (nonatomic) char managerIsRunning;
@property (nonatomic) unsigned int managerInvalidationCount;
@property (nonatomic) char controlAuthorizedOnce;
