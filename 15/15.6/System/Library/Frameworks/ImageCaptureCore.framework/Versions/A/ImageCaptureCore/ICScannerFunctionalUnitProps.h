...
@property (nonatomic) char acceptsThresholdForBlackAndWhiteScanning;
@property (nonatomic) char usesThresholdForBlackAndWhiteScanning;
...
@property (nonatomic) char supportsProgressNotificationsWithScanData;
@property (nonatomic) char useOverviewImageAsFinalImage;
