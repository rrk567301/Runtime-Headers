...
- (char)captureUserIntentForBundleIdentifier:(id)a0 withNotification:(id)a1;
...
- (void)updateApplicationWithBundleIdentifier:(id)a0 withStatus:(char)a1;
- (void)updateBundleIdentifier:(id)a0 accessType:(id)a1 withState:(unsigned long long)a2;
- (char)validateBundleIdentifierInstalled:(id)a0;
