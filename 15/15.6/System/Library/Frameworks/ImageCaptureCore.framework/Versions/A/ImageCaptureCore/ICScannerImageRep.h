...
@property (nonatomic) char bufferUpdated;
@property (nonatomic) char useOverlay;
...
- (struct CGImage { } *)copyCGImage:(char *)a0;
- (char)copyOverlayBuffer:(id)a0 toRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
