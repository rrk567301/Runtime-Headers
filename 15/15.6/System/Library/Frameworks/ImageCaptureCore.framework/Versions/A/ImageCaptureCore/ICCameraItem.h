...
@property (nonatomic, getter=isInTemporaryStore) char inTemporaryStore;
@property (nonatomic, getter=wasAddedAfterContentCatalogCompleted) char addedAfterContentCatalogCompleted;
@property (copy, nonatomic) NSDate *creationDate;
@property (copy, nonatomic) NSDate *modificationDate;
@property (nonatomic, getter=isRaw) char raw;
