...
- (void)dealloc;
- (void)addWindowsWithIDs:(id)a0 lazyCapture:(char)a1;
- (id)initWithTileID:(unsigned long long)a0 parentSpaceID:(unsigned long long)a1 tileFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 includeBorder:(char)a3 window:(id)a4;
