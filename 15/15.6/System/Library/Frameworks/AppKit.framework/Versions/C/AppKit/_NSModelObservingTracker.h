...
- (void)setIndexReferenceModelObjectArray:(id)a0 clearAllModelObjectObserving:(char)a1;
- (void)_dealloc;
- (void)_logObservingInfo;
- (void)_registerOrUnregister:(char)a0 observerNotificationsForKeyPath:(id)a1;
- (void)_registerOrUnregister:(char)a0 observerNotificationsForKeyPath:(id)a1 ofModelObject:(id)a2;
- (void)_registerOrUnregister:(char)a0 observerNotificationsForModelObject:(id)a1;
- (void)_startObservingModelObject:(id)a0;
- (void)_stopObservingModelObject:(id)a0;
- (void)analyzeKeyPath:(id)a0 registerOrUnregister:(char)a1;
