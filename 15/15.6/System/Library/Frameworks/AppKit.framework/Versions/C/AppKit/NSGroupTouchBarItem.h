...
- (void)setHasAutomaticLayoutDirection:(char)a0;
- (id)makeViewForCustomizationPreview;
- (id)_defaultCompressionOptionOrder;
- (void)_itemViewMinSize:(struct CGSize { double x0; double x1; } *)a0 maxSize:(struct CGSize { double x0; double x1; } *)a1 preferredSize:(struct CGSize { double x0; double x1; } *)a2 stretchesContent:(char)a3;
...
- (void)setGroupHasAlertStyle:(char)a0;
