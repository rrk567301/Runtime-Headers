...
- (void)_setOnDemandSpringLoadingArmed:(char)a0;
- (id)_target;
- (long long)_deviceID;
...
- (void)_enableSpringLoading:(char)a0 options:(unsigned long long)a1;
...
- (void)_setDragDeepEnabled:(char)a0;
...
- (void)_setOnDemandSpringLoadingActivated:(char)a0;
- (void)_setOnDemandSpringLoadingEnabled:(char)a0;
- (void)_setOnDemandSpringLoadingHoverArmed:(char)a0;
...
- (void)_springLoadingActivated:(char)a0;
