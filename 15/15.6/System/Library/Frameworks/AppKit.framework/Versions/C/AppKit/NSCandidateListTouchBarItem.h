...
@property (readonly, getter=isCandidateListVisible) char candidateListVisible;
@property char allowsTextInputContextCandidates;
...
- (void)setAllowsCollapsing:(char)a0;
- (void)setAllowsTextInputContextCandidates:(char)a0;
...
- (void)setLimitsNumberOfCandidates:(char)a0;
- (char)shouldAnimateNextLayoutPass;
- (void)updateWithInsertionPointVisibility:(char)a0;
- (id)viewController;
