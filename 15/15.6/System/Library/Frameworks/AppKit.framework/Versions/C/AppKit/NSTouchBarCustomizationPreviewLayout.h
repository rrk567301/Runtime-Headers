...
- (void)dealloc;
- (id)delegate;
- (id)_workaround_layoutAttributesForSupplementaryViewOfKind:(id)a0 atIndexPath:(id)a1 canReturnNil:(char)a2;
- (char)canInsertItem:(id)a0 atIndexPath:(id)a1;
- (char)canMoveItemAtIndexPath:(id)a0 toIndexPath:(id)a1;
