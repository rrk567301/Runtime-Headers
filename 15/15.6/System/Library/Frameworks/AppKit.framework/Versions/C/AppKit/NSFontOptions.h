...
- (id)displayStringsForAttributes:(id)a0 includeBoldItalic:(char)a1;
...
- (char)getStylesPanelTextView:(id *)a0 window:(id *)a1;
- (void)loadUI;
...
- (void)selectAllInView:(id)a0 selectionOnly:(char)a1 fontFamily:(char)a2 font:(char)a3 characterStyle:(char)a4 paragraphStyle:(char)a5;
- (void)selectDefaultRange;
- (void)selectFarthestRangeForward:(char)a0;
- (void)selectNextRangeForward:(char)a0;
