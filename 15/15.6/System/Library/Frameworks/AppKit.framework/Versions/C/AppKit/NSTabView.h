...
@property char allowsTruncatedLabels;
...
+ (void)_setUsesToolTipsWhenTruncated:(char)a0;
...
- (char)_associatedTabViewControllerHasTabs;
...
- (struct __CFDictionary { } *)_copyCoreUIOptionsForTabViewItem:(id)a0 withState:(unsigned long long)a1 maskOnly:(char)a2 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
- (char)_coreUIDrawBezelInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withClip:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 flipped:(char)a2;
- (char)_coreUIDrawTab:(id)a0 withState:(unsigned long long)a1 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
- (char)_coreUIDrawTab:(id)a0 withState:(unsigned long long)a1 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 maskOnly:(char)a3;
- (struct __CFDictionary { } *)_createCoreUIBezelOptionsFlipped:(char)a0;
...
- (long long)_findPreviousNextTab:(long long)a0 loop:(char)a1 invertForR2L:(char)a2 startingAtTabItem:(id)a3;
...
- (char)_hasKeyboardFocusInTabItem:(id)a0;
...
- (char)_isViewValidOriginalNextKeyView:(id)a0;
...
- (void)_previousNextTab:(long long)a0 loop:(char)a1;
...
- (char)_shouldSelectTabViewItem:(id)a0;
- (char)_shouldUseSeparateLayoutEngineForItem:(id)a0;
...
- (double)_tabHeight;
- (char)_tabIndexIsLeftOrTop:(unsigned long long)a0;
- (char)_tabIndexIsRightOrBottom:(unsigned long long)a0;
...
- (double)_totalTabsLength:(char)a0 overlap:(double)a1;
