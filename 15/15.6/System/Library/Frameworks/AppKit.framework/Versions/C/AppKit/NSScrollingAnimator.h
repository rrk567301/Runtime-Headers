...
@interface NSScrollingAnimator : NSObject {
    ...
    char _cursorWasOriginallyInContent;
    char _hasNotifiedOfSlowVelocity;
}

@property (weak) id<NSScrollingAnimatorDelegate> delegate;
@property long long axisFilterMode;
@property char allowsHorizontalStretching;
@property char allowsVerticalStretching;
...
- (void)_delegateVelocityHasSlowed:(char)a0;
