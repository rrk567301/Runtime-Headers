...
@property (readonly, nonatomic, getter=isTintedMonochrome) char tintedMonochrome;
...
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 geometry:(struct _NSSymbolImageRepGeometry { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; double x2; char x3; })a1 vectorGlyph:(id)a2 colors:(id)a3 renderingStyle:(long long)a4 namedColorOverrides:(id)a5 debugBackgroundColor:(id)a6;
- (char)isTemplate;
- (id)vectorGlyph;
