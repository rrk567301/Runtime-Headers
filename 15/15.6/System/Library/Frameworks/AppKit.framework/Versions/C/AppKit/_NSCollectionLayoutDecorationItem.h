...
- (id)initWithSize:(id)a0 elementKind:(id)a1 containerAnchor:(id)a2 zIndex:(long long)a3 contentInsets:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a4 edgeSpacing:(id)a5 name:(id)a6 registrationViewClass:(Class)a7 isBackgroundDecoration:(char)a8;
