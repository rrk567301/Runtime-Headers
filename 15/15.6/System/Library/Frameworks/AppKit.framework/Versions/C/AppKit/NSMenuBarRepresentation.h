...
@interface NSMenuBarRepresentation : NSResponder <NSMenuRepresentable> {
    ...
    char _isMagicAppleMenuPositionedFirst;
    char _hasPendingLayoutChanges;
    char _hasMenusAfterNotch;
...
- (void)addControlledBackingView:(id)a0 followingSystemAppearance:(char)a1;
- (id)backingViews;
- (void)beginUpdates;
- (void)endSearchQuery;
- (void)endUpdates;
...
- (void)setHidden:(char)a0 forMenuItemAtIndex:(long long)a1;
- (void)startSearchQueryWithString:(id)a0 behavior:(long long)a1;
- (id)subviewAtMenuIndex:(long long)a0;
- (id)subviewAtMenuIndex:(long long)a0 creatingIfNeeded:(char)a1;
- (void)updateFont;
