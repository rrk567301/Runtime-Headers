...
@property (setter=_setIgnoresRequestsToSetCurrentProgress:) char _ignoresRequestsToSetCurrentProgress;
...
+ (void)waitForAnimationToCompleteOnWindows:(id)a0 forFullScreen:(char)a1;
