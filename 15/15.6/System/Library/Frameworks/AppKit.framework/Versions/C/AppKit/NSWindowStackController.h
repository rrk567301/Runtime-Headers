...
+ (char)_tabBarIsVisibleForIdentifier:(id)a0;
+ (char)canJoinExistingStackForWindow:(id)a0;
+ (void)didFinishRestoring;
+ (void)disableTabBar;
+ (void)enableTabBar;
+ (id)findStackControllerForIdentifier:(id)a0 stateIdentifier:(id)a1;
+ (char)mergeAllWindowsWithWindow:(id)a0;
+ (void)moveWindow:(id)a0 toModalStackController:(id)a1;
+ (void)setTabPlusButtonWasClicked:(char)a0;
+ (void)setupStackControllerForWindow:(id)a0 attemptToJoinExistingStack:(char)a1 makeIfNeeded:(char)a2;
...
- (char)_insertDraggedItemAtIndex:(unsigned long long)a0 fromController:(id)a1 sourceIndex:(unsigned long long)a2;
- (void)_makeTabBarForWindow:(id)a0 visible:(char)a1;
...
- (void)_openTabPickerAnimated:(char)a0;
- (id)_overlayWindow;
- (char)_overlayWindowIsVisible;
- (char)_regularTabMergeOfWindowsFromTargetWindow:(id)a0;
...
- (void)_setTabBarIsVisible:(char)a0 force:(char)a1;
- (char)_shouldAnimateTabChanges;
...
- (void)_yankWindowFromIndex:(long long)a0 sendNotifications:(char)a1;
- (void)addWindow:(id)a0;
- (char)attemptToCloseEntireStack:(id)a0;
...
- (char)handleDeminimizingWindow:(id)a0;
- (char)handleMinimizingWindow:(id)a0;
...
- (char)tabBar:(id)a0 acceptDrop:(id)a1 index:(unsigned long long)a2;
- (char)tabBar:(id)a0 acceptTabDrop:(id)a1 index:(unsigned long long)a2;
- (char)tabBar:(id)a0 canCloseTabBarViewItem:(id)a1;
...
- (void)tabBar:(id)a0 didMoveTabBarViewItem:(id)a1 fromIndex:(unsigned long long)a2 toIndex:(unsigned long long)a3 isChangingPinnedness:(char)a4;
- (char)tabBar:(id)a0 droppedWindowTabShouldMoveToSpace:(long long)a1;
...
- (char)tabPicker:(id)a0 highlightStateForTabItem:(id)a1;
