...
- (void)_editor:(id)a0 didChangeEditingState:(char)a1 bindingAdaptor:(id)a2;
- (char)_handleValidationError:(id)a0 description:(id)a1 inEditor:(id)a2 errorUserInterfaceHandled:(char *)a3 bindingAdaptor:(id)a4;
- (void)_objectDidTriggerAction:(id)a0 bindingAdaptor:(id)a1;
- (char)_validateAndCommitValueInEditor:(id)a0 editingIsEnding:(char)a1 errorUserInterfaceHandled:(char *)a2 bindingAdaptor:(id)a3;
...
- (char)browser:(id)a0 selectRow:(long long)a1 inColumn:(long long)a2;
...
- (void)drawer:(id)a0 didChangeToState:(char)a1;
- (id)editableBinder;
...
- (char)setEnabledStateForMenuItem:(id)a0 printDebuggingExplanation:(char)a1;
- (char)setEnabledStateForToolbarItem:(id)a0;
