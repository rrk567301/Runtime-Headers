...
- (char)_eventInTitlebar:(id)a0;
- (struct CGPoint { double x0; double x1; })_fileButtonOrigin;
- (void)_fillWindowWithDoubleClick:(id)a0;
- (char)_handlePossibleDoubleClickForEvent:(id)a0;
- (char)_handlePossibleDoubleClickForEvent:(id)a0 onlyZoomInDragRegion:(char)a1;
...
- (char)attemptResizeWithEvent:(id)a0;
