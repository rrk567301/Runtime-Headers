...
+ (id)_relevantFileAttributesForURL:(id)a0 cached:(char)a1;
+ (void)_tagSetterFinished:(id)a0;
+ (void)_waitForURL:(id)a0 useSecurityScopedURL:(char)a1 withNameFieldString:(id)a2 thenSetTagNames:(id)a3;
...
- (id)_initWithURL:(id)a0 useSecurityScopedURL:(char)a1 tagNames:(id)a2;
