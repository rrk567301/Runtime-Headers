...
+ (void)_getSharingServiceNamed:(id)a0 allowInactive:(char)a1 completion:(id /* block */)a2;
+ (void)_loadShareKit;
+ (id)_sharingServiceNamed:(id)a0 allowInactive:(char)a1;
+ (id)_urlFromItem:(id)a0;
+ (char)_urlIsFolder:(id)a0;
+ (char)_urlIsShared:(id)a0;
...
- (void)_setIsAddPeopleService:(char)a0;
