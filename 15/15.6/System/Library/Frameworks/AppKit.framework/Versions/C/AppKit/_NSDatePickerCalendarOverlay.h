...
- (void).cxx_destruct;
- (void)close;
- (void)_arrangePickersForRTL:(char)a0 presentingUpward:(char)a1;
...
- (char)_eventLocationIsContainedInMask:(id)a0;
- (id)_maskPathForRTL:(char)a0 presentingUpward:(char)a1;
- (void)_positionOverlayPanelOverSourceDatePicker;
- (void)_positionOverlayWithSourceSubfieldsFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isRTL:(char)a1;
...
- (id)_windowMaskPresentingUpward:(char)a0;
- (void)applyWindowMaskImagePresentingUpward:(char)a0;
- (void)show;
