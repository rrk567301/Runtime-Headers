...
@property (setter=setButtonHighlighted:) char isButtonHighlighted;
...
+ (void)_statusItems:(id)a0 setHidden:(char)a1;
...
- (void)_setAppearsActive:(char)a0;
...
- (void)_setNavigationHighlight:(char)a0;
...
- (void)_startStatusItemDrag:(char)a0;
...
- (void)_userRemovedStatusItemOnCreation:(char)a0;
...
- (SEL)doubleAction;
- (void)drawStatusBarBackgroundInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withHighlight:(char)a1;
- (char)highlightMode;
