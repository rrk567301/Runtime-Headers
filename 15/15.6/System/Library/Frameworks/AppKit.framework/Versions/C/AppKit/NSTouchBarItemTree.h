...
- (char)customization_nodeCanBeRemoved:(id)a0;
- (id)_spliceTreeFromRootNode:(id)a0 centerNode:(id)a1 foundCenter:(char *)a2;
- (char)customization_itemWithIdentifier:(id)a0 canBeInsertedAfterNode:(id)a1;
- (char)customization_node:(id)a0 canBeMovedAfterNode:(id)a1;
- (char)customization_nodeCanBeReordered:(id)a0;
...
- (char)persistBar:(id)a0 toDomain:(id)a1;
- (char)persistBarNode:(id)a0 toDomain:(id)a1;
