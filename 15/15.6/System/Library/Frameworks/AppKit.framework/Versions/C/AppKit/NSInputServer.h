...
- (char)mouseDownOnCharacterIndex:(unsigned long long)a0 atCoordinate:(struct CGPoint { double x0; double x1; })a1 withModifier:(unsigned long long)a2 client:(id)a3;
- (char)mouseDraggedOnCharacterIndex:(unsigned long long)a0 atCoordinate:(struct CGPoint { double x0; double x1; })a1 withModifier:(unsigned long long)a2 client:(id)a3;
...
- (void)setActivated:(char)a0 sender:(id)a1;
