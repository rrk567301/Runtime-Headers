...
- (void)setDisplaysTokenWhileEditing:(char)a0;
...
- (char)tokenFieldCell:(id)a0 characterAtIndex:(unsigned long long)a1 shouldTerminateString:(id)a2;
...
- (char)tokenFieldCell:(id)a0 hasMenuForRepresentedObject:(id)a1;
...
- (char)tokenFieldCell:(id)a0 writeRepresentedObjects:(id)a1 toPasteboard:(id)a2;
