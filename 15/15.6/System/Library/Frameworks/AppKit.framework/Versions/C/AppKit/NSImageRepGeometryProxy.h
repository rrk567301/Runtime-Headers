...
+ (id)proxyWithRep:(id)a0 alignmentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 capInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2 resizingMode:(long long)a3 template:(char)a4;
