...
+ (id)printerWithName:(id)a0 domain:(id)a1 includeUnavailable:(char)a2;
...
- (char)acceptsBinary;
- (char)booleanForKey:(id)a0 inTable:(id)a1;
...
- (char)isFontAvailable:(id)a0;
- (char)isKey:(id)a0 inTable:(id)a1;
