...
+ (char)_performKeyEquivalent:(id)a0;

- (void)dealloc;
- (id)init;
- (void)enableLayoutChangeNotifications;
- (void)_setRegisteredForNotifications:(char)a0;
...
- (long long)backgroundStyleForHighlight:(char)a0;
- (void)drawBackgroundInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 inView:(id)a1 highlight:(char)a2;
