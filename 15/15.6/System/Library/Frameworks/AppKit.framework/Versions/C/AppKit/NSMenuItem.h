...
@property (class) char usesUserKeyEquivalents;
...
@property (readonly, getter=isSeparatorItem) char separatorItem;
@property (readonly, getter=isSectionHeader) char sectionHeader;
@property (copy) NSString *keyEquivalent;
@property unsigned long long keyEquivalentModifierMask;
@property (readonly, copy) NSString *userKeyEquivalent;
@property char allowsKeyEquivalentWhenHidden;
@property char allowsAutomaticKeyEquivalentLocalization;
@property char allowsAutomaticKeyEquivalentMirroring;
...
@property (readonly, getter=isHighlighted) char highlighted;
...
+ (id)_itemWithTitle:(id)a0 target:(id)a1 action:(SEL)a2 keyEquivalent:(id)a3 state:(long long)a4 enabled:(char)a5 representedObject:(id)a6;
+ (char)_languageIDHasDotlessI:(id)a0;
...
- (void)_setShowsBlockedByScreenTime:(char)a0;
- (id)initWithTitle:(id)a0 action:(SEL)a1 keyEquivalent:(id)a2;
- (id)uniqueIdentifier;
- (char)_isHidden;
- (char)_canShareKeyEquivalentWithItem:(id)a0;
...
- (struct CGSize { double x0; double x1; })_cachedAttributedTitleSizeForMeasuring:(char)a0 hasAttachment:(char *)a1;
- (struct CGSize { double x0; double x1; })_cachedTitleSizeForMeasuring:(char)a0;
- (char)_canBeHighlighted;
- (char)_canUseKeyEquivalent;
- (void)_cancelPredeepAnimation;
- (long long)_changedFlags;
- (void)_completeDeepAnimation;
- (struct CGSize { double x0; double x1; })_computeBoundingRectSizeForTitle:(id)a0 hasAttachment:(char *)a1;
...
- (char)_isAppleMenuItem;
- (char)_isEnabled;
- (char)_isGroupHeader;
- (char)_isHelpMenu;
- (char)_isHelpMenuAppKitOnly;
- (char)_isInlineMenuParentItem;
- (char)_isPaletteMenuItem;
- (char)_isSelectorAllowedForLimitedAppMode:(SEL)a0;
- (char)_isSystemMenuItem;
...
- (void)_recacheUserKeyEquivalentOnlyIfStale:(char)a0;
...
- (void)_setIgnoredForAccessibility:(char)a0;
- (void)_setIgnoresHotKey:(char)a0;
- (void)_setImage:(id)a0 resettingSize:(char)a1;
- (void)_setImageSize:(struct CGSize { double x0; double x1; })a0;
- (void)_setIsAlternateDespiteNonmatchingModifiers:(char)a0;
- (void)_setIsGroupHeader:(char)a0;
- (void)_setIsSystemMenuItem:(char)a0;
...
- (char)_setKeyboardAwareEquivalent:(id)a0 modifiers:(unsigned long long)a1;
- (void)_setKeyboardAwareEquivalentModifierMask:(unsigned long long)a0;
- (void)_setMatchImageToControlSize:(char)a0;
- (void)_setMenuItemBelongsToContextualMenu:(char)a0;
- (void)_setNewItemsCount:(unsigned long long)a0;
- (void)_setNextItemIsAlternate:(char)a0;
- (void)_setRequiresModifiersToBeVisible:(char)a0;
- (void)_setRespectsKeyEquivalentForRepeatKeys:(char)a0;
- (void)_setRespectsKeyEquivalentWhileHidden:(char)a0;
- (void)_setScaledSizeForImage;
- (void)_setSomeKeyEquivalent:(id)a0 savedKE:(id)a1 setKE:(id /* block */)a2;
- (void)_setSomeModifierMask:(unsigned long long)a0 location:(char *)a1 localizingIfChanged:(char)a2;
- (void)_setSubmenu:(id)a0;
- (void)_setSubmenuParentItemUnchoosable:(char)a0;
- (void)_setViewHandlesEvents:(char)a0;
- (void)_setViewIsDrawingOnly:(char)a0;
...
- (char)_shouldForceShiftModifierWithKeyEquivalent:(id)a0;
...
- (char)_updateKEDisplayOverride:(id)a0;
...
- (char)menuItemOrSubmenuNeedsShortcutLocalization;
- (id)mnemonic;
