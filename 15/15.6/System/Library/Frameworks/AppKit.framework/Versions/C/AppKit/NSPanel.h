...
@property char becomesKeyOnlyIfNeeded;
...
- (id)_initContent:(const struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 styleMask:(unsigned long long)a1 backing:(unsigned long long)a2 defer:(char)a3 counterpart:(id)a4;
