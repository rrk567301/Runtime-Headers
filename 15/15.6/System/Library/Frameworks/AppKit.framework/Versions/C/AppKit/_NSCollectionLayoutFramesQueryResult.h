...
@property (readonly, nonatomic) char isDecoration;
@property (readonly, nonatomic) char isAuxiliary;
@property (readonly, nonatomic) char isItem;
@property (readonly, nonatomic) char isAuxiliaryKindGlobal;
@property (readonly, nonatomic) char isAuxiliaryKindSection;
@property (readonly, nonatomic) char isAuxiliaryKindGroup;
@property (readonly, nonatomic) char isAuxiliaryKindItem;
