...
- (id)allIndexPaths;
- (char)containsIndexPath:(id)a0;
- (char)containsItemIndex:(unsigned long long)a0 inSection:(unsigned long long)a1;
- (char)containsItemIndexes:(id)a0 inSection:(unsigned long long)a1;
