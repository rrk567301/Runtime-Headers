...
@interface _NSSimpleImageView : NSView {
    ...
    char _shouldUseRBSymbolLayer;
    RBSymbolLayer *_symbolLayer;
    char _hasRegisteredForActivationNotifications;
...
- (void)_configurePreferredDynamicRange:(long long)a0 animated:(char)a1;
- (void)_configureSymbolLayer;
- (void)_ensureRBLayer;
- (char)_hasHDRContent;
- (double)_imageDynamicRangeHighEDRMaxHeadroom;
- (char)_isSymbolAndRBLayerImageView;
