...
- (void)dealloc;
- (void)_beginDragSession:(id)a0 withEvent:(id)a1 asynchronous:(char)a2;
- (void)_cancelAllFilePromiseDragsForPasteboard:(id)a0;
- (void)_dragSession:(id)a0 completed:(int)a1;
- (void)_dragUntilMouseUp:(id)a0 initialEvent:(id)a1 async:(char)a2;
...
- (void)_tryCatchDragUntilMouseUp:(id)a0 initialEvent:(id)a1 async:(char)a2;
