...
@property char floatsSelectionViews;
...
@property char showsArrowButtons;
@property char showsAdditionalContentIndicators;
...
- (char)_accessibilityChildIsVisible:(id)a0;
...
- (void)_interactiveHighlightItemAtIndex:(long long)a0 animated:(char)a1;
- (void)_interactiveSelectItemAtIndex:(long long)a0 animated:(char)a1;
- (long long)_numberOfItemsFromDataSource;
- (id)_preferredAppearance;
- (void)_scrollView:(id)a0 adjustScrollOffset:(inout struct CGPoint { double x0; double x1; } *)a1 withVelocity:(struct CGPoint { double x0; double x1; })a2 toItemWithAlignment:(long long)a3 pinningTarget:(char)a4;
- (void)_setIgnoresTouches:(char)a0;
...
- (void)_updateAutoscrollWithPointInScrollView:(struct CGPoint { double x0; double x1; })a0 trackingStatus:(char)a1;
...
- (char)allowPanningInScrollView:(id)a0;
...
- (struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })proxyState;
...
- (void)scrollItemAtIndex:(long long)a0 toAlignment:(long long)a1 animated:(char)a2;
- (id)scrollView;
...
- (void)setProxyState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a0;
- (void)setSelectedIndex:(long long)a0 animated:(char)a1;
