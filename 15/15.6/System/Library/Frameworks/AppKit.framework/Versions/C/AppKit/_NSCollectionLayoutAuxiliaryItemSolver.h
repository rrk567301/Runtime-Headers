...
@property (nonatomic) char hasEstimatedSizes;
...
@property (readonly, nonatomic) char contentSizeDiffersFromHostContentSize;
@property (readonly, nonatomic) struct CGPoint { double x; double y; } hostContentOffset;

- (void).cxx_destruct;
- (void)resolve;
- (struct CGSize { double x0; double x1; })_computeContentSizeForEmptyHostContentSizeForContainer:(id)a0 hostContentSize:(struct CGSize { double x0; double x1; })a1 layoutAxis:(int)a2 supplementaryFrames:(id)a3 preferredSizes:(id)a4 layoutRTL:(char)a5 supplementaryKind:(long long)a6;
- (id)_effectiveBoundarySupplementrayItem:(id)a0 forLayoutAxis:(int)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_frameForSupplementaryItem:(id)a0 container:(id)a1 contentSize:(struct CGSize { double x0; double x1; })a2 frameOffset:(struct CGPoint { double x0; double x1; })a3 applyPinning:(char)a4 visibleBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 preferredSizes:(id)a6 preferredIndex:(long long)a7 layoutRTL:(char)a8;
...
- (id)_rearrangeSupplementaryItems:(id)a0 byUpdatingPinning:(char)a1 forVisibleBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 frameOffset:(struct CGPoint { double x0; double x1; })a3;
- (id)_rearrangedFramesForFrames:(id)a0 container:(id)a1 contentSize:(struct CGSize { double x0; double x1; })a2 applyPinning:(char)a3 frameOffset:(struct CGPoint { double x0; double x1; })a4 visibleBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 preferredSizes:(id)a6 layoutRTL:(char)a7 supplementaryKind:(long long)a8;
...
- (void)_solveForPinning:(char)a0 visibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
