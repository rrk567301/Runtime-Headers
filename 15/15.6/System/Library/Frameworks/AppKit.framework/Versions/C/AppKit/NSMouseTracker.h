...
- (void)_releaseEvents;
- (char)continueTrackingWithEvent:(id)a0;
...
- (char)startTrackingWithEvent:(id)a0 inView:(id)a1 withDelegate:(id)a2;
- (char)stopTrackingWithEvent:(id)a0;
- (char)trackWithEvent:(id)a0 inView:(id)a1 withDelegate:(id)a2;
