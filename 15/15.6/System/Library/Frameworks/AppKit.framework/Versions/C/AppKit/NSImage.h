...
@property (readonly, getter=_isSymbolImage) char _symbolImage;
@property struct CGSize { double x0; double x1; } size;
@property (copy) NSColor *backgroundColor;
@property char usesEPSOnResolutionMismatch;
@property char prefersColorMatch;
@property char matchesOnMultipleResolution;
@property char matchesOnlyOnBestFittingAxis;
...
+ (id)_allNames;
+ (char)_canInitWithPasteboard:(id)a0 allowMultipleFiles:(char)a1;
...
+ (id)_imageWithSymbolName:(id)a0 inCatalog:(id)a1 variableValue:(double)a2 accessibilityDescription:(id)a3 createdWithCompatibilityImageName:(char)a4;
+ (id)_imageWithSystemSymbolName:(id)a0;
+ (id)_imageWithSystemSymbolName:(id)a0 variableValue:(double)a1 accessibilityDescription:(id)a2 allowPrivateLookup:(char)a3;
...
+ (id)imageWithSize:(struct CGSize { double x0; double x1; })a0 drawingIsFlipped:(char)a1 drawHandler:(id /* block */)a2;
+ (id)imageWithSize:(struct CGSize { double x0; double x1; })a0 flipped:(char)a1 drawingHandler:(id /* block */)a2;
...
- (void)recache;
- (void)setCacheDepthMatchesImageDepth:(char)a0;
...
- (char)_composite:(long long)a0 delta:(double)a1 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 toPoint:(struct CGPoint { double x0; double x1; })a3;
- (void)_compositeFlipped:(char)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 operation:(unsigned long long)a3 fraction:(double)a4;
- (void)_compositeFlipped:(char)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 fromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 operation:(unsigned long long)a3 fraction:(double)a4;
...
- (void)_drawInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withState:(unsigned long long)a1 backgroundStyle:(int)a2 tintColor:(id)a3 operation:(unsigned long long)a4 fraction:(double)a5 flip:(char)a6 hints:(id)a7;
- (void)_drawMappingAlignmentRectToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withState:(unsigned long long)a1 backgroundStyle:(int)a2 operation:(unsigned long long)a3 fraction:(double)a4 flip:(char)a5 hints:(id)a6;
...
- (char)_drawRepresentation:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 withScaling:(char)a2;
...
- (id)_initWithIconRef:(struct OpaqueIconRef { } *)a0 includeThumbnail:(char)a1;
- (char)_legacyAddRepresentationsForIconNamed:(id)a0 fromIconSectionInAppBinary:(id)a1;
- (void)_lockFocusOnRepresentation:(id)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 context:(id)a2 hints:(id)a3 flipped:(char)a4;
- (id)_providedAccessibilityDescription;
- (id)_repProviderForSymbolName:(id)a0 allowPrivateLookup:(char)a1;
...
- (void)_setAntialiased:(char)a0;
- (void)_setPrefersResolutionMatch:(char)a0;
- (void)_setRepProvider:(id)a0;
- (void)_setRepProviderWithISIcon:(id)a0 allowingPlaceholder:(char)a1;
...
- (void)_setRepProviderWithSymbolName:(id)a0 allowPrivateLookup:(char)a1;
...
- (char)_whenDrawn:(id)a0 fills:(const struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1;
...
- (char)drawRepresentation:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (char)hasAlpha;
- (char)hitTestPoint:(struct CGPoint { double x0; double x1; })a0 withImageDestinationRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 context:(id)a2 hints:(id)a3;
- (char)hitTestRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withImageDestinationRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 context:(id)a2 hints:(id)a3;
- (char)hitTestRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withImageDestinationRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 context:(id)a2 hints:(id)a3 flipped:(char)a4;
...
- (id)initWithISIcon:(id)a0 allowingPlaceholder:(char)a1;
...
- (void)lockFocus;
- (void)lockFocusFlipped:(char)a0;
- (void)lockFocusOnRepresentation:(id)a0;
- (void)lockFocusWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 context:(id)a1 hints:(id)a2 flipped:(char)a3;
- (id)pasteboardPropertyListForType:(id)a0;
- (double)recommendedLayerContentsScale:(double)a0;
- (void)removeRepresentation:(id)a0;
- (char)scalesWhenResized;
- (void)setCachedSeparately:(char)a0;
- (void)setDataRetained:(char)a0;
- (void)setFlipped:(char)a0;
- (void)setScalesWhenResized:(char)a0;
- (void)unlockFocus;
