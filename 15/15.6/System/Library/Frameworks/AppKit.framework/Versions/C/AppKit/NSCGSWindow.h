...
@property int level;
@property (readonly, getter=isOrderedIn) char orderedIn;
...
@property char prefersCurrentSpace;
...
@property char hasBackingStore;
@property (readonly) NSCGSWindowBackingStore *backingStore;
@property (readonly) char ownsWindow;
@property (readonly) char directlyOwnsWindow;
...
@property char usesActiveShadow;
@property char hasKeyAppearance;
@property char hasMainAppearance;
@property unsigned long long tags;
@property (copy) struct CGColor { } *chameleonOverrideColor;
@property char createsBackdropGroupNamespace;
@property char validateSecurityOfSuperlayers;
@property (copy) struct CGColorSpace { } *layerContextColorSpace;
@property unsigned int layerContextDepth;
@property char usesAutomaticContentsFormat;
@property (retain) CALayer *contentLayer;
@property char allowsFlattening;
...
+ (char)automaticallyNotifiesObserversOfContentContext;
...
+ (char)isAnyWindowOnAVisibleSpace:(id)a0;
...
- (void)disableActivationOrderingWithInitiallyOrderedIn:(char)a0;
- (void)disassociateFromSpacesIfOrderedOut;
- (void)enableActivationOrderingWithInitiallyOrderedIn:(char)a0;
- (id)encodedLayerTree;
- (id)initWithConnectionID:(unsigned int)a0 flags:(long long)a1;
- (id)initWithWindowID:(unsigned int)a0;
- (void)invalidateAlphaShape;
- (char)isExpectedToBeOnSpace:(unsigned long long)a0;
- (char)isStickyByBinding;
...
- (void)moveGroupTo:(struct CGPoint { double x0; double x1; })a0 delta:(struct CGSize { double x0; double x1; })a1 isChildOfGroupMovement:(char)a2;
- (void)moveTo:(struct CGPoint { double x0; double x1; })a0 delta:(struct CGSize { double x0; double x1; })a1;
- (void)moveTo:(struct CGPoint { double x0; double x1; })a0 delta:(struct CGSize { double x0; double x1; })a1 isChildOfGroupMovement:(char)a2;
