...
- (id)init;
- (void).cxx_destruct;
- (void)addDeletedAuxiliaryOfElementKind:(id)a0 atIndexPath:(id)a1 isSupplementary:(char)a2;
- (void)addInsertedAuxiliaryOfElementKind:(id)a0 atIndexPath:(id)a1 isSupplementary:(char)a2;
