...
@property char supportsPressAndHoldVariants;
...
- (void)_didFinishInteractingWithScrubber:(id)a0 cancelled:(char)a1;
- (unsigned long long)_effectiveColorCount;
- (long long)_effectiveSelectedColorIndex;
- (void)_setCurrentColor:(id)a0 updateScrubber:(char)a1;
...
- (void)popUpDidEndColorSelection:(id)a0 cancelled:(char)a1;
