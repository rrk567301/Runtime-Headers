...
@property char showsCloseButtonForOverlay;
@property char preventUserDismissalForOverlay;
@property char showsControlStripForOverlay;
@property (copy) id /* block */ closeButtonHandler;
@property (readonly) NSTouchBarView *touchBarView;
@property (readonly, getter=isTrackingTouches) char trackingTouches;
