...
- (void)_addTargetAnimation:(id)a0 start:(char)a1 atProgress:(float)a2;
- (void)_advanceTimeWithDisplayLink:(id)a0;
- (void)_callHandlerWithProgress:(float)a0 didStop:(char)a1 didFinish:(char)a2;
- (void)_clearAllTargetAnimations;
- (void)_createDisplayLink;
- (double)_instantProgress;
- (void)_removeTargetAnimation:(id)a0 start:(char)a1;
- (void)_runBlocking;
- (void)_setSendProgressAllTheTime:(char)a0;
