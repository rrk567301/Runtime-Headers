...
@property char indentationMarkerFollowsCell;
@property char autoresizesOutlineColumn;
@property char autosaveExpandedItems;
@property long long userInterfaceLayoutDirection;
@property char stronglyReferencesItems;
...
- (void)_setOutlineButtonVisible:(char)a0 onRow:(long long)a1;
- (char)_shouldDoExpandAnimationForRow:(long long)a0;
...
- (void)_adjustSelectionForItemEntry:(id)a0 numberOfRows:(long long)a1 adjustFieldEditorIfNecessary:(char)a2;
...
- (void)_batchCollapseItemsWithItemEntries:(struct __CFArray { } *)a0 collapseChildren:(char)a1;
- (void)_batchCollapseItemsWithItemEntries:(struct __CFArray { } *)a0 collapseChildren:(char)a1 clearExpandState:(char)a2;
- (void)_batchExpandItemsWithItemEntries:(struct __CFArray { } *)a0 expandChildren:(char)a1;
...
- (char)_clickedInExpansionTriangle:(struct CGPoint { double x0; double x1; })a0;
- (void)_collapseAllAutoExpandedItems;
- (unsigned long long)_collapseAnimation;
- (void)_collapseAutoExpandedItems:(id)a0;
- (void)_collapseItem:(id)a0 collapseChildren:(char)a1 clearExpandState:(char)a2;
- (void)_collapseItemEntry:(id)a0 collapseChildren:(char)a1 clearExpandState:(char)a2;
- (void)_collapseRootEntry:(char)a0 clearExpandState:(char)a1;
...
- (char)_dataSourceIsItemExpandable:(id)a0;
...
- (void)_doExpandAnimation:(char)a0 forRow:(long long)a1;
- (void)_doUserExpandOrCollapseOfItem:(id)a0 isExpand:(char)a1 optionKeyWasDown:(char)a2;
...
- (void)_expandItemEntry:(id)a0 expandChildren:(char)a1;
- (void)_expandItemEntry:(id)a0 expandChildren:(char)a1 startLevel:(long long)a2;
- (void)_expandItemEntryChildren:(id)a0 atStartLevel:(long long)a1 expandChildren:(char)a2 andInvalidate:(char)a3;
...
- (void)_handleLeftArrowKeyWithChildren:(char)a0;
- (void)_handleRightArrowKeyWithChildren:(char)a0;
...
- (double)_indentationForRow:(long long)a0 withLevel:(long long)a1 isSourceListGroupRow:(char)a2;
...
- (char)_isDisclosureButtonVisibleOnRow:(long long)a0;
- (char)_isDropFeedbackRow:(long long)a0;
- (char)_isEditingRowAChildOfRowAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)_isExpanding;
- (char)_isItemLoadedAndExpanded:(id)a0;
- (char)_isOutlineView;
...
- (double)_legacyIndentationForLevel:(long long)a0 isSourceListGroupRow:(char)a1;
- (void)_loadItemsIfNeeded;
- (double)_locOfOutlineColumnAtMin:(char)a0;
...
- (struct __CFArray { } *)_newSelectedRowEntriesArrayIncludingExpandable:(char)a0 includingUnexpandable:(char)a1 withCurrentExpandState:(char)a2;
...
- (char)_nonStaticDataSourceIsItemExpandable:(id)a0;
...
- (void)_recursiveCollapseItemEntry:(id)a0 collapseChildren:(char)a1 clearExpandState:(char)a2;
- (void)_recursivelyDeleteRowEntryAndAllChildren:(id)a0;
- (void)_recursivelyReloadItem:(id)a0 reloadChildren:(char)a1 withInsertAnimation:(unsigned long long)a2 removeAnimation:(unsigned long long)a3;
...
- (char)_removeDisclosureButtonForRowView:(id)a0 withIdentifier:(id)a1;
...
- (char)_rowEntryExistsForItem:(id)a0;
...
- (void)_setAnimateExpandAndCollapse:(char)a0;
- (void)_setDisclosureButtonVisible:(char)a0 onRow:(long long)a1;
...
- (char)_shouldAutoExpandItem:(id)a0;
- (char)_shouldAutoExpandNoExpandableItem:(id)a0;
- (char)_shouldCallWillDisplayOutlineCell;
- (char)_shouldCollapseItem:(id)a0;
- (char)_shouldContinueExpandAtLevel:(long long)a0 beganAtLevel:(long long)a1;
- (char)_shouldDoDragUpdateOfViewBasedRowData;
- (char)_shouldEncodeUILayoutDirection;
- (char)_shouldExpandItem:(id)a0;
- (char)_shouldHighlightParentRows;
- (char)_shouldIndentBackgroundRect;
- (char)_shouldReuseViews;
- (char)_shouldShowOutlineCellForGroupRow:(long long)a0;
...
- (void)_staticSetItem:(id)a0 isExpanded:(char)a1;
...
- (char)_wantsGroupRowHoverCallbacksForRow:(long long)a0;
...
- (char)mouseTracker:(id)a0 didStopTrackingWithEvent:(id)a1;
- (char)mouseTracker:(id)a0 shouldContinueTrackingWithEvent:(id)a1;
- (char)mouseTracker:(id)a0 shouldStartTrackingWithEvent:(id)a1;
...
- (void)reloadItem:(id)a0 reloadChildren:(char)a1 withInsertAnimation:(unsigned long long)a2 removeAnimation:(unsigned long long)a3;
...
- (void)setStronglyReferencesItems:(char)a0;
- (void)setUserInterfaceLayoutDirection:(long long)a0;
- (void)setUsesStaticContents:(char)a0;
- (char)shouldCollapseAutoExpandedItemsForDeposited:(char)a0;
- (char)shouldShowOutlineCellInlineForRow:(long long)a0;
