...
- (void)_invalidateCursorRectsIfNoTrackingAreas;
...
- (long long)addTrackingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 owner:(id)a1 userData:(void *)a2 assumeInside:(char)a3 useTrackingNum:(long long)a4;
- (void)addTrackingRects:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 owner:(id)a1 userDataList:(void **)a2 assumeInsideList:(char *)a3 trackingNums:(long long *)a4 count:(long long)a5;
- (char)areCursorRectsValid;
...
- (id)pressureConfigurationTrackingAreaCreateIfNeeded:(char)a0;
...
- (char)shouldUseTrackingAreasForToolTips;
...
- (void)updateTrackingAreasWithInvalidCursorRects:(char)a0;
