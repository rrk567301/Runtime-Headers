...
- (char)_canUnlearnSpellingForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inAnnotatedString:(id)a1;
...
- (void)_checkSpellingForPanel:(char)a0;
- (void)_checkSpellingWithOriginalStartLocation:(unsigned long long)a0 currentStartLocation:(unsigned long long)a1 firstTime:(char)a2 alreadyWrapped:(char)a3 forPanel:(char)a4;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_doubleClickAtIndex:(unsigned long long)a0 limitedRangeOK:(char)a1 inAnnotatedString:(id)a2;
...
- (void)_performScheduledTextChecking:(char)a0;
...
- (void)_removeGrammarAttributeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includeAccessibility:(char)a1 inAnnotatedString:(id)a2;
...
- (void)_removeSpellingAttributeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includeAccessibility:(char)a1 inAnnotatedString:(id)a2;
...
- (id)_spellingGuessesForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inAnnotatedString:(id)a1 canCorrect:(char *)a2;
...
- (void)annotatedSubstringForProposedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 wrap:(char)a1 completionHandler:(id /* block */)a2 failureHandler:(id /* block */)a3;
...
- (char)clientRecentlyReplacedCompletionPrefix;
...
- (char)hasPrereplacedStringAttributeAtIndex:(unsigned long long)a0;
- (char)inlinePredictionActive;
...
- (char)isAutomaticInlinePredictionEnabled;
- (char)isAutomaticLanguageIdentificationEnabled;
- (char)isAutomaticMathExpressionCompletionEnabled;
...
- (id)menuAtIndex:(unsigned long long)a0 clickedOnSelection:(char)a1 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2;
...
- (void)performFinalGrammarCheckingWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 allowAutocorrection:(char)a1 conditionalOnTerminationEstimation:(char)a2;
- (void)performPendingTextChecking;
- (void)recordResponse:(long long)a0 toCorrection:(id)a1 forWord:(id)a2;
- (void)recordResponse:(long long)a0 toCorrection:(id)a1 forWord:(id)a2 considerPostEditing:(char)a3;
...
- (void)setSuppressTextChecking:(char)a0;
...
- (void)setUsesStringAnnotations:(char)a0;
