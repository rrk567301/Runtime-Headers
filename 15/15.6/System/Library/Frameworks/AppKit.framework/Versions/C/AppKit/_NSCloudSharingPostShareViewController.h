...
+ (void)requestViewControllerForPopover:(char)a0 withItem:(id)a1 options:(unsigned long long)a2 sharingServiceParameters:(id)a3 connectionHandler:(id /* block */)a4;
