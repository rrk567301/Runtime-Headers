...
@property (nonatomic) char shouldUseUnacceleratedDelta;
@property (nonatomic) char shouldCoalesceDeltas;
@property (nonatomic) char shouldIgnoreConsumption;
@property (nonatomic) char wantsGestureEvents;
@property (nonatomic) char shouldStopMonitoringOnMomentumEnd;
@property (readonly, nonatomic) char deltaIsAccelerated;
