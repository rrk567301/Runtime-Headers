...
- (char)_cacheViewControllerForRepresentedObjectIfNeeded:(id)a0;
- (id)_cgSnapshotOfView:(id)a0;
- (double)_destinationAlphaOfDestinationTransitionViewForDirection:(long long)a0;
- (double)_destinationAlphaOfFilterTansitionViewForDirection:(long long)a0 destinationValid:(char)a1;
- (double)_destinationAlphaOfSourceTansitionViewForDirection:(long long)a0 destinationValid:(char)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_destinationFrameOfSourceTansitionViewForDirection:(long long)a0 destinationValid:(char)a1;
...
- (void)_navigateToIndex:(long long)a0 animated:(char)a1;
...
- (void)setDontCacheViewControllers:(char)a0;
