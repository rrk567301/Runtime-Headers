...
@property (readonly, getter=isResting) char resting;
...
- (double)_force;
- (long long)_index;
- (id)_initWithIdentity:(id)a0 index:(long long)a1 phase:(unsigned long long)a2 contextId:(long long)a3 position:(struct CGPoint { double x0; double x1; })a4 previousPosition:(struct CGPoint { double x0; double x1; })a5 touchType:(long long)a6 timestamp:(double)a7 isResting:(char)a8 view:(id)a9 device:(id)a10 deviceSize:(struct CGSize { double x0; double x1; })a11 force:(double)a12;
- (id)_initWithIndex:(long long)a0 phase:(unsigned long long)a1 contextId:(long long)a2 position:(struct CGPoint { double x0; double x1; })a3 previousPosition:(struct CGPoint { double x0; double x1; })a4 touchType:(long long)a5 timestamp:(double)a6 isResting:(char)a7 view:(id)a8 device:(id)a9 deviceSize:(struct CGSize { double x0; double x1; })a10 force:(double)a11;
- (id)_initWithPreviousTouch:(id)a0 newPhase:(unsigned long long)a1 position:(struct CGPoint { double x0; double x1; })a2 timestamp:(double)a3 isResting:(char)a4 force:(double)a5;
