...
- (void).cxx_destruct;
- (void)layout;
- (void)drawingStateDidChangeWithAnimation:(char)a0 controlSizeChanged:(char)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })knobRectWithThumbOnRight:(char)a0;
- (void)layoutSubviews;
- (void)removeSubviews;
