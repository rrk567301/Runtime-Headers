...
- (char)_asynchronouslyAllowDelegateToAdjustMomentum:(id)a0 withInitialOrigin:(struct CGPoint { double x0; double x1; })a1 velocity:(struct CGPoint { double x0; double x1; })a2 synchronousTimeout:(unsigned long long)a3 gestureToken:(unsigned long long)a4;
- (char)_asynchronouslyAllowDelegateToModifyProposedPageAlignedOrigin:(double *)a0 onAxis:(long long)a1 withInitialOrigin:(double)a2 velocity:(double)a3 synchronousTimeout:(unsigned long long)a4 gestureToken:(unsigned long long)a5;
...
- (char)scrollView:(id)a0 panGestureRecognizer:(id)a1 shouldReceiveTouch:(id)a2;
