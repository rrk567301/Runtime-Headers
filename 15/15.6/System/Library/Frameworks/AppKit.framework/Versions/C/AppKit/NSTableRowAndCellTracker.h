...
- (void)dealloc;
- (id)init;
- (void)removeIndexRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 shiftsResults:(char)a1;
...
- (void)shiftIndex:(long long)a0 shiftAmount:(long long)a1 isDeleteForMove:(char)a2;
- (long long)specifierComponentForIndex:(long long)a0 registerIfNeeded:(char)a1;
