...
- (void).cxx_destruct;
- (id)snapshot;
- (void)_applySnapshot:(id)a0 animatingDifferences:(char)a1 completion:(id /* block */)a2;
- (char)_isDiffableDataSource;
- (void)applySnapshot:(id)a0 animatingDifferences:(char)a1;
- (void)applySnapshot:(id)a0 animatingDifferences:(char)a1 completion:(id /* block */)a2;
- (id)collectionView;
