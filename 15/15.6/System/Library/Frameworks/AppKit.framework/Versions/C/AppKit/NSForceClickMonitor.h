...
@property (class, readonly) char forceClickUserPreferencesEnabled;
...
+ (char)_forceClickPossibleFromEvent:(id)a0 respectUserPreferences:(char)a1;
...
- (void)cancel;
- (id)_initWithEvent:(id)a0 ignoreForceClickSystemPreferences:(char)a1;
