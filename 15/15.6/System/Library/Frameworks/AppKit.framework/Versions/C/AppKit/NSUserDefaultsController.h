...
@property char appliesImmediately;
...
- (void)_dealloc;
- (void)_executeSave:(id)a0 didCommitSuccessfully:(char)a1 actionSender:(id)a2;
...
- (void)_setSharedUserDefaultsControllerProxy:(char)a0;
