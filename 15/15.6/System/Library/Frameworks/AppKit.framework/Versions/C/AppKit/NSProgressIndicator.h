...
@property (readonly, nonatomic, getter=_isAnimating) char _animating;
@property (readonly, nonatomic, getter=_isEffectivelyHidden) char _effectivelyHidden;
...
- (void)_stopAnimationAndRedisplay:(char)a0;
