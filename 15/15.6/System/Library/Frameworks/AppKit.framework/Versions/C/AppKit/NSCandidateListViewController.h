...
@property char limitsNumberOfCandidates;

+ (id)sharedPanel:(char)a0;

- (void)dealloc;
- (id)init;
- (id)_compositeCandidateForCandidate:(id)a0 atIndex:(unsigned long long)a1 addQuotes:(char)a2 isCorrection:(char)a3 isEmoji:(char)a4;
...
- (void)setPropertiesOnRemoteViewController:(char)a0;
...
- (void)updateState;
- (void)updateStateAndTitles:(char)a0 allowDelay:(char)a1;
- (void)updateTimerFired:(id)a0;
- (void)updateTitles;
- (void)updateViewConstraints;
- (void)userSetCollapsed:(char)a0;
