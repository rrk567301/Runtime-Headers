...
- (void)_enumerateDraggingItemsForDrag:(unsigned long long)a0 pasteboard:(id)a1 class:(Class)a2 view:(id)a3 isSource:(char)a4 usingBlock:(id /* block */)a5;
- (void)_enumerateDraggingItemsForDrag:(unsigned long long)a0 pasteboard:(id)a1 withOptions:(unsigned long long)a2 view:(id)a3 classes:(id)a4 searchOptions:(id)a5 isSource:(char)a6 usingBlock:(id /* block */)a7;
...
- (void)dragImage:(id)a0 fromWindow:(id)a1 at:(struct CGPoint { double x0; double x1; })a2 offset:(struct CGSize { double x0; double x1; })a3 event:(id)a4 pasteboard:(id)a5 source:(id)a6 slideBack:(char)a7 asynchronous:(char)a8;
...
- (char)switchWindow:(id)a0 dragRegistrationToRemoteContext:(unsigned int)a1;
- (char)unregisterDragTypesForWindow:(id)a0;
