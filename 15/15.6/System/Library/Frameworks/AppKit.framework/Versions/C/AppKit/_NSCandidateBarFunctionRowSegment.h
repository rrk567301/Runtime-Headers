...
@property (getter=isPressed) char pressed;
@property (getter=isCorrection) char correction;
@property char roundLeft;
@property char roundRight;
@property char drawsRightToLeft;
