...
@property (class) char allowsTouchesDuringTrackingLoops;
@property (class, getter=isAutomaticCustomizeTouchBarMenuItemEnabled) char automaticCustomizeTouchBarMenuItemEnabled;

@property char suppressesMoreFocusedBars;
@property char suppressesLessFocusedBars;
...
- (char)_didItemsReallyChange:(id)a0;
