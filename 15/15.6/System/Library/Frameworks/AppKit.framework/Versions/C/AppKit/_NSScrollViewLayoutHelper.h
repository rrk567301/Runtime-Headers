...
@property (readonly) char hScrollerShown;
@property (readonly) char vScrollerShown;
@property (readonly) char cornerShown;
@property (readonly) char contentsExtendUnderInsets;
