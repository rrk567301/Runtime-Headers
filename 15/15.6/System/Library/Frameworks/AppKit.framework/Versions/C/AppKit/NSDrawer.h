...
- (void)_doAttachDrawerIgnoreHidden:(char)a0;
...
- (void)_doPositionDrawerAndSize:(struct CGSize { double x0; double x1; })a0 parentFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 stashSize:(char)a2;
...
- (void)_resizeWithDelta:(struct CGPoint { double x0; double x1; })a0 fromFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 beginOperation:(char)a2 endOperation:(char)a3;
- (void)_setLevel;
...
- (void)_slideWithDelta:(struct CGPoint { double x0; double x1; })a0 beginOperation:(char)a1 endOperation:(char)a2;
...
- (void)removeImmediately:(char)a0;
