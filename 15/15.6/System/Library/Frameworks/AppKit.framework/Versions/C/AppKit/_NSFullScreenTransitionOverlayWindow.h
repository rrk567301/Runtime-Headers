...
- (void)positionLayersForEnter:(char)a0 reduced:(char)a1;
...
- (void)startEnterFullScreenAnimationWithDuration:(double)a0 reduced:(char)a1 completionHandler:(id /* block */)a2;
- (void)startExitFullScreenAnimationWithDuration:(double)a0 reduced:(char)a1 completionHandler:(id /* block */)a2;
