...
@property (nonatomic, setter=_setInvalidateDataSourceCounts:) char invalidateDataSourceCounts;
@property (nonatomic, setter=_setInvalidateEverything:) char invalidateEverything;
@property (nonatomic, getter=_updateItems, setter=_setUpdateItems:) NSArray *updateItems;
@property (nonatomic, getter=_initiatedFromReloadData, setter=_setInitiatedFromReloadData:) char initiatedFromReloadData;
@property (nonatomic, getter=_retainExistingSizingInfoForEstimates, setter=_setRetainExistingSizingInfoForEstimates:) char retainExistingSizingInfoForEstimates;
