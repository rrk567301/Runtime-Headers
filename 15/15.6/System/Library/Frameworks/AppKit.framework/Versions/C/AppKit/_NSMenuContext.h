...
@property (nonatomic) char allowsAllWhitespaceText;
@property (nonatomic) char inspectsSelectionText;
@property (nonatomic) char requiresSelection;

- (void)dealloc;
- (id)_selectedURLsForApplyingFilters;
- (char)_concurrentPortionOfQualifyEntriesWithEntriesNeedingURLTypechecking:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)_preconcurrentPortionOfQualifyEntries:(id)a0 returningEntriesNeedingURLTypecheckingIntoSet:(id)a1;
- (id)_selectedStringAndRangeForApplyingFilters:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a0 attributed:(char)a1;
- (char)_selectionExistsAndIsAllWhitespace;
- (char)_sendTypesContainsTextTypeAppropriateForFiltering;
- (char)_stringContainsFilePath:(id)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (char)determineSelectedStringForApplyingFiltersDirectlyFromRequestorSupplyingType:(id)a0 attributed:(char)a1;
- (char)determineSelectedStringForApplyingFiltersViaPasteboardFromRequestorSupplyingType:(id)a0 attributed:(char)a1;
...
- (char)qualifyEntries:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)reportNoTextForTrackingFiltersThatRequireText:(id)a0;
- (id)requestorProvidingType:(id)a0;
- (char)serviceEntryIsActiveInThisContext:(id)a0;
- (char)serviceEntryTypesConformToCarbonPasteboardTypes:(id)a0;
