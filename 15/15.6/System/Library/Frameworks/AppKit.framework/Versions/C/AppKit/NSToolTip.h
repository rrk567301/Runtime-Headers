...
@property (nonatomic) char ownerIsDisplayDelegate;
@property (readonly, nonatomic) char fadesOutWhenInactive;

- (void)dealloc;
- (id)description;
- (id)init;
- (id)initWithView:(id)a0 cell:(id)a1 owner:(id)a2 ownerIsDisplayDelegate:(char)a3 data:(void *)a4 trackingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 string:(id)a6;
