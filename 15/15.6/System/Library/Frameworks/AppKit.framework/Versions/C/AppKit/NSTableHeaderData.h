...
- (void)dealloc;
- (void)updateColumnViewWidthsAnimated:(char)a0;
...
- (void)_updateFramesAnimated:(char)a0;
- (void)addTableColumn:(id)a0 atIndex:(long long)a1;
- (void)beginDraggingColumn:(long long)a0;
- (void)didMoveFromColumn:(long long)a0 toColumn:(long long)a1 animated:(char)a2;
- (void)endDraggingColumn:(long long)a0 animated:(char)a1;
