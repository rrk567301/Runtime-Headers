...
@property (nonatomic) char fullyJustified;
...
- (void)_doUserParagraphStyleLineHeightMultiple:(double)a0 min:(double)a1 max:(double)a2 lineSpacing:(double)a3 paragraphSpacingBefore:(double)a4 after:(double)a5 isFinal:(char)a6;
...
- (void)_loadNib;
- (char)_shouldCheckForFallbackFont;
...
- (char)adjustStateForDifferentAttributeValuesInRange:(id)a0 attributedString:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
...
- (char)inspectorBarItemCanBeDetached:(id)a0;
- (char)inspectorBarItemDetachesFirst:(id)a0;
