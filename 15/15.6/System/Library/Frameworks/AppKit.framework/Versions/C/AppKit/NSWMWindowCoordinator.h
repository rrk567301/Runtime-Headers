...
@interface NSWMWindowCoordinator : NSObject <WMClientWindowManagerDelegate, SLSWindowManagementBridgeDelegate> {
    ...
    char _disableTransactionFencing;
    char _scheduledNSCGSTransactionAction;
...
- (void)performCycleWindowsReversed:(char)a0;
...
- (void)setWindowTags:(id)a0 onWindow:(unsigned int)a1 clear:(char)a2;
