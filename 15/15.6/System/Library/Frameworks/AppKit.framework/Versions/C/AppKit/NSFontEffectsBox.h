...
- (void)_validateDocumentColor:(char)a0;
- (void)_validateFontPanelFontAttributes:(id)a0;
- (void)_validateShadowEffect:(char)a0;
- (void)_validateStrikethrough:(char)a0;
- (void)_validateTextColor:(char)a0;
- (void)_validateUnderline:(char)a0;
- (void)awakeFromNib;
