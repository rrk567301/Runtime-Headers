...
@property (nonatomic) char _wantsCollapsedTopSpacing;
...
- (id)initWithContainer:(id)a0 traitCollection:(id)a1 dataSourceSnapshot:(id)a2 sectionIndex:(long long)a3 wantsCollapsedTopSpacing:(char)a4;
