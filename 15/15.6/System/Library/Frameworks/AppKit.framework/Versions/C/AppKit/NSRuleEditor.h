...
@property char canRemoveAllRows;
...
- (char)_performDragForSlice:(id)a0 withEvent:(id)a1;
- (id)_selectedSlices;
...
- (char)_findRowObject:(id)a0 startingAtObject:(id)a1 withIndex:(long long *)a2;
...
- (id)_newSlice;
- (char)_nextUnusedItems:(id *)a0 andValues:(id *)a1 forRow:(long long)a2 forRowType:(unsigned long long)a3;
...
- (char)_queryCanSelectItem:(id)a0 displayValue:(id)a1 inRow:(long long)a2;
...
- (void)_reconfigureSubviewsAnimate:(char)a0;
- (void)_recursiveGenerateFormattingDictionaryPlistForItem:(id)a0 rowType:(unsigned long long)a1 intoArray:(id)a2 withPriorValues:(id)a3 hasSiblings:(char)a4;
...
- (void)_setAllowsEmptyCompoundRows:(char)a0;
- (void)_setBoundDataSource:(id)a0 withKeyPath:(id)a1 options:(id)a2;
- (void)_setHeaderLocalizer:(id)a0;
- (void)_setPredicate:(id)a0;
- (void)_setPrivateDelegateMethodsEnabled:(char)a0;
- (void)_setStandardLocalizer:(id)a0;
- (void)_setSuppressKeyDownHandling:(char)a0;
- (void)_setWindow:(id)a0;
- (char)_shouldHideAddButtonForSlice:(id)a0;
- (char)_shouldHideSubtractButtonForSlice:(id)a0;
...
- (char)_validateItem:(id)a0 value:(id)a1 inRow:(long long)a2;
...
- (void)insertRowAtIndex:(long long)a0 withType:(unsigned long long)a1 asSubrowOfRow:(long long)a2 animate:(char)a3;
...
- (void)removeRowsAtIndexes:(id)a0 includeSubrows:(char)a1;
