...
@property (class, readonly) char itemLayoutIsSequential;
...
@property (nonatomic, getter=_isPrepared, setter=_setPrepared:) char prepared;
...
- (void)_didFinishLayoutTransitionAnimations:(char)a0;
