...
- (char)_cellTableContainsCell:(id)a0;
- (void)_commonPreInit;
...
- (char)_expandMergeBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 ifNeededForCell:(id)a1;
- (char)_expandMergeBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 ifNeededForColumnAtIndex:(long long)a1;
- (char)_expandMergeBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 ifNeededForRow:(id)a1;
...
- (id)_findVisibleThingNear:(id)a0 after:(char)a1 searchRows:(char)a2;
...
- (id)_rawCellAtColumnIndex:(long long)a0 rowIndex:(long long)a1 allocatingIfNeeded:(char)a2;
- (id)_removeColumnCellsAtIndex:(long long)a0;
- (char)_safeHasSubview:(id)a0;
- (void)_sanityCheck;
...
- (char)_verifyInsertionOfColumnAtIndex:(long long)a0;
- (char)_verifyInsertionOfRowAtIndex:(long long)a0;
- (void)_verifyMergedRegionWithHead:(id)a0;
- (char)_verifyRemovalOfRowColumn:(id)a0;
