...
- (id)initWithTileID:(unsigned long long)a0 parentSpaceID:(unsigned long long)a1 closingSpaceID:(unsigned long long)a2 screen:(id)a3 doResize:(char)a4 placeInWallSpace:(char)a5;
