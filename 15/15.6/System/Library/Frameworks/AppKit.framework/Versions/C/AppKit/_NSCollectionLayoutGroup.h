...
@property (readonly, nonatomic) char isHorizontalGroup;
@property (readonly, nonatomic) char isVerticalGroup;
@property (readonly, nonatomic) char isCustomGroup;
...
- (id)initWithlayoutSize:(id)a0 contentInsets:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a1 layoutAxis:(int)a2 isCustomGroup:(char)a3 subitems:(id)a4 count:(long long)a5 supplementaryItems:(id)a6 interItemSpacing:(id)a7 groupOptions:(long long)a8 subitemsProvider:(id /* block */)a9 frameProvider:(id /* block */)a10 customGroupItemProvider:(id /* block */)a11 visualFormats:(id)a12 visualFormatProvider:(id /* block */)a13;
