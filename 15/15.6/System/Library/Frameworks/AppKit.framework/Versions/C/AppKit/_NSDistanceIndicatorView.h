...
- (id)initWithEdge:(unsigned long long)a0 ofRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 andEdge:(unsigned long long)a2 ofRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 isHorizontal:(char)a4;
