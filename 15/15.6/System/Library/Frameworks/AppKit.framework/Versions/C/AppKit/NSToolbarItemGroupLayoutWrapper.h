...
@interface NSToolbarItemGroupLayoutWrapper : NSView <NSBarLayoutWrapper> {
    ...
    char _requiresLeadingPadding;
    char _requiresTrailingPadding;
}

@property (readonly) NSToolbarItem *item;
@property char requiresLeadingPadding;
@property char requiresTrailingPadding;
...
- (char)_shouldReserveSpaceForLabel;
