...
- (void)presentCloseConfirmationForNewDocument:(char)a0 withCompletion:(id /* block */)a1;
- (void)presentCustomSaveConfirmationShowingDeleteButton:(char)a0 withCompletion:(id /* block */)a1;
