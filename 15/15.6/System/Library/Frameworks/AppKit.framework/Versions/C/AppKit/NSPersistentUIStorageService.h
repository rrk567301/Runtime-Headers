...
- (void)writeWindowSnapshotData:(id)a0 width:(unsigned long long)a1 height:(unsigned long long)a2 bytesPerRow:(unsigned long long)a3 encryptingWithKey:(id)a4 uuid:(id)a5 checkChecksum:(char)a6 forWindowID:(unsigned int)a7 completionHandler:(id /* block */)a8;
