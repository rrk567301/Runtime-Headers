...
+ (char)automaticallyTracksDependenciesOnValueForKey:(id)a0;
...
- (void)_changePersistentKeyPathObservationTo:(char)a0;
...
- (char)_hasDependent:(id)a0 forKey:(id)a1 currentlyValid:(char *)a2;
...
- (id)_recursiveResponderThatWantsForwardedScrollEventsForAxis:(long long)a0 intendedForSwipe:(char *)a1;
- (char)_recursiveWantsForwardedScrollEventsForAxis:(long long)a0;
- (void)_recursivelyReinvalidateRestorableStateIfNecessary;
- (void)_restorePersistentState:(id)a0;
- (void)_setShouldPostEventNotifications:(char)a0;
...
- (char)shouldBeTreatedAsInkEvent:(id)a0;
