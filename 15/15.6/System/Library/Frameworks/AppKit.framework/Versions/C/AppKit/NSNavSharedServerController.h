...
@property char isBannerView;
@property (getter=isRemoteDisc) char remoteDisc;
@property (getter=isUsingDisc) char usingDisc;
@property (getter=isWaitingForDisc) char waitingForDisc;
