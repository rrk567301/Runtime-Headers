...
@interface NSScrubberDocumentView : NSView {
    ...
    struct { struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } visibleContentRect; long long selectedIndex; long long secondarySelectedIndex; double fractionOfSecondary; long long highlightedIndex; long long numberOfItems; struct CGPoint { double x; double y; } contentTrackingPoint; char trackingSelection; } _modelState;
...
@property struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; } modelState;
...
@property char animatingSelections;
...
@property char floatsSelection;
@property struct { struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } visibleContentRect; long long selectedIndex; long long secondarySelectedIndex; double fractionOfSecondary; long long highlightedIndex; long long numberOfItems; struct CGPoint { double x; double y; } contentTrackingPoint; char trackingSelection; } proxyState;
...
- (char)itemNearestToPoint:(struct CGPoint { double x0; double x1; })a0 index:(long long *)a1 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2;
- (void)layoutScrubberContentsAnimated:(char)a0;
...
- (void)applyItemAttributes:(id)a0 startingAttributes:(id)a1 withState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a2;
...
- (void)applySelectionAttributes:(id)a0 startingAttributes:(id)a1 withState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a2;
- (id)attributesNearestToPoint:(struct CGPoint { double x0; double x1; })a0;
- (struct { long long x0; long long x1; double x2; })calculatePinningConfigurationForState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a0;
...
- (char)itemAtPoint:(struct CGPoint { double x0; double x1; })a0 index:(long long *)a1 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a2;
- (id)itemTransitionsFromAttributes:(id)a0 toAttributes:(id)a1 withState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a2;
- (id)makeItemWithIdentifier:(id)a0 owner:(id)a1;
- (id)makeSelectionPairForItemView:(id)a0 withIndex:(long long)a1;
- (void)performItemTransitions:(id)a0 withState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a1;
- (void)performPendingTransitionsWithCompletion:(id /* block */)a0;
- (void)performSelectionTransitions:(id)a0 withState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a1;
...
- (struct CGPoint { double x0; double x1; })scrollPointAligningItemAtIndex:(long long)a0 toAlignment:(long long)a1 forState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a2;
- (id)selectionPairForItemAtIndex:(long long)a0 creatingIfNeeded:(char)a1;
...
- (void)setSuppressScrollCorrection:(char)a0;
- (void)setUserInterfaceLayoutDirection:(long long)a0;
- (id)snapshotForPendingChanges;
- (void)sortScrubberSubviews;
- (void)updateCornerMaskingForState:(struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; long long x1; long long x2; double x3; long long x4; long long x5; struct CGPoint { double x0; double x1; } x6; char x7; })a0;
...
- (id)viewForItemAtIndex:(long long)a0 creatingIfNeeded:(char)a1;
