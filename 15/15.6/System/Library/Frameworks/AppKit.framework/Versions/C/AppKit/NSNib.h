...
+ (char)getNibName:(id *)a0 objectID:(id *)a1 forUserInterfaceItem:(id)a2;
...
- (char)_instantiateNibWithExternalNameTable:(id)a0 options:(id)a1;
- (char)_instantiateWithOwner:(id)a0 options:(id)a1 topLevelObjects:(id *)a2;
- (void)_loadNibData;
...
- (char)instantiateNibWithExternalNameTable:(id)a0;
- (char)instantiateNibWithOwner:(id)a0 topLevelObjects:(id *)a1;
- (char)instantiateWithOwner:(id)a0 topLevelObjects:(id *)a1;
- (void)setInheritsDecodeTimeBundlePath:(char)a0;
