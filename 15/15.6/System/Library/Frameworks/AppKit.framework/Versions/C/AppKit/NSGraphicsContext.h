...
+ (id)graphicsContextWithCGContext:(struct CGContext { } *)a0 flipped:(char)a1;
+ (id)graphicsContextWithCGContext:(struct CGContext { } *)a0 forCALayer:(id)a1;
+ (id)graphicsContextWithGraphicsPort:(void *)a0 flipped:(char)a1;
