...
- (id)_findButtonImageForState:(struct NSButtonState { long long x0; char x1; char x2; char x3; })a0;
- (void)_initImageMetadata;
- (id)_initWithImageDictionary:(id)a0;
- (id)imageForState:(struct NSButtonState { long long x0; char x1; char x2; char x3; })a0;
- (char)useDisabledEffectForState:(struct NSButtonState { long long x0; char x1; char x2; char x3; })a0;
- (char)useHighlightEffectForState:(struct NSButtonState { long long x0; char x1; char x2; char x3; })a0;
