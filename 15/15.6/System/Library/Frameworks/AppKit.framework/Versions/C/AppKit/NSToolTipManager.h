...
+ (char)isCurrentMouseLocationAboveWindow:(id)a0;
...
- (long long)_addTrackingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 andStartToolTipIfNecessary:(char)a1 view:(id)a2 owner:(id)a3 toolTip:(id)a4 reuseExistingTrackingNum:(char)a5;
- (void)_addTrackingRectsForView:(id)a0;
- (char)_checkDisplayDelegate:(id)a0;
...
- (void)_getDisplayDelay:(double *)a0 inQuickMode:(char *)a1 forView:(id)a2;
- (char)_inQuickDisplayModeForWindow:(id)a0;
- (void)_menuDidBeginTracking:(id)a0;
- (id)_newToolTipWindow;
- (void)_removeToolTipsForView:(id)a0 passingTest:(id /* block */)a1;
- (void)_removeTrackingRectForToolTip:(id)a0 stopTimerIfNecessary:(char)a1;
- (void)_removeTrackingRectsForView:(id)a0 stopTimerIfNecessary:(char)a1;
- (long long)_setToolTip:(id)a0 forView:(id)a1 cell:(id)a2 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 owner:(id)a4 ownerIsDisplayDelegate:(char)a5 userData:(void *)a6;
- (char)_shouldInstallToolTip:(void *)a0;
- (void)_stopFadeTimer;
...
- (void)addTrackingRectForToolTip:(id)a0 reuseExistingTrackingNum:(char)a1;
- (void)fadeToolTip:(id)a0;
- (void)installContentView:(id)a0 forToolTip:(id)a1 toolTipWindow:(id)a2 isNew:(char)a3;
...
- (void)orderOutToolTipsImmediately:(char)a0;
- (void)recomputeToolTipsForView:(id)a0 remove:(char)a1 add:(char)a2;
