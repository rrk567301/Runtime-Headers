...
- (char)_characterAtIndex:(unsigned long long)a0 shouldTerminateString:(id)a1;
...
- (void)_setPerformingDrop:(char)a0;
...
- (char)_tokenizeCharactersAdjacentToSelectionForTextView:(id)a0 terminatorsNeeded:(char)a1;
...
- (char)hasMenuForTokenAttachment:(id)a0;
...
- (void)setAutoValidationDisabled:(char)a0;
- (void)setFont:(id)a0;
...
- (char)tokenAttachment:(id)a0 doubleClickedInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 ofView:(id)a2 atCharacterIndex:(unsigned long long)a3;
- (id)tokenAttachment:(id)a0 shouldUseTokenAttachmentCell:(id)a1;
- (char)tokenTextView:(id)a0 readSelectionFromPasteboard:(id)a1 type:(id)a2;
...
- (char)tokenTextView:(id)a0 writeSelectionToPasteboard:(id)a1 type:(id)a2;
