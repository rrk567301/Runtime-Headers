...
@interface NSPersistentUILocalStorageClient : NSObject <NSPersistentUIStorageClient> {
    ...
    char _fetchingStateDirectoryAtLaunch;
}
...
- (void)writeWindowSnapshot:(const void *)a0 length:(unsigned long long)a1 width:(unsigned long long)a2 height:(unsigned long long)a3 bytesPerRow:(unsigned long long)a4 encryptingWithKey:(id)a5 uuid:(id)a6 checkChecksum:(char)a7 forWindowID:(unsigned int)a8 synchronously:(char)a9 completionHandler:(id /* block */)a10;
