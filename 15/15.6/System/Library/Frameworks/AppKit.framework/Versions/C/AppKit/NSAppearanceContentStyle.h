...
- (int)_equivalentImageBackgroundStyleForTemplateImage:(char)a0;
...
- (double)_temporaryImageAlphaComponentOverrideWithTemplate:(char)a0;
...
- (void)drawStylizedImage:(id)a0 inAlignmentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 operation:(unsigned long long)a2 fraction:(double)a3 flip:(char)a4 hints:(id)a5;
- (void)drawStylizedImage:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 operation:(unsigned long long)a2 fraction:(double)a3 flip:(char)a4 hints:(id)a5;
- (id)stylizedAttributedStringForAttributedString:(id)a0;
- (struct CGImage { } *)stylizedImageForImage:(struct CGImage { } *)a0 isTemplate:(char)a1 backingTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2;
