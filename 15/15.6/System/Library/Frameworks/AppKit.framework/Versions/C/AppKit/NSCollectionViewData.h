...
@property (nonatomic, getter=isLayoutLocked) char layoutLocked;
...
- (char)isGlobalIndexValid:(long long)a0;
- (char)isIndexPathValid:(id)a0;
- (id)knownDecorationElementKinds;
- (id)knownSupplementaryElementKinds;
- (id)layoutAttributesForCellsInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 validateLayout:(char)a1;
