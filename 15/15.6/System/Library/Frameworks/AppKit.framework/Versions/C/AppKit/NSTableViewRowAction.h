...
+ (id)rowActionWithStyle:(long long)a0 title:(id)a1 allowsFullSwipe:(char)a2 handler:(id /* block */)a3;
+ (id)rowActionWithStyle:(long long)a0 title:(id)a1 handler:(id /* block */)a2;

- (void)dealloc;
- (id)copyWithZone:(struct _NSZone { } *)a0;
- (id)_initWithStyle:(long long)a0 title:(id)a1 allowsFullSwipe:(char)a2 handler:(id /* block */)a3;
