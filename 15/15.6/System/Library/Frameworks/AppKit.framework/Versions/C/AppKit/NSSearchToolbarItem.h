...
@interface NSSearchToolbarItem : NSToolbarItem <NSSearchFieldDelegate, _NSTextFieldHostingToolbarItem> {
    ...
    char _inTemporaryIconDisplayMode;
...
@property (readonly) char _usesNativeSearchField;
@property (readonly) char _usesBridgedSearchField;
@property id cancelButtonTarget;
@property SEL cancelButtonAction;
@property char allowsButtonRepresentation;
...
@property char resignsFirstResponderWithCancel;
...
- (void)_setExpanded:(char)a0 animated:(char)a1;
