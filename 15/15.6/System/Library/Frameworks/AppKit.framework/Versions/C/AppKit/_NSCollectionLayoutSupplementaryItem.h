...
@property (nonatomic) char canAdjustContentSize;
...
- (id)initWithSize:(id)a0 elementKind:(id)a1 zIndex:(long long)a2 contentInsets:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a3 containerAnchor:(id)a4 itemAnchor:(id)a5 edgeSpacing:(id)a6 name:(id)a7 canAdjustContentSize:(char)a8;
