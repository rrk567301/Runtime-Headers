...
@property (readonly, nonatomic) char layoutRTL;
...
@property (nonatomic) char shouldAdjustContentSizeForPartialLastGroupSolution;
...
- (void)solveForContainer:(id)a0 traitCollection:(id)a1 layoutAxis:(int)a2 frameCount:(long long)a3 preferredSizes:(id)a4 layoutRTL:(char)a5;
