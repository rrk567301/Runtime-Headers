...
@property (readonly, getter=_needsRecalc) char needsRecalc;
@property (readonly, getter=_selected) char selected;
@property (readonly, getter=_disabled) char disabled;
@property (readonly, getter=_showMenuIndicator) char showMenuIndicator;
@property (readonly, getter=_mouseInside) char mouseInside;
@property (readonly, getter=_inactiveStateDisablesRollovers) char inactiveStateDisablesRollovers;
@property (readonly, getter=_imageScaling) unsigned long long imageScaling;
@property (readonly) char highlighted;
@property (readonly) long long highlightState;
@property (readonly, getter=_showsBadge) char showsBadge;
