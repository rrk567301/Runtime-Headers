...
- (void)_doUserSetListMarkerFormat:(id)a0 options:(unsigned long long)a1 startingItemNumber:(long long)a2 forceStartingItemNumber:(char)a3;
...
- (id)rulerAccessoryViewForTextView:(id)a0 paragraphStyle:(id)a1 ruler:(id)a2 enabled:(char)a3;
