...
@property (readonly, getter=isDraggedOutOfBar) char draggedOutOfBar;
...
+ (id)_statusItemWithWindowID:(unsigned int)a0 isReplicant:(char)a1 parent:(unsigned int)a2 confiningDisplayID:(id)a3 flags:(unsigned int)a4 priority:(int)a5 systemInsertOrder:(int)a6 preferredPosition:(float)a7 appearance:(unsigned int)a8;
...
- (id)initWithWindowID:(unsigned int)a0 isReplicant:(char)a1 parent:(unsigned int)a2 confiningDisplayID:(id)a3 flags:(unsigned int)a4 priority:(int)a5 systemInsertOrder:(int)a6 preferredPosition:(float)a7 appearance:(unsigned int)a8;
