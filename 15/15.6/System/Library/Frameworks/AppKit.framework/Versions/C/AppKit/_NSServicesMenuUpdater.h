...
- (void)insertServicesIntoMenu:(id)a0 withKeyEvent:(id)a1 isForDisplay:(char)a2;
- (char)isPluggedIntoMenu:(id)a0;
- (char)isPluggedIntoMenuRef:(struct OpaqueMenuRef { } *)a0;
- (id)menuContext;
