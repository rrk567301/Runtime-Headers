...
@property (nonatomic, getter=isShowingCloseButton) char showingCloseButton;
...
- (id)_attributedStringColorMapForMainWindow:(char)a0 activeTab:(char)a1 isDragging:(char)a2;
- (char)_canShowCloseButton;
...
- (id)_titleStringAttributesForMainWindow:(char)a0 activeTab:(char)a1 isDragging:(char)a2;
...
- (void)setHasMouseOverHighlight:(char)a0 shouldAnimateCloseButton:(char)a1;
