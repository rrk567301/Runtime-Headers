...
- (double)_additionalDimensionForEdgeSpacingAlongAxis:(int)a0 group:(id)a1 trailingEdgeOnly:(char)a2;
...
- (unsigned long long)_directionalEdgeForLayoutAxis:(int)a0 preEdge:(char)a1;
...
- (void)_solve;
- (void)_solveForContainer:(id)a0 layoutAxis:(int)a1 traitCollection:(id)a2 maxFrameCount:(long long)a3 layoutRTL:(char)a4 preferredSizes:(id)a5 solutionRecursionDepth:(long long)a6;
- (void)_solveGroup;
...
- (char)canAccomodateItemWithSize:(struct CGSize { double x0; double x1; })a0;
...
- (id)initWithItem:(id)a0 supplementaryEnroller:(id)a1 container:(id)a2 layoutAxis:(int)a3 traitCollection:(id)a4 maxFrameCount:(long long)a5 layoutRTL:(char)a6 preferredSizes:(id)a7 solverResult:(id)a8 solutionRecursionDepth:(long long)a9;
...
- (void)solveForContainer:(id)a0 layoutAxis:(int)a1 traitCollection:(id)a2 maxFrameCount:(long long)a3 layoutRTL:(char)a4;
- (void)solveForContainer:(id)a0 layoutAxis:(int)a1 traitCollection:(id)a2 maxFrameCount:(long long)a3 layoutRTL:(char)a4 preferredSizes:(id)a5;
