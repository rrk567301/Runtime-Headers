...
- (char)acceptsNilReturnTypes;
- (char)acceptsNilSendTypes;
...
- (char)hasSendTypes;
- (id)internalRunService:(id)a0 flags:(unsigned long long)a1 cancelledHint:(const char *)a2;
- (char)invokeWithPasteboard:(id)a0;
- (char)invokeWithResponder:(id)a0;
- (char)invokeWithResponder:(id)a0 invocationSourceType:(unsigned long long)a1;
