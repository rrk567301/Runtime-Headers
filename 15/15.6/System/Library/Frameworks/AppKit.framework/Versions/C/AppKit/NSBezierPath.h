...
+ (id)_bezierPathWithRoundedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 radius:(double)a1 continuousCorners:(char)a2;
+ (id)bezierPath;
...
- (char)_initializeDashPatternFromDecodedBytes:(const void *)a0 length:(unsigned long long)a1 requiresSecureCoding:(char)a2 error:(id *)a3;
- (char)_initializeSegmentsFromDecodedBytes:(const void *)a0 length:(unsigned long long)a1 requiresSecureCoding:(char)a2 error:(id *)a3;
...
- (void)setCachesBezierPath:(char)a0;
