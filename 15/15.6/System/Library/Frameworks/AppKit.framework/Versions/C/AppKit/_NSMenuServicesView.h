...
@property (nonatomic) char shouldDrawCategoryName;
@property (nonatomic) char shouldDrawCategoryArea;
@property (nonatomic) char isSpacer;
@property (nonatomic) char isEditServicesItem;
@property (nonatomic) char isNoServicesApplyItem;
@property (nonatomic) char iconIsDefaultBrowser;
...
- (void)drawCategoryNameInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 highlighted:(char)a1 backgroundStyle:(long long)a2 clipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
...
- (void)drawKeyEquivalentForItem:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 highlighted:(char)a2 backgroundStyle:(long long)a3 clipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
- (void)drawRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (void)drawTitle:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 highlighted:(char)a2 enabled:(char)a3 backgroundStyle:(long long)a4 clipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5;
