...
+ (id)internalRunService:(id)a0 pboard:(id)a1 flags:(unsigned long long)a2 cancelledHint:(const char *)a3;
+ (id)internalRunService:(id)a0 pboard:(id)a1 requestingApp:(id)a2 flags:(unsigned long long)a3 cancelledHint:(const char *)a4;
...
- (id)objectForServicePath:(id)a0 app:(id)a1 doLaunch:(char)a2 limitDate:(id)a3;
- (id)objectForServicePath:(id)a0 app:(id)a1 doLaunch:(char)a2 limitDate:(id)a3 basePortName:(id)a4;
