...
@property (readonly, nonatomic) char shouldDisplayHostnameForThumbnailContainers;
...
- (void)_addContainerViewAtIndex:(unsigned long long)a0 isVisible:(char)a1;
...
- (char)canCloseNSVisualTabPickerTileContainerView:(id)a0;
...
- (char)visualTabPickerTileContainerView:(id)a0 highlightStateForTileAtIndex:(unsigned long long)a1;
