...
@property (readonly) char isShowingDocumentMenu;
...
- (void)_configureForShowingAutosave:(char)a0 editingState:(long long)a1 autosavingError:(id)a2 nonModalError:(id)a3;
- (void)_configureWithRepresentedURL:(id)a0;
- (void)_endEditingOfToolbarSubviewIfNecessary;
- (char)_performMouseDownWithEvent:(id)a0;
- (char)_shouldToolbarStealEvent:(id)a0;
