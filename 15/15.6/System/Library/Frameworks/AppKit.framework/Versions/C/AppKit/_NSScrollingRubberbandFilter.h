...
@property (nonatomic, getter=isFlipped) char flipped;
@property (nonatomic) char allowsHorizontalRubberbanding;
@property (nonatomic) char allowsVerticalRubberbanding;
...
@property (readonly, nonatomic, getter=isStretched) char stretched;
...
- (id)initWithDocumentFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 constrainedClippingOrigin:(struct CGPoint { double x0; double x1; })a1 clippingSize:(struct CGSize { double x0; double x1; })a2 isFlipped:(char)a3 pointsPerPixel:(double)a4;
