...
@property (readonly) char prefersMulticolor;
...
- (id)initWithPointSize:(double)a0 weight:(double)a1 scale:(long long)a2 colors:(id)a3 renderingStyle:(long long)a4 preferringMulticolor:(char)a5;
