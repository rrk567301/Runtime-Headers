...
@interface NSMenuBarImpl : NSCocoaMenuImpl <NSMenuBarLifecycleProtocol> {
    ...
    char _isGroupingLayoutChanges;
    char _hasPendingLayoutChanges;
    char _isImmediateLayoutClean;
}
...
@property (readonly) char isLocalInstance;
...
- (void).cxx_destruct;
- (id)trackingSession;
- (char)_isMenuBarReady;
- (id)highlightedView;
- (long long)predominantAxis;
- (char)_allowsHighlightingFirstItem;
- (char)_delaysSubmenuPresentation;
- (void)_finishSettingUpMenuBar;
- (void)_highlightSecondaryItemView:(id)a0 openingSubmenu:(char)a1;
...
- (char)_removeAuxiliaryHighlightIfNeeded;
...
- (void)highlightSecondaryItemAtIndex:(long long)a0 openingSubmenu:(char)a1;
