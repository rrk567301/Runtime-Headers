...
- (void)enableAll:(char)a0;
- (char)getRows:(unsigned long long *)a0 columns:(unsigned long long *)a1 inTabDelimitedString:(id)a2 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
- (void)mergeCells;
...
- (void)splitCells;
- (id)tableOptionsPanel:(char)a0;
- (char)textView:(id)a0 shouldSetColor:(id)a1;
- (void)updateUI;
- (void)windowDidLoad;
- (char)worksWhenModal;
