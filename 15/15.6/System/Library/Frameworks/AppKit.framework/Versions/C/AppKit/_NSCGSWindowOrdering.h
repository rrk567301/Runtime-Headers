...
- (char)_hasUncommittedSpaceAssignmentChanges:(id)a0;
...
- (void)disableActivationOrderingForWindow:(id)a0 isInitiallyOrderedIn:(char)a1;
- (void)disassociateFromSpacesIfOrderedOut:(id)a0;
- (void)enableActivationOrderingForWindow:(id)a0 isInitiallyOrderedIn:(char)a1;
- (char)isWindowOrderedIn:(id)a0;
