...
@property (nonatomic) char shouldUpdateElementOrdering;
...
- (double)_adjustedDestinationForLocation:(double)a0 inScrollView:(id)a1 scrollsVertically:(char)a2 velocity:(double)a3 pageSizeGetter:(id /* block */)a4;
...
- (char)hasOrthogonalSections;
- (id)initWithCollectionView:(id)a0;
- (char)isElementInOrthogonalScrollingSection:(id)a0;
- (char)isIndexPathInOrthogonalScrollingSection:(id)a0;
- (void)performLayout;
