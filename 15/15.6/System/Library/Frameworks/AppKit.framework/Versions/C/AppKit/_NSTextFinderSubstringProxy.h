...
- (void)_getSubstring:(id *)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1 searchBoundary:(char *)a2 atCharacterIndex:(unsigned long long)a3;
- (unsigned long long)_nextSearchBoundaryAfterOrIncluding:(char)a0 index:(unsigned long long)a1 forward:(char)a2;
