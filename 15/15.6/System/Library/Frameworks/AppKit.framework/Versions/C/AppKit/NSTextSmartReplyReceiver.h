...
@property (nonatomic) char allowFeedbackForCurrentSmartReplies;
...
@property (nonatomic) char isInWritingToolsSession;
...
- (char)_contextHistoryDifferent:(id)a0 fromOther:(id)a1;
...
- (char)_isSameConversationThread;
- (id)_keyboardStateUsingHistory:(id)a0;
- (char)_lastCloseShouldPreventNewRequestWithHistory:(id)a0;
...
- (void)removeTextPlaceholder:(id)a0 willInsertText:(char)a1 completionHandler:(id /* block */)a2;
