...
@property (readonly, getter=isContentOriginUpperLeft) char contentOriginUpperLeft;
...
@property (readonly, getter=isCursorWithinContent) char cursorWithinContent;
...
- (void)scrollingAnimator:(id)a0 velocityHasSlowed:(char)a1;
