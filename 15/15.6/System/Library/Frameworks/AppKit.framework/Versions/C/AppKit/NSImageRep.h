...
@property (readonly, getter=isTemplate) char template;
...
+ (id)_imageRepsWithContentsOfFile:(id)a0 expandImageContentNow:(char)a1;
+ (id)_imageRepsWithContentsOfURL:(id)a0 expandImageContentNow:(char)a1;
+ (id)_imageRepsWithContentsOfURL:(id)a0 expandImageContentNow:(char)a1 giveUpOnNetworkURLsWithoutGoodExtensions:(char)a2;
+ (id)_imageRepsWithData:(id)a0 fileType:(id)a1 hfsType:(id)a2 expandImageContentNow:(char)a3;
...
- (struct CGImage { } *)CGImageForProposedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 context:(id)a1 hints:(id)a2 flipped:(char)a3;
...
- (char)_drawFromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 operation:(unsigned long long)a2 alpha:(double)a3 compositing:(char)a4 flipped:(char)a5 ignoreContext:(char)a6;
...
- (struct CGImage { } *)_newCGImageForProposedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a0 context:(id)a1 hints:(id)a2 flipped:(char)a3;
