...
@property (nonatomic, getter=isDelegateQueueSuspended) char delegateQueueSuspended;
@property (nonatomic) char wantsToBecomeFirstResponder;
@property (nonatomic) char wantsToReceiveActionResponses;
...
- (void)_extensionWantsToBecomeFirstResponder:(char)a0;
- (void)_extensionWantsToReceiveActionResponses:(char)a0;
