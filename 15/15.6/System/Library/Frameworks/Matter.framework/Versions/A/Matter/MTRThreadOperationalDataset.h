...
@interface MTRThreadOperationalDataset : NSObject {
    struct OperationalDataset { unsigned char mData[254]; unsigned char mLength; } _cppThreadOperationalDataset;
}
...
- (char)_checkDataLength:(id)a0 expectedLength:(unsigned long long)a1;
- (char)_populateCppOperationalDataset;
