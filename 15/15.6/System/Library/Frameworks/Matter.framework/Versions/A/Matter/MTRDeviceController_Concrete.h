...
@property (readonly, nonatomic) char shouldAdvertiseOperational;
...
- (char)checkForInitError:(char)a0 logMsg:(id)a1;
- (char)checkForStartError:(struct ChipError { unsigned int x0; char *x1; unsigned int x2; })a0 logMsg:(id)a1;
- (char)checkIsRunning;
...
- (char)definitelyUsesThreadForDevice:(unsigned long long)a0;
...
- (id)initWithFactory:(id)a0 queue:(id)a1 storageDelegate:(id)a2 storageDelegateQueue:(id)a3 otaProviderDelegate:(id)a4 otaProviderDelegateQueue:(id)a5 uniqueIdentifier:(id)a6 concurrentSubscriptionPoolSize:(unsigned long long)a7 storageBehaviorConfiguration:(id)a8 startSuspended:(char)a9;
- (void)invalidateCASESessionForNode:(id)a0;
- (struct ChipError { unsigned int x0; char *x1; unsigned int x2; })isRunningOnFabric:(void *)a0 fabricIndex:(unsigned char)a1 isRunning:(char *)a2;
- (char)matchesPendingShutdownControllerWithOperationalCertificate:(id)a0 andRootCertificate:(id)a1;
...
- (char)syncRunOnWorkQueueWithBoolReturnValue:(id /* block */)a0 error:(id *)a1;
