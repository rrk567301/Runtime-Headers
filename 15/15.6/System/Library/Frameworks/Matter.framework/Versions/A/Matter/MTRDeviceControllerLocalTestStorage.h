...
@property (class, nonatomic) char localTestStorageEnabled;
...
- (void).cxx_destruct;
- (char)controller:(id)a0 removeValueForKey:(id)a1 securityLevel:(unsigned long long)a2 sharingType:(unsigned long long)a3;
- (char)controller:(id)a0 storeValue:(id)a1 forKey:(id)a2 securityLevel:(unsigned long long)a3 sharingType:(unsigned long long)a4;
- (char)controller:(id)a0 storeValues:(id)a1 securityLevel:(unsigned long long)a2 sharingType:(unsigned long long)a3;
