...
+ (void)readAttributeBindingWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeBindingWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeBindingWithParams:(id)a0 completion:(id /* block */)a1;
- (void)readAttributeBindingWithParams:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)subscribeAttributeBindingWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeBindingWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeBindingWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeBindingWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeBindingWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeBindingWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
