...
@property (readonly) char deviceCachePrimed;
...
- (char)_callDelegatesWithBlock:(id /* block */)a0;
...
- (char)_iterateDelegatesWithBlock:(id /* block */)a0;
