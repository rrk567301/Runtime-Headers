...
- (void)cancelRecordProgramWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)getProgramGuideWithCompletion:(id /* block */)a0;
- (void)getProgramGuideWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)recordProgramWithParams:(id)a0 completion:(id /* block */)a1;
