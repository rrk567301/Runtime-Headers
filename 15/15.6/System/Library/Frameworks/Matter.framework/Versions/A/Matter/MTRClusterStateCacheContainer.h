...
@property char shouldUseXPC;
@property void *cppClusterStateCache;
@property (retain, nonatomic) MTRBaseDevice *baseDevice;

- (id)init;
- (void).cxx_destruct;
- (void)_readKnownCachedAttributeWithEndpointID:(unsigned short)a0 clusterID:(unsigned int)a1 attributeID:(unsigned int)a2 queue:(id)a3 completion:(id /* block */)a4;
