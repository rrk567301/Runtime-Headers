...
@property (readonly, nonatomic) char advertiseOperational;
@property (readonly, nonatomic) char allowMultipleControllersPerFabric;
...
- (id)initForExistingFabric:(void *)a0 fabricIndex:(unsigned char)a1 keystore:(struct OperationalKeystore { void /* function */ **x0; } *)a2 advertiseOperational:(char)a3 params:(id)a4;
- (id)initForNewController:(id)a0 fabricTable:(void *)a1 keystore:(struct OperationalKeystore { void /* function */ **x0; } *)a2 advertiseOperational:(char)a3 params:(id)a4 error:(struct ChipError { unsigned int x0; char *x1; unsigned int x2; } *)a5;
- (id)initForNewFabric:(void *)a0 keystore:(struct OperationalKeystore { void /* function */ **x0; } *)a1 advertiseOperational:(char)a2 params:(id)a3;
- (char)keypairsMatchCertificates;
