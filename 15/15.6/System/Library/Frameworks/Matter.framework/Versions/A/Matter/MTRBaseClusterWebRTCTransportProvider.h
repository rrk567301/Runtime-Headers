...
+ (void)readAttributeCurrentSessionsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)endSessionWithParams:(id)a0 completion:(id /* block */)a1;
- (void)provideAnswerWithParams:(id)a0 completion:(id /* block */)a1;
- (void)provideICECandidatesWithParams:(id)a0 completion:(id /* block */)a1;
- (void)provideOfferWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeCurrentSessionsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)readAttributeFeatureMapWithCompletion:(id /* block */)a0;
- (void)readAttributeGeneratedCommandListWithCompletion:(id /* block */)a0;
- (void)solicitOfferWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeCurrentSessionsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
