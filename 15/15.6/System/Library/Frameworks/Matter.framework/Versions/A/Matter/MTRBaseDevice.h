...
@property (readonly, nonatomic) char isPASEDevice;
...
- (void)_invokeCommandWithEndpointID:(id)a0 clusterID:(id)a1 commandID:(id)a2 commandFields:(id)a3 timedInvokeTimeout:(id)a4 serverSideProcessingTimeout:(id)a5 logCall:(char)a6 queue:(id)a7 completion:(id /* block */)a8;
...
- (void)readAttributePaths:(id)a0 eventPaths:(id)a1 params:(id)a2 includeDataVersion:(char)a3 queue:(id)a4 completion:(id /* block */)a5;
