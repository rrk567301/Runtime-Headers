@class NSNumber, MTRDemandResponseLoadControlClusterLoadControlEventStruct;

@interface MTRDemandResponseLoadControlClusterAddLoadControlEventRequestParams : NSObject <NSCopying>

@property (copy, nonatomic) MTRDemandResponseLoadControlClusterLoadControlEventStruct *event;
