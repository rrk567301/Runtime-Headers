@class NSMutableArray, NSArray, NSObject, MTRDeviceController;
...
- (void).cxx_destruct;
- (char)_bulkStoreAttributeCacheValues:(id)a0;
- (id)_fetchNodeIndex;
- (void)_clearResumptionInfoForNodeID:(id)a0 controller:(id)a1;
...
- (char)_deleteClusterDataForNodeID:(id)a0 endpointID:(id)a1 clusterID:(id)a2;
- (char)_deleteClusterIndexForNodeID:(id)a0 endpointID:(id)a1;
- (char)_deleteEndpointIndexForNodeID:(id)a0;
- (char)_deleteNodeIndex;
...
- (char)_removeAttributeCacheValueForKey:(id)a0;
- (char)_removeEndpointFromEndpointIndex:(id)a0 forNodeID:(id)a1;
- (char)_storeAttributeCacheValue:(id)a0 forKey:(id)a1;
- (char)_storeClusterData:(id)a0 forNodeID:(id)a1 endpointID:(id)a2 clusterID:(id)a3;
- (char)_storeClusterIndex:(id)a0 forNodeID:(id)a1 endpointID:(id)a2;
- (char)_storeEndpointIndex:(id)a0 forNodeID:(id)a1;
- (char)_storeNodeIndex:(id)a0;
- (void)clearAllResumptionInfo;
- (void)clearAllStoredClusterData;
- (void)clearDeviceDataForNodeID:(id)a0;
- (void)clearResumptionInfoForNodeID:(id)a0;
...
- (void)synchronouslyPerformBlock:(id /* block */)a0;
