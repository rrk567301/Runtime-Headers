...
+ (void)readAttributeHoldTimeLimitsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeHoldTimeWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeHoldTimeLimitsWithCompletion:(id /* block */)a0;
- (void)readAttributeHoldTimeWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeHoldTimeLimitsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeHoldTimeWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeHoldTimeWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeHoldTimeWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
