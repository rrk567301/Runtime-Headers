@class NSString, MTRContentLauncherClusterPlaybackPreferencesStruct, MTRContentLauncherClusterContentSearchStruct, NSNumber;
...
@property (copy, nonatomic) MTRContentLauncherClusterPlaybackPreferencesStruct *playbackPreferences;
@property (copy, nonatomic) NSNumber *useCurrentContext;
