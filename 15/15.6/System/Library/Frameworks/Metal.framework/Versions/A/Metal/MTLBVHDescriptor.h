...
@interface MTLBVHDescriptor : NSObject {
    ...
    struct PipelineKey { struct { unsigned char pipelineIndex : 8; unsigned char polygonType : 2; unsigned char minFragmentsPerLeaf : 4; unsigned char maxFragmentsPerLeaf : 8; unsigned char indexStride : 4; unsigned char spatialSplits : 1; unsigned char useResourceBuffer : 1; unsigned char primitiveMotion : 1; unsigned char branchingFactor : 4; unsigned char motion : 1; unsigned char useBatching : 1; unsigned char useChildIndices : 1; unsigned char vertexFormat : 6; unsigned char logThreadgroupSize : 4; unsigned char maxFragmentsPerInnerNode : 8; unsigned char createLeafNodes : 1; unsigned char enforceMaxDepth : 1; unsigned char useTemporalSplits : 1; unsigned char disallowMixingTemporalSplitsAndLeafNodes : 1; unsigned char useFastWideBuild : 1; unsigned char deterministic : 1; unsigned char fragmentPhase : 1; unsigned char supportsSIMDReduction : 1; unsigned char supportsSIMDShuffleAndFill : 1; unsigned char useFastBestObjectSplit : 1; unsigned char maxSubKeyframeTemporalSplits : 4; unsigned char disallowTemporalSplits : 1; unsigned char rowMajorInstanceMatrix : 1; unsigned char refitUpdatesOpacityAndFunctionTableOffset : 1; } ; unsigned int vertexStride; unsigned int boundingBoxStride; float minOverlap; float traversalCost; float fragmentCost; float temporalSplitBias; } _pipelineKey;
...
- (id)init;
- (void).cxx_destruct;
- (char)primitiveMotion;
- (unsigned long long)actualMaxDepth;
- (struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 4; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 4; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; unsigned char x12 : 6; unsigned char x13 : 4; unsigned char x14 : 8; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; unsigned char x19 : 1; unsigned char x20 : 1; unsigned char x21 : 1; unsigned char x22 : 1; unsigned char x23 : 1; unsigned char x24 : 1; unsigned char x25 : 4; unsigned char x26 : 1; unsigned char x27 : 1; unsigned char x28 : 1; } x0; unsigned int x1; unsigned int x2; float x3; float x4; float x5; float x6; })cachedPipelineKey;
- (char)requiresResourceBuffer;
- (void)updateMaxDepth;
