...
- (id)structType;
- (id)initWithName:(id)a0 type:(unsigned long long)a1 access:(unsigned long long)a2 isActive:(char)a3 arraySize:(unsigned long long)a4 dataType:(unsigned long long)a5 dataSize:(unsigned long long)a6 alignment:(unsigned long long)a7;
