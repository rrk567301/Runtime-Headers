...
@property (nonatomic, getter=isAlphaToCoverageEnabled) char alphaToCoverageEnabled;
@property (nonatomic, getter=isAlphaToOneEnabled) char alphaToOneEnabled;
@property (nonatomic, getter=isRasterizationEnabled) char rasterizationEnabled;
...
@property (nonatomic, getter=isTessellationFactorScaleEnabled) char tessellationFactorScaleEnabled;
...
@property (nonatomic) char supportAddingVertexBinaryFunctions;
@property (nonatomic) char supportAddingFragmentBinaryFunctions;
