...
- (void)dealloc;
- (char)isEqual:(id)a0;
- (id)initWithName:(id)a0 type:(unsigned long long)a1 access:(unsigned long long)a2 isActive:(char)a3 locationIndex:(unsigned long long)a4 dataType:(unsigned long long)a5 pixelFormat:(unsigned long long)a6 aluType:(unsigned long long)a7 dataSize:(unsigned long long)a8 alignment:(unsigned long long)a9;
