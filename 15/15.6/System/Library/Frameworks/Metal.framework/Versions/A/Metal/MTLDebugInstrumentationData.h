...
@property (readonly, nonatomic) char hasGlobalConstantsInstrumentationFailures;
@property (readonly, nonatomic) char hasArgumentBufferInstrumentationFailures;
@property (readonly, nonatomic) char hasArgumentLimitsInstrumentationFailures;
