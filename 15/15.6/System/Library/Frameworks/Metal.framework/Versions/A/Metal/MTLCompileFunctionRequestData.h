...
@property (nonatomic) char meshShaderEmulatorEnabled;
@property (nonatomic) char emulatorGeneratesVertexShader;
@property (nonatomic) char emulatorLowersFragmentShader;
