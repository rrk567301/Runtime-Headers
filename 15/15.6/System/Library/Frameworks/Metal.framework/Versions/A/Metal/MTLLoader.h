...
+ (char)ReadHashTable:(unsigned long long)a0 begin:(unsigned int)a1 end:(unsigned int)a2 hashList:(void *)a3 reader:(id /* block */)a4 errorHandler:(id /* block */)a5 handler:(id /* block */)a6;
+ (char)deserializeHashesFromAIRNTHeaderAtOffset:(unsigned long long)a0 headerSize:(unsigned long long)a1 singleHeaderExpected:(BOOL)a2 reader:(id /* block */)a3 errorHandler:(id /* block */)a4 handler:(id /* block */)a5;
+ (char)deserializeObjectFromAIRNTHeaderAtSection:(struct { unsigned long long x0; unsigned long long x1; unsigned int x2; } *)a0 reader:(id /* block */)a1 errorHandler:(id /* block */)a2 handler:(id /* block */)a3;
+ (char)deserializePipelinesFromAIRNTHeaderAtOffset:(unsigned long long)a0 headerSize:(unsigned long long)a1 singleHeaderExpected:(BOOL)a2 reader:(id /* block */)a3 errorHandler:(id /* block */)a4 handler:(id /* block */)a5;
+ (char)isAIRHeaderExtLoadCommand:(const void *)a0 headerOffset:(unsigned long long *)a1 headerSize:(unsigned long long *)a2 headerSection:(unsigned int *)a3;
