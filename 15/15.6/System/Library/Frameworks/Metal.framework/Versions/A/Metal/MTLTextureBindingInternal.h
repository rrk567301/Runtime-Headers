...
@property (readonly, getter=isDepthTexture) char depthTexture;
...
- (id)initWithName:(id)a0 access:(unsigned long long)a1 isActive:(char)a2 locationIndex:(unsigned long long)a3 arraySize:(unsigned long long)a4 dataType:(unsigned long long)a5 textureType:(unsigned long long)a6 isDepthTexture:(BOOL)a7;
