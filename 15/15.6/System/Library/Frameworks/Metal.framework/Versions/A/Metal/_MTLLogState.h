...
- (char)checkAndGetMessage:(struct MessageHeader { unsigned int x0; unsigned int x1; unsigned int x2; BOOL x3; BOOL x4; } *)a0 logBuffer:(struct LogBuffer { struct LogBufferHeader *x0; char *x1; } *)a1 message:(void *)a2;
- (void)decodeLog;
