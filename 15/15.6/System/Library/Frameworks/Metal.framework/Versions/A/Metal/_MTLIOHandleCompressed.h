...
- (long long)read:(void *)a0 size:(unsigned long long)a1 offset:(unsigned long long)a2 stagingBuffer:(void *)a3 stagingBufferSize:(unsigned long long)a4 needsDecompress:(char *)a5;
...
- (void *)readIntoStagingBuffer:(unsigned long long)a0 offset:(unsigned long long)a1 stagingBuffer:(void *)a2 stagingBufferSize:(unsigned long long)a3 needsDecompress:(char *)a4;
- (unsigned long long)stagingBufferSize:(unsigned long long)a0 offset:(unsigned long long)a1;
- (id)initWithDevice:(id)a0 path:(const char *)a1 compressionType:(long long)a2 error:(id *)a3 uncached:(char)a4;
