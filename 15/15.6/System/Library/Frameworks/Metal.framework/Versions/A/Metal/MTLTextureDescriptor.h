...
@property (nonatomic) char allowGPUOptimizedContents;
...
+ (id)texture2DDescriptorWithPixelFormat:(unsigned long long)a0 width:(unsigned long long)a1 height:(unsigned long long)a2 mipmapped:(char)a3;
...
+ (id)textureCubeDescriptorWithPixelFormat:(unsigned long long)a0 size:(unsigned long long)a1 mipmapped:(char)a2;
