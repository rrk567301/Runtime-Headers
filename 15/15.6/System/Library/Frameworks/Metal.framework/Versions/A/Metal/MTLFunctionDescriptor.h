...
@interface MTLFunctionDescriptor : NSObject <NSCopying> {
    struct MTLFunctionDescriptorPrivate { NSString *name; NSString *specializedName; unsigned long long options; MTLFunctionConstantValues *constantValues; NSArray *binaryArchives; char applyFunctionConstants; NSArray *privateFunctions; } _private;
...
- (id)pluginData;
- (id)privateFunctions;
- (void)setApplyFunctionConstants:(char)a0;
