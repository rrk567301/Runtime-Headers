...
- (void).cxx_destruct;
- (void)openTabInWindow:(id)a0 withURL:(id)a1 makeActiveIfPossible:(char)a2 completionHandler:(id /* block */)a3;
...
- (void)setToolbarItem:(id)a0 isEnabled:(char)a1;
- (void)setToolbarItem:(id)a0 isEnabled:(char)a1 withBadgeText:(id)a2;
