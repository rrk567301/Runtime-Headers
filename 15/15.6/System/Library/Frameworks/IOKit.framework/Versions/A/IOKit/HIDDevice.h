...
- (char)commitElements:(id)a0 direction:(long long)a1 error:(out id *)a2;
- (char)conformsToUsagePage:(long long)a0 usage:(long long)a1;
- (id)elementsMatching:(id)a0;
- (char)getReport:(void *)a0 reportLength:(long long *)a1 withIdentifier:(long long)a2 forType:(long long)a3 error:(out id *)a4;
...
- (char)openWithOptions:(long long)a0 error:(out id *)a1;
- (char)commitElements:(id)a0 direction:(long long)a1 error:(out id *)a2 timeout:(long long)a3 callback:(id /* block */)a4;
- (char)getReport:(void *)a0 reportLength:(long long *)a1 withIdentifier:(long long)a2 forType:(long long)a3 error:(out id *)a4 timeout:(long long)a5 callback:(id /* block */)a6;
- (void)setBatchInputElementHandler:(id /* block */)a0;
- (void)setInputReportHandler:(id /* block */)a0;
- (char)setReport:(const void *)a0 reportLength:(long long)a1 withIdentifier:(long long)a2 forType:(long long)a3 error:(out id *)a4;
- (char)setReport:(const void *)a0 reportLength:(long long)a1 withIdentifier:(long long)a2 forType:(long long)a3 error:(out id *)a4 timeout:(long long)a5 callback:(id /* block */)a6;
- (void)dealloc;
- (id)description;
