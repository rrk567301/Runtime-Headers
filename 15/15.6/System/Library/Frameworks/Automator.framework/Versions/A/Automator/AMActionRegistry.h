...
@property char didLoadAllRegularActions;
@property char didLoadAllConversionActions;
...
- (id)importActionWithURL:(id)a0 replaceExisting:(char)a1 error:(id *)a2;
- (void)incrementUseCountForActionWithBundleIdenifier:(id)a0;
- (id)loadActionWithURL:(id)a0 replaceExisting:(char)a1 error:(id *)a2;
