...
@property char didSwitchToCustomDateFormat;
@property char didSwitchToCustomTimeFormat;
@property char didSwitchToDefinedTimeFormat;
@property char didSwitchToDefinedDateFormat;
@property char useCustomDateFormat;
...
@property (nonatomic) char useCustomTimeFormat;
...
- (void)reLayout;
- (void)setCustomDateFormatControlsAreHidden:(char)a0;
- (void)setCustomTimeFormatControlsAreHidden:(char)a0;
