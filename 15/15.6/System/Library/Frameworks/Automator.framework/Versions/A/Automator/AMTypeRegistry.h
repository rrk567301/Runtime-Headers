...
- (id)_automaticallyGuessedInputTypeForActionInputTypes:(id)a0 allowNothingType:(char)a1;
- (id)_basicTypes;
...
- (id)orderedTypesIncludingApplicationIdentifier:(id)a0 includeNothing:(char)a1 includeUnkown:(char)a2;
