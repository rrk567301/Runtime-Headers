...
- (void)_didPresentPreInstallErrorWithRecovery:(char)a0 contextInfo:(void *)a1;
...
- (void)_layoutWindowWithProgressIndicator:(char)a0 infoField:(char)a1 accessoryView:(char)a2;
