...
- (id)conversionFromUTI:(id)a0 toUTI:(id)a1 ignoreGenericTypes:(char)a2;
...
- (char)doAnyOfTheseTypes:(id)a0 conformToAnyOfTheseTypes:(id)a1;
- (char)doAnyOfTheseTypes:(id)a0 conformToType:(id)a1;
- (char)doesUTIType:(id)a0 conformToAnyOfTheseTypes:(id)a1;
- (char)doesUTIType:(id)a0 conformToUTIType:(id)a1;
