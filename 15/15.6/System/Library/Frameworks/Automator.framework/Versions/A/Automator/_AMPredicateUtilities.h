...
- (id)predicateWithKeyPath:(id)a0 isWithinCount:(unsigned long long)a1 calendarUnits:(unsigned long long)a2 isForPastDate:(char)a3;
- (id)_getDateAtMidnightBeginningTheDayForPredicate:(id)a0;
- (char)_getDatesForPredicate:(id)a0 startDate:(id *)a1 endDate:(id *)a2;
...
- (id)predicateWithKeyPath:(id)a0 isNotWithinCount:(unsigned long long)a1 calendarUnits:(unsigned long long)a2 isForPastDate:(char)a3;
- (id)predicateWithKeyPath:(id)a0 isOnDate:(id)a1;
- (id)predicateWithKeyPath:(id)a0 isOnDayOffsetByCount:(unsigned long long)a1 calendarUnits:(unsigned long long)a2 isForPastDate:(char)a3;
