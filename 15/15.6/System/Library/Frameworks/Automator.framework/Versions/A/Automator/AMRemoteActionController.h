...
- (void)_invalidateRemoteActionWithLock:(id)a0 fromXPCError:(char)a1;
- (id)_remoteActionsForConnection:(id)a0;
- (void)_setNameForConnection:(id)a0 remoteAction:(id)a1;
- (id)_storageForRemoteActionWithLock:(id)a0 creatingIfNeeded:(char)a1;
- (id)_xpcConnectionForRemoteActionWithLock:(id)a0;
- (id)_xpcProxyForRemoteAction:(id)a0 workflowUUID:(id)a1 synchronous:(char)a2 proxyCreationError:(id *)a3 errorHandler:(id /* block */)a4;
- (id)_xpcProxyFromProxyCreatingObject:(id)a0 synchronous:(char)a1 errorHandler:(id /* block */)a2;
- (id)_xpcServiceProxyForRemoteActionWithLock:(id)a0 errorHandler:(id /* block */)a1;
- (id)actionProxyForRemoteAction:(id)a0 workflowUUID:(id)a1 synchronous:(char)a2 proxyCreationError:(id *)a3 errorHandler:(id /* block */)a4;
...
- (char)remoteActionIsRegistered:(id)a0;
- (id)variableControllerProxyForRemoteAction:(id)a0 synchronous:(char)a1 errorHandler:(id /* block */)a2;
