...
@property char ignoreDidResign;
@property char isAnimating;
@property char positionAbove;
@property char positionLeft;
...
@property (readonly, nonatomic) char detailsWindowIsVisible;
