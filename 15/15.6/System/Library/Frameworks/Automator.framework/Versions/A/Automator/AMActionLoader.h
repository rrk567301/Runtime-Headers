...
- (char)_loadBundleIfNeeded:(id)a0 returningClass:(Class *)a1 shouldLoadASOCScripts:(char *)a2 error:(id *)a3;
- (id)resolvedIconURLForActionBundle:(id)a0;
- (char)_appleSignedBundleRequiresOutOfProcessLoaderForNonLoaderProcess:(id)a0;
- (char)_bundleRequiresOutOfProcessActionLoader:(id)a0;
- (char)_bundleRequiresOutOfProcessActionLoaderForCurrentProcess:(id)a0;
- (char)_bundleRequiresOutOfProcessLoaderForAppleSignedProcess:(id)a0;
- (char)_bundleRequiresOutOfProcessLoaderForNonLoaderProcess:(id)a0;
- (char)_validateBundle:(id)a0 error:(id *)a1;
...
- (char)blacklistAllowsLoadingOfActionWithIdentifier:(id)a0;
- (id)bundleForActionWithPropertyList:(id)a0;
- (id)bundleForActionWithURL:(id)a0 error:(id *)a1;
- (char)bundleShouldBeTreatedAsThirdParty:(id)a0;
