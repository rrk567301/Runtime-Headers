...
@property (readonly, nonatomic, getter=isLeafGroup) char leafGroup;
...
@property char useSmallIcon;
@property (getter=isReadOnly, setter=setReadOnly:) char readOnly;
@property (getter=isExpanded, setter=setIsExpanded:) char expanded;
...
- (char)containsAssetWithIdentifier:(id)a0;
