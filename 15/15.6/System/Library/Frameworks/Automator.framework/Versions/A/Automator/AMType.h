...
@property (readonly, nonatomic) char isCustomApplicationType;

+ (char)headerInputTypes:(id)a0 haveConnectionToActionInputTypes:(id)a1 conservativeConversionOnly:(char)a2 returningLength:(unsigned long long *)a3;
