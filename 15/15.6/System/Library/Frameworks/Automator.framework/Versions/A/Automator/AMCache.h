...
@property char didLoadAllActions;
...
- (id)_cacheLocationEntriesFromCacheFileURL:(id)a0 expectedActionLocationURLs:(id)a1 shouldDirtyCache:(char *)a2;
...
- (id)_validCacheLocationEntriesFromCacheFileURL:(id)a0 expectedActionLocationURLs:(id)a1 shouldDirtyCache:(char *)a2;
- (char)_writeCacheFileForLocationEntries:(id)a0 toURL:(id)a1 error:(id *)a2;
...
- (char)validateCacheFileData:(id)a0 error:(id *)a1;
