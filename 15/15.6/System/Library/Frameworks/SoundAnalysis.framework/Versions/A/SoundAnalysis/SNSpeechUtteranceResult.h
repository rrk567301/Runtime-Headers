...
@interface SNSpeechUtteranceResult : NSObject <SNResult, NSCopying, NSSecureCoding, SNTimeRangeProviding, SNConfidenceProviding> {
...
@property (nonatomic) char detected;
