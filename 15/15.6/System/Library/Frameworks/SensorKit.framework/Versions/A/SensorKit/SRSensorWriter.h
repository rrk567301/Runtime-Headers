...
@property char requestNewSegmentInFlight;
@property char authorized;
@property char connectionDidInterrupt;
@property char connectionDidInvalidate;
@property (retain) NSXPCConnection *connection;
@property char retryGetMonitoring;
...
- (char)_setSensorConfiguration:(id)a0 continuousTimestamp:(unsigned long long)a1 error:(id *)a2;
- (char)_setSensorConfiguration:(id)a0 error:(id *)a1;
...
- (void)evaluateAuthorizationStateWithNewValue:(char)a0;
- (void)flushDatabase;
...
- (char)provideSample:(id)a0 timestamp:(double)a1 error:(id *)a2;
...
- (char)provideSampleBytes:(const void *)a0 length:(unsigned long long)a1 continuousTimestamp:(unsigned long long)a2 error:(id *)a3;
- (char)provideSampleBytes:(const void *)a0 length:(unsigned long long)a1 error:(id *)a2;
- (void)provideSampleBytes:(const void *)a0 length:(unsigned long long)a1 timestamp:(double)a2;
- (char)provideSampleBytes:(const void *)a0 length:(unsigned long long)a1 timestamp:(double)a2 error:(id *)a3;
- (void)provideSampleData:(id)a0;
- (void)provideSampleData:(id)a0 continuousTimestamp:(unsigned long long)a1;
- (char)provideSampleData:(id)a0 continuousTimestamp:(unsigned long long)a1 error:(id *)a2;
- (char)provideSampleData:(id)a0 error:(id *)a1;
- (void)provideSampleData:(id)a0 timestamp:(double)a1;
- (char)provideSampleData:(id)a0 timestamp:(double)a1 error:(id *)a2;
