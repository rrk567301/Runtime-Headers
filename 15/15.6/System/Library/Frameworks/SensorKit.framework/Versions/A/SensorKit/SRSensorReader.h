...
@property (nonatomic) char bypassHoldingPeriod;
...
+ (void)requestAuthorizationForBundle:(id)a0 sensors:(id)a1 legacyPromptErrorBehavior:(char)a2 withCompletionHandler:(id /* block */)a3;
...
- (void)startRecording;
- (void)stopRecording;
- (char)fetchingRequest:(id)a0 didFetchResult:(id)a1;
- (id)initWithSensor:(id)a0;
- (void)_startRecordingWithSensorConfiguration:(id)a0 completionHandler:(id /* block */)a1;
- (char)_updateAuthorizationStatusWithAuthorizedServices:(id)a0 deniedServices:(id)a1 dataCollectionEnabled:(char)a2 onboardingCompleted:(char)a3 lastModifiedTimes:(id)a4 forBundleIdentifier:(id)a5;
- (char)_updateAuthorizationStatusWithAuthorizedServices:(id)a0 deniedServices:(id)a1 dataCollectionEnabled:(char)a2 onboardingCompleted:(char)a3 lastModifiedTimes:(id)a4 forBundleIdentifier:(id)a5 previousAuthorizationStatus:(long long)a6;
- (void)authorizedServicesDidChange:(id)a0 deniedServices:(id)a1 dataCollectionEnabled:(char)a2 onboardingCompleted:(char)a3 lastModifiedTimes:(id)a4 forBundleIdentifier:(id)a5;
- (id /* block */)createExportDataWithCompletionHandler:(id /* block */)a0;
