...
- (void)listenForAuthorizationUpdates:(char)a0;
...
- (char)sensorHasReaderAuthorization:(id)a0;
- (char)sensorHasReaderAuthorization:(id)a0 forBundleId:(id)a1;
- (char)setAuthorizationForBundleId:(id)a0 service:(id)a1 value:(char)a2;
- (char)setAuthorizationForBundleId:(id)a0 service:(id)a1 value:(char)a2 setOverride:(char)a3;
