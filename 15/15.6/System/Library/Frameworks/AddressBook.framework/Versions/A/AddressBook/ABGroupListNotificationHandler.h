...
- (char)doesExternalNotificationContainGroupChanges:(id)a0;
- (char)doesLocalNotificationContainEmptyAccountsChanges:(id)a0;
- (char)doesLocalNotificationContainGroupChanges:(id)a0;
