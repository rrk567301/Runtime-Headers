...
@property char ignoreOutlineSelectionChanges;
@property char autogeneratedSelectionPending;
...
- (char)handleDeletionOfCuratedEntries:(id)a0;
- (char)canDragEntries:(id)a0;
- (char)canEditEntries:(id)a0;
...
- (char)canDeleteEntries:(id)a0;
- (char)canEditEntry;
- (char)canFindEntriesInSpotlight:(id)a0;
- (char)canMergeSelectedContactsWithMenuItem:(id)a0;
...
- (char)handleDeleteKey:(id)a0;
- (char)handleDeletionOfNonCuratedEntries:(id)a0;
...
- (char)mainListOutlineView:(id)a0 shouldShowExpansionTriangleForItemAtRow:(unsigned long long)a1;
...
- (char)selectEntriesWithUIDs:(id)a0;
- (void)selectEntryIndexes:(id)a0 byExtendingSelection:(char)a1;
...
- (void)setShowsSuggestedEntries:(char)a0;
