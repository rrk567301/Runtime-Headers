...
@property char alignsNameViewTextWithImageMidpoint;
...
@property char shouldAlignLabelWithTopOfValue;
...
@property char allowsLabelRolloverActions;
@property char allowsNoteEditing;
@property char allowsPhotoEditing;
@property char allowsImmediateEditing;
@property char isContentSizeObservable;
