...
- (char)isPoint:(struct CGPoint { double x0; double x1; })a0 inRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)removeItemWithIdentifier:(id)a0;
- (void)selectItemWithIdentifier:(id)a0;
- (void)setTitle:(id)a0 ofItemWithIdentifier:(id)a1;
- (char)trackMouse:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 ofView:(id)a2 untilMouseUp:(char)a3 inColumn:(id)a4;
