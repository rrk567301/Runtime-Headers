...
+ (char)isViewOrDescendentFirstResponder:(id)a0;
...
+ (void)setEnabled:(char)a0 forSegmentWithTag:(long long)a1 onSegmentedControl:(id)a2;
+ (void)setHidden:(char)a0 onView:(id)a1;
+ (void)setHidden:(char)a0 onViews:(id)a1;
