...
- (void)importFiles:(id)a0 showImportConfirmation:(char)a1 ignoresGuardianRestrictions:(char)a2;
...
- (char)canCut;
- (char)canDeleteWithMenuItem:(id)a0;
- (char)canEditSmartGroup;
- (char)canRenameGroupWithMenuItem:(id)a0;
