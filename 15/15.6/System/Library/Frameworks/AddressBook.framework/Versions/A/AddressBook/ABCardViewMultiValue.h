...
- (char)customLabelsSupportedAtIndex:(unsigned long long)a0;
...
- (char)isDuplicateIndex:(unsigned long long)a0;
- (char)isPrivateValueIndex:(unsigned long long)a0;
- (char)isReadOnlyIndex:(unsigned long long)a0;
- (char)isSuggestedIndex:(unsigned long long)a0;
- (char)isValueEmptyAtIndex:(unsigned long long)a0;
