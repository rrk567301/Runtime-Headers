...
- (char)isDateComparison:(long long)a0 forProperty:(id)a1;
- (char)isWithinTimePeriodComparison:(long long)a0 forProperty:(id)a1;
- (char)isYearLessComparison:(long long)a0 forProperty:(id)a1;
...
- (char)propertyIsComposite:(id)a0;
- (char)putPropertyInOtherMenu:(id)a0;
