...
- (id)actionMenuItemsForPersonUniqueId:(id)a0 inAddressBook:(id)a1 property:(id)a2 identifier:(id)a3 value:(id)a4 isSuggested:(char)a5 delegate:(id)a6 item:(id)a7;
- (id)actionMenuItemsForPersonUniqueId:(id)a0 property:(id)a1 identifier:(id)a2 value:(id)a3;
- (id)actionMenuItemsForPersonUniqueId:(id)a0 property:(id)a1 identifier:(id)a2 value:(id)a3 isSuggested:(char)a4 delegate:(id)a5 item:(id)a6;
- (id)actionsForPerson:(id)a0 property:(id)a1 identifier:(id)a2 value:(id)a3 isSuggested:(char)a4 delegate:(id)a5 item:(id)a6;
