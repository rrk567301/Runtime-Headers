...
@property (readonly, nonatomic, getter=isTelephonySupported) char telephonySupported;
...
- (void)faceTimeAvailabilityChanged:(char)a0 forContactIdentifier:(id)a1;
- (id)loggingNameForService:(id)a0;
- (void)makeFaceTimeCallWithContactIdentifier:(id)a0 endpoint:(id)a1 isAudio:(char)a2;
- (void)makeFaceTimeCallWithEndpoint:(id)a0 isAudio:(char)a1;
- (void)messagingAvailabilityChanged:(char)a0 forEndpoint:(id)a1;
...
- (void)telephonyAvailaibilityChanged:(char)a0;
