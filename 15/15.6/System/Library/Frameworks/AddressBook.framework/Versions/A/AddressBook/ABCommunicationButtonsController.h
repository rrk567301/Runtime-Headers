...
+ (char)isIdentifierFromCuratedSource:(id)a0;
...
- (void)adjustStateOfButton:(id)a0 enabled:(char)a1;
...
- (void)faceTimeCommunicationsBridge:(id)a0 faceTimeAvailabilityChaged:(char)a1 forContactWithIdentifier:(id)a2;
...
- (void)handleFaceTimeAudioPressedRightClick:(char)a0;
- (void)handleFaceTimeButtonPressedRightClick:(char)a0;
- (char)hasActionsForActionType:(id)a0;
...
- (char)shouldShowFaceTimeMenuForActionType:(id)a0;
