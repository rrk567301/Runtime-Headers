...
- (char)personList:(id)a0 acceptFilenamesDrop:(id)a1;
- (void)entriesChangedInPersonList:(id)a0;
- (char)personList:(id)a0 acceptGroupsDrop:(id)a1;
- (char)personList:(id)a0 canDeleteContactsWithSender:(id)a1;
- (char)personList:(id)a0 deleteContactsWithSender:(id)a1;
- (char)personList:(id)a0 deleteContactsWithoutConfirmationWithSender:(id)a1;
- (void)personList:(id)a0 didSelectEntries:(id)a1;
- (char)personList:(id)a0 ignoreContactsWithSender:(id)a1;
- (char)personList:(id)a0 rejectContactsWithSender:(id)a1;
...
- (void)setCardEditingMode:(char)a0;
