...
@property (readonly, nonatomic) char fieldsEditable;
...
+ (id)log;
+ (unsigned long long)numberOfLinesInPostalAddress:(id)a0 isEditing:(char)a1;
...
- (id)initWithAddress:(id)a0 textColor:(id)a1 fieldsEditable:(char)a2;
