...
- (void)_drawSelection:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 selected:(char)a1 inView:(id)a2 withRoundedLeftEdges:(int)a3;
