...
@property (nonatomic) char reloadEnabled;
...
@property (readonly, nonatomic) char isSuggestedCardMode;
...
- (id)collectionItems;
- (id)addNewItemForKey:(id)a0 giveFocus:(char)a1;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 allowsScrolling:(char)a1;
- (void)showFirstItem;
- (void)showLastItem;
...
- (char)tabbingOutOfPagedOutViewOfItem:(id)a0;
...
- (void)addItem:(id)a0 sort:(char)a1 animated:(char)a2;
- (void)addNewItem:(id)a0 giveFocus:(char)a1;
- (void)addSeparatorItemAtIndex:(unsigned long long)a0;
- (void)adjustSpacing;
- (void)adjustStackViewSpacingAfterItem:(id)a0;
- (char)allowMultipleValuesForItem:(id)a0;
...
- (void)collectionItemDidChangeHeight:(id)a0 shouldAnimate:(char)a1;
...
- (void)commonInitAllowingScrolling:(char)a0;
- (void)doRemoveItem:(id)a0;
- (char)focusCollectionItem:(id)a0;
...
- (void)setupItemPresentorWithAllowsScrolling:(char)a0;
- (char)shouldShowPrivacyCheckboxForItem:(id)a0;
- (char)shouldUseFittingSizeToCalculateHeight:(id)a0;
