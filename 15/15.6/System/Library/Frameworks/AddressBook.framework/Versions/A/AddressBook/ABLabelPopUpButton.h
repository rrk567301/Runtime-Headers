...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })calcTextRectAndDraw:(char)a0;
- (void)includeCustomLabelItem:(char)a0;
