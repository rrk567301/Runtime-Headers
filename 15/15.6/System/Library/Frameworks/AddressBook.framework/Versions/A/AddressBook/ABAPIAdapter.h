...
@property (nonatomic) char hasCompletionHandler;

+ (id)methodSignatureForSelector:(SEL)a0 protocol:(id)a1;
+ (SEL)modifiedSelectorFromSeletor:(SEL)a0 numberOfArguments:(unsigned long long)a1 hasCompletionHandler:(char)a2;
+ (id)remoteProtocolFromLocalProtocol:(id)a0 localProtocolIsAsync:(char)a1;
