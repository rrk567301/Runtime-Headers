...
- (id)initWithContactStore:(id)a0 contact:(id)a1 imageData:(id)a2 largeImageData:(id)a3 clippingRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 imageType:(id)a5 memojiMetadata:(id)a6 ignoresGuardianRestrictions:(char)a7 shouldSave:(char)a8;
