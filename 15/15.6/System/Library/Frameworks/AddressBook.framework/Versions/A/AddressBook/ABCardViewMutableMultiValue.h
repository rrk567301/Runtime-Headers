...
- (void)setDuplicate:(char)a0 atIndex:(unsigned long long)a1;
- (void)setIsPrivateValue:(char)a0 index:(unsigned long long)a1;
...
- (void)setReadOnly:(char)a0 atIndex:(unsigned long long)a1;
