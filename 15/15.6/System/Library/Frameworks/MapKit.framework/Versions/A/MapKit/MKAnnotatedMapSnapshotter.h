...
- (id)initWithMapItems:(id)a0 camera:(id)a1 mapSize:(struct CGSize { double x0; double x1; })a2 mapType:(unsigned long long)a3 useSnapshotService:(char)a4;
- (id)initWithMapItems:(id)a0 mapSize:(struct CGSize { double x0; double x1; })a1 useSnapshotService:(char)a2;
- (id)initWithMapItems:(id)a0 region:(struct { struct CLLocationCoordinate2D { double x0; double x1; } x0; struct { double x0; double x1; } x1; })a1 mapSize:(struct CGSize { double x0; double x1; })a2 mapType:(unsigned long long)a3 useSnapshotService:(char)a4;
