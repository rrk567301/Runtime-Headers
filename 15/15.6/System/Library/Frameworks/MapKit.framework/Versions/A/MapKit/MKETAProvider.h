...
@property (readonly, nonatomic) char isLikelyToReturnETA;
@property (readonly, nonatomic) char hasFoundDistanceOrETA;
...
- (void)_refreshTimer;
- (char)_shouldUpdateETAForMapView:(id)a0;
- (void)_updateETA;
...
- (void)quickRouteManager:(id)a0 didUpdateETA:(id)a1 error:(id)a2 animated:(char)a3;
