...
@property (readonly, nonatomic, getter=_createdFromRegion) char createdFromRegion;
@property (nonatomic, getter=_maxResultCount, setter=_setMaxResultCount:) long long maxResultCount;
...
- (char)_isValidCoordinateRegion:(struct { struct CLLocationCoordinate2D { double x0; double x1; } x0; struct { double x0; double x1; } x1; })a0;
