...
@property (nonatomic) char needsElevationCorrection;
@property (readonly, nonatomic, getter=_requiresModernMap) char requiresModernMap;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
+ (id)polylineWithCoordinates:(const struct CLLocationCoordinate2D { double x0; double x1; } *)a0 elevations:(const double *)a1 count:(unsigned long long)a2 elevationCorrection:(char)a3;
