...
@property (readonly, nonatomic) char supportsElevation;
@property (readonly, nonatomic) char requiresModernMap;
...
- (long long)_levelForOverlay:(id)a0 exists:(char *)a1;
...
- (char)_overlaySpansGlobeAndReplacesMapContent;
