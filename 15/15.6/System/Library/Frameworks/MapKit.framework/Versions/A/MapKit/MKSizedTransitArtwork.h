...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)badgeImageToDisplayWithScreenScale:(double)a0 nightMode:(char)a1;
- (id)imageToDisplayWithScreenScale:(double)a0 nightMode:(char)a1;
...
- (char)isEqualToTransitArtworkViewMode:(id)a0;
