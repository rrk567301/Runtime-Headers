...
@interface MKLookAroundViewController : NSViewController <MKLookAroundViewDelegate, NSSecureCoding, NSCoding> {
    ...
    char _initialScene;
    char _needsLookAroundViewUpdate;
    char _needsSceneUpdate;
}

@property (class, readonly) char supportsSecureCoding;

@property (nonatomic) char didBecomeFullyDrawn;
@property (nonatomic, getter=_isFullScreenCover, setter=_setFullScreenCover:) char fullScreenCover;
@property (weak, nonatomic) id<MKLookAroundViewControllerDelegate> delegate;
@property (copy, nonatomic) MKLookAroundScene *scene;
@property (nonatomic, getter=isNavigationEnabled) char navigationEnabled;
...
- (void)_setupSubviews;
- (char)_shouldRestrictLookAroundViewOptionsForPreview;
...
- (void)lookAroundView:(id)a0 didTapAtPoint:(struct CGPoint { double x0; double x1; })a1 areaAvailable:(char)a2;
