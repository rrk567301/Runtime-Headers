@class NSArray, NSMutableDictionary, MKUsageCounter, NSColor;
...
@property (readonly, nonatomic, getter=_externalSubclassOverridesDrawingMethods) char externalSubclassOverridesDrawingMethods;
