...
@property (readonly, nonatomic, getter=_alreadySentFeedback) char alreadySentFeedback;
...
@property (readonly, nonatomic) char hasSortPriority;
...
@property (readonly, nonatomic) char hasQueryAcceleratorAffordanceEnabled;
...
@property (readonly, nonatomic, getter=_hasDisambiguationRadiusMeters) char hasDisambiguationRadiusMeters;
@property (readonly, nonatomic, getter=_disambiguationRadiusMeters) float disambiguationRadiusMeters;
@property (readonly, nonatomic, getter=_supportsOfflineDownload) char supportsOfflineDownload;
...
- (id)icon;
- (id)calloutTitle;
- (char)getCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; } *)a0;
