...
- (void)cancel;
- (id)extension;
- (void)_connectExtensionWithRemoteViewControllerNeeded:(char)a0 Handler:(id /* block */)a1;
- (void)connectExtensionWithHandler:(id /* block */)a0;
- (void)connectExtensionWithRemoteViewControllerNeeded:(char)a0 Handler:(id /* block */)a1;
