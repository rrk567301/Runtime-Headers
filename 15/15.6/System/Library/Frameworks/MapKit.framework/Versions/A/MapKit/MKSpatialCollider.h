...
- (id)viewsCollidingWithAnnotationView:(id)a0 inCollidableList:(char)a1;
- (id)viewsCollidingWithAnnotationView:(id)a0 inCollidableList:(char)a1 fromIndex:(long long)a2 length:(double)a3;
