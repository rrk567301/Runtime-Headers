@class MKPointOfInterestFilter, _MKLocalSearchExternalTransitLookupParameters, NSArray, NSString, CLLocation, _MKLocalSearchMerchantParameters, MKAddressFilter;
...
@property (nonatomic) char hasSentFeedbackForCompletion;
...
@property (nonatomic, getter=_allowPhoneNumberLookupUsingCellular, setter=_setAllowPhoneNumberLookupUsingCellular:) char allowPhoneNumberLookupUsingCellular;
