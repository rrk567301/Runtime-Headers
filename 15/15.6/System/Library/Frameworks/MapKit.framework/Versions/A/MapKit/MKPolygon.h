...
@interface MKPolygon : MKMultiPoint <MKGeoJSONObject, NSSecureCoding, MKOverlay> {
    ...
    struct GEOOnce_s { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; char didRun; } _determinedSimple;
}
...
@property (readonly, nonatomic, getter=_isSimple) char simple;
