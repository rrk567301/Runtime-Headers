...
@property (nonatomic) char suppressCallout;
...
@property (readonly, nonatomic) struct { long long x0; struct CLLocationCoordinate2D { double x0; double x1; } x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; id x4; char x5; } currentComparisonContext;
...
- (id)_annotationViewForSelectionAtPoint:(struct CGPoint { double x0; double x1; })a0 avoidCurrent:(char)a1 maxDistance:(double)a2;
- (void)_draggingAnnotationViewDidPause:(id)a0;
- (void)_dropDraggingAnnotationViewAnimated:(char)a0;
- (void)_dropPinsIfNeeded:(char)a0;
...
- (char)_updateAnnotationViews:(id)a0;
- (void)_updateAnnotationViewsForReason:(long long)a0 updatePositions:(char)a1;
...
- (char)_view:(id)a0 containsPoint:(struct CGPoint { double x0; double x1; })a1;
...
- (char)accessoryContainsPoint:(struct CGPoint { double x0; double x1; })a0;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })accessoryPadding;
- (void)addAnnotationView:(id)a0 allowAnimation:(char)a1;
- (void)annotationViewDidChangeDisplayPriority:(id)a0;
...
- (void)deselectAnnotationView:(id)a0 animated:(char)a1;
- (struct CGPoint { double x0; double x1; })draggingAnnotationViewDropPointForPoint:(struct CGPoint { double x0; double x1; })a0;
- (void)draggingTouchMovedToPoint:(struct CGPoint { double x0; double x1; })a0 edgeInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1;
...
- (void)pinDidDrop:(id)a0 animated:(char)a1;
...
- (void)selectAnnotationView:(id)a0 animated:(char)a1;
- (void)setAnnotationViewsRotationRadians:(double)a0 animation:(id)a1;
- (void)setMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; char x5; })a0;
