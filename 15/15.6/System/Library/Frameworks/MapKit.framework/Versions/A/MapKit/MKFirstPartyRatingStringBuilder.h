...
+ (id)_stringForPercentage:(double)a0;
+ (id)carPlayHeaderStringForMapItem:(id)a0 titleAttributes:(id)a1 providerAttributes:(id)a2;
+ (id)compactUserRecommendedRatingSummaryStringForMapItem:(id)a0;
+ (id)percentageStringForMapItem:(id)a0 showNumberOfRatings:(char)a1 textColor:(id)a2 font:(id)a3 theme:(id)a4;
...
+ (id)ratingStringForPercentage:(double)a0 font:(id)a1 color:(id)a2 includeGlyph:(char)a3;
+ (id)ratingSummaryAttributedStringForMapItem:(id)a0 textColor:(id)a1 font:(id)a2 theme:(id)a3;
+ (id)ratingSymbolName;
+ (id)thumbRecommendStringWithMapItem:(id)a0 font:(id)a1 includeGlyph:(char)a2;
