...
- (void)removeAnnotation:(id)a0 updateVisible:(char)a1;
- (id)addRepresentationForAnnotation:(id)a0;
- (void)_addAnnotation:(id)a0 updateVisible:(char)a1;
- (id)_addRepresentationForAnnotation:(id)a0;
- (void)_annotationDidChangeState:(id)a0 animated:(char)a1;
- (void)_removeAnnotation:(id)a0 updateVisible:(char)a1 removeFromContainer:(char)a2;
- (void)_removeRepresentationForAnnotation:(id)a0 fromCull:(char)a1;
- (void)_setupUpdateVisibleAnnotationsTimer;
- (void)addAnnotation:(id)a0 allowAnimation:(char)a1;
- (void)addRepresentationsForAnnotations:(id)a0;
- (char)annotationIsInternal:(id)a0;
...
- (void)deselectAnnotation:(id)a0 animated:(char)a1;
...
- (void)selectAnnotation:(id)a0 animated:(char)a1;
