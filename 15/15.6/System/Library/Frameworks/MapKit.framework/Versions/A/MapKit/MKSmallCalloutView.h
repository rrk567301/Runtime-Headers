...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 metrics:(struct { double x0; double x1; double x2; double x3; char x4; union { struct { double x0; double x1; } x0; struct { double x0; double x1; } x1; } x5; char x6; char x7; struct NSEdgeInsets { double x0; double x1; double x2; double x3; } x8; })a1;
- (void)setCalloutSubtitle:(id)a0 animated:(char)a1;
- (void)setDetailView:(id)a0 animated:(char)a1;
- (void)setLeftView:(id)a0 animated:(char)a1;
