...
@property (nonatomic, getter=_showsNightMode, setter=_setShowsNightMode:) char showsNightMode;
@property (nonatomic, getter=_showsVenues, setter=_setShowsVenues:) char showsVenues;
@property (nonatomic, getter=_showsRoadLabels, setter=_setShowsRoadLabels:) char showsRoadLabels;
@property (nonatomic, getter=_showsRoadShields, setter=_setShowsRoadShields:) char showsRoadShields;
@property (nonatomic, getter=_showsPointLabels, setter=_setShowsPointLabels:) char showsPointLabels;
@property (nonatomic, getter=_allowsSimultaneousLightDarkSnapshots, setter=_setAllowsSimultaneousLightDarkSnapshots:) char allowsSimultaneousLightDarkSnapshots;
@property (nonatomic, getter=_cartographicConfiguration, setter=_setCartographicConfiguration:) struct { long long x0; long long x1; long long x2; long long x3; long long x4; long long x5; char x6; } cartographicConfiguration;
@property (nonatomic, getter=_showsAppleLogo, setter=_setShowsAppleLogo:) char showsAppleLogo;
...
- (char)_overlaysRequireModernMap;
- (char)_overlaysSupportElevation;
- (void)_prepareToSubmit;
- (void)_removeCameraKVO;
- (struct { long long x0; long long x1; long long x2; long long x3; long long x4; long long x5; char x6; })_resolvedCartographicConfigurationWithAuditToken:(id)a0;
...
- (void)setShowsPointsOfInterest:(char)a0;
