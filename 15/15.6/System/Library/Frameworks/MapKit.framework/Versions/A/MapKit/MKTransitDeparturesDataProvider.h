...
@property (readonly, nonatomic, getter=isRefreshing) char refreshing;
@property (readonly, copy, nonatomic) NSString *lastInfoRefreshErrorDescription;
@property (readonly, nonatomic) char isStuckWithExpiredInfo;
...
- (id)_directionsForSystem:(id)a0 hasSequencesWithNoDirection:(out char *)a1;
...
- (char)_isSectionTypeEnabled:(long long)a0;
...
- (char)_systemHasInactiveLines:(id)a0;
...
- (char)isHidingDeparturesForSystem:(id)a0;
- (char)isLastSectionForSystem:(id)a0;
