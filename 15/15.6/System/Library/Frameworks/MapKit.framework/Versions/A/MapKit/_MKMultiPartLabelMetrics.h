...
- (void).cxx_destruct;
- (void)reset;
- (char)_shiftLocationOfStrings:(id)a0 startingAtIndex:(unsigned long long)a1 shiftValue:(long long)a2;
- (id)initWithMultiPartString:(id)a0;
- (char)replaceSeparatorAtIndex:(unsigned long long)a0 withString:(id)a1;
