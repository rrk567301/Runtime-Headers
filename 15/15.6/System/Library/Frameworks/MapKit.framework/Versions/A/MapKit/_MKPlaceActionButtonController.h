...
+ (id)actionButtonControllerWithTitle:(id)a0 subTitle:(id)a1 selectedBlock:(id /* block */)a2 disabled:(char)a3 symbolName:(id)a4;

- (void).cxx_destruct;
- (void)buttonTextChanged;
- (id)infoCardChildPossibleActions;
- (id)infoCardChildUnactionableUIElements;
- (id)initWithTitle:(id)a0 subTitle:(id)a1 analyticsAction:(int)a2 selectedBlock:(id /* block */)a3 disabled:(char)a4 symbolName:(id)a5;
