...
@property (nonatomic, getter=_showingPreciseAuthorizedLocation, setter=_setShowingPreciseAuthorizedLocation:) char showingPreciseAuthorizedLocation;
...
@property (readonly, nonatomic, getter=_balloonCalloutShouldShowArrow) char balloonCalloutShouldShowArrow;
@property (readonly, nonatomic, getter=_balloonCalloutShouldCenterWhenOffscreen) char balloonCalloutShouldCenterWhenOffscreen;
