...
@property (nonatomic) char wantsCloseUpView;
...
+ (id)entryPointWithMapItem:(id)a0 isMarkedLocation:(char)a1 wantsCloseUpView:(char)a2 cameraFrameOverride:(id)a3 triggerAction:(int)a4;
+ (id)entryPointWithMapItem:(id)a0 triggerAction:(int)a1;
+ (id)entryPointWithMapItem:(id)a0 wantsCloseUpView:(char)a1;
+ (id)entryPointWithMapItem:(id)a0 wantsCloseUpView:(char)a1 cameraFrameOverride:(id)a2;
+ (id)entryPointWithMapItem:(id)a0 wantsCloseUpView:(char)a1 triggerAction:(int)a2;
...
+ (id)entryPointWithScene:(id)a0 wantsCloseUpView:(char)a1;
