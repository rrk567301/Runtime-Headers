...
@property (nonatomic) char lastInfoRefreshFailed;
@property (nonatomic, getter=isRefreshing) char refreshing;
...
- (char)_isInfoExpiredRelativeToDate:(id)a0;
...
- (char)isStuckWithExpiredInfoRelativeToDate:(id)a0;
