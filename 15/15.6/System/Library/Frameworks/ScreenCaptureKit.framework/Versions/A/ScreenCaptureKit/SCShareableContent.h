...
+ (void)fetchShareableContentWithOption:(unsigned int)a0 windowID:(unsigned int)a1 currentProcess:(char)a2 transactionID:(id)a3 completionHandler:(id /* block */)a4;
...
+ (void)getShareableContentExcludingDesktopWindows:(char)a0 onScreenWindowsOnly:(char)a1 completionHandler:(id /* block */)a2;
+ (void)getShareableContentExcludingDesktopWindows:(char)a0 onScreenWindowsOnlyAboveWindow:(id)a1 completionHandler:(id /* block */)a2;
+ (void)getShareableContentExcludingDesktopWindows:(char)a0 onScreenWindowsOnlyBelowWindow:(id)a1 completionHandler:(id /* block */)a2;
