...
@property (nonatomic) char preseveAspectRatio;
...
+ (void)legacyStreamDidStart:(char)a0 withAuditToken:(struct { unsigned int x0[8]; })a1;
...
- (void)dealloc;
- (void).cxx_destruct;
- (char)addStreamOutput:(id)a0 type:(long long)a1 sampleHandlerQueue:(id)a2 error:(id *)a3;
...
- (char)removeStreamOutput:(id)a0 type:(long long)a1 error:(id *)a2;
- (void)updateStream:(id)a0 withClientOutputType:(unsigned long long)a1;
- (id)serializedRecordingOutputConfig;
- (char)addRecordingOutput:(id)a0 error:(id *)a1;
...
- (id)initWithSharingSession:(id)a0 excluding:(id)a1 updateMetadata:(char)a2 captureOutputProperties:(id)a3 delegate:(id)a4;
- (void)removeCurrentRecordingOutputError:(id *)a0;
- (char)removeRecordingOutput:(id)a0 error:(id *)a1;
...
- (char)validateStreamConfiguration;
