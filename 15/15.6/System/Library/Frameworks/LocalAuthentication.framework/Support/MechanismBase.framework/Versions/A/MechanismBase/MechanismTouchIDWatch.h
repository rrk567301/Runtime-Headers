...
- (void).cxx_destruct;
- (char)_runTouchIDWithHints:(id)a0 eventsDelegate:(id)a1;
...
- (id)initWithSubmechanisms:(id)a0 isAND:(char)a1 request:(id)a2;
...
- (void)restartWithEventIdentifier:(long long)a0 lastAttempt:(char)a1;
