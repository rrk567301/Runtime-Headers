...
- (void)_replyOnceToShowUi:(char)a0 error:(id)a1;
...
- (void)dismissRemoteUI:(id)a0 uiMechanism:(id)a1 uiDisappeared:(char)a2 shouldIdle:(char)a3 reply:(id /* block */)a4;
