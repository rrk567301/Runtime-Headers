...
+ (char)error:(id)a0 hasCode:(long long)a1;
+ (char)error:(id)a0 hasCode:(long long)a1 subcode:(long long)a2;
...
+ (char)storageError:(id)a0 hasCode:(long long)a1;
...
+ (char)error:(id)a0 hasCodeFromArray:(id)a1;
