...
- (id)_cancelationErrorWithDescription:(id)a0 cancelledByHigherPriority:(char)a1;
...
- (char)canStartAuthenticationWithPolicy:(long long)a0 options:(id)a1;
- (void)cancelWithError:(id)a0 originatorId:(unsigned long long)a1 reply:(id /* block */)a2;
- (id)findMechanismForEvent:(long long)a0 mustBeRunning:(char)a1 plugin:(id)a2;
