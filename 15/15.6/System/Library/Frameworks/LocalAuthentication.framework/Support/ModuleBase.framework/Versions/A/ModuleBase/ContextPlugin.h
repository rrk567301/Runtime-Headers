...
@property (readonly, nonatomic) char contextOwner;
...
- (void)pauseProcessedEvent:(long long)a0 pause:(char)a1 reply:(id /* block */)a2;
...
- (id)createInternalInfo:(id)a0 skipCallerIdentification:(char)a1 callerBundleId:(id)a2 request:(id)a3 originator:(id)a4;
...
- (id)initWithContextOwner:(char)a0 underlyingPtr:(void *)a1 moduleRef:(id)a2;
...
- (void)setShowingCoachingHint:(char)a0 event:(long long)a1 originator:(id)a2 reply:(id /* block */)a3;
