...
@property (nonatomic) char interactionNotAllowed;
...
- (char)canEvaluatePolicy:(long long)a0 error:(id *)a1;
...
- (char)isCredentialSet:(long long)a0;
- (char)setCredential:(id)a0 type:(long long)a1;
- (id)optionCallerPID;
- (id)optionPINLength;
- (id)optionTintColor;
...
- (void)_evaluateAccessControl:(struct __SecAccessControl { } *)a0 operation:(id)a1 options:(id)a2 log:(long long)a3 cid:(unsigned int)a4 synchronous:(char)a5 reply:(id /* block */)a6;
- (id)_evaluatePolicy:(long long)a0 options:(id)a1 log:(long long)a2 cid:(unsigned int)a3 error:(id *)a4;
- (void)_evaluatePolicy:(long long)a0 options:(id)a1 log:(long long)a2 cid:(unsigned int)a3 synchronous:(char)a4 reply:(id /* block */)a5;
- (void)_evaluatePolicy:(long long)a0 options:(id)a1 synchronous:(char)a2 reply:(id /* block */)a3;
...
- (char)_setCredential:(id)a0 type:(long long)a1 log:(long long)a2 cid:(unsigned int)a3 error:(id *)a4;
...
- (char)_useModernAuthorizationSheet;
...
- (char)canEvaluateCorePolicy:(long long)a0 error:(id *)a1;
- (void)checkCanEvaluateRight:(id)a0 reply:(id /* block */)a1;
- (char)checkContextValidWithError:(id *)a0;
...
- (char)setCoreCredential:(id)a0 type:(long long)a1 error:(id *)a2;
...
- (char)setCredential:(id)a0 type:(long long)a1 error:(id *)a2;
...
- (void)setShowingCoachingHint:(char)a0 event:(long long)a1 reply:(id /* block */)a2;
- (char)verifyFileVaultUser:(id)a0 volumeUuid:(id)a1 options:(unsigned long long)a2 error:(id *)a3;
