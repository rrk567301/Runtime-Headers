...
@property (readonly, nonatomic) char isFeatureEnabled;
@property (readonly, nonatomic) char isFeatureSupported;
@property (readonly, nonatomic) char isFeatureAvailable;
@property (readonly, nonatomic) char isFeatureStrictModeEnabled;
@property (readonly, nonatomic) char isSensorTrusted;
@property (readonly, nonatomic) LARatchetState *ratchetState;
@property (readonly, nonatomic) char isRatchetFeatureEnabled;
