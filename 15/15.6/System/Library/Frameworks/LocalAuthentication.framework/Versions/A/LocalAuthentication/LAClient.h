...
@property char shouldRecoverConnection;
@property char willRetryOnInterruptedConnection;
...
+ (id)_queue;
+ (id)createConnection:(const unsigned int *)a0 legacyService:(char)a1;
...
- (void)_checkIdResultForTCC:(id)a0 synchronous:(char)a1 error:(id)a2 retryBlock:(id /* block */)a3 finally:(id /* block */)a4;
- (void)_connectToServerWithRecovery:(char)a0 userSession:(const unsigned int *)a1 legacyService:(char)a2;
...
- (void)_performSynchronous:(char)a0 callBool:(id /* block */)a1 finally:(id /* block */)a2;
- (void)_performSynchronous:(char)a0 callId:(id /* block */)a1 finally:(id /* block */)a2;
- (void)_recoverConnectionIfNeeded;
- (void)_scheduleRecovery;
- (void)_serializedInvalidateWithMessage:(id)a0;
- (char)_setPermanentError:(id)a0;
...
- (void)evaluateACL:(id)a0 operation:(id)a1 options:(id)a2 uiDelegate:(id)a3 synchronous:(char)a4 reply:(id /* block */)a5;
- (void)evaluatePolicy:(long long)a0 options:(id)a1 uiDelegate:(id)a2 reply:(id /* block */)a3;
- (void)evaluatePolicy:(long long)a0 options:(id)a1 uiDelegate:(id)a2 synchronous:(char)a3 reply:(id /* block */)a4;
...
- (void)getDomainStateWithOptions:(id)a0 synchronous:(char)a1 reply:(id /* block */)a2;
...
- (char)setServerPropertyForOption:(long long)a0 value:(id)a1 error:(id *)a2;
