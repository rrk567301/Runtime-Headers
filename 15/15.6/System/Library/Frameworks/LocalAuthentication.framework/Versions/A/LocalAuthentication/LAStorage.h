...
- (char)setData:(id)a0 forKey:(long long)a1 error:(id *)a2;
...
- (char)boolForKey:(long long)a0 error:(id *)a1;
...
- (void)setBool:(char)a0 forKey:(long long)a1 completionHandler:(id /* block */)a2;
- (char)setBool:(char)a0 forKey:(long long)a1 error:(id *)a2;
...
- (char)setDictionary:(id)a0 forKey:(long long)a1 error:(id *)a2;
