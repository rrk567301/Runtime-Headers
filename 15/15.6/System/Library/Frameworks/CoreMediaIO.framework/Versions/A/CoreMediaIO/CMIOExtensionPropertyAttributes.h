...
+ (id)propertyAttributesWithMinValue:(id)a0 maxValue:(id)a1 validValues:(id)a2 readOnly:(char)a3;
...
- (id)initWithMinValue:(id)a0 maxValue:(id)a1 validValues:(id)a2 readOnly:(char)a3;
