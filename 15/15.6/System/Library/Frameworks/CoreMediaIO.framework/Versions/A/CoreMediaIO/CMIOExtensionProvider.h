...
@interface CMIOExtensionProvider : NSObject {
    ...
    char _nonStreamingProxyFrontedExtensionPIDsHasChanged;
...
+ (void)stopServiceWithProvider:(id)a0;
...
- (void)_clientQueue_startStreamForClientID:(id)a0 streamID:(id)a1 requestAudio:(char)a2 requestVideo:(char)a3 reply:(id /* block */)a4;
- (void)_performDeferredStreamStartsForClient:(id)a0 streamID:(id)a1 requestVideo:(char)a2 requestAudio:(char)a3;
- (char)addDevice:(id)a0 error:(id *)a1;
...
- (char)registerDevice:(id)a0 error:(id *)a1;
- (char)registerStream:(id)a0 withDeviceID:(id)a1 error:(id *)a2;
...
- (char)unregisterDevice:(id)a0 error:(id *)a1;
- (char)unregisterStream:(id)a0 withDeviceID:(id)a1 notify:(char)a2 error:(id *)a3;
