...
- (id)_securityImplementationForSender:(id)a0 completionHandler:(id /* block */)a1 isStatus:(char)a2;
- (id)_wrappedErrorForError:(id)a0 extensionIdentifier:(id)a1 isErrorHandler:(char)a2;
