...
@property (readonly) char bodyAccess;
@property (readonly) char hasMessageContentAccess;
...
@property (nonatomic, setter=setEnabled:) char isEnabled;
@property (readonly, nonatomic) NSArray *capabilities;
@property (readonly, nonatomic) char outboundNetworkingAllowed;
@property (readonly, nonatomic) char inboundNetworkingAllowed;
