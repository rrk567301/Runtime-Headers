...
@interface MEAppExtensionsController : NSObject {
    ...
    char _areRemoteExtensionsFetched;
}
...
- (void)registerMailAppExtensionsObserver:(id)a0 capabilities:(id)a1 includeDisabled:(char)a2 completion:(id /* block */)a3;
- (char)hasSecurityExtensionsEnabled;
- (char)_extension:(id)a0 matchesCapabilities:(id)a1;
- (char)_extension:(id)a0 matchesCriteria:(id)a1;
- (char)_extension:(id)a0 matchesOldCriteria:(id)a1;
...
- (id)_remoteEmailExtensionsForExtensions:(id)a0 enabledOnly:(char)a1;
