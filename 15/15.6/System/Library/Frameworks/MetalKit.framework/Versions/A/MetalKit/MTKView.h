...
@property (nonatomic) char autoResizeDrawable;
...
- (const id *)colorTexturesForceUpdate:(char)a0;
- (void)createDepthStencilTexture;
- (unsigned long long)drawNumber;
- (unsigned long long)drawableAttachmentIndex;
- (char)exportToTargaAtLocation:(id)a0 width:(unsigned long long)a1 height:(unsigned long long)a2 size:(unsigned long long)a3 bytes:(void *)a4;
...
- (const id *)multisampleColorTexturesForceUpdate:(char)a0;
