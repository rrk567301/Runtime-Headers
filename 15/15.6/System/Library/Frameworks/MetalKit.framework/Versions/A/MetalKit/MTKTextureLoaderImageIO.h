...
@interface MTKTextureLoaderImageIO : MTKTextureLoaderData {
    ...
    NSData *_imageData;
    char _expandRGBToRGBA;
}

- (void)dealloc;
- (id)initWithData:(id)a0 options:(id)a1 error:(id *)a2;
- (char)decodeCGImage:(struct CGImage { } *)a0 options:(id)a1;
- (char)decodeCGImageDataProvider:(struct CGImage { } *)a0 options:(id)a1;
- (char)decodeCGImageImageProvider:(struct CGImage { } *)a0 CGImageProvider:(struct CGImageProvider { } *)a1 options:(id)a2;
- (char)determineCGImageBlockFormatWithComponentType:(int)a0 alphaInfo:(unsigned int)a1 andPixelSizeBytes:(unsigned long long)a2 andColorSpace:(struct CGColorSpace { } *)a3 isOptimized:(char)a4 options:(id)a5;
