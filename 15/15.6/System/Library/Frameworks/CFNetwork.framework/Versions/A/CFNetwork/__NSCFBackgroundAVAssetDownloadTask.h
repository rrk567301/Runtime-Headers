...
@interface __NSCFBackgroundAVAssetDownloadTask : __NSCFBackgroundSessionTask {
    ...
    char _didCleanupProgress;
    char _enableSPIDelegateCallbacks;
...
- (id)currentRequest;
- (id)initWithTaskGroup:(id)a0 URLAsset:(id)a1 URL:(id)a2 destinationURL:(id)a3 temporaryDestinationURL:(id)a4 assetTitle:(id)a5 assetArtworkData:(id)a6 ident:(unsigned long long)a7 enableSPIDelegateCallbacks:(char)a8;
