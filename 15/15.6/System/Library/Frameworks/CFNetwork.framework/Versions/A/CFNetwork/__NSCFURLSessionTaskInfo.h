...
@property char resumedAndWaitingForEarliestBeginDate;
@property char respondedToWillBeginDelayedRequestCallback;
...
@property char expectingResumeCallback;
@property char establishedConnection;
@property unsigned long long retryCount;
@property unsigned long long lowThroughputTimerRetryCount;
@property char disablesRetry;
@property char shouldCancelOnDisconnect;
@property long long basePriority;
@property char basePrioritySetExplicitly;
...
@property char mayBeDemotedToDiscretionary;
...
@property (readonly, nonatomic) char _hasSZExtractor;
@property (readonly, nonatomic) char _doesSZExtractorConsumeExtractedData;
@property (nonatomic) char _updatedStreamingZipModificationDate;
@property char startedUserInitiated;
...
- (id)initWithAVAggregateDownloadTaskNoChildTaskKindWithURL:(id)a0 destinationURL:(id)a1 assetTitle:(id)a2 assetArtworkData:(id)a3 options:(id)a4 taskIdentifier:(unsigned long long)a5 uniqueIdentifier:(id)a6 bundleID:(id)a7 sessionID:(id)a8 enableSPIDelegateCallbacks:(char)a9;
