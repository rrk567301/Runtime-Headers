...
+ (void)_setCollectsTimingData:(char)a0;
...
- (id)_cfInternal;
- (id)_initWithRequest:(id)a0 delegate:(id)a1 usesCache:(char)a2 maxContentLength:(long long)a3 startImmediately:(char)a4 connectionProperties:(id)a5;
- (void)_resumeLoading;
- (id)_timingData;
