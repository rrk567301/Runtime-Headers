...
- (id)_siteForCookies;
- (id)_trackerContext;
- (void)set_allowsQUIC:(char)a0;
- (void)set_preconnect:(char)a0;
- (id)_APSRelayTopic;
...
- (void)set_appSSOFallback:(char)a0;
- (void)set_connectionIsCompanionLink:(char)a0;
- (void)set_discretionaryOverride:(long long)a0;
- (void)set_expectedProgressTarget:(unsigned long long)a0;
- (void)set_preventsAppSSO:(char)a0;
- (void)set_protocolForTask:(id)a0;
- (void)set_proxyHandshakePending:(char)a0;
