...
- (void)_onqueue_addBlockOp:(id /* block */)a0 description:(const char *)a1 shouldWaitForTls:(char)a2;
...
- (char)_onqueue_sendSessionChallenge:(id)a0 completionHandler:(id /* block */)a1;
