...
- (void)_conditionalRequirementsChanged:(char)a0;
- (void)_didFinishWithError:(id)a0;
- (void)_didReceiveChallenge:(id)a0;
- (void)_didReceiveData:(id)a0;
- (void)_didReceiveInformationalResponse:(id)a0;
- (void)_didReceiveResponse:(id)a0 sniff:(char)a1;
...
- (void)_needNewBodyStreamFromOffset:(long long)a0;
