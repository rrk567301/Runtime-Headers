...
@property (readonly, nonatomic, getter=isSandboxSafe) char sandboxSafe;
@property (readonly, nonatomic) char hasMIDIInput;
@property (readonly, nonatomic) char hasMIDIOutput;
...
@property (readonly, nonatomic) char passesAUVal;
@property (readonly, nonatomic) char hasCustomView;
...
- (char)isComponentDescriptionMatch:(struct AudioComponentDescription { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })a0;
- (char)supportsNumberInputChannels:(long long)a0 outputChannels:(long long)a1;
- (char)validateWithResults:(id)a0 inCompletionHandler:(id /* block */)a1;
