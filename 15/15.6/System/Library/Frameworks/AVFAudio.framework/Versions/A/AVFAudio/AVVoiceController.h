...
- (char)prepareRecordForStream:(id)a0 error:(id *)a1;
- (unsigned long long)setContext:(id)a0 streamType:(long long *)a1 error:(id *)a2;
- (void)setRecordDelegate:(id)a0;
- (char)startRecordForStream:(id)a0 error:(id *)a1;
- (char)stopRecordForStream:(unsigned long long)a0 error:(id *)a1;
- (void)teardownWithError:(id *)a0;
- (char)updateMeterForStream:(unsigned long long)a0;
...
- (id)recordDelegate;
- (char)activateAudioSessionForStream:(unsigned long long)a0 isPrewarm:(char)a1 recordMode:(char)a2 error:(id *)a3;
- (char)configureAlertBehaviorForStream:(id)a0 error:(id *)a1;
- (char)playAlertSoundForType:(int)a0 overrideMode:(long long)a1;
- (char)setAlertSoundFromURL:(id)a0 forType:(int)a1;
- (char)IsDeviceAvailableInLocalRoute:(id)a0 error:(id *)a1;
...
- (char)activateAudioSessionForStream:(unsigned long long)a0 isPrewarm:(char)a1 error:(id *)a2;
...
- (char)enableSmartRoutingConsiderationForStream:(unsigned long long)a0 enable:(char)a1 error:(id *)a2;
- (void)enableTriangleModeForStream:(unsigned long long)a0 enable:(char)a1 withCompletion:(id /* block */)a2;
...
- (char)isDuckingSupportedOnPickedRouteForStream:(unsigned long long)a0 error:(id *)a1;
- (char)isMeteringEnabledForStream:(unsigned long long)a0;
...
- (char)setAnnounceCallsEnabledForStream:(unsigned long long)a0 enable:(char)a1;
- (char)setContextForStream:(id)a0 forStream:(unsigned long long)a1 error:(id *)a2;
- (char)setDuckOthersForStream:(unsigned long long)a0 withSettings:(id)a1 error:(id *)a2;
- (char)setEnableInterruptionByRecordingClientsForStream:(unsigned long long)a0 enable:(char)a1 error:(id *)a2;
- (char)setRecordModeForStream:(unsigned long long)a0 recordMode:(long long)a1 error:(id *)a2;
