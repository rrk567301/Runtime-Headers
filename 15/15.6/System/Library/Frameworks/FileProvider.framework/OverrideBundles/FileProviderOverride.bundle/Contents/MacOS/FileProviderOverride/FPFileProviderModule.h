...
- (void)FPFileProviderServiceEndpointCreatingWithName:(id)a0 itemAtURL:(id)a1 synchronously:(char)a2 completionHandler:(id /* block */)a3;
- (char)FPSetValue:(id)a0 forAttribute:(id)a1 onItemAtURL:(id)a2 error:(id *)a3;
...
- (void)FPFileProviderServiceEndpointCreatingForItemAtURL:(id)a0 synchronously:(char)a1 completionHandler:(id /* block */)a2;
