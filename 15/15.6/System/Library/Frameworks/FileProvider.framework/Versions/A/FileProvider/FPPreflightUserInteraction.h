...
@property (nonatomic) char hasSuppressionIdentifier;
...
+ (id)userInteractionErrorsInInfoPlistDict:(id)a0 forAction:(id)a1 bundleID:(id)a2 hierarchyServicer:(id)a3 sourceNSFPItems:(id)a4 destinationNSFPItem:(id)a5 localizationLookup:(id)a6 provider:(id)a7 domain:(id)a8 extensionCapabilities:(unsigned long long)a9 useFPFS:(char)a10;
