@class NSURL, NSError, NSDate, NSDictionary, NSFileProviderItemVersion, NSString, NSSet, CSSearchableItemAttributeSet, NSPersonNameComponents, NSArray, NSData, CSSearchableItem, UTType, NSNumber;
