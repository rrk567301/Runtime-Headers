...
- (void).cxx_destruct;
- (void)service:(id)a0 didReceiveArchivedItemsDescriptors:(id)a1 placeholderName:(id)a2 placeholderTypeIdentifier:(id)a3;
...
- (void)actionMain;
- (id)findUniqueUnarchivedName:(id)a0 isFolder:(char)a1 parent:(id)a2;
- (char)getHasUnarchivedMultipleItems:(char *)a0 firstUnarchivedItemURL:(id *)a1 forArchiveFolderURL:(id)a2 error:(id *)a3;
