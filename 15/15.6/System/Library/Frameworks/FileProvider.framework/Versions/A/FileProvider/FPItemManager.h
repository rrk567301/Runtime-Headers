...
+ (char)isAnyDocumentRecentlyUsed:(id)a0 excludedFileTypes:(id)a1 allowedFileProviderIdentifiers:(id)a2;

- (id)init;
- (void).cxx_destruct;
- (void)addOperation:(id)a0;
- (void)fetchURLForItem:(id)a0 creatingPlaceholderIfMissing:(char)a1 completionHandler:(id /* block */)a2;
- (void)scheduleAction:(id)a0;
- (id)appLibraryCollectionForProviderDomainID:(id)a0;
...
- (id)newCollectionWithItemAtURL:(id)a0 error:(id *)a1;
- (id)rootCollectionForProviderDomain:(id)a0;
- (id)trashCollectionForProviderDomain:(id)a0;
- (id)newCollectionWithItemID:(id)a0;
- (void)fetchParentsForItemID:(id)a0 recursively:(char)a1 completionHandler:(id /* block */)a2;
- (id)__itemForURLWithBuggyNullability:(id)a0 error:(id *)a1;
- (void)_fetchHierarchyForItemID:(id)a0 recursively:(char)a1 completionHandler:(id /* block */)a2;
- (void)_fetchHierarchyForItemID:(id)a0 recursively:(char)a1 depth:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (void)_fetchItemForURL:(id)a0 synchronously:(char)a1 completionHandler:(id /* block */)a2;
- (void)_fetchItemForURL:(id)a0 synchronously:(char)a1 skipURLValidation:(char)a2 completionHandler:(id /* block */)a3;
- (void)_fetchParentsForItemID:(id)a0 recursively:(char)a1 completionHandler:(id /* block */)a2;
- (void)_fetchURLForItemID:(id)a0 creatingPlaceholderIfMissing:(char)a1 completionHandler:(id /* block */)a2;
- (void)_fetchURLForItemID:(id)a0 creatingPlaceholderIfMissing:(char)a1 completionHandlerWithInfo:(id /* block */)a2;
- (char)_isValidDestination:(id)a0;
- (char)_itemIsOfArchiveType:(id)a0;
...
- (id)eligibleActionsForItems:(id)a0 domainCachePolicy:(unsigned long long)a1;
...
- (void)fetchServicesWithName:(id)a0 itemAtURL:(id)a1 synchronously:(char)a2 handler:(id /* block */)a3;
...
- (char)isItemInTrash:(id)a0;
- (id)newCollectionForProvider:(id)a0;
- (id)newCollectionForTag:(id)a0;
- (id)newCollectionWithItemAtURL:(id)a0 skipValidation:(char)a1 error:(id *)a2;
...
- (id)serverCollectionForFolderItem:(id)a0;
