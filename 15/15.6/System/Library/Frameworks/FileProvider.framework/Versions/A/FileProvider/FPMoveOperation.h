...
@interface FPMoveOperation : FPActionOperation <FPDaemonActionOperationClient> {
    ...
    char _isScheduledFromThisClient;
...
@property (nonatomic) char shouldBounceOnCollision;
...
@property (readonly, nonatomic) char byCopy;
...
- (char)_hasAccessToURL:(id)a0 readonly:(char)a1;
- (id)_mapURLsToFakeFPItems:(id)a0;
- (char)_preflightCheckNotMovingIntoSelfWithError:(id *)a0;
- (char)_preflightCheckProviderCanMoveWithErrors:(id *)a0;
