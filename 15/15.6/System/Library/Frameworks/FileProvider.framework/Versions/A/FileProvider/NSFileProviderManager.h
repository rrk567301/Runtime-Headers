...
+ (char)addDomain:(id)a0 forProviderIdentifier:(id)a1 byImportingDirectoryAtURL:(id)a2 knownFolders:(id)a3 error:(id *)a4;
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 byImportingDirectoryAtURL:(id)a2 userAllowedDBDrop:(char)a3 knownFolders:(id)a4 completionHandler:(id /* block */)a5;
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 byImportingDirectoryAtURL:(id)a2 userAllowedDBDrop:(char)a3 knownFolders:(id)a4 synchronous:(char)a5 completionHandler:(id /* block */)a6;
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 completionHandler:(id /* block */)a2;
+ (char)addDomain:(id)a0 forProviderIdentifier:(id)a1 error:(id *)a2;
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 persona:(id)a2 completionHandler:(id /* block */)a3;
+ (void)addDomain:(id)a0 userAllowedDBDrop:(char)a1 completionHandler:(id /* block */)a2;
+ (char)checkDomainsCanBeStored:(char *)a0 onVolumeAtURL:(id)a1 unsupportedReason:(unsigned long long *)a2 error:(id *)a3;
+ (char)fileProviderReadyForBackupOrMigrationForSourceURL:(id)a0 error:(id *)a1;
...
+ (char)importDomain:(id)a0 forProviderIdentifier:(id)a1 fromDirectoryAtURL:(id)a2 error:(id *)a3;
...
+ (char)importDomain:(id)a0 forProviderIdentifier:(id)a1 fromDirectoryAtURL:(id)a2 knownFolders:(id)a3 error:(id *)a4;
...
+ (char)writePlaceholderAtURL:(id)a0 withDictionary:(id)a1 error:(id *)a2;
...
- (void)removeDomain:(id)a0 completionHandler:(id /* block */)a1;
- (void)setConnected:(char)a0 completionHandler:(id /* block */)a1;
- (void)setEjectable:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)fetchDomainServicerSynchronously:(char)a0 useOutgoingConnection:(char)a1 completionHandler:(id /* block */)a2;
...
- (char)isErrorSupportedForSignalResolved:(id)a0;
...
- (char)removeDomain:(id)a0 options:(long long)a1 preservedLocation:(id *)a2 error:(id *)a3;
