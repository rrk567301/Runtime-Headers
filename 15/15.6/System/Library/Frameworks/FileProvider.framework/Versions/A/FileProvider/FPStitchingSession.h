...
- (char)cleanStitchedItemForItemID:(id)a0;
- (id)createArchivePlaceholderForItem:(id)a0 underParent:(id)a1 inProviderDomainID:(id)a2 withArchiveFormat:(unsigned long long)a3;
- (id)createGenericArchivePlaceholderUnderParent:(id)a0 inProviderDomainID:(id)a1 withArchiveFormat:(unsigned long long)a2;
...
- (id)createPlaceholderWithName:(id)a0 isFolder:(char)a1 contentAccessDate:(id)a2 underParent:(id)a3 inProviderDomainID:(id)a4;
