...
@property (nonatomic) char setupRemoteOperationService;
@property (nonatomic) char haveErrorRecovery;
@property (nonatomic) char havePreflight;
@property (nonatomic) char haveStitching;
...
@property (nonatomic) char finishAfterPreflight;
