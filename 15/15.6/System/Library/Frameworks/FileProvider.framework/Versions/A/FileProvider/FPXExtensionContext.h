...
- (char)_inlineSymlinkTarget:(id)a0 url:(id *)a1 error:(id *)a2;
...
- (void)URLForItemID:(id)a0 creatingPlaceholderIfMissing:(char)a1 ignoreAlternateContentsURL:(char)a2 completionHandler:(id /* block */)a3;
- (id)_createItemBasedOnTemplate:(id)a0 fields:(unsigned long long)a1 contents:(id)a2 options:(unsigned long long)a3 request:(id)a4 bounce:(char)a5 bounceNumber:(id)a6 completionHandler:(id /* block */)a7;
...
- (void)_persistedDocumentURLForURL:(id)a0 itemID:(id)a1 extension:(id)a2 creatingPlaceholderIfMissing:(char)a3 completionHandler:(id /* block */)a4;
- (id)_proxyWithCancellationHandler:(id)a0 forClientOperation:(id)a1;
- (void)_setupItemForTrashing:(id)a0 usesFPFS:(char)a1 completionHandler:(id /* block */)a2;
- (void)_singleItemChange:(id)a0 changedFields:(unsigned long long)a1 bounce:(char)a2 bounceIndex:(unsigned long long)a3 request:(id)a4 completionHandler:(id /* block */)a5;
...
- (id)createItemBasedOnTemplate:(id)a0 fields:(unsigned long long)a1 contents:(id)a2 options:(unsigned long long)a3 request:(id)a4 bounce:(char)a5 completionHandler:(id /* block */)a6;
- (id)createTempThumbnailURLForVersion:(id)a0 appropriateForURL:(id)a1 itemIdentifier:(id)a2 isFromData:(char)a3 error:(id *)a4;
...
- (id)fetchContentsForItemWithID:(id)a0 version:(id)a1 request:(id)a2 estimatedItemSize:(long long)a3 isSymlink:(char)a4 extent:(id)a5 alignment:(unsigned long long)a6 options:(unsigned long long)a7 completionHandler:(id /* block */)a8;
- (id)fetchContentsForItemWithID:(id)a0 version:(id)a1 usingExistingContentsAtURL:(id)a2 existingVersion:(id)a3 request:(id)a4 estimatedItemSize:(long long)a5 isSymlink:(char)a6 completionHandler:(id /* block */)a7;
...
- (void)fetchServicesForItemID:(id)a0 allowRestrictedSources:(char)a1 completionHandler:(id /* block */)a2;
