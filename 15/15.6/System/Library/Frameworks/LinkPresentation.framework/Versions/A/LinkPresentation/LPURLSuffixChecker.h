...
- (char)insertString:(id)a0 intoTrieWithCache:(struct { struct { unsigned short x0; unsigned short x1; } x0[32]; unsigned long long x1; } *)a1;
- (void)addStringToFailedSuffixes:(id)a0;
- (id)initWithSuffixes:(id)a0;
- (char)hasSuffix:(id)a0 remainingPrefix:(id *)a1;
