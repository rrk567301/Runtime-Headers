...
- (struct CGSize { double x0; double x1; })_availableSizeForImageNumber:(unsigned long long)a0 withLayout:(unsigned long long)a1 withinSize:(struct CGSize { double x0; double x1; })a2 applyingLayout:(char)a3;
...
- (struct CGSize { double x0; double x1; })layoutImagesForSize:(struct CGSize { double x0; double x1; })a0 applyingLayout:(char)a1;
