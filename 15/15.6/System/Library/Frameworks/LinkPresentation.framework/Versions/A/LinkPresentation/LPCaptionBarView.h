...
@property (nonatomic) char useProgressSpinner;
...
@property (readonly, nonatomic) char captionTextIsTruncated;
...
- (struct CGSize { double x0; double x1; })_layoutCaptionBarForSize:(struct CGSize { double x0; double x1; })a0 applyingLayout:(char)a1;
- (void)animateInWithBaseAnimation:(id)a0 currentTime:(double)a1;
- (char)hasIconViewEqualToComponentView:(id)a0;
