...
@property (readonly, nonatomic) char useInvertedInactiveState;

- (void).cxx_destruct;
- (id)initWithKeyColor:(id)a0 secondaryColor:(id)a1 outerBorderColor:(id)a2 useInvertedInactiveState:(char)a3;
