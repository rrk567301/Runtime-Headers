...
@property (nonatomic) char scalesToFitParent;
@property (nonatomic) char preservesEdgeAlignmentWhenScaling;
...
@property (nonatomic) char allowsPlatterPresentation;
@property (nonatomic) char canAdjustVerticalPaddingForFixedSize;
