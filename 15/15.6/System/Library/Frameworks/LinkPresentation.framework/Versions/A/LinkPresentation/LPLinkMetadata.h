...
@property (nonatomic, readonly) char _hasMedia;
...
@property (readonly, nonatomic) char isGroupCollaboration;
...
@property (nonatomic, getter=_isIncomplete, setter=_setIncomplete:) char _incomplete;
...
- (char)_isCurrentlyLoadingOrIncomplete;
...
- (char)_isEqualIgnoringURLs:(id)a0;
- (char)_isLoadingAsynchronousFields;
- (char)_loadAsynchronousFieldsWithLoadGroup:(id)a0;
