...
@property (retain, nonatomic) NSTextField *textView;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

+ (id)attributedString:(id)a0 resolvedAgainstStyle:(id)a1 withEmphasizedTextExpression:(id)a2 tintColor:(id)a3 lineBreakMode:(unsigned long long)a4 usesVibrancy:(char)a5 forLTR:(char)a6 withFont:(id)a7 userInterfaceStyle:(long long)a8;
