...
- (char)_bindInputFeaturesAndWaitEvents:(id)a0 options:(id)a1 error:(id *)a2;
...
- (char)_bindOutputPortsWithOptions:(id)a0 error:(id *)a1;
- (void)_bindWaitEventsDirectly:(id)a0;
- (char)_copyInputFeatures:(id)a0 error:(id *)a1;
...
- (id)_outputPortNames;
- (char)_prepareInputPortsForFeatures:(id)a0 error:(id *)a1;
- (char)_reusableForCompletionSyncPoint:(id)a0 allOutputBackingsUseDirectBinding:(char)a1;
- (char)_reusableForWaitSyncPoints:(id)a0 allInputsUseDirectBinding:(char)a1;
...
- (char)preloadAndReturnError:(id *)a0;
- (char)prepareAsyncSubmissionForInputFeatures:(id)a0 options:(id)a1 error:(id *)a2;
- (char)prepareForInputFeatures:(id)a0 options:(id)a1 error:(id *)a2;
- (char)reusableForInputFeatures:(id)a0 options:(id)a1;
