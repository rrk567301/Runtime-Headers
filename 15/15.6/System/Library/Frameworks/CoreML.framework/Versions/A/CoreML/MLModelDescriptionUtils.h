...
+ (void *)getStateFeatureTypeFromConstraint:(id)a0;
+ (BOOL)saveModelDescription:(id)a0 toSpecification:(void *)a1 error:(id *)a2;
+ (char)validateAllFeatureDescriptions:(id)a0 hasAnyFeatureTypeIn:(id)a1 minimalCount:(unsigned long long)a2 maximumCount:(unsigned long long)a3 debugLabel:(id)a4 error:(id *)a5;
