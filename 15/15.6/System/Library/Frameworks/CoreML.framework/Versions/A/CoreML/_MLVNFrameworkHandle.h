...
@property (readonly, nonatomic, getter=isValid) char validForSceneprint;
@property (readonly, nonatomic, getter=isValid) char validForObjectprint;
...
- (id)detectionPrintsFromPixelBuffers:(struct __CVBuffer { } *)a0 version:(unsigned long long)a1 augmentationOptions:(id)a2 useCPUOnly:(char)a3 error:(id *)a4;
...
- (id)scenePrintsFromPixelBuffers:(struct __CVBuffer { } *)a0 version:(unsigned long long)a1 augmentationOptions:(id)a2 useCPUOnly:(char)a3 error:(id *)a4;
