...
- (char)hasEnumeratedShapeInputs;
- (char)hasRangeShapeInputs;
...
- (id)initWithInputDescriptions:(id)a0 outputDescriptions:(id)a1 predictedFeatureName:(id)a2 predictedProbabilitiesName:(id)a3 functionDescriptions:(id)a4 isUpdatable:(char)a5 trainingInputDescriptions:(id)a6 parameterDescriptions:(id)a7 orderedInputFeatureNames:(id)a8 orderedOutputFeatureNames:(id)a9 metadata:(id)a10 defaultFunctionName:(id)a11 functionName:(id)a12 classLabels:(id)a13 modelURL:(id)a14 modelPath:(id)a15;
...
- (char)validateAsClassifierDescriptionAndReturnError:(id *)a0;
- (char)validateAsRegressorDescriptionAndReturnError:(id *)a0;
- (char)verifyInput:(id)a0 error:(id *)a1;
