...
+ (char)needsANECompilationForModelAtURL:(id)a0 result:(char *)a1 error:(id *)a2;
+ (char)purgeANEBinaryForModelAtURL:(id)a0 error:(id *)a1;
+ (char)purgeANEIRForModelAtURL:(id)a0 error:(id *)a1;
