...
- (char)setWeightsOrBiasesForLayer:(id)a0 layerType:(unsigned long long)a1 value:(id)a2 error:(id *)a3;
- (id)stringForDataType:(unsigned long long)a0;
- (char)updateLearningRateWithTaskContext:(id)a0 isInCallBack:(BOOL)a1 error:(id *)a2;
- (void)updateModelWithData:(id)a0;
- (id)updateParameters;
- (char)updateWeightsAndBiasesFromConfigParams:(id)a0 error:(id *)a1;
