...
@property char ndArrayInterpretation;
...
@property (nonatomic) char modelIsEncrypted;
@property (retain, nonatomic) MLVersionInfo *modelVersionInfo;
@property (nonatomic) char modelIsMIL;
@property (nonatomic) char modelIsTrainingProgram;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithFeatureDescriptions:(id)a0 modelDescription:(id)a1 outputLayerNames:(id)a2 classScoreVectorName:(id)a3 classLabels:(id)a4 isEncrypted:(char)a5 modelVersionInfo:(id)a6;
- (id)initWithFeatureDescriptions:(id)a0 modelDescription:(id)a1 outputLayerNames:(id)a2 classScoreVectorName:(id)a3 classLabels:(id)a4 isEncrypted:(char)a5 modelVersionInfo:(id)a6 compilerVersionInfo:(id)a7;
