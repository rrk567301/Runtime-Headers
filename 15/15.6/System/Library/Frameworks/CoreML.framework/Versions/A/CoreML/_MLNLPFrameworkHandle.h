...
- (void *)initializeEmbeddingModelWithData:(id)a0 error:(id *)a1;
- (void *)initializeGazetteerModelWithData:(id)a0 error:(id *)a1;
- (void *)initializeSentenceClassifierModelWithData:(id)a0 error:(id *)a1;
- (void *)initializeWordTaggingModelWithData:(id)a0 error:(id *)a1;
