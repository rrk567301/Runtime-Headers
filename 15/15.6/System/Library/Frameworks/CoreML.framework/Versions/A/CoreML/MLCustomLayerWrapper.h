...
@property (readonly, nonatomic) char ndMode;
...
+ (id)factory;
+ (id)coremlShapeToEspressoShape:(id)a0 ndMode:(char)a1;
+ (id)coremlShapesToEspressoShapes:(id)a0 ndMode:(char)a1;
+ (id)espressoShapeToCoremlShape:(id)a0 ndMode:(char)a1;
+ (id)espressoShapesToCoremlShapes:(id)a0 ndMode:(char)a1;
+ (id)espressoTensorToCoremlTensor:(id)a0 ndMode:(char)a1;
+ (id)espressoTensorsToCoremlTensors:(id)a0 ndMode:(char)a1;
