...
@property (nonatomic) char layerFusedToLoss;
...
- (void).cxx_destruct;
- (char)buildGraphsFor:(void *)a0 batchSize:(unsigned long long)a1 numberOfClasses:(unsigned long long)a2 error:(id *)a3;
...
- (char)copyWeightsFrom:(id)a0 to:(void *)a1 error:(id *)a2;
...
- (char)saveUpdatedWeightsTo:(void *)a0 error:(id *)a1;
