...
+ (id)leakyRelu;
+ (id)matMulLayerWithTransposesX:(char)a0 transposesY:(char)a1;
...
+ (id)uniDirectionalLSTMLayerWithInputSize:(unsigned long long)a0 outputSize:(unsigned long long)a1 inputWeightsData:(id)a2 recursionWeightsData:(id)a3 hasBias:(char)a4 biasTermsData:(id)a5 sequenceOutput:(char)a6 inputGateActivation:(id)a7 cellGateActivation:(id)a8 hiddenOutputActivation:(id)a9;
