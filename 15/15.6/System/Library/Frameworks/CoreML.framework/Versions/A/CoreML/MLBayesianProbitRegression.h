...
+ (char)validateModelDescription:(id)a0;
...
- (char)isEqualToBopr:(id)a0;
- (id)regress:(id)a0 options:(id)a1 error:(id *)a2;
- (void)resetToLastCheckpointBeforeDate:(id)a0;
- (void *)saveModelToSpecification:(id *)a0;
- (char)setFeatureCount:(unsigned long long)a0;
- (BOOL)setInputFeatureName:(id *)a0 to:(id)a1;
- (BOOL)setOutputFeatureName:(id *)a0 to:(id)a1;
- (char)updateModelFromFeatures:(id)a0 toTarget:(id)a1 error:(id *)a2;
- (char)updateModelFromFeatures:(id)a0 toTarget:(id)a1 options:(id)a2 error:(id *)a3;
