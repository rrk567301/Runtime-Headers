...
- (char)_cleanUpAndReconfigureStream:(id)a0 forInputFeatures:(id)a1 error:(id *)a2;
...
- (char)_validateStreamReuse:(char)a0 expectation:(id)a1 error:(id *)a2;
- (id)classLabels;
...
- (char)prepareWithConcurrencyHint:(long long)a0 error:(id *)a1;
