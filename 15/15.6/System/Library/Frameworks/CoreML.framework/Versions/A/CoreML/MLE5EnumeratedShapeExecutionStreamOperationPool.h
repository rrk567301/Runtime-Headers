@class NSString, MLE5ProgramLibrary, NSSet, NSMutableDictionary, MLModelDescription, MLVersionInfo, NSObject, MLModelConfiguration;
...
- (char)prepareWithInitialPoolSize:(long long)a0 error:(id *)a1;
- (void)putBack:(id)a0;
