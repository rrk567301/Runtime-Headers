...
+ (char)_createDecryptSessionForModelAtURL:(id)a0 configuration:(id)a1 decryptSession:(id *)a2 loaderEvent:(id)a3 error:(id *)a4;
...
+ (id)_loadModelFromArchive:(void *)a0 configuration:(id)a1 loaderEvent:(id)a2 useUpdatableModelLoaders:(char)a3 error:(id *)a4;
+ (id)_loadModelFromArchive:(void *)a0 configuration:(id)a1 modelVersion:(id)a2 compilerVersion:(id)a3 loaderEvent:(id)a4 useUpdatableModelLoaders:(char)a5 loadingClasses:(id)a6 error:(id *)a7;
...
+ (id)_loadWithModelLoaderFromArchive:(void *)a0 configuration:(id)a1 loaderEvent:(id)a2 useUpdatableModelLoaders:(char)a3 error:(id *)a4;
...
+ (char)checkAssetPath:(id)a0 error:(id *)a1;
