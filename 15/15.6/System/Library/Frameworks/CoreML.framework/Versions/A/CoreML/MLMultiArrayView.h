...
+ (char)isSqueezableShape:(id)a0;
+ (char)isSqueezableShape:(id)a0 dimensions:(id)a1;
...
- (id)initSlicingMultiArray:(id)a0 origin:(id)a1 shape:(id)a2 squeeze:(char)a3 error:(id *)a4;
