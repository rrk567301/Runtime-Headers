...
+ (char)_convertStringClassVector:(const void *)a0 int64ClassVector:(const void *)a1 dimensions:(unsigned long long)a2 toClassLabel:(id *)a3 classType:(long long *)a4 andReturnError:(id *)a5;
