...
@interface MLNeuralNetworkEngine : MLModelEngine <MLModelAssetDescriptionLoader, MLNeuralNetwork, MLClassifier, MLRegressor, MLCompiledModelLoader> {
    ...
    struct map<std::string, _BlobShape, std::less<std::string>, std::allocator<std::pair<const std::string, _BlobShape>>> { struct __tree<std::__value_type<std::string, _BlobShape>, std::__map_value_compare<std::string, std::__value_type<std::string, _BlobShape>, std::less<std::string>>, std::allocator<std::__value_type<std::string, _BlobShape>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, _BlobShape>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, _BlobShape>, std::less<std::string>>> { unsigned long long __value_; } __pair3_; } __tree_; } _currentBlobShapes;
    ...
    struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct __compressed_pair<std::basic_string<char>::__rep, std::allocator<char>> { union __rep { struct __short { struct { unsigned char __is_long_ : 1; unsigned char __size_ : 7; } ; char __padding_[0]; char __data_[23]; } __s; struct __long { struct { unsigned char __is_long_ : 1; unsigned long __cap_ : 63; } ; unsigned long long __size_; char *__data_; } __l; } __value_; } __r_; } _currentConfigurationName;
...
@property (nonatomic) char usingCPU;
...
@property (readonly, nonatomic) char modelIsEncrypted;
...
@property char isGPUPathForbidden;
@property char isANEPathForbidden;
...
@property (nonatomic) char ndArrayInterpretation;
...
@property (nonatomic) char hardwareFallbackDetected;
...
- (char)bindDynamicOutputBuffers:(const void *)a0 error:(id *)a1;
- (char)_addCompiledNetworkOrProgramToPlan:(void *)a0 error:(id *)a1;
- (char)_addNetworkToPlan:(void *)a0 error:(id *)a1;
- (void)_deallocContextAndPlan;
- (int)_espressoDeviceForConfiguration:(id)a0 error:(id *)a1;
- (char)_espressoOutputShapeForFeatureName:(id)a0 matchesShapeOfMLMultiArray:(id)a1;
- (char)_handleAddNetworkToPlanStatus:(int)a0 error:(id *)a1;
- (char)_matchEngineToOptions:(id)a0 error:(id *)a1;
...
- (char)_setMultiArrayOutputBacking:(id)a0 forOutputFeatureName:(id)a1 toEbuf:(struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a2 error:(id *)a3;
- (char)_setMultipleBuffersOnPlan:(void *)a0 error:(id *)a1;
- (char)_setupContextAndPlanWithConfiguration:(id)a0 priority:(int)a1 error:(id *)a2;
- (char)_setupContextAndPlanWithConfiguration:(id)a0 usingCPU:(char)a1 priority:(int)a2 error:(id *)a3;
- (char)_setupContextAndPlanWithConfiguration:(id)a0 usingCPU:(char)a1 priority:(int)a2 reshapeWithContainer:(char)a3 error:(id *)a4;
- (char)_setupContextAndPlanWithForceCPU:(char)a0 priority:(int)a1 error:(id *)a2;
- (id)addClassifierInformationToOutput:(id)a0 options:(id)a1 error:(id *)a2;
- (id)availableOutputBlobList;
- (char)bindDirectlyInputFeatureNamed:(id)a0 pixelBuffer:(struct __CVBuffer { } *)a1 cleanUpBlocks:(id)a2 boundDirectly:(char *)a3 error:(id *)a4;
- (char)bindInputFeatureNamed:(id)a0 convertingMultiArray:(id)a1 bufferIndex:(unsigned long long)a2 error:(id *)a3;
- (char)bindInputFeatureNamed:(id)a0 featureValue:(id)a1 bufferIndex:(unsigned long long)a2 cleanUpBlocks:(id)a3 boundDirectly:(char *)a4 error:(id *)a5;
- (char)bindInputFeatureNamed:(id)a0 pixelBuffer:(struct __CVBuffer { } *)a1 cleanUpBlocks:(id)a2 error:(id *)a3;
- (char)bindInputFeatures:(id)a0 bufferIndex:(unsigned long long)a1 cleanUpBlocks:(id)a2 directlyBoundFeatureNames:(id *)a3 error:(id *)a4;
- (char)bindInputsAndOutputs:(id)a0 cleanUpBlocks:(id)a1 bufferIndex:(unsigned long long)a2 options:(id)a3 error:(id *)a4;
- (char)bindOutputBuffers:(const void *)a0 outputBackings:(id)a1 automaticOutputBackingMode:(id)a2 directlyBoundOutputFeatureNames:(id *)a3 error:(id *)a4;
- (id)classify:(id)a0 options:(id)a1 error:(id *)a2;
- (char)collectParametersFromContainer:(id)a0 configuration:(id)a1 error:(id *)a2;
...
- (char)copyEbuf:(const struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a0 ofPixelType:(unsigned long long)a1 toPixelBuffer:(struct __CVBuffer { } *)a2 error:(id *)a3;
- (char)copyImagePreprocessingParametersTo:(void *)a0 error:(id *)a1;
...
- (id)evaluateInputs:(id)a0 options:(id)a1 verifyInputs:(char)a2 error:(id *)a3;
- (char)executePlan:(void *)a0 error:(id *)a1;
...
- (char)lockPixelBuffer:(struct __CVBuffer { } *)a0 cleanUpBlocks:(id)a1 error:(id *)a2;
...
- (char)opacifyAndPermutePixelBuffer:(struct __CVBuffer { } *)a0 bufferContainsBGRA:(char)a1 error:(id *)a2;
...
- (char)rebuildPlan:(id *)a0;
- (char)rebuildPlan:(char)a0 error:(id *)a1;
- (id)regress:(id)a0 options:(id)a1 error:(id *)a2;
- (void)releaseBuffer:(unsigned long long)a0;
- (char)resetSizes:(id)a0 error:(id *)a1;
- (char)resetSizesNoAutoRelease:(id)a0 error:(id *)a1;
- (char)resetSizesWithEspressoConfigurations:(id)a0 error:(id *)a1;
- (char)sequenceConcatConsumesOptionalInputNamed:(id)a0;
- (int)sequenceNamed:(id)a0;
- (char)setEspressoBlobShapes:(void *)a0 widths:(void *)a1 heights:(void *)a2 ks:(void *)a3 batches:(void *)a4 sequences:(void *)a5 ranks:(void *)a6 error:(id *)a7;
- (unsigned long long)supportFromEspressoLayerInfo:(id)a0;
- (unsigned long long)supportFromEspressoPlatform:(int)a0;
- (char)transferOneComponent16HalfPixelBuffer:(struct __CVBuffer { } *)a0 toPixelBuffer:(struct __CVBuffer { } *)a1 withScale:(float)a2 bias:(float)a3;
- (char)transferPixelBuffer:(struct __CVBuffer { } *)a0 toPixelBuffer:(struct __CVBuffer { } *)a1;
- (char)tryToSetOutputBacking:(id)a0 forFeatureName:(id)a1 toEbuf:(struct { void *x0; void *x1; unsigned long long x2[4]; unsigned long long x3[4]; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; unsigned long long x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; int x14; } *)a2 reportPointerFlags:(int *)a3 error:(id *)a4;
- (char)updateDynamicOutputBlobIndicatorCacheAndReturnError:(id *)a0;
