...
- (struct e5rt_program_library { } *)_programLibraryHandleWithForceRespecialization:(char)a0 error:(id *)a1;
- (struct e5rt_execution_stream_operation { } *)createOperationForFunctionName:(id)a0 forceRespecialization:(char)a1 hasRangeShapeInputs:(char)a2 error:(id *)a3;
