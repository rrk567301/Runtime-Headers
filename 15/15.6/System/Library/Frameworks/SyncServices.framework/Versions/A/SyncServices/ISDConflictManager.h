...
- (char)_writeConflicts:(id)a0 toFile:(id)a1 obtainLock:(char)a2;
...
- (char)commitNewlyResolvedConflictsPostingNotification:(char)a0;
- (id)commonClientId;
...
- (id)initWithDataDirectory:(id)a0 lastSyncedGeneration:(unsigned int)a1 validateConflictsOnRead:(char)a2;
