...
+ (char)createDatabaseAtPath:(id)a0;
...
- (unsigned int)_earliestFromGenerationOfRecordsForEntityName:(id)a0 processed:(char)a1 changeType:(int)a2;
- (id)_entityNamesOfAddedRecords:(char)a0;
- (char)_enumerateChangesForEntityNames:(id)a0 changeType:(int)a1 processed:(char)a2 changeStore:(id)a3 asArgumentToFunction:(void /* function */ *)a4 context:(void *)a5;
...
- (unsigned int)_latestFromGenerationOfRecordsForEntityName:(id)a0 processed:(char)a1 changeType:(int)a2;
...
- (unsigned long long)_numberOfChanges:(char)a0;
...
- (void)_removeAllChangesForEntityNames:(id)a0 processed:(char)a1;
