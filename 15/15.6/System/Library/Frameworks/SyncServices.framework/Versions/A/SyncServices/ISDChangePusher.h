...
- (void)dealloc;
- (char)_addDeletedTuple:(id)a0 tuples:(id)a1;
...
- (void)createArrayOfFormattedTuples:(id *)a0 unformattedTuples:(id *)a1 byCombiningNewRecordIds:(id)a2 withOldTuples:(id)a3 oldUnformattedTuples:(id)a4 relationshipIsToMany:(char)a5 builder:(id)a6;
- (id)initWithClientId:(id)a0 clientFormatsRelationships:(char)a1;
- (void)prepareForNewChange:(id)a0;
- (void)updateRecordWithPropertyValue:(id)a0 unformattedRelationshipTuples:(id)a1 propertyDescription:(id)a2 name:(id)a3 lastModifiedGeneration:(unsigned int)a4 isDefaultValue:(char)a5;
