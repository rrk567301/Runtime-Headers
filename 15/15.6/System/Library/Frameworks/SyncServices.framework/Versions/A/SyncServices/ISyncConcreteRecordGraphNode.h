...
- (id)orderedSubentityIdsFromIds:(id)a0 usingEntityNames:(id)a1 defaultOrder:(id)a2 isAdd:(char)a3;
...
- (id)interestingAttributeKeysByComparingGraphNode:(id)a0 interestingAttributeKeysForOther:(id *)a1 includeRelationship:(char)a2;
- (id)interestingAttributeKeysByComparingGraphNode:(id)a0 interestingAttributeKeysForOther:(id *)a1 unInterestingAttributeKeysForOther:(id *)a2 includeRelationship:(char)a3 forClientWithIdentifier:(id)a4;
- (char)mergeChangesFromNode:(id)a0;
- (char)mergeChangesFromNode:(id)a0 childChangeType:(int)a1;
- (char)mergeChildrenTree:(id)a0 atRelationship:(id)a1 childChangeType:(int)a2;
