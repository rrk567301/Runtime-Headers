...
- (char)_isCoreDataEntitySyncable:(id)a0 inSchema:(id)a1;
- (char)_isCoreDataPropertySyncable:(id)a0 inSchema:(id)a1;
...
- (char)_propertyIsRequiredInDescription:(id)a0 propertyName:(id)a1 withEntityComponent:(id)a2;
- (int)_relationshipDeleteRuleInDescription:(id)a0 withComponent:(id)a1;
- (char)_relationshipIsMatchableInDescription:(id)a0 withComponent:(id)a1;
- (char)_relationshipIsToManyInDescription:(id)a0 withComponent:(id)a1;
...
- (id)_relationshipWithName:(id)a0 forEntity:(id)a1 create:(char)a2;
- (id)_schemaWithName:(id)a0 create:(char)a1 bundleRef:(id)a2;
- (void)_setHasDefinition:(char)a0 forObject:(id)a1;
- (char)_setVersionInformation:(id)a0 forObject:(id)a1 isExtension:(char)a2;
...
- (id)parseDescription:(id)a0 bundleRef:(id)a1 linkedOnTiger:(char)a2;
- (id)undefinedObjects;
