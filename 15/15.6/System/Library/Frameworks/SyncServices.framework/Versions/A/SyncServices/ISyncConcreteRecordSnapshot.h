...
- (id)recordsWithIdentifiers:(id)a0 useUnformattedValues:(char)a1;
- (id)recordsWithMatchingAttributes:(id)a0;
- (id)recordsWithMatchingAttributes:(id)a0 useUnformattedValues:(char)a1;
- (id)recordsWithMatchingAttributes:(id)a0 useUnformattedValues:(char)a1 matchAll:(char)a2;
