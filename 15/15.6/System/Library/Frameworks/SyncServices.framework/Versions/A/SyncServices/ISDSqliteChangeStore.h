...
- (char)_enumerateChangesOfType:(int)a0 forEntityNames:(id)a1 state:(long long *)a2 maxToEnumerate:(long long)a3 asArgumentToFunction:(void /* function */ *)a4 context:(void *)a5;
- (void)_insertChange:(id)a0;
- (void)addIndexToIndexSetOfEnumeratedChanges:(long long)a0;
- (void)appendChange:(id)a0;
- (char)changeExistsWhichReferencesRecordWithId:(id)a0;
- (char)changeExistsWhichReferencesRecordWithId:(id)a0 referringChanges:(id)a1;
...
- (char)enumerateAddsForEntityNames:(id)a0 state:(long long *)a1 maxToEnumerate:(long long)a2 asArgumentToFunction:(void /* function */ *)a3 context:(void *)a4;
- (void)enumerateChangesForEntityNames:(id)a0 asArgumentToFunction:(void /* function */ *)a1 context:(void *)a2;
- (char)enumerateChangesForEntityNames:(id)a0 changeType:(int *)a1 state:(long long *)a2 maxToEnumerate:(long long)a3 asArgumentToFunction:(void /* function */ *)a4 context:(void *)a5;
