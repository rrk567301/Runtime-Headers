...
- (char)_clientIsKnownToSyncAllSupportedEntities:(id)a0;
- (void)prepareToPullChangesInBackgroundForEntityNames:(id)a0 target:(id)a1 selector:(SEL)a2;
- (void)_commitAcceptedChangesAndStartAnotherTransaction:(char)a0;
...
- (void)_doFinalCleanupIfNeeded:(char)a0;
...
- (void)_finishTransactionAndStartAnother:(char)a0;
- (void)_forceCompleteRefreshSyncs;
- (char)_hasAlreadyReturnedOrAcceptedChangeForRecordWithIdentifier:(id)a0;
- (void)_leaveMingling;
...
- (void)_noteDataWrapper:(id)a0 forRecordWithIdentifier:(id)a1 withPropertyName:(id)a2 onlyForUpdate:(char)a3;
...
- (void)_prepareToPullChangesForEntityNames:(id)a0 inBackground:(char)a1 target:(id)a2 selector:(SEL)a3;
...
- (char)_recordWithDataReferenceWasFormatted:(id)a0;
...
- (void)_setIgnoreDataWrapperDecode:(char)a0;
...
- (char)_supportedEntityNamesIsEqualToEntityNames:(id)a0 forClient:(id)a1;
...
- (void)_updateClientRecord:(id)a0 withChangesFromTruth:(id)a1 formattedRecordDictionary:(id)a2 saveUnformattedValues:(char)a3;
- (void)_updateDataReferencesForRecordsWithIdentifiers:(id)a0;
- (void)_updateDataReferencesForRecordsWithIdentifiers:(id)a0 resetOnError:(char)a1;
...
- (void)cancelSyncing:(id)a0 notifyServer:(char)a1 pendingCancel:(char)a2;
...
- (void)notifyUserOfUnresolvedReferences:(id)a0 onlyUnknownTypeReferences:(char)a1;
...
- (void)setApplyPushedChanges:(char)a0;
...
- (id)unresolvedReferencesAreForUnknownTypes:(char *)a0;
