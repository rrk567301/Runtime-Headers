...
- (void)_resetSyncData;
- (void)_sayGoodnightGracieSkippingVacuum:(char)a0;
...
- (char)minglerHasFinishedMinglingPlanWithIdentifier:(bycopy id)a0 exception:(bycopy id)a1;
...
- (void)setIsPrivateInstance:(char)a0;
