...
- (char)addedOrModifiedPropertyValue:(id)a0;
...
- (id)fastRecordId;
- (id)initWithRecordId:(id)a0 entityName:(id)a1 propertyValues:(id)a2 addedGeneration:(unsigned int)a3 lastChangedGeneration:(unsigned int)a4 state:(int)a5 lastChangedByClientId:(id)a6 isDeleted:(char)a7;
- (id)initWithRecordId:(id)a0 entityNumber:(int)a1 propertyValues:(id)a2 addedGeneration:(unsigned int)a3 lastChangedGeneration:(unsigned int)a4 state:(int)a5 lastChangedByClientNumber:(int)a6 isDeleted:(char)a7;
- (id)initWithRecordId:(id)a0 propertyChanges:(id)a1;
- (char)isReorderOnlyChangeForPropertyName:(id)a0;
...
- (char)recordWithId:(id)a0 isInCachedRelationship:(id)a1 atIndex:(long long *)a2;
- (void)removeAllPropertyValues;
- (void)removePropertyValueWithName:(id)a0;
- (char)removePropertyValuesWithNames:(id)a0;
- (void)replaceRecordId:(id)a0 withRecordId:(id)a1;
- (void)replaceRecordIds:(id)a0;
- (void)setDeleted:(char)a0 forPropertyValueWithName:(id)a1 inGeneration:(unsigned int)a2 byClientId:(id)a3;
...
- (void)setPropertyValuesIncludeDataReferences:(char)a0;
