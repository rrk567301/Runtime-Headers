...
- (id)createArrayWithRecordsWithIdentifiers:(id)a0 constructRelationshipMap:(char)a1;
- (id)createRecordIdsForRowids:(unsigned long long *)a0 count:(unsigned long long)a1;
- (void)recreateIndexes;
- (void)_updateRelationshipsInRecord:(id)a0 ignoreDeletedRelationshipTuples:(char)a1 removeTuplesFirst:(char)a2;
- (void)_updateUnformattedRelationshipsInRecord:(id)a0 ignoreDeletedRelationshipTuples:(char)a1 removeTuplesFirst:(char)a2;
...
- (id)createDictionaryAndArray:(id *)a0 withRecordsWithIdentifiers:(id)a1 constructRelationshipMap:(char)a2;
...
- (void)enumerateRecordsForRecordIds:(id)a0 includeProperties:(char)a1 asArgumentsToFunction:(void /* function */ *)a2 context:(void *)a3;
...
- (char)haveAllMatchingAttributes:(id)a0 inPropertyValues:(id)a1;
- (char)haveAnyMatchingAttributes:(id)a0 inPropertyValues:(id)a1;
...
- (id)recordIdsInTruth:(id)a0 includeDeletedRecords:(char)a1;
...
- (void)removeDataReferencesWithRecordId:(id)a0 forPropertyName:(id)a1 updateRecord:(char)a2;
...
- (void)removeTuplesForRecordsWithIds:(id)a0 nullifyReferencesToRemovedRecords:(char)a1;
...
- (void)setDeleted:(char)a0 forRecord:(id)a1 inGeneration:(unsigned int)a2 lastChangedByClientId:(id)a3;
...
- (void)updateRecord:(id)a0 inGeneration:(unsigned int)a1 lastChangedByClientId:(id)a2 ignoreDeletedRelationshipTuples:(char)a3;
- (void)updateRelationshipsForRecordsInDictionary:(id)a0 withRecordIds:(id)a1 stringTable:(id)a2 constructRelationshipMap:(char)a3;
