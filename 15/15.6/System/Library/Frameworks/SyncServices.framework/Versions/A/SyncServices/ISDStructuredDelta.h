...
+ (void)applyRecordDictionary:(id)a0 toRecord:(id)a1 forClient:(id)a2 generation:(unsigned int)a3 entity:(id)a4 syncState:(id)a5 takeUnformattedRelationshipsFromRecord:(id)a6 saveUnformattedValues:(char)a7 ignoredProperties:(id)a8;
...
+ (id)recordDictionaryFromRecord:(id)a0 usingRecordIdMapper:(id)a1 useUnformattedValues:(char)a2;
...
- (id)initWithClientState:(id)a0 syncStates:(id)a1 entities:(id)a2 currentGeneration:(unsigned int)a3 clientIsTrusted:(char)a4;
- (id)initWithClientState:(id)a0 syncStates:(id)a1 entities:(id)a2 currentGeneration:(unsigned int)a3 clientIsTrusted:(char)a4 clientFormatsRelationships:(char)a5;
- (void)prepareChangePusherToUpdateRecord:(id)a0 clientFormatsRelationships:(char)a1;
