...
@interface MEHEVCDependencyInfo : NSObject <NSCopying> {
    ...
    char _temporalSubLayerAccess;
    char _stepwiseTemporalSubLayerAccess;
...
@property (nonatomic, getter=hasTemporalSubLayerAccess) char temporalSubLayerAccess;
@property (nonatomic, getter=hasStepwiseTemporalSubLayerAccess) char stepwiseTemporalSubLayerAccess;
