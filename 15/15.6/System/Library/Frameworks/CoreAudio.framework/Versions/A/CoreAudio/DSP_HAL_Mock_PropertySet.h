...
@property (nonatomic) struct function<unsigned int (const AudioObjectPropertyAddress &, unsigned int)> { struct __value_func<unsigned int (const AudioObjectPropertyAddress &, unsigned int)> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } propertyUpdater;
...
- (void)configureForProcessor:(struct function<void (unsigned int, unsigned int)> { struct __value_func<void (unsigned int, unsigned int)> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a0;
