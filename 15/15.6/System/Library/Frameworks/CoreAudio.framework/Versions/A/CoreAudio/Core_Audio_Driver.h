...
@property (nonatomic) struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[32]; } __buf_; void *__f_; } __f_; } m_invalidation_handler;
...
- (void)add_device_client:(unsigned int)a0 client_id:(unsigned int)a1 process_id:(int)a2 is_native_endianess:(char)a3 bundle_id:(id)a4 reply:(id /* block */)a5;
...
- (void)create_device:(id)a0 client_id:(unsigned int)a1 process_id:(int)a2 is_native_endianess:(char)a3 bundle_id:(id)a4 reply:(id /* block */)a5;
...
- (id)init_driver_interface:(struct AudioServerPlugInDriverInterface **)a0 invalidation_handler:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[32]; } x0; void *x1; } x0; })a1;
...
- (void)remove_device_client:(unsigned int)a0 client_id:(unsigned int)a1 process_id:(int)a2 is_native_endianess:(char)a3 bundle_id:(id)a4 reply:(id /* block */)a5;
