@class BAAgentClientProxy, NSString, BADownloaderExtensionConnection, NSMutableDictionary, NSObject;
...
- (id)init;
- (void).cxx_destruct;
- (char)cancelDownload:(id)a0 error:(id *)a1;
...
- (char)scheduleDownload:(id)a0 error:(id *)a1;
- (char)startForegroundDownload:(id)a0 error:(id *)a1;
