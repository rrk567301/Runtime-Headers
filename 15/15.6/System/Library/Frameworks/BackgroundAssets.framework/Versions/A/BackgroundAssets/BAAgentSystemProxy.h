...
- (void).cxx_destruct;
- (void)invalidate;
- (char)applicationEventPerformedWithDescriptor:(id)a0 error:(id *)a1;
- (char)applicationPrepareWithDescriptor:(id)a0 error:(id *)a1;
- (char)applicationShouldTriggerPeriodicWithIdentifier:(id)a0 bundleURLPath:(id)a1 error:(id *)a2;
- (void)receiveAppStoreProgressWithAppBundleIdentifier:(id)a0 progressInfo:(id)a1;
- (void)runDebugCommand:(id)a0;
- (char)updateAppStoreProgressObservationWithConfiguration:(id)a0 error:(id *)a1;
