...
- (id)initClient;
- (void)installedExtensionWithBundleID:(id)a0 synchronous:(char)a1 replyHandler:(id /* block */)a2;
- (void)installedExtensionWithShortName:(id)a0 synchronous:(char)a1 replyHandler:(id /* block */)a2;
...
- (void)setEnabledStateForIdentifier:(id)a0 newState:(char)a1 replyHandler:(id /* block */)a2;
