...
- (id)localizedMessage:(id)a0 table:(id)a1 bundle:(id)a2 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a3;
- (id)localizedMessage:(id)a0 table:(id)a1 bundle:(id)a2 array:(id)a3;
- (void)logLocalizedMessage:(id)a0 table:(id)a1 bundle:(id)a2;
- (void)logLocalizedMessage:(id)a0 table:(id)a1 bundle:(id)a2 arguments:(struct __va_list_tag { unsigned int x0; unsigned int x1; void *x2; void *x3; }[1])a3;
