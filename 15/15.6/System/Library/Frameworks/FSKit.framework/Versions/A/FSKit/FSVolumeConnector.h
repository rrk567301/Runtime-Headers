...
- (void)readDirectory:(id)a0 withAttr:(char)a1 requestedAttributes:(unsigned long long)a2 intoBuffer:(id)a3 cookie:(unsigned long long)a4 verifier:(unsigned long long)a5 requestID:(unsigned long long)a6 replyHandler:(id /* block */)a7;
...
- (void)setUpdateInterest:(id)a0 interest:(char)a1 requestID:(unsigned long long)a2 replyHandler:(id /* block */)a3;
