...
@property char usedByImageCapture;
...
- (char)isOpen;
- (char)supportedMatch:(struct TW_IDENTITY { char *x0; struct TW_VERSION { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned char x4[34]; } x1; unsigned short x2; unsigned short x3; unsigned int x4; unsigned char x5[34]; unsigned char x6[34]; unsigned char x7[34]; } *)a0;
