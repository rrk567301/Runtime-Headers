...
@property (nonatomic) char hasQueriedIsIncremental;
...
@property (readonly, nonatomic, getter=isIncremental) char incremental;
...
- (id)_remoteObjectProxyWithErrorHandler:(id /* block */)a0 synchronous:(char)a1;
