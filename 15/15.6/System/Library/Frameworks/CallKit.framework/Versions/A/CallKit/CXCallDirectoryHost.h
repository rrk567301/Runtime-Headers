...
- (char)_connectionContainsCallDirectoryHostEntitlementCapability:(id)a0;
...
- (oneway void)firstIdentificationEntriesForEnabledExtensionsWithPhoneNumbers:(id)a0 cacheOnly:(char)a1 reply:(id /* block */)a2;
...
- (oneway void)setEnabled:(char)a0 forExtensionWithIdentifier:(id)a1 reply:(id /* block */)a2;
- (oneway void)setEnabled:(char)a0 forLiveLookupExtensionWithIdentifier:(id)a1 reply:(id /* block */)a2;
