...
- (void)serviceServer:(id)a0 client:(id)a1 reportedIncomingTransmissionStartedForChannelWithUUID:(id)a2 update:(id)a3 shouldReplaceOutgoingTransmission:(char)a4 completionHandler:(id /* block */)a5;
