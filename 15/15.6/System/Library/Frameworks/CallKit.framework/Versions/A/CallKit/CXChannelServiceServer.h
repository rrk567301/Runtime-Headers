...
- (void)serviceClient:(id)a0 reportedIncomingTransmissionStartedForChannelWithUUID:(id)a1 update:(id)a2 shouldReplaceOutgoingTransmission:(char)a3 completionHandler:(id /* block */)a4;
