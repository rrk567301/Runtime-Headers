...
- (void)_didReceivePushPayload:(id)a0 channelUUID:(id)a1 reply:(id /* block */)a2 isServiceUpdateMessage:(char)a3 isHighPriority:(char)a4 remainingHighPriorityBudget:(long long)a5;
...
- (void)reportIncomingTransmissionStartedForChannelWithUUID:(id)a0 update:(id)a1 shouldReplaceOutgoingTransmission:(char)a2 completionHandler:(id /* block */)a3;
