...
- (char)fetchLiveBlockingInfoForHandle:(id)a0 timeout:(double)a1;
- (id)firstEnabledLiveBlockingExtensionIdentifierForPhoneNumber:(id)a0 timeout:(double)a1;
- (void)firstIdentificationEntriesForEnabledExtensionsWithPhoneNumbers:(id)a0 cacheOnly:(char)a1 completionHandler:(id /* block */)a2;
- (void)firstIdentificationEntryForEnabledExtensionWithPhoneNumber:(id)a0 cacheOnly:(char)a1 completionHandler:(id /* block */)a2;
...
- (void)setEnabled:(char)a0 forExtensionWithIdentifier:(id)a1 completionHandler:(id /* block */)a2;
