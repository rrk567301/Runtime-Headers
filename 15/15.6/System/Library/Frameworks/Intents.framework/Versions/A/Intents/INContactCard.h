...
+ (id)initWithContactIdentifier:(id)a0 nameComponents:(id)a1 isMe:(char)a2 image:(id)a3 organizationName:(id)a4 departmentName:(id)a5 jobTitle:(id)a6 phoneNumbers:(id)a7 emailAddresses:(id)a8 postalAddresses:(id)a9 urlAddresses:(id)a10 contactRelations:(id)a11 instantMessageAddresses:(id)a12 birthday:(id)a13 dates:(id)a14;
