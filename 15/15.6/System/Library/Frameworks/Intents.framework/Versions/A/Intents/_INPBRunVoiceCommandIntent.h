...
@property (readonly, nonatomic) char hasExecutionResult;
@property (retain, nonatomic) _INPBIntentMetadata *intentMetadata;
@property (readonly, nonatomic) char hasIntentMetadata;
@property (retain, nonatomic) _INPBVoiceCommandDeviceInformation *originDevice;
@property (readonly, nonatomic) char hasOriginDevice;
@property (copy, nonatomic) NSString *previousIntentIdentifier;
@property (readonly, nonatomic) char hasPreviousIntentIdentifier;
