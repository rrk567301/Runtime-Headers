...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, nonatomic, getter=_intents_isExemptFromMulitWindowRequirementForInAppHandling) char _intents_exemptFromMulitWindowRequirementForInAppHandling;
@property (readonly, nonatomic) char _intents_hasSystemIntentHandler;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
@property (nonatomic, getter=_isPrimaryDisplayDisabled, setter=_setPrimaryDisplayDisabled:) char _primaryDisplayDisabled;
...
@property (readonly, nonatomic) char _supportsBackgroundExecution;
@property (readonly, nonatomic, getter=_isConfigurable) char _configurable;
@property (readonly, nonatomic, getter=_isEligibleForSuggestions) char _eligibleForSuggestions;
...
@property (nonatomic, getter=_isUserConfirmationRequired, setter=_setUserConfirmationRequired:) char _userConfirmationRequired;
...
@property (nonatomic, setter=_setShouldForwardToAppOnSuccess:) char _shouldForwardToAppOnSucccess;
...
@property (nonatomic) char didAuthenticateAppProtection;
...
- (id)_emptyCopy;
- (char)_enumerateWithValueProcessingBlock:(id /* block */)a0;
- (char)_hasMatchingIntentHandlerIncludingRemoteExecution:(char)a0;
...
- (char)_isValueValidForKey:(id)a0 unsupportedReason:(id *)a1;
...
- (char)_supportsBackgroundExecutionWithOptions:(unsigned long long)a0;
