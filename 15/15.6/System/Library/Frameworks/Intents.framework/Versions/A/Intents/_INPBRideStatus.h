...
@property (readonly, nonatomic) char hasCompletionStatus;
@property (retain, nonatomic) _INPBRideDriver *driver;
@property (readonly, nonatomic) char hasDriver;
...
@property (readonly, nonatomic) char hasEstimatedDropOffDate;
...
@property (readonly, nonatomic) char hasEstimatedPickupEndDate;
...
@property (readonly, nonatomic) char hasRideIdentifier;
@property (retain, nonatomic) _INPBRideOption *rideOption;
@property (readonly, nonatomic) char hasRideOption;
...
@property (readonly, nonatomic) char hasUserActivityForCancelingInApplication;
@property (retain, nonatomic) _INPBRideVehicle *vehicle;
@property (readonly, nonatomic) char hasVehicle;
