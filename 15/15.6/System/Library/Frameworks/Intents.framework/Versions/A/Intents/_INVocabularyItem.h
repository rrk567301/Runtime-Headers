...
@property (readonly, nonatomic) char requiresUserIdentification;
...
- (id)initWithString:(id)a0 vocabularyIdentifier:(id)a1 requiresUserIdentification:(char)a2;
- (id)_dictionaryForSaving;
- (id)_initWithUncheckedSpeakable:(id)a0;
- (id)_initWithUncheckedString:(id)a0 vocabularyIdentifier:(id)a1 requiresUserIdentification:(char)a2;
- (id)_initWithVocabularyItem:(id)a0;
- (char)_isSimilarEnoughToNotSync:(id)a0;
