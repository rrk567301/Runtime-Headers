...
@property (readonly) char resolvedAllParametersSuccesfully;
...
- (id)initWithResolvedIntent:(id)a0 resolvedParameters:(id)a1 resolvedAllParametersSuccesfully:(char)a2 confirmResponse:(id)a3 handleResponse:(id)a4;
