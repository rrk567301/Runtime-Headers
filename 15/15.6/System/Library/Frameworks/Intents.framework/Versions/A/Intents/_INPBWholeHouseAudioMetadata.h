...
@property (nonatomic) char hasExcept;
@property (nonatomic) char hasHasExcept;
...
@property (nonatomic) char isAllSpeakers;
@property (nonatomic) char hasIsAllSpeakers;
@property (nonatomic) char isInHere;
@property (nonatomic) char hasIsInHere;
@property (nonatomic) char isParticipatingSpeaker;
@property (nonatomic) char hasIsParticipatingSpeaker;
@property (nonatomic) char isPauseOrStop;
@property (nonatomic) char hasIsPauseOrStop;
@property (nonatomic) char isWholeHouseAudioCommand;
@property (nonatomic) char hasIsWholeHouseAudioCommand;
@property (nonatomic) int numberOfHomeAutomationWords;
@property (nonatomic) char hasNumberOfHomeAutomationWords;
