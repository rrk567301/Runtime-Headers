...
@property (nonatomic, getter=isDeprecated) char deprecated;
@property (nonatomic, getter=isConfigurable) char configurable;
@property (nonatomic, getter=isEligibleForSuggestions) char eligibleForSuggestions;
@property (nonatomic, getter=isEligibleForWidgets) char eligibleForWidgets;
