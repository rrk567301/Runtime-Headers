...
@property (readonly, nonatomic, getter=_isSuccess) char _success;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
@property (readonly, nonatomic) char _userConfirmationRequired;
@property (readonly, nonatomic) char _shouldForwardIntentToApp;
@property (nonatomic, setter=_setRequiresProtectedData:) char _requiresProtectedData;
@property (readonly, nonatomic) NSString *_className;
@property (readonly, nonatomic) long long _type;
@property (nonatomic, setter=_setRequiresAuthentication:) char _requiresAuthentication;
...
- (id)_renderedResponseForLanguage:(id)a0 requiresSiriCompatibility:(char)a1;
- (id)_renderedResponseWithLocalizer:(id)a0 requiresSiriCompatibility:(char)a1;
- (id)_responseTemplateForLanguage:(id)a0;
- (id)_responseTemplateForLanguage:(id)a0 requiresSiriCompatibility:(char)a1;
- (id)_responseTemplateWithLocalizer:(id)a0 requiresSiriCompatibility:(char)a1;
