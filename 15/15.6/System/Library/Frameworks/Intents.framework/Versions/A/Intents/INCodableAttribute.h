...
@property (nonatomic, getter=isFixedSizeArray) char fixedSizeArray;
@property (copy, nonatomic) NSString *propertyName;
@property (copy, nonatomic) NSString *displayName;
@property (copy, nonatomic) NSString *displayNameID;
@property (nonatomic, getter=isDefaultAttribute) char defaultAttribute;
@property (nonatomic, getter=isConfigurable) char configurable;
@property (nonatomic) char supportsResolution;
@property (nonatomic) char supportsDynamicEnumeration;
