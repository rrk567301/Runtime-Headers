...
@property (readonly, nonatomic) char _hasAssociatedAuditToken;
@property (nonatomic, getter=_isMarkedForDeletionOnDeallocation, setter=_setMarkedForDeletionOnDeallocation:) char _markedForDeletionOnDeallocation;
...
- (char)_associatedAuditTokenIsEqualToAuditToken:(struct { unsigned int x0[8]; })a0;
...
- (char)_intents_enumerateObjectsOfClass:(Class)a0 withBlock:(id /* block */)a1;
