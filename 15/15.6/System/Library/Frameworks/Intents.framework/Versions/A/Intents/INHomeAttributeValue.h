...
- (id)initWithType:(long long)a0 boolValue:(char)a1 doubleValue:(double)a2 integerValue:(long long)a3 stringValue:(id)a4 limitValue:(long long)a5 unit:(long long)a6 rangeValue:(id)a7;
