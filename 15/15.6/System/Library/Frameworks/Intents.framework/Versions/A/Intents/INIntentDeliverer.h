...
- (id /* block */)_processResolutionDataProviderForIntent:(id)a0 intentSlotDescription:(id)a1 updateIntent:(char)a2 completion:(id /* block */)a3;
- (void)_resolveIntentParameter:(id)a0 forIntent:(id)a1 intentHandler:(id)a2 updateIntent:(char)a3 withCompletion:(id /* block */)a4;
...
- (char)_updateIntent:(id)a0 intentSlotDescription:(id)a1 resolutionResultDataProvider:(id)a2;
