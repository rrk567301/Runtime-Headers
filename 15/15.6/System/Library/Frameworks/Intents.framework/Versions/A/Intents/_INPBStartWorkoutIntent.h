...
@property (readonly, nonatomic) char hasCustomization;
@property (retain, nonatomic) _INPBDouble *goalValue;
@property (readonly, nonatomic) char hasGoalValue;
@property (retain, nonatomic) _INPBIntentMetadata *intentMetadata;
@property (readonly, nonatomic) char hasIntentMetadata;
@property (nonatomic) char isBuiltInWorkoutType;
@property (nonatomic) char hasIsBuiltInWorkoutType;
@property (nonatomic) char isOpenEnded;
@property (nonatomic) char hasIsOpenEnded;
@property (nonatomic) char isVoiceOnly;
@property (nonatomic) char hasIsVoiceOnly;
@property (nonatomic) int sequenceLabel;
@property (nonatomic) char hasSequenceLabel;
@property (nonatomic) int workoutGoalUnitType;
@property (nonatomic) char hasWorkoutGoalUnitType;
@property (nonatomic) int workoutLocationType;
@property (nonatomic) char hasWorkoutLocationType;
@property (retain, nonatomic) _INPBDataString *workoutName;
@property (readonly, nonatomic) char hasWorkoutName;
