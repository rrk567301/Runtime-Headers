...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly) char currentLocation;
...
- (id)_initWithCurrentLocation:(char)a0 file:(id)a1 speechDataURL:(id)a2 audioMessageFile:(id)a3 sharedLink:(id)a4 phAssetId:(id)a5;
