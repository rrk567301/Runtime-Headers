...
- (id)cachedSummaryForIntent:(id)a0 languageCode:(id)a1 creatingIfNeeded:(char)a2;
- (char)getSubtitle:(id *)a0 forIntent:(id)a1 languageCode:(id)a2;
- (char)getTitle:(id *)a0 forIntent:(id)a1 languageCode:(id)a2;
