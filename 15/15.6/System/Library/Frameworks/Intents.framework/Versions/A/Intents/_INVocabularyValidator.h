...
- (char)_bundleID:(id)a0 isWhitelistedForVocabularyType:(long long)a1;
...
- (id)_validatedItemsFromVocabularyObject:(id)a0 ofType:(long long)a1 loggingWarnings:(char)a2 withItemFactory:(id /* block */)a3;
...
- (id)validatedItemsFromVocabularySpeakables:(id)a0 ofType:(long long)a1 loggingWarnings:(char)a2;
- (id)validatedItemsFromVocabularyStrings:(id)a0 ofType:(long long)a1 loggingWarnings:(char)a2;
