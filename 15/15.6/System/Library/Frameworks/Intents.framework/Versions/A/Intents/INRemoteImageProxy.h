...
+ (void)requestProxyByStoringImage:(id)a0 qualityOfService:(unsigned int)a1 scaled:(char)a2 storeType:(unsigned long long)a3 completion:(id /* block */)a4;
+ (id)requestProxyByStoringImage:(id)a0 qualityOfService:(unsigned int)a1 scaled:(char)a2 storeType:(unsigned long long)a3 error:(id *)a4;
