...
- (void)writeTo:(id)a0;
- (id)_data;
- (char)_writeTo:(id)a0 error:(id *)a1;
...
- (char)_boolValueForAttribute:(id)a0;
- (id)_copyWithZone:(struct _NSZone { } *)a0 error:(id *)a1;
- (id)_dictionaryRepresentationWithNullValues:(char)a0;
...
- (char)_isAttribute:(id)a0 equalTo:(id)a1;
- (char)_isStringAttribute:(id)a0 equalTo:(id)a1;
- (id)_nonNilAttributes;
- (id)_nonNilRepeatedAttributes;
- (char)_readFrom:(id)a0 error:(id *)a1;
