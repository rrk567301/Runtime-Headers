...
@property (readonly, nonatomic) char isEnum;
...
@property (readonly, nonatomic) char isExtended;
...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithName:(id)a0 tag:(unsigned long long)a1 facadePropertyName:(id)a2 dataPropertyName:(id)a3 isExtended:(char)a4 isPrivate:(char)a5 valueType:(long long)a6 valueStyle:(long long)a7 codableAttribute:(id)a8 defaultValueSelectorStrings:(id)a9 provideOptionsSelectorStrings:(id)a10 resolutionResultClass:(Class)a11 resolveSelectors:(SEL)a12;
- (id)initWithName:(id)a0 tag:(unsigned long long)a1 facadePropertyName:(id)a2 dataPropertyName:(id)a3 isExtended:(char)a4 isPrivate:(char)a5 valueType:(long long)a6 valueStyle:(long long)a7 defaultValueSelectorStrings:(id)a8 provideOptionsSelectorStrings:(id)a9 resolutionResultClass:(Class)a10 resolveSelectors:(SEL)a11;
- (id)initWithName:(id)a0 tag:(unsigned long long)a1 facadePropertyName:(id)a2 dataPropertyName:(id)a3 valueType:(long long)a4 valueStyle:(long long)a5 isExtended:(char)a6 isPrivate:(char)a7 resolveSelectors:(SEL)a8;
