...
@property (readonly, nonatomic, getter=isCanceledByService) char canceledByService;
...
@property (readonly, getter=isMissedPickup) char missedPickup;
@property (readonly) INCurrencyAmount *paymentAmount;
@property (readonly) unsigned long long feedbackType;
@property (readonly, getter=isOutstanding) char outstanding;
...
- (id)_initCompleted:(char)a0 canceledByService:(char)a1 missedPickup:(char)a2 amount:(id)a3 feedbackType:(unsigned long long)a4 outstanding:(char)a5;
