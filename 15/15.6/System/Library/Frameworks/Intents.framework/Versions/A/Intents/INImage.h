...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, nonatomic) char _isEligibleForProxying;
@property (readonly, nonatomic) char _isSupportedForDonation;
...
@property (readonly, nonatomic, getter=_isSystem) char system;
@property (readonly, nonatomic) char _requiresRetrieval;
