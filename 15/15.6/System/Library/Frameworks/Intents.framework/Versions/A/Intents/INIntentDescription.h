...
- (char)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithName:(id)a0 responseName:(id)a1 facadeClass:(Class)a2 dataClass:(Class)a3 type:(id)a4 isPrivate:(char)a5 handleSelector:(SEL)a6 confirmSelector:(SEL)a7 slotsByName:(id)a8;
- (id)slotByName:(id)a0;
- (id)slotDescriptions;
