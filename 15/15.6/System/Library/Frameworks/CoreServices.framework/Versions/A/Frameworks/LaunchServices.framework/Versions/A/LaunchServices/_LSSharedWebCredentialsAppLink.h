...
+ (char)_areAppLinksEnabledForServiceDetails:(id)a0 cachedSettings:(id *)a1;
+ (char)_setSWCSetting:(id)a0 forKey:(id)a1 withApplicationIdentifier:(id)a2 error:(id *)a3;
...
- (char)_setSWCSetting:(id)a0 forKey:(id)a1 error:(id *)a2;
- (char)isEnabled;
