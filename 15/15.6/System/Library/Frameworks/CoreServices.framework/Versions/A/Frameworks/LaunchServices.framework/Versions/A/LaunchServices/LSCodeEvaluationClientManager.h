...
- (char)_checkAllowed32BitHostProcess:(id)a0;
...
- (char)getUID:(unsigned int *)a0 forSystemProcessAlertsForUID:(unsigned int)a1;
...
- (id)opMapCopy;
- (char)presentPromptOfType:(long long)a0 options:(long long)a1 info:(id)a2 completion:(id /* block */)a3;
...
- (char)updateQuarantineFlagsForInfo:(id)a0 setFlags:(int)a1 clearFlags:(int)a2;
