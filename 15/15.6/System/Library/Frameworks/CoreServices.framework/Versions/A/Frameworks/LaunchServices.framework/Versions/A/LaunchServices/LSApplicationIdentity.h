...
+ (char)personaWithUniqueString:(id)a0 getPersonaType:(unsigned long long *)a1 error:(id *)a2;
...
- (id)initWithBundleIdentifier:(id)a0 allowPlaceholder:(char)a1 personaUniqueString:(id)a2 error:(id *)a3;
