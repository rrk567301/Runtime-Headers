...
- (char)_canRegisterOrUnregisterURL:(id)a0 withOptions:(unsigned int)a1;
- (char)canRegisterContainer;
- (char)canRegisterURL:(id)a0 withOptions:(unsigned int)a1;
- (char)canUnregisterWithOptions:(unsigned int)a0;
- (char)clientHasMIEntitlement:(id)a0;
- (char)clientIsEntitledForEmbeddedRegistrationOperations;
...
- (void)setDatabaseIsSeeded:(char)a0 completionHandler:(id /* block */)a1;
...
- (void)updateRecordForApp:(id)a0 withSINF:(id)a1 iTunesMetadata:(id)a2 placeholderMetadata:(id)a3 sendNotification:(int)a4 operationUUID:(id)a5 returnSaveToken:(char)a6 completionHandler:(id /* block */)a7;
- (void)willHandleInvocation:(id)a0 isReply:(char)a1;
