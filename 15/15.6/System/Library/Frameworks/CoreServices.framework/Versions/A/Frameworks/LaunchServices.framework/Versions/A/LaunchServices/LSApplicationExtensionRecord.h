...
@property (readonly) char optsOutOfAppProtectionShield;
...
- (void).cxx_destruct;
- (id)initWithURL:(id)a0 requireValid:(char)a1 error:(id *)a2;
- (unsigned long long)_containerClass;
- (id)_initWithUUID:(id)a0 node:(id)a1 bundleIdentifier:(id)a2 context:(struct LSContext { id x0; } *)a3 requireValid:(char)a4 error:(id *)a5;
...
- (id)_initWithUUID:(id)a0 node:(id)a1 bundleIdentifier:(id)a2 platform:(unsigned int)a3 context:(struct LSContext { id x0; } *)a4 requireValid:(char)a5 allowRedacted:(char)a6 error:(id *)a7;
...
- (char)appProtectionHidden;
- (char)appProtectionLocked;
...
- (id)initWithBundleIdentifier:(id)a0 requireValid:(char)a1 error:(id *)a2;
- (id)initWithBundleIdentifier:(id)a0 requireValid:(char)a1 platform:(unsigned int)a2 error:(id *)a3;
- (id)initWithURL:(id)a0 error:(id *)a1;
- (id)initWithUUID:(id)a0 error:(id *)a1;
- (id)initWithUUID:(id)a0 requireValid:(char)a1 error:(id *)a2;
