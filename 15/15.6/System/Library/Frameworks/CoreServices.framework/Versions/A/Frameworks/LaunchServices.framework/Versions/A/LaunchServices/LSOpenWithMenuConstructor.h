...
@property (nonatomic) char showAppStoreMenuItem;
@property (nonatomic) char showOtherMenuItem;
@property (nonatomic) char allowMenuWithNoApplications;
@property (nonatomic, getter=isOtherPanelAlwaysModal) char otherPanelAlwaysModal;
@property (nonatomic, getter=isStronglyBoundApplicationIncluded) char stronglyBoundApplicationIncluded;
@property (nonatomic, getter=areUniversalLinksIncluded) char universalLinksIncluded;
