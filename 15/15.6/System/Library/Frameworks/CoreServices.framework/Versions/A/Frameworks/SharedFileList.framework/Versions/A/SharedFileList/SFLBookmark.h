...
@property (readonly, getter=isStale) char stale;
@property (readonly, getter=isResolved) char resolved;
...
- (char)isEqual:(id)a0 requiredMatchResult:(long long)a1;
- (void)resolveWithCompletion:(id /* block */)a0;
- (char)resolveWithOptions:(unsigned long long)a0;
- (void)resolveWithOptions:(unsigned long long)a0 completion:(id /* block */)a1;
- (char)resolveWithOptions:(unsigned long long)a0 relativeToURL:(id)a1;
- (void)resolveWithOptions:(unsigned long long)a0 relativeToURL:(id)a1 completion:(id /* block */)a2;
- (char)resolveWithOptions:(unsigned long long)a0 relativeToURL:(id)a1 error:(id *)a2;
