...
- (id).cxx_construct;
- (char)containerizedBundleExistsForIdentifier:(id)a0;
...
- (char)fullBundleExistsForIdentifier:(id)a0 matchingNode:(id)a1;
...
- (unsigned int)registerBundleNodeReinitializingContext:(id)a0 inBundleContainer:(char)a1 installDictionary:(id)a2 personasWithAttributes:(id)a3 error:(id *)a4;
- (char)registerNonBundledExtensionPointWithIdentifier:(id)a0 platform:(unsigned int)a1 SDKDict:(id)a2 url:(id)a3 error:(id *)a4;
- (char)registerPluginNodeReinitializingContext:(id)a0 installDictionary:(id)a1 existingPlugin:(unsigned int)a2 error:(id *)a3;
...
- (char)unregisterNonBundledExtensionPointWithIdentifier:(id)a0 error:(id *)a1;
- (char)unregisterPluginBundleByUnit:(unsigned int)a0 error:(id *)a1;
