...
@property (readonly) char allowedToCreateTemplateApplication;
@property (readonly) char allowedToUpdateTemplateApplication;
@property (readonly) char allowedToListApplications;
@property (readonly) char allowedToModifyDataVaultItems;
...
- (id)connection;
- (void)invalidate;
- (char)allowedToCreateTemplateApplication;
- (char)allowedToListApplications;
- (char)allowedToModifyDataVaultItems;
- (char)allowedToUpdateTemplateApplication;
