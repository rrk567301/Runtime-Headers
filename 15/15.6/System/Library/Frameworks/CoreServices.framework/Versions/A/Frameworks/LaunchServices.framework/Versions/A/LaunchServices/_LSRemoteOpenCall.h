...
@property (class, readonly) char canInvokeLocally;
@property (class, readonly) char canInvokeRemotely;
...
- (void)getOutAppWasLaunched:(char *)a0;
- (void)getOutPSNs:(struct ProcessSerialNumber { unsigned int x0; unsigned int x1; } *)a0;
- (id)initWithXPCConnection:(id)a0;
- (char)invokeWithError:(id *)a0;
- (char)invokeWithXPCConnection:(id)a0 error:(id *)a1;
- (char)openLocallyFromCaller:(struct { unsigned int x0[8]; })a0 error:(id *)a1;
...
- (void)setInAppParams:(const struct LSApplicationParameters_V1 { long long x0; unsigned int x1; struct FSRef *x2; void *x3; struct __CFDictionary *x4; struct __CFArray *x5; struct AEDesc *x6; struct __CFArray *x7; struct __CFURL *x8; struct ProcessSerialNumber *x9; } *)a0 inheritEnvironment:(char)a1;
