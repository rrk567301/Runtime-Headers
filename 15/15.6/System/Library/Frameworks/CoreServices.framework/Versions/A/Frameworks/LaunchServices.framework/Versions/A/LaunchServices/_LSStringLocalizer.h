...
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { } *)a0 infoDictionary:(id)a1 domains:(unsigned int)a2 delegatesMightBeMainBundle:(char)a3 legacyLocalizationList:(char)a4;
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { } *)a0 infoDictionary:(id)a1 domains:(unsigned int)a2 legacyLocalizationList:(char)a3;
+ (void)gatherLocalizedStringsForLSBundleProvider:(id)a0 infoDictionary:(id)a1 domains:(unsigned int)a2 delegatesMightBeMainBundle:(char)a3 legacyLocalizationList:(char)a4;
...
+ (id)localizedSystemFolderNameForNode:(id)a0 dictionaryRequested:(char)a1 preferredLocalizations:(id)a2 context:(struct LSContext { id x0; } *)a3;
...
+ (id)newSystemFolderLocalizer;
+ (id)preferredLocalizationsForXCTests;
+ (void)setPreferredLocalizationsForXCTests:(id)a0;
+ (char)useLegacyLocalizationListForPlatform:(unsigned int)a0 sdkVersion:(unsigned int)a1;
...
- (id)initWithBundleProvider:(id)a0 stringsFile:(id)a1 legacyLocalizationList:(char)a2;
- (id)initWithBundleURL:(id)a0 stringsFile:(id)a1;
- (id)initWithBundleURL:(id)a0 stringsFile:(id)a1 checkMainBundle:(char)a2 legacyLocalizationList:(char)a3;
- (id)initWithBundleURL:(id)a0 stringsFile:(id)a1 legacyLocalizationList:(char)a2;
- (id)initWithCFBundle:(struct __CFBundle { } *)a0 stringsFile:(id)a1;
- (id)initWithCFBundle:(struct __CFBundle { } *)a0 stringsFile:(id)a1 legacyLocalizationList:(char)a2;
