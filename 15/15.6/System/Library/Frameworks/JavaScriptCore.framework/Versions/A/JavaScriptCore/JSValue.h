...
@property (readonly) char isSymbol;
@property (readonly) char isBigInt;

+ (SEL)selectorForStructToValue:(const char *)a0;
+ (SEL)selectorForValueToStruct:(const char *)a0;
+ (id)valueWithBool:(char)a0 inContext:(id)a1;
...
- (char)isInstanceOf:(id)a0;
- (char)toBool;
- (id)toDictionary;
- (id)toNumber;
- (char)deleteProperty:(id)a0;
- (int)toInt32;
...
- (char)isEqualToObject:(id)a0;
- (char)isEqualWithTypeCoercionToObject:(id)a0;
- (double)toDouble;
- (id)toObject;
