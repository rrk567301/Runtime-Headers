...
@property (nonatomic, getter=isInspectable) char inspectable;
...
- (void)_setIncludesNativeCallStackWhenReportingExceptions:(char)a0;
- (void)_setRemoteInspectionEnabled:(char)a0;
...
- (char)boolFromNotifyException:(struct OpaqueJSValue { } *)a0;
