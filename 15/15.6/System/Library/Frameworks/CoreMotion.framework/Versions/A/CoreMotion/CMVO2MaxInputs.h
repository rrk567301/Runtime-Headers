...
@property (readonly, nonatomic) char hasStrideCal;
...
- (id)initWithRecordId:(unsigned long long)a0 startDate:(id)a1 mets:(double)a2 metSource:(long long)a3 heartRate:(double)a4 heartRateConfidence:(double)a5 gradeType:(long long)a6 grade:(double)a7 cadence:(double)a8 pace:(double)a9 hasGPS:(char)a10 hasStrideCal:(char)a11 workoutType:(long long)a12;
