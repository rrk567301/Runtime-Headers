...
+ (char)workoutIsSupportedForLowPower:(long long)a0;
+ (char)workoutIsTypePedestrian:(long long)a0;
+ (char)workoutIsTypeRunning:(long long)a0;
+ (char)workoutIsTypeWalking:(long long)a0;
...
- (void)setIsUserInitiated:(char)a0;
