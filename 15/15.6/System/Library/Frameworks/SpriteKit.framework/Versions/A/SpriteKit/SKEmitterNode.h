@class SKAction, SKTexture, SKKeyframeSequence, NSDictionary, SKNode, SKShader, NSColor;
...
- (void)setUsesPointSprites:(char)a0;
- (void)setValue:(id)a0 forAttributeNamed:(id)a1;
- (void)setWantsNewParticles:(char)a0;
- (id)subEmitterNode;
- (char)usesPointSprites;
- (id)valueForAttributeNamed:(id)a0;
- (char)wantsNewParticles;
