...
@property (nonatomic, getter=isAccessibilityElement) char accessibilityElement;
...
@property (nonatomic, getter=isAccessibilityEnabled) char accessibilityEnabled;
@property (weak, nonatomic) GKEntity *entity;
...
- (char)hasActions;
- (id)nodeAtPoint:(struct CGPoint { double x0; double x1; })a0 recursive:(char)a1;
- (id)physicsField;
...
- (char)_pathFromPhysicsBodyToPoints:(void **)a0 outSize:(unsigned long long *)a1;
...
- (void)_enumerateChildNodesWithName:(id)a0 usingBlock:(id /* block */)a1 stopPointer:(char *)a2;
- (void)_flippedChangedFrom:(char)a0 to:(char)a1;
- (void)_initAccessibility;
- (void *)_makeBackingNode;
- (void)_processSearchTokens:(struct vector<Token, std::allocator<Token>> { struct Token *x0; struct Token *x1; struct __compressed_pair<Token *, std::allocator<Token>> { struct Token *x0; } x2; })a0 visited:(void *)a1 usingBlock:(id /* block */)a2 stopPointer:(char *)a3;
...
- (id)allIntersectionsWithNode:(id)a0 useAlphaTest:(char)a1;
...
- (char)containsPoint:(struct CGPoint { double x0; double x1; })a0 withRadius:(double)a1;
...
- (char)inParentHierarchy:(id)a0;
- (char)intersectsNode:(id)a0 useAlphaTest:(char)a1;
