...
- (struct CGImage { } *)copyRotateCGImage:(struct CGImage { } *)a0 direction:(char)a1;
- (id)generateMetaData;
- (void)generateTextureAtlasImages:(id)a0 outputDictionary:(id *)a1 forcePOT:(char)a2;
- (id)getTextureFileList:(id)a0 modDate:(id *)a1;
- (char)isFullyOpaque:(struct CGImage { } *)a0;
