...
@property (nonatomic) char requiresBiasCorrection;
...
@property (nonatomic) char canInteract;
...
@property (nonatomic) char resetARSession;
@property (nonatomic) char revokeFindingExperience;
