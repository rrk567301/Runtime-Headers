@class NSData, UTType, NSArray, NSDate, NSString, SWCollaborationShareOptions, NSDictionary, NSPersonNameComponents, CKContainerSetupInfo, _SWCollaborationMetadataType;
...
- (char)isEqualToCollaborationMetadata:(id)a0;
