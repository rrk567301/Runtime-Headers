...
@property char ignoresParentalRestrictions;
@property char ignoresContactProviderRestrictions;
@property char suppressChangeNotifications;
@property (copy, nonatomic) NSString *changeHistoryClientIdentifier;
@property (copy, nonatomic) NSString *transactionAuthor;
@property (nonatomic) char shouldRefetchContacts;
...
- (id)allContainerIdentifierStrings:(char *)a0;
- (id)allContainerIdentifiers:(char *)a0;
...
- (char)hasConflictingSaveOperations;
