...
@property (readonly, getter=isGuardianStateDirty) char guardianStateDirty;
...
@property (readonly, getter=isGuardianRestricted) char guardianRestricted;
@property (readonly, getter=isParentallyManaged) char parentallyManaged;
...
+ (id)predicateForContainersInAccountWithIdentifier:(id)a0 includingDisabledContainers:(char)a1;
+ (id)predicateForContainersIncludingDisabled:(char)a0;
+ (id)predicateForContainersWithType:(long long)a0 includingDisabledContainers:(char)a1;
+ (id)predicateForDefaultContainerForAccountWithIdentifier:(id)a0;
+ (id)predicateForLocalContainerIncludingDisabled:(char)a0;
...
- (id)initWithIdentifier:(id)a0 name:(id)a1 type:(long long)a2 iOSLegacyIdentifier:(int)a3 accountIdentifier:(id)a4 enabled:(char)a5 permissions:(id)a6 externalIdentifier:(id)a7 externalModificationTag:(id)a8 externalSyncTag:(id)a9 externalSyncData:(id)a10 constraintsPath:(id)a11 meIdentifier:(id)a12 restrictions:(unsigned long long)a13 guardianRestricted:(char)a14 lastSyncDate:(id)a15 providerIdentifier:(id)a16 providerMetadata:(id)a17;
