...
@property (nonatomic) char unifyContactsFromMainStore;
@property (retain, nonatomic) NSArray *decoratedValue;
@property (retain, nonatomic) NSArray *value;

+ (id)log;
+ (id)allNicknamesForContact:(id)a0;
+ (char)enableSharedPhoto;

- (void).cxx_destruct;
- (id)decoratedContacts:(id)a0;
- (char)doesKeysToFetchContainRequiredKeys;
- (id)initWithContacts:(id)a0 keysToFetch:(id)a1 unifyContactsFromMainStore:(char)a2;
- (id)initWithContactsFetchResult:(id)a0 keysToFetch:(id)a1 unifyContactsFromMainStore:(char)a2;
