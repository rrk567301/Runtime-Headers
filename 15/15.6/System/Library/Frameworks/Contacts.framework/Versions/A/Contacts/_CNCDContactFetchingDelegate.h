...
+ (id)os_log;
+ (char)shouldRethrowException:(id)a0;
...
- (char)retry:(id)a0 shouldContinueAfterError:(id)a1 onAttempt:(long long)a2;
- (char)retry:(id)a0 shouldContinueAfterException:(id)a1 onAttempt:(long long)a2;
