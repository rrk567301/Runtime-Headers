...
- (void)fetchEncodedContactsMatchingPredicate:(id)a0 unifyResults:(char)a1 keysToFetch:(id)a2;
...
- (void)fetchContactsMatchingPredicate:(id)a0 unifyResults:(char)a1 keysToFetch:(id)a2;
- (void)fetchContactsProgressivelyMatchingPredicate:(id)a0 unifyResults:(char)a1 keysToFetch:(id)a2;
