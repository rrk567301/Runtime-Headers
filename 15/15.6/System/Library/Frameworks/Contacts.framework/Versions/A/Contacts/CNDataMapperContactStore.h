...
@property (readonly, nonatomic) char isContactProvider;
...
+ (char)hasEnvironmentSettingsEnabledContactsOutOfProcess;
...
- (char)requestMetadataAccessWithError:(id *)a0;
...
- (char)_requestDataMapperAccessType:(unsigned long long)a0 error:(id *)a1;
...
- (char)isValidSaveRequest:(id)a0 authorizationContext:(id)a1 error:(id *)a2;
...
- (char)requestContactsReadAccessWithError:(id *)a0;
- (char)requestContactsWriteAccessWithError:(id *)a0;
...
- (char)supportsMatchingDictionaries;
