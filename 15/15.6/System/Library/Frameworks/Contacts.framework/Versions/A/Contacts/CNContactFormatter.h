...
@property (nonatomic) char emphasizesPrimaryNameComponent;
...
+ (id)abbreviatedStringFromContact:(id)a0 trimmingWhitespace:(char)a1;
...
+ (long long)nameEmphasisStyleForContact:(id)a0 localeBasedEmphasisStyle:(long long)a1 preferNickname:(char)a2;
+ (id)posterNameComponentsForContact:(id)a0 nameOrder:(long long)a1 localeEmphasisStyle:(long long)a2 preferNicknames:(char)a3;
