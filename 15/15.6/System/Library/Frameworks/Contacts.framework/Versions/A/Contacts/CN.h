...
+ (unsigned long long)indexOfPreferredContactsForUnifying:(id)a0 includingMainStoreContacts:(char)a1;
...
+ (char)areValidDayComponents:(id)a0 error:(id *)a1;
+ (char)areValidGregorianDayComponents:(id)a0 error:(id *)a1;
+ (char)areValidKeyPaths:(id)a0 forObject:(id)a1 expectedClasses:(id)a2 allowNil:(id)a3 error:(id *)a4;
+ (char)areValidNonGregorianDayComponents:(id)a0 error:(id *)a1;
...
+ (id)contactUnifyingContacts:(id)a0 includingMainStoreContacts:(char)a1 allowMutableContactFreeze:(char)a2;
...
+ (char)hasContactChineseJapaneseKoreanName:(id)a0;
+ (char)hasContactChineseJapaneseKoreanPhoneticName:(id)a0;
...
+ (char)isEmptyNameContact:(id)a0 phonetic:(char)a1 includingPrefixAndSuffix:(char)a2;
...
+ (id)mutableContactUnifyingContacts:(id)a0 includingMainStoreContacts:(char)a1;
+ (id)namePrefixDescription;
+ (id)orderForContactName:(id)a0;
+ (id)orderForContactName:(id)a0 phonetic:(char)a1;
...
+ (char)shouldContactUseFamilyGivenNameOrder:(id)a0;
