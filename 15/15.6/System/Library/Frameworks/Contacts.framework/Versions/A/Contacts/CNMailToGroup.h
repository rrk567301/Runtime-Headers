...
+ (id)os_log;
+ (id)bestGuessEmailAddressForAddresses:(id)a0 sendingAddressDomain:(id)a1 alreadyDuetRanked:(char)a2;
...
- (id)init;
- (void).cxx_destruct;
- (char)allContactsHaveEmailAddress:(id)a0;
- (id)bestGuessEmailAddressForContact:(id)a0;
- (id)mailUrlForContacts:(id)a0;
- (id)mailUrlForContacts:(id)a0 needsEmailAddresses:(char)a1;
