...
@property (nonatomic) char imageDataAvailable;
...
@property (nonatomic) char isUsingSharedPhoto;
@property unsigned long long flags;
@property (getter=isImplicitAugmentation) char implicitAugmentation;
...
@property (nonatomic, getter=isPreferredForName) char preferredForName;
@property (nonatomic, getter=isPreferredForImage) char preferredForImage;
...
- (void)setPreferredForName:(char)a0;
...
- (void)setImageDataAvailable:(char)a0;
- (void)setImplicitAugmentation:(char)a0;
- (void)setIsUsingSharedPhoto:(char)a0;
...
- (void)setPreferredForImage:(char)a0;
