...
- (id)_stringForSpotlightError:(id)a0 willRetry:(char)a1;
...
- (void)failedToDeleteAllSearchableItemsWithSpotlight:(id)a0 willRetry:(char)a1;
- (void)failedToEndIndexBatchWithSpotlight:(id)a0 willRetry:(char)a1;
- (void)failedToFetchClientStateFromSpotlight:(id)a0 willRetry:(char)a1;
- (void)failedToFetchContactForChange:(id)a0;
- (void)failedToFetchSearchableForContactIdentifiers:(id)a0 error:(id)a1;
- (void)failedToJournalItemIdentifiersForDeletionWithSpotlight:(id)a0 identifiers:(id)a1 willRetry:(char)a2;
- (void)failedToJournalSearchableItemsForIndexingWithSpotlight:(id)a0 identifiers:(id)a1 willRetry:(char)a2;
...
- (void)willBatchIndexForFullSyncWithCount:(unsigned long long)a0 lastOffset:(long long)a1 doneFullSync:(char)a2;
