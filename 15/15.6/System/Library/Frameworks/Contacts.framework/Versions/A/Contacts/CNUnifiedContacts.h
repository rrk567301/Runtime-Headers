...
+ (char)shouldIncludeLabeledValue:(id)a0 fromSource:(id)a1 inDestination:(id)a2 forProperty:(id)a3;
+ (unsigned long long)countOfLabelIncludingEquivalents:(id)a0 value:(id)a1 inMultiValue:(id)a2 forProperty:(id)a3;
+ (char)doesMultiValue:(id)a0 needLabeledValue:(id)a1 fromMultiValue:(id)a2 forProperty:(id)a3;
...
+ (char)shouldLabeledValue:(id)a0 replaceInferiorValueInMultiValue:(id)a1 forProperty:(id)a2;
...
+ (char)canUnifyLabel:(id)a0 withLabel:(id)a1 forProperty:(id)a2;
...
+ (unsigned long long)indexOfPreferredContactForWallpaper:(id)a0 prefersSharedImage:(char)a1;
...
+ (id)sortedContacts:(id)a0 withPreferredContact:(id)a1;
...
+ (void)unifyWallpaperOfContacts:(id)a0 intoContact:(id)a1 availableKeyDescriptor:(id)a2;
