...
+ (char)performLightweightMigrationIfNeededError:(id *)a0;
...
- (id)storeDescription;
- (char)createStoreDirectoryIfNeeded:(id *)a0;
- (id)initWithStoreLocation:(id)a0;
- (id)initWithStoreLocation:(id)a0 container:(id)a1;
- (char)performWorkWithManagedObjectContext:(id /* block */)a0 error:(id *)a1;
- (void)setupIfNeeded;
