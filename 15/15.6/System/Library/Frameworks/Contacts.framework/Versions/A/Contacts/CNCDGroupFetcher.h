...
+ (id)os_log;
+ (id)groupsMatchingPredicate:(id)a0 inPersistenceStack:(id)a1 allowGenericPredicate:(char)a2 error:(id *)a3;
...
- (id)initWithPredicate:(id)a0 persistenceContext:(id)a1 allowGenericPredicate:(char)a2;
