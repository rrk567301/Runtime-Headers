...
- (id)initWithIdentifier:(id)a0 imageData:(id)a1 lastUsedDate:(id)a2 cropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 source:(long long)a4 sourceIdentifier:(id)a5 variant:(id)a6 poseConfigurationData:(id)a7 displayString:(id)a8 ignoredForRevert:(char)a9;
