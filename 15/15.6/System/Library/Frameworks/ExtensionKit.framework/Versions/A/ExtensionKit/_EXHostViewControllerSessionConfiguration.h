...
@property (nonatomic) char beginHostingImmediately;
@property (nonatomic) long long sizeBridgingOptions;
@property (nonatomic) char retryOnHostingFailure;
...
@property (nonatomic) char _shouldHostRemoteTextEffectsWindow;
