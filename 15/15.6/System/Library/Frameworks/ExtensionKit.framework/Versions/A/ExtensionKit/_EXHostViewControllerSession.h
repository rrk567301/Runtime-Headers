@class NSView, NSXPCConnection, NSError, NSXPCListenerEndpoint, NSUUID, _EXRemoteViewController, _EXExtensionProcessHandle, NSString, NSObject, _EXHostConfiguration, NSXPCListener, _EXHostViewControllerSessionConfiguration;
...
- (id)initWithProcessConfiguration:(id)a0 configuration:(id)a1 detached:(char)a2;
