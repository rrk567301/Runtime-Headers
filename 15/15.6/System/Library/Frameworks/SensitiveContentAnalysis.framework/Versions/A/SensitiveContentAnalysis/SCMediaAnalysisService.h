...
- (id)_processMADResults:(char *)a0 requestID:(int)a1 error:(id)a2 request:(id)a3;
- (id)_processMADResults:(char *)a0 requestID:(int)a1 error:(id)a2 videoRequest:(id)a3;
...
- (void)isSensitivePixelBuffer:(struct __CVBuffer { } *)a0 withOrientation:(unsigned int)a1 completionHandler:(id /* block */)a2;
- (void)isSensitiveVideoFile:(id)a0 useBlastdoor:(char)a1 progressHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
