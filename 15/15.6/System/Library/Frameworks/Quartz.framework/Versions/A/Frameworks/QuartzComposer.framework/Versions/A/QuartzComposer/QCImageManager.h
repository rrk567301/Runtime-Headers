...
- (id)_createTextureBufferFromImageBuffer:(id)a0 target:(unsigned int)a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 needsClipping:(char)a3 flippedState:(long long)a4 options:(id)a5;
- (id)QCCGLContext;
- (id)_convertersList;
- (char)_computeImageBufferParametersForProvider:(id)a0 withFormat:(id)a1 target:(unsigned int)a2 colorSpace:(struct CGColorSpace { } *)a3 outSrcFormat:(id *)a4 outSrcTarget:(unsigned int *)a5 outSrcColorSpace:(struct CGColorSpace **)a6 outDstFormat:(id *)a7 outDstTarget:(unsigned int *)a8 outDstColorSpace:(struct CGColorSpace **)a9 relaxedFormat:(char)a10 softwareOnly:(char)a11;
...
- (id)_createPixelBufferFromImageBuffer:(id)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 needsClipping:(char)a2 flippedState:(long long)a3 options:(id)a4;
- (id)userInfoForKey:(id)a0;
- (void)_finalize_QCImageManager;
- (void)_setProfileCache:(char)a0;
...
- (char)copyPixelsFromImage:(id)a0 toBaseAddress:(void *)a1 withBytesPerRow:(unsigned int)a2;
...
- (id)createPixelBufferFromPixelBuffer:(id)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 flip:(char)a2 options:(id)a3;
...
- (id)createSurfaceBufferFromPixelBuffer:(id)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 flip:(char)a2 options:(id)a3;
...
- (id)createTextureBufferFromTextureBuffer:(id)a0 target:(unsigned int)a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 flip:(char)a3 options:(id)a4;
...
- (void)optimizeCaches;
- (id)performanceCountersForVirtualScreen:(unsigned long long)a0 purgeable:(char)a1;
