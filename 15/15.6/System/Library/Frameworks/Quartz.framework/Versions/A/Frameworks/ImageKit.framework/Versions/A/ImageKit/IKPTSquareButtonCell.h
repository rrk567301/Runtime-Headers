...
@property char displaysState;

+ (id)leftPressed:(char)a0 mouseDown:(char)a1;
+ (id)middlePressed:(char)a0 mouseDown:(char)a1;
+ (id)resourceImageNamed:(id)a0;
+ (id)rightPressed:(char)a0 mouseDown:(char)a1;
