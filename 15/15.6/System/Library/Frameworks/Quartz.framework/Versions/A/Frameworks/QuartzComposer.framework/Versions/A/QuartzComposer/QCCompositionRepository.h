...
+ (id)sharedCompositionRepository:(char)a0;
...
- (char)_updateCompositions:(struct __CFDictionary { } *)a0;
- (char)_writeCacheFile:(id)a0;
...
- (char)doesPatch:(id)a0 conformToProtocol:(id)a1;
