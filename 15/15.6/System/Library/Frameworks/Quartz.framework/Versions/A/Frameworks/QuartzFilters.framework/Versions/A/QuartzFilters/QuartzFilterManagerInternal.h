...
+ (char)writeFilterXML:(id)a0 toURL:(id)a1;
...
- (char)reallySaveFilter:(id)a0 notification:(id)a1;
- (void)removeFilter:(id)a0 withCompletion:(id /* block */)a1;
- (void)removeFilterFile:(id)a0 completion:(id /* block */)a1;
- (id)saveFilter:(id)a0;
- (char)saveFilter:(id)a0 notification:(id)a1;
- (char)selectFilterByURL:(id)a0;
