...
- (char)addThumbnail:(id)a0 atUID:(id)a1;
- (char)alreadyHasIconInCache:(struct OpaqueIconRef { } *)a0 atSize:(int)a1 validForUID:(id)a2;
- (int)bestThumbnailSizeWithIndex:(id)a0 renderingSize:(struct CGSize { double x0; double x1; })a1 glRendering:(char)a2 lowFrameRateMode:(char)a3;
...
- (id)initWithVRAMSupport:(char)a0 sharedContext:(id)a1 pixelFormat:(id)a2;
