...
- (char)tableView:(id)a0 writeRows:(id)a1 toPasteboard:(id)a2;
- (void)tableViewSelectionDidChange:(id)a0;
- (void)_addColumnWithIdentifier:(id)a0 title:(id)a1 dataCell:(id)a2 sortable:(char)a3;
- (id)_columns;
- (long long)_compareNode:(id)a0 withNode:(id)a1 usingColumnIdentifier:(id)a2 ascending:(char)a3;
