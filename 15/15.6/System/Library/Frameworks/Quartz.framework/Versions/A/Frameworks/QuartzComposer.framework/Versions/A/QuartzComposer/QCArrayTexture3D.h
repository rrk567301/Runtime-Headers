...
- (void)bindTexture3DToContext:(id)a0 textureUnit:(unsigned int)a1 savedState:(struct { unsigned char x0; int x1; int x2; void *x3[4]; } *)a2 enableTexture:(char)a3;
...
- (void)unbindTexture3DFromContext:(id)a0 textureUnit:(unsigned int)a1 savedState:(struct { unsigned char x0; int x1; int x2; void *x3[4]; } *)a2 enableTexture:(char)a3;
