...
@property char autoResize;
@property char autoResizeMax100;
@property (nonatomic) char singleSelection;
@property char showAllSelectionsWithOrientation;
@property char selectionsCanRotate;
@property char selectionsCanBeModified;
@property char forceSelectionInsideView;
@property char selectionsAreHidden;
...
- (void)addScanArea:(id)a0 withOverlay:(char)a1;
...
- (struct CGPoint { double x0; double x1; })displayPointToImagePoint:(struct CGPoint { double x0; double x1; })a0 convertToInches:(char)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })displayRectToImageRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 convertToInches:(char)a1;
- (struct CGSize { double x0; double x1; })displaySizeToImageSize:(struct CGSize { double x0; double x1; })a0 convertToInches:(char)a1;
...
- (void)gotoNextSelection:(char)a0;
- (void)hideAllSelections;
- (void)hiliteSelection:(id)a0;
- (struct CGPoint { double x0; double x1; })imagePointToDisplayPoint:(struct CGPoint { double x0; double x1; })a0 convertFromInches:(char)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })imageRectToDisplayRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 convertFromInches:(char)a1;
- (struct CGSize { double x0; double x1; })imageSizeToDisplaySize:(struct CGSize { double x0; double x1; })a0 convertFromInches:(char)a1;
