...
@property (nonatomic) char hideDeleteButton;
@property char statusAsWindowSubtitle;
@property char hasBottomFiller;
@property char hasBottomSeparator;
@property (nonatomic) double sliderMaxValue;
@property (nonatomic) double sliderValue;
@property (nonatomic) char sliderEnabled;
@property (nonatomic) char sliderHidden;
