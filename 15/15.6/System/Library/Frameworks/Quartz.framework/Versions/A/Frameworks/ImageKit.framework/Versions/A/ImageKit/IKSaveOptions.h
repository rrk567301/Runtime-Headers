...
@property (nonatomic) char rememberLastSetting;

- (void).cxx_destruct;
- (char)showsFlattenAnnotationsCheckbox;
...
- (char)imagePropertiesAreEqualTo:(id)a0 forType:(id)a1;
- (id)initWithImageProperties:(id)a0 imageUTType:(id)a1;
- (char)orientationCheckboxValue;
- (id)pdfOptions;
- (void)savePanelDidEndSheet:(id)a0;
- (void)setCanCalculateEstimatedSize:(char)a0;
- (void)setEstimatedFileSize:(id)a0;
- (void)setOKButtonDisabled:(char)a0;
- (void)setOrientationCheckboxValue:(char)a0;
- (void)setPDFOptions:(id)a0;
- (void)setShowsFlattenAnnotationsCheckbox:(char)a0;
- (void)setShowsOCRCheckbox:(char)a0;
- (void)setShowsOptimizeImagesForScreenCheckbox:(char)a0;
- (void)setShowsOrientationCheckbox:(char)a0;
- (void)setShowsPermissionsButton:(char)a0;
- (void)setShowsSaveImagesAsJPEGCheckbox:(char)a0;
- (char)showsOCRCheckbox;
- (char)showsOptimizeImagesForScreenCheckbox;
- (char)showsOrientationCheckbox;
- (char)showsPermissionsButton;
- (char)showsSaveImagesAsJPEGCheckbox;
