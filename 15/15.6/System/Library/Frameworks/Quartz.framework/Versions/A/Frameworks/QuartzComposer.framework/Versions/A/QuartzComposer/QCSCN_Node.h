...
- (id)__skinner;
- (char)getBoundingSphereCenter:(struct _SCNVector3 { double x0; double x1; double x2; } *)a0 radius:(double *)a1;
- (char)isJoint;
- (id)morpher;
...
- (id)flattenedCopy;
- (id)getBoundingBox;
- (char)getBoundingBoxMin:(struct _SCNVector3 { double x0; double x1; double x2; } *)a0 max:(struct _SCNVector3 { double x0; double x1; double x2; } *)a1;
...
- (char)parseKeyPath:(id)a0 intoDestination:(id *)a1 remainingPath:(id *)a2;
