...
- (id)parameterList;
- (char)_updateTypes:(id)a0 ports:(id)a1 list:(id)a2 direction:(int)a3;
...
- (char)isSourceType:(id)a0;
- (id)parameterPorts;
- (void)recompileSourceOfType:(id)a0;
- (id)resultList;
- (id)resultPorts;
- (char)setParameterList:(id)a0;
- (char)setResultList:(id)a0;
