...
- (char)__filterAll:(id)a0;
- (void)__removeUnusedPatchesFromGraph:(id)a0 recursively:(char)a1;
...
- (char)acceptDroppedFile:(id)a0;
- (Class)classForPath:(id)a0;
- (int)connectionTypeForConnection:(id)a0;
- (void)drawTriggerPatchLink;
- (id)menuForGraph;
- (id)patch;
- (char)performDroppedFile:(id)a0 atPosition:(struct CGPoint { double x0; double x1; })a1;
- (void)setNeedsDisplayForNode:(id)a0;
- (void)setPatch:(id)a0;
- (char)trackTriggerPatch:(id)a0 fromNode:(id)a1;
