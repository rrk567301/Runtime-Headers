...
@property char canAnimateImage;
@property char isAnimatingImage;
@property char isBadImage;
@property struct CGSize { double width; double height; } originalImageSize;
@property int orientationTag;
@property char nonSquarePixels;
@property double nonSquareHeightFactor;
@property double nonSquareWidthFactor;
@property char userDefaultsOverwriteMagnificationFilter;
@property char userDefaultsOverwriteMinificationFilter;
...
- (void)autoResizeToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 allowZoomIn:(char)a1;
- (char)badImage;
- (void)centerImage;
...
- (void)updateOrientationTag:(int)a0 animate:(char)a1 reCenter:(char)a2;
