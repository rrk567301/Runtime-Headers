...
- (void)addConstraint:(id)a0 toView:(id)a1 allowRemoval:(char)a2;
- (void)addConstraintsArray:(id)a0 toView:(id)a1 allowRemoval:(char)a2;
- (void)addConstraintsWithVisualFormat:(id)a0 options:(unsigned long long)a1 views:(id)a2 toView:(id)a3 allowRemoval:(char)a4;
