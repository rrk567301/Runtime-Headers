...
+ (id)_thumbnailWithRepresentation:(id)a0 type:(id)a1 uti:(id)a2 quickLookOptions:(id)a3 proxySource:(id)a4 size:(double)a5 antialiased:(char)a6 quality:(int)a7;
+ (char)representationTypeSupportsConcurrentLoading:(id)a0;
