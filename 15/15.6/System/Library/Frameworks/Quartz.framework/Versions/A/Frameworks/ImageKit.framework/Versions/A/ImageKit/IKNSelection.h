...
@property char shouldClipToImageRect;
...
- (void)prepareShowSelectionWithOrientation:(long long)a0 forceInstallPatch:(char)a1;
- (void)removePatch;
...
- (void)updateRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 rotationAngle:(double)a1 alignTopLeft:(char)a2;
