...
@property char disableGPUDevice;
...
- (void)purgeResources;
- (id)_createArrayMemObjectFromMemObject:(id)a0 withCount:(unsigned long long)a1 elementSize:(unsigned long long)a2 type:(int)a3 attachToOpenGL:(char)a4 options:(id)a5;
...
- (id)createArrayMemObjectWithCount:(unsigned long long)a0 elementSize:(unsigned long long)a1 type:(int)a2 attachToOpenGL:(char)a3 options:(id)a4;
- (id)createImage2DMemObjectFromProvider:(id)a0 withFormat:(id)a1 options:(id)a2;
- (id)createImage2DMemObjectWithFormat:(id)a0 pixelsWide:(unsigned long long)a1 pixelsHigh:(unsigned long long)a2 attachToOpenGL:(char)a3 options:(id)a4;
- (id)createImage3DMemObjectFromProvider:(id)a0 options:(id)a1;
- (id)createImage3DMemObjectWithPixelsWide:(unsigned long long)a0 pixelsHigh:(unsigned long long)a1 pixelsDeep:(unsigned long long)a2 elementSize:(unsigned long long)a3 type:(int)a4 attachToOpenGL:(char)a5 options:(id)a6;
