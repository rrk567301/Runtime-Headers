...
+ (id)filterWithName:(id)a0 url:(id)a1 filterData:(id)a2 domains:(id)a3 comments:(id)a4 readOnly:(char)a5 owner:(id)a6;
...
- (id)initWithName:(id)a0 url:(id)a1 filterData:(id)a2 domains:(id)a3 comments:(id)a4 readOnly:(char)a5 owner:(id)a6;
