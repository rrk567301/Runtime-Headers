...
- (char)beginUpdatePixels:(char)a0 colorSpace:(struct CGColorSpace { } *)a1;
- (void)clearBuffer;
- (void)clearToBlack;
- (struct CGImage { } *)createCGImageWithRenderingIntent:(int)a0 shouldInterpolate:(char)a1;
- (id)initWithFormat:(id)a0 baseAddress:(const void *)a1 releaseCallback:(void /* function */ *)a2 releaseInfo:(void *)a3 bytesPerRow:(unsigned long long)a4 pixelsWide:(unsigned long long)a5 pixelsHigh:(unsigned long long)a6 flipped:(char)a7 colorSpace:(struct CGColorSpace { } *)a8 options:(id)a9;
