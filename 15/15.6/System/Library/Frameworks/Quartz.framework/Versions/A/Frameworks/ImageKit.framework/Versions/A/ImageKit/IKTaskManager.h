...
- (void)freezeTasks;
- (char)isAsynchronousTaskWithIdentifierRunning:(id)a0;
- (void)lockDelegate;
- (id)objectForTask:(id)a0 forKey:(id)a1;
- (id)operationQueueWithIdentifier:(id)a0 createsIfNeeded:(char)a1;
- (void)postNotificationNamed:(id)a0;
- (void)registerTaskName:(id)a0 withTaskDescriptor:(id)a1 taskOrder:(int)a2;
- (void)restartTasks;
- (char)runAsynchronousTasksWithIdentifier:(id)a0 timeout:(double)a1;
