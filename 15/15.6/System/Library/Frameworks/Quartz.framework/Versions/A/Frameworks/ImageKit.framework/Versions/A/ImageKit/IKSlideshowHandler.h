...
@property (readonly) char slideshowIsRunning;
@property char autoPlaying;
@property char autoPlayWrapAround;
...
@property char pdfDisplayAsBook;
...
- (void)fadeFromBlackToNormal:(float)a0 wait:(char)a1;
- (void)fadeFromNormalToBlack:(float)a0 wait:(char)a1;
- (void)freeItems;
...
- (void)gotoNext;
- (void)gotoPrevious;
- (char)handleKeyCode:(unsigned short)a0;
