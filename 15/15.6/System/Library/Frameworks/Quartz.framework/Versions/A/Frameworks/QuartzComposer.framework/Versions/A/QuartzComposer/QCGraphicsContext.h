...
- (char)prerenderPatch:(id)a0 time:(double)a1 imageSizeHint:(struct CGSize { double x0; double x1; })a2 arguments:(id)a3;
- (int)qualityHint;
- (char)renderPatch:(id)a0 time:(double)a1 arguments:(id)a2;
...
- (char)startRenderingPatch:(id)a0 options:(id)a1;
- (void)stopRenderingPatch:(id)a0;
- (id)streamManager;
- (char)willPushRenderState:(id)a0;
