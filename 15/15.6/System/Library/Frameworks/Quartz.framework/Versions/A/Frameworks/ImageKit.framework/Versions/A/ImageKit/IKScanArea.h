...
@property int index;
@property char shouldAutoScan;
@property char scanComplete;
@property char scanInProgress;
...
- (char)simpleScanAreaDetection:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 top:(int)a1 bottom:(int)a2 left:(int)a3 right:(int)a4 validateResult:(char)a5;
- (char)simpleScanAreaDetection:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 validateResult:(char)a1;
- (char)update:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0 imageIndex:(unsigned char)a1;
- (char)validScanAreaForBuffer:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; } *)a0;
