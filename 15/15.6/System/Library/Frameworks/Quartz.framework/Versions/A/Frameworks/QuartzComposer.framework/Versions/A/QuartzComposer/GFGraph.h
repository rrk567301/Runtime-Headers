...
- (char)_finalizing;
- (char)_isConnectionKeyInUse:(id)a0;
- (char)_isNodeKeyInUse:(id)a0;
- (void)_layoutUpdated;
- (char)_loadState:(id)a0;
- (id)_nodes;
- (char)_saveState:(id)a0 filterTarget:(id)a1 filterAction:(SEL)a2 flatten:(char)a3;
...
- (char)canCreateProxyPortWithOriginalPort:(id)a0;
