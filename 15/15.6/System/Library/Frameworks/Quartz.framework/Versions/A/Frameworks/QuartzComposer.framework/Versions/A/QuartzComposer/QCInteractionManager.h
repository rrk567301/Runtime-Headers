...
@property (readonly) char updated;
@property char exposeScale;
@property char exposeRotation;
@property char allowNonUniformScaling;
...
- (void)reset;
- (char)_selected;
- (char)hitTest:(struct CGPoint { double x0; double x1; })a0;
