...
- (void)closeAction;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 image:(id)a1 circular:(char)a2 screen:(id)a3 delegate:(id)a4;
