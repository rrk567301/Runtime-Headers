...
@property char perspectivePushed;
...
- (void)fillRoundedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 radius:(float)a1 cacheIt:(char)a2;
- (char)autoInstallBlendMode;
- (char)beginDrawingInView:(id)a0;
...
- (void)drawRoundedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 radius:(float)a1 lineWidth:(float)a2 cacheIt:(char)a3;
- (char)drawRoundedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 radius:(float)a1 strokeColor:(float *)a2 fillColor:(float *)a3 lineWidth:(int)a4;
...
- (char)renderBezelGroupWithPoints:(struct CGPoint { double x0; double x1; } *)a0 count:(int)a1 radius:(float)a2 strokeColor:(float *)a3 fillColor:(float *)a4 lineWidth:(int)a5;
- (int)rendererType;
- (void)resetOffset;
- (void)setAutoInstallBlendMode:(char)a0;
- (void)setColorRed:(float)a0 Green:(float)a1 Blue:(float)a2 Alpha:(float)a3;
- (void)setEnableMagFilter:(char)a0;
