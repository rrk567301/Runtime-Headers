...
- (char)canAllocateSize:(struct CGSize { double x0; double x1; })a0;
- (id)fragHandler;
- (char)freeRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (int)maxLineHeight;
