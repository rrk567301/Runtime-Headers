...
- (void)finish:(id)a0;
- (void)awakeFromNib;
- (char)browser:(id)a0 acceptDrop:(id)a1 atRow:(long long)a2 column:(long long)a3 dropOperation:(unsigned long long)a4;
- (char)browser:(id)a0 canDragRowsWithIndexes:(id)a1 inColumn:(long long)a2 withEvent:(id)a3;
...
- (char)browser:(id)a0 writeRowsWithIndexes:(id)a1 inColumn:(long long)a2 toPasteboard:(id)a3;
...
- (void)setPreviewState:(char)a0;
- (void)setupViewWithOptions:(id)a0 modal:(char)a1;
