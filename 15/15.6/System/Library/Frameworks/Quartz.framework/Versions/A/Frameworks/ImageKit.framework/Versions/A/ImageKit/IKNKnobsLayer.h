...
@property (nonatomic) char hideNonSelectedKnobs;
@property (nonatomic) char selectionsCanBeModified;
...
- (char)drawGuideForResizing:(struct CGPoint { double x0; double x1; })a0 autoItem:(id)a1;
- (void)drawHandleInContext:(struct CGContext { } *)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 filled:(char)a2;
- (void)resetMouseOverInfo;
- (void)resizeWithEvent:(id)a0 item:(id)a1 knob:(long long)a2;
- (void)rotateWithEvent:(id)a0 layers:(id)a1;
- (void)updateGuidesForAutodetectedItem:(id)a0 drawSingleGuide:(char)a1;
