...
- (char)beginUpdateBuffer:(char)a0;
- (char)beginUpdateBuffer:(char)a0 colorSpace:(struct CGColorSpace { } *)a1;
...
- (char)didRecycleResource:(id)a0;
- (void)endUpdateBuffer:(char)a0;
