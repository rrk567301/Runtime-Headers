...
@property (nonatomic) char isABMeImage;
@property (nonatomic) char isPlaceholder;
@property (nonatomic) char isForHUD;
@property (nonatomic) char isCurrent;

+ (id)recentPicturePlaceholderForHUD:(char)a0;
...
- (id)editedImage;
- (char)hasSameThumbnailAsRecentPicture:(id)a0;
