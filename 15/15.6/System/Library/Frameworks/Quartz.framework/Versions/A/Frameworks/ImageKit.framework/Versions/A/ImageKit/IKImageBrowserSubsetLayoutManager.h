...
@property char visuallyCollapsed;
...
- (void)scrollWheel:(id)a0 gesture:(char)a1;
- (void)setGridOrigin:(struct { double x0; double x1; })a0;
- (void)spaceOutSubmanagerCellsForDropAtIndex:(unsigned long long)a0 nearestCell:(unsigned long long)a1 isMoreThanHalfwayAcrossCell:(char)a2;
- (double)tailOffset;
