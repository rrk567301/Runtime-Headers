...
- (void)__setNodeSelection:(char)a0 adjacentToNode:(id)a1 inputNodes:(char)a2 selectedList:(id)a3;
- (char)nodeBecomesFirstResponder:(id)a0 view:(id)a1;
- (char)nodeResignsFirstResponder:(id)a0 view:(id)a1;
- (void)_deselectDownstream:(id)a0;
- (char)nodeAcceptsFirstResponder:(id)a0 view:(id)a1;
...
- (char)handleKeyDown:(id)a0 inNode:(id)a1 view:(id)a2;
- (char)handleKeyUp:(id)a0 inNode:(id)a1 view:(id)a2;
...
- (char)trackMouse:(id)a0 inNode:(id)a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 view:(id)a3;
