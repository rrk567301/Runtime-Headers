@class NSUUID, PHASETapInterfaceImpl, NSArray, PHASETapRegistry, NSMutableDictionary, NSDictionary, PHASETargetRoomAcousticParameters, PHASEAssetRegistry, PHASEGroupPreset, NSMutableArray, PHASEMedium, PHASEObject;
...
@property (nonatomic) char enableRoomAcousticParametersTracking;
...
@property (nonatomic) char roomAcousticSoftLimiting;
...
- (void)setSpatialHint:(long long)a0;
...
- (char)initInternalWithUpdateMode:(long long)a0 engineMode:(long long)a1 platform:(id)a2 spatialMode:(long long)a3;
...
- (char)setHeadphoneHRIRFile:(id)a0 error:(id *)a1;
...
- (void)setTargetRoomAcousticParameters:(id)a0;
