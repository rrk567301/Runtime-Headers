...
@property (readonly) char isIndefinite;
...
@property (readonly, getter=isIndefinite) char indefinite;
...
- (char)startWithCompletionHandler:(id /* block */)a0;
- (char)seekToTime:(double)a0 completionHandler:(id /* block */)a1;
- (void)prepareWithCompletion:(id /* block */)a0;
- (void)startWithCompletion:(id /* block */)a0;
- (char)startWithCompletionBlock:(id /* block */)a0;
...
- (char)internalPrepareActionTreeWithCompletionBlock:(id /* block */)a0;
- (char)internalStartActionTreeWithCompletionBlock:(id /* block */)a0;
- (void)prepareWithCompletionBlock:(id /* block */)a0;
- (void)registerTapSources;
- (char)seekToTime:(double)a0 completionBlock:(id /* block */)a1;
