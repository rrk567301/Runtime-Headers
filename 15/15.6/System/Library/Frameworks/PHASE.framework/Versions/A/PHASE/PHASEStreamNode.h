...
@property (readonly) char normalize;
...
- (void).cxx_destruct;
- (id)initWithEngine:(id)a0 actionTreeUniqueId:(struct UniqueObjectId { unsigned long long x0[2]; })a1 nodeStringHashId:(unsigned long long)a2 mixer:(id)a3 format:(id)a4 normalize:(char)a5 targetLKFS:(id)a6;
