...
@property (class, readonly, nonatomic) double recommendedTargetLKFSForVoiceStreams;
@property (class, readonly, nonatomic) double recommendedAbsoluteCalibrationLevelForVoiceStreamsAtRecommendedTargetLKFS;
@property (class, readonly, nonatomic) double recommendedAbsoluteCalibrationLevelForVoiceStreams;
@property (class, readonly, nonatomic) double recommendedRolloffFactorForVoiceStreams;
...
+ (void)controllerWithEngine:(id)a0 streamUUID:(id)a1 gainMetaParameterDefinition:(id)a2 mixerDefinition:(id)a3 source:(id)a4 listener:(id)a5 group:(id)a6 normalize:(char)a7 calibrationMode:(long long)a8 level:(double)a9 callback:(id /* block */)a10;
+ (void)controllerWithEngine:(id)a0 streamUUID:(id)a1 gainMetaParameterDefinition:(id)a2 mixerDefinition:(id)a3 source:(id)a4 listener:(id)a5 group:(id)a6 normalize:(char)a7 targetLKFS:(id)a8 calibrationMode:(long long)a9 level:(double)a10 callback:(id /* block */)a11;
+ (void)controllerWithEngine:(id)a0 streamUUID:(id)a1 gainMetaParameterDefinition:(id)a2 mixerDefinition:(id)a3 source:(id)a4 listener:(id)a5 normalize:(char)a6 calibrationMode:(long long)a7 level:(double)a8 callback:(id /* block */)a9;
...
- (id)initWithEngine:(id)a0 streamGroupUUID:(id)a1 gainMetaParameterDefinition:(id)a2 mixerDefinition:(id)a3 source:(id)a4 listener:(id)a5 group:(id)a6 normalize:(char)a7 targetLKFS:(id)a8 calibrationMode:(long long)a9 level:(double)a10 outError:(id *)a11;
