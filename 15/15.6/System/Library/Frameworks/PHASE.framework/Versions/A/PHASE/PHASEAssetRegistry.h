...
- (char)addAssetInternal:(id)a0 assetId:(unsigned long long)a1 outError:(id *)a2;
- (char)addAssetInternal:(id)a0 assetId:(unsigned long long)a1 stringPoolBuilder:(void *)a2 outError:(id *)a3;
...
- (char)removeAssetInternal:(id)a0;
