...
- (void)removeChildren;
- (char)addChild:(id)a0 error:(id *)a1;
...
- (char)isConnectedToRoot;
- (char)isUnderTarget:(id)a0;
- (char)validateTransform:(struct { void /* unknown type, empty encoding */ x0[4]; })a0 outAffine:(void *)a1;
