...
@property (readonly) char shouldIgnoreDoNotDisturb;
@property (readonly) char shouldIgnoreDowntime;
@property (readonly) char shouldSuppressScreenLightUp;
@property (readonly) char shouldHideDate;
@property (readonly, copy) NSDate *date;
@property (readonly, copy) NSDate *expirationDate;
@property (readonly) char shouldAuthenticateDefaultAction;
@property (readonly) char shouldBackgroundDefaultAction;
@property (readonly) char shouldPreventNotificationDismissalAfterDefaultAction;
@property (readonly) char shouldSuppressDefaultAction;
@property (readonly, copy) NSURL *defaultActionURL;
@property (readonly, copy) NSString *defaultActionBundleIdentifier;
@property (readonly) char shouldDisplayActionsInline;
@property (readonly, copy) UNNotificationIcon *icon;
@property (readonly) char shouldShowSubordinateIcon;
@property (readonly, copy, nonatomic) NSSet *topicIdentifiers;
@property (readonly) unsigned long long realertCount;
@property (readonly) char screenCaptureProhibited;
@property (readonly, copy) NSString *speechLanguage;
@property (readonly) char shouldUseRequestIdentifierForDismissalSync;
@property (readonly) char shouldSuppressSyncDismissalWhenRemoved;
@property (readonly) NSString *accessoryImageName;
@property (readonly, copy) NSArray *peopleIdentifiers;
@property (readonly) char shouldPreemptPresentedNotification;
@property (readonly) char shouldHideTime;
...
- (id)_descriptionForDebug:(char)a0;
- (id)_initWithContentType:(id)a0 communicationContext:(id)a1 accessoryImageName:(id)a2 attachments:(id)a3 badge:(id)a4 body:(id)a5 attributedBody:(id)a6 categoryIdentifier:(id)a7 date:(id)a8 icon:(id)a9 defaultActionTitle:(id)a10 defaultActionURL:(id)a11 defaultActionBundleIdentifier:(id)a12 expirationDate:(id)a13 header:(id)a14 footer:(id)a15 launchImageName:(id)a16 peopleIdentifiers:(id)a17 shouldHideDate:(char)a18 shouldHideTime:(char)a19 shouldIgnoreDoNotDisturb:(char)a20 shouldIgnoreDowntime:(char)a21 shouldSuppressScreenLightUp:(char)a22 shouldAuthenticateDefaultAction:(char)a23 shouldBackgroundDefaultAction:(char)a24 shouldPreventNotificationDismissalAfterDefaultAction:(char)a25 shouldShowSubordinateIcon:(char)a26 shouldSuppressDefaultAction:(char)a27 shouldSuppressSyncDismissalWhenRemoved:(char)a28 shouldUseRequestIdentifierForDismissalSync:(char)a29 shouldPreemptPresentedNotification:(char)a30 shouldDisplayActionsInline:(char)a31 sound:(id)a32 subtitle:(id)a33 threadIdentifier:(id)a34 title:(id)a35 topicIdentifiers:(id)a36 realertCount:(unsigned long long)a37 summaryArgument:(id)a38 summaryArgumentCount:(unsigned long long)a39 targetContentIdentifier:(id)a40 interruptionLevel:(unsigned long long)a41 relevanceScore:(double)a42 filterCriteria:(id)a43 screenCaptureProhibited:(char)a44 speechLanguage:(id)a45 userInfo:(id)a46;
- (id)_safeAttributedStringForAttributedString:(id)a0 debug:(char)a1;
- (id)_safeStringForString:(id)a0 debug:(char)a1;
