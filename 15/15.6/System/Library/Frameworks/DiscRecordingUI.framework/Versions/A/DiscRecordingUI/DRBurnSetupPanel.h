...
- (char)_itemIsEnabled:(id)a0;
- (void)_confirmSheetDidDismiss:(id)a0 returnCode:(long long)a1 contextInfo:(void *)a2;
- (void)_savePanelUserDefaults;
- (void)_setBoolValue:(char)a0 forButton:(id)a1 optionKey:(id)a2;
- (void)_setControl:(id)a0 enabled:(char)a1;
- (void)_setWindowExpanderDelta:(float)a0;
- (void)_sizePanelFrom:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 to:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 expand:(char)a2;
...
- (char)mediaStateChanged:(id)a0;
- (void)setAdvancedItems:(id)a0;
- (void)setBurnSpeedPopup:(id)a0;
- (void)setCanSelectAppendableMedia:(char)a0;
- (void)setCanSelectEraseDisc:(char)a0;
- (void)setCanSelectTestBurn:(char)a0;
