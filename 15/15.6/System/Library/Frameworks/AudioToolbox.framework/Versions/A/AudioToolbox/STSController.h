...
- (void).cxx_destruct;
- (id).cxx_construct;
- (char)_updateGlobalState:(const struct STSGlobalState { unsigned long long x0; struct { void /* unknown type, empty encoding */ x0[4]; } x1; } *)a0 didChange:(char *)a1 error:(id *)a2;
...
- (char)signalChangeWithError:(id *)a0;
- (char)updateGlobalState:(struct STSGlobalState { unsigned long long x0; struct { void /* unknown type, empty encoding */ x0[4]; } x1; } *)a0 didChange:(char *)a1 error:(id *)a2;
- (char)updateGlobalState:(const struct STSGlobalState { unsigned long long x0; struct { void /* unknown type, empty encoding */ x0[4]; } x1; } *)a0 labelStates:(const void *)a1 additionalLabelInfo:(id)a2 error:(id *)a3;
- (char)updateGlobalState:(const struct STSGlobalState { unsigned long long x0; struct { void /* unknown type, empty encoding */ x0[4]; } x1; } *)a0 labelStates:(const void *)a1 error:(id *)a2;
- (char)updateLabel:(struct __CFString { } *)a0 state:(const struct STSPerLabelState { struct { void /* unknown type, empty encoding */ x0[4]; } x0; unsigned int x1; float x2; float x3; } *)a1 didChange:(char *)a2 additionalInfo:(id)a3 error:(id *)a4;
- (char)updateLabel:(struct __CFString { } *)a0 state:(struct STSPerLabelState { struct { void /* unknown type, empty encoding */ x0[4]; } x0; unsigned int x1; float x2; float x3; } *)a1 didChange:(char *)a2 error:(id *)a3;
