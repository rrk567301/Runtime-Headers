...
@property (readonly, nonatomic, getter=isHighBandwidth) char highBandwidth;
@property (readonly, copy, nonatomic) NSString *colorMode;
@property (readonly, nonatomic) char colorModeIsYCbCr;
...
@property (readonly, nonatomic) char isVRR;
...
+ (id)displayModeWithWidth:(unsigned long long)a0 height:(unsigned long long)a1 refreshRate:(double)a2 isVRR:(char)a3;
