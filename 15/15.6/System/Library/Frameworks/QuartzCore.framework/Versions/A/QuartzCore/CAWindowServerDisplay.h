...
@interface CAWindowServerDisplay : NSObject <CABrightnessControl, CAPresetTransaction> {
    struct CAWindowServerDisplayImpl { struct Mutex { struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x0; } x0; struct Server *x1; struct CABrightnessTransaction { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; struct { float x0[9]; } x11; float x12; BOOL x13; BOOL x14; unsigned int x15; } x2; id /* block */ x3; id x4; id x5; id x6; id x7; BOOL x8; BOOL x9; } *_impl;
}
...
@property char scalePreservesAspect;
...
@property char blankingRemovesPower;
...
@property char allowsExtendedDynamicRange;
@property (getter=isGrayscale) char grayscale;
@property char allowsWirelessColorFiltering;
...
@property (readonly, getter=isDetaching) char detaching;
...
@property char cursorHidden;
@property char cursorEnabled;
...
@property char accessibilityFrameRateLimitEnabled;
...
@property (nonatomic) char preserveAppleSRGBGammaResponse;
@property (nonatomic) char isReferencePreset;
...
- (void)addClone:(id)a0;
- (void)beginExternalUpdate:(void *)a0 usingSoftwareRenderer:(char)a1;
- (char)canUpdateWithFlags:(unsigned int)a0;
- (void)cancelAllSwaps;
- (char)commitBrightness:(id *)a0;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(char *)a1 readOnly:(char *)a2 vsyncOff:(char)a3 sharedEventRef:(struct __IOSurfaceSharedEvent **)a4 signalValue:(unsigned long long *)a5;
- (struct __IOSurface { } *)displayedSurface;
- (char)finishExternalUpdate:(void *)a0 withFlags:(unsigned int)a1 debugInfo:(unsigned long long)a2;
- (void)freeze;
...
- (char)setDigitalModes:(id)a0;
- (char)setDigitalModes:(id)a0 withTimings:(id)a1;
...
- (char)setWhitePoint:(const struct { float x0[9]; } *)a0 rampDuration:(double)a1 error:(id *)a2;
- (void)unregisterNotificationBlocks;
- (char)finishExternalUpdate:(void *)a0 withFlags:(unsigned int)a1;
...
- (char)calibrationBegin;
- (char)calibrationToolboxCommand:(unsigned int)a0 input_buffer:(id)a1 output_buffer:(id *)a2;
- (char)canUpdate:(char)a0;
...
- (char)commitBrightness:(id *)a0 withBlock:(id /* block */)a1;
- (char)commitPreset;
...
- (struct __IOSurface { } *)currentSurface:(char)a0 protection:(unsigned long long)a1 needsClear:(char *)a2;
- (struct __IOSurface { } *)currentSurface:(char)a0 protection:(unsigned long long)a1 needsClear:(char *)a2 readOnly:(char *)a3 vsyncOff:(char)a4;
- (struct __IOSurface { } *)currentSurface:(char)a0 protection:(unsigned long long)a1 needsClear:(char *)a2 readOnly:(char *)a3 vsyncOff:(char)a4 sharedEventRef:(struct __IOSurfaceSharedEvent **)a5 signalValue:(unsigned long long *)a6;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(char *)a1;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(char *)a1 readOnly:(char *)a2;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(char *)a1 readOnly:(char *)a2 vsyncOff:(char)a3;
- (struct __IOSurface { } *)currentSurfaceWithProtection:(unsigned long long)a0 needsClear:(char *)a1;
- (struct __IOSurface { } *)currentSurfaceWithProtection:(unsigned long long)a0 needsClear:(char *)a1 readOnly:(char *)a2;
- (void)displayWatchdogWillTimeout;
- (void)emitBrightnessError:(id *)a0;
- (void)emitWhitePointError:(id *)a0;
- (unsigned int)finishedUpdateSeed;
- (char)forceCommitBrightness:(id *)a0 withBlock:(id /* block */)a1;
- (id)hitTestAtPosition:(struct CGPoint { double x0; double x1; })a0 options:(id)a1;
- (char)isFlipBookActive;
- (char)isFlipBookEnabled;
- (char)isFlipBookSuppressed;
...
- (void)setPrivacyIndicatorEnableHint;
- (char)setPrivacyIndicatorSurface:(struct __IOSurface { } *)a0 atPosition:(struct CGPoint { double x0; double x1; })a1;
