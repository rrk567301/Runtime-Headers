...
@interface CAMLWriter : NSObject {
    struct _CAMLWriterPriv { struct __CFData *x0; struct __CFURL *x1; id x2; struct _CAMLWriterElement *x3; struct __CFString *x4; struct __CFSet *x5; struct __CFSet *x6; int x7; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; } *_priv;
}
...
- (void)encodeObject:(id)a0 conditionally:(char)a1;
- (char)encodingForReverseSerializationTest;
- (void)endElement;
- (void)setElementAttribute:(id)a0 forKey:(id)a1;
- (void)setElementContent:(id)a0;
- (void)setEncodingForReverseSerializationTest:(char)a0;
