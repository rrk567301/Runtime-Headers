...
- (char)releaseSurface:(struct __IOSurface { } *)a0 error:(id *)a1;
- (char)releaseSurfaceWithId:(unsigned int)a0 error:(id *)a1;
- (char)setExcludedContexts:(id)a0 error:(id *)a1;
- (char)setIncludedContexts:(id)a0 error:(id *)a1;
- (unsigned int)streamId;
- (char)updateOptions:(id)a0 error:(id *)a1;
