...
@property (readonly, nonatomic) char hasNativeFrameRateRequest;
@property (readonly, nonatomic) char supportsVariableFrameDuration;
...
@property (readonly, nonatomic, getter=isCloned) char cloned;
@property (readonly, nonatomic, getter=isCloning) char cloning;
...
@property (readonly, nonatomic) char supportsExtendedColors;
...
@property (readonly, nonatomic) char isReference;
@property (readonly, nonatomic) char isReferenceLimited;
@property (readonly, nonatomic) float autoLuminanceBoost;
@property (nonatomic, getter=isForceFixedRateLinksEnabled) char forceFixedRateLinksEnabled;
...
- (char)setDisplayProperties:(id)a0;
- (id)stateControl;
