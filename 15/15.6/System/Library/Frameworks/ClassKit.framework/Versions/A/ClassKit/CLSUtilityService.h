...
- (void)accountChangedTrigger:(id /* block */)a0;
...
- (void)getBootstrapMode:(id /* block */)a0;
- (void)getClassKitCatalogEnvironmentWithCompletion:(id /* block */)a0;
- (void)getDevModeWithCompletion:(id /* block */)a0;
- (void)recreateDatabase:(char)a0 andTerminateDaemonWithCompletion:(id /* block */)a1;
...
- (void)setBootstrapMode:(int)a0 url:(id)a1 completion:(id /* block */)a2;
...
- (void)syncBootstrapWithCompletion:(id /* block */)a0;
