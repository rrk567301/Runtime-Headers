...
- (void)currentUserIsStudent:(id /* block */)a0;
...
- (void)dataServer:(id)a0 executeQuery:(id)a1 issueServerRequest:(char)a2;
...
- (void)executeQuery:(id)a0 issueServerRequest:(char)a1;
...
- (char)isAllowedToInsertObject:(id)a0;
- (char)isAppClient;
- (char)isDashboardAPIEnabled;
- (char)isPrivateSearchAPIEnabled;
- (char)isRemovedObject:(id)a0;
- (char)isSearchAPIEnabled;
- (char)isUIClient;
...
- (void)setShouldSyncTeacherBrowsedContexts:(char)a0 completion:(id /* block */)a1;
...
- (void)submittableURLByCurrentUser:(id)a0 completion:(id /* block */)a1;
