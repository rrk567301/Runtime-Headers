...
@property char includeUnsearchablePersons;
...
@property char includeEmptyGroupsInResults;
...
- (char)isClassSearch;
- (char)isGroupMemberSearch;
- (char)isGroupSearch;
- (char)isLocationSearch;
- (char)isOrganizationSearch;
- (char)isPersonSearch;
- (char)isValid:(char)a0 error:(id *)a1;
...
- (void)requireGroupMemberIDs:(id)a0;
...
- (void)restrictToGroupsAtLocationIDs:(id)a0;
