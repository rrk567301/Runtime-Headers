...
@property (nonatomic, getter=isOriginal) char original;
...
- (oneway void)clientRemote_downloadCompleted:(char)a0 error:(id)a1;
...
- (char)hasNotBeenRereferencedByServer;
- (char)isValidFileURL:(id)a0 isThumbnail:(char)a1;
- (char)isValidStreamingURL:(id)a0;
