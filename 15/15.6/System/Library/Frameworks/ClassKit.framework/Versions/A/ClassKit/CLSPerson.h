...
@property (nonatomic, getter=isProgressTrackingAllowed) char progressTrackingAllowed;
@property (nonatomic, getter=isFederatedAccount) char federatedAccount;
@property (nonatomic) long long axmAccountStatus;
@property (copy, nonatomic) NSString *emailAddress;
@property (copy, nonatomic) NSString *grade;
@property (nonatomic) long long sourceType;
@property (nonatomic, getter=isEditable) char isEditable;
@property (nonatomic, getter=isSearchable) char isSearchable;
