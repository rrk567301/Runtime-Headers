...
@property (nonatomic) void /* unknown type, empty encoding */ allowsAccessibilityTypingFeedback;
...
@property (nonatomic) void /* unknown type, empty encoding */ allowsKeyboardMathSolving;
@property (nonatomic) void /* unknown type, empty encoding */ allowsMathPaperSolving;
