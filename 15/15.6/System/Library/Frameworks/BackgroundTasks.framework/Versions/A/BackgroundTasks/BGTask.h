...
@property (nonatomic, setter=_setCompleted:) char _completed;
...
- (void)dealloc;
- (void).cxx_destruct;
- (void)setTaskCompletedWithSuccess:(char)a0;
- (void)_callExpirationHandler;
- (id)_initWithIdentifier:(id)a0 activity:(id)a1;
- (void)_setTaskCompletedWithSuccess:(char)a0 actionsIfNotAlreadyCompleted:(id /* block */)a1;
- (id /* block */)_unsafe_setTaskCompletedWithSuccess:(char)a0 afterDelay:(double)a1;
