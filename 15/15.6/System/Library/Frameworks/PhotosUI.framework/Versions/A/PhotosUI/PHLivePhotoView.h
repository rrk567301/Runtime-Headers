...
@interface PHLivePhotoView : NSView <ISChangeObserver, PHLivePhotoBadgeDelegate, PUPhotosAssetDebugOverlayViewDelegate> {
    struct { char willBeginPlaybackWithStyle; char didEndPlayback; char didChangeVideoPlayer; } _delegateRespondsTo;
    struct { char respondsToDidEndPlayingVitality; } _delegatePrivateFlags;
...
@property (nonatomic, setter=_setPlayingVitality:) char _playingVitality;
@property (nonatomic, setter=_setPlaybackRequested:) char _playbackRequested;
...
@property (nonatomic) char showsStatusBorder;
...
- (void)stopPlaybackAnimated:(char)a0;
...
- (char)photosAssetDebugOverlayViewHasEffectivePreferredImageDynamicRange:(id)a0;
