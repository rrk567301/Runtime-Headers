...
@property (nonatomic) char _copyToTemporaryDirectoryBeforeCallingOpenInPlaceCompletionHandler;
...
- (void)_completeProgressWithUUID:(id)a0 success:(char)a1 completionHandler:(id /* block */)a2;
