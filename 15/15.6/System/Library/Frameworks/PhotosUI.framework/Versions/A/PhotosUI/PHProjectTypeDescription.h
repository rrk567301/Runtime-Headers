...
@property (readonly, nonatomic) char canProvideSubtypes;

- (id)description;
- (void).cxx_destruct;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (id)initWithProjectType:(id)a0 title:(id)a1 description:(id)a2 image:(id)a3 canProvideSubtypes:(char)a4;
- (void)_configureWithProjectType:(id)a0 title:(id)a1 description:(id)a2 attributedDescription:(id)a3 image:(id)a4 subtypeDescriptions:(id)a5 willProvideSubtypeDescription:(char)a6;
- (id)initWithProjectType:(id)a0 title:(id)a1 attributedDescription:(id)a2 image:(id)a3 canProvideSubtypes:(char)a4;
