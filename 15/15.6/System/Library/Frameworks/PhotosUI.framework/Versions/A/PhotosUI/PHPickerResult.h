...
@property (readonly, nonatomic) char _isAssetResult;
...
+ (char)_validateBestCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (id)_initWithItemProvider:(id)a0 itemIdentifier:(id)a1 isAssetResult:(char)a2 metadata:(id)a3;
