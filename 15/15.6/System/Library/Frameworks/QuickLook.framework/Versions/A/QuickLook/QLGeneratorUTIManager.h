...
+ (char)_pluginExistsForType:(id)a0 extensionType:(unsigned long long)a1 outIsViewBased:(char *)a2 outShouldUseLegacyGenerator:(char *)a3;
...
+ (char)pluginExistsForPreviewType:(id)a0 outIsViewBased:(char *)a1 outShouldUseLegacyGenerator:(char *)a2;
+ (char)shouldUseLegacyGeneratorForThumbnailType:(id)a0;
