...
@property char keepAlive;

+ (char)setupSession:(struct __QLRequest { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; id x1; } *)a0;
...
+ (void)discardAllSessions:(char)a0;
...
+ (void)setupSessions:(char)a0 deadPortBlock:(id /* block */)a1;
...
- (void)handleSendDataWithAttachmentURL:(id)a0 lastChunk:(char)a1;
