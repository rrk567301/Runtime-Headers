...
- (void)_requestDone:(struct __QLRequest { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; id x1; } *)a0 success:(char)a1;
...
- (char)hasRequest:(struct __QLRequest { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; id x1; } *)a0;
- (id)initWithIdentifier:(id)a0 forExternalGenerators:(char)a1 architecture:(int)a2;
