...
- (char)obtainWithRights:(const struct { unsigned int x0; struct *x1; } *)a0 flags:(unsigned int)a1 environment:(const struct { unsigned int x0; struct *x1; } *)a2 authorizedRights:(struct **)a3 error:(id *)a4;
- (char)obtainWithRight:(char *)a0 flags:(unsigned int)a1 error:(id *)a2;
...
- (void)invalidateCredentials:(char)a0;
