...
+ (char)compareOid:(const struct cssm_data { unsigned long long x0; char *x1; } *)a0 toOid:(const struct cssm_data { unsigned long long x0; char *x1; } *)a1;
...
+ (id)printCertTypeString:(unsigned int)a0 isRoot:(char)a1;
