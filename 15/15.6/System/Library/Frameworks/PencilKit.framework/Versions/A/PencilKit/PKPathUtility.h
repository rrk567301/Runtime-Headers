...
+ (char)edge:(struct Edge { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; })a0 intersectsEdge:(struct Edge { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; })a1;
+ (char)edgeSet:(const void *)a0 containsEdge:(struct Edge { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; })a1;
...
+ (char)newEdgeWithPoint:(struct CGPoint { double x0; double x1; })a0 betweenEdge:(struct Edge { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; })a1 intersectsOtherEdgesInHull:(const void *)a2;
...
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct __compressed_pair<CGPoint *, std::allocator<CGPoint>> { struct CGPoint *x0; } x2; })smoothedHullForPoints:(const void *)a0;
...
+ (char)vector:(const void *)a0 containsPoint:(struct CGPoint { double x0; double x1; })a1;
