...
@property (nonatomic, getter=showBrushIndicator, setter=setShowBrushIndicator:) char showBrushIndicator;
...
@property (readonly, nonatomic) char immutableVelocity;
@property (nonatomic, getter=usesAzimuthOrAltitude, setter=setUsesAzimuthOrAltitude:) char usesAzimuthOrAltitude;
...
@property (readonly, nonatomic) char isEraser;
...
- (double)brushOpacityForPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a0 context:(struct { struct _PKStrokePoint { double x0; struct CGPoint { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; } x0; char x1; long long x2; double x3; double x4; double x5; double x6; id x7; unsigned long long x8; } *)a1;
...
- (double)solve:(void *)a0 forPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a1 context:(struct { struct _PKStrokePoint { double x0; struct CGPoint { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; } x0; char x1; long long x2; double x3; double x4; double x5; double x6; id x7; unsigned long long x8; } *)a2 weight:(double)a3;
