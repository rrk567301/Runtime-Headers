...
@property (nonatomic) char isDrawing;
@property (readonly, nonatomic) char waitingForStrokeToEnd;
@property (readonly, nonatomic) char isErasingObjects;
...
@property (readonly, nonatomic) char isMipmapped;
