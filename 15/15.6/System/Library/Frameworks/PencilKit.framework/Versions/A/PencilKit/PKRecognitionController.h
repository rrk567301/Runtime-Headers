...
+ (char)currentDeviceSupportsAutoRefine;
...
- (id)initWithDrawing:(id)a0 visibleOnscreenStrokes:(id)a1 useSessionCache:(char)a2;
...
- (char)shouldCancelForAutoRefineCompletion;
- (void)tagAsActive;
- (void)tagAsIdle;
