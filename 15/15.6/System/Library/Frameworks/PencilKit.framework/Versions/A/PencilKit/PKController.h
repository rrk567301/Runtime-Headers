...
- (void)_addNewStrokes:(id)a0 wasAddedEarly:(char)a1 hidden:(char)a2 preDrawingChangedBlock:(id /* block */)a3;
...
- (void)addNewRenderedStrokes:(id)a0 wasAddedEarly:(char)a1 hidden:(char)a2 preDrawingChangedBlock:(id /* block */)a3;
...
- (id)initWithPixelSize:(struct CGSize { double x0; double x1; })a0 actualSize:(struct CGSize { double x0; double x1; })a1 singleComponent:(char)a2 sixChannelBlendingMode:(long long)a3 metalConfig:(id)a4;
