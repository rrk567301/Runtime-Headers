...
@property (readonly, nonatomic) char _isFullyHidden;
...
- (char)hasSubstrokes;
- (id)initWithArchive:(const void *)a0 sortedUUIDs:(id)a1 inks:(id)a2 parent:(id)a3 isHidden:(char)a4 transientArchiveDictionary:(id)a5;
...
- (id)initWithStroke:(id)a0 hidden:(char)a1 version:(struct _PKStrokeID { unsigned int x0; unsigned char x1[16]; unsigned int x2; })a2 ink:(id)a3 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4;
...
- (unsigned int)saveToArchive:(void *)a0 sortedUUIDs:(id)a1 inks:(id)a2 withPathData:(char)a3 parent:(id)a4 transient:(char)a5;
- (unsigned int)saveToArchive:(void *)a0 sortedUUIDs:(id)a1 inks:(id)a2 withPathData:(char)a3 transient:(char)a4;
- (unsigned int)saveToV1Archive:(void *)a0 sortedUUIDs:(id)a1 inks:(id)a2 withPathData:(char)a3 transient:(char)a4;
