...
@property (readonly) char isAutoRefined;
@property (readonly) NSDictionary *debugInfo;

- (void).cxx_destruct;
- (void)estimateMetricsWithTokenDeviation:(double)a0 tokenHeight:(double)a1;
- (id)initWithRefinedStrokes:(id)a0 originalStrokes:(id)a1 unchangedStrokes:(id)a2 locale:(id)a3 refinedWordCount:(long long)a4 duration:(double)a5 isAutoRefined:(char)a6 debugInfo:(id)a7;
