...
@interface PKStrokeGenerator : NSObject <PKInputProvider> {
    ...
    char _keepPredictedTouchesAtEndOfStroke;
    char _currentShouldClearAzimuth;
    char _currentRollAngleEnabled;
    double _currentBaseRollAngle;
    double _currentAdditionalRollAngle;
    char _alwaysUseRollAngleForFountainPen;
    ...
    char _shouldSetIsSafeForStyleInventorFlag;
}

@property (nonatomic) struct CGAffineTransform { double a; double b; double c; double d; double tx; double ty; } rulerTransform;
@property (nonatomic) char useRuler;
@property (nonatomic) double rulerWidth;
@property (nonatomic) char isSnappedToRulerTopSide;
@property (nonatomic) char canSnapToRuler;
...
@property char isSnappedToRuler;
@property (readonly) char lastPointIsMasked;
...
@property (nonatomic) char captureLiveData;
@property (nonatomic) char isPreviewing;
@property double additionalRollAngle;
@property char rollAngleEnabled;
@property char shouldClearAzimuth;
...
- (id).cxx_construct;
- (void)reset;
- (void)addPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a0;
...
- (void)_drawingAddPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a0;
- (void)_drawingUpdateAllPointsDidTimeout:(char)a0 updateSemaphore:(char)a1;
...
- (void)drawingUpdatePoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a0;
