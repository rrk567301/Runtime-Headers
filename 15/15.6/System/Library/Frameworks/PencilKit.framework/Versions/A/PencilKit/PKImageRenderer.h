...
@property (readonly, nonatomic) char sixChannelBlending;
...
- (void)setupWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 renderQueue:(id)a2 sixChannelBlending:(char)a3 synchronous:(char)a4;
...
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 renderQueue:(id)a2 sixChannelBlending:(char)a3;
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 useMetal:(char)a2;
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 useMetal:(char)a2 renderQueue:(id)a3;
