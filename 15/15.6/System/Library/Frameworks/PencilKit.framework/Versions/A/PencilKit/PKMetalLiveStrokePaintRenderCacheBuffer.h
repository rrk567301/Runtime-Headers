...
- (id)init;
- (void).cxx_destruct;
- (id)initWithPoints:(const struct PKMetalPaintStrokePoint { float x0; float x1; unsigned short x2 : 16; unsigned short x3 : 16; } *)a0 liveStrokePoints:(const struct PKMetalLiveStrokePaintStrokePoint { float x0; float x1; } *)a1 numPoints:(unsigned long long)a2 numVertices:(unsigned long long)a3 resourceHandler:(id)a4;
