...
@property (readonly, nonatomic) char hasAzimuthAngles;
@property (readonly, nonatomic) char hasValidPointTimestampData;
...
- (void)_scaleRadius:(double)a0 isVector:(char)a1;
...
- (id)copyWithScaledRadius:(double)a0 isVector:(char)a1;
...
- (char)deltaContainsNewInfo:(id)a0;
- (id)deltaTo:(id)a0;
...
- (char)saveToDataArchive:(void *)a0;
