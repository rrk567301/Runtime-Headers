...
+ (struct { struct _PKStrokePoint { double x0; struct CGPoint { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; } x0; char x1; long long x2; double x3; double x4; double x5; double x6; id x7; unsigned long long x8; })_contextForStroke:(id)a0 weight:(double)a1 type:(id)a2;
+ (double)_weightForWidth:(double)a0 type:(id)a1;
+ (void *)_weightInfoMap;
+ (double)_widthForWeight:(double)a0 type:(id)a1;
+ (id)behaviorForInkType:(id)a0;
+ (id)convertColor:(id)a0 fromDark:(char)a1 to:(char)a2;
