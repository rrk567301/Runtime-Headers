...
+ (id)_otherStrokesCloseToLeft:(char)a0 forStrokes:(id)a1 withClosestStroke:(id)a2;
...
- (id)_copyAndAddStroke:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 inkTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 ink:(id)a3 newParent:(id *)a4;
...
- (void)_copyAndAddStrokes:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 inkTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2;
...
- (id)_originalDataUUIDToTransformedStrokeDictFromStrokes:(id)a0 pathDict:(id)a1 maskDict:(id)a2 shouldUseStrokeDataUUID:(char)a3;
- (id)_originalStrokeDataUUIDToTransformedStrokeDictFromStrokes:(id)a0 pathDict:(id)a1 maskDict:(id)a2;
- (id)_originalStrokeUUIDToTransformedStrokeDictFromStrokes:(id)a0 pathDict:(id)a1 maskDict:(id)a2;
...
- (id)newStroke;
- (void)performSearchQuery:(id)a0 fullWordsOnly:(char)a1 caseMatchingOnly:(char)a2 withBlock:(id /* block */)a3;
- (void)performSearchQuery:(id)a0 withBlock:(id /* block */)a1;
- (char)recognitionEnabled;
- (void)setForcedRecognitionLocales:(id)a0;
- (void)setRecognitionEnabled:(char)a0;
- (id)setStroke:(id)a0 hidden:(char)a1;
- (id)setStroke:(id)a0 ink:(id)a1;
- (id)setStroke:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 concat:(char)a2;
...
- (void)setStrokes:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 concat:(char)a2;
- (void)set_canvasBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (char)shouldClearSelectionAfterStraightening;
...
- (id)strokesForCHStrokeIdentifiers:(id)a0;
- (id)strokesForCHStrokeIdentifiers:(id)a0 didFindAllStrokes:(char *)a1;
...
- (void)transformStrokes:(id)a0 withTransforms:(id)a1 concat:(char)a2;
