...
@property (nonatomic) char _weightIsUndefined;
...
@property (readonly, nonatomic) char _isStrokeGeneratingInk;
...
+ (id)identifierForCommandType:(unsigned int)a0 wantsObjectErase:(char)a1;
...
- (char)_shouldRenderAsFountainPenInkV2;
...
- (char)_isCustomInk;
- (char)_isEraserInk;
- (char)_isFountainPenInk;
- (char)_isFountainPenInkV2;
- (char)_isGenerationTool;
...
- (char)_shouldSaveRequiredContentVersionOverride;
- (char)_shouldSaveSixChannelAddColor;
- (char)_shouldSaveSixChannelMultiplyColor;
- (id)_sixChannelVersion;
- (char)_supportsCombiningStrokes;
...
- (char)isEqualInk:(id)a0;
- (char)isEqualUnweightedInk:(id)a0;
