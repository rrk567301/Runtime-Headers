...
- (id)strokeGroups;
- (id)_closestLineToPoint:(struct CGPoint { double x0; double x1; })a0 isTop:(char)a1;
...
- (char)_strokes:(id)a0 containsAnyStrokes:(id)a1;
- (id)_strokesAtLineIndex:(long long)a0 containingStrokes:(id)a1;
- (id)_strokesForIdentifiers:(id)a0 inDrawing:(id)a1;
- (id)_strokesInLine:(id)a0 leftOf:(char)a1 point:(struct CGPoint { double x0; double x1; })a2;
...
- (id)firstStrokesInStrokes:(id)a0 isRTL:(char)a1;
- (id)initWithRecognitionSessionManager:(id)a0;
- (id)lastStrokesInStrokes:(id)a0 isRTL:(char)a1;
- (void)q_fetchStrokesAmbiguouslyBelowAndAboveInsertSpaceHandleWithStrokes:(id)a0 completion:(id /* block */)a1;
- (void)q_fetchStrokesBetweenTopPoint:(struct CGPoint { double x0; double x1; })a0 bottomPoint:(struct CGPoint { double x0; double x1; })a1 isRTL:(char)a2 completion:(id /* block */)a3;
