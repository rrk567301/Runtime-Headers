...
@property (nonatomic) char initialRandomRotation;
@property (nonatomic) unsigned long long particleBlendMode;
@property (nonatomic) double maskDepth;
@property (nonatomic) char maskInitialRandomOffset;
@property (nonatomic, getter=adjustEndCapParticleAlpha, setter=setAdjustEndCapParticleAlpha:) char adjustEndCapParticleAlpha;
