@class PKStrokeRenderMask, NSUUID, PKStrokePath, NSBezierPath, NSArray, PKInk;

@interface PKStroke : NSObject <NSCopying>

@property (copy, nonatomic, setter=_setRenderMask:) PKStrokeRenderMask *_renderMask;
@property (nonatomic, getter=_isNewCopy, setter=_setIsNewCopy:) char _isNewCopy;
@property (nonatomic, getter=_isInProgressScribbleStroke, setter=_setIsInProgressScribbleStroke:) char _isInProgressScribbleStroke;
...
@property (readonly, nonatomic) char _isInternal;
...
+ (void)_applyPropertiesToNewStrokes:(id)a0 fromOldStrokes:(id)a1;
...
+ (id)_commonGroupIDForStrokes:(id)a0;
...
+ (id)_createStrokesFromCHDrawing:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 inputScale:(double)a2 sourceStrokes:(id)a3 strokeClass:(Class)a4 newInk:(id)a5 suggestedHeight:(double)a6 shouldSetSynthesizedFlag:(char)a7;
...
+ (long long)_requiredContentVersionForStrokePath:(id)a0 ink:(id)a1;
+ (id)_snapToShape:(id)a0;
+ (id)_snapToShape:(id)a0 inputScale:(double)a1;
...
+ (struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })averagePointForSynthesisFromSourceStrokes:(id)a0;
+ (id)copyStrokes:(id)a0 hidden:(char)a1;
...
- (struct { union { struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned int x5 : 32; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; } x0; unsigned long long x1; } x0; })_flags;
...
- (char)_isPastedStroke;
- (void)_setRandomSeed:(unsigned int)a0;
- (void)_setStrokeMask:(id)a0;
- (char)_isMaskedStroke;
- (char)_isSharedStroke;
...
- (char)_containsSamePointsAsStroke:(id)a0;
...
- (char)_isBitmapEraserStroke;
- (char)_isSafeForStyleInventory;
- (char)_isSynthesizedInk;
- (struct CGPoint { double x0; double x1; })_locationAtIndex:(unsigned long long)a0;
- (struct CGPoint { double x0; double x1; })_locationAtIndex:(unsigned long long)a0 applyStrokeTransform:(char)a1;
- (double)_maxWidthForStroke;
- (id)_mergeWithStroke:(id)a0 inDrawing:(id)a1;
- (char *)_newAsciiBitfield;
- (char *)_newAsciiBitfieldWithWidth:(long long)a0 height:(long long)a1;
- (struct CGPath { } *)_newPathRepresentation;
- (id)_newStrokeWithSubstrokes:(id)a0 inDrawing:(id)a1;
- (char)_pathHasAzimuthAngles;
- (char)_pathHasClockwisePointOrdering;
...
- (void)_setIsPastedStroke:(char)a0;
- (void)_setIsSafeForStyleInventory:(char)a0;
- (void)_setIsSharedStroke:(char)a0;
- (void)_setIsSynthesizedInk:(char)a0;
...
- (id)_strokeByAppendingTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0;
- (id)_strokeMask;
- (id)_strokeUUID;
- (id)_strokeWithUUID:(id)a0 dataUUID:(id)a1;
...
- (char)_visitVisibleSubstrokes:(id /* block */)a0 inDrawing:(id)a1;
...
- (void)generateClipperPath:(void *)a0;
- (void)generateMask;
- (char)hasSubstrokes;
...
- (id)initWithData:(id)a0 id:(id)a1 hidden:(char)a2 ink:(id)a3 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4 substrokes:(id)a5;
...
- (char)intersectsClipperPath:(void *)a0;
- (char)intersectsClosedStroke:(id)a0;
- (char)intersectsClosedStrokeMasked:(id)a0;
- (char)intersectsLineFrom:(struct CGPoint { double x0; double x1; })a0 to:(struct CGPoint { double x0; double x1; })a1 minThreshold:(double)a2;
- (char)intersectsLineFromMasked:(struct CGPoint { double x0; double x1; })a0 to:(struct CGPoint { double x0; double x1; })a1 minThreshold:(double)a2;
- (char)intersectsPoint:(struct CGPoint { double x0; double x1; })a0;
- (char)intersectsPoint:(struct CGPoint { double x0; double x1; })a0 boundsOutset:(double)a1 minimumStrokeThreshold:(double)a2;
- (char)intersectsPointMasked:(struct CGPoint { double x0; double x1; })a0;
- (char)intersectsPointMasked:(struct CGPoint { double x0; double x1; })a0 boundsOutset:(double)a1 minimumStrokeThreshold:(double)a2;
- (char)intersectsRectMasked:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (struct CGPath { } *)newPathRepresentation;
- (struct CGPath { } *)newPathRepresentationMasked;
- (struct CGPath { } *)newSelectionPathRepresentationWithPointsCount:(int *)a0;
