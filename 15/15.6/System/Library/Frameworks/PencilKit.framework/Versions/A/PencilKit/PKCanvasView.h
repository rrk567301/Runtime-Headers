...
@property (nonatomic, getter=isFingerDrawingEnabled) char fingerDrawingEnabled;
@property (nonatomic) char disableWideGamut;
@property (nonatomic) char rulerEnabled;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 fixedPixelSize:(struct CGSize { double x0; double x1; })a1 drawingScale:(double)a2 layerFixedPixelSize:(char)a3;
