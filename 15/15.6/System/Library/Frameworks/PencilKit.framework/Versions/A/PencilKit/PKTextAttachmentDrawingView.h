...
@property (nonatomic) char currentModeIsDarkMode;
...
- (void)_triggerRedraw;
- (void)_updateAttachmentBoundsSafeToInvalidateLayout:(char)a0;
- (void)_updateTiles;
...
- (id)initWithAttachment:(id)a0 drawingClass:(Class)a1 inserted:(char)a2;
- (char)isDarkModeEnabled;
- (char)isLiveResizing;
- (id /* block */)linedPaperRenderBlockForTile:(id)a0;
- (void)updateFrameForTextContainerSafeToInvalidateLayout:(char)a0;
