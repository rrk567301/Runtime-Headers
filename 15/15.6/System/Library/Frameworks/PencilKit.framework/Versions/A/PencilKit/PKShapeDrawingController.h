...
@interface PKShapeDrawingController : NSObject {
    ...
    char _closedShapeDetected;
    char _stopGestureDetected;
    char _hasDetected;
    char _shouldDetect;
...
@property (nonatomic, getter=isSmartFillEnabled) char smartFillEnabled;
@property (nonatomic, getter=isShapeRecognitionOn) char shapeRecognitionOn;
@property (readonly, nonatomic, getter=isSmartFillActive) char smartFillActive;
@property (readonly, nonatomic, getter=isRecordingStroke) char recordingStroke;
@property (nonatomic, getter=isFastDetectionEnabled) char fastDetectionEnabled;
@property (readonly, nonatomic) struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; } averageInputPoint;
...
+ (void)_addTopCenterCloudPath:(struct CGPath { } *)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 leftEdge:(char)a2 rightEdge:(char)a3;
...
+ (char)hasSnapToShapeEntitlement;

- (void).cxx_destruct;
- (id)initWithDelegate:(id)a0;
- (id).cxx_construct;
- (id)shapeFromStroke:(id)a0 inputScale:(double)a1 averageInputPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a2 allowedShapeTypes:(id)a3;
- (void)_addAngles:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a0;
...
- (id)_strokeFromPoints:(const void *)a0 inputScale:(double)a1 averageInputPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a2 sourceStroke:(id)a3;
- (double)_strokeLength;
- (void)_updateAverageInputPoint:(const struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; } *)a0;
...
- (struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })averageInputPointFromStroke:(id)a0;
- (void)beginStrokeAtPoint:(struct CGPoint { double x0; double x1; })a0;
- (void)cancelDetectionIfNecessary;
- (id)detectedShapeWithInputScale:(double)a0 averageInputPoint:(struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; char x8; long long x9; double x10; char x11; double x12; long long x13; long long x14; })a1 allowedShapeTypes:(id)a2 createCurrentStrokeBlock:(id /* block */)a3;
- (void)endSmartFill;
- (char)hasMovementStopped;
- (char)isScratchOutActive;
