@class PKHandwritingTranscriptionCache, NSArray, PKDrawing, NSOrderedSet, NSString, NSMutableOrderedSet, NSMutableDictionary;
...
- (id)cachedTranscriptionsIntersectingStrokeGroup:(id)a0;
...
- (char)isStroke:(id)a0 versionOfStrokeWithIdentifier:(id)a1;
- (char)isValidStrokeIdentifier:(id)a0;
...
- (char)enumerateChangesSinceVersion:(id)a0 usingBlock:(id /* block */)a1;
- (id)initWithDrawing:(id)a0;
- (id)initWithDrawing:(id)a0 visibleOnscreenStrokes:(id)a1 shouldProcessVisibleStrokes:(char)a2 transcriptionCache:(id)a3;
- (id)sliceForIdentifier:(id)a0;
- (void)updateTranscriptionCache:(id)a0;
