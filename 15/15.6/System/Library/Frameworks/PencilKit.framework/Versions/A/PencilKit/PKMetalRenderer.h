...
@interface PKMetalRenderer : NSObject {
    ...
    struct RendererFramebuffer { PKMetalFramebuffer *framebuffer; char isNonPurgeable; char mustBeCleared; } _originalBackFramebuffer;
    struct RendererFramebuffer { PKMetalFramebuffer *framebuffer; char isNonPurgeable; char mustBeCleared; } _sixChannelMultiplyFramebuffer;
    char _shouldClearOriginalBackFramebuffer;
    struct { double red; double green; double blue; double alpha; } _originalBackClearColor;
    struct RendererFramebuffer { PKMetalFramebuffer *framebuffer; char isNonPurgeable; char mustBeCleared; } _paintFramebuffer[2];
    struct RendererFramebuffer { PKMetalFramebuffer *framebuffer; char isNonPurgeable; char mustBeCleared; } _paintAccumulationFramebuffer[2];
    ...
    char _sixChannelCanvasHasContentTexture;
...
@property (nonatomic) char solidColorBackboard;
@property (nonatomic) char oneRenderPassForLiveRendering;
...
@property (nonatomic) char edgeMask;
@property (nonatomic) double liveStrokeElapsedTime;
@property (readonly, nonatomic) char isFinishedRendering;
...
- (void)addBufferForRenderCache:(id)a0 strokeVertices:(const void *)a1 numVertices:(unsigned long long)a2 vertexSize:(long long)a3 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 secondaryParticles:(char)a5 renderEncoder:(id)a6;
...
- (char)applyStrokeSpaceClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 strokeTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
- (id)blitIntoPaintShaderPaintIndex:(long long)a0 alphaBlending:(char)a1;
- (id)blitShader;
...
- (char)canRenderStroke:(id)a0 combinedWith:(id)a1 allowMasks:(char)a2;
...
- (void)clearFramebuffer:(id)a0 waitUntilCompleted:(char)a1;
...
- (void)clearTile:(id)a0 waitUntilCompleted:(char)a1;
...
- (id)copyAccumulatorIntoPaintShaderPaintIndex:(long long)a0 alphaBlending:(char)a1;
...
- (void)copyIntoTile:(id)a0 tileFramebuffer:(id)a1 tileTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 waitUntilCompleted:(char)a3;
- (void)copyIntoTile:(id)a0 tileTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 waitUntilCompleted:(char)a2;
- (struct PKShaderPipelineConfig { unsigned char x0[6]; })currentPipelineConfig;
- (struct PKShaderPipelineConfig { unsigned char x0[6]; })defaultPipelineConfigForLiveRendering:(char)a0;
...
- (char)ensureMultiplyFramebufferHasContents;
...
- (void)finishLiveStrokeAndPresentDrawable:(id)a0 multiplyDrawable:(id)a1 waitUntilScheduled:(char)a2;
...
- (id)framebufferForTile:(id)a0 createIfNeeded:(char)a1;
- (char)generateBSplineInComputeForStroke:(id)a0;
- (id)generateCacheForMask:(id)a0;
- (id)generateCacheForParticleStroke:(void *)a0 points:(struct _PKStrokePointSlice { struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x0; struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x1; })a1 startPt:(char)a2 endPt:(char)a3;
...
- (id)generateParticleCacheForStroke:(struct _PKStrokePointSlice { struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x0; struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x1; })a0 animatingStroke:(void *)a1 starts:(char)a2 ends:(char)a3;
- (id)generateParticleCacheForStroke:(struct _PKStrokePointSlice { struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x0; struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x1; })a0 animatingStroke:(void *)a1 starts:(char)a2 ends:(char)a3 secondaryParticles:(char)a4;
...
- (id)invertShader;
- (id)linesShader;
- (id)multiplyFramebufferForTile:(id)a0 createIfNeeded:(char)a1;
...
- (id)paperShader;
- (id)particleAndMasksShaderForAttachmentIndex:(unsigned int)a0 maxBlendMode:(char)a1;
- (id)particleShaderForAttachmentIndex:(unsigned int)a0 maxBlendMode:(char)a1;
...
- (void)renderAheadWithTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 onPaper:(char)a1 renderBufferSize:(struct CGSize { double x0; double x1; })a2 destinationTexture:(id)a3 destinationMultiplyTexture:(id)a4;
- (void)renderAlternativeStroke:(id)a0 alpha:(double)a1 purgeableResources:(id)a2;
- (void)renderAnimatingStrokesWithTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 renderBufferSize:(struct CGSize { double x0; double x1; })a1 usingAccumulationBuffer:(char)a2;
...
- (void)renderImageTexture:(id)a0 imageTextureTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 withTiles:(id)a2 tileTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a3 waitUntilCompleted:(char)a4;
...
- (void)renderPaperTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 paperTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 flipped:(char)a2 multiply:(double)a3 renderEncoder:(id)a4;
- (unsigned long long)renderParticleRenderCache:(id)a0 renderEncoder:(id)a1 computeEncoder:(id)a2 animatingStroke:(void *)a3 secondaryParticles:(char)a4;
- (unsigned long long)renderParticleStroke:(struct _PKStrokePointSlice { struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x0; struct __wrap_iter<const _PKStrokePoint *> { struct _PKStrokePoint *x0; } x1; })a0 animatingStroke:(void *)a1 starts:(char)a2 ends:(char)a3 secondaryParticles:(char)a4 renderEncoder:(id)a5;
...
- (void)renderStroke:(id)a0 withTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 mode:(long long)a2 flipped:(char)a3 renderBufferSize:(struct CGSize { double x0; double x1; })a4 renderEncoder:(id)a5 currentClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 needRenderMask:(char)a7;
- (unsigned long long)renderStrokeRenderCache:(id)a0 renderEncoder:(id)a1 animatingStroke:(void *)a2 indexed:(char)a3;
- (unsigned long long)renderStrokeRenderCacheBuffers:(id)a0 renderEncoder:(id)a1 animatingStroke:(void *)a2 indexed:(char)a3;
...
- (void)renderTile:(id)a0 tileFramebuffer:(id)a1 tileTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 renderState:(id)a3 shouldComposite:(char)a4;
- (void)renderTiles:(id)a0 clearBackBuffer:(char)a1 tileTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 waitUntilCompleted:(char)a3;
- (void)renderTiles:(id)a0 intoTile:(id)a1 waitUntilCompleted:(char)a2;
...
- (unsigned long long)renderVerticies:(const void *)a0 size:(unsigned long long)a1 numRenderedVertices:(unsigned long long)a2 vertexSize:(unsigned long long)a3 numIndices:(unsigned long long)a4 localClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 animatingStroke:(void *)a6 secondaryParticles:(char)a7 renderEncoder:(id)a8;
- (void)renderWithTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a0 animatingStroke:(void *)a1 mode:(long long)a2 clipped:(char)a3 renderBufferSize:(struct CGSize { double x0; double x1; })a4 renderEncoder:(id)a5;
- (long long)renderZoomFactorForStroke:(id)a0;
- (void)resetDrawableDirtyRect;
- (void)resetPaintFramebufferAccumulate:(char)a0;
...
- (char)setupAlphaBlendingForAlphaBlendFactor:(double)a0 renderEncoder:(id)a1;
- (char)setupClippingForStrokeClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 clippedToPixelSpaceRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 renderEncoder:(id)a2 outNewClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a3;
- (void)setupDrawingFramebuffersIfNecessaryWantMemorylessPaint:(char)a0;
- (void)setupForDefaultUberVertexShaderInRenderEncoder:(id)a0;
- (void)setupOriginalBackFramebufferIfNecessary;
- (void)setupRenderEncoder:(id)a0 forParticleStroke:(void *)a1 secondaryParticles:(char)a2;
...
- (void)setupRenderState:(id)a0 needCompute:(char)a1;
- (void)setupRenderState:(id)a0 needCompute:(char)a1 clearPaint:(char)a2;
- (void)setupRenderStateForRenderingStrokes:(id)a0;
- (void)setupRenderStateForStrokeRenderingNumPaintBuffers:(long long)a0 needRenderMask:(char)a1;
- (void)setupRenderStateWithLiveRenderConfig:(struct RenderStateConfig { id x0; id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; char x9; char x10; long long x11; })a0;
...
- (char)shouldAccumulateLiveStrokeToBuffer;
- (char)shouldRenderDebugColorForStroke:(id)a0;
- (id)singleAttachmentBlitShader;
- (char)sixChannelBlendingIsEnabled;
...
- (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })strokeRenderTransformForFramebufferSize:(struct CGSize { double x0; double x1; })a0 flipped:(char)a1;
...
- (void)updateTile:(id)a0 strokes:(id)a1 clear:(char)a2 waitUntilCompleted:(char)a3 offscreen:(char)a4 stopBlock:(id /* block */)a5;
- (char)useBlitEncoder;
