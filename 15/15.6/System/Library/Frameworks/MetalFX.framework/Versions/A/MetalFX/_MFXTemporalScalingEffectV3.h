...
@interface _MFXTemporalScalingEffectV3 : _MTLFXTemporalScaler <MTLFXTemporalScalerSPI> {
    ...
    char _autoExposureEnabled;
    char _useANE;
    char _midBicubicWarp;
    char _reactiveMaskEnabled;
    char _enableLateLatch;
    char _prewarmComplete;
    ...
    struct BRNet_v3_Filter { int x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; int x8; int x9; int x10; int x11; int x12; unsigned short x13; unsigned short x14; BOOL x15; BOOL x16; BOOL x17; BOOL x18; BOOL x19; BOOL x20; int x21; id x22; id x23; id x24; id x25[2]; id x26[2]; unsigned char x27; id x28; id x29; id x30; id x31; id x32; id x33; id x34[2]; id x35[2]; id x36[2]; id x37; id x38; id x39[2]; id x40[2]; id x41; id x42; id x43; id x44; id x45; id x46; id x47; id x48; id x49; id x50; id x51; id x52; id x53; id x54; id x55; id x56; id x57; id x58; id x59; id x60; id x61; id x62; id x63; } *_filter;
