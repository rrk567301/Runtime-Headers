...
@property (nonatomic, getter=isSessionSuspended) char sessionSuspended;
...
- (void)_setActive:(char)a0 forRoute:(id)a1;
...
- (char)isRouteActive:(id)a0;
- (void)setActive:(char)a0 forRoute:(id)a1;
