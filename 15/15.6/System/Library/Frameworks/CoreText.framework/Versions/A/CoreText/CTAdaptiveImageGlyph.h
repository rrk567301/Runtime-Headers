...
@property (class, readonly) char _readsAdaptiveImageGlyphFromDocumentFormats;
@property (class, readonly) char prefersTextAttachment;
@property (class, readonly) char prefersEmojiImageTextAttachment;
...
+ (void)setPrefersEmojiImageTextAttachment:(char)a0;
+ (void)setPrefersTextAttachment:(char)a0;
