...
+ (id)_namesOfFontCollectionsWithVisibility:(unsigned long long)a0 includingHidden:(char)a1;
...
+ (char)hideFontCollectionWithName:(id)a0 visibility:(unsigned long long)a1 error:(id *)a2;
+ (char)renameFontCollectionWithName:(id)a0 visibility:(unsigned long long)a1 toName:(id)a2 error:(id *)a3;
+ (char)showFontCollection:(id)a0 withName:(id)a1 visibility:(unsigned long long)a2 error:(id *)a3;
...
- (char)_hasDesignatedName;
- (void)_replaceDescriptorsFromCollection:(id)a0;
- (char)_saveToURL:(id)a0 error:(id *)a1;
