@class NSString;
@protocol MTLDevice, MTLEvent, MTLCommandQueue, PGDeserializer;
...
- (id)addressRangesForVirtualPage:(unsigned int)a0 length:(unsigned long long)a1 readOnly:(char *)a2;
