...
- (char)_addTableFromAnalysis:(id)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 toPDFPage:(id)a2;
...
- (void)_callCompletionBlock:(id /* block */)a0 onQueue:(id)a1 analysis:(id)a2 error:(id)a3 foundTable:(char)a4;
