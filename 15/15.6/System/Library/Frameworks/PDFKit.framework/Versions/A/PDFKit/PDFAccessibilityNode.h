...
+ (char)_containsOnlyTextDescendant:(struct CGPDFTaggedNode { } *)a0;
+ (char)_containsSomeTextContainerChilden:(struct CGPDFTaggedNode { } *)a0;
+ (char)_containsSomeTextDescendant:(struct CGPDFTaggedNode { } *)a0;
+ (char)_containsSomeTextWordNodes:(struct CGPDFTaggedNode { } *)a0;
...
- (id)_descendantNodeWithClass:(Class)a0 fromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 reverseSearch:(char)a2;
...
- (void)_print:(id)a0 isTail:(char)a1;
