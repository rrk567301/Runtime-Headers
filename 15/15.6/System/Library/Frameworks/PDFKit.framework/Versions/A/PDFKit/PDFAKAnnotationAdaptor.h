...
+ (id)annotationAdaptorWithPDFAnnotation:(id)a0 andCGPDFAnnotation:(struct CGPDFAnnotation { } *)a1 andPDFDictionary:(struct CGPDFDictionary { } *)a2 updatePDFAnnotationIfNeeded:(char)a3;
