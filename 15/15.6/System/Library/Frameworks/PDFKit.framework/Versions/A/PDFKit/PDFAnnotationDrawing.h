...
+ (void)drawAppearance:(int)a0 ofAnnotation:(id)a1 withBox:(long long)a2 inContext:(struct CGContext { } *)a3 scaleProportional:(char)a4;
+ (void)drawAppearance:(int)a0 ofAnnotation:(id)a1 withBox:(long long)a2 inContext:(struct CGContext { } *)a3 scaleProportional:(char)a4 suppressTextRendering:(char)a5;
+ (void)drawArrowFrom:(struct CGPoint { double x0; double x1; })a0 to:(struct CGPoint { double x0; double x1; })a1 open:(char)a2 inContext:(struct CGContext { } *)a3 withBorder:(id)a4;
+ (void)drawBulletAtPoint:(struct CGPoint { double x0; double x1; })a0 shape:(int)a1 inContext:(struct CGContext { } *)a2 withBorder:(id)a3;
+ (void)drawCheckBox:(id)a0 inContext:(struct CGContext { } *)a1 withState:(long long)a2 withBackgroundColor:(id)a3 withBorderColor:(id)a4 withFontColor:(id)a5 isHighlighted:(char)a6;
...
+ (void)drawPushButton:(id)a0 inContext:(struct CGContext { } *)a1 withBackgroundColor:(id)a2 withCaption:(id)a3 withFont:(id)a4 withFontColor:(id)a5 isHighlighted:(char)a6;
+ (void)drawRadioButton:(id)a0 inContext:(struct CGContext { } *)a1 withState:(long long)a2 withBackgroundColor:(id)a3 withBorderColor:(id)a4 withFontColor:(id)a5 isHighlighted:(char)a6;
...
+ (char)renderString:(id)a0 forRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 font:(id)a2 color:(id)a3 alignment:(long long)a4 rotation:(int)a5 breaks:(char)a6 context:(struct CGContext { } *)a7 withAnnotation:(id)a8;
