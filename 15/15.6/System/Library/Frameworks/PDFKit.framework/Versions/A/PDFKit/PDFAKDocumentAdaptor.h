...
+ (void)setIsHandlingEditDetected:(char)a0;
...
- (char)handleBackTabInTextEditorForAnnotation:(id)a0 forAnnotationController:(id)a1;
...
- (char)handleTabInTextEditorForAnnotation:(id)a0 forAnnotationController:(id)a1;
- (char)hasHighlightableSelectionForAnnotationController:(id)a0;
...
- (char)requestPermissionForController:(id)a0 toPerformActionFromSender:(long long)a1;
- (void)rotateLeft:(id)a0;
- (void)rotateRight:(id)a0;
- (void)setPreferredCursor:(id)a0 forAnnotationController:(id)a1;
- (char)shouldAddTabControlsToTextEditorForAnnotation:(id)a0 forAnnotationController:(id)a1;
