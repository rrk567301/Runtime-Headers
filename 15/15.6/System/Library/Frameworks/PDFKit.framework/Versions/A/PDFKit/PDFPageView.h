...
@property (getter=isOverlayViewInstalled) char overlayViewInstalled;
...
- (char)_shouldReplaceStringOnAnnotation:(id)a0 withTextView:(id)a1;
...
- (void)colorWidgetBackgrounds:(char)a0;
