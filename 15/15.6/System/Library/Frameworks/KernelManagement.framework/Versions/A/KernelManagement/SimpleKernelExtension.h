...
@property (nonatomic) char kextIsSigned;
...
- (id)initWithBundleIdentifier:(id)a0 fileSystemPath:(id)a1 loaded:(char)a2 kextIsSigned:(char)a3 versionString:(id)a4 lastModifiedDate:(id)a5 signingInfo:(id)a6 infoString:(id)a7 type:(unsigned long long)a8 displayName:(id)a9 architectures:(id)a10 loadAddress:(id)a11 usageDescription:(id)a12;
