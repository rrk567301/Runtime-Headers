...
- (char)_bundleMustLoadInWindow:(id)a0;
- (void)_didEndLoading;
...
- (void)displayBundle:(id)a0 didSaveEdit:(char)a1 toURL:(id)a2;
- (void)displayBundle:(id)a0 didShowScreentimeLockout:(char)a1;
...
- (void)displayBundleDidExitMarkup:(id)a0 waitingForSave:(char)a1;
...
- (void)setExternalDocument:(char)a0;
