...
@interface QLPreviewBubble : NSObject <QLSeamlessOpenerDelegate> {
    ...
    NSArray *_modes;
    char _modesAreCustom;
    char _autoplays;
    char _forcePreferredEdge;
    id _eventMonitor;
    char _seamlesslyOpening;
    char _seamlesslyVisible;
    char _seamlesslyClosed;
...
@property char autoplays;
@property char forcePreferredEdge;
...
+ (void)setGlobalSeamlesslyOpening:(char)a0;
...
- (void)setSeamlesslyOpening:(char)a0;
