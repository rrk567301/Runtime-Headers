...
- (void)_checkToCloseTransientWindowWithAnimation:(char)a0;
- (void)_closeTransientWindowWithAnimation:(char)a0;
...
- (int)_openItems:(id)a0 async:(char)a1 local:(char)a2 realAppPID:(int)a3 options:(id)a4;
- (void)beginShowingTransientWindow;
- (void)endShowingTransientWindowShouldAnimate:(char)a0;
