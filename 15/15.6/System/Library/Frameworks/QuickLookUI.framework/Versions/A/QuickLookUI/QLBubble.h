...
@interface QLBubble : NSObject <QLControlsDelegate, NSWindowDelegate> {
    ...
    char _forcePreferredEdge;
    char _forceTitleBar;
    char _forceNoArrow;
    int _invokeBubbleTimeout;
    char _bubbleWasManuallyMoved;
    id _eventMonitor;
    char _isOpen;
    char _closing;
...
@property char preventsActivation;
@property char skipAnimationInvoke;
@property char skipAlphaDuringOpenAnimation;
@property char ignoreItemFrameWhenResizing;
@property char neverResize;
@property char mouseDownCanMoveBubble;
...
- (void)_setDirectlyVisible:(char)a0;
- (void)_showBubble;
- (void)_updateBubbleShow:(char)a0;
...
- (void)setControlsAtBottom:(char)a0;
- (void)setForcePreferredEdge:(char)a0;
- (void)setForceTitleBar:(char)a0;
