...
+ (struct CGSize { double x0; double x1; })optimalContentSizeForDisplayable:(id)a0 currentSize:(struct CGSize { double x0; double x1; })a1 adaptToScreen:(char)a2 screen:(id)a3 userDefinedSizes:(id)a4 inOutMinSize:(struct CGSize { double x0; double x1; } *)a5 outRatioNumber:(id *)a6 deltaPosition:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a7 onlyRatio:(char *)a8;
+ (struct CGSize { double x0; double x1; })optimalContentSizeForDisplayable:(id)a0 currentSize:(struct CGSize { double x0; double x1; })a1 minSize:(struct CGSize { double x0; double x1; })a2 adaptToScreen:(char)a3 screen:(id)a4;
