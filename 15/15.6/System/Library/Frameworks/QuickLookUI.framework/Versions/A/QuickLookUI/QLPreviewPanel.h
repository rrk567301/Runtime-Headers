...
@property char autosizesAndCenters;
@property char positionNearPreviewItem;
@property char loadingForForceTouch;
@property char showsIndexSheet;
@property char playsSlideShow;
@property char autostarts;
@property char playsDuringPanelAnimation;
@property char deferredLoading;
...
- (void)_cleanupPanel;
- (void)_closeWithEffect:(int)a0 canToggle:(char)a1 force:(char)a2;
...
- (void)_openWithEffect:(int)a0 willOpen:(char)a1 toFullscreen:(char)a2;
- (id)_openingAnimationOperationNameWithContentId:(id)a0;
- (unsigned long long)_openingAnimationSignpostID;
- (void)_orderFrontAndMakeKey:(char)a0;
...
- (id)_scaleEffectForItemFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isClosing:(char)a1;
...
- (void)_updateFocusBackgroundWindowWithSpotlight:(char)a0 forScreen:(id)a1;
- (void)beginDeferredClosing;
- (char)canPerformKeyEquivalent:(id)a0;
- (void)closeWithEffect:(int)a0 ignoreDirtyDocumentState:(char)a1 canToggle:(char)a2 force:(char)a3;
...
- (void)setCyclesSelection:(char)a0;
- (void)setFocusMode:(int)a0 animate:(char)a1;
