...
@property char tightLayout;
@property char highlighted;
@property (nonatomic) char perspectiveLayout;
@property char liveResize;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_imageFrameInBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 textVisible:(char)a1;
- (double)_interspace;
