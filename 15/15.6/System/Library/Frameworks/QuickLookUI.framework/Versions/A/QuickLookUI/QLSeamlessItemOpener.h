...
- (id)_displayStateFromViewDisplayState:(id)a0 fullscreen:(char)a1 screenFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
- (void)_invalidateWithSuccess:(char)a0;
