...
- (void)activateIndexSheetWithAnimation:(char)a0 forItemAtIndex:(unsigned long long)a1;
- (void)deactivateIndexSheetWithAnimation:(char)a0 forItemAtIndex:(unsigned long long)a1;
