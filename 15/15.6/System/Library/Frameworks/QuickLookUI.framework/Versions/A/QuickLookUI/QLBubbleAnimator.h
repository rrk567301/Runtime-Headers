...
- (void)setSize:(struct CGSize { double x0; double x1; })a0 itemFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 edge:(unsigned long long)a2 animate:(char)a3;
