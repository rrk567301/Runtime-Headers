...
@property (readonly) char isTranslated;
...
- (char)generateMemoryGraphWithContentLevel:(unsigned int)a0 memgraphFailedReasonOut:(unsigned long long *)a1;
- (void)populateAdditionalMetadataWithDiagnostics:(char)a0;
- (id)prettyPrintBacktrace:(char)a0;
- (id)prettyPrintBinaryImages;
- (id)prettyPrintIOAccelMemoryInfo;
- (id)prettyPrintIOSurfaceInfo;
- (void)releaseAnalyzedTask;
- (char)saveLogFileWithHandle:(id)a0 error:(id *)a1;
