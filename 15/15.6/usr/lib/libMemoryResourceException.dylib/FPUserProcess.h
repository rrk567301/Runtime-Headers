...
@property (readonly, nonatomic) char doOwnedAccountingAdjustments;
...
- (char)_isAlive;
- (char)_populateMemoryRegionWithPageQueries:(id)a0 regionInfo:(struct vm_region_submap_info_64 { int x0; int x1; unsigned int x2; unsigned long long x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned short x10; unsigned char x11; unsigned char x12; unsigned int x13; int x14; unsigned int x15; unsigned short x16; unsigned int x17; unsigned long long x18; } *)a1;
- (char)_populateTask;
