...
- (char)applyScript:(id)a0 error:(id *)a1;
- (char)applyScript:(id)a0 ignoreSW:(char)a1 error:(id *)a2;
...
- (id)transceiveAndCheckSW:(id)a0 inArray:(id)a1 keepingSW:(char)a2 error:(id *)a3;
- (id)transceiveAndCheckSW:(id)a0 keepingSW:(char)a1 error:(id *)a2;
...
- (id)transceiveBytesAndCheckSW:(const char *)a0 length:(unsigned long long)a1 inArray:(id)a2 keepingSW:(char)a3 error:(id *)a4;
- (id)transceiveBytesAndCheckSW:(const char *)a0 length:(unsigned long long)a1 keepingSW:(char)a2 error:(id *)a3;
