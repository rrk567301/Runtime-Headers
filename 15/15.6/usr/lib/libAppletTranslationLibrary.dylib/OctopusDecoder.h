...
+ (unsigned int)filterHistoryEntry:(id)a0;
+ (id)getAAVSAmount:(id)a0;
+ (id)getBaseDate:(id)a0;
+ (unsigned int)getEnRouteStatus:(id)a0;
...
+ (unsigned int)isDenyListed:(id)a0;
+ (char)isTopUpTransaction:(unsigned char)a0;
+ (unsigned int)isTransitTransactionCode:(unsigned char)a0;
