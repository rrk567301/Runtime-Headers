...
+ (char)parseRecordUsingScanner:(struct _NFDataScanner { struct _NFData *x0; unsigned long long x1; void *x2; } *)a0 header:(char *)a1 type:(id *)a2 identifier:(id *)a3 payload:(id *)a4;
