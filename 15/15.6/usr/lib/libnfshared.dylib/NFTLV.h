...
+ (id)_parseTLVs:(const char **)a0 end:(const char *)a1 simple:(char)a2 definite:(char)a3;
+ (id)TLVSsWithBytes:(const void *)a0 length:(unsigned long long)a1 requireDefiniteEncoding:(char)a2;
...
+ (id)TLVsWithData:(id)a0 requireDefiniteEncoding:(char)a1;
