...
+ (char)cancelActiveSysdiagnoseWithError:(id *)a0;
...
+ (char)isSysdiagnoseInProgressWithError:(id *)a0;
...
+ (char)verifyReply:(id)a0 withExpectedType:(struct _xpc_type_s { } *)a1 forError:(id *)a2;
