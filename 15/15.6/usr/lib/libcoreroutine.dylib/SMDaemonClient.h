...
@property (nonatomic) char monitorInitiatorSafetyCache;
@property (nonatomic) char monitorReceiverSessionStatus;
@property (nonatomic) char monitorReceiverSafetyCache;
@property (retain, nonatomic) SMSessionStore *sessionStore;
@property (nonatomic) char monitorSessionState;
@property (nonatomic) char monitorLocalSessionState;
