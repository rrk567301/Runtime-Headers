...
+ (id)managedObjectWithSessionIdentifier:(id)a0 currentRegionState:(unsigned long long)a1 triggerPending:(char)a2 triggerConfirmed:(char)a3 date:(id)a4 managedObjectContext:(id)a5;
