...
+ (char)isStandalone;
+ (char)isCellularActivated;
+ (void)submitCAMetricForMessageType:(unsigned long long)a0 scheduledSend:(char)a1 cancelationAttempt:(char)a2 attemptNumber:(long long)a3 wasFinalAttempt:(char)a4 timeToSendMessage:(double)a5 sendError:(id)a6 success:(char)a7 numReceivers:(unsigned long long)a8;
...
- (void)iMessageReceived:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)iMessageScheduledSendCancelFor:(id)a0 successful:(char)a1 withError:(id)a2;
- (void)iMessageScheduledSendScheduledFor:(id)a0 guid:(id)a1 successful:(char)a2 withError:(id)a3;
- (void)iMessageScheduledSendTriggeredFor:(id)a0;
- (void)iMessageSendFor:(id)a0 guid:(id)a1 successful:(char)a2 withError:(id)a3;
- (void)receivedMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedSessionStartMessageSendResultWithMessage:(id)a0 guid:(id)a1 successful:(char)a2 withError:(id)a3;
