...
+ (id)propertyDictionaryForIsVisited:(char)a0;
...
- (void)_fetchWorkoutsWithOffset:(unsigned long long)a0 limit:(unsigned long long)a1 maxDistanceThreshold:(double)a2 includeVisitedRecords:(char)a3 handler:(id /* block */)a4;
...
- (void)fetchWorkoutDistancesWithOffset:(unsigned long long)a0 limit:(unsigned long long)a1 maxDistanceThreshold:(double)a2 includeVisitedRecords:(char)a3 handler:(id /* block */)a4;
- (void)fetchWorkoutDistancesWithWorkout:(id)a0 handler:(id /* block */)a1;
- (void)storeWorkoutDistances:(id)a0 handler:(id /* block */)a1;
- (void)updateWorkoutDistancesWithObjectIDs:(id)a0 isVisited:(char)a1 handler:(id /* block */)a2;
