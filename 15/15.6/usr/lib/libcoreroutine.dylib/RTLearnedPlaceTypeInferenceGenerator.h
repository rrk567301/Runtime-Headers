...
- (id)inferPlaceTypesFromModelWithCandidateSelection:(char)a0 homeModelType:(unsigned long long)a1 workModelType:(unsigned long long)a2 placeStats:(id)a3 dateInterval:(id)a4;
