...
+ (void)submitBluePOIWiFiScanMetricsWithFingerprintsCount:(unsigned long long)a0 fingerprintsZeroAccessPointsCount:(unsigned long long)a1 fingerprintsNonZeroAccessPointsCount:(unsigned long long)a2 isFingerprintWindowFallback:(char)a3 timeIntervalSinceEarliestFingerprint:(double)a4 timeIntervalSinceLatestFingerprint:(double)a5 totalAccessPointsCount:(unsigned long long)a6 visitInterval:(double)a7 visitSource:(long long)a8;
