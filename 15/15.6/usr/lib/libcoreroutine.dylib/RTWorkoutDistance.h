...
@property (readonly, nonatomic) char areBothWorkoutsDecimated;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithObjectID:(id)a0 firstWorkout:(id)a1 secondWorkout:(id)a2 distanceMetric:(long long)a3 workoutActivityType:(long long)a4 areBothWorkoutsDecimated:(char)a5 distance:(double)a6 isVisited:(char)a7 date:(id)a8;
