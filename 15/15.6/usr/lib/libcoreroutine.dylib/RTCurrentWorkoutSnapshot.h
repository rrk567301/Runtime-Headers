...
- (id)description;
- (void).cxx_destruct;
- (id)initWithSessionIdentifier:(id)a0 activityType:(unsigned long long)a1 locationType:(long long)a2 swimmingLocationType:(long long)a3 isFirstPartyWorkout:(char)a4 sessionState:(unsigned long long)a5 workoutStartDate:(id)a6 snapshotDate:(id)a7;
