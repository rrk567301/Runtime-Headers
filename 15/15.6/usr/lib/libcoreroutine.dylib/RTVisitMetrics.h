...
- (char)collectBatchedMetricsForDateInterval:(id)a0 error:(id *)a1;
- (char)collectMetricsForDateInterval:(id)a0 configurations:(id)a1 error:(id *)a2;
- (char)collectRealtimeMetricsForDateInterval:(id)a0 error:(id *)a1;
...
- (id)predominantMotionMetricsForVisit:(id)a0 isPreviousVisit:(char)a1;
