...
@property (readonly, nonatomic) char migrationComplete;
...
- (void)fetchHindsightVisitsBetweenStartDate:(id)a0 endDate:(id)a1 ascending:(char)a2 handler:(id /* block */)a3;
...
- (void)_fetchHindsightVisitsBetweenStartDate:(id)a0 endDate:(id)a1 ascending:(char)a2 handler:(id /* block */)a3;
...
- (char)_matchLocation:(id)a0 locationOfInterest:(id)a1 minCircleOverlapThreshold:(double)a2 error:(id *)a3;
...
- (char)validateUpdatedMapItem:(id)a0 locationOfInterest:(id)a1 error:(id *)a2;
