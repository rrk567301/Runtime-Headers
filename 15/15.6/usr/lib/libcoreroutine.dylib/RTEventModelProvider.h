...
@property (nonatomic) char locationsOfInterestsAvailable;
...
- (char)_deleteUserInteractionsBeforeDate:(id)a0;
...
- (char)_hasSuggestedLocationForEvent:(id)a0;
- (unsigned long long)_locationStateOfEvent:(id)a0;
- (char)_persistEventModel;
- (char)_persistUserInteractionWithPredictedLocationOfInterest:(id)a0 interaction:(unsigned long long)a1 feedback:(id)a2;
...
- (void)addEvent:(id)a0 toIdentifierDict:(id)a1 useCalendarIdentifier:(char)a2;
- (id)appendFieldToCategoryString:(id)a0 field:(id)a1 value:(long long)a2;
- (id)categoryForLocationState:(unsigned long long)a0 ttlTrigggerd:(char)a1;
...
- (char)highProbabilityHistogramItem:(id)a0;
...
- (char)relativeHighProbabilityHistogramItem:(id)a0 toItem:(id)a1;
