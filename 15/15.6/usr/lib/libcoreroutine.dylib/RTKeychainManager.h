...
- (char)_updateKey:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
...
- (char)_setKey:(id)a0 forIdentifier:(id)a1 error:(id *)a2;
- (void)_shutdownWithHandler:(id /* block */)a0;
- (int)_updateSecItemMatchingQuery:(id)a0 attributes:(id)a1;
- (id)createSymmetricKeyWithSize:(long long)a0 identifier:(id)a1 storeInKeychain:(char)a2 error:(id *)a3;
- (id)encryptionKeyWithSize:(long long)a0 identifier:(id)a1 error:(id *)a2;
- (char)removeEncryptionKeyWithIdentifier:(id)a0 error:(id *)a1;
- (void)sendDiagnosticsToURL:(id)a0 options:(id)a1 handler:(id /* block */)a2;
- (char)updateKeyWithIdentifier:(id)a0 keyData:(id)a1 keySize:(long long)a2 error:(id *)a3;
