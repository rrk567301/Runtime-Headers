...
+ (char)areSessionConfigsInTheSameInterval:(id)a0 config2:(id)a1 timeInADayInterval:(id)a2 error:(id *)a3;
+ (id)getDateUsingYearMonthDayFromDate:(id)a0 hoursMinsSecsFromDate:(id)a1;
+ (char)isDateBetweenStartDate:(id)a0 endDate:(id)a1 targetDate:(id)a2 error:(id *)a3;
...
- (void)_deleteSMLocationMOPredating:(id)a0 handler:(id /* block */)a1;
- (void)_deleteSMWorkoutEventMOPredating:(id)a0 handler:(id /* block */)a1;
...
- (void)deleteSMLocationMOPredating:(id)a0 handler:(id /* block */)a1;
- (void)deleteSMWorkoutEventMOPredating:(id)a0 handler:(id /* block */)a1;
