...
@property (nonatomic) char locationContextMonitoringEnabled;
...
@property (nonatomic) char inLowConfidenceVisit;
@property (nonatomic) char inHighConfidenceVisit;
...
- (char)_clearTimerWithError:(id *)a0;
...
- (char)_postLocationContextNotificationUsingData:(id)a0 error:(id *)a1;
- (char)_resetTimerWitherror:(id *)a0;
