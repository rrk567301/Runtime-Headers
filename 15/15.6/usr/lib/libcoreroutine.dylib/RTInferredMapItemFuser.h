...
- (id)fusedInferredMapItemsUsingCandidates:(id)a0 referenceLocation:(id)a1 snapToBestKnownPlaceAndAoi:(char)a2 error:(id *)a3;
...
- (char)initializeEntriesForNonAoiDedupedInferredMapItems:(id)a0 aoiDedupedInferredMapItems:(id)a1 nonAoiUUIDToLogProbMap:(id *)a2 aoiUUIDToProbArrayMap:(id *)a3 error:(id *)a4;
...
- (char)partitionDedupedInferredMapItems:(id)a0 intoNonAoiDedupedInferredMapItems:(id *)a1 aoiDedupedInferredMapItems:(id *)a2 error:(id *)a3;
- (id)populateMapItemSourceEntriesForDedupedInferredMapItems:(id)a0 error:(id *)a1;
- (id)preprocessCandidates:(id)a0 referenceLocation:(id)a1 snapToBestKnownPlaceAndAoi:(char)a2 error:(id *)a3;
- (id)snapToBestAOICandidate:(id)a0 error:(id *)a1;
- (id)subtractMaxLogarithmFromLogProbMap:(id)a0 error:(id *)a1;
- (char)updateAoiUUIDToProbArrayMap:(id)a0 aoiDedupedInferredMapItems:(id)a1 error:(id *)a2;
- (char)updateNonAoiUUIDToLogProbMap:(id)a0 bluePOIDedupedInferredMapItems:(id)a1 error:(id *)a2;
- (char)updateNonAoiUUIDToLogProbMap:(id)a0 nonAoiDedupedInferredMapItems:(id)a1 error:(id *)a2;
- (char)updateNonAoiUUIDToLogProbMap:(id)a0 nonBluePOIDedupedInferredMapItems:(id)a1 error:(id *)a2;
