...
+ (char)isLocationShiftRequiredForCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0;
...
- (id)shiftedLocation:(id)a0 allowNetwork:(char)a1 error:(id *)a2;
