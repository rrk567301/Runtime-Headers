...
@property (nonatomic) char monitorVisits;
@property (nonatomic) char leechVisits;
@property (nonatomic) char leechLowConfidenceVisits;
@property (nonatomic) char monitorPlaceInferences;
...
- (void)_fetchHindsightVisitsWithDateInterval:(id)a0 ascending:(char)a1 handler:(id /* block */)a2;
...
- (char)hasReasonToOutliveClientConnection;
...
- (void)setRoutineEnabled:(char)a0 reply:(id /* block */)a1;
...
- (void)updateCloudSyncProvisionedForAccount:(char)a0 reply:(id /* block */)a1;
