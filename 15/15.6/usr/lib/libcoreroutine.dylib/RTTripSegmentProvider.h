...
@property (nonatomic) char sessionInProgress;
@property (nonatomic) char usingLegacyInertialData;

+ (long long)CLTripModeFromRTModeOfTransportation:(long long)a0;
+ (id)convertToTripSegmentLocations:(id)a0;
+ (char)isLocationTypeSupported:(int)a0;
+ (char)isTripSegmentGenerationSupportedOnPlatform:(id)a0;
...
- (char)allowReprocessingOfTransitionsWithTripSegments;
- (char)applyElevationAdjustmentToBreadcrumbs;
...
- (char)isTripSegmentGenerationEnabled;
