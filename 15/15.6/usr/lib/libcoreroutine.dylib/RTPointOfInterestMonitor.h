...
@property (nonatomic) char requestingHighAccuracyLocation;
@property (nonatomic) char registeredForRegionEvents;
...
- (void)_setup;
- (void)_shutdown;
- (char)_startMonitoringLocation:(id)a0 error:(id *)a1;
- (char)_exceedPowerBudget;
...
- (char)_setupPolygonalRegionsForLocations:(id)a0 error:(id *)a1;
- (char)_shouldMonitorLocation:(id)a0;
- (char)_shouldRequestHighAccuracyLocationsForMonitoringRegionLocations:(id)a0;
