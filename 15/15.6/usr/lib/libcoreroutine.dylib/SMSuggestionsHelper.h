...
+ (char)isContactBlocked:(id)a0 error:(id *)a1;
+ (char)isValidDistance:(double)a0;
...
- (void)_getNPLOIsWithOnlyHighConfidence:(char)a0 location:(id)a1 date:(id)a2 handler:(id /* block */)a3;
...
- (id)_submitMetricForFetchMostLikelyReceiverHandlesDidComplete:(char)a0 didFetchSessionConfigurations:(char)a1 didFetchEmergencyContacts:(char)a2 didFetchICloudFamily:(char)a3 didFetchFavorites:(char)a4 timeout:(double)a5;
- (id)_submitMetricForFetchMostLikelySessionDestinationsWithRefreshedLocationDidComplete:(char)a0 didFetchNavigationRouteSummary:(char)a1 didFetchLOIs:(char)a2 didFetchNPLOIs:(char)a3 didFetchSessionConfigurations:(char)a4 timeout:(double)a5;
...
- (void)getNPLOIsWithOnlyHighConfidence:(char)a0 location:(id)a1 date:(id)a2 handler:(id /* block */)a3;
