...
- (char)_inferUserSpecificPlaceTypeForInferredMapItem:(id)a0 userSpecificPlaceType:(unsigned long long *)a1 userSpecificPlaceTypeSource:(unsigned long long *)a2 error:(id *)a3;
- (char)_learnedPlaceTypeForInferredMapItem:(id)a0 placeType:(unsigned long long *)a1 placeTypeSource:(unsigned long long *)a2 error:(id *)a3;
...
- (char)_savePlaceInferenceQueriesFromInferredMapItems:(id)a0 inferenceErrorCode:(long long)a1 referenceLocation:(id)a2 options:(id)a3 outError:(id *)a4;
