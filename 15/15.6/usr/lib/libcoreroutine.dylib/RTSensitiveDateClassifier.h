...
@property (nonatomic) char inWifiDenseArea;
...
- (id)init;
- (void).cxx_destruct;
- (char)_accessPointsConditionsMet;
...
- (char)_isNearSensitiveLocation:(id)a0;
...
- (char)_sensitiveMotionSignalDetectedForMotion:(id)a0 startDate:(id)a1 endDate:(id)a2;
