...
@property (nonatomic) char spoofMode;
...
@property (nonatomic) char findingPointOfInterest;
@property (nonatomic) char pointOfInterestUpdateEnabled;
...
- (char)shouldFindPointOfInterestForVisit:(id)a0;
