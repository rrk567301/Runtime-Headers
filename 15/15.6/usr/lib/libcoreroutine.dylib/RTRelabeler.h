...
+ (char)placeholderCandidate:(id)a0 knownPlaceTypeThreshold:(double)a1;
...
- (char)dedupeRelabelingCandidate:(id)a0 nonRevGeoCandidates:(id)a1 deduper:(id)a2 inferredMapItemDeduperState:(id *)a3 dedupedRelabelingCandidate:(id *)a4 dedupedNonRevGeoCandidates:(id *)a5 error:(id *)a6;
- (void)enableLogging:(char)a0;
...
- (char)partitionCandidates:(id)a0 intoNonRevGeoCandidates:(id *)a1 revGeoCandidates:(id *)a2 error:(id *)a3;
- (char)placeholderCandidate:(id)a0;
