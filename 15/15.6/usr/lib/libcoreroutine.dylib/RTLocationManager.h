...
@property (nonatomic) char leechingLocations;
@property (nonatomic) char monitoringLocations;
@property (nonatomic) char monitoringRhythmicLocations;
...
@property (nonatomic) char locationStoreAvailable;
@property (nonatomic) char persistingLocations;
...
+ (char)isValidLocation:(id)a0 options:(id)a1;
...
- (char)_isClientIdentifierAvailable:(id)a0;
- (char)_isMonitoringForRegionWithClientIdentifier:(id)a0 regionIdentifier:(id)a1;
- (char)_performCallbackForClientRegion:(id)a0 clientIdentifier:(id)a1 regionEvent:(long long)a2 callbackError:(id)a3 handler:(id /* block */)a4;
- (char)_performCallbackForRegion:(id)a0 regionEvent:(long long)a1 callbackError:(id)a2 handler:(id /* block */)a3;
...
- (char)_stopMonitoringAllRegionsForClientIdentifier:(id)a0 error:(id *)a1;
...
- (char)isMonitoringForRegionWithClientIdentifier:(id)a0 regionIdentifier:(id)a1;
...
- (char)startMonitoringForRegion:(id)a0 clientIdentifier:(id)a1 error:(id *)a2;
- (char)stopMonitoringAllRegionsForClientIdentifier:(id)a0 error:(id *)a1;
- (char)stopMonitoringForRegion:(id)a0 clientIdentifier:(id)a1 error:(id *)a2;
