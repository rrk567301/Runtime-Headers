...
+ (char)hasRawLocationsNeededToComputeSmoothedLocationAtDate:(id)a0 workingVisitExit:(id)a1 rawLocations:(id)a2 kernelWidth:(double)a3 smallestSignificantWeightExponent:(double)a4;
