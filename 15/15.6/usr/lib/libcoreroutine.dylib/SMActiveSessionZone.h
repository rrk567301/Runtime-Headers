...
@property (nonatomic) char activeSessionZoneAvailable;
...
- (char)isActiveSessionDetailsOutOfSync;
...
- (char)_isActiveSessionDetailsFetchedFromCloudKitSinceBoot;
- (char)_isActiveSessionDetailsLocalRecordExpired;
- (void)_notifyObserversForActiveSessionDetailsFetchAttemptedFromCKCompleted:(id)a0 success:(char)a1 error:(id)a2;
- (void)_onActiveSessionDetailsFetchAttemptFromCKCompleted:(id)a0 success:(char)a1 error:(id)a2;
...
- (char)isEligibleForCacheUpdateForCurrentDeviceIdentifier:(id)a0 sessionManagerState:(id)a1;
- (void)setup;
