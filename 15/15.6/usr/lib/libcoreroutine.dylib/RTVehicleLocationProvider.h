...
@property (nonatomic) char monitorVehicleLocation;
@property (nonatomic) char monitorExternalVehicleLocation;
@property (nonatomic) char monitorVehicleConnection;
@property (nonatomic) char monitorVehicleExit;
@property (nonatomic) char monitorLocation;
...
@property (nonatomic) char vehicleEventPendingDeletion;
@property (nonatomic) char locationsOfInterestAvailable;
...
- (char)_persistVehicleEvent:(id)a0;
...
- (char)_sameVehicleWithDeviceId:(id)a0 otherDeviceId:(id)a1;
...
- (char)pairedWithEligibleDevices;
