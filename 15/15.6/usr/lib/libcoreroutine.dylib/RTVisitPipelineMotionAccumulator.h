...
@property (readonly, nonatomic) char processActivitiesReverse;

+ (char)isActivityTypeMotionTrimmable:(unsigned long long)a0;

- (void).cxx_destruct;
- (void)finishMotionObservations:(id)a0;
- (id)getTrimDate;
- (id)initWithParams:(id)a0 processInReverse:(char)a1;
