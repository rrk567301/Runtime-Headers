...
@property (nonatomic) char isPedometerNotificationsSetupAfterRoutineStarted;
...
- (char)_shouldShowProactiveSuggestions;
- (id)_generatePersonalizedSuggestionForRegularUserFromContext:(id)a0 error:(id *)a1;
- (void)_onSessionEndedForActiveDevice:(char)a0;
- (void)onVehicleConnectedNotification:(id)a0;
- (void)_changeWidgetVisibilityForMessagesInstallationState:(char)a0;
- (char)_checkInitiatorEligibilityWithError:(id *)a0;
- (char)_checkReceiverEligibilityForHandle:(id)a0 error:(id *)a1;
- (char)_deleteProactiveNotificationUponNavigationDestination:(id)a0 error:(id *)a1;
- (char)_deleteProactiveNotificationWithDestinationLocation:(id)a0 error:(id *)a1;
- (char)_deleteProactiveNotificationWithError:(id *)a0;
- (char)_didInteractInPastWithHandle:(id)a0 timeInterval:(double)a1 error:(id *)a2;
...
- (id)_getNPLOIsToHomeWithOnlyHighConfidence:(char)a0 location:(id)a1 date:(id)a2 error:(id *)a3;
...
- (char)_isFirstTimeUserOfZelkovaWithError:(id *)a0;
- (char)_isSessionConfigurationSimilarToTheSuggestion:(id)a0 sessionConfiguration:(id)a1 error:(id *)a2;
- (char)_isUserInActiveSessionWithError:(id *)a0;
- (char)_isValidForNextTimePrompt;
- (char)_isWalkingBoutDetectedByAppendingPedometerData:(id)a0;
...
- (char)_reRegisterForPedometerNotificationsForLearnedLocationOfInterest:(id)a0 startDate:(id)a1 error:(id *)a2;
- (char)_refreshCurrentLocationWithError:(id *)a0;
- (char)_registerForPedometerNotificationsForLearnedLocationOfInterest:(id)a0 startDate:(id)a1 error:(id *)a2;
- (char)_resetStatesForPedometerData;
- (id)_runProactiveSuggestionsEngineWithContext:(id)a0 shouldStoreSuggestions:(char)a1 error:(id *)a2;
- (char)_setupPedometerDataHandler;
- (char)_setupPedometerNotificationsIfExists:(id *)a0;
...
- (char)_showSuggestionsDetectionUIWithSuggestion:(id)a0 error:(id *)a1;
- (unsigned long long)_suppressSuggestion:(id)a0 context:(id)a1 error:(id *)a2;
- (void)_triggerCheckInWorkoutURLUpdateWithShouldGenerateURL:(char)a0;
- (char)_unregisterForPedometerNotificationsWithError:(id *)a0;
...
- (char)isZelkovaSuggestionsFeatureEnabledWithError:(id *)a0;
...
- (void)runProactiveSuggestionsEngineWithContext:(id)a0 shouldStoreSuggestions:(char)a1 handler:(id /* block */)a2;
...
- (char)suggestionEnabledForUserType:(unsigned long long)a0;
