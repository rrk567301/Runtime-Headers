...
- (id)initWithBatchSize:(unsigned long long)a0 fetchLimit:(unsigned long long)a1 sortByStateStartDate:(char)a2 ascending:(char)a3 dateInterval:(id)a4 sessionIdentifier:(id)a5;
