...
- (char)enumerateRelationshipsInEntityDescription:(id)a0 sourceObject:(id)a1 error:(id *)a2;
- (char)establishEntityRelationships:(id *)a0;
- (id)fetchDestinationObjectWithEntityDescription:(id)a0 predicate:(id)a1 context:(id)a2 error:(id *)a3;
- (char)importEntityRowsAndAttributes:(id *)a0;
...
- (char)updateRelationshipWithEntity:(id)a0 relationshipDescription:(id)a1 relationshipIdentifiers:(id)a2 context:(id)a3 error:(id *)a4;
