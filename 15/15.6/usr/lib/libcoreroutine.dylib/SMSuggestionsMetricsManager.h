...
- (void).cxx_destruct;
- (void)_setup;
- (char)_collectAndSubmitMetricsUponNotification:(id)a0;
...
- (id)_computeWorkoutAlwaysPromptMetricsWithError:(id *)a0;
- (id)_getNPLOIsWithOnlyHighConfidence:(char)a0 location:(id)a1 date:(id)a2 error:(id *)a3;
...
- (char)_submitMetrics:(id)a0 event:(unsigned long long)a1 error:(id *)a2;
- (void)_submitWorkoutAlwaysPromptResponseMetricUponNotification:(id)a0;
...
- (void)setup;
- (void)submitWorkoutAlwaysPromptResponseMetricUponNotification:(id)a0;
