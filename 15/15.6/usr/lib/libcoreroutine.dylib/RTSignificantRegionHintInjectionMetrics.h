...
@property (nonatomic) char hintSubmitted;

+ (void)submitMetricsWithHintSource:(long long)a0 region:(id)a1 locationOfInterest:(id)a2 hintSubmitted:(char)a3 matchingError:(id)a4;

- (id)init;
- (void).cxx_destruct;
- (id)computeMetrics;
- (id)initWithHintSource:(long long)a0 region:(id)a1 locationOfInterest:(id)a2 hintSubmitted:(char)a3 matchingError:(id)a4;
- (void)submitMetrics;
