...
- (void)_fetchPlaceInferenceQueriesWithDateInterval:(id)a0 ascending:(char)a1 handler:(id /* block */)a2;
...
- (void)fetchPlaceInferenceQueriesWithDateInterval:(id)a0 ascending:(char)a1 handler:(id /* block */)a2;
