...
- (char)checkConsistencyBetweenLocation:(id)a0 otherLocation:(id)a1 error:(id *)a2;
- (char)checkFractionAreaOverlapBetweenLocation:(id)a0 otherLocation:(id)a1 largerThanThreshold:(double)a2 error:(id *)a3;
