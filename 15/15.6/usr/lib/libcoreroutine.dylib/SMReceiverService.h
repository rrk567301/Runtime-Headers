@class NSHashTable, RTXPCActivityManager, NSString, RTPlatform, SMMessagingService, RTDefaultsManager, RTInvocationDispatcher, NSMutableArray, SMSafetyCacheStore;
...
@property (nonatomic) char attemptedToLoadFromDisk;
...
+ (void)_submitSentinelZoneMaintenanceMetricForSuccess:(char)a0 error:(id)a1;
...
- (void)_initializeSentinelZoneWithCompletion:(id /* block */)a0;
- (void)_onMessageReceived:(id)a0;
- (void)_onSafetyCacheStoreNotification:(id)a0;
- (void)_receivedLowPowerModeWarningStateUpdateMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
...
- (id)initWithDefaultsManager:(id)a0 platform:(id)a1 messagingService:(id)a2 safetyCacheStore:(id)a3 xpcActivityManager:(id)a4;
...
- (void)receivedCacheUpdatedMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedEstimatedEndTimeUpdateMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedKeyReleaseInfoMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedKeyReleaseMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedSessionEndMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedSessionStartInfoMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
- (void)receivedSessionStartMessage:(id)a0 fromHandle:(id)a1 fromMe:(char)a2;
