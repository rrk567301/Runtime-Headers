...
- (char)_isExceedingUpperBoundEta:(id)a0 mapsExpectedTravelTime:(double)a1 crowFliesExpectedTravelTime:(double)a2;
- (char)_isNoProgressStatus;
...
- (char)_shouldChangeModeOfTransportStartDate:(id)a0 endDate:(id)a1;
- (char)_shouldUpdateCoarseEta:(id)a0;
- (char)_shouldUpdateUpperBoundEtaWithRemainingDistance:(double)a0 mapsExpectedTravelTime:(double)a1;
