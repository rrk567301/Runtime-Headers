...
- (id)_bluePOIQueryFromFingerprint:(id)a0 fingerprintIdx:(unsigned long long)a1 referenceLocationArray:(id)a2 selected:(char)a3 endDate:(id)a4 totalAPsCount:(unsigned long long *)a5 error:(id *)a6;
...
- (char)_fallbackToLocationBasedLookupForVisitDuration:(double)a0;
...
- (char)_hasMapItemInQueryResult:(id)a0 wifiFingerprintLabelType:(long long)a1;
...
- (id)_selectFingerprintsStartDate:(id)a0 endDate:(id)a1 maxQueryAttemps:(unsigned long long)a2 isTimeWindowFallback:(char *)a3 fingerprintsTotalOut:(unsigned long long *)a4 fingerprintsNonZeroAPsTotalOut:(unsigned long long *)a5 error:(id *)a6;
- (void)_submitPerformanceMetricsForResults:(id)a0 noFingerprints:(char)a1 originalMaxNumberOfQueries:(unsigned long long)a2 aoiConfidencePassThroughThreshold:(double)a3 poiConfidencePassThroughThreshold:(double)a4 fingerprintsCount:(unsigned long long)a5 zeroAccessPointsFingerprintsCount:(unsigned long long)a6 nonZeroAccessPointsFingerprintsCount:(unsigned long long)a7 queryCount:(unsigned long long)a8 firstResultQueryCount:(unsigned long long)a9 error:(id)a10 visitInterval:(double)a11 visitSource:(long long)a12;
...
- (char)chooseBestAoiInferredMapItem:(id *)a0 PoiInferredMapItem:(id *)a1 fromSortedAveragedResults:(id)a2 error:(id *)a3;
...
- (id)fingerprintsBetweenStartDate:(id)a0 endDate:(id)a1 isTimeWindowFallback:(char *)a2 settledState:(unsigned long long)a3 error:(id *)a4;
- (id)getAllBluePOIQuerriesForStartDate:(id)a0 endDate:(id)a1 location:(id)a2 error:(id *)a3;
- (char)harvestVisits:(id)a0 mapItem:(id)a1 harvestType:(unsigned long long)a2 error:(id *)a3;
...
- (char)skipForOptions:(id)a0 error:(id *)a1;
- (id)sortQueryResults:(id)a0 error:(id *)a1;
- (id)sortedAveragedQueryResults:(id)a0 baseDuration:(double)a1 error:(id *)a2;
- (char)sortedQueryResult:(id)a0 correspondsToAoi:(id)a1 poi:(id)a2;
- (char)submitHarvest:(id)a0 error:(id *)a1;
