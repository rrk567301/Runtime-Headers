...
@property (readonly, nonatomic) char selectedToLabel;
...
- (id)initWithIdentifier:(id)a0 accessPoints:(id)a1 locations:(id)a2 referenceLocation:(id)a3 settledState:(unsigned long long)a4 selectedToLabel:(char)a5 date:(id)a6;
