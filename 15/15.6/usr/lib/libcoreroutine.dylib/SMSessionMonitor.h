@class RTDefaultsManager, RTWatchWristStateManager, RTLocationManager, RTTimer, NSString, RTLearnedLocationManager, RTXPCTimerAlarm, RTTimerManager, SMSessionStore, RTPlatform, SMSessionMetricManager, RTDistanceCalculator, NSObject, SMSessionMonitorState, NSSet, SMCMNoMovementMonitor, RTHealthKitManager, CLLocation, RTMotionActivityManager, RTDataProtectionManager, SMSessionMonitorContext, SMSessionConfiguration;
...
- (void)_promptWorkoutAnomalyVerificationWithContext:(id)a0;
...
- (id)initWithDefaultsManager:(id)a0 dataProtectionManager:(id)a1 healthKitManager:(id)a2 locationManager:(id)a3 motionActivityManager:(id)a4 platform:(id)a5 sessionMetricManager:(id)a6 sessionStore:(id)a7 wristStateManager:(id)a8 noMovementMonitor:(id)a9;
- (id)initWithDefaultsManager:(id)a0 dataProtectionManager:(id)a1 healthKitManager:(id)a2 locationManager:(id)a3 motionActivityManager:(id)a4 platform:(id)a5 sessionMetricManager:(id)a6 sessionStore:(id)a7 wristStateManager:(id)a8 timerManager:(id)a9 noMovementMonitor:(id)a10;
