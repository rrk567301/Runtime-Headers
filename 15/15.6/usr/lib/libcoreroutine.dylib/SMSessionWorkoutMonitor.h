...
@property (nonatomic) char isWorkoutPaused;
@property (nonatomic) char endWorkoutReminderSettingEnabled;
...
- (char)_shouldPromptNoMovementTrigger:(id)a0;
- (void)_addObservers;
- (void)_bootstrap;
...
- (void)_removeTimers;
- (char)_shouldPromptEndWorkoutReminderTriggerWithReason:(unsigned long long)a0;
