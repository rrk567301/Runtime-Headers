...
- (id)init;
- (void).cxx_destruct;
- (id)initWithEventIdentifier:(id)a0 allDay:(char)a1 startDate:(id)a2 endDate:(id)a3 participantStatus:(unsigned long long)a4 availability:(long long)a5 location:(id)a6 locationTitle:(id)a7 locationMapItemHandle:(id)a8;
