...
- (char)checkForVersionMatch:(char *)a0 withBver:(id)a1;
...
- (char)performDfuUpdateForSuperBinary:(id)a0 withManifestData:(id)a1;
- (char)performUpdateForSuperBinaryData:(id)a0 manifestData:(id)a1 apHardwareID:(id)a2 skipSameVersion:(char)a3 debugFlags:(unsigned long long)a4 bver:(id)a5;
- (char)printVersions;
- (id)queryPanicStatus:(id *)a0;
- (void)setUarpChipCallbacks:(struct uarpChipCallbacks { void /* function */ *x0; void /* function */ *x1; } *)a0;
- (char)startAppModeUpdateForSuperBinaryData:(id)a0;
