...
- (void)decryptAndStoreSafetyCacheDataWithPhoneCacheData:(id)a0 watchCacheData:(id)a1 userInitiatedDownload:(BOOL)a2 metricsDict:(id *)a3;
...
- (void)onCacheDownloadResult:(BOOL)a0 userInitiatedDownload:(BOOL)a1 withError:(id)a2;
