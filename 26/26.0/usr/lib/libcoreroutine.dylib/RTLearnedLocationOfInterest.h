...
+ (id)createWithManagedObject:(id)a0 includeVisits:(BOOL)a1 includeTransitions:(BOOL)a2;
...
+ (id)createWithLearnedLocationOfInterestMO:(id)a0 includeVisits:(BOOL)a1 includeTransitions:(BOOL)a2;
