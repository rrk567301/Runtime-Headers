...
- (void)_registerActivityWithIdentifier:(id)a0 criteria:(id)a1 handler:(id /* block */)a2 deferHandler:(id /* block */)a3;
...
- (void)deleteDefaultsForIdentifier:(id)a0;
...
- (void)registerActivityWithIdentifier:(id)a0 criteria:(id)a1 handler:(id /* block */)a2 deferHandler:(id /* block */)a3;
