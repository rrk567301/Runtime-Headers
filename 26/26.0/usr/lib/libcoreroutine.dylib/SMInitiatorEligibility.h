...
+ (void)checkInitiatorEligibilityWithQueue:(id)a0 authorizationManager:(id)a1 effectivePairedDevice:(id)a2 handoffType:(long long)a3 defaultsManager:(id)a4 platform:(id)a5 appDeletionManager:(id)a6 handler:(id /* block */)a7;
...
+ (BOOL)shouldSkipCellularEligibilityCheckWithEffectivePairedDevice:(id)a0 handoffType:(long long)a1 defaultsManager:(id)a2;
