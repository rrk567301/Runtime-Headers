...
- (void)_validateAttachedSpatialVideoConfigurationInTaggedBufferGroup:(struct OpaqueCMTaggedBufferGroup { } *)a0 reportingObject:(id)a1 reportingSelector:(SEL)a2;
- (void)_willDeallocOrFinalize;
- (void)attachSpatialVideoConfiguration:(id)a0 toPixelBuffer:(struct __CVBuffer { } *)a1;
- (struct OpaqueFigVideoCompositorFrame { } *)compositionFrame;
- (void)finishCancelledRequest;
- (void)finishWithComposedTaggedBufferGroup:(struct OpaqueCMTaggedBufferGroup { } *)a0;
- (void)finishWithComposedVideoFrame:(struct __CVBuffer { } *)a0;
- (id)initUsingSession:(id)a0 withRenderContext:(id)a1 compositionFrame:(struct OpaqueFigVideoCompositorFrame { } *)a2 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a3 usingSources:(id)a4 instruction:(id)a5 withSampleBuffers:(id)a6 lookupableSpatialVideoConfigurations:(id)a7;
...
- (struct OpaqueCMTaggedBufferGroup { } *)sourceTaggedBufferGroupByTrackID:(int)a0;
