...
- (id)initWithDate:(id)a0 mediaTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 sessionID:(id)a2 fromVariant:(id)a3 toVariant:(id)a4 videoRendition:(id)a5 audioRendition:(id)a6 subtitleRendition:(id)a7 loadedTimeRanges:(id)a8 didSucceed:(BOOL)a9;
