@class NSString, AVMediaFileType, NSDictionary, AVWeakReference, NSObject, NSOperationQueue;
...
- (void)_figAssetWriterFinalHDRMetadataGenerationStateAvailable:(int)a0 finalHDRMetadataGenerationState:(id)a1;
...
- (BOOL)addTaggedPixelBufferGroup:(struct OpaqueCMTaggedBufferGroup { } *)a0 atPresentationTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 error:(id *)a2;
