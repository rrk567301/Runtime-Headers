@class NSData, NSDate, HMFConnectivityInfo, NSPredicate, NSSet, NSArray, NSString, NSUUID, Protocol, MKFHAPAccessoryDatabaseID, NSNumber, _MKFHomeNetworkRouterSetting;
...
- (void)removeLocalPresenceRoomsObject:(id)a0;
- (void)addAdaptiveTemperatureSleepScheduleRulesObject:(id)a0;
- (void)addLocalPresenceRoomsObject:(id)a0;
...
- (id)findAdaptiveTemperatureSleepScheduleRulesRelationWithModelID:(id)a0;
- (id)findLocalPresenceRoomsRelationWithModelID:(id)a0;
- (id)findMatterPathsRelationWithModelID:(id)a0;
- (id)findServicesRelationWithInstanceID:(id)a0;
- (BOOL)hasRGCapableService;
- (id)materializeOrCreateAdaptiveTemperatureSleepScheduleRulesRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
- (id)materializeOrCreateLocalPresenceRoomsRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
...
- (void)removeAdaptiveTemperatureSleepScheduleRulesObject:(id)a0;
