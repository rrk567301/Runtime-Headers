...
+ (id)matterIssuerKeyDataForCurrentUserWithFlow:(id)a0;
+ (id)matterIssuerKeyDataWithPublicKey:(id)a0 flow:(id)a1;
...
- (id)_addIssuerKeyForUserIndex:(id)a0 toMatterAccessory:(id)a1 isUnifiedAccess:(BOOL)a2 issuerKeyData:(id)a3 withFlow:(id)a4;
- (id)_addOrUpdateIssuerKey:(id)a0 forUser:(id)a1 toMatterAccessory:(id)a2 unifiedAccess:(BOOL)a3 flow:(id)a4;
...
- (id)addOrUpdateIssuerKey:(id)a0 forUser:(id)a1 toMatterAccessory:(id)a2 withControllerType:(id)a3 unifiedAccess:(BOOL)a4 flow:(id)a5;
- (id)addOrUpdateIssuerKeyForUser:(id)a0 toMatterAccessory:(id)a1 flow:(id)a2;
