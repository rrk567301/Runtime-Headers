...
- (void)_handleStagedPairingCommissioneeInfo:(id)a0 forRequest:(id)a1;
- (void)_handleStagedPairingDeviceCredential:(id)a0 completionHandler:(id /* block */)a1 forRequest:(id)a2 activity:(id)a3;
- (void)_handleStagedPairingProgressState:(long long)a0 forRequest:(id)a1;
- (void)_handleStagedPairingReadyToCancel:(id /* block */)a0 forRequest:(id)a1;
...
- (void)handleCancelStagingMessage:(id)a0;
...
- (void)stopMetricsForThirdPartyPairingWithError:(id)a0;
