...
@property (copy, getter=isHomeSleeping) NSNumber *homeSleeping;
...
- (BOOL)_setAnyUserAtHomeFromHomeActivityStateWithHome:(id)a0;
- (BOOL)_setAnyUserAtHomeFromPresenceMonitorWithHome:(id)a0;
...
- (id)initWithHAPAccessory:(id)a0 home:(id)a1 workQueue:(id)a2;
