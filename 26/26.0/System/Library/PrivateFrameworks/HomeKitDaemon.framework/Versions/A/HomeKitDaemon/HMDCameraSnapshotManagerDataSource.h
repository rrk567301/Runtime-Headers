...
- (id)createSnapshotLocalWithSessionID:(id)a0 workQueue:(id)a1 accessory:(id)a2 delegate:(id)a3 snapshotRequestHandler:(id)a4;
- (id)createSnapshotRemoteRelayReceiverWithSessionID:(id)a0 workQueue:(id)a1 accessory:(id)a2 delegate:(id)a3 uniqueIdentifier:(id)a4 snapshotRequestHandler:(id)a5 residentMessageHandler:(id)a6 remoteDevice:(id)a7;
