...
- (id)initWithIDSIdentifier:(id)a0 idsDestination:(id)a1 version:(id)a2 generationID:(id)a3 assertionTime:(id)a4 preferredResidentsList:(id)a5 selectionInfo:(id)a6 connectionType:(unsigned long long)a7 locationRawValue:(id)a8 hasReachableAccessories:(BOOL)a9;
