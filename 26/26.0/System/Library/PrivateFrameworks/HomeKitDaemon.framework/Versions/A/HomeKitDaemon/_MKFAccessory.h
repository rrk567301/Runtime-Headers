...
- (id)castIfAccessory;
- (id)materializeOrCreateAllowedGuestsRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
...
- (id)materializeOrCreateOutgoingInvitationsRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
