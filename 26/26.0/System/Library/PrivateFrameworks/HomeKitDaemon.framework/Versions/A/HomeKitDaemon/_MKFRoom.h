...
@protocol MKFHome, MKFApplicationData, MKFRoomPresence;
...
- (id)materializeOrCreateLocalPresenceRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
- (id)castIfRoom;
- (id)findLocalPresenceRelationWithModelID:(id)a0;
