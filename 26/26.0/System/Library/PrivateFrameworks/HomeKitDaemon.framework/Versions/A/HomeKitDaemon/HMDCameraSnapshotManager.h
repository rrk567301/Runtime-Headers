...
- (void)snapshotRelaySender:(id)a0 didStartImageCaptureForSessionID:(id)a1;
- (void)snapshotRelayStream:(id)a0 didCompleteSendImage:(id)a1 sessionID:(id)a2;
- (void)snapshotRelayStream:(id)a0 didStartImageCaptureForSessionID:(id)a1;
- (void)snapshotStreamReceiver:(id)a0 didSaveSnapshotFile:(id)a1 error:(id)a2 sessionID:(id)a3;
- (void)snapshotStreamReceiver:(id)a0 didStartImageCaptureForSessionID:(id)a1;
