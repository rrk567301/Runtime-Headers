@class IDSQRProtoAllocBindTestOption, NSString, IDSQRProtoCallModeUpdateInfo, NSData, IDSQRProtoMaterial, NSMutableArray;
...
@property (readonly, nonatomic) BOOL hasCallModeInfo;
...
- (void)addFastPluginRequests:(id)a0;
...
- (id)fastPluginRequestsAtIndex:(unsigned long long)a0;
