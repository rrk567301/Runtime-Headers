...
@interface IDSQRProtoAllocBindResponse : PBCodable <NSCopying> {
    ...
    struct { unsigned char channelSettings : 1; unsigned char generationCounter : 1; unsigned char linkId : 1; unsigned char participantType : 1; unsigned char sessionStateCounter : 1; unsigned char isNewlyJoined : 1; } _has;
}
...
@property (nonatomic) BOOL hasIsNewlyJoined;
