@class NSString, SCStream, VCCannedVideoCaptureSource, NSObject, SCContentFilter;
...
@interface VCMacScreenCaptureScreenCaptureKit : VCObject <SCStreamDelegate, SCStreamOutput, VCMacScreenCaptureSource> {
    ...
    BOOL _alwaysHDCaptureEnabled;
    struct _VCMacScreenCaptureSourceContext { void *sinkContext; void /* function */ *sinkCallback; VCCannedVideoCaptureSource *cannedScreenCaptureSource; } _frameCallback;
}
...
- (id)initWithDelegate:(id)a0 screenCaptureSourceContext:(const struct _VCMacScreenCaptureSourceContext { void *x0; void /* function */ *x1; id x2; } *)a1;
