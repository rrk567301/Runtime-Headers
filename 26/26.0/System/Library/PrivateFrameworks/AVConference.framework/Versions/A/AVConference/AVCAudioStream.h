...
- (id)initWithLocalAddress:(id)a0 networkSockets:(id)a1 IDSDestination:(id)a2 rtpConnectionClientID:(id)a3 rtcpConnectionClientID:(id)a4 localEndpoint:(id)a5 callID:(id)a6 options:(id)a7 error:(id *)a8;
...
- (BOOL)setUpAudioStreamInProcessWithClientArgs:(id)a0 xpcArguments:(id)a1 error:(id *)a2;
- (BOOL)setUpAudioStreamOutOfProcessWithClientArgs:(id)a0 xpcArguments:(id)a1 error:(id *)a2;
