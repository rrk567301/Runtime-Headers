@class NSMutableDictionary, VCMediaRecorder, VCAudioMachineLearningCoordinator, VCAudioIO, NSObject, VideoConferenceManager, NSDictionary, VCAudioPowerLevelMonitor, NSMutableArray, GKNATObserver, VCImageQueue, NSString, VCCallSession, VCVideoRule, CameraConferenceSynchronizer, VCAudioPowerSpectrumSource, NSArray;
