...
@interface VCRateControlAlgorithmBase : NSObject <VCRateControlAlgorithm> {
    ...
    BOOL _machineLearningInitialRampUpOnly;
    BOOL _isBitrateStableAfterInitialRampUp;
...
@property (readonly, nonatomic) BOOL isRampingDown;
...
@property (readonly, nonatomic) struct tagVCRateControlAlgorithmReinforcementLearningVariables { double value; unsigned int action; double actionLogProbability; } trainingVariables;
...
@property (nonatomic) struct tagVCRateControlMachineLearningNetworkEnvironment { unsigned int localRadioAccessTechnology; unsigned int remoteRadioAccessTechnology; unsigned int rateControlMode; } machineLearningEnvironment;
@property (readonly, nonatomic) double activeMLEngagedDuration;
@property (readonly, nonatomic) BOOL isMLEngaged;
