@class VCStreamOutput, NSArray, NSString, VCPixelBufferOverlay, CAContext, NSObject, CALayer;
...
@property (nonatomic, getter=isLayerHostMode) BOOL layerHostMode;
@property (nonatomic, getter=isLowLatencyEnabled) BOOL lowLatencyEnabled;
@property (nonatomic, getter=isTransformForRemoteVideoOrientationEnabled) BOOL transformForRemoteVideoOrientationEnabled;
...
- (id)initWithFrameRate:(unsigned char)a0 imageQueueProtected:(BOOL)a1 vcImageQueueConfig:(const struct tagVCImageQueueConfig { BOOL x0; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x1; BOOL x2; BOOL x3; int x4; } *)a2;
- (void)releaseAllocators;
- (void)releaseSlot;
- (void)setHostTimeTimebaseOnFigDataQueue:(struct OpaqueFigDataQueue { } *)a0;
- (void)setHostTimeTimebaseOnFigImageQueue:(struct OpaqueFigImageQueue { } *)a0;
- (BOOL)setUpImageQueueForFigVideoTargetWithTagCollection:(struct OpaqueCMTagCollection { } *)a0 withDataChannelConfig:(struct OpaqueFigDataChannelConfiguration { } *)a1;
- (unsigned int)setVideoDestination:(id)a0;
- (BOOL)setupDataQueueForFigVideoTargetWithTagCollection:(struct OpaqueCMTagCollection { } *)a0 withDataChannelConfig:(struct OpaqueFigDataChannelConfiguration { } *)a1;
- (BOOL)setupDefaultImageQueueForFigVideoTargetWithDataChannelConfig:(struct OpaqueFigDataChannelConfiguration { } *)a0;
- (BOOL)setupQueuesAndDataChannelConfigForFigVideoTarget;
- (BOOL)setupQueuesForFigVideoTargetUsingBufferDescriptionWithDataChannelConfig:(struct OpaqueFigDataChannelConfiguration { } *)a0;
