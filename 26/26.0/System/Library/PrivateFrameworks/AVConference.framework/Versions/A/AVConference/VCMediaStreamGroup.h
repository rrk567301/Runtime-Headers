@class AVCStatisticsCollector, NSArray, NSString, VCNetworkFeedbackController, NSDictionary, VCExperimentManager, NSObject, VCMediaRecorder, TimingCollection, VCMediaKeyIndex;
...
@property (nonatomic, getter=isEnabledAtStart) BOOL enabledAtStart;
...
- (void)mkiCollisionDetectedForMediaStream:(id)a0;
