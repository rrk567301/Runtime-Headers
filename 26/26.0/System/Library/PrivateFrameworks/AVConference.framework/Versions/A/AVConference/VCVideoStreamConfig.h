@class NSString, NSMutableDictionary, NSMutableOrderedSet, NSArray, NSObject;
...
@property (nonatomic) BOOL remoteSupportsFullScreenReceive;
...
@property (nonatomic) BOOL isFECFrameBasedEnabled;
...
- (BOOL)applyVideoStreamXPCDictionary:(id)a0;
...
- (id)newTagCollectionArrayFromDescriptionArray:(id)a0 count:(unsigned long long)a1;
