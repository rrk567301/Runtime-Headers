@class VideoAttributes, NSString, VCVideoSourceTokenManager, VCImageQueue, NSMutableDictionary, VCImageRotationConverter, NSObject, NSMutableArray, NSMutableSet;
...
@interface VCVideoCaptureServer : NSObject <VCPowerManagerThermalDelegate, VCVideoCaptureServer> {
    ...
    BOOL _remoteSupportsFullScreenReceive;
...
@property (nonatomic) struct tagVCAspectRatios { struct CGSize { double width; double height; } portrait; struct CGSize { double width; double height; } landscape; } remoteScreenAspectRatios;
@property (nonatomic) struct tagVCAspectRatios { struct CGSize { double width; double height; } portrait; struct CGSize { double width; double height; } landscape; } remoteExpectedAspectRatios;
@property (nonatomic) struct tagVCAspectRatios { struct CGSize { double width; double height; } portrait; struct CGSize { double width; double height; } landscape; } remoteExpectedFullScreenAspectRatios;
...
+ (BOOL)backCameraSupportsFullBleedCapture;
+ (BOOL)cameraSupportsFullBleedCaptureWithFormatList:(id)a0;
+ (BOOL)clientPID:(id)a0 matchesProcessName:(id)a1;
+ (BOOL)frontCameraSupportsFullBleedCapture;
...
- (void)addDeviceStateDelegate:(id)a0;
...
- (void)dispatchedUpdateRemoteScreenAttributes:(int)a0 forceUpdate:(BOOL)a1;
...
- (void)notifyDeviceStateDelegatesWithOrientation:(int)a0;
...
- (void)removeDeviceStateDelegate:(id)a0;
...
- (void)setCameraPerClientRequest:(id)a0;
