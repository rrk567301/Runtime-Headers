...
- (id)capabilitiesForStream:(id)a0 mediaProtocolArgs:(id)a1 xpcArguments:(id)a2 error:(id *)a3;
...
- (id)newMediaProtocolArgsWithMediaProtocolArgs:(id)a0 nwEndpoint:(id)a1;
