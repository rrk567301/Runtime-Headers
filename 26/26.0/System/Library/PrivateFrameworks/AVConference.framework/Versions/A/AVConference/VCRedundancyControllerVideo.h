...
- (void)dealloc;
- (id)initWithDelegate:(id)a0 mode:(int)a1 parameters:(struct VCRedundancyControllerVideoParameters_t { id x0; unsigned int x1; BOOL x2; unsigned char x3; BOOL x4; })a2;
