...
- (unsigned int)maxAllowedBitrateForVCConnection:(id)a0 forLocalInterface:(BOOL)a1 arbiterMode:(unsigned char)a2 encodeRule:(id)a3;
...
- (unsigned int)maxAllowedImmersiveVideoBitrateForConnectionType:(int)a0;
