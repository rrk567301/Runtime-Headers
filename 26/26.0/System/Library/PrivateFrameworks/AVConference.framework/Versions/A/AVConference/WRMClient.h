...
@interface WRMClient : NSObject {
    ...
    int _mode;
    struct { BOOL reportImmediateMetricsEnabled; BOOL reportRtpErasureMetricsEnabled; BOOL allowPreWarmCellEnabled; BOOL disableFastLQMReporting; } _metricsConfig;
    int _rssiThreshold;
}
...
- (void)startWRMClientWithMode:(int)a0 metricsConfig:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; })a1;
- (void)stopWRMClient;
