@class NSString, NSObject, VCCannedVideoCaptureSource;
...
- (id)initWithDelegate:(id)a0 screenCaptureSourceContext:(const struct _VCMacScreenCaptureSourceContext { void *x0; void /* function */ *x1; id x2; } *)a1 sourceConfig:(id)a2;
