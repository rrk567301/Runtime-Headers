...
- (BOOL)isEqual:(id)a0;
- (id)initWithStreamConfig:(const struct tagVCAudioCaptionsStreamConfig { long long x0; struct AudioStreamBasicDescription { double x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; } x1; } *)a0 bufferLength:(double)a1;
