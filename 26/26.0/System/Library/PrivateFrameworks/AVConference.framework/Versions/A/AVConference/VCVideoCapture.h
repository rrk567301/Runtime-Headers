@class VideoAttributes, NSString, VCCannedVideoCaptureSource, NSObject;
@protocol VCVideoCaptureServer;

@interface VCVideoCapture : NSObject {
    id _captureServer;
    struct tagVCVideoCaptureServerProtocolRealtimeInstanceVTable { void /* function */ *onCaptureVideoFrame; } _protocolFunctions;
    NSString *_sourceUID;
...
- (id)initWithCaptureServer:(id)a0 protocolFunctions:(const struct tagVCVideoCaptureServerProtocolRealtimeInstanceVTable { void /* function */ *x0; } *)a1;
