...
@interface VCVideoStreamSendGroup : VCMediaStreamSendGroup <VCMediaStreamDelegate, VCSessionUplinkVideoStreamControllerDelegate, VCRedundancyControllerDelegate, VCMediaCaptureController, VCVideoSink, VCVideoCaptureClient, VCMediaStreamSendSyncSourceDelegate> {
    ...
    struct tagVCMemoryPool { struct { void *x0; long long x1; } x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; BOOL x4; } *_videoRedundancyPool;
...
- (id)stopCapture;
- (id)startCapture;
- (void)setUpFrameBasedFEC:(unsigned int)a0 inParameter:(struct VCRedundancyControllerVideoParameters_t { id x0; unsigned int x1; BOOL x2; unsigned char x3; BOOL x4; } *)a1;
- (id)activeStreamKeys;
...
- (void)configureCaptureForFullScreen:(BOOL)a0;
...
- (void)vcMediaStream:(id)a0 didChangeRedundancyPercentage:(unsigned int)a1;
