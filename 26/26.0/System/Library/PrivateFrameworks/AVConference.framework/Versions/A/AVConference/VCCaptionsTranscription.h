...
- (id)initWithTextTranscription:(id)a0 taskInfo:(id)a1 isLocal:(BOOL)a2 isFinal:(BOOL)a3 isTranslated:(BOOL)a4;
- (id)initWithUtteranceNumber:(unsigned int)a0 updateNumber:(unsigned int)a1 isLocal:(BOOL)a2 isFinal:(BOOL)a3 streamToken:(long long)a4 isTranslated:(BOOL)a5;
