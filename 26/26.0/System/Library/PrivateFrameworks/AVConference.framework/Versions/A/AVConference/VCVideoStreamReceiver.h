...
- (void)dealloc;
- (id)initWithConfig:(struct tagVCVideoStreamReceiverConfig { struct tagHANDLE *x0; id x1; struct tagVCVideoReceiverDelegateRealtimeInstanceVTable { void /* function */ *x0; void /* function */ *x1; } x2; struct opaqueRTCReporting *x3; unsigned int x4; int x5; id x6; BOOL x7; void *x8; void /* function */ *x9; id x10; char x11[30]; } *)a0;
- (void)setJitterBufferMode:(int)a0;
- (int)processVideoRTP;
- (BOOL)canDequeue:(struct opaqueCMBufferQueue { } *)a0 forTimestamp:(unsigned int)a1;
- (int)createDecodeSession:(struct opaqueCMFormatDescription { } *)a0;
...
- (void)reportVideoStallStatus:(BOOL)a0;
- (void)reportingVideoStreamEvent:(unsigned short)a0;
- (void)rtcpSendIntervalElapsed;
- (int)scheduleDecodeForFrameWithBuffer:(struct VCVideoReceiverSampleBuffer_t { struct __CFAllocator *x0; struct tagVCVideoDecodingArgs { int x0; int x1; unsigned int x2; unsigned short x3; unsigned char x4; BOOL x5; unsigned short x6; BOOL x7; double x8; int x9; unsigned short x10; BOOL x11; BOOL x12; unsigned short x13; double x14; BOOL x15; int x16; double x17; BOOL x18; BOOL x19; BOOL x20; BOOL x21; unsigned long long x22; BOOL x23; unsigned int x24; int x25; } x1; struct OpaqueCMBlockBuffer *x2; unsigned long long x3; struct OpaqueCMBlockBuffer *x4; struct VCBlockBuffer_t { struct OpaqueCMBlockBuffer *x0; unsigned long long x1; char *x2; } x5; struct VCBlockBuffer_t { struct OpaqueCMBlockBuffer *x0; unsigned long long x1; char *x2; } x6; struct VCBlockBuffer_t { struct OpaqueCMBlockBuffer *x0; unsigned long long x1; char *x2; } x7; struct VCBlockBuffer_t { struct OpaqueCMBlockBuffer *x0; unsigned long long x1; char *x2; } x8; int x9; struct { struct VCVideoReceiverSampleBuffer_t *x0; } x10; } *)a0 timestamp:(unsigned int)a1 hostTime:(double)a2 showFrame:(BOOL)a3;
