...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })edgeInsetsFromObject:(id)a0;
...
+ (struct OFNSOffset { double x0; double x1; })offsetFromObject:(id)a0;
...
+ (struct SCNVector3 { double x0; double x1; double x2; })vector3FromObject:(id)a0;
+ (struct SCNVector4 { double x0; double x1; double x2; double x3; })vector4FromObject:(id)a0;
