...
@interface ABPK2DDetection : NSObject {
    ...
    NSString *_netPath;
    struct vector<__CVBuffer *, std::allocator<__CVBuffer *>> { struct __CVBuffer **__begin_; struct __CVBuffer **__end_; struct __CVBuffer **__cap_; } _outputBuffers;
    struct vector<espresso_buffer_t, std::allocator<espresso_buffer_t>> { struct *__begin_; struct *__end_; struct *__cap_; } _espressoOutputTensors;
    struct vector<__CVPixelBufferPool *, std::allocator<__CVPixelBufferPool *>> { struct __CVPixelBufferPool **__begin_; struct __CVPixelBufferPool **__end_; struct __CVPixelBufferPool **__cap_; } _espressoOutputBufferPools;
