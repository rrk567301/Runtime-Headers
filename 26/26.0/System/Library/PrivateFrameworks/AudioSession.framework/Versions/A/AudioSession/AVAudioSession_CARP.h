@interface AVAudioSession_CARP : AVAudioSession {
    struct synchronized<std::shared_ptr<avas::client::Session>, caulk::shared_ptr_mutex<avas::client::KVOMutex>, avas::client::unguarded_accessor<std::shared_ptr<avas::client::Session>>> { struct shared_ptr_mutex<avas::client::KVOMutex> { struct shared_ptr<avas::client::KVOMutex> { struct KVOMutex *__ptr_; struct __shared_weak_count *__cntrl_; } mMutex; } mMutex; struct shared_ptr<avas::client::Session> { struct Session *__ptr_; struct __shared_weak_count *__cntrl_; } mObject; } _guarded_impl;
}
...
- (id)conformedPoliciesOfSession:(unsigned int)a0;
- (id)connectedOutputs;
...
- (BOOL)setConformsToSessionBehavior:(id)a0 error:(id *)a1;
