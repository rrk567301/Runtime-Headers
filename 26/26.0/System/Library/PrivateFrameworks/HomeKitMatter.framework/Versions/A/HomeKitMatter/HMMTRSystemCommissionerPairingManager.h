...
- (id)_retrievePreferredThreadCredentialsWithOptions:(unsigned long long)a0;
- (void)_updateThreadCredentialManagementEnabled:(BOOL)a0 forSystemCommissionerPairingUUID:(id)a1 completionHandler:(id /* block */)a2;
