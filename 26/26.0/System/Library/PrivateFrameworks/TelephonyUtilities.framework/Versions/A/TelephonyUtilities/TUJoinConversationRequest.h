@class TUConversationActivity, NSURL, TUConversationMemberAssociation, TUCallTranslationRequestConfiguration, NSDictionary, TUScreenSharingRequestMetadata, TUConversationParticipantAssociation, TUConversationParticipantCluster, NSString, NSSet, TUConversationLink, TUConversationProvider, TUHandle, NSUUID;
...
+ (BOOL)screeningTypeFromURLComponents:(id)a0;
...
+ (BOOL)isNearbySharePlayFromURLComponents:(id)a0;
+ (BOOL)isUpgradeToVideoFromURLComponents:(id)a0;
+ (BOOL)joiningConversationWithLinkFromURLComponents:(id)a0;
+ (BOOL)launchInBackgroundFromURLComponents:(id)a0;
...
+ (BOOL)requestToShareMyScreenFromURLComponents:(id)a0;
+ (BOOL)requestToShareScreenFromURLComponents:(id)a0;
...
+ (BOOL)shouldBypassInterventionFromURLComponents:(id)a0;
+ (BOOL)shouldSendLegacyScreenSharingInviteFromURLComponents:(id)a0;
...
- (id)initWithRemoteMembers:(id)a0 originatingUIType:(int)a1;
