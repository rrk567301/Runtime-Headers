...
@property (class, readonly, nonatomic) NSArray *callNotificationEligibleDevices;
@property (class, readonly, nonatomic) BOOL devicesAvailableForCallNotifications;
@property (class, nonatomic, getter=isRelayCallingEnabled) BOOL relayCallingEnabled;
@property (class, readonly, nonatomic, getter=areCallsOnOtherDevicesEnabled) BOOL callsOnOtherDevicesEnabled;
...
+ (BOOL)isSimultaneousVoiceAndDataSupportedForSIMWithUUID:(id)a0;
