@class UXView, NSArray, UXTabBarController, UXSourceController, UXWindowController, UXNavigationItem, UXTabBarItem, UXNavigationController, NSViewController, NSString, NSResponder;
@protocol UXViewControllerTransitionCoordinator, UXLayoutSupport, UXNavigationDestination;
...
@property (readonly, nonatomic) BOOL hidesInspectorWhenPushed;
...
@property (retain, nonatomic) UXView *observedView;
...
@property (readonly, nonatomic) UXNavigationItem *navigationItemIfLoaded;
...
- (void)setInspectorViewController:(id)a0;
