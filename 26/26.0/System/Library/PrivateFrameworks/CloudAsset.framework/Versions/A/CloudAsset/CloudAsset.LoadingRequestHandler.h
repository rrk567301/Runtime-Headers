@interface CloudAsset.LoadingRequestHandler : NSObject <AVAssetResourceLoaderDelegate> {
    void /* unknown type, empty encoding */ assetStreamHandle;
    void /* unknown type, empty encoding */ type;
    void /* unknown type, empty encoding */ protectedTaskMapping;
    void /* unknown type, empty encoding */ protectedActivity;
}
