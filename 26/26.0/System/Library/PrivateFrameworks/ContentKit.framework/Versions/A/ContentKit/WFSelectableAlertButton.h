...
+ (id)buttonWithTitle:(id)a0 subtitle:(id)a1 selected:(BOOL)a2 stickySelection:(BOOL)a3 style:(long long)a4 contextAwareHandler:(id /* block */)a5 image:(id)a6;
...
+ (id)buttonWithTitle:(id)a0 subtitle:(id)a1 selected:(BOOL)a2 style:(long long)a3 contextAwareHandler:(id /* block */)a4;
