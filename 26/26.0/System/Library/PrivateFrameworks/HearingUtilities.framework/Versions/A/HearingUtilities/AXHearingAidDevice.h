@class NSDate, NSString, NSArray, AXDispatchTimer, NSMutableDictionary, AXHearingAidMode, NSMutableArray, CBPeripheral, NSNumber;
...
- (id)programs;
- (unsigned long long)propertyForCharacteristic:(id)a0;
...
- (void)swapPeripheral:(id)a0 toEar:(int)a1;
