...
- (BOOL)_shouldPropagateToGlobalStore:(id)a0;
...
- (id)_writeFactorPackToLegacyPath:(id)a0 forFactorNames:(id)a1 aliasToUnaliasMap:(id)a2 assetStore:(id)a3 tempDirRef:(id)a4;
