...
- (BOOL)performRequests:(id)a0 onCGImage:(struct CGImage { } *)a1 withOrientation:(unsigned int)a2 andIdentifier:(id)a3 error:(id *)a4;
...
- (BOOL)registerUserSafetyPolicyUpdateHandler:(id /* block */)a0 error:(id *)a1;
...
- (int)performRequests:(id)a0 onAssetWithIdentifier:(id)a1 identifierType:(unsigned long long)a2 fromPhotoLibraryWithURL:(id)a3 timeoutInterval:(double)a4 completionHandler:(id /* block */)a5;
- (int)performRequests:(id)a0 onAssetWithLocalIdentifier:(id)a1 fromPhotoLibraryWithURL:(id)a2 timeoutInterval:(double)a3 completionHandler:(id /* block */)a4;
