...
- (void).cxx_destruct;
- (id)initWithPersonIdentifier:(id)a0 personName:(id)a1 mdID:(id)a2 detectionType:(short)a3 verified:(BOOL)a4 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 andConfidence:(float)a6;
