@class NSObject, BKUIFingerSecurePairingStateObserver, NSString, BKUIMagicKeyBoardClientAdapterController, BKUISystemPrefsPairingView, BKMesaSecureIntentProvider, BKUIDevice, NSWindow, BKUILockScreenAssertionHandler;
