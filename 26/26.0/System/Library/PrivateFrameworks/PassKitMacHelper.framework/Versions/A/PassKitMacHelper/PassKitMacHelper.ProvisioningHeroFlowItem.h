@interface PassKitMacHelper.ProvisioningHeroFlowItem : NSObject {
    ...
    void /* unknown type, empty encoding */ _hasSelectedMethod;
    void /* unknown type, empty encoding */ selectedMethod;
