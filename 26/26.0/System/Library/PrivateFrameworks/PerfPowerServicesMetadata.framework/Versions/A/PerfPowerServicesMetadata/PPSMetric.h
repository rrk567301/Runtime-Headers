...
+ (BOOL)isValidAppIdentifier:(id)a0;
+ (BOOL)isValidAuxiliaryType:(id)a0;
+ (BOOL)isValidBuild:(id)a0;
+ (BOOL)isValidCategory:(id)a0;
+ (BOOL)isValidDMACompliant:(id)a0;
...
+ (BOOL)isValidFilterEntryLogging:(id)a0;
+ (BOOL)isValidFixedArraySize:(id)a0;
