...
@property (readonly) BOOL useGlassDesign;
...
- (id)initWithConfiguration:(id)a0 hasLeadingEdgeAlignedCancelButton:(BOOL)a1 useGlassDesign:(BOOL)a2 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
