@class NSString, DCBiometricStoreClient;

@interface DCBiometricStore : NSObject <DCBioBindingProtocol>

@property (readonly, nonatomic) DCBiometricStoreClient *client;
...
- (void)deleteGlobalAuthACLWithOutcomeCompletion:(id /* block */)a0;
...
- (void)globalAuthACLTemplateUUIDsAndCredentialCountWithCompletion:(id /* block */)a0;
