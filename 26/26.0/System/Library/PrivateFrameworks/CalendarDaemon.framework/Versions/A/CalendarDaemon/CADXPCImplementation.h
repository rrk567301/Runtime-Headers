...
- (void)CADDatabaseMonitorResultsForPredicate:(id)a0 propertyFilter:(unsigned long long)a1 options:(unsigned long long)a2 identifier:(int)a3 reply:(id /* block */)a4;
