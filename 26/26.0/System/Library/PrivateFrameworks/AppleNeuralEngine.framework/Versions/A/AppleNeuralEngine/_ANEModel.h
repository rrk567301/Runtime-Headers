...
+ (id)modelAtURL:(id)a0 key:(id)a1 mpsConstants:(id)a2;
...
+ (id)modelAtURLWithSourceURL:(id)a0 sourceURL:(id)a1 key:(id)a2 identifierSource:(long long)a3 cacheURLIdentifier:(id)a4 UUID:(id)a5;
+ (id)modelWithCacheURLIdentifier:(id)a0 UUID:(id)a1;
...
- (id)initWithModelAtURL:(id)a0 sourceURL:(id)a1 UUID:(id)a2 key:(id)a3 identifierSource:(long long)a4 cacheURLIdentifier:(id)a5 modelAttributes:(id)a6 standardizeURL:(BOOL)a7 string_id:(unsigned long long)a8 generateNewStringId:(BOOL)a9 mpsConstants:(id)a10;
