@class NSData, NSString, NSArray, SFCard, SFColor, SFUserReportRequest, NSDictionary, SFButtonItem, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;

@interface RFReferenceItemButtonCardSection : SFCardSection <RFReferenceItemButtonCardSection, NSSecureCoding, NSCopying>
