@class NSMutableDictionary, SFColor, SFActionItem, SFCard, NSDictionary, SFAppEntityAnnotation, NSString, SFCommand, SFRichText, SFMediaItem, NSData, NSArray, SFUserReportRequest, SFCopyItem;
