@class SFColor, NSString, NSData, NSArray, SFCard, SFUserReportRequest, NSDictionary, SFTableAlignmentSchema, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;
