@class SFColor, NSData, NSArray, SFPerson, NSString, SFCard, NSDictionary, SFUserReportRequest, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;

@interface SFFindMyCardSection : SFCardSection <SFFindMyCardSection, NSSecureCoding, NSCopying>
