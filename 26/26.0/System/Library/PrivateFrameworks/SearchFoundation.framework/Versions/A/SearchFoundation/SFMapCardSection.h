@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFLatLng, NSString, SFCommand, SFMapRegion, NSArray, NSData, SFUserReportRequest, SFCopyItem;

@interface SFMapCardSection : SFCardSection <SFMapCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char interactive : 1; unsigned char sizeFormat : 1; unsigned char pinBehavior : 1; } _has;
}
