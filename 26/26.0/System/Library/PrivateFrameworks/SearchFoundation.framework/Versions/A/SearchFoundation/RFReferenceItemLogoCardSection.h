@class SFColor, NSData, NSArray, NSString, SFCard, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, SFCopyItem, NSMutableDictionary, RFVisualProperty;

@interface RFReferenceItemLogoCardSection : SFCardSection <RFReferenceItemLogoCardSection, NSSecureCoding, NSCopying>
