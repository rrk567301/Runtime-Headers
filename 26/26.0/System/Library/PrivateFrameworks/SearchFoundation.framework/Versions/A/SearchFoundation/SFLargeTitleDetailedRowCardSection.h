@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFButtonItem, NSString, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, SFCopyItem;

@interface SFLargeTitleDetailedRowCardSection : SFCardSection <SFLargeTitleDetailedRowCardSection, NSSecureCoding, NSCopying>
