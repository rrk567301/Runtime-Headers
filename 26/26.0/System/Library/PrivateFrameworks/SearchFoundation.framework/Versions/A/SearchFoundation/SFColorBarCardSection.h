@class SFCard, SFColor, NSArray, NSData, NSString, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, SFCopyItem, SFRichText, NSMutableDictionary;
