@class SFColor, NSString, NSData, SFSportsTeam, NSArray, SFCard, NSDictionary, SFUserReportRequest, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;
