@class NSURL, SFCopyItem, SFColor, SFAppEntityAnnotation, NSDictionary, SFCard, NSMutableDictionary, NSString, SFImage, SFCommand, NSArray, NSData, SFText, SFUserReportRequest, NSNumber;
