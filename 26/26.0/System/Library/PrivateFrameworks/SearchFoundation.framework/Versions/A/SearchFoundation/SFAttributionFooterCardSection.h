@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFPunchout, NSString, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, SFCopyItem;
