@class NSData, NSString, RFSummaryItemStandardCardSection, NSArray, SFCard, SFColor, NSDictionary, SFUserReportRequest, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;
