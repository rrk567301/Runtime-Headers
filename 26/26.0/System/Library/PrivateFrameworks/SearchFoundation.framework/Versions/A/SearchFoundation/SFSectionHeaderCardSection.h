@class SFColor, NSString, NSData, NSArray, SFCard, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, SFCopyItem, SFRichText, NSMutableDictionary;
