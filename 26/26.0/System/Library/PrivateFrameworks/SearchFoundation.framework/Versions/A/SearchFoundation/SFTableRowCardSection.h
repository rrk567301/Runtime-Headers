@class SFColor, NSString, NSArray, NSData, SFCard, SFUserReportRequest, SFTableAlignmentSchema, NSDictionary, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;

@interface SFTableRowCardSection : SFCardSection <SFTableRowCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char isSubHeader : 1; unsigned char reducedRowHeight : 1; unsigned char verticalAlign : 1; unsigned char alignRowsToHeader : 1; } _has;
}
