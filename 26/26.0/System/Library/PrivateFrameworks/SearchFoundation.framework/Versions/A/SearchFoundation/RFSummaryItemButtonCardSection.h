@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFButtonItem, RFVisualProperty, NSString, RFTextProperty, SFCommand, NSArray, NSData, SFUserReportRequest, SFCopyItem;
