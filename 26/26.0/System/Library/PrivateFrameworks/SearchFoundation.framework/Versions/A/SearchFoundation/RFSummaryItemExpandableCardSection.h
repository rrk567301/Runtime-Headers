@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, RFSummaryItemAttribution, RFVisualProperty, NSString, RFTextProperty, SFCommand, NSArray, NSData, SFUserReportRequest, SFCopyItem;
...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (BOOL)hasAttribution_ignores_expansion;
