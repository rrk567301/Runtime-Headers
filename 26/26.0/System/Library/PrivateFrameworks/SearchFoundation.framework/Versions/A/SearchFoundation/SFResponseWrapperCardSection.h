@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFPatternModel, NSString, SFCommand, NSArray, NSData, SFCATModel, SFUserReportRequest, SFCopyItem;
