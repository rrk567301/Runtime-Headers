@class NSString, NSConditionLock, NSOperationQueue, NSMutableDictionary, EFCancelationToken, NSObject, NSMutableArray, EMFocus, NSMutableSet;
...
@property (retain, nonatomic) EFCancelationToken *focusObservationToken;
