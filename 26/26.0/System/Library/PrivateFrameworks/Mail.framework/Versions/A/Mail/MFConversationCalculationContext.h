...
- (unsigned long long)_messagesWithSubject:(long long)a0 participant:(long long)a1 participantsByRowID:(id)a2 conversationIDByRowID:(id)a3 dateReceivedByRowID:(id)a4;
