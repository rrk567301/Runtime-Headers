...
+ (id)buildWithIdentifier:(id)a0 removed:(id)a1 declarationIdentifier:(id)a2 visibleName:(id)a3 hostname:(id)a4 port:(id)a5 username:(id)a6 isMailEnabled:(id)a7 areCalendarsEnabled:(id)a8 areContactsEnabled:(id)a9 areNotesEnabled:(id)a10 areRemindersEnabled:(id)a11;
+ (id)statusItemType;
+ (id)supportedOS;
