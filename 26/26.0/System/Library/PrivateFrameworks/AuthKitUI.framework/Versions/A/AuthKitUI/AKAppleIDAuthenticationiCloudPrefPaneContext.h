...
- (void)_presentInlineRemoteUIWithConfiguration:(id)a0 completion:(id /* block */)a1;
- (void)_presentInlineServerUIWithConfiguration:(id)a0 completion:(id /* block */)a1;
- (void)_presentInlineWebViewWithConfiguration:(id)a0 completion:(id /* block */)a1;
