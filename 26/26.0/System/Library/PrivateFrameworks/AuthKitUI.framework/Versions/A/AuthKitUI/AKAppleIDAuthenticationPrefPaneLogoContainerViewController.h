@class NSImageView, AKAuthWebTabView, NSView, NSString, AKAppleIDAuthenticationiCloudPrefPaneContext;
...
- (void).cxx_destruct;
- (void)_presentRemoteUIWithConfiguration:(id)a0 completion:(id /* block */)a1;
- (void)_presentWebviewWithConfiguration:(id)a0 parentWindow:(id)a1 completion:(id /* block */)a2;
