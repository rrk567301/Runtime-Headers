@class NSView, NSString, NSArray, LACUIAuthenticationLabel, NSStackView, NSColor, NSImageView, NSButton, NSMapTable;

@interface LACUIAuthenticationAlert : NSViewController <LACUIAuthenticationAlert> {
