...
@interface EMFEmojiPreferences : NSObject <EMFEmojiPreferenceActions> {
    ...
    struct unique_ptr<CEM::AdaptationDatabaseController, std::default_delete<CEM::AdaptationDatabaseController>> { struct AdaptationDatabaseController *__ptr_; } _adaptationController;
}
