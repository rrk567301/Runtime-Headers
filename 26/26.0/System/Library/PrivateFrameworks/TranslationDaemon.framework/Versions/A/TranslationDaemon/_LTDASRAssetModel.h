@class NSString, SFEntitledAssetConfig, NSURL, NSArray, _LTAssetProgress;

@interface _LTDASRAssetModel : NSObject <_LTDAssetModelProtocol> {
    NSString *_assetName;
...
@property (readonly, nonatomic) SFEntitledAssetConfig *provider;
...
- (id)initWithAssetIdentifier:(id)a0 provider:(id)a1;
