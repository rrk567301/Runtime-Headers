...
@interface _LTSpeechRecognizer : NSObject <_EARSpeechRecognitionResultStream> {
    ...
    BOOL _enableStreamingSpeechTranslation;
...
- (id)initWithModelURL:(id)a0 language:(id)a1 modelVersion:(id)a2 taskHint:(long long)a3;
- (void)startRecognitionWithAutoStop:(BOOL)a0 enableStreamingSpeechTranslation:(BOOL)a1 resultHandler:(id /* block */)a2;
