@class NSURL, NSMutableDictionary, _LTDSELFLoggingManager, EMTStablePrefixState, _LTTextToSpeechCache, NSObject, _LTSpeechTranslationAssetInfo, NSLocale, _LTMultilingualSpeechRecognizer, NSMutableArray, _LTLanguageDetectionResult, NSString, _LTLocalePair, NSArray, _LTOfflineSpeechSynthesizer, EMTTranslator, NSError;
...
+ (BOOL)_needToWaitForBothFinalTranslationResultsWithContext:(id)a0 lidResult:(id)a1;
...
- (id)_concatenatedAlignmentsFromSentences:(id)a0;
- (id)_getBestRecognitionResult:(id)a0 context:(id)a1;
- (id)_handleTranslationResults:(id)a0 withContext:(id)a1 sourceString:(id)a2 sourceSpans:(id)a3 stabilizer:(id)a4;
- (void)_loadEtiquetteSanitizersForTaskHint:(long long)a0;
- (void)_loadRecognizersWithContext:(id)a0;
- (void)_loadTranslatorForTask:(id)a0;
- (id)_paragraphResultFromSentences:(id)a0;
- (void)_performCancelRecognition:(BOOL)a0;
...
- (void)_translateString:(id)a0 isFinal:(BOOL)a1 withContext:(id)a2 toLocale:(id)a3 withSpans:(id)a4 stabilizer:(id)a5 completion:(id /* block */)a6;
- (void)_waitForLIDWithContext:(id)a0 completion:(id /* block */)a1;
- (void)cancelRecognition:(BOOL)a0;
- (void)cancelSpeechTranslation:(BOOL)a0;
- (id)initWithLocalePair:(id)a0 taskHint:(long long)a1 assetInfo:(id)a2 selfLoggingManager:(id)a3;
