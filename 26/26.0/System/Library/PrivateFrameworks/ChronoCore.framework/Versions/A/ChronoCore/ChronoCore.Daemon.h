@interface ChronoCore.Daemon : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ widgetRendererServer;
    ...
    void /* unknown type, empty encoding */ activityReplicationService;
    void /* unknown type, empty encoding */ activityRendererServer;
    ...
    void /* unknown type, empty encoding */ widgetPushManager;
