...
@property BOOL enableUnpaddedIDCapture;
...
@property BOOL enableManualIDCapture;
...
+ (unsigned long long)capturedCardHeightForTargetWidth:(unsigned long long)a0;
...
+ (id)extractCardImage:(id)a0 fromPixelBuffer:(struct __CVBuffer { } *)a1 withCardBuffer:(struct __CVBuffer { } *)a2 withPoints:(id)a3 cameraIntrinsicData:(id)a4 padding:(float)a5 inputOrientation:(int)a6 unpaddedCardImage:(id *)a7;
...
+ (void)loadFonts;
+ (id)perspectiveCorrectedImage:(id)a0 p1:(struct CGPoint { double x0; double x1; })a1 p2:(struct CGPoint { double x0; double x1; })a2 p3:(struct CGPoint { double x0; double x1; })a3 p4:(struct CGPoint { double x0; double x1; })a4;
+ (id)platformImageFromCIImage:(id)a0;
+ (id)scaledImage:(id)a0 width:(double)a1 height:(double)a2;
...
- (id)getCorrectedIDImageFromAuxiliaryPoints:(id)a0 fromPixelBuffer:(struct __CVBuffer { } *)a1 orientation:(unsigned int)a2 unpaddedCardImage:(id *)a3;
