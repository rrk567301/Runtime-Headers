@class NSArray, NSString, NSMutableDictionary, NSObject, NSColor;
...
- (id)_arrayByPaddingArray:(id)a0 toMaximumNumberOfThumbnailsWithObject:(id)a1 targetCount:(unsigned long long)a2;
...
- (id)backgroundColorForRequest:(id)a0;
