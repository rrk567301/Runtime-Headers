...
- (void)_downloadFirstValidImageWithURLs:(id)a0 inURLSession:(id)a1 failedURLDownloadsToErrorsDictionary:(id)a2 options:(unsigned long long)a3 completionHandler:(id /* block */)a4;
