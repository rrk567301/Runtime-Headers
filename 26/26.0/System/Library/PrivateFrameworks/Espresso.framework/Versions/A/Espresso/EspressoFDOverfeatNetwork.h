...
@interface EspressoFDOverfeatNetwork : NSObject {
    struct vector<std::shared_ptr<Espresso::net>, std::allocator<std::shared_ptr<Espresso::net>>> { void *__begin_; void *__end_; void *__cap_; } gpu_nets;
    struct vector<std::shared_ptr<Espresso::net>, std::allocator<std::shared_ptr<Espresso::net>>> { void *__begin_; void *__end_; void *__cap_; } ecpu_nets;
    struct vector<std::pair<unsigned long long, unsigned long long>, std::allocator<std::pair<unsigned long long, unsigned long long>>> { void *__begin_; void *__end_; void *__cap_; } net_scales;
    struct vector<std::pair<unsigned long long, unsigned long long>, std::allocator<std::pair<unsigned long long, unsigned long long>>> { void *__begin_; void *__end_; void *__cap_; } full_scales;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } scalesc;
    struct vector<std::shared_ptr<Espresso::fast_pyramid_resizer>, std::allocator<std::shared_ptr<Espresso::fast_pyramid_resizer>>> { void *__begin_; void *__end_; void *__cap_; } resizers_for_batching;
    int n_resizers_for_batching;
    struct vector<std::shared_ptr<Espresso::blob<float, 3>>, std::allocator<std::shared_ptr<Espresso::blob<float, 3>>>> { void *__begin_; void *__end_; void *__cap_; } probBlobs;
    struct vector<std::shared_ptr<Espresso::blob<float, 3>>, std::allocator<std::shared_ptr<Espresso::blob<float, 3>>>> { void *__begin_; void *__end_; void *__cap_; } boxBlobs;
    ...
    struct net_strides_configuration { int num_layer; struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } kernel_size; struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } stride; struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } pad; } strideConf;
    int retile_stride;
    int retile_tile_sz;
    struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } retile_n_outputs_v;
    int tile_w_1;
    int tile_h_1;
...
- (struct net_strides_configuration { int x0; struct vector<int, std::allocator<int>> { int *x0; int *x1; int *x2; } x1; struct vector<int, std::allocator<int>> { int *x0; int *x1; int *x2; } x2; struct vector<int, std::allocator<int>> { int *x0; int *x1; int *x2; } x3; })strideConfiguration;
