...
@interface EspressoDataFrameExecutor : NSObject {
    struct vector<void *, std::allocator<void *>> { void **__begin_; void **__end_; void **__cap_; } pointers_to_free;
    struct vector<__CVBuffer *, std::allocator<__CVBuffer *>> { struct __CVBuffer **__begin_; struct __CVBuffer **__end_; struct __CVBuffer **__cap_; } pixelbuffers_to_release;
}
