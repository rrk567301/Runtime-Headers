...
+ (id)generateGroupsForCalendars:(id)a0 eventStore:(id)a1 entityType:(unsigned long long)a2 forMode:(long long)a3 usingBackgroundColor:(id)a4 includingAccountsWithoutCalendars:(BOOL)a5 filterByFocus:(BOOL)a6 usingUnselectedCalendars:(id)a7 foundRefreshableCalendar:(BOOL *)a8 anyGroupsHiddenByFocus:(BOOL *)a9 numberOfCalendarsHiddenByFocus:(long long *)a10;
