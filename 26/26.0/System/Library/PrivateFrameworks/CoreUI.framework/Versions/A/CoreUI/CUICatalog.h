...
@interface CUICatalog : NSObject {
    ...
    unsigned char _skipLocalCaches : 1;
...
- (id)_appearancefallback_colorWithName:(id)a0 displayGamut:(long long)a1 deviceIdiom:(long long)a2 appearanceName:(id)a3;
- (id)_appearancefallback_gradientWithName:(id)a0 displayGamut:(long long)a1 deviceIdiom:(long long)a2 appearanceName:(id)a3;
- (id)_baseAtlasContentsKeyForName:(id)a0;
- (id)_baseAtlasKeyForName:(id)a0;
- (id)_baseColorKeyForName:(id)a0;
- (id)_baseGradientKeyForName:(id)a0;
- (id)_baseLayeredIconKeyForName:(id)a0;
...
- (id)_defaultBaseLayeredIconKeyForName:(id)a0;
...
- (id)copiedVectorGlyphsWithNames:(id)a0 outputFile:(id)a1;
- (BOOL)copyVectorGlyphsWithNames:(id)a0 toFile:(id)a1;
- (id)dataForVectorGlyphsWithNames:(id)a0;
...
- (id)gradientWithName:(id)a0 displayGamut:(long long)a1 deviceIdiom:(long long)a2 appearanceName:(id)a3;
...
- (id)iconLayerStackWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(unsigned long long)a4 appearanceName:(id)a5 locale:(id)a6;
