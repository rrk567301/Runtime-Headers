@class NSString, NSArray, CUIVectorGlyphLayerDrawAttachmentStore, CUIVectorGlyphPath;
...
@property (readonly, nonatomic) BOOL supportsVariableDraw;
...
@property (readonly, nonatomic) BOOL participatesInVariableDraw;
...
@property (readonly, nonatomic) BOOL gradientAlignsToLayer;
...
- (struct CGPath { } *)_visibleCompoundShape:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; } *)a0;
- (BOOL)anyLayerNeedsWideGamutColor;
- (struct CGPath { } *)copyClipShape;
- (struct CGPath { } *)copyClipShapeWithStartProgress:(double)a0 endProgress:(double)a1;
