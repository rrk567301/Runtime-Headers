...
+ (struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })adjustScissorRectToImageBlocks:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })a0 imageBlockSize:(unsigned long long)a1;
...
- (id)initWithTextureSize:(id)a0 scissorRect:(SEL)a1 outRect:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })a2 imageblockSize:(unsigned long long)a3;
