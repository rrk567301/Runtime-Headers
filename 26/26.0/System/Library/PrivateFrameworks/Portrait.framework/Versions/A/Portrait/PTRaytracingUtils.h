...
+ (struct PTFocus { float x0; float x1; float x2; float x3; float x4; float x5; })createFocusObject:(SEL)a0 anamorphicFactor:(id)a1 radialObstructionFactor:(float)a2 colorSize:(float)a3 circleOfConfusionReference:(float)a4 fNumberLimitWeight:(float)a5;
...
- (void)disparityApplyPostModifier:(id)a0 inDisparity:(id)a1 outDisparity:(id)a2 postModifier:(struct PTPostModifier { float x0; float x1; float x2; })a3;
- (void)disparityMinMaxApplyPostModifier:(id)a0 disparityMinMaxBuffer:(id)a1 postModifier:(struct PTPostModifier { float x0; float x1; float x2; })a2;
- (void)disparityPortraitPreviewDeadzone:(id)a0 inDisparity:(id)a1 outDisparity:(id)a2 postModifier:(struct PTPostModifier { float x0; float x1; float x2; })a3;
