...
- (void)estimateLightIntensityWithFaceRects:(void *)a0 inColor:(id)a1 numberOfFaceRects:(int)a2 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a3 humanDetections:(id)a4 asyncWork:(id)a5;
- (id)initWithMetalContext:(id)a0 msrColorPyramid:(id)a1 colorSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a2 prewarmOnly:(BOOL)a3 sharedResources:(id)a4;
