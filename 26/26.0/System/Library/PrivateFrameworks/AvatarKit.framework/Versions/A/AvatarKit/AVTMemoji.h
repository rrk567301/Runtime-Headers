@class AVTCompositor, AVTAssetResourceCache, AVTPreset, AVTColorPreset, AVTAvatarBodyPose, NSDictionary, AVTComponent, VFXMaterial, AVTComponentInstance, VFXNode, AVTMemojiWrapDeformerDriverInfo, AVTPresetStore;
...
- (void)_updateSkinAO;
- (void)_updateWithOptions:(unsigned long long)a0;
