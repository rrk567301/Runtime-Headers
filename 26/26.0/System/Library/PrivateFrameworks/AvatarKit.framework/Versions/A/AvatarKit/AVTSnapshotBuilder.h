@class AVTSnapshotHelper, AVTRenderer, AVTAvatar, VFXRenderer;
...
- (void)deprecated_avtui_applyModificationsForFramingMode:(SEL)a0 projectionDirectionModification:(id)a1 fieldOfViewModification:(long long)a2 lensShiftModification:(double)a3;
