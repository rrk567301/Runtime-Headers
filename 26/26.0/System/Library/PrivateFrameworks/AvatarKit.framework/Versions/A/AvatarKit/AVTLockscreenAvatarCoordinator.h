...
- (void).cxx_destruct;
- (id)timingAnimation;
- (void)_initWithStickerConfiguration:(id)a0 pose:(id)a1 framingMode:(id)a2 screenNumber:(id)a3 completionHandler:(id /* block */)a4 clientCompletionQueue:(id)a5 clientCompletionHandler:(id /* block */)a6;
- (id)debugAnimationIdentifier;
- (id)initWithAvatarDescriptor:(id)a0 stickerConfiguration:(id)a1 pose:(id)a2 framingMode:(id)a3 cropTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4 view:(id)a5 sharedHistory:(id)a6 clientCompletionQueue:(id)a7 clientCompletionHandler:(id /* block */)a8 queue:(id)a9 completionHandler:(id /* block */)a10;
