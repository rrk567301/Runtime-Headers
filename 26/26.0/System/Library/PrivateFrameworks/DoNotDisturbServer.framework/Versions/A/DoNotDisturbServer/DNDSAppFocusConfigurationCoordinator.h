...
- (void)_xpcCheckIn;
- (id)_effectiveBundleIDForBundleID:(id)a0;
...
- (void)_executeAction:(id)a0 orActionIdentifier:(id)a1 withBundleIdentifier:(id)a2 modeIdentifier:(id)a3 groupIdentifier:(id)a4 exiting:(BOOL)a5 metadata:(id)a6;
