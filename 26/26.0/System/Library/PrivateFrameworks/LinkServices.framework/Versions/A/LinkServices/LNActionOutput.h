...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 dialog:(id)a1 viewSnippet:(id)a2 snippetAction:(id)a3 attribution:(id)a4 value:(id)a5 showOutputAction:(id)a6 showOutputActionHint:(long long)a7 showOutputActionOptions:(unsigned long long)a8 deferred:(BOOL)a9 nextAction:(id)a10 suggestedFollowUpActions:(id)a11 activityIdentifier:(id)a12 confirmationActionName:(id)a13 showPrompt:(BOOL)a14 confirmationConditions:(long long)a15 undoContext:(id)a16;
