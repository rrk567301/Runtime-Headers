...
- (id)acceptedIdentifiersFromIdentifiers:(id)a0;
- (BOOL)isCuratedCNID:(id)a0;
- (BOOL)isUnknownCNID:(id)a0;
- (void)postDeleteContactNotificationForContactIdentifier:(id)a0;
- (void)postNotificationForCNContact:(id)a0 eventType:(unsigned long long)a1 handleIDsToProcess:(id)a2;
- (void)processAcceptedIntroductionForContact:(id)a0;
...
- (void)updateWithCurrentAcceptedContactsMap:(id)a0;
