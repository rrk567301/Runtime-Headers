...
- (id)initWithKeyList:(id)a0 manifestConfiguration:(id)a1 locale:(id)a2 cachedEtags:(id)a3 cachedData:(id)a4 priorities:(id)a5 signpostIDs:(id)a6 createTimes:(id)a7 additionalInfos:(id)a8 cacheInfos:(id)a9 auditToken:(id)a10 constraints:(unsigned long long)a11 backgroundSessionIdentifier:(id)a12 shouldParticipateInBalancer:(BOOL)a13 reason:(unsigned char)a14;
- (id)init;
