...
+ (BOOL)requestETAFromOrigin:(id)a0 toDestinations:(id)a1 transportType:(int)a2 timepoint:(struct GEOTimepoint { double x0; double x1; int x2; struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; } x3; })a3 includeDistance:(BOOL)a4 commonOptions:(id)a5 automobileOptions:(id)a6 walkingOptions:(id)a7 transitOptions:(id)a8 cyclingOptions:(id)a9 familiarRoute:(id)a10 auditToken:(id)a11 handler:(id /* block */)a12 callbackQueue:(id)a13;
+ (BOOL)requestTrafficAndETAFromWaypoint:(id)a0 toWaypoints:(id)a1 transportType:(int)a2 automobileOptions:(id)a3 familiarRoute:(id)a4 arrivalDate:(id)a5 handler:(id /* block */)a6;
