...
@interface GEOProbeCrumbs : NSObject {
    ...
    int _baseDistance;
    struct deque<_GEOProbeCrumbsLocation, std::allocator<_GEOProbeCrumbsLocation>> { struct __split_buffer<_GEOProbeCrumbsLocation *, std::allocator<_GEOProbeCrumbsLocation *>> { struct _GEOProbeCrumbsLocation **__first_; struct _GEOProbeCrumbsLocation **__begin_; struct _GEOProbeCrumbsLocation **__end_; struct _GEOProbeCrumbsLocation **__cap_; } __map_; unsigned long long __start_; unsigned long long __size_; } _locations;
}
