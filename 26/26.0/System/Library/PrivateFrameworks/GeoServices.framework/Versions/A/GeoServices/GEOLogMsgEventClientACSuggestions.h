@class PBDataReader, NSString, GEOModelMetadata, NSMutableArray, GEOExperimentMetadata;
...
@interface GEOLogMsgEventClientACSuggestions : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_overallLatencyInMs : 1; unsigned char has_autocompleteSequenceNumber : 1; unsigned char has_keypressStatus : 1; unsigned char has_responseStatus : 1; unsigned char has_selectedIndex : 1; unsigned char has_selectedSectionIndex : 1; unsigned char has_trigger : 1; unsigned char has_withinSectionSelectedIndex : 1; unsigned char has_isRerankerTriggered : 1; unsigned char has_isRetainedQuery : 1; unsigned char has_shouldDifferentiateClientAndServerResults : 1; unsigned char read_entries : 1; unsigned char read_modelMetadata : 1; unsigned char read_queryTokens : 1; unsigned char read_query : 1; unsigned char read_trialExperimentMetadata : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (readonly, nonatomic) BOOL hasTrialExperimentMetadata;
...
- (int)StringAsResponseStatus:(id)a0;
...
- (id)responseStatusAsString:(int)a0;
