...
+ (id)URLForReportAnIncidentWithType:(int)a0;
...
+ (id)URLForExploreGuides:(id)a0 cityName:(id)a1;
...
- (id)initForExploreGuides:(id)a0 cityName:(id)a1;
...
- (id)initForReportAnIncidentWithType:(int)a0;
