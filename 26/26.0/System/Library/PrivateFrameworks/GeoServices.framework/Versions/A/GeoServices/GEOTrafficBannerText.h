...
@property (readonly, nonatomic) BOOL hasCameraInput;
...
@property (nonatomic) BOOL hasIncludeDismissButton;
@property (nonatomic) BOOL includeDismissButton;
...
- (void)addBannerLargeText:(id)a0;
- (void)addBannerSmallText:(id)a0;
- (void)addButton:(id)a0;
- (void)addLocalizedIncidentBanner:(id)a0;
- (void)addLocalizedIncidentSubBanner:(id)a0;
- (id)bannerLargeTextAtIndex:(unsigned long long)a0;
- (unsigned long long)bannerLargeTextsCount;
- (id)bannerSmallTextAtIndex:(unsigned long long)a0;
