...
@interface GEOFormattedStringClientCapabilities : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_maxSupportedAppLinkValue : 1; unsigned char has_concatenatingFormatStringsSupported : 1; unsigned char has_styleSupported : 1; unsigned char has_timestampFormatPatternSupported : 1; } _flags;
}
...
@property (nonatomic) BOOL hasMaxSupportedAppLinkValue;
