...
@property (readonly, nonatomic) BOOL hasMapsEngagement;
@property (retain, nonatomic) GEOLogMsgEventMapsEngagement *mapsEngagement;
@property (readonly, nonatomic) BOOL hasRedactedServiceMetadata;
