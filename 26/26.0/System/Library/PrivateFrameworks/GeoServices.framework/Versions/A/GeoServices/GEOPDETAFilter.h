...
@interface GEOPDETAFilter : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_timepoint : 1; unsigned char has_includeEtaRouteIncidents : 1; unsigned char has_includeHistoricTravelTime : 1; unsigned char has_includeRouteTrafficDetail : 1; unsigned char read_unknownFields : 1; unsigned char read_transportTypes : 1; unsigned char read_automobileOptions : 1; unsigned char read_clientCapabilities : 1; unsigned char read_cyclingOptions : 1; unsigned char read_transitOptions : 1; unsigned char read_walkingOptions : 1; unsigned char wrote_anyField : 1; } _flags;
}
