...
@interface GEOSharedNavRouteInfo : PBCodable <NSCopying> {
    ...
    int _elevationModel;
    struct { unsigned char has_elevationModel : 1; unsigned char read_unknownFields : 1; unsigned char read_coordinates : 1; unsigned char read_trafficColorOffsets : 1; unsigned char read_trafficColors : 1; unsigned char read_chargingStations : 1; unsigned char read_routingPathLegs : 1; unsigned char wrote_anyField : 1; } _flags;
}
