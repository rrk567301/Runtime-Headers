@class NSString, GEOLocation, NSArray, NSDate, NSError;
...
@property (readonly, nonatomic) BOOL usesLearnedRoute;
...
- (void)_setTravelSections:(id)a0;
- (void)_setUsesLearnedRoute:(BOOL)a0;
