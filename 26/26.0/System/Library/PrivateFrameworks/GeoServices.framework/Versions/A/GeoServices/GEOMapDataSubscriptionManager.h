...
- (id)init;
- (void).cxx_destruct;
- (void)_addSubscriptionWithIdentifier:(id)a0 auditToken:(id)a1 dataTypes:(unsigned long long)a2 policy:(long long)a3 region:(id)a4 displayName:(id)a5 expirationDate:(id)a6 updateInterval:(double)a7 callbackQueue:(id)a8 completionHandler:(id /* block */)a9;
...
- (void)addSubscriptionWithIdentifier:(id)a0 dataTypes:(unsigned long long)a1 policy:(long long)a2 region:(id)a3 expirationDate:(id)a4 updateInterval:(double)a5 callbackQueue:(id)a6 completionHandler:(id /* block */)a7;
