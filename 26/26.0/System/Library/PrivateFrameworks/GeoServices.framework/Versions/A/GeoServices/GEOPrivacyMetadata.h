...
@interface GEOPrivacyMetadata : PBCodable <NSCopying> {
    ...
    BOOL _isOptedIntoFamiliarRoutePreservation;
    BOOL _isSharedIpadForEducation;
    BOOL _isUnderageAccount;
    struct { unsigned char has_isManagedAccount : 1; unsigned char has_isMismatchedStorefrontDeviceRegion : 1; unsigned char has_isOptedIntoFamiliarRoutePreservation : 1; unsigned char has_isSharedIpadForEducation : 1; unsigned char has_isUnderageAccount : 1; } _flags;
}
...
@property (nonatomic) BOOL hasIsOptedIntoFamiliarRoutePreservation;
@property (nonatomic) BOOL isOptedIntoFamiliarRoutePreservation;
