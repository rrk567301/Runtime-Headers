@class GEOStyleAttributes, GEORouteDisplayHints, GEOTransitDecoderData, PBUnknownFields, PBDataReader, GEOTrafficBannerText, GEOAlert, NSMutableArray, NSString, GEOPDDatasetABStatus, GEOPBTransitRoutingIncidentMessage, GEOTransitRouteUpdateConfiguration, GEOUUID, GEOSnapScoreMetadata, GEOClientMetrics, NSData, GEODirectionsRequestResponseAnalyticsData, GEOAdvisoriesInfo, GEOCommonResponseAttributes;
...
@property (readonly, nonatomic) BOOL hasRedactedAnalyticData;
