@class GEOPDIdentityMerchantInformation, NSString, PBDataReader, PBUnknownFields, GEOPDMerchantInformation, GEOPDWarsawMerchantIdentifier, GEOLocation, GEOPDAdamAppIdentifier, GEOPDCoreLocationHintMetadata;
...
@property (readonly, nonatomic) BOOL hasCurrentLocationHintMetadata;
@property (retain, nonatomic) GEOPDCoreLocationHintMetadata *currentLocationHintMetadata;
@property (nonatomic) BOOL hasIsNonApplePayFpanTransaction;
@property (nonatomic) BOOL isNonApplePayFpanTransaction;
