...
+ (unsigned long long)_determineNumItemsInSession:(id)a0 engagedAction:(id)a1 cacheReader:(id)a2;
+ (void)_harvestMenuItemActionPredictions:(id)a0 sessionUUID:(id)a1;
+ (void)harvestActionPredictionDataForResponse:(id)a0;
