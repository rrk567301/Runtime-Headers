...
- (void).cxx_destruct;
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct ATXPredictionItem *x2; })itemsForBundleIds:(id)a0;
