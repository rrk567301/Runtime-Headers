...
- (id)_getSleepScheduleStateOnDoSync:(BOOL)a0;
...
- (id)_getSleepEventRecordDoSync:(BOOL)a0;
- (id)_getSleepEventRecordFromServerDoSync:(BOOL)a0;
- (id)_getSleepModeDoSync:(BOOL)a0;
- (id)_getSleepModeFromServerDoSync:(BOOL)a0;
- (id)_getSleepScheduleDoSync:(BOOL)a0;
- (id)_getSleepScheduleFromServerDoSync:(BOOL)a0;
- (id)_getSleepScheduleModelDoSync:(BOOL)a0;
- (id)_getSleepScheduleModelFromServerDoSync:(BOOL)a0;
- (id)_getSleepScheduleStateFromServerDoSync:(BOOL)a0;
- (id)_getSleepSettingsDoSync:(BOOL)a0;
- (id)_getSleepSettingsFromServerDoSync:(BOOL)a0;
...
- (void)_updateAndNotifyForChangedSleepEventRecord:(id)a0 clientIdentifier:(id)a1;
- (void)_updateAndNotifyForChangedSleepMode:(id)a0;
- (void)_updateAndNotifyForChangedSleepSchedule:(id)a0 clientIdentifier:(id)a1;
- (void)_updateAndNotifyForChangedSleepScheduleState:(id)a0;
- (void)_updateAndNotifyForChangedSleepSettings:(id)a0 clientIdentifier:(id)a1;
- (void)_updateAndNotifyForSleepEvent:(id)a0;
...
- (BOOL)shouldInvalidateRelevanceForWidgetOfKind:(id)a0;
- (BOOL)shouldReloadWidgetOfKind:(id)a0;
...
- (void)trackSleepDataInteractionEventWithType:(unsigned long long)a0 isOnboardedVitals:(BOOL)a1 completion:(id /* block */)a2;
