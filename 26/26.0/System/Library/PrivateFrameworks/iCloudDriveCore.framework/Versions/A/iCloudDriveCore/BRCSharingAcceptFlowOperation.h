@class BRCAppLibrary, NSURL, NSObject, BRFileObjectID, BRCItemID, NSString, CKRecordID, CKShareMetadata, BRCAcceptShareOperation, BRCXPCClient, NSArray, BRCClientZone, NSError;
...
- (id)initWithShareMetadata:(id)a0 client:(id)a1 sessionContext:(id)a2 userNotifier:(id)a3 userActionsNavigator:(id)a4;
