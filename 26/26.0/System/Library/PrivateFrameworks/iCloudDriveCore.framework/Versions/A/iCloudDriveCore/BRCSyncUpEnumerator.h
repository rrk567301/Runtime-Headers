...
- (BOOL)_checkIfParentNeedsRevivalWithParentItem:(id)a0 item:(id)a1;
- (BOOL)_checkIfShouldDenylistForChildrenOfItemBeingCopiedToNewZone:(id)a0;
- (BOOL)_checkIfShouldDenylistForParentDirectoryFaultWithItem:(id)a0;
...
- (BOOL)shouldDenylistRemainingDeletionParentStackForItem:(id)a0;
