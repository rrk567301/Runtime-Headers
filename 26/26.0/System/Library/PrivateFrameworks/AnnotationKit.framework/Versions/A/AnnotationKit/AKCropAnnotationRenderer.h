...
+ (void)_addCurvedCornerToPath:(struct CGPath { } *)a0 cornerType:(long long)a1 cornerPoint:(struct CGPoint { double x0; double x1; })a2 cornerRadius:(double)a3 handleInside:(double)a4 handleOutside:(double)a5 handleWidth:(double)a6;
+ (void)_addStraightCornerToPath:(struct CGPath { } *)a0 cornerType:(long long)a1 cornerPoint:(struct CGPoint { double x0; double x1; })a2 handleInside:(double)a3 handleOutside:(double)a4 handleWidth:(double)a5;
...
+ (void)_concreteRenderAnnotation:(id)a0 intoContext:(struct CGContext { } *)a1 options:(id)a2 pageControllerOrNil:(id)a3;
...
+ (BOOL)_shouldUseRoundedCorner:(long long)a0 forAnnotation:(id)a1 withPageController:(id)a2;
