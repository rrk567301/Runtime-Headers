...
- (struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })characterTokenIDsForString:(id)a0;
...
- (struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })wordTokenIDsForString:(id)a0 outTokenRanges:(id *)a1;
