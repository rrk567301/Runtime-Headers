...
@property (nonatomic) struct BWCoreAnalyticsMovieRecordingVideoDeghostingStatistics { BOOL x0; int x1; double x2; double x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; } *videoDeghostingStatistics;
...
@property (nonatomic) struct BWCoreAnalyticsMovieRecordingCinematicAudioRemixStatistics { float dialogueGain; float ambienceGain; float dialogueLoudness; float ambienceLoudness; float recordingLoudness; } cinematicAudioRemixStats;
