...
@property (readonly, nonatomic) BOOL clientIsVOIP;
@property (readonly, nonatomic) BOOL suppressVideoEffects;
@property (readonly, nonatomic) BOOL useOfflineVISPipeline;
@property (readonly, nonatomic) BOOL smartStyleRenderingEnabled;
@property (readonly, nonatomic) long long smartStyleControlMode;
@property (readonly, nonatomic) FigCaptureSmartStyle *smartStyle;
@property (readonly, nonatomic, getter=isAudioOnlyRecordingSession) BOOL audioOnlyRecordingSession;
