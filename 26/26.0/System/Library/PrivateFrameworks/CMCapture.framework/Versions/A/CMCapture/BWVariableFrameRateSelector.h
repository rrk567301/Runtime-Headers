...
@interface BWVariableFrameRateSelector : NSObject {
    ...
    BOOL _teleAutoVideoFrameRateAllows24FPS;
...
- (id)initWithPortTypes:(id)a0 forParameters:(id)a1 frameRateSwitchBasedOnMotionDisabled:(BOOL)a2 teleAutoVideoFrameRateAllows24FPS:(BOOL)a3;
