...
@property (readonly, nonatomic) BOOL requiresGlobalSubjectRelightingCalculation;
@property (nonatomic) BOOL stillImageRequiresSmartStyleRenderingForSRL;
...
@property (nonatomic) BOOL isHardCut;
