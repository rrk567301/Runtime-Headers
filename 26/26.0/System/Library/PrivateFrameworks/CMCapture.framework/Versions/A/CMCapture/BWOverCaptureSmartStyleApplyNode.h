@class BWPixelBufferPool, CMISmartStyleOvercaptureThumbnailGenerator, BWVideoFormat;
...
- (id)initWithMetalCommandQueue:(id)a0 squareAspectRatioConfigEnabled:(BOOL)a1;
