...
@property (nonatomic) BOOL machineLearningVideoNoiseReductionSupported;
...
@property (nonatomic) struct { union { struct { int numerator; int denominator; } rational; float floating; } u; int tag; } minFrameRate;
...
@property (nonatomic) BOOL dynamicAspectRatioEnabled;
@property (nonatomic) BOOL adaptiveSensorCropForDynamicAspectRatioEnabled;
@property (nonatomic) BOOL sensorOutputLargerThanImageCircle;
...
@property (nonatomic) struct { int width; int height; } stillImageOutputDimensionsOverride;
@property (nonatomic) struct { int width; int height; } sushiRawDimensions;
...
@property (nonatomic) BOOL ltmThumbnailOnPreviewOutputEnabled;
@property (nonatomic) BOOL weightSegmentMapOnPreviewOutputEnabled;
...
@property (nonatomic) BOOL ltmThumbnailOnVideoCaptureOutputEnabled;
@property (nonatomic) BOOL weightSegmentMapOnVideoCaptureOutputEnabled;
...
@property (nonatomic) BOOL preLTMThumbnailEnabled;
@property (nonatomic) BOOL postLTMThumbnailEnabled;
@property (nonatomic) struct { int width; int height; } ltmThumbnailOutputDimensions;
...
@property (nonatomic) struct { int width; int height; } weightSegmentMapOutputDimensions;
@property (nonatomic) BOOL proResRawCaptureEnabled;
