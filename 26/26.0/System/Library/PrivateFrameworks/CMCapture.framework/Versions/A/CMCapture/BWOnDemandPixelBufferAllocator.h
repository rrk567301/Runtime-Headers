...
+ (void)initialize;
+ (id)onDemandAllocatorWithDimensions:(struct { int x0; int x1; })a0 dimensionAlignment:(int)a1 pixelFormat:(unsigned int)a2 name:(id)a3 memoryPool:(id)a4;
+ (id)onDemandAllocatorWithDimensions:(struct { int x0; int x1; })a0 pixelFormat:(unsigned int)a1 name:(id)a2 memoryPool:(id)a3;
+ (id)onDemandAllocatorWithoutMemoryPoolWithDimensions:(struct { int x0; int x1; })a0 dimensionAlignment:(int)a1 pixelFormat:(unsigned int)a2 name:(id)a3;
...
- (id)initWithoutMemoryPoolWithVideoFormat:(id)a0 name:(id)a1 additionalPixelBufferAttributes:(id)a2;
