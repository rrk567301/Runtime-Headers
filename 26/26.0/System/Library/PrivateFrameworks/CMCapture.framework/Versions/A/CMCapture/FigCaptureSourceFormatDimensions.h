...
+ (int)identifyResolutionFlavorFromDimensions:(struct { int x0; int x1; })a0 availableHighResStillImageDimensions:(id)a1 aspectRatio:(int)a2;
+ (id)identifySourceFormatDimensionsFromDimensions:(struct { int x0; int x1; })a0 availableHighResStillImageDimensions:(id)a1 aspectRatio:(int)a2;
