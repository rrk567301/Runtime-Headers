@class NSDate, NSString, NSManagedObjectContext, NFTrashFolder, NSManagedObjectID, NFFolder, NSArray, ACAccountCredential, CSSearchableItemAttributeSet, ACAccount;
