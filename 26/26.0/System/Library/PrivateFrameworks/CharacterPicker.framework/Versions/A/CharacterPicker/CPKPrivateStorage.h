@class NSView, EMFEmojiLocaleData, EMFEmojiPreferences, CPKWindow, NSDictionary, CPKPopoverController, CPKDataProvider, NSWindow, _STKImageGlyphRecencyObjCFacade;
...
@property (retain, nonatomic) _STKImageGlyphRecencyObjCFacade *stickersRecency;
