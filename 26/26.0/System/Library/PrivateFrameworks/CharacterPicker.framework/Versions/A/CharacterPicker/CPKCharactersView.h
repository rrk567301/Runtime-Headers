@class NSMutableDictionary, CPKCalculatedGeometry, CPKCharactersSectionView, NSTextField, NSButton, NSDictionary, NSScrollView, CPKHorizontalPopupMenu, NSLayoutConstraint, NSString, NSOperationQueue, NSView, CPKCharactersTableView, CPKSearchField;
...
@property (weak) id<CPKCharactersViewDelegate> delegate;
@property (weak) id<CPKCharactersViewDelegate> fallbackDelegate;
@property (readonly, weak) id<CPKCharactersViewDataSource> dataSource;
@property (weak) id<CPKCharactersViewDataSource> nextDataSource;
