...
- (BOOL)_processAlbumArtistOperation:(id)a0 withImportSession:(void *)a1;
- (BOOL)_processAlbumOperation:(id)a0 withImportSession:(void *)a1;
- (BOOL)_processLibraryPinOperation:(id)a0 withImportSession:(void *)a1;
