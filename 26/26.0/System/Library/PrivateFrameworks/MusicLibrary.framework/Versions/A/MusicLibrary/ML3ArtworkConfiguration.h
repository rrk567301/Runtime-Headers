...
- (id)description;
- (void).cxx_destruct;
- (id)sizesToAutogenerateForMediaType:(unsigned int)a0 artworkType:(long long)a1 artworkVariantType:(long long)a2;
...
- (id)supportedSizesForMediaType:(unsigned int)a0 artworkType:(long long)a1 artworkVariantType:(long long)a2;
- (id)_supportedSizeKeysForMediaType:(unsigned int)a0 artworkType:(long long)a1 artworkVariantType:(long long)a2;
