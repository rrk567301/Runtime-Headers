...
+ (struct unique_ptr<siri::ontology::UsoEntitySpan, std::default_delete<siri::ontology::UsoEntitySpan>> { struct UsoEntitySpan *x0; })buildEntitySpanWithSemantic:(id)a0 withVocLabel:(id)a1 withStartIndex:(unsigned int)a2 withEndIndex:(unsigned int)a3 withTokenCount:(unsigned int)a4;
...
+ (struct unique_ptr<siri::ontology::UsoIdentifier, std::default_delete<siri::ontology::UsoIdentifier>> { struct UsoIdentifier *x0; })buildIdentifierWithSemantic:(id)a0 withVocLabel:(id)a1;
