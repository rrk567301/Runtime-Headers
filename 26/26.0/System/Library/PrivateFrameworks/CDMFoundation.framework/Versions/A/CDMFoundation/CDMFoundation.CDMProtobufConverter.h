...
+ (id)serializeExternalCdmPlannerResponseWithResponse:(id)a0 formatType:(id)a1;
...
+ (id)serializeExternalSubwordEmbeddingResponseWithResponse:(id)a0 formatType:(id)a1;
...
+ (id)siriExternalCdmPlannerRequestJsonToObjWithProto2Json:(id)a0;
+ (id)siriExternalNluRequestJsonToObjWithProto2Json:(id)a0;
+ (id)siriExternalSubwordEmbeddingRequestJsonToObjWithProto2Json:(id)a0;
