...
- (void)_initConstantsBuffer:(id)a0;
- (id)initWithRenderPipelineState:(id)a0 descriptor:(id)a1 device:(id)a2;
- (id)initWithRenderPipelineState:(id)a0 descriptor:(id)a1 dynamicLinkingDescriptor:(id)a2 device:(id)a3;
...
- (id)initWithRenderPipelineState:(id)a0 originalObject:(id)a1 descriptor:(id)a2 device:(id)a3;
...
- (id)initWithRenderPipelineState:(id)a0 vertexBinaryFunctions:(id)a1 fragmentBinaryFunctions:(id)a2 tileBinaryFunctions:(id)a3 objectBinaryFunctions:(id)a4 meshBinaryFunctions:(id)a5 withState:(id)a6 device:(id)a7;
