@class MTLToolsDepthStencilState, NSString, MTLLegacySVCommandBuffer, MTLLegacySVRenderPipelineState;
...
@interface MTLLegacySVRenderCommandEncoder : MTLToolsRenderCommandEncoder <MTLLegacySVCommandEncoder> {
    ...
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; id<MTLLegacySVResource> resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[31][2]; BOOL needsFlush; } _vertexHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; id<MTLLegacySVResource> resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[31][2]; BOOL needsFlush; } _fragmentHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; id<MTLLegacySVResource> resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[31][2]; BOOL needsFlush; } _tileHandles;
    struct MTLLegacySVTileThreadgroup { struct GPUDebugThreadgroupTableEntry { unsigned int offset; unsigned int length; } entries[32]; BOOL needsFlush; } _tileThreadgroup;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; id<MTLLegacySVResource> resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[31][2]; BOOL needsFlush; } _objectHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; id<MTLLegacySVResource> resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[31][2]; BOOL needsFlush; } _meshHandles;
    struct MTLLegacySVThreadgroupLengths { unsigned int threadgroupSizes[31]; struct GPUDebugThreadgroupTableEntry { unsigned int offset; unsigned int length; } entries[32]; BOOL needsFlush; } _meshThreadgroup;
    ...
    struct MTLLegacySVBufferSubAlloc { id<MTLBuffer> buffer; unsigned long long offset; } _vertexReportBuffer;
    struct MTLLegacySVBufferSubAlloc { id<MTLBuffer> buffer; unsigned long long offset; } _fragmentReportBuffer;
    struct MTLLegacySVBufferSubAlloc { id<MTLBuffer> buffer; unsigned long long offset; } _tileReportBuffer;
    struct MTLLegacySVBufferSubAlloc { id<MTLBuffer> buffer; unsigned long long offset; } _objectReportBuffer;
    struct MTLLegacySVBufferSubAlloc { id<MTLBuffer> buffer; unsigned long long offset; } _meshReportBuffer;
...
- (void)dispatchThreadsPerTile:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0 withCondition:(long long)a1;
