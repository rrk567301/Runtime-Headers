...
@interface MTLDebugTexture : MTLToolsTexture <MTLDebugResourcePurgeable> {
    ...
    struct unordered_map<SubView, unsigned long, SubView::hash_t, SubView::equal_t, std::allocator<std::pair<const SubView, unsigned long>>> { struct __hash_table<std::__hash_value_type<SubView, unsigned long>, std::__unordered_map_hasher<SubView, std::__hash_value_type<SubView, unsigned long>, SubView::hash_t, SubView::equal_t>, std::__unordered_map_equal<SubView, std::__hash_value_type<SubView, unsigned long>, SubView::equal_t, SubView::hash_t>, std::allocator<std::__hash_value_type<SubView, unsigned long>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<SubView, unsigned long>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<SubView, unsigned long>, void *> *> *>>> { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<SubView, unsigned long>, void *> *> *>> { unsigned long long __size_; } __deleter_; } __bucket_list_; struct __hash_node_base<std::__hash_node<std::__hash_value_type<SubView, unsigned long>, void *> *> { void *__next_; } __first_node_; unsigned long long __size_; float __max_load_factor_; } __table_; } _activeSubViews;
}
...
- (BOOL)evaluateSloppyUsage:(unsigned long long)a0;
- (BOOL)evaluateUsage:(unsigned long long)a0;
...
- (id)initWithBaseTexture:(id)a0 device:(id)a1 buffer:(id)a2 offset:(unsigned long long)a3 bytesPerRow:(unsigned long long)a4 bytesPerImage:(unsigned long long)a5 descriptor:(id)a6;
- (id)initWithBaseTexture:(id)a0 device:(id)a1 buffer:(id)a2 offset:(unsigned long long)a3 bytesPerRow:(unsigned long long)a4 descriptor:(id)a5;
- (id)initWithBaseTexture:(id)a0 device:(id)a1 placementSparsePageSize:(long long)a2;
