@class NSData, NSString, MTLGPUDebugDynamicLibrary, MTLGPUDebugDevice, MTL4GPUDebugBinaryFunction, MTLGPUDebugFunction, MTLGPUDebugBuffer, MTLDebugInstrumentationData;
@protocol MTLBuffer;
...
- (id)initWithBinaryFunction:(id)a0 debugInstrumentationData:(id)a1 device:(id)a2;
- (id)initWithDynamicLibrary:(id)a0;
- (id)initWithFunction:(id)a0;
- (id)initWithFunction:(id)a0 debugInstrumentationData:(id)a1;
- (id)initWithFunctionName:(id)a0 functionType:(unsigned long long)a1 debugInstrumentationData:(id)a2 device:(id)a3;
