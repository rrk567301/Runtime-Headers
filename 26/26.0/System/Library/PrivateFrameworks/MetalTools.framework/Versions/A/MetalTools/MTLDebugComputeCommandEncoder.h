@class __begin_, baseLevel, MTLDebugCommandBuffer, __cap_, __end_;
...
@interface MTLDebugComputeCommandEncoder : MTLToolsComputeCommandEncoder {
    ...
    struct set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int>> { struct __tree<unsigned int, std::less<unsigned int>, std::allocator<unsigned int>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } _progressLabels;
