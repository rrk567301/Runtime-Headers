@class _TtC17LiveTranscription15AXLCTranscriber, NSString, AXLTTranscriber, _TtC17LiveTranscription23AXLiveCaptionSourceInfo, NSDate, AVAudioFormat;
...
- (id)initWithPID:(int)a0 appID:(id)a1 appName:(id)a2 locale:(id)a3 delegate:(id)a4 transcriberVersion:(long long)a5;
