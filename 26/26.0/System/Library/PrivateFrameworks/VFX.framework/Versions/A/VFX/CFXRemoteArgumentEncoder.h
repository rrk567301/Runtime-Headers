@class NSString;
@protocol MTLDevice, MTLArgumentEncoder;

@interface CFXRemoteArgumentEncoder : NSObject <MTLArgumentEncoder> {
...
- (id)initWithRemoteFrameBuilder:(struct __CFXRemoteFrameBuilder { } *)a0 encoder:(id)a1;
