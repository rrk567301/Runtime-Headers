...
- (struct __CFXProgram { } *)_newProgramWithHashCode:(struct __CFXProgramHashCode { } *)a0 engineContext:(struct __CFXEngineContext { } *)a1 introspectionDataPtr:(struct { long long x0; struct *x1; struct { long long x0; long long x1; } x2[4]; struct { long long x0; long long x1; } x3[4]; long long x4[4]; BOOL x5; } *)a2;
- (void)collectShaderForProgram:(struct __CFXProgram { } *)a0 hashCode:(id)a1 newVertexFunctionName:(id)a2 newFragmentFunctionName:(id)a3 sourceCodeBlock:(id /* block */)a4 additionalFileBlock:(id /* block */)a5;
