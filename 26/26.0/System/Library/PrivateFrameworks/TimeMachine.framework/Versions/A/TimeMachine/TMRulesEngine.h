...
+ (id)rulesEngineUsingBOM:(id)a0 findStickyExclusionsUsingSpotlight:(BOOL)a1 qos:(long long)a2 error:(id *)a3 cancelBlock:(id /* block */)a4;
+ (id)rulesEngineUsingBaseRuleSet:(unsigned int)a0 sourceVolumes:(id)a1 pathExclusions:(id)a2 excludedVolumeUUIDs:(id)a3 findStickyExclusionsUsingSpotlight:(BOOL)a4 qos:(long long)a5 error:(id *)a6 cancelBlock:(id /* block */)a7;
