...
@interface TMNodeCache : TMMonoStructure {
    struct vector<NodeCacheEntry, std::allocator<NodeCacheEntry>> { struct NodeCacheEntry *__begin_; struct NodeCacheEntry *__end_; struct NodeCacheEntry *__cap_; } _uncommittedEntries;
}
...
+ (BOOL)_appendEntries:(struct vector<NodeCacheEntry, std::allocator<NodeCacheEntry>> { struct NodeCacheEntry *x0; struct NodeCacheEntry *x1; struct NodeCacheEntry *x2; })a0 toURL:(id)a1 error:(id *)a2;
