...
- (void)_performLocationChecksWithTargetResponder:(id)a0 shouldPromptLocationAlert:(BOOL)a1 shouldRequestUserLocation:(BOOL)a2 isLocationAuthorized:(BOOL)a3 authorizationStatusDidChangeNotificationName:(id)a4 completionHandler:(id /* block */)a5;
