@interface _TtCC8VideosUI16FlowcaseViewCell19FlowcaseOverlayView : VUIBaseView {
    ...
    void /* unknown type, empty encoding */ bannerScorecardView;
    ...
    void /* unknown type, empty encoding */ logoImagePosition;
    void /* unknown type, empty encoding */ alphaImageView;
    void /* unknown type, empty encoding */ defaultContextMenuButtonColor;
    void /* unknown type, empty encoding */ highlightedContextMenuButtonColor;
    void /* unknown type, empty encoding */ contextMenuButton;
    void /* unknown type, empty encoding */ isPlayingVideo;
    void /* unknown type, empty encoding */ useDarkJoeColor;
    void /* unknown type, empty encoding */ useBoundingBoxMargin;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_darkeningGradientView;
    void /* unknown type, empty encoding */ $__lazy_storage_$_playbackGradientLayer;
    void /* unknown type, empty encoding */ $__lazy_storage_$_opacityMaskLayer;
    void /* unknown type, empty encoding */ scoreboardCoodinator;
}
