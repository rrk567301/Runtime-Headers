@class NSView, VKImageAnalysisButton, NSArray, NSFont, NSGlassContainerView, VKCActionInfoViewLayoutContext, VKCVisualSearchCornerView, VKCActionInfoMoreButton;

@interface VKCActionInfoView : VKPlatformView

@property (retain, nonatomic) NSGlassContainerView *containerView;
