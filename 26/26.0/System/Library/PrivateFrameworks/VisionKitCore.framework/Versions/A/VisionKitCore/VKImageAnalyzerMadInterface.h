@class VICVisualIntelligenceAnalyzer, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSObject, MADService;
...
- (void)_didFinishRequest:(id)a0 withAnalysis:(id)a1 analyticsEvent:(id)a2 error:(id)a3;
...
- (void)processMRCInfo:(id)a0 completionHandler:(id /* block */)a1;
