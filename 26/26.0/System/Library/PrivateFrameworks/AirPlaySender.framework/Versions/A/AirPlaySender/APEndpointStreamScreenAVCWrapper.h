...
- (int)createVideoStreamConfig:(id *)a0 withDirection:(long long)a1 screenOptions:(struct { struct CGSize { double x0; double x1; } x0; int x1; id x2; id x3; unsigned char x4; struct __CFString *x5; id x6; unsigned char x7; void *x8; unsigned long long x9; } *)a2 previousConfig:(id)a3;
- (int)getClientUPID:(unsigned long long *)a0;
- (void)getVideoResolutionFromOptions:(struct { struct CGSize { double x0; double x1; } x0; int x1; id x2; id x3; unsigned char x4; struct __CFString *x5; id x6; unsigned char x7; void *x8; unsigned long long x9; } *)a0 width:(unsigned long long *)a1 height:(unsigned long long *)a2;
- (void)handleFailureWithError:(int)a0 reason:(struct __CFString { } *)a1;
- (int)initScreeenCaptureWithScreenOptions:(struct { struct CGSize { double x0; double x1; } x0; int x1; id x2; id x3; unsigned char x4; struct __CFString *x5; id x6; unsigned char x7; void *x8; unsigned long long x9; } *)a0;
...
- (int)restartWithScreenOptions:(struct { struct CGSize { double x0; double x1; } x0; int x1; id x2; id x3; unsigned char x4; struct __CFString *x5; id x6; unsigned char x7; void *x8; unsigned long long x9; } *)a0 negotiatedBlob:(id)a1;
- (int)setCaptureSourceIDForStreamConfig:(id)a0;
- (int)startWithNWConnectionClientID:(unsigned char[16])a0 negotiatedBlob:(id)a1 screenOptions:(struct { struct CGSize { double x0; double x1; } x0; int x1; id x2; id x3; unsigned char x4; struct __CFString *x5; id x6; unsigned char x7; void *x8; unsigned long long x9; } *)a2 completion:(struct { void /* function */ *x0; void *x1; int x2; })a3;
