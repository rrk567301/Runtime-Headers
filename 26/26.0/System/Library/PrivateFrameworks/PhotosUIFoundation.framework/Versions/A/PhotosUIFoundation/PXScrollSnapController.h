...
@property (nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } visibilityInsets;
...
- (id)initWithSnapBehavior:(long long)a0 scrollAxis:(long long)a1 visibleRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 visibilityInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a3 scrollablePageSource:(id)a4;
