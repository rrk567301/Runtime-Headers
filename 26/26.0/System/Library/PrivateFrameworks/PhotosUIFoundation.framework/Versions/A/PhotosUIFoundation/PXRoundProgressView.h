@class NSDate, NSView, PXProgressArcLayer, CAShapeLayer, CALayer, NSTimer;

@interface PXRoundProgressView : NSView {
...
@property (retain, nonatomic, setter=_setContentView:) NSView *_contentView;
