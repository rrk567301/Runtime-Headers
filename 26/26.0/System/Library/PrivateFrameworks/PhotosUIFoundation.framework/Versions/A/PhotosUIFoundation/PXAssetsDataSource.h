@class NSString, PXAssetReference, NSPredicate;
@protocol PXDisplayCollection, PXDisplayAsset, PXAssetsDataSourceFetchResultInfoProvider, PXAssetsDataSourceContainer, PXDisplayAssetCollection;
