...
+ (id)_generateConsiderationIntervalFromDaySummaries:(id)a0 morningIndexRange:(struct { long long x0; long long x1; })a1;
+ (id)_generateStrategyWithSleepDayInterval:(id)a0 considerationInterval:(id)a1;
...
+ (id)sleepMetricsForDaySummaryCollections:(id)a0;
