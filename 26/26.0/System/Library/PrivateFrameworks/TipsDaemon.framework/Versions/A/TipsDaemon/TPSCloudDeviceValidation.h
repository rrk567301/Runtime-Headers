...
+ (id)deviceInfoForIdentifier:(id)a0 name:(id)a1 symbol:(id)a2 dataSource:(id)a3;
+ (id)deviceInfoForIdentifier:(id)a0 preferredIdentifiers:(id)a1 productIdentifier:(id)a2 name:(id)a3 symbol:(id)a4 dataSource:(id)a5;
+ (id)iPadDeviceInfoUsingDataSource:(id)a0;
+ (id)iPhoneDeviceInfoUsingDataSource:(id)a0;
+ (id)macDeviceInfoUsingDataSource:(id)a0;
