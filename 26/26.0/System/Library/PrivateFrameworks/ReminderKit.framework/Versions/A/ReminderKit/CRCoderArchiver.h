...
@interface CRCoderArchiver : CRCoder {
    struct vector<CRDT::Document_DocObject *, std::allocator<CRDT::Document_DocObject *>> { struct Document_DocObject **__begin_; struct Document_DocObject **__end_; struct Document_DocObject **__cap_; } currentDocObjectEncodingStack;
}
