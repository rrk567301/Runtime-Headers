...
- (id)rankedNameSuggestionsWithPredictionContext:(id)a0 forName:(id)a1 contactsOnly:(BOOL)a2;
...
- (id)rankedSuggestionsWithPredictionContext:(id)a0 bundleId:(id)a1 maxSuggestions:(unsigned long long)a2 frequencyOnly:(BOOL)a3 interactions:(id)a4;
...
- (id)_featureVectorFromSuggestionDate:(id)a0 bundleID:(id)a1 peopleInPhotoIdentifiers:(id)a2 sceneTagsInPhotoIdentifiers:(id)a3;
...
- (BOOL)suggestedRecipientHandles:(id)a0 differFromFetchedRecipientHandles:(id)a1;
