@class NSString, NSDictionary, NSMutableDictionary, NSDate, NSNumber, ACAccount;
...
@property (copy, nonatomic) NSString *enqueueTimeDefaultAccountIdentifier;
...
@property (copy) NSString *canonicalAccountIdentifierOverride;
@property BOOL disableAccountIdentifierAutoDecoration;
...
- (void)setClientOnlyEventDate:(id)a0;
