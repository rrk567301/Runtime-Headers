...
@interface TPPBPeerStableInfo : PBCodable <NSCopying> {
    struct { unsigned char clock : 1; unsigned char flexiblePolicyVersion : 1; unsigned char frozenPolicyVersion : 1; unsigned char userControllableViewStatus : 1; unsigned char isInheritedAccount : 1; unsigned char supportsRepudiation : 1; } _has;
}
...
@property (nonatomic) BOOL hasSupportsRepudiation;
@property (nonatomic) BOOL supportsRepudiation;
