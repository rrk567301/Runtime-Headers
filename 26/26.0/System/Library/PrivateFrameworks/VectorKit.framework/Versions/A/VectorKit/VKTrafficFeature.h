...
@property (readonly, nonatomic) struct vector<GeoCodecsFeatureStylePair, geo::allocator_adapter<GeoCodecsFeatureStylePair, mdm::zone_mallocator>> { struct GeoCodecsFeatureStylePair *x0; struct GeoCodecsFeatureStylePair *x1; struct GeoCodecsFeatureStylePair *x2; struct allocator_adapter<GeoCodecsFeatureStylePair, mdm::zone_mallocator> { struct zone_mallocator { } x0; } x3; } attributes;
