@class PGGraphLocationHelper, CLSServiceManager, PGMemoryMomentNodesWithBlockedFeatureCache, PGGraphYearNodeCollection, NSDictionary, MABinaryAdjacency, NSObject, PGGraphMomentNodeCollection, PGMemoryProcessedScenesAndFacesCache;
@protocol OS_os_log;
...
- (id)initWithPhotoLibrary:(id)a0 userFeedbackCalculator:(id)a1 graph:(id)a2 serviceManager:(id)a3 loggingConnection:(id)a4;
- (id)initWithProcessedScenesAndFacesCache:(id)a0 momentNodesWithBlockedFeatureCache:(id)a1 locationHelper:(id)a2 serviceManager:(id)a3 loggingConnection:(id)a4;
...
- (id)momentNodesForProcessingWindow:(id)a0 inGraph:(id)a1;
