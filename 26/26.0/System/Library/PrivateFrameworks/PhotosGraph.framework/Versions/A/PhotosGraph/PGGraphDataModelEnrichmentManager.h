...
- (void).cxx_destruct;
- (BOOL)enrichDataModelWithGraphUpdateInventory:(id)a0 progressReporter:(id)a1 error:(id *)a2;
- (BOOL)enrichDataModelForHighlightUUIDs:(id)a0 progressReporter:(id)a1 error:(id *)a2;
- (BOOL)enrichDataModelWithProgressReporter:(id)a0 error:(id *)a1;
- (id)initWithManager:(id)a0 enrichmentProcessors:(id)a1;
- (BOOL)_enrichDataModelWithGraphUpdateInventory:(id)a0 progressReporter:(id)a1 error:(id *)a2;
