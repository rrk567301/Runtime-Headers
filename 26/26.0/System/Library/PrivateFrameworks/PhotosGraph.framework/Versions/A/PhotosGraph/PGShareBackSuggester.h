...
+ (id)shareBackSuggesterForExternalAssetProcessingWithLoggingConnection:(id)a0 photoLibrary:(id)a1 graph:(id)a2 serviceManager:(id)a3;
+ (id)shareBackSuggesterForSyndicationWithLoggingConnection:(id)a0 syndicationPhotoLibrary:(id)a1 systemPhotoLibrary:(id)a2 graph:(id)a3 faceIdentification:(id)a4 serviceManager:(id)a5;
+ (id)shareBackSuggesterForSyndicationWithLoggingConnection:(id)a0 syndicationPhotoLibrary:(id)a1 systemPhotoLibrary:(id)a2 graph:(id)a3 serviceManager:(id)a4;
