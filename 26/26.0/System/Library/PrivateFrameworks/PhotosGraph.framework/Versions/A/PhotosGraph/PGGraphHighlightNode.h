...
+ (id)filter;
+ (struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; unsigned long long x12; unsigned long long x13; double x14; })_promotionScoreDescriptorWithMomentNodes:(id)a0 neighborScoreComputer:(id)a1;
+ (id)filterWithUUID:(id)a0;
+ (double)aboveAveragePromotionScoreWithPromotionScoreDescriptor:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; unsigned long long x12; unsigned long long x13; double x14; })a0;
+ (id)allHighlightsFilter;
+ (double)averagePromotionScoreWithPromotionScoreDescriptor:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; unsigned long long x12; unsigned long long x13; double x14; })a0;
+ (double)belowAveragePromotionScoreWithPromotionScoreDescriptor:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; unsigned long long x12; unsigned long long x13; double x14; })a0;
...
+ (double)nonMeaningfulPromotionScoreWithPromotionScoreDescriptor:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; unsigned long long x12; unsigned long long x13; double x14; })a0 isAggregation:(BOOL)a1 enrichmentState:(unsigned short)a2;
