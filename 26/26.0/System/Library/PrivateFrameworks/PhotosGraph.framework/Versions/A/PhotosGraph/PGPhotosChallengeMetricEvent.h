...
- (void)_gatherMetricsForRelationshipQuestions:(id)a0 questionMetricType:(unsigned short)a1 progressBlock:(id /* block */)a2 useGraphInference:(BOOL)a3;
...
- (id)_inferredResultsForEntityIdentifiers:(id)a0 withDefaultBoolValue:(BOOL)a1;
...
- (id)_reasonResultsForPublicEventQuestions:(id)a0;
- (id)_reasonResultsForQuestions:(id)a0 inferenceResults:(id)a1 inferenceReasons:(id)a2;
- (BOOL)_relationshipInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1 useGraphInference:(BOOL)a2;
- (id)_relationshipInferenceResultsForQuestionMetricType:(unsigned short)a0 personUUIDs:(id)a1 useGraphInference:(BOOL)a2;
- (unsigned long long)_relationshipTagFromQuestionMetricType:(unsigned short)a0;
- (BOOL)_relationshipTagInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1;
- (BOOL)_relatonshipInferenceResultForPersonNode:(id)a0 questionMetricType:(unsigned short)a1;
