...
+ (id)prefilteringSubpredicatesWithContext:(id)a0;

- (void).cxx_destruct;
- (unsigned long long)expectedNumberOfSuggestedAssets;
- (id)assetsFromCandidates:(id)a0;
- (void)computeSuggestedAssetsWithNumberOfSuggestions:(unsigned long long)a0 progressBlock:(id /* block */)a1;
