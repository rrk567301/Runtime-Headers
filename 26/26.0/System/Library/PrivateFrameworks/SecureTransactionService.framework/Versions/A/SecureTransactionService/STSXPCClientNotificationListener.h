...
- (oneway void)connectionEstablishedWithSTSReaderCryptarch:(id)a0 sessionTranscriptBytes:(id)a1;
- (oneway void)dummyStart;
- (oneway void)iso18013DecryptedDeviceResponse:(id)a0 sessionDataStatus:(id)a1 mDocResponseStatus:(id)a2 error:(id)a3;
