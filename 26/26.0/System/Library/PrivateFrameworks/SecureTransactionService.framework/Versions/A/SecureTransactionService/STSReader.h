@class NSData, NFSecureElementReaderProxyListener, STSTimer, STSHelperLibrary, STSReaderCryptarch, STSXPCClientNotificationListener, STSCASessionStats, NFSession, NSObject, NFSecureElementManagerSession, STSHardwareManagerWrapper;
...
- (void)connectionEstablishedWithSTSReaderCryptarch:(id)a0 sessionTranscript:(id)a1;
