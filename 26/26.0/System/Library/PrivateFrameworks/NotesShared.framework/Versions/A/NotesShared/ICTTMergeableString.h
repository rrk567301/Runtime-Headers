...
@interface ICTTMergeableString : NSObject <ICCRDataType, NSCopying> {
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct TopoSubstring **__cap_; } _startNodes;
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct TopoSubstring **__cap_; } _endNodes;
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct TopoSubstring **__cap_; } _orderedSubstrings;
