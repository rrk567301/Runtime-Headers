...
@interface BU_TBackupView : NSView {
    ...
    struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct CGRect *__cap_; } fRestoreImageBounds;
    ...
    struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct CGRect *__cap_; } fScaledBounds;
...
- (struct TBackupLayerList { id *x0; id *x1; id *x2; })layersForTarget:(const void *)a0;
