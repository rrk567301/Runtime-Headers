@interface ContextualSuggestionClient.CarPlayWidgetSuggestionProvider : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ engagementStream;
    ...
    void /* unknown type, empty encoding */ carPlayIdentity;
