...
@interface ADJasperColorInfieldCalibrationFlow : ADFlow <ADFlowColorConsumer, ADFlowPointCloudConsumer> {
    ...
    struct { void /* unknown type, empty encoding */ columns[4]; } _lastExtrinsicsFromInput;
    struct { void /* unknown type, empty encoding */ columns[4]; } _currentExtrinsics;
    BOOL _isFirstFrame;
}
...
- (id)initWithExecutor:(id)a0 andIntersessionData:(id)a1 andExtrinsicsFlowMode:(long long)a2;
