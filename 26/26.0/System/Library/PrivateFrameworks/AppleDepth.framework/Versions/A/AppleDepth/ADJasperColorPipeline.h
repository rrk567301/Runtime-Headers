...
- (long long)fuseCurrentDepth:(struct __CVBuffer { } *)a0 previousDepth:(struct __CVBuffer { } *)a1 intoOutputDepth:(struct __CVBuffer { } *)a2 currentConfidence:(struct __CVBuffer { } *)a3 previousConfidence:(struct __CVBuffer { } *)a4 intoOutputConfidence:(struct __CVBuffer { } *)a5;
...
- (long long)warpPreviousDepth:(struct __CVBuffer { } *)a0 intoCurrentDepth:(struct __CVBuffer { } *)a1 previousConfidence:(struct __CVBuffer { } *)a2 intoCurrentConfidence:(struct __CVBuffer { } *)a3 usingPoseDelta:(struct { void /* unknown type, empty encoding */ x0[4]; })a4 previousCalibration:(id)a5 currentCalibration:(id)a6;
