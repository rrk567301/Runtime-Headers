@class NSString, TFDataAggregator, NSViewController, TFFeedbackDataContainer, NSURL, ASDBetaAppLaunchInfo;
@protocol TFFeedbackSubmissionService, TFFeedbackSessionDelegate;

@interface TFFeedbackSession : NSObject <TFDataAggregatorDelegate, TestFlightCore.FeedbackDelegate>
...
@property (weak, nonatomic) NSViewController *activeFormViewController;
...
- (void)feedbackWillSendFeedbackSubmissionWithFeedbackText:(id)a0 emailAddress:(id)a1 screenshotURLs:(id)a2;
