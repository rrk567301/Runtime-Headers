...
- (id)listBySettingNewAutocorrection:(id)a0;
...
- (id)listBySettingNewAlternateCorrections:(id)a0;
- (id)listBySettingNewEmojiList:(id)a0;
- (id)listBySettingNewPredictions:(id)a0;
