...
- (void)startQueryTaskWithSearchString:(id)a0 queryOptions:(long long)a1 sourceResult:(id)a2 triggerEvent:(unsigned long long)a3 languages:(id)a4 currentKeyboardLanguage:(id)a5 queryId:(unsigned long long)a6;
