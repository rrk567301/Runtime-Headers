...
@property (readonly, nonatomic) BOOL wantsLoadingView;
@property (readonly, nonatomic) BOOL allowsPresentationWithSendLater;
@property (readonly, nonatomic) BOOL isEnabled;
@property (readonly, nonatomic) BOOL shouldHideAppSwitcher;
@property (readonly, nonatomic) BOOL prefersNoLoadingBubbles;
...
- (void)removeDataSourceForChatItem:(id)a0;
