...
@property (nonatomic) BOOL continuityMicrophoneUsed;
@property (nonatomic) BOOL displayTranslationEnabled;
@property (nonatomic) BOOL displayTransliterationEnabled;
