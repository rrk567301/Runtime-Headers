...
@property (class, readonly, nonatomic) BOOL deviceSupportsTransitions;
@property (class, readonly, nonatomic) BOOL deviceSupportsSmartTransitions;
@property (class, readonly, nonatomic, getter=isSystemPodcasts) BOOL systemPodcasts;
@property (class, readonly, nonatomic, getter=isSystemMusic) BOOL systemMusic;
@property (class, readonly, nonatomic, getter=isRemotePlayerService) BOOL remotePlayerService;
@property (class, readonly, nonatomic) BOOL supportsVideoViewController;
...
@property (nonatomic) BOOL usesStopState;
...
- (void)beginScanningWithDirection:(long long)a0 supportsRateChange:(BOOL)a1 identifier:(NSString *)a2 completion:(void (^)(NSError *))a3;
...
- (void)didChangeTransitionSettings:(id)a0;
...
- (id)takeCriticalSectionAssertion:(id)a0;
