...
@interface SASExpressSettings : PBCodable <NSCopying> {
    struct { unsigned char appearanceMode : 1; unsigned char displayZoomOption : 1; unsigned char iPadMultitaskingMode : 1; unsigned char appAnalyticsOptIn : 1; unsigned char deviceAnalyticsOptIn : 1; unsigned char fileVaultEnabled : 1; unsigned char findMyOptIn : 1; unsigned char locationServicesOptIn : 1; unsigned char screenTimeEnabled : 1; unsigned char siriDataSharingOptIn : 1; unsigned char siriOptIn : 1; unsigned char siriVoiceTriggerEnabled : 1; unsigned char softwareUpdateAutoDownloadEnabled : 1; unsigned char softwareUpdateAutoUpdateEnabled : 1; unsigned char stolenDeviceProtectionEnabled : 1; unsigned char stolenDeviceProtectionStrictModeEnabled : 1; unsigned char unlockWithWatchEnabled : 1; } _has;
}
...
@property (nonatomic) BOOL hasIPadMultitaskingMode;
...
- (int)StringAsIPadMultitaskingMode:(id)a0;
- (id)appearanceModeAsString:(int)a0;
- (id)displayZoomOptionAsString:(int)a0;
- (id)iPadMultitaskingModeAsString:(int)a0;
