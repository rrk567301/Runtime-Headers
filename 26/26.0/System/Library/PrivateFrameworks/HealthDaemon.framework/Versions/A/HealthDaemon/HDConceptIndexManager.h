...
@interface HDConceptIndexManager : NSObject <HDDataObserver, HDDatabaseProtectedDataObserver, HDProfileReadyObserver, HDHealthRecordsAccountExistenceObserver, HDContentDatabaseAvailabilityObserver, HDOntologyContentShardImportObserver> {
