@class HDPeriodicCountryMonitor, HDSharedSummaryManager, HDDataManager, HDCloudSyncManager, HDCurrentActivitySummaryHelper, HDFitnessMachineManager, HDAppSubscriptionManager, HDDeviceManager, HDFeatureAvailabilityHealthDataRequirementEvaluationManager, HDDeviceKeyValueStoreManager, HDFeatureSettingsManager, HDDaemon, NSObject, HDDatabaseDailyAnalytics, HKSynchronousObserverSet, HDAWDSubmissionManager, HDTinkerPrivacyAlertCoordinator, HDAttachmentManager, NSMutableArray, HDSummarySharingEntryIDSManager, HDSourceManager, HDNanoSyncManager, HDWorkoutManager, HDUserDomainConceptManager, HDRestorableAlarmScheduler, HDSharingAuthorizationManager, HDDeviceContextStoreManager, HDConceptIndexManager, HDAssociationManager, HKFeatureAvailabilityRequirementEvaluationDataSource, HDUnitPreferencesManager, HDServiceConnectionManager, HDSourceOrderManager, HDHealthRecordsAccountExistenceNotifier, HDSyncIdentityManager, _HKExpiringCompletionTimer, HDKeyValueDomainManager, HDAuthorizationManager, HDNotificationManager, HDAgeGatingManager, HDDatabase, HDHealthServiceManager, HDAssertionManager, HDRapportMessenger, NSString, HDNotificationSyncManager, HDDaemonSyncEngine, HDMedicalIDDataManager, HKProfileIdentifier, HDMetadataManager, HDUserCharacteristicsManager, NSURL, HDWorkoutCondenser, NSDictionary, HKObserverSet, NSMutableSet, HDProtectedDataOperationScheduler, HDContributorManager, HDSummarySharingEntryManager, HDDataProvenanceManager, HDDataCollectionManager, HDOnboardingCompletionManager;
@protocol OS_dispatch_group, HDHealthDaemon, HDInternalContentDatabaseManager, HDSyncEngine, HDActivityCacheManagerInterface;
...
@interface HDProfile : NSObject <HKAnalyticsHealthDataSource, HKFeatureAvailabilityHealthDataSource, HDCloudSyncRepositoryProfile, HDHealthDaemonReadyObserver> {
    ...
    id<HDInternalContentDatabaseManager> _internalContentDatabaseManager;
...
@property (readonly, nonatomic) id<HDInternalContentDatabaseManager> internalContentDatabaseManager;
