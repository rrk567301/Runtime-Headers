@class NSUUID, NSString, NSLock, HDDataCollectionAssertion, NSSet, HDWorkoutUtilities, HKDataFlowLink, HDProfile, HKWorkoutConfiguration, HDClientDataCollectionObservationStateMonitor, HDHealthStoreClient, HDWorkoutSessionServer;
