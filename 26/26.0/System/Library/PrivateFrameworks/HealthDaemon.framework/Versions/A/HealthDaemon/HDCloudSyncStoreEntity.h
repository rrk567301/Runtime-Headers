...
+ (BOOL)cacheEpochs:(id)a0 storeIdentifier:(id)a1 database:(id)a2 error:(id *)a3;
+ (BOOL)resetLastSyncDateExcludingStores:(id)a0 profile:(id)a1 error:(id *)a2;
+ (id)cachedEpochsForStoreIdentifier:(id)a0 database:(id)a1 error:(id *)a2;
+ (BOOL)cacheExcludedSyncIdentities:(id)a0 storeIdentifier:(id)a1 profile:(id)a2 error:(id *)a3;
+ (id)cachedEpochsForStoreIdentifier:(id)a0 profile:(id)a1 error:(id *)a2;
+ (BOOL)cacheEpochs:(id)a0 storeIdentifier:(id)a1 profile:(id)a2 error:(id *)a3;
