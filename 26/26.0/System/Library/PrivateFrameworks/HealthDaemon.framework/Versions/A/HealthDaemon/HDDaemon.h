@class HDNotificationInstructionSyncService, HDBackgroundObservationServerExtensionManager, HDContentProtectionManager, HDAutoBugCaptureReporter, HDOTAFeatureAvailabilityManager, HDXPCAlarmScheduler, NSDictionary, NSMutableArray, HDXPCEventManager, _HKBehavior, HDMaintenanceWorkCoordinator, HDTaskServerRegistry, HDPostInstallUpdateManager, HDProfileManager, BGSystemTaskScheduler, NSURL, HDAnalyticsSubmissionCoordinator, HDDatabasePruningCoordinator, HDQueryManager, HDOntologyConfigurationProvider, HKWristDetectionSettingManager, HDPeriodicActivity, HDDevicePowerMonitor, HDWorkoutPluginDaemonExtension, HDCacheDeleteCoordinator, HDHealthAppNewDeviceNotificationService, NSString, HKFeatureAvailabilityRequirementSatisfactionOverridesDataSource, HDPrimaryProfile, HDUserDomainConceptEntityRegistry, HDProcessStateManager, NSObject, HDDaemonConnectionManager, NSHashTable, HDPluginManager, HKWatchLowPowerModeDataSource, HDCloudSyncCoordinator;
@protocol HDDaemonTester, HDNanoAlertSuppressionService, OS_dispatch_queue, HDPairedDeviceCapabilityProviding;
