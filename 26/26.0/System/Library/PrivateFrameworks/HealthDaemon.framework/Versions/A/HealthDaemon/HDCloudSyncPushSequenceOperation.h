@class HDCloudSyncTarget, NSString, HDCloudSyncSequenceRecord, HDCodableSyncEntityVersionMap, NSSet, NSObject, HDCloudSyncSessionContext, NSMutableArray, HDSynchronousTaskGroup, HDCloudSyncSequenceState;
