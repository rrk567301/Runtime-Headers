...
@property (readonly, nonatomic, getter=isWebElement) BOOL webElement;
...
@property (readonly, nonatomic) BOOL supportsAccessibilityIndexForUIElementInNavigationOrder;
...
+ (void)initialize;
+ (void)blockOffscreenElementsWithText:(id)a0;
...
- (unsigned long long)_indexOfUIElement:(id)a0 useNavigationOrder:(BOOL)a1;
...
- (void)addIfSupportedAXAttributes:(id)a0;
...
- (unsigned long long)indexOfUIElementUnsorted:(id)a0;
