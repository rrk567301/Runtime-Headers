...
- (id)init;
- (void).cxx_destruct;
- (void)addActivityBitmapForSnapshot:(id)a0;
- (void)addActivityWithFlowId:(unsigned long long)a0 interfaceType:(unsigned char)a1 xnuBitmap:(struct xnu_activity_bitmap { unsigned long long x0; unsigned long long x1[2]; } *)a2;
