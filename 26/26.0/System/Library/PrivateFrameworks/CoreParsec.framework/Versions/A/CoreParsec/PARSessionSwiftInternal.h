@class PARBag, SFImageContext, NSXPCConnection, NSError, PARSessionConfiguration, SFImage, _TtC10CoreParsec15PARSearchClient;
@protocol PARSessionDelegate;

@interface PARSessionSwiftInternal : NSObject <SFFeedbackListener, SFMoreResultsResourceLoader, SFCardResourceLoader, SFImageResourceLoader> {
    ...
    void /* unknown type, empty encoding */ _deviceContext;
