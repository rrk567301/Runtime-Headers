...
- (id)_allRegionsInContainer:(id)a0 intersectingRegion:(id)a1;
...
- (id)_closestFocusableItemToPoint:(struct CGPoint { double x0; double x1; })a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 itemFilter:(id /* block */)a2 distanceMeasuringUnitPoint:(struct CGPoint { double x0; double x1; })a3;
