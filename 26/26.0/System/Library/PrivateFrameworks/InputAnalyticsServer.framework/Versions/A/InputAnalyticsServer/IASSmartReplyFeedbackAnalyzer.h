...
- (void)cacheDetailsForPollPayload:(id)a0;
- (void)cacheDetailsForSmartActionsGeneratedPayload:(id)a0;
- (void)cacheDetectedModelLanguageForPayload:(id)a0;
...
- (id)serializeDictionaryToJSON:(id)a0;
