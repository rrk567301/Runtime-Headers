@interface GameStoreKit.ArcadeSubscriptionOfferButtonPresenter : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ currentSubscriptionState;
    void /* unknown type, empty encoding */ appStateMachine;
