...
+ (id)_drawSingleLineSecureHeaders:(id)a0 secureContents:(id)a1 layoutTraits:(id)a2 renderTraits:(id)a3 contexts:(struct __CFArray { } *)a4 availableWidth:(double)a5 truncationSentinel:(id)a6 abortInsteadOfTruncating:(BOOL)a7;
