@class NSError, NSString, NSSet, DMCEnrollmentFlowController, NSMutableDictionary, NSDictionary, CPProfile, NSObject, NSWindow, CPUI_ProgressWindowController;
...
- (id)getMachineInfoForEnrollmentType:(unsigned long long)a0 enrollmentMethod:(unsigned long long)a1 canRequestSoftwareUpdate:(BOOL)a2;
