...
- (id)blastDoorTimingMeasurementForItemIdentifier:(id)a0;
- (id)businessCallerFetchTimingMeasurementForItemIdentifier:(id)a0;
- (id)businessEmailFetchTimingMeasurementForItemIdentifier:(id)a0;
...
- (id)pirFetchTimingMeasurementForItemIdentifier:(id)a0;
...
- (id)webPresentmentFetchTimingMeasurementForItemIdentifier:(id)a0;
