@class BCSLinkItemPersistentStore, BCSWebPresentmentPersistentStore, BCSBusinessCallerPersistentStore, BCSBusinessItemMemoryCache, BCSBusinessEmailPersistentStore, NSString;
...
@property (retain, nonatomic) BCSBusinessCallerPersistentStore *businessCallerStore;
@property (retain, nonatomic) BCSBusinessEmailPersistentStore *businessEmailStore;
@property (retain, nonatomic) BCSWebPresentmentPersistentStore *webPresentmentStore;
