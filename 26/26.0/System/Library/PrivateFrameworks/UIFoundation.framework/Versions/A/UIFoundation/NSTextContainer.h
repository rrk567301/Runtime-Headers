...
- (void)_appendTemporaryExclusionPathsForRects_iOS:(id)a0;
- (void)_appendTemporaryExclusionPathsForRects_macOS:(id)a0;
...
- (void)setExclusionPaths:(id)a0 temporarily:(BOOL)a1;
