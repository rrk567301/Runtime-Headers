@class NSGlyphGenerator, NSTextStorage, NSTextContainer, NSSortedArray, NSMutableArray, NSStorage, NSFont, CUIStyleEffectConfiguration, NSTypesetter, NSParagraphArbitrator, NSRunStorage, NSArray, NSTextView;
