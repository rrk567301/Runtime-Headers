...
- (void)fpanCredentialForPrimaryAccountIdentifier:(id)a0 passUniqueID:(id)a1 completion:(id /* block */)a2;
- (void)fpanDescriptorAndCredentialForFPAN:(id)a0 completion:(id /* block */)a1;
...
- (void)identityPassesOfTypes:(id)a0 completion:(id /* block */)a1;
...
- (void)passesOfCardType:(long long)a0 completion:(id /* block */)a1;
- (void)passesOfType:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)passesWithPrimaryPaymentApplicationStates:(id)a0 completion:(id /* block */)a1;
