...
- (id)initWithReceiptServiceIdentifier:(id)a0 receiptIdentifier:(id)a1 altDSID:(id)a2 featureIdentifier:(unsigned long long)a3;
- (id)initWithReceiptServiceIdentifier:(id)a0 receiptIdentifier:(id)a1 cardNumberSuffix:(id)a2 featureIdentifier:(unsigned long long)a3;
