...
+ (void)_sendAuthorizedQuoteAnalyticsWithSuccess:(BOOL)a0 mode:(unsigned long long)a1 authorizedQuote:(id)a2 status:(long long)a3;
...
- (BOOL)_isValidResponse:(id)a0;
- (BOOL)_modeIsSendType:(unsigned long long)a0;
- (BOOL)_modeSupportsExternalFundingSource:(unsigned long long)a0;
...
- (void)_prepareRecipientForCache:(id)a0 conversationAddress:(id)a1;
...
- (void)authorizeQuote:(id)a0 performOnAuthorization:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)identifyRecipientWithConversationAddress:(id)a0 senderAddress:(id)a1 completion:(id /* block */)a2;
...
- (void)identifyRecipientsWithConversationAddresses:(id)a0 senderAddress:(id)a1 completion:(id /* block */)a2;
...
- (void)selectIdentifiedRecipient:(id)a0;
