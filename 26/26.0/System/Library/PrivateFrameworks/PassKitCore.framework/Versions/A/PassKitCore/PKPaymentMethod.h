@class PKPaymentPass, NSString, PKAppletSubcredential, CNContact, PKRemotePaymentInstrument, PKSecureElementPass, PKBankAccountInformation;
...
- (id)initWithPaymentPass:(id)a0 paymentApplication:(id)a1 subCredential:(id)a2 obfuscateNetworks:(BOOL)a3;
