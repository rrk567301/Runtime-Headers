@class NSDecimalNumber, NSSet, NSArray, NSString, PKMerchant, NSDate;
...
@property (retain, nonatomic) NSArray *excludedAccountStates;
@property (retain, nonatomic) NSArray *excludedPeerPaymentAccountStates;
