@class NSDictionary, PKSeatingInformation, PKLocation, PKPassFrontFaceImageSet, PKPassUpcomingPassInformation, NSString, PKNFCPayload, PKPassPersonalization, PKPaymentPass, PKPassDisplayProfile, NSArray, PKBarcode, PKPassLiveRenderedArmedStateImageSet, NSSet, NSData, PKColor, PKPassBarcodeSettings, PKPassLiveRenderedImageSet, PKSecureElementPass, PKLiveRenderedShaderSet, NSURL, NSDate, NSNumber, PKImage;
...
- (id)_changeMessageForDictionariesSemantic:(id)a0 newSemantic:(id)a1 passStyle:(long long)a2;
- (id)_changeMessageForEventDateInfoSemantic:(id)a0 newSemantic:(id)a1;
- (id)_changeMessageForFieldKey:(id)a0;
- (id)_changeMessageForPersonNameComponentsSemantic:(id)a0 newSemantic:(id)a1;
- (id)_changeMessageForSemantic:(id)a0 newSemantic:(id)a1 passStyle:(long long)a2;
- (id)_changeMessageForStringSemantic:(id)a0 newSemantic:(id)a1;
