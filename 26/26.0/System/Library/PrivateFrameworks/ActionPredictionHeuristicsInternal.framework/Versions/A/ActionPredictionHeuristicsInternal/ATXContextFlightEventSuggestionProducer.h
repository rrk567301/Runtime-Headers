...
- (id)initWithTitle:(id)a0 flightInformationSchema:(id)a1 urlString:(id)a2 teamIdentifier:(id)a3 validFromStartDate:(id)a4 validToEndDate:(id)a5 alternateDestinationTitle:(id)a6 dateInterval:(id)a7;
- (id)sfSearchResult:(id)a0 title:(id)a1 subtitle:(id)a2 type:(int)a3 sectionHeader:(id)a4 score:(double)a5;
- (id)suggestionForAirplaneModeWithPredictionReasons:(unsigned long long)a0 score:(double)a1;
