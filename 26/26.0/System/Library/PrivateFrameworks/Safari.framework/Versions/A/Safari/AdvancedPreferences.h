@class NSTextField, NSMenuItem, NSView, NSString, NSGridRow, NSGridView, NSPopUpButton, EnableDevelopMenuButtonHostViewController, WKWebpagePreferences, NSLayoutConstraint, NSButton, NSComboBox;
...
@property (weak, nonatomic) NSGridRow *pressTabToHighlightSubtextRow;
...
@property (weak, nonatomic) NSLayoutConstraint *minFontSizeComboBoxWidthConstraint;
