...
+ (id)bookmarksSortedByAddressForBookmarks:(id)a0;
+ (id)bookmarksSortedByNameForBookmarks:(id)a0;
...
- (BOOL)_insertBookmark:(id)a0 atIndex:(unsigned long long)a1 inBookmarkFolder:(id)a2 allowDuplicateURLs:(BOOL)a3 insertedBookmarks:(id *)a4;
- (BOOL)_insertBookmarks:(id)a0 startingAtIndex:(unsigned long long)a1 inBookmarkFolder:(id)a2 insertedBookmarks:(id *)a3;
...
- (BOOL)_moveBookmarks:(id)a0 to:(id)a1 startingIndex:(unsigned long long)a2 insertedBookmarks:(id *)a3;
...
- (id)addBookmark:(id)a0 inBookmarkFolder:(id)a1;
