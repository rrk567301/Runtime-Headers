...
@interface Safari.CompletionListPegasusSuggestionData : NSObject <CompletionListItemData> {
    void /* function */ title;
    ...
    void /* unknown type, empty encoding */ pegasusResult;
}
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithPegasusResult:(id)a0;
