@class NSButton, NSMenu, NSMutableArray, BookmarksOutlineView, NSSearchField, NSString, SidebarScrollView, SafariWebBookmarkList, NSArray, NSView, _TtC6Safari42BookmarksSidebarTableRecentlySavedCarousel, WBSFaviconRequestsController, BookmarksSearcher;
@protocol BookmarksSidebarViewControllerDelegate;

@interface BookmarksSidebarViewController : NSViewController <SidebarSearchFieldDelegate, SidebarScrollViewAccessibilityDelegate, AnnotatedBookmarksSidebarExpandedTableCellViewDelegate, BookmarksTableCellViewDelegate, Safari.BookmarksSidebarTableCarouselViewDelegate, SidebarContentViewController, NSMenuDelegate, NSOutlineViewDataSource, BookmarksOutlineViewDelegate, BookmarksSidebarTableCellViewDelegate, CustomKeyViewLoop, SidebarContentFilterDelegate, SidebarContentFiltering, SidebarSearchFieldViewDelegate> {
    ...
    BOOL _bookmarkEditingInProgress;
...
@property (readonly, nonatomic) BOOL isShowingTopLevelBookmark;
...
- (long long)_additionalTopLevelChildren;
- (id)_allBookmarkRows;
...
- (id)_compactCellViewForBookmark:(id)a0;
...
- (id)_largeCellViewForFolder:(id)a0;
