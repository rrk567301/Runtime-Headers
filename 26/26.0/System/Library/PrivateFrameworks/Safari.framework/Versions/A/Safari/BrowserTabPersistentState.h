@class NSData, NSString, NSArray, NSURL, NSUUID, NSDate, NSDictionary, BrowserViewController, WBTab, WBLocalTabAttributes;
...
- (BOOL)_canAccessPersistedSessionStateData;
- (id)_deserializeCookieData:(id)a0;
- (id)_dictionaryRepresentationIncludingSessionState:(BOOL)a0 forCleanExit:(BOOL)a1 includingSessionStateDataUUIDs:(BOOL)a2;
