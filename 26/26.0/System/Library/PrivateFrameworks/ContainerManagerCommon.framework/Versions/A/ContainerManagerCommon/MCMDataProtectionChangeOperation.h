...
+ (id)dataProtectionChangeOperationWithContainerMetadata:(id)a0 settingClass:(int)a1 retryingIfLocked:(BOOL)a2 changeType:(unsigned long long)a3 queue:(id)a4;

- (void).cxx_destruct;
- (BOOL)_runChangeOperationNeedToRetry:(BOOL *)a0 error:(id *)a1;
- (id)initWithContainerMetadata:(id)a0 newClass:(int)a1 retryingIfLocked:(BOOL)a2 changeType:(unsigned long long)a3 internalChangeID:(id)a4 queue:(id)a5 userIdentityCache:(id)a6;
- (id)initWithContainerMetadata:(id)a0 newClass:(int)a1 retryingIfLocked:(BOOL)a2 changeType:(unsigned long long)a3 queue:(id)a4 userIdentityCache:(id)a5;
