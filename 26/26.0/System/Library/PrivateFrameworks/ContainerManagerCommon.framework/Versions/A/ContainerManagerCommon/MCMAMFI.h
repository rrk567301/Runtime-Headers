...
- (id)_encodeRequirement:(id)a0 name:(id)a1 reason:(unsigned long long)a2;
...
- (Class)lwcrClass;
- (unsigned long long)signaturePassesStrictScrutinyForAppGroupEntitlementWithContainerConfig:(id)a0 teamID:(id)a1;
