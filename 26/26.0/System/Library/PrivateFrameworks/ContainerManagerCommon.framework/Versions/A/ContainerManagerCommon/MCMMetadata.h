...
- (id)_modifiedDictBySettingValue:(id)a0 forKey:(id)a1 onInfo:(id)a2;
...
- (void).cxx_destruct;
- (id)_migrateContainerURL:(id)a0 containerClass:(unsigned long long)a1 userIdentity:(id)a2 userIdentityCache:(id)a3 error:(id *)a4;
