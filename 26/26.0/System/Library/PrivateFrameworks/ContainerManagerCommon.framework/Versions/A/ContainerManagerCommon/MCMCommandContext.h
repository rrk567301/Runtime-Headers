...
@protocol MCMGlobalConfiguration, MCMClientFactory, MCMContainerFactory, MCMContainerCache, MCMContainerClassUserIdentityIterator;
...
- (void).cxx_destruct;
- (id)initWithClientIdentity:(id)a0 containerCache:(id)a1 containerFactory:(id)a2 userIdentityCache:(id)a3 clientFactory:(id)a4 kernelPersonaID:(unsigned int)a5 globalConfiguration:(id)a6;
- (id)initWithClientIdentity:(id)a0 containerCache:(id)a1 containerFactory:(id)a2 userIdentityCache:(id)a3 clientFactory:(id)a4 kernelPersonaID:(unsigned int)a5 globalConfiguration:(id)a6 classIterator:(id)a7;
