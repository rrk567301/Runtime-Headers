...
@interface OFBackwarp : NSObject {
    ...
    id<MTLComputePipelineState> _padTexture2CTO2CKernel;
...
- (void)copyTextureWithPaddingSource:(id)a0 destination:(id)a1 callback:(id /* block */)a2;
...
- (void)encodeUpscaleFlowToCommandBuffer:(id)a0 source:(id)a1 destination:(id)a2 scaleFactor:(float)a3 rotation:(BOOL)a4;
...
- (void)upscaleFlow:(id)a0 destination:(id)a1 callback:(id /* block */)a2;
