...
- (BOOL)encodeWarpBlendToCommandBuffer:(id)a0 source:(id)a1 scaleFactor:(unsigned long long)a2 withLowResFlow:(id)a3 withBicubicUpscaled:(id)a4 withErrorMask:(id)a5 destination:(id)a6;
- (void)encodeWarpErrorToCommandBuffer:(id)a0 source:(id)a1 reference:(id)a2 flow:(id)a3 error:(id)a4;
- (BOOL)setupKernels;
- (BOOL)warpBlendBufferRGBTexture:(id)a0 scaleFactor:(unsigned long long)a1 withLowResFlowTexture:(id)a2 withBicubicUpscaledTexture:(id)a3 withErrorMaskTexture:(id)a4 toHighResBufferTexture:(id)a5;
