...
+ (unsigned long long)appDirectoryCategoryForLSApplicationCategoryType:(id)a0;
...
+ (unsigned long long)appDirectoryCategoryFromPropertyListOfAppWithIdentifier:(id)a0;
...
- (id)initWithCategoryID:(unsigned long long)a0 appIdentitites:(id)a1 localizedName:(id)a2;
- (void)updateCategoryLocalizedNameWithName:(id)a0;
- (id)initWithCategoryID:(unsigned long long)a0 appIdentities:(id)a1;
