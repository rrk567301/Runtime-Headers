@class BlastDoorAudioMessage, NSString, BlastDoorTypingIndicator, BlastDoorTapBack, BlastDoorEmojiTapBack, BlastDoorCustomAcknowledgement, BlastDoorMessage, BlastDoorStickerTapBack, BlastDoorSticker, BlastDoorBalloonPlugin;
