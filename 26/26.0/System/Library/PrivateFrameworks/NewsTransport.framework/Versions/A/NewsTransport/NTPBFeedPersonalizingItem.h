...
@interface NTPBFeedPersonalizingItem : PBCodable <NSCopying> {
    struct { unsigned char bodyTextLength : 1; unsigned char lastModifiedDateMilliseconds : 1; unsigned char publishDateMilliseconds : 1; unsigned char hasAudioTrack : 1; unsigned char hasVideo : 1; unsigned char isAIGenerated : 1; unsigned char isANF : 1; unsigned char isBundlePaid : 1; unsigned char isFeatured : 1; unsigned char isPaid : 1; } _has;
}
...
@property (nonatomic) BOOL hasLastModifiedDateMilliseconds;
