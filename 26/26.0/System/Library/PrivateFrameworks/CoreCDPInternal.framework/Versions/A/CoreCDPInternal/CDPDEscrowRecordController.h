...
- (void)_deviceCircleStatusUsingCache:(BOOL)a0 completion:(id /* block */)a1;
...
- (void)_reauthenticateAndPerformEscrowCheckWithIsBackground:(BOOL)a0 completion:(id /* block */)a1;
