@class NSString, MusicKit_SoftLinking_MPCPlaybackIntent, MPCPlaybackEngine;
...
@property (retain, nonatomic, getter=fallbackPlaybackIntent, setter=musicKit_setFallbackPlaybackIntent:) MusicKit_SoftLinking_MPCPlaybackIntent *fallbackPlaybackIntent;
