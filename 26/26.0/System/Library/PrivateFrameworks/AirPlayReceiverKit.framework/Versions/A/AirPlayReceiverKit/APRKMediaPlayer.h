@class NSMutableDictionary, APRKMetadata, AVPlayerInterstitialEventController, NSDictionary, NSObject, APRKResourceLoaderHelper, APRKContentKeyHelper, NSString, AVPlayerItem, AVPlayerPlaybackCoordinator, AVQueuePlayer, NSArray, NSUUID;
...
- (void).cxx_destruct;
- (void)integratedTimeline:(id)a0 didRequestSeekToTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 seekID:(int)a2 toleranceBefore:(struct { long long x0; int x1; unsigned int x2; long long x3; })a3 toleranceAfter:(struct { long long x0; int x1; unsigned int x2; long long x3; })a4;
...
- (void)_ensureInterstitialPlayerFor:(int)a0;
...
- (void)_handleCurrentEventSkippedNotification:(id)a0;
- (void)_handleCurrentItemChangedNotification:(id)a0;
- (void)_handleCurrentItemFailedToPlayToEndNotification:(id)a0;
...
- (void)_processPlaybackCoordinationMediumWithDictionary:(id)a0;
...
- (id)initWithP2PWiFiSupport:(BOOL)a0 isInterstitialPlayer:(BOOL)a1 playerSessionID:(int)a2;
- (void)processMessageWithIDAndDictionaryAsync:(id)a0 messageSessionID:(int)a1;
- (id)processMessageWithIDAndDictionarySync:(id)a0 messageSessionID:(int)a1;
...
- (void)setCompleteIntegratedTimelineSeekBlock:(id /* block */)a0;
- (void)setCurrentInterstitialEventID:(id)a0;
- (void)setInterstitialEventControllerForInterstitialPlayer:(id)a0;
- (void)setPendingIntegratedTimelineSeekID:(int)a0;
...
- (BOOL)shouldDelegateToInterstitialPlayerForMessageAndID:(id)a0 sessionID:(int)a1;
