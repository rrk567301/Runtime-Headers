...
- (void)setDepthStencilState:(id)a0 atIndex:(unsigned long long)a1;
- (void)setDepthStencilStates:(const id *)a0 withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
