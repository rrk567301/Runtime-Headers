...
- (id)initWithArea:(struct PFIntRect_st { struct PFIntPoint_st { long long x0; long long x1; } x0; struct PFIntSize_st { unsigned long long x0; unsigned long long x1; } x1; })a0 destFormat:(int)a1 destPtr:(void *)a2 rowBytes:(long long)a3;
