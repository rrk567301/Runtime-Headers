...
@interface PA2DBufferLazySourceBacking : NSObject <PA2DPurgeableBufferBacking> {
    struct vector<PFIntRect_st, std::allocator<PFIntRect_st>> { struct PFIntRect_st *__begin_; struct PFIntRect_st *__end_; struct PFIntRect_st *__cap_; } _tileList;
    struct vector<bool, std::allocator<bool>> { unsigned long long *__begin_; unsigned long long __size_; unsigned long long __cap_; } _localTileState;
