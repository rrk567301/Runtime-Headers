...
- (BOOL)changeBootstrapUserTokenFromOldToken:(id)a0 toNewToken:(id)a1 withError:(id *)a2;
- (BOOL)changeBootstrapUserTokenFromOldTokenInACMCredential:(id)a0 toNewTokenInACMCredential:(id)a1 withError:(id *)a2;
- (BOOL)checkBootstrapUserExistsWithError:(id *)a0;
- (BOOL)createBootstrapUserWithToken:(id)a0 withDevicePasscode:(id)a1 withError:(id *)a2;
- (BOOL)createBootstrapUserWithTokenInACMCredential:(id)a0 withDevicePasscodeInACMCredential:(id)a1 withError:(id *)a2;
...
- (BOOL)deleteBootstrapUserWithToken:(id)a0 withDevicePasscode:(id)a1 withError:(id *)a2;
- (BOOL)deleteBootstrapUserWithTokenInACMCredential:(id)a0 withDevicePasscodeInACMCredential:(id)a1 withError:(id *)a2;
...
- (BOOL)validateBootstrapUserWithToken:(id)a0 withError:(id *)a1;
- (BOOL)validateBootstrapUserWithTokenInACMCredential:(id)a0 withError:(id *)a1;
