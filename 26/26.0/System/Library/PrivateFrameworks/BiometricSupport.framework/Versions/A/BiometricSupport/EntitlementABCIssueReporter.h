...
- (void)reportGraylistedClient:(id)a0 withProcessName:(id)a1 clientUUID:(id)a2 platform:(id)a3;
- (void)reportLegacyClient:(id)a0 withProcessName:(id)a1 clientUUID:(id)a2 platform:(id)a3;
- (void)reportMissingPermission:(int)a0 forClientName:(id)a1 processName:(id)a2 clientUUID:(id)a3 platform:(id)a4;
