...
- (void)requestNowPlayingItemMetadataWithCompletion:(id /* block */)a0;
...
- (void)requestProxiableSupportedCommandsWithCompletion:(id /* block */)a0;
...
- (void)requestSupportedCommandsWithCompletion:(id /* block */)a0;
