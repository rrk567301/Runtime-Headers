@class NSError, NSString, NSArray, MRExternalOutputContextDataSource, NSMutableDictionary, MRSupportedProtocolMessages, MRGroupSessionToken, MRDeviceInfo, MROrigin;
