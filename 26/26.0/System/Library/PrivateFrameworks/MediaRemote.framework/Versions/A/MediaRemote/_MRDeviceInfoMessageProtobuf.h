...
@property (readonly, nonatomic) BOOL hasLeaderDeviceInfo;
...
@property (readonly, nonatomic) BOOL hasActiveSystemEndpointUID;
...
@property (nonatomic) BOOL hasParentGroupSupportsGroupCohesion;
@property (nonatomic) BOOL parentGroupSupportsGroupCohesion;
