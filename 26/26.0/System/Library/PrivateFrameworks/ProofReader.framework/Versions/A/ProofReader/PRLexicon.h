...
+ (id)lexiconWithLocalization:(id)a0 unigramsPath:(id)a1 cachedOnly:(BOOL)a2;
+ (id)lexiconWithLocalization:(id)a0 unigramsPath:(id)a1 deltaPath:(id)a2 cachedOnly:(BOOL)a3;
...
- (id)initWithLocalization:(id)a0 unigramsPath:(id)a1 cachedOnly:(BOOL)a2;
- (id)initWithLocalization:(id)a0 unigramsPath:(id)a1 deltaPath:(id)a2 cachedOnly:(BOOL)a3;
