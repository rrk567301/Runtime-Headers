@class NSError, NSString, NSArray, GDPersonEntityTagDirectFeedbackSet, GDScoreRankedEntityTagPersonsInner, GDPersonEntityTaggingStatefulFeedback, NSDictionary, GDScoreRankedPersonEntityTagsInner, GDPersonEntityTaggingOptionsInner;
...
- (void)peopleEntityTagsFor:(NSArray *)a0 options:(GDPersonEntityTaggingOptionsInner *)a1 completionHandler:(void (^)(NSDictionary *, NSError *))a2;
- (void)personEntitiesFor:(NSArray *)a0 options:(GDPersonEntityTaggingOptionsInner *)a1 completionHandler:(void (^)(NSDictionary *, NSError *))a2;
