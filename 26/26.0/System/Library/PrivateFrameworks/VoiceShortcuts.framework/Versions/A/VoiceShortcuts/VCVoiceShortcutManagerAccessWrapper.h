@class VCVoiceShortcutManager, WFShareSheetWorkflowProvider, WFWorkflowRunCoordinator, WFSandboxExtensionManager, VCAccessSpecifier, NSString, WFTriggerRegistrar;
...
- (void)requestSandboxExtensionForToolKitIndexingWithCompletion:(id /* block */)a0;
...
- (void)getConfiguredTriggerForTriggerID:(id)a0 completion:(id /* block */)a1;
...
- (id)initWithVoiceShortcutManager:(id)a0 triggerRegistrar:(id)a1 accessSpecifier:(id)a2 syncDataEndpoint:(id)a3 runCoordinator:(id)a4 auditToken:(struct { unsigned int x0[8]; })a5;
- (BOOL)isLNActionExecutionAllowedInDropletWithBundleIdentifier:(id)a0 actionIdentifier:(id)a1;
...
- (void)saveOutputActionSmartPromtDataForWorkflowReference:(id)a0 completion:(id /* block */)a1;
...
- (id)unsupportedRequestErrorWithMessage:(id)a0;
