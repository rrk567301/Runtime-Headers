...
- (void)postActionRequiredNotificationForTrigger:(id)a0 notificationType:(unsigned long long)a1 workflowReference:(id)a2 pendingTriggerEventIDs:(id)a3;
...
- (void)postNotificationThatTrigger:(id)a0 failedWithError:(id)a1 notificationRequestIdentifier:(id)a2;
