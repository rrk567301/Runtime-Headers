...
- (id)init;
- (void).cxx_destruct;
- (void)_analyzeSegmentationResult:(id)a0 forStroke:(id)a1 treatStrokeAsFilledCircle:(BOOL)a2 maskContext:(id)a3 compositionController:(id)a4 geometry:(id)a5 usingTargetPoints:(BOOL)a6 completion:(id /* block */)a7;
- (void)_analyzeStrokeMaskIntersections:(id)a0 treatStrokeAsFilledCircle:(BOOL)a1 usingMaskContext:(id)a2 useTargetPoints:(BOOL)a3 compositionController:(id)a4 geometry:(id)a5 completion:(id /* block */)a6;
...
- (void)analyzeStrokeMaskIntersections:(id)a0 inpaintMaskContext:(id)a1 compositionController:(id)a2 geometry:(id)a3 imageToScreenSpaceScale:(double)a4 faceRects:(id)a5 completion:(id /* block */)a6;
