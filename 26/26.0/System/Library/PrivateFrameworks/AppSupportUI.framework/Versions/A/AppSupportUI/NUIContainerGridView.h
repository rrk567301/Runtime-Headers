...
@interface NUIContainerGridView : NUIContainerView <_NUIGridArrangementContainer> {
    ...
    struct _NUIGridArrangement { id<_NUIGridArrangementContainer> container; unsigned char horzDist : 8; unsigned char vertDist : 8; BOOL baselineRelative; BOOL hasValidMeasurement; struct vector<_NUIGridArrangementCell, std::allocator<_NUIGridArrangementCell>> { struct _NUIGridArrangementCell *__begin_; struct _NUIGridArrangementCell *__end_; struct _NUIGridArrangementCell *__cap_; } cells; struct vector<_NUIGridArrangementDimension, std::allocator<_NUIGridArrangementDimension>> { struct _NUIGridArrangementDimension *__begin_; struct _NUIGridArrangementDimension *__end_; struct _NUIGridArrangementDimension *__cap_; } columns; struct vector<_NUIGridArrangementDimension, std::allocator<_NUIGridArrangementDimension>> { struct _NUIGridArrangementDimension *__begin_; struct _NUIGridArrangementDimension *__end_; struct _NUIGridArrangementDimension *__cap_; } rows; struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct CGRect *__cap_; } viewFrames; } _arrangement;
    struct { unsigned short width; unsigned short height; } _visibleCount;
    struct map<NSView *, const std::pair<_NSRange, _NSRange>, std::less<NSView *>, std::allocator<std::pair<NSView *const, const std::pair<_NSRange, _NSRange>>>> { struct __tree<std::__value_type<NSView *, const std::pair<_NSRange, _NSRange>>, std::__map_value_compare<NSView *, std::__value_type<NSView *, const std::pair<_NSRange, _NSRange>>, std::less<NSView *>>, std::allocator<std::__value_type<NSView *, const std::pair<_NSRange, _NSRange>>>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } _viewRanges;
