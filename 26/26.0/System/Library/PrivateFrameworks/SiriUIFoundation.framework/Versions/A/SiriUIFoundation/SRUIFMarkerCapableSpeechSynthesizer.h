@class OS_dispatch_queue, SRUIFSpeechSynthesizer;
...
@property (nonatomic, weak) void /* function */ clientStateManagerDelegate;
...
- (void)speechSynthesisRequestsForceAudioSessionActiveWithCompletion:(id /* block */)a0;
