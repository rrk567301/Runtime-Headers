...
- (void)generatePosterConfigFromSource:(id)a0 destination:(id)a1 senderContext:(id)a2 completionBlock:(id /* block */)a3 blockUntilReply:(BOOL)a4;
- (void)generateReadOnlyPosterConfig:(id)a0 completionBlock:(id /* block */)a1;
