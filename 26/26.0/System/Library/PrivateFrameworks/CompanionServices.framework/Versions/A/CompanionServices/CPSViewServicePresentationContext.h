@class NSData, NSString, AMSDelegatePurchaseRequest, CPSSystemAuthenticationRequest, CPSRestrictedAccessRequest, CPSTVProviderRequest, NSDictionary, PKPaymentRequest, ACAccount, CPSAmbientSetupRequest, CPSStoreAuthenticationRequest;
...
@property (retain, nonatomic) CPSAmbientSetupRequest *ambientSetupRequest;
