...
@interface EMTTranslator : NSObject {
    ...
    struct vector<quasar::SystemConfig, std::allocator<quasar::SystemConfig>> { struct SystemConfig *__begin_; struct SystemConfig *__end_; struct SystemConfig *__cap_; } _configs;
...
- (void)_dispatchTranslationRequest:(struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; void *x2; })a0 isFinal:(BOOL)a1 spans:(id)a2 translator:(struct shared_ptr<quasar::Translator> { struct Translator *x0; struct __shared_weak_count *x1; })a3 sourceLocale:(id)a4 targetLocale:(id)a5 options:(id)a6 completion:(id /* block */)a7;
- (struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; void *x2; })_tokenizeString:(id)a0;
