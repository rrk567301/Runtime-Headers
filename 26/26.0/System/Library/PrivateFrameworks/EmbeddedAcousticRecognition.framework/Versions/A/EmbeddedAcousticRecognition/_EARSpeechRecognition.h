...
- (void).cxx_destruct;
- (id)oneBest;
- (id)_initWithNBestList:(const void *)a0 useHatText:(BOOL)a1 endsOfSentencePunctuations:(id)a2 formattingInfo:(const void *)a3;
...
- (struct pair<std::vector<std::vector<unsigned int>>, std::vector<std::vector<std::vector<quasar::Token>>>> { struct vector<std::vector<unsigned int>, std::allocator<std::vector<unsigned int>>> { void *x0; void *x1; void *x2; } x0; struct vector<std::vector<std::vector<quasar::Token>>, std::allocator<std::vector<std::vector<quasar::Token>>>> { void *x0; void *x1; void *x2; } x1; })_tokenPhraseChoiceList;
