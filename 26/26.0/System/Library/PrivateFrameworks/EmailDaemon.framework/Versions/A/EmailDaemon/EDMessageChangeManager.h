...
@protocol OS_os_log, EDMessageChangeHookResponder, OS_dispatch_queue, EFCancelable;
...
- (void)_addLogMassDeletion:(unsigned long long)a0;
...
- (void)_generateFakeSummariesIfNeededForMessages:(id)a0 flagChange:(id)a1;
