@class EMCoreAnalyticsCollector, NSString, EFStoppableScheduler, NSDate, CSSearchableIndex, EDSearchableIndexState, NSSet, NSObject, EFFuture, EFManualCancelationToken, EFObservable;
