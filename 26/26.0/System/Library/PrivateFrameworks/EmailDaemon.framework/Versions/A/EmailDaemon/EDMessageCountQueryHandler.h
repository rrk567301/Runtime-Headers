@class NSMutableDictionary, EFDebouncer, NSPredicate, EFStoppableScheduler, NSObject, EDMessagePersistence, EFMutableInt64Set, EDMessageQueryEvaluator, EMMailboxScope, EDUpdateThrottler, NSString, EDPersistenceHookRegistry, NSTimer, NSMutableSet, EFListStateCapturer, EMQuery, EMObjectID, EFManualCancelationToken;
