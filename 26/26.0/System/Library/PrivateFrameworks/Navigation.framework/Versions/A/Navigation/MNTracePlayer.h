@class NSString, MNTracePlayerTimelineStream, MNTrace, GEOObserverHashTable, MNLocation, MNTracePlayerScheduler, MNTracePlayerETAUpdateRequester, NSMutableArray;
