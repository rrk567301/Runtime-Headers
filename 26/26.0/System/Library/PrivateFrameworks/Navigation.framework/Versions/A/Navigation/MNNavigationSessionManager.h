@class NSString, MNNavigationProxyUpdater, MNNavigationSession, MNSimulationLocationProvider, MNNavigationTraceManager, GEOApplicationAuditToken, MNSessionUpdateManager, MNRouteManager;
