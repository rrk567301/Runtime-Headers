@class MNArrivalInfo, MNNavigationSession, GEOApplicationAuditToken, NSString, MNNavigationSessionState, MNLocation;
...
- (void)_updateArrivalInfo:(id)a0 previousState:(long long)a1;
...
- (void)updateForETAUpdateResponse:(id)a0;
