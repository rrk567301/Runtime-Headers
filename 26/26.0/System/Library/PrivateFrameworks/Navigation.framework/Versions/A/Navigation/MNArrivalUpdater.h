@class _MNArrivalUpdaterState, NSString, GEOObserverHashTable, GEOComposedRoute, GEOComposedRouteLeg, _MNArrivalUpdaterDetails, NSMutableArray, MNEVChargingStateMonitor, MNParkedVehicleDetector, MNNavigationSessionState;
