...
@interface ConversationKit.ConversationController : NSObject <AVCRemoteVideoClientDelegate, TUMomentsControllerDelegate, TUAudioFrequencyControllerDelegate> {
    ...
    void /* unknown type, empty encoding */ pendingNoticeWaitingForRemoteScreenShareAttributes;
    void /* unknown type, empty encoding */ pendingNoticeWaitingForSharePlayTelephonyCallUpdate;
    ...
    void /* unknown type, empty encoding */ localFullBleedVideoOrientation;
    ...
    void /* unknown type, empty encoding */ shouldShowLastFrameDuringUPlusOneHandoff;
    void /* unknown type, empty encoding */ waitForModeSwitchDuringUPlusOneHandoff;
    ...
    void /* unknown type, empty encoding */ cameraBackgroundReplacementEnabledDidChange;
    ...
    void /* unknown type, empty encoding */ cameraOrientationUpdateDidGetSnapshot;
    ...
    void /* unknown type, empty encoding */ screenSharingRequestsChanged;
    void /* unknown type, empty encoding */ audioPausedDidChange;
    void /* unknown type, empty encoding */ bluetoothAudioFormatChanged;
    void /* unknown type, empty encoding */ callConversationChanged;
    void /* unknown type, empty encoding */ didUpdateLocalParticipant;
    void /* unknown type, empty encoding */ didUpdateSensitivityAnalysis;
    ...
    void /* unknown type, empty encoding */ conversationVisibleRemoteParticipantCountDidChange;
    ...
    void /* unknown type, empty encoding */ secondaryPillStateChanged;
    ...
    void /* unknown type, empty encoding */ callSharePlayCapabilityDidChange;
    void /* unknown type, empty encoding */ callAnyRemoteSupportsRequestToScreenShareDidChange;
    void /* unknown type, empty encoding */ greenTea3PCallStatusChanged;
    ...
    void /* unknown type, empty encoding */ fetchUISceneOrientation;
    ...
    void /* unknown type, empty encoding */ isSplitView;
    ...
    void /* unknown type, empty encoding */ callUUIDsThatHaveReceivedFirstVideoFrame;
...
- (void)handleAnyRemoteSupportsRequestToScreenShareDidChange:(id)a0;
- (void)handleAudioUplinkChange:(id)a0;
- (void)handleBackgroundReplacementEnabledChanged:(id)a0;
- (void)handleBluetoothAudioFormatChanged:(id)a0;
- (void)handleCallConnected:(id)a0;
- (void)handleCallConversationChanged:(id)a0;
- (void)handleCallSharePlayCapabilityDidChange:(id)a0;
...
- (void)handleCameraFallbackSelection:(id)a0;
...
- (void)handleLocalSensitiveContentAnalysisChanged:(id)a0;
- (void)handleLocalVideoAttributesChanged:(id)a0;
- (void)handleLocalVideoPreviewFirstFrameArrived:(id)a0;
- (void)handleSceneDidDisconnect:(id)a0;
- (void)handleSceneWillConnectOrDidActivate:(id)a0;
