@interface ConversationKit.RecentsCollectionViewDataSource : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_collator;
    void /* unknown type, empty encoding */ $__lazy_storage_$_messageInboxController;
    void /* unknown type, empty encoding */ itemProvider;
    void /* unknown type, empty encoding */ sectionProvider;
