...
@interface PKPhysicsBody : NSObject <NSCopying, NSSecureCoding> {
    ...
    int _dynamicType;
    struct vector<PKPhysicsShape *, std::allocator<PKPhysicsShape *>> { struct PKPhysicsShape **__begin_; struct PKPhysicsShape **__end_; struct PKPhysicsShape **__cap_; } _shapes;
