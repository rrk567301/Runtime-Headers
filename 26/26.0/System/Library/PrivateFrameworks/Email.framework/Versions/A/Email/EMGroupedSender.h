@class NSURL, EMGeneratedSummary, ECSubject, NSDate, NSObject, EMCategory, ECMessageFlags, EMGroupedSenderObjectID, NSString, EMFollowUp, EFFuture, NSIndexSet, NSArray, NSNumber, EMReadLater, EMObjectID, EMMessageRepository;
