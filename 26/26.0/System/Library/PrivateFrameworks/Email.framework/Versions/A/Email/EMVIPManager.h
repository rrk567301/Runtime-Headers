@class NSString, NSXPCInterface, EMRemoteConnectionRecoveryAssertion, NSSet, EMRemoteConnection, NSMutableDictionary, NSObject, EFPromise, EAEmailAddressSet, EFManualCancelationToken;
@protocol OS_os_log;
