@class NSURL, EMGeneratedSummary, ECSubject, NSDate, NSObject, EMCategory, ECMessageFlags, NSString, EMFollowUp, EFFuture, NSIndexSet, NSArray, NSNumber, EMReadLater, EMObjectID, EMMessageRepository;
