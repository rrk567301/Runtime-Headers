...
@interface WiFiUsageSession : NSObject <NSCopying> {
    ...
    unsigned long long _faultReasonCount[38];
    unsigned long long _joinReasonCount[15];
    unsigned long long _savedJoinReasonCount[15];
    unsigned long long _disconnectReasonCount[1036];
...
+ (BOOL)isDriverUnavailabilityReasonVoluntary:(int)a0 subReason:(int)a1 orReasonString:(id)a2;
...
- (void)bluetoothStateDidChange:(BOOL)a0 connectedDeviceCount:(unsigned long long)a1 inA2dp:(BOOL)a2 inSco:(BOOL)a3 inUniAoS:(BOOL)a4 inBiAoS:(BOOL)a5 btAudioBand:(BOOL)a6;
