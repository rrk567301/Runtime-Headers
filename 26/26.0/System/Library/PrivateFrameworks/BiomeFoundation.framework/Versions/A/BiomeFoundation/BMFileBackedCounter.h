...
- (id)_createFileDictionary:(id *)a0;
...
- (id)initWithFilename:(id)a0 protectionClass:(int)a1 directory:(id)a2 domain:(unsigned long long)a3 readOnly:(BOOL)a4 error:(id *)a5;
