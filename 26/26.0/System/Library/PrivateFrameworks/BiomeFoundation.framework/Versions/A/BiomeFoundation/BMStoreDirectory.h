...
@property (class, readonly, nonatomic) NSString *setsMergeableDeltas;
...
@property (class, readonly, nonatomic) NSString *pendingBatches;
...
@property (class, readonly, nonatomic) NSString *sets;
