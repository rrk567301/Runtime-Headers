@class NSData, IDSObjCPacketLog, IDSDataChannelsDirectConnections, IDSLinksQualityReportSyncTokenObject, IDSLinksQualityMeasurerSyncToken, NSMutableDictionary, IDSLinksQualityMeasurer, IDSDataChannelLinkContext, NSMutableArray, NSObject, IDSDataChannelLinkEngineHandle;
...
@interface _IDSDatagramChannel : NSObject {
    ...
    BOOL _hbhHalfThePackets;
    BOOL _shouldCollectMetrics;
    BOOL _shouldUsePacketLog;
    BOOL _shouldForcePathMTUEvaluationPeriodically;
    BOOL _shouldReportPMTUChangesOnIPv4;
