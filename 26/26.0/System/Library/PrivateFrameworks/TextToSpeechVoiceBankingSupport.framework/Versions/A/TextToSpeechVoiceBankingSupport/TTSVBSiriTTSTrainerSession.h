...
- (id)getAllAvailableLocalesForTrainingVersion:(id)a0;
...
- (id)installableTrainingAssetsForLocaleID:(id)a0 name:(id)a1 type:(long long)a2;
- (id)installedTrainingAssetsForLocaleID:(id)a0 name:(id)a1 type:(long long)a2;
