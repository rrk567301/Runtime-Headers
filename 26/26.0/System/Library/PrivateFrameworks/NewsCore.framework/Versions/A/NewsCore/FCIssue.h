...
- (BOOL)isEqual:(id)a0;
- (id)initWithIdentifier:(id)a0 type:(long long)a1 title:(id)a2 publicationDate:(id)a3 coverDate:(id)a4 lastModifiedDate:(id)a5 metadataJSONAssetHandle:(id)a6 coverImageAssetHandle:(id)a7 coverImageAspectRatio:(double)a8 coverImagePrimaryColor:(id)a9 coverImageBackgroundColor:(id)a10 coverImageTextColor:(id)a11 coverImageAccentColor:(id)a12 layeredCoverJSON:(id)a13 layeredCoverAspectRatio:(double)a14 layeredCoverPrimaryColor:(id)a15 isCurrent:(BOOL)a16 isDraft:(BOOL)a17 isPaid:(BOOL)a18 minimumNewsVersion:(long long)a19 allArticleIDs:(id)a20 coverArticleID:(id)a21 allowedStorefrontIDs:(id)a22 blockedStorefrontIDs:(id)a23 topicTagIDs:(id)a24 sourceChannel:(id)a25 notificationDescription:(id)a26 issueDescription:(id)a27 sortDate:(id)a28;
- (void).cxx_destruct;
