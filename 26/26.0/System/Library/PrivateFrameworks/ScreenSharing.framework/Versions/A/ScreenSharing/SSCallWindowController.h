...
- (void)toggleAppWindows:(id)a0;
- (void)toggleControlObserve:(id)a0;
- (void)toggleDesktop:(id)a0;
- (void)toggleLaunchpad:(id)a0;
- (void)toggleMissionControl:(id)a0;
- (void)toggleSharedKeyboard:(id)a0;
- (void)updateControlObserveButtonStateAndAccessibilityValue:(BOOL)a0;
- (BOOL)viewTypeSet;
