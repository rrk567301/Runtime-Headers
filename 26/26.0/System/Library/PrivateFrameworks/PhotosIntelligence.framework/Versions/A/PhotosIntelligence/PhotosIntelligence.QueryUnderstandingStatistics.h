@interface PhotosIntelligence.QueryUnderstandingStatistics : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ queryActivityEntities;
    void /* unknown type, empty encoding */ queryContainsPersonEntity;
    void /* unknown type, empty encoding */ queryContainsPersonAgeType;
    void /* unknown type, empty encoding */ queryContainsActivityEntity;
    void /* unknown type, empty encoding */ queryContainsPublicEvent;
    void /* unknown type, empty encoding */ queryContainsPersonalEvent;
    void /* unknown type, empty encoding */ queryContainsTimeEntity;
    void /* unknown type, empty encoding */ queryContainsPartOfDay;
    void /* unknown type, empty encoding */ queryContainsPartOfWeek;
    void /* unknown type, empty encoding */ queryContainsSeason;
    void /* unknown type, empty encoding */ queryContainsLocationEntity;
    void /* unknown type, empty encoding */ queryContainsGenericLocationEntity;
    ...
    void /* unknown type, empty encoding */ queryContainsAllTime;
    void /* unknown type, empty encoding */ queryContainsSortOrder;
    void /* unknown type, empty encoding */ queryWordCount;
}
