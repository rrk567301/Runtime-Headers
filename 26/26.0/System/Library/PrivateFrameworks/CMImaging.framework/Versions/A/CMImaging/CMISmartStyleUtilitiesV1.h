...
+ (BOOL)isHDRGainMapHeadroomAdjusted:(id)a0;
...
+ (struct CGSize { double x0; double x1; })styleEngineThumbnailSizeForUseCase:(unsigned long long)a0;
+ (unsigned int)styleEngineWeightPlaneCountForUseCase:(unsigned long long)a0;
+ (unsigned int)styleRendererWeightPlaneSigmaForUseCase:(unsigned long long)a0;
+ (id)defaultStyleForCastType:(id)a0;
+ (id)smartStyleCastForMakerNoteTag:(unsigned long long)a0 smartStyleVersion:(unsigned int)a1;
+ (id)StyleEngineTuningParametersForUseCase:(unsigned long long)a0;
+ (id)StyleEngineConfigurationForUseCase:(unsigned long long)a0;
...
+ (float)originalGainMapHeadroomFromStyle:(id)a0 currentHeadroom:(float)a1;
