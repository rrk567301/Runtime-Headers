@class NSUUID, LACSExtractablePassword, LACSCredential;

@interface LACSExtractableCredential : NSObject <NSSecureCoding>

@property (class, readonly) BOOL supportsSecureCoding;

@property (readonly, nonatomic) LACSCredential *credential;
@property (readonly, nonatomic) NSUUID *uuid;
@property (readonly, nonatomic) LACSExtractablePassword *password;
