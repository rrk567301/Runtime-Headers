@class NSDate, NSString, WBSTOTPGenerator, NSArray, WBSFileVaultRecoveryKeyDeviceInfo, NSMutableDictionary, NSDictionary, WBSFormerlySharedSavedAccountMarker, NSURLProtectionSpace, WBSPasswordWarningHideMarker;
