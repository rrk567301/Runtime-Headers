@class NSTextField, STTranslucentBlockingBackdropView, NSString, NSAnimation, NSDictionary, STLockoutAlertController, NSObject, NSImageView, NSButton, STLockoutPolicyController;
@protocol STLockoutViewControllerDelegate, OS_dispatch_group, STCommunicationLimitsLockoutViewControllerDelegate;
...
@property (weak) NSImageView *hourglassView;
