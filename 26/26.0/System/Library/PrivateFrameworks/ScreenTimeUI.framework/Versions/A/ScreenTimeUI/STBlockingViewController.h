@class NSTextField, NSView, NSBox, NSString, STManagementState, NSStackView, MOEffectiveSettingsStore, CNContactStore, STPasscodeField, NSImageView, NSLayoutConstraint, NSButton;
...
@property (retain) NSImageView *hourglassView;
