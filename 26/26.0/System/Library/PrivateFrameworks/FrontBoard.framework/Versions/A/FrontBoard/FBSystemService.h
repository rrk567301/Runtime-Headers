@class NSString, BSServiceDispatchQueue, BSServiceConnectionListener;
...
- (void)_reallyActivateApplication:(id)a0 requestID:(id)a1 options:(id)a2 serviceInstance:(id)a3 source:(id)a4 originalSourceToken:(id)a5 isTrusted:(BOOL)a6 sequenceNumber:(unsigned long long)a7 cacheGUID:(id)a8 ourSequenceNumber:(unsigned long long)a9 ourCacheGUID:(id)a10 withResult:(id /* block */)a11;
...
- (void)_activateBundleID:(id)a0 requestID:(id)a1 isTrusted:(BOOL)a2 options:(id)a3 serviceInstance:(id)a4 source:(id)a5 originalSourceToken:(id)a6 withResult:(id /* block */)a7;
