@class NSUUID, NSSet, CPApplicationLauncher;
...
@interface CPActivitySessionManager : NSObject <CPAudioPolicyStateObserver, CPSystemStateObserverObserver, CopresenceCore.CPApplicationObserverProtocol, CPActivitySessionManager> {
    ...
    void /* unknown type, empty encoding */ topicsObserverCacheEvictionTimeout;
    void /* unknown type, empty encoding */ __activitySessions;
    void /* unknown type, empty encoding */ applicationController;
    void /* unknown type, empty encoding */ _applicationLauncher;
...
- (void)updateExternalParticipants:(id)a0;
- (id)init;
- (void).cxx_destruct;
...
- (id)initWithIdentifier:(id)a0 groupUUID:(id)a1 activities:(id)a2 applicationController:(id)a3 delegate:(id)a4 queue:(id)a5 systemStateObserver:(id)a6 sceneObservationManager:(id)a7;
...
- (void)updateNearbyClustersWithLocalParticipantCluster:(id)a0 remoteParticipants:(id)a1;
