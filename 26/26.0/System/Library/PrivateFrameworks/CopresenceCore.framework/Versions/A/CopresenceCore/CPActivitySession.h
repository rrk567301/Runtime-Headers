@class NSXPCListenerEndpoint, NSUUID, NSString, TUConversationActivity, TUConversationActivitySession;
...
@interface CPActivitySession : NSObject <RBSAssertionObserving, CPLaunchableActivitySession, NSXPCListenerDelegate> {
    ...
    void /* unknown type, empty encoding */ reportDictionary;
    ...
    void /* unknown type, empty encoding */ isStageInitiated;
    ...
    void /* unknown type, empty encoding */ unaliasedNearbyParticipantIDs;
}
