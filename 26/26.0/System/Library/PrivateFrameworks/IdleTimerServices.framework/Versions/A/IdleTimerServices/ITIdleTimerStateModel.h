...
- (id)_access_newIdleTimerAssertionOnBehalfOfSceneWithPID:(int)a0 withConfiguration:(id)a1 forReason:(id)a2 error:(id *)a3;
- (void)_addStateCaptureHandler;
- (BOOL)handleIdleEvent:(unsigned long long)a0 usingConfigurationWithIdentifier:(id)a1;
- (id)newIdleTimerAssertionOnBehalfOfSceneWithPID:(int)a0 withConfiguration:(id)a1 forReason:(id)a2 error:(id *)a3;
