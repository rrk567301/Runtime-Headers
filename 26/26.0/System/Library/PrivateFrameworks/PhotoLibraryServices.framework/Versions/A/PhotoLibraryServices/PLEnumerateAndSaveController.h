...
@property (readonly, nonatomic, getter=shouldRefreshAllAfterSave) BOOL refreshesAllAfterSave;
@property (readonly, nonatomic, getter=shouldResetAfterSave) BOOL resetsAfterSave;
