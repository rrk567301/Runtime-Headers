...
+ (id)_sharedAlbumWarningMessageForAssetCount:(unsigned long long)a0 assetType:(short)a1 albumTitle:(id)a2;
+ (id)sharedAlbumWarningMessageForAssets:(id)a0 albumTitle:(id)a1;
