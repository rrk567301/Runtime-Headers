...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithContentString:(id)a0 categoriesType:(unsigned long long)a1 suggestionType:(unsigned long long)a2 matchedAssetsCount:(unsigned long long)a3 matchedCollectionsCount:(unsigned long long)a4 matchedText:(id)a5 matchRangeOfSearchText:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a6 suggestionComponents:(id)a7 nextTokenSuggestions:(id)a8;
