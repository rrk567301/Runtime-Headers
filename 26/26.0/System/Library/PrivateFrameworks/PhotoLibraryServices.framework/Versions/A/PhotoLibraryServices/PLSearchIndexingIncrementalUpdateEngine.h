...
- (void).cxx_destruct;
- (void)_donateBatch:(id)a0 library:(id)a1 progress:(id)a2 completion:(id /* block */)a3;
...
- (id)processJobObjectIDs:(id)a0 entity:(unsigned long long)a1 library:(id)a2 completion:(id /* block */)a3;
