...
+ (id)processFrequentLocationsWithItemSubset:(id)a0 locationsOfInterest:(id)a1 progressBlock:(id /* block */)a2;
+ (id)processFrequentLocationsWithItems:(id)a0 locationsOfInterest:(id)a1 progressBlock:(id /* block */)a2;
+ (id)processFrequentLocationsWithSortedMoments:(id)a0 locationsOfInterest:(id)a1 progressBlock:(id /* block */)a2;
