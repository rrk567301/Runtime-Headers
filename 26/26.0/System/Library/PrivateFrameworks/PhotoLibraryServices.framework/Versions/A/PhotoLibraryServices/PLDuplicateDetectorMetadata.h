...
- (void)_buildAdjustedFingerprintMapWithPrimaryStoreFullsizeFingerprintResults:(id)a0 mutableOIDFingerprintMap:(id)a1 property:(id)a2 filterOnCPLResourceType:(unsigned long long)a3;
...
- (void)_processBlendedResult:(id)a0 fullsizeMap:(id)a1 oidFullsizeVideoMap:(id)a2 oidMediumVideoMap:(id)a3 inDuplicateMap:(id)a4;
- (id)_propertiesToFetch;
- (id)detectDuplicatesWithPhotoLibrary:(id)a0 error:(id *)a1;
- (id)initWithSourceOIDs:(id)a0;
