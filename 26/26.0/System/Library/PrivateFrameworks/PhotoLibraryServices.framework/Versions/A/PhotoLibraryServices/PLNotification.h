@class NSMutableSet, NSString, NSArray, NSMutableOrderedSet, NSDate, NSDictionary, NSData;
...
- (id)initWithAssetsAdded:(id)a0 toCollectionShare:(id)a1;
...
- (id)initWithInvitationCollectionShare:(id)a0;
...
- (id)initWithMultipleContributorEnabledForCollectionShare:(id)a0;
- (id)initWithParticipantAcceptanceStatusChanged:(id)a0;
