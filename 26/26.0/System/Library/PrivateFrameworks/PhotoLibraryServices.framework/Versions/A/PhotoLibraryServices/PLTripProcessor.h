...
+ (BOOL)_isCurrentMomentOutlierWithPreviousMoment:(id)a0 currentMoment:(id)a1 nextMoment:(id)a2;
+ (BOOL)_isTimeDeltaViableForDistanceDeltaBetweenPreviousMoment:(id)a0 currentMoment:(id)a1;
+ (double)_minimumDistanceBetweenFrequentLocations:(id)a0 andItem:(id)a1;
+ (unsigned long long)_numberOfAssetsInItems:(id)a0;
+ (void)_removeOutliersFromTripsMoments:(id)a0;
+ (id)_splitTripsMomentsFromTripsMoments:(id)a0;
+ (double)_timeIntervalBetweenItem:(id)a0 andItem:(id)a1;
+ (id)_tripFromTripMoments:(id)a0 withLastHomeVisitDate:(id)a1 andLastItem:(id)a2;
+ (id)processTripsWithItems:(id)a0 frequentLocations:(id)a1 lastHomeVisitDate:(id)a2 progressBlock:(id /* block */)a3;
+ (BOOL)tripsEligibleForMoments:(id)a0 frequentLocations:(id)a1;
