...
+ (long long)fetchApproximateTransactionCountWithPathManager:(id)a0 error:(id *)a1;
...
+ (long long)_fetchApproximateRowCountWithPathManager:(id)a0 tableName:(id)a1 error:(id *)a2;
...
+ (long long)fetchApproximateChangeCountWithPathManager:(id)a0 error:(id *)a1;
