...
+ (void)captureImageWriterInvalidLivePhotoMetadataWithStillDisplayTimeNotNumeric:(BOOL)a0 videoDurationIsNotNumeric:(BOOL)a1 photoIrisMediaGroupUUIDDoesNotMatch:(BOOL)a2 existingPhotoIrisMediaGroupUUIDIsMissing:(BOOL)a3 completion:(id /* block */)a4;
...
+ (void)captureSpotlightClientStateMissingSnapshotWithSpotlightAssetCountResult:(id)a0 spotlightError:(id)a1 searchIndexingEvents:(id)a2 completion:(id /* block */)a3;
