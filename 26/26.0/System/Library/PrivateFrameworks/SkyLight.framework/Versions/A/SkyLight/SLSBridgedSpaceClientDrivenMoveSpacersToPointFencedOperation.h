...
- (id)initWithDrivingSpaceID:(unsigned long long)a0 verticalIndex:(unsigned long long)a1 horizontalIndex:(unsigned long long)a2 point:(struct CGPoint { double x0; double x1; })a3 options:(unsigned long long)a4 fencePort:(unsigned int)a5;
- (void)invokeFallback;
