...
- (void)dealloc;
- (id)init;
- (void)dbg_request:(id)a0 command:(unsigned long long)a1 uuid:(unsigned long long)a2 error:(int)a3;
- (id)brightnessControls:(id *)a0;
- (BOOL)commitBrightnessPolicy:(id *)a0;
- (id)controllerWithId:(unsigned int)a0;
- (const char *)dbg_DimPolicyToString:(unsigned char)a0;
- (BOOL)dbg_SLCFDictionaryGetBOOL:(id)a0 forKey:(id)a1 value:(BOOL *)a2;
- (BOOL)dbg_SLCFDictionaryGetFloat:(id)a0 forKey:(id)a1 value:(double *)a2;
- (BOOL)dbg_SLCFDictionaryGetInteger:(id)a0 forKey:(id)a1 value:(int *)a2;
- (void *)dbg_SLCFDictionaryGetValueWithType:(id)a0 forKey:(id)a1 ofType:(unsigned long long)a2;
- (const char *)dbg_ShieldPolicyToString:(unsigned char)a0;
- (const char *)dbg_SleepPolicyToString:(unsigned char)a0;
- (const char *)dbg_display_type:(unsigned int)a0;
