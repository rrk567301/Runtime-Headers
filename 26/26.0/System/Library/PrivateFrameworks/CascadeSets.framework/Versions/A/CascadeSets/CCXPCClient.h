...
- (void)servicePriorsRespondingRequest:(BOOL)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
- (void)serviceRequest:(BOOL)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
- (void)serviceThrowingRequest:(BOOL)a0 completion:(id /* block */)a1 usingBlock:(id /* block */)a2;
