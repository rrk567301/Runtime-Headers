@class CCDatabaseSetStateVectorBuilder, CCDatabaseSetStateReader, CCSet, CCDataResourceReadAccess, CKDistributedTimestampStateVector, CCDatabaseJoinedProvenance, CCDatabaseDeviceMapping, NSObject, NSNumber;
@protocol CCDatabaseReadOnlyAccess, CCDatabaseValueRowEnumerator;
