@class NSNumber, NSString, TTSMauiVocalizerBuffer, NSMutableDictionary, NSCondition, TTSRulesetRunner, NSObject, NSOrderedSet, NSMutableOrderedSet, TTSSpeechString, TTSMauiVoice;
