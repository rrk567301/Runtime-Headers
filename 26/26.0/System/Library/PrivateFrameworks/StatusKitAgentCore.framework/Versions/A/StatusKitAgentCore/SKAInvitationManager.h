...
- (long long)handleIncomingInvitationMessage:(id)a0 fromHandle:(id)a1 fromID:(id)a2 fromMergeID:(id)a3 toHandle:(id)a4 messageGuid:(id)a5;
...
- (void)shouldAcceptInvitationMessageForPresenceIdentifier:(id)a0 fromHandle:(id)a1 fromMergeID:(id)a2 inServiceFirewall:(id)a3 databaseContext:(id)a4 completion:(id /* block */)a5;
