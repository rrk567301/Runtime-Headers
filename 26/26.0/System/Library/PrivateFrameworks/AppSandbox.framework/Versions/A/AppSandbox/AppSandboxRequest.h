@class NSData, NSString, NSArray, _TtC10AppSandbox17ASBBinaryIdentity, NSDictionary, CodeIdentity, AppSandboxEntitlements, ASBMutableContainerSynchronization, NSNumber;
...
@property (retain, nonatomic) _TtC10AppSandbox17ASBBinaryIdentity *identity;
