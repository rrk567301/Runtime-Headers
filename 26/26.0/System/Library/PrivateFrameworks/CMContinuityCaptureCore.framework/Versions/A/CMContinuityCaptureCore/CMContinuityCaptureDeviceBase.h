...
@interface CMContinuityCaptureDeviceBase : NSObject <CMContinuityCaptureDevice> {
    ...
    struct { long long value; int timescale; unsigned int flags; long long epoch; } _lastStreamStartTimeInHostClock;
...
- (void)scheduleSendingInvalidFramesAfterTimeout:(BOOL)a0;
