@class WFWorkflowRecord, NSString, NSDictionary, NSData, NSDate, WFFileRepresentation, CKRecordID;
...
+ (BOOL)isShortcutV2RecordID:(id)a0;
+ (id)recordIDWithZoneID:(id)a0 workflowID:(id)a1;
+ (id)workflowIdentifierForRecordID:(id)a0;
