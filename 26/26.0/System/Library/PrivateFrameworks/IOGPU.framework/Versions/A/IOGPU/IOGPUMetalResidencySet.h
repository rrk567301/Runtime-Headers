...
@interface IOGPUMetalResidencySet : _MTLObjectWithLabel <MTLResidencySetSPI> {
    ...
    struct IOGPUGenerationalSet<id, IOGPUMTLIdKey, IOGPUMTLObjectHashAllocator> { struct IOGPUMTLIdKey *m_keyTable; unsigned long long *m_generationTable; unsigned int *m_hopInfo; unsigned long long *m_usedInfo; unsigned long long *m_dirtyInfo; unsigned long long *m_dirtyInfoH; unsigned int m_hashSize; unsigned int m_hashMask; unsigned int m_usedMask; unsigned int m_dirtyHMask; unsigned int m_hashShift; unsigned int m_count; unsigned int m_dirtyCount; unsigned int m_maxSize; unsigned long long m_allocatedSize; unsigned long long m_currentGeneration; unsigned long long m_expiredGeneration; BOOL m_init; } _hashTable;
}
...
- (void)commit;
- (void)dealloc;
- (id)initWithDevice:(id)a0 descriptor:(id)a1 args:(struct IOGPUNewResourceArgs { struct IOGPUNewResourceData { unsigned int x0; unsigned int x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned int x10; unsigned long long x11; unsigned long long x12; unsigned long long x13; unsigned int x14; unsigned int x15; union { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; union { unsigned int x0; unsigned long long x1; } x3; } x0; struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned long long x4[2]; } x1; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x2; struct { unsigned int x0; } x3; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned int x3; } x4; } x16; } x0; } *)a2 argsSize:(unsigned long long)a3;
- (id).cxx_construct;
- (void).cxx_destruct;
