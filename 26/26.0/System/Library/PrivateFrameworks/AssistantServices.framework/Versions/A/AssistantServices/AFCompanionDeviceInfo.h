...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithAssistantID:(id)a0 speechID:(id)a1 idsIdentifier:(id)a2 productPrefix:(id)a3 aceHost:(id)a4 syncMetadata:(id)a5 syncMetadataCapability:(BOOL)a6 peerToPeerHandoffCapability:(BOOL)a7 muxSupportCapability:(BOOL)a8 meDevice:(BOOL)a9 siriLanguage:(id)a10 companionName:(id)a11;
