...
+ (id)sharedInstance;
+ (id)effectiveGenderKeyForKey:(id)a0 gender:(long long)a1;
...
- (id)baseLocaleToDialectMapForLanguage:(id)a0;
- (id)compactDisplayNameInLanguage:(id)a0 forSiriLanguage:(id)a1;
- (id)defaultOutputVoiceForSiriSessionLanguage:(id)a0;
- (id)dialectForBaseLanguageCode:(id)a0;
- (id)dialectsMap;
- (id)getBaseLocale:(id)a0;
- (id)getValidOutputVoiceWithDialects:(id)a0;
...
- (id)localizedStringFromCatalogForKey:(id)a0 gender:(long long)a1 table:(id)a2 bundle:(id)a3 languageCode:(id)a4 defaultValue:(id)a5;
- (id)localizedStringOrNilFromCatalogForKey:(id)a0 gender:(long long)a1 table:(id)a2 bundle:(id)a3 languageCode:(id)a4 defaultValue:(id)a5;
