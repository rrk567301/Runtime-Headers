...
@property BOOL requestViewControllerSynchronously;
...
@property (readonly) BOOL allParameterValues;
...
@property (readonly) BOOL supportsUserPresets;
...
@property BOOL shouldBypassEffect;
@property (readonly) BOOL canProcessInPlace;
@property (getter=isRenderingOffline) BOOL renderingOffline;
...
@property (readonly) BOOL supportsMPE;
...
+ (void)instantiateWithComponentDescription:(struct AudioComponentDescription { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })a0 options:(unsigned int)a1 connectionProvider:(struct function<NSXPCConnection *(NSUUID *)> { struct __value_func<NSXPCConnection *(NSUUID *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; })a2 completionHandler:(id /* block */)a3;
...
- (void)setLocalCachingDisabled:(BOOL)a0;
