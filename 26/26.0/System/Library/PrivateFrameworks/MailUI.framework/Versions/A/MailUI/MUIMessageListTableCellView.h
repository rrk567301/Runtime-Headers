@class EFFuture, NSString, MessageListCellLayoutValuesHelper, MUIMessageListObjectProxy, EMCategory, NSColor, MessageListCellLayoutValues, MessageListCellViewModel, NSLayoutConstraint, NSButton, ToCCIndicator, MessageListCellHelper;
