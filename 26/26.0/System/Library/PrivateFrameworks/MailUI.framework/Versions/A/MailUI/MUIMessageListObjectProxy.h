@class NSTextEncapsulation, MFMailbox, NSDictionary, NSObject, MFCriterion, MCMessage, MessageListCellHelper, NSOrderedSet, MessageListCellViewModel, NSString, MUICachingSVGConverter, NSImage, NSAttributedString, NSSet, NSIndexSet, NSArray, EFPair, NSColor;
@protocol OS_os_log, EFCancelable, MUIBIMIProvider;
...
@property (weak, nonatomic) id<MUIBIMIProvider> brandIndicatorProvider;
...
@property (nonatomic) BOOL showTimeSensitiveImage;
...
- (void)_updateBlockedSenderImage;
