...
- (void)textureProvider:(id)a0 didProvideCGImage:(struct CGImage { } *)a1 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a2 adjustment:(id)a3 isDegraded:(BOOL)a4 forRequestID:(int)a5;
...
- (void)textureProvider:(id)a0 didProvidePixelBuffer:(struct __CVBuffer { } *)a1 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a2 adjustment:(id)a3 forRequestID:(int)a4;
