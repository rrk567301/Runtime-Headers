...
+ (id)_fetchKeyAssetUUIDForAlbumWithGUID:(id)a0 photoLibrary:(id)a1 plPhotoLibrary:(id)a2;
+ (id)_activitiesFromCloudFeedEntries:(id)a0 inMostRecentOrder:(BOOL)a1 photoLibrary:(id)a2 plPhotoLibrary:(id)a3;
+ (id)_assetsAddedActivitiesFromCloudFeedAssetsEntry:(id)a0 inMostRecentOrder:(BOOL)a1 withAlbumInformation:(id)a2 photoLibrary:(id)a3;
+ (id)_assetsAddedActivityFromAssets:(id)a0 batchID:(unsigned long long)a1 withAlbumInformation:(id)a2 forEntry:(id)a3 photoLibrary:(id)a4;
...
+ (id)_reactionActivitiesFromCloudFeedLikeEntry:(id)a0 photoLibrary:(id)a1 plPhotoLibrary:(id)a2;
