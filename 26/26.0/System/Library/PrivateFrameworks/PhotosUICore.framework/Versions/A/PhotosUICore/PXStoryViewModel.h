...
@property (nonatomic, readonly) BOOL wantsReportConcernAction;
...
@property (nonatomic) BOOL isAutoPlayingUpNext;
...
@property (readonly, nonatomic) BOOL isChromeAllowed;
...
@property (readonly, nonatomic) BOOL hasCurrentClosePermission;
...
@property (readonly, nonatomic) BOOL isPerformingAnyExportOperation;
...
@property (readonly, nonatomic) BOOL pointerOverPlayer;
...
@property (readonly, nonatomic) BOOL wantsFeedbackAction;
...
- (void)setIsPerformingAnyExportOperation:(BOOL)a0;
...
- (void)setMenuIsOpen:(BOOL)a0 withIdentifier:(id)a1;
