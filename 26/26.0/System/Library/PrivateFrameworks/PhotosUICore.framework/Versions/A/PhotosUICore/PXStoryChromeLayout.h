...
- (unsigned int)_addButtonForChromeItem:(unsigned long long)a0 isSupported:(BOOL)a1;
- (unsigned int)_addLabelForChromeItem:(unsigned long long)a0 isSupported:(BOOL)a1;
