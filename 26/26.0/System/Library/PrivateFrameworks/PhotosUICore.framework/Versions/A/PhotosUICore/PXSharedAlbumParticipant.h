@class NSString, PLCloudSharedAlbumInvitationRecord, NSArray, PHShareParticipant, NSNumber;
...
- (id)displayNameWithAddressAppended:(BOOL)a0;
- (id)matchingContact;
- (id)initWithInvitationRecord:(id)a0;
- (id)initWithPersonID:(id)a0 firstName:(id)a1 lastName:(id)a2 fullName:(id)a3 emails:(id)a4 phones:(id)a5 acceptanceStatus:(short)a6;
