@class NSString, NSData, NSDate, PXFlexMusicAsset, NSNumber;

@interface PXFlexMusicArtworkAsset : NSObject <PXDisplayAsset>

@property (readonly, nonatomic) PXFlexMusicAsset *audioAsset;
...
@property (readonly, nonatomic) BOOL isContentAnalyzedAsPreviewable;
