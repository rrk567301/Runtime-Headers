@class PHCachingImageManager, PHImageManager, NSArray, PHAssetResourceQualityClass, PHPhotoLibrary, NSDictionary, NSMutableArray, NSObject, PXPhotoKitThumbnailCache;
...
+ (void)configureLoadingStatusManager:(id)a0 andVideoProgressHandler:(id /* block */)a1 withVideoSensitivityProcessingProgress:(id)a2 imageManagerRequestProgress:(double)a3 loadOperationTrackingID:(id)a4 stop:(BOOL *)a5 info:(id)a6 error:(id)a7;
...
- (void)setSearchResultContextualVideoThumbnailIdentifiers:(id)a0;
