...
@interface PXStoryView : UXView <PXExtendedTraitCollectionReferenceRectProviding, PXStoryQueueParticipant, PXChangeObserver, PXTapToRadarDiagnosticProvider>
...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } px_platformSpecificFullScreenReferenceRect;
