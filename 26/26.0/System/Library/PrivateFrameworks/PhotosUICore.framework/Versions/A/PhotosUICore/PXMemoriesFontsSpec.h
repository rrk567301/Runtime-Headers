...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })paddingForFontSet:(long long)a0 specSet:(long long)a1 variant:(long long)a2 layoutMargins:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a3 width:(double)a4 shouldScale:(BOOL)a5 forHeaderTile:(BOOL)a6;
