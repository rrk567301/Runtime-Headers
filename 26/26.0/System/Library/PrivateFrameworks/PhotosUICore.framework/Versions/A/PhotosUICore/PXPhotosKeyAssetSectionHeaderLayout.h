@class NSView, NSString, PXAssetsDataSource, PXNumberAnimator, PXPhotosLayoutSpec, NSDictionary, PXPhotosViewModel, PXSelectionSnapshot;
...
@property (retain, nonatomic) NSView<PXPhotosBannerView> *bannerView;
