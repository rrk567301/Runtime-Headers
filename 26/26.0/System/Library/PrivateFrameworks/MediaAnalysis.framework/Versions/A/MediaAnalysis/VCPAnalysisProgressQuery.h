...
+ (unsigned long long)_countFailuresWithAssetBatch:(id)a0 fetchRequest:(id)a1 taskID:(unsigned long long)a2;
...
+ (int)queryVideoCountAndDurationBreakdown:(id)a0 photoLibrary:(id)a1 taskID:(unsigned long long)a2 cancelOrExtendTimeoutBlock:(id /* block */)a3;
