...
@interface VCPVideoCNNActionClassifier : VCPVideoCNNTask {
    ...
    NSArray *_inputNames;
    struct vector<float *, std::allocator<float *>> { float **__begin_; float **__end_; float **__cap_; } _inputsData;
    NSMutableArray *_phFaces;
}

+ (id)sharedModel:(id)a0 inputNames:(id)a1 properties:(id)a2;
+ (id)sharedModelStage1:(id)a0 inputNames:(id)a1 properties:(id)a2;
+ (float)thresholdForClass:(id)a0 isHighPrecision:(BOOL)a1;
