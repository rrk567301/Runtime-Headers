@class NSMutableDictionary, NSDictionary, VCPAsset, PHAsset, NSObject;
...
@property (nonatomic) BOOL requiresOnDemandDownload;
...
- (int)generateAndPersistVideoThumbnailResources:(id)a0 forPHAsset:(id)a1 withResults:(id)a2 cancelBlock:(id /* block */)a3;
...
- (int)postProcessAnimalResults:(id)a0;
