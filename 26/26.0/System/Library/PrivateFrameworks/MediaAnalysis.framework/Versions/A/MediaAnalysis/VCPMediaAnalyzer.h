...
- (id)getFaceIDRanges:(id)a0 asset:(id)a1;
- (id)getOverlapPersonRanges:(id)a0;
- (id)getThumbnailTimerange:(id)a0;
...
- (id)getTimeRangesForThumbnailIdentifiers:(id)a0 withResults:(id)a1;
- (id)getTimeRangesInAsset:(id)a0 forAnimals:(id)a1 withAnalysis:(id)a2;
