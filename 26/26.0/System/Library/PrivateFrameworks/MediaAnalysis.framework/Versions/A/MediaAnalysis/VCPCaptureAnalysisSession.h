@class VCPVideoFullFaceDetector, NSMutableDictionary, NSObject, NSDictionary, VCPFrameAnalysisStats, VCPTrimAnalyzer, VCPImagePetsAnalyzer, VCPHomeKitMotionAnalyzer, VCPLightMotionAnalyzer, VCPVideoFacePoseAnalyzer, VCPVideoFaceMeshAnalyzer, VCPSceneChangeAnalyzer, VCPFullVideoAnalyzer, VCPImageBlurAnalyzer, VCPAudioAnalyzer;
...
+ (id)analyzerForMediaAnalysis:(unsigned long long)a0 withProperties:(id)a1 andResultsHandler:(id /* block */)a2;
...
- (id)initWithAudioAnalysisTypes:(unsigned long long)a0 properties:(id)a1 andResultsHandler:(id /* block */)a2;
