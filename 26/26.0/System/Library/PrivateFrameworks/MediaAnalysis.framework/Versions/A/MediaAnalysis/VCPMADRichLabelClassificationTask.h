@class NSObject, NSString, MADRichLabelClassificationRequest, VCPMADServiceImageAsset;
@protocol OS_dispatch_queue, MTLDevice, VICancellable;

@interface VCPMADRichLabelClassificationTask : NSObject <VCPMADServiceImageProcessingSubtaskProtocol, VCPMADTaskProtocol> {
    MADRichLabelClassificationRequest *_request;
...
+ (unsigned long long)richLabelDomainFromVIDomain:(id)a0;
+ (id)taskWithRequest:(id)a0 imageAsset:(id)a1 andSignpostPayload:(id)a2;
+ (id)viDomainFromRichLabelDomain:(unsigned long long)a0;
