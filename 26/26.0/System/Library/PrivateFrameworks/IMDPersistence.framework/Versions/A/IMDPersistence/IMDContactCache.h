@class NSCache, IMAcceptedContactsChangeNotifier, NSData;
...
+ (BOOL)vCardCoordinateForMapURL:(id)a0 outLatitude:(float *)a1 outLongitude:(float *)a2;
...
- (void)removeCachedContactsForKeys:(id)a0;
