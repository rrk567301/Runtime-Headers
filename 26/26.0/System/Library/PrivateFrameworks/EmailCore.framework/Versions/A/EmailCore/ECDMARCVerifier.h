...
+ (long long)_alignmentForDKIMSigningDomain:(id)a0 andSenderDomain:(id)a1 senderOrganizationDomain:(id *)a2 onlyCheckStrictAlignment:(BOOL)a3;
+ (long long)alignmentForDKIMSigningDomain:(id)a0 andSenderDomain:(id)a1;
