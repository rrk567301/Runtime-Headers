...
@property (class, readonly, copy, nonatomic, getter=setTouchedByCleanup) ECMessageFlagChange *touchedByCleanup;
...
@property (nonatomic) BOOL touchedByCleanup;
...
@property (nonatomic) BOOL touchedByCleanupChanged;
...
- (void)changesTouchedByCleanupTo:(BOOL)a0;
