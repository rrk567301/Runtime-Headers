@class CBThermalBrightnessCap, NSString, CBRampManager, CBNVRAM, CBAurora, NSMutableDictionary, AABCHistograms, NSObject, NSMutableArray, CBGammaContrastPreservation, CBEDR, CBDynamicSlider;
