@class HMXPCEventRouterClient, NSString, _HMContext, HMAccessorySettingsMessenger, HMLocalization, HMAccessorySettingsMetricsDispatcher, NSObject;
@protocol OS_dispatch_queue, HMAccessorySettingsMessengerFactory, HMAccessorySettingsDataSourceDataSource, HMELastEventStoreReadHandle, HMAccessorySettingsDataSourceDelegate, HMESubscriptionProviding;
...
- (id)initWithContext:(id)a0 localizationManager:(id)a1 messengerFactory:(id)a2 subscriptionProvider:(id)a3 lastEventStoreReadHandle:(id)a4 eventRouterXPCClient:(id)a5 metricsDispatcher:(id)a6;
