@class NSUUID, NSString, NSURL, HMAccessory, NSData, HMSetupAccessoryPayload, HMAccessoryOwnershipToken, NSDictionary, NSError, NSArray, HMAccessoryCategory, MTRCommissioneeInfo;
...
@property (nonatomic) BOOL matterSystemCommissionerPairingIsNew;
