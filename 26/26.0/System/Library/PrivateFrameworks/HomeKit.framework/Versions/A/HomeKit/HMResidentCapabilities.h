...
@property (readonly, nonatomic) BOOL supportsDistributedExecutionOnPrimary;
@property (readonly, nonatomic) BOOL supportsResidentActionSetStateEvaluation;
@property (readonly, nonatomic) BOOL supportsUWB;
@property (readonly, nonatomic) BOOL supportsRestrictedGuest;
@property (readonly, nonatomic) BOOL supportsMatterOwnerCertFetch;
@property (readonly, nonatomic) BOOL supportsDistributedExecutionOnAppleMediaAccessories;
...
- (id)initWithTagUUID:(id)a0 capabilities:(struct _HMResidentCapabilitiesStruct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; unsigned char x14 : 1; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; unsigned char x19 : 1; unsigned char x20 : 1; unsigned char x21 : 1; unsigned char x22 : 1; unsigned char x23 : 1; unsigned char x24 : 1; unsigned char x25 : 1; unsigned char x26 : 1; unsigned char x27 : 1; unsigned char x28 : 1; unsigned char x29 : 1; unsigned char x30 : 1; unsigned char x31 : 1; unsigned char x32 : 1; unsigned char x33 : 1; unsigned char x34 : 1; unsigned char x35 : 1; unsigned char x36 : 1; unsigned char x37 : 1; unsigned char x38 : 1; })a1;
