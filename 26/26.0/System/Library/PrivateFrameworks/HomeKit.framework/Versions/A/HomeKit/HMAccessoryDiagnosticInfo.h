@class NSUUID, NSString, NSDate, HMSoftwareUpdateProgress, HMSoftwareUpdateDescriptor, HMSoftwareUpdateV2, HMFWiFiNetworkInfo, HMFSoftwareVersion, NSNumber;
...
@property (readonly, nonatomic) BOOL wifiRequiresPassword;
