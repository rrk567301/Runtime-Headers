...
- (void)configureWithHomeIdentifier:(id)a0 accessoryIdentifier:(id)a1 accessoryInfoOptions:(unsigned long long)a2 dataProviderDelegate:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)subscribeToAccessoryInfoWithHomeIdentifier:(id)a0 accessoryIdentifier:(id)a1 accessoryInfoOptions:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (void)unsubscribeToAccessoryInfoWithHomeIdentifier:(id)a0 accessoryIdentifier:(id)a1 accessoryInfoOptions:(unsigned long long)a2 completionHandler:(id /* block */)a3;
