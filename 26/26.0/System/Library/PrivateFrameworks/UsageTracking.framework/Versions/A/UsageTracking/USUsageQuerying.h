...
- (id)queryForApplications:(id)a0 exemptApplications:(id)a1 webDomains:(id)a2 categories:(id)a3 interval:(id)a4 error:(id *)a5;
...
- (id)_calculateAllExemptWebDomainsFromExemptApplications:(id)a0 categoryByBundleIdentifier:(id)a1;
- (void)queryUsageDuringInterval:(id)a0 partitionInterval:(double)a1 completionHandler:(id /* block */)a2;
- (void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)a0 exemptWebDomains:(id)a1 referenceDate:(id)a2 focalOnly:(BOOL)a3 block:(id /* block */)a4;
- (id)_calculateAllExemptBundleIdentifiersFromExemptApplications:(id)a0 categoryByBundleIdentifier:(id)a1;
- (id)queryForApplications:(id)a0 exemptApplications:(id)a1 webDomains:(id)a2 categories:(id)a3 interval:(id)a4 segmentInterval:(double)a5 error:(id *)a6;
...
- (id)queryForApplications:(id)a0 exemptApplications:(id)a1 webDomains:(id)a2 categories:(id)a3 interval:(id)a4 focalOnly:(BOOL)a5 error:(id *)a6;
- (id)init;
...
- (id)_computeWebUsageWithEvents:(id)a0 exemptWebDomains:(id)a1 timeZoneByDevice:(id)a2 lastEventDateByDevice:(id)a3 categoryUsageIntervalsByDevice:(id)a4 aggregatedApplicationUsageIntervalsByDevice:(id)a5 aggregatedWebUsageIntervalsByDevice:(id)a6 categoryByWebDomain:(id)a7 partition:(id)a8 referenceDate:(id)a9 focalOnly:(BOOL)a10;
...
- (double)_computeUsageForApplications:(id)a0 exemptApplications:(id)a1 webDomains:(id)a2 categories:(id)a3 applicationUsageEvents:(id)a4 webUsageEvents:(id)a5 nowPlayingEvents:(id)a6 videoUsageEvents:(id)a7 categoryByBundleIdentifier:(id)a8 categoryByWebDomain:(id)a9 interval:(id)a10 referenceDate:(id)a11 focalOnly:(BOOL)a12;
...
- (void)_enumerateCurrentVideoUsageIntervalsDuringInterval:(id)a0 exemptApplications:(id)a1 exemptWebDomains:(id)a2 referenceDate:(id)a3 block:(id /* block */)a4;
- (void)queryForUncategorizedLocalWebUsageDuringInterval:(id)a0 completionHandler:(id /* block */)a1;
- (id)_computeApplicationUsageWithEvents:(id)a0 exemptApplications:(id)a1 exemptWebDomains:(id)a2 unboundApplicationUsageIntervalsByDevice:(id *)a3 timeZoneByDevice:(id)a4 lastEventDateByDevice:(id)a5 categoryUsageIntervalsByDevice:(id)a6 aggregatedApplicationUsageIntervalsByDevice:(id)a7 categoryByBundleIdentifier:(id)a8 partition:(id)a9 referenceDate:(id)a10 focalOnly:(BOOL)a11;
- (id)_computeNotificationsWithEvents:(id)a0 timeZoneByDevice:(id)a1 lastEventDateByDevice:(id)a2 partition:(id)a3;
- (void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)a0 exemptApplications:(id)a1 referenceDate:(id)a2 focalOnly:(BOOL)a3 block:(id /* block */)a4;
