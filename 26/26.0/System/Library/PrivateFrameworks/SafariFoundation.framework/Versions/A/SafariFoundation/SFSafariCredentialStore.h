...
+ (void)_fetchKeychainCredentialsIfRequiredForAppID:(id)a0 withSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 webFrameIdentifier:(id)a3 isEntitledWebBrowser:(BOOL)a4 testOptions:(id)a5 completion:(id /* block */)a6;
...
+ (void)_getCredentialsForAppWithAppID:(id)a0 approvedAndValidSharedWebCredentialsDatabaseEntries:(id)a1 websiteURL:(id)a2 webFrameIdentifier:(id)a3 isEntitledWebBrowser:(BOOL)a4 hasPasskeyRequest:(BOOL)a5 testOptions:(id)a6 completionHandler:(id /* block */)a7;
