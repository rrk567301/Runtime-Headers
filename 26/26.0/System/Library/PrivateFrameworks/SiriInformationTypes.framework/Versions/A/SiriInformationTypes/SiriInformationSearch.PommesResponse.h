...
@interface SiriInformationSearch.PommesResponse : NSObject <NSSecureCoding> {
    ...
    void /* unknown type, empty encoding */ requestLocation;
    ...
    void /* unknown type, empty encoding */ albusMultiturnRewrite;
    void /* unknown type, empty encoding */ isRelatedQuestion;
    void /* unknown type, empty encoding */ previousPommesContext;
    void /* unknown type, empty encoding */ isQueryDirectQuestion;
