...
- (BOOL)deleteChatsForCommandDictionary:(id)a0;
- (id)deleteCommandDictionaryWithIncomingDictionary:(id)a0 inferredRecoverableDeleteForLegacyCommandsWithDate:(id)a1;
- (BOOL)deleteMessagePartsForCommandDictionary:(id)a0;
- (BOOL)deleteMessagesForCommandDictionary:(id)a0;
