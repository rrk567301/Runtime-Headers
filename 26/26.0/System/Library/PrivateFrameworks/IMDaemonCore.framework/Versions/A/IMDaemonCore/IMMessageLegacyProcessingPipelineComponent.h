@class IMDiMessageIDSTrustedData, IDSService, IMFilterMessagePipelineComponentContext;
...
- (id)initWithIDSTrustedData:(id)a0 messageContext:(id)a1 idsService:(id)a2 filteringContext:(id)a3;
