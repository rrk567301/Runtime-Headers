@class NSAttributedString, NSString, NSArray, IMDChat, NSDictionary, IMDiMessageIDSTrustedData, IMDAccount, NSNumber, IMDServiceSession;
...
- (id)initWithIdsTrustedData:(id)a0 editCommandGUID:(id)a1 timestamp:(id)a2 isFromStorage:(BOOL)a3 isLastFromStorage:(BOOL)a4 editedMessageGUID:(id)a5 editedMessagePartIndex:(long long)a6 editType:(unsigned long long)a7 editedMessagePartBody:(id)a8 editedMessagePartTranslation:(id)a9 editedMessagePartFileTransferGUIDs:(id)a10 shouldRetractMessageSubject:(BOOL)a11 hasEditTypeAndPartIndex:(BOOL)a12;
