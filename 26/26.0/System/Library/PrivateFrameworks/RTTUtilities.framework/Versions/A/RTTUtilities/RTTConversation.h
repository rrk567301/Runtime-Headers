...
- (id)addTranslatedTranscriptionFromOtherContactPath:(id)a0 original:(id)a1;
...
- (id)lastUtteranceForMe:(BOOL)a0 withText:(id)a1;
...
- (id)updateTranslatedTranscriptionFromOtherContactPath:(id)a0 original:(id)a1;
