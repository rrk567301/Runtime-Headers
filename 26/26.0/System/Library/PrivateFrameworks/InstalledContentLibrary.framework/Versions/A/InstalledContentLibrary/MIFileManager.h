...
- (id)mountPointForURL:(id)a0 error:(id *)a1;
...
- (id)dataForExtendedAttributeNamed:(id)a0 length:(long long)a1 fromURL:(id)a2 error:(id *)a3;
...
- (id)_dataForExtendedAttributeNamed:(id)a0 length:(long long)a1 onURL:(id)a2 orFD:(int)a3 error:(id *)a4;
- (id)_firstAvailableParentForURL:(id)a0 error:(id *)a1;
...
- (id)_traverseUntilFirstAvailableParentOfURL:(id)a0 withBlock:(id /* block */)a1;
...
- (BOOL)clearExtendedAttributesAtURL:(id)a0 error:(id *)a1;
...
- (BOOL)copyVolumeInfo:(struct { unsigned char x0[16]; char x1[16]; char x2[1024]; } *)a0 forURL:(id)a1 error:(id *)a2;
- (id)createRelativeDirectoryPath:(id)a0 inBaseDirectory:(id)a1 mode:(unsigned short)a2 class:(int)a3 error:(id *)a4;
- (id)dataForExtendedAttributeNamed:(id)a0 length:(long long)a1 fromFD:(int)a2 fdLocation:(id)a3 error:(id *)a4;
- (id)debugDescriptionForItemAtURL:(id)a0;
- (int)deviceForURLOrFirstAvailableParent:(id)a0 error:(id *)a1;
- (BOOL)enumerateExtendedAttributeNamesAtURL:(id)a0 includeCompression:(BOOL)a1 error:(id *)a2 enumerator:(id /* block */)a3;
- (id)enumerateExternalVolumesWithBlock:(id /* block */)a0;
- (id)extendedAttributesFromURL:(id)a0 error:(id *)a1;
- (id)extendedAttributesFromURL:(id)a0 includeCompression:(BOOL)a1 error:(id *)a2;
...
- (id)mountPointForVolumeUUID:(id)a0 error:(id *)a1;
...
- (BOOL)setOwnershipAtURL:(id)a0 toUID:(unsigned int)a1 gid:(unsigned int)a2 error:(id *)a3;
