...
- (int)copyDefaultContextWithAllocator:(struct __CFAllocator { } *)a0 options:(struct __CFDictionary { } *)a1 context:(struct OpaqueFigRoutingContext **)a2;
...
- (int)copySystemRemoteDisplayContextWithAllocator:(struct __CFAllocator { } *)a0 options:(struct __CFDictionary { } *)a1 context:(struct OpaqueFigRoutingContext **)a2;
...
- (int)copySystemAudioInputContextWithAllocator:(struct __CFAllocator { } *)a0 options:(struct __CFDictionary { } *)a1 context:(struct OpaqueFigRoutingContext **)a2;
