...
@property (class, nonatomic) BOOL failOnPushingChangesTimeout;
...
- (void)updateBlockedMetrics:(BOOL)a0 syncRequested:(BOOL)a1 runtimeCharacteristics:(id)a2;
- (void)updateComputeSyncMetrics:(long long)a0 silentDecryptionFailed:(BOOL)a1 error:(id)a2;
