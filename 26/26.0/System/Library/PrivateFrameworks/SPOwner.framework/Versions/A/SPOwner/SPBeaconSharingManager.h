...
- (void).cxx_destruct;
- (void)removeImportedShare:(id)a0 completion:(id /* block */)a1;
...
- (void)importDelegatedShare:(id)a0 completion:(id /* block */)a1;
- (void)importSharePreview:(id)a0 completion:(id /* block */)a1;
