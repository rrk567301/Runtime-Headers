@class _TtC11AppStoreKit20DynamicTypeTextField, NSString, NSBezierPath, NSFont, NSAttributedString;
...
@property (nonatomic, readonly) _TtC11AppStoreKit20DynamicTypeTextField *titleLabelView;
