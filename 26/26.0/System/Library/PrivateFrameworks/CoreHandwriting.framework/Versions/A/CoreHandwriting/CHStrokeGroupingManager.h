...
- (void).cxx_destruct;
- (id)initWithStrokeProvider:(id)a0 locales:(id)a1 isInlineContinuousMode:(BOOL)a2 inlineContinuousModeTargets:(id)a3;
...
- (id)simpleDrawingForStrokeGroup:(id)a0 originalDrawing:(id *)a1 orderedStrokesIDs:(id *)a2;
- (id)strokesForIdentifiers:(id)a0;
- (id)updateGroupingResult:(id)a0 addingStrokes:(id)a1 removingStrokeIdentifiers:(id)a2 orderedStrokeIdentifiers:(id)a3 lastOrderedStrokeIdentifiers:(id)a4 strokeClassificationResult:(id)a5 lastStrokeClassificationResult:(id)a6 mathStrokeGroupingResult:(id)a7 cancellationBlock:(id /* block */)a8;
