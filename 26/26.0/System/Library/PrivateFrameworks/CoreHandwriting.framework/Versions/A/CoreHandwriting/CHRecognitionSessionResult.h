@class NSData, CHDocumentLayoutAnalysisResult, NSArray, NSString, CHStrokeClutterFilter, CHStrokeClassificationResult, CHRecognitionSessionAutoRefineResult, NSDictionary, NSSet, CHStrokeGroupingResult, CHTilingResult;
...
@property (readonly, nonatomic) struct { double strokeClutterFilteringDuration; double strokeClassificationDuration; double groupingDuration; double documentLayoutAnalysisDuration; double recognitionDuration; double principalLinesDuration; double totalDuration; } generationDuration;
...
- (id)initWithStrokeProviderVersion:(id)a0 encodedStrokeProviderVersion:(id)a1 orderedStrokeIdentifiers:(id)a2 sessionMode:(long long)a3 locales:(id)a4 preferredLocales:(id)a5 declaredVariables:(id)a6 clutterFilter:(id)a7 strokeClassificationResult:(id)a8 strokeGroupingResult:(id)a9 unprocessedStrokeGroupingResult:(id)a10 tilingResult:(id)a11 documentLayoutAnalysisResult:(id)a12 recognitionResults:(id)a13 rawRecognitionResults:(id)a14 inlineContinuousModeResults:(id)a15 autoRefineResults:(id)a16 lastAutoRefineResult:(id)a17 generationDuration:(struct { double x0; double x1; double x2; double x3; double x4; double x5; double x6; })a18 recognitionEnvironment:(long long)a19;
