...
- (struct vector<std::vector<std::unordered_map<int, int>>, std::allocator<std::vector<std::unordered_map<int, int>>>> { void *x0; void *x1; void *x2; })_createCompressedInputImage:(const void *)a0;
- (struct FeatureArray { struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; } x0; struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; } x1; struct vector<float, std::allocator<float>> { float *x0; float *x1; float *x2; } x2; })_extractFeaturesFromDrawing:(id)a0 error:(id *)a1;
