@class NSError, NSString, NSArray, CHTokenizedMathResult, CHRecognitionInsightRequest, CHDrawing, NSDictionary, NSLocale, NSCharacterSet, CHTokenizedTextResult;
...
- (void)recordMathResult:(id)a0;
- (void)recordPrincipalPoints:(id)a0;
