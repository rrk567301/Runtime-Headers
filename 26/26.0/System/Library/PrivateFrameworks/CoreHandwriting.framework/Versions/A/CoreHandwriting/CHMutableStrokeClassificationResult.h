...
- (void)updateScriptByAddingNonClutterStroke:(id)a0 withClassification:(long long)a1 classificationRawResult:(id)a2;
- (void)updateStrokeIdentifier:(id)a0 withClassificationRawResult:(id)a1;
