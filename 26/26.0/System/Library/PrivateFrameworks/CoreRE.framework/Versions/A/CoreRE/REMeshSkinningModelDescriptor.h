...
- (BOOL)validateWithPayloadSize:(const void *)a0 partsOnResource:(id)a1 modelPartIndexToResourcePartIndex:(id)a2 skeletonCount:(unsigned long long)a3 error:(id *)a4;
