...
- (void)addBufferToArray:(void *)a0 name:(const char *)a1 payloadBuffer:(const void *)a2;
- (unsigned long long)estimateContainerSize;
- (id)initWithMeshAssetBuffer:(const void *)a0 payloadBuilder:(void *)a1;
- (id)initWithPayloadOffset:(unsigned int)a0 count:(unsigned int)a1 format:(unsigned long long)a2 stepFunction:(unsigned long long)a3 stride:(unsigned int)a4;
