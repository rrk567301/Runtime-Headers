@class NSString, UnitsInfo, LocalizeNumberingSystem, NSNumberFormatter, NSMutableDictionary, UnitTypeInfo, NSArray;
...
@property (nonatomic) BOOL matchLocale;
...
- (id /* block */)graphableFunction2DFor:(id)a0;
