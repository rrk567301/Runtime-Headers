@class NSTextField, NSString, NSArray, NSScrollView, AFCreditCard, RTIDocumentState, NSStackView, NSMutableArray, RTIDocumentTraits, NSPopover;
...
@property (retain, nonatomic) NSTextField *noSavedCardslabel;
