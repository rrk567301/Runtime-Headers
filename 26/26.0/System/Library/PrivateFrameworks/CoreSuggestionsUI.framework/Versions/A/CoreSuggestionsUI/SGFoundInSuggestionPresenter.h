...
- (id)init;
- (void).cxx_destruct;
- (void)_loadSuggestionsForTheFirstTime:(BOOL)a0;
- (void)_loadedRealtimeSuggestions:(id)a0 fromHostApp:(long long)a1 fromExtractionSource:(int)a2;
...
- (void)setRealtimeSuggestions:(id)a0 fromHostApp:(long long)a1 fromExtractionSource:(int)a2;
