...
+ (id)cachedValueForKey:(id)a0 cache:(id)a1 computeHandler:(id /* block */)a2;
+ (id)defaultAppURLForResult:(id)a0 typeCache:(id)a1 urlCache:(id)a2;
+ (void)filterResultsFromSections:(id)a0 queryContext:(id)a1;
