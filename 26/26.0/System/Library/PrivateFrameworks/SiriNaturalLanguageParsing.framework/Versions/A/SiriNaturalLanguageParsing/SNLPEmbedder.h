@interface SNLPEmbedder : NSObject {
    struct unique_ptr<nlv4_inference_orchestrator::orchestration::EmbedderOrchestrator, std::default_delete<nlv4_inference_orchestrator::orchestration::EmbedderOrchestrator>> { struct EmbedderOrchestrator *__ptr_; } _cppOrchestrator;
}

+ (const char *)getTokenCleanValueString:(id)a0 error:(id *)a1;
+ (id)convertCppSubwordTokenChainToObjC:(struct SubwordTokenChain { void /* function */ **x0; struct unique_ptr<std::string, std::default_delete<std::string>> { void *x0; } x1; struct PtrVector<sirinluinternal::SubwordToken> { struct vector<std::unique_ptr<sirinluinternal::SubwordToken>, std::allocator<std::unique_ptr<sirinluinternal::SubwordToken>>> { void *x0; void *x1; void *x2; } x0; } x2; })a0;
