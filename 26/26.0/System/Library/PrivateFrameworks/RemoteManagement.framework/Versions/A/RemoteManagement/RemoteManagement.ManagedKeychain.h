...
- (BOOL)removeAssetsNotMatchingStoreIdentifiers:(id)a0 scope:(long long)a1 persona:(id)a2 error:(id *)a3;
...
- (BOOL)unassignAssetsNotMatchingStoreIdentifiers:(id)a0 scope:(long long)a1 persona:(id)a2 error:(id *)a3;
