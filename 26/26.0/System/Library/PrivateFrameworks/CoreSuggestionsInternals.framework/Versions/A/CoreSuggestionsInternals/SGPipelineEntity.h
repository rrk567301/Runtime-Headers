...
- (id)initWithMessageId:(id)a0 uniqueIdentifier:(id)a1 appleMailMessageId:(id)a2 mailboxIdentifiers:(id)a3 accountType:(id)a4 mailingList:(id)a5 source:(id)a6 subject:(id)a7 date:(id)a8 author:(id)a9 textContentSnippet:(id)a10 isSent:(BOOL)a11 isPartiallyDownloaded:(BOOL)a12 hasInhumanHeaders:(BOOL)a13 primaryRecipients:(id)a14 accountHandles:(id)a15;
- (id)initWithTextMessage:(id)a0;
- (id)initWithUniqueIdentifier:(id)a0 source:(id)a1 subject:(id)a2 textContent:(id)a3 date:(id)a4 author:(id)a5 authorNickname:(id)a6 authorPhotoPath:(id)a7 isSent:(BOOL)a8;
- (BOOL)isInhuman;
