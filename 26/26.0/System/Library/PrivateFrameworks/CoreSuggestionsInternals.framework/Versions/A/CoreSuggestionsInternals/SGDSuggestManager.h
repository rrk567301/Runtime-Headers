...
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(BOOL)a1 keepPartialEvents:(BOOL)a2 keepEventsFromOldDocuments:(BOOL)a3 keepUnsupportedEventCategoryStatus:(BOOL)a4 keepUnsupportedEventCategoryStatusForTextMessage:(BOOL)a5;
+ (id /* block */)simpleWritebackHandler;
+ (id)filterAttributesForDonation:(id)a0;
+ (void)clearRequestCache;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(BOOL)a1 keepPartialEvents:(BOOL)a2 keepEventsFromOldDocuments:(BOOL)a3 keepUnsupportedEventCategoryStatus:(BOOL)a4 keepUnsupportedEventCategoryStatusForTextMessage:(BOOL)a5 keepLLMExtractionForRealTime:(BOOL)a6;
...
+ (id)entityTagForCategory:(long long)a0;
+ (id)filterPseudoEvents:(id)a0 keepPastEvents:(BOOL)a1 keepPartialEvents:(BOOL)a2 keepEventsFromOldDocuments:(BOOL)a3 keepUnsupportedEventCategoryStatus:(BOOL)a4;
...
- (id)realtimeEventsFromEnrichments:(id)a0 origin:(id)a1 participants:(id)a2 store:(id)a3 keepPastEvents:(BOOL)a4 keepPartialEvents:(BOOL)a5 keepEventsFromOldDocuments:(BOOL)a6 keepUnsupportedEventCategoryStatus:(BOOL)a7 keepUnsupportedEventCategoryStatusForTextMessage:(BOOL)a8 keepLLMExtractionForRealtime:(BOOL)a9 keepAttributesForEvents:(BOOL)a10 keepExceptions:(BOOL)a11;
...
- (id)enrichmentFromExternalExtraction:(id)a0 origin:(id)a1;
...
- (id)realtimeEventsFromEntity:(id)a0 message:(id)a1 enrichments:(id)a2 store:(id)a3 keepPastEvents:(BOOL)a4 keepPartialEvents:(BOOL)a5 keepEventsFromOldDocuments:(BOOL)a6 keepUnsupportedEventCategoryStatus:(BOOL)a7 keepUnsupportedEventCategoryStatusForTextMessage:(BOOL)a8 keepLLMExtractionForRealtime:(BOOL)a9 keepAttributesForEvents:(BOOL)a10;
...
- (BOOL)isSGEvent:(id)a0 duplicateOfEKEvent:(id)a1;
...
- (id)realtimeEventsFromEntity:(id)a0 enrichments:(id)a1 store:(id)a2;
