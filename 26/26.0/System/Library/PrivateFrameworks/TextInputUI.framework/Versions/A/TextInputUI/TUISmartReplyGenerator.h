@class TIKeyboardState, NSString, TIInputContextHistory, _TtC11TextInputUI18TUINetworkObserver, NSMutableDictionary, _TtC11TextInputUI28TUITextComposerClientWrapper, NSMutableArray, NSObject;
...
- (void)_performGenerateCandidatesForContext:(id)a0 completion:(id /* block */)a1;
...
- (void)shouldGenerateCandidatesForContext:(id)a0 completion:(id /* block */)a1;
