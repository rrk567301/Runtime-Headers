@class Backwarp, FRCBlit, Correlation, FlowAdaptationFeatureExtractor, FeatureExtractor, NSObject, FlowEstimate;
...
- (void)reshuffleFlow:(struct __CVBuffer { } *)a0 previousFlow:(struct __CVBuffer { } *)a1 destination:(struct __CVBuffer { } *)a2 waitForComplete:(BOOL)a3;
