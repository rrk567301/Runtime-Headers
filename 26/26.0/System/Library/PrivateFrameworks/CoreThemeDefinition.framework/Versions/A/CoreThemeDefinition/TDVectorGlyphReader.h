...
+ (struct CGPoint { double x0; double x1; })_anchorInOutlineCoordinateSpaceForAnchorPoint:(struct CGPoint { double x0; double x1; })a0 glyph:(struct CGSVGNode { } *)a1;
...
- (id)createInterpolatedDrawAttachmentDataForWeight:(long long)a0 size:(long long)a1 scaleFactor:(double)a2;
...
- (struct CGSVGNode { } *)_createAnchorNodeFromPoint:(struct CGPoint { double x0; double x1; })a0 withIdentifier:(struct __CFString { } *)a1;
...
- (double)_sourcePointSize;
- (void)_writeDrawAttachmentDataToRootNode:(struct CGSVGNode { } *)a0 forWeight:(long long)a1 size:(long long)a2 glyphNode:(struct CGSVGNode { } *)a3 scaleFactor:(double)a4 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a5;
- (void)_writeRotateAnchorToRootNode:(struct CGSVGNode { } *)a0 forWeight:(long long)a1 size:(long long)a2 glyphNode:(struct CGSVGNode { } *)a3 scaleFactor:(double)a4 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a5;
