...
- (id)initWithFormat:(unsigned long long)a0 docType:(id)a1 elements:(id)a2 validFrom:(id)a3 validUntil:(id)a4 deviceKey:(id)a5 signingAlgorithm:(long long)a6 timePolicy:(long long)a7;
