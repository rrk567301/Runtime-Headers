...
@property (readonly) BOOL isTALEngaged;
@property (readonly) BOOL isRunawayMitigated;
@property (readonly) BOOL wqExceededConstrainedThreadLimit;
@property (readonly) BOOL wqExceededTotalThreadLimit;
@property (readonly) BOOL wqExceededCooperativeThreadLimit;
@property (readonly) BOOL wqExceededActiveConstrainedThreadLimit;
@property (readonly) BOOL isRunningBoardActive;
@property (readonly) BOOL hasRunningBoardAssertion;
