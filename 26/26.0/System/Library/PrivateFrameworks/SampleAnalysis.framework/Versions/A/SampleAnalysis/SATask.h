...
@interface SATask : NSObject <SASerializable> {
    ...
    BOOL _hardenedHeap;
    BOOL _isRunningBoardManaged;
    BOOL _alreadyGatheredDataFromLiveProcess;
    BOOL _hasNoSharedCache;
    BOOL _mteCheckedAllocationsEnabled;
    BOOL _mteUserDataAllocationsTagged;
    BOOL _mteSoftModeEnabled;
    BOOL _mteInheritanceTurnedOn;
...
@property (readonly) BOOL hardenedHeap;
@property (readonly) BOOL isRunningBoardManaged;
...
- (id)initWithPid:(int)a0 uniquePid:(unsigned long long)a1 name:(const char *)a2 mainBinaryPath:(id)a3 forkTime:(unsigned long long)a4 loadInfos:(const struct dyld_uuid_info_64 { unsigned long long x0; unsigned char x1[16]; } *)a5 numLoadInfos:(unsigned int)a6 textExecLoadInfos:(const struct dyld_uuid_info_64 { unsigned long long x0; unsigned char x1[16]; } *)a7 numTextExecLoadInfos:(unsigned int)a8 architecture:(struct _CSArchitecture { int x0; int x1; })a9 sharedCache:(id)a10;
