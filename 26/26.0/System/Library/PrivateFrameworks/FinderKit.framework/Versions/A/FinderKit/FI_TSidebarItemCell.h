...
@interface FI_TSidebarItemCell : NSTableCellView {
    ...
    BOOL _enabled;
    struct function<NSImage *(bool, bool, bool, bool, NSTableViewRowSizeStyle, double)> { struct __value_func<NSImage *(bool, bool, bool, bool, NSTableViewRowSizeStyle, double)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } _iconGetter;
    NSTrackingArea *_trackingArea;
    struct function<void (FI_TSidebarItemCell *, bool)> { struct __value_func<void (FI_TSidebarItemCell *, bool)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } _fTrackingCallback;
...
- (void)finishMakingWithNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 iconGetter:(struct function<NSImage *(bool, bool, bool, bool, NSTableViewRowSizeStyle, double)> { struct __value_func<NSImage *(bool, bool, bool, bool, NSTableViewRowSizeStyle, double)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; })a1;
