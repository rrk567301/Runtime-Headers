...
- (void)dealloc;
- (id).cxx_construct;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })allNodes;
- (void).cxx_destruct;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })filterNodes:(const void *)a0;
