...
@interface FI_TBrowserViewDataSource : NSObject <TReadWriteLockingProtocol, TCoalescingNodeObserverProtocol> {
    ...
    struct unique_ptr<TBlockingQueue, std::default_delete<TBlockingQueue>> { struct TBlockingQueue *__ptr_; } _callBackQueue;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })flatten:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })flatten:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
