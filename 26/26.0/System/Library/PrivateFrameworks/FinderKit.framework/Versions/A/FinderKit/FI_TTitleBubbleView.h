...
@interface FI_TTitleBubbleView : FI_TDrawRectView <NSViewToolTipOwner, TTitleBadgeHost> {
    ...
    struct vector<std::pair<TitleViewBadgeID, FI_TTitleViewBadge *>, std::allocator<std::pair<TitleViewBadgeID, FI_TTitleViewBadge *>>> { void *__begin_; void *__end_; void *__cap_; } _badgeViews;
    BOOL _isDimmed;
}
...
- (struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *x0; struct CGRect *x1; struct CGRect *x2; })lineBubbleFrames;
