...
+ (id)copyProgressImageForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 iconImageSpec:(const struct IconImageSpec { double x0; double x1; BOOL x2; BOOL x3; } *)a1;
