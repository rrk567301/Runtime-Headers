...
@property (nonatomic) struct function<bool (FIAirDropListViewCellView *)> { struct __value_func<bool (FIAirDropListViewCellView *)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } ignoreClickHandler;
@property (nonatomic) struct function<void (FIAirDropListViewCellView *)> { struct __value_func<void (FIAirDropListViewCellView *)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } clickHandler;
