...
- (BOOL)addToDictionaryProperty:(id)a0 values:(id)a1 forConnectionWithUUID:(id)a2;
- (BOOL)addToDictionaryProperty:(id)a0 values:(id)a1 forEndpointWithUUID:(id)a2;
- (BOOL)appendToArrayProperty:(id)a0 values:(id)a1 forConnectionWithUUID:(id)a2;
- (BOOL)appendToArrayProperty:(id)a0 values:(id)a1 forEndpointWithUUID:(id)a2;
