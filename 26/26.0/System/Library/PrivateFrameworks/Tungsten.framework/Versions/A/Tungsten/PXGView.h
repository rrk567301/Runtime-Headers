@class PXScrollViewSpeedometer, PXUpdater, PXGAXCoalescingResponder, NSDictionary, PXGEngine, PXScrollViewController, NSObject, MTKView, PXGAnchor, NSResponder, NSString, PXGLayout, PXGViewRenderer, PXGDebugHUDLayer, NSArray, NSView, PXGMetalRenderer, PXGRectDiagnosticsLayer, NSColor;
...
@property (readonly, nonatomic) NSView *entityHostingView;
...
@property (nonatomic) BOOL isMetalViewInScrollView;
...
- (void)_realignMetalViewIfNecessaryForScrollViewController:(id)a0;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 allowedPresentationTypes:(id)a1 displayConfiguration:(struct { BOOL x0; BOOL x1; unsigned long long x2; unsigned long long x3; })a2;
