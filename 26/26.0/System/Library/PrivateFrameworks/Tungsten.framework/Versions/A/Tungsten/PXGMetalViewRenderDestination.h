...
@property (readonly, nonatomic) struct { BOOL allowHDR; BOOL allowMetalViewInScrollView; unsigned long long requiredColorSpace; unsigned long long requiredPixelFormat; } displayConfiguration;
...
- (id)initWithDisplayConfiguration:(struct { BOOL x0; BOOL x1; unsigned long long x2; unsigned long long x3; })a0;
- (id)init;
- (void).cxx_destruct;
