...
- (id)initWithTexture:(SEL)a0 chromaTexture:(id)a1 colorProgram:(id)a2 isOpaque:(id)a3 shaderFlags:(BOOL)a4 orientationTransform:(int)a5 alpha:(float)a6 suppressContentsRect:(float)a7 presentationType:(unsigned char)a8;
