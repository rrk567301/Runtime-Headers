@class PXGViewEnvironment, PXGDecoratingLayout, NSMutableArray, PXGSublayoutDataStore, NSString, NSMutableSet, PXGBasicAXGroup, PXGDataSourceChange, PXGItemsLayout, PXMediaProvider, PXGAnchor, NSArray, NSObject, NSView, PXGEntityManager, PXGSpriteDataStore, PXGSpriteMetadataStore, PXGLayoutSpriteModifier, NSIndexSet, NSHashTable;
...
@property (readonly, nonatomic) BOOL disableDebugAssertionForSublayoutUpdates;
...
+ (id)_defaultAccessibilityIdentifierForAXInfoKind:(long long)a0;
...
- (void)applySectionedChangeDetailsForSingleSection:(id)a0 dataSourceBeforeChanges:(id)a1 dataSourceAfterChanges:(id)a2 changeMediaVersionHandler:(id /* block */)a3 sectionIndexPathBeforeState:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a4;
