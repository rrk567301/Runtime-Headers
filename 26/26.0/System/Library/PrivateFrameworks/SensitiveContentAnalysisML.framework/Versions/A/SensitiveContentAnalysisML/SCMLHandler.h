...
- (id)analyzePixelBuffer:(struct __CVBuffer { } *)a0 scenePrint:(id)a1 error:(id *)a2;
- (long long)classifyPixelBuffer:(struct __CVBuffer { } *)a0 error:(id *)a1;
- (long long)classifyImage:(struct CGImage { } *)a0 scenePrint:(id)a1 error:(id *)a2;
- (id)analyzeImage:(struct CGImage { } *)a0 scenePrint:(id)a1 error:(id *)a2;
- (long long)classifyImage:(struct CGImage { } *)a0 error:(id *)a1;
- (long long)classifyPixelBuffer:(struct __CVBuffer { } *)a0 scenePrint:(id)a1 error:(id *)a2;
- (id)classifyPixelBuffer:(struct __CVBuffer { } *)a0 scenePrint:(id)a1 stagedText:(id)a2 inConversationWithIdentifier:(id)a3 error:(id *)a4;
- (id)classifyPixelBuffer:(struct __CVBuffer { } *)a0 scenePrint:(id)a1 startDate:(id)a2 endDate:(id)a3 stagedText:(id)a4 inConversationWithIdentifier:(id)a5 error:(id *)a6;
...
- (id)initWithOptionsInternal:(id)a0 error:(id *)a1;
