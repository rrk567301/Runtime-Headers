@class RWIProtocolDOMVideoProjectionMetadata, NSString, RWIProtocolDOMSpatialVideoMetadata, RWIProtocolDOMVideoColorSpace;
...
@property (retain, nonatomic) RWIProtocolDOMSpatialVideoMetadata *spatialVideoMetadata;
@property (retain, nonatomic) RWIProtocolDOMVideoProjectionMetadata *videoProjectionMetadata;
