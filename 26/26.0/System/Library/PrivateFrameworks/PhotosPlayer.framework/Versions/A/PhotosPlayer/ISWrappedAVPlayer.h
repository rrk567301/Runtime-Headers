@class NSError, NSString, AVPlayer, AVPlayerItem, ISWrappedMemoriesAppleMusicPlayer, NSMutableDictionary, NSObject, AVVideoComposition, ISWrappedAVAudioSession;
