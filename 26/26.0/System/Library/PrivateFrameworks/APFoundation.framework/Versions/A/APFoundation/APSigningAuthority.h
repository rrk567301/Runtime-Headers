@class NSString, APSigningContextStorage, NSMutableArray;
...
- (void)_setFailureStateWithError:(long long)a0 finalState:(unsigned long long)a1;
- (void)_setFailureStateWithErrorAndDestroyContext:(long long)a0 finalState:(unsigned long long)a1 contextRef:(void *)a2;
