...
+ (id)ifResultIsNil:(id)a0 setOutputError:(out id *)a1 withBlock:(id /* block */)a2;
+ (id)errorWithErrno;
+ (id)errorWithCode:(long long)a0 underlyingError:(id)a1;
+ (BOOL)ifResultIsNo:(BOOL)a0 setOutputError:(out id *)a1 withBlock:(id /* block */)a2;
...
+ (BOOL)ifResultIsNo:(BOOL)a0 setOutputError:(out id *)a1 toError:(id)a2;
...
+ (id)ifResultIsNil:(id)a0 setOutputError:(out id *)a1 toError:(id)a2;
