...
- (double)_navigationBar:(id)a0 heightForStyle:(unsigned long long)a1;
- (void)_presentTopViewController:(id)a0 push:(BOOL)a1 animated:(BOOL)a2 completion:(id /* block */)a3;
- (void)_setNeedsUpdateConstraints;
- (id)_updateBackBarButtonItem:(id)a0 navigationBarStyle:(unsigned long long)a1;
...
- (void)updateAdditionalSafeAreas;
