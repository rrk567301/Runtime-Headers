...
@property BOOL didEnqueueClickstreamMetrics;
@property BOOL didEnqueueEngagementMetrics;
@property long long currentIconPlayCount;
@property BOOL isImageSymbolImage;
@property unsigned long long jsEngagementImpressionsReportingFrequency;
...
+ (unsigned long long)_engagementReportingFrequencyWithDictionary:(id)a0;
