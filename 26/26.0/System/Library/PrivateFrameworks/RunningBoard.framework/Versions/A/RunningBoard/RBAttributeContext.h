@class RBProcessState, RBSAssertionIdentifier, RBSProcessIdentity, RBAssertion, RBDomainRestriction, NSString, NSDictionary, RBSystemState, RBProcess, RBInheritanceCollection;
