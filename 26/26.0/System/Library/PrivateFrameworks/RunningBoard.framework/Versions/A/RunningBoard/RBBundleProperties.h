@class NSString, NSURL, RBSProcessIdentity, NSSet, RBBundlePropertiesLSProvider, NSDictionary, RBBundlePropertiesBSXPCProvider, RBLSBundleProperties, RBSProcessIdentifier, RBXPCBundleProperties;
