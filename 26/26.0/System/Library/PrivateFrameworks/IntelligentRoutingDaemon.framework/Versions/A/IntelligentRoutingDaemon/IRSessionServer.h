@class NSMutableDictionary, IRRapportProvider, IRAVOutputContextController, IRAVOutputDeviceProvider, IRCleanupManager, NSObject, IRMobileAssetManager, IRDisplayMonitor, NSString, IRPersistenceManager, IRBiomeProvider, IRProximityProvider, IRBackgroundActivitiesManager, IRAnalyticsManager;
