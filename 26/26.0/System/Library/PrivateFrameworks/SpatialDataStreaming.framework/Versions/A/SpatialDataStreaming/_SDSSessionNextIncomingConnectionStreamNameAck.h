...
@interface _SDSSessionNextIncomingConnectionStreamNameAck : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct SessionNextIncomingConnectionStreamNameAck { unsigned char x0[1]; } *_ptr;
}
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct SessionNextIncomingConnectionStreamNameAck { unsigned char x0[1]; } *)a1;
