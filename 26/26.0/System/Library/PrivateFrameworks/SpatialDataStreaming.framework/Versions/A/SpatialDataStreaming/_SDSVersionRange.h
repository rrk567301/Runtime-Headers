...
@interface _SDSVersionRange : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct VersionRange { unsigned char x0[1]; } *_ptr;
}

@property (readonly, nonatomic) _SDSVersion *min;
@property (readonly, nonatomic) _SDSVersion *max;
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct VersionRange { unsigned char x0[1]; } *)a1;
