...
@interface _SDSNamedStreamResponse : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct NamedStreamResponse { unsigned char x0[1]; } *_ptr;
}
...
@property (readonly, nonatomic) NSArray *resolvedDataLayout;
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct NamedStreamResponse { unsigned char x0[1]; } *)a1;
