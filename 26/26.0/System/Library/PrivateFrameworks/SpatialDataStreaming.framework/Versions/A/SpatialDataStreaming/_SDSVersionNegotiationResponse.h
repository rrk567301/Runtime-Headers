@class _SDSVersion, AFBBufRef;

@interface _SDSVersionNegotiationResponse : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct VersionNegotiationResponse { unsigned char x0[1]; } *_ptr;
}

@property (readonly, nonatomic) BOOL hasConnectionId;
@property (readonly, nonatomic) unsigned int connectionId;
@property (readonly, nonatomic) _SDSVersion *resolvedVersion;
@property (readonly, nonatomic) _SDSVersion *sdsResolvedVersion;
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct VersionNegotiationResponse { unsigned char x0[1]; } *)a1;
