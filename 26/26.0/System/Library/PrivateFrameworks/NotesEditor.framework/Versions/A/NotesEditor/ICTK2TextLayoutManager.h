...
@property (nonatomic) BOOL suppressLocationUpdatesForRecycledViewProviders;
...
- (BOOL)canReuseMismatchedViewProviderForTextAttachment:(id)a0;
...
- (id)newViewProviderForTextAttachment:(id)a0 parentView:(id)a1 location:(id)a2;
...
- (Class)viewProviderClassForTextAttachment:(id)a0;
- (id)viewProviderForTextAttachment:(id)a0 parentView:(id)a1 location:(id)a2;
- (id)viewProviderForTextAttachment:(id)a0 parentView:(id)a1 location:(id)a2 ignoreCache:(BOOL)a3;
