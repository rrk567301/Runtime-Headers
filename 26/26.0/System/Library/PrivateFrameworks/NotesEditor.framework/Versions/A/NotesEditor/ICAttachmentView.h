@class NSString, ICMacTextView, NSTextContainer, ICAttachmentSharingServicePickerController, ICMacBaseTextView, ICMAttachmentViewOnlyController, ICServicesRolloverView, NSSharingServicePicker, NSWindow;
