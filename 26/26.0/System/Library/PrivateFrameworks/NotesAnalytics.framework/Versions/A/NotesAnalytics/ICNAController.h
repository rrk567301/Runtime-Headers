@class NSURL, AASessionManager, NSMutableDictionary, NSDate, AAUploadBatchEventConfig, AAClient, NSObject, ICNAServerEnvironment, ICNAMultiSceneSessionTracker, NSString, AAFlushManager, ICNADebugEventProcessor, NSNumber, AAAppSessionManager;
...
@property (class, readonly, nonatomic) BOOL audioTranscriptEnabled;
@property (class, readonly, nonatomic) BOOL audioSummaryEnabled;
@property (class, readonly, nonatomic) BOOL bioAuthEnabled;
@property (class, readonly, nonatomic) BOOL handwritingAutoRefineEnabled;
@property (class, readonly, nonatomic) BOOL localNotesEnabled;
@property (class, readonly, nonatomic) BOOL mathTextEnabled;
@property (class, readonly, nonatomic) BOOL mathHandwritingEnabled;
...
- (void)endSessionSynchronously:(BOOL)a0 forSessionType:(long long)a1 endReason:(long long)a2;
- (void)endSessionSynchronously:(BOOL)a0 forSessionType:(long long)a1 endReason:(long long)a2 successHandler:(id /* block */)a3;
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(long long)a1 endReason:(long long)a2 window:(id)a3;
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(long long)a1 endReason:(long long)a2 window:(id)a3 successHandler:(id /* block */)a4;
...
- (void)pushSessionLevelDataIntoSessionManager:(id)a0 withSessionType:(long long)a1 isGlobalSession:(BOOL)a2;
...
- (id)sessionDataWithType:(long long)a0 isGlobalSession:(BOOL)a1;
