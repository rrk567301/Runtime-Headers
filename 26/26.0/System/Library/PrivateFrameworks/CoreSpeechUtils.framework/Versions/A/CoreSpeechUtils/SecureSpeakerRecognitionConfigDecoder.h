@interface SecureSpeakerRecognitionConfigDecoder : NSObject {
    ...
    void /* unknown type, empty encoding */ kSatStrongAcceptThreshold;
    void /* unknown type, empty encoding */ kSatStrongRejectThreshold;
    ...
    void /* unknown type, empty encoding */ kAudioDurationProcessIntervalInMillis;
    void /* unknown type, empty encoding */ kMinAudioDurationInMillis;
    void /* unknown type, empty encoding */ kMaxAudioDurationInMillis;
    ...
    void /* unknown type, empty encoding */ defaultAudioDurationProcessIntervalInMillis;
    void /* unknown type, empty encoding */ defaultMinAudioDurationInMillis;
    void /* unknown type, empty encoding */ defaultMaxAudioDurationInMillis;
}
