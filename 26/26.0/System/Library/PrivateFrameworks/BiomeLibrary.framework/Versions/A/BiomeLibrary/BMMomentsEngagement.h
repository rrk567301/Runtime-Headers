...
@property (readonly, nonatomic) BOOL isDiagnosticSubmissionAllowed;
@property (nonatomic) BOOL hasIsDiagnosticSubmissionAllowed;
...
- (id)initWithSuggestionEvent:(id)a0 entryEvent:(id)a1 clientActivityEvent:(id)a2 onboardingFlowCompletionState:(int)a3 isJournalAppInstalled:(id)a4 isJournalAppLocked:(id)a5 isJournalSuggestionSkipped:(id)a6 isActivitySettingsSwitchEnabled:(id)a7 isCommunicationSettingsSwitchEnabled:(id)a8 isSignificantLocationSettingsSwitchEnabled:(id)a9 isMediaSettingsSwitchEnabled:(id)a10 isNearbyPeopleSettingsSwitchEnabled:(id)a11 isPhotoSettingsSwitchEnabled:(id)a12 isStateOfMindSettingsSwitchEnabled:(id)a13 isReflectionSettingsSwitchEnabled:(id)a14 isBroadSystemLocationSettingsSwitchEnabled:(id)a15 deviceType:(int)a16;
- (id)initWithSuggestionEvent:(id)a0 entryEvent:(id)a1 clientActivityEvent:(id)a2 onboardingFlowCompletionState:(int)a3 isJournalAppInstalled:(id)a4 isJournalAppLocked:(id)a5 isJournalSuggestionSkipped:(id)a6 isActivitySettingsSwitchEnabled:(id)a7 isCommunicationSettingsSwitchEnabled:(id)a8 isSignificantLocationSettingsSwitchEnabled:(id)a9 isMediaSettingsSwitchEnabled:(id)a10 isNearbyPeopleSettingsSwitchEnabled:(id)a11 isPhotoSettingsSwitchEnabled:(id)a12 isStateOfMindSettingsSwitchEnabled:(id)a13 isReflectionSettingsSwitchEnabled:(id)a14 isBroadSystemLocationSettingsSwitchEnabled:(id)a15 deviceType:(int)a16 isDiagnosticSubmissionAllowed:(id)a17;
