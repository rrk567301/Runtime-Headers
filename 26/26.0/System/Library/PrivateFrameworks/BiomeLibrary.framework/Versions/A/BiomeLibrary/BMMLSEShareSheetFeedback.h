@class NSString, NSArray, BMMLSEShareSheetFeedbackTrialIdentifier, BMPeopleSuggesterEventLevelMetrics;
...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 engagementType:(int)a1 engagementIdentifier:(id)a2 visiblePeopleSuggestionCount:(id)a3 visibleAppSuggestionCount:(id)a4 airdropPeopleSuggestionShown:(id)a5 inferenceSource:(int)a6 trialIdentifier:(id)a7 timeouts:(id)a8 productInsights:(id)a9;
