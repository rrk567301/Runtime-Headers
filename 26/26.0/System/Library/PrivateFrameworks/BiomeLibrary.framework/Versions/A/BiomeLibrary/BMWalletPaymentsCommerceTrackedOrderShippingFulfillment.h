@class NSString, BMWalletPaymentsCommerceTrackedOrderShippingRecipient, NSDate;

@interface BMWalletPaymentsCommerceTrackedOrderShippingFulfillment : BMEventBase <BMStoreData> {
