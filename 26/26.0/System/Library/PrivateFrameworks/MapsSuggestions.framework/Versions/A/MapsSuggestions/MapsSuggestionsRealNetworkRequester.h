...
- (BOOL)resolveMapItemHandleData:(id)a0 dropAnalyticsSessionID:(BOOL)a1 completion:(id /* block */)a2;
...
- (BOOL)drivingETAFromLocation:(id)a0 toLocation:(id)a1 arrivalDate:(id)a2 automobileOptions:(id)a3 completion:(id /* block */)a4;
...
- (BOOL)ETAFromWaypoint:(id)a0 toWaypoint:(id)a1 transportType:(int)a2 arrivalDate:(id)a3 automobileOptions:(id)a4 completion:(id /* block */)a5;
