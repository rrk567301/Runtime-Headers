@class WiFiAwarePairingMetadata, WiFiAwareDataSession, NSString, WiFiAwarePublisherDataSessionHandle, CUNANEndpoint, NSObject, WiFiAwarePublisher, WiFiAwarePublishServiceSpecificInfo, WiFiAwarePublishDatapathServiceSpecificInfo;
