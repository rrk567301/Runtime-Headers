@class NSMutableSet, NSString, NSArray, PKPackage, NSMutableDictionary, PKFileReference, NSMutableArray;
...
@property (retain, nonatomic) PKFileReference *bundleFileReference;
...
- (id)binarySubpathsForArch:(int)a0;
