@class NSError, HAP2SerializedOperationQueue, NSArray, NSString, HMFActivity, HAP2PropertyLock, HAPAccessoryPairingRequest, HAPSRPPairSetupSession;
...
- (id)pairAccessory:(id)a0 pairingRequest:(id)a1 delegate:(id)a2;
