...
+ (id)logCategory;
+ (id)dnsNameForHTTPHeaderFromDNSNames:(id)a0;
...
- (id)initWithSocketInfo:(id)a0 dnsName:(id)a1 eventsEnabled:(BOOL)a2 queue:(id)a3 wakeAddress:(id)a4;
- (id)initWithSocketInfo:(id)a0 dnsName:(id)a1 eventsEnabled:(BOOL)a2 queue:(id)a3 wakeAddress:(id)a4 dependencyFactory:(id)a5;
