...
- (id)description;
- (void).cxx_destruct;
- (id)initForReadingWithEndpoint:(id)a0 data:(id)a1 encrypted:(BOOL)a2 mimeType:(id)a3 dscpPriority:(long long)a4;
- (id)initForWritingWithEndpoint:(id)a0 data:(id)a1 encrypted:(BOOL)a2 mimeType:(id)a3 dscpPriority:(long long)a4;
