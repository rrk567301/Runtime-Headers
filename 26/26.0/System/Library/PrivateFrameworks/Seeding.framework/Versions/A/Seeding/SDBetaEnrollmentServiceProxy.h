...
- (void)betaEnrollmentProxyObjectWithCompletion:(id /* block */)a0;
...
- (void)queryProgramsForSystemAccountsWithPlatforms:(unsigned long long)a0 disableBuildPrefixMatching:(BOOL)a1 completion:(id /* block */)a2;
