@class GEODirectionIntent, GEOStyleAttributes, MKMapItem, GEOPublisherResult, GEOServerResultScoreMetadata, NSString, GEORetainedSearchMetadata, GEOStorageCompletion, GEOResolvedItem, NSArray, GEOSearchCategory, GEOCollectionResult;
...
@property (readonly, nonatomic, getter=_supportsOfflineDownload) BOOL supportsOfflineDownload;
