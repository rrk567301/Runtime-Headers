...
- (void)placeActionManager:(id)a0 didSelectAddToFavoritesGuideWithEnvironment:(id)a1;
- (id)poisInlineMapVC;
...
- (void)infoCardAnalyticsDidSelectAction:(int)a0 target:(int)a1 eventValue:(id)a2 actionURL:(id)a3 photoID:(id)a4 feedbackDelegateSelector:(int)a5 actionRichProviderId:(id)a6 classification:(id)a7;
...
- (void)placeActionManager:(id)a0 didSelectRateWithEnvironment:(id)a1;
