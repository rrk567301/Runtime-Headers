@class GEOPDExploreGuides, NSString, NSArray, MKMapCamera, GEOMuninViewState, GEOEnrichmentInfo, GEOURLExtraStorage, GEOMapURLParser, GEOUserSessionEntity, GEOURLDirectionsOptions, GEOURLLocationQueryItem, GEOURLCollectionStorage;
...
+ (void)urlParserForURL:(id)a0 completion:(id /* block */)a1;
