...
@property (nonatomic) BOOL captureMemoryStatistics;
...
@property (readonly, copy, nonatomic, getter=_composedRoutesForRouteLines) NSArray *composedRoutesForRouteLines;
@property (readonly, nonatomic, getter=_selectedRouteIndex) unsigned long long selectedRouteIndex;
...
- (void)_setComposedRoutesForRouteLines:(id)a0 selectedRouteIndex:(unsigned long long)a1;
