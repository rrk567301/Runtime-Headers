...
+ (id)fetchAlbumIdentifiersContainingAsset:(id)a0 options:(id)a1;
...
+ (id)fetchMomentsNeedingThemeAnalysisWithAdapterVersion:(long long)a0 uemVersion:(long long)a1 options:(id)a2;
