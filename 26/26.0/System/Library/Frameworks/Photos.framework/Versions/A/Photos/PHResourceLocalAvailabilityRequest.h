...
+ (id)_resourceInfoForAsset:(id)a0 resourcesToShare:(id)a1 assetVersion:(long long)a2 fulfillOnDemandResources:(BOOL)a3 error:(id *)a4;
+ (id)_resourcesToShareForAsset:(id)a0 asUnmodifiedOriginal:(BOOL)a1 error:(id *)a2;
+ (id)_resourcesToShareForAsset:(id)a0 options:(id)a1 error:(id *)a2;
+ (id)_singularResourcesToShareForAsset:(id)a0 fromAvailableResources:(id)a1 options:(id)a2 useOriginalResources:(BOOL)a3 knownUnsupported:(BOOL)a4 error:(id *)a5;
...
+ (BOOL)isKnownUnsupportedFormatForAsset:(id)a0;
+ (id)resourceInfoForSharingAsset:(id)a0 asUnmodifiedOriginal:(BOOL)a1 error:(id *)a2;
...
- (void)_fetchResourcesUsingPhotoKitForAsset:(id)a0 prioritizeLowResolutionResourcesForAnalysis:(BOOL)a1 options:(id)a2 networkAccessAllowed:(BOOL)a3 handler:(id /* block */)a4;
