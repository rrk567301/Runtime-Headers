...
@property (nonatomic) BOOL includeCollectionShareAssets;
...
@property (nonatomic) BOOL includePendingShares;
...
@property (nonatomic) BOOL excludeSensitiveAndUnprocessedAssets;
