...
- (void).cxx_destruct;
- (void)_addObjectIDsAndUUIDs:(id)a0 toMutableArray:(id)a1;
- (void)_addObjectIDsAndUUIDs:(id)a0 toMutableArray:(id)a1 coordinator:(id)a2;
- (void)_addObjectIDsAndUUIDsFrom:(id)a0 toXpcArray:(id)a1;
- (void)_addObjectIDsAndUUIDsFromXpcArray:(id)a0 toMutableArray:(id)a1 coordinator:(id)a2;
- (BOOL)_applyMutationsToManagedObject:(id)a0 orderedMutableChildren:(id)a1 oldSet:(id)a2 newSet:(id)a3 error:(id *)a4;
