@class NSDate, NSString, NSURL, UTType, NSMutableArray, PHAdjustmentData, PHLivePhoto, NSImage, NSObject, CLLocation, NSNumber, AVAsset;
...
@property (retain, nonatomic) NSImage *displaySizeImage;
...
- (id)initWithAppropriateURL:(id)a0;
