@class NSDate, NSString, FKContactTransactionInsight, FKPaymentTransactionInsights, FKUserTransactionInsight, FKApplePayTransactionInsight, FKMapsTransactionInsight, NSDecimalNumber, FKAmount;
