...
+ (BOOL)canSupportRefinementForStrokes:(id)a0;
+ (void)removeStrokesFromStyleInventory:(id)a0;
+ (BOOL)supportsCopyAsTextForStrokes:(id)a0;
+ (BOOL)supportsStraighteningForStrokes:(id)a0;
...
- (void)fetchIndexableContentWithCompletion:(id /* block */)a0;
- (void)fetchTranscriptionForStrokes:(id)a0 withCompletion:(id /* block */)a1;
...
- (id)initWithDrawing:(id)a0 visibleOnscreenStrokes:(id)a1 useSessionCache:(BOOL)a2 sessionCacheIdentifier:(id)a3;
...
- (id)strokesForSearchQueryItem:(id)a0 drawing:(id)a1;
- (void)supportsRefinementForStrokes:(id)a0 completionBlock:(id /* block */)a1;
- (void)tagAsActive;
- (void)tagAsIdle;
