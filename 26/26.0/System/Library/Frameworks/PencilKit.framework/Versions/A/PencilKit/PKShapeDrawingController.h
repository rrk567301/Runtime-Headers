...
@interface PKShapeDrawingController : NSObject {
    struct vector<ClipperLib::IntPoint, std::allocator<ClipperLib::IntPoint>> { struct IntPoint *__begin_; struct IntPoint *__end_; struct IntPoint *__cap_; } _currentStrokePoints;
    ...
    BOOL _hasDetected;
    BOOL _shouldDetect;
    struct vector<TimestampedPoint, std::allocator<TimestampedPoint>> { struct TimestampedPoint *__begin_; struct TimestampedPoint *__end_; struct TimestampedPoint *__cap_; } _timestampedPoints;
    struct vector<TimestampedAngles, std::allocator<TimestampedAngles>> { struct TimestampedAngles *__begin_; struct TimestampedAngles *__end_; struct TimestampedAngles *__cap_; } _timestampedAngles;
