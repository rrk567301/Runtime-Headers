...
- (id)initWithPixelSize:(struct CGSize { double x0; double x1; })a0 actualSize:(struct CGSize { double x0; double x1; })a1 singleComponent:(BOOL)a2 sixChannelBlendingMode:(long long)a3 wantsExtendedDynamicRangeContent:(BOOL)a4 metalConfig:(id)a5;
