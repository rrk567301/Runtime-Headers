...
@property (nonatomic) unsigned long long sixChannelMultiplyLayerColorAttachmentIndex;
@property (nonatomic) unsigned long long sixChannelRenderModeAddMultiplyLayersColorAttachmentIndexOffset;
...
@property (readonly, nonatomic) struct PKShaderPipelineConfig { unsigned char x0[8]; } pipelineConfig;
...
- (id)initWithCommandQueue:(id)a0 liveRendering:(BOOL)a1 defaultPipelineConfig:(struct PKShaderPipelineConfig { unsigned char x0[8]; })a2;
