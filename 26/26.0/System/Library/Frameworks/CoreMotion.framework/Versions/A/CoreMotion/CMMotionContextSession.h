...
@interface CMMotionContextSession : NSObject {
    struct unique_ptr<CMMotionContextLogger, std::default_delete<CMMotionContextLogger>> { struct CMMotionContextLogger *__ptr_; } _logger;
    BOOL _logMSL;
    ...
    struct unique_ptr<CMPdrMLModel, std::default_delete<CMPdrMLModel>> { struct CMPdrMLModel *__ptr_; } hmlModel;
    BOOL _enableMLModel;
    struct unique_ptr<CMMotionContextSessionAnalyticsTracker, std::default_delete<CMMotionContextSessionAnalyticsTracker>> { struct CMMotionContextSessionAnalyticsTracker *__ptr_; } _analyticsTracker;
