...
- (BOOL)_isAutoPauseAllowedForWorkoutType:(long long)a0;
- (BOOL)_isReminderAllowedForType:(long long)a0;
- (void)_muteAutoPauseForWorkoutType:(long long)a0 mute:(BOOL)a1;
- (void)_muteReminderType:(long long)a0 mute:(BOOL)a1;
- (void)_pauseWorkout:(id)a0;
- (void)_registerForWorkoutEvents;
- (void)_setCurrentWorkoutType:(id)a0 isManualTransition:(BOOL)a1;
- (void)_setReminderMuteSettingsForType:(long long)a0 mute:(BOOL)a1;
