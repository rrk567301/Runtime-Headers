...
- (void).cxx_destruct;
- (id)initWithUsesComputedPresentationProperties:(BOOL)a0 inComposeContext:(BOOL)a1 inSenderContext:(BOOL)a2 allowsTapping:(BOOL)a3 effectiveSizeClass:(unsigned long long)a4 overrideSubtitleButtonColor:(id)a5 overrideActionButtonColor:(id)a6 overrideSubtitle:(id)a7 captionButton:(id)a8 captionTextButton:(id)a9 secondaryCaptionButton:(id)a10;
