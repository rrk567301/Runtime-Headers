@class NSURL, NSObject, NSMutableArray, NSString, LPEvent, LPMetadataProviderSpecialization, NSTimer, WKWebView, LPFetcherGroup, NSURLRequest, LPLinkMetadata, LPAnimatedImageTranscoder, WKNavigation;
...
@interface LPMetadataProvider : NSObject <WKNavigationDelegate, LPMetadataProviderSpecializationDelegate> {
    ...
    BOOL _fetchWithDefaultUserAgentFailedPossiblyTransiently;
...
- (void)_finishedPostProcessingWithError:(id)a0;
