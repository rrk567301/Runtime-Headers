...
- (BOOL)canUseCloudKit;
- (void)completeRetrievingThumbnailForShareMetadata:(id)a0 application:(id)a1 kind:(id)a2 title:(id)a3 icon:(id)a4;
- (void)completeUsingApplication:(id)a0 kind:(id)a1 title:(id)a2 thumbnail:(id)a3 icon:(id)a4;
