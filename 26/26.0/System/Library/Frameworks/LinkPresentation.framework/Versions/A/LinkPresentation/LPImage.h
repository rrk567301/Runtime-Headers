...
@interface LPImage : NSObject <LPAsynchronousResource, LPCodable, NSSecureCoding> {
    ...
    BOOL _hasComputedTransparentRegions;
...
@property (readonly, nonatomic) BOOL _hasTransparencyInCenter;
...
+ (id)_optionalSystemImageNamed:(id)a0 withSymbolConfiguration:(id)a1;
