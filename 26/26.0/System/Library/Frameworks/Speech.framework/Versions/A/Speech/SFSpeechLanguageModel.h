...
+ (void)prepareCustomLanguageModelForUrl:(id)a0 configuration:(id)a1 completion:(id /* block */)a2;
+ (void)prepareCustomLanguageModelForUrl:(id)a0 configuration:(id)a1 ignoresCache:(BOOL)a2 completion:(id /* block */)a3;
