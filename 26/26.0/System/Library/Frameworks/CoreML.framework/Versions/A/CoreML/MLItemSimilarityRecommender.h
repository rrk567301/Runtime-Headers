...
@interface MLItemSimilarityRecommender : MLModel <MLModelSpecificationLoader, MLModeling, MLCompiledModelLoader, MLSpecificationCompiler> {
    struct vector<unsigned char, std::allocator<unsigned char>> { char *__begin_; char *__end_; char *__cap_; } m_cached_model;
    NSData *m_model_data;
    ...
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } _m_scores;
    struct vector<unsigned long long, std::allocator<unsigned long long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _m_items;
    struct vector<unsigned long long, std::allocator<unsigned long long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _m_item_buffer;
    struct vector<unsigned char, std::allocator<unsigned char>> { char *__begin_; char *__end_; char *__cap_; } _m_item_invalid_mask;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } _m_item_predictions;
    struct vector<std::pair<unsigned long long, double>, std::allocator<std::pair<unsigned long long, double>>> { void *__begin_; void *__end_; void *__cap_; } _m_item_heap;
}
