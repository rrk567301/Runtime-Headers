...
@property (readonly, nonatomic) BOOL passthroughStateFeatures;
...
- (id)initWithFeatureDescriptions:(id)a0 defaultValues:(id)a1 usingRank5Mapping:(BOOL)a2 optionalInputTypes:(id)a3 passthroughStateFeatures:(BOOL)a4;
