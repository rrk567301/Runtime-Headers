@class AVB17221AEMStreamFormat, NSArray, AVB17221AEMSamplingRate, AVBMediaClockInputThread, NSString, AVBMediaClockSource, AVBPTPClock;

@interface AVBMediaClockInputStream : AVBInputStream <AVBClockClient> {
    BOOL _isStreaming;
    ...
    unsigned long long *_presentationGrandmasters;
    ...
    BOOL _clockInHoldover;
    struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } _streamingLock;
    struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } _clockSourceLock;
}
