...
@interface MDLTransform : NSObject <NSCopying, MDLTransformComponent> {
    struct MDLAffineTransform { struct vector<std::pair<double, float __attribute__((ext_vector_type(3)))>, std::allocator<std::pair<double, float __attribute__((ext_vector_type(3)))>>> { void *__begin_; void *__end_; void *__cap_; } _keyedTranslation; struct vector<std::pair<double, float __attribute__((ext_vector_type(3)))>, std::allocator<std::pair<double, float __attribute__((ext_vector_type(3)))>>> { void *__begin_; void *__end_; void *__cap_; } _keyedRotation; struct vector<std::pair<double, float __attribute__((ext_vector_type(3)))>, std::allocator<std::pair<double, float __attribute__((ext_vector_type(3)))>>> { void *__begin_; void *__end_; void *__cap_; } _keyedShear; struct vector<std::pair<double, float __attribute__((ext_vector_type(3)))>, std::allocator<std::pair<double, float __attribute__((ext_vector_type(3)))>>> { void *__begin_; void *__end_; void *__cap_; } _keyedScale; double _startTime; double _greatestTime; BOOL _identity; BOOL _resetTransformStack; double _evaluationTime; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _transform; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _invTransform; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _jacobiRotation; struct float4x4 { void /* unknown type, empty encoding */ columns[4]; } _invJacobiRotation; } _transform;
}
