...
- (void)setTripSegmentLocationDataMask:(unsigned long long)a0;
...
- (BOOL)isSpeedValid;
- (BOOL)isTripSegmentLocationFollowedByUTurnMaskSet;
- (BOOL)isTripSegmentLocationMotionStationaryMaskSet;
