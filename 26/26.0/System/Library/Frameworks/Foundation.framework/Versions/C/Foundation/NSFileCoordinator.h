...
+ (id)_canonicalIntentsForIntents:(id)a0;
+ (id)_canonicalURLForURL:(id)a0;
+ (id)_canonicalURLForURL:(id)a0 modifyingReadingOptions:(unsigned long long *)a1 removedResolveFlags:(unsigned int *)a2;
+ (id)_canonicalURLsForURLs:(id)a0;
...
+ (id)_reconstructedURLForURL:(id)a0 resolveFlags:(unsigned int)a1;
