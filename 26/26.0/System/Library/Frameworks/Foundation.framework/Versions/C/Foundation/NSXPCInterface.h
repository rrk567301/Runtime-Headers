...
@property (class, readonly, nonatomic) NSXPCInterface *remoteViewSessionInterface;
@property (class, readonly, nonatomic) NSXPCInterface *remoteViewServiceInterface;
