@class HKProxyProvider, NSString, NSMutableDictionary, NSMutableSet, _HKCBCentralManagerLoader, AADeviceManager, AASystemStateMonitor;
...
@interface HKHealthServicesManager : NSObject <_HKXPCExportable, HKHealthServicesManagerClientInterface> {
    ...
    BOOL _audioDeviceManagerActivated;
    AASystemStateMonitor *_audioStateMonitor;
    BOOL _audioStateMonitorActivated;
}
...
- (void)_fetchHealthKitDataWriteStatusWithIdentifier:(id)a0 completion:(id /* block */)a1;
...
- (void)_getAudioAccessoryWriteStatusForIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)_getAudioHRMDevicesWithCompletion:(id /* block */)a0;
- (void)_getCBPeripheralforIdentifer:(id)a0 withCompletion:(id /* block */)a1;
- (void)_getHealthPeripheralOrServicesStatus:(id)a0 completion:(id /* block */)a1;
- (void)_getHealthPeripheralsStatus:(id)a0 withCompletion:(id /* block */)a1;
- (void)_setAudioAccessoryWriteStatusEnabled:(BOOL)a0 identifier:(id)a1 completion:(id /* block */)a2;
- (void)_setHealthKitDataWriteEnabled:(BOOL)a0 identifier:(id)a1 completion:(id /* block */)a2;
- (void)_setHealthPeripheralOrServicesStatus:(id)a0 enabled:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)healthAudioHRMDevicesWithCompletion:(id /* block */)a0;
