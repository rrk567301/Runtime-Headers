@class NSUUID, NSString, HKTaskServerProxyProvider, HKHealthStore, NSMutableDictionary, NSSet, NSMutableSet, NSObject, HKWorkoutConfiguration;
...
@property (nonatomic) BOOL collectsGeneratedTypes;
...
- (void)clientRemote_didUpdateDataSourceConfiguration:(id)a0 shouldUpdateSampleTypesToCollect:(BOOL)a1;
