...
- (void)ICECandidatesWithParams:(id)a0 completion:(id /* block */)a1;
- (void)answerWithParams:(id)a0 completion:(id /* block */)a1;
- (void)endWithParams:(id)a0 completion:(id /* block */)a1;
- (void)offerWithParams:(id)a0 completion:(id /* block */)a1;
