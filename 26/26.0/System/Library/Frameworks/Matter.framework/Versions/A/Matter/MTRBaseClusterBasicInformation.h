...
+ (void)readAttributeCapabilityMinimaWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeClusterRevisionWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeConfigurationVersionWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeDataModelRevisionWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeLocalConfigDisabledWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeLocationWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeManufacturingDateWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeMaxPathsPerInvokeWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeSpecificationVersionWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)mfgSpecificPingWithCompletion:(id /* block */)a0;
- (void)mfgSpecificPingWithParams:(id)a0 completion:(id /* block */)a1;
- (void)readAttributeAcceptedCommandListWithCompletion:(id /* block */)a0;
- (void)readAttributeAttributeListWithCompletion:(id /* block */)a0;
- (void)readAttributeCapabilityMinimaWithCompletion:(id /* block */)a0;
- (void)readAttributeClusterRevisionWithCompletion:(id /* block */)a0;
- (void)readAttributeConfigurationVersionWithCompletion:(id /* block */)a0;
- (void)readAttributeDataModelRevisionWithCompletion:(id /* block */)a0;
...
- (void)readAttributeLocalConfigDisabledWithCompletion:(id /* block */)a0;
- (void)readAttributeLocationWithCompletion:(id /* block */)a0;
- (void)readAttributeManufacturingDateWithCompletion:(id /* block */)a0;
- (void)readAttributeMaxPathsPerInvokeWithCompletion:(id /* block */)a0;
...
- (void)readAttributeSpecificationVersionWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeCapabilityMinimaWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeClusterRevisionWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeConfigurationVersionWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeDataModelRevisionWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeLocalConfigDisabledWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeLocationWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeManufacturingDateWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeMaxPathsPerInvokeWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeSpecificationVersionWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeLocalConfigDisabledWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeLocalConfigDisabledWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeLocationWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeLocationWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
