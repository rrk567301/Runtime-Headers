@class MTRJointFabricDatastoreClusterDatastoreGroupKeySetStruct, NSNumber;

@interface MTRJointFabricDatastoreClusterUpdateKeySetParams : NSObject <NSCopying>

@property (copy, nonatomic) MTRJointFabricDatastoreClusterDatastoreGroupKeySetStruct *groupKeySet;
