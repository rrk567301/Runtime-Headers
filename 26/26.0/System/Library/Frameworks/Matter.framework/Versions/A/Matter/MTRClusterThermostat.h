...
- (void)addThermostatSuggestionWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
- (void)atomicRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
...
- (id)readAttributeCurrentThermostatSuggestionWithParams:(id)a0;
...
- (id)readAttributeMaxThermostatSuggestionsWithParams:(id)a0;
...
- (id)readAttributeThermostatSuggestionNotFollowingReasonWithParams:(id)a0;
- (id)readAttributeThermostatSuggestionsWithParams:(id)a0;
...
- (void)removeThermostatSuggestionWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
