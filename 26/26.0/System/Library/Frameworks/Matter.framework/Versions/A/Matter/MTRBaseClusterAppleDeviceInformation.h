...
+ (void)readAttributeSupportsTapToUnlockWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeSupportsWEDWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeSupportsTapToUnlockWithCompletion:(id /* block */)a0;
- (void)readAttributeSupportsWEDWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeSupportsTapToUnlockWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeSupportsWEDWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
