...
+ (void)readAttributeSupportedFormatsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeCurrentConnectionsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)readAttributeFeatureMapWithCompletion:(id /* block */)a0;
- (void)readAttributeGeneratedCommandListWithCompletion:(id /* block */)a0;
- (void)readAttributeSupportedFormatsWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeSupportedFormatsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
