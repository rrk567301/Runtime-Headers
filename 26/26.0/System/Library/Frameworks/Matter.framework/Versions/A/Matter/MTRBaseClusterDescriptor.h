...
+ (void)readAttributeEndpointUniqueIDWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeEndpointUniqueIDWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeEndpointUniqueIDWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
