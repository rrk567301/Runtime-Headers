...
@interface _WKTextManipulationExclusionRule : NSObject {
    struct RetainPtr<NSString> { NSString *m_ptr; } _elementName;
    struct RetainPtr<NSString> { NSString *m_ptr; } _attributeName;
    struct RetainPtr<NSString> { NSString *m_ptr; } _attributeValue;
    struct RetainPtr<NSString> { NSString *m_ptr; } _className;
}
