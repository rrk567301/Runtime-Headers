...
@interface _WKRemoteWebInspectorViewController : NSObject <_WKInspectorExtensionHost, _WKInspectorIBActions> {
    ...
    struct unique_ptr<WebKit::_WKRemoteWebInspectorUIProxyClient, std::default_delete<WebKit::_WKRemoteWebInspectorUIProxyClient>> { struct _WKRemoteWebInspectorUIProxyClient *__ptr_; } m_remoteInspectorClient;
}
