@class NSString, RVPresenter, RVPresentingContext, RVItem;
...
@interface WKRevealItemPresenter : NSObject <RVPresenterHighlightDelegate> {
    ...
    struct RetainPtr<RVPresenter> { RVPresenter *m_ptr; } _presenter;
    struct RetainPtr<RVPresentingContext> { RVPresentingContext *m_ptr; } _presentingContext;
    struct RetainPtr<RVItem> { RVItem *m_ptr; } _item;
