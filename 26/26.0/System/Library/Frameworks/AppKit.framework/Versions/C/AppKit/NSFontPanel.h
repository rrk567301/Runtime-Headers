@class NSView, NSString, NSArray, NSSplitViewController, NSToolbar, _TtC6AppKitP33_3E10BF4A3CE530F1247E8FB13C5F4FD522FamiliesViewController, NSFontManager, _TtC6AppKitP33_3E10BF4A3CE530F1247E8FB13C5F4FD519FacesViewController, _TtC6AppKitP33_3E10BF4A3CE530F1247E8FB13C5F4FD523AccessoryViewController;
...
- (void)_setSelectedFamilyName:(id)a0;
- (void)_setSelectedFontName:(id)a0 faceName:(id)a1;
- (void)_setupTwoColumnLayout;
- (BOOL)_showEffects;
- (void)_showFaceColumn:(BOOL)a0;
- (void)_sizeEditDone:(id)a0;
- (void)_sizeListChanged:(id)a0;
- (void)_sortCollections;
- (void)_storeCollectionName:(id)a0;
...
- (void)_updateForCollection:(id)a0;
