...
@interface NSXPCSpellServerProxyClient : NSObject {
    NSXPCSpellServerClient *_xpcServer;
    NSString *_identifier;
}

+ (BOOL)isAvailableForXPCServer:(id)a0 language:(id)a1 vendor:(id)a2;
+ (id)proxyClientWithXPCServer:(id)a0 language:(id)a1 vendor:(id)a2;
...
- (id)initWithXPCServer:(id)a0 language:(id)a1 vendor:(id)a2;
