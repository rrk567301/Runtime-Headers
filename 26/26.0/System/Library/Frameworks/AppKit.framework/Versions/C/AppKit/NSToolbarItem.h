@class _NSSplitViewPartitionAdapter, NSToolbar, NSSplitView, NSMenuItem, NSToolbarItemGroup, _NSToolbarItemAuxiliary, NSToolbarItemViewer, NSString, NSSet, NSImage, NSItemBadge, NSArray, NSView, NSColor;
...
@property (readonly) BOOL needsViewConstraintsInvalidated;
...
@property (copy) NSItemBadge *badge;
