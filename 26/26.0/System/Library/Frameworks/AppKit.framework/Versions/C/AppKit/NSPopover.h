@class NSView, NSString, NSArray, NSURL, NSAppearance, NSViewController, NSWindow, _NSPopoverWindow;
...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_contentSafeAreaInsets;
...
- (struct CGSize { double x0; double x1; })safeAreaContentSize;
...
- (void)setSafeAreaContentSize:(struct CGSize { double x0; double x1; })a0;
