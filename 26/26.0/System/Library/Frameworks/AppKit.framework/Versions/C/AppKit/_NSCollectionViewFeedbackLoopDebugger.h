@interface _NSCollectionViewFeedbackLoopDebugger : NSObject {
...
- (void)recordCollectionViewInsetsPropertyChange:(id)a0 fromInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1 toInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2;
