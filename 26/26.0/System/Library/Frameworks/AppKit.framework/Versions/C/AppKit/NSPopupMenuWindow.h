@class NSCocoaMenuImpl, NSString, NSView, NSTrackingArea, NSMutableDictionary, NSGlassView;
...
@property (nonatomic) BOOL isFullScreenAuxiliary;
...
@property (readonly) NSGlassView *glassView;
