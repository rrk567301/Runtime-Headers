@class NSTextField, NSGlassView, NSFloatRange, NSMutableArray, NSImage, NSLayoutConstraint, _NSPopoverFrameAXBackgroundView, NSButton;
...
@property (retain) NSGlassView *glassView;
