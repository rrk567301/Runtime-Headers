...
@property (nonatomic) BOOL generateScreenshotGainMap;
...
@property (nonatomic) long long recordingPreset;
@property (nonatomic) BOOL hdrRecordingPreserveSDRRange;
...
+ (id)streamConfigurationWithRecordingPreset:(long long)a0;
