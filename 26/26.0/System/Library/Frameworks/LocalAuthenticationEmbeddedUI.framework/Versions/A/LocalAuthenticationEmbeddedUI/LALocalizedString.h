...
@property (class, readonly, nonatomic) NSString *passcodeRecoveryOldPasscodePrompt;
@property (class, readonly, nonatomic) NSString *passcodeRecoveryOldPasscodeSubPrompt;
...
@property (class, readonly, nonatomic) NSString *passcodeVerificationSubPrompt;
@property (class, readonly, nonatomic) NSString *passcodeChangeSubPrompt;
