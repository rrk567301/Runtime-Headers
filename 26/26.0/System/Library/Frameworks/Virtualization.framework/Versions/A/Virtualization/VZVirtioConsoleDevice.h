@class __end_, __cap_, VZVirtioConsolePortArray;
@protocol VZVirtioConsoleDeviceDelegate;

@interface VZVirtioConsoleDevice : VZConsoleDevice {
    struct vector<__weak id<VZVirtioConsoleDeviceDelegate>, std::allocator<__weak id<VZVirtioConsoleDeviceDelegate>>> { __end_ **__begin_; __cap_ **x0; id *x1; } _internalDelegates;
}
