...
- (void)acquireTokenWithSlot:(id)a0 AID:(id)a1 proprietaryCardUsage:(BOOL)a2 reply:(id /* block */)a3;
- (void)auditAuthOperation:(id)a0 auditToken:(struct { unsigned int x0[8]; })a1 success:(BOOL)a2;
- (void)configureWithReply:(id /* block */)a0;
- (id)createTokenWithSlot:(id)a0 AID:(id)a1 proprietaryCardUsage:(BOOL)a2 error:(id *)a3;
