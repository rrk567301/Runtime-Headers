...
@interface VNImageAnalyzerMultiDetector : VNDetector {
    ...
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _entityNetIndexesToReport;
    ...
    struct unique_ptr<vision::mod::ImageAnalyzer_PCA, std::default_delete<vision::mod::ImageAnalyzer_PCA>> { struct ImageAnalyzer_PCA *__ptr_; } _imageAnalyzerPCA256_DO_NOT_ACCESS_DIRECTLY;
