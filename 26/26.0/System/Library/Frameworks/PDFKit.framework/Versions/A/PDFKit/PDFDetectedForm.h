@interface PDFDetectedForm : NSObject {
    struct vector<PDFDetectedFormRow, std::allocator<PDFDetectedFormRow>> { struct PDFDetectedFormRow *__begin_; struct PDFDetectedFormRow *__end_; struct PDFDetectedFormRow *__cap_; } _rows;
...
- (struct vector<const CGDisplayListEntry *, std::allocator<const CGDisplayListEntry *>> { struct CGDisplayListEntry **x0; struct CGDisplayListEntry **x1; struct CGDisplayListEntry **x2; })_collectGlyphEntriesInDisplayList:(struct CGDisplayList { } *)a0 medianGlyphHeight:(double *)a1;
