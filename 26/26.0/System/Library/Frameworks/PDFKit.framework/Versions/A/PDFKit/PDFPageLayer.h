@class NSDate, NSString, CALayer, NSMutableDictionary, PDFPage, NSMutableArray, NSObject, PDFRenderingProperties, PDFTimer;
...
- (void)initPageCornerRadiusForMagnification:(double)a0;
