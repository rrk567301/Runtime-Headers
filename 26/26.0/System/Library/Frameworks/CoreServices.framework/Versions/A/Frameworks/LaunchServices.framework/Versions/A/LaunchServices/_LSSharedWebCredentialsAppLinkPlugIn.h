...
- (struct optional<LSBinding> { union { char x0; struct LSBinding { unsigned int x0; struct LSBundleData *x1; unsigned int x2; struct *x3; id x4; id x5; unsigned long long x6; } x1; } x0; BOOL x1; })bindingWithContext:(struct LSContext { id x0; } *)a0 forServiceDetails:(id)a1 callingBundleIdentifier:(id)a2;
