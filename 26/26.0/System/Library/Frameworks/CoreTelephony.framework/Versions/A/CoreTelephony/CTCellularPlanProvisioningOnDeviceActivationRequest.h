...
@property (nonatomic) BOOL portIn;
...
- (id)initWithDetails:(id)a0 installIccid:(id)a1 sourceIccid:(id)a2 unusableIccid:(id)a3 phoneNumber:(id)a4 mcc:(id)a5 mnc:(id)a6 gid1:(id)a7 gid2:(id)a8 smdp:(id)a9 useDS:(BOOL)a10 esim:(BOOL)a11 flowType:(id)a12 portIn:(BOOL)a13;
