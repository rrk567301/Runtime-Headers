...
- (id)security;
- (id)initWithContext:(id)a0 destination:(id)a1 messageID:(id)a2 descriptor:(id)a3 security:(id)a4;
- (id)initWithContext:(id)a0 groupChatURI:(id)a1 messageID:(id)a2 descriptor:(id)a3 security:(id)a4;
