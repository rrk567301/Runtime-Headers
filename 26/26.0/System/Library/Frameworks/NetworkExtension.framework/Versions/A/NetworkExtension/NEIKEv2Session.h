@class NSMutableDictionary, NEIPSecSASession, NSObject, NWEndpoint, NEIKEv2Packet, NSMutableArray, NEIKEv2IKESA, NEIKEv2ConfigurationMessage, NSString, NSMutableSet, NSArray, NEIKEv2RTT, NEIKEv2ChildSAConfiguration, NEIKEv2IKESAConfiguration;
