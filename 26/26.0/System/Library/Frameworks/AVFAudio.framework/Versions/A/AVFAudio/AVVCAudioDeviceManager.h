...
+ (BOOL)IsSiriSupportedExternalDeviceString:(id)a0;
...
+ (BOOL)IsExternalDisplayModelUID:(id)a0;
...
+ (BOOL)isDeviceAlive:(unsigned int)a0;
+ (BOOL)isDeviceMuted:(unsigned int)a0 isInputDevice:(BOOL)a1;
+ (BOOL)isProcessDeviceInputRunning:(unsigned int)a0;
...
+ (void)setReporterIDs:(struct vector<long long, std::allocator<long long>> { long long *x0; long long *x1; long long *x2; })a0 onDevice:(id)a1;
