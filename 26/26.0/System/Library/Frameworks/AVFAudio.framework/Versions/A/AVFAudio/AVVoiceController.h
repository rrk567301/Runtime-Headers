...
- (void)handleAudioHALDeviceWentAway:(unsigned long long)a0;
...
- (BOOL)setEnableInterruptionByRecordingClientsForStream:(unsigned long long)a0 enable:(BOOL)a1 error:(id *)a2;
