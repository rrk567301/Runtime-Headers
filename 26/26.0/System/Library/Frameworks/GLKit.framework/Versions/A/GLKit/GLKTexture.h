...
- (BOOL)determineCGImageBlockFormatWithComponentType:(int)a0 alphaInfo:(unsigned int)a1 andPixelSize:(unsigned long long)a2 andColorModel:(int)a3 isOptimized:(BOOL)a4;
