...
@property (nonatomic) struct function<DSP_HAL_Mock_TestHooks ()> { struct __value_func<DSP_HAL_Mock_TestHooks ()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } testHookFetcher;
