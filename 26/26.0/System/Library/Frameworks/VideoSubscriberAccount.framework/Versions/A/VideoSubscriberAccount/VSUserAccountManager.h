...
- (id)init;
- (void).cxx_destruct;
- (void)_runAutoSignInServiceCallWithSuccessHandler:(id /* block */)a0 failureHandler:(id /* block */)a1;
- (void)deleteAutoSignInTokenWithCompletionHandler:(id /* block */)a0;
...
- (void)queryAutoSignInTokenWithCompletionHandler:(id /* block */)a0;
