@class NSTimer, NSString, NSArray, NSTrackingArea, CALayer, QLOverlayProgressButtonLayer, QLOverlayButtonLayer, QLOverlayView, NSObject, QLOverlayGlassBackground, QLOverlayLoadingButtonLayer;
...
@interface QLPreviewOverlayController : NSObject <QLAccessibilityUIElementDelegate> {
    ...
    QLOverlayGlassBackground *_playButtonBackground;
    QLOverlayGlassBackground *_leftPageButtonBackground;
    QLOverlayGlassBackground *_rightPageButtonBackground;
