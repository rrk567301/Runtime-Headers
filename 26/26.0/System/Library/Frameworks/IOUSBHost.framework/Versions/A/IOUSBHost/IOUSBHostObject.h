...
- (unsigned long long)currentMicroframeWithTime:(unsigned long long *)a0 error:(id *)a1;
...
- (unsigned long long)referenceMicroframeWithTime:(unsigned long long *)a0 error:(id *)a1;
