@class MPModelAlbum, NSString, NSDate, MPModelRadioStation, MPModelArtist, MPModelPlaylist, MPModelGroup;
...
+ (id)playEventWithModelObject:(id)a0 nestedPlayEvent:(id)a1 featureName:(id)a2;
