...
- (id)_initWithLibrary:(id)a0 playlist:(id)a1 initialTrackList:(id)a2 initialItemList:(id)a3 playlistProperties:(id)a4 playlistEntryProperties:(id)a5 authorProfile:(id)a6;
...
- (id)initWithLibrary:(id)a0 initialItemList:(id)a1 playlistProperties:(id)a2 playlistEntryProperties:(id)a3 authorProfile:(id)a4;
