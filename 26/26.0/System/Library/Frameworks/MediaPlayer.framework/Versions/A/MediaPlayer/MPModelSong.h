@class MPGaplessInfo, MPModelArtist, MPModelHomeSharingAsset, MPModelFileAsset, NSDate, NSURL, MPModelComposer, NSString, MPModelPreviewAsset, MPModelLyrics, MPModelPlaybackPosition, MPModelGenre, MPModelAlbum, MPModelStoreAsset;
...
- (id)humanDescription;
- (id)animatedArtworkCatalogForFormat:(long long)a0;
- (id)artworkCatalog;
