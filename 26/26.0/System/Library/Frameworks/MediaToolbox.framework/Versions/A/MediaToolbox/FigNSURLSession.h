...
@property (readonly, nonatomic) BOOL usesNWLoader;
...
- (id)initWithClientBundleIdentifier:(id)a0 clientPersonaIdentifier:(id)a1 dispatchQueue:(id)a2 useNWLoader:(BOOL)a3;
