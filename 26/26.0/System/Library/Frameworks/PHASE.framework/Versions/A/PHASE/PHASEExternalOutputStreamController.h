@class NSUUID, NSNumber, PHASEMixerDefinition, PHASENumberMetaParameterDefinition, NSMutableDictionary, NSDictionary, PHASEListener, PHASESource, PHASEGroup, PHASEEngine;
