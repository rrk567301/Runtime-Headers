...
@interface SCNPhysicsBallSocketJoint : SCNPhysicsBehavior {
    struct { SCNPhysicsBody *bodyA; SCNPhysicsBody *bodyB; struct SCNVector3 { double x; double y; double z; } anchorA; struct SCNVector3 { double x; double y; double z; } anchorB; } _definition;
...
+ (id)jointWithBody:(id)a0 anchor:(struct SCNVector3 { double x0; double x1; double x2; })a1;
+ (id)jointWithBodyA:(id)a0 anchorA:(struct SCNVector3 { double x0; double x1; double x2; })a1 bodyB:(id)a2 anchorB:(struct SCNVector3 { double x0; double x1; double x2; })a3;
...
- (id)initWithBody:(id)a0 anchor:(struct SCNVector3 { double x0; double x1; double x2; })a1;
- (id)initWithBodyA:(id)a0 anchorA:(struct SCNVector3 { double x0; double x1; double x2; })a1 bodyB:(id)a2 anchorB:(struct SCNVector3 { double x0; double x1; double x2; })a3;
