...
- (id)CAMLType;
- (id)_pas_filteredSetWithTest:(id /* block */)a0;
- (id)_pas_mappedSetWithTransform:(id /* block */)a0;
- (id)_pas_setByRemovingObject:(id)a0;
- (id)_pas_setByRemovingObjectsFromSet:(id)a0;
- (id)bm_setBySubtractingSet:(id)a0;
- (id)aaf_filter:(id /* block */)a0;
- (id)aaf_map:(id /* block */)a0;
- (id)aaf_setByRemovingObjectsFromSet:(id)a0;
- (id)aaf_mapStoppable:(id /* block */)a0;
- (id)aaf_setByRemovingObject:(id)a0;
