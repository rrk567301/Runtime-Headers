...
+ (id)_cfurlWithString:(id)a0 encoding:(unsigned int)a1 relativeToURL:(id)a2 encodingInvalidCharacters:(BOOL)a3 forceBaseURL:(BOOL)a4;
+ (id)_fileURLWithPath:(id)a0 isDirectory:(BOOL)a1 relativeToURL:(id)a2;
+ (id)_fileURLWithPath:(id)a0 pathStyle:(long long)a1 isDirectory:(BOOL)a2 relativeToURL:(id)a3;
...
+ (id)_fileURLWithPath:(id)a0 relativeToURL:(id)a1;
...
+ (id)_urlWithDataRepresentation:(id)a0 relativeToURL:(id)a1 isAbsolute:(BOOL)a2;
+ (id)_urlWithString:(id)a0 relativeToURL:(id)a1 encodingInvalidCharacters:(BOOL)a2;
...
+ (id)_lp_URLWithUserTypedString:(id)a0 relativeToURL:(id)a1;
+ (id)_lp_URLWithData:(id)a0 baseURL:(id)a1;
+ (id)__unurl;
...
- (id)_lp_simplifiedStringForDisplayOnly:(BOOL)a0;
