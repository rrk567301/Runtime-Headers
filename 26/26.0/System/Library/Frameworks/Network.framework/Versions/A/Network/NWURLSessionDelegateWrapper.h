...
@interface NWURLSessionDelegateWrapper : NSObject {
    ...
    unsigned char checked_needNewBodyStreamFromOffset : 1;
    ...
    unsigned char checked__didConnect : 1;
    unsigned char checked_didReceiveInformationalResponse : 1;
    ...
    unsigned char checked_downloadDidReceiveResponse : 1;
    ...
    unsigned char accept_needNewBodyStreamFromOffset : 1;
    ...
    unsigned char accept__didConnect : 1;
    unsigned char accept_didReceiveInformationalResponse : 1;
    ...
    unsigned char accept_downloadDidReceiveResponse : 1;
