...
@protocol OS_nw_interface, OS_nw_browser, OS_dispatch_group, OS_nw_context, OS_nw_endpoint, OS_nw_parameters, OS_dnssd_getaddrinfo, OS_dispatch_queue, OS_nw_array, OS_nw_path_evaluator, OS_nw_path;
...
@interface NWConcrete_nw_resolver : NSObject <OS_nw_resolver> {
    ...
    unsigned char allow_encrypted_dns_name_resolution_failover : 1;
    unsigned char config_allows_failover : 1;
    unsigned char config_fell_back : 1;
    unsigned char has_completed_preferred_weighting : 1;
    unsigned char use_persistent_cache : 1;
    unsigned char use_agent_resolver : 1;
}
