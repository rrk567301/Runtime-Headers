...
@interface NWConcrete_nw_endpoint_proxy : NSObject <OS_nw_endpoint_proxy> {
    ...
    unsigned char privacy_proxy_strict_fail_closed : 1;
    ...
    unsigned char proxy_race_timeout : 1;
    unsigned char proxy_failed : 1;
    unsigned char proxy_finished_transport : 1;
}
