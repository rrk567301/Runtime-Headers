@class NSString, AVRoutingWeakReference, AVOutputDeviceAuthorizationRequest, AVOutputDeviceAuthorizationSession, AVFigEndpointUIAgentOutputDeviceAuthorizationRequestImpl;
