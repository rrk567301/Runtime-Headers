...
@property (readonly) NSNumber *threadCredentialManagementEnabled;
...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithUUID:(id)a0 nodeID:(id)a1 vendorID:(id)a2 productID:(id)a3 deviceType:(id)a4 serialNumber:(id)a5 name:(id)a6 setupPayload:(id)a7 threadCredentialManagementEnabled:(id)a8;
