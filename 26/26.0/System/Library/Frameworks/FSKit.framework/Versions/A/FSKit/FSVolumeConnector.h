@class FSItemGetAttributesRequest, FSWorkQueue, FSModuleVolume, NSXPCConnection;
...
- (void)getFreeSpaceInVolumeWithReplyHandler:(id /* block */)a0;
- (void)getIOItemAttributesSubsetData:(id)a0 replyHandler:(id /* block */)a1;
