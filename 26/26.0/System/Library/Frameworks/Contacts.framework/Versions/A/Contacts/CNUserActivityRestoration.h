...
+ (id)exactMatchForNameAndAtLeastOneHandleFromPayload:(id)a0 containerIdentifiers:(id)a1 contactStore:(id)a2;
+ (BOOL)exactNameMatchFoundForPayload:(id)a0 withContact:(id)a1;
