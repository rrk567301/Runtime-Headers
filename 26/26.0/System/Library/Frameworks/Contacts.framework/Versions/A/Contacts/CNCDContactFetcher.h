...
@property (retain) NSArray *contactPosterItems;
...
+ (id)contactCountForFetchRequest:(id)a0 inPersistenceStack:(id)a1 posterDataStore:(id)a2 error:(id *)a3;
+ (id)contactsForFetchRequest:(id)a0 inPersistenceStack:(id)a1 posterDataStore:(id)a2 error:(id *)a3;
...
- (id)initWithFetchRequestDescription:(id)a0 persistenceContext:(id)a1 posterDataStore:(id)a2;
...
- (void)withLockedContext_fetchPosterData;
