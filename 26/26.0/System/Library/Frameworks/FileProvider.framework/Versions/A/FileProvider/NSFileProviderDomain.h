@class NSString, NSDictionary, NSData, NSError, NSNumber, NSUUID;
...
@property (readonly, nonatomic) BOOL experimentIDIsValid;
...
@property BOOL supportsStringSearchRequest;
