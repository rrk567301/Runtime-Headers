@class NSUUID, NSString, NSData, NSDate, NSArray, NSURL, NSDictionary, SHArtwork, CLLocation;
...
@property (readonly) SHArtwork *artwork;
...
- (struct CGSize { double x0; double x1; })targetArtworkImageSizeFromTargetSize:(struct CGSize { double x0; double x1; })a0 aspectRatio:(double)a1;
