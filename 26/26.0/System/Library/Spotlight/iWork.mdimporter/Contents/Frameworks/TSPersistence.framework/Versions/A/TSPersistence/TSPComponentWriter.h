...
@interface TSPComponentWriter : NSObject {
    ...
    struct vector<TSP::ObjectStackEntry, std::allocator<TSP::ObjectStackEntry>> { struct ObjectStackEntry *__begin_; struct ObjectStackEntry *__end_; struct ObjectStackEntry *__cap_; } _objectStack;
