...
- (struct vector<TSTCellBorder *, std::allocator<TSTCellBorder *>> { id *x0; id *x1; id *x2; })accumulateCellBordersConcurrentlyInRow:(struct TSUModelRowIndex { unsigned int x0; })a0 atColumns:(void *)a1;
