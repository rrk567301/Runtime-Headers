...
@property (readonly, nonatomic) struct vector<_NSRange, std::allocator<_NSRange>> { struct _NSRange *__begin_; struct _NSRange *__end_; struct _NSRange *__cap_; } rangeVector;
