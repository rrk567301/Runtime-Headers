...
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; })p_charIndicesForAttributeArray:(struct TSWPAttributeArray { void /* function */ **x0; struct TSWPAttributeRecord *x1; id x2; unsigned int x3 : 32; unsigned char x4 : 8; unsigned char x5 : 1; } *)a0;
...
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; })p_charIndicesForString:(id)a0 breakingCharacterSet:(id)a1;
