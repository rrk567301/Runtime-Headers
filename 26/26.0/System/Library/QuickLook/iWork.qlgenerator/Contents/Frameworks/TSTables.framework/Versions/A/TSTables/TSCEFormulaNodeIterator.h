...
@interface TSCEFormulaNodeIterator : NSObject {
    ...
    struct vector<TSCEReplacedFormulaNodePair, std::allocator<TSCEReplacedFormulaNodePair>> { struct TSCEReplacedFormulaNodePair *__begin_; struct TSCEReplacedFormulaNodePair *__end_; struct TSCEReplacedFormulaNodePair *__cap_; } _replacedNodes;
}
