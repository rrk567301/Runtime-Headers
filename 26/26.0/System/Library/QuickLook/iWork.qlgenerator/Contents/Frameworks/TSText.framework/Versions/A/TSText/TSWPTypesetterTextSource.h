...
@interface TSWPTypesetterTextSource : NSObject <TSWPTextSource> {
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _spaceCharIndexes;
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _bidiCharIndexes;
    struct vector<bool, std::allocator<bool>> { unsigned long long *__begin_; unsigned long long __size_; unsigned long long __cap_; } _bidiDirectionMarkIsRTLVector;
