...
@interface TSTUidCoordsPerRunningCellValue : NSObject {
    struct vector<TSCECellValue *, std::allocator<TSCECellValue *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _cellValues;
    struct vector<TSTUidCoordsPerGroupValueTuple *, std::allocator<TSTUidCoordsPerGroupValueTuple *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _uidCoords;
}
