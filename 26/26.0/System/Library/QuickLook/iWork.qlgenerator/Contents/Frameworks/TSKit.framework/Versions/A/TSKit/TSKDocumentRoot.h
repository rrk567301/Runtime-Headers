@class TSKPasteboardController, NSString, _TtC5TSKit39TSKSimpleCollaborationSuspensionManager, TSKAccessController, NSDictionary, TSKDocumentSupport, TSULocale, TSKAnnotationAuthorStorage, TSKAnnotationAuthor, TSKSelectionDispatcher, TSKChangeNotifier;
