...
@interface TNChartFormulaWrapper : TSCKSosBase {
    ...
    struct vector<TSUCellCoord, std::allocator<TSUCellCoord>> { struct TSUCellCoord *__begin_; struct TSUCellCoord *__end_; struct TSUCellCoord *__cap_; } _cachedChromeCoords;
...
- (struct vector<std::pair<TSCEValue *, TSUCellCoord>, std::allocator<std::pair<TSCEValue *, TSUCellCoord>>> { void *x0; void *x1; void *x2; })outputVectorValuesWithChromeCoords:(id)a0 shouldSkipHiddenData:(BOOL)a1;
