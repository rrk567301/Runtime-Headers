@interface TSWPAdornments : NSObject {
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _charIndexes;
    struct vector<unsigned short, std::allocator<unsigned short>> { unsigned short *__begin_; unsigned short *__end_; unsigned short *__cap_; } _glyphs;
    struct vector<unsigned short, std::allocator<unsigned short>> { unsigned short *__begin_; unsigned short *__end_; unsigned short *__cap_; } _flippedGlyphs;
    struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *__begin_; struct CGPoint *__end_; struct CGPoint *__cap_; } _positions;
    struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *__begin_; struct CGPoint *__end_; struct CGPoint *__cap_; } _flippedPositions;
    struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct CGRect *__cap_; } _rects;
    struct vector<TSWPAttachmentPosition, std::allocator<TSWPAttachmentPosition>> { struct *__begin_; struct *__end_; struct *__cap_; } _attachmentPositions;
}
