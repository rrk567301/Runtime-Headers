@class TSCEValueGridIndexer, __cap_, __end_;

@interface TSCEValueGrid : NSObject <NSCopying> {
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct TSCEBitGridTile **__cap_; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _coords;
    TSCEValueGridIndexer *_indexer;
    struct vector<TSCEValue *, std::allocator<TSCEValue *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _valueForIndex;
...
- (struct vector<TSCEValue *, std::allocator<TSCEValue *>> { id *x0; id *x1; id *x2; })allValues;
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
