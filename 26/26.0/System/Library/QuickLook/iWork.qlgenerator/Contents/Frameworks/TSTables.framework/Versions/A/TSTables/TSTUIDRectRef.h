...
@interface TSTUIDRectRef : NSObject <NSCopying> {
    struct TSKUIDStructTract { struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct TSKUIDStruct *__cap_; } _colIdList; struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct TSKUIDStruct *__cap_; } _rowIdList; } _uidRange;
    TSCECellTractRef *_lastKnownTractRef;
    unsigned long long _viewMapVersionCounter;
    TSTColumnRowUIDMapper *_viewUidMapper;
    BOOL _lastKnownTractRefIsBase;
}
...
@property (readonly, nonatomic) struct TSKUIDStructTract { struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct TSKUIDStruct *x2; } x0; struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct TSKUIDStruct *x2; } x1; } uidRange;
...
- (struct vector<RefTypeHolder<TSCERangeRef, 0>, std::allocator<RefTypeHolder<TSCERangeRef, 0>>> { void *x0; void *x1; void *x2; })baseRangeRefs;
...
- (struct vector<RefTypeHolder<TSCERangeRef, 1>, std::allocator<RefTypeHolder<TSCERangeRef, 1>>> { void *x0; void *x1; void *x2; })viewRangeRefs;
