@class TSWPShapeStyle, TSWPParagraphStyle, __cap_, __end_, TSTTableStyle, TSTCellStyle;
...
@interface TSTTableStyleNetwork : TSPObject <TSTStyleProviding> {
    ...
    struct vector<TSTCellStyle *, std::allocator<TSTCellStyle *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _cellStyles;
    struct vector<TSWPParagraphStyle *, std::allocator<TSWPParagraphStyle *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _textStyles;
}
