...
@interface TSTTableDataStore : TSPContainedObject <TSTCompatibilityVersionProviding> {
    ...
    struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *__begin_; struct TSUCellRect *__end_; struct TSUCellRect *__cap_; } _mergedRects;
...
- (struct vector<TSTCell *, std::allocator<TSTCell *>> { id *x0; id *x1; id *x2; })accumulateCurrentCellsConcurrentlyInRow:(struct TSUModelRowIndex { unsigned int x0; })a0 rowInfo:(id)a1 atColumns:(void *)a2 usingCellCreationBlock:(id /* block */)a3;
...
- (struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; struct TSUCellRect *x1; struct TSUCellRect *x2; })mergedRects;
