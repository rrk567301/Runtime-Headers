...
+ (struct vector<TNChartFormulaType, std::allocator<TNChartFormulaType>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; })persistentFormulaTypes;
