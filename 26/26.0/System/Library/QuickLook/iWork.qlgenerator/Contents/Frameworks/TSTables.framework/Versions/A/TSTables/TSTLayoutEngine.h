@class NSIndexSet, TSTDupContentCache, TSTFontInfoCache, TSTTextStyleToFontHeightCache, __end_, NSMutableArray, TSDFill, NSMutableSet, TSTMergeRangeSortedSet, NSString, TSKChangeNotifier, NSMutableDictionary, NSPointerArray, __cap_, NSCountedSet, TSTHiddenRowsColumnsCache, NSObject, TSDInfoGeometry, TSUWidthLimitedQueue, TSTCellSelection, TSWPColumnStyle, TSTWidthHeightCache, TSTLayout, TSTLayoutDynamicResizeInfo, TSTConcurrentMutableIndexSet, TSTStrokeDefaultVendor, TSTTextEngineDelegate, TSTCellRegion, TSTWPColumnCache, TSTTableInfo, TSUColor, TSTStrokeWidthCache, TSDLayoutGeometry;
...
@interface TSTLayoutEngine : NSObject <TSTTableHiddenRowColumnProviding, TSTTableInternalGeometryProviding, TSTTableMergeRangeProviding> {
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _topRowStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _bottomRowStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _leftColumnStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _rightColumnStrokes;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } _tableDefaultFontHeightForArea;
...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })defaultPaddingForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0;
...
- (id)newLayoutHint;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })paddingForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0;
...
- (id)newTextEngineForCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 textStyle:(id)a2 naturalAlignment:(int)a3 cellDirection:(int)a4;
...
- (void)p_invalidateForStyleProviderChangeWithBroadcast:(BOOL)a0;
- (id)p_resolvedTextStyleForCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 textStyle:(id)a2 outNaturalAlignment:(int *)a3 outCellDirection:(int *)a4;
