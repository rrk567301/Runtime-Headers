...
+ (struct vector<TSKOperationPropertyId, std::allocator<TSKOperationPropertyId>> { unsigned short *x0; unsigned short *x1; unsigned short *x2; })propertyIdsForPropertyNames:(id)a0 allowUnknown:(BOOL)a1;
