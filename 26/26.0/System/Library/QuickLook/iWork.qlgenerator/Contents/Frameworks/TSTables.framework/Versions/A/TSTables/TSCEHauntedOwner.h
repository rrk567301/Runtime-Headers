...
+ (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })spillBlockedByBeingVerticalPrecedentForTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
+ (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })spillBlockedByContentPrecedentForTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
+ (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })spillBlockedByMergePrecedentForTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
+ (struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; })spillPrecedentForTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0;
