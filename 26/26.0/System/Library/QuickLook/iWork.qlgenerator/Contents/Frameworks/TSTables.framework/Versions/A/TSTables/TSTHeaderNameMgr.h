@class TSCECalculationEngine, NSString, TSCENameTrie, NSMutableSet, NSCharacterSet, __cap_, __end_;
...
@interface TSTHeaderNameMgr : TSPObject <TSTCellWillChangeProtocol, TSCEFormulaOwning> {
    ...
    struct vector<TSCECellRef, std::allocator<TSCECellRef>> { struct TSCECellRef *__begin_; struct TSCECellRef *__end_; struct TSCECellRef *__cap_; } _removeFormulasDuringWritePhase;
}
...
- (struct TSCECellRefSet { struct map<TSKUIDStruct, TSCECellCoordSet, std::less<TSKUIDStruct>, std::allocator<std::pair<const TSKUIDStruct, TSCECellCoordSet>>> { struct __tree<std::__value_type<TSKUIDStruct, TSCECellCoordSet>, std::__map_value_compare<TSKUIDStruct, std::__value_type<TSKUIDStruct, TSCECellCoordSet>, std::less<TSKUIDStruct>>, std::allocator<std::__value_type<TSKUIDStruct, TSCECellCoordSet>>> { void *x0; struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x1; unsigned long long x2; } x0; } x0; })headerCellsMatching:(id)a0 limitToTable:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 includePrefixes:(BOOL)a2;
- (id)initWithContext:(id)a0 calcEngine:(id)a1;
- (void)integrateReservedPrecedents;
- (struct TSCECellRefSet { struct map<TSKUIDStruct, TSCECellCoordSet, std::less<TSKUIDStruct>, std::allocator<std::pair<const TSKUIDStruct, TSCECellCoordSet>>> { struct __tree<std::__value_type<TSKUIDStruct, TSCECellCoordSet>, std::__map_value_compare<TSKUIDStruct, std::__value_type<TSKUIDStruct, TSCECellCoordSet>, std::less<TSKUIDStruct>>, std::allocator<std::__value_type<TSKUIDStruct, TSCECellCoordSet>>> { void *x0; struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x1; unsigned long long x2; } x0; } x0; })nameFragmentPrecedentsForReferenceString:(id)a0;
...
- (struct vector<NSString *, std::allocator<NSString *>> { id *x0; id *x1; id *x2; })wordFragmentsFromString:(id)a0 savePreserveFlags:(BOOL)a1;
