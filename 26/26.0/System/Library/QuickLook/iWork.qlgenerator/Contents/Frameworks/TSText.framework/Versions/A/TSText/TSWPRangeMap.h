...
@property (nonatomic) struct vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> { struct _TSWPCharIndexAndAffinity *__begin_; struct _TSWPCharIndexAndAffinity *__end_; struct _TSWPCharIndexAndAffinity *__cap_; } unmappedIndexes;
@property (nonatomic) struct vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> { struct _TSWPCharIndexAndAffinity *__begin_; struct _TSWPCharIndexAndAffinity *__end_; struct _TSWPCharIndexAndAffinity *__cap_; } mappedIndexes;
