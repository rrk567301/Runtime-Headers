...
@interface AGXG14XFamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    ...
    struct { AGXG14XFamilyPerformanceStateAssertion *existingAssertion; struct AGXA_UnfairLock { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } lock; } performance_state_assertion;
}
