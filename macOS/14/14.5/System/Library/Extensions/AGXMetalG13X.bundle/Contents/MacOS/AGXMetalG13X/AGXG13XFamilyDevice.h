@class MTLArchitecture, NSString, NSArray, NSMutableDictionary, NSDictionary, NSObject, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSPointerArray, AGXG13XFamilyPerformanceStateAssertion;
...
@interface AGXG13XFamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    ...
    struct { AGXG13XFamilyPerformanceStateAssertion *existingAssertion; struct AGXA_UnfairLock { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } lock; } performance_state_assertion;
}
