@class MTLArchitecture, NSString, NSArray, NSMutableDictionary, NSDictionary, AGXG14GFamilyPerformanceStateAssertion, NSObject, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSPointerArray;
...
@interface AGXG14GFamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    ...
    struct { AGXG14GFamilyPerformanceStateAssertion *existingAssertion; struct AGXA_UnfairLock { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } lock; } performance_state_assertion;
}
