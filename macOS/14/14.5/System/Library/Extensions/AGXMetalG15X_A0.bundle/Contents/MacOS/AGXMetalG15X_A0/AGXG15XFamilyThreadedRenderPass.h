...
@interface AGXG15XFamilyThreadedRenderPass : IOGPUMetalParallelRenderCommandEncoder <MTLParallelRenderCommandEncoderSPI> {
    void *_impl;
    NSObject<OS_dispatch_queue> *dispatchQueue;
    struct vector<AGXG15XFamilyRenderContext *, std::allocator<AGXG15XFamilyRenderContext *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG15XFamilyRenderContext **, std::allocator<AGXG15XFamilyRenderContext *>> { id *__value_; } x1; } _subOBJCRenderCommandEncoders;
