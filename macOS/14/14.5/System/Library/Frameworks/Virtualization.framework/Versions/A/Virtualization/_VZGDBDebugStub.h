...
- (struct Expected<Base::FileDescriptor, NSError *> { union storage<Base::FileDescriptor, NSError *> { char x0; struct FileDescriptor { int x0; } x1; id x2; } x0; BOOL x1; })_prepareServerSocket;
