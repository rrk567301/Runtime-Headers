...
- (id)initWithInfo:(const struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; id x10; } x0[22]; BOOL x1; BOOL x2; } *)a0;
...
- (void)initAuxiliaryButtonsWithInitInfo:(const struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; id x10; } x0[22]; BOOL x1; BOOL x2; } *)a0;
...
- (id)initWithController:(id)a0 initInfo:(const struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; id x10; } x0[22]; BOOL x1; BOOL x2; } *)a1;
- (id)initWithIdentifier:(id)a0 info:(const struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; id x10; } x0[22]; BOOL x1; BOOL x2; } *)a1;
- (void)populateEncodedInitInfo:(struct { struct { id x0; BOOL x1; BOOL x2; union { struct { int x0; BOOL x1; float x2; long long x3; } x0; struct { int x0; int x1; int x2; int x3; } x1; } x3; int x4; BOOL x5; BOOL x6; BOOL x7; id x8; id x9; id x10; } x0[22]; BOOL x1; BOOL x2; } *)a0;
