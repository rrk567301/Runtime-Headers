...
@interface ASCredentialPickerPaneViewController : ASCredentialRequestPaneViewController <_ASCredentialAuthenticationViewControllerDelegate, _ASCredentialListViewControllerDelegate, _ASAuthenticationPresentationProvider, ASCredentialRequestSubPaneConfirmButtonDelegate, NSTableViewDataSource> {
