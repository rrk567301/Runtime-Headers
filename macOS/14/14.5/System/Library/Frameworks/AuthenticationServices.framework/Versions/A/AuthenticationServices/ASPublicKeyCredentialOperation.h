@class WBSSavedAccountStore, NSMutableDictionary, NSDictionary, NSObject, _WKWebAuthenticationPanel, NSString, LAContext, WBSSavedAccountContext, ASCPublicKeyCredentialAssertionOptions, ASCPublicKeyCredentialCreationOptions, NSData, NSError, NSUUID;
...
@property (nonatomic) BOOL requestUsedNonEmptyAllowList;
@property (readonly, nonatomic) WBSSavedAccountStore *partialAccountStore;
