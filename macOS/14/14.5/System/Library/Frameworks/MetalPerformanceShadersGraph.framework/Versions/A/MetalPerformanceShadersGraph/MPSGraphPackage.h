...
- (id)getMLIRLibrary;
- (id)getPackageKeyForPlatform:(unsigned long long)a0 andMinimumDeploymentTarget:(struct MPSGraphOperatingSystemVersion { long long x0; long long x1; long long x2; })a1;
- (id)getPlistData;
