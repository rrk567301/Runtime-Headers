...
+ (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })_normalizedToPageTransformForPage:(id)a0 displayBox:(long long)a1 boxHeight:(double *)a2;

- (id)init;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)_addFormElementsFromAnalysis:(id)a0 displayBox:(long long)a1 toPage:(id)a2;
