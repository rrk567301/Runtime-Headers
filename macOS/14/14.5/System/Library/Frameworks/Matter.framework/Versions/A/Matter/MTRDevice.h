@class MTRDeviceController, NSDate, MTRAsyncWorkQueue, NSMutableDictionary, MTRWeakReference, NSObject, NSMutableArray, NSMutableSet, NSNumber;
@protocol OS_dispatch_queue;

@interface MTRDevice : NSObject {
    BOOL _delegateDeviceCachePrimedCalled;
    NSMutableDictionary *_clusterData;
    NSMutableSet *_clustersToPersist;
}
...
- (void)_noteChangeForClusterPath:(id)a0;
...
- (void)_setAttributeValues:(id)a0 reportChanges:(BOOL)a1;
...
- (void)setAttributeValues:(id)a0 reportChanges:(BOOL)a1;
