@class NSUUID, MTRDeviceControllerFactory, NSMutableDictionary, MTRCommissionableBrowser, NSObject, NSMutableArray, MTRDeviceControllerDataStore, NSNumber;
...
- (id)initWithFactory:(id)a0 queue:(id)a1 storageDelegate:(id)a2 storageDelegateQueue:(id)a3 otaProviderDelegate:(id)a4 otaProviderDelegateQueue:(id)a5 uniqueIdentifier:(id)a6;
...
- (void)preparePASESessionMetric:(unsigned long long)a0;
