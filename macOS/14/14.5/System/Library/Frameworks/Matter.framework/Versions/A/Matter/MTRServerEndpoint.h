...
@interface MTRServerEndpoint : NSObject {
    ...
    struct unique_ptr<EmberAfCluster[], std::default_delete<EmberAfCluster[]>> { struct __compressed_pair<EmberAfCluster *, std::default_delete<EmberAfCluster[]>> { struct *__value_; } __ptr_; } _matterClusterMetadata;
    struct { struct *cluster; unsigned char clusterCount; unsigned short endpointSize; } _matterEndpointMetadata;
    struct unique_ptr<EmberAfDeviceType[], std::default_delete<EmberAfDeviceType[]>> { struct __compressed_pair<EmberAfDeviceType *, std::default_delete<EmberAfDeviceType[]>> { struct *__value_; } __ptr_; } _matterDeviceTypes;
