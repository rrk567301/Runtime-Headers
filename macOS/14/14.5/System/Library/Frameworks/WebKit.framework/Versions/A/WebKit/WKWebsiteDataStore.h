...
@interface WKWebsiteDataStore : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebsiteDataStore> { struct type { unsigned char __lx[312]; } data; } _websiteDataStore;
...
- (void)_setStorageAccessPromptQuirkForTesting:(id)a0 withSubFrameDomains:(id)a1 completionHandler:(id /* block */)a2;
