...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })clipRectForSDFVertices:(const struct PKMetalSDFStrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; } *)a0 numVertices:(unsigned long long)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })clipRectForStrokeVertices:(const struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a0 numVertices:(unsigned long long)a1;
