@class NSButtonImageView, NSWidgetView, NSObject, NSButtonTextField, NSUserInterfaceCompressionOptions, _NSButtonCellAux, NSFont, NSString, NSImageSymbolConfiguration, NSImage, NSAttributedString, NSView, NSColor;
...
@property (retain, setter=_setAccessoryWidgetView:) NSWidgetView *_accessoryWidgetView;
...
- (void)_checkboxOrRadioFrameSize:(struct CGSize { double x0; double x1; } *)a0 alignmentInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; } *)a1 inView:(id)a2;
...
- (void)_removeAccessoryWidgetView;
...
- (void)_unconstrainedImageOrProgressAlignmentSize:(struct CGSize { double x0; double x1; } *)a0 alignmentInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; } *)a1 forFrameRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 inView:(id)a3;
- (void)_updateAccessoryWidgetDefinition:(id)a0;
- (void)_updateAccessoryWidgetViewWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inView:(id)a1;
