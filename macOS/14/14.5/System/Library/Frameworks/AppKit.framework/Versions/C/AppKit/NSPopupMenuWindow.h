@class NSString, NSView, NSTrackingArea, NSContextMenuImpl;

@interface NSPopupMenuWindow : NSWindow <NSWindowDelegate, NSMenuWindow> {
...
@property (readonly, nonatomic) NSContextMenuImpl *associatedImpl;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_exclusionRectForSubmenusOf:(id)a0;
...
- (void)_setUpFirstResponderIfNeeded;
