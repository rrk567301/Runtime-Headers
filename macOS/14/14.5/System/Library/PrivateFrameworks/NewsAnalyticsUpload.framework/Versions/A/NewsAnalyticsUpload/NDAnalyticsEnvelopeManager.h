@class NDAnalyticsUploadScheduler, NDAnalyticsPayloadAssembler, NDAnalyticsTelemetryUploader, FCKeyValueStore, NDAnalyticsEnvelopeStore, NSString, NFMutexLock, NSObject, NDAnalyticsPayloadUploader;
