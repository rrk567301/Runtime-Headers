...
@interface VCSymptomReporter : NSObject {
    ...
    BOOL _didSubmitABCSymptom[55];
    BOOL _didShowAlreadyExistFailure[55];
...
- (int)reportAudioConnectionTimeFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportAudioErasurePercentageFromTelemetryWithOptionalDictionary:(id)a0;
...
- (int)reportPoorConnectionPercentageFromTelemetryWithOptionalDictionary:(id)a0;
...
- (int)reportVideoConnectionTimeFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportVideoStall:(id)a0;
- (int)reportVideoStallPercentageFromTelemetryWithOptionalDictionary:(id)a0;
