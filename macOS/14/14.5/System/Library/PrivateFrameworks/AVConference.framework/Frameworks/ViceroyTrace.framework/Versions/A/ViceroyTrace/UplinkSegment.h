@class VCReportingHistogram, VCHistogram, NSMutableDictionary, VCReportingDistribution, VCReportingDeltaDistribution, NSNumber;
...
@interface UplinkSegment : MultiwaySegment {
    ...
    VCReportingDeltaDistribution *transmitterAVHostTimeData;
}
...
- (void)processKeyFrameReceived:(unsigned int)a0;
- (void)processKeyFrameRequestSent:(unsigned int)a0;
...
- (void)processStreamGroupStats:(id)a0;
