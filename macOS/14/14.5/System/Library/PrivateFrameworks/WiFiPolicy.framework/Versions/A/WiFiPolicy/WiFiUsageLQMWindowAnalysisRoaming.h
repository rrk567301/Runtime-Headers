...
- (id)initWithRollingWindow:(id)a0 WithRoamingState:(BOOL)a1 andReasonString:(id)a2 andStatus:(unsigned long long)a3 asString:(id)a4 andLatency:(unsigned long long)a5 andRoamData:(id)a6 andCurrentBSSSession:(id)a7 andContext:(struct context { BOOL x0; BOOL x1; BOOL x2; })a8 andPingPongStats:(id)a9 andTimestamp:(id)a10 onQueue:(id)a11;
