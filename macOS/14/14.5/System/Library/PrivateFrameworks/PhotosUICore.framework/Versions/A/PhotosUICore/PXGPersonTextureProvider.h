@interface PXGPersonTextureProvider : PXGTextureProvider {
    void /* unknown type, empty encoding */ $__lazy_storage_$_requestIDController;
    void /* unknown type, empty encoding */ lightLoadingImage;
    void /* unknown type, empty encoding */ darkLoadingImage;
}
