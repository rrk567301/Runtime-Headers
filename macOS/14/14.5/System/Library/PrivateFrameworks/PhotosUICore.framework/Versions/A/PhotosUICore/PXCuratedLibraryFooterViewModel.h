@class PXCPLPhotoLibrarySource, NSString, NSArray, PXCPLUIStatusProvider, PXFooterSettings, PXCuratedLibraryViewModel, PHPhotoLibrary, PXFilterFooterController, PXSharedLibraryStatusProvider, PXLibraryFilterState, PXCuratedLibraryAnalysisStatus, PXAssetsDataSourceCountsController;
