...
- (id)_initWithSymbolImageName:(id)a0 tintColorName:(id)a1 name:(id)a2 modeIdentifier:(id)a3 semanticType:(long long)a4 visibility:(unsigned long long)a5 identifier:(id)a6 placeholderExcludedPlatforms:(id)a7;
