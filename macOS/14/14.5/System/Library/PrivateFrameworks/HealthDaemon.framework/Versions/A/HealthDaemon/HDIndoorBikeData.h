...
+ (id)unitTest_fakeIndoorBikeDataForInstantaneousCadence:(double)a0 averageCadence:(double)a1 instantaneousSpeed:(double)a2 totalDistance:(unsigned int)a3 instantaneousPower:(short)a4 averagePower:(short)a5 energy:(unsigned short)a6 elapsedTime:(unsigned short)a7;
