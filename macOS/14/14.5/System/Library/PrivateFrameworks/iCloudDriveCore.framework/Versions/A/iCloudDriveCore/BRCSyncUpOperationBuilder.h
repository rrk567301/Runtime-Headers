@class BRCUserDefaults, BRCSyncUpOperation, BRCAccountSessionFPFS, BRCLocalItem, NSData, NSMutableSet, NSMutableDictionary;
...
@property (readonly, nonatomic) BRCLocalItem *itemNeedingBasehashSalting;
