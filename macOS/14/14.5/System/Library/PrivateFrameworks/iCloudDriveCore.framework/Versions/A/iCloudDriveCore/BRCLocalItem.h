...
@property (readonly, nonatomic) BOOL shouldUseAdvancedDataProtection;
...
- (id)structureRecordBeingDeadInServerTruth:(BOOL)a0 shouldPCSChainStatus:(unsigned char)a1 inZone:(id)a2 saltGetter:(id /* block */)a3 childBasehashSalt:(id)a4;
- (id)structureRecordBeingDeadInServerTruth:(BOOL)a0 stageID:(id)a1 shouldPCSChainStatus:(unsigned char)a2 saltGetter:(id /* block */)a3 childBasehashSalt:(id)a4;
