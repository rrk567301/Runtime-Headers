@class BRNotificationQueue, NSString, NSHashTable, NSMutableDictionary, BRCClientRanksPersistedState, NSObject, NSMutableSet, BRCXPCClient, NSMapTable, BRCAccountSessionFPFS;
