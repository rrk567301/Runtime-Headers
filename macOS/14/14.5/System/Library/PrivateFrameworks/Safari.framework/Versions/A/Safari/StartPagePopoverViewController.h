@class NSView, NSString, NSScrollView, NSArray, CollectionViewPlus, NSStackView, WBSStartPageSectionManager, ToggleRowItem, NSLayoutConstraint, NSPopover, NSCollectionView, NSIndexPath;
@protocol StartPagePopoverDelegate;

@interface StartPagePopoverViewController : NSViewController <WBTabGroupManagerObserver, NSCollectionViewDataSource, CollectionViewPlusDelegate, NSFilePromiseProviderDelegate, NSPopoverDelegate> {
...
- (void)_setEnabledSectionsForStartPageManager:(id)a0 withSectionOrdering:(id)a1;
