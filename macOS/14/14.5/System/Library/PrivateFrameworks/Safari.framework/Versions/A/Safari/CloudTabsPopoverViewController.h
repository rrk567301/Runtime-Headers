...
@interface CloudTabsPopoverViewController : NSViewController <NSOutlineViewDataSource, NSPopoverDelegate, CloudTabsPopoverOutlineViewDelegate, AccessibleRolloverActionButtonTableCellViewDelegate, RolloverActionButtonTableCellViewDelegate, WBTabGroupManagerObserver> {
