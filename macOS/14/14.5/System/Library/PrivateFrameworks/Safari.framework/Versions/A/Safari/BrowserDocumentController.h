...
- (id)_createEmptyBrowserDocumentWithBrowsingMode:(unsigned long long)a0 profileIdentifier:(id)a1 websiteDataStore:(id)a2 initialSize:(struct CGSize { double x0; double x1; })a3 options:(unsigned long long)a4;
