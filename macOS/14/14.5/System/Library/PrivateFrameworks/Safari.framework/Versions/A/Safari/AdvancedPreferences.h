@class NSTextField, NSMenuItem, NSView, EnableDevelopMenuButtonHostViewController, NSGridRow, NSGridView, NSPopUpButton, WKWebpagePreferences, NSButton, NSComboBox;
