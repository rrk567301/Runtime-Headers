...
- (id)batchOfRecordsToWriteWithLimit:(long long)a0 recurseCount:(int)a1 error:(id *)a2;
...
- (BOOL)updateLegacyTransferGUIDOn:(id)a0 andUpdateMessageIfNeeded:(id)a1 transfersToSync:(id)a2;
