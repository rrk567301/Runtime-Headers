@class NSMutableDictionary, NSDate, HMFMessageDispatcher, NSDictionary, NSObject, HMDTriggerPolicy, NSMutableArray, NSString, NSSet, HMDUser, NSArray, HMDHome, NSUUID;
