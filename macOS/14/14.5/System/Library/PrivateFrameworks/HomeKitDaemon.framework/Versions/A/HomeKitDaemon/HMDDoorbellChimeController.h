...
- (void)notifyAccessoriesViaCoordinationFreePathWithDelay:(double)a0 home:(id)a1 shouldPlayChime:(BOOL)a2 personIdentificationText:(id)a3 nexusNotificationDestinationIDs:(id)a4 logEvent:(id)a5;
