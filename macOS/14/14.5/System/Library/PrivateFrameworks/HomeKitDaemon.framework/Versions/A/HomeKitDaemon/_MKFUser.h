@class Protocol, NSArray, NSPredicate, NSDictionary, HMDAccountIdentifier, NSDate, MKFUserDatabaseID, HAPPairingIdentity, HMDAccountHandle, _MKFOutgoingInvitation, NSString, CKRecordID, _MKFUserAccessCode, NSSet, NSNumber, NSData, CKDeviceToDeviceShareInvitationToken, _MKFHome, NSUUID;
