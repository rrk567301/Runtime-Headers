...
@protocol HMDMediaDestinationManagerFactory, HMESubscriptionProviding, HMAccessoryCapabilities, HMELastEventStoreReadHandle, OS_os_log, HMDSoftwareUpdateInstallProvider, HMDAppleMediaAccessoryDataSource, HMMLogEventSubmitting, HMEEventForwarder, HMDAppleMediaAccessoryDependencyFactory, HMDMessageRouter, HMDSoftwareUpdateEventProvider, HMDMediaDestinationControllerFactory;
