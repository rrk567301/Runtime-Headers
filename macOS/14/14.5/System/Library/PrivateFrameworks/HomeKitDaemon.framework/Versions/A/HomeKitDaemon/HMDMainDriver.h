@class HMDNetworkInfoController, HMDCloudManager, HMDSymptomManager, NSObject, HMDUpdater, HMDCoreData, HMDDiscoveryController, HMDHomeManager, HMDAccessoryBrowser, HMDCurrentAccessorySetupMetricDispatcher, NSString, HMDMetricsManager, HMDAppleMediaAccessoryDiagnosticInfoController, HMDRetailDemoModeRequestHandler, HMDDeviceSetupConfiguringController;
...
@property (retain, nonatomic) HMDDiscoveryController *discoveryController;
