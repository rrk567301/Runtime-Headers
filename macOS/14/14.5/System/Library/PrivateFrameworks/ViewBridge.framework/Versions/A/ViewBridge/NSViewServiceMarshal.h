@class NSVB_ViewServiceBehaviorProxy, NSObject, NSServiceViewController, NSMutableArray, NSResponder, NSLayoutConstraint, NSString, NSCFRunLoopObserver, NSViewBridge, NSWindow, NSArray, NSAccessibilityRemoteUIElement, NSXPCInterface, NSXPCConnection;
...
- (void)connectAccessoryContext:(unsigned int)a0;
