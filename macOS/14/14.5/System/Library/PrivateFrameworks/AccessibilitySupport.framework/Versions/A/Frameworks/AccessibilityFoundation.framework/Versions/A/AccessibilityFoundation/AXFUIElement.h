...
- (struct __AXTextMarker { } *)_accessibilityEndTextMarkerForBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (struct __AXTextMarker { } *)_accessibilityStartTextMarkerForBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (struct __AXTextMarkerRange { } *)_accessibilityTextMarkerRangeForNSRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
