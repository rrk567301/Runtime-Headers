...
+ (id)filterOutUnlikelyMatchesFromTopHits:(id)a0 forQuery:(id)a1 searchProvider:(id)a2;
+ (BOOL)includeBookmarksAndHistory:(id)a0;
+ (BOOL)matchNavigationIsClientOrServerError:(id)a0;
+ (BOOL)shouldAutocompleteToURL:(id)a0 fromUserTypedString:(id)a1 withPredictedQueryString:(id)a2;
