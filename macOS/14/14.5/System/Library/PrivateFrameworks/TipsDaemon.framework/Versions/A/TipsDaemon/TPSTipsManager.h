@class TPSWidgetController, NSString, NSArray, TPSNotificationController, TPSMetadata, NSDictionary, TPSWelcomeInformation, TPSTipStatusController, TPSExperiment, NSMutableArray, NSObject, NSBundle;
