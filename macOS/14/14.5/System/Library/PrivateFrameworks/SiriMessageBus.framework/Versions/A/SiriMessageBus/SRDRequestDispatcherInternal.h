...
- (void)startDirectActionRequestWithAssistantId:(id)a0 requestId:(id)a1 inputOrigin:(id)a2 directAction:(id)a3 requestExecutionParameters:(id)a4 audioSource:(id)a5 audioDestination:(id)a6 responseMode:(id)a7 isEyesFree:(BOOL)a8 isVoiceTriggerEnabled:(BOOL)a9 isTextToSpeechEnabled:(BOOL)a10 isTriggerlessFollowup:(BOOL)a11 bargeInModes:(id)a12 approximatePreviousTTSInterval:(id)a13 deviceRestrictions:(id)a14 voiceTriggerEventInfo:(id)a15 voiceAudioSessionId:(unsigned int)a16 isSystemApertureEnabled:(BOOL)a17;
- (void)startDirectActionRequestWithAssistantId:(id)a0 requestId:(id)a1 inputOrigin:(id)a2 directAction:(id)a3 requestExecutionParameters:(id)a4 audioSource:(id)a5 audioDestination:(id)a6 responseMode:(id)a7 isEyesFree:(BOOL)a8 isVoiceTriggerEnabled:(BOOL)a9 isTextToSpeechEnabled:(BOOL)a10 isTriggerlessFollowup:(BOOL)a11 bargeInModes:(id)a12 approximatePreviousTTSInterval:(id)a13 deviceRestrictions:(id)a14 voiceTriggerEventInfo:(id)a15 voiceAudioSessionId:(unsigned int)a16 isSystemApertureEnabled:(BOOL)a17 isInAmbient:(BOOL)a18;
