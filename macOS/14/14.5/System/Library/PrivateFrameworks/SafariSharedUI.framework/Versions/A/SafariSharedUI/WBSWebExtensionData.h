...
@interface WBSWebExtensionData : WBSSafariExtension <WKNavigationDelegate, WKUIDelegate, _WKInspectorExtensionDelegate, WBSWebExtensionDataForwarding, NSSecureCoding, NSCopying> {
    NSMapTable *_backgroundWebViewsByInspectorExtensionHost;
    ...
    BOOL _isSessionStorageAllowedInContentScriptsValuePopulated;
...
@property (readonly, nonatomic) _WKWebExtension *webKitExtension;
...
@property (nonatomic, getter=isSessionStorageAllowedInContentScripts) BOOL sessionStorageAllowedInContentScripts;
...
@property (copy, nonatomic) NSSet *sessionRulesIDs;
@property (copy, nonatomic) NSSet *dynamicRulesIDs;
...
- (BOOL)_readSessionStorageAllowedInContentScriptsValueFromDisk;
...
- (BOOL)sessionStorageAllowedInContentScripts;
