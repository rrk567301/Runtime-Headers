...
- (id)initWithForYouConfiguration:(id)a0 appConfiguration:(id)a1 topStoriesChannelID:(id)a2 hiddenFeedIDs:(id)a3 allowPaidBundleFeed:(BOOL)a4 mutedTagIDs:(id)a5 purchasedTagIDs:(id)a6 rankedAllSubscribedTagIDs:(id)a7 bundleSubscriptionProvider:(id)a8;
