...
- (void)_finalizeTodayResultsWithSectionDescriptors:(id)a0 catchUpOperationResultsBySectionDescriptor:(id)a1 appConfiguration:(id)a2 feedPersonalizer:(id)a3 todayData:(id)a4 completion:(id /* block */)a5;
