...
- (BOOL)pruneEventsOfRemote:(id)a0 withReason:(unsigned long long)a1 error:(id *)a2 predicateBlock:(id /* block */)a3;
- (void)pruneEventsOfRemote:(id)a0 withReason:(unsigned long long)a1 usingPredicateBlock:(id /* block */)a2;
