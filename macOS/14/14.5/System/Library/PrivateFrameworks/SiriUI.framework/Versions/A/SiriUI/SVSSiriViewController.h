@class SAAceView, NSMutableDictionary, SAUISayIt, NSObject, AFUISiriViewController, AFConversationStore, NSMutableArray, NSString, SRUIFAnalyticsSupplement, NSTimer, SiriUIRequestOptions, NSMutableSet, SiriUISiriLanguage, AFManagedStorageConnection, SRUIFAceCommandRecords;
