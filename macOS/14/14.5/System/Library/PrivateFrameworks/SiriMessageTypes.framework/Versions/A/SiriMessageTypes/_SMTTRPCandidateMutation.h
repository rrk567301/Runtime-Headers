...
@interface _SMTTRPCandidateMutation : NSObject <SMTTRPCandidateMutating> {
    ...
    NSArray *_tcuList;
    NSString *_userId;
    struct _mutationFlags { unsigned char isDirty : 1; unsigned char hasTrpCandidateId : 1; unsigned char hasRequestId : 1; unsigned char hasTcuList : 1; unsigned char hasUserId : 1; } _mutationFlags;
}
