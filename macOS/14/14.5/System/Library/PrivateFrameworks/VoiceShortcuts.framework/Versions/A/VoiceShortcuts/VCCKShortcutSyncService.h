@class NSError, NSString, NSMutableDictionary, CKSyncEngine, CKSyncEngineSendChangesOptions, VCCKApplicationStateObserver, CKRecordZoneID, CKSyncEngineFetchChangesOptions, WFDatabase;
