...
- (BOOL)getUInt64:(unsigned long long *)a0 forKey:(BOOL)a1;
- (id)initWithUInt64s:(const unsigned long long *)a0 forKeys:(const BOOL *)a1 count:(unsigned long long)a2;
- (void)removeUInt64ForKey:(BOOL)a0;
...
- (void)setUInt64:(unsigned long long)a0 forKey:(BOOL)a1;
