...
- (BOOL)getUInt32:(unsigned int *)a0 forKey:(unsigned int)a1;
- (id)initWithUInt32s:(const unsigned int *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
- (void)removeUInt32ForKey:(unsigned int)a0;
...
- (void)setUInt32:(unsigned int)a0 forKey:(unsigned int)a1;
