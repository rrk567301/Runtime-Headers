...
- (BOOL)isRemindersZoneThatNeedsUpdate:(struct _OpaquePCSShareProtection { } *)a0;
...
- (void)_locked_checkIdentitiesForService:(unsigned long long)a0 withSyncKeyRegistryRetry:(BOOL)a1 keySyncAnalytics:(id)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(BOOL)a0 requestorOperationID:(id)a1 keySyncAnalytics:(id)a2 completionHandler:(id /* block */)a3;
- (void)_locked_decryptCurrentPerParticipantPCSDataOnSharePCS:(id)a0 shareModificationDate:(id)a1 requestorOperationID:(id)a2 completionHandler:(id /* block */)a3;
- (void)_locked_decryptPCSDataOnSharePCS:(id)a0 shareModificationDate:(id)a1 withPublicSharingKey:(id)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
- (void)_locked_markMissingIdentitiesFromFailedDecryptError:(struct __CFError { } *)a0 serviceName:(id)a1;
- (void)_locked_pcsDataFromFetchedShare:(id)a0 withPublicSharingKey:(id)a1 withServiceType:(unsigned long long)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)checkIdentitiesForService:(unsigned long long)a0 withSyncKeyRegistryRetry:(BOOL)a1 requestorOperationID:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)createZonePCSWithSyncKeyRegistryRetry:(BOOL)a0 requestorOperationID:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)keyRollIfNeededForPerRecordPCS:(id)a0 forOperation:(id)a1 didRoll:(BOOL *)a2;
...
- (void)pcsDataFromFetchedShare:(id)a0 withPublicSharingKey:(id)a1 withServiceType:(unsigned long long)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)synchronizeUserKeyRegistryForServiceType:(unsigned long long)a0 shouldThrottle:(BOOL)a1 context:(id)a2 requestorOperationID:(id)a3 completionHandler:(id /* block */)a4;
