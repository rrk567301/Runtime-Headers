@class NSURL, ICAssetGenerationManager, ICAttachmentModel, NSDate, NSPredicate, NSDictionary, AVAsset, ICSynapseLinkPreviewLoadingOperation, NSManagedObjectContext, NSString, CKRecordID, NSManagedObjectID, CKRecord, CSSearchableItemAttributeSet, ICNote, NSArray, NSData, ICMedia, ICAttachmentLocation, NSSet;
