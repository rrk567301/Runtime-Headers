...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7;
- (BOOL)isTopHit;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7 isServerAlternativeResult:(BOOL)a8;
