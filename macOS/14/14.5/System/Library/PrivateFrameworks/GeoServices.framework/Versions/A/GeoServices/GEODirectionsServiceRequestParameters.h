@class GEOMapServiceTraits, GEODirectionsRequestFeedback, GEOMapRegion, GEOResumeRouteHandle, GEOApplicationAuditToken, GEOLocation, GEOComposedRoute, NSString, GEOComposedWaypoint, GEOMatchedPathSegment, NSArray, GEOCommonOptions, GEORouteAttributes, GEORecentLocationHistory;
