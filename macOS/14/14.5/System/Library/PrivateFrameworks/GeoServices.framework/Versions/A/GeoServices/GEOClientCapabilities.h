...
@interface GEOClientCapabilities : PBCodable <NSCopying> {
    ...
    BOOL _supportsCustomDodgeballCameraInput;
...
@property (nonatomic) BOOL hasSupportsCustomDodgeballCameraInput;
@property (nonatomic) BOOL supportsCustomDodgeballCameraInput;
