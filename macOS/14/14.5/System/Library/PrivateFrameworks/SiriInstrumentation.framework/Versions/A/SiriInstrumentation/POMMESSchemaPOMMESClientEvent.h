@class POMMESSchemaPOMMESResourceDownloadContext, POMMESSchemaPOMMESCacheLookupContext, SISchemaInstrumentationMessage, POMMESSchemaPOMMESServiceClassifierScoreReported, POMMESSchemaPOMMESDebugPerformanceReported, POMMESSchemaPOMMESPegasusRequestContext, POMMESSchemaPOMMESCacheInvalidationContext, POMMESSchemaPOMMESCacheMaintenanceContext, POMMESSchemaPOMMESOnDeviceIndexSearchContext, POMMESSchemaPOMMESClientEventMetadata, POMMESSchemaPOMMESProfileSliceResolutionRequestContext, POMMESSchemaPOMMESPegasusKitPegasusRequestContext, POMMESSchemaPOMMESRequestContext, POMMESSchemaPOMMESCacheStoringContext, NSData;
