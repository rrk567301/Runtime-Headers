@interface _TtCV17PasswordManagerUI22PMAddGroupMembersField11Coordinator : NSObject <CNAutocompleteResultWindowDelegate, CNAutocompleteFetchDelegate, NSTokenFieldDelegate, NSTokenTextFieldDelegation, NSControlTextEditingDelegate> {
