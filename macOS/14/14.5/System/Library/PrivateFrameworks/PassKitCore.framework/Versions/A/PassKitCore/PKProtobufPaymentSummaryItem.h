@class PKProtobufAutomaticReloadPaymentSummaryItem, NSString, PKProtobufRecurringPaymentSummaryItem, PKProtobufNSDecimalNumber, PKProtobufDeferredPaymentSummaryItem, PKProtobufShippingMethod, PKProtobufCustomPrecisionAmount;
