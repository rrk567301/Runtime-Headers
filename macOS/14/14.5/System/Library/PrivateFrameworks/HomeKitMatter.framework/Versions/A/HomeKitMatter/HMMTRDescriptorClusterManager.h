...
- (id)fetchClusterFabricIndexForDevice:(id)a0 endpointID:(id)a1 clusterID:(id)a2 callbackQueue:(id)a3;
...
- (id)fetchDeviceTypesForDevice:(id)a0 endpointID:(id)a1 callbackQueue:(id)a2;
...
- (id)hapServiceDescriptionForServiceType:(id)a0 clustersInUse:(id)a1 endpoint:(id)a2 name:(id)a3 hapToCHIPClusterMappingArray:(id)a4 clusterClassesToQuery:(id)a5 hapServicesToCheckForFeatureMap:(id)a6 hapServicesToCheckForOptionalMatterAttribute:(id)a7 server:(id)a8;
