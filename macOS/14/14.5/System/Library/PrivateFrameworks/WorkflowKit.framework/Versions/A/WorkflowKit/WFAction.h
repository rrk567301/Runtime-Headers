@class NSDictionary, WFActionAuxiliaryButton, NSHashTable, WFWorkflow, WFParameter, NSString, WFColor, NSError, WFActionSessionKitSessionConfiguration, NSAttributedString, NSArray, NSMutableDictionary, WFAppInstalledResource, WFResourceManager, WFContentCollection, NSObject, WFActionParameterSummary, NSSet, WFContentAttributionTracker, WFIcon, WFContactStore, INAppDescriptor, ICApp, NSProgress, NSDate, WFContextualActionSuggestionMetadata;
