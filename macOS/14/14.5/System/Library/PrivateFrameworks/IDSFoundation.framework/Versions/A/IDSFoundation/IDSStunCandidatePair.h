...
- (void)_notifySessionStreamInfoReceived:(id)a0 withParticipants:(id)a1 lightweightParticipants:(id)a2 sentBytes:(unsigned long long)a3 receivedBytes:(unsigned long long)a4 offlineRequest:(BOOL)a5 streamInfoRequest:(BOOL)a6 status:(unsigned int)a7 commandFlag:(unsigned int)a8 isIndication:(BOOL)a9;
