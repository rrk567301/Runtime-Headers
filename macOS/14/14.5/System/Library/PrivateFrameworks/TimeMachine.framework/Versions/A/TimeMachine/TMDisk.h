...
- (id)calculateUniqueSizeOfAPFSSnapshotsFromStartName:(id)a0 to:(id)a1 error:(id *)a2;
- (id)calculateUniqueSizeOfAPFSSnapshotsFromStartXID:(unsigned long long)a0 to:(unsigned long long)a1 error:(id *)a2;
