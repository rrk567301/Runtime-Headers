@class NSDate, NSString, NSArray, _DASAssertion, NSURL, NSMutableDictionary, NSDictionary, NSUUID, NSObject, _DASFileProtection;
...
@property (retain, nonatomic) NSMutableDictionary *policyScores;
@property (retain, nonatomic) NSMutableDictionary *policyReasons;
@property (retain, nonatomic) NSMutableDictionary *policyDecisions;
