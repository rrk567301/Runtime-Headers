@class NSData, NSString, NSArray, NSError, CMLClientConfig, CMLUseCaseGroup, NSDictionary, CMLPECConfig, CMLUseCaseStatus, CMLPIRConfig;
...
- (void)constructPIRRequestWithKeyword:(NSData *)a0 shardId:(NSString *)a1 clientConfig:(CMLClientConfig *)a2 reply:(void (^)(NSData *, NSError *))a3;
...
- (void)decryptPIRResponse:(NSData *)a0 keyword:(NSData *)a1 clientConfig:(CMLClientConfig *)a2 reply:(void (^)(NSData *, NSError *))a3;
...
- (void)encryptDifferentiallyPrivateBatchOfElements:(NSArray *)a0 shardIndex:(long long)a1 pecConfig:(CMLPECConfig *)a2 clientConfig:(CMLClientConfig *)a3 reply:(void (^)(NSData *, BOOL, NSError *))a4;
- (void)encryptDifferentiallyPrivateFakes:(NSArray *)a0 shardIndex:(long long)a1 pecConfig:(CMLPECConfig *)a2 clientConfig:(CMLClientConfig *)a3 reply:(void (^)(NSArray *, NSError *))a4;
