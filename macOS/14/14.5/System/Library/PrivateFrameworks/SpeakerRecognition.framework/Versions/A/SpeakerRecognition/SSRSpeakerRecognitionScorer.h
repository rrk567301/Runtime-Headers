...
+ (id)createVoiceScorersWithVoiceProfiles:(id)a0 withConfigFile:(id)a1 withResourceFile:(id)a2 withOffsetsType:(unsigned long long)a3 forRetraining:(BOOL)a4;
...
- (id)initWithProfileID:(id)a0 withModelFile:(id)a1 withConfigFile:(id)a2 withResourceFile:(id)a3 configData:(const void *)a4 memoryIndex:(id)a5 withOffsetsType:(unsigned long long)a6 forRetraining:(BOOL)a7;
- (id)initWithProfileID:(id)a0 withModelFile:(id)a1 withConfigFile:(id)a2 withResourceFile:(id)a3 withOffsetsType:(unsigned long long)a4 forRetraining:(BOOL)a5;
