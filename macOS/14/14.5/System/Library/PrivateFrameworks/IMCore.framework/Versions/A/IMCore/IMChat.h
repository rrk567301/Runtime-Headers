@class NSDictionary, IMChatScrutinyController, IMTimingCollection, IMMessageItem, IMOrderingTools, NSMutableArray, NSString, NSMutableSet, IMReasonTrackingUpdater, IMDaemonController, NSArray, NSMutableDictionary, IMHandle, NSSet, NSData, IMScheduledUpdater, IMInlineReplyController, IMSendProgress, IMMessage, IMSharedEmergencyInfo, NSDate, IMAccount, NSNumber, IMBrand;
@protocol IMDaemonProtocol, IMChatItemRules;

@interface IMChat : IMItemsController <INSpeakable, IMPhotoLibraryPersistenceManagerListener, IMReasonTrackingUpdaterDelegate, IMStateLoggable, IMSendProgressDelegate> {
