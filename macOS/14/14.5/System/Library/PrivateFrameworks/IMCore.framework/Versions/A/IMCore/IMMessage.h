...
- (id)initWithSender:(id)a0 time:(id)a1 text:(id)a2 messageSubject:(id)a3 fileTransferGUIDs:(id)a4 flags:(unsigned long long)a5 error:(id)a6 guid:(id)a7 subject:(id)a8 balloonBundleID:(id)a9 payloadData:(id)a10 expressiveSendStyleID:(id)a11 threadIdentifier:(id)a12 scheduled:(BOOL)a13;
