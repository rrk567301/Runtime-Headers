@class NSUUID, NSString, HMSoftwareUpdateDocumentationMetadata, NSDate, NSArray, NSSet, HMFMessageDispatcher, NSObject, HMFSoftwareVersion, HMDAccessory, HMDSoftwareUpdateModel;
