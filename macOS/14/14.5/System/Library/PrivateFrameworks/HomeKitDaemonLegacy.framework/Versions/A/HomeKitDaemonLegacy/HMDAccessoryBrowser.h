@class NSHashTable, HMFTimer, HMDMediaBrowser, HMDHAP2Storage, NSMutableArray, NSMutableSet, HMDHomeManager, NSString, HMDAccessoryServerBrowserDemo, NSArray, HMDAuthServer, HMMTRAccessoryServerBrowser, HMFMessageDispatcher, HMDUnassociatedWACAccessory, NSObject, NSData, HMDWACBrowser, NSUUID, HAPAccessoryServerBrowserBTLE, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP;
...
- (void)accessoryServerBrowser:(id)a0 cacheOperationalCertData:(id)a1 forFabricID:(id)a2;
...
- (void)accessoryServerBrowser:(id)a0 getCachedOperationalCertificateDataForFabricID:(id)a1 completion:(id /* block */)a2;
...
- (void)accessoryServerBrowser:(id)a0 getOperationalCertificatesForFabricID:(id)a1 publicKey:(id)a2 completion:(id /* block */)a3;
