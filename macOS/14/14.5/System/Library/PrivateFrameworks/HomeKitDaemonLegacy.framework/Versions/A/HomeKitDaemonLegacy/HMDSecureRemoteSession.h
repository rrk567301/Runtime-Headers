@class HMDAccountRegistry, NSArray, NSString, NSMutableArray, HMDRemoteDeviceMonitor, NSObject, HMDDevice;
...
- (id)initWithDevice:(id)a0 deviceMonitor:(id)a1 accountRegistry:(id)a2 dataSource:(id)a3;
