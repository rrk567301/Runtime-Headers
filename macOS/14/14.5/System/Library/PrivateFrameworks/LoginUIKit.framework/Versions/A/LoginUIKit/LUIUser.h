...
@property (retain) NSDictionary *attributesInternal;
@property BOOL gatherMissingAttributes;
@property BOOL ODRecordInitialized;
@property (retain) ODRecord *ODRecordInternal;
...
@property (readonly) ODRecord *ODRecord;
