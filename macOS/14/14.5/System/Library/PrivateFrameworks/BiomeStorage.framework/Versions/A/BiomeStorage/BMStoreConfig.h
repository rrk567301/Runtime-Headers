...
- (id)_initWithStoreVersion:(unsigned long long)a0 storeBasePath:(id)a1 segmentSize:(unsigned long long)a2 protectionClass:(unsigned long long)a3 storeLocationOption:(long long)a4 account:(id)a5 remoteName:(id)a6 pruningPolicy:(id)a7 streamType:(unsigned long long)a8 domain:(unsigned long long)a9 isManaged:(BOOL)a10 streamIdentifier:(id)a11;
