...
- (void)updatePuzzle:(id)a0 puzzleTypeID:(id)a1 progressData:(id)a2 progressLevel:(long long)a3 score:(id)a4 rankID:(id)a5 usedReveal:(BOOL)a6 playDuration:(long long)a7 isSolved:(BOOL)a8;
