...
- (id)createPuzzleForPuzzleType:(id)a0 identifier:(id)a1 title:(id)a2 subtitle:(id)a3 puzzleDescription:(id)a4 dataResourceID:(id)a5 authors:(id)a6 behaviorFlags:(long long)a7 publishDate:(id)a8 isPaid:(BOOL)a9 difficulty:(long long)a10 difficultyDescription:(id)a11 thumbnailLargeURL:(id)a12 loadDate:(id)a13 teaserClue:(id)a14 teaserAnswer:(id)a15 teaserInfo:(id)a16 teaserDirection:(id)a17 teaserNumber:(id)a18 language:(id)a19 blockedStorefrontIDs:(id)a20 allowedStorefrontIDs:(id)a21 minimumNewsVersion:(id)a22 isDeprecated:(BOOL)a23 isDraft:(BOOL)a24 lastModifiedDate:(id)a25;
