@class FCReadingList, FCPersonalizationData, FCUserInfo, FCTagSettings, FCPrivateChannelMembershipController, FCPuzzleTypeSettings, FCReadingHistory, NSString, FCIssueReadingHistory, FCPuzzleHistory, FCSubscriptionList, FCUserEventHistory, FCAudioPlaylist, FCShortcutList;
