...
@protocol FCCoreConfiguration, FCJSONEncodableObjectProviding, FCFeldsparIDProvider, FCNetworkBehaviorMonitor, FCNewsAppConfiguration, OS_dispatch_queue;
...
- (void)fetchTodayFeedConfigurationIfNeededWithCompletionQueue:(id)a0 feedType:(unsigned long long)a1 formatVersion:(id)a2 cachePolicy:(id)a3 completion:(id /* block */)a4;
