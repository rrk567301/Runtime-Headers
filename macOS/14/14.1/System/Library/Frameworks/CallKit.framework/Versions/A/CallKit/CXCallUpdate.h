@class NSUUID, NSString, CXSandboxExtendedURL, CXAccount, NSSet, NSMutableDictionary, NSDictionary, CXParticipant, CXHandle, CXHandoffContext, CXScreenShareAttributes;
