...
@interface AppKit._NSSuggestionsMenuViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, AppKit._NSSuggestionsMenuTableViewDelegate> {
