@class NSCGSWindowBackingStore, NSArray, CAContext, _NSCGSWindowMovementChildren, CALayer, NSDictionary, CABackdropLayer, NSCGSWindowCornerMask, NSMapTable, NSPointerArray;
