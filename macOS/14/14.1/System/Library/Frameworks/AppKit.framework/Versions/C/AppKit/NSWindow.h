...
@property (readonly) BOOL _isConsideredForActivation;
...
- (void)_didChangeOverrideResolution;
...
- (BOOL)getOverrideResolution:(struct CGSize { double x0; double x1; } *)a0;
- (void *)graphicsPort;
