@class ICUserIdentity, NSArray, ITMediaLibrary, MPMediaLibrary, NSString, NSSet, NSMutableDictionary, NSObject, MPMediaEntityCache;
...
- (void)performStoreAlbumArtistLookupForImport:(id)a0 withCompletion:(id /* block */)a1;
