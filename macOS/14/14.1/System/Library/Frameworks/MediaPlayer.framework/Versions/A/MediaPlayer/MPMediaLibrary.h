@class NSDate, NSString, _MPActiveUserChangeMonitor, NSURL, ICUserIdentity, NSArray, MPMediaLibraryPrivacyContext, NSMutableDictionary, NSObject, QueryCriteriaResultsCache, NSMutableArray, NSPointerArray;
