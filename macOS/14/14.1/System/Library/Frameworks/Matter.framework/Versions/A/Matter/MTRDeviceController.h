@class MTRCommissionableBrowser, NSMutableDictionary, NSUUID, MTRDeviceControllerFactory, MTRDeviceControllerDataStore, NSNumber, NSObject;
@protocol OS_dispatch_queue, MTROTAProviderDelegate, MTRKeypair;
