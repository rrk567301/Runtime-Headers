...
- (void)didChangeEntity:(id)a0 toStreamFormat:(id)a1;
- (id)bestAudioMatchForStreamFormat:(id)a0 inStreamFormats:(id)a1 withSamplingRate:(id)a2;
- (void)_changeBuiltInEntity:(id)a0 localStream:(id)a1 andRemoteStream:(id)a2 toStreamFormat:(id)a3;
...
- (void)controllerRequestToChangeEntity:(id)a0 inputStreamWithIndex:(unsigned short)a1 toStreamFormat:(id)a2 forTargetEntityID:(unsigned long long)a3;
- (void)controllerRequestToChangeEntity:(id)a0 outputStreamWithIndex:(unsigned short)a1 toStreamFormat:(id)a2 forTargetEntityID:(unsigned long long)a3;
...
- (void)didChangeEntity:(id)a0 audioUnitSamplingRate:(id)a1;
- (void)didChangeEntity:(id)a0 clockDomainClockSource:(id)a1;
- (void)didChangeEntity:(id)a0 controlValue:(id)a1;
- (void)didChangeEntity:(id)a0 name:(id)a1;
- (void)didChangeEntity:(id)a0 sensorClusterSamplingRate:(id)a1;
- (void)didChangeEntity:(id)a0 toAssociationID:(id)a1;
- (void)didChangeEntity:(id)a0 toConfiguration:(id)a1;
- (void)didChangeEntity:(id)a0 toVideoFormat:(id)a1;
- (void)didChangeEntity:(id)a0 videoClusterSamplingRate:(id)a1;
