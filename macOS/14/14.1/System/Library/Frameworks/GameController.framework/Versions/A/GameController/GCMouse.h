@class GCController, NSString, NSArray, GCMouseLiveInput, GCMouseInput, NSObject, GCPhysicalInputProfile;
...
@property (readonly, nonatomic) struct IOUSBDeviceStruct942 **device;
