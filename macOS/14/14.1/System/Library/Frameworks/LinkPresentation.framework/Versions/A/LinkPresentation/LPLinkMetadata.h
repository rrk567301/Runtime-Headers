@class TUConversationActivity, _SWCollaborationMetadata, LPAudioMetadata, SYContentItem, NSMutableArray, NSString, LPAudio, LPARAsset, LPSpecializationMetadata, NSArray, LPSourceApplicationMetadata, NSItemProvider, NSObject, LPARAssetMetadata, LPProductMetadata, LPVideo, LPIconMetadata, LPImage, LPImageMetadata, NSURL, LPVideoMetadata;
...
- (id)dataRepresentationWithEncodingType:(unsigned long long)a0;
