@class NSString, NSArray, LPCollaborationFooterPresentationProperties, LPCaptionRowPresentationProperties, LPImagePresentationProperties, LPImage, LPCaptionButtonPresentationProperties, NSNumber;
