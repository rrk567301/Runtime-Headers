@class MPCPlayerPath, NSString, MPCMRRemoteArtworkDataSource, MSVLRUDictionary, NSMutableDictionary, MPCFuture, NSObject, NSMutableArray, MPCMRArtworkDataSource, NSMapTable;
