...
- (id)initWithFilePath:(id)a0 resourceVersion:(unsigned int)a1 resourceType:(unsigned int)a2 recipeID:(unsigned int)a3 bundleScope:(unsigned short)a4 pathManager:(id)a5;
