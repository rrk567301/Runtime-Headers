...
+ (void)stdAlertSheetWithClient:(id)a0 parentWindow:(id)a1 mainText:(id)a2 subText:(id)a3 okStr:(id)a4 cancelStr:(id)a5 otherStr:(id)a6 alertStyle:(unsigned long long)a7 defaultButton:(int)a8 showSuppressionButton:(BOOL)a9 suppressionButtonTitle:(const void *)a10 notifySuppression:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[24]; } x0; void *x1; } x0; })a11 optionalHelpURL:(const void *)a12;
