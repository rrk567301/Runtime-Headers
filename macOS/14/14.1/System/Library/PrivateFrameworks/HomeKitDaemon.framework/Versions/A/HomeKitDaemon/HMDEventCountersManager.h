@class NSArray, HMMDateProvider, NSSet, NSMutableDictionary, HMMCountersManager, NSObject, NSMutableArray, HMDPersistentStore;
...
- (id)initWithEventCountersStorage:(id)a0 bridgedCountersManager:(id)a1 bridgedDateProvider:(id)a2 saveInterval:(double)a3 timeSourceBlock:(id /* block */)a4;
