@class NSXPCConnection, NSString, NSArray, NSUUID, _TtC26AuthenticationServicesCore13ASCABLEClient, WBSSavedAccountContext, ASCCredentialRequestContext, ASCAuthorizationPresenter, NSObject, ASCAuthorizationTrafficController, NSXPCListener;
