@class NSTextField, LAUILockImageView, NSString, LAUIAuthenticationViewControllerUIDelegate, LAContext, NSColor, NSTextView, LAUIShakeAnimation, NSLayoutConstraint;
