@class GEOPDSInferredSignals, GEOPDViewportInfo, GEOPDSSearchFilter, GEOPDETAFilter, GEOPDRecentRouteInfo, PBUnknownFields, GEOPDResultRefinementQuery, GEOPDSSearchEvChargingParameters, NSMutableArray, GEOPDSearchOriginationInfo, NSString, GEOPDAutocompleteEntry, PBDataReader, GEOPDRetainedSearchMetadata, GEOPDSSearchLocationParameters, NSData, GEOPDSSearchStructureIntentRequestType;
