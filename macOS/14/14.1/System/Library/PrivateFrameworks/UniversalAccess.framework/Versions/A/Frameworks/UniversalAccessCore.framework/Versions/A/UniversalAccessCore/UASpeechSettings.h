...
- (id)_init;
- (id)_languageCanonicalFormToGeneralLanguage:(id)a0;
...
- (id)preferredVoiceForLanguage:(id)a0;
- (void)setPreferredVoice:(id)a0 forLanguage:(id)a1;
- (void)setSpeakingRate:(double)a0 forVoice:(id)a1;
- (void)setSpeakingVolume:(double)a0 forVoice:(id)a1;
- (double)speakingRateForVoice:(id)a0;
- (double)speakingVolumeForVoice:(id)a0;
