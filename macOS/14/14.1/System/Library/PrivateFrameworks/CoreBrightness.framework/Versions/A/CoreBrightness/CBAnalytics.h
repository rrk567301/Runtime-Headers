...
+ (void)userSliderCommit:(const struct CBSliderCommitInfo { long long x0; long long x1; int x2; float x3; float x4; BOOL x5; float x6; float x7; float x8; float x9; int x10; BOOL x11; BOOL x12; float x13; struct CBAABParams { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; } x14; BOOL x15; BOOL x16; BOOL x17; BOOL x18; float x19; float x20; int x21; BOOL x22; BOOL x23; } *)a0;
