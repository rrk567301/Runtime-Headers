@class BMAccessClient, BMComputeXPCPublisherClient, NSString, BMDSL, BMComputeXPCPublisherStorage, BMBookmarkablePublisher, BPSSubscriptionStatus, NSObject, BMComputeXPCSubscription;
