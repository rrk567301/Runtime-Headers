@class AVAudioSessionRouteDescription, NSString, NSArray, AVAudioSessionDataSourceDescription, NSDictionary, CAReporter, AVAudioSessionPortDescription;
...
- (struct sync_guard<AVAudioSessionImpl, caulk::mach::unfair_lock> { struct unfair_lock *x0; struct value_holder<AVAudioSessionImpl> { struct AVAudioSessionImpl *x0; } x1; })privateGetGuardOfImplementation;
...
- (BOOL)recreateSessionInServerIfNecessary;
