...
+ (long long)customAppleIDAvailabilityHealthCheckIntervalMinutes;
...
+ (id)getCustodianInfo;
+ (BOOL)isCustomAppleIDAvailabilityHealthCheckIntervalEnabled;
...
+ (void)setCustomAppleIDAvailabilityHealthCheckIntervalEnabled:(BOOL)a0;
+ (void)setCustomAppleIDAvailabilityHealthCheckIntervalMinutes:(long long)a0;
