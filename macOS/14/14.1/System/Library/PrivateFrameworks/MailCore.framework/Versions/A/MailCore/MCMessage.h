@class MCMimePart, NSColor, ECSubject, NSDate, NSDictionary, NSURL, ECMessageFlags, NSString, NSSet, MCDisplayNameInfo, ECAngleBracketIDHash, EMFollowUp, NSMutableSet, NSArray, NSData, EMReadLater, NSUUID;
