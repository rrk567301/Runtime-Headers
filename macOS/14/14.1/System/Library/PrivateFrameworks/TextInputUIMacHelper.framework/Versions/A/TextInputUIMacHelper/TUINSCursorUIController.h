@class NSString, NSArray, TUINSWindow, NSTimer, TUICursorAccessoryAssertionController, TUINSCursorUISwitcher, NSView;
...
- (void)didUpdateIndicator:(struct CGSize { double x0; double x1; })a0 offset:(struct CGSize { double x0; double x1; })a1;
