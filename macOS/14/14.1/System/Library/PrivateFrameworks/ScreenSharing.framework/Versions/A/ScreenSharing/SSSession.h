...
- (void)delegateCursorImageUpdated:(id)a0 hotSpot:(struct SSPoint { long long x0; long long x1; })a1;
...
- (void)handleCursorImageUpdate:(struct ServerCursorImageCallbackInfo { struct CGImage *x0; unsigned short x1; unsigned short x2; } *)a0;
