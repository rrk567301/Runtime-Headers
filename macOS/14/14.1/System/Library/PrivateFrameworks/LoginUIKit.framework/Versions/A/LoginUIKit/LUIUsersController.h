...
@interface LUIUsersController : NSObject <LUINetworkStatusProtocol>

@property BOOL inLoginwindowOS;
...
@property struct __ODTrigger { } *odTrigger;
@property NSTimer *odCheckTimer;
@property (retain) NSMutableSet *odNamesChanged;
...
- (void)freeODChangedThreadTimer;
- (void)handleMCXNotification:(id)a0;
- (void)handleODTriggerForName:(id)a0;
