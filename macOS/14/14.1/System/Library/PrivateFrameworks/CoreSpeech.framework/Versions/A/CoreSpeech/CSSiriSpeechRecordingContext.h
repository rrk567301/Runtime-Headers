@class CSAudioRecordContext, NSString, CSSiriRecordingInfo, CSAudioRecordDeviceInfo, NSURL, NSMutableDictionary, NSDictionary, NSUUID, NSObject, NSMutableSet, CSSiriAudioFileWriter, CSSiriAudioMessageRequestClient;
