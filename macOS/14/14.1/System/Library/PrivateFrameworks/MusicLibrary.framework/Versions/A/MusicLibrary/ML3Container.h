...
- (BOOL)_setItemPersistentIDs:(id)a0 andEntryProperties:(id)a1 reloadContainedMediaTypes:(BOOL)a2 removedMediaTypes:(id)a3 addedMediaTypes:(id)a4 notify:(BOOL)a5 incrementEntityRevision:(BOOL)a6 usingConnection:(id)a7;
...
- (BOOL)setItemReactionText:(id)a0 onEntryAtPosition:(unsigned long long)a1 forUserIdentifier:(id)a2;
- (BOOL)setTracksWithPersistentIDs:(id)a0 andEntryProperties:(id)a1 notify:(BOOL)a2;
