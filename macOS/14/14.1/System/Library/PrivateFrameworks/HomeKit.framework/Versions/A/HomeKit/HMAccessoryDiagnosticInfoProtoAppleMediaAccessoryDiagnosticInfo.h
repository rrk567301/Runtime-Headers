@class HMAccessoryDiagnosticInfoProtoIdsInfo, NSString, HMAccessoryInfoProtoWifiNetworkInfoEvent, HMAccessoryDiagnosticInfoProtoCurrentAccessoryInfo, HMAccessoryDiagnosticInfoProtoCloudInfo, HMRemoteEventRouterProtoServerDiagnosticInfo;

@interface HMAccessoryDiagnosticInfoProtoAppleMediaAccessoryDiagnosticInfo : PBCodable <NSCopying> {
    struct { unsigned char generationTime : 1; } _has;
}
