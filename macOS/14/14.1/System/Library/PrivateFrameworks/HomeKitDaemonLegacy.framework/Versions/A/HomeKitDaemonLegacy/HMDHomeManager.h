...
- (id)_decodeDiagnosticInfoFromResponse:(id)a0;
...
- (id)_diagnosticInfoFromResponse:(id)a0;
...
- (BOOL)_handleAccessoryDiagnosticStateQueryMessage:(id)a0 response:(id)a1 hasAdditionalRequest:(BOOL)a2 error:(id)a3;
...
- (void)queryAndLogConfiguringStateForAccessoryUUID:(id)a0;
