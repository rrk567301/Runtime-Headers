...
@property (readonly) id<HMDIDSService> modernService;
...
- (id)initWithMainService:(id)a0 modernService:(id)a1 proxyService:(id)a2 streamService:(id)a3 notificationCenter:(id)a4;
