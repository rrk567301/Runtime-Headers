...
- (void)_queryWithRequestID:(id)a0 mediaRouteIdentifier:(id)a1 rpDevice:(id)a2 withCompletion:(id /* block */)a3;
...
- (void)queryConfiguringState:(id)a0 withCompletion:(id /* block */)a1;
