@class UNUserNotificationCenter, NSString, ECAngleBracketIDHash, MCMessage, EMReadLater;
...
- (id)initWithTitle:(id)a0 message:(id)a1 identifier:(id)a2 snippet:(id)a3 userNotificationCenter:(id)a4 postType:(long long)a5;
- (id)initWithTitle:(id)a0 message:(id)a1 identifier:(id)a2 snippet:(id)a3 userNotificationCenter:(id)a4 postType:(long long)a5 readLater:(id)a6;
