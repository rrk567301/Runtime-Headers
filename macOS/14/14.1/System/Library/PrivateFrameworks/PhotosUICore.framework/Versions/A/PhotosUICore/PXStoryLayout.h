@class PXStoryFadeOverlayLayout, PXStoryStyleSwitchingFullsizeLayout, NSShadow, PXGItemPlacement, NSString, PXStoryFullsizeLayout, PXStoryScrollLayout, PXStoryBackgroundLayout, PXStoryThumbnailChromeLayout, PXStoryModel, PXGLayout;
...
@property (readonly, nonatomic) PXStoryBackgroundLayout *backgroundLayout;
