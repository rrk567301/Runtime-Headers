@class ASDTIOServiceManager, NSString, ASDTIOService, NSDictionary;

@interface ASDTIOServiceDependency : NSObject

@property (retain, nonatomic) NSString *ioServiceClassName;
@property (retain, nonatomic) NSString *ioServiceIdentifier;
...
+ (id)forClassName:(id)a0 identifier:(id)a1 andConfiguration:(id)a2;
...
- (id)initForClassName:(id)a0 identifier:(id)a1 andConfiguration:(id)a2;
