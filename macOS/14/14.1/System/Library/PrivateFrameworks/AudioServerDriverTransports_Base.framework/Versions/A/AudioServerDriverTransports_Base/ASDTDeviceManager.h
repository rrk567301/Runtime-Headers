@class NSString, ASDTCondition, NSMutableDictionary, NSDictionary, NSThread, NSMutableArray, NSObject, ASDPlugin, NSMutableSet, NSSet;
...
@property (retain, nonatomic) NSMutableDictionary *deviceFactories;
...
- (void)buildAndInitializeDevice:(id)a0 assertOnError:(BOOL)a1;
