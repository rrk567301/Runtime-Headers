...
- (id)_replyWithRequest:(id)a0 textStorage:(id)a1 documentAttributes:(id)a2 contentType:(id)a3 imageRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 textRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5;
