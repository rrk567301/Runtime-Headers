@class BrowserDiagnosticLoggingDelegate, BrowserWindowController, History, NSUserActivity, NSMutableDictionary, WBSCreditCardData, JavaScriptDialogSuppressionManager, NewExtensionBanner, NSWindowController, PrintSheetSuppressionManager, TabDialogViewController, ReadingListItem, WBSQueryParameterFilteringDataQueue, WBSMutableOrderedSet, BrowserContainerViewController, PointerLockBanner, NSURLProtectionSpace, BrowserInspectorDelegate, NSURLRequest, BrowserNavigationDelegate, NSURL, BackgroundLoad, WBSFormMetadata, AppExtensionPermissionMigrationBanner, BrowserResourceLoadDelegate, WebAppDocument, TabContentView, WBSTranslationContext, SearchableWKView, HighlightBanner, NSDate, ResponsiveDesignViewController, PagePreviewAnimationController, PrivateBrowsingPrivacyProtectionsBanner, BrowserTabPersistentState, WebAppWindowController, FullscreenUnifiedFieldWindowController, NSWindow, WebCrashBanner, WBSSameDocumentNavigationToHistoryVisitCorrelator, CKContextCompleter, WBSSecIdentitiesCache, NSMapTable, WBSHistoryVisit, StartPageViewController, NSHTTPURLResponse, SafariAppExtensionsController, WBSFluidProgressState, WBSMultiRoundAutoFillManager, BookmarksViewController, WalletOrderDownloadSuppressionManager, NSUUID, NSSet, WBSGeneratedPassword, NSMutableSet, NSString, StatusMessage, BrowserTabViewItem, NSMutableArray, PassDownloadSuppressionManager, ContinuousReadingListPageItem, WBSHistoryContextController, SafariWebExtensionsController, Banner, NSHashTable, BrowserDocument, AutoFillFunctionBarProvider, BrowserWKView, NSTimer, CKContextResponse, _WKRemoteObjectInterface, NSDictionary, NSArray, AppLinkBannerController, TextFieldInformation, WBSPermissionDialogThrottler, RemoteNotificationVerificationRequest, PrivateBrowsingExplanationBanner, _WKWebAuthenticationAssertionResponse, ContinuousReadingListViewController, NSPrintInfo, DefaultBrowserBanner, NSView, NSData, WBSURLSpoofingMitigator, TabDialogPresentationManager, SheetRequest;
@protocol WBSSandboxExtensionToken, ContentWindowController, AppExtensionMessageReceiver, WBSCertificateWarningPagePresenter, AuthenticationSessionNavigationHandling, BundleBrowserViewController, RemoteNotificationStateObserver, WKUIDelegate, FormAutoFiller, WBSContentBlockerStatisticsStore, BrowserContentLoaderDelegate;

@interface BrowserViewController : WebViewController <AppExtensionContentScriptMessageReceiver, AutoFillFunctionBarProviderDelegate, AutomaticBugCaptureObserver, BookmarksViewControllerDelegate, BrowserViewControllerLoading, BrowserViewIconLoadingDelegate, DefaultBrowserBannerDelegate, FormAutoFillCompletionControllerObserver, FormMetadataObserver, NSOpenSavePanelDelegate, PagePreviewAnimationControllerDelegate, ReaderStateObserver, RemoteNotificationControllerClient, RemoteNotificationPermissionHandler, SandboxExtensionPresentationDelegate, TabDialogPresentationManagerDelegate, WBSCertificateWarningPageHandler, BrowserDiagnosticLoggingBiomeDelegate, WBSBiomeNavigationDonor, PrivateBrowsingPrivacyProtectionsBannerDelegate, WBSQueryParameterFilteringDataQueueDelegate, _WKAppHighlightDelegate, WBSTranslationContextDelegate, WBSTranslationConsentAlertHelperDelegate, AuthenticationSheetRequestDelegate, DimmingViewDelegate, MutableMediaSource, ReaderActivationDelegate, ReaderAvailabilityDelegate, SearchableWKViewCancelDelegate, TabDialogPresenter, WBSFluidProgressStateSource> {
...
- (BOOL)_shouldCreatePopupWindowForNewPageWithWindowFeatures:(id)a0;
- (BOOL)_shouldCreateTabForNewPage;
