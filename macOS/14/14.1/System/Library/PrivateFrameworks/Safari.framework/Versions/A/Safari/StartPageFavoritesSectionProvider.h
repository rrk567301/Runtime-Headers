@class WBTabGroup, SafariWebBookmarkList, NSString, BookmarkAddressEditingPopoverViewController, NSArray, WBSPair, NSTimer;
@protocol StartPageFavoritesSectionProviderDelegate;

@interface StartPageFavoritesSectionProvider : StartPageTouchIconSectionProvider <StartPageEmptyTabGroupFavoritesItemDelegate, SiriSuggestionsStartPageLinkRecommendationDelegate, StartPageCollectionSectionTitleViewDelegate> {
