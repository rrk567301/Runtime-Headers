@class NSDate, NSUUID, NSArray, NSString, WBWindowState, NSDictionary, NSMutableArray, BrowserTabPersistentState, NSMutableSet;
...
- (void)_initializeWindowStateWithDictionaryRepresentation:(id)a0;
