@class WBTab, PerSitePreferencesPopoverManager, SidebarViewController, AutomationTouchBarProvider, WBMutableTabGroup, NSAppearance, WBSFaviconRequestsController, LibrarySidebarNavigationViewController, NSLayoutConstraint, UnifiedFieldEditor, NSTextView, NSObject, WBProfile, SafariAppExtensionsController, NSUUID, PopupWindowUnifiedField, NSMenu, NSView, NSMutableArray, TabGroupActivityNoticeView, BackgroundLoadController, SafariWebExtensionsController, NSTimer, BrowserWindowContentSplitViewController, BookmarksSidebarTitleTextView, StatusMessage, BrowserTabGroupPersistentState, TabBarView, UnifiedField, BrowserTabViewItem, UnifiedTabBar, WKWebpagePreferences, NSPopover, CKShare, SearchProvidersController, BrowserWindowContentViewController, TipsCoordinator, FormTextStatusWatcher, AutomaticReadingListContentProvider, ToolbarController, NSDate, WBProfileWindow, NSColor, WBSFluidProgressController, CustomViewSnapshotCache, NSArray, WBWindowState, PopupWindowUnifiedFieldViewController, FavoritesPickerVisibilityManager, TabContentViewController, VisualTabPickerViewController, BrowserWindow, BrowserWindowPersistentState, NSString, TitlebarVisualEffectView, UnifiedFieldSecurityUIManager, BrowserViewController, FavoritesBarView, OverlayStatusWindowController, WindowFunctionBarProvider, BrowserWindowTabViewController, TextFieldEditor, NSURL, WBSBrowserTabCompletionInfo, WBSSavedAccountContext, LockdownModeBarView, BackgroundColorView, NSMutableSet, ReadingListContentProvider, History, PrivacyReportPopoverViewController, NSAlert, NSTitlebarAccessoryViewController, WebViewController, WBTabGroup;
...
- (id)_tryMultipleURLs:(id)a0 windowPolicy:(long long)a1 httpReferrer:(id)a2;
...
- (void)_updateLockedPrivateBrowsing;
