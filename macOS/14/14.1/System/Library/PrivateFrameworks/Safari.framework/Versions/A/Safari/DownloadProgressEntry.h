@class WBSCoalescedAsynchronousWriter, NSURLRequest, _WKDownload, NSMutableArray, NSWindowController, NSString, WBSDownloadFileUnarchiver, NSError, NSTimer, NSArray, NSMutableDictionary, NSObject, DownloadFile, NSSet, NSOperationQueue, NSData, NSURLResponse, NSUUID, NSURL, NSDate, NSProgress;
@protocol OS_dispatch_queue, DownloadProgressEntryDelegate, WBSSandboxExtensionToken, ContentWindowController;
...
@interface DownloadProgressEntry : NSObject <NSFilePresenter> {
    ...
    NSWindowController<ContentWindowController> *_hopOriginWindowController;
