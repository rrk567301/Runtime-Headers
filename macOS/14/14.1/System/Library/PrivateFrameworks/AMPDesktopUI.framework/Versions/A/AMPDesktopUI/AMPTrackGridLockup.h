@class NSTextField, NSScrollView, TrackGridDiffableDataSource, NSProgressIndicator, NSString, NSCollectionView;
@protocol AMPTrackGridLockupModel;

@interface AMPTrackGridLockup : NSTableCellView <NSScrollViewDelegate>
