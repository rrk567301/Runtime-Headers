@class HMFNetAddress, HMFBlockOperation, NSDate, HAPAccessoryServerBrowserIP, NSDictionary, HAPAuthSession, HAPAccessoryServerIPConnectionStatistics, HAPAccessory, NSMutableArray, HAPHTTPClient, HAPWACAccessory, NSString, NSOperationQueue, NSArray, HMFNetMonitor, NSData, HMFTimer, HAPAccessoryProtocolInfo;
