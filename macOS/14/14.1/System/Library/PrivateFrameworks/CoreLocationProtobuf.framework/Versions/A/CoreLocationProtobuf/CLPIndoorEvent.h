@class CLPLOGENTRYVISIONVIOEstimation, CLPBundleId, CLPLOGENTRYVISIONVLLocalizationResult, CLPWorkoutUpdateMotionActivity, CLPInertialOdometry, CLPIndoorCMPedometer, CLPIndoorCMAttitude, CLPLocation, CLPIndoorMotionActivity, CLPIndoorWifiScan, CLPIndoorPressure;
