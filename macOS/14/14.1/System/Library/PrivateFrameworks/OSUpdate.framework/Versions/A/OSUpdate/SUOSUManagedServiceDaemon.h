@class NSDate, SUOSUAuthenticationManager, SUMacControllerDescriptor, SUOSUMobileSoftwareUpdateController, SUOSUServiceClient, NSString, SUCoreDDMActivityScheduler, NSObject, SUCorePolicyDDMConfiguration;
...
@property (retain) NSDate *pastDuePaddedEnforcementDate;
