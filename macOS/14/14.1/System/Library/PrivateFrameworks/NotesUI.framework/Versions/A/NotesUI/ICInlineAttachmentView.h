@class NSTextField, NSClickGestureRecognizer, ICDisplayLink, NSTrackingArea, ICAttributedStringRippler, NSColor, NSDictionary, NSString, NSImage, ICSearchResultRegexMatchFinder, ICInlineTextAttachment;
