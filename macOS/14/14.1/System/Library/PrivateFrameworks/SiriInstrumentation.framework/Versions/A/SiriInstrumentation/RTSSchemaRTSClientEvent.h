@class RTSSchemaRTSClientEventMetadata, SISchemaInstrumentationMessage, RTSSchemaRTSTriggered, RTSSchemaRTSFirstPassPolicyTriggered, RTSSchemaRTSSecondPassPolicyDecisionMade, RTSSchemaRTSFalseRejectDetected, NSData;
