@class NSURL, EMObjectID, ECSubject, NSDate, NSObject, ECMessageFlags, EMThreadObjectID, EMMailboxScope, NSString, EMFollowUp, EFFuture, NSIndexSet, NSArray, EMQuery, EMReadLater, EMMessageRepository;
