@class RTDeviceLocationPredictor, RTVisitMonitor, RTHintManager, RTLocationAwarenessManager, RTMotionActivityManager, RTVisitStore, RTDefaultsManager, NSMutableArray, RTPlatform, RTMetricManager, NSString, RTPointOfInterestMonitor, RTLearnedLocationManager, RTVisitLabeler, RTLocationManager;
...
- (id)initWithDefaultsManager:(id)a0 deviceLocationPredictor:(id)a1 hintManager:(id)a2 learnedLocationManager:(id)a3 locationAwarenessManager:(id)a4 locationManager:(id)a5 metricManager:(id)a6 motionActivityManager:(id)a7 platform:(id)a8 pointOfInterestMonitor:(id)a9 visitLabeler:(id)a10 visitStore:(id)a11;
