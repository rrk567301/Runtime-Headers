...
- (id)initWithCKKSMetrics:(id)a0 altDSID:(id)a1 eventName:(id)a2 testsAreEnabled:(BOOL)a3 category:(id)a4;
- (id)getEvent;
- (id)initWithKeychainCircleMetrics:(id)a0 altDSID:(id)a1 eventName:(id)a2 category:(id)a3;
- (id)initWithKeychainCircleMetrics:(id)a0 altDSID:(id)a1 flowID:(id)a2 deviceSessionID:(id)a3 eventName:(id)a4 testsAreEnabled:(BOOL)a5 category:(id)a6;
