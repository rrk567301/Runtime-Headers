@class NSXPCConnection, NSString, NSXPCListenerEndpoint, TKSmartCardATR, TKSmartCardSessionEngine, NSHashTable, TKPowerMonitor, NSObject, NSMutableArray, NSXPCListener, NSNumber, NSMapTable;
