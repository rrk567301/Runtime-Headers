...
@interface SCNManipulator : NSObject {
    ...
    struct { void *positions; void *orientations; struct CATransform3D *originalLocalMatrix; void *scales; } _originalData;
...
@property (readonly) struct CATransform3D { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; } transform;
...
- (id)copy;
- (id)init;
- (id)hitTest:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (BOOL)isDragging;
- (BOOL)mouseDown:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (BOOL)mouseDragged:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (BOOL)mouseMoved:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (BOOL)mouseUp:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (id)scene;
- (void)_deleteOriginalData;
- (BOOL)_applyWithEvent:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
...
- (void /* unknown type, empty encoding */)_snapPositionToAlign:(id)a0 original:(SEL)a1 unit:(struct SCNVector3 { double x0; double x1; double x2; })a2 axisMove:(double)a3 rayStart:(BOOL)a4 rayDir:(BOOL *)a5 didSnap:(long long *)a6 snapIndexes:(void /* unknown type, empty encoding */)a7;
- (void)_updateActionWithEvent:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
- (void)_updateCloneStateWithEvent:(struct { id x0; id x1; struct CGPoint { double x0; double x1; } x2; struct CGPoint { double x0; double x1; } x3; struct SCNVector3 { double x0; double x1; double x2; } x4; struct SCNVector3 { double x0; double x1; double x2; } x5; double x6; })a0;
