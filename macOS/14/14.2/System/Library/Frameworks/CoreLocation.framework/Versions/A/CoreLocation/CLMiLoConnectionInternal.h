...
- (void)_createCustomLocationOfInterestAtCurrentLocationWithConfiguration:(id)a0 RequestIdentifier:(id)a1;
- (void)_createCustomLocationOfInterestAtCurrentLocationWithRequestIdentifier:(id)a0;
...
- (void)_removeCustomLocationOfInterestFromMonitoringWithIdentifier:(id)a0 withRequestIdentifier:(id)a1;
