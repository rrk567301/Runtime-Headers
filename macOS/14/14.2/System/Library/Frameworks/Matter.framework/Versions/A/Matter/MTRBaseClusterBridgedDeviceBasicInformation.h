...
+ (void)readAttributeProductAppearanceWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeProductAppearanceWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeProductAppearanceWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
