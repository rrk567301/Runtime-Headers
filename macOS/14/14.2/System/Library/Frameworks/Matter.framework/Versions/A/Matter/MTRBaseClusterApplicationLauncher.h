...
+ (void)readAttributeCatalogListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeCurrentAppWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void).cxx_destruct;
- (void)launchAppWithParams:(id)a0 completion:(id /* block */)a1;
- (void)hideAppWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeCatalogListWithCompletion:(id /* block */)a0;
...
- (void)readAttributeCurrentAppWithCompletion:(id /* block */)a0;
...
- (void)stopAppWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeCatalogListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeCurrentAppWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeCurrentAppWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeCurrentAppWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentAppWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeCurrentAppWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
