...
+ (void)readAttributeRemainingCapacityWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeRemainingCapacityWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeRemainingCapacityWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
