...
+ (void)readAttributeAdminFabricIndexWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeAdminFabricIndexWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeAdminVendorIdWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeAdminVendorIdWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeWindowStatusWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeWindowStatusWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void).cxx_destruct;
- (id)initWithDevice:(id)a0 endpoint:(unsigned short)a1 queue:(id)a2;
- (id)initWithDevice:(id)a0 endpointID:(id)a1 queue:(id)a2;
- (void)openBasicCommissioningWindowWithParams:(id)a0 completion:(id /* block */)a1;
- (void)openBasicCommissioningWindowWithParams:(id)a0 completionHandler:(id /* block */)a1;
- (void)openCommissioningWindowWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeAdminFabricIndexWithCompletion:(id /* block */)a0;
- (void)readAttributeAdminFabricIndexWithCompletionHandler:(id /* block */)a0;
- (void)readAttributeAdminVendorIdWithCompletion:(id /* block */)a0;
...
- (void)readAttributeWindowStatusWithCompletion:(id /* block */)a0;
- (void)readAttributeWindowStatusWithCompletionHandler:(id /* block */)a0;
- (void)revokeCommissioningWithCompletion:(id /* block */)a0;
- (void)revokeCommissioningWithCompletionHandler:(id /* block */)a0;
- (void)revokeCommissioningWithParams:(id)a0 completion:(id /* block */)a1;
- (void)revokeCommissioningWithParams:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)subscribeAttributeAdminFabricIndexWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeAdminFabricIndexWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeAdminVendorIdWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeAdminVendorIdWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeWindowStatusWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeWindowStatusWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
