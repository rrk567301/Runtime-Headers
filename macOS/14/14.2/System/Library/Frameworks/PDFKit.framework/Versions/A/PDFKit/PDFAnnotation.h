@class NSURL, PDFAnnotationPrivateVars, PDFBorder, NSDate, PDFPage, NSDictionary, PDFAction, NSFont, NSString, PDFDestination, NSArray, CRNormalizedQuad, NSColor;
...
- (void)drawAppearance:(struct CGPDFForm { } *)a0 withBox:(long long)a1 inContext:(struct CGContext { } *)a2 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 scaleProportional:(BOOL)a4 suppressTextRendering:(BOOL)a5;
...
- (void)setShouldReportAnalytics:(BOOL)a0;
