...
@interface WebDisplayMediaPromptHelper : NSObject <SCContentSharingSessionProtocol, SCContentSharingPickerObserver> {
    struct WeakPtr<WebCore::ScreenCaptureKitSharingSessionManager, WTF::DefaultWeakPtrImpl> { struct RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> { struct DefaultWeakPtrImpl *m_ptr; } m_impl; } _callback;
