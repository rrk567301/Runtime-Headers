...
@interface WKWebInspectorUISaveController : NSViewController {
    struct Vector<WebCore::InspectorFrontendClient::SaveData, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct SaveData *m_buffer; unsigned int m_capacity; unsigned int m_size; } _saveDatas;
