...
@interface QLDisplayBundle : NSObject <QLAccessibilityUIElementDelegate, QLPreviewPageNavigationDataSource, QLTimeSliderDataSource, NSFilePresenter, QLDisplayable, NSPasteboardWriting> {
