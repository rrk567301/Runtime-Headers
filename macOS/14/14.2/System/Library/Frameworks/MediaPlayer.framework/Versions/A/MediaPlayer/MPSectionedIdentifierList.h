...
- (void)_performDelegateCalloutForSection:(id)a0 block:(id /* block */)a1;
...
- (void)dataSourceBeginTransactionForSection:(id)a0;
- (void)dataSourceEndTransactionForSection:(id)a0;
...
- (id)firstSectionMatching:(id /* block */)a0 containingItem:(id)a1 inSection:(id)a2;
