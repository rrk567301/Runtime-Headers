...
- (id)initWithContentType:(unsigned long long)a0 identifier:(id)a1 reason:(id)a2 title:(id)a3 subTitle:(id)a4 sfSymbolName:(id)a5 bundleID:(id)a6 actions:(id)a7 dismissAction:(id)a8 iconSpecification:(id)a9;
- (id)initWithContentType:(unsigned long long)a0 identifier:(id)a1 reason:(id)a2 title:(id)a3 subTitle:(id)a4 sfSymbolName:(id)a5 bundleID:(id)a6 actions:(id)a7 iconSpecification:(id)a8;
