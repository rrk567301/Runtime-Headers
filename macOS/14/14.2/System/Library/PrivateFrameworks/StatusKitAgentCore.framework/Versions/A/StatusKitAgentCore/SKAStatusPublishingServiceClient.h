...
@protocol SKAStatusPublishingServiceClientDelegate, OS_os_transaction, OS_dispatch_queue, SKADatabaseManaging, SKAMessagingProviding, SKADatabaseProviding, SKAChannelManaging, SKAStatusPublishingManaging;
