...
@interface MAUSBHostDeviceManager : MAUSBObject <MAUSBManagementPacketRequestTransmitterDelegate, MAUSBHostUSBDeviceDelegate> {
    ...
    NSMutableArray *_portMonitorRoutes;
...
- (void)inputApplePortEventNotification:(id)a0;
...
- (BOOL)startPortMonitoringForRouteString:(id)a0 completion:(id /* block */)a1;
- (BOOL)stopPortMonitoringForRouteString:(id)a0 completion:(id /* block */)a1;
