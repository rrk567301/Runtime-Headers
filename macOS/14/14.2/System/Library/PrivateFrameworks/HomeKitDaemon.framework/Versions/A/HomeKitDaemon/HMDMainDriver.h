@class HMDCurrentAccessorySetupMetricDispatcher, NSString, HMDCloudManager, HMDRetailDemoModeRequestHandler, HMDHomeManager, HMDDeviceSetupConfiguringController, HMDAppleMediaAccessoryDiagnosticInfoController, NSObject, HMDAccessoryBrowser, HMDUpdater, HMDMetricsManager, HMDCoreData;
