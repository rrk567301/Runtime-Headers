...
@interface LUI2UserListViewController : LUI2ViewController <LWUI2TrackingAreaOwnerProtocol, LUIStripViewDelegate, LUIStripViewDataSource> {
...
@property BOOL delegateSupportsAvatarDescriptorOfUser;
