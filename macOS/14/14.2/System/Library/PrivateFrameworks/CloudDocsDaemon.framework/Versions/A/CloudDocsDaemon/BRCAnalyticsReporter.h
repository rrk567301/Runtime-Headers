@class NSData, BRCItemGlobalID, NSSet, NSMutableDictionary, BRCAccountSession, BRCMetricEndpoint, NSObject, BRCSyncHealthReport, BRCRTCReporter, NSNumber, BRCAppTelemetryConverter;
