@class FBProcessExecutionContext, FBWatchdogTransitionContext, NSSet, RBSProcessHandle, FBSceneUpdateContext, BKSAnimationFenceHandle, BSProcessHandle, BSAnimationSettings;
