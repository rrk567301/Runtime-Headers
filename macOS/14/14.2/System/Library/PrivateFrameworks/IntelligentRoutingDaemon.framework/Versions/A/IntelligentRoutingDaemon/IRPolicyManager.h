@class IRPolicyEngine, IRCandidateManager, IRMediaRemoteProvider, NSMutableSet, IRTimer, IRServiceDO, NSString, IRReplayWriter, IRHistoryManager, NSObject, IRSystemStateManager, IRStatisticsManager;
...
- (void)_checkAndStartLowLatencyMiLoIfNeededWithForce:(BOOL)a0;
