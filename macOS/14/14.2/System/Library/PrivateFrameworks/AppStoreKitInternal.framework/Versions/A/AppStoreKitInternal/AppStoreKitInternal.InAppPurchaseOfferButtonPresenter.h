@interface AppStoreKitInternal.InAppPurchaseOfferButtonPresenter : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ offerButtonPresenterDelegate;
    void /* unknown type, empty encoding */ previousAppState;
    void /* unknown type, empty encoding */ currentAppState;
