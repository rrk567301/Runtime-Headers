...
- (id)_locateMatchingItemForTemplateItem:(id)a0 parentItem:(id)a1 logicalName:(id)a2 options:(unsigned long long)a3 fileURL:(id)a4 fields:(unsigned long long *)a5 shouldReject:(BOOL *)a6 additionalAttrs:(id)a7 importBookmark:(id)a8 ignoreImportBookmark:(BOOL *)a9 stillPendingFields:(unsigned long long *)a10 error:(id *)a11;
