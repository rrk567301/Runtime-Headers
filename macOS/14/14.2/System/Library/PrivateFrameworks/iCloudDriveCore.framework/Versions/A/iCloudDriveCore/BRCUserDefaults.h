...
@property (readonly, nonatomic) NSArray *telemetryRTCDisabledInvestigationKeys;
@property (readonly, nonatomic) NSArray *telemetryRTCAllowedZoneNamePrefixes;
@property (readonly, nonatomic) NSDictionary *telemetryRTCPayloadKeysConverter;
...
@property (readonly, nonatomic) BOOL ciconiaMarkSuccessAsFailOnContentProtectedItems;
...
@property (readonly, nonatomic) double thumbnailUploadAgeDelta;
