...
- (void)_populateFPFSImportStatusTelemetryEventForEvent:(id)a0 withFPImportReport:(id)a1;
...
- (void)_recoverAndReportContentPolicyWithCompletion:(id /* block */)a0;
...
- (BOOL)_shouldTriggerTapToRadar:(long long)a0 itemsNotMigrated:(long long)a1 reconciledItems:(long long)a2;
