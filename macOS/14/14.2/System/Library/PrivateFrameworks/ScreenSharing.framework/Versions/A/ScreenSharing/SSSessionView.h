@class SSCallWindowController, NSDate, NSMutableOrderedSet, NSDictionary, NSMutableArray, SSConnectionAuthenticationViewController, CALayer, SSCurtainMessageViewController, SSPanningScrollView, SSSession, NSTrackingArea, NSXPCConnection, SSNotificationOverlayViewController, SSScreenInfo, NSNumber, IDSService, NSCursor, IDSSession, SSConnectionProgressViewController, SSCredentials, NSArray, CAFilter, NSImage, NSMutableDictionary, NSView, NSString, SSBorderView, NSError, NWDatagramConnection, NSObject, SSConnectionAddressViewController, SSFadeView, SSSessionSelectViewController, NSTimer, SSConnectionWindowController, NSOrderedSet, SSFrameBufferView, AVConference, NSShadow, AVCRemoteVideoClient;
@protocol SSLocalDisplayMonitoring, SSSessionFileTransferDelegate, OS_dispatch_semaphore, SSSessionViewDelegate;

@interface SSSessionView : NSView <IDSSessionDelegate, SSConnectionProgressViewControllerDelegate, SSSessionSelectViewControllerDelegate, SSCurtainMessageViewControllerDelegate, SSConnectionPromptObserver, AVConferenceDelegate, AVCRemoteVideoClientDelegate, CALayerDelegate, SSSessionDelegate, SSFrameBufferViewDelegate, SSAddressResolutionObserver, SSCredentialsRequester, SSFadeViewDelegate, NSWindowDelegate, NSWindowRestoration, NSMutableCopying> {
