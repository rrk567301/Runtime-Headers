...
- (void)_decidePolicyForRemoteNotificationPermissionRequestWithID:(unsigned long long)a0 topLevelDomain:(id)a1;
...
- (void)agentDidVerifyRemoteNotificationProviderRequestID:(unsigned long long)a0 isValid:(BOOL)a1 forTopLevelDomain:(id)a2 errorMessages:(id)a3;
