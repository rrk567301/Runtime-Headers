...
@interface VisualTabPickerViewController : NSViewController <VisualTabPickerSearchFieldDelegate, VisualTabPickerCloudTabsViewDataSource, VisualTabPickerCloudTabsViewDelegate, VisualTabPickerTransitionAnimatorDelegate, VisualTabPickerTransitionCoordinatorDelegate, VisualTabPickerGridViewDataSource, VisualTabPickerGridViewDelegate> {
