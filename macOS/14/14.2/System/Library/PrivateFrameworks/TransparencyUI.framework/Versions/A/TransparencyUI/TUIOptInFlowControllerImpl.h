@class NSStackView, AIDAAccountManager, TUIAppleAccountManager, IDSService, iCloudAccountDetailsWebTabView, OBTemplateView, NSMutableArray, KTOptInManager, NSString, OBTemplateContainerViewController, TUIDeviceDetailsViewController, TUIStateManager, NSWindow, ACAccountStore, IDSSignInController;
...
- (BOOL)_hasIDSAccountTypeAppleID;
...
- (void)_showErrorAlertWithError:(id)a0;
