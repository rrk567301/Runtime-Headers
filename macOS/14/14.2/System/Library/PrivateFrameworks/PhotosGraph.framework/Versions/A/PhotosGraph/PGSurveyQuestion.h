...
- (id)_additionalInfoWithAnswerReasonRemovedForQuestionType:(unsigned short)a0 additionalInfo:(id)a1;
- (BOOL)_additionalInfosAreEqualForOtherQuestionAdditionalInfo:(id)a0;
