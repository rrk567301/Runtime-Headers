...
- (id)initWithID:(id)a0 titles:(id)a1 subtitles:(id)a2 flags:(long long)a3 ageRating:(id)a4 metrics:(id)a5 organicOffer:(id)a6 streamlinedOffer:(id)a7 contingentItemID:(id)a8 iapItemID:(id)a9 iapItemName:(id)a10;
