@class NSMutableDictionary, VUIDownloadConfig, VUIMediaShowcasingConfig, VUIPlaybackUpNextConfig, VUINowPlayingConfig, VUIAutoPlayConfig, VUIAccountMessageConfig, VUILiveLinkConfig, VUIUpNextConfig, VUICanonicalConfig, VUIPlayerTabsConfig, VUILaunchConfig, VUISyndicationConfig, VUITabItemsUpdateConfig, VUIMultiviewConfig, VUIDropOnTabConfig, VUIAccountConfig, VUIRootControllerConfig, VUILibConfig, VUIGDPRConfig;
