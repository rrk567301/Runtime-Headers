@class ATAParsedOpenURL, VUITVApplicationController, NSObject, NSDictionary, VUIStateMachine, VUIToolbar, VUIHintsWindowController, NSString, NSWindow, VUIBootURLController, NSArray, _TtC8VideosUI20VUIJetPackController, VUIWindowController;
