@class NSString, MUIMessageListDiffableDataSource, _TtC6MailUI28MUIMessageListCollectionView, NSObject, EFLocked;
...
@property (weak, nonatomic) _TtC6MailUI28MUIMessageListCollectionView *collectionView;
