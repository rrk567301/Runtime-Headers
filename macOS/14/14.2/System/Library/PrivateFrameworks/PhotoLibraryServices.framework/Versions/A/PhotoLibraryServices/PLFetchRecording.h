...
+ (void)_indexLocked_enumerateEntryHeadersFromBuffer:(const void *)a0 bufferLength:(unsigned long long)a1 fileHeaderSize:(unsigned long long)a2 block:(id /* block */)a3;
+ (void)_indexLocked_populateStatementIndex:(id)a0 fromBuffer:(void *)a1 bufferLength:(unsigned long long)a2 fileHeaderSize:(unsigned long long)a3;
