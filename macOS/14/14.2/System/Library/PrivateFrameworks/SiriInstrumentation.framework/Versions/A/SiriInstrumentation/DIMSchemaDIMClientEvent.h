@class NSData, SISchemaInstrumentationMessage, DIMSchemaDIMOnDeviceDigest, DIMSchemaDIMSiriAccountInformation, DIMSchemaDIMEphemeralToAggregationIdentifierMap, DIMSchemaDIMDeviceFixedContext, DIMSchemaDIMLocaleNotRecognized, DIMSchemaDIMEphemeralIdentifiers;
