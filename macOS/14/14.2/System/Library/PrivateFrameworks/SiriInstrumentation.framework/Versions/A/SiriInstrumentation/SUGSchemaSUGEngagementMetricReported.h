...
@interface SUGSchemaSUGEngagementMetricReported : SISchemaInstrumentationMessage {
    struct { unsigned char numberSuggestionShownBefore : 1; unsigned char hasConversion : 1; unsigned char secondsToConversion : 1; unsigned char numberOfActionsBefore : 1; unsigned char numberOfActionsAfter : 1; unsigned char daysBucketType : 1; } _has;
}
