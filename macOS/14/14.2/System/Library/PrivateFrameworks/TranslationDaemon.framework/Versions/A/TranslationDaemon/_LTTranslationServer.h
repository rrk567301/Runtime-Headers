@class _LTTextToSpeechCache, _LTDTranslationOperationScheduler, _LTDSELFLoggingManager, _LTServerSpeakSession, _LTActivityLogger, _LTLoggingRequestHandler, NSObject, _LTServerSpeechSession;
