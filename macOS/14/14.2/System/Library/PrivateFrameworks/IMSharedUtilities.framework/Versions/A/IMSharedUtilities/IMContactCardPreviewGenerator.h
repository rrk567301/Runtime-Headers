...
+ (struct CGImage { } *)newContactCardPreviewFrom:(id)a0 previewURL:(id)a1 senderContext:(id)a2 withPreviewConstraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; BOOL x4; })a3 error:(id *)a4;
...
+ (struct CGImage { } *)newPreviewFromSourceURL:(id)a0 previewURL:(id)a1 senderContext:(id)a2 withPreviewConstraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; BOOL x4; })a3 error:(id *)a4;
