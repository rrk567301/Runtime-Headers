@class PBUnknownFields, GEOMapRegion, GEOPDResolvedItem, GEOPDSearchSectionList, GEOPDSSearchAutoRedoThreshold, NSMutableArray, GEOPDSearchClientBehavior, NSString, GEOPDPlaceSummaryLayoutMetadata, PBDataReader, GEOPDResultRefinementGroup, GEOPDDirectionIntent, GEOPDMapsIdentifier, GEOPDRelatedSearchSuggestion;
...
@interface GEOPDSearchResult : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_dymSuggestionVisibleTime : 1; unsigned char has_retainSearchTime : 1; unsigned char has_searchResultType : 1; unsigned char has_searchResultViewType : 1; unsigned char has_disableAddingAdditionalPaddingOnViewport : 1; unsigned char has_enablePartialClientization : 1; unsigned char has_enableStructuredRapAffordance : 1; unsigned char has_isChainResultSet : 1; unsigned char has_showDymSuggestionCloseButton : 1; unsigned char read_unknownFields : 1; unsigned char read_autoRedoSearchThreshold : 1; unsigned char read_clientResolvedResult : 1; unsigned char read_defaultRelatedSearchSuggestion : 1; unsigned char read_directionIntent : 1; unsigned char read_disambiguationLabels : 1; unsigned char read_displayHeaderSubstitutes : 1; unsigned char read_displayMapRegion : 1; unsigned char read_openPlaceCardForResultWithId : 1; unsigned char read_placeSummaryLayoutMetadata : 1; unsigned char read_relatedEntitySections : 1; unsigned char read_relatedSearchSuggestions : 1; unsigned char read_resultDetourInfos : 1; unsigned char read_resultDisplayHeader : 1; unsigned char read_resultRefinementGroup : 1; unsigned char read_retainSearchs : 1; unsigned char read_searchClientBehavior : 1; unsigned char read_searchResultSections : 1; unsigned char read_searchTierMetadatas : 1; unsigned char read_sectionList : 1; unsigned char wrote_anyField : 1; } _flags;
}
