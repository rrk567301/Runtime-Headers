@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, GEOAddressObject, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOEnrichmentData, GEOEVCharger, GEOMapRegion, GEOMuninViewState, NSMapTable, NSData, GEOPlace, GEOEnclosingPlace, GEOStorefrontPresentationInfo, GEOEnrichmentInfo, GEOBusinessHours, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOInlineRapEnablement, GEOPlacecardLayoutData, GEOViewportFrame, GEOPOIClaim, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOPDMultiLocalizedString, GEOStyleAttributes, GEOStorefrontInfo, NSString, _GEOEncyclopedicInfo, NSTimeZone, GEOTooltip, GEOTrailHead, GEOMapItemPhotosAttribution, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEORestaurantFeaturesLink, geo_reentrant_isolater, GEOBusinessAssets, GEOPDPlace, GEOPriceDescription, GEOAddress;
