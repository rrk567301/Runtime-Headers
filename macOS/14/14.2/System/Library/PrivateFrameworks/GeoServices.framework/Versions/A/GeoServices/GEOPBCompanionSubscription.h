...
@interface GEOPBCompanionSubscription : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_dataType : 1; unsigned char has_policy : 1; unsigned char read_unknownFields : 1; unsigned char read_identifier : 1; unsigned char read_region : 1; unsigned char wrote_anyField : 1; } _flags;
}
