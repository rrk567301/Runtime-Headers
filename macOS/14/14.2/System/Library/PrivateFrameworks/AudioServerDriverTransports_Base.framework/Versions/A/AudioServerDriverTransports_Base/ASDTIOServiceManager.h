@class ASDTCondition, NSString, NSMutableDictionary, NSArray, NSDictionary, NSMutableArray, ASDTIOServiceMatcher;
...
@property (readonly, nonatomic) NSDictionary *matchedIOServices;
...
- (id)getIDValueForIOService:(unsigned int)a0 withProperties:(id)a1;
