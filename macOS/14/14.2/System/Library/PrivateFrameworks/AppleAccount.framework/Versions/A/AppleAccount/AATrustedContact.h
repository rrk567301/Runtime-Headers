...
- (id)initWithID:(id)a0 status:(long long)a1 handle:(id)a2 firstName:(id)a3 lastName:(id)a4 displayName:(id)a5 isAcceptedAndShared:(BOOL)a6 isIdMSConfirmed:(BOOL)a7 preflightStatus:(long long)a8;
