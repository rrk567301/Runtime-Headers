@class NSString, _MRGroupSessionTokenProtobuf, NSData, MRGroupSessionHostInfo, MRDiscoveredGroupSession;
...
- (id)initWithHostInfo:(id)a0 invitationData:(id)a1;
- (id)initWithHostInfo:(id)a0 invitationData:(id)a1 sharedSecret:(id)a2 sessionIdentifier:(id)a3 equivalentMediaIdentifier:(id)a4;
