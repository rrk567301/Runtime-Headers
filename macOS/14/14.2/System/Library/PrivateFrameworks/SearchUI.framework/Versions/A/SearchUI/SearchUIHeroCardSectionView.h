@class NSString, SFImage, NUIContainerBoxView, NSVisualEffectView, SearchUILabel, NUIContainerStackView, SFHeroCardSection, SearchUIButtonItemStackView, SearchUIImageView, SearchUIFeatheredBlurView;
