@class NSData, _SFPBWatchListButtonItem, _SFPBAppAutoShortcutsButtonItem, _SFPBContactButtonItem, _SFPBSportsFollowButtonItem, NSString, _SFPBCoreSpotlightButtonItem, _SFPBCommandButtonItem;
