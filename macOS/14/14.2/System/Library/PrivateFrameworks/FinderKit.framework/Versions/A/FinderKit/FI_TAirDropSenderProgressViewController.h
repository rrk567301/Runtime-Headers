...
+ (void)startSendingNodes:(const void *)a0 toReceiverNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1;
...
- (id)initWithReceiverServerNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 nodesToSend:(const void *)a1;
