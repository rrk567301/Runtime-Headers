@class BWFigVideoCaptureStream, NSMutableDictionary, CMCaptureFrameSenderService, NSObject, BWPixelBufferPool, BWFigCaptureStream, BWDeferredMetadataCache, BWStats, NSDictionary, BWMultiStreamCameraSourceNodeConfiguration, BWFigVideoCaptureDevice, NSString, BWDetectedFacesRingBuffer, BWDetectedObjectsInfoRingBuffer, BWMotionDataPreserver, CMIDistortionModel, NSArray, BWNodeOutput;
