@class PTEffectRenderRequest, NSString, BWLimitedGMErrorLogger, FigCaptureThermalMonitor, NSMutableDictionary, PTEffect, BWStats, NSMutableArray, BWNodeOutput, BWNodeInput;
