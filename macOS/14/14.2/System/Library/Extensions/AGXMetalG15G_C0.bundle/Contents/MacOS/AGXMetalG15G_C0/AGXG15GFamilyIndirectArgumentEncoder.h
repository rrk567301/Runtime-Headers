@class NSString, AGXG15GFamilyDevice, AGXG15GFamilyBuffer;
@protocol MTLDevice;

@interface AGXG15GFamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG15GFamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG15GFamilyBuffer *current_argument_buffer; } _impl;
}
