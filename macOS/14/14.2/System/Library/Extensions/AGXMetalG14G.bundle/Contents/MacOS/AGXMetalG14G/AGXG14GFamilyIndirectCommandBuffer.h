@class NSString, AGXG14GFamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG14GFamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG14GFamilyBuffer *_buffer;
