@class NSError, NSString, AGXG15GFamilyBlitContext, __end_, __end_cap_, NSMutableDictionary, NSDictionary, AGXG15GFamilyComputeContext, AGXG15GFamilyRenderContext;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLFence, MTLCommandQueue;

@interface AGXG15GFamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG15GFamilyBlitContext *_previousBlitCommandEncoder;
    AGXG15GFamilyComputeContext *_previousComputeCommandEncoder;
    AGXG15GFamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG15GFamilyTexture *, std::allocator<AGXG15GFamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG15GFamilyTexture **, std::allocator<AGXG15GFamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
