@class RTLearnedLocationReconcilerPerVisit, RTDefaultsManager, RTContactsManager, RTLocationStore, RTMapsSupportManager, RTMapServiceManager, RTFingerprintManager, RTLocationManager, RTVisitManager, RTAccountManager, RTLearnedLocationEngineTrainingMetrics, RTSettledStateTransitionStore, RTLearnedLocationReconcilerPerDevice, RTXPCActivityManager, NSString, RTTransitMetricManager, RTPlatform, RTDistanceCalculator, RTPlaceTypeClassifierMetricsCalculator, NSObject, RTDailyTrainingSessionCounter, RTPersonalizationPortraitManager, RTLearnedPlaceTypeInferenceStore, RTMetricManager, RTEventManager, RTDiagnostics, RTElevationManager, RTMotionActivityManager, RTLearnedLocationStore, RTTripSegmentProvider;
...
- (id)initWithAccountManager:(id)a0 contactsManager:(id)a1 dailyTrainingSessionCounter:(id)a2 defaultsManager:(id)a3 diagnostics:(id)a4 distanceCalculator:(id)a5 elevationManager:(id)a6 eventManager:(id)a7 fingerprintManager:(id)a8 learnedLocationStore:(id)a9 learnedPlaceTypeInferenceStore:(id)a10 locationManager:(id)a11 locationStore:(id)a12 mapServiceManager:(id)a13 mapsSupportManager:(id)a14 metricManager:(id)a15 motionActivityManager:(id)a16 platform:(id)a17 portraitManager:(id)a18 reconcilerPerVisit:(id)a19 reconcilerPerDevice:(id)a20 settledStateTransitionStore:(id)a21 transitMetricManager:(id)a22 tripSegmentProvider:(id)a23 visitManager:(id)a24 xpcActivityManager:(id)a25;
