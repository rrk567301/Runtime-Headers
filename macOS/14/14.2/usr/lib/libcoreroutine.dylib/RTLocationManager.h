@class NSMutableDictionary, CLLocation, NSDate, RTInvocationDispatcher, RTDefaultsManager, CLLocationManager, NSMutableArray, RTPlatform, RTTimerManager, NSString, RTPowerAssertion, CLLocationManagerRoutine, RTStore, RTTimer, RTAuthorizationManager, RTLocationSmoother;
...
@property (retain, nonatomic) NSDate *userTimeAtLastTrustedTimeUpdate;
@property double userTimeToTrustedTimeOffset_s;
