@class RTLearnedVisit, RTPlatform, NSDictionary, RTDefaultsManager, RTDistanceCalculator, RTPlaceTypeClassifierMetricsCalculator, RTLearnedLocationStore, NSMutableArray;
...
- (id)initWithDefaultsManager:(id)a0 distanceCalculator:(id)a1 learnedLocationStore:(id)a2 placeTypeClassifierMetricsCalculator:(id)a3 platform:(id)a4;
