@interface AGXG15XFamilyIndirectArgumentBufferLayout : _MTLIndirectArgumentBufferLayout {
    struct unique_ptr<AGX::G15::IndirectArgumentLayout, std::default_delete<AGX::G15::IndirectArgumentLayout>> { struct __compressed_pair<AGX::G15::IndirectArgumentLayout *, std::default_delete<AGX::G15::IndirectArgumentLayout>> { struct IndirectArgumentLayout *__value_; } __ptr_; } _impl;
}
