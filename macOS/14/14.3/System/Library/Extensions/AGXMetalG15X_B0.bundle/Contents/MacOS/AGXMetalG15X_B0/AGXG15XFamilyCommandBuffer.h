@class NSError, AGXG15XFamilyBlitContext, NSString, AGXG15XFamilyComputeContext, __end_cap_, NSMutableDictionary, NSDictionary, AGXG15XFamilyRenderContext, __end_;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLFence, MTLCommandQueue;

@interface AGXG15XFamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG15XFamilyBlitContext *_previousBlitCommandEncoder;
    AGXG15XFamilyComputeContext *_previousComputeCommandEncoder;
    AGXG15XFamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG15XFamilyTexture *, std::allocator<AGXG15XFamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG15XFamilyTexture **, std::allocator<AGXG15XFamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
