...
+ (void)_emitNotificationForTask:(unsigned short)a0;
+ (id)dailyDonateTasks;
...
- (BOOL)_handleTask:(unsigned short)a0 reason:(unsigned short)a1 shouldDefer:(id /* block */)a2 completion:(id /* block */)a3;
