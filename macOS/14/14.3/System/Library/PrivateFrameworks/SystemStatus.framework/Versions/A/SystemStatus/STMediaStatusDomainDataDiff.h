...
@interface STMediaStatusDomainDataDiff : NSObject <BSDebugDescriptionProviding, STStatusDomainDataDiff> {
    STListDataDiff *_microphoneRecordingAttributionListDataDiff;
...
- (id)initWithMicrophoneRecordingAttributionListDataDiff:(id)a0 mutedMicrophoneRecordingAttributionListDataDiff:(id)a1 systemAudioRecordingAttributionListDataDiff:(id)a2 cameraAttributionListDataDiff:(id)a3;
