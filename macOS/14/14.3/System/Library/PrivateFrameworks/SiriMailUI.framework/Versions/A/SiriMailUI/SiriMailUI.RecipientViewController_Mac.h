@interface SiriMailUI.RecipientViewController_Mac : NSViewController <NSTokenFieldDelegate, CNAutocompleteResultWindowDelegate, CNAutocompleteFetchDelegate, CNAutocompleteSuggestionsViewControllerDelegate, CNContactPickerDelegate> {
