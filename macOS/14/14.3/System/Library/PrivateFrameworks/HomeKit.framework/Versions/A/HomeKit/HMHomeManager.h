...
- (void)addEphemeralContainer:(id)a0 completion:(id /* block */)a1;
...
- (void)deactivateEphemeralContainer:(id)a0 completion:(id /* block */)a1;
- (void)deleteCountersBeforeDate:(id)a0 afterDate:(id)a1 completion:(id /* block */)a2;
- (void)deleteEphemeralContainer:(id)a0 completion:(id /* block */)a1;
...
- (void)readCountersForGroup:(id)a0 homeUUIDString:(id)a1 accessoryUUIDString:(id)a2 counter:(id)a3 statistics:(id)a4 datePartition:(id)a5 ephemeralContainer:(id)a6 completion:(id /* block */)a7;
...
- (void)startupEphemeralContainer:(id)a0 completion:(id /* block */)a1;
