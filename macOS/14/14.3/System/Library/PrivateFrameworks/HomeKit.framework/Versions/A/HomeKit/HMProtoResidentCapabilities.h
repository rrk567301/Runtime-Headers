...
@interface HMProtoResidentCapabilities : PBCodable <NSCopying> {
    struct { unsigned char supports5348b248a25f84b0c83e : 1; unsigned char supportsAccessCodes : 1; unsigned char supportsAnnounce : 1; unsigned char supportsCHIP : 1; unsigned char supportsCameraActivityZones : 1; unsigned char supportsCameraPackageDetection : 1; unsigned char supportsCameraRecording : 1; unsigned char supportsCameraRecordingReachabilityNotifications : 1; unsigned char supportsCameraSignificantEventNotifications : 1; unsigned char supportsCustomMediaApplicationDestination : 1; unsigned char supportsEventLog : 1; unsigned char supportsFaceClassification : 1; unsigned char supportsFirmwareUpdate : 1; unsigned char supportsHomeHub : 1; unsigned char supportsLockNotificationContext : 1; unsigned char supportsMatterTTU : 1; unsigned char supportsMediaActions : 1; unsigned char supportsNaturalLighting : 1; unsigned char supportsResidentFirmwareUpdate : 1; unsigned char supportsResidentFirstAccessoryCommunication : 1; unsigned char supportsRouterManagement : 1; unsigned char supportsShortcutActions : 1; unsigned char supportsSiriEndpointSetup : 1; unsigned char supportsThreadBorderRouter : 1; unsigned char supportsThreadNetworkCredentialSharing : 1; unsigned char supportsUnifiedMediaNotifications : 1; unsigned char supportsWakeOnLAN : 1; unsigned char supportsWalletKey : 1; } _has;
}
