@interface AWDHomeKitWHAAccessControl : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char privilegeLevel : 1; unsigned char isP2PEnabled : 1; unsigned char isPasswordSet : 1; } _has;
}
...
- (BOOL)readFrom:(id)a0;
- (void)writeTo:(id)a0;
- (int)StringAsPrivilegeLevel:(id)a0;
- (id)privilegeLevelAsString:(int)a0;
