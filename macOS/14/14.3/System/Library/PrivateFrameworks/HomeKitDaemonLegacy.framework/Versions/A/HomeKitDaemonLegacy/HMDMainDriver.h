@class HMDCoreData, NSString, HMDCloudManager, HMDRetailDemoModeRequestHandler, HMDHomeManager, HMDDeviceSetupConfiguringController, HMDAppleMediaAccessoryDiagnosticInfoController, NSObject, HMDAccessoryBrowser, HMDUpdater, HMDMetricsManager, HMDCurrentAccessorySetupMetricDispatcher;
