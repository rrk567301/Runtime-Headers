...
- (id)copyValueFromDevice:(struct _AMDevice { } *)a0 domain:(struct __CFString { } *)a1 key:(struct __CFString { } *)a2;
- (void)addMobileDeviceConnection:(id)a0;
- (id)copyValueFromDevice:(struct _AMDevice { } *)a0 key:(struct __CFString { } *)a1;
