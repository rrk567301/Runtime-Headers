@interface WeatherDaemon.WeatherDataServiceProxy : NSObject <WeatherDaemon.WeatherDataServiceProxyType> {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_dailyStatisticsService;
    void /* unknown type, empty encoding */ $__lazy_storage_$_dailySummaryService;
    void /* unknown type, empty encoding */ $__lazy_storage_$_hourlyStatisticsService;
    void /* unknown type, empty encoding */ $__lazy_storage_$_monthlyStatisticsService;
    void /* unknown type, empty encoding */ $__lazy_storage_$_availabilityDataManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_dataManager;
    void /* unknown type, empty encoding */ lazyStatisticsDataStore;
    void /* unknown type, empty encoding */ $__lazy_storage_$_hourlyStatisticsDataManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_dailyStatisticsDataManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_dailySummaryDataManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_monthlyStatisticsDataManager;
