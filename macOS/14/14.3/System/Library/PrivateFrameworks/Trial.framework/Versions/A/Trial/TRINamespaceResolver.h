@class _PASLock, NSSet, NSString, TRIRolloutDeployment, TRIExperimentDeployment, TRIBMLTDeployment;
@protocol TRIPaths;
...
- (id)_globalFactorProviderForNamespaceName:(id)a0 parentId:(id)a1 deploymentId:(int)a2 fromFactorPackId:(id)a3 resolvedPath:(id *)a4;
...
- (id)_resolvePropertyListGlobalFactorProviderChainForNamespaceName:(id)a0;
