@class FBSSceneIdentityToken, NSMapTable, FBSSceneSpecification, FBSSceneSettings, NSMutableArray, BKSAnimationFenceHandle, FBSSceneDefinition, FBSSerialQueue, NSString, FBSSceneHostHandle, BSAuditToken, FBSSceneIdentity, FBSSceneClientSettings;
