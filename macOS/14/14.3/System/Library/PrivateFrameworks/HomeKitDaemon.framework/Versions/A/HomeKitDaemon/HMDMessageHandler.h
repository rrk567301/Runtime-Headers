@class HMDAppleAccountManager, NSString, NSArray, HMDMediaGroupSetupMetricDispatcher, NSUUID, NSMutableDictionary, NSDictionary, HMFMessageDispatcher, NSObject, NSNotificationCenter, HMDMessageHandlerMetricsDispatcher;
