@class HMDAppleAccountManager, NSSet, HMDRemoteDeviceMonitor, NSMutableSet, NSObject, HMDMessageDispatcher, HMFFuture, NSString, HMDPrimaryElectionCoordinationAddOn, NSHashTable, HMDModernTransportDeviceReachabilityObserver, HMDResidentDevice, HMDDevice, NSArray, HMDHome, HMFPromise, NSNotificationCenter, NSUUID;
