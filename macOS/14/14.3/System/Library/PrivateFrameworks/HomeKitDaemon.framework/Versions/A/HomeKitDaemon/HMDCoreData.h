@class HMFPromise, NSMapTable, HMDFeaturesDataSource, NSObject, NSManagedObjectModel, HMFFuture, NSString, NSSet, NSHashTable, HMCContext, NSUserDefaults, NSArray, NSPersistentCloudKitContainer, NSPersistentStore, NSPersistentStoreCoordinator, NSPersistentStoreDescription;
