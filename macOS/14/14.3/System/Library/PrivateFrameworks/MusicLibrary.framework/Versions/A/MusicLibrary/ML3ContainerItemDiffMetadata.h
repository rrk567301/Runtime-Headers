...
+ (id)diffMetadataWithPersistentID:(long long)a0 containerPersistentID:(long long)a1 itemPersistentID:(long long)a2 newPosition:(long long)a3 previousPosition:(long long)a4 uuid:(id)a5 positionUUD:(id)a6;
