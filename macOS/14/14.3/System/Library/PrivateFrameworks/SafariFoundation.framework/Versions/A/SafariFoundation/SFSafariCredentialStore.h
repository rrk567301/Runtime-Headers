...
+ (void)_getCredentialsForAppWithApprovedAndValidSharedWebCredentialsDatabaseEntries:(id)a0 websiteURL:(id)a1 isEntitledWebBrowser:(BOOL)a2 hasPasskeyRequest:(BOOL)a3 completionHandler:(id /* block */)a4;
+ (void)_getCredentialsForAppWithApprovedAndValidSharedWebCredentialsDatabaseEntries:(id)a0 websiteURL:(id)a1 webFrameIdentifier:(id)a2 isEntitledWebBrowser:(BOOL)a3 hasPasskeyRequest:(BOOL)a4 completionHandler:(id /* block */)a5;
...
+ (void)_getExternalCredentialsMatchingSharedWebCredentialsDatabaseEntries:(id)a0 websiteURL:(id)a1 isEntitledWebBrowser:(BOOL)a2 hasPasskeyRequest:(BOOL)a3 completion:(id /* block */)a4;
