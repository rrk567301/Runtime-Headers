@class NSString, DEDCloudKitAttachmentGroupModel, NSMutableDictionary, DEDCloudKitClient, NSDictionary, NSMutableArray, NSObject, DEDBugSession;
@protocol OS_os_log;
...
- (void)_performCloudKitOperations;
