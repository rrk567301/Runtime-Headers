@class GEOPDSInferredSignals, GEOPDViewportInfo, GEOPDETAFilter, PBUnknownFields, GEOPDRecentRouteInfo, GEOPDResultRefinementQuery, GEOPDSSearchEvChargingParameters, NSMutableArray, GEOPDSSearchFilter, GEOPDSearchOriginationInfo, NSString, GEOPDAutocompleteEntry, PBDataReader, GEOPDRetainedSearchMetadata, GEOPDSSearchLocationParameters, NSData, GEOPDSSearchStructureIntentRequestType, GEOPDSPunchInHints;
