@class GEODirectionIntent, GEOMapServiceTraits, GEOMapRegion, GEOMapItemIdentifier, GEOPDMerchantLookupResult, NSString, GEOResultRefinementGroup, GEOPDPlaceSummaryLayoutMetadata, GEORelatedSearchSuggestion, GEOResolvedItem, NSArray, GEOSearchAutoRedoThreshold, GEOSearchSectionList, GEOCategorySearchResultSection;
...
- (id)initWithRequest:(id)a0 shiftLocationsIfNeeded:(BOOL)a1 traits:(id)a2;
