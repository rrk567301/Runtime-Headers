@class GEODirectionIntent, GEOMapServiceTraits, GEOMapRegion, GEOMapItemIdentifier, GEOPDMerchantLookupResult, NSString, GEOResultRefinementGroup, GEOPDPlaceSummaryLayoutMetadata, geo_isolater, GEORelatedSearchSuggestion, GEOResolvedItem, NSArray, GEOSearchAutoRedoThreshold, GEOSearchSectionList, GEOCategorySearchResultSection;
