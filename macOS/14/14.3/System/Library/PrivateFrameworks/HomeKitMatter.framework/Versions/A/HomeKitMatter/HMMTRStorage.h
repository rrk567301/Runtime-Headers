...
- (id)_createTransientOperationalCertificateForFabricID:(id)a0;
- (void)_fetchCert2ForFabricWithID:(id)a0 isOwner:(BOOL)a1 completion:(id /* block */)a2;
- (void)_fetchCertForFabricWithID:(id)a0 isOwner:(BOOL)a1 completion:(id /* block */)a2;
- (void)_fetchOperationalCertificatesFromResidentForFabricID:(id)a0 completion:(id /* block */)a1;
- (void)_fetchSharedUserCert2ForFabricWithID:(id)a0 reFetch:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)fetchSharedUserCertForFabricWithID:(id)a0 reFetch:(BOOL)a1 completion:(id /* block */)a2;
