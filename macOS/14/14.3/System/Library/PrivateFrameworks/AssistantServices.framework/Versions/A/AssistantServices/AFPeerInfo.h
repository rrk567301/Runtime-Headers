...
- (id)initWithIsDeviceOwnedByCurrentUser:(BOOL)a0 assistantIdentifier:(id)a1 sharedUserIdentifier:(id)a2 idsIdentifier:(id)a3 idsDeviceUniqueIdentifier:(id)a4 rapportEffectiveIdentifier:(id)a5 homeKitAccessoryIdentifier:(id)a6 mediaSystemIdentifier:(id)a7 mediaRouteIdentifier:(id)a8 isCommunalDevice:(BOOL)a9 roomName:(id)a10 name:(id)a11 productType:(id)a12 buildVersion:(id)a13 userInterfaceIdiom:(id)a14 aceVersion:(id)a15 isLocationSharingDevice:(BOOL)a16 isSiriCloudSyncEnabled:(BOOL)a17;
