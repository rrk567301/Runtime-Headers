...
@interface ReaderizedArticleFetcherNavigationDelegate : NSObject <WKNavigationDelegate> {
    struct WeakPtr<Safari::ReaderizedArticleFetcher, WTF::DefaultWeakPtrImpl> { struct RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> { struct DefaultWeakPtrImpl *m_ptr; } m_impl; } _readerizedArticleFetcher;
}
