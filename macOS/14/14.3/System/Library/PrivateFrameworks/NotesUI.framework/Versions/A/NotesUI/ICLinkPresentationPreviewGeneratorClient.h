...
- (struct CGSize { double x0; double x1; })drawPreviewStartingAtPoint:(struct CGPoint { double x0; double x1; })a0 attachment:(id)a1 insideSystemPaper:(BOOL)a2 forceLightContent:(BOOL)a3;
