...
+ (id)imageDataByAddingMissingPrimaryImageProperties:(id)a0 toImageDataSource:(struct CGImageSource { } *)a1 primaryImageIndex:(unsigned long long)a2 inputImagePropertiesByIndex:(id)a3;
...
+ (id)imagePropertiesByImageIndexInImageSource:(struct CGImageSource { } *)a0;
+ (id)primaryImagePropertiesForFileAtURL:(id)a0;
+ (id)stereoGroupInfoForImageIndex:(unsigned long long)a0 containerImageGroups:(id)a1;
