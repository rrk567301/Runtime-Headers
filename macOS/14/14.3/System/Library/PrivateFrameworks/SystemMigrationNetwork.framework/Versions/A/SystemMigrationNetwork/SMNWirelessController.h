@class NSString, NSTask, AWDLServiceDiscoveryManager, NSMutableArray, NSObject;
...
- (BOOL)startDedicatedAccessPointWithPassword:(id)a0 error:(id *)a1;
- (void)stopDedicatedAccessPoint;
