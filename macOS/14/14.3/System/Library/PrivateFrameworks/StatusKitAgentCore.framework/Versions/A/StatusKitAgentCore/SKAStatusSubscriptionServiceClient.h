...
@protocol SKAStatusSubscriptionServiceClientDelegate, SKADatabaseManaging, SKAStatusSubscriptionManaging, OS_os_transaction, OS_dispatch_queue, SKAStatusEncryptionManaging;
