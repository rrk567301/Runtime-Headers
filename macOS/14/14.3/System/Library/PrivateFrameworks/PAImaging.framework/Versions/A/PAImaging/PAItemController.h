@class NSMutableDictionary, PELivePortraitBehaviorController, PHAdjustmentData, NSObject, PHAsset, NSMutableArray, PAImageItem, PACompositionEditController, PHContentEditingInput, NSString, PXCinematicEditController, PICompositionController, PLEditSource;
