...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ leaderboardListSubview;
@property (nonatomic, readonly) void /* unknown type, empty encoding */ leaderboardAvatarsSubview;
