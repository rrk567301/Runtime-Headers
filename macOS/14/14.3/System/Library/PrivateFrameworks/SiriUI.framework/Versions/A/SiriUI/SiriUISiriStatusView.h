@class NSString, SiriSharedUINotificationCenterPlatterView, NSPressGestureRecognizer, AVPlayerLooper, AVQueuePlayer, SRFLockStateNotifier, SiriUIRequestHandlingStatusView, NSMutableArray, SiriUIOrbView, SiriUITextInputField, SiriUITalkGestureTarget, NSLayoutConstraint;
