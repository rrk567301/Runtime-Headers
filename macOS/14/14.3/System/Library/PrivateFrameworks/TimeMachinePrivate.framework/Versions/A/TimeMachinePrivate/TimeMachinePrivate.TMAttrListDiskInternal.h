@class NSString, NSURL, NSNumber, _TtC18TimeMachinePrivate22TMAttrListDiskInternal;

@interface TimeMachinePrivate.TMAttrListDiskInternal : NSObject <TMAttrListDisk> {
    void /* unknown type, empty encoding */ disk;
}

@property (class, nonatomic, readonly) _TtC18TimeMachinePrivate22TMAttrListDiskInternal *bootedDataVolume;
