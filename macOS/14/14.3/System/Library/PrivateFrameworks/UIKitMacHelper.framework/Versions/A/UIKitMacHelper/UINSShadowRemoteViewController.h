...
@interface UINSShadowRemoteViewController : NSRemoteViewController <UINSShadowRemoteViewController> {
    ...
    struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } _lastViewFrameInNSWindow;
...
+ (void)maybeReestablishFirstResponderStateForUIWindow:(id)a0 uiFirstResponder:(id)a1;
