@class NSString, NSArray, NSDraggingSession, NSMutableDictionary, SSFrameBuffer, CALayer, NSImage, NSPasteboard;
...
@property (nonatomic) double breakoutScaleAdjustment;
