@class NWDatagramConnection, NSString, NSFileHandle, NSXPCConnection, NWConnectionManager, SSConnectionOptions, NSDictionary, IDSSession, NSMutableSet, CNContactStore;
