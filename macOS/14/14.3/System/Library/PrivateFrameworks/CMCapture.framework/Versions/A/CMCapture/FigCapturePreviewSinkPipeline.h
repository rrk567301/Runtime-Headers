@class BWPixelTransferNode, FigCaptureSemanticStyle, NSDictionary, BWPreviewStitcherNode, BWPreviewStabilizationNode, NSObject, BWPreviewTimeMachineSinkNode, BWVideoPIPOverlayNode, NSString, BWImageQueueSinkNode, BWStreamingFilterNode, BWSceneClassifierSinkNode, NSArray, BWNodeOutput, BWInferenceNode;
