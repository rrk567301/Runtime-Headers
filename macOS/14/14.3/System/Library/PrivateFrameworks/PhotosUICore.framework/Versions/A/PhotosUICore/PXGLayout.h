@class PXGViewEnvironment, PXAssetsSectionLayout, PXGDecoratingLayout, NSMutableArray, PXGSublayoutDataStore, NSString, NSMutableSet, PXGBasicAXGroup, PXGDataSourceChange, PXGItemsLayout, PXMediaProvider, PXGAnchor, NSArray, NSObject, NSView, PXGEntityManager, PXGSpriteDataStore, PXGSpriteMetadataStore, NSIndexSet, NSHashTable;
