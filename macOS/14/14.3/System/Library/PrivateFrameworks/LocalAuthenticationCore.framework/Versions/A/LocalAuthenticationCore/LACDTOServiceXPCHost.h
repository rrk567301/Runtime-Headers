@class NSString;
@protocol LACDTOFeatureControlling, LACDTOPendingPolicyEvaluationController, LACDTORatchetStateProvider;
...
- (id)initWithFeatureController:(id)a0 ratchetStateProvider:(id)a1 pendingEvaluationController:(id)a2;
