...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
    ...
    struct tagTierInfo { unsigned int tier; unsigned int duplication; unsigned int redPayloads; unsigned int redMaxDelay; unsigned int bundling; unsigned int codecPayload; unsigned int codecBitrate; } _tierInfo;
