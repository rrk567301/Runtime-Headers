@class NSArray, NSSet, NSMutableSet, NSString, WBSWebExtensionsController;
...
- (id)initWithPersistentContentScriptDetails:(id)a0 extensionIdentifier:(id)a1 extensionsController:(id)a2 errorMessage:(id *)a3;
- (void)removeWKUserScriptsFromUserContentController:(id)a0;
- (void)removeWKUserStyleSheetsFromUserContentController:(id)a0;
