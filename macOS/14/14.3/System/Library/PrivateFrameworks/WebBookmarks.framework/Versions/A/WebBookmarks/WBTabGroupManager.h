@class WBSCRDTPositionGenerator, NSMutableDictionary, NSObject, NSDictionary, WBProfile, NSMutableArray, WBBrowserState, NSString, NSSet, NSHashTable, WBSProfileDataManager, NSMutableSet, WBSPair, NSArray, WBTabCollection, WBParticipantPresenceCoordinator, NSCountedSet;
