@class NSSet, NSString, NSDictionary, NSMutableData, NSNumber, NSArray;
...
- (BOOL)openCurrentOutputFDForPath:(id)a0 withOpenFlags:(int)a1 mode:(unsigned short)a2 error:(id *)a3;
- (BOOL)resolveOwnershipWithExtraField:(struct { unsigned char x0[2]; struct { unsigned short x0; } x1; struct { unsigned int x0; } x2; struct { unsigned int x0; } x3; struct { unsigned short x0; } x4; struct { unsigned short x0; } x5; } *)a0 outUID:(unsigned int *)a1 outGID:(unsigned int *)a2;
- (id)serializeState;
