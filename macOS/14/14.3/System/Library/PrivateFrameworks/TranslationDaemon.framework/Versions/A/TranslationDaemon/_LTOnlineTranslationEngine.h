@class NSDate, NSString, _LTTextToSpeechCache, _LTBatchTranslationResponseHandler, _LTDSELFLoggingManager, FTBlazarService, AFSettingsConnection, NSObject, _LTOspreySpeechTranslationSession;
