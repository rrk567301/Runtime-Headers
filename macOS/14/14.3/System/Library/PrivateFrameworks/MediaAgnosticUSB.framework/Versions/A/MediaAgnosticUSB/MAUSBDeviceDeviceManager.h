@class MAUSBProtocolConfiguration, NSMutableArray, MAUSBHostCapabilities, MAUSBManagementPacketResponseCache, MAUSBManagementPacketRequestTransmitter, NSObject, MAUSBPacketDumper;
@protocol OS_dispatch_queue, MAUSBDevicePAL, MAUSBDeviceDeviceManagerDelegate;

@interface MAUSBDeviceDeviceManager : MAUSBObject <MAUSBManagementPacketRequestTransmitterDelegate, MAUSBDeviceUSBDeviceDelegate, MAUSBDevicePortMonitorDelegate> {
...
- (void)inputStopPortMonitoringRequest:(id)a0;
...
- (id)initWithDelegate:(id)a0 mediaType:(unsigned long long)a1 queue:(id)a2 protocolAdaptationLayer:(id)a3 captureFileLocation:(id)a4;
...
- (void)inputStartPortMonitoringRequest:(id)a0;
...
- (void)sendStartPortMonitorResponseForRequest:(id)a0 appleStatus:(unsigned short)a1 portStatus:(unsigned char)a2;
- (void)sendStopPortMonitoringResponseForRequest:(id)a0 appleStatus:(unsigned short)a1;
