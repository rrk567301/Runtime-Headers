...
+ (void)readAttributeTagListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeTagListWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeTagListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
