...
+ (void)readAttributeChannelListWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeChannelListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeCurrentChannelWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeCurrentChannelWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeLineupWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeLineupWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void).cxx_destruct;
- (void)changeChannelByNumberWithParams:(id)a0 completion:(id /* block */)a1;
- (void)changeChannelByNumberWithParams:(id)a0 completionHandler:(id /* block */)a1;
- (void)changeChannelWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeChannelListWithCompletion:(id /* block */)a0;
- (void)readAttributeChannelListWithCompletionHandler:(id /* block */)a0;
- (void)readAttributeClusterRevisionWithCompletion:(id /* block */)a0;
- (void)readAttributeClusterRevisionWithCompletionHandler:(id /* block */)a0;
- (void)readAttributeCurrentChannelWithCompletion:(id /* block */)a0;
- (void)readAttributeCurrentChannelWithCompletionHandler:(id /* block */)a0;
...
- (void)readAttributeLineupWithCompletion:(id /* block */)a0;
- (void)readAttributeLineupWithCompletionHandler:(id /* block */)a0;
- (void)skipChannelWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeChannelListWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeChannelListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeCurrentChannelWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeCurrentChannelWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeLineupWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeLineupWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
