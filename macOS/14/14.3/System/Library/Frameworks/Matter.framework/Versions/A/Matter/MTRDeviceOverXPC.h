...
- (void).cxx_destruct;
- (void)_invokeCommandWithEndpointID:(id)a0 clusterID:(id)a1 commandID:(id)a2 commandFields:(id)a3 timedInvokeTimeout:(id)a4 serverSideProcessingTimeout:(id)a5 queue:(id)a6 completion:(id /* block */)a7;
