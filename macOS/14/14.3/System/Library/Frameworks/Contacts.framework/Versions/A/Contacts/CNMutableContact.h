@class CNWallpaperMetadata, NSString, NSArray, NSData, NSDate, CNWallpaper, NSDictionary, CNContact, CNActivityAlert, CNContactKeyVector, CNSensitiveContentConfiguration, NSDateComponents;
