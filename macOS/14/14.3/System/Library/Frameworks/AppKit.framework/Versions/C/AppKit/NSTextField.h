...
@property id<NSTextSuggestionsDelegate> suggestionsDelegate;
...
- (id)_getSuggestionsDelegateBridgingToObjectiveC;
...
- (void)_setSuggestionsDelegateBridgingFromObjectiveC:(id)a0;
...
- (BOOL)_suggestions_textView:(id)a0 doCommandBySelector:(SEL)a1;
