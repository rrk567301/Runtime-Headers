...
@interface NSTextCheckingController : NSObject {
    ...
    struct __tccClientFlags2 { unsigned char respondsToInlinePredictionType : 1; unsigned char respondsToBeginShowingCorrectionIndicatorUnderlines : 1; unsigned char respondsToEndShowingCorrectionIndicatorUnderlines : 1; unsigned char respondsToFinalSentenceRange : 1; unsigned char respondsToSetSoftSpaceRange : 1; unsigned int reserved : 27; } _tccClientFlags2;
}
