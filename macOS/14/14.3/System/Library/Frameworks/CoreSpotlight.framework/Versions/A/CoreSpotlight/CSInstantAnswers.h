...
+ (id)instantAnswersFallbackQueries:(id)a0 queryComponents:(id)a1 searchString:(id)a2 isShortQuery:(BOOL)a3;
+ (id)instantAnswersMailboxes:(id)a0;
+ (BOOL)isInstantAnswersTriggeringQuery:(id)a0 isCJK:(BOOL)a1 instantAnswerQueryMinLengthNonCJK:(long long)a2 instantAnswerQueryMinLengthCJK:(long long)a3;
