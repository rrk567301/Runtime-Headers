@class NIDevicePresenceNotifier, NIConfiguration, NSDictionary, NSObject, NIExportedObjectForwarder, NIFindingNotifier, NSDate, NICarKeyEventNotifier, NIServerConnection, NSString, NIDiscoveryToken, NSArray, NSError, NSUUID;
