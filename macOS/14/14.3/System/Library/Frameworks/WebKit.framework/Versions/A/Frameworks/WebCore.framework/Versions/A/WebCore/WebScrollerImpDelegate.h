...
@interface WebScrollerImpDelegate : NSObject <NSAnimationDelegate, NSScrollerImpDelegate> {
    struct WeakPtr<WebCore::Scrollbar, WTF::DefaultWeakPtrImpl> { struct RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> { struct DefaultWeakPtrImpl *m_ptr; } m_impl; } _scrollbar;
