@class MTLArchitecture, NSString, NSArray, NSMutableDictionary, NSDictionary, NSObject, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSPointerArray, AGXG15XFamilyPerformanceStateAssertion;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface AGXG15XFamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    void *_impl;
    ...
    struct { AGXG15XFamilyPerformanceStateAssertion *existingAssertion; struct AGXA_UnfairLock { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } lock; } performance_state_assertion;
}
