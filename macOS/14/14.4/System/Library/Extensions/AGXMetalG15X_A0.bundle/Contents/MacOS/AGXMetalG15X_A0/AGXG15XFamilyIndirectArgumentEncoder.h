@class NSString, AGXG15XFamilyDevice, AGXG15XFamilyBuffer;
@protocol MTLDevice;

@interface AGXG15XFamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG15XFamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG15XFamilyBuffer *current_argument_buffer; } _impl;
}
