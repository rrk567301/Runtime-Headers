...
@interface AGXG15GFamilyDeadlineProfile : NSObject <MTLDeadlineProfile> {
    ...
    unsigned long long _executionSize;
    unsigned long long _globalTraceObjectID;
    unsigned int _deadlineProfileID;
}
