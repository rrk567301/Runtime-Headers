...
- (BOOL)handleSpecialCaseCharacteristicWithOperation:(id)a0 clientQueue:(id)a1 operationResponseHandler:(id /* block */)a2 updatedAttributesHandler:(id /* block */)a3;
- (void)registerOperation:(id)a0 clientQueue:(id)a1 reportDistributor:(id)a2 operationResponseHandler:(id /* block */)a3 updatedAttributesHandler:(id /* block */)a4;
