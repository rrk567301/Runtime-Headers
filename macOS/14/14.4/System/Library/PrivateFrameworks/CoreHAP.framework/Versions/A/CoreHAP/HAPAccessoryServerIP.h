@class NSDictionary, HAPAccessoryProtocolInfo, HMFTimer, HAPAuthSession, HMFBlockOperation, NSMutableArray, NSString, HAPNameResolver, NSArray, HAPWACAccessory, HMFNetMonitor, HAPSocketInfo, HAPAccessoryServerIPConnectionStatistics, NSData, NSOperationQueue, HMFNetAddress, HAPHTTPClient, NSDate, HAPAccessoryServerBookkeeping, HAPAccessory, HAPAccessoryServerBrowserIP;
...
@property (retain, nonatomic) NSMutableArray *nameResolutionCompletionBlocks;
...
- (void)_doResolveWithCompletion:(id /* block */)a0;
