...
@interface libfssync.FPCK : NSObject <FSCheckerDelegate> {
    ...
    void /* unknown type, empty encoding */ packageDetection;
    ...
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorDomain;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeNilError;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithDiffWithContentDiffFS;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithDiffWithoutContentDiffFS;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithDiffWithContentDiffFP;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithDiffWithoutContentDiffFP;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithoutDiff;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodeFileLockErrorWithoutReconciliationEntry;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodePOSIXEACCESUnknown;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodePOSIXEACCESHasReadPermission;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodePOSIXEACCESMissingReadPermission;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodePOSIXENOTSUPUnknown;
    void /* unknown type, empty encoding */ FPCKPendingSetInternalErrorCodePOSIXENOTSUPAFSCCompressedFile;
}

@property (nonatomic) void /* unknown type, empty encoding */ numberOfFilesChecked;
@property (nonatomic) void /* unknown type, empty encoding */ numberOfBrokenFilesInFSCheck;
...
- (id)init;
- (void).cxx_destruct;
- (BOOL)checker:(id)a0 handleItem:(int)a1 itemStatus:(const struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; struct fpfs_fileattrs *x10; struct stat *x11; unsigned int x12; } *)a2 under:(id)a3 brokenInvariants:(unsigned long long)a4;
...
- (id)initWithDatabasesBackupsPaths:(id)a0 volumeRole:(unsigned int)a1 providerDomainID:(id)a2 domainUserInfo:(id)a3 reason:(unsigned long long)a4 usingFPFS:(BOOL)a5 iCDPackageDetection:(BOOL)a6 useShouldPause:(BOOL)a7 shouldPause:(id /* block */)a8;
- (BOOL)launchWithTelemetryFromURLs:(id)a0 options:(unsigned long long)a1 error:(id *)a2 resultHandler:(id /* block */)a3;
