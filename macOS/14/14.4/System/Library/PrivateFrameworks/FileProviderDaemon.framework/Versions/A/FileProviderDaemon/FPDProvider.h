...
- (void)addDomain:(id)a0 byImportingDirectoryAtURL:(id)a1 knownFolders:(id)a2 userAllowedDBDrop:(BOOL)a3 unableToStartup:(BOOL)a4 needsReimport:(BOOL)a5 startupError:(id)a6 reloadDomain:(BOOL)a7 request:(id)a8 completionHandler:(id /* block */)a9;
