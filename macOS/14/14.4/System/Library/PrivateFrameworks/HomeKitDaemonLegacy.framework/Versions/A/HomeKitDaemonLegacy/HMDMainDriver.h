@class HMDCloudManager, HMDSymptomManager, HMDCoreData, NSObject, HMDUpdater, HMDHomeManager, HMDAccessoryBrowser, NSString, HMDCurrentAccessorySetupMetricDispatcher, HMDMetricsManager, HMDAppleMediaAccessoryDiagnosticInfoController, HMDRetailDemoModeRequestHandler, HMDDeviceSetupConfiguringController;
