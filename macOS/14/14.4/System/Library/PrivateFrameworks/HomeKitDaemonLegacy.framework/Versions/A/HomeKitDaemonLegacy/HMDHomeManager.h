...
@protocol HMDarwinNotificationProvider, HMDDatabase, HAPKeyStore, OS_os_log, HMDAccessoryBrowserProtocol, OS_dispatch_queue, HMDCompositeSettingsSiriEndpointProfileBridge, OS_dispatch_source, HMMLogEventSubmitting;
...
- (id)setupSessionIdentifierForAccessoryUUIDs:(id)a0 outStartTime:(double *)a1;
