@class NSObject, HMFMessageDispatcher, HMDCameraStreamManagerSession, HMDService, HMDDynamicActivityAttributionPublisher, NSString, HMDCameraSupportedConfigurationCache, HMDHAPAccessory, HMDCameraStreamSnapshotHandler, HMDCameraMetricsMilestone, HMFNetMonitor, HMDCameraResidentMessageHandler, NSUUID;
