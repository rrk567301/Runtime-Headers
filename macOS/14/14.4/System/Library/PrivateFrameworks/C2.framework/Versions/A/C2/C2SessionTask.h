...
- (void)handleCallbackForTask_Backup:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_CloudDocs:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_CloudPhotos:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_GenericApple:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_Health:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_HomeKit:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_KeyValueService:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_KeychainSync:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_MailDrop:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_Messages:(id)a0 callback:(id /* block */)a1;
- (void)handleCallbackForTask_ThirdParty:(id)a0 callback:(id /* block */)a1;
