@class ODDSiriSchemaODDVoiceProperties, ODDSiriSchemaODDOptInProperties, NSData, SISchemaISOLocale, ODDSiriSchemaODDHomeKitProperties;

@interface ODDSiriSchemaODDAssistantProperties : SISchemaInstrumentationMessage {
    struct { unsigned char isAssistantEnabled : 1; unsigned char listenFor : 1; unsigned char numSiriShortcutsEnabled : 1; unsigned char isPreciseLocationEnabled : 1; } _has;
}
