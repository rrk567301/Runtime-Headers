...
@interface DIMSchemaDIMDeviceFixedContext : SISchemaInstrumentationMessage {
    struct { unsigned char systemLocale : 1; unsigned char siriInputLocale : 1; unsigned char dataSharingOptInState : 1; unsigned char countryCode : 1; unsigned char isStoreDemoMode : 1; unsigned char timeIntervalSince1970 : 1; unsigned char isLowPowerModeEnabled : 1; unsigned char programCode : 1; unsigned char homeKitConfiguration : 1; unsigned char availableDictationKeyboards : 1; } _has;
}
