...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_transparencyInsetsForUInt8AlphaContext:(struct CGContext { } *)a0 requiringFullOpacity:(BOOL)a1;
...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })transparencyInsetsForImage:(struct CGImage { } *)a0 imageRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 requiringFullOpacity:(BOOL)a2;
