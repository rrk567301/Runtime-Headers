@class DNDSModeAssertionInvalidationDetailsRecord, NSString, DNDSModeAssertionRecord, NSNumber, DNDSModeAssertionSourceRecord;
...
+ (id)recordForInvalidation:(id)a0;
