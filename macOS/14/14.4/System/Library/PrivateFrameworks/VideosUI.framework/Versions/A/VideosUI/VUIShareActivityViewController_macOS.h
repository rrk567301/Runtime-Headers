...
- (void)shareMediaItem:(id)a0 title:(id)a1 subtitle:(id)a2 imageURLStr:(id)a3 groupActivityMetadata:(id)a4 sharedWatchId:(id)a5 sharedWatchUrl:(id)a6 sourceView:(id)a7 relativePosition:(struct CGPoint { double x0; double x1; })a8;
