...
@interface CSSpeechManager : NSObject <CSAudioServerCrashMonitorDelegate, CSVoiceTriggerAssetHandlerDelegate, CSActivationEventNotificationHandlerDelegate, CSAudioRecorderDelegate, CSAudioProviderDelegate, CSLanguageCodeUpdateMonitorDelegate, CSOpportuneSpeakEventMonitorDelegate>
...
- (void)_notifyLanguageCodeChangeToExclaveKit;
