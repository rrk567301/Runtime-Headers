@class CSSiriClientBehaviorMonitor, CSVoiceTriggerHearstEnabledPolicy, NSArray, CSVoiceTriggerUserSelectedPhrase, NSString, NSMutableDictionary, CSAudioStreamHolding, CSVoiceTriggerAirPodWearerDetectionConfig, CSAsset, NSObject, CSAudioProvider, CSSpeechManager;
...
@property (retain, nonatomic) CSVoiceTriggerHearstEnabledPolicy *voicetriggerHearstEnabledPolicy;
...
- (id)initWithSpeechManager:(id)a0 voiceTriggerEnabledPolicyHearst:(id)a1;
