...
@protocol CKDXPCConnectionDelegate;

@interface CKDXPCConnection : NSObject <CKDSystemAvailabilityWatcher, CKPropertiesDescription, NSDiscardableContent, CKDXPCConnectionMuxer>
...
@property (nonatomic) BOOL hasValidXPCConnection;
@property (weak) id<CKDXPCConnectionDelegate> delegate;
