@class CCDifferentialUpdaterFactory, CCDonateRequest, NSObject, CCDonateRequestQueueNode;
...
- (id)initWithDataSiteManager:(id)a0 changeNotifier:(id)a1 donationTimeout:(double)a2;
