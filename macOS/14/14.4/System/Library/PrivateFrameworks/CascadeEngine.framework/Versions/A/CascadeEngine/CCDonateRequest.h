...
- (id)initWithConnection:(id)a0 manager:(id)a1 itemType:(unsigned short)a2 encodedDescriptors:(id)a3 version:(unsigned long long)a4 validity:(id)a5 device:(id)a6 accessAssertion:(id)a7;
