@class CKContainerSetupInfo, CKShare, SFCollaborationMetadata, NSItemProvider, SFCollaborationShareOptions, NSString, SFCollaborationCloudSharingResult, CKAllowedSharingOptions, NSArray, LPLinkMetadata, NSNumber, NSError, NSUUID;
