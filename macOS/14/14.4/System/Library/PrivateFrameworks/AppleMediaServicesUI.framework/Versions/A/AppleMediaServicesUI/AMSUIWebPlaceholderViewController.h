@class NSView, NSString, AMSUIWebAppearance, AMSUILoadingView, AMSUIWebSnapshotView, AMSBinaryPromise, AMSUIWebClientContext, AMSUIWebLoadingPageModel, NSViewController;
