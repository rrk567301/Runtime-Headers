@class NSDate, NSString, HKWorkoutType, HKCategoryType, NSSet, _HKDelayedOperation, NSDateInterval, HDActivityCacheStatisticsBuilder, NSMutableArray, HDActivityCacheHeartRateStatisticsBuilder, NSObject, HDProfile;
