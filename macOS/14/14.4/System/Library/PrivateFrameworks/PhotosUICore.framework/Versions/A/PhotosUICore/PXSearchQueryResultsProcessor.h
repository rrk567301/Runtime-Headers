@class PXSearchQueryResult, NSString, NSDictionary, NSArray, PHPhotoLibrary, NSObject;
...
- (id)initWithPhotoLibrary:(id)a0 dispatchQueue:(id)a1 resultsProcessingHandler:(id /* block */)a2;
- (void)processCollectionSearchResults:(id)a0 assetSearchResults:(id)a1 personSearchResults:(id)a2 searchSuggestions:(id)a3 searchQueryMatchInfo:(id)a4 forSearchQuery:(id)a5;
