@class NSString, BRMangledID, NSArray, NSMutableDictionary, BRCSyncContext, BRCAccountSession, BRCServerChangeState, CKRecordZoneID, BRCZoneRowID, BRCClientZone, BRCPQLConnection;
...
@property (readonly, nonatomic) BOOL advancedDataProtectionEnabled;
...
- (void)_fixupAdvancedDataProtectionState;
