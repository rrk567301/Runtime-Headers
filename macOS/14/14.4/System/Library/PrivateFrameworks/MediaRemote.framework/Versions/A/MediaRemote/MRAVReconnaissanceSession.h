@class NSString, NSArray, MRAVEndpoint, NSSet, NSMutableDictionary, MRRequestDetails, MRAVRoutingDiscoverySession, NSObject, NSMutableSet, NSMutableArray;
...
- (id)initWithDetails:(id)a0 outputDeviceUIDs:(id)a1 outputDeviceGroupID:(id)a2 features:(unsigned int)a3;
