@class NSString;
@protocol BCSQueryOperationFactoryProtocol, BCSCloudKitQueryProviding, BCSCoalesceHelperProtocol, BCSICloudServerEnvironmentProtocol, BCSCloudKitDatabaseProtocol, BCSPIRServerEnvironmentProtocol, BCSQueryOperationProtocol, BCSMetricFactoryProtocol, BCSBloomFilterExtractorProtocol, BCSCloudKitContainerProtocol, BCSOperationGroupFactoryProtocol;
...
@property (readonly, retain, nonatomic) id<BCSICloudServerEnvironmentProtocol, BCSPIRServerEnvironmentProtocol> environment;
