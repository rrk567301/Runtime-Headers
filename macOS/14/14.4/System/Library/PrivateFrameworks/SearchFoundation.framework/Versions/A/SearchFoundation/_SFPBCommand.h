@class _SFPBShowPurchaseRequestSheetCommand, _SFPBRequestProductPageCommand, _SFPBShowAppStoreSheetCommand, _SFPBPlayMediaCommand, _SFPBManageReservationCommand, _SFPBShowWrapperResponseViewCommand, _SFPBAddToPhotosLibraryCommand, _SFPBViewEmailCommand, _SFPBShowPhotosOneUpViewCommand, _SFPBCreateReminderCommand, _SFPBShowScreenTimeRequestSheetCommand, _SFPBOpenFileProviderItemCommand, _SFPBCreateContactCommand, _SFPBOpenCoreSpotlightItemCommand, _SFPBSearchInAppCommand, _SFPBUpdateSearchQueryCommand, _SFPBToggleAudioCommand, _SFPBToggleWatchListStatusCommand, _SFPBLaunchAppCommand, _SFPBPerformPersonEntityQueryCommand, _SFPBShareCommand, _SFPBOpenCalculationCommand, _SFPBExpandInlineCommand, _SFPBRejectPeopleInPhotoCommand, NSData, _SFPBInvokeSiriCommand, _SFPBOpenWebClipCommand, _SFPBOpenAppClipCommand, _SFPBUpdateSportsFollowingStatusCommand, _SFPBCommandReference, _SFPBEmailCommand, _SFPBPerformContactActionCommand, _SFPBShowSFCardCommand, _SFPBPlayVideoCommand, _SFPBClearProactiveCategoryCommand, _SFPBTopic, _SFPBPerformIntentCommand, _SFPBPerformEntityQueryCommand, NSString, _SFPBSubscribeForUpdatesCommand, _SFPBRequestUserReportCommand, _SFPBIndexedUserActivityCommand, _SFPBPerformContactQueryCommand, _SFPBCallCommand, _SFPBRunVoiceShortcutCommand, _SFPBSearchWebCommand, _SFPBCreateCalendarEventCommand, _SFPBRequestAppClipInstallCommand, _SFPBShowContactCardCommand, _SFPBCopyCommand, _SFPBOpenPunchoutCommand, _SFPBBeginMapsRoutingCommand, _SFPBOpenMediaCommand;
