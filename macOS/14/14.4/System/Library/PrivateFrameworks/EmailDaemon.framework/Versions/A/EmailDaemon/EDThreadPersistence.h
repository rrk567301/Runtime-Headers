@class EDThreadScopeManager, EMBlockedSenderManager, EDMessagePersistence, NSString, NSMutableSet, NSMutableArray, NSMutableDictionary, EDPersistenceHookRegistry, EFSQLTableSchema, NSObject, EDPersistenceDatabase, EFDebouncer;
