@class NSUUID, HMFMessageDestination, HMFTimer, HMDRemoteMessage, HMDModernTransportMessageContextOptions, NSSet, NSString, NSMutableSet, HMDNetworkActivityWrapper, NSMapTable;
@protocol HMDNetworkActivityWrapperFactory, HMDDateProvider, HMMLogEventSubmitting, HMDTimerProvider;
