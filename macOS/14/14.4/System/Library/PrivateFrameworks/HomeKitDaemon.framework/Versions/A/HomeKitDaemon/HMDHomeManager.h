...
@protocol HAPKeyStore, HMDDatabase, HMMLogEventSubmitting, OS_os_log, HMDAccessoryBrowserProtocol, HMFAsyncContext, OS_dispatch_queue, HMDCompositeSettingsSiriEndpointProfileBridge, OS_dispatch_source, HMDarwinNotificationProvider;
