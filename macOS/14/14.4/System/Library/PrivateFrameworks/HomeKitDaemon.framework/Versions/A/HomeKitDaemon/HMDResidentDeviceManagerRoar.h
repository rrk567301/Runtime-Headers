@class HMDAppleAccountManager, NSUUID, HMDRemoteDeviceMonitor, HMDFeaturesDataSource, NSObject, HMDMessageDispatcher, NSSet, HMFFuture, NSMutableSet, NSString, HMDPrimaryElectionCoordinationAddOn, NSHashTable, HMDModernTransportDeviceReachabilityObserver, HMDResidentStatusChannel, HMDResidentDevice, HMDHome, NSArray, HMFPromise, NSNotificationCenter, HMDDevice;
...
@interface HMDResidentDeviceManagerRoar : HMFObject <HMDResidentDeviceManagerContext, HMDPrimaryResidentDiscoveryManagerDelegate, HMDRemoteDeviceMonitorDeviceRegistrationClient, HMDResidentStatusChannelObserver, HMDPrimaryResidentElectionAddOnDelegate, HMDModernTransportDeviceReachabilityObserverListener, NSSecureCoding, HMDResidentDeviceManager> {
...
- (void)_publishCurrentResidentStatusWithReason:(long long)a0;
