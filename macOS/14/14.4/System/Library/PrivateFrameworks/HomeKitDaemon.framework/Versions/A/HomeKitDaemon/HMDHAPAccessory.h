...
- (BOOL)_hasActiveSessionRestoreClientWithName:(id)a0;
...
- (id)_notificationsByClientIDForCharacteristics:(id)a0;
...
- (void)handleAttributeReport:(id)a0 dictionary:(id)a1;
...
- (void)handleEventReport:(id)a0 dictionary:(id)a1 flow:(id)a2;
...
- (id)saveSupportsMatterAccessCode:(id)a0;
- (id)saveSupportsMatterWalletKey:(id)a0;
...
- (void)setNotificationsEnabled:(BOOL)a0 forCharacteristics:(id)a1 clientIdentifier:(id)a2 matchingHAPAccessory:(id)a3;
...
- (void)updateSupportsMatterAccessCodeForAttributeReport:(id)a0;
- (void)updateSupportsMatterWallet:(id)a0;
