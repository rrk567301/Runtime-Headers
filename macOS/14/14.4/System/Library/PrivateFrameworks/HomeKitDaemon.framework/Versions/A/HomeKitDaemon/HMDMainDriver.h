@class HMDCloudManager, HMDSymptomManager, NSObject, HMDUpdater, HMDCoreData, HMDHomeManager, HMDAccessoryBrowser, HMDCurrentAccessorySetupMetricDispatcher, NSString, HMDMetricsManager, HMDAppleMediaAccessoryDiagnosticInfoController, HMDRetailDemoModeRequestHandler, HMDDeviceSetupConfiguringController;
...
- (void)localeChanged;
- (void)markOrSaveFirstCoreDataContainerSetupDuration:(double)a0 error:(id)a1;
- (void)relaunch;
