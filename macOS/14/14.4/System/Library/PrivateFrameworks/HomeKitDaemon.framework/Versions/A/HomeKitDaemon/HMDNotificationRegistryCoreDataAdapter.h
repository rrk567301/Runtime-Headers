...
- (id)_fetchMKFRegistrationsWithUserUUID:(id)a0 actionSetUUID:(id)a1 deviceIdsDestination:(id)a2 prefetchPaths:(id)a3 context:(id)a4;
...
- (id)_fetchMKFUserAndRegistrationsWithUserUUID:(id)a0 actionSetUUID:(id)a1 deviceIdsDestination:(id)a2 prefetchPaths:(id)a3 outHomeMember:(id *)a4 context:(id)a5;
- (id)_fetchMKFUserAndRegistrationsWithUserUUID:(id)a0 withCharacteristicIIDs:(id)a1 withAccessoryUUID:(id)a2 withDeviceIdsDestination:(id)a3 withPrefetchPaths:(id)a4 outHomeMember:(id *)a5 context:(id)a6;
- (id)_fetchMKFUserAndRegistrationsWithUserUUID:(id)a0 withCharacteristicIIDs:(id)a1 withAccessoryUUIDs:(id)a2 withDeviceIdsDestination:(id)a3 withPrefetchPaths:(id)a4 outHomeMember:(id *)a5 context:(id)a6;
- (id)_fetchMKFUserAndRegistrationsWithUserUUID:(id)a0 withMediaProfileUUID:(id)a1 withMediaPropertyIn:(id)a2 withDeviceIdsDestination:(id)a3 withAccessoryUUID:(id)a4 withPrefetchPaths:(id)a5 outHomeMember:(id *)a6 context:(id)a7;
...
- (BOOL)_insertNotificationRegistrationForCharacteristic:(id)a0 deviceIdsDestination:(id)a1 homeMember:(id)a2 mkfCharacteristic:(id)a3 context:(id)a4;
...
- (id)homeMemberForRegistrations:(id)a0 userUUID:(id)a1 context:(id)a2;
