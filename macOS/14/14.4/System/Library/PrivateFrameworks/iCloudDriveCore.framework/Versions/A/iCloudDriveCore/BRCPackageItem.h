...
+ (id)newItemForSignatureCalculationWithURL:(id)a0 inPackage:(id)a1 error:(id *)a2;
...
- (void)_setXattrs:(id)a0 stageRegistry:(id)a1;
...
- (BOOL)updateContentSignature:(id)a0 error:(id *)a1;
