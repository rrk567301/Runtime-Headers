...
+ (void)_logDailyStatusEventForAssetSetArrived:(id)a0 entries:(id)a1;
...
+ (void)invalidatePromotedInstances:(id)a0 autoAssetSet:(id)a1 group:(id)a2 noAllowed:(BOOL)a3;
...
+ (void)manageAssetSet:(id)a0 specifiers:(id)a1 lockIfUnchanged:(BOOL)a2;
