@class ACAccountType, AKAccountStore, NSMutableDictionary, AIDAServiceOwnersManager, NSObject;
...
@interface AKAccountManager : NSObject {
    ...
    AIDAServiceOwnersManager *_aidaServiceOwnermanager;
}
...
- (id)altDSISDsForActiveMediaType:(unsigned long long)a0;
