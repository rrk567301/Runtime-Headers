@class GEOPBTransitArtwork, NSArray, GEOComposedString, GEOFormattedString, GEOStyleAttributes;
...
- (id)initWithTitle:(id)a0 routeCoordinateRange:(struct GEOPolylineCoordinateRange { struct { unsigned int x0; float x1; } x0; struct { unsigned int x0; float x1; } x1; })a1;
