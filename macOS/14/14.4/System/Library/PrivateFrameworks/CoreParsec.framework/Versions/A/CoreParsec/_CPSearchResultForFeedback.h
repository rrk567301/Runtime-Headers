@class NSData, NSString, _CPCoreSpotlightRankingSignalsForFeedback, _CPPunchoutForFeedback, _CPStruct, _CPMailRankingSignalsForFeedback, _CPMailResultDetailsForFeedback, _CPCardForFeedback, _CPActionItemForFeedback;
@protocol NSCopying;
