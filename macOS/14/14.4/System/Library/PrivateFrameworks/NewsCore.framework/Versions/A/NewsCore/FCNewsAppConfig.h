@class NSDictionary, FCArticleModalBrandBarConfig, FCSmarterMessagingConfig, FCPaidBundleConfiguration, FCSportsFavoritesSyncModalConfig, FCTimesOfDayConfiguration, FCSportsUpsellConfig, FCLaunchPresentationConfig, NSString, FCPersonalizationPublisherDampeningConfig, FCLocationSharingUpsellConfig, FCForYouGroupsConfiguration, FCTopStoriesConfiguration, FCNewsPlusLabelConfigGroup, FCStatelessPersonalizationPublisherFavorability, NSArray, FCWidgetConfig, FCIAdConfiguration, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, FCPuzzlesConfiguration, FCNewsTabiConfiguration, FCEmbedProxyConfiguration, FCAppReviewRequestConfig, FCArticleLinkBehaviorConfig, FCVideoGroupsConfig, FCPrefetchConfiguration, NTPBDiscoverMoreVideosInfo, FCPersonalizationTreatment, FCSportsPrivacyConfiguration, FCPaidBundleViaOfferConfig, NSNumber;
