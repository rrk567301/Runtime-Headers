...
@property (retain, nonatomic) id<MTLBuffer> inputLHSBuffer;
@property (retain, nonatomic) id<MTLBuffer> inputRHSBuffer;
@property (retain, nonatomic) id<MTLBuffer> inputStatusBuffer;
