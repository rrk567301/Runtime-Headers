@class NSString, LNActionDeprecationMetadata, NSArray, LNStaticDeferredLocalizedString, NSOrderedSet, LNValueType, NSDictionary, LNActionConfiguration, LNActionDescriptionMetadata;
