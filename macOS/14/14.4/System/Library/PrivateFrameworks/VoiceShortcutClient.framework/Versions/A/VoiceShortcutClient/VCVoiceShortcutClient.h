...
- (void)coherenceEnabledWithCompletion:(id /* block */)a0;
...
- (void)coherenceMigrationEnabledWithCompletion:(id /* block */)a0;
...
- (void)setCoherenceMigrationStatus:(BOOL)a0 completion:(id /* block */)a1;
...
- (void)toprakEngineEnabledWithCompletion:(id /* block */)a0;
