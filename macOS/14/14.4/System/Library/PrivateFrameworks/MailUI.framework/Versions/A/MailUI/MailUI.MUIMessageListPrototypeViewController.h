@interface MailUI.MUIMessageListPrototypeViewController : MUIPlatformViewController <MessageListDataSourceProvider, MessageListDataSourceDelegate, MessageListSectionDataSourceDelegate, MessageListRecentSectionDataSourceDelegate, MessageListSectionDataSourceSelectionModelProvider, NSTableViewDelegate> {
