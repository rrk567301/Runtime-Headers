@class NSString, PKProtobufNSDecimalNumber;

@interface PKProtobufPeerPaymentMessage : PBCodable <NSCopying> {
    struct { unsigned char amount : 1; unsigned char recurringPaymentStartDate : 1; unsigned char source : 1; unsigned char type : 1; } _has;
}
