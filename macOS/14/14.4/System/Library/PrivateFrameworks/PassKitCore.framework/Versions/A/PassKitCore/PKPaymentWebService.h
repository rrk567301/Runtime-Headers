...
- (unsigned long long)_passActionWithRemoteContentPassAction:(id)a0 serviceProviderData:(id)a1 forDeviceIdentifier:(id)a2 passTypeIdentifier:(id)a3 passSerialNumber:(id)a4 completion:(id /* block */)a5;
...
- (unsigned long long)passActionWithRemoteContentPassAction:(id)a0 serviceProviderData:(id)a1 forDeviceIdentifier:(id)a2 passTypeIdentifier:(id)a3 passSerialNumber:(id)a4 completion:(id /* block */)a5;
