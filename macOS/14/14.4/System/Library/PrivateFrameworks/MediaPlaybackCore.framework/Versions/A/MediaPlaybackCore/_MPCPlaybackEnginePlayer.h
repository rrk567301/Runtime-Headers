@class MPCItemBookmarker, NSDictionary, MPCAVItemTrace, MPCLeaseController, MPCPlaybackErrorController, MPAVItem, NSString, MRCriticalSectionToken, MPCExternalPlaybackController, MPCPlaybackEngine, NSNumber, MPCPlayerItemConfigurator, _MPCAudioSessionController, AVPlayerViewController, MPCMediaFoundationTranslator;
...
- (void)itemTransitionDidEndFrom:(id)a0 to:(id)a1 type:(long long)a2 duration:(double)a3 timeStamp:(id)a4;
- (void)itemTransitionWillBeginFrom:(id)a0 to:(id)a1 type:(long long)a2 duration:(double)a3 timeStamp:(id)a4;
