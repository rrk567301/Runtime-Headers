@class NSXPCListenerEndpoint, MPAVRoutingController, MPCPlaybackIntent, MPCQueueController, NSError, _MPCMediaRemotePublisher, _MPCSleepTimerController, NSString, _MPCReportingController, MPProtocolProxy, MPAVRoute, MPCAudioSpectrumAnalyzer, _MPCMusicPlayerControllerServer, _MPCLeaseManager, _MPCPlaybackEnginePlayer, _MPCPlaybackEngineSessionManager, MPCPlaybackEngineEventStream, MPCWhiskyController;
