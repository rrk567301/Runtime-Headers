...
- (id)initWithSize:(long long)a0 members:(id)a1;
- (id)initWithSize:(long long)a0 sizeFieldName:(id)a1 sizeCorrection:(int)a2 members:(id)a3;
- (id)initWithSizeFieldName:(id)a0 members:(id)a1;
- (id)initWithSizeFieldName:(id)a0 sizeCorrection:(int)a1 members:(id)a2;
