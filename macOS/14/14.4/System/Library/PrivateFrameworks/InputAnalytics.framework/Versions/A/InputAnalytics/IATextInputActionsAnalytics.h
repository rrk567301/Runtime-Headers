...
- (void)didCut:(id)a0;
- (void)_didDeleteBackwardText:(id)a0 withType:(long long)a1 shouldOverrideInputActionCountToZero:(BOOL)a2 withInputMode:(id)a3;
- (void)_didDeleteBackwardTextDetails:(id)a0 withType:(long long)a1 shouldOverrideInputActionCountToZero:(BOOL)a2 withInputMode:(id)a3;
...
- (void)didPaste:(id)a0;
- (void)didReplacementForText:(id)a0 withText:(id)a1 allowNilText:(BOOL)a2 allowEmptyText:(BOOL)a3 allowNilReplacement:(BOOL)a4 withSource:(long long)a5 withType:(long long)a6 withInputActionCount:(long long)a7;
