...
- (id)_iterateOverPeersWithBlock:(id /* block */)a0;
...
- (id)bestRecoveryKeyForStableInfo:(id)a0 vouchers:(id)a1;
- (id)bestWalrusAcrossTrustedPeers;
- (id)bestWalrusForStableInfo:(id)a0 walrusStableChanges:(id)a1;
- (id)bestWebAccessForStableInfo:(id)a0 webAccessStableChanges:(id)a1;
...
- (BOOL)hasPotentiallyTrustedPeer;
...
- (id)possibleSponsorsForCustodianRecoveryKey:(id)a0 block:(id /* block */)a1;
- (id)possibleSponsorsForRecoveryKey:(id)a0 block:(id /* block */)a1;
