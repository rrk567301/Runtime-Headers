...
+ (void)checkPurgeableSpaceCacheDelete:(unsigned long long)a0 fromBasePath:(id)a1 cacheDeleteUrgency:(int)a2 timeout:(int)a3 withCompletionQueue:(id)a4 completion:(id /* block */)a5;
