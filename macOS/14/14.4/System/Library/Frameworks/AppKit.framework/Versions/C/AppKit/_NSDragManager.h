...
- (id)_dragLocalSource;
- (void)_enumerateDraggingItemsForDrag:(void *)a0 pasteboard:(id)a1 class:(Class)a2 view:(id)a3 isSource:(BOOL)a4 usingBlock:(id /* block */)a5;
- (void)_enumerateDraggingItemsForDrag:(void *)a0 pasteboard:(id)a1 withOptions:(unsigned long long)a2 view:(id)a3 classes:(id)a4 searchOptions:(id)a5 isSource:(BOOL)a6 usingBlock:(id /* block */)a7;
