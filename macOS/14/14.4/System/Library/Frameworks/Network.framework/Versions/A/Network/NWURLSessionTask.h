@class NSURL, NSURLResponse, NSProgress, NSDate, NSObject, NWURLSessionTaskConfiguration, NSURLSessionTaskTransactionMetrics, NWURLError, NWURLSessionRequestBodyInfo, NWURLSessionMultipartParser, NWURLSessionTaskMetrics, NWURLSessionDelegateWrapper, NSString, NSURLRequest, NWURLSession, NSArray, NSData, NSURLSessionTask, NSURLSessionDataTask, NSURLSessionTaskMetrics;
@protocol NWURLSessionResponseConsumer, NSURLSessionTaskDelegate, NWURLLoader, OS_nw_context, OS_nw_activity, OS_nw_endpoint, OS_dispatch_queue, OS_nw_protocol_metadata, OS_nw_http_cookie_storage;
...
- (void)loaderDidReceiveServerTrustChallenge:(id)a0 shortCircuitCheck:(id /* block */)a1 completionHandler:(id /* block */)a2;
