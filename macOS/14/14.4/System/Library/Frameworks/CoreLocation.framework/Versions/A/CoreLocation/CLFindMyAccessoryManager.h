...
- (void)fetchPoshAccessoryCapabilities:(id)a0;
...
- (void)fetchPoshManufacturerName:(id)a0;
- (void)fetchPoshModelName:(id)a0;
- (void)fetchPoshProductName:(id)a0;
- (void)fetchPoshProtocolImplementation:(id)a0;
- (void)fetchPoshSerialNumber:(id)a0;
