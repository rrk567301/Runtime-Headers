@class MTRCommissionableBrowser, NSUUID, NSMutableDictionary, MTRDeviceControllerFactory, MTRDeviceControllerDataStore, NSNumber, NSObject;
...
@interface MTRDeviceController : NSObject {
    ...
    struct MTRDeviceControllerDelegateBridge { void /* function */ **x0; id x1; id x2; id x3; } *_deviceControllerDelegateBridge;
