...
+ (void)readAttributeNumberOfDailyTargetsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeNumberOfWeeklyTargetsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeNumberOfDailyTargetsWithCompletion:(id /* block */)a0;
- (void)readAttributeNumberOfWeeklyTargetsWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeNumberOfDailyTargetsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeNumberOfWeeklyTargetsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
