...
- (id)initWithComputeUnits:(unsigned long long)a0 layerName:(id)a1 layerError:(long long)a2 layerTypeName:(id)a3 supportedComputeUnits:(unsigned long long)a4 layerIndex:(long long)a5 supportMessages:(id)a6 computeTimeRatio:(double)a7;
