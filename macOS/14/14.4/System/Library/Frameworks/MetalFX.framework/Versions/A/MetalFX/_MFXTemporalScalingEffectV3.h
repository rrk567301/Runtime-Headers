...
@interface _MFXTemporalScalingEffectV3 : _MTLFXTemporalScaler <MTLFXTemporalScalerSPI> {
    ...
    struct BRNet_v3_Filter { int x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; int x8; int x9; int x10; int x11; int x12; unsigned short x13; unsigned short x14; BOOL x15; BOOL x16; BOOL x17; BOOL x18; int x19; id x20; id x21; id x22; id x23[2]; id x24[2]; unsigned char x25; id x26; id x27; id x28; id x29; id x30; id x31; id x32[2]; id x33[2]; id x34[2]; id x35; id x36; id x37[2]; id x38; id x39; id x40; id x41; id x42; id x43; id x44; id x45; id x46; id x47; id x48; id x49; id x50; id x51; id x52; id x53; id x54; id x55; id x56; id x57; id x58; id x59; } *_filter;
