...
@interface _PGDisplayNub : NSObject {
    ...
    struct { unsigned int x0; char x1[14]; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned int x7; unsigned int x8; float x9; float x10; struct AppleParavirtGPUDisplayColorPoint_t { float x0; float x1; } x11; struct AppleParavirtGPUDisplayColorPoint_t { float x0; float x1; } x12; struct AppleParavirtGPUDisplayColorPoint_t { float x0; float x1; } x13; struct AppleParavirtGPUDisplayColorPoint_t { float x0; float x1; } x14; struct { union { struct { unsigned short x0; unsigned short x1; } x0; _Atomic unsigned int x1; } x0; } x15; unsigned char x16; unsigned char x17; unsigned char x18[6]; unsigned long long x19; int x20; unsigned int x21[39]; _Atomic unsigned int x22; _Atomic unsigned int x23; unsigned int x24[62]; unsigned int x25; struct { unsigned short x0; struct { unsigned short x0; unsigned short x1; unsigned int x2; union { unsigned long long x0; struct { unsigned char x0 : 1; unsigned char x1 : 1; } x1; } x3; } x1[128]; } x26; struct APVColorMatrixState { float x0[2][3][4]; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; } x27; unsigned int x28[227]; struct { union { struct { unsigned short x0; unsigned short x1; } x0; _Atomic unsigned int x1; } x0; } x29; BOOL x30; unsigned int x31[62]; unsigned long long x32; unsigned long long x33; unsigned long long x34; unsigned int x35; unsigned int x36; BOOL x37; unsigned short x38; unsigned short x39; unsigned short x40; unsigned short x41; unsigned int x42; unsigned long long x43[10]; unsigned long long x44; unsigned long long x45; unsigned int x46; unsigned int x47; unsigned long long x48; unsigned int x49; unsigned int x50; BOOL x51; BOOL x52; unsigned long long x53; BOOL x54; unsigned int x55; unsigned int x56; } *_sharedState;
