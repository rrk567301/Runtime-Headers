@class NSHashTable, PAVideoConversionServiceClient, PLPhotoLibraryBundle, PLPhotoKitVariationCache, PAImageConversionServiceClient, PLLazyObject, NSString, NSError, PHPhotoLibraryObserverRegistrar, PLPhotoAnalysisServiceClient, PLFileSystemVolume, NSMutableDictionary, PLPhotoLibrary, PHChangeHandlingDebugger, PFStateCaptureHandler, CPLStatus, NSObject, PHPhotoLibraryAppPrivateData, PHPerformChangesRequest, PLAssetsdClient, PHFetchOptions, PLCacheMetricsCollectorClient, NSURL, NSProgress, PHPersistentChangeToken, NSManagedObjectID;
@protocol OS_dispatch_queue;

@interface PHPhotoLibrary : NSObject <PHBatchFetchingArrayDataSource, CPLStatusDelegate, PFStateCaptureProvider, PHPerformChangesRequest> {
