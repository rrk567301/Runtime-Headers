@class NSString, NSError, CNContactProviderSession;

@interface Contacts.CNContactProviderHost : NSObject {
...
- (void)synchronizeUsing:(CNContactProviderSession *)a0 bundleIdentifier:(NSString *)a1 completionHandler:(void (^)(NSError *))a2;
