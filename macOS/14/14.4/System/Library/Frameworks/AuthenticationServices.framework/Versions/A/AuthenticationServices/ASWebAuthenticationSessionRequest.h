@class NSUUID, NSData, NSURL, ASWebAuthenticationSessionController, NSSet, NSString, NSDictionary, ASWebAuthenticationSessionCallback;
...
- (id)initWithUUID:(id)a0 URL:(id)a1 callback:(id)a2 shouldUseEphemeralSession:(BOOL)a3 jitEnabled:(BOOL)a4 requestingAppSupportedSchemes:(id)a5 additionalHeaderFields:(id)a6;
