@class ASPublicKeyCredentialBase, NSString, NSData, ASAuthorizationPublicKeyCredentialLargeBlobRegistrationOutput;
...
- (id)_initWithBaseCredential:(id)a0 rawAttestationObject:(id)a1 largeBlob:(id)a2;
