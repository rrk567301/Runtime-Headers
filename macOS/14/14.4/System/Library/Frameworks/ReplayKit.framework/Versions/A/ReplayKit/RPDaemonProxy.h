...
- (oneway void)userDidStopStream:(id)a0;
...
- (oneway void)fetchShareableContentWithOption:(unsigned int)a0 windowID:(unsigned int)a1 currentProcess:(BOOL)a2 withCompletionHandler:(id /* block */)a3;
