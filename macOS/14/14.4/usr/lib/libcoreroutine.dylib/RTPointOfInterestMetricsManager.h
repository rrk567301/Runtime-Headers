@class RTScenarioTriggerManager, RTPlaceInferenceQueryStore, RTMapServiceManager, RTNavigationManager, RTDefaultsManager, NSMutableArray, RTTimerManager, RTBatteryManager, RTLearnedLocationStore, RTLocationManager, RTTimer, RTDistanceCalculator, RTVisitManager, RTPointOfInterestSampler;
