@class NSDate, NSObject, RTFixedSizeQueue, NSString, RTDefaultsManager, RTDistanceCalculator, RTLearnedLocationManager, SMSessionStore, RTLocationManager;
...
- (id)initWithDefaultsManager:(id)a0 learnedLocationManager:(id)a1 sessionStore:(id)a2 locationManager:(id)a3;
