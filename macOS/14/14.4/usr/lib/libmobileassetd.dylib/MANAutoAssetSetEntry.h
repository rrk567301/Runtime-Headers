...
- (id)initForAssetType:(id)a0 withAssetSpecifier:(id)a1 withAssetVersion:(id)a2 assetLockedInhibitsRemoval:(BOOL)a3;
- (id)initForAssetType:(id)a0 withAssetSpecifier:(id)a1 withAssetVersion:(id)a2 usingDecryptionKey:(id)a3 assetLockedInhibitsRemoval:(BOOL)a4;
