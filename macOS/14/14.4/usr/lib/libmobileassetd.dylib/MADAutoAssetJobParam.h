...
- (id)initWithAssetTargetOSVersion:(id)a0 withAssetTargetBuildVersion:(id)a1 withAssetTargetTrainName:(id)a2 withAssetTargetRestoreVersion:(id)a3 withControlInformation:(id)a4;
