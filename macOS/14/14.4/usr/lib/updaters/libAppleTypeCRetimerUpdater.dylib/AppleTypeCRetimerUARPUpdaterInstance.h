@class AppleTypeCRetimerIICDeviceHandle, NSString, AppleTypeCRetimerIICFifo, AppleTypeCRetimerDFU, NSObject, ACE;
...
- (void)appleTypeCRetimerIICFifoTransferError:(id)a0;
