@class NSString, AGXG15GFamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG15GFamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG15GFamilyBuffer *_buffer;
