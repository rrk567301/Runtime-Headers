@class NSString, AGXG15XFamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG15XFamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG15XFamilyBuffer *_buffer;
