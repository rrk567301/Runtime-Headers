...
@interface AGXG14XFamilyDynamicLibrary : _MTLDynamicLibrary <MTLDynamicLibrarySPI> {
    struct shared_ptr<AGX::G14X::DynamicLibrary> { struct DynamicLibrary *__ptr_; struct __shared_weak_count *__cntrl_; } _impl;
}
