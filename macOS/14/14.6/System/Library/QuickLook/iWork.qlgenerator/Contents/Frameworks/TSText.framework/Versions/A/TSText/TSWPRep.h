@class TSWPSelection, NSView, NSArray, TSDLayout, NSString, CAShapeLayer, CALayer, _TtC6TSText22TSWPSecondaryHighlight, NSMutableArray, TSWPStorage, TSUColor, TSWPSearchReference;
...
@property (nonatomic) BOOL platformViewOverRenderableNeedsUpdate;
@property (nonatomic) BOOL platformViewUpdateShouldBeDelayed;
...
- (BOOL)i_allowCaretForSelection:(id)a0;
...
- (void)p_invalidatePlatformViewOverChildRenderables;
