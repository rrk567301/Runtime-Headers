...
- (id)initWithID:(id)a0 titles:(id)a1 subtitles:(id)a2 flags:(long long)a3 ageRating:(id)a4 metrics:(id)a5 baseBuyParams:(id)a6 metricsBuyParams:(id)a7 additionalHeaders:(id)a8 preflightPackageURL:(id)a9 bundleID:(id)a10 itemName:(id)a11 vendorName:(id)a12 capabilities:(id)a13;
