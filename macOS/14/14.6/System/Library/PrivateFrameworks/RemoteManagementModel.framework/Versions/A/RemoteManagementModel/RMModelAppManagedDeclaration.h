@class RMModelAppManagedDeclaration_InstallBehavior, NSSet, NSString, NSNumber, RMModelAppManagedDeclaration_Attributes;
...
+ (id)assetTypes;
+ (id)buildWithIdentifier:(id)a0 appStoreID:(id)a1 bundleID:(id)a2 manifestURL:(id)a3 installBehavior:(id)a4 includeInBackup:(id)a5 attributes:(id)a6;
