...
@property (copy, nonatomic) NSString *payloadEnumFirst;
@property (copy, nonatomic) NSString *payloadEnumLast;
...
+ (id)assetTypes;
+ (id)buildWithIdentifier:(id)a0 booleanOr:(id)a1 booleanAnd:(id)a2 numberMin:(id)a3 numberMax:(id)a4 enumFirst:(id)a5 enumLast:(id)a6 firstString:(id)a7 arrayAppend:(id)a8 setUnion:(id)a9 setIntersection:(id)a10 dictionaryFirst:(id)a11 dictionaryCombine:(id)a12;
