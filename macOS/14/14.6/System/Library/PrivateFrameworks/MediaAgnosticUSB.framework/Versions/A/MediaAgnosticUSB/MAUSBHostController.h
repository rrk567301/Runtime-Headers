...
@interface MAUSBHostController : MAUSBObject <MAUSBHostDeviceManagerDelegate> {
    ...
    MAUSBHostControllerPort *_ports[15];
...
- (void)hostDeviceManager:(id)a0 portStatusChangedForRouteString:(id)a1 portStatus:(unsigned char)a2;
...
- (id)portForUSBDeviceAddress:(unsigned char)a0;
- (void)portStatusChangedForRouteStringInternal:(id)a0 portStatus:(unsigned char)a1;
