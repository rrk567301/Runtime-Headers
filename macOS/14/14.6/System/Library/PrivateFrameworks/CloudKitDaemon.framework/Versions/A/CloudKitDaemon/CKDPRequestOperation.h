...
@interface CKDPRequestOperation : PBCodable <NSCopying> {
    ...
    CKDPPrivateSearchDeleteRequest *_privateSearchDeleteRequest;
    CKDPPrivateSearchGetRequest *_privateSearchGetRequest;
    CKDPPrivateSearchSetRequest *_privateSearchSetRequest;
...
@property (readonly, nonatomic) BOOL hasPrivateSearchSetRequest;
@property (retain, nonatomic) CKDPPrivateSearchSetRequest *privateSearchSetRequest;
@property (readonly, nonatomic) BOOL hasPrivateSearchGetRequest;
@property (retain, nonatomic) CKDPPrivateSearchGetRequest *privateSearchGetRequest;
@property (readonly, nonatomic) BOOL hasPrivateSearchDeleteRequest;
@property (retain, nonatomic) CKDPPrivateSearchDeleteRequest *privateSearchDeleteRequest;
