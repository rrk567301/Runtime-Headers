@class NSXPCListener, NSObject, NSOperationQueue, NSMutableArray, NSCache;
@protocol OS_dispatch_source, OS_dispatch_queue;

@interface CKDXPCConnectionManager : NSObject <CKDXPCConnectionDelegate>

@property (retain, nonatomic) NSXPCListener *xpcListener;
@property (retain, nonatomic) NSMutableArray *clientConnections;
@property (retain, nonatomic) NSCache *clientConnectionCache;
...
- (void)connectionDidBeginAccess:(id)a0;
