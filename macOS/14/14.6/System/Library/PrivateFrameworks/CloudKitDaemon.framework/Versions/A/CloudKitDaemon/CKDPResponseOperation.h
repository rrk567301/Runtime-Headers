@class CKDPDeleteContainerResponse, CKDPPrivateSearchGetResponse, CKDPRecordDeleteResponse, CKDPUserRetrieveResponse, CKDPRecordRetrieveChangesResponse, CKDPWebAuthTokenRetrieveResponse, CKDPZoneDeleteResponse, CKDPShareAccessResponse, CKDPUpdateMissingAssetStatusResponse, CKDPZoneRetrieveChangesResponse, CKDPRecordSaveResponse, CKDPMergeableDeltaReplaceResponse, CKDPPrivateSearchSetResponse, CKDPRecordResolveTokenResponse, CKDPSubscriptionRetrieveResponse, CKDPArchiveRecordsResponse, CKDPSubscriptionDeleteResponse, CKDPUserPrivacySettingsUpdateResponse, CKDPUserPrivacySettingsBatchLookupResponse, CKDPUserPrivacySettingsRetrieveResponse, CKDPTokenRegistrationResponse, CKDPShareVettingInitiateResponse, CKDPRecordRetrieveResponse, CKDPUserAvailableQuotaResponse, CKDPShareDeclineResponse, CKDPNotificationMarkReadResponse, CKDPResponseOperationResult, CKDPShareAcceptResponse, CKDPAnonymousShareAddResponse, CKDPNotificationSyncResponse, CKDPUserPrivacySettingsResetResponse, CKDPOperation, CKDPFetchArchivedRecordsResponse, CKDPZoneSaveResponse, CKDPAnonymousShareRemoveResponse, CKDPPrivateSearchDeleteResponse, CKDPTokenUnregistrationResponse, CKDPSetBadgeCountResponse, CKDPCodeFunctionInvokeResponse, CKDPBundlesForContainerResponse, CKDPRecordMoveResponse, CKDPMergeableDeltaMetadataRetrieveResponse, CKDPZoneRetrieveResponse, CKDPMergeableDeltaSaveResponse, CKDPRecordRetrieveVersionsResponse, CKDPMarkAssetBrokenResponse, CKDPQueryRetrieveResponse, CKDPSubscriptionCreateResponse, CKDPUserQueryResponse, CKDPAssetUploadTokenRetrieveResponse, CKDPResponseOperationHeader, CKDPMergeableDeltaRetrieveResponse;
...
@interface CKDPResponseOperation : PBCodable <NSCopying> {
    ...
    CKDPPrivateSearchDeleteResponse *_privateSearchDeleteResponse;
    CKDPPrivateSearchGetResponse *_privateSearchGetResponse;
    CKDPPrivateSearchSetResponse *_privateSearchSetResponse;
...
@property (readonly, nonatomic) BOOL hasPrivateSearchSetResponse;
@property (retain, nonatomic) CKDPPrivateSearchSetResponse *privateSearchSetResponse;
@property (readonly, nonatomic) BOOL hasPrivateSearchGetResponse;
@property (retain, nonatomic) CKDPPrivateSearchGetResponse *privateSearchGetResponse;
@property (readonly, nonatomic) BOOL hasPrivateSearchDeleteResponse;
@property (retain, nonatomic) CKDPPrivateSearchDeleteResponse *privateSearchDeleteResponse;
