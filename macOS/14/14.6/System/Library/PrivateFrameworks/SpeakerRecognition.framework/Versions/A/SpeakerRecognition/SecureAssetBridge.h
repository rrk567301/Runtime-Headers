@class SecureMemoryIndex, NSString, NSDictionary, NSURL;

@interface SecureAssetBridge : NSObject

@property (retain, nonatomic) NSString *cachedConfigInfo;
@property (retain, nonatomic) NSString *cachedConfigSatInfo;
...
- (id)initWithAssetType:(unsigned long long)a0 configurationPath:(id)a1 configVersion:(id)a2 category:(id)a3 categoryResourceURLPath:(id)a4 categoryConfigFileName:(id)a5;
