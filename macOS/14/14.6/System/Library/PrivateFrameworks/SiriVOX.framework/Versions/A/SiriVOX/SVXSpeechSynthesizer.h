@class SVXSpeechSynthesisContext, SVXSpeechSynthesisAnnouncer, SVXSpeechSynthesisConfiguration, SVXSpeechSynthesisUtils, NSMutableArray, SVXVoiceGenderConverter, NSString, SiriTTSDaemonSession, SVXAudioStreamingAnnouncer, NSMutableSet, SVXSessionManager, SVXModule, SVXSessionUtils;
...
@interface SVXSpeechSynthesizer : NSObject <SVXModuleInstance> {
    ...
    SVXVoiceGenderConverter *_voiceUtils;
}
