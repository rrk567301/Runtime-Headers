...
+ (void)_appendSpanProperties:(id)a0 forAppShortcutMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forAutoShortcutMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forContactMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forCustomTermMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forGlobalTermMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forHomeEntityMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forLearnedContactMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forLearnedMediaEntityMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forLinkDynamicTermMatch:(id)a1 item:(id)a2;
+ (void)_appendSpanProperties:(id)a0 forRadioEntityMatch:(id)a1 item:(id)a2;
+ (id)_entitySpanForMatch:(id)a0 startIndex:(unsigned int)a1 endIndex:(unsigned int)a2 label:(id)a3;
+ (BOOL)_isSupportedFieldMatch:(id)a0 outFieldType:(long long *)a1 outFieldComponent:(unsigned char *)a2;
