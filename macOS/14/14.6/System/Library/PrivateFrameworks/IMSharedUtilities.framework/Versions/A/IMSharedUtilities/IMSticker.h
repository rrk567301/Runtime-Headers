...
+ (id)userInfoDictionaryWithLayoutIntent:(unsigned long long)a0 parentPreviewWidth:(double)a1 xScalar:(double)a2 yScalar:(double)a3 scale:(double)a4 rotation:(double)a5 initialFrameIndex:(unsigned long long)a6 stickerPositionVersion:(unsigned long long)a7;
...
- (id)initWithStickerID:(id)a0 stickerPackID:(id)a1 fileURL:(id)a2 accessibilityLabel:(id)a3 moodCategory:(id)a4 stickerName:(id)a5 effectType:(long long)a6;
- (id)initWithStickerID:(id)a0 stickerPackID:(id)a1 fileURL:(id)a2 accessibilityLabel:(id)a3 moodCategory:(id)a4 stickerName:(id)a5 effectType:(long long)a6 textToSpeechName:(id)a7;
