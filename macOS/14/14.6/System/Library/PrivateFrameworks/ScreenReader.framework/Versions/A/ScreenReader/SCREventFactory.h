...
@interface SCREventFactory : NSObject <SCRCursorAutoHideDelegate> {
    ...
    struct { unsigned char controlOnly : 1; unsigned char eventCaptureEnabled : 1; unsigned char fastSearchEnabled : 1; unsigned char invalid : 1; unsigned char kbCommanderEnabled : 1; unsigned char kbCommanderTracking : 1; unsigned char keyboardPassthruEnabled : 1; unsigned char modalSessionEnabled : 1; unsigned char numPadCommanderEnabled : 1; unsigned char quickNavOverridesSelectionEvents : 1; unsigned char speakAfterTextInsertionEnabled : 1; unsigned char vocFollowsKeyWindow : 1; unsigned char arrowKeyQuickNavEnabled : 1; unsigned char singleKeyQuickNavEnabled : 1; unsigned char arrowKeyQuickNavTemporarilyDisabled : 1; unsigned char singleKeyQuickNavTemporarilyDisabled : 1; } _flags;
