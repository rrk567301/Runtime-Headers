...
@interface AcceptedSiteDataSheetController : SheetWithTableController <WBTabGroupManagerObserver, NSTableViewDataSource, NSTableViewDelegate, TrackingDataControllerClient> {
