...
- (void)loadDeclarativeNetRequestContentBlockingRulesForExtensionWithIdentifier:(id)a0 previouslyLoadedHash:(id)a1 inContentBlockerStoreURL:(id)a2 sandboxExtensionToken:(id)a3 rules:(id)a4 reply:(id /* block */)a5;
