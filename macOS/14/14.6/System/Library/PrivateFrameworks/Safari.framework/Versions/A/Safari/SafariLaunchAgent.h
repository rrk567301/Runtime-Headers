...
- (void)askDefaultBrowserToBeginAuthenticationSessionWithUUID:(id)a0 url:(id)a1 callback:(id)a2 usingEphemeralSession:(BOOL)a3 jitEnabled:(BOOL)a4 additionalHeaderFields:(id)a5 completionHandler:(id /* block */)a6;
