...
@interface DownloadsManager : NSObject <WalletOrderFileDownloadDelegate, DownloadProgressEntryDelegate, PassFileDownloadDelegate, AuthenticationSheetRequestDelegate, DownloadAlertsManagerDataSource, DownloadViewControllerDataSource, DownloadViewControllerDelegate, _WKDownloadDelegate> {
    ...
    NSMutableDictionary *_wkDownloadToWalletOrderFileDownload;
...
- (id)startDownloadForRequest:(id)a0 shouldAvoidPersistingIdentifyingInformation:(BOOL)a1 profileIdentifier:(id)a2;
- (id)startDownloadForRequest:(id)a0 suggestedFilename:(id)a1 downloadLocationRequestType:(long long)a2 shouldAvoidPersistingIdentifyingInformation:(BOOL)a3 originatingWebView:(id)a4 profileIdentifier:(id)a5;
