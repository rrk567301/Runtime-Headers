...
@interface GEOPDLink : PBCodable <NSCopying> {
    ...
    int _linkType;
    struct { unsigned char has_linkType : 1; unsigned char read_unknownFields : 1; unsigned char read_appClipParams : 1; unsigned char read_extensionParams : 1; unsigned char read_quickLinkParams : 1; unsigned char read_webLinkParams : 1; unsigned char wrote_anyField : 1; } _flags;
}
