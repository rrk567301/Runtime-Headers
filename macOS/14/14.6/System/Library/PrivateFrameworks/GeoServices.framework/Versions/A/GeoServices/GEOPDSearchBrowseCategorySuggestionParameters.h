@class PBDataReader, GEOPDSearchOriginationInfo, GEOPDViewportInfo, GEOPDVenueIdentifier, GEOPDSSearchEvChargingParameters, PBUnknownFields;
...
@interface GEOPDSearchBrowseCategorySuggestionParameters : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_requestLocalTimestamp : 1; unsigned char has_minimumNumberOfCategories : 1; unsigned char has_preferredTransportType : 1; unsigned char has_suggestionType : 1; unsigned char has_isCarplayRequest : 1; unsigned char has_isFlatCategoryListRequest : 1; unsigned char has_isFromNoQueryState : 1; unsigned char has_isWidgetRequest : 1; unsigned char read_unknownFields : 1; unsigned char read_engineTypes : 1; unsigned char read_evChargingParameters : 1; unsigned char read_searchOriginationInfo : 1; unsigned char read_venueFilter : 1; unsigned char read_viewportInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
