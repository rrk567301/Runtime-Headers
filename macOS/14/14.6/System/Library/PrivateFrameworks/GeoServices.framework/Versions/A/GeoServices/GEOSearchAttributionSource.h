...
@interface GEOSearchAttributionSource : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_enforceAppStore : 1; unsigned char has_requiresAttributionInPhotoViewerHeader : 1; unsigned char read_unknownFields : 1; unsigned char read_attributionRequirements : 1; unsigned char read_suppressAttributionLogos : 1; unsigned char read_appAdamID : 1; unsigned char read_attributionApps : 1; unsigned char read_localizedAttributions : 1; unsigned char read_sourceIdentifier : 1; unsigned char read_supportedComponentActions : 1; unsigned char read_webBaseActionURL : 1; unsigned char wrote_anyField : 1; } _flags;
}
