...
@interface CMIStyleEngineCreateLinearSystem : NSObject <CMIStyleEngineProcessingStage> {
    ...
    struct { unsigned int polynomialCount; unsigned int systemCount; unsigned int systemSize; void /* unknown type, empty encoding */ spotlightCount; float extLambda; float tikLambdaConstant; float tikLambdaLinear; float tikLambdaQuadratic; float endLambda; float modulationStrength; float modulationOffset; } _params;
}
...
@property (retain, nonatomic) id<MTLBuffer> inputLHSDiagSumsBuffer;
@property (retain, nonatomic) id<MTLBuffer> inputPriorFactorForLHSBuffer;
@property (retain, nonatomic) id<MTLBuffer> inputPriorFactorForRHSBuffer;
@property (retain, nonatomic) id<MTLBuffer> outputLHSBuffer;
@property (retain, nonatomic) id<MTLBuffer> outputRHSBuffer;
