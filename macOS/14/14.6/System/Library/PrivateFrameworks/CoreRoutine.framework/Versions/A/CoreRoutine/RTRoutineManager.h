@class NSXPCConnection, NSString, RTRoutineManagerRegistrantAction, RTRoutineManagerRegistrantPeopleDiscovery, RTEventAgentHelper, NSObject, RTRoutineManagerRegistrantScenarioTrigger, RTTokenBucket;
