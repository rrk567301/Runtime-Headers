@class NSArray, NSString, NSData, NSFileProviderDomainVersion, NSError;

@interface libfssync.FPDDomainFPFSBackend : NSObject <FPDDomainBackend> {
...
- (void)stateDirectoryURLWithCompletionHandler:(id /* block */)a0;
- (void)temporaryDirectoryURLWithCompletionHandler:(id /* block */)a0;
