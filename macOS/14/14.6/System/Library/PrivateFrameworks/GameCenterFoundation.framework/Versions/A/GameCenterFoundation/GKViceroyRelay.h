@class GKConnection;
@protocol GKTransportMatchDataDelegate, GKTransportClientDelegate, GKTransportServiceHelper;
...
@property (retain, nonatomic) id<GKTransportServiceHelper> serviceHelper;
...
- (id)initWithClientDelegate:(id)a0 connection:(id)a1 matchDataDelegate:(id)a2 serviceHelper:(id)a3;
