...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 title:(id)a1 subtitle:(id)a2 puzzleDescription:(id)a3 puzzleType:(id)a4 dataResourceID:(id)a5 authors:(id)a6 publishDate:(id)a7 isPaid:(BOOL)a8 difficulty:(long long)a9 difficultyDescription:(id)a10 thumbnailSmallImageAssetHandle:(id)a11 thumbnailLargeImageAssetHandle:(id)a12 loadDate:(id)a13 teaserClue:(id)a14 teaserAnswer:(id)a15 teaserInfo:(id)a16 teaserDirection:(id)a17 teaserNumber:(id)a18 language:(id)a19 blockedStorefrontIDs:(id)a20 allowedStorefrontIDs:(id)a21 minimumNewsVersion:(long long)a22 showInfoModalOnFirstPlay:(BOOL)a23 ignoreFromStatsAndStreaks:(BOOL)a24 isDeprecated:(BOOL)a25 isDraft:(BOOL)a26 lastModifiedDate:(id)a27;
