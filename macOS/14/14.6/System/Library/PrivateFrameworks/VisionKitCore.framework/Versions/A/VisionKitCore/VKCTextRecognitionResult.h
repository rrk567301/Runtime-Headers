...
- (id)_selectionRectsForRange:(id)a0 documentView:(id)a1 contentRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 addTranscript:(BOOL)a3;
- (id)_adjustTextRangeToSelectableRange:(id)a0;
- (id)_normalizedSelectionQuadsForRange:(id)a0;
...
- (void)processListItemsItem:(id)a0 regionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 indexSet:(id)a2 attributedString:(id)a3 textListClass:(Class)a4;
- (void)processTableItem:(id)a0 regionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 indexSet:(id)a2 attributedString:(id)a3;
