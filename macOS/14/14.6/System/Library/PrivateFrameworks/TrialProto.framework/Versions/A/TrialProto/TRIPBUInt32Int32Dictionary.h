...
- (void)removeAll;
- (void)setInt32:(int)a0 forKey:(unsigned int)a1;
...
- (BOOL)getInt32:(int *)a0 forKey:(unsigned int)a1;
- (id)initWithInt32s:(const int *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
- (void)removeInt32ForKey:(unsigned int)a0;
