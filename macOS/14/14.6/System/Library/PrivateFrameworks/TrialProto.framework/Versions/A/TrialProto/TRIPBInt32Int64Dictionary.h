...
- (void)removeAll;
- (void)setInt64:(long long)a0 forKey:(int)a1;
...
- (BOOL)getInt64:(long long *)a0 forKey:(int)a1;
- (id)initWithInt64s:(const long long *)a0 forKeys:(const int *)a1 count:(unsigned long long)a2;
- (void)removeInt64ForKey:(int)a0;
