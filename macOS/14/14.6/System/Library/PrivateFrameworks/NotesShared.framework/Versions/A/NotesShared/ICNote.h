@class ICTTMergeableStringVersionedDocument, NSNumber, NSMutableArray, NSString, NSArray, ICAccount, ICNoteData, CKRecord, NSSet, NSData, CSSearchableItemAttributeSet, ICAttachment, ICTTVectorMultiTimestamp, ICMergeableDictionary, ICSelectorDelayer, ICFolder, NSUUID, NSManagedObjectContext, NSURL, NSDate, NSManagedObjectID, CKRecordID;
