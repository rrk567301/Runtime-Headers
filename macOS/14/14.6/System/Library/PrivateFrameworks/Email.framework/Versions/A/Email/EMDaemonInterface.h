@class EMClientState, EMSearchableIndex, EMDonationController, EMSenderRepository, NSObject, EMBlockedSenderManager, EFLocked, EMInteractionLogger, EMOutgoingMessageRepository, EMActivityRegistry, NSString, EMDiagnosticInfoGatherer, EMAccountRepository, NSHashTable, EMMailboxRepository, NSXPCListenerEndpoint, EMFetchController, NSXPCConnection, NSXPCInterface, EMMessageRepository;
