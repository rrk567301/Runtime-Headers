@class WBSQuerySuggestion, NSString, SFSearchResult, NSURL, WBSParsecImageRepresentation, MKMapItem;
...
+ (BOOL)_validateAndReturnPlacementHintValueForString:(id)a0 returnValue:(long long *)a1;
