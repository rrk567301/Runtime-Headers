@class WBSPhishingConfiguration, NSString, NSURL, WBSRemotelyUpdatableDataController, NSObject;
@protocol WBSPhishingAssetControllerDelegate, OS_dispatch_queue, WBSMobileAssetControllerProtocol;

@interface WBSPhishingAssetController : NSObject <WBSMobileAssetControllerDelegate, WBSRemotelyUpdatableDataControllerDelegate, WBSPhishingAssetControllerProtocol> {
    ...
    WBSRemotelyUpdatableDataController *_configurationController;
