...
@protocol LACDTORatchetStateProvider, LACDTOPolicyEvaluationIdentifierFactory, LACDTORatchetHandler, _TtP23LocalAuthenticationCore38LACDTOPendingPolicyEvaluationStoreType_, OS_dispatch_queue;

@interface LACDTOPendingPolicyEvaluationController : NSObject <LACDarwinNotificationCenterObserver, LACDTOPendingPolicyEvaluationController, LACDTOPolicyEvaluationControllerObserver, LACDTOEventHandler> {
...
- (void)_registerObserverForTimeChanges;
...
- (void)_cancelPreviousNotificationForPendingEvaluationRecord:(id)a0;
...
- (void)_scheduleNotificationForPendingEvaluationRecord:(id)a0 after:(double)a1 maxAge:(double)a2;
...
- (id)initWithRatchetStateProvider:(id)a0 ratchetHandler:(id)a1 evaluationIdentifierFactory:(id)a2 persistentStore:(id)a3 workQueue:(id)a4;
