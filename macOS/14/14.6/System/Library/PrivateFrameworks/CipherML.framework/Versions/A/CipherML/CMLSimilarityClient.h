...
- (id)encryptDifferentiallyPrivateBatchOfElements:(id)a0 shardIndex:(unsigned long long)a1 error:(id *)a2;
- (id)encryptDifferentiallyPrivateFakes:(id)a0 shardIndex:(unsigned long long)a1 error:(id *)a2;
