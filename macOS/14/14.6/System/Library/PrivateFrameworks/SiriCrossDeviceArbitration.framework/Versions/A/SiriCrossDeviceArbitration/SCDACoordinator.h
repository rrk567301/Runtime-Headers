@class NSString, SCDAPowerAssertionManager, NSDateFormatter, SCDAEmergencyCallPunchout, SCDAPreferences, NSMutableDictionary, SCDAContext, NSObject, SCDAAdvertisementContextRecord, NSData, CBPeripheralManager, SCDASession, WPHeySiri, SCDANotifyObserver, SCDAAdvertisementContextManager, SCDAWatchdogTimer, SCDAGoodnessScoreEvaluator, NSUUID, SCDAInstrumentation, NSDate, SCDARecord, SCDANotifyStatePublisher;
