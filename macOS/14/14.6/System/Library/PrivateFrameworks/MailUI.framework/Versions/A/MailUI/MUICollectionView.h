@class NSView, NSString, NSMutableIndexSet, MUICollectionHeightStorage, NSObject, NSLayoutConstraint, NSMutableArray, NSIndexSet, NSMutableSet;
...
@property (retain, nonatomic) NSView *bottomSupplementaryView;
@property (retain, nonatomic) NSLayoutConstraint *bottomSupplementaryViewHeightConstraint;
...
- (double)_bottomSupplementaryViewHeightWithOffset:(double)a0;
- (id)_claimUnusedCell;
