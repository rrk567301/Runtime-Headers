@class NSFileHandle, NSURL, AFSpeechTestRequestOptions, NSDictionary, SCDAContext, AFMyriadContext, AFSpeechSynthesisRecord, NSString, AFLanguageDetectionUserContext, NSXPCListenerEndpoint, NSNumber, AFSpeechRecordingAlertPolicy, NSUUID;
