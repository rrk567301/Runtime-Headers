...
- (BOOL)_hasActiveServerSideDictationLanguage:(id)a0;
- (BOOL)_isMTEOptOutEnabled;
- (BOOL)_isOptedOutOfMTE;
- (BOOL)_isOptedOutOfMTEWithOptInStatus:(long long)a0 locale:(id)a1 activeDictationLanguages:(id)a2 supportsUOD:(BOOL)a3;
