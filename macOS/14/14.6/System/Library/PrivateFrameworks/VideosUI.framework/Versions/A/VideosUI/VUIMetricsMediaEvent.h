...
+ (id)_metricsDataFromPlayable:(id)a0 actionType:(id)a1 canonicalIdOverride:(id)a2 contentType:(id)a3;
...
+ (void)recordPlay:(id)a0 isLaunchingExtras:(BOOL)a1 canonicalId:(id)a2 contentType:(id)a3;
+ (void)recordPlayOfTVPMediaItem:(id)a0;
+ (void)recordStop:(id)a0;
+ (void)recordStop:(id)a0 canonicalId:(id)a1 contentType:(id)a2;
