...
- (void)registerForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 shouldWake:(BOOL)a3 forDeviceTypes:(long long)a4 withErrorHandler:(id /* block */)a5;
- (void)registerForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 shouldWake:(BOOL)a3 forDeviceTypes:(long long)a4 withHandler:(id /* block */)a5;
- (void)registerForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 shouldWake:(BOOL)a3 forDevices:(id)a4 withErrorHandler:(id /* block */)a5;
...
- (void)unregisterForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 forDeviceTypes:(long long)a3 withHandler:(id /* block */)a4;
