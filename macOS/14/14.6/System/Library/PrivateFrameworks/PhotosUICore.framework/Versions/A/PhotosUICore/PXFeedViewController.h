@class PXFeedView, PXExpectation, PXUpdater, PXSelectionContainer, PXFeedConfiguration, NSScrollView, PXGViewMouseSession, PXSectionedObjectReference, NSString, UXView, PXFeedViewModel, PXFeedGadget, PXProgrammaticNavigationDestination;
