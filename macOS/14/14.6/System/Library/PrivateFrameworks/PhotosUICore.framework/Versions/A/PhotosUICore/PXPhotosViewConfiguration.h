@class NSURL, PXFooterViewModel, PXAssetsDataSourceManager, PXMediaProvider, PXStatusViewModel, PXAssetActionManager, PXAssetCollectionActionManager, PXSectionedObjectReference, NSString, PXSearchQueryMatchInfo, PXLoadingStatusManager, PXContentPrivacyController, PXSectionedSelectionManager;
