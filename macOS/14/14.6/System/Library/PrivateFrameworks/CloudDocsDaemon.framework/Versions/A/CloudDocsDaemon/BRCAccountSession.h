@class NSFileProviderDomain, BRCVolume, NSMutableSet, BRCFSUploader, BRCDeadlineScheduler, BRCInflightProgressTracker, BRCApplyScheduler, BRCDownloadTrackers, BRCClientState, BRCUserNotification, BRCServerPersistedState, BRCTimerScheduler, BRDSIDString, NSURL, BRCFileUnlinker, BRCThrottle, NSNumber, BRCFSDownloader, BRCPQLConnection, BRCFSReader, BRCContainerScheduler, br_pacer, BRCAccountHandler, NSMutableDictionary, NSString, BRCNotificationManager, BRCAccountWaitOperation, NSObject, NSHashTable, BRCItemTransmogrifier, BRCAnalyticsReporter, BRCFSWriter, BRCSyncUpScheduler, BRCDiskSpaceReclaimer, BRCFairScheduler, BRCStageRegistry, BRCGlobalProgress;
...
- (id)newAppLibraryFromPQLResultSet:(id)a0 version:(int)a1 error:(id *)a2;
