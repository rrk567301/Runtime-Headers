@class NSURL, brc_task_tracker, BRCSyncContext, NSMutableDictionary, BRCAccountSession, BRContainer, BRMangledID, NSString, BRCPQLConnection, BRCZoneRowID, BRCListDirectoryContentsOperation, BRCPrivateClientZone, BRCALRowID, NSNumber, NSData, NSMutableSet, BRCRelativePath, BRCFSEventsMonitor;
