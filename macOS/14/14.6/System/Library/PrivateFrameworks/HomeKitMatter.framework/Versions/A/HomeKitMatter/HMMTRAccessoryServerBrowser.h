@class NSDictionary, HMMTRControllerFactory, HMFTimer, CBCentralManager, HMMTRControllerWrapper, HMMTRAttestationDataStore, HMMTROTAProviderDelegate, NSMutableArray, NSMutableSet, MTRDeviceController, HMMTRSoftwareUpdateProvider, HMMTRUIDialogPresenter, HMMTRSystemCommissionerPairingManager, NSString, HMMTRFabricControllerStore, HMMTRMatterKeypair, HMMTRUserAuthorizationForPairing, NSObject, HAPPowerManager, NSData, HMMTRStorage, HMMTRAccessoryServer, HMMTRRegulatoryInfo, HMMTRAttestationStatus, HMMTROperationalCertificateIssuer, NSDate, HMMTRSystemCommissionerControllerParams, NSNumber, HMMTRResidentStateManager;
...
- (void)prepareForPairingWithSetupPayload:(id)a0 fabric:(id)a1 fabricID:(id)a2 owner:(BOOL)a3 completionHandler:(id /* block */)a4;
...
- (void)fetchOperationalCertificatesFromResidentForPublicKey:(id)a0 fabricID:(id)a1 completionHandler:(id /* block */)a2;
