@class NSNumber, HMFTimer, NSFileHandle, HMMTRControllerWrapper, HMMTRAccessoryReachabilityManager, HMMTRColorControl, NSString, HMMTRSyncClusterDoorLock, NSError, MTRDeviceController, HMMTRPairing, NSArray, NSMutableDictionary, HMMTRAccessoryServerBrowser, HMMTROTAApplyUpdateTimer, HMMTRHAPEnumerator, HMMTROTAAnnounceTimer, HMMTRFirmwareUpdateStatus, HMMTRDuration, HMMTRStorage, HMMTRMetricBundle, NSOperationQueue, NSData, HMFActivity, HMMTROTAApplyUpdateRequestTimer, HMMTRAttributeReportDistributor, NSUUID, MTRDevice, HMFFuture, HAPAccessory;
...
@property (retain, nonatomic) HMFTimer *stateCapturePartsListTimer;
...
@property (retain) HMMTRColorControl *colorControlCluster;
...
- (void)fetchColorControlCluster:(id /* block */)a0;
...
- (void)queueAccessoryOperation:(id /* block */)a0 highPriority:(BOOL)a1 operationQueuePriority:(long long)a2 completion:(id /* block */)a3;
