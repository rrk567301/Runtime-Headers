...
@interface _MRCommandInfoProtobuf : PBCodable <NSCopying> {
    ...
    struct { unsigned char sleepTimerFireDate : 1; unsigned char sleepTimerTime : 1; unsigned char canScrub : 1; unsigned char command : 1; unsigned char currentQueueEndAction : 1; unsigned char disabledReason : 1; unsigned char maximumRating : 1; unsigned char minimumRating : 1; unsigned char numAvailableSkips : 1; unsigned char preferredPlaybackRate : 1; unsigned char presentationStyle : 1; unsigned char repeatMode : 1; unsigned char shuffleMode : 1; unsigned char skipFrequency : 1; unsigned char skipInterval : 1; unsigned char sleepTimerStopMode : 1; unsigned char upNextItemCount : 1; unsigned char vocalsControlLevel : 1; unsigned char vocalsControlMaxLevel : 1; unsigned char vocalsControlMinLevel : 1; unsigned char active : 1; unsigned char enabled : 1; unsigned char supportsSharedQueue : 1; unsigned char vocalsControlActive : 1; unsigned char vocalsControlContinuous : 1; } _has;
}
