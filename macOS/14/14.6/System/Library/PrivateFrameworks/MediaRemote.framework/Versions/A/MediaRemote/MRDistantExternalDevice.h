@class NSXPCConnection, NSString, NSXPCListenerEndpoint, NSDate, MRAVDistantEndpoint, MRExternalOutputContextDataSource, NSArray, NSObject, NSMutableArray, MRDeviceInfo, MROrigin, MRGroupSessionToken;
...
- (void)hostedExternalDeviceGroupSessionTokenDidChange:(id)a0;
