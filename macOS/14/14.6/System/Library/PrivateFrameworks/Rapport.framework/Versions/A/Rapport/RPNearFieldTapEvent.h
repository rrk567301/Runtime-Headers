...
- (id)initWithIdentifier:(id)a0 applicationLabel:(id)a1 pkData:(id)a2 bonjourListenerUUID:(id)a3 isSameAccount:(BOOL)a4 contactID:(id)a5 forceSingleBandAWDLMode:(BOOL)a6 knownIdentity:(BOOL)a7 isUnsupportedApplicationLabel:(BOOL)a8;
