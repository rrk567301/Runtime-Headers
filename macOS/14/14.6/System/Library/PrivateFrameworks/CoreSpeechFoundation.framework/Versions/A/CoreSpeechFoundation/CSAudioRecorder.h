...
- (void)fetchSecureAudioStreamWithRecordDeviceIndicator:(id)a0 from:(unsigned long long)a1 numSamples:(unsigned long long)a2 hostTime:(unsigned long long)a3 error:(id *)a4;
