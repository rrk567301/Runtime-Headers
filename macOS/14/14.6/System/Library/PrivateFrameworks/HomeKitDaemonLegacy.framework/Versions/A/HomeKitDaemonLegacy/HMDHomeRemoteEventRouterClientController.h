@class NSUUID, NSString, HMEDelegatingEventRouter, HMDHomeManager, HMDUserMessagePolicy, HMFFuture, NSObject, NSMutableArray, HMDRemoteEventRouterPrimaryResidentClient;
...
- (id)initWithMessageTargetUUID:(id)a0 workQueue:(id)a1 dataSource:(id)a2 routerClientFactory:(id)a3 requestMessageName:(id)a4 updateMessageName:(id)a5 clientUserMessagePolicy:(id)a6 currentAccessoryUUID:(id)a7 assertionController:(id)a8 remoteTransportStartFuture:(id)a9 delegatingRouterFactory:(id /* block */)a10;
