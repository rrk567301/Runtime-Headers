...
- (BOOL)accountHasSentinelZoneForAppleMediaAccessorySensorManager:(id)a0;
- (void)createPairingIdentity;
- (id)fetchSentinelZoneDidFinishFutureForAppleMediaAccessorySensorManager:(id)a0;
