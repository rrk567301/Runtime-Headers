@class NSUUID, HMDFeaturesDataSource, HMDDatabaseZoneManager, NSObject, HMFMessageDispatcher, NSString, HMDCameraProfileSettingsDerivedPropertiesModel, HMDHAPAccessory, _HMCameraUserSettings, HMDBulletinBoard, NSNumber, NSOperationQueue, HMDCameraProfileSettingsModel, HMDCharacteristicsAvailabilityListener, NSNotificationCenter;
...
- (id)_processingOptionsForLabel:(id)a0;
- (void)_synchronizeSettingsModelForBackwardCompatibilityForCharacteristic:(id)a0;
- (id)initWithUniqueIdentifier:(id)a0 hapAccessory:(id)a1 workQueue:(id)a2 zoneManager:(id)a3 notificationCenter:(id)a4 bulletinBoard:(id)a5 characteristicsAvailabilityListener:(id)a6 featuresDataSource:(id)a7;
