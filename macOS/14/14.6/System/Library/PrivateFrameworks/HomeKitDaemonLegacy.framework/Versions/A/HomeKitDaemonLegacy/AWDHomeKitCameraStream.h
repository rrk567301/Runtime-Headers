...
@interface AWDHomeKitCameraStream : PBCodable <NSCopying> {
    struct { unsigned char duration : 1; unsigned char timestamp : 1; unsigned char certified : 1; unsigned char errorCode : 1; unsigned char receivedFirstFrame : 1; unsigned char underlyingErrorCode : 1; unsigned char isLocal : 1; } _has;
}
