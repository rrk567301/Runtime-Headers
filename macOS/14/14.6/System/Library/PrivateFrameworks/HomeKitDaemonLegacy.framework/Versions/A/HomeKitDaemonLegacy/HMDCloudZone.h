...
@property (nonatomic, getter=hasRecordsAvailable) BOOL recordsAvailable;
@property (readonly, nonatomic, getter=hasServerTokenAvailable) BOOL serverTokenAvailable;
...
- (void)deleteZone;
- (void)fetchAllObjects:(id /* block */)a0;
