...
- (void).cxx_destruct;
- (id)initWithThreshold:(long long)a0 message:(id)a1 radarTitle:(id)a2 componentName:(id)a3 componentVersion:(id)a4 componentID:(id)a5 radarInitiator:(id)a6;
- (id)initWithThreshold:(long long)a0 message:(id)a1 radarTitle:(id)a2 componentName:(id)a3 componentVersion:(id)a4 componentID:(id)a5 radarInitiator:(id)a6 primaryOnly:(BOOL)a7 forHome:(id)a8;
- (id)initWithThreshold:(long long)a0 ttrCategory:(id)a1 radarInitiator:(id)a2;
