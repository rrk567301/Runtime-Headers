...
+ (unsigned int)maxBdatQualityIndexForVideoQuality:(unsigned char)a0 isLocalOnWiFi:(BOOL)a1 isRedundancyRequested:(BOOL)a2;
+ (unsigned int)maxCameraQualityIndexForVideoQuality:(unsigned char)a0 isLocalOnWiFi:(BOOL)a1 isRedundancyRequested:(BOOL)a2 isSharingEnabled:(BOOL)a3;
+ (unsigned int)maxCameraQualityIndexForVideoQuality:(unsigned char)a0 useWiFiTable:(BOOL)a1 isSharingEnabled:(BOOL)a2;
+ (unsigned int)maxCameraQualityIndexWithRedundancyForVideoQuality:(unsigned char)a0 useWiFiTable:(BOOL)a1;
+ (unsigned int)maxFdatQualityIndexForVideoQuality:(unsigned char)a0 isLocalOnWiFi:(BOOL)a1 isRedundancyRequested:(BOOL)a2;
+ (unsigned int)maxFtxtQualityIndexForVideoQuality:(unsigned char)a0 isLocalOnWiFi:(BOOL)a1 isRedundancyRequested:(BOOL)a2;
+ (unsigned int)maxQualityIndexForStreamGroupID:(unsigned int)a0 videoQuality:(unsigned char)a1 isLocalOnWiFi:(BOOL)a2 isRedundancyRequested:(BOOL)a3 isSharingEnabled:(BOOL)a4;
+ (unsigned int)maxWebRTCCameraQualityIndexForVideoQuality:(unsigned char)a0 isLocalOnWiFi:(BOOL)a1 isSharingEnabled:(BOOL)a2;
