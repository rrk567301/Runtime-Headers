@class PGMutableGraph, PGEventLabelingFeaturesFileCache, NSMutableDictionary, CLSCurationContext, NSDictionary, CLSSceneTaxonomyHierarchy, CLSFocusPeopleCache, NSObject, PGGraphMomentNodeCollection, NSSet, PGAssetCollectionFeatureProvider, PHPhotoLibrary, PGGraphTimeDomainBuildingHelper, PGGraphPeopleDomainBuildingHelper, PGCurationManager;
@protocol OS_os_log;
...
- (void)setPopularityScore:(double)a0 onAreaNodeForIdentifier:(unsigned long long)a1;
