...
- (id)_extractSortedPoolOfContactIdentifiersWithProgressBlock:(id /* block */)a0;
...
- (id)initWithPersonNodes:(id)a0 runOptions:(unsigned long long)a1 photoLibrary:(id)a2 loggingConnection:(id)a3;
