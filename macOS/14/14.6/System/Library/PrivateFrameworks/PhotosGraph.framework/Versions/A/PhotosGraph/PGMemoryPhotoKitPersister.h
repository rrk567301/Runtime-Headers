...
- (BOOL)persistGraphEphemeralMemoriesFromEnrichedMemories:(id)a0 ephemeralMemoriesToDelete:(id)a1 graph:(id)a2 progressReporter:(id)a3 error:(id *)a4;
- (BOOL)updateExistingMemories:(id)a0 ephemeralMemoryByUniqueIdentifier:(id)a1 progressReporter:(id)a2;
