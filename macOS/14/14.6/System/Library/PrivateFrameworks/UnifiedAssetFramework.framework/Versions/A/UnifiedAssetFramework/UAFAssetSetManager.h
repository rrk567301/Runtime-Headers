@class UAFSubscriptionStoreManager, NSMutableSet, UAFConfigurationManager;
...
- (void)updateAssetsForSubscriber:(id)a0 subscriptionName:(id)a1 policies:(id)a2 queue:(id)a3 progress:(id /* block */)a4 completion:(id /* block */)a5 storeManager:(id)a6 configurationManager:(id)a7;
