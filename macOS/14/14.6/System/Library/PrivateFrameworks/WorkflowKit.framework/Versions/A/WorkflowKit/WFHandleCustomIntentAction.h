@class INSchema, NSString, WFIntentDynamicResolver, NSArray, INIntentResponseCodableDescription, INIntentDescriptor, NSDictionary, INIntent, WFIntentDynamicResolutionRequest, WFRemoteWidgetConnection, INIntentCodableDescription;
