@class NSString, NSSet, NSArray, NSOperationQueue, NSDictionary, NSObject, NSMapTable;
...
- (void)fillActionProviders:(id)a0 updatingCache:(BOOL)a1;
- (void)prewarmActionResourcesForProviderActions:(id)a0;
