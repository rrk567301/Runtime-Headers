@class NSUUID, NSString, NSArray, NSXPCConnection, _TtC26AuthenticationServicesCore13ASCABLEClient, ASCCredentialRequestContext, ASCAuthorizationPresenter, WBSSavedAccountContext, NSObject, ASCAuthorizationTrafficController, NSXPCListener, NSMutableArray;
