...
- (id)_initWithKind:(unsigned long long)a0 relyingPartyIdentifier:(id)a1 challenge:(id)a2 clientDataHash:(id)a3 clientDataJSON:(id)a4 userVerificationPreference:(id)a5 allowedCredentials:(id)a6 shouldHideHybrid:(BOOL)a7 appIDForSecurityKeys:(id)a8;
