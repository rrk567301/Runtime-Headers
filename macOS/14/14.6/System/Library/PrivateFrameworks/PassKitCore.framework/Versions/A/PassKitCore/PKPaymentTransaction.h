...
@property (readonly, nonatomic) unsigned long long fkCreditDebitIndicator;
@property (readonly, nonatomic) unsigned long long fkAppleTransactionType;
@property (readonly, nonatomic) unsigned long long fkAppleTransactionStatus;
