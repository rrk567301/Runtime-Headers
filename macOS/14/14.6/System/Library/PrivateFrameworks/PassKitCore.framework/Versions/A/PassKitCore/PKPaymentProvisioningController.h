@class NSHashTable, PKPaymentCredential, PKAccountService, NSMutableArray, NSString, NSMutableSet, PKPaymentSetupProductModel, PKPaymentPass, PKPaymentProvisioningControllerCredentialQueue, NSTimer, NSArray, PKPaymentService, PKAddPaymentPassRequestConfiguration, PKProvisioningUtility, PKSecureElementProvisioningState, PKPaymentCloudStoreZoneCreationManager, NSObject, NSSet, NSData, PKPaymentSetupProduct, CLLocationManager, CIDVUIProofingFlowManager, CLLocation, PKPaymentWebService, PKPaymentProvisioningResponse, PKProvisioningSEStorageSnapshot, NSMutableOrderedSet, PKPaymentRequirementsResponse, PKPaymentEligibilityResponse, NSExtension;
