@class NSDate, NSString, NSArray, NSURL, NSSet, PKEnteredValueActionItem, NSDictionary, PKPaymentPassActionRemoteConfiguration, PKAutoTopUpActionItem, PKTransitCommutePlan;
