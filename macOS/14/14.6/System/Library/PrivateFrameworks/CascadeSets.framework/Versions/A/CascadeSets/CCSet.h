...
@interface CCSet : NSObject <NSSecureCoding, NSCopying>
...
+ (id)setEnumerator;
+ (id)_setIdentifierFromItemType:(unsigned short)a0 encodedDescriptors:(id)a1;
...
- (id)serializeWithError:(id *)a0 enumerateToBookmark:(id)a1;
