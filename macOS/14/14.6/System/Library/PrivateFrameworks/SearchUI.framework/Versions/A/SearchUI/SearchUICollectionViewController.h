@class NSString, NSScrollView, NSSearchField, NSOrderedSet, NSMutableDictionary, SearchUICollectionViewAttributes, SearchUICollectionViewDataSource, SearchUICommandHandler, SearchUICollectionView, NSCollectionView, NSIndexPath;
@protocol SearchUIFeedbackDelegate, SearchUICardViewDelegate, SearchUICommandDelegate;

@interface SearchUICollectionViewController : NSViewController <SearchUICollectionViewSizingDelegate, NSCollectionViewDelegate, QLPreviewPanelDelegate, QLPreviewPanelDataSource, SearchUITableHeaderCommandDelegate, SearchUIFeedbackDelegateInternal, NSScrollViewDelegate, SearchUIViewTesting>
