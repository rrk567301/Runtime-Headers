...
+ (void)userSliderCommit:(const struct CBSliderCommitInfo { long long x0; long long x1; int x2; float x3; float x4; BOOL x5; float x6; float x7; float x8; float x9; int x10; BOOL x11; BOOL x12; float x13; struct CBAABParams { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; } x14; struct CBAABParams { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; } x15; BOOL x16; int x17; float x18; float x19; long long x20; float x21; long long x22; BOOL x23; BOOL x24; BOOL x25; float x26; float x27; int x28; BOOL x29; BOOL x30; } *)a0;
