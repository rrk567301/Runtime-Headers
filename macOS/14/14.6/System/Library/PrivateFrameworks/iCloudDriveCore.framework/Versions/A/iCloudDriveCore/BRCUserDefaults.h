...
@property (readonly, nonatomic) unsigned long long advancedDataProtectionBasehashSaltingBatchSize;
...
@property (readonly, nonatomic) BOOL supportsAdvancedDataProtection;
@property (readonly, nonatomic) BOOL advancedDataProtectionForced;
...
@property (readonly, nonatomic) NSSet *retriableCKInteralErrorCodesForRejectedRequestedError;
