@class BRCThumbnailGenerationManager, NSString, BRCDeadlineSource, br_pacer, BRCFairScheduler, BRCDeadlineScheduler;

@interface BRCFSUploader : BRCFSTransferScheduler <BRCModule, BRCScreenLockDelegate> {
