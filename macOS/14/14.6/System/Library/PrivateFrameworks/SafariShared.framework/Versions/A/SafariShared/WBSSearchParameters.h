...
@property (nonatomic) BOOL isStreamlinedCompletionListEnabledForTrial;
@property (readonly, nonatomic) BOOL isStreamlinedCompletionListEnabled;
@property (nonatomic) BOOL isLabelPreviousSearchesInCompletionListEnabledForTrial;
@property (readonly, nonatomic) BOOL isLabelPreviousSearchesInCompletionListEnabled;
