@class HMDAppleAccountManager, NSSet, HMDRemoteDeviceMonitor, HMDFeaturesDataSource, NSObject, HMDMessageDispatcher, NSMutableSet, HMFFuture, NSString, HMDResidentDevice, NSHashTable, HMDModernTransportDeviceReachabilityObserver, HMDPrimaryElectionCoordinationAddOn, HMDDevice, NSArray, HMDHome, HMFPromise, NSNotificationCenter, NSUUID;
...
- (id)foundNewPrimaryResident:(id)a0 generationID:(id)a1 selectionTimestamp:(id)a2;
