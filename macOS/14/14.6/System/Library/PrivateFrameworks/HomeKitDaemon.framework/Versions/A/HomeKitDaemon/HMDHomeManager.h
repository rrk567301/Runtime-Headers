...
- (void)_handleAccessoryDiagnosticQueryWithOptions:(unsigned long long)a0 accessory:(id)a1 accessoryUUID:(id)a2 mediaRouteID:(id)a3 additionalFetchKeys:(id)a4 completion:(id /* block */)a5;
...
- (void)_handleMediaPlaybackStateDidChangeNotification:(id)a0;
...
- (void)setMediaPlaybackStateChangeNotificationsEnabled:(BOOL)a0;
