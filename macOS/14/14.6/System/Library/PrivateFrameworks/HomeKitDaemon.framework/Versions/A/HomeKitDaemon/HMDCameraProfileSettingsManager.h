@class NSNumber, NSUUID, HMDFeaturesDataSource, HMFMessageDispatcher, NSObject, NSString, HMDCameraProfileSettingsDerivedPropertiesModel, HMDHAPAccessory, HMDCameraProfileSettingsCoreDataAdapter, _HMCameraUserSettings, HMDBulletinBoard, NSOperationQueue, HMDCharacteristicsAvailabilityListener, HMDCameraProfileSettingsModel, NSNotificationCenter, HMDCameraBulletinNotificationManager;
...
@property (readonly) NSOperationQueue *accessModeOperationQueue;
...
- (BOOL)_shouldQueryCanDisableRecordingForAccessMode:(unsigned long long)a0 isAtHome:(BOOL)a1;
- (BOOL)_shouldQueryCanEnableRecordingForAccessMode:(unsigned long long)a0;
...
- (void)_updateSettingsWithAccessMode:(unsigned long long)a0 forIsAtHome:(BOOL)a1 completion:(id /* block */)a2;
...
- (id)initWithUniqueIdentifier:(id)a0 hapAccessory:(id)a1 workQueue:(id)a2 coreDataAdapter:(id)a3 notificationCenter:(id)a4 bulletinBoard:(id)a5 characteristicsAvailabilityListener:(id)a6 featuresDataSource:(id)a7;
- (BOOL)isCurrentDeviceConfirmedPrimaryResident;
- (void)listener:(id)a0 didUpdateAvailableCharacteristics:(id)a1;
- (id)manuallyDisabledCharacteristic;
- (void)performAccessModeOperationWithBlock:(id /* block */)a0;
