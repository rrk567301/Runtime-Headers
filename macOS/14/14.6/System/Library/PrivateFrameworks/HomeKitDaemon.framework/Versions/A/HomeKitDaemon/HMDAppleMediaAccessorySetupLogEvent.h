...
- (void).cxx_destruct;
- (id)initWithRole:(long long)a0 setupStartTime:(unsigned long long)a1 setupEndTime:(unsigned long long)a2 accessoryAddEndTime:(unsigned long long)a3 accessoryRemoveTime:(unsigned long long)a4 configurationEndTime:(unsigned long long)a5 setupSessionError:(id)a6 setupSessionIdentifier:(id)a7 isRepairSession:(BOOL)a8 category:(id)a9 accessorySoftwareVersion:(id)a10 setupClientBundleID:(id)a11 retryCount:(unsigned long long)a12 firstSettingTime:(unsigned long long)a13 languageSettingTime:(unsigned long long)a14 accessoryInDefaultRoom:(BOOL)a15 lastPrimaryResidentAvailableTime:(unsigned long long)a16 numberOfTimesPrimaryResidentChanged:(unsigned int)a17 lastPrimaryClientConnectedTime:(unsigned long long)a18 numberOfTimesPrimaryClientConnected:(unsigned int)a19 numberOfTimesPrimaryClientDisconnected:(unsigned int)a20 numberOfTimesPrimaryClientConnectMessageFailed:(unsigned int)a21 lastPrimaryClientConnectMessageFailError:(id)a22 accessoryDiagnosticInfoFetchError:(id)a23 primaryResidentDiagnosticInfoFetchError:(id)a24;
