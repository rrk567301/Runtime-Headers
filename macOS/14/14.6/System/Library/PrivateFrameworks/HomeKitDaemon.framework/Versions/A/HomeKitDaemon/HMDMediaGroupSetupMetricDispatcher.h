...
- (void)markRequestReceivedForGroupIdentifier:(id)a0 metricType:(unsigned long long)a1 setupSessionIdentifier:(id)a2 setupSessionStartTimeMS:(unsigned long long)a3;
- (id)setupLatencyLogEvent:(unsigned long long)a0 groupIdentifier:(id)a1 isController:(BOOL)a2 isPrimaryResident:(BOOL)a3 totalDuration:(unsigned long long)a4 setupSessionIdentifier:(id)a5 totalDurationSinceSetupSessionStart:(unsigned long long)a6 errorStage:(id)a7;
