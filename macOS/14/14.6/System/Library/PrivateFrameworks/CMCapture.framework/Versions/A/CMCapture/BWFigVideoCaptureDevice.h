@class BWActionCameraFlickerAvoidanceMonitor, BWMovingWindowStats, NSDictionary, BWStats, NSMutableSet, NSMutableArray, BWFigCaptureDevice, BWAmbientLightSensor, BWStereoVideoCaptureSceneMonitor, BWInferenceResult, BWZoomCommandHandler, BWMemoryPool, BWFigVideoCaptureSynchronizedStreamsGroup, BWImageControlModeTransitionMonitor, NSNumber, BWFigCaptureDeviceVendor, BWStillImageCaptureSettings, BWFigVideoCaptureStream, BWDeviceMotionActivityDetector, BWMetadataTimeMachine, BWPixelBufferPool, BWBravoStreamSelector, BWVariableFrameRateSelector, NSArray, BWFrameStatisticsByPortType, BWRamp, NSMutableDictionary, FigWeakReference, BWZoomRange, NSString, NSObject, FigStateMachine, BWStreamStartStopSynchronizer, NSSet;
...
- (struct OpaqueFigSampleBufferProcessor { } *)_autofocusProcessor;
- (id)_initWithCaptureDevice:(id)a0 attributes:(id)a1 synchronizedStreamsAttributes:(id)a2 unsynchronizedStreamsAttributes:(id)a3 multiCamEnabled:(BOOL)a4 applicationID:(id)a5 clientAuditToken:(struct { unsigned int x0[8]; })a6 tccIdentity:(id)a7 mediaEnvironment:(id)a8 deviceVendor:(id)a9 createAutofocusSampleBufferProcessorFunction:(void /* function */ *)a10 cameraParameters:(id)a11 error:(int *)a12;
...
- (id)initWithCaptureDevice:(id)a0 attributes:(id)a1 synchronizedStreamsAttributes:(id)a2 unsynchronizedStreamsAttributes:(id)a3 multiCamEnabled:(BOOL)a4 applicationID:(id)a5 clientAuditToken:(struct { unsigned int x0[8]; })a6 tccIdentity:(id)a7 mediaEnvironment:(id)a8 error:(int *)a9;
