...
- (id)initWithCaptureDevice:(id)a0 studioAndContourRenderingEnabled:(BOOL)a1 stageRenderingEnabled:(BOOL)a2 depthDataSource:(int)a3 foregroundBlurEnabled:(BOOL)a4 commandQueue:(id)a5 priority:(unsigned int)a6 mirroredForMetadataAdjustment:(BOOL)a7 rotationDegreesForMetadataAdjustment:(int)a8;
