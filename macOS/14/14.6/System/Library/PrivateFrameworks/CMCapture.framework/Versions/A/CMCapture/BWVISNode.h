@class NSData, NSString, BWVideoFormatRequirements, BWVISProcessorControllerConfiguration, NSArray, BWVISProcessorController, NSDictionary, BWIrisStillImageMovieMetadataCache, NSObject, BWStats, NSNumber, BWLimitedGMErrorLogger;
