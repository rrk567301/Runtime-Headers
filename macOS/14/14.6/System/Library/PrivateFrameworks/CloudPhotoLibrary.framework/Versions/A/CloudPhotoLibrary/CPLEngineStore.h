@class CPLEngineCloudCache, CPLEngineScopeCleanupTasks, CPLEngineResourceStorage, CPLSyncSessionPredictor, CPLTransportScopeMapping, NSMutableArray, CPLRecordStorageView, CPLEngineQuarantinedRecords, CPLEngineOutgoingResources, CPLEngineRecordComputeStatePushQueue, CPLChangeBatch, CPLEngineResourceDownloadQueue, NSURL, CPLEngineTransientRepository, CPLPlatformObject, CPLEngineIDMapping, CPLEngineRevertRecords, CPLEnginePendingRecordChecks, NSArray, NSMutableDictionary, NSString, CPLEngineIgnoredRecords, NSObject, CPLEngineStatusCenter, CPLEngineLibrary, CPLResetTracker, NSHashTable, CPLEngineScopeStorage, CPLEnginePushRepository, CPLEngineChangePipe, CPLEngineRemappedRecords, NSSet, CPLEngineDerivativesCache, NSDate;
