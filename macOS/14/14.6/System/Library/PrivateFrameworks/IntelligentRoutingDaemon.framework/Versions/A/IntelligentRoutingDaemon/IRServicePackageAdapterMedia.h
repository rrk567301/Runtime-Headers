...
- (id)_reasonsForRejectingAutoRouteOrOneTapClassificationForCandidate:(id)a0 isAutoRoutingSettingEnabled:(BOOL)a1 isRoutePredictionSettingEnabled:(BOOL)a2;
...
- (BOOL)shouldRejectEvent:(id)a0 withHistoryEventsContainer:(id)a1 forCandidateIdentifier:(id)a2;
