...
- (void).cxx_destruct;
- (id)initWithClientIdentifier:(id)a0 internalAppName:(id)a1 eventType:(id)a2 miloAvailable:(id)a3 bannerCandidateType:(id)a4 bannerCandidateModelType:(id)a5 chosenCandidateType:(id)a6 chosenCandidateModelType:(id)a7 postBannerInteraction:(id)a8;
