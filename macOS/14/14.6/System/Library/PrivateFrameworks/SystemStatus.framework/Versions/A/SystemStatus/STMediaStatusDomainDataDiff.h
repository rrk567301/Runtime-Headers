...
- (id)initWithMicrophoneAttributionListDataDiff:(id)a0 mutedMicrophoneRecordingAttributionListDataDiff:(id)a1 systemAudioRecordingAttributionListDataDiff:(id)a2 cameraAttributionListDataDiff:(id)a3;
