@class HMFNetAddress, HMFBlockOperation, NSDate, HAPAccessoryServerBrowserIP, NSDictionary, HAPAuthSession, HAPAccessoryServerBookkeeping, HAPAccessory, NSMutableArray, HAPAccessoryServerIPConnectionStatistics, HAPHTTPClient, NSString, HAPWACAccessory, HAPSocketInfo, NSOperationQueue, NSArray, HMFNetMonitor, NSData, HAPAccessoryProtocolInfo, HMFTimer;
