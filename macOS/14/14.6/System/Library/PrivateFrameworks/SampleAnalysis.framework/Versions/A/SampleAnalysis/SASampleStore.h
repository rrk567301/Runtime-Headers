@class SAFrame, SAMountStatusTracker, SATimestamp, NSMutableDictionary, NSDictionary, SABinaryLocator, SAWSUpdateDataStore, NSMutableArray, NSString, SASharedCache, SATask, NSMutableSet, NSArray, SATimeRange, NSError;
