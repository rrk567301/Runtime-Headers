...
+ (BOOL)_prefetchIsEnabledForPhase:(unsigned long long)a0 givenMode:(long long)a1 andInitialSyncDate:(id)a2 photoLibrary:(id)a3;
...
- (void)_prefetchComputeSyncResources:(id)a0 photoLibrary:(id)a1 prefetchPhase:(unsigned long long)a2 shouldAutoPefetchNextBatch:(BOOL)a3;
- (BOOL)_prefetchIsEnabledForPhase:(unsigned long long)a0 photoLibrary:(id)a1;
