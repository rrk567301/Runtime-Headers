...
+ (void)_populateObjectDictionary:(id)a0 withObject:(id)a1 currentKeyPath:(id)a2 usingModelProperties:(id)a3 payloadClass:(Class)a4 info:(id)a5;
...
- (void)_applyModelProperties:(id)a0 toPayloadAttributes:(id)a1 andNilAttributes:(id)a2 forManagedObject:(id)a3 changedKeys:(id)a4 info:(id)a5;
...
- (void)applySubRelationshipPayloadProperty:(id)a0 toManagedObject:(id)a1 key:(id)a2 payloadAttributesToUpdate:(id)a3 payloadDictionary:(id)a4 info:(id)a5;
...
- (id)initWithPayloadID:(id)a0 payloadVersion:(unsigned int)a1 nilAttributes:(id)a2 managedObject:(id)a3 changedKeys:(id)a4 modelProperties:(id)a5 info:(id)a6;
