...
- (id)addDCIMEntryAtFileURL:(id)a0 mainFileMetadata:(id)a1 progress:(id)a2 previewImage:(id)a3 thumbnailImage:(id)a4 savedAssetType:(short)a5 replacementUUID:(id)a6 publicGlobalUUID:(id)a7 extendedInfo:(id)a8 withUUID:(id)a9 isPlaceholder:(BOOL)a10 placeholderFileURL:(id)a11;
