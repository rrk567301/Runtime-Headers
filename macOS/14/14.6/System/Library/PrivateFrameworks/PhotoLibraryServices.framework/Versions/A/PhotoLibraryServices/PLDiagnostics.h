...
+ (void)_tapToRadarKitDraftWithTitle:(id)a0 description:(id)a1 radarComponent:(long long)a2 displayReason:(id)a3 attachments:(id)a4;
...
+ (void)tapToRadarWithTitle:(id)a0 description:(id)a1 radarComponent:(long long)a2 displayReason:(id)a3 attachments:(id)a4;
