@class RBProcess, RBPowerAssertionManager, RBProcessReconnectManager, RBAssertionManager, RBBundlePropertiesManager, RBEntitlementManager, RBThrottleBestEffortNetworkingManager, RBThermalResponseManager, RBAssertionDescriptorValidator, RBHistoricalStatistics, NSString, RBProcessManager, RBConnectionListener, RBAssertionOriginatorPidStore, RBStateCaptureManager, RBProcessMonitor, RBDomainAttributeManager, RBJetsamPropertyManager;
