...
+ (BOOL)createSingleNetworkPlanFromModelPath:(id)a0 forComputeDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 explicitNetworkLayersStorageType:(int)a6 memoryPoolId:(unsigned long long)a7 espressoResources:(id *)a8 error:(id *)a9;
+ (BOOL)createSingleNetworkPlanFromModelPath:(id)a0 forComputeDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 memoryPoolId:(unsigned long long)a6 espressoResources:(id *)a7 error:(id *)a8;
