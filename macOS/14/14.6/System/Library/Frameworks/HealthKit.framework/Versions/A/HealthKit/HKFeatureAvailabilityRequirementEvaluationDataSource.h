@class HKFeatureAvailabilityProvidingDataSource, NSDate, HKNanoRegistryPairingAndSwitchingNotificationDataSource, HKFeatureStatusProvidingDataSource, HKFeatureAvailabilityRequirementSatisfactionOverridesDataSource, HKBluetoothDeviceDataSource, HKWatchAppInstallationDataSource, _HKBehavior, HKImportExclusionDeviceDataSource, HKUserDefaultsDataSource, HKDarwinNotificationDataSource, HKWristDetectionSettingDataSource, HKWatchLowPowerModeDataSource;
