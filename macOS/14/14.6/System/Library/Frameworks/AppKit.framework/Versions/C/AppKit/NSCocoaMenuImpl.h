@class NSMutableDictionary, NSObject, NSMenu, NSMenuContext, NSMenuSelectionRect, NSMenuItem, NSAppearance, NSString, NSMutableSet, NSMenuItemView, NSMenuTrackingSession, NSView, NSPopupMenuWindow;
