@class MTRDeviceController, NSArray, MTRServerEndpoint, MTRDiagnosticLogsDownloader, NSMutableArray, NSObject;
...
@interface MTRDeviceControllerFactory : NSObject {
    ...
    void *_opCertStore;
    struct MTROperationalBrowser { id x0; id x1; struct _DNSServiceRef_t *x2; BOOL x3; BOOL x4; } *_operationalBrowser;
