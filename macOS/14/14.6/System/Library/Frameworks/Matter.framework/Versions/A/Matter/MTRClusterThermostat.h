...
- (id)readAttributePresetsWithParams:(id)a0;
...
- (void)cancelPresetsSchedulesEditRequestWithExpectedValues:(id)a0 expectedValueInterval:(id)a1 completion:(id /* block */)a2;
- (void)cancelPresetsSchedulesEditRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
- (void)cancelSetActivePresetRequestWithExpectedValues:(id)a0 expectedValueInterval:(id)a1 completion:(id /* block */)a2;
- (void)cancelSetActivePresetRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
...
- (void)commitPresetsSchedulesRequestWithExpectedValues:(id)a0 expectedValueInterval:(id)a1 completion:(id /* block */)a2;
- (void)commitPresetsSchedulesRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
...
- (id)readAttributeActivePresetHandleWithParams:(id)a0;
- (id)readAttributeActiveScheduleHandleWithParams:(id)a0;
...
- (id)readAttributeNumberOfPresetsWithParams:(id)a0;
- (id)readAttributeNumberOfScheduleTransitionPerDayWithParams:(id)a0;
- (id)readAttributeNumberOfScheduleTransitionsWithParams:(id)a0;
- (id)readAttributeNumberOfSchedulesWithParams:(id)a0;
...
- (id)readAttributePresetTypesWithParams:(id)a0;
- (id)readAttributePresetsSchedulesEditableWithParams:(id)a0;
- (id)readAttributeQueuedPresetWithParams:(id)a0;
- (id)readAttributeRemoteSensingWithParams:(id)a0;
- (id)readAttributeScheduleTypesWithParams:(id)a0;
- (id)readAttributeSchedulesWithParams:(id)a0;
...
- (id)readAttributeSetpointHoldExpiryTimestampWithParams:(id)a0;
...
- (id)readAttributeTemperatureSetpointHoldPolicyWithParams:(id)a0;
...
- (void)setActivePresetRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
- (void)setActiveScheduleRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
- (void)setTemperatureSetpointHoldPolicyWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
...
- (void)startPresetsSchedulesEditRequestWithParams:(id)a0 expectedValues:(id)a1 expectedValueInterval:(id)a2 completion:(id /* block */)a3;
...
- (void)writeAttributePresetsWithValue:(id)a0 expectedValueInterval:(id)a1;
- (void)writeAttributePresetsWithValue:(id)a0 expectedValueInterval:(id)a1 params:(id)a2;
...
- (void)writeAttributeSchedulesWithValue:(id)a0 expectedValueInterval:(id)a1;
- (void)writeAttributeSchedulesWithValue:(id)a0 expectedValueInterval:(id)a1 params:(id)a2;
