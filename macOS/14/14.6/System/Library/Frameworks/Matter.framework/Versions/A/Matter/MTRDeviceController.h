@class NSUUID, MTRAsyncWorkQueue, MTRDeviceControllerFactory, NSMutableDictionary, MTRCommissionableBrowser, NSObject, NSMutableArray, MTRDeviceControllerDataStore, NSNumber, MTRDeviceStorageBehaviorConfiguration;
...
@interface MTRDeviceController : NSObject {
    ...
    struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } _deviceMapLock;
...
- (id)initWithFactory:(id)a0 queue:(id)a1 storageDelegate:(id)a2 storageDelegateQueue:(id)a3 otaProviderDelegate:(id)a4 otaProviderDelegateQueue:(id)a5 uniqueIdentifier:(id)a6 concurrentSubscriptionPoolSize:(unsigned long long)a7 storageBehaviorConfiguration:(id)a8;
