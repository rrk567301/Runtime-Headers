...
- (double)xpcConnectionActiveTimeoutSecondsWithDefaultValue:(double)a0;
- (unsigned long long)xpcConnectionCountLimitWithDefaultValue:(unsigned long long)a0;
- (double)xpcConnectionInactiveTimeoutSecondsWithDefaultValue:(double)a0;
- (unsigned long long)xpcConnectionMinimumCountWithDefaultValue:(unsigned long long)a0;
