...
@interface CKSQLiteTableGroup : CKSQLiteTableGroupEntry <CKSQLiteDatabaseKeyValueProperties> {
    struct { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } lock; _Atomic unsigned long long accessThread; } _serializerBacking;
    struct { struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x0; _Atomic unsigned long long x1; } *_serializer;
    BOOL _valid;
