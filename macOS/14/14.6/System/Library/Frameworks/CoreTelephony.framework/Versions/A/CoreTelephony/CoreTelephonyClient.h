...
- (id)retrieveDeviceIdentifier:(unsigned long long)a0 error:(id *)a1;
...
- (BOOL)_decodeCardData:(id)a0 smdp:(id *)a1 matchingID:(id *)a2 OID:(id *)a3;
...
- (void)addQRCodePlanWith:(id)a0 appType:(unsigned long long)a1 completionHandler:(id /* block */)a2;
...
- (void)checkPreFlightEligibility:(id)a0 mccs:(id)a1 mncs:(id)a2 gid1s:(id)a3 gid2s:(id)a4 smdpUrl:(id)a5 iccidPrefix:(id)a6 completion:(id /* block */)a7;
- (void)checkProfileEligibility:(id)a0 metadata:(id)a1 completion:(id /* block */)a2;
...
- (void)getActionForCardData:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)handleTermsAndConditionsCompleted:(id)a0 consented:(BOOL)a1 completion:(id /* block */)a2;
- (void)handleUserEnteredOtp:(id)a0 otp:(id)a1 completion:(id /* block */)a2;
...
- (BOOL)isAutofilleSIMIdAllowedForDomain:(id)a0 clientBundleIdentifier:(id)a1 error:(id *)a2;
- (BOOL)isAutofilleSIMIdAllowedForDomain:(id)a0 error:(id *)a1;
...
- (void)plansPendingCrossPlatformTransferWithCompletion:(id /* block */)a0;
...
- (void)renewOneTimePassword:(id)a0 completion:(id /* block */)a1;
...
- (void)retrieveAppListURLWithCompletion:(id /* block */)a0;
- (id)retrieveDeviceIdentifier:(unsigned long long)a0 clientBundleIdentifier:(id)a1 error:(id *)a2;
...
- (void)sendTravelBuddyCAEvent:(id)a0 carrierName:(id)a1 error:(id *)a2;
...
- (id)shouldShoweSIMTravelTip:(id *)a0;
- (void)simulateDataStall:(BOOL)a0 pdp:(int)a1 completion:(id /* block */)a2;
- (BOOL)smartDataMode:(id)a0 error:(id *)a1;
- (void)startPendingPlanInstallationForPlan:(id)a0 carrierName:(id)a1 completionHandler:(id /* block */)a2;
