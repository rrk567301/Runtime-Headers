...
- (void)_addPlaybackTargetPickerClient:(struct ObjectIdentifierGeneric<WebCore::PlaybackTargetClientContextIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x0; })a0;
...
- (void)_playbackTargetPickerClientStateDidChange:(struct ObjectIdentifierGeneric<WebCore::PlaybackTargetClientContextIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x0; })a0 state:(struct OptionSet<WebCore::MediaProducerMediaState> { unsigned int x0; })a1;
...
- (void)_removePlaybackTargetPickerClient:(struct ObjectIdentifierGeneric<WebCore::PlaybackTargetClientContextIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x0; })a0;
...
- (void)_showPlaybackTargetPicker:(struct ObjectIdentifierGeneric<WebCore::PlaybackTargetClientContextIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits> { unsigned long long x0; })a0 location:(const struct IntPoint { int x0; int x1; } *)a1 hasVideo:(BOOL)a2;
