@class ASPublicKeyCredentialBase, NSString, ASAuthorizationPublicKeyCredentialLargeBlobAssertionOutput, NSData;
...
- (id)_initWithBaseCredential:(id)a0 userID:(id)a1 signature:(id)a2 rawAuthenticatorData:(id)a3 largeBlob:(id)a4;
- (id)initWithCoreCredential:(id)a0;
- (void)populateExtensionsIfNeededFromCBOR:(id)a0 largeBlob:(id *)a1;
