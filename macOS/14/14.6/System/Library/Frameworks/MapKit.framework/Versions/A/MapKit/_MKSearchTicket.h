@class GEODirectionIntent, GEOMapServiceTraits, GEOMapRegion, MKMapItemIdentifier, NSString, GEOResultRefinementGroup, GEOPDPlaceSummaryLayoutMetadata, GEORelatedSearchSuggestion, GEOSearchAutoRedoThreshold, NSArray, GEOResolvedItem, GEOSearchSectionList, NSError, GEOCategorySearchResultSection;
