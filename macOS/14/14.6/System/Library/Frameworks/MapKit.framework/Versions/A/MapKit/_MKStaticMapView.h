@class NSMapTable, MKMapConfiguration, MKImageView, MKMapCamera, MKMapSnapshot, NSMutableArray, MKAnnotationView, NSString, MKMapSnapshotter, MKUserLocation, NSMutableOrderedSet, MKMapSnapshotOptions, NSArray, MKAnnotationContainerView, MKAnnotationManager;
