...
- (id)initWithDevice:(id)a0 arithmeticType:(int)a1 isSecondarySourceFilter:(BOOL)a2;
- (void)setSecondaryStrideInPixelsX:(unsigned long long)a0;
- (void)setSecondaryStrideInPixelsY:(unsigned long long)a0;
