@class NSTimer, NSString, SUCoreLog, NSMutableDictionary, MADAutoAssetPersisted, NSSet, NSMutableArray, NSObject;
...
@property (retain, nonatomic) NSSet *schedulerIntervalHeightenedAssetTypes;
@property (retain, nonatomic) NSSet *schedulerIntervalAggressiveAssetTypes;
...
- (void)_scheduleSelector:(id)a0 triggeringAtIntervalSecs:(long long)a1 withRemainingSecs:(long long)a2 forPushedJob:(BOOL)a3 forSetJob:(BOOL)a4 withSetPolicy:(id)a5 triggeringIfLearned:(BOOL)a6 resettingRemaining:(BOOL)a7;
