...
@interface AGXG14GFamilyRayTracingGPUBuilder : _MTLAccelerationStructureCommandEncoder <MTLAccelerationStructureCommandEncoderSPI> {
    void *_impl;
    id<MTLDevice> _device;
    _MTLCommandBuffer<MTLCommandBuffer> *_commandBuffer;
    id<MTLComputeCommandEncoderSPI> _computeEncoder;
    struct { } *_progressBins;
    BOOL virtualSubstreamsEnabled;
    BOOL virtualSubstreamOpen;
}
...
- (void)substreamSynchronizeAccelerationStructures:(id)a0 access:(unsigned long long)a1;
- (void)substreamSynchronizeDescriptor:(id)a0 access:(unsigned long long)a1;
