@class NSError, NSString, AGXG14FamilyRenderContext, __end_, __end_cap_, AGXG14FamilyComputeContext, NSMutableDictionary, NSDictionary, AGXG14FamilyBlitContext;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLFence, MTLCommandQueue;

@interface AGXG14FamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG14FamilyBlitContext *_previousBlitCommandEncoder;
    AGXG14FamilyComputeContext *_previousComputeCommandEncoder;
    AGXG14FamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG14FamilyTexture *, std::allocator<AGXG14FamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG14FamilyTexture **, std::allocator<AGXG14FamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
