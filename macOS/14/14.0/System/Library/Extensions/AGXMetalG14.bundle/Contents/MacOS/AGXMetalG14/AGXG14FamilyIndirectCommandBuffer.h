@class NSString, AGXG14FamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG14FamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG14FamilyBuffer *_buffer;
