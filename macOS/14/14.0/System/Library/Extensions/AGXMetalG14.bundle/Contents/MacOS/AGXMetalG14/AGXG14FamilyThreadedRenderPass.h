...
@interface AGXG14FamilyThreadedRenderPass : IOGPUMetalParallelRenderCommandEncoder <MTLParallelRenderCommandEncoderSPI> {
    void *_impl;
    NSObject<OS_dispatch_queue> *dispatchQueue;
    struct vector<AGXG14FamilyRenderContext *, std::allocator<AGXG14FamilyRenderContext *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG14FamilyRenderContext **, std::allocator<AGXG14FamilyRenderContext *>> { id *__value_; } x1; } _subOBJCRenderCommandEncoders;
