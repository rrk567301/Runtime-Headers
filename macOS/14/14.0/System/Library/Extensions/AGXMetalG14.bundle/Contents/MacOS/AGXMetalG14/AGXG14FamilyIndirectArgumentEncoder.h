@class NSString, AGXG14FamilyDevice, AGXG14FamilyBuffer;
@protocol MTLDevice;

@interface AGXG14FamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG14FamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG14FamilyBuffer *current_argument_buffer; } _impl;
}
