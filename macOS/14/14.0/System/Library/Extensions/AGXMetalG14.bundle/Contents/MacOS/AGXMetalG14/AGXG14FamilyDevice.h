@class MTLArchitecture, NSString, NSArray, AGXG14FamilyPerformanceStateAssertion, NSMutableDictionary, NSDictionary, NSObject, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSPointerArray;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface AGXG14FamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    void *_impl;
    ...
    struct { AGXG14FamilyPerformanceStateAssertion *existingAssertion; struct AGXA_UnfairLock { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } lock; } performance_state_assertion;
}
