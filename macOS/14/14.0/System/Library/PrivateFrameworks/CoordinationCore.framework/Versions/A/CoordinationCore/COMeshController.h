@class NSObject, NSDictionary, COMeshNodeStateTrackerSet, COMeshLocalNode, CODiscoveryManager, NSOrderedSet, COBallot, NSString, COIDSBrowser, CONodeManager, NSArray, COConstituent, CORapportBrowser, COBallotBrowser, COMeshNode;
