@class PXPhotosViewModel, PXMediaProvider, PXUpdater, PXAssetsDataSourceCountsController, PXExtendedTraitCollection, NSString, PXPhotosViewInteraction, PXPhotosLayout, NSUndoManager, PXPhotosContentInlinePlaybackController, UXView, PXGView, PXPhotosGridFooterPresentation, PXAssetReference, PXPhotosGridFooterStatusController;
