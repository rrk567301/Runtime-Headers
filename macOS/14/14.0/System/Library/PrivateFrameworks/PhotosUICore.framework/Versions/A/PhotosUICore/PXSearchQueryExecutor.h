@class PSIQuery, PXSearchQueryResultsProcessor, PLSearchProcessor, PXSearchQuery, PHPhotoLibrary, NSObject, NSDictionary;
...
- (BOOL)_shouldUseScopedSearchForQuery:(id)a0;
...
- (id)_queryTokenFromSearchSuggestion:(id)a0;
