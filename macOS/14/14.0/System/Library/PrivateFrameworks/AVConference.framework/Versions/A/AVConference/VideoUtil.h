...
+ (struct CGSize { double x0; double x1; })compute16AlignedResolutionForNativeWidth:(unsigned int)a0 nativeHeight:(unsigned int)a1 maxScreenPixelCount:(unsigned long long)a2;
