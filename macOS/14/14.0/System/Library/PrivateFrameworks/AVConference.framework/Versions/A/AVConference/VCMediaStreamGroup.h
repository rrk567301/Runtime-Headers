@class AVCStatisticsCollector, NSArray, NSString, VCNetworkFeedbackController, NSDictionary, VCSecurityKeyManager, VCMediaRecorder, NSObject, TimingCollection, VCMediaKeyIndex;
