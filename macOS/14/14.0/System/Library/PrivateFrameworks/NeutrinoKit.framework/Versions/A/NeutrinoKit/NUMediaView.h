@class NUScrollView, NSString, NSArray, NURenderView, NSView, NSTimer, PFCoalescer, NUAVPlayerView, NUComposition, NUMediaViewRenderer;
...
- (double)_currentDisplayHeadroomForScreen:(id)a0;
...
- (double)_maximumDisplayHeadroomForScreen:(id)a0;
