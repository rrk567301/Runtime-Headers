...
+ (id)simpleMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 shouldUpdateDisplayDate:(BOOL)a3 sortDescriptor:(id)a4 transformPredicate:(id /* block */)a5 ignoreMessageAdditionsPredicate:(id)a6;
...
+ (id)threadedMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 shouldUpdateDisplayDate:(BOOL)a3 sortDescriptor:(id)a4 transformPredicate:(id /* block */)a5 ignoreMessageAdditionsPredicate:(id)a6;
...
- (void)finishRecovery;
- (id)initWithMailboxes:(id)a0 repository:(id)a1 sortDescriptor:(id)a2 transformPredicate:(id /* block */)a3 ignoreMessageAdditionsPredicate:(id)a4 targetClass:(Class)a5 additionalQueryOptions:(unsigned long long)a6 shouldUpdateDisplayDate:(BOOL)a7 labelPrefix:(id)a8;
