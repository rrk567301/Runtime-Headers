@class NSURL, IDSDestination, NSUserActivity, NSDate, TUCallProvider, TUCallProviderManager, BSProcessHandle, NSString, NSArray, TUSenderIdentityClient, TUHandle, TUSenderIdentity, NSUUID;
