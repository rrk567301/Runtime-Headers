@class NSUUID, HMDAccount, NSObject, HMFExponentialBackoffTimer, HMDAppleAccountContext, HMDAppleAccountSettings, HMDDevice, HMDBackingStore, HMDWatchManager, HMDIDSActivityMonitorBroadcaster, HMDCloudCache, NSString, NSData, ACAccountStore, HMFTimer, NSNotificationCenter;
...
@property (retain, nonatomic) HMDWatchManager *watchManager;
...
- (BOOL)isDeviceLocallyPairedWatch:(id)a0;
