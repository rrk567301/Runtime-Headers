@class NSTextField, NSFont, NSString, NSStackView, NSImage, NSLayoutConstraint, NSImageView, NSButton;

@interface AMPEmptyStateLockup : NSView

@property (retain, nonatomic) NSStackView *contentStack;
@property (retain, nonatomic) NSImageView *iconImage;
