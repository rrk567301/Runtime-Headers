@class NSDictionary, PTGuidedFilter, PTQualitySettings, PTMetalContext, PTRaytracingUtils, PTRaytracingInterpolateResult, NSString, PTRenderDebugLayer, PTRenderEffectManager, PTPyramidRGB, PTColorConversion, PTUtil, PTGlobalReduction, PTMTLDropHints;
...
@interface PTRaytracingV3001 : NSObject <RenderingIntegration> {
    ...
    void /* unknown type, empty encoding */ _circleOfConfusionWeightMinMax;
