@class PTMetalContext, NSString, ANSTForegroundSegmentation, ANSTForegroundSegmentationResult;

@interface PTEffectPersonSegmentationCVL : NSObject <PTEffectPersonSegmentation> {
    PTMetalContext *_metalContext;
    ANSTForegroundSegmentation *_foregroundSegmentation;
    ANSTForegroundSegmentationResult *_result;
}
