...
- (id)initWithKeyboardLayout:(const void *)a0 currentLayoutCharacterKeysFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 shouldResample:(BOOL)a2;
