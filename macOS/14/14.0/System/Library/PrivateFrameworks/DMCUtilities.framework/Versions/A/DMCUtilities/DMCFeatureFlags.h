...
@property (class, readonly, nonatomic, getter=isAppleWellKnownEnabled) BOOL AppleWellKnownEnabled;
...
@property (class, readonly, nonatomic, getter=isMDAFirmwareVersionEnabled) BOOL MDAFirmwareVersionEnabled;
@property (class, readonly, nonatomic, getter=isMDAMDMManagedEnabled) BOOL MDAMDMManagedEnabled;
@property (class, readonly, nonatomic, getter=isMDAOSVersionEnabled) BOOL MDAOSVersionEnabled;
@property (class, readonly, nonatomic, getter=isMDAProductTypeEnabled) BOOL MDAProductTypeEnabled;
@property (class, readonly, nonatomic, getter=isMDASecureBootStatusEnabled) BOOL MDASecureBootStatusEnabled;
@property (class, readonly, nonatomic, getter=isMDASIPDisabledEnabled) BOOL MDASIPDisabledEnabled;
@property (class, readonly, nonatomic, getter=isMDAThirdPartyKextsAllowedEnabled) BOOL MDAThirdPartyKextsAllowedEnabled;
...
@property (class, readonly, nonatomic, getter=isOrgTokenEnabled) BOOL OrgTokenEnabled;
...
@property (class, readonly, nonatomic, getter=isWatchPairingTokenEnabled) BOOL WatchPairingTokenEnabled;
