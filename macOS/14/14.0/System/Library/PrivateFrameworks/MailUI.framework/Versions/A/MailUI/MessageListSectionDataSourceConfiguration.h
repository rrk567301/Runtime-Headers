@class NSString, MFSearchProgressView, MessageListViewControllerState, EMObjectID, MUIMessageListCollectionView, EMCachingContactStore, EFPromise, MessageListCellLayoutValuesHelper, EMMessageList;
