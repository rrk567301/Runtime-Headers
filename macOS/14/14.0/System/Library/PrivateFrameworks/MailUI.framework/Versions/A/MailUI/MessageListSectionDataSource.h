@class MessageListItemHelper, EFLocked, NSObject, EFPromise, MessageListCollectionHelper, MessageListViewControllerState, MessageListThreadHelper, MessageListCellLayoutValuesHelper, _TtC6MailUI28MUIMessageListCollectionView, NSString, EMMessageList, NSSet, EMCachingContactStore, NSMutableSet, EMObjectID;
