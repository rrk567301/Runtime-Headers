...
- (id)copyWithInputType:(long long)a0 resultTranscriptItems:(id)a1 conversationTranscriptItems:(id)a2 additionalPlatterTranscriptItems:(id)a3 serverUtterances:(id)a4 speechRecognitionHypothesis:(id)a5;
