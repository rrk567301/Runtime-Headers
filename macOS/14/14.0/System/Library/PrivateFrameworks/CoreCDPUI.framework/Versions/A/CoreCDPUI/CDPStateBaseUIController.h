...
- (void)_extractPasswordWithData:(id)a0 completion:(id /* block */)a1;
- (void)changeView:(id)a0;
- (void)promptForLocalAuthenticationWithMessage:(id)a0 completion:(id /* block */)a1;
- (void)promptForLocalSecretOldUIWithMessage:(id)a0 completion:(id /* block */)a1;
