@interface VideosUI.SearchTemplateController : VideosUI.VUIViewController <VideosUI.VUIDeeplinkURLHandlingInterceptor, VUIToolbarSearchFieldInteractingProtocol> {
