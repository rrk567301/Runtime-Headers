@class GKInvite, GKMatchRequest, NSObject, GKDispatchGroup, NSString, NSMutableArray, GKMatch;
@protocol GKRemoteViewController, GKMatchmakerViewControllerDelegate, OS_dispatch_queue, GKMatchDelegate;
