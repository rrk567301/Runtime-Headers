...
@interface IMDCKSyncController : IMDCKAbstractSyncController <IMDMessageSyncCoordinatorDelegate, IMDXPCEventStreamHandlerDelegate, IMSystemMonitorListener, IMDCKAbstractSyncControllerDelegate>
