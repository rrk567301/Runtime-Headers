...
@interface IMDNicknameController : NSObject <IMSystemMonitorListener, IDSServiceDelegate>
...
- (id)allNicknames;
- (void)allowHandlesForSharing:(id)a0 onChatGUIDs:(id)a1 fromHandle:(id)a2;
