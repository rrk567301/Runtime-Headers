...
- (id)predictionFromPlugin_battery_level:(double)a0 battery_duration_1:(double)a1 battery_duration_2:(double)a2 battery_duration_3:(double)a3 battery_duration_4:(double)a4 error:(id *)a5;
