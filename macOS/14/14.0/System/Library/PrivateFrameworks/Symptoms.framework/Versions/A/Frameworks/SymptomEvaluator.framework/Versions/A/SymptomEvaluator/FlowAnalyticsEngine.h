@class NSMutableDictionary, UsageAnalytics, NSDate, NSObject, NWStatsManager, NSString, AppAnalytics, ProcessAnalytics, FlowRefreshScheduler, CellularStateRelay, ObjectAnalytics, CoreTelephonyShim, NetworkAnalyticsStateRelay;
