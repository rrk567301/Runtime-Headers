@class AVPixelBufferAttributeMediator, NSMutableDictionary, AVApplicationStateMonitor, NSObject, NSDictionary, AVPlayerMediaSelectionCriteria, AVOutputContext, NSMutableArray, AVPlayerItem, AVQueuePlayer, NSString, AVPlayerPlaybackCoordinator, NSMutableSet, NSHashTable, NSArray, AVWeakReference, NSError, AVPlayerRateState;
