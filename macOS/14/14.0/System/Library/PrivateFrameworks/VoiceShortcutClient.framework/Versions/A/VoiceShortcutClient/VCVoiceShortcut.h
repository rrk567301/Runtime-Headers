...
- (id)initWithIdentifier:(id)a0 phrase:(id)a1 shortcutName:(id)a2 shortcutDescription:(id)a3 associatedAppBundleIdentifier:(id)a4 dateCreated:(id)a5 dateLastModified:(id)a6 lastRunDate:(id)a7 shortcut:(id)a8 keyImageData:(id)a9 error:(id *)a10;
