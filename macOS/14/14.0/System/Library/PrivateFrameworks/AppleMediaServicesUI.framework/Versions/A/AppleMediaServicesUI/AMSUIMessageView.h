@class NSView, NSAttributedString, AMSUICommonVisualEffectView, NSScrollView, NSArray, MicaPlayer, NSColor, AMSUICommonImageView, AMSDialogAction, NSImageView, AMSUIMessageViewLayoutContext, AMSUICommonTextView;
