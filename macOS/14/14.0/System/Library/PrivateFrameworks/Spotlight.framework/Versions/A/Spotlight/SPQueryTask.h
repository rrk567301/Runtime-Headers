@class NSMutableDictionary, SFSearchResult_SpotlightExtras, NSDictionary, NSObject, NSMutableArray, SPSearchQueryContext, NSString, SSBullseyeTopHitsManager, PRSRankingConfiguration, SPApplicationQuery, SPMetadataQuery, NSArray, SFStartLocalSearchFeedback, SFMutableResultSection, SSRankingManager, SPKQuery;
...
- (id)resultRankingFeedbackWithResult:(id)a0 duplicateResults:(id)a1 originalResultsId:(id)a2 responseKind:(int)a3;
- (id)sectionRankingFeedbackWithSections:(id)a0 duplicateResults:(id)a1 originalResultsId:(id)a2 responseKind:(int)a3;
- (id)sectionWithBundleId:(id)a0;
- (id)sectionWithBundleId:(id)a0;
- (void)sendRankingFeedbackForResultsArray:(id)a0 withSections:(id)a1 responseKind:(int)a2;
