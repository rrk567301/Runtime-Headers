...
- (id)initWithURL:(id)a0 iconSize:(struct CGSize { double x0; double x1; })a1 fallbackType:(unsigned long long)a2 iconDownloadingEnabled:(BOOL)a3;
...
- (id)_initWithURL:(id)a0 type:(unsigned long long)a1 iconSize:(struct CGSize { double x0; double x1; })a2 fallbackType:(unsigned long long)a3 isURLTypedByUser:(BOOL)a4 iconDownloadingEnabled:(BOOL)a5;
