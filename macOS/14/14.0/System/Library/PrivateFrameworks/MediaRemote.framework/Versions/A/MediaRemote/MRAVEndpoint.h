@class NSString, MRExternalDevice, MRAVOutputDevice, NSArray, MROutputContextDataSource, NSDictionary, _MRAVEndpointDescriptorProtobuf, MRGroupSessionInfo, MROrigin;
