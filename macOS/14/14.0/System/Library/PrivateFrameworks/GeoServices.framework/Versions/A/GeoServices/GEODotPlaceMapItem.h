@class NSDate, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOEnrichmentData, GEOEVCharger, GEOMapRegion, GEOMuninViewState, NSData, GEOPlace, GEOEnclosingPlace, GEOStorefrontPresentationInfo, GEOEnrichmentInfo, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEODotPlace, GEOInlineRapEnablement, GEOPlacecardLayoutData, GEOViewportFrame, GEOPOIClaim, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOStyleAttributes, GEOStorefrontInfo, NSString, NSTimeZone, GEOTooltip, GEOTrailHead, GEOMapItemPhotosAttribution, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEORestaurantFeaturesLink, GEOBusinessAssets, GEOPDPlace, GEOPriceDescription, GEOAddress;
