...
@interface GEOCompanionWaypoint : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_isCurrentLocation : 1; unsigned char read_findMyHandleID : 1; unsigned char read_mapItem : 1; unsigned char read_searchString : 1; unsigned char read_waypointTyped : 1; unsigned char wrote_anyField : 1; } _flags;
}
