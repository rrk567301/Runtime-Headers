@class NSUUID, HMDHAPAccessory, HMDCameraStreamManagerSession, HMDService, NSString, HMDCameraResidentMessageHandler, HMDCameraSupportedConfigurationCache, HMDCameraStreamSnapshotHandler, NSObject, HMFMessageDispatcher, HMFNetMonitor, HMDDynamicActivityAttributionPublisher;
