...
+ (void)sendMemoriesSelectedPhotosSharingFilter:(id)a0;
+ (void)sendMemoriesSelectedPhotosSourceFilter:(id)a0;
+ (void)sendMemoriesStartedEventWithUserAction:(BOOL)a0;
+ (void)sendMemoriesSwipeEventWithDirection:(id)a0;
+ (void)sendMemoriesToBePlayedWithCount:(unsigned long long)a0 photosSourceFilter:(id)a1 photosSharingFilter:(id)a2;
+ (void)sendMusicTrackSeekedOverAerialsEventWithDirection:(id)a0;
+ (void)sendScreenSaverActivatedType:(id)a0;
