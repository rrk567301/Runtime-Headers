...
- (id)fetchAllAssetsWithAssetURLMapping:(id)a0 localizedStringsBundle:(id)a1 preferredLocalizations:(id)a2 error:(id *)a3;
- (id)fetchAllAssetsWithError:(id *)a0;
- (id)fetchAllAssetsWithSortDescriptors:(id)a0 error:(id *)a1;
- (id)fetchAllCategoriesWithAssetURLMapping:(id)a0 localizedStringsBundle:(id)a1 preferredLocalizations:(id)a2 error:(id *)a3;
