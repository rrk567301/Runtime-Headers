@class TVISAerialServiceConfiguration, TVISAerialServiceDefaults, TVISReachabilityMonitor, NSString, NSObject, TVISAerialStore;
...
- (void)_downloadAsset:(id)a0 parentProgress:(id)a1 synchronously:(BOOL)a2 completion:(id /* block */)a3;
...
- (id)purgeableInfoForUrgency:(long long)a0;
