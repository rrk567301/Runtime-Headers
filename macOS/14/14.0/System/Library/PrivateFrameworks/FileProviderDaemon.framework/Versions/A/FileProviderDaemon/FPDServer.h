@class FPDPresenterManager, NSString, FPDVolumeManager, FPDActionOperationEngine, FPDTelemetryService, FPDAppMonitor, FPDCacheDeleteService, FPDExtensionManager, NSXPCListener, NSObject, FPPacer;
