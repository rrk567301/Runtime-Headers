...
@interface STMediaStatusDomainDataDiff : NSObject <BSDebugDescriptionProviding, STStatusDomainDataDiff> {
    STListDataDiff *_audioRecordingAttributionListDataDiff;
    STListDataDiff *_mutedAudioRecordingAttributionListDataDiff;
...
- (id)initWithAudioRecordingAttributionListDataDiff:(id)a0 mutedAudioRecordingAttributionListDataDiff:(id)a1 cameraAttributionListDataDiff:(id)a2;
