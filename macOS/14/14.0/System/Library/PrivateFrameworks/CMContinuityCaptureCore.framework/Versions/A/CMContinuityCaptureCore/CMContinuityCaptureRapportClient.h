...
@interface CMContinuityCaptureRapportClient : CMContinuityCaptureRapportTransportBase <ContinuityCaptureDeviceClient> {
    ...
    _Atomic long long _sessionAssertionTimeoutInSec;
    _Atomic BOOL _suspended;
    id /* block */ _sessionAssertionReevaluateBlock;
...
@property (nonatomic) long long sessionAssertionTimeoutInSec;
...
- (void)scheduleTerminateReevaluationBlock;
