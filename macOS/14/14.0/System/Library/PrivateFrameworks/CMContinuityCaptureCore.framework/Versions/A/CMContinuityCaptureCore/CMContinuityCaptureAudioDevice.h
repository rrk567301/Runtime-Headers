@class AVCAudioStream, NSString, AVCStreamOutput, CMContinuityCaptureSynchronizedAudioNetworkTimestamp, CMContinuityCaptureLocalFrameLatencyMetrics, CMContinuityCaptureMagicStateMonitor;
...
@interface CMContinuityCaptureAudioDevice : CMContinuityCaptureDeviceBase <AVCAudioStreamDelegate, AVCStreamOutputDelegate> {
    ...
    CMContinuityCaptureSynchronizedAudioNetworkTimestamp *_cachedSynchronizedNetworkTimestamp;
}
...
- (void)sendCachedSynchronizedNetworkTimestampIfApplicable;
