@class ICTTMergeableStringVersionedDocument, NSNumber, NSMutableArray, NSString, NSArray, ICAccount, ICNoteData, CKRecord, NSSet, NSData, CSSearchableItemAttributeSet, ICTTVectorMultiTimestamp, ICAttachment, ICMergeableDictionary, ICFolder, NSUUID, NSManagedObjectContext, NSURL, NSDate, NSManagedObjectID, CKRecordID;
