@class NSURL, ECSignatureInfo, ECSubject, MFMailbox, NSDate, NSDictionary, ECMessageFlags, MFMailAccount, NSString, MFLibraryCalendarEvent, EMFollowUp, ECAngleBracketIDHash, NSSet, NSArray, NSData, EMReadLater, MFLibraryStore, NSUUID;
