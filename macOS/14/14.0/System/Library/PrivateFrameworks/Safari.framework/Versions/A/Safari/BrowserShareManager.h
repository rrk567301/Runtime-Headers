@class NSMenu, NSString, NSPreviewRepresentingActivityItem, NSMutableDictionary, NSMutableSet, NSImage, NSWindow, NSSharingServicePicker, NSMapTable;
...
@property (readonly, nonatomic) BOOL shareMenuShouldBeEnabled;
