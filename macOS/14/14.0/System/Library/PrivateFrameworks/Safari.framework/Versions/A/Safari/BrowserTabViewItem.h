@class NSDictionary, WBTab, WBSSiriIntelligenceDonorPersonalizationData, BrowserWindowController, ContinuousReadingListViewController, WBProfile, FormTextStatusWatcher, NSMutableArray, NSString, NSImageView, UnifiedTabBarItem, NSArray, NSMutableDictionary, NSTimer, NSColor, NSSet, BrowserTabViewController, NSLayoutConstraint, WBSWebExtensionTabPosition, SearchState, BrowserViewController, NSView, WBSTranslationContext, DelayedPopUpRolloverImageButton, NSImage, WKWebView, NSUUID, NSURL, TabContentViewController, WBSHostTabProvider;
...
@property (readonly, nonatomic) BOOL didFireOnCreatedEvent;
