...
+ (BOOL)updateIconWithImages:(id)a0 forBundle:(id)a1;
+ (id)updateAndReturnIconWithImages:(id)a0 forBundle:(id)a1;

- (id)init;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)_createAppIconWithManifest:(id)a0 forBundleAtURL:(id)a1 completionHandler:(id /* block */)a2;
- (void)_didFailToGenerateWebAppAtURL:(id)a0 reason:(id)a1 completionHandler:(id /* block */)a2;
- (void)_generateIconWithImages:(id)a0 forBundle:(id)a1 completionHandler:(id /* block */)a2;
