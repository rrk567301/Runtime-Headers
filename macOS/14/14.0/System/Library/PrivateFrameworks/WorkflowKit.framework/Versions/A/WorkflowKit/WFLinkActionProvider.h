...
- (id)appDescriptorForActionRequest:(id)a0;
- (id)appDescriptorForActionRequest:(id)a0 availableActions:(id)a1 availableEntities:(id)a2 fullyQualifiedIdentifier:(id *)a3;
...
- (id)resolvedActionIdentifiersForActionRequests:(id)a0 availableActions:(id)a1 availableEntities:(id)a2;
