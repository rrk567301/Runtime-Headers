@class VKAnchorWrapper, NSColor, MKUserLocationAnnotationViewProxy, _MKAnnotationViewCustomFeatureAnnotation, _MKStaticMapView, NSMutableArray, NSImage, NSString, _MKKVOProxy, CALayer, MKCalloutView, _MKAnnotationViewAnchor, NSView, GEORouteMatch, MKUsageCounter;
