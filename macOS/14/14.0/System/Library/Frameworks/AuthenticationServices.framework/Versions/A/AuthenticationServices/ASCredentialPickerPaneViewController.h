@class ASCAuthorizationPresentationContext, NSString, NSArray, AKASAuthorizationProvider, ASCredentialRequestInfoLabelSubPane, ASCredentialRequestImageSubPane, NSObject, NSWindow, _ASCredentialAuthenticationViewController, ASCredentialRequestConfirmButtonSubPane, ASCPasswordCredential;
@protocol OS_dispatch_queue, ASCLoginChoiceProtocol, OS_os_activity;

@interface ASCredentialPickerPaneViewController : ASCredentialRequestPaneViewController <_ASCredentialAuthenticationViewControllerDelegate, _ASAuthenticationPresentationProvider, ASCredentialRequestSubPaneConfirmButtonDelegate, NSTableViewDataSource> {
