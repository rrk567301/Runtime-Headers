@class CNContactStore, NSMutableDictionary, CNAvatarImageRenderer, AOSUIProfilePictureStore, ACAccountStore, _ASAccountSharingGroupMemberData;
...
- (id)groupMemberDataForAutocompleteResults:(id)a0;
