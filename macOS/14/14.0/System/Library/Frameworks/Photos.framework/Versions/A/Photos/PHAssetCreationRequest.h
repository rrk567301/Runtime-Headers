@class NSMutableDictionary, PHAssetResourceBag, PHMomentShare, NSDictionary, PHAssetCreationPhotoStreamPublishingRequest, NSMutableArray, PHAssetCreationDerivativeContext, PHAssetCreationAdjustmentBakeInOptions, PHRelationshipChangeRequestHelper, NSString, NSManagedObjectID, PLIndicatorFileCoordinator, PHAssetCreationMetadataCopyOptions, NSNumber, PHAssetCreationCameraIngestOptions;
