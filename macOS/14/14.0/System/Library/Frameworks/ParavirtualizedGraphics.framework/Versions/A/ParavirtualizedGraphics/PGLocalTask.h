...
@protocol MTLComputePipelineState, PGDeserializer, MTLDevice;
...
@interface PGLocalTask : PGBaseTask <PGKernelTask, PGUserTask, PGTask_Resource> {
    ...
    struct { unsigned char x0 : 8; unsigned int x1 : 24; unsigned long long x2; } *_objectList;
    ...
    struct { unsigned int x0; unsigned int x1; unsigned long long x2; unsigned int x3; unsigned long long x4; } *_taskRoot;
...
- (void)mapObjectList;
- (void *)mappedAddressForOffset:(unsigned long long)a0 length:(unsigned long long)a1;
- (void *)mappedAddressForPageNumber:(unsigned int)a0 length:(unsigned long long)a1;
- (id)newBackingForReference:(unsigned int)a0;
- (id)newSharedTextureBackingForReference:(unsigned int)a0;
