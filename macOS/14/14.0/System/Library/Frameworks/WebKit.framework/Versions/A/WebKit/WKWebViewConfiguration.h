@class NSString, NSArray, _WKApplicationManifest, NSSet, WKProcessPool, WKPreferences, WKUserContentController, _WKWebExtensionController, WKWebpagePreferences, _WKVisitedLinkStore, WKWebsiteDataStore, WKWebView;
...
@interface WKWebViewConfiguration : NSObject <NSSecureCoding, NSCopying> {
    ...
    struct WKRetainPtr<const OpaqueWKPageGroup *> { struct OpaqueWKPageGroup *m_ptr; } _pageGroup;
