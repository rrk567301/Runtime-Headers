@class NSFont, LPPointUnit, LPVisualMediaViewStyle, LPContactsBadgeStyle, LPCaptionBarStyle, NSColor, LPAppearanceDependentValue, LPQuotedTextViewStyle, LPLinkRendererSizeClassParameters, LPImageViewStyle, LPTapToLoadViewStyle;
