...
- (void)authenticationViewModel:(id)a0 biometryIsActive:(BOOL)a1;
- (void)authenticationViewModel:(id)a0 biometryIsRunning:(BOOL)a1;
- (void)authenticationViewModel:(id)a0 succeededWithBiometry:(BOOL)a1;
- (void)authenticationViewModel:(id)a0 watchIsActive:(BOOL)a1;
- (void)authenticationViewModelBecameAvailable:(id)a0;
- (void)authenticationViewModelDidReceiveBiometryNoMatch:(id)a0;
- (void)authenticationViewModelIdles:(id)a0;
