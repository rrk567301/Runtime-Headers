@class NSTimer, NSMenuBarImpl, NSMenuBarTrackingSession;

@interface NSMenuBarPresentationInstance : NSObject {
    NSTimer *_autoShowHideTimer;
...
+ (void)_forceAutoShowMenuBarIfAllowed;
...
+ (void)forEachMenuBarDo:(id /* block */)a0;
...
- (void)_appendMenuTitleBounds:(id)a0 forWindow:(id)a1;
- (double)_atRestHeightForDisplay:(unsigned int)a0;
- (void)_autoShowHideTimer:(id)a0;
- (void)_calcBounds;
- (struct __CFArray { } *)_createMenuTitlesArrayForWindow:(id)a0;
...
- (BOOL)_hasAutoShow;
- (void)_hide:(long long)a0 shouldNotify:(BOOL)a1 inOrder:(BOOL)a2 outCallerMustEnableBarAutoShowAsDesired:(BOOL *)a3 requestVisibility:(BOOL)a4;
- (double)_hideWindow:(long long)a0 inOrder:(BOOL)a1;
...
- (void)_replicantWindows:(unsigned int[4])a0 forHostingWindow:(id)a1;
...
- (void)_show:(long long)a0 shouldNotify:(BOOL)a1 inOrder:(BOOL)a2 forAutoShow:(BOOL)a3 requestVisibility:(BOOL)a4;
