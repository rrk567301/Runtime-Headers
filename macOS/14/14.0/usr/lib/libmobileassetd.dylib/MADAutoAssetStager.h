@class NSString, SUCoreFSM, MADAutoAssetDescriptor, SUCoreLog, MADAutoAssetPersisted, NSDictionary, NSArray, MADAutoAssetClientRequest, NSMutableArray, NSMutableDictionary, MANAutoAssetControlStatisticsByCommand, MANAutoAssetControlStatisticsBySize;
