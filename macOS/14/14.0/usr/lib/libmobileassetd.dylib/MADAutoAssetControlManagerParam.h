@class MAAutoAssetProgress, MADAutoAssetClientRequest, MADAutoAssetJobInformation, MADAutoAssetJob, NSDictionary, MADAutoSetJobInformation, SUCoreConnectMessage, MAAutoAssetStatus, NSString, NSArray, MAAutoAssetSelector, MADAutoAssetDescriptor, NSError, SUCoreConnectClientProxy;
...
- (id)initWithParamType:(long long)a0 withSafeSummary:(id)a1 withClientID:(id)a2 withClientRequestMessage:(id)a3 withClientProgressProxy:(id)a4 withClientReplyCompletion:(id /* block */)a5 withResponseMessage:(id)a6 withResponseError:(id)a7 withDownloadsInFlight:(id)a8 withAutoAssetJobID:(id)a9 withAutoAssetCatalog:(id)a10 withLockForUseError:(id)a11 withFinishedError:(id)a12 withDownloadProgress:(id)a13 withJobCurrentStatus:(id)a14 withAutoAssetSelector:(id)a15 withAutoAssetUUID:(id)a16 withSetOfAutoAssetSelectors:(id)a17 withPushNotifications:(id)a18 withAssetTargetOSVersion:(id)a19 withAssetTargetBuildVersion:(id)a20 withStagedToDownloaded:(id)a21 withDownloadingDescriptor:(id)a22 withBaseForPatchDescriptor:(id)a23 withSchedulerInvolved:(BOOL)a24 withPotentialNetworkFailure:(BOOL)a25 withClientDomainName:(id)a26 withAssetSetIdentifier:(id)a27 withSetAtomicInstance:(id)a28 withSetJobInformation:(id)a29 withTriggeredSets:(id)a30;
