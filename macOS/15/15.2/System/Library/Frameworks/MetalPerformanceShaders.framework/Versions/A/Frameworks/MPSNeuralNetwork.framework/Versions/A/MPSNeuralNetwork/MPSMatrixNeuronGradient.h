...
- (void)encodeToCommandBuffer:(id)a0 gradientMatrix:(id)a1 inputMatrix:(id)a2 biasVector:(id)a3 resultGradientForDataMatrix:(id)a4 resultGradientForBiasVector:(id)a5;
