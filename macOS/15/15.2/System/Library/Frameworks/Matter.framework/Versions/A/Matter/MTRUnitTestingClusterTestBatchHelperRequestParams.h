...
@property (copy, nonatomic) NSNumber *sleepBeforeResponseTimeMs;
@property (copy, nonatomic) NSNumber *sizeOfResponseBuffer;
@property (copy, nonatomic) NSNumber *fillCharacter;
