@interface WKRotationCoordinatorObserver : NSObject {
    ...
    struct HashMap<WTF::String, WTF::RetainPtr<AVCaptureDeviceRotationCoordinator>, WTF::DefaultHash<String>, WTF::HashTraits<String>, WTF::HashTraits<WTF::RetainPtr<AVCaptureDeviceRotationCoordinator>>, WTF::HashTableTraits> { struct HashTable<WTF::String, WTF::KeyValuePair<WTF::String, WTF::RetainPtr<AVCaptureDeviceRotationCoordinator>>, WTF::KeyValuePairKeyExtractor<WTF::KeyValuePair<WTF::String, WTF::RetainPtr<AVCaptureDeviceRotationCoordinator>>>, WTF::DefaultHash<String>, WTF::HashMap<WTF::String, WTF::RetainPtr<AVCaptureDeviceRotationCoordinator>>::KeyValuePairTraits, WTF::HashTraits<String>> { union { void *m_table; unsigned int *m_tableForLLDB; } ; } m_impl; } m_coordinators;
}
