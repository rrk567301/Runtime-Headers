@interface WKIntelligenceTextEffectCoordinator : NSObject {
    ...
    void /* unknown type, empty encoding */ activePonderingEffect;
    void /* unknown type, empty encoding */ activeReplacementEffect;
    void /* unknown type, empty encoding */ replacementQueue;
    void /* unknown type, empty encoding */ onFlushCompletion;
    void /* unknown type, empty encoding */ suppressEffectView;
}
