...
- (id)initWithSession:(id)a0 identifier:(unsigned long long)a1 request:(id)a2 targetDispatcher:(struct RefCountedSerialFunctionDispatcher { void /* function */ **x0; } *)a3;
