@class TKPowerMonitor, NSMapTable, NSObject, TKSmartCardSessionEngine, NSMutableArray, TKSmartCardATR, NSString, TKSlotParameters, NSHashTable, NSXPCListenerEndpoint, NSXPCListener, NSNumber, NSXPCConnection;
