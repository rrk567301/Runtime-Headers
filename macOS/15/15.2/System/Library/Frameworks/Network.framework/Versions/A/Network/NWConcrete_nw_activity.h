...
@interface NWConcrete_nw_activity : NSObject <OS_nw_activity> {
    ...
    struct retained_ptr<NWConcrete_nw_activity *> { NWConcrete_nw_activity *m_obj; unsigned char m_should_release : 1; unsigned char __pad_bits : 7; unsigned char __pad_bytes[7]; } parent;
    ...
    struct description_cache { struct retained_ptr<NSString *> { NSString *m_obj; unsigned char m_should_release : 1; unsigned char __pad_bits : 7; unsigned char __pad_bytes[7]; } description; struct unfair_mutex { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } m_mutex; } mutex; unsigned char __pad[4]; } description_cache;
    unsigned int label;
    unsigned int domain;
