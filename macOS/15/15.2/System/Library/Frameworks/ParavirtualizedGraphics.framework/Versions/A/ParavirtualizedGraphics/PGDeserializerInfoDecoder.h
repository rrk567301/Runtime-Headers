...
+ (unsigned long long)rasterizationRateMapInfoReplySizeForLayerCount:(unsigned long long)a0;
...
- (void)decodeHeapTexturDescriptorSizeAndAlignWithIterator:(struct PGByteIterator { void *x0; unsigned long long x1; unsigned long long x2; } *)a0;
