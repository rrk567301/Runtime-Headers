...
+ (void)_populateSingleValueKeysForDiff:(id)a0 compareUIVisiblePropertiesOnly:(BOOL)a1;
...
+ (void)_populateMultiValueRelationshipKeysForDiff:(id)a0 compareUIVisiblePropertiesOnly:(BOOL)a1;
+ (void)_populateSingleValueRelationshipKeysForDiff:(id)a0 compareUIVisiblePropertiesOnly:(BOOL)a1;
