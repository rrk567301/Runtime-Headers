...
- (BOOL)checkNodeForValidChannelLayouts:(id)a0 assetRegistry:(id)a1 outError:(id *)a2;
...
- (BOOL)processNode:(id)a0 withArray:(id)a1 assetRegistry:(id)a2 outError:(id *)a3;
