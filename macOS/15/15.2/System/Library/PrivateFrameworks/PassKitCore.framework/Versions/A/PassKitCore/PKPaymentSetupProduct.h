...
@property (readonly, copy, nonatomic) NSArray *provisioningMethods;
...
- (void)addProvisioningMethod:(id)a0;
- (void)addProvisioningMethodType:(unsigned long long)a0;
...
- (BOOL)supportsProvisioningMethodForType:(unsigned long long)a0;
