...
- (id)initWithCertificate:(struct __SecCertificate { } *)a0 signatureAlgorithm:(id)a1 useIssuerAndSerialNumber:(BOOL)a2 error:(id *)a3;
...
- (id)getAttributesWithType:(id)a0 protectedAttributes:(BOOL)a1;
...
- (id)initWithIdentity:(struct __SecIdentity { } *)a0 signatureAlgorithm:(id)a1 useIssuerAndSerialNumber:(BOOL)a2 error:(id *)a3;
- (BOOL)sign:(id *)a0;
...
- (BOOL)verifyTimestamps:(BOOL)a0 error:(id *)a1;
