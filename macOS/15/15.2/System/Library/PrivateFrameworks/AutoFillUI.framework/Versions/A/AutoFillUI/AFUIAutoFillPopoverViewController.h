...
@property (retain, nonatomic) NSViewController *customContentViewController;
...
- (void)_presentCustomContentViewController;
- (void)_presentViewControllerForAutoFillMode:(unsigned long long)a0;
- (id)initWithDocumentTraits:(id)a0 documentState:(id)a1 customContentViewController:(id)a2;
