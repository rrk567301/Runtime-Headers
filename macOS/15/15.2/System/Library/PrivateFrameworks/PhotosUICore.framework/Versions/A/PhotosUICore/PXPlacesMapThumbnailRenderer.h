...
- (id)initWithTraitCollection:(id)a0 informationDelegate:(id)a1 popoverImageType:(long long)a2 popoverImageOptions:(unsigned long long)a3 countLabelStyle:(long long)a4 thumbnailCurationDelegate:(id)a5;
