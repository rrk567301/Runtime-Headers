...
@interface HomeKitEvents.QueryLogEvent : HMMLogEvent <HMMCoreAnalyticsLogging> {
    void /* unknown type, empty encoding */ subqueriesEnabled;
    void /* unknown type, empty encoding */ queryStartTime;
    ...
    void /* unknown type, empty encoding */ ckQueryExecutionStartTime;
    void /* unknown type, empty encoding */ ckQueryExecutionEndTime;
