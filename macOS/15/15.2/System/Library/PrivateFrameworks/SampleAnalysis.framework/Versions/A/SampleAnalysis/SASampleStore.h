@class SAFrame, NSMutableDictionary, SATimestamp, SAMountStatusTracker, NSDictionary, SABinaryLocator, SAWSUpdateDataStore, NSMutableArray, NSString, SASharedCache, SATask, NSMutableSet, NSArray, SATimeRange, NSError;
