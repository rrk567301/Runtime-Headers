...
@interface CPKPopoverController : NSViewController <CPKCharactersViewDelegate, CPKCharactersViewDataSource, CPKSearchViewDelegate, NSSearchFieldDelegate, NSWindowDelegate, CPKGenerationUIRemoteProtocol> {
