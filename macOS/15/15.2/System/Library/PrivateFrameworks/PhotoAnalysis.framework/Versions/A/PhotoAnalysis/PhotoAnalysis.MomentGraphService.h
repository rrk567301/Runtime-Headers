@class NSNumber, NSString, NSDictionary, NSData, NSError, NSArray, NSSet;
...
- (void)requestLocationRetrievalResultsWithQueryTokenAsData:(NSData *)a0 operationID:(NSString *)a1 reply:(void (^)(NSData *, NSError *))a2;
- (void)requestMeaningsForMomentUUIDs:(NSSet *)a0 operationID:(NSString *)a1 reply:(void (^)(NSDictionary *, NSError *))a2;
- (void)requestPersonRelationshipByUUIDForPersonUUIDs:(NSSet *)a0 operationID:(NSString *)a1 reply:(void (^)(NSDictionary *, NSError *))a2;
- (void)requestPersonalEventAssetsForQueryTokenAsData:(NSData *)a0 associatedPersonUUID:(NSString *)a1 scopedAssetUUIDs:(NSSet *)a2 momentUUIDByAssetUUID:(NSDictionary *)a3 retrievalResultsByQueryTokenAsData:(NSData *)a4 operationID:(NSString *)a5 reply:(void (^)(NSData *, NSError *))a6;
