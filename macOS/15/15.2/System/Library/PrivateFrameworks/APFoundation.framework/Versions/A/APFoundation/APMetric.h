...
- (id)initWithPurpose:(long long)a0 metric:(long long)a1 contentIdentifier:(id)a2 contextIdentifier:(id)a3 handle:(id)a4 branch:(id)a5 properties:(id)a6 internalProperties:(id)a7 relayData:(id)a8 environment:(id)a9 order:(long long)a10 options:(long long)a11;
