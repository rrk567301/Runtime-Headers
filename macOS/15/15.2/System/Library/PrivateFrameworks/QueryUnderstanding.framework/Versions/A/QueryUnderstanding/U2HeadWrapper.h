...
- (id)getU2PredictionsForEmbedding:(id)a0 queryString:(id)a1 spans:(id)a2 tokens:(id)a3 tokenRanges:(id)a4 subtokenLenForTokens:(id)a5 subtokens:(id)a6 error:(id *)a7;
