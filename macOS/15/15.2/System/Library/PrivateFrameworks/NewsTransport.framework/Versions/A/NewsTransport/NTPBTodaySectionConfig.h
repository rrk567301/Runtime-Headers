...
@interface NTPBTodaySectionConfig : PBCodable <NSCopying> {
    ...
    struct { unsigned char cachedResultCutoffTime : 1; unsigned char fallbackOrder : 1; unsigned char interSectionFilteringOptions : 1; unsigned char intraSectionFilteringOptions : 1; unsigned char maximumStoriesAllocation : 1; unsigned char minimumStoriesAllocation : 1; unsigned char paywalledStoriesMaxCount : 1; unsigned char personalizedPresenceFeatureClickPrior : 1; unsigned char personalizedPresenceFeatureImpressionPrior : 1; unsigned char seenArticlesMinimumTimeSinceFirstSeenToFilter : 1; unsigned char promotionCriterion : 1; unsigned char readArticlesFilterMethod : 1; unsigned char sectionType : 1; unsigned char seenArticlesFilterMethod : 1; unsigned char filterNonSubscribedInFavoritesOnlyMode : 1; unsigned char glanceable : 1; unsigned char presenceDeterminedByPersonalization : 1; unsigned char shownInFavoritesOnlyMode : 1; } _has;
}
