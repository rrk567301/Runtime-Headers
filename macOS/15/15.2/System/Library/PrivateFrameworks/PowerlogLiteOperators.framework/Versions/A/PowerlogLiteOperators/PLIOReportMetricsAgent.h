...
- (void)logInit;
- (struct IOReportGroupChecks { BOOL x0; BOOL x1; BOOL x2; })initGroupChecks;
- (BOOL)allowlistedChannel:(id)a0;
- (id)buildBaseSet:(struct IOReportGroupChecks { BOOL x0; BOOL x1; BOOL x2; } *)a0;
- (id)buildScreenStateSet:(struct IOReportGroupChecks { BOOL x0; BOOL x1; BOOL x2; } *)a0;
- (id)buildSnapshotSet:(struct IOReportGroupChecks { BOOL x0; BOOL x1; BOOL x2; } *)a0;
