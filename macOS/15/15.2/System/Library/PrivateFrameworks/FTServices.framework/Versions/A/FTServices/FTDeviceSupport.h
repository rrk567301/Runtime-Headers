...
@property (readonly, nonatomic) BOOL supportsManateeActivitySharing;
...
@property (readonly, nonatomic) BOOL supportsEmojiImages;
@property (readonly, nonatomic) BOOL supportsHomeKitResident;
@property (readonly, nonatomic) BOOL supportsStewie;
