@class CertificateSheetViewController, NSString, PopupWindowUnifiedFieldViewController, BrowserViewController, PopupWindowUnifiedField, NSTitlebarAccessoryViewController, NSWindow;

@interface FullscreenUnifiedFieldWindowController : NSController <UnifiedFieldDelegate, CertificateSheetViewControllerDelegate> {
