@class NSMutableDictionary, WiFiUsageInterfaceStats, NSDate, WiFiUsageBssSession, WiFiUsageNetworkIPv4Details, NSObject, NSMutableArray, WiFiUsageInterfaceCapabilities, NSString, WiFiUsageNetworkDetails, WiFiUsageNetworkIPv6Details, NSMutableSet, NSNumber, WiFiUsageSessionCAConfig, WiFiUsageSessionLQM;
@protocol OS_dispatch_queue;

@interface WiFiUsageSession : NSObject <NSCopying> {
    unsigned long long _perClientScanCount[27];
    unsigned long long _faultReasonCount[34];
    unsigned long long _joinReasonCount[15];
    unsigned long long _savedJoinReasonCount[15];
    unsigned long long _disconnectReasonCount[1034];
