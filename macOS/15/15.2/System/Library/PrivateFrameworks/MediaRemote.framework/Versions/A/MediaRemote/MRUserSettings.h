...
@property (readonly, nonatomic) BOOL useRSEForProximity;
@property (readonly, nonatomic) BOOL disablePairedDeviceActiveEndpointSync;
...
@property (readonly, nonatomic) BOOL groupSessionASEAssertionEnabled;
