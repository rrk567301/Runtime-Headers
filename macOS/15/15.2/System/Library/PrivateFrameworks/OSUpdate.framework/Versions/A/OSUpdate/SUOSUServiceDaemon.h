@class NSMutableDictionary, SUOSUNotificationManagerController, SUOSUAuthenticationManager, NSDictionary, NSObject, NSMutableArray, SUOSUManagedServiceDaemon, SUOSUScheduler, NSString, NSXPCListener, NSArray, SUMacControllerOverrides, SUOSUMobileSoftwareUpdateController, SUOSULoginCredentialPolicyManager;
