...
+ (id)simpleMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 countOfItemsToPrecache:(unsigned long long)a3 shouldUpdateDisplayDate:(BOOL)a4 sortDescriptors:(id)a5 transformPredicate:(id /* block */)a6 ignoreMessageAdditionsPredicate:(id)a7 shouldShowBundle:(BOOL)a8;
...
+ (id)threadedMessageListForMailboxes:(id)a0 withRepository:(id)a1 additionalQueryOptions:(unsigned long long)a2 countOfItemsToPrecache:(unsigned long long)a3 shouldUpdateDisplayDate:(BOOL)a4 sortDescriptors:(id)a5 sectionPredicates:(id)a6 transformPredicate:(id /* block */)a7 ignoreMessageAdditionsPredicate:(id)a8 shouldShowBundle:(BOOL)a9;
...
- (void)finishRecovery;
- (id)initWithMailboxes:(id)a0 repository:(id)a1 sortDescriptors:(id)a2 sectionPredicates:(id)a3 transformPredicate:(id /* block */)a4 ignoreMessageAdditionsPredicate:(id)a5 targetClass:(Class)a6 additionalQueryOptions:(unsigned long long)a7 countOfItemsToPrecache:(unsigned long long)a8 shouldUpdateDisplayDate:(BOOL)a9 labelPrefix:(id)a10 shouldShowBundle:(BOOL)a11;
