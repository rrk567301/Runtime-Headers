@class SFColor, SFActionItem, SFCard, NSDictionary, SFAppEntityAnnotation, NSString, SFImage, SFCommand, SFRichText, NSArray, NSData, SFFormattedText, SFUserReportRequest, SFButton;
