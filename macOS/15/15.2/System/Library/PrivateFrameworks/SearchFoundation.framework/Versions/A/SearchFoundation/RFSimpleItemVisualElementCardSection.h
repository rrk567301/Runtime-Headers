@class SFCard, NSData, NSArray, RFTextProperty, NSString, SFColor, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, RFVisualProperty;

@interface RFSimpleItemVisualElementCardSection : SFCardSection <RFSimpleItemVisualElementCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char horizontal_alignment : 1; unsigned char attribution_style : 1; } _has;
}
