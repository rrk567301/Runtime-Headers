@class SFColor, SFActionItem, SFCard, NSDictionary, SFAppEntityAnnotation, NSString, SFImage, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, NSNumber;
