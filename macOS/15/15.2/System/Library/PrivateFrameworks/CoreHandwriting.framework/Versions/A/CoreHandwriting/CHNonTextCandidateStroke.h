@class NSArray, NSMutableDictionary, CHEncodedStrokeIdentifier;
...
@property (readonly, nonatomic) long long nonTextClassification;
@property (readonly, nonatomic) double support;
@property (readonly, nonatomic) NSArray *supportingStrokeIdentifiers;
@property (readonly, nonatomic) BOOL isVerticalMathHorizontalLine;
@property (readonly, nonatomic) BOOL isLongHorizontalNonTextLine;
...
- (double)averageSupportFromStrokes:(id)a0;
- (BOOL)hasBoundingBoxOverlappingWithStroke:(id)a0;
...
- (BOOL)isHorizontalAlignedWithStroke:(id)a0;
- (BOOL)isSupportedByValidTextStrokesOrNonTextCandidates:(id)a0;
- (double)sizeRatioFromStrokes:(id)a0;
- (double)supportFromStrokes:(id)a0;
