@class NSString, GKArtworkMetadata, NSArray, NSDate;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithBundleID:(id)a0 adamID:(id)a1 name:(id)a2 shortName:(id)a3 artwork:(id)a4 supportsGameCenter:(BOOL)a5 supportsArcade:(BOOL)a6 supportsGameController:(BOOL)a7 deviceFamilies:(id)a8 latestVersionReleaseDate:(id)a9 genreDisplayName:(id)a10;
