@class FPDDomain, NSString, NSArray, NSData, NSFileProviderDomainVersion, NSError;
...
- (void)launchFeedbackForDomain:(FPDDomain *)a0 itemIdentifier:(NSString *)a1 triggeringError:(NSError *)a2 completionHandler:(void (^)(NSError *))a3;
