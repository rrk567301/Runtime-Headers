...
- (void)setSuppressPresentationInAmbient:(BOOL)a0;
...
- (void)setCanShowSummary:(BOOL)a0;
...
- (void)setDisplaysActionsInline:(BOOL)a0;
...
- (void)setShouldAnnounceForCarPlay:(BOOL)a0;
