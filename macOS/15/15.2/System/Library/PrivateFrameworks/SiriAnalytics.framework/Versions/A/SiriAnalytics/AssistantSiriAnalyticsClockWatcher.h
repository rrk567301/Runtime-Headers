@class NSString, SiriAnalyticsClientMessageStream, SiriAnalyticsClockInactivityScheduler, SiriAnalyticsSensitiveConditionsObservers, SiriAnalyticsInternalTelemetry, SiriAnalyticsDataCollectionPolicyClockObserver, SiriAnalyticsPreprocessor, SiriAnalyticsMetastore;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithInternalTelemetry:(id)a0 sensitiveConditionsObservers:(id)a1 clientMessageStream:(id)a2 preprocessor:(id)a3 metastore:(id)a4 scheduler:(id)a5 dataPolicyObserver:(id)a6;
