@class NSMutableDictionary, NSString, CESRSpeechProfileSettings, TRIClient, NSObject, CESRDictionaryLog;
...
- (BOOL)_rebuildAllSitesWithSerializedSets:(id)a0;
