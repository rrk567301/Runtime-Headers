@class WBSPasswordAuditor, NSString, WBSPasswordBreachHelperProxy, NSArray, NSSet, WBSPasswordWarningTopFraudTargetsManager, WBSPasswordEvaluator, NSMutableDictionary, NSObject, WBSSavedAccountStore, NSUserDefaults, NSMapTable;
...
- (unsigned long long)_issuesForPassword:(id)a0 withWeakPasswordEvaluation:(id)a1 passwordIsReused:(BOOL)a2 breachResultRecord:(id)a3;
