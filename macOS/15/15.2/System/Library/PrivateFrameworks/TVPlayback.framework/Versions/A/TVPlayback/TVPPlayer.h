@class TVPProgressiveJumpingScrubber, AVQueuePlayer, TVPPlayerReporter, TVPTimeRange, NSMutableArray, NSString, NSMutableSet, TVPChapter, TVPMediaItemLoader, TVPInterstitial, TVPPlayerItem, TVPExternalImagePlayer, NSMutableDictionary, TVPPlaylist, NSArray, TVPInterstitialCollection, AVPlayer, TVPChapterCollection, NSObject, TVPPlayerBookmarkMonitor, TVPDateRange, AVPlayerItem, TVPAudioOption, TVPSubtitleOption, TVPStateMachine, NSDate, TVPPlaybackState, NSNumber, NSHashTable;
@protocol TVPASyncPlaybackDelegate, TVPMediaItem, OS_dispatch_queue, TVPPlaybackDelegate;

@interface TVPPlayer : NSObject <AVPlayerPlaybackCoordinatorDelegate, AVPlayerItemDelegate, AVPlayerItemMetadataCollectorPushDelegate, TVPAVFPlayback>
