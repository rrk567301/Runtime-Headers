...
@interface SMSafetyMonitorManager : NSObject <SMFrameworkProtocol, SMInitiatorProtocol, SMInitiatorSafetyCacheMonitoringProtocol, SMInitiatorSessionConfigurationProtocol, SMInitiatorSessionMonitorProtocol, SMInitiatorGroupChatProtocol, SMDeviceConfigurationProtocol, SMEligibilityProtocol, SMSuggestionsProtocol, SMSuggestionsHelperProtocol, SMInitiatorCacheProtocol, SMSuggestionsStoreProtocol, SMMadridMessengerProtocol, SMReceiverProtocol, SMReceiverMonitorProtocol, SMSessionStoreProtocol, SMUserNotificationProtocol, SMInitiatorDestinationBoundSessionProtocol, SMWorkoutSnapshotProtocol>
