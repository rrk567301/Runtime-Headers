@class PLAutoBindingProxyFactory, PLAssetsdCloudInternalClient, PLAssetsdSyncClient, PLAssetsdNotificationClient, PLAssetsdPrivacySupportClient, PLAssetsdResourceAvailabilityClient, PLAssetsdLibraryInternalClient, PLAssetsdSystemLibraryURLReadOnlyClient, PLAssetsdResourceClient, PLAssetsdLibraryManagementClient, PLAssetsdCloudClient, PLAssetsdResourceInternalClient, PLAssetsdNonBindingDebugClient, NSObject, PLAssetsdPhotoKitClient, PLAssetsdMigrationClient, PLAssetsdClientXPCConnection, PLAssetsdPhotoKitAddClient, PLAssetsdDebugClient, PLAssetsdDiagnosticsClient, PLAssetsdClientSandboxExtensions, PLAssetsdLibraryClient, PLAssetsdDemoClient, PLAssetsdResourceWriteOnlyClient;
