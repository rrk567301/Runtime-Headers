@class PLAssetsdNonBindingDebugClient, PLAssetsdClientXPCConnection, PLAssetsdPrivacySupportClient, PLAssetsdLibraryManagementClient, PLAssetsdDemoClient, NSObject, PLAssetsdSystemLibraryURLReadOnlyClient;
