...
- (id)initWithIdentifier:(id)a0 mangledTypeName:(id)a1 mangledTypeNameByBundleIdentifier:(id)a2 effectiveBundleIdentifiers:(id)a3 bundleMetadataVersion:(long long)a4 title:(id)a5 descriptionMetadata:(id)a6 deprecationMetadata:(id)a7 openAppWhenRun:(BOOL)a8 explicitAuthenticationPolicy:(id)a9 outputType:(id)a10 outputFlags:(unsigned long long)a11 parameters:(id)a12 systemProtocolMetadata:(id)a13 actionConfiguration:(id)a14 typeSpecificMetadata:(id)a15 customIntentClassName:(id)a16 availabilityAnnotations:(id)a17 shortcutsMetadata:(id)a18 requiredCapabilities:(id)a19 attributionBundleIdentifier:(id)a20 sideEffect:(id)a21 assistantDefinedSchemas:(id)a22 assistantDefinedSchemaTraits:(id)a23 visibilityMetadata:(id)a24 fullyQualifiedTypeName:(id)a25;
