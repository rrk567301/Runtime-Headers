@class EMCoreAnalyticsCollector, NSString, NSBackgroundActivityScheduler, EDMailboxProvider, NSMutableDictionary, NSSet, EDPersistenceHookRegistry, EDPersistenceDatabase, EDMailboxPersistenceStatistics;
