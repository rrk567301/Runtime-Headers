@class NSString, EDBiomeBlackPearlLogger, EDMessagePersistence, EDMessageCategorizer, EDReadLaterPersistence, EDServerMessagePersistenceFactory, EDMessageAuthenticator, NSObject, EDBIMIManager, EDPersistenceDatabase, EDLocalActionPersistence;
