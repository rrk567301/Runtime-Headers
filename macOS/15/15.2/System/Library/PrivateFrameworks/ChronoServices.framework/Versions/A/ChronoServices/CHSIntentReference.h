...
@interface CHSIntentReference : NSObject <BSDescriptionStreamable, BSXPCSecureCoding, NSSecureCoding, NSCopying> {
...
- (id)_initWithGenericIntent:(id)a0 schemaData:(id)a1;
