@class NSMutableDictionary, FigCaptureSourceDepthDataFormat, BWMemoryPool, NSDictionary, NSMutableArray, BWSlaveFrameSynchronizerNode, BWFanOutNode, BWFigVideoCaptureDevice, NSString, BWMultiStreamCameraSourceNode, FigCaptureSourceVideoFormat, NSArray, BWNodeOutput;
