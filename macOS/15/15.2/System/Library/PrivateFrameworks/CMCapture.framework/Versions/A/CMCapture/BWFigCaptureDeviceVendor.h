...
- (int)registerClientWithPID:(int)a0 clientApplicationID:(id)a1 clientDescription:(id)a2 clientPriority:(int)a3 canStealFromClientsWithSamePriority:(BOOL)a4 deviceSharingWithOtherClientsAllowed:(BOOL)a5 deviceSharingWithAVFlashlightAllowed:(BOOL)a6 clientIsAVFlashlight:(BOOL)a7 deviceAvailabilityChangedHandler:(id /* block */)a8;
- (int)registerClientWithPID:(int)a0 clientDescription:(id)a1 clientPriority:(int)a2 canStealFromClientsWithSamePriority:(BOOL)a3 deviceSharingWithOtherClientsAllowed:(BOOL)a4 deviceSharingWithAVFlashlightAllowed:(BOOL)a5 clientIsAVFlashlight:(BOOL)a6 deviceAvailabilityChangedHandler:(id /* block */)a7;
