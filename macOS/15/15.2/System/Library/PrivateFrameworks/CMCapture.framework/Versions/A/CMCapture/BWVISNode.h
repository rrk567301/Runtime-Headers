@class NSMutableDictionary, NSDictionary, NSObject, BWStats, BWVISProcessorController, BWIrisStillImageMovieMetadataCache, NSString, BWLimitedGMErrorLogger, NSArray, NSData, NSNumber, BWVISProcessorControllerConfiguration, BWVideoFormatRequirements;
