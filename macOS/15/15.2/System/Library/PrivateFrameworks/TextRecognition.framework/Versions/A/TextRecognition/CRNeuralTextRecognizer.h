...
+ (Class)_modelClassForRevision:(long long)a0 language:(id)a1 error:(id *)a2;
...
+ (id)localeToModelClassMappingForRevision:(long long)a0;
...
- (id)recognizeInImage:(id)a0 lineRegions:(id)a1 rectifier:(id)a2 progressHandler:(id /* block */)a3 error:(id *)a4;
