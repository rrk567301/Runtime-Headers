@class NSDictionary, FCNewsTabiTagSuggestionsConfiguration, FCNewsTabiPersonalizedPaywallsConfiguration, FCNewsTabiNotificationScoringEndpoint, FCNewsTabiFeedPersonalizationConfiguration, FCNewsTabiMyMagazinesConfiguration, FCNewsTabiAdSegmentsEndpoint, NSString, FCNewsTabiEventAggregationConfiguration, FCNewsTabiChannelPickerSuggestionsEndpoint, FCNewsTabiTagScoringEndpoint, NSArray, FCNewsTabiNotificationScoringConfiguration, FCNewsTabiPersonalizedPaywallsEndpoint, FCNewsTabiRecommendedTagsConfiguration, FCNewsTabiTagScoringConfiguration, FCNewsTabiRecommendedIssuesConfiguration, FCNewsTabiRecommendedIssuesEndpoint, FCNewsTabiChannelPickerSuggestionsConfiguration, FCNewsTabiRecommendedTagsEndpoint, FCNewsTabiTagSuggestionsEndpoint, FCNewsTabiMyMagazinesEndpoint, FCNewsTabiTagCohortMembershipConfiguration, FCNewsTabiTagCohortMembershipEndpoint, FCNewsTabiFeedPersonalizationEndpoint, FCNewsTabiUnloadGraphOnBackgroundConfiguration;
