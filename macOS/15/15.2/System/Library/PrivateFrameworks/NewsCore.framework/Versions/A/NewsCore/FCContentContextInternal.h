@class FCResourceRecordSource, FCTagRecordSource, FCPuzzleRecordSource, FCIssueListRecordSource, NSString, FCTagListRecordSource, FCNotificationItemRecordSource, FCPurchaseLookupRecordSource, FCPuzzleTypeRecordSource, FCCKContentDatabase, FCAVAssetDownloadManager, FCArticleRecordSource, FCFeedDatabase, NSArray, FCSportsEventRecordSource, FCArticleListRecordSource, FCIssueRecordSource, FCAudioConfigRecordSource, FCChannelMembershipController, FCFeedPrewarmer, FCNotificationItemListRecordSource, FCWidgetSectionConfigRecordSource, FCForYouConfigRecordSource;
