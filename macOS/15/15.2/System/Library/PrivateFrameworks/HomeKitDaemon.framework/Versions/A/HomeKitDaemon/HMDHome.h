...
- (void)submitLogEventForCommandResponse:(id)a0 nodeID:(unsigned long long)a1 endpointID:(id)a2 clusterID:(id)a3 commandID:(id)a4 fields:(id)a5 source:(unsigned long long)a6 error:(id)a7;
