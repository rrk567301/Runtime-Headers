...
@property (nonatomic, readonly) void /* unknown type, empty encoding */ fields;
...
- (id)initWithHome:(id)a0 nodeId:(unsigned long long)a1 endpointId:(id)a2 clusterId:(id)a3 commandId:(id)a4 fields:(id)a5 source:(unsigned long long)a6;
