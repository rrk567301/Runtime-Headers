...
- (void)_sendStatusForFailedKeys:(id)a0 enumerator:(id)a1 scope:(long long)a2 configurations:(id)a3 completionHandler:(id /* block */)a4;
- (void)_sendStatusForSuccessKeys:(id)a0 failedKeys:(id)a1 reasons:(id)a2 scope:(long long)a3 configurations:(id)a4 completionHandler:(id /* block */)a5;
