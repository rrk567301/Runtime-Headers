...
- (id)createDecoderForTrack:(id)a0 timerange:(const struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; } *)a1 forAnalysisTypes:(unsigned long long)a2 decodedFrameRate:(float *)a3 withLossySetting:(BOOL)a4;
