...
- (id)initWithVideoOrientation:(int)a0 preferredTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 metaOrientation:(id)a2 privateResults:(id)a3 embeddings:(id)a4 isTimelapse:(BOOL)a5 isIris:(BOOL)a6 irisPhotoOffsetSec:(float)a7 irisPhotoExposureSec:(float)a8 slowMoRate:(float)a9 faceDominated:(BOOL)a10;
