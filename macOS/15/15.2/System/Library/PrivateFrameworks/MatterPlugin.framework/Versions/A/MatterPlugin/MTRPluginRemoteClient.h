...
- (oneway void)deviceController:(id)a0 controllerNodeIDWithReply:(id /* block */)a1;
- (oneway void)deviceController:(id)a0 getIsRunningWithReply:(id /* block */)a1;
- (oneway void)deviceController:(id)a0 getUniqueIdentifierWithReply:(id /* block */)a1;
...
- (void)sendControllerMessageToHomeWithID:(id)a0 controllerMessageType:(int)a1 queryRequestValue:(id)a2 errorBlock:(id /* block */)a3 replyBlock:(id /* block */)a4;
- (void)sendDeviceMessageToNodeWithID:(id)a0 homeID:(id)a1 deviceNodeMessageType:(int)a2 errorBlock:(id /* block */)a3 replyBlock:(id /* block */)a4;
- (void)sendMessageToHomeWithID:(id)a0 messageType:(int)a1 pbCodable:(id)a2 errorBlock:(id /* block */)a3 replyBlock:(id /* block */)a4;
- (void)sendOnewayMessageToHomeWithID:(id)a0 messageType:(int)a1 pbCodable:(id)a2;
