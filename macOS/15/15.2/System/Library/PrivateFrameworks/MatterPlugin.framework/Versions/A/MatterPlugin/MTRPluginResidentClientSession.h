@class NSUUID, NSString, NSMutableSet, NSDate, NSObject;
...
- (void)_sendMessageToHomeWithID:(id)a0 messageType:(int)a1 pbCodable:(id)a2 errorBlock:(id /* block */)a3 replyBlock:(id /* block */)a4;
...
- (void)messageTransport:(id)a0 handleControllerConfigUpdate:(id)a1;
