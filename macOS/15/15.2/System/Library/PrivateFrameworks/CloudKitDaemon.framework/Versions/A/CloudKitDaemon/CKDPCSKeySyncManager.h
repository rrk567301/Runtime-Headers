...
- (id)init;
- (void).cxx_destruct;
- (id)_on_queue_createSyncTrackerForAccount:(id)a0 requestorOperationID:(id)a1 service:(id)a2 manatee:(BOOL)a3 testOverrideProvider:(id)a4;
...
- (id)_on_queue_syncTrackerForAccount:(id)a0 requestorOperationID:(id)a1 service:(id)a2 manatee:(BOOL)a3 testOverrideProvider:(id)a4;
- (id)createSyncTrackerForAccount:(id)a0 requestorOperationID:(id)a1 service:(id)a2 manatee:(BOOL)a3 testOverrideProvider:(id)a4;
...
- (id)syncTrackerForAccount:(id)a0 requestorOperationID:(id)a1 service:(id)a2 manatee:(BOOL)a3 testOverrideProvider:(id)a4;
