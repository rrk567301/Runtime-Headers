...
@interface MFLibrary : NSObject <EDBrandIndicatorChangeHookResponder, EDMessageChangeHookResponder, EDRemindMeNotificationControllerObserver, EDCategoryChangeHookResponder, MCActivityTarget> {
