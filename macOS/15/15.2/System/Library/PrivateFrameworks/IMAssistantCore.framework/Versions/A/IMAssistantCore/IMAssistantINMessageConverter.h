...
+ (id)makeINMessage:(long long)a0 message:(id)a1 numberOfAttachments:(long long)a2 personProvider:(id)a3 referencedINMessage:(id)a4 content:(id)a5 reaction:(id)a6;
