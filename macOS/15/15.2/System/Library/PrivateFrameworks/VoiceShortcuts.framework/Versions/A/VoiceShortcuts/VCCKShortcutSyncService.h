@class WFCloudKitSyncEventLogger, NSString, NSError, NSMutableDictionary, CKSyncEngine, CKSyncEngineSendChangesOptions, VCCKApplicationStateObserver, CKRecordZoneID, CKSyncEngineFetchChangesOptions, WFDatabase;

@interface VCCKShortcutSyncService : NSObject <WFShortcutsSyncService, CKSyncEngineDelegate, WFDatabaseObjectObserver>
