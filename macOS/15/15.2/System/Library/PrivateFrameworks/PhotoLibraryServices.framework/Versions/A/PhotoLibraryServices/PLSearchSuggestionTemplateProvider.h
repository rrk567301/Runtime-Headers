...
@property (retain, nonatomic) NSArray *limitedTemplates;
...
- (id)templatesForSearchIndexCategory:(unsigned long long)a0 secondIndexCategory:(unsigned long long)a1 limitedTemplates:(id)a2;
