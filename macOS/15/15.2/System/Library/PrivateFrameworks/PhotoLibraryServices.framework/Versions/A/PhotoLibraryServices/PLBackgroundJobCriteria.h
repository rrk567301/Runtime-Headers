...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithName:(id)a0 shortCode:(id)a1 xpcActivityPriority:(unsigned long long)a2 allowBattery:(BOOL)a3 gracePeriod:(long long)a4 delay:(long long)a5 requireScreenSleep:(BOOL)a6 cpuIntensive:(BOOL)a7 memoryIntensive:(BOOL)a8 requireInexpensiveNetworkConnectivity:(BOOL)a9 requireConcurrencyLimit:(BOOL)a10 overrideRateLimiting:(BOOL)a11 involvedProcesses:(id)a12;
- (id)xpcCriteria;
