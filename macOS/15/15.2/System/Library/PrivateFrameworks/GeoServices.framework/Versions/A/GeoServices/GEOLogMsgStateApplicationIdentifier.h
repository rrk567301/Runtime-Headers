...
@interface GEOLogMsgStateApplicationIdentifier : PBCodable <NSCopying> {
    ...
    int _appType;
    BOOL _appDarkMode;
    struct { unsigned char has_appType : 1; unsigned char has_appDarkMode : 1; unsigned char read_appIdentifier : 1; unsigned char read_appMajorVersion : 1; unsigned char read_appMinorVersion : 1; unsigned char read_processName : 1; unsigned char wrote_anyField : 1; } _flags;
}
