...
+ (id)URLForDirectionsToDestinations:(id)a0;
+ (id)URLForCoordinate:(struct { double x0; double x1; })a0 address:(id)a1 label:(id)a2;
+ (id)URLForPlaceWithName:(id)a0 coordinate:(struct { double x0; double x1; })a1;
...
+ (id)URLForDirectionsFromSource:(id)a0 toDestination:(id)a1;
+ (id)URLForDirectionsFromSource:(id)a0 toDestination:(id)a1 transportType:(int)a2;
+ (id)URLForDirectionsFromSource:(id)a0 toDestinations:(id)a1;
+ (id)URLForDirectionsFromSource:(id)a0 toDestinations:(id)a1 transportType:(int)a2;
+ (id)URLForDirectionsFromSource:(id)a0 toDestinations:(id)a1 transportType:(int)a2 directionsOptions:(id)a3;
+ (id)URLForDirectionsToDestination:(id)a0;
+ (id)URLForDirectionsToDestination:(id)a0 transportType:(int)a1;
+ (id)URLForDirectionsToDestinations:(id)a0 transportType:(int)a1;
+ (id)URLForExternalBusiness:(id)a0 id:(id)a1 ofContentProvider:(id)a2;
+ (id)URLForGuidesWithCollectionMUID:(unsigned long long)a0 provider:(int)a1;
+ (id)URLForGuidesWithCollectionStorage:(id)a0;
+ (id)URLForGuidesWithPublisherMUID:(unsigned long long)a0 provider:(int)a1;
...
+ (id)URLForPlaceWithMapItemIdentifier:(id)a0;
+ (id)URLForPlaceWithName:(id)a0 address:(id)a1;
+ (id)URLForPlaceWithName:(id)a0 mapItemIdentifier:(id)a1 coordinate:(struct { double x0; double x1; })a2 address:(id)a3;
...
+ (id)URLForSearchWithQuery:(id)a0;
+ (id)URLForSearchWithQuery:(id)a0 centeredAt:(struct { double x0; double x1; })a1;
+ (id)URLForSearchWithQuery:(id)a0 centeredAt:(struct { double x0; double x1; })a1 span:(struct { double x0; double x1; })a2;
...
- (id)initForDirectionsWithSource:(id)a0 destinations:(id)a1 transportType:(int)a2 directionsOptions:(id)a3;
...
- (id)initForGuidesWithCollectionMUID:(unsigned long long)a0 provider:(int)a1;
- (id)initForGuidesWithCollectionStorage:(id)a0;
- (id)initForGuidesWithPublisherMUID:(unsigned long long)a0 provider:(int)a1;
...
- (id)initForPlaceWithName:(id)a0 mapItemIdentifier:(id)a1 coordinate:(struct { double x0; double x1; })a2 address:(id)a3 mapType:(int)a4 providerId:(int)a5;
