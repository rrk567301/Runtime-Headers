@class NSHashTable, NSString, NSProtocolChecker, NSData, NSMutableDictionary, _IDSRegistrationAccountManager, NSObject, IDSInternalQueueController;
...
@property (retain, nonatomic) _IDSRegistrationAccountManager *registrationAccountManager;
