...
- (id)initWithDelegate:(id)a0 creationOptions:(struct { id x0; BOOL x1; struct __CFDate *x2; struct __CFString *x3; struct __CFString *x4; BOOL x5; } *)a1;
...
- (void)processPersistentSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; unsigned long long x8; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; } x9; } *)a0;
