...
@property struct tagVCReportingClientSettingsPersist { char eyeContactStatus; char mlEnhanceStatus; char centerStageStatus; char portraitModeStatus; char studioLightStatus; char reactionsStatus; char backgroundReplacementStatus; char backgroundReplacementContinuityCameraStatus; unsigned long long switches; struct tagVCReportingClientExperimentSettings { BOOL networkConditionMonitoringClientExperimentEnabled; BOOL motionBasedDuplicationClientExperimentEnabled; } experimentSettings; } persistentSettings;
...
- (void)createSecondAggregatorWithOptions:(struct { id x0; BOOL x1; struct __CFDate *x2; struct __CFString *x3; struct __CFString *x4; BOOL x5; } *)a0;
...
- (id)newAggregatorForClientType:(int)a0 creationOptions:(struct { id x0; BOOL x1; struct __CFDate *x2; struct __CFString *x3; struct __CFString *x4; BOOL x5; } *)a1;
