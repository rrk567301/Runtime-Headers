...
+ (id)defaultOneToOneTierTable:(unsigned int)a0 redundancyEnabled:(BOOL)a1;
+ (unsigned int)defaultRemainingBitrateSplit:(unsigned int)a0;
+ (id)fdatGroupDisabled;
+ (id)foregroundCameraOneToOneTierTable:(unsigned int)a0 redundancyEnabled:(BOOL)a1;
+ (unsigned int)foregroundCameraRemainingBitrateSplit:(unsigned int)a0;
+ (id)ftxtGroupDisabled;
+ (id)oneToOneTierTableForStreamGroupID:(unsigned int)a0 splitType:(unsigned int)a1 redundancyEnabled:(BOOL)a2;
