...
- (id)initWithHeading:(unsigned long long)a0 linearHeading:(unsigned long long)a1 isInitial:(BOOL)a2 shouldLoadScrollableContainer:(BOOL)a3 looping:(BOOL)a4 groupFilter:(long long)a5 inputType:(unsigned long long)a6;
...
- (id)initWithHeading:(unsigned long long)a0 velocity:(struct CGVector { double x0; double x1; })a1 isInitial:(BOOL)a2 shouldLoadScrollableContainer:(BOOL)a3 groupFilter:(long long)a4 inputType:(unsigned long long)a5;
