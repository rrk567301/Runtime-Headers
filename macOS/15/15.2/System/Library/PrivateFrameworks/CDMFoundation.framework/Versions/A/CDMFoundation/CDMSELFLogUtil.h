...
+ (BOOL)cdmAllServicesWarmupEnded:(id)a0 logMessage:(id)a1 dataDispatcherContext:(id)a2;
+ (BOOL)cdmAllServicesWarmupFailed:(id)a0 logMessage:(id)a1 dataDispatcherContext:(id)a2;
+ (BOOL)cdmAllServicesWarmupStarted:(id)a0 logMessage:(id)a1 dataDispatcherContext:(id)a2;
...
+ (BOOL)cdmClientWarmupEnded:(id)a0 logMessage:(id)a1 dataDispatcherContext:(id)a2;
+ (BOOL)cdmClientWarmupFailed:(id)a0 errorDomain:(int)a1 errorCode:(unsigned int)a2 logMessage:(id)a3 dataDispatcherContext:(id)a4;
+ (BOOL)cdmClientWarmupStarted:(id)a0 logMessage:(id)a1 currentServiceGraph:(int)a2 dataDispatcherContext:(id)a3;
...
+ (id)createSELFMetadataWithNlId:(id)a0 andWithTrpId:(id)a1 andWithRequestId:(id)a2 andWithResultCandidateId:(id)a3 andWithConnectionId:(id)a4;
