...
- (id)summary;
- (void)_failedCancelActivity:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_stagePurgeAll:(id /* block */)a0;
- (id)assetAttribute:(id)a0;
- (void)_stageEraseAll:(id /* block */)a0;
- (void)_cancelActivityForSelector:(id /* block */)a0;
...
- (void)_failedMapLockedContent:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageCancelOperation:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageDetermineAllAvailable:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageDetermineGroupsAvailableForUpdate:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageDownloadAll:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageDownloadGroups:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
- (void)_failedStageEraseAll:(long long)a0 withResponseError:(id)a1 description:(id)a2 completion:(id /* block */)a3;
...
- (void)_stageDetermineGroupsAvailableForUpdate:(id)a0 completion:(id /* block */)a1;
...
- (void)_stageDownloadGroups:(id)a0 awaitingAllGroups:(BOOL)a1 withStagingTimeout:(long long)a2 reportingProgress:(id /* block */)a3 completion:(id /* block */)a4;
...
- (void)_successCancelActivity:(id /* block */)a0;
...
- (void)_successLockContent:(id)a0 dueToDesire:(id)a1 sandboxExtension:(id)a2 sandboxExtensionPath:(id)a3 completion:(id /* block */)a4;
- (void)_successMapLockedContent:(id)a0 dueToDesire:(id)a1 completion:(id /* block */)a2;
- (void)_successStageCancelOperation:(id /* block */)a0;
- (void)_successStageDetermineAllAvailable:(id)a0 completion:(id /* block */)a1;
- (void)_successStageDetermineGroupsAvailableForUpdate:(id)a0 completion:(id /* block */)a1;
- (void)_successStageDownloadAll:(id)a0 completion:(id /* block */)a1;
- (void)_successStageDownloadGroups:(id)a0 completion:(id /* block */)a1;
- (void)_successStageEraseAll:(id /* block */)a0;
