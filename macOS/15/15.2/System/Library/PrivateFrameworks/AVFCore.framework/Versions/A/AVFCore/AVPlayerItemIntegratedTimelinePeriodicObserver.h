@class NSString, AVPeriodicTimebaseObserver, NSObject;
...
- (id)initWithInterval:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 queue:(id)a1 block:(id /* block */)a2;
