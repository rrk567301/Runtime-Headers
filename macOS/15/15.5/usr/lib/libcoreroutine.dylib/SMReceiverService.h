...
+ (void)_submitSentinelZoneMaintenanceMetricForSuccess:(BOOL)a0 error:(id)a1;
...
- (void)_receivedLowPowerModeWarningStateUpdateMessage:(id)a0 fromHandle:(id)a1 fromMe:(BOOL)a2;
