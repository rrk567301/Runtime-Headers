...
- (id)base64PublicKey;
- (BOOL)allInvitedMembersInContactsChecking:(id)a0;
...
- (id)initWithPseudonym:(id)a0 publicKey:(id)a1 groupUUID:(id)a2 originatorHandle:(id)a3 creationDate:(id)a4 deletionDate:(id)a5 expirationDate:(id)a6 invitedMemberHandles:(id)a7 locallyCreated:(BOOL)a8 linkName:(id)a9 linkLifetimeScope:(long long)a10 deleteReason:(long long)a11;
