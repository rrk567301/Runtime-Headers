...
- (id)_calcDeviceID:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcFinishingTemplates:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (unsigned long long)_calcIdentifyActions:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcInputSlots:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (long long)_calcJobAccountIDSupport:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcJobPresets:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcMediaTypes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcOutputBins:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (BOOL)_calcPrintScalingSupported:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (void)_calcPrinterDriverInfo:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calcSpecialFeedOrientation:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculateFormats:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculateMediaColSupportedArray:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculateOutputModes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculatePaperList:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculateQuality:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (id)_calculateSides:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (void)_ingestAttrs:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0;
- (void)_ingestTxtRecord:(id)a0;
- (id)_makePrinterDeviceIDFromTxt;
- (id)initWithAttributes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0 translations:(id)a1;
- (id)initWithAttributes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x0; } *)a0 txtRecord:(id)a1 translations:(id)a2;
- (id)initWithTXT:(id)a0;
- (id)initWithUserCodableDictionary:(id)a0;
- (id)makeTXTRecordWithURL:(id)a0;
- (id)printInfoSupportedDictionary;
- (void)replacePaperList:(id)a0;
