...
- (BOOL)_parseSevenColumnLayoutWithOptions:(unsigned long long)a0;
...
- (BOOL)canUseSingleSevenColumnHeroRowForNumberOfRemainingItems:(long long)a0;
...
- (BOOL)parseSevenColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 options:(unsigned long long)a2;
- (BOOL)parseSevenColumnRowWithType:(long long)a0 numberOfItems:(long long)a1 subsequentShortRowItems:(long long)a2 options:(unsigned long long)a3;
