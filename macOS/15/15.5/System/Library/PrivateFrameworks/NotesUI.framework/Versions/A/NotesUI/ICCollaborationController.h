...
+ (id)updatedShareForObject:(id)a0 includeHierarchicalShare:(BOOL)a1 managedObjectContext:(id)a2;
...
- (void)removeShareIfNeededWithOwnedObjectID:(id)a0 countParticipants:(BOOL)a1 completionHandler:(id /* block */)a2;
