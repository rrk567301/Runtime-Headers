...
- (BOOL)connection:(id)a0 sendMessagePayloadToPrimaryResident:(id)a1 responseHandler:(id /* block */)a2 timeout:(double)a3 error:(id *)a4;
...
- (BOOL)sendMessage:(id)a0 homeUUID:(id)a1 timeout:(double)a2 error:(id *)a3;
