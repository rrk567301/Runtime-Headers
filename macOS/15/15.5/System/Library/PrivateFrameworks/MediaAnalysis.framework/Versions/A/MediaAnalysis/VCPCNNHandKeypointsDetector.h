...
+ (id)detector:(BOOL)a0 sharedModel:(BOOL)a1 modelName:(id)a2 enableHandObject:(BOOL)a3 options:(id)a4;
...
- (int)handKeypointsDetection:(struct __CVBuffer { } *)a0 box:(id)a1 keypoints:(struct CGPoint { double x0; double x1; }[21])a2 keypointConfidence:(float[21])a3 handHoldsObjectConfidence:(float *)a4;
