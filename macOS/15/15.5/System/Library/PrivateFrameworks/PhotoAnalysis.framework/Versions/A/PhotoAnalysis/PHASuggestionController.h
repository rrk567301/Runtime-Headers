...
+ (BOOL)_shouldCheckSuggestionRecylingForProfile:(unsigned char)a0;
...
- (BOOL)_filterExistingSuggestion:(id)a0;
...
- (BOOL)existingSuggestion:(id)a0 matchesSuggestion:(id)a1;
