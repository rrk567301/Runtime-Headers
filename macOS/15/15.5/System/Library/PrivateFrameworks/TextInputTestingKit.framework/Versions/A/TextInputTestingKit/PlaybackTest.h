...
+ (id)loadFromTextInputFile:(id)a0 withCatenation:(BOOL)a1 addWordSpacing:(BOOL)a2;
+ (id)sentenceToTransliteratedPlaybackTest:(id)a0 withCatenation:(BOOL)a1 addWordSpacing:(BOOL)a2;
