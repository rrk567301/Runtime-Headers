@class NSData, NSString, SFColor, NSArray, SFCard, SFUserReportRequest, SFMapRegion, NSDictionary, SFLatLng, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
