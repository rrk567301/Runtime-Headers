@class SFColor, NSString, NSData, NSArray, SFCard, SFUserReportRequest, NSDictionary, SFDetailedRowCardSection, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
