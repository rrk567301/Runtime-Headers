@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, NSString, SFImage, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, NSNumber;
