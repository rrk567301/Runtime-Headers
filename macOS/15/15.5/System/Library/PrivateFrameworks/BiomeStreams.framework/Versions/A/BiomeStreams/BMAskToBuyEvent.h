...
- (id)initWithRequestID:(id)a0 status:(int)a1 eventTime:(double)a2 userID:(id)a3 actionUserID:(id)a4 itemTitle:(id)a5 itemDescription:(id)a6 itemLocalizedPrice:(id)a7 thumbnailPath:(id)a8 ageRating:(id)a9 starRating:(id)a10 productType:(id)a11 isActionUserDevice:(BOOL)a12 storeLink:(id)a13;
