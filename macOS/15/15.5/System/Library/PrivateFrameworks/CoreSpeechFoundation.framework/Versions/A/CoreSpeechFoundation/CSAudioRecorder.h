...
@interface CSAudioRecorder : NSObject <AVVoiceControllerRecordDelegate, CSAudioDecoderDelegate, CSAudioFileReaderDelegate, CSRemoteRecordClientDelegate, CSUserSessionActiveMonitorDelegate, CSExclaveAudioProvidingDelegate, CSLaunchAgentXPCClientDelegate, CSSiriEnabledMonitorDelegate, CSAudioSessionEventProviding> {
...
- (void)CSSystemDaemonDidStartRecordingForStream:(unsigned long long)a0 successfully:(BOOL)a1;
...
- (BOOL)setListeningMicIndicatorPropertyForStream:(unsigned long long)a0;
