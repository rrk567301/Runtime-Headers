...
- (void).cxx_destruct;
- (void)daemonClientNotification:(unsigned int)a0 ioResult:(unsigned int)a1 arguments:(struct ScalarArgsArrayUserReference { unsigned long long x0[16]; unsigned int x1; } *)a2;
