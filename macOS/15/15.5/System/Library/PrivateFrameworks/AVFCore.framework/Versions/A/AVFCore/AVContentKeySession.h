...
- (void)didProvideKeyRequestWithBoss:(struct OpaqueFigContentKeyBoss { } *)a0 keySpecifier:(struct OpaqueFigContentKeySpecifier { } *)a1 requestID:(unsigned long long)a2 renewalRequest:(BOOL)a3 supportsOfflineKey:(BOOL)a4;
- (void)expire;
