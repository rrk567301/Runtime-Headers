...
- (BOOL)errorIndicatesBatchSizeFailure:(id)a0;
...
- (BOOL)errorIndicatesAssetWasNotAvailable:(id)a0;
- (BOOL)errorIndicatesBatchFailure:(id)a0;
- (BOOL)errorIndicatesDeviceConditionsDontAllowSync:(id)a0;
- (BOOL)errorIndicatesDeviceDoesNotHaveKeysToSync:(id)a0;
- (BOOL)errorIndicatesDuplicateRecordWasFound:(id)a0;
- (BOOL)errorIndicatesIdentityWasLost:(id)a0;
- (BOOL)errorIndicatesItemWasUnknown:(id)a0;
- (BOOL)errorIndicatesMaxAttemptsFailed:(id)a0;
- (BOOL)errorIndicatesQuotaExceeded:(id)a0;
- (BOOL)errorIndicatesRecordSizeFailure:(id)a0;
- (BOOL)errorIndicatesRecordWasAlreadyChanged:(id)a0;
- (BOOL)errorIndicatesRecordWasArchived:(id)a0;
- (BOOL)errorIndicatesTokenWasExpired:(id)a0;
- (BOOL)errorIndicatesUserDeletedZone:(id)a0;
- (BOOL)errorIndicatesZoneNotCreated:(id)a0;
- (BOOL)errorIndicatesZoneNotFound:(id)a0;
