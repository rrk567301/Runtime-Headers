...
@property (readonly, nonatomic) BOOL includeInferredNames;
@property (readonly, nonatomic) BOOL enableBackupSearch;
...
- (id)initWithKgq:(id)a0 text:(id)a1 mode:(long long)a2 includeFeatures:(BOOL)a3 includeInferredNames:(BOOL)a4;
...
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 includeInferredNames:(BOOL)a3;
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 includeInferredNames:(BOOL)a3 enableBackupSearch:(BOOL)a4;
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 mode:(long long)a3 constraint:(long long)a4;
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 mode:(long long)a3 constraint:(long long)a4 includeInferredNames:(BOOL)a5;
...
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 mode:(long long)a3 constraint:(long long)a4 sourceIDs:(id)a5 kgq:(id)a6 includeFeatures:(BOOL)a7 includeInferredNames:(BOOL)a8;
- (id)initWithText:(id)a0 entityClassFilter:(id)a1 spans:(id)a2 mode:(long long)a3 constraint:(long long)a4 sourceIDs:(id)a5 kgq:(id)a6 includeFeatures:(BOOL)a7 includeInferredNames:(BOOL)a8 enableBackupSearch:(BOOL)a9;
