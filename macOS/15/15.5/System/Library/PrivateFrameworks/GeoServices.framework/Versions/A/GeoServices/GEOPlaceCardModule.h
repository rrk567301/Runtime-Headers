...
@interface GEOPlaceCardModule : PBCodable <NSCopying> {
    ...
    int _type;
    struct { unsigned char has_type : 1; unsigned char read_unknownFields : 1; unsigned char read_contents : 1; unsigned char read_metadata : 1; unsigned char wrote_anyField : 1; } _flags;
}
