...
@property (readonly, nonatomic, getter=isFederated) BOOL federated;
@property (readonly, nonatomic) id<CRKASMNameComponents> nameComponents;
@property (readonly, nonatomic, getter=isAccountLockedDueToFailedLoginAttempts) BOOL accountLockedDueToFailedLoginAttempts;
@property (readonly, nonatomic, getter=isAccountATOLocked) BOOL accountATOLocked;
