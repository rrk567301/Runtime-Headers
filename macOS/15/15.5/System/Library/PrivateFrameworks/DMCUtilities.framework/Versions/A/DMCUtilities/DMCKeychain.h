...
+ (void *)_copyTypeRefWithQuery:(id)a0 useSystemKeychain:(BOOL)a1 enforcePersonalPersona:(BOOL)a2;
...
+ (id)copyDataWithPersistentID:(id)a0 useSystemKeychain:(BOOL)a1 enforcePersonalPersona:(BOOL)a2;
+ (struct __SecIdentity { } *)copyIdentityWithPersistentID:(id)a0 useSystemKeychain:(BOOL)a1 enforcePersonalPersona:(BOOL)a2;
+ (void *)copyItemWithPersistentID:(id)a0 useSystemKeychain:(BOOL)a1 enforcePersonalPersona:(BOOL)a2;
+ (id)copyPasswordWithPersistentID:(id)a0 useSystemKeychain:(BOOL)a1 enforcePersonalPersona:(BOOL)a2;
