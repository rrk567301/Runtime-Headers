...
- (void)clearAllHistoryInsertingTombstoneUpToDate:(id)a0 clearAllSpotlightHistoryForProfile:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (void)clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 clearAllSpotlightHistoryForProfile:(BOOL)a3 completionHandler:(id /* block */)a4;
