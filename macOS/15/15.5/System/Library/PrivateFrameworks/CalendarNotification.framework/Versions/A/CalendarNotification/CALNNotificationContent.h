...
- (id)_initWithTitle:(id)a0 subtitle:(id)a1 body:(id)a2 categoryIdentifier:(id)a3 sectionIdentifier:(id)a4 date:(id)a5 expirationDate:(id)a6 defaultActionURL:(id)a7 iconIdentifier:(id)a8 shouldHideTime:(BOOL)a9 shouldSuppressSyncDismissalWhenRemoved:(BOOL)a10 peopleIdentifiers:(id)a11 sound:(id)a12 userInfo:(id)a13 threadIdentifier:(id)a14 interruptionLevel:(unsigned long long)a15 filterCriteria:(id)a16;
