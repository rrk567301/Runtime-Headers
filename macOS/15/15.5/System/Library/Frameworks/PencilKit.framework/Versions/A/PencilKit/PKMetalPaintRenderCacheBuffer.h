...
- (id)initWithUniforms:(const struct PKMetalPaintKernelUniforms { unsigned int x0; unsigned int x1; unsigned int x2; float x3; float x4; struct float3x3 { void /* unknown type, empty encoding */ x0[3]; } x5; struct float3x3 { void /* unknown type, empty encoding */ x0[3]; } x6; } *)a0 points:(const struct PKMetalPaintStrokePoint { float x0; float x1; unsigned short x2 : 16; unsigned short x3 : 16; } *)a1 numPoints:(unsigned long long)a2 numVertices:(unsigned long long)a3 resourceHandler:(id)a4;
