...
- (BOOL)resetAndEstablish:(long long)a0 idmsTargetContext:(id)a1 idmsCuttlefishPassword:(id)a2 notifyIdMS:(BOOL)a3 accountSettings:(id)a4 isGuitarfish:(BOOL)a5 error:(id *)a6;
