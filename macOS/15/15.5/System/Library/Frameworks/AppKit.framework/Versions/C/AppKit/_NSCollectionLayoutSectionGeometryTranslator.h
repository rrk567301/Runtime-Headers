...
- (id)initWithContentSize:(struct CGSize { double x0; double x1; })a0 layoutAxis:(int)a1 layoutRTL:(BOOL)a2 sectionInsets:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a3 supplementaryInsets:(struct NSDirectionalEdgeInsets { double x0; double x1; double x2; double x3; })a4;
