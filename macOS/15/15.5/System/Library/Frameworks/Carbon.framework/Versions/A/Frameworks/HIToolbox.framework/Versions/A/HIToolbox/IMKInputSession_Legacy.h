@class IMKClient_Legacy, NSString, NSXPCConnection, NSMutableDictionary, NSMutableArray;

@interface IMKInputSession_Legacy : NSObject <IMKTextInput, IMKUnicodeTextInput, IMTSMSupport, IMKXPCSupport, IMKTextInput_FunctionRowUI, IMKTextInput_AutoCorrection, IMKTextInput_NSAppearance> {
