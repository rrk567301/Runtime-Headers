...
- (id)init_driver_interface:(struct AudioServerPlugInDriverInterface **)a0 invalidation_handler:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[24]; } x0; void *x1; } x0; })a1;
