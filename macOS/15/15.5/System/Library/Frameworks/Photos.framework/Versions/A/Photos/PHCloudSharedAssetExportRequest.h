...
- (void)_requestFileURLsForAsset:(id)a0 withOptions:(id)a1 networkAccessAllowed:(BOOL)a2 progressHandler:(id /* block */)a3 resultHandler:(id /* block */)a4 resultHandlerQueue:(id)a5;
- (int)_requestImageURLForAsset:(id)a0 networkAccessAllowed:(BOOL)a1 progressHandler:(id /* block */)a2 resultHandler:(id /* block */)a3 resultHandlerQueue:(id)a4;
- (void)_requestLivePhotoURLsForAsset:(id)a0 networkAccessAllowed:(BOOL)a1 progressHandler:(id /* block */)a2 resultHandler:(id /* block */)a3 resultHandlerQueue:(id)a4;
- (int)_requestVideoURLForAsset:(id)a0 networkAccessAllowed:(BOOL)a1 progressHandler:(id /* block */)a2 resultHandler:(id /* block */)a3 resultHandlerQueue:(id)a4;
