...
+ (id)createActivityEpilogueDictionary:(struct nw_activity_epilogue_report_s { unsigned long long x0; struct nw_activity_report_s { unsigned long long x0; unsigned int x1; unsigned int x2; unsigned char x3[16]; unsigned char x4[16]; char x5[256]; unsigned char x6 : 1; unsigned char x7 : 7; unsigned char x8[7]; } x1; unsigned int x2; int x3; int x4; int x5; char x6[256]; unsigned char x7[0]; })a0;

- (void).cxx_destruct;
- (id)initWithJSONData:(id)a0;
- (id)initWithNWActivityEpilogueReport:(struct nw_activity_epilogue_report_s { unsigned long long x0; struct nw_activity_report_s { unsigned long long x0; unsigned int x1; unsigned int x2; unsigned char x3[16]; unsigned char x4[16]; char x5[256]; unsigned char x6 : 1; unsigned char x7 : 7; unsigned char x8[7]; } x1; unsigned int x2; int x3; int x4; int x5; char x6[256]; unsigned char x7[0]; } *)a0 length:(unsigned long long)a1;
