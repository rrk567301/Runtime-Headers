...
+ (BOOL)_evaluateCycleSecurityRules:(struct NSKeyedUnarchiverCycleEvaluationRules { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; } *)a0;
...
- (BOOL)_validateAllowedClassesContainsClassOfReference:(id)a0 forKey:(id)a1;
