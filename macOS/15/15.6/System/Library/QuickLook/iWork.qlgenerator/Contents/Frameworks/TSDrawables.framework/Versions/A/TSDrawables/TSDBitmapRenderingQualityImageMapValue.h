...
- (struct CGImage { } *)degradedImageRefForProvider:(id)a0 quality:(unsigned long long)a1 canvasScale:(double)a2;
- (struct CGImage { } *)getDegradedImageRefFromProvider:(id)a0 quality:(unsigned long long)a1 canvasScale:(double)a2;
