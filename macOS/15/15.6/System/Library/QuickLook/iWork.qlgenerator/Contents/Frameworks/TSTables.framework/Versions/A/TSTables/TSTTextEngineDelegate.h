...
- (void).cxx_destruct;
- (id)initWithPadding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a0 verticalAlignment:(int)a1 locale:(id)a2 shouldHyphenate:(BOOL)a3 styleProvidingSource:(id)a4;
