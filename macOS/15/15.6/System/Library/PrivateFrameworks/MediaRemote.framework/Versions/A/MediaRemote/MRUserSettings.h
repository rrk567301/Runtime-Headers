...
@property (readonly, nonatomic) BOOL supportNativeToAirPlayASERetargetting;
...
@property (readonly, nonatomic) BOOL preferRoutesMatchingMediaType;
@property (readonly, nonatomic) BOOL showRouteRecommendationsOutsideApps;
@property (readonly, nonatomic) BOOL undoUnusedAutoRoutes;
...
@property (readonly, nonatomic) BOOL sourceRecommendationsPlattersFromIR;
@property (readonly, nonatomic) BOOL watchIntentionalRouting;
