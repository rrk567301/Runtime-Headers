...
- (void)_reportMessageDictionaryForMessages:(id)a0 withLastAddressedHandle:(id)a1 maxMessageLength:(unsigned long long)a2 isAutoReport:(BOOL)a3 withChat:(id)a4 maxMessagesToReport:(unsigned long long)a5 totalMessageCount:(unsigned long long *)a6 isJunkReportedToCarrier:(BOOL)a7 reportReason:(unsigned long long)a8;
...
- (unsigned long long)markAsSpamForIDs:(id)a0 style:(unsigned char)a1 onServices:(id)a2 chatID:(id)a3 queryID:(id)a4 autoReport:(BOOL)a5 isJunkReportedToCarrier:(BOOL)a6 reportReason:(unsigned long long)a7;
