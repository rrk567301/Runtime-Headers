...
- (id)initWithStartTime:(double)a0 characteristics:(id)a1 hmdAccessory:(id)a2 hapAccessory:(id)a3 source:(unsigned long long)a4 isWriteOperation:(BOOL)a5 isTimedWrite:(BOOL)a6 isLocal:(BOOL)a7 transactionId:(id)a8 isCached:(BOOL)a9 bundleId:(id)a10 userUUID:(id)a11 writtenValues:(id)a12 readWriteLogEventManager:(id)a13;
- (void)markEndTime;
