...
+ (id)optionsWithSource:(unsigned long long)a0 destination:(unsigned long long)a1 label:(id)a2 mustReplay:(BOOL)a3 mustPush:(BOOL)a4 mustSaveArchiveAtomically:(BOOL)a5 cdTransactionAuthor:(unsigned long long)a6 clientIdentifier:(id)a7;
...
- (id)initWithSource:(unsigned long long)a0 destination:(unsigned long long)a1 label:(id)a2 mustReplay:(BOOL)a3 mustPush:(BOOL)a4 mustSaveArchiveAtomically:(BOOL)a5 cdTransactionAuthor:(unsigned long long)a6 clientIdentifier:(id)a7;
