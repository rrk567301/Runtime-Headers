...
- (void).cxx_destruct;
- (id)toDict;
- (id)initWithCharacterCount:(id)a0 hasChecklist:(id)a1 hasStyleFormatting:(id)a2 hasTable:(id)a3 hasAttachmentInlineDrawingV1:(id)a4 hasAttachmentInlineDrawingV2:(id)a5 hasAttachmentFullscreenDrawing:(id)a6 hasAttachmentOther:(id)a7 hasAttachedPhoto:(id)a8 weeksSinceCreation:(id)a9 hasAttachmentRichUrl:(id)a10 hasAttachmentMapLink:(id)a11 hasTags:(id)a12 hasScannedDoc:(id)a13 countOfTags:(id)a14 countOfDistinctTags:(id)a15 hasMentions:(id)a16 countOfMentions:(id)a17 countOfDistinctMentions:(id)a18 hasPaperKitDrawing:(id)a19 hasPaperDocument:(id)a20 hasPdf:(id)a21 countOfNoteLinks:(id)a22 countOfDistinctNoteLinks:(id)a23 countOfFolderLinks:(id)a24 countOfDistinctFolderLinks:(id)a25 countOfAudioAttachments:(id)a26;
