@interface _TtCV10PegasusAPI23Snippetpb_MoviesSnippetP33_F199C19048C5BF86F0818B89959AB78D13_StorageClass : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ _titles;
    ...
    void /* unknown type, empty encoding */ _releaseDateSecs;
    ...
    void /* unknown type, empty encoding */ _isAppleOriginal;
    void /* unknown type, empty encoding */ _studios;
    void /* unknown type, empty encoding */ _contentRating;
    void /* unknown type, empty encoding */ _trailers;
    void /* unknown type, empty encoding */ _rottenTomatoReviews;
    void /* unknown type, empty encoding */ _tomatoMeter;
    void /* unknown type, empty encoding */ _freshReviewCount;
    void /* unknown type, empty encoding */ _certifiedFresh;
    void /* unknown type, empty encoding */ _rottenReviewCount;
    void /* unknown type, empty encoding */ _rottenTomatoURL;
    void /* unknown type, empty encoding */ _theaters;
    void /* unknown type, empty encoding */ _fandangoID;
    void /* unknown type, empty encoding */ _fandangoName;
    void /* unknown type, empty encoding */ _numScreenings;
    void /* unknown type, empty encoding */ _coverArt;
    void /* unknown type, empty encoding */ _isShowtimes;
    void /* unknown type, empty encoding */ _wikiID;
    void /* unknown type, empty encoding */ _imdbID;
    void /* unknown type, empty encoding */ _voiceOnlyActors;
    ...
    void /* unknown type, empty encoding */ _writers;
    void /* unknown type, empty encoding */ _producers;
