...
@property (nonatomic) BOOL hasPommesKnowledgeFallbackContext;
@property (retain, nonatomic) POMMESSchemaPOMMESKnowledgeFallbackOffered *pommesKnowledgeFallbackOffered;
@property (nonatomic) BOOL hasPommesKnowledgeFallbackOffered;
...
@property (nonatomic) BOOL hasPommesKnowledgeFallbackConfirmationOutcomeReceived;
...
@property (nonatomic) BOOL hasPommesKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown;
...
@property (nonatomic) BOOL hasPommesKnowledgeFallbackTurnOffAlwaysPromptOutcomeReceived;
