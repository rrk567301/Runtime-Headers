...
+ (void)updateTrialFactors:(id)a0 rolloutUpdateMode:(long long)a1 removeUnneededFactors:(BOOL)a2 expensiveNetworking:(BOOL)a3 updateCount:(unsigned long long)a4 storeManager:(id)a5 noRemovalNamespaces:(id)a6 assetSetNamespaces:(id)a7 progress:(id /* block */)a8 completion:(id /* block */)a9;
+ (void)updateTrialFromAssetSetUsages:(id)a0 rolloutUpdateMode:(long long)a1 expensiveNetworking:(BOOL)a2 storeManager:(id)a3 configurationManager:(id)a4 progress:(id /* block */)a5 completion:(id /* block */)a6;
