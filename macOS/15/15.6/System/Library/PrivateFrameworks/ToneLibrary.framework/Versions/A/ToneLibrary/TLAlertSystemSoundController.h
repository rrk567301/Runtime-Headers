...
+ (id)_optionsForSystemSoundAlert:(id)a0 withSound:(id)a1 isDeemphasized:(BOOL)a2;
+ (unsigned int)_soundBehaviorForAlert:(id)a0 withSound:(id)a1 isDeemphasized:(BOOL)a2;
