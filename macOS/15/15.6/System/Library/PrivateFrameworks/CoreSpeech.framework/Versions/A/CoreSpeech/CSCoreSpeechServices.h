...
+ (void)_voiceTriggerRTModelForVersion:(unsigned long long)a0 minorVersion:(unsigned long long)a1 accessoryRTModelType:(long long)a2 accessoryInfo:(id)a3 endpointId:(id)a4 downloadedModels:(id)a5 preinstalledModels:(id)a6 completion:(id /* block */)a7;
+ (void)clearTriggerCount;
+ (void)fetchRemoteVoiceTriggerAssetForLanguageCode:(id)a0 completion:(id /* block */)a1;
+ (void)getCSVoiceTriggerRTModelRequestOptions:(id)a0 completion:(id /* block */)a1;
...
+ (void)setDelayInterstitialSounds:(id)a0 level:(long long)a1;
+ (void)supportsMultiPhraseVoiceTriggerForEngineVersion:(id)a0 engineMinorVersion:(id)a1 accessoryRTModelType:(id)a2 completion:(id /* block */)a3;
+ (void)voiceTriggerJarvisLanguageList:(id)a0 jarvisSelectedLanguage:(id)a1 completion:(id /* block */)a2;
+ (void)voiceTriggerRTModelForVersion:(unsigned long long)a0 minorVersion:(unsigned long long)a1 accessoryRTModelType:(long long)a2 accessoryInfo:(id)a3 endpointId:(id)a4 downloadedModels:(id)a5 preinstalledModels:(id)a6 completion:(id /* block */)a7;
