...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })verticalBaselineInsetsForHeader:(BOOL)a0 isCompactTable:(BOOL)a1;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })verticalBaselineInsetsForRowsWithCompactTable:(BOOL)a0;
