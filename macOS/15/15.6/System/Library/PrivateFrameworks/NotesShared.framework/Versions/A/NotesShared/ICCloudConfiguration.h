...
@property (readonly, nonatomic) BOOL keychainFetchingEnabled;
...
@property (readonly, nonatomic) BOOL audioTranscriptPostProcessingEnabled;
@property (readonly, nonatomic) BOOL searchSubstringMatchingEnabled;
