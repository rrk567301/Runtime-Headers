...
+ (struct CGPoint { double x0; double x1; })denormalizePoint:(struct CGPoint { double x0; double x1; })a0 masterSize:(struct CGSize { double x0; double x1; })a1 flipYCoordinate:(BOOL)a2;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_reframeWithinVideo:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 isFixedFocus:(BOOL)a1 fixedFocusCenter:(struct CGPoint { double x0; double x1; })a2;
