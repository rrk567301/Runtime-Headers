...
- (id)initWithUserDefaultsStore:(id)a0 processLastRecordedExitTimeKey:(id)a1 resetStoreReadToken:(BOOL)a2 timestamp:(id)a3 osReasonDomain:(long long)a4 osReasonCode:(unsigned long long)a5 isCrash:(BOOL)a6 isJetsam:(BOOL)a7 errorRepresentation:(id)a8;
