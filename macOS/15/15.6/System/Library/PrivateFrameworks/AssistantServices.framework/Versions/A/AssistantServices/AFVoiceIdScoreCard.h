...
- (id)initWithSpIdAudioProcessedDuration:(id)a0 spIdUnknownUserScore:(id)a1 spIdKnownUserScores:(id)a2 spIdUserScoresVersion:(id)a3 spIdScoreThresholdingType:(id)a4 spIdAssetVersion:(id)a5 userClassified:(id)a6 userIdentityClassification:(long long)a7 lowScoreThreshold:(id)a8 highScoreThreshold:(id)a9 confidentScoreThreshold:(id)a10 deltaScoreThreshold:(id)a11 hasSufficientAudioProcessed:(long long)a12;
