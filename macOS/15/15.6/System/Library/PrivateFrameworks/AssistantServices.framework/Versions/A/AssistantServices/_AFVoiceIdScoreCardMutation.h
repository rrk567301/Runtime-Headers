...
- (void)setHasSufficientAudioProcessed:(long long)a0;
...
- (void)setConfidentScoreThreshold:(id)a0;
- (void)setDeltaScoreThreshold:(id)a0;
- (void)setHighScoreThreshold:(id)a0;
