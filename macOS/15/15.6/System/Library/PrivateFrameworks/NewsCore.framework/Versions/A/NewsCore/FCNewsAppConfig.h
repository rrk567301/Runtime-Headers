...
@property (readonly, nonatomic) BOOL adSponsorshipsEnabled;
...
@property (readonly, nonatomic) BOOL feedDifferentiationModeEnabled;
...
@property (readonly, nonatomic) BOOL respectRecipeChannelGroupingEligibility;
