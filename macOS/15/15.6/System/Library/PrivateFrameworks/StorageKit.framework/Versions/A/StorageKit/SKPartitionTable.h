...
+ (BOOL)updatePartitionTypeWithPartitions:(id)a0 partID:(id)a1 newType:(id)a2 error:(id *)a3;

- (void)dealloc;
- (void).cxx_destruct;
- (BOOL)allocateMediaRef:(id *)a0;
...
- (BOOL)overwritePartitionAt:(id)a0 filesystem:(id)a1 error:(id *)a2;
- (BOOL)resizePartitionID:(id)a0 size:(unsigned long long)a1 offset:(unsigned long long)a2 error:(id *)a3;
