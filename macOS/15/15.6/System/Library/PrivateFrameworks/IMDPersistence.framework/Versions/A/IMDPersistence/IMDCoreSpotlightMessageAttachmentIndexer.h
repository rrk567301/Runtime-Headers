...
+ (id)assetUUIDKey;
+ (id)attachmentIndexTypeForPath:(id)a0 filename:(id)a1 isSticker:(BOOL)a2 isCommSafetySensitive:(BOOL)a3 knownSender:(BOOL)a4;
+ (id)attachmentIsSyndicatableMediaKey;
+ (id)attachmentRecordsFromAttachments:(id)a0;
+ (id)auxiliaryItemsForPrimaryAttributes:(id)a0 withItem:(id)a1 chat:(id)a2 isReindexing:(BOOL)a3 timingProfiler:(id)a4 rejectedItems:(id)a5;
