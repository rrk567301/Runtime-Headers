...
- (id)effectiveSectionInfoWithDefaultContentPreviewSetting:(long long)a0 globalAnnounceSetting:(long long)a1 globalScheduledDeliverySetting:(long long)a2 hasPairedVehiclesForCarPlay:(BOOL)a3 hasDestinationForRemoteNotifications:(BOOL)a4;
- (id)effectiveSectionInfoWithFactoryInfo:(id)a0 defaultContentPreviewSetting:(long long)a1 globalAnnounceSetting:(long long)a2 globalScheduledDeliverySetting:(long long)a3 hasPairedVehiclesForCarPlay:(BOOL)a4 hasDestinationForRemoteNotifications:(BOOL)a5;
