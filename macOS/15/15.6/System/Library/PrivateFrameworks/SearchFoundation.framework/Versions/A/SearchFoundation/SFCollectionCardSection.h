@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFCommandButtonItem, NSString, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, SFCollectionStyle;
