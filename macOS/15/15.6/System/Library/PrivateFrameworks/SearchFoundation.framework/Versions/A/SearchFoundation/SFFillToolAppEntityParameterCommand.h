@class NSString, NSDictionary, NSData, SFAppEntityAnnotation, SFTopic, SFCommandReference;

@interface SFFillToolAppEntityParameterCommand : SFCommand <SFFillToolAppEntityParameterCommand, NSSecureCoding, NSCopying>
