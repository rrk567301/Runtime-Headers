@class SFCard, NSString, NSData, SFCardSection, NSArray, SFColor, NSDictionary, SFUserReportRequest, SFMediaMetadata, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
