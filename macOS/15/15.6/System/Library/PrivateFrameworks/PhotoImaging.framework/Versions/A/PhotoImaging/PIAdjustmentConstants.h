...
@property (readonly, nonatomic) NSString *PIInpaintAdjustmentKey;
...
@property (readonly, nonatomic) NSString *PICinematicAudioAdjustmentKey;
@property (readonly, nonatomic) NSString *PISemanticStyleAdjustmentKey;
