@class PLGraphCache, NSPersistentStore, NSURL, PLCoreAnalyticsEventManager, PLPhotoLibraryPathManager, NSString, NSDictionary, NSPersistentStoreCoordinator, PLModelMigrationHistory, PLLazyObject;
