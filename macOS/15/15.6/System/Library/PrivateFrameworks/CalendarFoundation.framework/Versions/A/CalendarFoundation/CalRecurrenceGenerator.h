...
- (id)copyOccurrenceDatesBetweenStartDate:(id)a0 endDate:(id)a1 timeZone:(id)a2 limit:(long long)a3 plusExtraOccurrencePastEnd:(BOOL)a4;
- (id)copyOccurrenceDatesBetweenStartDate:(id)a0 endDate:(id)a1 timeZone:(id)a2 plusExtraOccurrencePastEnd:(BOOL)a3;
