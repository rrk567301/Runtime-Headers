...
- (id)visiblePredicate;
- (id)visibleReferencesForWorkflowIDs:(id)a0 sortBy:(unsigned long long)a1 nameContaining:(id)a2 nameEqualing:(id)a3 hasAssociatedAppBundleIdentifier:(BOOL)a4 associatedAppBundleIdentifier:(id)a5 hasTombstonedConflicts:(BOOL)a6 isRecentlyModified:(BOOL)a7 isRecentlyRun:(BOOL)a8 limitTo:(unsigned long long)a9;
- (id)visibleReferencesForWorkflowIDs:(id)a0 sortByKeys:(id)a1 nameContaining:(id)a2 nameEqualing:(id)a3 hasAssociatedAppBundleIdentifier:(BOOL)a4 associatedAppBundleIdentifier:(id)a5 hasTombstonedConflicts:(BOOL)a6 isRecentlyModified:(BOOL)a7 isRecentlyRun:(BOOL)a8 limitTo:(unsigned long long)a9;
