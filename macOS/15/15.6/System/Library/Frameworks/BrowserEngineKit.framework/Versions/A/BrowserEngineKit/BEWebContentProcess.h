...
+ (void)webContentProcessWithBundleID:(id)a0 interruptionHandler:(id /* block */)a1 completion:(id /* block */)a2;
+ (void)webContentProcessWithInterruptionHandler:(id /* block */)a0 completion:(id /* block */)a1;
