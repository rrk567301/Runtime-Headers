...
- (id)__initWithFormat:(id)a0 attributeOptions:(unsigned long long)a1 formattingOptions:(id)a2 locale:(id)a3 context:(id)a4 arguments:(char *)a5;
- (BOOL)_attributesAreEqualToAttributesInAttributedString:(id)a0;
...
- (id)initWithFormat:(id)a0 options:(unsigned long long)a1 locale:(id)a2 context:(id)a3 arguments:(char *)a4;
