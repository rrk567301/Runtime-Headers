...
- (struct CGPoint { double x0; double x1; })_interpolatedPointForSplineSegment:(long long)a0 t:(double)a1 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2;
- (double)_interpolatedTimeForSplineSegment:(long long)a0 t:(double)a1;
- (double)_lengthOfSplineSegment:(unsigned long long)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
- (struct CGPoint { double x0; double x1; })_splineControlPoint:(long long)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1;
- (double)_strokeLength;
- (void)enumeratePointsWithDataStep:(double)a0 usingBlock:(id /* block */)a1;
