...
- (void)payloadTestRequestWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)timeSnapshotWithCompletion:(id /* block */)a0;
- (void)timeSnapshotWithParams:(id)a0 completion:(id /* block */)a1;
