...
- (id)readAttributeAirflowDirectionWithParams:(id)a0;
...
- (void)writeAttributeAirflowDirectionWithValue:(id)a0 expectedValueInterval:(id)a1;
- (void)writeAttributeAirflowDirectionWithValue:(id)a0 expectedValueInterval:(id)a1 params:(id)a2;
