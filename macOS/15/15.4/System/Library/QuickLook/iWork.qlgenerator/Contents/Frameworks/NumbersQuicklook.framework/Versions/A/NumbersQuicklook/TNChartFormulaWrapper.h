...
- (struct vector<std::pair<TSCEValue *, TSUCellCoord>, std::allocator<std::pair<TSCEValue *, TSUCellCoord>>> { void *x0; void *x1; struct __compressed_pair<std::pair<TSCEValue *, TSUCellCoord> *, std::allocator<std::pair<TSCEValue *, TSUCellCoord>>> { void *x0; } x2; })outputVectorValuesWithChromeCoords:(id)a0 shouldSkipHiddenData:(BOOL)a1;
