@class NSNumber, MTRCameraAVSettingsUserLevelManagementClusterViewportStruct;
...
@property (copy, nonatomic) MTRCameraAVSettingsUserLevelManagementClusterViewportStruct *viewport;
