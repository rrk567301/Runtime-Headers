...
+ (void)readAttributeAirQualityWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeAirQualityWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeAirQualityWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
