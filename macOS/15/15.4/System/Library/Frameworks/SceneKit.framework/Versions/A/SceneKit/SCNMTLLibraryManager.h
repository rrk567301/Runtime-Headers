...
- (id)deviceQueue;
- (id)frameworkLibrary;
- (void)libraryForProgramDesc:(struct { struct __C3DFXMetalProgram *x0; struct __C3DMaterial *x1; struct __C3DGeometry *x2; struct __C3DFXPass *x3; struct __C3DFXPass *x4; struct __C3DBlendStates *x5; struct __C3DNode *x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; id x11; unsigned long long x12; unsigned char x13; unsigned char x14; id x15; struct { unsigned char x0; id /* block */ x1; } x16; unsigned long long x17; })a0 completionHandler:(id /* block */)a1;
