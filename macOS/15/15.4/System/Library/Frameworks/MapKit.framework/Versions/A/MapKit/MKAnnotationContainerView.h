...
- (BOOL)_view:(id)a0 containsPoint:(struct CGPoint { double x0; double x1; })a1;
...
- (BOOL)accessoryContainsPoint:(struct CGPoint { double x0; double x1; })a0;
...
- (void)setMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0;
