...
- (void)dealloc;
- (void).cxx_destruct;
- (BOOL)_encodeRenderToCommandBuffer:(id)a0 frameAttributes:(id)a1 sourceImage:(struct __CVBuffer { } *)a2 sourceDisparity:(struct __CVBuffer { } *)a3 destinationTexture:(id)a4;
