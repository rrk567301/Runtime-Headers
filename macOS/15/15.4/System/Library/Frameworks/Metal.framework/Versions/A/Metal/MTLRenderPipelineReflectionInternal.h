...
- (id)initWithObjectData:(id)a0 objectDynamicLibraries:(id)a1 meshData:(id)a2 meshDynamicLibraries:(id)a3 fragmentData:(id)a4 fragmentDynamicLibraries:(id)a5 device:(id)a6 options:(unsigned long long)a7 flags:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned long x11 : 53; })a8;
...
- (id)initWithTileData:(id)a0 tileDynamicLibraries:(id)a1 functionType:(unsigned long long)a2 device:(id)a3 options:(unsigned long long)a4 flags:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned long x11 : 53; })a5;
...
- (id)initWithVertexData:(id)a0 vertexDynamicLibraries:(id)a1 fragmentData:(id)a2 fragmentDynamicLibraries:(id)a3 serializedVertexDescriptor:(id)a4 device:(id)a5 options:(unsigned long long)a6 flags:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned long x11 : 53; })a7;
- (id)meshArguments;
...
- (void)setTileResourceBindingIndexRemappingTable:(id)a0;
