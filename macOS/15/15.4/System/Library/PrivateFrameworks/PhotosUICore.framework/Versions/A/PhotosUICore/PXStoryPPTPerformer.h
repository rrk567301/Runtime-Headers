...
- (void)_produceTimelineForViewConfiguration:(id)a0 recipeManagerWithProducedRecipe:(id)a1 initialCompletionHandler:(id /* block */)a2 finalCompletionHandler:(id /* block */)a3;
