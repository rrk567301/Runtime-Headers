...
- (void)_workQueue_requestVideoTexturesForSpriteAtIndex:(unsigned int)a0 spriteReference:(id)a1 displayAsset:(id)a2 presentationController:(id)a3 adjustment:(id)a4 presentationType:(unsigned char)a5 textureRequestID:(int)a6 mediaProvider:(id)a7 pixelBufferSourcesProvider:(id)a8 useLowMemoryMode:(BOOL)a9;
