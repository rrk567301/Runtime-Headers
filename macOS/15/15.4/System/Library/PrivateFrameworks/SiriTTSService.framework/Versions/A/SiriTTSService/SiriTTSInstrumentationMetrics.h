...
@property (nonatomic) void /* unknown type, empty encoding */ minimizeDeviceUsage;
...
@property (nonatomic) void /* unknown type, empty encoding */ synthesisQualityIssue;
@property (nonatomic) void /* unknown type, empty encoding */ useHydraFrontend;
...
@property (nonatomic) void /* unknown type, empty encoding */ deviceThermalState;
