@interface SiriVideoIntents.WatchSportsEventWrapperFlow : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ flowFactory;
    void /* unknown type, empty encoding */ deviceResolutionProvider;
    void /* unknown type, empty encoding */ deviceSelectionDonationProvider;
    void /* unknown type, empty encoding */ deviceResolutionAnalytics;
    ...
    void /* unknown type, empty encoding */ executionDevice;
}
