...
@interface GEOPDPlaceCollection : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_modifiedTime : 1; unsigned char has_errorState : 1; unsigned char has_numItems : 1; unsigned char has_enableFallbackImagesForItems : 1; unsigned char read_unknownFields : 1; unsigned char read_authorName : 1; unsigned char read_authorPhoto : 1; unsigned char read_collectionClassDisplayNames : 1; unsigned char read_collectionClassSpokenNames : 1; unsigned char read_collectionDescriptionBytes : 1; unsigned char read_collectionDescriptionHtmls : 1; unsigned char read_collectionDescriptions : 1; unsigned char read_collectionId : 1; unsigned char read_collectionItemDescriptionHtmls : 1; unsigned char read_collectionItemDescriptions : 1; unsigned char read_displayTitles : 1; unsigned char read_itemIds : 1; unsigned char read_itemPhotos : 1; unsigned char read_localizedCategorys : 1; unsigned char read_longSpokenTitles : 1; unsigned char read_longTitles : 1; unsigned char read_mediaLinks : 1; unsigned char read_photos : 1; unsigned char read_placeCollectionItems : 1; unsigned char read_publisherId : 1; unsigned char read_publisher : 1; unsigned char read_spokenTitles : 1; unsigned char read_url : 1; unsigned char wrote_anyField : 1; } _flags;
}
