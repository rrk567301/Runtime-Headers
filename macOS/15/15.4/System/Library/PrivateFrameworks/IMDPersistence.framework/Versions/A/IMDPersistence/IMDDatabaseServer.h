...
- (void)handleIMDAttachmentRecordsUpdateSyncStatusForGUIDs_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_respondWithHandleRecords:(id)a0 responseMessage:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)deleteAllDonationsForAppDeletion_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDAttachmentRecordCopySortedAttachmentsFilteredUsingPredicateWithLimit_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDChatRecordCopyDuplicateGroupChatRecords_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDChatRecordsUpdateSyncStatusForGUIDs_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDCoreSpotlightFetchClientState_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDCoreSpotlightInvalidateSpotlightClientStateVersioning_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDCoreSpotlightValidateClientState_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDCountOfRecordType_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDDeleteDatabase_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDFetchContactsForIdentifiers_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDHandleRecordCopyHandlesFilteredUsingPredicate_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDHandleRecordCopySortedHandlesFilteredUsingPredicateWithLimit_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageDeleteTombstonedScheduledMessagesWithRecordIDs_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDMessageRecordAddScheduledMessageGUIDandCKRecordToDeleteFromCloudKit_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDMessageRecordCalculateMessagesWithoutChatsCount_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDMessageRecordCalculateTotalMessageCount_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageRecordCopyAllUnreadMessages_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageRecordCopyScheduledMessagesForChatGUIDToLimit_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDMessageRecordCopyScheduledMessagesToDeleteFromCloudKitToLimit_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageRecordMarkGUIDsAsRead_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageRecordUpdateRecoverableMessageSyncStateForMessageGUIDs_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)handleIMDMessageRecordsUpdateSyncStatusForGUIDs_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
- (void)handleIMDMessageRecordsUpdateSyncedSyndicationRangesForGUIDsToStatus_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)notifyFirstUnlockComplete_IPCActionWithXPCConnection:(id)a0 requestMessage:(id)a1 responseMessage:(id)a2 completionHandler:(id /* block */)a3;
