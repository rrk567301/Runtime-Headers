...
- (id)initWithView:(id)a0 viewType:(unsigned long long)a1 finalLayoutAttributes:(id)a2 duration:(double)a3 startFraction:(double)a4 endFraction:(double)a5 animateFromCurrentPostion:(BOOL)a6 deleteAfterAnimation:(BOOL)a7 customAnimations:(id /* block */)a8;
