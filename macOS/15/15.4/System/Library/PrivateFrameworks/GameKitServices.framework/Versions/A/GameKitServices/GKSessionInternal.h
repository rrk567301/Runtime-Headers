...
- (void)handleNewGKOOBAudioMessage:(id)a0 messageData:(id)a1 remotePID:(unsigned int)a2 callbackData:(id *)a3 maxCallbackCount:(int)a4 checkDelegateCallbackSelector:(BOOL *)a5 tellDelegateSelector:(SEL *)a6 callbackCount:(int *)a7;
...
- (BOOL)sendVoiceChatData:(id)a0 toPeers:(id)a1 error:(id *)a2;
