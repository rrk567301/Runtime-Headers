...
- (id)initWithRequestId:(id)a0 inputOrigin:(id)a1 speechRecognitionTaskName:(unsigned long long)a2 speechRecognitionMode:(unsigned long long)a3 location:(id)a4 jitGrammar:(id)a5 overrideModelPath:(id)a6 applicationName:(id)a7 detectUtterances:(BOOL)a8 continuousListening:(BOOL)a9 shouldHandleCapitalization:(BOOL)a10 secureOfflineOnly:(BOOL)a11 maximumRecognitionDuration:(double)a12 recognitionOverrides:(id)a13 shouldStoreAudioOnDevice:(BOOL)a14 deliverEagerPackage:(BOOL)a15 enableEmojiRecognition:(BOOL)a16 enableAutoPunctuation:(BOOL)a17 UILanguage:(id)a18 enableVoiceCommands:(BOOL)a19 dictationUIInteractionId:(id)a20 sharedUserInfos:(id)a21 prefixText:(id)a22 postfixText:(id)a23 selectedText:(id)a24 powerContext:(id)a25 shouldStartAudioCapture:(BOOL)a26 audioCaptureStartHostTime:(unsigned long long)a27 audioRecordType:(long long)a28 audioRecordDeviceId:(id)a29 shouldGenerateVoiceCommandCandidates:(BOOL)a30 asrLocale:(id)a31;
...
- (id)initWithRequestId:(id)a0 inputOrigin:(id)a1 speechRecognitionTaskName:(unsigned long long)a2 speechRecognitionMode:(unsigned long long)a3 location:(id)a4 jitGrammar:(id)a5 overrideModelPath:(id)a6 applicationName:(id)a7 detectUtterances:(BOOL)a8 continuousListening:(BOOL)a9 shouldHandleCapitalization:(BOOL)a10 secureOfflineOnly:(BOOL)a11 maximumRecognitionDuration:(double)a12 recognitionOverrides:(id)a13 shouldStoreAudioOnDevice:(BOOL)a14 deliverEagerPackage:(BOOL)a15 enableEmojiRecognition:(BOOL)a16 enableAutoPunctuation:(BOOL)a17 enableVoiceCommands:(BOOL)a18 dictationUIInteractionId:(id)a19 sharedUserInfos:(id)a20 prefixText:(id)a21 postfixText:(id)a22 selectedText:(id)a23 powerContext:(id)a24 shouldStartAudioCapture:(BOOL)a25 audioCaptureStartHostTime:(unsigned long long)a26 audioRecordType:(long long)a27 audioRecordDeviceId:(id)a28 shouldGenerateVoiceCommandCandidates:(BOOL)a29 asrLocale:(id)a30;
