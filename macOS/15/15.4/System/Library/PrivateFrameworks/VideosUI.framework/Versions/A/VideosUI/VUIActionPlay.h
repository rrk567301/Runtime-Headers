...
+ (void)_playMediaInfo:(id)a0 multiviewMediaInfos:(id)a1 watchType:(long long)a2 extrasInfo:(id)a3 playType:(id)a4 isRentAndWatchNow:(BOOL)a5 targetResponder:(id)a6 completion:(id /* block */)a7;
+ (void)_playPlayables:(id)a0 multiviewPlayables:(id)a1 appContext:(id)a2 watchType:(long long)a3 isUpNextPlayback:(BOOL)a4 userPlaybackInitiationDate:(id)a5 openURLCompletionDate:(id)a6 playType:(id)a7 playbackContext:(unsigned long long)a8 targetResponder:(id)a9;
...
+ (void)presentPlaybackWithMediaInfo:(id)a0 multiviewMediaInfos:(id)a1 extrasInfo:(id)a2 isCoWatching:(BOOL)a3 watchType:(long long)a4 playType:(id)a5 allowsCellular:(BOOL)a6 previewMetadata:(id)a7 targetResponder:(id)a8 completion:(id /* block */)a9;
