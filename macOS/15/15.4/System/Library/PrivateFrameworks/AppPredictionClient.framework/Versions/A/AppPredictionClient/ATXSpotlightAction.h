...
+ (id)actionIdentifierFromTopic:(id)a0;
+ (unsigned long long)instanceIdentifierFromTopic:(id)a0;
+ (id)spotlightActionTypeFromTopic:(id)a0;
...
- (id)initWithEntityName:(id)a0 qid:(id)a1 criteria:(id)a2;
- (id)initWithFlightCode:(id)a0 date:(id)a1 criteria:(id)a2;
- (id)initWithMediaName:(id)a0 identifier:(id)a1 criteria:(id)a2;
- (id)initWithWeatherLatitude:(double)a0 longitude:(double)a1 criteria:(id)a2;
...
- (id)initWithSportsTeamName:(id)a0 qid:(id)a1 criteria:(id)a2;
