...
+ (BOOL)receiverIsCandidateForAppleSMSFilterSubClassificationWithSimSlot:(long long)a0;
+ (BOOL)receiverIsCandidateForDefaultAppleSMSFilter:(id)a0;
+ (BOOL)receiverIsCandidateForDefaultAppleSMSFilterWithSimSlot:(long long)a0;
+ (BOOL)receiverIsCandidateForHawking:(id)a0;
+ (BOOL)receiverIsCandidateForSMSFilter:(id)a0;
+ (BOOL)receiverIsCandidateForSMSFilterWithSimSlot:(long long)a0;
