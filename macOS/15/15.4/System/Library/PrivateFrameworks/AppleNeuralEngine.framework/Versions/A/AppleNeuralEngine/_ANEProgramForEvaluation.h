...
- (BOOL)processRequest:(id)a0 model:(id)a1 qos:(unsigned int)a2 qIndex:(unsigned long long)a3 modelStringID:(unsigned long long)a4 options:(id)a5 returnValue:(unsigned int *)a6 error:(id *)a7;
- (BOOL)processSessionHint:(id)a0 options:(id)a1 report:(id)a2 error:(id *)a3;
