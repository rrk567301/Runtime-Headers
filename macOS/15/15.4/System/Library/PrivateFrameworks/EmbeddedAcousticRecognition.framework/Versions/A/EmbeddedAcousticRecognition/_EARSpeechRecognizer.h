...
@property (readonly, nonatomic) BOOL isLegacyVoiceCommandRequest;
...
+ (void)initialize;
+ (void)ConvertCXXExceptionToNSException:(id /* block */)a0;
+ (id)EARErrorWithCode:(long long)a0 localizedDescription:(id)a1;
+ (BOOL)ConvertCXXExceptionToNSError:(id /* block */)a0 error:(id *)a1;
+ (long long)EARErrorCodeForExceptionMessage:(id)a0;
+ (void)EARSetError:(id *)a0 error:(id)a1;
