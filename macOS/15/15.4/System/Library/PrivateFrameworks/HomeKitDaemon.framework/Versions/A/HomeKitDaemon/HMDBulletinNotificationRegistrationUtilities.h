...
+ (id)endpointRegistrationFromLocalRegistration:(id)a0;
+ (id)matterRegistrationFromLocalRegistration:(id)a0 home:(id)a1;
+ (id)matterRegistrationFromMKFRegistration:(id)a0 home:(id)a1;
