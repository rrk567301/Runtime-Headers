@class NSData, RFTextProperty, NSArray, NSString, SFCard, SFColor, NSDictionary, SFButtonItem, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
