@class SFCard, NSData, NSArray, SFCATModel, NSString, SFColor, NSDictionary, SFUserReportRequest, SFPatternModel, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
