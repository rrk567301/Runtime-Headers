@class NSData, NSString, NSURL, NSArray, SFMessageAttachment, SFCard, NSDictionary, SFColor, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
