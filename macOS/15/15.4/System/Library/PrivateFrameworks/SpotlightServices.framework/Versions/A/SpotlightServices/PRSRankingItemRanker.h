...
- (void)updateScoresForPreparedItems:(id)a0 isCJK:(BOOL)a1 clientBundleID:(id)a2 thresholdValue:(double)a3 queryNodeMatchInfo:(id)a4 collectL2Signals:(BOOL)a5 isCardSearch:(BOOL)a6;
...
- (id)rankingConfigurationWithMeContact:(id)a0 emailAddresses:(id)a1 phoneFavorites:(id)a2 vipList:(id)a3 clientBundle:(id)a4 isScopedSearch:(BOOL)a5 isAdvancedSyntax:(BOOL)a6 spotlightQuery:(id)a7 userQuery:(id)a8 tokenString:(id)a9 queryKind:(unsigned long long)a10 isPeopleSearch:(BOOL)a11 isSearchToolClient:(BOOL)a12 keyboardLanguage:(id)a13;
