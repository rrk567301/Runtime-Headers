...
- (void)dealloc;
- (id)filtersForSemanticStyle:(id)a0 sceneType:(int)a1 personSegmentationEnabled:(BOOL)a2 maskVisualizationEnabled:(BOOL)a3 applyStyleBackgroundToEntireFrame:(BOOL)a4 filtersToCombine:(id)a5;
