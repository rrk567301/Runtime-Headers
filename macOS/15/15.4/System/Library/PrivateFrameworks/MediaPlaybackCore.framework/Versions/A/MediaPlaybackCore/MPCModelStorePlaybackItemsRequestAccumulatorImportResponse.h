...
@property (readonly, nonatomic) struct MPCModelStorePlaybackItemsRequestAccumulatorResult { BOOL didFinishEntireRequest; BOOL didFinishPrioritizedBatch; BOOL hasPrioritizedItemsToLoad; } accumulatorImportResult;
