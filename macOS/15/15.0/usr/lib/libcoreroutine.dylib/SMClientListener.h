@class SMDeviceConfigurationChecker, NSXPCInterface, SMSuggestionsManager, RTDefaultsManager, RTPlatform, SMSuggestionsHelper, SMEligibilityChecker, SMSessionStore, NSString, SMReceiverService, SMInitiatorService, SMSuggestionsStore, RTAuthorizationManager, SMMessagingService, RTDistanceCalculator;
