@class RTDeviceLocationPredictor, RTContactsManager, RTMapServiceManager, RTNavigationManager, RTLearnedLocationStore, SMSessionStore, NSString, RTLearnedLocationManager, RTHealthKitManager, RTLocation, RTLocationManager, RTAuthorizationManager, RTDistanceCalculator;
...
- (id)initWithAuthorizationManager:(id)a0 contactsManager:(id)a1 deviceLocationPredictor:(id)a2 distanceCalculator:(id)a3 healthKitManager:(id)a4 learnedLocationStore:(id)a5 learnedLocationManager:(id)a6 locationManager:(id)a7 mapServiceManager:(id)a8 navigationManager:(id)a9 sessionStore:(id)a10;
