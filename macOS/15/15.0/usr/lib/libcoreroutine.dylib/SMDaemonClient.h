@class SMDeviceConfigurationChecker, RTDistanceCalculator, NSObject, SMSuggestionsManager, RTDefaultsManager, RTEntitlementProvider, RTPlatform, SMSuggestionsHelper, SMEligibilityChecker, SMSessionStore, NSString, SMReceiverService, SMInitiatorService, SMSuggestionsStore, NSXPCConnection, SMMessagingService, RTAuthorizationManager;
