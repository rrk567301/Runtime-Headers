...
+ (void)checkInitiatorEligibilityWithQueue:(id)a0 authorizationManager:(id)a1 effectivePairedDevice:(id)a2 isHandoff:(BOOL)a3 defaultsManager:(id)a4 platform:(id)a5 handler:(id /* block */)a6;
