...
+ (id)_performDisambiguationForLocationName:(id)a0 expansionStringValues:(id)a1 photosEntityStore:(id)a2 photoLibrary:(id)a3;
+ (id)_performDisambiguationForPersonName:(id)a0 expansionStringValuesByCSAttributedEntityType:(id)a1 photosEntityStore:(id)a2 photoLibrary:(id)a3;
...
+ (id)performDisambiguationForLocationName:(id)a0 expansionStringValues:(id)a1 photoLibrary:(id)a2;
