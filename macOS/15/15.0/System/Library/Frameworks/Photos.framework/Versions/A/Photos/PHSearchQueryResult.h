...
- (id)initWithSearchQuery:(id)a0 searchResults:(id)a1 unfilteredAssetSearchResults:(id)a2 rankedAssetSearchResults:(id)a3 rankedCollectionSearchResults:(id)a4 searchSuggestions:(id)a5 queryMatchDetails:(id)a6 annotatedQueryString:(id)a7 queryStringReceivedFromSpotlight:(id)a8;
