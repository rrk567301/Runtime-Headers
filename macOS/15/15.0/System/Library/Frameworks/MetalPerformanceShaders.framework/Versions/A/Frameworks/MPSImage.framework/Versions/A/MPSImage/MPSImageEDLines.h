@class MPSImageAreaMax, MPSImageGaussianBlur, MPSImageConvolution;
...
@property (nonatomic) unsigned short minLineLength;
@property (nonatomic) unsigned long long maxLines;
@property (nonatomic) unsigned short detailRatio;
...
- (void)encodeInternalToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceTexture:(id)a2 destinationTexture:(id)a3 endpointBuffer:(id)a4 endpointOffset:(unsigned long long)a5 inputExtent:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; })a6;
- (void)encodeToCommandBuffer:(id)a0 sourceTexture:(id)a1 destinationTexture:(id)a2 endpointBuffer:(id)a3 endpointOffset:(unsigned long long)a4;
- (void)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceTexture:(id)a2 destinationTexture:(id)a3 endpointBuffer:(id)a4 endpointOffset:(unsigned long long)a5;
- (id)initWithDevice:(id)a0 gaussianSigma:(float)a1 minLineLength:(unsigned short)a2 maxLines:(unsigned long long)a3 detailRatio:(unsigned short)a4 gradientThreshold:(float)a5 lineErrorThreshold:(float)a6 mergeLocalityThreshold:(float)a7;
