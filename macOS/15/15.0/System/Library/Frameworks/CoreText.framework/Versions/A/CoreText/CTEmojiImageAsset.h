...
- (void).cxx_destruct;
- (id)imageData;
- (id)_TFFDictionaryWithEmojiInfoAndAlignmentInset:(struct CGSize { double x0; double x1; })a0;
- (id)_attachmentProperties;
- (void)_finalizeImageData;
- (id)_imagePropertiesForImage:(struct CGImage { } *)a0 withAlignmentInset:(struct CGSize { double x0; double x1; })a1;
