@class NSURL, LNValue, NSProgress, LNExportedContentConfiguration, LNXPCListenerEndpointContainer, LNConfigurableQueryRequest, NSString, LNAction, LNQueryOutput, NSArray, NSNumber, NSXPCConnection, NSError, NSUUID;
