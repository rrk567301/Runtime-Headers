@class _SFSearchRequest, NSString, NSDictionary, NSURL, NSArray, SFSpeechLanguageModelConfiguration, NSNumber;

@interface SFSpeechRecognitionRequest : NSObject {
    BOOL _detectMultipleUtterances;
    NSNumber *_detectMultipleUtterancesOverride;
...
- (id)init;
- (void).cxx_destruct;
- (void)_setUseOnDeviceRecognition:(BOOL)a0;
