...
- (id)initWithLeftContext:(id)a0 rightContext:(id)a1 selectedText:(id)a2 geoLMRegionID:(id)a3 contextualStrings:(id)a4 contextualNamedEntities:(id)a5 profileData:(id)a6 jitProfileData:(id)a7;
