...
- (id)initWithFarField:(BOOL)a0 supplementalModelURL:(id)a1 modelOverrideURL:(id)a2 speechProfileURLs:(id)a3 taskForMemoryLock:(id)a4 atypicalSpeech:(BOOL)a5 enableParallelLoading:(BOOL)a6;
- (id)initWithFarField:(BOOL)a0 supplementalModelURL:(id)a1 modelOverrideURL:(id)a2 speechProfileURLs:(id)a3 userIdMask:(id)a4 taskForMemoryLock:(id)a5 atypicalSpeech:(BOOL)a6 enableParallelLoading:(BOOL)a7;
