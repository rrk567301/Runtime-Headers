@interface WKVideoLayerRemote : CALayer {
    struct ThreadSafeWeakPtr<WebKit::MediaPlayerPrivateRemote> { struct RefPtr<WTF::ThreadSafeWeakPtrControlBlock, WTF::RawPtrTraits<WTF::ThreadSafeWeakPtrControlBlock>, WTF::ThreadSafeWeakPtrControlBlockRefDerefTraits> { struct ThreadSafeWeakPtrControlBlock *m_ptr; } m_controlBlock; struct MediaPlayerPrivateRemote *m_objectOfCorrectType; } _mediaPlayerPrivateRemote;
