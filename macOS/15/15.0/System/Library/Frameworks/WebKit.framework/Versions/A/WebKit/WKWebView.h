...
@interface WKWebView : NSView <WebViewImplDelegate, NSUserInterfaceValidations, NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSScrollViewSeparatorTrackingAdapter, WKShareSheetDelegate, WTWritingToolsDelegate, NSTextInputTraits> {
    ...
    struct RetainPtr<NSMapTable<NSUUID *,WTSession *>> { void *m_ptr; } _writingToolsSessions;
...
- (void)_proofreadingSessionWithUUID:(id)a0 updateState:(unsigned char)a1 forSuggestionWithUUID:(id)a2;
...
- (void)_addTextAnimationForAnimationID:(id)a0 withData:(const struct TextAnimationData { unsigned char x0; struct UUID { unsigned __int128 x0; } x1; } *)a1;
...
- (void)_disableTextIndicatorStylingWithUUID:(id)a0;
...
- (id)_enableTextIndicatorStylingAfterElementWithID:(id)a0;
- (id)_enableTextIndicatorStylingForElementWithID:(id)a0;
...
- (void)_proofreadingSessionWithUUID:(id)a0 showDetailsForSuggestionWithUUID:(id)a1 relativeToRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
