...
- (id)initWithOriginatingRequestSpecifier:(id)a0 instanceLowResMaskArray:(id)a1 instanceFeatureKeyIndexMap:(id)a2 instanceMask:(struct __CVBuffer { } *)a3 numComponents:(unsigned long long)a4 regionOfInterest:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5;
