...
- (struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })generateMaskFromInstanceFeatures:(id)a0 toCategory:(int)a1 drawBox:(BOOL)a2 maskImageType:(int *)a3;
