...
- (void).cxx_destruct;
- (BOOL)_addInstanceMaskBuffersForCategory:(id)a0 toInstanceMaskArray:(id)a1 connectedComponentResult:(const void *)a2 featureInstanceMaskMap:(id)a3 options:(id)a4 error:(id *)a5;
...
- (id)errorForVNFgBgInstanceSegmenterErrorCode:(long long)a0 localizedDescription:(id)a1;
