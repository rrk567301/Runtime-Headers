...
+ (id)faceObservationWithRequestRevision:(unsigned long long)a0 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 roll:(id)a2 yaw:(id)a3 pitch:(id)a4 isBoundingBoxAligned:(BOOL)a5 alignedBoundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 landmarks:(id)a7 landmarks65:(id)a8 landmarkScore:(float)a9 isBlinking:(BOOL)a10 blinkScore:(float)a11;
+ (id)faceObservationWithRequestRevision:(unsigned long long)a0 boundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 roll:(id)a2 yaw:(id)a3 pitch:(id)a4 isBoundingBoxAligned:(BOOL)a5 alignedBoundingBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6 landmarks:(id)a7 landmarks65:(id)a8 landmarkScore:(float)a9 isBlinking:(BOOL)a10 blinkScore:(float)a11 faceOrientationIndex:(float)a12 faceJunkinessIndex:(float)a13;
