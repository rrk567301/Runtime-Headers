@class NSString, NSArray, _NSTextSmartReplyContext, TITextInputTraits, NSObject, NSTextInputContext, TUIKeyboardCandidateMultiplexer, _NSTextSmartReplyLastClosedContext;
