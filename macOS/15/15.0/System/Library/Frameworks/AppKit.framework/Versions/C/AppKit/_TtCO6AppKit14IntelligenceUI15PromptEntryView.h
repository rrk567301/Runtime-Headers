@interface _TtCO6AppKit14IntelligenceUI15PromptEntryView : NSView <NSTextFieldDelegate> {
    ...
    void /* unknown type, empty encoding */ _overrideLeadingImageAnimated;
...
- (void)control:(id)a0 didFailToValidatePartialString:(id)a1 errorDescription:(id)a2;
