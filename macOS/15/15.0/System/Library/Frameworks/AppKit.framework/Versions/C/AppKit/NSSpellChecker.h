...
- (id)createCorrectionPanelForView:(id)a0 correctionTag:(long long)a1;
...
- (void)showCorrectionIndicatorOfType:(long long)a0 primaryString:(id)a1 alternativeStrings:(id)a2 forStringInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 view:(id)a4 dismissalEventHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
