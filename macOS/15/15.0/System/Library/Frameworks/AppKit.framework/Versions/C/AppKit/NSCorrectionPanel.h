@class NSView, NSString, NSCorrectionTypedTextHighlightView, NSCorrectionShadowView, NSCorrectionTextView, NSPanel, NSDictionary, NSAttributedString, NSMutableArray, NSArray, NSVisualEffectView;
...
- (void)showPanelAtRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inView:(id)a1 primaryString:(id)a2 alternativeStrings:(id)a3 forType:(long long)a4 dismissalEventHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
