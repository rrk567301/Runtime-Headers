@class NSView, NSString, NSTextField, NSData, NSStackView, NSObject, LAUIAuthenticationView, ASCredentialRequestPaneContext, ASCredentialRequestButton;
...
- (id)initWithActivity:(id)a0 auditTokenData:(id)a1;
