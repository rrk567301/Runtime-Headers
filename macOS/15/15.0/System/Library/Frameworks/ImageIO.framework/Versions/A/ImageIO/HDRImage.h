...
+ (id)flexRangeParametersWithHeadroom:(double)a0 options:(id)a1;
+ (double)gainMapHeadroomForHDRGain:(double)a0 gainMapValue:(double)a1;
+ (BOOL)getColorTRC:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } *)a0 matrix:(struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } *)a1 toneMapping:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } *)a2 fromEDR:(float)a3 toTargetSpace:(struct CGColorSpace { } *)a4;
+ (BOOL)getColorTRC:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } *)a0 matrix:(struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } *)a1 toneMapping:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } *)a2 fromSourceSpace:(struct CGColorSpace { } *)a3 toEDR:(float)a4 toneMappingMode:(int)a5;
+ (BOOL)getColorTRC:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } *)a0 matrix:(struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } *)a1 toneMapping:(struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } *)a2 fromSourceSpace:(struct CGColorSpace { } *)a3 toTargetSpace:(struct CGColorSpace { } *)a4 options:(id)a5;
+ (BOOL)getComponentMin:(void *)a0 componentMax:(void *)a1 forPixelType:(int)a2 componentRange:(id)a3 bitDepth:(unsigned short)a4;
+ (BOOL)getGainMapHeadroom:(double *)a0 fromFlexGTCInfo:(id)a1;
...
+ (BOOL)getInputPixelRange:(struct { } *)a0 forPixelType:(int)a1 componentRange:(id)a2 bitDepth:(unsigned short)a3;
...
+ (BOOL)getOutputPixelRange:(struct { } *)a0 forPixelType:(int)a1 componentRange:(id)a2 bitDepth:(unsigned short)a3;
+ (BOOL)getOutputYCCMatrix:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a0 forYCCMatrixString:(id)a1;
+ (BOOL)getPixelType:(int *)a0 YCCMatrixString:(id *)a1 chromaSubsampling:(void *)a2 componentRange:(id *)a3 bitDepth:(unsigned short *)a4 forBuffer:(struct __CVBuffer { } *)a5;
...
- (BOOL)getInputColorTransform:(struct { struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } x0; struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } x1; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x2; } *)a0 toEDR:(float)a1;
...
- (BOOL)getInputImageTransform:(struct { struct { int x0; struct { } x1; struct { void /* unknown type, empty encoding */ x0[3]; } x2; struct { void /* unknown type, empty encoding */ x0[3]; } x3; } x0; struct { struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } x0; struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } x1; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x2; } x1; } *)a0 toEDR:(float)a1;
- (BOOL)getInputTransform:(struct { unsigned int x0; struct { struct { int x0; struct { } x1; struct { void /* unknown type, empty encoding */ x0[3]; } x2; struct { void /* unknown type, empty encoding */ x0[3]; } x3; } x0; struct { struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } x0; struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } x1; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x2; } x1; } x1; struct { struct { int x0; struct { } x1; struct { void /* unknown type, empty encoding */ x0[3]; } x2; struct { void /* unknown type, empty encoding */ x0[3]; } x3; } x0; struct { struct { int x0; struct { } x1; } x0; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x1; } x1; } x2; } *)a0 toEDR:(float)a1;
- (BOOL)getOutputColorTransform:(struct { struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x0; struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; BOOL x1; } x3; } x1; struct { int x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x1; void *x2; } x2; } *)a0 fromEDR:(float)a1;
