@class MTRDeviceController, NSDate, MTRAsyncWorkQueue, MTRDeviceConnectivityMonitor, MTRDeviceStorageBehaviorConfiguration, NSMutableDictionary, NSMutableArray, NSObject, NSMutableSet, NSNumber, NSCache;
