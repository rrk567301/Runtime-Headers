...
@property (copy, nonatomic) NSNumber *chargingEnabledUntil;
@property (copy, nonatomic) NSNumber *minimumChargeCurrent;
@property (copy, nonatomic) NSNumber *maximumChargeCurrent;
