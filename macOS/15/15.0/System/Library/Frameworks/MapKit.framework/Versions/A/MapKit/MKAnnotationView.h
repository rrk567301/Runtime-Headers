...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_calculatePresentationFrameForAccessoryView:(id)a0;
...
- (void)_showSelectionAccessoryView:(id)a0 animated:(BOOL)a1;
