...
- (void)pushRangeAndSpanningDependentsWithCounts:(void *)a0 fromCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } *)a1 cellIsInACycle:(BOOL)a2;
