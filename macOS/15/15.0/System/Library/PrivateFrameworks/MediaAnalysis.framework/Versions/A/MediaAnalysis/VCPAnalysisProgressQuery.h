...
+ (int)_queryProgressDetailExpress:(id *)a0 forPhotoLibrary:(id)a1 andTaskID:(unsigned long long)a2 extendedTimeoutBlock:(id /* block */)a3;
...
+ (unsigned long long)countAllAssetsForTaskID:(unsigned long long)a0 withPhotoLibrary:(id)a1 error:(id *)a2;
+ (unsigned long long)countProcessedAssetsForTaskID:(unsigned long long)a0 withPhotoLibrary:(id)a1 error:(id *)a2;
