@class PXStoryFadeOverlayLayout, PXStoryStyleSwitchingFullsizeLayout, NSShadow, PXGItemPlacement, PXGHostingControllerProposedSize, PXStoryFullsizeLayout, PXStoryScrollLayout, NSString, PXStoryThumbnailChromeLayout, PXStoryModel, PXGLayout;
