...
+ (id)activitiesFromCloudFeedEntries:(id)a0 inMostRecentOrder:(BOOL)a1 photoLibrary:(id)a2 plPhotoLibrary:(id)a3;
...
- (id)debugDescription;
- (void).cxx_destruct;
- (id)initWithPhotoLibrary:(id)a0 uuid:(id)a1 date:(id)a2 type:(long long)a3 isFromMe:(BOOL)a4 contributors:(id)a5 avatarConfigurations:(id)a6 albumGUID:(id)a7 albumName:(id)a8 message:(id)a9 keyAssetUUIDs:(id)a10 keyAssets:(id)a11 relatedCommentUUID:(id)a12 relatedUUIDs:(id)a13 underlyingObject:(id)a14;
