...
@property (class, readonly, nonatomic) BOOL isLemonadeUIEnabled;
...
@property (class, nonatomic) BOOL simulateLemonadeUIEnabled;
...
+ (BOOL)titleShouldBeUppercasedForStylePairing:(long long)a0 kind:(unsigned long long)a1;
