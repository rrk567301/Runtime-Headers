...
@property (readonly, nonatomic) BOOL lemonadeActivityFeedUseActivityEntries;
...
@property (readonly, nonatomic) BOOL useLemonadeSettingsView;
@property (readonly, nonatomic) BOOL showPublishingButtonSpinner;
@property (readonly, nonatomic) BOOL showPublishingProgressDialog;
