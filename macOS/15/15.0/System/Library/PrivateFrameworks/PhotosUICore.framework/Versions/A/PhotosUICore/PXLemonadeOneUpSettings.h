...
@property (nonatomic) BOOL requireLemonadeEnabled;
...
@property (nonatomic) BOOL chromeShadowsOverContent;
@property (nonatomic) double chromeShadowOpacity;
@property (nonatomic) double chromeButtonShadowRadius;
@property (nonatomic) double chromeTextShadowRadius;
...
@property (nonatomic) double legibilityTintDistanceToBaseline;
