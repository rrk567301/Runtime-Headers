...
- (void)logIntentFor:(id)a0 intent:(id)a1 completion:(id /* block */)a2;
- (void)disconnectForAppWithAppBundleId:(id)a0 placementId:(id)a1 completionHandler:(id /* block */)a2;
- (void)getSuggestionsForAppWithAppBundleId:(id)a0 placementId:(id)a1 entities:(id)a2 intentToSuggest:(id)a3 bridge:(id)a4 completionHandler:(id /* block */)a5;
