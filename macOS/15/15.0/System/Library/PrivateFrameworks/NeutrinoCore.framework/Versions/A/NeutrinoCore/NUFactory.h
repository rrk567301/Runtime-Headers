@class NSString, NURenderPipelineRegistry, NUPlatform, VNSession, NUPurgeableStoragePool, NURenderNodeCache, NURenderResourcePool, NUScheduler, NUCacheNodeRegistry, NURenderResultCache, NUSchemaRegistry, CIFilter;
