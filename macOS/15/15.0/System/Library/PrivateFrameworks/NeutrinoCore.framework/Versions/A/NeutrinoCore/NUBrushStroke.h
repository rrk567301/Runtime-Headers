...
- (void)_updateExtent;
- (id)ciImageTiled:(BOOL)a0 closed:(BOOL)a1 pressureMode:(long long)a2 alwaysUseCG:(BOOL)a3;
- (id)ciImageTiled:(BOOL)a0 closed:(BOOL)a1 pressureMode:(long long)a2 filled:(BOOL)a3 alwaysUseCG:(BOOL)a4;
