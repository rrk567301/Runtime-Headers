@class CWFSCNetworkConfiguration, CWFPrivateMACManager, CWFIO80211, CWFSCNetworkReachability, NSMutableDictionary, CWFKernelEventMonitor, NSSet, NSMutableSet, NSObject, NSOperationQueue, CWFNetworkProfile, CWFXPCConnection;
...
- (void)__updateWiFiNetworkInterfaces:(id)a0 reply:(id /* block */)a1;
