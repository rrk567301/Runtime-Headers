@class NSURL, NSMutableDictionary, NSURLResponse, NSDate, NSProgress, _WKDownload, NSObject, NSMutableArray, DownloadFile, NSString, NSSet, NSURLRequest, WBSCoalescedAsynchronousWriter, BrowserWindowController, NSOperationQueue, NSArray, NSData, NSTimer, NSError, NSUUID;
