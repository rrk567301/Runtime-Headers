...
+ (id)_webViewConfigurationForBrowsingMode:(unsigned long long)a0 profileIdentifier:(id)a1 relatedWebView:(id)a2 groupIdentifier:(id)a3 preferences:(id)a4 userContentController:(id)a5 jitEnabled:(BOOL)a6 preferencesManager:(id)a7;
+ (id)_webViewConfigurationForBrowsingMode:(unsigned long long)a0 profileIdentifier:(id)a1 relatedWebView:(id)a2 groupIdentifier:(id)a3 preferences:(id)a4 userContentController:(id)a5 webExtensionsController:(id)a6 jitEnabled:(BOOL)a7 preferencesManager:(id)a8;
...
+ (id)contentWebViewConfigurationForBrowsingMode:(unsigned long long)a0 profileIdentifier:(id)a1;
