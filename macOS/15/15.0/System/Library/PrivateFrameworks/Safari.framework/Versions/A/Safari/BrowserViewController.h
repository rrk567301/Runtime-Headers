...
@interface BrowserViewController : WebViewController <AppExtensionContentScriptMessageReceiver, AutoFillFunctionBarProviderDelegate, AutomaticBugCaptureObserver, BookmarksViewControllerDelegate, BrowserViewIconLoadingDelegate, DefaultBrowserBannerDelegate, FormAutoFillCompletionControllerObserver, FormMetadataObserver, NSOpenSavePanelDelegate, PagePreviewAnimationControllerDelegate, ReaderStateObserver, RemoteNotificationControllerClient, RemoteNotificationPermissionHandler, SandboxExtensionPresentationDelegate, TabDialogPresentationManagerDelegate, WBSCertificateWarningPageHandler, BrowserDiagnosticLoggingBiomeDelegate, WBSBiomeNavigationDonor, _WKAppHighlightDelegate, OnDeviceSummarizationDelegate, AssistantPopoverResultCollectionViewCellDelegate, WBSBrowsingAssistantControllerDelegate, PrivateBrowsingPrivacyProtectionsBannerDelegate, WBSQueryParameterFilteringDataQueueDelegate, WBSTranslationConsentAlertHelperDelegate, WBSTranslationContextDelegate, ScribbleUnifiedFieldOverlayControllerDelegate, WBSScribbleControllerDelegate, WBSSiriIntelligenceDonorTabDataProviding, AuthenticationSheetRequestDelegate, BrowserViewControllerLoading, MutableMediaSource, ReaderActivationDelegate, ReaderAvailabilityDelegate, SearchableWKViewCancelDelegate, TabDialogPresenter, WBSFluidProgressStateSource, WBSWebExtensionTab> {
    ...
    NSUUID *_readerSweepAnimationEffectUUID;
    unsigned long long _summaryChunksCount;
...
@property (readonly, nonatomic) BOOL webAppContentBlockersWereDisabledDuringLastLoad;
...
- (id)tabTitleForWebExtensionContext:(id)a0;
...
- (void)deselectForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)duplicateForWebExtensionContext:(id)a0 withOptions:(id)a1 completionHandler:(id /* block */)a2;
...
- (BOOL)isAudibleForWebExtensionContext:(id)a0;
...
- (BOOL)isShowingReaderModeForWebExtensionContext:(id)a0;
- (void)loadURL:(id)a0 forWebExtensionContext:(id)a1 completionHandler:(id /* block */)a2;
- (id)mainWebViewForWebExtensionContext:(id)a0;
- (void)muteForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (id)parentTabForWebExtensionContext:(id)a0;
- (id)pendingURLForWebExtensionContext:(id)a0;
- (void)pinForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)reloadForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)reloadFromOriginForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)selectForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)setParentTab:(id)a0 forWebExtensionContext:(id)a1 completionHandler:(id /* block */)a2;
- (BOOL)shouldGrantTabPermissionsOnUserGestureForWebExtensionContext:(id)a0;
- (struct CGSize { double x0; double x1; })sizeForWebExtensionContext:(id)a0;
- (void)toggleReaderModeForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)unmuteForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
- (void)unpinForWebExtensionContext:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_runScribbleAnimationForSelectedElement;
...
- (void)openFeedbackAppForScribbleReport;
...
- (struct CGImage { } *)scribbleController:(id)a0 snapshotForElement:(id)a1;
...
- (void)updateWebAppContentBlockersWereDisabledDuringLastLoadForNavigation:(id)a0;
