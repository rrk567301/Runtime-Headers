...
- (void)askDefaultBrowserToBeginAuthenticationSessionWithUUID:(id)a0 url:(id)a1 callback:(id)a2 usingEphemeralSession:(BOOL)a3 jitEnabled:(BOOL)a4 additionalHeaderFields:(id)a5 customAnchorCertificatesData:(id)a6 shouldFailOnHTTPErrorResponse:(BOOL)a7 completionHandler:(id /* block */)a8;
