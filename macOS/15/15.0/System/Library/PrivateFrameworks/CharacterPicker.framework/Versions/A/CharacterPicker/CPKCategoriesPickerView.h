@class NSView, NSMutableArray, CPKCategoryButton;
...
- (void)setIcon:(id)a0 accessibilityLabel:(id)a1 forPageIndex:(unsigned long long)a2 iconIndex:(unsigned long long)a3;
