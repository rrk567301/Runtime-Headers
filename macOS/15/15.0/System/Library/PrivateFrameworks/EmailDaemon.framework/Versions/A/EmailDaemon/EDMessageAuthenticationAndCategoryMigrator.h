...
@property (readonly, nonatomic) id<EFScheduler> backgroundMessageMigrationScheduler;
...
- (id)startMigrationIfNecessaryWithCategorizationQuery:(id)a0 authenticationQuery:(id)a1 completion:(id /* block */)a2;
- (id)startMigrationIfNecessaryWithCompletion:(id)a0;
