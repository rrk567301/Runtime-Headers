@class EDSenderPersistence, NSString, EMNSUserDefaultsBoolObserver, NSConditionLock, EDCategoryCoreAnalyticsLogger, EMCachingContactStore, NSObject, EDMessageCategorizationResult, ECDKIMVerifier, EDCategoryPersistence;
