@class NSString, EDMessagePersistence, EMQuery, EDMessageCategorizer, EFCancelationToken, EFLocked, NSObject, EDActivityPersistence, EDCategoryPersistence;
...
@property (nonatomic) BOOL canBeResumed;
...
@property (readonly, nonatomic) EMQuery *categorizationQuery;
@property (readonly, nonatomic) EFCancelationToken *categorizationCancelationToken;
...
+ (void)migrateCategoryForQuery:(id)a0 cancelationToken:(id)a1 reason:(long long)a2;
+ (void)migrateCategoryForQuery:(id)a0 cancelationToken:(id)a1 reason:(long long)a2 task:(id)a3;

- (void).cxx_destruct;
- (void)_categorizeMessageBatch:(id)a0 cancelationToken:(id)a1 reason:(long long)a2;
- (void)_categorizeMessagesForQuery:(id)a0 cancelationToken:(id)a1;
- (void)_endCategorizationTask:(id)a0;
- (void)_handleCategoryMigration:(id)a0;
- (void)_migrateCategoryForQuery:(id)a0 cancelationToken:(id)a1 reason:(long long)a2 task:(id)a3;
