@class EMCoreAnalyticsCollector, NSString, NSBackgroundActivityScheduler, NSSet, NSMutableDictionary, EDMailboxProvider, EDPersistenceDatabase, EDMailboxPersistenceStatistics;
