@class NSMutableDictionary, EDCategoryPersistence, EFSQLTableSchema, EDMessagePersistence, NSObject, NSMutableArray, NSString, EDPersistenceHookRegistry, EDPersistenceDatabase, NSMutableSet, EDThreadScopeManager, EFDebouncer, EMBlockedSenderManager;
...
- (unsigned long long)persistenceStateForThreadScope:(id)a0 wantsPrecomputed:(BOOL)a1;
