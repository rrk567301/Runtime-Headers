...
+ (void)initVideoFeatureStatusSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; unsigned long long x6; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; } x7; } *)a0;
...
- (int)selectDataPath;
- (void)sendDeviceStateMessageToParticipant:(id)a0 withStatus:(id)a1;
