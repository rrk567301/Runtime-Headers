...
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 endReason:(long long)a2 window:(id)a3;
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 endReason:(long long)a2 window:(id)a3 successHandler:(id /* block */)a4;
