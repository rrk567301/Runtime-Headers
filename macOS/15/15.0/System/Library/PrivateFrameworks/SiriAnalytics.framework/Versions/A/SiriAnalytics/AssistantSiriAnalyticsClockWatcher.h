@class NSString, SiriAnalyticsClientMessageStream, SiriAnalyticsMetadataExtractor, SiriAnalyticsClockInactivityScheduler, SiriAnalyticsSensitiveConditionsObservers, SiriAnalyticsInternalTelemetry, SiriAnalyticsDataCollectionPolicyClockObserver, SiriAnalyticsPreprocessor, SiriAnalyticsMetastore;
...
- (id)initWithInternalTelemetry:(id)a0 sensitiveConditionsObservers:(id)a1 clientMessageStream:(id)a2 preprocessor:(id)a3 metastore:(id)a4 scheduler:(id)a5 metadataExtractor:(id)a6 dataPolicyObserver:(id)a7;
