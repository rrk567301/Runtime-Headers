...
- (id)_attributedAssociatedMessageSummaryFromMessageSummaryInfo:(id)a0 isAdaptiveImageGlyphProvider:(id /* block */)a1 adaptiveImageGlyphProvider:(id /* block */)a2 effectString:(id)a3;
- (id)_convertDatabaseFormatAssociatedMessageSummaryToDisplayFormat:(id)a0 isAdaptiveImageGlyphProvider:(id /* block */)a1 adaptiveImageGlyphProvider:(id /* block */)a2;
...
- (id)backwardCompatibilityStringWithMessageSummaryInfo:(id)a0 isAdaptiveImageGlyphProvider:(id /* block */)a1;
...
- (id)previewAttributedStringWithMessageSummaryInfo:(id)a0 isAdaptiveImageGlyphProvider:(id /* block */)a1 adaptiveImageGlyphProvider:(id /* block */)a2 senderDisplayName:(id)a3 isFromMe:(BOOL)a4 effectString:(id)a5;
- (id)previewStringFormatForMessageSummaryInfo:(id)a0 adaptiveImageGlyphAvailable:(BOOL)a1 isFromMe:(BOOL)a2;
- (id)reactionStringWithAdaptiveImageGlyph:(id)a0;
