...
- (id)init;
- (void).cxx_destruct;
- (id)initWithSrResponse:(id)a0 threadIdentifier:(id)a1 type:(long long)a2 contentWarning:(long long)a3 error:(id)a4 modelInfoString:(id)a5 userFeedbackInputString:(id)a6;
- (void)printValues;
