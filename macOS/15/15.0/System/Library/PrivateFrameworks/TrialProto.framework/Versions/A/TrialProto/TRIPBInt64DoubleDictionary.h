...
- (void)setDouble:(double)a0 forKey:(long long)a1;
- (void)removeAll;
...
- (BOOL)getDouble:(double *)a0 forKey:(long long)a1;
- (id)initWithDoubles:(const double *)a0 forKeys:(const long long *)a1 count:(unsigned long long)a2;
- (void)removeDoubleForKey:(long long)a0;
