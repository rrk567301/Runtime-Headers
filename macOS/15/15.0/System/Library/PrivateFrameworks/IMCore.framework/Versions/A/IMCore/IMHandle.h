@class NSURL, IMBrand, NSDate, NSDictionary, IMAccount, IMBrandManager, NSMutableArray, DNDContactHandle, NSString, CNContact, NSSet, NSAttributedString, IMServiceImpl, NSData, NSNumber, NSArray;
