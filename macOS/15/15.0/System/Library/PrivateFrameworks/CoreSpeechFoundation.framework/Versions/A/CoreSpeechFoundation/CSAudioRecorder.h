@class NSHashTable, NSString, CSExclaveRecordClient, CSRemoteRecordClient, NSMutableDictionary, NSMutableSet, NSObject, CSAudioFileReader, AVVoiceController, CSReusableBufferPool;
@protocol OS_dispatch_queue, CSAudioSessionEventProvidingDelegate;

@interface CSAudioRecorder : NSObject <AVVoiceControllerRecordDelegate, CSAudioDecoderDelegate, CSAudioFileReaderDelegate, CSRemoteRecordClientDelegate, CSUserSessionActiveMonitorDelegate, CSExclaveRecordClientDelegate, CSAudioSessionEventProviding> {
    ...
    CSExclaveRecordClient *_exclaveAudioClient;
}
...
- (BOOL)startDeliverSecureAudioStreamWithRecordDeviceIndicator:(id)a0 error:(id *)a1;
