...
@interface MHSchemaMHOdldFalseTriggerMitigated : SISchemaInstrumentationMessage {
    struct { unsigned char odldScore : 1; unsigned char odldScoreThreshold : 1; unsigned char errorCode : 1; unsigned char anchorSocialScore : 1; unsigned char socialScore : 1; } _has;
}
