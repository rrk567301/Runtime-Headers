@class NSURL, NSMapTable, LNConnectionOptions, NSObject, RBSProcessMonitor, NSSet, NSString, LNConnectionManager, NSOperationQueue, NSMutableSet, NSNumber, NSXPCConnection, LNWatchdogTimer, LNUserIdentity;
...
@property (readonly, nonatomic) NSNumber *bundleType;
...
+ (id)getUIExtensionBundleIdentifiersForOnScreenBundles:(id)a0;
