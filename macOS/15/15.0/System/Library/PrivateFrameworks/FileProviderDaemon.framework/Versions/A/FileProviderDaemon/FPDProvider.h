...
- (void)dumpAllDomains:(id)a0 domains:(id)a1 auditToken:(struct { unsigned int x0[8]; })a2 request:(id)a3 providerFilter:(id)a4 limitNumberOfItems:(BOOL)a5 completionHandler:(id /* block */)a6;
- (void)dumpDomain:(id)a0 allowedToDump:(BOOL)a1 dumper:(id)a2 limitNumberOfItems:(BOOL)a3 request:(id)a4 completionHandler:(id /* block */)a5;
- (void)dumpStateTo:(id)a0 auditToken:(struct { unsigned int x0[8]; })a1 request:(id)a2 providerFilter:(id)a3 limitNumberOfItems:(BOOL)a4 completionHandler:(id /* block */)a5;
