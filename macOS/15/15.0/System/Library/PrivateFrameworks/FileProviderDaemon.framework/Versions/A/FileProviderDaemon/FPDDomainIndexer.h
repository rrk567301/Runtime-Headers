@class NSDate, NSString, NSError, FPDExtension, NSObject, FPDDomainIndexerState, FPDSharedScheduler, FPDDomain;
...
@property (class, readonly, nonatomic) FPDSharedScheduler *indexingScheduler;
