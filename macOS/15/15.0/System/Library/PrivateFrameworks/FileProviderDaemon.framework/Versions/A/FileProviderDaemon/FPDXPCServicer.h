...
- (void)dumpProviders:(id)a0 dumper:(id)a1 auditToken:(struct { unsigned int x0[8]; })a2 request:(id)a3 limitNumberOfItems:(BOOL)a4 providerFilter:(id)a5 completionHandler:(id /* block */)a6;
