...
- (void)_saveCorruptIndexWithPath:(id)a0 shouldSendABC:(BOOL)a1 fullyCreated:(BOOL)a2;
- (void)_scheduleStringsCleanupForBundleID:(id)a0;
- (void)_sendIndexDropABCEvent:(BOOL)a0;
...
- (void)indexFromBundle:(id)a0 personaID:(id)a1 options:(long long)a2 items:(id)a3 itemsText:(id)a4 clientState:(id)a5 expectedClientState:(id)a6 clientStateName:(id)a7 deletes:(id)a8 canCreateNewIndex:(BOOL)a9 completionHandler:(id /* block */)a10;
- (id)indexLossAnalyticsDictWithPreviousIndexCreationDate:(long long)a0 size:(long long)a1 openingInReadOnly:(BOOL)a2 fullyCreated:(BOOL)a3 forAnalytics:(BOOL)a4;
...
- (void)issueRepair;
- (void)issueSplit;
- (void)markAllFilesPurgeable:(id)a0 purgeableOrNot:(BOOL)a1;
...
- (void)writeIndexLossEventToFile:(id)a0;
