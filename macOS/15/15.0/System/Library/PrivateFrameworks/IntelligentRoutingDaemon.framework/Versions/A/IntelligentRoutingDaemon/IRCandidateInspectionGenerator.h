...
- (id)initWithClassification:(long long)a0 ClassificationDescription:(id)a1 sameSpaceBasedOnMiLo:(BOOL)a2 sameSpaceBasedOnBrokeredLOI:(BOOL)a3 sameSpaceBasedOnPDRFence:(BOOL)a4 sameSpaceBasedOnUWB:(BOOL)a5 sameSpaceBasedOnBLE:(BOOL)a6 candidateSelectorReasons:(id)a7 forCandidate:(id)a8;
