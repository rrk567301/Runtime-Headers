...
- (id)fetchRemindersWithParentReminderID:(id)a0 accountID:(id)a1 fetchOption:(long long)a2 error:(id *)a3;
...
- (id)fetchSubtasksOfParentReminder:(id)a0 fetchOption:(long long)a1 error:(id *)a2;
- (id)fetchSubtasksOfParentReminderChangeItem:(id)a0 fetchOption:(long long)a1 error:(id *)a2;
