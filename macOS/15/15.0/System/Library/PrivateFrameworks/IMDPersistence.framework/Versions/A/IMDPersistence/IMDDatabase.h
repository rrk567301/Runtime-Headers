...
@interface IMDDatabase : NSObject <IMDAttachmentQueries, IMDKeyValueQueries, IMDNotificationQueries, IMDChatQueries, IMDSpotlightQueries, IMDMessageQueries, IMDDatabaseQueries, IMDHandleQueries>
...
- (void)checkSpotlightIndexCountWithCompletion:(id /* block */)a0;
