@class NSMutableArray, _TtC26SensitiveContentAnalysisML26SCMLTextModerationLMFromMM, NSLocale;
...
- (void)doLLMBackend:(id)a0 withText:(id)a1 withResponder:(void *)a2;
- (void)doModeration:(id)a0 withResponder:(void *)a1;
- (void)sanitizeRequestAsynchronously:(id)a0 completionHandler:(id /* block */)a1;
- (id)sanitizeText:(id)a0 keepGoing:(BOOL)a1 error:(id *)a2;
