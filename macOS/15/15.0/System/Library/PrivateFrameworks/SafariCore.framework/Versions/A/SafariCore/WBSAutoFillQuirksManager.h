@class WBSAutoFillAssociatedDomainsManager, WBSChangePasswordURLManager, NSString, WBSPasswordGenerationManager, NSSet, WBSAppIDsToDomainsAssociationManager, WBSPasswordAuditingEligibleDomainsManager, WBSRemotelyUpdatableDataController;
