...
+ (id)latestObjectAssociatedWithObjectPID:(long long)a0 subObjectReference:(id)a1 dataTypes:(id)a2 associationType:(unsigned long long)a3 limit:(unsigned long long)a4 sortDescending:(BOOL)a5 profile:(id)a6 error:(id *)a7;
+ (id)latestObjectAssociatedWithObjectUUID:(id)a0 subObjectReference:(id)a1 dataTypes:(id)a2 associationType:(unsigned long long)a3 limit:(unsigned long long)a4 sortDescending:(BOOL)a5 profile:(id)a6 error:(id *)a7;
