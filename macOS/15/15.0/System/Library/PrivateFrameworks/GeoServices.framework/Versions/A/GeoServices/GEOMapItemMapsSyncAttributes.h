...
@interface GEOMapItemMapsSyncAttributes : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_mapsSyncIdentifier : 1; unsigned char read_mapsSyncObjectType : 1; unsigned char wrote_anyField : 1; } _flags;
}
