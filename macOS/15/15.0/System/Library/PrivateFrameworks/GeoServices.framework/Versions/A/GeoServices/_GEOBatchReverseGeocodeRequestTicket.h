@class GEODirectionIntent, GEOMapServiceTraits, GEOMapRegion, geo_isolater, GEOGuideSummaryLayoutMetadata, GEOMapItemIdentifier, GEOPDMerchantLookupResult, NSString, GEOResultRefinementGroup, GEOSearchRedoButtonThreshold, GEOPDPlaceSummaryLayoutMetadata, GEORelatedSearchSuggestion, GEOResolvedItem, NSArray, GEOSearchAutoRedoThreshold, GEOCategorySearchResultSection, GEOSearchSectionList, GEOSearchSessionData;
