...
@interface GEOPDPlaceSuggestionParameters : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_mapsCategoryIds : 1; unsigned char read_suggestedPlaceIds : 1; unsigned char read_viewportInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
