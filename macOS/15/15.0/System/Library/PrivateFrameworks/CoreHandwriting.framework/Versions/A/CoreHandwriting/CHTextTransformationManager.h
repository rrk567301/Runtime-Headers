...
+ (unsigned long long)ascendersCount:(id)a0;
...
+ (double)estimatedLeadingForTextLine:(id)a0;
...
+ (BOOL)hasAmbiguousCharacter:(id)a0;
+ (BOOL)hasAscender:(id)a0;
+ (BOOL)hasDescender:(id)a0;
...
- (id)initWithContextStrokes:(id)a0 relatedNonTextStrokes:(id)a1 contextResults:(id)a2 strokeGroupingResult:(id)a3 strokeClassificationResult:(id)a4 strokeProvider:(id)a5;
- (id)initWithContextStrokes:(id)a0 relatedNonTextStrokes:(id)a1 parameters:(id)a2 contextResults:(id)a3 strokeGroupingResult:(id)a4 strokeClassificationResult:(id)a5 strokeProvider:(id)a6;
