...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })boundsForStrokes:(id)a0;
...
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct __compressed_pair<CGPoint *, std::allocator<CGPoint>> { struct CGPoint *x0; } x2; })convexHullForStrokes:(id)a0;
+ (id)createDrawingForStrokeIdentifiers:(id)a0 strokeProvider:(id)a1 interpolationType:(long long)a2 resolution:(long long)a3 cancellationBlock:(id /* block */)a4;
+ (id)createDrawingForStrokes:(id)a0 interpolationType:(long long)a1 resolution:(long long)a2 cancellationBlock:(id /* block */)a3;
...
+ (double)distanceFromPoint:(struct CGPoint { double x0; double x1; })a0 toStroke:(id)a1 withStrokeProvider:(id)a2;
+ (double)distanceFromPoint:(struct CGPoint { double x0; double x1; })a0 toStrokes:(id)a1 withStrokeProvider:(id)a2;
+ (double)distanceFromRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
...
+ (double)horizontalDistanceBetweenRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 rectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
+ (double)horizontalOverlapOfIndividualStrokeBounds:(const void *)a0 otherStrokeBounds:(const void *)a1;
+ (struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *x0; struct CGRect *x1; struct __compressed_pair<CGRect *, std::allocator<CGRect>> { struct CGRect *x0; } x2; })horizontallyOverlappedChunks:(const void *)a0;
+ (BOOL)isMatchingStrokeClassification:(long long)a0 scriptClassification:(long long)a1;
+ (BOOL)isPointEnumerationSupportedForStroke:(id)a0;
+ (BOOL)isScriptClassificationMath:(long long)a0;
+ (BOOL)isStroke:(id)a0 intersectingPolygon:(id)a1;
+ (BOOL)isStrokeClassificationMath:(long long)a0;
+ (BOOL)isStrokeClassificationText:(long long)a0;
+ (BOOL)isStrokeClassificationTextOrMath:(long long)a0;
+ (double)lineOrientationForStrokePoints:(const void *)a0 error:(double *)a1;
+ (id)polygonForStrokes:(id)a0;
...
+ (id)sortedStrokesForIdentifiers:(id)a0 inStrokeProvider:(id)a1;
...
+ (id)strokesForIdentifiers:(id)a0 inStrokeProvider:(id)a1;
...
+ (double)verticalDistanceBetweenRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 rectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
