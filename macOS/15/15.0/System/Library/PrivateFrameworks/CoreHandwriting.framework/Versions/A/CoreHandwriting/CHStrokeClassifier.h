...
- (void).cxx_destruct;
- (id)initWithStrokeProvider:(id)a0 strokeClassificationLastResult:(id)a1 forceClass:(long long)a2;
...
- (id)refineStrokeClassificationResultUsingSortedTextStrokeGroups:(id)a0 strokeClassificationResult:(id)a1 cancellationBlock:(id /* block */)a2;
