@class NSData, NSString, NSArray, CHStrokeClutterFilter, CHStrokeClassificationResult, NSDictionary, CHRecognitionSessionAutoRefineResult, NSSet, CHStrokeGroupingResult;
...
@property (readonly, nonatomic) CHRecognitionSessionAutoRefineResult *autoRefineResult;
...
- (id)initWithStrokeProviderVersion:(id)a0 encodedStrokeProviderVersion:(id)a1 orderedStrokeIdentifiers:(id)a2 sessionMode:(long long)a3 locales:(id)a4 preferredLocales:(id)a5 declaredVariables:(id)a6 clutterFilter:(id)a7 strokeClassificationResult:(id)a8 strokeGroupingResult:(id)a9 rawStrokeGroupingResult:(id)a10 recognitionResults:(id)a11 rawRecognitionResults:(id)a12 inlineContinuousModeResults:(id)a13 autoRefineResult:(id)a14 generationDuration:(struct { double x0; double x1; double x2; double x3; double x4; double x5; })a15 recognitionEnvironment:(long long)a16;
