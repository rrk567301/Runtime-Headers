...
@property (readonly, nonatomic) BOOL isPersonalizedSynthesisModelReady;
...
- (id)initWithIsPersonalizationAvailable:(BOOL)a0 isPersonalizedSynthesisModelReady:(BOOL)a1 personalizedSynthesisModelVersion:(id)a2;
- (id)initWithIsPersonalizationAvailable:(BOOL)a0 isPersonalizedSynthesisModelReady:(BOOL)a1 personalizedSynthesisModelVersion:(id)a2 hasAllDigits:(BOOL)a3 styleSampleCount:(long long)a4 samplesWithoutStylePredictionCount:(long long)a5 characterCoverage:(id)a6 inventoryStorageURL:(id)a7 inventoryRelativePath:(id)a8;
