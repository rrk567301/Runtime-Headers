...
- (id)initWithStrokeClassificationsByStrokeIdentifier:(id)a0 scriptClassificationsByStrokeIdentifier:(id)a1 scriptClassificationRawResultsByStrokeIdentifier:(id)a2 substrokesByStrokeIdentifier:(id)a3 nontextCandidates:(id)a4;
