...
- (id)highConfidenceTextForSessionResult:(id)a0 averageTokenScore:(double *)a1 rejectionRate:(double *)a2 doesContainUnfilteredMultiLocaleResults:(BOOL *)a3;
...
- (id)mathStrokeGroupRecognitionResultByAppendingStrokeGroupRecognitionResult:(id)a0;
