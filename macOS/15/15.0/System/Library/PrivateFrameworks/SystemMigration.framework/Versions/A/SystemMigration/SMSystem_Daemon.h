...
- (void)generateAppsFileStep:(id *)a0;
- (void)generateAutoLoginUserStep:(id *)a0;
- (void)generateMachineSettingsStep:(id *)a0 shouldSetOnlyUpdateSystemSettings:(BOOL)a1;
- (void)generateMigrateGuestAccountStep:(id *)a0;
- (void)generatePeerToPeerStep:(id *)a0;
