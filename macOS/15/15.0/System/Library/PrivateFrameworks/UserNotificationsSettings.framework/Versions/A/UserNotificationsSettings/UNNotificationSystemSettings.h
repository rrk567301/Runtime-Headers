...
- (id)initWithShowPreviewsSetting:(long long)a0 announcementSetting:(long long)a1 announcementHeadphonesSetting:(long long)a2 announcementCarPlaySetting:(long long)a3 scheduledDeliverySetting:(long long)a4 scheduledDeliveryTimes:(id)a5 scheduledDeliveryShowNextSummarySetting:(long long)a6 notificationListDisplayStyleSetting:(long long)a7 remoteNotificationsSetting:(long long)a8 modifiedSettings:(unsigned long long)a9;
