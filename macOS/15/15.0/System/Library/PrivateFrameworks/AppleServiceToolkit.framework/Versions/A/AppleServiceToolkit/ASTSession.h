@class ASTContext, ASTRepairSession, NSString, NSObject, ASTRemoteServerSession;
...
+ (void)requestAsset:(id)a0 useEnvironmentAssetsURL:(BOOL)a1 customEndpoint:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)fetchAsset:(id)a0 sessionClass:(Class)a1 useEnvironmentAssetsURL:(BOOL)a2 customEndpoint:(id)a3 completionHandler:(id /* block */)a4;
