@class AMSURLMetricsLoadURLHandler, AMSURLSession, NSString;
...
- (id)initWithMetricsHandler:(id)a0;
...
- (BOOL)shouldEnableReversePushForTask:(id)a0 apsEnabledPatterns:(id)a1;
