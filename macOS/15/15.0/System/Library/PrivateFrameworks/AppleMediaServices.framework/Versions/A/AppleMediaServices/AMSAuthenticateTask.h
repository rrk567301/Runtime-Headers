@class NSUUID, NSString, NSDictionary, AMSAuthenticateOptions, AMSBagKeySet, AMSMutablePromise, NSMutableArray, NSNumber;
...
- (id)_signIntoOtherMediaTypeWithVerifiedAccount:(id)a0 andAuthKitUpdateResults:(id)a1;
