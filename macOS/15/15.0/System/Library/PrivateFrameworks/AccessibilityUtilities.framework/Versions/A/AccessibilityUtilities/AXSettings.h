@class NSURL, NSMutableDictionary, NSDate, NSDictionary, NSOrderedSet, _TtC22AccessibilityUtilities13AXPreferences, NSString, NSSet, NSMutableSet, NSArray, NSData, NSNumber, NSUUID;
...
@property (retain, nonatomic) _TtC22AccessibilityUtilities13AXPreferences *swiftSettings;
