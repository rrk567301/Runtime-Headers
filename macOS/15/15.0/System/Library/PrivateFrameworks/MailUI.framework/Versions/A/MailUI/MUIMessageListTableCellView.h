@class EFFuture, NSString, MessageListCellLayoutValuesHelper, MUIMessageListObjectProxy, MessageListCellLayoutValues, NSColor, MessageListCellViewModel, NSLayoutConstraint, NSButton, ToCCIndicator, MessageListCellHelper;
