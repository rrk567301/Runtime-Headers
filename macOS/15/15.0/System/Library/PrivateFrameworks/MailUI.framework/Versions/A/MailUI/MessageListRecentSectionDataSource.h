...
- (id)initWithIdentifier:(id)a0 section:(id)a1 collectionView:(id)a2 messageList:(id)a3 initialLoadCompletedPromise:(id)a4 layoutValuesHelper:(id)a5 state:(id)a6;
