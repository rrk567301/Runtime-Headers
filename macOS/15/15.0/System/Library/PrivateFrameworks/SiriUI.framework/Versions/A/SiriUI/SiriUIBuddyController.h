@class SiriUIBuddyImproveSiriController, NSDictionary, SiriUIBuddyEnableSiriController, NSImageView, AFVoiceInfo, SiriUIBuddyVoiceTriggerController, OBTemplateView, NSString, NSSet, NSLayoutConstraint, SiriUIBuddyVoiceTriggerIntroController, SSRVoiceProfile, SiriUIRemoteDeviceBrowser, NSViewController, NSView, SiriUIBuddyChooseVoiceController, SiriUIBuddyChooseLanguageController, SiriUIBuddyVoiceTriggerOutroController;
...
@property (nonatomic) BOOL isGMEnablementFlow;
