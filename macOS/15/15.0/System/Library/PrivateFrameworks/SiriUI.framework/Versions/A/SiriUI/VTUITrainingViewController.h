@class VTUITickMarkView, SUICOrbView, SSRVoiceProfile, SCDACoordinator, NSButton, SUICIntelligentLightLayer, NSString, SSRVTUITrainingManager, AFMyriadCoordinator, NSTimer, _TtC6SiriUI21GMEnrollmentViewModel, VTUIPagedLabel, NSArray, _TtC6SiriUI26GMEnrollmentViewController, AVAudioPlayer, NSTextField, NSUUID;
...
- (void)_playSoundForStage:(long long)a0 afterDelay:(double)a1;
