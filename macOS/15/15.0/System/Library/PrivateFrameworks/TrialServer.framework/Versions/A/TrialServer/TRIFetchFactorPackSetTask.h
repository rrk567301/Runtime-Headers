...
+ (id)taskWithFactorPackSetId:(id)a0 treatmentId:(id)a1 taskAttribution:(id)a2 experimentDeployment:(id)a3;
...
- (id)initWithFactorPackSetId:(id)a0 treatmentId:(id)a1 taskAttribution:(id)a2 experimentDeployment:(id)a3;
