...
+ (id)new;
+ (id)_calculateCommunicationPoliciesWithApplicationPoliciesByBundleIdentifier:(id)a0 categoryEffectivePolicy:(id)a1 applicationCategoryEffectivePolicy:(id)a2;
...
- (void)_updateWithPoliciesByBundleIdentifier:(id)a0 categoryEffectivePolicy:(id)a1 applicationCategoryEffectivePolicy:(id)a2;
