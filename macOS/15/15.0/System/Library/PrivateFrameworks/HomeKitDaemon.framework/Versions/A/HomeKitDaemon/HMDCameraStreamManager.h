...
- (id)initWithSessionID:(id)a0 streamSnapshotHandler:(id)a1 workQueue:(id)a2 delegate:(id)a3 delegateQueue:(id)a4 videoStreamInterface:(id)a5 audioStreamInterface:(id)a6;
