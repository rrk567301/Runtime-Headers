@class NSMutableDictionary, NSObject, HMDStatusChannel, HMFFuture, NSString, NSSet, HMDResidentStatusChannelManager, NSMutableSet, HMDResidentStatus, HMDHome, HMFPromise, NSNotificationCenter, HMFTimer;
