...
@protocol OS_dispatch_queue, HMMLogEventSubmitting, HMDDoorbellBulletinUtilities, HMDCoordinationStateManagerProviding, HMDCOStateManager;
...
@property (readonly, getter=isCoordinationFreePathEnabled) BOOL coordinationFreePathEnabled;
...
- (BOOL)accessorySupportsCoordinationFreeDoorbellChime:(id)a0;
