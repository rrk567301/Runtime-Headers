...
- (BOOL)hasHome:(id)a0;
- (id)initWithQueue:(id)a0 discoveryController:(id)a1 networkInfoController:(id)a2 trackingInfo:(id)a3 setupSessionIdentifier:(id)a4 homeManager:(id)a5 logEventSubmitter:(id)a6 radarInitiator:(id)a7 timerFactory:(id /* block */)a8;
