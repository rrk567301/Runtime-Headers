...
@interface HMDCHIPDataSource : HMFObject <HMMTRResidentStateManagerDataSource, HMMTRStorageDataSource, HMMTRThreadRadioControllerDelegate, HMDCHIPThreadNetworkEventListenerDelegate, HMMTRUIDialogPresenterDelegate, HMMTRAccessoryServerBrowserDelegate, HMFLogging, HMFTimerDelegate> {
...
- (BOOL)hasValidGeoOrPreferredNetworkForHome:(id)a0;
