@class NSDate, NSString, HMFTimer, NSArray, NSError, HMDHAPAccessory, NSMutableDictionary, NSDictionary, NSObject, HAP2AccessorySessionInfo;
@protocol OS_dispatch_queue, HMMRadarInitiating;
