@class HMFTimer, NSString, HMDResidentStatusChannel, NSNotificationCenter, NSMutableSet, NSObject, HMDIDSServerBag;
...
- (id)initWithResidentStatusChannel:(id)a0 notificationCenter:(id)a1 queue:(id)a2 timerProvider:(id)a3 idsServerBag:(id)a4;
