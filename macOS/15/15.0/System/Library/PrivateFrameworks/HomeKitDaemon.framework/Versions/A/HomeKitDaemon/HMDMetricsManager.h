...
- (void)addTTRThresholdTrigger:(id)a0 radarTitle:(id)a1 componentName:(id)a2 componentVersion:(id)a3 componentID:(id)a4 forEventName:(id)a5 requestGroup:(id)a6 atThreshold:(unsigned long long)a7 primaryOnly:(BOOL)a8 forHome:(id)a9;
...
- (void)registerPrimaryChangedCounterTriggerTTRforHome:(id)a0;
