...
- (id)doorbellMessagePayloadWithChimeMode:(long long)a0 chimeDate:(id)a1 personIdentificationText:(id)a2;
- (void)handleDoorbellChimeMessage:(id)a0;
- (id)initWithAppleMediaAccessory:(id)a0;
- (void)sendDoorbellChimeMessageWithChimeMode:(long long)a0 chimeDate:(id)a1 personIdentificationText:(id)a2;
