@class NSEvent, NSString, NSView, UINSSceneHostingView, NSTrackingArea, UINSEventTranslator, UINSGameEventTranslator, UINSSceneView, NSViewHost, UINSMouseEventTranslator, UINSWritingToolsBridge, NSMutableSet;

@interface UINSInputView : NSView <NSTextInputClient, NSServicesMenuRequestor, UINSKeyboardEventHandler, UINSWritingToolsBridgeDelegate> {
    ...
    UINSWritingToolsBridge *_writingToolsBridge;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })selectionRectForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
