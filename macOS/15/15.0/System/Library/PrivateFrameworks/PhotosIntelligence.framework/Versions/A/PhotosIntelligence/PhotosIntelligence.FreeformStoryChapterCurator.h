@interface PhotosIntelligence.FreeformStoryChapterCurator : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ storyState;
    ...
    void /* unknown type, empty encoding */ originalRetrievedAssetUUIDs;
    void /* unknown type, empty encoding */ globalTraitsExtendedAssetUUIDs;
    void /* unknown type, empty encoding */ allPersonsQueryExtendedTokenAssetUUIDs;
    void /* unknown type, empty encoding */ performDeduping;
