...
@interface CLPLteCellTowerLocation : PBCodable <NSCopying> {
    struct { unsigned char cellLatitude : 1; unsigned char cellLongitude : 1; unsigned char bandInfo : 1; unsigned char bandwidth : 1; unsigned char csgId : 1; unsigned char csgIndication : 1; unsigned char deploymentType : 1; unsigned char downlinkBandwidth : 1; unsigned char ecn0 : 1; unsigned char latency : 1; unsigned char maxThroughput : 1; unsigned char pid : 1; unsigned char pmax : 1; unsigned char rscp : 1; unsigned char rssi : 1; unsigned char serverHash : 1; unsigned char timingAdvance : 1; unsigned char uarfcn : 1; unsigned char hasWifiFallback : 1; unsigned char isLimitedService : 1; unsigned char isStalled : 1; unsigned char uniqueCount : 1; } _has;
}
...
@property (readonly, nonatomic) BOOL hasNpnNwIdEf;
@property (retain, nonatomic) NSString *npnNwIdEf;
@property (readonly, nonatomic) BOOL hasNpnCsgIdEf;
