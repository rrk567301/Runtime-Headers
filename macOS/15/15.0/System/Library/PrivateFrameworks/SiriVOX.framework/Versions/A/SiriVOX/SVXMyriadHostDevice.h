@class NSString, AFMyriadCoordinator, SCDACoordinator, SVXMyriadWiFiAssertion, NSObject;
@protocol SVXMyriadResponseDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface SVXMyriadHostDevice : NSObject <SCDADelegate, AFMyriadDelegate, SVXMyriadRequestDelegate> {
