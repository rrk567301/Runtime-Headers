@class NSString, SVXSessionManager, SVXClientServiceServer, SVXSynthesisManager, SVXDeviceSetupManager, NSDictionary, SVXSpeechSynthesizer, SVXServiceCommandHandler, SVXSystemObserver;
