...
@interface VFXRECachedRenderCommandEncoder : NSObject <MTLRenderCommandEncoder> {
    ...
    struct RenderCommandEncoder { m_impCache *m_object; struct RenderEncoderImpCache *x0; } _encoderCPP;
    void *_encoderState;
}
...
- (void)setEncoder:(id)a0 state:(void *)a1;
