@class MSPSharedTripRelay, MSPSenderVirtualLiveStrategy, NSObject, MSPSenderVirtualMessageStrategy, MSPSenderMessageStrategy, MSPNavigationListener, NSString, MSPSenderLiveStrategy, MSPGroupSessionStorage, NSMutableSet, MSPSenderVirtualMinimalStrategy, NSArray, MSPSharedTripGroupSession, MSPSharedTripStorageController, MSPSenderMinimalStrategy;
...
@interface MSPSenderETAController : NSObject <MSPNavigationListenerDelegate, MSPSharedTripGroupSessionDelegate, MSPSenderMessageStrategyDelegate> {
    ...
    MSPSenderMessageStrategy *_iMessageSender;
    MSPSenderMessageStrategy *_smsSender;
    MSPGroupSessionStorage *_sessionStorage;
    MSPSharedTripStorageController *_storageController;
    MSPSenderVirtualMinimalStrategy *_virtualMinimalSender;
    MSPSenderVirtualLiveStrategy *_virtualLiveSender;
    MSPSenderVirtualMessageStrategy *_virtualiMessageSender;
    MSPSenderVirtualMessageStrategy *_virtualSMSSender;
}
...
- (BOOL)startSharingWith:(id)a0 capabilityType:(unsigned long long)a1 error:(id *)a2;
