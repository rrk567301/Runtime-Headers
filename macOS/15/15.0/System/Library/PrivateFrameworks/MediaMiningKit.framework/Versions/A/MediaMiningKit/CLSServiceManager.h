@class CLSSocialServiceCoreNameParser, NSString, CLSLRUMemoryCache, CLSSocialServiceCoreDuet, CLSSocialServiceCalendar, CLSPersonIdentity, CLSRoutineService, CLSSocialServiceContacts;
