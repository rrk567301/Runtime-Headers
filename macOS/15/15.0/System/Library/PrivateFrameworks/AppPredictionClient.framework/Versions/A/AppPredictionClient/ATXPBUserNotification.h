...
@interface ATXPBUserNotification : PBCodable <ATXJSONSerializableProtocol, NSCopying> {
    struct { unsigned char appSpecifiedScore : 1; unsigned char badge : 1; unsigned char bodyLength : 1; unsigned char numberOfNotificationsInStack : 1; unsigned char positionInStack : 1; unsigned char recordTimestamp : 1; unsigned char subtitleLength : 1; unsigned char summaryLength : 1; unsigned char timestamp : 1; unsigned char titleLength : 1; unsigned char attachmentType : 1; unsigned char priorityStatus : 1; unsigned char urgency : 1; unsigned char isDeterminedUrgentByModel : 1; unsigned char isGroupMessage : 1; unsigned char isMessage : 1; unsigned char isPartOfStack : 1; unsigned char isStackSummary : 1; unsigned char isSummarized : 1; } _has;
}
...
@property (nonatomic) BOOL hasTitleLength;
@property (nonatomic) unsigned long long titleLength;
@property (nonatomic) BOOL hasSubtitleLength;
...
@property (nonatomic) BOOL hasSummaryLength;
...
@property (nonatomic) BOOL hasIsDeterminedUrgentByModel;
