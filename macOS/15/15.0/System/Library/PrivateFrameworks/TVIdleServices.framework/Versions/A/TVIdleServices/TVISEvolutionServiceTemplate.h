@class NSHashTable, NSString, TVISOperationQueue, TVISEvolutionServicePurgeableAmounts, TVISEvolutionServiceUpdate, NSObject, NSMutableArray, TVISEvolutionServicePurgeableManifest;
@protocol OS_os_log, TVISEvolutionServiceDelegate;

@interface TVISEvolutionServiceTemplate : NSObject <TVISOperationQueueOwner, TVISEvolutionService>
...
@property (readonly, nonatomic) TVISOperationQueue *networkQueue;
