...
- (BOOL)_setLogEvent:(struct { unsigned int x0; unsigned long long x1; char x2[1024]; long long x3; long long x4; union { struct { struct tracev3_chunk_s *x0; struct catalog_s *x1; struct _OSLogEventChunkContext { struct tracev3_chunk_s *x0; struct _firehose_unaligned_chunk_s *x1; struct iovec { void *x0; unsigned long long x1; } x2; struct catalog_procinfo_s *x3; } x2; struct _firehose_unaligned_tracepoint_s *x3; } x0; struct { unsigned char x0[16]; struct os_timesync_time_entry_s { struct os_timesync_header_s { unsigned short x0; unsigned short x1; unsigned int x2; } x0; unsigned long long x1; unsigned long long x2; struct timezone { int x0; int x1; } x3; } x1; } x1; struct { unsigned char x0[16]; unsigned char x1; BOOL x2; } x2; } x5; } *)a0 rangeUUIDIndex:(unsigned long long)a1 machTimebase:(struct mach_timebase_info { unsigned int x0; unsigned int x1; } *)a2;
