@class CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptions, NSString, CKDPLocale, NSData, CKDPRequestOperationHeaderZoneAndShareUsageInfo, NSMutableArray, CKDPIdentifier;
...
@property (readonly, nonatomic) BOOL hasZoneAndShareUsageInfo;
@property (retain, nonatomic) CKDPRequestOperationHeaderZoneAndShareUsageInfo *zoneAndShareUsageInfo;
