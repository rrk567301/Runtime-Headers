...
+ (id)_metricsDataFromPlayable:(id)a0 actionType:(id)a1 canonicalIdOverride:(id)a2 durationOverride:(id)a3 contentType:(id)a4;
...
+ (void)recordClipPlay:(id)a0 canonicalId:(id)a1 duration:(double)a2;
+ (void)recordClipStop:(id)a0 canonicalId:(id)a1 duration:(double)a2;
