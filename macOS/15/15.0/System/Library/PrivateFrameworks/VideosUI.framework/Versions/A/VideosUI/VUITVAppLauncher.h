@class NSObject, NSString, NSArray, VUIWindowController, VUIStateMachine, VUIToolbar, VUIHintsWindowController, ATAParsedOpenURL, NSDictionary, _TtC8VideosUI20VUIJetPackController, NSWindow, VUITVApplicationController;
