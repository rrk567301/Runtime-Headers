...
@property (nonatomic) unsigned long long currentLoginCredentialPolicy;
@property (retain) NSObject<OS_dispatch_queue> *loginCredentialPolicyQueue;
...
- (void)setMobileSoftwareUpdateDescriptorToInstallLater:(id)a0;
