...
+ (unsigned short)maskForRecoveredAlbum;
...
+ (unsigned short)maskForSocialGroupKeyAssetFetch;
...
+ (unsigned short)maskForAssetsEligibleForFileSystemImportSavedAssetTypeUpdate;
...
+ (unsigned short)maskForFeatureAvailabilityForSceneAnalysis:(BOOL)a0;
...
+ (unsigned short)_maskForCMMMutatingFrom;
+ (unsigned short)_maskForCMMMutatingTo;
+ (unsigned short)_maskForGuestMutatingFrom;
+ (unsigned short)_maskForGuestMutatingTo;
+ (unsigned short)_maskForRecoveredMutatingFrom;
+ (unsigned short)_maskRecoveredForMutatingTo;
...
+ (unsigned short)maskForAssetStackProcessingExclusions;
