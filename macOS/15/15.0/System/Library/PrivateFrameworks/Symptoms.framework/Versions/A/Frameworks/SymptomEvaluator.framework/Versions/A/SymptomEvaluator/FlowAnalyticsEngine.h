@class NSMutableDictionary, FlowScrutinizer, NetworkStateRelay, NSDate, NSObject, BitmapRetriever, NWStatsManager, NSString, AppAnalytics, ProcessAnalytics, FlowRefreshScheduler, CellularStateRelay, UsageAnalytics, ObjectAnalytics, CoreTelephonyShim;
...
@interface FlowAnalyticsEngine : AnalyticsEngineCore <NWStatsManagerDelegate, FlowImmediateRefreshDelegate> {
    ...
    unsigned int pdpThresholdMonitoredBitmap;
