@class NSSet, NSArray, NSDictionary, NSData, NSError, NSDate, NSString;
...
- (void)requestExtendedTokenCollectionWithQueryTokensAsData:(NSData *)a0 assetUUIDs:(NSArray *)a1 momentUUIDByAssetUUID:(NSDictionary *)a2 reply:(void (^)(NSData *, NSError *))a3;
