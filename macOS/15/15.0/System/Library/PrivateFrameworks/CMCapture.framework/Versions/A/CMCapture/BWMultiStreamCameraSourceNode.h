@class BWFigVideoCaptureStream, NSMutableDictionary, FigCaptureThermalMonitor, NSObject, BWPixelBufferPool, BWFigCaptureStream, BWDeferredMetadataCache, BWStats, NSDictionary, BWMultiStreamCameraSourceNodeConfiguration, BWFigVideoCaptureDevice, NSString, BWDetectedFacesRingBuffer, BWDetectedObjectsInfoRingBuffer, BWMotionDataPreserver, CMIDistortionModel, NSArray, BWNodeOutput;
