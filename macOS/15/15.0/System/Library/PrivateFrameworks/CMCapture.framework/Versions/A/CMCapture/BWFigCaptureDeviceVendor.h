@class NSString, NSArray, FigCaptureOSStateHandle, BWFigCaptureDeviceClient, NSMutableDictionary, NSObject, NSMutableArray, NSDateFormatter, FigCaptureGameModeMonitor;
