...
@interface FigCapturePreviewSinkPipeline : FigCaptureSinkPipeline {
    ...
    BWInferenceNode *_secondaryPersonSegmentationNode;
...
@property (nonatomic, setter=setSemanticStyleSceneObserver:) id<BWSemanticStyleSceneObserver> semanticStyleSceneObserver;
