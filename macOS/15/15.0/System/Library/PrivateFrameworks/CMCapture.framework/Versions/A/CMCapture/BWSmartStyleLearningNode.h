...
- (void)_asynchronouslyLearnWithContainer:(struct opaqueCMSampleBuffer { } *)a0 inputUnstyledSampleBuffer:(struct opaqueCMSampleBuffer { } *)a1 withUnrefinedMasks:(id)a2 withStats:(id)a3 styleToLearn:(id)a4 shouldBypass:(BOOL)a5;
