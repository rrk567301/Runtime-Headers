@class NSDictionary, BWNodeInput, BWNodeOutput;
...
@interface BWTemporalFilterNode : BWNode {
    ...
    struct { unsigned long long framesReceivedCount; unsigned long long framesWithMLVNRAppliedCount; unsigned long long framesWithMCTFAppliedCount; unsigned long long framesDispatchedCount; BOOL lastFrameWasMLVNRAppliedFrame; } _frameStats;
