@class BWVideoCompressorNode, BWQuickTimeMovieFileSinkNode, BWPixelTransferNode, NSMutableDictionary, FigCaptureVISPipeline, BWBackPressureNode, BWAudioConverterNode;
