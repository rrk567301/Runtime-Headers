...
- (id)initWithCaptureDevice:(id)a0 maxLossyCompressionLevel:(int)a1 semanticStyleRenderingEnabled:(BOOL)a2 cinematicVideoEnabled:(BOOL)a3 smartStyleRenderingEnabled:(BOOL)a4 portraitPreviewForegroundBlurEnabled:(BOOL)a5 metalCommandQueue:(id)a6 priority:(unsigned int)a7 mirroredForMetadataAdjustment:(BOOL)a8 rotationDegreesForMetadataAdjustment:(int)a9;
- (id)nodeSubType;
