@class NSDictionary, WFActionAuxiliaryButton, WFContextualActionSuggestionMetadata, WFWorkflow, WFParameter, NSString, WFColor, NSError, WFActionSessionKitSessionConfiguration, NSAttributedString, NSArray, NSMutableDictionary, WFAppInstalledResource, WFResourceManager, WFActionDefinition, WFToolInvocation, WFContentCollection, NSObject, WFActionParameterSummary, NSSet, WFActionLocalizationContext, WFContentAttributionTracker, WFIcon, WFContactStore, INAppDescriptor, ICApp, NSProgress, WFActionDescriptionDefinition, NSHashTable;
...
@property (readonly, nonatomic) WFActionLocalizationContext *defaultLocalizationContext;
