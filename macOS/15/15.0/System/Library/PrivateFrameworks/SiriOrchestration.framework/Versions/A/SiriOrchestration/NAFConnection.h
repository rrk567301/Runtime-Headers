...
@protocol NAFSpeechDelegate, OS_dispatch_group, NAFAssistantUIService, OS_dispatch_queue;

@interface NAFConnection : NSObject <NSXPCListenerDelegate, AFAudioPowerUpdaterDelegate, AFAccessibilityListening, AFDeviceRingerSwitchListening, AFInterstitialProviderDelegate> {
...
@property (weak, nonatomic) id<NAFAssistantUIService> delegate;
@property (weak, nonatomic) id<NAFSpeechDelegate> speechDelegate;
