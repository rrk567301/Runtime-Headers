...
@protocol _LTActivityLoggerDelegate, _LTDAnalyticsAssetSnapshotProviding;
...
- (void)_logAssetSnapshotForDate:(id)a0;
...
- (void)activityLogger:(id)a0 logAssetSnapshot:(id)a1 forDate:(id)a2;
