...
@protocol EMMessageListItemChangeCategory, EMCollectionItemID, EMMessageListItemChangeFlagColors, EMMessageListItemChangeSummary, EMMessageListItemChangeSendLaterDate, EMMessageListItemChangeGeneratedSummary, EMMessageListItemChangeSubject, EMMessageListItemChangeReadLater, EMMessageListItemChangeFollowUp;
...
+ (id)changeFrom:(id)a0 to:(id)a1 with:(id)a2 hasChanges:(BOOL)a3;
