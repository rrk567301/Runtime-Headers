@protocol IMDaemonListenerFileTransfersProtocol, IMDaemonListenerChatProtocol, IMDaemonListenerChatCountsProtocol, IMDaemonListenerFileProviderProtocol, IMDaemonListenerSyncedSettingsProtocol, IMDaemonListenerCollaborationProtocol, IMDaemonListenerAnyProtocol, IMDaemonListenerAVProtocol, IMDaemonListenerChatDatabaseProtocol, IMDaemonListenerKeyTransparencyProtocol, IMDaemonListenerAccountsProtocol, IMDaemonListenerCloudSyncProtocol;
...
@interface IMDClientConnectionManager : NSObject <IMDBroadcasterProviding> {
    ...
    void /* unknown type, empty encoding */ broadcastingQueue;
}
