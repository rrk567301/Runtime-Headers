@class NSString, NSArray, IMDRelayPushHandler, IDSService, IMDRelayDeletionController, NSMutableDictionary, IMDService, IMDRelayEnrollmentController;
...
+ (id)_convertIMMessageItemToIncomingRelayDictionary:(id)a0 chat:(id)a1;
