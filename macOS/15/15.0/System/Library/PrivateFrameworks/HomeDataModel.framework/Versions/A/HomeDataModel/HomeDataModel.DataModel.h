...
@interface HomeDataModel.DataModel : NSObject <MTRDeviceDelegate, HMResidentDeviceDelegate, HMCameraStreamControlDelegate, HMCameraSnapshotControlDelegate, HMAccessorySoftwareUpdateControllerV2Delegate, HMSoftwareUpdateDelegate, HMSymptomsHandlerDelegate, HMLightProfileDelegate, HMMediaObjectDelegate, HMMediaSessionDelegate, HMAccessoryDelegatePrivate, HMAccessoryDelegate, HMUserActionPredictionControllerDelegate, HMHomeDelegatePrivate, HMHomeDelegate, HMHomeManagerDelegate> {
    ...
    void /* unknown type, empty encoding */ _currentUserActionPredictionControllersDictionary;
    void /* unknown type, empty encoding */ _currentUserActionPredictionsDictionary;
