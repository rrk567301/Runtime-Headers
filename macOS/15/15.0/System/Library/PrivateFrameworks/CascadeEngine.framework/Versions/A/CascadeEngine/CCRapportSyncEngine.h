...
- (void)startServer;
- (void)startClient;
- (void)addOperationsToFetchMergeableDeltasFromDevice:(id)a0;
- (id)buildMergeableDeltasRequestForSet:(id)a0 withIsReciprocal:(BOOL)a1 device:(id)a2;
- (id)buildVersionedMergeableForSet:(id)a0;
- (void)completeRequestAsDeliveredToDevices:(id)a0 withErrors:(id)a1;
- (void)completeRequestIfDeliveredToAllNearbyDevices;
- (void)fetchMergeableDeltasIsReciprocal:(BOOL)a0 reason:(unsigned long long)a1 activity:(id)a2 completionHandler:(id /* block */)a3;
