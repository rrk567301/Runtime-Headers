@class NSExtension, NSURL, WBSWebExtensionsController, _WKWebExtension, NSDictionary, WBSWebExtensionToolbarItem, NSMutableArray, NSImage, NSString, NSSet, _WKWebExtensionContext, WKWebView, NSArray, NSUUID;
...
@property (readonly, nonatomic) _WKWebExtensionContext *webKitContext;
