@class NSString, WBSWebExtensionData, WKWebView, NSImage, WBSWebExtensionsController, _WKWebExtensionAction;
...
@property (retain, nonatomic) _WKWebExtensionAction *webKitAction;
