@class SiriSharedUICompactUserUtteranceView, NSDictionary, SiriSharedUIViewStackConstraints, SiriSharedUIStandardScrollView, _TtC12SiriSharedUI32SiriSharedUISmartDialogContainer, SiriSharedUIAnimationContext, NSMutableArray, SFCard, NSString, SAUIPluginSnippet, SiriSharedUILatencyViewModel, NSArray, NSView, SRUIFSpeechRecognitionHypothesis, SiriSharedUILatencyView, SiriSharedUINotificationCenterPlatterView;
...
@property (retain, nonatomic, getter=_suggestionView, setter=_setSuggestionView:) NSView *suggestionView;
...
- (id)initWithSuggestionView:(id)a0;
