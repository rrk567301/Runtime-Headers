@class PLMomentGenerationDataManager, NSPersistentStoreCoordinator, PLCacheDeleteSupport, PLModelMigrator, NSMutableArray, CPLConfiguration, PLAnalysisCoordinator, PLFeatureAvailabilityComputer, PLSearchIndexingEngine, PFClientSideEncryptionManager, PLLibraryServicesCPLReadiness, PLAssetsdCrashRecoverySupport, NSProgress, PLComputeCacheManager, PLCacheDeleteRegistration, PLPairing, PLClientServerTransaction, PLQuickActionManager, PLRebuildJournalManager, PLChangeHandlingContainer, NSURL, PLImageWriter, PLBackgroundJobService, PLDuplicateProcessor, PLLibraryServicesStateNode, PLTrackableRequestManager, PLPhotoLibraryBundle, PLSearchDonationProgress, PLCloudPhotoLibraryManager, NSString, NSError, NSObject, PLSyndicationDeleteEngine, PLLibraryOpenerCreationOptions, PLKeywordManager, PLDeferredProcessingServiceHandler, PLDatabaseContext, PLSearchIndexManager, PLPhotoLibraryPathManager, PLRelationshipOrderKeyManager, PLCPLSettings, PLReadyForAnalysis, PLLazyObject, PFStateCaptureHandler, NSMutableDictionary;
