@class NSString, PSIWordEmbeddingTable, PLPhotoLibraryPathManager, PSIStatement, PSIIntArray, PLSearchMetadataStore, NSObject, NSDictionary, NSMutableString, NSMutableArray, PSITokenizer;
