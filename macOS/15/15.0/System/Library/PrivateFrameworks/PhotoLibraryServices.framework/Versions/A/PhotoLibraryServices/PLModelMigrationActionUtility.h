...
+ (long long)processAssetWithAction:(id)a0 managedObjectContext:(id)a1 fetchRequest:(id)a2 useObjectIDResumeMarker:(BOOL)a3 error:(id *)a4 processingBlock:(id /* block */)a5;
