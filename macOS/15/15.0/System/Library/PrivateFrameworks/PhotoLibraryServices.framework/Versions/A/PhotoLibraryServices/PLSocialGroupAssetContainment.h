...
- (id)_assetIDsWithLargeMemberFacesFromAssetPersonEdgeDictionaries:(id)a0 error:(id *)a1;
...
- (id)_fetchEdgeIDsWithLabel:(id)a0 inEdgeIDSet:(id)a1 error:(id *)a2;
...
- (id)_personIDsByAssetIDFromAssetPersonEdgeDictionaries:(id)a0 potentialAssetsIDs:(id)a1;
- (id)_potentialAssetsIDsExcludingNonMembersFromAssetIDs:(id)a0 assetIDsWithLargeMemberFaces:(id)a1 error:(id *)a2;
