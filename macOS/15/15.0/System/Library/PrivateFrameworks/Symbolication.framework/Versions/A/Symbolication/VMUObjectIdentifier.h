...
@property (readonly, nonatomic) struct libSwiftRemoteMirrorWrapper { struct SwiftReflectionInteropContext *x0; unsigned long long x1; unsigned long long x2; } *swiftMirror;
