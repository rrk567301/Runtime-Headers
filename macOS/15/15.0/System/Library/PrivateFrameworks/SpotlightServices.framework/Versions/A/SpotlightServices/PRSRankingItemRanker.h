@class NSString, NSArray, NSMapTable, PRSQueryRankingConfiguration;
...
+ (void)thresholdResultsInSection:(id)a0 userQuery:(id)a1 queryID:(long long)a2 isEntitiesSearch:(BOOL)a3 currentTime:(double)a4 isScopedSearch:(BOOL)a5 queryKind:(unsigned long long)a6 clientBundleID:(id)a7;
+ (void)clearState;
