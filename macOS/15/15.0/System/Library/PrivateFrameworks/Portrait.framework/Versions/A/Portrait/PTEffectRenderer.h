@class PTBackgroundReplacement, PTNormalAndDiffuseEstimation, PTEffectRelighting, PTEffectReactionProvider, PTTextureYUV, PTEffectTemporalFilter, PTMSRResize, PTEffectDebugLayer, PTVFXRenderEffect, NSObject, PTEffectDescriptor, PTEffectPersonSegmentation, PTRenderPipeline, PTDepthConverter, PTMetalContext, PTCVMNetwork, PTRenderRequest, PTEffectUtil, PTUtil, PTGuidedFilter, PTColorConversion, PTHumanDetections, PTEffectResources;
