...
- (BOOL)accumulateHomeAndWorkWithHomeAndWorkKeywords:(id)a0 forMomentUUID:(id)a1 error:(id *)a2;
...
- (BOOL)accumulatePublicEventsInPublicEventKeywords:(id)a0 forMomentUUID:(id)a1 error:(id *)a2;
