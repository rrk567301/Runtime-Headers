...
@interface PGGraphBuilder : NSObject {
    ...
    NSMutableDictionary *_visualLookupSceneNodeBySceneName;
...
- (void)_insertVisualLookupScene:(id)a0 fromMomentNode:(id)a1 changeRequest:(id)a2;
...
- (void)insertVisualLookupScenesWithClueCollection:(id)a0 fromMomentNode:(id)a1;
