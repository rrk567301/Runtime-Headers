...
- (void)_triggerTTRForEvent:(id)a0 componentName:(id)a1 componentVersion:(id)a2 componentID:(id)a3 fullDiagnostic:(BOOL)a4;
...
- (void)requestTTRWithTitle:(id)a0 message:(id)a1 componentName:(id)a2 componentVersion:(id)a3 componentID:(id)a4 keywords:(id)a5 fullDiagnostic:(BOOL)a6 completion:(id /* block */)a7;
