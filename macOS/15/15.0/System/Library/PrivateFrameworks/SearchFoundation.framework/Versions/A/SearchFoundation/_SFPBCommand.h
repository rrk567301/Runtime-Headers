@class _SFPBShareCommand, _SFPBPerformPersonEntityQueryCommand, _SFPBPerformContactActionCommand, _SFPBCallCommand, _SFPBUpdateSearchQueryCommand, _SFPBInvokeSiriCommand, _SFPBClearProactiveCategoryCommand, _SFPBPerformEntityQueryCommand, _SFPBRunVoiceShortcutCommand, _SFPBShowPurchaseRequestSheetCommand, _SFPBToggleAudioCommand, _SFPBRejectPeopleInPhotoCommand, _SFPBFlightCheckinCommand, _SFPBToggleWatchListStatusCommand, _SFPBIndexedUserActivityCommand, _SFPBSearchWebCommand, _SFPBSearchInAppCommand, _SFPBOpenCalculationCommand, _SFPBEmailCommand, _SFPBLaunchAppCommand, _SFPBCreateReminderCommand, _SFPBTopic, _SFPBUpdateSportsFollowingStatusCommand, _SFPBPerformIntentCommand, _SFPBCreateContactCommand, _SFPBRequestUserReportCommand, NSData, _SFPBRequestProductPageCommand, _SFPBShowAppStoreSheetCommand, _SFPBShowScreenTimeRequestSheetCommand, _SFPBShowContactCardCommand, _SFPBOpenWebClipCommand, _SFPBShowPhotosOneUpViewCommand, _SFPBBeginMapsRoutingCommand, _SFPBAddToPhotosLibraryCommand, _SFPBOpenMediaCommand, _SFPBCommandReference, _SFPBOpenPunchoutCommand, _SFPBOpenFileProviderItemCommand, NSString, _SFPBSubscribeForUpdatesCommand, _SFPBCopyCommand, _SFPBPerformContactQueryCommand, _SFPBManageReservationCommand, _SFPBViewEmailCommand, _SFPBShowWrapperResponseViewCommand, _SFPBExpandInlineCommand, _SFPBShowSFCardCommand, _SFPBPlayVideoCommand, _SFPBCreateCalendarEventCommand, _SFPBOpenAppClipCommand, _SFPBOpenCoreSpotlightItemCommand, _SFPBRequestAppClipInstallCommand, _SFPBPlayMediaCommand;
