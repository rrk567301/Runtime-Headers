...
@property struct __CFData { } *hsmContent;
@property struct __CFData { } *newHSMContent;
@property struct __CFData { } *brHSMContent;
@property struct __CFData { } *newKeychainContent;
@property struct __CFData { } *externalEscrow;
@property struct __CFDictionary { } *metadata;
@property void *metadataHashKey;
...
@property struct __CFData { } *FDEKey;
