@class NSMutableDictionary, WiFiSoftError, WiFiUsageInterfaceStats, NSDate, NSDictionary, NSObject, WAMessage, NSMutableArray, NSString, WiFiUsageNetworkDetails, WiFiUsageRangingSession, NSArray, AnalyticsProcessor, NSNumber;
