...
- (void)_queryColorModeFromClusterAtCHIPEndpoint:(id)a0 device:(id)a1 callbackQueue:(id)a2 completionHandler:(id /* block */)a3;
- (id)_responseTupleWithMappedValueForOperation:(id)a0 responseValue:(id)a1 responseError:(id)a2;
- (void)handleHueSaturationWriteWithOperation:(id)a0 clientQueue:(id)a1 operationResponseHandler:(id /* block */)a2 updatedAttributesHandler:(id /* block */)a3;
- (void)handleIdentifyDeviceWriteWithOperation:(id)a0 clientQueue:(id)a1 operationResponseHandler:(id /* block */)a2;
- (void)handleLockTargetStateWriteWithOperation:(id)a0 accessoryServer:(id)a1 clientQueue:(id)a2 operationResponseHandler:(id /* block */)a3;
- (BOOL)handleSpecialCaseCharacteristicWithOperation:(id)a0 accessoryServer:(id)a1 clientQueue:(id)a2 operationResponseHandler:(id /* block */)a3 updatedAttributesHandler:(id /* block */)a4;
- (void)registerOperation:(id)a0 accessoryServer:(id)a1 clientQueue:(id)a2 reportDistributor:(id)a3 operationResponseHandler:(id /* block */)a4 updatedAttributesHandler:(id /* block */)a5;
