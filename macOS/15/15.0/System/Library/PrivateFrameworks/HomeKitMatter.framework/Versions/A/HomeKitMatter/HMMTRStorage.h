...
- (id)_createTransientOperationalCertificateForFabricID:(id)a0 rootCert:(id)a1 caseAuthenticatedTags:(id)a2;
...
- (void)fetchCertificatesFromStorageForFabricID:(id)a0 rootCert:(id *)a1 operationalCert:(id *)a2 residentNodeID:(id *)a3 ipk:(id *)a4;
