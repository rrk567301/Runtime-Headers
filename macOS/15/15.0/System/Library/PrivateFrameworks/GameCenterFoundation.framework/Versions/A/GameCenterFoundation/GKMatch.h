@class GKMatchmaker, NSString, NSArray, GKTransportContext, NSMutableDictionary, NSDictionary, GKThreadsafeDictionary, NSObject, NSMutableSet, NSMutableArray, GKMultiplayerActivityReporter, _TtC20GameCenterFoundation22ExponentialBackoffTask;
@protocol GKMatchDelegatePrivate, GKMatchDelegate, OS_dispatch_queue, GKTransportProtocol;

@interface GKMatch : NSObject <GameCenterFoundation.ExponentialBackoffTaskDelegate, GKTransportClientDelegate, GKTransportMatchDataDelegate>
