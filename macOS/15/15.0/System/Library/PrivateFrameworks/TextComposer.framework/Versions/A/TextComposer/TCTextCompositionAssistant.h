...
+ (id)sharedAssistant;
+ (BOOL)_canHandleAttributedString:(id)a0 proposedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 lookBack:(BOOL)a2 tagger:(id)a3 actualRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a4 contextRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a5 error:(id *)a6;
...
- (BOOL)useServerModelsForOpenEnded;
...
- (BOOL)userTitleCasesTexts:(id)a0 inputPreferences:(id)a1;
