@interface NotesUI.TranscriptViewController : NSViewController <NSTextContentManagerDelegate, NSTextViewDelegate, NSGestureRecognizerDelegate> {
...
- (void)audioDidPauseWithNotification:(id)a0;
- (void)audioDidPlayWithNotification:(id)a0;
