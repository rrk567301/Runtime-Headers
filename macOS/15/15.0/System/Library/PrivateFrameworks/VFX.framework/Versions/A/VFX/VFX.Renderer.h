@interface VFX.Renderer : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ simulateCommandBufferError;
    void /* unknown type, empty encoding */ counters;
    void /* unknown type, empty encoding */ engineContext;
    ...
    void /* unknown type, empty encoding */ uniformValidationBuffer;
    ...
    void /* unknown type, empty encoding */ _compiledVariantCount;
