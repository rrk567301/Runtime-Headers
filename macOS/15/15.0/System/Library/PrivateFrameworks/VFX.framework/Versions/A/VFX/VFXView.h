@class AVAudioEngine, MTLRenderPassDescriptor, VFXNode, VFXCameraController, VFXDisplayLink, CALayer, AVAudioEnvironmentNode, VFXRenderGraph, VFXWorld, NSString, VFXJitterer, VFXRenderer, VFXRecursiveLock, _TtC3VFX13VFXViewLegacy, NSColor;
