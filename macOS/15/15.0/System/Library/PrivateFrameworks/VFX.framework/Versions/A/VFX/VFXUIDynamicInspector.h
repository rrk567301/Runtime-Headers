@class NSString, VFXUIArrayEditor, NSPathControl, NSObjectController, NSMutableArray;

@interface VFXUIDynamicInspector : NSView {
    id _instance;
    NSString *_modelPath;
    NSMutableArray *_modelPathComponents;
    NSMutableArray *_stack;
    VFXUIArrayEditor *_pendingAllocationListener;
}
