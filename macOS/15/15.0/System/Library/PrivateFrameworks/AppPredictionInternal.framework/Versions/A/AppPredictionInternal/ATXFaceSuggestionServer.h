@class ATXPosterDescriptorCache, NSString, ATXPosterConfigurationCache, _PASSimpleCoalescingTimer, _ATXInternalUninstallNotification, ATXInternalLockedOrHiddenAppNotification, ATXComplicationSuggestionGenerator, ATXFaceSuggestionGenerator, ATXFaceSuggestionAssetParameters, NSXPCListener, ATXInternalUnLockedOrUnHiddenAppNotification;
