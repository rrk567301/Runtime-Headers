...
- (id)_generateSectionWithWidgetDescriptorsAdditionalData:(id)a0 aggregatedAppLaunchData:(id)a1 bundleIdToCompanionBundleId:(id)a2 assetDescriptors:(id)a3 semanticType:(long long)a4;
...
- (id)_generatedHeroSectionWithWidgetDescriptorsAdditionalData:(id)a0 aggregatedAppLaunchData:(id)a1 bundleIdToCompanionBundleId:(id)a2;
...
- (id)descriptorsToRemoveFromSectionWithSemanticType:(long long)a0;
...
- (BOOL)shouldRemoveDescriptorFromFeatured:(id)a0;
