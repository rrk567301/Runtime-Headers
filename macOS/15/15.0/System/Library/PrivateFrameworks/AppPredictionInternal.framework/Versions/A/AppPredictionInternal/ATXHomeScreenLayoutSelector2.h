...
- (BOOL)_isSuggestionACandidate:(id)a0 forStack:(id)a1 dedupeAppSuggestionsByWidgets:(BOOL)a2 ignoreDuplicatesInSGWidget:(BOOL)a3 ignoreDuplicatesInPanels:(BOOL)a4 homeScreenState:(id)a5;
...
- (BOOL)_stackHasRemainingReloadBudgetForWidgetSuggestion:(id)a0 homeScreenState:(id)a1;
...
- (id)initWithHomeScreenPageConfigurations:(id)a0 blendingLayerHyperParameters:(id)a1 suggestionDeduplicator:(id)a2 engagementRecordManager:(id)a3 widgetDismissManager:(id)a4 stackStateTracker:(id)a5 store:(id)a6 defaults:(id)a7 modeFilter:(id)a8 isiPad:(BOOL)a9;
