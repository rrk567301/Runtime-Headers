@class NSString, _ATXAggregateLogger, ATXBBNotificationManager, ATXNotificationsDedupeTracker, ATXModeTimelineManager, CNContactStore, ATXNotificationDeliverySuggestionManager, NSXPCListener, NSObject;
