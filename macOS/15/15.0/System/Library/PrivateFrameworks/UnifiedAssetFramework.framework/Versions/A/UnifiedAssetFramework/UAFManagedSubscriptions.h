...
+ (void)manageGMSSiriLanguageSubscription:(BOOL)a0 language:(id)a1;
...
+ (void)manageSubscription:(id)a0 subscriber:(id)a1 assetSets:(id)a2 usageAliases:(id)a3 useHold:(BOOL)a4;
