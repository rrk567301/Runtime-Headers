...
@property (nonatomic) BOOL shouldFailOnHTTPErrorResponse;
...
- (id)initWithUUID:(id)a0 URL:(id)a1 callback:(id)a2 shouldUseEphemeralSession:(BOOL)a3 jitEnabled:(BOOL)a4 requestingAppSupportedSchemes:(id)a5 additionalHeaderFields:(id)a6 customAnchorCertificatesData:(id)a7 shouldFailOnHTTPErrorResponse:(BOOL)a8;
