...
@interface CAWindowServerDisplay : NSObject <CABrightnessControl, CAPresetTransaction> {
    struct CAWindowServerDisplayImpl { struct Mutex { struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x0; } x0; struct Server *x1; struct CABrightnessTransaction { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; struct { float x0[9]; } x10; float x11; BOOL x12; BOOL x13; unsigned int x14; } x2; id /* block */ x3; id x4; id x5; id x6; id x7; BOOL x8; BOOL x9; } *_impl;
}
...
- (void)setFlipBookEnabled:(BOOL)a0;
- (void)setFlipBookSuppressed:(BOOL)a0;
