@class NSURL, LNValue, NSProgress, LNExportedContentConfiguration, NSDictionary, LNXPCListenerEndpointContainer, LNConfigurableQueryRequest, NSString, LNAction, LNQueryOutput, NSArray, NSNumber, NSXPCConnection, NSError, NSUUID;
...
- (void)fetchValueForPropertyWithIdentifier:(NSString *)a0 entity:(id)a1 completionHandler:(void (^)(id, NSError *))a2;
