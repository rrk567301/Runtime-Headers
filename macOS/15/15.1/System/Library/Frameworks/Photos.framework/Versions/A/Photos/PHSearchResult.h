...
- (id)initWithSearchResultType:(unsigned long long)a0 uuid:(id)a1 personUUIDs:(id)a2 sceneIdentifiers:(id)a3 audioIdentifiers:(id)a4 humanActionIdentifiers:(id)a5 retrievalType:(unsigned long long)a6 hasOCRTextMatch:(BOOL)a7 isSensitiveLocation:(BOOL)a8 embeddingDistances:(id)a9 l1Score:(id)a10 l2Score:(id)a11 collectionScore:(id)a12 assetAlbumUUIDs:(id)a13 assetMemoryUUIDs:(id)a14 assetHighlightUUIDs:(id)a15;
