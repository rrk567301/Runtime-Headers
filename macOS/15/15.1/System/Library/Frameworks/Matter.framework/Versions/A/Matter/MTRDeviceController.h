@class NSUUID, MTRDeviceStorageBehaviorConfiguration, MTRAsyncWorkQueue, MTRDeviceControllerFactory, MTRCommissionableBrowser, NSObject, NSMutableArray, MTRDeviceControllerDataStore, NSMapTable, NSNumber;
