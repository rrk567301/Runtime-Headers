...
+ (void)readAttributePresetsSchedulesEditableWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributePresetsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeQueuedPresetWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeTemperatureSetpointHoldPolicyWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)cancelPresetsSchedulesEditRequestWithCompletion:(id /* block */)a0;
- (void)cancelPresetsSchedulesEditRequestWithParams:(id)a0 completion:(id /* block */)a1;
- (void)cancelSetActivePresetRequestWithCompletion:(id /* block */)a0;
- (void)cancelSetActivePresetRequestWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)commitPresetsSchedulesRequestWithCompletion:(id /* block */)a0;
- (void)commitPresetsSchedulesRequestWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributePresetsSchedulesEditableWithCompletion:(id /* block */)a0;
- (void)readAttributePresetsWithCompletion:(id /* block */)a0;
- (void)readAttributeQueuedPresetWithCompletion:(id /* block */)a0;
...
- (void)readAttributeTemperatureSetpointHoldPolicyWithCompletion:(id /* block */)a0;
...
- (void)setTemperatureSetpointHoldPolicyWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)startPresetsSchedulesEditRequestWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributePresetsSchedulesEditableWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributePresetsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeQueuedPresetWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeTemperatureSetpointHoldPolicyWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
