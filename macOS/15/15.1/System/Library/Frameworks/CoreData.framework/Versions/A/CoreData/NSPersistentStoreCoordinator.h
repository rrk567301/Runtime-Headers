...
@interface NSPersistentStoreCoordinator : NSObject <NSLocking> {
    id _queueOwner;
    void *_dispatchQueue;
    struct _persistentStoreCoordinatorFlags { unsigned char _isRegistered : 1; unsigned char _canUseDirectDispatch : 1; unsigned char _queueUsage : 1; unsigned char _qosClass : 8; unsigned char _isMigrating : 1; unsigned int _reservedFlags : 20; } _flags;
    int _cd_rc;
