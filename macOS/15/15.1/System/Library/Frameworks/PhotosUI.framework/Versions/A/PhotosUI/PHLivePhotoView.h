@class ISLivePhotoPlayer, ISPlayerItem, PUPhotosAssetDebugOverlayView, NSLayoutGuide, ISLivePhotoNSView, PHLivePhotoBadge, NSView, PHLivePhoto, NSString, NSLayoutConstraint, NSNumber;
