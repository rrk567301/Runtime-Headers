...
- (void)_runServiceAndRequestTransferFromWindowID:(long long)a0 toWindowID:(long long)a1 isReturnTrip:(BOOL)a2;
...
- (void)requestTransferFromWindow:(id)a0 toWindow:(id)a1 isReturnTrip:(BOOL)a2 withCompletionHandler:(id /* block */)a3;
