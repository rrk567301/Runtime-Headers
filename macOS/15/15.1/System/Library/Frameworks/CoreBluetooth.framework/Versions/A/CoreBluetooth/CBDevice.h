...
@interface CBDevice : NSObject <CUXPCCodable, NSSecureCoding, NSCopying, CBDictionaryCodable> {
    struct { unsigned char bitArray[4]; } _changedTypesInternal;
    struct { unsigned char bitArray[4]; } _discoveryTypesInternal;
}
...
@property (readonly, nonatomic) struct { unsigned char x0[4]; } *changedTypesInternalPtr;
...
@property (readonly, nonatomic) struct { unsigned char x0[4]; } *discoveryTypesInternalPtr;
...
- (BOOL)changedTypesContainTypes:(const struct { unsigned char x0[4]; } *)a0;
...
- (BOOL)discoveryTypesContainTypes:(const struct { unsigned char x0[4]; } *)a0;
