...
@interface WebAVPlayerLayer : CALayer {
    struct ThreadSafeWeakPtr<WebCore::VideoPresentationModel> { struct RefPtr<WTF::ThreadSafeWeakPtrControlBlock, WTF::RawPtrTraits<WTF::ThreadSafeWeakPtrControlBlock>, WTF::ThreadSafeWeakPtrControlBlockRefDerefTraits> { struct ThreadSafeWeakPtrControlBlock *m_ptr; } m_controlBlock; struct VideoPresentationModel *m_objectOfCorrectType; } _presentationModel;
