@class NSUUID, NSString, CXSandboxExtendedURL, CXAccount, NSSet, NSMutableDictionary, NSDictionary, CXParticipant, CXCallTokens, CXHandoffContext, CXHandle, CXScreenShareAttributes;
