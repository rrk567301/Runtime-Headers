@class NSString, CRNeuralTextDetector, CRPerformanceStatistics, CRFormAnalyzer, NSDictionary, CRTableStructureRecognizer, CRMultiModelTextRecognizer, CRLineWrapper;
...
- (void)_loadFormAnalyzerIfNeededWithImageReaderOptions:(id)a0 error:(id *)a1;
