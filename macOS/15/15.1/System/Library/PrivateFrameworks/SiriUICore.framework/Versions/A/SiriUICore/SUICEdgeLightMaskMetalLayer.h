@class MTLRenderPassDescriptor, NSString, CADisplayLink, NSDate, NSScreen;
...
@interface SUICEdgeLightMaskMetalLayer : CAMetalLayer <CAAnimationDelegate> {
    ...
    id<MTLRenderPipelineState> _roundRenderPipeline;
    ...
    struct { void /* unknown type, empty encoding */ resolution; float yxRatio; float screenRadius; float screenRadiusRound; float falloffCoefficient; void /* unknown type, blank encoding */ flameScale; void /* unknown type, blank encoding */ burstOpacity; void /* unknown type, blank encoding */ contrast; } _layout;
