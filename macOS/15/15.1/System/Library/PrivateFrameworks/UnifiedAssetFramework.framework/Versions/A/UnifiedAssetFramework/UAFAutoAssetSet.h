@class NSString, NSUUID, NSMutableDictionary, MAAutoAssetSet, MAAutoAssetSetStatus;
...
- (id)initWithAssetSetName:(id)a0 autoAssets:(id)a1 uuid:(id)a2 experiment:(id)a3 error:(id *)a4;
