@class NSError, NSString, UAFAssetSetExperiment, NSUUID, NSDictionary, UAFAutoAssetSet, UAFAssetSetConfiguration, TRIClient;
...
+ (id)autoAssetSet:(id)a0 usages:(id)a1 uuid:(id)a2 autoAssets:(id)a3 experiment:(id)a4 error:(id *)a5;
...
- (id)initWithAssetSet:(id)a0 usages:(id)a1 configurationDirURLs:(id)a2 disableExperimentation:(BOOL)a3;
