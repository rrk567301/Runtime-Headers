...
- (id)initWithApplicationIdentifier:(id)a0 bundleIdentifier:(id)a1 name:(id)a2 iconData:(id)a3 bundleVersion:(id)a4 shortVersionString:(id)a5 applicationType:(id)a6 adamID:(id)a7 externalVersionIdentifier:(id)a8 betaExternalVersionIdentifier:(id)a9 staticUsage:(id)a10 dynamicUsage:(id)a11 onDemandResourcesUsage:(id)a12 unusedRedemptionCode:(id)a13 attributes:(id)a14 configuration:(id)a15 feedback:(id)a16 state:(unsigned long long)a17 managementFlags:(unsigned long long)a18 isManaged:(BOOL)a19 isValidated:(BOOL)a20 isInstalled:(BOOL)a21 isPlaceholder:(BOOL)a22 isAppUpdate:(BOOL)a23 isBetaApp:(BOOL)a24 isRemoveable:(BOOL)a25 fileSharingEnabled:(BOOL)a26 progress:(id)a27;
- (id)initWithBundleIdentifier:(id)a0 name:(id)a1 iconData:(id)a2 applicationType:(id)a3 adamID:(id)a4 externalVersionNumber:(id)a5 betaExternalVersionIdentifier:(id)a6 isInstalled:(BOOL)a7 isPlaceholder:(BOOL)a8 isAppUpdate:(BOOL)a9 isBetaApp:(BOOL)a10 isRemoveable:(BOOL)a11 fileSharingEnabled:(BOOL)a12 progress:(id)a13;
