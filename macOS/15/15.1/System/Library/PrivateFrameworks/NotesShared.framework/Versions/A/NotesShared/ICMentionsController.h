@class ICNote, NSString, ICMentionsParticipantNode, NSMutableDictionary, ICAutoCompleteSuggestionsViewController, ICTableColumnTextView, ICAttachmentInsertionController, NSMutableSet, NSTextView, NSObject;
