...
+ (void)principalComponentsForPoints:(const void *)a0 outFirstComponent:(struct CGVector { double x0; double x1; } *)a1 outSecondComponent:(struct CGVector { double x0; double x1; } *)a2;
