@class SSRVTUITrainingServiceClient, AVAudioPlayer, NSObject, NSMutableArray, CSAudioZeroCounter, CSVTUIKeywordDetector, NSString, SFSpeechRecognizer, SSRVoiceProfile, CSVTUIEndpointAnalyzer, CSPlainAudioFileWriter, CSVTUITrainingSession, CSAsset, CSDispatchGroup, NSUUID;
...
- (void)_playSoundsEffect:(long long)a0;
...
- (id)initWithLocaleIdentifier:(id)a0 withAudioSession:(id)a1 withAppDomain:(id)a2 shouldTrainViaXPC:(BOOL)a3;
