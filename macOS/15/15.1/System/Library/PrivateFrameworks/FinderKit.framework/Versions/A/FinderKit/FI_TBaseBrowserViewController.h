...
- (struct pair<bool, TFENodeVector> { BOOL x0; struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct __compressed_pair<TFENode *, std::allocator<TFENode>> { struct TFENode *x0; } x2; } x1; })preCheckFPActionForNodes:(id)a0 forUIElement:(id)a1;
