@class NSStackView, UnifiedTabBarItem, LayerView, NSImageView, RolloverImageButton, NSLayoutConstraint, NSString, NSImage, UnifiedTabBarVisualEffectView, NSArray, NSView, CABackdropLayer, NSTextField, WBSTabEntity;
