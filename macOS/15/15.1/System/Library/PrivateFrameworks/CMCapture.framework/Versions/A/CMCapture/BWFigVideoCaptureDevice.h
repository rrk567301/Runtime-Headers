@class BWActionCameraFlickerAvoidanceMonitor, BWMovingWindowStats, NSDictionary, BWStats, NSMutableSet, NSMutableArray, BWFigCaptureDevice, BWAmbientLightSensor, BWStereoVideoCaptureSceneMonitor, BWInferenceResult, BWZoomCommandHandler, BWMemoryPool, BWFigVideoCaptureSynchronizedStreamsGroup, BWImageControlModeTransitionMonitor, NSNumber, BWFigCaptureDeviceVendor, BWStillImageCaptureSettings, BWFigVideoCaptureStream, BWDeviceMotionActivityDetector, BWMetadataTimeMachine, BWBravoStreamSelector, BWVariableFrameRateSelector, NSArray, BWFrameStatisticsByPortType, BWRamp, NSMutableDictionary, FigWeakReference, BWZoomRange, NSString, NSObject, FigStateMachine, BWStreamStartStopSynchronizer, NSSet;
