@class BWRamp, BWScalingSession, CIContext, CIColor, NSDictionary, CIFilter, NSObject, CIBlendKernel;
@protocol OS_dispatch_queue, CMISmartStyle, CIRoundedRectangleStrokeGenerator, CIBlurredRectangleGenerator, BWVideoPIPOverlayDelegate, MTLCommandQueue, CMISmartStyleProxyRenderer;
...
@interface BWVideoPIPOverlayNode : BWNode {
    ...
    NSObject<OS_dispatch_queue> *_stylesProxyRendererLoadQueue;
