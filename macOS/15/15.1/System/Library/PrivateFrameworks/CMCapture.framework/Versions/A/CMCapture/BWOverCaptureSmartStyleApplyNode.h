@class BWPixelBufferPool, NSObject, CMISmartStyleOvercaptureThumbnailGenerator;
@protocol CMISmartStyle, CMISmartStyleProxyRenderer, CMISmartStyleProcessor, MTLCommandQueue, OS_dispatch_queue;
