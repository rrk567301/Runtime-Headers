@class NSHashTable, NSString, WBTabGroupManager, WBSCoreAnalyticsExtensionsStatistics, NSURL, NSMutableDictionary, _WKWebExtensionController, NSMutableSet, WBSWebExtensionNewTabOverridePreferencesManager;
@protocol WBSWebExtensionsControllerDelegate, WBSWebExtensionWindow;

@interface WBSWebExtensionsController : WBSExtensionsController <_WKWebExtensionControllerDelegate> {
...
@property (readonly, nonatomic) _WKWebExtensionController *webKitController;
...
- (void)webExtensionController:(id)a0 openNewTabWithOptions:(id)a1 forExtensionContext:(id)a2 completionHandler:(id /* block */)a3;
