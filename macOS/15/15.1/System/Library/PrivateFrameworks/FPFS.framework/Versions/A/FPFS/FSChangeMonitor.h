@class FSVolume, NSURL, NSMutableArray, NSObject;
...
@property (retain, nonatomic) NSURL *barrierFolderURL;
...
- (struct fpfs_fsevent_stream { } *)_createStreamNamed:(id)a0 since:(unsigned long long)a1 criteria:(id)a2;
...
- (id)initWithLabel:(id)a0 workloop:(id)a1;
