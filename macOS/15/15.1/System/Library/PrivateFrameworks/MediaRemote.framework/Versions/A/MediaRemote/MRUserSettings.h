...
@property (readonly, nonatomic) BOOL execssiveNowPlayingControllersABC;
...
@property (readonly, nonatomic) BOOL useDynamicEligibilityForRouteRecommendations;
...
@property (readonly, nonatomic) BOOL forceEnableUIAssertions;
