@class NSURL, PKPaymentOffersControllerSelectedOfferDetails, NSMutableDictionary, PKPaymentOfferCatalog, PKPaymentOffersControllerRequest, NSObject, NSMutableOrderedSet, NSHashTable, PKPaymentOffersControllerConfiguration, PKPassLibrary, PKPaymentService, PKPaymentWebService, NSError;
