...
- (id)_copyNewSearchableIndexesForMessagesWithLastRowID:(unsigned long long *)a0 messageRecordCount:(unsigned long long *)a1 messagesWithItemsGeneratedCount:(unsigned long long *)a2 batchSize:(unsigned long long)a3 timingCollection:(id)a4;
- (id)_donationManager;
...
- (void)_indexSearchableItems:(id)a0 clientState:(id)a1 lastIndexedRowID:(unsigned long long)a2 messagesInBatch:(unsigned long long)a3 messagesWithItemsGeneratedCount:(unsigned long long)a4 batchSize:(unsigned long long)a5 lastBatch:(BOOL)a6 withIndex:(id)a7 reason:(long long)a8 blockUntilCompleted:(BOOL)a9 completion:(id /* block */)a10;
