...
- (void)_suggestionsFromSearchableItem:(id)a0 options:(unsigned long long)a1 dissectIfNecessary:(BOOL)a2 processingType:(unsigned long long)a3 withCompletion:(id /* block */)a4;
