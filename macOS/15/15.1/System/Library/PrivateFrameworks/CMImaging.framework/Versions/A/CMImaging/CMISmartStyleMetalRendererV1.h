...
- (int)_populatePreComputedStats:(struct { unsigned int x0[10][256]; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; } x1[10]; unsigned int x2; unsigned int x3; float x4; struct { float x0; float x1; float x2; } x5; struct { float x0; float x1; float x2; } x6; } *)a0 inputStatisticsByStatsType:(id)a1;
