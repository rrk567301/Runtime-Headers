...
@protocol VUILanguageAwareStringHandling, VUIMusicManager, VUIControllerPresenter, VUIDocumentCreator, VUIOpenURLHandling, VUITimedMetadataManager, VUIGroupActivitiesManagerDelegate, VUITabBarProtocol, VUIPlaybackWindowManager;
