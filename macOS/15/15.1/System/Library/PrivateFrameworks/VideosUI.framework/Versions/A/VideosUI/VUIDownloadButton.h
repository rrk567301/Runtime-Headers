@class NSView, NSImageSymbolConfiguration, VUIDownloadButtonViewModel, VUITextLayout, VUIDownloadButtonActionHandler, NSImage, NSColor, VUICircularProgress, CAShapeLayer, NSViewController;
