@class NSFileProviderDomain, BRCVolume, BRCNamedThrottleManager, NSMutableSet, BRCDesktopAndDocumentsManager, BRCSyncContextProvider, BRCFSUploader, BRCDeadlineScheduler, BRCApplyScheduler, BRCDownloadTrackers, BRCServerChangesApplier, BRCClientState, BRCUserNotification, BRCServerPersistedState, BRDSIDString, BRCFileUnlinker, BRCThrottle, NSURL, NSNumber, BRCBouncingAnalyzer, BRCFSDownloader, BRCPQLConnection, BRCTapToRadarManager, BRCContainerScheduler, BRCBarrier, BRCAccountHandler, BRCFSImporter, NSMutableDictionary, NSString, NSObject, BRCAccountWaitOperation, BRCNotificationManager, NSHashTable, BRCAnalyticsReporter, BRCRecentsEnumerator, BRCSyncUpScheduler, BRCDiskSpaceReclaimer, BRCFairScheduler, BRCStageRegistry, BRCGlobalProgress;
@protocol BRCSyncUpStagingProtocol, BRFileProviderExtensionBackChannel, OS_dispatch_workloop, OS_dispatch_source, BRCZoneAppRetriever, OS_dispatch_queue, BRCDownloadStagingProtocol;
...
@interface BRCAccountSessionFPFS : NSObject <BRCCloudDocsAppsObserver, BRCSessionContext, BRCZoneAppRetriever> {
    ...
    id<BRFileProviderExtensionBackChannel> _extensionBackChannel;
...
@property (retain, nonatomic) id<BRFileProviderExtensionBackChannel> extensionBackChannel;
