@class NLTagger, TCTextCompositionSmartRepliesCache;
...
- (void)addGrammarCheckingDetailsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 originalSentenceRanges:(id)a3 tagger:(id)a4 writingOptions:(id)a5 toDictionary:(id)a6;
- (void)addGrammarCheckingDetailsForRewrittenString:(id)a0 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 originalString:(id)a2 originalAttributedString:(id)a3 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 tagger:(id)a5 writingOptions:(id)a6 toDictionary:(id)a7;
...
- (id)classificationPromptForRewritingType:(id)a0 instructions:(id)a1 options:(id)a2 error:(id *)a3;
...
- (id)sanitizationListForRewritingType:(id)a0 string:(id)a1 instructions:(id)a2;
...
- (BOOL)shouldUseInstructionsWithClassificationResult:(id)a0;
...
- (id)textCheckingResultsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 offset:(unsigned long long)a3 writingOptions:(id)a4;
