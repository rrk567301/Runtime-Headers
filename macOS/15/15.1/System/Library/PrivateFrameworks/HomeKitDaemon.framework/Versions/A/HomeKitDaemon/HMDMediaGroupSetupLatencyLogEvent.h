...
- (void).cxx_destruct;
- (id)initWithRequestType:(id)a0 systemUUID:(id)a1 deviceRole:(id)a2 totalDurationMS:(unsigned long long)a3 setupSessionIdentifier:(id)a4 totalDurationSinceAccessorySetupStartMS:(unsigned long long)a5 errorStage:(id)a6;
