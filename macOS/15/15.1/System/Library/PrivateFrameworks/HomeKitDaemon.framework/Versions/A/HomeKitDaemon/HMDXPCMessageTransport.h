@class NSString, NSArray, NSXPCInterface, HMDProcessMonitor, NSDictionary, HMXPCMessageTransportConfiguration, NSMutableSet;
@protocol HMDAppProtectionGuard, HMDXPCListener;
