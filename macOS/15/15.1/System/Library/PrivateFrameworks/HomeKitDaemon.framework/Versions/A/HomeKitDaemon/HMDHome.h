...
@property (readonly) NSUUID *userSelectedPreferredIdentifier;
@property (readonly, copy) NSArray *autoSelectedPreferredIdentifiers;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
- (void)_modifyCharacteristicNotificationsOnRemoteGateways:(id)a0 characteristicChangeThresholds:(id)a1 mediaNotifications:(id)a2 actionSetNotificationPayload:(id)a3 matterAttributeNotifications:(id)a4 enableNotification:(BOOL)a5;
...
- (void)_registerForAccessoryReachabilityNotifications:(BOOL)a0 registrationIdentifier:(id)a1 clientBundleIdentifier:(id)a2;
- (void)_registerForMatterFabricNotifications:(BOOL)a0 registrationIdentifier:(id)a1 clientBundleIdentifier:(id)a2;
...
- (void)invokeCommandWithNodeId:(unsigned long long)a0 endpointId:(id)a1 clusterId:(id)a2 commandId:(id)a3 fields:(id)a4 timedInvokeTimeout:(id)a5 completion:(id /* block */)a6;
...
- (void)registerForMatterFabricNotifications:(BOOL)a0 registrationIdentifier:(id)a1 clientBundleIdentifier:(id)a2;
...
- (void)subscribeAttributeWithNodeId:(unsigned long long)a0 endpointId:(id)a1 clusterId:(id)a2 attributeId:(id)a3 minInterval:(id)a4 maxInterval:(id)a5 params:(id)a6 establishedHandler:(id /* block */)a7 completion:(id /* block */)a8;
