...
- (void)sendLockOperationEventNotification:(id)a0 lockOperationType:(id)a1 lockOperationSource:(id)a2 fabricIndex:(id)a3 accessory:(id)a4 timestamp:(id)a5 flow:(id)a6;
