@class NSNotificationCenter, NSDate, NSDictionary, HMFMessage, HMDActionSetEvent, HMFMessageDispatcher, NSObject, NSMutableArray, HMDApplicationData, NSString, NSSet, NSArray, HMDHome, HMFTimer, NSUUID;
