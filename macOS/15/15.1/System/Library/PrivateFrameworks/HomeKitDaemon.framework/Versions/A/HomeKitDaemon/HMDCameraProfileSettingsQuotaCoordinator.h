...
- (BOOL)_requiresDisablingCloudStorageForAccessMode:(unsigned long long)a0 isAtHome:(BOOL)a1;
...
- (void)_updateCloudStorageAndSettingsWithAccessMode:(unsigned long long)a0 forIsAtHome:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)updateCloudStorageAndSettingsWithAccessMode:(unsigned long long)a0 forIsAtHome:(BOOL)a1 completion:(id /* block */)a2;
