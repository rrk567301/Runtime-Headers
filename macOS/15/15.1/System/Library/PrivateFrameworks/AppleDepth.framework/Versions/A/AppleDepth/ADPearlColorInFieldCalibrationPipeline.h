...
- (long long)preProcessPearl:(struct __CVBuffer { } *)a0 pose:(struct { void /* unknown type, empty encoding */ x0[4]; })a1 prevPose:(struct { void /* unknown type, empty encoding */ x0[4]; })a2 referenceCameraCalibration:(id)a3 pearlCameraCalibration:(id)a4 reprojectedPointsBuffer:(struct __CVBuffer { } *)a5 reprojectedPointsMaskBuffer:(struct __CVBuffer { } *)a6;
