...
- (void)_updateLargeFilesTaskResumeState:(id)a0 data:(id)a1 sendFlags:(unsigned int)a2 error:(id)a3 complete:(BOOL)a4;
- (id)_ioQueueDequeue;
...
- (BOOL)_largeFileReceiveTaskUpdateSHA256CtxFromFileItem:(id)a0 length:(unsigned long long)a1 error:(id *)a2;
...
- (int)_openWriteFileItem:(id)a0 size:(long long)a1 truncate:(BOOL)a2 error:(id *)a3;
- (int)_openWritePath:(id)a0 size:(long long)a1 error:(id *)a2;
- (int)_openWritePath:(id)a0 size:(long long)a1 truncate:(BOOL)a2 error:(id *)a3;
- (void)_prefsChanged;
...
- (BOOL)_truncateFD:(int)a0 size:(long long)a1 error:(id *)a2;
