@class NSUUID, NSString, NSArray, RBSProcessIdentity, LSApplicationIdentity, RBSProcessHandle, NSDictionary, NSSet, RBProcess, RBSProcessIdentifier, RBSMachPort, NSNumber;
