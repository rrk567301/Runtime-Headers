@class SRUIFSiriSessionStateHandler, NSString, SUIBUIBridgeClient, NSObject;
...
- (oneway void)uiBridgeServiceTaskDidCancel:(id)a0;
- (oneway void)uiBridgeServiceTaskDidEnd:(id)a0;
- (id)buildLatencyTextFromActionFlow:(id)a0;
- (void)endForReason:(long long)a0;
- (void)idleAndQuietDidChange:(BOOL)a0;
- (void)newRequestWillStart;
- (void)promptedUserForInput;
- (oneway void)uiBridgeServiceReceivedCancelPhotoSelectionWithAnimation:(BOOL)a0;
- (oneway void)uiBridgeServiceReceivedShowPhotoSelectionWithSearchString:(id)a0;
