...
- (void)createEDPLivenessDictionaryWithContext:(id)a0 uiProvider:(id)a1 completion:(id /* block */)a2;
...
- (void)uploadEDPRecoveryTokenForContext:(id)a0 uiProvider:(id)a1 completion:(id /* block */)a2;
