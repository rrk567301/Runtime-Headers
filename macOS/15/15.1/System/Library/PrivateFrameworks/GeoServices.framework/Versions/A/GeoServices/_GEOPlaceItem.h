@class GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEORestaurantFeaturesLink, GEOMapItemClientAttributes, geo_isolater, GEOTrailHead, GEOMuninViewState, GEOBusinessAssets, GEOMessageLink, GEOMapItemContainedPlace, GEOPlacecardLayoutData, GEOPDPlace, GEOPDHikeAssociatedInfo, GEOStyleAttributes, GEOMapItemIdentifier, NSSet, GEOEnrichmentInfo, GEOMiniBrowseCategories, GEOViewportFrame, GEOExploreGuides, GEOLabelGeometry, GEOAppleRating, GEOPDFlyover, GEOEnrichmentData, NSData, GEOPlaceResult, GEOEnhancedPlacement, NSDate, GEOAssociatedApp, NSArray, GEOPOIClaim, NSTimeZone, GEOFeatureStyleAttributes, GEOMapItemPlaceAttribution, GEOPDURLData, GEOAddressObject, GEOInlineRapEnablement, GEOPriceDescription, GEOTooltip, GEOAddress, NSString, GEOStorefrontInfo, GEOEVCharger, GEOPDHikeGeometry, NSURL, GEOLocalizedString, NSDictionary, GEOHikeSummary, GEOPlaceQuestionnaire, GEOEnclosingPlace, GEOMapRegion, GEOMapItemReviewsAttribution, GEOStorefrontPresentationInfo, GEOPlace;
