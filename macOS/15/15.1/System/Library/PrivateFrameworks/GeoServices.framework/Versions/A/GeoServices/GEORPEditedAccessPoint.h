@class PBDataReader, GEORoadAccessPoint, GEORPCorrectedString, PBUnknownFields;
...
@interface GEORPEditedAccessPoint : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_corrected : 1; unsigned char read_name : 1; unsigned char read_original : 1; unsigned char wrote_anyField : 1; } _flags;
}
