...
- (void)encodeBlendWarpedFeaturesWithErrorMaskToCommandBuffer:(id)a0 first:(id)a1 second:(id)a2 forwardErrorMap:(id)a3 backwardErrorMap:(id)a4 forwarpConsistency:(id)a5 backwardConsistency:(id)a6 timeScale:(float)a7 destination:(id)a8;
...
- (void)encodeWarpAndBlendFeaturesWithErrorMaskToCommandBuffer:(id)a0 first:(id)a1 second:(id)a2 forwardFlow:(id)a3 backwardFlow:(id)a4 forwardErrorMap:(id)a5 backwardErrorMap:(id)a6 forwarpConsistency:(id)a7 backwardConsistency:(id)a8 timeScale:(float)a9 destination:(id)a10;
- (id)initWithDevice:(id)a0 commmandQueue:(id)a1 mode:(unsigned long long)a2;
