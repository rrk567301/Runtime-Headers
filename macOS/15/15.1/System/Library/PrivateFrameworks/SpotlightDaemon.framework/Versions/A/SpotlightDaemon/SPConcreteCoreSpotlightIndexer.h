...
- (id)indexLossAnalyticsDictWithPreviousIndexCreationDate:(long long)a0 size:(long long)a1 openingInReadOnly:(BOOL)a2 fullyCreated:(BOOL)a3 markedPurgeable:(BOOL)a4 forAnalytics:(BOOL)a5;
