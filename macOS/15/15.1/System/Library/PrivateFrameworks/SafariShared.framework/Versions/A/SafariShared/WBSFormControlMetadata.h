...
@property (readonly, nonatomic, getter=isVerticalWritingMode) BOOL verticalWritingMode;
...
@property (readonly, nonatomic) BOOL looksLikeEIDField;
@property (readonly, nonatomic) BOOL looksLikeIMEIField;
...
+ (id)formControlMetadataFromSerializedData:(id)a0;
...
- (id)dictionaryRepresentationRedactingSensitiveValues:(BOOL)a0;
