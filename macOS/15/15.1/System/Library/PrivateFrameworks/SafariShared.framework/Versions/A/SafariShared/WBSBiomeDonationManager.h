...
- (id)_autoPlayStream;
- (id)_pageLoadStream;
- (void)donateNavigationWithURL:(id)a0 userAgent:(long long)a1 wasPrivateRelayed:(BOOL)a2 statusCode:(long long)a3;
...
- (void)donateBrowsingAssistantServerRequestEndedEventWithWebPageID:(id)a0 requestIdentifier:(id)a1 summary:(id)a2 tableOfContentsTexts:(id)a3;
...
- (void)donateBrowsingAssistantUserInteractionDetectedWithWebPageID:(id)a0 componentType:(long long)a1 componentIdentifier:(id)a2 summaryText:(id)a3 tableOfContentsArrayLength:(id)a4;
...
- (void)donateBrowsingAssistantVisualComponentPresentationStartedWithWebPageID:(id)a0 componentType:(long long)a1 componentIdentifier:(id)a2 summaryText:(id)a3 tableOfContentsArrayLength:(id)a4;
