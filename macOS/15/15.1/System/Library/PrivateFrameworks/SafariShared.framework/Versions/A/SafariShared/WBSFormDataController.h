...
- (BOOL)_hasMatchingAutoFillEventForUsername:(id)a0 withinTimeInterval:(double)a1 inTabWithID:(id)a2 currentURL:(id)a3 shouldAllowPrivateTabs:(BOOL)a4 shouldRemoveMatchingEvent:(BOOL)a5;
