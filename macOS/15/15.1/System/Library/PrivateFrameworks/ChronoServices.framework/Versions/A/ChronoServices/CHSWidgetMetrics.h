...
@property (readonly, nonatomic) CHSWidgetMargins *widgetGroupMargins;
...
@property (readonly, nonatomic) struct CHSEdgeInsets { double x0; double x1; double x2; double x3; } widgetGroupSafeAreaInsets;
@property (readonly, nonatomic) struct CHSEdgeInsets { double x0; double x1; double x2; double x3; } widgetGroupLayoutInsets;
@property (readonly, nonatomic) struct CHSEdgeInsets { double x0; double x1; double x2; double x3; } widgetGroupContentMargins;
