...
@interface BCSBusinessQueryController : NSObject <BCSLinkQueryChopperDelegate, BCSBusinessConfigProvider, BCSBusinessShardProvider, BCSBusinessItemProvider, BCSBusinessLookupProvider, BCSXPCDaemonProtocol>
...
@property (retain, nonatomic) id<BCSItemResolving> businessEmailItemResolver;
