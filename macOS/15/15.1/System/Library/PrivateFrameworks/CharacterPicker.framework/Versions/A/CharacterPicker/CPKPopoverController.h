@class CPKCategoriesView, STKEmojiGenerationViewController, NSDictionary, CPKCharactersView, CPKSearchView, NSMutableArray, CPKDividerLine, NSString, CPSearchManager, CPKCategoriesPickerView, NSArray, CPKBottomView, CPKDataProvider;

@interface CPKPopoverController : NSViewController <CPKCharactersViewDelegate, CPKCharactersViewDataSource, CPKSearchViewDelegate, NSSearchFieldDelegate, NSWindowDelegate> {
