@class NSView, NSString, NSTextField, CPKCharactersTableView, NSMutableDictionary, NSDictionary, NSOperationQueue, CPKSearchField, CPKCalculatedGeometry, CPKHorizontalPopupMenu, CPKCharactersSectionView;
