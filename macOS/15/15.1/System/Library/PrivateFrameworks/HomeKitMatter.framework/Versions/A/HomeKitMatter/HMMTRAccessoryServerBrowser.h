...
@protocol HMMTRAccessoryServerBrowserDelegate, HMMTRVendorMetadataStore, HAPAccessoryServerBrowserDelegate, OS_dispatch_queue, OS_nw_browser;
...
- (void)prepareForPairingWithSetupPayload:(id)a0 fabric:(id)a1 fabricID:(id)a2 owner:(BOOL)a3 ownerCertFetchSupported:(BOOL)a4 completionHandler:(id /* block */)a5;
