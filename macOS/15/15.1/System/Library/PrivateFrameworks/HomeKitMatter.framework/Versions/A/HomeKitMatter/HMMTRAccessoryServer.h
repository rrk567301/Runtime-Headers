...
- (void)_handleDownloadLogCommand:(id)a0 device:(id)a1 completion:(id /* block */)a2;
...
- (void)_readCharacteristicValuesForFailedResponses:(id)a0 atIndexes:(id)a1 device:(id)a2 completionHandler:(id /* block */)a3;
- (void)_readCharacteristicValuesForFailedResponses:(id)a0 dispatchGroup:(id)a1 errorHandler:(id /* block */)a2;
...
- (void)_registerStateCaptureHandler:(unsigned long long)a0 stateCaptureInformation:(id)a1;
