...
- (id)initWithIdentifier:(id)a0 name:(id)a1 kind:(id)a2 engineResourceID:(id)a3 superfeedConfigResourceID:(id)a4 latestPuzzleIDs:(id)a5 promotedPuzzleIDs:(id)a6 nameImageAssetHandle:(id)a7 nameImageCompactAssetHandle:(id)a8 nameImageMaskAssetHandle:(id)a9 nameImageForDarkBackgroundAssetHandle:(id)a10 feedNavImageAssetHandle:(id)a11 coverImageAssetHandle:(id)a12 navigationChromeBackgroundImageHandle:(id)a13 navigationChromeBackgroundImageCompactHandle:(id)a14 navigationChromeBackgroundImageLargeHandle:(id)a15 navigationChromeBackgroundDarkModeImageHandle:(id)a16 navigationChromeBackgroundDarkModeImageCompactHandle:(id)a17 navigationChromeBackgroundDarkModeImageLargeHandle:(id)a18 language:(id)a19 allowedStorefrontIDs:(id)a20 blockedStorefrontIDs:(id)a21 minimumNewsVersion:(long long)a22 loadDate:(id)a23 fetchDate:(id)a24 lastModifiedDate:(id)a25 exploreTileImageAssetHandle:(id)a26 versionKey:(id)a27 titleDisplayPrefix:(id)a28 titleDisplaySuffix:(id)a29 themeColor:(id)a30 puzzlePrimaryColor:(id)a31 darkStyleThemeColor:(id)a32 darkStylePuzzlePrimaryColor:(id)a33 groupTitleColor:(id)a34 groupDarkStyleTitleColor:(id)a35 thumbnailDirectory:(id)a36;
