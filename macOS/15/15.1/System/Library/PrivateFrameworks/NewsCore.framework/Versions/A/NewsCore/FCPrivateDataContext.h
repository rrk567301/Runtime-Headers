@class FCReadingList, FCPersonalizationData, FCUserInfo, FCTagSettings, FCPrivateChannelMembershipController, FCPuzzleTypeSettings, FCReadingHistory, NSString, FCShortcutCategoryList, FCIssueReadingHistory, FCPuzzleHistory, FCSubscriptionList, FCUserEventHistory, FCAudioPlaylist, FCShortcutList;
