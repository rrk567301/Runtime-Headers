...
@interface CKDPRecordRetrieveRequest : PBRequest <NSCopying> {
    struct { unsigned char requestEncryptedAssetOwnerIdentifier : 1; unsigned char shouldFailBatch : 1; } _has;
}
...
@property (nonatomic) BOOL hasRequestEncryptedAssetOwnerIdentifier;
@property (nonatomic) BOOL requestEncryptedAssetOwnerIdentifier;
