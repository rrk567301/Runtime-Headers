...
- (id)createCloudKitFeaturesSignatureForData:(id)a0 error:(id *)a1;
...
- (id)createSignatureWithIdentity:(struct _PCSIdentityData { } *)a0 dataToBeSigned:(id)a1 useWholePublicKeyAsSigner:(BOOL)a2 error:(id *)a3;
- (id)createSignatureWithServiceType:(unsigned long long)a0 dataToBeSigned:(id)a1 useWholePublicKeyAsSigner:(BOOL)a2 error:(id *)a3;
