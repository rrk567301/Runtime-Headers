@class CKDPZoneCryptoFeatureSet, CKDPZoneZoneReference, CKDPProtectionInfoKeysToRemove, CKDPRecordStableUrl, CKDPShareIdentifier, CKDPZoneSignedCryptoRequirements, CKDPProtectionInfo, CKDPStorageExpiration, CKDPRecordZoneIdentifier, NSMutableArray;
