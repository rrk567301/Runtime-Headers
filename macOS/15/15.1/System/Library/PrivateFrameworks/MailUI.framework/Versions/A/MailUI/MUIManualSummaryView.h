@interface MUIManualSummaryView : NSView {
    ...
    void /* unknown type, empty encoding */ buttonTitleAdditionalTrailingPadding;
    void /* unknown type, empty encoding */ topPadding;
    void /* unknown type, empty encoding */ horizontalInsetFromLayoutMargin;
    ...
    void /* unknown type, empty encoding */ buttonTitleTrailingConstraintConstant;
    ...
    void /* unknown type, empty encoding */ buttonTitleTrailingConstraint;
