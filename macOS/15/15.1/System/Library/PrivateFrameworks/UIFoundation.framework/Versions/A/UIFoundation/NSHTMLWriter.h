...
- (unsigned long long)_paragraphClassforParagraphStyle:(id)a0 presentationIntent:(id)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 isEmpty:(BOOL)a3 isCompletelyEmpty:(BOOL)a4 headerString:(id *)a5 alignmentString:(id *)a6 directionString:(id *)a7;
- (id)_prefixDown;
- (id)_prefixUp;
