...
+ (id)maskByDilatingMask:(id)a0 amount:(double)a1;
...
+ (BOOL)renderImage:(id)a0 intoMutableBuffer:(id)a1 destinationBounds:(struct { struct { long long x0; long long x1; } x0; struct { long long x0; long long x1; } x1; })a2 context:(id)a3 error:(out id *)a4;
