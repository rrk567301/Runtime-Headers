...
+ (id)_detectedFacesFromFaceResult:(id)a0;
...
+ (id)inflatedFaceRects:(id)a0 captureOrientation:(long long)a1 multiplier:(double)a2;
+ (BOOL)loadAndRegisterInpaintModel:(out id *)a0;
+ (BOOL)loadAndRegisterModelForKey:(id)a0 error:(out id *)a1;
+ (BOOL)macOSDeviceIsAppleSilicon;
...
+ (BOOL)maskIsMostlyWithinFace:(id)a0 imageSize:(struct { long long x0; long long x1; })a1 detectedFaces:(id)a2;
...
+ (BOOL)strokeIsEntirelyWithinFace:(id)a0 imageSize:(struct { long long x0; long long x1; })a1 detectedFaces:(id)a2;
