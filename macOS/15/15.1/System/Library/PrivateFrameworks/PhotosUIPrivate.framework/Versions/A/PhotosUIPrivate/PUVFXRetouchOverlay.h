@class _TtC15PhotosUIPrivate27PUVFXDimmingBackgroundLayer, NSString, NSView, CIContext, PUVFXBrushView, NSArray, PIInpaintMaskContext, NSDictionary, NSWindow, NUComposition;
@protocol PUVFXCleanupOverlayDelegate;
