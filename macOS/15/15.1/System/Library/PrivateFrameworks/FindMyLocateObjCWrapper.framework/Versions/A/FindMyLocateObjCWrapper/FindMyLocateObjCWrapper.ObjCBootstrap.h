@class NSData, NSArray, NSString, FMLHandle, NSError, FMLDevice, NSDate;
...
- (void)processLocationCommandPayloadWithPayload:(NSData *)a0 completionHandler:(void (^)(NSError *))a1;
- (void)processLocationPayloadWithPayload:(NSData *)a0 completionHandler:(void (^)(NSError *))a1;
