@class NSString, AMSPromise, AMSURLSession, NSObject;
@protocol AMSBagProtocol, AMSMetricsDataSource, OS_dispatch_queue;

@interface AMSMetricsFigaroFlushTask : AMSTask <AMSMetricsFlushTask> {
    NSObject<OS_dispatch_queue> *_anomalyDetectionQueue;
...
- (void).cxx_destruct;
- (BOOL)cancel;
- (void)_detectAnomaliesForEvent:(id)a0;
