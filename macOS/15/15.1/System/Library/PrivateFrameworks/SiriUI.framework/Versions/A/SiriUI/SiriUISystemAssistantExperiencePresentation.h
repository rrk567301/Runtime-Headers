@class SiriUISystemAssistantExperienceViewController, NSString, AFConversation, SiriSharedUICompactViewModelController, SAUIFeedbackForm, NSObject;
@protocol SiriUIPresentationDelegate, OS_dispatch_queue, SiriUIPresentationDataSource;

@interface SiriUISystemAssistantExperiencePresentation : NSObject <SiriUISystemAssistantExperienceViewControllerDelegate, SiriSharedUICompactViewModelControllerDelegate, SiriUIPresentation> {
