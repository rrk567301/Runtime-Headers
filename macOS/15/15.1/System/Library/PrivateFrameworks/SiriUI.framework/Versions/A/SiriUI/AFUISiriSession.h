@class NSTimer, NSString, AFModesConfiguration, SRUIFAudioPowerLevelUpdater, AFConnection, SRUIFStateFeedbackManager, NSObject, SRUIFSpeechRequestHandler, NSMutableArray, SRUIFSiriSessionStateHandler, SRUIFUIBridgeClient;
...
@interface AFUISiriSession : NSObject <AFAssistantUIService, AFSpeechDelegate, AFUISpeechSynthesisLocalDelegate, SRUIFSiriSessionStateHandlerDelegate, SRUIFStateFeedbackManagerDelegate, SRUIFSpeechRequestHandlerDelegate, SRUIFAudioPowerLevelUpdaterDelegate, AFUISiriSession, SRUIFUIBridgeClientDelegate> {
    ...
    NSMutableArray *_ongoingOrchestrationTasks;
}
...
- (void)_orchestrationTaskCompleted:(id)a0;
...
- (void)orchestrationTaskEnded:(id)a0;
- (void)orchestrationTaskWasCancelled:(id)a0;
- (void)performAceCommand:(id)a0 conflictHandler:(id /* block */)a1;
- (void)performAceCommands:(id)a0;
- (void)receivedOrchestrationTasksWithIDs:(id)a0;
