@class NSDictionary, CSAudioStream, CSAudioCircularBuffer, NSMutableArray, CSPhraseDetector, NSString, CSVoiceTriggerFirstPassMetrics, SSRSpeakerRecognitionController, CSPlainAudioFileWriter, CSVoiceTriggerSecondPassConfig, NSMutableDictionary, CSAudioTimeConverter, SSRSpeakerRecognitionContext, CSAsset, NSObject, CSSpeechManager, CSVTSecondPassLatencyMetrics, CSExclaveRecordClient, CSPhraseNDEAPIScorer, CSVoiceTriggerAwareZeroFilter, NSUUID;
...
- (void)_processSecondPassInExclave:(id /* block */)a0;
