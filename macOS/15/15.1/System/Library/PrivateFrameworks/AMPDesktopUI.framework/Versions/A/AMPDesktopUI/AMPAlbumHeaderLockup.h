@class NSStackView, NSObject, NSMenu, NSButton, AMPAvatarStackLockup, NSLayoutConstraint, NSString, NSLevelIndicator, _TtC12AMPDesktopUI16AMPArtworkLockup, BadgeStackLockup, NSView, NSTextField, KeyColorButton;
@protocol AMPAlbumHeaderLockupModel;

@interface AMPAlbumHeaderLockup : NSTableCellView <AMPNewImagePickerDelegate, NSTextFieldDelegate> {
