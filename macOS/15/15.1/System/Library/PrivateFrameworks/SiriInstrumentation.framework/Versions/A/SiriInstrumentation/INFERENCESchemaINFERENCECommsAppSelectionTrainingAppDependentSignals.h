...
@interface INFERENCESchemaINFERENCECommsAppSelectionTrainingAppDependentSignals : SISchemaInstrumentationMessage {
    struct { unsigned char isResolvedApp : 1; unsigned char isResolvedContactInApp : 1; unsigned char appTimeSpentAffinityScore : 1; unsigned char isForegroundApp : 1; unsigned char timeSinceAppLastLaunchedInSec : 1; unsigned char isFirstPartyApp : 1; unsigned char appTimeSpentInSec : 1; unsigned char timeSinceAppContactLastLaunchedInSec : 1; } _has;
}
