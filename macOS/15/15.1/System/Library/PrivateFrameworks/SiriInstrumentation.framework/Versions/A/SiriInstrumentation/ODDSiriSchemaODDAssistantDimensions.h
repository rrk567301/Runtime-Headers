...
@interface ODDSiriSchemaODDAssistantDimensions : SISchemaInstrumentationMessage {
    struct { unsigned char dataSharingOptInStatus : 1; unsigned char viewInterface : 1; unsigned char asrLocation : 1; unsigned char nlLocation : 1; unsigned char responseCategory : 1; unsigned char isIntelligenceEngineRequest : 1; } _has;
}
