...
- (id)audioRecordingDataForModernAttachment:(id)a0 appBackgroundOccurred:(BOOL)a1 noteMultitaskingOccurred:(BOOL)a2;
...
- (void)submitAudioRecordingEventWithAttachment:(id)a0 appBackgroundOccurred:(BOOL)a1 noteMultitaksingOccurred:(BOOL)a2;
