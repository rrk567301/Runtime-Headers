...
- (id)init;
- (int)computeLTM:(const struct sLtmComputeInput { float x0[3072]; float x1[64]; float x2[1024]; float x3[48]; float x4[48]; float x5[64]; float x6[64]; float x7[65]; float x8[48]; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; float x20; unsigned short x21; float x22[9]; float x23[192]; float x24; float x25; float x26; BOOL x27; BOOL x28; float x29[48]; float x30; } *)a0 withMetadata:(const struct sLtmComputeMeta { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; int x5; BOOL x6; int x7; float x8; unsigned char x9; struct LTMTuning { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; float x20; float x21; float x22; float x23; float x24; float x25; float x26; } x10[4]; BOOL x11; } *)a1 to:(struct sLtmComputeOutput { float x0[3120]; float x1[65]; float x2[257]; float x3[257]; float x4[5184]; float x5[257]; float x6; unsigned long long x7; float x8; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; unsigned char x14 : 3; } *)a2;
