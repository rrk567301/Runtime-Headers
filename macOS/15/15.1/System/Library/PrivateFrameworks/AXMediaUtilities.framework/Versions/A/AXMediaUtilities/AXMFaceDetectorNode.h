@class VNClassifyFaceAttributesRequest, VNDetectFaceLandmarksRequest, VNDetectFacePoseRequest, VNDetectFaceRectanglesRequest, VNDetectFaceExpressionsRequest, VNCreateFaceprintRequest;
