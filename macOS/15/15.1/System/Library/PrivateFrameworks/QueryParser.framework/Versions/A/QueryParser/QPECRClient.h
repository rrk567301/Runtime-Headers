...
- (id)visualIdentifiersWithText:(id)a0 allowPrefixSearch:(BOOL)a1 entityFilterType:(long long)a2 includeInferredNames:(BOOL)a3 allowGroundingToNamesAndEmails:(BOOL)a4 error:(id *)a5;
- (void)warmUpAsync;
