@class NSString, WFDialogButton, WFParameterKeyValuePair;
...
- (id)initWithActionMetadata:(id)a0 showPrompt:(BOOL)a1 dialogString:(id)a2 viewSnippet:(id)a3 yesText:(id)a4 noText:(id)a5 attribution:(id)a6 parameterInfo:(id)a7 isContinueInAppRequest:(BOOL)a8;
- (id)initWithActionParameterMetadata:(id)a0 dialogString:(id)a1 viewSnippet:(id)a2 attribution:(id)a3 parameterInfo:(id)a4;
- (id)initWithTitle:(id)a0 viewSnippet:(id)a1 yesText:(id)a2 noText:(id)a3 attribution:(id)a4 parameterInfo:(id)a5 isContinueInAppRequest:(BOOL)a6;
