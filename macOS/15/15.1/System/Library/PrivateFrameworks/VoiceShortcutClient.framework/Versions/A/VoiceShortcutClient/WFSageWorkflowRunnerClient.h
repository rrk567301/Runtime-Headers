...
- (void)completeStepExecutionForActionIdentifier:(id)a0 serializedVariable:(id)a1 executionMetadata:(id)a2 error:(id)a3;
...
- (void)extractVariableContentFromEncodedReference:(id)a0 forEncodedExpectedType:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)initWithClientIdentifier:(id)a0 siriSessionID:(id)a1;
- (void)injectContentAsVariable:(id)a0 completionHandler:(id /* block */)a1;
- (void)outOfProcessWorkflowController:(id)a0 actionWithUUID:(id)a1 didFinishRunningWithError:(id)a2 serializedVariable:(id)a3 executionMetadata:(id)a4;
...
- (void)performQuery:(id)a0 inValueSet:(id)a1 toolInvocation:(id)a2 completionHandler:(id /* block */)a3;
- (void)performSiriRequest:(id)a0 completionHandler:(id /* block */)a1;
- (void)resolveDeferredValueFromEncodedStorage:(id)a0 forEncodedExpectedType:(id)a1 completionHandler:(id /* block */)a2;
