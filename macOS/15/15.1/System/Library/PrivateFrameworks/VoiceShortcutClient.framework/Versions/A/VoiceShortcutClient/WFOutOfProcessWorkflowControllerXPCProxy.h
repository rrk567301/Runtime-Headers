...
- (oneway void)extractVariableContentFromEncodedReference:(id)a0 forEncodedExpectedType:(id)a1 completionHandler:(id /* block */)a2;
...
- (oneway void)performQuery:(id)a0 inValueSet:(id)a1 toolInvocation:(id)a2 completionHandler:(id /* block */)a3;
...
- (oneway void)resolveDeferredValueFromEncodedStorage:(id)a0 forEncodedExpectedType:(id)a1 completionHandler:(id /* block */)a2;
