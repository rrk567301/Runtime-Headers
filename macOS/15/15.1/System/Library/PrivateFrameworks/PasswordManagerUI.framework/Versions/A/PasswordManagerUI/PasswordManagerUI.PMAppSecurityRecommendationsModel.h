@interface PasswordManagerUI.PMAppSecurityRecommendationsModel : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ _highPriorityRecommendations;
    void /* unknown type, empty encoding */ _standardRecommendations;
    void /* unknown type, empty encoding */ _hiddenRecommendations;
    ...
    void /* unknown type, empty encoding */ _selectedAccountID;
