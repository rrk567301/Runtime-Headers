@class NSString, NSXPCConnection, NSMutableDictionary, NSSet, NSObject, COClusterRoleMonitor;
@protocol OS_dispatch_queue, COMessageChannelConnectionProvider, COClusterRoleMonitorConnectionProvider;
...
+ (id)messageChannelWithTopic:(id)a0 cluster:(id)a1 manualGrouping:(BOOL)a2;
...
- (void)_invokeResponseCallbackForInfo:(id)a0 snapshot:(id)a1 response:(id)a2 error:(id)a3;
