...
- (BOOL)registerListenerWithCellularTapType:(id)a0 clientProcessId:(id)a1 powerSpectrumMeter:(id)a2 powerSpectrumMeterKey:(id)a3 resultDictionary:(id *)a4 error:(id *)a5;
