...
@interface VideoConference : VCObject <GKNATObserverDelegate, VCVideoSink, VCVideoCaptureClient, VCCallSessionDelegate, VCAudioIOSource, VCAudioIOSink, VCAudioIODelegate, VCAudioPowerLevelMonitorDelegate, VCMediaRecorderTransportDelegate> {
    int _clientPid;
    id delegate;
