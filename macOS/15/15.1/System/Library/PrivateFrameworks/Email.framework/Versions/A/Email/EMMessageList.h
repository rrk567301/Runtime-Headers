@class NSMutableDictionary, NSMapTable, NSPredicate, NSDictionary, EFLazyCache, NSObject, EFLocked, EMMailboxScope, NSString, EFFuture, NSSet, EMCollectionItemIDStateCapturer, EMThreadScope, EMObjectID, EMMessageRepository;
