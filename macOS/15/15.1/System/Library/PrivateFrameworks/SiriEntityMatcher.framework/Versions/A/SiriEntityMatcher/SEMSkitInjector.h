...
@interface SEMSkitInjector : NSObject <SEMSkitReadAccess, SEMSkitAccessProvider> {
    ...
    struct Indexer { struct ContextV2 { struct shared_ptr<skit::internal::ContextImpl> { struct ContextImpl *__ptr_; struct __shared_weak_count *__cntrl_; } pimpl; } context; struct IndexWriter { struct unique_ptr<skit::internal::IndexWriterImpl, std::default_delete<skit::internal::IndexWriterImpl>> { struct __compressed_pair<skit::internal::IndexWriterImpl *, std::default_delete<skit::internal::IndexWriterImpl>> { struct IndexWriterImpl *__value_; } __ptr_; } pimpl; } index_writer; long long index_locale; struct basic_string<char16_t, std::char_traits<char16_t>, std::allocator<char16_t>> { struct __compressed_pair<std::basic_string<char16_t>::__rep, std::allocator<char16_t>> { struct __rep { union { struct __short { unsigned short __data_[11]; unsigned char __padding_[1]; unsigned char __size_ : 7; unsigned char __is_long_ : 1; } __s; struct __long { unsigned short *__data_; unsigned long long __size_; unsigned long __cap_ : 63; unsigned char __is_long_ : 1; } __l; struct __raw { unsigned long long __words[3]; } __r; } ; } __value_; } __r_; } index_locale_id; struct shared_ptr<semskitbridge::Tokenizer> { struct Tokenizer *__ptr_; struct __shared_weak_count *__cntrl_; } tokenizer; struct shared_ptr<semskitbridge::Analyzer> { struct Analyzer *__ptr_; struct __shared_weak_count *__cntrl_; } analyzer; struct Alias { struct shared_ptr<skit::internal::AliasImpl> { struct AliasImpl *__ptr_; struct __shared_weak_count *__cntrl_; } pimpl; } alias; struct TrialFactors { BOOL use_contact_aliases; BOOL use_contact_emoji_matches; BOOL use_contact_diacritics_stripping; BOOL use_contact_prefix_matching; BOOL use_contact_phonetic_search; BOOL use_token_lemmatization; int phonetic_search_n_gram_order; } trial_factors; unsigned short index_features; } _indexer;
