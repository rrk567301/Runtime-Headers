@class NSData, NSString, NSArray, NSDate, PRSRankingSpanCalculator, NSDictionary, PRSL2FeatureVector, NSMutableArray, NSNumber;
...
@property (nonatomic) struct { long long x0; unsigned long long x1[5]; unsigned long long x2[5]; unsigned long long x3[5]; void *x4[0]; } *attributes;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[5]; unsigned long long x2[5]; unsigned long long x3[5]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2;
- (unsigned long long)bundleIDType;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[5]; unsigned long long x2[5]; unsigned long long x3[5]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[5]; unsigned long long x2[5]; unsigned long long x3[5]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7;
- (BOOL)isTopHit;
...
- (void)populateOnlyPommesL1RankingFeaturesWithQueryTokenCount:(unsigned long long)a0 queryID:(long long)a1;
...
- (float)bucketizeDenseScore:(float)a0 minScore:(float)a1 maxScore:(float)a2 highlyRelevantThresh:(float)a3 relevantThresh:(float)a4 queryID:(long long)a5;
- (float)calibrateSemanticScore:(float)a0 queryTokenCount:(unsigned long long)a1 queryID:(long long)a2;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[5]; unsigned long long x2[5]; unsigned long long x3[5]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7 isServerAlternativeResult:(BOOL)a8;
...
- (float)matchScoreForAppEntityWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
- (float)matchScoreForApplicationsWithEvaluator:(id)a0;
- (float)matchScoreForBooksWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
- (float)matchScoreForCalendarWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
- (float)matchScoreForContactsWithEvaluator:(id)a0;
- (float)matchScoreForDictionaryWithEvaluator:(id)a0;
- (float)matchScoreForFilesWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
- (float)matchScoreForMessagesWithEvaluator:(id)a0;
- (float)matchScoreForMusicWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
...
- (float)matchScoreForSafariWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
...
- (float)matchScoreGeneric:(id)a0 quParsedEvaluator:(id)a1;
...
- (void)populateOnlyPommesFeaturesForBundleID:(id)a0 queryTokenCount:(unsigned long long)a1 queryID:(long long)a2;
- (void)populateOtherFeatures:(struct PRSL2FeatureScoreInfo { unsigned short *x0; float *x1; unsigned long long x2; unsigned long long x3; } *)a0 withEvaluator:(id)a1 currentTime:(double)a2 quParsedEvaluator:(id)a3 queryID:(long long)a4;
...
- (float)topicalityScoreWithEvaluator:(id)a0 quParsedEvaluator:(id)a1;
