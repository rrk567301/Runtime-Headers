...
+ (void)logItems:(id)a0 prefix:(id)a1 query:(id)a2;
...
+ (void)prepareServerSectionRankingItemsForTopHitNomination:(id)a0;
...
- (void)calculateLikelihoodAndPriorForSection:(id)a0 currentTime:(double)a1 shortcutResult:(id)a2 queryId:(unsigned long long)a3 ranker:(id)a4 nominateLocalTopHit:(BOOL)a5 qu:(id)a6;
...
- (void)finalizeLog;
- (float)freshnessAdjustmentForAppResult:(id)a0 section:(id)a1 freshnessBeforeAdjustment:(float)a2 topicality:(float)a3 engagement:(float)a4 appsWithLaunchCount:(BOOL)a5;
