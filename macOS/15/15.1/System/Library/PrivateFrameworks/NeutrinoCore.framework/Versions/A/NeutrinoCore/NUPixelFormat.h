...
@property (class, readonly, nonatomic) BOOL supportsPacked10BitsFormats;
@property (class, readonly, nonatomic) BOOL supportsUniversalCompressionFormats;
@property (class, readonly, nonatomic) BOOL supportsRenderingToCompressedFormats;
