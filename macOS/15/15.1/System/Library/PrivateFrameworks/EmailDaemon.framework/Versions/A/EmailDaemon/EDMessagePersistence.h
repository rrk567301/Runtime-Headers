...
@interface EDMessagePersistence : NSObject <EFSignpostable, EDMessageObjectIDToDatabaseIDConverter>
...
@property (class, readonly, copy, nonatomic) NSString *messageGlobalDataUserCategoryColumnName;
...
@property (class, readonly, copy, nonatomic) NSString *addressesTableDomainColumnName;
@property (class, readonly, copy, nonatomic) NSString *addressesTableBusinessesColumnName;
...
+ (void)addCategoryKeyPathMappersToDictionary:(id)a0 schema:(id)a1;
