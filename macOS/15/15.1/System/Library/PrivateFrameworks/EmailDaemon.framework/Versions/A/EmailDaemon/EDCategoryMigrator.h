@class NSString, EDMessagePersistence, EMQuery, EDMessageCategorizer, EFLocked, NSObject, EDActivityPersistence, EDCategoryPersistence;
...
+ (void)migrateCategoryForQuery:(id)a0 cancelationToken:(id)a1 reason:(long long)a2 completion:(id /* block */)a3;

- (void).cxx_destruct;
- (void)_categorizeMessageBatch:(id)a0 cancelationToken:(id)a1 reason:(long long)a2;
- (void)_categorizeMessagesForQuery:(id)a0 cancelationToken:(id)a1 completion:(id /* block */)a2;
- (void)_endCategorization;
- (void)_migrateCategoryForQuery:(id)a0 cancelationToken:(id)a1 reason:(long long)a2 completion:(id /* block */)a3;
