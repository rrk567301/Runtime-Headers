@class EDMessageQueryEvaluator, EDRemindMeNotificationController, EDMessagePersistence, NSPredicate, NSString, EFCancelationToken, EMQuery, EDPersistenceHookRegistry, EFPromise, NSObject, NSMutableSet;
@protocol OS_os_log, EFScheduler, EDMessageQueryHelperDelegate, EDSearchProvider;

@interface EDMessageQueryHelper : NSObject <EDCategoryChangeHookResponder, EDMessageChangeHookResponder, EDRemindMeNotificationControllerObserver, EDRemoteSearchDelegate, EFLoggable, EDMessageQueryHelperMessageSource, EFCancelable> {
...
@property (readonly, nonatomic) NSPredicate *ignoreMessagesPredicate;
...
- (void)persistenceDidChangeCategoryForAddressIDs:(id)a0;
