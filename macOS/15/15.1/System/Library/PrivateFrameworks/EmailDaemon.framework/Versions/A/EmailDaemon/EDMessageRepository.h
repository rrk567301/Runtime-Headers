...
- (id)initWithMessagePersistence:(id)a0 conversationPersistence:(id)a1 threadPersistence:(id)a2 remoteContentPersistence:(id)a3 messageChangeManager:(id)a4 richLinkPersistence:(id)a5 attachmentPersistenceManager:(id)a6 categoryPersistence:(id)a7 senderPersistence:(id)a8 activityPersistence:(id)a9 businessPersistence:(id)a10 hookRegistry:(id)a11 mailboxPersistence:(id)a12 searchProvider:(id)a13 userProfileProvider:(id)a14 vipManager:(id)a15 fetchController:(id)a16 observerResumer:(id)a17 remoteContentManager:(id)a18 remoteContentCacheConfiguration:(id)a19 blockedSenderManager:(id)a20 listUnsubscribeHandler:(id)a21 remindMeNotificationController:(id)a22 accountsProvider:(id)a23;
