@class BRCSharedServerItem, BRCVersion, BRCUserRowID, BRCAccountSession, BRServerMetrics, BRCBasehashSaltInfo, BRCServerZone, NSString, BRCPQLConnection, BRCServerStatInfo, BRCItemID, BRCItemGlobalID, BRCClientZone, BRFieldCKInfo;
