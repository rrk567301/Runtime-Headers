...
@interface AppTelemetryInvestigation : PBCodable <NSCopying> {
    ...
    BOOL _sharedZone;
    struct { unsigned char errorCode : 1; unsigned char eventTimestamp : 1; unsigned char hasForegroundClients : 1; unsigned char isEnhancedDrivePrivacyEnabled : 1; unsigned char isPCSChained : 1; unsigned char nonDiscretionary : 1; unsigned char sharedZone : 1; } _has;
}
