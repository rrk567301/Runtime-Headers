...
@interface MTLLegacySVAccelerationStructureCommandEncoder : MTLToolsAccelerationStructureCommandEncoder {
    ...
    struct list<LegacySVResourceAndUsage, std::allocator<LegacySVResourceAndUsage>> { struct __list_node_base<LegacySVResourceAndUsage, void *> { void *__prev_; void *__next_; } __end_; struct __compressed_pair<unsigned long, std::allocator<std::__list_node<LegacySVResourceAndUsage, void *>>> { unsigned long long __value_; } __size_alloc_; } _LegacySVResourceAndUsageList;
