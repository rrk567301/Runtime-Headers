@class NSUUID, NSString, NSURL, NSArray, NSSet, INInteraction, NSDateInterval, CNContact, NSDictionary, CHPhoneBookIOSManager, NSDate, NSNumber;
...
- (id)localizedIdentityExtensionName;
