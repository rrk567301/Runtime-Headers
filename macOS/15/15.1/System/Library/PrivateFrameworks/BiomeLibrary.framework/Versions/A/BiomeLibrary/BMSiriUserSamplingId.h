...
@property (readonly, nonatomic) NSUUID *samplingId;
...
- (id)initWithSamplingId:(id)a0 effectiveFrom:(id)a1 validityDays:(id)a2 createdOn:(id)a3 adoptedOn:(id)a4 switchedCount:(id)a5;
