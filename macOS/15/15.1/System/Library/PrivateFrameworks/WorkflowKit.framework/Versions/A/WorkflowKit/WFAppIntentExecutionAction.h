@class NSMutableDictionary, LNAppIntentConnectionPolicy, LNFullyQualifiedActionIdentifier, NSObject, NSDictionary, LNActionConfigurationContext, LNActionMetadata, NSString, LNUndoContext, NSSet, LNActionExecutorOptions, LNSystemContext, LNConnectionPolicySignals, LNConnection, INAppIntentDescriptor;
