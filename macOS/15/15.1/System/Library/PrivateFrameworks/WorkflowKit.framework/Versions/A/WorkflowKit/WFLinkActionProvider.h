...
+ (BOOL)isFullyQualifiedActionIdentifier:(id)a0 withMetadata:(id)a1 visibleForUse:(long long)a2;
+ (BOOL)restrictIdentifierToAssistantOnly:(id)a0;
...
- (id)actionMetadataByAppBundleIdentifier:(id)a0;
...
- (id)getAppSettingActionForRequest:(id)a0 fullyQualifiedActionIdentifier:(id)a1 entityMetadataByAppIdentifier:(id)a2 localActionsOnly:(BOOL)a3;
...
- (id)queryMetadataByAppBundleIdentifier:(id)a0 entityIdentifier:(id)a1;
- (id)queryMetadataByAppBundleIdentifier:(id)a0 queryIdentifier:(id)a1;
...
- (id)settingUpdaterActionForActionRequest:(id)a0 fullyQualifiedActionIdentifier:(id)a1 enumMetadataByAppIdentifier:(id)a2 entityMetadataByAppIdentifier:(id)a3 localActionsOnly:(BOOL)a4;
- (id)targetedEntityUpdaterActionForRequest:(id)a0 fullyQualifiedActionIdentifier:(id)a1 enumMetadataByAppIdentifier:(id)a2 entityMetadataByAppIdentifier:(id)a3 localActionsOnly:(BOOL)a4;
