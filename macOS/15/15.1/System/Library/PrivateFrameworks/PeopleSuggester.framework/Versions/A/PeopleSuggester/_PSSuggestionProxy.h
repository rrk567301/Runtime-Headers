...
- (id)initWithBundleID:(id)a0 interactionRecipients:(id)a1 contactID:(id)a2 handles:(id)a3 reason:(id)a4 reasonType:(id)a5 useGroupsWhenFindingRecipient:(BOOL)a6 groupName:(id)a7 image:(id)a8 modelScore:(id)a9;
