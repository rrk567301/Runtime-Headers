@class NSArray, PXPhotoLibraryLocalDefaults, NSNumber;
...
- (id)initWithSourcePeople:(id)a0 destinationPeople:(id)a1 destinationManualOrder:(long long)a2 destinationType:(long long)a3 otherPeople:(id)a4;
