...
@interface ODBATCHSiriSchemaProvisionalODBATCHTurnRestatementScore : SISchemaInstrumentationMessage {
    struct { unsigned char utteranceRestatementScore : 1; unsigned char semanticSimilarityScore : 1; } _has;
}
