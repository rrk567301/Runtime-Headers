...
- (id)runAssetContainmentExcludingScreenshotsAndVideos:(BOOL)a0 error:(id *)a1;
...
- (id)_assetIDsWithRequiredPersonsPresentWithAssetIDs:(id)a0 excludingScreenshotsAndVideos:(BOOL)a1 error:(id *)a2;
- (id)_assetPersonEdgeDictionaries:(id *)a0 excludingScreenshotsAndVideos:(BOOL)a1 forAssetIDs:(id)a2;
