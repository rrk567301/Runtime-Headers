...
- (BOOL)_onDemandAvailabilityUpdateForPhotoLibrary:(id)a0 error:(id *)a1;
- (void)_persistFeatureAvailabilityDictionary:(id)a0 photoLibrary:(id)a1;
- (BOOL)_readLastFullModeClusterDate:(id *)a0 forPhotoLibrary:(id)a1 error:(id *)a2;
- (BOOL)_updateVUClusterStateInProcessingSnapshot:(id)a0 photoLibrary:(id)a1 error:(id *)a2;
