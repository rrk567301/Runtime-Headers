...
@interface MFLibrary : NSObject <EDBrandIndicatorChangeHookResponder, EDMessageChangeHookResponder, EDRemindMeNotificationControllerObserver, EDSenderBucketChangeHookResponder, MCActivityTarget> {
...
- (void)retryMessageDownloadIfNecessary:(id)a0;
