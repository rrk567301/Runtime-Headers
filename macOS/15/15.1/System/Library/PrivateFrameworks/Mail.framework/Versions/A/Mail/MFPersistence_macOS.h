@class EDServerMessagePersistenceFactory, EDRemoteContentManager, MEContentRuleListManager, EDCategoryPersistence, EMRemoteContentURLCache, EDMailboxPersistence, EDRemoteContentPersistence, EDSearchableIndexDiagnosticsController, EDSearchableIndexManager, EDPersistenceDatabase, EDGmailLabelPersistence, EDMessageChangeManager, EDRemoteContentCacheConfiguration, EDMessagePersistence, EDRemindMeNotificationController, EDReadLaterPersistence, EDRichLinkPersistence, EDConversationPersistence, EDDataDetectionPersistence, EDBusinessPersistence, EMRemoteContentURLSession, EDVIPManager, EDAttachmentPersistenceManager, EDBIMIManager, EDSenderPersistence, EDLocalActionPersistence, EDMailboxActionPersistence;
