...
@property (readonly, nonatomic, getter=isConsolidatedSleepCoachingOnboardingCompleted) BOOL consolidatedSleepCoachingOnboardingCompleted;
@property (readonly, nonatomic, getter=isConsolidatedSleepTrackingOnboardingCompleted) BOOL consolidatedSleepTrackingOnboardingCompleted;
...
- (BOOL)isEqualToOnboardingModel:(id)a0;
