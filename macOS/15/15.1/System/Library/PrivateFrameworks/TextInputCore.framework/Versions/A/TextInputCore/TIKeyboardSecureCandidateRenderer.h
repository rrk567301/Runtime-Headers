...
- (struct __CFArray { } *)imagesFromSecureCandidates:(id)a0 withRenderTraits:(id)a1 outAccessibilityLabels:(id *)a2 outWidths:(id)a3;
- (id)localizedApplicationNameWithBundleIdentifier:(id)a0;
- (unsigned int)slotIDForSendCurrentLocationWithRenderTraits:(id)a0;
- (id)slotIDsFromSecureCandidates:(id)a0 withRenderTraits:(id)a1 outWidths:(id)a2;
