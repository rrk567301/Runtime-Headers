@class NSMutableDictionary, PELivePortraitBehaviorController, PHAdjustmentData, NSObject, PHAsset, NSMutableArray, PAImageItem, PACompositionEditController, PHContentEditingInput, NSString, PXCinematicEditController, PICompositionController, NSArray, PLEditSource;
...
- (void)ensureEditingResourcesWithCompletion:(id /* block */)a0 queue:(id)a1;
