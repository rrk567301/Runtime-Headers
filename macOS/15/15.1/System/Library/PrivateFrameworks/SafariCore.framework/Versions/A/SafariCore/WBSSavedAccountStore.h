...
@protocol OS_dispatch_queue, WBSSavedAccountStoreWebsiteNameProvider;

@interface WBSSavedAccountStore : NSObject <WBSSavedAccountStoreWebsiteNameConsumer, WBSOngoingSharingGroupProviderSubscriber, WBSAuthenticationServicesAgentDelegate> {
...
- (id)initPartialStoreForDomains:(id)a0;
- (id)initWithAuthenticationServicesAgentProxy:(id)a0 shouldPrewarmSavedAccounts:(BOOL)a1 limitedToDomains:(id)a2;
