@class SMHandoffMetricsManager, RTDefaultsManager, RTContactsManager, RTTimer, RTBiomeManager, RTLocationManager, SMScreenLockMonitor, RTAuthorizationManager, RTWatchWristStateManager, NSString, SMSessionManagerState, SMAnomalyAlertManager, RTXPCTimerAlarm, SMMessagingService, RTTimerManager, SMSessionStore, RTPlatform, SMSessionManagerStatus, SMActiveSessionDetails, SMSessionMetricManager, NSObject, RTStarkManager, CLLocation, SMCarPlayAlertManager, RTLocationAwarenessManager, SMLocalSessionState, NSHashTable;
@protocol OS_dispatch_queue, SMActiveSessionZoneProtocol;

@interface SMSessionManager : NSObject <IDSServiceDelegate, SMActiveSessionZoneObserverProtocol, SMInitiatorSessionConfigurationProtocol, SMInitiatorGroupChatProtocol, SMSessionManagerMonitorProtocol, SMSessionManagerCacheProtocol, SMSessionManagerRegistrationProtocol, SMUserNotificationProtocol> {
