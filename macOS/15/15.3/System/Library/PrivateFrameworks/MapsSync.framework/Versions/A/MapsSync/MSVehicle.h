...
@interface MSVehicle : MapsSync.MapsSyncObject {
    ...
    void /* unknown type, empty encoding */ _preferredChargingNetworks;
...
- (void).cxx_destruct;
- (id)initWithColorHex:(id)a0 currentVehicleState:(id)a1 dateOfVehicleIngestion:(id)a2 displayName:(id)a3 headUnitBluetoothIdentifier:(id)a4 headUnitMacAddress:(id)a5 iapIdentifier:(id)a6 lastStateUpdateDate:(id)a7 licensePlate:(id)a8 lprPowerType:(id)a9 lprVehicleType:(id)a10 manufacturer:(id)a11 model:(id)a12 pairedAppIdentifier:(id)a13 positionIndex:(long long)a14 powerByConnector:(id)a15 preferredChargingNetworks:(id)a16 siriIntentsIdentifier:(id)a17 supportedConnectors:(id)a18 vehicleIdentifier:(id)a19 vehicleType:(id)a20 year:(id)a21;
- (id)initWithObject:(id)a0 store:(id)a1 lazyLoad:(BOOL)a2;
- (id)initWithStore:(id)a0 colorHex:(id)a1 currentVehicleState:(id)a2 dateOfVehicleIngestion:(id)a3 displayName:(id)a4 headUnitBluetoothIdentifier:(id)a5 headUnitMacAddress:(id)a6 iapIdentifier:(id)a7 lastStateUpdateDate:(id)a8 licensePlate:(id)a9 lprPowerType:(id)a10 lprVehicleType:(id)a11 manufacturer:(id)a12 model:(id)a13 pairedAppIdentifier:(id)a14 positionIndex:(long long)a15 powerByConnector:(id)a16 preferredChargingNetworks:(id)a17 siriIntentsIdentifier:(id)a18 supportedConnectors:(id)a19 vehicleIdentifier:(id)a20 vehicleType:(id)a21 year:(id)a22;
