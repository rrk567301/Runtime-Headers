...
- (void)stopService;
- (struct DevicePresetTokenResult { id x0; id x1; BOOL x2; })_checkTokenPresetsForDSID:(id)a0 forceRefresh:(BOOL)a1;
- (void)_commitCache;
- (struct DevicePresetTokenResult { id x0; id x1; BOOL x2; })_devicePresetForConfiguration:(id)a0 withDSID:(id)a1;
