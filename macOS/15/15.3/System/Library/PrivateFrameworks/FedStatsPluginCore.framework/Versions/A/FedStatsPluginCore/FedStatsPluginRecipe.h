...
- (id)initWithAssetProvider:(id)a0 recipeIdentifier:(id)a1 clientIdentifier:(id)a2 recordMetadata:(id)a3 dataTypeContent:(id)a4 sqlQuery:(id)a5 cohortNameList:(id)a6;
