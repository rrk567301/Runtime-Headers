...
@protocol FCReadablePrivateDataStorage, FCContentContext, NTTodayResultsFetchDescriptor, FCFeedPersonalizerFactoryType, NTTodayBannerValidator;
...
- (id)initWithFetchDescriptor:(id)a0 feedPersonalizerFactory:(id)a1 todayBannerValidator:(id)a2 privateDataStorage:(id)a3 contentContext:(id)a4 fetchQueue:(id)a5;
