...
- (id)initWithBundleIdentifier:(id)a0 source:(unsigned short)a1 clientLabel:(id)a2 executionUUID:(id)a3 executionDate:(id)a4 actionData:(id)a5 resolvedActionData:(id)a6 actionOutputData:(id)a7 predictionsData:(id)a8 hasNextAction:(BOOL)a9;
