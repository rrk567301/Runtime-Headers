@class NSMutableDictionary, WKUserContentController, NSDictionary, NSObject, WBProfile, NSMutableArray, NSString, NSSet, WKWebsiteDataStore, NSTimer, NSMutableSet, NSPointerArray, NSArray, WBSExtensionsAnalyticsEventCoalescer, WBSDiagnosticStateCollector;
