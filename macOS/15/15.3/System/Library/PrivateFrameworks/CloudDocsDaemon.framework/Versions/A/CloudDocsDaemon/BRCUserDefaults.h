@class NSString, NSArray, BRCSyncOperationThrottleParams, NSSet, NSMutableDictionary, NSDictionary, NSObject, NSDateFormatter, NSIndexSet;
...
@property (readonly, nonatomic) BOOL useTrialToGateFPFSMigration;
@property (readonly, nonatomic) unsigned int listFilesIngestedBatchSize;
@property (readonly, nonatomic) BOOL ignoreFaultingErrorsDuringDirectoryProviding;
