...
- (BOOL)existsByParentID:(id)a0 andLogicalName:(id)a1 excludingItemGlobalID:(id)a2 db:(id)a3;
...
- (id)locateRecordIfNecessaryForRecordID:(id)a0 isUserWaiting:(BOOL)a1 maxOperationBackoff:(double)a2;
