...
- (id)initWithKeypointsOption:(int)a0 forceCPU:(BOOL)a1 sharedModel:(BOOL)a2 enableHandDetection:(BOOL)a3 enableANSTHandDetection:(BOOL)a4 enableRejectHandsNearBoundaries:(BOOL)a5 enableHandObject:(BOOL)a6 sourceWidth:(int)a7 sourceHeight:(int)a8 modelName:(id)a9 revision:(int)a10 options:(id)a11;
