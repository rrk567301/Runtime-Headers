@class HMFTimer, HMMTRAccessoryServerBrowser, NSString, NSMutableOrderedSet, NSObject, NSNumber;
...
- (id)initWithQueue:(id)a0 browser:(id)a1 fabricID:(id)a2 systemCommissionerFabric:(BOOL)a3;
