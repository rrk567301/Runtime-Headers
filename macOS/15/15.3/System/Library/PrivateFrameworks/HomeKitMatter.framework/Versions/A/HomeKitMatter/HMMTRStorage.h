@class NSData, NSString, NSSet, NSMutableDictionary, NSOperationQueue, NSDictionary, NSObject, NSNumber, HMMTRMatterKeypair;
...
- (id)_cachedOperationalCertificateIfValidForFabricID:(id)a0;
- (id)_cachedRootCertificateIfValidForFabricID:(id)a0;
- (id)_createOperationalCertificateForFabricID:(id)a0 rootCert:(id)a1 caseAuthenticatedTags:(id)a2 controllerNodeID:(id)a3;
- (void)_fetchCertForFabricWithID:(id)a0 isOwner:(BOOL)a1 forPairing:(BOOL)a2 forceFetchFromResident:(BOOL)a3 completion:(id /* block */)a4;
...
- (id)_operationalCertificateFromSdkCertificatesForFabricID:(id)a0;
- (id)_preferencesValueForKey:(id)a0;
- (BOOL)_removeAllDataSourceData;
- (void)_removeSystemCommissionerFabricNodeIDForUuid:(id)a0;
- (id)_rootCertificateFromSdkCertificatesForFabricID:(id)a0;
...
- (void)fetchCertForFabricWithID:(id)a0 isOwner:(BOOL)a1 forPairing:(BOOL)a2 forceFetchFromResident:(BOOL)a3 completion:(id /* block */)a4;
- (void)fetchCertificatesFromStorageForFabricID:(id)a0 controllerNodeID:(id)a1 rootCert:(id *)a2 operationalCert:(id *)a3 residentNodeID:(id *)a4 ipk:(id *)a5;
...
- (id)ipkForFabricID:(id)a0 forPairing:(BOOL)a1;
...
- (id)legacyNodeIDForFabricID:(id)a0;
...
- (void)persistLegacyControllerNodeWithDictionary:(id)a0;
- (void)prepareStorageForFabricID:(id)a0;
- (void)prepareStorageForFabricID:(id)a0 forInitialSetup:(BOOL)a1;
