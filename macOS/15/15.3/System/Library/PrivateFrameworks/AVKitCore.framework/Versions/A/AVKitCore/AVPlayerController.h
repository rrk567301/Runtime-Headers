@class AVCoordinatedPlaybackSuspension, NSDate, NSDictionary, NSObject, BSSimpleAssertion, AVObservationController, AVValueTiming, AVAsset, AVPlayerLayer, AVMediaSelectionOption, NSString, AVFragmentedMovieMinder, AVTimecodeController, NSTimer, AVSampleTable, AVAssetTrack, NSArray, AVPlayerItemPhotosensitivityMetadataHandler, AVPlayer, NSError;
