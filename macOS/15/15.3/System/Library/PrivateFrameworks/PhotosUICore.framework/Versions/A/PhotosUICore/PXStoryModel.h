...
@interface PXStoryModel : PXObservable <PXStoryMutableModel, PXChangeObserver, PXStoryQueueParticipant, PXTapToRadarDiagnosticProvider, PXStoryDiagnosticHUDContentProviderSource> {
