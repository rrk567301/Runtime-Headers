...
- (BOOL)hasProtector;
- (id)initWithKeySystem:(id)a0 keySession:(id)a1 contentKeyBoss:(struct OpaqueFigContentKeyBoss { } *)a2 useContentKeyBoss:(BOOL)a3 groupID:(unsigned long long)a4 storageDirectoryAtURL:(id)a5;
