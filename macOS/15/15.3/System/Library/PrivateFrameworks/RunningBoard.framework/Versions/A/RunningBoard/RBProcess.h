@class RBSProcessIdentity, RBProcessState, RBJetsamProperties, RBSProcessIdentifier, NSDictionary, NSObject, RBSProcessInstance, NSString, RBSProcessHandle, RBSProcessExitContext, RBSProcessExitStatus, RBSAuditToken;
