@class CSExclaveIndicatorController, NSString, NSObject;
@protocol CSExclaveAudioProvidingDelegate, OS_dispatch_source, OS_dispatch_queue;

@interface CSExclaveRecordClient : NSObject <CSExclaveAudioProviding, CSExclaveFirstPassVoiceTriggerAnalyzing, CSExclaveSecondPassVoiceTriggerAnalyzing, CSExclaveAssetsControlling, CSExclaveAdBlockerAnalyzing, CSExclaveEntityKitProviding>
...
- (void)updateEntityStatistics:(id)a0;
