...
- (id)initWithIdentifier:(id)a0 name:(id)a1 nameCompact:(id)a2 kind:(id)a3 traits:(unsigned long long)a4 engineResourceID:(id)a5 superfeedConfigResourceID:(id)a6 latestPuzzleIDs:(id)a7 promotedPuzzleIDs:(id)a8 nameImageAssetHandle:(id)a9 nameImageCompactAssetHandle:(id)a10 nameImageMaskAssetHandle:(id)a11 nameImageForDarkBackgroundAssetHandle:(id)a12 feedNavImageAssetHandle:(id)a13 coverImageAssetHandle:(id)a14 navigationChromeBackgroundImageHandle:(id)a15 navigationChromeBackgroundImageCompactHandle:(id)a16 navigationChromeBackgroundImageLargeHandle:(id)a17 navigationChromeBackgroundDarkModeImageHandle:(id)a18 navigationChromeBackgroundDarkModeImageCompactHandle:(id)a19 navigationChromeBackgroundDarkModeImageLargeHandle:(id)a20 language:(id)a21 allowedStorefrontIDs:(id)a22 blockedStorefrontIDs:(id)a23 minimumNewsVersion:(long long)a24 loadDate:(id)a25 fetchDate:(id)a26 lastModifiedDate:(id)a27 exploreTileImageAssetHandle:(id)a28 versionKey:(id)a29 titleDisplayPrefix:(id)a30 titleDisplaySuffix:(id)a31 themeColor:(id)a32 puzzlePrimaryColor:(id)a33 darkStyleThemeColor:(id)a34 darkStylePuzzlePrimaryColor:(id)a35 groupTitleColor:(id)a36 groupDarkStyleTitleColor:(id)a37 thumbnailDirectory:(id)a38 isPublic:(BOOL)a39;
