...
- (BOOL)savePreviewSegmentationResourcesForAsset:(id)a0 atURL:(id)a1 withClassification:(unsigned long long)a2 styleCategory:(id)a3 enableSettlingEffect:(BOOL)a4 error:(id *)a5;
