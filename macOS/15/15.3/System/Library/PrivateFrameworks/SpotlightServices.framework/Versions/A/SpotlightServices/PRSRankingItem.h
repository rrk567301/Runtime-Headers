...
@property (nonatomic) struct { long long x0; unsigned long long x1[6]; unsigned long long x2[6]; unsigned long long x3[6]; void *x4[0]; } *attributes;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[6]; unsigned long long x2[6]; unsigned long long x3[6]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2;
- (unsigned long long)bundleIDType;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[6]; unsigned long long x2[6]; unsigned long long x3[6]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[6]; unsigned long long x2[6]; unsigned long long x3[6]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7;
- (BOOL)isTopHit;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[6]; unsigned long long x2[6]; unsigned long long x3[6]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7 isServerAlternativeResult:(BOOL)a8;
...
- (float)matchScoreFileName:(id)a0 withEvaluator:(id)a1 isSearchToolClient:(BOOL)a2;
...
- (void)populateBundleSpecificFeatures:(struct PRSL2FeatureScoreInfo { unsigned short *x0; float *x1; unsigned long long x2; unsigned long long x3; } *)a0 currentTime:(double)a1 isSearchToolClient:(BOOL)a2;
