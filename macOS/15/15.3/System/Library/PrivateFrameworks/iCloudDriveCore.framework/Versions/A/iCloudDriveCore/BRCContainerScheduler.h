@class BRCDeadlineScheduler, BRCDeadlineSource, APSConnection, NSObject, BRCContainerMetadataSyncPersistedState, _BRCOperation, BRCPeriodicSyncScheduler, BRCFairSource, BRCSideCarSyncPersistedState, BRCSyncOperationThrottle, NSString, BRCAccountSessionFPFS, BRCMigrateZonePCSOperation, BRCZoneHealthSyncPersistedState, BRCSyncBudgetThrottle, NSMutableArray, NSData, NSError;
