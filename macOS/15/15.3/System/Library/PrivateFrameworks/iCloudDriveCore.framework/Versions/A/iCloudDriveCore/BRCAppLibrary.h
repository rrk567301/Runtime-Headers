@class NSURL, NSMutableDictionary, brc_task_tracker, NSObject, BRContainer, BRMangledID, NSString, BRCPQLConnection, BRCZoneRowID, BRCAccountSessionFPFS, BRCALRowID, BRCPrivateClientZone, NSNumber, NSData, NSMutableSet, BRCListDirectoryContentsOperation, BRCSyncContext;
