@class NSUUID, NSString, CSVTUIKeywordDetector, SFSpeechAudioBufferRecognitionRequest, NSTimer, NSDictionary, SFSpeechRecognitionTask, NSMutableArray, SFSpeechRecognizer, NSObject, CSVTUITrainingSessionHelper, CSAudioZeroCounter;
...
- (id)createDigitalZeroReporterWithVoiceTriggerEventInfo:(id)a0 withSessionStatus:(int)a1;
...
- (id)initWithUtteranceId:(long long)a0 sessionNumber:(long long)a1 Locale:(id)a2 vtAssetConfigVersion:(id)a3 audioSession:(id)a4 keywordDetector:(id)a5 speechRecognizer:(id)a6 speechRecognitionRequest:(id)a7 sessionDelegate:(id)a8 sessionDispatchQueue:(id)a9 mhUUID:(id)a10 zeroCounter:(id)a11 completionWithResult:(id /* block */)a12;
