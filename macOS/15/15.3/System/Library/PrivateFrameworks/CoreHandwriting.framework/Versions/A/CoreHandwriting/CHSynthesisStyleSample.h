...
+ (id)sampleWithTranscription:(id)a0 drawing:(id)a1 strokeIdentifiers:(id)a2;
+ (id)sampleWithTranscription:(id)a0 drawing:(id)a1 strokeIdentifiers:(id)a2 embeddingVector:(const void *)a3;
...
- (id)initWithTranscription:(id)a0 drawing:(id)a1 strokeIdentifiers:(id)a2 embeddingVector:(const void *)a3;
- (void)shiftTimestepsByOffset:(long long)a0;
- (void)updateStyleEmbedding:(id)a0;
