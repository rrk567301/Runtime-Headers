...
- (void)_notifySessionStreamInfoReceived:(id)a0 withParticipants:(id)a1 lightweightParticipants:(id)a2 joinedParticipantInfo:(id)a3 leftParticipantInfo:(id)a4 sentBytes:(unsigned long long)a5 receivedBytes:(unsigned long long)a6 offlineRequest:(BOOL)a7 streamInfoRequest:(BOOL)a8 status:(unsigned int)a9 commandFlag:(unsigned int)a10 isIndication:(BOOL)a11;
