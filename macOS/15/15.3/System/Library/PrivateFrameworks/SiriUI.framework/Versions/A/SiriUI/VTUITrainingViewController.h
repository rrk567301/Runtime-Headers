...
- (void)_slideInText:(id)a0 showPrelude:(BOOL)a1 afterDelay:(double)a2 completion:(id /* block */)a3;
...
- (void)slideInText:(id)a0 showPrelude:(BOOL)a1 afterDelay:(double)a2 completion:(id /* block */)a3;
