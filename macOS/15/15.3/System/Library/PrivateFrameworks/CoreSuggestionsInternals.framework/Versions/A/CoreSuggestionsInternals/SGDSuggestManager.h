...
- (id)shortNamesAndRealtimeEventsFromEntity:(id)a0 message:(id)a1 enrichments:(id)a2 store:(id)a3 keepPastEvents:(BOOL)a4 keepPartialEvents:(BOOL)a5 keepEventsFromOldDocuments:(BOOL)a6;
