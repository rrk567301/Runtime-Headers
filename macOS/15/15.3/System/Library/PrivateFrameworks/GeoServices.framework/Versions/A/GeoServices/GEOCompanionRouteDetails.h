...
@property (readonly, nonatomic) BOOL hasStorageID;
@property (retain, nonatomic) NSData *storageID;
@property (readonly, nonatomic) BOOL hasAnchorPointsData;
...
- (BOOL)_hasIncompatibleManeuverType:(unsigned long long)a0;
