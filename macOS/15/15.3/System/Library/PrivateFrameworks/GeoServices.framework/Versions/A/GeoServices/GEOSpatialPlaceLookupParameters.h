...
- (id)initWithCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1 categories:(id)a2 maxResultCount:(int)a3 source:(long long)a4;
- (id)initWithCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1 poiCategoryFilter:(id)a2;
- (id)initWithCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1 poiCategoryFilter:(id)a2 maxResultCount:(int)a3;
- (id)initWithCoordinate:(struct { double x0; double x1; })a0 radius:(double)a1 poiCategoryFilter:(id)a2 maxResultCount:(int)a3 source:(long long)a4;
- (id)initWithMapRegion:(id)a0 poiCategoryFilter:(id)a1;
- (id)initWithMapRegion:(id)a0 poiCategoryFilter:(id)a1 maxResultCount:(int)a2;
- (id)initWithMapRegion:(id)a0 poiCategoryFilter:(id)a1 maxResultCount:(int)a2 source:(long long)a3;
