@class EDBiomeBlackPearlLogger, NSArray, MSBucketBarConfigurationController, NSString, EMCoreAnalyticsCollector;
...
- (void)_logAccountPersonalPreferenceWithEventName:(id)a0 scheduledHour:(id)a1;
