...
- (void).cxx_destruct;
- (id)_transformBaseMessage:(id)a0 messageObjectID:(id)a1 duplicateInfo:(id)a2 additionalBuilder:(id /* block */)a3;
- (id)_transformPersistedMessage:(id)a0 mailboxScope:(id)a1 duplicateInfo:(id)a2 additionalBuilder:(id /* block */)a3;
