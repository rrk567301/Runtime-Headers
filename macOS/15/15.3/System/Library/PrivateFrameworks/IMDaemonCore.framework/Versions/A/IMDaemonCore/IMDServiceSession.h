...
- (void)storeMessage:(id)a0 forceReplace:(BOOL)a1 modifyError:(BOOL)a2 modifyFlags:(BOOL)a3 calculateUnreadCount:(BOOL)a4 flagMask:(unsigned long long)a5 didReplaceBlock:(id /* block */)a6 shouldStoreBlock:(id /* block */)a7 didStoreBlock:(id /* block */)a8 block:(id /* block */)a9;
