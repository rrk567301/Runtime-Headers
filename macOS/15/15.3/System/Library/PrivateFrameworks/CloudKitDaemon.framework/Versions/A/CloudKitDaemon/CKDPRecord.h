...
@property (readonly, nonatomic) BOOL hasProtectionInfoKeysToRemove;
@property (retain, nonatomic) CKDPProtectionInfoKeysToRemove *protectionInfoKeysToRemove;
@property (readonly, nonatomic) BOOL hasOneTimeStableUrlInfo;
@property (retain, nonatomic) CKDPRecordOneTimeStableUrlInfo *oneTimeStableUrlInfo;
@property (readonly, nonatomic) BOOL hasChainProtectionInfoKeysToRemove;
