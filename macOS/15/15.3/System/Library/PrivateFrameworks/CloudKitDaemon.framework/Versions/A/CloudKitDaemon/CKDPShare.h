@class NSData, NSString, CKDPProtectionInfo, CKDPShareIdentifier, CKDPShareAccessRequesters, NSMutableArray, CKDPShareAccessBlockedRequesters;

@interface CKDPShare : PBCodable <NSCopying> {
    struct { unsigned char participantSelfRemovalBehavior : 1; unsigned char publicAccess : 1; unsigned char publisherModelType : 1; unsigned char anonymousPublicAccess : 1; unsigned char denyAccessRequests : 1; unsigned char publisherModel : 1; } _has;
}
...
@property (readonly, nonatomic) BOOL hasBlockedRequestingAccess;
@property (retain, nonatomic) CKDPShareAccessBlockedRequesters *blockedRequestingAccess;
