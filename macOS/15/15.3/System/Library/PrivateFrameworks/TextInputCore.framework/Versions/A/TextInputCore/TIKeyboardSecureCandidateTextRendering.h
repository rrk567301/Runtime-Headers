...
+ (BOOL)_drawSingleLineSecureHeaders:(id)a0 secureContents:(id)a1 layoutTraits:(id)a2 renderTraits:(id)a3 contexts:(struct __CFArray { } *)a4 availableWidth:(double)a5 truncationSentinel:(id)a6 abortInsteadOfTruncating:(BOOL)a7 outWidths:(id)a8;
+ (void)_drawTwoLineCellsWithSecureHeaders:(id)a0 secureContents:(id)a1 layoutTraits:(id)a2 renderTraits:(id)a3 contexts:(struct __CFArray { } *)a4 availableWidth:(double)a5 truncationSentinel:(id)a6 outWidths:(id)a7;
...
+ (void)drawSecureHeaders:(id)a0 secureContents:(id)a1 inContexts:(struct __CFArray { } *)a2 traits:(id)a3 truncationSentinel:(id)a4 outWidths:(id)a5;
