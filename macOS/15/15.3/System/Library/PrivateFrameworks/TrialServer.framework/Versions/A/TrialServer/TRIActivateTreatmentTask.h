...
+ (id)taskWithExperiment:(id)a0 treatmentId:(id)a1 factorPackSetId:(id)a2 taskAttributing:(id)a3 requiresTreatmentInstallation:(BOOL)a4 capabilityModifier:(id)a5 startTime:(id)a6 taskOptions:(id)a7;
