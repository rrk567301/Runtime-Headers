...
@interface CDMClient : CDMClientInterface <CDMSsuInferenceClient, CDMEmbeddingClient, CDMNLUClient, CDMPlannerClient> {
...
- (void)processPlannerRequest:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)setupWithLocale:(id)a0 forGraph:(id)a1 completionHandler:(id /* block */)a2;
