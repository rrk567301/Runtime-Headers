@class WBSAuthenticationServicesAgentProxy, NSString, AutoFillLocalAuthenticationManager, _ASCredentialAuthenticationViewController, WBSGlobalFrameIdentifier, _ASCredentialListViewController;
