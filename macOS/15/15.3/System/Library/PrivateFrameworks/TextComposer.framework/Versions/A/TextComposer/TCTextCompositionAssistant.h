@class _TtC12TextComposer40TCTextCompositionCalendarEventGeneration, NLTagger, TCTextCompositionSmartRepliesCache;
...
+ (id)sharedAssistant;
+ (BOOL)_canHandleAttributedString:(id)a0 proposedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 accumulateTokenCount:(unsigned long long)a2 lookBack:(BOOL)a3 tagger:(id)a4 actualRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a5 contextRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a6 error:(id *)a7;
...
+ (BOOL)isStringInSupportedLanguage:(id)a0 contextRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 numTopLanguagesToCheck:(long long)a2 allowAllCaps:(BOOL)a3 tagger:(id)a4;
+ (BOOL)isStringInSupportedLanguage:(id)a0 numTopLanguagesToCheck:(long long)a1 allowAllCaps:(BOOL)a2;
...
- (BOOL)_eligibleForSmartRepliesWith:(id)a0 inputContextHistory:(id)a1 documentType:(id)a2 outError:(id *)a3;
...
- (id)_shortFormRepliesForMessagesFrom:(id)a0 normalizedNamesToNames:(id)a1 inputContextHistory:(id)a2 inputPreferences:(id)a3 options:(id)a4;
...
- (id)_stripEmailSignatures:(id)a0;
...
- (BOOL)addGrammarCheckingDetailsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 originalSentenceRanges:(id)a3 tagger:(id)a4 writingOptions:(id)a5 toDictionary:(id)a6;
- (BOOL)addGrammarCheckingDetailsForRewrittenString:(id)a0 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 originalString:(id)a2 originalAttributedString:(id)a3 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 tagger:(id)a5 writingOptions:(id)a6 toDictionary:(id)a7;
...
- (int)categorizeClassificationResult:(id)a0 additionalInfo:(id *)a1;
- (BOOL)checkLexiconForString:(id)a0 locale:(id)a1;
- (id)classificationPromptForRewritingType:(id)a0 instructions:(id)a1 options:(id)a2 needsAdditionalLanguageIdentification:(BOOL)a3 error:(id *)a4;
- (id)cleanedInput:(id)a0;
- (id)cleanedInputForInput:(id)a0;
- (id)cleanedOutputForOutput:(id)a0;
- (id)detailDictionaryForTokenDifferenceManager:(id)a0 difference:(id)a1 originalAttributedString:(id)a2 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 tagger:(id)a4 writingOptions:(id)a5;
- (BOOL)disableMailSRFiltering;
- (id)disallowedStringsWithUserPayload:(id)a0 outputString:(id)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })findMisspelledWordInString:(id)a0 preferredLanguage:(id)a1;
- (BOOL)foundAllowedAttributionInString:(id)a0;
- (BOOL)foundAttributionInString:(id)a0 usingGazetteer:(id)a1;
- (BOOL)foundBlockedAttributionInString:(id)a0;
- (BOOL)foundTag:(id)a0 inString:(id)a1 withTagger:(id)a2 usingOptions:(unsigned long long)a3;
...
- (BOOL)isEligibleForSmartRepliesWith:(id)a0 replyToMessageID:(id)a1 documentType:(id)a2 isPrecomputationRequest:(BOOL)a3 outError:(id *)a4;
- (BOOL)isEligibleMessageSRs:(id)a0;
...
- (id)mailSnippetFromCleanedString:(id)a0;
...
- (id)normalizedMessage:(id)a0 namesToNormalizedNames:(id)a1;
...
- (void)requestClassificationOfInstructionsForInput:(id)a0 rewritingType:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)requestModelInvocationToGenerateUserQuestionnaire:(id)a0 forString:(id)a1 documentType:(id)a2 replyType:(id)a3 token:(unsigned long long)a4 pid:(unsigned long long)a5 requestIdentifier:(id)a6 completionHandler:(id /* block */)a7;
...
- (void)requestModelInvocationWithPrompt:(id)a0 forString:(id)a1 documentType:(id)a2 normalizedNamesToNames:(id)a3 inputContextHistory:(id)a4 token:(unsigned long long)a5 isPrecomputeRequest:(BOOL)a6 pid:(unsigned long long)a7 requestIdentifier:(id)a8 inputPreferences:(id)a9 completionHandler:(id /* block */)a10;
- (void)requestModelInvocationWithPrompt:(id)a0 forString:(id)a1 documentType:(id)a2 replyType:(id)a3 token:(unsigned long long)a4 pid:(unsigned long long)a5 requestIdentifier:(id)a6 inputPreferences:(id)a7 completionHandler:(id /* block */)a8;
- (void)requestModelInvocationWithPrompt:(id)a0 forString:(id)a1 documentType:(id)a2 replyType:(id)a3 userFilledQuestionnaire:(id)a4 token:(unsigned long long)a5 pid:(unsigned long long)a6 requestIdentifier:(id)a7 inputPreferences:(id)a8 completionHandler:(id /* block */)a9;
- (void)requestModelInvocationWithPrompt:(id)a0 forString:(id)a1 rewritingType:(id)a2 instructions:(id)a3 userDescription:(id)a4 token:(unsigned long long)a5 seed:(unsigned long long)a6 draftSteps:(unsigned long long)a7 pid:(unsigned long long)a8 appPid:(unsigned long long)a9 requestIdentifier:(id)a10 completionHandler:(id /* block */)a11;
- (void)requestModelInvocationWithPrompt:(id)a0 input:(id)a1 token:(unsigned long long)a2 pid:(unsigned long long)a3 requestIdentifier:(id)a4 completionHandler:(id /* block */)a5;
...
- (id)shortFormRepliesFromModelOutput:(id)a0 documentType:(id)a1 normalizedNamesToNames:(id)a2 inputContextHistory:(id)a3 inputPreferences:(id)a4 options:(id)a5;
...
- (BOOL)shouldProcessInstructionClassificationResults:(id)a0 error:(id *)a1;
...
- (id)textCheckingResultsForRewrittenString:(id)a0 originalString:(id)a1;
- (id)textCheckingResultsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2;
- (id)textCheckingResultsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 offset:(unsigned long long)a3 options:(id)a4;
- (id)textCheckingResultsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 offset:(unsigned long long)a3 writingOptions:(id)a4 error:(id *)a5;
