...
@interface HMDHAPAccessory : HMDAccessory <HMMTRAccessoryServerDelegate, HMMTRHMDHAPAccessoryDelegate, HMDSiriEndpointProfileMetricsDispatcherFactory, HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDAccessoryMinimumUserPrivilegeCapable, HMDServiceOwner, HMDMatterAccessoryProtocol, HAPAccessoryDelegate, HMFTimerDelegate, HAPAccessoryServerNotification, HMDAccessoryUserManagement> {
...
@property (nonatomic) BOOL convertingToNativeMatter;
...
- (id)chipHomeDataSourceWithFabricID:(id)a0 home:(id)a1;
...
- (id)fabricDataFetcherWithCHIPStorageDelegate:(id)a0 keychainDelegate:(id)a1;
...
- (void)handleStartUpWithEventNumber:(id)a0;
...
- (id)rootPublicKeysOfHomes:(id)a0 keychainDelegate:(id)a1;
...
- (void)unconfigureHAPMatterAccessoryWithCompletion:(id /* block */)a0;
