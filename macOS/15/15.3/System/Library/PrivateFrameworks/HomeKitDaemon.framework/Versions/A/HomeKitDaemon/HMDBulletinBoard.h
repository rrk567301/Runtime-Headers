...
+ (BOOL)isBulletinSupportedForMatterPath:(id)a0 accessory:(id)a1 endpointID:(id)a2;
...
- (id)matterAttributeBulletinMessageFor:(id)a0 attributePath:(id)a1 value:(id)a2 fields:(id)a3;
...
- (id)rvcOperationalErrorBulletinMessageForErrorStateID:(unsigned long long)a0 includePausedInMessage:(BOOL)a1;
