@class NSUUID, NSString, HMDHomeManager, HMDWidgetConfigurationReader, NSSet, HMDWidgetTimelineController, NSMutableDictionary, NSObject, NSMutableSet, NSNotificationCenter, NSMapTable;
...
@interface HMDWidgetTimelineRefresher : HMFObject <HMFTimerManagerDelegate, HMFMessageReceiver, HMFLogging, HMDActionSetStateSubscriptionManagerObserver, MTRDeviceDelegate> {
...
- (void)didUpdateStateWithActionSetUUID:(id)a0 state:(BOOL)a1;
