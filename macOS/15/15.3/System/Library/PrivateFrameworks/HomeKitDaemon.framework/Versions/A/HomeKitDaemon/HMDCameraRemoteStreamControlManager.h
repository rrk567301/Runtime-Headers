@class NSUUID, NSString, HMDCameraMediaConfigGenerator, HMDCameraRemoteStreamSession, HMDCameraResidentMessageHandler, NSDictionary, NSNumber, HMDCameraStreamMetrics;
