...
- (id)initWithUniqueID:(id)a0 domainID:(id)a1 absoluteTimestamp:(id)a2 title:(id)a3 content:(id)a4 summary:(id)a5 publication:(id)a6 contentProtection:(id)a7 personaId:(id)a8;
