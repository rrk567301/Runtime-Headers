@class CSManagedSearchableIndex, NSString, PLSearchIndexingAccessManager, CSSearchableIndex, PSIDatabase, PLResult, NSObject, NSMutableArray, PLSearchIndexingRebuildEngine, PLSearchIndexingIncrementalUpdateEngine, PLSearchIndexConfiguration;
