...
- (id)initWithSceneName:(id)a0 sceneIdentifier:(unsigned long long)a1 level:(unsigned long long)a2 isIndexed:(BOOL)a3 localizedName:(id)a4 localizedSynonyms:(id)a5;
