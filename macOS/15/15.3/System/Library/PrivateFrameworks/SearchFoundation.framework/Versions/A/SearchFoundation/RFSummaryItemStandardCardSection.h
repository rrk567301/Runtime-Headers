...
@interface RFSummaryItemStandardCardSection : SFCardSection <RFSummaryItemStandardCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char suppress_text_2_if_text_1_exceeds_a_single_line : 1; } _has;
}
