@class NSData, NSString, NSArray, SFCommandButtonItem, SFCard, SFColor, NSDictionary, SFUserReportRequest, SFCommand, SFAppEntityAnnotation, SFRichText, SFCollectionStyle;
