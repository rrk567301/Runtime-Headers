...
- (void)setBool:(BOOL)a0 forKey:(unsigned int)a1;
- (void)removeAll;
- (BOOL)getBool:(BOOL *)a0 forKey:(unsigned int)a1;
...
- (id)initWithBools:(const BOOL *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
- (void)removeBoolForKey:(unsigned int)a0;
