...
+ (long long)_errorFromACMStatus:(int)a0;
...
- (void)verifyAclConstraint:(id)a0 operation:(id)a1 preflight:(BOOL)a2 parameters:(const struct { unsigned int x0; void *x1; unsigned int x2; } *)a3 parametersCount:(unsigned int)a4 maxGlobalCredentialAge:(unsigned int)a5 processRequirement:(id /* block */)a6;
