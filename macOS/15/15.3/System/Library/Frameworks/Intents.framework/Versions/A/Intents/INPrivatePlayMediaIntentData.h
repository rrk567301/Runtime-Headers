...
@property (readonly, copy) NSNumber *appSelectionEnabled;
@property (readonly, copy) NSNumber *appInferred;
@property (readonly, copy) NSArray *audioSearchResults;
@property (readonly, copy) NSNumber *appSelectionSignalsEnabled;
@property (readonly, copy) NSNumber *appSelectionSignalsFrequencyDenominator;
@property (readonly, copy) NSNumber *shouldSuppressCommonWholeHouseAudioRoutes;
@property (readonly, copy) NSNumber *immediatelyStartPlayback;
@property (readonly, copy) NSNumber *isAmbiguousPlay;
@property (readonly, copy) NSNumber *isPersonalizedRequest;
@property (readonly, copy) NSArray *internalSignals;
@property (readonly, copy) NSNumber *entityConfidenceSignalsEnabled;
@property (readonly, copy) NSNumber *entityConfidenceSignalsFrequencyDenominatorInternal;
@property (readonly, copy) NSNumber *entityConfidenceSignalsFrequencyDenominatorProd;
@property (readonly, copy) NSNumber *entityConfidenceSignalsMaxItemsToDisambiguate;
@property (readonly, copy) NSString *alternativeProviderBundleIdentifier;
@property (readonly, copy) NSString *ampPAFDataSetID;
...
- (id)initWithAppSelectionEnabled:(id)a0 appInferred:(id)a1 audioSearchResults:(id)a2 privateMediaIntentData:(id)a3 appSelectionSignalsEnabled:(id)a4 appSelectionSignalsFrequencyDenominator:(id)a5 shouldSuppressCommonWholeHouseAudioRoutes:(id)a6 immediatelyStartPlayback:(id)a7 isAmbiguousPlay:(id)a8 isPersonalizedRequest:(id)a9 internalSignals:(id)a10 entityConfidenceSignalsEnabled:(id)a11 entityConfidenceSignalsFrequencyDenominatorInternal:(id)a12 entityConfidenceSignalsFrequencyDenominatorProd:(id)a13 entityConfidenceSignalsMaxItemsToDisambiguate:(id)a14 alternativeProviderBundleIdentifier:(id)a15 ampPAFDataSetID:(id)a16 pegasusMetaData:(id)a17;
