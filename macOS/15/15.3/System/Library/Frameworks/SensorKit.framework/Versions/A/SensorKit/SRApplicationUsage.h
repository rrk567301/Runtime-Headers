...
+ (id)applicationUsageWithBundleIdentifier:(id)a0 reportApplicationIdentifier:(id)a1 totalUsageTime:(double)a2 relativeStartTime:(double)a3 textInputSessions:(id)a4 supplementalCategories:(id)a5;
