...
+ (BOOL)_compareSingleValueRelationshipKey:(id)a0 forObject:(id)a1 againstObject:(id)a2 propertiesToIgnore:(id)a3 ignoreIdentityKeys:(BOOL)a4;
...
- (void)_addChanges:(id)a0 copyingBackingObjects:(BOOL)a1 objectIdentifierBlock:(id /* block */)a2;
- (void)_addChangesFromObject:(id)a0 ignoringDifferencesFrom:(id)a1 changesToSkip:(id)a2 copyingBackingObjects:(BOOL)a3;
...
- (void)_resetAfterUpdatingChangeSetOrBackingObjectWithForce:(BOOL)a0;
- (BOOL)_resetCommon;
...
- (id)diffWithObject:(id)a0 compareUIVisiblePropertiesOnly:(BOOL)a1;
...
- (void)updateMultiValueCacheForChangeSet:(id)a0 preservingExistingAdds:(BOOL)a1 objectIdentifierBlock:(id /* block */)a2;
