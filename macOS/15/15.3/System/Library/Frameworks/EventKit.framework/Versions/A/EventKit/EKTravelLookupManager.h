...
- (void)_findCoordinatesForLocation:(id)a0 completionBlock:(id /* block */)a1;
- (void)_travelTimeFrom:(id)a0 to:(id)a1 arrivalDate:(id)a2 withRouteType:(id)a3 withCompletionBlock:(id /* block */)a4;
