...
@property (copy, nonatomic) NSNumber *cookMode;
@property (copy, nonatomic) NSNumber *cookTime;
@property (copy, nonatomic) NSNumber *powerSetting;
@property (copy, nonatomic) NSNumber *wattSettingIndex;
@property (copy, nonatomic) NSNumber *startAfterSetting;
