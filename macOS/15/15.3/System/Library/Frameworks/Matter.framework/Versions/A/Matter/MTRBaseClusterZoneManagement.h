...
+ (void)readAttributeTimeControlWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeTimeControlWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeTimeControlWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeTimeControlWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeTimeControlWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
