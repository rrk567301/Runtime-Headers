@class MTRDemandResponseLoadControlClusterLoadControlProgramStruct, NSNumber;

@interface MTRDemandResponseLoadControlClusterRegisterLoadControlProgramRequestParams : NSObject <NSCopying>

@property (copy, nonatomic) MTRDemandResponseLoadControlClusterLoadControlProgramStruct *loadControlProgram;
