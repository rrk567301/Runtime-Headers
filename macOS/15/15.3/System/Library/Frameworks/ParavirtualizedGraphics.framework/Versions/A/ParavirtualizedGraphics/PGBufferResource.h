...
+ (id)newHeapBufferWithTask:(id)a0 descriptor:(const void *)a1 descriptorLength:(unsigned int)a2 placement:(union { unsigned long long x0; struct { unsigned long long x0; unsigned long long x1; } x1; } *)a3;
