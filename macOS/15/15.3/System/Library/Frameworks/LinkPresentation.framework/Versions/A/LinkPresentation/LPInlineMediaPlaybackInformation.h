...
+ (id)_inlineiTunesMediaPlaybackInformationWithType:(unsigned long long)a0 storeIdentifier:(id)a1 storefrontIdentifier:(id)a2 offers:(id)a3 previewURL:(id)a4 lyricExcerpt:(id)a5;
...
+ (id)podcastEpisodePlaybackInformationWithStoreIdentifier:(id)a0 storefrontIdentifier:(id)a1 offers:(id)a2;
