...
@property (readonly, weak, nonatomic) NSMenu *_firstMenu;
...
- (void)_forEachAccessibleChild:(id /* block */)a0;
...
- (void)_setNextMenuForImpl:(id)a0;
- (void)_setOwnedByPopUp:(id)a0;
- (void)_setPreviousMenuForImpl:(id)a0;
