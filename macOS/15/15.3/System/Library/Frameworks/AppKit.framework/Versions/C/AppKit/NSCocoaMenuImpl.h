...
@property (readonly) long long numberOfMenuItemsIncludingLinkedMenus;
...
- (BOOL)_dismissPrimarySubmenuAnimated:(BOOL)a0 coalescingSubmenus:(BOOL)a1;
...
- (BOOL)_itemCanBeHighlightedForAX:(id)a0 allowingDisabledItems:(BOOL)a1;
