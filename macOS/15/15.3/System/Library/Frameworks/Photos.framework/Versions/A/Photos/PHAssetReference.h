...
- (id)initWithLocalIdentifier:(id)a0 libraryURL:(id)a1 mediaType:(long long)a2 subtypes:(unsigned long long)a3 sourceType:(unsigned long long)a4 isTrashed:(BOOL)a5 isRecovered:(BOOL)a6;
