...
- (void)blockmapFile:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 startIO:(int)a2 flags:(unsigned int)a3 operationID:(unsigned long long)a4 replyHandler:(id /* block */)a5;
...
- (void)endIO:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 status:(int)a2 flags:(unsigned int)a3 operationID:(unsigned long long)a4 replyHandler:(id /* block */)a5;
...
- (id)getStandardItemAttributes:(id)a0;
- (id)getStandardItemAttributesData:(id)a0;
- (id)getStandardItemAttributesDataForNewItem:(id)a0;
...
- (void)renameItemIn:(id)a0 item:(id)a1 oldName:(id)a2 toDirectory:(id)a3 newName:(id)a4 toItem:(id)a5 usingFlags:(unsigned int)a6 replyHandler:(id /* block */)a7;
- (void)renameItemIn:(id)a0 item:(id)a1 oldName:(id)a2 toDirectory:(id)a3 overItem:(id)a4 newName:(id)a5 replyHandler:(id /* block */)a6;
