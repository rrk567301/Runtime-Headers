@class NSString, SMConversation, NSDate;
...
- (void).cxx_destruct;
- (id)initWithIdentifier:(id)a0 messageType:(unsigned long long)a1 messageSentDate:(id)a2 pendingRetryCount:(long long)a3 conversation:(id)a4 callback:(id)a5;
