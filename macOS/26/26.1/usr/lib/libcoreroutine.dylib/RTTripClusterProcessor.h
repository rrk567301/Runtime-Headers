...
@property BOOL shouldDeferClusterProcessing;
...
- (void)deferClusterProcessing:(BOOL)a0;
- (void)deleteWaypointsForClustersWithDuplicateWaypoints:(id)a0 tripClusterWaypointStore:(id)a1 tripClusterRouteStore:(id)a2 tripClusterRouteTransitionsStore:(id)a3 minimumTraversalCountForLearnedRoutes:(int)a4;
- (void)fillInRouteLocationsForClustersInStore:(id)a0 tripClusterRouteStore:(id)a1 tripClusterWaypointStore:(id)a2 tripClusterRoadTransitionsStore:(id)a3 minimumTraversalCountForLearnedRoutes:(int)a4;
...
- (BOOL)updateClusterRouteUsingWaypointsWithClusterID:(id)a0 tripClusterStore:(id)a1 tripClusterRouteStore:(id)a2 tripClusterWaypointStore:(id)a3;
