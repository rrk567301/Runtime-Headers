...
- (id)_fetchHistoryTransactionBatchFromContext:(id)a0 store:(id)a1 fromToken:(id)a2 limit:(unsigned long long)a3 error:(id *)a4;
...
- (unsigned long long)_countChangesInTransactionsFromContext:(id)a0 store:(id)a1 startingToken:(id)a2 error:(id *)a3;
...
- (unsigned long long)_changeCountForManagedObjectContext:(id)a0 currentExporterToken:(id)a1 error:(id *)a2;
...
- (void)mirroringManager:(id)a0 exceededHistoryType:(unsigned long long)a1 count:(unsigned long long)a2 limit:(unsigned long long)a3 hasExceeded:(BOOL)a4;
