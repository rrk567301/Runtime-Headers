@class NSString, NSDictionary, SecureMobileAssetManifestVerifier, MAAssetTypeDescriptor, NSObject;
...
- (BOOL)loadTrustCache:(id *)a0;
- (BOOL)_activateManifestInExclaves:(unsigned int)a0 error:(id *)a1;
- (BOOL)_beginAccessWithOptions_nowait:(id)a0 accessMechanismPtr:(long long *)a1 errorPtr:(id *)a2;
- (BOOL)_generateNonceProposalForHandle:(unsigned long long)a0 digest:(id *)a1 nonce:(id *)a2 error:(id *)a3;
- (id)_manifestDataFromStoredTicket:(id)a0 manifestType:(unsigned long long)a1;
- (BOOL)_personalize:(id)a0 error:(id *)a1;
- (id)_personalizedBundleTicketData;
- (BOOL)_queryNonceForHandle:(unsigned long long)a0 domain:(unsigned int)a1 digest:(id *)a2 error:(id *)a3;
- (BOOL)_shouldForcePersonalizationFailure;
- (BOOL)_storeManifest:(id)a0 manifestType:(unsigned long long)a1 stage:(BOOL)a2 error:(id *)a3;
- (BOOL)_storeManifestToExclaves:(id)a0 infoPlist:(id)a1 stage:(BOOL)a2 error:(id *)a3;
- (id)assetValues;
- (id)attach:(id)a0 error:(id *)a1;
- (BOOL)beginAccessWithOptions:(id)a0 accessMechanismPtr:(long long *)a1 errorPtr:(id *)a2;
- (BOOL)bundleAccessPermitted:(id *)a0;
- (BOOL)depersonalize:(id *)a0;
- (id)devnodesForDiskImageID:(id)a0 error:(id *)a1;
- (BOOL)endAccessWithOptions:(id)a0 accessMechanismPtr:(long long *)a1 errorPtr:(id *)a2;
- (BOOL)endAccessWithOptions_nowait:(id)a0 accessMechanismPtr:(long long *)a1 errorPtr:(id *)a2;
- (BOOL)graft:(id *)a0;
- (BOOL)graftOrMount:(long long *)a0 graftingError:(id *)a1;
- (id)integrityCatalogPath;
- (BOOL)isGrafted;
- (BOOL)isGraftedPath:(id)a0;
- (BOOL)isMappableToExclaves:(unsigned int *)a0;
- (BOOL)isPersonalizedForExclaves:(unsigned int)a0 staged:(BOOL)a1;
...
- (void)recordAssetGraftStateForEarlyBootTask:(BOOL)a0 options:(id)a1;
- (BOOL)ungraft:(id *)a0;
- (BOOL)ungraftOrUnmount:(long long *)a0 ungraftingError:(id *)a1;
