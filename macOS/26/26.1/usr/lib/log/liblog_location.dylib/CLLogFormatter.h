...
- (id)JSONObjectWith_CLClientInUseLevel:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_RBSTaskState:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_Encrypted_CLClientLocation:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_CLClientIncidentalUseMode:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_NEVPNConnectivityState:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (void)dealloc;
...
- (id)JSONObjectWith_Encrypted_longitude:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (id)JSONObjectWith_CLSimulationLocationRepeatBehavior:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (id)JSONObjectWith_CLClientServiceType:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (id)JSONObjectWith_CLTelephonyService_Type__Cell:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (id)JSONObjectWith_Encrypted_CLLocationCoordinate2D:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
- (id)JSONObjectWith_CLClientCorrectiveCompensation:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_Encrypted_latitude:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
...
- (id)JSONObjectWith_CLLocationDictionaryUtilitiesAuthorizationMask:(id)a0 info:(struct os_log_type_info_s { unsigned int x0; BOOL x1; } *)a1;
