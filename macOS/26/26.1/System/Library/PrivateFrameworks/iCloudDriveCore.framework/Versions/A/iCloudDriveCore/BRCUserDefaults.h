...
@property (readonly, nonatomic) NSDictionary *cacheDeletePushBGSystemTaskConfig;
...
@property (readonly, nonatomic) BOOL useBGSTForSchedulingDiscretionaryOperations;
...
- (id)discretionaryOperationBGSystemTaskConfigWithForegroundState:(BOOL)a0;
