...
@interface VCMediaStreamTransport : NSObject {
    ...
    int _payloadType;
    struct { void *context; void /* function */ *creationCallback; BOOL isReceiveExternallyScheduled; BOOL requiresLargeReceiveBuffer; BOOL isRTCPReceiveFromMultipleSSRCsEnabled; int transportStreamIndex; } _transportStreamInfo;
    BOOL _rtcpXREnabled;
...
- (BOOL)setupRTPWithNWConnection:(struct _VCMediaStreamTransportSetupInfo { unsigned char x0; union { struct { int x0; int x1; } x0; struct { struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x0; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x1; } x1; struct { void *x0; void /* function */ *x1; BOOL x2; BOOL x3; BOOL x4; int x5; } x2; id x3; } x1; unsigned int x2; unsigned int x3; BOOL x4; void *x5; } *)a0 error:(id *)a1;
- (BOOL)configureWithStreamConfig:(id)a0 setupInfo:(struct _VCMediaStreamTransportSetupInfo { unsigned char x0; union { struct { int x0; int x1; } x0; struct { struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x0; struct tagIPPORT { int x0; char x1[16]; union { unsigned int x0; unsigned char x1[16]; } x2; unsigned short x3; } x1; } x1; struct { void *x0; void /* function */ *x1; BOOL x2; BOOL x3; BOOL x4; int x5; } x2; id x3; } x1; unsigned int x2; unsigned int x3; BOOL x4; void *x5; } *)a1 reducedSizeRTCPPackets:(BOOL)a2 hopByHopEncryptRTCPPackets:(BOOL)a3 statisticsCollector:(id)a4 basebandCongestionDetector:(id)a5 error:(id *)a6;
