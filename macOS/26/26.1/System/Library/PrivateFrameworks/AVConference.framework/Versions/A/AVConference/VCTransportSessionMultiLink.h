@class AVCAuditToken, VCDatagramChannelMultiLink, NSMutableArray, NSObject;
...
- (id)initWithLocalEndpoint:(id)a0 clientAuditToken:(id)a1 handlerQueue:(id)a2 context:(void *)a3 eventHandler:(void /* function */ *)a4 options:(id)a5 error:(id *)a6;
