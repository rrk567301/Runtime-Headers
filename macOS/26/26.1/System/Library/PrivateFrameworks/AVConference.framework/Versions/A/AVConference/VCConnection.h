...
- (long long)compare:(id)a0 isPrimary:(BOOL)a1 selectionPolicy:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; } *)a2;
- (long long)compareConnectionTypePriority:(id)a0 selectionPolicy:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; } *)a1;
- (long long)compareE2EPriority:(id)a0 selectionPolicy:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; } *)a1;
- (long long)compareInterfacePriority:(id)a0 isPrimary:(BOOL)a1 preferWired:(BOOL)a2;
- (long long)compareIpVersionPriority:(id)a0 selectionPolicy:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; } *)a1;
- (long long)compareVpnPriority:(id)a0 selectionPolicy:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; } *)a1;
- (id)getConnectionSelectionPriorities;
- (void)setPreviousLinkFlags:(unsigned short)a0;
- (void)setPreviousRemoteLinkFlags:(unsigned short)a0;
