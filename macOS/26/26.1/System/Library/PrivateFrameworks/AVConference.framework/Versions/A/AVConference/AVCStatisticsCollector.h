...
@interface AVCStatisticsCollector : NSObject {
    ...
    BOOL _shouldUseStatisticsForBWE;
    struct __CFAllocator { } *_statisticsChangeHandlerEntryAllocator;
    unsigned int _nextChangeHandlerIdentifier;
    struct _VCSingleLinkedList { struct _VCSingleLinkedListEntry *head; BOOL initialized; void /* function */ *compare; unsigned long long countEntries; } _statisticsChangeHandlers[17];
    struct _opaque_pthread_rwlock_t { long long __sig; char __opaque[192]; } _statisticsChangeHandlersLock;
    struct _opaque_pthread_rwlock_t { long long __sig; char __opaque[192]; } _processCompletionHandlerLock;
