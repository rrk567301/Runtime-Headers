...
- (BOOL)isEqual:(id)a0;
- (BOOL)addAudioPayload:(int)a0 isSecondary:(BOOL)a1;
- (id)initWithAllowAudioRecording:(BOOL)a0 ssrc:(unsigned int)a1 audioUnitNumber:(unsigned int)a2 audioRuleCollection:(id)a3;
