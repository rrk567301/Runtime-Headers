...
+ (id)reflowableTokensWithContext:(id)a0 contextStrokes:(id)a1 strokeProvider:(id)a2 skipLineOrientationEstimate:(BOOL)a3 shouldCancel:(id /* block */)a4;
+ (id)reflowableTokensWithTextResult:(id)a0 principalLineResult:(id)a1 shouldUseRefinablePath:(BOOL)a2 strokeProvider:(id)a3 shouldCancel:(id /* block */)a4;
