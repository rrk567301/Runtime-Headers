...
@interface CHCTCRecognitionModel : CHRecurrentNeuralNetworkCoreML {
    struct unique_ptr<CoreHandwriting::PreprocessingManager, std::default_delete<CoreHandwriting::PreprocessingManager>> { struct PreprocessingManager *__ptr_; } _preprocessor;
    struct unique_ptr<CoreHandwriting::FeatureExtractionProcessor, std::default_delete<CoreHandwriting::FeatureExtractionProcessor>> { struct FeatureExtractionProcessor *__ptr_; } _featureExtractor;
