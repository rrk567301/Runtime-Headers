...
- (int)loadFullPixelBuffer:(struct __CVBuffer **)a0 scaledPixelBuffer299:(struct __CVBuffer **)a1 scaledPixelBuffer360:(struct __CVBuffer **)a2 fromImageURL:(id)a3 abnormalDimension:(unsigned long long)a4;
