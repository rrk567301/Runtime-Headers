...
+ (id)_setIdentifier:(id)a0 withStartedDate:(id)a1 forKey:(id)a2 database:(id)a3 account:(id)a4 clientInfo:(id)a5 domain:(id)a6 resetInterval:(double)a7 serverProvidedAt:(id)a8 skipSync:(BOOL)a9;
