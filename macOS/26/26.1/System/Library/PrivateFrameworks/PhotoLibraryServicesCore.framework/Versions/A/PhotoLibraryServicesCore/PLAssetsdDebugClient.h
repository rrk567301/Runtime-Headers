...
- (id)backgroundAssetResourceNetworkStatusForBundleID:(id)a0 withLevel:(long long)a1;
- (BOOL)backgroundMigrationWithError:(id *)a0;
- (BOOL)clearSensitivityStateForAssetsWithUUIDs:(id)a0 error:(id *)a1;
...
- (BOOL)fileTapToRadarWithTitle:(id)a0 description:(id)a1 error:(id *)a2;
...
- (BOOL)insertBackgroundResourceJobConfigurationWithBundleIdentifier:(id)a0 state:(short)a1 error:(id *)a2;
...
- (BOOL)signalBackgroundJobServiceForWorkerCodes:(id)a0 error:(id *)a1;
