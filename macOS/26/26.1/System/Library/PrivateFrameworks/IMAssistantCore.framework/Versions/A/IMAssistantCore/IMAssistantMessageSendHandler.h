...
- (void)sendMessageWithDraft:(id)a0 expressiveSendStyleID:(id)a1 idsIdentifier:(id)a2 executionContext:(long long)a3 sourceApplicationID:(id)a4 toChat:(id)a5 completion:(id /* block */)a6;
- (void)sendMessagesWithText:(id)a0 currentLocation:(BOOL)a1 sharedLinkURL:(id)a2 audioMessageAttachment:(id)a3 photoLibraryAttachment:(id)a4 fileAttachments:(id)a5 expressiveSendStyleID:(id)a6 idsIdentifier:(id)a7 executionContext:(long long)a8 shouldHideSiriAttribution:(BOOL)a9 toChat:(id)a10 completion:(id /* block */)a11;
