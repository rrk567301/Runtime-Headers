...
+ (void)_configureEnumeratorForLibrarySummaryLogging:(id)a0 cloudPhotoLibraryEnabled:(BOOL)a1 dataForCA:(id)a2 libraryServicesManager:(id)a3;
...
+ (void)configureEnumeratorForLibrarySummaryForLibraryEnumerator:(id)a0 withSyndicationLibraryEnumerator:(id)a1 cloudPhotoLibraryEnabled:(BOOL)a2 dataForCA:(id)a3 libraryServicesManager:(id)a4;
