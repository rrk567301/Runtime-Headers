...
- (void)_addAssetCountsToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addAssetForSceneCountsToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (BOOL)_addCaptioningStatusToProcessingSnapshot:(id)a0 managedObjectContext:(id)a1 error:(id *)a2;
- (void)_addCaptioningToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addEmbeddingIndexingToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_addHighlightStatusToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addMediaAnalysisIndexingToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addPhotosKnowledgeGraphAvailabilityToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addSceneAnalysisIndexingToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addSceneAnalysisToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_addVUIndexFullClusterStatusToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
- (void)_addVersionsToProcessingSnapshot:(id)a0;
- (void)_addVisualUnderstandingClusterIndexStatusToProcessingSnapshot:(id)a0 photoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_onDemandAvailabilityUpdateWithChanges:(id)a0 forPhotoLibrary:(id)a1 progress:(id)a2 completionHandler:(id /* block */)a3;
...
- (BOOL)_shouldStopWithProgress:(id)a0 afterCallingCompletionHandler:(id /* block */)a1;
- (void)_updateSnapshot:(id)a0 withChanges:(id)a1;
...
- (id)computeAvailabilityForPhotoLibrary:(id)a0 shouldPersist:(BOOL)a1 completionHandler:(id /* block */)a2;
- (id)computeSnapshotForPhotoLibrary:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)onDemandAvailabilityUpdateWithChanges:(id)a0 forPhotoLibrary:(id)a1 completionHandler:(id /* block */)a2;
