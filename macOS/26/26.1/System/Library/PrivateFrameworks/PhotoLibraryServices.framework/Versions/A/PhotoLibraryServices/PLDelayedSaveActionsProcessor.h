...
- (void)_processDelayedCloudFeedAlbumUpdates:(id)a0 collectionShareUpdates:(id)a1 collectionShareDeletes:(id)a2 assetInserts:(id)a3 assetUpdates:(id)a4 commentInserts:(id)a5 invitationRecordUpdates:(id)a6 shareParticipantUpdates:(id)a7 shareParticipantDeletes:(id)a8 deletionEntries:(id)a9 transaction:(id)a10;
...
- (void)_processDelayedBackgroundUploadEventUpdate:(BOOL)a0 library:(id)a1 transaction:(id)a2;
- (void).cxx_destruct;
