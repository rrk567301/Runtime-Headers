...
@property (readonly, nonatomic) unsigned int orderContentType;
...
- (id)initWithOrderNumber:(id)a0 merchant:(id)a1 shippingDetails:(id)a2 orderContentType:(unsigned int)a3 error:(id *)a4;
