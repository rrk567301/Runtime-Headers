...
+ (id)preventWipeErrorWithReason:(id)a0 preventedByUser:(BOOL)a1;
+ (id)readOnlyError;
+ (id)sessionHasBeenDeferredError;
+ (id)tooManyOpenedEnginesError;
+ (id)transportErrorFromTransportError:(id)a0;
+ (id)unableToDeserializeRecordInStorage:(id)a0;
+ (id)unableToSerializeRecordError:(id)a0 inStorage:(id)a1;
