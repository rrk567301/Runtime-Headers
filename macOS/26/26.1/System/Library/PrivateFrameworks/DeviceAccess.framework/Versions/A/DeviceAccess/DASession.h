...
+ (BOOL)setDeviceAccessoryServiceInfo:(id)a0 device:(id)a1 session:(id)a2 error:(id *)a3;
...
- (void)launchInteractionWithDevice:(id)a0 flags:(long long)a1 reason:(id)a2 completionHandler:(id /* block */)a3;
- (void)modifyDeviceWithIdentifier:(id)a0 settings:(id)a1 completionHandler:(id /* block */)a2;
- (void)requestPermissionForDevice:(id)a0 services:(id)a1 completionHandler:(id /* block */)a2;
- (void)setDeviceAccessoryServiceInfo:(id)a0 device:(id)a1 completionHandler:(id /* block */)a2;
