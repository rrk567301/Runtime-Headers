@class VCPHandGestureVideoRequest, PTMSRResize;
...
@property (readonly) BOOL externalCamera;
...
- (id)initWithFrameSize:(struct CGSize { double x0; double x1; })a0 asyncInitQueue:(id)a1 externalHandDetectionsEnabled:(BOOL)a2 externalCamera:(BOOL)a3;
