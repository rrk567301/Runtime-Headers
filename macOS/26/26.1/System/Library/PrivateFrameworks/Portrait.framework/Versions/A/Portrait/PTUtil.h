...
- (int)renderDisparity:(id)a0 inDisparity:(id)a1 outYUV:(id)a2 region:(struct PTRegion { struct PTSize { unsigned short x0; unsigned short x1; } x0; })a3 drawLegend:(BOOL)a4;
