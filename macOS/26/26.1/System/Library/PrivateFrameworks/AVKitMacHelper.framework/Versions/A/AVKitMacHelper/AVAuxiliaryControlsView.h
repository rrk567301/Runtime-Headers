@class AVDesktopButton, NSArray, AVPlayerControlsConfigurator, AVAuxiliaryControl, NSMutableArray, AVObservationController;
...
@property (retain, nonatomic) AVPlayerControlsConfigurator *buttonConfigurator;
