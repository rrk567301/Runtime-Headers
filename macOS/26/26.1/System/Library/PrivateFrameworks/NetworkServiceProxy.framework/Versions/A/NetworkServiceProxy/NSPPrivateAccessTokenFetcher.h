...
- (void)checkRemainingCostQuotaWithQueue:(id)a0 completionHandler:(id /* block */)a1;
- (void)fetchLinkedTokenPairWithQueue:(id)a0 completionHandler:(id /* block */)a1;
- (void)fetchTokenAndAuxiliaryAuthenticationWithQueue:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)initWithChallenge:(id)a0 tokenKey:(id)a1 auxiliaryAuthenticationChallenge:(id)a2 auxiliaryAuthenticationKey:(id)a3 auxiliaryAuthenticationLabel:(id)a4;
- (void)saveOneTimeTokenToCache:(id)a0 oneTimeTokenSalt:(id)a1 longLivedToken:(id)a2;
