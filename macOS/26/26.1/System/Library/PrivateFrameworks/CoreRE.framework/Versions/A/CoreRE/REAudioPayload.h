...
- (id)initWithFilePath:(id)a0 inputMode:(unsigned char)a1 referenceLevel:(float)a2 loopCount:(int)a3 mixGroupName:(id)a4 streaming:(BOOL)a5 normalizationMode:(int)a6 calibrationMode:(int)a7 calibrationLevel:(double)a8 layoutTag:(unsigned int)a9 taskToken:(unsigned int)a10 targetLUFS:(double)a11 audioAssetID:(unsigned long long)a12 urlQueryItems:(id)a13;
