@class NSString;
@protocol VFXStencilInfo, VFXRenderTargetInfo;
...
@property (nonatomic) BOOL _isFadeOpaque;
...
@property (nonatomic) struct MeshStats { int x0; int x1; int x2; int x3; int x4; int x5; int x6; int x7; int x8; int x9; int x10; int x11; int x12; int x13; int x14; int x15; int x16; int x17; int x18; int x19; int x20; int x21; int x22; int x23; int x24; int x25; int *x26; int *x27; int *x28; unsigned char x29; } *_meshStats;
...
@property (readonly, nonatomic) BOOL enableDepthMitigation;
...
@property (readonly, nonatomic) BOOL renderInGBuffer;
@property (readonly, nonatomic) BOOL outputsNormalRoughness;
@property (readonly, nonatomic) BOOL outputsAlbedoMetalness;
@property (readonly, nonatomic) BOOL outputsRadianceAO;
@property (readonly, nonatomic) long long renderMode;
@property (readonly, nonatomic) BOOL isLayeredRendering;
@property (readonly, nonatomic) BOOL enableSSAO;
