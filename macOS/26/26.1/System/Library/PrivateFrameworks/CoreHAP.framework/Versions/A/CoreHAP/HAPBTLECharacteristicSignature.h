...
- (void).cxx_destruct;
- (id)initWithCharacteristicType:(id)a0 serviceInstanceID:(id)a1 serviceType:(id)a2 characteristicProperties:(unsigned short)a3 characteristicMetadata:(id)a4 authenticated:(BOOL)a5;
