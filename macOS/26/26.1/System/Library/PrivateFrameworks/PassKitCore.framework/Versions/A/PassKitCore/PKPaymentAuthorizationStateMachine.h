@class PKAccountService, NSMutableArray, NSString, PKPaymentService, PKContinuityPaymentService, NSArray, PKPaymentAuthorizationDataModel, PKPaymentAuthorizationClientCallbackStateParam, PKPeerPaymentService, NSObject, PKPaymentSheetExperiment, PKInAppPaymentSession, PKPaymentOffersController, PKAccountEnhancedMerchantsFetcher, PKContinuityPaymentCoordinator, PKAccount, PKPaymentWebService, NSUUID, PKSecureElement, PKPeerPaymentSession, PKBluetoothMonitorer;
...
- (id)acceptedPassForProvisionedPass:(id)a0;
...
- (void)_applyFulfillmentMethodToPayment:(id)a0;
...
- (void)_enqueueDidSelectPaymentPass:(id)a0 paymentApplication:(id)a1 subCredential:(id)a2;
...
- (void)_purchaseMerchantIdentifier:(id *)a0 originURL:(id *)a1 webMerchantIdentifier:(id *)a2 webMerchantName:(id *)a3 adamIdentifier:(id *)a4 isMerchantTokenRequest:(BOOL *)a5 isMultiTokenRequest:(BOOL *)a6;
...
- (void)didSelectPaymentPass:(id)a0 paymentApplication:(id)a1 subCredential:(id)a2;
...
- (void)paymentOfferMerchandisingChanged:(id)a0;
