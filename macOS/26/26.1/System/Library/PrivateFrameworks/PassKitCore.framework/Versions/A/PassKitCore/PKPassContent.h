@class PKPassPersonalization, NSString, NSArray, PKPassLiveDataConfiguration, NSSet, NSDictionary, PKFidoProfile, PKPassBarcodeSettings, PKPassUpcomingPassInformation;
