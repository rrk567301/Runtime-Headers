...
- (id)_bodyDictionaryForRequests:(id)a0 isStopRequest:(BOOL)a1 deviceLocation:(id)a2;
...
- (id)_jsonDictionaryForRequest:(id)a0 isStopRequest:(BOOL)a1 deviceLocation:(id)a2;
