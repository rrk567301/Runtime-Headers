...
@interface CSStingrayRecordClientMetadataICloudDataProtection : PBCodable <NSCopying> {
    struct { unsigned char icdp : 1; unsigned char icdpArmed : 1; unsigned char icdpDBRv2 : 1; unsigned char icdpDrop : 1; unsigned char icdpGF : 1; unsigned char icdpWalrus : 1; } _has;
}
