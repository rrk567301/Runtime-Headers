...
@property (nonatomic) BOOL isAwaitingRetrain;

- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (void).cxx_destruct;
- (id)filterItems:(id)a0 usingLocationBlock:(id /* block */)a1;
- (BOOL)_requestRetrainIfNeededWithReason:(id)a0;
