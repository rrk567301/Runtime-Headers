...
+ (unsigned int)appleIDVValidatePrearmTrustWithCertificate:(id)a0 protectedPublicKey:(id)a1;
...
+ (unsigned int)removeDoublePressOnACL:(id)a0 intoACL:(id *)a1;
...
+ (unsigned int)appleIDVGetPrearmTrustKeyFromExistingKeyBlob:(id)a0 nonce:(id)a1 progenitorPublicKey:(id)a2 encryptedPrivateKey:(id *)a3 attestation:(id *)a4 publicKey:(id *)a5 keyBlob:(id *)a6;
