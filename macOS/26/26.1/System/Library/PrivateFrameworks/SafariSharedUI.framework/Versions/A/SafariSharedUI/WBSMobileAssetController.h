...
- (void)_queryBackgroundImageAsset:(id)a0 completionHandler:(id /* block */)a1;
- (void)_queryBackgroundImageAsset:(id)a0 retryCount:(long long)a1 completionHandler:(id /* block */)a2;
