...
+ (struct vector<double, std::allocator<double>> { double *x0; double *x1; double *x2; })extractFeatureVectorForLocale:(id)a0 string1:(id)a1 string2:(id)a2 evaluation:(id)a3 imageSize:(struct CGSize { double x0; double x1; })a4;
