...
@property (nonatomic, setter=setShowsReflectionRemixesInline:) BOOL showsReflectionRemixesInline;
...
@property (retain, nonatomic, setter=_setRemixRingtoneIdentifiers:) NSArray *_remixRingtoneIdentifiers;
@property (nonatomic, setter=_setSelectedRemixRingtoneIndex:) unsigned long long _selectedRemixRingtoneIndex;
...
- (BOOL)_isReflectionHeaderAtIndexPath:(id)a0;
...
- (id)initWithAlertType:(long long)a0 topic:(id)a1 defaultToneIdentifier:(id)a2 selectedToneIdentifier:(id)a3 showsDefault:(BOOL)a4 showsNone:(BOOL)a5 isNoneAtTop:(BOOL)a6 noneString:(id)a7;
- (id)pickerItemForSection:(long long)a0;
- (void)setIgnoreMute:(BOOL)a0 updateSource:(long long)a1;
- (BOOL)stopPlayingWithFadeOut:(BOOL)a0;
