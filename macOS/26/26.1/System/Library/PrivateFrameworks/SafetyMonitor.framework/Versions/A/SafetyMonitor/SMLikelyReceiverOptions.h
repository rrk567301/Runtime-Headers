...
@property (readonly, nonatomic) BOOL firstResultOnly;
...
- (id)initWithRequireEligibility:(BOOL)a0 requireContact:(BOOL)a1 requireNonBlockedContact:(BOOL)a2 requireOnlyFavoritedHandles:(BOOL)a3 requireOnlyPastSessionRecipients:(BOOL)a4 firstResultOnly:(BOOL)a5;
