...
- (id)serialize;
- (void)writeTo:(id)a0;
- (id)initWithEmailMetadata:(id)a0 emailType:(int)a1 orderNumber:(id)a2 orderDate:(id)a3 merchant:(id)a4 customer:(id)a5 shippingRecipient:(id)a6 shippingInformation:(id)a7 paymentInformation:(id)a8 spotlightUniqueIdentifier:(id)a9 spotlightDomainIdentifier:(id)a10 orderContentType:(int)a11;
