...
- (void)dealloc;
- (void).cxx_destruct;
- (void)addOperations:(id)a0 completionOp:(id)a1 allOps:(id)a2 context:(id)a3;
- (void)createIdentity:(id)a0 complete:(id /* block */)a1;
- (id)createIdentityOperation:(id)a0;
- (void)createNewIdentities:(id)a0 roll:(BOOL)a1 sync:(BOOL)a2 forceSync:(BOOL)a3 complete:(id /* block */)a4;
