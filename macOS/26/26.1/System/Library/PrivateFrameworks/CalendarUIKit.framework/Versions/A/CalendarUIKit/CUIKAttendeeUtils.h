...
+ (id)attendeesWithoutSelfOrganizerAndLocationsWithEvent:(id)a0 outSelfOrganizer:(id *)a1;
...
+ (id)displayStringForIdentity:(id)a0 useAddressAsFallback:(BOOL)a1 contactIdentifier:(id *)a2;
