...
+ (id)buildWithCalendarIdentifier:(id)a0 withMonitor:(id)a1 withIdentifiers:(id)a2 withIdentifiersVersion2:(id)a3 withExemptApps:(id)a4 withNotificationTimes:(id)a5 withTimeBudget:(id)a6;
