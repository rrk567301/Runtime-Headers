...
- (id)_existingAssetsInContainer:(id)a0 curationKind:(long long)a1 curationLength:(long long)a2 options:(unsigned long long)a3 sortDescriptors:(id)a4 reverseSortOrder:(BOOL)a5 filterPredicate:(id)a6 fetchPropertySets:(id)a7 libraryFilter:(long long)a8 includeOthersInSocialGroupAssets:(BOOL)a9;
...
- (id)_existingFetchResultForAssetCollection:(id)a0 withFilterPredicate:(id)a1 inclusionPredicate:(id)a2 includeUnsavedSyndicatedAssets:(BOOL)a3 includeSharedCollectionAssets:(BOOL)a4 includeAllBurstAssets:(BOOL)a5 fetchLimit:(unsigned long long)a6 options:(unsigned long long)a7 sortDescriptors:(id)a8 reverseSortOrder:(BOOL)a9 hideHiddenAssets:(BOOL)a10 fetchPropertySets:(id)a11 libraryFilter:(long long)a12;
...
- (id)_fetchAssetsInAssetCollection:(id)a0 withFilterPredicate:(id)a1 inclusionPredicate:(id)a2 includeUnsavedSyndicatedAssets:(BOOL)a3 includeSharedCollectionAssets:(BOOL)a4 includeAllBurstAssets:(BOOL)a5 fetchLimit:(unsigned long long)a6 options:(unsigned long long)a7 sortDescriptors:(id)a8 reverseSortOrder:(BOOL)a9 hideHiddenAssets:(BOOL)a10 fetchPropertySets:(id)a11 libraryFilter:(long long)a12 includeOthersInSocialGroupAssets:(BOOL)a13;
- (id)_fetchAssetsInContainer:(id)a0 curationKind:(long long)a1 curationLength:(long long)a2 options:(unsigned long long)a3 sortDescriptors:(id)a4 reverseSortOrder:(BOOL)a5 filterPredicate:(id)a6 fetchPropertySets:(id)a7 libraryFilter:(long long)a8 includeOthersInSocialGroupAssets:(BOOL)a9;
- (id)_fetchConfigurationForCuratedAssetsWithCurationKind:(long long)a0 curationLength:(long long)a1 options:(unsigned long long)a2 sortDescriptors:(id)a3 reverseSortOrder:(BOOL)a4 filterPredicate:(id)a5 fetchPropertySets:(id)a6 libraryFilter:(long long)a7 includeOthersInSocialGroupAssets:(BOOL)a8;
...
- (id)_fetchConfigurationWithFilterPredicate:(id)a0 inclusionPredicate:(id)a1 includeUnsavedSyndicatedAssets:(BOOL)a2 includeSharedCollectionAssets:(BOOL)a3 includeAllBurstAssets:(BOOL)a4 fetchLimit:(unsigned long long)a5 options:(unsigned long long)a6 sortDescriptors:(id)a7 reverseSortOrder:(BOOL)a8 hideHiddenAssets:(BOOL)a9 fetchPropertySets:(id)a10 libraryFilter:(long long)a11;
...
- (id)_fetchOptionsForContainer:(id)a0 curationKind:(long long)a1 options:(unsigned long long)a2 sortDescriptors:(id)a3 reverseSortOrder:(BOOL)a4 filterPredicate:(id)a5 fetchPropertySets:(id)a6 libraryFilter:(long long)a7;
