...
@property (readonly, nonatomic) BOOL shouldUseInactiveImageFilter;
...
@property (readonly, nonatomic) BOOL shouldLimitVideoDownloadQuality;
@property (readonly, nonatomic) BOOL inLiveResize;
@property (readonly, nonatomic) BOOL shouldPauseTransitions;
...
- (BOOL)_isPlaceholderPresentInSegmentWithIdentifier:(long long)a0;
...
- (void)setShouldPauseTransitions:(BOOL)a0;
