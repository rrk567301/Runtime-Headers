...
+ (BOOL)_requestWidgetTimelineReloadForWidgetKind:(id)a0 withError:(id *)a1;
...
+ (id)timelineFromLibrary:(id)a0 albumIdentifier:(id)a1 widgetIdentifier:(id)a2 widgetSize:(struct CGSize { double x0; double x1; })a3 withOptions:(id)a4;
+ (id)timelineFromLibrary:(id)a0 assetLocalIdentifiers:(id)a1 widgetIdentifier:(id)a2 widgetSize:(struct CGSize { double x0; double x1; })a3 withOptions:(id)a4;
