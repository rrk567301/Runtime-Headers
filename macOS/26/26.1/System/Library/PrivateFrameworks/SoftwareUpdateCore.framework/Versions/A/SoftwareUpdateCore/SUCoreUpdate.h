@class NSError, NSString, SUCoreFSM, SUCoreDescriptor, SUCorePolicy, NSDictionary, SUCoreRollbackDescriptor, NSObject, SUCoreUpdateDownloader, SUCoreRollback, SUCoreMSU;
...
- (void)anomaly:(id)a0;
- (void)downloadProgress:(id)a0;
- (void)downloadStalled:(id)a0;
- (void)downloaded:(id)a0;
- (id)previousRollback;
- (void)targetBrainLoaded:(id)a0;
- (void)targetDownloadPreflighted:(id)a0;
- (void)updateRemoveFailed:(id)a0;
- (void)updateRemoved;
