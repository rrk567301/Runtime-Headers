...
@property (nonatomic) BOOL hasLocalizedTextDataInCache;
...
- (void)didFinishUploadingWithError:(id)a0;
...
- (void)populateLocalizedTextDataForExtensions:(id)a0;
...
- (void)updateCachedExtensionsWithLocalizedTextData:(id)a0;
