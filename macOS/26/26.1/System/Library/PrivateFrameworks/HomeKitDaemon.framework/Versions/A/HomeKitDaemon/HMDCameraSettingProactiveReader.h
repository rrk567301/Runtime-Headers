...
- (id)initWithWorkQueue:(id)a0 sessionID:(id)a1 accessory:(id)a2 message:(id)a3 streamControlMessageHandlers:(id)a4 streamPreferences:(id)a5 logIdentifier:(id)a6 logEventSubmitter:(id)a7;
- (void)readSetting;
