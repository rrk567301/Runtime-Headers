@class HMDMatterAccessoryAdapter, NSDate, HMDHome, NSDictionary, HMDWiFiManagementController, HMDDoorbellChimeController, NSMutableSet, NSMutableArray, HMCameraUserNotificationSettings, HMDDataStreamController, HMDCameraProfileSettingsManager, HMDAnalyticsHAPServiceData, HMDMediaProfile, HMDUser, OS_dispatch_queue, HMDAccessoryAdvertisement, HMDLightProfile, HAPSocketInfo, NSData, HMDAccessoryFirmwareUpdateProfile, HMFPairingIdentity, HMDAccessoryDiagnosticsManager, HMDHAPAccessoryLocalNotifyUpdateManager, NAFuture, NSNumber, HMMTRAccessoryServer, HMFConnectivityInfo, HMDSiriEndpointProfile, HMDTargetControllerManager, HMDDeviceCapabilities, HMDCHIPAccessoryStorage, NSArray, HMDAccessorySymptomHandler, HMDBulletinBoard, NSMutableDictionary, HMDRoom, NSString, HMDLowPowerModeProfile, HMDSiriEndpointProfileMetricsDispatcher, HMDMatterAccessoryDiagnosticsManager, HMDPendingCharacteristic, HMSupportedAccessoryDiagnostics, HMFTimer, NSUUID, HMDNetworkRouterController, NSSet, HMDService, HMDAccessoryMetric;
@protocol HMDDataStreamSocketController, HMDMessageRouter, HMDHAPAccessorySwiftExtensions, HMDHAPAccessoryDataSource;

@interface HMDHAPAccessory : HMDAccessory <HMMTRAccessoryServerDelegate, HMMTRReportObserver, HMDSiriEndpointProfileMetricsDispatcherFactory, HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDHomeActivityStateObserver, HMDAccessoryMinimumUserPrivilegeCapable, HMDAccessoryMediaPrivilegeCapable, HMDServiceOwner, HMDMatterAccessoryProtocol, HAPAccessoryDelegate, HMFTimerDelegate, HAPAccessoryServerNotification, HMDAccessoryUserManagement> {
...
@property (nonatomic) BOOL mediaPrivilegeUpdateScheduled;
@property (nonatomic) double lastLinkChangeSessionCheckTime;
@property (getter=isBridgedAccessoryConnected) BOOL bridgedAccessoryConnected;
...
@property (readonly) HMDHAPAccessoryLocalNotifyUpdateManager *enableNotifyUpdateManager;
...
@property (nonatomic) BOOL previousUnexpectedDisconnect;
...
+ (double)initialExpiryForRemainingTTL:(double)a0 expiry:(id)a1;
+ (double)retryExpiryForRemainingTTL:(double)a0 expiry:(id)a1;
+ (BOOL)suspendedPerErrorCode:(long long)a0;
...
- (BOOL)supportsPresenceDetectionViaHAP;
- (void)unconfigureAsValenciaThermostat;
...
- (void)_darkWakeHAPAccessory:(id /* block */)a0 errorBlock:(id /* block */)a1;
...
- (void)_handleBridgedAccessoryConnectedChangedWithError:(id)a0;
- (void)_handleChangeUpdateSource:(id)a0;
- (void)_handleCompletedReadCharacteristicResponse:(id)a0 hmdResponseTuples:(id)a1 readRequests:(id)a2 hapAccessory:(id)a3 hapHmdMapping:(id)a4 readEvent:(id)a5 startTime:(double)a6 overallError:(id)a7 completionHandler:(id /* block */)a8;
- (void)_handleCompletedWriteCharacteristicResponse:(id)a0 hmdResponseTuples:(id)a1 writeRequests:(id)a2 hapAccessory:(id)a3 hapHmdCharacteristicMapping:(id)a4 writeEvent:(id)a5 startTime:(double)a6 overallError:(id)a7 completionHandler:(id /* block */)a8;
...
- (void)_handleReadCharacteristicResponse:(id)a0 hapCharacteristics:(id)a1 hapAccessory:(id)a2 retryExpiry:(double)a3 expiry:(id)a4 overallError:(id)a5 readEvent:(id)a6 completionBlock:(id /* block */)a7;
...
- (void)_handleUnreachableAccessoryToPerformOperation:(long long)a0 wakeAccessoryIfNeeded:(BOOL)a1 operationBlock:(id /* block */)a2 errorBlock:(id /* block */)a3;
...
- (void)_handleWriteCharacteristicResponse:(id)a0 hapWriteRequestTuples:(id)a1 hapAccessory:(id)a2 retryExpiry:(double)a3 expiry:(id)a4 overallError:(id)a5 writeEvent:(id)a6 completionBlock:(id /* block */)a7;
- (id)_hh2HandleUpdatedServicesForProfilesAndControllers:(id)a0;
- (BOOL)_hh2ShouldFilterAccessoryProfile:(id)a0;
- (BOOL)_isRegisteredForNotificationsByAnyForegroundClient:(id)a0;
- (BOOL)_isRegisteredForNotificationsByForegroundProcess;
- (void)_locallyEnableNotificationWithCoalescing:(BOOL)a0 characteristicsToModifyLocally:(id)a1 activity:(id)a2 notificationChangeThresholds:(id)a3 clientIdentifier:(id)a4 matchingHAPAccessory:(id)a5 characteristicsErrorsMapFailingToModify:(id)a6;
- (void)_locallyEnableNotificationWithoutCoalescing:(BOOL)a0 characteristicsToModifyLocally:(id)a1 activity:(id)a2 notificationChangeThresholds:(id)a3 clientIdentifier:(id)a4 matchingHAPAccessory:(id)a5 characteristicsErrorsMapFailingToModify:(id)a6;
...
- (void)_performOperation:(long long)a0 linkType:(long long)a1 wakeAccessoryIfNeeded:(BOOL)a2 operationBlock:(id /* block */)a3 errorBlock:(id /* block */)a4;
- (void)_postMatterEventNotificationWithEventReport:(id)a0 dictionary:(id)a1 home:(id)a2 hapAccessory:(id)a3;
- (void)_postUpdateEventsIfDifferent:(id)a0;
- (id)_prepareMessagePayloadForCharacteristicRemoteWrite:(id)a0;
- (void)_processMediaPrivilegeCharacteristicUpdate:(id)a0;
...
- (void)_retrieveHAPAccessoryToPerformOperation:(long long)a0 linkType:(long long)a1 operationBlock:(id /* block */)a2 errorBlock:(id /* block */)a3 activity:(id)a4 performOperationOnRetrieveFailure:(BOOL)a5 overrideFailureError:(id)a6;
...
- (void)_setMediaPrivilegeOnAccessory:(long long)a0 toCharacteristic:(id)a1;
...
- (BOOL)_shouldDarkPollAccessory:(id)a0;
- (BOOL)_shouldDarkPollAccessory:(id)a0 override:(BOOL)a1;
- (BOOL)_shouldFilterAccessoryProfileForUnentitledClients:(id)a0;
- (BOOL)_shouldHandleEventReports:(id)a0;
- (BOOL)_shouldPostHMDAccessoryMatterEventReportNotification:(id)a0;
- (BOOL)_shouldTrackAccessoryWithPriority:(BOOL *)a0;
- (BOOL)_shouldUpdateMediaPrivilegeCharacteristic:(id)a0 toNew:(long long)a1;
...
- (id)_targetHMDHAPAccessoryForHAPAccessory:(id)a0 home:(id)a1;
...
- (void)_wol_processReadWriteResponseForCharacteristic:(id)a0 isRead:(BOOL)a1 response:(id)a2 error:(id)a3;
...
- (void)_writeCharacteristicValues:(id)a0 hapAccessory:(id)a1 source:(unsigned long long)a2 biomeSource:(unsigned long long)a3 message:(id)a4 logEvent:(id)a5 completionHandler:(id /* block */)a6;
- (void)_writeCharacteristicValues:(id)a0 localOperationRequired:(BOOL)a1 source:(unsigned long long)a2 biomeSource:(unsigned long long)a3 message:(id)a4 completionHandler:(id /* block */)a5 logEvent:(id)a6 errorBlock:(id /* block */)a7;
...
- (BOOL)accesorySupportsWakeWithSystemOn:(id)a0;
...
- (BOOL)canDarkPollForErrorCode:(long long)a0;
- (BOOL)canDarkPollForOperation:(long long)a0 characteristicType:(id)a1;
...
- (void)cancelPowerOn;
- (id)changeThresholdForCharacteristic:(id)a0 changeThresholds:(id)a1;
...
- (id)climateMessageBindingForMessage:(id)a0;
...
- (void)configureAsValenciaThermostatWithCompletionHandler:(id /* block */)a0;
...
- (void)createAndRunTransactionForLastDarkPollDate:(id)a0;
...
- (long long)currentMediaPrivilegeValue;
- (BOOL)custom1WoBLE;
- (id)dataFromAttributeReport:(id)a0;
- (void)deregisterFromSessionRestore:(id)a0;
- (long long)determineRetryStatusForOriginalError:(id)a0 retryError:(id)a1 originalResponses:(id)a2 retryResponses:(id)a3 tuplesNeedingRetry:(id)a4;
...
- (void)enableBroadcastNotifications:(BOOL)a0 hapAccessory:(id)a1 forCharacteristics:(id)a2;
...
- (void)evaluateSupportsAdaptiveTemperatureAutomations:(id /* block */)a0;
- (void)evaluateSupportsCleanEnergyAutomation:(id /* block */)a0;
...
- (long long)getSuspendedErrorFromRemote:(BOOL)a0;
...
- (void)handleAccessoryHasOnboardedForAdaptiveTemperatureAutomationsMessage:(id)a0;
- (void)handleAccessoryHasOnboardedForCleanEnergyAutomationMessage:(id)a0;
- (void)handleAccessoryIsAllowedToOnboardForAdaptiveTemperatureAutomations;
...
- (void)handleAdaptiveTemperatureDriverSettingsChanged:(id)a0;
...
- (void)handleCharacteristicChangeNotification:(id)a0;
- (void)handleCharacteristicEventReportMessage:(id)a0;
- (void)handleCharacteristicsChangedNotification:(id)a0;
- (void)handleChipAccessoryServerConfiguredNotification:(id)a0;
- (void)handleClearCredentialMessage:(id)a0;
- (void)handleClearUserMessage:(id)a0;
- (void)handleColorControlAttributeReport:(id)a0;
- (BOOL)handleDarkPollRequestToPerformOperation:(long long)a0 characteristic:(id)a1 error:(id)a2 operationBlock:(id /* block */)a3 errorBlock:(id /* block */)a4;
- (BOOL)handleDarkPollRequestWithOverride:(BOOL)a0;
- (void)handleEventReport:(id)a0 dictionary:(id)a1 flow:(id)a2 hapAccessory:(id)a3;
- (void)handleFetchAdaptiveThermostatDriverSettingsMessage:(id)a0;
- (void)handleFetchThermostatSleepScheduleMessage:(id)a0;
...
- (void)handleMatterAttributeChanged:(id)a0;
...
- (void)handleRawEventReportDictionary:(id)a0 flow:(id)a1 hapAccessory:(id)a2;
...
- (void)handleSetAdaptiveThermostatDriverMessage:(id)a0;
- (void)handleSetHasOnboardedForNaturalLighting:(id)a0;
- (void)handleSetStartUpColorTemperature:(id)a0;
- (void)handleSetThermostatSleepScheduleMessage:(id)a0;
- (void)handleSleepScheduleRulesUpdated:(id)a0;
- (void)handleUnexpectedTCPDisconnect;
...
- (void)handleUpdatedMediaPeerToPeerEnabled:(BOOL)a0;
...
- (void)handleValenciaAccessoryBecameReachable;
- (void)handleValenciaTimerFiredWithNotification:(id)a0;
...
- (void)homeActivityStateManager:(id)a0 didMoveToState:(id)a1;
- (id)initWithTransaction:(id)a0 home:(id)a1;
- (id)initWithTransaction:(id)a0 home:(id)a1 dataSource:(id)a2;
- (void)initializeBTLEScan;
- (void)initiateScan:(id /* block */)a0;
- (BOOL)isAdaptiveTemperatureAutomationsEnabled;
- (BOOL)isBLESecureSessionEstablished;
- (BOOL)isConfiguredAsValenciaThermostat;
...
- (BOOL)matterDeviceSupportsValencia;
- (void)maybeCommissionToThreadNetworkWithCompletion:(id /* block */)a0;
- (id)mergeNewResponses:(id)a0 withOldResponses:(id)a1;
- (id)messageBindingForMessage:(id)a0;
...
- (BOOL)needsRetryForError:(id)a0;
- (void)notifyClientsOfTargetControlSupportUpdate;
- (void)notifyClientsOfUpdatedAccessoryControllableValue;
- (void)notifyClientsOfUpdatedAdaptiveTemperatureAutomations:(BOOL)a0;
- (void)notifyClientsOfUpdatedCleanEnergyAutomations:(BOOL)a0;
...
- (void)profile:(id)a0 didUpdateWoWLANInfos:(id)a1 darkPollMinimumInterval:(id)a2;
...
- (void)registerForClimateMessages;
...
- (id)retryErrorFromOverallError:(id)a0 responses:(id)a1;
...
- (void)sendMessageWhenValueChangesWithRequiresThreadRouter:(BOOL)a0 cause:(id)a1;
...
- (void)setSuspendedState:(unsigned long long)a0 shouldNotify:(BOOL)a1 saveToBackingStore:(BOOL)a2;
...
- (void)startObservingClimateNotifications;
- (void)startReachabilityCheck;
- (void)stopObservingClimateNotifications;
- (void)stopReachabilityCheck;
- (unsigned long long)supportedTransports;
- (BOOL)supportsAccessCodesForUser:(id)a0;
- (BOOL)supportsClimateAutomations;
...
- (BOOL)supportsPresenceDetectionViaMatter;
...
- (id)transportReports;
- (id)tuplesNeedingRetry:(id)a0 withOverallError:(id)a1;
...
- (void)writeCharacteristicValues:(id)a0 source:(unsigned long long)a1 biomeSource:(unsigned long long)a2 message:(id)a3 queue:(id)a4 logEvent:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)writeValue:(id)a0 toCharacteristic:(id)a1 queue:(id)a2 source:(unsigned long long)a3 completion:(id /* block */)a4;
