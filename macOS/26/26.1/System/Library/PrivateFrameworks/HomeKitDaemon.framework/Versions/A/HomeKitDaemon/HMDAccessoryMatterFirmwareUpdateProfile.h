...
@property (nonatomic) BOOL wasPreviousStateInstalling;
...
- (void)_processIdleStateWithCharacteristic:(id)a0;
...
- (void)handleDisplayableFirmwareVersionUpdatedNotification:(id)a0;
