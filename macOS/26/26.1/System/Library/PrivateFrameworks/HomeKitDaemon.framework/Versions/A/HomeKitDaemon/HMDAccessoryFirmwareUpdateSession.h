...
- (BOOL)_isAccessoryVersionInSyncWithAssetVersion:(id)a0 matterFirmwareRevisionNumber:(id)a1 assetVersionString:(id)a2 matterFirmwareRevisionString:(id)a3;
- (BOOL)_isMatterFirmwareVersionMatchingOrNewerThanUARP:(id)a0 matterFirmwareRevisionNumber:(id)a1 uarpAccessoryVersion:(id)a2;
...
- (BOOL)_shouldUpdateUarpAccessoryVersion:(id)a0 matterFirmwareRevisionNumber:(id)a1 assetVersionString:(id)a2 matterFirmwareRevisionString:(id)a3 uarpAccessoryVersion:(id)a4;
- (void)_stagingFailed;
