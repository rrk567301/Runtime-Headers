...
- (id)initWithSessionID:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 supportedConfigCache:(id)a6 streamSession:(id)a7 accessoryCommunicator:(id)a8 isRelayed:(BOOL)a9;
