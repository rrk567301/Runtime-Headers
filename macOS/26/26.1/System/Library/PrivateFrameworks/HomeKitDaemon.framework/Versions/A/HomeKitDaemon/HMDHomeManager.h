...
- (id)initWithMessageDispatcher:(id)a0 accessoryBrowser:(id)a1 messageFilterChain:(id)a2 homeData:(id)a3 localDataDecryptionFailed:(BOOL)a4 identityRegistry:(id)a5 accountRegistry:(id)a6 metricsManager:(id)a7 darwinNotificationProvider:(id)a8 notificationCenter:(id)a9 dataSource:(id)a10 appleAccountManager:(id)a11 remoteAccountManager:(id)a12 userDefaults:(id)a13 hmdUserDefaults:(id)a14 biomeEventManager:(id)a15 logEventSubmitter:(id)a16 widgetConfigurationReader:(id)a17 configuringStateController:(id)a18 diagnosticInfoController:(id)a19 currentAccessorySetupMetricDispatcher:(id)a20 uncommittedTransactions:(id)a21 featuresDataSource:(id)a22;
