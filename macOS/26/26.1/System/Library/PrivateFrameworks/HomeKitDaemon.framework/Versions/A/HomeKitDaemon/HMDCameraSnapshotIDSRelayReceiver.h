...
- (id)initWithSessionID:(id)a0 logIdentifier:(id)a1 workQueue:(id)a2 idsStreamService:(id)a3 machOUUID:(id)a4 sessionInviterDeviceVerifier:(id)a5 delegate:(id)a6;
- (id)initWithSessionID:(id)a0 logIdentifier:(id)a1 workQueue:(id)a2 machOUUID:(id)a3 sessionInviterDeviceVerifier:(id)a4 delegate:(id)a5;
