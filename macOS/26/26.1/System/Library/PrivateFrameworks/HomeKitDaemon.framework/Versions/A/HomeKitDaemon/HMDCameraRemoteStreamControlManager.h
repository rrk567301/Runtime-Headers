...
- (id)initWithSessionID:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 profileUniqueIdentifier:(id)a6 residentMessageHandler:(id)a7 streamSession:(id)a8 isRelayed:(BOOL)a9;
