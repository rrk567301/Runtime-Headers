...
@protocol OS_dispatch_queue, HMDAccountManager, HMDFeaturesDataSource, HMDCommunicationTrustHandlerProtocol, NSCopying;
...
@property (readonly, copy) HMDAccountHandle *primaryDisplayHandle;
...
- (id)shortDescription;
- (void)isTrustedPersonWithCompletion:(id /* block */)a0;
- (void)addHandle:(id)a0;
- (id)_primaryHandleForDisplay:(BOOL)a0;
...
- (id)initWithIdentifier:(id)a0 handles:(id)a1 devices:(id)a2 featuresDataSource:(id)a3 communicationTrustHandler:(id)a4;
- (void).cxx_destruct;
