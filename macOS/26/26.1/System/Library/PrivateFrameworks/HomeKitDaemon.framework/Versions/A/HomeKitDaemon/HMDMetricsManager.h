...
@protocol HMDMetricsDeviceStateProvider, HMMLogEventDispatching, HMDUserNotificationCenterSettingsProviding, HMMRadarInitiating, HMDEWSLogging, OS_dispatch_queue, HMDMetricsManagerSwiftData, HMMUptimeProvider, HMMLogEventSubmitting;

@interface HMDMetricsManager : NSObject <HMFMessageReceiver, HMMDailyTaskRunner, HMFTimerDelegate, HMMLogEventDispatchingDataSource, HMDCoreAnalyticsLogEventObserverDelegateDataSource, HMDHouseholdMetricsDataSource, HMDCurrentResidentDeviceDataSource, HMDLogEventAnalyzerDataSource, HMDHH2AutoMigrationEligibilityLogEventSubmitterDataSource, HMDConfigurationLogEventWidgetDataSource> {
