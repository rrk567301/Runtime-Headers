...
- (void)_xpc_dataFromProofreadingReviewOfString:(id)a0 language:(id)a1 offset:(unsigned long long)a2 optionsData:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_reviewString:(id)a0 language:(id)a1 offset:(unsigned long long)a2 options:(id)a3 completionHandler:(id /* block */)a4;
- (id)_timeoutQueue;
