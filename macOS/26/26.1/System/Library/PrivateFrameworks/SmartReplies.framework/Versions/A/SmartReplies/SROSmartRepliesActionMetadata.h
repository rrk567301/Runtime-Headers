...
- (void).cxx_destruct;
- (id)initWithType:(unsigned long long)a0 title:(id)a1 attribution:(id)a2 stringRepresentation:(id)a3 date:(id)a4 hasRichActionType:(BOOL)a5 url:(id)a6 locationLatitude:(double)a7 locationLongitude:(double)a8 imageName:(id)a9 attributionSource:(unsigned long long)a10 currencyAmount:(double)a11 currencyCode:(id)a12;
