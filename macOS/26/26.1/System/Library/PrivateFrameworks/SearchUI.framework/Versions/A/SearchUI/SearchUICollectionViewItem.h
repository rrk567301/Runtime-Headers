@class SearchUIRowModel, SearchUICollectionViewItemView, NSView, TLKProminenceView, SearchUISeparatorView, NSString;
...
@property (retain) TLKProminenceView *unempasizedSelectionHaloView;
