...
@property (nonatomic) BOOL fileProviderURLFetched;
...
@property (readonly, nonatomic) BOOL hasGridStyling;
...
@property (readonly, nonatomic) BOOL adjustMarginsForConcentricity;
...
@property (nonatomic) BOOL isBrowseSection;
@property (nonatomic) BOOL allowAdjustmentsForConcentricity;
