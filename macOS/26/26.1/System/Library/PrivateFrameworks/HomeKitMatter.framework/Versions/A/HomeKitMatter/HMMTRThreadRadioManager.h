...
- (void)_connectToAccessoryWithExtendedMACAddress:(id)a0 forRetry:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)connectToWEDAccessory:(id)a0 completion:(id /* block */)a1;
- (void)disconnectFromWEDAccessory:(id)a0 completion:(id /* block */)a1;
...
- (void)startThreadRadioForSystemCommissionerFabricUUID:(id)a0 completion:(id /* block */)a1;
