@class HMMTRControllerWrapper, MTRDevice, NSDictionary, HMMTRTimeBasedCounter, NSMutableArray, HMMTRMetricBundle, HMMTROTAAnnounceTimer, HMMTRAccessoryReachabilityManager, HMMTRFirmwareUpdateStatus, HMMTRSyncClusterDoorLock, HMMTRDuration, NSData, MTRCommissioneeInfo, HMMTROTAApplyUpdateTimer, HMFActivity, HMMTRFabric, NSNumber, NSArray, HMMTRAccessoryPairingEndContext, HMMTRAccessoryServerBrowser, HMMTROTAApplyUpdateRequestTimer, NSMutableDictionary, MTRDeviceController, HMMTRPairing, NSString, MTRSetupPayload, NSError, HMMTRHAPEnumerator, HMMTRAttributeReportDistributor, HAPAccessory, NSHashTable, HMFTimer, NSUUID, NSFileHandle, HMFFuture;
...
@property (nonatomic) BOOL commissionCompletePending;
...
- (void)_controller:(id)a0 commissioningAndPairedNodeRecoveryComplete:(id)a1 nodeID:(id)a2 abstractMetrics:(id)a3;
