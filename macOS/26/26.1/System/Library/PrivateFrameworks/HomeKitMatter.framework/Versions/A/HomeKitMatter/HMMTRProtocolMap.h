...
+ (id)mapChangeIndicationToFilterChangeIndication:(id)a0;
...
+ (id)mapSensorFaultToStatusActive:(id)a0;
...
- (id)primaryHAPServiceAmongServices:(id)a0;
...
- (id)_chipClusterFunctionNameForOperationType:(unsigned long long)a0 operationDictionary:(id)a1 value:(id)a2 forMTRCluster:(BOOL)a3 forHMMTRCluster:(BOOL)a4;
...
- (id)rawPlistAtKey:(id)a0;
- (unsigned int)rawPlistOffsetForKey:(id)a0;
...
- (id)retrieveHAPToCHIPClusterMapping:(id)a0;
