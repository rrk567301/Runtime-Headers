@class ATXRSFilter, BMBiomeScheduler, BPSSink, _PASSimpleCoalescingTimer, NSObject, LNMetadataProvider, ATXRSRelevanceMonitor, ATXWidgetSuggestionAbuseGuard, ATXWidgetDescriptorCache, ATXClientModelSuggestionReceiver, NSString, ATXInformationFeatureWeights, CHSWidgetRelevanceService, ATXInformationFeaturizer, ATXInfoToBlendingConfidenceMapper, ATXInformationDescendingStartDateRanker;
...
- (id)initWithDescriptorCache:(id)a0 relevanceMonitor:(id)a1 filter:(id)a2 abuseGuard:(id)a3 featurizer:(id)a4 featureWeights:(id)a5 ranker:(id)a6 confidenceMapper:(id)a7 suggestionReceiver:(id)a8 metadataProvider:(id)a9 widgetRelevanceService:(id)a10;
