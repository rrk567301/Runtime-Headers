...
+ (void)_predictNextAppLaunchEmbedding:(id)a0 into:(float *)a1 launchSequence:(id)a2;
...
- (void)setZeroValuesForModeEntityFeatures:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[828]; float x3; BOOL x4; BOOL x5; } *)a0;
- (void)setDistributionBasedScoreInputsForTimeAndDay:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[828]; float x3; BOOL x4; BOOL x5; } *)a0 forBundleId:(id)a1 withTimeOfDayHistogram:(id)a2 withDayOfWeekHistogram:(id)a3;
...
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct ATXPredictionItem *x2; })evaluateFeaturesForApps:(id)a0 clipBundleIdsToRank:(id)a1 consumerSubType:(unsigned char)a2 intent:(id)a3 scoreLogger:(id)a4 context:(id)a5 featureCache:(id)a6;
- (void)setDistributionBasedScoreInputsForItem:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[828]; float x3; BOOL x4; BOOL x5; } *)a0 withGeoHashResolution:(unsigned long long)a1 withGeoHashLaunchCounts:(id)a2;
- (void).cxx_destruct;
- (void)setModeAffinityScores:(struct ATXPredictionItem { id x0; unsigned long long x1; float x2[828]; float x3; BOOL x4; BOOL x5; } *)a0 appModeEntityScores:(id)a1;
- (id)initWithDayZeroParameters:(id)a0 dayZeroIntentParameters:(id)a1 feedback:(id)a2 appLaunchHistogramManager:(id)a3 appLaunchSequenceManager:(id)a4 appLaunchLocation:(id)a5 appInstallMontior:(id)a6 mediaApplications:(id)a7 appDailyDose:(id)a8 globalAppScorePredictor:(id)a9 globalSmartSuppression:(id)a10 appInfoManager:(id)a11 magicalMomentsUpdateMonitor:(id)a12 heroAppPredictions:(id)a13 appIconState:(id)a14 appLaunchMicroLocation:(id)a15 notificationManager:(id)a16;
- (id)init;
