@class MUPlaceActionManager, MUPlaceViewControllerConfiguration, MKMapItemIdentifier, NSString, _MKPlaceViewController, MUPlaceCallToActionAppearance, MUPlaceCardAnalyticsController, GEOWalkingOptions, NSArray, GEOTransitOptions, MUPlaceInlineMapSectionController, _MKPlaceActionButtonController, MUTimeExpirableLRUCache, MKPlaceActionEnvironment, GEOCyclingOptions, MKETAProvider, NSLayoutConstraint, MUScrollViewImpressionsCalculator, NSView, CLLocation, MUContactStore, CNContact, MUPlaceItemActionDataProvider, GEOAutomobileOptions, NSUUID, CALayer, MKMapItem;
@protocol MUPlaceViewControllerDelegate, MULibraryAccessProviding, _MKPlaceItem, MUPlaceViewControllerMapsAppDelegate, MUPlaceViewControllerFeedbackDelegate, MUDeviceProvider, MUContentStackViewProtocol;

@interface MUPlaceViewController : _MKUIViewController <_MKPlaceViewControllerDelegate, _MKPlaceViewControllerFeedbackDelegate, _MKPlaceViewControllerFeedbackDelegate, MKETAProviderDelegate, MKETAProviderObserver, MKPlaceCardActionControllerDelegate, MUContactStoreObserver, MUPlaceCardAnalyticsProvider, MUPlaceSectionControllerDelegate, MUVisibleItemsProvider, _MKPlaceCardConforming, MUPlaceCardContentProtocol> {
    BOOL _showNewUI;
    _MKPlaceViewController *_legacyPlacecard;
    NSView<MUContentStackViewProtocol> *_contentStackView;
...
@property (readonly, nonatomic) BOOL isFlexiblePlaceCardEnabled;
...
@property (nonatomic) BOOL placeHasRating;
@property (nonatomic) BOOL placeInFavoritesGuide;
...
- (id)_actionBarSectionControllerForAvailability:(id)a0 moduleConfiguration:(id)a1;
...
- (void)_handleMapsExtension:(id)a0 usingAppStoreApp:(id)a1 parameters:(id)a2;
...
- (void)_launchAttributionURLs:(id)a0 withAttribution:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)_unifiedActionRowSectionControllerForAvailability:(id)a0 buttonModuleConfiguration:(id)a1;
...
- (void)_updateWebPlacecardForSubmissionStatusChange:(id)a0 userRatings:(id)a1;
- (id)_venueInfoSectionControllerForAvailability:(id)a0;
- (id)_webBasedPlacecardViewControllerForAvailability:(id)a0;
...
- (void)handleMapsExtension:(id)a0 usingAppStoreApp:(id)a1 options:(id)a2 parameters:(id)a3;
...
- (BOOL)placeSectionControllerShouldLayoutSubviews:(id)a0;
- (void)requestHostToLogFeedbackTypeIfNeeded:(int)a0;
- (void)resetAnalyticsState;
- (void)setMapItem:(id)a0 contact:(id)a1;
- (id)unifiedActionRowConfigurationForAvailability:(id)a0 buttonModuleConfiguration:(id)a1;
