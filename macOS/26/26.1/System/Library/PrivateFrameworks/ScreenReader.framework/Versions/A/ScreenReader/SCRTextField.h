...
@property (nonatomic) double _lastSpokenContentChangeTime;
@property (nonatomic) BOOL isStatic;
@property (nonatomic) BOOL isSearchField;
@property (nonatomic) BOOL isSecureTextField;
@property (nonatomic) BOOL treatContentChangeAsStatusChange;
...
- (BOOL)addTextSelectionDescriptionToRequest:(id)a0 braille:(BOOL)a1;
