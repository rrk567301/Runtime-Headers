@class NSLock, SCRVisualsCaptionWindow, NSXPCConnection, SCRVisualsHUDWindow, SCRVisualsRemoteDelegate, SCRFocusCursorDrawingOptions, SCRVisualsRotorWindow, SCRVisualsPreferences, SCRVisualsSearchWindow, SCRVisualsBrailleWindow, SCRVisualsOverlayWindow, SCRVisualsMenuWindow;
...
@property (retain, nonatomic) NSLock *lastDrawnCursorOptionsLock;
