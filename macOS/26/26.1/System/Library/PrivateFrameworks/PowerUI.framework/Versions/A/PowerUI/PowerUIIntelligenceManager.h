...
- (void)postAnalyticsEventForDynamicRuntimeAllocationWithPredictedDurationMinutes:(long long)a0 andActualDurationMinutes:(long long)a1 andEngagementDecision:(BOOL)a2 andWasWireless:(BOOL)a3 andSPIError:(BOOL)a4;
