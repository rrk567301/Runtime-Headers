...
@property (class, readonly) NSString *quickTimeUserDataMultitrackMemoryMovieType;
...
@property (class, readonly) NSString *quicktimeMetadataFullFrameRatePlaybackIntent;
@property (class, readonly) NSString *quicktimeMetadataSpatialAggressorsSeen;
@property (class, readonly) NSString *quicktimeMetadataSpatialFormatVersion;
@property (class, readonly) NSString *quicktimeMetadataSmartStyleCast;
@property (class, readonly) NSString *quicktimeMetadataFrontAndRearComposition;
@property (class, readonly) NSString *quicktimeMetadataCinematicVideoIntent;
