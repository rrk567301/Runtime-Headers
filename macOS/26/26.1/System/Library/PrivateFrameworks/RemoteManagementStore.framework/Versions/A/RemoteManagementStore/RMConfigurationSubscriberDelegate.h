...
- (void)_sendConfigurationUIForConfigurationReference:(id)a0 visible:(BOOL)a1 configurationUI:(id)a2 configurationUIGroup:(id)a3;
...
- (void)didFetchConfigurationsWithVisibleUIByType:(id)a0 storesByIdentifier:(id)a1 scope:(long long)a2 completionHandler:(id /* block */)a3;
