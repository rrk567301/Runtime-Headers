...
- (void)handleTrustKitDecisioningForSender:(id)a0 service:(id)a1 trustIndicator:(id)a2 messageBody:(id)a3 myReceiverISOCountryCode:(id)a4 containsOneTimeCode:(BOOL)a5 foundChat:(id)a6 fallbackFilterCategory:(long long)a7 fallbackFilterSubCategory:(long long)a8 filteringProcessingBlock:(id /* block */)a9 processDictCompletionBlock:(id /* block */)a10;
