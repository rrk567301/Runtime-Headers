@class IMDChat, NSString, NSDictionary, IMDAccount, IMDServiceSession, NSNumber, NSArray;

@interface IMAcceptChatCommandPipelineParameter : NSObject <IMAcceptChatCommandProcessingParameter, IMFindAccountProcessingParameter, IMMessageFromStorageParameter>
