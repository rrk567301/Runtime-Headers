...
@property (nonatomic) unsigned long long numberOfBouncedMainThreadSaves;
...
- (id)namedStylesForCurrentSelectionAndBIUS:(unsigned long long *)a0 emphasisColorType:(long long *)a1;
...
- (void)setSelectionBIUSStyle:(unsigned long long)a0 toggleOn:(BOOL)a1 onValue:(id)a2;
- (void)setSelectionBIUSStyle:(unsigned long long)a0 toggleOn:(BOOL)a1 onValue:(id)a2 withSelection:(id)a3;
...
- (void)toggleBIUS:(unsigned long long)a0 onValue:(id)a1;
- (void)toggleEmphasis:(id)a0 onValue:(id)a1;
