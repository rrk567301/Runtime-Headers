@class NSViewController, NSError, NSNumber, SCUIInterventionScreenModel;
...
+ (void)askUserForScreenTimePasscodeFrom:(NSViewController *)a0 interventionType:(long long)a1 completionHandler:(void (^)(NSNumber *, NSError *))a2;
+ (void)askUserForScreenTimePasscodeFrom:(NSViewController *)a0 model:(SCUIInterventionScreenModel *)a1 completionHandler:(void (^)(NSNumber *, NSError *))a2;
