...
- (id)initForServiceName:(id)a0 limitType:(unsigned long long)a1 limitSize:(id)a2 qualityType:(unsigned long long)a3 isSticker:(BOOL)a4 lowQualityModeEnabled:(BOOL)a5;
