@class BWNodeConnection, BWFormat, BWMemoryPool, NSMutableDictionary, NSObject, BWPixelBufferPool, BWDataBufferPool, NSMutableArray, BWFormatRequirements, NSString, BWPointCloudFormat, BWNodeOutputMediaProperties, BWVideoFormat, NSArray, BWNodeOutputMediaConfiguration, BWNode;
@protocol OS_dispatch_semaphore, BWNodeOutputConsumer;
