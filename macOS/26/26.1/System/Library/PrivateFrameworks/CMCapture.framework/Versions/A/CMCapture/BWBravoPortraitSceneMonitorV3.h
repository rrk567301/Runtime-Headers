...
@interface BWBravoPortraitSceneMonitorV3 : NSObject <BWPortraitSceneMonitor> {
    ...
    BOOL _canProceedBeforeFocusBecomesStable;
...
- (id)initWithTuningParameters:(id)a0 zoomFactor:(float)a1 portraitAutoSuggestEnabled:(BOOL)a2 shallowDepthOfFieldEnabled:(BOOL)a3 attachDebugFrameStatistics:(BOOL)a4 stageSegmentationMonitoringEnabled:(BOOL)a5;
