@class BWFigVideoCaptureStream, NSMutableDictionary, FigCaptureFrameCounter, NSDictionary, BWStats, BWFigCaptureStream, BWDeferredMetadataCache, NSObject, BWPixelBufferPool, BWMultiStreamCameraSourceNodeConfiguration, BWFigVideoCaptureDevice, NSString, BWDetectedFacesRingBuffer, BWDetectedObjectsInfoRingBuffer, BWMotionDataPreserver, CMIDistortionModel, FigCaptureThermalMonitor, NSArray, FigCaptureGameModeMonitor, BWNodeOutput;
...
@interface BWMultiStreamCameraSourceNode : BWSourceNode <BWFigVideoCaptureDeviceZoomFactorChangedDelegate, BWSecureMetadataOutputConfiguratorDelegate> {
    ...
    BOOL _dynamicAspectRatioChangePending;
    BOOL _dynamicAspectRatioGraphPrepared;
    BOOL _dynamicAspectRatioFirstBufferReceived;
    int _aspectRatio;
    ...
    BOOL _useNondisruptiveSwitchingFormatWithAdditionalOverscanIfAvailable;
...
- (void)activateSecureMetadataOutputConfiguration:(id)a0 forAttachedSesssion:(id)a1;
...
- (void)deactivateSecureMetadataForAttachedSession:(id)a0;
- (void)dealloc;
- (void)setMotionToWakeTargetFrameRate:(float)a0;
