...
@property (readonly, nonatomic) BOOL teleAutoVideoFrameRateAllows24FPS;
@property (readonly, nonatomic) BOOL highPriorityLaunchFromLockScreenSupported;
@property (readonly, nonatomic) BOOL metadataCameraHostingSupported;
...
@property (readonly, nonatomic) BOOL fineGrainThermalMonitoringEnabled;
