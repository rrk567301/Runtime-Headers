@class NSMutableDictionary, FigCaptureMicSourcePipeline, FigCaptureCameraSourcePipeline, NSMutableArray;
...
- (id)metadataSinkPipelineWithSessionID:(id)a0;
- (void)removeCameraSourcePipelineWithSessionID:(id)a0;
- (id)metadataSinkPipelineWithSinkID:(id)a0;
- (void)addMetadataSinkPipeline:(id)a0 sessionID:(id)a1;
...
- (id)cameraSourcePipelineWithSessionID:(id)a0;
...
- (void)removeMetadataSinkPipelineWithSessionID:(id)a0;
...
- (void)addCameraSourcePipeline:(id)a0 sessionID:(id)a1;
