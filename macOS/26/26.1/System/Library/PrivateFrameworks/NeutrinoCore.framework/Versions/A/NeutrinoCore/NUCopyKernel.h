...
+ (void)copyFromTexture:(id)a0 toTexture:(id)a1 atPoint:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a2 withCommandBuffer:(id)a3;
+ (void)copyFromTexture:(id)a0 toTexture:(id)a1 withCommandBuffer:(id)a2;
