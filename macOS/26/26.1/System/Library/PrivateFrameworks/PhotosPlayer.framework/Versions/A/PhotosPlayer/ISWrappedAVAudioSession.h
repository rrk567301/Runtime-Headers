...
+ (id)sharedInstanceWithKind:(long long)a0;
+ (void)sharedInstanceWithKind:(long long)a0 loadHandler:(id /* block */)a1;
+ (id)sharedMemoryPlaybackInstance;
+ (void)sharedMemoryPlaybackInstanceWithLoadHandler:(id /* block */)a0;
