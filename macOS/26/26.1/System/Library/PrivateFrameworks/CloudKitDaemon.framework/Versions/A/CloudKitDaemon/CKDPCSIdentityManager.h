...
+ (id)currentIdentityPublicKeyIDForAccount:(id)a0 serviceName:(id)a1 error:(id *)a2;
+ (BOOL)needsUserKeySyncToPopulateCurrentIdentityForAccount:(id)a0 serviceName:(id)a1;
+ (id)overrideKeys;
