@class REMResolutionTokenMap, NSURL, NSUUID, NSDate, REMCRMergeableStringDocument, REMContactRepresentation, REMUserActivity, NSString, NSSet, REMDisplayDate, NSArray, NSData, REMObjectID, NSDateComponents;
...
@property (nonatomic) BOOL prefersUrgentPresentationStyleForDateAlarms;
...
+ (BOOL)isDate:(id)a0 overdueAtReferenceDate:(id)a1 allDay:(BOOL)a2 floatingDateSecondsFromGMT:(long long)a3 floatingDateTargetTimeZone:(id)a4 showAllDayRemindersAsOverdue:(BOOL)a5 showTimedRemindersAsOverdue:(BOOL)a6;
