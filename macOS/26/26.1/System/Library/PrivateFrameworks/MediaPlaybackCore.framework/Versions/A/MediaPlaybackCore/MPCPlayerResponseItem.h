@class NSString, NSArray, MPNowPlayingInfoAudioFormat, NSDictionary, MPModelGenericObject, MPCPlayerResponseParticipant, MPCPlayerResponse, MPCPlayerAudioFormat, MPCPlayerAudioRoute, NSIndexPath;
