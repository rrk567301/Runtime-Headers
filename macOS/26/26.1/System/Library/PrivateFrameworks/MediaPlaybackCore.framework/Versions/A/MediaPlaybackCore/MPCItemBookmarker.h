...
- (void).cxx_destruct;
- (void)itemDidBecomeCurrent:(id)a0 time:(double)a1 rate:(float)a2;
- (void)itemSmartTransitionDidEnd:(id)a0 time:(double)a1;
...
- (void)itemSmartTransitionWillBeginFrom:(id)a0 outgoingItemAveragePrePivotTransitionRate:(double)a1 time:(double)a2;
- (void)itemTransitionDidReachPivotPoint:(id)a0 to:(id)a1 incomingItemAveragePostPivotTransitionRate:(double)a2 time:(double)a3;
