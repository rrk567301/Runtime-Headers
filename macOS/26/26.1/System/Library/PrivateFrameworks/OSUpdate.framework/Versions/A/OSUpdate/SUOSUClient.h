...
@property BOOL isAutomaticallyInstallBackgroundSecurityImprovementsPreferenceEnabled;
...
@property (readonly) BOOL isAutomaticallyInstallBackgroundSecurityImprovementsPreferenceManaged;
