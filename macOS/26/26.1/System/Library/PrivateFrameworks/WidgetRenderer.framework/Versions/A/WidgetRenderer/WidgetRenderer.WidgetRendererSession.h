@interface WidgetRenderer.WidgetRendererSession : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ environmentModifiers;
    ...
    void /* unknown type, empty encoding */ _catastrophicReloadReason;
    void /* unknown type, empty encoding */ _catastrophicReloadReasonDate;
