@class EMCategory, EMObjectID, EMGeneratedSummary, NSString, ECSubject, EMFollowUp, EFFuture, EMReadLater, NSArray, EMMessageObjectID, NSObject, EMSearchableMessageID, EMMailDropMetadata, UTType, EMMessageRepository, ECMessageFlags, NSUUID, NSDate, NSURL, NSIndexSet, NSNumber;
