...
- (id)initWithSettingName:(id)a0 defaultArray:(id)a1 combineOperator:(long long)a2 maximumCount:(unsigned long long)a3 isPublic:(BOOL)a4 scope:(id)a5 isPrivacySensitive:(BOOL)a6;
