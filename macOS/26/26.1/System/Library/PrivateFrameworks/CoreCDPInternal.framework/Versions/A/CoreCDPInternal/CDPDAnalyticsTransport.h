...
- (void)sanitizeEventForInternalReporting:(id)a0 key:(id)a1 value:(id)a2;
- (void)santizeEventForPendingCFUType:(id)a0 value:(id)a1;
- (BOOL)shouldEnforcePrivacyComplianceForEvent:(id)a0;
- (BOOL)shouldSanitizeEventForInternalReporting:(id)a0;
