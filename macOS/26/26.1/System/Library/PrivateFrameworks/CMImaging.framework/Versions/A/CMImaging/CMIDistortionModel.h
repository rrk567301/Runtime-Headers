...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })adjustCropRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 validCropRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 withGDCParams:(struct { float x0; float x1; float x2[8]; float x3[8]; float x4; } *)a2;
...
- (void /* unknown type, empty encoding */)getValidRadiusAfterGDCInImageCoord;
- (void /* unknown type, empty encoding */)getValidRadiusInImageCoord;
