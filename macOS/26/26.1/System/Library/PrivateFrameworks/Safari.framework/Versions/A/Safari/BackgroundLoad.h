@class NSArray, NSString, NSURL, BrowserViewController, BrowserTabViewItem, NSMutableArray;
...
@property (retain, nonatomic) NSURL *contentRuleListRedirectWebExtensionURL;
