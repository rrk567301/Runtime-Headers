...
- (void)enumerateItemsOnDiskAtURL:(id)a0 detachedRoots:(id)a1 usingFPFS:(BOOL)a2 ioContext:(const struct { id /* block */ x0; unsigned int x1; unsigned int x2; BOOL x3; BOOL x4; BOOL x5; } *)a3 delegate:(id)a4;
