@class NSView, NSObject, NSStackView, FI_TSidebarViewController, FI_TNotificationCenterObserverGlue, FI_TSplitView, FI_TBrowserViewContainerController, NSSplitViewItem;
...
- (void)updateMinimumBrowserItemThickness:(double)a0;
