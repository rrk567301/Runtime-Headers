...
@interface FI_TBaseBrowserViewController : FI_TViewController <NSSharingServiceDelegate, NSTouchBarDelegate, NSDraggingSource, NSMenuItemValidation, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TContextMenuDelegate, TMarkTornDown, TQLPreviewWindowControllerProtocol, TTypeSelectDelegate, TFloatingInputWindowDelegateProtocol, TThumbnailExtractorDelegate> {
    ...
    struct vector<std::shared_ptr<TIconFetcher>, std::allocator<std::shared_ptr<TIconFetcher>>> { void *__begin_; void *__end_; void *__cap_; } _pendingIconFetchers;
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct TFENode *__cap_; } _orderedSelection;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })selectedNodes;
...
- (void)cmdUnpin:(id)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })commandTarget:(SEL)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })commandTarget:(SEL)a0 upTo:(unsigned long long)a1;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })commandValidationTarget:(SEL)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })commandValidationTarget:(SEL)a0 isPartial:(BOOL *)a1;
...
- (struct pair<bool, TFENodeVector> { BOOL x0; struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; } x1; })preCheckFPActionForNodes:(id)a0 allowPartialValidation:(BOOL)a1 forUIElement:(id)a2;
...
- (void)shareNodes:(struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })a0 withSpecificSharingServiceName:(id)a1;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })typeSelectCandidateNodes;
