...
@interface _TtC9Coherence19CRTTMergeableString : NSObject {
    struct vector<Coherence_namespace::TopoSubstring *, std::allocator<Coherence_namespace::TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct TopoSubstring **__cap_; } _orderedSubstrings;
