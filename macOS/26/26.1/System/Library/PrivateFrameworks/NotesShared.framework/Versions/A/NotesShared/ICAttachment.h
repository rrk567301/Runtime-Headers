@class NSURL, ICAttachmentModel, ICSynapseLinkPreviewLoadingOperation, NSDate, NSPredicate, NSDictionary, NSManagedObjectContext, NSString, CKRecordID, NSManagedObjectID, CKRecord, CSSearchableItemAttributeSet, ICNote, NSSet, NSData, ICMedia, ICAttachmentLocation, ICAssetGenerationManager;
...
@property (class, nonatomic) BOOL suppressWritingPaperKitBundles;
...
+ (BOOL)isTypeUTISupportedForWatch:(id)a0;
...
- (BOOL)hasFallbackPDF;
- (BOOL)hasSynapseLink;
- (BOOL)hasUnfetchedAssetForRecordKey:(id)a0;
...
- (BOOL)updateHandwritingSummary:(id)a0;
