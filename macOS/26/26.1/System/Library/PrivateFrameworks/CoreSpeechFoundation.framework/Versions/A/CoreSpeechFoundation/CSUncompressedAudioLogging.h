...
@property (nonatomic) BOOL shouldWriteRpiData;
...
- (id)initWithRequestId:(id)a0 asrId:(id)a1 dictationInteractionId:(id)a2 languageCode:(id)a3 task:(id)a4 isSamplingForDictation:(BOOL)a5 rpiEnabled:(BOOL)a6;
- (id)initWithRequestId:(id)a0 asrId:(id)a1 languageCode:(id)a2 task:(id)a3;
- (id)initWithRequestId:(id)a0 asrId:(id)a1 languageCode:(id)a2 task:(id)a3 rpiEnabled:(BOOL)a4;
- (BOOL)isRPISamplingEnabled;
- (id)samplingString;
- (void)setShouldWriteRPIData:(BOOL)a0;
