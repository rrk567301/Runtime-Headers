@class VKMapCameraController, VKMapCanvas, GEOMapRegion, GEOPOICategoryFilter, VKStateCaptureHandler, VKNotificationObserver, GEOFeatureStyleAttributes, NSString, VKCamera, NSMutableArray, NSArray, VKPolylineOverlay, VKRouteContext, VKMuninCameraController, VKPuckAnimator, VKMetrics, VKNavContext, VKDaVinciCameraController, VKSceneConfiguration, VKLabelMarker, VKTimedAnimation, NSSet, CADisplay, VKARWalkingCameraController, VKNavCameraController, MDARController, VKDeferredCameraController;
...
@interface VKMapView : CALayer {
    ...
    struct unique_ptr<md::MapEngine, md::MapEngineDeleter> { struct MapEngine *__ptr_; } _mapEngine;
    ...
    struct unique_ptr<md::DisplayOptions, std::default_delete<md::DisplayOptions>> { struct DisplayOptions *__ptr_; } _displayOptions;
...
@property (nonatomic, getter=isIncreaseContrastEnabled) BOOL increaseContrastEnabled;
...
@property (nonatomic) BOOL showsPOIUpdates;
@property (nonatomic) BOOL preferStaleTiles;
...
- (void)_configureDynamicFrameRateForCarDisplayConfig:(long long)a0;
