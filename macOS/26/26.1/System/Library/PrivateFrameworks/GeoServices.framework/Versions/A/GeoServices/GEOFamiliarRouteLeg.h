...
@interface GEOFamiliarRouteLeg : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_likelihood : 1; unsigned char has_beginTimestamp : 1; unsigned char has_endTimestamp : 1; unsigned char has_transportType : 1; unsigned char has_usualTraversalTimeSeconds : 1; } _flags;
}
