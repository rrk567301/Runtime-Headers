...
- (void).cxx_destruct;
- (id)init;
- (id)initWithCoordinate:(struct { double x0; double x1; double x2; })a0 angle:(double)a1 road:(id)a2 startCoordinate:(struct { double x0; double x1; double x2; })a3 endCoordinate:(struct { double x0; double x1; double x2; })a4 penalties:(id)a5;
