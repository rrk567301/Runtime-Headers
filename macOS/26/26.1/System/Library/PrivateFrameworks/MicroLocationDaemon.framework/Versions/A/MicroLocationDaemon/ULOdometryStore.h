...
@interface ULOdometryStore : ULStore <ULStoreProtocol> {
    struct vector<ULOdometryDO, std::allocator<ULOdometryDO>> { struct ULOdometryDO *__begin_; struct ULOdometryDO *__end_; struct ULOdometryDO *__cap_; } _dataObjectBuffer;
...
- (struct vector<ULOdometryDO, std::allocator<ULOdometryDO>> { struct ULOdometryDO *x0; struct ULOdometryDO *x1; struct ULOdometryDO *x2; })efficientlyFetchOdometryEntriesWithLOIGroupUUIDs:(struct vector<boost::uuids::uuid, std::allocator<boost::uuids::uuid>> { struct uuid *x0; struct uuid *x1; struct uuid *x2; })a0 odometrySource:(long long)a1 startDate:(id)a2 endDate:(id)a3 fetchLimit:(unsigned long long)a4 newest:(BOOL)a5 ascending:(BOOL)a6;
- (struct vector<ULOdometryDO, std::allocator<ULOdometryDO>> { struct ULOdometryDO *x0; struct ULOdometryDO *x1; struct ULOdometryDO *x2; })fetchAllRecordsWithLimit:(unsigned int)a0;
