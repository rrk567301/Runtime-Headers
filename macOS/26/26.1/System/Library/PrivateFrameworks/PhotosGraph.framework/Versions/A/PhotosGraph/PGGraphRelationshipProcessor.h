@class CLSServiceManager, NSSet, NSMutableDictionary, NSDictionary, PGGraphPersonNodeCollection, NSMutableArray, PGGraphMomentNodeCollection, PGGraph;
...
- (void)enumerateHighRecallInferredRelationshipsExcludingPersonNodes:(id)a0 usingBlock:(id /* block */)a1;
- (void)enumerateInferredRelationshipsUsingBlock:(id /* block */)a0;
- (id)initWithPersonNodes:(id)a0 runOptions:(unsigned long long)a1 serviceManager:(id)a2;
