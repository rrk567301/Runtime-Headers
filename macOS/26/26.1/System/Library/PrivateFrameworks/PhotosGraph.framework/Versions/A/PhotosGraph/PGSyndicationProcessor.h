...
- (void).cxx_destruct;
- (BOOL)processSyndicatedAssetGuestInferenceWithError:(id *)a0 progressReporter:(id)a1;
- (id)initWithWorkingContext:(id)a0;
- (BOOL)processSavedSyndicatedAssetsWithError:(id *)a0 progressReporter:(id)a1;
- (BOOL)processSyndicatedAssetCurationWithError:(id *)a0 progressReporter:(id)a1;
- (BOOL)processSyndicatedAssetRevGeoCodingWithError:(id *)a0 progressReporter:(id)a1;
...
- (BOOL)processSyndicatedAssetGuestInferenceWithError:(id *)a0 progressReporter:(id)a1 shareBackSuggester:(id)a2;
- (id)similarStacker;
