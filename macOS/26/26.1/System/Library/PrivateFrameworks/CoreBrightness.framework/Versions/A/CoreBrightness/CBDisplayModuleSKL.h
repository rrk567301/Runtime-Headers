@class NSMutableDictionary, CBThermalBrightnessCap, NSObject, CBGammaContrastPreservation, CBRampManager, NSMutableArray, CBDynamicSlider, NSString, CBEDR, CBAurora, CBNVRAM, CBAppliedCompensations, AABCHistograms;
...
- (id)initWithBrightnessControl:(id)a0 andQueue:(id)a1 andCBPM:(id)a2;
