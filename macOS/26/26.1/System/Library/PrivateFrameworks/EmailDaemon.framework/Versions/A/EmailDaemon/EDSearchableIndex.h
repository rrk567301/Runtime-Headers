@class EMCoreAnalyticsCollector, NSString, EFStoppableScheduler, NSDate, CSSearchableIndex, EDSearchableIndexState, EDSearchableIndexAnalyticsPersistence, NSSet, NSObject, EFFuture, EFManualCancelationToken, EFObservable;
