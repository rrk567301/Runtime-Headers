...
- (void)_createHelper;
- (id)_extraInfoForThreadObjectIDs:(id)a0 searchInfo:(id)a1 isMove:(BOOL)a2;
...
- (void)collection:(id)a0 didMergeInThreadsForMove:(BOOL)a1 newObjectIDs:(id)a2 existingObjectID:(id)a3 searchInfo:(id)a4 hasChanges:(BOOL *)a5;
