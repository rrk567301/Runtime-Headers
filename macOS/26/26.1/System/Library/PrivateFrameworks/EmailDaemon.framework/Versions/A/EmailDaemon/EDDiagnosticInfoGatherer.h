...
- (void)_copyAndCompressDatabaseIntoDirectoryURL:(id)a0 originalURL:(id)a1 targetName:(id)a2;
- (BOOL)_copyDatabaseFromURL:(id)a0 intoDatabaseAtURL:(id)a1;
- (void)_copyIndexingDiagnosticsDatabaseIntoDirectoryURL:(id)a0 completionPromise:(id)a1;
...
- (void)gatherIndexingDiagnosticsWithRedaction:(long long)a0 completionHandler:(id /* block */)a1;
