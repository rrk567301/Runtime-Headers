...
- (BOOL)addRelayWithParameters:(id)a0 errorStr:(id *)a1;
...
- (BOOL)removeRelayWithParameters:(id)a0 errorStr:(id *)a1;
...
- (BOOL)setHotspotProviderParameters:(id)a0 errorStr:(id *)a1;
...
- (BOOL)setRelayConditionsWithParameters:(id)a0 errorStr:(id *)a1;
...
- (BOOL)unsetHotspotProviderParameters:(id)a0 errorStr:(id *)a1;
...
- (BOOL)unsetRelayConditionsWithParameters:(id)a0 errorStr:(id *)a1;
