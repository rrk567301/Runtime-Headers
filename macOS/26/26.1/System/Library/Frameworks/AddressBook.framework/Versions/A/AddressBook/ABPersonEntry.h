@class NSString, SGRecordId, CNContact, NSDate, NSArray, NSURL;
...
@property (readonly) BOOL isAcceptedIntroduction;
...
+ (id)personEntryForRecord:(id)a0 contact:(id)a1;
...
- (id)initWithRecord:(id)a0 contact:(id)a1 withFactory:(id)a2;
