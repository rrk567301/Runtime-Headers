...
- (void)setAllowsDarkAppearanceContent:(BOOL)a0;
...
- (id)akToolbarView;
- (BOOL)allowsDarkAppearanceContent;
...
- (void)handleAnalysisCompletionOfPage:(id)a0 resultTypes:(unsigned long long)a1;
...
- (BOOL)isDocumentAnalysisEnabled;
...
- (void)pdf_reflectScrolledClipView;
- (void)performBeep;
