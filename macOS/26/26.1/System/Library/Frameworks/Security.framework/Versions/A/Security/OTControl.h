...
- (void)performCKServerUnreadableDataRemoval:(id)a0 isGuitarfish:(BOOL)a1 accountIsW:(BOOL)a2 altDSID:(id)a3 reply:(id /* block */)a4;
...
- (void)resetAndEstablish:(id)a0 resetReason:(long long)a1 idmsTargetContext:(id)a2 idmsCuttlefishPassword:(id)a3 notifyIdMS:(BOOL)a4 accountSettings:(id)a5 isGuitarfish:(BOOL)a6 accountIsW:(BOOL)a7 reply:(id /* block */)a8;
