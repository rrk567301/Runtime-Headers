...
+ (BOOL)clearCliqueFromAccount:(id)a0 error:(id *)a1;
...
+ (BOOL)performCKServerUnreadableDataRemoval:(id)a0 error:(id *)a1;
...
- (BOOL)establish:(id)a0 error:(id *)a1;
...
- (BOOL)resetAndEstablish:(long long)a0 idmsTargetContext:(id)a1 idmsCuttlefishPassword:(id)a2 notifyIdMS:(BOOL)a3 accountSettings:(id)a4 isGuitarfish:(BOOL)a5 accountIsW:(BOOL)a6 altDSID:(id)a7 flowID:(id)a8 deviceSessionID:(id)a9 canSendMetrics:(BOOL)a10 error:(id *)a11;
