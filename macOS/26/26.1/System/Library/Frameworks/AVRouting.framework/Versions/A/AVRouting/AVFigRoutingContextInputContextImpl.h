...
@property (readonly, nonatomic) BOOL canSetInputGain;
...
- (void)_canSetMainVolumeDidChangeForRoutingContextWithID:(id)a0;
...
- (void)_mainVolumeDidChangeForRoutingContextWithID:(id)a0;
- (BOOL)clearUserPreferredInputDevice:(id)a0 error:(id *)a1;
- (id)initWithFigRoutingContext:(struct OpaqueFigRoutingContext { } *)a0 routingContextReplacementBlock:(id /* block */)a1 volumeController:(struct OpaqueFigVolumeControllerState { } *)a2;
