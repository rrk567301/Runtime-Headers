...
@property (readonly, nonatomic, getter=isB768ERoute) BOOL b768ERoute;
@property (readonly, nonatomic, getter=isB768MRoute) BOOL b768MRoute;
@property (readonly, nonatomic, getter=isB768CHERoute) BOOL b768CHERoute;
@property (readonly, nonatomic, getter=isB768CHMRoute) BOOL b768CHMRoute;
@property (readonly, nonatomic, getter=isB735ERoute) BOOL b735ERoute;
@property (readonly, nonatomic, getter=isB735MRoute) BOOL b735MRoute;
...
@property (readonly, nonatomic, getter=isB494BRoute) BOOL b494BRoute;
@property (readonly, nonatomic, getter=isB498Route) BOOL b498Route;
...
@property (readonly, nonatomic, getter=isB465Route) BOOL b465Route;
...
@property (readonly, nonatomic, getter=isVisionRoute) BOOL visionRoute;
