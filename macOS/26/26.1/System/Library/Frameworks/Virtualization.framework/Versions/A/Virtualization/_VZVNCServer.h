...
@interface _VZVNCServer : NSObject <_VZFramebufferObserver> {
    ...
    struct unique_ptr<Vnc::Server, std::default_delete<Vnc::Server>> { struct Server *__ptr_; } _server;
    struct unique_ptr<(anonymous namespace)::ServerDelegate, std::default_delete<(anonymous namespace)::ServerDelegate>> { struct ServerDelegate *__ptr_; } _serverDelegate;
