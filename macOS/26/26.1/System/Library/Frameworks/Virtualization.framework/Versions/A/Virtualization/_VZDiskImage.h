...
@interface _VZDiskImage : NSObject {
    struct Descriptor { struct DiskImageFormat *format; int cache_mode; struct vector<Base::PropertyBag, std::allocator<Base::PropertyBag>> { struct PropertyBag *__begin_; struct PropertyBag *__end_; struct PropertyBag *__cap_; } parameters; BOOL per_io_encrypted; } _descriptor;
