@interface _TtCC7SwiftUI27SwiftUISharingServicePicker13InnerDelegate : NSObject <NSSharingServicePickerDelegate> {
    void /* unknown type, empty encoding */ servicePicker;
}
