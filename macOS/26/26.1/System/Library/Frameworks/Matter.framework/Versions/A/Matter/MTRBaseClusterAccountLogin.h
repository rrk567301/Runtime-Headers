...
- (void)getSetupPINWithParams:(id)a0 completion:(id /* block */)a1;
- (void)getSetupPINWithParams:(id)a0 completionHandler:(id /* block */)a1;
- (id)initWithDevice:(id)a0 endpoint:(unsigned short)a1 queue:(id)a2;
- (void)loginWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)logoutWithParams:(id)a0 completion:(id /* block */)a1;
- (void)logoutWithParams:(id)a0 completionHandler:(id /* block */)a1;
