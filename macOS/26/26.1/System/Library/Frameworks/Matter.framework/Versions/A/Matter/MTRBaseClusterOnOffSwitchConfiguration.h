...
+ (void)readAttributeSwitchActionsWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeSwitchActionsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeSwitchTypeWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeSwitchTypeWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeSwitchActionsWithCompletion:(id /* block */)a0;
- (void)readAttributeSwitchActionsWithCompletionHandler:(id /* block */)a0;
- (void)readAttributeSwitchTypeWithCompletion:(id /* block */)a0;
- (void)readAttributeSwitchTypeWithCompletionHandler:(id /* block */)a0;
...
- (void)subscribeAttributeSwitchActionsWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeSwitchActionsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeSwitchTypeWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeSwitchTypeWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)writeAttributeSwitchActionsWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeSwitchActionsWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSwitchActionsWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeSwitchActionsWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
