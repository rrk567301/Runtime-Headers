@class NSFont, NSString, NSUserInterfaceCompressionOptions, NSSymbolContentTransition, NSImageSymbolConfiguration, NSAttributedString, NSColor, _NSButtonCellAux, NSImage, NSObject;
...
@interface NSButtonCell : NSActionCell <_NSAcceleratorCell> {
    ...
    unsigned char _controlViewIsButton : 1;
    unsigned char _visualProviderNeedsRefresh : 1;
}
...
@property (setter=_setVisualProviderNeedsRefresh:) BOOL _visualProviderNeedsRefresh;
...
@property (readonly) BOOL _showsJiggleImageEffect;
...
@property (readonly) BOOL _hasRolloverAppearance;
@property (copy) NSUserInterfaceCompressionOptions *compressionOptions;
@property (readonly) BOOL _subclassHasVibrancyIncompatibleDrawing;
@property (readonly, nonatomic) NSImage *_currentImage;
@property (readonly) BOOL _shouldDrawWithContentTintColor;
...
- (void)_displayedAlternateAttributedTitleDidChange;
- (void)_displayedAttributedTitleDidChange;
...
- (void)_postTrackedUntilMouseUp:(BOOL)a0;
- (BOOL)_preTrackLocation:(struct CGPoint { double x0; double x1; })a0 hasPressure:(BOOL)a1 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 ofView:(id)a3;
...
- (unsigned long long)_refreshVisualProviderForBezelConfiguration:(id)a0;
