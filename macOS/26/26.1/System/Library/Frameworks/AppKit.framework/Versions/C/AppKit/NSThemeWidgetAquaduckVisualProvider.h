...
@interface NSThemeWidgetAquaduckVisualProvider : NSObject <NSButtonVisualProvider> {
    void /* unknown type, empty encoding */ button;
    void /* unknown type, empty encoding */ $__lazy_storage_$_hostingView;
    void /* unknown type, empty encoding */ currentBezelConfiguration;
...
@property (nonatomic, readonly) BOOL hasDestructiveAppearance;
