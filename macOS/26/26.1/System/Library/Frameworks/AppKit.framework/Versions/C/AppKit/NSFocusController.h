@class NSHashTable, NSString, NSArray, NSScrollView, NSFocusItemCache, UIFocusSystem, NSView, NSWindow;
...
@property long long navigationCommand;
...
@property (readonly, getter=isNavigating) BOOL navigating;
...
- (void)_tryToScrollForUpdateContext:(id)a0;
- (BOOL)_tryToScrollHeading:(unsigned long long)a0;
