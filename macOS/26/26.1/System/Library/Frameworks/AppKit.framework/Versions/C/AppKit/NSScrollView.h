...
@interface NSScrollView : NSView <NSGestureRecognizerDelegate, NSScrollViewSeparatorTrackingAdapter, NSScrollerImpPairDelegate, NSTextFinderBarContainer> {
    ...
    unsigned char _topPocketDisallowsColorSchemeAdaptivity : 1;
    unsigned char _bottomPocketDisallowsColorSchemeAdaptivity : 1;
}
...
@property (class, readonly) Class _contentViewClass;
...
@property (readonly) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } _automaticContentInsets;
...
- (void)_setPocketColor:(id)a0 forEdge:(long long)a1;
- (void)dealloc;
...
- (BOOL)_allowsPocketColorSchemeAdaptivityForEdge:(long long)a0;
...
- (void)_invalidatePocketGeometry;
...
- (void)_setAllowsPocketColorSchemeAdaptivity:(BOOL)a0 forEdge:(long long)a1;
...
- (void)_setPreferredScrollPocketAppearance:(id)a0 forEdge:(long long)a1;
...
- (long long)scrollPocketStyleOnEdge:(long long)a0;
...
- (void)setScrollPocketStyle:(long long)a0 onEdge:(long long)a1;
