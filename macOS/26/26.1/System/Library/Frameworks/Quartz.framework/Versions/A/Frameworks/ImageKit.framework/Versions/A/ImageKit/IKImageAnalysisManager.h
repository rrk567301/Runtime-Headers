@class VKCImageAnalyzer, NSString, NSMutableSet, VKCImageAnalysisOverlayView, NSURL, NSData, IKImageContentView;
...
@property (weak, nonatomic) id<IKImageAnalysisManagerDelegate> delegate;
