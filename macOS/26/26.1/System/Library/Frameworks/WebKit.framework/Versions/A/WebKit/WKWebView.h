@class WKBrowsingContextHandle, NSMenu, WKWebViewConfiguration, _WKSessionState, WKScrollGeometry, NSString, NSVisualEffectView, _WKFrameHandle, STWebpageController, NSArray, NSScrollPocket, NSColor, _WKSpatialBackdropSource, _WKInspector, NSData, STScreenTimeConfigurationObserver, _WKThumbnailView, WKColorExtensionView, WTSession, NSView, _WKWarningView, WKBackForwardList, CALayer, NSURL, NSMapTable, NSTouchBar, WKTextFinderClient;
