...
@interface _WKActivatedElementInfo : NSObject {
    ...
    struct RetainPtr<NSString> { NSString *m_ptr; } _imageMIMEType;
    struct RetainPtr<NSImage> { NSImage *m_ptr; } _cocoaImage;
    BOOL _animatedImage;
    BOOL _isImage;
