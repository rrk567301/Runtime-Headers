@class NSString, WebScrollbarPartAnimation;
...
@interface WebScrollerImpDelegate : NSObject <NSAnimationDelegate, NSScrollerImpDelegate> {
    ...
    struct RetainPtr<WebScrollbarPartAnimation> { WebScrollbarPartAnimation *m_ptr; } _knobAlphaAnimation;
    struct RetainPtr<WebScrollbarPartAnimation> { WebScrollbarPartAnimation *m_ptr; } _trackAlphaAnimation;
    struct RetainPtr<WebScrollbarPartAnimation> { WebScrollbarPartAnimation *m_ptr; } _uiStateTransitionAnimation;
    struct RetainPtr<WebScrollbarPartAnimation> { WebScrollbarPartAnimation *m_ptr; } _expansionTransitionAnimation;
}
