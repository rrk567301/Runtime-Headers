@interface TSTCellUIDRegion : TSCKSosBase {
    struct vector<TSKUIDStructTract, std::allocator<TSKUIDStructTract>> { struct TSKUIDStructTract *__begin_; struct TSKUIDStructTract *__end_; struct TSKUIDStructTract *__cap_; } _cellUIDRangeList;
}
...
- (struct vector<TSKUIDStructTract, std::allocator<TSKUIDStructTract>> { struct TSKUIDStructTract *x0; struct TSKUIDStructTract *x1; struct TSKUIDStructTract *x2; })rowBasedSubRangesOfCellCount:(unsigned long long)a0;
