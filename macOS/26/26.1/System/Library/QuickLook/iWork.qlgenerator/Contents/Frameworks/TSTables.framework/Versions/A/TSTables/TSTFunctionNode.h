...
- (void)addTSTCanvasReferencesToSet:(id)a0 inRangeContext:(unsigned char)a1 withColorHelper:(id)a2 preferringNodesFromStorage:(id)a3 showingSpillRanges:(BOOL)a4 deepSearch:(BOOL)a5 calcEngine:(id)a6 allVisitedNodes:(id)a7;
...
- (void)insertFormulaText:(id)a0 printingOptions:(unsigned int)a1 unwrapped:(BOOL)a2;
