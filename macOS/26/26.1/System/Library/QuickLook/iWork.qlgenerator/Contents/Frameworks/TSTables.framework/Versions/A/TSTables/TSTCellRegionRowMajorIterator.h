...
@interface TSTCellRegionRowMajorIterator : NSObject <TSTCellRegionIterating> {
    struct set<TSUCellRect, TSTCellRangeRowMajorLess, std::allocator<TSUCellRect>> { struct __tree<TSUCellRect, TSTCellRangeRowMajorLess, std::allocator<TSUCellRect>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } mCellRangeSet;
