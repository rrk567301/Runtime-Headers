...
@interface TSPReader : NSObject <TSPObjectDelegate, TSPUnarchiverDelegate> {
    ...
    struct IdentifierMap<TSP::ObjectInfo> { struct __hash_table<std::__hash_value_type<const long long, TSP::ObjectInfo>, std::__unordered_map_hasher<const long long, std::__hash_value_type<const long long, TSP::ObjectInfo>, std::hash<long long>, std::equal_to<const long long>>, std::__unordered_map_equal<const long long, std::__hash_value_type<const long long, TSP::ObjectInfo>, std::equal_to<const long long>, std::hash<long long>>, std::allocator<std::__hash_value_type<const long long, TSP::ObjectInfo>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, TSP::ObjectInfo>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, TSP::ObjectInfo>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<const long long, TSP::ObjectInfo>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<const long long, TSP::ObjectInfo>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _objectInfoMap;
    struct vector<TSP::UnarchiverRepeatedReference, std::allocator<TSP::UnarchiverRepeatedReference>> { struct UnarchiverRepeatedReference *__begin_; struct UnarchiverRepeatedReference *__end_; struct { struct UnarchiverRepeatedReference *__cap_; } ; } _repeatedReferences;
    NSMapTable *_objects;
    NSObject<OS_dispatch_queue> *_objectsToModifyQueue;
    NSHashTable *_objectsToModify;
    struct { unsigned char didFinishResolvingReferences : 1; unsigned char needsUpgrade : 1; unsigned char hasDocumentVersionUUID : 1; unsigned char sourceType : 3; unsigned char isCrossDocumentPaste : 1; unsigned char isCrossAppPaste : 1; unsigned char ignoreDataReferenceCountValidationWhileReading : 1; unsigned char delegateRespondsToDidResetObjectIdentifierForObject : 1; unsigned char delegateRespondsToDidResetObjectUUID : 1; unsigned char delegateRespondsToDidUnarchiveObject : 1; } _flags;
}
...
- (BOOL)setObject:(id)a0 forIdentifier:(long long)a1;
