@interface GameCenterUI.GameCenterSettings : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ _safetyLinkURL;
    void /* unknown type, empty encoding */ _localPlayer;
    void /* unknown type, empty encoding */ _profilePrivacy;
    void /* unknown type, empty encoding */ _playerAgeCategory;
    void /* unknown type, empty encoding */ bag;
    void /* unknown type, empty encoding */ _resetAnalyticsIdentifierState;
    void /* unknown type, empty encoding */ scrollObservation;
    void /* unknown type, empty encoding */ minNicknameLength;
    void /* unknown type, empty encoding */ maxNicknameLength;
    void /* unknown type, empty encoding */ _privacySelectionState;
}
