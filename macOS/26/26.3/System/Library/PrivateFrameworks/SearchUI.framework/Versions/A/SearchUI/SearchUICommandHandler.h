@class NSMenu, NSString, NSArray, SFImage, SearchUIRowModel, SFCommand, SearchUISectionModel, SFButtonItem, NSViewController, SearchUICommandEnvironment, SFPunchout;
...
@property (readonly) BOOL supportsOpen;
...
+ (id)generateHandlerForCommand:(id)a0 environment:(id)a1;
