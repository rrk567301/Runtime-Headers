...
@interface AskTo.ATQuestion : NSObject <NSSecureCoding> {
    ...
    void /* unknown type, empty encoding */ askToTopicMetadata;
    ...
    void /* function */ responseUIExtensionBundleIdentifier;
    ...
    void /* unknown type, empty encoding */ requiredRegistrationCapabilities;
}
