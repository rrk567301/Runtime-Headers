...
+ (struct unique_ptr<sirinluinternalnlv4_parser::NLv4ParserRequest, std::default_delete<sirinluinternalnlv4_parser::NLv4ParserRequest>> { struct { struct NLv4ParserRequest *x0; } x0; })buildNLv4ProtoRequest:(id)a0;
