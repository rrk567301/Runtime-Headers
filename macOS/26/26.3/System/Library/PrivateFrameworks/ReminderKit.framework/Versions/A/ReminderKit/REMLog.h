...
@property (class, readonly, nonatomic) NSObject<OS_os_log> *suggestedAttributesAutoTrainer;
...
@property (class, readonly, nonatomic) NSObject<OS_os_log> *intelligentGrocery;
@property (class, readonly, nonatomic) NSObject<OS_os_log> *operationQueue;
...
@property (class, readonly, nonatomic) NSObject<OS_os_log> *appIntents;
...
@property (class, readonly, nonatomic) NSObject<OS_os_log> *autoCategorization;
@property (class, readonly, nonatomic) NSObject<OS_os_log> *intelligentReminderExtraction;
@property (class, readonly, nonatomic) NSObject<OS_os_log> *widget;
@property (class, readonly, nonatomic) NSObject<OS_os_log> *urgentAlarm;
