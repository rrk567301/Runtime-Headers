...
- (struct vector<float, std::allocator<float>> { float *x0; float *x1; struct { float *x0; } x2; })getTokenScoresfromScoreTensor:(id)a0 intentIndex:(int)a1 tokens:(id)a2 subtokenLenForTokens:(id)a3 subtokens:(id)a4 scoreFromSubtokenScores:(id /* block */)a5;
