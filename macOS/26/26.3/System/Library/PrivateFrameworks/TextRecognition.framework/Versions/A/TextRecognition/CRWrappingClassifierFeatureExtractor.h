...
+ (void)_extractLocaleFeaturesTo:(void *)a0 locale:(id)a1;
+ (id)_tokenizeString:(id)a0 usingWordUnits:(BOOL)a1 excludeWhitespace:(BOOL)a2;
+ (id)evaluationResultForTextFeature:(id)a0 withLastFeature:(id)a1 locale:(id)a2 imageSize:(struct CGSize { double x0; double x1; })a3;
...
+ (struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; })extractFeatureVectorForLocale:(id)a0 string1:(id)a1 string2:(id)a2 evaluation:(id)a3 imageSize:(struct CGSize { double x0; double x1; })a4;
