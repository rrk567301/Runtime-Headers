...
@interface CRCTCCVNLPOrientationDecoder : NSObject <CRTextDecoding> {
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; struct { unsigned long long *__cap_; } ; } _spaceLabels;
}
...
- (struct vector<CoreRecognition::decoder::ActivationMatrix, std::allocator<CoreRecognition::decoder::ActivationMatrix>> { struct ActivationMatrix *x0; struct ActivationMatrix *x1; struct { struct ActivationMatrix *x0; } x2; })_buildModernizedActivationMatrices:(id)a0;
