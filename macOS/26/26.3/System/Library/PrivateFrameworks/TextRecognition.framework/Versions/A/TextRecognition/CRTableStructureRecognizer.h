...
@interface CRTableStructureRecognizer : NSObject {
    struct unique_ptr<CoreRecognition::EspressoModelWrapper, std::default_delete<CoreRecognition::EspressoModelWrapper>> { struct { struct EspressoModelWrapper *__ptr_; } ; } _encoderModel;
    struct unique_ptr<CoreRecognition::EspressoModelWrapper, std::default_delete<CoreRecognition::EspressoModelWrapper>> { struct { struct EspressoModelWrapper *__ptr_; } ; } _decoderModel;
    BOOL _modelsLoaded;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)alignResult:(struct CRTableStructureRecognizerResultParsed { unsigned long long x0; unsigned long long x1; BOOL x2; struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; } x3; struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; } x4; struct vector<CRTableStructureMerge, std::allocator<CRTableStructureMerge>> { struct CRTableStructureMerge *x0; struct CRTableStructureMerge *x1; struct { struct CRTableStructureMerge *x0; } x2; } x5; })a0 lines:(id)a1 lineIndexMap:(struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; struct { unsigned long long *x0; } x2; })a2;
...
- (struct vector<float, std::allocator<float>> { float *x0; float *x1; struct { float *x0; } x2; })normalizedLineRegions:(id)a0 numConfigurationRegions:(long long)a1 usingMinMaxNorm:(BOOL)a2;
- (struct CRTableStructureRecognizerResultParsed { unsigned long long x0; unsigned long long x1; BOOL x2; struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; } x3; struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; } x4; struct vector<CRTableStructureMerge, std::allocator<CRTableStructureMerge>> { struct CRTableStructureMerge *x0; struct CRTableStructureMerge *x1; struct { struct CRTableStructureMerge *x0; } x2; } x5; })parseResult:(id)a0;
- (BOOL)preheatWithError:(id *)a0;
- (struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; })readBinValuesStartingAtIndex:(int *)a0 tokenIndexes:(struct vector<int, std::allocator<int>> { int *x0; int *x1; struct { int *x0; } x2; })a1;
