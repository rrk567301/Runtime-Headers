...
+ (id)_removeStoreForNamespace:(id)a0 accountID:(id)a1 bag:(id)a2;
+ (id)_setConsumerIdentifier:(id)a0 forKey:(id)a1 inNamespace:(id)a2 accountID:(id)a3 bag:(id)a4 at:(id)a5 serverProvidedAt:(id)a6 skipSync:(BOOL)a7 linkedKey:(id)a8 linkedNamespace:(id)a9;
...
+ (id)_identifierInfoForKey:(id)a0 storeInfo:(id)a1 inDatabase:(id)a2 setValue:(id)a3 needsToSync:(BOOL *)a4 serverProvidedAt:(id)a5 resetInterval:(double)a6 valueDidChange:(BOOL *)a7 error:(id *)a8;
...
+ (id)_setIdentifier:(id)a0 withStartedDate:(id)a1 forKey:(id)a2 database:(id)a3 account:(id)a4 clientInfo:(id)a5 domain:(id)a6 resetInterval:(double)a7 serverProvidedAt:(id)a8 skipSync:(BOOL)a9 linkedClientInfo:(id)a10 linkedDomain:(id)a11 linkedResetInterval:(double)a12 linkedKey:(id)a13;
