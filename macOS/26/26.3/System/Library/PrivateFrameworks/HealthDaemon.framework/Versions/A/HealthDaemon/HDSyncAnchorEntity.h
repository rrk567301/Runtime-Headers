...
+ (long long)minimumFrozenAnchorInEpochs:(id)a0 store:(id)a1 entityIdentifier:(id)a2 profile:(id)a3 error:(id *)a4;
...
+ (id)unitTest_predicateForReceived:(long long)a0;
+ (id)unitTest_predicateForType:(long long)a0;
