...
@interface MFIMAPAccount : MFRemoteStoreAccount <MCDiagnosticsLoggable, IMAPAccount> {
...
- (id)_diagnosticStringForStore:(id)a0;
- (id)_dictionaryRepresentationForCounts:(id)a0;
