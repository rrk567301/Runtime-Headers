...
- (void)addTwoWayAllocation:(id)a0 localAffinity:(int)a1 remoteAffinity:(int)a2 resolvedCandidates:(id)a3;
...
- (id)initWithLinkConnector:(id)a0 allocateType:(long long)a1 isInitiator:(BOOL)a2 useLinkSelection:(BOOL)a3 recordExpensiveQualityMetrics:(BOOL)a4 linkSelectionStrategy:(id)a5 serviceIdentifier:(id)a6 serverBag:(id)a7 experiments:(id)a8 timeFn:(id /* block */)a9;
