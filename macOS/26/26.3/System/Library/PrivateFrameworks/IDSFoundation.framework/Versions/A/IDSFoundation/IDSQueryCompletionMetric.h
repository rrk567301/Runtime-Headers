...
@property (readonly, nonatomic) BOOL isForced;
@property (nonatomic) BOOL ktQueryKickedConcurrently;
@property (nonatomic) BOOL ktQueryTimedOut;
...
- (void).cxx_destruct;
- (id)initWithService:(id)a0 querySuccess:(BOOL)a1 connectionType:(unsigned int)a2 queryTimeInterval:(double)a3 queryURITypes:(unsigned int)a4 conferenceResultCode:(unsigned int)a5 queryErrorType:(unsigned int)a6 queryError:(id)a7 wasReversePushAttempted:(BOOL)a8 hasEmptyResult:(BOOL)a9 queryReason:(id)a10 retryCount:(unsigned long long)a11 uriCount:(unsigned long long)a12 isForced:(BOOL)a13;
