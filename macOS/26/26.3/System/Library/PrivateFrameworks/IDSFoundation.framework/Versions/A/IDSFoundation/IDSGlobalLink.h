@class NSDictionary, IDSObjCPacketLog, NSMutableArray, IDSUDPLink, NSString, IDSTCPLink, NSMutableSet, IDSPacketDeduplicator, NSArray, NSMutableDictionary, IDSGlobalLinkBlocks, IDSLinkSelectionStrategy, IDSLinksQualityMeasurer, NSObject, NSData, IDSGFTMetricsCollector, IDSNWLink, IDSStunCandidatePair, IDSLinkSelectorPrimarySecondary, NSDate, IDSGLP2PLinkEngineHandle;
@protocol IDSGroupQUICMaterialExchangeProvider, IDSGlobalLinkP2PKeyNegotiatorProvider, OS_dispatch_source, IDSLinkDelegate;

@interface IDSGlobalLink : NSObject <IDSLink, IDSGlobalLinkProtocol, IDSLinkDelegate, IDSStunCandidatePairDelegate, IDSGroupMaterialExchangeQUICHandler, IDSGLLinkConnector> {
    BOOL _hasStarted;
    ...
    BOOL _shouldUsePathMTUDiscovery;
    unsigned long long _nextP2PNegotiationAttempt;
    BOOL _disableDirectDatapath;
    BOOL _useLinkEngine;
    BOOL _hasUseLinkEngineBeenProgramaticallyOverriden;
    BOOL _useLinkSelection;
    BOOL _areGLExperimentsLockedIn;
    NSDictionary *_glComputedSessionExperiments;
    BOOL _recordExpensiveQualityMetrics;
    ...
    BOOL _isLinkSelectionStrategyLockedIn;
    ...
    BOOL _ftPowerOptimizationEnabled;
    BOOL _ftPowerOptimizationForceEnabled;
...
- (void)setLinkSelectionStrategy:(id)a0;
...
- (void)_processCommandTestPacket:(id)a0 candidatePairToken:(id)a1 remoteRelayLinkID:(unsigned short)a2;
...
- (BOOL)_findTriedCandidatePairForSession:(id)a0 wantOnlyCell:(BOOL)a1 wantOnlyNonCell:(BOOL)a2;
...
- (void)_addQRAAWDBlock:(id)a0 allocateRequestTime:(double)a1 inferredExternalRAT:(unsigned int)a2 stunTransport:(long long)a3 relayProviderType:(long long)a4 idsSessionID:(id)a5 reportingDataBlob:(id)a6 isInitiator:(BOOL)a7 serverSoftwareVersion:(id)a8;
...
- (void)_connectTCPAndUpdateLocalCandidatePortToAvailablePortIfNeeded:(id)a0 remoteCandidate:(id)a1 glLinkProtocol:(long long)a2;
...
- (void)_convergeSharedSessionsWithLinkEngine:(id)a0;
- (id)_convergeSharedSessionsWithoutLinkEngine:(id)a0;
...
- (void)_deinitialieSendInfoForCandidatePair:(id)a0;
...
- (void)_discardAllCandidatePairs:(BOOL)a0;
...
- (void)_enableE2E;
- (id)_ensureSessionWithSessionInfo:(id)a0 sessionInfoDict:(id)a1 localInterfacePreference:(int)a2;
...
- (id)_getLink:(int)a0 stunTransport:(long long)a1 glLinkProtocol:(long long)a2;
...
- (BOOL)_getPacketBufferSendInfo:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 channelNumber:(unsigned short *)a1 transport:(long long *)a2 glLinkProtocol:(long long *)a3;
- (long long)_getQRAllocateType;
- (id)_getRemoteAddress:(struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a0;
...
- (BOOL)_glLinkProtocolIsFakeTLS:(long long)a0;
- (BOOL)_glLinkProtocolIsNWLink:(long long)a0;
- (BOOL)_glLinkProtocolIsTCPRelay:(long long)a0;
...
- (void)_handleDisconnect:(BOOL)a0;
...
- (BOOL)_hasCandidatePairInState:(unsigned long long)a0 state2:(unsigned long long)a1 state3:(unsigned long long)a2 relayCandidatePairsOnly:(BOOL)a3 excludeSelfAlloc:(BOOL)a4;
- (BOOL)_hasConnectedP2pLink;
- (BOOL)_hasConnectingRelayCandidatePair;
- (BOOL)_hasStunRequest:(id)a0;
- (void)_initializeSendInfoForCandidatePair:(id)a0;
- (BOOL)_interfaceName:(id)a0 missingFrom:(id)a1;
...
- (BOOL)_isCLAT46Interface:(struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a0;
...
- (BOOL)_isInterfaceUltraConstrained:(unsigned int)a0;
- (BOOL)_isSessionAccepted:(id)a0;
- (BOOL)_isSharedQRSession:(id)a0;
- (BOOL)_isSlicedCellularInterfaceActive:(unsigned int)a0;
- (BOOL)_isUsingSameRATCandidatePair:(id)a0 transportScoreCard:(id)a1;
- (id)_linkIDsForSession:(id)a0;
- (id)_localCandidatesForRelaySession:(id)a0;
- (long long)_localCapabilityFlags;
- (BOOL)_localIsQualityMetadataSupported;
- (void)_markLinkAsUsed:(id)a0;
...
- (void)_notifyLinkEngineCandidatePairDidConnect:(id)a0;
...
- (BOOL)_processChannelDataCommandMessage:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 remoteRelayLinkID:(unsigned short)a1 channelNumber:(unsigned short)a2 fromDeviceUniqueID:(id)a3 cbuuid:(id)a4 arrivalTime:(double)a5;
...
- (BOOL)_processNWLinkAllocbindResponse:(id)a0 fromDevice:(id)a1 localIfIndex:(unsigned int)a2 localAddress:(struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a3 remmoteAddress:(struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a4 candidatePairToken:(id)a5 arrivalTime:(double)a6;
- (void)_processNewLocalAddressList:(id)a0;
- (void)_processNewRemoteCandidates:(id)a0;
- (BOOL)_processProtoPacket:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 fromDeviceUniqueID:(id)a1 cbuuid:(id)a2 arrivalTime:(double)a3 headerOverhead:(unsigned long long)a4;
...
- (void)_processReallocChannelData:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 channelNumber:(unsigned short)a1 fromDeviceUniqueID:(id)a2 cbuuid:(id)a3 arrivalTime:(double)a4;
...
- (BOOL)_qrMaterialExchangePutMaterial:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)_remoteCandidatesForRelaySession:(id)a0;
...
- (void)_reportNoSessionState:(id)a0 errorCode:(unsigned short)a1;
...
- (void)_saveProtoRequest:(id)a0 token:(id)a1 path:(id)a2;
...
- (void)_selectStunTransport:(long long *)a0 andInterfaceAddress:(id *)a1 forRelaySessionID:(id)a2 preferIPv4:(BOOL)a3 isValidSA:(BOOL)a4;
- (void)_selectStunTransport:(long long *)a0 andInterfaceAddress:(id *)a1 forRelaySessionID:(id)a2 preferIPv4:(BOOL)a3 wantOnlyCell:(BOOL)a4 wantOnlyNonCell:(BOOL)a5 isValidSA:(BOOL)a6;
- (void)_sendAllocbindForCandidatePair:(id)a0 session:(id)a1 glLinkProtocol:(long long)a2;
...
- (BOOL)_sendChannelConfigRequestToQR:(id)a0;
- (void)_sendChannelDataCommandMessage:(long long)a0 packetBuffer:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a1 options:(id)a2 candidatePair:(id)a3;
- (void)_sendChannelDataCommandMessage:(long long)a0 packetBuffer:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a1 options:(id)a2 candidatePairToken:(id)a3;
- (unsigned long long)_sendChannelDataPacketBuffer:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 candidatePair:(id)a1;
- (void)_sendCommandMessage:(long long)a0 stunMessage:(id)a1 options:(id)a2 candidatePair:(id)a3;
...
- (BOOL)_sendInfoRequest:(id)a0 relaySessionID:(id)a1;
- (void)_sendInfoRequestForCandidatePair:(id)a0 glLinkProtocol:(long long)a1;
- (void)_sendNowConnectionDataWithRemovedAddressList:(id)a0;
- (long long)_sendPacketBuffer:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 stunTransport:(long long)a1 glLinkProtocol:(long long)a2 token:(id)a3 linkID:(char)a4 delegatedLinkID:(char)a5;
...
- (long long)_sendStunMessage:(id)a0 sourceIfIndex:(int)a1 source:(const struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a2 destination:(struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a3 stunTransport:(long long)a4 glLinkProtocol:(long long)a5 token:(id)a6 linkID:(char)a7 delegatedLinkID:(char)a8 MTULimit:(int)a9;
- (void)_sendSyntheticPacket:(id)a0 candidatePair:(id)a1;
...
- (void)_setLinkMetricsAttributesForCandidatePair:(id)a0 linkAttributes:(id)a1;
...
- (void)_updateLinksForSession:(id)a0;
...
- (void)candidatePair:(id)a0 didReceiveSessionStats:(id)a1 success:(BOOL)a2;
...
- (void)candidatePairDidReceiveInfoResponse:(id)a0;
- (void)configureGLExperimentsWithSessionInfo:(id)a0;
...
- (void)didReceiveFirstDataOnCandidatePair:(id)a0;
...
- (void)importLinkEngineQualityMeasurementDelta:(id)a0 sourceName:(id)a1 completionHandler:(id /* block */)a2;
- (void)importQualityMeasurementDelta:(id)a0 sourceName:(id)a1 completionHandler:(id /* block */)a2;
- (id)initWithDeviceUniqueID:(id)a0 cbuuid:(id)a1;
- (id)interfaceNameForCandidatePair:(id)a0;
- (BOOL)isCandidatePairConstrained:(id)a0;
- (BOOL)isCandidatePairDelegated:(id)a0;
- (BOOL)isCandidatePairExpensive:(id)a0;
- (BOOL)isFtPowerOptimizationEnabled;
...
- (BOOL)link:(id)a0 didReceivePacket:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a1 fromDeviceUniqueID:(id)a2 cbuuid:(id)a3;
- (void)link:(id)a0 pathMTUDidChange:(unsigned short)a1 connectionInfo:(id)a2;
...
- (void)linksQualityDeltaSince:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)registerP2PCandidatePairWithLinkEngine:(id)a0;
...
- (void)requestPathMTUEvaluationForLinkID:(char)a0;
...
- (struct tagIDSQRSendInfo { int x0; int x1; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x2; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x3; unsigned short x4; BOOL x5; long long x6; long long x7; long long x8; long long x9; double x10; double x11; double x12; unsigned int x13; unsigned int x14; unsigned long long x15; unsigned long long x16; BOOL x17; } *)sendInfoForCandidatePair:(id)a0;
- (void)sendKeyMaterialMessageData:(id)a0 relayGroupID:(id)a1 destinationURIs:(id)a2 completionHandler:(id /* block */)a3;
- (unsigned long long)sendPacketBuffer:(struct { char *x0; unsigned long long x1; long long x2; long long x3; unsigned int x4; unsigned char x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; BOOL x15; BOOL x16; unsigned int x17; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x18; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x19; struct sockaddr_storage { unsigned char x0; unsigned char x1; char x2[6]; long long x3; char x4[112]; } x20; unsigned short x21; unsigned char x22; int x23; struct { char *x0; unsigned short x1; int x2; unsigned short x3[12]; unsigned long long x4; unsigned char x5; unsigned short x6; unsigned char x7; BOOL x8; BOOL x9; unsigned short x10; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; } x11; BOOL x12; BOOL x13; int x14; unsigned short x15[4]; unsigned char x16; BOOL x17; BOOL x18; BOOL x19; unsigned int x20; } x24[8]; char x25; char x26; int x27; double x28; unsigned char x29[16]; unsigned long long x30; unsigned long long x31; id x32; id x33; int x34; unsigned int x35; unsigned short x36; unsigned long long x37; BOOL x38; BOOL x39; BOOL x40; unsigned short x41; unsigned char x42[0]; } *)a0 toDeviceUniqueID:(id)a1 cbuuid:(id)a2;
...
- (void)sendTestPacketChannelDataMessage:(id)a0 candidatePair:(id)a1;
- (void)sendTestPacketCommandMessage:(id)a0 candidatePair:(id)a1;
...
- (void)setForceTCPFallbackOnCell:(BOOL)a0;
- (void)setForceTCPFallbackOnWiFi:(BOOL)a0;
...
- (id)tagForCandidatePair:(id)a0 glLinkProtocol:(long long)a1;
