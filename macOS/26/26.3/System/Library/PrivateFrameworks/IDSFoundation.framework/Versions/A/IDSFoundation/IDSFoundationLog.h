...
@property (class, readonly) NSObject<OS_os_log> *stewieMessaging;
@property (class, readonly) NSObject<OS_os_log> *IDSOffGridMessenger;
@property (class, readonly) NSObject<OS_os_log> *IDSOffGridStateManager;
@property (class, readonly) NSObject<OS_os_log> *IDSOffGridStateManager_oversized;
@property (class, readonly) NSObject<OS_os_log> *IDSSKStatusClient;
...
@property (class, readonly) NSObject<OS_os_log> *ServerMaterialExchange_oversize;
@property (class, readonly) NSObject<OS_os_log> *Metrics;
@property (class, readonly) NSObject<OS_os_log> *GlobalLink;
@property (class, readonly) NSObject<OS_os_log> *GlobalLink_oversize;
...
@property (class, readonly) NSObject<OS_os_log> *FeatureToggler;
...
@property (class, readonly) NSObject<OS_os_log> *QRProto_oversize;
...
@property (class, readonly) NSObject<OS_os_log> *NWPathUtils;
...
@property (class, readonly) NSObject<OS_os_log> *IDSPinnedIdentity;
@property (class, readonly) NSObject<OS_os_log> *PeerLookup_DBCache;
@property (class, readonly) NSObject<OS_os_log> *DiagnosticInfoHandler;
