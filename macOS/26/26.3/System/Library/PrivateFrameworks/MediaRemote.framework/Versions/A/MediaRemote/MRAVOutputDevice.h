@class MRAVOutputDeviceSourceInfo, NSString, NSArray, MRAVEndpoint, NSData, MRGroupSessionInfo, NSDictionary, _MRAVOutputDeviceDescriptorProtobuf, MRAVDistantOutputDevice;
...
@property (readonly, nonatomic) BOOL discoveredDeviceIsPlaying;
@property (readonly, nonatomic) BOOL isNonRemoteControllableAirPlayDevice;
@property (readonly, nonatomic) BOOL belongsToLocalCluster;
@property (readonly, nonatomic) BOOL isLocalDeviceOrBelongsToLocalCluster;
...
@property (readonly, nonatomic) BOOL wasDiscoveredInCache;
@property (readonly, nonatomic) BOOL representsUGLSender;
@property (readonly, nonatomic) BOOL hasPlaceholderName;
@property (readonly, nonatomic) BOOL isSystemCaptureDevice;
...
@property (readonly, nonatomic) BOOL isAirpodsMaxDevice;
...
@property (readonly, nonatomic) BOOL isStudioDisplay;
