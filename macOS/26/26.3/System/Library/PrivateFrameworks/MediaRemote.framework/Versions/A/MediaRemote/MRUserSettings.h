...
@property (readonly, nonatomic) BOOL shouldInitializeMRRelayService;
...
@property (readonly, nonatomic) BOOL verbosePlaybackQueueRequestLogging;
...
@property (readonly, nonatomic) BOOL nowPlayingAppStackShouldAutomaticallyForwardFailedPlayCommands;
...
@property (readonly, nonatomic) BOOL supportProactiveRecommendedPlayer;
...
@property (readonly, nonatomic) BOOL supportUserSelectedEndpointTimeout;
...
@property (readonly, nonatomic) BOOL hasSystemVolumeCapabilitiesOverride;
...
@property (readonly, nonatomic) BOOL supportAirplayStereoPairPersistentConnections;
@property (readonly, nonatomic) BOOL removeLocalDeviceOnMultiplayerReceiverSession;
@property (readonly, nonatomic) BOOL supportPTOTRefactorPart1;
@property (readonly, nonatomic) BOOL supportPTOTRefactorPart2;
@property (readonly, nonatomic) BOOL supportLargeHomeAudioOptimization;
@property (readonly, nonatomic) BOOL prewarmPodcasts;
@property (readonly, nonatomic) BOOL supportDiscoveryCaching;
@property (readonly, nonatomic) BOOL disableDUGLDuringAirPlayVideo;
@property (readonly, nonatomic) BOOL supportBluehop;
@property (readonly, nonatomic) BOOL supportTwoStageMove;
...
@property (readonly, nonatomic) BOOL supportMRRelay;
@property (readonly, nonatomic) BOOL supportUGL;
@property (readonly, nonatomic) BOOL startNowPlayingSessionABC;
@property (readonly, nonatomic) BOOL forceNowPlayingSessionFailure;
@property (readonly, nonatomic) BOOL supportTopologyHealing;
@property (readonly, nonatomic) BOOL supportRoutingContinuity;
@property (readonly, nonatomic) BOOL supportPredictedRoutes;
@property (readonly, nonatomic) BOOL supportASERetargetting;
@property (readonly, nonatomic) BOOL supportsNativeThirdPartyApps;
@property (readonly, nonatomic) BOOL excessiveNowPlayingControllersABC;
@property (readonly, nonatomic) BOOL excessiveTaskAssertionsABC;
@property (readonly, nonatomic) double persistentDiscoveryABCDuration;
@property (readonly, nonatomic) BOOL inconsistentPlaybackQueueCacheABC;
...
@property (readonly, nonatomic) BOOL enableDeltaRouteRecommendations;
...
@property (readonly, nonatomic) BOOL supportLiveActivityBanner;
@property (readonly, nonatomic) BOOL alwaysShowVolumeControls;
...
@property (readonly, nonatomic) BOOL groupSessionAutoApproveParticipantsForAppleTV;
...
@property (readonly, nonatomic) BOOL groupSessionBoopAdvertisementEnabled;
@property (readonly, nonatomic) BOOL groupSessionRotateAfterLastGuest;
...
@property (readonly, nonatomic) BOOL groupSessionDelayedInitializationEnabled;
...
@property (readonly, nonatomic) BOOL supportCriticalSectionManagement;
@property (readonly, nonatomic) long long waveformNonVariableFramerate;
@property (readonly, nonatomic) BOOL staticWaveform;
@property (readonly, nonatomic) BOOL sonicMusicEnabled;
@property (readonly, nonatomic) BOOL sonicPodcastsEnabled;
@property (readonly, nonatomic) BOOL disableAWDLRoutes;
