...
+ (void)_getSessionWithIdentifier:(id)a0 configuration:(id)a1 dedDevice:(id)a2 filerForm:(id)a3 getDetails:(BOOL)a4 shouldGetSessionStatus:(BOOL)a5 completion:(id /* block */)a6;
+ (void)_getSessionWithIdentifier:(id)a0 configuration:(id)a1 device:(id)a2 filerForm:(id)a3 getDetails:(BOOL)a4 shouldGetSessionStatus:(BOOL)a5 completion:(id /* block */)a6;
+ (id)_seedPortal;
+ (id)_seedingHost;
+ (void)_startSessionByFirstPairingWithConfig:(id)a0 device:(id)a1 grouped:(id)a2 identifier:(id)a3 filerForm:(id)a4 shouldGetDetails:(BOOL)a5 shouldGetSessionStatus:(BOOL)a6 completion:(id /* block */)a7;
...
+ (void)fetchDETextDataWithFilerForm:(id)a0 fromSession:(id)a1 configuration:(id)a2 completion:(id /* block */)a3;
