...
- (void)notifyPresentedWindowToCancel;
- (long long)presentedWindowNumber;
- (void)reopen;
...
- (BOOL)shouldCloseForMouseDownEventAtLocation:(struct CGPoint { double x0; double x1; })a0;
