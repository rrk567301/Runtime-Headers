@interface MediaControl.DistantRoutingSessionsDataSource : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ _optimisticSnapshot;
    void /* unknown type, empty encoding */ _snapshot;
    void /* unknown type, empty encoding */ _pendingItemIdentifiers;
    ...
    void /* unknown type, empty encoding */ pendingSessionTransition;
    void /* unknown type, empty encoding */ lock;
    void /* unknown type, empty encoding */ service;
    void /* unknown type, empty encoding */ configuration;
    void /* unknown type, empty encoding */ identifier;
    void /* unknown type, empty encoding */ $__lazy_storage_$_volumeControlSegments;
}
