...
- (struct vector<ULWiFiHistogramDO, std::allocator<ULWiFiHistogramDO>> { struct ULWiFiHistogramDO *x0; struct ULWiFiHistogramDO *x1; struct { struct ULWiFiHistogramDO *x0; } x2; })_fetchWiFiHistogramByAndPredicates:(id)a0 sortDescriptors:(id)a1 andLimit:(unsigned long long)a2;
- (BOOL)deleteOrphanRecords;
- (struct vector<ULWiFiHistogramDO, std::allocator<ULWiFiHistogramDO>> { struct ULWiFiHistogramDO *x0; struct ULWiFiHistogramDO *x1; struct { struct ULWiFiHistogramDO *x0; } x2; })fetchAllRecordsWithLimit:(unsigned int)a0;
