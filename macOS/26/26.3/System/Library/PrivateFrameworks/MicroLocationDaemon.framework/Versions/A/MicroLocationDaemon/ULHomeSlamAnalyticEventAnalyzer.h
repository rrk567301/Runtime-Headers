...
- (BOOL)_checkIfScreenTransitionedToOnBefore:(id)a0 after:(id)a1 withEvents:(struct vector<ULHomeSlamAnalyticEventDO, std::allocator<ULHomeSlamAnalyticEventDO>> { struct ULHomeSlamAnalyticEventDO *x0; struct ULHomeSlamAnalyticEventDO *x1; struct { struct ULHomeSlamAnalyticEventDO *x0; } x2; })a2;
- (BOOL)_daemonWasRestartedWithEvents:(struct vector<ULHomeSlamAnalyticEventDO, std::allocator<ULHomeSlamAnalyticEventDO>> { struct ULHomeSlamAnalyticEventDO *x0; struct ULHomeSlamAnalyticEventDO *x1; struct { struct ULHomeSlamAnalyticEventDO *x0; } x2; })a0;
- (long long)_hoursFromFirstEventToDate:(id)a0 withDBStore:(struct ULDatabaseStoreInterface { void /* function */ **x0; } *)a1;
- (BOOL)_wasLastScreenStateOnBefore:(id)a0 withEvents:(struct vector<ULHomeSlamAnalyticEventDO, std::allocator<ULHomeSlamAnalyticEventDO>> { struct ULHomeSlamAnalyticEventDO *x0; struct ULHomeSlamAnalyticEventDO *x1; struct { struct ULHomeSlamAnalyticEventDO *x0; } x2; })a1;
