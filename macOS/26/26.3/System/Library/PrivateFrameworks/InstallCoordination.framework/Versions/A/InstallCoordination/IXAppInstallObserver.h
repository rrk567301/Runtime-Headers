...
- (oneway void)_client_coordinatorDidInstallPlaceholderWithSeed:(id)a0 atURL:(id)a1;
- (oneway void)_client_mayUninstallAppWithIdentity:(id)a0;
- (id)initWithMachServiceName:(id)a0 forClients:(id)a1 delegate:(id)a2;
- (oneway void)_client_shouldPrioritizeAppWithIdentity:(id)a0;
...
- (oneway void)_client_coordinatorDidCompleteSuccessfullyWithSeed:(id)a0 forAppAtURL:(id)a1;
- (oneway void)_client_shouldPrioritizeAppWithBundleID:(id)a0;
- (oneway void)_client_coordinatorWithSeed:(id)a0 didCancelWithReason:(id)a1 client:(unsigned long long)a2 atURL:(id)a3;
- (void).cxx_destruct;
- (void)_internalInit;
- (void)dealloc;
...
- (oneway void)_client_coordinatorShouldBeginPostProcessingWithSeed:(id)a0 forAppAtURL:(id)a1;
