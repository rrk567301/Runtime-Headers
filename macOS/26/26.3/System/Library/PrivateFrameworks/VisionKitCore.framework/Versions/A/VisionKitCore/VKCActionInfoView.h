@class NSView, VKImageAnalysisButton, NSArray, VKFlippedGlassContainerView, NSFont, VKCActionInfoViewLayoutContext, VKCVisualSearchCornerView, VKCActionInfoMoreButton;

@interface VKCActionInfoView : VKPlatformView

@property (retain, nonatomic) VKFlippedGlassContainerView *containerView;
