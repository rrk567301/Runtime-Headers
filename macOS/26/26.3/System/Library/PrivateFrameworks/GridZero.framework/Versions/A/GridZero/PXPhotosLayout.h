@class NSDictionary, PXPhotosHeaderCustomizationModel, PXPhotosLayoutSpecManager, PXGItemPlacement, PXGSingleViewLayout, NSString, PXGLayout, PXScrollDetent, PXNumberAnimator, PXPhotosSectionedLayout, NSView, PXPhotosLayoutState, PXPhotosViewModel;
