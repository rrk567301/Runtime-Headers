...
+ (id)embeddingCaches;
+ (id)initInstanceWithType:(unsigned int)a0 name:(id)a1;
+ (id)initInstanceWithType:(unsigned int)a0 name:(id)a1 cacheOptions:(long long)a2;
+ (id)sharedInstanceWithType:(unsigned int)a0;
...
- (id)initWithParentFd:(int)a0 indexType:(unsigned int)a1 dbName:(id)a2;
- (id)initWithParentFd:(int)a0 indexType:(unsigned int)a1 dbName:(id)a2 cacheOptions:(long long)a3;
