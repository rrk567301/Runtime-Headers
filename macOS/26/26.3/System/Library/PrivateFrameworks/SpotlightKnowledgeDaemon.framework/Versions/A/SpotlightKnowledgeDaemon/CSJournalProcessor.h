...
- (id)initWithParentFd:(int)a0 eventListener:(id)a1 indexType:(unsigned int)a2 journalNumber:(unsigned long long)a3 journalCookie:(id)a4 name:(id)a5;
- (id)initWithParentFd:(int)a0 eventListener:(id)a1 key:(id)a2 indexType:(unsigned int)a3 journalIno:(unsigned long long)a4 dev:(int)a5 journalNumber:(unsigned long long)a6 journalCookie:(const char *)a7 journalName:(const char *)a8 journalBasePath:(const char *)a9;
...
- (BOOL)writeUpdaterProgressToStoreWithIndexType:(unsigned int)a0 UUID:(const char *)a1 serialNumber:(unsigned long long)a2 error:(id)a3;
