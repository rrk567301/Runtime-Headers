...
@interface SFAirDropUserDefaults : NSObject {
    void /* unknown type, empty encoding */ _solariumEnabled;
    ...
    void /* unknown type, empty encoding */ _pinPairingAirDrop;
    void /* unknown type, empty encoding */ _everyoneModeBanner;
    void /* unknown type, empty encoding */ __privacyImprovements;
...
@property (nonatomic, readonly) BOOL objcSolariumEnabled;
