...
@interface AppStoreComponentsDaemonKit.JSLegacyLocObject : NSObject <_TtP27AppStoreComponentsDaemonKitP33_95C574A6F73E386171965476C49CFBED18JSLocObjectExports_> {
    void /* unknown type, empty encoding */ localizer;
    void /* unknown type, empty encoding */ locale;
    void /* unknown type, empty encoding */ localeWithCalendar;
    void /* unknown type, empty encoding */ localeWithCalendarWithBagFixUp;
}
