@class NSString, NSArray, ASCAdamID, NSSet, ASCLockupDisplayContext, ASCTrailers, ASCArtwork, ASCScreenshots, ASCViewMetrics;
@protocol ASCOffer;
...
- (void)_buyParamsWithCompletionBlock:(id /* block */)a0;
...
- (id)lockupWithSubtitle:(id)a0;
- (id)lockupWithTitle:(id)a0;
