...
- (void)defaultProcessEventWithCategory:(unsigned short)a0 type:(unsigned short)a1 payload:(id)a2;
...
- (void)processEndpointChanged:(unsigned short)a0;
...
- (void)processSenderOnlyStats:(id)a0;
- (void)processTransportInfo:(id)a0;
- (void)reportSegment;
- (int)reportingClientType;
- (BOOL)supportsSegmentReporting;
- (BOOL)supportsSessionReporting;
- (void)telephonyCallingProcessAWDMetrics:(id)a0;
