@class NSMutableDictionary, VCAdaptiveLearning, VCDurationHistogram, NSDate, NSObject, NSDictionary, VCVideoFECStatsHolder, VCReportingHistogram, VCAlgosStreamingScoreAggregator, TimingCollection, NSMutableArray, VCMediaRecorderDataCollector, NSString, VCMediaAnalyzerDataCollector, VCHistogram, VCAlgosStreamingScorer, VCCaptionsDataCollector, WiFiP2PAWDLStateMonitor, NSNumber;
...
@property (nonatomic) char alwaysFullBleedUserPreferenceStatus;
...
+ (BOOL)firstOrientation:(unsigned char)a0 matchesSecondOrientation:(unsigned char)a1;
...
- (void)addAggregateAudioInjectorMetricsToReport:(id)a0;
- (void)addAlternateThermalMetricsToReportDictionary:(id)a0;
- (void)addAudioStreamTimestampJumpDurationToReport:(id)a0;
- (void)addCameraMetricsToReportDictionary:(id)a0 totalDuration:(int)a1;
- (void)addFECStats:(id)a0 parameters:(struct tagVCFECSegmentReportParameters { id x0; id x1; id x2; id x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; } *)a1;
- (void)addFECStats:(id)a0 parameters:(struct tagVCFECSegmentReportParameters { id x0; id x1; id x2; id x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; } *)a1 reportFrameSizeTelemetry:(BOOL)a2 reportLevels:(BOOL)a3;
- (void)addFECStatsHolderKPIs:(id)a0 usingFECStatsHolder:(id)a1;
- (void)addFECStatsHolderKPIs:(id)a0 usingFECStatsHolder:(id)a1 reportFrameSizeTelemetry:(BOOL)a2 reportLevels:(BOOL)a3;
- (void)addIDSTelemetry:(id)a0;
- (void)addLegacyThermalMetricsToReportDictionary:(id)a0;
...
- (void)processAudioInjectionInitWithPayload:(id)a0 currentTime:(double)a1;
- (void)processAudioInjectionReadyWithCurrentTime:(double)a0;
...
- (void)setPeriodicAggregationOccurredHandler:(id /* block */)a0;
...
- (void)updateFECStats:(id)a0 usingUpdateValuesIn:(id)a1;
...
- (void)updateTimeToThermalsAlternate:(id)a0;
- (void)updateTimeToThermalsLegacy:(id)a0;
...
- (void)updateVideoFECStatsOnSegment:(id)a0 fecStats:(id)a1 segmentLossPattern:(id)a2 segmentLossHistogram:(id)a3 segmentLossFecHistogram:(id)a4 direction:(int)a5;
