...
- (id)capabilitiesForStream:(id)a0 mediaProtocolArgs:(id)a1 xpcArguments:(id)a2 clientAuditToken:(id)a3 error:(id *)a4;
- (void)cleanupStreamSyncSourceForVideoStream:(id)a0 andAudioStream:(id)a1;
- (id)newLocalNWEndpointFromXPCArguments:(id)a0 mediaProtocolArgs:(id)a1;
- (id)newMediaProtocolArgsWithMediaProtocolArgs:(id)a0 nwEndpoint:(id)a1 clientAuditToken:(id)a2;
- (id)newRemoteNWEndpointFromXPCArguments:(id)a0;
- (void)pauseStreams:(BOOL)a0;
- (unsigned int)remoteSSRCFromXPCArguments:(id)a0;
