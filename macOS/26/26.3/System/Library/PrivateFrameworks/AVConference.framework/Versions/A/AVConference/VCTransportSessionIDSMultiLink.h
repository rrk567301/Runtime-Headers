...
- (void)didLocalNetworkQualityChange:(BOOL)a0 isLocalNetworkQualityBad:(BOOL)a1 isRemoteNetworkQualityBad:(BOOL)a2;
- (void)didMediaQualityDegrade:(BOOL)a0;
- (void)didUpdatePreferredInterfaceForDuplication:(int)a0 notifyPeer:(BOOL)a1 enableDuplication:(BOOL)a2 isMediaUnrecoverableSignal:(BOOL)a3;
