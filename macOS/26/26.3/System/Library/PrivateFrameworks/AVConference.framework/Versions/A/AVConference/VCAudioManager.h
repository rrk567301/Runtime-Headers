...
@property (readonly, nonatomic) void **audioSession;
...
+ (unsigned char)audioIOTypeWithAudioUnitProperties:(id)a0 shouldEnableAudioInput:(BOOL)a1;
+ (id)logPrefixForMode:(int)a0;
...
- (BOOL)isSystemAudioOutputPlaybackMode;
...
- (void)serverDidDie;
- (void)setAudioUnitIOProperties:(id)a0;
...
- (void)setupSpatialContextWithAudioUnitProperties:(id)a0 forceUpdate:(BOOL)a1;
- (BOOL)setupVAD;
