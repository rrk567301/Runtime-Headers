@class NSData, NSString, VCNetworkFeedbackController, NSDictionary, VCSecurityKeyManager, NSObject, VCAudioMachineLearningCoordinator, VCExperimentManager, VCSessionMediaNegotiator;
...
@property (nonatomic) BOOL p2pEncryptionEnabled;
...
@property (nonatomic) BOOL isACC24ForU1Enabled;
@property (nonatomic) BOOL isACC24ForGFTEnabled;
...
@property (nonatomic) BOOL isJBLatencySensitiveModeEnabled;
