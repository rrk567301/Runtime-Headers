...
@property (getter=isP2PEncryptionExperimentEnabled) BOOL p2pEncryptionExperimentEnabled;
...
- (void)dealloc;
- (unsigned short)applyLinkFlagsOverride:(unsigned short)a0 isLocal:(BOOL)a1;
