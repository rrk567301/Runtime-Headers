...
+ (void)addCodecConfigurationToStreamConfig:(id)a0 codecType:(long long)a1 preferredMode:(int)a2 isV2Codec:(BOOL)a3;
...
+ (void)setUpCodecConfig:(id)a0 payload:(int)a1 preferredMode:(int)a2;
+ (void)setUpV2CodecConfig:(id)a0 payload:(int)a1 preferredMode:(int)a2;
...
- (BOOL)initializeAudioStreamWithConfig:(struct _VCMediaStreamConfigurationProviderAudio { unsigned int x0; unsigned int x1; struct _VCMediaStreamConfigurationProviderAudioBitrateInfo { int x0; unsigned int x1; unsigned int x2; unsigned int x3; } x2; unsigned int x3; struct _VCMediaStreamConfigurationProviderAudioPayload { long long x0; int x1; } x4[4]; unsigned int x5; unsigned int x6[4]; int x7; BOOL x8; unsigned int x9; unsigned int x10; unsigned int x11; long long x12[9]; unsigned int x13; struct _VCMediaStreamConfigurationProviderAudioPayload { long long x0; int x1; } x14[1]; } *)a0 maxIDSStreamIDCount:(unsigned int)a1 supportedAudioRules:(id)a2 isLowestQualityAudio:(BOOL)a3;
