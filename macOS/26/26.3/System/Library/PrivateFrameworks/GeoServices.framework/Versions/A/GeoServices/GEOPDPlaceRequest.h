...
- (id)initForTerritoryForGEOIP:(id)a0;
...
- (id)initWithSearchQuery:(id)a0 entryMetadata:(id)a1 metadata:(id)a2 autocompleteEntry:(id)a3 retainedSearch:(id)a4 maxResults:(unsigned int)a5 filters:(id)a6 suppressResultsRequiringAttribution:(BOOL)a7 traits:(id)a8 routeInfo:(id)a9 error:(id *)a10 searchSessionData:(id)a11;
