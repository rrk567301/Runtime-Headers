...
- (id)ticketForSearchQuery:(id)a0 completionItem:(id)a1 retainedSearch:(id)a2 maxResults:(unsigned int)a3 suppressResultsRequiringAttribution:(BOOL)a4 traits:(id)a5 searchSessionData:(id)a6;
...
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 maxResults:(unsigned int)a2 suppressResultsRequiringAttribution:(BOOL)a3 traits:(id)a4 searchSessionData:(id)a5;
...
- (id)ticketForTerritoryForIP:(id)a0;
...
- (id)ticketForSearchQuery:(id)a0 filters:(id)a1 completionItem:(id)a2 retainedSearch:(id)a3 maxResults:(unsigned int)a4 suppressResultsRequiringAttribution:(BOOL)a5 traits:(id)a6 searchSessionData:(id)a7;
