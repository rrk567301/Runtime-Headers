...
@interface GEOSnappedRouteEdge : NSObject {
    ...
    struct vector<geo::PolylineCoordinate, std::allocator<geo::PolylineCoordinate>> { struct PolylineCoordinate *__begin_; struct PolylineCoordinate *__end_; struct { struct PolylineCoordinate *__cap_; } ; } _routeOffsets;
    struct vector<GeoCodecsVectorTilePoint, std::allocator<GeoCodecsVectorTilePoint>> { struct GeoCodecsVectorTilePoint *__begin_; struct GeoCodecsVectorTilePoint *__end_; struct { struct GeoCodecsVectorTilePoint *__cap_; } ; } _points;
}
