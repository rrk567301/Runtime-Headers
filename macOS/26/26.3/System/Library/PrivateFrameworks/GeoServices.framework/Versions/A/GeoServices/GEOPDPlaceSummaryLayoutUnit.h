...
@property (readonly, nonatomic) BOOL hasVisitedPlace;
@property (retain, nonatomic) GEOPDPlaceSummaryLayoutUnitVisitedPlace *visitedPlace;
@property (readonly, nonatomic) BOOL hasUserLibUserNoteClientFix;
