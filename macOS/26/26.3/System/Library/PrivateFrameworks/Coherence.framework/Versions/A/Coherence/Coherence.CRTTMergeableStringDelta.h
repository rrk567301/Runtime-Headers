...
@interface _TtC9Coherence24CRTTMergeableStringDelta : NSObject {
    struct vector<Coherence_namespace::TopoSubstring *, std::allocator<Coherence_namespace::TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct { struct TopoSubstring **__cap_; } ; } orderedSubstrings;
}
