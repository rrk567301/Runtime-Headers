...
- (id)_populateScoreProfilesForFeedItems:(id)a0;
- (void)_populateScoreProfilesForFeedItems:(id)a0 configurationSet:(long long)a1;
- (void)_prepareForUse;
- (void)_rescoreInventoryIfNeeded:(id)a0 forEnvironment:(id)a1;
- (id)allFeedItemScoreProfilesForConfigurationSet:(long long)a0 environment:(id)a1;
