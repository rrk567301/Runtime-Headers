...
+ (id)_appleAllowList:(id)a0;
+ (id)_blockPageForURL:(id)a0 inLanguage:(id)a1 withAllowButton:(BOOL)a2;
+ (id)_defaultUserSettingsPath;
+ (id)_denyList:(id)a0;
+ (void)_evaluateURL:(id)a0 inMode:(unsigned long long)a1 usingBloomFilter:(id)a2 userSettings:(id)a3 language:(id)a4 allowList:(id)a5 appleAllowList:(id)a6 denyList:(id)a7 allowedWebsitesOnlyList:(id)a8 macOSExemptURLList:(id)a9 withCompletion:(id /* block */)a10 onCompletionQueue:(id)a11;
