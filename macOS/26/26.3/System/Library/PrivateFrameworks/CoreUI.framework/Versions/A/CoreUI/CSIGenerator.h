...
@property (nonatomic) struct CGPoint { double x; double y; } namedgradientStartPoint;
@property (nonatomic) struct CGPoint { double x; double y; } namedgradientEndPoint;
...
- (id)initWithGradientNamed:(id)a0 type:(long long)a1 startPoint:(struct CGPoint { double x0; double x1; })a2 endPoint:(struct CGPoint { double x0; double x1; })a3 colorNames:(id)a4 colorStops:(id)a5;
