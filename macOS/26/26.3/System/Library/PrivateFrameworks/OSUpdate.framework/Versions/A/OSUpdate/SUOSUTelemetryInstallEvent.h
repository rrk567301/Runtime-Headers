...
@property (retain) SUOSUProduct *installProduct;
...
- (void)addTelemetryEventWithTotalRequiredFreeSpace:(unsigned long long)a0 bytesPurged:(unsigned long long)a1 cacheDeleteSuccessfullyFreedSpace:(BOOL)a2;
