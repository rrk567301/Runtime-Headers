...
@property (retain) NSDictionary *firstOfferDates;
...
@property BOOL softwareUpdateSettingsIsActive;
@property BOOL splatSettingsIsActive;
...
- (BOOL)_nowExceedsSplatNotificationDelay;
- (BOOL)_shouldShowDeviceCompatibilityNotificationForDevice:(id *)a0;
- (BOOL)_shouldShowNotificationForSplatWithReason:(id *)a0;
