...
@interface PKPhysicsWorld : NSObject <NSSecureCoding> {
    ...
    struct PKDebugDrawPacket { struct vector<PKPoint, std::allocator<PKPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _linePoints; struct vector<PKDebugDrawPacket::color4, std::allocator<PKDebugDrawPacket::color4>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _colors; } drawPacket;
}
...
@property (readonly, nonatomic, getter=isSettling) BOOL settling;
