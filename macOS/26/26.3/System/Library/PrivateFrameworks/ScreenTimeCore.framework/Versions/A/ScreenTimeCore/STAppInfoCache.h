...
- (void)_handleAMSClientResponseForBundleIdentifiers:(id)a0 results:(id)a1 error:(id)a2 completionHandler:(id /* block */)a3;
...
- (id)appInfoForBundleIdentifier:(id)a0 adamId:(id)a1 distributorId:(id)a2;
