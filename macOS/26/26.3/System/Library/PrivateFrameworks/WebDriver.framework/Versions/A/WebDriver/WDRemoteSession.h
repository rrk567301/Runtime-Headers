...
@property (nonatomic) BOOL supportsBidiProtocol;
...
- (void)loadWebExtensionWithResourceType:(long long)a0 value:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)setStorageAccessPermissionState:(long long)a0 browsingContext:(id)a1 completionHandler:(id /* block */)a2;
- (void)setStorageAccessPolicyForBrowsingContext:(id)a0 blockThirdPartyCookies:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (void)unloadWebExtensionWithIdentifier:(id)a0 completionHandler:(id /* block */)a1;
- (void)validateBrowsingContextExists:(id)a0 completionHandler:(id /* block */)a1;
