@class NSUUID, NSString, NSURL, NSDate, NSSet, CHRecentCall, CHManagedHandle, CHHandle, NSNumber;
...
@property (readonly, nonatomic) BOOL supportsReminderUUID;
@property (readonly, nonatomic) BOOL supportsCommunicationTrustScore;
@property (readonly, nonatomic) BOOL supportsOriginatingUIType;
@property (readonly, nonatomic) BOOL supportsOriginatingDeviceName;
