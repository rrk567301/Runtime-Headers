...
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)getSpeechRecognitionResultFromTokens:(struct vector<std::vector<quasar::Token>, std::allocator<std::vector<quasar::Token>>> { void *x0; void *x1; struct { void *x0; } x2; })a0 taskName:(id)a1;
- (id)initWithConfiguration:(id)a0 memoryLock:(BOOL)a1;
- (void)resetWithSamplingRate:(unsigned int)a0 language:(id)a1 taskType:(id)a2 userId:(id)a3 sessionId:(id)a4 deviceId:(id)a5 farField:(BOOL)a6 atypicalSpeech:(BOOL)a7 maxAudioBufferSizeSeconds:(unsigned int)a8;
