@class CHSDynamicColor, NSString, NSArray, NSData, CHSExtensionIdentity, CHSIntentReference, CHSControlActionMetadata;
...
@property (nonatomic) BOOL supportsForwardingToRemoteDevices;
...
- (void)setConfigurationAccentColor:(id)a0;
- (void)setConfigurationBackgroundColor:(id)a0;
...
- (void)setSupportsForwardingToRemoteDevices:(BOOL)a0;
...
- (void)setDisfavoredLocations:(unsigned long long)a0;
