@class NSData, NSString, NSArray, CHSDynamicColor, CHSIntentReference, NSDictionary, CHSIntentRecommendationsContainer, INIntent, CHSExtensionIdentity;
...
@property (nonatomic, getter=isRelevanceBacked) BOOL relevanceBacked;
...
- (void)setSpatialChromeStyles:(unsigned long long)a0;
- (void)setSpatialSurface:(unsigned long long)a0;
