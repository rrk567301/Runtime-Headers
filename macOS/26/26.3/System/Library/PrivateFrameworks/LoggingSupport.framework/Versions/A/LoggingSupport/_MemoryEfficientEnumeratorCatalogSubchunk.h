@class NSUUID, NSString, _OSLogChunkStore;

@interface _MemoryEfficientEnumeratorCatalogSubchunk : NSObject <EnumeratorCatalogSubchunk> {
    BOOL _had_subchunk;
    struct _NSRange { unsigned long long location; unsigned long long length; } _range;
}

@property (readonly, nonatomic) long long catalog_offset;
@property (readonly, nonatomic) _OSLogChunkStore *store;
@property (readonly, nonatomic) NSUUID *buuid;
@property (readonly, nonatomic) unsigned int algo;
@property (readonly, nonatomic) unsigned int usize;
