...
- (id)fetchAppLibraryPlist:(id)a0;
- (id)getAssetRanksForFileItemsInPackage:(id)a0;
- (unsigned long long)getSyncState:(unsigned long long)a0 ignoredZones:(id)a1 error:(id *)a2;
- (BOOL)hasDownloadJobWithTransferStageID:(id)a0;
...
- (BOOL)item:(id)a0 hasSyncUpJobState:(id)a1;
