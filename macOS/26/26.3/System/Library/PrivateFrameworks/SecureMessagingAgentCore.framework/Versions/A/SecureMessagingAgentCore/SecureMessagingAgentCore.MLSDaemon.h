@interface SecureMessagingAgentCore.MLSDaemon : NSObject <_TtPO15SecureMessaging8XPCUtils28DeliveryCollaboratorProtocol_> {
...
- (void)processIncomingGroupMetadataWithUniqueClientIdentifier:(id)a0 forGroup:(id)a1 withGroupInfo:(id)a2 incomingGroupMetadataContext:(id)a3 completion:(id /* block */)a4;
...
- (void)setupXPCConnectionWithClient:(id)a0 uniqueClientIdentifier:(id)a1 selfMember:(id)a2 completion:(id /* block */)a3;
- (void)updateWithUniqueClientIdentifier:(id)a0 groupDetails:(id)a1 forGroup:(id)a2 completion:(id /* block */)a3;
- (void)updateWithUniqueClientIdentifier:(id)a0 groupMetadataKey:(id)a1 forGroup:(id)a2 incomingGroupMetadataKeyContext:(id)a3 completion:(id /* block */)a4;
