...
- (void).cxx_destruct;
- (void)_generateAndStoreDerivativeResourcesForSyndicationResource:(id)a0 taskIdentifier:(id)a1 completion:(id /* block */)a2;
...
- (void)generateAndStoreDerivativeResourcesForSyndicationResource:(id)a0 taskIdentifier:(id)a1 completion:(id /* block */)a2;
