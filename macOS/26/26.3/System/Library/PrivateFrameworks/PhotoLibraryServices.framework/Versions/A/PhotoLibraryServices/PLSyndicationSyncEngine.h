...
+ (void)_recursiveFindStartDateForMessagesSpotlightItemsWithStartDate:(id)a0 endDate:(id)a1 block:(id /* block */)a2 completionHandler:(id /* block */)a3;
+ (void)findStartDateForMessagesSpotlightItemsWithBlock:(id /* block */)a0 completionHandler:(id /* block */)a1;
