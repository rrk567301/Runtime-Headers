@class NSString, PLInternalResource, PLAssetResourceUploadJobConfiguration, NSDate, PLAssetResourceUploadJobRequest, NSData;
...
+ (id)uploadJobsWithConfiguration:(id)a0 state:(short)a1 limit:(unsigned long long)a2 inPhotoLibrary:(id)a3 error:(id *)a4;
