...
@interface AUPasscodeEncoder : AUAudioUnit {
    struct unique_ptr<APCEncoderBase, std::default_delete<APCEncoderBase>> { struct { struct APCEncoderBase *__ptr_; } ; } _kernel;
