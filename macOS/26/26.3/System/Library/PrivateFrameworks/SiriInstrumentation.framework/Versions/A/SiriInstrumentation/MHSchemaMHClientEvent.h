...
@property (nonatomic) BOOL hasSpeakerIdEnrollmentDataReportedTier1;
...
@property (nonatomic) BOOL hasSpeakerIdModelSelectedClockSessionInfoTier1;
...
@property (nonatomic) BOOL hasSpeakerIdModelOneSessionReportedTier1;
