...
@interface SPCoreSpotlightQuery : SPMetadataQuery {
    ...
    struct IndexResultsRegistry { unsigned long long queryId; NSString *redactedQuery; struct vector<IndexResults, std::allocator<IndexResults>> { struct IndexResults *__begin_; struct IndexResults *__end_; struct { struct IndexResults *__cap_; } ; } results; NSMutableDictionary *indexMapping; } _indexResultsRegistry;
...
@property (retain) NSMutableSet *foundAliasedItems;
