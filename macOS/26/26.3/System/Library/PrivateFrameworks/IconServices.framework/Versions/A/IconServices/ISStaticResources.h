...
- (id)cacheMissIconResourceForPlatform:(unsigned long long)a0 variant:(unsigned long long)a1;
- (id)cacheMissIconResourceForVariant:(unsigned long long)a0;
...
- (id)fallbackResourceForHint:(id)a0 descriptor:(id)a1 referenceObj:(id)a2 variant:(unsigned long long)a3;
- (id)genericAppClipIconResource;
- (id)genericAppIconResource;
- (id)genericAppIconResourceForPlatform:(unsigned long long)a0 variant:(unsigned long long)a1;
