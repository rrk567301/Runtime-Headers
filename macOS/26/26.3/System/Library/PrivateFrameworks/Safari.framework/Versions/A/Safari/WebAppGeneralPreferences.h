@class NSTextField, TextFieldWithEnforcedPrefixFormatter, NSImage, NSLayoutConstraint, NSButton, NSObject;
...
@property (weak) NSLayoutConstraint *gridViewHeightConstraint;
