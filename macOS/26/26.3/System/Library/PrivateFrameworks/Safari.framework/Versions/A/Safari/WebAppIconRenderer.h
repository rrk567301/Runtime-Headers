...
+ (struct CGPath { } *)_newContinuousRoundedRectPath:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 cornerRadius:(double)a1;
...
+ (struct CGImage { } *)newChicletImageWithCGImage:(struct CGImage { } *)a0 fullLength:(double)a1 scale:(double)a2;
