...
@interface WebAppDocument : BrowserDocument <WKNavigationDelegate, WKUIDelegatePrivate> {
...
- (id)_defaultWebViewConfiguration;
...
- (BOOL)_shouldApplyDownloadPolicyForNavigationAction:(id)a0;
- (BOOL)_shouldDelegateToHandlerApplicationForNavigationAction:(id)a0 inWebView:(id)a1;
...
- (id)initWithURLRequest:(id)a0 configuration:(id)a1;
