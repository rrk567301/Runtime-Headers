@class NSString, NSArray, StartPageCollectionViewLayoutSection, NSAppearance, NSMutableDictionary, WBSRecentCloudTabsProvider, WBSRecentsStore, NSButton, NSMapTable;
...
@property (retain, nonatomic) NSString *deviceUUIDForStandaloneStartPage;
...
- (void)_cloudDevicesDidChange:(id)a0 previousDevices:(id)a1 previousItemsByDeviceUUID:(id)a2;
...
- (void)_filterDevicesForStandaloneStartPageIfNecessary;
...
- (id)initWithCompactAppearance:(BOOL)a0 forStandaloneStartPage:(BOOL)a1 forProfileWithIdentifier:(id)a2 forSideBarSection:(BOOL)a3 deviceUUIDForStandaloneStartPage:(id)a4;
