...
@interface LibrarySidebarNavigationViewController : NSViewController <SafariViewDelegate, LibraryViewControllerDelegate, BookmarksSidebarViewControllerDelegate, AnnotatedBookmarksSidebarViewControllerDelegate, SidebarStateRestorationContext, RolloverTrackingButtonDelegate> {
...
@property (class, copy, nonatomic) NSString *defaultSidebarViewMode;
...
- (void)_migrateSidebarBookmarksSortByPreferenceIfNeeded;
