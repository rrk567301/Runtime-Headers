@class NSString, NSMutableDictionary, _ASWebAuthenticationSessionRequestServer, NSMutableArray;
...
- (void)authenticationSessionRequestServerNeedsClientToReconnect:(id)a0 toBrowserWithApplicationIdentifier:(id)a1;
