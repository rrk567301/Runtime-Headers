...
- (void)removeAutomaticPasswordElementsInFrame:(id)a0 formID:(long long)a1 focusedPasswordControlUniqueID:(id)a2 passwordControlUniqueIDs:(id)a3;
- (void)removeAutomaticPasswordVisualTreatmentInFrame:(id)a0 formID:(long long)a1 passwordControlUniqueIDs:(id)a2;
