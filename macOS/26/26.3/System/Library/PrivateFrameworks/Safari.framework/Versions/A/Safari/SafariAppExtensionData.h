@class NSExtension, NSString, NSUUID, WKContentWorld, NSSet, AppExtensionContextMenu, NSDictionary, ExtensionWebsiteAccess, NSMutableDictionary, AppExtensionToolbarItem, NSMutableArray, NSNumber;
