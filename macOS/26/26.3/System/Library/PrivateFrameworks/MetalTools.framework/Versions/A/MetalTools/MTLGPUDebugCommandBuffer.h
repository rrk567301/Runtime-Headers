@class , MTLGPUDebugDevice, MTLGPUDebugCommandQueue, __end_;
...
@interface MTLGPUDebugCommandBuffer : MTLToolsCommandBuffer <MTLGPUDebugBufferEncoder> {
    ...
    struct vector<MetalBuffer, std::allocator<MetalBuffer>> { struct MetalBuffer *__begin_; struct MetalBuffer *__end_; struct { struct MetalBuffer *__cap_; } ; } _usedBuffers;
    ...
    struct vector<MTLGPUDebugBuffer *, std::allocator<MTLGPUDebugBuffer *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _usedBytesBuffers;
