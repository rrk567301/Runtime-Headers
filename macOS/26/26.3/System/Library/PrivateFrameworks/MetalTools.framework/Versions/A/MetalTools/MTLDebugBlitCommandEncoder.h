@class , __begin_, MTLDebugCommandBuffer, __end_;

@interface MTLDebugBlitCommandEncoder : MTLToolsBlitCommandEncoder {
    BOOL canDealloc;
    BOOL canEndEncoding;
    BOOL hasEndEncoding;
    struct deque<id, std::allocator<id>> { struct __split_buffer<id *, std::allocator<id *>> { __begin_ ***__first_; __end_ ***x0;  ***x1; struct { id **__cap_; } x2; } __map_; unsigned long long __start_; struct { unsigned long long __size_; } ; } updatedFences;
