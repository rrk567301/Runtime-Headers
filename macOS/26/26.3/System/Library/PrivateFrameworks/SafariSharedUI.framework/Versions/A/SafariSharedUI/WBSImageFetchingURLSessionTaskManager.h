...
- (void)_downloadFirstValidImageWithURLs:(id)a0 inURLSession:(id)a1 urlsToResponsesDictionary:(id)a2 failedURLDownloadsToErrorsDictionary:(id)a3 options:(unsigned long long)a4 completionHandler:(id /* block */)a5;
