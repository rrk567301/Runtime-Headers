...
@interface WBSExtensionsController : NSObject <_EXQueryControllerDelegate, WBSExtensionResourceVerifier, WBSCloudExtensionStateProvider, WBSExtensionsExportDataSource> {
...
- (id)_extensionStateForComposedIdentifier:(id)a0;
