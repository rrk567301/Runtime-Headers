...
- (void)_setMetadata:(id)a0 forURLString:(id)a1 lastFetchDate:(id)a2 lastFetchDidSucceed:(BOOL)a3 metadataHasImage:(BOOL)a4 lastFetchUsedWebView:(BOOL)a5 existingInfo:(id)a6 completionHandler:(id /* block */)a7;
...
- (void)setMetadata:(id)a0 forURLString:(id)a1 lastFetchDate:(id)a2 lastFetchDidSucceed:(BOOL)a3 metadataHasImage:(BOOL)a4 lastFetchUsedWebView:(BOOL)a5 completionHandler:(id /* block */)a6;
