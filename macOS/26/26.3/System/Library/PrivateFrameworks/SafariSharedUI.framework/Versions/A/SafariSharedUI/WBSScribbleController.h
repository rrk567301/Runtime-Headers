...
@property (readonly, nonatomic) BOOL hasPendingSelectionRequest;
...
- (void)hideSelectedElementAnimated:(BOOL)a0;
...
- (void)updateSelectionToPoint:(struct CGPoint { double x0; double x1; })a0 completionHandler:(id /* block */)a1;
