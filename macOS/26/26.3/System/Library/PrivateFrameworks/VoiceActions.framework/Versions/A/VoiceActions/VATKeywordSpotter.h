@class NSString, NSArray, FeatureExtractObjc, VATConfiguration;
...
@interface VATKeywordSpotter : NSObject {
    ...
    BOOL _isRunning;
    struct vector<voiceactions::FstSpotterResults, std::allocator<voiceactions::FstSpotterResults>> { struct FstSpotterResults *__begin_; struct FstSpotterResults *__end_; struct { struct FstSpotterResults *__cap_; } ; } _keywordResults;
...
+ (id)pronounciationsFor:(id)a0 wordSeparator:(id)a1 prefixWithPhrase:(BOOL)a2;
