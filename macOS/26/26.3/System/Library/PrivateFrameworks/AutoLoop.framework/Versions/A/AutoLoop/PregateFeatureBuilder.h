...
@property struct vector<CMTime, std::allocator<CMTime>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } frameTimes;
@property struct vector<FloatPoint, std::allocator<FloatPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } frameOffsets;
@property struct vector<FloatPoint, std::allocator<FloatPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } frameBlurVectors;
