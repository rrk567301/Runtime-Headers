...
@property (readonly, nonatomic) BOOL supportPersonasIfAvailable;
@property (readonly, nonatomic) BOOL requireDataBackedPersona;
@property (readonly, nonatomic) BOOL warnIfNotDataBackedPersona;
...
- (void).cxx_destruct;
- (id)_containerIdentityMigrationsFromPlistValue:(id)a0 error:(id *)a1;
