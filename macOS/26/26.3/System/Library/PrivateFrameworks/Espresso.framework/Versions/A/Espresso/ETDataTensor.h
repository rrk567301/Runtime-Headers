...
@property struct vector<std::shared_ptr<unsigned char>, std::allocator<std::shared_ptr<unsigned char>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } allocatedImageData;
