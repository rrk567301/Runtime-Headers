@class , NSString, NSArray, ETImagePreprocessor, __end_;

@interface ETImageFolderDataProvider : NSObject <ETDataProvider> {
    struct vector<std::pair<NSString *, unsigned long>, std::allocator<std::pair<NSString *, unsigned long>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } samples;
    struct vector<NSString *, std::allocator<NSString *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } classes;
