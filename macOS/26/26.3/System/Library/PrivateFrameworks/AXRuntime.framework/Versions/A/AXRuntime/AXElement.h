...
@property (readonly, nonatomic) BOOL hoverTypingShouldAdjustDockedMode;
...
+ (id)elementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 withVisualPadding:(BOOL)a1 allowSameProcess:(BOOL)a2;
+ (id)elementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 withVisualPadding:(BOOL)a1 displayID:(unsigned int)a2;
+ (id)elementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 withVisualPadding:(BOOL)a1 displayID:(unsigned int)a2 allowSameProcess:(BOOL)a3;
...
- (BOOL)setNativeFocus;
- (BOOL)simulateTapWithFingerIndex:(unsigned long long)a0;
- (BOOL)simulateTapWithFingerIndex:(unsigned long long)a0 withPoint:(struct CGPoint { double x0; double x1; })a1;
