...
- (void)handleContinuityCameraConfirmationWithID:(id)a0 fromDevice:(id)a1 completionHandler:(id /* block */)a2;
- (void)handleMicOnlyConfirmationWithID:(id)a0 fromDevice:(id)a1 completionHandler:(id /* block */)a2;
