...
@interface BTMManager : NSObject <BTMForceQuitHandlerClient> {
    long long _mode;
    NSHashTable *_lists;
...
- (long long)checkBackgroundAppRefreshAllowedForAppURL:(id)a0 shouldNotify:(BOOL)a1 uid:(unsigned int)a2 allowed:(BOOL *)a3;
- (long long)checkBackgroundAppRefreshAllowedForAppURL:(id)a0 shouldRegister:(BOOL)a1 uid:(unsigned int)a2 allowed:(BOOL *)a3;
- (long long)checkTasksAllowedInBackgroundForAppURL:(id)a0 allowed:(BOOL *)a1;
- (void)checkTasksAllowedInBackgroundForAppURL:(id)a0 completion:(id /* block */)a1;
- (long long)checkTasksAllowedInBackgroundForAppURL:(id)a0 shouldRegister:(BOOL)a1 allowed:(BOOL *)a2;
...
- (void)forceQuitAppWithURL:(id)a0;
...
- (void)getTasksAllowedInBackgroundForAppURL:(id)a0 completion:(id /* block */)a1;
...
- (long long)lightweightCheckTasksAllowedInBackgroundForAppURL:(id)a0 allowed:(BOOL *)a1 notified:(BOOL *)a2;
- (id)mdmPayloadForIdentifier:(id)a0;
- (void)noteLogoutForUID:(unsigned int)a0;
- (void)openLoginItemsWithCompletion:(id /* block */)a0;
- (long long)promptUserToAlwaysAllowQuittingASN:(struct __LSASN { } *)a0;
- (long long)promptUserToAlwaysAllowQuittingURL:(id)a0;
- (void)refreshManagedItems;
- (BOOL)registerForceQuitHandler:(id)a0;
...
- (BOOL)setTasksAllowedInBackground:(BOOL)a0 forAppURL:(id)a1;
