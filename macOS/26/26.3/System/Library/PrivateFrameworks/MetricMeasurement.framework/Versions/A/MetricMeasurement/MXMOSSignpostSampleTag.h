...
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationUpdateTimeP90;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationRenderTimeP90;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationGPUTimeP90;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationRenderGPUTimeP90;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationNumberOfOffscreenPassesP90;
...
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationPerAppNonFirstFrameGlitchTimeRatioAdjusted;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationPerAppNonFirstFrameNumberOfGlitches;
@property (class, readonly, copy, nonatomic) MXMOSSignpostSampleTag *animationPerAppNonFirstFrameGlitchesTotalDuration;
