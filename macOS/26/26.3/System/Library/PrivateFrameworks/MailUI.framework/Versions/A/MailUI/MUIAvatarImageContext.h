...
- (void).cxx_destruct;
- (BOOL)isEqual:(id)a0;
- (id)initWithCategory:(id)a0 emailAddress:(id)a1 businessLogoID:(id)a2 isAuthenticated:(BOOL)a3 reducePlaceholderImage:(BOOL)a4 brandIndicatorLocation:(id)a5 scale:(double)a6 isRTL:(BOOL)a7;
- (id)initWithMessageListItem:(id)a0;
- (id)initWithMessageListItem:(id)a0 reducePlaceholderImage:(BOOL)a1;
- (id)initWithMessageListItem:(id)a0 showRecipient:(BOOL)a1 reducePlaceholderImage:(BOOL)a2;
