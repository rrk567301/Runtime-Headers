...
- (id)_replacementStringForSubstitutionString:(id)a0 repeatCount:(unsigned long long)a1 speakWithCount:(BOOL)a2;
- (id)_spokenStringForIndentationResult:(id)a0 stringsFileName:(id)a1 domainIdentifier:(id)a2 punctuationSettings:(id)a3;
- (id)_spokenStringForPunctuationResult:(id)a0 stringsFileName:(id)a1 domainIdentifier:(id)a2 punctuationSettings:(id)a3 locale:(id)a4;
- (id)_spokenStringForUnalignedIndentation:(id)a0 stringsFileName:(id)a1 domainIdentifier:(id)a2 punctuationSettings:(id)a3;
- (id)_spokenStringForWhitespaceResult:(id)a0;
