...
@interface GTShaderProfilerBinaryAnalysisResult : NSObject <NSSecureCoding> {
    struct GTShaderProfilerBinaryInfo { struct vector<GTWaitInstructionInfo, std::allocator<GTWaitInstructionInfo>> { struct GTWaitInstructionInfo *__begin_; struct GTWaitInstructionInfo *__end_; struct { struct GTWaitInstructionInfo *__cap_; } ; } waitInfos; struct GTRegisterPressureInfo { unsigned int allocGPRCount; struct vector<GTRegisterPressureInstructionInfo, std::allocator<GTRegisterPressureInstructionInfo>> { struct GTRegisterPressureInstructionInfo *__begin_; struct GTRegisterPressureInstructionInfo *__end_; struct { struct GTRegisterPressureInstructionInfo *__cap_; } ; } instructionRegisterPressureInfos; } binaryRegisterPressureInfo; struct vector<std::string, std::allocator<std::string>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } stringTable; struct vector<GTShaderProfilerShaderInstructionInfo, std::allocator<GTShaderProfilerShaderInstructionInfo>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } instructions; struct vector<GTShaderProfilerShaderTargetClause, std::allocator<GTShaderProfilerShaderTargetClause>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } targetClauses; struct vector<GTShaderProfilerShaderBranchTarget, std::allocator<GTShaderProfilerShaderBranchTarget>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } branchTargets; struct vector<GTShaderProfilerDebugBinaryLocation, std::allocator<GTShaderProfilerDebugBinaryLocation>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } binaryLocations; struct vector<GTShaderProfilerDebugBinaryRange, std::allocator<GTShaderProfilerDebugBinaryRange>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } binaryRanges; struct vector<GTShaderProfilerInstructionRegisterInfo, std::allocator<GTShaderProfilerInstructionRegisterInfo>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } registers; } _binaryInfo;
    void *_pBinaryInfo;
    NSArray *_strings;
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; struct { unsigned long long *__cap_; } ; } _registerOffsets;
}
