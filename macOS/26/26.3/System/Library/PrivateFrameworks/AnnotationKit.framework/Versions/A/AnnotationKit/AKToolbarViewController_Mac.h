...
@interface AKToolbarViewController_Mac : AKToolbarViewController <NSMenuItemValidation, AKToolbarColorWellItem_Mac_Delegate, AKPopoverColorWellDelegate, NSPopoverDelegate> {
...
- (id)_createSignatureAnnotationWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (double)_currentMaxHDRGain;
- (BOOL)_isApplicationDataTooLargeForSidecar;
- (BOOL)_isIntelMac;
...
- (void)colorWellDidMoveToWindow:(id)a0;
- (void)displaySignaturePopoverOnSender:(id)a0;
...
- (void)insertSignature:(id)a0 atBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)lineStyleButtonClicked:(id)a0;
- (void)popoverColorWellDidActivate:(id)a0;
- (void)popoverColorWellDidDeactivate:(id)a0;
- (BOOL)popoverColorWellShouldPreventDeactivation:(id)a0;
- (void)revalidateHDR;
- (void)revalidateHDRandPropagateChanges:(BOOL)a0;
- (void)setFillColorUIDisplayToColor:(id)a0;
- (void)shapeButtonClicked:(id)a0;
- (BOOL)shouldIncludeRotation;
- (void)showAddSignatureView;
...
- (void)updateColorWellActivation:(id)a0;
