...
- (struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>> { struct { void *x0; } **x0; })extractDataForJointIdx:(unsigned long long)a0 fromPoseTimeArray:(id)a1;
