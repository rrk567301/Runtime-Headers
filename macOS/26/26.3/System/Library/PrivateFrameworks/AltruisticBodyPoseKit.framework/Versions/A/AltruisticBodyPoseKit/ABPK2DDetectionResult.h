...
@interface ABPK2DDetectionResult : NSObject <NSSecureCoding> {
    struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _rawJoints;
    struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _rotatedJoints;
    struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; struct { unsigned int *__cap_; } ; } _jointTrackingStates;
}
...
- (id)initWithJoints:(const void *)a0 trackingStates:(const unsigned int *)a1 numberOfJoints:(unsigned long long)a2 aligningPreviousSkeleton:(id)a3 rotation:(long long)a4;
