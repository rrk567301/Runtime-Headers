...
@interface ABPKSkeletonDefinition : NSObject {
    NSArray *_jointNames;
    struct vector<long, std::allocator<long>> { long long *__begin_; long long *__end_; struct { long long *__cap_; } ; } _jointParentIndicesVector;
    struct map<long, std::vector<long>, std::less<long>, std::allocator<std::pair<const long, std::vector<long>>>> { struct __tree<std::__value_type<long, std::vector<long>>, std::__map_value_compare<long, std::__value_type<long, std::vector<long>>, std::less<long>>, std::allocator<std::__value_type<long, std::vector<long>>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _parentsToChildIndicesMap;
