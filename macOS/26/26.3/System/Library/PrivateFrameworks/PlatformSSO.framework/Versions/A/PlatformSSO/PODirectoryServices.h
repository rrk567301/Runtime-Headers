...
- (BOOL)createTempUserHomeDirectory;
...
- (id)profilePictureForUser:(id)a0;
...
- (BOOL)updateFullName:(id)a0 forGroup:(id)a1;
- (BOOL)updateProfilePicture:(id)a0 forUser:(id)a1;
