@class NSData, WBSAutoFillAssociatedDomainsManager, NSURL, NSString, NSSet, WBSGlobalFrameIdentifier, WBSStringQuery, WBSSavedAccountContext;
...
- (id)initWithAppID:(id)a0 options:(unsigned long long)a1 userNameQuery:(id)a2;
