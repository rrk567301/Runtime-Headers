...
- (void)notifyUpdateRequestedForNodeID:(id)a0 isUserTriggered:(BOOL)a1 isRetry:(BOOL)a2 timeZone:(id)a3;
...
- (void)triggerQueryImageWithPairing:(id)a0 initiationType:(unsigned long long)a1 requestParams:(id)a2 completionHandler:(id /* block */)a3;
