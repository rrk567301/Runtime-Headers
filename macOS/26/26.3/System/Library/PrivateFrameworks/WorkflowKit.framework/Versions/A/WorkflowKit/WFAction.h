@class WFWorkflowActionTree, NSDictionary, WFActionAuxiliaryButton, WFInterchangeApp, WFWorkflow, WFParameter, NSString, WFUserVisibleString, WFColor, NSError, WFActionSessionKitSessionConfiguration, NSAttributedString, NSArray, NSMutableDictionary, WFAppInstalledResource, WFResourceManager, WFActionDefinition, WFToolInvocation, WFContentCollection, NSObject, WFActionParameterSummary, NSSet, WFIcon, WFContentAttributionTracker, WFLocalizationContext, WFContactStore, INAppDescriptor, WFActionDescriptionDefinition, NSProgress, NSHashTable;
...
@property (readonly, nonatomic, getter=requiresUpdatedHome) BOOL requiresUpdatedHome;
...
@property (readonly, nonatomic) BOOL defaultParameterSummaryContainsRequiredParameters;
@property (readonly, nonatomic) BOOL prefersBackgroundExecutionForSpotlight;
...
@property (readonly, nonatomic) BOOL runningViaSpotlight;
@property (nonatomic) BOOL shouldSkipLoadingAsynchronousDefaultValue;
...
@property (readonly, nonatomic) BOOL isEligibleForOutputVariable;
...
- (void)populateFailedRunEventProperties:(id)a0 withRunError:(id)a1;
- (void)populateSuccessfulRunEventProperties:(id)a0;
...
- (id)possibleContentClassesForVariableNamed:(id)a0;
- (id)possibleContentClassesForVariableWithOutputUUID:(id)a0;
...
- (void)_finishRunningWithError:(id)a0;
...
- (void)snapInputParameterToVariable:(id)a0;
