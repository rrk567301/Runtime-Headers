...
- (long long)validIndexForInsertingActionAtIndex:(long long)a0 insertionPreference:(long long)a1;
...
- (BOOL)isActionOutputWithIDAvailable:(id)a0 atIndex:(long long)a1;
- (BOOL)isVariableNameAvailable:(id)a0 atIndex:(long long)a1;
