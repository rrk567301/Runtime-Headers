@class NSHashTable, NSString, NSManagedObjectContext, WFLibrary, NSURL, WFCoreDataChangeNotification, NSArray, NSMutableSet, NSObject, NSPersistentStoreDescription, WFDebouncer;
...
- (BOOL)deleteReference:(id)a0 tombstone:(BOOL)a1 error:(id *)a2;
- (void)deleteShortcutSuggestionsFromApps:(id)a0;
- (BOOL)deleteWorkflowRecordWithIdentifier:(id)a0 error:(id *)a1;
- (id)desiredFolderSyncOperationForCollection:(id)a0;
- (id)desiredOrderingSyncOperationForCollection:(id)a0;
- (id)desiredSyncOperationForWorkflow:(id)a0;
...
- (BOOL)handleUploadedWorkflowRecordWithIdentifier:(id)a0 cloudKitMetadata:(id)a1 syncHash:(long long)a2 encryptedSchemaVersion:(long long)a3 error:(id *)a4;
- (id)initWithPersistenceMode:(unsigned long long)a0 error:(id *)a1;
...
- (BOOL)setCloudKitMetadata:(id)a0 forWorkflowRecordWithIdentifier:(id)a1 error:(id *)a2;
...
- (id)storeTrackedFilesystemNodeWithIdentifier:(id)a0 bookmark:(id)a1 contents:(id)a2 triggers:(id)a3 isDirectory:(BOOL)a4 ignoringSubfolders:(BOOL)a5 error:(id *)a6;
...
- (void)addWorkflowIdentifiersToLibraryRootCollection:(id)a0;
...
- (id)conflictingReferenceForWorkflowID:(id)a0;
...
- (BOOL)hasConflictingReferenceForWorkflowID:(id)a0;
- (BOOL)hasVisibleWorkflowsWithName:(id)a0;
- (id)initWithPersistenceMode:(unsigned long long)a0 fileURL:(id)a1 error:(id *)a2;
- (id)initWithTestFileURL:(id)a0 error:(id *)a1;
...
- (void)updateLibraryWithNewWorkflowID:(id)a0 adjacentToExistingWorkflowID:(id)a1;
...
- (void)writeCapsuleDataAndUpdatedSyncHashToCoreDataLibrary:(id)a0;
