...
@property (readonly) BOOL softwareUpdateAssetType;
@property (readonly) BOOL softwareUpdateEraseInstall;
@property (readonly) BOOL forceInstall;
...
- (void)setSoftwareUpdateAssetType:(BOOL)a0;
...
- (void)setSoftwareUpdateEraseInstall:(BOOL)a0;
