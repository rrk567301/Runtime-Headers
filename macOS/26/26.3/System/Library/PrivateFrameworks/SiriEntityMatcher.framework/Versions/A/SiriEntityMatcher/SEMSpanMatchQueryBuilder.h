...
@interface SEMSpanMatchQueryBuilder : NSObject {
    ...
    struct TokenStream { struct Token *__begin_; struct Token *__end_; struct { struct Token *__cap_; } ; } _tokens;
    struct TokenStream { struct Token *__begin_; struct Token *__end_; struct { struct Token *__cap_; } ; } _normalized_tokens;
