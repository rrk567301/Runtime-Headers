...
- (struct vector<__fp16, std::allocator<__fp16>> { void /* unknown type, blank encoding */ *x0; void /* unknown type, blank encoding */ *x1; struct { void /* unknown type, blank encoding */ *x0; } x2; })generateGridKeypointsWithMaxKeypoints:(float)a0 minGridFrequency:(int)a1;
