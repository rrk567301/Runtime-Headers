...
@interface AMSUIWebBuyAction : AMSUIWebAction <AMSUIViewServiceWindowProvider, AMSUIPurchaseDelegate, AMSUIWebActionRunnable>
...
- (id)_runBuy;
- (id)_configurePaymentViewServiceListenerForPurchase:(id)a0;
- (id)_iTunesAccount;
- (void)_makeCurrentAccountIfNeeded:(id)a0;
- (id)_purchasePluginIdentifierForContentType:(id)a0;
- (id)_runBuyWithContentType:(id)a0;
- (id)configurePurchaseWithBuyParams:(id)a0 isUserInitiated:(BOOL)a1 clientInfo:(id)a2 requiresAccount:(BOOL)a3 additionalHeaders:(id)a4 sendBlindedData:(id)a5 metricsOverlay:(id)a6 performanceMetricsOverlay:(id)a7;
- (id)initWithJSObject:(id)a0 context:(id)a1;
- (id)purchase:(id)a0 handleWindowRequest:(id)a1 error:(id *)a2;
- (id)purchaseContentWithType:(id)a0;
- (id)runAction;
- (id)windowForPresentation;
