@class AMSUIWebNavigationBarModel, NSString, AMSUIWebAppearance, NSDictionary, AMSBinaryPromise, NSViewController, AMSUIWebClientContext, AMSUICommonNavigationItem, NSNumber, AMSUIWebPageRenderMetricsPresenterWrapper;
...
@property (retain) AMSUIWebPageRenderMetricsPresenterWrapper *pageRenderPresenter;
...
- (void)replaceContentWithViewController:(id)a0 animated:(BOOL)a1 pageModel:(id)a2 completion:(id /* block */)a3;
