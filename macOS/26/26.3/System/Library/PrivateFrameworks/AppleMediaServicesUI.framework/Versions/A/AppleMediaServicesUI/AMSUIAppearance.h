...
+ (BOOL)_isBannerStyle:(unsigned long long)a0;
...
+ (id)_anchorIdentifierWithDictionary:(id)a0;
...
+ (id)_defaultButtonContentColorForStyle:(unsigned long long)a0;
+ (id)_defaultButtonIconColorForStyle:(unsigned long long)a0;
+ (id)_defaultButtonTextColorForStyle:(unsigned long long)a0;
+ (id)_defaultMessageColorForStyle:(unsigned long long)a0;
...
+ (id)_footerButtonBackgroundColorWithDictionary:(id)a0;
...
+ (BOOL)_isBubbleTipStyle:(unsigned long long)a0;
