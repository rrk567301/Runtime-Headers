...
- (void).cxx_destruct;
- (struct vector<CHFastGroupingCluster, std::allocator<CHFastGroupingCluster>> { struct CHFastGroupingCluster *x0; struct CHFastGroupingCluster *x1; struct { struct CHFastGroupingCluster *x0; } x2; })clustersForStrokes:(id)a0 shouldMakeSingleCluster:(BOOL)a1 anchorPoints:(unsigned long long)a2;
...
- (id)groupingResultUsingStrokes:(id)a0 distanceMetric:(int)a1 mergingDistanceThreshold:(double)a2 clusteringLinkage:(int)a3 anchorPoints:(unsigned long long)a4 shouldCancel:(id /* block */)a5;
