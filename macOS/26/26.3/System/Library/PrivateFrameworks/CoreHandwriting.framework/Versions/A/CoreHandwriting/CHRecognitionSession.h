@class NSMutableDictionary, NSObject, CHTextInputQuery, CHSessionStateTracker, NSOrderedSet, CHRecognitionSessionVersion, NSMutableArray, NSString, NSHashTable, CHRecognitionSessionResult, CHRemoteTextSynthesizer, NSArray, NSData, CHMathRecognizer;
@protocol CHDocumentLayoutAnalyzing, CHSynthesizingText, CHLineWrapperProviding, OS_dispatch_queue, CHCanvasAttachmentProvider, CHRecognitionSessionDataSource, CHCalculateDocumentProvider, CHStrokeProvider;
...
@interface CHRecognitionSession : NSObject <CHRecognitionSessionTaskDelegate, CHRecognitionSessionTextInputTaskDelegate, NSSecureCoding> {
    ...
    BOOL __skipMathTransliterations;
...
@property (nonatomic) BOOL skipMathTransliterations;
...
- (id)synthesizeTokensForString:(id)a0 point:(struct CGPoint { double x0; double x1; })a1 synthesisOptions:(id)a2 completion:(id /* block */)a3 shouldCancel:(id /* block */)a4;
