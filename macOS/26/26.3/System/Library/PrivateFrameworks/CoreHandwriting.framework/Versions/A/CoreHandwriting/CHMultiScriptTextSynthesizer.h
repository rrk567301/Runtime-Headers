...
+ (id)stringForSynthesizerSuggestion:(long long)a0;
+ (id)chunksForFeatures:(const void *)a0 metadata:(struct CHDiffusionPipelinePreprocessingExecutionMetadata { struct vector<CoreHandwriting::synthesis::CHDiffusionPipelineReplacementData, std::allocator<CoreHandwriting::synthesis::CHDiffusionPipelineReplacementData>> { struct CHDiffusionPipelineReplacementData *x0; struct CHDiffusionPipelineReplacementData *x1; struct { struct CHDiffusionPipelineReplacementData *x0; } x2; } x0; unsigned long long x1; })a1 mode:(long long)a2;
...
+ (int)pipelineModeFromSynthesizerMode:(long long)a0;
+ (id)rescaleAndShiftSynthesizedDrawing:(id)a0 original:(id)a1;
+ (id)stringForSynthesizerMode:(long long)a0;
...
- (id)chunkForSynthesisString:(id)a0 allowedSynthesizers:(id)a1 mode:(id)a2;
