...
@interface CHRecognizer : NSObject <CHRecognizingText> {
    ...
    struct map<std::set<long>, std::vector<CHCandidateResult>, std::less<std::set<long>>, std::allocator<std::pair<const std::set<long>, std::vector<CHCandidateResult>>>> { struct __tree<std::__value_type<std::set<long>, std::vector<CHCandidateResult>>, std::__map_value_compare<std::set<long>, std::__value_type<std::set<long>, std::vector<CHCandidateResult>>, std::less<std::set<long>>>, std::allocator<std::__value_type<std::set<long>, std::vector<CHCandidateResult>>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _cachedResults;
    struct map<unsigned int, unsigned int, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, unsigned int>>> { struct __tree<std::__value_type<unsigned int, unsigned int>, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, unsigned int>, std::less<unsigned int>>, std::allocator<std::__value_type<unsigned int, unsigned int>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _characterIDMap;
}
...
+ (id)inputLocalesFromRecognitionOptions:(id)a0;
...
- (struct vector<const void *, std::allocator<const void *>> { void **x0; void **x1; struct { void **x0; } x2; })completionsForCandidate:(id)a0 candidateContext:(id)a1 prefix:(id)a2 option:(unsigned long long)a3;
- (struct vector<const void *, std::allocator<const void *>> { void **x0; void **x1; struct { void **x0; } x2; })completionsForCandidate:(id)a0 prefix:(id)a1 option:(unsigned long long)a2;
