...
@protocol VUIPlaybackMetricsQueueManagerDelegate, VUITabBarProtocol, VUIMusicManager, VUIControllerPresenter, VUILanguageAwareStringHandling, VUIDocumentCreator, VUIOpenURLHandling, VUITimedMetadataManager, VUIDownloadQueueManager, VUITVAppRootViewController, VUIBackgroundTaskManager;
