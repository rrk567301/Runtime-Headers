@class NSView, NSString, NSImageSymbolConfiguration, NSColor, VUITextLayout, VUIDownloadButtonActionHandler, NSImage, CAShapeLayer, VUICircularProgress, NSViewController, VUIDownloadButtonViewModel;
...
- (id)_buttonPropertiesForState:(unsigned long long)a0 isExpired:(BOOL)a1 isExpiringSoon:(BOOL)a2 hasFailed:(BOOL)a3 isAutoDownload:(BOOL)a4;
- (void)_clearMasks;
- (void)_configureProgressIndicatorWithProperties:(id)a0;
- (BOOL)_hasTextForNotDownloadState;
- (id)_imageForDownloadState:(unsigned long long)a0 isExpired:(BOOL)a1 isExpiringSoon:(BOOL)a2 hasFailed:(BOOL)a3 isAutoDownload:(BOOL)a4;
...
- (id)_localButtonPropertiesForState:(unsigned long long)a0 isExpired:(BOOL)a1 isExpiringSoon:(BOOL)a2 hasFailed:(BOOL)a3 isAutoDownload:(BOOL)a4;
- (id)_remoteButtonPropertiesForState:(unsigned long long)a0 isExpired:(BOOL)a1 isExpiringSoon:(BOOL)a2 hasFailed:(BOOL)a3;
- (void)_setTitleAndImageWithProperties:(id)a0;
- (void)_setTitleWithProperties:(id)a0;
- (void)_setupDownloadButton;
- (void)_setupProgressIndicatorForState:(unsigned long long)a0 WithProperties:(id)a1 shouldObserveProgress:(BOOL)a2;
...
- (void)_updateButtonToState:(unsigned long long)a0 isExpired:(BOOL)a1 isExpiringSoon:(BOOL)a2 hasFailed:(BOOL)a3 isAutoDownload:(BOOL)a4;
