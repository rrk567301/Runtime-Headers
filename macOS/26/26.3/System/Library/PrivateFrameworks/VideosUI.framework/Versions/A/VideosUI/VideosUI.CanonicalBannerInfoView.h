@interface VideosUI.CanonicalBannerInfoView : VUIBaseView {
    void /* unknown type, empty encoding */ debugLineRects;
    void /* unknown type, empty encoding */ bannerLayout;
    void /* unknown type, empty encoding */ buttonViewModels;
    void /* unknown type, empty encoding */ parentViewWidth;
    ...
    void /* unknown type, empty encoding */ genresAndProviderTagsView;
    void /* unknown type, empty encoding */ metadataAndBadgesTagsView;
