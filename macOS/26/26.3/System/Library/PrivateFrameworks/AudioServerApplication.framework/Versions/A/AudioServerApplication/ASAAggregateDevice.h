...
- (id)initWithDevices:(id)a0 usingMainDevice:(id)a1 andClockDevice:(id)a2 withName:(id)a3 withUID:(id)a4 isPrivate:(BOOL)a5 withIsolatedUseCaseID:(unsigned int)a6;
- (id)initWithDevices:(id)a0 usingMainDevice:(id)a1 andClockDeviceUID:(id)a2 withName:(id)a3 withUID:(id)a4 isPrivate:(BOOL)a5;
- (id)initWithDevices:(id)a0 usingMainDevice:(id)a1 andClockDeviceUID:(id)a2 withName:(id)a3 withUID:(id)a4 isPrivate:(BOOL)a5 withIsolatedUseCaseID:(unsigned int)a6;
