...
+ (id)decryptData:(id)a0 withCryptoInfo:(id)a1 capability:(unsigned long long)a2 error:(id *)a3;
+ (id)encryptData:(id)a0 withCryptoInfo:(id)a1 capability:(unsigned long long)a2 error:(id *)a3;
