...
- (id)initWithName:(id)a0 modelPartIndexToResourcePartIndexMap:(SEL)a1 skeletonCount:(id)a2 skinningModel:(id)a3 blendShapeModel:(unsigned int)a4 lods:(id)a5 boundingBoxMin:(id)a6 boundingBoxMax:(id)a7;
