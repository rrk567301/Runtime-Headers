@class IDSAccount, NSString, IDSDirectMessageConnection, NSSet, IMOrderedMutableDictionary, NSDictionary, NSMapTable, IMSystemMonitor;
...
- (void)inviteDroppedWithPayload:(id)a0 forTopic:(id)a1 sessionID:(id)a2 toIdentifier:(id)a3 fromID:(id)a4 error:(id)a5;
- (void)pendingIncomingMessageWithGUID:(id)a0 forTopic:(id)a1 toURI:(id)a2 fromURI:(id)a3 context:(id)a4;
- (void)receivedBatchMessage:(id)a0 forTopic:(id)a1;
...
- (void)_connect;
- (void)didReceiveLocalNetworkHandshake:(id)a0 handshakeSucceeded:(BOOL)a1 forTopic:(id)a2 sessionID:(id)a3 toIdentifier:(id)a4 fromID:(id)a5 error:(id)a6;
- (id)daemonController;
