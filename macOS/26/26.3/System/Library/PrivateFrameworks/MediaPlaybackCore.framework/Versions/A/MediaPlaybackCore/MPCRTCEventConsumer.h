@class NSString, MPCPlaybackEngineEvent, NSDictionary, NSObject;
...
- (void)_updateAssetSelectionEvent:(id)a0 fromAssetLoadEndEvent:(id)a1 untilAssetLoadBeginEvent:(id)a2 cursor:(id)a3;
