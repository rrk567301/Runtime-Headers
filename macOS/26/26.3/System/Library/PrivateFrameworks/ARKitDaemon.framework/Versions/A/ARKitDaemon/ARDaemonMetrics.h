...
- (void)_reportCoreAnalyticsDaemonEventWithServiceName:(id)a0 clientBundleIdentifier:(id)a1 isServiceRemoved:(BOOL)a2 isDisconnectingClient:(BOOL)a3;
- (void)_reportDaemonHeartbeatForSessionUUID:(id)a0 daemonUpTimeExcludingSleepMinutes:(unsigned long long)a1 daemonUpTimeIncludingSleepMinutes:(unsigned long long)a2 systemUpTimeMinutes:(unsigned long long)a3 memoryFootprintInBytes:(unsigned long long)a4;
