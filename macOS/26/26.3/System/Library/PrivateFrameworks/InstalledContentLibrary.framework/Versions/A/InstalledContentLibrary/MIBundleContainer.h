...
@property (readonly, nonatomic) BOOL hasSerializedPlaceholder;
...
+ (id)appBundleContainerWithIdentifier:(id)a0 forPersona:(id)a1 createIfNeeded:(BOOL)a2 created:(BOOL *)a3 error:(id *)a4;
...
- (id)initWithContainerURL:(id)a0 expectAppWithin:(BOOL)a1 error:(id *)a2;
