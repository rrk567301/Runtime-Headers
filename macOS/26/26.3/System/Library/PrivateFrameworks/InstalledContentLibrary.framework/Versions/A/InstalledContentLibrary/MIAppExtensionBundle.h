...
@property (readonly, nonatomic) BOOL targetsDevelopmentOnlyBrowserExtensionPoint;
@property (readonly, nonatomic) BOOL targetsBrowserContentExtensionPoint;
@property (readonly, nonatomic) BOOL targetsBrowserRenderingExtensionPoint;
@property (readonly, nonatomic) BOOL targetsBrowserNetworkingExtensionPoint;
