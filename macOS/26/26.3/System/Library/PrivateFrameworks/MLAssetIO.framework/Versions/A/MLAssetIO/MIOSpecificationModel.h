...
@interface MIOSpecificationModel : NSObject <MIOModeling> {
    struct unique_ptr<MIL::IRProgram, std::default_delete<MIL::IRProgram>> { struct { struct IRProgram *__ptr_; } ; } _irProgram;
    struct vector<MIOFunctionInfo, std::allocator<MIOFunctionInfo>> { struct MIOFunctionInfo *__begin_; struct MIOFunctionInfo *__end_; struct { struct MIOFunctionInfo *__cap_; } ; } _functions;
}
