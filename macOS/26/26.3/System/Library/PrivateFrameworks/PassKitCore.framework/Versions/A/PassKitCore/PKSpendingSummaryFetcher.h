...
- (id)_summaryForComparisonForPeriodStartingWithDate:(id)a0 endDate:(id)a1 type:(unsigned long long)a2;
- (void)availableSummaries:(id /* block */)a0;
- (id)cachedSpendingSummaryStartingWithDate:(id)a0 type:(unsigned long long)a1;
- (id)categoryTotalSpendingSummaryStartingWithDate:(id)a0 type:(unsigned long long)a1;
