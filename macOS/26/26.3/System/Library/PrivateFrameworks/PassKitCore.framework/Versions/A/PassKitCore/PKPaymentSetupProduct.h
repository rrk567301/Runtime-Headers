...
@property (readonly, nonatomic) BOOL showOtherProviders;
...
- (BOOL)hasPaymentOptionMatching:(long long)a0;
- (BOOL)isCarKey;
- (id)provisioningMethodMetadataForMethod:(id)a0;
- (id)provisioningMethodMetadataForType:(id)a0;
- (id)provisioningMethodTypes;
- (void)setProvisioningMethodMetadata:(id)a0 forMethod:(id)a1;
- (void)setProvisioningMethodMetadata:(id)a0 forType:(id)a1;
- (id)setupProductMethodOfType:(unsigned long long)a0 withIdentifier:(id)a1;
- (id)setupProductMethodsOfType:(unsigned long long)a0;
- (BOOL)supportsDeviceOS:(id)a0;
- (BOOL)supportsOSVersion:(id)a0 deviceClass:(id)a1 minimumOSVersion:(id)a2;
- (BOOL)supportsSetupProductMethodForType:(unsigned long long)a0;
- (BOOL)updateSupportWithOSVersion:(id)a0 deviceClass:(id)a1 deviceRegion:(id)a2;
- (BOOL)updateSupportWithOSVersion:(id)a0 deviceClass:(id)a1 deviceRegion:(id)a2 deviceVersion:(id)a3;
