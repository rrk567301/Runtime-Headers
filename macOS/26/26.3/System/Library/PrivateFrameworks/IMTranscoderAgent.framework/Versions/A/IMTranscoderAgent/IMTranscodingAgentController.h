...
- (BOOL)checkPath:(id)a0 withSizes:(id)a1;
- (void)decodeiMessageAppPayload:(id)a0 senderContext:(id)a1 bundleID:(id)a2 completionBlock:(id /* block */)a3;
- (void)generatePosterConfig:(id)a0 destinationURL:(id)a1 senderContext:(id)a2 completionBlock:(id /* block */)a3;
...
- (id)generateReadOnlyPosterConfig:(id)a0 error:(id *)a1;
