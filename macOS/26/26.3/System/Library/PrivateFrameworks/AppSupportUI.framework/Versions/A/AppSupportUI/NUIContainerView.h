@class , NSArray, NSView, NSMutableArray, __end_;
@protocol NUIContainerViewDelegate;

@interface NUIContainerView : NSView {
    BOOL _isRTL;
    id<NUIContainerViewDelegate> _delegate;
    struct map<NSView *, _NUIContainerViewArrangedSubview, std::less<NSView *>, std::allocator<std::pair<NSView *const, _NUIContainerViewArrangedSubview>>> { struct __tree<std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, std::__map_value_compare<NSView *, std::__value_type<NSView *, _NUIContainerViewArrangedSubview>, std::less<NSView *>>, std::allocator<std::__value_type<NSView *, _NUIContainerViewArrangedSubview>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _arrangedSubviewInfo;
    ...
    struct vector<CALayer *, std::allocator<CALayer *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _debugBoundingBoxLayers;
