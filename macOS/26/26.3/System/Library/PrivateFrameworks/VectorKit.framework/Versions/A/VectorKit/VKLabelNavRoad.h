...
@interface VKLabelNavRoad : NSObject <VKLabelNavFeature> {
    ...
    struct vector<gm::Matrix<double, 2, 1>, geo::allocator_adapter<gm::Matrix<double, 2, 1>, mdm::zone_mallocator>> { void *__begin_; void *__end_; struct { void *__cap_; struct allocator_adapter<gm::Matrix<double, 2, 1>, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } ; } _simplifiedPoints;
    struct vector<float, geo::allocator_adapter<float, mdm::zone_mallocator>> { float *__begin_; float *__end_; struct { float *__cap_; struct allocator_adapter<float, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } ; } _simplifiedPointElevations;
    double _length;
...
- (BOOL)matchesRoadEdge:(const struct GeoCodecsRoadEdge { struct GeoCodecsRoadFeature *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct GeoCodecsConnectivityJunction *x5; struct GeoCodecsConnectivityJunction *x6; } *)a0;
