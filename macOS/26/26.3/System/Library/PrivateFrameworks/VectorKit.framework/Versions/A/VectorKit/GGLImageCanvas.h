...
@interface GGLImageCanvas : NSObject <MDRenderTarget> {
    ...
    struct unique_ptr<ggl::IOSurfaceTexture, std::default_delete<ggl::IOSurfaceTexture>> { struct { struct IOSurfaceTexture *__ptr_; } ; } _flippedSurfaceTexture;
    struct unique_ptr<ggl::RenderTarget, std::default_delete<ggl::RenderTarget>> { struct { struct RenderTarget *__ptr_; } ; } _flippedRenderTarget;
    struct unique_ptr<md::YFlipPass, std::default_delete<md::YFlipPass>> { struct { struct YFlipPass *__ptr_; } ; } _yFlipPass;
    ...
    struct unique_ptr<ggl::Renderer, std::default_delete<ggl::Renderer>> { struct { struct Renderer *__ptr_; } ; } _renderer;
    struct unique_ptr<ggl::RenderTarget, std::default_delete<ggl::RenderTarget>> { struct { struct RenderTarget *__ptr_; } ; } _sRGBRenderTarget;
    ...
    struct unique_ptr<ggl::RenderBuffer, std::default_delete<ggl::RenderBuffer>> { struct { struct RenderBuffer *__ptr_; } ; } _depthStencilBuffer;
    ...
    struct unique_ptr<ggl::RenderTarget, std::default_delete<ggl::RenderTarget>> { struct { struct RenderTarget *__ptr_; } ; } _linearRenderTarget;
    ...
    struct unique_ptr<md::DebugConsoleManager, std::default_delete<md::DebugConsoleManager>> { struct { struct DebugConsoleManager *__ptr_; } ; } _debugConsoleManager;
    void *_services;
}
