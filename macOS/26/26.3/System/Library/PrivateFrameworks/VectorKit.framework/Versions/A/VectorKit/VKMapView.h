...
@interface VKMapView : CALayer {
    ...
    struct unique_ptr<md::MapEngine, md::MapEngineDeleter> { struct { struct MapEngine *__ptr_; } ; } _mapEngine;
    ...
    struct unique_ptr<md::DisplayOptions, std::default_delete<md::DisplayOptions>> { struct { struct DisplayOptions *__ptr_; } ; } _displayOptions;
