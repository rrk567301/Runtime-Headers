...
- (void)idsKTVerifierResultsUpdatedForDestinations:(id)a0 service:(id)a1 info:(id)a2;
...
- (BOOL)_hasSuppressionForCapability:(id)a0;
...
- (BOOL)supportsCapability:(id)a0 forAlias:(id)a1;
- (BOOL)supportsCapability:(id)a0 forAlias:(id)a1 simID:(id)a2;
