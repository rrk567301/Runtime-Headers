@class SPSearchQueryContext, NSString, NSArray, SFColor, UTType, NSDate, SFSearchResult_SpotlightExtras;
...
+ (id)resultBuilderForItem:(id)a0 preferAppVendedView:(BOOL)a1;
+ (id)resultForItem:(id)a0;
