@class NSMutableDictionary, BWFigCaptureDevice, BWSphereModeSelector, NSDictionary, NSObject, BWFigCaptureStream, BWStillImageCaptureSettings, BWStillImageCaptureStreamSettings, NSMutableArray, BWStillImageTimeMachine, FigCaptureThermalMonitor, NSString, NSSet, BWSecureMetadataOutputConfigurator, BWFigCaptureSynchronizedStreamsGroup, BWNoiseReductionAndSharpeningParameters, NSArray, NSData, NSNumber, BWNondisruptiveSwitchingFormatSelector;
...
@interface BWFigVideoCaptureStream : NSObject <BWFigCaptureStreamStartStopDelegate, BWPortraitEffectPropertiesDelegate> {
    ...
    BOOL _frameRateThrottlingForThermalMitigationEnabled;
