...
- (void)reset;
- (int)process;
- (int)_addMetadataAttachmentsForEncodingScheme:(int)a0 sampleBuffer:(struct opaqueCMSampleBuffer { } *)a1 requestedSettings:(id)a2 captureType:(int)a3 parentImageHandle:(long long)a4 exifExtraRotationDegrees:(int)a5;
...
- (void)_addOrientationOptionsToDictionary:(id)a0 encodingScheme:(int)a1 metadata:(id)a2 allowSensorOrientationRotation:(BOOL)a3;
- (void)_addOrientationOptionsToDictionary:(id)a0 encodingScheme:(int)a1 orientation:(int)a2 allowSensorOrientationRotation:(BOOL)a3;
...
- (id)_newMetadataAttachmentsForEncodingScheme:(int)a0 sampleBuffer:(struct opaqueCMSampleBuffer { } *)a1 requestedSettings:(id)a2 captureType:(int)a3 exifExtraRotationDegrees:(int)a4;
...
- (int)_optionsForEncodingScheme:(int)a0 pixelBuffer:(struct __CVBuffer { } *)a1 imageDimensions:(struct { int x0; int x1; })a2 processingFlags:(unsigned int)a3 metadata:(id)a4 thumbnailOptions:(id)a5 requestedStillImageCaptureSettings:(id)a6 resolvedStillImageCaptureSettings:(id)a7 cropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a8 usePixelsOutsideCrop:(BOOL)a9 allowSensorOrientationRotation:(BOOL)a10 containerOptionsOut:(id *)a11 encodingOptionsOut:(id *)a12;
