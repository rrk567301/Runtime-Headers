@class ICAuthorHighlightsUpdater, NSDate, ICTextController, ICPaperTextAttachmentManager, ICMPasswordEntryViewController, ICTableColumnTextView, ICSearchResultRegexMatchFinder, NSPopover, NSResponder, ICCalculatePreviewBehaviorMenu, ICCalculateRecognitionController, ICCalculateScrubberController, NSManagedObjectID, ICAttachmentInsertionController, ICMTextStylesCollectionView, _TtC11NotesEditor24ICMSystemPaperLinkHelper, ICLinkAcceleratorController, ICMHashtagDebugViewController, ICTextViewScrollState, ICInvitation, ICNoteUserActivityState, ICTTTextStorage, NSClickGestureRecognizer, NSImageView, ICLayoutManager, ICHashtagController, NSArray, ICMNoteEditorTouchBarController, NSMenu, ICAuthorHighlightsController, ICSelectorDelayer, NSView, ICMacTextView, NSString, ICActivityStreamSelection, ICVisualAssetImportController, ICMacBaseTextView, NSMenuItem, ICNAEventReporter, ICMLinkSuggestionsController, NSViewController, ICMInvitationViewController, NSMutableDictionary, ICNote, ICMentionsController, ICManagedObjectContextChangeController, ICMUnsupportedNoteView;
