@class MUPlaceSectionFooterViewModel, NSString, MUPlaceSectionHeaderViewModel, MUPlaceSectionHeaderView, NSLayoutGuide, NSLayoutConstraint, MULinkView;
...
@property (nonatomic) BOOL applyVerticalSpacingBetweenHeaderAndContent;
