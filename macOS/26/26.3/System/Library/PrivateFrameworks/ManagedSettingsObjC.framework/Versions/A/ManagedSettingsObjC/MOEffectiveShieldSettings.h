...
+ (id)newConnection;
+ (void)appResponsibleForShieldingCategoryIdentifier:(id)a0 completionHandler:(id /* block */)a1;
+ (void)appResponsibleForShieldingBundleIdentifier:(id)a0 categoryIdentifier:(id)a1 completionHandler:(id /* block */)a2;
+ (id)appResponsibleForShieldingBundleIdentifier:(id)a0 categoryIdentifier:(id)a1 error:(id *)a2;
+ (id)appResponsibleForShieldingCategoryIdentifier:(id)a0 error:(id *)a1;
+ (void)appResponsibleForShieldingWebDomain:(id)a0 categoryIdentifier:(id)a1 completionHandler:(id /* block */)a2;
+ (id)appResponsibleForShieldingWebDomain:(id)a0 categoryIdentifier:(id)a1 error:(id *)a2;
