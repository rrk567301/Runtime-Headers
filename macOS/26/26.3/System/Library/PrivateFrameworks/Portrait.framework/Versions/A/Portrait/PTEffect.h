@class PTMetalContext, PTEffectResources, PTEffectRenderer, PTEffectDescriptor, PTHumanDetections, PTEffectReaction;
...
- (void)handleReactionDuringVFXInit:(id)a0 effectRenderRequest:(id)a1 renderCall:(BOOL)a2;
