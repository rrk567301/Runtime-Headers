...
+ (float)applyDeadZoneOnValue:(SEL)a0 deadZoneFactor:(float)a1 valueRange:(float)a2 newValue:(float)a3 edgeEMACoefficient:(float)a4;
+ (float)applyStepFunctionOnValue:(float)a0 min:(float)a1 max:(float)a2 levels:(int)a3;
