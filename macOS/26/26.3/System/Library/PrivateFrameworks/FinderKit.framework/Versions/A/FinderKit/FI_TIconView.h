@class NSAccessibilityCustomAction, NSObject, FI_TRunAfterHelper, FI_TTitleBubbleView, NSFont, NSString, FI_TTrackingImageView, NSSet, FI_TButton, FI_TTextField, NSImage, FI_TIconSelectionView, FI_TDesktopInlineProgressView, FI_TBasicImageView, NSColor;
...
@interface FI_TIconView : FI_TUpdateLayerView <TCollectionViewItemViewProtocol, TImageAttachmentContainer, NSDraggingDestination, TMarkTornDown> {
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper> { FI_TRunAfterHelper *fWeakObject; } _iconSelectionViewAnimationDelayToken;
