...
@interface FI_TBrowserImmediateActionGestureRecognizerDelegate : NSObject <NSGestureRecognizerDelegatePrivate, NSImmediateActionGestureRecognizerDelegate, NSImmediateActionAnimationController> {
    struct unique_ptr<TBrowserImmediateActionGestureRecognizerHandlerBase, std::default_delete<TBrowserImmediateActionGestureRecognizerHandlerBase>> { struct { struct TBrowserImmediateActionGestureRecognizerHandlerBase *__ptr_; } ; } _handler;
}
