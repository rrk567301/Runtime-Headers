...
@interface FI_TTitleBubbleView : FI_TDrawRectView <NSViewToolTipOwner, TTitleBadgeHost> {
    ...
    struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; struct { int *__cap_; } ; } _tagColorIndexes;
    struct vector<std::pair<TitleViewBadgeID, FI_TTitleViewBadge *>, std::allocator<std::pair<TitleViewBadgeID, FI_TTitleViewBadge *>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _badgeViews;
    BOOL _isDimmed;
}
...
- (struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *x0; struct CGRect *x1; struct { struct CGRect *x0; } x2; })lineBubbleFrames;
