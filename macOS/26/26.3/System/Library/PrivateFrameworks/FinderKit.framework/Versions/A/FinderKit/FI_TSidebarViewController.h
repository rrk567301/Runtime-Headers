...
@interface FI_TSidebarViewController : FI_TViewController <QLSeamlessCloserDelegate, NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, NSMenuItemValidation, ISpawnOriginDelegateProtocol, TMarkTornDown> {
    ...
    struct vector<TSidebarZone, std::allocator<TSidebarZone>> { int *__begin_; int *__end_; struct { int *__cap_; } ; } _localDataSourceCopyZones;
    struct map<TSidebarZone, TFENodeVector, std::less<TSidebarZone>, std::allocator<std::pair<const TSidebarZone, TFENodeVector>>> { struct __tree<std::__value_type<TSidebarZone, TFENodeVector>, std::__map_value_compare<TSidebarZone, std::__value_type<TSidebarZone, TFENodeVector>, std::less<TSidebarZone>>, std::allocator<std::__value_type<TSidebarZone, TFENodeVector>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _localDataSourceCopy;
    ...
    struct function<void ()> { struct __value_func<void ()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } _optimalWidthUpdateCallback;
...
- (struct pair<std::function<void (FI_TMouseOverButton *)>, std::function<void (FI_TMouseOverButton *)>> { struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x0; struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x1; })makeDeterminateProgressAnimationSetup:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
- (struct pair<std::function<void (FI_TMouseOverButton *)>, std::function<void (FI_TMouseOverButton *)>> { struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x0; struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x1; })makeIndeterminateProgressAnimationSetup:(int)a0 node:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1;
- (struct pair<std::function<void (FI_TMouseOverButton *)>, std::function<void (FI_TMouseOverButton *)>> { struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x0; struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x1; })makeNormalButtonStateSetup:(int)a0 forNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1;
- (struct pair<std::function<void (FI_TMouseOverButton *)>, std::function<void (FI_TMouseOverButton *)>> { struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x0; struct function<void (FI_TMouseOverButton *)> { struct __value_func<void (FI_TMouseOverButton *)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; } x1; })makeSimpleImageSetterForAction:(int)a0 forNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1 mouseState:(int)a2;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })nodesForZone:(int)a0;
...
- (struct optional<long> { union { char x0; long long x1; } x0; BOOL x1; })sectionIndexForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 inZone:(int)a1;
...
- (id)tint:(id)a0 forMouseState:(int)a1 action:(int)a2;
- (void)unloadContents;
...
- (struct optional<unsigned long> { union { char x0; unsigned long long x1; } x0; BOOL x1; })validateDropOnZone:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 onItem:(id)a1 atIndex:(int)a2;
- (unsigned long long)validateNoZoneDrop;
- (int)zoneForItem:(id)a0;
- (id)zoneItemForKind:(int)a0;
- (const void *)zoneList:(int)a0;
- (int)zoneRowIndexInController:(int)a0;
