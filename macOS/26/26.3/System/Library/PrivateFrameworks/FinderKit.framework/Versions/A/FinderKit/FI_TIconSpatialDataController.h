@interface FI_TIconSpatialDataController : NSObject {
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _bulkSettingNodes;
    struct vector<IconSpatialData, std::allocator<IconSpatialData>> { struct IconSpatialData *__begin_; struct IconSpatialData *__end_; struct { struct IconSpatialData *__cap_; } ; } _bulkSettingSpatialData;
