@interface FI_TPreviewOptionsDynamicGroup : FI_TPreviewOptionsGroup {
    struct vector<TMetadataAttribute, std::allocator<TMetadataAttribute>> { struct TMetadataAttribute *__begin_; struct TMetadataAttribute *__end_; struct { struct TMetadataAttribute *__cap_; } ; } _dynamicAttributes;
}
