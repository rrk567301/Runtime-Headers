@class NSObject, NSDictionary, FI_TNotificationCenterObserverGlue, NSFont, NSString, FI_TListHeaderRowView, NSLayoutGuide, NSIndexSet, FI_TKeyValueObserverGlue, NSArray, FI_TBrowserViewDataSource, FI_TListNameCellView, FI_TKindFormatter, NSEvent;
...
- (id)rowForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
