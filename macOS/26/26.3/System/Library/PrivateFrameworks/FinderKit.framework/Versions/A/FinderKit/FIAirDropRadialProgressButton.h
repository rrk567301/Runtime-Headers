...
@interface FIAirDropRadialProgressButton : FI_TButton {
    ...
    NSImage *_blankImage;
    NSImage *_icon;
    struct vector<TKeyValueBinder, std::allocator<TKeyValueBinder>> { struct TKeyValueBinder *__begin_; struct TKeyValueBinder *__end_; struct { struct TKeyValueBinder *__cap_; } ; } _bindings;
