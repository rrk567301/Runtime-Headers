...
- (struct shared_ptr<TOperationRecord> { struct TOperationRecord *x0; struct __shared_weak_count *x1; })configureOperationRecordForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 destination:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1;
