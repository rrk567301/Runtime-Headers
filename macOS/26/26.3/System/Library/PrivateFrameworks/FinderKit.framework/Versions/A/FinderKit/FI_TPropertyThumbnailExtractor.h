...
@interface FI_TPropertyThumbnailExtractor : FI_TPropertyIconExtractor {
    ...
    struct vector<std::pair<TFENode, NSImage *>, std::allocator<std::pair<TFENode, NSImage *>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _nodeToImageList;
}
...
@property (readonly, nonatomic) struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } randomAnglesForStack;
