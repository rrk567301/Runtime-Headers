...
@interface FI_TTextField : NSTextField <TBestFitStringSelectorDelegate> {
    ...
    struct unique_ptr<FI_TBestFitStringSelector, std::default_delete<FI_TBestFitStringSelector>> { struct { struct FI_TBestFitStringSelector *__ptr_; } ; } _bestFitStringSelector;
...
- (void)awakeCommon;
- (struct set<double, std::less<double>, std::allocator<double>> { struct __tree<double, std::less<double>, std::allocator<double>> { void *x0; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x0; } x1; struct { unsigned long long x0; } x2; } x0; })bestFitWidths;
