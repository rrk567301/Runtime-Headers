...
- (BOOL)_authenticateHeadless;
- (BOOL)_authenticateWithCLI:(id)a0;
- (BOOL)_authenticateWithDelegatedAccount;
- (BOOL)_authenticateWithKeytab;
- (BOOL)_loadSSOFramework;
- (id)_locateSSOFramework;
- (id)_usernameFromPrincipal:(id)a0;
