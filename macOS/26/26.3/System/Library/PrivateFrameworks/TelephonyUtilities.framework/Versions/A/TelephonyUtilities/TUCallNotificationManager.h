...
@property (readonly, nonatomic) BOOL wantsCallNotifications;
...
- (void)supportsDTMFUpdatesChangedForCall:(id)a0;
- (void)callTranslationStateChanged:(id)a0;
...
- (void)callTranslationAvailabilityChangedForCall:(id)a0 newValue:(BOOL)a1;
- (void)mediaStalledChangedForCall:(id)a0;
- (void)nearbyModeChangedForCall:(id)a0;
...
- (void)receptionistStateChangedForCall:(id)a0 oldValue:(int)a1;
- (void)conversationGroupUUIDChangedForCall:(id)a0;
...
- (void).cxx_destruct;
- (void)callRecordingAvailabilityChangedForCall:(id)a0;
...
- (id)initWithNotificationCenter:(id)a0 wantsCallNotifications:(BOOL)a1;
- (void)deferNotificationsUntilAfterPerformingBlock:(id /* block */)a0;
- (void)receptionistMessageChangedForCall:(id)a0;
- (void)callRecordingStateChanged:(id)a0;
- (void)connectingChangedForCall:(id)a0;
- (void)anyRemoteSupportsRequestToScreenShareChangedForCall:(id)a0;
- (void)callGroupUUIDChangedForCall:(id)a0;
- (void)destinationIDChangedForCall:(id)a0;
- (void)isFailureExpectedChangedForCall:(id)a0;
- (void)mediaTokensChangedForCall:(id)a0;
- (void)postNotificationsForCall:(id)a0 usingComparisonCall:(id)a1 afterUpdatesInBlock:(id /* block */)a2;
- (void)callSubtypeChangedForCall:(id)a0;
- (void)isSharePlayCapableChangedForCall:(id)a0;
- (void)screeningAnnouncementFinishedChangedForCall:(id)a0;
- (BOOL)hasReceptionistSessionChangedFromOldSession:(id)a0 newSession:(id)a1;
- (void)prefersExclusiveAccessToCellularNetworkChangedForCall:(id)a0;
- (void)resolvedStatusChangedForCall:(id)a0;
- (BOOL)hasSmartHoldingSessionChangedFromOldSession:(id)a0 newSession:(id)a1;
- (void)canAnswerCallChangedForCall:(id)a0;
...
- (void)receptionistSessionChangedForCall:(id)a0;
...
- (void)smartHoldingSessionChanged:(id)a0;
