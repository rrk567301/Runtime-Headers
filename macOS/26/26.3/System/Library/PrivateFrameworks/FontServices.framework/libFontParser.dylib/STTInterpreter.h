...
- (BOOL)runFpgm:(const char *)a0 fpgmCount:(int)a1 prep:(const char *)a2 prepCount:(int)a3 glyf:(const char *)a4 glyfCount:(int)a5 twilightZone:(struct fnt_ElementType { int x0; int x1; int *x2; int *x3; unsigned short *x4; unsigned short *x5; char *x6; char *x7; int *x8; int *x9; short *x10; short *x11; int x12; struct unscaledBounds { short x0; short x1; short x2; short x3; } x13; struct unscaledMetrics { short x0; short x1; } x14; struct unscaledMetrics { short x0; short x1; } x15; int x16; int x17; short *x18; } *)a6 glyphZone:(struct fnt_ElementType { int x0; int x1; int *x2; int *x3; unsigned short *x4; unsigned short *x5; char *x6; char *x7; int *x8; int *x9; short *x10; short *x11; int x12; struct unscaledBounds { short x0; short x1; short x2; short x3; } x13; struct unscaledMetrics { short x0; short x1; } x14; struct unscaledMetrics { short x0; short x1; } x15; int x16; int x17; short *x18; } *)a7 unscaledOutlineIsWrong:(BOOL)a8 parBlock:(struct fnt_ParameterBlock { int x0; int x1; int x2; int x3; int x4; int x5; void /* function */ *x6; int x7; int x8; short x9; short x10; short x11; short x12; short x13; short x14; char x15; unsigned char x16; } *)a9 error:(id *)a10;
