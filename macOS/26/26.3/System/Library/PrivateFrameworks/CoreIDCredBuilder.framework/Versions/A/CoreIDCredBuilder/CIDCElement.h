...
- (id)initWithElementIdentifier:(id)a0 integerKeyedDictionaryValue:(id)a1;
- (id)initWithElementIdentifier:(id)a0 numberValue:(id)a1;
- (id)initWithElementIdentifier:(id)a0 stringValue:(id)a1 dataValue:(id)a2 dateValue:(id)a3 numberValue:(id)a4 arrayValue:(id)a5 dictionaryValue:(id)a6 integerKeyedDictionaryValue:(id)a7;
