...
- (BOOL)shouldInitiallyZoomContentWithSize:(struct CGSize { double x0; double x1; })a0 toFillViewWithSize:(struct CGSize { double x0; double x1; })a1 forAssetMediaType:(long long)a2 userInterfaceIdiom:(long long)a3;
