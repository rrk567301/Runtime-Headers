...
- (id)initWithMediaProvider:(id)a0 displayScale:(double)a1 videoSessionManager:(id)a2 loadingStatusReporter:(id)a3 storyQueue:(id)a4 isExporting:(BOOL)a5 isInline:(BOOL)a6 limitVideoDownloadQuality:(BOOL)a7;
- (long long)lagsCount;
