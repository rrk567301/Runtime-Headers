...
- (id)initWithAsset:(id)a0 mediaProvider:(id)a1 deliveryStrategies:(id)a2 audioSessionKind:(long long)a3 requestURLOnly:(BOOL)a4;
- (id)initWithAsset:(id)a0 mediaProvider:(id)a1 deliveryStrategies:(id)a2 audioSessionKind:(long long)a3 requestURLOnly:(BOOL)a4 resourceReclamationController:(id)a5;
- (id)initWithAsset:(id)a0 mediaProvider:(id)a1 deliveryStrategies:(id)a2 audioSessionKind:(long long)a3 spec:(id)a4 resourceReclamationController:(id)a5;
