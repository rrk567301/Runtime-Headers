...
@property (nonatomic) double videoScrubberTrackShadowOpacity;
@property (nonatomic) double videoScrubberTrackShadowBlurRadius;
@property (nonatomic) double videoScrubberTrackShadowOffsetX;
@property (nonatomic) double videoScrubberTrackShadowOffsetY;
...
@property (nonatomic) BOOL enableClearMagicPocket;
...
@property (nonatomic) BOOL showChromeMarginsBox;
