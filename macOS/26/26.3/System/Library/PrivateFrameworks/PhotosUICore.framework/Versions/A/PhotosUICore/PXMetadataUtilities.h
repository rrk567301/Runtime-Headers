...
+ (void)_addDualCaptureBadgeIfNeededForItem:(id)a0 toSymbols:(id)a1;
+ (id)_apertureNumberFromString:(id)a0;
+ (long long)_cameraDeviceForItem:(id)a0;
+ (id)_cameraNominalFocalLengthForItem:(id)a0;
...
+ (id)_numberStringResolvingDecimalSeparatorLocalization:(id)a0;
+ (id)_secondaryFormattedLensDescriptionForItem:(id)a0;
