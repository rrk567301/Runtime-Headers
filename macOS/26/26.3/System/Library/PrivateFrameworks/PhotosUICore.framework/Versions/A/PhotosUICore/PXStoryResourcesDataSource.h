...
@property (readonly, nonatomic) BOOL shouldOptimizeForInlinePlayback;
...
- (void)enumerateTextResourcesForTitles:(unsigned long long)a0 displayAssetResourceAtIndex:(long long)a1 usingBlock:(id /* block */)a2;
...
- (id)initWithKeyAsset:(id)a0 displayAssets:(id)a1 availableDisplayAssets:(id)a2 movieHighlights:(id)a3 detailedSaliency:(id)a4 chapterCollection:(id)a5 audioAssets:(id)a6 assetCollection:(id)a7 overallDurationInfo:(struct { long long x0; struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; struct { long long x0; int x1; unsigned int x2; long long x3; } x2; } x1; })a8 storyConfiguration:(id)a9;
