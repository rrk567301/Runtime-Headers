@class PXDataSectionManager, PXPhotoLibraryLocalDefaults, NSString, PXSidebarDataContext, PXNavigationListItemDataSectionManager, NSMutableDictionary, PHAssetCollection, PHPhotoLibrary, PXOutlineDataSectionManager, NSArray, PXSidebarImageLoader;
...
+ (id)fromMyMacDataSectionManagerForLibrary:(id)a0 context:(id)a1;
...
+ (id)sharedAlbumsDataSectionManagerForLibrary:(id)a0 context:(id)a1;
