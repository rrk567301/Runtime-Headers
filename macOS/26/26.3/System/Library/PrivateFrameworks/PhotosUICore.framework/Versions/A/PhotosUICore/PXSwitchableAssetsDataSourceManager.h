...
@interface PXSwitchableAssetsDataSourceManager : PXAssetsDataSourceManager <PXAssetsDataSourceManagerObserver, PXLensInterchangeable> {
    BOOL _applyPropertyChangesToAllDataSourceManagers;
}
...
- (id)initWithDataSourceManagerByKey:(id)a0 currentKey:(id)a1 applyPropertyChangesToAllDataSourceManagers:(BOOL)a2;
