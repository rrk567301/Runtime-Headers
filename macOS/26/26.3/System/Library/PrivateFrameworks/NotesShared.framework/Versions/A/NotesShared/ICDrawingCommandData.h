...
@property (readonly, nonatomic) struct vector<ICDrawingOutputPoint, std::allocator<ICDrawingOutputPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } points;
