...
- (id).cxx_construct;
- (id)initWithProgram:(struct unique_ptr<MIL::IRProgram, std::default_delete<MIL::IRProgram>> { struct { struct IRProgram *x0; } x0; })a0;
- (id)initWithProgram:(struct unique_ptr<MIL::IRProgram, std::default_delete<MIL::IRProgram>> { struct { struct IRProgram *x0; } x0; })a0 sourceFilePath:(id)a1;
