...
@property (class, readonly) NSObject<OS_os_log> *proxy;
@property (class, readonly) NSObject<OS_os_log> *protocolParser;
@property (class, readonly) NSObject<OS_os_log> *protocolParserDetailed;
@property (class, readonly) NSObject<OS_os_log> *power;
@property (class, readonly) NSObject<OS_os_log> *offloader;
@property (class, readonly) BOOL shouldReduceLogging;
