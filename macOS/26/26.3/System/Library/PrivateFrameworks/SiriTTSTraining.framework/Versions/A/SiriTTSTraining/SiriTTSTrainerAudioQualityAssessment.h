@interface SiriTTSTrainerAudioQualityAssessment : NSObject {
    struct map<AudioQualityMetric, double, std::less<AudioQualityMetric>, std::allocator<std::pair<const AudioQualityMetric, double>>> { struct __tree<std::__value_type<AudioQualityMetric, double>, std::__map_value_compare<AudioQualityMetric, std::__value_type<AudioQualityMetric, double>, std::less<AudioQualityMetric>>, std::allocator<std::__value_type<AudioQualityMetric, double>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _metrics;
}
