...
- (void).cxx_destruct;
- (struct MXIGeometry { struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> { struct { void *x0; } **x0; } x0; struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>> { struct { void *x0; } **x0; } x1; struct vector<std::array<unsigned int, 3>, std::allocator<std::array<unsigned int, 3>>> { void *x0; void *x1; struct { void *x0; } x2; } x2; struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; struct { unsigned int *x0; } x2; } x3; })copyMXIGeometryWithError:(id *)a0;
