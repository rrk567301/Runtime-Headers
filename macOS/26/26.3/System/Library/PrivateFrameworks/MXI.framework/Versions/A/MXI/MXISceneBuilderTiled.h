...
@interface MXISceneBuilderTiled : MXISceneBuilder {
    ...
    struct unique_ptr<tiled::Processor, std::default_delete<tiled::Processor>> { struct { struct Processor *__ptr_; } ; } _proc;
...
- (BOOL)generateBackingPlaneTexture:(id)a0 forScene:(id)a1 error:(id *)a2;
