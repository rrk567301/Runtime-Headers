@class NSMutableDictionary, MNGuidanceSignInfo, MNAnnouncementPlanEvent, MNLocation, NSDictionary, MNAnnouncementEngine, MNAudioManager, GEOComposedRoute, NSMutableArray, GEOComposedGuidanceEvent, NSString, MNNavigationSessionState, NSMutableSet, NSArray, MNDispatchTimer, MNJunctionViewImageLoader;
...
- (BOOL)_checkValidSpokenEventForGuidanceLevel:(id)a0;
...
- (void)_handleNoGuidanceAnnouncementTimerFiredForEvent:(id)a0;
- (BOOL)_hasPersistentEvents;
...
- (void)_triggerHapticsForEvent:(id)a0 timeUntilAnnouncement:(double)a1;
