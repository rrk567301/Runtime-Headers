...
- (void)_finishReportMessageDictionariesWithiMessageSpamDictionaries:(id)a0 textMessageSpamDictionaries:(id)a1 trustKitSpamDictionaries:(id)a2 smsServiceReportAllowed:(BOOL)a3 maxMessagesPerReport:(unsigned long long)a4 chat:(id)a5 totalMessageCount:(unsigned long long *)a6 totalMessages:(unsigned long long)a7;
