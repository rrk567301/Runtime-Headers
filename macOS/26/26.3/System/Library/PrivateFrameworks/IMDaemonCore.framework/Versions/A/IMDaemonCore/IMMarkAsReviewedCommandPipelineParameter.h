...
@interface IMMarkAsReviewedCommandPipelineParameter : NSObject <IMMarkAsReviewedCommandProcessingParameter, IMFindAccountProcessingParameter, IMMessageFromStorageParameter>
