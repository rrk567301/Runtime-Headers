@class NSUUID, NSString, HMFTimer, HMDDatabaseZoneManager, NSSet, NSObject, HMBCloudZone, HMDPersonCoreDataManager, HMBLocalZone;
@protocol OS_dispatch_queue, HMDFeaturesDataSource, HMDPersonManagerSettings;
...
- (void)_handleCreatedOrUpdatedUnassociatedFaceCrop:(id)a0 mirrorOutputFuture:(id)a1;
...
- (void)_createZones;
- (id)_faceCropUUIDsForPersonWithUUID:(id)a0;
- (id)_faceCropsModelsWithUUIDs:(id)a0;
- (void)_handleCreatedOrUpdatedFaceprint:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleCreatedOrUpdatedModel:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleCreatedOrUpdatedPerson:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleCreatedOrUpdatedPersonFaceCrop:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleDeletedFaceCropWithUUID:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleDeletedFaceprintWithUUID:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleDeletedModel:(id)a0 mirrorOutputFuture:(id)a1;
- (void)_handleDeletedPersonWithUUID:(id)a0 mirrorOutputFuture:(id)a1;
...
- (id)addOrUpdateFaceCrops:(id)a0 andRemoveFaceCropsWithUUIDs:(id)a1;
- (id)addOrUpdateFaceprints:(id)a0;
- (id)addOrUpdatePersons:(id)a0;
- (id)addOrUpdatePersons:(id)a0 andRemovePersonsWithUUIDs:(id)a1;
- (id)addUnassociatedFaceCropWithUUID:(id)a0 data:(id)a1;
- (id)associateFaceCropsWithUUIDs:(id)a0 toPersonWithUUID:(id)a1 forSource:(long long)a2;
- (id)associatedUnassociatedFaceCropWithUUID:(id)a0;
- (void)configureWithHome:(id)a0;
- (void)coreDataManager:(id)a0 didRemoveFaceprintsWithUUIDs:(id)a1;
- (void)coreDataManager:(id)a0 didRemovePersonsWithUUIDs:(id)a1;
- (void)coreDataManager:(id)a0 didUpdateFaceprints:(id)a1;
...
- (id)fetchFaceCropsForPersonsWithUUIDs:(id)a0;
- (id)fetchFaceCropsWithUUIDs:(id)a0;
...
- (id)initWithUUID:(id)a0 zoneManager:(id)a1 coreDataManager:(id)a2 dataInterfaces:(id)a3 workQueue:(id)a4 featuresDataSource:(id)a5;
- (BOOL)manager:(id)a0 shouldShareWithUser:(id)a1;
- (id)performCloudPull;
- (id)personFaceCropWithUUID:(id)a0;
