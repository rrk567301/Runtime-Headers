...
- (id)initWithSessionInfo:(id)a0 reachabilityPath:(unsigned long long)a1 streamSender:(id)a2 remoteCapabilities:(id)a3 localNetworkConfig:(id)a4 streamPreference:(id)a5;
