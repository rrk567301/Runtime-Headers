@class HMFTimer, NSString, NSNumber, NSNotificationCenter, HMFSoftwareVersion, IDSServerBag, HMDHomeKitVersion;
...
@property BOOL disableResidentSelectionReachableAccessoriesCriteria;
...
- (void)_serverBagDidFinishLoading:(id)a0;
- (id)init;
- (void).cxx_destruct;
- (id)initWithIDSServerBag:(id)a0 refreshTimer:(id)a1 keySuffix:(id)a2 notificationCenter:(id)a3;
