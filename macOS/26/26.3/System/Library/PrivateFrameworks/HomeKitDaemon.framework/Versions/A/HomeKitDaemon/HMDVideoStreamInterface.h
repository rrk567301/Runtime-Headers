...
+ (id)_createLocalStreamAndRTPSocket:(int *)a0 localNetworkConfig:(id)a1 sessionUUID:(id)a2;
+ (id)_createStreamWithRemoteDestinationReceiver:(id)a0 sessionUUID:(id)a1;
+ (id)_createStreamWithRemoteSocketReceiver:(id)a0 sessionUUID:(id)a1;
+ (id)_createVideoStreamWithSessionHandler:(id)a0 localNetworkConfig:(id)a1 localRTPSocket:(int *)a2 sessionInfo:(id)a3;
...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 delegate:(id)a2 sessionHandler:(id)a3 localNetworkConfig:(id)a4;
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 delegate:(id)a2 sessionHandler:(id)a3 videoStream:(id)a4 localRTPSocket:(int)a5 videoStreamReconfigure:(id)a6 dataSource:(id)a7;
