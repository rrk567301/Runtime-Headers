...
- (void).cxx_destruct;
- (id)initWithHomeUUID:(id)a0 fromState:(unsigned long long)a1 toState:(unsigned long long)a2 reason:(long long)a3 fromStateDuration:(id)a4 supportsAdaptiveTemperatureAutomations:(id)a5;
