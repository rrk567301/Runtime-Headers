@class HMFTimer, NSString, NSDictionary, NSURL, NSData, NSObject;
@protocol OS_dispatch_queue, HMDSimpleDownloader;
...
- (id)_createMmapFromEncodedData:(id)a0 errorContext:(id)a1;
...
- (id)initWithWorkQueue:(id)a0 downloader:(id)a1 fetchTimer:(id)a2;
- (void)setEntriesByProductData:(id)a0;
