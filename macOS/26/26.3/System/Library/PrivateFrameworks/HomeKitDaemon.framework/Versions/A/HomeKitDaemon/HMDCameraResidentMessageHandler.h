...
- (void)sendMessageWithName:(id)a0 cameraSessionInfo:(id)a1 payload:(id)a2 target:(id)a3 device:(id)a4 responseQueue:(id)a5 responseHandler:(id /* block */)a6;
- (void)sendMessageWithName:(id)a0 cameraSessionInfo:(id)a1 payload:(id)a2 target:(id)a3 responseQueue:(id)a4 responseHandler:(id /* block */)a5;
