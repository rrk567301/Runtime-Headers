...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 device:(id)a2 localNetworkConfig:(id)a3 delegate:(id)a4;
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 idsStreamService:(id)a2 device:(id)a3 localNetworkConfig:(id)a4 delegate:(id)a5;
