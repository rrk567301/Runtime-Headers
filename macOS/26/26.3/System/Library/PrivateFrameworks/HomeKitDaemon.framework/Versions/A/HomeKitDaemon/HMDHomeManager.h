...
@property (readonly) BOOL firstCloudKitSharedImportComplete;
...
@property (readonly, nonatomic) id<HMDHomeManagerMetricsDataSource> metricsDataSource;
...
- (void)handleFindVendorAccessoryRequest:(id)a0;
...
- (void)_sendUserRemoved:(id)a0 fromHome:(id)a1 pushToCloud:(BOOL)a2 completionHandler:(id /* block */)a3;
...
- (id)initWithMessageDispatcher:(id)a0 accessoryBrowser:(id)a1 messageFilterChain:(id)a2 homeData:(id)a3 localDataDecryptionFailed:(BOOL)a4 identityRegistry:(id)a5 accountRegistry:(id)a6 metricsDataSource:(id)a7 darwinNotificationProvider:(id)a8 notificationCenter:(id)a9 dataSource:(id)a10 appleAccountManager:(id)a11 remoteAccountManager:(id)a12 userDefaults:(id)a13 hmdUserDefaults:(id)a14 logEventSubmitter:(id)a15 widgetConfigurationReader:(id)a16 configuringStateController:(id)a17 diagnosticInfoController:(id)a18 currentAccessorySetupMetricDispatcher:(id)a19 uncommittedTransactions:(id)a20 featuresDataSource:(id)a21;
...
- (void)handleLocalEnergyKitClearAllMessage:(id)a0;
...
- (void)handleRemoteEnergyKitClearAllMessage:(id)a0;
...
- (id)initWithMessageDispatcher:(id)a0 accessoryBrowser:(id)a1 messageFilterChain:(id)a2 homeData:(id)a3 localDataDecryptionFailed:(BOOL)a4 identityRegistry:(id)a5 accountRegistry:(id)a6 metricsDataSource:(id)a7 configuringStateController:(id)a8 diagnosticInfoController:(id)a9 currentAccessorySetupMetricDispatcher:(id)a10 uncommittedTransactions:(id)a11 featuresDataSource:(id)a12;
