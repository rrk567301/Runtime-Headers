...
@protocol OS_os_log, HMDFeaturesDataSource, HMDMediaDestinationControllerDataSource, HMDMediaDestinationControllerDelegate;
...
+ (id)logCategory;
+ (unsigned long long)expectedSupportOptionsWithFeaturesDataSource:(id)a0;
...
- (id)initWithBackingStoreHandler:(id)a0 messageHandler:(id)a1 metricsEventDispatcher:(id)a2 targetDevice:(BOOL)a3 dataSource:(id)a4 delegate:(id)a5 featuresDataSource:(id)a6;
...
- (void)requestToUpdateDestinationIdentifier:(id)a0 options:(unsigned long long)a1 completion:(id /* block */)a2;
