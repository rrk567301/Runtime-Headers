...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 device:(id)a2 delegate:(id)a3;
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 device:(id)a2 delegate:(id)a3 idsProxyStreamService:(id)a4;
