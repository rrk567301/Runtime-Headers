@class NSString, NSOperationQueue, HMDHAPAccessory, NSObject;
@protocol OS_dispatch_queue, HMDCameraCloudStorageManaging, HMDCameraProfileSettingsQuotaCoordinatorDelegate;
...
- (id)initWithWorkQueue:(id)a0 accessory:(id)a1 cloudStorageManager:(id)a2;
