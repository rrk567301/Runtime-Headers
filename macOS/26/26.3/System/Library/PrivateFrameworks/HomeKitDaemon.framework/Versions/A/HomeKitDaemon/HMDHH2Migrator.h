@class HMDCloudKitReachabilitySource, NSDate, NSObject, HMDBackgroundOperationManager, NSString, HMDHomeData, NSMutableSet, HMDHH2MigratorRecord, HMDCoreData, HMDCoreDataCloudTransform, HMDHH2FrameworkSwitch;
...
- (id)initWithMigratorRecord:(id)a0 hh2FrameworkSwitch:(id)a1 coreData:(id)a2 cloudTransform:(id)a3 backgroundOperationManager:(id)a4 defaultDatabase:(id)a5 cameraClipsDatabase:(id)a6 cloudkitReachabilitySource:(id)a7;
- (void)submitABCEventForFailedMigrationWithReason:(unsigned long long)a0 withError:(id)a1;
- (id)privateZoneForOwnerUser:(id)a0;
- (void)fixupPreviousFailedMigrationModelsWithHomeData:(id)a0 managedObjectContext:(id)a1;
...
- (BOOL)makeSureToCreateHH2SentinelZoneWithError:(id *)a0;
- (void).cxx_destruct;
