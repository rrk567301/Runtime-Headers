...
- (id)removeSharesForHomeWithModelID:(id)a0;
- (id)_canonicalModelFromSharedHomes:(id)a0;
...
- (id)_existingSharedHomeWithoutShareWithHomeModelID:(id)a0 error:(id *)a1;
- (id)_existingSharedHomesWithModelID:(id)a0 error:(id *)a1;
- (id)_removeShare:(id)a0 usingShareService:(id)a1 forHomeWithUUID:(id)a2 isOwnedShare:(BOOL)a3;
...
- (id)fetchUserRecordIDForUser:(id)a0 home:(id)a1;
- (id)grantAccessForUser:(id)a0 home:(id)a1 logEventBuilder:(id)a2;
...
- (id)leaveReverseShareForHomeWithModelID:(id)a0;
- (id)removeSharesForHome:(id)a0;
- (id)revokeAccessForUser:(id)a0 home:(id)a1;
- (double)shareAgeForHome:(id)a0;
- (void)updateSharedOwnerAccountHandleForHome:(id)a0;
- (id)validateGrantingAccessForUserWithAccountHandle:(id)a0 home:(id)a1;
