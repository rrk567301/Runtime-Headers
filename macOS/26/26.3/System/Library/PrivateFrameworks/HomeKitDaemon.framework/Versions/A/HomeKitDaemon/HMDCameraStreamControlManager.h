@class HMDHAPAccessory, HMDCameraStreamSessionInfo, HMDCameraStreamMetrics, NSString, HMDCameraStreamSnapshotHandler, NSObject, HMDService;
...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 isLocal:(BOOL)a6 isRelayed:(BOOL)a7;
