@class NSPopover, _TtC14WorkflowEditor34ParameterValuePickerViewController, WFSlotIdentifier, NSString, WFVariableSubstitutableParameterState, WFEnumerationParameter;

@interface WFEnumerationValuePicker : NSObject <WorkflowEditor.ParameterValuePickerViewControllerDelegate, NSPopoverDelegate, NSObject>

@property (retain, nonatomic) WFEnumerationParameter *parameter;
@property (copy, nonatomic) id /* block */ completionHandler;
@property (retain, nonatomic) _TtC14WorkflowEditor34ParameterValuePickerViewController *parameterValuePickerViewController;
