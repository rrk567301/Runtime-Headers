@class ADUserTargetingProperties, NSString, ADRotatingIdentifiers, ADTriggerContainer;

@interface ADSponsoredSearchRequest : PBRequest <NSCopying> {
    struct { unsigned char featureEnabledBitmap : 1; unsigned char supportedODMLVersion : 1; unsigned char clientExclusive : 1; unsigned char enableImagesForDupes : 1; unsigned char inAllocation : 1; unsigned char isBaseline : 1; unsigned char isTest : 1; } _has;
}
...
@property (nonatomic) BOOL hasFeatureEnabledBitmap;
@property (nonatomic) int featureEnabledBitmap;
@property (readonly, nonatomic) BOOL hasJsVersion;
@property (retain, nonatomic) NSString *jsVersion;
@property (readonly, nonatomic) BOOL hasTriggersContainer;
