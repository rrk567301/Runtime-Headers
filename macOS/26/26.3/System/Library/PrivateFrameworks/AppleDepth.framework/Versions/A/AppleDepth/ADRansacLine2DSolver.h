@interface ADRansacLine2DSolver : NSObject {
    ...
    struct unique_ptr<DisparityToDepth::RansacLine2DModel, std::default_delete<DisparityToDepth::RansacLine2DModel>> { struct { struct RansacLine2DModel *__ptr_; } ; } _model2D;
}
