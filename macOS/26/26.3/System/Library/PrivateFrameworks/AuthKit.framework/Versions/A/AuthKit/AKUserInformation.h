...
@property (nonatomic) BOOL isPDPOperation;
...
@property (readonly, copy, nonatomic) NSNumber *activeHMECount;
@property (readonly, copy, nonatomic) NSNumber *inActiveHMECount;

+ (id)_emailFields;
+ (id)userInformationForUpdates;
+ (BOOL)isFieldUpdateableForAccountWithAltDSID:(id)a0 fieldName:(id)a1;
+ (id)_securityFields;
+ (id)_ageFields;
...
+ (BOOL)_getIsPDPOperation;
+ (id)_managedFields;
+ (void)_setIsPDPOperation:(BOOL)a0;
...
- (BOOL)hasUpdateableFieldsForAccountWithAltDSID:(id)a0;
- (id)initWithResponseBody:(id)a0;
- (id)sharedEmailForManagedAppleID;
- (id)updateableFieldNamesForAccountWithAltDSID:(id)a0;
- (BOOL)validateForUpdatesWithContext:(id)a0 error:(id *)a1;
