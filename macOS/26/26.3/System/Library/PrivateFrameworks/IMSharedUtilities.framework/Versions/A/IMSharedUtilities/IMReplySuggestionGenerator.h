...
+ (void)_annotatedRepliesForMessages:(id)a0 senderMessages:(id)a1 recipientHandles:(id)a2 languageCode:(id)a3 languageCodeChangeDate:(id)a4 loadAsync:(BOOL)a5 actionsOnly:(BOOL)a6 completion:(id /* block */)a7;
+ (void)_contextualRepliesForMessages:(id)a0 senderMessages:(id)a1 recipientHandles:(id)a2 languageCode:(id)a3 languageCodeChangeDate:(id)a4 loadAsync:(BOOL)a5 includeDynamicSuggestions:(BOOL)a6 requestType:(unsigned long long)a7 completion:(id /* block */)a8;
...
+ (void)annotatedRepliesForMessages:(id)a0 senderMessages:(id)a1 recipientHandles:(id)a2 languageCode:(id)a3 languageCodeChangeDate:(id)a4 actionsOnly:(BOOL)a5 completion:(id /* block */)a6;
