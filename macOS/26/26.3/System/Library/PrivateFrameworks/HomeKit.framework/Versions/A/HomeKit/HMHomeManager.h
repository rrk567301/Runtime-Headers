@class _HMContext, HMFTimer, HMSoftwareUpdateDocumentationManager, NSMutableArray, NSString, NSError, HMApplicationData, HMELastEventStore, HMUserActionPredictionProvider, HMMigrationBoost, HMHome, NSArray, HMCurrentMediaGroupProvider, NSCountedSet, NSObject, HMAccessorySettingsMetricsDispatcher, HMMutableArray, NSOperationQueue, HMCameraClipsQuotaMessenger, HMCacheManager, HMAccessorySetupCoordinator, HMCoreAnalyticsMetricEventDispatcher, HMWidgetManager, HMNetworkRouterFirewallRuleManager, HMHAPMetadata, HMUserCloudShareManager, HMAccessory, HMXPCEventRouterClient, NSUUID, HMHomeManagerConfiguration;
