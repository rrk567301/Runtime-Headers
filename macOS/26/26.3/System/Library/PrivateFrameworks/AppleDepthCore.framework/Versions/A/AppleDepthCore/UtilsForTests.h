...
+ (BOOL)areIdenticalPointCloud0:(id)a0 pointCloud1:(id)a1 accuracy:(float)a2;
...
+ (struct vector<float, std::allocator<float>> { float *x0; float *x1; struct { float *x0; } x2; })pointsVectorFromFilePath:(id)a0;
