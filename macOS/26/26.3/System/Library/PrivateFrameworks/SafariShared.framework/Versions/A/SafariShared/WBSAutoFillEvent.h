...
@property (readonly, nonatomic) BOOL passwordWasFilled;

- (id)description;
- (void).cxx_destruct;
- (id)initWithUsername:(id)a0 tabID:(id)a1 isPrivateTab:(BOOL)a2 url:(id)a3 providerBundleIdentifier:(id)a4 passwordWasFilled:(BOOL)a5;
