...
@interface WBSHistoryServiceURLCompletionMatchEntry : NSObject <NSSecureCoding> {
    struct unique_ptr<SafariShared::_HistoryStreamedMatchEntry, std::default_delete<SafariShared::_HistoryStreamedMatchEntry>> { struct { struct _HistoryStreamedMatchEntry *__ptr_; } ; } _streamData;
    NSString *_url;
    NSString *_title;
}
