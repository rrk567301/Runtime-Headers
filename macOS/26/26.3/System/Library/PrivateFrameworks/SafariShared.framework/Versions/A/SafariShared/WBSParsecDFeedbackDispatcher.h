...
- (void)userDidEngageWithCompletionListItem:(id)a0 method:(long long)a1;
- (void)userDidEngageWithCompletionListItem:(id)a0 method:(long long)a1 doesMatchSiriSuggestion:(BOOL)a2 voiceSearchQueryID:(id)a3;
