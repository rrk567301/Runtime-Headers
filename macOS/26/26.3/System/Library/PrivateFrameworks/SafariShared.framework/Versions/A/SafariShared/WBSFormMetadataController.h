...
+ (id)test_findBestIndexToFillSelectControl:(id)a0 withSynonyms:(id)a1;
...
- (void)fillForm:(long long)a0 inFrame:(id)a1 withPassword:(id)a2 focusedFieldControlID:(id)a3 completionHandler:(id /* block */)a4;
...
- (id)formElementWithFormID:(long long)a0 inFrame:(id)a1;
...
- (void)formObservedChangeIndicatingFormSubmission:(id)a0 removedControls:(id)a1 inInjectedBundleFrame:(id)a2;
