...
- (unsigned long long)_getSecondPassRejectReasonFromExclaveKeywordResult:(unsigned long long)a0 speakerDetectionResult:(unsigned long long)a1;
...
- (BOOL)_isFirstPassSourceExclave:(unsigned long long)a0;
...
- (unsigned long long)getSecondPassRejectReasonFromExclaveKeywordResult:(unsigned long long)a0 speakerDetectionResult:(unsigned long long)a1;
- (void)handleVoiceTriggerSecondPassFrom:(id)a0 completion:(id /* block */)a1;
- (id)initWithFirstPassSource:(unsigned long long)a0 phsEnabled:(BOOL)a1 speechManager:(id)a2 supportsMphDetection:(BOOL)a3 secondPassQueue:(id)a4;
