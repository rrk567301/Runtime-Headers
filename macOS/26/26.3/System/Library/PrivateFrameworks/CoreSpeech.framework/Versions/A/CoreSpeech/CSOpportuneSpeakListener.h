@class CSPlainAudioFileWriter, CSAudioRecordContext, NSString, CSSPGEndpointAnalyzer, CSAudioStreamHolding, NSObject, NSMutableArray, CSAudioStream, CSAudioTimeConverter;
