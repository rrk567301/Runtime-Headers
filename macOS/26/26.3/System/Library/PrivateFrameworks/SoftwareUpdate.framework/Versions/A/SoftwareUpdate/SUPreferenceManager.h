...
@property (readonly) BOOL automaticallyInstallBackgroundSecurityImprovements;
...
- (BOOL)_clearAnyPreferenceWithKey:(id)a0 withError:(id *)a1;
...
- (void)clearPendingSplatRollbackPostRebootNotificationVersion;
- (BOOL)enableRecommendedSettings;
- (BOOL)isMacOSAutoUpdateManaged;
- (BOOL)isProdFused;
- (BOOL)migratePreferencesAfterUpdate;
...
- (BOOL)setAutomaticallyInstallBackgroundSecurityImprovements:(BOOL)a0;
...
- (BOOL)setEncodedBundleOverridePath:(id)a0;
...
- (BOOL)setPostSuccessfulMinorUpdatePostLogOutNotification:(BOOL)a0;
- (void)setProductKeysToAutoInstall:(id)a0;
- (void)setReadmeOverridePath:(id)a0;
- (BOOL)setSettingsClientOverride:(id)a0;
