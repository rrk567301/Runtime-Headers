...
- (id)init;
- (void).cxx_destruct;
- (id)collectItemIDsWithQuery:(id)a0 messagePersistence:(id)a1 hookRegistry:(id)a2 remindMeNotificationController:(id)a3 searchProvider:(id)a4 errorString:(id *)a5;
