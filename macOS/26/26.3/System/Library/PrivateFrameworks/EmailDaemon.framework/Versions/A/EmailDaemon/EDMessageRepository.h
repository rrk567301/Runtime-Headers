@class EDMessagePersistence, EDAttachmentPersistenceManager, NSMutableSet, EDCategoryCoreAnalyticsLogger, EFLocked, EMCoreAnalyticsCollector, EDActivityPersistence, EDConversationPersistence, EDVIPManager, EDWebContentParser, EDPersistenceHookRegistry, EDListUnsubscribeHandler, EDThreadMigratorManager, NSUserDefaults, EDMailboxPersistence, EMBlockedSenderManager, EDCategoryPersistence, EDMailboxPredictionController, EDBusinessCloudStorage, EDRemoteContentCacheConfiguration, EDMessageChangeManager, NSConditionLock, NSMutableDictionary, EDThreadPersistence, NSString, EDRemindMeNotificationController, NSObject, EDSenderPersistence, EDRemoteContentManager, EDRichLinkPersistence, NSSet, EDRemoteContentPersistence, EDBusinessPersistence, EDFetchController;
...
- (void)_enumerateMessageObjectIDs:(id)a0 queryHandler:(id)a1 usingBlock:(id /* block */)a2;
...
- (void)recordHydrationTelemetryWithRequestSource:(int)a0 isLocallyAvailable:(BOOL)a1 startTimestamp:(double)a2 messageDate:(id)a3 error:(id)a4;
...
- (void)test_setTestSearchProvider:(id)a0;
