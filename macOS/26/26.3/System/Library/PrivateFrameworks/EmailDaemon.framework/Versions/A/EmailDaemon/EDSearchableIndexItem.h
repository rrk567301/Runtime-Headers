@class EDEnqueuedDonation, NSString, CSSearchableItem, NSData, NSDate, NSObject, EDPersistedMessageID;
...
+ (id)messageIDForBaseMessage:(id)a0;
+ (id)searchableMessageAttachmentsForBaseMessage:(id)a0 includeEncryptedBody:(BOOL)a1;
+ (id)searchableMessageAuthenticationStateForBaseMessage:(id)a0;
...
- (void)addMessageAuthenticationStateAttributesToAttributeSet:(id)a0;
