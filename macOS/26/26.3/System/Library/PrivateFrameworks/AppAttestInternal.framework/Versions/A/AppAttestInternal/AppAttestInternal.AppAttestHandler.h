@interface AppAttestInternal.AppAttestHandler : NSObject {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_attestationCborManager;
    void /* unknown type, empty encoding */ $__lazy_storage_$_assertionCborManager;
...
- (void)getKeyFor:(id)a0 credential:(id)a1 completion:(id /* block */)a2;
