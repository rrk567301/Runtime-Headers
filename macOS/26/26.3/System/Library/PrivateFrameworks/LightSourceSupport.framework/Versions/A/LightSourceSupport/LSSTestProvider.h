...
@interface LSSTestProvider : NSObject <LSSProvider> {
    ...
    struct { double time; void /* unknown type, empty encoding */ direction; struct { void /* unknown type, empty encoding */ vector; } referenceOrientation; float intensity; unsigned int activityLevel; } _lastUpdate;
