...
- (id)initWithAssetName:(id)a0 assetSpecifier:(id)a1 assetVersion:(id)a2 assetLocale:(id)a3 assetSource:(int)a4 isAssetPathValid:(id)a5 assetPath:(id)a6 assetDownloadSizeInBytes:(id)a7 assetUnarchivedSizeInBytes:(id)a8 sourceOSBuild:(id)a9 promotedOSBuild:(id)a10;
