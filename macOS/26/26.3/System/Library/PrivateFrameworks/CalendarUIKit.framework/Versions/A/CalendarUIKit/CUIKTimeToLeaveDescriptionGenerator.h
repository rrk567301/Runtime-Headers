...
+ (id)_travelMultiModalWithHypothesis:(id)a0;
...
+ (id)_travelTimeLeaveNowMultiModalSubstringWithEta:(id)a0 location:(id)a1 routeName:(id)a2;
+ (id)_travelTimeLeaveNowMultiModalWithHypothesis:(id)a0 eta:(id)a1 location:(id)a2;
...
+ (id)_travelTimeSubstringWithEta:(id)a0 location:(id)a1 routeName:(id)a2;
+ (id)_travelTimeSubstringWithHypothesis:(id)a0 eta:(id)a1 location:(id)a2;
