@interface PGFlexMusicCurationParameters : NSObject {
    ...
    void /* unknown type, empty encoding */ weightByLanguage;
    void /* unknown type, empty encoding */ weightByRegion;
    void /* unknown type, empty encoding */ flexMusicSongProvider;
}
...
- (id)initWithMood:(unsigned long long)a0 moodKeywords:(id)a1 recentlyUsedSongs:(id)a2 entityUUID:(id)a3 useMoodKeywords:(BOOL)a4 features:(id)a5 musicCuratorContext:(id)a6 genre:(id)a7 weightByLanguage:(id)a8 weightByRegion:(id)a9;
