...
- (id)init;
- (void).cxx_destruct;
- (id)initWithPromptId:(id)a0 promptText:(id)a1 isValidated:(BOOL)a2 assetCount:(long long)a3 source:(id)a4 mcAvailabilityStatus:(long long)a5 localFactoryScore:(double)a6;
