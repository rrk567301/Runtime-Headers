@interface ImagePlaygroundInternal.GenerativePlaygroundPhotoLibrary : NSObject <PHPhotoLibraryChangeObserver> {
    ...
    void /* unknown type, empty encoding */ shouldFetchAssets;
}
