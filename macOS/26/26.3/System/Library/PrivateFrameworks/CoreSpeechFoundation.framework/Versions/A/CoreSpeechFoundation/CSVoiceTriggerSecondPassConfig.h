...
- (void).cxx_destruct;
- (id)phraseNamesHash;
- (id)initWithPreTriggerAudioTime:(float)a0 prependingAudioTime:(float)a1 trailingAudioTime:(float)a2 resourcePath:(id)a3 configPathNDAPI:(id)a4 useRecognizerCombination:(BOOL)a5 configPathRecognizer:(id)a6 useKeywordSpotting:(BOOL)a7 phraseConfigs:(id)a8 wearerDetectionConfig:(id)a9 quasarCheckerResultCutOffCount:(id)a10 useTimeBasedTriggerLength:(BOOL)a11;
