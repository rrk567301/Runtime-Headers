...
@interface CSAudioCircularBuffer : NSObject {
    struct unique_ptr<corespeech::CSAudioCircularBufferImpl<float>, std::default_delete<corespeech::CSAudioCircularBufferImpl<float>>> { struct { void *__ptr_; } ; } _csAudioCircularBufferImpl;
}
