...
- (void)_deselectItemsWithIdentifiers:(id)a0;
- (void)_hostEffectiveAppearanceDidChange:(BOOL)a0;
- (void)_hostModalInPresentationDidChange:(BOOL)a0;
- (void)_moveItemWithIdentifier:(id)a0 afterIdentifier:(id)a1;
- (void)_overrideSelectedItemsWithIdentifiers:(id)a0;
