...
- (void)_finishPickingWithResults:(id)a0 action:(long long)a1 error:(id)a2;
...
- (void)_pickerDidFinishPicking:(id)a0 action:(long long)a1 error:(id)a2;
...
- (void)deselectItemsWithIdentifiers:(id)a0;
