...
- (id)decodeSegmentWithHeader:(struct { unsigned int x0; unsigned char x1; unsigned char x2; unsigned char x3; } *)a0 withIterator:(struct shared_ptr<PGVirtualMemoryCursor> { struct PGVirtualMemoryCursor *x0; struct __shared_weak_count *x1; })a1 withDecoder:(id)a2 into:(id)a3;
- (void)decodeSegments:(void *)a0 into:(id)a1;
...
- (void)deleteIndirectCommandBufferForReference:(unsigned int)a0;
...
- (id)getIndirectCommandBufferForReference:(unsigned int)a0;
...
- (id)textureDescriptorForDescriptor2:(const struct { unsigned char x0 : 4; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned short x5 : 16; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned short x10; unsigned short x11; unsigned short x12; unsigned short x13; unsigned long long x14; unsigned char x15; unsigned char x16; unsigned char x17; unsigned char x18; } *)a0;
