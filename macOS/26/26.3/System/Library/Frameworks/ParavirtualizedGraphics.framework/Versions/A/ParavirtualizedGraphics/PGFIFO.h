...
@interface PGFIFO : NSObject {
    ...
    struct atomic<bool> { struct __cxx_atomic_impl<bool, std::__cxx_atomic_base_impl<bool>> { _Atomic BOOL __a_value; } __a_; } _quiesced;
    unsigned long long _traceId;
    id<MTLSharedEvent> _fifoEvent;
...
- (void)CmdInfoIndirect:(struct { unsigned short x0; unsigned short x1; unsigned int x2; unsigned int x3; } *)a0 stampValue:(unsigned int)a1 withPayload:(void *)a2 payloadSize:(unsigned long long)a3;
