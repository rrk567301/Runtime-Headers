@class ITMediaLibraryQuery, NSArray, NSString, , MPMediaQueryMutableSectionInfo, __end_;

@interface ITMediaLibraryQueryResultSet : NSObject <MPMediaLibraryResultSet> {
    struct vector<ITMediaEntity *, std::allocator<ITMediaEntity *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _results;
