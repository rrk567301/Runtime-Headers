...
- (long long)_icPinnedEntityDefaultActionFromMPMediaLibraryPinDefaultAction:(long long)a0;
...
- (long long)_icPinnedEntityTypeFromMPMediaLibraryPinnedEntityType:(long long)a0;
...
- (void)addStoreItemsWithAdamIDs:(id)a0 referralObject:(id)a1 completionHandler:(id /* block */)a2;
