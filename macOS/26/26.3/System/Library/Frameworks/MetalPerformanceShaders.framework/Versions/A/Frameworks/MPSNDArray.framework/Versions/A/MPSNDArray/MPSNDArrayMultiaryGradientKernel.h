...
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 sourceGradient:(id)a3 gradientState:(id)a4 destinationArray:(id)a5 kernelDAGObject:(id)a6;
