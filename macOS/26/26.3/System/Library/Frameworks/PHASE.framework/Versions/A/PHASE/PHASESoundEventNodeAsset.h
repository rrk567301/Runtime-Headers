...
- (id)initWithUID:(id)a0 ownedActionTree:(struct unique_ptr<Phase::ActionTree, std::default_delete<Phase::ActionTree>> { struct { struct ActionTree *x0; } x0; })a1 assetRegistry:(id)a2 weakStringPoolReference:(void *)a3 details:(id)a4;
