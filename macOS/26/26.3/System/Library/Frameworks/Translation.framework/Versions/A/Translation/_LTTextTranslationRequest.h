@class _LTGenmojiReplacementManager, NSString, NSArray, _LTTranslationSession, NSMutableDictionary, NSAttributedString, _LTTextToSpeechTranslationRequest;
...
@property (nonatomic) BOOL requiresMultiParagraphPathway;
@property (nonatomic) BOOL preserveGenmoji;
...
- (id)_replaceAdaptiveImageGlyphsIfNeededForText:(id)a0 requestUniqueID:(id)a1;
...
- (void)_submitMessagesSELFLoggingIfNeededForInvocationStart:(BOOL)a0 error:(id)a1;
