...
- (struct ScopedLookupOfMixTapToUplinkHost { struct scoped_lookup { void *x0; struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct { union __rep { struct __short { char x0[23]; unsigned char x1 : 7; unsigned char x2 : 1; } x0; struct __long { char *x0; unsigned long long x1; unsigned long x2 : 63; unsigned char x3 : 1; } x1; } x0; } x0; } x1; struct optional<std::weak_ptr<MixTapToUplinkHost>> { union { char x0; struct weak_ptr<MixTapToUplinkHost> { struct MixTapToUplinkHost *x0; struct __shared_weak_count *x1; } x1; } x0; BOOL x1; } x2; struct element_t *x3; } x0; struct shared_ptr<MixTapToUplinkHost> { struct MixTapToUplinkHost *x0; struct __shared_weak_count *x1; } x1; })getScopedLookupOfMixTapToUplinkHost:(id)a0;
- (struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; struct { void *x0; } x2; })getUUIDsOfAudioStreams;
