@class LPInlineMediaPlaybackInformation, NSURL, LPImagePresentationProperties, LPImage, LPAudio, LPVideo, NSString, LPCaptionBarPresentationProperties, LPARAsset, NSArray, NSNumber, LPIndeterminateProgressSpinnerPresentationProperties, NSColor;

@interface LPWebLinkPresentationProperties : NSObject <LPLinkPresentationPropertyProvider>

@property (nonatomic, setter=_setHasComputedDominantImageBackgroundColor:) BOOL _hasComputedDominantImageBackgroundColor;
...
@property (retain, nonatomic) NSColor *dominantImageBackgroundColor;
@property (nonatomic) BOOL allowsDominantImageBackgroundColorAsCaptionBackground;
