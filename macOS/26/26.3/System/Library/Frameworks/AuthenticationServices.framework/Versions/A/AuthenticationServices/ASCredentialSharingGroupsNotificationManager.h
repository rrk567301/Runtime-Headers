@class NSString, WBSSavedAccountStore, UNUserNotificationCenter;
...
- (void)_presentNotificationWithRequestIdentifier:(id)a0 content:(id)a1 completionHandler:(id /* block */)a2;
- (id)initWithSavedAccountStore:(id)a0;
