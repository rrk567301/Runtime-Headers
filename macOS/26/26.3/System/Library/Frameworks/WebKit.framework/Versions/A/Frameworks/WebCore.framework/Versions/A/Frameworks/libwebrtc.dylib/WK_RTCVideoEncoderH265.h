...
@interface WK_RTCVideoEncoderH265 : NSObject <RTCVideoEncoder> {
    ...
    struct unique_ptr<webrtc::BitrateAdjuster, std::default_delete<webrtc::BitrateAdjuster>> { struct { struct BitrateAdjuster *__ptr_; } ; } _bitrateAdjuster;
    ...
    int framesLeft;
    struct vector<unsigned char, std::allocator<unsigned char>> { char *__begin_; char *__end_; struct { char *__cap_; } ; } _nv12ScaleBuffer;
    BOOL _useAnnexB;
