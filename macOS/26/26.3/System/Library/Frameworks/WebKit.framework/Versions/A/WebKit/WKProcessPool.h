@class NSString, NSDictionary, NSURL, _WKAutomationSession, _WKProcessPoolConfiguration;
@protocol _WKDownloadDelegate, _WKAutomationDelegate;

@interface WKProcessPool : NSObject <WKObject, NSSecureCoding> {
    struct AlignedStorage<WebKit::WebProcessPool, 8UL> { struct Storage { unsigned char data[1424]; } m_storage; } _processPool;
...
- (void)_countWebPagesInAllProcessesForTesting:(id /* block */)a0;
...
- (void)_registerAdditionalFonts:(id)a0;
...
- (void)_setCachedProcessLifetimeForTesting:(double)a0;
...
- (void)_setPLTResourceDelayIntervalForTesting:(double)a0;
