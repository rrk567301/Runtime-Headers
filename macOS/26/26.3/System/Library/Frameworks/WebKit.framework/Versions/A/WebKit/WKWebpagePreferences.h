...
@interface WKWebpagePreferences : NSObject <WKObject> {
    struct AlignedStorage<API::WebsitePolicies, 8UL> { struct Storage { unsigned char data[456]; } m_storage; } _websitePolicies;
}
...
- (void)_setEnhancedSecurityEnabled:(BOOL)a0;
