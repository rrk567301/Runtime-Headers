...
- (struct Interaction { unsigned char x0; struct String { struct RefPtr<WTF::StringImpl, WTF::RawPtrTraits<WTF::StringImpl>, WTF::DefaultRefDerefTraits<WTF::StringImpl>> { struct StringImpl *x0; } x0; } x1; struct optional<WebCore::FloatPoint> { union { char x0; struct FloatPoint { float x0; float x1; } x1; } x0; BOOL x1; } x2; struct optional<WTF::ObjectIdentifierGeneric<WebCore::NodeIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long>> { union { char x0; struct ObjectIdentifierGeneric<WebCore::NodeIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long> { unsigned long long x0; } x1; } x0; BOOL x1; } x3; BOOL x4; })_convertToWebCoreInteraction:(id)a0;
