...
@interface WKImageAnalysisOverlayViewDelegate : NSObject <VKCImageAnalysisOverlayViewDelegate> {
    ...
    struct WeakObjCPtr<VKCImageAnalysisOverlayView> { id m_weakReference; } _overlayView;
    struct WeakObjCPtr<NSResponder> { id m_weakReference; } _lastOverlayResponderView;
}
