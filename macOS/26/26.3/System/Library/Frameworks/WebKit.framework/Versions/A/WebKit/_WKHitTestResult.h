@class NSString, NSURLResponse, NSURL, WKFrameInfo;

@interface _WKHitTestResult : NSObject <WKObject, NSCopying> {
    struct AlignedStorage<API::HitTestResult, 16UL> { struct Storage { unsigned char data[928]; } m_storage; } _hitTestResult;
}
...
@property (readonly, nonatomic) BOOL linkHasTargetFrame;
@property (readonly, nonatomic) BOOL linkTargetFrameIsSameAsLinkFrame;
@property (readonly, nonatomic) BOOL linkTargetFrameIsInDifferentWebView;
