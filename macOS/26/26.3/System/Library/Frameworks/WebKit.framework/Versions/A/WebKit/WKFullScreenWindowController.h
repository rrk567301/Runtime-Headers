@class NSArray, NSString, NSView, NSTimer, WebCoreFullScreenPlaceholderView, WKFullScreenPlaceholderView;
...
@interface WKFullScreenWindowController : NSWindowController <NSWindowDelegate> {
    ...
    struct RetainPtr<WKFullScreenPlaceholderView> { WKFullScreenPlaceholderView *m_ptr; } _webViewPlaceholder;
    ...
    struct CompletionHandler<void (bool)> { struct Function<void (bool)> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _enterFullScreenCompletionHandler;
    struct CompletionHandler<void ()> { struct Function<void ()> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void>, std::default_delete<WTF::Detail::CallableWrapperBase<void>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _beganExitFullScreenCompletionHandler;
    struct CompletionHandler<void ()> { struct Function<void ()> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void>, std::default_delete<WTF::Detail::CallableWrapperBase<void>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _exitFullScreenCompletionHandler;
    double _savedScale;
    struct RectEdges<float> { struct array<float, 4UL> { float __elems_[4]; } m_sides; } _savedObscuredContentInsets;
    struct unique_ptr<WTF::Observer<void (bool)>, std::default_delete<WTF::Observer<void (bool)>>> { struct { void *__ptr_; } ; } _pipObserver;
...
@property (readonly, nonatomic) WebCoreFullScreenPlaceholderView *webViewPlaceholder;
