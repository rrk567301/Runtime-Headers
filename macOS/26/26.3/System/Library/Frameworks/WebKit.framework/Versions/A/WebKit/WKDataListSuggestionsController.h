@class NSString, NSView, NSScrollView, WKDataListSuggestionTableView, WKDataListSuggestionWindow;
...
@interface WKDataListSuggestionsController : NSObject <NSTableViewDataSource, NSTableViewDelegate> {
    ...
    struct RetainPtr<NSView> { NSView *m_ptr; } _presentingView;
    struct RetainPtr<NSScrollView> { NSScrollView *m_ptr; } _scrollView;
    struct RetainPtr<WKDataListSuggestionWindow> { WKDataListSuggestionWindow *m_ptr; } _enclosingWindow;
    struct RetainPtr<WKDataListSuggestionTableView> { WKDataListSuggestionTableView *m_ptr; } _table;
