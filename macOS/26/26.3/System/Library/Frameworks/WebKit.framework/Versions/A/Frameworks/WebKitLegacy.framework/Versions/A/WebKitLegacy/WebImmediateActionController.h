...
@interface WebImmediateActionController : NSObject <QLPreviewMenuItemDelegate, NSImmediateActionGestureRecognizerDelegate> {
    WebView *_webView;
    int _type;
    struct HitTestResult { struct HitTestLocation { struct LayoutPoint { struct LayoutUnit { int m_value; } m_x; struct LayoutUnit { int m_value; } m_y; } m_point; struct LayoutRect { struct LayoutPoint { struct LayoutUnit { int m_value; } m_x; struct LayoutUnit { int m_value; } m_y; } m_location; struct LayoutSize { struct LayoutUnit { int m_value; } m_width; struct LayoutUnit { int m_value; } m_height; } m_size; } m_boundingBox; struct FloatPoint { float m_x; float m_y; } m_transformedPoint; struct FloatQuad { struct FloatPoint { float m_x; float m_y; } m_p1; struct FloatPoint { float m_x; float m_y; } m_p2; struct FloatPoint { float m_x; float m_y; } m_p3; struct FloatPoint { float m_x; float m_y; } m_p4; } m_transformedRect; BOOL m_isRectBased; BOOL m_isRectilinear; } m_hitTestLocation; struct RefPtr<WebCore::Node, WTF::RawPtrTraits<WebCore::Node>, WTF::DefaultRefDerefTraits<WebCore::Node>> { struct Node *m_ptr; } m_innerNode; struct RefPtr<WebCore::Node, WTF::RawPtrTraits<WebCore::Node>, WTF::DefaultRefDerefTraits<WebCore::Node>> { struct Node *m_ptr; } m_innerNonSharedNode; struct LayoutPoint { struct LayoutUnit { int m_value; } m_x; struct LayoutUnit { int m_value; } m_y; } m_pointInInnerNodeFrame; struct LayoutPoint { struct LayoutUnit { int m_value; } m_x; struct LayoutUnit { int m_value; } m_y; } m_localPoint; struct RefPtr<WebCore::Element, WTF::RawPtrTraits<WebCore::Element>, WTF::DefaultRefDerefTraits<WebCore::Element>> { struct Element *m_ptr; } m_innerURLElement; struct RefPtr<WebCore::Scrollbar, WTF::RawPtrTraits<WebCore::Scrollbar>, WTF::DefaultRefDerefTraits<WebCore::Scrollbar>> { struct Scrollbar *m_ptr; } m_scrollbar; BOOL m_isOverWidget; struct optional<WebCore::Style::PseudoElementIdentifier> { union { char __null_state_; struct PseudoElementIdentifier { unsigned char type; struct AtomString { struct String { struct RefPtr<WTF::StringImpl, WTF::RawPtrTraits<WTF::StringImpl>, WTF::DefaultRefDerefTraits<WTF::StringImpl>> { struct StringImpl *m_ptr; } m_impl; } m_string; } nameArgument; } __val_; } ; BOOL __engaged_; } m_pseudoElementIdentifier; struct unique_ptr<WTF::ListHashSet<WTF::Ref<WebCore::Node>>, std::default_delete<WTF::ListHashSet<WTF::Ref<WebCore::Node>>>> { struct { void *__ptr_; } ; } m_listBasedTestResult; } _hitTestResult;
