...
@interface WKWebViewConfiguration : NSObject <WKObject, NSSecureCoding, NSCopying> {
    struct AlignedStorage<API::PageConfiguration, 8UL> { struct Storage { unsigned char data[584]; } m_storage; } _pageConfiguration;
}
...
@property (nonatomic, setter=_setOverrideReferrerForAllRequests:) NSString *_overrideReferrerForAllRequests;
@property (nonatomic, setter=_setAllowPostingLegacySynchronousMessages:) BOOL _allowPostingLegacySynchronousMessages;
@property (nonatomic, setter=_setShouldSendConsoleLogsToUIProcessForTesting:) BOOL _shouldSendConsoleLogsToUIProcessForTesting;
