@class NSURL, LNValue, LNExportedContentConfiguration, NSNumber, NSDictionary, LNAsyncSequenceReference, _NSAuxiliaryUndoManagerReference, NSProgress, LNAsyncIteratorReference, LNConfigurableQueryRequest, LNStageContextRequest, NSString, LNAction, LNQueryOutput, NSArray, LNXPCListenerEndpointContainer, NSXPCConnection, NSError, NSUUID;
