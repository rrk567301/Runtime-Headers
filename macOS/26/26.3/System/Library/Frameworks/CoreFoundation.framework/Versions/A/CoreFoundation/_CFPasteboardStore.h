...
- (id)description;
- (void)dealloc;
- (void)handleGetIsExcludedFromHistory:(id)a0;
- (void)handleSetIsExcludedFromHistory:(id)a0;
...
- (unsigned char)onqueue_checkEndpointSecurityWithEntry:(id)a0 destination:(struct { unsigned int x0[8]; })a1;
