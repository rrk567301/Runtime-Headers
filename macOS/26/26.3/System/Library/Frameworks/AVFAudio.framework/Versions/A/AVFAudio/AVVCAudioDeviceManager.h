...
+ (BOOL)IsAppleDisplayDevice:(id)a0;
...
+ (BOOL)IsSiriSupportedAppleDisplay:(id)a0;
...
+ (void)setReporterIDs:(struct vector<long long, std::allocator<long long>> { long long *x0; long long *x1; struct { long long *x0; } x2; })a0 onDevice:(id)a1;
