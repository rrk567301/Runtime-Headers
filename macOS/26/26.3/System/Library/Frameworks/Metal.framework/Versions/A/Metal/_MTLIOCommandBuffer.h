@class , NSString, _MTLIOCommandQueue, NSError, MTLResourceList, __end_;
...
@interface _MTLIOCommandBuffer : _MTLObjectWithLabel <MTLIOCommandBufferSPI> {
    ...
    struct vector<id<MTLIOScratchBuffer>, std::allocator<id<MTLIOScratchBuffer>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _activeScratchBuffers;
    struct vector<id<MTLIOScratchBuffer>, std::allocator<id<MTLIOScratchBuffer>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _poolScratchBuffers;
}
