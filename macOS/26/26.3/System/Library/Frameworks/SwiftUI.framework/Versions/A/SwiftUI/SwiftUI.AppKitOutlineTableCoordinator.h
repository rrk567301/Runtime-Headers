@interface SwiftUI.AppKitOutlineTableCoordinator : SwiftUI.PlatformViewCoordinator <NSOutlineViewDelegate, NSOutlineViewDataSource, NSOutlineViewDelegatePrivate> {
    ...
    void /* unknown type, empty encoding */ dragConfiguration;
    void /* unknown type, empty encoding */ supplementaryDragConfiguration;
    void /* unknown type, empty encoding */ dropController;
    void /* unknown type, empty encoding */ tableView;
    void /* unknown type, empty encoding */ selectionGuardReason;
    void /* unknown type, empty encoding */ subviewSizingOptions;
    void /* unknown type, empty encoding */ subviewUniformHeight;
    void /* unknown type, empty encoding */ isUpdatingTableColumns;
    void /* unknown type, empty encoding */ rootItem;
    void /* unknown type, empty encoding */ isDragSource;
