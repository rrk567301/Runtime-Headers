@interface _TtC7SwiftUIP33_0BC2519238CC4854E8BA774CC855AC9A22PasteboardDataProvider : NSObject <NSFilePromiseProviderDelegate, NSPasteboardItemDataProvider_Private> {
    ...
    void /* unknown type, empty encoding */ onDataTransferConcluded;
}
