@class NSString, NSArray, NSTrackingArea, CALayer, QLOverlayProgressButtonLayer, QLOverlayButtonLayer, QLOverlayView, NSObject, QLOverlayGlassBackground, QLOverlayLoadingButtonLayer;
