...
@property (nonatomic) struct Dispatch_Queue { struct object { NSObject<OS_dispatch_object> *fObj; } fObj; struct weak_ptr<AMCP::Utility::Dispatch_Queue> { struct Dispatch_Queue *__ptr_; struct __shared_weak_count *__cntrl_; } __weak_this_; struct Workloop { struct object { NSObject<OS_dispatch_object> *fObj; } fObj; } m_workloop; struct atomic<bool> { struct __cxx_atomic_impl<bool, std::__cxx_atomic_base_impl<bool>> { _Atomic BOOL __a_value; } __a_; } m_flush_started; struct atomic<bool> { struct __cxx_atomic_impl<bool, std::__cxx_atomic_base_impl<bool>> { _Atomic BOOL __a_value; } __a_; } m_something_dispatched_after_flush; struct vector<AMCP::Utility::Dispatch_Queue::Event_Source, std::allocator<AMCP::Utility::Dispatch_Queue::Event_Source>> { struct Event_Source *__begin_; struct Event_Source *__end_; struct { struct Event_Source *__cap_; } ; } m_port_death_list; struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } m_port_death_list_mutex; struct vector<AMCP::Utility::Dispatch_Queue::Event_Source, std::allocator<AMCP::Utility::Dispatch_Queue::Event_Source>> { struct Event_Source *__begin_; struct Event_Source *__end_; struct { struct Event_Source *__cap_; } ; } m_mach_port_receiver_list; struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } m_mach_port_receiver_list_mutex; struct vector<AMCP::Utility::Dispatch_Queue::Event_Source, std::allocator<AMCP::Utility::Dispatch_Queue::Event_Source>> { struct Event_Source *__begin_; struct Event_Source *__end_; struct { struct Event_Source *__cap_; } ; } m_mig_server_list; struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } m_mig_server_list_mutex; struct atomic<long long> { struct __cxx_atomic_impl<long long, std::__cxx_atomic_base_impl<long long>> { _Atomic long long __a_value; } __a_; } m_after_count; NSObject<OS_dispatch_semaphore> *m_after_count_semaphore; struct optional<applesauce::dispatch::group> { union { char __null_state_; struct group { struct object { NSObject<OS_dispatch_object> *fObj; } fObj; } __val_; } ; BOOL __engaged_; } m_dispatch_group; } queue;
