@class NSString, NWConcrete_nw_connection, NWURLSessionTaskConfiguration, NWURLBackgroundScheduler, NSURLRequest, NWURLError, NSObject, NSCachedURLResponse, NWURLLoaderCache;
