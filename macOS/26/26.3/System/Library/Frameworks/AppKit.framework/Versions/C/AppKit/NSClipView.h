...
@property (copy) id /* block */ _scrollCompletionHandler;
...
- (BOOL)_scrollTo:(const struct CGPoint { double x0; double x1; } *)a0 animateScroll:(long long)a1 flashScrollerKnobs:(unsigned long long)a2 completionHandler:(id /* block */)a3;
