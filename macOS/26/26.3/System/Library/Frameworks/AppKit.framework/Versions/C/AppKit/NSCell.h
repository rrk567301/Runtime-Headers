...
@interface NSCell : NSObject <_NSControlEventTrackable, _NSControlValueAccessing, NSCopying, NSCoding, NSUserInterfaceItemIdentification, NSAccessibilityElement, NSAccessibility> {
    ...
    unsigned char _forceGladeMetrics : 1;
...
@property (setter=_setForceGladeMetrics:) BOOL _forceGladeMetrics;
...
+ (id)_bulletStringForString:(id)a0 bulletCharacter:(unsigned short)a1;
+ (id)_cuiCatalogKey;
...
- (void)_editingInViewDidChange:(id)a0;
