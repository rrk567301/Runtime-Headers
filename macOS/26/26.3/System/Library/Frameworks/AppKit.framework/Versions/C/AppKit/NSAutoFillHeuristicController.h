...
@interface NSAutoFillHeuristicController : NSObject <RTIInputSystemClientDelegate, NSMenuItemValidation> {
    ...
    BOOL _isCollectingSelectedTextRectAndRangeForTextInputContext;
    ...
    BOOL _hasDeliveredOneTimeCodesForAutoFill;
}
...
- (BOOL)_canRestrictDeliveredOneTimeCodeAutoFillToOnlyWhenCodesAreAvailable;
...
- (BOOL)_isAbleToHandleAutoFillForTextInputContext:(id)a0;
...
- (BOOL)_selectedTextRectIsInvalid:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (void)_showOrHideAutoFillForCurrentTextInputContextIfAppropriate;
...
- (void)safariPlatformSupport:(id)a0 hasDeliveredOneTimeCodesForAutoFillDidChange:(BOOL)a1;
- (BOOL)shouldReconnectOnInterruption:(id)a0;
