@class NSSet, NSImage, NSAppearance, NSColorSpace, SLSIconAppearanceConfiguration, NSString;
...
@property (retain, nonatomic) SLSIconAppearanceConfiguration *iconAppearanceConfiguration;
