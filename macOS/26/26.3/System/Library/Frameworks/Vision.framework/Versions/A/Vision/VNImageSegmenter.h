...
- (void).cxx_destruct;
- (BOOL)_addInstanceMaskBuffersForCategory:(id)a0 instanceFeatures:(id)a1 toInstanceMaskArray:(id)a2 connectedComponentResult:(const void *)a3 featureInstanceMaskMap:(id)a4 categoryInstanceMaskMap:(id)a5 options:(id)a6 session:(id)a7 error:(id *)a8;
- (struct __CVBuffer { } *)_createPixelBufferOfFormat:(unsigned int)a0 fromImageBuffer:(struct vImage_Buffer { void *x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; })a1 ofType:(int)a2 options:(id)a3 session:(id)a4 error:(id *)a5;
- (struct __CVBuffer { } *)_createPixelBufferOfFormat:(unsigned int)a0 fromSegmenter:(id)a1 instanceFeatures:(id)a2 category:(int)a3 options:(id)a4 session:(id)a5 error:(id *)a6;
- (struct __CVBuffer { } *)_createPixelBufferOfFormat:(unsigned int)a0 fromSegmenter:(id)a1 instanceFeatures:(id)a2 options:(id)a3 session:(id)a4 error:(id *)a5;
- (BOOL)_instanceMask:(struct __CVBuffer { } *)a0 containsTargetPoints:(id)a1;
- (id)_observationsFromSegmenter:(id)a0 instanceFeatures:(id)a1 originatingRequestSpecifier:(id)a2 options:(id)a3 maskPixelFormatType:(unsigned int)a4 session:(id)a5 error:(id *)a6;
- (struct vector<float, std::allocator<float>> { float *x0; float *x1; struct { float *x0; } x2; })_oneDimensionalArrayFromInputVNPointArray:(id)a0;
- (BOOL)_validatePoints:(id)a0 error:(id *)a1;
- (BOOL)_validateSegmentationOutputFormat:(unsigned int)a0;
- (struct __CVBuffer { } *)createAllInstancesMaskFromForegroundCC:(const void *)a0 backgroundCC:(const void *)a1 options:(id)a2 session:(id)a3 error:(id *)a4;
