...
- (id)initForNewController:(id)a0 fabricTable:(void *)a1 keystore:(struct OperationalKeystore { void /* function */ **x0; } *)a2 advertiseOperational:(BOOL)a3 params:(id)a4 error:(struct ChipError { unsigned int x0; unsigned int x1; char *x2; } *)a5;
