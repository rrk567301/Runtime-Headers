...
+ (void)readAttributeDPTZStreamsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeMovementStateWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeDPTZStreamsWithCompletion:(id /* block */)a0;
...
- (void)readAttributeMovementStateWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeDPTZStreamsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeMovementStateWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
