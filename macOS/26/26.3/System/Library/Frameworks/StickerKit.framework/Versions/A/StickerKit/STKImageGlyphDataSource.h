...
@interface STKImageGlyphDataSource : STKImageGlyphAggregatingDataSource {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_notificationCenter;
    ...
    void /* unknown type, empty encoding */ isConfiguring;
    void /* unknown type, empty encoding */ $__lazy_storage_$_assessmentMonitor;
}
