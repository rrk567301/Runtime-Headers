...
@interface CADisplayMode : NSObject {
    struct CADisplayModePriv { struct Mode { union { struct { unsigned short x0 : 14; unsigned short x1 : 14; unsigned char x2 : 1; unsigned int x3 : 25; unsigned char x4 : 1; unsigned char x5 : 5; unsigned char x6 : 2; unsigned char x7 : 1; unsigned char x8 : 1; } x0; unsigned long long x1; } x0; } x0; id x1; unsigned long long x2; unsigned long long x3; unsigned int x4; id x5; struct PerModeInfo { unsigned int x0; unsigned int x1; unsigned char x2; unsigned char x3; } x6; unsigned int x7; unsigned int x8; } *_priv;
}
...
+ (id)_displayModeWithMode:(struct Mode { union { struct { unsigned short x0 : 14; unsigned short x1 : 14; unsigned char x2 : 1; unsigned int x3 : 25; unsigned char x4 : 1; unsigned char x5 : 5; unsigned char x6 : 2; unsigned char x7 : 1; unsigned char x8 : 1; } x0; unsigned long long x1; } x0; })a0 display:(id)a1 rates:(id)a2 perMode:(struct PerModeInfo { unsigned int x0; unsigned int x1; unsigned char x2; unsigned char x3; })a3 maxSourceBandwidthPerPipe:(unsigned int)a4 maxMultiPipeAggregateBandwidth:(unsigned int)a5;
...
- (id)_initWithMode:(struct Mode { union { struct { unsigned short x0 : 14; unsigned short x1 : 14; unsigned char x2 : 1; unsigned int x3 : 25; unsigned char x4 : 1; unsigned char x5 : 5; unsigned char x6 : 2; unsigned char x7 : 1; unsigned char x8 : 1; } x0; unsigned long long x1; } x0; })a0 display:(id)a1 rates:(id)a2 perMode:(struct PerModeInfo { unsigned int x0; unsigned int x1; unsigned char x2; unsigned char x3; })a3 maxSourceBandwidthPerPipe:(unsigned int)a4 maxMultiPipeAggregateBandwidth:(unsigned int)a5;
