...
@interface CAWindowServerDisplay : NSObject <CABrightnessControl, CAPresetTransaction> {
    struct CAWindowServerDisplayImpl { struct Mutex { struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x0; } x0; struct Server *x1; struct CABrightnessTransaction { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; float x11; struct { float x0[9]; } x12; float x13; BOOL x14; BOOL x15; unsigned int x16; } x2; id /* block */ x3; id x4; id x5; id x6; id x7; BOOL x8; BOOL x9; } *_impl;
}
...
@property BOOL pulseWidthMaximization;
...
@property (readonly) BOOL supportsSecureIndicators;
@property double globalLightAngle;
@property (copy) id /* block */ needsGlobalLightCallback;
@property (readonly) BOOL supportsLFC;
...
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(BOOL *)a1;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2;
- (void)renderForTime:(double)a0;
- (void)cancelAllSwaps;
- (void)registerForNotifications:(id)a0 withBlock:(id /* block */)a1;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2 readOnly:(BOOL *)a3 vsyncOff:(BOOL)a4 sharedEventRef:(struct __IOSurfaceSharedEvent **)a5 signalValue:(unsigned long long *)a6;
- (void)activateReplay;
- (BOOL)copySecureIndicatorsToUpdate:(void *)a0 fromUpdate:(void *)a1 indicatorWindowRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 destinationResolution:(float)a3;
- (void)invalidate;
- (void)freeze;
...
- (void)setSCLCursorResolution:(int)a0;
- (void)displayWatchdogWillTimeout;
- (void)setSCLCursorOutline:(float)a0 g:(float)a1 b:(float)a2 a:(float)a3;
...
- (BOOL)setPrivacyIndicatorSurface:(struct __IOSurface { } *)a0 atPosition:(struct CGPoint { double x0; double x1; })a1;
...
- (struct __IOSurface { } *)currentSurfaceWithProtection:(unsigned long long)a0 needsClear:(BOOL *)a1;
...
- (void)setSecureIndicatorBrightnessCallback:(id /* block */)a0;
...
- (BOOL)flushSecureIndicators:(void *)a0;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2 readOnly:(BOOL *)a3 vsyncOff:(BOOL)a4 sharedEventRef:(struct __IOSurfaceSharedEvent **)a5 signalValue:(unsigned long long *)a6 wantFP16:(BOOL)a7;
- (unsigned long long)protectionLevel;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(BOOL *)a1 readOnly:(BOOL *)a2 vsyncOff:(BOOL)a3 sharedEventRef:(struct __IOSurfaceSharedEvent **)a4 signalValue:(unsigned long long *)a5 wantFP16:(BOOL)a6;
...
- (void)setSCLCursorName:(struct __CFString { } *)a0;
...
- (struct __IOSurface { } *)currentSurfaceWithProtection:(unsigned long long)a0 needsClear:(BOOL *)a1 readOnly:(BOOL *)a2;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2 readOnly:(BOOL *)a3 vsyncOff:(BOOL)a4;
- (struct __IOSurface { } *)acquireFrozenSurface;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(BOOL *)a1 readOnly:(BOOL *)a2 vsyncOff:(BOOL)a3;
- (void)setSCLCursorFill:(float)a0 g:(float)a1 b:(float)a2 a:(float)a3;
- (void)setGlobalLightParameters:(id)a0;
- (void)setSCLCursorScale:(float)a0;
- (void)addFramePresentationTimestamp:(unsigned long long)a0;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(BOOL *)a1 readOnly:(BOOL *)a2;
- (void)update;
...
- (void)dealloc;
- (BOOL)calibrationToolboxCommand:(unsigned int)a0 input_buffer:(id)a1 output_buffer:(id *)a2;
- (void)powerStateDidChange:(id)a0;
- (void)setAccessibilityColorMatrix:(float *)a0 scale:(float)a1;
- (struct __IOSurface { } *)currentSurfaceWithOptions:(unsigned long long)a0 needsClear:(BOOL *)a1 readOnly:(BOOL *)a2 vsyncOff:(BOOL)a3 sharedEventRef:(struct __IOSurfaceSharedEvent **)a4 signalValue:(unsigned long long *)a5;
- (void)addClone:(id)a0;
