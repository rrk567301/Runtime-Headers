...
@interface MLE5ExecutionStreamOperation : NSObject {
    struct unique_ptr<e5rt_async_event, MLE5ObjectDeleter<e5rt_async_event>> { struct { struct e5rt_async_event *__ptr_; } ; } _cachedWaitEvent;
}
...
- (id)_inoutPortNames;
- (void)_bindCompletionSyncPointDirectlyIfPossible:(id)a0;
...
- (BOOL)serializeInferenceFrameDataForOptions:(id)a0 error:(id *)a1;
