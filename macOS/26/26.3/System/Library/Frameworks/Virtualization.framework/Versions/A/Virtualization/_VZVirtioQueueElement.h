...
@interface _VZVirtioQueueElement : NSObject {
    struct Element { union { struct { unsigned short descriptor_index; } split; struct { unsigned short buffer_id; unsigned short chained_descriptor_count; } packed; } ; unsigned int bytes_written; struct GuestDescriptors { struct vector<VzCore::Hardware::Virtio::GuestDescriptors::Element, std::allocator<VzCore::Hardware::Virtio::GuestDescriptors::Element>> { struct Element *__begin_; struct Element *__end_; struct { struct Element *__cap_; } ; } _elements; } guest_read_buffers; struct GuestDescriptors { struct vector<VzCore::Hardware::Virtio::GuestDescriptors::Element, std::allocator<VzCore::Hardware::Virtio::GuestDescriptors::Element>> { struct Element *__begin_; struct Element *__end_; struct { struct Element *__cap_; } ; } _elements; } guest_write_buffers; struct IoVector { unsigned long long _size; struct vector<std::span<unsigned char>, std::allocator<std::span<unsigned char>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _buffers; } read_buffers; struct IoVector { unsigned long long _size; struct vector<std::span<unsigned char>, std::allocator<std::span<unsigned char>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _buffers; } write_buffers; } _element;
