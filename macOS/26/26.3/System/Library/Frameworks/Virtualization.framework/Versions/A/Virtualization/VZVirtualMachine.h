...
@interface VZVirtualMachine : NSObject <_VZPointingEventSender, _VZMultiTouchEventSender, _VZKeyboardEventSender, _VZHIDAdditions> {
    ...
    struct unique_ptr<Base::Xpc::Connection, std::default_delete<Base::Xpc::Connection>> { struct { struct Connection *__ptr_; } ; } _connection;
    ...
    struct unique_ptr<Vz::VzVirtualMachineMessenger, std::default_delete<Vz::VzVirtualMachineMessenger>> { struct { struct VzVirtualMachineMessenger *__ptr_; } ; } _messenger;
    struct unique_ptr<Base::DispatchSource, std::default_delete<Base::DispatchSource>> { struct { struct DispatchSource *__ptr_; } ; } _cancellationSource;
