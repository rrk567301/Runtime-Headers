...
@interface VZVirtioSocketDevice : VZSocketDevice {
    ...
    struct map<unsigned int, VZVirtioSocketListener *, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, VZVirtioSocketListener *>>> { struct __tree<std::__value_type<unsigned int, VZVirtioSocketListener *>, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, VZVirtioSocketListener *>, std::less<unsigned int>>, std::allocator<std::__value_type<unsigned int, VZVirtioSocketListener *>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _listeners;
