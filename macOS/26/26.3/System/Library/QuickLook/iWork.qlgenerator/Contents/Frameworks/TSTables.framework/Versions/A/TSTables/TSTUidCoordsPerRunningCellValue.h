...
@interface TSTUidCoordsPerRunningCellValue : NSObject {
    struct vector<TSCECellValue *, std::allocator<TSCECellValue *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _cellValues;
    struct vector<TSTUidCoordsPerGroupValueTuple *, std::allocator<TSTUidCoordsPerGroupValueTuple *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _uidCoords;
}
