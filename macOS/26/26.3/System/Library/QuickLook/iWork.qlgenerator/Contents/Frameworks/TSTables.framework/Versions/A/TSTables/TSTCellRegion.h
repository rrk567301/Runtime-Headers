...
@property (readonly, nonatomic) struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *__begin_; struct TSUCellRect *__end_; struct { struct TSUCellRect *__cap_; } ; } cellRanges;
...
+ (struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; struct TSUCellRect *x1; struct { struct TSUCellRect *x0; } x2; })combineNonOverlappingCellRanges:(void *)a0 addingOverlappingCellRanges:(void *)a1;
...
- (struct vector<TSUCellRect, std::allocator<TSUCellRect>> { struct TSUCellRect *x0; struct TSUCellRect *x1; struct { struct TSUCellRect *x0; } x2; })rowBasedSubRangesOfCellCount:(unsigned long long)a0;
