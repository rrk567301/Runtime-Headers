...
- (struct CGPoint { double x0; double x1; })axisSnapPoint:(struct CGPoint { double x0; double x1; })a0 toXs:(struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; })a1 toYs:(struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; })a2 withThreshold:(double)a3;
