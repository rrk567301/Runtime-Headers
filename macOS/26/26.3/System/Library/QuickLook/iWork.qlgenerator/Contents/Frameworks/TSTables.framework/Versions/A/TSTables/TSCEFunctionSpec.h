...
@interface TSCEFunctionSpec : TSUPermanentObject {
    ...
    struct vector<TSCEFunctionArgSpec *, std::allocator<TSCEFunctionArgSpec *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _arguments;
    struct vector<TSCEFunctionArgSpec *, std::allocator<TSCEFunctionArgSpec *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _repeatingArguments;
}
...
- (BOOL)acceptsFunctorAtIndex:(unsigned long long)a0 numArgs:(unsigned long long)a1;
