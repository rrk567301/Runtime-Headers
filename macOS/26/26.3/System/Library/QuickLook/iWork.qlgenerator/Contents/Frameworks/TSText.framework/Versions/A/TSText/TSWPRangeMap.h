...
@property (nonatomic) struct vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> { struct _TSWPCharIndexAndAffinity *__begin_; struct _TSWPCharIndexAndAffinity *__end_; struct { struct _TSWPCharIndexAndAffinity *__cap_; } ; } unmappedIndexes;
@property (nonatomic) struct vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> { struct _TSWPCharIndexAndAffinity *__begin_; struct _TSWPCharIndexAndAffinity *__end_; struct { struct _TSWPCharIndexAndAffinity *__cap_; } ; } mappedIndexes;
...
- (unsigned long long)p_extendBackwardMappedIndex:(unsigned long long)a0;
- (unsigned long long)p_extendForwardMappedIndex:(unsigned long long)a0;
