@interface TSCEDecimalMatrix : NSObject <NSCopying> {
    ...
    struct vector<TSUDecimal, std::allocator<TSUDecimal>> { struct TSUDecimal *__begin_; struct TSUDecimal *__end_; struct { struct TSUDecimal *__cap_; } ; } _values;
}
...
- (struct vector<TSCEDecimalMatrix *, std::allocator<TSCEDecimalMatrix *>> { id *x0; id *x1; struct { id *x0; } x2; })pluDecompositionWithPivotDet:(struct TSUDecimal { struct { unsigned long long x0[2]; } x0; } *)a0;
