@interface TSTStrokeLayer : TSPObject <NSCopying, NSMutableCopying, TSTStrokeLayerEnumerating> {
    struct vector<TSTStrokeLayerRun, std::allocator<TSTStrokeLayerRun>> { struct TSTStrokeLayerRun *__begin_; struct TSTStrokeLayerRun *__end_; struct { struct TSTStrokeLayerRun *__cap_; } ; } _strokeRuns;
}
