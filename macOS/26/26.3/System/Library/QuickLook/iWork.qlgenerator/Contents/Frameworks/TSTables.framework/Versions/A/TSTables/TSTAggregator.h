...
- (struct vector<TSCECellRef, std::allocator<TSCECellRef>> { struct TSCECellRef *x0; struct TSCECellRef *x1; struct { struct TSCECellRef *x0; } x2; })cellRefsForAggNodesAtGroup:(id)a0;
