...
@interface TNChartMediator : TSCHChartMediator <TSCECalculationEngineRegistration, TSCEFormulaOwning> {
    ...
    struct unordered_set<TSUCellCoord, std::hash<TSUCellCoord>, std::equal_to<TSUCellCoord>, std::allocator<TSUCellCoord>> { struct __hash_table<TSUCellCoord, std::hash<TSUCellCoord>, std::equal_to<TSUCellCoord>, std::allocator<TSUCellCoord>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<TSUCellCoord, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TSUCellCoord, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TSUCellCoord, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<TSUCellCoord, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _formulasToRecalculate;
    int _scatterFormat;
...
- (struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; struct TSCERangeRef *x1; struct { struct TSCERangeRef *x0; } x2; })expandSingleTractForProposedCategoryLabels:(id)a0 byRow:(BOOL)a1;
- (id)formulaOwner;
...
- (struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> { struct TSCERangeRef *x0; struct TSCERangeRef *x1; struct { struct TSCERangeRef *x0; } x2; })p_expandSingleRangeForLabels:(const struct TSCERangeRef { struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x1; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 iterateOverRowsNotColumns:(BOOL)a1;
