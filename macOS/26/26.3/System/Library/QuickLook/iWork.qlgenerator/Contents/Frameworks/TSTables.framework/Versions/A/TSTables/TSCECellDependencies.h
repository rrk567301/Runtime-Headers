...
@interface TSCECellDependencies : NSObject {
    ...
    struct vector<TSCECellRecordTile *, std::allocator<TSCECellRecordTile *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _tiles;
    unsigned long long _numCellRecords;
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct { struct TSCEBitGridTile **__cap_; } ; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _containsAFormulaGrid;
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct { struct TSCEBitGridTile **__cap_; } ; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _isDirtyGrid;
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct { struct TSCEBitGridTile **__cap_; } ; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _isInACycleGrid;
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct { struct TSCEBitGridTile **__cap_; } ; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _isDirtyAndNotInACycleGrid;
...
- (struct vector<TSUCellCoord, std::allocator<TSUCellCoord>> { struct TSUCellCoord *x0; struct TSUCellCoord *x1; struct { struct TSUCellCoord *x0; } x2; })cellsWithRecordsInRange:(const struct TSCERangeCoordinate { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x1; } *)a0 formulaCellsOnly:(BOOL)a1;
