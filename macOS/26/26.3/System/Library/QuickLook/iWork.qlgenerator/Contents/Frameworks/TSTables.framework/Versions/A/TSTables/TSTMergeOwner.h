...
- (struct vector<TSUModelCellRect, std::allocator<TSUModelCellRect>> { struct TSUModelCellRect *x0; struct TSUModelCellRect *x1; struct { struct TSUModelCellRect *x0; } x2; })allValidMergesForMergeList:(const void *)a0;
