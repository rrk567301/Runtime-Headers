@class NSString, RTPlaceTypeClassifierMetricsCalculator, RTDistanceCalculator, RTLearnedLocationStore, RTVisitManager, RTLocationManager, RTMapServiceManager;
...
- (id)initWithDistanceCalculator:(id)a0 learnedLocationStore:(id)a1 locationManager:(id)a2 mapServiceManager:(id)a3 visitManager:(id)a4 placeTypeClassifierMetricsCalculator:(id)a5;
