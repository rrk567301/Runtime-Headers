...
@property (nonatomic) BOOL enableWalkBikeClustering;
@property (nonatomic) unsigned long long maxDeletionAttemptsForClusterData;
@property (nonatomic) BOOL rehydrateRouteLocationsFromWaypoints;
@property (nonatomic) BOOL cleanUpClusterWithDuplicateWaypoints;
