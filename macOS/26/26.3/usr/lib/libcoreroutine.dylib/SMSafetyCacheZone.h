...
- (void).cxx_destruct;
- (void)createRecordsWithParticipants:(id)a0 qos:(id)a1 completion:(id /* block */)a2;
...
- (void)fetchShareParticipantsWithRetryCount:(long long)a0 conversation:(id)a1 qos:(id)a2 completion:(id /* block */)a3;
- (void)fetchShareWithQos:(id)a0 completion:(id /* block */)a1;
...
- (void)setupZoneAndShareWithConversation:(id)a0 qos:(id)a1 completion:(id /* block */)a2;
