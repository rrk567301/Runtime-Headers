...
+ (id)mutableQueryForSearch:(BOOL)a0 useAppSpecificAccessGroup:(BOOL)a1 withParameters:(id)a2;
...
+ (BOOL)lookupGenericItem:(id)a0 account:(id *)a1 passphrase:(id *)a2 options:(unsigned long long)a3 searchInLegacyKeychainIfNeeded:(BOOL)a4 error:(id *)a5;
+ (void)lookupGenericItem:(id)a0 localizedReason:(id)a1 completionQueue:(id)a2 completionHandler:(id /* block */)a3;
+ (int)lookupGenericItem:(id)a0 needsData:(BOOL)a1 synchronizable:(BOOL)a2 searchInLegacyKeychainIfNeeded:(BOOL)a3 outRef:(const void **)a4;
+ (BOOL)lookupGenericItem:(id)a0 passphrase:(id *)a1 options:(unsigned long long)a2 error:(id *)a3;
+ (void)migratePasswordItem:(void *)a0;
+ (id)mutableQueryForGenericItem:(id)a0 useAppSpecificAccessGroup:(BOOL)a1 returnData:(BOOL)a2;
+ (id)queryForSearch:(BOOL)a0 useAppSpecificAccessGroup:(BOOL)a1 withParameters:(id)a2;
