...
@interface PHASESoundEvent : NSObject <MetaParameterValueProtocol> {
    ...
    struct vector<Phase::UniqueObjectId, std::allocator<Phase::UniqueObjectId>> { struct UniqueObjectId *__begin_; struct UniqueObjectId *__end_; struct { struct UniqueObjectId *__cap_; } ; } _submixIds;
