...
@interface PHASEShape : NSObject <NSCopying> {
    struct MdlMeshAsset { unsigned int mType; struct unique_ptr<Phase::details::MdlMeshAssetImplementation, std::default_delete<Phase::details::MdlMeshAssetImplementation>> { struct { struct MdlMeshAssetImplementation *__ptr_; } ; } mpImplementation; } _meshAsset;
    int _voxelDensity;
    unsigned long long _flags;
    BOOL _isReal;
    struct vector<Phase::LocalizedGeometryPermutation, std::allocator<Phase::LocalizedGeometryPermutation>> { struct LocalizedGeometryPermutation *__begin_; struct LocalizedGeometryPermutation *__end_; struct { struct LocalizedGeometryPermutation *__cap_; } ; } _localizedGeometryPermutations;
}
