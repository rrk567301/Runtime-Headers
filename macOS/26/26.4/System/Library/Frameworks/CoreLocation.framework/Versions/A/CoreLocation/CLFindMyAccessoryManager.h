...
+ (id)checkAvailabilityForPairedOwnerInformationControlPointMessages:(id)a0 messageName:(struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct { union __rep { struct __short { char x0[23]; unsigned char x1 : 7; unsigned char x2 : 1; } x0; struct __long { char *x0; unsigned long long x1; unsigned long x2 : 63; unsigned char x3 : 1; } x1; } x0; } x0; })a1;
...
- (void)fetchAISProtocolImplementation:(id)a0;
- (void)fetchFirmwareVersionFromDevice:(id)a0;
- (void)initRangingOnDevice:(id)a0 macAddress:(id)a1;
- (void)startNBRangingOnDevice:(id)a0 withIRK:(id)a1;
- (void)fetchTxPowerFromDevice:(id)a0 asOwner:(BOOL)a1;
- (void)initAccumulator;
- (void)configureNBRangingOnDevice:(id)a0 withParams:(id)a1;
...
- (void)fetchAISAccessoryCapabilities:(id)a0;
- (void)fetchAISAccessoryCategory:(id)a0;
- (void)fetchAISBatteryLevel:(id)a0;
- (void)fetchAISBatteryType:(id)a0;
- (void)fetchAISFirmwareVersion:(id)a0;
- (void)fetchAISForTAUnknownBeacon:(id)a0 macAddress:(id)a1 deviceType:(id)a2;
- (void)fetchAISManufacturerName:(id)a0;
- (void)fetchAISModelName:(id)a0;
- (void)fetchAISNetworkID:(id)a0;
- (void)fetchAISProductData:(id)a0;
- (void)fetchAISSerialNumber:(id)a0;
...
- (void)fetchAccessoryInformationForDevice:(id)a0;
- (void)fetchBatteryStatusForDevice:(id)a0;
- (void)fetchConnectionStateForDevice:(id)a0;
- (void)fetchFindingCapabilities:(id)a0;
...
- (void)forceSurfaceStagedDetections:(id)a0 deviceType:(id)a1 detailsBitmask:(id)a2;
...
- (void)stageTADetection:(id)a0 deviceType:(id)a1 detailsBitmask:(id)a2 shouldRemoveDevice:(id)a3;
