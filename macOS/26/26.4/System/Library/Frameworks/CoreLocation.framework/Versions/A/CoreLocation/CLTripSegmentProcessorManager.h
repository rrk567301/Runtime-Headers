...
- (id)constructRouteFromWaypoints:(id)a0 forRouteID:(id)a1 withOptions:(id)a2 outputHandler:(id /* block */)a3;
- (void)constructRouteFromWaypoints:(id)a0 forRouteID:(id)a1 withOptions:(id)a2 outputHandler:(id /* block */)a3 completionHandler:(id /* block */)a4;
