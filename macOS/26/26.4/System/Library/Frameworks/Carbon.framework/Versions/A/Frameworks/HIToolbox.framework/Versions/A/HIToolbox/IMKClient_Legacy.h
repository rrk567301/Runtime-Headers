...
- (void)_invalidateXPCConnectionForSession:(id)a0;
- (BOOL)_isNonLaunchOption;
- (BOOL)_isPalette;
- (BOOL)_isServerRetryPending;
- (BOOL)_isXPCConnectionUsable:(id)a0;
...
- (BOOL)_shouldAttemptXPCConnection;
