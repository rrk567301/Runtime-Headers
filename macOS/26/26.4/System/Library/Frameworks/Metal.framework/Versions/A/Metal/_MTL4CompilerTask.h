...
@interface _MTL4CompilerTask : _MTLObjectWithLabel <MTL4CompilerTaskGGDSPI> {
    ...
    struct _opaque_pthread_cond_t { long long __sig; char __opaque[40]; } _completionHandlerCondition;
    BOOL _hasNoPendingCompletionHandlers;
    ...
    BOOL _completionHandlerConditionInitialized;
}
