@class NSDateComponents, NSDate, NSDictionary, NSObject, CNWallpaper, CNContactKeyVector, CNWallpaperMetadata, NSString, NSSet, SGRecordId, CNActivityAlert, NSArray, NSData, NSNumber, CNSensitiveContentConfiguration, NSUUID;
...
@property (readonly, nonatomic) BOOL isCoreRecentsAccepted;
...
@property (readonly, copy) NSData *avatarRecipeData;
...
@property (readonly, nonatomic) BOOL isSharingPaired;
...
+ (BOOL)isCoreRecentsAcceptedIdentifier:(id)a0;
...
+ (id)persistedContactWithIdentifierOnly:(id)a0;
...
+ (id)predicateForContactsWithExternalIdentifiers:(id)a0;
...
- (BOOL)arePropertiesEqualToContact:(id)a0 ignoredProperties:(id)a1;
...
- (BOOL)isEquivalent:(id)a0 ignoringProperties:(id)a1;
