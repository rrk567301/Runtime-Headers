...
- (void)failedToFetchContactForContactIdentifier:(id)a0;
- (void)failedToFetchSearchableForContactIdentifiers:(id)a0 error:(id)a1;
- (void)failedToGetBuildVersionWithError:(long long)a0;
...
- (void)unexpectedChangeHistoryError:(id)a0;
...
- (void)willReindexAsFailedToFetchChangeHistoryWithError:(id)a0;
