...
@property (nonatomic) BOOL sharedToMe;
...
- (id)initWithPosterArchiveData:(id)a0 contentIsSensitive:(BOOL)a1 sharedToMe:(BOOL)a2;
- (id)initWithPosterArchiveData:(id)a0 fontDescription:(id)a1 fontColorDescription:(id)a2 backgroundColorDescription:(id)a3 extensionBundleID:(id)a4 vertical:(BOOL)a5 contentIsSensitive:(BOOL)a6;
- (id)initWithPosterArchiveData:(id)a0 fontDescription:(id)a1 fontColorDescription:(id)a2 backgroundColorDescription:(id)a3 extensionBundleID:(id)a4 vertical:(BOOL)a5 contentIsSensitive:(BOOL)a6 sharedToMe:(BOOL)a7;
- (id)initWithPosterArchiveData:(id)a0 fontDescription:(id)a1 fontColorDescription:(id)a2 backgroundColorDescription:(id)a3 extensionBundleID:(id)a4 vertical:(BOOL)a5 identifier:(id)a6 contentIsSensitive:(BOOL)a7;
- (id)initWithPosterArchiveData:(id)a0 fontDescription:(id)a1 fontColorDescription:(id)a2 backgroundColorDescription:(id)a3 extensionBundleID:(id)a4 vertical:(BOOL)a5 identifier:(id)a6 contentIsSensitive:(BOOL)a7 sharedToMe:(BOOL)a8;
- (id)initWithPosterArchiveData:(id)a0 metadata:(id)a1 contentIsSensitive:(BOOL)a2;
- (id)initWithPosterArchiveData:(id)a0 metadata:(id)a1 contentIsSensitive:(BOOL)a2 sharedToMe:(BOOL)a3;
