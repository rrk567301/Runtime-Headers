...
- (id)firstRevertibleCustomIn:(id)a0;
- (id)firstRevertibleIn:(id)a0;
- (id)firstRevertibleSharedIn:(id)a0;
...
- (id)targetProfileForActionType:(unsigned long long)a0 context:(unsigned long long)a1;
- (id)updateContactAndNicknamesForActionType:(unsigned long long)a0 context:(unsigned long long)a1 error:(id *)a2;
...
- (id)updateContactForActionType:(unsigned long long)a0 context:(unsigned long long)a1 error:(id *)a2;
