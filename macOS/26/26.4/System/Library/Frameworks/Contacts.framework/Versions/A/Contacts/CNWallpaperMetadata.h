...
- (id)initWithFontDescription:(id)a0 fontColorDescription:(id)a1 backgroundColorDescription:(id)a2 extensionBundleID:(id)a3 vertical:(BOOL)a4 identifier:(id)a5;
