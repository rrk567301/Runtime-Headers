...
- (BOOL)canChangeDefaultAppForCategory:(unsigned long long)a0;
- (id)URLOverrideForNewsURL:(id)a0;
- (id)URLOverrideForURL:(id)a0;
- (void)_LSClearSchemaCaches;
- (void)_LSFailedToOpenURL:(id)a0 withBundle:(id)a1;
- (BOOL)_LSPrivateAskLSDToExitSafely:(double)a0 completionHandler:(id /* block */)a1;
...
- (BOOL)_LSPrivateRebuildDatabaseAtNextRestart:(id /* block */)a0;
...
- (BOOL)getDefaultApplicationCategories:(unsigned long long *)a0 withCurrentDefaultApplication:(id)a1 error:(id *)a2;
...
- (BOOL)isApplicationEligibleForReadOnlyDocumentOpenBehavior:(id)a0;
- (BOOL)isBundleEligibleForOpenDocumentViaOpenURL:(id)a0;
...
- (BOOL)mayProcessWithAuditTokenMapDatabase:(struct { unsigned int x0[8]; })a0;
...
- (id)operationToOpenResource:(id)a0 usingApplication:(id)a1 uniqueDocumentIdentifier:(id)a2 isContentManaged:(BOOL)a3 sourceAuditToken:(const struct { unsigned int x0[8]; } *)a4 userInfo:(id)a5 configuration:(id)a6 delegate:(id)a7;
...
- (id)preferenceSetDateForDefaultAppCategory:(unsigned long long)a0 error:(id *)a1;
- (void)rebuildDatabaseContentForFrameworkAtURL:(id)a0 completionHandler:(id /* block */)a1;
- (BOOL)refreshUnbundledSystemExtensionPointsWithOperationUUID:(id)a0 requestContext:(id)a1 saveObserver:(id)a2 registrationError:(id *)a3;
...
- (BOOL)registerBuiltinApplicationWithInstallationRecord:(id)a0 extensionInstallationRecords:(id)a1 personaUniqueStrings:(id)a2 operationUUID:(id)a3 requestContext:(id)a4 saveObserver:(id)a5 registrationError:(id *)a6;
- (BOOL)registerBuiltinStandaloneExtension:(id)a0 personaUniqueStrings:(id)a1 operationUUID:(id)a2 requestContext:(id)a3 saveObserver:(id)a4 registrationError:(id *)a5;
...
- (void)setDefaultHandlerForTypeRecord:(id)a0 toApplicationRecord:(id)a1 completionHandler:(id /* block */)a2;
...
- (BOOL)setPersonaUniqueStrings:(id)a0 forApplicationsWithBundleIdentifiers:(id)a1 operationUUID:(id)a2 requestContext:(id)a3 saveObserver:(id)a4 error:(id *)a5;
- (void)setPreferenceForNoHandlerForCategory:(unsigned long long)a0 completionHandler:(id /* block */)a1;
...
- (BOOL)unregisterBuiltinApplicationAtURL:(id)a0 operationUUID:(id)a1 requestContext:(id)a2 saveObserver:(id)a3 error:(id *)a4;
- (BOOL)unregisterBuiltinStandaloneExtensionAtURL:(id)a0 operationUUID:(id)a1 requestContext:(id)a2 saveObserver:(id)a3 error:(id *)a4;
...
- (BOOL)urlContainsDeviceIdentifierForAdvertising:(id)a0;
