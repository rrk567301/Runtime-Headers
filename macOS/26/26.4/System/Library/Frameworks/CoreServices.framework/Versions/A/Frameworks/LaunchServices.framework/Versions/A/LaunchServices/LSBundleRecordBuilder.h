...
@interface LSBundleRecordBuilder : LSRecordBuilder {
    ...
    struct LSBundleMoreFlags { unsigned char isWebBrowser : 1; unsigned char isMailClient : 1; unsigned char supportsControllerUserInteraction : 1; unsigned char isWrapper : 1; unsigned char isWrapped : 1; unsigned char supportsSpotlightQueryContinuation : 1; unsigned char supportsSpotlightActions : 1; unsigned char requiresNativeExecution : 1; unsigned char architecturePriorityIsForged : 1; unsigned char isCodeSigningInfoNotAuthoritative : 1; unsigned char isPlaygroundsApp : 1; unsigned char supportsLiveActivities : 1; unsigned char supportsLiveActivitiesFrequentUpdates : 1; unsigned char hasShellRole : 1; unsigned char requiresSecureLaunch : 1; unsigned char isManagedAppDistributor : 1; unsigned char hasSupportsGameModeKey : 1; unsigned char supportsGameMode : 1; unsigned char isOnCryptex : 1; } _moreFlags;
    struct LSBundleBaseFlags { unsigned char appleInternal : 1; unsigned char requiresObjCGarbageCollection : 1; unsigned char builtWithTSan : 1; unsigned char isLinkEnabled : 1; unsigned char isSecuredSystemContent : 1; unsigned char redactable : 1; unsigned char _reserved : 1; } _baseFlags;
    ...
    BOOL _prefersSafeApertureSystemFullscreenCompat;
    BOOL _prefersSafeApertureSystemFullscreenCompatExplicit;
    BOOL _prefersSafeApertureAppFullscreenCompat;
    BOOL _prefersSafeApertureAppFullscreenCompatExplicit;
    BOOL _prefersSafeApertureWindowedCompat;
    BOOL _prefersSafeApertureWindowedCompatExplicit;
    BOOL _canChange_safeApertureWindowedCompat;
    BOOL _canBeSystemHidden;
    BOOL _defaultSystemHidden;
...
@property (readonly, nonatomic) NSString *minExecOSVersion;
...
@property (readonly, nonatomic) NSArray *alternateBundleIdentifiers;
...
@property (readonly, nonatomic) NSArray *trustedCDHashesForArchitectures;
...
- (struct LSBundleData { struct LSBundleBaseData { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; int x6; struct LSVersionNumber { unsigned char x0[32]; } x7; struct LSVersionNumber { unsigned char x0[32]; } x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; unsigned int x13; unsigned int x14; unsigned int x15; unsigned int x16; unsigned int x17; unsigned int x18; unsigned char x19; unsigned char x20; unsigned int x21; unsigned short x22; struct LSBundleBaseFlags { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; } x23; } x0; unsigned int x1; unsigned long long x2; unsigned int x3; unsigned int x4; unsigned char x5; unsigned char x6; unsigned char x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; unsigned char x14; struct LSBundleMoreFlags { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 1; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; unsigned char x14 : 1; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; } x15; unsigned int x16; unsigned int x17; unsigned long long x18; unsigned long long x19; int x20; unsigned int x21; struct LSVersionNumber { unsigned char x0[32]; } x22; struct LSVersionNumber { unsigned char x0[32]; } x23; unsigned int x24; int x25; struct LSVersionNumber { unsigned char x0[32]; } x26; unsigned long long x27; unsigned long long x28; unsigned int x29; unsigned int x30; unsigned int x31; unsigned int x32; unsigned int x33; unsigned int x34; unsigned int x35; unsigned int x36; unsigned int x37; unsigned int x38; unsigned long long x39; unsigned int x40; unsigned long long x41; unsigned long long x42; unsigned long long x43; unsigned int x44; unsigned long long x45; unsigned long long x46; unsigned int x47; unsigned int x48; unsigned int x49; unsigned long long x50; unsigned int x51; unsigned long long x52; unsigned int x53; unsigned int x54; unsigned long long x55; unsigned int x56; unsigned int x57; unsigned int x58; unsigned int x59; unsigned int x60; unsigned int x61; unsigned int x62; unsigned int x63; unsigned int x64; unsigned int x65; unsigned int x66; unsigned int x67; unsigned int x68; unsigned int x69; unsigned int x70; unsigned int x71; unsigned char x72; unsigned char x73; unsigned char x74; unsigned int x75; unsigned int x76[0]; unsigned int x77; unsigned int x78; int x79; unsigned int x80; unsigned int x81; unsigned int x82; unsigned int x83; unsigned int x84; unsigned int x85; })buildBundleData:(id)a0 error:(id *)a1;
- (id)iconsDictionaryFromDict:(id)a0;
- (void)parseActivityTypesFromDictionary:(id)a0;
- (void)parseArchitecturesFromDict:(id)a0;
- (void)parseCDHashesFromDictionary:(id)a0;
- (void)parseCapabilityFlagsFromDict:(id)a0;
- (void)parseDeviceFamilyFromDict:(id)a0;
- (void)parseDocumentClaimsFromDict:(id)a0;
- (void)parseIconFilenamesFromDict:(id)a0 forPlatform:(unsigned int)a1;
