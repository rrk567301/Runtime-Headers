@class NSString, NSArray, SKPaymentQueueClient, NSDictionary, NSError, SKStorefront, SKPaymentTransaction;
...
- (void)checkServerQueueForced:(BOOL)a0;
- (void)checkServerQueueForced:(BOOL)a0 completionHandler:(void (^)(NSArray *, NSError *))a1;
- (void)clearTransactions;
- (void)finishTransaction:(SKPaymentTransaction *)a0 completionHandler:(void (^)(void))a1;
...
- (void)restoreTransactionsWithApplicationUsername:(NSString *)a0 completionHandler:(void (^)(NSArray *, NSError *))a1;
