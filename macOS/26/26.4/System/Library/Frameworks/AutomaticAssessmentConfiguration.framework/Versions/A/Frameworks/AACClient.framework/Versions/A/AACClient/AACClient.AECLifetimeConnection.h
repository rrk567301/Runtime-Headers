@interface AACClient.AECLifetimeConnection : NSObject <NSXPCListenerDelegate, AELifecycleEventHandling> {
    ...
    void /* unknown type, empty encoding */ contentCaptureController;
...
- (void)handleEventWantsStartWindowContentCaptureWithCompletion:(id /* block */)a0;
- (void)handleEventWantsStopWindowContentCaptureWithCompletion:(id /* block */)a0;
