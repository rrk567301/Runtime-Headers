...
- (id)initWithRouteDescriptor:(struct __CFDictionary { } *)a0 routeDiscoverer:(struct OpaqueFigRouteDiscoverer { } *)a1 volumeController:(struct OpaqueFigVolumeControllerState { } *)a2 routingContextFactory:(id)a3 useRouteConfigUpdatedNotification:(BOOL)a4 routingContext:(struct OpaqueFigRoutingContext { } *)a5;
- (id)init;
