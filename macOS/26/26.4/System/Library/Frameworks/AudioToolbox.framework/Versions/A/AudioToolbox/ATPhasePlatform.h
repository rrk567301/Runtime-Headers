...
@interface ATPhasePlatform : NSObject <PHASEPlatform> {
    struct unique_ptr<Phase::ServerManager, std::default_delete<Phase::ServerManager>> { struct { struct ServerManager *__ptr_; } ; } _serverManager;
...
- (int)muteAudioSessionBidirectional:(unsigned int)a0 mute:(BOOL)a1 inputFadeTime:(float)a2 outputFadeTime:(float)a3;
