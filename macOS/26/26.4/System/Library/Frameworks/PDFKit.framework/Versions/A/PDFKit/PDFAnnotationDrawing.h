...
+ (void)drawCommonCommentNoteIconToContext:(struct CGContext { } *)a0 color:(id)a1 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
...
+ (void)drawWithBox:(long long)a0 inContext:(struct CGContext { } *)a1 withSignatureWidgetAnnotation:(id)a2;
...
+ (void)setupDrawColor:(id)a0 forContext:(struct CGContext { } *)a1;
