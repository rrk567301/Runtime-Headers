@class NSMutableDictionary, PDFAKPageAdaptor, NSObject, NSDictionary, PDFRenderingProperties, NSMutableArray, PDFDocument, NSString, PDFDetectedForm, NSAttributedString, NSMutableSet, NSArray, NSData, PDFView, NSLock;
...
@interface PDFPage : NSObject <NSCopying> {
    ...
    BOOL _textFromOCR;
    BOOL _didPerformOCR;
    char _candidateForFormDetection;
...
- (void)_handlePageRefChangeWithOldRotation:(long long)a0 oldMediaBox:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
...
- (id)accessibilityElementsWithPlugin:(id)a0;
- (id)accessibilityHitTest:(struct CGPoint { double x0; double x1; })a0 withPlugin:(id)a1;
...
- (id)selectionForTableRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
...
- (id)selectionFromPoint:(struct CGPoint { double x0; double x1; })a0 toPoint:(struct CGPoint { double x0; double x1; })a1 type:(int)a2 withClampedRange:(struct { long long x0; long long x1; })a3 withCellRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4;
...
- (id)tableSelectionFromPoint:(struct CGPoint { double x0; double x1; })a0 toPoint:(struct CGPoint { double x0; double x1; })a1;
