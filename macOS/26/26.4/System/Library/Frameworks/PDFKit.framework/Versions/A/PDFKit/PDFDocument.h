...
- (void)exchangeAccessibilityPageElementAtIndex:(unsigned long long)a0 withAccessibilityPageElementAtIndex:(unsigned long long)a1;
...
- (id)formFillingQueue;
- (id)getAKSignatureMenu;
- (BOOL)hasHighLatencyDataProvider;
- (void)incrementRedactionCount;
- (void)insertAKSignature:(id)a0 atBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (void)insertAccessibilityPageElementAtIndex:(unsigned long long)a0;
- (BOOL)isLinearized;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })normalizedBoundsForBox:(long long)a0 ofPageAtIndex:(unsigned long long)a1;
...
- (void)removeAccessibilityPageElementAtIndex:(unsigned long long)a0;
...
- (id)selectionFromPage:(id)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 toPage:(id)a2 atPoint:(struct CGPoint { double x0; double x1; })a3 type:(int)a4 withClampedRange:(struct { long long x0; long long x1; })a5 withCellRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6;
...
- (void)showAKSignatureCreationView;
- (BOOL)showsAnnotations;
- (id)textExtractionQueue;
- (id)textPositionFromPage:(id)a0 atCharacterIndex:(unsigned long long)a1 offset:(long long)a2;
- (void)updateBookmarksInPDFDocument;
- (void)updateUserNameFromAKControllerforAnnotation:(id)a0;
