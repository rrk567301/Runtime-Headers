...
- (struct OptionSet<WebCore::DragApplicationFlags, WTF::ConcurrencyTag::None> { unsigned char x0; })_applicationFlagsForDrag:(id)a0;
...
- (struct OptionSet<WebCore::DragDestinationAction, WTF::ConcurrencyTag::None> { unsigned char x0; })actionMaskForDraggingInfo:(id)a0;
...
- (void)setSmartListsEnabled:(BOOL)a0;
