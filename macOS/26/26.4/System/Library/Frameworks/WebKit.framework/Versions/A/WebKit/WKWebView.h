@class WKBrowsingContextHandle, NSMenu, WKWebViewConfiguration, _WKSessionState, WKScrollGeometry, NSString, NSVisualEffectView, _WKFrameHandle, STWebpageController, NSArray, NSScrollPocket, NSColor, _WKSpatialBackdropSource, _WKInspector, NSData, WKColorExtensionView, _WKThumbnailView, WTSession, NSView, WKScreenTimeConfigurationObserver, _WKWarningView, WKBackForwardList, CALayer, NSURL, NSMapTable, NSTouchBar, WKTextFinderClient;
@protocol _WKTextManipulationDelegate, WKHistoryDelegatePrivate, WKNavigationDelegate, WKIntelligenceTextEffectCoordinating, _WKIconLoadingDelegate, _WKDiagnosticLoggingDelegate, _WKFindDelegate, _WKAppHighlightDelegate, WKUIDelegate, _WKResourceLoadDelegate, _WKFullscreenDelegate, _WKInputDelegate, _WKImmersiveEnvironmentDelegate;
...
@interface WKWebView : NSView <WebViewImplDelegate, NSUserInterfaceValidations, NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSScrollViewSeparatorTrackingAdapter, WKShareSheetDelegate, WTWritingToolsDelegate, NSTextInputTraits> {
    ...
    struct unique_ptr<WebKit::NavigationState, std::default_delete<WebKit::NavigationState>> { struct { struct NavigationState *__ptr_; } ; } _navigationState;
    struct unique_ptr<WebKit::UIDelegate, std::default_delete<WebKit::UIDelegate>> { struct { struct UIDelegate *__ptr_; } ; } _uiDelegate;
    struct unique_ptr<WebKit::IconLoadingDelegate, std::default_delete<WebKit::IconLoadingDelegate>> { struct { struct IconLoadingDelegate *__ptr_; } ; } _iconLoadingDelegate;
    struct unique_ptr<WebKit::ResourceLoadDelegate, std::default_delete<WebKit::ResourceLoadDelegate>> { struct { struct ResourceLoadDelegate *__ptr_; } ; } _resourceLoadDelegate;
    ...
    struct OptionSet<WebKit::PreferSolidColorHardPocketReason, WTF::ConcurrencyTag::None> { unsigned char m_storage; } _preferSolidColorHardPocketReasons;
    ...
    struct unique_ptr<WebKit::WebViewImpl, std::default_delete<WebKit::WebViewImpl>> { struct { struct WebViewImpl *__ptr_; } ; } _impl;
    ...
    struct CornerRadii { struct FloatSize { float m_width; float m_height; } m_topLeft; struct FloatSize { float m_width; float m_height; } m_topRight; struct FloatSize { float m_width; float m_height; } m_bottomLeft; struct FloatSize { float m_width; float m_height; } m_bottomRight; } _lastViewCornerRadii;
...
@property (nonatomic, setter=_setStatusBarIsVisible:) BOOL _statusBarIsVisible;
@property (nonatomic, setter=_setMenuBarIsVisible:) BOOL _menuBarIsVisible;
@property (nonatomic, setter=_setToolbarsAreVisible:) BOOL _toolbarsAreVisible;
...
@property (weak, nonatomic, setter=_setImmersiveEnvironmentDelegate:) id<_WKImmersiveEnvironmentDelegate> _immersiveEnvironmentDelegate;
...
@property (readonly, nonatomic) BOOL _didCallEndSwipeGestureForTesting;
...
@property (nonatomic, setter=_setPrefersSolidColorHardScrollPocket:) BOOL _prefersSolidColorHardScrollPocket;
@property (readonly, nonatomic) BOOL _hasActiveVideoForControlsManager;
...
@property (readonly, nonatomic) struct RetainPtr<NSScrollPocket> { id x0; } _copyTopScrollPocket;
...
- (void)_requestJSHandleForNodeIdentifier:(id)a0 searchText:(id)a1 completionHandler:(id /* block */)a2;
...
- (struct RetainPtr<NSPopUpButtonCell> { id x0; })_activePopupButtonCell;
...
- (void)_addReasonToPreferSolidColorHardPocket:(unsigned char)a0;
...
- (id)_animationStackForLayerWithID:(unsigned long long)a0;
...
- (id)_caLayerTreeAsTextForLayer:(id)a0;
- (id)_caLayerTreeAsTextForLayerWithID:(unsigned long long)a0;
...
- (struct Interaction { unsigned char x0; struct String { struct RefPtr<WTF::StringImpl, WTF::RawPtrTraits<WTF::StringImpl>, WTF::DefaultRefDerefTraits<WTF::StringImpl>> { struct StringImpl *x0; } x0; } x1; struct optional<WebCore::FloatPoint> { union { char x0; struct FloatPoint { float x0; float x1; } x1; } x0; BOOL x1; } x2; struct optional<WTF::ObjectIdentifierGeneric<WebCore::NodeIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long>> { union { char x0; struct ObjectIdentifierGeneric<WebCore::NodeIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long> { unsigned long long x0; } x1; } x0; BOOL x1; } x3; struct FloatSize { float x0; float x1; } x4; BOOL x5; BOOL x6; })_convertToWebCoreInteraction:(id)a0;
...
- (void)_createWebArchiveForFrame:(id)a0 completionHandler:(id /* block */)a1;
- (void)_createWebArchiveForFrames:(id)a0 rootFrame:(id)a1 completionHandler:(id /* block */)a2;
- (void)_dataTaskWithRequest:(id)a0 completionHandler:(id /* block */)a1;
- (void)_debugTextWithConfiguration:(id)a0 completionHandler:(id /* block */)a1;
- (void)_decodeImageData:(id)a0 preferredSize:(id)a1 completionHandler:(id /* block */)a2;
- (void)_denyNextUserMediaRequest;
- (void)_describeInteraction:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_exitImmersive;
- (void)_exitInWindow;
- (void)_extractDebugTextWithConfiguration:(id)a0 completionHandler:(id /* block */)a1;
- (void)_extractDebugTextWithConfigurationWithoutUpdatingFilterRules:(id)a0 assertionScope:(void *)a1 completionHandler:(id /* block */)a2;
...
- (void)_getNodeForSelectorPathData:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_getRenderTreeAsStringWithCompletionHandler:(id /* block */)a0;
- (void)_getSelectorPathDataForNode:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_hideFindUI;
- (void)_hitTestAtPoint:(struct CGPoint { double x0; double x1; })a0 inFrameCoordinateSpace:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)_isEnhancedSecurityEnabled:(id /* block */)a0;
...
- (void)_loadAlternateHTMLString:(id)a0 baseURL:(id)a1 forUnreachableURL:(id)a2 withWebpagePreferences:(id)a3;
...
- (id)_pdfHUDs;
- (void)_performInteraction:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)_progressBasedTimelinesForScrollingNodeID:(unsigned long long)a0 processID:(unsigned long long)a1;
- (struct Vector<WTF::String, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct String *x0; unsigned int x1; unsigned int x2; })_promisedFileMIMETypes:(id)a0;
...
- (struct RetainPtr<WKTextFinderClient> { id x0; })_protectedTextFinderClient;
...
- (void)_removeReasonToPreferSolidColorHardPocket:(unsigned char)a0;
...
- (void)_requestTextExtraction:(id)a0 completionHandler:(id /* block */)a1;
- (void)_requestTextExtractionInternal:(id)a0 completion:(void *)a1;
...
- (void)_setSmartListsEnabled:(BOOL)a0;
...
- (void)_simulateDeviceMotionChangeWithXAcceleration:(double)a0 yAcceleration:(double)a1 zAcceleration:(double)a2 xAccelerationIncludingGravity:(double)a3 yAccelerationIncludingGravity:(double)a4 zAccelerationIncludingGravity:(double)a5 xRotationRate:(double)a6 yRotationRate:(double)a7 zRotationRate:(double)a8;
- (void)_simulateDeviceOrientationChangeWithAlpha:(double)a0 beta:(double)a1 gamma:(double)a2;
- (void)_simulateMouseEnter:(id)a0;
- (void)_simulateMouseExit:(id)a0;
...
- (void)_storePrivateClickMeasurementWithSourceID:(unsigned char)a0 destinationURL:(id)a1 reportEndpoint:(id)a2;
- (void)_storeSimulatedPrivateClickMeasurementConversionWithPriority:(unsigned char)a0 triggerData:(unsigned char)a1 sourceURL:(id)a2 destinationURL:(id)a3;
...
- (void)_takeSnapshotOfNode:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)_webContentProcessVariantForFrame:(id)a0;
...
- (id)registeredRemoteAccessibilityPids;
