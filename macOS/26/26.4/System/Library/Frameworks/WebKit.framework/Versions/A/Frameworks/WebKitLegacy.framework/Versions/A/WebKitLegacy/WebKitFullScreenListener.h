...
@interface WebKitFullScreenListener : NSObject <WebKitFullScreenListener> {
    ...
    struct CompletionHandler<void (WebCore::ExceptionOr<void>)> { struct Function<void (WebCore::ExceptionOr<void>)> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void, WebCore::ExceptionOr<void>>, std::default_delete<WTF::Detail::CallableWrapperBase<void, WebCore::ExceptionOr<void>>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _initialCompletionHandler;
    struct CompletionHandler<void (bool)> { struct Function<void (bool)> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _finalCompletionHandler;
}
