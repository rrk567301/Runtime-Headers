...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })computeTextBoundsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 backingObject:(const void *)a1;
...
- (id)parameterizedAttributeValueForTesting:(id)a0 parameter:(id)a1 backingObject:(const void *)a2;
