...
@interface WebHistoryPrivate : NSObject {
    ...
    struct unique_ptr<WTF::HashMap<long long, WTF::RetainPtr<NSMutableArray>>, std::default_delete<WTF::HashMap<long long, WTF::RetainPtr<NSMutableArray>>>> { struct { void *__ptr_; } ; } _entriesByDate;
