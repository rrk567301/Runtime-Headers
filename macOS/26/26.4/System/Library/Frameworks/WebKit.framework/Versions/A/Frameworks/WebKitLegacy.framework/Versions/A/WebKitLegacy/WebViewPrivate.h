...
@interface WebViewPrivate : NSObject {
    ...
    struct unique_ptr<TextIndicatorWindow, std::default_delete<TextIndicatorWindow>> { struct { struct TextIndicatorWindow *__ptr_; } ; } textIndicatorWindow;
    ...
    struct unique_ptr<WebViewRenderingUpdateScheduler, std::default_delete<WebViewRenderingUpdateScheduler>> { struct { struct WebViewRenderingUpdateScheduler *__ptr_; } ; } renderingUpdateScheduler;
    ...
    struct unique_ptr<WebSelectionServiceController, std::default_delete<WebSelectionServiceController>> { struct { struct WebSelectionServiceController *__ptr_; } ; } _selectionServiceController;
    BOOL interactiveFormValidationEnabled;
    int validationMessageTimerMagnification;
    float customDeviceScaleFactor;
    struct unique_ptr<WebCore::AlternativeTextUIController, std::default_delete<WebCore::AlternativeTextUIController>> { struct { struct AlternativeTextUIController *__ptr_; } ; } m_alternativeTextUIController;
    struct RetainPtr<NSData> { NSData *m_ptr; } sourceApplicationAuditData;
    BOOL _didPerformFirstNavigation;
    struct unique_ptr<WebMediaPlaybackTargetPicker, std::default_delete<WebMediaPlaybackTargetPicker>> { struct { struct WebMediaPlaybackTargetPicker *__ptr_; } ; } m_playbackTargetPicker;
