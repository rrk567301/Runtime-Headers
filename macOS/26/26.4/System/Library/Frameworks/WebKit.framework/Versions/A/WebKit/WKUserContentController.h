...
@interface WKUserContentController : NSObject <WKObject, NSSecureCoding> {
    struct AlignedStorage<WebKit::WebUserContentControllerProxy, 8UL> { struct Storage { unsigned char data[104]; } m_storage; } _userContentControllerProxy;
}
...
- (void)dealloc;
- (void)_addBuffer:(id)a0 contentWorld:(id)a1 name:(id)a2;
...
- (void)_removeBufferWithName:(id)a0 contentWorld:(id)a1;
