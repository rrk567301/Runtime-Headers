...
@interface WKWebsiteDataStore : NSObject <WKObject, NSSecureCoding> {
    struct AlignedStorage<WebKit::WebsiteDataStore, 8UL> { struct Storage { unsigned char data[576]; } m_storage; } _websiteDataStore;
    struct WeakObjCPtr<id<_WKWebsiteDataStoreDelegate>> { id m_weakReference; } _delegate;
    struct RetainPtr<NSArray> { NSArray *m_ptr; } _proxyConfigurations;
}
...
- (void)_isStorageSuspendedForTesting:(id /* block */)a0;
...
- (void)fetchDataOfTypes:(id)a0 completionHandler:(id /* block */)a1;
