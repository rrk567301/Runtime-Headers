...
@property (nonatomic, setter=_setUpdateSceneGeometryEnabled:) BOOL _updateSceneGeometryEnabled;
...
@property (nonatomic, setter=_setSiteIsolationEnabled:) BOOL _siteIsolationEnabled;
...
@property (nonatomic) BOOL isLookToScrollEnabled;
