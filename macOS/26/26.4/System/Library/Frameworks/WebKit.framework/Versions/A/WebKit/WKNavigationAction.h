...
@interface WKNavigationAction : NSObject <WKObject> {
    struct AlignedStorage<API::NavigationAction, 16UL> { struct Storage { unsigned char data[3472]; } m_storage; } _navigationAction;
}
...
@property (readonly, nonatomic) BOOL _isContentExtensionRedirect;
