...
@interface _WKInspectorExtension : NSObject <WKObject> {
    ...
    struct unique_ptr<WebKit::InspectorExtensionDelegate, std::default_delete<WebKit::InspectorExtensionDelegate>> { struct { struct InspectorExtensionDelegate *__ptr_; } ; } _delegate;
}
