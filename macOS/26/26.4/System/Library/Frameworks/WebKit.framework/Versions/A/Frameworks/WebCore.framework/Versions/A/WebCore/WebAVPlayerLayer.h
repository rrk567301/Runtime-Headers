...
@interface WebAVPlayerLayer : CALayer {
    ...
    struct unique_ptr<WebCore::WebAVPlayerLayerPresentationModelClient, std::default_delete<WebCore::WebAVPlayerLayerPresentationModelClient>> { struct { struct WebAVPlayerLayerPresentationModelClient *__ptr_; } ; } _presentationModelClient;
...
@property (readonly, nonatomic) BOOL showingCaptionPreview;
