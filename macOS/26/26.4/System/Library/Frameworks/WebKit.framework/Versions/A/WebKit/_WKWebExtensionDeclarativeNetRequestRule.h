...
- (id)_convertRulesWithModifiedCondition:(id)a0 webKitActionType:(id)a1 chromeActionType:(id)a2 includeIdentifier:(BOOL)a3;
...
- (id)_webKitRuleWithWebKitActionType:(id)a0 chromeActionType:(id)a1 condition:(id)a2 includeIdentifier:(BOOL)a3;
- (id)initWithDictionary:(id)a0 rulesetID:(id)a1 errorString:(id *)a2;
