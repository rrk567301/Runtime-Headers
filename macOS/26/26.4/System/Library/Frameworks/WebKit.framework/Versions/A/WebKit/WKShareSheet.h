@class NSString, NSURL, NSSharingServicePicker;
...
@interface WKShareSheet : NSObject <NSSharingServiceDelegate, NSSharingServicePickerDelegate> {
    ...
    struct CompletionHandler<void (bool)> { struct Function<void (bool)> { struct unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>> { struct { void *__ptr_; } ; } m_callableWrapper; } m_function; } _completionHandler;
    struct RetainPtr<NSSharingServicePicker> { NSSharingServicePicker *m_ptr; } _sharingServicePicker;
