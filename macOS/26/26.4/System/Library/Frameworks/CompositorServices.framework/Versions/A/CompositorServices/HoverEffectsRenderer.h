...
@interface HoverEffectsRenderer : NSObject {
    ...
    struct vector<HoverEffectArea, std::allocator<HoverEffectArea>> { struct HoverEffectArea *__begin_; struct HoverEffectArea *__end_; struct { struct HoverEffectArea *__cap_; } ; } _glow_animator;
