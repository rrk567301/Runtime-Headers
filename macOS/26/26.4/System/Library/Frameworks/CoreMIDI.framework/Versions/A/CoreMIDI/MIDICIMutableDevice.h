...
@interface MIDICIMutableDevice : MIDICIDevice {
    struct unique_ptr<MIDICI::SysexCollector, std::default_delete<MIDICI::SysexCollector>> { struct { struct SysexCollector *__ptr_; } ; } _sysexCollector;
    struct unique_ptr<caulk::concurrent::messenger, std::default_delete<caulk::concurrent::messenger>> { struct { struct messenger *__ptr_; } ; } _messenger;
