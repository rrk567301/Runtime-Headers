...
@interface MIDICIDevice : NSObject {
    ...
    struct vector<CIAsyncTransaction, std::allocator<CIAsyncTransaction>> { struct CIAsyncTransaction *__begin_; struct CIAsyncTransaction *__end_; struct { struct CIAsyncTransaction *__cap_; } ; } _activeTransactions;
