...
@interface PKStrokeMask : NSObject {
    struct vector<std::vector<ClipperLib::IntPoint>, std::allocator<std::vector<ClipperLib::IntPoint>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _maskPaths;
    struct vector<_PKFloatRange, std::allocator<_PKFloatRange>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _centerlineSlices;
}
