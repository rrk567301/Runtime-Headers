...
@interface PKInkBehavior : NSObject {
    ...
    struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *__ptr_; } ; } _weightFunction;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _radiusOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _radius2Output;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _thresholdOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _azimuthOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _opacityOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _edgeWidthOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _aspectRatioOutput;
    struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *__begin_; struct PKOutputFunction *__end_; struct { struct PKOutputFunction *__cap_; } ; } _brushOpacityOutput;
}
...
+ (struct PKOutputFunction { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *x0; } x0; } x5; })outputFunctionFromInkFunction:(id)a0;
...
- (id)initWithRenderingDescriptor:(id)a0 blendAlpha:(double)a1 targetMultiple:(double)a2 baseAlpha:(double)a3 inkTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4 useUnclampedWeight:(BOOL)a5 smoothingDescriptor:(id)a6 featheringDescriptor:(id)a7 pencilFeatheringDescriptor:(id)a8 animationDescriptor:(id)a9 identifier:(id)a10 version:(unsigned long long)a11 variant:(id)a12 uiWidths:(id)a13 defaultWidth:(double)a14 uiAzimuthControl:(BOOL)a15 showBrushIndicator:(BOOL)a16 supportsCombiningStrokes:(BOOL)a17 rulerOffsetScale:(double)a18 rulerOffsetConstant:(double)a19 weightFunction:(void *)a20 radiusOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a21 radius2Output:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a22 azimuthOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a23 thresholdOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a24 opacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a25 edgeWidthOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a26 aspectRatioOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a27 brushOpacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a28;
...
- (void)setAspectRatioOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setAzimuthOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setBrushOpacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setEdgeWidthOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setOpacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setRadius2Output:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setRadiusOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setThresholdOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })a0;
- (void)setWeightFunction:(struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *x0; } x0; })a0;
