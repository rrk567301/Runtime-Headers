...
- (void)flushDrawables;
- (void)initLayer;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 andPixelSize:(struct CGSize { double x0; double x1; })a1 pixelFormat:(unsigned long long)a2 wantsExtendedDynamicRangeContent:(BOOL)a3;
...
- (void)setupEDROnLayer:(id)a0 shouldToneMap:(BOOL)a1;
- (void)setupMetalLayer:(id)a0 shouldToneMap:(BOOL)a1;
