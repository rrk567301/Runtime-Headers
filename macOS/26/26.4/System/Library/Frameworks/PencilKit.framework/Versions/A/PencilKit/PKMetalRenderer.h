...
@interface PKMetalRenderer : NSObject {
    ...
    struct vector<PKMetalParticleStrokePoint, std::allocator<PKMetalParticleStrokePoint>> { struct PKMetalParticleStrokePoint *__begin_; struct PKMetalParticleStrokePoint *__end_; struct { struct PKMetalParticleStrokePoint *__cap_; } ; } _particleStrokePointBuffer;
    struct vector<PKMetalPaintStrokePoint, std::allocator<PKMetalPaintStrokePoint>> { struct PKMetalPaintStrokePoint *__begin_; struct PKMetalPaintStrokePoint *__end_; struct { struct PKMetalPaintStrokePoint *__cap_; } ; } _paintStrokePointBuffer;
    struct vector<PKMetalSDFPenStrokePoint, std::allocator<PKMetalSDFPenStrokePoint>> { struct PKMetalSDFPenStrokePoint *__begin_; struct PKMetalSDFPenStrokePoint *__end_; struct { struct PKMetalSDFPenStrokePoint *__cap_; } ; } _sdfPenStrokePointBuffer;
    struct vector<PKMetalLiveStrokePaintStrokePoint, std::allocator<PKMetalLiveStrokePaintStrokePoint>> { struct PKMetalLiveStrokePaintStrokePoint *__begin_; struct PKMetalLiveStrokePaintStrokePoint *__end_; struct { struct PKMetalLiveStrokePaintStrokePoint *__cap_; } ; } _liveStrokeStrokePointBuffer;
    ...
    struct vector<(anonymous namespace)::AnimatingStroke, std::allocator<(anonymous namespace)::AnimatingStroke>> { struct AnimatingStroke *__begin_; struct AnimatingStroke *__end_; struct { struct AnimatingStroke *__cap_; } ; } _animatingStrokes;
    ...
    struct vector<_PKStrokePoint, std::allocator<_PKStrokePoint>> { struct _PKStrokePoint *__begin_; struct _PKStrokePoint *__end_; struct { struct _PKStrokePoint *__cap_; } ; } previewStrokePoints;
...
@property (nonatomic) BOOL allowBrushIndicator;
