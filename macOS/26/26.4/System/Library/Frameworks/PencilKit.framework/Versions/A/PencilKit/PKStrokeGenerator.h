...
@interface PKStrokeGenerator : NSObject <PKInputProvider> {
    ...
    struct vector<PKInputPoint, std::allocator<PKInputPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _drawPoints;
    struct vector<_PKStrokePoint, std::allocator<_PKStrokePoint>> { struct _PKStrokePoint *__begin_; struct _PKStrokePoint *__end_; struct { struct _PKStrokePoint *__cap_; } ; } _outputPoints;
    ...
    struct vector<PKInputPoint, std::allocator<PKInputPoint>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _updatedDrawPoints;
...
+ (void)initialize;
+ (struct vector<PKInputPoint, std::allocator<PKInputPoint>> { struct *x0; struct *x1; struct { struct *x0; } x2; })inputPointsFromPath:(struct CGPath { } *)a0 maxSegmentLength:(double)a1 velocityForDistanceFunction:(id /* block */)a2;
+ (struct vector<PKInputPoint, std::allocator<PKInputPoint>> { struct *x0; struct *x1; struct { struct *x0; } x2; })inputPointsFromPoints:(const void *)a0 velocityForDistanceFunction:(id /* block */)a1;

- (void)addPoints:(struct vector<PKInputPoint, std::allocator<PKInputPoint>> { struct *x0; struct *x1; struct { struct *x0; } x2; })a0;
- (void).cxx_destruct;
