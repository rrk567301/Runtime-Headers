...
+ (struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *x0; } x0; })loadFunction:(id)a0;
+ (struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction *x0; struct PKOutputFunction *x1; struct { struct PKOutputFunction *x0; } x2; })loadOutput:(id)a0;
