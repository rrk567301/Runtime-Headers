...
@property (readonly) BOOL _explicitlySetAllowsUCA;
@property BOOL _explicitlySetATSContext;
...
@property BOOL _enablesEarlyData;
@property BOOL _backgroundSessionForPrivilegedDaemon;
