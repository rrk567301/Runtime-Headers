@class SFSpeechLanguageModelConfiguration, NSString, NSArray, NSURL, NSDictionary, SFPersonalNamedEntityRetrievalOptions;
...
- (id)initWithFarField:(BOOL)a0 geoLMRegionID:(id)a1 supplementalModelURL:(id)a2 modelOverrideURL:(id)a3 speechProfileURLs:(id)a4 userIdMask:(id)a5 taskForMemoryLock:(id)a6 atypicalSpeech:(BOOL)a7 enableParallelLoading:(BOOL)a8 disableEagerLimit:(BOOL)a9 speechProfileContainers:(id)a10 enableFullPayloadCorrection:(BOOL)a11 customLm:(id)a12 personalNamedEntityRetrievalOptions:(id)a13;
