...
- (void)assetStateForConfig:(id)a0 clientID:(id)a1 completion:(id /* block */)a2;
...
- (void)downloadAssetsForConfig:(id)a0 clientID:(id)a1 expiration:(id)a2 detailedProgress:(id /* block */)a3 completionHandler:(id /* block */)a4;
- (void)downloadAssetsForConfig:(id)a0 clientID:(id)a1 expiration:(id)a2 progress:(id /* block */)a3 completionHandler:(id /* block */)a4;
...
- (void)pathToAssetWithConfig:(id)a0 clientID:(id)a1 asyncCompletion:(id /* block */)a2;
...
- (void)subscribeToAssetsWithConfigs:(id)a0 clientID:(id)a1 expiration:(id)a2 asyncCompletion:(id /* block */)a3;
- (void)subscriptionsForClientId:(id)a0 completion:(id /* block */)a1;
- (oneway void)supportedLanguagesForAssetType:(unsigned long long)a0 synchronous:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)synchronousEuclidConfigPathForLanguageStr:(id)a0 completion:(id /* block */)a1;
- (void)synchronousEuclidNearestNeighborsForSource:(id)a0 numberOfNeighbors:(id)a1 completion:(id /* block */)a2;
...
- (void)unsubscribeFromAssetWithConfig:(id)a0 clientID:(id)a1 asyncCompletion:(id /* block */)a2;
- (void)unsubscribeFromAssetWithConfig:(id)a0 clientID:(id)a1 completion:(id /* block */)a2;
- (void)unsubscribeFromAssetsWithConfigs:(id)a0 clientID:(id)a1 asyncCompletion:(id /* block */)a2;
- (void)versionOfAssetWithConfig:(id)a0 clientID:(id)a1 completion:(id /* block */)a2;
