...
+ (void)_setPurgeabilityForAssetWithConfig:(id)a0 purgeable:(BOOL)a1 completionHandler:(id /* block */)a2;
+ (id)statusForAsset:(id)a0;
+ (id)supportedLanguagesForAssetType:(unsigned long long)a0;
+ (id)_assetSetSubscriptionWithConfig:(id)a0 expiration:(id)a1;
...
+ (void)_handleSubscriptionChangeForSubscriber:(id)a0 assetConfigs:(id)a1;
+ (id)_overridePathForConfig:(id)a0;
+ (id)_overrideStatusForConfig:(id)a0;
+ (void)_postSystemSubscriptionsChangedNotification;
+ (void)_subscribeToAssetsWithConfigs:(id)a0 subscriberId:(id)a1 expiration:(id)a2 completionHandler:(id /* block */)a3;
+ (id)_subscriptionNamesForConfig:(id)a0 error:(id *)a1;
+ (id)_subscriptionNamesForConfigs:(id)a0 errorForConfig:(id)a1;
+ (id)_subscriptionsForConfig:(id)a0 expiration:(id)a1 error:(id *)a2;
+ (id)_subscriptionsForConfigs:(id)a0 expiration:(id)a1 errorForConfig:(id)a2;
+ (void)_unsubscribeFromAssetsWithConfigs:(id)a0 subscriberId:(id)a1 completionHandler:(id /* block */)a2;
...
+ (id)assetSetUsageForConfig:(id)a0;
+ (id)assetSetUsageForConfig:(id)a0 regionId:(id)a1;
+ (id)assetSetUsagesForAssetType:(unsigned long long)a0;
+ (unsigned long long)assetStateForDownloadStatus:(unsigned long long)a0;
...
+ (BOOL)isSubscribedToAssetWithConfig:(id)a0 subscriberId:(id)a1;
...
+ (id)stringForAssetState:(unsigned long long)a0;
...
+ (void)subscribeToAssetWithConfig:(id)a0 subscriberId:(id)a1 expiration:(id)a2 completionHandler:(id /* block */)a3;
+ (BOOL)subscribeToAssetWithConfig:(id)a0 subscriberId:(id)a1 expiration:(id)a2 error:(id *)a3;
+ (void)subscribeToAssetsWithConfigs:(id)a0 subscriberId:(id)a1 expiration:(id)a2 completionHandler:(id /* block */)a3;
+ (BOOL)subscribeToAssetsWithConfigs:(id)a0 subscriberId:(id)a1 expiration:(id)a2 errorForAssetConfig:(id *)a3;
+ (id)subscriberIdForDictationAssets;
+ (id)subscriptionNameForConfig:(id)a0;
...
+ (void)unsubscribeFromAssetWithConfig:(id)a0 regionId:(id)a1 subscriberId:(id)a2 completionHandler:(id /* block */)a3;
+ (void)unsubscribeFromAssetWithConfig:(id)a0 subscriberId:(id)a1 completionHandler:(id /* block */)a2;
+ (BOOL)unsubscribeFromAssetWithConfig:(id)a0 subscriberId:(id)a1 error:(id *)a2;
+ (id)unsubscribeFromAssetsWithAssetType:(unsigned long long)a0 exceptLanguages:(id)a1 subscriberId:(id)a2;
+ (void)unsubscribeFromAssetsWithConfigs:(id)a0 subscriberId:(id)a1 completionHandler:(id /* block */)a2;
+ (BOOL)unsubscribeFromAssetsWithConfigs:(id)a0 subscriberId:(id)a1 errorForAssetConfig:(id *)a2;
...
- (id)_assetForConfig:(id)a0;
- (id)_assetSetWithName:(id)a0 usage:(id)a1;
- (id)_assetSetsWithAssetType:(unsigned long long)a0;
- (void)_assetStateForConfig:(id)a0 subscriberId:(id)a1 completionHandler:(id /* block */)a2;
- (id)_assetsWithAssetType:(unsigned long long)a0;
- (void)_cleanupTimerFired;
- (void)_downloadStatusForAssetWithConfig:(id)a0 subscriberId:(id)a1 progressHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (id)_installationStatusForLanguagesWithAssetType:(unsigned long long)a0 includeDetailedStatus:(BOOL)a1 subscriberId:(id)a2;
- (id)_installedAssetWithConfig:(id)a0 shouldSubscribe:(BOOL)a1 subscriberId:(id)a2 expiration:(id)a3;
- (void)_refreshAssetSetsWithName:(id)a0;
- (void)_scheduleCleanupTimer;
- (id)assetSetDict;
- (void)assetStateForConfig:(id)a0 subscriberId:(id)a1 completionHandler:(id /* block */)a2;
- (id)assetStatusForConfig:(id)a0;
- (id)assetVersionForConfig:(id)a0;
- (id)detailedInstallationStatusForLanguagesWithAssetType:(unsigned long long)a0 subscriberId:(id)a1;
- (void)downloadStatusForAssetWithConfig:(id)a0 subscriberId:(id)a1 progressHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
...
- (id)installedAssetWithConfig:(id)a0 shouldSubscribe:(BOOL)a1 subscriberId:(id)a2 expiration:(id)a3;
- (id)installedAudioSamplingConfigWithAssetName:(id)a0;
- (id)modelQualityTypeStatusStringWithConfig:(id)a0;
- (void)refreshAssetSetWithConfig:(id)a0;
