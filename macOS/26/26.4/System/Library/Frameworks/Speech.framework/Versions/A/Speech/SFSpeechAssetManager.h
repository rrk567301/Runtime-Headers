...
+ (void)assetStateForConfig:(id)a0 clientIdentifier:(id)a1 completion:(id /* block */)a2;
...
+ (void)fetchAssetWithConfig:(id)a0 clientIdentifier:(id)a1 expiration:(id)a2 detailedProgress:(id /* block */)a3 completion:(id /* block */)a4;
+ (void)fetchAssetWithConfig:(id)a0 clientIdentifier:(id)a1 expiration:(id)a2 detailedProgress:(id /* block */)a3 completion:(id /* block */)a4 timeout:(double)a5;
+ (void)fetchAssetWithConfig:(id)a0 clientIdentifier:(id)a1 expiration:(id)a2 progress:(id /* block */)a3 completion:(id /* block */)a4;
+ (void)fetchAssetWithConfig:(id)a0 clientIdentifier:(id)a1 expiration:(id)a2 progress:(id /* block */)a3 completion:(id /* block */)a4 timeout:(double)a5;
...
+ (void)subscribeToAssetsWithConfigs:(id)a0 clientIdentifier:(id)a1 expiration:(id)a2 completionHandler:(id /* block */)a3;
...
+ (void)unsubscribeFromAssetsWithConfigs:(id)a0 clientIdentifier:(id)a1 completionHandler:(id /* block */)a2;
+ (id)versionOfAssetWithConfig:(id)a0 clientIdentifier:(id)a1;
