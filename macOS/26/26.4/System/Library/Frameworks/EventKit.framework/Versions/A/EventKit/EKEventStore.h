...
@protocol EKAuthStatusChecker, EKEmailSender, CalBlockList, OS_dispatch_queue;
...
@property (class, readonly, nonatomic) BOOL shouldUseInProcessXPCByDefault;
...
+ (long long)realAuthorizationStatusForEntityType:(unsigned long long)a0 preferredConnection:(id)a1;
+ (unsigned long long)ekEventStoreInitOptionsFromCalDatabaseInitOptions:(unsigned long long)a0;
+ (void)_openURL:(id)a0;
...
+ (unsigned long long)calDatabaseInitOptionsFromEKEventStoreInitOptions:(unsigned long long)a0;
+ (id)_iMIPScheduledEvent:(id)a0;
+ (BOOL)_shouldRefreshSource:(id)a0;
+ (BOOL)_parseiCloudReplyURL:(id)a0 reply:(unsigned long long *)a1 uid:(id *)a2;
...
+ (BOOL)_shouldUseInProcessXPCWithInitOptions:(unsigned long long)a0;
...
- (id)_checkPendingIntegrationEvents:(id)a0 changedIDsValid:(BOOL)a1;
...
- (BOOL)batchedEventsMatchingPredicate:(id)a0 batchSize:(int)a1 error:(id *)a2 handler:(id /* block */)a3;
...
- (int)countOfEventsCalendarFromStartDate:(id)a0 toEndDate:(id)a1 ByCalendars:(id)a2;
- (int)countOfEventsFromStartDate:(id)a0 toEndDate:(id)a1;
- (unsigned long long)countOfEventsInSource:(id)a0;
...
- (id)eventForiCloudReplyURL:(id)a0 reply:(unsigned long long *)a1;
...
- (id)eventWithRecurrenceIdentifier:(id)a0 isAppEntityID:(BOOL)a1;
...
- (id)initWithEKOptions:(unsigned long long)a0 path:(id)a1 containerProvider:(id)a2 changeTrackingClientId:(id)a3 enablePropertyModificationLogging:(BOOL)a4 allowDelegateSources:(BOOL)a5 allowedSourceIdentifiers:(id)a6;
- (id)initWithEKOptions:(unsigned long long)a0 path:(id)a1 containerProvider:(id)a2 tccPermissionChecker:(id)a3 changeTrackingClientId:(id)a4 enablePropertyModificationLogging:(BOOL)a5 allowDelegateSources:(BOOL)a6 allowedSourceIdentifiers:(id)a7;
- (id)initWithOptions:(unsigned long long)a0 path:(id)a1;
- (id)initWithOptions:(unsigned long long)a0 path:(id)a1 allowDelegateSources:(BOOL)a2;
- (id)initWithOptions:(unsigned long long)a0 path:(id)a1 changeTrackingClientId:(id)a2 enablePropertyModificationLogging:(BOOL)a3 allowDelegateSources:(BOOL)a4;
...
- (BOOL)saveColor:(id)a0 commit:(BOOL)a1 error:(id *)a2;
...
- (double)sumOfDurationCalendarFromStartDate:(id)a0 toEndDate:(id)a1 ByCalendars:(id)a2;
- (int)syncErrorCount;
...
- (void)waitUntilDatabaseUpdatedToTimestamp:(id)a0 completion:(id /* block */)a1;
