@class NSURL, EKImage, NSDate, NSDictionary, EKSuggestedEventInfo, EKVirtualConference, EKCalendarDate, EKParticipant, EKEventStore, NSMutableArray, NSString, EKColor, NSSet, EKRecurrenceIdentifier, NSArray, NSNumber, EKStructuredLocation, NSDateComponents;
...
- (BOOL)locationPredictionAllowed;
