@class NSURL, LNValue, LNExportedContentConfiguration, NSNumber, NSDictionary, LNAsyncSequenceReference, _NSAuxiliaryUndoManagerReference, NSProgress, LNAsyncIteratorReference, LNConfigurableQueryRequest, LNValueType, LNStageContextRequest, NSString, LNAction, LNQueryOutput, NSArray, LNXPCListenerEndpointContainer, NSXPCConnection, NSError, NSUUID;
...
- (void).cxx_destruct;
- (id)init;
- (void)fetchAppShortcutParametersForMangledName:(NSString *)a0 withCompletionHandler:(void (^)(NSArray *, NSError *))a1;
...
- (void)exportTransientEntities:(NSArray *)a0 withConfiguration:(LNExportedContentConfiguration *)a1 auditToken:(struct { unsigned int x0[8]; })a2 connectionIdentifier:(NSNumber *)a3 completionHandler:(void (^)(LNValue *, NSError *))a4;
...
- (void)linkUndoManager:(_NSAuxiliaryUndoManagerReference *)a0 completionHandler:(void (^)(NSError *))a1;
...
- (void)resolveParameterWithIdentifier:(NSString *)a0 action:(LNAction *)a1 auditToken:(struct { unsigned int x0[8]; })a2 connectionIdentifier:(NSNumber *)a3 completionHandler:(void (^)(LNValue *, NSError *))a4;
- (void)resolveValue:(LNValue *)a0 toValueType:(LNValueType *)a1 auditToken:(struct { unsigned int x0[8]; })a2 connectionIdentifier:(NSNumber *)a3 completionHandler:(void (^)(LNValue *, NSError *))a4;
- (void)stageContextWithRequest:(LNStageContextRequest *)a0 completionHandler:(void (^)(NSArray *, NSError *))a1;
