...
- (void).cxx_destruct;
- (void)dealloc;
- (void)fetchAppShortcutParametersForMangledName:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)fetchURLForEnumWithIdentifier:(id)a0 caseIdentifier:(id)a1 completionHandler:(id /* block */)a2;
- (void)cancelOperationWithIdentifier:(id)a0 reason:(long long)a1;
...
- (void)linkAppUndoManager:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)resolveParameterWithIdentifier:(id)a0 action:(id)a1 completionHandler:(id /* block */)a2;
- (void)resolveValue:(id)a0 toValueType:(id)a1 completionHandler:(id /* block */)a2;
