@class NSString, NSURL, NSOrderedSet, NSSet, NSDictionary, UTTypeRecord, NSNumber;
...
+ (id)_typeWithTypeRecord:(id)a0 detachTypeRecord:(BOOL)a1 findConstant:(BOOL)a2 installInConstant:(BOOL)a3;
...
- (void)_setDefaultHandlerToApplicationRecord:(id)a0 completionHandler:(id /* block */)a1;
- (void)_unrealize;
