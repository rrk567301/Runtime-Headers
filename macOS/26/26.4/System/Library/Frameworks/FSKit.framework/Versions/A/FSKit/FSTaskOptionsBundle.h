...
- (id)initWithOptionString:(char **)a0 count:(int)a1 optionDictionary:(id)a2 operationType:(unsigned char)a3 errorHandler:(id /* block */)a4;
- (int)mapStringToKind:(id)a0;
- (id)parseAndValidateActivateOptions:(id)a0 activationSyntax:(id)a1;
