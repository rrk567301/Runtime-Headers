@class NSString, NSSet, NSXPCInterface;

@interface FSKitConstants : NSObject

@property (class, readonly, retain) NSString *fskitdMachServiceName;
@property (class, readonly, retain) NSString *fskitdLiveFSMachServiceName;
