@class NSPanel, NSView, NSArray, NSString, NSTextField, NSDictionary, NSPopUpButton, NSViewController, NSTextView, NSButton, NSTableView;
...
- (id)_alternateSpellCheckerMenuItemsArray;
...
- (void)_showInlinePredictionForReplacingRangeRecursively:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 markedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 string:(id)a2 withString:(id)a3 view:(id)a4 client:(id)a5 lastReplacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a6 completeWordIndexes:(id)a7 resultDictionary:(id)a8 completionHandler:(id /* block */)a9;
- (void)_showInlinePredictionRecursivelyWithContext:(id)a0 currentRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 markedRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 replacementRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
...
- (void)removeCorrectionPanelWithCorrectionTag:(long long)a0 forView:(id)a1;
