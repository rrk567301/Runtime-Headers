...
@property (class, readonly) BOOL _lazyDefaultImagesEnabled;
...
@property (readonly) id remoteAccessibilityParent;
@property (readonly, weak) NSMenu *accessibilitySubmenu;
@property (readonly, weak) id remoteAccessibilityView;
@property (readonly) BOOL _isAppleMenuItem;
@property (readonly) struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } _accessibilityFrame;
...
+ (id)_standardMenuItemImageWithName:(id)a0 hierarchical:(BOOL)a1;
+ (id)_standardMenuItemImageWithName:(id)a0 isKitImage:(BOOL)a1 hierarchical:(BOOL)a2;
+ (id)_standardMenuItemMinimizedStateImage;
+ (id)_standardMenuItemMixedStateImage;
+ (id)_standardMenuItemOnStateImage;
+ (id)_systemImageNameForAction:(SEL)a0;
+ (id)_systemImageNameForAction:(SEL)a0 tag:(long long)a1;
+ (id)_systemImageNameForAction:(SEL)a0 tag:(long long)a1 isHierarchical:(BOOL *)a2 isKitImage:(BOOL *)a3;
...
+ (id)_writingToolsItemWithTitle:(id)a0 imageName:(id)a1 tool:(long long)a2;
+ (id)_writingToolsMenuItemsWithStyle:(unsigned long long)a0;
+ (id)currentAppLanguage;
+ (void)examineDefaultImagesForSPI:(id)a0;
...
- (void)_internalPerformActionThroughMenuIfPossible:(unsigned long long)a0;
...
- (void)_setActionImage:(id)a0;
- (void)_setActionImageByName:(id)a0 hierarchical:(BOOL)a1;
- (void)_setActionImageName:(id)a0;
...
- (void)_setHasActionImage:(BOOL)a0;
...
- (void)_setImage:(id)a0 name:(id)a1 imageType:(unsigned long long)a2 resettingSize:(BOOL)a3;
...
- (void)_updateActionImageFromSubmenu;
...
- (void)setInterfaceBuilderSecondaryImage:(id)a0;
