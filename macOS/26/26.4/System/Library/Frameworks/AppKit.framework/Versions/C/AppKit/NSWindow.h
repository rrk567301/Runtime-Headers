...
+ (void)_getResizeEdgeAndCornerThicknesses:(double[8])a0 forStyleMask:(unsigned long long)a1 cornerRadius:(double)a2;
...
+ (BOOL)automaticallyNotifiesObserversOf_hasBottomAccessoryViewControllerNeedingBackground;
...
- (void)_addBackgroundSubview:(id)a0;
...
- (long long)_mouseLocationIsInCoarseResizeRects:(struct CGPoint { double x0; double x1; })a0;
- (BOOL)_mouseLocationIsInsideRoundRectBorder:(struct CGPoint { double x0; double x1; })a0;
...
- (void)_setResizeDebugWindow:(id)a0;
...
- (void)_toggleDebugResizeOverlay;
...
- (void)_updateRoundRectEventPaths;
- (BOOL)_updateRoundedCornersUnifiedTrackingArea;
...
- (BOOL)_wantsRoundedCornerResize;
...
- (void)setOverlaidInspector:(id)a0;
- (void)setOverlaidSidebar:(id)a0;
