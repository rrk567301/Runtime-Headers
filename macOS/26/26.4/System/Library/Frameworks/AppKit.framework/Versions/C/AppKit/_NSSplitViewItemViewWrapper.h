@class NSView, NSString, _NSSplitViewItemAccessoryViewWrapper, NSBlurryAlleywayView, NSLayoutGuide, NSVisualEffectView, NSGlassEffectView, NSLayoutConstraint, NSSplitViewItem;
...
- (double)_glassMinimumCornerRadius;
