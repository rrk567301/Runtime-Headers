...
- (void)_scaleFactorWillChange:(id)a0;
...
- (void)_valueForTIProperty:(long long)a0 completionHandler:(id /* block */)a1;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })convertRectFromUIKitToAppKit:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 clientDisplayZoom:(struct CGSize { double x0; double x1; })a1;
