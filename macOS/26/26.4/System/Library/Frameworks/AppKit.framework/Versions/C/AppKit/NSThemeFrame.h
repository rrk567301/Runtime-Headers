@class NSView, NSString, NSTrackingArea, NSTitlebarView, NSVisualEffectView, NSSheetEffectDimmingView, NSObject, NSButton, NSMapTable, NSTitlebarContainerView;
...
@interface NSThemeFrame : NSTitledFrame <NSViewLayerContentScaleDelegate> {
    ...
    BOOL _cachedHasSolariumAppearance;
...
@property (readonly) BOOL _hasBottomAccessoryViewControllerNeedingBackground;
...
+ (double)_contentToFrameMaxYHeight:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
...
+ (double)_maxXTitlebarWidgetInset:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
+ (double)_maxXWindowBorderWidth:(unsigned long long)a0;
+ (double)_minXTitlebarWidgetInset:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
...
+ (double)_titlebarHeight:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
...
+ (double)_windowTitlebarButtonSpacingWidth:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
+ (double)_windowTitlebarTitleMinHeight:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
+ (BOOL)automaticallyNotifiesObserversOfTitlebarBlendingMode;
+ (BOOL)automaticallyNotifiesObserversOf_backdropView;
+ (BOOL)automaticallyNotifiesObserversOf_containerView;
+ (id)containingThemeFrameFromView:(id)a0;
+ (double)minFrameWidthWithTitle:(id)a0 styleMask:(unsigned long long)a1 hasSolariumAppearance:(BOOL)a2;
+ (struct CGSize { double x0; double x1; })sizeOfTitlebarButtons:(unsigned long long)a0 hasSolariumAppearance:(BOOL)a1;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_defaultCenteredTitlebarTitleRect;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_defaultLeadingAlignedTitlebarTitleRect;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_defaultTitlebarTitleRect;
- (void)_didAddUnknownSubview:(id)a0;
...
- (unsigned long long)_effectiveStyleMask;
...
- (struct CGPath { } *)_getCachedWindowCornerPath;
...
- (BOOL)_hasAnyVisibleTitlebarButtons;
...
- (BOOL)_hasVisibleBottomAccessoryViewController;
- (BOOL)_hasVisibleLeadingAccessoryViewController;
...
- (BOOL)_inspectorSitsBelowAccessories;
- (BOOL)_inspectorSitsBelowTitlebar;
- (BOOL)_inspectorSitsBelowToolbar;
...
- (void)_setContentContainerView:(id)a0;
...
- (struct CGPoint { double x0; double x1; })_sharingIndicatorAlignmentOriginFromSize:(struct CGSize { double x0; double x1; })a0;
...
- (BOOL)_sidebarSitsBelowAccessories;
- (BOOL)_sidebarSitsBelowTitlebar;
...
- (BOOL)_splitsFollowToolbarHiddenInFullscreen;
...
- (BOOL)_trafficLightsAreInlineWithToolbar;
...
- (BOOL)computed_hasBottomAccessoryViewControllerNeedingBackground;
- (double)contentAlpha;
