...
@interface NSScrollPocket : NSView {
    ...
    void /* unknown type, empty encoding */ glassEffectDiffusionDidChangeObserver;
    void /* unknown type, empty encoding */ _resetLumaTimer;
    ...
    void /* unknown type, empty encoding */ scrollVelocityResetTimer;
