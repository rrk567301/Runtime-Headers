@class NSLayoutXAxisAnchor, NSPressureConfiguration, NSColor, NSLayoutGuide, NSDictionary, NSMutableSet, NSMutableArray, NSWritingToolsCoordinator, NSCoordinateSpace, CIFilter, CALayer, _NSViewLayoutAux, NSCandidateListTouchBarItem, _NSViewAnimator, NSViewFocusProxy, NSLayoutYAxisAnchor, NSScrollView, NSURL, NSTextInputContext, NSViewCornerConfiguration, _NSTrackingAreaViewHelper, NSBezierPath, NSLayoutPoint, NSSurface, NSArray, NSLayoutRect, NSMenu, NSPointerArray, NSAppearance, NSColorSpace, NSString, NSObject, NSFocusController, _NSGlassEffectViewMaterialContext, NSMenuItem, _NSBindingAdaptor, NSViewController, _TtC6AppKit30_NSViewMaterialBackdropContext, NSViewCornerRadii, NSLayoutDimension, NSShadow, NSPSMatrix, NSFunctionRow, NSWindow;
@protocol NSAppearanceCustomization, _NSDisplayLinkInfoProvider, NSContentStyle, NSObject, NSViewRoot;

@interface NSView : NSResponder <NSAppearanceCustomizationInternal, NSISVariableDelegate, NSLayoutItem, NSISEngineDelegate, NSAKLayoutItem, NSLayoutSpacingItem, _NSDisplayLinkInfoProvider, _NSDisplayLinkCreatingWithOptions, CALayerDelegate, NSAnimatablePropertyContainer, NSUserInterfaceItemIdentification, NSDraggingDestination, NSAppearanceCustomization, NSAccessibilityElement, NSAccessibility> {
    ...
    unsigned char _isObservingEffectiveCornerConfiguration : 1;
...
@property (class, readonly) Class _focusProxyClass;
@property (class, readonly) BOOL _displayLinkInfoRequiresMainThread;
@property (class, readonly) long long _defaultControlMetricsBehavior;
...
@property (nonatomic, readonly) NSCoordinateSpace *_coordinateSpace;
@property (nonatomic, retain) _TtC6AppKit30_NSViewMaterialBackdropContext *_materialBackdropContext;
@property (nonatomic, retain) _TtC6AppKit30_NSViewMaterialBackdropContext *_effectiveMaterialBackdropContext;
@property (nonatomic, readonly) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } _scrollPocketMaskInsets;
@property (nonatomic, readonly) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } _scrollPocketLumaInsets;
...
@property (nonatomic, readonly) BOOL _isTitlebarAssociatedScrollPocketElementContainer;
@property (nonatomic, retain) NSPointerArray *_scrollPocketDescendantContributors;
@property (nonatomic) double _effectiveAlphaValue;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } _horizontalSafeAreaRect;
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } _verticalSafeAreaRect;
@property (readonly) BOOL _parentNeedsMouseDown;
@property (readonly) BOOL _managesOpenGLDrawable;
@property (setter=_setDrawnByCacheDisplayStatus:) long long _drawnByCacheDisplayStatus;
@property (readonly) BOOL _isBeingDrawnForCacheDisplay;
@property (retain) NSObject *_environmentWrapper;
@property (readonly) NSObject *_resolvedEnvironmentWrapper;
...
@property (copy) _NSGlassEffectViewMaterialContext *_glassMaterialContext;
@property (readonly, copy) _NSGlassEffectViewMaterialContext *_effectiveGlassMaterialContext;
@property (nonatomic, setter=_setFirstItemInGlassGroup:) BOOL _isFirstItemInGlassGroup;
@property (nonatomic, setter=_setLastItemInGlassGroup:) BOOL _isLastItemInGlassGroup;
@property (nonatomic, setter=_setInGlassSidebar:) BOOL _inGlassSidebar;
@property (readonly) NSViewFocusProxy *_focusProxy;
@property (readonly) BOOL _useFocusEngine;
@property (readonly) BOOL _canBecomeFocused;
@property (readonly) BOOL _isTransparentFocusItem;
@property (readonly, getter=_isFocusGuide) BOOL _focusGuide;
@property (copy) NSString *_focusGroupIdentifier;
@property (readonly) NSString *_effectiveFocusGroupIdentifier;
@property long long _focusGroupPriority;
@property (setter=_setIgnoreFocusEngine:) BOOL _ignoreFocusEngine;
@property (readonly) NSFocusController *_focusController;
@property (readonly) NSView *_replacementViewForFocus;
@property (readonly, getter=_isLayoutContainer) BOOL _layoutContainer;
@property (readonly, getter=_isBarContainer) BOOL _barContainer;
...
@property (copy) NSString *minimumContentSizeCategory;
@property (copy) NSString *maximumContentSizeCategory;
@property (readonly) NSString *effectiveContentSizeCategory;
@property (readonly, copy) NSViewCornerConfiguration *_cornerConfiguration;
@property (readonly) NSViewCornerRadii *_effectiveCornerRadii;
@property (readonly) NSString *effectiveMinimumContentSizeCategory;
@property (readonly) NSString *effectiveMaximumContentSizeCategory;
...
@property (setter=_setControlMetricsBehavior:) long long _controlMetricsBehavior;
@property (readonly) long long _effectiveControlMetricsBehavior;
@property (setter=_setRequiresCompactControlMetrics:) BOOL _requiresCompactControlMetrics;
@property BOOL prefersCompactControlSizeMetrics;
@property (readonly) NSLayoutPoint *_centerLayoutPoint;
@property (readonly) NSLayoutPoint *_bottomLeadingCornerCenterLayoutPoint;
@property (readonly) NSLayoutPoint *_bottomTrailingCornerCenterLayoutPoint;
@property (readonly) NSLayoutPoint *_topLeadingCornerCenterLayoutPoint;
@property (readonly) NSLayoutPoint *_topTrailingCornerCenterLayoutPoint;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
...
@property (readonly) NSLayoutGuide *layoutMarginsGuide;
@property (nonatomic, setter=_setSafeAreaCornerAdaptation:) long long _safeAreaCornerAdaptation;
@property (nonatomic, setter=_setSafeAreaCornerInsets:) struct _NSCornerInsets { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; struct CGSize { double x0; double x1; } x3; } _safeAreaCornerInsets;
@property (readonly, nonatomic) struct _NSCornerInsets { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; struct CGSize { double x0; double x1; } x3; } _effectiveSafeAreaCornerInsets;
...
@property (copy, setter=_setTitlebarGroupName:) NSString *_titlebarGroupName;
@property (readonly, copy) NSString *_effectiveTitlebarGroupName;
@property (setter=_setTitlebarMaterial:) long long _titlebarMaterial;
@property (readonly) long long _effectiveTitlebarMaterial;
...
@property (setter=_setIgnoreForKeyViewLoop:) BOOL _ignoreForKeyViewLoop;
...
@property (readonly) BOOL _hasSolariumAppearance;
...
+ (BOOL)automaticallyTracksDependenciesOn_scrollPocketDescendantContributors;
+ (id)defaultAnimationForKey:(id)a0;
+ (unsigned long long)defaultFocusRingType;
+ (long long)default_controlMetricsBehavior;
+ (id)default_cornerConfiguration;
+ (id)default_environmentWrapper;
+ (long long)default_safeAreaCornerAdaptation;
+ (long long)default_semanticContext;
+ (id)default_titlebarGroupName;
+ (long long)default_titlebarMaterial;
...
- (BOOL)computed_isLastItemInGlassGroup;
...
- (void)_cacheDisplayInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 toBitmapImageRep:(id)a1 includeSubviews:(BOOL)a2;
...
- (void)_disableGlassViewEmbedding;
...
- (BOOL)_hasAnySafeAreaLayoutGuides;
...
- (id)_layoutMarginsGuideCornerAdaptationHorizontalIfExists;
- (id)_layoutMarginsGuideCornerAdaptationVerticalIfExists;
...
- (id)_observeChangesInGeometryInWindow:(id /* block */)a0;
- (id)_observeChangesInGeometryInWindowWithOptions:(unsigned long long)a0 changeHandler:(id /* block */)a1;
...
- (void)_reenableGlassViewEmbedding;
...
- (id)_rvPresenter;
- (struct _NSCornerInsets { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; struct CGSize { double x0; double x1; } x3; })_safeAreaCornerInsetsForFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inSuperview:(id)a1;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_safeAreaInsetsForFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inSuperview:(id)a1 withAdaptivityAxis:(long long)a2;
- (id)_safeAreaLayoutGuideCornerAdaptationHorizontalIfExists;
- (id)_safeAreaLayoutGuideCornerAdaptationVerticalIfExists;
...
- (BOOL)_shouldStopCornerInsetsPropagationFromSuperview:(id)a0;
...
- (void)_updateAdaptationLayoutGuideConstraintsIfNecessary;
...
- (id)computedEffectiveContentSizeCategory;
- (id)computedEffectiveMaximumContentSizeCategory;
- (id)computedEffectiveMinimumContentSizeCategory;
...
- (double)computed_effectiveAlphaValue;
- (long long)computed_effectiveControlMetricsBehavior;
- (id)computed_effectiveCornerRadii;
- (id)computed_effectiveFocusGroupIdentifier;
- (id)computed_effectiveGlassMaterialContext;
- (id)computed_effectiveMaterialBackdropContext;
- (struct _NSCornerInsets { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; struct CGSize { double x0; double x1; } x3; })computed_effectiveSafeAreaCornerInsets;
- (long long)computed_effectiveSemanticContext;
- (id)computed_effectiveTitlebarGroupName;
- (long long)computed_effectiveTitlebarMaterial;
- (BOOL)computed_inGlassSidebar;
- (BOOL)computed_inSelectedTableRow;
- (BOOL)computed_isBeingDrawnForCacheDisplay;
- (BOOL)computed_isFirstItemInGlassGroup;
- (BOOL)computed_parentNeedsMouseDown;
- (id)computed_resolvedEnvironmentWrapper;
- (id)computed_scrollPocketDescendantContributors;
...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })edgeInsetsForLayoutRegion:(id)a0;
...
- (id)layoutGuideForLayoutRegion:(id)a0;
- (id)layoutRect;
...
- (void)oneTimeDisplayLinkWithHandler:(id /* block */)a0;
...
- (void)print:(id)a0;
- (id)printJobTitle;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })rectForLayoutRegion:(id)a0;
