...
- (void)_testDelayTrampoline:(id /* block */)a0;
- (id)_windowForDocument:(id)a0;
- (id)_windowForTestNamed:(id)a0;
...
- (void)moveTestingWindowToScreen:(long long)a0 forTest:(id)a1 andPerformBlock:(id /* block */)a2;
