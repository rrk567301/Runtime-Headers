...
@property (readonly) NSMenuItem *_parentItem;
...
@property (weak, setter=_setControllerDelegate:) id<NSMenuDelegate> _controllerDelegate;
...
+ (id)displayWindowWithImpl:(id)a0 display:(unsigned int)a1 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 aperture:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 scaleFactor:(double)a4 isRTL:(BOOL)a5;
...
- (id)_actionImageNameFromMenuName;
...
- (id)_descriptionRecursing:(BOOL)a0 depth:(unsigned long long)a1;
- (void)_didInitialize;
...
- (void)_internalPerformActionForItemAtIndex:(long long)a0 invocationType:(unsigned long long)a1;
...
- (void)_performActionWithHighlightingForItemAtIndex:(long long)a0 sendAccessibilityNotification:(BOOL)a1 invocationType:(unsigned long long)a2;
...
- (id)_recursiveItemWithAction:(SEL)a0;
