...
@interface NSLocalStatusItem : NSStatusItem {
    ...
    struct { unsigned char isDragging : 1; unsigned char isDraggedOutOfBar : 1; unsigned char customDragDestination : 1; unsigned char customDragDestinationWantsSpaceInBar : 1; unsigned char isCreationDrag : 1; unsigned char sawMoveEvent : 1; unsigned char draggedLongEnoughToAllowRemoval : 1; unsigned char dragSetSomeOverrideCursor : 1; } _flags;
}
...
- (void)_performCustomDragOperation;
- (void)_presentIndicatorInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 type:(unsigned int)a1;
...
- (void)_uninstall;
- (void)_updateCustomDragOperationForDragMovement;
