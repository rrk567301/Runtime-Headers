...
@interface NSSegmentedCell : NSActionCell {
    ...
    struct { unsigned char trackingMode : 3; unsigned char trimmedLabels : 1; unsigned char drawing : 1; unsigned char recalcToolTips : 1; unsigned char usesWindowsStyle : 1; unsigned char dontShowSelectedAndPressedAppearance : 1; unsigned char menuShouldBeUniquedAgainstMain : 1; unsigned char style : 8; unsigned char segmentedSeparated : 1; unsigned char isObservingAllowsRollover : 1; unsigned char visualProviderNeedsRefresh : 1; } _seFlags;
...
- (void)_setSegmentItems:(id)a0 updateSegmentItemViews:(BOOL)a1 usingVisualProvider:(id)a2;
...
- (void)_setVisualProvider:(id)a0 withInvalidations:(BOOL)a1;
