...
+ (id)dateFormatter;
+ (BOOL)isInternalMediaItemProperty:(id)a0;
...
+ (id)transformArrayValue:(id)a0 property:(id)a1 shouldSerialize:(BOOL)a2;
+ (id)transformLocationCoordinateValue:(id)a0 shouldSerialize:(BOOL)a1;
