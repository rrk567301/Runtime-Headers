...
- (id)initWithSignatures:(id)a0 density:(long long)a1 algorithm:(long long)a2 databasePeakDensity:(long long)a3 bufferSize:(long long)a4 skipPrefixTable:(BOOL)a5 error:(id *)a6;
- (id)initWithSignatures:(id)a0 density:(long long)a1 algorithm:(long long)a2 error:(id *)a3;
- (id)search:(id)a0 error:(id *)a1;
- (id)search:(id)a0 multipleResults:(BOOL)a1 scorePenalties:(BOOL)a2 threshold:(float)a3 skewMin:(float)a4 skewMax:(float)a5 error:(id *)a6;
