...
@property (nonatomic) BOOL usesInferredAppearanceWithOverriddenBackgroundColor;
@property (nonatomic) BOOL needsDominantBackgroundColor;
...
@property (nonatomic, getter=isInSenderContext) BOOL inSenderContext;
...
@property (nonatomic) BOOL hasButtonActions;
@property (nonatomic) BOOL hasButton;
@property (nonatomic) BOOL canUseBlurBackgroundForCaptionBar;

- (void).cxx_destruct;
- (id)init;
- (id)arAsset;
- (BOOL)_allowsDominantBackgroundColorAsCaptionBackgroundForProperties:(id)a0;
- (id)_lastResortIcon;
...
- (BOOL)_shouldUseDominantBackgroundColorAsCaptionBackgroundForProperties:(id)a0;
