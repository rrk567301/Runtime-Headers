@class NSURL, LPTheme, LPConcretePresentationProperties, LPImage, LPLinkViewComponents, NSRegularExpression, LPCaptionButtonPresentationProperties, NSImmediateActionGestureRecognizer, NSMutableArray, NSAppearance, NSString, NSHashTable, LPLinkRendererSizeClassParameters, NSAttributedString, LPCollaborationFooterPresentationProperties, NSArray, NSView, NSNumber, LPLinkMetadata, NSColor;
...
@property (nonatomic) BOOL _allowsVibrancy;
@property (nonatomic, setter=_setBytesLoaded:) unsigned long long _bytesLoaded;
@property (nonatomic, setter=_setTransferIndicatorDirection:) long long _transferIndicatorDirection;
...
@property (nonatomic, setter=_setAllowsUnconstrainedSize:) BOOL _allowsUnconstrainedSize;
...
@property (nonatomic, setter=_setNeedsDominantBackgroundColor:) BOOL _needsDominantBackgroundColor;
...
@property (readonly, nonatomic) BOOL _specializedBackgroundIsMediaBlur;
@property (nonatomic, setter=_setUsesInferredAppearanceWithOverriddenBackgroundColor:) BOOL _usesInferredAppearanceWithOverriddenBackgroundColor;
...
- (void)_secondaryCaptionBarButtonPressed:(id)a0;
...
- (void)_setPresentationPropertiesInternal:(id)a0;
- (void)_setSecondaryButtonAction:(id)a0;
...
- (void)set_needsDominantBackgroundColor:(BOOL)a0;
- (void)set_preferredSizeClass:(unsigned long long)a0;
- (void)set_usesInferredAppearanceWithOverriddenBackgroundColor:(BOOL)a0;
