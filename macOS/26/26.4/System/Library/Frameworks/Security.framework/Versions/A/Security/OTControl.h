...
- (void)escrowCheck:(id)a0 isBackgroundCheck:(BOOL)a1 reply:(id /* block */)a2;
...
- (void)disableWalrus:(id)a0 preRecords:(id)a1 isDBRv2:(BOOL)a2 reply:(id /* block */)a3;
...
- (void)icscRepairReset:(id)a0 reply:(id /* block */)a1;
...
- (void)trustedFullPeers:(id)a0 reply:(id /* block */)a1;
...
- (void)simulateReceiveTDLChangePush:(id)a0 reply:(id /* block */)a1;
...
- (void)enableWalrus:(id)a0 preRecords:(id)a1 isDBRv2:(BOOL)a2 reply:(id /* block */)a3;
...
- (void)healthCheck:(id)a0 skipRateLimitingCheck:(BOOL)a1 repair:(BOOL)a2 danglingPeerCleanup:(BOOL)a3 caesarPeerCleanup:(BOOL)a4 updateIdMS:(BOOL)a5 reply:(id /* block */)a6;
...
- (void)resetAndEstablish:(id)a0 resetReason:(long long)a1 idmsTargetContext:(id)a2 idmsCuttlefishPassword:(id)a3 notifyIdMS:(BOOL)a4 accountSettings:(id)a5 isDBRv2:(BOOL)a6 accountIsW:(BOOL)a7 reply:(id /* block */)a8;
...
- (void)clearCliqueFromAccount:(id)a0 resetReason:(long long)a1 isDBRv2:(BOOL)a2 reply:(id /* block */)a3;
...
- (void)performCKServerUnreadableDataRemoval:(id)a0 isDBRv2:(BOOL)a1 accountIsW:(BOOL)a2 altDSID:(id)a3 reply:(id /* block */)a4;
