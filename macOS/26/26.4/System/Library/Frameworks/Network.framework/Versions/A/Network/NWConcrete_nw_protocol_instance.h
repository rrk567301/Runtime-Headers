...
@protocol OS_nw_protocol_options, OS_nw_protocol_instance_registrar, OS_nw_path_flow_registration, OS_nw_context, OS_nw_parameters, OS_nw_array, OS_nw_endpoint, OS_nw_association, OS_nw_protocol_metadata, OS_xpc_object, OS_nw_path;
...
@interface NWConcrete_nw_protocol_instance : NSObject <OS_nw_protocol_instance> {
    ...
    unsigned char handling_early_data_rejection : 1;
