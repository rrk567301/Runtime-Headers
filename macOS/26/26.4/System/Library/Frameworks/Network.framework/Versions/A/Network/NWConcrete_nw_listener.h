@class NSString, NSArray, NSMutableDictionary, NWConcrete_nw_connection, NSObject;
@protocol OS_xpc_object, OS_nw_txt_record, OS_nw_group_descriptor, OS_nw_advertise_descriptor, OS_nw_context, OS_nw_parameters, OS_nw_array, OS_dispatch_queue, OS_nw_endpoint, OS_nw_error, OS_nw_path_evaluator, OS_nw_path;
...
@interface NWConcrete_nw_listener : NSObject <nw_listener_inbox_delegate, OS_nw_listener> {
    ...
    unsigned char require_authorized_keys : 1;
}
...
- (id).cxx_construct;
- (void)handleInboundPacket:(const char *)a0 length:(unsigned short)a1 from:(id)a2 to:(id)a3 interface:(id)a4 socket:(id)a5 ipMetadata:(id)a6;
- (void)dealloc;
