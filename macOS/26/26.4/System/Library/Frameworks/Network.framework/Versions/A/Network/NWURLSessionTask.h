@class NSDictionary, NSURLRequest, NWURLSessionDelegateWrapper, NWURLError, NSURLSessionTaskTransactionMetrics, NSMutableArray, NSString, NWConcrete_nw_connection, NWURLSessionRequestBodyInfo, NWURLSessionTaskMetrics, NSArray, NSMutableDictionary, NSURLSessionTask, NWURLSession, NWURLSessionMultipartParser, NSObject, NSURLSessionTaskMetrics, NSData, NWURLSessionTaskConfiguration, NSURLSessionDataTask, NSURLResponse, NSURL, NSProgress, NSDate;
...
- (id)loaderNeedsEarlyData:(BOOL *)a0;
