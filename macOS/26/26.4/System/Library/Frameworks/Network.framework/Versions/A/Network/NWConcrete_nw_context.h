...
@protocol OS_nw_resolver_config, OS_dispatch_workloop, OS_dispatch_queue, OS_nw_array;
...
@interface NWConcrete_nw_context : NSObject <OS_nw_context> {
    ...
    unsigned char suppress_kernel_logging : 1;
    unsigned char has_active_instances : 1;
    unsigned char client_set_privacy_level : 1;
    unsigned char _pad_bits : 5;
}
