...
@protocol OS_nw_http_connection_state_storage, OS_nw_context, OS_nw_authentication_credential_storage, NSURLSessionDelegate, OS_nw_array, OS_sec_protocol_configuration, OS_dispatch_queue, OS_nw_http_cookie_storage;
...
- (id)dataTaskWithResumeInfo:(id)a0;
- (id)downloadTaskWithResumeInfo:(id)a0;
- (id)initWithConfiguration:(id)a0 UUID:(id)a1 delegate:(id)a2 delegateQueue:(id)a3 delegateDispatchQueue:(id)a4;
- (id)uploadTaskWithResumeInfo:(id)a0;
