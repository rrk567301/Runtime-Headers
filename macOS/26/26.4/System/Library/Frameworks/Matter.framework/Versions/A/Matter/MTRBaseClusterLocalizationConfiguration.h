...
+ (void)readAttributeActiveLocaleWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeSupportedLocalesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeActiveLocaleWithCompletion:(id /* block */)a0;
...
- (void)readAttributeSupportedLocalesWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeActiveLocaleWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeSupportedLocalesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)writeAttributeActiveLocaleWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeActiveLocaleWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeActiveLocaleWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeActiveLocaleWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
