...
+ (void)readAttributeFlipFlopWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)addArgumentsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)pingWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeFlipFlopWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeFlipFlopWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeFlipFlopWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeFlipFlopWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
