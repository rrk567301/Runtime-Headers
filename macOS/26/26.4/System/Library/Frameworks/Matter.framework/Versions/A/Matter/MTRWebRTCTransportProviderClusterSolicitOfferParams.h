@class NSArray, NSString, MTRWebRTCTransportProviderClusterSFrameStruct, NSNumber;
...
@property (copy, nonatomic) NSNumber *originatingEndpointID;
...
@property (copy, nonatomic) MTRWebRTCTransportProviderClusterSFrameStruct *sFrameConfig;
