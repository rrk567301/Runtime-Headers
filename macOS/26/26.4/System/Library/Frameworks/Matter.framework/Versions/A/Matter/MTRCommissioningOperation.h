@class MTRSetupPayload, NSString, MTRCommissioningParameters, MTRDeviceController_Concrete, NSNumber, NSObject;
...
- (void)controller:(id)a0 commissioningSessionEstablishmentDone:(id)a1 forPayload:(id)a2;
- (void)controller:(id)a0 needsThreadCredentialsWithScanResults:(id)a1 error:(id)a2;
- (void)controller:(id)a0 needsWiFiCredentialsWithScanResults:(id)a1 error:(id)a2;
- (void)controller:(id)a0 readCommissioneeInfo:(id)a1;
- (void)controller:(id)a0 statusUpdate:(long long)a1;
- (void)controllerStartingNetworkScan:(id)a0;
