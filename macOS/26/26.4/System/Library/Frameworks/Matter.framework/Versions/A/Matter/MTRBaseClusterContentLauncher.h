...
+ (void)readAttributeAcceptHeaderWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeSupportedStreamingProtocolsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)launchURLWithParams:(id)a0 completion:(id /* block */)a1;
- (id)initWithDevice:(id)a0 endpoint:(unsigned short)a1 queue:(id)a2;
- (void)launchContentWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeAcceptHeaderWithCompletion:(id /* block */)a0;
...
- (void)readAttributeSupportedStreamingProtocolsWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeAcceptHeaderWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeSupportedStreamingProtocolsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
