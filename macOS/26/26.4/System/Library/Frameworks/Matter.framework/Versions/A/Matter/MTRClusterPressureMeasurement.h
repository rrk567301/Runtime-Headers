...
- (id)readAttributeMaxScaledValueWithParams:(id)a0;
- (id)readAttributeMeasuredValueWithParams:(id)a0;
- (id)readAttributeMinMeasuredValueWithParams:(id)a0;
- (id)readAttributeMinScaledValueWithParams:(id)a0;
- (id)readAttributeScaleWithParams:(id)a0;
- (id)readAttributeScaledToleranceWithParams:(id)a0;
- (id)readAttributeScaledValueWithParams:(id)a0;
