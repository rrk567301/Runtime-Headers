...
@interface MTRServerCluster : NSObject {
    ...
    struct unique_ptr<MTRServerAttributeAccessInterface, std::default_delete<MTRServerAttributeAccessInterface>> { struct { struct MTRServerAttributeAccessInterface *__ptr_; } ; } _attributeAccessInterface;
    struct vector<EmberAfAttributeMetadata, std::allocator<EmberAfAttributeMetadata>> { struct EmberAfAttributeMetadata *__begin_; struct EmberAfAttributeMetadata *__end_; struct { struct EmberAfAttributeMetadata *__cap_; } ; } _matterAttributeMetadata;
    struct unique_ptr<unsigned int[], std::default_delete<unsigned int[]>> { struct { unsigned int *__ptr_; } ; } _matterAcceptedCommandList;
    struct unique_ptr<unsigned int[], std::default_delete<unsigned int[]>> { struct { unsigned int *__ptr_; } ; } _matterGeneratedCommandList;
