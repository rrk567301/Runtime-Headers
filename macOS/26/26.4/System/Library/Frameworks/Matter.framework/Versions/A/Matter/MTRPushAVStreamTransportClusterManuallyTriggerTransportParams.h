@class NSNumber, MTRPushAVStreamTransportClusterTransportMotionTriggerTimeControlStruct, NSData;
...
@property (copy, nonatomic) MTRPushAVStreamTransportClusterTransportMotionTriggerTimeControlStruct *timeControl;
@property (copy, nonatomic) NSData *userDefined;
