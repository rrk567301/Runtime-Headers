...
+ (void)readAttributeProvisionedClientCertificatesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeProvisionedRootCertificatesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)clientCSRWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeProvisionedClientCertificatesWithParams:(id)a0 completion:(id /* block */)a1;
- (void)readAttributeProvisionedRootCertificatesWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeProvisionedClientCertificatesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeProvisionedRootCertificatesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
