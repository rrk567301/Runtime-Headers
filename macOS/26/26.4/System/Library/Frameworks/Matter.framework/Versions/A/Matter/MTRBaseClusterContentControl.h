...
+ (void)readAttributeBlockApplicationListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeBlockChannelListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeBlockContentTimeWindowWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)addBlockApplicationsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)addBlockChannelsWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeBlockApplicationListWithCompletion:(id /* block */)a0;
- (void)readAttributeBlockChannelListWithCompletion:(id /* block */)a0;
- (void)readAttributeBlockContentTimeWindowWithCompletion:(id /* block */)a0;
...
- (void)removeBlockApplicationsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)removeBlockChannelsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)removeBlockContentTimeWindowWithParams:(id)a0 completion:(id /* block */)a1;
- (void)resetPINWithCompletion:(id /* block */)a0;
- (void)resetPINWithParams:(id)a0 completion:(id /* block */)a1;
- (void)setBlockContentTimeWindowWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeBlockApplicationListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeBlockChannelListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeBlockContentTimeWindowWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
