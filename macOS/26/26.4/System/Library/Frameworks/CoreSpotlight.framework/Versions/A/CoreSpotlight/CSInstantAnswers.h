...
+ (id)instantAnswersFallbackQueries:(id)a0 queryComponents:(id)a1 isCJK:(BOOL)a2;
+ (id)instantAnswersMailboxes:(id)a0;
+ (BOOL)isInstantAnswerTriggerQuery:(id)a0 isCJK:(BOOL)a1 isSearchToolClient:(BOOL)a2;
+ (BOOL)isInstantAnswersTriggeringQuery:(id)a0 isCJK:(BOOL)a1 instantAnswerQueryMinLengthNonCJK:(long long)a2 instantAnswerQueryMinLengthCJK:(long long)a3 isSearchTool:(BOOL)a4;
+ (id)noInstantAnswersQueries;
+ (BOOL)overrideParsedQuery:(id)a0;
+ (id)overrideTokens;
+ (id)selectInstantAnswersEventsWithFoundEvents:(id)a0;
+ (id)selectInstantAnswersEventsWithFoundEvents:(id)a0 forDate:(id)a1 isSearchToolQuery:(BOOL)a2;
