...
@property BOOL previouslyInitialized;
...
+ (BOOL)copyBoolForKey:(const char *)a0 fromXPCDictionary:(id)a1;
...
- (id)initMachServiceListenerWithName:(id)a0 enableConnectionLogging:(BOOL)a1;
