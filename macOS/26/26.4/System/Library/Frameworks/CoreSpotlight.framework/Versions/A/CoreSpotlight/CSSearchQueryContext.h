@class NSData, NSAttributedString, NSArray, NSString, CSSuggestion, _MDQueryRewriteContext, NSDictionary, NSDate, NSNumber;
...
@property (nonatomic) BOOL dateSortedL1;
...
- (void)setLogToken:(unsigned long long)a0;
