...
- (id)rankBatch:(id)a0 withRanker:(id)a1 withBundle:(id)a2 maxCount:(unsigned long long)a3 heapMaxCount:(long long)a4 rankingConfiguration:(id)a5 isCJK:(BOOL)a6 isKeyboardCJK:(BOOL)a7 queryContext:(id)a8;
...
- (BOOL)_shouldEmitAnalyticsEvent;
...
- (void)_sendQueryAnalyticsEventWithError:(id)a0;
- (id)description;
