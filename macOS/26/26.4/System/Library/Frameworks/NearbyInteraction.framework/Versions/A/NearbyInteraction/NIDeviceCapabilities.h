...
- (id)initWithFineRangingSupport:(BOOL)a0 aoaSupport:(BOOL)a1 extendedDistanceMeasurementSupport:(BOOL)a2 syntheticApertureSupport:(BOOL)a3 dltdoaSupport:(BOOL)a4;
- (unsigned char)toBitmap;
- (id)initWithFineRangingSupport:(BOOL)a0 coarseRangingSupport:(BOOL)a1 aoaSupport:(BOOL)a2 extendedDistanceMeasurementSupport:(BOOL)a3 syntheticApertureSupport:(BOOL)a4 dltdoaSupport:(BOOL)a5;
