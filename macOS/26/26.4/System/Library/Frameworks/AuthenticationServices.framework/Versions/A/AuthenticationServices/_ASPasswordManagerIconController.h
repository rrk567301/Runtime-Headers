...
- (void)_fetchIconWithName:(id)a0 domain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 shouldUseOneTimeRequest:(BOOL)a3 requestID:(id)a4 responseHandler:(id /* block */)a5;
- (unsigned long long)_optionsWithDomain:(id)a0;
- (void)_privacyProxyStateInitialized;
- (void)_requestIconWithName:(id)a0 domain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 options:(unsigned long long)a3 shouldUseOneTimeRequest:(BOOL)a4 requestID:(id)a5 responseHandler:(id /* block */)a6;
...
- (void)fetchIconWithOneTimeRequestWithName:(id)a0 domain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 responseHandler:(id /* block */)a3;
- (void)fetchIconWithOngoingRequestWithName:(id)a0 domain:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 requestID:(id)a3 responseHandler:(id /* block */)a4;
- (BOOL)historyShouldScheduleMaintenance:(id)a0;
- (id)initWithAllowNetworkFetchingBlock:(id /* block */)a0;
