@class NSData, NSString, NSURL, NSArray, NSSet, ASWebAuthenticationSessionController, NSUUID, NSDictionary, ASWebAuthenticationSessionCallback;
...
@property (retain, nonatomic) NSString *webBrowserApplicationIdentifier;
...
- (id)initWithUUID:(id)a0 URL:(id)a1 callback:(id)a2 shouldUseEphemeralSession:(BOOL)a3 jitEnabled:(BOOL)a4 requestingAppSupportedSchemes:(id)a5 additionalHeaderFields:(id)a6 customAnchorCertificatesData:(id)a7 shouldFailOnMDMProfileErrorResponse:(BOOL)a8 webBrowserApplicationIdentifier:(id)a9;
