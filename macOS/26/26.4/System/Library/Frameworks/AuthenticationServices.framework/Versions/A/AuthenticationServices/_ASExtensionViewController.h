@class NSString, NSDictionary, NSExtensionContext, NSViewController, NSExtension, NSTimer;
...
- (void).cxx_destruct;
- (void)_beginNonUIRequestAllowingRequestingUI:(BOOL)a0 connectionHandler:(id /* block */)a1;
