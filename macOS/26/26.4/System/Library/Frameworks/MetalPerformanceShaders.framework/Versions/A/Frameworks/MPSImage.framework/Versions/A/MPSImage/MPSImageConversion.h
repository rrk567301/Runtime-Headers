...
@interface MPSImageConversion : MPSUnaryImageKernel {
    ...
    struct ConversionInfo_s { float bgColor[4]; unsigned int nData; unsigned int nFData; int nStages; int nMatrices; int nLuts; int nLutTextures; int nTRCs; int nLuminanceScales; int nCHIn; int nCHOut; int containsATableTRC; unsigned int stagesClampFlags; unsigned int trcFCFlags; unsigned int stageTypesFC; } convertInfo;
