@class MPSNDArrayStitchedReductionSoftmax, MPSNDArrayMatrixMultiplication, MPSNDArrayIdentity, MPSKernelDAGObject;

@interface MPSNDArrayScaledDotProductAttention : MPSNDArrayMultiaryKernel {
    MPSKernelDAGObject *_kernelDAGObject;
    BOOL _createdFallbackKernels;
...
- (void)dealloc;
- (long long)createFallbackKernels:(id)a0;
...
- (id)initWithDevice:(id)a0 kernelType:(int)a1;
- (id)initWithDevice:(id)a0 kernelType:(int)a1 maskType:(int)a2;
- (id)initWithDevice:(id)a0 kernelType:(int)a1 maskType:(int)a2 sourceCount:(unsigned long long)a3;
- (id)initWithDevice:(id)a0 kernelType:(int)a1 sourceCount:(unsigned long long)a2;
