@class MPSNDArrayIdentity, MPSNDArrayQuantizationDescriptor, MPSExternalNDArrayBinaryGradient;
...
- (id)encodePreProcessingToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 sourceGradientArray:(id *)a3 destinationArray:(id *)a4 kernelDAGObject:(id *)a5;
