...
@property (nonatomic) union { unsigned int bits; struct { unsigned char mpsKernelVersion : 8; unsigned char intermediateObjectVersion : 8; unsigned short version : 16; } ; } fileVersion;
