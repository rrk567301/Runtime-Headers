@class MPSNDArrayQuantizationDescriptor, MPSNDArrayIdentity, MPSExternalNDArrayBinary, NSArray;

@interface MPSNDArrayConvolution2D : MPSNDArrayMultiaryKernel <MPSAutoTuneKernel> {
    ...
    BOOL _allowFP16WinogradTransformIntermediate;
}
...
- (id)initWithDevice:(id)a0 ndArrayConvolution2DDescriptor:(id)a1 sourceCount:(unsigned long long)a2;
