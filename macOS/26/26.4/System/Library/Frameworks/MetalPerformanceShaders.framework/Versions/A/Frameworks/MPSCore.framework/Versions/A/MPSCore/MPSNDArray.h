...
- (id)arrayViewWithDescriptor:(id)a0;
- (id)arrayViewWithDimensionCount:(unsigned long long)a0 dimensionSizes:(const unsigned long long *)a1 strides:(const unsigned long long *)a2;
- (id)arrayViewWithShape:(id)a0 strides:(id)a1;
...
- (id)initWithBuffer:(id)a0 dataType:(unsigned int)a1 numDimensions:(unsigned long long)a2 dimSizes:(const long long *)a3 strides:(const long long *)a4 offsets:(const long long *)a5 offsetBytes:(unsigned long long)a6 sizePermutation:(unsigned long long)a7 permutation:(const long long *)a8;
- (id)initWithBuffer:(id)a0 dataType:(unsigned int)a1 numDimensions:(unsigned long long)a2 dimSizes:(const long long *)a3 strides:(const long long *)a4 offsets:(const long long *)a5 sizePermutation:(unsigned long long)a6 permutation:(const long long *)a7;
- (id)initWithBuffer:(id)a0 offset:(unsigned long long)a1 descriptor:(id)a2;
- (id)initWithBufferImpl:(id)a0 offset:(unsigned long long)a1 descriptor:(id)a2 isForNDArrayAlias:(BOOL)a3 isUserBuffer:(BOOL)a4;
- (id)initWithDevice:(id)a0 descriptor:(id)a1 isTextureBacked:(BOOL)a2;
...
- (void)shapeToVector:(long long *)a0 numberOfDimensions:(long long)a1;
- (void)updateStrides;
- (id)userBuffer;
