...
@property (nonatomic) BOOL fusedKeypointOrientation;
@property (nonatomic) BOOL useCompressedTexture;
...
- (void)dealloc;
- (void)encodeToCommandBuffer:(id)a0 sourceTexture:(id)a1 destinationGaussianPyramid:(id)a2 destinationDOGPyramid:(id)a3 keypointsBuffer:(id)a4 keypointBufferOffset:(unsigned long long)a5 keypointCountBuffer:(id)a6 keypointCountBufferOffset:(unsigned long long)a7;
- (void)encodeToCommandBuffer:(id)a0 sourceTexture:(id)a1 keypointsBuffer:(id)a2 keypointBufferOffset:(unsigned long long)a3 keypointCountBuffer:(id)a4 keypointCountBufferOffset:(unsigned long long)a5;
