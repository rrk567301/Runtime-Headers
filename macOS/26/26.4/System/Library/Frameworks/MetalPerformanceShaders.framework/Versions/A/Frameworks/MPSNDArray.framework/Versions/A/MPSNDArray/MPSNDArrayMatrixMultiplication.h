@class MPSNDArrayStitchedReductionSoftmax, MPSMatrixMultiplication, MPSNDArray, MPSNDArrayStitchedReductionRMSNorm, MPSNDArrayQuantizationDescriptor, MPSNDArrayIdentity, MPSNDArrayNormFusionDescriptor, MPSKernelDAGObject;

@interface MPSNDArrayMatrixMultiplication : MPSNDArrayMultiaryKernel <MPSAutoTuneKernel> {
...
- (void)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 normScaleArray:(id)a3 resultState:(id)a4 destinationArray:(id)a5 kernelDAGObject:(id)a6;
