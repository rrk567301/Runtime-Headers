...
- (BOOL)getDestContiguousFunctionConstant:(id)a0;
...
- (void)kernelMDAGObjectSetup:(id *)a0 sourceArrays:(id)a1 sourceGradient:(id)a2 destination:(id)a3;
- (struct { unsigned long long x0[16]; })kernelSizesForSourceIndex:(unsigned long long)a0;
- (unsigned long long)maxSupportedArraySizeForIsDestination:(BOOL)a0;
...
- (BOOL)usesVectorFunctionsOnOutput:(id)a0;
