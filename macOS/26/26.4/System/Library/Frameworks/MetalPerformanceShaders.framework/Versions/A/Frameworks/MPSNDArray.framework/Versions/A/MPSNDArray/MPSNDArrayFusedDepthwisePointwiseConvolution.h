...
@property (readonly, nonatomic) unsigned int inputDataFormat;
@property (readonly, nonatomic) unsigned int outputDataFormat;
@property (readonly, nonatomic) unsigned int depthwiseWeightsFormat;
@property (readonly, nonatomic) unsigned int pointwiseWeightsFormat;
...
- (id)initWithDevice:(id)a0 ndArrayFusedConvolutionDescriptor:(id)a1;
- (id)initWithDevice:(id)a0 ndArrayFusedConvolutionDescriptor:(id)a1 sourceCount:(unsigned long long)a2;
