...
- (void)encodeToCommandBuffer:(id)a0 sourceArrays:(id)a1 resultState:(id)a2 destinationArray:(id)a3 kernelDAGObjects:(id)a4;
...
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 resultState:(id)a3 destinationArray:(id)a4 kernelDAGObjects:(id)a5;
