@class QLControlsController, QLPreviewPageNavigationView, QLPreviewPanelController, QLPreviewScroller, NSMutableArray, QLFullscreenHUDWindow, NSString, QLFadeWindowEffect, NSTimer, QLTimeSlider, NSWindow, NSView, QLScaleWindowEffect, NSTrackingArea, NSScreen;
...
@interface QLFullscreenController : NSResponder <QLIndexSheetDelegate, QLControlsDelegate> {
    ...
    QLFullscreenHUDWindow *_controlsPanel;
