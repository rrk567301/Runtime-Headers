@class NSString, MPMediaLibrary, NSDictionary, MPMediaLibraryArtwork, NSNumber, ICUserIdentity;
...
- (id)initWithLibrary:(id)a0 identifier:(unsigned long long)a1 entityType:(long long)a2 artworkType:(long long)a3 mediaType:(unsigned long long)a4 variantType:(long long)a5;
- (id)initWithLibrary:(id)a0 identifier:(unsigned long long)a1 entityType:(long long)a2 artworkType:(long long)a3 mediaType:(unsigned long long)a4 variantType:(long long)a5 colorInfo:(id)a6;
