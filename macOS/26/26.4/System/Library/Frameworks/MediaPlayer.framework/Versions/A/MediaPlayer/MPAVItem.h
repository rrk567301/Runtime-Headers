...
@property (readonly, nonatomic) BOOL isPreloadedAsset;
@property (nonatomic, getter=isInSmartTransition) BOOL inSmartTransition;
@property (nonatomic, getter=isInOverlappedTransition) BOOL inOverlappedTransition;
...
@property (readonly, nonatomic) BOOL supportsIntegratedTimeline;
...
@property (readonly, nonatomic, getter=isSelectionDisabled) BOOL selectionDisabled;
...
- (void)_updateDurationSnapshotWithElapsedTime:(double)a0 playbackRate:(float)a1 playbackState:(long long)a2 timestamp:(double)a3;
