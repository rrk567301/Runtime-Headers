...
@property (readonly, nonatomic, getter=isOnboardedPerson) BOOL onboardedPerson;
...
- (id)initWithStoreMusicAPIDictionary:(id)a0 storePlatformDictionary:(id)a1;
...
- (id)staticTallEditorialArtworkRequestTokenForStorePlatformDictionary:(id)a0;
...
- (id)superHeroTallEditorialArtworkRequestTokenForStorePlatformDictionary:(id)a0;
