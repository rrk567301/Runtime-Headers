@class NSDate, NSString, NSURL, MPModelFileAsset, NSArray, NSSet, NSDictionary, MPModelPodcast, NSDateComponents, MPModelPlaybackPosition, MPModelPodcastAuthor;
...
@property (readonly, nonatomic) BOOL areChaptersGenerated;
