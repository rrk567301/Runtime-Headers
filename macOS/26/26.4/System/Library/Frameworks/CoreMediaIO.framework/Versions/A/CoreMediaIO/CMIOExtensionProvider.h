...
- (void)_addSystemStatusAttributionsForClient:(id)a0 stream:(id)a1 requestVideo:(BOOL)a2 requestAudio:(BOOL)a3;
...
- (void)_removeSystemStatusAttributionsForClient:(id)a0 stream:(id)a1 allowAudioRemoval:(BOOL)a2;
...
- (void)toggleVideoSystemStatusAttributionsForAllClientsOfStream:(id)a0;
