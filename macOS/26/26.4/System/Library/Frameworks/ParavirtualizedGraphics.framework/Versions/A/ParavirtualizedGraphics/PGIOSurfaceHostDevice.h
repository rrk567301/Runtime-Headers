...
@interface PGIOSurfaceHostDevice : NSObject {
    ...
    _Atomic unsigned long long reg_ringBase;
    _Atomic unsigned long long reg_ringSize;
    _Atomic unsigned long long reg_descriptorBase;
    _Atomic unsigned long long reg_ringWrCounter;
    _Atomic unsigned long long reg_ringRdCounter;
    _Atomic unsigned long long reg_descEnable;
