...
@interface PGBaseTask : NSObject <PGTask_Resource, PGTask_ResourceManager, PGTask_ObjectListManager> {
    ...
    struct unique_ptr<PGResourceManager, std::default_delete<PGResourceManager>> { struct { struct PGResourceManager *__ptr_; } ; } _resourceManager;
