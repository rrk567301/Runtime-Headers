...
@interface _PGDevice : NSObject <PGDevice> {
    ...
    void *_stampMemory;
    struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } _rootTaskMutex;
    ...
    struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } _rootNodeMutex;
    PGMapping *_rootNodeMapping;
    void *_rootNode;
    BOOL _tearingDownRoot;
    struct mutex { struct _opaque_pthread_mutex_t { long long __sig; char __opaque[56]; } __m_; } _rootFIFOMutex;
...
@property (readonly, nonatomic) unsigned int displayPortConnectionTypes;
...
- (unsigned int)guestDisplayPortConnectionTypes;
...
- (BOOL)checkEnableProtectedContent;
...
- (unsigned int)guestDisplayPortCount;
