@class Module, LACExternalizedContextProvider, NSDictionary, NSString, NSDate, NSMutableDictionary;
...
- (void)evaluateACL:(id)a0 operation:(id)a1 options:(id)a2 uiDelegate:(id)a3 request:(id)a4 reply:(id /* block */)a5;
- (void)evaluateRequest:(id)a0 uiDelegate:(id)a1 reply:(id /* block */)a2;
- (void)evaluatePolicy:(long long)a0 options:(id)a1 uiDelegate:(id)a2 request:(id)a3 reply:(id /* block */)a4;
...
- (id)createInternalInfoWithPolicy:(long long)a0 policyOptions:(id)a1 request:(id)a2;
- (id)createInternalInfo:(id)a0 skipCallerIdentification:(BOOL)a1 callerBundleId:(id)a2 request:(id)a3;
