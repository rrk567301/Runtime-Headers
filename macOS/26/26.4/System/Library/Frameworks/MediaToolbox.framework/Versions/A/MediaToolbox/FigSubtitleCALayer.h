...
@property (nonatomic) BOOL hidesAllCaptionDisplay;
...
- (void)setCaptionRendererOutputOptions:(id)a0 forKeyPath:(id)a1;
...
- (void)setCaptionsAvoidanceOptions:(struct FigCaptionRendererAvoidanceOptions { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; })a0;
- (id)init;
- (void)setVideosize:(struct CGSize { double x0; double x1; })a0;
- (void)setCaptionRendererOutputSeparated:(BOOL)a0;
