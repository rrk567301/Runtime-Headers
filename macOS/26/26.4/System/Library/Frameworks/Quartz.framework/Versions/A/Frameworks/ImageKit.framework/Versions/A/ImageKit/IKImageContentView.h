...
@interface IKImageContentView : NSView <CALayerDelegate> {
    BOOL _initialized;
    CIImage *_ciImage;
...
- (struct CGPoint { double x0; double x1; })_rotationCenter;
...
- (void)_setRotationAngle:(double)a0 centeredAroundImagePoint:(struct CGPoint { double x0; double x1; })a1;
- (void)_setRotationAngleWithAnimation:(double)a0 duration:(double)a1;
...
- (void)ik_setRotationAngleCenteredInSafeArea:(double)a0;
- (void)ik_setRotationAngleWithAnimation:(double)a0 duration:(double)a1;
