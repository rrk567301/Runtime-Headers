...
@property (nonatomic) BOOL restrainsMinZoomToViewSize;
...
- (void)_showCheckerboardLayerAfterRotation;
...
- (void)ik_willRotateAnimated:(BOOL)a0 setupCompletion:(id /* block */)a1;
- (BOOL)imageAnalysisManagerAllowsCopyAndSharing:(id)a0;
