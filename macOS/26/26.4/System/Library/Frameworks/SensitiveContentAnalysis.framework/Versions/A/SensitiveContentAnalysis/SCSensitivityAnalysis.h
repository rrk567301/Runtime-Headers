...
@property (nonatomic, readonly) BOOL shouldDisableTranscriptCapabilities;
@property (nonatomic, readonly) BOOL shouldIncludeInStacksAndCollages;
...
- (id)initWithAnalysisResults:(id)a0 error:(id *)a1;
- (id)initWithMediaAnalysisServiceResult:(id)a0;
