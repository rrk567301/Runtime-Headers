...
@interface VZVirtualMachineConfiguration : NSObject <NSCopying> {
    ...
    struct vector<HvCore::SharedRamEntry, std::allocator<HvCore::SharedRamEntry>> { struct SharedRamEntry *__begin_; struct SharedRamEntry *__end_; struct { struct SharedRamEntry *__cap_; } ; } _sharedRamRegions;
...
@property (copy, setter=_setHIDDevices:) NSArray *_hidDevices;
...
@property (setter=_setSharedRamRegions:) struct vector<HvCore::SharedRamEntry, std::allocator<HvCore::SharedRamEntry>> { struct SharedRamEntry *x0; struct SharedRamEntry *x1; struct { struct SharedRamEntry *x0; } x2; } _sharedRamRegions;
