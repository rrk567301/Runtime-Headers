...
@interface VZVirtualMachine : NSObject <_VZPointingEventSender, _VZMultiTouchEventSender, _VZKeyboardEventSender, _VZHIDAdditions, _VZIOHIDEventSender> {
...
@property (readonly) NSArray *_hidDevices;
