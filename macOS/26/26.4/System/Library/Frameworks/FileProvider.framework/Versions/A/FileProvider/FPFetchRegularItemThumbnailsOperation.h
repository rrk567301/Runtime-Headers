@class NSDictionary, FPItemManager, FPService;
@protocol FPXOperationService, FPOperationProgressDelegate;
...
- (void)main;
- (void).cxx_destruct;
- (id)initWithDictionary:(id)a0 desiredSizeToScale:(struct CGSize { double x0; double x1; })a1 itemManager:(id)a2 operationServicer:(id)a3;
