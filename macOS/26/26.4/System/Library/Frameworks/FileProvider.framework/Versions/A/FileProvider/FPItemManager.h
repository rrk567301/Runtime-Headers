...
- (void)fetchItemForURL:(id)a0 options:(unsigned long long)a1 completionHandler:(id /* block */)a2;
...
- (void)_fetchItemForURL:(id)a0 options:(unsigned long long)a1 completionHandler:(id /* block */)a2;
- (void)_fetchParentsForItemID:(id)a0 recursively:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_fetchPathComponentsForURL:(id)a0 synchronously:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_fetchURLForItemID:(id)a0 creatingPlaceholderIfMissing:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_fetchURLForItemID:(id)a0 creatingPlaceholderIfMissing:(BOOL)a1 completionHandlerWithInfo:(id /* block */)a2;
- (void)_fetchURLForItemID:(id)a0 creatingPlaceholderIfMissing:(BOOL)a1 synchronously:(BOOL)a2 completionHandlerWithInfo:(id /* block */)a3;
...
- (BOOL)hasEnumerateEntitlement;
- (BOOL)isItemInTrash:(id)a0;
- (id)itemForURL:(id)a0 options:(unsigned long long)a1 error:(id *)a2;
- (id)newCollectionForProvider:(id)a0;
- (id)newCollectionForTag:(id)a0;
- (id)newCollectionWithItemAtURL:(id)a0 skipValidation:(BOOL)a1 error:(id *)a2;
...
- (id)pathComponentsForURL:(id)a0 error:(id *)a1;
...
- (id)thumbnailsFetchOperationForItem:(id)a0 withVersions:(id)a1 withSize:(struct CGSize { double x0; double x1; })a2 scale:(double)a3 operationServicer:(id)a4;
- (id)thumbnailsFetchOperationForItems:(id)a0 withSize:(struct CGSize { double x0; double x1; })a1 scale:(double)a2;
- (id)urlForItem:(id)a0 creatingPlaceholderIfMissing:(BOOL)a1 error:(id *)a2;
- (id)urlForItem:(id)a0 error:(id *)a1;
- (id)urlForItemID:(id)a0 creatingPlaceholderIfMissing:(BOOL)a1 error:(id *)a2;
- (id)urlForItemID:(id)a0 error:(id *)a1;
