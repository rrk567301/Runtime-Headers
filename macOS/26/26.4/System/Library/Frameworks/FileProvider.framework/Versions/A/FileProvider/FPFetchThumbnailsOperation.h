@class NSString, NSMutableDictionary, NSOperationQueue, FPService, NSMutableArray, FPItemManager;
...
- (id)initWithItem:(id)a0 versions:(id)a1 desiredSize:(struct CGSize { double x0; double x1; })a2 screenScale:(double)a3 itemManager:(id)a4 operationServicer:(id)a5;
