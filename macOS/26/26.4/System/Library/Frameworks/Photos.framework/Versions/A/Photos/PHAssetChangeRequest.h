...
@interface PHAssetChangeRequest : PHChangeRequest <NSSecureCoding, PHUpdateChangeRequest> {
    ...
    BOOL _deleteContextualVideoThumbnails;
    BOOL _didSetTitle;
    BOOL _didSetVisibilityState;
    BOOL _didSetSceneClassifications;
    BOOL _didSetCompactImageSCSensitivityAnalysis;
    BOOL _didSetCompactVideoSCSensitivityAnalysis;
    ...
    BOOL _didSetTextUnderstandingProperties;
    ...
    BOOL _resetTextUnderstandingProperties;
...
+ (void)deleteAssets:(id)a0 deleteOptions:(id)a1;
...
- (BOOL)_applyCompactSCSensitivityAnalysisUpdateToAsset:(id)a0 error:(id *)a1;
- (BOOL)_applySensitivityAnalysisUpdateToAsset:(id)a0 error:(id *)a1;
...
- (void)addFaces:(id)a0;
- (void)addLike:(id)a0;
- (BOOL)applyMutationsToAssetRelationshipWithKey:(id)a0 asset:(id)a1 error:(id *)a2;
...
- (void)setCompactImageSCSensitivityAnalysis:(long long)a0;
- (void)setCompactVideoSCSensitivityAnalysis:(long long)a0;
- (void)setCompactVideoSCSensitivityAnalysis:(long long)a0 videoSensitivityAnalysisVersion:(short)a1;
- (void)setContextualVideoThumbnailImage:(struct CGImage { } *)a0 withIdentifier:(id)a1;
