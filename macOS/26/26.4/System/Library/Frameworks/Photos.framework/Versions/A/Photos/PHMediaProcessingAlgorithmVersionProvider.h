...
- (id)initWithSceneAnalysisVersion:(short)a0 faceAnalysisVersion:(short)a1 characterRecognitionAlgorithmVersion:(short)a2 visualSearchAlgorithmVersion:(short)a3 stickerConfidenceAlgorithmVersion:(short)a4 vaAnalysisVersion:(short)a5 vaLocationAnalysisVersion:(short)a6 mediaAnalysisVersion:(unsigned long long)a7 mediaAnalysisImageVersion:(short)a8 captionGenerationVersion:(short)a9 imageEmbeddingVersion:(short)a10 videoEmbeddingVersion:(short)a11 videoSensitivityAnalysisVersion:(short)a12;
- (id)initWithSceneAnalysisVersion:(short)a0 faceAnalysisVersion:(short)a1 characterRecognitionAlgorithmVersion:(short)a2 visualSearchAlgorithmVersion:(short)a3 stickerConfidenceAlgorithmVersion:(short)a4 vaAnalysisVersion:(short)a5 vaLocationAnalysisVersion:(short)a6 mediaAnalysisVersion:(unsigned long long)a7 mediaAnalysisImageVersion:(short)a8 captionGenerationVersion:(short)a9 imageEmbeddingVersion:(short)a10 videoEmbeddingVersion:(short)a11 videoSensitivityAnalysisVersion:(short)a12 textUnderstandingAlgorithmVersion:(short)a13 textUnderstandingGatingVersion:(short)a14;
