@class NSURL, PHAssetPhotosSmartStyleExtendedProperties, CLLocation, NSDate, PLLazyObject, NSManagedObjectContext, NSString, NSSet, NSManagedObjectID, PHPhotoLibrary, NSArray, NSData, NSNumber, UTType, NSValue;
...
@property (readonly, nonatomic) BOOL isEligibleForSpatialGeneration;
...
@property (readonly, nonatomic) unsigned long long thumbnailIndex;
@property (readonly, nonatomic) BOOL hasLargerThanThumbResourceLocal;
...
@property (readonly, nonatomic) BOOL isCollectionShareAsset;
...
@property (readonly, nonatomic) BOOL isSpatial3DPresentation;
...
+ (id)fetchAnyCinematicVideosNeedingDeferredProcessingWithOptions:(id)a0;
+ (id)fetchAssetObjectIdsForOsMigrationWithOptions:(id)a0;
...
+ (id)fetchAssetsForCloudFeedEntry:(id)a0 options:(id)a1;
...
+ (id)fetchAssetsForOsMigrationWithOptions:(id)a0;
...
+ (id)fetchAssetsThroughAssetPersonEdgesForPerson:(id)a0 options:(id)a1;
...
+ (id)fetchAssetsWithConversationGroupIDs:(id)a0 options:(id)a1;
...
+ (id)fetchKeyAssetBySuggestionUUIDForSuggestionsOIDs:(id)a0 options:(id)a1;
...
+ (id)predicateForResourcesForOsMigrationForResourceTypes:(id)a0 assetIDs:(id)a1 includeLocalOnly:(BOOL)a2 iCPLEnabled:(BOOL)a3;
...
+ (unsigned long long)sourceTypeFromSavedAssetType:(short)a0;
...
- (BOOL)isEligibleForSpatialGenerationIncludingStereo:(BOOL)a0;
- (BOOL)isInFlight;
...
- (BOOL)needsSensitivityProtection;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })suggestedAdaptiveCropWithFaceRectScaleFactor:(double)a0 andOutputCropScore:(out double *)a1 andAdaptiveHeadroom:(out double *)a2;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })suggestedAdaptiveCropWithFaceRegionsForOutputCropScore:(out double *)a0 andAdaptiveHeadroom:(out double *)a1;
