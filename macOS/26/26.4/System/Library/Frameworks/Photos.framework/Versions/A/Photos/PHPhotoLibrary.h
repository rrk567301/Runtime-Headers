@class PHPhotoLibraryIdentifier, PAVideoConversionServiceClient, PHPersistentChangeToken, PHAnalysisCoalescer, PLPhotoKitVariationCache, PLPhotoLibraryBundle, PAImageConversionServiceClient, PLLazyObject, NSString, NSError, _TtC6Photos27PHDatabaseStatisticsTracker, PLFileSystemVolume, PLPhotoAnalysisServiceClient, NSArray, NSMutableDictionary, PLPhotoLibrary, PHPhotoLibraryChangeObserverRegistrar, PFStateCaptureHandler, PHChangeHandlingDebugger, CPLStatus, NSObject, PHPhotoLibraryAppPrivateData, PHPerformChangesRequest, PHPhotoLibraryCloudStatus, PLAssetsdClient, PLCacheMetricsCollectorClient, PLCPLSettingsObserver, PHPhotoLibraryCloudStatusObserverRegistrar, PHFetchOptions, NSURL, NSProgress, NSManagedObjectID, NSHashTable;
...
@property (readonly, nonatomic) BOOL isReadyForAnalysis_FOR_UI_USE_ONLY_NON_BLOCKING;
...
- (long long)sizeOfLocallyAvailableiCloudQuotaResourcesWithError:(id *)a0;
...
- (void)_addChangeObservers:(id)a0 authorizationStatus:(long long)a1;
- (void)_addCloudStatusObservers:(id)a0 authorizationStatus:(long long)a1;
...
- (id)_countOfMediaProcessingAssetsWithInternalPredicate:(id)a0 taskID:(unsigned long long)a1 processed:(BOOL)a2 exactVersionMatch:(BOOL)a3 versionProvider:(id)a4;
...
- (id)_errorCodeForAuthorizationStatus:(long long)a0 accessLevel:(long long)a1;
...
- (void)_processCPLStatusDidChange:(id)a0;
...
- (void)_publishCloudStatusUpdate:(id)a0;
- (double)_ratioOfAssetsAtOrAboveVersion:(short)a0 forKey:(id)a1;
- (void)_removeChangeObserver:(id)a0;
- (void)_removeCloudStatusObserver:(id)a0;
- (void)_resetCachedValues;
- (void)_resourceBytesUsedForPredicate:(id)a0 minVideoSize:(unsigned long long)a1 completion:(id /* block */)a2;
...
- (void)_validateSpotlightAvailabilityInFeatureAvailability:(id)a0 forFeature:(unsigned long long)a1 completionHandler:(id /* block */)a2;
...
- (id)cloudIdentifierMappingsForLocalIdentifiers:(id)a0 excludeUnsyncedItems:(BOOL)a1;
...
- (id)countOfAssetsByMediaTypeForMediaProcessingTaskID:(unsigned long long)a0 processed:(BOOL)a1 algorithmVersion:(id)a2 exactVersionMatch:(BOOL)a3 error:(id *)a4;
...
- (void)featureAvailabilityForFeature:(unsigned long long)a0 readOptions:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)forceSyndicationIngestAsyncToDate:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)getLibrarySizesFromDB:(BOOL)a0 error:(id *)a1;
...
- (id)ingestItemWithSpotlightUniqueIdentifier:(id)a0 bundleID:(id)a1 purgeUrgency:(long long)a2 error:(id *)a3;
...
- (BOOL)localResourceBytesUsed:(id *)a0 error:(id *)a1;
- (BOOL)localResourceBytesUsed:(id *)a0 minVideoSize:(unsigned long long)a1 error:(id *)a2;
- (void)localResourceBytesUsedForMinVideoSize:(unsigned long long)a0 completion:(id /* block */)a1;
...
- (void)registerCloudStatusObserver:(id)a0;
...
- (void)unregisterCloudStatusObserver:(id)a0;
