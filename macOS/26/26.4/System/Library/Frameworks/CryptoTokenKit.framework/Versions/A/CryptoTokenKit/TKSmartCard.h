...
- (struct { struct _NSRange { unsigned long long x0; unsigned long long x1; } x0; unsigned long long x1; BOOL x2; BOOL x3; })calculateChunkInfoForIns:(unsigned char)a0 data:(id)a1 offset:(unsigned long long)a2 chained:(BOOL)a3 isCase4:(BOOL)a4;
...
- (void)handleApduResponse:(id)a0 body:(id)a1 le:(unsigned long long)a2 isCase4:(BOOL)a3 synchronous:(BOOL)a4 error:(id)a5 reply:(id /* block */)a6;
- (BOOL)inSessionWithError:(id *)a0 executeBlock:(id /* block */)a1;
- (void)inSlotQueueExecuteBlock:(id /* block */)a0 synchronous:(BOOL)a1;
- (void)querySessionSynchronous:(BOOL)a0 reply:(id /* block */)a1;
- (void)releaseSessionWithReply:(id /* block */)a0;
- (id)remoteSessionWithErrorHandler:(id /* block */)a0 synchronous:(BOOL)a1;
...
- (void)transmitRequest:(id)a0 synchronous:(BOOL)a1 reply:(id /* block */)a2;
- (BOOL)transmitSynchronouslyChunkedIns:(unsigned char)a0 p1:(unsigned char)a1 p2:(unsigned char)a2 data:(id)a3 offset:(unsigned long long *)a4 realLe:(unsigned long long)a5 chained:(BOOL)a6 isCase4:(BOOL)a7 responseBody:(id)a8 sw:(unsigned short *)a9 error:(id *)a10;
- (void)unreserve;
...
- (BOOL)validateSendInsPreconditionsWithError:(id *)a0;
