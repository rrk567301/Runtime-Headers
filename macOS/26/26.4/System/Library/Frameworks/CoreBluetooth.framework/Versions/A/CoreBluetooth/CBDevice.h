...
- (BOOL)discoveryTypesContainTypes:(const struct { unsigned char x0[7]; } *)a0;
...
- (void)_parseProximityPairingAppleTVRemotePtr:(const char *)a0 end:(const char *)a1;
...
- (void)_parseProximityPairingPtr:(const char *)a0 end:(const char *)a1 badType:(unsigned char)a2 badLen:(unsigned char)a3;
...
- (void)_parseProximityServiceAccessorySetupPtr:(const char *)a0 end:(const char *)a1;
- (void)_parseProximityServiceData:(id)a0 dataChanged:(BOOL)a1;
- (void)_parseProximityServiceHomeKitSetupPtr:(const char *)a0 end:(const char *)a1;
- (void)_parseProximityServiceSubType:(unsigned char)a0 src:(const char *)a1 end:(const char *)a2 dataChanged:(BOOL)a3;
...
- (BOOL)changedTypesContainTypes:(const struct { unsigned char x0[7]; } *)a0;
