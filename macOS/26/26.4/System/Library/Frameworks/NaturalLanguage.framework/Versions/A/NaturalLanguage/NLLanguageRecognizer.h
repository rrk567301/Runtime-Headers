...
+ (BOOL)_isString:(id)a0 words:(id)a1 plausiblyInLanguage:(id)a2 increasedThreshold:(BOOL)a3;
...
+ (id)_selectRepresentativeChunks:(id)a0 numberOfChunks:(unsigned long long)a1;
+ (BOOL)_shouldUseIndicLatinModelForPreferredLanguages:(id)a0;
+ (id)_splitStringIntoChunks:(id)a0 maxChunkSize:(unsigned long long)a1;
...
+ (id)mostAppropriateLanguageForLongString:(id)a0 candidateLanguages:(id)a1 preferredLanguages:(id)a2 numberOfChunks:(unsigned long long)a3;
