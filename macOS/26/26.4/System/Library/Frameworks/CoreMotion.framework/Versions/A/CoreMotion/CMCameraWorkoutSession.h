...
@interface CMCameraWorkoutSession : NSObject {
    struct unique_ptr<CMCameraWorkoutLogger, std::default_delete<CMCameraWorkoutLogger>> { struct { struct CMCameraWorkoutLogger *__ptr_; } ; } _logger;
...
- (void)_feedAccessoryConfig:(const struct Config { int x0; char x1[64]; char x2[32]; int x3; BOOL x4; unsigned int x5; struct CMOQuaternion { float x0[4]; } x6; BOOL x7; struct CMOQuaternion { float x0[4]; } x8; } *)a0;
