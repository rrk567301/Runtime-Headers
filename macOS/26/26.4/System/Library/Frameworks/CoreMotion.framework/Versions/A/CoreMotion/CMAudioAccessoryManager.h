@interface CMAudioAccessoryManager : NSObject {
    id _internal;
    struct unique_ptr<CMResampleAccessoryDeviceMotion, std::default_delete<CMResampleAccessoryDeviceMotion>> { struct { struct CMResampleAccessoryDeviceMotion *__ptr_; } ; } _resampleAccessoryDeviceMotion;
}
...
- (void)onAudioAccessoryDeviceMotionConfig:(const struct Config { int x0; char x1[64]; char x2[32]; int x3; BOOL x4; unsigned int x5; struct CMOQuaternion { float x0[4]; } x6; BOOL x7; struct CMOQuaternion { float x0[4]; } x8; } *)a0;
...
- (void)onAudioAccessoryInertialOdometry:(const struct InertialOdometryReport { unsigned long long x0; float x1[3]; float x2[3]; unsigned long long x3; unsigned long long x4; unsigned long long x5[3]; unsigned long long x6; float x7[4]; float x8; unsigned char x9; float x10[3]; int x11; double x12; } *)a0;
