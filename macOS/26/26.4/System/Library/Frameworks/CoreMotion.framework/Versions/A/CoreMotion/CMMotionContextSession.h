...
@interface CMMotionContextSession : NSObject {
    ...
    struct unique_ptr<CMPdrMLModel, std::default_delete<CMPdrMLModel>> { struct { struct CMPdrMLModel *__ptr_; } ; } hmlModel;
    BOOL _enableMLModel;
    struct unique_ptr<CMMotionContextSessionAnalyticsTracker, std::default_delete<CMMotionContextSessionAnalyticsTracker>> { struct { struct CMMotionContextSessionAnalyticsTracker *__ptr_; } ; } _analyticsTracker;
...
- (void)feedAccessoryConfig:(const struct Config { int x0; char x1[64]; char x2[32]; int x3; BOOL x4; unsigned int x5; struct CMOQuaternion { float x0[4]; } x6; BOOL x7; struct CMOQuaternion { float x0[4]; } x8; } *)a0;
