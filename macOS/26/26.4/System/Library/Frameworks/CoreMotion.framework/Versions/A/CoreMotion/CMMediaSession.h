...
@interface CMMediaSession : NSObject <CMDistributedSensingDelegate> {
    struct unique_ptr<CMHeadTrackingService, std::default_delete<CMHeadTrackingService>> { struct { struct CMHeadTrackingService *__ptr_; } ; } _headTrackingService;
    ...
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct { struct Dispatcher *__ptr_; } ; } _accessoryDeviceMotionInEarStatusDispatcher;
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct { struct Dispatcher *__ptr_; } ; } _accessoryMonitorDispatcher;
    ...
    struct unique_ptr<CMMediaSessionAnalyticsTracker, std::default_delete<CMMediaSessionAnalyticsTracker>> { struct { struct CMMediaSessionAnalyticsTracker *__ptr_; } ; } _analyticsTracker;
    ...
    struct unique_ptr<CMSpatialLogger, std::default_delete<CMSpatialLogger>> { struct { struct CMSpatialLogger *__ptr_; } ; } _logger;
    int _inEarStatus;
...
- (BOOL)shouldHeadTrackWithInEarStatus:(int)a0;
...
- (struct AudioAccessorySample { struct { struct CMOQuaternion { float x0[4]; } x0; struct CMVector<float, 3UL> { float x0[3]; } x1; struct CMVector<float, 3UL> { float x0[3]; } x2; struct CMVector<float, 3UL> { float x0[3]; } x3; struct Status { unsigned short x0; } x4; } x0; unsigned long long x1; double x2; double x3; struct CMVector<float, 3UL> { float x0[3]; } x4; float x5; int x6; unsigned int x7; int x8; int x9; unsigned long long x10; double x11; float x12[3]; BOOL x13; unsigned char x14; BOOL x15; BOOL x16; double x17; double x18; BOOL x19; BOOL x20; unsigned int x21; })_getLastAudioAccessorySample;
