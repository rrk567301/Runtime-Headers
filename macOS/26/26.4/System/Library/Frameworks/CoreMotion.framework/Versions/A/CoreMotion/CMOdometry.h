...
- (void)dealloc;
- (id)initWithDeltaPositionX:(id)a0 deltaPositionY:(id)a1 deltaPositionZ:(id)a2 deltaVelocityX:(id)a3 deltaVelocityY:(id)a4 deltaVelocityZ:(id)a5 quaternionX:(id)a6 quaternionY:(id)a7 quaternionZ:(id)a8 quaternionW:(id)a9 rotationArbitraryToTrueNorth:(float)a10 staticFlag:(long long)a11 deltaPositionUncertaintyX:(id)a12 deltaPositionUncertaintyY:(id)a13 deltaPositionUncertaintyZ:(id)a14 deviceLocation:(long long)a15 timestamp:(double)a16;
- (id)initWithDeltaPositionX:(id)a0 deltaPositionY:(id)a1 deltaPositionZ:(id)a2 deltaVelocityX:(id)a3 deltaVelocityY:(id)a4 deltaVelocityZ:(id)a5 quaternionX:(id)a6 quaternionY:(id)a7 quaternionZ:(id)a8 quaternionW:(id)a9 rotationArbitraryToTrueNorth:(float)a10 staticFlag:(long long)a11 isDOTBiasChangePossible:(BOOL)a12 isMounted:(BOOL)a13 isZUPT:(BOOL)a14 deltaPositionUncertaintyX:(id)a15 deltaPositionUncertaintyY:(id)a16 deltaPositionUncertaintyZ:(id)a17 deviceLocation:(long long)a18 timestamp:(double)a19;
