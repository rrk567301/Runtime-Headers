@class NSString, _LTLanguageStatus, _LTSupportedLocaleList, _LTPreflightChecker;
...
- (void)_installationStatusWithCompletion:(id /* block */)a0;
- (void)_localesRequiringAppleIntelligenceWithCompletion:(id /* block */)a0;
- (void)_supportedLocaleListWithCompletion:(id /* block */)a0;
- (void)_supportedLocalePairsWithCompletion:(id /* block */)a0;
- (id)_uniqueLocalesFromSupportedPairs:(id)a0;
- (void)currentLanguageStatusSnapshotWithLocaleList:(id)a0 completion:(id /* block */)a1;
- (id)initWithPreferredStrategy:(long long)a0;
- (BOOL)isTranslationSupportedOnCurrentDeviceForPreflightChecker:(id)a0;
- (void)localeProviderSupportedLocaleListWithCompletion:(id /* block */)a0;
