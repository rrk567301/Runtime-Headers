...
+ (void)languagesForText:(id)a0 usingModel:(unsigned long long)a1 strategy:(unsigned long long)a2 taskHint:(long long)a3 useDedicatedTextMachPort:(BOOL)a4 completion:(id /* block */)a5;
