...
@property (readonly, nonatomic) BOOL isHeadless;
...
- (id)initWithSourceLocale:(id)a0 targetLocale:(id)a1 preferredStrategy:(long long)a2 isHeadless:(BOOL)a3;
...
- (id)initWithSourceLocale:(id)a0 targetLocale:(id)a1 preferredStrategy:(long long)a2;
...
- (void)translateAttributedString:(id)a0 completionHandler:(id /* block */)a1;
