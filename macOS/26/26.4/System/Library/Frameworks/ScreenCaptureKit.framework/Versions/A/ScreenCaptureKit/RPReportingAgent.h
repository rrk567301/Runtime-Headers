...
@property (nonatomic) long long mixedRealityCameraEnabled;
@property (nonatomic) BOOL audioOnlyRecording;
@property (nonatomic) long long saveDestinationType;
@property (nonatomic) BOOL usesCustomSaveDirectory;
...
+ (void)reportSettingsUIEventWithAction:(long long)a0;
