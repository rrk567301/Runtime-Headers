@class MTLRenderPassDescriptor, NSString, CAMetalLayer, MTKOffscreenDrawable, NSMutableArray, MTL4RenderPassDescriptor, NSObject;
@protocol MTKViewDelegate, MTLDevice, MTLResidencySet, MTLTexture, OS_dispatch_source, CAMetalDrawable;
...
- (void)_replaceResidencySetEntryForOriginalTexture:(id)a0 newTexture:(id)a1;
