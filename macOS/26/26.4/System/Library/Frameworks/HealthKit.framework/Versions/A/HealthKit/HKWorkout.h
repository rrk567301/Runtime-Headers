...
@property (copy, nonatomic, getter=_workoutZonesByType, setter=_setWorkoutZonesByType:) NSDictionary *workoutZonesByType;
...
+ (id)_workoutWithActivityType:(unsigned long long)a0 startDate:(id)a1 endDate:(id)a2 duration:(double)a3 totalEnergyBurned:(id)a4 totalDistance:(id)a5;
+ (id)_workoutWithActivityType:(unsigned long long)a0 startDate:(id)a1 endDate:(id)a2 duration:(double)a3 totalEnergyBurned:(id)a4 totalDistance:(id)a5 metadata:(id)a6;
+ (id)_workoutWithActivityType:(unsigned long long)a0 startDate:(id)a1 endDate:(id)a2 workoutEvents:(id)a3;
