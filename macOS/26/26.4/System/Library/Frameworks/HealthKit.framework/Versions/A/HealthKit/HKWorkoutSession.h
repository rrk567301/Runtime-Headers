@class HKWorkoutSessionTaskConfiguration, HKWorkoutMirroringDataUpdate, NSDate, HKWorkoutActivity, NSObject, HKStateMachine, HKHealthStore, HKTaskServerProxyProvider, NSMutableArray, NSString, NSSet, HKWorkoutConfiguration, NSArray, HKLiveWorkoutBuilder, NSError, NSUUID;
...
- (void)client_didUpdateGeneratedTypes:(id)a0;
...
- (void)_queue_dataSentToRemoteWithSuccess:(BOOL)a0 uuid:(id)a1 error:(id)a2;
- (void)_queue_enqueueStateEvent:(long long)a0 date:(id)a1 completion:(id /* block */)a2;
- (void)_queue_handleSendDataToRemoteWorkoutSession_proxyError:(id)a0 uuid:(id)a1;
...
- (void)_runSetupPostClientMirroringStartHandlerWithCompletion:(id /* block */)a0;
