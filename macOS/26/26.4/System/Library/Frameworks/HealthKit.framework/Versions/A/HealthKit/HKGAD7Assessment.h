...
@interface HKGAD7Assessment : HKScoredAssessment <HKAssociatableObject, _HKScoredRiskAssessment>
...
- (BOOL)acceptsAssociationWithObject:(id)a0 associationType:(unsigned long long)a1;
