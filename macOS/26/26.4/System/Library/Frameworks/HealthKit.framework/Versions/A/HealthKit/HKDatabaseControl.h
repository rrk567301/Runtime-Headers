...
- (void)generateDemoDataWithDurationInDays:(long long)a0 includeToday:(BOOL)a1 seed:(id)a2 completion:(id /* block */)a3;
...
- (void)showDatabaseShapeWithConfiguration:(int)a0 completion:(id /* block */)a1;
