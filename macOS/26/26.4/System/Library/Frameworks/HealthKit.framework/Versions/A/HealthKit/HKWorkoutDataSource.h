...
+ (id)_cyclingTypesForActivityType:(unsigned long long)a0 isAppleWatch:(BOOL)a1 connectedToFitnessMachine:(BOOL)a2;
+ (id)_distanceTypeForActivityType:(unsigned long long)a0 isIndoor:(BOOL)a1 connectedToFitnessMachine:(BOOL)a2 isAppleWatch:(BOOL)a3;
...
+ (BOOL)_shouldCollectCyclingTypesForActivityType:(unsigned long long)a0 isAppleWatch:(BOOL)a1 connectedToFitnessMachine:(BOOL)a2;
+ (BOOL)_shouldCollectDistanceForActivityType:(unsigned long long)a0 isIndoor:(BOOL)a1 connectedToFitnessMachine:(BOOL)a2 isAppleWatch:(BOOL)a3;
