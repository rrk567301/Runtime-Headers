@class NSString, HKProxyProvider, NSMutableDictionary;
...
- (id)_lock_observersForBundleIdentifier:(id)a0;
- (void)_lock_setObserversForBundleIdentifier:(id)a0 observers:(id)a1;
- (void)_registerRemoteObserverForBundleIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)addObserver:(id)a0 bundleIdentifier:(id)a1;
- (void)addObserver:(id)a0 bundleIdentifier:(id)a1 completion:(id /* block */)a2;
- (void)clientRemote_authorizationDidUpdateForBundleIdentifier:(id)a0 authorizationRecords:(id)a1;
