@class NSUUID, NSString, NSLock, HKTaskServerProxyProvider, HKHealthStore, _HKCurrentWorkoutSnapshot, NSMutableArray, _HKWorkoutObserverConfiguration;
...
@property (readonly, nonatomic) BOOL reportInactiveSessions;
...
- (void)getPairedWatchWorkoutState:(id /* block */)a0;
- (void)dealloc;
...
- (id)initWithHealthStore:(id)a0 reportInactiveSessions:(BOOL)a1;
