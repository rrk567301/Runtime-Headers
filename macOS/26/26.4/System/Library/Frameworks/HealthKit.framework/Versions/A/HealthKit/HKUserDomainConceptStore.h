...
- (id)init;
- (void)_clientQueue_notifyForChangesToUserDomainConcepts:(id)a0 changeType:(long long)a1 maxAnchor:(long long)a2;
...
- (void)client_notifyForChangesToUserDomainConcepts:(id)a0 changeType:(long long)a1 maxAnchor:(long long)a2;
