...
- (void)getPNRSupportStatus:(id)a0 completion:(id /* block */)a1;
...
- (BOOL)addParticipants:(id)a0 toGroupChat:(id)a1 withParticipantsToAdd:(id)a2 withOperationID:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)changeIcon:(id)a0 forGroupChat:(id)a1 withNewIcon:(id)a2 withOperationID:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)changeSubject:(id)a0 forGroupChat:(id)a1 withNewSubject:(id)a2 withOperationID:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
- (id)checkBasebandConfigUpdateInfo:(id *)a0;
...
- (void)checkRadioBootHealthDetails:(id /* block */)a0;
...
- (id)copyRequiresResiliency:(id)a0 outError:(id *)a1;
...
- (void)getActiveSlicesInfo:(id /* block */)a0;
...
- (id)getCachedCapabilities:(id)a0 forDestination:(id)a1 withError:(id *)a2;
...
- (void)getEuiccPairingIdentifier:(id /* block */)a0;
...
- (void)getPNRPriorityRegistrationListWithCompletion:(id /* block */)a0;
- (id)getPNRPriorityRegistrationListWithError:(id *)a0;
- (id)getPNRSupportStatus:(id)a0 outError:(id *)a1;
...
- (void)getProfileSizeInfoWithCompletion:(id /* block */)a0;
- (void)getProfileSizeInformationWithCompletion:(id /* block */)a0;
...
- (void)getRegulatedRatsSwitchEnabled:(id)a0 completion:(id /* block */)a1;
- (BOOL)getRegulatedRatsSwitchEnabledSync:(id)a0 error:(id *)a1;
- (void)getRegulatedRatsUserPreference:(id)a0 completion:(id /* block */)a1;
- (BOOL)getRegulatedRatsUserPreferenceSync:(id)a0 error:(id *)a1;
...
- (void)getSlicingCapability:(id /* block */)a0;
...
- (id)getSupportsTARandomization:(id)a0 error:(id *)a1;
- (id)getSystemConfiguration:(id)a0 withError:(id *)a1;
- (id)getTARandomizationSetting:(id)a0 error:(id *)a1;
...
- (id)isSharingIdentitySupportedWithError:(id *)a0;
...
- (BOOL)removeParticipants:(id)a0 fromGroupChat:(id)a1 withParticipantsToRemove:(id)a2 withOperationID:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)requestBootstrapDataService:(unsigned long long)a0 completion:(id *)a1;
...
- (BOOL)sendComposingIndicator:(id)a0 to:(id)a1 messageID:(id)a2 indication:(id)a3 withSecurity:(id)a4 error:(id *)a5;
...
- (BOOL)sendComposingIndicator:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withIndication:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)sendDispositionNotificationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withDisposition:(long long)a3 forMessageID:(id)a4 withSecurity:(id)a5 withError:(id *)a6;
- (BOOL)sendFileTransferMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withFileInformation:(id)a3 withError:(id *)a4;
- (BOOL)sendFileTransferMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withFileInformation:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)sendFileTransferMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withFileInformation:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
- (BOOL)sendGeolocationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withError:(id *)a4;
- (BOOL)sendGeolocationMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
- (BOOL)sendGeolocationMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withError:(id *)a4;
- (BOOL)sendGeolocationMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withGeoPush:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)sendGroupDispositionNotificationMessage:(id)a0 toGroup:(id)a1 to:(id)a2 withMessageID:(id)a3 withDisposition:(long long)a4 forMessageID:(id)a5 withSecurity:(id)a6 withError:(id *)a7;
...
- (BOOL)sendTextMessage:(id)a0 to:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
- (BOOL)sendTextMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withError:(id *)a4;
- (BOOL)sendTextMessage:(id)a0 toGroupDestination:(id)a1 withMessageID:(id)a2 withMessage:(id)a3 withSecurity:(id)a4 withError:(id *)a5;
...
- (BOOL)setLazuliEncryption:(id)a0 enabled:(BOOL)a1 withError:(id *)a2;
...
- (void)setPreferredSlice:(id)a0 completion:(id /* block */)a1;
...
- (void)setRegulatedRatsUserPreference:(id)a0 enable:(BOOL)a1 completion:(id /* block */)a2;
- (id)setReliableNetworkFallback:(id)a0 enable:(BOOL)a1;
- (void)setRemotePolicies:(id)a0 completion:(id /* block */)a1;
- (void)setSatelliteAppCategories:(id)a0 appCategories:(id)a1 completion:(id /* block */)a2;
...
- (id)setTARandomizationUserSetting:(id)a0 enabled:(BOOL)a1;
- (void)setTestBundleIdForSlice:(id)a0 completion:(id /* block */)a1;
...
- (void)startSharingIdentity:(id /* block */)a0;
- (void)stopSharingIdentity;
- (BOOL)supportsCellular;
- (BOOL)supportsEmbeddedSIM;
- (id)supportsLimitedUseSIMsWithError:(id *)a0;
...
- (void)updateAvsTrafficStatus:(int)a0 dataType:(int)a1 completion:(id /* block */)a2;
- (BOOL)updateGeofenceProfile:(id)a0;
- (void)updateIdsTrafficStatus:(BOOL)a0 dataType:(int)a1 completion:(id /* block */)a2;
- (id)updatePrivateNetworkProfile:(id)a0 setProfileAside:(BOOL)a1;
- (void)updateVoipCallTrafficStatus:(BOOL)a0 completion:(id /* block */)a1;
