@class NSView, NSString, MKMapView, NSClickGestureRecognizer, NSCursor, NSPanGestureRecognizer, CALayer, MKModernControlAppearanceHelper, NSObject, CAShapeLayer;
