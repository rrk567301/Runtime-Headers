...
@interface MKMapView : NSView <MKMapViewRouteContextUpdates, MKMouseOverLabelRecognizerDelegate, MKMouseOverLabelTarget, NSScrollViewSeparatorTrackingAdapter, MKOverlayContainerViewDelegate, MKMapGestureControllerDelegate, NSGestureRecognizerDelegate, MKLocationManagerObserver, VKMapViewDelegate, VKMapViewCameraDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, MKRotationFilterDelegate, GEOConfigChangeListenerDelegate, CALayerDelegate, GEOResourceManifestTileGroupObserver, MKAnnotationContainerViewDelegate, NSCoding> {
    ...
    BOOL _registeredAsScrollViewSeparatorTrackingAdapter;
}
...
@property (nonatomic, getter=_cartographicConfiguration, setter=_setCartographicConfiguration:) struct { long long style; long long emphasis; long long projection; long long terrainMode; long long mapkitUsage; long long mapkitClientMode; BOOL gridOnly; } cartographicConfiguration;
...
@property (nonatomic, getter=_showsLabels, setter=_setShowsLabels:) BOOL showsLabels;
@property (nonatomic, getter=_showsContourLabels, setter=_setShowsCountourLabels:) BOOL showsContourLabels;
@property (nonatomic, getter=_showsPhysicalFeatureLabels, setter=_setShowsPhysicalFeatureLabels:) BOOL showsPhysicalFeatureLabels;
...
@property (readonly, nonatomic) BOOL shouldShowExternalCompass;
...
@property (nonatomic, getter=_labelEdgeInsets, setter=_setLabelEdgeInsets:) struct NSEdgeInsets { double top; double left; double bottom; double right; } labelEdgeInsets;
@property (nonatomic, getter=_labelEdgeWidths, setter=_setLabelEdgeWidths:) struct NSEdgeInsets { double top; double left; double bottom; double right; } labelEdgeWidths;
...
- (id)_pocketForEdge:(long long)a0 makeIfNeeded:(BOOL)a1;
...
- (void)_updateIncreasedContrastSetting;
...
- (id)_createPocketForEdge:(long long)a0;
...
- (struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })_mapDisplayStyle;
...
- (BOOL)_needsPocketForEdge:(long long)a0;
...
- (void)_removePocketForEdge:(long long)a0;
...
- (void)_setCartographicConfiguration:(struct { long long x0; long long x1; long long x2; long long x3; long long x4; long long x5; BOOL x6; })a0 animated:(BOOL)a1;
- (void)_setCartographicConfiguration:(struct { long long x0; long long x1; long long x2; long long x3; long long x4; long long x5; BOOL x6; })a0 onInit:(BOOL)a1 animated:(BOOL)a2;
...
- (void)_setPitchButtonVisible:(BOOL)a0 animationAllowed:(BOOL)a1;
...
- (void)_setTrackingButtonVisible:(BOOL)a0 animationAllowed:(BOOL)a1;
...
- (BOOL)canPossiblyShowCompassForInternalControl:(BOOL)a0;
...
- (void)setShowsLiveEVData:(BOOL)a0;
