@class NSView, NSClickGestureRecognizer, NSString, MKMapView, CALayer, NSPanGestureRecognizer, NSCursor, MKModernControlAppearanceHelper, NSImage, NSArray, NSNumber;
