...
- (void)_processSearchTokens:(struct vector<Token, std::allocator<Token>> { struct Token *x0; struct Token *x1; struct { struct Token *x0; } x2; })a0 visited:(void *)a1 usingBlock:(id /* block */)a2 stopPointer:(BOOL *)a3;
