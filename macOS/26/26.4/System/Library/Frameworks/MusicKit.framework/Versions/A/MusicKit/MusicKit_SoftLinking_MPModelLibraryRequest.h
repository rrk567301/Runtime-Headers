...
- (id)initWithLegacyModelObject:(id)a0 itemType:(long long)a1 properties:(id)a2 relationships:(id)a3 filteringOptions:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; })a4 mediaLibrary:(id)a5;
- (id)initWithLegacyModelObjectType:(long long)a0 itemKind:(id)a1 allowedItemIdentifiers:(id)a2 allowedItemIdentifierSets:(id)a3 itemSortDescriptors:(id)a4 itemFilterText:(id)a5 itemPropertyFilters:(id)a6 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a7 filteringOptions:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; })a8 mediaLibrary:(id)a9;
- (id)initWithLegacyModelObjectType:(long long)a0 sectionLegacyModelObjectType:(long long)a1 itemKind:(id)a2 sectionKind:(id)a3 allowedItemIdentifiers:(id)a4 allowedSectionIdentifiers:(id)a5 allowedItemIdentifierSets:(id)a6 allowedSectionIdentifierSets:(id)a7 scopedContainers:(id)a8 itemSortDescriptors:(id)a9 sectionSortDescriptors:(id)a10 itemFilterText:(id)a11 sectionFilterText:(id)a12 itemPropertyFilters:(id)a13 sectionPropertyFilters:(id)a14 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a15 filteringOptions:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; })a16 mediaLibrary:(id)a17;
