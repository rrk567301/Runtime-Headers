...
- (void)setLibrarySoftLinkingFilteringOptions:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; })a0 forUnderlyingRequest:(id)a1;
