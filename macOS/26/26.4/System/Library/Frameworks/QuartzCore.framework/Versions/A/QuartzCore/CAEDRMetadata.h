@interface CAEDRMetadata : NSObject <NSCopying, NSSecureCoding> {
    struct _CAEDRMetadataPrivate { struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x0; struct { unsigned short x0; unsigned short x1; } x1; id x2; id x3; BOOL x4; float x5; } *_priv;
}
...
+ (id)HDR10PlusMetadataWithDisplayInfo:(id)a0 contentInfo:(id)a1 plusMetadata:(id)a2 opticalOutputScale:(float)a3;
...
- (id)initWithSEIMasteringDisplayData:(id)a0 contentLightLevelData:(id)a1 plusMetadata:(id)a2 opticalOutputScale:(float)a3;
