...
@property (nonatomic) BOOL prefersHDRRenderingIsCached;
@property (nonatomic) BOOL prefersHDRRenderingValue;
@property (nonatomic) int maxOrder;
@property (readonly, nonatomic) BOOL prefersHDRRendering;
...
- (struct vector<TSTCellBorder *, std::allocator<TSTCellBorder *>> { id *x0; id *x1; struct { id *x0; } x2; })accumulateCellBordersConcurrentlyInRow:(struct TSUModelRowIndex { unsigned int x0; })a0 atColumns:(void *)a1;
...
- (BOOL)p_prefersHDRRenderingInStrokeArray:(id)a0;
