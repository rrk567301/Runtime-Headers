...
@property (readonly, nonatomic) BOOL supportsHDRRendering;
...
- (void).cxx_destruct;
- (void)dealloc;
- (id)initWithSurface:(id)a0 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 contentsScale:(double)a3 supportsHDRRendering:(BOOL)a4 destinationColorSpaceOverride:(struct CGColorSpace { } *)a5 metalDeviceOverride:(id)a6;
