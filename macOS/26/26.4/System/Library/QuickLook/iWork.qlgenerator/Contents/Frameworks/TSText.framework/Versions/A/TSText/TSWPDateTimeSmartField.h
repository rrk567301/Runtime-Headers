...
@property (nonatomic) BOOL incrementsDateByYear;
@property (nonatomic) int customFormat;
@property (readonly, nonatomic) BOOL usesDesignOnlyFeatures;

+ (id)dateStringFromTime:(double)a0 withFormat:(id)a1 localeIdentifier:(id)a2 dateStyle:(long long)a3 timeStyle:(long long)a4;
+ (id)dateStringFromTime:(double)a0 withFormat:(id)a1 localeIdentifier:(id)a2 dateStyle:(long long)a3 timeStyle:(long long)a4 yearOnlyDateString:(BOOL)a5;
