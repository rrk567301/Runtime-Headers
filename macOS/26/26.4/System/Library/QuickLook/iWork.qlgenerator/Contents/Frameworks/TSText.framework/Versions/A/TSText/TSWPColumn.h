...
+ (unsigned long long)charCountOfGlyphStartingAtCharIndex:(unsigned long long)a0 withColumns:(id)a1;
+ (unsigned long long)charIndexForPoint:(struct CGPoint { double x0; double x1; })a0 inColumnsArray:(id)a1 hitTestMode:(int)a2 isAtEndOfLine:(BOOL *)a3 leadingEdge:(BOOL *)a4;
+ (unsigned long long)charIndexForPointWithPinning:(struct CGPoint { double x0; double x1; })a0 inLayoutTarget:(id)a1;
+ (unsigned long long)charIndexForPointWithPinning:(struct CGPoint { double x0; double x1; })a0 isTail:(BOOL)a1 selectionType:(long long)a2 inLayoutTarget:(id)a3;
+ (unsigned long long)charIndexFromPoint:(struct CGPoint { double x0; double x1; })a0 hitTestMode:(int)a1 isAtEndOfLine:(BOOL *)a2 leadingEdge:(BOOL *)a3 inLayoutTarget:(id)a4;
...
+ (unsigned int)fontTraitsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withColumns:(id)a1 includingLabel:(BOOL)a2;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frameBoundsOfColumns:(id)a0;
+ (unsigned long long)glyphCountForRubyFieldAtCharIndex:(unsigned long long)a0 withColumns:(id)a1;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })glyphRectForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withColumns:(id)a1 includingLabel:(BOOL)a2;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })glyphRectForRubyFieldAtCharIndex:(unsigned long long)a0 withColumns:(id)a1 glyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
...
- (BOOL)hasPartitionedAttachmentContinuationAt:(int)a0;
...
- (id)rectsForSelectionRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 selectionType:(long long)a1 forParagraphMode:(BOOL)a2 includeRuby:(BOOL)a3 includePaginatedAttachments:(BOOL)a4;
...
- (unsigned long long)charIndexFromPoint:(struct CGPoint { double x0; double x1; })a0 hitTestMode:(int)a1 isAtEndOfLine:(BOOL *)a2 leadingEdge:(BOOL *)a3;
- (unsigned long long)charIndexFromPoint:(struct CGPoint { double x0; double x1; })a0 hitTestMode:(int)a1 isAtEndOfLine:(BOOL *)a2 outFragment:(const struct TSWPLineFragment **)a3 leadingEdge:(BOOL *)a4;
- (unsigned long long)charIndexFromWPPoint:(struct CGPoint { double x0; double x1; })a0 hitTestMode:(int)a1 outFragment:(const struct TSWPLineFragment **)a2 leadingEdge:(BOOL *)a3;
- (void)enumerateParagraphAdornmentsUsingBlock:(id /* block */)a0;
- (id)glyphRectsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includingLabel:(BOOL)a1;
...
- (id)pMutableRectsForSelectionRanges:(id)a0 selectionType:(long long)a1 includeSpaceAfter:(BOOL)a2 includeSpaceBefore:(BOOL)a3 includeLeading:(BOOL)a4 forParagraphMode:(BOOL)a5 includeRuby:(BOOL)a6 includePaginatedAttachments:(BOOL)a7 outranges:(id *)a8;
...
- (id)p_glyphRectsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 includingLabel:(BOOL)a1;
...
- (id)rectsForSelectionRanges:(id)a0 selectionType:(long long)a1 forParagraphMode:(BOOL)a2 includeRuby:(BOOL)a3 includePaginatedAttachments:(BOOL)a4;
