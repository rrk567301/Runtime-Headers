...
- (id)staticRevealAnimationForDuration:(double)a0;
- (id)textureWithColor:(id)a0 frame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (id)textureWithLayerImage:(id)a0;
