...
- (struct CGImage { } *)newPosterFrameWithSize:(struct CGSize { double x0; double x1; })a0 wantsHDR:(BOOL)a1;
- (struct CGSize { double x0; double x1; })p_adjustedPosterFrameSize:(struct CGSize { double x0; double x1; })a0;
- (struct CGImage { } *)p_newPosterFrameWithWidth:(double)a0 height:(double)a1 wantsHDR:(BOOL)a2;
