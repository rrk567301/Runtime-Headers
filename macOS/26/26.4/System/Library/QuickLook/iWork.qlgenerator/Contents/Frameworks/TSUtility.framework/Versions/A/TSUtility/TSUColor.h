...
@property (class, readonly, nonatomic) double hdrEnabledMaximumLinearExposure;
@property (class, readonly, nonatomic) double hdrDisabledMaximumLinearExposure;
...
- (void)getRGBComponentsForArchiving:(double *)a0;
- (id)initFromUnarchivingSDRRed:(double)a0 green:(double)a1 blue:(double)a2 alpha:(double)a3 headroom:(double)a4 targetRGBSpace:(unsigned long long)a5;
