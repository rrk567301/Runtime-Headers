@class TSWPShapeStyle, TSWPParagraphStyle, , __end_, TSTTableStyle, TSTCellStyle;
...
@interface TSTTableStyleNetwork : TSPObject <TSTStyleProviding> {
    ...
    struct vector<TSTCellStyle *, std::allocator<TSTCellStyle *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _cellStyles;
    struct vector<TSWPParagraphStyle *, std::allocator<TSWPParagraphStyle *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _textStyles;
}
