...
@property (readonly, nonatomic) BOOL isNonSpillRangeExpression;
@property (readonly, nonatomic) BOOL isAnyRangeExpression;
...
@property (nonatomic) BOOL spillRangeSuffix;
...
- (id)initWithTableInfo:(id)a0 rowIndex:(unsigned int)a1 columnIndex:(unsigned short)a2 targetCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a3;
