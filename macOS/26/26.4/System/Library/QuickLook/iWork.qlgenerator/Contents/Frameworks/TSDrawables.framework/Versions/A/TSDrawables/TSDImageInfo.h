@class NSDate, NSObject, TSDMediaStyle, NSString, NSSet, TSPData, TSUBezierPath, TSDInfoGeometry, TSDMaskInfo, NSArray, TSPObject, TSDImageDataHelper, TSDImageAdjustments, NSUUID;
@protocol TSDInfo, TSDOwningAttachment;

@interface TSDImageInfo : TSDMediaInfo <TSDReducibleImageContainer, TSDContainerInfo, TSDMixing, TSSPresetSource, TSKTransformableObject, TSDCompatibilityAwareMediaContainer, TSDAttachmentAwareContainerInfo, TSDSmartCropInfo, TSKit.TSKWatermarkableAssetMetadataProviding> {
...
@property (readonly, nonatomic) BOOL allowsImageGeneration;
