...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })groupUidsGivenUids:(const void *)a0 selectedLevels:(const void *)a1 forDimension:(long long)a2;
- (BOOL)hasValidInfo;
- (BOOL)hasValidUidMap;
...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })orderedUidsForDimension:(long long)a0;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })orderedUidsFromUids:(const void *)a0 forDimension:(long long)a1;
