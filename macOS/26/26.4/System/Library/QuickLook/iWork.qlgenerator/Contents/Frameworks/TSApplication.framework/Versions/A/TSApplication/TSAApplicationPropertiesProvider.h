...
@property (readonly, nonatomic) BOOL supportsWarmStart;
@property (readonly, nonatomic) BOOL supportsGenNotes;
@property (readonly, nonatomic) BOOL fixWPKindsForTOCObjects;
