...
@property (class, readonly, nonatomic) BOOL defaultTieredNumber;
...
- (id)boxedLabelIndentForLevel:(unsigned long long)a0;
- (float)floatValueForProperty:(int)a0 atIndex:(unsigned long long)a1;
- (id)geometryForLevel:(unsigned long long)a0;
...
- (id)rawTextIndentForLevel:(unsigned long long)a0;
