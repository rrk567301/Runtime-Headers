...
+ (void)applyHDRHeadroomFromFill:(id)a0 toContext:(struct CGContext { } *)a1;
...
+ (struct CGImage { } *)newImageFromFills:(id)a0 size:(struct CGSize { double x0; double x1; })a1 spaceBetween:(struct CGSize { double x0; double x1; })a2 scale:(double)a3 borderColor:(id)a4 outFillRects:(struct CGRect **)a5 supportsHDR:(BOOL)a6;
