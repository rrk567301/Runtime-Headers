...
@protocol TSKDocumentImporter, TSAImportDelegate, NSFilePresenter, TSADocumentPassphraseProvider, OS_dispatch_queue;
...
@property (readonly, nonatomic) BOOL shouldSaveDocumentPreviewImage;
