...
@interface TSDImager : NSObject <TSDDynamicOverridingCanvasDelegate, TSDCanvasDelegate> {
    ...
    BOOL mIsUserSubscribed;
    BOOL mWillBeCalledSafelyOutsideOfReadLock;
}
...
@property (nonatomic) BOOL shouldAnalyzeHDRContentHeadroom;
@property (readonly, nonatomic) BOOL previousRenderTonemappedHDRContentToSDR;
...
@property (nonatomic) BOOL verticalTextAllowed;
@property (nonatomic) BOOL prefersThumbnailImagesToRender;
...
- (BOOL)prefersThumbnailImagesToRenderForCanvas:(id)a0;
...
- (void)i_setRenderHDRContent:(BOOL)a0;
- (id)initWithDocumentRoot:(id)a0 renderForWideGamut:(BOOL)a1;
- (id)initWithDocumentRoot:(id)a0 renderForWideGamut:(BOOL)a1 renderHDRContent:(BOOL)a2 willBeCalledSafelyOutsideOfReadLock:(BOOL)a3;
- (id)initWithDocumentRoot:(id)a0 renderForWideGamut:(BOOL)a1 willBeCalledSafelyOutsideOfReadLock:(BOOL)a2;
