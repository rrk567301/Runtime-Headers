...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })groupUidsGivenRowUids:(const void *)a0 selectedLevels:(const void *)a1;
- (BOOL)hasValidInfo;
- (BOOL)hasValidUidMap;
