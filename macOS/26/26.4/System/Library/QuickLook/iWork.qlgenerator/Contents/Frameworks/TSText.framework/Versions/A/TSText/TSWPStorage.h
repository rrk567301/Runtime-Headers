...
@interface TSWPStorage : TSPObject <TSDDrawableContainerInfo, TSKPencilAnnotationContainer, TSKTransformableObject, TSWPStyleProvider, TSWPStorageParent, TSSStyleClient, TSWPTextSource, TSPCopying> {
    ...
    unsigned char _isIngestingWTAttributedString : 1;
...
@property (nonatomic, getter=isIngestingWTAttributedString) BOOL ingestingWTAttributedString;
...
- (void)enumerateChangesInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 usingBlock:(id /* block */)a1;
...
- (id)filteredStorageForWritingToolsWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 expandRangeToParagraphBoundaries:(BOOL)a1;
...
- (unsigned long long)listLabelTypeAtCharIndex:(unsigned long long)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_calcEffectiveRangeAtCharIndex:(unsigned long long)a0 property:(int)a1 charStyleRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 parStyleRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 parStyle:(id)a4 value:(id)a5;
- (BOOL)p_canTransferBookmark:(id)a0;
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; struct { unsigned long long *x0; } x2; })p_charIndicesForString:(id)a0 breakingCharacterSet:(id)a1;
...
- (id)valueForProperty:(int)a0 atCharIndex:(unsigned long long)a1 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2 styleEffectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a3;
