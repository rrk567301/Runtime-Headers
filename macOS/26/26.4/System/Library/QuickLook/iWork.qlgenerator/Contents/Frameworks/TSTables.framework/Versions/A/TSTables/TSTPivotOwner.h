...
@interface TSTPivotOwner : TSPObject <TSCEFormulaOwning, TSCETableNameChangeProtocol> {
    ...
    struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct { struct TSKUIDStruct *__cap_; } ; } _sortedColumnUids;
    struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct { struct TSKUIDStruct *__cap_; } ; } _sortedRowUids;
...
@property (readonly, nonatomic) struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct { struct TSKUIDStruct *__cap_; } ; } pivotRowUIDs;
@property (readonly, nonatomic) struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct { struct TSKUIDStruct *__cap_; } ; } pivotColumnUIDs;
...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })p_sortColumnsInMode:(unsigned long long)a0 sortDirection:(int)a1 rowIndex:(unsigned int)a2 level:(unsigned char)a3 aggregateIndex:(unsigned long long)a4 resetLabels:(BOOL *)a5;
- (void)p_sortFullTable:(unsigned long long)a0;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })p_sortRowsInMode:(unsigned long long)a0 sortDirection:(int)a1 columnIndex:(unsigned int)a2 level:(unsigned char)a3 aggregateIndex:(unsigned long long)a4 resetLabels:(BOOL *)a5;
