...
- (BOOL)p_prefersHDRRenderingForCellStyle:(id)a0;
- (BOOL)p_prefersHDRRenderingForTableStyle:(id)a0;
- (BOOL)p_prefersHDRRenderingForTextStyle:(id)a0;
