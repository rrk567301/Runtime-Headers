@class TSKAnnotationAuthorStorage, TSKAnnotationAuthor, TSKSelectionDispatcher, NSDate, NSDictionary, TSKAccessController, TSKPasteboardController, NSString, TSKChangeNotifier, TSKDocumentSupport, TSULocale, _TtC5TSKit39TSKSimpleCollaborationSuspensionManager, NSUUID;
@protocol TSKCollaborationSuspensionManager, TSKDocumentRootDelegate, TSULogContext;

@interface TSKDocumentRoot : TSPObject <TSKit.TSKWatermarkableDocumentMetadataProviding, TSKAccessControllerDelegate, TSKModel, TSKChangeNotifierProvider> {
...
@property (readonly, nonatomic) BOOL containsAIGeneratedContent;
...
@property (readonly, nonatomic) BOOL isDocumentBasedOnPremiumTemplate;
...
- (void)setIsDocumentBasedOnPremiumTemplate:(BOOL)a0 shouldModifyPersistenceObject:(BOOL)a1;
