...
@interface TSTLayoutEngine : NSObject <TSTTableHiddenRowColumnProviding, TSTTableInternalGeometryProviding, TSTTableMergeRangeProviding> {
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _topRowStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _bottomRowStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _leftColumnStrokes;
    struct vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _rightColumnStrokes;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _tableDefaultFontHeightForArea;
...
+ (long long)tableRowsBehaviorForTable:(id)a0 andEnvironment:(int)a1;
...
- (id)effectiveTextStyleForCell:(id)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1;
...
- (void)updateDynamicFontColor:(id)a0 andRegion:(id)a1;
