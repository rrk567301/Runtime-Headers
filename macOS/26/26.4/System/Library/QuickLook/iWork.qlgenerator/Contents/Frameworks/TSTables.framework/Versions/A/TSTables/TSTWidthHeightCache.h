@interface TSTWidthHeightCache : NSObject {
    ...
    struct vector<TSTWidthHeightCacheEntry<4>, std::allocator<TSTWidthHeightCacheEntry<4>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _rowHeights;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _columnModelWidths;
}
