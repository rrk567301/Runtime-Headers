@class , TSCEDependencyTracker, __end_;
...
@interface TSCERangeDependencies : NSObject {
    ...
    struct vector<TSCERangePrecedentsTile *, std::allocator<TSCERangePrecedentsTile *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _rangePrecedentsTiles;
    struct vector<TSCEUnarchiveRangePrecedent, std::allocator<TSCEUnarchiveRangePrecedent>> { struct TSCEUnarchiveRangePrecedent *__begin_; struct TSCEUnarchiveRangePrecedent *__end_; struct { struct TSCEUnarchiveRangePrecedent *__cap_; } ; } _unarchivedPrecedentList;
}
