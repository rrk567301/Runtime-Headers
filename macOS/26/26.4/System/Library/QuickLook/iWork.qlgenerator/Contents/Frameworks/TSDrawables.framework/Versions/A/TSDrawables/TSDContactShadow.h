...
- (struct CGImage { } *)newShadowImageFromContext:(struct CGContext { } *)a0 withSize:(struct CGSize { double x0; double x1; })a1 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 unflipped:(BOOL)a3 supportsHDR:(BOOL)a4 supportsWideGamut:(BOOL)a5;
