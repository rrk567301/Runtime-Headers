...
- (void)enumerateAllRenderingFills:(id /* block */)a0;
- (void)enumerateAllRenderingShadows:(id /* block */)a0;
- (void)enumerateAllRenderingStrokes:(id /* block */)a0;
