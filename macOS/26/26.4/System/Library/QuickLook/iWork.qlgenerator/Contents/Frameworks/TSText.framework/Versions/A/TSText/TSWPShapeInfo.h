...
@property (nonatomic) BOOL autogrowsForLocalization;
...
+ (struct CGPoint { double x0; double x1; })alignmentOffsetForProperty:(int)a0 oldAlignment:(long long)a1 newAlignment:(long long)a2 size:(struct CGSize { double x0; double x1; })a3 textIsVertical:(BOOL)a4;
+ (double)autosizeOffsetForProperty:(int)a0 value:(long long)a1 size:(struct CGSize { double x0; double x1; })a2 textIsVertical:(BOOL)a3;
...
- (id)autosizeGeometryForAlignment:(int)a0;
...
- (BOOL)p_bakeShrinkTextToFitIntoModelIfNeeded;
...
- (void)setAutogrowsForLocalizationForPersistence:(BOOL)a0;
