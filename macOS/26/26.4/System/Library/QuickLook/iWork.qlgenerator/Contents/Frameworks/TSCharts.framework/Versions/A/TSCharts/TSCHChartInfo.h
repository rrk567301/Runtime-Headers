...
@property (readonly, nonatomic) BOOL supportsAndHasStackedSummaryLabels;
@property (readonly, nonatomic) BOOL supportsStackedSummaryLabels;
@property (readonly, nonatomic) BOOL hasStackedSummaryLabels;
...
- (id)fillForParagraphStyle:(id)a0;
...
- (BOOL)hasSummaryLabelCustomFormatForGridValueType:(int)a0;
...
- (id)paragraphStyleForStyleOwner:(id)a0 andProperty:(int)a1;
