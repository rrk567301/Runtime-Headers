@interface TSCECellRecordTile : TSPObject {
    ...
    struct vector<TSCECellRecord *, std::allocator<TSCECellRecord *>> { struct TSCECellRecord **__begin_; struct TSCECellRecord **__end_; struct { struct TSCECellRecord **__cap_; } ; } _cellRecords;
