...
@property (nonatomic) BOOL analyticsHasHDRImages;
@property (nonatomic) BOOL analyticsHasAnyHDRContent;
@property (nonatomic) BOOL analyticsHas3DObjects;
@property (nonatomic) BOOL analyticsHasLoaded3DObjects;
@property (nonatomic) BOOL analyticsHasWindowedPlaybackPD;
...
- (void)analyticsVisitedSlideNode:(id)a0;
