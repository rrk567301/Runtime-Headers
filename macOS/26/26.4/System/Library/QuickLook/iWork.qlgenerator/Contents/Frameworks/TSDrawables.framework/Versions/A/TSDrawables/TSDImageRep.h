@class TSDImageInfo, NSString, TSDImageDrawingHelper, TSDImageLayout, NSObject, TSDMaskInfo, TSUBezierPath, NSMutableArray, TSDMaskLayout, TSPData, NSNumber, TSDLayoutGeometry;
@protocol TSDRepTrackerDelegate, OS_dispatch_semaphore;

@interface TSDImageRep : TSDMediaRep <TSDrawables.TSDWatermarkRenderingContextProviding, CALayerDelegate, TSDImageDrawingDataSource, TSDMagicMoveMatching> {
...
@property (readonly, nonatomic) BOOL i_shouldShowWatermark;
...
- (void)p_drawMaskedContentOnlyInContext:(struct CGContext { } *)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
...
- (struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })watermarkPatternTransformIn:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
