...
@interface TSCH3DChartBarElementProperties : TSCH3DChartBasicElementProperties {
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _maxValues;
    struct vector<TSCH3D::BarElementInfo, std::allocator<TSCH3D::BarElementInfo>> { struct BarElementInfo *__begin_; struct BarElementInfo *__end_; struct { struct BarElementInfo *__cap_; } ; } _elementInfos;
    BOOL _stacked;
    float _barWidth;
...
- (struct BarElementInfo { BOOL x0; float x1; BOOL x2; unsigned long long x3; })barElementInfoAtIndex:(void *)a0;
- (id)boundsGeometryForSeries:(id)a0 index:(void *)a1;
- (id)calculateInterceptForSeries:(id)a0;
- (float)chartInitialDepthOffset;
- (struct BarElementInfo { BOOL x0; float x1; BOOL x2; unsigned long long x3; } *)elementInfoAtIndex:(void *)a0;
...
- (id)p_barResourceCacheItemAtIndex:(void *)a0;
...
- (void)setBeveledAtIndex:(void *)a0;
- (void)setElementInfo:(const struct BarElementInfo { BOOL x0; float x1; BOOL x2; unsigned long long x3; } *)a0 atIndex:(void *)a1;
