@class FARequestCoalescer, FAAgeRangeDaemonConnection;
...
- (void)fetchDSIDWithCompletionHandler:(id /* block */)a0;
...
- (void)getAgeVerificationInfoForDSID:(id)a0 completion:(id /* block */)a1;
