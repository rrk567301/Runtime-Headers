@class NSData, AIDAServiceOwnersManager, AKAppleIDServerResourceLoadDelegate, NSDictionary, ACAccount, AAGrandSlamSigner, AKAppleIDAuthenticationContext, ACAccountStore;
...
- (void)addLocalHeadersToRequest:(id)a0;
