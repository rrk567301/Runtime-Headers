@class RBProcess, RBSProcessIdentity, OSLaunchdJobProperties, NSDictionary, RBSProcessIdentifier, RBSMachPort, RBDomainRestriction, NSString, RBSProcessHandle, RBSAssertionIdentifier, LSApplicationIdentity, NSSet, NSArray, NSNumber, NSUUID;
...
@property (nonatomic) BOOL psPageIn;
