@class NSString, NSURL, NSArray, NSSet, BRCSyncOperationThrottleParams, NSDictionary, NSMutableDictionary, NSDateFormatter, NSIndexSet;
...
@property (readonly, nonatomic) BOOL treatPerItemThrottleAsOperationSuccess;
...
@property (readonly, nonatomic) BOOL considerSyncUpBatchFailuresAsSuccessForThrottling;
...
@property (readonly, nonatomic) BOOL dbVerboseProfiled;
...
@property (readonly, nonatomic) BOOL reportShareSaveErrors;
...
@property (readonly, nonatomic) BOOL integrityCheckContentPolicy;
...
@property (readonly, nonatomic) BOOL dbIntegrityCheckContainerMetadataSyncUpJob;
@property (readonly, nonatomic) BOOL dbIntegrityCheckMissingShareOptions;
@property (readonly, nonatomic) BOOL dbIntegrityCheckBasehashSalting;
@property (readonly, nonatomic) BOOL dbIntegrityCheckLostZombieDirectories;
@property (readonly, nonatomic) BOOL dbIntegrityCheckForBouncedDocumentsDirectories;
@property (readonly, nonatomic) BOOL dbIntegrityCheckParentItemReferences;
@property (readonly, nonatomic) BOOL shouldPerformPeriodicSyncInvestigation;
...
@property (readonly, nonatomic) BOOL fpfsOptimizeStorageAndSpeculativeDownload;
@property (readonly, nonatomic) BOOL fpfsOptimizeStorageAndSpeculativeDownloadCandidate;
@property (readonly, nonatomic) BOOL fpfsNamespacePolicyEnabled;
@property (readonly, nonatomic) BOOL fpfsSpeculativeSetDownload;
@property (readonly, nonatomic) NSArray *containersWithContentPolicyDownloadLazilyAndEvictOnRemoteUpdate;
@property (readonly, nonatomic) BOOL supportsEnhancedDrivePrivacy;
@property (readonly, nonatomic) BOOL enhancedDrivePrivacyRolledBack;
@property (readonly, nonatomic) BOOL enhancedDrivePrivacyForced;
@property (readonly, nonatomic) BOOL allowAssetReferencesOfMMCSV1Assets;
@property (readonly, nonatomic) BOOL requestForAccess;
@property (readonly, nonatomic) BOOL requestForAccessNotifications;
...
@property (readonly, nonatomic) BOOL shouldSendRoundedTimestamps;
...
@property (readonly, nonatomic) BOOL scheduleDeepScanOnFSEventsReset;
...
@property (readonly, nonatomic) BOOL recoverDamagedDocumentOnDisk;
...
@property (readonly, nonatomic) BOOL fpfsStuckMigrationTakeReconciledItemsIntoAccount;
...
@property (readonly, nonatomic) BOOL filterDecendantsOfNotMigratedFolders;
@property (readonly, nonatomic) BOOL failModifyRequestsWhenInFlightUnAckedChanges;
@property (readonly, nonatomic) BOOL useIDSDecisionService;
...
@property (readonly, nonatomic) BOOL reimportRootContainerWhenDomainDecorationIsInvalid;
@property (readonly, nonatomic) BOOL fpfsUploadV2;
@property (readonly, nonatomic) BOOL showNotificatioForTapToRadar;
@property (readonly, nonatomic) BOOL showNotificatioForRadarURL;
...
@property (readonly, nonatomic) BOOL ignoreCKCZMigrationAlreadyDoneErrorForABC;
@property (readonly, nonatomic) BOOL ignoreCKMMCSItemNotAvailableErrorForABC;
@property (readonly, nonatomic) double authKitRefreshRate;
@property (readonly, nonatomic) BOOL fetchTelemetryStatusFromAuthKit;
@property (readonly, nonatomic) NSSet *nonForegroundBundles;
@property (readonly, nonatomic) BOOL shouldSetBackgroundTopicsInAPSConnectionAsEnabled;
@property (readonly, nonatomic) BOOL shouldBoostDefaultAndSharedZones;
@property (readonly, nonatomic) unsigned long long xpcConnectionFailureRetries;
@property (readonly, nonatomic) BOOL shouldPurgeUploadsOnDeviceIDChange;
...
@property (readonly, nonatomic) BOOL shouldSendTelemetryOnCollaborationAPIs;
...
@property (readonly, nonatomic) BOOL checkBRCTLTCCAccessOnInternalBuild;
@property (readonly, nonatomic) BOOL handleUnloadedZones;
@property (readonly, nonatomic) BOOL finishSaltingPartiallySaltedDirectories;
...
@property (readonly, nonatomic) BOOL promoteEmptyDirectoryFromDirFault;
...
@property (readonly, nonatomic) BOOL fastThrottleOnlyForSpeculativeDownloads;
...
@property (readonly, nonatomic) BOOL populateFPDomainExperimentID;
@property (readonly, nonatomic) BOOL signpostEnabled;
@property (readonly, nonatomic) BOOL applyNonDocumentsOnLocateRecord;
@property (readonly, nonatomic) long long diskSpaceReclaimedThresholdForSendingTelemetry;
@property (readonly, nonatomic) BOOL supportsIncrementalAppsMonitoring;
@property (readonly, nonatomic) unsigned long long uploadV1PerformanceTrackerCap;
@property (readonly, nonatomic) BOOL clientZoneMemoryOptimizationEnabled;
@property (readonly, nonatomic) BOOL memoryReclaimerBGSystemTaskEnabled;
@property (readonly, nonatomic) double syncContextIdleTimeBeforeMemoryReclaim;
@property (readonly, nonatomic) BOOL skipEvictUploadedItemsForUninstalledAppLibraries;
...
- (id)_checkServerOverrideForKey:(id)a0 validateWithBlock:(id /* block */)a1;
...
- (BOOL)shouldPrimeMMCSCacheBeforeDownloadWithAccountFacade:(id)a0;
...
- (BOOL)_shouldRampForKey:(id)a0 accountFacade:(id)a1;
- (BOOL)saveLocalContentVersionIdentifierOnDiskWithAccountFacade:(id)a0;
- (id)_checkLocalCacheForKey:(id)a0 inherit:(BOOL)a1 validateWithBlock:(id /* block */)a2;
- (BOOL)_isSharedDefaults;
- (BOOL)aggressivelyPCSChainWithAccountFacade:(id)a0;
- (id)_healthErrorSetForKey:(id)a0 byDefault:(id)a1;
- (BOOL)optimisticallyPCSChainDuringResetWithAccountFacade:(id)a0;
- (id)initAsGlobalWithServerConfiguration:(id)a0 localNSUserDefaultsDict:(id)a1;
...
- (BOOL)optimisticallyPCSChainWithAccountFacade:(id)a0;
- (id)_handleGlobalFallbackForKey:(id)a0 validateWithBlock:(id /* block */)a1;
- (void)_cacheValueLocally:(id)a0 forKey:(id)a1;
...
- (id)initWithServerConfiguration:(id)a0 globalUserDefaults:(id)a1 localNSUserDefaultsDict:(id)a2 clientZoneIdentifier:(id)a3;
...
- (id)getBirdBGSTActivitiesConfigsWithAccountFacade:(id)a0;
- (float)_defaultSyncUpHourlyBudget;
- (id)bgSystemTaskParamsForKey:(id)a0 byDefault:(id)a1;
- (id)_checkLocalNSUserDefaultsForKey:(id)a0 validateWithBlock:(id /* block */)a1;
