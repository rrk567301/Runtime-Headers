...
@property (readonly, nonatomic) BOOL uploadV2Enabled;
...
+ (id)_readTelemetryInfoFileAtPath:(id)a0;
...
- (void)_recoverNamespaceAndContentPolicyIfNecessaryForItemID:(id)a0 appLibrary:(id)a1 isAppLibraryRoot:(BOOL)a2 isDocumentsFolder:(BOOL)a3 completion:(id /* block */)a4;
...
- (void)enableEnhancedDrivePrivacyForZone:(id)a0 ownerName:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)fileProviderItemIdentifierForItemIdentifierString:(id)a0 zoneName:(id)a1 ownerName:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)generateRequestIDForZone:(id)a0 ownerName:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)hasSyncedDownZoneSinceStartup:(id)a0 ownerName:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)invokePCSChainOnItem:(id)a0 zoneName:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)learnNewItemIdentifier:(id)a0 forItemIdentifier:(id)a1 zoneName:(id)a2 ownerName:(id)a3 completionHandler:(id /* block */)a4;
- (void)locateItemWithIdentifier:(id)a0 zoneName:(id)a1 ownerName:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)performAsyncOnClientReadDatabaseWorkloop:(id /* block */)a0;
...
- (void)recoverAndReportNamespaceAndContentPolicyWithCompletion:(id /* block */)a0;
- (BOOL)reimportFPFSDomainWithError:(id *)a0;
- (void)reportDBIntegrityIssueWithError:(id)a0;
...
- (id)serverItemForItemIdentifier:(id)a0;
- (id)serverItemForItemIdentifierString:(id)a0 zoneName:(id)a1 ownerName:(id)a2;
- (id)serverItemWithParent:(id)a0 filename:(id)a1 zoneName:(id)a2 ownerName:(id)a3;
...
- (void)shouldPCSChainItem:(id)a0 zoneName:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)updatePCSStateForItemIdentifier:(id)a0 newState:(unsigned int)a1 zoneName:(id)a2 ownerName:(id)a3 completionHandler:(id /* block */)a4;
- (void)updateServerState:(id)a0;
- (void)waitForSyncDownOfZone:(id)a0 ownerName:(id)a1 completionHandler:(id /* block */)a2;
