...
- (void)__performQuery:(id)a0 recordFetchedBlock:(id /* block */)a1 cursorUpdatedBlock:(id /* block */)a2 desiredKeys:(id)a3 completion:(id /* block */)a4;
...
- (void)_updatedContinuationCursor:(id)a0 fetchedRecords:(id)a1 alreadyOnServerTruth:(BOOL)a2 reply:(id /* block */)a3;
