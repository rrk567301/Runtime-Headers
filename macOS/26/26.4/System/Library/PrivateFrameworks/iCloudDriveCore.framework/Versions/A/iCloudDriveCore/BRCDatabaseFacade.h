...
- (id)fetchRootItemIDAboveItemID:(id)a0 zoneRowID:(id)a1 serverTruth:(BOOL)a2 itemState:(char *)a3 depth:(long long *)a4 itemType:(char *)a5;
- (id)fetchShareRootItemIDWithSharedChildItemID:(id)a0 zoneRowID:(id)a1 serverTruth:(BOOL)a2;
- (id)getParticipantsAndRecordIDsWithIsRequesters:(BOOL)a0;
...
- (id)serverItemFromClientRowID:(unsigned long long)a0 itemBuilder:(id)a1;
