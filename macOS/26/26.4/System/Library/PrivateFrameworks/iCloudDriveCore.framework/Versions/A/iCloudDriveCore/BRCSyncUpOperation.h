...
+ (id)pcsChainItem:(id)a0 forZone:(id)a1 sessionContext:(id)a2;
...
- (void)_clearErrorForRecord:(id)a0 inZone:(id)a1;
...
- (id)_localItemFromRecord:(id)a0 inZone:(id)a1 validateSyncUpState:(BOOL)a2;
