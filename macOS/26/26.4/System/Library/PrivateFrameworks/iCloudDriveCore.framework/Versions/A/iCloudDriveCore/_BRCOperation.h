@class NSError, NSUUID, NSDate, NSHashTable, NSString, CKOperationGroup, BRCSyncContext, NSObject, NSMutableArray, BRCThrottle;
@protocol OS_dispatch_source, OS_dispatch_group, OS_os_activity, OS_os_transaction, OS_dispatch_queue, BRCSessionContext;
...
- (void)_addSubOperation:(id)a0 overrideContext:(id)a1 allowsCellularAccess:(id)a2;
