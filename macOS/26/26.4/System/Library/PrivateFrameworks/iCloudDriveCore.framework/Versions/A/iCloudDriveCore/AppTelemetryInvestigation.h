...
@property (nonatomic) BOOL hasIsConsolidated;
@property (nonatomic) BOOL isConsolidated;
@property (nonatomic) BOOL hasDbAge;
@property (nonatomic) long long dbAge;
@property (readonly, nonatomic) BOOL hasErrorsChain;
