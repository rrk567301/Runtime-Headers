...
- (BOOL)_populateParticipantsAndSendUserNotificationsIfNeededWithShare:(id)a0;
- (BOOL)_saveEditedSymlinkRecord:(id)a0 error:(id *)a1;
- (void)_userNotificationMetadataWithShare:(id)a0 requester:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)_removeRequestAccessNotificationsIfNeededWithShare:(id)a0 notificationIDsToKeep:(id)a1;
...
- (BOOL)_saveItemID:(id)a0 version:(id)a1 record:(id)a2 contentBoundaryKey:(id)a3 iWorkSharingOptions:(unsigned long long)a4;
...
- (void)_sendApprovedNotificationIfNeededWithShare:(id)a0;
- (BOOL)_shouldSendNotification;
- (BOOL)_updateParticipantsTableForShare:(id)a0;
- (id)_userNotificationRequestApprovedMetadataWithShare:(id)a0;
- (BOOL)_verifyChildbasehashSaltKeysForItemID:(id)a0 saltInfo:(id)a1 record:(id)a2;
...
- (void)recordResetWithReason:(id)a0;
