@class NSURL, brc_task_tracker, NSMutableDictionary, NSObject, BRCAccountSession, BRContainer, BRCClientDatabaseFacade, BRMangledID, BRCItemID, NSString, BRCZoneRowID, BRCPQLConnection, BRCListDirectoryContentsOperation, BRCALRowID, BRCPrivateClientZone, NSNumber, NSData, NSMutableSet, BRCSyncContext;
...
- (id)trashItemIDWithFacade:(id)a0;
