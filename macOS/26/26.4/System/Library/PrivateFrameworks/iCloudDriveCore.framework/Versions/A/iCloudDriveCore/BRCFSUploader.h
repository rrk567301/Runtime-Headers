...
- (void).cxx_destruct;
- (BOOL)_shouldReingestAfterUploadErrorWithItem:(id)a0 record:(id)a1 error:(id)a2;
...
- (void)close;
- (BOOL)_isUploadingPackageAsRegularFileForItem:(id)a0 record:(id)a1 error:(id)a2;
