@class BRCAppLibrary, NSString, NSArray, NSURL, CKRecordID, CKShareMetadata, BRFileObjectID, BRCAcceptShareOperation, NSObject, NSError, BRCClientZone, BRCItemID;
...
@interface BRCSharingAcceptFlowOperation : _BRCOperation <LSOpenResourceOperationDelegate, BRCForegroundClient, BRCOperationSubclass> {
    ...
    BOOL _isShareOwnerDSAtApple;
    BOOL _currentUserIsDSAtApple;
...
@property (nonatomic) BOOL skipAcceptDialogs;
...
- (BOOL)_getBundleURLAndEntitlementsForBundle:(id)a0 bundleURL:(id *)a1 entitlements:(id *)a2 error:(id *)a3;
...
- (id)initWithShareMetadata:(id)a0 sessionContext:(id)a1 userNotifier:(id)a2 userActionsNavigator:(id)a3;
