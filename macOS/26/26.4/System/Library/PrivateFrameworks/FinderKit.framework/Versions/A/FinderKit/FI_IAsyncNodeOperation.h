...
@interface FI_IAsyncNodeOperation : NSObject {
    ...
    struct TOperationMonitor { struct unique_ptr<OperationMonitorEx, std::default_delete<OperationMonitorEx>> { struct { struct OperationMonitorEx *__ptr_; } ; } fDetails; } _operationMonitor;
    struct vector<std::shared_ptr<TOperationRecord>, std::allocator<std::shared_ptr<TOperationRecord>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _operationRecordList;
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _nodes;
    struct TOperationIterator { struct unique_ptr<TOperationIteratorDetails, std::default_delete<TOperationIteratorDetails>> { struct { struct TOperationIteratorDetails *__ptr_; } ; } fDetails; } _operationIterator;
...
@property (copy) NSData *scriptingAuditToken;
