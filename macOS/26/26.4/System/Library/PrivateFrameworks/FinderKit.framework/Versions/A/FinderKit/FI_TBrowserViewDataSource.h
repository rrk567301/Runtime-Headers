...
@interface FI_TBrowserViewDataSource : NSObject <TReadWriteLockingProtocol, TCoalescingNodeObserverProtocol> {
    ...
    struct unique_ptr<TBlockingQueue, std::default_delete<TBlockingQueue>> { struct { struct TBlockingQueue *__ptr_; } ; } _callBackQueue;
    ...
    struct unordered_map<TFENode, TChildrenData, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, TChildrenData>>> { struct __hash_table<std::__hash_value_type<TFENode, TChildrenData>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, TChildrenData>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, TChildrenData>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, TChildrenData>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TChildrenData>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TChildrenData>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TChildrenData>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TChildrenData>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _nodeToChildrenDataMap;
    BOOL _checkChildrenForTags;
    int _sortBy;
    BOOL _isSortInIncreasingOrder;
    BOOL _isSortFoldersFirst;
    struct unordered_map<TFENode, TGroupModeData, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, TGroupModeData>>> { struct __hash_table<std::__hash_value_type<TFENode, TGroupModeData>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, TGroupModeData>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, TGroupModeData>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, TGroupModeData>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TGroupModeData>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TGroupModeData>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TGroupModeData>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TGroupModeData>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _containerNodeToGroupDataMap;
    int _groupBy;
    struct function<std::shared_ptr<TFENodeComparator> (const TFENodeComparatorParameters &)> { struct __value_func<std::shared_ptr<TFENodeComparator> (const TFENodeComparatorParameters &)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } _comparatorFunc;
    struct unordered_map<TFENode, FI_TBVDSBusyStateIncrementer *, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, FI_TBVDSBusyStateIncrementer *>>> { struct __hash_table<std::__hash_value_type<TFENode, FI_TBVDSBusyStateIncrementer *>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, FI_TBVDSBusyStateIncrementer *>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, FI_TBVDSBusyStateIncrementer *>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, FI_TBVDSBusyStateIncrementer *>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, FI_TBVDSBusyStateIncrementer *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, FI_TBVDSBusyStateIncrementer *>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, FI_TBVDSBusyStateIncrementer *>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, FI_TBVDSBusyStateIncrementer *>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _firstPopBusyStateIncrementers;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })flatten:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })flatten:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
