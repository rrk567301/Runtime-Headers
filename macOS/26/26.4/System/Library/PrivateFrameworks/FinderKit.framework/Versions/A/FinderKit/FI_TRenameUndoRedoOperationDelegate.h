@interface FI_TRenameUndoRedoOperationDelegate : FI_TRenameOperationDelegate {
    struct unique_ptr<TRenameUndoRedoOperationHelper, std::default_delete<TRenameUndoRedoOperationHelper>> { struct { struct TRenameUndoRedoOperationHelper *__ptr_; } ; } _actionHelper;
    BOOL _needToReselectNode;
    int _renameOpCount;
    BOOL _isUndo;
    struct optional_bool { union { char __null_state_; BOOL __val_; } ; BOOL __engaged_; } _pendingIsUndo;
}
