...
@interface FIAirDropViewGutsController : FI_TViewController <NSTouchBarDelegate, TAirDropTransferEventDelegate, TMarkTornDown> {
    ...
    struct vector<std::shared_ptr<TAirDropSenderOperationController>, std::allocator<std::shared_ptr<TAirDropSenderOperationController>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _senderOpControllers;
