@class , NSString, NSData, __end_, NSExtension, NSDictionary, NSObject, NSImage;
...
@interface FIFinderSyncExtensionHost_Badging : NSExtensionContext <FIFinderSyncExtensionHostProtocol, NSMenuDelegate> {
    ...
    struct unordered_map<TString, NSImage *, std::hash<TString>, std::equal_to<TString>, std::allocator<std::pair<const TString, NSImage *>>> { struct __hash_table<std::__hash_value_type<TString, NSImage *>, std::__unordered_map_hasher<TString, std::pair<const TString, NSImage *>, std::hash<TString>, std::equal_to<TString>>, std::__unordered_map_equal<TString, std::pair<const TString, NSImage *>, std::equal_to<TString>, std::hash<TString>>, std::allocator<std::pair<const TString, NSImage *>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, NSImage *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, NSImage *>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, NSImage *>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TString, NSImage *>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _badgeIDImages;
    struct unordered_map<TString, TString, std::hash<TString>, std::equal_to<TString>, std::allocator<std::pair<const TString, TString>>> { struct __hash_table<std::__hash_value_type<TString, TString>, std::__unordered_map_hasher<TString, std::pair<const TString, TString>, std::hash<TString>, std::equal_to<TString>>, std::__unordered_map_equal<TString, std::pair<const TString, TString>, std::equal_to<TString>, std::hash<TString>>, std::allocator<std::pair<const TString, TString>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, TString>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, TString>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TString, TString>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TString, TString>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _badgeIDLabels;
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _interestedRoots;
    struct vector<NSURL *, std::allocator<NSURL *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _unresolvedRoots;
    struct unordered_map<TFENode, TString, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, TString>>> { struct __hash_table<std::__hash_value_type<TFENode, TString>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, TString>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, TString>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, TString>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TString>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TString>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TString>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, TString>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _nodeToBadgeIDMap;
