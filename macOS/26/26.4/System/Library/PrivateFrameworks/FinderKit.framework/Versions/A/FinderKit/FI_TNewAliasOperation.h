@interface FI_TNewAliasOperation : FI_TRenameOperation {
    struct unordered_map<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>>> { struct __hash_table<std::__hash_value_type<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, std::vector<std::pair<TFENode, TFENodePropertyList>>>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _recordsTable;
