...
@interface FI_TColumnViewController : FI_TBrowserViewController <TableView_Common_Delegate, FIAliasResolution, TColumnViewDelegate, TDuplicateTaskDelegateProtocol, TListNameFieldDelegate> {
    ...
    struct TAliasesTargets { struct map<TFENode, std::pair<unsigned long, TFENode>, std::less<TFENode>, std::allocator<std::pair<const TFENode, std::pair<unsigned long, TFENode>>>> { struct __tree<std::__value_type<TFENode, std::pair<unsigned long, TFENode>>, std::__map_value_compare<TFENode, std::pair<const TFENode, std::pair<unsigned long, TFENode>>, std::less<TFENode>>, std::allocator<std::pair<const TFENode, std::pair<unsigned long, TFENode>>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } fMap; } _resolvedAliasTable;
    void *_optimizer;
    struct TFENode { struct OpaqueNodeRef *fNodeRef; } _brokenAlias;
    NSTimer *_delayedContainerSynchingTimer;
    struct TColumnOptimizerContainers { struct __tree<std::__value_type<std::pair<long, TFENode>, short>, std::__map_value_compare<std::pair<long, TFENode>, std::pair<const std::pair<long, TFENode>, short>, std::greater<std::pair<long, TFENode>>>, std::allocator<std::pair<const std::pair<long, TFENode>, short>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _delayedContainers;
    ...
    struct vector<TNotificationCenterObserver, std::allocator<TNotificationCenterObserver>> { struct TNotificationCenterObserver *__begin_; struct TNotificationCenterObserver *__end_; struct { struct TNotificationCenterObserver *__cap_; } ; } _columnViewNotificationObservers;
}
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })sortedGroups:(const void *)a0 forContainerNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1;
