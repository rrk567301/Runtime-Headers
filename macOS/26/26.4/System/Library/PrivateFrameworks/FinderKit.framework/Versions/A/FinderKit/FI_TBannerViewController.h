@class FINode, NSString, FI_TPopover, NSTextField, _SWCollaborationDetailViewController, ICQInAppMessage, NSObject, FI_TNotificationCenterObserverGlue, NSButton, FI_TImageView, NSLayoutConstraint;

@interface FI_TBannerViewController : NSSplitViewItemAccessoryViewController <FPUIActionViewControllerDelegate, TMarkTornDown, TCoalescingNodeObserverProtocol, NSPopoverDelegate> {
    ...
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _finderPrefsChangedObserver;
