...
@interface FI_TBrowserViewController : FI_TBaseBrowserViewController <FPUIActionViewControllerDelegate, NSMenuDelegate, NSMenuItemValidation, NSScrollViewDelegate, NSToolbarItemValidation> {
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _resolvedTargetPath;
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _unResolvedTargetPath;
    ...
    struct vector<TKeyValueBinder, std::allocator<TKeyValueBinder>> { struct TKeyValueBinder *__begin_; struct TKeyValueBinder *__end_; struct { struct TKeyValueBinder *__cap_; } ; } _viewSettingsBinders;
    struct unordered_map<TFENode, ContainerObservingOptions, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, ContainerObservingOptions>>> { struct __hash_table<std::__hash_value_type<TFENode, ContainerObservingOptions>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, ContainerObservingOptions>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, ContainerObservingOptions>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, ContainerObservingOptions>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, ContainerObservingOptions>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, ContainerObservingOptions>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, ContainerObservingOptions>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, ContainerObservingOptions>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _openContainerMap;
    int _sortBy;
    BOOL _shouldSuspendPendingSelectionsAndRenamesDuringAnimation;
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _pendingNodesToSelect;
    BOOL _shouldEditPendingNodesToSelect;
    FI_TRenameOperation *_editPendingNodesToSelectRenameOp;
    BOOL _shouldAnimateNewFolder;
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _nodesBeingDragged;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })openContainers:(const void *)a0;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })closeContainers:(const void *)a0;
- (void)closeTarget;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })nodesToRestore;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })nodesWithViews;
...
- (void)openTarget;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })openedContainers;
