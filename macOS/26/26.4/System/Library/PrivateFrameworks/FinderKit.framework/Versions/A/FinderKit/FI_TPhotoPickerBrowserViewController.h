...
@interface FI_TPhotoPickerBrowserViewController : FI_TBrowserViewController <PHPickerViewControllerDelegate> {
    ...
    struct unordered_map<PHPickerResult *, NSURL *, std::hash<PHPickerResult *>, std::equal_to<PHPickerResult *>, std::allocator<std::pair<PHPickerResult *const, NSURL *>>> { struct __hash_table<std::__hash_value_type<PHPickerResult *, NSURL *>, std::__unordered_map_hasher<PHPickerResult *, std::pair<PHPickerResult *const, NSURL *>, std::hash<PHPickerResult *>, std::equal_to<PHPickerResult *>>, std::__unordered_map_equal<PHPickerResult *, std::pair<PHPickerResult *const, NSURL *>, std::equal_to<PHPickerResult *>, std::hash<PHPickerResult *>>, std::allocator<std::pair<PHPickerResult *const, NSURL *>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSURL *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSURL *>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSURL *>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSURL *>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _itemToURLMap;
    struct unordered_map<PHPickerResult *, NSProgress *, std::hash<PHPickerResult *>, std::equal_to<PHPickerResult *>, std::allocator<std::pair<PHPickerResult *const, NSProgress *>>> { struct __hash_table<std::__hash_value_type<PHPickerResult *, NSProgress *>, std::__unordered_map_hasher<PHPickerResult *, std::pair<PHPickerResult *const, NSProgress *>, std::hash<PHPickerResult *>, std::equal_to<PHPickerResult *>>, std::__unordered_map_equal<PHPickerResult *, std::pair<PHPickerResult *const, NSProgress *>, std::equal_to<PHPickerResult *>, std::hash<PHPickerResult *>>, std::allocator<std::pair<PHPickerResult *const, NSProgress *>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSProgress *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSProgress *>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSProgress *>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<PHPickerResult *, NSProgress *>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _pendingItemToProgressMap;
}
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })nodesInBrowser;
