@interface FI_TRenameOperationDelegate : FI_TFileSystemOperationDelegate {
    ...
    struct optional_bool { union { char __null_state_; BOOL __val_; } ; BOOL __engaged_; } _extensionHiddenState;
...
- (struct optional_bool { union { char x0; BOOL x1; } x0; BOOL x1; })extensionHiddenState;
