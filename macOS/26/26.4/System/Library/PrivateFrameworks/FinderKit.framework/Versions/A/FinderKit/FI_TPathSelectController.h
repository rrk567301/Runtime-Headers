...
@interface FI_TPathSelectController : NSObject <NSMenuDelegate, TCoalescingNodeObserverProtocol, TMarkTornDown> {
    ...
    struct function<bool (const TFENode &)> { struct __value_func<bool (const TFENode &)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } _shouldShowNode;
}
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })allNodes;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)dealloc;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })filterNodes:(const void *)a0;
