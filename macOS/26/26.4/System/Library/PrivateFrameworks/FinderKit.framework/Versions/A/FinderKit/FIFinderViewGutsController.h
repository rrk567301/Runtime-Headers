...
@interface FIFinderViewGutsController : FI_TViewController <FILocationPopUpDelegate, FIBrowserOverlayStackViewTarget, NSMenuDelegate, NSMenuItemValidation, BrowserContainerTargeting, BrowserContainerSearching, BrowserContainerDelegate> {
    ...
    struct list<NSURL *, std::allocator<NSURL *>> { struct __list_node_base<NSURL *, void *> { void *__prev_; void *__next_; } __end_; struct { unsigned long long __size_; } ; } _pendingTargetURLQueue;
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _pendingSelectionToOpen;
    ...
    struct vector<TNotificationCenterObserver, std::allocator<TNotificationCenterObserver>> { struct TNotificationCenterObserver *__begin_; struct TNotificationCenterObserver *__end_; struct { struct TNotificationCenterObserver *__cap_; } ; } _prefObservers;
...
- (void)cmdCancelSearch:(id)a0;
- (void)cmdCollapseSavePanel:(id)a0;
- (void)cmdEditTagsInOpenPanel:(id)a0;
- (void)cmdSearchTextChanged:(id)a0;
...
- (void)forceContainerToExistWithTargetPath:(struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })a0;
