...
@interface FI_TBrowserTableView : NSBrowserTableView <TShrinkToFitDelegateProtocol, TShrinkToFitEditorControllerAccessible> {
    struct TOrderedSet<TFENode, std::hash<TFENode>, std::equal_to<TFENode>> { struct unordered_map<TFENode, unsigned long, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, unsigned long>>> { struct __hash_table<std::__hash_value_type<TFENode, unsigned long>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, unsigned long>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, unsigned long>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, unsigned long>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, unsigned long>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, unsigned long>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, unsigned long>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, unsigned long>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } fItemToIndexMap; struct vector<TFENode, std::allocator<TFENode>> { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } fItems; } _nodeToRowSet;
