...
@interface FI_TNodesAndValues : NSObject <NSCopying> {
    struct unordered_map<TFENode, NSObject *, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<std::pair<const TFENode, NSObject *>>> { struct __hash_table<std::__hash_value_type<TFENode, NSObject *>, std::__unordered_map_hasher<TFENode, std::pair<const TFENode, NSObject *>, std::hash<TFENode>, std::equal_to<TFENode>>, std::__unordered_map_equal<TFENode, std::pair<const TFENode, NSObject *>, std::equal_to<TFENode>, std::hash<TFENode>>, std::allocator<std::pair<const TFENode, NSObject *>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, NSObject *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, NSObject *>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, NSObject *>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<TFENode, NSObject *>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _values;
    ...
    NSObject *_highest;
    double _total;
    struct unordered_map<NSObject *, unsigned long, std::hash<NSObject *>, std::equal_to<NSObject *>, std::allocator<std::pair<NSObject *const, unsigned long>>> { struct __hash_table<std::__hash_value_type<NSObject *, unsigned long>, std::__unordered_map_hasher<NSObject *, std::pair<NSObject *const, unsigned long>, std::hash<NSObject *>, std::equal_to<NSObject *>>, std::__unordered_map_equal<NSObject *, std::pair<NSObject *const, unsigned long>, std::equal_to<NSObject *>, std::hash<NSObject *>>, std::allocator<std::pair<NSObject *const, unsigned long>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<NSObject *, unsigned long>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<NSObject *, unsigned long>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<NSObject *, unsigned long>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<NSObject *, unsigned long>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _uniqueValueCounts;
    struct vector<std::pair<NSObject *, unsigned long>, std::allocator<std::pair<NSObject *, unsigned long>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _valuesSortedByCount;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })nodesWithValues;
