...
@interface FI_TPathBarController : NSSplitViewItemAccessoryViewController <FI_TPathSelectDelegate, TPathControlDelegate, TNodeObserverProtocol, NSMenuDelegate, TMarkTornDown> {
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _commonPathVector;
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _observedSelection;
...
- (struct TFENode { struct OpaqueNodeRef *x0; })preflightSelection:(const void *)a0;
