...
+ (struct vector<std::pair<unsigned long, NSString *>, std::allocator<std::pair<unsigned long, NSString *>>> { void *x0; void *x1; struct { void *x0; } x2; })readDetachedDomainsStateFromDisk;
