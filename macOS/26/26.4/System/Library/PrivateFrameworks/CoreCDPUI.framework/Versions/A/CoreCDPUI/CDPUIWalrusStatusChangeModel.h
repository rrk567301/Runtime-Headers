...
@protocol CDPWalrusStatusProvider, CDPWalrusStatusUpdater, CDPStateUIProvider;
...
- (void)_statusForDisablingWalrus:(id /* block */)a0;
...
- (id)initWithTargetStatus:(unsigned long long)a0 statusProvider:(id)a1 statusUpdater:(id)a2 context:(id)a3;
