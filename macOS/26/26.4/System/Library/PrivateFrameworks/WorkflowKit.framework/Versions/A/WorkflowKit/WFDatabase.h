@class NSURL, NSMutableDictionary, NSObject, WFDebouncer, WFLibrary, NSManagedObjectContext, NSString, WFCoreDataChangeNotification, NSHashTable, NSMutableSet, NSArray, NSPersistentStoreDescription;
...
- (id)duplicateReferences:(id)a0 error:(id *)a1;
...
- (BOOL)moveCollections:(id)a0 toIndex:(long long)a1 error:(id *)a2;
- (BOOL)moveReferences:(id)a0 adjacentToIdentifier:(id)a1 inCollection:(id)a2 error:(id *)a3;
