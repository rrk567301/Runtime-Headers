@class LNDisplayRepresentation, NSString, LNEntity, LNQueryMetadata, LNEntityValueType, LNEntityMetadata;

@interface WFLinkEntityContentItem : WFContentItem

@property (class, readonly, nonatomic) LNEntityValueType *entityValueType;
...
+ (id)serializedFieldNameForFieldName:(id)a0;
