...
+ (BOOL)deniedBySchemaForActionMetadata:(id)a0;
+ (id)shortcutsPublicActionIdentifierHashes;
+ (BOOL)shouldAuditAction:(id)a0 forBundleIdentifier:(id)a1;
...
- (Class)contentItemClassForEntity:(id)a0 bundleIdentifier:(id)a1;
- (Class)contentItemClassForEnumeration:(id)a0 bundleIdentifier:(id)a1;
...
- (void)registerAllAvailableTypesFromBundle:(id)a0;
