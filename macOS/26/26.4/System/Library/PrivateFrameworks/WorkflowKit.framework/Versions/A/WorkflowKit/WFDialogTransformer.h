...
- (void)sequentialParameterInputProvider:(id)a0 didFinishWithInputtedStates:(id)a1 responseContext:(id)a2;
- (void)sequentialParameterInputProviderDidCancel:(id)a0 responseContext:(id)a1;
- (void)setToolInvocationIdentifierForRequestIfApplicable:(id)a0;
