@class NSMutableDictionary, LNAppIntentConnectionPolicy, LNFullyQualifiedActionIdentifier, NSDictionary, NSObject, LNActionSummary, LNActionMetadata, LNActionConfigurationContext, WFActionParameterSummary, NSSet, NSString, LNSystemContext, LNActionExecutorOptions, LNAttribution, LNUndoContext, NSNumber, NSData, LNConnectionPolicySignals, LNConnection, INAppIntentDescriptor;
