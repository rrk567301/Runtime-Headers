...
@interface AVDesktopPlayerViewContentView : NSView <AVDesktopGestureControllerDelegate, AVPlayerControlsViewControllerMediaOptionPreviewDelegate, NSTouchBarProvider> {
...
- (void)playerControlsViewControllerHideMediaOptionPreview:(id)a0;
- (void)playerControlsViewControllerShowMediaOptionPreview:(id)a0 option:(id)a1;
