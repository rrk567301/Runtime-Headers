...
@property (readonly, nonatomic) BOOL canZoomContent;
...
+ (id)keyPathsForValuesAffectingCanZoomContent;
...
- (void)present:(id)a0;
- (void)_handleAnalysisButton:(id)a0;
- (void)_handleZoomControl;
