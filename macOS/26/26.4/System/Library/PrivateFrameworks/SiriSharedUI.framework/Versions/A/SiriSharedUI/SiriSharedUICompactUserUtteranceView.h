...
- (void)_setStreamingText:(id)a0 carousel:(BOOL)a1 showEditImage:(BOOL)a2 preferredLeadingIconBundleIdentifier:(id)a3;
...
- (void)revealASRDuringLatencyDisplay:(id)a0;
