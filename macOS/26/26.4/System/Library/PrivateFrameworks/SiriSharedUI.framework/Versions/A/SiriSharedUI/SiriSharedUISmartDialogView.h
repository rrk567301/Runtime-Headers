@class SiriSharedUICompactUserUtteranceView, SRUIFLocalization, _TtC12SiriSharedUI36SiriSharedUIMiniSnippetViewContainer, SiriSharedUIViewStackConstraints, SiriSharedUIStandardScrollView, SiriSharedUIAnimationContext, SiriSharedUISAEUserUtteranceViewModel, _TtC12SiriSharedUI32SiriSharedUISmartDialogContainer, NSDictionary, NSMutableArray, NSString, SFCard, SiriSharedUISmartDialogViewModel, SiriSharedUILatencyViewModel, SAUIPluginSnippet, NSArray, NSView, SRUIFSpeechRecognitionHypothesis, SiriSharedUILatencyView;
...
@interface SiriSharedUISmartDialogView : SiriSharedUIStandardView <SiriSharedUICompactUserUtteranceViewDelegate, SiriSharedUICompactServerUtteranceViewDelegate, NSScrollViewDelegate, SiriSharedUI.SiriSharedUISmartDialogDelegate, SiriSharedUILatencyViewDelegate, SiriSharedUI.SiriSharedUIMiniSnippetViewDelegate, SiriSharedUISmartDialogViewModelDelegate, SiriSharedUICompactConversationViewHosting> {
...
- (void)endStreamingWithAttributionData:(id)a0;
- (BOOL)hasSnippet;
- (BOOL)isDrilledIn;
- (BOOL)isLatencyPill;
- (void)latencyViewClosed:(id)a0;
- (void)miniSnippetSizeDidChangeTo:(struct CGSize { double x0; double x1; })a0;
- (BOOL)ongoingASR;
...
- (void)setMiniSnippetModel:(id)a0;
- (void)setSmartDialogCard:(id)a0 withAttributionCardSections:(id)a1;
...
- (void)updateMiniSnippetStreamingStatus:(BOOL)a0;
...
- (void)viewDidAppearForAceObject:(id)a0;
