...
- (void).cxx_destruct;
- (BOOL)_categorizeMessages:(id)a0 signpostID:(unsigned long long)a1 results:(id *)a2 cancelationToken:(id)a3 reason:(long long)a4;
- (unsigned long long)_categoryTypeForString:(id)a0 subType:(unsigned long long *)a1;
- (BOOL)_categorizeMessages:(id)a0 senderAttributes:(id)a1 signpostID:(unsigned long long)a2 results:(id)a3 cancelationToken:(id)a4 reason:(long long)a5;
...
- (id)categorizeMessages:(id)a0 cancelationToken:(id)a1 reason:(long long)a2;
