@class NSDate, NSString, CSSearchableItem, EDSearchableIndexAttachmentItemMetadatum, NSObject, EDPersistedAttachmentID, EFPromise, EDPersistedMessageID, EDEnqueuedDonation;
@protocol OS_os_log;
