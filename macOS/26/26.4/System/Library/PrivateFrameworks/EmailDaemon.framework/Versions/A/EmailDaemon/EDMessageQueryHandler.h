@class EDMessageQueryHelper, NSString, NSMutableDictionary, EMCollectionItemIDStateCapturer, EFLocked, EDSectionQueryItemHelper, NSObject, EFDebouncer;
@protocol OS_os_log, EFScheduler, EDSearchProvider, OS_dispatch_queue, EDResumable;
...
+ (id)findMessagesByPreviousObjectIDForAddedMessages:(id)a0 messageSource:(id)a1 comparator:(id /* block */)a2;
...
- (void)_createHelper;
- (id)_extraInfoForMessages:(id)a0 messagesToPrecache:(id)a1 outObjectIDs:(id *)a2 searchInfo:(id)a3;
- (id)_extraInfoFromLocalSearchInfoCollector:(id)a0;
- (id)_getResultsObserver;
- (BOOL)_hasUrgentSectionPredicateForQuery:(id)a0;
- (void)_initializeOldestMessagesByMailbox;
- (id)_messageItemIDsBySectionFromMessages:(id)a0;
...
- (id)_queryWithUpdatedSortDescriptorFromQuery:(id)a0;
- (void)_reportFoundMessages:(id)a0 before:(id)a1 messagesToPrecache:(id)a2 searchInfo:(id)a3;
- (id)_requestedItemObjectID;
- (void)_restartHelper;
- (long long)_searchResultTypeForMessageObjectID:(id)a0;
- (void)_setSearchResultTypesForMessages:(id)a0;
- (id)_sortMessagesBySections:(id)a0;
...
- (id)initWithQuery:(id)a0 messagePersistence:(id)a1 hookRegistry:(id)a2 remindMeNotificationController:(id)a3 searchProvider:(id)a4 observer:(id)a5 observationIdentifier:(id)a6 observationResumer:(id)a7;
- (id)itemIDsForStateCaptureWithErrorString:(id *)a0;
- (id)messagesForObjectIDs:(id)a0 missedMessageObjectIDs:(id *)a1;
...
- (void)queryHelper:(id)a0 didAddMessages:(id)a1 searchInfo:(id)a2;
- (void)queryHelper:(id)a0 didDeleteMessages:(id)a1;
- (void)queryHelper:(id)a0 didFindMessages:(id)a1 searchInfo:(id)a2 forInitialBatch:(BOOL)a3;
...
- (void)queryHelperDidFailInitialLoad:(id)a0 localSearchInfoCollector:(id)a1;
- (void)queryHelperDidFindAllMessages:(id)a0 localSearchInfoCollector:(id)a1;
