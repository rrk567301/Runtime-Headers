...
- (unsigned long long)_biomeRecategorizationTypeFromType:(unsigned long long)a0 isHighImpactFlagChange:(BOOL)a1 isModelCategoryRestoration:(BOOL)a2 isResetAllManualCategorization:(BOOL)a3;
...
- (int)_hourInUTC;
- (BOOL)_isMailAccountBucketBarHidden:(id)a0;
...
- (void)logFedStatRecategorizationEventForMessages:(id)a0 categoryChangeAction:(id)a1 categoryPersistence:(id)a2 recategorizationType:(unsigned long long)a3;
- (void)logModelMetadataForMessages:(id)a0 categoryPersistence:(id)a1;
- (void)logRecategorizationEventForMessages:(id)a0 categoryType:(unsigned long long)a1 categoryPersistence:(id)a2 isHighImpactFlagChange:(BOOL)a3 recategorizationType:(unsigned long long)a4;
- (void)logRecategorizationEventForMessages:(id)a0 categoryType:(unsigned long long)a1 categoryPersistence:(id)a2 recategorizationType:(unsigned long long)a3;
