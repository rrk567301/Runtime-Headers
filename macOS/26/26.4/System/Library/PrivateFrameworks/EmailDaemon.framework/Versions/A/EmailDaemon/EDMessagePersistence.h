...
@protocol OS_os_log, EMUserProfileProvider, EFScheduler, EFSQLValueExpressable, OS_dispatch_queue, EMVIPReader;
...
+ (id)persistedMessagesForCollectionItemID:(id)a0;
+ (void)associatePersistedMessages:(id)a0 withCollectionItemID:(id)a1;
...
- (BOOL)_addBrandIndicatorEvidenceWithInfo:(id)a0 brandIndicatorDatabaseID:(long long)a1 withConnection:(id)a2 evidenceDatabaseID:(long long *)a3 existingEvidence:(id *)a4;
- (BOOL)_addBrandIndicatorWithInfo:(id)a0 withConnection:(id)a1 indicatorDatabaseID:(long long *)a2 existingIndicator:(id *)a3;
...
- (id)_databaseIDsDictionaryForGlobalMessageIDs:(id)a0 mailboxScope:(id)a1 includingDisabledAccounts:(BOOL)a2;
...
- (BOOL)_queryHasConversationIDPredicate:(id)a0;
...
- (void)_updateIsUrgentForMessagesMatchingQuery:(id)a0;
...
- (id)databaseIDsDictionaryForMessageObjectIDs:(id)a0 includingDisabledAccounts:(BOOL)a1;
...
- (void)messageObjectIDForSearchIndexerIdentifier:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)persistMessageIDHeader:(id)a0 forGlobalMessageID:(long long)a1;
- (void)persistMessageIDHeaderForMessage:(id)a0 async:(BOOL)a1;
...
- (void)persistenceDidChangeCategoryForAddressIDs:(id)a0 userInitiated:(BOOL)a1 generationWindow:(id)a2;
- (void)persistenceDidNotChangeCategoryForAddressIDs:(id)a0;
- (void)persistenceIsChangingCategoryForAddressIDs:(id)a0;
...
- (BOOL)removeBrandIndicatorForMessages:(id)a0;
...
- (BOOL)setBrandIndicatorForMessages:(id)a0 fromPersistedBIMIInfo:(id)a1;
...
- (void)setGeneratedSummary:(id)a0 forPersistedMessage:(id)a1 forceUpdateUrgent:(BOOL)a2;
