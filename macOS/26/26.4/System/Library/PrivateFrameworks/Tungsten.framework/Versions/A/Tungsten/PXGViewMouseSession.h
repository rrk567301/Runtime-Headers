@class NSView, NSString, NSScrollView, PXGView, PXGPointReference, PXSectionedSelectionManager, NSTimer, PXSectionedDataSource, PXMutableIndexPathSet, PXIndexPathSet, NSEvent;
@protocol PXGViewMouseSessionDelegate;

@interface PXGViewMouseSession : NSObject <PXChangeObserver> {
...
+ (struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })_convertFromIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0 fromDataSource:(id)a1 toDataSource:(id)a2 changeHistory:(id)a3;
+ (id)_convertFromIndexPaths:(id)a0 fromDataSource:(id)a1 toDataSource:(id)a2 changeHistory:(id)a3;
+ (void)_updateIndexPaths:(id)a0 fromDataSource:(id)a1 toDataSource:(id)a2 changeHistory:(id)a3;
