...
- (void)invocationEndSuccessfullyWithInvocationId:(id)a0 qssSessionId:(id)a1 localePair:(id)a2;
- (void)invocationEndWithInvocationId:(id)a0 error:(id)a1 qssSessionId:(id)a2 localePair:(id)a3;
...
- (id)sendFrameworkRequestWithInvocationId:(id)a0 qssSessionId:(id)a1 requestType:(long long)a2 requestRoute:(long long)a3 requestSize:(unsigned long long)a4 modelVersion:(id)a5;
