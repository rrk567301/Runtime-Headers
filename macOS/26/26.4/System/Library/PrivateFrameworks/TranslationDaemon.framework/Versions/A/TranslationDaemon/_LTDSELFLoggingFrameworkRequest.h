...
- (void).cxx_destruct;
- (id)initWithInvocationId:(id)a0 endpoints:(id)a1 sessionIdProvider:(id)a2 qssSessionId:(id)a3 requestType:(long long)a4 requestRoute:(long long)a5 requestSize:(unsigned long long)a6 modelVersion:(id)a7;
- (void)responseReceived:(unsigned long long)a0;
