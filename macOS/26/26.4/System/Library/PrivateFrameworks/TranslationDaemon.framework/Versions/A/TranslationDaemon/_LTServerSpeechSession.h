...
@protocol _LTTranslationEngine, _LTSpeechTranslationDelegate, OS_dispatch_source;
...
- (void)_addMultiFieldSpeechAudioData:(id)a0;
- (void)_addMultiFieldSpeechAudioData_onQueue:(id)a0;
