...
@interface VCSymptomReporter : NSObject {
    ...
    BOOL _didSubmitABCSymptom[82];
    BOOL _didShowAlreadyExistFailure[82];
...
- (void)dealloc;
- (int)reportPoorConnectionDespiteVideoReceivedWithOptionalDictionary:(id)a0;
- (void)reportSymptomCommon:(unsigned int)a0 shouldWaitForCompletion:(BOOL)a1 optionalDictionary:(id)a2;
...
- (BOOL)isSymptomReportingEnabled;
- (int)reportAlgosScoreWithOptionalDictionary:(id)a0;
- (int)reportAudioConnectionTimeRegressedFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportAudioErasurePercentageRegressedFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportAudioStall:(id)a0;
- (int)reportBandwidthEstimationMismatch;
- (int)reportCCReliableDataNotReceived:(id)a0;
- (int)reportConnectionSliceStatus:(unsigned int)a0;
...
- (int)reportInvalidVideoTxCaptureFrameCountWithOptionalDictionary:(id)a0;
- (int)reportKeyIndexNotReceived;
- (int)reportLongMediaStallRecoveredWithOptionalDictionary:(id)a0;
...
- (int)reportNoPackets:(unsigned int)a0 WithOptionalDictionary:(id)a1;
...
- (int)reportNoVideoDisplayedFailSafeFIRWithOptionalDictionary:(id)a0;
- (int)reportOSLogSymptomWithDictionary:(id)a0;
- (int)reportPoorConnectionPercentageRegressedFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportQRATKNTokenError;
- (int)reportRateTargetMismatch;
- (void)reportSelfTerminateSyncSymptom:(unsigned int)a0 optionalDictionary:(id)a1;
- (int)reportSelfTerminationWithOptionalDictionary:(id)a0;
...
- (int)reportThermalIncreaseAudioOnlyWithOptionalDictionary:(id)a0;
- (int)reportULSRTPEncryptionSetupError;
- (int)reportULTargetBitrateOvershoot;
- (int)reportUnbinnedCameraFormatSelected;
- (int)reportUnexpectedHighRTTWithOptionalDictionary:(id)a0;
- (int)reportUnexpectedLowTargetBitrate;
- (int)reportUnexpectedRampUpFrozen;
- (int)reportV1SpeechAPIEnabled;
- (int)reportVideoConnectionTimeRegressedFromTelemetryWithOptionalDictionary:(id)a0;
- (int)reportVideoReceiverEnqueueFrameRateTooHighWithOptionalDictionary:(id)a0;
- (int)reportVideoStall:(id)a0;
- (int)reportVideoStallPercentageRegressedFromTelemetryWithOptionalDictionary:(id)a0;
