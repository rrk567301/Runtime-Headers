@class VCReportingHistogram, NSString, VCReportingHistogram2D, VCHistogram, VCDurationHistogram, NSMutableDictionary, VCReportingDistribution, NSSet, NSMutableArray, DownlinkSegment, UplinkSegment, NSNumber;
...
@interface VCAggregatorMultiway : VCAggregator <SegmentStatsDelegate> {
    ...
    BOOL _sensitiveContentAnalysisForCamTxEnabled;
    BOOL _sensitiveContentAnalysisForCamRxEnabled;
    NSMutableDictionary *_nearbyStats;
    BOOL _hasReportedSliceStatusFailedSymptom;
    BOOL _hasReportedSliceStatusNotReceivedSymptom;
    BOOL _hasReportedSliceStatusFailedRemoteSymptom;
    BOOL _hasReportedSliceStatusNotReceivedRemoteSymptom;
...
- (void)markHDCaptureStopWithTimestamp:(double)a0;
...
- (void)populateSegmentBytes:(struct tagVCAggregatorFaceTimeSegmentStatsBytes { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; } *)a0 toPayload:(id)a1;
...
- (void)addFECMaxNumPacketsInFrame:(id)a0;
...
- (void)addSessionOperatingModeForCallReport:(id)a0;
...
- (double)audioErasureTotalTimeAlt:(id)a0;
...
- (void)markHDCaptureStartWithTimestamp:(double)a0;
...
- (void)processABCSymptomsForSliceStatus:(id)a0 currentSegmentName:(id)a1 isRemoteStatus:(BOOL)a2;
- (void)processActiveTemporalTiers:(id)a0;
- (void)processActualBitrateChange:(id)a0;
- (void)processAlwaysFullBleedUserPrefer:(id)a0;
...
- (void)processDeviceOrientation:(id)a0;
...
- (void)processFecConfigData:(id)a0;
- (void)processHDCaptureBenefitDistribution:(id)a0;
- (void)processHDCaptureEnabledWithPayload:(id)a0 withType:(unsigned short)a1 withTimestamp:(double)a2;
...
- (void)processNearbyStopWithPayload:(id)a0;
...
- (void)processPersistentSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; unsigned long long x8; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; BOOL x2; } x9; } *)a0;
...
- (void)processSliceStatusFailedABCSymptom:(id)a0 isRemoteStatus:(BOOL)a1;
- (void)processSliceStatusNotReceivedABCSymptom:(id)a0 isRemoteStatus:(BOOL)a1;
...
- (void)reallocateAndStartBoundedAlgoScorerWithTime:(double)a0;
...
- (void)resetRateControlMLEnrollmentAndStatsInSegment:(id)a0;
- (void)resetUplinkSegmentRateControlInfo;
- (void)resetUplinkSegmentWithStreamGroups:(unsigned int)a0 withPayload:(id)a1;
- (void)resetVideoStatsForU1OrMultiwaySwitch:(id)a0 participantID:(id)a1;
- (void)saveCallSegmentHistory;
- (void)screenEnabled:(id)a0 timestamp:(double)a1;
- (void)setAlgosScorerVideoResolution:(id)a0 time:(double)a1 participantID:(id)a2;
...
- (void)startAlgosScorer:(id)a0 time:(double)a1;
...
- (void)updateClientExperiments:(id)a0;
...
- (void)updateCurrentSatelliteNetworkStatusWithPayload:(id)a0;
...
- (void)updateFECMaxNumPacketsInFrame:(id)a0;
...
- (void)updateOperatingMode:(unsigned int)a0;
...
- (void)updateRateControlMachineLearningEnrollment:(id)a0;
- (void)updateRateControlMachineLearningRateControllerStats:(id)a0;
