@class NSDate, RTCReporting, NSArray, NSString, VCRemoteDataCollectionDumpProducer, VCPersistentDataStore, NSMutableDictionary, NWSMetricReporter, VCAggregator, NSObject, VCRateControlMachineLearningLocalTrainingDataProducer, NSNumber;
...
@interface RTCReportingAgent : NSObject <VCAggregatorDelegate, RTCReportingMessageSentNotifier> {
    ...
    BOOL _audioTotalConnectionTimeRegressedFromTelemetrySymptomReported;
    BOOL _videoTotalConnectionTimeRegressedFromTelemetrySymptomReported;
    id _awdAdaptor;
...
@property struct tagVCReportingClientSettingsPersist { char eyeContactStatus; char mlEnhanceStatus; char centerStageStatus; char portraitModeStatus; char studioLightStatus; char reactionsStatus; char backgroundReplacementStatus; char alwaysfullbleedUserPreferenceStatus; unsigned long long switches; struct tagVCReportingClientExperimentSettings { BOOL networkConditionMonitoringClientExperimentEnabled; BOOL motionBasedDuplicationClientExperimentEnabled; BOOL detectInactiveAudioFramesAACELD; } experimentSettings; } persistentSettings;
...
@property (getter=abcSymptomsReportingTelemetryThresholdValues) struct tagABCSymptomsReportingTelemetryThresholdValues { int audioConnectionTimeThreshold; int audioErasurePercentageThreshold; int poorConnectionPercentageThreshold; int videoConnectionTimeThreshold; int videoStallPercentageThreshold; } abcSymptomsReportingTelemetryThresholdValues;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;

- (id)initWithConfig:(struct { unsigned int x0; struct __CFString *x1; struct __CFDate *x2; int x3; BOOL x4; void *x5; id x6; struct __CFString *x7; struct __CFString *x8; struct __CFString *x9; struct __CFString *x10; struct __CFDictionary *x11; id /* block */ x12; id x13; BOOL x14; struct tagABCSymptomsReportingTelemetryThresholdValues { int x0; int x1; int x2; int x3; int x4; } x15; struct tagVCPersistentDataStoreConfiguration { BOOL x0; BOOL x1; struct __CFString *x2; } x16; })a0;
...
- (void)copyPersistentSettingsMultiway:(id)a0;
- (id)deriveFromParentHierarchyToken:(id)a0;
- (void)blockReportingQueueUntilReportingObjectInitialized;
- (BOOL)checkIfWeeklyIDIsExpired:(id)a0 currentWeek:(long long)a1 currentYear:(long long)a2;
- (void)collectTelemetryForService:(id)a0 payload:(id)a1 lock:(struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } *)a2;
- (void)copyPersistentSettingsCommon:(id)a0;
- (void)createSecondAggregatorWithOptions:(struct { id x0; BOOL x1; struct __CFDate *x2; struct __CFString *x3; struct __CFString *x4; BOOL x5; struct __CFString *x6; } *)a0;
- (id)directoryPathForWeeklyIDCache;
- (void)finalizeAggregation:(id)a0;
- (id)getUserInfoFromReportingConfiguration:(struct { unsigned int x0; struct __CFString *x1; struct __CFDate *x2; int x3; BOOL x4; void *x5; id x6; struct __CFString *x7; struct __CFString *x8; struct __CFString *x9; struct __CFString *x10; struct __CFDictionary *x11; id /* block */ x12; id x13; BOOL x14; struct tagABCSymptomsReportingTelemetryThresholdValues { int x0; int x1; int x2; int x3; int x4; } x15; struct tagVCPersistentDataStoreConfiguration { BOOL x0; BOOL x1; struct __CFString *x2; } x16; })a0;
- (id)newAggregatorForClientType:(int)a0 creationOptions:(struct { id x0; BOOL x1; struct __CFDate *x2; struct __CFString *x3; struct __CFString *x4; BOOL x5; struct __CFString *x6; } *)a1;
...
- (void)reportQR:(id)a0;
- (void)reportSegment:(id)a0 withMessageType:(unsigned short)a1 clientType:(int)a2;
...
- (void)reportingSelfTerminateSyncSymptom:(unsigned int)a0 withOptionalDict:(struct __CFDictionary { } *)a1;
...
- (void)reportingSymptomCommon:(unsigned int)a0 shouldWaitForCompletion:(BOOL)a1 withOptionalDict:(struct __CFDictionary { } *)a2;
...
- (void)sendMessageToAWDAdaptorWithCategory:(unsigned short)a0 type:(unsigned short)a1 payload:(id)a2;
- (void)sendMessageWithCategory:(unsigned short)a0 type:(unsigned short)a1 payload:(id)a2;
- (BOOL)sendMessageWithCategory:(unsigned short)a0 type:(unsigned short)a1 payload:(id)a2 error:(id *)a3 toAggregatorOnly:(BOOL)a4;
- (void)sendNetworkScoreDictionary:(id)a0 networkScoreType:(unsigned char)a1;
- (void)setAggregatorForClientType:(int)a0 isOneToOneEnabled:(BOOL)a1 shouldCreateSecondAggregator:(BOOL)a2;
- (void)setAndSaveWeeklyID:(id)a0 currentWeek:(unsigned long long)a1 currentYear:(unsigned long long)a2 cachePath:(id)a3;
- (void)setDataPath:(int)a0;
- (void)setUpWeeklyRotatingID;
- (void)setupAdaptiveLearningWithParameters:(id)a0;
- (BOOL)setupConfigurationCompletionSemaphore:(struct { unsigned int x0; struct __CFString *x1; struct __CFDate *x2; int x3; BOOL x4; void *x5; id x6; struct __CFString *x7; struct __CFString *x8; struct __CFString *x9; struct __CFString *x10; struct __CFDictionary *x11; id /* block */ x12; id x13; BOOL x14; struct tagABCSymptomsReportingTelemetryThresholdValues { int x0; int x1; int x2; int x3; int x4; } x15; struct tagVCPersistentDataStoreConfiguration { BOOL x0; BOOL x1; struct __CFString *x2; } x16; } *)a0;
- (void)setupPersistentDataStoreFromConfig:(struct { unsigned int x0; struct __CFString *x1; struct __CFDate *x2; int x3; BOOL x4; void *x5; id x6; struct __CFString *x7; struct __CFString *x8; struct __CFString *x9; struct __CFString *x10; struct __CFDictionary *x11; id /* block */ x12; id x13; BOOL x14; struct tagABCSymptomsReportingTelemetryThresholdValues { int x0; int x1; int x2; int x3; int x4; } x15; struct tagVCPersistentDataStoreConfiguration { BOOL x0; BOOL x1; struct __CFString *x2; } x16; })a0;
...
- (void)updateSelfTerminateSyncSymptomCount:(unsigned int)a0;
- (void)updateSymptomCount:(unsigned int)a0;
- (void)updateSymptomCountCommon:(unsigned int)a0 shouldWaitForCompletion:(BOOL)a1;
