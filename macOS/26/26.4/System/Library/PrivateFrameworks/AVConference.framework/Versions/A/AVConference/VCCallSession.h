...
@interface VCCallSession : NSObject <AVCRateControllerDelegate, VCTransportSessionLegacyDelegate, VCCaptionsReceiverDelegate, VCSecureDataChannelDelegate, VCPowerManagerThermalDelegate, VCAudioIOSink, VCRedundancyControllerDelegate> {
    ...
    BOOL useSBR;
    BOOL detectInactiveAudioFramesAACELD;
...
- (void)getVideoFeatureStatusSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; unsigned long long x8; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; BOOL x2; } x9; } *)a0;
