...
@property (readonly, nonatomic) BOOL supportsFoveation;
@property (readonly, nonatomic) BOOL shouldEnableLowPowerMode;
@property (readonly, nonatomic) BOOL supportsAlwaysHDCapture;
...
@property (readonly, nonatomic) BOOL supportsDecodingSquareCameraVideo;
@property (readonly, nonatomic) BOOL isMediaRecordingSupported;
@property (readonly, nonatomic) BOOL isMLEnhanceOneToOneSupported;
@property (readonly, nonatomic) BOOL isVCRateControlMLSupported;
@property (readonly, nonatomic) BOOL supportsCompressedPixelFormat;
@property (readonly, nonatomic) BOOL isDeviceLargeScreen;
@property (readonly, nonatomic) BOOL supportsOutOfProcessVideoDecoding;
@property (readonly, nonatomic) BOOL supportsOutOfProcessAudioDecoding;
...
- (BOOL)supportsOutOfProcessAudioDecodingForFormat:(unsigned int)a0;
