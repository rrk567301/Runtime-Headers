...
- (BOOL)isEndToEndLinkWithCellAvailable:(BOOL)a0;
...
- (void)setPreferredLocalInterfaceForDuplication:(int)a0;
- (void)setPreferredRemoteInterfaceForDuplication:(int)a0;
...
- (void)updateLocalLinkTechnology:(unsigned char)a0;
- (void)updateNegotiatedSettingsOnetoOne:(id)a0;
- (void)updateOneToOneBitrateCapsForConnection:(id)a0;
- (void)updatePathMTU:(unsigned short)a0 linkID:(unsigned char)a1;
