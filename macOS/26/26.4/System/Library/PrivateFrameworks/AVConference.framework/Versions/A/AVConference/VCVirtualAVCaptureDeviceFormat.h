@class NSString, NSArray, VCVirtualFigCaptureSourceVideoFormat;
...
@property (nonatomic, getter=isPortraitEffectSupported) BOOL portraitEffectSupported;
...
@property (nonatomic, getter=isCenterStageSupported) BOOL centerStageSupported;
@property (nonatomic) BOOL reactionEffectsSupported;
@property (nonatomic, getter=isStudioLightSupported) BOOL studioLightSupported;
@property (nonatomic, getter=isBackgroundReplacementSupported) BOOL backgroundReplacementSupported;
@property (nonatomic, getter=isBackgroundReplacementSupportedForContinuityCamera) BOOL backgroundReplacementSupportedForContinuityCamera;
