...
+ (long long)entitlementStatusForToken:(struct { unsigned int x0[8]; })a0;
...
- (id)autorelease;
- (void)appendClientAuditTokenToDictionary:(id)a0 clientAuditToken:(struct { unsigned int x0[8]; })a1;
...
- (void)sendMessageAsync:(const char *)a0 arguments:(id)a1 context:(id)a2;
- (id)retain;
- (id)newNSDictionaryWidthNSDictionary:(id)a0;
- (id)newNSDictionaryFromXPCDictionary:(id)a0;
- (void)registerBlockForService:(const char *)a0 block:(id /* block */)a1 queue:(id)a2 eventLogLevel:(int)a3 authorizationBlock:(id /* block */)a4 allowablePublicAPIs:(id)a5;
- (id)init;
