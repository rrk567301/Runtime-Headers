...
+ (void)initVideoFeatureStatusSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; unsigned long long x8; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; BOOL x2; } x9; } *)a0;
...
- (void)initAudioFeatureStatusSettings:(struct tagVCReportingClientSettingsPersist { char x0; char x1; char x2; char x3; char x4; char x5; char x6; char x7; unsigned long long x8; struct tagVCReportingClientExperimentSettings { BOOL x0; BOOL x1; BOOL x2; } x9; } *)a0;
...
- (void)handlePreferredInterfaceForDuplicationUpdate:(int)a0 notifyPeer:(BOOL)a1 enableDuplication:(BOOL)a2 isMediaUnrecoverableSignal:(BOOL)a3;
...
- (void)reportSatelliteNetworkStatusForConnection:(id)a0;
...
- (void)updateL4SModeWithNewPrimaryConnection:(id)a0;
