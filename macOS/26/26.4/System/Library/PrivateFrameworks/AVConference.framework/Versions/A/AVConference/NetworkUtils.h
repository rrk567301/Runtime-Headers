...
+ (id)networkAddressFromEndpoint:(id)a0;
+ (id)networkEmulationSettings:(id)a0;
+ (id)networkEmulationSettings:(id)a0 onUplink:(BOOL)a1;
+ (id)newEncryptionInfoWithMediaKeyIndex:(id)a0 participantID:(id)a1;
+ (id)newNWConnectionWithIPAddress:(id)a0 srcPort:(short)a1;
+ (id)newNetworkEndpointForLocalAddress:(id)a0 preferredPort:(unsigned short)a1;
+ (id)newNetworkEndpointForLocalLoopbackInterface:(unsigned short)a0;
+ (id)newRTPSocketDictionary:(BOOL)a0 rtpSourcePort:(short)a1;
+ (id)newRemoteEndpointArrayWithRemotePort:(int)a0 remoteSSRC:(unsigned int)a1;
+ (id)newRemoteEndpoints:(BOOL)a0;
