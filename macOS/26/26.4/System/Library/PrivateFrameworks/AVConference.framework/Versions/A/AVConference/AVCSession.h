@class AVCSessionParticipant, NSUUID, VCXPCClientShared, NSArray, NSString, NSMutableDictionary, NSDictionary, NSData, NSObject, VCSessionPresentationInfo, AVCSessionConfiguration;
...
- (void)completeAddParticipant:(id)a0 didSucceed:(BOOL)a1 error:(id)a2;
- (void)completeRemoveParticipant:(id)a0 didSucceed:(BOOL)a1 error:(id)a2;
- (void)deregisterFromNotifications;
- (void)didAddParticipantHandlerWithResult:(id)a0;
- (id)dispatchedConfiguration;
- (void)endParticipantConfiguration;
- (void)handleEndConfigurationOnParticipantAdd:(id)a0;
