...
@property (readonly, nonatomic) BOOL computeSpatial;
...
+ (double)closeupZoomPercentWithLayoutType:(unsigned long long)a0;
...
+ (double)scoreBonusAdaptiveWithLayoutType:(unsigned long long)a0;
+ (double)scoreBonusInactiveWithLayoutType:(unsigned long long)a0;
+ (double)scoreBonusOverlapStretchWithLayoutType:(unsigned long long)a0;
...
+ (double)targetCenterZoomFactorWithLayoutType:(unsigned long long)a0;
...
- (void).cxx_destruct;
- (id)_pickBestLayout:(id)a0 allowHeadroom:(BOOL)a1;
- (id)bestLayout:(id)a0;
...
- (id)intermediateWithSpatialStrategy:(unsigned long long)a0 intermediate:(id)a1;
