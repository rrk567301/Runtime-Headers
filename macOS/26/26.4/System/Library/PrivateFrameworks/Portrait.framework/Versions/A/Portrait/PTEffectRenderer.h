@class PTBackgroundReplacement, PTNormalAndDiffuseEstimation, PTEffectRelighting, PTEffectReactionProvider, PTEffectTemporalFilter, PTMSRResize, NSArray, PTTexture, PTEffectRingLightEstimation, PTPyramid, PTVFXRenderEffect, PTEffectDebugLayer, PTEffectDescriptor, PTRenderPipeline, PTEffectPersonSegmentation, PTMetalContext, PTCVMNetwork, PTRenderRequest, PTDepthConverter, PTGuidedFilter, PTColorConversion, PTMSRResizeAdditionalOutput, PTHumanDetections, PTEffectResources;
