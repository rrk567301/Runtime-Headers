...
+ (unsigned int)compressedPixelFormat:(unsigned int)a0;
+ (unsigned int)compressedPixelFormat:(unsigned int)a0 compression:(int)a1;
...
+ (id)createTextureFromPixelBuffer:(struct __CVBuffer { } *)a0 device:(id)a1 textureCache:(struct __CVMetalTextureCache { } *)a2 sRGB:(BOOL)a3 metalYCBCRConversion:(BOOL)a4;
...
+ (id)getMTLTextureDescriptor:(struct __CVBuffer { } *)a0 device:(id)a1 metalYCBCRConversion:(BOOL)a2;
...
+ (BOOL)is420YpCbCr8:(unsigned int)a0;
...
+ (BOOL)supportsMetalYCBCRConversion:(struct __CVBuffer { } *)a0;
...
- (struct __CVBuffer { } *)readPixelBufferFromFile:(id)a0 pixelFormat:(unsigned int)a1 ciOptions:(id)a2 enforceSRGB:(BOOL)a3;
