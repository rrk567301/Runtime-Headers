@class NSData, NSString, NSArray, NSURL, NSError, CMLClientConfig, CMLUseCaseGroup, CMLPIRConfig, CMLPECConfig, NSDictionary, CMLUseCaseStatus;
...
- (void)asyncResponseSimilarityScoresForElements:(NSArray *)a0 shardIds:(NSArray *)a1 clientConfig:(CMLClientConfig *)a2 reply:(void (^)(NSString *, NSError *))a3;
- (void)cacheFileForUseCase:(NSString *)a0 reply:(void (^)(NSURL *))a1;
...
- (void)dataVaultDirectory:(void (^)(NSURL *))a0;
...
- (void)removeCachedEntriesByKeywords:(NSArray *)a0 clientConfig:(CMLClientConfig *)a1 reply:(void (^)(long long, NSError *))a2;
...
- (void)similarityScoresForElements:(NSArray *)a0 shardIds:(NSArray *)a1 clientConfig:(CMLClientConfig *)a2 reply:(void (^)(NSArray *, NSError *))a3;
