...
- (id)asyncResponseSimilarityScoresForElements:(id)a0 shardId:(id)a1 error:(id *)a2;
- (id)asyncResponseSimilarityScoresForElements:(id)a0 shardIds:(id)a1 error:(id *)a2;
...
- (void)requestSimilarityScoresForElement:(id)a0 shardId:(id)a1 completionHandler:(id /* block */)a2;
- (void)requestSimilarityScoresForElement:(id)a0 shardIds:(id)a1 completionHandler:(id /* block */)a2;
- (void)requestSimilarityScoresForElements:(id)a0 shardId:(id)a1 completionHandler:(id /* block */)a2;
- (void)requestSimilarityScoresForElements:(id)a0 shardIds:(id)a1 completionHandler:(id /* block */)a2;
- (id)setPECConfig:(id)a0 error:(id *)a1;
- (id)similarityScoresForElement:(id)a0 shardId:(id)a1 error:(id *)a2;
- (id)similarityScoresForElement:(id)a0 shardIds:(id)a1 error:(id *)a2;
- (id)similarityScoresForElements:(id)a0 shardId:(id)a1 error:(id *)a2;
- (id)similarityScoresForElements:(id)a0 shardIds:(id)a1 error:(id *)a2;
