...
+ (id)optionForFlexibleFollowupWithAudioRecordType:(long long)a0 deviceId:(id)a1 startAttendingSampleCount:(unsigned long long)a2;
...
- (id)initWithAttendingType:(long long)a0 startAttendingHostTime:(unsigned long long)a1 startAttendingSampleCount:(unsigned long long)a2 useVAD:(BOOL)a3 useOwnVoiceVAD:(BOOL)a4 useBoron:(BOOL)a5 startOfSpeechThresholdInMs:(double)a6 prependAudioDuration:(double)a7 timeoutThresholdInSec:(double)a8 triggerType:(long long)a9 audioStreamHoldingDurationInSec:(double)a10 audioRecordType:(long long)a11 deviceId:(id)a12 attendingListeningType:(unsigned long long)a13 pauseDurationThreshold:(double)a14 maxPauseDelay:(double)a15;
