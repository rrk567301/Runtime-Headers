...
@property (retain, nonatomic) CSVoiceTriggerHearstAPEnabledPolicy *voiceTriggerHearstAPEnabledPolicy;
...
- (void)_transitHearstAPEnable:(BOOL)a0 withAudioProviderUUID:(id)a1;
