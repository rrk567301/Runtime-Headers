...
@protocol OS_dispatch_source, CSAudioProviderSelecting, OS_dispatch_queue;
...
@interface CSSmartSiriVolume : NSObject <CSMediaPlayingMonitorDelegate, CSAudioStreamProvidingDelegate, CSAudioServerCrashMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSSmartSiriVolumeProcessor> {
    ...
    struct unique_ptr<SmartSiriVolume, std::default_delete<SmartSiriVolume>> { struct { struct SmartSiriVolume *__ptr_; } ; } _smartSiriVolumeNoiseLevel;
    struct unique_ptr<SmartSiriVolume, std::default_delete<SmartSiriVolume>> { struct { struct SmartSiriVolume *__ptr_; } ; } _smartSiriVolumeLKFS;
