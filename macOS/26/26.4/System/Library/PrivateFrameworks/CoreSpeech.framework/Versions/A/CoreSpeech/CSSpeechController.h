@class NSDictionary, CSAudioStream, SSRVoiceProfileManager, CSSpeechEndHostTimeEstimator, CSXPCClientFactory, CSAudioStopStreamOption, SOClockAlarmObserver, NSString, SOClockTimerObserver, CSAudioPowerMeter, SSRSpeakerRecognitionController, CSPlainAudioFileWriter, CSAudioSampleRateConverter, CSSelectiveChannelAudioFileWriter, NSMutableDictionary, NSArray, CSAsset, SOMediaNowPlayingObserver, CSUncompressedAudioLogging, CSAudioZeroCounter, NSObject, CSContinuousVoiceTrigger, CSAudioRecordContext, CSLanguageDetector, CSSpeakerRecognitionProxy, CSAudioSessionController, CSRCHandlingXPCClient, CSXPCClient, CSVolumeMonitor, CSFAudioConverter, NSUUID, CSSmartSiriVolumeController, CSFAudioDeviceInfo;
