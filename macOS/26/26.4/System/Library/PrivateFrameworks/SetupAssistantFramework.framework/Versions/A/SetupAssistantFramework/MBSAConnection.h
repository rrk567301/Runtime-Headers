...
- (void)performFastUserSwitchToLocallyCreatedUserWithUID:(unsigned int)a0 withPassword:(id)a1 isDemoUser:(BOOL)a2 completionBlock:(id /* block */)a3;
...
- (void)setResumeBuddyCookieForReason:(id)a0 forOriginatingApp:(id)a1 migrationMode:(id)a2 withCompletionBlock:(id /* block */)a3;
...
- (id)synchronousConnectionWithErrorHandler:(id /* block */)a0;
...
- (void)writeMiniBuddyCookieForUser:(unsigned int)a0 completion:(id /* block */)a1;
