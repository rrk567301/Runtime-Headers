...
- (id)initWithBundleID:(id)a0 path:(id)a1 runState:(unsigned long long)a2 processID:(int)a3 activationPolicy:(unsigned long long)a4 eventID:(unsigned long long)a5 processName:(id)a6;
