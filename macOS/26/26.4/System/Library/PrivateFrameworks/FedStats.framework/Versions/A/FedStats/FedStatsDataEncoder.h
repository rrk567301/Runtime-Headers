...
+ (id)extractAssetNamesFrom:(id)a0 usingFieldValues:(id)a1 error:(id *)a2;
+ (id)extractRequiredFieldsFrom:(id)a0 error:(id *)a1;
+ (id)mutateCollectionKeyForHistogramType:(id)a0;
