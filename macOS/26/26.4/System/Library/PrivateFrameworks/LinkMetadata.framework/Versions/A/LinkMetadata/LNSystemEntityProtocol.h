...
@property (class, readonly, nonatomic) LNSystemEntityProtocol *collaborativeEntityProtocol;
...
@property (class, readonly, nonatomic) LNSystemEntityProtocol *structuredDataRepresentableTypeProtocol;
