@class LNValueType, NSString, LNVisibilityMetadata, NSArray, NSDictionary, NSOrderedSet, LNActionDescriptionMetadata;
...
@property (readonly, nonatomic) BOOL defaultQueryForEntity;
...
- (id)queryMetadataWithSourceBundleIdentifier:(id)a0;
...
- (id)initWithIdentifier:(id)a0 entityType:(id)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 parameters:(id)a5 sortingOptions:(id)a6 availabilityAnnotations:(id)a7 capabilities:(unsigned long long)a8 descriptionMetadata:(id)a9 visibilityMetadata:(id)a10 defaultQueryForEntity:(BOOL)a11;
- (id)initWithIdentifier:(id)a0 entityType:(id)a1 mangledTypeName:(id)a2 mangledTypeNameByBundleIdentifier:(id)a3 effectiveBundleIdentifiers:(id)a4 parameters:(id)a5 sortingOptions:(id)a6 availabilityAnnotations:(id)a7 capabilities:(unsigned long long)a8 descriptionMetadata:(id)a9 visibilityMetadata:(id)a10 defaultQueryForEntity:(BOOL)a11 fullyQualifiedIdentifier:(id)a12;
- (id)initWithIdentifier:(id)a0 inputValueType:(id)a1 resultValueType:(id)a2 mangledTypeName:(id)a3 mangledTypeNameByBundleIdentifier:(id)a4 effectiveBundleIdentifiers:(id)a5 parameters:(id)a6 sortingOptions:(id)a7 availabilityAnnotations:(id)a8 capabilities:(unsigned long long)a9 descriptionMetadata:(id)a10 visibilityMetadata:(id)a11 defaultQueryForEntity:(BOOL)a12 fullyQualifiedIdentifier:(id)a13;
- (id)initWithIdentifier:(id)a0 inputValueType:(id)a1 resultValueType:(id)a2 mangledTypeName:(id)a3 mangledTypeNameByBundleIdentifier:(id)a4 effectiveBundleIdentifiers:(id)a5 parameters:(id)a6 sortingOptions:(id)a7 availabilityAnnotations:(id)a8 capabilities:(unsigned long long)a9 descriptionMetadata:(id)a10 visibilityMetadata:(id)a11 defaultQueryForEntity:(BOOL)a12 fullyQualifiedIdentifier:(id)a13 allowedTargets:(id)a14;
