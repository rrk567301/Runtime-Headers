...
@property (readonly) BOOL hasStorageIvar;
@property (readonly) BOOL isStorageForSpecificOwnerClassInfo;
...
- (id)_initWithClass:(unsigned long long)a0 type:(unsigned int)a1 realizedOnly:(BOOL)a2 infoMap:(id)a3 objectIdentifier:(id)a4;
...
- (void)_setHasStorageIvar:(BOOL)a0;
...
- (void)_setIsStorageForSpecificOwnerClassInfo:(BOOL)a0;
...
- (id)initWithClass:(unsigned long long)a0 type:(unsigned int)a1 infoMap:(id)a2 objectIdentifier:(id)a3;
...
- (id)initWithRealizedClass:(unsigned long long)a0 type:(unsigned int)a1 infoMap:(id)a2 objectIdentifier:(id)a3;
- (id)initWithSerializer:(id)a0 classMap:(id)a1 version:(unsigned int)a2 error:(id *)a3;
- (id)instanceSpecificInfoForObject:(unsigned long long)a0 ofSize:(unsigned int)a1 withScanner:(id)a2 memoryCache:(id)a3;
- (BOOL)isOSObject;
