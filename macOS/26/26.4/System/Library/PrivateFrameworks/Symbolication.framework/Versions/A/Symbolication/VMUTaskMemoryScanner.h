...
@property (readonly, nonatomic) struct _VMURegionNode { id x0; unsigned int *x1; unsigned int x2; unsigned int x3; unsigned long long x4; unsigned long long x5; BOOL x6; id x7; struct _VMURegionNode *x8; } *regions;
...
- (struct _VMURegionNode { id x0; unsigned int *x1; unsigned int x2; unsigned int x3; unsigned long long x4; unsigned long long x5; BOOL x6; id x7; struct _VMURegionNode *x8; } *)validateAddressRangeForSwiftRemoteMirror:(struct _VMURange { unsigned long long x0; unsigned long long x1; })a0 allowUnusedSplitLibs:(BOOL)a1;
...
- (id)_recursivelyIdentifySwiftAsyncTaskSlabs:(unsigned long long)a0 containerRange:(struct _VMURange { unsigned long long x0; unsigned long long x1; })a1 remoteBlock:(unsigned long long)a2 mappedBlock:(const void *)a3 asyncTaskSlabMetadataIsa:(unsigned long long)a4 nestingLevel:(unsigned int)a5;
- (void)_sortBlocks;
...
- (void)withContentForNode:(unsigned int)a0 block:(id /* block */)a1;
