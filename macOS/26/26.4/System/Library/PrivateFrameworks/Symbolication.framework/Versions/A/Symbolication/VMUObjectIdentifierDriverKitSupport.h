...
- (id)_fieldsFromStructureLayout:(const struct { unsigned long long x0; unsigned long long x1; char *x2; unsigned long long x3; unsigned long long x4; struct _IntrospectedObjectField { char *x0; char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; } x5[0]; } *)a0 withOffset:(unsigned long long)a1;
...
- (id)classInfoForDriverKitMemory:(void *)a0 length:(unsigned long long)a1 atOffset:(unsigned long long)a2 translatedIsa:(unsigned long long)a3 symbol:(struct _CSTypeRef { unsigned long long x0; unsigned long long x1; })a4 remoteAddress:(unsigned long long)a5;
