...
@property (nonatomic) BOOL hasStorageIvar;
@property (nonatomic) BOOL isStorageForSpecificOwnerClassInfo;
...
- (void)setHasStorageIvar:(BOOL)a0;
...
- (void)setSuperclassOffset:(unsigned int)a0;
...
- (void)setIsStorageForSpecificOwnerClassInfo:(BOOL)a0;
