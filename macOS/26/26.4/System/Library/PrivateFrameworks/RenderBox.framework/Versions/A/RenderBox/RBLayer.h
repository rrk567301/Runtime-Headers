...
@interface RBLayer : CALayer <_RBSharedSurfaceOwner, RBDrawableStatistics> {
    ...
    struct atomic<bool> { struct __cxx_atomic_impl<bool, std::__cxx_atomic_base_impl<bool>> { _Atomic BOOL __a_value; } __a_; } _failed_before;
    float _dpy_headroom;
...
- (void)display;
- (void)_commandBufferError:(id)a0 failedBefore:(BOOL)a1;
