...
- (oneway void)fetchToolInvocationSummaryForInvocation:(id)a0 fetchingDefaultValues:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (oneway void)resolveContent:(id)a0 completionHandler:(id /* block */)a1;
- (oneway void)resolveDeferredValueFromEncodedStorage:(id)a0 withResolutionRequest:(id)a1 completionHandler:(id /* block */)a2;
- (oneway void)resolveParameterWithIdentifier:(id)a0 toolInvocation:(id)a1 resolutionRequest:(id)a2 completionHandler:(id /* block */)a3;
...
- (oneway void)transformAction:(id)a0 completionHandler:(id /* block */)a1;
