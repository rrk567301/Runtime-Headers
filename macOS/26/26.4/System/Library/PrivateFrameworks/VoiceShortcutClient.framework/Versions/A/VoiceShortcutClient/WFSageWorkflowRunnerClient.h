...
@property (readonly, nonatomic) struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } stepLock;
...
- (void)fetchToolInvocationSummaryForInvocation:(id)a0 fetchingDefaultValues:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)forTestingOnly_simulateXPCInterruption;
- (id)initWithClientIdentifier:(id)a0 siriSessionID:(id)a1 locale:(id)a2 runSource:(id)a3;
...
- (void)resignDialogHandlingIfNeededWithPersistentMode:(BOOL)a0;
- (void)resolveContent:(id)a0 completionHandler:(id /* block */)a1;
- (void)resolveDeferredValueFromEncodedStorage:(id)a0 withResolutionRequest:(id)a1 completionHandler:(id /* block */)a2;
- (void)resolveParameterWithIdentifier:(id)a0 toolInvocation:(id)a1 resolutionRequest:(id)a2 completionHandler:(id /* block */)a3;
- (void)stepWithEncodedToolInvocation:(id)a0 completionHandler:(id /* block */)a1;
- (void)transformAction:(id)a0 completionHandler:(id /* block */)a1;
