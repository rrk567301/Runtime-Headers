...
+ (id)identifierWithIdentifier:(id)a0 computeUnits:(unsigned long long)a1;
+ (BOOL)isBridgeVersion:(unsigned long long)a0 compatibleWithEmbeddingVersion:(unsigned long long)a1;
+ (id)sharedModel:(id)a0 identifier:(id)a1 outputNames:(id)a2 inputNames:(id)a3 functionName:(id)a4 precompiled:(BOOL)a5 computeUnits:(unsigned long long)a6;
...
- (id)initWithRequestedAnalyses:(unsigned long long)a0 andRevision:(id)a1 useSharedModel:(BOOL)a2 computeUnits:(unsigned long long)a3;
