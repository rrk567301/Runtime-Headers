...
@interface SPCoreSpotlightQuery : SPMetadataQuery {
    ...
    struct IndexResultsRegistry { unsigned long long queryId; unsigned long long logToken; NSString *redactedQuery; struct vector<IndexResults, std::allocator<IndexResults>> { struct IndexResults *__begin_; struct IndexResults *__end_; struct { struct IndexResults *__cap_; } ; } results; NSMutableDictionary *indexMapping; } _indexResultsRegistry;
...
- (void)foundItems:(id)a0 sendResponseImmediately:(BOOL)a1;
- (void)gatherEnded;
- (void)initQuery;
