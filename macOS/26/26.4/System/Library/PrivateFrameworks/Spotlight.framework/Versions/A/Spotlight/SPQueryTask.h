@class NSMutableDictionary, SFSearchResult_SpotlightExtras, NSDate, NSDictionary, NSObject, NSMutableArray, SPSearchQueryContext, NSString, SSBullseyeTopHitsManager, PRSRankingConfiguration, NSMutableSet, SPMetadataQuery, NSArray, SPApplicationQuery, SFMutableResultSection, SSRankingManager, SPKQuery;
...
+ (id)_askLLMResult;
+ (id)_askSiriResult;
+ (id)_counterpartBundleIdentifierForOnenessApp:(id)a0;
...
+ (id)_showAllInFinderResultForQuery:(id)a0 queryID:(unsigned long long)a1;
...
+ (BOOL)canUseNLPSignalFromQUIntent:(int)a0;
...
+ (BOOL)isResponseEligibleForUpdateForSections:(id)a0 task:(id)a1 config:(id)a2 response:(id)a3;
...
+ (BOOL)responseContainsPriorityResult:(id)a0 queryId:(unsigned long long)a1 redactedQuery:(id)a2;
