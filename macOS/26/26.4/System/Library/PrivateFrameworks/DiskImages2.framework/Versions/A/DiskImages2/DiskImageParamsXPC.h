...
+ (id)newWithBackendXPC:(id)a0 error:(id *)a1;
...
- (struct unique_ptr<DiskImage, std::default_delete<DiskImage>> { struct { struct DiskImage *x0; } x0; })createDiskImageWithCache:(BOOL)a0 shadowValidation:(BOOL)a1;
