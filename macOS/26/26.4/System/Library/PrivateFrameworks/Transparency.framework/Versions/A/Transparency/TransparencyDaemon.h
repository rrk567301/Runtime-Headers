...
- (void)ktQuery:(id)a0 application:(id)a1 queryOptions:(id)a2 complete:(id /* block */)a3;
- (void)ktQuery:(id)a0 application:(id)a1 queryOptions:(id)a2 trace:(id)a3 complete:(id /* block */)a4;
- (void)ktRepair:(id)a0 complete:(id /* block */)a1;
- (void)maybeUpdateMonitorState;
- (void)networkKTPublicKeyBag:(id)a0 queryOptions:(id)a1 traceUUID:(id)a2 complete:(id /* block */)a3;
- (void)networkKTQuery:(id)a0 application:(id)a1 complete:(id /* block */)a2;
- (void)networkKTQuery:(id)a0 application:(id)a1 traceUUID:(id)a2 complete:(id /* block */)a3;
...
- (void)validateURIs:(id)a0 queryOptions:(id)a1 complete:(id /* block */)a2;
- (void)validateURIs:(id)a0 queryOptions:(id)a1 traceUUID:(id)a2 complete:(id /* block */)a3;
