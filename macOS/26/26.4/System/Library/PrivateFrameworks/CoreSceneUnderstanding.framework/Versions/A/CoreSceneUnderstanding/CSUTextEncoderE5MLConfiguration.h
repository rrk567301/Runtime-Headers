...
+ (id)getConfigurationForRevision_v7_0_Tier0WithError:(id *)a0;
+ (id)getConfigurationFromModelCatalogForRevision_ADM_v10Revision_v1WithError:(id *)a0;
...
- (BOOL)isTextEncoderE5MLPresentForLatestRevision;
- (BOOL)isTextEncoderE5MLPresentForTextEncoderVersion:(id)a0 forTextEncoderName:(id)a1;
