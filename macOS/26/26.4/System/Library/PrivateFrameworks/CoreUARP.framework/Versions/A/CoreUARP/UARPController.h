@class UARPPacketDumper, NSString, NSArray, UARPUploader, UARPPowerLogManager, NSMutableDictionary, UARPPersonalizationManager, UARPAnalyticsUpdateFirmwareManager, NSObject, UARPAccessoryMetadataStore, NSNumber, NSCache;
...
- (void)unregisterForSupportedAccessoriesFileAvailability:(int)a0;
...
- (void)availabilityNotificationForSupportedAccessoriesFilePosted:(int)a0;
...
- (id)copyChipMetadataForRecordName:(id)a0;
...
- (BOOL)subscribeForChipSupportedAccessories;
