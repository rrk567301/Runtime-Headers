...
@property (class) unsigned long long forcedGlitchTimeRatioContributedVersion;
@property (class, readonly) unsigned long long effectiveGlitchTimeRatioContributedVersion;
...
+ (id)frameStatisticsForFrameLifetimes:(id)a0;
+ (id)normalizeOverrunIntervals:(id)a0;
...
- (id)frameStatisticsForDisplayID:(id)a0;
