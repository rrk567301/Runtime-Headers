...
+ (id)optimizeSceneKitAnimation:(id)a0 target:(id)a1;
...
- (id)_initWithSceneKitScene:(id)a0 usdaMetadata:(struct { BOOL x0; double x1; double x2; double x3; })a1 identifier:(id)a2;
...
- (id)initWithSceneKitScene:(id)a0;
- (id)initWithSceneKitScene:(id)a0 usdaMetadata:(struct { BOOL x0; double x1; double x2; double x3; })a1;
- (id)initWithSceneKitSceneAtURL:(id)a0;
- (id)initWithSceneKitSceneAtURL:(id)a0 usdaMetadata:(struct { BOOL x0; double x1; double x2; double x3; })a1;
