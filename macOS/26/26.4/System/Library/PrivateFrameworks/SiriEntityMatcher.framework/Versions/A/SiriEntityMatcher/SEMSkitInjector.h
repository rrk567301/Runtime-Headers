...
@interface SEMSkitInjector : NSObject <SEMSkitReadAccess, SEMSkitAccessProvider> {
    ...
    struct Indexer { struct ContextV2 { struct shared_ptr<skit::internal::ContextImpl> { struct ContextImpl *__ptr_; struct __shared_weak_count *__cntrl_; } pimpl; } context; struct IndexWriter { struct unique_ptr<skit::internal::IndexWriterImpl, std::default_delete<skit::internal::IndexWriterImpl>> { struct { struct IndexWriterImpl *__ptr_; } ; } pimpl; } index_writer; long long index_locale; struct basic_string<char16_t, std::char_traits<char16_t>, std::allocator<char16_t>> { struct { union __rep { struct __short { unsigned short __data_[11]; struct __padding<1UL> { char __padding_[1]; } __padding_; unsigned char __size_ : 7; unsigned char __is_long_ : 1; } __s; struct __long { unsigned short *__data_; unsigned long long __size_; unsigned long __cap_ : 63; unsigned char __is_long_ : 1; } __l; } __rep_; } ; } index_locale_id; struct shared_ptr<semskitbridge::Tokenizer> { struct Tokenizer *__ptr_; struct __shared_weak_count *__cntrl_; } tokenizer; struct shared_ptr<semskitbridge::Analyzer> { struct Analyzer *__ptr_; struct __shared_weak_count *__cntrl_; } analyzer; struct Alias { struct shared_ptr<skit::internal::AliasImpl> { struct AliasImpl *__ptr_; struct __shared_weak_count *__cntrl_; } pimpl; } alias; struct TrialFactors { BOOL use_contact_aliases; BOOL use_contact_emoji_matches; BOOL use_contact_diacritics_stripping; BOOL use_contact_prefix_matching; BOOL use_contact_phonetic_search; BOOL use_token_lemmatization; int phonetic_search_n_gram_order; BOOL use_media_threshold_filtering; BOOL index_phonetic_vector_db; } trial_factors; unsigned short index_features; } _indexer;
    ...
    struct vector<std::pair<semskitbridge::SearchGroup, std::vector<std::byte>>, std::allocator<std::pair<semskitbridge::SearchGroup, std::vector<std::byte>>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _documents;
}
