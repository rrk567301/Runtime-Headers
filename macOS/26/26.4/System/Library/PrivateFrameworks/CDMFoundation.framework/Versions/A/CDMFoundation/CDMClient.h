...
- (id)createNLContextWithSystemOffered:(id)a0;
- (id)createSystemDialogAct:(id)a0;
- (id)createUserDialogActFromGraph:(id)a0;
- (BOOL)daemonKilled;
...
- (void)processShortcutDetectorRequestWithText:(id)a0 requestId:(id)a1 completionHandler:(id /* block */)a2;
- (void)processSsuInferenceRequest:(id)a0 completionHandler:(id /* block */)a1;
- (void)processSystemOfferedText:(id)a0 requestConnectionId:(id)a1 offeredGraph:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)processText:(id)a0 requestConnectionId:(id)a1 nlContext:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)setupShortcutDetectorWithLocale:(id)a0 requestId:(id)a1 serviceStateDirectory:(id)a2 overrideSiriVocabSpans:(id)a3 completionHandler:(id /* block */)a4;
