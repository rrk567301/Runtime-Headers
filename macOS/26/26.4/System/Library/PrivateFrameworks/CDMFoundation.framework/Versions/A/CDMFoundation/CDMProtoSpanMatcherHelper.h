...
+ (id)buildUsoEntitySpan:(id)a0 semantic:(id)a1 nodeIndex:(int)a2 startIndex:(unsigned int)a3 endIndex:(unsigned int)a4 tokenCount:(unsigned int)a5;
+ (id)buildUsoEntitySpan:(id)a0 semantic:(id)a1 nodeIndex:(int)a2 startIndex:(unsigned int)a3 endIndex:(unsigned int)a4 tokenCount:(unsigned int)a5 originAppId:(id)a6;
