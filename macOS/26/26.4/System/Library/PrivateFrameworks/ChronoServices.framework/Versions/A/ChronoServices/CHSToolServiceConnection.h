...
- (oneway void)runReaper:(id)a0 completion:(id /* block */)a1;
- (oneway void)subscribeToTaskServiceStateWithDelegate:(id)a0 completion:(id /* block */)a1;
- (oneway void)taskServiceStateDidChange:(id)a0;
