@class BSColor, NSString, CHSGlassOptions;
...
@property (readonly, nonatomic) BOOL wantsGlassMaterial;
@property (readonly, nonatomic) BOOL isClearGlass;
@property (readonly, nonatomic) BOOL isAccentedGlass;
...
- (id)copyWithFilterStyle:(long long)a0;
- (BOOL)isEqual:(id)a0;
...
- (id)initWithFilterStyle:(long long)a0 primaryTintColor:(id)a1 secondaryTintColor:(id)a2 fraction:(double)a3;
- (id)initWithFilterStyle:(long long)a0 primaryTintColor:(id)a1 secondaryTintColor:(id)a2;
