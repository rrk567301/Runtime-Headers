@class NSString, _TtC14ChronoServices32LiveActivityDescriptorsPredicate, CHSControlDescriptorsPredicate, CHSWidgetDescriptorsPredicate;
...
- (id)initWithWidgetsPredicate:(id)a0 controlsPredicate:(id)a1 liveActivitiesPredicate:(id)a2 includeIntents:(BOOL)a3;
- (BOOL)matchesControlDescriptor:(id)a0;
- (BOOL)matchesExtension:(id)a0;
- (BOOL)matchesLiveActivityDescriptor:(id)a0;
