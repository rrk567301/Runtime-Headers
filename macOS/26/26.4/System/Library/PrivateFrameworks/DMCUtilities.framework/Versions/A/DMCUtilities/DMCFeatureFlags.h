...
@property (class, readonly, nonatomic, getter=isAuthenticatedTemporarySessionEnabled) BOOL AuthenticatedTemporarySessionEnabled;
@property (class, readonly, nonatomic, getter=isDirectUserSwitchEnabled) BOOL DirectUserSwitchEnabled;
