...
@interface CCTAAAlgorithm : CCAlgorithm {
    ...
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _hRatesVector;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _vRatesVector;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _hFactorVector;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _vFactorVector;
    struct vector<TAARegion1D, std::allocator<TAARegion1D>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _hRegionVector[2];
    struct vector<TAARegion1D, std::allocator<TAARegion1D>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _vRegionVector[2];
    ...
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _rasterizationRatesX;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _rasterizationRatesY;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _accumulationFactorsX;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _accumulationFactorsY;
