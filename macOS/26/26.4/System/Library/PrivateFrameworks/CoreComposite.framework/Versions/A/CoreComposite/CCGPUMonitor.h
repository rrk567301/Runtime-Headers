...
@interface CCGPUMonitor : NSObject {
    ...
    struct unordered_map<unsigned long long, CCGPUPerformanceCounterSnapshot, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, CCGPUPerformanceCounterSnapshot>>> { struct __hash_table<std::__hash_value_type<unsigned long long, CCGPUPerformanceCounterSnapshot>, std::__unordered_map_hasher<unsigned long long, std::pair<const unsigned long long, CCGPUPerformanceCounterSnapshot>, std::hash<unsigned long long>, std::equal_to<unsigned long long>>, std::__unordered_map_equal<unsigned long long, std::pair<const unsigned long long, CCGPUPerformanceCounterSnapshot>, std::equal_to<unsigned long long>, std::hash<unsigned long long>>, std::allocator<std::pair<const unsigned long long, CCGPUPerformanceCounterSnapshot>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, CCGPUPerformanceCounterSnapshot>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, CCGPUPerformanceCounterSnapshot>, void *> *> *>>> { struct { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, CCGPUPerformanceCounterSnapshot>, void *> *> *>> { struct { unsigned long long __size_; } ; } __deleter_; } ; } __bucket_list_; struct { struct __hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, CCGPUPerformanceCounterSnapshot>, void *> *> { void *__next_; } __first_node_; } ; struct { unsigned long long __size_; } ; struct { float __max_load_factor_; } ; } __table_; } _perfSnapshotPool;
}
