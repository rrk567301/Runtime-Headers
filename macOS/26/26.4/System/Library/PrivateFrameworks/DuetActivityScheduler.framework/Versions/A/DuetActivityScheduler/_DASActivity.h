@class NSMutableDictionary, NSURL, _DASAssertion, NSDate, NSDictionary, NSUUID, NSObject, _DASFileProtection, NSMutableArray, NSString, NSSet, NSMutableSet, NSArray, _DASFastPass, _DASContinuedProcessingWrapper, NSProgress;
...
@interface _DASActivity : NSObject <NSCopying, NSSecureCoding> {
    ...
    BOOL _requiresDeviceInactivityIsSetByUser;
...
@property (nonatomic) BOOL runWhenAppLaunchUnlikely;
...
@property (nonatomic) BOOL startedOnBattery;
@property (nonatomic) BOOL startedInIdle;
@property (nonatomic) BOOL indeedCPUIntensive;
@property (nonatomic) BOOL indeedMemoryIntensive;
@property (nonatomic) BOOL thermalLevelElevated;
...
@property (readonly, nonatomic) BOOL isEmergencySOSActivity;
...
+ (id)continuedProcessingActivityWithName:(id)a0;
+ (unsigned long long)convertUUIDToUint64:(id)a0;
...
- (unsigned long long)hashArrayOfString:(id)a0;
- (unsigned long long)hashString:(id)a0;
...
- (BOOL)isIndeedIntensive;
- (BOOL)isIntensive;
- (BOOL)isLowPriorityIdleStackTask;
...
- (BOOL)shouldImposeDeviceInactivity;
