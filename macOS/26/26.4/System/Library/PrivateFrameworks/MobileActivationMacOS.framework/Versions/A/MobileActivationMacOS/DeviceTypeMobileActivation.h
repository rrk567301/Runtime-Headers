...
@property (readonly, nonatomic) BOOL device_supports_mfi_certificates;
@property (readonly, nonatomic) BOOL device_supports_eda_certificates;
...
@property (readonly, nonatomic) BOOL is_factory_restored;
@property (readonly, nonatomic) BOOL has_internal_diagnostics;
@property (readonly, nonatomic) BOOL ucrt_enforced;
...
- (id)copyDeviceTreeInt:(id)a0 key:(id)a1;
