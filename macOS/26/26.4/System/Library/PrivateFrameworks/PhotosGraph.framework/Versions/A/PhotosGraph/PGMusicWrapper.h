...
+ (void)requestFlexMusicCurationWithCurationOptions:(id)a0 graphManager:(id)a1 progressReporter:(id)a2 reply:(id /* block */)a3;
+ (void)requestMaestroSongsWithOptions:(id)a0 graphManager:(id)a1 progressReporter:(id)a2 reply:(id /* block */)a3;
...
+ (void)requestMusicCurationWithCurationOptions:(id)a0 graphManager:(id)a1 progressReporter:(id)a2 reply:(id /* block */)a3;
+ (void)requestRecentlyUsedSongsWithOptions:(id)a0 graphManager:(id)a1 progressReporter:(id)a2 reply:(id /* block */)a3;
