@class PGGraphWeekOfYearNodeCollection, PGGraphWeekOfMonthNodeCollection, PGGraphYearNodeCollection, PGGraphMonthDayNodeCollection, PGGraphHolidayNodeCollection, NSArray, NSDateInterval, PGGraphSeasonNodeCollection, PGGraphMomentNodeCollection, PGGraphMonthNodeCollection, PGGraphDayNodeCollection;
...
+ (id)dateNodesForDateComponents:(id)a0 inGraph:(id)a1;
