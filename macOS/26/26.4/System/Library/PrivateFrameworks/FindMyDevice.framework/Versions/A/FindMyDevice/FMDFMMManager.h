...
- (void)commandValidationSignatureWithContext:(id)a0 completion:(id /* block */)a1;
...
- (void)enableRepairWithContext:(id)a0 completion:(id /* block */)a1;
...
- (void)getRepairStateWithContext:(id)a0 reply:(id /* block */)a1;
...
- (void)simulatePushWithPayload:(id)a0 completion:(id /* block */)a1;
