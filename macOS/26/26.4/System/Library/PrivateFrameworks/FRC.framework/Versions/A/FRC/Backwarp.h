...
- (void)encodeUpscaleFlowToCommandBuffer:(SEL)a0 source:(id)a1 destination:(id)a2 scaleFactor:(id)a3 rotation:(BOOL)a4;
...
- (void)encodeToCommandBuffer:(id)a0 source:(id)a1 flow:(id)a2 destination:(id)a3;
