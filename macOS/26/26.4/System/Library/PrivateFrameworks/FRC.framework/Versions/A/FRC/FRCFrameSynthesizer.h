...
@protocol OS_os_log, MTLDeviceSPI, MTLCommandQueue;
...
- (void)updateFlowSize;
- (id)initWithUsage:(long long)a0 qualityMode:(long long)a1 bypassFrameStats:(BOOL)a2;
- (id)initWithUsage:(long long)a0 qualityMode:(long long)a1 normalizationMode:(long long)a2;
