...
- (long long)flowAdaptationFrom:(struct __CVBuffer { } *)a0 to:(struct __CVBuffer { } *)a1 inputFlow:(struct __CVBuffer { } *)a2 outputFlow:(struct __CVBuffer { } *)a3;
- (struct __CVBuffer { } *)matchFlow:(struct __CVBuffer { } *)a0 callback:(id /* block */)a1;
- (void)matchFlow:(struct __CVBuffer { } *)a0 toFullSizeFlow:(struct __CVBuffer { } *)a1 callback:(id /* block */)a2;
- (long long)opticalFlowFrom:(struct __CVBuffer { } *)a0 to:(struct __CVBuffer { } *)a1 flow:(struct __CVBuffer { } *)a2 completionHandler:(id /* block */)a3;
