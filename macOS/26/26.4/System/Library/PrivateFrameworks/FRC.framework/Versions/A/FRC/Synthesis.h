@class Tiling, NSString, FlowConsistencyMap, Forwarp, NSObject, Pyramid, SynthesisGridNet, Backwarp;
...
- (void)createConsistencyMapFormFirstImage:(struct __CVBuffer { } *)a0 secondImage:(struct __CVBuffer { } *)a1 flowForward:(struct __CVBuffer { } *)a2 flowBackward:(struct __CVBuffer { } *)a3;
...
- (id)initWithMode:(long long)a0 mtlDevice:(id)a1 commandQueue:(id)a2;
- (void)releaseTiles;
