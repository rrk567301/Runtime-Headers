...
+ (id)_sortedCalendarIdentifiersFrom:(id)a0;
...
+ (id)_dataForLunarCalendar:(id)a0;
...
+ (void)checkForDiscoveredLanguages:(id /* block */)a0;
...
+ (BOOL)isChineseLikeLunarCalendar:(id)a0;
