...
+ (id)fetchAppAssetForBundleID:(id)a0 error:(id *)a1;
...
+ (BOOL)preflightMigrationWithConfigurations:(id)a0 session:(id)a1 error:(id *)a2;
...
+ (void)testProxFlow:(id)a0 manufacturerID:(id)a1 modelID:(id)a2;
...
- (void)preflightMigrationWithConfigurations:(id)a0 completionHandler:(id /* block */)a1;
