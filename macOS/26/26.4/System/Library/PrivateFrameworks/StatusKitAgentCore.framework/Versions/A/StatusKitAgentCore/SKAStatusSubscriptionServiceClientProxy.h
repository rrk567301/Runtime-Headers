@class NSError, SKSubscriptionValidationTokens, NSString, NSArray, SKStatusSubscriptionMetadata, SKHandle, SKAStatusSubscriptionServiceClient, SKStatusSubscriptionValidationTokenResult;
...
- (void)validatePersonalStatusSubscriptionMatchesSubscriptionValidationTokens:(SKSubscriptionValidationTokens *)a0 fromSender:(SKHandle *)a1 statusTypeIdentifier:(NSString *)a2 completion:(void (^)(SKStatusSubscriptionValidationTokenResult *, NSError *))a3;
- (id)initWithXPCConnection:(id)a0 queue:(id)a1 delegate:(id)a2 cloudDatabaseManager:(id)a3 localDatabaseManager:(id)a4 subscriptionManager:(id)a5 encryptionManager:(id)a6 serverBag:(id)a7 inTrafficMode:(BOOL)a8;
