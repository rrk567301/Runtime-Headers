@class ChannelActivityPollingRequest, ChannelActivityActivationRequest, ChannelActivityDeactivationRequest, PersistentPayloadUpdateRequest;
...
@property (readonly, nonatomic) BOOL hasPersistentPayloadRequest;
