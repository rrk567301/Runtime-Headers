...
- (BOOL)_evaluateL2ForLoadedLqmOnInterfaceType:(unsigned char)a0;
...
- (void)_computeExpMovingAvgOfRssi:(int)a0 snr:(int)a1 txRate:(double)a2 rxRate:(double)a3 isInitialized:(BOOL)a4;
...
- (int)_computeLoadedLQMFrom:(int)a0 oldLqm:(int)a1 isLowInternetDL:(BOOL)a2 isLowInternetUL:(BOOL)a3 stallMetric:(double)a4 onInterfaceType:(unsigned char)a5;
