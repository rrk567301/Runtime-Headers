...
- (void)_setupMetricMonitorWithProxyMetric:(id)a0 processNames:(id)a1 response:(id /* block */)a2;
- (void)_startFunctionCoverageCollection:(id)a0 response:(id /* block */)a1;
- (void)_startPerformanceTrace:(id)a0 response:(id /* block */)a1;
- (void)_stopFunctionCoverageCollection:(id /* block */)a0;
