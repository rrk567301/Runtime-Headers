@class NSXPCConnection, CDPDPCSController, CDPRecoveryFlowContext, CDPDLockAssertion, CDPInheritanceTrustController, CDPContext, NSObject, CDPDPDPRecoveryController;
...
- (void)_attemptPDPFallbackForProximityFlow:(id /* block */)a0;
- (void)_attemptPDPFallbackWithCompletion:(id /* block */)a0;
...
- (id)_constructFallbackResultForCDPResult:(id)a0 pdpError:(id)a1;
- (void)_continuePerformPDPRepairWithResult:(id)a0 completion:(id /* block */)a1;
...
- (void)_handleSecureBackupEnablementFailureForNonRepairFlowWithCircleJoinResult:(id)a0 completion:(id /* block */)a1;
...
- (id)_makePDPRepairStartEventWithContext:(id)a0 cdpdAccount:(id)a1;
- (id)_makeSOSCompatibilityModeEnableEvent:(BOOL)a0 error:(id)a1;
- (void)_performInteractivelyAuthenticatedRepair:(id /* block */)a0;
- (void)_performNativeIntermission:(id /* block */)a0;
- (void)_performPDPRepairWithResult:(id)a0 completion:(id /* block */)a1;
...
- (void)_postPDPRepairFinishEventWithContext:(id)a0 didSucceed:(BOOL)a1 error:(id)a2 shouldCompleteSignIn:(BOOL)a3 octagonCliqueStatus:(long long)a4 cdpdAccount:(id)a5;
...
- (void)_processIntermissionStingrayRecord:(id /* block */)a0;
- (void)_recordNativeIntermissionFlowCompletion:(BOOL)a0 error:(id)a1;
...
- (void)_shouldAttemptDBRRepairWithCompletion:(id /* block */)a0;
- (BOOL)_shouldAttemptPDPFallbackForProximityFlow;
- (BOOL)_shouldAttemptPDPIntermission;
- (void)_shouldEnableSecureBackupWithCompletion:(id /* block */)a0;
...
- (void)_validateAndAttemptNativeIntermission:(id /* block */)a0;
...
- (void)reportPDPRepairStartEventWithContext:(id)a0 cdpdAccount:(id)a1;
