...
- (id)_createPDPPasswordRequiredErrorWithUnderlyingError:(id)a0;
...
- (BOOL)_isDroppedKeysSuccessForEnablement:(BOOL)a0 error:(id)a1;
...
- (BOOL)_containsPCSError:(long long)a0 inError:(id)a1;
...
- (BOOL)_shouldPromptForPasswordWithError:(id)a0 context:(id)a1;
...
- (void)_retryWalrusStateUpdate:(BOOL)a0 context:(id)a1 account:(id)a2 completion:(id /* block */)a3;
