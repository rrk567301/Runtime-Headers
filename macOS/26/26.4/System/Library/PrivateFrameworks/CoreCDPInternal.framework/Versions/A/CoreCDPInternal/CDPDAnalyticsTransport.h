...
- (void)_replaceClientNameWithEvent:(id)a0 isIdentifiableApproved:(BOOL)a1;
- (id)_sanitizeCFUStrings:(id)a0 allowedStrings:(id)a1;
- (void)_sanitizeCFUTypesInEvent:(id)a0;
- (id)_transportForEvent:(id)a0;
...
- (void)enforceIdentifiableDataPrivacyComplianceOnEvent:(id)a0 manager:(id)a1;
...
- (void)sanitizeEventForSEPBasedEscrowRepairRateLimitDaysLeftForEvent:(id)a0 attribute:(id)a1;
