...
- (void)validatePDPIdentitiesWithContext:(id)a0 uiProvider:(id)a1 completion:(id /* block */)a2;
...
- (void)createPDPLivenessDictionaryWithContext:(id)a0 completion:(id /* block */)a1;
- (void)_removeObserver;
- (oneway void)updateLastSilentEscrowRecordRepairAttemptDate:(id)a0 context:(id)a1 completion:(id /* block */)a2;
- (void)repairPDPStateWithContext:(id)a0 uiProvider:(id)a1 completion:(id /* block */)a2;
