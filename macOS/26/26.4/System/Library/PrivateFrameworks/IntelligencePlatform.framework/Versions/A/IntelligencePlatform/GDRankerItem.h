...
- (id)initWithEntityID:(id)a0 sourceID:(id)a1 entityClass:(id)a2 features:(id)a3 score:(double)a4 nameScore:(double)a5 contextualScore:(double)a6 entityRelevance:(double)a7 entityRelevanceInferenceEventId:(id)a8 confirmationConfidence:(double)a9 isRelationshipMatch:(BOOL)a10 matchingSignal:(id)a11 identifierInformation:(id)a12;
