...
@interface E5RunnerObjC : NSObject {
    struct unique_ptr<cgm::token_generation_inference::ajax::AJAXE5MLModel, std::default_delete<cgm::token_generation_inference::ajax::AJAXE5MLModel>> { struct { struct AJAXE5MLModel *__ptr_; } ; } ajax_e5_model;
