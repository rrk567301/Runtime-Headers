@class NSError, NSString, NSURL, AMSEngagementRequest, AMSUIEngagementViewController, AMSBagKeySet, NSViewController, AMSEngagementResult, AMSPresentationConfig, AMSProcessInfo;
...
- (void)engagementViewController:(id)a0 contentViewControllerWithDictionary:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)presentationConfigFor:(NSURL *)a0 completionHandler:(void (^)(AMSPresentationConfig *, NSError *))a1;
