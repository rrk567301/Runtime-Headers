...
@property (readonly, nonatomic) BOOL hasOptedOutOfKnowledgeGraph;
...
- (void).cxx_destruct;
- (id)initWithBundleID:(id)a0 adamID:(id)a1 bundleShortVersion:(id)a2 name:(id)a3 shortName:(id)a4 estimatedInstallDate:(id)a5 supportsGameController:(BOOL)a6 isArcade:(BOOL)a7 platform:(long long)a8 isHidden:(BOOL)a9 metadataEligibility:(long long)a10 applicationType:(long long)a11 isBeta:(BOOL)a12 sizeOnDeviceInBytes:(id)a13 hasOptedOutOfKnowledgeGraph:(BOOL)a14 appStoreInstallDate:(id)a15 appStoreLastLaunchedDate:(id)a16 persistentRecordID:(id)a17;
