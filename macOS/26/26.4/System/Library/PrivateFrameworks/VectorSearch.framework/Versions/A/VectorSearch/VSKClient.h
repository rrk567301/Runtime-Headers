...
- (BOOL)isOneTimeReadWritePrewarmNeededWithError:(id *)a0;
...
- (id)searchByBatch:(id)a0 stringIdentifiers:(id)a1 attributeFilters:(id)a2 selectAttributes:(id)a3 limit:(int)a4 fullScan:(BOOL)a5 includePayload:(BOOL)a6 numberOfProbes:(id)a7 batchSize:(id)a8 numConcurrentReaders:(id)a9 error:(id *)a10;
...
- (id)searchByVector:(id)a0 identifiers:(id)a1 attributeFilters:(id)a2 selectAttributes:(id)a3 limit:(int)a4 fullScan:(BOOL)a5 includePayload:(BOOL)a6 numberOfProbes:(id)a7 batchSize:(id)a8 numConcurrentReaders:(id)a9 error:(id *)a10;
...
- (id)searchByVector:(id)a0 stringIdentifiers:(id)a1 attributeFilters:(id)a2 selectAttributes:(id)a3 limit:(int)a4 fullScan:(BOOL)a5 includePayload:(BOOL)a6 numberOfProbes:(id)a7 batchSize:(id)a8 numConcurrentReaders:(id)a9 error:(id *)a10;
...
- (id)stringIdentifiedAssetsWithIdentifiers:(id)a0 attributeFilters:(id)a1 pagination:(id)a2 includeVectors:(BOOL)a3 selectAttributes:(id)a4 error:(id *)a5;
