...
- (id)getStringIdentifiedAssetsWithIdentifiers:(id)a0 attributeFilters:(id)a1 pagination:(id)a2 includeVectors:(BOOL)a3 selectAttributes:(id)a4 error:(id *)a5;
- (id)getStringIdentifiersWithApplyingFilters:(id)a0 error:(id *)a1;
- (id)insertWithAssets:(id)a0 error:(id *)a1;
- (id)isOneTimeReadWritePrewarmNeededAndReturnError:(id *)a0;
- (BOOL)rebuildAndReturnError:(id *)a0;
- (id)searchByBatch:(id)a0 stringIdentifiers:(id)a1 attributeFilters:(id)a2 selectAttributes:(id)a3 limit:(long long)a4 fullScan:(BOOL)a5 includePayload:(BOOL)a6 numberOfProbes:(long long)a7 batchSize:(id)a8 numConcurrentReaders:(long long)a9 error:(id *)a10;
