...
@property (retain, nonatomic) SUCoreMobileAsset *splatDocumentationMobileAssetControl;
...
- (void)downloadAndStashSplatDocumentation:(id)a0 scanUUID:(id)a1 completion:(id /* block */)a2;
