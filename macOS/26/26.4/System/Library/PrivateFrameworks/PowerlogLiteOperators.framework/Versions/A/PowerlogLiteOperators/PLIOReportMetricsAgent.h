@class PLStateTrackingComposition, PLMonotonicTimer, NSMutableDictionary, PLEntryNotificationOperatorComposition, PLNSNotificationOperatorComposition, NSDate;
