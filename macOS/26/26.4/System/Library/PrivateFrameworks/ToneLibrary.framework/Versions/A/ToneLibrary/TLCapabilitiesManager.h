...
@property (readonly, nonatomic) BOOL supportsReflectionRemixes;
@property (readonly, nonatomic) BOOL supportsMediaExperienceAlarmVolume;
...
@property (readonly, nonatomic) BOOL hasFaceIDCapability;
