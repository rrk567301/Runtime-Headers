@class HAPAccessoryProtocolInfo, NSMapTable, HAPAuthSession, HAPCharacteristic, NSMutableArray, HAPSecuritySession, NSString, _HAPBTLEDiscoveryContext, HAPBLEAccessoryCache, NSMutableSet, NSOperationQueue, NSError, HMFTimer;
