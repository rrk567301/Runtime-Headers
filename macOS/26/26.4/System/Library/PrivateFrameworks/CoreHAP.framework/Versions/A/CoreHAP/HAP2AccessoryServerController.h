@class HAP2AccessoryServerAccessoryCache, NSString, HAPKeyBag, HAPPairingIdentity, HAP2PropertyLock, HAP2SerializedOperationQueue;
...
@property (readonly, nonatomic) BOOL managesConnectionStateExternally;
