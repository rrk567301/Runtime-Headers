...
- (void)_refreshScanResultForSSID:(id)a0 completion:(id /* block */)a1;
- (id)_removeUnconfiguredWACDevice:(id)a0;
- (void)_stopBrowsingForWACAccessories;
- (void)handleFoundAPDevice:(id)a0;
- (void)refreshScanResultForSSID:(id)a0 completion:(id /* block */)a1;
