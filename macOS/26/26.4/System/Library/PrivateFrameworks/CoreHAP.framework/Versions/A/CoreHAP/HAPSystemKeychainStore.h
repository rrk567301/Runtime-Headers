...
@protocol HAPSystemKeychainStore, OS_dispatch_queue, HAPSystemKeychainStoreDataSource, HAPSystemKeyCountProvider, HAPKeyStore;

@interface HAPSystemKeychainStore : HMFObject <HAPKeyStore, HMFLogging, HAPSystemKeychainStore, HAPSystemKeyCountProvider>

@property (class, readonly) id<HAPSystemKeychainStore> systemStore;
@property (class, readonly) id<HAPKeyStore> keyStore;
@property (class, readonly) id<HAPSystemKeyCountProvider> keyCountProvider;
...
- (BOOL)deleteRemovedAccessoryKeyForName:(id)a0 error:(id *)a1;
...
- (BOOL)cloneRemovedAccessoryKeyForName:(id)a0 iCloudIdentifier:(id)a1 error:(id *)a2;
...
- (BOOL)clearRemovedAccessoryKeysPriorToTime:(double)a0 error:(id *)a1;
...
- (id)hh2KeychainItemWithIdentifier:(id)a0;
- (BOOL)removeControllerKeyPairLeaveTombstone:(BOOL)a0 error:(id *)a1;
- (int)_savePublicKey:(id)a0 forAccessoryName:(id)a1;
- (id)readPublicKeyForRemovedAccessoryName:(id)a0 iCloudIdentifier:(id)a1 error:(id *)a2;
