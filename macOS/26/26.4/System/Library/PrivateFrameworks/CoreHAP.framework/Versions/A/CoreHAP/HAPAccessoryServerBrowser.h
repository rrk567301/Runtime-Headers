...
- (void)removeRecentlySeenPairedPeripheralWithIdentifier:(id)a0;
- (void)clearRemovedFromHome:(id)a0;
- (id)pairSetupSession:(id)a0 pairSetupType:(unsigned long long)a1 features:(unsigned char)a2 error:(id *)a3;
- (BOOL)wasRemovedFromHome:(id)a0;
