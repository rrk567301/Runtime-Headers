@class HAP2SerializedOperationQueue, HMFTimer, HAP2AccessorySessionInfo, NSString, HAPAccessory, NSArray;
...
- (void)discoverRemovedAccessoriesWithCompletion:(id /* block */)a0;
...
- (void)enableRemovedAccessoryKey:(id)a0 completionQueue:(id)a1 completion:(id /* block */)a2;
- (id)getSessionInfo;
...
- (void)setSessionInfoWithNumIPsResolved:(unsigned long long)a0 numIPsTried:(unsigned long long)a1 numBonjourNames:(unsigned long long)a2 ipAddress:(id)a3 serviceName:(id)a4 resolveAttempted:(BOOL)a5;
