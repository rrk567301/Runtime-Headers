...
- (void)_updateAccessories:(id)a0;
- (void)_updateServerMetadata:(id)a0 controller:(id)a1;
...
- (id)getPairingsWithRemovedAccessoryKey:(id)a0 completion:(id /* block */)a1;
...
- (id)pairWithDelegate:(id)a0 pairingRequest:(id)a1;
...
- (id)removeUnpairedAccessoryPairing:(id)a0 accessoryKey:(id)a1 completion:(id /* block */)a2;
- (void)stopConfirming;
- (id)updateAccessoriesWithReason:(long long)a0;
- (void)updateConnectionState:(unsigned long long)a0 withError:(id)a1;
- (id)updateRemovedAccessoriesWithReason:(long long)a0 accessoryKey:(id)a1 completion:(id /* block */)a2;
