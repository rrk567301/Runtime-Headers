...
@interface HAPAccessoryServerIP : HAPAccessoryServer <HAPAccessoryServerMetricProtocol, HAPAuthSessionDelegate, HAPHTTPClientDelegate, HAPHTTPClientDebugDelegate, HMFNetMonitorDelegate, HMFTimerDelegate> {
...
@property (class) BOOL useDeferredResolutionStrategy;
...
@property (nonatomic) BOOL triedConnectingToIPv4Address;
@property (nonatomic) BOOL triedConnectingToIPv6Address;
...
@property (nonatomic) BOOL pendingBonjourAdd;
...
@property (nonatomic) BOOL isSeenOnBonjour;
...
- (void)_establishSecureConnectionAndFetchAttributeDatabaseWithReason:(long long)a0;
- (void)_establishSecureSession;
- (void)_establishSecureSessionAndListPairings:(id)a0 queue:(id)a1 completion:(id /* block */)a2;
- (void)_establishSecureSessionAndListPairingsWithCompletionQueue:(id)a0 completion:(id /* block */)a1;
...
- (void)_handlePrepareWriteResponseObject:(id)a0 type:(unsigned long long)a1 prepareIdentifier:(id)a2 httpStatus:(int)a3 error:(id)a4 requestTuples:(id)a5 timeout:(double)a6 expiry:(id)a7 queue:(id)a8 originalCompletion:(id /* block */)a9 completion:(id /* block */)a10;
- (void)_handleReadECONNRESETError:(id)a0 readCharacteristics:(id)a1 responses:(id)a2 timeout:(double)a3 expiry:(id)a4 queue:(id)a5 completionHandler:(id /* block */)a6;
...
- (BOOL)_handleSecureSessionClosingWithError:(id *)a0 status:(int)a1 data:(id)a2;
- (void)_handleUpdatesForCharacteristics:(id)a0 stateNumber:(id)a1;
- (void)_handleWriteECONNResetError:(id)a0 writeRequests:(id)a1 responses:(id)a2 timeout:(double)a3 expiry:(id)a4 queue:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)_httpClientDidCloseConnectionDueToServer:(id)a0;
- (void)_incrementPairVerifyFailureCount;
- (void)_indicateSessionActivityWithReason:(long long)a0;
- (void)_insertReadCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (void)_insertWriteCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 withCompletionHandler:(id /* block */)a4;
- (void)_invalidateWAC;
...
- (void)_performExecuteWriteValues:(id)a0 prepareIdentifier:(id)a1 timeout:(double)a2 expiry:(id)a3 queue:(id)a4 completionHandler:(id /* block */)a5;
- (void)_performTimedWriteValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (void)_performWriteValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (void)_pollAccessory;
...
- (void)_queueReadCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (void)_queueWriteCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 withCompletionHandler:(id /* block */)a4;
- (id /* block */)_queuedReadOperationBlock:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (id /* block */)_queuedWriteOperationBlock:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
- (void)_readCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_sendListPairingsWithData:(id)a0 queue:(id)a1 completion:(id /* block */)a2;
- (void)_sendRemovePairingWithData:(id)a0 queue:(id)a1 completion:(id /* block */)a2;
- (BOOL)_shouldConnectBasedOnDisconnectOnIdle;
- (BOOL)_shouldNotifyClientsOfPVFailure:(id)a0;
- (void)_skipReconfirm;
- (long long)_socketUpdateTypeForCachedSocketInfo:(id)a0 newSocketInfo:(id)a1;
...
- (void)_writeCharacteristicValues:(id)a0 timeout:(double)a1 expiry:(id)a2 queue:(id)a3 completionHandler:(id /* block */)a4;
...
- (double)remainingTTLForExpiry:(id)a0;
