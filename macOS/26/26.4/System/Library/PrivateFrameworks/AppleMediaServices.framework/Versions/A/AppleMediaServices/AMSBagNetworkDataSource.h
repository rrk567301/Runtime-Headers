@class NSDate, AMSMetricsLoadURLOverlay, NSString, AMSBagNetworkTaskResult, AMSObserver, NSMutableDictionary, AMSBagNetworkTask, NSObject, AMSProcessInfo;
...
- (id)initWithProfile:(id)a0 profileVersion:(id)a1 processInfo:(id)a2 accountProvider:(id)a3 loadURLOverlay:(id)a4;
- (void)dealloc;
