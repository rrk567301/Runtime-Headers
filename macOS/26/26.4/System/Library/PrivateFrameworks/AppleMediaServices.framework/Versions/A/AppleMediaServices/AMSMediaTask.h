@class AMSMetricsLoadURLOverlay, NSString, NSArray, AMSBagKeySet, ACAccount, NSDictionary, AMSProcessInfo;
...
@property (retain) NSString *appDistributionCountryCodeOverride;
