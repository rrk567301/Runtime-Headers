...
+ (id)imageSession;
+ (BOOL)_shouldAttemptBagLoadForURL:(id)a0 existingBag:(id)a1;
...
- (void)URLSession:(id)a0 task:(id)a1 willPerformHTTPRedirection:(id)a2 newRequest:(id)a3 taskInfo:(id)a4 redirectCookieRemovalExclusionList:(id)a5 completionHandler:(id /* block */)a6;
