...
+ (id)_bagForProfile:(id)a0 profileVersion:(id)a1 processInfo:(id)a2 accountProvider:(id)a3 loadURLOverlay:(id)a4;
...
+ (id)bagForProfile:(id)a0 profileVersion:(id)a1 processInfo:(id)a2 account:(id)a3 loadURLOverlay:(id)a4;
+ (id)bagForProfile:(id)a0 profileVersion:(id)a1 processInfo:(id)a2 loadURLOverlay:(id)a3;
+ (void)resetBagCache;
