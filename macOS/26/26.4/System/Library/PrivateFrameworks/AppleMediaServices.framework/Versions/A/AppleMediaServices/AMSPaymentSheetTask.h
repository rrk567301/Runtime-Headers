@class AMSPaymentSheetAssetCache, NSDictionary, AMSFinancePaymentSheetResponse, NSString, AMSPurchaseInfo, PKPaymentAuthorizationController, AMSPaymentSheetRequest, NSMutableArray, AMSMutablePromise, AKAppleIDAuthenticationContext, AMSBinaryPromise, _PaymentSheetState;
...
@property (retain) AMSBinaryPromise *initialBiometricsAvailability;
...
- (void)_configureContentItemsForPaymentRequest:(id)a0 amsPaymentRequest:(id)a1 error:(id *)a2;
...
- (void)_configureWatchDelegateAuthContentItemsForPaymentRequest:(id)a0;
