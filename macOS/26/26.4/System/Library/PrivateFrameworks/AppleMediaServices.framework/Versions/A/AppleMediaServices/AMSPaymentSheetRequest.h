...
+ (void)_sendAutoBugCaptureReportWithError:(id)a0 subtypeContext:(id)a1;
+ (id)attributedStringByRemovingPlaceholderTagsFromAttributedString:(id)a0;
+ (long long)imageTypeForURLResult:(id)a0;
...
- (id)_amsContentItemsForFlexibleList:(id)a0 assetCache:(id)a1 designVersion:(id)a2 bag:(id)a3 error:(id *)a4;
...
- (id)_contentItemsForFlexibleList:(id)a0 assetCache:(id)a1 designVersion:(id)a2 bag:(id)a3 error:(id *)a4;
...
- (id)ams_createAMSContentItemsForFlexibleListWithAssetCache:(id)a0 designVersion:(id)a1 bag:(id)a2 error:(id *)a3;
- (id)ams_createAMSContentItemsForPreScreenDialogWithAssetCache:(id)a0 designVersion:(id)a1 bag:(id)a2;
- (id)ams_createAMSExpandableInfo:(id)a0 info:(id)a1 bag:(id)a2 error:(id *)a3;
- (id)ams_createContentFromData:(id)a0 keys:(id)a1 error:(id *)a2;
- (id)ams_createContentItemForDeviceName:(id)a0;
- (id)ams_createContentItemForRating;
- (id)ams_createContentItemForSalableInfoFromAMSContentItem:(id)a0;
- (id)ams_createContentItemForSalableInfoWithAssetCache:(id)a0 designVersion:(id)a1 bag:(id)a2;
- (id)ams_createContentItemsForFlexibleListWithAssetCache:(id)a0 designVersion:(id)a1 bag:(id)a2 error:(id *)a3;
