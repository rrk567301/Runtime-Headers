...
- (id)countNetworksPerChannel:(id)a0 error:(id *)a1;
- (id)dedicatedAccessPointSSID;
- (id)dedicatedAcessPointSSID;
- (void)printWirelessInformation;
- (id)randomAccessPointPassword;
- (id)randomAccessPointSSID;
...
- (void)updateAWDLTrafficRegistrationStatus:(BOOL)a0 forRemoteAddress:(id)a1;
