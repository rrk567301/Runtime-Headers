...
@interface SMNNetworkSourceServer : NSObject <SMNNetworkSessionDelegateProtocol>

@property (retain, nonatomic) NSMutableDictionary *txtRecord;
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *requestQueue;
@property (nonatomic) BOOL networkServerShouldBeUp;
@property (retain, nonatomic) NSURL *systemPath;
