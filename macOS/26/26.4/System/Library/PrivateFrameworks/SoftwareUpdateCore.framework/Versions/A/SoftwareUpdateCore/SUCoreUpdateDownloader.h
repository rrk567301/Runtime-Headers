@class NSString, SUCoreFSM, SUCoreProgress, SUCoreDescriptor, NSDictionary, SUCorePolicy, NSMutableArray, SUCoreMobileAsset, NSObject;
...
- (BOOL)_shouldStageOptionalPSUSAssets:(id *)a0;
- (long long)actionDownloadPSUSAssets:(id)a0 error:(id *)a1;
- (id)_biomePayloadForUpdate:(id)a0 error:(id)a1;
- (id)_createEvent:(id)a0;
- (void)_emitNotPerformingPSUSDownloadToBiome:(id)a0;
- (BOOL)_isPreSUStagingEnabled:(id *)a0;
