@class NSDate, NSString, NSArray, NSData, NSURL, NSDictionary, MAAsset, SUCoreDocumentation, SUCoreMAIdentifier, MAAbsoluteAssetId, NSNumber;
...
@property (nonatomic) BOOL disableReserveSpace;
...
@property (nonatomic) BOOL disableMASuspension;
...
- (id)initWithSUAsset:(id)a0 releaseDate:(id)a1 prepareSize:(id)a2 snapshotPrepareSize:(id)a3 applySize:(id)a4 snapshotApplySize:(id)a5 defaultValues:(id)a6;
...
- (unsigned long long)totalRequiredFreeSpaceHelper:(BOOL)a0;
