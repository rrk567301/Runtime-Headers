...
@property (nonatomic) BOOL reserveSpacePaused;
@property (nonatomic) BOOL entitledSpaceDisabled;
...
+ (void)_checkMinimumRequiredSpace:(unsigned long long)a0 purgingFromBase:(id)a1 userInitiated:(BOOL)a2 totalRequiredFreeSpace:(unsigned long long)a3 freeSpaceAvailable:(unsigned long long)a4 checkAvailableSpaceTransaction:(id)a5 withCompletionQueue:(id)a6 completion:(id /* block */)a7;
+ (BOOL)_isUserVolume:(id)a0;
+ (void)_issuePurgeCompletion:(id /* block */)a0 withCompletionQueue:(id)a1 haveEnoughSpace:(BOOL)a2 amountPurged:(unsigned long long)a3 error:(id)a4 transaction:(id)a5 transactionName:(id)a6;
+ (void)_issuePurgeableCompletion:(id /* block */)a0 withCompletionQueue:(id)a1 haveEnoughSpace:(BOOL)a2 amountPurgeable:(unsigned long long)a3 error:(id)a4 transaction:(id)a5 transactionName:(id)a6;
...
+ (unsigned long long)getFreeSpace:(id)a0;
+ (unsigned long long)getFreeSpaceAvailableForSoftwareUpdate:(id)a0;
+ (unsigned long long)getVolumeUsedSpace:(id)a0;
