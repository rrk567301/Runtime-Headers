...
@interface FileProviderDaemon.FPCK : NSObject <FPFSCheckerDelegate> {
    ...
    void /* unknown type, empty encoding */ consistencyPayload;
    ...
    void /* unknown type, empty encoding */ reingestItems;
    ...
    void /* unknown type, empty encoding */ fsRepair;
    void /* unknown type, empty encoding */ itemsToReimport;
...
- (id)initWithDatabasesBackupsPaths:(id)a0 volumeRole:(unsigned int)a1 providerDomainID:(id)a2 domainUserInfo:(id)a3 reason:(unsigned long long)a4 usingFPFS:(BOOL)a5 iCDPackageDetection:(BOOL)a6 useShouldPause:(BOOL)a7 shouldPause:(id /* block */)a8 sendDiagnostics:(id /* block */)a9 saveCheckpoint:(id /* block */)a10 reingestItems:(id /* block */)a11 isInvalidated:(id /* block */)a12;
- (BOOL)launchFromURLs:(id)a0 options:(unsigned long long)a1 contentBarrier:(long long)a2 error:(id *)a3 resultHandler:(id /* block */)a4;
