...
@property (readonly, nonatomic) BOOL isCurrentlyActiveProvider;
...
@property (readonly, nonatomic) BOOL isExternalVolumeSyncingAllowedByManagement;
...
- (void)fetchTelemetryReportForAllDomains:(id)a0 alwaysFetchExpandedUsageStats:(BOOL)a1 resultDictionary:(id)a2 completionHandler:(id /* block */)a3;
- (void)fetchTelemetryReportWithProviderFilter:(id)a0 alwaysFetchExpandedUsageStats:(BOOL)a1 completionHandler:(id /* block */)a2;
