...
@property (retain, nonatomic, getter=startupError, setter=setStartupError:) NSError *startupError;
...
@property (readonly, nonatomic) BOOL hasItemsWithPermissionsIssuesToRepair;
