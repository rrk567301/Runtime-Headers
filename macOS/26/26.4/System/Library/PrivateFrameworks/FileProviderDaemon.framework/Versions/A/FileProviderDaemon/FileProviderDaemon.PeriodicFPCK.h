@interface FileProviderDaemon.PeriodicFPCK : _TtCs12_SwiftObject <FPCKUpdateReceiving> {
    void /* unknown type, empty encoding */ runTimer;
    ...
    void /* unknown type, empty encoding */ reingestItemsInDomain;
}

- (void)reingestItemIDs:(id)a0;
- (void)saveCheckpointWithReport:(id)a0 completionHandler:(id /* block */)a1;
