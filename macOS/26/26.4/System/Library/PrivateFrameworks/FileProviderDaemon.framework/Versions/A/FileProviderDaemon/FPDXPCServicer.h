...
- (void)extendBookmarkForFileURL:(id)a0 toConsumerID:(id)a1 options:(long long)a2 completionHandler:(id /* block */)a3;
...
- (void)_test_isDiskSpaceMonitorRunningForDomain:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)getNumberOfNonMaterializedFilesInDomain:(id)a0 withCompletionHandler:(id /* block */)a1;
...
- (void)startAccessingOperationServiceForItemAtURL:(id)a0 handler:(id /* block */)a1;
...
- (void)itemForURL:(id)a0 options:(unsigned long long)a1 completionHandler:(id /* block */)a2;
...
- (void)_selectNewProviderDomain:(id)a0 knownFolders:(unsigned long long)a1 skipReleasePrompt:(BOOL)a2 completionHandler:(id /* block */)a3;
...
- (void)_test_getDBOptions:(id)a0 completionHandler:(id /* block */)a1;
...
- (BOOL)_canBundleIDTriggerTTRForFailure:(id)a0;
...
- (void)uploadLocalVersionOfItemAtURL:(id)a0 bundleID:(id)a1 conflictResolutionPolicy:(long long)a2 completionHandler:(id /* block */)a3;
...
- (void)bookmarkableStringFromDocumentURL:(id)a0 options:(long long)a1 completionHandler:(id /* block */)a2;
...
- (void)launchItemsPermissionsRepairInDomain:(id)a0 completionHandler:(id /* block */)a1;
