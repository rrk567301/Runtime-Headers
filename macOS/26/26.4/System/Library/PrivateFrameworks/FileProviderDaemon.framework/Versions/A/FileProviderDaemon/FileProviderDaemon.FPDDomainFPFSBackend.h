...
@interface FileProviderDaemon.FPDDomainFPFSBackend : NSObject <FPDDomainBackend, FPDSharedSystemSchedulerWatcher> {
    ...
    void /* unknown type, empty encoding */ itemsPermissionsRepair;
    void /* unknown type, empty encoding */ hasItemsWithPermissionsToRepairRecord;
...
@property (nonatomic, readonly) BOOL hasItemsWithPermissionsToRepair;
...
- (void)registerFPCKProgress:(id)a0;
...
- (void)itemForURL:(id)a0 options:(unsigned long long)a1 request:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)launchItemsPermissionsRepairWithCompletionHandler:(id /* block */)a0;
...
- (void)addItemsWithPermissionsIssuesToRepairWithURLs:(id)a0;
...
- (void)getDBOptionsWithCompletionHandler:(id /* block */)a0;
- (void)getDBQueryStatisticsWithQueryPlan:(BOOL)a0 completionHandler:(id /* block */)a1;
- (void)getNumberOfNonMaterializedFilesWithCompletionHandler:(id /* block */)a0;
