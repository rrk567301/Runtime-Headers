@interface WeatherCore.DataProtectionInformationManager : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ pendingWriteBackWorkItem;
    void /* unknown type, empty encoding */ writeBackAttempts;
    void /* unknown type, empty encoding */ writeBackDebounceInterval;
    void /* unknown type, empty encoding */ maxWriteBacksPerHour;
}
