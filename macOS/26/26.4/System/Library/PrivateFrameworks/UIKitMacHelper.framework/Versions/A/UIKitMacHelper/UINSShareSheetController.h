@class NSSharingService, NSArray, NSDictionary, NSString, NSSharingServicePicker, UIViewController;
...
@property (retain, nonatomic) id pickerPopoverWillCloseObserver;
...
@property (weak, nonatomic) UIViewController *sourceActivityViewController;
...
- (void)_setupPopoverDismissalObservationIfNecessary;
- (void)_teardownPopoverDismissalObservationIfNecessary;
