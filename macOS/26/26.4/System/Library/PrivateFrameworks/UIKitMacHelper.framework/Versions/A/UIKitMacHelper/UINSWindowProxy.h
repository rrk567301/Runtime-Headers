...
- (id)NS_touchBars;
- (BOOL)_moveToScreen:(unsigned long long)a0;
...
- (void)_inspectorAdapterWasAddedToWindow:(id)a0;
- (void)_inspectorProviderWillRemoveFromWindow:(id)a0;
...
- (void)removeToolbarScrollPocketAppearanceWithIdentifier:(id)a0;
- (void)sendInitialWindowVisibilityChangedNotifications;
- (void)setNeedsDragRegionsUpdate;
- (void)setNeedsSizeRestrictionsUpdate;
- (void)setToolbarScrollPocketAppearance:(long long)a0 luma:(double)a1 glassFrost:(long long)a2 pocketContainer:(id)a3 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 identifier:(id)a5;
