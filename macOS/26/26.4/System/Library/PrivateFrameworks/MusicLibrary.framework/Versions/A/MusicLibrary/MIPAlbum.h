...
@interface MIPAlbum : PBCodable <NSCopying> {
    struct { unsigned char likedStateChangedDate : 1; unsigned char persistentId : 1; unsigned char storeId : 1; unsigned char artworkSourceType : 1; unsigned char likedState : 1; unsigned char numDiscs : 1; unsigned char numTracks : 1; unsigned char userRating : 1; unsigned char compilation : 1; } _has;
}
