...
@property (nonatomic) BOOL sagaForcePerformDeltaSync;
...
@property (nonatomic, getter=isAutoUpdatingSharedLibrary) BOOL autoUpdatingSharedLibrary;
...
@property (readonly, nonatomic) BOOL hasUserPinnedLibraryEntity;
...
- (void)_retrieveBestArtworkTokensAndColorInfoForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 retrievalTime:(double)a4 completionHandler:(id /* block */)a5;
...
- (BOOL)_determineAndUpdateBestArtworkTokensForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 retrievalTime:(double)a3 preserveExistingAvailableToken:(BOOL)a4 variantType:(long long)a5 usingConnection:(id)a6;
...
- (BOOL)_insertArtworkRowWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 relativePath:(id)a4;
- (BOOL)_insertArtworkRowWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 relativePath:(id)a4 usingConnection:(id)a5;
...
- (void)_removeLibraryPinsForDeletedTracksUsingConnection:(id)a0;
...
- (BOOL)_removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 canonocalizeCollections:(BOOL)a3 usingConnection:(id)a4 postNotifications:(BOOL)a5;
...
- (BOOL)_updateBestArtworkTokensForArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 variantType:(long long)a3 preserveExistingAvailableToken:(BOOL)a4 usingConnection:(id)a5;
...
- (id)artworkColorInfoForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 token:(id)a4;
- (id)artworkColorInfoForToken:(id)a0 artworkType:(long long)a1 variantType:(long long)a2;
...
- (void)enumerateLibraryPinsPersistentIDsAfterRevision:(long long)a0 revisionTrackingCode:(unsigned long long)a1 usingBlock:(id /* block */)a2;
...
- (void)importArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkToken:(id)a2 artworkType:(long long)a3 sourceType:(long long)a4 variantType:(long long)a5 colorInformation:(id)a6 usingConnection:(id)a7;
...
- (BOOL)importExistingOriginalArtworkWithArtworkToken:(id)a0 artworkType:(long long)a1 sourceType:(long long)a2 mediaType:(unsigned int)a3 variantType:(long long)a4;
...
- (BOOL)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(BOOL)a5;
- (void)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(BOOL)a5 completion:(id /* block */)a6;
- (BOOL)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(BOOL)a6;
- (void)importOriginalArtworkFromFileURL:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(BOOL)a6 completion:(id /* block */)a7;
- (BOOL)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(BOOL)a5;
- (void)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 shouldPerformColorAnalysis:(BOOL)a5 completion:(id /* block */)a6;
- (BOOL)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(BOOL)a6;
- (void)importOriginalArtworkFromImageData:(id)a0 withArtworkToken:(id)a1 artworkType:(long long)a2 sourceType:(long long)a3 mediaType:(unsigned int)a4 variantType:(long long)a5 shouldPerformColorAnalysis:(BOOL)a6 completion:(id /* block */)a7;
...
- (BOOL)isArtworkTokenAvailable:(id)a0 forVariantType:(long long)a1;
- (id)itemTablesEntryCountsUsingConnection:(id)a0;
- (id)libraryEntityFilterPredicatesForContainerClass:(Class)a0;
- (id)libraryEntityFilterPredicatesForEntityClass:(Class)a0;
- (BOOL)markSystemPurgeableMusicPath:(id)a0 forUrgency:(unsigned long long)a1;
- (id)mediaFolderPathByAppendingPathComponent:(id)a0;
...
- (BOOL)performMainentanceTasksUsingActivity:(id)a0;
...
- (BOOL)removeArtworkForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 sourceType:(long long)a3 variantType:(long long)a4 usingConnection:(id)a5;
...
- (void)removeArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 sourceType:(long long)a3 variantType:(long long)a4;
- (void)removeArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 sourceType:(long long)a3 variantType:(long long)a4 usingConnection:(id)a5;
...
- (BOOL)removeSource:(int)a0 forImportOperation:(id)a1 usingConnection:(id)a2 postNotifications:(BOOL)a3;
- (BOOL)removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 canonocalizeCollections:(BOOL)a3 usingConnection:(id)a4 postNotifications:(BOOL)a5;
- (BOOL)removeSource:(int)a0 fromPersistentIDS:(id)a1 forImportOperation:(id)a2 usingConnection:(id)a3 postNotifications:(BOOL)a4;
...
- (id)representativeArtworkItemForAlbumPersistentID:(long long)a0 artworkSourceType:(long long)a1;
- (BOOL)requiresNonSchemaUpdatesOnConnection:(id)a0;
- (BOOL)requiresSchemaOnlyUpdatesOnConnection:(id)a0;
- (void)retrieveBestArtworkTokensAndColorInfoForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 retrievalTime:(double)a4 completionHandler:(id /* block */)a5;
...
- (void)sanitizeDatabaseContentsUsingConnection:(id)a0 removeOrphanedAssets:(BOOL *)a1 itemTablesEntryCounts:(id)a2;
- (BOOL)sanitizeSortMapContentsUsingConnection:(id)a0 didSortMapEntries:(BOOL *)a1;
- (void)savePlaylists;
...
- (void)updateBestArtworkTokenForEntityPersistentID:(long long)a0 entityType:(long long)a1 artworkType:(long long)a2 variantType:(long long)a3 retrievalTime:(double)a4 preserveExistingAvailableToken:(BOOL)a5 usingConnection:(id)a6;
