...
- (void).cxx_destruct;
- (void)_insertQueueWithPath:(id)a0 position:(long long)a1 sessionID:(id)a2 userActionTime:(id)a3 completionHandler:(id /* block */)a4;
- (long long)_persistentIDForStartItem;
- (void)_resolveMediaQueryForLibraryRequest:(id)a0 completionHandler:(id /* block */)a1;
- (void)_setQueueWithPath:(id)a0 shuffleMode:(long long)a1 sessionID:(id)a2 userActionTime:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)insertQueueWithPath:(id)a0 position:(long long)a1 sessionID:(id)a2 userActionTime:(id)a3 completionHandler:(id /* block */)a4;
- (void)setQueueWithPath:(id)a0 shuffleMode:(long long)a1 sessionID:(id)a2 userActionTime:(id)a3 completionHandler:(id /* block */)a4;
