...
- (void)_handleDidReceiveSpeechWordTimingInfoArray:(id)a0 forSynthesisRequest:(id)a1;
...
- (void)_handleDidFinishStreamingWithSpeechRequest:(id)a0 success:(BOOL)a1 error:(id)a2;
...
- (void)_handleDidGenerateAudioChunkData:(id)a0 forSynthesisRequest:(id)a1;
...
- (void)_withSpeechRequest:(id)a0 didGenerateAudioChunk:(id)a1;
- (void)_withSpeechRequest:(id)a0 didReceiveTimingInfo:(id)a1;
- (void)_withSynthesisRequest:(id)a0 didGenerateAudioChunk:(id)a1;
- (void)_withSynthesisRequest:(id)a0 didReceiveTimingInfo:(id)a1;
...
- (void)didFinishStreamingRequest:(id)a0 successfully:(BOOL)a1 withError:(id)a2;
