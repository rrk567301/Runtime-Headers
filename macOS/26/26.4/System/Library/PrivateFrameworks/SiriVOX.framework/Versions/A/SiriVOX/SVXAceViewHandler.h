@class SVXInstrumentationUtilities, NSMutableDictionary, SVXSpeechSynthesizer, SVXAFUtilitiesWrapper, SVXSpeechSynthesisResultConverter, SVXModule, SVXAceViewSpeakableTextExtractor;
