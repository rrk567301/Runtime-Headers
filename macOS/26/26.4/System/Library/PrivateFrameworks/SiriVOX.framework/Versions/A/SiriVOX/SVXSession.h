@class SVXAceViewSpeakableTextExtractor, AFAnalytics, AFAnalyticsTurnBasedInstrumentationContext, NSUserActivity, SVXActivationContext, SVXDeviceProblemsState, NSMutableSet, NSMutableArray, SRUIFStateFeedbackManager, AFPreferences, AFDeviceContext, AFXPCWrapper, SVXServiceCommandHandler, SVXRequestPrewarmer, SVXDeactivationContext, AFHomeAccessoryInfo, SVXDeviceSetupContext, SVXSpeechSynthesizer, SVXTapToRadarManager, AFModesConfiguration, SVXSessionUtils, SASetApplicationContext, SVXTaskTrackingCenter, AFSpeechRequestOptions, AFInstanceContext, SVXSoundUtils, SVXPowerLevelManager, NSMutableDictionary, NSString, SVXActivationInstrumentation, SVXSpeechSynthesisUtils, SVXAlarmAndTimerUtilities, NSUUID, SVXSessionIdleTimer, SVXAFConnectionManager;
...
- (BOOL)_isAssistantConnectionAvailable;
...
- (void)handleShouldSpeak:(BOOL)a0;
- (id)initWithPerformer:(id)a0 serviceCommandHandler:(id)a1 powerLevelManager:(id)a2 speechSynthesizer:(id)a3 connectionManager:(id)a4 requestPrewarmer:(id)a5 instanceContext:(id)a6 preferences:(id)a7 analytics:(id)a8 delegate:(id)a9;
