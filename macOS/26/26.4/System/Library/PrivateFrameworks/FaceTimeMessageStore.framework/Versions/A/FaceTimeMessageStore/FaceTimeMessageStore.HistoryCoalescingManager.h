@interface FaceTimeMessageStore.HistoryCoalescingManager : _TtCs12_SwiftObject <_FTMSMessageStoreControllerDelegate> {
    ...
    void /* unknown type, empty encoding */ fetchSignpostID;
    void /* unknown type, empty encoding */ signpostIntervals;
    void /* unknown type, empty encoding */ didEmitFinishedInitialFetch;
    void /* unknown type, empty encoding */ didEmitFinishedInitialBatch;
    void /* unknown type, empty encoding */ initialBatchReceived;
}
