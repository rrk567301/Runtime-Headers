...
@property (retain, nonatomic, setter=setAltDSID:) NSString *altDSID;
@property (retain, nonatomic, setter=setDSID:) NSNumber *DSID;
...
- (BOOL)isActiveForMediaType:(id)a0;
- (void)setProperty:(id)a0 key:(id)a1;
- (void)setStorefront:(id)a0 forMediaType:(id)a1;
- (id)storefrontForMediaType:(id)a0;
