...
@interface AMPTrackTableLockup : NSTableCellView <AMPRolloverTableViewDelegate, NSTableViewDelegate, NSControlTextEditingDelegate> {
    ...
    void /* unknown type, empty encoding */ needDataRebuildOnLayout;
    ...
    void /* unknown type, empty encoding */ pendingSelectedModelIdentifiers;
}
...
@property (nonatomic, copy) NSArray *selectedModelIdentifiers;

+ (id)lockup;
+ (id)keyPathsForValuesAffectingSelectedModels;
