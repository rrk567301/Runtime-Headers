...
- (void)requestDataAccessAuthorizationForRecordIdentifier:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)resetDataAccessAuthorizationsWithCompletionHandler:(id /* block */)a0;
...
- (void)silentlyResetAuthorizationForRecordIdentifier:(id)a0 completionHandler:(id /* block */)a1;
