@class NSGlassEffectView, NSImage, NSEvent, NSProgressIndicator, NSButton;
...
@property (nonatomic) BOOL animatedOut;
...
- (void)showSpinner:(BOOL)a0 withCompletion:(id /* block */)a1;
