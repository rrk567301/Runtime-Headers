...
- (id)initWithDomainName:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withLatestDownloadedAtomicInstance:(id)a3 withDownloadedAtomicInstances:(id)a4 withDiscoveredAtomicInstance:(id)a5 withActiveClientCount:(long long)a6 withMaximumClientCount:(long long)a7 withTotalClientCount:(long long)a8;
