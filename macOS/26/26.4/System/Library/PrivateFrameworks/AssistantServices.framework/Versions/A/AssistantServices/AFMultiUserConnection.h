...
- (void)getLoggableIdentiferForUserWithSharedUserID:(id)a0 iCloudAltDSID:(id)a1 sessionID:(id)a2 completion:(id /* block */)a3;
- (oneway void)getLoggableMultiUserSharedUserIdForSharedUserID:(id)a0 completion:(id /* block */)a1;
...
- (void)getSAHomeMemberInfoFor:(id)a0 completion:(id /* block */)a1;
...
- (void)postMessageToMUXWithMultiUserInfo:(id)a0 completion:(id /* block */)a1;
- (void)saveUserWithProximitySetupInfo:(id)a0 completion:(id /* block */)a1;
