@class NSMutableDictionary, AFQueue, NSError, NSObject, AFWatchdogTimer, AFClientConfiguration, AFInstanceContext, AFCheckSRT, NSString, AFOneArgumentSafetyBlock, AFSiriClientStateManager, AFPreferences, AFCallSiteInfo, AFInterstitialProvider, NSArray, AFAnalytics, NSXPCConnection, AFAudioPowerUpdater, NSUUID;
...
- (void)startListenerSelectionWithDate:(id)a0 requestSessionId:(id)a1 resultCallback:(id /* block */)a2;
...
- (void)_emitServerExecutionValuesReportedMessage:(id)a0 requestUUID:(id)a1;
...
- (BOOL)_shouldBeginInterstitialsForRequestInfo:(id)a0;
