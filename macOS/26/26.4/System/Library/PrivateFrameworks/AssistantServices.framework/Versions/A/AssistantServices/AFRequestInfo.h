@class NSUUID, NSString, NSData, SAStartRequest, AFTestRequestOptions, AFSpeechRequestOptions, NSDictionary, SAStartLocalRequest, AFExplicitRequestContext, AFRequestCompletionOptions, AFAnnouncementContext, NSNumber;
...
@property (nonatomic) BOOL isAlwaysAllowedWhileDeviceLocked;
