...
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 asChildrenOfItemWithIdentifier:(id)a3 isSupplemental:(BOOL)a4 isImmersiveExperience:(BOOL)a5 isPersistentAcrossInvocations:(BOOL)a6;
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 atIndexPaths:(id)a3;
- (void)_addItemsForAceViews:(id)a0 withDialogPhase:(id)a1 fromCommandWithIdentifier:(id)a2 atIndexPaths:(id)a3 isSupplemental:(BOOL)a4 isImmersiveExperience:(BOOL)a5 isPersistentAcrossInvocations:(BOOL)a6;
...
- (void)addItemForUpdateVisualResponseCommand:(id)a0;
...
- (BOOL)containsItemForSpeechWithIdentifier:(id)a0;
