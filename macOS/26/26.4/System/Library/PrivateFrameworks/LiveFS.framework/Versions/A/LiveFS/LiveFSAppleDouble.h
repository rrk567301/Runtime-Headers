...
- (int)_removeXattrNamed:(id)a0 allowADFileRemoval:(BOOL)a1;
- (id)allXattrNamesAndPosixError:(int *)a0;
- (BOOL)containerFileExists;
- (int)createFile;
- (id)initWithManager:(id)a0 baseFileHandle:(id)a1 name:(id)a2 andDirectoryHandle:(id)a3 andPurpose:(int)a4;
