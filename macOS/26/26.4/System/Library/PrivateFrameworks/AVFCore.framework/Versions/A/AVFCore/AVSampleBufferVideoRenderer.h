...
- (struct OpaqueCMTimebase { } *)_readOnlyVideoQueueTimebase;
- (void)_refreshAboveHighWaterLevelAndAlwaysStartRequestMediaDataIfRequesting:(BOOL)a0;
...
- (int)_setUpFigVideoQueueControlTimebase:(struct OpaqueFigVideoQueue { } *)a0;
...
- (int)attachToContentKeySession:(id)a0 contentKeyBoss:(struct OpaqueFigContentKeyBoss { } *)a1 failedSinceAlreadyAttachedToAnotherSession:(BOOL *)a2;
...
- (void)setReadyForDisplayWithoutKVO:(BOOL)a0;
- (BOOL)setRenderSynchronizer:(id)a0 error:(id *)a1;
- (void)setShouldWaitForVideoTarget:(BOOL)a0;
- (void)setVideoLayerGeometryFlipped:(BOOL)a0;
