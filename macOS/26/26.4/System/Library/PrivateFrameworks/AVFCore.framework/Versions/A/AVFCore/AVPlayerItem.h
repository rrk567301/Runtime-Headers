@class AVPlayerItemInternal, NSArray, NSString, NSDate, AVPlayerItemIntegratedTimeline, NSError;
...
@property (readonly, nonatomic) BOOL missingAudioEditList;
...
- (void)_executeHandlerCheckingIfTrickModesAreAllowed:(id /* block */)a0;
...
- (void)_forwardBufferVideoIfVideoDestinationAttachedToInterstitialItems:(BOOL)a0;
- (void)_forwardPrefersOfflinePlayableVariantsToInterstitialItems:(BOOL)a0;
...
- (void)_setItemAudioTapProcessor:(struct opaqueMTAudioProcessingTap { } *)a0 fromAudioMixContext:(BOOL)a1;
...
- (void)_updateEligibilityForDSPBasedEnhancedDialogue:(id)a0;
...
- (BOOL)bufferVideoIfVideoDestinationAttached;
...
- (id)effectiveMediaPresentationSettingsForMediaSelectionGroup:(id)a0;
- (id)errorLog;
- (BOOL)fixFaultyTFDT165791136;
- (BOOL)fixFaultyTFDT165791136;
- (id)gaplessInfo;
...
- (void)selectMediaPresentationLanguage:(id)a0 forMediaSelectionGroup:(id)a1;
- (void)selectMediaPresentationSetting:(id)a0 forMediaSelectionGroup:(id)a1;
- (id)selectedMediaPresentationLanguageForMediaSelectionGroup:(id)a0;
- (id)selectedMediaPresentationSettingsForMediaSelectionGroup:(id)a0;
...
- (void)setBufferVideoIfVideoDestinationAttached:(BOOL)a0;
...
- (void)setFixFaultyTFDT165791136:(BOOL)a0;
