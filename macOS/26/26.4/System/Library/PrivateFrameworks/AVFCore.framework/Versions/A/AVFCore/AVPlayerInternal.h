@class NSDictionary, AVRoutingPlaybackArbiter, AVQueuePlayer, AVPlayerObservationRegistrar, NSMutableArray, AVPixelBufferAttributeMediator, NSString, NSMutableSet, NSError, AVPlayerRateState, NSArray, NSMutableDictionary, AVPlayerPlaybackCoordinator, AVApplicationStateMonitor, AVOutputContext, AVWeakReference, NSObject, AVPlayerVideoOutput, AVPlayerItem, AVCoordinatedPlaybackSuspension, AVPlayerMediaSelectionCriteria, AVPlayerTaggedBufferOutput, NSHashTable;
...
@interface AVPlayerInternal : NSObject {
    ...
    BOOL allowsCaptureOfClearKeyVideo;
    ...
    BOOL startupSyncIgnoresAudioDeviceLatency;
    ...
    BOOL hasExternalPlaybackPriority;
    BOOL hasNonMixableAudioPriority;
    ...
    BOOL itemsToPrebufferRequireUpdate;
    BOOL coPlaybackEnabled;
