...
- (BOOL)allowsHEVCInTransportStreams;
- (BOOL)allowsLATMInTransportStreams;
...
- (void)setAllowsHEVCInTransportStreams:(BOOL)a0;
- (void)setAllowsLATMInTransportStreams:(BOOL)a0;
