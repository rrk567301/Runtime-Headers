@class NSDictionary, AVAudioMix, AVAsset, AVCustomVideoCompositorSession, AVPlayerItemAudioTrackInfoCache, NSMutableArray, NSString, AVVideoComposition, AVMediaSelection, NSError, NSArray, NSMutableDictionary, NSPointerArray, AVPlayerPlaybackCoordinator, AVPlayerItemObservationRegistrar, AVWeakReference, AVPlayerItemInterstitialEventCollector, NSObject, NSData, AVPlayerItem, AVPlayerConnection, AVPlayerItemIntegratedTimeline, NSURL, NSDate;
...
@interface AVPlayerItemInternal : NSObject {
    ...
    BOOL audioTapProcessorSetIsPending;
    BOOL audioTapProcessorWasSetFromAudioMix;
    ...
    BOOL clientCaresAboutOverlappedPlayback;
