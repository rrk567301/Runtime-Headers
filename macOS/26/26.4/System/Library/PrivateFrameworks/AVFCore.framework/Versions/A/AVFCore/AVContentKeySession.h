...
@property BOOL supportsAdvisoryKeys;
...
- (id)_getOriginatingRecipientForUniqueIdentifier:(id)a0;
...
- (BOOL)_makeContentKeyGroupWithIDOut:(unsigned long long *)a0 error:(id *)a1;
...
- (BOOL)_renewKeyWithIdentifier:(id)a0 encryptionMethod:(int)a1 initializationData:(id)a2 contentIdentifier:(id)a3 keyIDFromInitializationData:(id)a4 options:(id)a5 error:(id *)a6;
...
- (void)didProvideKeyRequestWithBoss:(struct OpaqueFigContentKeyBoss { } *)a0 keySpecifier:(struct OpaqueFigContentKeySpecifier { } *)a1 requestID:(unsigned long long)a2 renewalRequest:(BOOL)a3 supportsOfflineKey:(BOOL)a4 originatingRecipientIdentifier:(id)a5;
...
- (void)issuePersistableContentKeyRequestForKeySpecifier:(struct OpaqueFigContentKeySpecifier { } *)a0 initializationData:(id)a1 keyIDFromInitializationData:(id)a2 contentIdentifier:(id)a3 requestID:(unsigned long long)a4 preloadingRequestOptions:(id)a5 identifier:(id)a6 originatingRecipientIdentifier:(id)a7;
