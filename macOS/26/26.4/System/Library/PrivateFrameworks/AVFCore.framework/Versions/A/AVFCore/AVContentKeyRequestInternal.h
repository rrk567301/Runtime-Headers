@class NSData, NSString, AVContentKeySession, NSError, AVContentKeySpecifier, AVContentKey, NSDictionary, NSUUID, AVContentKeyReportGroup;
...
@interface AVContentKeyRequestInternal : NSObject {
    ...
    BOOL supportsAdvisoryKeys;
    BOOL canBeFulfilledWithAdvisoryKey;
}
