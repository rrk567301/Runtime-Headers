...
- (void)_getMaskLayer:(id *)a0 videoLayer:(id *)a1 subtitleLayer:(id *)a2 subtitlePreviewLayer:(id *)a3 closedCaptionLayer:(id *)a4 interstitialLayer:(id *)a5;
...
- (void)_setSubtitlePreviewHelper:(id)a0;
