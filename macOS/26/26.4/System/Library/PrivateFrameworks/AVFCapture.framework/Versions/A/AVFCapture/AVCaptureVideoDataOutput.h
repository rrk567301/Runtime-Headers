...
- (BOOL)isPanoRecordingInProgress;
...
- (id)recommendedMovieMetadataForVideoCodecType:(id)a0 assetWriterOutputFileType:(id)a1;
...
- (void)updateClientVideoSettingsForAspectRatio:(id)a0;
