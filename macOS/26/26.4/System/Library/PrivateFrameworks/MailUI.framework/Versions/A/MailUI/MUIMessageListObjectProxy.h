@class NSTextEncapsulation, NSDictionary, NSObject, MFCriterion, MCMessage, NSOrderedSet, NSImage, NSString, MUICachingSVGConverter, EFPair, NSIndexSet, NSAttributedString, NSArray, NSColor;
