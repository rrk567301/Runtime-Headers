@class NSObject, NSString, SafariWebBookmarkList, TopSitesController, NSArray, NSSet, TouchIconCache;
...
@interface CombinedFavoritesController : NSObject <WBSStartPageSuggestionsProvider> {
    ...
    BOOL _shouldSendNumberOfFrequentlyVisitedSitesTelemetry;
...
- (void)_sendDidRetrieveNumberOfFrequentlyVisitedSitesTelemetry;
