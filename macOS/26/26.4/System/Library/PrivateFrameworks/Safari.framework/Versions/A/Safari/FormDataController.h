@class NSString, WBSSavedAccount, AutoFillLocalAuthenticationManager, AutoFillAuthorizationController, NSMutableDictionary, WBSCoalescedAsynchronousWriter;
...
@property (retain, nonatomic) WBSSavedAccount *recentlyUsedSavedAccount;
...
- (int)_performCredentialAutoFillActionForForm:(id)a0 ofType:(unsigned long long)a1 inViewController:(id)a2 isUserInitiated:(BOOL)a3 frameInfo:(id)a4;
- (void)_saveFormDataIfNecessary:(id)a0 frame:(const void *)a1 sourceFrame:(const void *)a2 values:(id)a3 passwordGenerationCredentials:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)autoFillActiveFormOrBestFormForPageLevelAutoFillInViewController:(id)a0 metadataProvider:(id)a1 autoFillDataType:(unsigned long long)a2 contactLabel:(id)a3 multiRoundAutoFillManager:(id)a4 contact:(id)a5 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a6;
...
- (BOOL)mayPrefillInBrowserViewController:(id)a0;
...
- (void)saveUnsubmittedFormDataFromRemovedFrameIfNecessary:(id)a0 frame:(const void *)a1 sourceFrame:(const void *)a2 passwordGenerationCredentials:(id)a3;
- (int)sendAutoFillDataForStandardForm:(id)a0 inViewController:(id)a1 frameInfo:(id)a2 autoFillDataType:(unsigned long long)a3 contactLabel:(id)a4 multiRoundAutoFillManager:(id)a5 contact:(id)a6 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a7;
- (BOOL)shouldDeferLoadingWhileSavingFormDataInPage:(const void *)a0 sourceFrame:(const void *)a1 formMetadata:(id)a2 passwordGenerationCredentials:(id)a3;
...
- (void)showFlexibleContactsAutoFillUIForCompletionController:(void *)a0 browserViewController:(id)a1 metadataProvider:(id)a2 contactLabel:(id)a3;
- (id)uniqueIDOfMe;
- (void)verifyKeychainAccessWithContentViewController:(id)a0;
- (void)willSubmitFormInPage:(const void *)a0 fromFrame:(const void *)a1 values:(id)a2 formMetadata:(id)a3 submissionHandler:(id /* block */)a4;
- (void)willSubmitFormWithCredentials:(id)a0 shouldPreferAnnotatedCredentials:(BOOL)a1 toFrame:(const void *)a2 fromFrame:(const void *)a3 passwordGenerationCredentials:(id)a4 completionHandler:(id /* block */)a5;
