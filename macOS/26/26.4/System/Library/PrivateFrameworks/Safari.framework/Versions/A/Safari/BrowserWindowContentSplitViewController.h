@class NSView, LibrarySidebarNavigationViewController, NSString, NSArray, SafariSidebarSplitViewItem, NSColor, NSMutableDictionary, StartPageViewController, NSSplitViewItemAccessoryViewController, NSVisualEffectView, NSSplitViewItem, BrowserWindowController;
...
- (double)_minimumThicknessForMainContentSplitViewItem;
