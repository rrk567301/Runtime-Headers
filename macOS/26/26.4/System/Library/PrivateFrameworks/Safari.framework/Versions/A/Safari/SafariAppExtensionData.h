@class NSExtension, AppExtensionContextMenu, NSMutableDictionary, NSMapTable, NSDictionary, ExtensionWebsiteAccess, NSMutableArray, WKContentWorld, NSString, NSSet, AppExtensionToolbarItem, NSNumber, NSUUID;
...
@interface SafariAppExtensionData : WBSSafariExtension {
    ...
    BOOL _didInjectSafariBindingsObject;
    BOOL _didInjectSafariBindingsObjectInPrivateBrowsing;
...
- (void)addAppExtensionBindingsToUserContentController:(id)a0 inWorld:(id)a1;
- (void)addContentScript:(id)a0;
- (void)addInjectedContentForAllGrantedOrigins;
- (void)addListenerHandle:(id)a0 forBrowserViewController:(id)a1;
- (void)applyManagedExtensionPermissionsUpdatingSafariState:(BOOL)a0;
- (id)baseURIHost;
- (void)dispatchMessageWithName:(id)a0 userInfo:(id)a1 toBrowserViewController:(id)a2;
...
- (void)removeListenerHandle:(id)a0 fromBrowserViewController:(id)a1;
