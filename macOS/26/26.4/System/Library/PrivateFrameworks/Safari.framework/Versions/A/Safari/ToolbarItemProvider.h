@class CombinedSidebarTabGroupToolbarButton, ToolbarDownloadsButton, TabGroupPickerToolbarButton, BrowserToolbarItem, NSSeparatorToolbarItem, CollaborationToolbarItem, NSToolbarItemGroup;

@interface ToolbarItemProvider : NSObject

@property (retain, nonatomic) BrowserToolbarItem *backForwardItem;
@property (retain, nonatomic) NSToolbarItemGroup *backForwardGroup;
...
@property (retain, nonatomic) BrowserToolbarItem *tabGroupPickerItem;
@property (retain, nonatomic) TabGroupPickerToolbarButton *tabGroupPickerToolbarButton;
