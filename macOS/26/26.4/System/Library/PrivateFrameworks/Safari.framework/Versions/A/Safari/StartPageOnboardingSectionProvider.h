@class StartPageOnboardingCollectionViewItem, NSString, NSArray, NSAppearance, _TtC6Safari27SafariOnboardingCoordinator;
@protocol StartPageCollectionSectionProviderDelegate;

@interface StartPageOnboardingSectionProvider : NSObject <StartPageOnboardingCollectionViewItemDelegate, StartPageCollectionSectionProvider> {
...
- (void)_updateSectionAfterCompletingOnboardingItem:(id)a0 wasClosed:(BOOL)a1;
...
- (void)didCloseOnboardingItem:(id)a0;
- (void)didStartOnboardingItem:(id)a0;
