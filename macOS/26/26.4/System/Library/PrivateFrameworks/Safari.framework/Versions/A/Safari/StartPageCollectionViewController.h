@class StartPageCollectionViewControllerAnimator, _StartPageCollectionLayoutEnvironment, StartPagePrivateBrowsingSectionProvider, NSMutableIndexSet, BrowserWindowController, StartPageRecentlyClosedTabsSectionProvider, NSIndexSet, StartPagePrivacyReportSectionProvider, NSTrackingArea, NSMapTable, StartPageHeadingSectionProvider, WBSStartPageSectionManager, StartPageViewController, StartPageOnboardingSectionProvider, NSScrollView, NSLayoutConstraint, StartPageReadingListSectionProvider, StartPageCollectionViewLayout, StartPagePrivateRelayInPrivateBrowsingSectionProvider, StartPageCollectionView, StartPageFavoritesSectionProvider, NSArray, NSAppearance, NSView, NSString, ForYouRecommendationMediator, StartPageCloudTabsSectionProvider, NSButton, StartPageFeatureAvailabilitySectionProvider, StartPageSeparatorSectionProvider, NSSet, StartPageHighlightsSectionProvider, StartPagePasswordBreachSectionProvider, StartPagePopoverViewController;
@protocol StartPageCollectionSectionProvider;

@interface StartPageCollectionViewController : NSViewController <StartPageSuggestionsSectionProviderDelegate, CollectionViewPlusDelegate, NSCollectionViewDataSource, StartPageCollectionViewLayoutSectionProvider, StartPageFavoritesSectionProviderDelegate, StartPagePopoverDelegate, WBSCloudTabDeviceObserving, WBTabGroupManagerObserver, StartPageCollectionSectionTitleViewDelegate, StartPagePrivateRelayInPrivateBrowsingSectionProviderDelegate, StartPageFeatureAvailabilitySectionProviderDelegate, StartPageCollectionSectionProviderDelegate, StartPageContentViewController> {
    ...
    BOOL _didSetUpFeatureAvailabilitySection;
    BOOL _shouldShowFeatureAvailabilitySection;
...
- (BOOL)_canShowFeatureAvailabilitySection;
...
- (void)_loadFeatureAvailabilitySectionProvider;
- (void)_loadHighlightsSectionProvider;
- (void)_loadOnboardingSectionProvider;
...
- (BOOL)_shouldShowBackgroundImage;
- (void)_softwareUpdateAwarenessDidChange:(id)a0;
...
- (BOOL)canShowSoftwareUpdateAwarenessView;
...
- (id)initWithCompactAppearance:(BOOL)a0 startPageType:(long long)a1 usesPrivateBrowsing:(BOOL)a2 inBrowserWindowController:(id)a3 deviceUUIDForStandaloneCloudTabsStartPage:(id)a4;
...
- (void)startPageFeatureAvailabilitySectionProvider:(id)a0 didCloseAfterImportingBrowserData:(BOOL)a1;
