...
@property (readonly, nonatomic) BOOL alwaysPromptForDownloadFolder;
...
- (void)_extractDownloadedArchiveWithURL:(id)a0 ofType:(unsigned long long)a1 forDownloadWithIdentifier:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_moveDownloadedFilesWithURLs:(id)a0 inDownloadWithIdentifier:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)_tokenByIssuingSandboxExtension:(const char *)a0 forFileAtURL:(id)a1 flags:(unsigned int)a2;
...
- (void)extractDownloadedArchiveWithURL:(id)a0 ofType:(unsigned long long)a1 forDownloadWithIdentifier:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)moveDownloadedFilesAtURLs:(id)a0 inDownloadWithIdentifier:(id)a1 completionHandler:(id /* block */)a2;
- (void)removeQuarantineHardAttributeFromFileAtURL:(id)a0 completionHandler:(id /* block */)a1;
