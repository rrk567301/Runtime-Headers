@class UnifiedTabBarButton, UnifiedTabBarClipView, UnifiedTabBarItemList, BackdropView, UnifiedTabBarLayout, NSMutableArray, NSString, NSMutableSet, TabPreviewController, UnifiedTabBarItem, NSArray, NSMutableDictionary, NSSet, NSLayoutConstraint, WBSDispatchSourceTimer, NSView, NSScrollView, NSTrackingArea, NSMapTable, NSPopUpButton, UnifiedTabBarDebugView;
...
- (void)morphingDragImage:(id)a0 movedToPoint:(struct CGPoint { double x0; double x1; })a1;
...
- (void)_cleanUpDraggingInformation;
...
- (BOOL)_isAnyInactiveTabSelected;
...
- (void)_removeTabBarButtonsForTabBarItems:(id)a0 addRemovedButtonsToSet:(id)a1 addRemovedButtonSeparatorsToSet:(id)a2 addRemovedItemsToSet:(id)a3 removeFromSuperview:(BOOL)a4;
...
- (void)_updateActiveTabSelectionForMultiSelectIfNeeded;
...
- (void)dismissAlternatePreviewForTabPreviewController:(id)a0;
...
- (void)morphingDragImage:(id)a0 getWindowImageUsingBlock:(id /* block */)a1;
