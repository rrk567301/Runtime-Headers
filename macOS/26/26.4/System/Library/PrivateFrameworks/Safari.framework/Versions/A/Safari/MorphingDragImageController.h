@class NSView, NSString, NSArray, NSTimer, DetachedTabDraggingImageToWindowTransitionController, NSAnimation, MorphingDragView, NSWindow, NSImageView, _TearOffTabWindow, MutableDraggingInfo;
...
@interface MorphingDragImageController : NSObject <NSTearOffTabWindowDelegate> {
    ...
    struct CGSize { double width; double height; } _maximumScreenSize;
...
+ (void)dragTabsWithDraggingItems:(id)a0 tabDragView:(id)a1 tabBookmarkImage:(id)a2 bookmarks:(id)a3 windowImage:(id)a4 fromView:(id)a5 at:(struct CGPoint { double x0; double x1; })a6 source:(id)a7;
...
- (void)_dragTabsWithDraggingItems:(id)a0 tabDragView:(id)a1 pinnedTabDragView:(id)a2 tabBookmarkImage:(id)a3 bookmarks:(id)a4 windowImage:(id)a5 fromView:(id)a6 at:(struct CGPoint { double x0; double x1; })a7 source:(id)a8;
- (void)_morphToDragView:(id)a0;
- (void)_prepareForDragWithView:(id)a0;
