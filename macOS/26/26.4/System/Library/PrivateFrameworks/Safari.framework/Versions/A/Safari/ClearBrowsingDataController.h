...
@property (readonly) unsigned long long tombstoneGenerationMethod;
...
- (id)_defaultRecentWebSearchesController;
- (void)_deleteAllUserDefinedContentBlockerAndReload;
- (void)_deleteUnusedSafariDesktopPictureFiles;
- (id)initWithTombstoneGenerationMethod:(unsigned long long)a0;
