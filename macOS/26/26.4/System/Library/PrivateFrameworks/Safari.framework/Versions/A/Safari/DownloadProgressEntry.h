...
@interface DownloadProgressEntry : NSObject <NSFilePresenter> {
    ...
    struct unique_ptr<SafariShared::SuddenTerminationDisabler, std::default_delete<SafariShared::SuddenTerminationDisabler>> { struct { struct SuddenTerminationDisabler *__ptr_; } ; } m_suddenTerminationDisabler;
...
@property (copy, nonatomic) NSString *securityOriginHost;
...
- (void)_addPostDownloadFileWithURL:(id)a0;
- (void)_addPostDownloadFiles:(id)a0;
- (void)_addUnarchivedFiles:(id)a0;
- (unsigned long long)_additionalSpaceRequiredAtURL:(id)a0;
- (id)_allFiles;
- (void)_applyQuarantineAttributesToDownloadFile:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_continuePostProcessingWithResumeData:(id)a0;
...
- (void)_setDownloadFileWithURL:(id)a0;
...
- (void)_updateFileURL:(id)a0 ofFile:(id)a1;
...
- (void)setDownloadFileWithURL:(id)a0;
