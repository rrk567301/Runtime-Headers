@class NSStackView, NSIndexPath, WBSNamedColorOption, WBSStartPageSectionManager, NSScrollView, NSLayoutConstraint, NSString, CollectionViewPlus, NSSet, ToggleRowItem, NSArray, NSView, NSCollectionView, WBSCGImage, NSPopover;
@protocol StartPagePopoverDelegate;

@interface StartPagePopoverViewController : NSViewController <WBTabGroupManagerObserver, CollectionViewPlusDelegate, NSCollectionViewDataSource, NSFilePromiseProviderDelegate, NSPopoverDelegate, WBSDeallocationSentinelObserver> {
