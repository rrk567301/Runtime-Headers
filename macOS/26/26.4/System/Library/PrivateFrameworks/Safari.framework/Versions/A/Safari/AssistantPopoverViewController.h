@class NSView, NSString, NSArray, AssistantPopoverPageMenuItemInfo, AssistantPopoverSection, NSMutableDictionary, AssistantPopoverResultCollectionViewCellActionButton, NSMutableArray, NSLayoutConstraint, AssistantPopoverResultsCollectionViewController, BrowserWindowController;
...
@property (retain, nonatomic) NSLayoutConstraint *popoverWidthConstraint;
@property (copy, nonatomic) NSString *webpageIdentifier;
@property (nonatomic) BOOL enableScribble;
@property (nonatomic) BOOL enableSummarizeItem;
...
- (void)viewWillAppear;
- (void)showUnsafeSummaryWarning:(id)a0 headerText:(id)a1 buttonTitle:(id)a2 continueAction:(SEL)a3;
...
- (void)_didClickReportWebPageCompatibilityIssueButton:(id)a0;
- (void)_didClickStartScribble:(id)a0;
- (void)_didClickSummarizeButton:(id)a0;
- (void)_findInPageButtonClicked:(id)a0;
- (long long)_getSearchResultSection:(id)a0;
- (id)_highlightConsentNotNowButton;
- (id)_highlightConsentTurnOnButton;
...
- (void)_updateSummaryCellWithPlaceholder;
...
- (void)showSummaryWithFinalText:(id)a0 readerTextUsedForSummarization:(id)a1 footer:(id)a2 enableRetry:(BOOL)a3;
- (void)showSummaryWithPlaceholder:(id)a0;
- (void)showUnsafeSummaryWarning:(id)a0 continueAction:(SEL)a1;
- (void)updateIfNeededWithHiddenElementCount:(unsigned long long)a0;
- (void)updatePictureInPictureItemIfPlaying:(BOOL)a0 isInPictureInPicture:(BOOL)a1;
- (void)updateReaderResultsIfNeededWithTitle:(id)a0 readerCellDelegate:(id)a1;
- (void)updateScribbleFeedbackItemVisibility;
- (void)updateSummaryCard:(id)a0 header:(id)a1 symbol:(id)a2 footer:(id)a3 enableRetry:(BOOL)a4;
