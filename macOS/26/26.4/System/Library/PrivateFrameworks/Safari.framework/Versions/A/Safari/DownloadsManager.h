@class NSTimer, NSString, NSURL, WBSCoalescedAsynchronousWriter, NSMutableDictionary, NSMutableSet, NSMutableArray, AuthenticationSheetRequest, NSMapTable;
...
- (void)_decrementPendingDownloadsCountForSecurityOriginHost:(id)a0;
- (void)_didStartDownloadEntry:(id)a0 withNotification:(id)a1 voiceOverMessage:(id)a2;
- (void)_download:(id)a0 didCreateDestinationAtURL:(id)a1;
...
- (void)_incrementPendingDownloadsCountForSecurityOriginHost:(id)a0;
...
- (unsigned long long)_pendingDownloadsCountBySecurityOriginHost:(id)a0;
...
- (void)_reportInvalidDownloadFileErrorAtURL:(id)a0;
...
- (void)resumeDownloadAtFileURL:(id)a0;
- (void)setPendingDownloadNavigatedWebView:(id)a0 forOriginatingWebView:(id)a1;
- (void)showPermissionDialogTabForDownloadProgressEntry:(id)a0;
