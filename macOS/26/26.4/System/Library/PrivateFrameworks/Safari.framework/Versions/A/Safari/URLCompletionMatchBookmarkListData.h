@class NSString, SafariWebBookmark, NSMutableArray;
@protocol WBSURLCompletionMatchData, WBSCloudTabItem;
...
@property (readonly, nonatomic) id<WBSURLCompletionMatchData> historyMatchData;
...
@property (readonly, nonatomic) BOOL containsReadingListItem;
...
- (id)initWithBookmarks:(id)a0 andHistoryMatchData:(id)a1;
