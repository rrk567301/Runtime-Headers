...
@interface BrowserViewController : WebViewController <AutoFillFunctionBarProviderDelegate, BookmarksViewControllerDelegate, BrowserViewIconLoadingDelegate, DefaultBrowserBannerDelegate, FormAutoFillCompletionControllerObserver, FormMetadataObserver, NSOpenSavePanelDelegate, PagePreviewAnimationControllerDelegate, ReaderStateObserver, RemoteNotificationControllerClient, RemoteNotificationPermissionHandler, SandboxExtensionPresentationDelegate, TabDialogPresentationManagerDelegate, WBSCertificateWarningPageHandler, WBSAutoFillJavaScriptFocusObserver, TabEntityInfoProviding, BrowserDiagnosticLoggingBiomeDelegate, WBSBiomeNavigationDonor, _WKAppHighlightDelegate, OnDeviceSummarizationDelegate, SummarizationAnimationCoordinatorDelegate, AssistantPopoverResultCollectionViewCellDelegate, WBSBrowsingAssistantControllerDelegate, PrivateBrowsingPrivacyProtectionsBannerDelegate, WBSQueryParameterFilteringDataQueueDelegate, WBSTranslationConsentAlertHelperDelegate, WBSTranslationContextDelegate, ScribbleUnifiedFieldOverlayControllerDelegate, WBSScribbleControllerDelegate, WBSSiriIntelligenceDonorTabDataProviding, AuthenticationSheetRequestDelegate, BrowserViewControllerLoading, MutableMediaSource, ReaderActivationDelegate, ReaderAvailabilityDelegate, SearchableWKViewCancelDelegate, TabDialogPresenter, WBSCloudFeedbackSource, WBSFluidProgressStateSource, WBSWebExtensionTab> {
    ...
    BOOL _shouldRecordDefaultBannerInteractions;
    BOOL _isTabClosing;
    ...
    id /* block */ _readerTextExtractionCompletionHandler;
...
@property (readonly, nonatomic) BOOL isPageEligibleToShowNotSecureWarning;
...
@property (readonly, nonatomic) FormAutoFillController *autoFillController;
...
@property (readonly, nonatomic) BOOL didTryHidingDistractionsOnCurrentPage;
...
@property (copy, nonatomic) id /* block */ test_mainDocumentDidLoadHandler;
...
- (BOOL)_isTopScrollPocketColorDisabled;
...
- (BOOL)_extensionTintColorConflictsWithWebpage;
...
- (void)_modifiedGeneratedPasswordContentInFormOrFieldWithFormMetadata:(id)a0 inFrame:(const void *)a1;
...
- (void)_setUsesSolidColorInTopScrollPocketWithReaderPreference:(BOOL)a0;
...
- (BOOL)_shouldPerformActionInFormTextFieldWithMetadata:(id)a0 formMetadata:(id)a1 inFrame:(const void *)a2 actionType:(unsigned int)a3;
...
- (void)_textFieldDidEndEditingInFrame:(const void *)a0 textFieldMetadata:(id)a1;
...
- (id)certificateWarningHTML:(id)a0;
- (void)clearAllStatus;
...
- (void)clearUnsubmittedInformationInFormWithID:(long long)a0 sourceFrame:(const void *)a1;
...
- (void)didAutoDetectSearchURLTemplateString:(id)a0 inFrame:(id)a1;
- (void)didBecomeCurrentBrowserViewController;
- (void)didCalculateBestWidthForPage:(double)a0;
- (void)didCancelClientRedirect;
...
- (void)extractReaderTextNowWithCompletionHandler:(id /* block */)a0;
...
- (void)formObservedChangeIndicatingFormSubmission:(id)a0 removedControls:(id)a1 inFrame:(id)a2;
...
- (BOOL)isPageModificationInProgress;
...
- (void)manualAutoFillRequestForControl:(id)a0 form:(id)a1 frameInfo:(id)a2;
- (void)manualAutoFillRequestForControl:(id)a0 form:(id)a1 inFrame:(id)a2;
- (void)modifiedGeneratedPasswordContentInFormOrFieldWithFormMetadata:(id)a0 frameInfo:(id)a1;
- (void)modifiedGeneratedPasswordContentInFormOrFieldWithFormMetadataAsData:(const void *)a0 inFrame:(const void *)a1;
...
- (void)performActionInFormTextFieldWithMetadata:(id)a0 formMetadata:(id)a1 withFrameInfo:(id)a2 actionType:(unsigned int)a3;
...
- (id)preferencesForCertificateWarningHTML;
...
- (void)recordUserSetDefaultBrowser;
- (void)recordUserShownDefaultBrowserBanner;
...
- (void)setStatusForMouseoverWithHitTestResult:(id)a0 modifiers:(unsigned long long)a1;
...
- (void)showDefaultBrowserBannerTriggeringAttribution:(BOOL)a0;
...
- (void)textDidChangeInTextFieldWithMetadata:(id)a0 formMetadata:(id)a1 frameInfo:(id)a2;
...
- (void)textFieldBlurredWithFrameInfo:(id)a0 formMetadata:(id)a1 textFieldMetadata:(id)a2;
- (void)textFieldDidEndEditingInFrame:(const void *)a0 textFieldMetadata:(const void *)a1;
- (void)textFieldDidEndEditingWithFrameInfo:(id)a0 textFieldMetadata:(id)a1;
- (void)textFieldFocusedInFrame:(id)a0 formMetadata:(id)a1 textFieldMetadata:(id)a2;
- (void)textFieldFocusedWithFrameInfo:(id)a0 formMetadata:(id)a1 textFieldMetadata:(id)a2;
- (void)toggleReader;
...
- (void)willPerformClientRedirect:(id)a0 toURL:(id)a1;
- (void)willSubmitFormValues:(id)a0 fromFrame:(id)a1 values:(id)a2 formMetadata:(id)a3 targetURL:(id)a4 submissionHandler:(id /* block */)a5;
- (void)zoomIn;
