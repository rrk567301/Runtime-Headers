@class _PSMegadomeFamilyUtility, CNContactStore, _CDInteractionStore, HKMedicalIDStore, NSObject, _PSContactResolver;
...
- (id)familyRecipientsFromMegadomeWithPredictionContext:(id)a0;
- (id)familyRecommendationSuggestionsForShareSheetWithPredictionContext:(id)a0;
- (id)familyRecommendationSuggestionsFromMegadomeWithPredictionContext:(id)a0;
