...
+ (id)sceneTagsInSharedPhotoAttachments:(id)a0 forBundleID:(id)a1 shouldProcessPicturesLive:(BOOL)a2 withTraceID:(id)a3 withSpanID:(id)a4 withCompletion:(id /* block */)a5;
+ (id)sharedMADService;
