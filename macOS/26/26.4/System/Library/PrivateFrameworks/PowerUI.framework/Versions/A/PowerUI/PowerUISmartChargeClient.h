...
- (id)availableChargeLimitsWithError:(id *)a0;
...
- (BOOL)temporarilyOverrideMCLTargetSoC:(unsigned char)a0 error:(id *)a1;
- (void)temporarilyOverrideMCLTargetSoC:(unsigned char)a0 withHandler:(id /* block */)a1;
