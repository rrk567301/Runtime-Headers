...
@property (nonatomic) BOOL replicatingEncryptedMessage;
...
+ (BOOL)isBIAWithBlastDoorMessage:(id)a0;
...
+ (id)transcriptBackgroundVersionWithBlastDoorMessage:(id)a0;

- (void).cxx_destruct;
- (id)description;
- (id)initWithBDBasic:(id)a0 idsTrustedData:(id)a1;
- (void)_addTranslatedMessageParts:(id)a0 to:(id)a1;
