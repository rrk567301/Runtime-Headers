...
- (void)appendTranslation:(id)a0 toMessageItem:(id)a1 partIndex:(long long)a2 toChatIdentifier:(id)a3 style:(unsigned char)a4 account:(id)a5;
...
- (void)downloadTranslationAssetsForLanguageCodes:(id)a0 messageItemsToTranslateLocally:(id)a1 chatIdentifier:(id)a2 style:(unsigned char)a3 account:(id)a4;
- (void)downloadTranslationAssetsForLanguageCodes:(id)a0 messageItemsToTranslateLocally:(id)a1 chatIdentifier:(id)a2 style:(unsigned char)a3 account:(id)a4;
...
- (void)__metricValidationError:(id)a0 withSubtypePrefix:(id)a1 chatGUID:(id)a2 serviceName:(id)a3;
...
- (void)didUpdateChatStatusWithContext:(id)a0;
- (id)groupChatIdentifierForChatRoom:(id)a0;
- (id)groupIDForChat:(id)a0;
- (void)markItemForOffGridRelay:(id)a0 inChat:(id)a1;
...
- (BOOL)__validateDisplayNameAndParticipantsForChat:(id)a0 relayMessageItem:(id)a1 messageGUID:(id)a2 serviceName:(id)a3 againstRecipients:(id)a4 trustLocalChat:(BOOL)a5 error:(id *)a6;
- (void)_abandonPWFetcher;
- (void)_abandonSystemProxySettingsFetcher;
- (BOOL)_alwaysAllowMarkingSent;
- (void)_applyChat:(id)a0 toMetric:(id)a1;
- (void)_applyTransferGUIDs:(id)a0 toMetric:(id)a1 isOutgoing:(BOOL)a2;
- (void)_autoReconnectTimer:(id)a0;
- (id)_autoReplier;
- (void)_automation_messageDeliveryControllerDidFlushCacheForRemoteURI:(id)a0 fromURI:(id)a1 guid:(id)a2;
- (void)_blastDoorProcessingWithIMMessageItem:(id)a0 chat:(id)a1 account:(id)a2 fromToken:(id)a3 fromIDSID:(id)a4 fromIdentifier:(id)a5 toIdentifier:(id)a6 participants:(id)a7 groupName:(id)a8 groupID:(id)a9 isFromMe:(BOOL)a10 isLastFromStorage:(BOOL)a11 isFromStorage:(BOOL)a12 batchID:(id)a13 hideLockScreenNotification:(BOOL)a14 wantsCheckpointing:(BOOL)a15 needsDeliveryReceipt:(id)a16 messageBalloonPayloadAttachmentDictionary:(id)a17 inlineAttachments:(id)a18 attributionInfoArray:(id)a19 nicknameDictionary:(id)a20 availabilityVerificationRecipientChannelIDPrefix:(id)a21 availabilityVerificationRecipientEncryptionValidationToken:(id)a22 availabilityOffGridRecipientSubscriptionValidationToken:(id)a23 availabilityOffGridRecipientEncryptionValidationToken:(id)a24 idsService:(id)a25 messageContext:(id)a26 isFromTrustedSender:(BOOL)a27 isFromSnapTrustedSender:(BOOL)a28 wasContextUsed:(BOOL)a29 isBlackholed:(BOOL)a30 shouldTrackForRequery:(BOOL)a31 isFiltered:(long long)a32 spamDetectionSource:(long long)a33 completionBlock:(id /* block */)a34;
...
- (void)_processMessagesForRelayIfNeededMarkingAsRelayedUponSuccess:(BOOL)a0;
- (void)_processNetworkMonitorUpdate;
- (void)_processParticipantConvergenceResult:(id)a0 forChat:(id)a1;
...
- (BOOL)_validateChat:(id)a0 relayMessage:(id)a1 fromIdentifier:(id)a2 sortedIdentifiers:(id)a3 againstRecipients:(id)a4 error:(id *)a5;
...
- (id)chatForChatIdentifier:(id)a0 style:(unsigned char)a1 account:(id)a2 updatingAccount:(BOOL)a3;
- (id)chatForChatIdentifier:(id)a0 style:(unsigned char)a1 updatingAccount:(BOOL)a2;
...
- (id)dictionaryForHandlesToGUIDsFromHandleInfo:(id)a0;
...
- (void)didJoinChat:(id)a0 style:(unsigned char)a1 displayName:(id)a2 groupID:(id)a3 handleInfo:(id)a4 category:(long long)a5 account:(id)a6 isBlackholed:(BOOL)a7 spamDetectionSource:(long long)a8;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 handleInfo:(id)a5 account:(id)a6 category:(long long)a7 isBlackholed:(BOOL)a8 spamDetectionSource:(long long)a9;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 lastAddressedHandle:(id)a5 lastAddressedSIMID:(id)a6 handleInfo:(id)a7 account:(id)a8 category:(long long)a9 spamExtensionName:(id)a10 isBlackholed:(BOOL)a11 spamDetectionSource:(long long)a12;
...
- (void)didUpdateChatStatus:(int)a0 chat:(id)a1 style:(unsigned char)a2 displayName:(id)a3 groupID:(id)a4 originalGroupID:(id)a5 lastAddressedHandle:(id)a6 lastAddressedSIMID:(id)a7 handleInfo:(id)a8 account:(id)a9 category:(long long)a10 spamExtensionName:(id)a11 isBlackholed:(BOOL)a12 spamDetectionSource:(long long)a13;
...
- (void)receiveIncomingBlastdoorBackgroundCommand:(id)a0 for:(id)a1 sender:(id)a2 senderContext:(id)a3;
...
- (BOOL)reflectAcceptChatToPeerDevicesForMessageGUID:(id)a0;
- (BOOL)reflectJunkChatForTrustKitToPeerDevicesForMessageGUID:(id)a0 forReason:(unsigned long long)a1 withMetadata:(id)a2;
- (BOOL)reflectJunkChatToPeerDevicesForMessageGUID:(id)a0;
- (BOOL)reflectMarkAsReviewedToPeerDevicesForChatGUIDs:(id)a0;
...
- (BOOL)reflectTranslationWithCommand:(id)a0;
...
- (void)relayLegacySatelliteMessage:(id)a0 toChat:(id)a1 localWatchOnly:(BOOL)a2;
...
- (void)requestTranscriptBackgroundIfNecessary:(id)a0 toIdentifier:(id)a1 fromIdentifier:(id)a2 messageIsFromStorage:(BOOL)a3;
...
- (void)sendHQAttachmentsForMessage:(id)a0 toChatID:(id)a1 style:(unsigned char)a2;
- (void)sendIncomingRelayMessage:(id)a0 toChat:(id)a1 style:(unsigned char)a2;
...
- (void)sendRelayDeliveryReceiptForMessageID:(id)a0 toChat:(id)a1;
- (void)sendRelayMessage:(id)a0 toChat:(id)a1 style:(unsigned char)a2;
- (void)sendReportJunkMessageGUID:(id)a0 shouldRelay:(BOOL)a1;
- (void)sendReportNotJunkMessageGUID:(id)a0;
...
- (void)storeMessages:(id)a0 messagesToWithdraw:(id)a1 messagesToPost:(id)a2 chatIdentifier:(id)a3 style:(unsigned char)a4 account:(id)a5 fromIDSID:(id)a6;
- (BOOL)testOverrideTextValidationDidFail;
- (void)trackTimeSensitiveContentInMessageItem:(id)a0 chat:(id)a1;
- (id)unifiedMetricForIncomingMessage:(id)a0 inChat:(id)a1 transportType:(long long)a2;
- (id)unifiedMetricForOutgoingMessage:(id)a0 inChat:(id)a1 transportType:(long long)a2;
