@class NSData, NSString, NSArray, NSRecursiveLock, NSMutableDictionary, IMDCKUtilities, IMDChatStore, IMDMessageHistorySyncController, NSMutableSet, TUConversationManager, IMDBackgroundMessageProcessingController, IMAcceptedContactsChangeNotifier;
...
- (void)_reportMessageDictionaryForMessages:(id)a0 isAutoReport:(BOOL)a1 withChat:(id)a2 conversationID:(id)a3 maxMessagesToReport:(unsigned long long)a4 totalMessageCount:(unsigned long long *)a5 notifyInternalSecurity:(BOOL)a6 isJunkReportedToCarrier:(BOOL)a7 reportReason:(unsigned long long)a8 context:(id)a9;
...
- (void)_reportMessageDictionaryForMessages:(id)a0 isAutoReport:(BOOL)a1 withChat:(id)a2 conversationID:(id)a3 maxMessagesToReport:(unsigned long long)a4 totalMessageCount:(unsigned long long *)a5 isJunkReportedToCarrier:(BOOL)a6 reportReason:(unsigned long long)a7 context:(id)a8;
...
- (void)_refreshDomainIdentifiersForChat:(id)a0;
