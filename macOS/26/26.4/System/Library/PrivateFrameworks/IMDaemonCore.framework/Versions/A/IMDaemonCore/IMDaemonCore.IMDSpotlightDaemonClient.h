@interface IMDaemonCore.IMDSpotlightDaemonClient : NSObject <IMDBaseSpotlightIndexControllerDelegate, SpotlightDaemonClient> {
    void /* unknown type, empty encoding */ importer;
    void /* unknown type, empty encoding */ indexesLock;
