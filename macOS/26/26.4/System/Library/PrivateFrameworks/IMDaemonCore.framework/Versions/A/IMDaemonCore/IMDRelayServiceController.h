@class NSString, NSArray, IMDRelayPushHandler, IDSService, NSMutableDictionary, IMDRelayDeletionController, IMDService, IMOneTimeCodeUtilities, IMDRelayEnrollmentController;
...
+ (id)_convertIMMessageItemToIncomingRelayDictionary:(id)a0 chat:(id)a1 serviceName:(id)a2 overridingAttachmentData:(id)a3;
...
- (void)_forwardMessageToPeers:(id)a0 messageType:(long long)a1 guid:(id)a2 originalSender:(id)a3 forcedCallerID:(id)a4 hasAttachment:(BOOL)a5 watchOnly:(BOOL)a6 sentToDevices:(id *)a7 requiredCapabilities:(id)a8;
...
- (BOOL)_relayMessageToPeers:(id)a0 forChat:(id)a1 serviceName:(id)a2 requiredCapabilities:(id)a3 reflectOnly:(BOOL)a4 excludesWatch:(BOOL)a5 onlyWatch:(BOOL)a6 overridingAttachmentData:(id)a7 skipServiceForSending:(BOOL)a8;
...
- (void)forwardMessageToPeers:(id)a0 messageType:(long long)a1 guid:(id)a2 originalSender:(id)a3 forcedCallerID:(id)a4;
- (void)forwardMessageToPeers:(id)a0 messageType:(long long)a1 guid:(id)a2 originalSender:(id)a3 forcedCallerID:(id)a4 hasAttachment:(BOOL)a5 watchOnly:(BOOL)a6;
- (void)forwardMessageToPeers:(id)a0 messageType:(long long)a1 guid:(id)a2 originalSender:(id)a3 forcedCallerID:(id)a4 watchOnly:(BOOL)a5;
...
- (void)messageFailedToSend:(id)a0 messageExtras:(id)a1;
...
- (id)phoneAliasForDominentPhoneAlias:(id)a0 registeredPhoneNumbers:(id)a1 preferredCallerID:(id)a2 CTPhoneNumber:(id)a3;
- (BOOL)reflectCommandTranslationWithDictionary:(id)a0 relayToWatchOnly:(id)a1;
- (void)reflectGroupMutation:(id)a0 callerID:(id)a1 didOccurLocally:(BOOL)a2;
- (void)reflectGroupMutation:(id)a0 toPushToken:(id)a1 callerID:(id)a2 didOccurLocally:(BOOL)a3;
...
- (BOOL)reflectTranslationWithCommand:(id)a0 serviceName:(id)a1;
...
- (void)relayMessage:(id)a0 chat:(id)a1 didSendSMS:(BOOL)a2 attemptingReplication:(BOOL)a3 forceReflection:(BOOL)a4 relayToWatchOnly:(BOOL)a5 shouldDisableScreenTimeRestrictions:(BOOL)a6 callerID:(id)a7 iMessageCapability:(long long)a8 requiredCapabilities:(id)a9 skipServiceForSending:(BOOL)a10;
- (BOOL)relayMessageToPeers:(id)a0 forChat:(id)a1 serviceName:(id)a2 reflectOnly:(BOOL)a3 requiredCapabilities:(id)a4;
- (BOOL)relayMessageToPeers:(id)a0 forChat:(id)a1 serviceName:(id)a2 reflectOnly:(BOOL)a3 requiredCapabilities:(id)a4 skipServiceForSending:(BOOL)a5;
- (void)reportJunkMessageToCarrier:(id)a0 toChat:(id)a1 fromCallerID:(id)a2;
