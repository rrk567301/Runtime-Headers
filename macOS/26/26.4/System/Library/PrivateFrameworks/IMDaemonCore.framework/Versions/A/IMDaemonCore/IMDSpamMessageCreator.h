...
- (void)_createJunkMessageDictionaryForItem:(id)a0 senderURI:(id)a1 chat:(id)a2 conversationID:(id)a3 receiverURI:(id)a4 notifyInternalSecurity:(BOOL)a5 reportReason:(unsigned long long)a6 completionBlock:(id /* block */)a7;
- (void)_finishReportMessageDictionariesWithiMessageSpamDictionaries:(id)a0 textMessageSpamDictionaries:(id)a1 trustKitSpamDictionaries:(id)a2 smsServiceReportAllowed:(BOOL)a3 maxMessagesPerReport:(unsigned long long)a4 chat:(id)a5 totalMessageCount:(unsigned long long *)a6 totalMessages:(unsigned long long)a7 context:(id)a8;
...
- (void)_uploadToMMCSForItem:(id)a0 transfer:(id)a1 completionBlock:(id /* block */)a2;
...
- (void)reportMessageDictionariesForMessages:(id)a0 isAutoReport:(BOOL)a1 withChat:(id)a2 conversationID:(id)a3 maxMessagesToReport:(unsigned long long)a4 totalMessageCount:(unsigned long long *)a5 notifyInternalSecurity:(BOOL)a6 isJunkReportedToCarrier:(BOOL)a7 reportReason:(unsigned long long)a8 context:(id)a9;
- (void)reportMessageDictionaryToApple:(id)a0 forChat:(id)a1 isJunk:(BOOL)a2 context:(id)a3;
