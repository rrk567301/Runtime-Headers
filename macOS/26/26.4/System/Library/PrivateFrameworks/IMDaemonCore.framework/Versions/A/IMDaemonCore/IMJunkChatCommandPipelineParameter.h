@class BlastDoorTrustKitSpamReport, NSString, NSArray, IMDChat, NSDictionary, IMDAccount, IMDServiceSession, NSNumber;

@interface IMJunkChatCommandPipelineParameter : NSObject <IMJunkChatCommandProcessingParameter, IMFindAccountProcessingParameter, IMMessageFromStorageParameter>
