...
- (void)_metricIdentifierIfMalformed:(id)a0 domain:(id)a1 subType:(id)a2;
- (void)_metricIdentifiersIfMalformed:(id)a0 subType:(id)a1;
...
- (BOOL)hasMatchingParticipantHandles:(id)a0;
...
- (void)updateIsFiltered:(long long)a0 fromContact:(BOOL)a1;
