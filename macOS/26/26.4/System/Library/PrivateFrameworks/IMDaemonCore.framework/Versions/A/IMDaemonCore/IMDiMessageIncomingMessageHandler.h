...
- (void)handlePriorityMessageCommandWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
- (void)handleChatSessionCloseWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
- (void)handleJunkChatCommandWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
- (void)handleMarkAsReviewedCommandWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
- (void)handleTranscriptBackgroundCommandWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
...
- (void)handleAcceptChatCommandWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
...
- (void)handleTranslationWithPipeline:(id)a0 input:(id)a1 completionBlock:(id /* block */)a2;
