...
@property (readonly, nonatomic) BOOL isFromActivePairedDevice;
...
@property (readonly, nonatomic, getter=isFromSnapTrustedSender) BOOL fromSnapTrustedSender;
@property (copy, nonatomic) NSString *senderCorrelationIdentifier;
@property (readonly, nonatomic) BOOL hadQOI;
@property (readonly, nonatomic) NSDictionary *batchContext;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (id)description;
- (id)initWithBatchedMessage:(id)a0 batchContext:(id)a1;
- (id)initWithTopLevelMessage:(id)a0 fromPushID:(id)a1 messageContext:(id)a2;
- (void)updateIsFromActivePairedDeviceForService:(id)a0;
