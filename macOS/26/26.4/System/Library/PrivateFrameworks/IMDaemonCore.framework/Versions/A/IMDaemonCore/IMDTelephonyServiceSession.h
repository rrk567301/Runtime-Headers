...
- (id)_phoneNumberForRegisteredSimID:(id)a0;
...
- (void)_convergeChat:(id)a0 fromValidationError:(id)a1 recipients:(id)a2 groupID:(id)a3 fromIdentifier:(id)a4;
...
- (BOOL)_hasRegisteredLocalPhoneNumberForHandle:(id)a0;
- (long long)_iMessageCapabilityForSIMID:(id)a0;
- (id)_identifierForMergedBusinessThread:(id)a0;
- (BOOL)_isMessageFromPairedDeviceFromIdentifier:(id)a0 toIdentifier:(id)a1 fromToken:(id)a2 checkFor:(id)a3;
...
- (void)_relayGroupMutationsWithValidationErrorUserInfo:(id)a0 message:(id)a1 fromIdentifier:(id)a2 token:(id)a3 chat:(id)a4;
...
- (void)_reportReceivedMetricForSMSWithMessage:(id)a0 context:(id)a1;
- (void)_resetAndBroadcastBlackholeErrorStateIfNeededForChatIdentifier:(id)a0 chatStyle:(unsigned char)a1;
- (id)_resolvedCallerIDForLastAddressedLocalHandle:(id)a0 lastAddressedSIMID:(id)a1 saveResolvedCallerIDToChat:(BOOL *)a2;
- (BOOL)_sendMessageOverAlternatePath:(id)a0 toChat:(id)a1;
- (unsigned long long)_sendingDecisionForMessageItem:(id)a0 callerID:(id)a1 lastAddressedLocalHandle:(id)a2 lastAddressedSIMID:(id)a3;
- (id)_sendingHandleForOutgoingMessageInChat:(id)a0 fromIdentifier:(id)a1;
...
- (void)handleRelayEncryptionFailureForRelayMessageID:(id)a0;
...
- (void)handler:(id)a0 receivedJunkChatCommand:(id)a1 fromIdentifier:(id)a2 toIdentifier:(id)a3 fromToken:(id)a4;
- (void)handler:(id)a0 receivedPriorityMessageCommand:(id)a1 fromIdentifier:(id)a2 toIdentifier:(id)a3 fromToken:(id)a4;
- (void)handler:(id)a0 receivedTranslationCommand:(id)a1;
...
- (void)processMessageSendFailure:(id)a0 messageExtras:(id)a1;
