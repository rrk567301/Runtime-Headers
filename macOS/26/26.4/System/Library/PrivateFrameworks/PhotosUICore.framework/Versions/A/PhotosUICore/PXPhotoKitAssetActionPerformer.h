...
+ (BOOL)_canPerformWithActionManager:(id)a0 error:(id *)a1;
+ (BOOL)_canPerformWithSelectionSnapshot:(id)a0 person:(id)a1 socialGroup:(id)a2 error:(id *)a3;
+ (BOOL)canPerformOnAsset:(id)a0 inAssetCollection:(id)a1 person:(id)a2 socialGroup:(id)a3 error:(id *)a4;
+ (BOOL)canPerformOnImplicitSelectionInContainerCollection:(id)a0;
+ (BOOL)canPerformWithActionManager:(id)a0 error:(id *)a1;
+ (BOOL)canPerformWithSelectionSnapshot:(id)a0 person:(id)a1 socialGroup:(id)a2 error:(id *)a3;
