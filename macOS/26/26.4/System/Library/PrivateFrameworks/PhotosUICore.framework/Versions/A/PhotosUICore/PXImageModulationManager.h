@class PXRequestedEDRHeadroomFactorFilter, NSViewController, NSString, PXImageModulationSettings, NSHashTable, CAContext;
...
@property (readonly, weak, nonatomic) NSViewController *rootViewController;
