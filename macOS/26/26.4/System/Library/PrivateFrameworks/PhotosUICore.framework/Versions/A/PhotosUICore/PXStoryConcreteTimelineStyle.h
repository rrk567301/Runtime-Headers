...
- (id)initWithSpec:(id)a0 audioAsset:(id)a1 cueSource:(id)a2 overallDurationInfo:(struct { long long x0; struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; struct { long long x0; int x1; unsigned int x2; long long x3; } x2; } x1; })a3 autoEditDecisionList:(id)a4 autoEditConfiguration:(id)a5 allowedKeyAssetClipCompositions:(id)a6 allowedClipCompositions:(id)a7 randomNumberGenerators:(id)a8 errorReporter:(id)a9 allowsIncompleteTimelines:(BOOL)a10 styleOptions:(struct { unsigned long long x0; BOOL x1; })a11 storyConfiguration:(id)a12;
