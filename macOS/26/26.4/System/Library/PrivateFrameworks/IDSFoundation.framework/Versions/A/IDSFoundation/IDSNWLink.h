...
@property (nonatomic) BOOL ftPowerOptimizationEnabled;
...
+ (id)descriptionForMessageType:(int)a0;
...
- (id)_createP2PQUICPodConnectionWithType:(unsigned int)a0 udpNWLinkConnection:(id)a1 parameters:(id)a2 completionHandler:(id /* block */)a3;
- (id)_createQUICPodConnectionWithType:(unsigned int)a0 quicNWLinkConnection:(id)a1 qpodParameters:(id)a2;
...
- (id)connectionInfoForLocalAddress:(const struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a0 remoteAddress:(const struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a1 clientUniquePID:(unsigned long long)a2 sessionID:(id)a3 type:(unsigned long long)a4 isRelay:(BOOL)a5 protocolStackSuffix:(id)a6 isCellular:(BOOL)a7;
- (id)connectionInfoForToken:(id)a0;
...
- (void)requestPathMTUEvaluationForLocalAddress:(const struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a0 remoteAddress:(const struct sockaddr { unsigned char x0; unsigned char x1; char x2[14]; } *)a1 sessionID:(id)a2 type:(unsigned long long)a3;
