@class NSData, NSString, NSArray, NSDate, IDSSendMessagePolicy, NSMutableDictionary, NSDictionary, IDSSendReasonContainer, IDSDestination, IDSMessageSendMetric, NSNumber;
...
@property (nonatomic) BOOL skipPairedDeviceReflection;
