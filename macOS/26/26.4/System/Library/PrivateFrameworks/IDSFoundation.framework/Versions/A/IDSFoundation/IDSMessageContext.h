@class NSData, NSString, IDSCertifiedDeliveryContext, NSDate, IDSPseudonym, NSError, NSDictionary, IDSServerStorageFetchContext, NSObject, NSNumber, IDSSendMessagePolicyResult;
...
- (void)setQueueOneIdentifier:(id)a0;
