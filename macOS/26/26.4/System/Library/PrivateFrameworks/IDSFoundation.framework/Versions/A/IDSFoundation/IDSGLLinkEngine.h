...
- (id)initWithLinkConnector:(id)a0 allocateType:(long long)a1 isInitiator:(BOOL)a2 useLinkSelection:(BOOL)a3 recordExpensiveQualityMetrics:(BOOL)a4 linkSelectionStrategy:(id)a5 serviceIdentifier:(id)a6 serverBag:(id)a7 experiments:(id)a8;
