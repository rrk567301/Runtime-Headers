...
@interface IDSServiceProperties : NSObject <NSCopying> {
    ...
    unsigned char _supportsBatchDelivery : 1;
    unsigned char _isInternalOnly : 1;
}
...
@property (readonly, nonatomic) BOOL allowLaunchOnNearbyDevicesChanged;
...
@property (readonly, nonatomic) unsigned char skipServerStorageRetry : 1;
...
@property (readonly, nonatomic) unsigned char supportsOfflineDelivery : 1;
@property (readonly, nonatomic) BOOL supportsBatchDelivery;
...
@property (readonly, nonatomic) unsigned char isUltraConstrainedPushAllowed : 1;
@property (readonly, nonatomic) unsigned char requiresPinnedIdentity : 1;
...
@property (readonly, nonatomic) BOOL allowExpensiveQualityMetrics;
@property (readonly, nonatomic) BOOL groupSessionParticipantIDValidation;
...
@property (readonly, nonatomic) unsigned char ignoreServerStorageSSM : 1;
@property (readonly, nonatomic) BOOL isInternalOnly;
@property (readonly, nonatomic) BOOL requiresNewAllocator;
@property (readonly, nonatomic) BOOL enableDirectRTCLogging;
