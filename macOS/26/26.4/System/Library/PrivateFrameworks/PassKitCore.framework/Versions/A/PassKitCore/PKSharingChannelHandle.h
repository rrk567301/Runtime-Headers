...
+ (void)bootstrapProximityChannelWithTemplateSession:(id)a0 group:(id)a1 completion:(id /* block */)a2;
+ (void)bootstrapSetupAssistantProximityChannelWithTemplateSession:(id)a0 completion:(id /* block */)a1;
+ (id)createHandleForDescriptor:(id)a0 queue:(id)a1;
+ (void)descriptorsForAccountDevicesWithServiceType:(unsigned long long)a0 completion:(id /* block */)a1;
+ (void)terminateProximityChannelForGroup:(id)a0;
