@class NSDate, NSString, NSArray, NSURL, NSSet, PKEnteredValueActionItem, NSDictionary, PKPaymentPassActionExternalActionContent, PKPaymentPassActionRemoteConfiguration, PKAutoTopUpActionItem, PKTransitCommutePlan, PKImage;
...
- (id)_initWithBusinessChatIdentifier:(id)a0;
- (id)_initWithExternalURL:(id)a0 title:(id)a1;
...
- (void)applyServiceProviderPropertiesToPaymentRequest:(id)a0;
