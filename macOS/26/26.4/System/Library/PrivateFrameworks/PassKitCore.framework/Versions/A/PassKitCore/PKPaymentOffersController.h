...
@interface PKPaymentOffersController : NSObject <PKPaymentServiceDelegate> {
    ...
    BOOL _didSendPaymentOfferStatus;
...
@property (readonly, nonatomic) BOOL consumingSelectedPaymentOffer;
...
- (BOOL)_handleOffersChangedForPassUniqueID:(id)a0 didRemove:(BOOL)a1;
...
- (void)_sendPaymentStatusIfNecessary:(unsigned long long)a0;
...
- (void)didEndContactlessPaymentSessionForPassUniqueID:(id)a0;
...
- (id)sessionIdentifierForCriteriaIdentifier:(id)a0 shouldGenerateIfNotPresent:(BOOL)a1;
...
- (void)willConsumeSelectedPaymentOfferForPassUniqueID:(id)a0;
