@class NSDecimalNumber, NSDictionary, PKAccountEvent, PKCreditInstallmentPlan, PKPaymentTransactionQuestion, PKPeerPaymentRecurringPayment, NSOrderedSet, PKPaymentTransactionFees, NSString, FKPaymentTransaction, PKAccountServicingEvent, PKCurrencyAmount, PKMerchant, PKTransactionAuthenticationContext, NSArray, PKPaymentTransactionRewards, NSSet, PKPaymentTransactionForeignExchangeInformation, NSData, PKCreditInstallmentPlanPayment, PKPaymentRewardsRedemption, CLLocation, PKAccountServicingEventStatusDetails, NSUUID, PKTransactionReleasedData, NSDate, NSTimeZone, NSNumber, NSURL;
...
@property (readonly, nonatomic) BOOL isPeerPaymentGroupRequestReceivedTransaction;
...
@property (readonly, nonatomic) BOOL isBankConnectTransaction;
...
@property (readonly, nonatomic) BOOL hasUnansweredQuestions;
...
@property (readonly, nonatomic, getter=isUnknownNearbyPeerPayment) BOOL unknownNearbyPeerPayment;
...
+ (id)transactionFromFKPaymentTransaction:(id)a0;
...
+ (id)formattedBalanceAdjustmentForCurrencyAmount:(id)a0 transactionType:(long long)a1 adjustmentType:(long long)a2 peerPaymentType:(long long)a3 featureIdentifier:(unsigned long long)a4 pending:(BOOL)a5 locale:(id)a6;
...
+ (BOOL)isPositiveBalanceAdjustmentForCurrencyAmount:(id)a0 transactionType:(long long)a1 adjustmentType:(long long)a2 peerPaymentType:(long long)a3 featureIdentifier:(unsigned long long)a4;
...
- (void)_applyTransactionCategoryFromRecord:(id)a0;
...
- (id)_formatBalanceAdjustmentTransactionAmount:(id)a0 locale:(id)a1;
- (id)_preformattedStringForMultipleAmounts;
- (id)_preformattedStringForMultipleAmountsWithLocale:(id)a0;
...
- (id)formattedStringForMultipleAmountsForPass:(id)a0 locale:(id)a1;
