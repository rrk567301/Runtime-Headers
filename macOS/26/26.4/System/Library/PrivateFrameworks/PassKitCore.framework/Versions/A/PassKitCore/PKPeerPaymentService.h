...
- (void)deleteUserInfoWithCompletion:(id /* block */)a0;
- (void)encryptData:(id)a0 usingCertificateWithDestination:(unsigned long long)a1 completion:(id /* block */)a2;
- (void)encryptionCertificateForDestination:(unsigned long long)a0 forceUpdate:(BOOL)a1 completion:(id /* block */)a2;
- (void)fetchUserInfoWithCompletion:(id /* block */)a0;
...
- (void)insertOrUpdateUserInfo:(id)a0 completion:(id /* block */)a1;
...
- (void)submitAnswer:(id)a0 forTransaction:(id)a1 completion:(id /* block */)a2;
...
- (void)userInfoWithCompletion:(id /* block */)a0;
