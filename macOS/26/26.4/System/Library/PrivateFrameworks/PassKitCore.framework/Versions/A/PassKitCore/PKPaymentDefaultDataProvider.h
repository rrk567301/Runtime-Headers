...
- (void)credentialIdentifier:(id)a0 paymentApplicationIdentifier:(id)a1 secureElementIdentifier:(id)a2 didUpdateRangingSuspensionReasons:(unsigned long long)a3;
- (BOOL)hideCardBenefitMerchandisingOffers;
...
- (void)setExpressWithPassConfiguration:(id)a0 credential:(id)a1 completion:(id /* block */)a2;
- (void)setHideCardBenefitMerchandisingOffers:(BOOL)a0;
- (void)setHideCardBenefitPayLater:(BOOL)a0;
- (void)setHideCardBenefitRewards:(BOOL)a0;
