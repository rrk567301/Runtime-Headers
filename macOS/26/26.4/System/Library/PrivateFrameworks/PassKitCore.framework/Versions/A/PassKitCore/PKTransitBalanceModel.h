...
@property (readonly, nonatomic) BOOL hasDeviceBoundCommutePlans;

+ (BOOL)shouldCollectPlan:(id)a0 withAction:(id)a1;
...
- (void)getDisplayableCommutePlanDetailsForTitle:(id *)a0 value:(id *)a1 subtitle:(id *)a2 isExpired:(BOOL *)a3;
