@class PKAccountAdditionalPushTopics, NSString, NSURL, NSDate, NSSet, PKAccountDetails, NSArray, PKCreditAccountDetails, PKAppleBalanceAccountDetails, PKAccountMinimumOSVersions, PKSavingsAccountDetails, PKAccountFetchPeriods;
...
- (void)copyFinanceKitAccountIDFrom:(unsigned char[16])a0;
- (void)copyFinanceKitAccountIDTo:(unsigned char[16])a0;
...
- (BOOL)restrictsHardwarePurchases;
...
- (BOOL)supportsAccountBalanceEventReportingForLocation:(id)a0;
...
- (BOOL)supportsExportTransactionDataRange;
