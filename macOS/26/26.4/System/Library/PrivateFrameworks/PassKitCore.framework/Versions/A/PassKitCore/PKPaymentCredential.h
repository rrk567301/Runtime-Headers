...
@property (readonly, nonatomic) BOOL supportsExistingCardAuthorization;
...
- (BOOL)isExistingCardAuthorizationCredential;
...
- (BOOL)shouldProvisionPrecursorPassUponFailure;
