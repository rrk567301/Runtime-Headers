...
- (id)automaticallyPresentedPassForPasses:(id)a0 applicationIdentifier:(id)a1;
...
- (void)openPaymentSetupWithMerchantIdentifier:(id)a0;
...
- (id)_filterPassesForIssuerRegions:(id)a0 request:(id)a1;
...
- (id)flightsWithScheduledDepartureFromStartDate:(id)a0 endDate:(id)a1;
...
- (id)inAppPaymentPassUniqueIDForPaymentRequest:(id)a0;
