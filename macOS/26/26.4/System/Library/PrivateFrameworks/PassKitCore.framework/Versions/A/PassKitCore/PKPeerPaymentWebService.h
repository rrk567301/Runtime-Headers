...
- (unsigned long long)peerPaymentUpdateUserInfoForRequest:(id)a0 withCompletion:(id /* block */)a1;
...
- (id)_createDeviceScorerForAttributes:(id)a0;
...
- (unsigned long long)peerPaymentRequestStatementForAccountIdentifier:(id)a0 emailAddress:(id)a1 completion:(id /* block */)a2;
- (unsigned long long)peerPaymentEncryptionCertificateForDestination:(unsigned long long)a0 withCompletion:(id /* block */)a1;
- (void)_deviceScoreForAttributes:(id)a0 withCompletion:(id /* block */)a1;
...
- (unsigned long long)peerPaymentUserInfoForAccountIdentifier:(id)a0 lastUpdated:(id)a1 withCompletion:(id /* block */)a2;
- (unsigned long long)peerPaymentReOpenAccountWithCompletion:(id /* block */)a0;
- (void)_provideDeviceScoreFeedbackIfNeededForAttributes:(id)a0 ingested:(BOOL)a1;
...
- (unsigned long long)peerPaymentRecipientsForRecipientAddresses:(id)a0 senderAddress:(id)a1 source:(unsigned long long)a2 completion:(id /* block */)a3;
...
- (void)unloadDeviceScoreForAttributes:(id)a0;
...
- (unsigned long long)peerPaymentTransactionAnswerWithRequest:(id)a0 completion:(id /* block */)a1;
- (unsigned long long)peerPaymentPerformQuoteWithRequest:(id)a0 completion:(id /* block */)a1;
- (void)prewarmDeviceScoreForAttributes:(id)a0;
