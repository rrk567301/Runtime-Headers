@class NSDate, NSString, PKCreditInstallmentPlan, NSArray, NSSet, NSDictionary, PKTransactionSourceCollection, PKMerchant, PKPaymentPass, NSDecimalNumber;
...
@interface PKDashboardTransactionFetcher : NSObject <PKPaymentDataProviderDelegate> {
    ...
    BOOL _filterExcludedTransactionSourceIdentifiers;
...
@property (nonatomic) BOOL needsInstantWithdrawalFees;
...
- (void)_addCashbackTransactions:(id)a0 synchronous:(BOOL)a1 currentMonthOnly:(BOOL)a2 completion:(id /* block */)a3;
- (void)_addInstantWidthdrawalTransactionsWithCompletion:(id /* block */)a0;
- (void)_commonSetup;
- (BOOL)_containsFrequentTransactionType:(id)a0;
- (void)_excludedTransactionSourcesWithCompletion:(id /* block */)a0;
- (id)_feeTotalForTransaction:(id)a0;
- (void)_processPaymentPassTransactionsWithTransactions:(id)a0 synchronous:(BOOL)a1 currentMonthOnly:(BOOL)a2 sendTransactionsBlock:(id /* block */)a3;
...
- (void)filterAmountComparisons:(id)a0;
- (void)filterDisputesOnly:(BOOL)a0;
- (void)filterExcludedTransactionSourceIdentifiers:(BOOL)a0;
- (void)filterPeerPaymentPaymentMode:(unsigned long long)a0;
- (void)filterPeerPaymentRequestToken:(id)a0;
...
- (void)reloadTransactionsWithAllowSynchronous:(BOOL)a0 completion:(id /* block */)a1;
- (void)reloadTransactionsWithCompletion:(id /* block */)a0;
- (void)sendTransactionsWithRequest:(id)a0 useSynchronous:(BOOL)a1 completion:(id /* block */)a2;
- (void)setLimit:(unsigned long long)a0 startDate:(id)a1 endDate:(id)a2;
- (void)setPreferredRecentTransactionMinimum:(unsigned long long)a0;
