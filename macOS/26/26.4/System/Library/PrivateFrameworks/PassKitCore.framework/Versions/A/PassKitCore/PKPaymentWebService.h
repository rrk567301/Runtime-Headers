...
- (id)removeRedundantMethodGroupsFromMethodGroups:(id)a0;
- (void)_archiveBackgroundContext;
- (void)_handleRemoteCloudStoreAssetForRecordName:(id)a0 taskRecord:(id)a1 data:(id)a2 shouldWriteData:(BOOL)a3 error:(id *)a4;
...
- (void)_backgroundDownloadPassAtURL:(id)a0 fromPushTopic:(id)a1;
...
- (unsigned long long)submitVerificationEntries:(id)a0 forPass:(id)a1 completion:(id /* block */)a2;
...
- (id)_requestBuilderForRegion:(id)a0;
...
- (unsigned long long)creditAccountUserInfoWithRequest:(id)a0 completion:(id /* block */)a1;
- (unsigned long long)sendPaymentOfferPaymentStatusWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (unsigned long long)selectedOffersWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (void)_handlePassListDownloadTask:(id)a0 data:(id)a1 fromPushTopic:(id)a2;
...
- (void)_handleRemoteAssetDownloadForManifestItem:(id)a0 taskPassURL:(id)a1 data:(id)a2 shouldWriteData:(BOOL)a3 error:(id *)a4;
- (unsigned long long)accountBankLookupWithRequest:(id)a0 completion:(id /* block */)a1;
- (void)_handlePassDownloadTask:(id)a0 data:(id)a1 fromPushTopic:(id)a2;
...
- (unsigned long long)cancelPaymentOfferWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (unsigned long long)agreementURLForPass:(id)a0 agreement:(id)a1 completion:(id /* block */)a2;
- (unsigned long long)storeExistingCardAuthorizationWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (void)_performVerificationRequest:(id)a0 selectedMethodGroup:(id)a1 selectedMethod:(id)a2 pass:(id)a3 taskID:(unsigned long long)a4 completion:(id /* block */)a5;
...
- (unsigned long long)confirmOffersWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (unsigned long long)merchandisingWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (void)_secureRequestBuilderForRegion:(id)a0 fields:(unsigned long long)a1 completion:(id /* block */)a2;
...
- (unsigned long long)authenticationTokenWithRequest:(id)a0 completion:(id /* block */)a1;
...
- (unsigned long long)passAtURL:(id)a0 completionWithError:(id /* block */)a1;
...
- (id)_requestBuilderForRegion:(id)a0 regionOut:(id *)a1;
