...
@property (class, readonly, nonatomic) PKIdentityElement *signatureUsualMarkElement;
@property (class, readonly, nonatomic) PKIdentityElement *placeOfBirthElement;
@property (class, readonly, nonatomic) PKIdentityElement *nationalityElement;
@property (class, readonly, nonatomic) PKIdentityElement *dhsTemporaryLawfulStatusElement;
