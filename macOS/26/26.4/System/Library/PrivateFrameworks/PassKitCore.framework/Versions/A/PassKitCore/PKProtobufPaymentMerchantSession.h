...
@interface PKProtobufPaymentMerchantSession : PBCodable <NSCopying> {
    struct { unsigned char epochTimestamp : 1; unsigned char expiresAt : 1; unsigned char isDelegatedSession : 1; } _has;
}
...
@property (nonatomic) BOOL hasIsDelegatedSession;
@property (nonatomic) BOOL isDelegatedSession;
@property (readonly, nonatomic) BOOL hasDelegateDisplayName;
