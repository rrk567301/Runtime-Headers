@class NSDecimalNumber, PKContactFormatValidator, PKPaymentOrderDetails, PKPaymentOptionsDefaults, PKCurrencyAmount, PKPaymentApplication, NSString, NSMutableArray, PKPaymentPass, NSArray, PKSelectedPaymentOffer, PKPeerPaymentQuote, PKBankAccountInformation, PKPaymentRequest, PKPeerPaymentService, NSMutableDictionary, PKAccountEnhancedMerchant, NSSet, PKPeerPaymentAccount, PKPayment, PKRemoteDevice, PKPaymentOptionsRecents, PKPaymentOffersController, CNContact, PKPaymentWebService, PKPaymentInstructions, PKPassLibrary, PKPaymentSummaryItem, NSMapTable, PKRemotePaymentInstrument, PKShippingMethod;
...
@property (nonatomic) BOOL presenterIsIssuerInstallmentsRepayment;
...
@property (nonatomic) BOOL hasAutomaticallyPresentedPass;
