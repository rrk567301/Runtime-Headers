@class NSHashTable, PKPaymentCredential, PKAccountService, NSMutableArray, NSMutableSet, NSString, PKPaymentSetupProductModel, PKPaymentPass, PKPaymentProvisioningControllerCredentialQueue, PKPaymentService, NSArray, NSTimer, PKAddPaymentPassRequestConfiguration, PKProvisioningUtility, PKSecureElementProvisioningState, PKPaymentCloudStoreZoneCreationManager, NSObject, NSSet, NSData, PKPaymentSetupProduct, PKPaymentOffersController, CLLocationManager, CIDVUIProofingFlowManager, CLLocation, PKProvisioningAnalyticsSessionPreflightReporter, PKPaymentWebService, PKPaymentProvisioningResponse, PKProvisioningSEStorageSnapshot, NSMutableOrderedSet, PKPaymentRequirementsResponse, PKPaymentEligibilityResponse, NSExtension;
...
@interface PKPaymentProvisioningController : NSObject <CLLocationManagerDelegate, PKPaymentServiceDelegate, PKAccountServiceObserver, PKPaymentWebServiceDelegate> {
    ...
    BOOL _targetDeviceSupportedRadioTechnologiesLoaded;
}
...
@property (nonatomic) BOOL fetchCardsOnFileExtendedAuthorization;
@property (nonatomic) BOOL isInProximitySetup;
@property (nonatomic) BOOL allowProductsInUnsupportedRegion;
@property (nonatomic) BOOL includePendingVerificationCredentials;
@property (nonatomic) BOOL ignoreFPANCardOnFileState;
...
- (id)initWithWebService:(id)a0 localPaymentService:(id)a1 paymentOffersController:(id)a2;
...
- (id)_filterFPANCredentials:(id)a0 forExistingCredentials:(id)a1;
...
- (void)_retrieveFPANCredentialsWithCompletion:(id /* block */)a0;
...
- (id)initWithWebService:(id)a0 paymentOffersController:(id)a1;
