@class SADispatchQueue, NSString, NSArray, SAFrame, SATimestamp, SAThreadExclavesInfo, SASwiftTask, SAWaitInfo, SATurnstileInfo;
...
@property unsigned char needsExclave : 1;
...
@property (readonly) BOOL isPageGrabRecord;
