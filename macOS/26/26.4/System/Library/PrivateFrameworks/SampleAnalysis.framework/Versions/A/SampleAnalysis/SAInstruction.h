...
- (unsigned char)numInlineFramesForSerializedBufferLength:(unsigned long long)a0;
...
- (void).cxx_destruct;
- (BOOL)symbolicateWithOptions:(unsigned long long)a0 pid:(int)a1 additionalCSSymbolicatorFlags:(unsigned int)a2;
