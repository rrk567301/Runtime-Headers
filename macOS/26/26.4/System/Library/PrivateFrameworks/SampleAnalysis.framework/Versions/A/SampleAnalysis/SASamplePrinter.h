@class NSMutableDictionary, SATimestamp, NSDictionary, SAThread, SASampleStore, NSMutableArray, SASamplePrintOptions, NSString, SAHIDEvent, SATask, SAOutputStream, NSMutableSet, NSUUID;
...
@interface SASamplePrinter : NSObject {
    ...
    BOOL _haveAnyOnlyPageGrabMicrostackshots;
