...
@property BOOL showTaskEnergyAsLeafFrame;
...
@property BOOL omitStacksWithMCore;
@property BOOL omitStacksWithECore;
@property int omitStacksBelowBasePriority;
@property int omitStacksAboveBasePriority;
@property BOOL displayVMFaultAddressAsLeafFrame;
@property BOOL displayVMFaultIntervalInCallTrees;
@property BOOL displayVMFaultTypeInCallTrees;
@property BOOL displayPageGrabIntervalInCallTrees;
@property BOOL displayPageGrabTypeInCallTrees;
@property BOOL displayPageGrabVMTagInCallTrees;
...
@property BOOL displayCPUSpeedInCallTrees;
@property BOOL displayPMICycleIntervalInCallTrees;
...
@property BOOL repeatPrimaryStateInCallTrees;
