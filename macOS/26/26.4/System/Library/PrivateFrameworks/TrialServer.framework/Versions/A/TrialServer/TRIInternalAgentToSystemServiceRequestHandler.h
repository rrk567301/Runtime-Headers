...
@interface TRIInternalAgentToSystemServiceRequestHandler : NSObject <TRIXPCInternalAgentToSystemServiceProtocol> {
...
- (void)getSystemLogEventsWithCompletion:(id /* block */)a0;
...
- (void)saveAssetWithIdentifier:(id)a0 sourcePath:(id)a1 flockWitness:(struct TRIFlockWitness_ { int x0; } *)a2 removeSourceOnFailure:(BOOL)a3 sourceExtension:(id)a4 completion:(id /* block */)a5;
...
- (BOOL)_getOnDemandReferenceCountsAtGlobalPath:(id)a0 onDemandFactorsPerUser:(id *)a1 error:(id *)a2;
