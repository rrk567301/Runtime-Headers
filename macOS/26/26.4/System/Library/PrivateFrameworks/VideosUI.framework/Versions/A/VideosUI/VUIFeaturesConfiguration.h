@class VUIGDPRConfig, VUILivePostPlayConfig, VUICarPlayConfig, VUIDropOnTabConfig, VUIExpansiveBrowsingConfig, VUIAutoPlayConfig, VUINowPlayingConfig, VUILibConfig, VUIAccountConfig, NSMutableDictionary, VUIMediaShowcasingConfig, VUILiveLinkConfig, VUICanonicalConfig, VUIPlaybackUpNextConfig, VUILaunchConfig, VUISyndicationConfig, VUIUpNextConfig, VUIMultiviewConfig, VUITipKitConfig, VUITabItemsUpdateConfig, VUITimedMetadataConfig, VUIPlayerTabsConfig, VUIDownloadConfig, VUIAccountMessageConfig, VUIRootControllerConfig;
...
- (BOOL)_populateConfigWithDictionary:(id)a0 isLaunching:(BOOL)a1;
- (void)_populateExpansiveBrowsingConfig:(id)a0;
...
- (void)_populateTipKitConfig:(id)a0;
