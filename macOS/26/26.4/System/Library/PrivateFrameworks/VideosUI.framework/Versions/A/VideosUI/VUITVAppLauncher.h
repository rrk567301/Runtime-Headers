@class ATAParsedOpenURL, VUITVApplicationController, NSDate, NSObject, NSDictionary, VUIStateMachine, VUIToolbar, VUIHintsWindowController, NSString, NSViewController, NSArray, _TtC8VideosUI20VUIJetPackController, NSWindow, VUIWindowController;
@protocol VUITVAppRootViewController, VUIAppStackProtocolObjC, VUITabBarProtocol, VUIRootSplitViewController;
...
@interface VUITVAppLauncher : NSObject <VUITVApplicationControllerDelegate, VUIToolbarDelegate, VUITabBarControllerUpdatingDelegate, NSTextFieldDelegate, VUIHintsWindowControllerDelegate, VUITVAppLaunchProtocol> {
    ...
    BOOL _didProcessAppFinishLoading;
}
...
@property (nonatomic) BOOL firstBecomeActiveSinceColdLaunch;
@property (nonatomic) BOOL didRegisterAppLaunchNotifications;
...
@property (readonly, nonatomic) BOOL isAppRunningWithJS;
...
- (void)javascriptSetTabBarItems:(id)a0 error:(id)a1;
- (void)_appAppearanceSettingChanged:(id)a0;
...
- (BOOL)didOpenDeeplink:(id)a0 options:(id)a1;
- (BOOL)didProcessAppFinishLoading;
- (void)didShowGDPRWelcome;
- (void)finishAppInitialization;
- (void)javascriptSetCarplayBarItems:(id)a0 error:(id)a1;
...
- (void)setDidProcessAppFinishLoading:(BOOL)a0;
