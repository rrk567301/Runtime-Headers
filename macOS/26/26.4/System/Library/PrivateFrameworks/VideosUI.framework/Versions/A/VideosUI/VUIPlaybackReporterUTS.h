@class NSMutableDictionary, NSMapTable, VUIPlaybackUpNextConfig, WLKPlaybackReporter;
...
- (void)_registerSessionForCanonicalID:(id)a0;
- (id)_canonicalIDForSession:(id)a0;
...
- (BOOL)_isReportingOwnerForSession:(id)a0;
...
- (void)_unregisterSessionForCanonicalID:(id)a0;
