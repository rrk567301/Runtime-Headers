...
@interface VideosUI.PaginatedMediaController : VUIBaseViewController <VUIBackgroundMediaPlayback> {
    ...
    void /* unknown type, empty encoding */ shouldFocusOnBackgroundMediaView;
    ...
    void /* unknown type, empty encoding */ swipeTransitionStyle;
    ...
    void /* unknown type, empty encoding */ hideQuoteViewTimer;
