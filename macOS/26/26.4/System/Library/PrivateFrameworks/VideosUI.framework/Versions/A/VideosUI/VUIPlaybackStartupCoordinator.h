@class VUIAlertController, NSString, VUIMediaInfo, TVPStateMachine, NSDictionary, NSObject, NSNumber, VUIVideosPlayable;
...
+ (id)startupCoordinatorWithMediaInfo:(id)a0 watchType:(long long)a1 isRentAndWatchNow:(BOOL)a2 isCarPlay:(BOOL)a3;
...
- (id)initWithMediaInfo:(id)a0 watchType:(long long)a1 isRentAndWatchNow:(BOOL)a2 isCarPlay:(BOOL)a3;
- (id)makeDownloadStreamedForCoWatchingWarningNotificationOptions;
- (void)performPlaybackStartupFlowWithCompletion:(id /* block */)a0;
- (void)presentAlertController:(id)a0 fromPresentingController:(id)a1 animated:(BOOL)a2 completion:(id /* block */)a3;
