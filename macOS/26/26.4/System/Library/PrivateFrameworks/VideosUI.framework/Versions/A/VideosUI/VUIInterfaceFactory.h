...
@protocol VUITabBarProtocol, VUILanguageAwareStringHandling, VUIMusicManager, VUIControllerPresenter, VUIDocumentCreator, VUIOpenURLHandling, VUITimedMetadataManager, VUIDownloadQueueManager, VUITVAppRootViewController, VUIBackgroundTaskManager;
