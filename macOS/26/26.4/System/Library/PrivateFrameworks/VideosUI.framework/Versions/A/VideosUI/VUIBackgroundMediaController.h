@class NSDate, VUIBackgroundMediaImageView, VUIImageProxy, VUIImageView, VUIBackgroundPlayerViewController, VUIMediaInfoFetchController, VUIMediaInfo, TVPVideoView, NSLayoutConstraint, NSString, VUIPlayerControlsView, NSTimer, TVPStateMachine, NSViewController, NSNumber, NSArray, TVPPlayer, NSUUID;
...
@property (nonatomic) BOOL shouldShowQuoteView;
...
@property (nonatomic) BOOL interruptsOtherAppAudio;
@property (nonatomic) BOOL allowsHDR;
@property (nonatomic) BOOL hideCustomPlaybackControl;
...
- (void)_externalPlaybackStateChanged:(id)a0;
...
- (BOOL)_hasProxyImageViewContent;
...
- (void)_loadQuoteImageIfNeeded:(id)a0;
...
- (void)_playbackRateDidChange:(id)a0;
...
- (void)hideQuoteView:(BOOL)a0 animated:(BOOL)a1;
...
- (void)showImageView:(id)a0 show:(BOOL)a1 animated:(BOOL)a2;
