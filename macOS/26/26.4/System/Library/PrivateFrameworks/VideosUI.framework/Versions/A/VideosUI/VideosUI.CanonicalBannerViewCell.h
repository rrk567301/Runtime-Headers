...
@interface VideosUI.CanonicalBannerViewCell : VUIBaseCollectionViewCell <VUINSNavigationBarVisibilityThresholdProviding, VUIRentalExpirationLabelDelegate> {
    ...
    void /* unknown type, empty encoding */ badgeViewPresenter;
    ...
    void /* unknown type, empty encoding */ infoView;
    ...
    void /* unknown type, empty encoding */ askToBuyPromptView;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_uberBackgroundContainerView;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_mediaToolbar;
    void /* unknown type, empty encoding */ backgroundMediaController;
    void /* unknown type, empty encoding */ $__lazy_storage_$_backgroundMediaView;
    void /* unknown type, empty encoding */ $__lazy_storage_$_backgroundMediaContainerView;
    ...
    void /* unknown type, empty encoding */ attributionViewVerticalMargin;
