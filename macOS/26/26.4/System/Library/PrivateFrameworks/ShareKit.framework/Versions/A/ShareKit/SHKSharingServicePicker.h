@class NSDictionary, SFShareSheetSessionTestingDataDump, NSMenu, NSAlert, SHKShareSheetRemoteViewController, SFShareSheetSessionManager, NSMutableArray, NSString, NSArray, SHKSharingService, NSSharingServicePicker, NSSet, NSWindow, NSOperationQueue, NSSharingCollaborationModeRestriction, SFCollaborationPerformer, SHKShareSheetHEICOptionsModel, NSView, NSObject, SHKSharingServicePickerMenuItemConfig, SHKSharingServicePickerMenuLatencyMetric, CSAddParticipantsViewController, NSPopover, SFCollaborationItemsProvider, SHKCollaborationService, NSUUID;
...
+ (void)_setIconServicesInformationIfPossibleForSharingService:(id)a0 transport:(id)a1;
...
- (BOOL)createDataDumpWithActivityType:(id)a0;
...
- (id)_heicOptionsModelForURLItems:(id)a0;
...
- (id)_placeholderItemForActivityItem:(id)a0 resolvingURLs:(BOOL)a1;
- (id)_placeholderItemsForCollaborative:(BOOL)a0 resolvingURLs:(BOOL)a1;
...
- (void)_setupTestingDataDumpIfNeeded;
