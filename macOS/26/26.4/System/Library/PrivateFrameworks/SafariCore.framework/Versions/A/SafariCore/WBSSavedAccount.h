@class NSDate, WBSFileVaultRecoveryKeyDeviceInfo, NSString, NSArray, AKSignInWithAppleAccount, NSMutableDictionary, NSURL, WBSFormerlySharedSavedAccountMarker, NSMutableArray, NSMutableSet, WBSSavedAccountKeychainCoordinator, WBSPasswordWarningHideMarker;
...
@property (readonly, nonatomic) BOOL isBackedByUUIDHighLevelDomain;
...
@property (readonly, nonatomic) BOOL hasValidWebsite;
@property (readonly, nonatomic) BOOL canBeExportedToPasswordsCSVFile;
@property (readonly, nonatomic) BOOL canBeExportedViaCredentialExchange;
@property (readonly, nonatomic) BOOL canBeDeletedByServiceViaCredentialUpdater;

+ (BOOL)_shouldUseFuzzyStringMatchingForMatchingType:(long long)a0;
...
- (void)_addFileVaultRecoveryKeyMetadataFromUniqueIdentifier:(id)a0;
...
- (BOOL)_canMergeWithSavedAccountWithoutUserInteractionUsingCaseInsensitiveUsernameMatching:(id)a0;
...
- (void)_copyHistoryItemsFromSharedSidecarToPersonalSidecarAndSetupNewSharedSidecarForGroupID:(id)a0;
...
- (void)_deleteCredentialForProtectionSpace:(id)a0 forGroupID:(id)a1;
...
- (void)_deleteSidecarForProtectionSpace:(id)a0 forGroupID:(id)a1;
...
- (BOOL)_hasAppAsHighLevelDomain;
- (id)_highLevelDomainWithPortIncluded;
- (id)_initWithHighLevelDomain:(id)a0 passkeyRelyingPartyID:(id)a1 user:(id)a2 password:(id)a3 passkeyUserHandle:(id)a4 passkeyCredentialID:(id)a5 siteToProtectionSpaces:(id)a6 sitesToSidecars:(id)a7 passkeySidecarsDictionary:(id)a8 serviceName:(id)a9;
- (id)_initWithHighLevelDomain:(id)a0 user:(id)a1 password:(id)a2;
- (id)_initWithPasskeyRelyingPartyID:(id)a0 user:(id)a1 passkeyUserHandle:(id)a2 passkeyCredentialID:(id)a3 passkeySidecarsDictionary:(id)a4;
...
- (void)_mergeWithSavedAccountWithoutUserInteractionUsingCaseInsensitiveUsernameMatching:(id)a0;
...
- (void)_recordStoppedSharingAccountWithGroupEventToPersonalSidecar:(id)a0 groupName:(id)a1;
...
- (id)_searchMatchForSearchPattern:(id)a0 matchAgainstUser:(BOOL)a1 associatedDomains:(id)a2;
- (void)_setUser:(id)a0 password:(id)a1;
- (BOOL)_shouldSaveHistoryItemToSharedSidecar:(id)a0;
...
- (id)_updateSharedGroupHistoryEventsForGroupID:(id)a0 groupName:(id)a1 sidecar:(id)a2;
- (void)_updateSidecarsWithHistoryItems:(id)a0 sharedSidecar:(id)a1;
- (id)_websitesFromAdditionalSites;
- (void)_writeFormerlySharedSavedAccountMarkerForCredentialTypes:(long long)a0;
- (void)addItemToAccountHistory:(id)a0;
- (void)clearParticipantIDThatMovedSavedAccountToRecentlyDeleted;
- (void)deleteItemFromAccountHistory:(id)a0;
...
- (BOOL)hasProtectionSpaceForAdditionalSite:(id)a0;
...
- (id)initWithPasskeyRelyingPartyID:(id)a0 user:(id)a1 passkeyUserHandle:(id)a2 passkeyCredentialID:(id)a3 passkeySidecarsDictionary:(id)a4;
...
- (BOOL)matchesUserTypedSearchPattern:(id)a0;
