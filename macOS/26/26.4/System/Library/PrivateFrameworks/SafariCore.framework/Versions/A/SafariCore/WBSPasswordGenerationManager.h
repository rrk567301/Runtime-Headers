...
@property (class, readonly, nonatomic) unsigned long long defaultStrongPasswordLength;
...
- (id)defaultPasswordRulesForDomain:(id)a0;
- (id)defaultPasswordRulesForURL:(id)a0;
- (id)defaultRequirementsForDomain:(id)a0;
- (id)generated15CharacterAlphanumericPassword;
- (id)initWithPasswordRequirementsByDomain:(id)a0 passwordRulesByDomain:(id)a1;
