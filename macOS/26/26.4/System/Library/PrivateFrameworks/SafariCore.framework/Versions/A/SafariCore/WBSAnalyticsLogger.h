...
- (id)_bundleIdDictionaryWithArray:(id)a0;
- (void)_didAddBookmarkWithMethod:(id)a0 menuItemType:(id)a1;
- (id)_keyForSavingSyncOperationTimingWithGroup:(id)a0;
...
- (id)_operationTimingUserDefaultsKeyForGroup:(id)a0;
- (void)_recursivelyReportSiteIconDownloadFailureWithFetchType:(long long)a0 iconType:(long long)a1 iconFormat:(long long)a2 didDetermineSize:(BOOL)a3 didUseOffScreenWebView:(BOOL)a4 httpStatusCode:(long long)a5 error:(id)a6;
- (void)_recursivelyReportSyncDidFailedWithResult:(long long)a0 error:(id)a1 inOperationGroup:(id)a2;
...
- (void)didCompleteSiteIconFetchOfType:(long long)a0 iconURL:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 didSucceed:(BOOL)a3 didUseOffScreenWebView:(BOOL)a4 numberOfDownloadAttempts:(unsigned long long)a5;
...
- (void)didFailSiteIconDownloadForFetchType:(long long)a0 iconURL:(id)a1 iconSize:(struct CGSize { double x0; double x1; })a2 didUseOffScreenWebView:(BOOL)a3 response:(id)a4 error:(id)a5;
...
- (void)didInteractWithOnboardingItem:(id)a0 userClosedCard:(BOOL)a1;
...
- (void)didSelectBrowserChoice:(id)a0 browserAlreadyInstalled:(BOOL)a1 browsersWithProductPagesViewed:(id)a2 browserList:(id)a3 userCohort:(long long)a4 listContainsDisabledBrowser:(BOOL)a5 userTriedSelectingDisabledBrowser:(BOOL)a6;
...
- (void)didShowBrowserChoiceScreen:(id)a0;
...
- (void)didViewBrowserProductPage:(id)a0;
...
- (void)reportDatabaseTransactionFailureWithProcessName:(id)a0 revertedChangesCount:(unsigned long long)a1 stacktrace:(id)a2 sqliteError:(id)a3;
...
- (void)reportFolderOnTopModePreference:(BOOL)a0;
...
- (void)reportSafariRecoveredWindowStateWithSuccess:(BOOL)a0;
...
- (void)reportSyncOperationDidBeginWithGroup:(id)a0;
- (void)reportSyncOperationDidFinishWithResult:(long long)a0 error:(id)a1 inOperationGroup:(id)a2;
...
- (void)reportUnexpectedTabDeletionWithPreviousTabCount:(unsigned long long)a0 newTabCount:(unsigned long long)a1 stackTrace:(id)a2;
