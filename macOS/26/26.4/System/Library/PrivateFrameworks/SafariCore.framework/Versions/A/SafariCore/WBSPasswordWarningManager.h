@class NSMutableDictionary, NSMapTable, WBSPasswordWarningTopFraudTargetsManager, NSObject, WBSPasswordBreachHelperProxy, WBSPasswordAuditor, NSString, NSSet, WBSPasswordManagerWebsiteMetadataStore, NSUserDefaults, _TtC10SafariCore32WBSPasswordEvaluationsCacheStore, NSArray, WBSSavedAccountStore, WBSPasswordEvaluator;
