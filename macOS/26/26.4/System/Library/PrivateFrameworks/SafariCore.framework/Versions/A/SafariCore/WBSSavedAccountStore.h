@class NSMutableDictionary, WBSDiagnosticStateCollector, NSDictionary, WBSSavedAccountKeychainCoordinator, WBSSavedAccount, WBSAutoFillQuirksManager, _TtC10SafariCore15WBSPasskeyStore, NSObject, WBSPublicKeyCredentialIdentifier, NSMutableArray, NSString, NSSet, _TtC10SafariCore37WBSAuthenticationServicesAgentMonitor, NSTimer, NSArray, WBSAuthenticationServicesAgentProxy, WBSKeychainCredentialNotificationMonitor, NSError;
...
@interface WBSSavedAccountStore : NSObject <WBSSavedAccountStorePasskeyExtras, WBSSavedAccountStoreWebsiteNameConsumer, WBSOngoingSharingGroupProviderSubscriber, WBSAuthenticationServicesAgentDelegate> {
    ...
    BOOL _shouldSkipHistoryEvents;
    _TtC10SafariCore37WBSAuthenticationServicesAgentMonitor *_authenticationServicesAgentMonitor;
}

@property (class, readonly, nonatomic) BOOL isSharedStoreInitialized;
@property (class, readonly, nonatomic) WBSSavedAccountStore *sharedStore;
@property (class, readonly, nonatomic) unsigned long long recentlyDeletedExpirationTimeInDays;
...
@property BOOL shouldIgnoreKeychainUpdatesDuringMaintenanceActivity;
...
+ (BOOL)getProtectionSpaceAndHighLevelDomainForUserTypedSite:(id)a0 protectionSpace:(id *)a1 highLevelDomain:(id *)a2 mode:(long long)a3;
...
- (void)_addAccountHistoryItemOnInternalQueue:(id)a0 toSavedAccount:(id)a1 completionHandler:(id /* block */)a2;
- (id)_addAccountsWithAdditionalSitesToDictionary:(id)a0 withSavedAccounts:(id)a1 usingDictionaryForSavedAccountsWithPasskeys:(id)a2;
- (void)_addAdditionalSiteOnInternalQueue:(id)a0 toSavedAccount:(id)a1;
...
- (void)_changeSavedAccountWithRequestOnInternalQueue:(id)a0 performPostUpdateActions:(BOOL)a1;
...
- (void)_deleteAccountHistoryItemOnInternalQueue:(id)a0 fromSavedAccount:(id)a1 completionHandler:(id /* block */)a2;
...
- (BOOL)_ignoreServiceNames;
- (void)_insertSavedAccount:(id)a0 intoAllSavedAccountDictionaryWithKey:(id)a1;
...
- (void)_mergeDuplicateSavedAccountsWithPasswordsOnInternalQueueForGroupID:(id)a0;
...
- (void)_performMergeForSavedAccount:(id)a0 withAccountToDelete:(id)a1 usernameToOccurrences:(id)a2;
...
- (id)_preferredUsernameForMergingAccount:(id)a0 withOtherAccount:(id)a1 usernameToOccurrences:(id)a2;
- (void)_prewarm;
...
- (id)_saveAccountOnInternalQueueWithUser:(id)a0 password:(id)a1 forAppWithID:(id)a2 appName:(id)a3 customTitle:(id)a4 groupID:(id)a5;
...
- (void)_saveCustomTitleOnInternalQueue:(id)a0 forSavedAccount:(id)a1;
...
- (id)_savedAccountsWithPasswordsInAssociatedDomainsForUser:(id)a0 matchingPasskeyDomain:(id)a1 usingDictionaryForSavedAccountsWithPasswords:(id)a2 dictionaryForSavedAccountsWithPasskeys:(id)a3;
- (void)_setSavedAccountAsDefaultOnInternalQueue:(id)a0 forProtectionSpace:(id)a1 context:(id)a2 associatedDomainsManager:(id)a3;
...
- (void)_updateSavedAccountsAndSavedAccountsWithPasswordsDictionary:(id)a0 withChangeFromOldUser:(id)a1 oldPassword:(id)a2 didChangeSites:(BOOL)a3 forSavedAccountWithPassword:(id)a4;
- (void)_updateShowServiceNamesInPasswordsPreference;
- (id)_usernameToOccurrencesFromSavedAccounts:(id)a0;
- (void)_verifyGroupsInSync;
- (void)_warmDataStoreAfterResetTimerFired:(id)a0;
- (void)_writeSidecarDataForMergedSavedAccount:(id)a0;
- (void)addAccountHistoryItem:(id)a0 toSavedAccount:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)changeSavedAccountsWithRequests:(id)a0;
- (void)changeSavedAccountsWithRequests:(id)a0 completionHandler:(id /* block */)a1;
- (void)clearSavedAccountHistory:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)deleteAccountHistoryItem:(id)a0 fromSavedAccount:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)mergeDuplicateSavedAccountsWithPasswordsWithCompletionHandler:(id /* block */)a0;
...
- (id)persistentIdentifierForUser:(id)a0 protectionSpace:(id)a1;
...
- (void)removeWebsiteMetadataIfNecessaryForSavedAccount:(WBSSavedAccount *)a0 coordinator:(WBSSavedAccountKeychainCoordinator *)a1 completionHandler:(void (^)(BOOL))a2;
...
- (id)saveUser:(id)a0 password:(id)a1 forAppWithID:(id)a2 appName:(id)a3 customTitle:(id)a4 groupID:(id)a5;
- (id)saveUser:(id)a0 password:(id)a1 forAppWithID:(id)a2 appName:(id)a3 groupID:(id)a4;
- (void)saveUser:(id)a0 password:(id)a1 forAppWithID:(id)a2 appName:(id)a3 groupID:(id)a4 completionHandler:(id /* block */)a5;
- (id)saveUser:(id)a0 password:(id)a1 forProtectionSpace:(id)a2 highLevelDomain:(id)a3 customTitle:(id)a4 groupID:(id)a5;
- (void)saveUser:(id)a0 password:(id)a1 forProtectionSpace:(id)a2 highLevelDomain:(id)a3 groupID:(id)a4 completionHandler:(id /* block */)a5;
- (void)saveUser:(id)a0 password:(id)a1 forUserTypedSite:(id)a2 customTitle:(id)a3 notesEntry:(id)a4 groupID:(id)a5 additionalSites:(id)a6 completionHandler:(id /* block */)a7;
...
- (void)savedAccountsAfterLoadingGroupsWithCompletionHandler:(id /* block */)a0;
- (id)savedAccountsForGroupID:(id)a0;
- (void)setDontSaveMarkerForSavedAccountsWithProtectionSpace:(id)a0;
- (void)setSavedAccountAsDefault:(id)a0 forProtectionSpace:(id)a1 context:(id)a2 associatedDomainsManager:(id)a3;
- (void)setSavedAccountAsDefault:(id)a0 forProtectionSpace:(id)a1 context:(id)a2 associatedDomainsManager:(id)a3 completionHandler:(id /* block */)a4;
...
- (id)test_loadSavedAccountsWithPasskeysFromPasskeyData:(id)a0;
- (void)test_setKeychainCoordinator:(id)a0;
- (void)test_setSharedAccountsGroups:(id)a0;
- (void)test_setShouldSkipHistoryEvents:(BOOL)a0;
- (BOOL)unshareSignInWithAppleSavedAccount:(id)a0;
- (void)updateAllSavedAccountsWithPasswordsWithUser:(id)a0 appID:(id)a1 withNewPassword:(id)a2;
