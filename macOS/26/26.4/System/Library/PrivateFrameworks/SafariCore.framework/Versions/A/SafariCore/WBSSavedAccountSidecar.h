@class NSDate, NSString, WBSTOTPGenerator, WBSPair, NSArray, WBSFileVaultRecoveryKeyDeviceInfo, NSDictionary, WBSFormerlySharedSavedAccountMarker, NSMutableDictionary, NSURLProtectionSpace, WBSPasswordWarningHideMarker;
