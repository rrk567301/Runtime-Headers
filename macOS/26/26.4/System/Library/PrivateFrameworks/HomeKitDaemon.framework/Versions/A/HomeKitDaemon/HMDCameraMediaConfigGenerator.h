...
- (BOOL)_loadAVCAudioStreamConfig:(id)a0 protocolParametersWithStreamingControlRequest:(id)a1;
- (BOOL)_loadAVCVideoStreamConfig:(id)a0 protocolParameters:(id)a1;
- (BOOL)_loadAVCVideoStreamConfig:(id)a0 protocolParametersWithStreamingControlRequest:(id)a1;
...
- (BOOL)_sharedLoadAVCAudioStreamConfig:(id)a0 protocolParameters:(id)a1;
- (BOOL)_sharedLoadAVCVideoStreamConfig:(id)a0 protocolParameters:(id)a1;
