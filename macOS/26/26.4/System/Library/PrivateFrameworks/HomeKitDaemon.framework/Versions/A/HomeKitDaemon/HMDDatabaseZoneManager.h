...
@protocol HMDDatabase, HMDCloudShareManaging, HMDDatabaseZoneManagerDelegate, OS_dispatch_queue, HMDDatabaseZoneManagerDataSource;
...
@property (readonly, getter=isStartedUp) BOOL isStartedUp;
...
- (id)logIdentifier;
- (void)start;
- (void)_fetchExistingPrivateZonesWithConfiguration:(id)a0;
- (void)_fetchPrivateZonesWithConfiguration:(id)a0;
- (void)_fetchSharedZonesWithConfiguration:(id)a0;
- (void)_handleFetchZonesResult:(id)a0 configuration:(id)a1;
- (void)_handleSuccessfulStartupWithConfiguration:(id)a0;
...
- (id)initWithCloudContainerIdentifier:(id)a0 zoneName:(id)a1 home:(id)a2 messageTargetUUID:(id)a3 workQueue:(id)a4;
- (id)initWithDatabase:(id)a0 shareManager:(id)a1 zoneName:(id)a2 home:(id)a3 shareMessenger:(id)a4 workQueue:(id)a5;
