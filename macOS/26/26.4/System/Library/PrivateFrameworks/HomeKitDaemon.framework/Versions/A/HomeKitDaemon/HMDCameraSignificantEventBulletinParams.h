...
- (void).cxx_destruct;
- (id)init;
- (id)initWithSignificantEvent:(id)a0 cameraProfileUUID:(id)a1 clipUUID:(id)a2;
- (id)initWithUUID:(id)a0 reason:(unsigned long long)a1 dateOfOccurrence:(id)a2 confidenceLevel:(unsigned long long)a3 faceClassifications:(id)a4 cameraProfileUUID:(id)a5 clipUUID:(id)a6;
