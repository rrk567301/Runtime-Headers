...
@protocol OS_dispatch_queue, HMDFeaturesDataSource, HMDCameraRecordingSettingsControlDelegate;
...
@property (readonly, getter=isPrimaryResident) BOOL primaryResident;
@property (readonly, getter=isConfigurable) BOOL configurable;
...
- (void)_invokePendingConfigureCompletionHandlersWithGeneralConfiguration:(id)a0;
- (void)_invokePendingConfigureCompletionHandlersWithGeneralConfiguration:(id)a0 error:(id)a1;
...
- (BOOL)_shouldReconfigureForChangedCharacteristic:(id)a0;
...
- (id)initWithWorkQueue:(id)a0 accessory:(id)a1 recordingManagementService:(id)a2 featuresDataSource:(id)a3 notificationCenter:(id)a4;
