...
- (void).cxx_destruct;
- (id)initWithLinkType:(id)a0 hasAdvertisement:(BOOL)a1 protocol:(id)a2 protocolVersion:(id)a3 reachable:(BOOL)a4 reachableLastChangedTime:(id)a5 reason:(long long)a6;
