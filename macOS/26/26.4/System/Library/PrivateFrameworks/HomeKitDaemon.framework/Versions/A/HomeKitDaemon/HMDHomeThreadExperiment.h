@class HMFTimer, NSUUID, NSString, NSObject, HMDHAPAccessory;
...
- (void).cxx_destruct;
- (id)initWithMetricsMode:(long long)a0 hapAccessory:(id)a1 workQueue:(id)a2 homeUUID:(id)a3;
- (id)initWithMetricsMode:(long long)a0 hapAccessory:(id)a1 workQueue:(id)a2 homeUUID:(id)a3 reachabilityTimer:(id)a4 logEventSubmitter:(id)a5;
