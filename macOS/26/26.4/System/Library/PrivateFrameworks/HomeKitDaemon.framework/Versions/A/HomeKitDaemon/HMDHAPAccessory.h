...
+ (id)tlvCredentialsFromHAPMetadata:(id)a0;
...
- (void)_handleResetUARPDeviceRequest:(id)a0;
...
- (BOOL)_isStreamManagementService:(id)a0;
...
- (BOOL)accessorySupportsSendingWakeNotification:(id)a0;
...
- (void)handleNotificationToEvaluateClimateFeatureSupport:(id)a0;
...
- (void)savePublicKeyToKeyStore:(id)a0;
...
- (BOOL)supportsWoL;
- (void)swiftEncodeWithCoder:(id)a0 isXPCTransport:(BOOL)a1 isEntitledForSPIAccess:(BOOL)a2;
