...
@property (copy, nonatomic) NSNumber *musicTransitionStyle;
...
@property (retain, nonatomic) NSSet *faceprintsFromPhotos_;
...
+ (BOOL)isOwnerOrAdminWithPrivilege:(unsigned long long)a0;
+ (BOOL)isOwnerWithPrivilege:(unsigned long long)a0;
+ (BOOL)isResidentSyncParticipantWithPrivilege:(unsigned long long)a0;
...
- (id)findUserActivityStatusForType:(unsigned long long)a0;
...
- (id)materializeOrCreateBulletinRegistrationsRelationOfTypeEventBulletinRegistrationWithModelID:(id)a0 createdNew:(BOOL *)a1;
