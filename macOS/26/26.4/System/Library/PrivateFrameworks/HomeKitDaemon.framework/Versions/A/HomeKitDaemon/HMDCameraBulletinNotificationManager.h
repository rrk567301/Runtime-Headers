...
- (void)_handleSignificantEvent:(id)a0 cameraProfileUUID:(id)a1 clipUUID:(id)a2;
- (void)_handleSignificantEvent:(id)a0 remoteRegistration:(id)a1;
- (void)_handleSignificantEventWithUUID:(id)a0 reason:(unsigned long long)a1 dateOfOccurrence:(id)a2 confidenceLevel:(unsigned long long)a3 faceClassifications:(id)a4 cameraProfile:(id)a5 clipUUID:(id)a6;
...
- (void)_notifyPrimaryResidentOfSignificantEvent:(id)a0 withCameraProfileUUID:(id)a1 clipUUID:(id)a2;
...
- (void)handleSignificantEvent:(id)a0 cameraProfileUUID:(id)a1 clipUUID:(id)a2;
