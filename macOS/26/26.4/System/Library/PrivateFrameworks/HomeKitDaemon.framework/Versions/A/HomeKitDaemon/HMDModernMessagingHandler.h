...
@protocol OS_dispatch_queue, HMDModernMessagingHandlerContextFactory, HMDFeaturesDataSource;
...
- (id)initForMappings:(id)a0 withContextFactory:(id)a1 featuresDataSource:(id)a2;
