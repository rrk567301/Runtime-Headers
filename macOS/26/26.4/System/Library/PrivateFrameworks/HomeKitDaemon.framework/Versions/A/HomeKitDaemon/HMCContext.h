...
+ (id)findFaceprintWithDatabaseID:(id)a0 error:(id *)a1;
...
+ (id)findStatusChannelWithDatabaseID:(id)a0 error:(id *)a1;
...
+ (id)findRoomPresenceWithModelID:(id)a0;
...
+ (id)findFaceprintWithModelID:(id)a0 error:(id *)a1;
...
+ (id)findStatusChannelWithModelID:(id)a0 error:(id *)a1;
...
+ (id)findRoomPresenceWithModelID:(id)a0 error:(id *)a1;
...
+ (id)findStatusChannelWithDatabaseID:(id)a0;
...
+ (id)findFaceprintWithModelID:(id)a0;
...
+ (id)findRoomPresenceWithDatabaseID:(id)a0 error:(id *)a1;
...
+ (id)findStatusChannelWithModelID:(id)a0;
...
- (void)ensureLocalStoreUnsafeSynchronousBlock:(id /* block */)a0;
...
- (void)ensureLocalStoreAndPerformBlock:(id /* block */)a0;
