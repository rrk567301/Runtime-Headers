...
@protocol HMDHomeActivityStateAggregatorStateDataSource, HMDHomeActivityStateManagerDataSource, HMDHomeUserActivityStatesDetails, HMDHomeActivityStateAggregatorManagerStorage;
...
- (BOOL)_evaluateShouldProbeHomeActivityStateWithDidUpdateByContributorType:(id)a0;
