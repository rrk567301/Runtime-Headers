...
- (void)_publishPreferredResidentsList:(id)a0 reason:(unsigned long long)a1;
...
- (BOOL)_updateLocalPreferredResidentsList:(unsigned long long)a0;
...
- (BOOL)shouldRegeneratePreferredResidentsListBasedOnUpdate:(id)a0 residentsLost:(id)a1 residentLocationMap:(id)a2;
...
- (BOOL)weAreConnectedToStatusKit;
- (id)wiredResidents;
