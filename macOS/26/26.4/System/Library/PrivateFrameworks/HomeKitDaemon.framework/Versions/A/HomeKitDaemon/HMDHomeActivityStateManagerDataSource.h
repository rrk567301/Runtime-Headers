@class HMDHomeAdministratorHandler, NSDate, HMFMessageDispatcher, NSObject, HMDResidentDevice, NSString, HMDUser, HMCContext, HMDBulletinBoard, HMDHome, HMDLocation, NSNotificationCenter, HMDBackgroundTaskManager;
@protocol OS_dispatch_queue, HMFLogging, HMDFeaturesDataSource, HMMLogEventSubmitting, HMDPreferences;
...
@property (readonly, nonatomic) BOOL someHomeAccessorySupportsAdaptiveTemperatureAutomations;
...
- (id)makeHomeActivityStateMachineWithAggregatorStateDataSource:(id)a0 initialStateHoldDetails:(id)a1;
