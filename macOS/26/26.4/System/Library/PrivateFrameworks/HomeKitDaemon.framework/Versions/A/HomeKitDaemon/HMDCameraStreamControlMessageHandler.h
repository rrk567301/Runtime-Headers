@class NSDictionary, NSObject, HMFMessageDispatcher, HMDCameraStreamManagerSession, HMDService, HMDDynamicActivityAttributionPublisher, HMDCameraStreamSnapshotHandler, HMDCameraSupportedConfigurationCache, HMDHAPAccessory, HMDCameraMetricsMilestone, NSString, HMFNetMonitor, HMDCameraResidentMessageHandler, NSUUID;
...
+ (BOOL)_isUpdateMaximumVideoResolutionQualityMessage:(id)a0;
...
- (void)streamControlManager:(id)a0 didStopStreamWithSessionInfo:(id)a1 error:(id)a2;
