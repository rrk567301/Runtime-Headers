...
@property (readonly) BOOL hasReachableAccessories;
...
- (void)_createAllKnownResidentsInHomeWithCurrentDevice:(id)a0 hasResidents:(BOOL *)a1;
...
- (void)_publishCurrentResidentStatusWithReason:(long long)a0 priority:(unsigned long long)a1 preferredResidentsList:(id)a2;
...
- (void)_updateReachability:(BOOL)a0 forResidentDevice:(id)a1 source:(unsigned long long)a2;
- (void)_updateReachability:(BOOL)a0 forResidentDevice:(id)a1 source:(unsigned long long)a2 forceUpdate:(BOOL)a3;
- (void)_updateReachability:(BOOL)a0 forResidentDevices:(id)a1 source:(unsigned long long)a2;
- (id)_updateReachabilityForResidentDevices:(id)a0 reachableResidents:(id)a1 source:(unsigned long long)a2;
...
- (void)_updateResidentReachabilityFromReachableResidents:(id)a0 source:(unsigned long long)a1;
...
- (void)channelManager:(id)a0 didAddDevice:(id)a1 lost:(id)a2 updated:(id)a3;
...
- (void)handlePresenceUpdateFromStatusKitWithNewDevices:(id)a0 lost:(id)a1 updated:(id)a2;
- (void)handlePrimaryResidentDiscovered:(id)a0 primaryResidentGenerationID:(id)a1;
- (void)handlePrimaryResidentUpdateFromStatusKit:(id)a0;
