@class HMDAppleAccountManager, NSString, NSArray, HMDIDSActivityMonitorObserver, HMFTimer, NSOperationQueue, HMDRemoteAccountManager, HMDAccountRegistry, NSObject, HMFNetMonitor, NSMapTable, IDSAccount;
...
- (id)initWithAccountRegistry:(id)a0 activityObserver:(id)a1 appleAccountManager:(id)a2;
...
- (id)initWithAccountRegistry:(id)a0 activityObserver:(id)a1 queue:(id)a2 service:(id)a3 modernService:(id)a4 appleAccountManager:(id)a5 remoteAccountManager:(id)a6 netMonitor:(id)a7 factory:(id)a8;
