...
- (void)_donateNaturalLightingRequest:(id)a0;
...
- (id)setNaturalLightingEnabledForMatterLightProfile:(BOOL)a0;
...
- (void)updateSettingsWithNaturalLightingEnabled:(BOOL)a0;
- (void)updateSettingsWithNaturalLightingSupported:(BOOL)a0;
