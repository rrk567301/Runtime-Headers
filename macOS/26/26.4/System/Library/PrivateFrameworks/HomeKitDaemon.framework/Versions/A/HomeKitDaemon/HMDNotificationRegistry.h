@class HMFTimer, NSString, NSMutableSet, NSHashTable, HMDHome, NSObject;
@protocol OS_dispatch_queue, HMDNotificationRegistryAdapter;
...
- (void)configureWithHome:(id)a0 registryAdapter:(id)a1;
