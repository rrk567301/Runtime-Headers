...
- (id)_fetchUserRecordIDForUserWithAccountHandle:(id)a0 share:(id)a1;
- (id)_grantAccessForUserWithAccountHandle:(id)a0 share:(id)a1 logEventBuilder:(id)a2;
...
- (id)fetchUserRecordIDForUserWithAccountHandle:(id)a0 share:(id)a1;
- (id)grantAccessForUserWithAccountHandle:(id)a0 share:(id)a1 logEventBuilder:(id)a2;
...
- (id)validateGrantingAccessForUserWithAccountHandle:(id)a0 share:(id)a1;
