@class NSHashTable, HMFTimer, HMDMediaBrowser, HMDHAP2Storage, NSMutableArray, NSMutableSet, HMDHomeManager, NSString, NSArray, HMDAuthServer, HMMTRAccessoryServerBrowser, HMFMessageDispatcher, HMDUnassociatedWACAccessory, NSObject, NSData, HMDUnassociatedAppleMediaAccessory, HMDWACBrowser, NSUUID, HAPAccessoryServerBrowserBTLE, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP;
...
- (id)accessoryWithPairingsWithServerIdentifier:(id)a0;
...
- (void)_removePairingWithPairedAccessoryServerIfPairing:(id)a0 errorCode:(long long)a1;
...
- (id)removedAccessoryKeyOfAccessoryServer:(id)a0 homeUUID:(id)a1;
...
- (void)_addAccessoryWithPairingsForServer:(id)a0;
...
- (id)_accessoryWithPairingsMatchingPairingInfo:(id)a0;
...
- (void)accessoryServerBrowser:(id)a0 getThreadNetworkCredentialsForStagingWithCompletion:(id /* block */)a1;
...
- (BOOL)accessoryServerHasActiveClients:(id)a0;
...
- (void)accessoryServerBrowser:(id)a0 getWifiNetworkCredentialsForAccessoryWithIdentifier:(id)a1 withCompletion:(id /* block */)a2;
...
- (id)accessoryWithPairingsForServer:(id)a0;
