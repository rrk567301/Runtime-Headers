...
@property (class, readonly) BOOL requiresHomePodGeneration2Pairing;
@property (class, readonly) BOOL requiresHH2Pairing;
...
@property (class, readonly) BOOL supportsHostingLocalAccessoryServer;
...
+ (BOOL)supportsHostingLocalAccessoryServerForProductType:(int)a0;
+ (id)logCategory;
...
- (BOOL)supportsMusicTransitionStyle;
