...
- (id)createBulletinForSignificantEvents:(id)a0 cameraProfile:(id)a1;
- (id)initWithBulletinBoard:(id)a0 workQueue:(id)a1 logIdentifier:(id)a2;
- (id)initWithBulletinBoard:(id)a0 workQueue:(id)a1 logIdentifier:(id)a2 fileManager:(id)a3;
