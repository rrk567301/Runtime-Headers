@class NSMutableDictionary, NSNotificationCenter, HMDFeaturesDataSource, NSObject, HMFFuture, NSString, NSSet, NSHashTable, HMDResidentStatusChannelManager, HMDResidentStatus, HMDHome, HMDUnpublishedResidentStatus, HMFTimer, HMFPromise;
