@class HMDAccessoryFirmwareUpdateManager, HMDKeyRollOrchestrator, HMDCapabilitiesController, HMDThreadNetworkMetadataStore, NSMutableDictionary, HMDLoggingEventForwarder, HMDCameraRecordingLoadBalancer, HMDLastEventStoreController, HMDNetworkMismatchDetectorResult, HMFWiFiNetworkInfo, HMDBackingStore, HMDUserCloudShareManager, HMDDevice, HMDMatterSoftwareUpdateProviderDelegate, HMDHomeOwnerCloudShareManager, HMDWatchManager, HMEMemoryEventBus, NSUserDefaults, HMDCHIPDataSource, HMEDelegatingEventRouter, HMDBackgroundOperationManager, HMDIDSFirewallManager, NSObject, HMDSyncOperationManager, HMDMediaSystemHints, HMFTimer, HMFMessageDestination, HMDCompositeSettingsControllerManager, HMDAppleMediaAccessoryDiagnosticInfoController, HMDBonjourBrowserHelper, HMDDeviceSetupConfiguringController, NSDate, HMDIdentityRegistry, HMDMessageDispatcher, HMCContext, HMDCompanionManager, HMDHomeManagerObjectChangeHandler, HMDNameValidator, HMDIDSServerBag, _TtCE13HomeKitDaemonCSo14HMDHomeManagerP33_A2017DEA629FAA91F481E814718C0BF815SwiftExtensions, HMDApplicationData, HMDRemoteAccountManager, HMDSelfRemovalWatchdog, HMDHomeManagerHH2SharedUserLastSyncManager, HMDMediaGroupParticipantLocalDataStorage, NSMapTable, HMDUserDeviceCapabilitiesRequestManager, HMDHomeSharedUserCloudShareManager, HMDCHIPXPCListener, HMDXPCEventRouterServer, HMFFlow, HMDSiriEndpointOnboardingManager, HMDCloudDataSyncStateFilter, NSSet, NSUUID, HMDWidgetConfigurationReader, NSMutableSet, NSString, NSError, HMDSharedUserPrivateSettingsManager, HMFPromise, HMDClientConnection, NSMutableArray, HMDMultiUserStatusController, HMDMatterXPCListener, HMDMemoryUtilizationTracker, HMDUserDefaults, HMFBoolean, HMDPairedSync, HMDRemoteEventRouterAssertionController, HMDPredictionSubscriber, HMDMTSXPCServer, NSNotificationCenter, HMFFuture, NSArray, HMDSoftwareUpdateManager, HMDWalletKeyStepUpFailureListener, HMDAppleAccessoryPairingController, HMFActivity, HMDResidentMesh, HMDAccountHandle, HMDLocation, HMDCloudAccount, HMDAccessorySetupCoordinator, HMDSiriEndpointSettingsSyncManager, HMDCurrentAccessorySetupMetricDispatcher, HMELastEventStore, HMFNetMonitor, HMDAssistantGather, HMDWidgetTimelineRefresher, NSData, HMDIDSInvitationManager, HMDAppleAccountManager, HMDMessageFilterChain, HMDAccountRegistry, HMDMultiUserSettingsMetricsEventDispatcher, HMDPowerManager;
@protocol HMDarwinNotificationProvider, HMDFeaturesDataSource, HAPKeyStore, HMDDemoModeManagerDataSource, OS_dispatch_queue, HMDHomeManagerMetricsDataSource, HMDHomeManagerDataSource, HMDHH2FrameworkSwitchProtocol, HMDMobileAssetManager, HMDHomeManagerXPCClientConnectionsManager, HMDCompositeSettingsSiriEndpointProfileBridge, HMDFMFHandlerProtocol, HMDDemoModeManager, HMMLogEventSubmitting, OS_os_log, HMDDatabase, HMDFileManager, HMFAsyncContext, OS_dispatch_source, HMDAccessoryBrowserProtocol;
...
+ (id)containerWithIdentifier:(id)a0 isManatee:(BOOL)a1;
...
- (void)getOrCreateIssuerKeyPairExternalRepresentationWithHomeUUID:(NSUUID *)a0 flow:(HMFFlow *)a1 completionHandler:(void (^)(NSData *, BOOL, NSError *))a2;
...
- (void)getOrCreateIssuerKeyAndSaveToSharedUserReverseShareWithHomeUUID:(NSUUID *)a0 context:(HMCContext *)a1 flow:(HMFFlow *)a2 completionHandler:(void (^)(NSData *, BOOL, NSError *))a3;
...
- (void)purgeRecordZonesWithIDs:(id)a0 fromDatabase:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)initWithMessageDispatcher:(id)a0 dataSource:(id)a1 accessoryBrowser:(id)a2 metricsDataSource:(id)a3 configuringStateController:(id)a4 diagnosticInfoController:(id)a5 currentAccessorySetupMetricDispatcher:(id)a6 featuresDataSource:(id)a7;
...
- (void)determineDataSyncStateForHH2:(BOOL *)a0 homeManagerDataSyncState:(unsigned long long *)a1 homeManagerStatus:(unsigned long long *)a2;
- (id)_remotePeers;
...
- (void)_loadMessageDispatcher:(id)a0 accessoryBrowser:(id)a1 messageFilterChain:(id)a2 homeData:(id)a3 localDataDecryptionFailed:(BOOL)a4 accountRegistry:(id)a5 uncommittedTransactions:(id)a6 reloadData:(BOOL)a7;
...
- (id)initWithMessageDispatcher:(id)a0 dataSource:(id)a1;
...
- (void)_handleRollCurrentUserControllerKeyRequest:(id)a0;
...
- (id)eventForwarder;
- (BOOL)_processTestModeUpdateFindMy:(id)a0 error:(id *)a1;
...
- (void)purgeSharesFromZonesWithIDs:(id)a0 fromDatabase:(id)a1 dispatchGroup:(id)a2;
...
- (void)purgeSharesWithRecordIDs:(id)a0 fromDatabase:(id)a1 completionHandler:(id /* block */)a2;
