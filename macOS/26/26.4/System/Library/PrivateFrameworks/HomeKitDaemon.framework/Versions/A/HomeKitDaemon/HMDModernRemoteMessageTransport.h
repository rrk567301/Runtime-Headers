@class NSString, HMDModernTransportMessageContextManager, NSMutableOrderedSet, HMDRemoteMessageTransport, NSObject;
@protocol HMFTimerManager, HMFDateProvider, HMDDeviceResidencyProvider, HMDFeaturesDataSource, OS_dispatch_queue, HMFTimerProvider;
...
- (void).cxx_destruct;
- (id)initWithAccountRegistry:(id)a0 requestID:(id)a1 rapportTransport:(id)a2 idsTransport:(id)a3 bleTransport:(id)a4 contextManager:(id)a5 systemDateProvider:(id)a6 idsDateProvider:(id)a7 timerProvider:(id)a8 timerManager:(id)a9 featuresDataSource:(id)a10;
- (id)start;
