...
- (id)destinationControllerDataWithIdentifier:(id)a0;
...
- (id)leafParentIdentifiersForDestinationIdentifier:(id)a0;
- (id)mediaSystemDataWithIdentifier:(id)a0;
- (void)notifyOfUpdatedAggregateData;
- (id)rootDestinationIdentfierForDestinationIdentifier:(id)a0;
- (id)rootMediaGroupForDestinationIdentifier:(id)a0;
