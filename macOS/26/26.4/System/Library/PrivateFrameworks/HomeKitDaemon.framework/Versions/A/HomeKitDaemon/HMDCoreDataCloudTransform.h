@class NSMutableSet, NSString, NSManagedObjectContext, NSMapTable, NSMutableDictionary, NSPersistentCloudKitContainerActivityVoucher, NSObject, HMDCoreData, HMDCoreDataCloudTransformMergePolicy, NSUserDefaults;
...
+ (id)new;
+ (BOOL)detectExcessiveHistoryPruningInContext:(id)a0;
