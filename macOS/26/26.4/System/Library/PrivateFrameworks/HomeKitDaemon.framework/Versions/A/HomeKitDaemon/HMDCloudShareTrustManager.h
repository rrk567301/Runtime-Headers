@class HMDCloudShareMessenger, HMFTimer, HMDCloudShareParticipantsManager, NSString, HMDCloudShareTrustManagerMetricsEventDispatcher, HMBCloudZone, NSObject, HMBShareUserID, HMBLocalZone, NSNotificationCenter;
...
- (void)localZone:(id)a0 didProcessModelCreation:(id)a1;
- (void)localZone:(id)a0 didProcessModelDeletion:(id)a1;
- (void)localZone:(id)a0 didProcessModelUpdate:(id)a1;
...
- (void)_handleHomeOwnerDidBecomeTrustZoneCapableNotification:(id)a0;
...
- (void)fetchTrustStatusCountsForCloudShareTrustManagerMetricsEventDispatcher:(id)a0 completion:(id /* block */)a1;
- (void)handleHomeOwnerDidBecomeTrustZoneCapableNotification:(id)a0;
- (id)homeForCloudShareTrustManagerMetricsEventDispatcher:(id)a0;
- (id)initWithDatabase:(id)a0 isOwnedTrust:(BOOL)a1 queue:(id)a2 shareMessenger:(id)a3 ownerCloudShareID:(id)a4 logEventSubmitter:(id)a5 dailyScheduler:(id)a6 notificationCenter:(id)a7;
- (BOOL)isFromOwner;
...
- (struct CloudShareTrustManagerTrustStatusCounts { long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; })trustStatusCountsUsingParticipants:(id)a0;
