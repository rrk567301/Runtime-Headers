@class HMFTimer, NSDate, HMBLocalZone, HMFMessageDispatcher, NSObject, HMBCloudZone, HMDCameraRecordingReachabilityEventModel, NAFuture, HMDAppleAccountSettings, NSString, HMDHAPAccessory, NSHashTable, _HMCameraUserSettings, HMDBulletinBoard, NSNotificationCenter, NSUUID;
...
- (id)addCameraReachabilityEventModel:(id)a0;
- (void)addCameraReachabilityEventWithReachability:(BOOL)a0 dateOfOccurrence:(id)a1;
- (void)cleanUpEvents;
...
- (void)handleBridgedAccessoryConnectedNotification:(id)a0;
- (void)handleBridgedAccessoryDisconnectedNotification:(id)a0;
...
- (void)handleRemoteCameraReachabilityDidChangeMessage:(id)a0;
...
- (id)initWithAccessory:(id)a0 workQueue:(id)a1 identifier:(id)a2 bulletinBoard:(id)a3 logEventSubmitter:(id)a4 accountSettings:(id)a5 featuresDataSource:(id)a6 notificationCenter:(id)a7;
- (id)initWithHAPAccessory:(id)a0 zoneName:(id)a1 workQueue:(id)a2;
- (void)insertBulletinForReachabilityEvent:(id)a0;
- (BOOL)isAccessoryReachable;
- (id)mostRecentReachabilityEventModelInModels:(id)a0;
- (void)notifyRemoteSubscribersOfCameraReachabilityEventModel:(id)a0;
- (void)notifyTransportOfUpdatedEvents:(id)a0 removedEventUUIDs:(id)a1;
- (id)performCloudPullWithLabel:(id)a0;
- (id)reachabilityEventModelWithReachability:(BOOL)a0 dateOfOccurrence:(id)a1;
- (id)reachabilityEventModelWithUUID:(id)a0 reachability:(BOOL)a1 dateOfOccurrence:(id)a2;
- (BOOL)shouldAddInitialReachabilityEventWithReachability:(BOOL)a0 mostRecentReachabilityEventModel:(id)a1;
