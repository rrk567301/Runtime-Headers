@class NSObject, HMDService, NSString, HMDCameraStreamSessionInfo, HMDHAPAccessory;
...
- (void).cxx_destruct;
- (id)logIdentifier;
- (void)_handleRTPStreamingControlWriteResponses:(id)a0 completion:(id /* block */)a1;
- (void)_handleReadSupportedConfigurationsResponses:(id)a0 completion:(id /* block */)a1;
- (void)_handleReadSupportedTiersResponses:(id)a0 completion:(id /* block */)a1;
...
- (id)initWithWorkQueue:(id)a0 sessionInfo:(id)a1 accessory:(id)a2 streamManagementService:(id)a3;
- (void)readSetupEndPointWithCompletion:(id /* block */)a0;
- (void)readSupportedConfigurationsWithCompletion:(id /* block */)a0;
- (void)readSupportedTiersWithCompletion:(id /* block */)a0;
- (void)writeRTPStreamingControlRequest:(id)a0 completion:(id /* block */)a1;
