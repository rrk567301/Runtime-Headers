...
+ (id)logCategory;
+ (id)_createAudioStreamWithSessionHandler:(id)a0 localNetworkConfig:(id)a1 localRTPSocket:(int *)a2 sessionInfo:(id)a3;
+ (int)_createLocalRTPSocketWithRemoteSender:(id)a0 localNetworkConfig:(id)a1;
+ (id)_createLocalStreamAndRTPSocket:(int *)a0 localNetworkConfig:(id)a1 sessionInfo:(id)a2;
...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 delegate:(id)a2 sessionHandler:(id)a3 audioStream:(id)a4 localRTPSocket:(int)a5 dataSource:(id)a6;
