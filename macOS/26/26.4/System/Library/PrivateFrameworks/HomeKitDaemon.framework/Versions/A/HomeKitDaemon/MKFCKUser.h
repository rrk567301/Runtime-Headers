...
+ (id)fetchRequest;
+ (BOOL)decodeOwnerCrossfadeEnabled:(long long)a0;
+ (long long)decodeOwnerMusicTransitionStyleValue:(long long)a0;
+ (long long)encodeMusicTransitionStyleValue:(long long)a0 withCrossfadeEnabled:(BOOL)a1;
