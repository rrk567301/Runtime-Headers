...
- (void)_retrieveMetadataForStagingWithCompletion:(id /* block */)a0;
...
- (id)initWithThreadClientFactory:(id /* block */)a0;
...
- (void)retrieveMetadataForStagingWithCompletion:(id /* block */)a0;
