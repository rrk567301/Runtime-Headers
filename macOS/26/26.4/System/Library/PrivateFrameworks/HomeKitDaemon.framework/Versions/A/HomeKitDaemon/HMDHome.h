@class HMHomePersonManagerSettings, HMDPredicateUtilities, NSMutableDictionary, HMDMediaGroupsAggregateConsumer, HMDResidentStatusChannelManagerV2, HMDHomeNaturalLightingContextUpdater, HMDHomeLocationHandler, HMDHomeAdministratorHandler, HMDPrimaryResidentChangeMonitor, HMDDelegatingMessageRouter, HMDBackingStore, HMDAppleMediaAccessoryMessageRouter, HMUserPresenceCompute, HMDDevice, HMDNotificationRegistry, HMDUserPresenceFeeder, HMEDelegatingEventRouter, NSObject, HMDSharedHomeUpdateHandler, HMFTimer, HMDMediaGroupSetupMetricDispatcher, HMDSiriSecureAccessoryAccessController, HMFMessageDestination, HMDModernMessagingHandler, HMFMessageDispatcher, HMDHAPAccessory, HMDAccessCodeManager, HMDAccessoryBulletinNotificationManager, HMDCameraBulletinNotificationManager, HMDBackgroundTaskManager, NSDate, HMDLaunchHandler, HMMTRFabric, HMDCHIPHomeStorage, HMDMediaGroupsAggregator, HMDHomeNFCReaderKeyManager, HMDHomeActivityStateManager, HMDXPCMessageReportingSessionManager, HMDMultiuserSettingsMessenger, HMMDailyScheduler, HMDHomePeriodicReader, HMDHomeManager, HMDPrimaryResidentCapabilitiesAggregator, HMDApplicationData, HMDSelfRemovalWatchdog, HMDBulletinUserAttributionManager, HMDHomeNFCReaderKey, HMDAccessory, NSMapTable, HMDAccessorySettingsMessenger, HMDHomeMetricsDispatcher, HMDHAPAccessoryReaderWriter, HMDMediaGroupStagingManager, HMDHomeKitVersion, HMDMediaActionRouter, HMDAccessoryNetworkProtectionGroupRegistry, HMDFetchedAccessorySettingsSubscriber, NSUUID, HMDNaturalLightingContext, HMDLastSeenStatusManager, HMUserPresenceAuthorization, HMDResidentReachabilityNotificationManager, NSString, NSMutableSet, NSError, HMDHomePrimaryResidentMessagingHandler, NSSet, HMDHomePersonManager, HMDUserActivityStateDetectorManager, HMDUser, HMDHomeRemoteEventAccessController, HMFPromise, HMDAccessoryCount, NSMutableArray, HMDHomeObjectChangeHandler, HMDCHIPControllerPrivateStorage, HomeIntelligenceActivityLogger, NSNumber, HMDStateSyncManager, NSHashTable, HMDNetworkRouterClientManager, HMDUnifiedLanguageValueListSettingDataProvider, HMDDeviceCapabilities, HMDMediaGroupsUnconfiguredParticipantOnboardingManager, HMDHomeMediaStateSubscriber, HMDAppleAccountSettings, HMDHAPAccessoryConnectionCoordinator, HMDHomeHindsightCloudShareManager, HMDHomeNaturalLightingCurveWriter, HMDCameraAnalysisStatePublisher, NSNotificationCenter, HMDHomeRemoteEventRouterClientController, HMDHomeMediaSystemHandler, NSArray, NSDictionary, HMFFuture, HMDAccessoryReachabilityChangedLogEventManager, MTRDeviceController, HMDUserActionPredictionManager, HMDHomePersonDataManager, HMFWiFiManager, HMDRoom, HMDSiriEndpointProfilesMessenger, HMDResidentDevice, HMDRemoteEventRouterServer, HMDManagedStagedValue, HMDHomeReprovisionHandler, HMDThreadNetworkStatusReporter, NSData, HMDHomeLockNotificationManager, NSTimeZone, HMHomeNetworkInfo;
@protocol HMDActionSetStateObserver, HMDFeaturesDataSource, HAPKeyStore, NSObject, OS_dispatch_queue, HMDHomeDataSource, HMDHomePresenceCheck, HMDBackgroundOperationManagerHelperDataSource, HMDResidentSyncManager, HMDHomeSwiftExtensions, HMDCarPlayDataSource, HMDActionSetStateSubscriptionManager, HMMLogEventSubmitting, HMDResidentDeviceManager, HMEEventForwarder, HMDIDSIDQueryController, HMDHomeLocalDeviceCapabilitiesDataSource, HMDMessageRouter, HMDAccessoryBrowserProtocol, OS_os_log;
...
@property (nonatomic, readonly) BOOL hasDemoPrimaryResident;
...
@property (readonly) BOOL hasAnyAccessoryWithAliroNFCSupport;
@property (readonly) BOOL hasAnyAccessoryWithAliroUWBSupport;
...
@property (readonly, nonatomic) BOOL hasThreadCapableResident;
...
@property (readonly) NSUUID *targetFabricUUID;
@property BOOL fabricSetUpForPairing;
@property BOOL retainFabricDataWhenLocallyUnavailable;
...
@property (readonly) BOOL hasAnyReachableAccessories;
...
@property (readonly, nonatomic, getter=isAllowedToEnableAdaptiveTemperatureAutomations) BOOL allowedToEnableAdaptiveTemperatureAutomations;
@property (retain) HMDHomeMediaSystemHandler *mediaSystemController;
@property (getter=isAutomaticSoftwareUpdateEnabled) BOOL automaticSoftwareUpdateEnabled;
@property (nonatomic) BOOL overrideSentinelZoneForConvergencePeriod;
@property (retain, nonatomic) HMDHomeKitVersion *currentHomeKitVersion;
...
@property (readonly, nonatomic, getter=isLocalPresenceSupported) BOOL localPresenceSupported;
...
+ (id)createNewHomeModelsWithModelID:(id)a0 parentModelID:(id)a1 name:(id)a2 acwgGroupResolvingKey:(id)a3 acwgIssuerPublicKeyExternalRepresentation:(id)a4 userUniqueIDForAccessories:(id)a5 hasOnboardedActivityHistory:(BOOL)a6 ownedBy:(id)a7;
...
- (BOOL)_isResidentNativeMatterCapable:(id)a0;
...
- (id)sharedHomeModel;
- (BOOL)_accessoryRequiresNativeMatter:(id)a0;
...
- (BOOL)_matterAccessoryRequiresThread:(id)a0;
- (id)_residentDeviceForResidentUser:(id)a0;
- (id)_residentUserForResidentDevice:(id)a0;
- (void)_setDidOnboardEventLog:(BOOL)a0 message:(id)a1;
...
- (void)_auditChangedCharacteristics:(id)a0;
...
- (void)_clearEventsWithCompletion:(id /* block */)a0;
...
- (void)_donateReadRequests:(id)a0 fromMessage:(id)a1;
- (void)_donateWriteRequests:(id)a0 fromMessage:(id)a1;
...
- (void)_fetchThreadCredentialsAndStartThreadNetworkWithCompletion:(id /* block */)a0;
- (void)_fixupHindsightOnboarding;
- (void)_fixupUsersWithoutMergeID;
- (id)_getLogEventsForOperation:(BOOL)a0 startTime:(double)a1 accessories:(id)a2 requestMap:(id)a3 identifier:(id)a4 userUUID:(id)a5 source:(unsigned long long)a6 biomeSource:(unsigned long long)a7 bundleID:(id)a8;
...
- (void)_handleClearActivityHistoryBroadcastMessage:(id)a0;
...
- (void)_handleFetchUniqueIdentifierForBundleIdentifier:(id)a0;
- (void)_handleHAPAccessoryCharacteristicsUpdatedForAccessory:(id)a0;
...
- (void)_handleUpdatePairingIdentityRequest:(id)a0;
...
- (BOOL)_isCurrentDeviceAtHomeLocation;
...
- (BOOL)_isResidentThreadCapable:(id)a0;
...
- (void)_modifyCharacteristicNotifications:(id)a0 characteristicChangeThresholds:(id)a1 matterAttributeNotifications:(id)a2 mediaNotifications:(id)a3 actionSetNotificationPayload:(id)a4 enableNotification:(BOOL)a5 withDevice:(id)a6 completion:(id /* block */)a7;
- (void)_modifyCharacteristicNotificationsOnResident:(id)a0 characteristicChangeThresholds:(id)a1 matterAttributeNotifications:(id)a2 mediaNotifications:(id)a3 actionSetNotificationPayload:(id)a4 enableNotification:(BOOL)a5;
...
- (void)_processUpdatePairingIdentityRequest:(id)a0;
...
- (void)_retrievePreferredNetworkOnControllerWithCompletion:(id /* block */)a0;
...
- (void)_setUpSharedUserFabricDataWithForceFetch:(BOOL)a0 completion:(id /* block */)a1;
...
- (void)_startThreadNetworkOnCommissionerWithOperationalDataset:(id)a0 completion:(id /* block */)a1;
- (void)_startThreadNetworkOnControllerWithCompletion:(id /* block */)a0;
- (void)_startThreadNetworkOnResidentWithCompletion:(id /* block */)a0;
...
- (id)_updatePairingIdentityForUser:(id)a0 pairingIdentity:(id)a1;
...
- (void)_validateACWGCertificationStatusForAccessory:(id)a0;
...
- (void)_writeCharacteristicValues:(id)a0 requestMessage:(id)a1 source:(unsigned long long)a2 biomeSource:(unsigned long long)a3 withCompletionHandler:(id /* block */)a4;
...
- (void)addAccessoryRemoteReachabilityRegistrationForClientIdentifier:(id)a0;
...
- (id)audioDestinationControllerForHomePodAccessory:(id)a0;
...
- (id)auditOrAddRestrictedGuestUserUniqueIdentifier:(id)a0 onAccessory:(id)a1 user:(id)a2 requireFullScheduleAudit:(BOOL)a3 flow:(id)a4;
- (BOOL)auditStorageWithFabricData:(id)a0;
...
- (id)destinationIdentifierForParentIdentifier:(id)a0;
...
- (id)dumpActionSetDescriptionWithPrivacyLevel:(unsigned long long)a0;
- (id)dumpBulletinNotificationRegistrationsState;
- (id)dumpCharacteristicNotificationRegistry;
- (id)dumpMediaSessionDescriptionWithPrivacyLevel:(unsigned long long)a0;
...
- (void)fetchOrCreateFabricDataForPairingWithOperationalKeyPair:(id)a0 fetchFromResident:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)handleFetchPresenceMapMessage:(id)a0;
...
- (void)handleGetPowerAssertionsWithMessage:(id)a0;
- (void)handleGetPrimaryResidentNetworkInfoWithMessage:(id)a0;
- (void)handleHAPAccessoryCharacteristicsAddedNotification:(id)a0;
- (void)handleHAPAccessoryServicesAddedNotification:(id)a0;
- (void)handleHomeBecameQualifiedForAdaptiveTemperatureAutomations;
- (void)handleHomeDataLoaded:(id)a0;
- (void)handleHomePresenceUpdate:(id)a0;
...
- (void)handleNotificationsForIsAllowedToEnableAdaptiveTemperatureAutomations:(id)a0;
...
- (void)handleRoomsSupportingLocalPresenceMessage:(id)a0;
...
- (void)handleUserActivityStateDetectorManagerChangeNotification:(id)a0;
- (void)handleUserFabricKeyUpdate:(id)a0;
- (void)handleValenciaEnabledStateAttributeChanged:(id)a0;
...
- (id)homeLocationWithPrivacyLevel:(unsigned long long)a0;
- (id)hubAccessories;
- (void)incrementOperatePrivilegeCATVersion:(id /* block */)a0;
- (id)initWithName:(id)a0 uuid:(id)a1 defaultRoomUUID:(id)a2 owner:(id)a3 homeManager:(id)a4 presenceAuth:(id)a5 dataSource:(id)a6;
- (id)initWithName:(id)a0 uuid:(id)a1 defaultRoomUUID:(id)a2 owner:(id)a3 homeManager:(id)a4 presenceAuth:(id)a5 dataSource:(id)a6 logEventSubmitter:(id)a7 carPlayDataSource:(id)a8 administratorHandlerFactory:(id /* block */)a9 localCapabilitiesDataSource:(id)a10 notificationCenter:(id)a11 keychainStore:(id)a12;
...
- (void)isEnergyCurrentlyExpensiveWithCompletion:(void (^)(BOOL))a0;
...
- (id)nameForAccessoryUUID:(id)a0 mediaGroupsAggregator:(id)a1;
...
- (void)notifyOfAddedAccessory:(id)a0 user:(id)a1;
...
- (void)notifyOfRemovedAccessory:(id)a0 source:(unsigned long long)a1 user:(id)a2;
...
- (id)performReadRequests:(id)a0 loggingObject:(id)a1 flow:(id)a2;
- (id)performReadRequests:(id)a0 withRetries:(long long)a1 timeInterval:(double)a2 loggingObject:(id)a3 flow:(id)a4;
- (id)performWriteRequests:(id)a0 loggingObject:(id)a1 flow:(id)a2;
...
- (void)primaryResidentClientHasConnectivityDidChangeForRemoteEventRouterClientController:(id)a0;
...
- (void)remotelySetNotificationsEnabled:(BOOL)a0 forActionSetUUIDs:(id)a1;
...
- (void)removeAccessoryRemoteReachabilityRegistrationForClientIdentifier:(id)a0;
...
- (id)rootAudioDestinationIdentifierForAppleMediaAccessory:(id)a0;
...
- (id)routerForDestinationControllerIdentifier:(id)a0;
...
- (id)routersForDestinationIdentifier:(id)a0;
- (id)routersForParentIdentifiers:(id)a0;
...
- (id)sameRoomAccessoryUUIDsForDestinationControllerData:(id)a0 mediaGroupsAggregator:(id)a1;
- (void)saveAndSyncWithThreadOperationalDataset:(id)a0;
- (void)saveAndSyncWithThreadOperationalDataset:(id)a0 forceUpdate:(BOOL)a1;
...
- (void)sendFirmwareUpdateUINotification:(id)a0;
- (BOOL)sendMatterHMFMessageRequest:(id)a0;
- (BOOL)sendMatterMessagePayloadToPrimaryResident:(id)a0 timeout:(double)a1 responseHandler:(id /* block */)a2;
- (void)setAllowedToEnableAdaptiveTemperatureAutomations:(BOOL)a0;
...
- (BOOL)setUpAccessoryServerBrowserWithOperationalFabricData:(id)a0 ownerDataSnapshot:(id)a1 error:(id *)a2;
- (void)setUpFabricForPairingWithCompletion:(id /* block */)a0;
- (BOOL)setUpOperationalFabricDataWithError:(id *)a0;
- (void)setUpSharedUserFabricDataWithForceFetch:(BOOL)a0 completion:(id /* block */)a1;
- (id)sharedUsers;
...
- (BOOL)storeIntoLegacyStorageWithFabricData:(id)a0;
...
- (BOOL)storeNewFabricData:(id)a0;
- (BOOL)storeSharedHomeFabricData:(id)a0;
- (id)storedFabricDataWithDataPresentInV2FabricDataStore:(BOOL *)a0 error:(id *)a1;
...
- (void)updateLocalUWBOnboardingDismissed:(BOOL)a0;
...
- (id)userForActivityStatus:(id)a0;
...
- (void)verifyAdaptiveTemperatureAutomationsEnabledHomeShouldSendInvitations:(NSArray *)a0 withQueryController:(id<HMDIDSIDQueryController>)a1 completion:(void (^)(NSError *))a2;
...
- (void)writeCharacteristicValues:(id)a0 message:(id)a1 withCompletionHandler:(id /* block */)a2;
- (void)writeCharacteristicValues:(id)a0 source:(unsigned long long)a1 biomeSource:(unsigned long long)a2 identifier:(id)a3 transport:(id)a4 qualityOfService:(long long)a5 withCompletionHandler:(id /* block */)a6;
