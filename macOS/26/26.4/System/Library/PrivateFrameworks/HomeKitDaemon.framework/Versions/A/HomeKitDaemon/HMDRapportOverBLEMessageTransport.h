@class HMFTimer, NSString, NSMutableDictionary, RPCompanionLinkClient, NSMutableArray, NSObject;
@protocol HMDRemoteMessageListener, HMDRapportOverBLEDeviceWrapperFactory, HMDFeaturesDataSource, HMDRapportOverBLEDiscoveryClientFactory, OS_dispatch_queue;
...
- (id)initWithAccountRegistry:(id)a0 requestID:(id)a1 rapportMessaging:(id)a2 discoClientFactory:(id)a3 deviceWrapperFactory:(id)a4 featuresDataSource:(id)a5;
