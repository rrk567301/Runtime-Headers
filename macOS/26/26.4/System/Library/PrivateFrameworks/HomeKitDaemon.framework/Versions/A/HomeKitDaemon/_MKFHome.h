...
- (void)addFaceprintsObject:(id)a0;
...
- (void)addResidentStatusChannelsObject:(id)a0;
...
- (id)findFaceprintsRelationWithModelID:(id)a0;
...
- (id)findResidentStatusChannelsRelationWithModelID:(id)a0;
...
- (id)materializeOrCreateFaceprintsRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
...
- (id)materializeOrCreateResidentStatusChannelsRelationWithModelID:(id)a0 createdNew:(BOOL *)a1;
...
- (void)removeFaceprintsObject:(id)a0;
...
- (void)removeResidentStatusChannelsObject:(id)a0;
