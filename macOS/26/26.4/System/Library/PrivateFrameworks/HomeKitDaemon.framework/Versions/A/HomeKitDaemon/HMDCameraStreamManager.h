@class NSNumber, HMDVideoStreamInterface, HMDAudioStreamInterface, NSString, HMDCameraStreamSnapshotHandler, HMDCameraStreamSessionInfo, NSObject;
...
- (id)initWithSessionInfo:(id)a0 streamSnapshotHandler:(id)a1 workQueue:(id)a2 delegate:(id)a3 localVideoNetworkConfig:(id)a4 localAudioNetworkConfig:(id)a5 sessionHandler:(id)a6;
- (id)initWithSessionInfo:(id)a0 streamSnapshotHandler:(id)a1 workQueue:(id)a2 delegate:(id)a3 videoStreamInterface:(id)a4 audioStreamInterface:(id)a5 dataSource:(id)a6;
