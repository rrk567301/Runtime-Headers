...
@protocol HMDCameraRecordingManagerDependencyFactory, HMDCameraFragmentHandling, HMDFeaturesDataSource, OS_dispatch_queue, HMMLogEventSubmitting;
...
- (void)fragmentHandler:(id)a0 didEndWithError:(id)a1;
