...
- (void)_handleChannelUpdateWithDomainDataStatuses:(id)a0;
...
- (void)_publishData:(id)a0 completion:(id /* block */)a1;
...
- (void)channelManager:(id)a0 didAddDomainData:(id)a1 lost:(id)a2 updated:(id)a3;
