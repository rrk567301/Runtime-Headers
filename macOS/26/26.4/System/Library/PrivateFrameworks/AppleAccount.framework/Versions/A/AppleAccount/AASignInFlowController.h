@class AADataclassManager, NSMutableDictionary, NSDictionary, AADataclassActionsStore, CUMessageSession, AASignInOperationHelper, NSObject, ACAccountStore;
@protocol CDPStateUIProvider, AAAnalyticsReporting, AASignInFlowControllerDelegate, OS_dispatch_queue;
...
- (id)_dataclassActionsForPostCDPSaveForAccount:(id)a0;
- (id)_dataclassActionsForPreflightSaveForAccount:(id)a0;
...
- (void)_delegate_presentAccountPrivacyOptInForAccount:(id)a0 userActionCompletion:(id /* block */)a1;
- (void)_delegate_presentDataclassActionsForAccount:(id)a0 withAuthResults:(id)a1 completion:(id /* block */)a2;
...
- (BOOL)_previouslySignedOutAccountMatchesAccount:(id)a0 lastSignedOutAccountAltDSID:(id)a1 withAuthResults:(id)a2;
...
- (id)dataclassManager;
- (id)initWithAccountStore:(id)a0 dataclassManager:(id)a1;
