...
- (void)_sendEventForAddAbsintheHeaderWithFlowID:(id)a0 absintheError:(id)a1;
- (void)_additionalHeadersForRequest:(id)a0 withFlowID:(id)a1 completion:(id /* block */)a2;
- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void)encodeWithCoder:(id)a0;
- (void)_additionalAbsintheHeadersForData:(id)a0 withFlowID:(id)a1 completion:(id /* block */)a2;
- (void).cxx_destruct;
- (id)init;
