...
- (void)addToSoftwareUpdateDetails:(unsigned long long)a0 key:(id)a1;
...
- (void)updateBundleIDs:(id)a0 fixedSize:(unsigned long long)a1 stagedSize:(unsigned long long)a2 dataSize:(unsigned long long)a3 cloneSize:(unsigned long long)a4 purgeableSize:(unsigned long long)a5 cloneFixUpSize:(unsigned long long)a6 physicalSize:(unsigned long long)a7 appCacheSize:(unsigned long long)a8 CDPluginSize:(unsigned long long)a9;
