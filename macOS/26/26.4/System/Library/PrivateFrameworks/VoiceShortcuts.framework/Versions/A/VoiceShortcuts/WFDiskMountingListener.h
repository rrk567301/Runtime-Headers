@class NSMutableDictionary, NSDictionary, WFTriggerEventQueue, WFDatabase, NSObject, NSString;
...
- (void)diskArbitrationEventSubscribe:(id)a0 specificDiskVolumeUUID:(id)a1 needsAppear:(BOOL)a2 needsDisappear:(BOOL)a3 completion:(id /* block */)a4;
