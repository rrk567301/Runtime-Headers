...
- (void)getRunShortcutIntentForWorkflow:(id)a0 completion:(id /* block */)a1;
- (void)markMenuBarWorkflowAsMigratedWithIdentifiers:(id)a0 completion:(id /* block */)a1;
...
- (id)initWithDatabaseProvider:(id)a0 appShortcutsUpdater:(id)a1 contextualActionSyncService:(id)a2;
