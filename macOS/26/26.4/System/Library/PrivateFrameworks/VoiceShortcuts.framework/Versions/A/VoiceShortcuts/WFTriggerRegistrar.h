@class WFTriggerNotificationScheduler, WFFilesystemListener, WFBiomeListener, WFTriggerBootManager, NSObject, WFCoreDuetListener, WFDiskMountingListener, WFTriggerEventQueue;
...
- (id)initWithDatabaseProvider:(id)a0 userNotificationManager:(id)a1;
