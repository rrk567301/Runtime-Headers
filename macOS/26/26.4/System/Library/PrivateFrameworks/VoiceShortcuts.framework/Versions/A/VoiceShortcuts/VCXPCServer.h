@class NSXPCInterface, WFTopHitsAppShortcutsUpdater, NSXPCListenerEndpoint, NSString, WFWorkflowRunCoordinator, WFContextualActionSpotlightSyncService, WFTriggerManager, WFTriggerRegistrar, NSXPCListener, VCVoiceShortcutManager;
...
- (id)initWithDatabaseProvider:(id)a0 triggerRegistrar:(id)a1 syncDataEndpoint:(id)a2 runCoordinator:(id)a3 appShortcutsUpdater:(id)a4 contextualActionSyncService:(id)a5;
- (id)initWithUnsecuredAnonymousListenerAndDatabaseProvider:(id)a0;
- (id)initWithXPCListener:(id)a0 databaseProvider:(id)a1 triggerRegistrar:(id)a2 syncDataEndpoint:(id)a3 runCoordinator:(id)a4 appShortcutsUpdater:(id)a5 contextualActionSyncService:(id)a6;
