@class PXZoomablePhotosMiniModeAnimator, PXMediaProvider, PXUpdater, PXAssetsDataSourceManager, PXNumberAnimator, PXZoomableInlineHeadersDataSourceManager, PXAssetsDataSource, PXSelectionSnapshot, NSSet, NSString, PXZoomablePhotosAlphaAnimator, PXLoadingStatusManager, NSArray, PXZoomablePhotosLayoutSpecManager, PXAssetReference, PXSectionedSelectionManager, PXGridInlinePlaybackController;
