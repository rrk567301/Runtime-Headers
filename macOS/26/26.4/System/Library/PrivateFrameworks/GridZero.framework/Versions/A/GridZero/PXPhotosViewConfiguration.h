@class PXLoadingStatusManager, NSString, NSURL, PXAssetsDataSourceManager, NSArray, PXSectionedSelectionManager, PXFooterViewModel, PXStatusViewModel, PXSectionedObjectReference, PXAssetActionManager, PXMediaProvider, PXAssetCollectionActionManager;
@protocol PXPhotosViewDelegate, PXPhotosCustomViewDecorationDataSource, PXTapbackStatusManager, PXPhotosCustomSectionBodyLayoutProvider, PXPhotosViewAppSpecificConfiguration, PXPhotosPreferredAssetCropDelegate, PXPhotosGlobalHeaderLayoutProvider, PXPhotosSectionHeaderLayoutProvider, PXPhotosBannerProvider, PXPhotosPreferredColumnCountsDelegate, PXPhotosOverlayController, PXAssetImportStatusManager;

@interface PXPhotosViewConfiguration : NSObject <NSCopying> {
    id<PXPhotosViewAppSpecificConfiguration> _appSpecificConfiguration;
}

@property (class, readonly, nonatomic) NSString *defaultScrollViewAccessibilityIdentifier;
...
@property (nonatomic) BOOL wantsNavbarHidden;
...
@property (nonatomic) BOOL ignoreFilterStateWhenNotFiltering;
...
@property (nonatomic) BOOL prefersCurationModeToggleInNavBar;
...
@property (nonatomic) BOOL disableAutoPlaybackInOneUp;
...
- (id)_appSpecificConfigurationLoadIfNeeded:(BOOL)a0;
