@class PXZoomableInlineHeadersLayout, PXGBurstStackEffect, NSMapTable, PXMediaProvider, NSMutableSet, PXNumberAnimator, NSDateInterval, NSCache, PXGAnchor, PXAssetsDataSource, NSString, PXPhotosGridAssetDecorationSource, PXGEdgeStretchEffect, PXGOneColumnLayout, PXGItemsLayout, NSArray, PXZoomablePhotosViewModel, PXAssetReference, PXZoomablePhotosLayoutSpec, PXGZoomLayout;
...
@property (readonly, nonatomic) BOOL fillSafeAreaBottomInset;
...
- (void)addDecorationsToAllLayers:(id)a0;
...
- (BOOL)_getMiniModeInfo:(out struct { struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x0; struct CGPoint { double x0; double x1; } x1; double x2; struct _NSRange { unsigned long long x0; unsigned long long x1; } x3; } *)a0 forLayout:(id)a1;
...
- (BOOL)zoomablePhotosViewModelIsResetToInitialState:(id)a0;
