...
- (void).cxx_destruct;
- (id)init;
- (void)callForFileSharing:(id)a0 oneTimeParticipantCount:(unsigned long long)a1 optionsGroups:(id)a2 reply:(id /* block */)a3;
...
- (void)callForAddParticipantsToShare:(id)a0 containerSetupInfo:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 reply:(id /* block */)a5;
...
- (void)callForAddParticipantsToShareWithFileOrFolderURL:(id)a0 share:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 reply:(id /* block */)a5;
- (void)callForAddParticipantsToShareWithFileOrFolderURL:(id)a0 share:(id)a1 oneTimeParticipantCount:(unsigned long long)a2 optionsGroups:(id)a3 reply:(id /* block */)a4;
- (void)callForAddParticipantsToShareWithURLWrapper:(id)a0 share:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 reply:(id /* block */)a5;
- (void)callForAddParticipantsToShareWithURLWrapper:(id)a0 share:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 permissionType:(long long)a4 allowOthersToInvite:(BOOL)a5 reply:(id /* block */)a6;
...
- (void)callForCloudKitAddToShare:(id)a0 containerSetupInfo:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 reply:(id /* block */)a5;
...
- (void)callForFileSharing:(id)a0 emailAddresses:(id)a1 phoneNumbers:(id)a2 optionsGroups:(id)a3 reply:(id /* block */)a4;
- (void)callForFileURLRemoveShare:(id)a0 reply:(id /* block */)a1;
...
- (void)callForForciblyShareFolder:(id)a0 emailAddresses:(id)a1 phoneNumbers:(id)a2 optionsGroups:(id)a3 reply:(id /* block */)a4;
