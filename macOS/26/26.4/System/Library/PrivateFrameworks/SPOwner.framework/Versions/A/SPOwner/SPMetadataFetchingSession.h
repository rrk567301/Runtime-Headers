...
- (void)executeAccessoryCommand:(unsigned long long)a0 forBeaconId:(id)a1 completion:(id /* block */)a2;
...
- (void)fetchCurrentPrimaryKey:(id)a0 completion:(id /* block */)a1;
...
- (void)fetchiCloudIdentifier:(id)a0 completion:(id /* block */)a1;
