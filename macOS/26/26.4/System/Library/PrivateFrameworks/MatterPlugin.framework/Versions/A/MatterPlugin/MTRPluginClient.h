@class NSUUID, NSXPCConnection, NSString, NSMutableDictionary, MTRPluginClientXPCProxy, NSDictionary, NSMutableSet, MTRPluginLocalClient, NSObject;
@protocol OS_dispatch_queue, MTRXPCServerProtocol;
...
+ (BOOL)isRemoteModeForHome:(id)a0;
...
- (id)_currentTarget;
- (id)_currentTargetForControllerUUID:(id)a0 nodeID:(id)a1;
- (id)_localTarget;
