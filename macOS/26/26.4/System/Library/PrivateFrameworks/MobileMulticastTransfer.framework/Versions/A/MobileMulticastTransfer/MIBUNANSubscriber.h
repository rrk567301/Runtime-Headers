...
- (id)initWithServiceName:(id)a0 groupAddress:(id)a1 groupPort:(id)a2 countryCode:(id)a3 channelName:(unsigned long long)a4 band:(unsigned long long)a5 bandwidth:(unsigned long long)a6 rateAdapter:(BOOL)a7 multicastKeysBlob:(id)a8 subscriberDelegate:(id)a9 dataCollector:(id)a10;
