...
- (void)_startMulticastUsingInterface:(id)a0;
...
- (id)initWithPacketProvider:(id)a0 hostAddress:(id)a1 hostPort:(id)a2 nanPort:(id)a3 groupAddress:(id)a4 groupPort:(id)a5 serviceName:(id)a6 countryCode:(id)a7 channelName:(unsigned long long)a8 band:(unsigned long long)a9 bandwidth:(unsigned long long)a10 rateAdapter:(BOOL)a11 multicastSecurity:(BOOL)a12 controllerDelegate:(id)a13;
...
- (void)nanPublisher:(id)a0 didGenerateSecurityKeys:(id)a1;
- (void)nanPublisher:(id)a0 didReceiveData:(id)a1 fromPeer:(id)a2;
- (void)nanPublisherDidStart:(id)a0 usingInterface:(id)a1 forRetry:(BOOL)a2;
