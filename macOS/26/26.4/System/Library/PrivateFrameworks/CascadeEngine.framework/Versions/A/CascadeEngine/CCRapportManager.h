...
- (unsigned long long)discoveryControlFlagsForDevicePlatform:(long long)a0;
- (id)fileTransferSessionCacheKeyWithServerDevice:(id)a0 clientTargetDeviceID:(id)a1;
- (void)finishedSendingRequestsToDevice:(id)a0;
- (id)fulfillFileTransferSessionFromClientDevice:(id)a0 withTargetDeviceID:(id)a1 peerPublicKey:(id)a2 error:(id *)a3;
...
- (id)initiateFileTransferSessionWithServerDevice:(id)a0 error:(id *)a1;
- (void)invalidateDirectLinkToDevice:(id)a0;
- (BOOL)isNoAWDLDiscoverySupportedForDevicePlatform:(long long)a0;
