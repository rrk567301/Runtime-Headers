...
- (BOOL)didRemoteDeviceInitiateSyncWithMessage:(id)a0 beforeLocalInteraction:(id)a1;
...
- (id)initWithQueue:(id)a0 rapportManager:(id)a1 readAccess:(id)a2 donationServiceProvider:(id)a3 localDeviceUUID:(id)a4;
...
- (id)validateInRequest:(id)a0 inOptions:(id)a1 inResponseHandler:(id /* block */)a2 isInitiatingRequest:(BOOL)a3 outPlatform:(long long *)a4;
