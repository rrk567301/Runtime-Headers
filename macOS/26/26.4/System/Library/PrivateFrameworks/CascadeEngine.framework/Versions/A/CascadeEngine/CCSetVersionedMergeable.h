...
+ (id)writeOnlyInstanceForSet:(id)a0 donationServiceProvider:(id)a1;
...
- (id)initWithSet:(id)a0 readAccess:(id)a1 donationServiceProvider:(id)a2 mergeableDeltasFileURL:(id)a3;
