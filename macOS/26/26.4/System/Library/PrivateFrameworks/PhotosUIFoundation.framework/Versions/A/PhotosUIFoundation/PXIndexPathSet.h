...
- (id)filteredWithDataSourceIdentifier:(long long)a0;
- (id)indexPathSetByFilteringAndReplacingDataSourceIdentifier:(long long)a0 withDataSourceIdentifier:(long long)a1;
