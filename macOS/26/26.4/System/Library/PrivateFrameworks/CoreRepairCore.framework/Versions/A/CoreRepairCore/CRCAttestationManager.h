...
- (BOOL)sendCertIssueRequestWith:(id)a0 requestID:(id)a1 serverCertResponse:(id *)a2 error:(id *)a3;
- (BOOL)sendChallengeRequestWith:(id)a0 requestID:(id)a1 serverResponse:(id *)a2 error:(id *)a3;
