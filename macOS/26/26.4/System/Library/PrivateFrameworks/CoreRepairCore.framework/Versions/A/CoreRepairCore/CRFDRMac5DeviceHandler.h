...
- (long long)performPostSealingStage:(id)a0 patchClasses:(id)a1 patchInstances:(id)a2 patchValues:(id)a3 mergedDataClasses:(id)a4 mergedDataInstances:(id)a5 error:(id *)a6;
