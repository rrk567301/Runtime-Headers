@class TRIEncryptedMessage, NSString, TRIPBTimestamp, NSMutableDictionary, TRICounterfactualLogging, TRIAssignment, TRILowLevelExperimentConfiguration;
...
@property (nonatomic) BOOL hasEncryptedMessage;
