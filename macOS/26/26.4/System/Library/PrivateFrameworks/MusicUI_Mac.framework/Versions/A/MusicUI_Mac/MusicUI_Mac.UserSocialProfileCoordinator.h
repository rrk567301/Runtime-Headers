@interface MusicUI_Mac.UserSocialProfileCoordinator : NSObject {
    ...
    void /* unknown type, empty encoding */ pendingStatePromises;
    void /* unknown type, empty encoding */ state;
    void /* unknown type, empty encoding */ onUserProfileDidChange;
    void /* unknown type, empty encoding */ onUserProfileCoordinatorFetchStateChange;
    ...
    void /* unknown type, empty encoding */ cachedFallbackFullname;
