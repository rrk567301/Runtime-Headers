@interface MusicUI_Mac.MouseTrackingView : MusicUI_Mac.FlippedView {
    void /* unknown type, empty encoding */ mouseTrackingPool;
    ...
    void /* unknown type, empty encoding */ onMouseClicked;
