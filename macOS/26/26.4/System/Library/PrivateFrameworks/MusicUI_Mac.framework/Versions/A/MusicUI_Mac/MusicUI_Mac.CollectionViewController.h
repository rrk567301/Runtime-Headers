@interface MusicUI_Mac.CollectionViewController : MusicUI_Mac.ScrollViewController <NSCollectionViewDataSource, NSCollectionViewDelegate, NSCollectionViewDelegatePrivate> {
