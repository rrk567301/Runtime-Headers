@interface MusicUI_Mac.SocialOnboardingUserNameHandlePageComponentItem : NSCollectionViewItem {
    ...
    void /* unknown type, empty encoding */ didSelectValidUsername;
    ...
    void /* unknown type, empty encoding */ preferredPrivacyLinkSize;
