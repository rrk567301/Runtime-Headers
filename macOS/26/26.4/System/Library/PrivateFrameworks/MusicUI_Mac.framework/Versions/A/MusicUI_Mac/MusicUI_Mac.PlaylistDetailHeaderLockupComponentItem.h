@interface MusicUI_Mac.PlaylistDetailHeaderLockupComponentItem : NSCollectionViewItem {
    ...
    void /* unknown type, empty encoding */ controlAction;
    void /* unknown type, empty encoding */ _libraryState;
    ...
    void /* unknown type, empty encoding */ previousBoundsWidth;
}
