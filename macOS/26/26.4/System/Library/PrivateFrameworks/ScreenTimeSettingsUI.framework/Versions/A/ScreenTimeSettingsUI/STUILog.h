...
@property (class, readonly) NSObject<OS_os_log> *eyeRelief;
@property (class, readonly) NSObject<OS_os_log> *ageMigrationTip;
@property (class, readonly) NSObject<OS_os_log> *regulatoryRestrictions;
