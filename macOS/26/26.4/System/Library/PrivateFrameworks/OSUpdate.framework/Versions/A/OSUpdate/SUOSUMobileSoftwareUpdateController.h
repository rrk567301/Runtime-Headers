@class SUMacControllerClient, NSString, NSMutableDictionary, NSData, NSNumber, SUOSUDDMErrorReporter;
...
@property (retain) SUOSUDDMErrorReporter *ddmErrorReporter;
...
- (BOOL)_shouldReportDDMError:(id)a0;
- (id)_ssoTokenOverride;
...
- (void)destroyStashForDescriptor:(id)a0 localAuthenticationUserID:(id)a1 localAuthenticationContext:(id)a2 progressBlock:(id /* block */)a3 completion:(id /* block */)a4;
...
- (id)initWithID:(id)a0 ddmErrorReporter:(id)a1;
