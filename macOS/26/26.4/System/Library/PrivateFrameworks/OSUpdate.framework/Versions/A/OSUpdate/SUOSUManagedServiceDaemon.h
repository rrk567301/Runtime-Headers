@class SUOSUAuthenticationManager, SUMacControllerDescriptor, SUOSUMobileSoftwareUpdateController, SUOSUServiceClient, NSString, SUCoreDDMActivityScheduler, SUOSUDDMErrorReporter, NSObject, SUCorePolicyDDMConfiguration;
...
- (id)initWithServiceQueue:(id)a0 clientQueue:(id)a1 mobileSoftwareUpdateController:(id)a2 ddmErrorReporter:(id)a3;
