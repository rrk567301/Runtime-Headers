...
+ (id)_splashPlistFromBundle:(id)a0 forResource:(id)a1;

- (id)initWithBundle:(id)a0;
- (void).cxx_destruct;
- (id)_deviceClass;
- (id)_iconSymbolName;
- (id)_platformOfPreferredDeviceType:(unsigned long long)a0;
- (id)_SKU;
...
- (BOOL)_showInCombinedListWithDeviceClass:(id)a0;
...
- (BOOL)showInCombinedListForPreferredDeviceType:(unsigned long long)a0;
- (BOOL)supportsPlatformForPreferredDeviceType:(unsigned long long)a0;
