...
- (id)_symbolIconForSymbolName:(id)a0 withAccesibilityDescription:(id)a1 additionalConfiguration:(id)a2;
...
- (void)setTopImageSymbolName:(id)a0 withAccesibilityDescription:(id)a1 additionalConfiguration:(id)a2 animated:(BOOL)a3;
- (void)setTopImageSymbolName:(id)a0 withAccesibilityDescription:(id)a1 animated:(BOOL)a2;
- (BOOL)shouldLeadAlignIconImage;
