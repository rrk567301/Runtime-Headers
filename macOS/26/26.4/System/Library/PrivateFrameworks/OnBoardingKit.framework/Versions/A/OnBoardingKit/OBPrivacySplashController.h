@class NSColor, OBTemplateContainerViewController, NSString, OBPrivacySplashView, OBPrivacyFlow;
...
- (void)setHierarchicalSymbol:(id)a0 withAccesibilityDescription:(id)a1;
