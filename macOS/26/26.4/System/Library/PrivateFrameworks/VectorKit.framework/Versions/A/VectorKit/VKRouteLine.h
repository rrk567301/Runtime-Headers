...
@interface VKRouteLine : NSObject {
    ...
    struct ManeuverArrowCoordinates { struct vector<md::ManeuverArrowInfo, std::allocator<md::ManeuverArrowInfo>> { struct ManeuverArrowInfo *__begin_; struct ManeuverArrowInfo *__end_; struct { struct ManeuverArrowInfo *__cap_; } ; } _maneuverArrows; } _maneuverArrowCoordinates;
...
@property (readonly, nonatomic) struct vector<geo::fast_shared_ptr<md::RouteLineSection, mdm::allocator>, std::allocator<geo::fast_shared_ptr<md::RouteLineSection, mdm::allocator>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } sections;
...
@property (readonly, nonatomic) struct vector<Arrow, std::allocator<Arrow>> { struct Arrow *__begin_; struct Arrow *__end_; struct { struct Arrow *__cap_; } ; } arrows;
