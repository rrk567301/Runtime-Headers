@interface VKSceneConfiguration : NSObject {
    ...
    struct vector<GEOLocationCoordinate2D, std::allocator<GEOLocationCoordinate2D>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _pointsOfInterest;
