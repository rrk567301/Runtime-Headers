...
@interface VKUntetheredCameraController : VKMapCameraController <VKGesturingCameraController, VKMovableCamera> {
    ...
    struct vector<md::CameraCollision, std::allocator<md::CameraCollision>> { struct CameraCollision *__begin_; struct CameraCollision *__end_; struct { struct CameraCollision *__cap_; } ; } _collisions;
    struct vector<std::shared_ptr<gdc::BoundingVolumeNode<double, gdc::CollisionMeshNode<double, float>, float, const gdc::Tiled *>>, std::allocator<std::shared_ptr<gdc::BoundingVolumeNode<double, gdc::CollisionMeshNode<double, float>, float, const gdc::Tiled *>>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _bvhRoots;
    ...
    struct vector<md::RaycastDebug::RayHit, std::allocator<md::RaycastDebug::RayHit>> { struct RayHit *__begin_; struct RayHit *__end_; struct { struct RayHit *__cap_; } ; } _debugRayResults;
    struct vector<geo::Triangle<double, 3>, std::allocator<geo::Triangle<double, 3>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _debugRayTriangles;
