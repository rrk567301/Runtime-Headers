...
@interface VKLabelNavTileData : NSObject {
    ...
    struct vector<LabelNavJunctionInfo, geo::allocator_adapter<LabelNavJunctionInfo, mdm::zone_mallocator>> { struct LabelNavJunctionInfo *__begin_; struct LabelNavJunctionInfo *__end_; struct { struct LabelNavJunctionInfo *__cap_; struct allocator_adapter<LabelNavJunctionInfo, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } ; } _junctionInfos;
}
