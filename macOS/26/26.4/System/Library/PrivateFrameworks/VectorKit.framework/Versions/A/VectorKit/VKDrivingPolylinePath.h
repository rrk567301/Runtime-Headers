@interface VKDrivingPolylinePath : VKPolylinePath {
    ...
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _laneHalfWidths;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _distances;
    struct vector<md::GradientTraffic, std::allocator<md::GradientTraffic>> { struct GradientTraffic *__begin_; struct GradientTraffic *__end_; struct { struct GradientTraffic *__cap_; } ; } _gradientTraffics;
}
...
- (id)initWithOverlay:(id)a0 section:(id)a1 routeStartIndex:(unsigned int)a2 routeEndIndex:(unsigned int)a3 matchedPathSegments:(id)a4 elevationSource:(void *)a5 elevationSourceContext:(void *)a6;
