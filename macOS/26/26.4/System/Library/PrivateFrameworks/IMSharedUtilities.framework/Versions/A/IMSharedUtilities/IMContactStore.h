...
@property (retain, nonatomic, getter=getHandleIDToCNIDMap) NSDictionary *handleIDToCNIDMap;
@property (retain, nonatomic, getter=getCNIDToHandleIDsMap) NSMutableDictionary *CNIDToHandleIDsMap;
@property (retain, nonatomic, getter=getIDToCNContactMap) NSMutableDictionary *IDToCNContactMap;
@property BOOL batchFetchingForLaunchCompleted;
@property (retain, nonatomic) CNContact *meContact;
@property BOOL shouldSkipMeContactLookup;
...
- (void)_fetchContactsWithIdentifiers:(id)a0 usingCNID:(BOOL)a1 handleIDsWithoutCNID:(id)a2;
- (id)_postChangeEventsForAcceptedIntroductions:(id)a0;
- (void)_unlockedAddIDToCNIDToHandleIDsMap:(id)a0 withCNID:(id)a1;
- (void)_unlockedGenerateCNIDToHandleIDMap;
- (id)_unlockedGetCNIDToHandleIDsMap;
- (void)_unlockedRemoveIDFromCNIDToHandleIDsMap:(id)a0 withCNID:(id)a1;
