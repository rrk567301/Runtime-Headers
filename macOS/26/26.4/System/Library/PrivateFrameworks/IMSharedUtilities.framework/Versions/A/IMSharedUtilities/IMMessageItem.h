@class NSData, NSString, NSArray, NSAttributedString, NSDate, NSMutableDictionary, NSDictionary, IMCollaborationInitiationRequestInfo, TUConversationActivity, NSNumber, NSIndexSet;
...
+ (id)editedMessageItemWithOriginalMessageItem:(id)a0 editedPartIndex:(long long)a1 newPartText:(id)a2 newPartTranslation:(id)a3;
...
- (BOOL)_retractAllowedForBundleIdentifier:(id)a0;
...
- (BOOL)_unrestrictedModificationsAllowedForBundleIdentifier:(id)a0;
...
- (void)addTelemetryMetricForKey:(long long)a0;
- (void)addTelemetryMetricsFromDictionary:(id)a0;
- (void)addTranslation:(id)a0 forMessagePart:(long long)a1;
...
- (id)formatWithReasonCode:(long long)a0 subReasonCode:(long long)a1 pathID:(long long)a2;
...
- (void)removeTranslationsForMessagePart:(long long)a0;
...
- (void)setTelemetryMetricsReasonCode:(long long)a0 subReasonCode:(long long)a1 pathID:(long long)a2;
- (void)setWasDataDetected:(BOOL)a0;
- (id)translationsForMessagePart:(long long)a0;
