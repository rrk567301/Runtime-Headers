...
+ (id)defuseNicknameCommand:(id)a0 senderContext:(id)a1 error:(id *)a2;
+ (void)generateAnimatedImagePreview:(id)a0 senderContext:(id)a1 destinationFileURL:(id)a2 maxPixelDimension:(double)a3 scale:(double)a4 maxFrameCount:(long long)a5 isSticker:(BOOL)a6 progressBlock:(id /* block */)a7 withCompletionBlock:(id /* block */)a8;
...
+ (void)generateNickname:(id)a0 senderContext:(id)a1 forRecordID:(id)a2 wallpaperDataTag:(id)a3 wallpaperLowResDataTag:(id)a4 wallpaperMetadataTag:(id)a5 avatarRecipeDataTag:(id)a6 withKey:(id)a7 processImageFields:(BOOL)a8 completionBlock:(id /* block */)a9;
...
+ (void)generateSpamDetectionPreviewImage:(id)a0 senderContext:(id)a1 maxPxWidth:(double)a2 scale:(double)a3 withCompletionBlock:(id /* block */)a4;
+ (void)generateTranscriptBackground:(id)a0 senderContext:(id)a1 completion:(id /* block */)a2;
+ (void)generateTranscriptBackgroundCommandFrom:(id)a0 senderContext:(id)a1 completion:(id /* block */)a2;
