...
+ (id)sharedInstance;
+ (id)_IMServiceNameToSentMessageEventType:(id)a0;
+ (id)stringForFZErrorType:(unsigned int)a0;
...
- (void)trackAttachmentDownloadFailedWithFileSize:(id)a0 reason:(long long)a1 context:(id)a2;
- (void)trackAttachmentDownloadSuccess:(id)a0 context:(id)a1;
...
- (void)trackSentMessageEventOfType:(id)a0 subtype:(id)a1 originalServiceName:(id)a2 messageSize:(unsigned long long)a3 sendDuration:(id)a4 receiverType:(id)a5 receiverGroupType:(id)a6 wasSuccessful:(BOOL)a7 isEmergencyNumber:(BOOL)a8 isPartiallyActiveSIM:(id)a9 isEncrypted:(BOOL)a10 strugglingMessageIndicationSent:(BOOL)a11 error:(id)a12;
