...
- (BOOL)_boundingCircle:(const void *)a0 withBuildingTilePoints:(struct vector<GeoCodecsVectorTilePoint, std::allocator<GeoCodecsVectorTilePoint>> { struct GeoCodecsVectorTilePoint *x0; struct GeoCodecsVectorTilePoint *x1; struct { struct GeoCodecsVectorTilePoint *x0; } x2; })a1;
