...
@interface GEOClientCapabilities : PBCodable <NSCopying> {
    ...
    BOOL _hasPartnerProfileInstalled;
    ...
    BOOL _supportsEv2;
    BOOL _supportsEvRoutingPreconditioning;
    BOOL _supportsExtendedSpringfieldRegions;
...
@property (nonatomic) BOOL hasSupportsExtendedSpringfieldRegions;
@property (nonatomic) BOOL supportsExtendedSpringfieldRegions;
@property (nonatomic) BOOL hasHasPartnerProfileInstalled;
@property (nonatomic) BOOL hasPartnerProfileInstalled;
@property (nonatomic) BOOL hasSupportsInternalInfo;
@property (nonatomic) BOOL supportsInternalInfo;
@property (nonatomic) BOOL hasSupportsEvRoutingPreconditioning;
@property (nonatomic) BOOL supportsEvRoutingPreconditioning;
