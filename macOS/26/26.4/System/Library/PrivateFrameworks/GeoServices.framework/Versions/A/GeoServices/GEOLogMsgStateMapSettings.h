...
@interface GEOLogMsgStateMapSettings : PBCodable <NSCopying> {
    ...
    BOOL _eBike;
    BOOL _familiarRoutes;
    BOOL _findMyCarEnabled;
    BOOL _headingEnabled;
    BOOL _labelEnabled;
    BOOL _pauseSpokenAudioEnabled;
    BOOL _reportingIncidentsEnabled;
    BOOL _speedLimitEnabled;
    BOOL _trafficEnabled;
    BOOL _walkingAvoidBusyRoads;
    BOOL _walkingAvoidHills;
    BOOL _walkingAvoidStairs;
    struct { unsigned char has_cyclingVoiceSettings : 1; unsigned char has_drivingVoiceSettings : 1; unsigned char has_locationType : 1; unsigned char has_navVoiceVolume : 1; unsigned char has_preferredTransportMode : 1; unsigned char has_routeHandoff : 1; unsigned char has_visitedPlaces : 1; unsigned char has_walkingVoiceSettings : 1; unsigned char has_hFPEnabled : 1; unsigned char has_avoidBusyRoads : 1; unsigned char has_avoidHighways : 1; unsigned char has_avoidHills : 1; unsigned char has_avoidStairs : 1; unsigned char has_avoidTolls : 1; unsigned char has_bikingAvoidBusyRoads : 1; unsigned char has_bikingAvoidHills : 1; unsigned char has_bikingAvoidStairs : 1; unsigned char has_directionsWakeDevice : 1; unsigned char has_eBike : 1; unsigned char has_familiarRoutes : 1; unsigned char has_findMyCarEnabled : 1; unsigned char has_headingEnabled : 1; unsigned char has_labelEnabled : 1; unsigned char has_pauseSpokenAudioEnabled : 1; unsigned char has_reportingIncidentsEnabled : 1; unsigned char has_speedLimitEnabled : 1; unsigned char has_trafficEnabled : 1; unsigned char has_walkingAvoidBusyRoads : 1; unsigned char has_walkingAvoidHills : 1; unsigned char has_walkingAvoidStairs : 1; } _flags;
}
...
@property (nonatomic) BOOL hasFamiliarRoutes;
@property (nonatomic) BOOL familiarRoutes;
@property (nonatomic) BOOL hasVisitedPlaces;
@property (nonatomic) int visitedPlaces;
@property (nonatomic) BOOL hasReportingIncidentsEnabled;
@property (nonatomic) BOOL reportingIncidentsEnabled;
@property (nonatomic) BOOL hasRouteHandoff;
...
- (id)routeHandoffAsString:(int)a0;
- (int)StringAsRouteHandoff:(id)a0;
