...
@property (readonly, nonatomic, getter=_hasSprLandmarkIcon) BOOL hasSprLandmarkIcon;
...
@property (readonly, nonatomic, getter=_isCoordinateDerived) BOOL isCoordinateDerived;
...
- (id)shortAddress;
- (id)appBundleIDWithVendorID:(id)a0;
...
- (id)_bestIconForPlaceCardHeaderDisplay:(struct CGSize { double x0; double x1; })a0 allowSmaller:(BOOL)a1;
