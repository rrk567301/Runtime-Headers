...
- (id)initWithCoordinates:(struct { struct { double x0; double x1; double x2; } x0; double x1; BOOL x2; } *)a0 count:(unsigned long long)a1 allSupportPoints:(BOOL)a2;
- (id)initWithCoordinates:(struct { struct { double x0; double x1; double x2; } x0; double x1; BOOL x2; } *)a0 count:(unsigned long long)a1 allSupportPoints:(BOOL)a2 isLearnedRoute:(BOOL)a3;
