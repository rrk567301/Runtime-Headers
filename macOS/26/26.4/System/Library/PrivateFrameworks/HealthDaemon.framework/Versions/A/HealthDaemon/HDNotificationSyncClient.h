...
- (id)initWithProfile:(id)a0 clientIdentifier:(id)a1 queue:(id)a2 registrationCompleteHandler:(id /* block */)a3;
...
- (BOOL)obliterateNotificationInstructionsWithError:(id *)a0;
