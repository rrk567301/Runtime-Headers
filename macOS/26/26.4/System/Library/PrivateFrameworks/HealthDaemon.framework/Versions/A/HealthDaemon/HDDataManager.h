...
- (void)shouldNotifyForDeletedSamplesMap:(id)a0 intervals:(id)a1 userRequested:(BOOL)a2 transaction:(id)a3 anchor:(id)a4;
...
- (BOOL)insertDataObjects:(id)a0 withProvenance:(id)a1 creationDate:(double)a2 skipInsertionFilter:(BOOL)a3 updateSourceOrder:(BOOL)a4 resolveAssociations:(BOOL)a5 transactionContext:(id)a6 error:(id *)a7;
...
- (BOOL)insertDataObjects:(id)a0 sourceEntity:(id)a1 deviceEntity:(id)a2 sourceVersion:(id)a3 creationDate:(double)a4 timeZone:(id)a5 OSVersion:(struct { long long x0; long long x1; long long x2; })a6 error:(id *)a7;
