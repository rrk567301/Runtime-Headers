...
+ (void)databaseShapeWithConfiguration:(long long)a0 healthDatabase:(id)a1 completion:(id /* block */)a2;
+ (id)databaseShapeWithHealthDatabase:(id)a0 error:(id *)a1;
+ (id)dateIntervalsForSampleTypes:(id)a0 profile:(id)a1 error:(id *)a2;
+ (void)deleteSamplesWithPredicate:(id)a0 limit:(unsigned long long)a1 deletionContext:(id)a2 completion:(id /* block */)a3;
+ (void)deleteSamplesWithPredicate:(id)a0 limit:(unsigned long long)a1 generateDeletedObjects:(BOOL)a2 transaction:(id)a3 profile:(id)a4 recursiveDeleteAuthorizationBlock:(id /* block */)a5 completion:(id /* block */)a6;
...
+ (BOOL)enumerateAssociatedObjectsForIdentifier:(long long)a0 inDatabase:(id)a1 predicate:(id)a2 error:(id *)a3 associatedObjectHandler:(id /* block */)a4;
