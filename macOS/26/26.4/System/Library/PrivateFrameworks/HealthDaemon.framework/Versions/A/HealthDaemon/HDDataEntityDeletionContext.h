@class NSMutableDictionary, HDDatabaseTransaction, HDProfile, NSString, NSNumber;
...
@property (readonly, copy, nonatomic) NSMutableDictionary *deletedObjectsMap;
@property (readonly, copy, nonatomic) NSMutableDictionary *deletedObjectsParentMap;
