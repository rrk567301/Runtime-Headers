@class NSMutableDictionary, HDLocationManager, HDBiomeInterface, HDProfile, NSDictionary, NSObject, HDWorkoutAppStateMonitor, HDWorkoutAssertionManager, HDAssertion, NSMutableArray, NSString, HDWorkoutMirroringManager, HDWorkoutSessionServer, HDWorkoutLocationSmoother, HKObserverSet;
...
- (void)receivedCompanionWorkoutStateRequestWithCompletion:(id /* block */)a0;
