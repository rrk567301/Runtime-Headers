...
@protocol OS_dispatch_group, HDHealthDaemon, HDInternalOntologyDatabaseManager, HDSyncEngine, HDActivityCacheManagerInterface;
...
@interface HDProfile : NSObject <HKFeatureAvailabilityHealthDataSource, HKAnalyticsHealthDataSource, HDCloudSyncRepositoryProfile, HDHealthDaemonReadyObserver> {
    ...
    id<HDInternalOntologyDatabaseManager> _internalOntologyDatabaseManager;
