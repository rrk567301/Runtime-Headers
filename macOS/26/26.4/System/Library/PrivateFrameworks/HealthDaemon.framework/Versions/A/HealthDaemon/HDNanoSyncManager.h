...
- (void)messageCenterDidReceiveCompanionWorkoutStateRequest:(id)a0;
...
- (void)messageCenterDidReceiveCompanionWorkoutStateError:(id)a0;
...
- (void)messageCenterDidReceiveCompanionWorkoutStateResponse:(id)a0;
...
- (void)messageCenterDidReceiveNotificationInstructionRequest:(id)a0;
...
- (void)sendNotificationInstructionMessageRequest:(id)a0 completion:(id /* block */)a1;
