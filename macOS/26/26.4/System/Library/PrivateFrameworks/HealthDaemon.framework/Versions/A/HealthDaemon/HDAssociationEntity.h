...
+ (id)associatedObjectsForUUID:(id)a0 excludeDeleted:(BOOL)a1 profile:(id)a2 error:(id *)a3;
...
+ (BOOL)parentObject:(id)a0 isAssociatedWithChildObject:(id)a1 type:(unsigned long long)a2 behavior:(unsigned long long)a3 profile:(id)a4 error:(id *)a5;
+ (id)tableAliases;
