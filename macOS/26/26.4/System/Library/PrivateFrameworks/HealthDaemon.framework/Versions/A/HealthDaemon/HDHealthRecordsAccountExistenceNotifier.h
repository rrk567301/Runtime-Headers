...
@protocol HDHealthRecordsAccountExistenceObserver, HDHealthRecordsProfileExtensionProtocol;
...
@property (readonly, nonatomic) BOOL isCurrentCountryCodeSupportingCHR;
