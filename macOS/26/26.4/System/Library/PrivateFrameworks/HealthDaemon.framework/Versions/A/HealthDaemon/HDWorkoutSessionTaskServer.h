...
- (void)remote_recoverAllActiveSessionsWithStates:(id)a0 date:(id)a1 completion:(id /* block */)a2;
- (void)remote_recoverWithCompletion:(id /* block */)a0;
- (void)remote_runSetupPostClientMirroringStartHandlerWithCompletion:(id /* block */)a0;
- (void)remote_sendDataToRemoteWorkoutSession:(id)a0 completion:(id /* block */)a1;
- (void)remote_setTargetState:(long long)a0 date:(id)a1 completion:(id /* block */)a2;
- (void)remote_setupMirroredSessionWithHandler:(id /* block */)a0;
- (void)remote_setupTaskServerWithCompletion:(id /* block */)a0;
- (void)remote_startMirroringToCompanionDeviceWithCompletion:(id /* block */)a0;
- (void)remote_stopMirroringToCompanionDeviceWithCompletion:(id /* block */)a0;
- (void)remote_syncSessionEvent:(long long)a0 date:(id)a1;
...
- (void)didSyncCurrentActivity:(id)a0;
- (void)didSyncStateEvent:(long long)a0 date:(id)a1;
- (void)didSyncTransitionToNewState:(long long)a0 date:(id)a1;
