@class _HKBehavior, NSString, HKObserverSet, NSDate, HDPeriodicActivity, HDPrimaryProfile, HDRepeatingBackgroundTask, NSObject, NSMutableDictionary, NSMutableSet;
...
- (void)heartRate_reportDailyRestingHeartRate:(double)a0 sedentaryHeartRateCount:(int)a1 filteredSedentaryHeartRateCount:(int)a2 hasTimeAsleep:(BOOL)a3 hasBGHRSleepMode:(BOOL)a4 unfilteredRestingHeartRate:(double)a5 profileType:(long long)a6;
...
- (void)cloudSync_reportRestoreForProfile:(id)a0 startDate:(id)a1 endDate:(id)a2 duration:(double)a3 finishedJournalMerge:(BOOL)a4 restoreSessionID:(id)a5;
...
- (void)workout_reportEvent:(id)a0 timestamp:(id)a1 sessionID:(id)a2 activityType:(long long)a3 sessionDuration:(long long)a4 activityCount:(long long)a5 extendedMode:(BOOL)a6 totalLocations:(long long)a7 routeSmoothingRetryCount:(long long)a8 activityID:(id)a9 failure:(BOOL)a10;
...
- (void)workout_reportWorkoutCondenserCoalescingCompressionRate:(id)a0 numberOfSamplesBeforeCoalescing:(long long)a1 numberOfSamplesAfterCoalescing:(long long)a2 compressionRate:(double)a3;
