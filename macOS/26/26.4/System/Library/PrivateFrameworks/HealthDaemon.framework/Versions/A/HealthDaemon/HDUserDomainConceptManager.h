...
- (void)notifyObserversForDeletedUDC:(id)a0 maxAnchor:(long long)a1 transaction:(id)a2;
...
- (void)notifyObserversForUpdatedUDC:(id)a0 maxAnchor:(long long)a1 transaction:(id)a2;
- (void)removeSynchronousUserDomainConceptObserver:(id)a0;
- (BOOL)deleteUserDomainConcepts:(id)a0 error:(id *)a1;
- (void).cxx_destruct;
- (id)keyValueDomain;
- (void)notifyObserversForAddedUDC:(id)a0 maxAnchor:(long long)a1 transaction:(id)a2;
