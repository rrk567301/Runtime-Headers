...
+ (id)notSupportedErrorForMethod:(id)a0;
...
+ (id)virtualizationDataError:(id)a0;
+ (id)virtualizationHostError:(id)a0;
+ (id)virtualizationHostError:(id)a0 error:(id)a1;
+ (id)virtualizationKernelError:(id)a0 kernelErrorCode:(int)a1;
