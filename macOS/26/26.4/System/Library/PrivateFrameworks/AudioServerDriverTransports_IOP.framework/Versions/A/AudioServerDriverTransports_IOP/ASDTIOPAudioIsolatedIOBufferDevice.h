@interface ASDTIOPAudioIsolatedIOBufferDevice : ASDTIOService {
    struct unique_ptr<ASDT::IOPAudio::IsolatedIOBuffer::UserClient, std::default_delete<ASDT::IOPAudio::IsolatedIOBuffer::UserClient>> { struct { struct UserClient *__ptr_; } ; } _userClient;
}
