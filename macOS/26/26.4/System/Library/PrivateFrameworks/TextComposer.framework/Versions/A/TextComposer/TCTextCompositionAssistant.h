@class NLTagger, TCTextCompositionSmartRepliesCache, TCTextCompositionSmartRepliesRateLimiter, NSDictionary, _TtC12TextComposer40TCTextCompositionCalendarEventGeneration;
@protocol TCModelRunnerProtocol;
...
+ (unsigned long long)getKoreanWordCount:(id)a0;
+ (unsigned long long)getKoreanWordCount:(id)a0 withTokenizer:(struct __NLTokenizer { } *)a1;
...
+ (BOOL)isEnglishWithIndiaLocale:(id)a0;
+ (BOOL)isEnglishWithIndiaLocaleOrHindiInPreferredLanguage;
+ (BOOL)isFrench:(id)a0;
+ (BOOL)isFrenchWithCanadaLocale:(id)a0;
+ (BOOL)isHindi:(id)a0;
+ (BOOL)isHindiWithLatinScript:(id)a0;
...
+ (BOOL)isResolvedLanguageHindiLatinForString:(id)a0 regionPolicy:(unsigned long long)a1;
...
+ (id)resolvedLanguageForString:(id)a0 supportedLanguages:(id)a1 preferredLanguages:(id)a2;
...
+ (BOOL)supportsHinglish:(id)a0;
+ (BOOL)testInputTokenIsWord:(id)a0 preferredLanguage:(id)a1 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a2;
+ (BOOL)testOutputTokenIsWord:(id)a0 preferredLanguage:(id)a1 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a2;
...
- (void)_defaultDescribeDetailForTokenDifferenceManager:(id)a0 difference:(id)a1 tagger:(id)a2 preferredLanguage:(id)a3 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a4 detail:(id)a5;
...
- (BOOL)addGrammarCheckingDetailsForRewrittenString:(id)a0 originalString:(id)a1 originalAttributedString:(id)a2 originalSentenceRanges:(id)a3 tagger:(id)a4 preferredLanguage:(id)a5 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a6 writingOptions:(id)a7 retainList:(id)a8 toDictionary:(id)a9;
- (BOOL)addGrammarCheckingDetailsForRewrittenString:(id)a0 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 originalString:(id)a2 originalAttributedString:(id)a3 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 tagger:(id)a5 preferredLanguage:(id)a6 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a7 writingOptions:(id)a8 retainList:(id)a9 toDictionary:(id)a10;
...
- (id)chinesePunctuationSpacingVersionOfString:(id)a0;
...
- (id)detailDictionaryForTokenDifferenceManager:(id)a0 difference:(id)a1 originalAttributedString:(id)a2 sentenceRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 tagger:(id)a4 preferredLanguage:(id)a5 tokenizerForKoreanSubword:(struct __NLTokenizer { } *)a6 writingOptions:(id)a7 retainList:(id)a8;
...
- (BOOL)enableWritingAssistantPrototypes;
...
- (id)frenchCanadianPunctuationSpacingVersionOfString:(id)a0;
