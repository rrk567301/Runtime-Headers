@interface CoreEmbeddedSpeechAnalyzer : NSObject <CoreEmbeddedSpeechRecognizerProvider> {
    ...
    void /* unknown type, empty encoding */ loggableUserIDHashCache;
    void /* unknown type, empty encoding */ preheatingTask;
    void /* unknown type, empty encoding */ taggerInitTask;
    void /* unknown type, empty encoding */ entityTagger;
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_speechProfileConfig;
