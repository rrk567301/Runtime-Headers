...
- (void).cxx_destruct;
- (id)description;
- (id)_euclidProfileRelevantSets:(id)a0;
...
- (id)_purgeableSpeechProfileInstancesFromObsoleteSpeechProfileInstances:(id)a0;
- (BOOL)_removeSpeechProfileInstance:(id)a0;
...
- (void)_updateEuclidProfileInstanceWithSets:(id)a0;
...
- (BOOL)_verifyAllProfileInstances:(unsigned long long)a0 shouldDefer:(id /* block */)a1;
...
- (BOOL)verifyAllProfileInstances:(unsigned long long)a0 shouldDefer:(id /* block */)a1;
