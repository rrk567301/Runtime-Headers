...
- (id)initWithLanguage:(id)a0 requestIdentifier:(id)a1 dictationUIInteractionIdentifier:(id)a2 task:(id)a3 loggingContext:(id)a4 applicationName:(id)a5 profile:(id)a6 overrides:(id)a7 modelOverrideURL:(id)a8 originalAudioFileURL:(id)a9 codec:(id)a10 narrowband:(BOOL)a11 detectUtterances:(BOOL)a12 censorSpeech:(BOOL)a13 farField:(BOOL)a14 secureOfflineOnly:(BOOL)a15 shouldStoreAudioOnDevice:(BOOL)a16 continuousListening:(BOOL)a17 shouldHandleCapitalization:(BOOL)a18 isSpeechAPIRequest:(BOOL)a19 maximumRecognitionDuration:(double)a20 endpointStart:(double)a21 inputOrigin:(id)a22 location:(id)a23 jitGrammar:(id)a24 deliverEagerPackage:(BOOL)a25 disableDeliveringAsrFeatures:(BOOL)a26 enableEmojiRecognition:(BOOL)a27 enableAutoPunctuation:(BOOL)a28 enableVoiceCommands:(BOOL)a29 disableEagerLimit:(BOOL)a30 sharedUserInfos:(id)a31 prefixText:(id)a32 postfixText:(id)a33 selectedText:(id)a34 powerContext:(id)a35 recognitionStart:(double)a36 shouldGenerateVoiceCommandCandidates:(BOOL)a37 asrId:(id)a38 activeUserInfo:(id)a39 messagesContext:(id)a40 sessionIdentifier:(id)a41;
...
- (id)initWithLanguage:(id)a0 requestIdentifier:(id)a1 dictationUIInteractionIdentifier:(id)a2 task:(id)a3 loggingContext:(id)a4 applicationName:(id)a5 profile:(id)a6 overrides:(id)a7 modelOverrideURL:(id)a8 originalAudioFileURL:(id)a9 codec:(id)a10 narrowband:(BOOL)a11 detectUtterances:(BOOL)a12 censorSpeech:(BOOL)a13 farField:(BOOL)a14 secureOfflineOnly:(BOOL)a15 shouldStoreAudioOnDevice:(BOOL)a16 continuousListening:(BOOL)a17 shouldHandleCapitalization:(BOOL)a18 isSpeechAPIRequest:(BOOL)a19 maximumRecognitionDuration:(double)a20 endpointStart:(double)a21 inputOrigin:(id)a22 location:(id)a23 jitGrammar:(id)a24 deliverEagerPackage:(BOOL)a25 disableDeliveringAsrFeatures:(BOOL)a26 enableEmojiRecognition:(BOOL)a27 enableAutoPunctuation:(BOOL)a28 enableVoiceCommands:(BOOL)a29 sharedUserInfos:(id)a30 prefixText:(id)a31 postfixText:(id)a32 selectedText:(id)a33 powerContext:(id)a34 recognitionStart:(double)a35 shouldGenerateVoiceCommandCandidates:(BOOL)a36 asrId:(id)a37 activeUserInfo:(id)a38;
- (id)initWithLanguage:(id)a0 requestIdentifier:(id)a1 dictationUIInteractionIdentifier:(id)a2 task:(id)a3 loggingContext:(id)a4 applicationName:(id)a5 profile:(id)a6 overrides:(id)a7 modelOverrideURL:(id)a8 originalAudioFileURL:(id)a9 codec:(id)a10 narrowband:(BOOL)a11 detectUtterances:(BOOL)a12 censorSpeech:(BOOL)a13 farField:(BOOL)a14 secureOfflineOnly:(BOOL)a15 shouldStoreAudioOnDevice:(BOOL)a16 continuousListening:(BOOL)a17 shouldHandleCapitalization:(BOOL)a18 isSpeechAPIRequest:(BOOL)a19 maximumRecognitionDuration:(double)a20 endpointStart:(double)a21 inputOrigin:(id)a22 location:(id)a23 jitGrammar:(id)a24 deliverEagerPackage:(BOOL)a25 disableDeliveringAsrFeatures:(BOOL)a26 enableEmojiRecognition:(BOOL)a27 enableAutoPunctuation:(BOOL)a28 enableVoiceCommands:(BOOL)a29 sharedUserInfos:(id)a30 prefixText:(id)a31 postfixText:(id)a32 selectedText:(id)a33 powerContext:(id)a34 recognitionStart:(double)a35 shouldGenerateVoiceCommandCandidates:(BOOL)a36 asrId:(id)a37 activeUserInfo:(id)a38 messagesContext:(id)a39;
