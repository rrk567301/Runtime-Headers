...
@property (nonatomic) BOOL shouldSkipAppStoreDeployment;
...
- (void)_addLayerReference:(id)a0 toMutableIconLayerStack:(id)a1 matchingAppearance:(id)a2 fallbackAppearance:(id)a3 error:(id *)a4;
- (void)_addLegacyIconAssetsForLayerStack:(id)a0 forAppearance:(id)a1 renderedAppearance:(unsigned long long)a2 renderingMode:(id)a3 error:(id *)a4;
- (void)_addLegacyIconAssetsForLayerStackProduction:(id)a0 withName:(id)a1 error:(id *)a2;
...
- (id)_iconLayerStackFromLayerStackRendition:(id)a0 withName:(id)a1 matchingAppearance:(id)a2 fallbackAppearance:(id)a3 error:(id *)a4;
...
- (id)_namedColorFromColorRendition:(id)a0;
- (id)_namedGradientFromGradientRendition:(id)a0 matchingAppearance:(id)a1 fallbackAppearance:(id)a2;
...
- (id)_renditionInSet:(id)a0 matchingAppearance:(id)a1;
- (id)_sizeIndexesByNameFromNamedAssetImportInfos:(id)a0;
- (void)_synchronousSave;
- (BOOL)_testRenditionForP3:(id)a0;
...
- (struct CGColorSpace { } *)createCGColorSpaceWithIdentifier:(unsigned long long)a0;
...
- (id)createNamedArtworkProductionsForAssets:(id)a0 customInfos:(id)a1 skipLastStep:(BOOL)a2 error:(id *)a3;
...
- (id)createNamedGradientProductionsForImportInfos:(id)a0 error:(id *)a1;
- (void)createNamedIconLayerStacksForCustomInfos:(id)a0 referenceFiles:(BOOL)a1 bitSource:(id)a2 error:(id *)a3;
...
- (id)urlForRasterizedIconImageStackNamed:(id)a0;
