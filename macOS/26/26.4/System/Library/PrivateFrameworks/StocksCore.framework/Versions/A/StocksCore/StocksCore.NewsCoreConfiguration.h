...
@interface StocksCore.NewsCoreConfiguration : NSObject <FCNewsAppConfiguration, FCCoreConfiguration> {
    void /* function */ experimentalizableFieldPostfix;
...
@property (nonatomic, readonly) BOOL paywallExperimentationEnabled;
...
@property (nonatomic, readonly) BOOL foodEnabled;
