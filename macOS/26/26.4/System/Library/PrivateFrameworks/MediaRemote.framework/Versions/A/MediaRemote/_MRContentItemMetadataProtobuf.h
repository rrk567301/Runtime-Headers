...
@property (readonly, nonatomic) BOOL hasInternationalStandardRecordingCode;
...
@property (readonly, nonatomic) BOOL hasSubtitleShort;
@property (retain, nonatomic) NSString *subtitleShort;
@property (readonly, nonatomic) BOOL hasTransitionInfoData;
...
- (void)addEntityPaths:(id)a0;
- (int)StringAsFormatTierPreference:(id)a0;
- (id)entityPathsAtIndex:(unsigned long long)a0;
