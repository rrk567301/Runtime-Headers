...
@property (readonly, nonatomic) BOOL staticWaveform;
...
@property (readonly, nonatomic) BOOL supportSystemGroupSession;
...
@property (readonly, nonatomic) BOOL supportNowPlayingDrivenAgent;
