...
@property (readonly, nonatomic) BOOL groupLeaderIsPlaceholder;
...
+ (void)volumeCapabilitiesForOutputDeviceUID:(id)a0 timeout:(double)a1 details:(id)a2 completion:(id /* block */)a3;
+ (void)_notifyEndpointDidConnect:(id)a0;
+ (void)_notifyDidChangePredictedOutputDevice:(id)a0 endpoint:(id)a1;
+ (void)volumeForOutputDeviceUID:(id)a0 timeout:(double)a1 details:(id)a2 completion:(id /* block */)a3;
...
+ (void)pauseOutputDeviceUIDs:(id)a0 behavior:(unsigned long long)a1 details:(id)a2 queue:(id)a3 completion:(id /* block */)a4;
...
+ (void)changeVolume:(float)a0 action:(unsigned long long)a1 outputDeviceUIDs:(id)a2 timeout:(double)a3 details:(id)a4 completion:(id /* block */)a5;
