...
@property (readonly) BOOL callerIdIsBlocked;
...
+ (id)getLocationForHandle:(id)a0 andIsoCountryCode:(id)a1;
+ (id)getLocationForHandleMap:(id)a0;
...
+ (id)predicateForCallsWithFilteredOutReason:(id)a0;
+ (id)predicateForCallsWithLocalParticipantUUID:(id)a0 andCallerIDAvailability:(unsigned int)a1;
...
- (BOOL)canCoalesceRemoteParticipantHandlesFromCall:(id)a0 usingNewStrategy:(BOOL)a1;
