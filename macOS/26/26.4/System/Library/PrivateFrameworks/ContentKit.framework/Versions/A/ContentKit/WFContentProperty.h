...
- (BOOL)hasPropertyClass:(Class)a0;
- (BOOL)hasPropertyClassOfKind:(Class)a0;
- (BOOL)hasPropertyClassSubclassingClass:(Class)a0;
- (id)initWithKeyPath:(id)a0 block:(id /* block */)a1 setterBlock:(id /* block */)a2 name:(id)a3 propertyClasses:(id)a4 multipleValues:(BOOL)a5 filterable:(BOOL)a6 sortable:(BOOL)a7 gettable:(BOOL)a8 settable:(BOOL)a9 appendable:(BOOL)a10 removable:(BOOL)a11 primary:(BOOL)a12 allowedOperators:(id)a13 userInfo:(id)a14 possibleValues:(id)a15 caseInsensitive:(BOOL)a16 negativeName:(id)a17 singularItemName:(id)a18 irrational:(BOOL)a19 tense:(unsigned long long)a20 timeUnits:(unsigned long long)a21 preferredTimeUnit:(unsigned long long)a22 comparableUnits:(unsigned long long)a23 measurementUnitType:(id)a24 displayName:(id)a25 canLowercaseName:(BOOL)a26 linkPropertyIdentifier:(id)a27 spotlightAttributeKey:(id)a28 spotlightCustomAttributeKey:(id)a29;
