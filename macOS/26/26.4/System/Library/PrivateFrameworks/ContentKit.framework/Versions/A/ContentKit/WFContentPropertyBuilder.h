...
- (id)preferredTimeUnit:(unsigned long long)a0;
- (id)primary:(BOOL)a0;
...
- (id)userInfo:(id)a0;
- (id)withLinkPropertyIdentifier:(id)a0;
- (id)withSpotlightAttributeKey:(id)a0;
- (id)withSpotlightCustomAttributeKey:(id)a0;
