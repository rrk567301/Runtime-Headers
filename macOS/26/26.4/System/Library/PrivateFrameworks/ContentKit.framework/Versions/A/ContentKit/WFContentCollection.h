...
- (void)getObjectRepresentationAndAttributionSet:(id /* block */)a0 coercionOptions:(id)a1 forClass:(Class)a2;
- (void)getObjectRepresentationAndAttributionSet:(id /* block */)a0 forClass:(Class)a1;
- (void)getObjectRepresentations:(id /* block */)a0 coercionOptions:(id)a1 forClass:(Class)a2;
...
- (void)getRichTextRepresentationWithPermissionRequestor:(id)a0 completion:(id /* block */)a1;
