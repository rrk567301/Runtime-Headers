...
+ (void)createMapsLinkWithPlacemark:(id)a0 location:(id)a1 streetAddress:(id)a2 postalAddress:(id)a3 shiftingLocationIfNecessary:(BOOL)a4 completionHandler:(id /* block */)a5;
+ (void)getLocationFromPlacemark:(id)a0 location:(id)a1 postalAddress:(id)a2 completionHandler:(id /* block */)a3;
