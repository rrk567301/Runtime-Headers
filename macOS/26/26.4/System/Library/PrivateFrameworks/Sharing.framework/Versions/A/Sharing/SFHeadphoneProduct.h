...
@property (class, readonly, nonatomic) SFHeadphoneProduct *b788;
...
@property (class, readonly, nonatomic) SFHeadphoneProduct *b494b;
@property (class, readonly, nonatomic) SFHeadphoneProduct *b515d;
...
@property (nonatomic) BOOL isAirPodsPro;
@property (nonatomic) BOOL isAirPodsMax;
@property (nonatomic) BOOL hasCaseBT;
@property (nonatomic) BOOL isBeatsProductWithCase;
