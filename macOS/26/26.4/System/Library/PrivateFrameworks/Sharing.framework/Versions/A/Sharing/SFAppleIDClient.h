...
- (id)init;
- (void)dealloc;
- (void)_altDSIDLookupWithEmails:(id)a0 phoneNumbers:(id)a1 fetchType:(long long)a2 completion:(id /* block */)a3;
...
- (void)altDSIDLookupWithEmails:(id)a0 phoneNumbers:(id)a1 fetchType:(long long)a2 completion:(id /* block */)a3;
