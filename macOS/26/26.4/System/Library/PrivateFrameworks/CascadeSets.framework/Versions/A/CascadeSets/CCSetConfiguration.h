...
- (void).cxx_destruct;
- (id)initWithSetIdentifier:(id)a0 setUUID:(id)a1 resourceDomain:(unsigned long long)a2 configuredDescriptors:(id)a3 syncPolicy:(id)a4 indexedFields:(id)a5 dataProtectionClass:(unsigned char)a6;
