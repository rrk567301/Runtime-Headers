...
+ (id)_computeMetricsForSet:(id)a0 error:(id *)a1;
+ (double)_populationStandardDeviation:(struct shared_ptr<std::vector<unsigned int>> { void *x0; struct __shared_weak_count *x1; })a0 mean:(double)a1;
