...
- (BOOL)_atomicallyCreateDataResource:(id)a0 withResourceGeneration:(id)a1;
- (BOOL)_atomicallyRemoveDataResource:(id)a0;
...
- (id)_temporaryDirectoryForDataResource:(id)a0;
