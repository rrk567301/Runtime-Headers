...
- (BOOL)enumerateContentProvenanceRecordsForStateVector:(id)a0 selectAtomsInState:(unsigned char)a1 skipOverAtomsInState:(unsigned char)a2 deviceMapping:(id)a3 error:(id *)a4 usingBlock:(id /* block */)a5;
- (id)fetchContentRecordFromContentHash:(id)a0;
- (id)initWithDatabaseAccess:(id)a0 siteIdentifierFormat:(unsigned char)a1;
- (id)_createProvenanceSelectCommandFromDeviceRowIdToClockValues:(id)a0 recordClass:(Class)a1 state:(unsigned char)a2 columns:(id)a3;
- (BOOL)_enumerateProvenanceRecordsForStateVector:(id)a0 recordClass:(Class)a1 selectAtomsInState:(unsigned char)a2 skipOverAtomsInState:(unsigned char)a3 deviceMapping:(id)a4 error:(id *)a5 usingBlock:(id /* block */)a6;
- (id)_resolveSequenceNumberRangesOfDeltaVector:(id)a0 seenStateVectorBuilder:(id)a1 deviceMapping:(id)a2 tableName:(id)a3;
- (BOOL)checkForLocalSourceDonation:(BOOL *)a0 error:(id *)a1;
- (BOOL)enumerateMetaContentProvenanceRecordsForStateVector:(id)a0 selectAtomsInState:(unsigned char)a1 skipOverAtomsInState:(unsigned char)a2 deviceMapping:(id)a3 error:(id *)a4 usingBlock:(id /* block */)a5;
