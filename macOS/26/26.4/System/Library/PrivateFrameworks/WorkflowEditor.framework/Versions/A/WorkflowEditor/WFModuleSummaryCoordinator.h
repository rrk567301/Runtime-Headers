@class WFSlotTemplateView, WFModuleSummaryTemplateBuilder, NSArray, NSString, NSSet, NSMutableDictionary, NSDictionary, WFModuleSummaryEditor, WFSlotIdentifier, WFVariable;
...
- (BOOL)slotTemplateView:(id)a0 shouldChangeTextTo:(id)a1 replacingRanges:(id)a2 withStrings:(id)a3 forSlotWithIdentifier:(id)a4;
