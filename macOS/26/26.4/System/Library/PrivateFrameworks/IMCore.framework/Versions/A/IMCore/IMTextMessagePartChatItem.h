...
- (id)_initWithItem:(id)a0 text:(id)a1 translationSecondaryText:(id)a2 index:(long long)a3 messagePartRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 subject:(id)a5 isShowingEditHistory:(BOOL)a6 showTranslationAlternateText:(BOOL)a7;
