@class NSString, NSArray, IMMessageItem, NSLocale, NSAttributedString, IMMessagePartHighlightChatItem;
...
+ (BOOL)_shouldDisplayLinksForMessage:(id)a0 context:(id)a1 service:(id)a2 screenUnknownSendersEnabled:(BOOL)a3;
...
- (id)_initWithItem:(id)a0 text:(id)a1 translationSecondaryText:(id)a2 index:(long long)a3 messagePartRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 visibleAssociatedMessageChatItems:(id)a5;
...
- (void)setTranslationSecondaryText:(id)a0;
- (id)transcriptText;
