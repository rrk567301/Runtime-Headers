...
- (id)_archivedItemsToReplace:(id)a0 isReplacingItems:(BOOL)a1 historyLoadContext:(long long)a2;
...
- (void)_insertHistoricalMessages:(id)a0 queryID:(id)a1 isRefresh:(BOOL)a2 isHistoryQuery:(BOOL)a3 isReplacingItems:(BOOL)a4 limit:(unsigned long long)a5 hasMessagesBefore:(BOOL)a6 hasMessagesAfter:(BOOL)a7 historyLoadContext:(long long)a8;
...
- (id)_lastMessageItemFromContactOrFromMe:(BOOL)a0;
...
- (void)_setChatProperties:(id)a0 isCurrentGUID:(BOOL)a1;
...
- (void)_setDisplayName:(id)a0 hasDisappearedChatBot:(BOOL)a1;
...
- (unsigned long long)_translationChangesetWhenSettingProperties:(id)a0;
...
- (void)_updateEncryptionForMessageIfNeeded:(id)a0;
...
- (BOOL)isKnownSenderWithUnknownFilteringEnabled:(BOOL)a0;
