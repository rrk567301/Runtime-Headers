@class NSMutableDictionary, NSUserActivity, NSObject, NSDictionary, IMContactStore, IMSharedWithYouManager, NSMutableArray, IMDaemonController, NSString, NSSet, IMDaemonQueryController, IMTimer, NSArray, TUConversationManager, IMUnreadCountController, IMNetworkMonitor;
...
- (void)account:(id)a0 chat:(id)a1 style:(unsigned char)a2 chatProperties:(id)a3 groupID:(id)a4 chatPersonCentricID:(id)a5 messageSending:(id)a6;
...
- (void)markChatGUIDsAsReviewed:(id)a0;
...
- (void)transcriptBackgroundUpdatedForChatIdentifier:(id)a0 style:(unsigned char)a1 account:(id)a2 userInfo:(id)a3;
...
- (void)unreadCountChanged:(long long)a0 reports:(id)a1;
- (void)unreadCountReportsUpdated:(id)a0;
- (void)updatedPriorityForChatsWithGUIDsAndProperties:(id)a0 chatsAndMessageGUIDs:(id)a1;
...
- (void)_enumerateChatGUIDPermutationsForChatIdentifier:(id)a0 includingInstantMessageStyle:(BOOL)a1 includingGroupStyle:(BOOL)a2 includingRoomStyle:(BOOL)a3 usingBlock:(id /* block */)a4;
...
- (void)_account:(id)a0 chat:(id)a1 style:(unsigned char)a2 messagesUpdated:(id)a3 suppressNotification:(BOOL)a4;
...
- (id)_cachedChatWithHandles:(id)a0 allowAlternativeService:(BOOL)a1 groupID:(id)a2 displayName:(id)a3 joinedChatsOnly:(BOOL)a4 findMatchingNamedGroups:(BOOL)a5;
...
- (void)_chat:(id)a0 appendTranslation:(id)a1 toMessageItem:(id)a2 partIndex:(long long)a3;
- (void)_chat:(id)a0 cancelScheduledMessageWithGUID:(id)a1 destinations:(id)a2 cancelType:(unsigned long long)a3;
- (void)_chat:(id)a0 downloadTranslationAssetsForLanguageCodes:(id)a1 messageItemsToTranslateLocally:(id)a2;
...
- (void)_chat:(id)a0 partiallyUpdated:(id)a1;
...
- (void)_chat:(id)a0 retryTranscriptBackgroundUpload:(id)a1 transferID:(id)a2;
...
- (void)_chat:(id)a0 sendHQAttachmentsForMessage:(id)a1;
...
- (void)_chat:(id)a0 setTranscriptBackgroundAndSendToChat:(id)a1 transferID:(id)a2;
...
- (void)_chat:(id)a0 updateIsDeletingIncomingMessages:(BOOL)a1;
- (void)_chat:(id)a0 updateIsFiltered:(long long)a1 synchronously:(BOOL)a2;
- (void)_chat:(id)a0 updateIsRecovered:(BOOL)a1;
- (void)_chat:(id)a0 updateLastAddressedHandle:(id)a1;
- (void)_chat:(id)a0 updateProperties:(id)a1;
- (void)_chatDidRecoverFromJunk:(id)a0;
- (id)_chatForIdentifiers:(id)a0;
- (void)_chatLoadedWithChatIdentifier:(id)a0 chats:(id)a1;
- (id)_chatPredicateForGUIDs:(id)a0;
- (void)_chat_acceptChat:(id)a0;
- (long long)_chat_cachedUnreadCount:(id)a0;
- (void)_chat_clearCachedUnreadCount:(id)a0;
- (void)_chat_clearHistory:(id)a0 beforeGUID:(id)a1 afterGUID:(id)a2 queryID:(id)a3;
- (void)_chat_closeSession:(id)a0 didDeleteConversation:(BOOL)a1;
- (void)_chat_declineInvitation:(id)a0;
- (void)_chat_downloadPurgedAttachmentsForChat:(id)a0;
- (void)_chat_fetchHistorySummary:(id)a0 dateInterval:(id)a1 synchronous:(BOOL)a2 queryID:(id)a3 completion:(id /* block */)a4;
- (void)_chat_fetchIncomingPendingMessagesOverSatellite:(id)a0;
- (void)_chat_fetchOldestMessageDateForChat:(id)a0 synchronous:(BOOL)a1 queryID:(id)a2 completion:(id /* block */)a3;
...
- (void)_chat_markAsSpam:(id)a0 queryID:(id)a1 autoReport:(BOOL)a2 isJunkReportedToCarrier:(BOOL)a3 reportReason:(unsigned long long)a4;
- (void)_chat_markAsSpam:(id)a0 queryID:(id)a1 isJunkReportedToCarrier:(BOOL)a2;
- (void)_chat_markAsSpamAutomatically:(id)a0;
- (void)_chat_markLastMessageAsUnread:(id)a0;
- (void)_chat_markMessageAsUnread:(id)a0 message:(id)a1;
...
- (void)_handleTranslationEnabledChangedNotification:(id)a0;
- (void)_handleTranslationLanguageStatusChangedNotification:(id)a0;
- (void)_handleTranslationSupportChangedNotification:(id)a0;
...
- (void)_loadAllSiblingChatsForGroupChat:(id)a0 waitForReply:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_loadAllSiblingChatsForHandlesAssociatedWithOneToOneChat:(id)a0 waitForReply:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (void)_loadPossibleSiblingChatsForHandlesAssociatedWithChat:(id)a0 waitForReply:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)_loadSiblingsForChatIfNeeded:(id)a0;
- (void)_loadUnreadChatsWithLastMessageOlderThan:(id)a0 waitForReply:(BOOL)a1 predicate:(id)a2 limit:(unsigned long long)a3 completionHandler:(id /* block */)a4;
- (void)_markHasHadSuccessfulQueryForChat:(id)a0;
- (id)_mergedChatGUIDsForChatGUIDs:(id)a0;
...
- (void)_processMessagesForAccount:(id)a0 chat:(id)a1 style:(unsigned char)a2 chatProperties:(id)a3 groupID:(id)a4 chatPersonCentricID:(id)a5 messages:(id)a6 removed:(id)a7 messagesComingFromStorage:(BOOL)a8;
- (void)_processUnreadCountFullReplacement:(id)a0;
- (void)_rebuildUnreadCountController;
- (void)_recalculateServiceNamesForChatIdentifierSearch;
- (void)_refetchLocalTranscriptBackgroundAssetIfNecessaryForChat:(id)a0;
...
- (BOOL)_shouldSwitchAccountAddingMessagesToChat:(id)a0 messageItems:(id)a1 removedGUIDs:(id)a2 messagesComingFromStorage:(BOOL)a3 chatProperties:(id)a4;
- (BOOL)_shouldUpdateChatPropertyByRecencyOnChat:(id)a0 incomingDictionary:(id)a1;
...
- (id)_sortedParticipantIDHashForParticipants:(id)a0 usesPersonCentricID:(BOOL)a1 fallbackToContactID:(BOOL)a2;
- (void)_trackUsageForMessage:(id)a0;
- (void)_unreadCountControllerUpdated:(id)a0;
- (id)_unreadCountGUIDsForChat:(id)a0;
- (void)_unregisterChat:(id)a0 deleted:(BOOL)a1;
- (void)_unregisterChat:(id)a0 deleted:(BOOL)a1 didClearUnreadCount:(BOOL)a2;
- (void)_unregisterChatWithGUID:(id)a0 deleted:(BOOL)a1;
...
- (BOOL)_updateChat:(id)a0 chatIdentifierForGroups:(id)a1 shouldPostNotification:(BOOL)a2;
- (void)_updateChat:(id)a0 groupID:(id)a1 shouldPostNotification:(BOOL)a2;
- (void)_updateChat:(id)a0 originalGroupID:(id)a1 shouldPostNotification:(BOOL)a2;
...
- (void)_updateDomainIdentifiersForChat:(id)a0 incomingDictionary:(id)a1 shouldPostNotification:(BOOL)a2;
- (void)_updateFilterediMessageChatsExist:(BOOL)a0;
- (void)_updateHasCancellableScheduledMessage:(id)a0 shouldPostNotification:(BOOL)a1;
...
- (void)_updateIsDownloadingPendingSatelliteMessages:(id)a0 shouldPostNotification:(BOOL)a1;
- (void)_updateIsFilteredForChat:(id)a0 withSavedValue:(id)a1;
- (void)_updatePendingIncomingSatelliteMessageCount:(id)a0 shouldPostNotification:(BOOL)a1;
...
- (void)_updateTranscriptBackgroundForChat:(id)a0 shouldPostNotification:(BOOL)a1;
...
- (id)_winningChatIdentifierForExistingChat:(id)a0 incomingDictionary:(id)a1;
- (id)_winningGroupIDForExistingChat:(id)a0 incomingDictionary:(id)a1;
- (long long)_winningJoinStateForExistingChat:(id)a0 incomingDictionary:(id)a1;
- (id)_winningParticipantsForExistingChat:(id)a0 incomingDictionary:(id)a1;
- (id)activeCallForConversationUUID:(id)a0;
- (id)allGUIDsForChat:(id)a0;
- (id)allVisibleChatGUIDsForChats:(id)a0;
...
- (id)chatForURL:(id)a0 outMessageText:(id *)a1 outRecipientIDs:(id *)a2 outService:(id *)a3 outMessageGUID:(id *)a4 presentOverlay:(BOOL *)a5 outSIMID:(id *)a6;
- (id)chatGuidsForChat:(id)a0;
- (id)chatWithHandle:(id)a0 lastAddressedHandle:(id)a1 lastAddressedSIMID:(id)a2;
- (id)chatWithHandle:(id)a0 lastAddressedHandle:(id)a1 lastAddressedSIMID:(id)a2 shouldForceCreate:(BOOL)a3;
- (id)chatWithHandles:(id)a0;
- (id)chatWithHandles:(id)a0 displayName:(id)a1 joinedChatsOnly:(BOOL)a2;
- (id)chatWithHandles:(id)a0 displayName:(id)a1 joinedChatsOnly:(BOOL)a2 findMatchingNamedGroups:(BOOL)a3 lastAddressedHandle:(id)a4 lastAddressedSIMID:(id)a5;
...
- (void)clearHistoryAndReloadLastMessageForChatsWithGUIDs:(id)a0;
...
- (id)existingChatWithHandles:(id)a0 allowAlternativeService:(BOOL)a1 groupID:(id)a2 displayName:(id)a3 joinedChatsOnly:(BOOL)a4 findMatchingNamedGroups:(BOOL)a5;
...
- (void)markChatsAsReviewed:(id)a0;
