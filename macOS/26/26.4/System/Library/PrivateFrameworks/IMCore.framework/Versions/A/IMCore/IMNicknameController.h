@class NSSet, IMNickname, NSDictionary, NSMutableSet, NSObject, NSMutableDictionary;
...
- (id)_changedKeysForNewNicknameDictionary:(id)a0 oldNicknameDictionary:(id)a1 withComparisonOptions:(unsigned long long)a2;
