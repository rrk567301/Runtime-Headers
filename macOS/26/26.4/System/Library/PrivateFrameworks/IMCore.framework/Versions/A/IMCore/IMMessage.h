@class IMHandle, NSDate, NSDictionary, IMCollaborationInitiationRequestInfo, NSString, IMMessageItem, IMTapback, NSAttributedString, NSIndexSet, NSArray, NSData, NSError, TUConversationActivity;
...
@property (readonly, nonatomic, getter=isSenderContactAndNotMe) BOOL senderContactAndNotMe;
...
@property (nonatomic, getter=isTimeSensitive) BOOL timeSensitive;
...
+ (id)customAcknowledgementMessageWithPayloadData:(id)a0 associatedMessageGUID:(id)a1 balloonBundleID:(id)a2 messageSummaryInfo:(id)a3 threadIdentifier:(id)a4;
...
- (void)setEncrypted:(BOOL)a0;
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)description;
- (void)setIsTimeSensitive:(BOOL)a0;
- (id)_account;
- (struct IMTypingMessageCriteria { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; id /* block */ x6; })_typingMessageCriteria;
