@class NSString, NSArray, SMSystem_Daemon, SMUIDGIDTranslator, NSMutableDictionary, NSDictionary, SMManagedMigrationConfig, NSMutableSet, NSMutableArray, NSURL, NSNumber;
...
@property struct timeval { long long tv_sec; int tv_usec; } mostRecentlySavedBootTime;
...
@property (retain, nonatomic) SMManagedMigrationConfig *managedConfig;
...
@property BOOL copiesSecuritySettings;
...
@property (retain) NSString *managedTargetUsername;
...
- (id)exportXPCDict;
- (id)fileGroupingPathsDescription;
- (void)getBootTime:(struct timeval { long long x0; int x1; } *)a0;
- (id)initWithManagedConfig:(id)a0;
- (void)nudgeBootTime;
...
- (BOOL)shouldDoManagedMigration;
- (id)stringForPathGroupType:(unsigned long long)a0;
