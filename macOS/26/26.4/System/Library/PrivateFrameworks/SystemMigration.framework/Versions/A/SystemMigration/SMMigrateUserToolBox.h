...
+ (BOOL)objectContainsPattern:(id)a0 inObject:(id)a1;
...
+ (void)fixPathsInPlist:(id)a0 pattern:(id)a1 replacement:(id)a2 ownershipAttributes:(id)a3;
+ (void)fixUserNamePathsInPreferences:(id)a0 fromUserName:(id)a1 toUserName:(id)a2 userID:(unsigned int)a3 groupID:(unsigned int)a4;
...
+ (BOOL)processObject:(id)a0 replacePattern:(id)a1 withReplacement:(id)a2 clearBookmarksForPattern:(id)a3;
