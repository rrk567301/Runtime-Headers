...
+ (void)initialize;
+ (id)sharedDaemon;
+ (id)getClientConnectionInfo;
+ (id)getMemoryInfo;
+ (id)getMigrationStateInfo;
+ (id)getProcessInfo;
+ (void)handleTerminationSignal:(int)a0;
+ (void)logTerminationDiagnosticsForSignal:(int)a0;
+ (id)loghandle;
+ (void)setupSignalEventHandlers;
