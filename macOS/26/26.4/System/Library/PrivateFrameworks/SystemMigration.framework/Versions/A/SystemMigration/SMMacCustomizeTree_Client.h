...
@property (retain) SMCustomizeTreeNode_Client *security;
...
@property (retain) NSString *userRecommendedForManagedMigration;
...
- (BOOL)conflictExists;
- (void)ensureMatchedUserIsSelected;
- (void)generateTree;
- (id)getImageForUserOffSpring:(id)a0;
- (id)getTCCSecuritySize;
- (id)migrationRequest;
