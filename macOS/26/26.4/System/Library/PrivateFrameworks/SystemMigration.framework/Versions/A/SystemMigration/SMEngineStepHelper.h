...
+ (id)generateStepsForEngineForMac:(id)a0 mustGenerateUserStep:(BOOL)a1 mustGenerateMachineSettingsStep:(BOOL)a2 mustGenerateAppsFileStep:(BOOL)a3 mustDoManagedMigration:(BOOL)a4;
