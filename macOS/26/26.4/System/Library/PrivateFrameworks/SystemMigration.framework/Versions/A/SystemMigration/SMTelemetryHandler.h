...
- (void)recordErrorSignature:(id)a0;
...
- (void)recordIsManagedRun:(BOOL)a0;
- (void)recordIsPreReboot:(id)a0;
- (void)recordMigrationSelections:(id)a0;
...
- (void)recordWindowsSessionID:(id)a0;
- (void)sendEvent;
- (void)setStateTracker:(id)a0 phase:(unsigned long long)a1;
- (void)updateFromProgressUpdate:(id)a0;
