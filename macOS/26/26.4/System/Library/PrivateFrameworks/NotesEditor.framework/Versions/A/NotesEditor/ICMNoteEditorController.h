@class ICAuthorHighlightsUpdater, NSDate, ICTextController, ICPaperTextAttachmentManager, ICMPasswordEntryViewController, ICTableColumnTextView, ICSearchResultRegexMatchFinder, NSPopover, NSResponder, ICCalculatePreviewBehaviorMenu, ICCalculateRecognitionController, ICCalculateScrubberController, NSManagedObjectID, ICAttachmentInsertionController, ICMTextStylesCollectionView, _TtC11NotesEditor24ICMSystemPaperLinkHelper, ICLinkAcceleratorController, ICMHashtagDebugViewController, ICTextViewScrollState, ICInvitation, NSNumber, ICNoteUserActivityState, NSClickGestureRecognizer, ICTTTextStorage, NSImageView, ICLayoutManager, ICHashtagController, NSArray, ICMNoteEditorTouchBarController, NSMenu, ICAuthorHighlightsController, ICNAEventReporter, NSView, ICSelectorDelayer, NSString, ICActivityStreamSelection, ICVisualAssetImportController, ICMacBaseTextView, NSMenuItem, ICMacTextView, ICMLinkSuggestionsController, NSViewController, ICMInvitationViewController, NSMutableDictionary, ICNote, ICMentionsController, ICManagedObjectContextChangeController, ICMUnsupportedNoteView;
...
- (void)insertOpenLinkMenuItemIntoMenu:(id)a0;
- (void)setIconsForSystemLinkMenuItems:(id)a0;
- (void)toggleUnderline;
- (void)warnUserAttachmentLimitExceeded;
- (void)acceleratorOriginNeedsUpdate;
- (void)addAILabelingFlagToExportedPDFIfNecessaryForPrintOperation:(id)a0;
...
- (void)analyticsSessionDidResume:(id)a0;
- (void)analyticsSessionWillResign:(id)a0;
- (void)announceCurrentIndentationLevelForAccessibility;
- (void)applyContentOffsetIfAvailable;
- (void)applyContentOffsetY:(double)a0;
...
- (void)audioEventReporterLostSession:(id)a0;
- (void)audioFindInTranscript:(id)a0;
- (void)audioRecordingStarted:(id)a0;
- (void)audioRecordingStopped:(id)a0;
- (void)audioTranscriptInteraction:(id)a0;
...
- (id)snapshotImageInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
- (void)submitNoteEditEventIfNecessary;
- (void)submitNoteViewEventForNote:(id)a0;
