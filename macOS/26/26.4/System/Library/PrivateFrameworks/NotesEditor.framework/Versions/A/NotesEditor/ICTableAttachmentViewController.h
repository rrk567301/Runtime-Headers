@class ICTableUndoTarget, ICTableAutoScroller, NSMutableOrderedSet, NSDictionary, ICTableColumnTextView, NSMutableSet, NSMutableArray, ICTableContentView, ICTableAccessibilityController, NSIndexSet, ICTableClipView, NSMapTable, ICTableAttachmentSelection, NSScrollView, ICTableAttachmentProvider, ICTable, ICTableAttachmentView, ICTTTextStorage, ICDimensionSumCache, ICTableSelectionView, ICTableTextViewManager, ICLayoutManager, NSArray, ICSelectorDelayer, NSMutableDictionary, ICAppearanceInfo, NSView, NSString, NSObject, ICTableScrollView, ICMacBaseTextView, ICTableSelectionKnob, ICTableLayoutManager, ICTK2TextLayoutManager, NSUUID, NSUndoManager, ICTableColumnRowButton;
