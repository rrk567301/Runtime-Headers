...
- (void)requestFlexMusicCurationWithOptions:(id)a0 operationID:(id)a1 reply:(id /* block */)a2;
- (void)requestMusicCurationWithOptions:(id)a0 operationID:(id)a1 reply:(id /* block */)a2;
- (void)requestPersonalizedSensingRefreshWithReply:(id /* block */)a0;
- (void)requestRecentlyUsedSongsWithOptions:(id)a0 operationID:(id)a1 reply:(id /* block */)a2;
- (void)requestSongsForAdamIDs:(id)a0 options:(id)a1 operationID:(id)a2 reply:(id /* block */)a3;
