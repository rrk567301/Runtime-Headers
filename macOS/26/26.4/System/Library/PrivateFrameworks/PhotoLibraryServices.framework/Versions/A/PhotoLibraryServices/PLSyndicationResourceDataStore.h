...
+ (BOOL)readInodeAndMarkResource:(id)a0 locallyAvailableWithFileURL:(id)a1 error:(id *)a2;
...
- (BOOL)_copyItemAtURL:(id)a0 withPathManager:(id)a1 destFileIdentifier:(id)a2 inode:(unsigned long long *)a3 error:(id *)a4;
