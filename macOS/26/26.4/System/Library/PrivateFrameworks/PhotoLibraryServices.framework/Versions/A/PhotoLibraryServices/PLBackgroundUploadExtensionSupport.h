...
+ (long long)containsValidExtensionFromBundleIdentifier:(id)a0 extensionPointLabel:(id)a1;
...
+ (long long)containsValidExtensionFromBundleRecord:(id)a0 extensionPointLabel:(id)a1;
+ (BOOL)isInvalidExtensionFromValidationType:(long long)a0;
