...
+ (BOOL)isBackgroundProcessingEnabledWithManagedObjectContext:(id)a0;
...
- (id)addBackgroundJobWorkItemWithIdentifier:(id)a0 jobType:(short)a1 jobFlags:(long long)a2;
...
- (id)addBackgroundJobWorkItemIfNeededWithIdentifier:(id)a0 jobType:(short)a1 jobFlags:(long long)a2;
...
- (void)signalBackgroundProcessingNeededForWorkerTypes:(id)a0;
