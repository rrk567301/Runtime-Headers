...
+ (id)taskForGeneratingDeferredAdjustmentForAsset:(id)a0 trackingIdentifier:(id)a1 imageConversionClient:(id)a2 videoConversionClient:(id)a3 reason:(id)a4 clientBundleID:(id)a5 allowCancellationByService:(BOOL)a6;
...
- (long long)compareQOSWithTask:(id)a0;
