...
- (void)setAnimatedStickerTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0;
...
- (void)setStickerConfidenceScore:(float)a0 stickerAlgorithmVersion:(short)a1;
- (void)setTextUnderstandingData:(id)a0 version:(long long)a1;
...
- (void)resetCharacterRecognitionAttributesResetVersion:(BOOL)a0 resetData:(BOOL)a1;
- (void)resetTextUnderstandingAttributesResetVersion:(BOOL)a0 resetData:(BOOL)a1;
