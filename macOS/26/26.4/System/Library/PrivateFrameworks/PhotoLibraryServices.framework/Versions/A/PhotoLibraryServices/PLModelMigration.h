...
- (id)addStoreWithCoordinator:(id)a0 migrationUUID:(id)a1 storeURL:(id)a2 options:(id)a3 description:(id)a4 fromVersion:(unsigned long long)a5 toVersion:(unsigned long long)a6 progress:(id)a7 progressUnitCount:(unsigned long long)a8 error:(id *)a9;
...
- (long long)migratePreSchemaMigrationWithCurrentStoreVersion:(id)a0 error:(id *)a1;
...
- (void)registerPreSchemaActionClass:(Class)a0 onCondition:(BOOL)a1;
