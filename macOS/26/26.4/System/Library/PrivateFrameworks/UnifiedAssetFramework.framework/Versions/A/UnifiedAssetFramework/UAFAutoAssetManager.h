...
+ (void)stageAssetsWithNewSubscriptions:(id)a0 oldSubscriptions:(id)a1 autoAssetSets:(id)a2;
+ (BOOL)allowRemoves;
+ (BOOL)assetSetComplete:(id)a0;
+ (BOOL)assetSetEmpty:(id)a0;
...
+ (void)cacheAssetSetCompleteness:(id)a0 autoAssetSetStatus:(id)a1;
+ (void)cacheAssetSetCompleteness:(id)a0 complete:(BOOL)a1;
+ (BOOL)cacheDeleteStatusChange:(id)a0;
+ (id)completedAtomicInstance:(id)a0;
...
+ (void)configureAutoAssetsFromNewSubscriptions:(id)a0 oldSubscriptions:(id)a1 configurationManager:(id)a2 lockIfUnchanged:(BOOL)a3 userInitiated:(BOOL)a4;
+ (id)consistencyTokenFromConfig:(id)a0 atomicInstance:(id)a1 experiment:(id)a2;
+ (id)currentLockURLForAssetSet:(id)a0;
+ (id)defaultCheckPolicy;
+ (void)eliminateAssetType:(id)a0;
+ (id)fileLockPolicy;
+ (id)findDiffBetweenOldAssetSetUsages:(id)a0 newAssetSetUsages:(id)a1 knownAssetSets:(id)a2 usedAssetSets:(id)a3 configurationManager:(id)a4;
+ (id)forceRemoveAutoAssetSet:(id)a0;
+ (id)getAssetSelectorsFromSpecifiers:(id)a0 status:(id)a1;
+ (id)getAutoAssetSet:(id)a0 specifiers:(id *)a1 addEntries:(BOOL)a2 configured:(BOOL *)a3 downloaded:(BOOL *)a4 currentPolicy:(id *)a5 telemetryInfo:(id *)a6;
...
+ (unsigned long long)getDownloadStatusForAssetSet:(id)a0 configurationManager:(id)a1;
...
+ (unsigned long long)getDownloadStatusFromMAAutoAssetSetStatus:(id)a0 config:(id)a1;
...
+ (id)lockLatestAssetSet:(id)a0 atomicInstance:(id)a1;
+ (void)lockLatestAssetSet:(id)a0 atomicInstance:(id)a1 completion:(id /* block */)a2;
...
+ (id)removeAutoAssetSet:(id)a0 fallbackAlter:(BOOL)a1;
...
+ (id)setLatestAtomicInstance:(id)a0 autoAssetSet:(id)a1 fallbackAlter:(BOOL)a2 atomicInstanceMetadata:(id *)a3;
+ (void)setMinimalSpecifiers:(id)a0;
...
+ (void)stageAssetSet:(id)a0 targets:(id)a1 platformAssetVersion:(id)a2;
