...
+ (id)_subscriptionDiffersFromDB:(id)a0 subscriber:(id)a1 user:(id)a2 expirationOnlyCount:(long long *)a3 error:(id *)a4;
...
+ (BOOL)isSubscriptionExpirationIgnorable:(id)a0 subscriber:(id)a1 user:(id)a2;
