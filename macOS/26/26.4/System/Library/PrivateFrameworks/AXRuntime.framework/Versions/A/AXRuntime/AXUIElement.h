...
+ (id)uiApplicationWithPid:(int)a0;
+ (id)uiElementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 displayId:(unsigned int)a1;
+ (id)uiElementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 displayId:(unsigned int)a1 allowSameProcess:(BOOL)a2;
...
+ (id)uiElementAtCoordinate:(struct CGPoint { double x0; double x1; })a0 forApplication:(struct __AXUIElement { } *)a1 contextId:(unsigned int)a2 displayId:(unsigned int)a3 allowSameProcess:(BOOL)a4;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })nextCursorRangeInDirection:(unsigned long long)a0 unit:(unsigned long long)a1 outputRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a2 currentCursorRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3 outputStyleSpeakToRight:(BOOL)a4;
