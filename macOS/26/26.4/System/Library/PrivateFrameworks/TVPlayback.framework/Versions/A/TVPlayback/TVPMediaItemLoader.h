@class NSHashTable, NSString, AVURLAsset, NSError, TVPStateMachine, TVPMediaItemTimingData, TVPContentKeySession, NSTimer, NSObject;
...
@property (nonatomic) BOOL disableAVAssetCacheAfterMediaServicesReset;
...
- (void)_tvpMediaServicesWereReset:(id)a0;
