@class TVPProgressiveJumpingScrubber, AVQueuePlayer, TVPPlayerReporter, TVPTimeRange, NSMutableArray, NSString, NSMutableSet, AVPlayerInterstitialEventMonitor, TVPMediaItemLoader, TVPChapter, TVPInterstitial, TVPExternalImagePlayer, NSMutableDictionary, TVPPlaylist, NSArray, TVPInterstitialCollection, AVPlayer, TVPChapterCollection, NSObject, TVPPlayerBookmarkMonitor, TVPDateRange, AVPlayerItem, TVPAudioOption, TVPSubtitleOption, TVPStateMachine, NSDate, TVPPlaybackState, NSNumber, NSHashTable;
...
- (void)_addCustomTimelineBoundaryTimeObserversWithSnapshot:(id)a0;
...
- (long long)_avResourcePriority:(long long)a0;
...
- (long long)_tvpResourcePriority:(long long)a0;
...
- (void)_updateCustomTimelineBoundaryObserversDueToCurrentSegmentChange:(BOOL)a0;
...
- (void)_updateSynchronizationForAVQueuePlayer:(id)a0 synchronizationIdentifier:(id)a1;
- (void)_updateVideoViewsWithAVQueuePlayer:(id)a0;
- (BOOL)_useCustomTimelineBoundaryTimeObserver;
