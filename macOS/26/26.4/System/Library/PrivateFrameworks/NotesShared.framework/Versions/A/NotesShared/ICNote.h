...
+ (void)createNoteForAirDropDocument:(id)a0 processAttributedString:(id /* block */)a1 completion:(id /* block */)a2;
...
- (id)addAttachmentWithFileURL:(id)a0 filename:(id)a1 updateFileBasedAttributes:(BOOL)a2 analytics:(BOOL)a3;
...
- (id)addAttachmentWithUTI:(id)a0 withURL:(id)a1 filename:(id)a2 updateFileBasedAttributes:(BOOL)a3 analytics:(BOOL)a4;
...
- (id)csPersonForShareParticipant:(id)a0;
...
- (id)descendantsNeedingOnDemandAssetFetchWithContext:(id)a0 shouldFetchObject:(id /* block */)a1;
