...
- (id)initWithQueryString:(id)a0 rankingQueries:(id)a1 modernResultsOnly:(BOOL)a2;
- (id)initWithQueryString:(id)a0 rankingQueries:(id)a1 modernResultsOnly:(BOOL)a2 attributes:(id)a3;
- (id)initWithSearchSuggestionsResponder:(id)a0 searchString:(id)a1 performNLSearch:(BOOL)a2 tokens:(id)a3 modernResultsOnly:(BOOL)a4;
