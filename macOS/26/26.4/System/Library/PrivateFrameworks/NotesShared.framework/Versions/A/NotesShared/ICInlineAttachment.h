...
@property (readonly, nonatomic) BOOL isParagraphLinkAttachment;
@property (readonly, nonatomic) BOOL isInternalParagraphLinkAttachment;
...
+ (id)newLinkAttachmentWithIdentifier:(id)a0 url:(id)a1 altText:(id)a2 fromNote:(id)a3 parentAttachment:(id)a4;
+ (id)newMentionAttachmentWithIdentifier:(id)a0 mentionText:(id)a1 userRecordName:(id)a2 note:(id)a3 parentAttachment:(id)a4;
+ (id)newParagraphLinkAttachmentWithIdentifier:(id)a0 toNote:(id)a1 paragraphName:(id)a2 paragraphID:(id)a3 fromNote:(id)a4 parentAttachment:(id)a5;
...
- (id)displayTextForParagraphLink:(id)a0;
