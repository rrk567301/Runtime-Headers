...
+ (id)appURLForNote:(id)a0 contentOffsetY:(id)a1;
+ (id)appURLForNote:(id)a0 inFolder:(id)a1;
+ (id)appURLForNote:(id)a0 paragraphID:(id)a1;
...
+ (id)contentOffsetFromShowNoteURL:(id)a0;
