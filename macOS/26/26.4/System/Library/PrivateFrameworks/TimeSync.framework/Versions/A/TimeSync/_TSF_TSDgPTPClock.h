...
- (BOOL)pokeRemoteIPv6Destination:(id)a0 withDestinationAddress:(const char *)a1;
...
- (BOOL)setPreferredGM:(BOOL)a0 error:(id *)a1;
- (unsigned long long)timeSyncTimeFromgPTPTime:(id)a0;
- (BOOL)updateNtpAnchorOffset:(long long)a0 isLocalClockSourceFromNTP:(BOOL)a1 error:(id *)a2;
