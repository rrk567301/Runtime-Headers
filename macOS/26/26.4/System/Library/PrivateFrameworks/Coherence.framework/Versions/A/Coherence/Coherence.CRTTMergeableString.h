@class NSUUID, _TtC9Coherence11ObjCReplica, NSObject, _TtC9Coherence11ObjCVersion;

@interface _TtC9Coherence19CRTTMergeableString : NSObject {
    struct vector<Coherence_namespace::TopoSubstring *, std::allocator<Coherence_namespace::TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct { struct TopoSubstring **__cap_; } ; } _orderedSubstrings;
...
- (void)_apply:(id)a0 alwaysApply:(BOOL)a1;
- (BOOL)_canDeltaMergeRenamed:(id)a0 charMap:(void *)a1;
- (unsigned long long)_characterIndexForIndex:(id)a0;
- (void)addNewAddedByFor:(void *)a0;
- (void)addedRefsInRangesTo:(id)a0 newRange:(id /* block */)a1;
- (void)apply:(id)a0 skipRetain:(BOOL)a1 alwaysApply:(BOOL)a2;
...
- (unsigned long long)mergeWithString:(id)a0 optimized:(BOOL)a1 suggestedContext:(id)a2;
