@interface ChronoCore.DescriptorService : NSObject {
    void /* unknown type, empty encoding */ _activityDescriptorPublisher;
    void /* unknown type, empty encoding */ $__lazy_storage_$_activityDescriptorPublisher;
    void /* unknown type, empty encoding */ _widgetDescriptorPublisher;
    void /* unknown type, empty encoding */ $__lazy_storage_$_widgetDescriptorPublisher;
    void /* unknown type, empty encoding */ _controlDescriptorPublisher;
    void /* unknown type, empty encoding */ $__lazy_storage_$_controlDescriptorPublisher;
    void /* unknown type, empty encoding */ _combinedDescriptorPublisher;
    void /* unknown type, empty encoding */ $__lazy_storage_$_combinedDescriptorPublisher;
    void /* unknown type, empty encoding */ _extensionPublisher;
    void /* unknown type, empty encoding */ $__lazy_storage_$_extensionPublisher;
    ...
    void /* unknown type, empty encoding */ _queue_extensionsPendingRefetchWithLNMetadataChanged;
    void /* unknown type, empty encoding */ initialQueryTimerInterval;
    void /* unknown type, empty encoding */ queryTimerInterval;
    void /* unknown type, empty encoding */ suppressPublishingNotificationsForTesting;
    void /* unknown type, empty encoding */ queryTimerLeeway;
    void /* unknown type, empty encoding */ _queue_queryTimer;
    void /* unknown type, empty encoding */ _queue_retryIntentsTimer;
    void /* unknown type, empty encoding */ userInitiatedDiscoveryLeeway;
    void /* unknown type, empty encoding */ _queue_lastUserInitiatedDiscovery;
    void /* unknown type, empty encoding */ retryMissingAppIntentsTimerInterval;
}
