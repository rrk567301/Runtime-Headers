...
- (BOOL)isDark;
- (void).cxx_destruct;
- (struct ImageDisplayModel { id x0; id x1; id x2; id x3; id x4; id x5; id x6; struct CGPoint { double x0; double x1; } x7; struct CGSize { double x0; double x1; } x8; double x9; })_getJ700DisplayModelForOriginatingApp:(long long)a0;
