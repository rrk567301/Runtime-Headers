@class NSDate, NSString, LNActionExecutorPassthroughDelegate, LNProgressPropertySynchronizer, NSUUID, LNActionExecutorMetrics, LNActionExecutorOptions, LNAction, NSObject, NSProgress, LNActionMetadata, LNConnection;
...
- (void)dealloc;
- (void)cancelWithReason:(long long)a0;
