...
+ (BOOL)enumerateActionsWithConnection:(id)a0 bundleIdentifier:(id)a1 batchSize:(long long)a2 block:(id /* block */)a3 outError:(id *)a4;
+ (BOOL)enumerateEntitiesWithConnection:(id)a0 bundleIdentifier:(id)a1 batchSize:(long long)a2 block:(id /* block */)a3 outError:(id *)a4;
+ (BOOL)enumerateEnumsWithConnection:(id)a0 bundleIdentifier:(id)a1 batchSize:(long long)a2 block:(id /* block */)a3 outError:(id *)a4;
+ (BOOL)enumerateQueriesWithConnection:(id)a0 bundleIdentifier:(id)a1 batchSize:(long long)a2 block:(id /* block */)a3 outError:(id *)a4;
