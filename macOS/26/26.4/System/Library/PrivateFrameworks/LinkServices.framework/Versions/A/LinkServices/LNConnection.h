...
- (void)linkUndoManager:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)connectUsingListenerEndpoint:(id)a0 auditToken:(struct { unsigned int x0[8]; })a1;
- (BOOL)connectUsingProcessIdentifierWithOptions:(id)a0;
...
- (void)setIdleTimer;
- (void)setUpConnectionContextWithCompletionHandler:(id /* block */)a0;
- (BOOL)shouldRefreshWithOptions:(id)a0;
- (BOOL)targetBundleIsRunning;
