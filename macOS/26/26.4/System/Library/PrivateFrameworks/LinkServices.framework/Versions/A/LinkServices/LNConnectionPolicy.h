...
+ (id)policyWithActionMetadata:(id)a0 effectiveBundleIdentifier:(id)a1 appBundleIdentifier:(id)a2 processInstanceIdentifier:(id)a3 schemaVersion:(id)a4;
+ (id)policyWithActionMetadata:(id)a0 signals:(id)a1 schemaVersion:(id)a2;
...
+ (id)policyWithIntentSchemaTarget:(id)a0 signals:(id)a1 error:(id *)a2;
...
+ (void)resolveEffectiveBundleIdentifiers:(id)a0 allowedTargets:(id)a1 appBundleIdentifier:(id *)a2 extensionBundleIdentifier:(id *)a3 daemonBundleIdentifier:(id *)a4 frameworkBundleIdentifier:(id *)a5 signals:(id)a6;
