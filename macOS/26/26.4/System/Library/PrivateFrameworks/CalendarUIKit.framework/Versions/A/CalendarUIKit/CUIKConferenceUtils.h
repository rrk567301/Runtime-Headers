...
+ (unsigned long long)_buttonTypeForApplicationRecord:(id)a0 URL:(id)a1 isBroadcast:(BOOL)a2 isEventURL:(BOOL)a3;
...
+ (void)displayDetailsForURL:(id)a0 isEventURL:(BOOL)a1 completionHandler:(id /* block */)a2;
