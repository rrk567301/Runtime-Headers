...
+ (id)summaryStringForEventDateWithOptions:(int)a0 withEvent:(id)a1 withWideSpacing:(BOOL)a2 inTimeZone:(id)a3 useSmallCaps:(BOOL)a4 dropZeroMinutes:(BOOL)a5 font:(id)a6;
...
+ (id)_overlayDayOnlyStringForFormat:(id)a0 date:(id)a1 inCalendar:(id)a2;
+ (id)_significantLocaleComponents:(id)a0;
+ (id)_summaryStringForEventDate:(id)a0 startTimeZone:(id)a1 endDate:(id)a2 endTimeZone:(id)a3 isAllDay:(BOOL)a4 inTimeZone:(id)a5 options:(int)a6 withWideSpacing:(BOOL)a7 useSmallCaps:(BOOL)a8 dropZeroMinutes:(BOOL)a9 font:(id)a10;
...
+ (id)overlayDayNameStringForDate:(id)a0 inCalendar:(id)a1;
...
+ (id)overlayShortStringForDate:(id)a0 inCalendar:(id)a1 alwaysShowingDayNumber:(BOOL)a2;
+ (id)overlayYearStringForDate:(id)a0 inCalendar:(id)a1;
+ (id)summaryStringForEventDate:(id)a0 startTimeZone:(id)a1 endDate:(id)a2 endTimeZone:(id)a3 isAllDay:(BOOL)a4 inTimeZone:(id)a5 useSmallCaps:(BOOL)a6 dropZeroMinutes:(BOOL)a7 font:(id)a8;
