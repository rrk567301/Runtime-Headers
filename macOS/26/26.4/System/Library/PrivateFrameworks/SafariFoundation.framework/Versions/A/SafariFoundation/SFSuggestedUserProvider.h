...
- (id)_userNameFromSavedAccount:(id)a0;
...
- (void)suggestedUsersPrioritizingExistingUsersForURL:(id)a0 matchingText:(id)a1 limitForUsersNotFromURL:(unsigned long long)a2 completionHandler:(id /* block */)a3;
