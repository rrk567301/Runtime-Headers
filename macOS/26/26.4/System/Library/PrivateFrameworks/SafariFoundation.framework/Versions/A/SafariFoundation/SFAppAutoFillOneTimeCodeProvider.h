...
- (void).cxx_destruct;
- (void)test_setOverrideForAppIdentifier:(id)a0 associatedDomainEntriess:(id)a1;
- (id)_oneTimeCodesSortedByLastedUsedDateOfSavedAccount:(id)a0;
...
- (void)test_setOverrideForAppIdentifier:(id)a0 isWebBrowser:(BOOL)a1;
- (void)consumeCurrentOneTimeCode;
- (id)_mostRecentlyReceivedOneTimeCode;
- (id)_oneTimeCodesFromSavedAccounts:(id)a0 context:(id)a1;
