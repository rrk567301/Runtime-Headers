...
+ (void)_fetchPasswordCredentialIdentitiesMatchingDomains:(id)a0 withProxy:(id)a1 completion:(id /* block */)a2;
...
+ (BOOL)_isEnabledCredentialProviderAppID:(id)a0 enabledExtensions:(id)a1;
