...
+ (BOOL)registerContentsForOSModuleAtURL:(id)a0 options:(id)a1 error:(id *)a2;
+ (id)stagingLocationForInstallLocation:(id)a0 withSandboxExtension:(id *)a1 error:(id *)a2;
...
+ (BOOL)registerRootContentForBundles:(id)a0 options:(id)a1 error:(id *)a2;
...
+ (void)registerRootContentForBundles:(id)a0 options:(id)a1 completion:(id /* block */)a2;
...
+ (id)_temporaryStagingLocationForInstallLocation:(id)a0 withSandboxExtensionHandle:(long long *)a1 error:(id *)a2;
...
+ (id)fetchDuplicatedClassInfoWithError:(id *)a0;
...
+ (BOOL)unregisterRootContentForBundles:(id)a0 options:(id)a1 error:(id *)a2;
...
+ (void)unregisterRootContentForBundles:(id)a0 options:(id)a1 completion:(id /* block */)a2;
...
+ (BOOL)refreshContainersWithOptions:(id)a0 forApplicationIdentity:(id)a1 error:(id *)a2;
+ (void)revertAppWithBundleID:(id)a0 completion:(id /* block */)a1;
+ (BOOL)_validateInstallLocationForAppWithIdentity:(id)a0 intent:(unsigned long long)a1 error:(id *)a2;
...
+ (BOOL)setKnownOSModuleURLs:(id)a0 options:(id)a1 error:(id *)a2;
...
+ (id)unregisterContentsForOSModuleAtURL:(id)a0 options:(id)a1 error:(id *)a2;
...
- (BOOL)getHasDataImportPromises:(BOOL *)a0 error:(id *)a1;
...
- (id)dataImportPromisesWithError:(id *)a0;
...
- (BOOL)setDataImportPromises:(id)a0 error:(id *)a1;
...
- (BOOL)setPreserveTargetBundleNameOnUpdate:(BOOL)a0 error:(id *)a1;
