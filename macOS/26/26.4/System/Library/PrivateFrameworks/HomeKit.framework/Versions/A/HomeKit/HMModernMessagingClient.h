...
- (void).cxx_destruct;
- (id)logIdentifier;
- (void)_sendModernMessagingRequestWithMessageName:(id)a0 destination:(id)a1 requestPayload:(id)a2 options:(id)a3 responseHandler:(id /* block */)a4 completionHandler:(id /* block */)a5;
