@class _HMContext, HMFTimer, HMSoftwareUpdateDocumentationManager, NSMutableArray, NSString, NSError, HMApplicationData, HMELastEventStore, HMUserActionPredictionProvider, HMMigrationBoost, HMHome, NSArray, HMCurrentMediaGroupProvider, NSCountedSet, NSObject, HMAccessorySettingsMetricsDispatcher, HMMutableArray, NSOperationQueue, HMCacheManager, HMAccessorySetupCoordinator, HMWidgetManager, HMCoreAnalyticsMetricEventDispatcher, HMNetworkRouterFirewallRuleManager, HMHAPMetadata, _TtCE7HomeKitCSo13HMHomeManagerP33_97D41597F1FDBF41774F3917C3C3FEF715SwiftExtensions, HMAccessory, HMXPCEventRouterClient, HMUserCloudShareManager, NSUUID, HMHomeManagerConfiguration;
...
@property (readonly, nonatomic, getter=isInitialMergeComplete) BOOL initialMergeComplete;
...
@property (readonly, nonatomic) BOOL shouldPostHH2UpgradeRequired;
...
+ (BOOL)shouldDisableWiFiPickerBasedOnOSEligibility;
...
- (void)setShouldPostHH2UpgradeRequired:(BOOL)a0;
...
- (id)__loadMetadata;
- (void)__preconfigure;
- (void)__processSyncResponse:(id)a0 refreshRequested:(BOOL)a1;
...
- (void)_addHomeWithName:(id)a0 extraMessageArguments:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)_fetchHomeConfigurationWithRefreshRequested:(BOOL)a0 completion:(id /* block */)a1;
...
- (void)clearMobileAssetsLocalInfoAndPurgeLocalFiles:(BOOL)a0 completion:(id /* block */)a1;
...
- (void)dumpState:(id)a0 dataPrivacyLevel:(unsigned long long)a1 payload:(id)a2 completion:(id /* block */)a3;
...
- (id)eventRouter;
- (void)fetchAppleMediaAccessoryDiagnosticInfo:(id)a0 options:(unsigned long long)a1 completion:(id /* block */)a2;
- (void)fetchAppleMediaAccessoryDiagnosticInfo:(id)a0 options:(unsigned long long)a1 filteringKeyPaths:(id)a2 completion:(id /* block */)a3;
...
- (void)fetchHomeConfigurationWithCompletion:(id /* block */)a0;
- (void)fetchNetworkMismatchInfoWithCompletionHandler:(id /* block */)a0;
- (id)fetchPairingIdentitiesInRankOrder:(id)a0 error:(id *)a1;
- (void)findVendorAccessoryWithHAPPublicKey:(id)a0 completionHandler:(id /* block */)a1;
...
- (id)homeManagerForCurrentMediaGroupProvider:(id)a0;
...
- (void)postHH2UpdateRequiredCarPlayNotificationWithCompletion:(id /* block */)a0;
