@class NSObject, NSMutableDictionary, _HMContext, NSNotificationCenter, NSMapTable, NSUUID, NSString;
...
- (id)initWithContext:(id)a0 profileUniqueIdentifier:(id)a1 zoneName:(id)a2 home:(id)a3;
