@class HMCameraIndexingManager, NSString, HMCameraAudioControl, HMCameraStreamControl, HMCameraRecordingReachabilityEventManager, HMCameraClipManager, HMCameraUserSettings, HMCameraRecordingEventManager, _HMCameraProfile, HMCameraSettingsControl, HMCameraSnapshotControl;
