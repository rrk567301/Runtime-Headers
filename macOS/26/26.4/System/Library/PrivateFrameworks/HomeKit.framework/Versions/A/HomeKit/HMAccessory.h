...
@property (readonly, nonatomic, getter=isVendorAccessory) BOOL vendorAccessory;
...
- (BOOL)_mergeBulletinBoardNotificationByEndpoint:(id)a0 usingContext:(id)a1;
- (BOOL)_mergeControlTargetUUIDs:(id)a0 usingContext:(id)a1;
- (void)_mergeProfiles:(id)a0 usingContext:(id)a1;
- (BOOL)_mergeRemoteLoginHandler:(id)a0 usingContext:(id)a1;
- (BOOL)_mergeServices:(id)a0 usingContext:(id)a1;
...
- (BOOL)_updateHasSymptomsHandler:(BOOL)a0 context:(id)a1;
...
- (void)notifyDelegateOfAppDataUpdateForService:(id)a0 usingContext:(id)a1;
- (void)notifyDelegateOfAudioDestinationControllerUpdateUsingContext:(id)a0;
- (void)notifyDelegateOfAudioDestinationUpdateUsingContext:(id)a0;
- (void)notifyDelegateOfUpdatedServicesUsingContext:(id)a0;
- (void)notifyDelegateOfUpdatedWiFiNetworkInfoUsingContext:(id)a0;
- (void)notifyDelegateUpdatedPreferredMediaUserUsingContext:(id)a0;
- (void)notifyDelegateUpdatedSupportsJustSiriUsingContext:(id)a0;
- (void)notifyDelegateUpdatedSupportsMediaContentProfileUsingContext:(id)a0;
- (void)notifyDelegateUpdatedSupportsPreferredMediaUserUsingContext:(id)a0;
- (void)notifyDelegateUpdatedSupportsRMVonAppleTVUsingContext:(id)a0;
...
- (void)resetUARPDeviceWithCompletionHandler:(id /* block */)a0;
...
- (void)setVendorAccessory:(BOOL)a0;
- (id)siriEndpointIdentifier;
- (id)siriEndpointProfile;
- (id)softwareUpdateController;
- (id)stagingManagerForMediaDestinationController:(id)a0;
- (void)swiftInitWithCoder:(id)a0;
