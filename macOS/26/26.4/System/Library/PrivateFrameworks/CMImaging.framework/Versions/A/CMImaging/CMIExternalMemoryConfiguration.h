...
- (void).cxx_destruct;
- (id)description;
- (id)initWithMaxInputDimensions:(struct { int x0; int x1; })a0 inputPixelFormat:(unsigned int)a1 maxOutputDimensions:(struct { int x0; int x1; })a2 cmiResourceEnabled:(BOOL)a3 processorSpecificOptions:(id)a4;
