@class FigMetalExecutionStatus, NSString, MTLDeviceFeatureQueries, InterceptConfig, MTLArchitecture, NSArray, NSDictionary, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture;
