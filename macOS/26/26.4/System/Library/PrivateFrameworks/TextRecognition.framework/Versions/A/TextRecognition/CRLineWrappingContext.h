...
@interface CRLineWrappingContext : NSObject {
    struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; struct { unsigned int *__cap_; } ; } _contextTokens;
    BOOL _active;
    NSString *_text;
...
- (BOOL)classifierShouldInsertLineBreakForEvaluationResult:(id)a0 threshold:(float)a1 useThresholdOverride:(BOOL)a2;
...
- (struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; struct { unsigned int *x0; } x2; })tokenizeStringIntoWords:(id)a0;
