...
+ (void)setTestCollector:(id)a0;
+ (void)reportCoreAnalyticsExecutionStageForKey:(id)a0 executionStage:(unsigned long long)a1 error:(id)a2 count:(unsigned long long)a3;
