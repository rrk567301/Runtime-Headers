...
- (void).cxx_destruct;
- (id)init;
- (id)addNoiseToData:(id)a0 metadata:(id)a1 error:(id *)a2;
- (id)auditedMetadata:(id)a0;
- (id)initWithMaxCentralEpsilon:(double)a0 parameter:(id)a1;
- (BOOL)isDPMechanismNoneForMetadata:(id)a0;
- (id)pineParameterWithMetadata:(id)a0 error:(id *)a1;
- (id)randomizeFloatVector:(id)a0 metadata:(id)a1 error:(id *)a2;
- (id)randomizeFloatVectors:(id)a0 metadata:(id)a1 forKey:(id)a2 error:(id *)a3;
- (id)recordWithShardResult:(id)a0 noisedVector:(id)a1 metadata:(id)a2 key:(id)a3;
