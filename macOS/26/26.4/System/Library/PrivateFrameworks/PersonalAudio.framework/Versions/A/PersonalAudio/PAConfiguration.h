...
@property (nonatomic) BOOL audiogramValidForPSE;
...
- (struct { float x0; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; float x11; } x1; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; float x8; float x9; float x10; float x11; } x2; float x3; } *)transparencySettingsv4ForAddress:(id)a0;
