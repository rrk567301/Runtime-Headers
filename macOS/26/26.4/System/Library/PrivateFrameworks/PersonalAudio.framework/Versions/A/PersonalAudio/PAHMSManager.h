...
- (double)ownVoiceForAddress:(id)a0;
- (BOOL)ownVoiceSupportedForAddress:(id)a0;
- (BOOL)ppeEnrolledForAddress:(id)a0;
- (BOOL)ppeRegionSupportedForAddress:(id)a0;
- (BOOL)regionSupportedForHearingProtection:(id)a0;
- (BOOL)regionSupportsHearingAssistForAddress:(id)a0;
...
- (void)setOwnVoice:(double)a0 forAddress:(id)a1;
