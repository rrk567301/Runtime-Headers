...
@property (readonly, nonatomic) BOOL supportsHeySiri;
@property (readonly, nonatomic) BOOL supportsExternalSecureMute;
@property (nonatomic) BOOL externalSecureMute;
@property (readonly, nonatomic) BOOL supportsExternalVoiceActivityDetectEnable;
@property (nonatomic) BOOL externalVoiceActivityDetectEnable;
@property (nonatomic) BOOL externalVoiceActivityDetected;
...
@property (nonatomic, getter=isReferenceStreamEnabled) BOOL enableReferenceStream;
...
- (BOOL)externalVoiceActivityDetectionEnable;
- (id)headsetInfo;
- (int)hogModeOwner;
...
- (float)ioCycleUsage;
- (unsigned int)isolatedUseCaseID;
...
- (void)setEnableReferenceStream:(BOOL)a0;
- (void)setExternalVoiceActivityDetectionEnable:(BOOL)a0;
...
- (BOOL)supportsExternalVoiceActivityDetectionEnable;
