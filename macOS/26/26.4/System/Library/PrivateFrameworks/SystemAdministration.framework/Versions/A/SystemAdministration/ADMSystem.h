...
- (id)_createLocalAuthenticationRecoveryKey:(id)a0 password:(id)a1;
- (BOOL)_isRecoveryKeyUUID:(id)a0;
...
- (BOOL)_useLocalAuthenticationToTransferOwnershipWithOwner:(id)a0 uuid:(id)a1 password:(id)a2 currentSystemAdminCredential:(id)a3 existingSecureTokenCredential:(id)a4 error:(id *)a5;
- (BOOL)_useOpenDirectoryToTransferOwnershipWithOwner:(id)a0 uuid:(id)a1 password:(id)a2 currentSystemAdminCredential:(id)a3 existingSecureTokenCredential:(id)a4 error:(id *)a5;
