...
+ (BOOL)asyncRemoveDirectoryWithFileDescriptor:(int)a0 expectedUID:(long long)a1 delegate:(id)a2;
+ (BOOL)asyncSecurelyRemoveDirectoryWithFileDescriptor:(int)a0 expectedUID:(long long)a1 withOptions:(unsigned long long)a2 delegate:(id)a3;
