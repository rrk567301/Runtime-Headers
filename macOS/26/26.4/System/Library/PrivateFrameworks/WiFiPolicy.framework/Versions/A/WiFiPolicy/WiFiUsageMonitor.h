@class NSMutableDictionary, WiFiSoftError, WiFiUsageInterfaceStats, NSDate, NSDictionary, WiFiUsagePrivacyFilterSamplingRate, NSObject, WiFiUsageAccessPointProfile, WAMessage, NSMutableArray, NSString, WiFiUsageNetworkDetails, WiFiUsageRangingSession, NSArray, NSNumber;
...
- (void)setLinkEventWithIntegerReason:(BOOL)a0 isInvoluntary:(BOOL)a1 linkChangeReason:(long long)a2 linkChangeSubreason:(long long)a3 withNetworkDetails:(id)a4 forInterface:(id)a5;
...
- (void)setScanningState:(BOOL)a0 client:(unsigned long long)a1 neighborBSS:(id)a2 otherBSS:(id)a3 withChannelInfoList:(id)a4 withRequest:(id)a5 forInterface:(id)a6;
- (void)submitLqmToCA:(id)a0 forInterface:(id)a1;
- (void)addFaultEvent:(unsigned long long)a0 forInterface:(id)a1 at:(id)a2;
- (void)setTdLogic_fastTdState:(struct { unsigned long long x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; })a0 forInterface:(id)a1;
...
- (BOOL)submitBeaconInfoToCAForInterface:(id)a0;
...
- (void)addFaultEvent:(unsigned long long)a0 forInterface:(id)a1 event:(id)a2;
...
- (void)setJoinEvent:(BOOL)a0 withReason:(int)a1 lastDisconnectReason:(int)a2 lastJoinFailure:(long long)a3 andNetworkDetails:(id)a4 forInterface:(id)a5;
- (void)setTdLogic_cellularState:(struct { BOOL x0; BOOL x1; unsigned long long x2; unsigned long long x3; double x4; })a0 forInterface:(id)a1;
...
- (void)addFaultEvent:(unsigned long long)a0 forInterface:(id)a1 at:(id)a2 event:(id)a3;
...
- (void)setBluetoothState:(BOOL)a0 connectedDeviceCount:(unsigned long long)a1 inA2dp:(BOOL)a2 inSco:(BOOL)a3 inUniAoS:(BOOL)a4 inBiAoS:(BOOL)a5 btAudioBand:(BOOL)a6;
...
- (void)setLinkEvent:(BOOL)a0 isInvoluntary:(BOOL)a1 linkChangeReason:(int)a2 linkChangeSubreason:(long long)a3 withNetworkDetails:(id)a4 forInterface:(id)a5;
...
- (void)updateWithMLORuntimeConfig:(struct { unsigned long long x0; int x1[3]; int x2; BOOL x3; })a0 forInterface:(id)a1;
...
- (id)mapIORegistryEntryPathToCAFieldTransport:(id)a0;
...
- (void)notifyDriverAvailability:(id)a0 available:(BOOL)a1 version:(unsigned long long)a2 flags:(unsigned long long)a3 eventID:(unsigned long long)a4 reason:(long long)a5 subReason:(long long)a6 minorReason:(long long)a7 reasonString:(id)a8;
- (BOOL)shouldFilterSession:(unsigned long long)a0;
