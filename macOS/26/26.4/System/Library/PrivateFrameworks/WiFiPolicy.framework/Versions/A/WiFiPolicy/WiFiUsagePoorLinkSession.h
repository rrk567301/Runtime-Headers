@class WiFiSoftError, NSString, NSArray, NSDate, NSMutableArray, NSObject;
...
@interface WiFiUsagePoorLinkSession : WiFiUsageSession {
    ...
    BOOL _lastIsTimeSensitiveAppRunning;
    BOOL _lastIsAnyAppinFG;
    BOOL _isFirstTDConfirmed;
    BOOL _firstLQMForSessionReceived;
    BOOL _timerActive;
...
@property (nonatomic) BOOL isLastCellularStateValid;
...
@property (nonatomic) struct { unsigned long long fastTD_voteCount; BOOL fastTD_vote_recommendation; BOOL fastTD_vote_TxPER; BOOL fastTD_vote_BeaconPER; BOOL fastTD_vote_FWTxPER; BOOL fastTD_vote_HighLatency; BOOL fastTD_vote_2GPoorLink; BOOL fastTD_vote_2GDataStall; BOOL fastTD_vote_InsufficientRxFrames; BOOL fastTD_RTApp; BOOL fastTD_Cheap5G; } last_FastTdVotes;
@property (nonatomic) unsigned long long last_RSSIMode;
@property (nonatomic) struct { BOOL wifiPreferredOverCell; BOOL isCellularDataUsable; unsigned long long cellularWRMScore; unsigned long long cellularWRMScoreConfidence; double cellularWRMStateChangeTimestamp; } last_CellularState;
@property (nonatomic) BOOL rtAppAtFirstTDConfirmed;
@property (nonatomic) BOOL rtAppAtSessionEnd;
@property (nonatomic) BOOL fgAppAtFirstTDConfirmed;
@property (nonatomic) BOOL fgAppAtSessionEnd;
@property (nonatomic) BOOL cellularFallbackEnabledAtLinkDown;
@property (nonatomic) struct { BOOL wifiPreferredOverCell; BOOL isCellularDataUsable; unsigned long long cellularWRMScore; unsigned long long cellularWRMScoreConfidence; double cellularWRMStateChangeTimestamp; } cellularStateAtLinkDown;
@property (nonatomic) BOOL isCellularStateAtLinkDownValid;
...
@property (nonatomic) BOOL assertiveTdDisabled;
...
+ (id)describeWiFiUsageMonitor_tdCellularState:(struct { BOOL x0; BOOL x1; unsigned long long x2; unsigned long long x3; double x4; })a0;
...
+ (id)describeWiFiUsageMonitor_tdFastTDState:(struct { unsigned long long x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; })a0;
...
- (void)tdLogic_cellularState:(struct { BOOL x0; BOOL x1; unsigned long long x2; unsigned long long x3; double x4; })a0;
...
- (void)tdLogic_fastTdState:(struct { unsigned long long x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; })a0;
...
- (void)suspendTimer;
- (void)updateRxFrameImpactWith:(id)a0;
