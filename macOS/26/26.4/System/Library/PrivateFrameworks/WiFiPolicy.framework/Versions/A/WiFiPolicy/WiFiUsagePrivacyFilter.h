...
+ (short)waBandFromBand:(int)a0;
+ (unsigned long long)scalingFactorForSamplingRate:(id)a0;
...
+ (BOOL)canPerformActionWithRawSampleRate:(unsigned long long)a0;
...
+ (BOOL)canPerformActionWithDynamicBaseSampleRate:(id)a0;
