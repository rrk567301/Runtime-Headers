...
@interface SwiftMedia.PlayerViewModelAVPlayer : NSObject {
    ...
    void /* unknown type, empty encoding */ _subtitleLanguageOptions;
    void /* unknown type, empty encoding */ _subtitleStyleOptions;
    ...
    void /* unknown type, empty encoding */ __currentSubtitleLanguageOption;
    void /* unknown type, empty encoding */ __currentAudioOption;
    void /* unknown type, empty encoding */ __currentSubtitleStyleOption;
