...
@property (readonly, nonatomic) BOOL launchesBatchUI;
@property (readonly, nonatomic) BOOL launchesSurvey;
@property (readonly, nonatomic) BOOL launchesInbox;
...
@property (readonly, nonatomic) BOOL isShowContentItemAction;
...
+ (id)actionWithPathAndQueryParams:(id)a0;
