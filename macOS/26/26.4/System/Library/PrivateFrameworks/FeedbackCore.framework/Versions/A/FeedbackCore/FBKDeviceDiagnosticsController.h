@class NSString, NSArray, _TtC12FeedbackCore37FBKDeviceDiagnosticsControllerCombine, NSSet, FBKDeviceManager, FBKAttachmentManager, NSMutableDictionary, NSMutableSet, NSNumber;
...
- (id)initWithDeviceManager:(id)a0 delegate:(id)a1 filerForm:(id)a2 pendingFileUrls:(id)a3 pendingURLExtensions:(id)a4 draftDeviceIds:(id)a5 attachmentDescriptors:(id)a6 autoGathersDiagnosticExtensions:(BOOL)a7;
...
- (id)deviceDataForSubmissionWithFilerFormID:(long long)a0;
