...
- (long long)copyHistStatFromObject:(id)a0;
...
- (long long)getHistStatFromLayer:(struct __IOSurface { } *)a0 HDRMode:(unsigned int)a1 HDRProfile:(unsigned int)a2 transferFunction:(int)a3 temporalMode:(int)a4 iirAlpha:(float)a5 frameNumber:(unsigned long long)a6;
- (void)getSettingsFromDefaultsWrite;
- (unsigned long long)getSumHist;
- (void)mapBinFromNarrowRangeToFullRange;
- (long long)normalizeHistData:(unsigned int)a0 hdrProfile:(unsigned int)a1 transferFunction:(int)a2;
- (void)normalizeHistDataAndMapToPQForHLGInput:(int)a0;
- (void)normalizeHistDataForDoViInput:(int)a0;
...
- (void)setMasteringNits:(unsigned long long)a0 minMasteringNits:(float)a1;
- (void)setbufSize;
- (long long)temporalProcessHistStat:(long long)a0 iirAlpha:(float)a1;
- (BOOL)testpatchDetection:(unsigned int)a0;
