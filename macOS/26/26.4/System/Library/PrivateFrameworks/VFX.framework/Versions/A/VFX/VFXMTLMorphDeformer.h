...
- (void)dealloc;
- (void)createSparseIndicesBufferForMorphTarget:(struct { float x0; unsigned int x1; unsigned int x2; unsigned long long x3; unsigned long long x4; } *)a0 withSetupTarget:(struct { unsigned int x0; struct __CFXGeometry *x1; struct __CFXMeshSource *x2; struct __CFXMeshSource *x3; unsigned long long x4; } *)a1 indicesBuffer:(char *)a2 indicesBufferOffset:(unsigned long long)a3 indexSize:(unsigned long long)a4 originalToFirstDeindexedTable:(unsigned int *)a5 computeContext:(id)a6;
- (void)createVertexBufferForMorphTarget:(struct { float x0; unsigned int x1; unsigned int x2; unsigned long long x3; unsigned long long x4; } *)a0 withSetupTarget:(struct { unsigned int x0; struct __CFXGeometry *x1; struct __CFXMeshSource *x2; struct __CFXMeshSource *x3; unsigned long long x4; } *)a1 vertexBuffer:(char *)a2 vertexBufferOffset:(unsigned long long)a3 indicesBuffer:(char *)a4 indicesBufferOffset:(unsigned long long)a5 indexSize:(unsigned long long)a6 originalToFirstDeindexedTable:(unsigned int *)a7 computeContext:(id)a8;
