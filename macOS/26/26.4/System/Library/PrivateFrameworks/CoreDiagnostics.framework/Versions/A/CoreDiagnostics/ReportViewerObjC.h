...
+ (id)transformURL:(id)a0 template:(id)a1 options:(id)a2;
+ (BOOL)transformReport:(id)a0 templateString:(id)a1 header:(id)a2 report:(id)a3 error:(id *)a4 streamingBlock:(id /* block */)a5;
...
- (id)formatFrame:(id)a0 withImages:(id)a1 macosStyle:(BOOL)a2 showBinaryImage:(BOOL)a3;
- (BOOL)transformLines:(id)a0 withDefinitions:(id)a1 body:(id)a2 header:(id)a3 report:(id)a4 error:(id *)a5 streamingBlock:(id /* block */)a6;
