...
+ (id)groceryShoppingWithTitle:(id)a0 subtitle:(id)a1 heuristicName:(id)a2 predictionReasons:(unsigned long long)a3 localizedReason:(id)a4 score:(double)a5;
...
+ (id)suggestionWithAction:(id)a0 predictionReasons:(unsigned long long)a1 localizedReason:(id)a2 score:(double)a3 dateInterval:(id)a4 allowedOnLockscreen:(BOOL)a5 allowedOnHomeScreen:(BOOL)a6 allowedOnSpotlight:(BOOL)a7;
+ (id)_uiSpecWithTitle:(id)a0 subtitle:(id)a1 predictionReason:(id)a2 allowedOnLockscreen:(BOOL)a3 allowedOnHomeScreen:(BOOL)a4 allowedOnSpotlight:(BOOL)a5 shouldClearOnEngagement:(BOOL)a6 predictionReasons:(unsigned long long)a7 dateInterval:(id)a8;
...
+ (id)_suggestionWithAction:(id)a0 predictionReasons:(unsigned long long)a1 localizedReason:(id)a2 score:(double)a3 dateInterval:(id)a4 allowedOnLockscreen:(BOOL)a5 allowedOnHomeScreen:(BOOL)a6 allowedOnSpotlight:(BOOL)a7 shouldClearOnEngagement:(BOOL)a8;
