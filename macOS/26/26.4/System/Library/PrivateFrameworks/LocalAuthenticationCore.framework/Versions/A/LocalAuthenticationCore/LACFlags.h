...
@property (readonly, nonatomic) BOOL featureFlagAllowTouchIDLandscapeEnabled;
...
@property (readonly, nonatomic) BOOL featureFlagPresentationContextEnabled;
@property (readonly, nonatomic) BOOL featureFlagUserAuthDaemonEnabled;
...
@property (readonly, nonatomic) BOOL featureFlagDimpleKeyAutoEnablementEnabled;
...
@property (readonly, nonatomic) BOOL featureFlagDimpleKeyiPadTelemetryEnabled;
