...
+ (BOOL)_error:(id)a0 hasCode:(long long)a1 subcodeValue:(id)a2;
...
+ (id)errorWithCode:(long long)a0 subcode:(long long)a1 underlyingError:(id)a2 debugDescription:(id)a3;
