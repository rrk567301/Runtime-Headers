...
- (BOOL)createUserWithKeybag:(id)a0 credential:(id)a1 error:(id *)a2;
- (BOOL)createUserWithKeybag:(id)a0 salt:(id)a1 iterations:(unsigned long long)a2 credentialHash:(id)a3 error:(id *)a4;
...
- (BOOL)transferOwnershipFromAuthorizer:(id)a0 authorizerCredential:(id)a1 toExistingUser:(id)a2 existingUserCredential:(id)a3 disk:(id)a4 error:(id *)a5;
- (BOOL)transferOwnershipFromAuthorizer:(id)a0 authorizerCredential:(id)a1 toNewRecoveryKey:(id)a2 recoveryCredential:(id)a3 targetDisk:(id)a4 error:(id *)a5;
