...
@interface AFUISiriSession : NSObject <AFAssistantUIService, AFSpeechDelegate, SRUIFSiriSessionStateHandlerDelegate, SRUIFStateFeedbackManagerDelegate, SRUIFSpeechRequestHandlerDelegate, SRUIFAudioPowerLevelUpdaterDelegate, AFUISiriSession, SRUIFUIBridgeClientDelegate> {
    ...
    BOOL _isDialogPhasePossiblyPartOfMultiTurnRequest;
}
...
- (void)assistantConnection:(id)a0 replayAll:(unsigned long long)a1 with:(id)a2;
- (void)assistantConnection:(id)a0 replayAt:(unsigned long long)a1 with:(id)a2;
- (void)assistantConnection:(id)a0 requestFailedWithError:(id)a1 requestClass:(id)a2;
- (void)assistantConnection:(id)a0 setReplayEnabled:(BOOL)a1;
- (void)assistantConnection:(id)a0 setReplayOverridePath:(id)a1;
...
- (id)_genAITextDirectActionRequestWithUtterance:(id)a0;
- (void)_handlePhotoPickerRequest:(id)a0 completion:(id /* block */)a1;
- (void)_handleRequestUpdateViewsCommand:(id)a0;
- (void)_handleUnlockDeviceCommand:(id)a0;
- (long long)_mapSuggestionRequestType:(long long)a0;
...
- (id)_photoPickerDirectActionRequestWith:(id)a0 assetIdentifiers:(id)a1;
- (void)_populateInvocationEventWithTypeToSiriInvocationContext:(id)a0;
...
- (void)_startDirectRequestWith:(id)a0 completion:(id /* block */)a1;
- (void)_startGenAITextRequestWithUtterance:(id)a0 completion:(id /* block */)a1;
- (void)_startRequestWithBlock:(id /* block */)a0;
- (void)_startRequestWithFinalOptions:(id)a0;
- (void)_startRequestWithSuggestionText:(id)a0 turnIdentifier:(id)a1 suggestionRequestType:(long long)a2;
...
- (void)prewarmForPossibleTextRequest;
