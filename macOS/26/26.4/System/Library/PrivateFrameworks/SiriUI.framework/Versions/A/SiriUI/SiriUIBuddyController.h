...
@protocol SiriUIBuddyDelegate, UNNotificationOnboardingViewModel, SiriUIBuddyInteractingHost, SiriUIBuddySubviewController;
...
@property (readonly) BOOL gmOptedIn;
...
@property (readonly, weak) id<SiriUIBuddyInteractingHost> host;
