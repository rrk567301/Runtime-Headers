...
- (id)_handlePreviousConversationRestoration:(id)a0;
...
- (void)siriPresentation:(id)a0 shouldStartAnimatingStatusViewActivityIndicator:(BOOL)a1;
- (void)siriPresentation:(id)a0 showBugTemplateWithInformation:(id)a1;
- (void)siriPresentation:(id)a0 siriRequestCommittedFromSuggestion:(id)a1 suggestionRequestType:(long long)a2;
...
- (void)updateStatusViewHeight:(double)a0 textViewHeight:(double)a1;
