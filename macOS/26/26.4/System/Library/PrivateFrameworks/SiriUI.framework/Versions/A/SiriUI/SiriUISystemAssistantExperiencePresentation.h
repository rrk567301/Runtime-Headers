@class SiriUISystemAssistantExperienceViewController, NSString, SAUIFeedbackForm, NSUUID, SiriSharedUISAEViewModelController;
...
- (void)_activeConversationDidChangeWithMiniSnippetModel:(id)a0;
- (id)_activeRequestOptions;
- (void)_clearLatencyUtterance;
- (id)_conversationIdentifiers;
- (long long)_mapSuggestionRequestTypeToSASSuggestionRequestType:(long long)a0;
...
- (void)animateStatusViewActivityIndicator:(BOOL)a0;
...
- (void)previousConversationDidLoad:(id)a0 withMiniSnippetModel:(id)a1;
...
- (void)siriDidTransitionFromState:(long long)a0 toState:(long long)a1 event:(long long)a2;
