@class VTUITickMarkView, SUICOrbView, SSRVoiceProfile, SCDACoordinator, NSButton, SiriUICAPackageView, SUICIntelligentLightLayer, NSString, SSRVTUITrainingManager, NSTimer, _TtC6SiriUI21GMEnrollmentViewModel, VTUIPagedLabel, NSArray, _TtC6SiriUI26GMEnrollmentViewController, AVAudioPlayer, NSTextField, NSUUID;
@protocol VTUITrainingViewControllerDelegate;

@interface VTUITrainingViewController : NSViewController <SSRVTUITrainingManagerDelegate, SCDADelegate> {
