...
@interface _NUImage : NSObject <NUImage, NUMutableImage, NUImageCopying, NUPurgeableImage, NUMutablePurgeableImage> {
    ...
    struct vector<unsigned char, std::allocator<unsigned char>> { char *__begin_; char *__end_; struct { char *__cap_; } ; } _accessCount;
}
...
- (id)initWithLayout:(id)a0 format:(id)a1 colorSpace:(id)a2 headroom:(float)a3 tileFactory:(id)a4;
- (id)mutableImageCopy;
