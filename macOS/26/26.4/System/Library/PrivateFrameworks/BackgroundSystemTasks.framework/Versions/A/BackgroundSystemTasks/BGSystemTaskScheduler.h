...
@property (nonatomic) BOOL clampToBGQoS;
@property (retain, nonatomic) _DASScheduler *scheduler;
@property (nonatomic) BOOL isInternalVariant;
...
- (id)suspensionThresholdForTask:(id)a0;
