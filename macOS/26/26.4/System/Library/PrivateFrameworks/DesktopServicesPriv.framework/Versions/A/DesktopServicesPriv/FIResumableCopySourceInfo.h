...
+ (id)newInfoWithSourceURLInfo:(const void *)a0;
...
- (BOOL)isSuspendedCopyOfSourceURLInfo:(const void *)a0 checkpointTime:(double *)a1;
- (BOOL)writeToTarget:(const void *)a0 useCheckpoints:(BOOL *)a1;
