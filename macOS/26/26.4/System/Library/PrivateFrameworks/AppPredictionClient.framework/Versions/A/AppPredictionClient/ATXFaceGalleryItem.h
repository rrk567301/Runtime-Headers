...
- (id)initWithIdentifier:(id)a0 descriptorIdentifier:(id)a1 extensionBundleIdentifier:(id)a2 containerBundleIdentifier:(id)a3 localizedDisplayName:(id)a4 modeSemanticType:(id)a5 titleFontName:(id)a6 titleColor:(id)a7 subtitleComplication:(id)a8 layoutType:(long long)a9 complications:(id)a10 landscapeComplications:(id)a11;
