...
- (void)_writeHomeScreenPageConfigurations:(id)a0 forClientWithIdentifier:(id)a1 guardedData:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)setActivePersonaWithClientIdentifier:(id)a0;
...
- (void)writeHomeScreenPageConfigurations:(id)a0 forClientWithIdentifier:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)loadHomeScreenPageConfigurationsForClientWithIdentifier:(id)a0 completionHandler:(id /* block */)a1;
