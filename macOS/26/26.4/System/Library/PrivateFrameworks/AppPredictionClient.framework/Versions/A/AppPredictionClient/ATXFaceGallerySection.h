...
- (id)initWithLocalizedTitle:(id)a0 symbolImageName:(id)a1 symbolColorName:(id)a2 localizedSubtitle:(id)a3 localizedDescriptiveText:(id)a4 associatedAppBundleIdentifier:(id)a5 unityDescription:(id)a6 type:(long long)a7 items:(id)a8 semanticType:(long long)a9;
- (void).cxx_destruct;
- (id)json;
