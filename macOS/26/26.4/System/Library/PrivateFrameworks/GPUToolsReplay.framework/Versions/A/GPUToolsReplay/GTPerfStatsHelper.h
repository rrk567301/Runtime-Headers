...
@interface GTPerfStatsHelper : NSObject {
    ...
    struct vector<GTPerfStateGroup, std::allocator<GTPerfStateGroup>> { struct GTPerfStateGroup *__begin_; struct GTPerfStateGroup *__end_; struct { struct GTPerfStateGroup *__cap_; } ; } _perfStateGroups;
