@class NSData, NSString, AMSDelegatePurchaseRequest, CPSSystemAuthenticationRequest, CPSRestrictedAccessRequest, CPSTVProviderRequest, NSDictionary, PKPaymentRequest, ACAccount, CPSPhotosConfigurationRequest, CPSStoreAuthenticationRequest;
