...
- (BOOL)startTranscriptionForPID:(int)a0 appID:(id)a1 appName:(id)a2 excludingPIDs:(id)a3 locale:(id)a4 error:(id *)a5;
- (BOOL)startTranscriptionWithLocale:(id)a0 error:(id *)a1;
- (BOOL)stopTranscription:(id *)a0;
- (BOOL)stopTranscriptionForPID:(int)a0 error:(id *)a1;
