@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCFeedPersonalizedItemScoreProfile, FCColor, FCContentArchive, NTPBRecipeRecord, FCHeadlineThumbnail, NSString, FCContentManifest, FCInterestToken, NSArray, NSData, NSNumber, FCAssetHandle;
...
@property (readonly, nonatomic) BOOL isBakingRecipe;
@property (readonly, nonatomic) BOOL isCocktailRecipe;
...
- (void)_setMockRatingsWithAverage:(double)a0 oneStarCount:(long long)a1 twoStarCount:(long long)a2 threeStarCount:(long long)a3 fourStarCount:(long long)a4 fiveStarCount:(long long)a5;
...
- (id)initWithRecipeRecord:(id)a0 sourceChannel:(id)a1 articles:(id)a2 assetManager:(id)a3 interestToken:(id)a4 appConfiguration:(id)a5;
