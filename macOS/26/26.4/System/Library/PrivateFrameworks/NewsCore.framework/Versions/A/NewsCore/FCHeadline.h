...
@protocol FCNativeAdProviding, FCSportsEventProviding, FCHeadlineStocksFields, FCHeadlineMetadata, FCChannelProviding;
...
@property (nonatomic, getter=isAIGenerated) BOOL aiGenerated;
...
@property (readonly, nonatomic) BOOL liveCoverageCompleted;
