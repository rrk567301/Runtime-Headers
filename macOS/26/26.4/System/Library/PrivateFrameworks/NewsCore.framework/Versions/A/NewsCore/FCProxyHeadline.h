...
@protocol FCNativeAdProviding, FCSportsEventProviding, FCHeadlineProviding, FCHeadlineStocksFields, FCHeadlineMetadata, FCChannelProviding;
...
@property (readonly, nonatomic, getter=isAIGenerated) BOOL aiGenerated;
