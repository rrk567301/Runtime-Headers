@class FCNewsPlusLabelConfigGroup, NSDictionary, FCSportsPrivacyConfiguration, FCTimesOfDayConfiguration, FCTopStoriesConfiguration, NTPBDiscoverMoreVideosInfo, FCPaidBundleViaOfferConfig, FCPersonalizationPublisherDampeningConfig, FCArticleLinkBehaviorConfig, FCFeaturePromotionResourceConfiguration, FCWidgetConfig, NSData, FCSportsFavoritesSyncModalConfig, NFLazy, FCEmbedProxyConfiguration, FCAppReviewRequestConfig, FCTipConfig, NSNumber, FCVideoGroupsConfig, FCSportsUpsellConfig, FCPuzzlesConfiguration, FCNewsPersonalizationConfiguration, FCStatelessPersonalizationPublisherFavorability, NSArray, FCPrefetchConfiguration, FCSmarterMessagingConfig, NSString, FCOfflineDownloadsConfiguration, FCIAdConfiguration, FCNewsTabiConfiguration, FCNotificationsConfiguration, FCLocationSharingUpsellConfig, FCPaidBundleConfiguration, FCPeopleAlsoReadConfiguration, FCArticleModalBrandBarConfig, FCForYouGroupsConfiguration, FCLaunchPresentationConfig;
...
@property (readonly, nonatomic) BOOL isSportsEventOpenInTVSupported;
...
@property (readonly, nonatomic) BOOL useNotificationsV2;
@property (readonly, nonatomic) BOOL useWelcomeSeries;
@property (readonly, nonatomic) BOOL useSearchInArticle;
...
@property (readonly, nonatomic) BOOL configurableOffersEnabled;
@property (readonly, nonatomic) BOOL localOnboardingEnabled;
@property (readonly, nonatomic) BOOL featurePromotionEnabled;
@property (readonly, nonatomic) BOOL fineGrainedNewsletterManagementEnabled;
@property (readonly, nonatomic) BOOL offlineModeEnabled;
@property (readonly, nonatomic) BOOL dimNonSubscriberContentOffline;
...
@property (readonly, nonatomic) BOOL localOnboardingManagementAutoPresentation;
...
@property (readonly, nonatomic) BOOL isTodaySponsorshipEligible;
...
@property (readonly, nonatomic) BOOL foregroundHeartbeatEventEnabled;
@property (readonly, nonatomic) BOOL foregroundHeartbeatEventShouldUseQueue;
...
@property (readonly, nonatomic) BOOL inFeedDebugging;
...
@property (readonly, nonatomic) BOOL foodEnabled;
@property (readonly, nonatomic) BOOL recipeHistoryFeedEnabled;
@property (readonly, nonatomic) BOOL cookingEnhancementsEnabled;
@property (readonly, nonatomic) BOOL recipeUnitConversionEnabled;
@property (readonly, nonatomic) BOOL multipartRecipesEnabled;
@property (readonly, nonatomic) BOOL recipeRatingsEnabled;
@property (readonly, nonatomic) BOOL ingredientScalingEnabled;
@property (readonly, nonatomic) BOOL recipeNotesEnabled;
@property (readonly, nonatomic) BOOL imagesInStepsEnabled;
@property (readonly, nonatomic) BOOL nutritionInfoEnabled;
...
@property (readonly, nonatomic) BOOL enableNewsPersonalizationAutoFavorites;
@property (readonly, nonatomic) BOOL enableTabiTagScoring;
@property (readonly, nonatomic) BOOL enableTabiAdSegments;
@property (readonly, nonatomic) BOOL enableTabiCohortMemberships;
@property (readonly, nonatomic) BOOL enableTabiMyMagazinesPersonalization;
@property (readonly, nonatomic) BOOL aggregatesInAppXavierEnabled;
@property (readonly, nonatomic) BOOL aggregatesInNotificationExtensionXavierEnabled;
@property (readonly, nonatomic) BOOL tabiScoringInNotificationExtensionEnabled;
@property (readonly, nonatomic) BOOL aggregatesInWidgetsXavierEnabled;
@property (readonly, nonatomic) BOOL tabiScoringInWidgetsEnabled;
@property (readonly, nonatomic) BOOL widgetForYouFromDaemonEnabled;
@property (readonly, nonatomic) BOOL todayWidgetForYouBestOfEnabled;
...
@property (readonly, nonatomic) BOOL tabiBackgroundRefreshEnabled;
@property (readonly, nonatomic) NSString *recipeRecirculationConfigJSON;
@property (readonly, nonatomic) BOOL shouldIncludeRecipePersonalizationScienceData;
...
@property (readonly, nonatomic) BOOL isSmarterFetchEnabledForESL;
@property (readonly, nonatomic) BOOL isSmarterFetchEnabledForLatest;
@property (readonly, nonatomic) BOOL isSmarterFetchEnabledForSupplementalESL;
@property (readonly, nonatomic) BOOL isSmarterFetchEnabledForSupplementalLatest;
...
@property (readonly, nonatomic) BOOL blockingConfirmationDialogEnabled;
...
@property (readonly, nonatomic) BOOL privateDataShouldCleanupAfterSecureSubscriptions;
@property (readonly, nonatomic, getter=isPrivateDataEncryptionRequired) BOOL privateDataEncryptionRequired;
@property (readonly, nonatomic) BOOL privateDataShouldMigrateToV4;
@property (readonly, nonatomic) BOOL privateDataShouldCleanupToV4;
...
@property (readonly, nonatomic) BOOL treatmentIDAdDonationEnabled;
...
@property (readonly, nonatomic) BOOL widgetBackgroundInteractionEnabled;
@property (readonly, nonatomic) BOOL widgetFetchOfTodayFeedLiteConfigEnabled;
