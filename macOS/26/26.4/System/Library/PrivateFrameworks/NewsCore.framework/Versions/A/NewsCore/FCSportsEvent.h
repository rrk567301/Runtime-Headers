@class NTPBSportsEventRecord, FCSectionSupergroupKnobs, NSDate, NSDictionary, FCContentArchive, NTPBPublisherPaidDescriptionStrings, FCColor, FCPaywallConfiguration, FCContentManifest, NSString, FCInterestToken, FCSportsEventLiveStreamVideo, FCSportsRecommendationMappings, NSArray, NSData, FCAssetHandle;
...
@property (readonly, nonatomic) BOOL sponsoredFeedEligible;
@property (readonly, nonatomic) BOOL allowsRecipes;
...
@property (readonly, nonatomic) BOOL isFoodTopic;
@property (readonly, nonatomic) BOOL isFoodHub;
@property (readonly, nonatomic) BOOL isRecipeCatalog;
@property (readonly, nonatomic) BOOL isSearchHub;
@property (readonly, nonatomic) BOOL isLocalHub;
@property (readonly, nonatomic) BOOL hasEvergreenArticleList;
@property (readonly, nonatomic) BOOL hasRecipeList;
@property (readonly, nonatomic) BOOL hasRecipes;
...
+ (BOOL)_useLiveStreamVideoOverrides;
+ (BOOL)isSportsEventIdentifier:(id)a0;
...
- (id)authorizationURL;
- (void)_inflateSportsDataFromJSONDictionary:(id)a0 sportsEventRecord:(id)a1 assetManager:(id)a2;
