@class FCReadingList, FCUserInfo, FCTagSettings, FCPrivateChannelMembershipController, FCPuzzleTypeSettings, FCReadingHistory, FCRecipeUserEventHistory, NSString, FCIssueReadingHistory, FCSubscriptionList, FCPuzzleHistory, FCUserEventHistory, FCAudioPlaylist, FCShortcutList;
