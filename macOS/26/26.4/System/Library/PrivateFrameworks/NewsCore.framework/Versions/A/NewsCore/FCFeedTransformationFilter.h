...
+ (id)transformationWithFilterOptions:(unsigned long long)a0 otherArticleIDs:(id)a1 otherClusterIDs:(id)a2 subscribedTagIDs:(id)a3 mutedTagIDs:(id)a4 ignoredTagIDs:(id)a5 readingHistoryItems:(id)a6 playlistArticleIDs:(id)a7 downloadedArticleIDs:(id)a8 briefingsTagID:(id)a9 paidAccessChecker:(id)a10 bundleSubscription:(id)a11 paywalledArticlesMaxCount:(unsigned long long)a12;
+ (id)transformationWithFilterOptions:(unsigned long long)a0 configuration:(id)a1 context:(id)a2 ignoreMutedTagIDs:(id)a3;
+ (id)transformationWithFilterOptions:(unsigned long long)a0 configuration:(id)a1 context:(id)a2 otherArticleIDs:(id)a3 otherClusterIDs:(id)a4;
