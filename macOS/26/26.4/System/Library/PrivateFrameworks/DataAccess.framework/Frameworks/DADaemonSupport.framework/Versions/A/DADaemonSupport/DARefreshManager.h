@class NSMutableDictionary, APSConnection, NSMutableSet, NSDate, NSObject;
...
@property (class, readonly) DARefreshManager *sharedManager;
...
- (void)_schedulePushRefreshWithDeadline:(id)a0;
- (void)_tearDownAPS;
- (void)_tearDownAllApsConnections;
- (void)delegateDidSuccessfullyRecoverFromBeingUnauthenticated:(id)a0;
- (void)handlePushRefreshTask:(id)a0;
- (void)wrapperPushRegistrationFinished:(id)a0;
