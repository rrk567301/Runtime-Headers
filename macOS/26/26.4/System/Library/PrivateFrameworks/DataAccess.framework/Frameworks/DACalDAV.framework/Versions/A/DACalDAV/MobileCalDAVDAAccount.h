@class NSURL, NSDictionary, DATrustHandler, DACoreDAVTaskManager, NSString, NSSet, DALocalDBHelper, MobileCalDAVAccount, DAAccount, CoreDAVDiscoveryTaskGroup, NSData, DAStatusReport, DACoreDAVLogger;
