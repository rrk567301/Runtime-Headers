@class NSURL, NSMutableDictionary, NSDictionary, NSString, NSSet, CalDAVRefreshContext, MobileCalDAVAccount, NSMutableSet, AKAppleIDSession, NSArray, NSData, NSNumber, NSDateComponents;
...
- (void)completeWithError:(id)a0 httpMethod:(id)a1 latency:(double)a2 task:(id)a3 responseStatusCode:(long long)a4;
