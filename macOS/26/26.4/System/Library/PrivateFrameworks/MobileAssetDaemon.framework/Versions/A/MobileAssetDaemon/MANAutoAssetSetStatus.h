...
@property (nonatomic) BOOL latestDownloadedAtomicInstanceFromFactoryPreinstalled;
...
@property (readonly, retain, nonatomic) NSString *previouslyVendedLockedAtomicInstance;
...
+ (id)shortTermLockDirectory:(id)a0 forAssetSetIdentifier:(id)a1;
...
- (id)initStatusForClientDomain:(id)a0 forAssetSetIdentifier:(id)a1 withConfiguredAssetEntries:(id)a2 withAtomicInstancesDownloaded:(id)a3 withCatalogCachedAssetSetID:(id)a4 withCatalogDownloadedFromLive:(id)a5 withCatalogLastTimeChecked:(id)a6 withCatalogPostedDate:(id)a7 withNewerAtomicInstanceDiscovered:(id)a8 withNewerDiscoveredAtomicEntries:(id)a9 withLatestDownloadedAtomicInstance:(id)a10 withLatestDownloadedAtomicInstanceFromPreSUStaging:(BOOL)a11 withLatestDownloadedAtomicInstanceFromFactoryPreinstalled:(BOOL)a12 withLatestDownloadedAtomicInstanceStagedFromOSBuild:(id)a13 withLatestDowloadedAtomicInstanceEntries:(id)a14 withDownloadedCatalogCachedAssetSetID:(id)a15 withDownloadedCatalogDownloadedFromLive:(id)a16 withDownloadedCatalogLastTimeChecked:(id)a17 withDownloadedCatalogPostedDate:(id)a18 withCurrentNotifications:(id)a19 withCurrentNeedPolicy:(id)a20 withSchedulerPolicy:(id)a21 withStagerPolicy:(id)a22 havingReceivedLookupResponse:(BOOL)a23 vendingAtomicInstanceForConfiguredEntries:(BOOL)a24 withDownloadUserInitiated:(BOOL)a25 withDownloadProgress:(id)a26 withDownloadedNetworkBytes:(long long)a27 withDownloadedFilesystemBytes:(long long)a28 withCurrentLockUsage:(id)a29 withSelectorsForStaging:(id)a30 withAvailableForUseError:(id)a31 withNewerVersionError:(id)a32;
