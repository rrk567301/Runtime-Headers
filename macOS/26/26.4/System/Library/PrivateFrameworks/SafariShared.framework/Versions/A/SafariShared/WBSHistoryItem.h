...
@interface WBSHistoryItem : NSObject {
    int _visitCount;
    struct unique_ptr<WBSHistoryItemVisitCountScoresStorage, std::default_delete<WBSHistoryItemVisitCountScoresStorage>> { struct { struct WBSHistoryItemVisitCountScoresStorage *__ptr_; } ; } _visitCountScores;
...
- (void)updateLastVisit:(id /* block */)a0;
