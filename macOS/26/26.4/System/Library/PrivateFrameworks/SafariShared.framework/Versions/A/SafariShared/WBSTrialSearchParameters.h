...
@property (readonly, nonatomic) BOOL enableRecentSearchSortingByVisitCountScore;
@property (readonly, nonatomic) BOOL enableRecentSearchSortingUsingExponentialWeighting;
