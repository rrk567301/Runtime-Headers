...
- (BOOL)_didCertificateExceptionsApplySuccessfully:(id)a0 protectionSpace:(id)a1;
...
- (BOOL)didInvalidCertificateExceptionsApplySuccessfullyForURL:(id)a0 trust:(struct __SecTrust { } *)a1 inPrivateBrowsing:(BOOL)a2;
