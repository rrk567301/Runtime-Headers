...
- (id)_frequencyValueForWebSearchEntry:(id)a0 useExponentialWeighting:(BOOL)a1;
...
- (void)computeSortedRecentWebSearches:(id)a0 useExponentialWeighting:(BOOL)a1 completionHandler:(id /* block */)a2;
