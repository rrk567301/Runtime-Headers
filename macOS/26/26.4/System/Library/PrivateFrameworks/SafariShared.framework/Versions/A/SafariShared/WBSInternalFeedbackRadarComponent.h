...
@property (class, readonly, copy, nonatomic) WBSInternalFeedbackRadarComponent *authenticationExperienceNewBugs;
@property (class, readonly, copy, nonatomic) WBSInternalFeedbackRadarComponent *webAccessibility;
