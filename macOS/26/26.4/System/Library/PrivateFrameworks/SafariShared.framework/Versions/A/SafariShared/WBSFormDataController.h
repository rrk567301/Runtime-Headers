...
+ (BOOL)_fieldWithValueIsEligibleForOneTimeCodeAutoFill:(id)a0;
+ (BOOL)_password:(id)a0 appearsToBeAHashOfExistingPassword:(id)a1;
...
- (id)init;
- (void)dealloc;
- (id)extractUserNameFromForm:(id)a0 atURL:(id)a1 inContext:(id)a2 updateLastUsedUserName:(BOOL)a3;
- (id)matchesForControl:(id)a0 atURL:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a4;
- (id)metadataOfActiveFormOrBestFormForPageLevelAutoFill:(id)a0 frameHandle:(id *)a1;
...
- (BOOL)_hasAutoFillEventMatchingCriteria:(id)a0;
...
- (id)_matchesForControl:(id)a0 inDomain:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 preferredLabel:(id)a4 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a5;
- (id)_matchesForControl:(id)a0 inDomain:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 preferredLabel:(id)a4 contact:(id)a5 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a6;
...
- (void)_processMatchesArray:(id)a0 autoFillSetKey:(id)a1 autoFillSet:(id)a2 madeChanges:(BOOL *)a3;
...
- (id)bestMatchForControl:(id)a0 inDomain:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 preferredLabel:(id)a4 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a5;
- (id)bestMatchForControl:(id)a0 inDomain:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 preferredLabel:(id)a4 contact:(id)a5 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a6;
...
- (BOOL)canShowSavedAccountHistoryItemInTabWithID:(id)a0 currentURL:(id)a1;
...
- (void)didFillPasswordForUsername:(id)a0 password:(id)a1 fromProviderWithApplicationBundleIdentifier:(id)a2 providerExtensionBundleIdentifier:(id)a3 inTabWithID:(id)a4 currentURL:(id)a5 isPrivate:(BOOL)a6 formMetadata:(id)a7 requester:(id)a8;
...
- (id)extractPasswordFromForm:(id)a0 shouldPreferAnnotatedCredentials:(BOOL)a1;
- (id)extractUserNameFromForm:(id)a0 atURL:(id)a1 inContext:(id)a2;
...
- (id)identiferToLastUsedDateMapForContact:(id)a0;
...
- (id)matchesForControl:(id)a0 atURL:(id)a1 matchingPartialString:(id)a2 autoFillDataType:(unsigned long long)a3 contact:(id)a4 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a5;
...
- (id)metadataOfBestFormForStreamlinedLogin:(id)a0 frameHandle:(id *)a1;
...
- (BOOL)textFieldIsEligibleForAutomaticStrongPassword:(id)a0 form:(id)a1 ignorePreviousDecision:(BOOL)a2;
...
- (id)valuesForStandardForm:(id)a0 inDomain:(id)a1 autoFillDataType:(unsigned long long)a2 matches:(id *)a3 preferredLabel:(id)a4 multiRoundAutoFillManager:(id)a5;
- (id)valuesForStandardForm:(id)a0 inDomain:(id)a1 autoFillDataType:(unsigned long long)a2 matches:(id *)a3 preferredLabel:(id)a4 multiRoundAutoFillManager:(id)a5 contact:(id)a6 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)a7;
