...
- (void)clearAllHistoryInsertingTombstoneUpToDate:(id)a0 clearAllSpotlightHistoryForProfile:(BOOL)a1 tombstoneAttributes:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (void)clearHistoryItems:(id)a0 afterDate:(id)a1 beforeDate:(id)a2 tombstoneMode:(unsigned long long)a3 tombstoneAttributes:(unsigned long long)a4 completionHandler:(id /* block */)a5;
- (void)clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 tombstoneAttributes:(unsigned long long)a3 clearAllSpotlightHistoryForProfile:(BOOL)a4 completionHandler:(id /* block */)a5;
