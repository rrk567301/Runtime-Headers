...
@protocol OS_dispatch_queue, OS_dispatch_group, WBSFileLock;
...
- (id)_clearAllHistoryInsertingTombstoneUpToDate:(id)a0 udid:(id)a1 tombstoneAttributes:(unsigned long long)a2 clearAllSpotlightHistoryForProfile:(BOOL)a3;
- (id)_clearHistoryItems:(id)a0 afterDate:(id)a1 beforeDate:(id)a2 tombstoneMode:(unsigned long long)a3 udid:(id)a4 tombstoneAttributes:(unsigned long long)a5;
- (void)_clearHistoryItems:(id)a0 afterDate:(id)a1 beforeDate:(id)a2 tombstoneMode:(unsigned long long)a3 udid:(id)a4 tombstoneAttributes:(unsigned long long)a5 completionHandler:(id /* block */)a6;
- (id)_clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 udid:(id)a3 tombstoneAttributes:(unsigned long long)a4 clearAllSpotlightHistoryForProfile:(BOOL)a5;
- (void)_clearHistoryVisitsAddedAfterDate:(id)a0 beforeDate:(id)a1 tombstoneMode:(unsigned long long)a2 udid:(id)a3 tombstoneAttributes:(unsigned long long)a4 clearAllSpotlightHistoryForProfile:(BOOL)a5 completionHandler:(id /* block */)a6;
...
- (id)_executePlan:(void *)a0 outDeletedItemCount:(unsigned long long *)a1 outDeletedVisitCount:(unsigned long long *)a2 clearAllSpotlightHistoryForProfile:(BOOL)a3;
...
- (id)_insertTombstonesForURLs:(id)a0 afterDate:(id)a1 beforeDate:(id)a2 tombstoneMode:(unsigned long long)a3 udid:(id)a4 attributes:(unsigned long long)a5;
...
- (id)_metadataObjectOfClass:(Class)a0 forKey:(id)a1 error:(id *)a2;
...
- (void)importVisits:(id)a0 desiredVisitTimePrecision:(unsigned long long)a1 completionHandler:(id /* block */)a2;
- (id)initWithID:(id)a0 url:(id)a1 options:(id)a2 fileOperationGroup:(id)a3 lock:(id)a4 error:(id *)a5;
