...
- (void)_removeItems:(id)a0 count:(int)a1;
- (void)_removeItemsInResponseToUserAction:(id)a0 tombstoneAttributes:(unsigned long long)a1 completionHandler:(id /* block */)a2;
- (void)_removeMultipleItemsFromStringsForUserTypedDomainExpansion:(id)a0;
...
- (void)clearHistoryWithTombstoneAttributes:(unsigned long long)a0 completionHandler:(id /* block */)a1;
...
- (void)removeItemsInResponseToUserAction:(id)a0 tombstoneAttributes:(unsigned long long)a1;
- (void)removeItemsInResponseToUserAction:(id)a0 tombstoneAttributes:(unsigned long long)a1 completionHandler:(id /* block */)a2;
