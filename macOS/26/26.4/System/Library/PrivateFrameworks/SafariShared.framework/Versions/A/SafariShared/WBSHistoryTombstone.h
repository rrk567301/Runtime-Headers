...
- (id)initWithDictionary:(id)a0 origin:(unsigned long long)a1;
- (id)initWithSQLiteRow:(id)a0 crypto:(id)a1;
- (id)initWithURLString:(id)a0 urlHash:(id)a1 urlSalt:(id)a2 startTime:(double)a3 endTime:(double)a4 generation:(long long)a5 udid:(id)a6 attributes:(unsigned long long)a7;
