...
+ (void)cleanupOrphanedFilesInDirectory:(id)a0 matchingPattern:(id)a1;
...
+ (BOOL)isHypotheticalAudioRouteBluetoothAndNotBTSpeakerFromAudioSessinoId:(unsigned int)a0;
...
+ (BOOL)useEnhancedSpeechEnrollmentFlow;
+ (BOOL)isVoiceRepairEnabled;
...
+ (void)_clearLogFilesInDirectory:(id)a0 matchingPattern:(id)a1 exceedNumber:(unsigned long long)a2 outError:(id *)a3;
...
+ (BOOL)checkCurrentProcessHasEntitlement:(id)a0;
+ (BOOL)checkEntitlementForToken:(struct { unsigned int x0[8]; })a0 withEntitlement:(id)a1;
+ (void)clearLogFilesInDirectorySync:(id)a0 matchingPattern:(id)a1 exceedNumber:(unsigned long long)a2 outError:(id *)a3;
+ (void)createHardLinkCopyFromFile:(id)a0 toFile:(id)a1;
...
+ (BOOL)isAudioStreamConsumingEnabled;
+ (BOOL)isAudioStreamProvidingEnabled;
+ (BOOL)isBridgeOS;
+ (BOOL)isFasterMitigationEnabled;
...
+ (BOOL)isNonHSCapableBTHeadsetRouteFromHypotheticalRoute:(id)a0;
+ (BOOL)isOnDeviceASRAudioLoggingEnabled;
+ (BOOL)isPlaybackRouteCarAudio:(id)a0;
