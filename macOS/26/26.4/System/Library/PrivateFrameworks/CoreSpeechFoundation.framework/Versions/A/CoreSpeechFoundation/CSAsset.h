@class NSString, NSArray, NSDictionary, CSOEPEntitledAssetManager;
...
+ (id)assetForAssetType:(unsigned long long)a0 resourcePath:(id)a1 configVersion:(id)a2 assetProvider:(unsigned long long)a3 assetVariant:(unsigned long long)a4 identity:(id)a5 assistantLanguageCode:(id)a6 uafAssetVersion:(id)a7 oepEntitledAssetManager:(id)a8;
+ (id)decodeJson:(id)a0;
...
+ (id)assetForAssetType:(unsigned long long)a0 resourcePath:(id)a1 configVersion:(id)a2 assetProvider:(unsigned long long)a3 assetVariant:(unsigned long long)a4 identity:(id)a5 assistantLanguageCode:(id)a6 uafAssetVersion:(id)a7;
...
- (id)initWithResourcePath:(id)a0 configFile:(id)a1 configVersion:(id)a2 assetProvderType:(unsigned long long)a3 assetType:(unsigned long long)a4 assetVariant:(unsigned long long)a5 identity:(id)a6 assistantLanguageCode:(id)a7 uafAssetVersion:(id)a8;
- (id)initWithResourcePath:(id)a0 configFile:(id)a1 configVersion:(id)a2 assetProvderType:(unsigned long long)a3 assetType:(unsigned long long)a4 assetVariant:(unsigned long long)a5 identity:(id)a6 assistantLanguageCode:(id)a7 uafAssetVersion:(id)a8 oepEntitledAssetManager:(id)a9;
