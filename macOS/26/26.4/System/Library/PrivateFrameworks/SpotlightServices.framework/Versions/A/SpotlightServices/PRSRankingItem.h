@class NSData, NSString, NSArray, NSDate, NSURL, PRSRankingSpanCalculator, NSDictionary, PRSL2FeatureVector, NSMutableArray, _CSEmbedding, NSNumber, SSMixedRankingScore;
...
@property (retain, nonatomic) SSMixedRankingScore *mrScore;
@property (nonatomic) BOOL isRootVolumeApplication;
@property (nonatomic) BOOL matchesNlpGroupName;
@property (nonatomic) BOOL demotionAllowed;
...
@property (nonatomic) BOOL hasDictionaryTrigger;
...
@property (nonatomic) BOOL isMeCardEmailInPrimaryRecipients;
@property (nonatomic) BOOL isMeCardEmailInAdditionalRecipients;
...
@property (nonatomic) BOOL isInferredSharedLinkOrSafariLink;
@property (nonatomic) BOOL isPromotedSharedLink;
@property (retain, nonatomic) NSString *preExtractedCardType;
@property (nonatomic) BOOL hasQUMatchWithPreextractedLocationAttributes;
@property (nonatomic) BOOL hasPreextractedLocationAttributesForQU;
@property (nonatomic) BOOL hasPreExtractedCustomerNames;
...
@property (nonatomic) BOOL isMatchedAliasShortcut;
@property (nonatomic) BOOL isUserTypedURL;
...
+ (id)_setOfImportantFirstPrioritySettingIdentifiers;
+ (id)_setOfImportantSecondPrioritySettingIdentifierPrefixes;
+ (id)createItemUtility:(struct { long long x0; unsigned long long x1[7]; unsigned long long x2[7]; unsigned long long x3[7]; void *x4[0]; } *)a0 bundleID:(id)a1;
+ (unsigned short)featureFromVirtualIdx:(unsigned long long)a0;
+ (struct { long long x0; unsigned long long x1[7]; unsigned long long x2[7]; unsigned long long x3[7]; void *x4[0]; } *)generateCompactRankingAttrsUtility:(id)a0;
...
+ (BOOL)isPhotoBundleType:(unsigned long long)a0;
+ (float)matchScoreLaunchString:(id)a0 withEvaluator:(id)a1;
+ (float)matchScoreServerCompletion:(id)a0 withEvaluator:(id)a1;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[7]; unsigned long long x2[7]; unsigned long long x3[7]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isSearchToolClient:(BOOL)a3;
...
- (void)initBundleIDTypeWithAppDetails:(id)a0;
...
- (void)calculateFreshnessForSearchTool:(id)a0 userSpecifiedStartTime:(double)a1 userSpecifiedEndTime:(double)a2;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[7]; unsigned long long x2[7]; unsigned long long x3[7]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isAppleInternalApp:(BOOL)a4 isFrequentlyUsedAppleInternalApp:(BOOL)a5 isAppleSystemApp:(BOOL)a6 isMetadataResult:(BOOL)a7 isServerAlternativeResult:(BOOL)a8 isSearchToolClient:(BOOL)a9;
...
- (void)populateOtherFeatures:(struct PRSL2FeatureScoreInfo { unsigned short *x0; float *x1; unsigned long long x2; unsigned long long x3; } *)a0 withEvaluator:(id)a1 currentTime:(double)a2 quParsedEvaluator:(id)a3 queryID:(long long)a4 isSearchToolClient:(BOOL)a5 quParsedArgSearchTermsEvaluator:(id)a6;
...
- (float)topicalityScoreWithEvaluator:(id)a0 quParsedEvaluator:(id)a1 isSearchToolClient:(BOOL)a2 quParsedArgSearchTermsEvaluator:(id)a3;
