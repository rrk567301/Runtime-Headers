...
- (void)updatePhotosRankingItemScore:(id)a0 userQuery:(id)a1 currentTime:(double)a2 collectL2Signals:(BOOL)a3 keyboardLanguage:(id)a4 uniqueSessionID:(id)a5 onlyEmbeddingResults:(BOOL)a6 amlInputs:(id)a7 isCardSearch:(BOOL)a8 isDocumentSearch:(BOOL)a9 maxCount:(long long)a10;
- (void)updateScoresForItems:(id)a0 withSectionBundle:(id)a1 userQuery:(id)a2 queryID:(long long)a3 currentTime:(double)a4 collectL2Signals:(BOOL)a5 keyboardLanguage:(id)a6 onlyEmbeddingResults:(BOOL)a7 isCardSearch:(BOOL)a8 isDocumentSearch:(BOOL)a9 maxCount:(long long)a10;
