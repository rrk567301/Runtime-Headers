...
+ (void)getWorldClockResultsForQuery:(id)a0 queryID:(unsigned long long)a1 completionHandler:(id /* block */)a2;
...
+ (void)parseQueryForWorldClock:(id)a0 queryID:(unsigned long long)a1 completionHandler:(id /* block */)a2;
+ (void)parseQueryForWorldClock:(id)a0 queryID:(unsigned long long)a1 forceLoad:(BOOL)a2 completionHandler:(id /* block */)a3;
