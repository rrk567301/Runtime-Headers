@class NSString, NSMutableDictionary, NSArray, NSMapTable, PRSQueryRankingConfiguration, _CSEmbedding;
...
@property (copy, nonatomic) NSString *mailSessionID;
@property (nonatomic) long long mailQueryID;
...
+ (BOOL)shouldFilterResult:(id)a0 currentTime:(double)a1 isScopedSearch:(BOOL)a2;
+ (unsigned long long)spellCorrectedAppMinQueryLen;
+ (BOOL)isCJK;
+ (id)phoneFavoritesCopy;
+ (void)thresholdResultsInSection:(id)a0 userQuery:(id)a1 queryID:(long long)a2 isEntitiesSearch:(BOOL)a3 currentTime:(double)a4 isScopedSearch:(BOOL)a5 isSearchToolClient:(BOOL)a6;
...
- (void)updateScoresForPreparedItems:(id)a0 isCJK:(BOOL)a1 clientBundleID:(id)a2 thresholdValue:(double)a3 queryNodeMatchInfo:(id)a4 collectL2Signals:(BOOL)a5 isCardSearch:(BOOL)a6 isDocumentSearch:(BOOL)a7;
- (void)parseSingleLLMQUParse:(id)a0 signalsPerTool:(id)a1 globalSignals:(id)a2 currentTime:(double)a3;
...
- (void)parseMultiParseLLMQUQuery:(id)a0;
