...
@property (retain, nonatomic) SFSearchResult_SpotlightExtras *appPrefixMatch;
@property (retain, nonatomic) SFSearchResult_SpotlightExtras *cccdResult;
@property (retain, nonatomic) SFSearchResult_SpotlightExtras *dictionaryResult;
@property (retain, nonatomic) SFSearchResult_SpotlightExtras *localPrefixMatch;
...
- (BOOL)isQueryPrefixOfResult:(id)a0;
- (void)processResult:(id)a0;
- (void)resolveCCCDConflicts;
- (void)resolveDictionaryConflicts;
