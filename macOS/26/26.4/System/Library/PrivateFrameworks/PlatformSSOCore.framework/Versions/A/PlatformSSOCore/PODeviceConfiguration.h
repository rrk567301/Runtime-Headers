@class NSMutableDictionary, NSString, NSArray, NSData, NSDate, NSNumber, NSDictionary;
...
- (id)decryptTemporaryAccountCredentialForAccount:(id)a0;
...
- (BOOL)encryptAndSaveTemporaryAccountCredential:(id)a0 account:(id)a1;
- (BOOL)hasTemporaryAccountCredentialForAccount:(id)a0;
- (BOOL)supportsCreateTemporaryUsers;
- (BOOL)supportsTokenUnlock;
- (BOOL)_encryptAndSaveTemporaryAccountCredential:(id)a0 account:(id)a1 key:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a2;
