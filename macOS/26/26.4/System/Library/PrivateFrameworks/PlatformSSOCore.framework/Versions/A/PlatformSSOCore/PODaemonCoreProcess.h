...
@property BOOL useOldPrebootPath;
...
- (id)_deviceConfigurationForIdentifier:(id)a0;
- (id)_loginConfigurationForIdentifier:(id)a0;
...
- (id)_stashedDecryptionContextForIdentifier:(id)a0 error:(id *)a1;
...
- (id)_pendingSSOTokensForIdentifier:(id)a0 error:(id *)a1;
- (id)_pssoSystemConfigurationPathFromPreboot;
- (void)_saveCachedContextsToDiskWithCompletion:(id /* block */)a0;
- (id)_stashedSSOTokensForIdentifier:(id)a0 error:(id *)a1;
