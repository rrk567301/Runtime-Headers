...
@property (retain, nonatomic) LAContext *accessKeyContext;
@property (readonly, nonatomic) BOOL isSmartCardAuth;
@property (readonly, nonatomic) BOOL isAccessKeyAuth;
...
- (void).cxx_destruct;
- (void)setContextInt:(unsigned int)a0 withFlags:(unsigned int)a1 forKey:(const char *)a2;
...
- (BOOL)createAccessKeyCredentialContext;
...
- (void)removeContextValueForKey:(const char *)a0;
- (void)saveValuesInContextForNewUser:(id)a0;
- (void)saveValuesInContextForTemporarySession:(id)a0;
...
- (BOOL)shouldCreateAccessKeyNewUser;
- (BOOL)shouldCreatePasswordNewUser;
- (BOOL)shouldCreateSmartCardNewUser;
