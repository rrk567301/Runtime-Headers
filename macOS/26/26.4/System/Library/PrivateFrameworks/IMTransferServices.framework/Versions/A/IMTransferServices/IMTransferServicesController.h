...
- (void)setPersonalNickname:(id)a0 oldRecordID:(id)a1 completionBlockWithWallpaperAndRecipeDataTags:(id /* block */)a2;
...
- (void)updateUltraConstrainedAttachments:(BOOL)a0;
