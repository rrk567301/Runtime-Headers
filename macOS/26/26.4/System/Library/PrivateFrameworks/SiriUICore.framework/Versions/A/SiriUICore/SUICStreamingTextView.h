...
- (void)setWords:(id)a0 showEditImage:(BOOL)a1 useCarouselAnimation:(BOOL)a2 preferredLeadingIconBundleIdentifier:(id)a3;
- (void)_adjustCompositeFilters;
- (void)_animateLayers;
- (void)_animateWordIn:(id)a0 displacement:(double)a1 delay:(double)a2;
- (void)_animateWordInSAE:(id)a0 displacement:(double)a1 isUpdatingExistingAnimation:(BOOL)a2 delay:(double)a3;
- (void)_animateWordOut:(id)a0 delay:(double)a1;
- (void)_carouselWordOut:(id)a0 speed:(double)a1 delay:(double)a2 displacement:(double)a3;
...
- (void)_crossfadeAnimateWordIn:(id)a0;
...
- (BOOL)_wordHasInFlightAnimation:(id)a0;
- (void)updateLastWord;
