...
@interface SUICEdgeLightMaskMetalLayer : CAMetalLayer <CAAnimationDelegate> {
    ...
    struct { void /* unknown type, empty encoding */ resolution; float yxRatio; float screenRadiusRatio; float falloffCoefficient; void /* unknown type, blank encoding */ flameScale; void /* unknown type, blank encoding */ flameScaleDucked; void /* unknown type, blank encoding */ burstOpacity; void /* unknown type, blank encoding */ contrast; } _layout;
...
- (void)setIntelligenctLightStatic:(BOOL)a0;
- (void)setIntelligentLightNoiseSpeedReducer:(id)a0;
