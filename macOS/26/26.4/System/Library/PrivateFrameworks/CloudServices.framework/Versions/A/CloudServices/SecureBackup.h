...
@property (nonatomic) BOOL generateClientMetadata;
...
@property (nonatomic) BOOL dbr;
@property (nonatomic) BOOL dbrFDE;
@property (nonatomic) BOOL fallBackSR;
@property (nonatomic) BOOL lrcFed;
@property (nonatomic) BOOL lrc;
...
@property (nonatomic) BOOL returnSerializedEscrowRecord;
...
- (id)enableAndReturnNetworkReachedHint:(id *)a0;
- (void)enableWithCompletionBlock:(id /* block */)a0;
- (BOOL)enableWithError:(id *)a0;
- (void)enableWithResults:(id /* block */)a0;
...
- (void)wrapDataToFedKeyWithCompletionBlock:(id /* block */)a0;
- (id)wrapDataToFedKeyWithError:(id *)a0;
- (id)wrapDataToFedKeyWithInfo:(id)a0;
- (void)wrapDataToFedKeyWithInfo:(id)a0 completionBlock:(id /* block */)a1;
