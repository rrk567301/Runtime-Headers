...
@property (class, retain, nonatomic) SecureBackupTermsInfo *testTermsOverride;
...
+ (struct __SecCertificate { } *)fedCertificate:(unsigned int)a0 altDSID:(id)a1 inEnvironment:(id)a2;
+ (void)fetchTermsWithAltDSID:(id)a0 reply:(id /* block */)a1;
+ (id)knownICDPFederations;
+ (id)moveToFederationAllowed:(id)a0 altDSID:(id)a1;
