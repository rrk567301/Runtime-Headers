...
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; struct __SecKeyDescriptor *x1; void *x2; } *)a0 certificateData:(id)a1 error:(id *)a2;
- (id)encodedEscrowRecordWithPublicKeyBytes:(id)a0 certificateData:(id)a1 error:(id *)a2;
- (id)initWithDSID:(id)a0 escrowRecordContents:(id)a1 passcodeStashSecret:(id)a2 recoveryPassphrase:(id)a3 recordID:(id)a4 recordLabel:(id)a5 useAppleIDPassword:(BOOL)a6 appleIDPasswordMetadata:(id)a7 reqVersion:(int)a8;
- (id)initWithRequest:(id)a0 reqVersion:(int)a1;
- (id)initWithRequest:(id)a0 validate:(BOOL)a1 reqVersion:(int)a2 error:(id *)a3;
