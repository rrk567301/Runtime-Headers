@class SecureBackup, NSString, NSDictionary, NSData, AppleIDPasswordMetadata;
...
@property (readonly, nonatomic) BOOL dbr;
@property (readonly, nonatomic) BOOL dbrFDE;
@property (readonly, nonatomic) BOOL fallBackSR;
@property (readonly, nonatomic) BOOL lrcFed;
@property (readonly, nonatomic) BOOL lrc;
