...
+ (id)_iconForURL:(id)a0 iconConfiguration:(id)a1;
+ (id)_iconForURL:(id)a0 options:(unsigned long long)a1;
+ (id)_iconForURL:(id)a0 options:(unsigned long long)a1 iconConfiguration:(id)a2;
...
- (id)initWithURL:(id)a0 iconConfiguration:(id)a1;
