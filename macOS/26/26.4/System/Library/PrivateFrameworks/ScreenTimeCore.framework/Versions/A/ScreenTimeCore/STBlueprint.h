...
+ (id)appExceptionsDeclarationForUser:(id)a0 usingCache:(id)a1;
...
+ (id)fetchRequestForBlueprintsOfType:(id)a0;
+ (id)_buildConfigurationsByDeclarationIdentifierFromBlueprint:(id)a0 excludingConfigurationTypes:(id)a1 error:(id *)a2;
...
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 ofType:(id)a1 withIdentifier:(id)a2 fromOrganization:(id)a3 includeTombstones:(BOOL)a4;
...
+ (BOOL)disableRestrictionsBlueprintForUser:(id)a0 error:(id *)a1;
...
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 ofType:(id)a1 fromOrganization:(id)a2 includeTombstones:(BOOL)a3;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)a0 fromOrganization:(id)a1 includeTombstones:(BOOL)a2;
+ (id)applyAutomaticOnDemandDowntimeStateChange:(long long)a0 forUserID:(id)a1 context:(id)a2 error:(id *)a3;
+ (id)alwaysAllowBundleIdentifiersForUser:(id)a0 error:(id *)a1;
+ (id)fetchRequestMatchingUnexpiredOneMoreMinuteBlueprintsForUserWithDSID:(id)a0;
...
- (BOOL)_validateBlueprintConfiguration:(id)a0;
- (BOOL)_validateBlueprintIdentifier:(id)a0;
- (BOOL)_validateNumberOfBlueprints:(id)a0;
- (BOOL)_validateType:(id)a0;
- (BOOL)_validateUsersOnBlueprint:(id)a0;
- (id)_webFilterBlacklistStringsForURL:(id)a0;
- (id)alwaysAllowBundleIdentifiersWithError:(id *)a0;
...
- (id)declarationsExcludingConfigurationTypes:(id)a0 error:(id *)a1;
...
- (void)updateUsageLimitWithAlwaysAllowBundleIdentifiers:(id)a0;
