...
@property (readonly) BOOL isInFamily;
...
@property (readonly) BOOL isThirdPartyReplacingAppAndWebsiteActivity;
...
@property BOOL isThirdPartyReplacingAppAndWebsiteActivity;
