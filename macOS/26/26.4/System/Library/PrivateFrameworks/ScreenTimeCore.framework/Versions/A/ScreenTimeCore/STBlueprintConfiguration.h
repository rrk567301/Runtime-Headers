...
+ (void)logWebContentFilterDiagnostics:(id)a0;
...
+ (id)_recoverSiteWhiteListItemsFromArray:(id)a0;
...
+ (id)_recoverSiteWhiteListItemFromDictionary:(id)a0;
