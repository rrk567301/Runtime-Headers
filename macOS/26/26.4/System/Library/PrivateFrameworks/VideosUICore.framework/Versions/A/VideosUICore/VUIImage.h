...
@interface VUIImage : NSObject {
    ...
    BOOL _usePrepareImageForDisplay;
    NSURL *_imageURL;
    NSData *_imageData;
    NSString *_imageType;
...
+ (BOOL)cgImageHasAlpha:(struct CGImage { } *)a0;
...
- (void)setUsePrepareImageForDisplay:(BOOL)a0;
- (id)uiImageWithScale:(double)a0;
- (BOOL)usePrepareImageForDisplay;
