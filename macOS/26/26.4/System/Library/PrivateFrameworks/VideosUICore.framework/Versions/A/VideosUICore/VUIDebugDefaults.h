...
@property (nonatomic) BOOL vStackInForEachEnabled;
...
@property (nonatomic) BOOL closeSynchronizedStreamsOnBroadcastEnd;
@property (nonatomic) BOOL requireLSPPToRemoveFromMultiview;
