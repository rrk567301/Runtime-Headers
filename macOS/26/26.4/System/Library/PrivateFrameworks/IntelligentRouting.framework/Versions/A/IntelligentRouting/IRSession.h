...
+ (void)classifyRoomName:(id)a0 accessoryNames:(id)a1 reply:(id /* block */)a2;
...
+ (void)terminateLLMServiceWithReply:(id /* block */)a0;
...
- (void)requestCurrentContextWithReply:(id /* block */)a0;
...
- (BOOL)_isEventValid:(id)a0 forSuggestionTarget:(id)a1;
...
- (void)requestCurrentContextWithTargets:(id)a0 reply:(id /* block */)a1;
