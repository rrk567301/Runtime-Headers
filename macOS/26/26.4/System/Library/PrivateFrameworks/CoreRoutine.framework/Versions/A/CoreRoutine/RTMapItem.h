@class NSUUID, NSDate, NSData, NSString, NSArray, RTLocation, RTAddress, RTMapItemExtendedAttributes, NSNumber;
...
- (id)initWithIdentifier:(id)a0 name:(id)a1 category:(id)a2 categoryMUID:(id)a3 address:(id)a4 location:(id)a5 source:(unsigned long long)a6 mapItemPlaceType:(unsigned long long)a7 muid:(unsigned long long)a8 resultProviderID:(long long)a9 geoMapItemHandle:(id)a10 geoMapItemIdentifier:(id)a11 creationDate:(id)a12 expirationDate:(id)a13 extendedAttributes:(id)a14 displayLanguage:(id)a15 disputed:(BOOL)a16;
- (id)initWithIdentifier:(id)a0 name:(id)a1 category:(id)a2 categoryMUID:(id)a3 address:(id)a4 location:(id)a5 source:(unsigned long long)a6 mapItemPlaceType:(unsigned long long)a7 muid:(unsigned long long)a8 resultProviderID:(long long)a9 geoMapItemHandle:(id)a10 geoMapItemIdentifier:(id)a11 creationDate:(id)a12 expirationDate:(id)a13 extendedAttributes:(id)a14 displayLanguage:(id)a15 disputed:(BOOL)a16 businessHours:(id)a17;
