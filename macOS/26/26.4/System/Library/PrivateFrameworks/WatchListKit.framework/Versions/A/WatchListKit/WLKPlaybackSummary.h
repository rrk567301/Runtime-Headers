...
@property (readonly, nonatomic) BOOL needsIntentDonation;

+ (id)debugStringForPlaybackState:(long long)a0;
+ (id)liveSummaryWithBundleID:(id)a0 channelID:(id)a1 serviceID:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 playbackState:(long long)a6 playbackRate:(id)a7 currentPlaybackDate:(id)a8 playablePassthrough:(id)a9;
+ (id)VODSummaryWithBundleID:(id)a0 channelID:(id)a1 contentID:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 duration:(id)a6 elapsedTime:(id)a7 playbackState:(long long)a8 playbackRate:(id)a9 playablePassthrough:(id)a10 contentTitle:(id)a11 completionState:(long long)a12;
...
+ (id)EBSSummaryWithBundleID:(id)a0 channelID:(id)a1 externalId:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 playbackState:(long long)a6 playbackRate:(id)a7 currentPlaybackDate:(id)a8 playablePassthrough:(id)a9;
...
+ (id)VODSummaryWithBundleID:(id)a0 channelID:(id)a1 contentID:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 duration:(id)a6 elapsedTime:(id)a7 featureDuration:(id)a8 featureElapsedTime:(id)a9 playbackState:(long long)a10 playbackRate:(id)a11 playablePassthrough:(id)a12 contentTitle:(id)a13 completionState:(long long)a14;
...
+ (id)VODSummaryWithBundleID:(id)a0 channelID:(id)a1 contentID:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 duration:(id)a6 elapsedTime:(id)a7 featureDuration:(id)a8 featureElapsedTime:(id)a9 playbackState:(long long)a10 playbackRate:(id)a11 contentTitle:(id)a12 completionState:(long long)a13;
...
+ (id)VODSummaryWithBundleID:(id)a0 channelID:(id)a1 contentID:(id)a2 accountID:(id)a3 externalProfileID:(id)a4 timestamp:(id)a5 duration:(id)a6 elapsedTime:(id)a7 playbackState:(long long)a8 playbackRate:(id)a9 contentTitle:(id)a10 completionState:(long long)a11;
...
- (void).cxx_destruct;
- (BOOL)isLiveType;
- (id)initWithBundleID:(id)a0 timestamp:(id)a1 duration:(id)a2 elapsedTime:(id)a3 featureDuration:(id)a4 featureElapsedTime:(id)a5 externalProfileID:(id)a6 contentID:(id)a7 accountID:(id)a8 playbackState:(long long)a9 playbackRate:(id)a10 completionState:(long long)a11 isAlwaysLive:(BOOL)a12 serviceID:(id)a13 currentPlaybackDate:(id)a14 playbackType:(long long)a15 isTimerDerived:(BOOL)a16 isFromActivePlayerPath:(BOOL)a17 channelID:(id)a18 contentTitle:(id)a19;
