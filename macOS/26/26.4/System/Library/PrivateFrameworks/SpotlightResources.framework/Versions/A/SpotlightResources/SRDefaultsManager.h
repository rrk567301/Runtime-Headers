...
@interface SRDefaultsManager : NSObject <DDSAssetCenterDelegate> {
    ...
    BOOL _fetchedRootSystem;
    NSMutableSet *_fetchedLanguagesOTA;
    BOOL _fetchedRootOTA;
...
- (id)allLoadedAssets;
- (id)trialConfigDump;
- (void)_loadAssets:(id)a0 shouldUpdate:(BOOL)a1 merge:(BOOL)a2;
- (id)assetConfigDump;
- (void)_unloadAssetsForLocale:(id)a0;
- (void)addFetchForLanguage:(id)a0 ota:(BOOL)a1;
- (id)assertionsDump;
- (id)assetBundleForLocale:(id)a0 client:(id)a1 force:(BOOL)a2 noOTA:(BOOL)a3;
- (id)assetConfig;
...
- (BOOL)didFetchForLanguage:(id)a0 ota:(BOOL)a1;
- (void)didUpdateTrialNamespace:(id)a0;
- (id)fetchedLanguages:(BOOL)a0;
- (BOOL)hasTestAssets;
- (id)langConfig;
- (id)langConfigDump;
- (id)loadAssetsForLanguage:(id)a0 reload:(BOOL)a1 force:(BOOL)a2 noOTA:(BOOL)a3;
- (id)loadDefaultsForLocale:(id)a0 reload:(BOOL)a1 force:(BOOL)a2 noOTA:(BOOL)a3;
- (void)loadDefaultsFromDefaultAssets:(id)a0;
- (void)loadFactorsAtPath:(id)a0 namespaceId:(id)a1;
- (void)loadInternalAssetsForLanguage:(id)a0 assetTypes:(id)a1;
...
- (id)parametersOfContentTypeWithName:(id)a0 client:(id)a1;
...
- (void)removeFetchForLanguage:(id)a0 ota:(BOOL)a1;
...
- (void)updateFetchedLanguages:(id)a0 ota:(BOOL)a1;
