@interface _TtCC19ModelCatalogRuntime20CatalogServiceServer6Server : NSObject <ModelCatalog.CatalogServicesProtocol> {
    ...
    void /* unknown type, empty encoding */ unifiedAssetInterface;
    void /* unknown type, empty encoding */ mobileAssetInterface;
    void /* unknown type, empty encoding */ assetLockProvider;
    void /* unknown type, empty encoding */ resourceReadinessProvider;
    void /* unknown type, empty encoding */ assetStatusProviderRouter;
}

- (void).cxx_destruct;
- (id)init;
- (void)acquireCoherenceTokenWithIdentifiers:(id)a0 with:(id /* block */)a1;
- (void)availableUseCasesWithUseCaseIdentifiers:(id)a0 includeAssetsInformation:(BOOL)a1 with:(id /* block */)a2;
- (void)donateGenerativeGuardrailResultWithGuardrailResult:(id)a0 with:(id /* block */)a1;
- (void)donateSafetyFailureWithSafetyFailure:(id)a0 with:(id /* block */)a1;
- (void)downloadStatusWithSubscriberID:(id)a0 subscriptionName:(id)a1 with:(id /* block */)a2;
- (void)enableTestResourcesWith:(id /* block */)a0;
- (void)formatInferenceIDFrom:(id)a0 with:(id /* block */)a1;
...
- (void)safetyFailuresWithUserIdentifier:(unsigned int)a0 with:(id /* block */)a1;
...
- (void)useCasesStatusWithUseCaseIdentifiers:(id)a0 with:(id /* block */)a1;
