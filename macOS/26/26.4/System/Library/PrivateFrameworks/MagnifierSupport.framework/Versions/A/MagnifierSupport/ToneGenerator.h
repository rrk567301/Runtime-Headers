...
- (void).cxx_destruct;
- (id)init;
- (id)_configureHapticPlayerWithVolume:(float)a0 duration:(double)a1 error:(id *)a2;
- (void)_playSoundWithPitchFactor:(float)a0 leftBalance:(float)a1 rightBalance:(float)a2 volume:(float)a3 loop:(BOOL)a4;
- (id)_configureAudioEngine;
- (void)_configurePlayerWithPitchFactor:(float)a0 leftBalance:(float)a1 rightBalance:(float)a2 volume:(float)a3 loop:(BOOL)a4;
- (void)_playHapticsWithVolume:(float)a0 pulseDuration:(double)a1;
- (void)_playOnePulse;
- (void)startPulse;
- (void)stopPulse;
