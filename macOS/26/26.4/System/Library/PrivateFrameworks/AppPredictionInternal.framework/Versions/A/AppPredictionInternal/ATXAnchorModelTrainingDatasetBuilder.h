@class NSString, ATXAnchorModelEventHarvester;
...
+ (id)_pickTopSamplesFromArray:(id)a0 sampleSize:(unsigned long long)a1;
...
- (id)fetchPositiveActionEventsAfterAnchorDate:(id)a0 durationOfAnchorEvent:(double)a1 anchor:(id)a2;
...
- (id)initWithActivity:(id)a0 dataStoreWrapper:(id)a1 harvester:(id)a2;
