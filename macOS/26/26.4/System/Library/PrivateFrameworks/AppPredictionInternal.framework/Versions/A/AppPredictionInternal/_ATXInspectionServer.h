...
- (void)_getActionLogs:(id /* block */)a0 obfuscation:(BOOL)a1;
...
- (void)lockScreenBundleIdsWithReply:(id /* block */)a0;
- (void)appHistoryStartDeltaRecording:(id /* block */)a0;
- (void)setTestMode:(BOOL)a0 withCompletion:(id /* block */)a1;
...
- (void)showFileURLsOfItemsRelatedToAppEntityWithIdentifier:(id)a0 reply:(id /* block */)a1;
...
- (id)_filterAndSortAppIntentEventsWithUUID:(id)a0 events:(id)a1;
...
- (void)showSimilarFileURLsForFileWithPath:(id)a0 reply:(id /* block */)a1;
...
- (void)resetHistogramsAndRemoveUICaches:(id /* block */)a0;
...
- (void)showIdentifiersOfItemsRelatedToAppEntityWithIdentifier:(id)a0 reply:(id /* block */)a1;
...
- (void)showEmbeddingsVectorForAppEntityWithIdentifier:(id)a0 reply:(id /* block */)a1;
...
- (void)showSimilarFileURLsForSelectedFilesOnFinderWithReply:(id /* block */)a0;
- (void)validPredictionsRightNowForAnchorModelWithReply:(id /* block */)a0;
- (void)predictDocumentsAndReturnInputsAndSubscoresForConsumerSubtype:(unsigned char)a0 limit:(unsigned long long)a1 reply:(id /* block */)a2;
...
- (void)getActionPrivacyFriendlyLogs:(id /* block */)a0;
...
- (void)triggerPredictionsUpdateWithCompletion:(id /* block */)a0;
- (id)init;
...
- (void)triggerBackgroundJobWithIdentifier:(id)a0 configuration:(id)a1 completion:(id /* block */)a2;
...
- (void)logNotificationMetricsFromStartTimestamp:(id)a0 toEndTimestamp:(id)a1 withCompletion:(id /* block */)a2;
...
- (void)resetAnchorModelData:(id /* block */)a0;
