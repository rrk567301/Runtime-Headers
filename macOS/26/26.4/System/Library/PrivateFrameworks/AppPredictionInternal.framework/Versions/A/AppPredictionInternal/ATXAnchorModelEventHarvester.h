...
- (id)fetchAppLaunchEventsAfterAnchorOccurrenceDate:(id)a0 limit:(unsigned long long)a1 maxSecondsBeforeAnchor:(long long)a2 maxSecondsAfterAnchor:(long long)a3 isIncluded:(id /* block */)a4 anchorClass:(Class)a5;
...
- (id)fetchEventsAfterAnchorOccurrenceDate:(id)a0 withDuetDataProviderClass:(Class)a1 limit:(unsigned long long)a2 maxSecondsBeforeAnchor:(long long)a3 maxSecondsAfterAnchor:(long long)a4 predicates:(id)a5 anchorClass:(Class)a6;
