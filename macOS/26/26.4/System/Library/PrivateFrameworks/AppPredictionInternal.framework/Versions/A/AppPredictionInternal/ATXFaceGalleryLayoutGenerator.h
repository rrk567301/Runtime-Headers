...
- (id)_generatedSpatialPhotosSectionWithWidgetDescriptorsAdditionalData:(id)a0 aggregatedAppLaunchData:(id)a1 bundleIdToCompanionBundleId:(id)a2;
...
- (id)_generatedFeaturedSectionWithWidgetDescriptorsAdditionalData:(id)a0 aggregatedAppLaunchData:(id)a1 bundleIdToCompanionBundleId:(id)a2 dayZeroDescriptors:(id)a3;
- (id)_localizedNameForPosterWithExtensionBundleId:(id)a0 appBundleId:(id)a1;
- (id)_localizedDescriptiveTextWithSemanticType:(long long)a0;
- (void).cxx_destruct;
...
- (id)_associatedAppBundleIdentifierForSemanticType:(long long)a0;
...
- (id)putPhotoShuffleAndSpatialSceneInTheTopPositions:(id)a0;
- (BOOL)isDescriptorFromGalleryItem:(id)a0 availableInAssetParameter:(id)a1;
- (BOOL)_shouldExcludePhotosDescriptorOnTVOS:(id)a0;
