...
- (id)boolValueForSetting:(unsigned long long)a0 manufacturer:(id)a1 brand:(id)a2 uuid:(id)a3 error:(id *)a4;
...
- (id)getSettingForKey:(id)a0 error:(id *)a1;
- (id)getSettingsFor:(id)a0 brand:(id)a1 uuid:(id)a2 error:(id *)a3;
- (id)getSignatureCertificateFor:(id)a0 environment:(id)a1 region:(id)a2 keyID:(id)a3 error:(id *)a4;
- (id)initAtPath:(id)a0 deviceClass:(id)a1 productVersion:(id)a2;
- (id)intValueForSetting:(unsigned long long)a0 manufacturer:(id)a1 brand:(id)a2 uuid:(id)a3 error:(id *)a4;
