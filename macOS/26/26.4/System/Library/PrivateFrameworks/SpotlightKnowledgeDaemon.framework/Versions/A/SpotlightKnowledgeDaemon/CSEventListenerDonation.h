...
- (id)initWithSerialNumber:(unsigned long long)a0 bundle:(const char *)a1 journalCookie:(const char *)a2 itemsObj:(struct { char *x0; unsigned long long x1; struct { unsigned int x0; unsigned char x1; } x2; })a3 contentDictObj:(struct { char *x0; unsigned long long x1; struct { unsigned int x0; unsigned char x1; } x2; })a4 htmlDictObj:(struct { char *x0; unsigned long long x1; struct { unsigned int x0; unsigned char x1; } x2; })a5 embeddingsObj:(struct { char *x0; unsigned long long x1; struct { unsigned int x0; unsigned char x1; } x2; })a6 indexType:(unsigned int)a7 bundleHash:(unsigned int)a8;
