...
+ (id)instanceForIndexType:(unsigned int)a0;
+ (void)purgeAllWithUUID:(id)a0 listenerType:(int)a1 indexType:(unsigned int)a2;
...
- (id)initWithParentFd:(int)a0 indexType:(unsigned int)a1;
