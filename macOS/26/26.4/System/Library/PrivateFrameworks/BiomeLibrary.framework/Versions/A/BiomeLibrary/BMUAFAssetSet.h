...
@property (readonly, nonatomic) BOOL fromFactory;
@property (nonatomic) BOOL hasFromFactory;
...
- (id)initWithAssetSetName:(id)a0 assets:(id)a1 assetType:(id)a2 assetSetId:(id)a3 audienceId:(id)a4 mobileAssetDownloadErrorCodeFrequency:(id)a5 fromPreSoftwareUpdateStaging:(id)a6 expensiveCellularDownloadRequested:(id)a7 fromFactory:(id)a8;
