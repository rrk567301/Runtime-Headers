@class BMAppleIntelligenceAvailabilityUseCaseInfo, NSArray, NSString, BMAppleIntelligenceAvailabilityOptInInfo, NSDate;
...
- (void).cxx_destruct;
- (void)writeTo:(id)a0;
- (id)initWithAppleIntelligenceUseCase:(id)a0 appleIntelligenceDiffusionUseCase:(id)a1 isAppleIntelligenceToggleEnabled:(id)a2 languages:(id)a3 region:(int)a4 optInInfo:(id)a5;
