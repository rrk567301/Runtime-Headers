...
@property (readonly, nonatomic) BOOL isLastPrompt;
@property (nonatomic) BOOL hasIsLastPrompt;
...
- (id)initWithTimestamp:(id)a0 prompt:(id)a1 tokenLength:(id)a2 identifier:(id)a3 topic:(id)a4 usage:(id)a5 userInterfaceLanguage:(id)a6 userSetRegionFormat:(id)a7 personalization:(int)a8 result:(int)a9 feature:(int)a10 style:(id)a11 hair:(id)a12 facialHair:(id)a13 accessories:(id)a14 additionalDescription:(id)a15 sessionIdentifier:(id)a16 isLastPrompt:(id)a17 promptIdentifier:(id)a18;
