...
- (id)initWithPlacement:(int)a0 numAds:(id)a1 numPassed:(id)a2 storefront:(id)a3 searchTerm:(id)a4 identifier:(id)a5;
- (id)initWithPlacement:(int)a0 numAds:(id)a1 numPassed:(id)a2 storefront:(id)a3 searchTerm:(id)a4 identifier:(id)a5 locale:(id)a6;
