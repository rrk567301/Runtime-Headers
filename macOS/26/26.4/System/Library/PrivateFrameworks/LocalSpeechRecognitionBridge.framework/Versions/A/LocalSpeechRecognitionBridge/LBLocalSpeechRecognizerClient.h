...
- (oneway void)localSpeechServiceDidReceiveSpeechDetectionEvent:(id)a0;
- (void)_invalidate;
- (void)connectToServiceIfNeeded;
- (void)resetCacheAndCompileAllAssets;
- (void)turnEndedwithContext:(id)a0;
...
- (void)_querySpeechDetectionUpdatesEventWithCompletion:(id /* block */)a0;
...
- (void)turnEndedForRequestId:(id)a0 withTrpId:(id)a1;
...
- (void)_notifyObserverOfSpeechDetectionEvent:(id)a0;
...
- (void)dismissForRequestId:(id)a0;
- (void)requestingSpeechDetectionNotificationAfter:(double)a0 forRequest:(id)a1 withTrpId:(id)a2;
...
- (void)_stopAudioCaptureWithReason:(unsigned long long)a0 requestId:(id)a1;
- (id)_service;
- (oneway void)localSpeechServiceDidReceiveSpeechDetectionUpdate:(id)a0;
