...
- (id)init;
- (id)initWithIndexOffset:(id)a0 indexCount:(SEL)a1 topology:(long long)a2 materialIndex:(long long)a3 boundsMin:(unsigned long long)a4 boundsMax:(long long)a5;
