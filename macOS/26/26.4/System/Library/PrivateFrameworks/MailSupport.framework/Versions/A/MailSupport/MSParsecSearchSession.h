@class MSParsecSearchEmbeddingState, SFStartLocalSearchFeedback, PARSession, NSString, MSParsecSearchIndexState, NSMutableArray, NSObject;
@protocol OS_os_log;
...
- (void)reportMessageListResultsFetched:(id)a0 topHitResults:(id)a1 instantAnswerResult:(id)a2 isFinished:(BOOL)a3;
- (void)reportMessageResultEngaged:(id)a0 engagementAction:(long long)a1;
- (void)reportMessageResultsVisible:(id)a0 latencyMs:(id)a1;
...
- (void)reportSuggestionsVisible:(id)a0 latencyMs:(id)a1;
