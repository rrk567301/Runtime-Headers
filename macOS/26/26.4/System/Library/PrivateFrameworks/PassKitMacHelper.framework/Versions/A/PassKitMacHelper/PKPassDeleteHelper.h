...
+ (void)deletePaymentPassAlertCopyForPass:(id)a0 withAccount:(id)a1 paymentServiceDataProvider:(id)a2 transitBalanceModel:(id)a3 transitPassProperties:(id)a4 isBridge:(BOOL)a5 completion:(id /* block */)a6;
