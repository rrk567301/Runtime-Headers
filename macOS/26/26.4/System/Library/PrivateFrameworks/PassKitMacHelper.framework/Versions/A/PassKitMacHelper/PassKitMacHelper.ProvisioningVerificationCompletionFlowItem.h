@interface PassKitMacHelper.ProvisioningVerificationCompletionFlowItem : NSObject {
    void /* unknown type, empty encoding */ context;
    void /* unknown type, empty encoding */ methodGroup;
    ...
    void /* unknown type, empty encoding */ _hasSeenMethodsScreen;
}
