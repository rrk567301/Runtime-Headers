@interface PassKitMacHelper.ProvisioningUICoordinator : NSObject {
    void /* unknown type, empty encoding */ delegate;
    void /* unknown type, empty encoding */ manualEntryDelegate;
    ...
    void /* unknown type, empty encoding */ seStorageHandle;
    void /* unknown type, empty encoding */ reporter;
    void /* unknown type, empty encoding */ provisioningStepStartIntervalStates;
}
