...
- (void)_sendPTEventToAccessory:(id)a0 value:(unsigned char)a1 completion:(id /* block */)a2;
- (void)sendPTEventToAccessory:(id)a0 value:(unsigned char)a1 completion:(id /* block */)a2;
