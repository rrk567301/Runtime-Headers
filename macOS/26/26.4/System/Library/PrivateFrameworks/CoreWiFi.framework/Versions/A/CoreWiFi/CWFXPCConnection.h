...
- (void)setInternetSharingDiscoveryState:(BOOL)a0 immediateDisable:(BOOL)a1 requestParams:(id)a2 reply:(id /* block */)a3;
...
- (void)wifiNetworkSharingConnectedAPListWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)startUIScanWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryFamilyHotspotPreferencesWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)stopUIScanWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryInternetSharingStateWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)setInternetSharingPassword:(id)a0 requestParams:(id)a1 reply:(id /* block */)a2;
- (void)setInternetSharingState:(BOOL)a0 requestParams:(id)a1 reply:(id /* block */)a2;
...
- (void)resetInternetSharingStatsWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)setShareMyPersonalHotspotMode:(long long)a0 requestParams:(id)a1 reply:(id /* block */)a2;
...
- (void)queryTetheringSupportedWithRequestParams:(id)a0 reply:(id /* block */)a1;
- (void)beginActivity:(id)a0 requestParams:(id)a1 reply:(id /* block */)a2;
- (void)queryShareMyPersonalHotspotModeWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryInternetSharingDiscoveryStateWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryHotspotClientDataUsageWithRequestParams:(id)a0 reply:(id /* block */)a1;
- (void)acknowledgeWiFiNetworkSharingConnectedAPUpdate:(id)a0 requestParams:(id)a1 reply:(id /* block */)a2;
...
- (void)setFamilyHotspotPreferences:(id)a0 requestParams:(id)a1 reply:(id /* block */)a2;
...
- (void)setInternetSharingDiscoveryStateExt:(BOOL)a0 request:(id)a1 requestParams:(id)a2 reply:(id /* block */)a3;
...
- (void)queryInternetSharingStatsWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryInternetSharingPasswordWithRequestParams:(id)a0 reply:(id /* block */)a1;
...
- (void)queryPersonalHotspotModificationDisabledWithRequestParams:(id)a0 reply:(id /* block */)a1;
