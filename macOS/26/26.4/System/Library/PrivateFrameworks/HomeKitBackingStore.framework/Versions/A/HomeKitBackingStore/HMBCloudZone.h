@class NSMutableDictionary, NSMapTable, HMBCloudDatabase, HMBCloudZoneID, HMBCloudZoneConfiguration, NAFuture, HMBLocalZone, HMBCloudZoneShareModel, HMBModelContainer, NSString, CKDatabase, NSSet, NSMutableSet, NSOperationQueue, NSArray, NSUUID;
...
- (void)_startUpWithLocalZone:(id)a0;
...
- (BOOL)retryStartupWithCloudDatabase:(id)a0 afterError:(id)a1 retryBlock:(id /* block */)a2;
