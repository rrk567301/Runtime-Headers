@class , NSString, __end_, _NUIFlowContainer;
@protocol _NUIFlowArrangementContainer;

@interface NUIContainerFlowView : NUIContainerView <_NUIFlowArrangementContainer> {
    struct _NUIFlowArrangement { id<_NUIFlowArrangementContainer> container; unsigned char horzDist : 8; unsigned char vertDist : 8; BOOL baselineRelative; unsigned long long columns; double rowSpacing; double itemSpacing; double rowHeight; double itemWidth; struct vector<_NUIFlowArrangementCell, std::allocator<_NUIFlowArrangementCell>> { struct _NUIFlowArrangementCell *__begin_; struct _NUIFlowArrangementCell *__end_; struct { struct _NUIFlowArrangementCell *__cap_; } ; } cells; struct vector<_NUIFlowRowContainer *, std::allocator<_NUIFlowRowContainer *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } rows; _NUIFlowContainer *flowContainer; double measuredWidth; struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct { struct CGRect *__cap_; } ; } viewFrames; struct { double baseLineFromTop; double baseLineFromBottom; } maxBaseLinePair; } _arrangement;
...
+ (id)containerFlowViewWithNumberOfColumns:(long long)a0 arrangedSubviews:(id)a1;
...
- (long long)alignmentForCell:(const struct _NUIFlowArrangementCell { id x0; struct CGSize { double x0; double x1; } x1; struct CGSize { double x0; double x1; } x2; struct { double x0; double x1; } x3; unsigned char x4 : 8; unsigned char x5 : 8; } *)a0 inAxis:(long long)a1;
