...
@interface NUIContainerStackView : NUIContainerView <_NUIGridArrangementContainer> {
    ...
    struct map<NSView *, double, std::less<NSView *>, std::allocator<std::pair<NSView *const, double>>> { struct __tree<std::__value_type<NSView *, double>, std::__map_value_compare<NSView *, std::pair<NSView *const, double>, std::less<NSView *>>, std::allocator<std::pair<NSView *const, double>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _customSpacings;
