...
@interface ULLogicAdapter : NSObject <ULDiagnosticsProvider, ULLogicAdapterServiceHandlingInterface, ULLogicAdapterDiagnosticsHandlingInterface, ULLogicAdapterLegacyServiceHandlingInterface, ULLogicAdapterTemporaryMapHandlingInterface, ULRapportMonitorHandlingInterface, ULDataProtectionMonitorHandlingInterface> {
    struct unique_ptr<ULLogicAdapterImpl, std::default_delete<ULLogicAdapterImpl>> { struct { struct ULLogicAdapterImpl *__ptr_; } ; } logicAdapterImpl;
}
...
- (void)_capturePhotoAndWriteToPolarisGraphWithCompletionHandler:(id /* block */)a0;
...
- (void)_mapReconstructionExecute:(id)a0;
...
- (id)exportDatabase;
- (void)exportVisualLoggerDataWithCompletion:(id /* block */)a0;
- (id)purgeDatabase;
...
- (void)requestMapReconstructionForConnectionToken:(id)a0 requestIdentifier:(id)a1;
...
- (void)setDependencies:(struct unique_ptr<ULLogicAdapterImpl, std::default_delete<ULLogicAdapterImpl>> { struct { struct ULLogicAdapterImpl *x0; } x0; })a0 peripheralControl:(id)a1 environment:(id)a2;
- (void)startRapportSession;
- (void)stopRapportSession;
- (void)updateHomeKitUserInteractionLabelForConnectionToken:(id)a0 label:(id)a1;
