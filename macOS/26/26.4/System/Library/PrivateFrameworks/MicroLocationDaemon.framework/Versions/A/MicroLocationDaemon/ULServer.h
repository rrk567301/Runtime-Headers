...
@protocol ULLogicAdapterDiagnosticsHandlingInterface, ULLogicAdapterLegacyServiceHandlingInterface, ULLogicAdapterTemporaryMapHandlingInterface, OS_dispatch_queue, ULLogicAdapterServiceHandlingInterface;
...
- (id)initWithQueue:(id)a0 serviceHandling:(id)a1 legacyServiceHandling:(id)a2 diagnosticsHandling:(id)a3 temporaryMapHandling:(id)a4;
