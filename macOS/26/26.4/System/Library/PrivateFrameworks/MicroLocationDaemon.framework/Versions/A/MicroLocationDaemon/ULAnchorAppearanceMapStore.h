...
- (struct vector<ULAnchorAppearanceMapDO, std::allocator<ULAnchorAppearanceMapDO>> { struct ULAnchorAppearanceMapDO *x0; struct ULAnchorAppearanceMapDO *x1; struct { struct ULAnchorAppearanceMapDO *x0; } x2; })_fetchAnchorAppearanceMapByAndPredicates:(id)a0 sortDescriptors:(id)a1 andLimit:(unsigned long long)a2;
- (BOOL)deleteOrphanRecords;
- (struct vector<ULAnchorAppearanceMapDO, std::allocator<ULAnchorAppearanceMapDO>> { struct ULAnchorAppearanceMapDO *x0; struct ULAnchorAppearanceMapDO *x1; struct { struct ULAnchorAppearanceMapDO *x0; } x2; })fetchAllRecordsWithLimit:(unsigned int)a0;
