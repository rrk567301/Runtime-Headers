...
@property (readonly, nonatomic) BOOL isPodcastsApp;
...
@property (readonly, nonatomic) BOOL subtitlesOnLanguageMismatchEnabled;
...
@property (nonatomic) BOOL subtitleStylesMenuEnabled;
...
@property (readonly, nonatomic) BOOL inputPickerGainControlEnabled;
...
@property (readonly, nonatomic) BOOL cornerPanGestureForContentTabsEnabled;
