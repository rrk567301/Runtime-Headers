...
+ (id)_intendedPayloadEncodingForMinimumOSVersion:(id)a0 compressionHint:(long long)a1;
+ (id)_intendedPayloadEncodingForPackageInfo:(id)a0 compressionHint:(long long)a1;
