...
+ (id)pcsOverrideKeys;
+ (struct _PCSPublicIdentityData { } *)copyPublicIdentityInPCS:(struct _OpaquePCSShareProtection { } *)a0 matchingFlag:(unsigned long long)a1;
...
+ (BOOL)zonePCSIsV2:(struct _OpaquePCSShareProtection { } *)a0;
...
- (void)pcsDataFromFetchedShare:(id)a0 sharePCSData:(id)a1 withPublicSharingKey:(id)a2 oonPrivateKey:(id)a3 withServiceType:(unsigned long long)a4 requestorOperationID:(id)a5 completionHandler:(id /* block */)a6;
...
- (id)createZonePCSWithSpecifiedOwnerPublicKey:(id)a0 error:(id *)a1;
...
- (void)upgradeZonePCSToV2:(id)a0 requestorOperationID:(id)a1 completion:(id /* block */)a2;
...
- (void)synchronizeUserKeyRegistryForSigningIdentitiesForRequestorOperationID:(id)a0 shouldThrottle:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (id)_locked_createZonePCSWithSpecifiedOwnerPublicKey:(id)a0 error:(id *)a1;
- (void)_locked_pcsDataFromFetchedShare:(id)a0 existingSharePCSData:(id)a1 withPublicSharingKey:(id)a2 oonPrivateKey:(id)a3 withServiceType:(unsigned long long)a4 requestorOperationID:(id)a5 completionHandler:(id /* block */)a6;
...
- (BOOL)needsUserKeySyncToPopulateCurrentIdentityForServiceType:(unsigned long long)a0;
