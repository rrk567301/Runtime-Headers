...
- (id)recordZoneFromPZoneSummary:(id)a0 expectedZoneID:(id)a1 databaseScope:(long long)a2 error:(id *)a3 requiredFeaturesValidationFailureType:(id *)a4;
...
- (id)pAncestryEtagFromAncestry:(id)a0;
- (id)pAdopterFeatureSetFromFeatureSet:(id)a0;
- (id)recordIDFromPRecordIdentifier:(id)a0 error:(id *)a1;
- (id)inheritedShareParticipantFromPInheritedParticipant:(id)a0 error:(id *)a1;
