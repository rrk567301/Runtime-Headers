@class CKDPMergeableDeltaReplaceResponse, CKDPRecordRetrieveVersionsResponse, CKDPMergeableDeltaRetrieveResponse, CKDPZoneDeleteResponse, CKDPRecordSaveResponse, CKDPUserQueryResponse, CKDPRecordDeleteResponse, CKDPShareDeclineResponse, CKDPAdopterCapabilitiesCheckResponse, CKDPNotificationMarkReadResponse, CKDPDeleteContainerResponse, CKDPFetchArchivedRecordsResponse, CKDPUserPrivacySettingsBatchLookupResponse, CKDPRecordMoveResponse, CKDPZoneDescendantsRetrieveResponse, CKDPSharePcsIdentityResponse, CKDPWebAuthTokenRetrieveResponse, CKDPNotificationSyncResponse, CKDPResponseOperationHeader, CKDPShareAcceptResponse, CKDPRecordRetrieveResponse, CKDPUserAvailableQuotaResponse, CKDPTokenUnregistrationResponse, CKDPZoneRetrieveResponse, CKDPZoneUsageSaveResponse, CKDPAdopterCapabilitiesSaveResponse, CKDPAnonymousShareAddResponse, CKDPMarkAssetBrokenResponse, CKDPResponseOperationResult, CKDPBundlesForContainerResponse, CKDPMergeableDeltaMetadataRetrieveResponse, CKDPCodeFunctionInvokeResponse, CKDPSetBadgeCountResponse, CKDPShareVettingInitiateResponse, CKDPArchiveRecordsResponse, CKDPUpdateMissingAssetStatusResponse, CKDPSubscriptionDeleteResponse, CKDPUserRetrieveResponse, CKDPTokenRegistrationResponse, CKDPUserPrivacySettingsUpdateResponse, CKDPMergeableDeltaSaveResponse, CKDPShareAccessResponse, CKDPUserPrivacySettingsRetrieveResponse, CKDPSubscriptionCreateResponse, CKDPSubscriptionRetrieveResponse, CKDPZoneSaveResponse, CKDPShareSelfRemoveResponse, CKDPRecordResolveTokenResponse, CKDPShareUsageSaveResponse, CKDPOperation, CKDPUserPrivacySettingsResetResponse, CKDPZoneRetrieveAncestorsResponse, CKDPQueryRetrieveResponse, CKDPZoneRetrieveChangesResponse, CKDPAnonymousShareRemoveResponse, CKDPRecordRetrieveChangesResponse, CKDPAssetUploadTokenRetrieveResponse;
...
@property (readonly, nonatomic) BOOL hasZoneRetrieveAncestorsResponse;
@property (retain, nonatomic) CKDPZoneRetrieveAncestorsResponse *zoneRetrieveAncestorsResponse;
@property (readonly, nonatomic) BOOL hasZoneDescendantsRetrieveResponse;
...
@property (readonly, nonatomic) BOOL hasShareSelfRemoveResponse;
