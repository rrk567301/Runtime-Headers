@class NSData, NSString, CKDPShareAccessBlockedRequesters, CKDPProtectionInfoKeysToRemove, CKDPInheritedSharesInfo, CKDPShareAccessRequesters, CKDPCryptoRequirementsSigningKey, CKDPShareIdentifier, CKDPProtectionInfo, NSMutableArray;
...
@property (readonly, nonatomic) BOOL hasInheritedSharesInfo;
