@class NSString, CKDPZoneEtagValidationInformation, CKDPZone;

@interface CKDPZoneSaveRequest : PBRequest <NSCopying> {
    struct { unsigned char zoneSaveSemantics : 1; } _has;
}
...
@property (readonly, nonatomic) BOOL hasDestinationParentValidationEtag;
