@class CKDPContactInformation, CKDPProtectionInfo, NSString, NSData, CKDPDate, CKDPIdentifier;
...
@property (readonly, nonatomic) BOOL hasInviteNSSecTimestampDate;
@property (retain, nonatomic) CKDPDate *inviteNSSecTimestampDate;
@property (readonly, nonatomic) BOOL hasAcceptedNSSecTimestampDate;
@property (retain, nonatomic) CKDPDate *acceptedNSSecTimestampDate;
@property (readonly, nonatomic) BOOL hasCustomRole;
