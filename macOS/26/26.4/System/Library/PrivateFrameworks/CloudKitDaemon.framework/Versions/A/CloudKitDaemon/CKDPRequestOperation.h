@class CKDPRecordRetrieveVersionsRequest, CKDPAdopterCapabilitiesSaveRequest, CKDPSubscriptionCreateRequest, CKDPNotificationSyncRequest, CKDPZoneDescendantsRetrieveRequest, CKDPRequestOperationHeader, CKDPUserRetrieveRequest, CKDPMergeableDeltaRetrieveRequest, CKDPRecordDeleteRequest, CKDPZoneRetrieveChangesRequest, CKDPSharePcsIdentityRequest, CKDPAdopterCapabilitiesCheckRequest, CKDPShareAcceptRequest, CKDPShareUsageSaveRequest, CKDPFetchArchivedRecordsRequest, CKDPSubscriptionRetrieveRequest, CKDPBundlesForContainerRequest, CKDPMergeableDeltaReplaceRequest, CKDPMergeableDeltaSaveRequest, CKDPUserPrivacySettingsUpdateRequest, CKDPRecordRetrieveChangesRequest, CKDPMergeableDeltaMetadataRetrieveRequest, CKDPQueryRetrieveRequest, CKDPZoneUsageSaveRequest, CKDPZoneDeleteRequest, CKDPMarkAssetBrokenRequest, CKDPUserPrivacySettingsResetRequest, CKDPSubscriptionDeleteRequest, CKDPAnonymousShareRemoveRequest, CKDPDeleteContainerRequest, CKDPArchiveRecordsRequest, CKDPSetBadgeCountRequest, CKDPUserAvailableQuotaRequest, CKDPRecordResolveTokenRequest, CKDPZoneSaveRequest, CKDPZoneRetrieveAncestorsRequest, CKDPShareSelfRemoveRequest, CKDPAssetUploadTokenRetrieveRequest, CKDPShareAccessRequest, CKDPUserPrivacySettingsRetrieveRequest, CKDPUserPrivacySettingsBatchLookupRequest, CKDPRecordRetrieveRequest, CKDPWebAuthTokenRetrieveRequest, CKDPCodeFunctionInvokeRequest, CKDPTokenRegistrationRequest, CKDPUserQueryRequest, CKDPRecordMoveRequest, CKDPRecordSaveRequest, CKDPUpdateMissingAssetStatusRequest, CKDPAnonymousShareAddRequest, CKDPNotificationMarkReadRequest, CKDPOperation, CKDPTokenUnregistrationRequest, CKDPZoneRetrieveRequest, CKDPShareDeclineRequest, CKDPShareVettingInitiateRequest;
...
@property (readonly, nonatomic) BOOL hasZoneRetrieveAncestorsRequest;
@property (retain, nonatomic) CKDPZoneRetrieveAncestorsRequest *zoneRetrieveAncestorsRequest;
@property (readonly, nonatomic) BOOL hasZoneDescendantsRetrieveRequest;
...
@property (readonly, nonatomic) BOOL hasShareSelfRemoveRequest;
