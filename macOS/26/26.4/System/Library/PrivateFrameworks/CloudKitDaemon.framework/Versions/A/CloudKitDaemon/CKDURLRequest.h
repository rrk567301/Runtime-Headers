...
+ (BOOL)isZoneNotFoundError:(id)a0;
...
- (void)_noteZonesAndSharesUsedForOperation:(id)a0 container:(id)a1;
...
- (void)_requestWillComplete:(id /* block */)a0;
...
- (void)addFailedRecordID:(id)a0;
- (void)addFailedZoneID:(id)a0;
...
- (id)notFailedRecordIDsIn:(id)a0 inZones:(id)a1;
- (id)notFailedZoneIDsIn:(id)a0;
