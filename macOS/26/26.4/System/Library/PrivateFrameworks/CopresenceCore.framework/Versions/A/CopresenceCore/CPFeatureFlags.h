...
@property (readonly, nonatomic) BOOL zoneHierarchiesEnabled;
...
@property (readonly, nonatomic) BOOL wranglerHomePodBoopEnabled;
...
@property (readonly, nonatomic) BOOL fastSyncFirewallDonation;
