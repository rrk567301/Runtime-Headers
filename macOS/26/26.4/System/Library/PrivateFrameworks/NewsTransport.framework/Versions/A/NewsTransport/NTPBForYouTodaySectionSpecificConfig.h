@interface NTPBForYouTodaySectionSpecificConfig : PBCodable <NSCopying> {
    struct { unsigned char cutoffTime : 1; unsigned char feedItemMaxCount : 1; unsigned char feedMaxCount : 1; unsigned char headlinesPerFeedFetchCount : 1; unsigned char localNewsPromotionIndex : 1; unsigned char minimumUpdateInterval : 1; unsigned char subscriptionsFetchCount : 1; unsigned char subscriptionsMinCount : 1; unsigned char fetchingBin : 1; unsigned char stabilizeAcrossRefreshes : 1; } _has;
}
...
@property (nonatomic) BOOL hasFeedItemMaxCount;
@property (nonatomic) unsigned long long feedItemMaxCount;
@property (nonatomic) BOOL hasSubscriptionsMinCount;
