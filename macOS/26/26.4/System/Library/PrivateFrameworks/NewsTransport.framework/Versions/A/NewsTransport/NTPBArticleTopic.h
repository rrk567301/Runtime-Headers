...
@interface NTPBArticleTopic : PBCodable <NSCopying> {
    struct { unsigned char flowRate : 1; unsigned char ontologyLevel : 1; unsigned char quality : 1; unsigned char subscriptionRate : 1; unsigned char hardFollowRequiredForGrouping : 1; unsigned char isDisallowedFromGrouping : 1; unsigned char isEligibleForFeaturePromotion : 1; unsigned char isEligibleForFoodGrouping : 1; unsigned char isEligibleForFoodGroupingIfAutofavorited : 1; unsigned char isEligibleForFoodGroupingIfFavorited : 1; unsigned char isEligibleForGrouping : 1; unsigned char isEligibleForGroupingIfAutofavorited : 1; unsigned char isEligibleForGroupingIfFavorited : 1; unsigned char isHidden : 1; unsigned char isManagedTopic : 1; unsigned char isManagedTopicWinner : 1; } _has;
}
...
@property (nonatomic) BOOL hasIsEligibleForFeaturePromotion;
@property (nonatomic) BOOL isEligibleForFeaturePromotion;
