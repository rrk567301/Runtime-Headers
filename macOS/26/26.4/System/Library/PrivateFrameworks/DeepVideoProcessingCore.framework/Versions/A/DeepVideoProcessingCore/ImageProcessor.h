...
- (long long)preserveCMAttachmentFirstFrame:(struct __CVBuffer { } *)a0 secondFrame:(struct __CVBuffer { } *)a1;
- (void)releaseNormalizedBuffers;
- (long long)restoreCMAttachmentToFirstFrame:(struct __CVBuffer { } *)a0 secondFrame:(struct __CVBuffer { } *)a1;
