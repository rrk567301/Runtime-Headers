...
- (void)_finallyQueryProgramsForSystemAccountsWithPlatforms:(unsigned long long)a0 credentials:(id)a1 betaEnrollmentTokens:(id)a2 shouldSavePrograms:(BOOL)a3 disableBuildPrefixMatching:(BOOL)a4 language:(id)a5 completion:(id /* block */)a6;
...
- (void)_queryProgramsForSystemAccountsWithPlatforms:(unsigned long long)a0 disableBuildPrefixMatching:(BOOL)a1 language:(id)a2 completion:(id /* block */)a3;
...
- (void)enrollInProgramWithToken:(id)a0 userIdentifier:(id)a1 language:(id)a2 completion:(id /* block */)a3;
- (void)enrollInProgramWithToken:(id)a0 userIdentifier:(id)a1 language:(id)a2 shouldSaveToken:(BOOL)a3 completion:(id /* block */)a4;
...
- (void)system_enrolledBetaProgramWithCompletion:(id /* block */)a0;
- (id)system_enrolledBetaProgramWithError:(id *)a0;
