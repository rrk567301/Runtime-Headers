...
- (void).cxx_destruct;
- (id)init;
- (id)initWithForYouTodaySectionSpecificConfig:(id)a0 appConfiguration:(id)a1 topStoriesChannelID:(id)a2 localNewsTagID:(id)a3 hiddenFeedIDs:(id)a4 allowPaidBundleFeed:(BOOL)a5 mutedTagIDs:(id)a6 purchasedTagIDs:(id)a7 rankedAllSubscribedTagIDs:(id)a8 paidAccessChecker:(id)a9 throttlingIdentifier:(id)a10;
