...
- (id)aggregateSections:(id)a0 itemsBySectionDescriptor:(id)a1 budgetInfo:(id)a2 todayData:(id)a3 lastEntrySnapshot:(id)a4;
...
- (id)init;
- (id)_itemsForSection:(id)a0 items:(id)a1 todayData:(id)a2 budgetInfo:(id)a3 previouslyChosenItems:(id)a4 priorClusterIDsInOtherSections:(id)a5 sectionItemsLimit:(unsigned long long)a6 otherArticleIDs:(id)a7 lastEntryItems:(id)a8 remainingSlots:(double)a9 slotsUsed:(double *)a10 noMoreItemsToGive:(BOOL *)a11 noRoomForMoreItems:(BOOL *)a12 debugInspection:(id *)a13;
