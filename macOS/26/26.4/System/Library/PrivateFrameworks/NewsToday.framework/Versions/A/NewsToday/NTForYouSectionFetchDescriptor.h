...
@property (readonly, nonatomic) BOOL stabilizeAcrossRefreshes;
...
- (id)initWithForYouConfiguration:(id)a0 appConfiguration:(id)a1 topStoriesChannelID:(id)a2 localNewsTagID:(id)a3 hiddenFeedIDs:(id)a4 allowPaidBundleFeed:(BOOL)a5 mutedTagIDs:(id)a6 purchasedTagIDs:(id)a7 rankedAllSubscribedTagIDs:(id)a8 paidAccessChecker:(id)a9 groupingService:(id)a10;
- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void)configureCatchUpOperationWithFetchRequest:(id)a0;
- (void).cxx_destruct;
- (id)init;
- (id)incrementalLimitTransformationWithFeedPersonalizer:(id)a0 limit:(unsigned long long)a1 priorFeedItems:(id)a2 lastEntryItems:(id)a3;
