...
- (void).cxx_destruct;
- (id)initWithSectionConfig:(id)a0 appConfiguration:(id)a1 topStoriesChannelID:(id)a2 hiddenFeedIDs:(id)a3 allowPaidBundleFeed:(BOOL)a4 todayData:(id)a5 supplementalFeedFilterOptions:(unsigned long long)a6 groupingService:(id)a7;
- (id)init;
