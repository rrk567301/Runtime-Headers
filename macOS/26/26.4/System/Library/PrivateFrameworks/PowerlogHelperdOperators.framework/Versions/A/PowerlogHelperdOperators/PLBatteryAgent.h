...
@property (retain) PLTimer *slowChargerDebouncingTimer;
@property BOOL isSlowCharger;
@property int slowChargerNotificationToken;
...
- (void)updateAndNotifySlowChargerState;
...
- (void)registerSlowChargerNotificationToken;
...
- (void)showOrHideTLCNotification:(BOOL)a0 meetsTLCNotificationConditions:(BOOL)a1;
- (void)showOrHideTLCNotification:(BOOL)a0 timeInTLC:(double)a1;
- (void)slowChargerIsDebounced;
- (void)startSlowChargerDebounce;
