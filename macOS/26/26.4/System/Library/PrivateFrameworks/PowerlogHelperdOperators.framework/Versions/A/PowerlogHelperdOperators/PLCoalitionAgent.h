@class PLStateTrackingComposition, NSString, NSDictionary, PLEntryNotificationOperatorComposition, NSDate, PLNSNotificationOperatorComposition, PLTimer;
...
- (void)logCoalitionObjectMemory:(id)a0 withOSMetrics:(BOOL)a1;
- (void)logEventIntervalCoalitionIntervalWithHFLFlag:(BOOL)a0;
- (void)logEventIntervalCoalitionIntervalWithoutHighFreqLogging;
- (void)logOSMetrics:(id)a0 withEndObject:(id)a1;
- (void)logOsMetricsMemory:(id)a0 withData:(id)a1;
