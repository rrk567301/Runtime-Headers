...
- (void)logEventBackwardProcessExitHistogram:(id)a0 withStats:(struct { id x0; struct _launch_service_stats_record *x1; unsigned int x2; unsigned int x3; } *)a1 withDate:(id)a2;
...
- (void)logEventPointProcessExit:(id)a0 excludeProcesses:(id)a1 withStats:(struct { id x0; struct _launch_service_stats_record *x1; unsigned int x2; unsigned int x3; } *)a2 withDate:(id)a3 withNowInSec:(unsigned long long)a4;
