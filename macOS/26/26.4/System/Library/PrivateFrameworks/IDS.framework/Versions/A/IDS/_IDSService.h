@class NSMutableDictionary, NSMapTable, IDSAccount, NSDictionary, CUTDeferredTaskQueue, IDSServiceProperties, IDSAccountController, NSMutableArray, NSString, NSSet, IDSQuickSwitchAcknowledgementTracker, NSMutableSet, IDSSession, NSArray, IDSGroupContextController;
...
- (void)finishedVerifyingBatchedSignedDataForRequest:(id)a0 results:(id)a1 error:(id)a2;
...
- (void)beginLocalNetworkHandshakeFromAccount:(id)a0 destinations:(id)a1 options:(id)a2;
...
- (void)connection:(id)a0 account:(id)a1 didReceiveLocalNetworkHandshake:(BOOL)a2 fromID:(id)a3 context:(id)a4;
...
- (void).cxx_destruct;
- (void)verifySignedPayloads:(id)a0 forAlgorithm:(long long)a1 options:(id)a2 completion:(id /* block */)a3;
...
- (void)connection:(id)a0 incomingBatchMessage:(id)a1;
...
- (BOOL)sendBatchMessageProcessedContext:(id)a0;
...
- (void)connection:(id)a0 account:(id)a1 inviteDroppedForSessionID:(id)a2 fromID:(id)a3 context:(id)a4 error:(id)a5;
