...
- (void)setForceTCPFallbackOnCellUsingReinitiate:(BOOL)a0;
- (void)setForceTCPFallbackOnWiFiUsingReinitiate:(BOOL)a0;
...
- (void)updateMembers:(id)a0 withContext:(id)a1 messagingCapabilities:(id)a2 triggeredLocally:(BOOL)a3 requestUUID:(id)a4;
...
- (void)updateParticipantType:(unsigned short)a0 members:(id)a1 withContext:(id)a2 triggeredLocally:(BOOL)a3 timestamp:(double)a4 identifier:(unsigned long long)a5;
