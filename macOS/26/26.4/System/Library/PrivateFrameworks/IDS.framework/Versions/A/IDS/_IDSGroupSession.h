@class NSMutableDictionary, NSDictionary, NSObject, NSMutableArray, IDSGroupEncryptionKeyMaterialCache, CUTWeakReference, NSString, NSSet, IDSBaseSocketPairConnection, NSMutableSet, NSArray, NSNumber, NSError;
...
- (unsigned long long)_getParticipantIDForAliasFromCache:(unsigned long long)a0 salt:(id)a1;
