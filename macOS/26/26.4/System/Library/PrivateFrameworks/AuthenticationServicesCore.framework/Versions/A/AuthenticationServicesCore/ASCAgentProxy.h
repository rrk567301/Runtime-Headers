...
- (void)browserPasskeysForRelyingParty:(id)a0 testOptions:(id)a1 completionHandler:(id /* block */)a2;
- (void)deletePasskeyForRelyingParty:(id)a0 withCredentialID:(id)a1 completionHandler:(id /* block */)a2;
- (void)getEnabledCredentialProviderAppBundleIDsWithCompletionHandler:(id /* block */)a0;
- (id)initWithEndpoint:(id)a0 activity:(id)a1 failureHandler:(id /* block */)a2;
- (BOOL)isDeviceConfiguredForPasskeysWithTestOptions:(id)a0;
...
- (void)_getSavedAccountContextFromSafariApplicationWithRequestContext:(id)a0 completionHandler:(id /* block */)a1;
- (id)_remoteObjectProxyForSynchronousCalls:(BOOL)a0 withErrorHandler:(id /* block */)a1;
...
- (void)getIsDeviceConfiguredForPasskeysWithTestOptions:(id)a0 completionHandler:(id /* block */)a1;
