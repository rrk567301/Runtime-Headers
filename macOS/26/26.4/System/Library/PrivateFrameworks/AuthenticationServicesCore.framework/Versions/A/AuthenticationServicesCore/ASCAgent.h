@class SFCredentialProviderExtensionManager, _TtC26AuthenticationServicesCore23ASCRelatedOriginFetcher, _TtC26AuthenticationServicesCore38ASCPasskeyAccountRegistrationUserState, ASCAuthorizationTrafficController, NSObject, NSDictionary, NSMutableArray, _TtC26AuthenticationServicesCore13ASCABLEClient, NSString, NSSet, ASCCredentialRequestContext, WBSSavedAccountContext, NSXPCListener, _TtC26AuthenticationServicesCore30ASPasswordSignInEventCollector, NSArray, NSNumber, NSXPCConnection, NSError, NSUUID;
...
+ (BOOL)isClientWithAuditTokenAWebBrowser:(struct { unsigned int x0[8]; })a0;
+ (void)getEnabledCredentialProviderAppBundleIDsWithConnection:(NSXPCConnection *)a0 extensionManager:(SFCredentialProviderExtensionManager *)a1 completionHandler:(void (^)(NSSet *, NSError *))a2;
+ (BOOL)isClientEntitledWebBrowserWithConnection:(id)a0 testOptions:(id)a1;
+ (BOOL)isClientTCCAuthorizedWebBrowserWithConnection:(id)a0 testOptions:(id)a1;
+ (BOOL)validatePresenceOfTestOptions:(id)a0;
...
- (void)_configurePasswordCredentialsWithTestOptions:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_credentialRequestedForPasskeyAccountRegistrationLoginChoice:(id)a0 authenticatedContext:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)authorizationPresenterDidIgnorePINRequest:(id)a0;
...
- (void)test_prepareForAuthorizationRequestsForContext:(id)a0 clientConnection:(id)a1 withPresentationHandler:(id /* block */)a2;
...
- (BOOL)test_urlMatchesRequestOrigin:(id)a0 forRequestContext:(id)a1;
