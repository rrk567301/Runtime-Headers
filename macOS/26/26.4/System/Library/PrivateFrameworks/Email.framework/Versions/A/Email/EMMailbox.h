@class NSURL, NSString, EMMailboxObjectID, EMMailboxRepository, EMReceivingAccount, EMObjectID;
...
- (void)_commonInitName:(id)a0 accountIdentifier:(id)a1 type:(long long)a2 canContainMessages:(BOOL)a3 parentID:(id)a4 builder:(id /* block */)a5;
