...
- (void)start;
- (void)dealloc;
- (id)initWithSearchString:(id)a0 filterQueries:(id)a1 bundleID:(id)a2 keyboardLanguage:(id)a3 updatedSuggestion:(id)a4 generateSuggestions:(BOOL)a5 logDescription:(id)a6 resultLimit:(unsigned long long)a7 suggestionLimit:(unsigned long long)a8 customFlags:(id)a9 feedbackQueryID:(long long)a10 sessionID:(id)a11 queryID:(id)a12;
...
- (void)_searchFoundInstantAnswers:(id)a0;
- (void)_searchFoundItems:(id)a0;
- (void)_searchFoundSuggestions:(id)a0;
- (void)_searchHasAttributedQuery:(id)a0;
