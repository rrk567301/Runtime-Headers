...
@interface SCROBrailleLine : NSObject <BRLTBrailleTranslationDelegateProtocol, BRLTBrailleStateManagerDelegate, BRLTBrailleModelDelegate> {
    ...
    BOOL _shouldTruncateAtPanBoundary;
    char *_displayBuffer;
    ...
    BOOL _hasNonemptyCanvas;
    SCRO2DBraillePlane *_braillePlane;
    BOOL _isZoomOutActive;
    NSLock *_flushLock;
...
@property (nonatomic) BOOL shouldForceLinearOutput;
...
- (BOOL)_selectBrailleRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 selectionBegin:(out long long *)a1 selectionEnd:(out long long *)a2;
- (long long)_selectionForOffsetIndex:(long long)a0;
- (BOOL)_setMainCells:(const char *)a0 length:(long long)a1;
- (BOOL)_setMainCells:(const char *)a0 length:(long long)a1 forZoomOut:(BOOL)a2;
- (void)_updateOffsets;
...
- (void)planarPanLeft;
- (void)planarPanRight;
- (BOOL)selectContiguousBrailleRange:(unsigned long long)a0 selectionBegin:(out long long *)a1 selectionEnd:(out long long *)a2;
- (BOOL)selectEntireLine:(out long long *)a0 selectionEnd:(out long long *)a1;
- (BOOL)selectUpToRouterIndex:(unsigned long long)a0 selectionBegin:(out long long *)a1 selectionEnd:(out long long *)a2;
