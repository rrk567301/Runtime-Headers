...
@property (readonly, nonatomic) BOOL shouldBulkSelectPrepopulatedBraille;
...
- (id)initWithIdentifier:(id)a0 label:(id)a1 prepopulatedBraille:(id)a2 shouldBulkSelect:(BOOL)a3;
