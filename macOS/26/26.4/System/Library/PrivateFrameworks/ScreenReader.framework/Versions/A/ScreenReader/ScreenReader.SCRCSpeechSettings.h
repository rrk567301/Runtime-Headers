...
- (long long)getPitchForVoiceId:(id)a0;
- (long long)getRateForVoiceId:(id)a0;
- (long long)getVolumeForVoiceId:(id)a0;
- (id)languageForVoice:(id)a0;
- (id)languagesInRotor;
- (id)nameForVoice:(id)a0 userDefineName:(id)a1;
- (void)setPitch:(long long)a0 forVoiceId:(id)a1;
- (void)setRate:(long long)a0 forVoiceId:(id)a1;
- (void)setVolume:(long long)a0 forVoiceId:(id)a1;
