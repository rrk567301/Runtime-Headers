...
@interface BRLTBrailleModelInternal : NSObject {
    ...
    void /* unknown type, empty encoding */ hasReceivedMaskedCharacter;
    ...
    void /* unknown type, empty encoding */ _editable;
    ...
    void /* unknown type, empty encoding */ uncommittedBrailleCharCount;
    void /* unknown type, empty encoding */ switchedToEditableWithUncommittedBraille;
