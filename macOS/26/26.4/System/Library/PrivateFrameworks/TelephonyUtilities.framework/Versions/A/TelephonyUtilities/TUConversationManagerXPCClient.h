...
- (void)setLocalParticipantCluster:(id)a0 forConversation:(id)a1;
...
- (void)createActivitySession:(id)a0 onConversation:(id)a1 options:(unsigned long long)a2;
- (oneway void)didChangeConversationAdvertisement:(id)a0;
...
- (void)setDownlinkMuted:(BOOL)a0 forParticipants:(id)a1 inConversation:(id)a2 completionHandler:(id /* block */)a3;
...
- (oneway void)updatePseudonymsByCallUUID:(id)a0;
...
- (void)buzzMember:(id)a0 destinationID:(id)a1 invitationContext:(id)a2 conversation:(id)a3;
...
- (void)requestScreenSharingPickerForCallUUID:(id)a0 withContentStyle:(long long)a1;
...
- (void)dealloc;
- (void)addRemoteMembers:(id)a0 otherInvitedHandles:(id)a1 invitationPreferences:(id)a2 toConversation:(id)a3;
