@class NSUUID, NSString, NSData, NSDate, TUConversationActivityContext, TUConversationActivityMetadata, TUHandle, TUScreenShareAttributes;
...
@property (nonatomic) BOOL requiresParticipantTranslation;
...
- (id)initWithCreationRequest:(id)a0 bundleIdentifier:(id)a1 systemActivity:(BOOL)a2 requiresParticipantTranslation:(BOOL)a3;
