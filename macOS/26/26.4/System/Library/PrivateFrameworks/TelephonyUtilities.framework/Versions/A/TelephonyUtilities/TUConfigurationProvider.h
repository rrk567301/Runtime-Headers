...
@property (readonly, nonatomic, getter=isCallHapticsAvailable) BOOL callHapticsAvailable;
@property (nonatomic, getter=isCallHapticsEnabled, setter=setCallHapticsEnabled:) BOOL callHapticsEnabled;
...
@property (readonly, nonatomic, getter=isGranularCallFilteringAvailableForFaceTime) BOOL granularCallFilteringAvailableForFaceTime;
