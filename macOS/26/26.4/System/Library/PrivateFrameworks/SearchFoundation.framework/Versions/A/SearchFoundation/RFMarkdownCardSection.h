@class SFColor, NSData, NSArray, NSString, SFCard, NSMutableDictionary, NSDictionary, SFUserReportRequest, SFCommand, SFCopyItem, SFAppEntityAnnotation;

@interface RFMarkdownCardSection : SFCardSection <RFMarkdownCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char streaming_state : 1; } _has;
}
