@class SFColor, NSData, NSArray, RFTextProperty, NSString, SFCard, NSDictionary, SFUserReportRequest, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;

@interface RFLongItemStandardCardSection : SFCardSection <RFLongItemStandardCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char is_quote : 1; unsigned char has_background_platter : 1; unsigned char is_fresh : 1; unsigned char is_markdown : 1; } _has;
}
