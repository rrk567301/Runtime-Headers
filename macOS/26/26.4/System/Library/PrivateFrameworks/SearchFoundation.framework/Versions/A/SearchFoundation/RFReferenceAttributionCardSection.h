@class NSData, NSString, NSArray, SFCard, SFUserReportRequest, SFColor, NSDictionary, SFCommand, SFAppEntityAnnotation, SFCopyItem, NSMutableDictionary;

@interface RFReferenceAttributionCardSection : SFCardSection <RFReferenceAttributionCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char attribution_type : 1; unsigned char expansion_type : 1; unsigned char add_tint : 1; } _has;
}
...
- (BOOL)hasAdd_tint;
- (BOOL)hasAttribution_type;
- (BOOL)hasExpansion_type;
