@class NSString, NSMutableDictionary, CUCoalescer, CUSystemMonitor, NSObject, CWFInterface;
...
- (void)_updateDeviceMap:(id)a0 deviceIdentifier:(id)a1 deviceAdded:(BOOL)a2;
- (void)dealloc;
