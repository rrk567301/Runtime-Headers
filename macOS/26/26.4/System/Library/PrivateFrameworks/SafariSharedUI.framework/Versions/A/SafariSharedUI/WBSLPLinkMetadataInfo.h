...
@property (readonly, nonatomic) BOOL lastFetchUsedWebView;
...
- (id)initWithURLString:(id)a0 uuidString:(id)a1 lastFetchDate:(id)a2 lastFetchDidSucceed:(BOOL)a3 metadataHasImage:(BOOL)a4 lastFetchUsedWebView:(BOOL)a5;
