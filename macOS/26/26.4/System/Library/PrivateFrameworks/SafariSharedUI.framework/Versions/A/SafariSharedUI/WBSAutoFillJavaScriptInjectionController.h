...
@property (class, readonly, nonatomic) NSString *configAsScriptSource;
@property (class, nonatomic) BOOL isRunningAutoFillTests;
...
- (void)annotateForm:(long long)a0 withValues:(id)a1 inFrame:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
- (void)autoFillControlsInForm:(long long)a0 withPassword:(id)a1 focusingControl:(id)a2 inFrame:(id)a3 webView:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)_convertFormControlMetadataInfos:(id)a0 frameContainingControl:(id)a1 mainFrame:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_formMetadataAndControlMetadataFromJavaScriptDictionary:(id)a0 controlMetadataDictionary:(id)a1 frameInfo:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
- (void)_formMetadataFromJavaScriptDictionary:(id)a0 frameContainingForm:(id)a1 mainFrame:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_handleDidAssociateFormControlsMessage:(id)a0;
- (void)_handleFormObservedChangeIndicatingFormSubmissionMessage:(id)a0;
- (void)_handleLoadMainScriptRequestMessage:(id)a0;
- (void)_handleManualAutoFillRequestMessage:(id)a0;
- (void)_handleObservedActionInFormTextField:(id)a0;
- (void)_handlePageHideMessage:(id)a0;
- (void)_injectMainScripts:(id)a0 webView:(id)a1 completionHandler:(id /* block */)a2;
- (void)_injectMainScriptsIfNeeded:(id)a0 webView:(id)a1 force:(BOOL)a2 completionHandler:(id /* block */)a3;
- (void)_loadScriptsIfNeededAndCallJavascript:(id)a0 arguments:(id)a1 inFrame:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)_processControlDictionaries:(id)a0 frameContainingControl:(id)a1 mainFrame:(id)a2 webView:(id)a3 formDictionary:(id)a4 completionHandler:(id /* block */)a5;
