...
- (void)linkAndUpdateMetadataInfoForURLString:(id)a0 lastFetchDate:(id)a1 lastFetchDidSucceed:(BOOL)a2 metadataHasImage:(BOOL)a3 lastFetchUsedWebView:(BOOL)a4 completionHandler:(id /* block */)a5;
