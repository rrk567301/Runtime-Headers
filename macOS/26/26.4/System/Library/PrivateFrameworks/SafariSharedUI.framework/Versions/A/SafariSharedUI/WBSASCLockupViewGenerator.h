...
- (void)generateLockupViewsForAvailableApps:(id)a0 lockupViewType:(long long)a1 lockupViewSize:(long long)a2 maintainRequestedOrderOfApps:(BOOL)a3 completionHandler:(id /* block */)a4;
