@class NSString, NSArray, NSURL, WBSFaviconProviderPersistenceController, NSMutableDictionary, NSCalendar, NSCountedSet, NSObject, NSCache;
...
- (void)saveFaviconImageData:(id)a0 usingWebView:(id)a1 iconURL:(id)a2 pageURL:(id)a3 originalPageURL:(id)a4 size:(struct CGSize { double x0; double x1; })a5 isPrivate:(BOOL)a6 completionHandler:(id /* block */)a7;
...
- (void)_atomicallySaveImageDataUsingInfoFromWebView:(id)a0 iconURL:(id)a1 pageURL:(id)a2 originalPageURL:(id)a3 size:(struct CGSize { double x0; double x1; })a4 isPrivate:(BOOL)a5 completionHandler:(id /* block */)a6;
- (void)_beginOperationForRequest:(id)a0 withExistingResponse:(id)a1;
- (id)_cachedResponseForRequest:(id)a0;
- (void)_confirmImageDataShouldBeSaved:(id)a0 size:(struct CGSize { double x0; double x1; })a1 pageURL:(id)a2 iconURL:(id)a3 includingPrivateData:(BOOL)a4 preferredSizeFromData:(struct CGSize { double x0; double x1; })a5 isMultiResolution:(BOOL)a6 completionHandler:(id /* block */)a7;
...
- (void)_performBlockByAllocatingWebViewIfNeeded:(id /* block */)a0 usingWebView:(id)a1;
...
- (void)_saveAfterGettingMultiResolutionInfoForImageData:(id)a0 usingWebView:(id)a1 iconURL:(id)a2 pageURL:(id)a3 originalPageURL:(id)a4 redirectedOriginalPageURL:(id)a5 size:(struct CGSize { double x0; double x1; })a6 isPrivate:(BOOL)a7 completionHandler:(id /* block */)a8;
- (void)_saveImageData:(id)a0 iconURL:(id)a1 pageURL:(id)a2 originalPageURL:(id)a3 size:(struct CGSize { double x0; double x1; })a4 isPrivate:(BOOL)a5 preferredSizeFromData:(struct CGSize { double x0; double x1; })a6 isMultiResolution:(BOOL)a7 didGenerateResolutions:(BOOL)a8 completionHandler:(id /* block */)a9;
