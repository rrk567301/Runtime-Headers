...
+ (id)deletedEventTimestampsForStream:(id)a0 account:(id)a1 device:(id)a2 bookmark:(id)a3 error:(id *)a4;
...
+ (id)latestDeleteBookmarkForStream:(id)a0 account:(id)a1 device:(id)a2 bookmark:(id)a3 error:(id *)a4;
...
+ (id)tombstonePublisherForStream:(id)a0 device:(id)a1 account:(id)a2 startTime:(id)a3 endTime:(id)a4 maxEvents:(id)a5 lastN:(id)a6 reversed:(BOOL)a7;
