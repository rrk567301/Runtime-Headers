...
@interface REMeshSkeletonDescriptor : NSObject <NSSecureCoding> {
    struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _localRestPoseScales;
    struct vector<simd_quatf, std::allocator<simd_quatf>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _localRestPoseRotations;
    struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _localRestPoseTranslations;
    struct vector<simd_float4x4, std::allocator<simd_float4x4>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _inverseBindPose;
}
