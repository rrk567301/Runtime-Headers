@interface CLPCUserClient : NSObject {
    struct CLPC { void /* function */ **_vptr$Object; unsigned int object; unsigned int connect; struct unique_ptr<char[], std::default_delete<char[]>> { struct { char *__ptr_; } ; } rpc_buffer; unsigned long long rpc_buffer_size; } clpc;
}
...
- (BOOL)setPowerTarget:(unsigned long long)a0 toTargetWatts:(float)a1 withReasonCode:(int)a2 error:(id *)a3;
