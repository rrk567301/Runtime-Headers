@interface AKFeatureManager : NSObject {
    ...
    BOOL _cachedAgeAssuranceEnabled;
    BOOL _cachedPrivacyVersionSavingEnabled;
    BOOL _cachedIsDBRTwoEnabled;
    BOOL _cachedProxBAAEnabled;
    BOOL _cachedVMProxBAAEnabled;
    BOOL _cachedPasskeyValidationFixesEnabled;
}
...
@property (readonly, nonatomic, getter=shouldForceEnableSimpleProfilesUpgradeQR) BOOL simpleProfilesUpgradeQRForceEnable;
...
@property (readonly, nonatomic, getter=isAgeAssuranceEnabled) BOOL ageAssuranceEnabled;
@property (readonly, nonatomic, getter=isPrivacyVersionSavingEnabled) BOOL privacyVersionSavingEnabled;
@property (readonly, nonatomic, getter=isProxBAAEnabled) BOOL proxBAAEnabled;
@property (readonly, nonatomic, getter=isDBRTwoEnabled) BOOL dbrTwoEnabled;
@property (readonly, nonatomic, getter=isVMProxBAAEnabled) BOOL vmProxBAAEnabled;
@property (readonly, nonatomic, getter=isTrustedDeviceIdEnabled) BOOL trustedDeviceIdEnabled;
@property (readonly, nonatomic, getter=isPasskeyValidationFixesEnabled) BOOL passkeyValidationFixesEnabled;
