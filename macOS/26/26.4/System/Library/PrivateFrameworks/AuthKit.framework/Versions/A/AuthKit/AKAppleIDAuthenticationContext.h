@class AKAuthenticatableResource, AKDevice, AKSimpleProfileContext, NSDictionary, NSObject, AKCompanionKeyEnvelope, NSString, NSSet, AKAccountMigrationContext, AKAnisetteData, NSArray, AKProtoAccountContext, NSData, NSNumber, NSUUID;
...
@property (nonatomic) BOOL _shouldSendSigningHeadersForServerUI;
@property (nonatomic) BOOL _shouldSkipAccountUpdates;
...
@property (readonly, nonatomic) BOOL isConfiguredForTokenUpgrade;
@property (copy, nonatomic) NSString *idmsData;
@property (readonly, nonatomic) BOOL isConfiguredForProfileAuthentication;
...
@property (readonly, nonatomic) BOOL needsNewSimpleProfile;
@property (readonly, nonatomic) BOOL isConfiguredForAccountCreation;
...
@property (nonatomic) BOOL biometricSkipPasscodeFallback;
...
@property (nonatomic) BOOL teenRequiredToConnectToFamily;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) BOOL cliMode;
@property (readonly, nonatomic) BOOL isContextEligibleForSilentAuth;
...
- (void)configureForThirdPartyDeviceAuthWithAppProvidedData:(id)a0;
