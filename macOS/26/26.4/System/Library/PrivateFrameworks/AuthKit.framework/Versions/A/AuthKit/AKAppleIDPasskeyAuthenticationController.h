...
@protocol OS_dispatch_group, OS_dispatch_queue, AKCredentialDataManagerProtocol;
...
- (void)_setCredentialDataManager:(id)a0;
...
- (void)updatePasskeyCredentialWithUserHandle:(id)a0 newName:(id)a1 completion:(id /* block */)a2;
