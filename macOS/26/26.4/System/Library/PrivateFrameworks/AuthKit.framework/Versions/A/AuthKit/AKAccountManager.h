...
- (void)updatePasskeyCredentialsWithAltDSID:(id)a0 username:(id)a1;
...
- (BOOL)_shouldEnableIdentifiableTelemetryForConsentVersion:(id)a0;
...
- (BOOL)_handleSaveResult:(BOOL)a0 version:(id)a1 error:(id *)a2;
- (void)setBeneficiary:(BOOL)a0 forAccount:(id)a1;
- (BOOL)isEligibleForSafetyScreenForAccount:(id)a0;
- (id)_accountTypeForServiceType:(long long)a0;
- (id)isEligibleToMigrateToChildForAccount:(id)a0;
- (BOOL)_validateConsentVersion:(id)a0 error:(id *)a1;
...
- (id)passkeyDeletionAttemptDateForAccount:(id)a0;
...
- (id)matchingServiceAccountForAuthKitAccount:(id)a0 service:(long long)a1;
...
- (BOOL)hasSimpleProfileForAccount:(id)a0;
...
- (BOOL)safetyScreenSeenForAccount:(id)a0;
...
- (id)lastSettingsRedirectDateForAccount:(id)a0;
...
- (void)setSafetyScreenSeen:(BOOL)a0 forAccount:(id)a1;
...
- (BOOL)enforceLivenessNonce:(id)a0;
...
- (BOOL)isPDPEligibleForAccount:(id)a0;
...
- (BOOL)setAppleAccountConsentVersion:(id)a0 forAccount:(id)a1 error:(id *)a2;
...
- (void)setPDPState:(id)a0 forAccount:(id)a1;
- (void)setPasskeyDeletionAttemptDate:(id)a0 forAccount:(id)a1;
- (id)appleAccountConsentVersionForAccount:(id)a0;
- (void)removeMasterTokenForAccount:(id)a0;
- (unsigned long long)_pdpStateValueForAccount:(id)a0;
...
- (unsigned long long)pdpStateValueForAccount:(id)a0;
- (void)setIsEligibleToMigrateToChild:(id)a0 forAccount:(id)a1;
- (void)setEnforceLivenessNonce:(id)a0 success:(BOOL)a1;
...
- (id)simpleProfileAuthTokenForAccount:(id)a0;
- (void)setBeneficiaryListVersion:(id)a0 forAccount:(id)a1;
- (BOOL)_setConsentVersionProperty:(id)a0 forAccount:(id)a1 error:(id *)a2;
...
- (void)setIsEligibleForSafetyScreen:(BOOL)a0 forAccount:(id)a1;
...
- (void)setHasSimpleProfile:(BOOL)a0 forAccount:(id)a1;
...
- (void)setGeoChangeRegistered:(id)a0 forAccount:(id)a1;
...
- (id)geoChangeRegisteredForAccount:(id)a0;
...
- (id)trustedDeviceIdForAccount:(id)a0;
...
- (void)setPasskeyRegistrationAttemptDate:(id)a0 forAccount:(id)a1;
...
- (BOOL)identifiableTelemetryAllowedForAccount:(id)a0;
- (void)setCanCreateSimpleProfiles:(BOOL)a0 forAccount:(id)a1;
...
- (void)setIdMSTrustedDevicesVersion:(id)a0 forAccount:(id)a1;
...
- (void)setLastSettingsRedirectDate:(id)a0 forAccount:(id)a1;
- (id)authKitAccountWithAppleID:(id)a0;
- (BOOL)privateAttestationEnabledForAccount:(id)a0;
- (id)idmsTrustedDevicesVersionForAccount:(id)a0;
...
- (void)setTrustedDeviceId:(id)a0 forAccount:(id)a1;
- (unsigned long long)_pdpStateFromRawState:(id)a0;
