...
- (void)_updateUserInformationWithContext:(id)a0 userInformation:(id)a1 isServerOperation:(BOOL)a2 completion:(id /* block */)a3;
...
- (void)fetchBAADeviceTokenWithCompletion:(id /* block */)a0;
...
- (void)performPDPNativeIntermissionWithPDPContext:(id)a0 completion:(id /* block */)a1;
- (void)performPasswordResetWithContext:(id)a0 completion:(id /* block */)a1;
- (BOOL)performPdpCompleteKeyDropWithAltDSID:(id)a0 error:(id *)a1;
- (BOOL)performPdpMigrationWithAltDSID:(id)a0 error:(id *)a1;
...
- (void)removeHomeDevicesWithContext:(id)a0 completion:(id /* block */)a1;
...
- (void)updateUserInformationWithContext:(id)a0 userInformation:(id)a1 completion:(id /* block */)a2;
- (void)upgradeSimpleProfileWithFollowUpIdentifier:(id)a0 sponsorAltDSID:(id)a1 completion:(id /* block */)a2;
