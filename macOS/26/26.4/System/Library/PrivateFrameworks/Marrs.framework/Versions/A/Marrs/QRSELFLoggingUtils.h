...
+ (id)createCCQRContextEvaluatedTier1Event:(struct QRResponse { struct vector<marrs::qr::orchestration::QRHypothesis, std::allocator<marrs::qr::orchestration::QRHypothesis>> { struct QRHypothesis *x0; struct QRHypothesis *x1; struct { struct QRHypothesis *x0; } x2; } x0; int x1; double x2; double x3; double x4; int x5; })a0 withNLXMetadata:(id)a1 andLinkId:(id)a2;
...
+ (id)createRDContextEvaluatedEvent:(struct QRResponse { struct vector<marrs::qr::orchestration::QRHypothesis, std::allocator<marrs::qr::orchestration::QRHypothesis>> { struct QRHypothesis *x0; struct QRHypothesis *x1; struct { struct QRHypothesis *x0; } x2; } x0; int x1; double x2; double x3; double x4; int x5; })a0 withNLXMetadata:(id)a1;
+ (id)createRDContextEventWrapper:(id)a0 withMetaData:(id)a1;
+ (BOOL)emitCCQREvaluatedEventWithResponse:(struct QRResponse { struct vector<marrs::qr::orchestration::QRHypothesis, std::allocator<marrs::qr::orchestration::QRHypothesis>> { struct QRHypothesis *x0; struct QRHypothesis *x1; struct { struct QRHypothesis *x0; } x2; } x0; int x1; double x2; double x3; double x4; int x5; })a0 andNLXMetadata:(id)a1;
...
+ (BOOL)emitQueryRewriteEvaluatedEventWithResponse:(struct QRResponse { struct vector<marrs::qr::orchestration::QRHypothesis, std::allocator<marrs::qr::orchestration::QRHypothesis>> { struct QRHypothesis *x0; struct QRHypothesis *x1; struct { struct QRHypothesis *x0; } x2; } x0; int x1; double x2; double x3; double x4; int x5; })a0 andNLXMetadata:(id)a1 byPredictorType:(int)a2;
