@class NSString, NSArray, UVCDeviceStreamFormat, UVCUSBDeviceStreamingInterface, UVCExtensionDevice, NSSet, UVCFrameProcessorNative, NSObject, MMAssertion, UVCExtensionStateMachine;
