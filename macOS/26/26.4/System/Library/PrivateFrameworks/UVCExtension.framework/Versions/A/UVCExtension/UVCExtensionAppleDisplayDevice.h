@class UVCDeviceControl, NSString, UVCExtensionAppleDisplayDeskViewDevice;
...
@interface UVCExtensionAppleDisplayDevice : UVCExtensionAppleDevice {
    ...
    UVCDeviceControl *_panningAnglesControl;
    UVCDeviceControl *_cameraResetControl;
    UVCDeviceControl *_centerStageFramingStyleControl;
    long long _deviceType;
    UVCExtensionAppleDisplayDeskViewDevice *_companionDeskViewVideoDevice;
}
...
- (id)companionDeviceOfType:(long long)a0;
...
- (void)setPanningAngles:(struct CGPoint { double x0; double x1; })a0;
