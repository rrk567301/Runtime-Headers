@class NSData, WiFiAwareDataSession, NSString, WiFiAwarePublisherDataSessionHandle, CUNANEndpoint, WiFiAwarePairingMetadata, NSObject, WiFiAwarePublisher, WiFiAwarePublishServiceSpecificInfo, WiFiAwarePublishDatapathServiceSpecificInfo;
