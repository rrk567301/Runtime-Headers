@class NSDate, NSString, NetworkQualityRemoteConfiguration, NSURLSession, LatencyURLSessionDelegate, NSOperationQueue, NetworkQualityConfiguration, NetworkQualityExecutionsResult, NSObject, NSMutableArray, ThroughputDelegate;
...
@interface NetworkQualityExecutions : NSObject <NSURLSessionDelegate> {
    ...
    BOOL _drainingInProgress;
    BOOL _heartbeatScheduled;
...
- (void)completeNWActivity:(id)a0 withError:(id)a1;
...
- (BOOL)isDraining;
- (BOOL)isErrorActivityCompleting:(id)a0;
- (void)reallyExecuteParallel;
- (void)reportIdleLatencyProbe:(id)a0;
- (void)reportingCompletionHandler:(id)a0;
- (void)scheduleHeartbeat;
- (void)setTimeout;
- (void)shareProgress;
- (void)validateAndAdjustRuntimeParameters:(id)a0;
