...
@interface SPSafariPlatformSupport : NSObject {
    ...
    BOOL _isObservingParentWindowVisibility;
    ...
    BOOL _hasDeliveredOneTimeCodes;
}

@property (nonatomic) BOOL hasDeliveredOneTimeCodes;
@property (weak, nonatomic) id<SPSafariPlatformSupportDeliveredOneTimeCodeAvailabilityObserver> deliveredOneTimeCodeAvailabilityObserver;
@property (readonly, nonatomic) BOOL isSecurityCodeAutoFillOfDeliveredCodesInUnannotatedContextsAvailable;
...
- (BOOL)_completionListHasContentToShow;
- (void)_addVisibleObserverToWindow:(id)a0;
- (BOOL)_appCanSupportOneTimeCodeModeDeliveredCodesOnly;
- (void)updatePartialUsername:(id)a0 inWindow:(id)a1;
- (id)_stringFromPossibleFieldEditor:(id)a0;
...
- (BOOL)_isTextFieldEmpty:(id)a0;
- (BOOL)_isTextFieldEmpty:(id)a0 valueToReturnIfNotTextField:(BOOL)a1;
- (id)_keyWindowFromPositioningView:(id)a0;
- (id)_nsWindowForUIWindow:(id)a0;
...
- (void)_resizeWindow:(id)a0 toSize:(struct CGSize { double x0; double x1; })a1;
...
- (void)updateOneTimeCodeFieldOrOtherFieldIsEmpty:(BOOL)a0 inWindow:(id)a1;
