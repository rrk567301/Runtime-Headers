...
+ (id)startPageTab;
+ (id)pinnedTabWithTitle:(id)a0 url:(id)a1;

- (id)initWithUUID:(id)a0 lastVisitTime:(id)a1;
- (BOOL)canCloseAutomaticallyForInterval:(double)a0;
- (id)initWithUUID:(id)a0;
- (id)initWithUUID:(id)a0 title:(id)a1 url:(id)a2 pinned:(BOOL)a3 pinnedTitle:(id)a4 pinnedURL:(id)a5 localAttributes:(id)a6 cookiesUUID:(id)a7 localStorageUUID:(id)a8 sessionStorageUUID:(id)a9;
- (id)_determineURL;
...
- (id)initWithUUID:(id)a0 title:(id)a1 url:(id)a2 lastVisitTime:(id)a3;
- (id)initWithUUID:(id)a0 title:(id)a1 url:(id)a2 isPrivateBrowsing:(BOOL)a3;
- (id)mutableDuplicate;
- (BOOL)isEqual:(id)a0;
