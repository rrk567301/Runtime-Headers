@class NSData, NSString, NSDate, WBSCRDTGeneration, WBBookmarkSyncData, NSUUID, NSDictionary, NSArray, WBSCRDTField, NSNumber, WBSCRDTPosition;
...
@interface WebBookmark : NSObject <NSCopying, WBBookmarkRepresentable> {
    ...
    NSString *_cookiesUUID;
    NSString *_localStorageUUID;
    NSString *_sessionStorageUUID;
...
@property (readonly, nonatomic, getter=wasLoadedFromDatabase) BOOL loadedFromDatabase;
...
@property (readonly, nonatomic) BOOL isSpecialFolder;
...
- (void)_setUUID:(id)a0;
- (void)lockFields;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 subtype:(long long)a3 collectionType:(long long)a4;
- (void)markAsRead;
...
- (id)initFolderWithParentID:(int)a0 subtype:(long long)a1 collectionType:(long long)a2;
- (id)initManagedBookmarkFolderWithTitle:(id)a0 uuid:(id)a1;
- (id)initManagedBookmarkWithTitle:(id)a0 address:(id)a1 uuid:(id)a2;
...
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 collectionType:(long long)a1;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 collectionType:(long long)a1 skipDecodingSyncData:(BOOL)a2;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 hasIcon:(BOOL)a1 collectionType:(long long)a2 skipDecodingSyncData:(BOOL)a3;
...
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 folder:(BOOL)a3 collectionType:(long long)a4;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 subtype:(long long)a3 collectionType:(long long)a4 score:(id)a5;
...
- (void)setSyncState:(id)a0 incrementGeneration:(BOOL)a1;
