@class WBSCRDTPositionGenerator, NSMutableDictionary, NSObject, NSDictionary, WBProfile, NSMutableArray, WBSDevice, WBBrowserState, WBSProfileDataManager, NSString, NSSet, NSHashTable, NSMutableSet, WBSPair, NSArray, WBTabCollection, WBParticipantPresenceCoordinator, NSCountedSet;
...
- (void).cxx_destruct;
- (id)_tabWithUUIDIncludingFallbackSearch:(id)a0;
...
- (id)initWithCollection:(id)a0 profileDataManager:(id)a1;
