...
+ (void)insertLinkSubtype:(id)a0 toAttributes:(id)a1;
...
- (void)mapPropertiesFromMetadata:(id)a0 text:(id)a1 originalURL:(id)a2 attachmentPaths:(id)a3 toAttributes:(id)a4 context:(id)a5;
