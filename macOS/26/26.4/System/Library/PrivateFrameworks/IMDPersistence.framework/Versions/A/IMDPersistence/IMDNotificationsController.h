...
- (BOOL)_chatIsMutedBasedOnChatGUID:(id)a0 chatIdentifier:(id)a1 groupID:(id)a2 domainIdentifiers:(id)a3 handles:(id)a4 lastAddressedHandleString:(id)a5 originalGroupID:(id)a6 style:(long long)a7;
...
- (BOOL)_haveMigrated;
- (BOOL)_includesNotificationReplyActionOnIOS;
- (id)_interactionDonationContextWithContent:(id)a0 chatDictionary:(id)a1 messageDictionary:(id)a2 isUrgentMessageTrigger:(BOOL)a3;
...
- (id)_messagePredicateForNewMessagesAfterDate:(long long)a0;
...
- (void)_populateEntityIdentifierOnContent:(id)a0 messageGUID:(id)a1;
...
- (BOOL)_transcodeImageAtURL:(id)a0 toJPEGAtURL:(id)a1;
- (BOOL)_useBatchFetcherForNotificationPosting;
- (BOOL)_useDateInPredicate;
...
- (BOOL)shouldDisplayGroupNameAndPhotoWith:(long long)a0 participants:(id)a1;
