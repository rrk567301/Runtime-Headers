...
- (void)_deleteSearchableItemsWithIdentifiers:(id)a0 withReason:(long long)a1 completionHandler:(id /* block */)a2;
- (void)_performSpotlightRequestWithBlock:(id /* block */)a0;
- (id)_personIdentityQueue;
- (void)_resolvedURLForItems:(id)a0;
- (void)_sanitizeIndexesForCurrentVersionIfNeededWithClientState:(id)a0 completion:(id /* block */)a1;
