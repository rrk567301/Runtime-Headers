...
- (void)loadPTaskReportsForGroups:(id)a0 excludingReasons:(id)a1 loadFullReports:(BOOL)a2 completionBlock:(id /* block */)a3;
...
- (void)scheduleGUIDs:(id)a0 flag:(unsigned long long)a1 lane:(unsigned long long)a2 reason:(long long)a3 userInfo:(id)a4 completionBlock:(id /* block */)a5;
