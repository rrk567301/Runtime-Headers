@class NSArray, NSMapTable, NSString, NSLock, IMDIndexThrottlingController;

@interface IMDIndexingController : NSObject <IMDIndexingQueries>

@property (class, readonly, nonatomic) IMDIndexingController *sharedController;

@property (readonly, nonatomic) NSLock *indexingDisabledLock;
@property (nonatomic, getter=isIndexingDisabled) BOOL indexingDisabled;
...
- (id)_integrationsRespondingToSelector:(SEL)a0;
- (BOOL)_itemDonationTriggersChatPostProcessingForContext:(id)a0;
...
- (void)_performManagerOperationWithSelector:(SEL)a0 invokeSynchronously:(BOOL)a1 invokeBlock:(id /* block */)a2 completionBlock:(id /* block */)a3;
...
- (id)initWithIntegrations:(id)a0 throttlingController:(id)a1;
