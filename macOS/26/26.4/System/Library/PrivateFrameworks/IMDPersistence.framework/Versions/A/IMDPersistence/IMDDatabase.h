...
@interface IMDDatabase : NSObject <IMDMigrationQueries, IMDImportExportQueries, IMDRecoverableQueries, IMDLegacyAttachmentQueries, IMDKeyValueQueries, IMDNotificationQueries, IMDLegacyChatQueries, IMDLegacyMessageQueries, IMDContactQueries, IMDDatabaseQueries, IMDHandleQueries>
...
- (void)reassignIdentifierForMessageWithGUID:(id)a0 newGUID:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)_queryForMessageRecordCountWithMessageWhereClause:(id)a0 chatWhereClause:(id)a1 limit:(long long)a2;
...
- (BOOL)_shouldDisplayGroupNameAndPhotoWithRecord:(id)a0;
...
- (void)copyChatRecordsWithHandles:(id)a0 displayName:(id)a1 identifier:(id)a2 domain:(id)a3 style:(long long)a4 everOnServices:(id)a5 completionHandler:(id /* block */)a6;
- (void)copyChatsFromSortedIdentifiers:(id)a0 completionHandler:(id /* block */)a1;
- (void)copyChatsWithGroupedHandles:(id)a0 style:(long long)a1 displayName:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)exportAttachmentRecordBatchWithExportConfiguration:(id)a0 batchIterationKeys:(id)a1 completionHandler:(id /* block */)a2;
- (void)exportChatRecordBatchWithExportConfiguration:(id)a0 batchIterationKeys:(id)a1 completionHandler:(id /* block */)a2;
- (void)exportHandleRecordBatchWithExportConfiguration:(id)a0 batchIterationKeys:(id)a1 completionHandler:(id /* block */)a2;
- (void)exportMessageRecordBatchWithExportConfiguration:(id)a0 state:(id)a1 chatRowIDs:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)fetchDeletedMessageRowIDs:(id)a0 completionHandler:(id /* block */)a1;
- (void)fetchDonationProgressWithCompletionHandler:(id /* block */)a0;
...
- (void)fetchMessageGUIDsForChatWithGUID:(id)a0 chatMessageLimit:(long long)a1 completionHandler:(id /* block */)a2;
- (void)fetchMessageRecordCountFilteredUsingPredicate:(id)a0 inChatsFilteredUsingPredicate:(id)a1 limit:(unsigned long long)a2 completionHandler:(id /* block */)a3;
- (void)fetchMessageRecordCountForChatRecordWithGUID:(id)a0 filteredUsingPredicate:(id)a1 limit:(unsigned long long)a2 completionHandler:(id /* block */)a3;
...
- (void)fetchPredictedFinalProgressCountsForExportingRecordTypes:(unsigned long long)a0 withExportConfiguration:(id)a1 chatRowIDs:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)isRecoverablyDeletedMessageGUID:(id)a0 completionHandler:(id /* block */)a1;
- (id)loadRecoverableMessagesMetadataGroupedByChatGUID;
- (void)markMessageRecordsAsReadWithGUIDs:(id)a0;
- (void)markMessagesAsIndexedStartingAtRowID:(long long)a0 throughToRowID:(long long)a1 completionHandler:(id /* block */)a2;
- (void)markMessagesAsIndexedWithGUIDs:(id)a0 completionHandler:(id /* block */)a1;
- (void)markMessagesAsNeedingSelectiveReindexingWithGUIDs:(id)a0 completionHandler:(id /* block */)a1;
- (void)moveMessageRecordsToRecoveryForMessageGUIDs:(id)a0 deleteDate:(id)a1;
- (void)notifyDatabaseMergeComplete;
- (void)performImportedAccountMigrationsWithChatReplacementPairs:(id)a0 messageReplacementPairs:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)rebuildIndexStateMetricsWithCompletionHandler:(id /* block */)a0;
