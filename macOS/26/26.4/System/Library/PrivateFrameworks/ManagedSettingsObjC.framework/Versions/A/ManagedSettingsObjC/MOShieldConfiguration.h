@class NSData, MOShieldLabel, NSArray;
...
- (id)initWithBackgroundColorData:(id)a0 backgroundEffectData:(id)a1 iconData:(id)a2 title:(id)a3 subtitle:(id)a4 primaryButtonLabel:(id)a5 primaryButtonColorData:(id)a6 secondaryButtonLabel:(id)a7 secondaryButtonSubmenuItems:(id)a8;
