...
@interface ADJasperPointCloud : NSObject {
    struct JasperPointCloud { struct unique_ptr<unsigned char[], std::default_delete<unsigned char[]>> { struct { char *__ptr_; } ; } m_ownedStorage; struct JasperPointCloudDataHeader *m_header; unsigned long long m_capacity; } _pc;
...
+ (id)pointCloudFromCSVString:(id)a0;
+ (id)pointCloudFromFile:(id)a0;
+ (id)pointCloudFromJSPP:(id)a0;
+ (id)pointCloudFromPlistData:(id)a0;
