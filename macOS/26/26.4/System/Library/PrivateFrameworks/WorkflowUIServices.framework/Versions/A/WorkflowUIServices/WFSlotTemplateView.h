...
@interface WFSlotTemplateView : NSView <WFSlotTemplateLayoutManagerDelegate, WFSlotTemplateTextStorageDelegate, WFSlotTemplateTypingTextViewDelegate, WFSlotTextAttachmentObserver, NSGestureRecognizerDelegate>
...
- (void)slotTemplateLayoutManagerDidInvalidateLayout:(id)a0;
...
- (void)updateTintColorInTextStorageAnimated:(BOOL)a0;
