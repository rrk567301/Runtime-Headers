...
+ (id)iconWithTypeID:(id)a0 size:(struct CGSize { double x0; double x1; })a1;
...
- (id)_imageWithSystemName:(id)a0 size:(struct CGSize { double x0; double x1; })a1 masked:(BOOL)a2;
- (id)_imageWithTypeID:(id)a0 size:(struct CGSize { double x0; double x1; })a1 masked:(BOOL)a2;
...
- (id)initWithTypeID:(id)a0 size:(struct CGSize { double x0; double x1; })a1;
- (id)maskedImage;
- (id)unmaskedImage;
