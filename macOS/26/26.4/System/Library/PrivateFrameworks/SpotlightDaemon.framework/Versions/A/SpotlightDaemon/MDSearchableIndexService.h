...
@property (nonatomic) BOOL allowCarPlayApps;
...
- (BOOL)processReportDonationProgressMessage:(id)a0;
...
- (void)_deleteAllSearchableItemsWithBundleID:(id)a0 protectionClass:(id)a1 shouldGC:(BOOL)a2 options:(long long)a3 deleteAllReason:(long long)a4 completionHandler:(id /* block */)a5;
...
- (BOOL)processFetchIndexingPipelineCompletenessMessage:(id)a0;
