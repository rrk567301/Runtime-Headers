@class SPCoreSpotlightIndexer, NSString, CSDonationProgressStreamRecorder, NSSet, CNContact, NSMutableArray, NSObject, NSMutableSet, NSMapTable;
...
+ (id)_clientDonationProgressAttributeWithName:(id)a0;
...
- (BOOL)_startInternalQueryWithIndex:(struct __SI { } *)a0 query:(id)a1 fetchAttributes:(id)a2 forBundleIds:(id)a3 maxCount:(unsigned long long)a4 resultQueue:(id)a5 postFilter:(id)a6 clientBundleID:(id)a7 resultsHandler:(id /* block */)a8;
...
- (void)updateDerivedIsToMeRankingNot:(BOOL)a0 nameTokens:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
- (BOOL)_hasPurgeableTouchFile;
- (BOOL)_startInternalQueryWithIndex:(struct __SI { } *)a0 query:(id)a1 fetchAttributes:(id)a2 forBundleIds:(id)a3 maxCount:(unsigned long long)a4 resultQueue:(id)a5 resultsHandler:(id /* block */)a6;
...
- (void)updateDerivedIsMeRankingToken:(BOOL)a0 nameTokens:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (BOOL)_startInternalQueryWithIndex:(struct __SI { } *)a0 query:(id)a1 liftingRules:(id)a2 fetchAttributes:(id)a3 forBundleIds:(id)a4 maxCount:(unsigned long long)a5 resultQueue:(id)a6 postFilter:(id)a7 clientBundleID:(id)a8 resultsHandler:(id /* block */)a9;
...
- (void)updateDerivedIsToMeRanking:(BOOL)a0 nameTokens:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (void)updateDerivedIsMeRankingPreExtractionNot:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
- (void)updateDerivedIsMeRankingSpan:(BOOL)a0 fullName:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
- (BOOL)toSendMeCard;
- (int)openIndex:(BOOL)a0;
- (void)_scheduleStringsCleanupForBundleID:(id)a0;
- (void)updateDerivedIsMeRankingTextContentMatchTokens:(BOOL)a0 nameTokens:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (void)updateDerivedIsFromMeNot:(BOOL)a0 fullName:(id)a1 emails:(id)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (void)revokeExpiredItems:(id)a0 expirationRef:(BOOL *)a1;
- (void)updateDerivedIsMeTextContentMatch:(BOOL)a0 nameTokens:(id)a1 alias:(id)a2 onlyIfNotAlready:(BOOL)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
- (void)updateDerivedIsMeRankingNot:(BOOL)a0 nameTokens:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
- (void)updateContainersAndScores:(BOOL)a0 group:(id)a1 forceMerge:(BOOL)a2;
- (void)issuePriorityIndexFixupOn:(id)a0 key:(id)a1;
- (void)updateDerivedMeAll:(BOOL)a0 runAllStates:(BOOL)a1 runOtherFixups:(BOOL)a2 force:(BOOL)a3 group:(id)a4 state:(long long)a5 context:(id)a6 completion:(id /* block */)a7;
- (void)updateDerivedIsMeRankingOCRTextContentMatch:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 onlyIfNotAlready:(BOOL)a4 group:(id)a5 forceMerge:(BOOL)a6 context:(id)a7;
- (void)powerStateChanged;
- (void)deleteAllInteractionsWithBundleID:(id)a0 completionHandler:(id /* block */)a1;
- (void)updateDerivedIsToMeNot:(BOOL)a0 fullName:(id)a1 emails:(id)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (BOOL)_startInternalQueryWithIndex:(struct __SI { } *)a0 query:(id)a1 fetchAttributes:(id)a2 forBundleIds:(id)a3 resultQueue:(id)a4 resultsHandler:(id /* block */)a5;
- (void)readyIndex:(BOOL)a0;
- (BOOL)issuePriorityIndexFixup;
- (void)updateDerivedIsMeRankingOCR:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 onlyIfNotAlready:(BOOL)a4 group:(id)a5 forceMerge:(BOOL)a6 context:(id)a7;
...
- (void)resumeIndex;
- (void)updateDerivedIsMeRanking:(BOOL)a0 nameTokens:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
- (void)fetchAllCompletedBundleIDsForIndexerTask:(id)a0 completionHandler:(id /* block */)a1;
- (void)removeDerivedMeDebug:(BOOL)a0 group:(id)a1 forceMerge:(BOOL)a2 context:(id)a3;
...
- (void)updateDerivedIsMeRankingSpanNot:(BOOL)a0 fullName:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
...
- (void)updateDerivedIsMeRankingTextContentMatchTokensNot:(BOOL)a0 nameTokens:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
- (void)runOtherFixups:(id)a0 state:(long long)a1;
- (void)resendMeCard:(id)a0 meCardTime:(double)a1 timeout:(long long)a2 numRetries:(int)a3 numClientRetries:(int)a4;
...
- (void).cxx_destruct;
- (void)updateDerivedIsFromMeRanking:(BOOL)a0 nameTokens:(id)a1 onlyIfNotAlready:(BOOL)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (BOOL)_startInternalQueryWithIndex:(struct __SI { } *)a0 query:(id)a1 fetchAttributes:(id)a2 forBundleIds:(id)a3 maxCount:(unsigned long long)a4 resultQueue:(id)a5 postFilter:(id)a6 resultsHandler:(id /* block */)a7;
...
- (void)updateDerivedIsFromMe:(BOOL)a0 fullName:(id)a1 emails:(id)a2 onlyIfNotAlready:(BOOL)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
...
- (void)persistDonationProgress:(id)a0 fromBundle:(id)a1 clientIndexName:(id)a2 personaID:(id)a3 canCreateNewIndex:(BOOL)a4 completionHandler:(id /* block */)a5;
...
- (long long)updateDerivedMeAll:(BOOL)a0 group:(id)a1 order:(long long)a2 aliasName:(id)a3 fullName:(id)a4 nameTokens:(id)a5 givenNameTokens:(id)a6 nonGivenNameTokens:(id)a7 emails:(id)a8 context:(id)a9;
- (id)_cancelIdleTimer;
...
- (void)reindexAttributes:(id)a0 ofItemsMatchingQuery:(id)a1 liftingRules:(id)a2 indexAttrName:(id)a3 withVersion:(unsigned long long)a4 perItemCompletionAttributeArray:(id)a5 completionValueArray:(id)a6 alwaysReindexWithCompletionAttribute:(BOOL)a7 force:(BOOL)a8 postFilter:(id)a9 group:(id)a10 forceMerge:(BOOL)a11;
- (void)updateDerivedIsFromMeRankingNot:(BOOL)a0 nameTokens:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
- (void)updateDerivedIsMe:(BOOL)a0 nameTokens:(id)a1 alias:(id)a2 onlyIfNotAlready:(BOOL)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
...
- (void)fetchConsumedAndLatestSerialNums:(id /* block */)a0;
...
- (void)updateDerivedIsToMe:(BOOL)a0 fullName:(id)a1 emails:(id)a2 onlyIfNotAlready:(BOOL)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
- (void)fixupBundlesWithGroup:(id)a0;
- (void)deleteSearchableItemsWithFileProviderDomains:(id)a0 completionHandler:(id /* block */)a1;
- (void)updateDerivedIsMeTextContentMatchNot:(BOOL)a0 nameTokens:(id)a1 alias:(id)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
...
- (void)sendMeCard:(id)a0;
- (void)updateDerivedIsMeRankingPreExtraction:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 onlyIfNotAlready:(BOOL)a4 group:(id)a5 forceMerge:(BOOL)a6 context:(id)a7;
...
- (void)updateDerivedIsMeRankingTokenNot:(BOOL)a0 nameTokens:(id)a1 group:(id)a2 forceMerge:(BOOL)a3 context:(id)a4;
- (void)updateDerivedIsMeNot:(BOOL)a0 nameTokens:(id)a1 alias:(id)a2 group:(id)a3 forceMerge:(BOOL)a4 context:(id)a5;
- (void)dealloc;
...
- (void)updateDerivedIsMeRankingOCRTextContentMatchNot:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
...
- (void)updateDerivedIsMeRankingOCRNot:(BOOL)a0 givenNameTokens:(id)a1 nonGivenNameTokens:(id)a2 alias:(id)a3 group:(id)a4 forceMerge:(BOOL)a5 context:(id)a6;
