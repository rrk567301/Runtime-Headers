...
- (void)persistDonationProgress:(id)a0 fromBundle:(id)a1 clientIndexName:(id)a2 protectionClass:(id)a3 personaID:(id)a4 options:(long long)a5 completionHandler:(id /* block */)a6;
...
- (void)revokeExpiredItems:(id)a0 protected:(BOOL)a1 expirationRef:(BOOL *)a2;
- (void)lockingCx;
