@class ULConnection, NSUUID, NSSet, NSString, NSObject;
...
+ (id)_tokenToULContextLayerTypes:(id)a0;
...
- (void)addHomeKitUserInteractionLabelWithName:(id)a0 timestamp:(id)a1 deviceClass:(unsigned long long)a2 type:(long long)a3 interactionType:(long long)a4 labelIdentifier:(id)a5;
...
- (void)updateHomeKitUserInteractionLabelWithName:(id)a0 timestamp:(id)a1 deviceClass:(unsigned long long)a2 type:(long long)a3 interactionType:(long long)a4 labelIdentifier:(id)a5;
