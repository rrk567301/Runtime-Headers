@class NSMutableDictionary, IRRapportProvider, IRAVOutputContextController, IRAVOutputDeviceProvider, IRCleanupManager, NSObject, IRMobileAssetManager, IRLLMService, IRDisplayMonitor, IRTimerProvider, NSString, IRPersistenceManager, IRBiomeProvider, IRProximityProvider, IRHomeKitManager, IRBackgroundActivitiesManager, IRAnalyticsManager, IRDaemonStore;
...
- (void)_dispatchToConnectionsForServiceContainer:(id)a0 usingBlock:(id /* block */)a1;
...
- (void)serviceContainer:(id)a0 didSpotOnLocationCompleteForClientIds:(id)a1 withError:(id)a2;
- (void)serviceContainer:(id)a0 didUpdateBundlesWithSignificantInteractionPattern:(id)a1;
