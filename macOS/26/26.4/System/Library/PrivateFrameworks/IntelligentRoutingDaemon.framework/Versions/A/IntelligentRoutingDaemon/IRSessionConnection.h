...
- (void)_classifyRoomName:(id)a0 accessoryNames:(id)a1 reply:(id /* block */)a2;
...
- (void)_donateEvent:(id)a0 forSuggestionTarget:(id)a1;
- (void)_getServiceTokensWithReply:(id /* block */)a0;
- (void)_requestCurrentContextWithBundleID:(id)a0;
- (void)_requestCurrentContextWithReply:(id /* block */)a0;
- (void)_requestCurrentContextWithTargets:(id)a0 reply:(id /* block */)a1;
- (void)_runWithConfiguration:(id)a0;
- (void)_setSpotOnLocationWithParameters:(id)a0;
- (void)_terminateLLMServiceWithReply:(id /* block */)a0;
