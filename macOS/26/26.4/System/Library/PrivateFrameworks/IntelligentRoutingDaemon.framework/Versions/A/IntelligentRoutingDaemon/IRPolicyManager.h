@class IRTimerProvider, IRCandidateManager, NSObject, IRTimer, IRStatisticsManager, IRHistoryManager, NSString, IRHomeKitManager, IRSessionAnalytics, IRServiceDO, NSMutableSet, IRReplayWriter, IRSystemStateManager, IRSiriHomeSession, IRPolicyEngine;
...
- (id)getStatistics;
- (id)initWithService:(id)a0 queue:(id)a1 delegate:(id)a2 avOutputDeviceProvider:(id)a3 biomeProvider:(id)a4 miloProvider:(id)a5 rapportProvider:(id)a6 proximityProvider:(id)a7 serviceStore:(id)a8 displayMonitor:(id)a9 audioAVOutputContextController:(id)a10 homekitManager:(id)a11 timerProvider:(id)a12 isLowLatencyMiLo:(BOOL)a13;
