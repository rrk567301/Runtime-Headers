...
- (id)installEventTap:(id /* block */)a0 identifier:(id)a1 type:(int)a2 skipDeviceMatching:(BOOL)a3 shouldSeparateHIDStreamsBySenderID:(BOOL)a4 filterEvents:(id)a5 matchingServiceHandler:(id /* block */)a6;
