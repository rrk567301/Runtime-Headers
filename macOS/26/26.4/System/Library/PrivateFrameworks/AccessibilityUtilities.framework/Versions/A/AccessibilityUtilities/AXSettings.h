...
@interface AXSettings : AXBaseSettings {
    ...
    void /* unknown type, empty encoding */ tts;
    ...
    void /* unknown type, empty encoding */ liveRecognition;
    ...
    void /* unknown type, empty encoding */ tripleClick;
    void /* unknown type, empty encoding */ visualAlerts;
}
...
@property (nonatomic) BOOL voiceOverTouchCurtain;
...
@property (nonatomic) BOOL quickTypePredictionFeedbackEnabled;
...
@property BOOL reduceHighlightingEffectsEnabled;
...
- (void)setAssistiveTouchMouseDwellControlGesturesAtScreenEdgesEnabled:(BOOL)a0;
...
- (void)setAssistiveTouchHeadTrackingExpressionToActionMappingDidMigrateToLuckB:(BOOL)a0;
...
- (BOOL)assistiveTouchHeadTrackingExpressionToActionMappingDidMigrateToLuckB;
- (id)init;
...
- (BOOL)assistiveTouchMouseDwellControlGesturesAtScreenEdgesEnabled;
