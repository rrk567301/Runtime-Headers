...
@property (nonatomic) struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } spatialPhotoNormalizedBounds;
...
@property (nonatomic) BOOL headroomInfillQualified;
...
@property (readonly, nonatomic) BOOL settlingEffectFailedUnexpectedly;
...
@property (readonly, nonatomic) BOOL isSpatialPhotoAvailable;
@property (readonly, nonatomic) BOOL spatialPhotoFailedAnyGating;
@property (readonly, nonatomic) BOOL spatialPhotoFailedUnexpectedly;
...
- (id)spatialPhotoGatingDiagnosticsOnlyFailures:(BOOL)a0;
