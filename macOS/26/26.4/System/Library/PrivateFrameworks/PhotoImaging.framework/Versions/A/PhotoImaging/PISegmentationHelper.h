...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })computeCenterZoomAreaWithMidpoint:(double)a0 visibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 segmentationMatte:(id)a2 layoutConfiguration:(id)a3 context:(id)a4;
+ (struct PISegmentationClockOverlapResult { id x0; unsigned long long x1; double x2; double x3; })computeClockLayerOrderWithAdaptiveTimeRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 visibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 segmentationMatte:(id)a2 layoutConfiguration:(id)a3 context:(id)a4 interactive:(BOOL)a5;
...
+ (double)computeStretchOverlapYOffsetWithVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 imageSize:(struct CGSize { double x0; double x1; })a1 segmentationMatte:(id)a2 classicOverlap:(BOOL)a3 layoutConfiguration:(id)a4 context:(id)a5;
...
+ (id)debugImageWithInputImage:(id)a0 finalLayout:(id)a1 intermediateLayout:(id)a2 faceRects:(id)a3 saliencyPreferrectRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 saliencyAcceptableRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 settlingEffectRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6;
+ (id)debugImageWithInputImage:(id)a0 fullSize:(struct CGSize { double x0; double x1; })a1 debugRects:(id)a2 label:(id)a3;
+ (id)debugImageWithInputImage:(id)a0 layout:(id)a1 faceRects:(id)a2 saliencyPreferrectRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 saliencyAcceptableRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 gazeAreaRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 settlingEffectRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a6;
...
+ (BOOL)layoutConfigurationValidForVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 layoutConfiguration:(id)a1;
...
+ (BOOL)topEdgeHasNoContactWithInspectionMatte:(id)a0 classification:(unsigned long long)a1 context:(id)a2;
