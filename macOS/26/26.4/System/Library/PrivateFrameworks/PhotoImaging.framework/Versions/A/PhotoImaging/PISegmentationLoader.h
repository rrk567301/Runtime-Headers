...
@property (nonatomic) BOOL disableSpatialPhoto;
@property (nonatomic) BOOL disableAdaptiveLayout;
@property (nonatomic) BOOL disableSpatialAdaptiveLayout;
...
+ (BOOL)currentDeviceSupportsSpatialPhoto;
+ (id)effectiveLayoutForSegmentationItem:(id)a0 editConfiguration:(id)a1 layerStackOptions:(unsigned long long)a2;
+ (id)generateLayerStackForItem:(id)a0 style:(id)a1 layout:(id)a2 ignoreOriginalLayout:(BOOL)a3 options:(unsigned long long)a4 enableSettlingEffect:(BOOL)a5 enableSpatialPhoto:(BOOL)a6 allowedLayoutStrategies:(unsigned long long)a7 shouldRecalculateLayoutProperties:(BOOL)a8 useLegacyHeadroom:(BOOL)a9 userAdjustedVisibleFrame:(BOOL)a10 completion:(id /* block */)a11;
...
+ (void)loadSpatialPhotoForSegmentationItem:(id)a0 asset:(id)a1 completion:(id /* block */)a2;
...
+ (id)saveSegmentationItem:(id)a0 layerStackOptions:(unsigned long long)a1 configuration:(id)a2 style:(id)a3 layout:(id)a4 allowedLayoutStrategies:(unsigned long long)a5 shouldRecalculateLayoutProperties:(BOOL)a6 shouldKeepSpecifiedStyle:(BOOL)a7 toWallpaperURL:(id)a8 completion:(id /* block */)a9;
+ (id)saveSegmentationItem:(id)a0 layerStackOptions:(unsigned long long)a1 configuration:(id)a2 style:(id)a3 layout:(id)a4 allowedLayoutStrategies:(unsigned long long)a5 shouldRecalculateLayoutProperties:(BOOL)a6 toWallpaperURL:(id)a7 completion:(id /* block */)a8;
...
- (BOOL)_shouldLoadSpatialPhotoForItem:(id)a0;
...
- (BOOL)_headroomInfillQualifiedWithMatte:(id)a0;
...
- (void)_loadFinalResource:(id)a0 completion:(id /* block */)a1;
- (void)_loadFirstPreferredResource:(id)a0 completion:(id /* block */)a1;
- (void)_loadFullSizeResource:(id)a0 completion:(id /* block */)a1;
- (void)_loadHDRGainMap:(id)a0 completion:(id /* block */)a1;
...
- (void)_loadSpatialPhoto:(id)a0 layoutGroup:(id)a1 completion:(id /* block */)a2;
...
- (void)_performSpatialPhotoLayout:(id)a0 completion:(id /* block */)a1;
- (void)_segment:(id)a0 completion:(id /* block */)a1;
- (BOOL)_shouldEnableHeadroomByDefault;
...
- (void)_updateItem:(id)a0 withSpatialPhotoGatingFailures:(unsigned long long)a1;
...
- (void)refreshSegmentationItem:(id)a0 completion:(id /* block */)a1;
