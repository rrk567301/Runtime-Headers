...
- (id)init;
- (void)writeTo:(id)a0;
- (id)initWithStartSearch:(id)a0 responseSize:(long long)a1 statusCode:(long long)a2 parsecStatus:(id)a3 parsecDuration:(double)a4 fbq:(id)a5 partialClientIp:(id)a6 networkTimingData:(id)a7 edge:(id)a8;
