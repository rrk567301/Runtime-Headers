@class NSSet, NSString, NSArray, NSError, NSDictionary, NSData;
...
- (void)hastingsCurationFromAssetUUIDs:(NSArray *)a0 options:(NSData *)a1 operationID:(NSString *)a2 reply:(void (^)(NSArray *, NSError *))a3;
...
- (void)notifyAvailabilityForFeature:(unsigned long long)a0 reply:(void (^)(NSError *))a1;
- (void)requestFlexMusicCurationWithOptions:(NSDictionary *)a0 operationID:(NSString *)a1 reply:(void (^)(NSString *, NSError *))a2;
- (void)requestMusicCurationWithOptions:(NSDictionary *)a0 operationID:(NSString *)a1 reply:(void (^)(NSString *, NSError *))a2;
- (void)requestPersonalizedSensingRefreshWithReply:(void (^)(BOOL, NSError *))a0;
- (void)requestRecentlyUsedSongsWithOptions:(NSDictionary *)a0 operationID:(NSString *)a1 reply:(void (^)(NSDictionary *, NSError *))a2;
- (void)requestSongsForAdamIDs:(NSArray *)a0 options:(NSDictionary *)a1 operationID:(NSString *)a2 reply:(void (^)(NSString *, NSError *))a3;
- (void)warmupPhotoLibraryWorkerForDuration:(double)a0 operationID:(NSString *)a1 reply:(void (^)(NSError *))a2;
