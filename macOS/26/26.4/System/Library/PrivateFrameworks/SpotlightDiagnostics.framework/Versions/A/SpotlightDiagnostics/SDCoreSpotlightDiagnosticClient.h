...
+ (id)testClientWithBundleID:(id)a0 protectionClass:(id)a1;
...
- (id)findSpotlightIndexDropsForDays:(unsigned int)a0;
- (id)copySpotlightIndexDropsToDirectory:(id)a0 forDays:(unsigned int)a1;
- (id)dateStringForDaysAgo:(unsigned int)a0;
...
- (id)initWithBundleID:(id)a0 protectionClass:(id)a1 path:(id)a2 private:(BOOL)a3 managed:(BOOL)a4 test:(BOOL)a5;
- (BOOL)isTestIndex;
