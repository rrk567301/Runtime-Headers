...
+ (id)buildWithIdentifier:(id)a0 removed:(id)a1 declarationIdentifier:(id)a2 visibleName:(id)a3 hostname:(id)a4 port:(id)a5 username:(id)a6 areCalendarsEnabled:(id)a7 areRemindersEnabled:(id)a8;
+ (id)statusItemType;
+ (id)supportedOS;
