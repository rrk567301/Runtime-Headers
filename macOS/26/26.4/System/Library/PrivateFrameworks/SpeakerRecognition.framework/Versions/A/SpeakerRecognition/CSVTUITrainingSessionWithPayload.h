...
@interface CSVTUITrainingSessionWithPayload : CSVTUITrainingSession <SFSpeechRecognitionTaskDelegate, SpeakerRecognition.SSRSpeechTranscriberIntfDelegate, CSVTUIAudioSessionDelegate, CSVTUIEndPointDelegate> {
    BOOL _detectBOS;
...
- (void)_handleFinalResult:(id)a0;
- (void)_handlePartialText:(id)a0 shouldWaitForFinal:(BOOL)a1;
...
- (void)speechTranscriber:(id)a0 didReceiveFinalResult:(id)a1;
- (void)speechTranscriber:(id)a0 didReceivePartialResult:(id)a1;
- (void)startTraining;
