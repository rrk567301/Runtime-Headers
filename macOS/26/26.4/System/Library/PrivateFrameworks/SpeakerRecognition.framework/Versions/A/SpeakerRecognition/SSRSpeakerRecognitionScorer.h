...
- (id)initWithProfileID:(id)a0 withModelFile:(id)a1 withConfigFile:(id)a2 withResourceFile:(id)a3 config:(id)a4 memoryIndex:(id)a5 withOffsetsType:(unsigned long long)a6 forRetraining:(BOOL)a7;
