@class NSString, NSArray, NSDate, NSMutableArray, NSNumber;
...
- (id)_getEnrollmentUtterancesForType:(unsigned long long)a0;
...
- (void)addEnrollmentSNR:(id)a0;
- (void)addEnrollmentSimilarityScore:(id)a0;
- (void)addEnrollmentWER:(id)a0;
