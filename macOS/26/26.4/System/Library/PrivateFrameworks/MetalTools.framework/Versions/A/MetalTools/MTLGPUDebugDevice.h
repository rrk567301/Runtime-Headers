@class , NSData, __end_, NSSet, NSMutableDictionary, MTLGPUDebugSynchronizedResidencySet, NSMutableArray;
...
@interface MTLGPUDebugDevice : MTLToolsDevice {
    ...
    struct GPUDebugDeviceOptions { unsigned char retainReflection : 1; unsigned char retainPSOFunctions : 1; unsigned char abortOnFault : 1; unsigned char enableDumpToStderr : 1; unsigned char enableReportAllocationStackTrace : 1; } deviceOptions;
    ...
    struct BVHTypeTable { id<MTLBuffer> _backingMemory; id<MTLResidencySet> _residencySet; } accelerationStructureTypeTable;
