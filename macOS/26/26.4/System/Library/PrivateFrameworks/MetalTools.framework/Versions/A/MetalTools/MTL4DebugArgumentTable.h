@interface MTL4DebugArgumentTable : MTL4ToolsArgumentTable {
    struct vector<MTL4DebugBindingInfo, std::allocator<MTL4DebugBindingInfo>> { struct MTL4DebugBindingInfo *__begin_; struct MTL4DebugBindingInfo *__end_; struct { struct MTL4DebugBindingInfo *__cap_; } ; } _bufferBindings;
    struct vector<MTL4DebugBindingInfo, std::allocator<MTL4DebugBindingInfo>> { struct MTL4DebugBindingInfo *__begin_; struct MTL4DebugBindingInfo *__end_; struct { struct MTL4DebugBindingInfo *__cap_; } ; } _textureBindings;
    struct vector<MTL4DebugBindingInfo, std::allocator<MTL4DebugBindingInfo>> { struct MTL4DebugBindingInfo *__begin_; struct MTL4DebugBindingInfo *__end_; struct { struct MTL4DebugBindingInfo *__cap_; } ; } _samplerBindings;
