...
@interface MTL4DebugRenderCommandEncoder : MTL4ToolsRenderCommandEncoder {
    ...
    struct vector<MTLViewport, std::allocator<MTLViewport>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _currentViewports;
    ...
    struct vector<MTLScissorRect, std::allocator<MTLScissorRect>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _currentScissorRects;
