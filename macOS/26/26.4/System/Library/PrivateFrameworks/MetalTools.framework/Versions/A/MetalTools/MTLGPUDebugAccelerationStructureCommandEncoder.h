@class , MTLGPUDebugCommandBuffer, MTLAccelerationStructurePassDescriptor, __end_;
@protocol MTLLibrary, MTLFence;
...
@interface MTLGPUDebugAccelerationStructureCommandEncoder : MTLToolsAccelerationStructureCommandEncoder {
    ...
    struct list<resourceAndUsage, std::allocator<resourceAndUsage>> { struct __list_node_base<resourceAndUsage, void *> { void *__prev_; void *__next_; } __end_; struct { unsigned long long __size_; } ; } _resourceAndUsageList;
    struct list<id<MTLHeap>, std::allocator<id<MTLHeap>>> { struct __list_node_base<id<MTLHeap>, void *> { void *__prev_; void *__next_; } __end_; struct { unsigned long long __size_; } ; } _heapList;
    ...
    struct vector<id<MTLFence>, std::allocator<id<MTLFence>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _fencesToUpdate;
    struct vector<id<MTLFence>, std::allocator<id<MTLFence>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _fencesToWaitFor;
}
