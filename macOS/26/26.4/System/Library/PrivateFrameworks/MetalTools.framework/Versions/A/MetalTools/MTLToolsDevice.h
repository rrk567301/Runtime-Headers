@class MTLArchitecture, NSString, NSArray, MTLDeviceFeatureQueries, NSDictionary, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, MTLToolsObjectCache;
...
+ (id)newUnwrappedMTLRelocations:(id)a0;
...
- (id)newTensorWithBuffer:(id)a0 descriptor:(id)a1 offset:(unsigned long long)a2 strides:(id)a3 error:(id *)a4;
...
- (id)newUnwrappedMTL4CompilerDescriptor:(id)a0;
- (id)newUnwrappedMTL4CompilerTaskOptions:(id)a0;
- (id)newUnwrappedMTL4FunctionDescriptor:(id)a0;
- (id)newUnwrappedMTL4PipelineDescriptor:(id)a0;
- (id)newUnwrappedMTL4PipelineStageDynamicLinkingDescriptor:(id)a0;
- (id)newUnwrappedMTL4RenderPipelineBinaryFunctionsDescriptor:(id)a0;
- (id)newUnwrappedMTL4RenderPipelineDynamicLinkingDescriptor:(id)a0;
- (id)newUnwrappedStaticLinkingDescriptor:(id)a0;
