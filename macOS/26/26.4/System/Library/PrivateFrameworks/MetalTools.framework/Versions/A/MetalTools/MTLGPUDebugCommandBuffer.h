...
@interface MTLGPUDebugCommandBuffer : MTLToolsCommandBuffer <MTLGPUDebugBufferEncoder> {
    ...
    struct TensorUsageTable { id<MTLBuffer> _backingMemory; id<MTLResidencySet> _residencySet; } _tensorResidencyTables[4];
...
- (void)markTensor:(unsigned long long)a0 stages:(unsigned long long)a1;
