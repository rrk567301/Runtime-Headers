...
- (id)initWithBaseObject:(id)a0 device:(id)a1 commandBuffer:(id)a2 afterEncoderStageMaskForBarriers:(unsigned long long)a3 afterEncoderStageMaskForFences:(unsigned long long)a4 beforeEncoderStageMask:(unsigned long long)a5;
