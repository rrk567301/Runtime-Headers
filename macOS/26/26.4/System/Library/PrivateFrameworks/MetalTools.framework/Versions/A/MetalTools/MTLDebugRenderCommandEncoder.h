@class , __begin_, MTLDepthStencilDescriptor, baseLevel, __end_, MTLLogicalToPhysicalColorAttachmentMap, NSMutableSet, MTLRenderPassDescriptor, MTLDebugCommandBuffer;
...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
    ...
    struct vector<MTLViewport, std::allocator<MTLViewport>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _viewports;
    struct vector<MTLScissorRect, std::allocator<MTLScissorRect>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _scissorRects;
    unsigned long long _amplificationMode;
    unsigned long long _amplificationValue;
    unsigned long long _vertexAmplificationCount;
    struct deque<id, std::allocator<id>> { struct __split_buffer<id *, std::allocator<id *>> { __begin_ ***__first_; __end_ ***x0;  ***x1; struct { id **__cap_; } x2; } __map_; unsigned long long __start_; struct { unsigned long long __size_; } ; } _updatedFences;
...
- (void)_dispatchThreadsPerTile:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0 inRegion:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; } *)a1 withRenderTargetArrayIndex:(unsigned int *)a2 withCondition:(long long)a3;
- (void)_setDefaults;
