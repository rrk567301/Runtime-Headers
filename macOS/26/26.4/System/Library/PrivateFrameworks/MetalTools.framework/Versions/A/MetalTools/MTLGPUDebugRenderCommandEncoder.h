...
@protocol MTLGPUDebugResource, MTLBuffer, MTLResource;
...
@interface MTLGPUDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder <MTLGPUDebugCommandEncoder> {
    ...
    struct GPUDebugEncoderBoundBuffers { id<MTLResource> resource; unsigned long long offset; unsigned long long stride; unsigned long long type; } _vertexEncoderBoundBuffers[31];
    struct GPUDebugEncoderBoundBuffers { id<MTLResource> resource; unsigned long long offset; unsigned long long stride; unsigned long long type; } _fragmentEncoderBoundBuffers[31];
    struct GPUDebugEncoderBoundBuffers { id<MTLResource> resource; unsigned long long offset; unsigned long long stride; unsigned long long type; } _meshEncoderBoundBuffers[31];
    struct GPUDebugEncoderBoundBuffers { id<MTLResource> resource; unsigned long long offset; unsigned long long stride; unsigned long long type; } _objectEncoderBoundBuffers[31];
...
- (void)_setBufferForStage:(id)a0 atIndex:(unsigned long long)a1 stage:(unsigned long long)a2;
- (void)_setInternalBindingTableForStage:(id)a0 stage:(unsigned long long)a1;
...
- (void)setBufferUsageTable:(id)a0 textureUsageTable:(id)a1 tensorResidencyTable:(id)a2 textureTypeTable:(id)a3 forStage:(unsigned long long)a4;
