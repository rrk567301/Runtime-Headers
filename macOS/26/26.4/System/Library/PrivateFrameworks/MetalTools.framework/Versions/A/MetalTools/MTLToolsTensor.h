...
- (id)initWithBaseObject:(id)a0 buffer:(id)a1 initializeInternalBuffers:(BOOL)a2;
- (id)initWithBaseObject:(id)a0 parent:(id)a1;
- (id)initWithBaseObject:(id)a0 parent:(id)a1 initializeInternalBuffers:(BOOL)a2;
- (id)initWithBaseObject:(id)a0 parentTensor:(id)a1;
- (id)initWithBaseObject:(id)a0 parentTensor:(id)a1 initializeInternalBuffers:(BOOL)a2;
