...
@interface MTLToolsIOCommandBuffer : MTLToolsObject <MTLIOCommandBufferSPI> {
    ...
    struct vector<void (^)(id<MTLIOCommandBuffer>), std::allocator<void (^)(id<MTLIOCommandBuffer>)>> { id /* block */ *__begin_; id /* block */ *__end_; struct { id /* block */ *__cap_; } ; } _completedHandlers;
