...
+ (double)nsFromMachTime:(unsigned long long)a0;
...
+ (id)dateFromnSecEpoch:(unsigned long long)a0;
...
+ (long long)grabSysctlValueInt64:(id)a0;
+ (BOOL)hasInternalKey;
+ (BOOL)inBUIDemoMode;
...
+ (unsigned int)uidForProcessName:(id)a0;
