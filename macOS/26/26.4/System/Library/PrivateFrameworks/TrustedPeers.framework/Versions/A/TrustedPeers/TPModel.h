...
+ (BOOL)ignoreTDLForModel:(id)a0;
+ (id)preapprovalsFromKeys:(id)a0;
+ (BOOL)isFullPeer:(id)a0;
+ (id)pickClock:(id)a0;
...
- (BOOL)doAnyTrustedPeersMatchMachineID:(id)a0 error:(id *)a1;
- (unsigned long long)trustedFullPeerCountWithError:(id *)a0;
