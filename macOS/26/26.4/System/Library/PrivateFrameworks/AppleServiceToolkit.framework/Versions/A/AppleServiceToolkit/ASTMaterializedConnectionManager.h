...
- (void)downloadAsset:(id)a0 serverURL:(id)a1 endpoint:(id)a2 countryCode:(id)a3 destinationFileHandle:(id)a4 allowsCellularAccess:(BOOL)a5 completion:(id /* block */)a6;
...
- (void)postPrepareDeviceWithIdentities:(id)a0 allowsCellularAccess:(BOOL)a1 completionHandler:(id /* block */)a2;
