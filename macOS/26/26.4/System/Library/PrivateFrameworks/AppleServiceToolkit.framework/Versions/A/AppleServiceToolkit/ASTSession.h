...
+ (void)requestAsset:(id)a0 serverURL:(id)a1 endpoint:(id)a2 countryCode:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)fetchAsset:(id)a0 sessionClass:(Class)a1 serverURL:(id)a2 endpoint:(id)a3 countryCode:(id)a4 completionHandler:(id /* block */)a5;
