@class NSUUID, NSString, NSSet, NSOrderedSet, NSObject;
...
@property (nonatomic) BOOL is2GHzResidencyLow;
@property (nonatomic) BOOL is5GHzResidencyLow;
@property (nonatomic) BOOL is6GHzResidencyLow;
