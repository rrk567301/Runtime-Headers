@class TimeseriesPoliciesHandler, AnalyticsStoreMOHandler, LinkChangePolicyHandler, NSDate, WAPersistentContainer, NSString, NSMutableArray, UsagePoliciesHandler, RoamPolicyStore, DeploymentMetricHandler, NSDateFormatter;
...
- (BOOL)processCachedFaultsAndResetMoc:(BOOL)a0;
...
- (BOOL)event:(id)a0 andResetMoc:(BOOL)a1 andRunPostProcessing:(BOOL)a2 withError:(id *)a3;
...
- (BOOL)updateContextAwareTDPolicies:(id)a0;
