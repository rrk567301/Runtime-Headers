...
- (void)submitEvent:(id)a0 async:(BOOL)a1 andDeferReclaimMem:(BOOL)a2 andRunPostProcessing:(BOOL)a3 uponCompletionDo:(id /* block */)a4;
...
- (BOOL)submitEvent:(id)a0 andDeferReclaimMem:(BOOL)a1 andRunPostProcessing:(BOOL)a2 withError:(id *)a3;
- (BOOL)submitEvent:(id)a0 withError:(id *)a1;
...
- (void)asyncSubmitEvent:(id)a0 uponCompletionDo:(id /* block */)a1;
- (void)asyncSubmitEvent:(id)a0 andDeferReclaimMem:(BOOL)a1 andRunPostProcessing:(BOOL)a2 uponCompletionDo:(id /* block */)a3;
- (void).cxx_destruct;
