...
+ (void)evaluateWithInteraction:(id)a0 action:(long long)a1 showFeedbackForm:(BOOL)a2 associateWithAppleAccount:(BOOL)a3 sceneID:(id)a4 presentingBundleId:(id)a5 completionWithResult:(id /* block */)a6;
