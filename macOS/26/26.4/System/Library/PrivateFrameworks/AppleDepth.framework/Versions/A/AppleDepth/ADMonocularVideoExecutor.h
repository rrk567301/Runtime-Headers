...
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 cameraCalibration:(id)a1 outDisparityMap:(struct __CVBuffer **)a2;
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 efl:(float)a1 outDisparityMap:(struct __CVBuffer **)a2;
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 focalLength35mm:(float)a1 outDisparityMap:(struct __CVBuffer **)a2;
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 outDisparityMap:(struct __CVBuffer **)a1;
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 scaleFactor:(float)a1 outDisparityMap:(struct __CVBuffer **)a2;
- (id)getIntermediates;
