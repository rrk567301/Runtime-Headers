...
@interface ADJasperPearlInFieldCalibrationInterSessionData : ADInFieldCalibrationInterSessionData {
    struct vector<ADJasperPearlInFieldCalibrationDiagnosticPipelineEntry, std::allocator<ADJasperPearlInFieldCalibrationDiagnosticPipelineEntry>> { struct ADJasperPearlInFieldCalibrationDiagnosticPipelineEntry *__begin_; struct ADJasperPearlInFieldCalibrationDiagnosticPipelineEntry *__end_; struct { struct ADJasperPearlInFieldCalibrationDiagnosticPipelineEntry *__cap_; } ; } _diagnosticPipelineLog;
