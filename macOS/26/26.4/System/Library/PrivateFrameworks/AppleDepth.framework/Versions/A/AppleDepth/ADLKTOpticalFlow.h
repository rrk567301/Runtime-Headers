...
+ (void)_initializeBaseConfig:(struct { unsigned long long x0; id x1; BOOL x2; int x3; int x4; float x5; float x6; float x7; unsigned long long x8; unsigned int x9; BOOL x10; } *)a0;
