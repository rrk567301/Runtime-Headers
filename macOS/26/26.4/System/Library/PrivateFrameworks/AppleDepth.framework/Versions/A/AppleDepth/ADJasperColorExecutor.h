...
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 colorCameraCalibration:(id)a1 colorWorldToPlatformTransform:(struct { void /* unknown type, empty encoding */ x0[4]; })a2 pointClouds:(id)a3 lidarCameraCalibration:(id)a4 pointCloudWorldToPlatformTransforms:(struct { void /* unknown type, empty encoding */ x0[4]; } *)a5 outDepthMap:(struct __CVBuffer **)a6 outConfMap:(struct __CVBuffer **)a7 outConfidenceLevels:(struct __CVBuffer { } *)a8 outNonTemporalyConsistentDepthMap:(struct __CVBuffer { } *)a9 outNonTemporalyConsistentConfMap:(struct __CVBuffer { } *)a10 outNonTemporalyConsistentConfLevels:(struct __CVBuffer { } *)a11;
