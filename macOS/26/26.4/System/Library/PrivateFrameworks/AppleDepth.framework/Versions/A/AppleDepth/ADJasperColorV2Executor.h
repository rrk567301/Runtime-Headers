...
- (long long)executeWithColor:(struct __CVBuffer { } *)a0 pointCloud:(id)a1 jasperCalibration:(id)a2 colorCalibration:(id)a3 timestamp:(double)a4 outputDepthMap:(struct __CVBuffer **)a5 outputConfidenceMap:(struct __CVBuffer **)a6;
...
- (id)initWithParameters:(id)a0 prioritization:(long long)a1 engineType:(unsigned long long)a2;
