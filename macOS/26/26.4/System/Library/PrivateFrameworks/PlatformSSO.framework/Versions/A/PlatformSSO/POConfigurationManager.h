...
- (BOOL)_createTemporaryUserLocalAccount:(id)a0 deviceConfiguration:(id)a1;
- (BOOL)_setTokens:(id)a0 identifier:(id)a1 extensionIdentifier:(id)a2 returningError:(id *)a3;
- (id)_tokensForExtensionIdentifier:(id)a0 identifier:(id)a1;
- (BOOL)addLocalUser:(id)a0 toLocalGroup:(id)a1;
- (BOOL)addPlatformSSOToSearchPolicyReturningError:(id *)a0;
- (BOOL)bindTokenForUsername:(id)a0 hash:(id)a1 wrapHash:(id)a2 tokenId:(id)a3 pinContext:(id)a4 returningError:(id *)a5;
- (id)calculateExpirationForTokens:(id)a0;
- (BOOL)changeTempSessionAccount;
...
- (BOOL)createTemporaryUser:(id)a0 passwordContext:(id)a1;
- (BOOL)createTemporaryUserLocalAccountsIfNeeded:(id)a0;
...
- (id)currentTempSessionAccount;
- (id)currentUserConfiguration;
- (void)enablePlatformSSORulesAndDefaultsIfNeeded:(id /* block */)a0;
...
- (void)resetTemporaryAccountWithName:(id)a0;
...
- (BOOL)setTokens:(id)a0 user:(id)a1 extensionIdentifier:(id)a2 returningError:(id *)a3;
- (id)tokensForExtensionIdentifier:(id)a0;
- (id)tokensForExtensionIdentifier:(id)a0 user:(id)a1;
...
- (BOOL)updateGroupNames:(id)a0;
- (BOOL)updateProfilePicture:(id)a0 forUsername:(id)a1;
- (BOOL)updateTemporaryAccountWithName:(id)a0 fullName:(id)a1 altSecurityIdentity:(id)a2;
