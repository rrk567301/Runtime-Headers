@class PODirectoryServices, NSString, NSXPCConnection, POUserGroupManager, SOConfigurationHost, POConfigurationManager, NSObject;
...
- (BOOL)_removeDeviceConfigurationForIdentifier:(id)a0 error:(id *)a1;
- (BOOL)_removeLoginConfigurationForIdentifier:(id)a0 error:(id *)a1;
- (BOOL)_removeUserConfigurationForIdentifier:(id)a0 error:(id *)a1;
- (BOOL)_saveDeviceConfiguration:(id)a0 identifier:(id)a1 error:(id *)a2;
- (BOOL)_saveLoginConfiguration:(id)a0 identifier:(id)a1 error:(id *)a2;
...
- (void)resetTemporaryAccount:(id)a0;
