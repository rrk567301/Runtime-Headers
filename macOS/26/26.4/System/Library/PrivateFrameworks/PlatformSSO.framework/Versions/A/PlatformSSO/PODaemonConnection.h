...
- (void)changeTempSessionAccountWithCompletion:(id /* block */)a0;
...
- (void)currentTempSessionAccountWithCompletion:(id /* block */)a0;
...
- (void)resetTemporaryAccountWithName:(id)a0 completion:(id /* block */)a1;
...
- (void)updateTemporaryAccountWithName:(id)a0 fullName:(id)a1 altSecurityIdentity:(id)a2 completion:(id /* block */)a3;
