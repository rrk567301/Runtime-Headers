...
- (unsigned long long)authenticateTemporaryUserAccount:(id)a0 forLogin:(BOOL)a1 passwordContext:(id)a2 smartCardContext:(id)a3 tokenId:(id)a4 loginContext:(id)a5 returningTempAccountName:(id *)a6;
