...
@interface CHRemoteTextSynthesizer : NSObject <CHSynthesizingText> {
    ...
    BOOL _shouldForceInventoryDefaultStyle;
...
- (id)init;
- (void)dealloc;
- (BOOL)awaitInventoryIdleWithTimeout:(double)a0;
- (id)cachedStyleInventoryStatus;
- (id)chunkedDataForString:(id)a0 allowedSynthesizers:(id)a1;
- (id)chunkedDataForStringRefine:(id)a0 allowedSynthesizers:(id)a1;
- (id)initWithShouldSkipInventoryLookup:(BOOL)a0 shouldSaveStyleSample:(BOOL)a1 shouldForceInventoryDefaultStyle:(BOOL)a2;
- (BOOL)isInventoryContainingSampleWithStrokeIdentifiers:(id)a0;
- (id)planForReplacingText:(id)a0 withText:(id)a1;
