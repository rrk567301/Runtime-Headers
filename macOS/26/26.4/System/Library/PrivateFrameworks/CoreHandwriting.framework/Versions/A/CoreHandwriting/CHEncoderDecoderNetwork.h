...
- (struct vector<std::vector<std::unordered_map<int, int>>, std::allocator<std::vector<std::unordered_map<int, int>>>> { void *x0; void *x1; struct { void *x0; } x2; })_createCompressedInputImage:(const void *)a0;
