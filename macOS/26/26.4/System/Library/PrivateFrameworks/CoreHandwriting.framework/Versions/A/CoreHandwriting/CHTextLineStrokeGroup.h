...
@interface CHTextLineStrokeGroup : CHStrokeGroup {
    ...
    struct vector<CGVector, std::allocator<CGVector>> { struct CGVector *__begin_; struct CGVector *__end_; struct { struct CGVector *__cap_; } ; } _localStrokeWritingOrientations;
...
- (struct CGPath { } *)newEstimatedBaselineForStrokesWithTokens:(id)a0 tokenStrokeIdentifiers:(id)a1 relaxedChecks:(BOOL)a2;
