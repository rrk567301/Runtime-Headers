...
+ (BOOL)lexiconHasEntryForString:(id)a0 withLexicon:(struct _LXLexicon { } *)a1 outHasMatchingString:(BOOL *)a2;
...
+ (id)performInverseBiDiForNumeric:(id)a0 isRTLContext:(BOOL)a1;
+ (id)rankedLatinLocalesForString:(id)a0 locales:(id)a1;
