...
- (id)defuseNicknameCommand:(id)a0 error:(id *)a1;
...
- (void)generatePreviewForMultiFrameImageWithFileURL:(id)a0 destinationFileURL:(id)a1 maxPixelDimension:(float)a2 scale:(float)a3 maxFrameCount:(long long)a4 isSticker:(BOOL)a5 progressBlock:(id /* block */)a6 resultHandler:(id /* block */)a7;
...
- (void)generateSpamDetectionPreviewImageForFileURL:(id)a0 maxPixelDimension:(float)a1 scale:(float)a2 resultHandler:(id /* block */)a3;
...
- (void).cxx_destruct;
- (void)generatePreviewForEmojiImageWithFileURL:(id)a0 frameIndex:(long long)a1 maxPixelDimension:(float)a2 resultHandler:(id /* block */)a3;
...
- (id)defuseRelayReachabilityResponsePayloadForData:(id)a0 error:(id *)a1;
- (id)defuseRelayReachabilityRequestPayloadForData:(id)a0 error:(id *)a1;
- (id)defuseRelayGroupMutationPayloadForData:(id)a0 error:(id *)a1;
