@class NSURL, NSMutableDictionary, NSDictionary, REMDAChangeTrackingHelper, NSString, NSSet, MobileCalDAVAccount, CalDAVRefreshContext, NSMutableSet, AKAppleIDSession, NSNumber, NSData, NSDateComponents;
