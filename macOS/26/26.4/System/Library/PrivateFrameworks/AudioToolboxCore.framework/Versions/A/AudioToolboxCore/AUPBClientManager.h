...
@interface AUPBClientManager : NSObject <AUPBRegistrarListening, AUPBInspecting> {
    ...
    struct vector<PropertyListener, std::allocator<PropertyListener>> { struct PropertyListener *__begin_; struct PropertyListener *__end_; struct { struct PropertyListener *__cap_; } ; } mPropertyListeners;
    struct vector<NewServerListener, std::allocator<NewServerListener>> { struct NewServerListener *__begin_; struct NewServerListener *__end_; struct { struct NewServerListener *__cap_; } ; } mNewServerListeners;
