...
@interface AUAudioUnitV2Bridge : AUAudioUnit {
    ...
    struct unique_ptr<AUAudioUnitV2Bridge_Renderer, std::default_delete<AUAudioUnitV2Bridge_Renderer>> { struct { struct AUAudioUnitV2Bridge_Renderer *__ptr_; } ; } _renderer;
