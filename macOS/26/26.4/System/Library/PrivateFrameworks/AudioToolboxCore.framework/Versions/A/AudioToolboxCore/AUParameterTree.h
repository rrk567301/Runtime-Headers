...
@property (nonatomic) struct vector<AddressToParameter, std::allocator<AddressToParameter>> { struct AddressToParameter *__begin_; struct AddressToParameter *__end_; struct { struct AddressToParameter *__cap_; } ; } addrToParamIndex;
