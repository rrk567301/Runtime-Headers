...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })expandRangeToIncludeFullList:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inAttributedString:(id)a1;
...
- (void)fixListWritingDirectionInAttributedString:(id)a0 forListItemsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (void)setTextAlignment:(long long)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inTextStorage:(id)a2 inTextView:(id)a3;
...
- (BOOL)shouldChangeTextInTextStorage:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 replacementString:(id)a2;
...
- (long long)writingDirectionForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 inTextStorage:(id)a1;
