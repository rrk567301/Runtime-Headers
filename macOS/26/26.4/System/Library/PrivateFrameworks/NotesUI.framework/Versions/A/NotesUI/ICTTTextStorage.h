...
@property (nonatomic) BOOL parsePresentationIntents;
...
@property (nonatomic) BOOL isEditingPlaceholderForWritingTools;
...
+ (id)filteredAttributedSubstring:(id)a0 fromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 forPlainText:(BOOL)a2 forStandardizedText:(BOOL)a3 fixAttachments:(BOOL)a4 insertListMarkers:(BOOL)a5 context:(id)a6;
