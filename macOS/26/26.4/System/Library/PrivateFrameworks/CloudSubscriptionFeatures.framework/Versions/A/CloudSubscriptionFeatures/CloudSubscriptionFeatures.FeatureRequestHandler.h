@interface CloudSubscriptionFeatures.FeatureRequestHandler : NSObject <CloudSubscriptionFeatures.FeaturesServiceRequest> {
    ...
    void /* unknown type, empty encoding */ featureCache;
    void /* unknown type, empty encoding */ ticketCache;
    ...
    void /* unknown type, empty encoding */ deviceUnlockedSinceBoot;
    void /* unknown type, empty encoding */ allFeaturesFetch;
    void /* unknown type, empty encoding */ postWaitlistCFUIfEligible;
}
