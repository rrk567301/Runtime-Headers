...
@interface NSPPrivacyProxyProxiedContentMap : PBCodable <NSCopying> {
    ...
    struct { unsigned char percentEnabled : 1; unsigned char resolver : 1; unsigned char allowFailover : 1; unsigned char isPrivacyProxy : 1; unsigned char matchExactHostnames : 1; unsigned char supportsReverseProxying : 1; unsigned char systemProcessOnly : 1; } _has;
}
...
@property (nonatomic) BOOL hasAllowFailover;
@property (nonatomic) BOOL allowFailover;
