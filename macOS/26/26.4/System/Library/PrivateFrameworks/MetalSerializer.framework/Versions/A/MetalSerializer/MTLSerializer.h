...
@interface MTLSerializer : NSObject {
    ...
    struct MTLSerializerFeatures { BOOL supportsGenerateResourceRefs; BOOL supportsReflectionSerializationVersion; BOOL supportsSharedTextures; BOOL supportsScripts; BOOL supportsOpenGL; BOOL supportsIOSurfaceTextureWithRotation; BOOL supportsCorrectBaseVertex; BOOL supportsCorrectSwizzleChannels; BOOL supportsAsyncWithReply; } _features;
}
...
@property (readonly) BOOL supportsAsyncWithReply;
