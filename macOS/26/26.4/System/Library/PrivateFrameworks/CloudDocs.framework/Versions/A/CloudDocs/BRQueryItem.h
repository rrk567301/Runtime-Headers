...
@interface BRQueryItem : NSObject <NSFileProviderItem_Private, NSFileProviderItemDecorating, NSSecureCoding, NSCopying> {
    ...
    id _replacement;
    union { struct { unsigned char downloadStatus : 2; unsigned char uploadStatus : 2; unsigned char itemStatus : 2; unsigned char conflicted : 1; unsigned char isUploadActive : 1; unsigned char isDownloadActive : 1; unsigned char isDownloadRequested : 1; unsigned char shareOptions : 3; unsigned char isHiddenExtension : 1; unsigned char isTrashed : 1; unsigned char itemMode : 3; unsigned char fromReadOnlyDB : 1; unsigned char isSharedFolderSubItem : 1; unsigned char isSharedToMeOrContainsSharedToMeItem : 1; unsigned char isSharedByMeOrContainsSharedByMeItem : 1; unsigned char editedSinceShared : 1; unsigned char isNetworkOffline : 1; unsigned char isHiddenItem : 1; unsigned char isTopLevel : 1; unsigned char isEvictable : 1; unsigned char isAppLibraryTrashFolder : 1; unsigned char isAppLibraryRootFolder : 1; unsigned char isAppLibraryDocumentsFolder : 1; unsigned char evadeSpotlightIndexing : 1; unsigned char isContentZoneRoot : 1; unsigned char kind; } ; unsigned long long value; } _flags;
...
@property (readonly, nonatomic, getter=isContentZoneRoot) BOOL contentZoneRoot;
...
- (id)sharedItemRole;
- (void)updateContentVersion:(id)a0;
