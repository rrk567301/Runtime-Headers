@class NSMetadataQuery, NSString, NSArray, NSPredicate, NSOperationQueue, NSMutableDictionary, NSMutableArray, NSMutableSet, BRItemCollectionGatherer, br_pacer, NSObject;
...
- (void)_postNote:(struct __CFString { } *)a0;
- (void)_postNote:(struct __CFString { } *)a0 userInfo:(id)a1;
