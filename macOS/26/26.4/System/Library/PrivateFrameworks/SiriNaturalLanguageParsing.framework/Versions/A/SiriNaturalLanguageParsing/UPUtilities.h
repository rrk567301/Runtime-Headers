...
+ (struct basic_string<char16_t, std::char_traits<char16_t>, std::allocator<char16_t>> { struct { union __rep { struct __short { unsigned short x0[11]; struct __padding<1UL> { char x0[1]; } x1; unsigned char x2 : 7; unsigned char x3 : 1; } x0; struct __long { unsigned short *x0; unsigned long long x1; unsigned long x2 : 63; unsigned char x3 : 1; } x1; } x0; } x0; })nSStringToU16String:(id)a0;
