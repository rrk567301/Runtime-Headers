@class NSArray, FigCaptureSourceVideoFormat, NSMutableDictionary, NSDictionary, FigCaptureSessionConfiguration, NSMutableSet, NSObject, NSSet, NSNumber;
...
- (id)_bestVideoCameraActiveDeviceFormatForVideoConnectionConfiguration:(id)a0;
