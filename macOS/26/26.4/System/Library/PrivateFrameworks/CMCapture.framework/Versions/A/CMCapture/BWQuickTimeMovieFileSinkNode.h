...
@interface BWQuickTimeMovieFileSinkNode : BWFileSinkNode {
    ...
    BOOL _greenGhostMovieMetadataEnabled;
    BOOL _greenGhostSampleBufferMetadataDetected;
    ...
    BOOL _writeFirstFrameMetadataForProResRaw;
...
@property (nonatomic) BOOL frontRearSimultaneousVideoRecording;
