@interface CLPScdmaCellTower : PBCodable <NSCopying> {
    struct { unsigned char ci : 1; unsigned char lac : 1; unsigned char mcc : 1; unsigned char mnc : 1; } _has;
}
...
@property (nonatomic) BOOL hasLac;
