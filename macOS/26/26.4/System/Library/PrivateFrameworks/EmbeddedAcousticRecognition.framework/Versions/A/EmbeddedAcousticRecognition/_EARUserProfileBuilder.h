...
@interface _EARUserProfileBuilder : NSObject {
    ...
    struct map<std::string, long long, std::less<std::string>, std::allocator<std::pair<const std::string, long long>>> { struct __tree<std::__value_type<std::string, long long>, std::__map_value_compare<std::string, std::pair<const std::string, long long>, std::less<std::string>>, std::allocator<std::pair<const std::string, long long>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _templateToVersion;
