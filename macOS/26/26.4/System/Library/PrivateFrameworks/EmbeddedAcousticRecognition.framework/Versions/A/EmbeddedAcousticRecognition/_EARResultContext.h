...
@property (readonly, nonatomic) struct vector<std::vector<quasar::Token>, std::allocator<std::vector<quasar::Token>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } partialResults;
@property (readonly, nonatomic) unsigned long long partialResultIndexOffset;
@property (nonatomic) struct vector<std::vector<quasar::Token>, std::allocator<std::vector<quasar::Token>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } loggableConcatResult;
@property (nonatomic) struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } loggableConcatCosts;
@property (nonatomic) struct shared_ptr<quasar::result_handler::ResultHandler> { struct ResultHandler *__ptr_; struct __shared_weak_count *__cntrl_; } resultHandler;
