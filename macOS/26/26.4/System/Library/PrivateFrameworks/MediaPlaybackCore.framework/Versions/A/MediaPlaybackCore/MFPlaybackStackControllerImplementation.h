@class NSArray, AVQueuePlayer, NSDictionary, NSString, NSNumber;
@protocol MFExternalPlaybackConfigurable, MFQueuePlayerItem;

@interface MFPlaybackStackControllerImplementation : NSObject <MFPlaybackStackController, MFQueueManagement, MFPlaybackStackController_IPI> {
...
@property (nonatomic, readonly) BOOL mediaServicesAvailable;
...
@property (nonatomic, readonly) BOOL isPlaybackLikelyToKeepUp;
...
@property (nonatomic, readonly) BOOL supportsMultichannelAudio;
...
- (void)activateAudioSessionWithOptions:(unsigned long long)a0 completion:(id /* block */)a1;
