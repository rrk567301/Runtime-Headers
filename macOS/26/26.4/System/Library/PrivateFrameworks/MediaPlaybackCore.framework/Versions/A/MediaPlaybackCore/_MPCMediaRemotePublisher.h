@class NSString, NSArray, MPNowPlayingInfoCenter, MPRemoteCommandCenter, _MPCMediaRemotePublisher_Swift, _MPCMediaRemoteDetective, NSObject, NSDictionary, MSVBlockGuard, MPCPlaybackEngine;
...
@property (readonly, nonatomic, getter=hasInitializedSupportedCommands) BOOL initializedSupportedCommands;
...
- (void).cxx_destruct;
- (void)dealloc;
- (void)_snapshotOutOfSyncNotification:(id)a0;
- (void)commandCenter:(id)a0 didDeliverCommandEvent:(id)a1;
...
- (void)_MRPlaybackSessionMigratePostCallback:(id)a0 completion:(id /* block */)a1;
- (void)_activeSharedSessionDidChange:(id)a0;
- (BOOL)_commandRequiresMediaServices:(unsigned int)a0;
- (void)_dispatchCommandEvent:(id)a0 completion:(id /* block */)a1;
- (void)_durationUpdatedForItem:(id)a0 duration:(double)a1;
- (void)_enqueueFallbackIntentIfNeededForCommandEvent:(id)a0 play:(BOOL)a1 completion:(id /* block */)a2;
- (id)_exportableSessionTypes;
- (BOOL)_hasVideoForCurrentItem:(id)a0;
...
- (void)engineDidChangeTransitionSettings:(id)a0;
...
- (id)stripCommandStatusForEVS:(id)a0;
- (void)stripMediaRemoteOptionsForEVS:(id)a0;
