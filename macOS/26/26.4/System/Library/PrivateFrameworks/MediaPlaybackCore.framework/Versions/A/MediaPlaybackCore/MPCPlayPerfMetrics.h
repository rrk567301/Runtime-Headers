@class NSString, NSMutableDictionary, NSDictionary, NSDate, NSNumber;
...
@property (retain, nonatomic, setter=set_AVPlayerItemPerformanceMetrics:) NSDictionary *AVPlayerItemPerformanceMetrics;
@property (retain, nonatomic, setter=set_timeSinceBoot:) NSNumber *timeSinceBoot;
@property (retain, nonatomic, setter=set_timeSinceLaunch:) NSNumber *timeSinceLaunch;
@property (retain, nonatomic, setter=set_timeSincePaused:) NSNumber *timeSincePaused;
@property (retain, nonatomic, setter=set_userActionHandlingTime:) NSNumber *userActionHandlingTime;
...
+ (id)playMetricsWithItemReadyForMetricsEvent:(id)a0 cursor:(id)a1;
...
- (void)addQueueNetworkTimeWithScopedCursor:(id)a0 sectionID:(id)a1;
