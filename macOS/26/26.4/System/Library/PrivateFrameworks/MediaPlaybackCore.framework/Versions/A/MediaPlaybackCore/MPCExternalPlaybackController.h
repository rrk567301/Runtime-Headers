...
- (void)configureExternalPlaybackForPlayer:(id)a0 queueItem:(id)a1 prefersAudioOnly:(BOOL)a2;
- (void)configurePlayerForAudioOnly:(id)a0 item:(id)a1 reason:(id)a2;
