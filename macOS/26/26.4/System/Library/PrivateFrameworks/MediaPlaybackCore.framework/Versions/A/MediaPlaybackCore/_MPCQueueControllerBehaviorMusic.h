@class MPShuffleableSectionedIdentifierList, NSMutableDictionary, NSString, NSDictionary, NSNumber, MPSectionedIdentifierListPosition, MPSectionedIdentifierList;
...
@interface _MPCQueueControllerBehaviorMusic : NSObject <MPArtworkDataSource, MPShuffleableSectionedIdentifierListDelegate, MPSectionedIdentifierListAnnotationDelegate, MPCContinueListeningRadioQueueProviding, MPCQueueControllerBehaviorMusic, MPCQueueControllerBehaviorDynamicLoadingImplementation, MPCQueueControllerBehaviorTransportableImplementation, MPCQueueControllerBehaviorRestorableImplementation, MPCQueueControllerBehaviorUpNextImplementation, MPCQueueControllerBehaviorStartPlayerItemContinuableImplementation, MPCQueueControllerBehaviorTransitionTogglableImplementation> {
    ...
    BOOL _userToggledTransitionsInDowngradeState;
}
...
- (void)_emitEventsForAddingPlaybackContext:(id)a0 sectionIdentifier:(id)a1 source:(long long)a2;
...
- (BOOL)canUserToggleTransitionsEnabledWithReason:(id *)a0;
- (void)clearAllItemsAfterContentItemID:(id)a0;
- (void)clearUpNextAfterContentItemID:(id)a0;
...
- (BOOL)isOneShotExportableSessionForContentItemID:(id)a0 reason:(id *)a1;
- (BOOL)isSupportedInsertionPosition:(long long)a0 fromContentItemID:(id)a1 reason:(id *)a2;
- (BOOL)isSupportedQueueEndAction:(long long)a0;
...
- (void)setQueueEndAction:(long long)a0 completion:(id /* block */)a1;
...
- (void)toggleTransitionsEnabledFromRemoteCommand:(BOOL)a0 completion:(id /* block */)a1;
