...
- (BOOL)playerEnhanceDialogueActive:(BOOL)a0 chain:(id)a1;
...
- (BOOL)playerItemIsPreview:(BOOL)a0 atIndexPath:(id)a1 chain:(id)a2;
...
- (id)playerItemTransitionInfo:(id)a0 atIndexPath:(id)a1 chain:(id)a2;
...
- (BOOL)playerVideoEnabled:(BOOL)a0 chain:(id)a1;
...
- (long long)transitionStyle:(long long)a0 chain:(id)a1;
- (BOOL)transitionsActive:(BOOL)a0 chain:(id)a1;
