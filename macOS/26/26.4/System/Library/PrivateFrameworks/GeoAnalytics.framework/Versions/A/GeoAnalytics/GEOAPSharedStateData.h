@class NSObject, GEOLogMsgStateSuggestions, geo_isolater, geo_reentrant_isolater;
...
- (void)setHasSuggestionsSearchFieldType:(BOOL)a0;
...
- (void)setHasMapSettingsRouteHandoff:(BOOL)a0;
...
- (void)setHasSuggestionsAcSequenceNumber:(BOOL)a0;
...
- (void)setSuggestionsDisplayedResults:(id)a0;
...
- (void)setSuggestionsAcSequenceNumber:(int)a0;
...
- (void)setMapSettingsReportingIncidentsEnabled:(BOOL)a0;
...
- (void)setHasSuggestionsSelectedIndex:(BOOL)a0;
...
- (void)setMapSettingsVisitedPlaces:(int)a0;
- (void)setMapFeatureSubmittedPhotosCount:(int)a0;
- (void)setHasMapSettingsReportingIncidentsEnabled:(BOOL)a0;
- (void)setHasMapSettingsFamiliarRoutes:(BOOL)a0;
- (void)setMapSettingsSpeedLimitEnabled:(BOOL)a0;
- (void)setMapSettingsFamiliarRoutes:(BOOL)a0;
- (void)setMapFeatureSavedCollectionsCount:(int)a0;
- (void)setMapSettingsLabelEnabled:(BOOL)a0;
- (void)setHasMapSettingsVisitedPlaces:(BOOL)a0;
- (void)setSuggestionsSelectedIndex:(int)a0;
- (void).cxx_destruct;
- (void)setSuggestionsSearchString:(id)a0;
...
- (BOOL)rdar165650327_homeHasEnriched;
- (BOOL)rdar165650327_homeHasPlacesSection;
- (BOOL)rdar165650327_itemIsEnriched;
