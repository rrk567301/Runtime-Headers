...
- (void)publishDataConfirmedForHandle:(id)a0 localInterfaceIndex:(unsigned int)a1 serviceSpecificInfo:(id)a2 pairingKeyStoreID:(id)a3;
- (void)publishDataConfirmedForHandle:(id)a0 localInterfaceIndex:(unsigned int)a1 serviceSpecificInfo:(id)a2 pairingKeyStoreID:(id)a3 deviceID:(unsigned long long)a4;
...
- (void)publishKeysBlobForMulticastSession:(id)a0;
- (void)publishPairingApprovalForSubscriber:(id)a0 withPairingMethod:(long long)a1 pairingSetupApprovalCompletion:(id /* block */)a2;
- (void)publishPairingApprovalForSubscriber:(id)a0 withPairingMethod:(long long)a1 pairingSetupApprovalHandler:(id /* block */)a2;
- (void)publishPairingDidSucceedWithPairingKeyStoreID:(id)a0 deviceID:(unsigned long long)a1;
- (void)publishPairingRequestEndedWithSubscriber:(id)a0 reason:(long long)a1;
...
- (void)updateTimeout:(unsigned long long)a0 completionHandler:(id /* block */)a1;
