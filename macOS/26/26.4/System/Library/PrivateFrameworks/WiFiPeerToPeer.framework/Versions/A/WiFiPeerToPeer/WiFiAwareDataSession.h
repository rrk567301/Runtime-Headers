@class NSData, NSString, WiFiAwareDiscoveryResult, WiFiAwareInternetSharingConfiguration, WiFiAwarePublishServiceSpecificInfo, WiFiAwarePairingMetadata, WiFiMACAddress, WiFiP2PXPCConnection, NSNumber, WiFiAwarePublishDatapathServiceSpecificInfo, WiFiAwareMulticastConfiguration;
...
- (void)datapathConfirmedForPeerDataAddress:(id)a0 serviceSpecificInfo:(id)a1 pairingKeyStoreID:(id)a2 deviceID:(unsigned long long)a3;
- (void)datapathPairingDidSucceedWithPairingKeyStoreID:(id)a0 deviceID:(unsigned long long)a1;
- (void)datapathPairingRequestStartedWithPairingMethod:(long long)a0 pairingAuthenticationInputCompletionHandler:(id /* block */)a1;
...
- (void)generateDiversifiedPINWithCompletionHandler:(id /* block */)a0;
