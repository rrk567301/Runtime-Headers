@class NSData, NSString, NSAttributedString, MTSyncInfo, NSSet, NSOrderedSet, NSUUID, NSDate, MTPodcast;
...
@property (nonatomic) BOOL isCurrentNewEpisode;
...
+ (id)_predicateForPriceType:(long long)a0 forPriceTypeKey:(id)a1 excluding:(BOOL)a2;
...
+ (id)insertNewEpisodeInManagedObjectContext:(id)a0 canSendNotifications:(BOOL)a1;
+ (id)insertNewEpisodeInManagedObjectContext:(id)a0 title:(id)a1 podcast:(id)a2 pubDate:(id)a3 byteSize:(long long)a4 guid:(id)a5 uti:(id)a6 contentId:(long long)a7 enclosureUrl:(id)a8 playStateSource:(int)a9 importSource:(int)a10 canSendNotifications:(BOOL)a11;
...
+ (id)predicateForEpisodeDescriptionMatch:(id)a0;
...
+ (id)predicateForEpisodeTitleMatch:(id)a0;
...
+ (id)predicateForEpisodesFirstAvailableAfterDate:(id)a0;
...
- (void)setDownloadError:(long long)a0;
- (BOOL)isEntitled;
...
- (BOOL)allowsDurationUpdateFromSource:(int)a0;
- (id)bestUrl;
...
- (id)bestEnclosureMetadataWithIsSubscriptionActive:(BOOL)a0;
- (id)bestSummary;
- (id)bestTitle;
- (id)displayURL;
- (double)endOfTrack;
...
- (void)setExplicitEpisode:(BOOL)a0;
...
- (void)setPlayState:(long long)a0 manually:(BOOL)a1 source:(int)a2;
- (void)setPlayed:(BOOL)a0 manually:(BOOL)a1 source:(int)a2;
