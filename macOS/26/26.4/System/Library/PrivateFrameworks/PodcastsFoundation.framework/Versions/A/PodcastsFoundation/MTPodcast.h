...
+ (id)insertNewPodcastInManagedObjectContext:(id)a0 subscribed:(BOOL)a1 feedUrl:(id)a2 showType:(long long)a3 showTypeInFeed:(id)a4 title:(id)a5 author:(id)a6 provider:(id)a7 imageUrl:(id)a8 description:(id)a9 adamId:(long long)a10 displayType:(id)a11 showSpecificUpsellCopy:(id)a12;
+ (id)insertNewPodcastInManagedObjectContext:(id)a0 subscribed:(BOOL)a1 feedUrl:(id)a2 showType:(long long)a3 showTypeInFeed:(id)a4 title:(id)a5 author:(id)a6 provider:(id)a7 imageUrl:(id)a8 description:(id)a9 displayType:(id)a10 showSpecificUpsellCopy:(id)a11;
+ (id)insertNewPodcastInManagedObjectContext:(id)a0 subscribed:(BOOL)a1 feedUrl:(id)a2 showType:(long long)a3 title:(id)a4 author:(id)a5 provider:(id)a6 imageUrl:(id)a7 description:(id)a8;
...
+ (id)predicateForPodcastFeedUrls:(id)a0;
...
- (void)applyDefaultFollowedShowSettingsFor:(long long)a0;
- (void)applyDefaultUnfollowedShowSettings;
- (BOOL)autoDownloadVideoResolvedValue;
...
- (void)setMediaKindsFromStringSet:(id)a0;
