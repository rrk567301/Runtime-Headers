...
- (void)requestReturnToServiceObliterationWithPreserveDataPlan:(BOOL)a0 disallowProximitySetup:(BOOL)a1 mdmProfileData:(id)a2 wifiProfileData:(id)a3 revertToSnapshotName:(id)a4 bootstrapToken:(id)a5 shouldRetryEnrollment:(BOOL)a6 completionHandler:(id /* block */)a7;
