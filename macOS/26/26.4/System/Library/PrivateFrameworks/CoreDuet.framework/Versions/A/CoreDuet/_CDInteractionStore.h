...
- (id)createInteractionRecord:(id)a0 context:(id)a1 keywordCache:(id)a2 attachmentCache:(id)a3 contactCache:(id)a4 recordAlreadyExists:(BOOL)a5 error:(id *)a6;
...
- (void)iterInteractionRecordsWithPredicate:(id)a0 fetchLimit:(unsigned long long)a1 sortAscending:(BOOL)a2 preemptBackgroundWork:(BOOL)a3 updateTelemetry:(id /* block */)a4 withBlock:(id /* block */)a5;
