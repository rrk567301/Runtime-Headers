@class NSString, NSUUID, NSURL, NSDate, NSNumber, NSArray;
...
- (id)initWithIdentifier:(id)a0 cloudIdentifier:(id)a1 photoLocalIdentifier:(id)a2 type:(id)a3 sizeInBytes:(id)a4 creationDate:(id)a5 contentURL:(id)a6 contentText:(id)a7 photoSceneDescriptor:(id)a8 personInPhoto:(id)a9 contentTitle:(id)a10 contentKeywords:(id)a11;
