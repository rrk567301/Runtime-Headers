...
- (id)initWithAdamID:(id)a0 assetInfo:(id)a1 adData:(id)a2 instanceID:(id)a3 commonAdInfo:(id)a4;
- (id)initWithAdamID:(id)a0 cppIDs:(id)a1 serverCppID:(id)a2 adData:(id)a3 instanceID:(id)a4 commonAdInfo:(id)a5;
- (void).cxx_destruct;
