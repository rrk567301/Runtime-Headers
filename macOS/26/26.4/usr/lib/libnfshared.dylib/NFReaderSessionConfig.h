...
@property (readonly, nonatomic) BOOL delayConnectionHandoverRestart;

+ (id)sessionConfigWithUIMode:(unsigned long long)a0 sessionType:(unsigned long long)a1 initialScanText:(id)a2 vasPass:(id)a3 delayConnectionHandoverRestart:(BOOL)a4;
