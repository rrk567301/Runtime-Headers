...
@interface boringssl_concrete_boringssl_ctx : NSObject <OS_boringssl_ctx> {
    ...
    unsigned char ats_non_pfs_ciphersuite_allowed : 1;
    unsigned char old_ats_enforced : 1;
    unsigned char old_ats_enforced_compat : 1;
    unsigned char fcs_tls_v2_compliance_mode_enabled : 1;
    ...
    unsigned char pqtls_enabled : 1;
    unsigned char pake_offered : 1;
    unsigned char tls13_epsk_offered : 1;
    unsigned char ats_applicable : 1;
    unsigned char legacy_ats_applicable : 1;
    unsigned char is_local_networking : 1;
}
