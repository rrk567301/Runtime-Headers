@class RTInvocationDispatcher, NSMutableDictionary, RTPersistenceManager, RTInterimPersistenceManager;
...
+ (long long)evaluatePolicyForCoreDataContextPerformBlockException:(id)a0;
+ (id)exceptionHandlingPolicyToString:(long long)a0;
+ (BOOL)handleCoreDataException:(id)a0 outError:(id *)a1;
...
- (void)_onInterimPersistenceManagerNotification:(id)a0;
...
- (id)initWithInterimPersistenceManager:(id)a0;
- (void)onInterimPersistenceManagerNotification:(id)a0;
