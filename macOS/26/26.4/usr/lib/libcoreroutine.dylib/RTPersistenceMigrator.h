...
+ (id)_metadataStateToString:(long long)a0;
...
- (long long)_detectMetadataStateForStore:(id)a0 coordinator:(id)a1 error:(id *)a2;
...
- (BOOL)_updateStoreMetadataWithAppleIDs:(id)a0 coordinator:(id)a1 error:(id *)a2;
