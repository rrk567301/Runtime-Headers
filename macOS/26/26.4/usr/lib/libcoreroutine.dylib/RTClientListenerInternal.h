@class RTMapServiceManager, RTLocationManager, RTBuildingPolygonManager, RTAccountManager, RTUserCurationManager, RTLocationStore, RTDeviceLocationPredictor, RTScenarioTriggerManager, RTEventModelProvider, RTVehicleLocationProvider, SMSafetyCacheStore, RTAuthorizationManager, RTLearnedLocationManager, RTDiagnostics, RTPurgeManager, RTPlatform, RTLearnedLocationStore, RTVisitManager, RTWiFiManager, RTWorkoutScheduler, RTIntermittentGNSSManager, RTMotionActivityManager, RTPredictedContextManager, RTBluePOITileManager, RTEventAgentManager, RTAssetManager, RTTripSegmentManager, RTPersistenceManager, RTWorkoutRouteManager, RTAuthorizedLocationManager, RTPointOfInterestSampler, NSString, RTPlaceInferenceQueryStore, RTHintManager, RTFingerprintManager, RTPeopleDiscoveryProvider;
