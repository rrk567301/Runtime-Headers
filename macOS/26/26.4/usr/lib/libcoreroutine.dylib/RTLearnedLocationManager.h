@class NSString, RTLearnedLocationEngine, RTLearnedPlaceTypeInferenceStore, RTDefaultsManager, RTContactsManager, RTDistanceCalculator, RTLearnedLocationStore, RTMapServiceManager;
...
- (id)_createLookbackDateIntervalFromOptions:(id)a0 error:(id *)a1;
...
- (void)learnedLocationEngineDidUpdate:(id)a0 intervalSinceLastUpdate:(double)a1 trainMode:(unsigned long long)a2 trainResult:(unsigned long long)a3;
...
- (void)_applyUserCuration:(id)a0 harvestCuration:(BOOL)a1 handler:(id /* block */)a2;
...
- (id)initWithQueue:(id)a0 contactsManager:(id)a1 defaultsManager:(id)a2 distanceCalculator:(id)a3 learnedLocationStore:(id)a4 learnedPlaceTypeInferenceStore:(id)a5 mapServiceManager:(id)a6;
