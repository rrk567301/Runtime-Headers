...
- (BOOL)_isUpdateLearnedPlaceWithBusinessHoursRequired:(id)a0;
- (BOOL)_isUpdateLearnedPlaceWithGeomapItemIdentifierRequired:(id)a0;
...
- (void)_submitMetricsForApplicationOfCuratedLabel:(id)a0 visit:(id)a1 result:(unsigned long long)a2;
...
- (id)_updateLearnedPlaceWithBusinessHours:(id)a0;
...
- (id)_updateLearnedPlaceWithGeomapItemIdentifier:(id)a0;
