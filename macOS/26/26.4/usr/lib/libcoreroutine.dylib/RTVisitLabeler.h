...
- (void)startWiFiScanForLabelling:(id)a0 clientIdentifier:(id)a1 policy:(unsigned long long)a2 delay:(double)a3 maxRetries:(unsigned long long)a4 handler:(id /* block */)a5;
