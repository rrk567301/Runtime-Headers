...
- (BOOL)deleteTripClusterRoadTransitionsWithClusterID:(id)a0 maxDeleteAttempts:(unsigned long long)a1;
...
- (unsigned long long)getTripClusterRoadTransitionsDataCountForClusterID:(id)a0;
