...
+ (id)amountDictionaryWithAmount:(id)a0 withIdentifier:(id)a1 usingAmountKey:(id)a2 usingCurrencyKey:(id)a3 usingExponentKey:(id)a4 usingIdentifierKey:(id)a5 withUniqueIdentifier:(id)a6 usingUniqueIdentifierKey:(id)a7;
+ (id)commutePlanWithIdAndExpiry:(id)a0 withExpiry:(id)a1 withUniqueId:(id)a2;
+ (id)formatPartnerRecords:(id)a0 withFileLabel:(id)a1;
...
- (id)getServiceProviderData:(id)a0 withPackage:(id)a1 withModule:(id)a2 withPublicKey:(id)a3 withEncryptionScheme:(id)a4 withTransceiver:(id)a5 withFileMapping:(id)a6 withError:(id *)a7;
