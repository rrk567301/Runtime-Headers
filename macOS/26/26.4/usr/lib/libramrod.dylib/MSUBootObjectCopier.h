...
- (void)dealloc;
- (id)_tagsToPreserve;
- (BOOL)_buildIdentityHasCentauri:(id)a0;
- (id)_centauriManifestTypes;
...
- (id)bootFolderPathOnVolume:(id)a0 nsih:(id)a1;
...
- (BOOL)populateSystemRecoveryVolume:(id)a0 buildIdentity:(id)a1 ticket:(id)a2 fetchBootObjectBlock:(id /* block */)a3;
