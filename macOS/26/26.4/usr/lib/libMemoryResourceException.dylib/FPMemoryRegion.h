@class NSString, FPRangeList, NSDictionary;
...
@interface FPMemoryRegion : NSObject <FPMemoryObject> {
    ...
    unsigned char _hasNoFootprint : 1;
    FPRangeList *_subrangeList;
}

@property (nonatomic) BOOL verbose;
@property (nonatomic) BOOL hasNoFootprint;
...
- (void)addSubrange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 memoryTotal:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned int x5; } *)a1;
