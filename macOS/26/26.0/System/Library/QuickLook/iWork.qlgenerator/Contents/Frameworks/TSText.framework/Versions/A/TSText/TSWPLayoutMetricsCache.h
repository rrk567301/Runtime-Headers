...
@interface TSWPLayoutMetricsCache : NSObject <TSWPStorageParagraphObserver> {
    ...
    struct vector<TSWPParagraphMetrics, std::allocator<TSWPParagraphMetrics>> { struct TSWPParagraphMetrics *__begin_; struct TSWPParagraphMetrics *__end_; struct TSWPParagraphMetrics *__cap_; } _paragraphMetrics;
}
