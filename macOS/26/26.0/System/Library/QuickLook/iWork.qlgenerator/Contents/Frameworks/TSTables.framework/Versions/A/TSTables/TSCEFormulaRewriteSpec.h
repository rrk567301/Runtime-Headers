@class TSCEFormulaRewrite_RegionMergedInfo, TSCETableTransposedInfo, TSCEFormulaRewriteInfo_RowColumnInfo, TSCECoordMapper, TSCERewriteTableUIDInfo, NSMutableArray, TSTImportWarningSetByCellRef, TSCEGroupByChange, TSCEFormulaRewrite_MergeOriginMovedInfo, TSCEFormulasForUndo, TSCERewriteGroupNodeUIDInfo, TSKShuffleMapping, TSCEFormulaRewrite_RegionMovedInfo;
...
@property (nonatomic) BOOL forSpillFormulasOnly;
...
- (struct unordered_set<TSKUIDStruct, std::hash<TSKUIDStruct>, std::equal_to<TSKUIDStruct>, std::allocator<TSKUIDStruct>> { struct __hash_table<TSKUIDStruct, std::hash<TSKUIDStruct>, std::equal_to<TSKUIDStruct>, std::allocator<TSKUIDStruct>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<TSKUIDStruct, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TSKUIDStruct, void *> *> *>>> { void **x0; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TSKUIDStruct, void *> *> *>> { unsigned long long x0; } x1; } x0; struct __hash_node_base<std::__hash_node<TSKUIDStruct, void *> *> { void *x0; } x1; unsigned long long x2; float x3; } x0; })affectedOwnerUIDs;
- (id)amendRewriteWithCalcEngine:(id)a0;
- (void)clearTableIndexes;
- (void *)conditionalStylesForUndo;
- (id)coordMapperForTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 calcEngine:(id)a1;
- (void)didModifySrcTable:(id)a0 dstTable:(id)a1;
- (void)didModifyTable:(id)a0 calcEngine:(id)a1;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct TSKUIDStruct *x2; })expandedRowColumnUuids;
