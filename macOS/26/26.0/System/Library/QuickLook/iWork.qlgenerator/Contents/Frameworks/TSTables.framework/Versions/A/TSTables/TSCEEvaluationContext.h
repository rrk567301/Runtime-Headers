@class __end_, __cap_, TSCECalculationEngine, TSCEValueBindingEnvironment, TSCERemoteDataSpecifierSet, TSULocale, NSMutableSet, NSMutableDictionary, TSCEDependencyTracker;

@interface TSCEEvaluationContext : NSObject <NSCopying> {
    struct TSCEEvaluationStack { struct vector<TSCEValue *, std::allocator<TSCEValue *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _evaluationStack; unsigned int _argumentCount; } _evaluationStack;
...
- (void)addDynamicPrecedent:(id)a0;
