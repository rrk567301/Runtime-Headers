...
- (id)initWithTableResolver:(struct TSCETableResolverWrapper { id x0; } *)a0 topLeft:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } *)a1 bottomRight:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } *)a2 preserveFlags:(const struct TSUPreserveFlags { unsigned char x0; } *)a3;
...
- (id)intersectionWithHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 rangeContext:(unsigned char)a1;
- (id)intersectionWithHostCellRef:(const struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } *)a0 rangeContext:(unsigned char)a1 evaluationContext:(id)a2;
...
- (id)scalarValueFromCoord:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } *)a0 readOptions:(unsigned short)a1;
