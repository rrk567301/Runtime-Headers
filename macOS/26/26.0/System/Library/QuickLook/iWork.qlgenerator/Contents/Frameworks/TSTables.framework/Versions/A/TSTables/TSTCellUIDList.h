...
@interface TSTCellUIDList : NSObject <NSCopying> {
    struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct TSKUIDStruct *__cap_; } _rowIdList;
    struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *__begin_; struct TSKUIDStruct *__end_; struct TSKUIDStruct *__cap_; } _columnIdList;
    struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } _rowUIDIndexList;
    struct vector<int, std::allocator<int>> { int *__begin_; int *__end_; int *__cap_; } _columnUIDIndexList;
