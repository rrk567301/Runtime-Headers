...
- (struct vector<TSUModelCellRect, std::allocator<TSUModelCellRect>> { struct TSUModelCellRect *x0; struct TSUModelCellRect *x1; struct TSUModelCellRect *x2; })mergeRanges;
...
- (struct vector<TSUModelCellRect, std::allocator<TSUModelCellRect>> { struct TSUModelCellRect *x0; struct TSUModelCellRect *x1; struct TSUModelCellRect *x2; })mergeRangesIntersectingBaseCellRegion:(id)a0;
