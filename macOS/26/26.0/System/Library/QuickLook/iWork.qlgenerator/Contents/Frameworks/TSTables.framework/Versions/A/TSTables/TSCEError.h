...
+ (id)invalidIntersectionError:(struct vector<TSCEReferenceValue *, std::allocator<TSCEReferenceValue *>> { id *x0; id *x1; id *x2; })a0 hostTableUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 calcEngine:(id)a2;
