...
@interface TSCERangeDependencies : NSObject {
    ...
    struct vector<TSCERangePrecedentsTile *, std::allocator<TSCERangePrecedentsTile *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _rangePrecedentsTiles;
    struct vector<TSCEUnarchiveRangePrecedent, std::allocator<TSCEUnarchiveRangePrecedent>> { struct TSCEUnarchiveRangePrecedent *__begin_; struct TSCEUnarchiveRangePrecedent *__end_; struct TSCEUnarchiveRangePrecedent *__cap_; } _unarchivedPrecedentList;
}
