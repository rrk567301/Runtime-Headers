@interface TSCECellRecordTile : TSPObject {
    ...
    struct vector<TSCECellRecord *, std::allocator<TSCECellRecord *>> { struct TSCECellRecord **__begin_; struct TSCECellRecord **__end_; struct TSCECellRecord **__cap_; } _cellRecords;
...
- (struct vector<TSCECellRecord *, std::allocator<TSCECellRecord *>> { struct TSCECellRecord **x0; struct TSCECellRecord **x1; struct TSCECellRecord **x2; })sortedCellRecordVector;
