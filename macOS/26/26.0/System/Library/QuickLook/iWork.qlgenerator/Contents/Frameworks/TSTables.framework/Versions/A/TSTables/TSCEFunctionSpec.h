...
@interface TSCEFunctionSpec : TSUPermanentObject {
    ...
    struct vector<TSCEFunctionArgSpec *, std::allocator<TSCEFunctionArgSpec *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _arguments;
    struct vector<TSCEFunctionArgSpec *, std::allocator<TSCEFunctionArgSpec *>> { __end_ **__begin_; __cap_ **x0; id *x1; } _repeatingArguments;
}
