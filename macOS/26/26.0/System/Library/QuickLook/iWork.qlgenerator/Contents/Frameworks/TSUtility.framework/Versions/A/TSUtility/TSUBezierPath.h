...
+ (void)subdivideBezierWithFlatness:(double)a0 startPoint:(struct CGPoint { double x0; double x1; })a1 controlPoint1:(struct CGPoint { double x0; double x1; })a2 controlPoint2:(struct CGPoint { double x0; double x1; })a3 endPoint:(struct CGPoint { double x0; double x1; })a4 addLineBlock:(id /* block */)a5;
...
- (id)copyWithPointsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 countingSubpaths:(unsigned long long *)a1;
- (void)_deviceCurveToPoint:(struct CGPoint { double x0; double x1; })a0 controlPoint1:(struct CGPoint { double x0; double x1; })a1 controlPoint2:(struct CGPoint { double x0; double x1; })a2 elementLength:(double)a3;
- (void)convertCloseElementsToLineElements;
- (void)iteratePathElementsWithBlock:(id /* block */)a0;
- (void)p_appendPointsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 fromBezierPath:(id)a1 countingSubpaths:(unsigned long long *)a2;
- (void)p_subdivideBezierWithFlatness:(double)a0 startPoint:(struct CGPoint { double x0; double x1; })a1 controlPoint1:(struct CGPoint { double x0; double x1; })a2 controlPoint2:(struct CGPoint { double x0; double x1; })a3 endPoint:(struct CGPoint { double x0; double x1; })a4;
