...
@interface TSCH3DShaderContext : NSObject {
    struct ObjectStateMatchObject { struct ObjcSharedPtr<NSSet> { NSSet *mValue; } _effects; struct vector<TSCH3D::ResourceAttributeState, std::allocator<TSCH3D::ResourceAttributeState>> { struct ResourceAttributeState *__begin_; struct ResourceAttributeState *__end_; struct ResourceAttributeState *__cap_; } _attributes; struct vector<TSCH3D::TextureAttributeState, std::allocator<TSCH3D::TextureAttributeState>> { struct TextureAttributeState *__begin_; struct TextureAttributeState *__end_; struct TextureAttributeState *__cap_; } _textures; } _state;
}
