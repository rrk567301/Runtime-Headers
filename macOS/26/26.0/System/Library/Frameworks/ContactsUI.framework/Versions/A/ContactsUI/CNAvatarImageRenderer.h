...
- (id)renderAvatarsForContacts:(id)a0 scope:(id)a1 includePlaceholder:(BOOL)a2 workScheduler:(id)a3 observer:(id)a4;
...
- (id)runScopeBasedImageObservable:(id /* block */)a0 scope:(id)a1 observer:(id)a2;
