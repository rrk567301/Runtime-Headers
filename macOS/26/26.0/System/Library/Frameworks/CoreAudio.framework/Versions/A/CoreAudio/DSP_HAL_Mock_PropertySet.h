...
@property (nonatomic) struct function<unsigned int (const AudioObjectPropertyAddress &, unsigned int)> { struct __value_func<unsigned int (const AudioObjectPropertyAddress &, unsigned int)> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } propertyUpdater;
...
- (void)configureForProcessor:(struct function<void (unsigned int, unsigned int)> { struct __value_func<void (unsigned int, unsigned int)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; })a0;
