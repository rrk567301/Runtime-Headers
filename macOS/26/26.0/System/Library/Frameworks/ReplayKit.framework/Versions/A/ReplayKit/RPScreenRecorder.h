...
@property (nonatomic, getter=isMixedRealityCameraEnabled) BOOL mixedRealityCameraEnabled;
...
+ (id)sharedRecorder;
+ (id)validateHQLRSessionInfo:(id)a0;
...
- (void)startHQLRWithSessionInfo:(id)a0 handler:(id /* block */)a1;
