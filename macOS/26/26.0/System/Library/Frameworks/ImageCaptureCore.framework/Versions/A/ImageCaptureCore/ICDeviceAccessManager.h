...
- (BOOL)captureUserIntentForControlWithBundleIdentifier:(id)a0 withNotification:(id)a1;
...
- (void)displayAlertForControlWithNotification:(id)a0 completionBlock:(id /* block */)a1;
