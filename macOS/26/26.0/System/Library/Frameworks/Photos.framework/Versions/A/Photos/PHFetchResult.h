...
- (void)_handleInitWithInvalidConfigurationDetails:(id)a0 library:(id)a1;
- (id)_mediaTypeCounts;
...
- (id)initWithMediaTypeCounts:(id)a0 library:(id)a1;
- (id)initWithQuery:(id)a0 library:(id)a1;
- (id)initWithQuery:(id)a0 library:(id)a1 oids:(id)a2 registerIfNeeded:(BOOL)a3 usingManagedObjectContext:(id)a4;
- (id)initWithQuery:(id)a0 library:(id)a1 registerIfNeeded:(BOOL)a2;
- (id)localIdentifiers;
