...
@interface PHQuery : NSObject <NSPredicateVisitor, NSCopying> {
    ...
    BOOL _containsToManySelfInPredicate;
...
+ (id)queryForAssetsCaptured:(BOOL)a0 orEdited:(BOOL)a1 onThisCameraSinceDate:(id)a2 options:(id)a3;
...
+ (id)queryForAssetResourceUploadJobConfigurationsWithLocalIdentifiers:(id)a0 options:(id)a1;
...
+ (id)queryForSuggestionsWithState:(unsigned short)a0 type:(unsigned short)a1 subtype:(unsigned short)a2 options:(id)a3;
+ (id)queryForEntryWithLocalIdentifier:(id)a0 options:(id)a1;
+ (id)queryForShareParticipantsWithLocalIdentifiers:(id)a0 options:(id)a1;
+ (id)queryForAssetsForPTPWithOptions:(id)a0;
...
+ (id)queryForLikesForAsset:(id)a0 options:(id)a1;
...
+ (id)queryForContributorForComment:(id)a0 options:(id)a1;
...
+ (id)queryForAssetsAssociatedWithMomentsOfMemory:(id)a0 options:(id)a1;
+ (id)queryForEntriesFromEarliestDate:(id)a0 latestDate:(id)a1 filter:(long long)a2 options:(id)a3;
+ (id)queryForFacesOnFaceCrop:(id)a0 options:(id)a1;
+ (id)queryForCloudSharedAlbumInvitationRecordsWithOptions:(id)a0;
+ (id)queryForAssetsEditedOnThisCameraSinceDate:(id)a0 options:(id)a1;
...
+ (id)queryForMemoriesWithLocalIdentifiers:(id)a0 options:(id)a1;
+ (id)queryForKeyAssetInPhotosHighlight:(id)a0 options:(id)a1;
+ (id)queryForCloudSharedAlbumsWithLocalIdentifiers:(id)a0 options:(id)a1;
+ (id)queryForVisibleAssetsWithObjectIDs:(id)a0 options:(id)a1;
+ (id)queryForCurrentUserParticipantInShare:(id)a0 options:(id)a1;
...
+ (id)queryForType:(id)a0 withLocalIdentifiers:(id)a1 options:(id)a2;
...
+ (id)queryForAnyCinematicVideosNeedingDeferredProcessingWithOtions:(id)a0;
+ (id)queryForKeyAssetsInSuggestion:(id)a0 options:(id)a1;
+ (id)queryForOwnerParticipantInShare:(id)a0 options:(id)a1;
+ (id)queryForAssetsForComment:(id)a0 options:(id)a1;
...
+ (id)queryForAssetsUsingSearchIndexLookupIdentifier:(id)a0 options:(id)a1;
+ (id)queryForKeyAssetForPerson:(id)a0 options:(id)a1;
...
+ (id)queryForAssetResourceUploadJobConfigurationsWithOptions:(id)a0;
...
+ (id)queryForCollageAssetsInDayHighlight:(id)a0 options:(id)a1;
+ (id)queryForAssetsWithCloudIdentifiers:(id)a0 options:(id)a1;
+ (unsigned int)_excludeMaskForUserLibraryWithFetchOptions:(id)a0;
+ (id)queryForProjectsWithLocalIdentifiers:(id)a0 options:(id)a1;
+ (id)queryForAssetsCapturedOnThisCameraSinceDate:(id)a0 options:(id)a1;
...
+ (id)defaultSortDescriptorForFetchType:(id)a0 predicate:(id)a1 ascending:(BOOL)a2;
...
+ (BOOL)isToManySelfInPredicate:(id)a0;
+ (id)queryForAllTripHighlightsContainingAssetUUIDs:(id)a0 options:(id)a1;
...
+ (id)queryForCommentsWithLocalIdentifiers:(id)a0 options:(id)a1;
+ (id)queryForAssetsInConversations:(id)a0 options:(id)a1;
+ (id)queryForRepresentativeAssetsInSuggestion:(id)a0 options:(id)a1;
+ (id)queryForAssetsForCloudFeedEntry:(id)a0 options:(id)a1;
...
+ (id)_queryForAssetsWithLocalIdentifiers:(id)a0 options:(id)a1;
...
+ (id)queryForLikesForCloudFeedEntry:(id)a0 options:(id)a1;
+ (id)queryForShareParticipantsInShare:(id)a0 options:(id)a1;
+ (void)photoLibraryWasAccessed;
+ (id)queryForAssetResourceUploadJobsWithConfiguration:(id)a0 options:(id)a1;
...
- (id)_effectiveDefaultSortDescriptorReversingOrder:(BOOL)a0;
