...
+ (id)performDisambiguationForPerson:(id)a0 usingGroundedNames:(id)a1 photoLibrary:(id)a2;
...
+ (id)performDisambiguationForGenericLocationName:(id)a0 allowedSearchIndexCategories:(id)a1 photoLibrary:(id)a2;
