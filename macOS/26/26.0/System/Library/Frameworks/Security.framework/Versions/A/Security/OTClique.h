...
+ (id)fetchAccountWideSettings:(id)a0 error:(id *)a1;
+ (id)fetchAccountWideSettingsDefaultWithForceFetch:(BOOL)a0 configuration:(id)a1 error:(id *)a2;
+ (id)filterRecords:(id)a0;
+ (id)recordMatchingLabel:(id)a0 allRecords:(id)a1;
+ (id)sortListPrioritizingiOSRecords:(id)a0;
+ (id)_fetchAccountWideSettingsDefaultWithForceFetch:(BOOL)a0 useDefault:(BOOL)a1 configuration:(id)a2 error:(id *)a3;
+ (BOOL)areRecoveryKeysDistrusted:(id)a0 error:(id *)a1;
+ (id)createAndSetRecoveryKeyWithContext:(id)a0 error:(id *)a1;
+ (long long)doesRecoveryKeyExistInOctagonAndIsCorrect:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (long long)doesRecoveryKeyExistInSOSAndIsCorrect:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (BOOL)ensureBackupKeyExistsinSOS:(id *)a0;
+ (id)escrowCheck:(id)a0 isBackgroundCheck:(BOOL)a1 error:(id *)a2;
+ (id)fetchAccountWideSettingsWithForceFetch:(BOOL)a0 configuration:(id)a1 error:(id *)a2;
+ (id)fetchAllEscrowRecords:(id)a0 error:(id *)a1;
+ (id)fetchAndHandleEscrowRecords:(id)a0 shouldFilter:(BOOL)a1 error:(id *)a2;
+ (id)fetchEscrowRecords:(id)a0 error:(id *)a1;
+ (id)filterViableSOSRecords:(id)a0;
+ (id)handleRecoveryResults:(id)a0 recoveredInformation:(id)a1 record:(id)a2 performedSilentBurn:(BOOL)a3 error:(id *)a4;
+ (BOOL)invalidateEscrowCache:(id)a0 error:(id *)a1;
+ (BOOL)isRecoveryKeySetInOctagon:(id)a0 error:(id *)a1;
+ (BOOL)isRecoveryKeySetInSOS:(id)a0 error:(id *)a1;
+ (id)performEscrowRecovery:(id)a0 cdpContext:(id)a1 escrowRecord:(id)a2 error:(id *)a3;
+ (id)performSilentEscrowRecovery:(id)a0 cdpContext:(id)a1 allRecords:(id)a2 error:(id *)a3;
+ (BOOL)preflightRecoverOctagonUsingRecoveryKey:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (BOOL)recoverWithRecoveryKey:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (BOOL)registerRecoveryKeyInSOSAndBackup:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (BOOL)registerRecoveryKeyWithContext:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (BOOL)setRecoveryKeyWithContext:(id)a0 recoveryKey:(id)a1 error:(id *)a2;
+ (id)totalTrustedPeers:(id)a0 error:(id *)a1;
+ (id)trustedFullPeers:(id)a0 error:(id *)a1;
...
- (BOOL)setAccountSetting:(id)a0 error:(id *)a1;
- (BOOL)deliverAKDeviceListDelta:(id)a0 error:(id *)a1;
- (id)fetchAccountSettings:(id *)a0;
- (id)fetchTrustedSecureElementIdentities:(id *)a0;
- (BOOL)removeLocalSecureElementIdentityPeerID:(id)a0 error:(id *)a1;
- (BOOL)removeRecoveryKey:(id)a0 error:(id *)a1;
- (BOOL)removeRecoveryKeyFromSOSWhenInCircle:(id)a0 error:(id *)a1;
- (BOOL)removeRecoveryKeyFromSOSWhenNOTInCircle:(id)a0 error:(id *)a1;
- (BOOL)setLocalSecureElementIdentity:(id)a0 error:(id *)a1;
- (id)tlkRecoverabilityForEscrowRecord:(id)a0 error:(id *)a1;
- (BOOL)waitForPriorityViewKeychainDataRecovery:(id *)a0;
