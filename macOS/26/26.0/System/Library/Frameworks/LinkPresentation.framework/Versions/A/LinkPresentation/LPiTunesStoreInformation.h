...
@interface LPiTunesStoreInformation : NSObject {
    ...
    BOOL _capabilitiesAreOverridden;
    BOOL _storefrontIdentifierIsOverridden;
}
...
- (void)_setOverrideCapabilities:(unsigned long long)a0;
- (void)_setOverrideStorefrontIdentifier:(id)a0;
