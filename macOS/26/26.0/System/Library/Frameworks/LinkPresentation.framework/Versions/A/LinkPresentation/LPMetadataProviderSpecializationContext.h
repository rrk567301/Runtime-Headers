...
@property (readonly, nonatomic) BOOL fetchIsNotUserInitiated;
...
- (id)initWithOriginalURL:(id)a0 postRedirectURL:(id)a1 MIMEType:(id)a2 webView:(id)a3 hasLoadedResource:(BOOL)a4 shouldFetchSubresources:(BOOL)a5 allowedSpecializations:(unsigned long long)a6 fetchIsNotUserInitiated:(BOOL)a7;
