...
+ (BOOL)isWebexSiteURL:(id)a0;
+ (BOOL)isAppleNewsURL:(id)a0;
+ (BOOL)isWikipediaURL:(id)a0;
...
+ (BOOL)isAppleBookSeriesURL:(id)a0;
+ (BOOL)isAppleFitnessURL:(id)a0;
+ (BOOL)isAppleGamesActivityURL:(id)a0;
+ (BOOL)isAppleHealthURL:(id)a0;
+ (BOOL)isAppleMapsCollectionURL:(id)a0;
+ (BOOL)isAppleMusicClassicalURL:(id)a0;
+ (BOOL)isApplePhotosSharedLibraryInvitationURL:(id)a0;
+ (BOOL)isAppleSportsURL:(id)a0;
+ (BOOL)isAppleTVURL:(id)a0;
+ (BOOL)isArticle:(id)a0;
+ (BOOL)isArticleWithActivityPub:(id)a0;
+ (BOOL)isBlueskyURL:(id)a0;
+ (BOOL)isFacebookURL:(id)a0;
+ (BOOL)isGoogleMapsURL:(id)a0;
...
+ (BOOL)isRedditURL:(id)a0;
+ (BOOL)isSharedPasswordsInviteURL:(id)a0;
...
+ (BOOL)shouldAllowHoistingContentImagesForURL:(id)a0;
+ (BOOL)shouldAllowMultipleImagesForURL:(id)a0;
+ (BOOL)shouldLoadInsteadOfUsingExistingWebViewForURL:(id)a0;
+ (id)simplifiedTitleFromTitle:(id)a0 forMetadata:(id)a1;
+ (id)titleSimplifiedByDeduplicatingHostname:(id)a0 forMetadata:(id)a1;
+ (id)titleSimplifiedByDeduplicatingMicroblogUsernameComponents:(id)a0 forMetadata:(id)a1;
