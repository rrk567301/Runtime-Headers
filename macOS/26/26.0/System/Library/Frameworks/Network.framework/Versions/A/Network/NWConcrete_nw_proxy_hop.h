...
@interface NWConcrete_nw_proxy_hop : NSObject <OS_nw_proxy_hop> {
    ...
    unsigned char use_pqtls : 1;
    unsigned char allow_redirects : 1;
    unsigned char disable_idle_timeout : 1;
    unsigned char disable_keepalives : 1;
    unsigned char ignore_path_errors : 1;
}
