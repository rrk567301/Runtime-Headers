...
@interface StickerKit.UnifiedRecentImageGlyphDataSource : _TtCs12_SwiftObject <StickerKit.ImageGlyphDataSourceProtocol> {
    void /* unknown type, empty encoding */ _isReady;
    void /* unknown type, empty encoding */ stickerStore;
    void /* unknown type, empty encoding */ unifiedRecencyModel;
    void /* unknown type, empty encoding */ _unifiedRecentImageGlyphs;
    void /* unknown type, empty encoding */ _recentEmojis;
    void /* unknown type, empty encoding */ __recentStickers;
    void /* unknown type, empty encoding */ _stickerIdentifiersCreatedInGuestMode;
    void /* unknown type, empty encoding */ recencyChangeObservers;
    void /* unknown type, empty encoding */ _uiConfig;
}
