...
@property (nonatomic) struct _KDBoundingBox { struct vector<_KDInterval, std::allocator<_KDInterval>> { struct _KDInterval *__begin_; struct _KDInterval *__end_; struct _KDInterval *__cap_; } _intervals; unsigned long long _numDimensions; } boundingBox;
