...
@interface MLLocalOutlierFactor : MLModel {
    ...
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; float *__cap_; } _cachedKDistances;
...
- (struct vector<std::pair<unsigned long, float>, std::allocator<std::pair<unsigned long, float>>> { void *x0; void *x1; void *x2; })findNearestNeighborsToIndex:(unsigned long long)a0;
- (struct vector<std::pair<unsigned long, float>, std::allocator<std::pair<unsigned long, float>>> { void *x0; void *x1; void *x2; })findNearestNeighborsToQueryPoint:(const void *)a0;
