...
@interface MLNearestNeighborsSingleKdTreeIndex : NSObject <MLNearestNeighborsIndex, NSSecureCoding> {
    ...
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } vIndices;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct vector<std::pair<unsigned long, float>, std::allocator<std::pair<unsigned long, float>>> { void *x0; void *x1; void *x2; })calculateDistancesForNodesBetweenLeft:(unsigned long long)a0 andRight:(unsigned long long)a1 toQueryPoint:(const void *)a2;
- (id)constructTree;
