...
- (void)fetchPlaceInferencesWithFidelityPolicy:(unsigned long long)a0 handler:(id /* block */)a1;
...
- (void)startMonitoringVisitsWithObserver:(id)a0;
...
- (void)stopMonitoringVisitsWithObserver:(id)a0;
