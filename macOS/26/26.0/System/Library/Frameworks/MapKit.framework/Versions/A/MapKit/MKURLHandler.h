...
- (id)_createMKURLHandlerError:(id)a0;
...
- (BOOL)_handleShortURL:(id)a0 sourceApplication:(id)a1 context:(id)a2;
...
- (BOOL)_treatExploreGuidesFrom:(id)a0;
...
- (BOOL)_treatReportAProblemFrom:(id)a0;
- (BOOL)_treatReportAnIncidentFrom:(id)a0;
- (BOOL)_treatSearchFrom:(id)a0;
- (BOOL)_treatSearchRegionFrom:(id)a0;
- (BOOL)_treatShowMyLocationCardFrom:(id)a0;
- (BOOL)_treatShowParkedCarFrom:(id)a0;
