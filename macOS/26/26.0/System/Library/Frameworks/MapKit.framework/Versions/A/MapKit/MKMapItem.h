@class GEOAddress, geo_isolater, NSColor, NSDictionary, GEOLabelGeometry, GEOPDFlyover, GEOMapItemStorage, _MKMapItemReviewsAttribution, _MKPlaceReservationInfo, MKMapItemIdentifier, GEOFeatureStyleAttributes, GEOEnrichmentData, MKMapItemMetadata, GEOMapRegion, GEOBusinessHours, GEOMuninViewState, NSData, GEOPlace, GEOEnrichmentInfo, NSNumberFormatter, GEOEnhancedPlacement, NSURL, GEOFactoid, NSNumber, GEOViewportFrame, GEOPOIClaim, GEOMiniBrowseCategories, GEOPDHikeAssociatedInfo, GEOExploreGuides, GEOMapItemStorageUserValues, NSArray, MKPlacemark, GEOEVChargerAvailability, GEOHikeSummary, CLLocation, MKAddressRepresentations, NSString, NSTimeZone, _MKMapItemAttribution, GEOTrailHead, GEOPDHikeGeometry, GEOMapItemDetourInfo, _MKMapItemPhotosAttribution, _MKMapItemPlaceAttribution, NSSet, GEOBusinessAssets, MKAddress, GEOModuleLayoutEntry, NSDate;
...
@property (readonly, nonatomic, getter=_hasHikeInfo) BOOL hasHikeInfo;
...
+ (BOOL)_isDirectionsActionURL:(id)a0;
...
+ (BOOL)_shouldUseUniversalLinkForMapItems:(id)a0 options:(id)a1;
...
- (id)_cnPostalAddress;
- (id)_createFullSharingURLWithLookAroundViewState:(id)a0 includeSensitiveFields:(BOOL)a1;
- (id)_factoidWithSemantic:(int)a0;
- (id)_formatterForAdamId;
- (id)_fullAddressWithMultiline:(BOOL)a0;
- (id)_fullSharingURLIncludingSensitiveFields:(BOOL)a0;
- (id)_fullSharingURLWithLookAroundViewState:(id)a0;
- (id)_getBusiness;
...
- (id)hoursBuilderForSearchResultCellForOptions:(unsigned long long)a0 conciseStyle:(BOOL)a1;
- (id)hoursBuilderForSearchResultCellForOptions:(unsigned long long)a0 conciseStyle:(BOOL)a1 openAt:(id)a2;
- (id)initWithCLLocation:(id)a0 address:(id)a1;
...
- (id)initWithLocation:(id)a0 address:(id)a1;
...
- (id)searchResultsHoursWithConciseStyle:(BOOL)a0 openAt:(id)a1;
