@class GEOMapServiceTraits, CLLocation, MKPointOfInterestFilter, GEOSortPriorityMapping, MKAddressFilter, NSMutableArray, GEORetainedSearchMetadata, NSString, GEOClientRankingModel, GEOPDPlaceSummaryLayoutMetadata, MKLocalSearchCompletion, GEOAutocompleteSessionData, NSArray, GEOMIFAutocompleteRequest, GEOSearchCategory, NSTimer;
...
@property (readonly, nonatomic, getter=_geoMIFAutocompleteRequest) GEOMIFAutocompleteRequest *geoMIFAutocompleteRequest;
