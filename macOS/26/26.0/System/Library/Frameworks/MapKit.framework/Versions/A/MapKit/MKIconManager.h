...
+ (id)poiBalloonIconForConfiguration:(id)a0;
...
+ (id)_markerStyleAttributesForCustomStyleAttributes:(id)a0 selected:(BOOL)a1;
+ (void)_updatePickingStateStyleAttribute:(id)a0 selected:(BOOL)a1;
...
+ (id)markerBalloonIconForConfiguration:(id)a0;
