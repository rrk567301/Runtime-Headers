...
@property (readonly) BOOL excludeCloudMetadata;
...
- (void).cxx_destruct;
- (void)commonInitWithResultsLimit:(long long)a0 filterOptions:(unsigned long long)a1 ascending:(BOOL)a2 shouldUpdate:(BOOL)a3 providerIdentifier:(id)a4 excludeCloudMetadata:(BOOL)a5;
...
- (id)initWithResultsLimit:(long long)a0 filterOptions:(unsigned long long)a1 ascending:(BOOL)a2 shouldUpdate:(BOOL)a3 excludeCloudMetadata:(BOOL)a4;
...
- (id)initWithResultsLimit:(long long)a0 filterOptions:(unsigned long long)a1 ascending:(BOOL)a2 shouldUpdate:(BOOL)a3 providerIdentifier:(id)a4 excludeCloudMetadata:(BOOL)a5;
