@class ABAccount, NSArray, ABGroupEntry, NSMutableArray, ABAddressBook;
...
@property (retain) ABAccount *acceptedIntroductionsAccount;
...
- (void)addEntryForAcceptedIntroductions;
