...
@interface VNFaceLandmarkDetectorDNN : VNFaceLandmarkDetector {
    ...
    struct vector<_Geometry2D_point2D_, std::allocator<_Geometry2D_point2D_>> { struct _Geometry2D_point2D_ *__begin_; struct _Geometry2D_point2D_ *__end_; struct _Geometry2D_point2D_ *__cap_; } _landmarkPoints65;
}
