...
@interface VNHomographyTrackerState : NSObject <ICFlowControl, ICResultDelegate> {
    ...
    struct vector<std::tuple<simd_float3x3, float>, std::allocator<std::tuple<simd_float3x3, float>>> { void *__begin_; void *__end_; void *__cap_; } _transformsAndConfidences;
}
