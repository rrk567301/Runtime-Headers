@interface FaceCoreDetector : NSObject {
    struct unique_ptr<apple::vision::libraries::facecore::FaceCoreAPI, std::default_delete<apple::vision::libraries::facecore::FaceCoreAPI>> { struct FaceCoreAPI *__ptr_; } _api;
}
...
+ (struct Face { int x0; struct coord { int x0; int x1; } x1; struct coord { int x0; int x1; } x2; struct coord { int x0; int x1; } x3; struct coord { int x0; int x1; } x4; float x5; int x6; int x7; struct vector<double, std::allocator<double>> { double *x0; double *x1; double *x2; } x8; int x9; struct vector<apple::vision::libraries::facecore::coord, std::allocator<apple::vision::libraries::facecore::coord>> { struct coord *x0; struct coord *x1; struct coord *x2; } x10; int x11; BOOL x12; BOOL x13; float x14; float x15; BOOL x16; float x17; BOOL x18; float x19; struct naturalSmileData *x20; })_createFaceFromFCRFace:(id)a0 image:(id)a1;
