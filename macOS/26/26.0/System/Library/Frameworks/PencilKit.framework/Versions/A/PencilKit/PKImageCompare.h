...
+ (struct { int x0[4]; int x1[4]; double x2[4]; double x3[4]; struct CGImage *x4; BOOL x5; })compareImage:(struct CGImage { } *)a0 toMasterImage:(struct CGImage { } *)a1 filename:(id)a2 differenceImageOutputPath:(id)a3 diffWhite:(BOOL)a4 stdDevThreshold:(double)a5;
