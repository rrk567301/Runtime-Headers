...
@property (readonly, nonatomic) BOOL wantsExtendedDynamicRangeContent;
...
- (id)initWithLevel:(long long)a0 offset:(struct CGPoint { double x0; double x1; })a1 drawingTransform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a2 contentsScale:(double)a3 sixChannelMode:(BOOL)a4 transparentBlending:(BOOL)a5 wantsExtendedDynamicRangeContent:(BOOL)a6;
