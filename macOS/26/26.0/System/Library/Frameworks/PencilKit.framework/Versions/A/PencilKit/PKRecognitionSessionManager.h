@class PKRecognitionQueryController, NSDate, NSObject, PKRecognitionSessionObserverWrapper, PKDrawing, NSString, NSSet, NSHashTable, PKAutoRefineQuery, PKHandwritingTranscriptionCache, CHRecognitionSession, NSArray, NSTimer, NSUUID;
...
- (BOOL)didHitHandwritingStroke:(id)a0;
...
- (id)fetchTranscriptionForStrokes:(id)a0 callCompletionOnMainThread:(BOOL)a1 cancelBlock:(id /* block */)a2 withCompletion:(id /* block */)a3;
