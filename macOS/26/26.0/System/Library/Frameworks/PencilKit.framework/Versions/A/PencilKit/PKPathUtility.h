...
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct CGPoint *x2; })centripetalCatmullRomPointsFromConvexHull:(const void *)a0 alpha:(double)a1 granularity:(double)a2;
...
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct CGPoint *x2; })smoothedHullForPoints:(const void *)a0;
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct CGPoint *x2; })smoothedHullForPoints:(const void *)a0 alpha:(double)a1 granularity:(double)a2 minAngleFactor:(double)a3 maxLengthThreshold:(double)a4 edgeRemovalConstant:(double)a5;
+ (void)smoothedHullForPoints:(const void *)a0 completion:(id /* block */)a1;
+ (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct CGPoint *x2; })unorderedSimplifiedPointsFromPoints:(const void *)a0 factor:(double)a1;
