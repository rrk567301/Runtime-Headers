...
+ (id)_createStrokesFromCHDrawing:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 inputScale:(double)a2 sourceStrokes:(id)a3 strokeClass:(Class)a4 newInk:(id)a5 suggestedHeight:(double)a6 shouldSetSynthesizedFlag:(BOOL)a7;
+ (struct _PKStrokePoint { double x0; struct CGPoint { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; })_decompressStrokePoint:(struct PKCompressedStrokePoint { struct _PKPoint { float x0; float x1; } x0; float x1; float x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned short x8; float x9; unsigned short x10; })a0 withTimestamp:(double)a1;
...
+ (id)_strokesByCullingStrokes:(id)a0 toRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
+ (id)_testStrokeFromPoints:(struct PKCompressedStrokePoint { struct _PKPoint { float x0; float x1; } x0; float x1; float x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned short x8; float x9; unsigned short x10; } *)a0 length:(long long)a1 ink:(id)a2;
+ (struct { union { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; BOOL x8; long long x9; double x10; double x11; BOOL x12; double x13; long long x14; long long x15; })averagePointForSynthesisFromSourceStrokes:(id)a0;
...
- (id)_ascii;
- (id)_clipPlane;
- (struct unique_ptr<std::vector<PKCompressedStrokePoint>, std::default_delete<std::vector<PKCompressedStrokePoint>>> { void *x0; })_compressedStrokePoints;
- (BOOL)_containsSamePointsAsStroke:(id)a0;
- (id)_copyWithNewParticleOffset:(double)a0 secondaryParticleOffset:(double)a1;
...
- (double)_particleOffsetAt:(double)a0 forSecondaryParticles:(BOOL)a1;
...
- (void)_setIsPastedStroke:(BOOL)a0;
- (void)_setIsSafeForStyleInventory:(BOOL)a0;
- (void)_setIsSharedStroke:(BOOL)a0;
- (void)_setIsSynthesizedInk:(BOOL)a0;
...
- (double)_thresholdForPoint:(struct _PKStrokePoint { double x0; struct CGPoint { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; })a0;
...
- (BOOL)intersectsClipperPath:(void *)a0;
...
- (BOOL)intersectsRectMasked:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
