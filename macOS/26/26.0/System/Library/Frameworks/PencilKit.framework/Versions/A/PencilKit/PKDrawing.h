...
- (id)firstIntersectedStrokeAtPoint:(struct CGPoint { double x0; double x1; })a0 inputType:(long long)a1 visibleOnscreenStrokes:(id)a2;
- (id)_addStroke:(id)a0;
- (id)_allStrokes;
- (id)_ascii;
...
- (id)_originalDataUUIDToTransformedStrokeDictFromStrokes:(id)a0 pathDict:(id)a1 maskDict:(id)a2 shouldUseStrokeDataUUID:(BOOL)a3;
...
- (void)copyCachedStrokesFrom:(id)a0;
...
- (id)replaceStrokes:(id)a0 withNewStrokes:(id)a1 actionName:(id)a2;
...
- (id)strokesForCHStrokeIdentifiers:(id)a0 didFindAllStrokes:(BOOL *)a1;
