...
@interface SCNPhysicsContact : NSObject {
    SCNNode *_nodeA;
    SCNNode *_nodeB;
    struct SCNVector3 { double x; double y; double z; } _contactPoint;
    struct SCNVector3 { double x; double y; double z; } _contactNormal;
...
@property (readonly, nonatomic) struct SCNVector3 { double x0; double x1; double x2; } contactPoint;
@property (readonly, nonatomic) struct SCNVector3 { double x0; double x1; double x2; } contactNormal;
...
- (void)_fillNodeA:(id)a0 nodeB:(id)a1 contactPoint:(struct SCNVector3 { double x0; double x1; double x2; })a2 collisionImpulse:(struct SCNVector3 { double x0; double x1; double x2; })a3 distance:(double)a4 hitFraction:(double)a5;
- (void)_prepareUpdate;
