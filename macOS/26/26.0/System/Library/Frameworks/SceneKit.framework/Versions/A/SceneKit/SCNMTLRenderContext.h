...
@protocol MTLCommandBuffer, MTLDevice, MTLComputePipelineState, OS_dispatch_queue, CAMetalDrawable, MTLDepthStencilState, MTLTexture, OS_dispatch_semaphore, SCNMTLRenderContextCommandBufferStatusMonitor, MTLBlitCommandEncoder, MTLBuffer, SCNMTLRenderContextResourceManagerMonitor, MTLComputeCommandEncoder, MTLRenderCommandEncoder, MTLSamplerState, MTLCommandQueue;
...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
    ...
    struct CATransform3D { double m11; double m12; double m13; double m14; double m21; double m22; double m23; double m24; double m31; double m32; double m33; double m34; double m41; double m42; double m43; double m44; } _screenTransform;
