...
- (BOOL)_acceptsMedicationDoseEventWithLogOrigin:(long long)a0;
- (BOOL)_acceptsMedicationDoseEventWithMedicationConceptIdentifier:(id)a0;
- (BOOL)_acceptsMedicationDoseEventWithMedicationIdentifier:(id)a0;
- (BOOL)_acceptsMedicationDoseEventWithMedicationUUID:(id)a0;
- (BOOL)_acceptsMedicationDoseEventWithScheduleItemIdentifier:(id)a0;
- (BOOL)_acceptsMedicationDoseEventWithScheduledDate:(id)a0;
