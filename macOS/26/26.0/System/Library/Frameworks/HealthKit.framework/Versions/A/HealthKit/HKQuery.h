...
+ (id)predicateForMedicationDoseEventWithMedicationConceptIdentifier:(id)a0;
...
+ (id)predicateForMedicationDoseEventWithMedicationConceptIdentifiers:(id)a0;
...
+ (id)predicateForUserAnnotatedMedicationsWithHasSchedule:(BOOL)a0;
+ (id)predicateForUserAnnotatedMedicationsWithIsArchived:(BOOL)a0;
...
+ (id)predicateForWorkoutRoutesUsingMetadataForWorkout:(id)a0;
