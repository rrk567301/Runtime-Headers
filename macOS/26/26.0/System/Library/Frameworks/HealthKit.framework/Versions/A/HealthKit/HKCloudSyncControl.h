...
- (void)cloudSyncEntityVersions:(id /* block */)a0;
- (void)cloudSyncProtocolVersion:(id /* block */)a0;
...
- (void)fetchCloudDescriptionWithProgress:(id /* block */)a0 useDescriptionForLogs:(BOOL)a1 prettyPrinted:(BOOL)a2 updateCacheAndPrepareForSync:(BOOL)a3 completion:(id /* block */)a4;
...
- (void)recordsToCreate:(id)a0 recordsToDelete:(id)a1 completion:(id /* block */)a2;
