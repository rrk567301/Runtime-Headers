...
- (void)_lock_encodeQuantity:(id)a0 withCoder:(id)a1 key:(id)a2 unit:(id)a3;
- (BOOL)_lock_isEqual:(id)a0;
...
- (double)_lock_percentageCompleteWithQuantity:(id)a0 goalQuantity:(id)a1 unit:(id)a2;
- (void).cxx_destruct;
