...
@interface HKFeatureAvailabilityRequirementOSEligibilityDomainIsEligible : HKFeatureAvailabilityBaseRequirement <HKObservableFeatureAvailabilityRequirement> {
