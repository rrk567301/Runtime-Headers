@class __end_, NSString, _MTLIOCommandQueue, NSError, MTLResourceList, __cap_;
...
@interface _MTLIOCommandBuffer : _MTLObjectWithLabel <MTLIOCommandBufferSPI> {
    ...
    struct vector<id<MTLIOScratchBuffer>, std::allocator<id<MTLIOScratchBuffer>>> { __end_ **__begin_; __cap_ **x0; id *x1; } _activeScratchBuffers;
    struct vector<id<MTLIOScratchBuffer>, std::allocator<id<MTLIOScratchBuffer>>> { __end_ **__begin_; __cap_ **x0; id *x1; } _poolScratchBuffers;
}
