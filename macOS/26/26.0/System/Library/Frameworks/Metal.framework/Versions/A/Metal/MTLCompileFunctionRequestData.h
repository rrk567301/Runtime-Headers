...
@property (nonatomic) BOOL meshShaderEmulatorEnabled;
@property (nonatomic) BOOL emulatorGeneratesVertexShader;
@property (nonatomic) BOOL emulatorLowersFragmentShader;
@property (nonatomic) unsigned int emulatorMaxVertexAmplificationCount;
...
@property BOOL useAIRNTInterfaces;
