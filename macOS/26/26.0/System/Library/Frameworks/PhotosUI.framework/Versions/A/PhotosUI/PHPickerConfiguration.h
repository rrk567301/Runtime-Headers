@class NSString, NSArray, PHPhotoLibrary, _PHPickerSuggestionGroup, _PHPickerAspectRatio, _PHPickerCollectionConfiguration, PHPickerFilter, _PHPickerShareAlbumSheetConfiguration;
