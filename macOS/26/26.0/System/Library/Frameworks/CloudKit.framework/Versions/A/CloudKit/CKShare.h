...
@property BOOL serializeOwnerInfo;
...
- (id)_copyWithoutPersonalInfoAndSerializeOwnerInfo:(BOOL)a0;
...
- (void)_setAccessRequestsEnabledNoSideEffects:(BOOL)a0;
...
- (void)approve:(id)a0 inContainer:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)approveRequesters:(id)a0 inContainer:(id)a1 withPermission:(long long)a2 asRole:(long long)a3 operationGroup:(id)a4 completionHandler:(id /* block */)a5;
- (void)blockRequesters:(id)a0;
- (BOOL)blockRequesters:(id)a0 error:(id *)a1;
- (void)blockUserIdentities:(id)a0;
- (void)blockUserIdentityLookupInfos:(id)a0;
