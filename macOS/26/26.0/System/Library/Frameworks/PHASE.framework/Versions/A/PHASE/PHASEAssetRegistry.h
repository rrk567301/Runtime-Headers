...
- (BOOL)addAssetInternal:(id)a0 stringPool:(struct unique_ptr<Phase::StringPool, std::default_delete<Phase::StringPool>> { struct StringPool *x0; })a1 outError:(id *)a2;
...
- (struct unique_ptr<Phase::Controller::SoundAssetInfo, std::default_delete<Phase::Controller::SoundAssetInfo>> { struct SoundAssetInfo *x0; })makeSoundAssetInfoWithURL:(id)a0 assetString:(const char *)a1 assetType:(long long)a2 channelLayout:(id)a3 normalizationMode:(long long)a4 targetLKFS:(double)a5 ownerTask:(unsigned int)a6 outError:(id *)a7;
- (struct unique_ptr<Phase::StringPool, std::default_delete<Phase::StringPool>> { struct StringPool *x0; })makeStringPoolForSingleAsset:(id)a0 outError:(id *)a1;
