@interface SwiftUI.ScrollViewHelper : NSObject <_NSUpdateCycleIdleObserver, NSScrollViewDelegate> {
    ...
    void /* unknown type, empty encoding */ lastScrollOffset;
    ...
    void /* unknown type, empty encoding */ pendingTargetOffsetRequest;
    ...
    void /* unknown type, empty encoding */ accessoryPlacementInsets;
}
