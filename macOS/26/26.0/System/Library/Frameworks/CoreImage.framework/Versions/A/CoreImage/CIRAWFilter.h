...
@property (readonly, getter=isHighlightRecoverySupported) BOOL highlightRecoverySupported;
@property (getter=isHighlightRecoveryEnabled) BOOL highlightRecoveryEnabled;
