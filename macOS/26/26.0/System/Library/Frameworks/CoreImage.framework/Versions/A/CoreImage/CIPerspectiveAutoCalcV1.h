...
@interface CIPerspectiveAutoCalcV1 : CIPerspectiveAutoCalc {
    ...
    struct vector<CI::Perspective::Line, std::allocator<CI::Perspective::Line>> { struct *__begin_; struct *__end_; struct *__cap_; } vLineCluster;
    struct vector<CI::Perspective::Line, std::allocator<CI::Perspective::Line>> { struct *__begin_; struct *__end_; struct *__cap_; } hLineCluster;
    BOOL vGuidesValid;
    BOOL hGuidesValid;
    float vGuidesAOE;
    float hGuidesAOE;
