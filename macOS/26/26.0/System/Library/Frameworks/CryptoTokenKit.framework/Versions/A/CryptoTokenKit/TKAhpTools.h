...
+ (id)buildContextBlob:(id)a0 tokenId:(id)a1 pubKeyHash:(id)a2 wrapHash:(id)a3 accessTokenContext:(id)a4;
+ (void)getContextBlobValues:(id)a0 userName:(id *)a1 tokenId:(id *)a2 pubKeyHash:(id *)a3 wrapHash:(id *)a4;
+ (void)getContextBlobValues:(id)a0 userName:(id *)a1 tokenId:(id *)a2 pubKeyHash:(id *)a3 wrapHash:(id *)a4 accessTokenContext:(id *)a5;
