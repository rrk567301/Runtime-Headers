...
- (struct expected<void, NSError *> { struct __conditional_no_unique_address<true, std::__expected_void_base<NSError *>::__repr> { struct __repr { struct __conditional_no_unique_address<false, std::__expected_void_base<NSError *>::__union_t> { union __union_t { struct __empty_t { } x0; id x1; } x0; } x0; BOOL x1; } x0; } x0; })_captureUSBPassthroughDevices;
