...
@interface WK_RTCVideoEncoderH265 : NSObject <RTCVideoEncoder> {
    ...
    struct unique_ptr<webrtc::BitrateAdjuster, std::default_delete<webrtc::BitrateAdjuster>> { struct BitrateAdjuster *__ptr_; } _bitrateAdjuster;
    ...
    int framesLeft;
    struct vector<unsigned char, std::allocator<unsigned char>> { char *__begin_; char *__end_; char *__cap_; } _nv12ScaleBuffer;
    BOOL _useAnnexB;
    BOOL _isLowLatencyEnabled;
    BOOL _needsToSendDescription;
    id /* block */ _descriptionCallback;
    id /* block */ _errorCallback;
    struct H265BitstreamParser { void /* function */ **_vptr$BitstreamParser; struct flat_map<unsigned int, webrtc::H265VpsParser::VpsState, std::less<void>, std::vector<std::pair<unsigned int, webrtc::H265VpsParser::VpsState>>> { struct vector<std::pair<unsigned int, webrtc::H265VpsParser::VpsState>, std::allocator<std::pair<unsigned int, webrtc::H265VpsParser::VpsState>>> { void *__begin_; void *__end_; void *__cap_; } body_; } vps_; struct flat_map<unsigned int, webrtc::H265SpsParser::SpsState, std::less<void>, std::vector<std::pair<unsigned int, webrtc::H265SpsParser::SpsState>>> { struct vector<std::pair<unsigned int, webrtc::H265SpsParser::SpsState>, std::allocator<std::pair<unsigned int, webrtc::H265SpsParser::SpsState>>> { void *__begin_; void *__end_; void *__cap_; } body_; } sps_; struct flat_map<unsigned int, webrtc::H265PpsParser::PpsState, std::less<void>, std::vector<std::pair<unsigned int, webrtc::H265PpsParser::PpsState>>> { struct vector<std::pair<unsigned int, webrtc::H265PpsParser::PpsState>, std::allocator<std::pair<unsigned int, webrtc::H265PpsParser::PpsState>>> { void *__begin_; void *__end_; void *__cap_; } body_; } pps_; struct optional<int> { union { char __null_state_; int __val_; } ; BOOL __engaged_; } last_slice_qp_delta_; struct optional<unsigned int> { union { char __null_state_; unsigned int __val_; } ; BOOL __engaged_; } last_slice_pps_id_; } _h265BitstreamParser;
}
