...
@interface WebCoreNSURLSessionDataTask : NSObject {
    ...
    struct RetainPtr<NSURLResponse> { NSURLResponse *m_ptr; } _response;
    struct RetainPtr<NSURLRequest> { NSURLRequest *m_ptr; } _originalRequest;
    struct RetainPtr<NSURLRequest> { NSURLRequest *m_ptr; } _currentRequest;
    ...
    struct RetainPtr<NSString> { NSString *m_ptr; } _taskDescription;
