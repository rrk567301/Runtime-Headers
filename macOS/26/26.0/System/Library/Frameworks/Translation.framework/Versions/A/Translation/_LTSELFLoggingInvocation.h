...
- (void)cancelWithReason:(id)a0 localePair:(id)a1 qssSessionId:(id)a2;
- (void)endSuccessfullyWithQSSSessionId:(id)a0 localePair:(id)a1;
- (void)endWithError:(id)a0 localePair:(id)a1 qssSessionId:(id)a2;
...
- (void)startedWithClientIdentifier:(id)a0;
