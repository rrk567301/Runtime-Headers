...
+ (void)readAttributeMaxProvisionedWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeProvisionedEndpointsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)findEndpointWithParams:(id)a0 completion:(id /* block */)a1;
- (void)provisionEndpointWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeMaxProvisionedWithCompletion:(id /* block */)a0;
- (void)readAttributeProvisionedEndpointsWithParams:(id)a0 completion:(id /* block */)a1;
- (void)removeEndpointWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeMaxProvisionedWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeProvisionedEndpointsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
