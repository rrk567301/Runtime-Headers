@class MTRPushAVStreamTransportClusterTransportConfigurationStruct;

@interface MTRPushAVStreamTransportClusterAllocatePushTransportResponseParams : NSObject <NSCopying>

@property (copy, nonatomic) MTRPushAVStreamTransportClusterTransportConfigurationStruct *transportConfiguration;
