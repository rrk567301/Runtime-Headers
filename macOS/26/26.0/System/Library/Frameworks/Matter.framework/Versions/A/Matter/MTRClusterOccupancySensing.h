...
- (id)readAttributeHoldTimeLimitsWithParams:(id)a0;
- (id)readAttributeHoldTimeWithParams:(id)a0;
...
- (void)writeAttributeHoldTimeWithValue:(id)a0 expectedValueInterval:(id)a1;
- (void)writeAttributeHoldTimeWithValue:(id)a0 expectedValueInterval:(id)a1 params:(id)a2;
