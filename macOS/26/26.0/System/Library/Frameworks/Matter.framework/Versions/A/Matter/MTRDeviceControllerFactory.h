...
@interface MTRDeviceControllerFactory : NSObject {
    ...
    struct TestPersistentStorageDelegate { void /* function */ **_vptr$PersistentStorageDelegate; struct map<std::string, std::vector<unsigned char>, std::less<std::string>, std::allocator<std::pair<const std::string, std::vector<unsigned char>>>> { struct __tree<std::__value_type<std::string, std::vector<unsigned char>>, std::__map_value_compare<std::string, std::__value_type<std::string, std::vector<unsigned char>>, std::less<std::string>>, std::allocator<std::__value_type<std::string, std::vector<unsigned char>>>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } mStorage; struct set<std::string, std::less<std::string>, std::allocator<std::string>> { struct __tree<std::string, std::less<std::string>, std::allocator<std::string>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } mPoisonKeys; BOOL mRejectWrites; unsigned int mLoggingLevel; } _groupStorageDelegate;
    ...
    void *_opCertStore;
    struct unique_ptr<MTROperationalBrowser, std::default_delete<MTROperationalBrowser>> { struct MTROperationalBrowser *__ptr_; } _operationalBrowser;
    ...
    struct unique_ptr<MTROTAProviderDelegateBridge, std::default_delete<MTROTAProviderDelegateBridge>> { struct MTROTAProviderDelegateBridge *__ptr_; } _otaProviderDelegateBridge;
