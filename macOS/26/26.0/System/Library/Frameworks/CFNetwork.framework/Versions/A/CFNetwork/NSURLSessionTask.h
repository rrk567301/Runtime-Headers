@class NSURL, NSURLResponse, NSURLSessionConfiguration, NSProgress, NSURLSessionTaskHTTPAuthenticator, NSURLSession, NSDictionary, NSObject, __NSCFResumableUploadState, NSDate, __CFN_TaskMetrics, NSString, NSURLRequest, __CFN_TransactionMetrics, __NSCFURLSessionDelegateWrapper, NSArray, NSData, NSError, NSUUID;
...
@property BOOL _privacyProxyStrictFailClosed;
...
@property (nonatomic) BOOL _disableBackgroundRetry;
...
- (void)setDependencyTree:(id)a0;
- (void)setTaskDependency:(id)a0;
- (id)taskDependency;
