...
@interface NSString : NSObject <_OSXPCObjectRepresentable, _PASDistilledString, BMDSLNativeJSONArchiving, CCDatabaseValue, NSItemProviderReading, NSItemProviderWriting, NSCopying, NSMutableCopying, NSSecureCoding>
...
+ (id)ak_base64EncodedJsonFromObject:(id)a0;
+ (id)decodeFromDER:(id)a0 error:(id *)a1;
+ (id)_pas_stringWithConsumedAllocaDescrNoCopy:(struct { void *x0; BOOL x1; })a0 bufferSize:(unsigned long long)a1 encoding:(unsigned long long)a2 nullTerminated:(BOOL)a3 isExternalRepresentation:(BOOL)a4;
+ (id)_pas_distilledStringClasses;
+ (id)_pas_proxyStringByConcatenatingStrings:(id)a0;
+ (id)_pas_stringWithDataNoCopy:(id)a0 encoding:(unsigned long long)a1 nullTerminated:(BOOL)a2;
+ (id)_pas_stringWithDataNoCopy:(id)a0 encoding:(unsigned long long)a1 nullTerminated:(BOOL)a2 isExternalRepresentation:(BOOL)a3;
+ (void)_lp_reverseEnumerateComponents:(id)a0 usingBlock:(id /* block */)a1;
+ (id)URLQueryValueAllowedCharacterSet;
+ (id)hexStringFromData:(id)a0;
+ (id)stringFromData:(id)a0;
+ (BOOL)isDataConvertibleToVisibleString:(id)a0;
+ (id)macAddressStringFromData:(id)a0;
+ (id)macAddressStringFromSysconfigDataSixByte:(id)a0;
+ (id)visibleStringFromData:(id)a0;
...
+ (id)_stringWithValidatedFormat:(id)a0 validFormatSpecifiers:(id)a1 locale:(id)a2 arguments:(char *)a3 error:(id *)a4;
...
- (id)ak_stringByZeroPaddingOccurencesOfString:(id)a0;
- (id)ak_truncatedCopy;
- (id)personaUniqueString;
- (long long)compareVersionString:(id)a0;
- (id)_OS_xpcObjectRepresentation;
- (id)_pas_distilledString;
- (const char *)_pas_fastUTF8StringPtrWithOptions:(unsigned long long)a0 encodedLength:(unsigned long long *)a1;
- (id)_pas_proxyArrayOfSubstringsWithRanges:(id)a0;
- (BOOL)_pas_retainsConmingledBackingStore;
- (id)_pas_revivedString;
- (void)_pas_setRetainsConmingledBackingStore:(BOOL)a0;
- (id)_pas_stringBackedByUTF8CString;
- (BOOL)isPasswordEquivalentToken;
- (id)_lp_userVisibleHost;
- (BOOL)_lp_hasCaseInsensitivePrefix:(id)a0;
- (BOOL)_lp_hasCaseInsensitiveSubstring:(id)a0 startingAt:(unsigned long long)a1;
- (id)_lp_highLevelDomainFromComponents:(id)a0 indexOfFirstHighLevelDomainComponent:(unsigned long long *)a1 indexOfFirstTopLevelDomainComponent:(unsigned long long *)a2;
- (id)_lp_highLevelDomainFromHost;
- (id)_lp_hostByStrippingTopLevelDomain;
- (unsigned long long)_lp_lengthOfDeepSubdomainsFromComponents:(id)a0;
- (float)_lp_similarityToString:(id)a0;
- (id)_lp_simplifiedUserVisibleURLStringWithSimplifications:(unsigned long long)a0 forDisplayOnly:(BOOL)a1;
...
- (id)stringByReplacingPathBeforeComponent:(id)a0 with:(id)a1;
- (id)stringByTrimming;
- (id)aaf_base64Padded;
...
- (id)aaf_toSHA256Data;
- (id)aaf_urlEncoded;
- (id)stringByRightTrimmingCharacter:(char)a0;
- (id)ccccValue;
- (id)stringByLeftTrimmingCharacter:(char)a0;
- (id)stringByRemovingCharactersInString:(id)a0;
- (id)stringByTrimmingCharactersInString:(id)a0;
