...
- (id)_NSItemProviderTypeCoercion_coercedNSDataValueFromNSImageValue:(id)a0 error:(id *)a1;
- (id)_NSItemProviderTypeCoercion_coercedNSFileWrapperValueFromNSDataValue:(id)a0 error:(id *)a1;
- (id)_NSItemProviderTypeCoercion_coercedNSImageValueFromNSDataValue:(id)a0 error:(id *)a1;
