...
- (void)fetchLatestRemoteVersionOfItemAtURL:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)pauseSyncForUbiquitousItemAtURL:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)resumeSyncForUbiquitousItemAtURL:(id)a0 withBehavior:(long long)a1 completionHandler:(id /* block */)a2;
...
- (void)uploadLocalVersionOfUbiquitousItemAtURL:(id)a0 withConflictResolutionPolicy:(long long)a1 completionHandler:(id /* block */)a2;
