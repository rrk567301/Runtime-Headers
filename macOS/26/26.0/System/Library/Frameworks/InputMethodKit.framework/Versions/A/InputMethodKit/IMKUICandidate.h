...
- (double)_luminanceOfColor:(id)a0;
...
- (void)drawLineSeparatorInFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
