...
+ (void)didReceiveAssetsChangedNotification:(id)a0;
+ (id)dominantScriptForString:(id)a0;
+ (void)registerForAssetNotifications;
+ (void)requestAssetsForLanguage:(id)a0 assetIdentifier:(id)a1 tagScheme:(id)a2 completionHandler:(id /* block */)a3;
