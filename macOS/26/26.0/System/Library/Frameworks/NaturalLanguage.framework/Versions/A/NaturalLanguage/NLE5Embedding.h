...
@interface NLE5Embedding : NSObject <NLE5Embedding, NLLogging> {
    ...
    struct unique_ptr<E5RT::ProgramLibrary, std::default_delete<E5RT::ProgramLibrary>> { struct ProgramLibrary *__ptr_; } _programLibrary;
    struct unique_ptr<E5RT::ExecutionStream, std::default_delete<E5RT::ExecutionStream>> { struct ExecutionStream *__ptr_; } _stream;
...
- (id)initWithProgramLibrary:(struct unique_ptr<E5RT::ProgramLibrary, std::default_delete<E5RT::ProgramLibrary>> { struct ProgramLibrary *x0; })a0 andSubwordVocab:(void *)a1;
