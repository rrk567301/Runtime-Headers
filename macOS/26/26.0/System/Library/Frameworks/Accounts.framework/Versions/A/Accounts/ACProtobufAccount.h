...
- (void)addEnabledEnumDataclasses:(id)a0;
- (void)addProperties:(id)a0;
- (void)addProvisionedDataclasses:(id)a0;
- (void)addProvisionedEnumDataclasses:(id)a0;
...
- (id)enabledEnumDataclassesAtIndex:(unsigned long long)a0;
...
- (id)provisionedEnumDataclassesAtIndex:(unsigned long long)a0;
