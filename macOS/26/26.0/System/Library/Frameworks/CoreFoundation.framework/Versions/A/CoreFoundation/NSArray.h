...
@interface NSArray : NSObject <BSCollection, _OSXPCObjectRepresentable, NSCopying, NSMutableCopying, NSSecureCoding, NSFastEnumeration>
...
+ (id)ak_arrayWithJSONResponseData:(id)a0;
+ (id)arrayWithValues:(id)a0 inBlock:(id /* block */)a1;
+ (id)_pas_proxyArrayWithObject:(id)a0 repetitions:(unsigned long long)a1;
+ (id)_pas_arrayNoCopyLeavesWithPropertyListData:(id)a0 error:(id *)a1;
+ (id)_pas_proxyArrayUsingObjectAtIndexBlock:(id /* block */)a0 andCountBlock:(id /* block */)a1;
+ (id)bm_shuffledArrayWithArray:(id)a0;
+ (id)aaf_empty;
+ (id)arrayFromShellCommandString:(id)a0;
+ (id)graphicInfoArrayFromArray:(id)a0;
+ (id)array;
...
- (BOOL)ls_caseInsensitiveContainsString:(id)a0;
...
- (id)ac_map:(id /* block */)a0;
- (id)ac_mapNullable:(id /* block */)a0;
- (id)ac_filter:(id /* block */)a0;
- (id)ac_firstObjectPassingTest:(id /* block */)a0;
...
- (id)_pas_unproxy;
- (id)_pas_componentsJoinedByString:(id)a0;
- (void)_pas_enumerateChunksOfSize:(unsigned long long)a0 usingBlock:(id /* block */)a1;
- (id)_pas_filteredArrayWithIndexedTest:(id /* block */)a0;
- (id)_pas_filteredArrayWithTest:(id /* block */)a0;
- (id)_pas_mappedArrayWithIndexedTransform:(id /* block */)a0;
- (id)_pas_mappedArrayWithTransform:(id /* block */)a0;
- (id)_pas_proxyArrayWithRepetitions:(unsigned long long)a0;
- (id)_pas_ensureImmutable;
- (id)_pas_leftFoldWithInitialObject:(id)a0 accumulate:(id /* block */)a1;
- (id)_pas_leftFoldWithInitialObject:(id)a0 indexedAccumulate:(id /* block */)a1;
- (id)_pas_proxyArrayByAppendingArray:(id)a0;
- (id)_pas_proxyArrayDistillingStrings;
- (id)_pas_proxyArrayReversed;
- (id)_pas_proxyArrayRevivingStrings;
- (id)_pas_proxyArrayWithMapping:(id /* block */)a0;
- (id)_pas_proxyArrayWithObjectsAtIndexes:(id)a0;
- (id)_pas_proxyComponentsJoinedByString:(id)a0;
- (id)_pas_proxySubarrayWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)_pas_rightFoldWithInitialObject:(id)a0 accumulate:(id /* block */)a1;
- (id)_pas_rightFoldWithInitialObject:(id)a0 indexedAccumulate:(id /* block */)a1;
- (id)_pas_shuffledArrayUsingRng:(id)a0;
- (id)_pas_unlazyArray;
- (id)sortedPids;
- (id)bpsPublisher;
- (id)publisher;
...
- (id)aaf_firstObjectPassingTest:(id /* block */)a0;
- (id)aaf_map:(id /* block */)a0;
- (id)aaf_arrayByRemovingObject:(id)a0;
- (BOOL)aaf_isSubsetOfArray:(id)a0;
- (id)aaf_mapStoppable:(id /* block */)a0;
- (id)_bmdsl_randomObjectForKey:(id)a0;
- (id)bmdsl_randomObject;
- (id)dslWithClass:(Class)a0;
- (id)dslWithValueClassName:(id)a0;
- (id)lastObject;
