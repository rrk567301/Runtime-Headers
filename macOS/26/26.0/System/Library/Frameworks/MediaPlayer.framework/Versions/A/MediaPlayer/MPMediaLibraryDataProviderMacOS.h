...
- (BOOL)collectionInLibraryWithPersistentID:(unsigned long long)a0 groupingType:(long long)a1;
...
- (BOOL)removePlaylistWithIdentifier:(long long)a0 preserveUndeletableEntities:(BOOL)a1;
