@class MPEnhanceDialogueCommand, MPChangePlaybackRateCommand, MPVocalsControlCommand, MPSetPlaybackQueueCommand, MPChangePlaybackPositionCommand, NSMutableArray, NSString, MPInsertIntoPlaybackQueueCommand, MPReorderQueueCommand, MPSetPriorityForPlaybackSessionCommand, MPRatingCommand, MPChangeRepeatModeCommand, MPSetSleepTimerCommand, MPSkipIntervalCommand, MPChangeShuffleModeCommand, MPRemoteCommand, MPFeedbackCommand, MPSetPlaybackSessionCommand, MPAdvanceShuffleModeCommand, MPPreloadPlaybackSessionCommand, MPChangeQueueEndActionCommand, MPToggleTransitionsCommand, MRPlayerPath, MPPrepareForSetPlaybackQueueCommand, MPAdvanceRepeatModeCommand;
...
@interface MPRemoteCommandCenter : NSObject {
    ...
    BOOL _anyCommandHandlersRegistered;
...
- (void)_dispatchMediaRemoteCommand:(unsigned int)a0 withOptions:(id)a1 completion:(id /* block */)a2;
