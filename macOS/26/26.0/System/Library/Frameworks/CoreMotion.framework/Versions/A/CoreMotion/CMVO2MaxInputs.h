...
+ (struct VO2MaxInput { unsigned long long x0; unsigned char x1[16]; float x2; double x3; float x4; float x5; double x6; int x7; double x8; BOOL x9; BOOL x10; int x11; int x12; double x13; double x14; BOOL x15; int x16; })VO2MaxInputFromCMVO2MaxInputs:(id)a0;
+ (struct VO2MaxInput { unsigned long long x0; unsigned char x1[16]; float x2; double x3; float x4; float x5; double x6; int x7; double x8; BOOL x9; BOOL x10; int x11; int x12; double x13; double x14; BOOL x15; int x16; })inputFromPreparedStatement:(struct sqlite3_stmt { } *)a0;
...
- (BOOL)isEqual:(id)a0;
- (id)initWithSample:(struct VO2MaxInput { unsigned long long x0; unsigned char x1[16]; float x2; double x3; float x4; float x5; double x6; int x7; double x8; BOOL x9; BOOL x10; int x11; int x12; double x13; double x14; BOOL x15; int x16; })a0;
