...
@interface CMMotionManagerInternal : NSObject {
    ...
    struct unique_ptr<CLIspDataVisitor, std::default_delete<CLIspDataVisitor>> { struct CLIspDataVisitor *__ptr_; } fSidebandVisitor;
    struct unique_ptr<CLDisplayGravityService, std::default_delete<CLDisplayGravityService>> { struct CLDisplayGravityService *__ptr_; } fDisplayGravityService;
    ...
    struct unique_ptr<CLDeviceMotionLiteService, std::default_delete<CLDeviceMotionLiteService>> { struct CLDeviceMotionLiteService *__ptr_; } fDeviceMotionLiteService;
    struct unique_ptr<CMMotionManagerStatsCollector, std::default_delete<CMMotionManagerStatsCollector>> { struct CMMotionManagerStatsCollector *__ptr_; } fMotionManagerStatsCollector;
