...
@interface CMMediaSession : NSObject <CMDistributedSensingDelegate> {
    struct unique_ptr<CMHeadTrackingService, std::default_delete<CMHeadTrackingService>> { struct CMHeadTrackingService *__ptr_; } _headTrackingService;
    ...
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct Dispatcher *__ptr_; } _accessoryDeviceMotionInEarStatusDispatcher;
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct Dispatcher *__ptr_; } _accessoryMonitorDispatcher;
    ...
    struct unique_ptr<CMMediaSessionAnalyticsTracker, std::default_delete<CMMediaSessionAnalyticsTracker>> { struct CMMediaSessionAnalyticsTracker *__ptr_; } _analyticsTracker;
    ...
    struct unique_ptr<CMSpatialLogger, std::default_delete<CMSpatialLogger>> { struct CMSpatialLogger *__ptr_; } _logger;
    int _inEarStatus;
