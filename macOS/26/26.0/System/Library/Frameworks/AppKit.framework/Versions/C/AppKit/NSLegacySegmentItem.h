@class NSMenu, NSString, NSImageSymbolConfiguration, NSSegmentItem, NSSegmentedCell, NSSegmentedControlAppearanceBasedVisualProvider, NSSegmentItemView, NSImage, NSImageView;
