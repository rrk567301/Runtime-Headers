...
@interface NSStepperCell : NSActionCell <_NSStepperTrackable> {
    ...
    double _maxValue;
    double _increment;
    struct { unsigned char valueWraps : 1; unsigned char autorepeat : 1; unsigned char drawing : 1; unsigned char isTrackingWithPressure : 1; unsigned char subclassOverridesDrawing : 1; unsigned char wantsBackground : 1; unsigned char controlViewIsStepper : 1; } _stFlags;
...
- (void)_setupForTrackingWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 hasPressure:(BOOL)a1;
