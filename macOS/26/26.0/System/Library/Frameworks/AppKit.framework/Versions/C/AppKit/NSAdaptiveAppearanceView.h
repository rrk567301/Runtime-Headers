...
@property (nonatomic) BOOL animatesAppearanceTransitions;
@property (nonatomic) BOOL windowServerAware;
@property (nonatomic, copy) NSString *groupName;
@property (nonatomic, readonly) double lightThreshold;
@property (nonatomic, readonly) double darkThreshold;
