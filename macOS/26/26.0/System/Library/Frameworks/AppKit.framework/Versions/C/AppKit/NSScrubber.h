@class NSTimer, NSString, NSView, _NSBoxCustomView, NSScrollView, NSColor, NSPanGestureRecognizer, NSScrubberSelectionStyle, NSPressGestureRecognizer, CADisplayLink, NSScrubberLayout, NSButton;
