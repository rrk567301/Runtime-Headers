...
- (void)_handleBubbleSelection:(id)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 view:(id)a2 lastDisplayedHistory:(id)a3 correctionTag:(long long)a4;
