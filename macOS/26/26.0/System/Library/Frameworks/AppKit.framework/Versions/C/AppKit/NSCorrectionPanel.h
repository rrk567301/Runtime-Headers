@class NSView, NSString, NSCorrectionTypedTextHighlightView, NSCorrectionShadowView, NSCorrectionTextView, NSPanel, NSDictionary, NSAttributedString, NSMutableArray, NSArray, NSObject, NSEvent;
