...
@interface MTLLegacySVAccelerationStructureCommandEncoder : MTLToolsAccelerationStructureCommandEncoder {
    ...
    struct list<LegacySVResourceAndUsage, std::allocator<LegacySVResourceAndUsage>> { struct __list_node_base<LegacySVResourceAndUsage, void *> { void *__prev_; void *__next_; } __end_; unsigned long long __size_; } _LegacySVResourceAndUsageList;
    struct list<id<MTLHeap>, std::allocator<id<MTLHeap>>> { struct __list_node_base<id<MTLHeap>, void *> { void *__prev_; void *__next_; } __end_; unsigned long long __size_; } _heapList;
