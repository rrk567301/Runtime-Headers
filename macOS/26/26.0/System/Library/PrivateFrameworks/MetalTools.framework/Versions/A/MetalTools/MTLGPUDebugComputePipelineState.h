...
- (id)initWithComputePipelineState:(id)a0 descriptor:(id)a1 device:(id)a2;
- (id)initWithComputePipelineState:(id)a0 descriptor:(id)a1 dynamicLinkingDescriptor:(id)a2 device:(id)a3;
