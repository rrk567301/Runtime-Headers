...
@interface MTLToolsCommandBuffer : MTLToolsObject <MTLCommandBufferSPI, MTLToolsRetainingContainer> {
    ...
    struct vector<void (^)(id<MTLCommandBuffer>), std::allocator<void (^)(id<MTLCommandBuffer>)>> { id /* block */ *__begin_; id /* block */ *__end_; id /* block */ *__cap_; } _scheduledHandlers;
    struct vector<void (^)(id<MTLCommandBuffer>), std::allocator<void (^)(id<MTLCommandBuffer>)>> { id /* block */ *__begin_; id /* block */ *__end_; id /* block */ *__cap_; } _completedHandlers;
