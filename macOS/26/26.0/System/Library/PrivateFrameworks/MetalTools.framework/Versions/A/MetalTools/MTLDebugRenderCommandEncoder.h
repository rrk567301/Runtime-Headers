@class __cap_, __begin_, MTLDepthStencilDescriptor, baseLevel, __end_, MTLLogicalToPhysicalColorAttachmentMap, NSMutableSet, MTLRenderPassDescriptor, MTLDebugCommandBuffer;
...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
    ...
    struct vector<MTLViewport, std::allocator<MTLViewport>> { struct *__begin_; struct *__end_; struct *__cap_; } _viewports;
    struct vector<MTLScissorRect, std::allocator<MTLScissorRect>> { struct *__begin_; struct *__end_; struct *__cap_; } _scissorRects;
    unsigned long long _amplificationMode;
    unsigned long long _amplificationValue;
    unsigned long long _vertexAmplificationCount;
    struct deque<id, std::allocator<id>> { struct __split_buffer<id *, std::allocator<id *>> { __begin_ ***__first_; __end_ ***x0; __cap_ ***x1; id **x2; } __map_; unsigned long long __start_; unsigned long long __size_; } _updatedFences;
