...
@interface FIDSNode : FINode {
    struct TPrivateNodeInstantiationEnabler { struct shared_ptr<TFSVolumeInfo> { struct TFSVolumeInfo *__ptr_; struct __shared_weak_count *__cntrl_; } fVolumeInfoPtr; struct shared_ptr<TFSInfo> { struct TFSInfo *__ptr_; struct __shared_weak_count *__cntrl_; } fFSInfo; struct TNodePtr { FINode *fFINode; } fAliasTarget; struct unique_ptr<TOperationLock, std::default_delete<TOperationLock>> { struct TOperationLock *__ptr_; } fOperationLock; struct TNode *fParent; struct unique_ptr<TChildrenList, std::default_delete<TChildrenList>> { struct TChildrenList *__ptr_; } fChildrenList; void *fCustomNode; struct unique_ptr<TNotifierList, std::default_delete<TNotifierList>> { struct TNotifierList *__ptr_; } fNotifierList; struct unique_ptr<AutoSignpostInterval_General_OpenSync, std::default_delete<AutoSignpostInterval_General_OpenSync>> { struct AutoSignpostInterval_General_OpenSync *__ptr_; } fOpenSyncSignpost; struct atomic<unsigned short> { struct __cxx_atomic_impl<unsigned short, std::__cxx_atomic_base_impl<unsigned short>> { _Atomic unsigned short __a_value; } __a_; } fFlags; } _node;
}
