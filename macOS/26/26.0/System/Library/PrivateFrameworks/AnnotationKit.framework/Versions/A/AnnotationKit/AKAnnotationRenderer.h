...
+ (id)_optionsForContext:(struct CGContext { } *)a0 forDisplay:(BOOL)a1;
...
+ (BOOL)isBitmapContext:(struct CGContext { } *)a0;
...
+ (void)renderAnnotation:(id)a0 intoContext:(struct CGContext { } *)a1 options:(id)a2 pageControllerOrNil:(id)a3;
