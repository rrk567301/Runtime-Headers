...
+ (void)_drawPathForArrow:(id)a0 inContext:(struct CGContext { } *)a1 options:(id)a2 inPath:(struct CGPath { } *)a3 pageControllerForPixelAlignmentOrNil:(id)a4 minimumGrabbableBorderThickness:(double)a5;
