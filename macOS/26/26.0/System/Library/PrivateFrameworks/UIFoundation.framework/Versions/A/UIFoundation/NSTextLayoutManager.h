...
@protocol NSTextLayoutManagerDelegate, NSTextLayoutManagerDelegatePrivate, _NSTextLayoutManagerPlatformDelegate, NSTextLocation;
...
@interface NSTextLayoutManager : NSObject <NSTextViewportElementProvider, NSSecureCoding, NSTextSelectionDataSource> {
    ...
    BOOL _delegateWithViewProviderInvalidationNotification;
    BOOL _delegateWithCachedViewProviderForTextAttachment;
    BOOL _platformDelegateWithViewProviderInvalidationNotification;
    BOOL _platformDelegateWithCachedViewProviderForTextAttachment;
...
@property (readonly) BOOL canSendViewProviderInvalidationNotification;
@property BOOL _hasTextAnimationContextsSnapshotting;
...
+ (long long)_fallbackBaseWritingDirectionForApplicationFrameworkContext:(long long)a0;
...
- (BOOL)_delegateCanSendViewProviderInvalidationNotification;
...
- (BOOL)_platformDelegateCanSendViewProviderInvalidationNotification;
...
- (void)willInvalidateTextAttachmentViewProvider:(id)a0 forTextAttachment:(id)a1;
