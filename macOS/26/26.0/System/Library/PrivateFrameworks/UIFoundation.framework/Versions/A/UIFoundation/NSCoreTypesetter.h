...
@interface NSCoreTypesetter : NSTypesetter {
    ...
    BOOL _delegateSupportsTruncationToken;
    BOOL _delegateSupportsBidi;
...
@property (readonly) BOOL _overridingFallbackWritingDirection;
...
- (void)_updateBidiLevelsAndBaseWritingDirectionForAttributedString:(id)a0 paragraphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
...
- (BOOL)_overridingFallbackWritingDirection;
