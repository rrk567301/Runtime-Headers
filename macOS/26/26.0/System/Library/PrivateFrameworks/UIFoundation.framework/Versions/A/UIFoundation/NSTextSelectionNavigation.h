...
@property BOOL prefersVisuallyContiguousNavigation;
@property (readonly) BOOL _isVisuallyContiguousNavigation;
...
- (id)_mergeVisuallyContiguousRanges:(id)a0 withRanges:(id)a1;
...
- (id)deletionRangesForTextSelection:(id)a0 direction:(long long)a1 destination:(long long)a2 allowsDecomposition:(BOOL)a3 confined:(BOOL)a4;
...
- (BOOL)_isVisuallyContiguousNavigation;
