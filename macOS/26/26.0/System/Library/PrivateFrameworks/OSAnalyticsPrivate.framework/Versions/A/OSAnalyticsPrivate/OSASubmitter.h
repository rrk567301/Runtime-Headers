@class NSArray, NSString, NSDictionary, NSData, NSError;
...
+ (id)endpointToString:(int)a0;
+ (BOOL)submitToUAT;
+ (id)taskingKeyForRouting:(id)a0 withConfig:(id)a1;
...
- (void)cheaterTaskingWithSets:(id)a0 usingConfig:(id)a1 resultsCallback:(id /* block */)a2;
...
- (void)submitLogsUsingPolicy:(id)a0 resultsCallback:(id /* block */)a1;
