...
- (unsigned char)_regionSupportStatusForFeatureID:(id)a0;
- (void)_registerForRegionStatusUpdatesWithFeatureIdentifier:(id)a0;
- (BOOL)_updateHMRegionStatusFromFeatureStatus:(id)a0 featureIdentifier:(id)a1;
