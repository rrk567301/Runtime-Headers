@class HMIVideoFrameAnalyzer, HMIVideoFrameTracker, NSObject, HMIVideoDecoder, HMIVideoEncoder, HMIVideoTimeline, NSDate, HMIVideoCommandBuffer, HMIVideoEventBuffer, HMIVideoFrameIntervalSampler, NSString, HMIVideoTemporalEventFilter, NSData, HMIVideoFrameSelector, HMFTimer, HMIVideoAssetWriter;
...
- (void)_prepareForInputVideoFormat:(struct opaqueCMFormatDescription { } *)a0 audioFormat:(struct opaqueCMFormatDescription { } *)a1;
- (void)_prepareForTimelapseOutputVideoFormat:(struct opaqueCMFormatDescription { } *)a0;
- (void)_produceResult:(SEL)a0 withArguments:(id)a1;
- (void)_saveFragmentDataToDisk:(id)a0 diskBufferSize:(unsigned long long)a1;
- (void)_updateDecoderAndEncodersForFragment:(id)a0 withConfiguration:(id)a1;
- (void)_updateDecoderForFragment:(id)a0 decodeMode:(long long)a1;
- (void)_updateTimelapseEncoder:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
...
- (BOOL)monitored;
- (void)setBoosted:(BOOL)a0;
- (void)setDecodeMode:(long long)a0;
