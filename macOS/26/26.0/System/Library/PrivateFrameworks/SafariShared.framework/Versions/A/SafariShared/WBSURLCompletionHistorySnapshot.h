...
@interface WBSURLCompletionHistorySnapshot : NSObject <WBSURLCompletionDataSource> {
    ...
    struct unique_ptr<std::vector<WTF::RefPtr<SafariShared::HistoryURLCompletionItem>>, std::default_delete<std::vector<WTF::RefPtr<SafariShared::HistoryURLCompletionItem>>>> { void *__ptr_; } _items;
}
...
- (id)initWithItems:(struct unique_ptr<std::vector<WTF::RefPtr<SafariShared::HistoryURLCompletionItem>>, std::default_delete<std::vector<WTF::RefPtr<SafariShared::HistoryURLCompletionItem>>>> { void *x0; })a0;
- (id)init;
- (id).cxx_construct;
- (void).cxx_destruct;
