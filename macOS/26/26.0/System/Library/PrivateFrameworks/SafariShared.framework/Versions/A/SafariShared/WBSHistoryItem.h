...
@interface WBSHistoryItem : NSObject {
    ...
    int _visitCount;
    struct unique_ptr<WBSHistoryItemVisitCountScoresStorage, std::default_delete<WBSHistoryItemVisitCountScoresStorage>> { struct WBSHistoryItemVisitCountScoresStorage *__ptr_; } _visitCountScores;
}
