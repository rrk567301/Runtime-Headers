...
@property (readonly, nonatomic) BOOL isDropOutliersInFrequentlyVisitedEnabled;
@property (readonly, nonatomic) BOOL isAllowFavoritesInFrequentlyVisitedEnabled;
@property (readonly, nonatomic) BOOL isAllowLogOnURLsInFrequentlyVisitedEnabled;
