...
- (void)didFillPasswordForUsername:(id)a0 fromProviderWithBundleIdentifier:(id)a1 inTabWithID:(id)a2 currentURL:(id)a3 isPrivate:(BOOL)a4 formMetadata:(id)a5 requester:(id)a6;
