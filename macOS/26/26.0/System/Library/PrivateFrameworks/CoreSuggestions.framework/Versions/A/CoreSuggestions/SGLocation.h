...
- (id)initWithId:(id)a0 origin:(id)a1 type:(unsigned long long)a2 label:(id)a3 address:(id)a4 airportCode:(id)a5 latitude:(double)a6 longitude:(double)a7 accuracy:(double)a8 quality:(double)a9 handle:(id)a10 country:(id)a11 state:(id)a12 city:(id)a13 thoroughfare:(id)a14 subThoroughfare:(id)a15 postalCode:(id)a16;
...
- (id)initWithLocation:(id)a0 latitude:(double)a1 longitude:(double)a2 accuracy:(double)a3 handle:(id)a4 country:(id)a5 state:(id)a6 city:(id)a7 thoroughfare:(id)a8 subThoroughfare:(id)a9 postalCode:(id)a10;
- (id)initWithMailAccountIdentifier:(id)a0 messageIdentifier:(id)a1 type:(unsigned long long)a2 label:(id)a3 address:(id)a4 airportCode:(id)a5 latitude:(double)a6 longitude:(double)a7;
