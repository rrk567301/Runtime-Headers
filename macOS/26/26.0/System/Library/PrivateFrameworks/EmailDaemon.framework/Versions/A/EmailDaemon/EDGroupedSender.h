@class NSNumber, EMCategory, EMObjectID, EMGeneratedSummary, NSString, ECSubject, EMFollowUp, EFFuture, EMReadLater, EMMessage, NSArray, NSMutableArray, EDMessagePersistence, EMListUnsubscribeDetector, EDBusinessPersistence, EMBusinessExternalID, ECMessageFlags, EDBusinessCloudStorage, NSURL, NSDate, EMGroupedSenderObjectID, NSIndexSet;
...
@property (readonly) BOOL isUrgent;
