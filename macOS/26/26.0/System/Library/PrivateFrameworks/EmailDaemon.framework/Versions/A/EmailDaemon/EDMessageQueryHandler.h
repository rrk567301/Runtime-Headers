...
- (void)_createHelper;
- (id)_extraInfoForMessages:(id)a0 messagesToPrecache:(id)a1 outObjectIDs:(id *)a2 existingExtraInfo:(id)a3;
...
- (void)_reportFoundMessages:(id)a0 before:(id)a1 messagesToPrecache:(id)a2 extraInfo:(id)a3;
