@class NSUUID, RTLocation, RTPlaceInference, NSDate;
...
- (id)initWithDate:(id)a0 type:(long long)a1 location:(id)a2 entry:(id)a3 exit:(id)a4 dataPointCount:(long long)a5 confidence:(double)a6 placeInference:(id)a7 source:(long long)a8 identifier:(id)a9;
