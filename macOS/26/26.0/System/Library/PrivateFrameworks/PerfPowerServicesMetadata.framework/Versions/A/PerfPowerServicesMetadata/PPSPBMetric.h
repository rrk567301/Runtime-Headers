...
@interface PPSPBMetric : PBCodable <NSCopying> {
    struct { unsigned char version : 1; unsigned char appIdentifier : 1; unsigned char auxiliaryType : 1; unsigned char datatype : 1; unsigned char deviceCapability : 1; unsigned char directionality : 1; unsigned char enabledPopulation : 1; unsigned char fixedArraySize : 1; unsigned char mode : 1; unsigned char obfuscation : 1; unsigned char privacyClassification : 1; unsigned char storage : 1; unsigned char timeToLive : 1; unsigned char dmaCompliant : 1; unsigned char filterEntryLogging : 1; } _has;
}
