...
@property (nonatomic) BOOL contentStartsAtEnd;
...
@property (readonly, nonatomic) BOOL enablePinchEffect;
...
@property (readonly, nonatomic) BOOL isInteractiveZoomingAllowed;
...
@property (readonly, nonatomic) BOOL showSensitiveWarningBadges;
...
@property (readonly, nonatomic) BOOL enableCornerRadiusMaskingWhenAlignedWithEdge;
...
- (void)setIsInteractiveZoomingAllowed:(BOOL)a0;
...
- (id)initWithDataSourceManager:(id)a0 selectionManager:(id)a1 mediaProvider:(id)a2 specManager:(id)a3 loadingStatusManager:(id)a4 badgesModifier:(id /* block */)a5 preferredAssetCropDelegate:(id)a6 preferredColumnCountsDelegate:(id)a7 inlinePlaybackController:(id)a8 sectionIndex:(long long)a9 headersEnabled:(BOOL)a10;
- (void)performInitialChanges:(id /* block */)a0;
- (void)resetColumns;
- (void)setEffectProvider:(id /* block */)a0;
- (void)setEnableCornerRadiusMaskingWhenAlignedWithEdge:(BOOL)a0;
- (void)setFaceModeEnabled:(BOOL)a0;
- (void)setHidesDurationLabelBadge:(BOOL)a0;
- (void)setSectionIndexPath:(struct PXSimpleIndexPath { long long x0; long long x1; long long x2; long long x3; })a0;
- (void)setWantsAssetIndexBadge:(BOOL)a0;
...
- (void)setIsDisplayingIndividualItems:(BOOL)a0;
...
- (void)setEnablePinchEffect:(BOOL)a0;
...
- (void)setShowSensitiveWarningBadges:(BOOL)a0;
