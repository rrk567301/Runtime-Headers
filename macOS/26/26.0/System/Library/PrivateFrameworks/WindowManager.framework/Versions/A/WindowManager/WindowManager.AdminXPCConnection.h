...
- (void)xpcTakeModalRevealAssertion:(id)a0 withInclusions:(id)a1 animated:(BOOL)a2 completion:(id /* block */)a3;
...
- (void)minimumDockRevealAmountDidChange:(double)a0;
...
- (void)xpcCreateManagedSpaceWithDisplayUUID:(id)a0 completion:(id /* block */)a1;
- (void)xpcDestroySpaceWithSpace:(unsigned long long)a0 completion:(id /* block */)a1;
...
- (void)xpcReleaseExposeGestureAssertion:(id)a0 completion:(id /* block */)a1;
- (void)xpcReleaseLayoutControlWithCompletion:(id /* block */)a0;
- (void)xpcReleaseModalRevealAssertion:(id)a0 completion:(id /* block */)a1;
...
- (void)xpcTakeExposeGestureAssertion:(id)a0 direction:(id)a1 completion:(id /* block */)a2;
- (void)xpcTileWindow:(id)a0 completion:(id /* block */)a1;
