...
@property (readonly, nonatomic) BOOL installsAppleAppExtensionsNotInExtensionCache;
...
@property (readonly, nonatomic) BOOL isAppTypeBundle;
@property (readonly, nonatomic) BOOL mayContainAppExtensions;
@property (readonly, nonatomic) BOOL mayContainFrameworks;
@property (readonly, nonatomic) BOOL mayHaveExecutableProgram;
...
@property (readonly, nonatomic) NSURL *macAppStoreReceiptDirectoryURL;
@property (readonly, nonatomic) NSURL *macAppStoreReceiptURL;
...
+ (id)bundleForURL:(id)a0 platformHint:(unsigned int)a1 forceAsPlaceholder:(BOOL)a2 error:(id *)a3;
+ (BOOL)bundleIsInDenyList:(id)a0;
...
- (BOOL)_getBundleRootContainsOnlyContentsDirectory:(BOOL *)a0 error:(id *)a1;
- (BOOL)_isMinimumOSVersion:(id)a0 applicableToOSVersion:(id)a1 requiredOS:(unsigned long long)a2 error:(id *)a3;
- (BOOL)_setBundleParentDirectoryURL:(id)a0 forBundleArray:(id)a1 error:(id *)a2;
...
- (id)denormalizedURLForCFBundleURL:(id)a0;
...
- (id)infoPlistHashWithError:(id *)a0;
- (id)initWithBundleInDirectory:(id)a0 withExtension:(id)a1 error:(id *)a2;
- (id)initWithBundleParentURL:(id)a0 parentSubdirectory:(id)a1 bundleName:(id)a2 platformHint:(unsigned int)a3 forceAsPlaceholder:(BOOL)a4 error:(id *)a5;
- (id)initWithBundleURL:(id)a0 platformHint:(unsigned int)a1 forceAsPlaceholder:(BOOL)a2 error:(id *)a3;
- (id)initWithParentBundle:(id)a0 parentSubdirectory:(id)a1 bundleName:(id)a2 platformHint:(unsigned int)a3 forceAsPlaceholder:(BOOL)a4 error:(id *)a5;
- (BOOL)isApplicableToCurrentDeviceCapabilitiesWithError:(id *)a0;
- (BOOL)isApplicableToCurrentDeviceFamilyWithError:(id *)a0;
- (BOOL)isApplicableToCurrentMacOSVersionWithError:(id *)a0;
...
- (BOOL)setBundleParentDirectoryURL:(id)a0 error:(id *)a1;
- (void)setInfoPlistSubsetForTesting:(id)a0;
