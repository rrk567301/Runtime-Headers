...
+ (void)_performWithLaunchPersona:(id /* block */)a0;
+ (id)containerForIdentifier:(id)a0 contentClass:(unsigned long long)a1 forPersona:(id)a2 create:(BOOL)a3 error:(id *)a4;
+ (id)containersForBundleIdentifier:(id)a0 contentClass:(unsigned long long)a1 forPersona:(id)a2 create:(BOOL)a3 fetchTransient:(BOOL)a4 error:(id *)a5;
+ (id)containersForContentClass:(unsigned long long)a0 forPersona:(id)a1 fetchTransient:(BOOL)a2 error:(id *)a3;
+ (id)containersForGroupIdentifier:(id)a0 forPersona:(id)a1 create:(BOOL)a2 fetchTransient:(BOOL)a3 error:(id *)a4;
+ (id)daemonContainerForIdentifier:(id)a0 personaUniqueString:(id)a1 error:(id *)a2;
+ (id)daemonContainerForPersona:(id)a0 error:(id *)a1;
