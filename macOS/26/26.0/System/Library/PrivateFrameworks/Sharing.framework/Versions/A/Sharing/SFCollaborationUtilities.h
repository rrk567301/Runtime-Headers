...
+ (void)_fetchCollaborationAppInfoIfNeededForActivityType:(id)a0 deviceScreenScale:(double)a1 appInfoCompletion:(id /* block */)a2;
...
+ (void)createCollaborationRequestWithCollaborationItem:(id)a0 activityType:(id)a1 deviceScreenScale:(double)a2 completionHandler:(id /* block */)a3;
...
+ (void)requestSharedURLForCollaborationRequest:(id)a0 completionHandler:(id /* block */)a1;
+ (void)shareStatusForURL:(id)a0 completionHandler:(id /* block */)a1;
+ (BOOL)shareSupportsRequestAccess:(id)a0 options:(id)a1;
