@class GEOObserverHashTable, MNDisplayETAInfo, GEODirectionsResponse, MNArrivalInfo, NSString, GEOComposedWaypoint, NSArray, MNNavigationClientProxy, MNNavTrayGuidanceEvent, NSMutableDictionary, MNUserOptions, GEOResumeRouteHandle, NSObject, NSSet, MNGuidanceLaneInfo, MNRouteDistanceInfo, MNVehicleParkingInfo, MNNavigationServiceRemoteProxy, MNBatteryChargeInfo, GEOComposedRoute, NSUUID, MNNavigationDetails, MNLocation, GEODirectionsRequest;
@protocol OS_dispatch_queue, MNNavigationServiceProxy;
...
- (void)_navigationServiceCallback_DidUpdateTrafficIncidentAlert:(id)a0;
