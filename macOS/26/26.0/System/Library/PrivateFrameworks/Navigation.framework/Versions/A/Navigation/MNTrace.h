@class NSDate, NSString, NSArray, GEOComposedRoute, NSDictionary, NSObject, NSMutableArray, MNTracePreparedStatement;
...
- (BOOL)closeTrace;
- (id)createMapMatcherTestEventInsertStatementAndReturnError:(id *)a0;
...
- (id)routeAtRowIndex:(long long)a0;
