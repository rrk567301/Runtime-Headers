@class NSButton, BKUICBDeviceManager, BKUIAlertView, BKExtendEnrollTouchIDOperation, BKUIDeviceImageView, BKUIFingerSecurePairingStateObserver, NSString, BKIdentity, BKDeviceTouchID, BKUIFunctionBarController, NSTimer, NSTextField, BKUIBlueButton, BKUILockScreenAssertionHandler, NSObject, BKMesaSecureIntentProvider, BiometricKitIdentity, NSLayoutConstraint, NSView, BKUICurvesView, BKEnrollTouchIDOperation, NSProgressIndicator, NSDate, BKUIDevice;
@protocol OS_os_log;
...
@property (retain) BKUICBDeviceManager *cbDeviceManager;
@property (retain) BKDeviceTouchID *bkDevice_Surrogate;
@property (retain) BKUIDevice *currentDevice_Surrogate;
@property (retain) BKUICBDeviceManager *cbDeviceManager_Surrogate;
