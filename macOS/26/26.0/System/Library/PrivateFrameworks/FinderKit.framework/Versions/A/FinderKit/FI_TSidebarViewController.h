...
@interface FI_TSidebarViewController : FI_TViewController <QLSeamlessCloserDelegate, NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, NSMenuItemValidation, ISpawnOriginDelegateProtocol, TMarkTornDown> {
    ...
    struct vector<TSidebarZone, std::allocator<TSidebarZone>> { int *__begin_; int *__end_; int *__cap_; } _localDataSourceCopyZones;
    struct map<TSidebarZone, TFENodeVector, std::less<TSidebarZone>, std::allocator<std::pair<const TSidebarZone, TFENodeVector>>> { struct __tree<std::__value_type<TSidebarZone, TFENodeVector>, std::__map_value_compare<TSidebarZone, std::__value_type<TSidebarZone, TFENodeVector>, std::less<TSidebarZone>>, std::allocator<std::__value_type<TSidebarZone, TFENodeVector>>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } _localDataSourceCopy;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct TFENode *x2; })nodesForZone:(int)a0;
