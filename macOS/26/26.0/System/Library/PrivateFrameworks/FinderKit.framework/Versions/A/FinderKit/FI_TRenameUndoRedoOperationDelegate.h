@interface FI_TRenameUndoRedoOperationDelegate : FI_TRenameOperationDelegate {
    struct unique_ptr<TRenameUndoRedoOperationHelper, std::default_delete<TRenameUndoRedoOperationHelper>> { struct TRenameUndoRedoOperationHelper *__ptr_; } _actionHelper;
