...
@interface FI_TSearchSliceController : NSSplitViewItemAccessoryViewController <NSTextFieldDelegate, TSearchScopeSliceControllerDelegate, TSearchCriteriaViewControllerDelegate, TMarkTornDown> {
