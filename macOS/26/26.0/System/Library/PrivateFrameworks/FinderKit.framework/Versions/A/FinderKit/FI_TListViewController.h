...
@interface FI_TListViewController : FI_TBrowserViewController <TListHeaderRowViewDelegate, NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate, TListNameFieldDelegate, TListRowViewDelegate, TListViewDelegate> {
    ...
    struct unordered_set<TFENode, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<TFENode>> { struct __hash_table<TFENode, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<TFENode>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *>>> { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *>> { unsigned long long __size_; } __deleter_; } __bucket_list_; struct __hash_node_base<std::__hash_node<TFENode, void *> *> { void *__next_; } __first_node_; unsigned long long __size_; float __max_load_factor_; } __table_; } _nodesToRecursivelyExpand;
    BOOL _setupExpandingNodes;
    struct unordered_set<TFENode, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<TFENode>> { struct __hash_table<TFENode, std::hash<TFENode>, std::equal_to<TFENode>, std::allocator<TFENode>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *>>> { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<TFENode, void *> *> *>> { unsigned long long __size_; } __deleter_; } __bucket_list_; struct __hash_node_base<std::__hash_node<TFENode, void *> *> { void *__next_; } __first_node_; unsigned long long __size_; float __max_load_factor_; } __table_; } _nodesToExpand;
    struct vector<std::pair<TFENode, TFENode>, std::allocator<std::pair<TFENode, TFENode>>> { void *__begin_; void *__end_; void *__cap_; } _disclosedAliasNodes;
    NSFont *_monospacedDigitsCellViewFont;
    NSFont *_nameCellViewFont;
    NSFont *_cellViewFont;
    struct multimap<long, TFENode, std::less<long>, std::allocator<std::pair<const long, TFENode>>> { struct __tree<std::__value_type<long, TFENode>, std::__map_value_compare<long, std::__value_type<long, TFENode>, std::less<long>>, std::allocator<std::__value_type<long, TFENode>>> { void *__begin_node_; struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; unsigned long long __size_; } __tree_; } _depthToOpenContainerMap;
