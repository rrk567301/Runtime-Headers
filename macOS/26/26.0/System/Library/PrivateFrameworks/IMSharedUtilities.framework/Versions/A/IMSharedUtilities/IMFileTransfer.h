...
+ (long long)finalTransferStateForThumbnailMode:(long long)a0 success:(BOOL)a1;
+ (BOOL)genmojiFileTransferShouldDisplayAsPermanentlyFailed:(id)a0;
+ (id)guidByStrippingAuxPrefix:(id)a0;
+ (id)guidForFileTransferDictionary:(id)a0;
+ (long long)thumbnailModeForMode:(long long)a0 afterDownloadSuccess:(BOOL)a1;
...
- (void)setTranscoderUserInfoIsGenmoji:(BOOL)a0;
...
- (long long)finalTransferStateForSuccess:(BOOL)a0;
- (BOOL)isDownloadingFromRemoteIntent;
- (void)setTranscoderUserInfoObject:(id)a0 forKey:(id)a1;
- (long long)thumbnailModeAfterDownloadSuccess:(BOOL)a0;
