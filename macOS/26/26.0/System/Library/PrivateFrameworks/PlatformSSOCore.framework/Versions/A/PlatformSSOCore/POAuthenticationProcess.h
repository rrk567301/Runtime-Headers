...
- (void)extractGroupsAndSubUsingAuthorizationWithLoginConfiguration:(id)a0 tokens:(id)a1 returningGroups:(id *)a2 identifier:(id *)a3 refreshToken:(id *)a4;
- (BOOL)extractNewUserValuesFromTokens:(id)a0 deviceConfiguration:(id)a1 loginUserName:(id)a2 returningName:(id *)a3 userName:(id *)a4 error:(id *)a5;
...
- (void)completeAccessTokenLoginUsingContext:(id)a0 completion:(id /* block */)a1;
- (id)createAuthenticationContextUsingLoginConfiguration:(id)a0 deviceConfiguration:(id)a1 userName:(id)a2 resumeData:(id)a3;
...
- (void)performAccessTokenSigningUsingContext:(id)a0 completion:(id /* block */)a1;
...
- (void)prepareForAccessTokenLoginUsingContext:(id)a0 completion:(id /* block */)a1;
