...
@interface _EARSpeechRecognizer : NSObject {
    ...
    struct vector<std::string, std::allocator<std::string>> { void *__begin_; void *__end_; void *__cap_; } _rightContextTokens;
...
- (struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; void *x2; })splitWithTokenizer:(id)a0 isLeftContext:(BOOL)a1 shouldTruncate:(BOOL)a2 outTokensInVocab:(id *)a3;
- (struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; void *x2; })splitWithTokenizer:(id)a0 outTokensInVocab:(id *)a1 isLeftContext:(BOOL)a2;
