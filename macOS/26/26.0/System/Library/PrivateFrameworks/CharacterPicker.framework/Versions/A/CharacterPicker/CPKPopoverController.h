@class CPKCategoriesView, STKEmojiGenerationViewController, NSButton, CPKCharactersView, NSDictionary, CPKSearchView, NSMutableArray, CPKDividerLine, NSRemoteViewController, NSString, CPSearchManager, STKEmojiGenerationViewControllerOLD, CPKCategoriesPickerView, CPKPopover, NSArray, CPKBottomView, CPKDataProvider, NSTextField, CPKTestWindow;
