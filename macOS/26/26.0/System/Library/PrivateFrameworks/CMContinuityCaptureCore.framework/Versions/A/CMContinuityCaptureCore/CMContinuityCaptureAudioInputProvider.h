...
@interface CMContinuityCaptureAudioInputProvider : NSObject <NSXPCListenerDelegate, CMContinuityCaptureAudioInputProviderObject> {
    ...
    NSMutableDictionary *_availableDevicesByAudioDeviceUIDs;
...
- (void)publishDeviceForClientDeviceUID:(id)a0 audioDeviceUID:(id)a1 name:(id)a2 deviceModel:(id)a3 voiceAmplificationModeSupported:(BOOL)a4;
