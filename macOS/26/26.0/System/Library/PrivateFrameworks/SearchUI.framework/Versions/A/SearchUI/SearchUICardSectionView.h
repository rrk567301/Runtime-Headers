@class NSViewController, NSView, NSString, SFCardSection, SearchUITabButtonIndicatorView, SearchUICardSectionRowModel;
...
@property (nonatomic) BOOL shouldShowTabIndicator;
