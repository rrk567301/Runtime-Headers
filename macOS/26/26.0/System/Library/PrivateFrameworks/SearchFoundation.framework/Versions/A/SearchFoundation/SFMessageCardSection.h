@class NSURL, NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, NSString, SFMessageAttachment, SFCommand, NSArray, NSData, SFUserReportRequest, SFCopyItem;
