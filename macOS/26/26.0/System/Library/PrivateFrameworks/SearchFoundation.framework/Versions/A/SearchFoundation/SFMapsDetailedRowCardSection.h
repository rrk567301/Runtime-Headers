@class SFColor, NSString, NSData, NSArray, SFCard, SFUserReportRequest, NSDictionary, SFDetailedRowCardSection, SFCommand, SFCopyItem, SFAppEntityAnnotation, NSMutableDictionary;

@interface SFMapsDetailedRowCardSection : SFCardSection <SFMapsDetailedRowCardSection, NSSecureCoding, NSCopying>

@property (class, readonly) BOOL supportsSecureCoding;

@property (retain, nonatomic) SFDetailedRowCardSection *internalDetailedRowCardSection;
