...
@interface RFPrimaryHeaderStandardCardSection : SFCardSection <RFPrimaryHeaderStandardCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char addTint : 1; } _has;
}
