@class NSURL, NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, NSString, SFImage, SFCommand, NSArray, NSData, SFUserReportRequest, SFCopyItem;
