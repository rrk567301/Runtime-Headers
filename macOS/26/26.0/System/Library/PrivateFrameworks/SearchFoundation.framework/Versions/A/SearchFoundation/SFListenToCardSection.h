@class NSMutableDictionary, SFMediaMetadata, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, NSString, SFCommand, SFCardSection, NSArray, NSData, SFUserReportRequest, SFCopyItem;

@interface SFListenToCardSection : SFCardSection <SFListenToCardSection, NSSecureCoding, NSCopying>
