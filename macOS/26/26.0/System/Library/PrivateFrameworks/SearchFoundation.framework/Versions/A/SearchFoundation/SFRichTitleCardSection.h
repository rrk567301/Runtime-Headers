@class NSMutableDictionary, SFColor, SFActionItem, SFCard, NSDictionary, SFAppEntityAnnotation, NSString, SFImage, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, NSNumber, SFCopyItem;
