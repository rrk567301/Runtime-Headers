@class NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFButtonItem, NSString, RFTextProperty, SFCommand, NSArray, NSData, SFUserReportRequest, SFCopyItem;

@interface RFFactItemHeroButtonCardSection : SFCardSection <RFFactItemHeroButtonCardSection, NSSecureCoding, NSCopying>
