@class SFColor, NSString, NSArray, NSData, SFCard, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, SFCopyItem, SFRichText, NSMutableDictionary;
