@class SFCollectionStyle, NSMutableDictionary, SFColor, SFAppEntityAnnotation, SFCard, NSDictionary, SFCommandButtonItem, NSString, SFCommand, SFRichText, NSArray, NSData, SFUserReportRequest, SFCopyItem;

@interface SFCollectionCardSection : SFCardSection <SFCollectionCardSection, NSSecureCoding, NSCopying>
