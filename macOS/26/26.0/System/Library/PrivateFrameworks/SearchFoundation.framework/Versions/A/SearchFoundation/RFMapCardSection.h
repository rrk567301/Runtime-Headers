...
@interface RFMapCardSection : SFCardSection <RFMapCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char sizeFormat : 1; unsigned char cameraDistance : 1; unsigned char showsUserLocation : 1; } _has;
}
