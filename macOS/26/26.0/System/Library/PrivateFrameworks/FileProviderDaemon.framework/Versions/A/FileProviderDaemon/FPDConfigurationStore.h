@class NSDictionary, NSString, NSArray, NSSet, NSMutableDictionary, NSObject, NSHashTable;
...
@interface FPDConfigurationStore : NSObject {
    ...
    NSDictionary *_trialConfigurationState;
...
@property (readonly, nonatomic, getter=getTrialConfigurationState) NSString *trialConfigurationState;
...
@property (readonly, nonatomic) BOOL useCacheDeleteWhenReachingLowerBound;
...
- (id)loadTrialClient:(BOOL)a0;
- (void)loadSpecDownloadNamespace:(id)a0;
- (id)init;
- (void)__test_only_refresh;
- (void)addObserver:(id)a0;
- (void)loadFpfsConfigNamespace:(id)a0;
- (void).cxx_destruct;
