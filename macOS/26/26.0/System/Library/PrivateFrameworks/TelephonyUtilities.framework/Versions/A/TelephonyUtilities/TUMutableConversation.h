@class TUConversationParticipantAssociation, NSObject, TUConversationMember, TUConversationHandoffContext, TUConversationParticipantCluster, TUConversationHandoffEligibility, NSString, NSSet, TUConversationReport, TUConversationLink, NSArray, TUHandle, NSUUID;
...
@property (nonatomic, getter=isNearbySession) BOOL nearbySession;
