@class NSURL, IDSDestination, TUCallTranslationRequestConfiguration, NSDate, TUCallProvider, TUCallProviderManager, NSUserActivity, BSProcessHandle, NSString, NSSet, NSArray, TUSenderIdentityClient, TUHandle, TUSenderIdentity, NSUUID;
...
- (id)initWithProvider:(id)a0 featureFlags:(id)a1;
- (id)initWithService:(int)a0 featureFlags:(id)a1;
- (id)initWithURL:(id)a0 featureFlags:(id)a1;
- (id)initWithURL:(id)a0 translationRequestConfiguration:(id)a1;
...
- (id)legacyAddressBookIdentifierQueryItemNameFromURLComponents:(id)a0;
