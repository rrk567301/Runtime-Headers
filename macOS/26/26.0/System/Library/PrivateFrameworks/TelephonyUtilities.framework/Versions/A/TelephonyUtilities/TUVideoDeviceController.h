...
@property (readonly, nonatomic) BOOL currentInputSupportsTrueDepth;
@property (readonly, nonatomic) BOOL currentInputSupportsUltraWide;
...
- (void)startPreview;
- (void)stopPreview;
- (void)_postIsCinematicFramingAvailable:(BOOL)a0;
...
- (void)provider:(id)a0 backgroundReplacementEnabledDidChange:(BOOL)a1;
...
- (void)provider:(id)a0 cameraDidBecomeInterruptedForForUniqueID:(id)a1 reason:(long long)a2;
...
- (void)provider:(id)a0 didDetectSensitiveContentWithAnalysis:(id)a1;
...
- (void)provider:(id)a0 dockKitTrackingDidChange:(BOOL)a1;
