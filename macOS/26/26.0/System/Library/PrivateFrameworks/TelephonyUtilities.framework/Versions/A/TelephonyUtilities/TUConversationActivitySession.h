@class NSUUID, NSDate, NSXPCListenerEndpoint, NSString, NSSet, TUConversationActivity, NSDictionary, NSArray, TUHandle, NSNumber;
...
@property (nonatomic) BOOL isStageInitiated;
...
@property (readonly, nonatomic, getter=isLocalParticipantActive) BOOL localParticipantActive;
...
@property (nonatomic) BOOL didAssociateScene;
...
- (id)initWithActivity:(id)a0 state:(unsigned long long)a1 uuid:(id)a2 endpoint:(id)a3 locallyInitiated:(BOOL)a4 timestamp:(id)a5 isFirstJoin:(BOOL)a6 activeRemoteParticipants:(id)a7 isLocalParticipantActive:(BOOL)a8 applicationState:(unsigned long long)a9;
