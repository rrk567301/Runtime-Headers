...
@protocol VFXEditorViewDelegate, OS_dispatch_source;
...
@interface VFXEditorView : VFXView <VFXCameraNavigationControllerDelegate> {
    ...
    NSObject<OS_dispatch_source> *_renderGraphInvalidateSource;
}
...
@property (readonly, nonatomic) BOOL showsDebugUI;
