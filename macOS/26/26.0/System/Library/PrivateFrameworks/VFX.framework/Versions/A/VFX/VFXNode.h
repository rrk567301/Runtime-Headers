@class NSMutableDictionary, VFXMorpher, VFXParticleEmitter, VFXLight, VFXForceField, VFXSkinner, NSString, VFXWorld, VFXBehaviorGraph, NSMutableArray, VFXNodeComponent, VFXModel, NSArray, VFXOrderedDictionary, VFXCamera, VFXPhysicsBody;
@protocol VFXParameterList, VFXState;

@interface VFXNode : NSObject <VFXBehaviorSupport, VFXParameterizable, NSObject, VFXWorldReference, VFXReferenceEnumerable, VFXCopyingRemappable, VFXEntityProvider, VFXTransactionCommandObject, NSCopying, NSSecureCoding, VFXAnimatable, VFXBehaviorSupport, VFXParameterizable, VFXBoundingBox, VFXStateSupport> {
    ...
    unsigned char _isEyeSightFrame : 1;
    unsigned char _isHandTrackingRoot : 1;
    ...
    unsigned short _hasComponentBitmask : 15;
...
+ (id)nodeWithNodeRef:(struct __CFXNode { struct __CFXEntity { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; void *x1; struct __CFString *x2; struct __CFString *x3; struct __CFDictionary *x4; struct __CFXWorld *x5; long long x6; } x0; struct __CFXNode *x1; struct __CFXNode *x2; struct __CFXNode *x3; int x4; struct { struct { void /* unknown type, empty encoding */ x0[4]; } x0; union { } x1; } x5; struct *x6; BOOL x7; float x8; unsigned long long x9; int x10; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; unsigned char x14 : 1; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; unsigned char x19 : 1; unsigned char x20 : 1; unsigned char x21 : 1; unsigned char x22 : 1; unsigned char x23 : 1; unsigned char x24 : 1; unsigned char x25 : 1; unsigned char x26 : 1; unsigned char x27 : 1; unsigned char x28 : 1; unsigned char x29 : 1; unsigned char x30 : 3; unsigned char x31 : 1; unsigned char x32 : 1; unsigned char x33 : 1; unsigned char x34 : 1; unsigned char x35 : 1; unsigned char x36 : 1; struct { struct { unsigned short x0; unsigned short x1; } x0; unsigned int x1; } x37; struct *x38; struct __CFXModel *x39; struct __CFXDeformerStack *x40; float x41; struct { } x42; } *)a0;
...
+ (id)localUpValue;
+ (id)nodeWithMDLObject:(id)a0 masterObjects:(id)a1 worldNodes:(id)a2 skinnedMeshes:(id)a3 skelNodesMap:(void *)a4 asset:(id)a5 options:(id)a6 context:(id)a7 mpuScale:(float)a8;
...
- (struct __CFXNode { struct __CFXEntity { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; void *x1; struct __CFString *x2; struct __CFString *x3; struct __CFDictionary *x4; struct __CFXWorld *x5; long long x6; } x0; struct __CFXNode *x1; struct __CFXNode *x2; struct __CFXNode *x3; int x4; struct { struct { void /* unknown type, empty encoding */ x0[4]; } x0; union { } x1; } x5; struct *x6; BOOL x7; float x8; unsigned long long x9; int x10; unsigned char x11 : 1; unsigned char x12 : 1; unsigned char x13 : 1; unsigned char x14 : 1; unsigned char x15 : 1; unsigned char x16 : 1; unsigned char x17 : 1; unsigned char x18 : 1; unsigned char x19 : 1; unsigned char x20 : 1; unsigned char x21 : 1; unsigned char x22 : 1; unsigned char x23 : 1; unsigned char x24 : 1; unsigned char x25 : 1; unsigned char x26 : 1; unsigned char x27 : 1; unsigned char x28 : 1; unsigned char x29 : 1; unsigned char x30 : 3; unsigned char x31 : 1; unsigned char x32 : 1; unsigned char x33 : 1; unsigned char x34 : 1; unsigned char x35 : 1; unsigned char x36 : 1; struct { struct { unsigned short x0; unsigned short x1; } x0; unsigned int x1; } x37; struct *x38; struct __CFXModel *x39; struct __CFXDeformerStack *x40; float x41; struct { } x42; } *)nodeRef;
...
- (BOOL)isEyeSightFrame;
- (id)script_rootNode;
- (void)setIsAuthoring:(BOOL)a0;
- (void)_addSkinnerWithMDLMesh:(id)a0 worldNodes:(id)a1;
- (id)worldFrontValue;
- (id)worldRightValue;
- (id)_cloneWithOption:(unsigned long long)a0 copyContext:(id)a1;
- (void)_copyBindingsFrom:(id)a0;
- (id)_copyRecursively:(unsigned long long)a0 copyContext:(id)a1;
...
- (id)_deepCloneWithContext:(id)a0;
- (void)_didDecodeVFXNode:(id)a0;
- (void)_propagatePhysicsBodyCountChange:(int)a0;
- (void)_remapNodeReferences:(id)a0 nullifyIfAbsent:(BOOL)a1;
...
- (id)_vfxBindings;
- (void)addAnimationAsset:(id)a0 forKey:(id)a1;
...
- (id)deepCloneWithContext:(id)a0;
- (BOOL)editorLocked;
- (void)enumerateAnimationReferencesUsingBlock:(id /* block */)a0;
- (void)enumerateDrawCallsUsingBlock:(id /* block */)a0 context:(struct { id /* block */ x0; id x1; struct __CFXRenderingOverride *x2; id x3; struct __CFXWorld *x4; struct __CFXNode *x5; } *)a1;
...
- (void)setIsEyeSightFrame:(BOOL)a0;
- (void)setIsHandTrackingRoot:(BOOL)a0;
