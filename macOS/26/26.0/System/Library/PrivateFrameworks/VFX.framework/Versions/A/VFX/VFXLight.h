@class NSData, NSString, NSArray, VFXWorld, VFXMaterialProperty, NSMutableDictionary, VFXOrderedDictionary, VFXIESProfile;
...
- (void)_resyncObjCModelOfPerTypeParametersWithOldType:(unsigned char)a0;
