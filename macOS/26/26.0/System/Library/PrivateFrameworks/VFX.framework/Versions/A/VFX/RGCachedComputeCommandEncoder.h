...
- (void)beginEncodingWithCommandBuffer:(id)a0 label:(id)a1;
...
- (void)dispatchOnGrid1D:(unsigned long long)a0;
- (void)dispatchOnGrid2D:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0;
- (void)dispatchOnGrid3D:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a0;
...
- (BOOL)isEncoding;
- (void)setBufferSlice:(struct { void *x0; unsigned int x1; unsigned int x2; })a0 atIndex:(unsigned long long)a1;
