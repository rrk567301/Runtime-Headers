...
@interface DeskCamRenderingSession : NSObject <DeskCamRenderingManager> {
    ...
    float _roll;
    BOOL _gimbalLock;
    struct { void /* unknown type, empty encoding */ sensorSize; struct { void /* unknown type, empty encoding */ columns[3]; } intrinsicMatrix; struct { void /* unknown type, empty encoding */ columns[3]; } intrinsicMatrixT; BOOL hasGeometricDistortionCalibration; void /* unknown type, empty encoding */ lensDistortionCenter; float mmFactor; int distortionCalibrationValidMaxRadiusInPixels; struct { float c0; float c2; float c4; float c6; float c8; float c10; float c12; float c14; } inverseGeometricDistortionPolynomial; struct { float c0; float c2; float c4; float c6; float c8; float c10; float c12; float c14; } forwardGeometricDistortionPolynomial; } _calibrationParameters;
    ...
    BOOL _undistortControlsAvailable;
}
...
@property (readonly, nonatomic) BOOL gravityVectorUpdated;
...
- (void /* unknown type, empty encoding */)_translationVector;
- (struct { struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; struct { void /* unknown type, empty encoding */ x0[3]; } x1; int x2; } x0; struct { void /* unknown type, empty encoding */ x0[3]; } x1; struct { struct { void /* unknown type, empty encoding */ x0[3]; } x0; struct { void /* unknown type, empty encoding */ x0[3]; } x1; BOOL x2; float x3; int x4; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x5; struct { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } x6; } x2; int x3; BOOL x4; })_undistortControls;
