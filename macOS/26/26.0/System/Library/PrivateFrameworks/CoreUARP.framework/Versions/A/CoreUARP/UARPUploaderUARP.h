...
- (void)updateNonceSeed:(id)a0 remoteEndpoint:(id)a1;
...
- (void)updateNonceHash:(id)a0 remoteEndpoint:(id)a1;
...
- (void)addUnprocessedDynamicAsset:(id)a0 withAssetTag:(id)a1 serialNumber:(id)a2;
...
- (BOOL)offerAssetToAccessory:(id)a0 asset:(id)a1 downstreamID:(unsigned short)a2 error:(id *)a3;
...
- (long long)queryProperty:(unsigned long long)a0 forAccessory:(id)a1 downstreamID:(unsigned short)a2;
