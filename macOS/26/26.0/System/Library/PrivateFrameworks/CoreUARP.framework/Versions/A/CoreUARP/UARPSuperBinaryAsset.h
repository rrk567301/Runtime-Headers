@class NSDate, NSString, NSArray, NSURL, UARPSuperBinaryMetaDataTable, NSDictionary, NSObject, UARPAssetTag, UARPAssetVersion, NSMutableArray, NSMutableData;
@protocol OS_os_log;
...
- (id)initWithURL:(id)a0 assetTag:(id)a1 serialNumber:(id)a2;
