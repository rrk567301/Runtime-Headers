...
@interface PKAuthenticatorEvaluationContext : NSObject <LAUIDelegate> {
    ...
    struct atomic_flag { _Atomic BOOL _Value; } _evaluated;
...
- (void)_dismissAuthenticatorViewOfType:(unsigned char)a0;
- (void)_handleLiftFinger;
- (void)_presentAuthenticatorViewOfType:(unsigned char)a0 withParams:(id)a1;
- (BOOL)_presentPasscodeIfNecessary;
- (id)_requestRemoteAuthenticatorViewControllerOfType:(unsigned char)a0;
