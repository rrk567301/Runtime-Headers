@class NSString;
@protocol EKEventStoreProvider, CALNTravelAdvisoryAuthority, CalDateProvider;
...
- (void).cxx_destruct;
- (id)initWithTravelAdvisoryAuthority:(id)a0 dateProvider:(id)a1 eventStoreProvider:(id)a2;
