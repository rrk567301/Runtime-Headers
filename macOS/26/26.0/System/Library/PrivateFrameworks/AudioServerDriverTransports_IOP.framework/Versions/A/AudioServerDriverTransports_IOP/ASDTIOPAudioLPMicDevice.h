...
@interface ASDTIOPAudioLPMicDevice : ASDTAudioDevice <ASDTExclavesStatusTrackerHostProtocol, ASDTIOServiceDependency> {
    struct unique_ptr<ASDT::IOPAudio::LPMic::UserClient, std::default_delete<ASDT::IOPAudio::LPMic::UserClient>> { struct UserClient *__ptr_; } _lpMicUserClient;
    ...
    struct unique_ptr<ASDT::Exclaves::StatusTracker, std::default_delete<ASDT::Exclaves::StatusTracker>> { struct StatusTracker *__ptr_; } _exclavesStatusTracker;
}
