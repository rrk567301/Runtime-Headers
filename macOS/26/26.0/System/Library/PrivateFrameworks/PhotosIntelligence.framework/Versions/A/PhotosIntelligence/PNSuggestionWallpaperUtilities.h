...
+ (id)fetchFeaturedGyroPosterSuggestionsInPhotoLibrary:(id)a0 avoiding:(id)a1 limit:(id)a2;
...
+ (BOOL)setAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1;
+ (id)suggestionContextFromPersonLocalIdentifiers:(id)a0;
+ (id)wallpaperGalleryPosterTitleForSuggestion:(id)a0 withAsset:(id)a1;
...
+ (id)fetchLivePhotoTabHighlightCandidateAssetsWithOptions:(id)a0 excludeExistingWallpapers:(BOOL)a1 statistics:(struct { int x0; int x1; int x2; int x3; int x4; int x5; } *)a2;
+ (long long)primaryOrientation;
+ (id)settlingEffectAssetInternalSortDescriptors;
+ (id)settlingEffectLivePhotoPredicate;
+ (id)sortedDedupedCandidatesFromCandidates:(id)a0 sortDescriptors:(id)a1 timeIntervalForCandidateDeduping:(double)a2 targetNumberOfSuggestions:(unsigned long long)a3 maximumTimeIntervalReductionFactor:(unsigned long long)a4;
...
+ (id)_personNameForGalleryTitleFromSuggestion:(id)a0;
+ (id)_settlingEffectAssetFetchPropertySets;
+ (unsigned long long)_settlingEffectVideoDecisionForAsset:(id)a0;
+ (BOOL)_updateAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1 toClear:(BOOL)a2;
+ (id)bestWallpaperCropForAsset:(id)a0 classification:(unsigned long long)a1 layoutConfiguration:(id)a2 headroomFeasible:(BOOL)a3 withFaceRegions:(BOOL)a4;
...
+ (BOOL)clearAvailableFeatures:(unsigned long long)a0 forSuggestions:(id)a1;
...
+ (double)cropScoreWithAsset:(id)a0 classification:(unsigned long long)a1 passesClockOverlap:(BOOL *)a2 headroomEngaged:(BOOL *)a3 cropZoomRatio:(double *)a4 adaptiveHeadroom:(double *)a5 maxClockShift:(double *)a6 notificationRoom:(double *)a7 layoutVariant:(unsigned long long *)a8 orientation:(long long)a9 adaptiveCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a10 headroomFeasible:(BOOL)a11 withFaceRegions:(BOOL)a12;
+ (id)fetchFallbackMessagesBackdropSuggestionsInPhotoLibrary:(id)a0;
+ (id)fetchFeaturedGyroPosterSuggestionsFetchResultInPhotoLibrary:(id)a0 avoiding:(id)a1 limit:(id)a2;
+ (id)fetchGyroPosterSuggestionsInPhotoLibrary:(id)a0 limit:(id)a1;
...
+ (id)fetchPersonLocalIdentifiersForSuggestionSubtypes:(id)a0 photoLibrary:(id)a1;
+ (id)fetchRankedGyroPosterSuggestionsInPhotoLibrary:(id)a0 avoiding:(id)a1 limit:(id)a2;
+ (id)fetchSharedWithYouMessagesBackdropSuggestionsInPhotoLibrary:(id)a0;
+ (id)fetchWallpaperGallerySuggestionsInPhotoLibrary:(id)a0;
+ (id)filterMessagesBackdropSuggestions:(id)a0 fallback:(BOOL)a1;
+ (BOOL)hasAnyKnownPersonLocalIdentifierInPhotoLibrary:(id)a0;
+ (id)internalPredicateForSuggestionFetchExcludingAvailableFeatures:(unsigned long long)a0;
+ (id)internalPredicateForSuggestionFetchIncludingAvailableFeatures:(unsigned long long)a0;
+ (id)knownPersonLocalIdentifiersInPhotoLibrary:(id)a0;
+ (id)personLocalIdentifiersFromSuggestionContext:(id)a0;
...
+ (id)randomNumberGeneratorForWallpaperDonationWithDate:(id)a0;
...
+ (id)sortedDedupedCandidatesFromCandidates:(id)a0 sortDescriptors:(id)a1 timeIntervalForCandidateDeduping:(double)a2;
+ (id)wallpaperCroppingDebugKeyValuePairsForAsset:(id)a0;
+ (id)wallpaperCroppingDebugKeyValuePairsForAsset:(id)a0 withFaceRegions:(BOOL)a1 headroomFeasible:(BOOL)a2;
+ (BOOL)wallpaperDemoModeEnabled;
+ (id)wallpaperGalleryFeaturedPhotoSortedSuggestionsFromSuggestions:(id)a0;
+ (id)wallpaperGalleryPosterTitleFromPlaceNames:(id)a0 personName:(id)a1 isLocatedAtHome:(BOOL)a2;
+ (id)wallpaperGallerySmartAlbumSuggestionsFromSuggestions:(id)a0;
+ (id)wallpaperPeopleLocalIdentifiersInPhotoLibrary:(id)a0 vipOnly:(BOOL)a1;
