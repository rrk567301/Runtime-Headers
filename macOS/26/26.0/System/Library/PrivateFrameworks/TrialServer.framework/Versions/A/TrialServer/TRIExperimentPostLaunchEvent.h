...
+ (id)activatedEventWithExperimentRecord:(id)a0;
+ (id)allocationEventWithTriple:(id)a0 isDynamicEnrollment:(BOOL)a1 environment:(int)a2 namespaces:(id)a3;
...
+ (id)fetchedEventWithExperimentRecord:(id)a0;
