...
- (void)unknownCode:(unsigned int)a0 bytes:(const char *)a1 size:(long long)a2 context:(const char *)a3;
- (id)parseBookletItem:(const char *)a0 count:(long long)a1;
- (id)parseBookletListing:(const char *)a0 count:(long long)a1;
- (id)parseFlavor:(const char *)a0 size:(long long)a1;
- (id)parseFlavorListing:(const char *)a0 size:(long long)a1;
- (id)parseXMLContent:(const char *)a0 count:(long long)a1;
