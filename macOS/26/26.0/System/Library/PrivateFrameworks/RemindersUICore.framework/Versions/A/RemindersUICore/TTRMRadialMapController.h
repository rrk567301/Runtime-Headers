@class TTRMMapContainerView, _MKLocationShifter, TTRMMapDragRadiusView, MKMapView, CLCircularRegion, NSString, NSColor;
...
@property (retain) TTRMMapContainerView *mapContainerView;
