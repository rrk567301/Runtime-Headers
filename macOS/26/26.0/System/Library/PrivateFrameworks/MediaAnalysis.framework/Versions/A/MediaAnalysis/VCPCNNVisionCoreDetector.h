...
@interface VCPCNNVisionCoreDetector : NSObject {
    ...
    struct vector<espresso_buffer_t, std::allocator<espresso_buffer_t>> { struct *__begin_; struct *__end_; struct *__cap_; } _outputEspressoBuffers;
...
- (id)planExecutionandOutput:(struct vector<espresso_buffer_t, std::allocator<espresso_buffer_t>> { struct *x0; struct *x1; struct *x2; })a0 descriptor:(id)a1;
