@class MADSceneResources, VCPObjectPool, NSObject;
...
- (int)_collectSceneAnalysisResults:(id *)a0 fromRequests:(id)a1 wpResults:(id)a2 safetyNResults:(id)a3 safetyGVResults:(id)a4 abnormalDimension:(unsigned long long)a5;
