...
@property (nonatomic) struct vector<espresso_buffer_t, std::allocator<espresso_buffer_t>> { struct *__begin_; struct *__end_; struct *__cap_; } inputBlobs;
@property (nonatomic) struct vector<espresso_buffer_t, std::allocator<espresso_buffer_t>> { struct *__begin_; struct *__end_; struct *__cap_; } outputBlobs;
...
- (int)espressoForwardInputs:(struct vector<float *, std::allocator<float *>> { float **x0; float **x1; float **x2; })a0;
...
- (int)prepareModelInputs:(struct vector<float *, std::allocator<float *>> { float **x0; float **x1; float **x2; })a0;
