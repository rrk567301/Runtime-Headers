@interface RBTransitionEffect : NSObject {
    struct Effect { unsigned char type : 6; unsigned char has_animation : 1; unsigned char flags : 3; unsigned char events : 6; unsigned char begin_or_insert_animation : 8; unsigned char dur_or_remove_animation : 8; } _effect;
    union EffectOrArg { struct Effect { unsigned char type : 6; unsigned char has_animation : 1; unsigned char flags : 3; unsigned char events : 6; unsigned char begin_or_insert_animation : 8; unsigned char dur_or_remove_animation : 8; } effect; float arg; unsigned int int_arg; } _args[2];
}
