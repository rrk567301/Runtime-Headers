...
@property (readonly, nonatomic) unsigned long long layers;
...
- (id)initWithCalendar:(id)a0 dayNumber:(id)a1 monthName:(id)a2 canvasSize:(struct CGSize { double x0; double x1; })a3 canvasScale:(double)a4 layers:(unsigned long long)a5;
