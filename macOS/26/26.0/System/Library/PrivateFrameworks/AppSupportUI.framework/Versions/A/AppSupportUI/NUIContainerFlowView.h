@class __end_, NSString, __cap_, _NUIFlowContainer;
@protocol _NUIFlowArrangementContainer;

@interface NUIContainerFlowView : NUIContainerView <_NUIFlowArrangementContainer> {
    struct _NUIFlowArrangement { id<_NUIFlowArrangementContainer> container; unsigned char horzDist : 8; unsigned char vertDist : 8; BOOL baselineRelative; unsigned long long columns; double rowSpacing; double itemSpacing; double rowHeight; double itemWidth; struct vector<_NUIFlowArrangementCell, std::allocator<_NUIFlowArrangementCell>> { struct _NUIFlowArrangementCell *__begin_; struct _NUIFlowArrangementCell *__end_; struct _NUIFlowArrangementCell *__cap_; } cells; struct vector<_NUIFlowRowContainer *, std::allocator<_NUIFlowRowContainer *>> { __end_ **__begin_; __cap_ **x0; id *x1; } rows; _NUIFlowContainer *flowContainer; double measuredWidth; struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct CGRect *__cap_; } viewFrames; struct { double baseLineFromTop; double baseLineFromBottom; } maxBaseLinePair; } _arrangement;
