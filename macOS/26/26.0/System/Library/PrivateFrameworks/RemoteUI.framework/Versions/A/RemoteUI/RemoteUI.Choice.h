@interface RemoteUI.Choice : RemoteUI.RUIElement {
    void /* unknown type, empty encoding */ activityIndicatorCount;
    void /* unknown type, empty encoding */ urlLoadingParams;
    ...
    void /* unknown type, empty encoding */ buttonAlign;
    void /* unknown type, empty encoding */ destructive;
    void /* unknown type, empty encoding */ enabledFunctionName;
    void /* unknown type, empty encoding */ accessibilityInfo;
