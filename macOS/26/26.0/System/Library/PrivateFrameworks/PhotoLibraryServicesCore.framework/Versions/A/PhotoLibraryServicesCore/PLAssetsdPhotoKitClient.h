...
- (BOOL)cancelReservedCloudIdentifiers:(id)a0 error:(id *)a1;
- (BOOL)cancelReservedCloudIdentifiersWithEntityName:(id)a0 error:(id *)a1;
- (id)forceSyndicationIngestAsyncToDate:(id)a0 withCompletionHandler:(id /* block */)a1;
- (BOOL)forceSyndicationIngestSyncToDate:(id)a0 error:(id *)a1;
- (id)getUUIDsForAssetObjectIDs:(id)a0 filterPredicate:(id)a1 context:(id)a2 error:(id *)a3;
- (id)ingestItemWithCoreSpotlightUniqueIdentifier:(id)a0 bundleID:(id)a1 purgeUrgency:(long long)a2 error:(id *)a3;
- (id)photoLibraryIdentifierWithError:(id *)a0;
