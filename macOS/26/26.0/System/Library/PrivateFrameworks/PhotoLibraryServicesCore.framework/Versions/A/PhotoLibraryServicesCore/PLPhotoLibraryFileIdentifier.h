...
- (id)initWithAssetUuid:(id)a0 bundleScope:(unsigned short)a1 uti:(id)a2 resourceVersion:(unsigned int)a3 resourceType:(unsigned int)a4 recipeID:(unsigned int)a5 originalFilename:(id)a6 customSuffix:(id)a7;
