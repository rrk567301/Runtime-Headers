...
- (void)startDownloadAllowingCellular:(BOOL)a0 quality:(long long)a1 shouldMarkAsDeletedOnCancellationOrFailure:(BOOL)a2 prefer3DOrImmersiveDownload:(BOOL)a3 isAutomatic:(BOOL)a4 completion:(id /* block */)a5;
