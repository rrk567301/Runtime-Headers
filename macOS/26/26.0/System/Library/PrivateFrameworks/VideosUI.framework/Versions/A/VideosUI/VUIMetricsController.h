...
@interface VUIMetricsController : NSObject {
    ...
    BOOL _shouldRecordCachedAccount;
}
...
- (void)_handleLocationChange:(id)a0;
...
- (void)_recordEvent:(id)a0 withEventData:(id)a1 pageData:(id)a2;
- (void)_recordEventWithJet:(id)a0 withEventData:(id)a1 pageData:(id)a2;
...
- (BOOL)arePageEventsIdentical:(id)a0 previousPage:(id)a1;
...
- (void)recordClick:(id)a0 pageData:(id)a1;
- (void)recordDialog:(id)a0;
- (void)recordImpressions:(id)a0;
- (void)recordImpressions:(id)a0 pageData:(id)a1;
