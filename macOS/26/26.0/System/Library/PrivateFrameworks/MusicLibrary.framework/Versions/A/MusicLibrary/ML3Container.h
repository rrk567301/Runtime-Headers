...
+ (BOOL)deleteFromLibrary:(id)a0 deletionType:(int)a1 persistentIDs:(const long long *)a2 count:(unsigned long long)a3 preserveUndeletableEntities:(BOOL)a4;
...
+ (id)sagaIDTreeForPlaylistWithIdentifier:(long long)a0 inLibrary:(id)a1 includeUndeletablePlaylists:(BOOL)a2;
+ (id)sagaIDTreeForPlaylistWithIdentifier:(long long)a0 inLibrary:(id)a1 persistentIDsToIgnore:(id)a2;
...
+ (id)userUndeleteablePlaylistPersistentIDSInLibrary:(id)a0;
