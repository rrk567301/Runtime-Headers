...
+ (BOOL)_deleteRowsFromLibraryPinsTableForPersistentIDs:(const long long *)a0 count:(unsigned long long)a1 library:(id)a2 usingConnection:(id)a3;
...
+ (BOOL)deleteFromLibrary:(id)a0 deletionType:(int)a1 canonicalizeCollections:(BOOL)a2 persistentIDs:(const long long *)a3 count:(unsigned long long)a4 usingConnection:(id)a5;
...
+ (BOOL)setDifferentValues:(id)a0 forProperties:(id)a1 forEntityPersistentIDs:(id)a2 inLibrary:(id)a3 usingConnection:(id)a4;
