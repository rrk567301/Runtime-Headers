...
- (id)addContainersReturningResult:(id)a0;
- (id)addItemsReturningResult:(id)a0;
- (id)removeContainersReturningResult:(id)a0;
- (id)removeItemsReturningResult:(id)a0;
- (void)sessionDidUpdateProgress:(float)a0;
- (void)sessionFailedToAddContainer:(id)a0 completion:(id /* block */)a1;
- (void)sessionFailedToAddItem:(id)a0 completion:(id /* block */)a1;
- (void)sessionFailedToRemoveContainer:(id)a0 completion:(id /* block */)a1;
- (void)sessionFailedToRemoveItem:(id)a0 completion:(id /* block */)a1;
- (void)sessionFailedToUpdateContainer:(id)a0 completion:(id /* block */)a1;
- (void)sessionFailedToUpdateItem:(id)a0 completion:(id /* block */)a1;
- (id)updateContainersReturningResult:(id)a0;
