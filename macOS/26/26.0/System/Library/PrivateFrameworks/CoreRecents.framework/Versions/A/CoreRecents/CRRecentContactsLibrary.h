@class NSObject;
@protocol OS_dispatch_queue, CRRecentContactsLibraryAccess, CNScheduler;
...
+ (id)recentEventForEmailAddress:(id)a0 displayName:(id)a1 metadata:(id)a2;
+ (id)recentEventForPhoneNumber:(id)a0 displayName:(id)a1 metadata:(id)a2;
...
- (long long)countOfRecentContactsForQuery:(id)a0 error:(id *)a1;
...
- (void)recordAcceptedContactEvents:(id)a0 sendingAddress:(id)a1 source:(id)a2 completion:(id /* block */)a3;
...
- (id)restorePreviouslyDeletedRecentContacts:(id)a0 error:(out id *)a1;
