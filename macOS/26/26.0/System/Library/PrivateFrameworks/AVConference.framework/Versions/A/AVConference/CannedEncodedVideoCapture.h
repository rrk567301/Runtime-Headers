...
@property (readonly, nonatomic) BOOL shouldScaleAndPad;
...
- (id)initWithPath:(id)a0 shouldScaleAndPad:(BOOL)a1;
...
- (void)getFrameRate:(double *)a0 frameCount:(int *)a1 transformFlags:(unsigned int *)a2;
