@class VCWCMClient, VCRecommendedNetworkSettings, VCExperimentManager, VCConnectionManager, NSObject, WRMClient;
...
@interface VCNetworkFeedbackController : NSObject <WCMClientDelegate, WRMClientDelegate> {
    ...
    BOOL _isFastLQMReportingEnabled;
}
...
- (id)initWithDelegate:(id)a0 connectionManager:(id)a1 experimentManager:(id)a2;
...
- (void)setupWCMClient;
- (void)setupWRMClientWithMetricsConfig:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; })a0;
- (void)startWithMetricsConfig:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; })a0;
- (void)updateMetricsConfig:(struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; })a0;
