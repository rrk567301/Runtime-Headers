...
@interface VCAudioHALPluginDevice : ASDAudioDevice <VCAudioHALPluginCaptureSource> {
    ...
    struct VCAudioHALPluginTimestamp { unsigned long long numberOfSlots; struct vector<tagVCAudioHALPluginTimestampInfo, std::allocator<tagVCAudioHALPluginTimestampInfo> > { struct tagVCAudioHALPluginTimestampInfo *__begin_; struct tagVCAudioHALPluginTimestampInfo *__end_; struct tagVCAudioHALPluginTimestampInfo *__cap_; } timestamps; struct atomic<unsigned long> { struct __cxx_atomic_impl<unsigned long, std::__cxx_atomic_base_impl<unsigned long> > { _Atomic unsigned long long __a_value; } __a_; } timestampIndex; struct tagVCAudioHALPluginTimestampInfo { double sampleTime; unsigned long long hostTime; unsigned long long seed; } initLocklessTimestampInfo; } _timestamp;
