...
@property (nonatomic, getter=isFECEnabled) BOOL fecEnabled;
@property (nonatomic, getter=isRTXEnabled) BOOL rtxEnabled;
@property (nonatomic) BOOL shouldSendBlackFramesOnClearScreen;
@property (nonatomic, getter=isFoveationEnabled) BOOL foveationEnabled;
...
- (id)init;
- (id)dictionary;
- (void)encodeVideoBufferDescription:(id *)a0;
