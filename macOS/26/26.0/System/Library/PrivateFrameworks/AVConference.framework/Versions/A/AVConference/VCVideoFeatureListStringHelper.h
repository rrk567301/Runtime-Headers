...
+ (id)deriveAspectRatioFLSWithPortraitRatio:(struct CGSize { double x0; double x1; })a0 landscapeRatio:(struct CGSize { double x0; double x1; })a1 expectedPortraitRatio:(struct CGSize { double x0; double x1; })a2 expectedLandscapeRatio:(struct CGSize { double x0; double x1; })a3 expectedFullScreenRatios:(const struct tagVCAspectRatios { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a4;
...
+ (BOOL)extractExpectedAspectRatiosFromFeatureString:(const char *)a0 expectedFullScreenAspectRatios:(struct tagVCAspectRatios { struct CGSize { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a1;
...
+ (BOOL)isResizePIPSupportedInFeatureListString:(id)a0;
