...
@interface VCConnectionManager : NSObject <VCConnectionHealthMonitorDelegate, VCWifiAssistManagerDelegate, VCLinkProbingHandlerDelegate, VCCoreMotionManagerDelegate> {
    ...
    BOOL _disallowAlternateConnectionForRTXSupportWhenVideoDegraded;
...
@property (nonatomic, getter=isP2PEncryptionExperimentEnabled) BOOL p2pEncryptionExperimentEnabled;
...
- (void)copyPersistenPacketCounts:(unsigned int *)a0 isOutgoing:(BOOL)a1 size:(int)a2;
...
- (BOOL)hasSameReportingConfig:(id)a0 oldPrimaryConnection:(id)a1;
...
- (BOOL)localOrRemoteHasMultipleInterfaceAvailable:(id)a0 remoteInterface:(id)a1;
