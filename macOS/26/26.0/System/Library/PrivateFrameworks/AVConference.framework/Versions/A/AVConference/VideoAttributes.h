...
@property (nonatomic) struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } contentsRectForCALayer;
...
- (id)initWithCameraStatusBits:(unsigned char)a0 aspectRatio:(struct CGSize { double x0; double x1; })a1 contentsRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 scaleFactor:(float)a3 frameOrientationReference:(int)a4;
