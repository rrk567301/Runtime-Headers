@class VCMediaNegotiationBlobCaptionsSettings, NSString, VCMediaNegotiationBlobMediaEncryptionSettings, VCMediaNegotiationBlobAudioSettings, VCMediaNegotiationFaceTimeSettings, VCMediaNegotiationBlobMomentsSettings, NSMutableArray, VCMediaNegotiationBlobVideoSettings;
...
@property (readonly, nonatomic) BOOL hasEncryptionSettings;
