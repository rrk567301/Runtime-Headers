...
+ (id)defaultsForFTXTWithStreamIndex:(unsigned char)a0;
+ (id)defaultsForBDATWithStreamIndex:(unsigned char)a0;
...
+ (id)defaultsForBDATV2WithStreamIndex:(unsigned char)a0;
+ (id)defaultsForFTXTV2WithStreamIndex:(unsigned char)a0;
