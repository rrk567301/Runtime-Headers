...
@interface VCAudioStreamSendGroup : VCMediaStreamSendGroup <VCRedundancyControllerDelegate, VCAudioStreamGroup> {
    ...
    struct tagVCMemoryPool { struct { void *x0; long long x1; } x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; BOOL x4; } *_audioStreamUpdatePool;
    struct tagVCMemoryPool { struct { void *x0; long long x1; } x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; BOOL x4; } *_audioRedundancyEventPool;
    ...
    BOOL _shouldModulateSampleBufferTimestamp;
...
- (id)startCapture;
- (void)didStart;
- (void)updateOperatingMode:(int)a0;
...
- (void)redundancyController:(id)a0 redundancyVectorDidChange:(struct { unsigned short x0; struct { unsigned char x0; unsigned char x1; } x1[256]; })a1;
- (BOOL)removeSyncDestination:(id)a0;
- (void)reportOperatingMode:(int)a0;
...
- (BOOL)startCaptureIfNeeded:(BOOL)a0;
