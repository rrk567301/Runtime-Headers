@class VCReportingHistogram, VCReportingHistogram2D, VCVideoFECStatsHolder, VCDurationHistogram, NSString, VCDataMLEnhance, NSMutableDictionary, NSSet, NSMutableArray, NSNumber;
...
@property (retain) NSMutableArray *screenControlDurationsMsec;
@property (retain) NSMutableArray *screenShareDurationsMsec;
