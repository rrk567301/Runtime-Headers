...
- (void)dispatchedUpdateRoleModeTransport:(unsigned short)a0 deviceRole:(unsigned short)a1 transportType:(unsigned short)a2 isInitiator:(BOOL)a3 isWalkieTalkieMode:(BOOL)a4;
