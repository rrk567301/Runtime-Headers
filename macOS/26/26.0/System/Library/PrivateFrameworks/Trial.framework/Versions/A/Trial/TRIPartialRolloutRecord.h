...
+ (id)recordWithDeployment:(id)a0 rampId:(id)a1 activeFactorPackSetId:(id)a2 activeTargetingRuleIndex:(id)a3 targetedFactorPackSetId:(id)a4 targetedTargetingRuleIndex:(id)a5 status:(long long)a6 namespaces:(id)a7;

- (BOOL)isEqualToRecord:(id)a0;
- (id)copyWithReplacementStatus:(long long)a0;
- (id)initWithDeployment:(id)a0 rampId:(id)a1 activeFactorPackSetId:(id)a2 activeTargetingRuleIndex:(id)a3 targetedFactorPackSetId:(id)a4 targetedTargetingRuleIndex:(id)a5 status:(long long)a6 namespaces:(id)a7;
