...
- (void).cxx_destruct;
- (id)initWithiTunesStoreID:(id)a0 appIDs:(id)a1 associatedDomains:(id)a2 associatedDomainsEnableDirectDownloads:(id)a3 configurationProfile:(id)a4 declarations:(id)a5;
