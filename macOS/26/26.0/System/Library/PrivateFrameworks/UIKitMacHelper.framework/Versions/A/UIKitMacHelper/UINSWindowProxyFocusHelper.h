...
- (void)_updateIfUIKitFirstResponderChanged;
- (void)_updateIfUIKitKeyWindowChanged;
- (void)_updateIfUIKitKeyWindowOrFirstResponderChanged:(BOOL)a0;
...
- (void)updateIfUIKitFirstResponderChanged;
- (void)updateIfUIKitKeyWindowChanged;
