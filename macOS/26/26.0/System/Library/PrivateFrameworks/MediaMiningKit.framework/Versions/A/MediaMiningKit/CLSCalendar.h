...
+ (id)_calendarForIdentifier:(id)a0;
+ (long long)compareDate:(id)a0 toDate:(id)a1 toUnitGranularities:(unsigned long long)a2;
+ (id)components:(unsigned long long)a0 fromDate:(id)a1 withCalendarIdentifier:(id)a2;
+ (id)componentsFromDate:(id)a0 inTimeZone:(id)a1;
+ (long long)countOfWeekday:(long long)a0 inMonthOfDate:(id)a1 withCalendarIdentifier:(id)a2;
+ (id)currentLocalDate;
+ (BOOL)currentLocaleSupportsSeasons;
+ (id)dateByAddingDays:(long long)a0 toDate:(id)a1;
+ (id)dateByAddingDays:(long long)a0 toDate:(id)a1 withCalendarIdentifier:(id)a2;
...
+ (id)dateByAddingYears:(long long)a0 toDate:(id)a1 withCalendarIdentifier:(id)a2;
...
+ (id)dateFromComponents:(id)a0 inTimeZone:(id)a1 withCalendarIdentifier:(id)a2;
...
+ (BOOL)isLeapYearForDate:(id)a0 withCalendarIdentifier:(id)a1;
...
+ (long long)monthFromDate:(id)a0 withCalendarIdentifier:(id)a1;
+ (id)northernMeteorologicalSeasonNameForDateComponents:(id)a0;
+ (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfUnit:(unsigned long long)a0 inUnit:(unsigned long long)a1 forDate:(id)a2 withCalendarIdentifier:(id)a3;
...
+ (long long)yearFromDate:(id)a0 withCalendarIdentifier:(id)a1;
