@class NSString, NSArray, NSURL, SSRLoggingAggregator, SecureAsset, SSRVoiceProfile, NSDictionary, CSAsset;
...
- (id)initWithVoiceRetrainingContext:(id)a0 skipClassTypeValidate:(BOOL)a1 error:(id *)a2;
