...
+ (id)createAVAudioPCMBufferWithNSData:(id)a0 audioFormat:(unsigned long long)a1 sampleRate:(float)a2 numOfChannel:(unsigned int)a3 isInterleaved:(BOOL)a4;
+ (id)createDirectoryIfDoesNotExist:(id)a0;
...
+ (BOOL)needProfileEmbeddingsForDarwin;
