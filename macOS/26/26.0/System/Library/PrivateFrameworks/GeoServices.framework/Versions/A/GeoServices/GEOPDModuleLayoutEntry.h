...
@interface GEOPDModuleLayoutEntry : PBCodable <NSCopying> {
    ...
    int _platformType;
    int _renderingMode;
    struct { unsigned char has_platformType : 1; unsigned char has_renderingMode : 1; unsigned char read_unknownFields : 1; unsigned char read_applicationIds : 1; unsigned char read_debugLayoutId : 1; unsigned char read_modules : 1; unsigned char wrote_anyField : 1; } _flags;
}
