...
@interface GEOAutomobileOptions : PBCodable <NSCopying> {
    ...
    BOOL _optoutIncidentReporting;
    struct { unsigned char has_trafficType : 1; unsigned char has_includeHistoricTravelTime : 1; unsigned char has_includeStaticTravelTime : 1; unsigned char has_optoutIncidentReporting : 1; unsigned char read_unknownFields : 1; unsigned char read_userPreferences : 1; unsigned char read_vehicleSpecifications : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (nonatomic) BOOL hasOptoutIncidentReporting;
@property (nonatomic) BOOL optoutIncidentReporting;
