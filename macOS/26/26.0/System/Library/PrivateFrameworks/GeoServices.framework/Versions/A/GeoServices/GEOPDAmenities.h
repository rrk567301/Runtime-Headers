...
@interface GEOPDAmenities : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_expandThreshold : 1; unsigned char read_unknownFields : 1; unsigned char read_amenityV2s : 1; unsigned char read_amenitys : 1; unsigned char wrote_anyField : 1; } _flags;
}

@property (retain, nonatomic) NSMutableArray *amenitys;
@property (retain, nonatomic) NSMutableArray *amenityV2s;
@property (nonatomic) BOOL hasExpandThreshold;
