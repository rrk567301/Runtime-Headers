...
@interface GEOPBTransitArtwork : PBCodable <GEOTransitArtworkDataSource, NSCopying> {
    ...
    int _artworkUse;
    int _badge;
    struct { unsigned char has_artworkType : 1; unsigned char has_artworkUse : 1; unsigned char has_badge : 1; unsigned char read_unknownFields : 1; unsigned char read_accessibilityString : 1; unsigned char read_appleAccountAvatarFallbackSfSymbol : 1; unsigned char read_iconFallbackShield : 1; unsigned char read_icon : 1; unsigned char read_sfSymbol : 1; unsigned char read_shield : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (readonly, nonatomic) BOOL hasSfSymbol;
@property (retain, nonatomic) GEOSFSymbol *sfSymbol;
@property (readonly, nonatomic) BOOL hasAppleAccountAvatarFallbackSfSymbol;
