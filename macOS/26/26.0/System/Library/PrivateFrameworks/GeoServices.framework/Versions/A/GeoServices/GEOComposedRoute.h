...
@property (readonly, nonatomic) BOOL isFamiliarRoute;
...
- (void)_initCommuteNotificationStrings:(id)a0;
...
- (double)distanceForRange:(struct GEOPolylineCoordinateRange { struct { unsigned int x0; float x1; } x0; struct { unsigned int x0; float x1; } x1; })a0;
...
- (void)enumerateCellCoverageRangesWithBlock:(id /* block */)a0;
...
- (double)travelDurationForRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a0 etaRoute:(id)a1;
