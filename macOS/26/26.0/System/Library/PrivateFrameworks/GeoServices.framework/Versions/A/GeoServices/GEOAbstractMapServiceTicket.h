@class GEODirectionIntent, GEOMapServiceTraits, GEOMapRegion, GEOMIFAutocompleteRequestParameters, GEOGuideSummaryLayoutMetadata, GEOMapItemIdentifier, GEOPDMerchantLookupResult, NSString, GEOResultRefinementGroup, GEOSearchRedoButtonThreshold, GEOPDPlaceSummaryLayoutMetadata, GEORelatedSearchSuggestion, GEOResolvedItem, NSArray, GEOSearchAutoRedoThreshold, GEOCategorySearchResultSection, GEOSearchSectionList, GEOSearchSessionData;
...
- (void)submitWithAuditToken:(id)a0 completionHandler:(id /* block */)a1;
- (void)submitWithAuditToken:(id)a0 timeout:(double)a1 completionHandler:(id /* block */)a2;
...
- (void)submitWithTimeout:(double)a0 completionHandler:(id /* block */)a1;
