@class GEORecentLocationHistory, GEOPDABClientDatasetMetadata, PBUnknownFields, GEOLocation, NSMutableArray, NSString, GEOClientCapabilities, GEOPrivacyMetadata, GEOWalkingOptions, GEOAdditionalEnabledMarkets, GEOTransitOptions, GEOFamiliarWaypointRoute, GEOCyclingOptions, NSData, PBDataReader, GEOWaypoint, GEOWaypointTyped, GEOOriginalWaypointRoute, GEOAutomobileOptions, GEOPathComputationOptions, GEOCommonOptions;
...
@interface GEOETARequest : PBRequest <NSCopying> {
    ...
    BOOL _isFromAPI;
    struct { unsigned char has_timepoint : 1; unsigned char has_sessionID : 1; unsigned char has_sessionRelativeTimestamp : 1; unsigned char has_trafficSnapshotUnixTime : 1; unsigned char has_transportType : 1; unsigned char has_walkingLimitMeters : 1; unsigned char has_allowPartialResults : 1; unsigned char has_includeDistance : 1; unsigned char has_includeHistoricTravelTime : 1; unsigned char has_includeEtaRouteIncidents : 1; unsigned char has_includeRouteTrafficDetail : 1; unsigned char has_includeShortTrafficSummary : 1; unsigned char has_isFromAPI : 1; unsigned char read_unknownFields : 1; unsigned char read_abClientMetadata : 1; unsigned char read_additionalEnabledMarkets : 1; unsigned char read_automobileOptions : 1; unsigned char read_clientCapabilities : 1; unsigned char read_commonOptions : 1; unsigned char read_cyclingOptions : 1; unsigned char read_destinationWaypointTypeds : 1; unsigned char read_destinations : 1; unsigned char read_deviceHistoricalLocations : 1; unsigned char read_familiarWaypointRoute : 1; unsigned char read_intermediateWaypointTypeds : 1; unsigned char read_lastKnownRoadLocation : 1; unsigned char read_originWaypointTyped : 1; unsigned char read_originalRouteID : 1; unsigned char read_originalRouteZilchPoints : 1; unsigned char read_originalWaypointRoute : 1; unsigned char read_origin : 1; unsigned char read_pathComputationOptions : 1; unsigned char read_phoneticLocaleIdentifier : 1; unsigned char read_privacyMetadata : 1; unsigned char read_recentLocationHistory : 1; unsigned char read_requestingAppId : 1; unsigned char read_serviceTags : 1; unsigned char read_sessionState : 1; unsigned char read_trafficApiResponses : 1; unsigned char read_trafficSnapshotIds : 1; unsigned char read_transitOptions : 1; unsigned char read_walkingOptions : 1; unsigned char wrote_anyField : 1; } _flags;
}
