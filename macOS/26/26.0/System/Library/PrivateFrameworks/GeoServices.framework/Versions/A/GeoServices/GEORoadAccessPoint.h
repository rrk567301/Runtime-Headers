...
@interface GEORoadAccessPoint : PBCodable <NSCopying> {
    ...
    BOOL _isApproximate;
    struct { unsigned char has_cyclingDirection : 1; unsigned char has_distanceCm : 1; unsigned char has_drivingDirection : 1; unsigned char has_parkingDirection : 1; unsigned char has_significance : 1; unsigned char has_source : 1; unsigned char has_transitDirection : 1; unsigned char has_walkingDirection : 1; unsigned char has_isApproximate : 1; } _flags;
}
