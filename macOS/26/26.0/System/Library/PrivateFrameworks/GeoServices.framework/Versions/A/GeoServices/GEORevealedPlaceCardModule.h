@class GEORevealedPlaceCardModuleTypeInfos, GEORevealedPlaceCardModuleTypeTitle, GEORevealedPlaceCardModuleTypeUnifiedActionRow, PBDataReader, GEORevealedPlaceCardModuleTypePhotos, PBUnknownFields, GEORevealedPlaceCardModuleTypeHours, GEORevealedPlaceCardModuleTypeActionBar, GEORevealedPlaceCardModuleTypeShowcase;
...
@interface GEORevealedPlaceCardModule : PBCodable <NSCopying> {
    ...
    int _type;
    struct { unsigned char has_type : 1; unsigned char read_unknownFields : 1; unsigned char read_actionBar : 1; unsigned char read_hours : 1; unsigned char read_infos : 1; unsigned char read_photos : 1; unsigned char read_showcase : 1; unsigned char read_title : 1; unsigned char read_unifiedActionRow : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (readonly, nonatomic) BOOL hasActionBar;
