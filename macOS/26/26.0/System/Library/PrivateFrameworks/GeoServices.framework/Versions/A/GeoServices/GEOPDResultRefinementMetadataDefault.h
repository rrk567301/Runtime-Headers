...
@interface GEOPDResultRefinementMetadataDefault : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_refinementMetadataDefaultType : 1; unsigned char has_selectionBasedPosition : 1; unsigned char has_selectionFromQuerySequenceNumber : 1; unsigned char has_selectionFromQuery : 1; unsigned char read_unknownFields : 1; unsigned char read_refinementKey : 1; unsigned char read_refinementValueMetadata : 1; unsigned char read_refinementValue : 1; unsigned char wrote_anyField : 1; } _flags;
}
