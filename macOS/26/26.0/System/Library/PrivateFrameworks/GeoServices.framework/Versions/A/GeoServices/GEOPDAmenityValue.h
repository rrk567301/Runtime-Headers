...
@interface GEOPDAmenityValue : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_amenityType : 1; unsigned char has_amenityPresent : 1; unsigned char read_unknownFields : 1; unsigned char read_amenityId : 1; unsigned char read_names : 1; unsigned char read_ribbonSymbolImageName : 1; unsigned char read_symbolImageName : 1; unsigned char read_vendorId : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (readonly, nonatomic) BOOL hasRibbonSymbolImageName;
