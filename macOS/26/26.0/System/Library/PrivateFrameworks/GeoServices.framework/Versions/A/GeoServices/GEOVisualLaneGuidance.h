...
@interface GEOVisualLaneGuidance : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_endSegmentIndex : 1; unsigned char read_unknownFields : 1; unsigned char read_instructions : 1; unsigned char read_laneInfos : 1; unsigned char read_titles : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (nonatomic) BOOL hasEndSegmentIndex;
