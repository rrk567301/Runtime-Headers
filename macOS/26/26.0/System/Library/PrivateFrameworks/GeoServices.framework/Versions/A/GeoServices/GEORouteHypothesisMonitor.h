@class GEOETAUpdater, GEOMapRegion, GEODirectionsServiceRequest, GEOLocation, NSMutableArray, NSString, GEOComposedWaypoint, GEORouteMatch, GEODirectionsRequestFeedback, GEORouteHypothesizerAnalyticsStore, NSObject, geo_isolater, GEORouteAttributes, NSData, GEOComposedETARoute, GEORouteHypothesis, GEOComposedRoute, GEONavdClientInfo, GEOCommonOptions, GEOMapServiceTraits, NSDate;
@protocol OS_dispatch_group, GEODirectionsServiceFamiliarRouteProvider;
...
- (void)_receivedRoute:(id)a0 forLocation:(id)a1 isReroute:(BOOL)a2 familiarRoute:(id)a3;
- (void)_requestNewRouteFromLocation:(id)a0 usualRouteData:(id)a1;
- (void)_routeRequestFailed:(id)a0 directionsError:(id)a1;
...
- (void)updateLocation:(id)a0 allowServer:(BOOL)a1 familiarRouteProvider:(id)a2 hypothesisHandler:(id /* block */)a3;
