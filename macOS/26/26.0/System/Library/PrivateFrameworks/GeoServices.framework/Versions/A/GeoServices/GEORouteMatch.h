@class GEOComposedTransitStationRouteStep, NSDate, GEOComposedRouteStep, GEOComposedRouteLeg, GEOComposedTransitTripRouteStep, GEOComposedRouteSegment, GEOComposedRoute, GEOMapFeatureRoad, NSArray, GEOMatchedPathSegment, GEONavigationMatchInfo, NSUUID;
