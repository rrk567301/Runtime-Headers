...
@interface GEOPDSearchQueryIntentMetadata : PBCodable <NSCopying> {
    ...
    BOOL _isPartiallyResolved;
    struct { unsigned char has_queryIntentWeight : 1; unsigned char has_rewrittenQueryIndex : 1; unsigned char has_isFromDefinitiveQu : 1; unsigned char has_isFromKnowledgeGraph : 1; unsigned char has_isFromSearchQu : 1; unsigned char has_isPartiallyResolved : 1; unsigned char read_intentSources : 1; unsigned char read_rewrittenQueryTypes : 1; unsigned char read_acHintMetadata : 1; unsigned char read_geoTokenImportanceMetadata : 1; unsigned char read_originalQuery : 1; unsigned char read_queryClassificationMetadatas : 1; unsigned char read_queryCompletionMetadata : 1; unsigned char read_queryCtrMetadata : 1; unsigned char read_queryDirectionsIntentMetadata : 1; unsigned char read_queryDymMetadata : 1; unsigned char read_queryEmbeddingMetadatas : 1; unsigned char read_queryFuzzyMatchV2Metadata : 1; unsigned char read_queryGeoMetadata : 1; unsigned char read_queryGeoNormalizerMetadata : 1; unsigned char read_queryGeoTagMetadata : 1; unsigned char read_queryInterpretationMetadata : 1; unsigned char read_queryNeuralRewriteMetadata : 1; unsigned char read_queryNeuralSegmentMetadata : 1; unsigned char read_queryNormalizerMetadata : 1; unsigned char read_queryPoiMetadata : 1; unsigned char read_querySpellCorrectionMetadata : 1; unsigned char read_querySynonymMetadata : 1; unsigned char read_queryTagMetadata : 1; unsigned char read_queryTokenImportanceMetadata : 1; unsigned char read_queryTokenizerMetadata : 1; unsigned char read_queryTransliterMetadata : 1; unsigned char read_rawQueryTokenizerMetadata : 1; unsigned char read_rewrittenQuery : 1; unsigned char read_richBrandMetadata : 1; unsigned char read_tokenSynonymMetadata : 1; unsigned char wrote_anyField : 1; } _flags;
}
