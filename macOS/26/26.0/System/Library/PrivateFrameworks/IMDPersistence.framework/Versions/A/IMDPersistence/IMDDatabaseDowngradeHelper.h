...
- (BOOL)splitMergedChatsUsingConnection:(struct CSDBSqliteConnection { struct CSDBSqliteDatabase *x0; struct sqlite3 *x1; struct __CFDictionary *x2; void *x3; void /* function */ *x4; unsigned int x5; void *x6; } *)a0 error:(id *)a1;
