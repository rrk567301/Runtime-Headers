@class NSURL, NSMutableDictionary, NSDate, NSDictionary, LSApplicationProxy, PRSRankingItem, IQFMapsPersonalizationResult, NSImage, NSString, SFRichText, NSArray, NSData, NSNumber, UTType;
@protocol NSPasteboardWriting;

@interface SFSearchResult_SpotlightExtras : SFSearchResult <QLSeamlessOpenerDelegate, NSSecureCoding> {
    unsigned long long _matchBits;
    BOOL _lastRestrictionStatus;
    BOOL _needsPreviewUpdate;
    UTType *_uniformContentType;
    BOOL _uniformContentTypeUnavailable;
}
...
@property (retain, nonatomic) NSString *counterpartBundleIdentifier;
...
@property (readonly) NSDate *contentCreationDate;
@property BOOL isFolderQuery;
@property BOOL isFromOneness;
...
@property (nonatomic) BOOL isFileProviderServerResult;
@property (nonatomic) BOOL isTemplateAppResult;
@property (retain, nonatomic) NSArray *answerAttributes;
@property (retain, nonatomic) NSString *blendingCacheUUID;
