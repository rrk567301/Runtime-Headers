@class ATXSearchFeedbackListener, NSString, PARSession, SIFeedbackListener, NSObject;
...
- (void)sendFeedback:(id)a0 selector:(SEL)a1;
...
- (void)sendFeedback:(id)a0 selector:(SEL)a1 queryId:(unsigned long long)a2;
- (void).cxx_destruct;
