@class NSArray, NSDictionary, NSData, NSString, SFTopic, SFCommandReference;

@interface SSDeleteCoreSpotlightItemsCommand : SFCommand <SSDeleteCoreSpotlightItemsCommand, NSSecureCoding, NSCopying>
