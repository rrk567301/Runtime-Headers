...
@property (readonly, nonatomic) BOOL hasInsertedSocialGroupNodes;
@property (readonly, nonatomic) BOOL hasDeletedSocialGroupNodes;
@property (readonly, nonatomic) BOOL hasUpdatedSocialGroupNodes;
...
@property (readonly, nonatomic) BOOL hasSocialGroupsToInsert;
@property (readonly, nonatomic) BOOL hasSocialGroupsToDelete;
@property (readonly, nonatomic) BOOL hasSocialGroupsToUpdate;
...
- (id)uuidsOfMomentsToUpdateForMomentUpdateTypes:(unsigned long long)a0;
- (void)_consolidate;
