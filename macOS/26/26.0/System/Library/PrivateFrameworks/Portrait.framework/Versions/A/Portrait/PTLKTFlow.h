...
- (int)_computeFeatures:(id)a0 in_tex:(id)a1 out_tex:(id)a2;
- (int)_computeFeaturesDerivatives:(id)a0 in_tex:(id)a1 out_tex:(id)a2;
...
- (int)_createImagePyramid:(id)a0 in_tex:(id)a1 I_idx:(int)a2;
- (int)_doNLRegularization:(id)a0 in_uv_tex:(id)a1 join_tex:(id)a2 w_tex:(id)a3 out_uv_tex:(id)a4;
- (int)_doSolver:(id)a0 scale:(int)a1 in_uv_tex:(id)a2 in_G0_tex:(id)a3 in_G1_tex:(id)a4 in_C0_tex:(id)a5 in_C1_tex:(id)a6 out_uv_tex:(id)a7 out_w_tex:(id)a8;
- (int)_downscale2X:(id)a0 in_tex:(id)a1 out_tex:(id)a2;
- (int)_enqueueFlowConsistency:(id)a0 in_uv0_tex:(id)a1 in_uv1_tex:(id)a2 out_uv_tex:(id)a3;
- (int)_enqueueKeypointsFromFlow:(id)a0 in_uv_fwd_tex:(id)a1 in_uv_bwd_tex:(id)a2 out_kpt_buf:(id)a3 block_size:(int)a4 bidirectional_error:(float)a5 out_num_keypoints:(unsigned short *)a6;
- (int)_initMemory:(int)a0 height:(int)a1 nscales:(int)a2;
- (int)_setupBuffer:(id)a0;
- (int)_setupPipelines:(id)a0;
- (int)_zeroFlow:(id)a0 uv_tex:(id)a1;
...
- (id)newBufferWithPixelFormat:(unsigned long long)a0 width:(int)a1 data:(const void *)a2 metalContext:(id)a3;
