@class PTMetalContext, PTLKTFlow;
...
- (id)initWithMetalContext:(id)a0 colorSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a1 lktPreset:(long long)a2 allocateDisplacementFWD:(BOOL)a3 needConversionBGRA2YUVA:(BOOL)a4 inverseFlow:(BOOL)a5;
