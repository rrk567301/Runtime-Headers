...
@interface PXBrowserSummaryController : PXObservable <PXMutableBrowserSummaryController, PXInfoUpdaterObserver, PXInfoProvider> {
    struct { BOOL containerTitle; BOOL containerFallbackTitle; BOOL localizedContainerItemsCount; BOOL containerDateInterval; BOOL selectionSnapshot; BOOL filteringContainerContent; BOOL attributedPrimaryTitle; BOOL attributedPrimaryFallbackTitle; BOOL secondaryTitle; BOOL tertiaryTitle; BOOL navigationTitle; BOOL attributedSelectionTitle; BOOL stackedAssets; } _needsUpdateFlags;
    struct { BOOL containerTitle; BOOL containerFallbackTitle; BOOL localizedContainerItemsCount; BOOL containerDateInterval; BOOL visibleContentSnapshot; BOOL selectionSnapshot; BOOL filteringContainerContent; BOOL useAssetImportDate; BOOL shouldUpdateImmediately; } _dataSourceRespondsTo;
}
...
- (void)_setAttributedPrimaryFallbackTitle:(id)a0 accessibilityIdentifier:(id)a1;
