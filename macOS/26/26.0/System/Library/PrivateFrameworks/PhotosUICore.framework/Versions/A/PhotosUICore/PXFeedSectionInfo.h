@class NSDate, NSString, NSArray, NSOrderedSet, PHPhotoLibrary, PHAssetCollection, PLCloudFeedEntry, PXSharedAlbumParticipant, NSCountedSet, NSIndexSet;
...
+ (id)sectionInfoWithCloudFeedEntry:(id)a0 inPhotoLibrary:(id)a1;
...
- (id)initWithCloudFeedEntry:(id)a0 photoLibrary:(id)a1;
