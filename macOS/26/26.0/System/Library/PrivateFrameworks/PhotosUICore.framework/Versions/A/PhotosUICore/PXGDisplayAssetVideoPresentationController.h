...
- (void)becomeVisible:(BOOL)a0;
- (void)fetchShouldDisplayPreviousNonnullPixelBuffer:(id /* block */)a0;
...
- (void)requestPixelBufferSourceForMediaProvider:(id)a0 isVisible:(BOOL)a1 stillActive:(id /* block */)a2 completion:(id /* block */)a3;
- (void)requestPlayerViewForMediaProvider:(id)a0 isVisible:(BOOL)a1 stillActive:(id /* block */)a2 completion:(id /* block */)a3;
