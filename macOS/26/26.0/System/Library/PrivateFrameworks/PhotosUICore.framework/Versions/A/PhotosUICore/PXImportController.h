...
- (void)loadAssets;
- (id)pauseChangeDeliveryForImportAssetsDataSourceManager:(id)a0 withTimeout:(double)a1 identifier:(id)a2;
- (void)performChangesOnMainQueue:(id /* block */)a0;
- (void)removeDataSourceManager:(id)a0;
- (void)restartTimedAssetsLoadingPowerAssertion;
- (void)resumeChangeDeliveryAndBackgroundLoadingForImportAssetsDataSourceManager:(id)a0 token:(id)a1;
