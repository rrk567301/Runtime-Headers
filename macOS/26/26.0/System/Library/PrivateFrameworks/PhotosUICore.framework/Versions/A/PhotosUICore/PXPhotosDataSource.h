...
@protocol OS_dispatch_group, OS_os_log, PXAssetsDataSourceContainer, OS_dispatch_queue;
...
@property (nonatomic) BOOL hasAnyAllowedUUIDs;
...
- (id)_fetcherConfigurationForAssetCollection:(id)a0 useCase:(long long)a1 isLimitedInitialFetch:(BOOL)a2;
...
- (BOOL)_isFiltering;
- (BOOL)_isResultTupleApplicable:(id)a0 forAssetCollection:(id)a1;
...
- (id)createDataSourceWithAssetsInSectionOfAsset:(id)a0 usingNewTransientAssetCollection:(BOOL)a1;
