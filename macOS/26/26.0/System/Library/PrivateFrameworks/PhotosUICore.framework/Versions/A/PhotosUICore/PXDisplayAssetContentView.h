@class UXView, NSError, NSArray, PXRegionOfInterest, NSString, PXUIMediaProvider, PXImageRequester, PXDisplayScreenDynamicRangeMonitor, NSImage, PXReusableObjectPool, NSObject, PXDisplayAssetViewModel;
