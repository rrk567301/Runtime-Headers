...
@protocol PXDisplayCollection, PXFastEnumeration, PXAssetsDataSourceContainer, PXDisplayCollectionFetcher;
...
@property (readonly, nonatomic) BOOL containsSensitiveAssets;
...
- (id)selectedObjectsOrContainerOfClass:(Class)a0;
- (BOOL)shouldCheckAssetSensitivity;
