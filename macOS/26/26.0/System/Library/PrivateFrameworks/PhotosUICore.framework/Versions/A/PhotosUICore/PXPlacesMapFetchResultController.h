@class NSString, PXPlacesPhotoAssetsStore, PXPlacesMapPipeline, PXPlacesMapThumbnailLocationCurator, PHPhotoLibrary, PXPlacesMapController, NSObject, PXLibraryFilterState, PXPlacesMapViewController, PXPlacesMapView;
...
- (id)initWithMapViewController:(id)a0 libraryFilterState:(id)a1 photoLibrary:(id)a2;
