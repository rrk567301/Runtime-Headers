@class UXView, AVVideoComposition, PXTrimScrubberLayoutHelper, NSArray, PXExtendedTraitCollection, PXLivePhotoTrimScrubberLoupeView, NURenderContext, NSImage, PXLivePhotoTrimScrubberHiddenAnimationHelper, UXImageView, PXLivePhotoTrimScrubberSpec, AVAsset;
...
- (void)setDisabled:(BOOL)a0 useTransparency:(BOOL)a1;
