@class NSString, PXPhotoKitAssetsDataSource, NSPredicate, NSArray, PHPhotoLibrary, PXPhotosDataSource, NSObject, NSNumber, PXContentSyndicationConfigurationProvider;
...
+ (BOOL)_shouldIncludeSharedCollectionAssetsForAssetCollection:(id)a0;
