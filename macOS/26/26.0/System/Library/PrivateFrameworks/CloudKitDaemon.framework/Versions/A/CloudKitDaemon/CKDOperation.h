...
+ (BOOL)finishWithCallbackProxy:(id)a0 assetDownloadStagingInfo:(id)a1 fileURL:(id *)a2 fileHandle:(id *)a3 error:(id *)a4;
+ (id)openFileWithCallbackProxy:(id)a0 openInfo:(id)a1 error:(id *)a2;
...
- (id)_stateFlags;
- (void)applyCloudCoreSessionValidityErrorUnitTestOverridesWithKey:(id)a0;
