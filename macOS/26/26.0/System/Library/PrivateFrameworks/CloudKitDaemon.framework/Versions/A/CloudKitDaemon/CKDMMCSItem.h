@class NSURL, NSFileHandle, CKAssetDownloadPreauthorization, NSDictionary, CKDMMCSItemCommandWriter, CKConcretePackage, CKAsset, NSMutableArray, CKDAssetZoneKey, NSString, CKRecordID, NSNumber, NSData, NSError;
