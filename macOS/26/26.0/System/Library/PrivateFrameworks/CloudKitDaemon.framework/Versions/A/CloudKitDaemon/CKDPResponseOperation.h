...
@interface CKDPResponseOperation : PBCodable <NSCopying> {
    ...
    CKDPZoneChildrenRetrieveResponse *_zoneChildrenRetrieveResponse;
...
@property (readonly, nonatomic) BOOL hasZoneChildrenRetrieveResponse;
@property (retain, nonatomic) CKDPZoneChildrenRetrieveResponse *zoneChildrenRetrieveResponse;
