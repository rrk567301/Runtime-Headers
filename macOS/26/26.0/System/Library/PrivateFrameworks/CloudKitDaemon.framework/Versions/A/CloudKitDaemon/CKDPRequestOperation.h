...
@interface CKDPRequestOperation : PBCodable <NSCopying> {
    ...
    CKDPZoneChildrenRetrieveRequest *_zoneChildrenRetrieveRequest;
...
@property (readonly, nonatomic) BOOL hasZoneChildrenRetrieveRequest;
@property (retain, nonatomic) CKDPZoneChildrenRetrieveRequest *zoneChildrenRetrieveRequest;
