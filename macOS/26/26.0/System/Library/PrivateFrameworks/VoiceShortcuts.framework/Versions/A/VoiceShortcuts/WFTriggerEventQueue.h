...
+ (double)rateLimitingTimeoutForTrigger:(id)a0 runEvents:(id)a1 numFailures:(unsigned long long)a2;
...
- (void)deactivateEphemeralTriggerIfNeeded:(id)a0 completion:(id /* block */)a1;
...
- (id)initWithDatabaseProvider:(id)a0 notificationManager:(id)a1 notificationScheduler:(id)a2;
- (id)initWithDatabaseProvider:(id)a0 notificationManager:(id)a1 notificationScheduler:(id)a2 triggerBootManager:(id)a3;
- (BOOL)isPossiblyInLoopForTrigger:(id)a0;
...
- (void)notificationManager:(id)a0 didFailToPostActionRequiredNotificationWithTriggerIdentifier:(id)a1 pendingTriggerEventIDs:(id)a2;
...
- (void)notificationManager:(id)a0 receivedContinuePotentialLoopForTriggerWithIdentifier:(id)a1 pendingTriggerEventIDs:(id)a2;
- (void)notificationManager:(id)a0 receivedStopPotentialLoopForTriggerWithIdentifier:(id)a1;
...
- (void)sendRateLimitEncounteredNotificationForTrigger:(id)a0;
- (void)setConfirmedForTriggerEventIDs:(id)a0 error:(id *)a1;
- (void)setPausedForTriggerEventIDs:(id)a0 paused:(BOOL)a1 error:(id *)a2;
...
- (id)triggerEventForConfiguredTrigger:(id)a0 eventInfo:(id)a1 confirmed:(BOOL)a2 paused:(BOOL)a3 error:(id *)a4;
