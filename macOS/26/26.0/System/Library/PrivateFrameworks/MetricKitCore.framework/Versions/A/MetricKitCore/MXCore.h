...
- (void)_deliverSamplePayloadForXcodeClient:(id)a0;
- (id)_getDailyActivityCriteria;
- (id)_getSampleDiagnosticPayloadForClient:(id)a0 dateString:(id)a1;
- (id)_getSamplePayloadForClient:(id)a0 dateString:(id)a1;
- (void)_initIvar;
- (void)_initLogHandle;
- (void)_initQueue;
...
- (void)deliverSamplePayloadForXcodeClient:(id)a0;
