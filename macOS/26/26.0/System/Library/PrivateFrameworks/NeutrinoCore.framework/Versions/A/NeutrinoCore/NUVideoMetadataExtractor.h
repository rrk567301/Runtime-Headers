...
- (struct CGPoint { double x0; double x1; })opticalCenterFromMetadata:(const struct { unsigned short x0; float x1[9]; unsigned long long x2; unsigned long long x3; unsigned char x4; char x5; unsigned char x6; char x7[13]; } *)a0;
- (struct { void /* unknown type, empty encoding */ x0[3]; })trajectoryHomographyFromMetadata:(const struct { unsigned short x0; float x1[9]; unsigned long long x2; unsigned long long x3; unsigned char x4; char x5; unsigned char x6; char x7[13]; } *)a0;
