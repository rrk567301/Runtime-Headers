...
- (void).cxx_destruct;
- (id)_newImage;
- (id)initWithImageSize:(struct { long long x0; long long x1; })a0 tileSize:(struct { long long x0; long long x1; })a1 borderSize:(struct { long long x0; long long x1; })a2 pixelFormat:(id)a3 colorSpace:(id)a4 headroom:(float)a5 input:(id)a6;
