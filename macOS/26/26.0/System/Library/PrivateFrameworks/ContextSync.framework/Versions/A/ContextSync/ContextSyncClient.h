...
- (BOOL)registerForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 withOptions:(unsigned long long)a3 forDeviceTypes:(long long)a4 withError:(id *)a5;
- (BOOL)registerForUpdates:(id)a0 withIdentifier:(id)a1 forUseCase:(id)a2 withOptions:(unsigned long long)a3 forDevices:(id)a4 withError:(id *)a5;
