...
@property (nonatomic) BOOL rnfAskedOutrank;
...
@property (nonatomic) BOOL wifiAlwaysOutrank;
@property (nonatomic) BOOL wifiNeverOutrank;
...
@property (nonatomic) BOOL wifiPublicEligible;
