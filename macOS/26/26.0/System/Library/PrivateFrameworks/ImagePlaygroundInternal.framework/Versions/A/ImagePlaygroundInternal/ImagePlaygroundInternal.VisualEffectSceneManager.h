@interface ImagePlaygroundInternal.VisualEffectSceneManager : NSObject <VFXWorldRendererDelegate> {
    ...
    void /* unknown type, empty encoding */ vfxEntity;
    ...
    void /* unknown type, empty encoding */ blobViewScaleModifier;
    void /* unknown type, empty encoding */ blobStateScaleModifier;
    void /* unknown type, empty encoding */ transitionToGeneratingTask;
    void /* unknown type, empty encoding */ transitionToGeneratedTask;
    void /* unknown type, empty encoding */ delayedGeneratedCompletions;
    ...
    void /* unknown type, empty encoding */ isInLightMode;
    ...
    void /* unknown type, empty encoding */ vfxThreadStorage;
    void /* unknown type, empty encoding */ vfxShouldReadColors;
    void /* unknown type, empty encoding */ vfxShouldDispatchWand;
    void /* unknown type, empty encoding */ vfxAttractorNodes;
