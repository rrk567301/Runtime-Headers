@class NSString, NSArray, ICAutoCompleteSuggestionsTableView, ICAutoCompleteSuggestionsTableViewScrollView, NSDictionary, NSWindow, NSLayoutConstraint, NSGlassView;
