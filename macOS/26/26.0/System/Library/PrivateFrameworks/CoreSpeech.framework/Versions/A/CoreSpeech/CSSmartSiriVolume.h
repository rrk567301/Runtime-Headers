...
@interface CSSmartSiriVolume : NSObject <CSMediaPlayingMonitorDelegate, CSAudioStreamProvidingDelegate, CSAudioServerCrashMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSSmartSiriVolumeProcessor> {
    ...
    struct unique_ptr<SmartSiriVolume, std::default_delete<SmartSiriVolume>> { struct SmartSiriVolume *__ptr_; } _smartSiriVolumeNoiseLevel;
    struct unique_ptr<SmartSiriVolume, std::default_delete<SmartSiriVolume>> { struct SmartSiriVolume *__ptr_; } _smartSiriVolumeLKFS;
