@class NSMutableDictionary, CSPhoneCallStateMonitor, CSVoiceTriggerUserSelectedPhrase, NSObject, CSSpeechManager, CSSiriClientBehaviorMonitor, CSVoiceTriggerAirPodWearerDetectionConfig, CSAudioProvider, NSString, CSVoiceTriggerEnabledMonitor, NSArray, CSAudioStreamHolding, CSAudioRouteChangeMonitor, CSAsset;
@protocol OS_dispatch_queue, CSOtherAppRecordingStateMonitorProviding, CSVoiceTriggerDelegate;
...
- (id)initWithSpeechManager:(id)a0 voiceTriggerEnabledMonitor:(id)a1 siriClientBehaviorMonitor:(id)a2 phoneCallStateMonitor:(id)a3 otherAppRecordingStateMonitor:(id)a4 audioRouteChangeMonitor:(id)a5;
