@class NSUUID, NSHashTable, NSString, CSAudioInjectionDevice, CSAudioRecordContext, NSMutableDictionary, NSObject, NSMutableArray;
...
- (BOOL)_connectPluginDevice:(id)a0 withError:(id *)a1;
- (BOOL)isNarrowBandWithStreamHandleId:(unsigned long long)a0;
- (BOOL)_connectBuiltInDevice:(id)a0 withError:(id *)a1;
...
- (BOOL)connectDevice:(id)a0 withOutError:(id *)a1;
...
- (void)selectBuiltInDevice:(id)a0 withCompletion:(id /* block */)a1;
