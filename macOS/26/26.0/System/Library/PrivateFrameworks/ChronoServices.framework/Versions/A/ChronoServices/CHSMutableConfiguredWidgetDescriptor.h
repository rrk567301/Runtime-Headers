@class NSArray, NSDateComponents, CHSWidgetDisplayProperties;
@protocol CHSWidgetRefreshStrategy;

@interface CHSMutableConfiguredWidgetDescriptor : CHSConfiguredWidgetDescriptor

@property (nonatomic) NSDateComponents *idealizedDateComponents;
...
- (void)setSupportedProximities:(unsigned long long)a0;
