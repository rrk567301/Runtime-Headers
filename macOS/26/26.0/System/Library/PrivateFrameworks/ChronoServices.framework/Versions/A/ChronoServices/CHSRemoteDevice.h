...
- (id)initWithName:(id)a0 relationshipID:(id)a1 deviceID:(id)a2 currentSupportedVersion:(long long)a3 minSupportedVersion:(long long)a4 isPossibleSource:(BOOL)a5 pairingState:(long long)a6 lastConnectionDate:(id)a7 deviceType:(long long)a8;
