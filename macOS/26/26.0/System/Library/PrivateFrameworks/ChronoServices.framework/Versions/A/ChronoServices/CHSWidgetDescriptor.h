...
@property (readonly, nonatomic) BOOL wantsLiveScene;
@property (readonly, copy, nonatomic) NSString *targetLiveSceneBundleIdentifier;
...
@property (readonly, nonatomic, getter=isRelevanceBacked) BOOL relevanceBacked;
