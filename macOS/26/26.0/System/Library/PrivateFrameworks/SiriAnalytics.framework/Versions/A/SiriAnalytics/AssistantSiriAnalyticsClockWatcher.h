@class NSString, SiriAnalyticsClockInactivityScheduler, SiriAnalyticsSensitiveConditionsObservers, SiriAnalyticsInternalTelemetry, SiriAnalyticsDataCollectionPolicyClockObserver, SiriAnalyticsLogicalClocksProvider, SiriAnalyticsMessageResolutionPipeline, SiriAnalyticsPreprocessor;
...
- (id)init;
- (id)initWithInternalTelemetry:(id)a0 sensitiveConditionsObservers:(id)a1 messageResolution:(id)a2 preprocessor:(id)a3 logicalClocks:(id)a4 scheduler:(id)a5 dataPolicyObserver:(id)a6;
