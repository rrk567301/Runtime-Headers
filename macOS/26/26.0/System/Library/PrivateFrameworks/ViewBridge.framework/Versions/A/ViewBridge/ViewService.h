...
- (void)_addChildWindow:(const struct { long long x0; BOOL x1; BOOL x2; struct { unsigned long long x0; unsigned char x1; struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } x2; unsigned int x3; unsigned long long x4; } x3; } *)a0 identifier:(id)a1 listenerEndpoint:(id)a2 reply:(id /* block */)a3;
