...
+ (id)statsWithReconstructed:(id)a0 hardwareExecutionNS:(unsigned long long)a1 aneStatsRawData:(id)a2;
...
- (id)initWithHardwareExecution:(unsigned long long)a0 perfCounterData:(id)a1 ANEStatsRawData:(id)a2;
