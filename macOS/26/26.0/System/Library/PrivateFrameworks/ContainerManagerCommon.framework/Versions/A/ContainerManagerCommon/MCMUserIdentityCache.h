...
- (void)_notifyObserversOfChangesWithUserIdentities:(id)a0 firstFetch:(BOOL)a1;
- (void)_refreshFromUserManagementIfNecessary;
- (void)addUserIdentityCacheObserver:(id)a0;
...
- (void)removeUserIdentityCacheObserver:(id)a0;
