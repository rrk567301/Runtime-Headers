...
@property (readonly, nonatomic) struct container_notify_s { struct container_error_extended_s *x0; id x1; unsigned long long x2; unsigned long long x3; id x4; id /* block */ x5[4]; int x6[4]; int x7; unsigned long long x8; unsigned long long x9; unsigned int x10; BOOL x11; BOOL x12; } *notify;
...
- (BOOL)_isEntryA:(id)a0 olderThanEntryB:(id)a1;
- (void)dealloc;
...
- (id)_setEntry:(id)a0 forIdentifier:(id)a1 containerPath:(id)a2 writeThrough:(BOOL)a3 replace:(BOOL)a4;
- (void)resyncRequired;
...
- (BOOL)_identifier:(id)a0 isEqualToOtherIdentifier:(id)a1 caseSensitive:(BOOL)a2;
- (void).cxx_destruct;
