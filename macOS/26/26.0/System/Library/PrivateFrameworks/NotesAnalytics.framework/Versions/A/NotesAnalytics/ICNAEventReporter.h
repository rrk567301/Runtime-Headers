...
+ (BOOL)activityTypeHasUnknownShareFlow:(id)a0;
...
- (id)audioRecordingDataForModernAttachment:(id)a0 appBackgroundOccurred:(BOOL)a1 noteMultitaskingOccurred:(BOOL)a2 audioAttachmentDuration:(id)a3;
- (id)audioTranscriptInteractionDataWithSummaryViewed:(BOOL)a0 transcriptViewed:(BOOL)a1 interactionTargets:(id)a2 interactionTypes:(id)a3;
...
- (void)pushInlineDrawingDataForDrawingID:(id)a0 tool:(long long)a1;
...
- (void)submitAudioRecordingEventWithAttachment:(id)a0 appBackgroundOccurred:(BOOL)a1 noteMultitaskingOccurred:(BOOL)a2 audioAttachmentDuration:(id)a3;
- (void)submitAudioTranscriptInteractionEventSummaryViewed:(BOOL)a0 transcriptViewed:(BOOL)a1 interactionTargets:(id)a2 interactionTypes:(id)a3 audioAttachment:(id)a4;
...
- (void)submitFindInNoteEventWasSearchQueryEntered:(BOOL)a0 htmlNote:(id)a1;
- (void)submitFindInNoteEventWasSearchQueryEntered:(BOOL)a0 modernNote:(id)a1;
- (void)submitFindInTranscriptEventWasSearchQueryEntered:(BOOL)a0 audioAttachment:(id)a1;
...
- (void)submitNoteSharrowEventForModernNote:(id)a0 activityType:(id)a1 collaborationSelected:(BOOL)a2 countOfCollaboratorsAdded:(long long)a3 countOfCollaboratorsRemoved:(long long)a4 startInvitedCount:(long long)a5 startAcceptedCount:(long long)a6 endInvitedCount:(long long)a7 endAcceptedCount:(long long)a8;
