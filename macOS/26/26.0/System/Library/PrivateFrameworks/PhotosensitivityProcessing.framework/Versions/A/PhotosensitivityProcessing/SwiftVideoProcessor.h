@interface SwiftVideoProcessor : NSObject {
    ...
    void /* function */ validationCallback;
}
...
- (id)init;
- (void).cxx_destruct;
- (void)processSurfaceWithSourceSurface:(struct __IOSurface { } *)a0 timestamp:(double)a1 destinationSurface:(struct __IOSurface { } *)a2 options:(id)a3;
