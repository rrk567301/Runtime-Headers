...
@property (nonatomic) BOOL diagnosticPipelineEnabled;
@property (nonatomic) BOOL diagnostic_pipeline_submission;
@property (nonatomic) double diagnostic_pipeline_submission_rate;
@property (readonly, nonatomic) BOOL is_automated_device_group;
@property (readonly, nonatomic) BOOL has_apple_email;
@property (readonly, nonatomic) BOOL is_carry_device;
