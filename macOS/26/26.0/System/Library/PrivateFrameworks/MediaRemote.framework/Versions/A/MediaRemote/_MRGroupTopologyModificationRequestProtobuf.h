...
@interface _MRGroupTopologyModificationRequestProtobuf : PBCodable <NSCopying> {
    struct { unsigned char type : 1; unsigned char fadeAudio : 1; unsigned char muteUntilFinished : 1; unsigned char shouldClearPredictedRoutes : 1; unsigned char shouldModifyPredictedRoutes : 1; unsigned char shouldNotPauseIfLastDeviceRemoved : 1; unsigned char shouldWaitForUpdatedOutputDevices : 1; unsigned char suppressErrorDialog : 1; } _has;
}
...
@property (nonatomic) BOOL hasShouldWaitForUpdatedOutputDevices;
