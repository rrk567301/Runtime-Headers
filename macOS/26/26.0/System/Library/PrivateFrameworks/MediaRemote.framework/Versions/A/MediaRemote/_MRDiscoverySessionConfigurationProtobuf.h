...
@interface _MRDiscoverySessionConfigurationProtobuf : PBCodable <NSCopying> {
    struct { unsigned char features : 1; unsigned char targetSessionID : 1; unsigned char alwaysAllowUpdates : 1; unsigned char cachedDiscoveryEnabled : 1; unsigned char enableThrottling : 1; unsigned char populatesExternalDevice : 1; } _has;
}
...
@property (nonatomic) BOOL hasCachedDiscoveryEnabled;
