...
- (id)createAndExportMediaForSuggestionLocalIdentifiers:(id)a0 editConfiguration:(id)a1 toURL:(id)a2 error:(id *)a3;
...
- (void)refreshPosterConfigurationsForNightlyRefresh:(BOOL)a0 progressReporter:(id)a1 passingFilter:(id /* block */)a2 withCompletion:(id /* block */)a3;
...
- (BOOL)saveMessagesBackdropPreviewResourcesForAsset:(id)a0 atURL:(id)a1 withClassification:(unsigned long long)a2 error:(id *)a3;
- (BOOL)saveOnboardingPreviewSegmentationResourcesForAsset:(id)a0 atURL:(id)a1 withClassification:(unsigned long long)a2 style:(id)a3 enableSpatialPhoto:(BOOL)a4 error:(id *)a5;
- (BOOL)savePreviewSegmentationResourcesForAsset:(id)a0 atURL:(id)a1 withClassification:(unsigned long long)a2 styleCategory:(id)a3 enableSettlingEffect:(BOOL)a4 enableSpatialPhoto:(BOOL)a5 error:(id *)a6;
...
- (BOOL)saveShuffleSegmentationResourcesForAsset:(id)a0 atURL:(id)a1 withClassification:(unsigned long long)a2 style:(id)a3 enableSpatialPhoto:(BOOL)a4 error:(id *)a5;
- (void)sendHasSmartShuffleWallpaperBiomeEvent;
- (id)spatialPhotoDescriptorsForDonationWithSuggestionUUIDsToAvoid:(id)a0;
