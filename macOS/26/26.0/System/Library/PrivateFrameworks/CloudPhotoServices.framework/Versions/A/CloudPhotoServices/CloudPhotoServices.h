...
+ (BOOL)_createVideoResourcesFromInputURL:(id)a0 withItemScopedIdentifier:(id)a1 videoAdjustments:(id)a2 resourceType:(unsigned long long)a3 forIris:(BOOL)a4 destinationDirectory:(id)a5 fingerprintScheme:(id)a6 outputResources:(id)a7 weightInProgress:(long long)a8 error:(id *)a9;
