...
+ (BOOL)isDuplicateProcessorEnabledForLibraryServicesManager:(id)a0;
...
+ (void)signalDuplicateBackgroundJobItemForAssetUUID:(id)a0 requiresMetadataProcessing:(BOOL)a1 library:(id)a2;
...
- (BOOL)_moveDuplicateAlbumAssetsFromAlbums:(id)a0 toTargetAlbum:(id)a1 duplicateType:(short)a2 error:(id *)a3;
