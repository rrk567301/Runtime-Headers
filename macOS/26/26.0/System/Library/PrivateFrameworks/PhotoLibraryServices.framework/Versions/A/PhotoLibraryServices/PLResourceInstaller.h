...
+ (id)onDemand_installExistingAlchemistV2ResourceAtFilePath:(id)a0 recipe:(id)a1 forAsset:(id)a2;
+ (BOOL)_isPenultimateVersionFromCPLType:(unsigned long long)a0;
+ (id)_storeValidatedLocalExternalResource:(id)a0 forAsset:(id)a1;
+ (id)validatedExternalResourceFromExternalResourceCloudAttributes:(id)a0 cplType:(unsigned long long)a1 assetType:(short)a2 uti:(id)a3 resourceWidth:(unsigned long long)a4 resourceHeight:(unsigned long long)a5 resourceFingerprint:(id)a6 resourceStableHash:(id)a7 resourceSize:(unsigned long long)a8 isAvailable:(BOOL)a9 fromAdjustedSet:(BOOL)a10 resourceURL:(id)a11 cloudMaster:(id)a12 isForMigration:(BOOL)a13 context:(id)a14;
...
+ (id)generatedValidatedExternalSyndicationResourceOfType:(unsigned int)a0 version:(unsigned int)a1 recipeID:(unsigned int)a2 fileURL:(id)a3 requireFileToBePresent:(BOOL)a4 uniformTypeIdentifier:(id)a5;
...
+ (BOOL)resetImageRequestHintsInContext:(id)a0 allowOneTimeThumbRebuild:(BOOL)a1;
+ (void)_applyImageIOMetadataToExternalResource:(id)a0 fromFileURL:(id)a1 fileExists:(BOOL)a2 assumedWidth:(long long)a3 assumedHeight:(long long)a4 recipe:(id)a5 assetKind:(short)a6;
