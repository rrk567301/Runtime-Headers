...
+ (short)cloudSharedPlaceholderKindFromSharedAlbumAsset:(id)a0;
...
- (short)_localAvailabilityForAsset:(id)a0 collectionShare:(id)a1 type:(unsigned int)a2;
...
- (id)_sharedStreamsExternalResourceForAsset:(id)a0 type:(unsigned int)a1;
