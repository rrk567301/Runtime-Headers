...
+ (long long)migrateBackgroundActionsWithPhotoLibraryBundle:(id)a0 logger:(id)a1 error:(id *)a2 reportProgressUsingBlock:(id /* block */)a3 continuationHandler:(id /* block */)a4;
...
- (long long)migrateBackgroundPostProcessingWithError:(id *)a0 reportProgressUsingBlock:(id /* block */)a1;
