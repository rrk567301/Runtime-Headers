...
@interface CVNLPCTCTextDecodingPath : CVNLPTextDecodingPath {
    struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; unsigned int *__cap_; } _tokenString;
    struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; unsigned int *__cap_; } _histWordTokenIDs;
    unsigned long long _beginningCurrentWord;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } _cumulativeTokenLogProbabilities;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; double *__cap_; } _tokenBoundaryLogProbabilities;
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _tokenStringSegmentationPositions;
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _tokenMaxActivations;
    struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *__begin_; unsigned long long *__end_; unsigned long long *__cap_; } _tokenCommitCharacterLengths;
    BOOL _hasContext;
...
- (float)_wordLanguageModelLogProbabilityForString:(id)a0 originalWordRanges:(id)a1 originalWordIDs:(struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })a2 wordRanges:(id)a3 wordIDs:(struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })a4;
...
- (id)initWithLanguageResourceBundle:(id)a0 scoringFunction:(id /* block */)a1 initialCharacterLMState:(struct CVNLPLanguageModelWithState { } *)a2 characterTokenIDs:(struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })a3 wordTokenIDs:(struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; })a4 optimizingAlignment:(BOOL)a5 hasContext:(BOOL)a6;
- (double)lexiconScore;
