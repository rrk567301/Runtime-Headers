@class FigCaptureMicSourcePipeline, NSMutableArray, FigCaptureCameraSourcePipeline;
...
@property (readonly, nonatomic) NSMutableArray *cinematographyPipelines;
...
- (void)addLiDARDepthPipeline:(id)a0;
- (id)movieFileSinkPipelineWithFileCoordinatorNode:(id)a0;
- (id)cinematographyPipelineWithSourceID:(id)a0;
...
- (id)videoDataSinkPipelineForMetadataWithSourceID:(id)a0 sourceDeviceType:(int)a1;
