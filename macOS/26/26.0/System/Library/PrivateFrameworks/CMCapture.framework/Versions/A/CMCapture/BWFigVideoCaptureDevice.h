...
@interface BWFigVideoCaptureDevice : NSObject <BWZoomCompletionDelegate, BWSupplementalPointCloudCaptureDeviceDelegate> {
    ...
    NSMutableDictionary *_outputAspectRatioRequestIDByConfigurationID;
    NSMutableDictionary *_configurationIDByOutputAspectRatioRequestID;
    NSMutableDictionary *_bufferPTSByConfigurationID;
    long long _nextOutputAspectRatioRequestIDToRemove;
...
- (void)liveReconfigureForOutputAspectRatioStarted:(long long)a0 forConfigurationID:(long long)a1;
...
- (void)liveReconfigureForOutputAspectRatioCompleted:(long long)a0;
