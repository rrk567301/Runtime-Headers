...
@interface BWBravoStreamSelector : NSObject {
    ...
    BOOL _teleSwitchBasedOnFocusTargetOffsetInRestrictedModeEnabled;
    BOOL _teleExposureLimitsEnabled;
    ...
    BOOL _digitalFlashEITTargetOffsetThresholdsEnabled;
    ...
    BOOL _afRecommendedPrimaryPortTypeForWideTeleAutoSwitchEnabled;
    BOOL _afRecommendedPrimaryPortTypeForWideSuperWideAutoSwitchEnabled;
    unsigned int _afMaxFocusPositionStepForStableStatus;
    BOOL _afHigherFPSDuringConvergenceEnabled;
...
- (id)recommendMasterStreamUsingCurrentMasterStream:(id)a0 frameStatisticsByPortType:(id)a1 zoomFactor:(float)a2 isAutoFlashScene:(BOOL)a3 digitalFlashMode:(int)a4 isStationary:(BOOL)a5 detectedObjects:(id)a6 cameraControlsStatisticsMasterStream:(id)a7;
