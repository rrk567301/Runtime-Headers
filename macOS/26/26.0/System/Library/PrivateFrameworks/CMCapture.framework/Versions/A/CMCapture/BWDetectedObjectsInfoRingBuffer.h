...
- (void)transferObjectsToSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0 transformToBufferSpace:(BOOL)a1 sourceCropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
