@class BWDisparityAPSScaling, FigMetalContext, NSDictionary, FigDepthValueMultiplier, NSString, NSObject, BWStillImageNodeConfiguration;
@protocol OS_dispatch_queue, DepthProcessor;

@interface BWDepthConverterNode : BWNode {
    BOOL _depthProcessingEnabled;
