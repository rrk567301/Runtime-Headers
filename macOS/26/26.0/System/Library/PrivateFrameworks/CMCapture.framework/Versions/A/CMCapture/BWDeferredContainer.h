@class NSString, NSArray, NSURL, FigCaptureStillImageSettings, NSDictionary, BWStillImageCaptureSettings, NSMutableArray, BWStillImageProcessingSettings, BWDeferredPipelineParameters;
...
- (id)description;
- (BOOL)valid:(int *)a0;
- (id)initWithApplicationID:(id)a0 resolvedSettings:(id)a1 unresolvedSettings:(id)a2 processingSettings:(id)a3 pipelineParameters:(id)a4 intermediates:(id)a5 photoDescriptors:(id)a6;
