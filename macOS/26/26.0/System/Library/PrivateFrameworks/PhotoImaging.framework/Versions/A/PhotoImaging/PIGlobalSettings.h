...
@property (nonatomic) BOOL portraitDrawDebugInfo;
...
@property (nonatomic) BOOL forceEnableSpatialPhoto;
...
@property (nonatomic) BOOL inpaintApplySafetyFilterOnFaceLandmarks;
