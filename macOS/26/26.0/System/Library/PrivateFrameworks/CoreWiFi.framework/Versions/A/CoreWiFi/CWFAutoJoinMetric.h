@class NSUUID, NSString, NSArray, NSDate, CWFAutoJoinParameters, NSError, SFRemoteHotspotDevice, NSDictionary, CWFScanResult;
...
@property (nonatomic) BOOL wasBeforeFirstUnlock;
