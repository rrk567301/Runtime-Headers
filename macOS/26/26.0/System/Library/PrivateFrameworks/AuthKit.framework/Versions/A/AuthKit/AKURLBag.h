...
@property (readonly, nonatomic) BOOL isSIWAForPAAChildEnabled;
@property (readonly, nonatomic) BOOL isAccountAccessTelemetryOptInEnabled;
...
- (id)_urlConfigurationAtKey:(id)a0 fromURLBag:(id)a1;
...
- (void)urlConfigurationForKey:(id)a0 fromCache:(BOOL)a1 completion:(id /* block */)a2;
