@class AKAuthenticatableResource, AKDevice, NSDictionary, NSObject, AKCompanionKeyEnvelope, NSString, NSSet, AKAccountMigrationContext, AKAnisetteData, NSArray, NSData, AKProtoAccountContext, NSNumber, NSUUID;
