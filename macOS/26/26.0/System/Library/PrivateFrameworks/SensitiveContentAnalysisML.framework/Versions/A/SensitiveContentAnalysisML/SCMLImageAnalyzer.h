...
- (struct vector<SCML::BoxInfo, std::allocator<SCML::BoxInfo>> { struct BoxInfo *x0; struct BoxInfo *x1; struct BoxInfo *x2; })_processDetectionOutput:(struct NetworkOutputs { struct TensorView<float, 1> { float *x0; struct array<int, 1UL> { int x0[1]; } x1; } x0; struct TensorView<float, 3> { float *x0; struct array<int, 3UL> { int x0[3]; } x1; } x1; struct TensorView<float, 3> { float *x0; struct array<int, 3UL> { int x0[3]; } x1; } x2; })a0;
