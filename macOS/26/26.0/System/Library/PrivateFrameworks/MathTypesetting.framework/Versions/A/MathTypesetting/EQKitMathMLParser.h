...
@interface EQKitMathMLParser : NSObject {
    ...
    NSData *mSource;
    struct stack<EQKitMathMLParserState, std::deque<EQKitMathMLParserState>> { struct deque<EQKitMathMLParserState, std::allocator<EQKitMathMLParserState>> { struct __split_buffer<EQKitMathMLParserState *, std::allocator<EQKitMathMLParserState *>> { int **__first_; int **__begin_; int **__end_; int **__cap_; } __map_; unsigned long long __start_; unsigned long long __size_; } c; } mState;
    void *mAttributeCollection;
    struct basic_string<wchar_t, std::char_traits<wchar_t>, std::allocator<wchar_t>> { union __rep { struct __short { int __data_[5]; struct __padding<3UL> { char __padding_[3]; } __padding_; unsigned char __size_ : 7; unsigned char __is_long_ : 1; } __s; struct __long { int *__data_; unsigned long long __size_; unsigned long __cap_ : 63; unsigned char __is_long_ : 1; } __l; } __rep_; } mAttribution;
}
