@class NSDictionary, REMAccount, REMListSectionContextChangeItem, REMListSublistContextChangeItem, NSOrderedSet, NSString, REMMemberships, REMSaveRequest, REMListAutoCategorizeContextChangeItem, NSArray, REMListAppearanceContextChangeItem, REMResolutionTokenMap, NSSet, NSData, REMColor, REMObjectID, REMAccountCapabilities, REMListCalDAVNotificationContextChangeItem, NSUUID, REMListStorage, REMListShareeContextChangeItem, NSDate, REMChangedKeysObserver, REMListGroceryContextChangeItem;
...
@property (readonly, nonatomic) BOOL isAutoCategorizationSupportedInCurrentAppVersion;
@property (readonly, nonatomic) BOOL isSuggestedRemindersSupportedInCurrentAppVersion;
