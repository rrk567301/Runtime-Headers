@class NSArray, NSString, BMSiriSegmentsCohortsEventMetadata;

@interface BMSiriSegmentsCohorts : BMEventBase <BMStoreData>

@property (class, readonly, nonatomic) unsigned int latestDataVersion;

@property (readonly, nonatomic) BMSiriSegmentsCohortsEventMetadata *eventMetadata;
