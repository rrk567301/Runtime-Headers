...
- (BOOL)_autoShortcutHasBeenHiddenForSearchResult:(id)a0 withFeedbackManager:(id)a1;
...
- (id)_makeClearButtonItemForAutoShortcutAndShouldClearWholeSection:(BOOL)a0 ForResult:(id)a1;
