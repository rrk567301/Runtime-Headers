...
@property struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; unsigned int *__cap_; } cachedFeatureTokens;
@property BOOL contextNoText;
@property BOOL featureInTestNoText;
@property (readonly) struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *x0; unsigned int *x1; unsigned int *x2; } featureTokens;
...
- (id)initWithTextFeature:(id)a0 context:(id)a1 imageSize:(struct CGSize { double x0; double x1; })a2 parameters:(id)a3 skipTextComputation:(BOOL)a4;
