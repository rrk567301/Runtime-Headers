...
@property (copy, nonatomic) NSString *cookiesUUID;
@property (copy, nonatomic) NSString *localStorageUUID;
@property (copy, nonatomic) NSString *sessionStorageUUID;
@property (copy, nonatomic) NSString *tabGroupUUID;
@property (nonatomic, getter=isInUnnamedTabGroup) BOOL inUnnamedTabGroup;
...
- (void)setLocalStorageUUID:(id)a0;
- (void)setMoved:(BOOL)a0;
- (void)setSessionStorageUUID:(id)a0;
