@interface StabilizeParams : NSObject {
    struct vector<SP_FrameInfo, std::allocator<SP_FrameInfo>> { struct *__begin_; struct *__end_; struct *__cap_; } mFrameInfo;
    struct vector<CMTime, std::allocator<CMTime>> { struct *__begin_; struct *__end_; struct *__cap_; } mFrameTimeArray;
}
