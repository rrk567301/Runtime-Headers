...
+ (id)buttonWithTitle:(id)a0 style:(long long)a1 contextAwareHandler:(id /* block */)a2;
+ (id)buttonWithTitle:(id)a0 style:(long long)a1 preferred:(BOOL)a2 contextAwareHandler:(id /* block */)a3;
+ (id)buttonWithTitle:(id)a0 style:(long long)a1 preferred:(BOOL)a2 handler:(id /* block */)a3;
+ (id)cancelButtonWithContextAwareHandler:(id /* block */)a0;
+ (id)cancelButtonWithHandler:(id /* block */)a0;
+ (id)cancelButtonWithTarget:(id)a0 action:(SEL)a1;
+ (id)okButtonWithContextAwareHandler:(id /* block */)a0;
