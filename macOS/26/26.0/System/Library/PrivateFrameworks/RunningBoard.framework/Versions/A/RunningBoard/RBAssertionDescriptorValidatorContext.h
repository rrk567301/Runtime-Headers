@class RBDomainRestriction, RBSProcessIdentity, RBSAssertionDescriptor, RBProcessState, NSString, NSDictionary, RBSystemState, RBProcess, RBSProcessIdentifier, RBAssertionDescriptorValidator, RBAssertionAcquisitionContext;
