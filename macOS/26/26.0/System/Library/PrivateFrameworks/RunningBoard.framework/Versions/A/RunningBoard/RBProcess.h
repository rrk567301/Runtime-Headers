@class RBSProcessIdentity, NSDictionary, RBJetsamProperties, RBSProcessIdentifier, RBProcessState, NSObject, RBSProcessInstance, RBDomainRestriction, NSString, RBSProcessHandle, RBSAssertionIdentifier, RBSProcessExitContext, RBSProcessExitStatus, RBSAuditToken;
...
@property (nonatomic, getter=isJetsamCoalitionLeader) BOOL jetsamCoalitionLeader;
