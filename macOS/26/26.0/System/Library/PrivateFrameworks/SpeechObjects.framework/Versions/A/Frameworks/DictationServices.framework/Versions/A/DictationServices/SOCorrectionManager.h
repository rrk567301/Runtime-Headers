...
- (void)showCorrectionsForSelectedString:(id)a0 alternativeStrings:(id)a1 emojiStrings:(id)a2 showInvisibles:(BOOL)a3 selectionRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 completionBlock:(id /* block */)a5 didShowBlock:(id /* block */)a6;
