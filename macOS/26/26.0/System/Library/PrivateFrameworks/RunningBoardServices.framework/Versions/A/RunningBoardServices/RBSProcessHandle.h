...
+ (id)handleForAuditToken:(struct { unsigned int x0[8]; })a0 error:(out id *)a1;
+ (BOOL)supportsRBSXPCSecureCoding;
+ (id)currentProcess;
+ (id)handleForKey:(unsigned long long)a0 fetchIfNeeded:(BOOL)a1;
+ (id)handleForPredicate:(id)a0 error:(out id *)a1;
+ (id)handleForIdentifier:(id)a0 pidVersion:(int)a1 error:(out id *)a2;
...
+ (id)forceLookupIdentifer:(id)a0 error:(out id *)a1;
