@class PXExtendedTraitCollectionSnapshot, NSViewController, NSObject;
...
+ (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_simulatedExtraPeripheryInsets;
