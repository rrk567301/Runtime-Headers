@class NSMenu, VKCImageSubjectContext, NSString, NSImageView, VIUVisualIntelligenceView, VKCImageVisualSearchView, VKCImageCustomHighlightView, VKCRemoveBackgroundRequestHandler, VKCAnalysisDebugMenuProvider, NSArray, NSTextField, VKCVisualSearchResultItem, VKCImageAnalysisResult, NSAttributedString, NSObject, VKCActionInfoButton, VKCImageDataDetectorView, VKCActionInfoView, VIUVisualIntelligenceOmnibar, VIUIVisualIntelligenceViewCoordinator, NSView, VKCImageTranslationView, NSScrollView, VKCRemoveBackgroundRequest, VKCImageTextSelectionView, NSImage, CALayer, VKCImageSubjectHighlightView, VKTextRange, NSIndexSet, NSNumber;
...
@property (readonly, nonatomic) BOOL isVisualIntelligenceType;
...
@property (nonatomic) BOOL isVIHosted;
...
@property (readonly, nonatomic) BOOL isVisualIntelligenceSheetPresented;
...
- (void)visualIntelligenceView:(id)a0 didRequestVluEnabled:(BOOL)a1;
- (void)visualIntelligenceView:(id)a0 isDraggingSheetDidChange:(BOOL)a1;
- (void)visualIntelligenceView:(id)a0 isSheetPresentedDidChangeToValue:(BOOL)a1;
