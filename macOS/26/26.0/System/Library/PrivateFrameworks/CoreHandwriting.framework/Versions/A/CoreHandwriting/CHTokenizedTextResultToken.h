...
+ (id)tokenWithString:(id)a0 strokeIndexes:(id)a1 wordID:(unsigned int)a2 modelScore:(double)a3 recognitionScore:(double)a4 combinedScore:(double)a5 alignmentScore:(double)a6 properties:(unsigned long long)a7 recognizerSourceLocale:(id)a8 inputSources:(unsigned long long)a9 substrokeCount:(long long)a10 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a11 originalBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a12 principalLines:(struct { struct { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x0; struct { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x1; struct { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x2; struct { struct CGPoint { double x0; double x1; } x0; struct CGPoint { double x0; double x1; } x1; } x3; })a13 principalPoints:(id)a14;
