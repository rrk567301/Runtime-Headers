@interface CHDiffusionTextSynthesizerLatin : CHDiffusionTextSynthesizerBase {
    struct unique_ptr<CoreHandwriting::synthesis::CHDiffusionPipelineLatin, std::default_delete<CoreHandwriting::synthesis::CHDiffusionPipelineLatin>> { struct CHDiffusionPipelineLatin *__ptr_; } _pipeline;
}
