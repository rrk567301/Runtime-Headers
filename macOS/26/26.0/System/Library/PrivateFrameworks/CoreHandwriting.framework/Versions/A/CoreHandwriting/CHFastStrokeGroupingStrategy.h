...
- (void).cxx_destruct;
- (struct vector<CHFastGroupingCluster, std::allocator<CHFastGroupingCluster>> { struct CHFastGroupingCluster *x0; struct CHFastGroupingCluster *x1; struct CHFastGroupingCluster *x2; })clustersForStrokes:(id)a0 shouldMakeSingleCluster:(BOOL)a1 anchorPoints:(unsigned long long)a2;
