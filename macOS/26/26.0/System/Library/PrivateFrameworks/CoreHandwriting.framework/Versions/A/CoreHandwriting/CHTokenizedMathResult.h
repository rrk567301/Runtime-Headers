...
+ (BOOL)isTranscriptionValidExpression:(id)a0 limitToCurrentLocale:(BOOL)a1 declaredVariables:(id)a2;
+ (BOOL)isTranscriptionValidExpression:(id)a0 transcriptionPath:(id)a1 limitToCurrentLocale:(BOOL)a2 requireDeclaredVariables:(BOOL)a3;
