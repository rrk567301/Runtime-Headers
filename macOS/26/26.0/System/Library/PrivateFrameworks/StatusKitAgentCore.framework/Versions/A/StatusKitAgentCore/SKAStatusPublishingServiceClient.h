...
- (id)initWithXPCConnection:(id)a0 queue:(id)a1 delegate:(id)a2 databaseManager:(id)a3 invitationManager:(id)a4 publishingManager:(id)a5 channelManager:(id)a6 daemonProtocolDelegate:(id)a7;
