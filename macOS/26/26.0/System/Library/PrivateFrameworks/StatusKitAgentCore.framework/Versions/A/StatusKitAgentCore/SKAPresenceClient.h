@class SKAPresenceClientConnection, SKPresenceOptions, NSString, NSObject;
@protocol SKAPresenceClientDelegate, SKADatabaseManaging, SKAPresenceManaging, SKAStatusSubscriptionManaging, SKAInvitationManaging, OS_dispatch_queue, OS_os_transaction;
...
- (void)assertPresenceForIdentifier:(id)a0 withPresencePayload:(id)a1 assertionOptions:(id)a2 completion:(id /* block */)a3;
...
- (void)handleReceivedPresentDevicesUpdate:(id)a0 forPresenceIdentifier:(id)a1;
- (id)initWithXPCConnection:(id)a0 queue:(id)a1 delegate:(id)a2 subscriptionManager:(id)a3 presenceManager:(id)a4 invitationManager:(id)a5 databaseManager:(id)a6 daemonProtocolDelegate:(id)a7;
