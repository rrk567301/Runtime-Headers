...
- (id)syntheticDataTaskWithRequest:(id)a0 failOpen:(BOOL)a1 background:(BOOL)a2 completionHandler:(id /* block */)a3;
- (void)_createURLSession;
- (id)dataTaskWithRequest:(id)a0 isSynthetic:(BOOL)a1 allowProxying:(BOOL)a2 failOpen:(BOOL)a3 background:(BOOL)a4 completionHandler:(id /* block */)a5;
