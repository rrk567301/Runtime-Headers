...
@property (nonatomic) BOOL experimentActivated;
...
- (id)initWithUUID:(id)a0 assetSetName:(id)a1 atomicInstance:(id)a2 experiment:(id)a3 preinstalledAssetsSummary:(id)a4 bootUUID:(id)a5 experimentActivated:(BOOL)a6;
