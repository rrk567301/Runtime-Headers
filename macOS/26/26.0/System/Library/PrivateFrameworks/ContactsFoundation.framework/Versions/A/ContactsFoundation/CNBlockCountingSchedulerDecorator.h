...
@property (readonly, nonatomic) long long pendingBlockCount;
@property (readonly, nonatomic) long long activeBlockCount;
@property (readonly, nonatomic) long long completedBlockCount;
