...
- (id)initWithBackgroundScheduler:(id)a0 mainThreadScheduler:(id)a1 inlineScheduler:(id)a2 immediateScheduler:(id)a3 serialSchedulerProvider:(id /* block */)a4 workloopSchedulerProvider:(id /* block */)a5 synchronousSerialSchedulerProvider:(id /* block */)a6 readerWriterSchedulerProvider:(id /* block */)a7;
- (id)newWorkloopSchedulerWithName:(id)a0;
