@class SFCertificateView, NSSecureTextField, NSPopUpButton, NSButton, NSScrollView, NSImageView, NSProgressIndicator, NSLayoutConstraint, NSString, NSAttributedString, CWDisplayedScanResult, NSTextView, NSData, NSView, NSTextField, NSError;
...
@property (copy) NSAttributedString *descriptionOverride;
