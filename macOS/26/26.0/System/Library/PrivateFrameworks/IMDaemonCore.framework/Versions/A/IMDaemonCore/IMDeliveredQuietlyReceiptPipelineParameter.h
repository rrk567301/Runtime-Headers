@class NSString, NSArray, IMDChat, NSDictionary, IMDiMessageIDSTrustedData, IMDAccount, NSNumber, IMDServiceSession;

@interface IMDeliveredQuietlyReceiptPipelineParameter : NSObject <IMFindAccountProcessingParameter, IMDeliveredQuietlyReceiptProcessingParameter, IMMessageFromStorageParameter>
