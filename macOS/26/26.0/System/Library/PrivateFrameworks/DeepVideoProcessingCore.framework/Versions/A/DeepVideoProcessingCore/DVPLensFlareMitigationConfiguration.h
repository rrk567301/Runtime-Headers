...
@interface DVPLensFlareMitigationConfiguration : NSObject <DVPConfiguration>
...
+ (void)downloadAssetWithCompletionHandler:(id /* block */)a0;
+ (long long)getAssetStatusWithPercentCompleted:(long long *)a0;
