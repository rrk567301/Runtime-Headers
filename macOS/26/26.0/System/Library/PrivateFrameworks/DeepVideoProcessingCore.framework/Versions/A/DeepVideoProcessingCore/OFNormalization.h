...
- (BOOL)convertBuffer:(struct __CVBuffer { } *)a0 toFP16IOSurface:(struct __IOSurface { } *)a1;
- (BOOL)convertBuffer:(struct __CVBuffer { } *)a0 toFP16ShuffledIOSurface:(struct __IOSurface { } *)a1;
- (BOOL)convertFP16IOSurface:(struct __IOSurface { } *)a0 toBuffer:(struct __CVBuffer { } *)a1;
- (id)createFP16TextureFromIOSurface:(struct __IOSurface { } *)a0 width:(long long)a1 height:(long long)a2 arrayLength:(long long)a3;
...
- (void)encodePadRGBToCommandBuffer:(id)a0 source:(id)a1 destination:(id)a2;
...
- (BOOL)padRGB:(struct __CVBuffer { } *)a0 to:(struct __CVBuffer { } *)a1;
