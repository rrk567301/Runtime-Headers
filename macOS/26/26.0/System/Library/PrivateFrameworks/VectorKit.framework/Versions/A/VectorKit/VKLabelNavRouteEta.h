...
@interface VKLabelNavRouteEta : NSObject <VKLabelNavFeature> {
    ...
    BOOL _anchorHasNoAltitude;
    BOOL _anchorFollowsTerrain;
}
...
+ (struct vector<GeoCodecsFeatureStylePair, geo::allocator_adapter<GeoCodecsFeatureStylePair, mdm::zone_mallocator>> { struct GeoCodecsFeatureStylePair *x0; struct GeoCodecsFeatureStylePair *x1; struct GeoCodecsFeatureStylePair *x2; struct allocator_adapter<GeoCodecsFeatureStylePair, mdm::zone_mallocator> { struct zone_mallocator { } x0; } x3; })baseAttributesForEtaLabel:(BOOL)a0 focused:(BOOL)a1 etaComparison:(unsigned char)a2 transportType:(unsigned char)a3 navLabelType:(unsigned char)a4 when:(struct optional<gss::When> { union { char x0; unsigned char x1; } x0; BOOL x1; })a5 routeLegWhen:(struct optional<gss::RouteLegWhen> { union { char x0; unsigned char x1; } x0; BOOL x1; })a6 additionalAttributes:(id)a7;
+ (struct RoadSignStyleGroup { struct shared_ptr<gss::StylesheetQuery<gss::PropertyID>> { void *x0; struct __shared_weak_count *x1; } x0; struct shared_ptr<gss::StylesheetQuery<gss::PropertyID>> { void *x0; struct __shared_weak_count *x1; } x1; struct shared_ptr<gss::StylesheetQuery<gss::PropertyID>> { void *x0; struct __shared_weak_count *x1; } x2; })styleForNavContext:(const struct NavContext { void /* function */ **x0; struct LabelManager *x1; struct MapNavLabeler *x2; struct LabelLayoutContext *x3; struct LabelNavLayoutContext *x4; } *)a0 selected:(BOOL)a1 focused:(BOOL)a2 etaComparison:(unsigned char)a3 transportType:(unsigned char)a4 navLabelType:(unsigned char)a5 when:(struct optional<gss::When> { union { char x0; unsigned char x1; } x0; BOOL x1; })a6 routeLegWhen:(struct optional<gss::RouteLegWhen> { union { char x0; unsigned char x1; } x0; BOOL x1; })a7 additionalAttributes:(id)a8;
...
- (void).cxx_destruct;
- (void)clearLabel;
- (void)createLabelWithNavContext:(const struct NavContext { void /* function */ **x0; struct LabelManager *x1; struct MapNavLabeler *x2; struct LabelLayoutContext *x3; struct LabelNavLayoutContext *x4; } *)a0 orientation:(unsigned char)a1 etaDescription:(id)a2 selected:(BOOL)a3 when:(struct optional<gss::When> { union { char x0; unsigned char x1; } x0; BOOL x1; })a4 routeLegWhen:(struct optional<gss::RouteLegWhen> { union { char x0; unsigned char x1; } x0; BOOL x1; })a5 artworkCache:(void *)a6;
