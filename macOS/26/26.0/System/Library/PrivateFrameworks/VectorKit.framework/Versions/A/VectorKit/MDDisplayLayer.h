...
@interface MDDisplayLayer : NSObject <MDRenderTarget> {
    ...
    struct unique_ptr<ggl::RenderBuffer, std::default_delete<ggl::RenderBuffer>> { struct RenderBuffer *__ptr_; } _depthStencil;
    ...
    struct unique_ptr<ggl::RenderTarget, std::default_delete<ggl::RenderTarget>> { struct RenderTarget *__ptr_; } _blitRenderTarget;
    ...
    struct unique_ptr<BlitPass, std::default_delete<BlitPass>> { struct BlitPass *__ptr_; } _blitPass;
    void *_services;
