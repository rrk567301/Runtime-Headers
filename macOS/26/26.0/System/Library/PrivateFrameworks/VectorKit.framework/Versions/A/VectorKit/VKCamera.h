@class NSString, VKFootprint, VKViewVolume, VKCameraRegionRestriction;
...
- (struct Matrix<double, 3, 1> { double x0[3]; })groundPlaneIntersectionPoint:(const void *)a0 transform:(const void *)a1;
...
- (BOOL)moveTo:(const void *)a0;
- (id /* block */)annotationRectTest;
- (void)updateCamera:(struct shared_ptr<gdc::Camera> { struct Camera *x0; struct __shared_weak_count *x1; })a0 cameraFrame:(struct CameraFrame<geo::Radians, double> { struct Coordinate3D<geo::Radians, double> { struct Unit<geo::RadianUnitDescription, double> { double x0; } x0; struct Unit<geo::RadianUnitDescription, double> { double x0; } x1; struct Unit<geo::MeterUnitDescription, double> { double x0; } x2; } x0; struct Unit<geo::MeterUnitDescription, double> { double x0; } x1; struct Unit<geo::RadianUnitDescription, double> { double x0; } x2; struct Unit<geo::RadianUnitDescription, double> { double x0; } x3; struct Unit<geo::RadianUnitDescription, double> { double x0; } x4; })a1 withAdjustment:(struct function<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double> &, geo::Unit<geo::MeterUnitDescription, double> &)> { struct __value_func<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double> &, geo::Unit<geo::MeterUnitDescription, double> &)> { union type { unsigned char x0[24]; } x0; void *x1; } x0; })a2;
