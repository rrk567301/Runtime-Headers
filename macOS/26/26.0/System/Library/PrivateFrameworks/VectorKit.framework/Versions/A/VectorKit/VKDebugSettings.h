...
@interface VKDebugSettings : NSObject {
    ...
    struct unordered_set<unsigned long long, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<unsigned long long>> { struct __hash_table<unsigned long long, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<unsigned long long>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<unsigned long long, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<unsigned long long, void *> *> *>>> { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<unsigned long long, void *> *> *>> { unsigned long long __size_; } __deleter_; } __bucket_list_; struct __hash_node_base<std::__hash_node<unsigned long long, void *> *> { void *__next_; } __first_node_; unsigned long long __size_; float __max_load_factor_; } __table_; } _enabledLogicConsoles;
    struct unique_ptr<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>, std::default_delete<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>>> { void *__ptr_; } _labelHighlightingValue;
    struct unique_ptr<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>, std::default_delete<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>>> { void *__ptr_; } _showLabelCountsValue;
}
...
@property (nonatomic) BOOL debugEnableSprAtScaleLighting;
@property (nonatomic) BOOL daVinciEnableSharpnessBasedNormals;
@property (nonatomic) BOOL daVinciOverrideNormalsSharpness;
@property (nonatomic) float daVinciSharpnessNormalsBias;
...
@property (nonatomic) BOOL simulateGlobePanning;
...
@property (nonatomic) BOOL cameraCollisionSphereIsNearPlaneCentred;
...
@property (nonatomic) BOOL panWithCollisionPointsAllowsElevationDelta;
@property (nonatomic) BOOL collisionPointPitchLimit;
@property (nonatomic) BOOL collisionPointHeightLimit;
...
@property (nonatomic) BOOL enableCollisionWithCollisionMesh;
@property (nonatomic) BOOL enableCollisionWithElevationRaster;
@property (nonatomic) int collisionMeshGridSamples;
@property (nonatomic) BOOL activeCameraCollisionAvoidance;
@property (nonatomic) BOOL cameraCollisionGestures;
@property (nonatomic) BOOL cameraDebugSimplestCollisionGestures;
@property (nonatomic) BOOL drawCollisionHitPoints;
@property (nonatomic) BOOL drawCollisionRadii;
@property (nonatomic) int drawCameraPath;
@property (nonatomic) BOOL drawCollisionGeometries;
@property (nonatomic) BOOL enableBuildingCollisionGeometries;
@property (nonatomic) BOOL enableLandmarkCollisionGeometries;
...
- (id).cxx_construct;
- (const struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; } *)displayStyleOverride;
