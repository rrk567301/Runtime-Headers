...
@interface VKPolylinePath : NSObject {
    ...
    struct vector<gm::Matrix<float, 3, 1>, std::allocator<gm::Matrix<float, 3, 1>>> { void *__begin_; void *__end_; void *__cap_; } _points;
    struct vector<geo::PolylineCoordinate, std::allocator<geo::PolylineCoordinate>> { struct PolylineCoordinate *__begin_; struct PolylineCoordinate *__end_; struct PolylineCoordinate *__cap_; } _polylineCoordinates;
