...
@interface VKRouteLine : NSObject {
    ...
    struct ManeuverArrowCoordinates { struct vector<md::ManeuverArrowInfo, std::allocator<md::ManeuverArrowInfo>> { struct ManeuverArrowInfo *__begin_; struct ManeuverArrowInfo *__end_; struct ManeuverArrowInfo *__cap_; } _maneuverArrows; } _maneuverArrowCoordinates;
...
@property (readonly, nonatomic) struct vector<geo::fast_shared_ptr<md::RouteLineSection, mdm::allocator>, std::allocator<geo::fast_shared_ptr<md::RouteLineSection, mdm::allocator>>> { void *__begin_; void *__end_; void *__cap_; } sections;
...
@property (readonly, nonatomic) struct vector<Arrow, std::allocator<Arrow>> { struct Arrow *__begin_; struct Arrow *__end_; struct Arrow *__cap_; } arrows;
...
- (struct optional<std::pair<const unsigned int, const unsigned int>> { union { char x0; struct pair<const unsigned int, const unsigned int> { unsigned int x0; unsigned int x1; } x1; } x0; BOOL x1; })_getSnappedSegment:(struct fast_shared_ptr<md::RouteLineSection, mdm::allocator> { struct _fast_shared_ptr_control *x0; })a0 coord:(const struct PolylineCoordinate { unsigned int x0; float x1; } *)a1;
...
- (struct vector<gm::Matrix<float, 2, 1>, std::allocator<gm::Matrix<float, 2, 1>>> { void *x0; void *x1; void *x2; })maneuverPoints;
