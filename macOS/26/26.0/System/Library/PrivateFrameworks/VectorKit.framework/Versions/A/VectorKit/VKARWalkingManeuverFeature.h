...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithDisplayLocation:(struct { double x0; double x1; double x2; })a0 routeCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 maneuverHeading:(double)a2 displayText:(id)a3 elevationModel:(int)a4;
- (id)initWithDisplayLocation:(struct { double x0; double x1; double x2; })a0 routeCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 maneuverHeading:(double)a2 displayText:(id)a3 maneuverPriority:(unsigned long long)a4 elevationModel:(int)a5;
