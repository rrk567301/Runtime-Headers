...
@interface VKLabelNavRoad : NSObject <VKLabelNavFeature> {
    ...
    struct vector<gm::Matrix<double, 2, 1>, geo::allocator_adapter<gm::Matrix<double, 2, 1>, mdm::zone_mallocator>> { void *__begin_; void *__end_; void *__cap_; struct allocator_adapter<gm::Matrix<double, 2, 1>, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } _simplifiedPoints;
    struct vector<float, geo::allocator_adapter<float, mdm::zone_mallocator>> { float *__begin_; float *__end_; float *__cap_; struct allocator_adapter<float, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } _simplifiedPointElevations;
    double _length;
