...
@interface PXGMetalCaptureSpriteTexture : PXGPayloadTexture <PXGMetalSpriteTexture, NSCopying>

@property (readonly, copy, nonatomic) PXGCaptureSpritePayload *payload;
@property (readonly, nonatomic) unsigned long long behavior;
@property (readonly, nonatomic) id<MTLTexture> snapshotTexture;
