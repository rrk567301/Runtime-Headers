...
- (void)providePixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 forRequestID:(int)a3;
...
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 forRequestID:(int)a3;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 isDegraded:(BOOL)a3 forRequestID:(int)a4;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 forRequestID:(int)a2;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 isDegraded:(BOOL)a2 forRequestID:(int)a3;
...
- (void)providePixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 forRequestID:(int)a2;
