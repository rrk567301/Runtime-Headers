...
@interface PXGTextureManager : NSObject <PXGTextureProviderDelegate, PXGTextureAtlasManagerDelegate> {
    ...
    struct unordered_map<int, unsigned int, std::hash<int>, std::equal_to<int>, std::allocator<std::pair<const int, unsigned int>>> { struct __hash_table<std::__hash_value_type<int, unsigned int>, std::__unordered_map_hasher<int, std::__hash_value_type<int, unsigned int>, std::hash<int>, std::equal_to<int>>, std::__unordered_map_equal<int, std::__hash_value_type<int, unsigned int>, std::equal_to<int>, std::hash<int>>, std::allocator<std::__hash_value_type<int, unsigned int>>> { struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<int, unsigned int>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<int, unsigned int>, void *> *> *>>> { void **__ptr_; struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<int, unsigned int>, void *> *> *>> { unsigned long long __size_; } __deleter_; } __bucket_list_; struct __hash_node_base<std::__hash_node<std::__hash_value_type<int, unsigned int>, void *> *> { void *__next_; } __first_node_; unsigned long long __size_; float __max_load_factor_; } __table_; } _spriteIndexByRequestID;
    NSIndexSet *_loadedSpriteIndexes;
    struct { struct { unsigned int x0; } x0; int x1; unsigned char x2; unsigned char x3; unsigned short x4; void *x5; unsigned int x6; void *x7; unsigned int x8; unsigned int x9; unsigned char x10; BOOL x11; } *_streamInfoBySpriteIndex;
...
- (id)_createTextureForCGImage:(struct CGImage { } *)a0 requestID:(int)a1 requestDetails:(struct { unsigned char x0; unsigned int x1; })a2 processingOptions:(struct { BOOL x0; float x1; float x2; BOOL x3; })a3 fromTextureProvider:(id)a4 withTextureConverter:(id)a5;
- (id)_createTextureForCVPixelBuffer:(struct __CVBuffer { } *)a0 requestID:(int)a1 requestDetails:(struct { unsigned char x0; unsigned int x1; })a2 processingOptions:(struct { BOOL x0; float x1; float x2; BOOL x3; })a3 fromTextureProvider:(id)a4 withTextureConverter:(id)a5;
...
- (id)_existingTextureForCGImage:(struct CGImage { } *)a0 processingOptions:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 presentationType:(unsigned char)a2;
...
- (id)_existingTextureForPixelBuffer:(struct __CVBuffer { } *)a0 processingOptions:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 presentationType:(unsigned char)a2;
...
- (void)_lookupLock_requestTexturesForSpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x0; unsigned int x1; })a0 textureProvider:(id)a1 mediaKind:(unsigned char)a2 presentationType:(unsigned char)a3 isAppearing:(BOOL)a4 layout:(id)a5 leafSpriteIndexRange:(struct _PXGSpriteIndexRange { unsigned int x0; unsigned int x1; })a6 sprites:(struct { unsigned int x0; struct *x1; struct *x2; struct *x3; struct *x4; })a7 textureStreamInfos:(struct { struct { unsigned int x0; } x0; int x1; unsigned char x2; unsigned char x3; unsigned short x4; void *x5; unsigned int x6; void *x7; unsigned int x8; unsigned int x9; unsigned char x10; BOOL x11; } *)a8 loadingStatus:(id)a9;
- (void)_processCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 isDegraded:(BOOL)a3 fromTextureProvider:(id)a4 withTextureConverter:(id)a5 requestID:(int)a6 requestDetails:(struct { unsigned char x0; unsigned int x1; })a7 deliveryOrder:(unsigned int)a8;
- (void)_processPixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 fromTextureProvider:(id)a3 withTextureConverter:(id)a4 forRequestID:(int)a5 requestDetails:(struct { unsigned char x0; unsigned int x1; })a6 deliveryOrder:(unsigned int)a7;
...
- (id)_storeTexture:(id)a0 forKey:(id)a1 replaceExisting:(BOOL)a2 presentationType:(unsigned char)a3;
