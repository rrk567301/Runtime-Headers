...
- (struct { BOOL x0; float x1; float x2; BOOL x3; })_defaultStillImageTextureProcessingOptionsForAsset:(id)a0 orientation:(unsigned int)a1 applyCleanAperture:(BOOL)a2;
- (void)_handlePixelBufferChangedForTextureStreamingSession:(id)a0 useLowMemoryMode:(BOOL)a1;
...
- (void)_workQueue_provideCGImage:(struct CGImage { } *)a0 options:(struct { BOOL x0; float x1; float x2; BOOL x3; })a1 adjustment:(id)a2 isDegraded:(BOOL)a3 forRequestID:(int)a4;
- (void)_workQueue_provideVideoFrameForTextureStreamingSession:(id)a0 useLowMemoryMode:(BOOL)a1;
- (struct __CVBuffer { } *)_workQueue_renderCrossfadeIfNeededWithPixelBuffer:(struct __CVBuffer { } *)a0 forVideoSession:(id)a1 textureRequestID:(id)a2 useLowMemoryMode:(BOOL)a3;
- (void)_workQueue_requestVideoTexturesForSpriteAtIndex:(unsigned int)a0 spriteReference:(id)a1 displayAsset:(id)a2 presentationController:(id)a3 adjustment:(id)a4 presentationType:(unsigned char)a5 textureRequestID:(int)a6 mediaProvider:(id)a7 pixelBufferSourcesProvider:(id)a8 useLowMemoryMode:(BOOL)a9 spriteSize:(struct CGSize { double x0; double x1; })a10 displayScale:(double)a11;
- (void)_workQueue_startRequestingVideoTexturesForDisplayAsset:(id)a0 presentationController:(id)a1 pixelBufferSource:(id)a2 pixelBufferSourcesProvider:(id)a3 adjustment:(id)a4 textureRequestID:(int)a5 useLowMemoryMode:(BOOL)a6;
...
- (void)requestEntityPayloadForAsset:(id)a0 mediaProvider:(id)a1 requestOptions:(id)a2 resultHandler:(id /* block */)a3;
