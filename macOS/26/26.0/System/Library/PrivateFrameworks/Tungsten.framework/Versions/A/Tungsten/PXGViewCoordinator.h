@class PXGLayout, NSView, PXGTransitioningLayout, NSMapTable, PXMediaProvider, PXGView;

@interface PXGViewCoordinator : NSObject <PXGViewCoordinatorConfiguration> {
    NSMapTable *_backgroundColorByViewBeforeTransition;
}

@property (readonly, weak, nonatomic) NSView *containerView;
@property (readonly, weak, nonatomic) NSView *belowSubview;
...
@property (nonatomic) BOOL metalViewInScrollViewAllowed;
