...
- (id)init;
- (void).cxx_destruct;
- (id)_applyAdjustment:(id)a0 toMetalTexture:(id)a1 options:(struct { unsigned int x0; BOOL x1; float x2; })a2;
- (id)_createTextureFromCIImage:(id)a0 source:(id)a1 options:(struct { unsigned int x0; BOOL x1; float x2; })a2;
- (id)_createTransparentTexture;
- (id)_generateMipmapsForMetalTexture:(id)a0;
- (id)applyAdjustment:(id)a0 toTexture:(id)a1 options:(struct { unsigned int x0; BOOL x1; float x2; })a2;
...
- (id)createTextureFromCGImage:(SEL)a0 transform:(struct CGImage { } *)a1 alpha:(float)a2 options:(struct { unsigned int x0; BOOL x1; float x2; })a3 error:(id *)a4;
- (id)createTextureFromCVPixelBuffer:(SEL)a0 transform:(struct __CVBuffer { } *)a1 alpha:(float)a2 options:(struct { unsigned int x0; BOOL x1; float x2; })a3 error:(id *)a4;
