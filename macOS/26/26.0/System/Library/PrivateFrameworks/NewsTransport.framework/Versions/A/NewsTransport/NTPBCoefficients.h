@interface NTPBCoefficients : PBCodable <NSCopying> {
    struct { unsigned char autofavoritedScoreCoefficient : 1; unsigned char clientScoreCoefficient : 1; unsigned char conversionCoefficient : 1; unsigned char halfLifeCoefficient : 1; unsigned char serverScoreCoefficient : 1; unsigned char subscribedChannelScoreCoefficent : 1; unsigned char subscribedTopicScoreCoefficient : 1; unsigned char tabiScoreCoefficient : 1; } _has;
}
