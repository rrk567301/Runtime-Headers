...
+ (void)_extractEventsAndOrdersWithDocument:(_TtC21DocumentUnderstanding10DUDocument *)a0 documentType:(long long)a1 onBehalfOfPID:(long long)a2 completionHandler:(void (^)(NSArray *, NSError *))a3;
...
+ (id)filterOrderExtractionsWithExtractions:(id)a0 error:(id *)a1;
