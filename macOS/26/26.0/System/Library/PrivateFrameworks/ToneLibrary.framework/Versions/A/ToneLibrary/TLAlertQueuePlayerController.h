...
- (void).cxx_destruct;
- (void)_applyAudioVolume:(float)a0 forAlert:(id)a1 isForMusicPlayback:(BOOL)a2 phase:(long long)a3;
...
- (void)_didEndPlayingAlertForStateDescriptor:(id)a0 isForMusicPlayback:(BOOL)a1;
...
- (void)_notifyPlaybackObserverForStateDescriptor:(id)a0 isForMusicPlayback:(BOOL)a1;
...
- (void)_prepareAudioEnvironmentForStateDescriptor:(id)a0 isForMusicPlayback:(BOOL)a1;
...
- (void)_restoreAudioEnvironmentForStateDescriptor:(id)a0 isForMusicPlayback:(BOOL)a1;
...
- (void)_willBeginPlayingAlertForStateDescriptor:(id)a0 isForMusicPlayback:(BOOL)a1;
