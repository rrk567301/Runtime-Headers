...
- (id)initWithName:(id)a0 displayName:(id)a1 customTitle:(id)a2 identifier:(id)a3 userHandle:(id)a4 relyingPartyIdentifier:(id)a5 publicKeyCredentialOperationUUID:(id)a6 groupID:(id)a7 groupName:(id)a8;
