...
- (void)xpc_didFinishUploadingWithError:(id)a0 sessionID:(id)a1;
...
- (void)xpc_didLoadTextDataForExtensions:(id)a0 localization:(id)a1 sessionID:(id)a2;
...
- (void)xpc_compressionProgress:(unsigned long long)a0 total:(unsigned long long)a1 session:(id)a2;
- (void)xpc_stopDeviceDiscovery;
- (void)xpc_didDiscoverDevices:(id)a0;
- (void)xpc_hasActiveSessionReply:(id)a0 isActive:(BOOL)a1;
- (void)xpc_addData:(id)a0 withFilename:(id)a1 forSession:(id)a2;
...
- (void)xpc_pong;
- (void)xpc_forceRemoveNotificationOfType:(long long)a0 identifier:(id)a1 hostIdentifier:(id)a2;
...
- (void)xpc_loadTextDataForExtensions:(id)a0 localization:(id)a1 sessionID:(id)a2;
