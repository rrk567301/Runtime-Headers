@interface PassKitMacHelper.TransactionsModel : NSObject <PKDashboardTransactionFetcherDelegate, PKAccountServiceObserver> {
    ...
    void /* unknown type, empty encoding */ _transactionFetcher;
    void /* unknown type, empty encoding */ _updateUsersRequestQueue;
    void /* unknown type, empty encoding */ _requestInFlight;
