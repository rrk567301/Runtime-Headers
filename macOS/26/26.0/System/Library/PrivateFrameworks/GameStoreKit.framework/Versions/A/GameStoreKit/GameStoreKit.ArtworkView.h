@class _TtC12GameStoreKit11ArtworkView, NSString, NSImage, NSImageSymbolConfiguration, NSColor;

@interface GameStoreKit.ArtworkView : GameStoreKit.BaseView {
...
@property (class, nonatomic, readonly) _TtC12GameStoreKit11ArtworkView *iconArtworkView;
@property (class, nonatomic, readonly) _TtC12GameStoreKit11ArtworkView *iapIconArtworkView;
@property (class, nonatomic, readonly) _TtC12GameStoreKit11ArtworkView *cardArtworkView;
