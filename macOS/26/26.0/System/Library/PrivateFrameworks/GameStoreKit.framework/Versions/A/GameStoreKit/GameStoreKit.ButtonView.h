@class NSString, _TtC12GameStoreKit20DynamicTypeTextField, NSBezierPath, NSFont, NSAttributedString;

@interface GameStoreKit.ButtonView : GameStoreKit.ClickableView {
...
@property (nonatomic, readonly) _TtC12GameStoreKit20DynamicTypeTextField *titleLabelView;
@property (nonatomic, copy) NSString *title;
@property (nonatomic, retain) NSAttributedString *attributedTitle;
@property (nonatomic, retain) NSFont *titleFont;
@property (nonatomic) BOOL includeLastBaselineMeasurement;
@property (nonatomic) BOOL wantsPillShape;
