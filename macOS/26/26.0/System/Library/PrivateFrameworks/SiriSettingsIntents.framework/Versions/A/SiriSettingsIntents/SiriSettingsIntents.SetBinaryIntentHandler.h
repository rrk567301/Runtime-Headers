@class INSetBinarySettingIntent, INTemporalEventTriggerResolutionResult;
...
- (void)resolveTemporalEventTriggerForSetBinarySetting:(INSetBinarySettingIntent *)a0 withCompletion:(void (^)(INTemporalEventTriggerResolutionResult *))a1;
