...
- (id)createActivity;
- (void).cxx_destruct;
- (id)initWithContainerScheduler:(id)a0 metadataChangeToken:(id)a1 zoneHealthChangeToken:(id)a2 sideCarChangeToken:(id)a3 sessionContext:(id)a4;
- (BOOL)scheduleSyncDownIfNeededForZoneID:(id)a0 zoneIfAny:(id)a1 zoneType:(unsigned char *)a2;
