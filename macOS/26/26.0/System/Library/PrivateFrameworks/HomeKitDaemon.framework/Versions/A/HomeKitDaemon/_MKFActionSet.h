...
- (id)materializeOrCreateActionsRelationOfTypeMatterCommandActionWithModelID:(id)a0 createdNew:(BOOL *)a1;
...
- (BOOL)shouldIncludeForRestrictedGuestWithContext:(id)a0;
