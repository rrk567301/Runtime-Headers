@class HMEMessageDatagramClient, HMFMessageDispatcher, NSString, _TtC13HomeKitDaemon28HMDRemoteConnectivityMonitor, NSUUID, NSObject, NSNotificationCenter;
@protocol HMDRemoteEventRouterClientDataSource, OS_os_log, OS_dispatch_queue, HMMLogEventSubmitting;

@interface HMDRemoteEventRouterClient : NSObject <HMFMessageReceiver, HomeKitDaemon.HMDRemoteConnectivityMonitorDelegate, HMFLogging, HMEMessageDatagramClientDataSource, HMEMessageDatagramClientDelegate, HMDRemoteEventRouterAssertionClient> {
...
@property (readonly) BOOL isPrimaryResident;
@property (readonly) HMEMessageDatagramClient *eventRouterClient;
@property (readonly, nonatomic) BOOL hasConnectivityToServer;
...
- (void)hasConnectivityDidChangeFor:(id)a0;
