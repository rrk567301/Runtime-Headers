...
@protocol HMDMetricsDeviceStateProvider, HMMLogEventDispatching, HMDUserNotificationCenterSettingsProviding, HMMRadarInitiating, HMDEWSLogging, HMMDailyTaskBookend, OS_dispatch_queue, HMMUptimeProvider, HMMLogEventSubmitting;
...
@property (retain, nonatomic) id<HMMDailyTaskBookend> countersBookend;
