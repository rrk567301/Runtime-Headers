...
@property (nonatomic) unsigned long long sendAttemptCount;
...
@property (readonly, getter=isMigrationInvitation) BOOL migrationInvitation;
...
- (BOOL)shouldRetrySendingInvitationForError:(id)a0;
