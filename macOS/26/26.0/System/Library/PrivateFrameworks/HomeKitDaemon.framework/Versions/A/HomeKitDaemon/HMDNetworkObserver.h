@class HMMDailyScheduler, NSString, HMMDateProvider, HMFTimer, NSMutableDictionary, HMFWifiNetworkAssociation, HMFWiFiManager, HMDEventCountersManager, NSNotificationCenter;
