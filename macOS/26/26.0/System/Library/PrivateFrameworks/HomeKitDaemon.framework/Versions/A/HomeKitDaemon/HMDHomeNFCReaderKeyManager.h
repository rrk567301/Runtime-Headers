...
- (void).cxx_destruct;
- (void)createReaderKeyInKeychainForHome:(id)a0 isForceUpdate:(BOOL)a1 flow:(id)a2 completion:(id /* block */)a3;
- (void)configureWithHome:(id)a0;
- (id)createNFCReaderKeyModelWithHome:(id)a0 nfcReaderKey:(id)a1;
- (void)createReaderKeyInKeychainForHome:(id)a0 isForceUpdate:(BOOL)a1 flow:(id)a2;
