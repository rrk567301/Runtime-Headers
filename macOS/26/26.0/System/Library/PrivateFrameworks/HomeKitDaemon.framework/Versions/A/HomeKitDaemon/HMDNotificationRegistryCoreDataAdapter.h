...
- (id)_characteristicRegistrationsIncludeEnabled:(BOOL)a0 includeDisabled:(BOOL)a1;
...
- (id)_fetchRequestForCharacteristicRegistrations:(BOOL)a0 enabled:(BOOL)a1 destination:(id)a2 propertiesToFetch:(id)a3 relationshipKeyPathsForPrefetching:(id)a4;
