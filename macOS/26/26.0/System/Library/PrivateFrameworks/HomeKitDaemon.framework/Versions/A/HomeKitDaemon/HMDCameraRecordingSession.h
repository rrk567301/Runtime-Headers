@class NSUUID, HMDDataStreamFragment, HMDCameraRecordingSessionTimelineManager, NSObject, HMBLocalZone, HMIVideoFragment, HMFActivity, HMDCameraProfile, NSDictionary, NSString, HMDCameraRecordingSessionVariantFragmentManager, NSNumber, NSData, HMDCameraRecordingSessionSignificantEventManager, HMIVideoAnalyzerFragmentResult;
@protocol HMDCameraRecordingSessionVideoAnalyzer, HMDCameraClipUploading, HMDCameraRecordingSessionDelegate, OS_dispatch_queue, HMDCameraRecordingSessionFactory;

@interface HMDCameraRecordingSession : HMFObject <HMFLogging, HMDCameraRecordingSessionVideoAnalyzerDelegate, HMDCameraClipUploadingDelegate, HMDCameraRecordingSessionVariantFragmentManagerDelegate>
