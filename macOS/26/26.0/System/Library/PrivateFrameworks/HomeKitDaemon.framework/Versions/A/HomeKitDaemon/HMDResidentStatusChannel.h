@class NSMutableDictionary, NSNotificationCenter, HMDFeaturesDataSource, NSObject, HMFFuture, NSString, NSSet, NSHashTable, HMDResidentStatusChannelManager, HMDResidentStatus, HMDHome, HMFPromise, HMFTimer, HMDUnpublishedResidentStatus;
@protocol OS_dispatch_queue, HMDSDumpState, HMDStatusChannelProtocol, HMMLogEventSubmitting, HMFTimerProvider;
