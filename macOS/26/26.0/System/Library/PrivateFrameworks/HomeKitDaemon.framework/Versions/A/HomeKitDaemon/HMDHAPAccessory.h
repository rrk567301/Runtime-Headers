...
- (void)_handleReadCharacteristicResponse:(id)a0 hapCharacteristics:(id)a1 hapAccessory:(id)a2 retryExpiry:(double)a3 expiry:(id)a4 overallError:(id)a5 completionBlock:(id /* block */)a6;
...
- (void)_handleWriteCharacteristicResponse:(id)a0 hapWriteRequestTuples:(id)a1 hapAccessory:(id)a2 retryExpiry:(double)a3 expiry:(id)a4 overallError:(id)a5 completionBlock:(id /* block */)a6;
