...
- (void)assistantAccessControlModelRemoved:(id)a0;
- (void)assistantAccessControlModelUpdated:(id)a0 previousModel:(id)a1;
...
- (void)mediaContentProfileAccessControlModelRemoved:(id)a0;
- (void)mediaContentProfileAccessControlModelUpdated:(id)a0 previousModel:(id)a1;
- (void)performFirstRunOperationsOnPrivateZoneController:(id)a0;
- (void)performFirstRunOperationsOnSharedZoneController:(id)a0;
- (void)sharedUserDataModelUpdated:(id)a0 previousModel:(id)a1;
- (long long)sharedUserSettingsLogEventBackingStoreControllerRunState;
- (id)updateListeningHistoryModelToReset;
- (void)userListeningHistoryUpdateControlModelRemoved:(id)a0;
- (void)userListeningHistoryUpdateControlModelUpdated:(id)a0 previousModel:(id)a1;
