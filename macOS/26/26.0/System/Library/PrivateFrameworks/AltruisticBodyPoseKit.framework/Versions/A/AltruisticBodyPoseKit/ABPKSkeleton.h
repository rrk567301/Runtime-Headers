...
@interface ABPKSkeleton : NSObject {
    struct vector<ABPKTransform, std::allocator<ABPKTransform>> { struct ABPKTransform *__begin_; struct ABPKTransform *__end_; struct ABPKTransform *__cap_; } _localPoses;
    struct vector<simd_float4x4, std::allocator<simd_float4x4>> { struct *__begin_; struct *__end_; struct *__cap_; } _modelPoses;
}
