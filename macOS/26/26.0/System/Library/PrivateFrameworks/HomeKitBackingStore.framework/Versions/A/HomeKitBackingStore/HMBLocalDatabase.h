...
- (BOOL)reopenZone:(id)a0 error:(id *)a1;
- (id)removeZone:(id)a0;
- (id)_openZoneWithZoneID:(id)a0 mirror:(id)a1 configuration:(id)a2 existingLocalZone:(id)a3 error:(id *)a4;
- (id)fetchZonesWithError:(id *)a0;
- (id)logIdentifier;
- (id)openZoneWithMirror:(id)a0 configuration:(id)a1 error:(id *)a2;
- (id)initWithDatastorePath:(id)a0 configuration:(id)a1 error:(id *)a2;
