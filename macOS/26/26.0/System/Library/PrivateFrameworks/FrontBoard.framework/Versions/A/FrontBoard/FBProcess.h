@class BSProcessHandle, FBProcessManager, FBSProcessExecutionProvision, FBSProcessTerminationRequest, FBProcessWatchdogEventContext, NSMutableArray, NSString, BSMachPortTaskNameRight, RBSProcessHandle, FBProcessExitContext, NSMutableSet, RBSProcessIdentity, NSError, RBSAssertion, BSAbsoluteMachTimer, RBSProcessState, FBSProcessWatchdogPolicy, FBWorkspace, NSObject, FBProcessState, RBSTarget, FBProcessWatchdog, FBProcessCPUStatistics, FBSApplicationInfo, FBProcessExecutionContext, BSAuditToken;
@protocol FBProcessDelegate, OS_dispatch_workloop, FBProcessWatchdogProviding, OS_dispatch_queue;
...
@property (class, readonly, retain, nonatomic) NSObject<OS_dispatch_workloop> *userInitiatedWorkloop;
...
- (id)_initWithProcessManager:(id)a0 identity:(id)a1 handle:(id)a2 executionContext:(id)a3;
...
- (BOOL)_setSceneLifecycleState:(unsigned char)a0;
