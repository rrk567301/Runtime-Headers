@class FBSSceneIdentityToken, FBSSceneClientSettings, NSMapTable, FBProcess, FBSceneWorkspace, FBSSceneSpecification, FBSceneClientHandle, FBSSceneSettings, NSMutableArray, FBSceneLayerManager, FBSSceneDefinition, NSString, FBSceneObserver, NSMutableOrderedSet, FBSceneEventQueue, FBSceneRemnant, FBSSceneIdentity, FBSSceneUpdate, FBSScene, FBSSceneParameters;
@protocol FBSceneClient, FBSceneDelegate, BSInvalidatable, FBSProcess, NSObject;
...
- (id)prepareSnapshotWithConfigurator:(id /* block */)a0;
- (id)uiClientSettings;
- (id)uiSettings;
