@class NSMutableDictionary, LNAppIntentConnectionPolicy, LNFullyQualifiedActionIdentifier, NSDictionary, NSObject, LNActionSummary, LNActionMetadata, LNActionConfigurationContext, WFActionParameterSummary, NSString, NSSet, LNSystemContext, LNActionExecutorOptions, LNAttribution, LNUndoContext, NSNumber, LNConnectionPolicySignals, LNConnection, INAppIntentDescriptor;
...
- (id)alertForLinkActionConfirmationWithActionMetadata:(id)a0 dialogString:(id)a1 request:(id)a2 encodedSnippetActionToolInvocation:(id)a3;
...
- (void)postProcessToolKitProcessedValue:(id)a0 forParameter:(id)a1 completionHandler:(id /* block */)a2;
