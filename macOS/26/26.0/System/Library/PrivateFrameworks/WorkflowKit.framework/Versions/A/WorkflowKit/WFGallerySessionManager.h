...
- (void)addLocalContent:(id)a0 toPage:(id)a1;
...
- (id)getImageForBanner:(id)a0 completionHandler:(id /* block */)a1;
- (void)getPageWithID:(id)a0 completionHandler:(id /* block */)a1;
- (void)getPageWithID:(id)a0 localContent:(id)a1 completionHandler:(id /* block */)a2;
...
- (id)localPageWithId:(id)a0;
- (id)preferredPageInPages:(id)a0 preferredLanguages:(id)a1;
- (id)queryFilterForTokenizedKey:(id)a0 query:(id)a1;
- (void)removeRestrictedContentFromCollection:(id)a0;
- (void)removeRestrictedContentFromPage:(id)a0;
