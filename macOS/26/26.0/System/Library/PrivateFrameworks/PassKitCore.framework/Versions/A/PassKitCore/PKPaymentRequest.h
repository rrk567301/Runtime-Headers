...
@property (retain, nonatomic) NSArray *thumbnailImages;
...
@property (readonly) BOOL _shouldSupportLandscapeOrientation;
@property (readonly, nonatomic, getter=isMultiTokenRequest) BOOL multiTokenRequest;
@property (readonly, nonatomic) BOOL isRemoteNetworkRequest;
