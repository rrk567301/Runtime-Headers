@class NSDate, NSString, NSArray, PKPassProvisioningMetadata, NSSet, NSURL, PKCurrencyAmount, PKPassAuxiliaryRegistrationRequirements, PKPaymentApplication, PKSiriIntentsConfiguration, PKTransitPassProperties;
...
@property (readonly, nonatomic) BOOL isPaymentOptionSelectable;
...
- (BOOL)supportsDeepLinkingTransactions;
