...
@property (retain, nonatomic) NSMutableArray *thumbnailImages;
@property (nonatomic) BOOL hasSuppressLandscape;
@property (nonatomic) BOOL suppressLandscape;
...
- (id)thumbnailImagesAtIndex:(unsigned long long)a0;
- (unsigned long long)thumbnailImagesCount;
