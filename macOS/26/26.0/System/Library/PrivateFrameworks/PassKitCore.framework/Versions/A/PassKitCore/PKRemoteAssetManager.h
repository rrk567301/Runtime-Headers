...
- (void)_downloadRemoteAssetsWithScreenScale:(double)a0 suffix:(id)a1 cloudStoreCoordinatorDelegate:(id)a2 requireRequiredAssets:(BOOL)a3 includeEncryptedAssets:(BOOL)a4 completion:(id /* block */)a5;
...
- (void)cacheRemoteAssetData:(id)a0 forManifestItem:(id)a1;
...
- (void)downloadRemoteAssetsWithScreenScale:(double)a0 suffix:(id)a1 cloudStoreCoordinatorDelegate:(id)a2 ignoreRequiredAssetDownloadFailures:(BOOL)a3 includeEncryptedAssets:(BOOL)a4 completion:(id /* block */)a5;
