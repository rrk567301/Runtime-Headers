@class NSDecimalNumber, NSDictionary, PKAccountEvent, PKCreditInstallmentPlan, PKPeerPaymentRecurringPayment, NSOrderedSet, PKPaymentTransactionFees, PKCurrencyAmount, NSString, FKPaymentTransaction, PKAccountServicingEvent, PKMerchant, PKTransactionAuthenticationContext, NSArray, PKPaymentTransactionRewards, NSSet, PKPaymentTransactionForeignExchangeInformation, NSData, PKCreditInstallmentPlanPayment, PKPaymentRewardsRedemption, CLLocation, PKAccountServicingEventStatusDetails, NSUUID, PKTransactionReleasedData, NSDate, NSTimeZone, NSNumber, NSURL;
