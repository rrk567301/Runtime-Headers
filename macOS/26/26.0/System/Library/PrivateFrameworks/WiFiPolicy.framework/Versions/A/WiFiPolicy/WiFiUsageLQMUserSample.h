...
@property (nonatomic) BOOL isAVcallOnWiFi;
@property (nonatomic) BOOL isNwAppInFG;
...
- (void)populateWithMotionState:(id)a0 andAppState:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; })a1;
- (long long)rssiForTD;
