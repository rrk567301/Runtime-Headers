@class WiFiSoftError, NSMutableDictionary, WiFiUsageInterfaceStats, NSDate, NSDictionary, NSObject, WiFiUsageAccessPointProfile, WAMessage, NSMutableArray, NSString, WiFiUsageNetworkDetails, WiFiUsageRangingSession, NSArray, NSNumber;
...
@property (retain) NSNumber *lqmDistributionSampling_telemetry;
@property (retain) NSNumber *lqmDistributionSampling_store;
