...
- (void).cxx_destruct;
- (id)initWithMaxConcurrentOperationCount:(long long)a0 qualityOfService:(unsigned long long)a1 name:(id)a2;
- (id)initWithMaxConcurrentOperationCount:(long long)a0 underlyingDispatchQueue:(id)a1 qualityOfService:(unsigned long long)a2;
- (id)initWithOperationQueue:(id)a0 qualityOfService:(unsigned long long)a1;
