@class NSMutableDictionary, SCROBrailleUIKeyCommandAdapter, NSObject, SCROBrailleDisplay, SCRO2DBrailleData, NSMutableArray, SCROBrailleUIVisualManager, SCROBrailleDisplayManagerStatus, NSString, NSAttributedString, NSMutableSet, SCROBrailleFormatter, SCROBrailleDisplayManagedQueue, NSData, SCROBrailleDisplayHistory;
@protocol OS_dispatch_queue, OS_dispatch_source, SCROSBrailleDisplayManagerDelegate;

@interface SCROBrailleDisplayManager : NSObject <SCROBrailleUIAppDelegate, SCROBrailleUIDisplayManagerSpeechDelegate, AXFUserSessionObserverDelegate, SCROBrailleDisplayDelegate, BRLTBrailleModelDelegate> {
...
- (void)userSessionObserverScreenLockUIShown:(id)a0;
...
- (void)userSessionObserverUserWillLogOut:(id)a0;
...
- (void)_eventQueue_didChangeBrailleString:(id)a0 brailleSelection:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 brailleUIOptions:(id)a2;
...
- (BOOL)_eventQueue_handleBrailleUICommand:(id)a0;
- (BOOL)_eventQueue_handleBrailleUIKeyPress:(id)a0;
- (void)_eventQueue_handleBrailleUIResponse:(id)a0 forRequest:(id)a1;
- (BOOL)_eventQueue_handleSystemVirtualDisplayKeyPress:(id)a0;
...
- (void)_eventQueue_requestSpeech:(id)a0 language:(id)a1 shouldQueue:(BOOL)a2;
...
- (void)_eventQueue_setBrailleFormatter:(id)a0;
...
- (void)_eventQueue_startBrailleUI:(id)a0;
...
- (void)_eventQueue_virtualDisplay:(unsigned long long)a0 pressRouterWithIndex:(unsigned long long)a1 withSpace:(BOOL)a2;
- (BOOL)_hasPlanarDisplay;
- (BOOL)_isBrailleUIActive;
- (BOOL)_isIOElementHID:(id)a0;
...
- (void)endBrailleUI;
- (void)endBrailleUI:(id)a0;
- (void)exitCurrentDisplayMode;
- (void)handleBrailleUIRequest:(id)a0;
- (void)handleBrailleUIResponse:(id)a0 forRequest:(id)a1;
...
- (void)processBrailleUICommand:(id)a0;
...
- (void)virtualDisplay:(unsigned long long)a0 pressRouterWithIndex:(unsigned long long)a1 withSpace:(BOOL)a2;
