...
@interface _SDSSessionNewStreamAck : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct SessionNewStreamAck { unsigned char x0[1]; } *_ptr;
}
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct SessionNewStreamAck { unsigned char x0[1]; } *)a1;
