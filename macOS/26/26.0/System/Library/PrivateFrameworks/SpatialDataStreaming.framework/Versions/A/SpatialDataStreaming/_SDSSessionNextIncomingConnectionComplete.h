...
@interface _SDSSessionNextIncomingConnectionComplete : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct SessionNextIncomingConnectionComplete { unsigned char x0[1]; } *_ptr;
}
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct SessionNextIncomingConnectionComplete { unsigned char x0[1]; } *)a1;
