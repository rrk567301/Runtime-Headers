...
@interface _SDSSessionNewStreamIntent : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct SessionNewStreamIntent { unsigned char x0[1]; } *_ptr;
}
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct SessionNewStreamIntent { unsigned char x0[1]; } *)a1;
