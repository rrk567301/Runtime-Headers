@class NSArray, AFBBufRef;

@interface _SDSDataLayoutNode : NSObject <AFBBufferReferencing, NSCopying> {
    AFBBufRef *_br;
    const struct DataLayoutNode { unsigned char x0[1]; } *_ptr;
}

@property (readonly, nonatomic) NSArray *flattenedLayout;
...
- (id)initWithBufRef:(id)a0 cppPointer:(const struct DataLayoutNode { unsigned char x0[1]; } *)a1;
