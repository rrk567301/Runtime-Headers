...
- (void)_enumerateListDescendantsOnChildrenAccessQueueUsingBlock:(id /* block */)a0;
...
- (void)enumerateListDescendantsUsingBlock:(id /* block */)a0;
...
- (struct vector<unsigned long, std::allocator<unsigned long>> { unsigned long long *x0; unsigned long long *x1; unsigned long long *x2; })indexesForShownCollectionsWithChildCount:(unsigned long long *)a0;
