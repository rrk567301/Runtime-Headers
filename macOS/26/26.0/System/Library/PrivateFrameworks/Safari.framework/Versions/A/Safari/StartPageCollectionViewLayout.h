...
@interface StartPageCollectionViewLayout : NSCollectionViewLayout {
    ...
    BOOL _isViewFlipped;
    BOOL _isViewRTL;
    struct NSEdgeInsets { double top; double left; double bottom; double right; } _cachedSafeAreaInsets;
...
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_scrollViewSafeAreaInsets;
