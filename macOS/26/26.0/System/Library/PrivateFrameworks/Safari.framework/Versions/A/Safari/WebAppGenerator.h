...
@interface WebAppGenerator : NSObject {
    ...
    struct unique_ptr<SafariShared::SuddenTerminationDisabler, std::default_delete<SafariShared::SuddenTerminationDisabler>> { struct SuddenTerminationDisabler *__ptr_; } _appGenerationSuddenTerminationDisabler;
}
