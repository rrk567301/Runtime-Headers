@class NSTextField, NSView, NSArray, WKWebpagePreferences, NSStackView, NSPopUpButton, TabsLayoutPreviewButton, NSButton;
...
@property (class, readonly, nonatomic) BOOL showsStandaloneTabBar;
...
@property (weak, nonatomic) NSTextField *tabLayoutLabel;
