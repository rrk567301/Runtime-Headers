@class NSString, WKPreferences, _WKAutomationSession, NSMutableSet;
...
- (id)_automationSession:(id)a0 defaultTextOfCurrentJavaScriptDialogForWebView:(id)a1;
...
- (void)_automationSession:(id)a0 loadWebExtensionWithOptions:(long long)a1 resource:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)_automationSession:(id)a0 unloadWebExtensionWithIdentifier:(id)a1 completionHandler:(id /* block */)a2;
- (id)_automationSession:(id)a0 userInputOfCurrentJavaScriptDialogForWebView:(id)a1;
...
- (id)_processPool;
- (void)_removeTemporaryExtensions;
