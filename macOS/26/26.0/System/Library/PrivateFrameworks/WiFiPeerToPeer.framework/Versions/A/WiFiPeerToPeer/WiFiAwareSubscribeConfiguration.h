@class WiFiAwareMulticastConfiguration, NSString, WiFiMACAddress, NSData, WiFiAwareFastDiscoveryConfiguration, NSSet, WiFiChannel;
...
- (id)initWithServiceName:(id)a0 discoveryMode:(long long)a1;
