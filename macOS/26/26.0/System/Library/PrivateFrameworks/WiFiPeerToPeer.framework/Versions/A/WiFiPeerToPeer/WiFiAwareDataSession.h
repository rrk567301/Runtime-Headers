@class NSData, NSString, WiFiAwareDiscoveryResult, WiFiAwareInternetSharingConfiguration, WiFiAwarePairingMetadata, WiFiMACAddress, WiFiP2PXPCConnection, NSNumber, WiFiAwarePublishDatapathServiceSpecificInfo, WiFiAwarePublishServiceSpecificInfo;
...
- (void)datapathConfirmedForPeerDataAddress:(id)a0 serviceSpecificInfo:(id)a1 pairingKeyStoreID:(id)a2;
