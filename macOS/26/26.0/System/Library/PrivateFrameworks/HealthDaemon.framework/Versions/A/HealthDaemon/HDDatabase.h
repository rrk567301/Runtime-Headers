@class HKProfileIdentifier, NSDictionary, HKObserverSet, NSMutableArray, NSString, NSMutableSet, HDDatabaseConfiguration, HDWorkoutUtilities, HDContentProtectionManager, HDXPCGatedActivity, NSMutableDictionary, NSObject, NSLock, NSOperationQueue, HDDatabaseJournal, HDDatabaseAssertionManager, NSUUID, HDProfile, NSDate, NSConditionLock, NSHashTable;
...
- (id)takeAccessibilityAssertionWithOwnerIdentifier:(id)a0 contextType:(long long)a1 shouldPerformTransaction:(BOOL)a2 error:(id *)a3;
...
- (void)invalidateAllAssertionsWithContextType:(long long)a0;
...
- (id)takeAccessibilityAssertionWithOwnerIdentifier:(id)a0 contextType:(long long)a1 error:(id *)a2;
