@class HDAssertion, NSString, NSDate, NSSet, HDPeriodicActivity, NSMutableDictionary, HDDatabaseCoalescedWritePool, HDProfile, NSObject, NSMutableArray, HDFakeDataCollector, HDSeriesQuantityEventObserver;
...
- (id)init;
- (void)generateFakeDataForActivityType:(long long)a0 startDate:(id)a1 seconds:(double)a2 completion:(id /* block */)a3;
...
- (void)_setObserverRemovedHandler:(id /* block */)a0;
- (void)periodicUpdate;
