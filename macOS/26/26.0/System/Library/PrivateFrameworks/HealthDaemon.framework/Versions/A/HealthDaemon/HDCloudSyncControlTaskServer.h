...
- (id)remoteInterface;
- (void)remote_cloudSyncEntityVersions:(id /* block */)a0;
- (void)remote_accountConfigurationDidChangeWithCompletion:(id /* block */)a0;
- (void)remote_cloudSyncProtocolVersion:(id /* block */)a0;
...
- (id)remote_fetchCloudDescriptionUseDescriptionForLogs:(BOOL)a0 prettyPrinted:(BOOL)a1 updateCacheAndPrepareForSync:(BOOL)a2 withCompletion:(id /* block */)a3;
...
- (void)remote_modifyRecordsToCreate:(id)a0 recordsToDelete:(id)a1 completion:(id /* block */)a2;
