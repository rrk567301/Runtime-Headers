@class HDCloudSyncCodableSequence, NSUUID, HDSyncAnchorMap, NSSet, CKRecordID, HDCodableSyncEntityVersionMap, CKReference;
...
- (BOOL)hasFutureSyncEntityVersions:(id)a0;
...
- (void)updateSyncProtocolVersion:(int)a0 syncEntityVersions:(id)a1;
