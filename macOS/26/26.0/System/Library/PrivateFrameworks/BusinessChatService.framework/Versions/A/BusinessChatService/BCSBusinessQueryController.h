...
@property (retain, nonatomic) id<BCSItemResolving> webPresentmentItemResolver;
...
- (void)fetchBrandWithIdentifier:(id)a0 forClientBundleID:(id)a1 serviceType:(long long)a2 completion:(id /* block */)a3;
