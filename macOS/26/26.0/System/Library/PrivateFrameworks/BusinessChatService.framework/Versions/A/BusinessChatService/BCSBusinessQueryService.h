...
- (void)fetchBrandWithIdentifier:(id)a0 serviceType:(long long)a1 completion:(id /* block */)a2;
...
- (void)fetchWebPresentmentPermissionsWithIdentifier:(id)a0 completion:(id /* block */)a1;
