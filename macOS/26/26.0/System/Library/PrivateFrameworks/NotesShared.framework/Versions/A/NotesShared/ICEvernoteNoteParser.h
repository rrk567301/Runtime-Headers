...
- (id)archiveItemsFromFileURL:(id)a0 error:(id *)a1;
- (void)cleanupArchiveId:(id)a0;
- (unsigned long long)countEvernoteNotesFromFileURL:(id)a0;
- (id)dateFromDateString:(id)a0;
- (id)importDirectoryURLWithImportIdentifier:(id)a0;
- (void)parseFileAtFileURL:(id)a0 shouldCountOnly:(BOOL)a1;
