...
@interface CBFrameStats : NSObject {
    ...
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; float *__cap_; } _rtplcFrameDelayedNitsTable;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; float *__cap_; } _rtplcFrameDelayedAPCETable;
