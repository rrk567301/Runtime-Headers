...
- (struct ColorSensorVendorEventData { unsigned int x0; unsigned char x1; unsigned char x2; unsigned short x3; unsigned int x4; unsigned int x5; int x6; float x7; float x8; float x9[6]; float x10; short x11[6]; float x12; unsigned int x13; int x14; unsigned short x15; BOOL x16; unsigned int x17[6]; BOOL x18; float x19[3]; float x20[3]; float x21; BOOL x22; })copyVendorDataFromEvent:(struct __IOHIDEvent { } *)a0;
- (id)description;
- (id)initWithHIDEvent:(struct __IOHIDEvent { } *)a0 andNode:(id)a1;
