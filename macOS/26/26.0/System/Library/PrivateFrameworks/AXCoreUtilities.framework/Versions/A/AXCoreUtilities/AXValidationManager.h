...
- (BOOL)validateClass:(id)a0 hasInstanceMethod:(id)a1 withReturnType:(id)a2 args:(id)a3;
...
- (BOOL)validateClass:(id)a0 hasClassMethod:(id)a1 withReturnType:(id)a2 args:(id)a3;
