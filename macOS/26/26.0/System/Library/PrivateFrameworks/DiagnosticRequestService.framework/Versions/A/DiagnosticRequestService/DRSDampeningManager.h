...
+ (id)_appIntentsServicesTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
+ (id)_coreDuetPeopleSuggesterTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
+ (id)defaultTeamConfigurationsForCurrentDevice:(id)a0;
+ (id)_mssTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
+ (unsigned long long)defaultTotalCapForIsInternal:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2;
+ (id)_newsTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
...
+ (id)_healthkitTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
...
+ (id)_spotlightTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
...
+ (id)_softwareUpdateTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
...
+ (id)_entityName;
+ (id)_libtraceTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
...
+ (id)_backlightServicesTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
+ (id)_pearlTeamConfiguration:(BOOL)a0 isSeed:(BOOL)a1 isCarrier:(BOOL)a2 platform:(unsigned char)a3;
