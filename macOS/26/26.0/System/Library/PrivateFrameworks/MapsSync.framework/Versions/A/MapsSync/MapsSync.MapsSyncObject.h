...
@interface MapsSync.MapsSyncObject : NSObject {
    ...
    void /* unknown type, empty encoding */ cachedHashingDescriptor;
...
- (BOOL)isSemanticallyEqual:(id)a0;
- (id)onDeleteWithManagedObject:(id)a0 context:(id)a1;
- (void)performEditsOnContextWithLock:(id)a0 managedObject:(id)a1 context:(id)a2;
- (void)performEditsWithManagedObject:(id)a0 context:(id)a1;
