@class AVURLAssetInternal, NSArray, NSString, AVAssetResourceLoader, AVMediaExtensionProperties, NSURL, NSUUID;

@interface AVURLAsset : AVAsset <AVContentKeyRecipientInternal, AVContentKeyRecipient> {
    AVURLAssetInternal *_URLAsset;
}

@property (class, readonly, copy) NSArray *audiovisualContentTypes;
