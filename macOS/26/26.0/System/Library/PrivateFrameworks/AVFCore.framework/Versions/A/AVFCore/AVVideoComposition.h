...
+ (id)videoCompositionWithVideoComposition:(id)a0;
...
- (void)setLookupableSpatialVideoConfigurations:(id)a0;
- (void)setOutputBufferDescription:(id)a0;
...
- (void)setSpatialVideoConfigurations:(id)a0;
