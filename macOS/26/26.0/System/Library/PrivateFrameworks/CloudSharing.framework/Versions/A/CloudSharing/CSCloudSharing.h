...
+ (void)addParticipantsToShare:(id)a0 containerSetupInfo:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 completionHandler:(id /* block */)a5;
+ (void)completeShare:(id)a0 containerSetupInfo:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 completionHandler:(id /* block */)a5;
...
+ (void)shareFolderRemovingSubshares:(id)a0 emailAddresses:(id)a1 phoneNumbers:(id)a2 optionsGroups:(id)a3 completionHandler:(id /* block */)a4;
...
+ (void)addParticipantsToShareWithURLWrapper:(id)a0 share:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 optionsGroups:(id)a4 completionHandler:(id /* block */)a5;
+ (void)addParticipantsToShareWithURLWrapper:(id)a0 share:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3 permissionType:(long long)a4 allowOthersToInvite:(BOOL)a5 completionHandler:(id /* block */)a6;
