@class NSString, NSArray, MPNowPlayingInfoCenter, MPRemoteCommandCenter, _MPCMediaRemotePublisher_Swift, _MPCMediaRemoteDetective, NSObject, NSDictionary, MPCPlaybackEngine;
