...
@protocol MPCQueueControllerBehaviorMusicSharePlay, MPCQueueControllerPlaybackEngine, MPCQueueControllerBehaviorImplementation, MPCQueueControllerBehaviorMusic, MPCQueueControllerUpNextBehavior, MPCQueueControllerReusableBehavior, MPCQueueControllerBehavior, MPCQueueControllerDelegate, MPCQueueControllerBehaviorTransitionTogglableImplementation;
...
- (BOOL)isUserSelectedContentItemID:(id)a0;
