...
- (void)_notifyObserversForChange:(id)a0;
- (void)_setNeedsRefreshDueToMissingBag:(BOOL)a0;
- (void)_subscriptionStatusChangedNotification:(id)a0;
- (void)_updateAccountsWithAttemptCount:(long long)a0 completion:(id /* block */)a1;
...
- (id)musicPlaybackRequestEnvironmentForAccount:(id)a0;
