...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_adjustElementFrameForOrientationDisagreement:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 deviceOrientation:(long long)a1 interfaceOrientation:(long long)a2 deviceSize:(struct CGSize { double x0; double x1; })a3;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_rotateCoordinateSystemForNormalizedFrameInBottomLeft:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 deviceOrientation:(long long)a1;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_rotateFrameAboutBottomLeftCorner:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 deviceOrientation:(long long)a1;
...
- (id)initWithCachedTreeClientType:(unsigned long long)a0;
