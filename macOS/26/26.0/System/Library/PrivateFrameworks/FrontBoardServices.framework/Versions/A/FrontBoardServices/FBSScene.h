@class FBSSceneIdentityToken, FBSWorkspaceService, NSMapTable, BSServiceQueue, FBSSceneSpecification, BKSAnimationFenceHandle, FBSSceneSettings, NSMutableArray, FBSSceneDefinition, NSString, FBSSceneHostHandle, FBSSceneUpdate, BSAuditToken, FBSSceneIdentity, FBSSceneClientSettings;
...
- (void)_callOutQueue_ensureCoalesceClientSettingsUpdates:(id /* block */)a0;
- (void)_callOutQueue_invalidate;
- (void)_callOutQueue_maybeCoalesceClientSettingsUpdates:(id /* block */)a0;
