...
- (BOOL)_associatedPayloads:(id)a0 shouldUpdateToPayloads:(id)a1;
- (void)_dataSourceDidChange;
- (id)_findMatchForAssociatedPluginPayload:(id)a0 inArray:(id)a1;
...
- (id)_summaryText;
- (void)_updatePayload:(id)a0 associatedPayloads:(id)a1 messageID:(long long)a2 messageGUID:(id)a3;
- (void)_updateTemporaryAttachmentURLsForPluginPayload;
- (unsigned long long)_updateWithPluginPayload:(id)a0 associatedPayloads:(id)a1 messageID:(long long)a2 messageGUID:(id)a3;
