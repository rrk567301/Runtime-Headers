...
@property (readonly, nonatomic) BOOL eligibleForRetry;
...
- (void)readValueForCharacteristic:(id)a0 timeout:(double)a1 expiry:(id)a2 completionQueue:(id)a3 completionHandler:(id /* block */)a4;
- (id)serviceWithInstanceID:(id)a0;
- (BOOL)updateForAccessoryInformationService;
- (void)writeCharacteristicValue:(id)a0 timeout:(double)a1 expiry:(id)a2 completionQueue:(id)a3 completionHandler:(id /* block */)a4;
