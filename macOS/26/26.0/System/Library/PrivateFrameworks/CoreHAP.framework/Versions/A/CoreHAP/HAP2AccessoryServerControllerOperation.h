...
- (void)_sendRequest;
- (id)initWithName:(id)a0 controller:(id)a1 encoding:(id)a2 transport:(id)a3 request:(id)a4 endpoint:(id)a5 mimeType:(id)a6 timeout:(double)a7 options:(unsigned long long)a8 dscpPriority:(long long)a9;
