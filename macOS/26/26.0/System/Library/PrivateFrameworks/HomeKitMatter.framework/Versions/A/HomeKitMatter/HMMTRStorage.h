...
@protocol OS_dispatch_queue, HMMTRStorageDataSource, HMMTRFabricStorageDataSource;
...
@property (readonly, getter=isSharedAdmin) BOOL sharedAdmin;
...
- (id)initWithQueue:(id)a0 dataSource:(id)a1 systemCommissionerFabric:(BOOL)a2 fabricUUID:(id)a3 sharedAdmin:(BOOL)a4;
...
- (void)setThreadCredentialManagementEnabled:(BOOL)a0 forSystemCommissionerFabricNode:(id)a1;
- (void)setThreadCredentialManagementEndpoint:(id)a0 forSystemCommissionerFabricNode:(id)a1;
...
- (BOOL)threadCredentialManagementEnabledForSystemCommissionerFabricNode:(id)a0;
- (id)threadCredentialManagementEndpointForSystemCommissionerFabricNode:(id)a0;
