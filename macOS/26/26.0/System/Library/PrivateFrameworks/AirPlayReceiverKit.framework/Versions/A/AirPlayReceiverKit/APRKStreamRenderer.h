...
@interface APRKStreamRenderer : NSObject <APRKMediaPlayerMessagingDelegate> {
    ...
    BOOL _isProtectedMirroring;
    BOOL _initializeTransform;
...
- (BOOL)processStopAudioSessionRequestWithSessionID:(unsigned int)a0;
- (BOOL)processStopScreenPresentationWithSessionID:(unsigned int)a0;
- (BOOL)processStopVideoPlaybackRequestWithSessionID:(unsigned int)a0;
...
- (void)setIsProtectedMirroring:(BOOL)a0;
