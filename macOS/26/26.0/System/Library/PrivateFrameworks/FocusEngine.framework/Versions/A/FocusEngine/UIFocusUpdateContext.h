@class UIFocusGuide, NSString, NSArray, _UIFocusGuideImpl, _UIFocusMovementInfo, _UIFocusMapSearchInfo, _UIFocusEnvironmentScrollableContainerTuple, _UIDebugIssueReportFormatter, _UIFocusItemInfo, _UIDynamicFocusGroupMap, _UIDebugLogReport, _UIDebugIssueReport;
...
@property (weak, nonatomic, setter=_setFocusedGuideImpl:) _UIFocusGuideImpl *_focusedGuideImpl;
...
@property (readonly, nonatomic, getter=_isInitialMovement) BOOL isInitialMovement;
