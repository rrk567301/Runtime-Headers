...
- (id)_loadLexiconsForLanguage:(id)a0 localization:(id)a1 cachedOnly:(BOOL)a2 onQueue:(id)a3;
...
- (id)_siriDeltaPathForLanguage:(id)a0;
- (id)_siriLexiconPathForLanguage:(id)a0;
...
- (id)nerTaggerWaitForResult:(BOOL)a0;
...
- (BOOL)spellServer:(id)a0 shouldBlockWord:(id)a1 language:(id)a2 offensiveOnly:(BOOL)a3;
...
- (id)transformerOrSiriLanguageModelForLanguageObject:(id)a0 appIdentifier:(id)a1 waitForResult:(BOOL)a2;
...
- (BOOL)validateDiacriticInsensitiveWord:(id)a0 inLexiconForLanguageObject:(id)a1;
