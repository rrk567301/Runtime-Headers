@class NSDate, NSString, NSArray, WBSFileVaultRecoveryKeyDeviceInfo, AKSignInWithAppleAccount, NSMutableDictionary, NSURL, WBSFormerlySharedSavedAccountMarker, NSMutableArray, NSMutableSet, WBSPasswordWarningHideMarker;
