@class AVAudioEngine, AVAudioPlayerNode, AXMDataSeriesDescriptor, AVAudioUnitTimePitch, AVAudioEnvironmentNode, AXMAudioDataSourceMixer, AXMChartDescriptor, AVAudioSourceNode, NSMutableOrderedSet, NSTimer, NSPointerArray, AXMLiveContinuousSynth, AVAudioUnitEffect, NSArray, AXMAudioDataSource, AVAudioPCMBuffer;
...
- (double)_centsForNormalizedFrequency:(double)a0;
