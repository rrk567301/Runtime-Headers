@class NSURL, NSButton, NSDictionary, NSBox, NSProgressIndicator, NSLayoutConstraint, NSString, NSSet, WKWebView, NSArray, NSView, NSData, NSTextField, NSError;
...
@property (retain) NSSet *allowed403Codes;
@property BOOL mandatorySURequired;
...
@property (retain) NSDictionary *detailsFrom403;
