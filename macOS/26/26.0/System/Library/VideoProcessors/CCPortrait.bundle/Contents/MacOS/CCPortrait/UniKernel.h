...
- (id)_findKernelInCache:(id)a0 metalContext:(id)a1 coreImageLibrary:(id)a2 constants:(id)a3;
...
- (id)initWithName:(id)a0 metalContext:(id)a1 coreImageLibrary:(id)a2 constants:(id)a3;
- (id)inputBufferArray;
- (id)inputNameArray;
