@class RTLocationManager, SMCheckInRemindersTipResponseMetricManager, RTNetworkOfInterestManager, SMCMNoMovementMonitor, SMAppDeletionManager, NSMutableArray, RTVehicleLocationProvider, RTXPCActivityManager, RTStarkManager, RTAuthorizationManager, SMInitiatorSessionInitializationRequest, SMSafetyCacheStore, SMSessionManager, RTLearnedLocationManager, RTPlatform, RTDefaultsManager, SMSuggestionsManager, SMSessionStore, RTContactsManager, SMSuggestionsHelper, RTHealthKitManager, RTInvocationDispatcher, SMDeviceConfigurationChecker, SMMessagingService, SMActiveSessionZone, SMSessionMetricManager, RTXPCTimerAlarm, SMEmergencyCallManager, RTBatteryManager, RTMotionActivityManager, RTBiomeManager, SMSessionMonitor, NSString, RTLocationAwarenessManager, SMWatchdog, NSHashTable, RTWatchWristStateManager, RTDataProtectionManager;
...
- (void)_fetchCurrentSessionStateWithCompletion:(id /* block */)a0;
- (void)_fetchCurrentWorkoutSnapshotWithCompletion:(id /* block */)a0;
...
- (void)fetchCurrentWorkoutSnapshotWithCompletion:(id /* block */)a0;
