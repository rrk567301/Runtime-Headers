...
- (id)computeMetricsForWorkCandidates:(id)a0 sourceType:(unsigned long long)a1 homeLOIs:(id)a2 workTruths:(id)a3 distanceBins:(id)a4 homeLOIMethodLabel:(id)a5;
...
- (void)fetchWorkInferenceStatsForLookbackDays:(long long)a0 handler:(id /* block */)a1;
