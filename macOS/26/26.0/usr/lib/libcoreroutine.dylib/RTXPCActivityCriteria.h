...
@property (readonly, nonatomic) BOOL requiresClassB;
@property (readonly, nonatomic) BOOL requiresClassA;
...
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferDirection:(unsigned long long)a5 allowBattery:(BOOL)a6 powerNap:(BOOL)a7 delay:(double)a8;
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferDirection:(unsigned long long)a5 allowBattery:(BOOL)a6 powerNap:(BOOL)a7 delay:(double)a8 requiresClassA:(BOOL)a9;
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferDirection:(unsigned long long)a5 allowBattery:(BOOL)a6 powerNap:(BOOL)a7 delay:(double)a8 requiresClassB:(BOOL)a9;
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferDirection:(unsigned long long)a5 allowBattery:(BOOL)a6 powerNap:(BOOL)a7 requiresClassA:(BOOL)a8;
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferDirection:(unsigned long long)a5 allowBattery:(BOOL)a6 powerNap:(BOOL)a7 requiresClassB:(BOOL)a8;
...
- (id)initWithInterval:(double)a0 gracePeriod:(double)a1 priority:(unsigned long long)a2 requireNetworkConnectivity:(BOOL)a3 requireInexpensiveNetworkConnectivity:(BOOL)a4 networkTransferUploadSize:(unsigned long long)a5 networkTransferDownloadSize:(unsigned long long)a6 allowBattery:(BOOL)a7 powerNap:(BOOL)a8 delay:(double)a9 requireBatteryLevel:(id)a10 requiresClassB:(BOOL)a11 requiresClassA:(BOOL)a12;
