...
- (void)_setupPersistenceAfterConfigurationChange:(long long)a0 cloudSyncAuthorization:(long long)a1 accountStatus:(long long)a2 account:(id)a3;
- (BOOL)_shouldAttemptSetupAccordingToAccountStatus:(long long)a0 account:(id)a1;
- (BOOL)_shouldAttemptSetupAccordingToCloudSyncAuthorization:(long long)a0;
...
- (BOOL)copyPersistenceStore:(id)a0 outputURL:(id)a1 error:(id *)a2;
...
- (long long)store:(id)a0 validateAppleIDs:(id)a1;
