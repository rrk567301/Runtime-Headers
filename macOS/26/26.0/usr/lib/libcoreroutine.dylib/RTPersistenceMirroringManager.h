...
- (id)_createHistoryChangeRequestWithManagedObjectContext:(id)a0 currentExporterToken:(id)a1 excludeImport:(BOOL)a2 store:(id)a3;
...
- (unsigned long long)_changeCountForManagedObjectContext:(id)a0 currentExporterToken:(id)a1 excludeImport:(BOOL)a2 error:(id *)a3;
