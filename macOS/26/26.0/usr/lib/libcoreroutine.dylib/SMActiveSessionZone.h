...
- (void)_writeActiveSessionDetailsRecord:(id)a0 qos:(id)a1 completion:(id /* block */)a2;
...
- (void)writeActiveSessionDetails:(id)a0 pendingRetryCount:(long long)a1 qos:(id)a2 completion:(id /* block */)a3;
