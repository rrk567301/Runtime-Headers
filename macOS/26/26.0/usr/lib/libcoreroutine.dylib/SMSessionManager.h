...
@property (nonatomic) BOOL isEmergencyCallOngoing;
...
- (void)_checkInitiatorEligibilityWithHandoffType:(long long)a0 completion:(id /* block */)a1;
...
- (void)_setupWorkoutTimeoutWithFireDate:(id)a0;
...
- (void)_updateSessionWithWorkoutSnapshot:(id)a0 handler:(id /* block */)a1;
...
- (void)cancelInitializationWithCompletion:(id /* block */)a0;
...
- (void)endSessionForSessionID:(id)a0 reason:(unsigned long long)a1 completion:(id /* block */)a2;
- (void)fetchCurrentLocalSessionStateWithHandler:(id /* block */)a0;
- (void)fetchCurrentSessionStateWithCompletion:(id /* block */)a0;
...
- (void)startSessionWithConfiguration:(id)a0 completion:(id /* block */)a1;
