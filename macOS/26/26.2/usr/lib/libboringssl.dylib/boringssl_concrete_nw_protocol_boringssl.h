...
@protocol OS_nw_frame, OS_dispatch_data, OS_nw_association, OS_nw_parameters, OS_dispatch_queue;
...
@interface boringssl_concrete_nw_protocol_boringssl : NSObject <OS_nw_protocol_boringssl> {
    ...
    unsigned char pqtls_fallback_initiated : 1;
    char log_str[84];
    unsigned char logging_disabled : 1;
    unsigned char log_identities_redacted : 1;
}
