...
- (void)fetchQuickReplySuggestionURLWithCompletion:(id /* block */)a0;
...
- (void)quickReplySuggestionURLWithCompletionHandler:(void (^)(NSURL *, NSError *))a0;
