...
- (void)_fetchTripClusterRouteCountWithOptions:(id)a0 handler:(id /* block */)a1;
...
- (BOOL)deleteTripClusterRouteWithClusterID:(id)a0 maxDeleteAttempts:(unsigned long long)a1;
...
- (void)fetchTripClusterRouteCountWithClusterID:(id)a0 handler:(id /* block */)a1;
...
- (unsigned long long)getTripClusterRouteCountWithClusterID:(id)a0;
