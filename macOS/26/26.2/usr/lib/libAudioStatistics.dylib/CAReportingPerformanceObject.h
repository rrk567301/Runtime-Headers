...
@property (nonatomic) struct vector<pc_session *, std::allocator<pc_session *>> { struct pc_session **__begin_; struct pc_session **__end_; struct { struct pc_session **__cap_; } ; } sessions;
