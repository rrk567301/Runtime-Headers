...
@interface WKFrameInfo : NSObject <WKObject, NSCopying> {
    struct AlignedStorage<API::FrameInfo, 16UL> { struct Storage { unsigned char data[368]; } m_storage; } _frameInfo;
}
...
- (void)dealloc;
- (BOOL)_isSameFrame:(id)a0;
- (struct Ref<API::FrameInfo, WTF::RawPtrTraits<API::FrameInfo>, WTF::DefaultRefDerefTraits<API::FrameInfo>> { struct FrameInfo *x0; })_protectedFrameInfo;
