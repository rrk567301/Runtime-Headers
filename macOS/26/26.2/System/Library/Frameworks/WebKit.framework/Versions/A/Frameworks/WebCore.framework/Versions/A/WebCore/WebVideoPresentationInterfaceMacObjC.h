...
@interface WebVideoPresentationInterfaceMacObjC : NSObject <PIPViewControllerDelegate, WebVideoViewContainerDelegate> {
    struct CheckedPtr<WebCore::VideoPresentationInterfaceMac, WTF::RawPtrTraits<WebCore::VideoPresentationInterfaceMac>> { struct VideoPresentationInterfaceMac *m_ptr; } _videoPresentationInterfaceMac;
