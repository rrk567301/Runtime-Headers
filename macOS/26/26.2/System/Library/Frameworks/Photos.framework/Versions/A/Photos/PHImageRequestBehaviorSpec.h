...
@property (nonatomic) BOOL disableImageIOForHDR;
...
+ (BOOL)_shouldDecodeAsHDRBasedOnChoosingPolicy:(long long)a0 optionsPreferHDR:(BOOL)a1;
...
+ (id)livePhotoRequestBestBehaviorSpecWithPreviousBehaviorSpec:(id)a0 options:(id)a1;
...
+ (BOOL)_shouldLoadHDRGainMapBasedOnChoosingPolicy:(long long)a0 options:(id)a1;
