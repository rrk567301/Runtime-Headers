...
- (void)_finalizePhotosResultsForQuery:(id)a0 resultHandler:(id /* block */)a1;
- (void)_finalizeSyndicationResultsForQuery:(id)a0 resultHandler:(id /* block */)a1;
...
- (void)_processSearchableItemForPhotosLibrary:(id)a0;
- (void)_processSearchableItemForSyndicationLibrary:(id)a0;
