...
+ (void)completionSuggestionDateComponentsForQueryString:(id)a0 locationInQueryString:(unsigned long long)a1 completion:(id /* block */)a2;
...
+ (BOOL)isSyndicationLibrary:(id)a0;
