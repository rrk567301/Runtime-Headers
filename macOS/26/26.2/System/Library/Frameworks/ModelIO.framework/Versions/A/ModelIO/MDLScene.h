@class , NSMutableArray, __end_;

@interface MDLScene : NSObject {
    struct mutex { struct _opaque_pthread_mutex_t { long long x0; char x1[56]; } x0; } *_sceneMutex;
    struct vector<ModelIO::RTRenderable *, std::allocator<ModelIO::RTRenderable *>> { struct RTRenderable **__begin_; struct RTRenderable **__end_; struct { struct RTRenderable **__cap_; } ; } _sceneObjects;
    struct vector<MDLLight *, std::allocator<MDLLight *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _sceneLights;
    int _signature;
}
