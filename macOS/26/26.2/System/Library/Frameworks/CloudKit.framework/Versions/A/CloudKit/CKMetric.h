...
- (id)initWithStartDate:(id)a0 duration:(double)a1 queueing:(double)a2 executing:(double)a3 bytesUploaded:(unsigned long long)a4 bytesDownloaded:(unsigned long long)a5 networkServiceType:(unsigned long long)a6 connections:(unsigned long long)a7 connectionsCreated:(unsigned long long)a8 bytesFulfilledByPeers:(unsigned long long)a9 bytesFulfilledLocally:(unsigned long long)a10 bytesResumed:(unsigned long long)a11 totalBytesByChunkProfile:(id)a12 chunkCountByChunkProfile:(id)a13 fileCountByChunkProfile:(id)a14 walrusEnabled:(BOOL)a15 zoneishKeysRolled:(unsigned long long)a16 perRecordKeysRolled:(unsigned long long)a17 zoneKeysRolled:(unsigned long long)a18 shareKeysRolled:(unsigned long long)a19 keyRollsSkippedBySizeCheck:(unsigned long long)a20 identitiesRolledOnRecordSave:(unsigned long long)a21 identitiesRolledOnZoneSave:(unsigned long long)a22 failedIdentityRollAttempts:(unsigned long long)a23 zoneKeysRemoved:(unsigned long long)a24 zoneishKeysRemoved:(unsigned long long)a25 recordKeysRemoved:(unsigned long long)a26 keysNotRemoved:(unsigned long long)a27 adopterCapabilityCheckValidationFailures:(unsigned long long)a28 adopterCapabilityCheckValidationFailureTypes:(id)a29 adopterCapabilityCheckResult:(unsigned long long)a30 requiredFeatureSetValidationFailures:(unsigned long long)a31 requiredFeatureSetValidationFailureTypes:(id)a32;
- (void).cxx_destruct;
- (id)description;
