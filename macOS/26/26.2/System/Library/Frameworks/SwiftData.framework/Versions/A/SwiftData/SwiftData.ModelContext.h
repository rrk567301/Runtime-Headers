@interface SwiftData.ModelContext : _TtCs12_SwiftObject {
    ...
    void /* unknown type, empty encoding */ _trackAccessors;
    ...
    void /* unknown type, empty encoding */ _readAttributeKeypathsForType;
    void /* unknown type, empty encoding */ _readRelationshipKeypathsForType;
