...
+ (void)addContextualUsageDescriptionValuesToLocalizedKeys:(id)a0 fromInfoDictionary:(id)a1;
+ (void)findKeysToLocalizeInInfoDictionary:(id)a0 forArrayKey:(struct __CFString { } *)a1 stringKeys:(id)a2 localizedKeys:(id)a3;
