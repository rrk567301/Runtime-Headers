...
- (BOOL)isRestrictedWithStateProvider:(id)a0;
- (void).cxx_destruct;
- (id)description;
- (id)initWithBundleIdentifier:(id)a0 stateFlags:(unsigned long long)a1 ratingRank:(int)a2 ratingRankEligibilityDomain:(unsigned long long)a3 installType:(unsigned long long)a4;
- (unsigned long long)restrictionReasonWithStateProvider:(id)a0;
