...
- (struct vector<std::pair<unsigned long, float>, std::allocator<std::pair<unsigned long, float>>> { void *x0; void *x1; struct { void *x0; } x2; })computeKClosestLabels:(id)a0;
- (void)extractNearestNeighborLabels:(id *)a0 distances:(id *)a1 indices:(id *)a2 from:(struct vector<std::pair<unsigned long, float>, std::allocator<std::pair<unsigned long, float>>> { void *x0; void *x1; struct { void *x0; } x2; })a3;
