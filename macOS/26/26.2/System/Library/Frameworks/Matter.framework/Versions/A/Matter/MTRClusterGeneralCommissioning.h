...
- (id)readAttributeIsCommissioningWithoutPowerWithParams:(id)a0;
- (id)readAttributeLocationCapabilityWithParams:(id)a0;
- (id)readAttributeNetworkRecoveryReasonWithParams:(id)a0;
- (id)readAttributeRecoveryIdentifierWithParams:(id)a0;
