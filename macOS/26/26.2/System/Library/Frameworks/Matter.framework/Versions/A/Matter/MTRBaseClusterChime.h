...
+ (void)readAttributeInstalledChimeSoundsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeSelectedChimeWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)playChimeSoundWithCompletion:(id /* block */)a0;
- (void)playChimeSoundWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeInstalledChimeSoundsWithCompletion:(id /* block */)a0;
- (void)readAttributeSelectedChimeWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeInstalledChimeSoundsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeSelectedChimeWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)writeAttributeEnabledWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeEnabledWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeSelectedChimeWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeSelectedChimeWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
