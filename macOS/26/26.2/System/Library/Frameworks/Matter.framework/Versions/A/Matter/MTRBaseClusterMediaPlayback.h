...
+ (void)readAttributeActiveAudioTrackWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeActiveTextTrackWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeAvailableAudioTracksWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeAvailableTextTracksWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)activateAudioTrackWithParams:(id)a0 completion:(id /* block */)a1;
- (void)activateTextTrackWithParams:(id)a0 completion:(id /* block */)a1;
- (void)deactivateTextTrackWithCompletion:(id /* block */)a0;
- (void)deactivateTextTrackWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeActiveAudioTrackWithCompletion:(id /* block */)a0;
- (void)readAttributeActiveTextTrackWithCompletion:(id /* block */)a0;
- (void)readAttributeAttributeListWithCompletion:(id /* block */)a0;
- (void)readAttributeAttributeListWithCompletionHandler:(id /* block */)a0;
- (void)readAttributeAvailableAudioTracksWithCompletion:(id /* block */)a0;
- (void)readAttributeAvailableTextTracksWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeActiveAudioTrackWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeActiveTextTrackWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeAvailableAudioTracksWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeAvailableTextTracksWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
