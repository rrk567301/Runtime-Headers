...
+ (void)readAttributeElectricalCircuitNodesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeElectricalCircuitNodesWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeElectricalCircuitNodesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)writeAttributeElectricalCircuitNodesWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeElectricalCircuitNodesWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
