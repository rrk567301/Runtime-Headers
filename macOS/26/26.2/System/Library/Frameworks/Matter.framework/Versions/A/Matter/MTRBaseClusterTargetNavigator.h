...
+ (void)readAttributeCurrentTargetWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeCurrentTargetWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
+ (void)readAttributeTargetListWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeTargetListWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (id)initWithDevice:(id)a0 endpoint:(unsigned short)a1 queue:(id)a2;
- (void)navigateTargetWithParams:(id)a0 completion:(id /* block */)a1;
- (void)navigateTargetWithParams:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)readAttributeCurrentTargetWithCompletion:(id /* block */)a0;
- (void)readAttributeCurrentTargetWithCompletionHandler:(id /* block */)a0;
...
- (void)readAttributeTargetListWithCompletion:(id /* block */)a0;
- (void)readAttributeTargetListWithCompletionHandler:(id /* block */)a0;
...
- (void)subscribeAttributeCurrentTargetWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeCurrentTargetWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeTargetListWithMinInterval:(id)a0 maxInterval:(id)a1 params:(id)a2 subscriptionEstablished:(id /* block */)a3 reportHandler:(id /* block */)a4;
- (void)subscribeAttributeTargetListWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
