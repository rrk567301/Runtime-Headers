...
+ (void)readAttributeSetTimeWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeTimeRemainingWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeTimerStateWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)addTimeWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeSetTimeWithCompletion:(id /* block */)a0;
- (void)readAttributeTimeRemainingWithCompletion:(id /* block */)a0;
- (void)readAttributeTimerStateWithCompletion:(id /* block */)a0;
- (void)reduceTimeWithParams:(id)a0 completion:(id /* block */)a1;
- (void)resetTimerWithCompletion:(id /* block */)a0;
- (void)resetTimerWithParams:(id)a0 completion:(id /* block */)a1;
- (void)setTimerWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeSetTimeWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeTimeRemainingWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeTimerStateWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
