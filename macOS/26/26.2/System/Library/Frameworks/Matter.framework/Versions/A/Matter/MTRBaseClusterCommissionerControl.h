...
+ (void)readAttributeSupportedDeviceCategoriesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;

- (void)commissionNodeWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeSupportedDeviceCategoriesWithCompletion:(id /* block */)a0;
- (void)requestCommissioningApprovalWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeSupportedDeviceCategoriesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
