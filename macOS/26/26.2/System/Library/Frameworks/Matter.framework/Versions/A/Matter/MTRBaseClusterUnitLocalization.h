...
+ (void)readAttributeSupportedTemperatureUnitsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeTemperatureUnitWithAttributeCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completionHandler:(id /* block */)a3;
+ (void)readAttributeTemperatureUnitWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeSupportedTemperatureUnitsWithCompletion:(id /* block */)a0;
- (void)readAttributeTemperatureUnitWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeSupportedTemperatureUnitsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
...
- (void)subscribeAttributeTemperatureUnitWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)writeAttributeTemperatureUnitWithValue:(id)a0 completion:(id /* block */)a1;
- (void)writeAttributeTemperatureUnitWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeTemperatureUnitWithValue:(id)a0 params:(id)a1 completion:(id /* block */)a2;
- (void)writeAttributeTemperatureUnitWithValue:(id)a0 params:(id)a1 completionHandler:(id /* block */)a2;
