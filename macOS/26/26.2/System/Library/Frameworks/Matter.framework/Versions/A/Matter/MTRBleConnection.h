...
@property (nonatomic) struct vector<chip::SetupDiscriminator, std::allocator<chip::SetupDiscriminator>> { struct SetupDiscriminator *__begin_; struct SetupDiscriminator *__end_; struct { struct SetupDiscriminator *__cap_; } ; } desiredDiscriminators;
...
- (void)dispatchConnectionError:(struct ChipError { unsigned int x0; unsigned int x1; char *x2; })a0;
