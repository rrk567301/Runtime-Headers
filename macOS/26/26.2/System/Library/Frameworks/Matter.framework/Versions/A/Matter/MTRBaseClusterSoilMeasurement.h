@interface MTRBaseClusterSoilMeasurement : MTRGenericBaseCluster
...
+ (void)readAttributeSoilMoistureMeasuredValueWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeSoilMoistureMeasurementLimitsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeSoilMoistureMeasuredValueWithCompletion:(id /* block */)a0;
- (void)readAttributeSoilMoistureMeasurementLimitsWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeSoilMoistureMeasuredValueWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeSoilMoistureMeasurementLimitsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
