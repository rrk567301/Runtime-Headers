...
@interface PKAutoRefineQueryItem : NSObject {
    struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct { struct CGRect *__cap_; } ; } _boundingBoxForTokenColumn;
    struct vector<CGRect, std::allocator<CGRect>> { struct CGRect *__begin_; struct CGRect *__end_; struct { struct CGRect *__cap_; } ; } _rotatedBoundingBoxForTokenColumn;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _writingOrientationAngleForTokenColumn;
}
