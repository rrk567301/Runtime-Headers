@class NSUUID, NSString, NSArray, CHTokenizedMathResult, NSSet, PKMathRecognitionItemAttributes, PKStrokeGroupItem, PKStroke, NSNumber;
...
@property (readonly, nonatomic) BOOL isGraphable2D;
@property (readonly, nonatomic) BOOL isGraphable3D;
...
@property (copy, nonatomic) PKMathRecognitionItemAttributes *attributes;
@property (readonly, nonatomic) BOOL shouldBeSolved;
@property (readonly, nonatomic) BOOL isEvaluationExpected;
