...
@interface PKInkParticleDescriptor : NSObject {
    double _dynamicStep;
    struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *__ptr_; } ; } _particleSpacingFunction;
}
...
+ (id)arrayFromVector:(struct vector<double, std::allocator<double>> { double *x0; double *x1; struct { double *x0; } x2; })a0;
...
- (double)dynamicStep;
- (id)initWithTextureName:(id)a0 textureImage:(struct CGImage { } *)a1 maskTextureName:(id)a2 maskTextureImage:(struct CGImage { } *)a3 particleSpacing:(double)a4 particleCount:(long long)a5 particleSize:(struct CGSize { double x0; double x1; })a6 particleRotation:(unsigned long long)a7 maskScale:(double)a8 maskScaleConstant:(double)a9 maskMovement:(double)a10 maskDepth:(double)a11 initialRandomRotation:(BOOL)a12 maskInitialRandomOffset:(BOOL)a13 adjustEndCapParticleAlpha:(BOOL)a14 particleBlendMode:(unsigned long long)a15;
- (double)particleSpacingForRadius:(double)a0;
- (void *)particleSpacingFunction;
- (void)setParticleSpacingFunction:(struct unique_ptr<PKFunction, std::default_delete<PKFunction>> { struct { struct PKFunction *x0; } x0; })a0;
