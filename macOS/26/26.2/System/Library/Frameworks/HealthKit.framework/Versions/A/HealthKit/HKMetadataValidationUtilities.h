...
+ (BOOL)hk_validateCyclingFTPTestTypeMetadataValue:(id)a0 error:(id *)a1;
...
+ (BOOL)hk_validatePhysicalEffortEstimationTypeMetadataValue:(id)a0 error:(id *)a1;
...
+ (BOOL)hk_validateWaterSalinityMetadataValue:(id)a0 error:(id *)a1;
+ (BOOL)hk_validateWeatherConditionMetadataValue:(id)a0 error:(id *)a1;
+ (BOOL)hk_validateWorkoutEventSourceMetadataValue:(id)a0 error:(id *)a1;
