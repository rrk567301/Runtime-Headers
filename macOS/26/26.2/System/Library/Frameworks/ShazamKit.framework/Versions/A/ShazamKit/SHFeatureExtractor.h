@interface SHFeatureExtractor : NSObject {
    struct unique_ptr<shazam::dsp::FeatureExtractor, std::default_delete<shazam::dsp::FeatureExtractor>> { struct { struct FeatureExtractor *__ptr_; } ; } real_streatx;
}

@property (readonly) struct unique_ptr<shazam::dsp::FeatureExtractor, std::default_delete<shazam::dsp::FeatureExtractor>> { struct { struct FeatureExtractor *x0; } x0; } streatx;
...
- (void)setStreatx:(struct unique_ptr<shazam::dsp::FeatureExtractor, std::default_delete<shazam::dsp::FeatureExtractor>> { struct { struct FeatureExtractor *x0; } x0; })a0;
