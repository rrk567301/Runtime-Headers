...
@property (readonly, nonatomic) BOOL couldBeJunk;
@property (readonly, nonatomic) BOOL containsBlockedAttendee;
@property (readonly, nonatomic) BOOL containsCachedBlockedAttendee;
