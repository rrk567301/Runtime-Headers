...
- (void)_feedAccessoryConfig:(const struct Config { int x0; char x1[64]; char x2[32]; int x3; BOOL x4; struct CMOQuaternion { float x0[4]; } x5; BOOL x6; struct CMOQuaternion { float x0[4]; } x7; } *)a0;
