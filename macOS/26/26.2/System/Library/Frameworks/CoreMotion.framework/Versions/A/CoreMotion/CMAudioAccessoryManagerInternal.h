...
@interface CMAudioAccessoryManagerInternal : NSObject {
    ...
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct { struct Dispatcher *__ptr_; } ; } fAudioAccessoryActivityDispatcher;
    ...
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct { struct Dispatcher *__ptr_; } ; } fAudioAccessoryActivityStatusDispatcher;
    id /* block */ fAudioAccessoryActivityStatusHandler;
    NSOperationQueue *fAudioAccessoryActivityStatusQueue;
    struct unique_ptr<CLMotionNotifier::Dispatcher, std::default_delete<CLMotionNotifier::Dispatcher>> { struct { struct Dispatcher *__ptr_; } ; } fAudioAccessorySitStandDispatcher;
