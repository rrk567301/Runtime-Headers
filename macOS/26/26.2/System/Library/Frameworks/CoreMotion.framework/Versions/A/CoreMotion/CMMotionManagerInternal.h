...
@interface CMMotionManagerInternal : NSObject {
    ...
    BOOL fPrivateDeviceMotionNoSimClient;
    void *fConnection;
    ...
    struct unique_ptr<CLIspDataVisitor, std::default_delete<CLIspDataVisitor>> { struct { struct CLIspDataVisitor *__ptr_; } ; } fSidebandVisitor;
    struct unique_ptr<CLDisplayGravityService, std::default_delete<CLDisplayGravityService>> { struct { struct CLDisplayGravityService *__ptr_; } ; } fDisplayGravityService;
    BOOL fShouldResetStartingReference;
    ...
    struct unique_ptr<CLDeviceMotionLiteService, std::default_delete<CLDeviceMotionLiteService>> { struct { struct CLDeviceMotionLiteService *__ptr_; } ; } fDeviceMotionLiteService;
    struct unique_ptr<CMMotionManagerStatsCollector, std::default_delete<CMMotionManagerStatsCollector>> { struct { struct CMMotionManagerStatsCollector *__ptr_; } ; } fMotionManagerStatsCollector;
