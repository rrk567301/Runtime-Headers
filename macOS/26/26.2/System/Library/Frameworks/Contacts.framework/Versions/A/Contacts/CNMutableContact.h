...
@property (copy) NSData *avatarRecipeData;
...
@property (nonatomic) BOOL isSharingPaired;
...
- (void)_setAvatarRecipeData:(id)a0;
...
- (void)setAvatarRecipeData:(id)a0;
...
- (void)setIsSharingPaired:(BOOL)a0;
