...
@interface PGRemoteTask : NSObject <PGUserTask> {
    ...
    id<MTLSharedEvent> _lastFifoEvent[64];
...
- (void)infoIndirectWithCmdBufCount:(unsigned int)a0 cmdBuffers:(struct { unsigned long long x0; unsigned long long x1; } *)a1 resourceCount:(unsigned int)a2 resources:(struct { unsigned int x0; union { struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; } x0; unsigned int x1; } x1; } *)a3 stampIndex:(unsigned int)a4 fifoEvent:(id)a5 fifoEventValue:(unsigned long long *)a6 completionHandler:(id /* block */)a7;
...
- (void)setStampEvent:(id)a0 stampIndex:(unsigned int)a1;
