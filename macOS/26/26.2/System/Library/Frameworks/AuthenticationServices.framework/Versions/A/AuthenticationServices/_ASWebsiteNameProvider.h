...
- (void)setWebsiteNameConsumer:(id)a0 completion:(id /* block */)a1;
...
- (void)_processMetadataEntryFetchedFromKeychain:(id)a0 forDomain:(id)a1 allowRefreshingDataFromNetwork:(BOOL)a2 allowCachingResult:(BOOL)a3;
...
- (id)knownWebsiteNameForDomain:(id)a0 allowCachingResult:(BOOL)a1;
