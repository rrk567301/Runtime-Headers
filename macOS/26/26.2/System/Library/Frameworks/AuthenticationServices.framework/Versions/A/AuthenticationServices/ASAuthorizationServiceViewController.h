...
@protocol OS_os_activity, ASCAuthorizationPresenterDelegate, AuthenticationServicesHelperProtocol, OS_dispatch_queue, ASCAuthorizationPresenterHostProtocol;
...
- (void)authorizationViewControllerDidIgnorePINRequest:(id)a0;
...
- (void)userDidSelectImportingDestinationWithApplicationIdentifier:(id)a0 exportViewController:(id)a1;
