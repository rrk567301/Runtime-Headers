@class , __end_, VZVirtioConsolePortArray;
@protocol VZVirtioConsoleDeviceDelegate;

@interface VZVirtioConsoleDevice : VZConsoleDevice {
    struct vector<__weak id<VZVirtioConsoleDeviceDelegate>, std::allocator<__weak id<VZVirtioConsoleDeviceDelegate>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _internalDelegates;
}
