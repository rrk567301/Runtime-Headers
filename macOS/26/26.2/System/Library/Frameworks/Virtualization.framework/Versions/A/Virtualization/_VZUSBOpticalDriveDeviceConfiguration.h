...
- (void)_getStorageDeviceWithQueue:(struct DispatchQueue { struct OpaqueId *x0; })a0 session:(const struct DispatchGroupSession { id x0; struct PendingOperation { struct Breadcrumb { unsigned long long x0; } x0; } x1; } *)a1 completionHandler:(id /* block */)a2;
