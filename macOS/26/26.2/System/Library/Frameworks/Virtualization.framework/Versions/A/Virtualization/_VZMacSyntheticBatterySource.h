...
@interface _VZMacSyntheticBatterySource : _VZMacBatterySource <_VZVirtualMachineConfigurationEncodable> {
    ...
    struct vector<__weak id<_VZMacBatterySourceObserver>, std::allocator<__weak id<_VZMacBatterySourceObserver>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _observers;
}
