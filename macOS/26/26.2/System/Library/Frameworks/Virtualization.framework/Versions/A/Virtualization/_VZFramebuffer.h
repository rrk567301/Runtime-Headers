...
@interface _VZFramebuffer : NSObject {
    ...
    struct vector<FramebufferObserver, std::allocator<FramebufferObserver>> { struct FramebufferObserver *__begin_; struct FramebufferObserver *__end_; struct { struct FramebufferObserver *__cap_; } ; } _observers;
