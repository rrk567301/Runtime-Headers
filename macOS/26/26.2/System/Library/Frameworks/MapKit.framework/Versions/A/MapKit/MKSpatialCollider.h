@class _MKSpatialColliderPairSet, , __end_;
...
@interface MKSpatialCollider : NSObject <NSFastEnumeration> {
    ...
    BOOL _isVertical;
    struct vector<MKAnnotationView *, std::allocator<MKAnnotationView *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _sortedAnnotationViews;
    double _maxLength;
