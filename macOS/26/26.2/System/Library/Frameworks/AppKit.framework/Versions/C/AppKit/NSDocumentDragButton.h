...
@interface NSDocumentDragButton : NSButton <NSDraggingSource> {
    struct __ddbFlags { unsigned char waitForDrag : 1; unsigned char currentlyDragging : 1; unsigned char shouldDrag : 1; unsigned char disableDragDelay : 1; } _ddbFlags;
}

@property (copy) NSString *representedFilename;
@property (copy, setter=_setRepresentedURL:) NSURL *_representedURL;
