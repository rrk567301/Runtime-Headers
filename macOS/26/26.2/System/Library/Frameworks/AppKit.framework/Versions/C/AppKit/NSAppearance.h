...
@interface NSAppearance : NSObject <NSSecureCoding> {
    ...
    unsigned char _wantsSolarium : 1;
    unsigned char _isFauxVibrant : 1;
}
...
@property (readonly) BOOL _isFauxVibrant;
@property (readonly) BOOL _wantsSolarium;
...
- (id)_canonicalSystemCatalogColorName:(id)a0;
- (id)_catalystName;
...
- (BOOL)_wantsSolariumForWidget:(id)a0;
...
- (id)glassCompositingFilterWithTintColor:(id)a0;
