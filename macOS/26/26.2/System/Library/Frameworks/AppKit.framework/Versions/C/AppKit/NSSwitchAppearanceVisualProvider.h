@class NSSwitch, NSView, NSString, NSWidgetView, NSColor;
...
@interface NSSwitchAppearanceVisualProvider : NSObject <NSSwitchVisualProvider> {
    ...
    struct { double scaleFactor; unsigned long long controlSize; long long stateValue; NSColor *trackColor; unsigned char isActive : 1; unsigned char isEnabled : 1; unsigned char isHighlighted : 1; unsigned char isRTL : 1; unsigned char shouldShowAxLabels : 1; } _currentDrawingState;
    NSColor *_trackColor;
}
