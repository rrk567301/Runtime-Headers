@class _NSScrollingPerfLogger, NSScrollView, NSTimer, CADisplayLink, _NSScrollingPredominantAxisFilter, _NSScrollingRubberbandFilter, _NSScrollingMomentumCalculator;
