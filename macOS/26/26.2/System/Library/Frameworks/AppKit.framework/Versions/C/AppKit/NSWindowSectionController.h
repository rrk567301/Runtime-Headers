@class NSTrackingSeparatorToolbarItem, NSArray, NSWindowSectionControllerBoundingDivider, NSMutableSet, NSMutableArray, NSWindow;
...
- (long long)_doesAdapterFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 meetCriteriaForRegistrationWithSectionController:(id)a1 forWindow:(id)a2;
- (long long)_doesAdapterFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 meetCriteriaForRegistrationWithSectionController:(id)a1 forWindow:(id)a2 strict:(BOOL)a3;
- (long long)_doesScrollViewAdapter:(id)a0 meetCriteriaForRegistrationWithSectionController:(id)a1 forWindow:(id)a2;
- (long long)_doesScrollViewAdapter:(id)a0 meetCriteriaForRegistrationWithSectionController:(id)a1 forWindow:(id)a2 strict:(BOOL)a3;
...
- (void)_updateControllersSidebarAdjacencyState;
- (void)_updatePendingRegistrationForObject:(id)a0;
