@class NSString, NSButtonCell, NSButtonBezelConfiguration, NSWidgetView, NSButton, NSColor;

@interface NSThemeWidgetAppearanceBasedVisualProvider : NSObject <NSButtonVisualProvider> {
...
@property (readonly) BOOL hasDestructiveAppearance;
...
- (id)currentThemeWidgetConfiguration;
