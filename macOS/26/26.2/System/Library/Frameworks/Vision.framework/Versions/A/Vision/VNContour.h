...
@interface VNContour : NSObject <NSCopying, VNRequestRevisionProviding> {
    ...
    struct vector<float __attribute__((ext_vector_type(2))), std::allocator<float __attribute__((ext_vector_type(2)))>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _contourPoints;
