@class TSCEValueGridIndexer, , __end_;

@interface TSCEValueGrid : NSObject <NSCopying> {
    struct TSCEBitGrid { struct vector<TSCEBitGridTile *, std::allocator<TSCEBitGridTile *>> { struct TSCEBitGridTile **__begin_; struct TSCEBitGridTile **__end_; struct { struct TSCEBitGridTile **__cap_; } ; } _tiles; unsigned long long _count; unsigned long long _lastTileFoundAtIndex; } _coords;
    TSCEValueGridIndexer *_indexer;
    struct vector<TSCEValue *, std::allocator<TSCEValue *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _valueForIndex;
