...
@interface TSCH3DCombinationRenderProcessor : TSCH3DRetargetRenderProcessor {
    ...
    struct StateStack<TSCH3D::ObjectState, 6L> { unsigned long long _index; struct ObjectState { struct ObjcSharedPtr<NSSet> { NSSet *mValue; } _effects; struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>, std::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _attributes; struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>, std::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _textures; } _current; struct ObjectState { struct ObjcSharedPtr<NSSet> { NSSet *mValue; } _effects; struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>, std::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _attributes; struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>, std::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _textures; } _stack[6]; } _objectStateStack;
