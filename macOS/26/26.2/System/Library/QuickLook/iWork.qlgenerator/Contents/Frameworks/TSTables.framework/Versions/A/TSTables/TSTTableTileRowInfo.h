...
- (BOOL)_quickValidateBuffer:(struct TSTTableTileRowBuffer { struct { char *x0; unsigned long long x1; unsigned long long x2; unsigned short *x3; unsigned short x4; BOOL x5; } x0; } *)a0;
- (void)_replaceCellAtIndex:(unsigned short)a0 withCell:(id)a1;
- (struct vector<TSTCell *, std::allocator<TSTCell *>> { id *x0; id *x1; struct { id *x0; } x2; })accumulateCurrentCellsConcurrentlyAtColumns:(void *)a0 usingCellCreationBlock:(id /* block */)a1;
