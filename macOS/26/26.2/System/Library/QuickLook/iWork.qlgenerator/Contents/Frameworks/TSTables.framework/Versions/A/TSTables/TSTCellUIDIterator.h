...
@interface TSTCellUIDIterator : NSObject {
    struct deque<TSKUIDStruct, std::allocator<TSKUIDStruct>> { struct __split_buffer<TSKUIDStruct *, std::allocator<TSKUIDStruct *>> { struct TSKUIDStruct **__first_; struct TSKUIDStruct **__begin_; struct TSKUIDStruct **__end_; struct { struct TSKUIDStruct **__cap_; } ; } __map_; unsigned long long __start_; struct { unsigned long long __size_; } ; } _recentRowResults;
    struct deque<TSKUIDStruct, std::allocator<TSKUIDStruct>> { struct __split_buffer<TSKUIDStruct *, std::allocator<TSKUIDStruct *>> { struct TSKUIDStruct **__first_; struct TSKUIDStruct **__begin_; struct TSKUIDStruct **__end_; struct { struct TSKUIDStruct **__cap_; } ; } __map_; unsigned long long __start_; struct { unsigned long long __size_; } ; } _recentColumnResults;
}
