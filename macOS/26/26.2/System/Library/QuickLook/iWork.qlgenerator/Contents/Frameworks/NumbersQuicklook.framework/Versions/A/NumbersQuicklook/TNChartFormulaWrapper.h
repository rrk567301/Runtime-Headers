...
@interface TNChartFormulaWrapper : TSCKSosBase {
    ...
    struct vector<TSUCellCoord, std::allocator<TSUCellCoord>> { struct TSUCellCoord *__begin_; struct TSUCellCoord *__end_; struct { struct TSUCellCoord *__cap_; } ; } _cachedChromeCoords;
...
+ (id)emptyFormula;
+ (id)newEvaluationContextWith:(id)a0 inChart:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 forSummaryChart:(BOOL)a2;
...
- (void)enumerateOutputGridForSeries:(unsigned long long)a0 withContext:(id)a1 byRow:(BOOL)a2 shouldSkipHiddenData:(BOOL)a3 withBlock:(id /* block */)a4;
...
- (id)gridLabelValueAtIndex:(unsigned long long)a0 withEvaluationContext:(id)a1 byRow:(BOOL)a2 shouldSkipHiddenData:(BOOL)a3;
...
- (id)outputGrid:(id)a0 shouldSkipHiddenData:(BOOL)a1;
- (id)outputGridVectorForSeries:(unsigned long long)a0 withContext:(id)a1 byRow:(BOOL)a2 shouldSkipHiddenData:(BOOL)a3;
- (id)outputValue:(id)a0 shouldSkipHiddenData:(BOOL)a1;
- (id)outputValue:(id)a0 shouldSkipHiddenData:(BOOL)a1 requiresChromeCoords:(BOOL)a2;
- (struct vector<std::pair<TSCEValue *, TSUCellCoord>, std::allocator<std::pair<TSCEValue *, TSUCellCoord>>> { void *x0; void *x1; struct { void *x0; } x2; })outputVectorValuesWithChromeCoords:(id)a0 shouldSkipHiddenData:(BOOL)a1;
- (id)plotwiseLabelValuesWithEvaluationContext:(id)a0 byRow:(BOOL)a1 shouldSkipHiddenData:(BOOL)a2;
