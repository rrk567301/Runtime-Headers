@class , __end_, TSCECalculationEngine, TSCEValueBindingEnvironment, TSCERemoteDataSpecifierSet, TSULocale, NSMutableSet, NSMutableDictionary, TSCEDependencyTracker;

@interface TSCEEvaluationContext : NSObject <NSCopying> {
    struct TSCEEvaluationStack { struct vector<TSCEValue *, std::allocator<TSCEValue *>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _evaluationStack; unsigned int _argumentCount; } _evaluationStack;
