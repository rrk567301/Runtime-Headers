...
@interface TSWPLayoutMetricsCache : NSObject <TSWPStorageParagraphObserver> {
    ...
    struct vector<TSWPParagraphMetrics, std::allocator<TSWPParagraphMetrics>> { struct TSWPParagraphMetrics *__begin_; struct TSWPParagraphMetrics *__end_; struct { struct TSWPParagraphMetrics *__cap_; } ; } _paragraphMetrics;
}
