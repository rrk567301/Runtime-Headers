...
@property (readonly, nonatomic) struct vector<TSTCellValueType, std::allocator<TSTCellValueType>> { unsigned char *__begin_; unsigned char *__end_; struct { unsigned char *__cap_; } ; } pivotValueTypesByColumn;
@property (readonly, nonatomic) struct map<unsigned long, TSTGroupingType, std::less<unsigned long>, std::allocator<std::pair<const unsigned long, TSTGroupingType>>> { struct __tree<std::__value_type<unsigned long, TSTGroupingType>, std::__map_value_compare<unsigned long, std::__value_type<unsigned long, TSTGroupingType>, std::less<unsigned long>>, std::allocator<std::__value_type<unsigned long, TSTGroupingType>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } pivotDateGroupingTypesByColumn;
...
@property (nonatomic) BOOL upgradeShouldSuppressFormulaWarnings;
...
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })UIDsForIndexes:(id)a0 isRows:(BOOL)a1;
- (struct TSKUIDStructVectorTemplate<TSKUIDStruct> { struct TSKUIDStruct *x0; struct TSKUIDStruct *x1; struct { struct TSKUIDStruct *x0; } x2; })UIDsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 isRows:(BOOL)a1;
- (BOOL)_hasRatingFormats;
...
- (struct TSCECellCoordSet { struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } x0; struct map<unsigned short, TSUIndexSet, std::less<unsigned short>, std::allocator<std::pair<const unsigned short, TSUIndexSet>>> { struct __tree<std::__value_type<unsigned short, TSUIndexSet>, std::__map_value_compare<unsigned short, std::__value_type<unsigned short, TSUIndexSet>, std::less<unsigned short>>, std::allocator<std::__value_type<unsigned short, TSUIndexSet>>> { void *x0; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x0; } x1; struct { unsigned long long x0; } x2; } x0; } x1; })clearArrayFormulasSpillingIntoRegion:(id)a0 affectedRegion:(id *)a1;
- (void)clearCommentHostingMapForCommentStorage:(id)a0;
- (void)clearFromGroupByUID;
- (void)clearFromTableUID;
- (void)clearSpillCellsForOriginID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0 boundingResultRegion:(id *)a1;
- (void)clearSpillCellsInRange:(const struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a0;
...
- (id)expectedSpillErrorForValue:(id)a0 withContext:(id)a1;
...
- (void)getPendingCellCopy:(id)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; })a1 suppressCellBorder:(BOOL)a2;
...
- (int)getValue:(id *)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; })a1 fetchRichTextAttributesIfPlainText:(BOOL)a2;
- (int)getValue:(id *)a0 atBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; })a1 fetchRichTextAttributesIfPlainText:(BOOL)a2 skipPendingWrites:(BOOL)a3;
...
- (void)p_modifyAllCellsConcurrentlyWithSearchFlags:(unsigned long long)a0 affectsCellBorders:(BOOL)a1 ignoreFormulas:(BOOL)a2 clearImportWarnings:(BOOL)a3 formulaReplacer:(id)a4 modificationBlock:(id /* block */)a5 furtherPassNeededBlock:(id /* block */)a6 furtherPassConcurrentBlock:(id /* block */)a7 preApplyBlock:(id /* block */)a8;
...
- (void)p_modifyCellsConcurrentlyInBaseRegion:(id)a0 searchFlags:(unsigned long long)a1 affectsCellBorders:(BOOL)a2 ignoreFormulas:(BOOL)a3 clearImportWarnings:(BOOL)a4 formulaReplacer:(id)a5 modificationBlock:(id /* block */)a6 furtherPassNeededBlock:(id /* block */)a7 furtherPassConcurrentBlock:(id /* block */)a8 preApplyBlock:(id /* block */)a9;
...
- (void)resetSpillingRangesInRange:(const struct TSUCellRect { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct { unsigned int x0; unsigned int x1; } x1; } *)a0;
...
- (BOOL)spillArrayValue:(id)a0 primaryCell:(id)a1 withContext:(id)a2 hasWarnings:(BOOL)a3 didBeginOrEndWithTextCell:(BOOL *)a4 propagateCheckboxes:(BOOL)a5;
- (struct vector<TSKUIDStructTract, std::allocator<TSKUIDStructTract>> { struct TSKUIDStructTract *x0; struct TSKUIDStructTract *x1; struct { struct TSKUIDStructTract *x0; } x2; })spillingRangesInRegion:(id)a0;
