...
- (id)initWithColonTract:(id)a0 refFlags:(const struct TSCEASTRefFlags { unsigned char x0; } *)a1 colonTractFlags:(const struct TSCEASTColonTractFlags { unsigned char x0; } *)a2 undoTractList:(id)a3;
