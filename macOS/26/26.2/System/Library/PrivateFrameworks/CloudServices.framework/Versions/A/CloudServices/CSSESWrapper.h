...
- (id)initWithDSID:(id)a0 escrowRecordContents:(id)a1 passcodeStashSecret:(id)a2 recoveryPassphrase:(id)a3 recordID:(id)a4 recordLabel:(id)a5 reqVersion:(int)a6;
