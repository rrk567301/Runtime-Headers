...
+ (id)_fetchSearchEntityEdgesForMoment:(id)a0;
...
+ (id)_labelIDWithCode:(int)a0 inContext:(id)a1;
+ (id)_labelWithCode:(int)a0 inContext:(id)a1;
...
+ (id)dateIntervalForMomentEdge:(id)a0;
