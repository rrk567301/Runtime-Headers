...
- (void)backgroundAssetResourceNetworkStatusForBundleID:(id)a0 withLevel:(long long)a1 reply:(id /* block */)a2;
...
- (void)insertBackgroundResourceJobConfigurationWithBundleIdentifier:(id)a0 state:(short)a1 reply:(id /* block */)a2;
...
- (void)verifyAssetResourceJobConsistencyWithReply:(id /* block */)a0;
