...
@interface HeadphoneManager.HearingRecord : NSObject {
    ...
    void /* unknown type, empty encoding */ _ownVoiceLevel;
    ...
    void /* unknown type, empty encoding */ _safetyInformation;
    void /* unknown type, empty encoding */ _hearingProtectionPPECapability;
    void /* unknown type, empty encoding */ _hearingProtectionPPECapLevel;
    void /* unknown type, empty encoding */ _hearingProtectionPPEEnabled;
    void /* unknown type, empty encoding */ _hearingProtectionPPERegionStatus;
    void /* unknown type, empty encoding */ _hearingAidV2RegionStatus;
    void /* unknown type, empty encoding */ _hearingAidV2Capability;
