...
@interface ASDTIOPAudioLPMicDevice : ASDTAudioDevice <ASDTExclavesStatusTrackerHostProtocol, ASDTIOServiceDependency> {
    struct unique_ptr<ASDT::IOPAudio::LPMic::UserClient, std::default_delete<ASDT::IOPAudio::LPMic::UserClient>> { struct { struct UserClient *__ptr_; } ; } _lpMicUserClient;
    ...
    struct unique_ptr<ASDT::Exclaves::StatusTracker, std::default_delete<ASDT::Exclaves::StatusTracker>> { struct { struct StatusTracker *__ptr_; } ; } _exclavesStatusTracker;
}
...
+ (id)enableListeningOnGesturePropertyForService:(id)a0;
