@interface ASDTIOPAudioCMDevice : ASDTIOService {
    struct unique_ptr<ASDT::IOPAudio::ClientManager::UserClient, std::default_delete<ASDT::IOPAudio::ClientManager::UserClient>> { struct { struct UserClient *__ptr_; } ; } _userClient;
}
