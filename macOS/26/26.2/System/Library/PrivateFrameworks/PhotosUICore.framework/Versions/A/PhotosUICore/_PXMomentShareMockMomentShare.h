...
@property (readonly, nonatomic) BOOL px_shouldSelectAllAssetsWhenSharing;
...
@property (readonly, nonatomic) BOOL px_wantsDynamicHeaderDisabled;
...
@property (readonly, nonatomic) BOOL px_isPerson;
@property (readonly, nonatomic) BOOL px_isSocialGroup;
@property (readonly, nonatomic) BOOL px_isSharedAlbum;
@property (readonly, nonatomic) BOOL px_isCloudKitSharedAlbum;
@property (readonly, nonatomic) BOOL px_isOwnedCloudKitSharedAlbum;
@property (readonly, nonatomic) BOOL px_isStreamSharedAlbum;
@property (readonly, nonatomic) BOOL px_isOwnedStreamSharedAlbum;
@property (readonly, nonatomic) BOOL px_isStreamSharedAlbumMultipleContributorsEnabled;
@property (readonly, nonatomic) BOOL px_isInReadWriteCloudLibrary;
@property (readonly, nonatomic) BOOL px_canContainPotentiallySensitiveContent;
...
@property (readonly, nonatomic) BOOL px_isBookmarksFolder;
...
@property (readonly, nonatomic) BOOL px_isLibraryVirtualCollection;
@property (readonly, nonatomic) BOOL px_isPickerVirtualCollection;
...
@property (readonly, nonatomic) BOOL px_isCollectionsVirtualCollection;
...
@property (readonly, nonatomic) BOOL px_isAllProjectsVirtualCollection;
...
- (void).cxx_destruct;
- (long long)compactSCSensitivityAnalysis;
- (unsigned long long)sensitivityAnalysisState;
