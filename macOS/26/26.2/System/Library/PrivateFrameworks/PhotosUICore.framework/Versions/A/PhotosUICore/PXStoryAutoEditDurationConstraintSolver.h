...
@interface PXStoryAutoEditDurationConstraintSolver : NSObject {
    ...
    struct vector<PFStoryDurationInfo, std::allocator<PFStoryDurationInfo>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _infos;
    struct vector<PFStoryDurationInfo, std::allocator<PFStoryDurationInfo>> { struct *__begin_; struct *__end_; struct { struct *__cap_; } ; } _solveResults;
}
