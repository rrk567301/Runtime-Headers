@class NSError, NSString, SUMacControllerDescriptor, SUMacControllerOverrides, SUCoreProgress, SUCoreDescriptor, NSDictionary, SUCoreUpdatePreSUStagingOutcome, SUMacControllerClientRequest, NSNumber, SUMacControllerAccessControlContext;
...
@property (retain) SUCoreUpdatePreSUStagingOutcome *preSUStagingOutcome;
...
@property (nonatomic) BOOL firstRunAfterUpdate;
