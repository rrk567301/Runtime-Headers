@class NSMutableDictionary, SUOSUServiceClientManager, SUOSUNotificationManagerController, SUOSULastLockActionScheduler, SUOSUAuthenticationManager, NSDictionary, NSObject, SUOSUInstallTonightManager, SUOSUScheduler, SUOSUManagedServiceDaemon, NSString, NSXPCListener, NSArray, SUMacControllerOverrides, SUOSUMobileSoftwareUpdateController, SUOSULoginCredentialPolicyManager;
