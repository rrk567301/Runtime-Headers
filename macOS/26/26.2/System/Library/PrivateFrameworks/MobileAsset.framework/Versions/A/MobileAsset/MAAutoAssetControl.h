...
- (void)_failedControlStagerOverview:(id)a0 withErrorCode:(long long)a1 withResponseError:(id)a2 description:(id)a3 isSynchronous:(BOOL)a4 completion:(id /* block */)a5;
...
- (BOOL)_simulateCacheDeleteDetermineReclaimableSpace:(id)a0 withUrgency:(int)a1 error:(id *)a2 isSynchronous:(BOOL)a3 completion:(id /* block */)a4;
- (BOOL)_simulateCacheDeleteReclaimSpace:(id)a0 withUrgency:(int)a1 targetingPurgeAmount:(long long)a2 isSynchronous:(BOOL)a3 completion:(id /* block */)a4;
...
- (void)_stagerOverview:(BOOL)a0 limitedToAssetTypes:(id)a1 isSynchronous:(BOOL)a2 completion:(id /* block */)a3;
...
- (void)_successControlStagerOverview:(id)a0 withStagerInformation:(id)a1 isSynchronous:(BOOL)a2 completion:(id /* block */)a3;
