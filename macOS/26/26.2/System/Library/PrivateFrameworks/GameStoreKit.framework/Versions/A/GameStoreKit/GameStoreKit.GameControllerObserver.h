...
@interface GameStoreKit.GameControllerObserver : NSObject {
    ...
    void /* unknown type, empty encoding */ _dpadUpPressed;
    void /* unknown type, empty encoding */ _dpadDownPressed;
    void /* unknown type, empty encoding */ _dpadLeftPressed;
    void /* unknown type, empty encoding */ _dpadRightPressed;
    void /* unknown type, empty encoding */ _leftShoulderPressed;
    void /* unknown type, empty encoding */ _rightShoulderPressed;
    void /* unknown type, empty encoding */ _menuButtonPressed;
    void /* unknown type, empty encoding */ _optionsButtonPressed;
