@interface AskToDaemon.Server : _TtCs12_SwiftObject <AskToCore.ATDaemonProtocol> {
    ...
    void /* unknown type, empty encoding */ regionEligibilityChecker;
    void /* unknown type, empty encoding */ regionInformationFetcher;
...
- (void)canAsk:(short)a0 requiredCapabilities:(id)a1 reply:(id /* block */)a2;
- (void)canManageContactsFor:(long long)a0 reply:(id /* block */)a1;
- (void)deliverSignificantAppUpdateMockResponseToClientIfNecessaryFor:(id)a0 reply:(id /* block */)a1;
- (void)getMessagesGUIDFor:(id)a0 reply:(id /* block */)a1;
