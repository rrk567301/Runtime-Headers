...
@property (nonatomic) BOOL supportsAlternativeAppDistribution;
@property (nonatomic) BOOL isCustomBrowserEngineApp;
@property (nonatomic) BOOL usesNonWebKitBrowserEngines;
@property (nonatomic) BOOL usesNonWebKitBrowserEnginesAsSteward;
