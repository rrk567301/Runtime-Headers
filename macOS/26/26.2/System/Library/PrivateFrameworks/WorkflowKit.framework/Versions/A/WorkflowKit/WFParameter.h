@class NSHashTable, NSString, NSArray, WFResourceManager, NSSet, NSMutableDictionary, WFParameterDefinition, NSDictionary;
...
@property (readonly, nonatomic) BOOL allowsEmptyValue;
