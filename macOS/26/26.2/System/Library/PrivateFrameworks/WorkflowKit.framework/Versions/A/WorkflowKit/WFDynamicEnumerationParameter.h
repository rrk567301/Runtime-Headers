@class NSString, NSArray, NSError, NSObject, INObjectCollection;
@protocol OS_dispatch_group, WFPropertyListObject, WFDynamicEnumerationDataSource, OS_dispatch_queue;
...
@property (readonly, nonatomic) struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } possibleStatesLock;
...
- (void)lock_setPossibleStatesCollection:(id)a0;
