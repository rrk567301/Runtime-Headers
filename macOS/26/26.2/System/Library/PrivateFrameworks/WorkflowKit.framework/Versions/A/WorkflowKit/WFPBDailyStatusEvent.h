...
@property (nonatomic) BOOL hasCoherenceSyncEnablement;
@property (nonatomic) int coherenceSyncEnablement;
@property (nonatomic) BOOL hasCoherenceBlobSize;
@property (nonatomic) unsigned int coherenceBlobSize;
@property (nonatomic) BOOL hasRecoverableShortcutsCount;
