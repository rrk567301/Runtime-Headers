...
@property (readonly, nonatomic) BOOL supportsHikingTip;
@property (readonly, nonatomic) BOOL supportsAppleRatings;
@property (readonly, nonatomic) BOOL supportsPlaceNotes;
@property (readonly, nonatomic) BOOL isRouteCreationAvailable;
@property (readonly, nonatomic) BOOL supportsAcceptsPayments;
@property (readonly, nonatomic) BOOL supportsActionBar;
