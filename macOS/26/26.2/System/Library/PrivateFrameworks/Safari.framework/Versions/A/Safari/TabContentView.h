...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } backgroundViewVisibleBounds;
...
- (void)_adjustContentInsetsForSubviews;
- (id)_browserWindowController;
- (void)_currentContentViewDidChange;
- (struct NSEdgeInsets { double x0; double x1; double x2; double x3; })_insetsForContentView:(id)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_visibleBoundsForContentView:(id)a0;
