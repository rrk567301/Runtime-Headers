...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } pinningDragRegionBoundsInTabBarContainer;
...
- (unsigned long long)_dropIndexForDraggingLocation:(double)a0 inRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 isPinned:(BOOL)a2;
...
- (BOOL)shouldAnimateButtonAsInsertedForTabBarItem:(id)a0;
