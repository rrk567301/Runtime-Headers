@class NSArray, NSDictionary, NSString, WBSSavedAccountKeychainCoordinator, NSMutableArray;
...
@property (readonly, nonatomic) WBSSavedAccountKeychainCoordinator *keychainCoordinator;
