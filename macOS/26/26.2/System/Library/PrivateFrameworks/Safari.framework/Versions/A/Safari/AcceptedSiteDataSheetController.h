...
@interface AcceptedSiteDataSheetController : SheetWithTableController <NSTableViewDataSource, NSTableViewDelegate, TrackingDataControllerClient, WBTabGroupManagerObserver> {
    ...
    struct unique_ptr<Safari::TrackingDataControllerClientObjCAdapter, std::default_delete<Safari::TrackingDataControllerClientObjCAdapter>> { struct { struct TrackingDataControllerClientObjCAdapter *__ptr_; } ; } _clientObjCAdapter;
