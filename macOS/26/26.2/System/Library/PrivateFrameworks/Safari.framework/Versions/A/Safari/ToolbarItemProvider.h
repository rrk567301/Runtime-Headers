@class CombinedSidebarTabGroupToolbarButton, ToolbarDownloadsButton, TabGroupPickerToolbarButton, BrowserToolbarItem, NSSeparatorToolbarItem, CollaborationToolbarItem;
