...
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 deviceIdentifier:(id)a1 collectionType:(long long)a2 skipDecodingSyncData:(BOOL)a3;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 deviceIdentifier:(id)a1 hasIcon:(BOOL)a2 collectionType:(long long)a3 skipDecodingSyncData:(BOOL)a4;
