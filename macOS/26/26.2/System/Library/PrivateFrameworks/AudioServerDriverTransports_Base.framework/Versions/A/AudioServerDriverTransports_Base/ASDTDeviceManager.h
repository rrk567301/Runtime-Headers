@class ASDTPlugin, NSString, NSArray, ASDTCondition, NSMutableDictionary, NSDictionary, NSThread, NSMutableSet, NSMutableArray, NSSet, NSObject;
...
- (int)getInitStatusForDeviceUID:(id)a0;
