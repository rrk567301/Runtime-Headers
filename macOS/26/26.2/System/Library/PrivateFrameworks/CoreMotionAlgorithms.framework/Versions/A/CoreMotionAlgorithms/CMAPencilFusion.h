...
@interface CMAPencilFusion : NSObject {
    struct unique_ptr<CMABarrelRoll::CMABarrelRollService, std::default_delete<CMABarrelRoll::CMABarrelRollService>> { struct { struct CMABarrelRollService *__ptr_; } ; } _barrelRollService;
}
