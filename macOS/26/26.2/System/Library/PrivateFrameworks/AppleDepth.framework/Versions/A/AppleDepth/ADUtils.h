...
+ (long long)fuseCurrentDepth:(struct __CVBuffer { } *)a0 previousDepth:(struct __CVBuffer { } *)a1 intoOutputDepth:(struct __CVBuffer { } *)a2 currentConfidence:(struct __CVBuffer { } *)a3 previousConfidence:(struct __CVBuffer { } *)a4 intoOutputConfidence:(struct __CVBuffer { } *)a5 alpha:(float)a6 confidenceUnits:(unsigned long long)a7;
...
+ (long long)convertToLevelsConfidence:(struct __CVBuffer { } *)a0 confidenceOutput:(struct __CVBuffer { } *)a1 confidenceLevelRanges:(id)a2;
...
+ (struct __CVBuffer { } *)pixelBufferFromData:(id)a0 width:(unsigned long long)a1 height:(unsigned long long)a2 pixelFormat:(const char *)a3;
+ (id)pixelBufferToData:(struct __CVBuffer { } *)a0;
+ (long long)postProcessConfidence:(struct __CVBuffer { } *)a0 confidenceOutput:(struct __CVBuffer { } *)a1 rawConfidenceUnits:(unsigned long long)a2 outConfidenceUnits:(unsigned long long)a3 confidenceLevelRanges:(id)a4;
...
+ (long long)postProcessWithDepth:(struct __CVBuffer { } *)a0 confidence:(struct __CVBuffer { } *)a1 normals:(struct __CVBuffer { } *)a2 depthOutput:(struct __CVBuffer { } *)a3 confidenceOutput:(struct __CVBuffer { } *)a4 normalsOutput:(struct __CVBuffer { } *)a5 normalsRotation:(long long)a6 rawConfidenceUnits:(unsigned long long)a7 outConfidenceUnits:(unsigned long long)a8 confidenceLevelRanges:(id)a9;
...
+ (long long)warpPreviousDepth:(struct __CVBuffer { } *)a0 intoCurrentDepth:(struct __CVBuffer { } *)a1 previousConfidence:(struct __CVBuffer { } *)a2 intoCurrentConfidence:(struct __CVBuffer { } *)a3 usingOpticalFlow:(struct __CVBuffer { } *)a4;
