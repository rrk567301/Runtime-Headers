...
- (void).cxx_destruct;
- (void)bimiLogoFromLocation:(id)a0 scale:(double)a1 handler:(id /* block */)a2;
- (void)bimiLogoFromLocation:(id)a0 size:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 handler:(id /* block */)a3;
- (id)brandIndicatorFutureForLocation:(id)a0 scale:(double)a1;
- (id)brandIndicatorFutureForLocation:(id)a0 size:(struct CGSize { double x0; double x1; })a1 scale:(double)a2;
