...
@interface MTLLegacySVAccelerationStructureCommandEncoder : MTLToolsAccelerationStructureCommandEncoder {
    ...
    struct list<LegacySVResourceAndUsage, std::allocator<LegacySVResourceAndUsage>> { struct __list_node_base<LegacySVResourceAndUsage, void *> { void *__prev_; void *__next_; } __end_; struct { unsigned long long __size_; } ; } _LegacySVResourceAndUsageList;
