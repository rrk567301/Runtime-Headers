...
@interface E5RunnerImageTokenizerObjC : NSObject <E5RunnerImageTokenizerObjCProtocol> {
    struct unique_ptr<cgm::token_generation_inference::ajax::ANEAJAXE5ImageTokenizer, std::default_delete<cgm::token_generation_inference::ajax::ANEAJAXE5ImageTokenizer>> { struct { struct ANEAJAXE5ImageTokenizer *__ptr_; } ; } _imageTokenizer;
