@class HMMTRControllerWrapper, MTRDevice, NSDictionary, HMMTRTimeBasedCounter, NSMutableArray, HMMTRMetricBundle, HMMTRQueryImageResponseBusyTimer, HMMTROTAAnnounceTimer, HMMTRAccessoryReachabilityManager, HMMTRFirmwareUpdateStatus, HMMTRSyncClusterDoorLock, HMMTRDuration, NSData, MTRCommissioneeInfo, HMMTROTAApplyUpdateTimer, HMFActivity, HMMTRFabric, NSNumber, HMMTRAnnounceOtaSchedulerTimer, NSArray, HMMTRAccessoryPairingEndContext, HMMTRAccessoryServerBrowser, MTRCommissioningOperation, NSMutableDictionary, MTRDeviceController, HMMTRPairing, NSString, MTRSetupPayload, NSError, HMMTRHAPEnumerator, NSObject, HAPAccessory, NSHashTable, HMMTROTAApplyUpdateRequestTimer, HMMTRAttributeReportDistributor, HMFTimer, NSUUID, NSFileHandle, HMFFuture;
@protocol HMMTRAccessoryServerDiagnosticsEventDelegate, HMMTRReportObserver, OS_dispatch_queue, HMMTRAccessoryServerDelegate;
...
@property (nonatomic) BOOL dispatchedNetworkScanEnd;
...
@property (readonly, nonatomic) BOOL accessoryWithSameDiscriminatorDiscovered;
...
+ (id)shortDescription;
+ (id)logCategory;
+ (id)_convertPairingFailureError:(id)a0;
+ (BOOL)certificateSubjectHasCATs:(id)a0;
+ (void)propagateCharactersticValuesToAccessory:(id)a0;
+ (BOOL)shouldRetryPairingWithCommissioningSessionEstablishmentError:(id)a0;
...
- (BOOL)hasBusyImageResponseTimer;
- (BOOL)hasOtaProviderSchedulerTimer;
...
- (void)scheduleOrExecuteOTAProviderAnnouncement:(id)a0 initiatorType:(unsigned long long)a1 immediateAnnouncement:(BOOL)a2 endpoint:(id)a3 delayCounter:(long long)a4 isUserTriggered:(BOOL)a5;
- (void)setCHIPReportHandler:(id /* block */)a0;
- (void)startBusyImageResponseTimer:(id)a0 timeInterval:(double)a1 endpoint:(id)a2 requestParams:(id)a3 queue:(id)a4;
- (void)stopBusyImageResponseTimer;
- (void)stopPairingWithError:(id *)a0 metricsReadyHandler:(id /* block */)a1;
...
- (void)commissioning:(id)a0 failedWithError:(id)a1 metrics:(id)a2;
- (void)commissioning:(id)a0 readCommissioneeInfo:(id)a1;
- (void)commissioning:(id)a0 succeededForNodeID:(id)a1 metrics:(id)a2;
- (void)commissioningProvisionedNetworkCredentials:(id)a0;
- (void)commissioningStartingNetworkScan:(id)a0;
- (void)setupReporting;
...
- (void)_collectThreadNetworkCredentials:(id)a0 completion:(id /* block */)a1;
- (void)_collectWiFiNetworkCredentials:(id)a0 completion:(id /* block */)a1;
- (void)_commissioning:(id)a0 complete:(id)a1 abstractMetrics:(id)a2;
- (void)_commissioningAndPairedNodeRecoveryComplete:(id)a0 abstractMetrics:(id)a1;
- (id)_computeSetupPayloadString;
- (BOOL)_controllerIsOnWiFiNetworkWhichSupportsBothBands;
- (id)_createCommissioningOperationWithParameters:(id)a0 setupPayload:(id)a1;
...
- (BOOL)_isAllowedForRawEventDictionaryHandling:(id)a0;
...
- (void)_queueOpenPairingWindowWithPINForDuration:(double)a0 completionHandler:(id /* block */)a1;
...
- (void)_retrieveRootEndpointPartsListWithDevice:(id)a0 completion:(id /* block */)a1;
- (void)_retryPairing;
...
- (void)_startNewCommissioningWithPayload:(id)a0;
...
- (void)_syncAbortStagingWithError:(id)a0 context:(id)a1;
- (BOOL)_threadScanRequired;
...
- (void)announceOtaProvider:(id)a0 providerEndpoint:(id)a1 immediateAnnouncement:(BOOL)a2 delayCounter:(long long)a3 completionHandler:(id /* block */)a4;
...
- (BOOL)isLocallyDiscoveredAndMatchesDiscriminatorOfSetupPayload:(id)a0;
...
- (void)startOtaProviderSchedulerTimer:(double)a0 endpoint:(id)a1 queue:(id)a2;
- (void)startStagedPairingWithCompletion:(id /* block */)a0;
- (void)startStagedPairingWithDeviceCredentialHandler:(id /* block */)a0 wifiScanResultsHandler:(id /* block */)a1 threadScanResultsHandler:(id /* block */)a2 readyToCancelHandler:(id /* block */)a3 progressUpdateHandler:(id /* block */)a4 commissioneeInfoHandler:(id /* block */)a5 scanningNetworks:(BOOL)a6 completion:(id /* block */)a7;
