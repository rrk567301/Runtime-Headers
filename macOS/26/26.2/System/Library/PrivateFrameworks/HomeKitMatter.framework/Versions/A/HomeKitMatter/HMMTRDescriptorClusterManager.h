...
- (id)init;
- (id)protocolMap;
- (id)_fetchAccessoryConfigurationForDevice:(id)a0 endpointID:(id)a1 callbackQueue:(id)a2;
- (void)endpointForClusterID:(id)a0 mtrDevice:(id)a1 callbackQueue:(id)a2 completionHandler:(id /* block */)a3;
- (id)endpointForClusterID:(id)a0 mtrDevice:(id)a1;
- (id)_buildClustersInUseDictWithClustersInUse:(id)a0;
- (id)_endpointIncludingClusterID:(id)a0 amongEndpoints:(id)a1 device:(id)a2 error:(id *)a3;
- (id)_fetchAccessoryConfigurationForDevice:(id)a0 endpointID:(id)a1 clusterID:(id)a2 callbackQueue:(id)a3;
...
- (id)_populateMeasuredValueAttributeForClusterClassName:(id)a0 clusterClassFeatureMap:(id)a1 endpoint:(id)a2 device:(id)a3 deviceTopology:(id)a4 callbackQueue:(id)a5;
...
- (void)endpointForClusterID:(id)a0 device:(id)a1 partsList:(id)a2 callbackQueue:(id)a3 completionHandler:(id /* block */)a4;
- (id)endpointsWithMTRDevice:(id)a0 endpointID:(id)a1;
- (void)fetchAccessoryConfigurationForDevice:(id)a0 nodeId:(id)a1 server:(id)a2 reasonString:(id)a3 callbackQueue:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)fetchHAPCategoryForCHIPDevice:(id)a0 nodeId:(id)a1 server:(id)a2 partsList:(id)a3 callbackQueue:(id)a4 completionHandler:(id /* block */)a5;
...
- (id)hapServiceDescriptionForServiceType:(id)a0 linkedServiceTypes:(id)a1 clustersInUse:(id)a2 endpoint:(id)a3 name:(id)a4 hapToCHIPClusterMappingArray:(id)a5 clusterClassesToQuery:(id)a6 hapServicesToCheckForFeatureMap:(id)a7 hapServicesToCheckForOptionalMatterAttribute:(id)a8 hapServicesToCheckForRequiredAttributeValues:(id)a9 hapCharacteristicsToCheckForRequiredAttributeValues:(id)a10 server:(id)a11;
- (id)hapServiceDescriptionsForTopology:(id)a0 namesDictionary:(id)a1 server:(id)a2;
- (void)isEndpointPresentForClusterID:(id)a0 endpoint:(id)a1 device:(id)a2 callbackQueue:(id)a3 completionHandler:(id /* block */)a4;
- (void)isEndpointPresentForClusterID:(id)a0 endpoint:(id)a1 mtrDevice:(id)a2 callbackQueue:(id)a3 completionHandler:(id /* block */)a4;
