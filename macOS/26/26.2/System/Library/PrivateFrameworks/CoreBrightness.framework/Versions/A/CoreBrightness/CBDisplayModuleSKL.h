@class NSMutableDictionary, CBThermalBrightnessCap, NSObject, CBRingLight, CBGammaContrastPreservation, CBRampManager, NSMutableArray, CBDynamicSlider, NSString, CBEDR, CBAurora, CBNVRAM, CBAppliedCompensations, AABCHistograms;
