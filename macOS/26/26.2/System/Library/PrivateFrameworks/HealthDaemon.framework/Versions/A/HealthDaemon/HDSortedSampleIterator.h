...
@interface HDSortedSampleIterator : NSObject <HDSampleIterator, HDDeletedObjectIterator> {
    ...
    NSError *_lastError;
    BOOL _isComplete;
    struct vector<std::tuple<long long, HKSample *>, std::allocator<std::tuple<long long, HKSample *>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _sampleBuffer;
    struct vector<std::tuple<long long, HKDeletedObject *>, std::allocator<std::tuple<long long, HKDeletedObject *>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _deletedObjectsBuffer;
