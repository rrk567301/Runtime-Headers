...
- (struct unique_ptr<health::DataStore, std::default_delete<health::DataStore>> { struct { struct DataStore *x0; } x0; })dataStoreAtURL:(id)a0 filesystem:(const void *)a1 allowCheckpoint:(BOOL)a2 error:(id *)a3;
