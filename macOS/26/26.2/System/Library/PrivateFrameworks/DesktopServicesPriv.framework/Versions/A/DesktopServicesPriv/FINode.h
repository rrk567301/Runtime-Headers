@class NSURL, FPProviderDomain, NSError, NSDate, NSObject, NSProgress, FIProviderDomain, BRContainer, NSString, NSPersonNameComponents, NSArray, NSNumber, FPItem, UTType;
