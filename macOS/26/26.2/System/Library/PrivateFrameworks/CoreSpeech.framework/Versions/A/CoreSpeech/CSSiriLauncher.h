...
- (void)_notifyBuiltInVoiceTriggerPrewarm:(id)a0 activationSource:(long long)a1 completion:(id /* block */)a2;
...
- (void)notifyBuiltInVoiceTriggerPrewarmExclave:(id)a0 completion:(id /* block */)a1;
...
- (void)notifyContinuousConversationActivation:(id)a0 deviceId:(id)a1 completion:(id /* block */)a2;
