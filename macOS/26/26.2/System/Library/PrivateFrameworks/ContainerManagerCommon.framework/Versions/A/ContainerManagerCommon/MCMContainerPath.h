...
- (BOOL)createIfNecessaryWithDataProtectionClass:(int)a0 quarantine:(BOOL)a1 error:(id *)a2;
...
- (BOOL)_createURLIfNecessary:(id)a0 mode:(unsigned short)a1 owner:(id)a2 dataProtectionClass:(int)a3 quarantine:(BOOL)a4 exists:(BOOL *)a5 error:(id *)a6;
- (void).cxx_destruct;
