...
- (BOOL)quarantineNeededForDirectoryURL:(id)a0;
- (id)fsMinimallySanitizedStringFromString:(id)a0;
...
- (id)fsSanitizedStringFromString:(id)a0 allowSpaces:(BOOL)a1;
...
- (BOOL)quarantineURL:(id)a0 identifier:(id)a1 error:(id *)a2;
- (BOOL)symbolicallyLinkURL:(id)a0 toSymlinkTarget:(id)a1 error:(id *)a2;
- (BOOL)setDataProtectionAtURL:(id)a0 toDataProtectionClass:(int)a1 directoriesOnly:(BOOL)a2 recursive:(BOOL)a3 error:(id *)a4;
