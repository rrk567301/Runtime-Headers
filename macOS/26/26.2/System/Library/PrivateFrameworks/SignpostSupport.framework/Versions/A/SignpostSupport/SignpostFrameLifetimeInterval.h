...
@property (nonatomic) BOOL isMaintaningFrameCadanceWithPreviousFrameLifetime;
...
- (void).cxx_destruct;
- (unsigned int)_displayID;
- (BOOL)_glitchIntervalBeginTime:(unsigned long long *)a0 roundingUp:(BOOL)a1 previousMCT:(unsigned long long)a2 hasLongUpdateSequence:(BOOL)a3;
- (id)_glitchIntervalWithRoundingUp:(BOOL)a0 previousMCT:(unsigned long long)a1 hasLongUpdateSequence:(BOOL)a2;
- (BOOL)_hasDisplayID;
- (BOOL)_inProcessGlitchIntervalBeginTime:(unsigned long long *)a0 targetMCT:(unsigned long long)a1 previousMCT:(unsigned long long)a2 hasLongUpdateSequence:(BOOL)a3;
- (id)_inProcessGlitchIntervalWithTargetMCT:(unsigned long long)a0 previousMCT:(unsigned long long)a1 hasLongUpdateSequence:(BOOL)a2;
...
- (id)initWithInterval:(id)a0 contextArray:(id)a1 isLong:(BOOL)a2 renderInterval:(id)a3 gpuInterval:(id)a4 frameSeedToSkippedRenderIntervals:(id)a5;
- (id)initWithInterval:(id)a0 swapID:(unsigned int)a1 surfaceID:(unsigned int)a2 frameSeed:(unsigned int)a3 displayID:(unsigned int)a4 skipRequested:(BOOL)a5 bufferCount:(unsigned char)a6 refreshInterval:(unsigned long long)a7 previousPresentationMCT:(unsigned long long)a8 inProcessTargetMCT:(unsigned long long)a9 contextArray:(id)a10 isLong:(BOOL)a11 renderInterval:(id)a12 gpuInterval:(id)a13;
