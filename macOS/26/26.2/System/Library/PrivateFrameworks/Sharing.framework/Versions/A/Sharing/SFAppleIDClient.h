...
- (void)_invalidate;
- (void)dealloc;
- (void)_altDSIDLookupWithEmails:(id)a0 phoneNumbers:(id)a1 completion:(id /* block */)a2;
...
- (void)altDSIDLookupWithEmails:(id)a0 phoneNumbers:(id)a1 completion:(id /* block */)a2;
