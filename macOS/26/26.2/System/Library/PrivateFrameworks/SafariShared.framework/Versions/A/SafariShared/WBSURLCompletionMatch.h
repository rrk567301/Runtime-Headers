...
@property (nonatomic) BOOL isTabCompletionItem;
@property (readonly, nonatomic) BOOL isSynthesized;
@property (readonly, nonatomic) BOOL wasPromotedAsSearchResultTopHitWithTitleMatch;
