...
+ (id)recentAndSuggestedCompletionStringsByMergingRecentSearches:(id)a0 withSuggestions:(id)a1 userTypedString:(id)a2 userTypedStringHasMultipleCorrespondingRichSuggestions:(BOOL)a3;
