...
@property (readonly) struct vector<TSU::UUIDData<TSP::UUIDData>, std::allocator<TSU::UUIDData<TSP::UUIDData>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } baseUuidVector;
