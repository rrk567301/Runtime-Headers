...
@property (nonatomic) BOOL timeZoneOverrideEnabled;
...
@property (nonatomic) BOOL treatRemindersAsNotOverdue;
...
@property (nonatomic) BOOL resetShowSuggestGroceries;
...
@property (nonatomic) BOOL showUrgentRemindersCompleteButton;
...
@property (nonatomic) BOOL isAutoCategorizationLoggingEnabled;
@property (nonatomic) BOOL excludeExistingSectionsForAutoCategorizationEnabled;
...
@property (copy, nonatomic) NSDate *lastViewedUrgentAlarmNonMePermissionDeviceWarmingSheetDate;
...
- (id)observeTimeZoneOverrideWithBlock:(id /* block */)a0;
- (id)observeEnableAssignmentNotificationsWithBlock:(id /* block */)a0;
- (BOOL)hideEmptySectionsForGroceryList:(id)a0;
- (void)setLastViewedUrgentAlarmNonMeDevicePermissionWarmingSheetDate:(id)a0;
...
- (id)observeTimeZoneOverrideEnabledWithBlock:(id /* block */)a0;
- (id)lastViewedUrgentAlarmNonMeDevicePermissionWarmingSheetDate;
...
- (id)observeShowUrgentRemindersCompleteButtonWithBlock:(id /* block */)a0;
...
- (id)observeTreatRemindersAsNotOverdueWithBlock:(id /* block */)a0;
