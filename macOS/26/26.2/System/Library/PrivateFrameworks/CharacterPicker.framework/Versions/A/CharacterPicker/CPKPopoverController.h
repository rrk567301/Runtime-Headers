@class CPKCategoriesView, STKEmojiGenerationViewController, NSDictionary, CPKCharactersView, CPKHeaderView, CPKSearchView, NSMutableArray, CPKDividerLine, NSRemoteViewController, NSString, CPSearchManager, STKEmojiGenerationViewControllerOLD, CPKCategoriesPickerView, CPKPopover, NSArray, CPKBottomView, NSView, CPKTestWindow, CPKDataProvider;

@interface CPKPopoverController : NSViewController <CPKCharactersViewDelegate, CPKCharactersViewDataSource, CPKSearchViewDelegate, NSSearchFieldDelegate, NSWindowDelegate, CPKCategoriesPickerViewDelegate> {
    ...
    BOOL _dontUnhideGridAfterUpdatingDataProvider;
    ...
    struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } _genmojiCreationContentsFrame;
...
@property (readonly, nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } genmojiContentsFrame;
...
@property (weak) CPKPopover *enclosingPopover;
...
- (void)updateTrailingEdgeAuxiliaryView;
...
- (void)endMixmojiSelect;
- (id)entityAtIndex:(long long)a0 ofSection:(long long)a1;
- (void)expansionButtonClicked;
- (void)extendContentTopBy:(double)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })genmojiContentsWindowFrame;
...
- (BOOL)isRemotelyPresentingWindow:(id)a0;
...
- (void)prepareRelease;
- (void)pushHeaderSubview:(id)a0;
- (void)refreshCharactersView:(id)a0;
- (void)removeTitleAndBackButton;
...
- (void)sendMixmojiToCreationView:(id)a0;
- (void)setGridHidden:(BOOL)a0;
...
- (void)setupGridUIForMode:(unsigned long long)a0;
