...
@interface VKMuninCameraController : VKCameraController <VKGesturingCameraController> {
    ...
    struct unique_ptr<(anonymous namespace)::BumpAnimator, std::default_delete<(anonymous namespace)::BumpAnimator>> { struct { struct BumpAnimator *__ptr_; } ; } _bumpAnimator;
    BOOL _panning;
    BOOL _panStopping;
    ...
    struct unique_ptr<(anonymous namespace)::PathAnimationDescription, std::default_delete<(anonymous namespace)::PathAnimationDescription>> { struct { struct PathAnimationDescription *__ptr_; } ; } _currentPathAnimation;
    struct unique_ptr<(anonymous namespace)::PendingPathAnimation, std::default_delete<(anonymous namespace)::PendingPathAnimation>> { struct { struct PendingPathAnimation *__ptr_; } ; } _pendingPathAnimation;
