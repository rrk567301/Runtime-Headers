@class VKRouteContext, NSString, VKNotificationObserver, GEOPOICategoryFilter, VKMapImageCanvas, VKManifestTileGroupObserverProxy;
...
@interface VKMapSnapshotCreator : NSObject <MapEngineDelegate, VKNotificationObserverDelegate> {
    ...
    struct vector<CGImage *, std::allocator<CGImage *>> { struct CGImage **__begin_; struct CGImage **__end_; struct { struct CGImage **__cap_; } ; } _images;
    struct vector<__IOSurface *, std::allocator<__IOSurface *>> { struct __IOSurface **__begin_; struct __IOSurface **__end_; struct { struct __IOSurface **__cap_; } ; } _ioSurfaces;
    ...
    struct unique_ptr<gdc::Timer, std::default_delete<gdc::Timer>> { struct { struct Timer *__ptr_; } ; } _expirationTimer;
...
- (void)capturePostSnapshotStatisticsIfNecessary:(id)a0;
