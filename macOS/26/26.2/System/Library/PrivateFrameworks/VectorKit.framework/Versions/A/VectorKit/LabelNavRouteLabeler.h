...
@property (readonly, nonatomic) struct vector<std::shared_ptr<md::NavLabel>, geo::allocator_adapter<std::shared_ptr<md::NavLabel>, mdm::zone_mallocator>> { void *__begin_; void *__end_; struct { void *__cap_; struct allocator_adapter<std::shared_ptr<md::NavLabel>, mdm::zone_mallocator> { struct zone_mallocator { } _allocator; } __alloc_; } ; } activeSigns;
