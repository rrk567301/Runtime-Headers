@class , CCContextDeviceGroup, CCWarpAlgorithmForwardDescriptor, CCVFWMeshGenerationAlgorithm, CCFittingPlaneHybridWarpAlgorithm, __end_, CCAdaptiveMeshGenerationAlgorithm, NSArray, CCMinMaxDepthBinAlgorithm;
...
@interface CCWarpAlgorithmForward : CCWarpAlgorithm {
    ...
    struct vector<id<MTLRenderPipelineState>, std::allocator<id<MTLRenderPipelineState>>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _renderPipelineApplyStencil;
