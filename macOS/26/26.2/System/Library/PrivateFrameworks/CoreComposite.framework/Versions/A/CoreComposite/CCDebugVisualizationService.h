@class , CCContextDeviceGroup, CCDebugVisualizationServiceDescriptor, MTLRenderPassDescriptor, CCLane, CCSimpleRenderPass, __end_;
@protocol MTLTexture, MTLBuffer;

@interface CCDebugVisualizationService : CCService {
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _missFrameGraphVisualizerPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _missFrameSpeedoMeterPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _badgeLogoMarkerVisualizerPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _gazeMarkerPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _displayCorrectionZoomBorderPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _gazeTrackZonePipline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _gazeVRRVisualizationPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _whiteScreenM2PFlashPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _fullScreenVisualizationPipeline;
    struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } _fullScreenGridVisualizationPipeline;
    struct DebugLayerServiceData { struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } imagePipelineStates; struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } wireframePipelineStates; struct realtime_vector<id<MTLRenderPipelineState>> { __end_ **__begin_;  **x0; struct { id *__cap_; } x1; } pointsPipelineStates; id<MTLBuffer> cornerVertices; id<MTLBuffer> basisVertices; id<MTLBuffer> pointsModelViewProjectionBuffer; id<MTLBuffer> meshesModelViewProjectionBuffer; } _debugLayer;
    ...
    struct queue<long long, std::deque<long long>> { struct deque<long long, std::allocator<long long>> { struct __split_buffer<long long *, std::allocator<long long *>> { long long **__first_; long long **__begin_; long long **__end_; struct { long long **__cap_; } ; } __map_; unsigned long long __start_; struct { unsigned long long __size_; } ; } c; } _clientsMissedFrameQueue;
