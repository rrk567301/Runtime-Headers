@class WFCloudKitSyncEventLogger, NSString, NSArray, CKContainer, NSMutableDictionary, CKSyncEngine, CKSyncEngineSendChangesOptions, VCCKApplicationStateObserver, CKRecordZoneID, CKSyncEngineFetchChangesOptions, WFDatabase;
...
- (id)initWithContainer:(id)a0 database:(id)a1 applicationObserver:(id)a2 debuggingOptions:(unsigned long long)a3 logger:(id)a4;
