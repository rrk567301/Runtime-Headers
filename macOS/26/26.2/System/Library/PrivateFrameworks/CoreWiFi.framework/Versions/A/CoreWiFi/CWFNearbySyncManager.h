...
- (id)__failedNearbyNetworkSyncRequestTimestampForDevice:(id)a0 network:(id)a1;
...
- (void)__updateFailedNearbyNetworkSyncRequestTimestampForDevice:(id)a0 network:(id)a1;
