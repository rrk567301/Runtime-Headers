...
- (void)storeDataInSyncableKeyStoreForIdentifier:(id)a0 data:(id)a1 credentialIdentifier:(id)a2 completion:(id /* block */)a3;
...
- (void)updateDataInSyncableKeyStoreForIdentifier:(id)a0 attributesToUpdate:(id)a1 credentialIdentifier:(id)a2 completion:(id /* block */)a3;
