...
@interface AVAudioIOController_macOS : NSObject <AVAudioIOController> {
    ...
    struct unique_ptr<avas::client::IOControllerImpl, std::default_delete<avas::client::IOControllerImpl>> { struct { struct IOControllerImpl *__ptr_; } ; } _impl;
    struct unique_ptr<avas::client::AggregateDeviceFactory, std::default_delete<avas::client::AggregateDeviceFactory>> { struct { struct AggregateDeviceFactory *__ptr_; } ; } _aggregateDeviceFactory;
}
