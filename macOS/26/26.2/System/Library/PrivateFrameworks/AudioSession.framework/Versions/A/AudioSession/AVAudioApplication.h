@interface AVAudioApplication : NSObject {
    struct unique_ptr<caulk::synchronized<avas::client::AVAudioApplicationImpl>, std::default_delete<caulk::synchronized<avas::client::AVAudioApplicationImpl>>> { struct { void *__ptr_; } ; } _impl;
}
