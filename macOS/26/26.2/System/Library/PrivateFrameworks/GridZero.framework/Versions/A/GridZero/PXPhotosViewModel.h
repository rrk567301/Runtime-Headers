...
@property (readonly, nonatomic) BOOL wantsImmediateBarsUpdate;
...
@property (readonly, nonatomic) BOOL prefersCurationModeToggleInNavBar;
...
- (void)setAllowsSearch:(BOOL)a0;
- (void)setAllowsShareAllAction:(BOOL)a0;
- (void)setAllowsSortAndFilterMenu:(BOOL)a0;
...
- (void)setWantsImmediateBarsUpdate:(BOOL)a0;
