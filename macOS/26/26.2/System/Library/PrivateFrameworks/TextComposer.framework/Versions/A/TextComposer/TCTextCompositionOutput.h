@class NSString, NSDictionary, NSArray, NSAttributedString, TCTextCompositionUserProvidedPreferences;
...
- (id)initWithInput:(id)a0 inputString:(id)a1 openEndedString:(id)a2 leadingString:(id)a3 trailingString:(id)a4 writingOptions:(id)a5 resultOptions:(id)a6 tagger:(id)a7 error:(id *)a8;
...
- (id)initWithInput:(id)a0 rewrittenString:(id)a1 resultOptions:(id)a2;
- (id)initWithInput:(id)a0 rewrittenString:(id)a1 resultOptions:(id)a2 tagger:(id)a3;
- (id)initWithInput:(id)a0 rewrittenString:(id)a1 resultOptions:(id)a2 tagger:(id)a3 userProvidedPreferences:(id)a4;
- (id)initWithInput:(id)a0 rewrittenString:(id)a1 userProvidedPreferences:(id)a2;
...
- (id)initWithRewrittenAttributedString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 inputLengths:(id)a2 outputLengths:(id)a3 options:(id)a4 characterExpansions:(id)a5 userProvidedPreferences:(id)a6;
- (id)inputLengths;
- (id)outputLengths;
