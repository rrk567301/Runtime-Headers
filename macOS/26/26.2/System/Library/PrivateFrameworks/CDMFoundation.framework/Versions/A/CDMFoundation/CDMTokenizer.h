...
@interface CDMTokenizer : NSObject {
    void *_analyzer;
    struct unique_ptr<morphun::Tokenizer, std::default_delete<morphun::Tokenizer>> { struct { struct Tokenizer *__ptr_; } ; } _tokenizer;
    void *_normalizer;
    struct unique_ptr<morphun::util::ULocale, std::default_delete<morphun::util::ULocale>> { struct { struct ULocale *__ptr_; } ; } _locale;
    NSString *_language;
    int _maxTokens;
