@interface ConversationKit.ConversationControlsManager : NSObject <CNKGameControllerResponder, TUGameOverlayControllerDelegate> {
    ...
    void /* unknown type, empty encoding */ gameOverlayController;
    void /* unknown type, empty encoding */ contentExtractor;
    void /* function */ presentContactCard;
    void /* function */ presentAddParticipantSheet;
    void /* unknown type, empty encoding */ isOnScreenSubscription;
    void /* unknown type, empty encoding */ defaults;
    void /* unknown type, empty encoding */ cnkFeatures;
    ...
    void /* unknown type, empty encoding */ tccServer;
    void /* unknown type, empty encoding */ applicationState;
    void /* unknown type, empty encoding */ _secondaryPillButtonType;
...
- (BOOL)gameControllerDidRequestFocus:(BOOL)a0;
