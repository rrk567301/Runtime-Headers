...
@interface ASDDSPStream : ASDStream {
    ...
    struct unique_ptr<ASDDSPStreamHelper, std::default_delete<ASDDSPStreamHelper>> { struct { struct ASDDSPStreamHelper *__ptr_; } ; } _streamHelper;
    struct list<ASDDSPGraphHelper, std::allocator<ASDDSPGraphHelper>> { struct __list_node_base<ASDDSPGraphHelper, void *> { void *__prev_; void *__next_; } __end_; struct { unsigned long long __size_; } ; } _graphHelpers;
    struct unique_ptr<caulk::concurrent::guarded_lookup_hash_table<unsigned long long, ASDDSPGraphHelper *, caulk::concurrent::guarded_lookup_hash_table_must_count_dereferences>, std::default_delete<caulk::concurrent::guarded_lookup_hash_table<unsigned long long, ASDDSPGraphHelper *, caulk::concurrent::guarded_lookup_hash_table_must_count_dereferences>>> { struct { void *__ptr_; } ; } _clientToGraphMap;
