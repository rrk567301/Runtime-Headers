...
- (BOOL)clearShortcutForCommandWithName:(id)a0;
...
- (BOOL)updateCommandWithCommandInfo:(id)a0;
...
- (BOOL)_updateCommandWithName:(id)a0 withValue:(id)a1 forKey:(id)a2;
- (id)_userInfoDictionaryForPermissionsNotificationWithPermissions:(id)a0 origins:(id)a1;
- (id)_userVisiblePermissionsIncludingCommands:(BOOL)a0;
...
- (BOOL)hasCustomizedShortcutForCommand:(id)a0;
...
- (id)initWithWebKitExtension:(id)a0 extensionIdentifier:(id)a1 uniqueIdentifier:(id)a2;
...
- (void)restoreDefaultShortcutForCommand:(id)a0;
