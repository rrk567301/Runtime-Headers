...
+ (id)resultWithFavicon:(id)a0 iconData:(id)a1 iconURL:(id)a2 host:(id)a3 pageRequestDidSucceed:(BOOL)a4 response:(id)a5 higherPriorityIconDownloadFailedDueToNetworkError:(BOOL)a6 faviconInfoFromWebView:(id)a7;
