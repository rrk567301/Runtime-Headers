...
- (id)searchURLForUserTypedString:(id)a0 richSearchSuggestionEntityIDURLParameter:(id)a1;
...
- (void)_updateSuggestionsURLTemplateWithGroupIdentifier:(long long)a0;
