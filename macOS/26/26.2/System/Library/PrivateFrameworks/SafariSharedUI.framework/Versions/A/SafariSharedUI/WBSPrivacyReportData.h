@class NSString, NSArray, WBSKnownTrackingThirdParty, NSSet, NSMutableArray, NSObject, WBSKnownTrackerFilter, WKWebView;
...
+ (void)setCachedPrivacyReportDataOnStartPage:(id)a0 forProfileWithIdentifier:(id)a1;
+ (id)cachedNumberOfTrackersOnStartPageForProfileWithIdentifier:(id)a0;
+ (id)cachedPrivacyReportDataOnStartPageForProfileWithIdentifier:(id)a0;
...
- (id)_getRecentFirstPartiesFromThirdParty:(id)a0 fromStartDate:(id)a1 toEndDate:(id)a2;
- (void)_ingestPreventedThirdParties:(id)a0 blockedThirdParties:(id)a1 fromStartDate:(id)a2 toEndDate:(id)a3 completionHandler:(id /* block */)a4;
