...
+ (id)updatePlayMediaActionPredictions:(id)a0 withUpcomingMedia:(id)a1 forActionKey:(id)a2 appActionPredictionItem:(const struct ATXPredictionItem { id x0; unsigned long long x1; float x2[828]; float x3; BOOL x4; BOOL x5; } *)a3 appActionLogProbability:(double)a4 statistics:(id)a5;
