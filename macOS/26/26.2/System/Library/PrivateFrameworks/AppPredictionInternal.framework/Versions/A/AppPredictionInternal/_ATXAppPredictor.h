...
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct { struct ATXPredictionItem *x0; } x2; })_evalFeaturesForActions:(id)a0 scoreLogger:(id)a1 context:(id)a2 featureCache:(id)a3;
...
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct { struct ATXPredictionItem *x0; } x2; })_getPredictionForItems:(id)a0 clipBundleIdsToRank:(id)a1 consumerSubType:(unsigned char)a2 intent:(id)a3 scoreLogger:(id)a4 context:(id)a5 featureCache:(id)a6;
...
- (id)getABGroups;
- (id)appLaunchMonitor;
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct { struct ATXPredictionItem *x0; } x2; })_evalFeaturesForAppIntents:(id)a0 scoreLogger:(id)a1 context:(id)a2;
- (id)init;
...
- (id)initInternal;
- (struct vector<ATXPredictionItem, std::allocator<ATXPredictionItem>> { struct ATXPredictionItem *x0; struct ATXPredictionItem *x1; struct { struct ATXPredictionItem *x0; } x2; })_evalFeaturesForAppForAllIntents:(id)a0 scoreLogger:(id)a1 context:(id)a2;
