...
@interface _EARFormatter : NSObject {
    struct unique_ptr<SpeechITN, std::default_delete<SpeechITN>> { struct { struct SpeechITN *__ptr_; } ; } _itn;
...
+ (void)initialize;
+ (struct vector<quasar::Token, std::allocator<quasar::Token>> { struct Token *x0; struct Token *x1; struct { struct Token *x0; } x2; })convertStringsToQuasarTokens:(id)a0;
+ (struct vector<quasar::Token, std::allocator<quasar::Token>> { struct Token *x0; struct Token *x1; struct { struct Token *x0; } x2; })convertStringsToQuasarTokens:(id)a0 offset:(unsigned int)a1;
...
- (void).cxx_destruct;
- (id).cxx_construct;
- (struct vector<quasar::Token, std::allocator<quasar::Token>> { struct Token *x0; struct Token *x1; struct { struct Token *x0; } x2; })formatWords:(const void *)a0 unrepairedWordsOut:(void *)a1;
- (struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct { union __rep { struct __short { char x0[23]; unsigned char x1 : 7; unsigned char x2 : 1; } x0; struct __long { char *x0; unsigned long long x1; unsigned long x2 : 63; unsigned char x3 : 1; } x1; } x0; } x0; })getOrthography:(const void *)a0;
...
- (struct vector<std::string, std::allocator<std::string>> { void *x0; void *x1; struct { void *x0; } x2; })emojiAlternativesForEmojis:(id)a0;
...
- (struct vector<quasar::Token, std::allocator<quasar::Token>> { struct Token *x0; struct Token *x1; struct { struct Token *x0; } x2; })formattedTokensWithoutEmojiModifier:(const void *)a0 emojiTokenIndices:(const void *)a1 recognizeEmoji:(BOOL)a2;
