...
- (id)initWithProfileUniqueIdentifier:(id)a0 slotIdentifier:(id)a1 aspectRatio:(double)a2 sessionUUID:(id)a3 audioStreamSetting:(unsigned long long)a4 audioDownlinkToken:(long long)a5 audioUplinkToken:(long long)a6;
