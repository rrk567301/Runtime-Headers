...
@interface HMAccessory : NSObject <HMMediaDestinationControllerDataSource, HMAccessoryInfoDataProviderDelegate, HMFLogging, HMAccessorySettingsContainerInternal, HMControllable, HMMediaDestinationInternal, HMMutableApplicationDataContainer, HMObjectMerge, HMFMessageReceiver, HMFObject, HMAccessorySettingsAdapterDelegate, NSSecureCoding, HMApplicationDataContainer, HMMediaDestination> {
