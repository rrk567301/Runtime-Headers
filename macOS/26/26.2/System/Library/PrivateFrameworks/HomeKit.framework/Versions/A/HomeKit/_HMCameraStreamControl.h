@class NSUUID, NSString, HMCameraStream;
...
- (void)_handleStreamStartedWithResponse:(id)a0 sessionUUID:(id)a1 error:(id)a2;
- (void)_handleVideoStopResponse:(id)a0 sessionUUID:(id)a1 error:(id)a2;
