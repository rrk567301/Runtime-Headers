...
- (void).cxx_destruct;
- (id)description;
- (id)initWithAttachmentDictionary:(id)a0 recipientConservativeDictionary:(id)a1 recipientDictionary:(id)a2 nicknameDictionary:(id)a3 followUpOnOutgoingMailsQuestionsDictionary:(id)a4 followUpOnOutgoingMailsAsksDictionary:(id)a5 followUpOnIncomingMailsDictionary:(id)a6 compiledRegexCache:(id)a7;
