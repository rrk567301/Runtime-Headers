...
@interface VCPLoudnessAnalyzer : NSObject {
    ...
    float _sampleRate;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _peakValues;
    struct vector<double, std::allocator<double>> { double *__begin_; double *__end_; struct { double *__cap_; } ; } _momentaryEnergyValues;
    struct vector<float, std::allocator<float>> { float *__begin_; float *__end_; struct { float *__cap_; } ; } _loudnessSampleBuffer;
