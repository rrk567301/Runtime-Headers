...
- (void)_sendRequest;
- (id)initWithName:(id)a0 controller:(id)a1 encoding:(id)a2 transport:(id)a3 prepareRequest:(id)a4 executeRequest:(id)a5 endpoint:(id)a6 mimeType:(id)a7 timeout:(double)a8 options:(unsigned long long)a9 dscpPriority:(long long)a10;
