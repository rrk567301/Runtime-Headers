...
- (id)initWithType:(id)a0 instanceID:(id)a1 value:(id)a2 stateNumber:(id)a3 properties:(unsigned short)a4 eventNotificationsEnabled:(BOOL)a5 implicitWriteWithResponse:(BOOL)a6 metadata:(id)a7;
- (id)initWithType:(id)a0 instanceID:(id)a1 value:(id)a2 stateNumber:(id)a3 properties:(unsigned short)a4 eventNotificationsEnabled:(BOOL)a5 metadata:(id)a6;
