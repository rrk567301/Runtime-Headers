...
+ (id)personalitiesFromAssetsWithKey:(id)a0 launchCounts:(id)a1;
...
+ (id)widgetExtensionAndKindFromKey:(id)a0;
...
+ (BOOL)shouldConsiderSimilarThirdPartyWidgetsForPosition:(id)a0;
+ (id)eligibleThirdPartyWidgetFromSimilarWidgets:(id)a0 launchCounts:(id)a1;
+ (id)personalitiesFromAssetsWithKey:(id)a0;
+ (id)similarThirdPartyWidgetsForPosition:(id)a0;
...
+ (id)mergedDescriptorsFrom:(id)a0 withAdditional:(id)a1;
+ (id)bundleIdentifierFromWidgetKey:(id)a0;
