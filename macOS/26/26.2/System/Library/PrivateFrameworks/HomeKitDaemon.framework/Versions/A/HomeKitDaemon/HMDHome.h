...
@protocol HMDActionSetStateObserver, HMDFeaturesDataSource, HAPKeyStore, NSObject, OS_dispatch_queue, HMDHomeDataSource, HMDHomePresenceCheck, HMDResidentSyncManager, HMDHomeSwiftExtensions, HMDCarPlayDataSource, HMDActionSetStateSubscriptionManager, HMMLogEventSubmitting, HMDResidentDeviceManager, HMEEventForwarder, HMDIDSIDQueryController, HMDMessageRouter, HMDHomeLocalDeviceCapabilitiesDataSource, HMDAccessoryBrowserProtocol, OS_os_log;
