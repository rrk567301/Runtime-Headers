@class NSString;
@protocol HMDFeaturesDataSource, HMMLogEventSubmitting, HMDPreferences;
...
- (id)createRecordingSessionRetryContextWithWorkQueue:(id)a0;
- (id)createRecordingSessionWithWorkQueue:(id)a0 camera:(id)a1 hapAccessory:(id)a2 home:(id)a3 localZone:(id)a4 configuredFragmentDuration:(double)a5 timelineManager:(id)a6;
