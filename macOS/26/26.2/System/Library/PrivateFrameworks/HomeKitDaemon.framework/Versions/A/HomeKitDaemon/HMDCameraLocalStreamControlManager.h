...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 supportedConfigCache:(id)a6 streamSession:(id)a7 accessoryCommunicator:(id)a8 isRelayed:(BOOL)a9;
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 reachabilityPath:(unsigned long long)a3 device:(id)a4 delegate:(id)a5 accessory:(id)a6 streamManagementService:(id)a7 localNetworkConfig:(id)a8 remoteCapabilities:(id)a9 supportedConfigCache:(id)a10 streamPreference:(id)a11;
