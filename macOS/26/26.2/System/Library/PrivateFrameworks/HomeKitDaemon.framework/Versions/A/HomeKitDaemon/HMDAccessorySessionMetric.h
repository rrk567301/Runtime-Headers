...
- (void).cxx_destruct;
- (void)_handleSessionEnd:(id)a0 sessionInfo:(id)a1 withAccessory:(id)a2;
- (void)_handleSessionStart:(long long)a0 sessionInfo:(id)a1 bookkeeping:(id)a2 withAccessory:(id)a3;
- (void)_recordSessionError:(id)a0;
- (void)_resetSessionMetric;
- (void)_submitMetric;
- (void)_updateSessionInfo:(id)a0;
- (void)_updateSessionState:(BOOL)a0 linkLayerType:(long long)a1 sessionInfo:(id)a2 bookkeeping:(id)a3 withError:(id)a4;
- (void)handleSessionFailureForTTR:(id)a0 withAccessory:(id)a1;
- (void)handleTTRTimerFired:(id)a0;
