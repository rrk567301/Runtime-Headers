@class NSObject, NSString, HMFTimer, HMDCameraStreamSessionInfo, IDSDeviceConnection;
...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 idsProxyStreamService:(id)a2;
