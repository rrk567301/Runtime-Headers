...
@protocol HMDWidgetTimelineRefresherDataSource, HMFTimerManagerTimerContext, OS_dispatch_queue, HMDWidgetAccessoryReachabilityMonitor, HMDarwinNotificationProvider, HMMLogEventSubmitting, HMFTimerManager;
...
- (id)initWithHomeManager:(id)a0 queue:(id)a1 dataSource:(id)a2 reachabilityUpdateDispatchDelayNs:(long long)a3 forceUpdateTimelineDispatchDelayNs:(long long)a4;
