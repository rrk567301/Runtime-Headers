...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 sourceDevice:(id)a2 remoteDevice:(id)a3 accessory:(id)a4 delegate:(id)a5 uniqueIdentifier:(id)a6 snapshotRequestHandler:(id)a7 residentMessageHandler:(id)a8;
