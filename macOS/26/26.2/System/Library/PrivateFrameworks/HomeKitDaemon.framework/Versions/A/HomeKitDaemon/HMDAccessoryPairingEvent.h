@class HMDAccessoryMetricVendorDetails, NSString, NSUUID, NSDate, HMDAccessoryPairingLogEventStateManager, NSError, NSDictionary, NSNumber, HMDAccessory;
...
@property (nonatomic) BOOL matterUnauthenticatedPromptStartTimeSet;
@property (readonly, nonatomic) BOOL primaryResidentIsThreadCapable;
