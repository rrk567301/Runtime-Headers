@class NSDictionary, HMDApplicationData, HMAccessoryCategory, NSNotificationCenter, HMDRoom, HMDAccessoryNetworkAccessViolation, NSString, NSMutableSet, NSArray, HMFMessageDispatcher, HMDVendorModelEntry, NSObject, NSData, HMDSoftwareUpdate, HMDNetworkRouterFirewallRuleAccessoryIdentifier, HMAccessoryLastSeenStatus, HMFVersion, NSUUID, HMDAccessoryVersion, NSDate, NSNumber, HMDHome;
@protocol _TtPO13HomeKitDaemon13LocalPresence4Room_, HMDFeaturesDataSource, OS_dispatch_queue;
...
@property (nonatomic, readonly) BOOL isDemoAccessory;
@property (nonatomic, readonly) BOOL isCurrentDemoAccessory;
...
@property (readonly, nonatomic) BOOL isKnownManufacturer;
...
@property (readonly) BOOL requiresWaitingToBecomeReachableAfterRemoteAdd;
...
- (void)_handleRenameMessage:(id)a0;
- (void)_handleUpdateRoomMessage:(id)a0;
...
- (void)_updateBridgedAccessoriesWithLastSeenDate:(id)a0;
...
- (void)encodeProfiles:(id)a0 forXPCCoder:(id)a1;
- (id)findVendorInfoAndManufacturerKnown:(BOOL *)a0;
...
- (id)networkProtectionBindingForMessage:(id)a0;
...
- (void)setIsKnownManufacturer:(BOOL)a0;
...
- (void)updateLastSeenStatusWithDate:(id)a0 lowBatteryStatus:(id)a1;
