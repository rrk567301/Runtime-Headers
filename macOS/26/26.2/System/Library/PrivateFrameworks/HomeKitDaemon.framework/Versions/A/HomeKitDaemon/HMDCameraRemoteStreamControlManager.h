...
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 delegate:(id)a3 accessory:(id)a4 streamManagementService:(id)a5 profileUniqueIdentifier:(id)a6 residentMessageHandler:(id)a7 streamSession:(id)a8 isRelayed:(BOOL)a9;
- (id)initWithSessionInfo:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 reachabilityPath:(unsigned long long)a3 device:(id)a4 delegate:(id)a5 accessory:(id)a6 streamManagementService:(id)a7 remoteCapabilities:(id)a8 profileUniqueIdentifier:(id)a9 residentMessageHandler:(id)a10 remoteAccessDevice:(id)a11 streamPreference:(id)a12;
