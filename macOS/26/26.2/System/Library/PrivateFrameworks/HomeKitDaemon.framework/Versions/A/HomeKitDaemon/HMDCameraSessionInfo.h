@class NSUUID, NSString, NSMutableDictionary, NSNumber;
...
- (id)initWithUUID:(id)a0 hostProcessBundleIdentifier:(id)a1 isSPIClient:(BOOL)a2 deviceSectionName:(id)a3 description:(id)a4;
- (id)initWithUUID:(id)a0 message:(id)a1 description:(id)a2;
