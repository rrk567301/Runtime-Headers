...
- (id)_supersedingSignificantEventFromCurrentSignificantEvents:(id)a0 forSignificantEvent:(id)a1;
- (id)_supersedingSignificantEventFromPreviousSignificantEvents:(id)a0 forSignificantEvent:(id)a1;
