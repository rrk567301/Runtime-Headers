@class HMFTimer, HMDCameraRecordingSessionNotificationTrigger, HMFMessageDispatcher, NSObject, HMDCameraRecordingSessionLogEvent, HMDResidentMesh, HMDCameraRecordingSettingsControl, HMDCameraProfile, HMDCameraRecordingSession, HMDCameraRecordingBulkSendSessionReader, HMDCameraRecordingSessionRetryContext, HMDHAPAccessory, NSDictionary, NSMutableSet, NSString, HMDCameraRecordingLoadBalancer, HMDCameraRecordingBulkSendSessionInitiator, NSNotificationCenter, NSUUID;
@protocol HMDCameraRecordingManagerDependencyFactory, HMDFeaturesDataSource, OS_dispatch_queue, HMMLogEventSubmitting;

@interface HMDCameraRecordingManager : HMFObject <HMDCameraRecordingBulkSendSessionReaderDelegate, HMDCameraRecordingSessionDelegate, HMDCameraRecordingSessionNotificationTriggerDelegate, HMDCameraRecordingSettingsControlDelegate, HMDDevicePreferenceDataSource, HMDResidentMeshObserver, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMDCameraClipManagerDelegate>
...
- (id)_createRecordingSessionWithGeneralConfiguration:(id)a0;
...
- (void)_shutDown;
- (void)_startReadingFromBulkSendSession:(id)a0;
- (void)_startRecordingSessionForTrigger:(unsigned long long)a0 reason:(id)a1 generalConfiguration:(id)a2 completionCallback:(id /* block */)a3;
...
- (void)handleStopRecordingSessionRequest:(id)a0;
...
- (void)residentMeshDidUpdate:(id)a0 activeRecordingSessionCameraUUIDs:(id)a1;
