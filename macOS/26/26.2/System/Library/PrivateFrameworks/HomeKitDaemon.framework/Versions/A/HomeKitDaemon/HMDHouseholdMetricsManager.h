...
- (void).cxx_destruct;
- (id)initWithCountersManager:(id)a0 dataSource:(id)a1 accessoryDetailsManager:(id)a2 metricsHomeDataChangedManager:(id)a3 dailyScheduler:(id)a4 logEventSubmitter:(id)a5 dateProvider:(id)a6 activityContributors:(id)a7 logEventFactories:(id)a8;
