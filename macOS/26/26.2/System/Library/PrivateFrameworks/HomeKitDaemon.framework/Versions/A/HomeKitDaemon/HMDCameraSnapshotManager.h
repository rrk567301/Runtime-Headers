@class NSMutableDictionary, HMDCameraSnapshotRequestHandler, NSDictionary, HMFMessageDispatcher, NSObject, HMDCameraSnapshotLocalSession, NSMutableArray, HMDCameraSnapshotCache, HMDCameraSnapshotFileManager, NSString, HMDCameraStreamSnapshotHandler, HMDHAPAccessory, HMFNetMonitor, HMDCameraSnapshotMonitorEvents, HMDCameraResidentMessageHandler, NSUUID;
...
- (id)initWithAccessory:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 uniqueIdentifier:(id)a3 msgDispatcher:(id)a4 networkMonitor:(id)a5 logIdentifier:(id)a6 imageCacheDirectory:(id)a7 residentMessageHandler:(id)a8 snapshotFileManager:(id)a9 dataSource:(id)a10;
...
- (void)snapshotRelayReceiver:(id)a0 didSaveSnapshotFile:(id)a1 error:(id)a2 sessionInfo:(id)a3;
- (void)snapshotRelayReceiver:(id)a0 didStartImageCaptureForSessionInfo:(id)a1;
- (void)snapshotRelaySender:(id)a0 didCompleteSendImage:(id)a1 sessionInfo:(id)a2;
- (void)snapshotRelaySender:(id)a0 didSaveSnapshotFile:(id)a1 sessionInfo:(id)a2;
- (void)snapshotRelaySender:(id)a0 didStartImageCaptureForSessionInfo:(id)a1;
- (void)snapshotRelayStream:(id)a0 didCompleteSendImage:(id)a1 sessionInfo:(id)a2;
- (void)snapshotRelayStream:(id)a0 didStartImageCaptureForSessionInfo:(id)a1;
- (void)snapshotStreamReceiver:(id)a0 didSaveSnapshotFile:(id)a1 error:(id)a2 sessionInfo:(id)a3;
- (void)snapshotStreamReceiver:(id)a0 didStartImageCaptureForSessionInfo:(id)a1;
- (void)snapshotStreamSender:(id)a0 didCompleteSendImage:(id)a1 sessionInfo:(id)a2;
- (void)snapshotStreamSender:(id)a0 didStartImageCaptureForSessionInfo:(id)a1;
