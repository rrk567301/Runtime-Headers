...
@property (readonly) BOOL dropErrorMessage;
...
+ (id)userMessagePolicyWithHome:(id)a0 userPrivilege:(unsigned long long)a1 remoteAccessRequired:(BOOL)a2 dropErrorMessage:(BOOL)a3;
...
- (void).cxx_destruct;
- (id)init;
- (id)__initWithHome:(id)a0 homeUUID:(id)a1 userPrivilege:(unsigned long long)a2 remoteAccessRequired:(BOOL)a3 requiresCameraStreamingAccess:(BOOL)a4 useProofOfLocality:(BOOL)a5 dropErrorMessage:(BOOL)a6;
