@class NSString, NSMutableData, NSObject, HMDDevice;
@protocol HMDIDSSession, HMDCameraSnapshotIDSRelayInitiatorDelegate, OS_dispatch_source;
...
- (id)initWithSessionUUID:(id)a0 logIdentifier:(id)a1 workQueue:(id)a2 device:(id)a3 delegate:(id)a4;
- (id)initWithSessionUUID:(id)a0 logIdentifier:(id)a1 workQueue:(id)a2 idsStreamService:(id)a3 device:(id)a4 delegate:(id)a5;
