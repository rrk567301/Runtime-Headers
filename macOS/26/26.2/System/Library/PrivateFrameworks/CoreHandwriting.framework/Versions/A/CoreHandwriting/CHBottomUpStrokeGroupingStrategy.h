...
@interface CHBottomUpStrokeGroupingStrategy : CHStrokeGroupingStrategy {
    ...
    BOOL _containsCJKLocale;
    BOOL _containsNonCJKLocale;
    BOOL _containsVeryComplexCharacters;
}
...
- (struct vector<CGPoint, std::allocator<CGPoint>> { struct CGPoint *x0; struct CGPoint *x1; struct { struct CGPoint *x0; } x2; })flippedCenters:(const void *)a0 ofSubstrokes:(id)a1 maxStrokesGap:(long long)a2 begnning:(BOOL)a3;
...
- (void)mergeGroupsPostProcessing:(id)a0 createdGroups:(id)a1 deletedGroups:(id)a2 availableGroupingStrategies:(id)a3 allowOppositeOrientations:(BOOL)a4 groupStatistics:(id)a5;
...
- (id)strokeGroupFromStrokes:(id)a0 ancestorIdentifier:(long long)a1 strokeBoundsPerStrokeIdentifier:(id)a2 substrokesByStrokeIdentifier:(id)a3 scriptClassification:(long long)a4;
