@interface CHRemoveInvalidExpressionCandidatesStep : CHMathPostprocessingStep {
    struct unique_ptr<CoreHandwriting::LaTeXSyntaxHelper, std::default_delete<CoreHandwriting::LaTeXSyntaxHelper>> { struct { struct LaTeXSyntaxHelper *__ptr_; } ; } _latexSyntaxHelper;
}
