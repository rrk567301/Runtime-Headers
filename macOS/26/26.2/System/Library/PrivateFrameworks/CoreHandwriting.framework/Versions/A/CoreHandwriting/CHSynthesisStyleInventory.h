...
@interface CHSynthesisStyleInventory : NSObject <NSCopying, NSSecureCoding> {
    struct unique_ptr<CoreHandwriting::synthesis::fast_path::CHFastPathCharacterHolderMMap, std::default_delete<CoreHandwriting::synthesis::fast_path::CHFastPathCharacterHolderMMap>> { struct { struct CHFastPathCharacterHolderMMap *__ptr_; } ; } _zhjaPrototypes;
    struct unique_ptr<CoreHandwriting::synthesis::fast_path::CHFastPathCharacterHolderMMap, std::default_delete<CoreHandwriting::synthesis::fast_path::CHFastPathCharacterHolderMMap>> { struct { struct CHFastPathCharacterHolderMMap *__ptr_; } ; } _koPrototypes;
}
