@interface CHDiffusionTextSynthesizerZhJa : CHDiffusionTextSynthesizerBase {
    struct unique_ptr<CoreHandwriting::synthesis::CHDiffusionPipelineZhJa, std::default_delete<CoreHandwriting::synthesis::CHDiffusionPipelineZhJa>> { struct { struct CHDiffusionPipelineZhJa *__ptr_; } ; } _pipeline;
}
