...
- (id)synthesizeTokensForString:(id)a0 point:(struct CGPoint { double x0; double x1; })a1 synthesisOptions:(id)a2 completionWithSynthesisResults:(id /* block */)a3 shouldCancel:(id /* block */)a4;
- (id)synthesizeTokensForString:(id)a0 replacingStrokes:(id)a1 completion:(id /* block */)a2 shouldCancel:(id /* block */)a3;
- (id)synthesizeTokensForString:(id)a0 replacingStrokes:(id)a1 completionWithSynthesisResults:(id /* block */)a2 shouldCancel:(id /* block */)a3;
