...
+ (id)cachingKeyFromRelevantLocales:(id)a0 forLocale:(id)a1;
...
+ (BOOL)hasSupportForPrincipalPoints:(id)a0;
+ (BOOL)isGroupingWithLocales:(id)a0 differentFromGroupingWithLocales:(id)a1;
+ (BOOL)isLocaleReflowable:(id)a0;
+ (BOOL)isLocaleSupported:(id)a0 withMode:(int)a1;
+ (BOOL)isMatchingScriptAndLocale:(id)a0 scriptCode:(id)a1;
...
+ (BOOL)shouldAllowSubTokenDeletionForLocale:(id)a0;
+ (BOOL)shouldApplyLatinSpacingForLocale:(id)a0;
+ (BOOL)shouldApplyThaiSpacingForLocale:(id)a0;
+ (BOOL)shouldDeformRenderedAscendersDescenders:(id)a0;
...
+ (BOOL)shouldTryAlternativeStringRender:(id)a0;
+ (BOOL)shouldUseFullWidthSpaceBasedOnContextForLocale:(id)a0;
+ (BOOL)shouldUseOriginalTokensForLocale:(id)a0;
+ (BOOL)shouldUseRefinablePathForReflowTokensForLocale:(id)a0;
...
- (BOOL)shouldPerformTurkishPostProcessing;
