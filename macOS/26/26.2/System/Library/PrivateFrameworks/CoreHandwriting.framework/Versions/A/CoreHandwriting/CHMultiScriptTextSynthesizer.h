...
+ (id)chunksForFeatures:(const void *)a0 metadata:(struct CHDiffusionPipelinePreprocessingExecutionMetadata { struct vector<CoreHandwriting::synthesis::CHDiffusionPipelineReplacementData, std::allocator<CoreHandwriting::synthesis::CHDiffusionPipelineReplacementData>> { struct CHDiffusionPipelineReplacementData *x0; struct CHDiffusionPipelineReplacementData *x1; struct { struct CHDiffusionPipelineReplacementData *x0; } x2; } x0; unsigned long long x1; })a1;
