...
+ (id)mergeReflowableTokens:(id)a0 parameters:(id)a1 locale:(id)a2;
...
+ (id)transformReflowableTokens:(id)a0 parameters:(id)a1 locale:(id)a2;
...
- (id)initWithContextStrokes:(id)a0 relatedNonTextStrokes:(id)a1 contextResults:(id)a2 strokeGroupingResult:(id)a3 strokeClassificationResult:(id)a4 strokeProvider:(id)a5 excludedStrokeTypes:(id)a6;
- (id)initWithContextStrokes:(id)a0 relatedNonTextStrokes:(id)a1 parameters:(id)a2 contextResults:(id)a3 strokeGroupingResult:(id)a4 strokeClassificationResult:(id)a5 strokeProvider:(id)a6 excludedStrokeTypes:(id)a7;
- (id)initWithContextStrokes:(id)a0 relatedNonTextStrokes:(id)a1 parameters:(id)a2 contextResults:(id)a3 strokeGroupingResult:(id)a4 strokeClassificationResult:(id)a5 strokeProvider:(id)a6 excludedStrokeTypes:(id)a7 initialStrokes:(id)a8;
