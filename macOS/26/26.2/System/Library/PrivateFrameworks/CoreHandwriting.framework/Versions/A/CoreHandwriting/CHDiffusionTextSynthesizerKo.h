@interface CHDiffusionTextSynthesizerKo : CHDiffusionTextSynthesizerBase {
    struct unique_ptr<CoreHandwriting::synthesis::CHDiffusionPipelineKo, std::default_delete<CoreHandwriting::synthesis::CHDiffusionPipelineKo>> { struct { struct CHDiffusionPipelineKo *__ptr_; } ; } _pipeline;
}
