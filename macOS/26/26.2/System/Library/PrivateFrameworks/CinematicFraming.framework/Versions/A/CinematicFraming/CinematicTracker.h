...
- (void)processFaceDetections:(id)a0 bodyDetections:(id)a1 atTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 inView:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3;
