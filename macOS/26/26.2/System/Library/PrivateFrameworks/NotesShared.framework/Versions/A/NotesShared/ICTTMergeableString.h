...
@interface ICTTMergeableString : NSObject <ICCRDataType, NSCopying> {
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct { struct TopoSubstring **__cap_; } ; } _startNodes;
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct { struct TopoSubstring **__cap_; } ; } _endNodes;
    struct vector<TopoSubstring *, std::allocator<TopoSubstring *>> { struct TopoSubstring **__begin_; struct TopoSubstring **__end_; struct { struct TopoSubstring **__cap_; } ; } _orderedSubstrings;
...
- (id)initWithData:(id)a0 replicaID:(id)a1 fragment:(BOOL)a2;
- (long long)substring:(void *)a0 modifiedAfter:(id)a1 includeAttributes:(BOOL)a2 replicaID:(id *)a3;
