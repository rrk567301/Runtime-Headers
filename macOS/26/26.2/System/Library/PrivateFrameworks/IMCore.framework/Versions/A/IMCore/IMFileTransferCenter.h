@class NSString, NSMutableDictionary, NSDictionary, NSMutableSet, NSArray, NSMutableArray, NSCache;
...
- (void)_addTransferToOriginalGUIDMap:(id)a0;
...
- (void)registerNewFileTransfer:(id)a0;
