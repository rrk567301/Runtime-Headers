...
@property (nonatomic, getter=isChatBot) BOOL isChatBot;
@property (nonatomic) BOOL showTranslationAlternateText;
...
- (void)setIsChatBot:(BOOL)a0;
- (void)setResponded:(BOOL)a0;
- (void)setSendersUnknown:(BOOL)a0;
- (void)setShowTranslationAlternateText:(BOOL)a0;
