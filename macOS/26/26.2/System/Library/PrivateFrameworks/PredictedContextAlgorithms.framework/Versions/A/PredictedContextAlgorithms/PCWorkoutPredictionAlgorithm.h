...
- (id)_buildWorkoutTypeLocationMapping:(id)a0;
...
- (BOOL)_hasUserWorkedOutForActivityType:(id)a0 nearCurrentVisit:(id)a1 workoutTypeLocationMap:(id)a2;
...
- (id)generateWorkoutPredictionsFromProbabilities:(id)a0 atTime:(double)a1 currentVisit:(id)a2 embeddings:(id)a3 clusters:(id)a4;
