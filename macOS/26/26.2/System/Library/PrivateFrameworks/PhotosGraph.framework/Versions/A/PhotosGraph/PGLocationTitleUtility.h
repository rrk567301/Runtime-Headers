...
+ (id)_beautifiedLocationStringWithTitleComponents:(id)a0 momentNodes:(id)a1 lineBreakBehavior:(unsigned long long)a2 keyAssetAddressNode:(id)a3 curationAddressNodes:(id)a4 isMatchingKeyAsset:(BOOL *)a5 useDistrict:(BOOL)a6 allowFamilyHome:(BOOL)a7 showAllCities:(BOOL)a8 locationHelper:(id)a9 serviceManager:(id)a10;
...
+ (id)_firstComponentInTimeFromComponents:(id)a0 momentNodes:(id)a1 curationAddressNodes:(id)a2 allowFamilyHome:(BOOL)a3 serviceManager:(id)a4;
...
+ (id)_locationStringWithDistrictsFromTitleComponents:(id)a0 momentNodes:(id)a1 lineBreakBehavior:(unsigned long long)a2 allowFamilyHome:(BOOL)a3 locationHelper:(id)a4 serviceManager:(id)a5;
...
+ (id)commonAOIComponentsForMomentNodes:(id)a0 addressNodes:(id)a1 aoiDisplayType:(unsigned long long)a2 containsAmusementParkPOI:(BOOL)a3 locationHelper:(id)a4;
...
+ (BOOL)containsAmusementParkPOIFromMomentNodes:(id)a0;
