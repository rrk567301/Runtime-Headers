...
@property (class, readonly) BOOL graphConsistencyNotificationIsEnabled;
...
@property (class, readonly) BOOL enableMomentCLIPFeatureGraphIngest;
@property (class, readonly) BOOL useAOIsInExtendedTokens;
...
@property (class, readonly) long long retrievalThresholdForCLIPTrendsMemories;
