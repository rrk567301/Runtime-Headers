@class SCUIMoreHelpMenuModel, NSDictionary, NSString;
...
@property (retain, nonatomic) SCUIMoreHelpMenuModel *model;
...
+ (id)_menuWithAnalysis:(id)a0 options:(long long)a1 error:(id *)a2;
