@class PBUnknownFields, GEOETATrafficUpdateWaypointRoute, GEOClientCapabilities, GEOLocation, GEODirectionsAnalyticMetadata, NSMutableArray, GEOPrivacyMetadata, GEOPDABClientDatasetMetadata, GEOTripInfo, NSString, GEOClientFeedbackInfo, PBDataReader, GEOFamiliarWaypointRoute, GEOCommonOptions, NSData, GEOAdditionalEnabledMarkets, GEORouteAttributes, GEORecentLocationHistory;
...
@interface GEOETATrafficUpdateRequest : PBRequest <NSCopying> {
    ...
    struct { unsigned char has_sessionID : 1; unsigned char has_sessionCreateHour : 1; unsigned char has_sessionRelativeTimestamp : 1; unsigned char has_displayedEta : 1; unsigned char has_maxAlternateRouteCount : 1; unsigned char has_previouslyRejectedRerouteSavings : 1; unsigned char has_purpose : 1; unsigned char has_rerouteStatus : 1; unsigned char has_trafficSnapshotUnixTime : 1; unsigned char has_includeBetterRouteSuggestion : 1; unsigned char read_unknownFields : 1; unsigned char read_abClientMetadata : 1; unsigned char read_additionalEnabledMarkets : 1; unsigned char read_analyticMetadata : 1; unsigned char read_clientCapabilities : 1; unsigned char read_clientFeedbackInfo : 1; unsigned char read_commonOptions : 1; unsigned char read_currentUserLocation : 1; unsigned char read_destinationWaypointTypeds : 1; unsigned char read_directionsResponseID : 1; unsigned char read_displayedBannerIds : 1; unsigned char read_etauResponseID : 1; unsigned char read_familiarWaypointRoute : 1; unsigned char read_privacyMetadata : 1; unsigned char read_recentLocationHistory : 1; unsigned char read_requestingAppId : 1; unsigned char read_routeAttributes : 1; unsigned char read_routes : 1; unsigned char read_serviceTags : 1; unsigned char read_sessionState : 1; unsigned char read_trafficApiResponses : 1; unsigned char read_trafficSnapshotIds : 1; unsigned char read_tripID : 1; unsigned char read_tripInfo : 1; unsigned char read_tripOrigin : 1; unsigned char read_userIncidentReports : 1; unsigned char read_waypointRoute : 1; unsigned char read_waypointTypeds : 1; unsigned char read_xpcUuid : 1; unsigned char wrote_anyField : 1; } _flags;
}
