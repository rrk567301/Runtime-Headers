...
@interface GEOSnappedRoutePath : NSObject {
    ...
    struct unique_ptr<geo::RouteMapMatchingSection, std::default_delete<geo::RouteMapMatchingSection>> { struct { struct RouteMapMatchingSection *__ptr_; } ; } _mapMatchingSection;
