@interface GEOPolylineCoordinateRangeArray : NSObject <NSFastEnumeration, NSSecureCoding> {
    struct vector<GEOPolylineCoordinateRange, std::allocator<GEOPolylineCoordinateRange>> { struct GEOPolylineCoordinateRange *__begin_; struct GEOPolylineCoordinateRange *__end_; struct { struct GEOPolylineCoordinateRange *__cap_; } ; } _polylineCoordinateRanges;
