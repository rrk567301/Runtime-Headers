...
@property (nonatomic, getter=isEstimated) BOOL estimated;
...
- (id)description;
- (id)asDictionary;
- (id)initWithAirlineCode:(id)a0 airlineName:(id)a1 flightNumber:(unsigned long long)a2 operatorAirlineCode:(id)a3 operatorFlightNumber:(unsigned long long)a4 departure:(id)a5 arrival:(id)a6 state:(unsigned long long)a7 publishedDate:(id)a8 staleDate:(id)a9 isEstimated:(BOOL)a10 dataSource:(unsigned long long)a11;
