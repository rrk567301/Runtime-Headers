@class NSString, PKPayment, PKPaymentMethod, PKAccountServicePaymentMethod, PKServiceProviderPurchase, CNContact, PKShippingMethod, PKAuthorizedPeerPaymentQuote, PKApplePayTrustSignature;
