...
@property (nonatomic) struct map<std::string, DeviceModel, std::less<std::string>, std::allocator<std::pair<const std::string, DeviceModel>>> { struct __tree<std::__value_type<std::string, DeviceModel>, std::__map_value_compare<std::string, std::__value_type<std::string, DeviceModel>, std::less<std::string>>, std::allocator<std::__value_type<std::string, DeviceModel>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } anchorDeviceModelAllowedMap;
...
- (void)_createBLEMeasurementFromDeprecatedMeasurement:(id)a0 withMeasurementProto:(struct unique_ptr<CLMicroLocationProto::Measurement, std::default_delete<CLMicroLocationProto::Measurement>> { struct { struct Measurement *x0; } x0; })a1 andRelatedScanningEventObjectID:(id)a2;
...
- (void)_createUWBMeasurementFromDeprecatedMeasurement:(id)a0 withMeasurementProto:(struct unique_ptr<CLMicroLocationProto::Measurement, std::default_delete<CLMicroLocationProto::Measurement>> { struct { struct Measurement *x0; } x0; })a1 andRelatedScanningEventObjectID:(id)a2;
- (void)_createWiFiHistogramMOFromConfigurationMO:(id)a0 withLOIObjectID:(id)a1;
- (void)_createWiFiMeasurementFromDeprecatedMeasurement:(id)a0 withMeasurementProto:(struct unique_ptr<CLMicroLocationProto::Measurement, std::default_delete<CLMicroLocationProto::Measurement>> { struct { struct Measurement *x0; } x0; })a1 andRelatedScanningEventObjectID:(id)a2;
- (struct unique_ptr<CLMicroLocationProto::Configuration, std::default_delete<CLMicroLocationProto::Configuration>> { struct { struct Configuration *x0; } x0; })_getConfigProtoFromConfigurationMO:(id)a0;
