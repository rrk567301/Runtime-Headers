...
- (id)_getStopMotionTriggersFromOdometryEntries:(struct vector<ULOdometryDO, std::allocator<ULOdometryDO>> { struct ULOdometryDO *x0; struct ULOdometryDO *x1; struct { struct ULOdometryDO *x0; } x2; })a0;
