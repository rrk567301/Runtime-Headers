@class _TtC13CoreIDVShared20IdentityImageQuality, _TtC13CoreIDVShared25IdentityProofingNFCConfig, _TtC13CoreIDVShared25IdentityProofingDocuments, _TtC13CoreIDVShared22IdentityLivenessConfig, _TtC13CoreIDVShared24NFCPendingCommandsStatus, NSString, _TtC13CoreIDVShared24IdentityProofingUIConfig, _TtC13CoreIDVShared18NFCPendingCommands, _TtC13CoreIDVShared22IdentityProofingStatus, _TtC13CoreIDVShared22IdentityBindingDetails, _TtC13CoreIDVShared32IdentityProofingLivenessVideoURL, _TtC13CoreIDVShared27IdentityProofingDisplayInfo, _TtC13CoreIDVShared29IdentityProofingConfiguration, NSArray, NSError, NSData;
...
- (void)getPendingCommandsStatusWithCompletionHandler:(void (^)(_TtC13CoreIDVShared24NFCPendingCommandsStatus *, NSError *))a0;
...
- (void)globalAuthACLInfoWithCompletionHandler:(void (^)(NSArray *, long long, long long, NSError *))a0;
- (void)initiatePartialProofingWithConfiguration:(_TtC13CoreIDVShared29IdentityProofingConfiguration *)a0 documents:(_TtC13CoreIDVShared25IdentityProofingDocuments *)a1 proofingSessionID:(NSString *)a2 completionHandler:(void (^)(_TtC13CoreIDVShared25IdentityProofingNFCConfig *, NSError *))a3;
