@class NSDictionary, CDPRPDConfirmationFlow, CDPDevice, NSButton, CDPQuotaStoragePresenter, IASPickerViewController, NSStackView, NSMutableArray, NSString, CDPRemoteDeviceSecretValidator, NSViewController, NSArray, NSTextField, CDPContext, NSSecureTextField, NSWindow, AKPinFieldView, NSLayoutConstraint, NSView, NSImage, NSProgressIndicator, NSNumber;
@protocol CDPRPDLedger;

@interface CDPEnrollViewController : NSViewController <AKPinFieldViewDelegate, CDPQuotaScreenUIHandlerCapable>
