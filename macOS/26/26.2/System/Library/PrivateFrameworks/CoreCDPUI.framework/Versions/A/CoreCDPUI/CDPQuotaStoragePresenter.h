...
- (id)_makeQuotaStorageViewHandler;
- (id)_makeRequestHelper;
- (void)_sendAnalyticsEventForRPDConfirmationUI;
- (void)_setupQuotaStorageUIWithRequestHelper:(id)a0;
- (id)initWithContext:(id)a0 presentingWindow:(id)a1 validator:(id)a2 uiHandler:(id)a3;
- (void)presentQuotaStorageAppListView;
