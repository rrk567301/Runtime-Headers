@interface DIOpenParams : DIBaseParams {
    struct unique_ptr<diskimage_uio::diskimage_open_params, std::default_delete<diskimage_uio::diskimage_open_params>> { struct { struct diskimage_open_params *__ptr_; } ; } _openParams;
}
