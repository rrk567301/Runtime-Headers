...
- (BOOL)_ensurePayload:(id)a0 fromRequest:(id)a1 hasRequiredParameter:(id)a2 allowedTypes:(id)a3 orSendResponse:(id)a4 withErrorCode:(long long)a5 relatedSession:(id)a6;
...
- (void)_handleLoadWebExtension:(id)a0 response:(id)a1 relatedSession:(id)a2;
...
- (void)_handleSetPermission:(id)a0 response:(id)a1 relatedSession:(id)a2;
- (void)_handleSetPermissions:(id)a0 response:(id)a1 relatedSession:(id)a2;
- (void)_handleSetStorageAccess:(id)a0 response:(id)a1 relatedSession:(id)a2;
- (void)_handleSetStorageAccessPermissionState:(long long)a0 descriptorPayload:(id)a1 request:(id)a2 response:(id)a3 relatedSession:(id)a4;
...
- (void)_handleUnloadWebExtension:(id)a0 response:(id)a1 relatedSession:(id)a2;
...
- (void)_performIfBrowsingContextStillOpen:(id)a0 orSendResponse:(id)a1 withErrorCode:(long long)a2 relatedSession:(id)a3 block:(id /* block */)a4;
