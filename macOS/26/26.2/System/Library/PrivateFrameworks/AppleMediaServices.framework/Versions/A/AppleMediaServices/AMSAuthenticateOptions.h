@class AMSProcessInfo, NSString, NSDictionary, NSURL, NSNumber, AKAuthenticatableResource;
...
@property (retain) NSString *simpleProfileAltDSID;
@property BOOL simpleProfileCreated;
@property (retain) NSNumber *simpleProfileDSID;
...
@property (retain) AKAuthenticatableResource *authenticatableResource;
...
+ (id)_stringForAuthenticationType:(unsigned long long)a0;
