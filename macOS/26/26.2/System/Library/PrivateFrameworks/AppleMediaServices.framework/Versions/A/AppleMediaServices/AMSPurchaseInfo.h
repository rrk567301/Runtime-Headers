@class AMSPurchase, NSString, NSXPCListenerEndpoint, NSURL, AMSPurchaseTask, NSDictionary, NSMutableDictionary, ACAccount, AMSBuyParams, LAContext, NSNumber, AMSProcessInfo;
