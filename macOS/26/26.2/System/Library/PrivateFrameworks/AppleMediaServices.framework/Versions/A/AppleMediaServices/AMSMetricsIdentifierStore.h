...
+ (id)_promiseOfListOfStoresInNamespaceList:(id)a0 forAccount:(id)a1 bag:(id)a2;
+ (BOOL)_isResetEnabledForList:(id)a0;
+ (id)_promiseToRotateIdentifiersForAccount:(id)a0 bag:(id)a1 namespaceList:(id)a2;
+ (id)shouldEnableResetUIFromBag:(id)a0;
+ (id)_promiseOfListOfNamespacesFromBag:(id)a0;
+ (id)removeIdentifiersForStore:(id)a0;
...
+ (id)_database;
+ (id)performUserResetForStoresInBag:(id)a0 forAccount:(id)a1;
