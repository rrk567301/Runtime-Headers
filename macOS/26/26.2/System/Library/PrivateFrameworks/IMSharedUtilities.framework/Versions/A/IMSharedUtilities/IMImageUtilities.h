...
+ (BOOL)imageIsAnimatedSequenceAtFileURL:(id)a0;
...
+ (struct CGImage { } *)newUncroppedPreviewImageFromImage:(struct CGImage { } *)a0 isScreenshot:(BOOL)a1 maximumSizeInPx:(struct CGSize { double x0; double x1; })a2 minimumSizeInPx:(struct CGSize { double x0; double x1; })a3;
...
+ (double)scaleFactorForThumbnailWithSize:(struct CGSize { double x0; double x1; })a0 constraints:(struct IMPreviewConstraints { double x0; struct CGSize { double x0; double x1; } x1; double x2; BOOL x3; BOOL x4; BOOL x5; })a1 targetPxSize:(struct CGSize { double x0; double x1; })a2 shouldScaleUpPreview:(BOOL)a3 maxUpScale:(double)a4;
