@class NSMutableDictionary, NSSet, LSApplicationWorkspace, NSString;

@interface IMSharedWithYouManager : NSObject <LSApplicationWorkspaceObserverProtocol>

@property (class, nonatomic, getter=isSharedWithYouEnabled) BOOL sharedWithYouEnabled;
@property (class, readonly, nonatomic) BOOL sharedWithYouKeyExists;
...
- (void)setSharedWithYouEnabled:(BOOL)a0;
- (void)setSharedWithYouEnabled:(BOOL)a0 forApplicationWithBundleID:(id)a1;
- (void)setSharedWithYouEnabledForAllApplicationsIndividually:(BOOL)a0;
- (id)sharedWithYouApplicationBundleIDs;
