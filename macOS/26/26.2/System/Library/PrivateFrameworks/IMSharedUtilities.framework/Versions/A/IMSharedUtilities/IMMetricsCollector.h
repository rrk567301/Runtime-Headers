...
- (void)trackSentMessageEventOfType:(id)a0 subtype:(id)a1 originalServiceName:(id)a2 messageSize:(unsigned long long)a3 sendDuration:(id)a4 receiverType:(id)a5 receiverGroupType:(id)a6 wasSuccessful:(BOOL)a7 sourceHandle:(id)a8 destinationHandle:(id)a9 error:(id)a10;
