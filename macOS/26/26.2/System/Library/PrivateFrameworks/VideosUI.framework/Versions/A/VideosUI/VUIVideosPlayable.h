...
@property (readonly, nonatomic) NSString *identifierForPlaybackCoordinator;
@property (retain, nonatomic) NSDate *playbackStartDate;
@property (nonatomic) BOOL stoppedBecauseNewItemPlayedFromLSPPShelf;
@property (nonatomic) BOOL stoppedBecauseNewItemAutoPlayedFromLSPPShelf;
@property (nonatomic) BOOL isPlayedFromLSPPShelf;
@property (nonatomic) BOOL isAutoplayedFromLSPPShelf;
