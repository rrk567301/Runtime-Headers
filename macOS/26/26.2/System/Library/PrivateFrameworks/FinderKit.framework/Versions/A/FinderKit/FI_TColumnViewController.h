...
@interface FI_TColumnViewController : FI_TBrowserViewController <TableView_Common_Delegate, FIAliasResolution, TColumnViewDelegate, TDuplicateTaskDelegateProtocol, TListNameFieldDelegate> {
    ...
    struct TColumnOptimizerContainers { struct __tree<std::__value_type<std::pair<long, TFENode>, short>, std::__map_value_compare<std::pair<long, TFENode>, std::__value_type<std::pair<long, TFENode>, short>, std::greater<std::pair<long, TFENode>>>, std::allocator<std::__value_type<std::pair<long, TFENode>, short>>> { void *__begin_node_; struct { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __end_node_; } ; struct { unsigned long long __size_; } ; } __tree_; } _delayedContainers;
