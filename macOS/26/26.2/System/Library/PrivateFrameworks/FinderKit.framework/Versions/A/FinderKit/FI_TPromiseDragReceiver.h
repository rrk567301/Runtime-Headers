...
@interface FI_TPromiseDragReceiver : NSObject <TCoalescingNodeObserverProtocol> {
    ...
    struct vector<TString, std::allocator<TString>> { struct TString *__begin_; struct TString *__end_; struct { struct TString *__cap_; } ; } _rawNamesOfPendingPromisedNodes;
