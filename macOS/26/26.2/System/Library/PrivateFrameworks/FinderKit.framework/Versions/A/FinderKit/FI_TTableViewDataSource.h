...
@interface FI_TTableViewDataSource : NSArrayController <NSTableViewDataSource> {
    ...
    struct vector<TKeyValueBinder, std::allocator<TKeyValueBinder>> { struct TKeyValueBinder *__begin_; struct TKeyValueBinder *__end_; struct { struct TKeyValueBinder *__cap_; } ; } _keyValueBinders;
}
