...
@interface FI_TButton : NSButton {
    ...
    struct unique_ptr<FI_TBestFitStringSelector, std::default_delete<FI_TBestFitStringSelector>> { struct { struct FI_TBestFitStringSelector *__ptr_; } ; } _bestFitTitleSelector;
    struct unique_ptr<FI_TBestFitStringSelector, std::default_delete<FI_TBestFitStringSelector>> { struct { struct FI_TBestFitStringSelector *__ptr_; } ; } _bestFitAlternateTitleSelector;
}
...
- (void)awakeCommon;
- (struct unique_ptr<FI_TBestFitStringSelector, std::default_delete<FI_TBestFitStringSelector>> { struct { struct FI_TBestFitStringSelector *x0; } x0; })bestFitSelectorForStringSet:(const void *)a0 attributes:(id)a1 extraContentInsets:(const struct NSEdgeInsets { double x0; double x1; double x2; double x3; } *)a2;
- (id)copyButton;
