...
@interface FILocationMenuFactory : NSObject <TMarkTornDown> {
    ...
    struct unique_ptr<FIAmbiguousMenuItems, std::default_delete<FIAmbiguousMenuItems>> { struct { struct FIAmbiguousMenuItems *__ptr_; } ; } _ambiguousMenuItems;
