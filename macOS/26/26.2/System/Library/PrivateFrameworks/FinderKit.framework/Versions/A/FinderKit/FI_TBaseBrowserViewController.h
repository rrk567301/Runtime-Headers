...
@interface FI_TBaseBrowserViewController : FI_TViewController <NSSharingServiceDelegate, NSTouchBarDelegate, NSDraggingSource, NSMenuItemValidation, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TContextMenuDelegate, TMarkTornDown, TQLPreviewWindowControllerProtocol, TTypeSelectDelegate, TFloatingInputWindowDelegateProtocol, TThumbnailExtractorDelegate> {
    ...
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _dataSourceChangedObserver;
    ...
    struct vector<std::shared_ptr<TIconFetcher>, std::allocator<std::shared_ptr<TIconFetcher>>> { void *__begin_; void *__end_; struct { void *__cap_; } ; } _pendingIconFetchers;
    ...
    struct TFENodeVector { struct TFENode *__begin_; struct TFENode *__end_; struct { struct TFENode *__cap_; } ; } _orderedSelection;
    ...
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserViewWillMoveToWindowObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserViewDidMoveToWindowObserver;
    ...
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserViewBackingPropertiesObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserWindowDidBecomeMainObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserWindowDidResignMainObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserWindowDidBecomeKeyObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _browserWindowDidResignKeyObserver;
    struct TNotificationCenterObserver { NSObject *fObservedObject; struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *fRef; } fString; } fNotificationName; FI_TNotificationCenterObserverGlue *fFunctorGlue; BOOL fIsDistributedObserving; struct function<NSNotificationCenter *()> { struct __value_func<NSNotificationCenter *()> { union type { unsigned char __data[24]; } __buf_; void *__f_; } __f_; } fCenterProvider; } _tagsPopoverDidCloseObserver;
}
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })selectedNodes;
...
- (BOOL)validateCustomizeFolderPopover:(id)a0;
...
- (void)cmdUnpin:(id)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })commandTarget:(SEL)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })commandTarget:(SEL)a0 upTo:(unsigned long long)a1;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })commandValidationTarget:(SEL)a0;
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })commandValidationTarget:(SEL)a0 isPartial:(BOOL *)a1;
...
- (struct pair<TFENodeVector, unsigned long> { struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; } x0; unsigned long long x1; })getCommandTarget:(SEL)a0 upTo:(unsigned long long)a1;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })pendingNodesToSelectUpTo:(unsigned long long)a0;
...
- (struct pair<bool, TFENodeVector> { BOOL x0; struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; } x1; })preCheckFPActionForNodes:(id)a0 allowPartialValidation:(BOOL)a1 forUIElement:(id)a2;
...
- (void)shareNodes:(struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })a0 withSpecificSharingServiceName:(id)a1;
...
- (BOOL)snapNodeToGridNowOrLater:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 runNewFolderAnimation:(BOOL)a1 startEditing:(BOOL)a2 renameOp:(id)a3;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct { struct TFENode *x0; } x2; })typeSelectCandidateNodes;
...
- (void)willPerformSelector:(SEL)a0;
