...
- (void).cxx_destruct;
- (id)_itemsForSection:(id)a0 items:(id)a1 todayData:(id)a2 budgetInfo:(id)a3 previouslyChosenItems:(id)a4 priorClusterIDsInOtherSections:(id)a5 sectionItemsLimit:(unsigned long long)a6 otherArticleIDs:(id)a7 remainingSlots:(double)a8 slotsUsed:(double *)a9 noMoreItemsToGive:(BOOL *)a10 noRoomForMoreItems:(BOOL *)a11 debugInspection:(id *)a12;
- (id)init;
