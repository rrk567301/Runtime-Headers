...
- (id)createCredentialRegistrationRequestWithChallenge:(id)a0 name:(id)a1 userID:(id)a2 requestStyle:(long long)a3;
- (id)createCredentialRegistrationRequestWithClientData:(id)a0 name:(id)a1 userID:(id)a2 requestStyle:(long long)a3;
