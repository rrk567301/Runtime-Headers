...
@interface _IMKXPCCompatibilityDOProxyInterposerLegacy : NSObject <IMKTextInput, IMKUnicodeTextInput>

@property (readonly, retain) NSXPCConnection *xpcConnection;

+ (id)clientDOProxyInterposerWithXPCConnection:(id)a0;
...
- (id)initClientDOProxyInterposerWithXPCConnection:(id)a0;
