@class NSString, NSSet, NSCondition, NSDictionary, NSMutableDictionary, _MDExtensionLoader, NSObject, NSMutableSet, CSFileProviderDomainMonitor;
...
+ (BOOL)_isSupported:(id)a0 extension:(id)a1;
...
- (BOOL)extensionExistsForBundleId:(id)a0;
...
- (void)indexRequestsPerformJob:(id)a0 forBundles:(id)a1 perExtensionCompletionHandler:(id /* block */)a2 completionHandler:(id /* block */)a3;
