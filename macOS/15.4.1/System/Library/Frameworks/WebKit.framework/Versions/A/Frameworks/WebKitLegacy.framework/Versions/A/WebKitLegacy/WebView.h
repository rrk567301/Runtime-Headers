...
- (void)_showPlaybackTargetPicker:(struct ObjectIdentifierGeneric<WebCore::PlaybackTargetClientContextIdentifierType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long> { unsigned long long x0; })a0 location:(const struct IntPoint { int x0; int x1; } *)a1 hasVideo:(BOOL)a2;
