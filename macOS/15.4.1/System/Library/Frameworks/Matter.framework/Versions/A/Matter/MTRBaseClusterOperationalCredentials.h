...
- (void)setVidVerificationStatementWithCompletion:(id /* block */)a0;
- (void)setVidVerificationStatementWithParams:(id)a0 completion:(id /* block */)a1;
- (void)signVidVerificationRequestWithParams:(id)a0 completion:(id /* block */)a1;
