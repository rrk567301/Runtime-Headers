...
@interface MTRClosureControlClusterConfigureFallbackParams : NSObject <NSCopying>

@property (copy, nonatomic) NSNumber *restingProcedure;
@property (copy, nonatomic) NSNumber *triggerCondition;
@property (copy, nonatomic) NSNumber *triggerPosition;
@property (copy, nonatomic) NSNumber *waitingDelay;
