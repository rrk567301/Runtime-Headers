...
+ (void)readAttributeLinkLocalAddressWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeMACAddressWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)readAttributeLinkLocalAddressWithCompletion:(id /* block */)a0;
- (void)readAttributeMACAddressWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeLinkLocalAddressWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeMACAddressWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
