...
+ (void)readAttributeLatchWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)modifyEnabledAlarmsWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeLatchWithCompletion:(id /* block */)a0;
...
- (void)resetWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)subscribeAttributeLatchWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
