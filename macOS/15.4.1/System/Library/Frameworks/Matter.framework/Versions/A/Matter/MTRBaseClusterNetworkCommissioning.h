...
+ (void)readAttributeSupportedThreadFeaturesWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
+ (void)readAttributeSupportedWiFiBandsWithClusterStateCache:(id)a0 endpoint:(id)a1 queue:(id)a2 completion:(id /* block */)a3;
...
- (void)queryIdentityWithParams:(id)a0 completion:(id /* block */)a1;
...
- (void)readAttributeSupportedThreadFeaturesWithCompletion:(id /* block */)a0;
- (void)readAttributeSupportedWiFiBandsWithCompletion:(id /* block */)a0;
...
- (void)subscribeAttributeSupportedThreadFeaturesWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
- (void)subscribeAttributeSupportedWiFiBandsWithParams:(id)a0 subscriptionEstablished:(id /* block */)a1 reportHandler:(id /* block */)a2;
