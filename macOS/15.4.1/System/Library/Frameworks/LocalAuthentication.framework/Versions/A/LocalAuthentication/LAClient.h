...
- (void)analyticsAction:(long long)a0 dismissing:(BOOL)a1 reply:(id /* block */)a2;
- (void)analyticsMechanism:(long long)a0 result:(id)a1 reply:(id /* block */)a2;
- (void)analyticsMechanism:(long long)a0 starting:(BOOL)a1 reply:(id /* block */)a2;
- (void)analyticsSessionStarting:(BOOL)a0 dialogID:(id)a1 bundleID:(id)a2 reply:(id /* block */)a3;
