...
- (id)initWithSerializedData:(id)a0 dynamicLibraries:(id)a1 serializedStageInputDescriptor:(id)a2 device:(id)a3 options:(unsigned long long)a4 flags:(struct { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned long x5 : 59; })a5;
