...
- (BOOL)ensureContentsOfRecordStorageMatchForStorage:(id)a0 andOtherStore:(id)a1 error:(id *)a2;
...
- (BOOL)ensureRecordMetadataMatchesForRecordID:(id)a0 inStore:(id)a1 andOtherStore:(id)a2 error:(id *)a3;
