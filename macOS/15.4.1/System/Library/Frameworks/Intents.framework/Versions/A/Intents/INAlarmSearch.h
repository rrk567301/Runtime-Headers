...
@property (readonly) long long alarmReferenceType;
@property (readonly, copy) NSString *identifier;
@property (readonly, copy) INDateComponentsRange *time;
@property (readonly, copy) INSpeakableString *label;
@property (readonly) long long alarmSearchStatus;
@property (readonly, copy) NSNumber *includeSleepAlarm;
@property (readonly) long long period;
@property (readonly, copy) NSNumber *isMeridianInferred;
