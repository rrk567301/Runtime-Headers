...
- (void)decodedMessageForMessageData:(id)a0 decodeContext:(id)a1 withCompletionHandler:(id /* block */)a2;
...
- (void)session:(id)a0 hasSendMessageCheckWithCompletion:(id /* block */)a1;
