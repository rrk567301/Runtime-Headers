...
- (id)initWithSigners:(id)a0 isEncrypted:(BOOL)a1 signingError:(id)a2 encryptionError:(id)a3 shouldBlockRemoteContent:(BOOL)a4 disallowUsersToLoadRemoteContent:(BOOL)a5 localizedRemoteContentBlockingReason:(id)a6;
