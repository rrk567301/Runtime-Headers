...
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 destinationArrays:(id)a3;
- (void)encodeToMPSCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceArrays:(id)a2 destinationArrays:(id)a3 activeDestinationMask:(unsigned int)a4;
