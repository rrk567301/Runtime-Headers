...
@interface CMMotionManagerInternal : NSObject {
    ...
    struct unique_ptr<CLDisplayGravityService, std::default_delete<CLDisplayGravityService>> { struct __compressed_pair<CLDisplayGravityService *, std::default_delete<CLDisplayGravityService>> { struct CLDisplayGravityService *__value_; } __ptr_; } fDisplayGravityService;
