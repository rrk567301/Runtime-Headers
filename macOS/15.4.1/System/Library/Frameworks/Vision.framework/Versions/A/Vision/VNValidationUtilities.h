...
+ (BOOL)getEspressoPriority:(int *)a0 forKey:(id)a1 inOptions:(id)a2 withDefaultValue:(int)a3 error:(id *)a4;
...
+ (BOOL)getOptionalFaceObservation:(id *)a0 inOptions:(id)a1 error:(id *)a2;
+ (BOOL)getOptionalFaceObservations:(id *)a0 inOptions:(id)a1 error:(id *)a2;
