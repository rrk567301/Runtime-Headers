@class NSDate, NSString, NSArray, HKMedicalDateInterval, HKCodedQuantity, HKRatioValue, HKMedicalDate, NSDateComponents, HKCodedValueCollection, HKConcept, NSNumber, HKUCUMUnitDisplayConverter;
