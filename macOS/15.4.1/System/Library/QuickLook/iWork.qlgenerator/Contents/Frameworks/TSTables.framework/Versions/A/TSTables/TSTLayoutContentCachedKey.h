...
- (id)initWithString:(id)a0 width:(double)a1 height:(double)a2 paragraphStyle:(id)a3 cellWraps:(BOOL)a4 valueType:(unsigned char)a5 paddingInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a6 verticalAlignment:(int)a7 writingDirection:(int)a8 naturalAlignment:(int)a9 styleProvidingSource:(id)a10;
