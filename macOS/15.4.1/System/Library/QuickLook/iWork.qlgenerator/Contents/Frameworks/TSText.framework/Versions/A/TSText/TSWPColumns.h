...
- (id)initWithColumnCount:(unsigned long long)a0 equalWidth:(BOOL)a1 widthArray:(const double *)a2 gapArray:(const double *)a3;
...
- (id)initWithColumnCount:(unsigned long long)a0 equalWidth:(BOOL)a1 widthArray:(const double *)a2 gapArray:(const double *)a3 assert:(BOOL)a4;
