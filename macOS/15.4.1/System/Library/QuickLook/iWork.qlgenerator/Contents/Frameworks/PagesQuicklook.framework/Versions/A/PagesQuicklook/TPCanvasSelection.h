...
- (id)initWithType:(long long)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 styleInsertionBehavior:(long long)a2 caretAffinity:(long long)a3 leadingEdge:(BOOL)a4 leadingCharIndex:(unsigned long long)a5 infos:(id)a6 excludedInfos:(id)a7 additionalInfos:(id)a8;
...
- (id)initWithType:(long long)a0 ranges:(id)a1 validVisualRanges:(BOOL)a2 styleInsertionBehavior:(long long)a3 caretAffinity:(long long)a4 leadingEdge:(BOOL)a5 leadingCharIndex:(unsigned long long)a6 headCharIndex:(unsigned long long)a7 tailCharIndex:(unsigned long long)a8 infos:(id)a9 excludedInfos:(id)a10 additionalInfos:(id)a11;
