...
@property (readonly, nonatomic) BOOL hasValueOrCommentBreakingMergeFragment;
...
@property (readonly, nonatomic) BOOL hasEditableFormula;
...
@property (readonly, nonatomic) BOOL hasFormulaContainingUidReferences;
...
- (void)applyFormulaResult:(id)a0 context:(id)a1 hasWarnings:(BOOL)a2 outWriteDidBeginOrEndWithTextCell:(BOOL *)a3 propagateCheckboxes:(BOOL)a4;
