...
+ (id)argumentSpecForFunctionIndex:(unsigned short)a0 argumentIndex:(int)a1;
...
- (id)initWithContext:(id)a0 argumentSpec:(id)a1 firstIndex:(unsigned long long)a2 lastIndex:(unsigned long long)a3;
...
- (BOOL)isArgumentPlaceholderNode;
- (BOOL)isEmptyNode;
