...
- (struct TSUChromeCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; })p_parseStringAsGeometricReferenceComponent:(id)a0 inResolver:(id)a1 outPreserveFlags:(struct TSUPreserveFlags { unsigned char x0; } *)a2 gettingReferencesMatchingInputAsPrefix:(id *)a3;
