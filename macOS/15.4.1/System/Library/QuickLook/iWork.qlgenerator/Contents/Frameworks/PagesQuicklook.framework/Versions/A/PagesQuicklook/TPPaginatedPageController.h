...
- (id)displayPageNumberForCharIndex:(unsigned long long)a0 withSystemFormatting:(BOOL)a1;
- (id)displayPageNumberForPageIndex:(unsigned long long)a0 withSystemFormatting:(BOOL)a1;
...
- (unsigned long long)p_pageNumberForContinuousSectionsAtPageIndex:(unsigned long long)a0 finalPage:(BOOL)a1;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_pageRangeAffectedByInfo:(id)a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_pageRangeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 forcePagination:(BOOL)a1 includingEmptyPages:(BOOL)a2 caretAffinity:(long long)a3 leadingCharIndex:(unsigned long long)a4 outEndIsValid:(BOOL *)a5;
...
- (id)pageIndexesForSelection:(id)a0 forcePagination:(BOOL)a1 outEndIsValid:(BOOL *)a2;
