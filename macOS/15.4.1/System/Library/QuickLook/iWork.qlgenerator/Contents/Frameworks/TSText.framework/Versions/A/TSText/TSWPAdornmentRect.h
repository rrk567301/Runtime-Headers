@class TSDFill, TSDShadow, TSUSparseArray, TSDStroke, TSUBezierPath;
...
- (id)initWithRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 paragraphPath:(id)a1 stroke:(id)a2 fill:(id)a3 type:(int)a4;
