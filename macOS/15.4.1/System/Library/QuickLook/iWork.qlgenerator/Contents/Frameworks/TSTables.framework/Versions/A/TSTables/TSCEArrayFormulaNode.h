...
@property (nonatomic) unsigned short numColumns;
@property (nonatomic) unsigned short numRows;
...
- (id)initWithNumColumns:(unsigned short)a0 numRows:(unsigned short)a1;
