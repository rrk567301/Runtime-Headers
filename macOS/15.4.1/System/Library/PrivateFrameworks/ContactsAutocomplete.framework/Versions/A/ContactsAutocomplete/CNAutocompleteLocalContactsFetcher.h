...
- (BOOL)doesContact:(id)a0 haveEmailAddressesMatchingTerms:(id)a1 givenRequestedProperties:(id)a2;
- (BOOL)doesContact:(id)a0 haveInstantMessagingAddressesMatchingTerms:(id)a1 givenRequestedProperties:(id)a2;
- (BOOL)doesContact:(id)a0 havePhoneNumbersMatchingTerms:(id)a1 givenRequestedProperties:(id)a2;
- (BOOL)doesContact:(id)a0 matchProperties:(id)a1 terms:(id)a2 givenNameProperties:(id)a3;
- (BOOL)doesContact:(id)a0 matchTerms:(id)a1 givenNameProperties:(id)a2;
