...
+ (id)_reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(BOOL)a2 skipMSU:(BOOL)a3 defaultValues:(id)a4 pSUReloadError:(id *)a5 pDocReloadError:(id *)a6;
...
+ (void)reloadDescriptor:(id)a0 allowingDifferences:(id)a1 forceReload:(BOOL)a2 skipMSU:(BOOL)a3 defaultValues:(id)a4 completion:(id /* block */)a5;
