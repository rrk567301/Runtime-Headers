@class HAPNameResolver, HMFNetAddress, HMFBlockOperation, NSDate, HAPAccessoryServerBrowserIP, NSDictionary, HAPAuthSession, HAPAccessoryServerBookkeeping, HAPAccessory, NSMutableArray, HAPHTTPClient, HAPWACAccessory, NSString, HAPSocketInfo, NSOperationQueue, NSArray, HMFNetMonitor, NSData, HAPAccessoryProtocolInfo, HMFTimer;
...
@property (nonatomic) BOOL checkIfSuspendedAccesoryRediscovered;
