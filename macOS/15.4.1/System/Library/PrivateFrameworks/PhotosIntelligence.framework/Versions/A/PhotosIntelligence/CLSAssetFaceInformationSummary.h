...
- (id)initWithNumberOfFaces:(unsigned long long)a0 numberOfFacesIncludingPets:(unsigned long long)a1 numberOfFacesOfVerifiedPersons:(unsigned long long)a2 numberOfFacesOfHiddenPersons:(unsigned long long)a3 numberOfGoodFaces:(unsigned long long)a4 numberOfGoodFacesIncludingPets:(unsigned long long)a5 numberOfGoodFacesOfVerifiedPersons:(unsigned long long)a6 averageFaceQuality:(double)a7 averageFaceQualityIncludingPets:(double)a8 averageFaceQualityOfVerifiedPersons:(double)a9 userFeedbackScore:(double)a10 faceInformationByPersonLocalIdentifier:(id)a11 faceInformationByConsolidatedPersonLocalIdentifier:(id)a12;
