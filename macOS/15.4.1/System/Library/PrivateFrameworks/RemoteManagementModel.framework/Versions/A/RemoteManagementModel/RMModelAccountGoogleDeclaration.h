...
+ (id)assetTypes;
+ (id)buildRequiredOnlyWithIdentifier:(id)a0 userIdentityAssetReference:(id)a1;
+ (id)buildWithIdentifier:(id)a0 visibleName:(id)a1 userIdentityAssetReference:(id)a2;
