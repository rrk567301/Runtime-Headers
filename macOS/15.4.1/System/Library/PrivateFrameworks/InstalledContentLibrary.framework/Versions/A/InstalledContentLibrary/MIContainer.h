...
@property (nonatomic) BOOL isStagedContainer;
...
+ (id)containersForIdentifier:(id)a0 groupContainerIdentifier:(id)a1 ofContentClass:(unsigned long long)a2 forPersona:(id)a3 fetchTransient:(BOOL)a4 createIfNeeded:(BOOL)a5 error:(id *)a6;
...
- (BOOL)_isStagedUpdateContainer:(BOOL *)a0 withError:(id *)a1;
...
- (BOOL)clearStagedUpdateContainerStatusWithError:(id *)a0;
...
- (BOOL)markContainerAsStagedUpdateContainer:(id *)a0;
