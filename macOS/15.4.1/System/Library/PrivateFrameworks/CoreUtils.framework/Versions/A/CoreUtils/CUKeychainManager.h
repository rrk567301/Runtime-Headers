...
- (BOOL)removeItemMatchingItem:(id)a0 flags:(unsigned int)a1 error:(id *)a2;
- (BOOL)updateItem:(id)a0 matchingItem:(id)a1 error:(id *)a2;
- (BOOL)updateItem:(id)a0 matchingItem:(id)a1 flags:(unsigned int)a2 error:(id *)a3;
