...
@property (nonatomic, getter=isPersistentAcrossInvocations) BOOL persistentAcrossInvocations;
...
- (id)initWithIdentifier:(id)a0 type:(long long)a1 aceObject:(id)a2 dialogPhase:(id)a3 presentationState:(long long)a4 aceCommandIdentifier:(id)a5 virgin:(BOOL)a6 transient:(BOOL)a7 supplemental:(BOOL)a8 immersiveExperience:(BOOL)a9 persistentAcrossInvocations:(BOOL)a10 associatedDataStore:(id)a11;
