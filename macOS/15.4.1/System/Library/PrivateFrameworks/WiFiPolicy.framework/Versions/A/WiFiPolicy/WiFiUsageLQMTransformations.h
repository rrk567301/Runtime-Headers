...
+ (unsigned long long)getMaxPhyrateWithNss:(unsigned long long)a0 Bw:(unsigned long long)a1 Phy:(int)a2;
...
+ (void)updateConfig;
+ (unsigned long long)validateRate:(unsigned long long)a0 frames:(unsigned long long)a1;
