@class NSMapTable, NSDictionary, NSObject, VFXMTLLibrary;
...
- (id)deviceQueue;
- (id)frameworkLibrary;
- (void)libraryForProgramDesc:(struct { struct __CFXFXProgram *x0; struct __CFXMaterial *x1; struct __CFXGeometry *x2; struct __CFXFXPass *x3; struct __CFXFXPass *x4; id x5; struct __CFXBlendStates *x6; struct __CFXNode *x7; unsigned char x8; unsigned char x9; unsigned char x10; unsigned char x11; unsigned char x12; unsigned char x13; id x14; struct { unsigned char x0; id /* block */ x1; } x15; unsigned long long x16; })a0 completionHandler:(id /* block */)a1;
