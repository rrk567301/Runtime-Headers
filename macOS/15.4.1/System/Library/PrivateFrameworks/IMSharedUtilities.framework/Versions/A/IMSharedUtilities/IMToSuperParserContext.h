...
- (void)appendInlineImageWithGUID:(id)a0 filename:(id)a1 width:(long long)a2 height:(long long)a3 isAnimoji:(long long)a4 isAdaptiveImageGlyph:(BOOL)a5;
- (void)appendRichCards:(id)a0 transferGuids:(id)a1;
