...
- (void)remote_qaSourceForBundleIdentifier:(id)a0 name:(id)a1 completion:(id /* block */)a2;
- (void)remote_sourceForAppleDeviceWithUUID:(id)a0 identifier:(id)a1 name:(id)a2 productType:(id)a3 completion:(id /* block */)a4;
