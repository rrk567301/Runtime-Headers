...
- (void)updateOntologyWithShardIdentifier:(id)a0 schemaType:(id)a1 schemaVersion:(long long)a2 shardURL:(id)a3 shardVersion:(long long)a4 shouldPruneOldShard:(BOOL)a5 reason:(long long)a6 completion:(id /* block */)a7;
