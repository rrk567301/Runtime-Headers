...
+ (BOOL)enumerateEntitiesForSyncWithProperties:(id)a0 predicate:(id)a1 syncEntityClass:(Class)a2 session:(id)a3 syncAnchorRange:(struct HDSyncAnchorRange { long long x0; long long x1; })a4 orderingTerms:(id)a5 limit:(unsigned long long)a6 lastSyncAnchor:(long long *)a7 distinct:(BOOL)a8 healthDatabase:(id)a9 error:(id *)a10 block:(id /* block */)a11;
...
+ (BOOL)enumerateProperties:(id)a0 withPredicate:(id)a1 orderingTerms:(id)a2 groupBy:(id)a3 limit:(unsigned long long)a4 healthDatabase:(id)a5 error:(id *)a6 enumerationHandler:(id /* block */)a7;
