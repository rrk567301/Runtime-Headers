...
- (void).cxx_destruct;
- (id)initWithNavigationInterrupted:(BOOL)a0 requiredCharge:(id)a1 routeProgressWaypointIndex:(short)a2 routeRequestStorage:(id)a3 sharedETAData:(id)a4 type:(short)a5 vehicleIdentifier:(id)a6;
