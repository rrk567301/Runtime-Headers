@class OFFlowEstimate, FRCFlowAdaptationFeatureExtractor, OFBackwarp, OFCorrelation, NSObject, OFFeatureExtractor;
@protocol OS_dispatch_group, MTLDevice, MTLCommandQueue, OS_dispatch_queue;
