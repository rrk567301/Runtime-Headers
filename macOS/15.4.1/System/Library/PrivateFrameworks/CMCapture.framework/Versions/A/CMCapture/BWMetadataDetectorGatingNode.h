...
- (id)initWithMRCEnabled:(BOOL)a0 appClipCodeEnabled:(BOOL)a1 textLocalizationEnabled:(BOOL)a2 lowPowerModeEnabled:(BOOL)a3 compressed8BitInputEnabled:(BOOL)a4;
- (id)initWithSceneClassifierVersion:(struct { unsigned short x0; unsigned short x1; unsigned short x2; })a0 mrcEnabled:(BOOL)a1 appClipCodeEnabled:(BOOL)a2 textLocalizationEnabled:(BOOL)a3 lowPowerModeEnabled:(BOOL)a4 compressed8BitInputEnabled:(BOOL)a5;
- (id)nodeSubType;
