...
- (BOOL)flush;
- (BOOL)flushAsync;
- (id)initWithReadableByteStream:(struct OpaqueCMByteStream { } *)a0 forFrontFacingCamera:(BOOL)a1 forExternalCamera:(BOOL)a2 clientExpectsCameraMountedInLandscapeOrientation:(BOOL)a3 sampleReferenceMoviesEnabled:(BOOL)a4 movieGenerationQueue:(id)a5 irisStillImageMovieMetadataCache:(id)a6 videoOrientationTimeMachine:(id)a7;
