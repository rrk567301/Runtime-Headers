...
- (void)setTypicalISPZoomDelay:(unsigned int)a0 maxISPZoomDelay:(unsigned int)a1 clientCanCompensateForDelay:(BOOL)a2;
- (long long)timeForLastRequestedZoomFactor;
- (void)updateAppliedZoomFactorForDelayedISPAppliedZoomFactor:(float)a0;
- (void)updateISPZoomDelay:(unsigned int)a0;
