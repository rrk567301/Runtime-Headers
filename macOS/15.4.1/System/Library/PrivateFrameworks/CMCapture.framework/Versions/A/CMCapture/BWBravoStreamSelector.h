...
- (id)recommendMasterStreamUsingCurrentMasterStream:(id)a0 frameStatisticsByPortType:(id)a1 zoomFactor:(float)a2 isAutoFlashScene:(BOOL)a3 digitalFlashMode:(int)a4 detectedObjects:(id)a5 cameraControlsStatisticsMasterStream:(id)a6;
