...
@property (weak) MTVPAFKit *vpafKit;
@property (retain) id<MTMediaPlaylist> playlist;
@property (retain) MTMediaActivity *playActivity;
@property (retain) MTMediaActivity *seekActivity;
@property (retain) NSMutableArray *eventData;
@property (retain) MTMediaTimeTracker *timeTracker;
@property BOOL shouldGenerateTransitions;
