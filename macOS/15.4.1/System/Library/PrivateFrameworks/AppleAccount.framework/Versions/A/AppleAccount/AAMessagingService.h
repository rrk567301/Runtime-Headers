...
- (id)_optionsDictionaryWithResponseIdentifier:(id)a0 fireAndForget:(BOOL)a1 requiredCapabilities:(id)a2 lackingCapabilities:(id)a3 sendFromHandleUri:(id)a4;
...
- (id)sendMessage:(id)a0 destinations:(id)a1 sendFromHandleUri:(id)a2 responseIdentifier:(id)a3 fireAndForget:(BOOL)a4 requiredCapabilities:(id)a5 lackingCapabilities:(id)a6 error:(id *)a7;
