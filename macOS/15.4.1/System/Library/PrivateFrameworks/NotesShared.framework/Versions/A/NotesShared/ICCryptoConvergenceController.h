...
- (BOOL)convergeAttachmentsInNoteWithID:(id)a0 configuration:(id)a1;
- (BOOL)convergeNotesInAccountWithID:(id)a0 configuration:(id)a1 progress:(id)a2;
- (id)initWithWorkerContext:(id)a0;
- (BOOL)unsafelyConvergeAttachment:(id)a0 configuration:(id)a1;
- (BOOL)unsafelyConvergeAttachmentsInNote:(id)a0 configuration:(id)a1;
