...
+ (BOOL)_parsePlatformSSORequiredErrorWithMessage:(id)a0 details:(id)a1 outError:(id *)a2;
...
+ (BOOL)_parseWellKnownFailedErrorWithMessage:(id)a0 details:(id)a1 outError:(id *)a2;
+ (id)jsonDictFromResponse:(id)a0;
+ (BOOL)parse403ErrorWithResponseDictionary:(id)a0 outError:(id *)a1;
+ (BOOL)parsePredefined403ErrorWithResponseDictionary:(id)a0 outError:(id *)a1;
