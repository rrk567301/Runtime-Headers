...
- (id)bestItemInItems:(id)a0 options:(id)a1 criteria:(id)a2 minimumCriteriaScore:(double)a3 triedAndFailedToDoBetter:(BOOL *)a4;
- (id)bestItemInItems:(id)a0 options:(id)a1 criteria:(id)a2 minimumCriteriaScore:(double)a3 useIconicScore:(BOOL)a4;
