...
- (void)applyDistortionModelToPixels:(unsigned long long)a0 inPixels:(const struct CGPoint { double x0; double x1; } *)a1 intrinsicsMatrix:(struct { void /* unknown type, empty encoding */ x0[3]; })a2 pixelSize:(float)a3 distort:(BOOL)a4 outPixels:(struct CGPoint { double x0; double x1; } *)a5;
