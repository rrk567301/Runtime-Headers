...
+ (id)_timeIntervalAttributedTextWithStartDate:(id)a0 endDate:(id)a1 calendar:(id)a2 designatorRequiresWhitespace:(BOOL)a3 smallCapsAllowed:(BOOL)a4 dropLeftRedundantDesignator:(BOOL)a5 keepRedundantDesignator:(BOOL)a6;
