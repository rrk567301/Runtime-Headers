...
- (void)retrieveCachedResultsForString:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 tagger:(id)a2 offset:(unsigned long long)a3 ignoreTermination:(BOOL)a4 mutableResults:(id)a5 remainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a6;
