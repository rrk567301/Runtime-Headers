...
- (id)defaultTransportWithForceEnabledTransports:(id)a0 forceDisabledTransports:(id)a1 andHealthMonitorEnabled:(BOOL)a2;
...
- (BOOL)supportsTransportVersion:(id)a0;
...
- (void)updateWithForceEnabledTransports:(id)a0 forceDisabledTransports:(id)a1 andHealthMonitorEnabled:(BOOL)a2;
