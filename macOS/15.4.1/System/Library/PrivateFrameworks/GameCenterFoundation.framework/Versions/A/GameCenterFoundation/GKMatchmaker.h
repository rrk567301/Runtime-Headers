...
- (void)handleMatchRequest:(id)a0 forCurrentMatch:(id)a1 hostedCurrentPlayerCount:(long long)a2 serverHosted:(BOOL)a3 rematchID:(id)a4 devicePushToken:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)sendMatchmakingRequest:(id)a0 forMatch:(id)a1 rematchID:(id)a2 serverHosted:(BOOL)a3 playerCount:(long long)a4 completionHandler:(id /* block */)a5;
...
- (void)setShareInvitees:(id)a0 forMatch:(id)a1 propagateToDaemon:(BOOL)a2;
- (void)setShareInvitees:(id)a0 propagateToDaemon:(BOOL)a1;
