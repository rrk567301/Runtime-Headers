...
- (void)submitEndpointerIssueReport:(id)a0 withContext:(id)a1;
- (void)submitSELFIssueReport:(id)a0;
...
- (void)submitASRIssueReport:(id)a0;
...
- (void)submitSecureAssetIssueReport:(id)a0 withContext:(id)a1;
