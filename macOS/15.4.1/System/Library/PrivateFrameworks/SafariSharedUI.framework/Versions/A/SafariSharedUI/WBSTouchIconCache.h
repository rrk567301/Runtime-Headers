...
+ (id)generateFavoritesIconForTitle:(id)a0 url:(id)a1 backgroundColor:(id)a2 shouldRemoveGrammaticalArticles:(BOOL)a3 fontWeight:(long long)a4 fontDesign:(long long)a5 fontSize:(double)a6;
