@class PTParameterRecordsPersistenceManager, NSString, PTParameterRecords, NSDictionary, NSMutableSet, NSObject, NSMutableDictionary;
...
- (BOOL)_hasValueChangedFromDefault:(id)a0 forKeypath:(id)a1 settingsClassName:(id)a2;
