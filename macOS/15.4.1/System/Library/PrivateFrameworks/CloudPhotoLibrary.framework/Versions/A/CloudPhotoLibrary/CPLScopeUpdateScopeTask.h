...
+ (void)_updateScopeWithNewScopeType:(long long)a0 scope:(id)a1 updatedScopeChange:(id)a2 updatedFlags:(id)a3 oldTransportScope:(id)a4 updatedTransportScope:(id)a5 shouldUpdateTransportScope:(id /* block */)a6 store:(id)a7 transport:(id)a8 session:(id)a9 inTransaction:(id)a10;
+ (void)updateScopeWithNewScopeType:(long long)a0 scope:(id)a1 updatedScopeChange:(id)a2 updatedFlags:(id)a3 oldTransportScope:(id)a4 updatedTransportScope:(id)a5 shouldUpdateTransportScope:(id /* block */)a6 store:(id)a7 transport:(id)a8 session:(id)a9 inTransaction:(id)a10;
...
- (void)_updateScopeWithNewScopeType:(long long)a0 updatedScopeChange:(id)a1 updatedFlags:(id)a2 oldTransportScope:(id)a3 session:(id)a4 updatedTransportScope:(id)a5;
