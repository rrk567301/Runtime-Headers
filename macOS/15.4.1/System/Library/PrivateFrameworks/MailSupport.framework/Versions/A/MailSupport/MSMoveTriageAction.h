...
- (id)initWithQuery:(id)a0 origin:(long long)a1 actor:(long long)a2 delegate:(id)a3 destinationMailboxType:(long long)a4 flagChange:(id)a5 copyMessages:(BOOL)a6;
