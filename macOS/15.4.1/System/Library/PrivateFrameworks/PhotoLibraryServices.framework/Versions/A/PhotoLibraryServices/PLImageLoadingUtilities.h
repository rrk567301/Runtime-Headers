...
+ (void)_imageForAsset:(id)a0 withFormat:(unsigned short)a1 allowPlaceholder:(BOOL)a2 optimalSourcePixelSize:(struct CGSize { double x0; double x1; })a3 networkAccessAllowed:(BOOL)a4 networkAccessForced:(BOOL)a5 trackCPLDownload:(BOOL)a6 isCanceledHandler:(id /* block */)a7 completion:(id /* block */)a8 sync:(BOOL)a9;
+ (BOOL)canAccessImageForAsset:(id)a0;
+ (id)newSynchronousImageForAsset:(id)a0 withFormat:(unsigned short)a1 allowPlaceholder:(BOOL)a2 outImageProperties:(const struct __CFDictionary **)a3 outDeliveredPlaceholder:(BOOL *)a4;
