...
- (id)createSubregionsForString:(id)a0 topWhiteSpacePoints:(id)a1 bottomWhiteSpacePoints:(id)a2 hasBoundarySpacePoints:(BOOL)a3 hasCharacterAndWordBoundaries:(BOOL)a4 tokenPermutation:(id)a5;
