...
- (id)imageByCroppingRectangle:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 iosurfaceBacking:(BOOL)a1;
...
- (struct __CVBuffer { } *)pixelBufferWithScale:(double)a0 paddedToSize:(struct CGSize { double x0; double x1; })a1 adjustedToSize:(struct CGSize { double x0; double x1; } *)a2 paddingMode:(unsigned long long)a3 format:(unsigned int)a4 hardwareAcceleration:(BOOL)a5 toSurface:(struct __IOSurface **)a6;
