@interface AMSCB1PMediaTokenProvider : AMSCB1PBridgeDependent {
    ...
    struct shared_ptr<AMSCore::MediaTokenProvider> { struct MediaTokenProvider *__ptr_; struct __shared_weak_count *__cntrl_; } _mediaTokenProvider;
}
