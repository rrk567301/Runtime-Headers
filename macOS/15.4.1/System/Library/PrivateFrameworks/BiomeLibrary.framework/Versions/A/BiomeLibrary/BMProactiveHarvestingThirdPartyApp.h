...
- (id)initWithUniqueID:(id)a0 domainID:(id)a1 bundleID:(id)a2 absoluteTimestamp:(id)a3 title:(id)a4 desc:(id)a5 comment:(id)a6 content:(id)a7 contentProtection:(id)a8 personaId:(id)a9;
