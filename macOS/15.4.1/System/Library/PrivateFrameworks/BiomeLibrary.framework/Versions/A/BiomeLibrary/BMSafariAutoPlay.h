...
- (id)initWithDomain:(id)a0 visited:(id)a1 signal:(int)a2 countryCode:(id)a3 privacyProxy:(id)a4;
- (id)initByReadFrom:(id)a0;
- (id)initWithDomain:(id)a0 visited:(id)a1 signal:(int)a2 countryCode:(id)a3;
