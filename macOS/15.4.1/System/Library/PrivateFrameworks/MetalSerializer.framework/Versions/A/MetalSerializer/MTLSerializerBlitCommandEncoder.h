...
- (void)optimize:(id)a0 slice:(unsigned long long)a1 level:(unsigned long long)a2 withCommand:(unsigned int)a3;
- (void)optimize:(id)a0 withCommand:(unsigned int)a1;
- (void)optimizeReset:(id)a0 withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 withCommand:(unsigned int)a2;
