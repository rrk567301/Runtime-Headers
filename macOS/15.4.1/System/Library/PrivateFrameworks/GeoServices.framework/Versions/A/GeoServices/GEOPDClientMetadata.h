...
@interface GEOPDClientMetadata : PBCodable <NSCopying> {
    ...
    BOOL _supportExpertPartner;
    BOOL _supportHikeDisclaimer;
...
@property (nonatomic) BOOL hasSupportExpertPartner;
@property (nonatomic) BOOL supportExpertPartner;
@property (nonatomic) BOOL hasSupportHikeDisclaimer;
@property (nonatomic) BOOL supportHikeDisclaimer;
