@class NSData, NSArray, GEOComposedRoute, GEOArrivalParameters, GEOComposedWaypoint, GEOWaypointInfo, GEOComposedString, GEOComposedRouteEVChargingStationInfo, GEOComposedWaypointDisplayInfo;
