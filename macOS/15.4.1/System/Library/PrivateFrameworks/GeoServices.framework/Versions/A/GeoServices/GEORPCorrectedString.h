...
@interface GEORPCorrectedString : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_correctedValue : 1; unsigned char read_originalValue : 1; unsigned char wrote_anyField : 1; } _flags;
}
