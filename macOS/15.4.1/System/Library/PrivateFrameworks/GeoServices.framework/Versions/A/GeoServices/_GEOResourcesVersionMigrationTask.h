...
- (id)initForOpportunisticWithMigrator:(id)a0 manifestConfiguration:(id)a1 newTileGroup:(id)a2 inResourceManifest:(id)a3 dataSet:(id)a4 oldTileGroup:(id)a5 activeNames:(id)a6;
- (id)initForRequiredWithMigrator:(id)a0 manifestConfiguration:(id)a1 newTileGroup:(id)a2 inResourceManifest:(id)a3 dataSet:(id)a4 oldTileGroup:(id)a5 activeScales:(id)a6 activeScenarios:(id)a7;
- (id)initForWithMigrator:(id)a0 manifestConfiguration:(id)a1 newTileGroup:(id)a2 inResourceManifest:(id)a3 dataSet:(id)a4 oldTileGroup:(id)a5 activeScales:(id)a6 activeScenarios:(id)a7 activeNames:(id)a8;
