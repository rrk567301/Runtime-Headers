@class PBDataReader, GEOLocationInfo, GEOCameraFrame, PBUnknownFields;
...
@interface GEOMuninViewState : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_cameraFrame : 1; unsigned char read_locationInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
