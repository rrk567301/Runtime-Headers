...
@interface GEORPFeedbackTransitLine : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_transitLineMuid : 1; unsigned char read_transitLineName : 1; unsigned char read_transitSystemName : 1; unsigned char wrote_anyField : 1; } _flags;
}
