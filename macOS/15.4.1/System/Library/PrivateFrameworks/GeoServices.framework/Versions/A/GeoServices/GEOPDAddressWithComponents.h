...
@interface GEOPDAddressWithComponents : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_additionalComponents : 1; unsigned char read_formattedAddressComponents : 1; unsigned char read_formattedAddressLines : 1; unsigned char wrote_anyField : 1; } _flags;
}
