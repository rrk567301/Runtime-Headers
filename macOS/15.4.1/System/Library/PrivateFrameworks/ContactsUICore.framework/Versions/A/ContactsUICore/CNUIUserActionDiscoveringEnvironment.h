...
- (id)init;
- (void).cxx_destruct;
- (id)copyWithContactStore:(id)a0 schedulerProvider:(id)a1;
...
- (id)initWithIDSAvailabilityProvider:(id)a0 schedulerProvider:(id)a1 capabilities:(id)a2 defaultUserActionFetcher:(id)a3 applicationWorkspace:(id)a4;
