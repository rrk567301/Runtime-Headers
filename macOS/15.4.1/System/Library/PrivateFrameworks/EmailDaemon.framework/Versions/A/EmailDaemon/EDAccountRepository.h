@class EDBiomeBlackPearlLogger, NSString, EDAccountECAccountTransformer, NSMutableSet, EDPersistenceHookRegistry, NSObject;
...
@property (retain) EDAccountECAccountTransformer *transformer;
