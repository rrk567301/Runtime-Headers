...
@interface PKSharedPassSharesController : NSObject <PKPaymentDataProviderDelegate> {
    ...
    BOOL _platformSharingFeatureBlocked;
...
+ (BOOL)_isPlatformSharingFeatureBlockedForPass:(id)a0 targetDevice:(id)a1;
...
- (id)revocableShares;
- (id)_baseNewShareForPassIsTransfer:(BOOL)a0;
...
- (id)baseShareForPassTransferWithIsForCompanion:(BOOL)a0;
- (id)blockedSharingChannels;
- (void)canSendInvitationWithCompletion:(id /* block */)a0;
- (void)canSendInvitationWithIsTransfer:(BOOL)a0 completion:(id /* block */)a1;
