...
@property (nonatomic) BOOL isNestedPresentation;
...
@property (readonly, nonatomic) BOOL praguePolicyRequired;
...
@property (nonatomic) BOOL hasAnyPayWithRewardsOffers;
...
- (BOOL)canSupportDisbursementsOnRemoteDevice:(id)a0;
- (BOOL)canSupportMerchantCategoryCodeAccordingToWebService:(id)a0 forPass:(id)a1;
- (BOOL)canSupportMerchantCategoryCodeAccordingToWebService:(id)a0 forPaymentInstrument:(id)a1;
