...
- (id)_initWithApplicationConfigurationType:(id)a0 senderConfigurationType:(id)a1 suppressionType:(id)a2 suppressionMode:(id)a3 minimumBreakthroughUrgency:(id)a4 hideApplicationBadges:(id)a5 allowIntelligentManagement:(id)a6 compatibilityVersion:(id)a7;
