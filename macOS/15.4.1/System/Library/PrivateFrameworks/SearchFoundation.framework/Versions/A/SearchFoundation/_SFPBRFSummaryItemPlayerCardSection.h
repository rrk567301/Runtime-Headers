@class NSString, _SFPBButtonItem, NSData, _SFPBRFTextProperty, _SFPBRFVisualProperty;

@interface _SFPBRFSummaryItemPlayerCardSection : PBCodable <_SFPBRFSummaryItemPlayerCardSection, NSSecureCoding>
