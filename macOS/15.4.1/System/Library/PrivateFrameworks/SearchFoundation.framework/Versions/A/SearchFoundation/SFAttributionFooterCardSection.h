@class NSData, NSString, NSArray, SFCard, SFColor, SFCommand, NSDictionary, SFUserReportRequest, SFAppEntityAnnotation, SFPunchout, SFRichText, NSMutableDictionary;
