@class SFColor, NSString, NSArray, NSData, SFCard, SFUserReportRequest, SFTableAlignmentSchema, NSDictionary, SFCommand, SFAppEntityAnnotation, NSMutableDictionary;
