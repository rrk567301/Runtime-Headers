@class NSData, NSString, NSArray, SFCard, SFColor, SFUserReportRequest, NSDictionary, SFButtonItem, SFCommand, SFAppEntityAnnotation, SFRichText, NSMutableDictionary;
