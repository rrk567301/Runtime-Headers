...
- (id)_processAttachments:(id)a0 withSessionIdentifier:(id)a1 extension:(id)a2 shouldAddClassBDataProtection:(BOOL)a3 rootDir:(id)a4 annotatedGroup:(id)a5;
...
- (id)processAttachments:(id)a0 withSessionIdentifier:(id)a1 extension:(id)a2 shouldAddClassBDataProtection:(BOOL)a3 annotatedGroup:(id)a4;
