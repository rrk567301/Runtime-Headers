...
@interface AWDMETRICSKCellularPowerLogGPSStates : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char durationMs : 1; unsigned char lastSdmState : 1; unsigned char subsId : 1; } _has;
}
