@interface AWDMETRICSKCellularPowerLogLteRrcStateChange : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char cause : 1; unsigned char prevState : 1; unsigned char prevStateDurMs : 1; unsigned char state : 1; unsigned char subsId : 1; unsigned char isDataPreferred : 1; } _has;
}
