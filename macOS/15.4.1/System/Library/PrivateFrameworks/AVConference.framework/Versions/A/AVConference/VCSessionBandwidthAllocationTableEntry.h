...
- (id)initWithClient:(id)a0 type:(unsigned char)a1 streamToken:(long long)a2 minNetworkBitrate:(unsigned int)a3 maxNetworkBitrate:(unsigned int)a4 mediaBitrate:(unsigned int)a5 qualityIndex:(unsigned int)a6 streamID:(unsigned int)a7 hasRepairStreamID:(BOOL)a8 repairStreamID:(unsigned int)a9 repairMaxNetworkBitrate:(unsigned int)a10 subscribedTo:(BOOL)a11 startOnDemand:(BOOL)a12 streamGroupID:(unsigned int)a13 encoderGroupID:(unsigned int)a14 v2StreamID:(unsigned int)a15;
