...
- (id)initWithCapacity:(long long)a0 utteranceComplete:(BOOL)a1 utteranceNumber:(unsigned int)a2 updateNumber:(unsigned int)a3 utteranceStartTimestamp:(double)a4 utteranceDuration:(double)a5;
