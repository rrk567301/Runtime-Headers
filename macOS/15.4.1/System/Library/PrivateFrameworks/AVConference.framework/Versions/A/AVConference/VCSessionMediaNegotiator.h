@class NSString, NSArray, VCMediaNegotiatorResults, VCMediaNegotiatorResultsAudio, VCMediaNegotiatorResultsVideo, NSMutableDictionary, VCMediaNegotiatorLocalConfiguration, VCMediaNegotiatorResultsMediaRecorder, VCMediaNegotiatorResultsFaceTimeSettings;
