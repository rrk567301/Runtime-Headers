...
- (BOOL)attemptToSendOrBufferReliableMessage:(id)a0 participantID:(unsigned long long)a1 sequenceNumber:(long long)a2 retryNumber:(long long)a3;
- (void)clearTransactionCacheForParticipant:(id)a0;
- (void)dispatchedCompletionHandlerForSendMessage:(id)a0 withTopic:(id)a1 participantID:(unsigned long long)a2 result:(BOOL)a3 sequenceNumber:(long long)a4 retryNumber:(long long)a5;
