...
- (BOOL)createSocketWithSourcePort:(short)a0;
- (void)dequeueDatagramPacket:(id /* block */)a0;
- (int)drainUnderlyingFileDescriptor;
- (id)encryptionInfoEventWithIsLocalKey:(BOOL)a0;
...
- (id)initCreateSocketRequiresOptions:(BOOL)a0 dataPath:(int)a1 destination:(id)a2;
...
- (BOOL)isVideoPacket:(char *)a0 length:(unsigned long long)a1;
...
- (BOOL)setupMockIDSDatagramChannelRequiresOptions:(BOOL)a0 sourcePort:(short)a1;
