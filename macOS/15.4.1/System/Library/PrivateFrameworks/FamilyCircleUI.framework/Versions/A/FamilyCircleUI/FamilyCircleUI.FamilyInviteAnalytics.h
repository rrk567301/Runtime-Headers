...
- (void)sendFamilySuggestionsEventWithFamilySuggestionsProactiveCount:(long long)a0 familySuggestionsDisplayedCount:(long long)a1 hasBoostedContacts:(BOOL)a2 proactiveModelUsed:(long long)a3 serverRequestedModel:(id)a4;
