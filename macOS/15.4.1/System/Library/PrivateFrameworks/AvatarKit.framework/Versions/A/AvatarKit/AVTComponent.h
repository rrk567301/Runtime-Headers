...
- (id)initWithType:(long long)a0 assets:(id)a1 morphVariant:(id)a2 imageVariant:(id)a3 materialVariant:(id)a4 morphVariantIntensity:(float)a5 bodyPoseVariantIntensity:(float)a6 textureAssetPresence:(float)a7;
