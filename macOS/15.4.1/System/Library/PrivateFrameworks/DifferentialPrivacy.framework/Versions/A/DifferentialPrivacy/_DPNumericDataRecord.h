...
- (id)initWithKey:(id)a0 clearNumber:(double)a1 privateNumber:(double)a2 creationDate:(double)a3 submitted:(BOOL)a4 objectId:(id)a5;
- (BOOL)isEqualToNumericDataRecord:(id)a0;
