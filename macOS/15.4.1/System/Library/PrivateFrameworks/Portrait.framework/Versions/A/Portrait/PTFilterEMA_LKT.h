...
- (int)emaFilter:(id)a0 inDisplacement:(id)a1 inTexPrev:(id)a2 inTex:(id)a3 outTex:(id)a4 frameIndex:(int)a5 scale:(float)a6;
...
- (int)gaussEMAFilter:(id)a0 inDisplacement:(id)a1 inTexPrev:(id)a2 inTex:(id)a3 outTex:(id)a4 frameIndex:(int)a5;
