...
- (BOOL)getUInt64:(unsigned long long *)a0 forKey:(unsigned int)a1;
- (id)initWithUInt64s:(const unsigned long long *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
- (void)removeUInt64ForKey:(unsigned int)a0;
...
- (void)setUInt64:(unsigned long long)a0 forKey:(unsigned int)a1;
