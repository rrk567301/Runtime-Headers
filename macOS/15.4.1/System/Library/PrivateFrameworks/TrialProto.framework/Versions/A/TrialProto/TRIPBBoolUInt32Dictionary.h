...
- (BOOL)getUInt32:(unsigned int *)a0 forKey:(BOOL)a1;
- (id)initWithUInt32s:(const unsigned int *)a0 forKeys:(const BOOL *)a1 count:(unsigned long long)a2;
- (void)removeUInt32ForKey:(BOOL)a0;
...
- (void)setUInt32:(unsigned int)a0 forKey:(BOOL)a1;
