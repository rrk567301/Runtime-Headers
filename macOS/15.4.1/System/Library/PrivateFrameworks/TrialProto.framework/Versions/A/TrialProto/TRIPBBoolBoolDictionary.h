...
- (void)setBool:(BOOL)a0 forKey:(BOOL)a1;
- (void)removeAll;
- (BOOL)getBool:(BOOL *)a0 forKey:(BOOL)a1;
...
- (id)initWithBools:(const BOOL *)a0 forKeys:(const BOOL *)a1 count:(unsigned long long)a2;
- (void)removeBoolForKey:(BOOL)a0;
