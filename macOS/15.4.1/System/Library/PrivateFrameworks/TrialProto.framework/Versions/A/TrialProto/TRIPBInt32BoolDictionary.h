...
- (void)setBool:(BOOL)a0 forKey:(int)a1;
- (void)removeAll;
- (BOOL)getBool:(BOOL *)a0 forKey:(int)a1;
...
- (id)initWithBools:(const BOOL *)a0 forKeys:(const int *)a1 count:(unsigned long long)a2;
- (void)removeBoolForKey:(int)a0;
