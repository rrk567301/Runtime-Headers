...
- (BOOL)getUInt32:(unsigned int *)a0 forKey:(id)a1;
- (id)initWithUInt32s:(const unsigned int *)a0 forKeys:(id *)a1 count:(unsigned long long)a2;
- (void)removeUInt32ForKey:(id)a0;
