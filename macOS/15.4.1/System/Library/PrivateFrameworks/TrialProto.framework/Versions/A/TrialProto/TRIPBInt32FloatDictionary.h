...
- (void)setFloat:(float)a0 forKey:(int)a1;
- (void)removeAll;
...
- (BOOL)getFloat:(float *)a0 forKey:(int)a1;
- (id)initWithFloats:(const float *)a0 forKeys:(const int *)a1 count:(unsigned long long)a2;
- (void)removeFloatForKey:(int)a0;
