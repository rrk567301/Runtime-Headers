...
- (void)removeAll;
- (void)setInt32:(int)a0 forKey:(long long)a1;
...
- (BOOL)getInt32:(int *)a0 forKey:(long long)a1;
- (id)initWithInt32s:(const int *)a0 forKeys:(const long long *)a1 count:(unsigned long long)a2;
- (void)removeInt32ForKey:(long long)a0;
