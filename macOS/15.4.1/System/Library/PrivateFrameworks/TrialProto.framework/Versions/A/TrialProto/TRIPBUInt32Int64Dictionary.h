...
- (void)removeAll;
- (void)setInt64:(long long)a0 forKey:(unsigned int)a1;
...
- (BOOL)getInt64:(long long *)a0 forKey:(unsigned int)a1;
- (id)initWithInt64s:(const long long *)a0 forKeys:(const unsigned int *)a1 count:(unsigned long long)a2;
- (void)removeInt64ForKey:(unsigned int)a0;
