...
+ (id)_payloadWithProvidenceInfo:(id)a0 isOnboarded:(BOOL)a1 secondsSinceAlarmDismissed:(double)a2;

- (void).cxx_destruct;
- (id)initWithProvenanceInfo:(id)a0 isOnboarded:(BOOL)a1;
- (id)initWithProvenanceInfo:(id)a0 isOnboarded:(BOOL)a1 secondsSinceAlarmDismissed:(double)a2;
