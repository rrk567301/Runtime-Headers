...
- (void)cacheThumbnailData:(id)a0 specification:(const struct PHAssetResourceTableDataSpecification { int x0; int x1; int x2; int x3; int x4; int x5; long long x6; } *)a1 forAsset:(id)a2;
