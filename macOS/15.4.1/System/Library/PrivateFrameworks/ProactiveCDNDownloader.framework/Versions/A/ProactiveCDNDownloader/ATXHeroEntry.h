...
- (id)initWithAdamId:(unsigned long long)a0 urlHash:(id)a1 location:(struct CLLocationCoordinate2D { double x0; double x1; })a2 radiusInMeters:(unsigned long long)a3 rank:(unsigned long long)a4 isTouristApp:(BOOL)a5 poiCategory:(id)a6 poiMuid:(id)a7;
