...
+ (id)pickedPointWithSceneObject:(id)a0 element:(const void *)a1 projection:(const void *)a2 transform:(const void *)a3 objectSpacePoint:(const void *)a4 centerProjectionPoint:(const void *)a5;

- (id)copyWithZone:(struct _NSZone { } *)a0;
- (void).cxx_destruct;
- (id).cxx_construct;
- (id)initWithSceneObject:(id)a0 element:(const void *)a1 projection:(const void *)a2 transform:(const void *)a3 objectSpacePoint:(const void *)a4 centerProjectionPoint:(const void *)a5;
