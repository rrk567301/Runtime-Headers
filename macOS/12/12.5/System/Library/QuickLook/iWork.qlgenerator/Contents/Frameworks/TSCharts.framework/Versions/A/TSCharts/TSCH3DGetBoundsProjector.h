...
- (id).cxx_construct;
- (void)reset;
- (struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; })backProjectModelViewPoint:(const void *)a0;
- (void)setCamera:(id)a0 accessor:(id)a1;
- (void)resetTransformsForLayoutBounds;
- (void)resetTransformsForRenderBounds;
- (struct box<glm::detail::tvec3<float>> { struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; } x0; struct tvec3<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; union { float x0; float x1; float x2; } x2; } x1; })projectBounds:(const void *)a0 type:(int)a1;
