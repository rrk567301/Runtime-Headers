...
- (void)didPerformImmediateActionHitTest:(const void *)a0 contentPreventsDefault:(BOOL)a1 userData:(struct Object { void /* function */ **x0; id x1; } *)a2;
