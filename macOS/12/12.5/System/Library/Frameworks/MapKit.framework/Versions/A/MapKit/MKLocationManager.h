@class CLLocation, GEOLocationShifter, NSBundle, _MKWiFiObserver, GEOLocation, NSMutableArray, CLHeading, NSString, geo_isolater, NSHashTable, NSTimer, NSError, NSLock;
