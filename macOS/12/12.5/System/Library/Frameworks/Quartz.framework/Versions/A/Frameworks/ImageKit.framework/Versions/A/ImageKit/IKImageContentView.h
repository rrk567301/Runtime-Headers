@class NSURL, CIImage, IKImageAnalysisManager, CIContext, NSDictionary, IKCenteringClipView, NSMutableArray, CALayer, IKImageViewLayerQueue, NSTimer, IKImageRenderInfo, NSView, NSData, IKImageView2, CIFilter;
