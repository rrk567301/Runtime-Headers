...
@interface _VZVirtioQueueElement : NSObject {
    struct Element { union { struct { unsigned short descriptor_index; } split; struct { unsigned short buffer_id; unsigned short chained_descriptor_count; } packed; } ; unsigned int bytes_written; struct IoVector { unsigned long long _size; struct vector<std::span<unsigned char, 18446744073709551615>, std::allocator<std::span<unsigned char, 18446744073709551615>>> { void *__begin_; void *__end_; struct __compressed_pair<std::span<unsigned char, 18446744073709551615> *, std::allocator<std::span<unsigned char, 18446744073709551615>>> { void *__value_; } __end_cap_; } _buffers; } read_buffers; struct IoVector { unsigned long long _size; struct vector<std::span<unsigned char, 18446744073709551615>, std::allocator<std::span<unsigned char, 18446744073709551615>>> { void *__begin_; void *__end_; struct __compressed_pair<std::span<unsigned char, 18446744073709551615> *, std::allocator<std::span<unsigned char, 18446744073709551615>>> { void *__value_; } __end_cap_; } _buffers; } write_buffers; } _element;
