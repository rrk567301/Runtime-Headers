...
@interface NSSpellChecker : NSObject <NSWindowRestoration> {
    ...
    id _defineButton;
    struct __scFlags { unsigned char autoShowGuesses : 1; unsigned char needDelayedGuess : 1; unsigned char unignoreInProgress : 1; unsigned char wordFieldEdited : 1; unsigned char inSpelling : 1; unsigned char reconnectSpelling : 1; unsigned char inGrammar : 1; unsigned char reconnectGrammar : 1; unsigned char languageIdentification : 1; unsigned char languagesHidden : 1; unsigned char quotesByLanguage : 1; unsigned int _reserved : 21; } _scFlags;
