@class NSMutableDictionary, NSMapTable, NSControl, NSBundle, NSMutableIndexSet, NSTableViewRecycledViews, NSMutableArray, NSTableViewDropFeedbackData, NSString, NSTableView, NSTableUpdateData, NSTableGroupRowData, NSTableSwipeData, NSMutableSet, NSView, NSTableRowView;
...
@interface NSTableRowData : NSObject <NSAnimationDelegate> {
    ...
    NSTableGroupRowData *_groupRowData;
