@class NSColorSpace, NSDictionary, NSMenu, NSPSMatrix, _NSViewAnimator, NSMutableArray, NSString, NSMutableSet, NSViewController, NSTextInputContext, NSFunctionRow, NSArray, NSAppearance, NSPressureConfiguration, _NSBindingAdaptor, NSColor, NSLayoutGuide, NSWindow, NSLayoutRect, NSShadow, _NSIdleTimer, NSCandidateListTouchBarItem, NSSurface, NSScrollView, _NSViewLayoutAux, CALayer, CIFilter, NSMenuItem, NSBezierPath, NSURL;
...
@interface NSView : NSResponder <NSLayoutSpacingItem, NSAppearanceCustomizationInternal, CALayerDelegate, NSAnimatablePropertyContainer, NSUserInterfaceItemIdentification, NSDraggingDestination, NSAppearanceCustomization, NSAccessibilityElement, NSAccessibility> {
    ...
    unsigned char _hasEverBeenRotatedOrScaledFromBase : 1;
    ...
    unsigned char _trackingAreasDirty : 4;
...
- (id)_getNextResizeEventInvalidatingLiveResizeCacheIfNecessary:(id)a0;
...
- (id)_getNextResizeEventFromMask:(unsigned long long)a0 invalidatingLiveResizeCacheIfNecessary:(id)a1;
...
- (void)_recursiveSetTrackingAreasDirty:(long long)a0;
...
- (void)_previewCurrentPageForPrintOperation:(id)a0;
- (void)beginDocument;
- (void)endDocument;
- (void)endPage;
