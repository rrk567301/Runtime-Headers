...
- (void)notify_listeners_of_object:(unsigned int)a0 about_changes_to_properties:(const void *)a1;
- (void)synchronously_notify_listeners_of_object:(unsigned int)a0 about_changes_to_properties:(const void *)a1;
