@class NSData, NSDate, PHRelationshipChangeRequestHelper, NSString, PHMemoryFeature, PHUserFeedback, NSDictionary, NSManagedObjectID, PHObjectPlaceholder, NSNumber;
...
@property (retain, nonatomic) NSNumber *customMaximumNumberOfUserCuratedAssets;
