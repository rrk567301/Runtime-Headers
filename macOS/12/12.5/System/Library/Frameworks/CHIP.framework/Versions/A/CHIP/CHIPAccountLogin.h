...
@property (readonly) struct AccountLoginCluster { void /* function */ **_vptr$ClusterBase; unsigned int mClusterId; struct DeviceProxy *mDevice; unsigned short mEndpoint; struct Optional<std::chrono::duration<unsigned int, std::ratio<1, 1000>>> { BOOL mHasValue; union Value { struct duration<unsigned int, std::ratio<1, 1000>> { unsigned int __rep_; } mData; } mValue; } mTimeout; } cppCluster;
...
- (void)getSetupPINWithParams:(id)a0 completionHandler:(id /* block */)a1;
- (void)loginWithParams:(id)a0 completionHandler:(id /* block */)a1;
- (void)logoutWithCompletionHandler:(id /* block */)a0;
