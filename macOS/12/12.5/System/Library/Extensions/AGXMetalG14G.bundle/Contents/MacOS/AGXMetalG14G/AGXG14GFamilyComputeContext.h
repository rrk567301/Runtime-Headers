...
@interface AGXG14GFamilyComputeContext : IOGPUMetalComputeCommandEncoder <MTLComputeCommandEncoderSPI> {
    void *_impl;
...
- (id)initWithCommandBuffer:(id)a0 creationParams:(struct CreationParams { int x0; unsigned int x1; id x2; int x3; BOOL x4; } *)a1;
