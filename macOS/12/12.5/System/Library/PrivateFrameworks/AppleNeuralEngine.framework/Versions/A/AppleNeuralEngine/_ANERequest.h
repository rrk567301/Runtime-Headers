...
@property (readonly, nonatomic) _ANESharedEvents *sharedEvents;
...
- (void).cxx_destruct;
- (BOOL)validate;
- (id)initWithInputs:(id)a0 inputIndices:(id)a1 outputs:(id)a2 outputIndices:(id)a3 weightsBuffer:(id)a4 perfStats:(id)a5 procedureIndex:(id)a6 sharedEvents:(id)a7;
