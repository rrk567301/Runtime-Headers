@class BWStreamingCVAFilterRenderer, FigCaptureSemanticStyle, NSObject, BWRenderList, BWFencedAnimationQueue, BWSemanticStyleColorCubeCache, BWColorLookupCache, BWFigVideoCaptureDevice, NSString, NSArray, BWRenderListProcessor, BWRenderListAnimator, FigCaptureSemanticStyleSet;
...
- (id)initWithCaptureDevice:(id)a0 maxLossyCompressionLevel:(int)a1 semanticStyleRenderingEnabled:(BOOL)a2;
