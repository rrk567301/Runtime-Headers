@interface NTPBForYouTodaySectionSpecificConfig : PBCodable <NSCopying> {
    struct { unsigned char cutoffTime : 1; unsigned char headlinesPerFeedFetchCount : 1; unsigned char minimumUpdateInterval : 1; unsigned char subscriptionsFetchCount : 1; unsigned char fetchingBin : 1; } _has;
}
