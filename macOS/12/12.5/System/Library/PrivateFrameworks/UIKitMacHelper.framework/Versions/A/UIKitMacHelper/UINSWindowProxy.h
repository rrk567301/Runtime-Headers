@class NSURL, NSToolbar, NSViewHost, NSObject, NSTrackingSeparatorToolbarItem, NSISEngine, NSString, UINSSceneViewController, NSPointerArray, UIScene, NSWindow, NSArray, NSView, UIWindow;
@protocol NSSidebarTrackingAdapter, NSObject, NSSplitViewItemSeparatorTrackingAdapter, UINSToolbar, UINSTouchBarCoordinator;
...
@property (readonly, weak) UINSSceneViewController *sceneViewController;
@property (readonly, weak) NSWindow *attachedWindow;
...
- (void)_notifyIfActualKeyChanged;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })convertRectFromWindowSceneView:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0;
