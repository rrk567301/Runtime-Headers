@class NSUUID, SignpostSupportObjectFilter, SignpostSupportUniquePIDFilter, SignpostSupportPIDFilter, SignpostSupportExactProcessNameFilter, OSLogEventLiveStream, NSObject, SignpostIntervalBuilder, SignpostSupportSubsystemCategoryFilter;
