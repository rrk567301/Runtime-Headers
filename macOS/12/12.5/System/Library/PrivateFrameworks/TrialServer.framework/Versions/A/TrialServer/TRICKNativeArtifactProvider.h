...
- (id)queryOperationForRecordType:(id)a0 predicate:(id)a1 sortDescriptors:(id)a2 desiredKeys:(id)a3 options:(id)a4 recordFetchedBlock:(id /* block */)a5 queryCompletionBlock:(id /* block */)a6;
...
- (id)queryOperationForRecordType:(id)a0 predicate:(id)a1 desiredKeys:(id)a2 options:(id)a3 recordFetchedBlock:(id /* block */)a4 queryCompletionBlock:(id /* block */)a5;
...
- (id)queryOperationWithCursor:(id)a0 desiredKeys:(id)a1 options:(id)a2 recordFetchedBlock:(id /* block */)a3 queryCompletionBlock:(id /* block */)a4;
