...
@property (readonly) HMEDelegatingEventRouter *delegatingEventRouter;
...
- (id)initWithName:(id)a0 uuid:(id)a1 defaultRoomUUID:(id)a2 owner:(id)a3 homeManager:(id)a4 presenceAuth:(id)a5 metricsDispatcherFactory:(id)a6 logEventSubmitter:(id)a7 currentUserFactory:(id /* block */)a8 residentDeviceManagerFactory:(id /* block */)a9 locationHandlerFactory:(id /* block */)a10 hapMetadata:(id)a11 siriSecureAccessoryAccessController:(id)a12 carPlayDataSource:(id)a13 deviceLockStateDataSource:(id)a14 notificationRegistry:(id)a15 administratorHandlerFactory:(id /* block */)a16 xpcMessageTransportFactory:(id)a17 notificationCenter:(id)a18;
...
- (void)_reprocessAccessoryServers;
...
- (id)routerClientResidentManagerForRemoteEventRouterClientController:(id)a0;
...
- (id)deviceWithIdentifier:(id)a0 forRemoteEventRouterClientController:(id)a1;
