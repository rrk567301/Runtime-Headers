@class NSArray, NSObject, HMDMetricsDateProvider;
...
- (id)initWithDataSource:(id)a0 logEventSubmitter:(id)a1 dateProvider:(id)a2 householdDataProvider:(id)a3 remoteMessageDispatcher:(id)a4 contributors:(id)a5 workQueue:(id)a6;
