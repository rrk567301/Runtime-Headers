@class HMDTimeBasedFlagsManager, HMDLogEventErrorEventsAnalyzer, HMDConfigurationLogEvent, HMDLogEventProcessMemoryEventsAnalyzer, NSMutableArray, HMDLogEventMessageEventsAnalyzer, HMDHomeManager, HMDCloudSyncLogEventsAnalyzer, HMDMessageDispatcher, HMDLogEventDispatcher, NSString, HMDLogEventReachabilityEventsAnalyzer, NSArray, HMDCoreAnalyticsLogObserver, HMDLogEventDailyScheduler, NSObject, HMDLogEventElectionEventsAnalyzer, HMDLogEventProcessLaunchAnalyzer, HMDLogEventUserActivityAnalyzer, HMDHouseholdMetricsManager, HMDEventCountersManager, NSUUID, HMDLogEventHAPMetricsEventAnalyzer, HMFUnfairLock;
...
- (id)initWithMessageDispatcher:(id)a0 logEventDispatcher:(id)a1 dailyScheduler:(id)a2 countersManager:(id)a3 flagsManager:(id)a4;
