@class NSUUID, NSString, NSData, NSPredicate, HMFConnectivityInfo, NSSet, NSDate, NSArray, Protocol, MKFHAPAccessoryDatabaseID, NSNumber, _MKFHomeNetworkRouterSetting;
@protocol MKFSoftwareUpdate, MKFRoom, MKFHomeNetworkRouterSetting, MKFAccessory, MKFAssistantAccessControl, MKFApplicationData, MKFHome;
