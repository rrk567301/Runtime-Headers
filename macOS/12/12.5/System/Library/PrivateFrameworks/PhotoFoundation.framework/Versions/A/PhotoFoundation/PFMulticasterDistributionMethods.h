...
- (void)distribute:(id)a0 pfIntSizeArg:(struct PFIntSize_st { unsigned long long x0; unsigned long long x1; })a1 pfIntSizeArg:(struct PFIntSize_st { unsigned long long x0; unsigned long long x1; })a2;
