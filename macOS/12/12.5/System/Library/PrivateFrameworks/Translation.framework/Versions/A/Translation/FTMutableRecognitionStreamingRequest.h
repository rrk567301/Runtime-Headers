@class FTResetServerEndpointer, FTSetAlternateRecognitionSausage, FTStartSpeechRequest, FTCheckForSpeechRequest, FTAudioPacket, FTSetRequestOrigin, FTSetSpeechProfile, FTUpdateAudioInfo, FTSetEndpointerState, FTSetSpeechContext, FTFinishAudio;
