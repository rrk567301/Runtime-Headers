@class NSData, NSString, NSArray, QSSTextToSpeechRequestMeta, QSSTextToSpeechRequestExperiment, QSSTTSRequestFeatureFlags, NSMutableDictionary, QSSTextToSpeechUserProfile, QSSTextToSpeechRequestDebug, QSSTextToSpeechRequestContext;
