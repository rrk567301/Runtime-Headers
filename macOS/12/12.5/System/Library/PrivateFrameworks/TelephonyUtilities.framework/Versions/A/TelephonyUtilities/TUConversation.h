@class NSUUID, NSString, TUConversationMember, TUConversationActivitySession, NSSet, TUConversationProvider, TUConversationReport, TUHandle, NSObject, TUConversationLink;
