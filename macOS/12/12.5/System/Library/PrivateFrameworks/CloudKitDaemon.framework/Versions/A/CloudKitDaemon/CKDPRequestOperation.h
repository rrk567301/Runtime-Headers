@class CKDPRecordRetrieveChangesRequest, CKDPAtomBatchSaveRequest, CKDPAnonymousShareAddRequest, CKDPUserAvailableQuotaRequest, CKDPRequestOperationHeader, CKDPZoneRetrieveChangesRequest, CKDPAtomSyncRequest, CKDPAtomBatchReplaceRequest, CKDPUserRetrieveRequest, CKDPAtomBatchMetadataRetrieveRequest, CKDPBundlesForContainerRequest, CKDPZoneRetrieveRequest, CKDPRecordSaveRequest, CKDPUserPrivacySettingsResetRequest, CKDPUpdateMissingAssetStatusRequest, CKDPArchiveRecordsRequest, CKDPShareVettingInitiateRequest, CKDPQueryRetrieveRequest, CKDPWebAuthTokenRetrieveRequest, CKDPMarkAssetBrokenRequest, CKDPSubscriptionDeleteRequest, CKDPTokenUnregistrationRequest, CKDPNotificationSyncRequest, CKDPRecordRetrieveVersionsRequest, CKDPOperation, CKDPNotificationMarkReadRequest, CKDPFetchArchivedRecordsRequest, CKDPRecordRetrieveRequest, CKDPShareAcceptRequest, CKDPAssetUploadTokenRetrieveRequest, CKDPSubscriptionCreateRequest, CKDPZoneSaveRequest, CKDPCodeFunctionInvokeRequest, CKDPZoneDeleteRequest, CKDPUserPrivacySettingsRetrieveRequest, CKDPRecordResolveTokenRequest, CKDPSetBadgeCountRequest, CKDPUserPrivacySettingsBatchLookupRequest, CKDPDeleteContainerRequest, CKDPAnonymousShareRemoveRequest, CKDPRecordDeleteRequest, CKDPUserPrivacySettingsUpdateRequest, CKDPTokenRegistrationRequest, CKDPUserQueryRequest, CKDPSubscriptionRetrieveRequest;
...
@interface CKDPRequestOperation : PBCodable <NSCopying> {
    ...
    CKDPAtomBatchMetadataRetrieveRequest *_atomBatchMetadataRetrieveRequest;
    CKDPAtomBatchReplaceRequest *_atomBatchReplaceRequest;
    CKDPAtomBatchSaveRequest *_atomBatchSaveRequest;
    CKDPAtomSyncRequest *_atomSyncRequest;
...
@property (readonly, nonatomic) BOOL hasAtomSyncRequest;
@property (retain, nonatomic) CKDPAtomSyncRequest *atomSyncRequest;
@property (readonly, nonatomic) BOOL hasAtomBatchSaveRequest;
@property (retain, nonatomic) CKDPAtomBatchSaveRequest *atomBatchSaveRequest;
@property (readonly, nonatomic) BOOL hasAtomBatchMetadataRetrieveRequest;
@property (retain, nonatomic) CKDPAtomBatchMetadataRetrieveRequest *atomBatchMetadataRetrieveRequest;
@property (readonly, nonatomic) BOOL hasAtomBatchReplaceRequest;
