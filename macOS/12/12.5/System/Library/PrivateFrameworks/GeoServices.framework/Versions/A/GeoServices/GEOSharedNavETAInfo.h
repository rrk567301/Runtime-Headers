...
@interface GEOSharedNavETAInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_etaTimestamp : 1; unsigned char has_latitude : 1; unsigned char has_longitude : 1; unsigned char has_remainingDistance : 1; unsigned char has_remainingTime : 1; } _flags;
}
