@class GEOComposedRoute, GEOArrivalParameters, GEOComposedWaypointDisplayInfo, GEOWaypointInfo, NSData, GEOComposedRouteEVChargingStationInfo, GEOComposedWaypoint;
