@class GEOFormattedStringClientCapabilities, NSString, GEOAdvisoryClientCapabilities, GEOLocalTime, GEOLocalizationCapabilities, PBDataReader, PBUnknownFields, NSMutableArray, GEOAbAssignInfo;
...
@interface GEOClientCapabilities : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_maxFormatterSupported : 1; unsigned char has_maxManeuverTypeSupported : 1; unsigned char has_maxRouteIncidentSupported : 1; unsigned char has_maxTrafficSpeedSupported : 1; unsigned char has_maxZilchMessageVersionSupported : 1; unsigned char has_transitMarketSupport : 1; unsigned char has_clusteredTransitRoutesSupported : 1; unsigned char has_includeCrossLanguagePhonetics : 1; unsigned char has_internalInstall : 1; unsigned char has_internalTool : 1; unsigned char has_isAdvancedMap : 1; unsigned char has_isGlobeProjection : 1; unsigned char has_replaceAccidentStringWithCrash : 1; unsigned char has_routeOptionsSupported : 1; unsigned char has_snapToClosestStopSupported : 1; unsigned char has_supportsAdvancedMap : 1; unsigned char has_supportsAreaEventsEnhancements : 1; unsigned char has_supportsArrivalMapRegion : 1; unsigned char has_supportsCongestionZones : 1; unsigned char has_supportsElectricVehicleRoutes : 1; unsigned char has_supportsGuidanceEventImportanceInfo : 1; unsigned char has_supportsGuidanceEventPrivacyFilters : 1; unsigned char has_supportsGuidanceEventsInlineShields : 1; unsigned char has_supportsGuidanceEvents : 1; unsigned char has_supportsJunctionView : 1; unsigned char has_supportsLicensePlateRestrictions : 1; unsigned char has_supportsLongShieldStrings : 1; unsigned char has_supportsNaturalGuidance : 1; unsigned char has_supportsRoadComplexities : 1; unsigned char has_supportsSilentRouteUpdates : 1; unsigned char has_supportsSpeedTrapAnnouncements : 1; unsigned char has_supportsTrafficCameras : 1; unsigned char has_supportsUserIncidentReports : 1; unsigned char has_supportsWaypointRoutes : 1; unsigned char has_willSendEvDirectionsFeedback : 1; unsigned char read_unknownFields : 1; unsigned char read_supportedTransitFeatures : 1; unsigned char read_abAssignInfo : 1; unsigned char read_advisoryClientCapabilities : 1; unsigned char read_appMajorVersion : 1; unsigned char read_appMinorVersion : 1; unsigned char read_deviceCountryCode : 1; unsigned char read_deviceSku : 1; unsigned char read_displayLanguages : 1; unsigned char read_displayRegion : 1; unsigned char read_formattedStringClientCapabilities : 1; unsigned char read_hardwareModel : 1; unsigned char read_localizationCapabilities : 1; unsigned char read_osVersion : 1; unsigned char read_requestTime : 1; unsigned char read_userCurrentTimezone : 1; unsigned char wrote_anyField : 1; } _flags;
}
