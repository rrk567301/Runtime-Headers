@class PBDataReader, NSString, GEOMapRegion, NSMutableArray, GEORPUpdatedLabel;
...
@interface GEORPDetails : PBCodable <NSCopying> {
    ...
    int _displayStyle;
    int _mapType;
    struct { unsigned char has_directionsType : 1; unsigned char has_displayStyle : 1; unsigned char has_mapType : 1; unsigned char read_displayRegion : 1; unsigned char read_label : 1; unsigned char read_localizedDescription : 1; unsigned char read_localizedTitle : 1; unsigned char read_places : 1; unsigned char wrote_anyField : 1; } _flags;
}
