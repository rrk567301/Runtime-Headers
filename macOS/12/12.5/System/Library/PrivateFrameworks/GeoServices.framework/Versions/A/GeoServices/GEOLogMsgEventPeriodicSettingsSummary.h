@class GEOLogMsgStateMapsUserSettings, GEOLogMsgStateDeviceConnection, GEOLogMsgStateMapUIShown, PBDataReader, GEOLogMsgStateMapsFeatures, GEOLogMsgStateAccount, GEOLogMsgStateRoutingSettings, GEOLogMsgStateMapSettings;
...
@interface GEOLogMsgEventPeriodicSettingsSummary : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_electricVehicleCount : 1; unsigned char has_favoritesCount : 1; unsigned char has_licensePlateCount : 1; unsigned char has_personalCollectionsCount : 1; unsigned char has_homeFavoriteSet : 1; unsigned char has_learnFromAppEnabled : 1; unsigned char has_notificationsEnabled : 1; unsigned char has_siriSuggestionsEnabled : 1; unsigned char has_workFavoriteSet : 1; unsigned char read_account : 1; unsigned char read_deviceConnection : 1; unsigned char read_mapSettings : 1; unsigned char read_mapUiShown : 1; unsigned char read_mapsFeatures : 1; unsigned char read_mapsUserSettings : 1; unsigned char read_routingSettings : 1; unsigned char wrote_anyField : 1; } _flags;
}
