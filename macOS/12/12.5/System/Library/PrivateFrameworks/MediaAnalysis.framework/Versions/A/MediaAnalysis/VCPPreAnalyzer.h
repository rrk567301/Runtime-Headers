...
- (int)_convertFromBuffer:(struct __CVBuffer { } *)a0 toLumaPixelBuffer:(struct __CVBuffer **)a1;
...
- (int)_collectSceneAnalysisResults:(id *)a0 fromRequests:(id)a1 wpResults:(id)a2 ivsResults:(id)a3 ignoreSceneClassification:(BOOL)a4;
- (int)_performSceneAnalysis:(id *)a0 image:(id)a1 abnormalDimension:(unsigned long long)a2;
- (int)_performBlurAnalysis:(id *)a0 withLumaPixelBuffer:(struct __CVBuffer { } *)a1 isSDOF:(BOOL)a2;
...
- (int)_loadImageURL:(id)a0 abnormalDimension:(unsigned long long)a1 colorPixelBuffer:(struct __CVBuffer **)a2 andLumaPixelBuffer:(struct __CVBuffer **)a3 image:(id *)a4;
- (int)_performAnalysis:(id *)a0 abnormalDimension:(unsigned long long)a1 isSDOF:(BOOL)a2 colorPixelBuffer:(struct __CVBuffer { } *)a3 andLumaPixelBuffer:(struct __CVBuffer { } *)a4 image:(id)a5;
...
- (void)analyzeWithImageURL:(id)a0 abnormalDimension:(unsigned long long)a1 isSDOF:(BOOL)a2 completionHandler:(id /* block */)a3;
