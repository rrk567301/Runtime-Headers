...
@interface DocumentUnderstanding.DURequestContentType : NSObject
...
@property (class, nonatomic, readonly) _TtC21DocumentUnderstanding20DURequestContentType *productCategory;
