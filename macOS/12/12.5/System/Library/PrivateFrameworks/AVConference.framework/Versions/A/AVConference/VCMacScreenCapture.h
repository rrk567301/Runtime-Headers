...
- (struct __CFDictionary { } *)createDisplayStreamPropertiesFromConfig:(id)a0;
- (void)setOriginHIDEventTimestamp:(unsigned long long)a0 onBuffer:(struct __CVBuffer { } *)a1;
- (int)_startCapture;
