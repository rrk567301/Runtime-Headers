@class NSData, NSString, IDSGlobalLinkBlocks, NSDate, NSMutableDictionary, NSDictionary, IDSUDPLink, NSMutableArray, NSObject, IDSStunCandidatePair, IDSTCPLink;
...
- (void)_selectStunTransport:(long long *)a0 andInterfaceAddress:(id *)a1;
...
- (void)_updateLinkIDForQUIC:(id)a0;
...
- (void)_updateSendStatsWithResult:(unsigned long long)a0 bytesSent:(long long)a1 packetsSent:(int)a2 linkID:(char)a3 delegatedLinkID:(char)a4 token:(id)a5 useRelay:(BOOL)a6 isClientData:(BOOL)a7 sendTime:(double)a8 stunTransport:(long long)a9;
