...
- (void).cxx_destruct;
- (id)initWithRole:(long long)a0 setupStartTime:(id)a1 setupEndTime:(id)a2 configurationEndTime:(id)a3 setupSessionError:(id)a4 category:(id)a5 retryCount:(unsigned long long)a6 firstSettingTime:(id)a7 languageSettingTime:(id)a8;
