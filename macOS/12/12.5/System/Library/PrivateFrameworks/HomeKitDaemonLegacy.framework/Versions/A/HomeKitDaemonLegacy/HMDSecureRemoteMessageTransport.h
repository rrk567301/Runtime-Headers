@class HMDRemoteMessageNotifications, NSString, NSArray, HMDHomeManager, HMDRemoteDeviceMonitor, NSMutableDictionary, HMFPromise, NSMutableSet, HMFFuture, NSObject;
