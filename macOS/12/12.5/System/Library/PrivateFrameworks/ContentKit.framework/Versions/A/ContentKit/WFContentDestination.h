...
@property (class, readonly, nonatomic) WFContentDestination *onScreenContentDestination;
...
@property (class, readonly, nonatomic) WFContentDestination *webpagesDestination;
