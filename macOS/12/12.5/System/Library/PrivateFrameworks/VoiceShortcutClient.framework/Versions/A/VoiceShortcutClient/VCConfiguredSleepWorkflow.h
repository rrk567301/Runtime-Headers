...
- (id)initWithWorkflowIdentifier:(id)a0 bundleIdentifierForDisplay:(id)a1 summaryString:(id)a2 name:(id)a3 actionIdentifier:(id)a4 glyphCharacter:(unsigned short)a5 backgroundColorValue:(long long)a6;
