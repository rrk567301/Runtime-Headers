@class NSArray, NSString, NSSet, NSMenu, WFVariable, NSIndexSet;

@interface WFTextTokenChooser : NSObject <NSMenuDelegate>

@property (copy, nonatomic) NSArray *auxiliaryButtons;
@property (retain, nonatomic) NSMenu *presentedMenu;
...
- (id)menuItemForButton:(id)a0;
- (void)menuItemSelected:(id)a0;
