@class FI_TPropertyColumnPreviewNameController, NSObject, FI_TPropertyColumnPreviewKindAndSizeController, NSLayoutConstraint, FI_TPropertyColumnPreviewSmallIconController, NSStackView;
...
- (BOOL)showSmallThumbnail;
- (double)nameFontSize;
- (long long)nameKindTextAlignment;
