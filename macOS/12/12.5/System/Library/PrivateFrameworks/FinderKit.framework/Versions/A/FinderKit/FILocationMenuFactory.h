@class NSString, NSArray, NSValue, NSPopUpButton, NSObject;
...
@interface FILocationMenuFactory : NSObject <TMarkTornDown> {
    ...
    struct TNSWeakPtr<NSPopUpButton, void> { NSValue *fWeakObject; } _weakPopUpButton;
...
- (void)addICloudSectionOnQueue:(void *)a0 nodesInMenu:(void *)a1 data:(const void *)a2 genCount:(unsigned long long)a3;
