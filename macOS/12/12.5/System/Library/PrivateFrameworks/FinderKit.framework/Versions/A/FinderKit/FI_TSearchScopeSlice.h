@class NSString, FI_TButton, FI_TPopUpButton, NSStackView, NSValue, NSObject, FI_TTextField, FI_TScopeBarRadioGroupView, NSLayoutConstraint;
...
@interface FI_TSearchScopeSlice : NSNavBannerView <NSStackViewDelegate> {
    ...
    struct TNSRef<FI_TButton, void> { FI_TButton *fRef; } _genericRadioButtonRetainer;
    struct TNSWeakPtr<NSObject<TSearchScopeSliceControllerDelegate>, void> { NSValue *fWeakObject; } _weakDelegate;
}
