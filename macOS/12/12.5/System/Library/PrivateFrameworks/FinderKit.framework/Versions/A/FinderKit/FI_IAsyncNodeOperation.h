...
@interface FI_IAsyncNodeOperation : NSObject {
    ...
    struct TNSWeakPtr<NSObject<IAsyncNodeOperationDelegateProtocol>, void> { NSValue *fWeakObject; } _weakDelegate;
    unsigned int _respondsToFlags;
}

@property (retain, nonatomic) FI_IAsyncNodeOperation *selfReference;
@property (weak, nonatomic) NSObject<IAsyncNodeOperationDelegateProtocol> *delegate;
