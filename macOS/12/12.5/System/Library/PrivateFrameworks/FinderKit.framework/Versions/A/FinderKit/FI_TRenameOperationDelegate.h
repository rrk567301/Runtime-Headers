@interface FI_TRenameOperationDelegate : FI_TFileSystemOperationDelegate {
    ...
    struct TriStateBool { int fState; } _extensionHiddenState;
    struct TriStateBool { int fState; } _changeExtensionResponse;
    BOOL _isBulkRename;
}
...
- (const struct TriStateBool { int x0; } *)extensionHiddenState;
