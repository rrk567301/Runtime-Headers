@class CHIPPluginClusterDescription, HAPCharacteristic, CHIPAttributeCacheContainer, NSString, CHIPDevice;
...
@property (readonly, nonatomic) CHIPAttributeCacheContainer *attributeCacheContainer;
