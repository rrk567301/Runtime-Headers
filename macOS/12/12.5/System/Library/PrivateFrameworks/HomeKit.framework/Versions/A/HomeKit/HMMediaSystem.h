@class HMMediaSession, HMSymptomsHandler, HMAccessorySettings, HMHome, NSObject, HMAccessoryCategory, HMMediaDestination, HMMutableArray, NSString, HMApplicationData, HMFUnfairLock, HMAccessorySettingsDataSource, NSArray, _HMContext, NSUUID;
...
- (BOOL)_mergeWithNewObject:(id)a0 includeSettingsAndAppData:(BOOL)a1;
