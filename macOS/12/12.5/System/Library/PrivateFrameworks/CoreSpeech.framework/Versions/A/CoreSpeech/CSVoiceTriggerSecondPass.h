@class NSUUID, NSMutableData, CSVTSecondPassScorer, CSAudioCircularBuffer, CSSyncKeywordAnalyzerQuasar, NSDictionary, NSObject, CSSpeechManager, CSKeywordAnalyzerNDEAPI, CSAudioStream, NSMutableArray, CSAudioTimeConverter, NSString, CSKeywordAnalyzerNDAPI, NSMutableDictionary, SSRSpeakerRecognitionController, SSRSpeakerRecognitionContext, CSPlainAudioFileWriter, CSAsset, CSShadowMicScoreCreator;
...
@property (nonatomic) float twoShotFeedbackDelayRemora;
...
- (id)initWithPHSEnabled:(BOOL)a0 speechManager:(id)a1 stateQueue:(id)a2 secondPassQueue:(id)a3;
- (void)handleVoiceTriggerSecondPassFrom:(unsigned long long)a0 deviceId:(id)a1 audioProviderUUID:(id)a2 firstPassInfo:(id)a3 rejectionMHUUID:(id)a4 completion:(id /* block */)a5;
...
- (void)_voiceTriggerFirstPassDidDetectKeywordFrom:(unsigned long long)a0 deviceId:(id)a1 audioProviderUUID:(id)a2 firstPassInfo:(id)a3 rejectionMHUUID:(id)a4 completion:(id /* block */)a5;
