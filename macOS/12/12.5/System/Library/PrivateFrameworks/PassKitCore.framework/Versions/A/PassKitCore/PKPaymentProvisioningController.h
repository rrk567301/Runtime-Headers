@class NSHashTable, PKPaymentCredential, PKAccountService, NSMutableArray, NSString, PKPaymentSetupMoreInfoItem, NSMutableSet, PKPaymentSetupProductModel, PKPaymentPass, PKAddPaymentPassRequestConfiguration, PKPaymentProvisioningControllerCredentialQueue, NSTimer, NSArray, PKPaymentService, PKPaymentCloudStoreZoneCreationManager, NSObject, NSSet, NSData, CLLocationManager, CIDVUIProofingFlowManager, PKPaymentWebService, PKPaymentProvisioningResponse, PKPaymentRequirementsResponse, PKPaymentEligibilityResponse, NSExtension;
