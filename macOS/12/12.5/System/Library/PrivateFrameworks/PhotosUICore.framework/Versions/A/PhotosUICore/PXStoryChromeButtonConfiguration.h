@class NSString, PXStoryChromeButtonSpec, NSArray, NSMenu, NSColor;
@protocol PXStoryMenuDelegate, PXDisplayAsset, NSObject;
...
@property (weak, nonatomic) id<PXStoryMenuDelegate> menuDelegate;
