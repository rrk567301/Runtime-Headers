...
@interface IFInstallJob : NSObject {
    ...
    struct _modDirs_t { unsigned char notifyATS : 1; unsigned char notifyKext : 1; unsigned char notifyPrefPane : 1; unsigned char notifyQuickTime : 1; unsigned char notifyComponents : 1; unsigned char notifyAudioPlugIns : 1; } _modDirs;
    int _planFiles;
    int _packageFiles;
...
- (struct _modDirs_t { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; } *)modDirs;
