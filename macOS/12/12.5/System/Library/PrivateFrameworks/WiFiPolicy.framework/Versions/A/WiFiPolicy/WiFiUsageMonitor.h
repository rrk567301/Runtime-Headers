...
- (void)setRoamingState:(BOOL)a0 flags:(unsigned long long)a1 scannedChannelCount:(unsigned long long)a2 withReason:(unsigned long long)a3 asString:(id)a4 andStatus:(unsigned long long)a5 asString:(id)a6 andLatency:(unsigned long long)a7 andOriginRSSI:(long long)a8 andTargetRssi:(long long)a9 andPingPongNth:(unsigned long long)a10 forInterface:(id)a11;
