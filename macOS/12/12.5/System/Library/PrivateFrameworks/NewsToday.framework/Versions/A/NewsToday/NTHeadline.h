@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSURL, NSDate, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, NTHeadlinePersonalizationMetadata, SFSearchResult, NTPBHeadlineAnalyticsElement, NSString, NTPBHeadlineBackingElement, NTPBHeadlineAdElement, NTPBFeedItem, NSArray;
