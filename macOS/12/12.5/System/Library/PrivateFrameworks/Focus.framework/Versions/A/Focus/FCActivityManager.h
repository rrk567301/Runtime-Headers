@class NSHashTable, NSString, NSArray, DNDModeSelectionService, DNDLifetimeDetailsProvider, DNDStateService, DNDModeAssertion, DNDStateUpdate, NSMutableDictionary;
