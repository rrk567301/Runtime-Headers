@class BRCVolume, NSMutableSet, BRCFSUploader, BRCDeadlineScheduler, BRCInflightProgressTracker, BRCApplyScheduler, BRCDownloadTrackers, BRCClientState, BRCUserNotification, BRCServerPersistedState, BRDSIDString, NSURL, BRCFileUnlinker, BRCThrottle, NSNumber, BRCFSDownloader, BRCPQLConnection, BRCFSReader, BRCContainerScheduler, br_pacer, BRCAccountHandler, NSMutableDictionary, NSString, NSObject, BRCAccountWaitOperation, BRCNotificationManager, NSHashTable, BRCItemTransmogrifier, BRCAnalyticsReporter, BRCFSWriter, BRCFairScheduler, BRCSyncUpScheduler, BRCDiskSpaceReclaimer, BRCStageRegistry, BRCGlobalProgress;
