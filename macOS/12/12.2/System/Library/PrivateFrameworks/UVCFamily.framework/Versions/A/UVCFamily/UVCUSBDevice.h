@class NSArray, NSDictionary, NSString, UVCUSBDeviceControlInterface, NSObject, NSMutableSet;
...
- (void)handleDataWithError:(id)a0 error:(id)a1 interface:(id)a2 context:(void *)a3;
