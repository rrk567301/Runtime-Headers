...
@property struct Promise<PromiseResult> { void /* function */ **_vptr$Future; struct shared_ptr<AMSCore::Future<PromiseResult>::FutureImp> { struct FutureImp *__ptr_; struct __shared_weak_count *__cntrl_; } mFutureImpSharedPtr; } backingPromise;
