@class NSString, NSArray, AMSKeychainOptions, NSDictionary, AMSBagKeySet, ACAccount, NSObject, AMSSigningSecurityService, NSURLSessionTask, AMSProcessInfo;
...
@property (retain) NSURLSessionTask *parentTask;
