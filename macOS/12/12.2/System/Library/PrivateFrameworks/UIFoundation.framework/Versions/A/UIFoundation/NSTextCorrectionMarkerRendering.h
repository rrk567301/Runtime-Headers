...
+ (id)_patternColorForSpellType_macOS:(long long)a0 size:(struct CGSize { double x0; double x1; })a1 gap:(struct CGSize { double x0; double x1; })a2 imageSize:(out struct CGSize { double x0; double x1; } *)a3;
+ (id)colorForType:(long long)a0 font:(id)a1 imageSize:(out struct CGSize { double x0; double x1; } *)a2;
+ (id)colorForSpellType_macOS:(long long)a0;
