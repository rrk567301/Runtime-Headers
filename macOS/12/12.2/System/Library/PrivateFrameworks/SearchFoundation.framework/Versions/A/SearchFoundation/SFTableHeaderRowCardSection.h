@class SFCard, NSString, NSArray, SFColor, NSData, SFUserReportRequest, SFTableAlignmentSchema, NSDictionary, SFCommand;

@interface SFTableHeaderRowCardSection : SFTableRowCardSection <SFTableHeaderRowCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char canBeHidden : 1; unsigned char hasTopPadding : 1; unsigned char hasBottomPadding : 1; unsigned char separatorStyle : 1; unsigned char isSubHeader : 1; unsigned char reducedRowHeight : 1; unsigned char verticalAlign : 1; unsigned char alignRowsToHeader : 1; } _has;
}
