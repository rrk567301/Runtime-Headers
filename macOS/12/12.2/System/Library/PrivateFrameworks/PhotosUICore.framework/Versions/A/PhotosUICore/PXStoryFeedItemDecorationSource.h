@class PXGLayout, PXSectionedDataSource, PXSelectionSnapshot, PXStoryFeedSectionContentLayout, NSString;

@interface PXStoryFeedItemDecorationSource : NSObject <PXGSelectionDecorationSource>

@property (readonly, nonatomic) PXStoryFeedSectionContentLayout *decoratedSectionContentLayout;
