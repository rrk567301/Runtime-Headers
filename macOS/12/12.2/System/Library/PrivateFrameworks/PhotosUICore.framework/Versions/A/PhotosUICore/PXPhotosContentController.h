@class PXPhotosGridFooterStatusController, PXMediaProvider, PXUpdater, PXAssetsDataSourceCountsController, PXExtendedTraitCollection, NSString, PXPhotosViewInteraction, UXView, PXPhotosLayout, PXGView, PXPhotosGridFooterPresentation, PXAssetReference, PXPhotosViewModel;
