...
+ (void)_drawWithDecorationInfo:(struct PXGDecorationSpriteInfo { long long x0; double x1; long long x2; })a0 solidColorOverlay:(id)a1 debugDecoration:(id)a2 cornerRadius:(struct { union { struct { float x0; float x1; float x2; float x3; } x0; float x1[4]; } x0; })a3 context:(struct CGContext { } *)a4 viewport:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a5 screenScale:(double)a6 viewEnvironment:(id)a7 userInterfaceDirection:(unsigned long long)a8 videoDurationFormatter:(id)a9;
...
- (void)_requestTextureForDecorationInfo:(struct PXGDecorationSpriteInfo { long long x0; double x1; long long x2; })a0 solidColorOverlay:(id)a1 debugDecoration:(id)a2 targetSize:(struct CGSize { double x0; double x1; })a3 cornerRadius:(struct { union { struct { float x0; float x1; float x2; float x3; } x0; float x1[4]; } x0; })a4 screenScale:(double)a5 requestID:(int)a6 viewEnvironment:(id)a7 userInterfaceDirection:(unsigned long long)a8;
- (void)_requestViewTextureForDecorationInfo:(struct PXGDecorationSpriteInfo { long long x0; double x1; long long x2; })a0 customViewClass:(Class)a1 userData:(id)a2 decorationOptions:(unsigned long long)a3 requestID:(int)a4;
