...
- (struct HGEquirectProjectParams { float x0[3]; float x1[3]; float x2[3]; float x3; float x4; BOOL x5; float x6; float x7; float x8; float x9; float x10; float x11; int x12; int x13; int x14; int x15; BOOL x16; float x17[4]; float x18[4]; float x19[4]; float x20[4]; })getParams:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; unsigned long long x5; })a0 withOutputImage:(id)a1 inputImage:(id)a2 width:(unsigned long long)a3 height:(unsigned long long)a4 outputWidth:(unsigned long long)a5 outputHeight:(unsigned long long)a6 xRotation:(double)a7 yRotation:(double)a8 zRotation:(double)a9 cameraBehavior:(int)a10 paramAPI:(id)a11;
