...
@interface EDSecureMessageCompositionHandler : NSObject <MEAppExtensionsObserver, MEMessageEncoder> {
...
- (id)_securityImplementationForSender:(id)a0;
- (void)getEncodingStatusForMessage:(id)a0 composeContext:(id)a1 completionHandler:(id /* block */)a2;
- (id)_wrappedErrorForError:(id)a0 extensionIdentifier:(id)a1;
