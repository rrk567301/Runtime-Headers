...
- (id)edgeDescription;
- (id)initFromPersonNode:(id)a0 toContactNode:(id)a1 weight:(float)a2 contactScore:(double)a3 numberOfMomentsAtHome:(unsigned long long)a4 numberOfMomentsAtMentionedAddress:(unsigned long long)a5 numberOfWeakBirthdayMomentsAroundBirthdayDate:(unsigned long long)a6 numberOfWeakBirthdayMomentsAroundPotentialBirthdayDate:(unsigned long long)a7 numberOfMomentsOverlappingWithCalendarEvents:(unsigned long long)a8 numberOfAppearancesInSharedAssets:(unsigned long long)a9 numberOfCMMMoments:(unsigned long long)a10 facetimeFaceprintConfidence:(double)a11 contactFaceprintMatch:(BOOL)a12 relationshipsDebug:(id)a13 socialGroupsConfidence:(double)a14 socialGroupsDebug:(id)a15 messageGroupsDebug:(id)a16 birthdayScore:(double)a17 potentialBirthdayScore:(double)a18 addressScore:(double)a19 mentionedAddressScore:(double)a20 calendarScore:(double)a21 sharedAssetScore:(double)a22 sharedCMMScore:(double)a23 relationshipScore:(double)a24 scoreAfterMessagePenalty:(double)a25 sexMatch:(unsigned long long)a26;
