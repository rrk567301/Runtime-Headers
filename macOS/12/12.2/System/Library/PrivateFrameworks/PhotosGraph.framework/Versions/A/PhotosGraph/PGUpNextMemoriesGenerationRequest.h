...
- (id)initWithRootMemoryLocalIdentifier:(id)a0 momentUUIDs:(id)a1 memoryLocalIdentifiersToAvoid:(id)a2 targetUpNextMemoryCount:(unsigned long long)a3;
- (id)initWithRootMemoryLocalIdentifier:(id)a0 momentUUIDs:(id)a1 memoryLocalIdentifiersToAvoid:(id)a2 targetUpNextMemoryCount:(unsigned long long)a3 customVectors:(id)a4 wantsVerboseDebugInfo:(BOOL)a5;
...
- (id)_ephemeralMemoriesByUniqueMemoryIdentifiersWithWorkingContext:(id)a0;
