@class AVPixelBufferAttributeMediator, NSMutableDictionary, NSObject, NSDictionary, AVOutputContext, NSMutableArray, AVPlayerItem, NSString, AVPlayerPlaybackCoordinator, AVQueuePlayer, NSMutableSet, NSHashTable, NSArray, AVWeakReference, NSError;
