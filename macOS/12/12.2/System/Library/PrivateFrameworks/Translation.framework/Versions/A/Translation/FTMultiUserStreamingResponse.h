@class FTRequestStatsResponse, FTAudioLimitExceeded, NSData, FTRecognitionCandidate, NSMutableDictionary, FTServerEndpointFeatures, FTPartialSpeechRecognitionResponse, FTRecognitionProgress, FTFinalSpeechRecognitionResponse, FTClientSetupInfo, FTFinalBlazarResponse;
