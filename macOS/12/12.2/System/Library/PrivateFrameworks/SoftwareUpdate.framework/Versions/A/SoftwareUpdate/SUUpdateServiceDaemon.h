...
- (BOOL)_unarchiveStateFrom:(id)a0;
- (void)_refreshLocalUpdateObjects:(id)a0 afterScan:(BOOL)a1 joinUpdateInfoQueue:(BOOL)a2;
- (void)_saveCurrentStateNoDelay:(BOOL)a0;
- (id)_currentClients;
- (void)_installStateDidChangeForKeys:(id)a0;
- (void)_runBackgroundActionsOnCurrentQueueIfAppropriate:(BOOL *)a0 shouldSkipScanning:(BOOL)a1;
...
- (void)_setProductsForPostLogoutInstallResultsNotification:(id)a0 nowIsLater:(BOOL)a1;
- (void)_doTheCredsStashEnablingFLO:(BOOL)a0 reply:(id /* block */)a1;
- (void)purgeManualProductState;
- (void)configureProgressPhasesEnablingFLO:(id)a0 finishBlock:(id /* block */)a1;
- (void)performDownloadAndStageWithProductKeys:(id)a0 downloadOnly:(BOOL)a1 stageOnly:(BOOL)a2 reply:(id /* block */)a3;
...
- (void)startStagingUpdatesForProductKey:(id)a0 usingForeground:(BOOL)a1 replyWhenDone:(id /* block */)a2;
- (void)startUpdatesForProductKeys:(id)a0 usingClientAuthorization:(struct AuthorizationOpaqueRef { } *)a1 holdingBoostDuringInstall:(BOOL)a2 usingForeground:(BOOL)a3 clientBlocksRestart:(BOOL)a4 packageScriptUserID:(unsigned int)a5 sendingStatusUpdates:(BOOL)a6 replyWhenDone:(id /* block */)a7;
