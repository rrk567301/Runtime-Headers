...
@protocol FCLocalRegionManager, FCCurrentIssuesChecker, FCPPTContext, FCContentContextInternal, FCPersonalizedGrouping, FCFavoritesPersonalizer, FCFeedPersonalizing, FCWebURLResolutionEndpointConnection, FCFeedDatabaseProtocol, FCOfflineArticleManagerType, FCBundleSubscriptionManagerType, FCPrivateDataContextInternal, FCContentContext, FCPurchaseManagerType, FCCoreConfigurationManager, FCNewsletterManager, FCBackgroundTaskable, FCNewsAppConfigurationManager, FCPurchaseProviderType, FCAVAssetPrewarming, FCAppActivityMonitor, FCPaidAccessCheckerType, FCPrivateDataContext, FCPushNotificationHandling;
