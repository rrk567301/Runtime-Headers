...
- (id)_detectionsFromFTTrackingResult:(id)a0 autoFocusRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 namedSignalsPerTrack:(id)a2 time:(struct { long long x0; int x1; unsigned int x2; long long x3; })a3 disparityBuffer:(struct __CVBuffer { } *)a4;
...
- (void)_setDisparityOfDetections:(id)a0 disparityBuffer:(struct __CVBuffer { } *)a1;
