@class VUIImageView, VUIBaseView, VUILabel, _TtC8VideosUI21StyledProgressBarView, VUITextBadgeView;

@interface VideosUI.UnifiedOverlayView : VideosUI.BaseOverlayView <VUITextBadgeViewDelegate, VUISportsScoreboardManagerDelegate> {
