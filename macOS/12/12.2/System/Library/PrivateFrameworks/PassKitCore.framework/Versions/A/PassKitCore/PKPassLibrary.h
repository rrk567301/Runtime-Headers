...
- (void)hasInAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)a0 issuerCountryCodes:(id)a1 withHandler:(id /* block */)a2;
- (void)hasInAppPrivateLabelPaymentPassesForWebDomain:(id)a0 issuerCountryCodes:(id)a1 withHandler:(id /* block */)a2;
- (void)canPresentPaymentRequest:(id)a0 completion:(id /* block */)a1;
- (void)shouldHomePresentAddPassFlow:(id /* block */)a0;
...
- (id)inAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)a0 issuerCountryCodes:(id)a1;
- (id)inAppPrivateLabelPaymentPassesForWebDomain:(id)a0 issuerCountryCodes:(id)a1;
...
- (void)transitMessageForRouteInfo:(id)a0 completion:(id /* block */)a1;
- (void)transitMessageDidDisplay:(id)a0;
- (id)_remoteLibrary;
- (BOOL)migrateData;
