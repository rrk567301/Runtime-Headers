...
@property (readonly, nonatomic) struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *geoJunction;
...
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *)a0 routeOffset:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 tile:(const void *)a2;
