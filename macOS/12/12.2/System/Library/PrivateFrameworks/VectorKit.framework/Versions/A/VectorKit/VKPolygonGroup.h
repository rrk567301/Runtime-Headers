...
@property (readonly, nonatomic) struct vector<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>> { void *__begin_; void *__end_; struct __compressed_pair<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh> *, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>> { void *__value_; } __end_cap_; } elevatedStrokeMeshes;
