...
@interface DRSProtoTaskingConfigCompletion : PBCodable <CKCodeOperationMessageMutation, NSCopying> {
    struct { unsigned char activeDuration : 1; unsigned char receivedToCompletedDuration : 1; } _has;
}
...
@property (nonatomic) BOOL hasReceivedToCompletedDuration;
@property (nonatomic) float receivedToCompletedDuration;
