...
+ (id)logCategory;
+ (id)eventTrackFromObjectGoundTruth:(id)a0;
...
- (id)compareWithObjectDetectionTruth:(id)a0 eventClass:(Class)a1 confidenceThreshold:(float)a2 minIntersectionOverMinArea:(float)a3;
- (id)compareWithObjectDetectionTruth:(id)a0 trackFilter:(id /* block */)a1 minIntersectionOverMinArea:(float)a2;
...
- (id)chartDataWithObjectDetectionTruth:(id)a0 isBaseline:(BOOL)a1 intersectionOverMinAreaThreshold:(float)a2;
- (id)initWithDetectionGroundTruth:(id)a0;
...
- (id)compareWithObjectDetectionTruth:(id)a0 eventClass:(Class)a1 confidenceLevel:(long long)a2 minIntersectionOverMinArea:(float)a3;
