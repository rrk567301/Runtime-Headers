...
@interface PREAMResponseListGenerated : PBCodable <NSCopying> {
    struct { unsigned char ageGroup : 1; unsigned char generationStatus : 1; unsigned char numberOfCustomResponses : 1; unsigned char numberOfResponsesGenerated : 1; unsigned char isApricotDevice : 1; unsigned char isCached : 1; } _has;
}
