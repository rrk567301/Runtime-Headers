@class AVDesktopPlaybackControlsController, AVUIViewHostMacHelper, AVFullscreenTransitionConfigurationMacHelper, AVFloatingPlaybackControlsViewController, AVObservationController, NSDictionary, AVDetachedFullscreenController, AVDesktopPlaybackContentContainerView, NSString, AVPlayerController, AVDesktopPlayerLayerView, AVDesktopPlayerViewContentView, AVPlaybackRateCollection;
