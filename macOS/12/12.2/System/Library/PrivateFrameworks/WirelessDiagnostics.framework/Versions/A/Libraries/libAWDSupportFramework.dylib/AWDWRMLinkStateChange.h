...
@interface AWDWRMLinkStateChange : PBCodable <NSCopying> {
    struct { unsigned char timestamp : 1; unsigned char btRssi : 1; unsigned char ccAssertion : 1; unsigned char enableCMAS : 1; unsigned char enableTelephony : 1; unsigned char isTriggeredByProximityChange : 1; unsigned char newLinkState : 1; unsigned char oldLinkState : 1; unsigned char siriApp : 1; unsigned char wifiProximity : 1; unsigned char wifiRssi : 1; } _has;
}
