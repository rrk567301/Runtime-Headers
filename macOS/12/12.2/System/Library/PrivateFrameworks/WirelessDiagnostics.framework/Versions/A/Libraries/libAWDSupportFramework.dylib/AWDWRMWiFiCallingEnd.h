...
@interface AWDWRMWiFiCallingEnd : PBCodable <NSCopying> {
    struct { unsigned char lTECTRSRP : 1; unsigned char lTERSRP : 1; unsigned char timestamp : 1; unsigned char wiFiRSSI : 1; unsigned char wiFiSINR : 1; unsigned char bBAudioErasures : 1; unsigned char bBAudioPacketLoss : 1; unsigned char bSSLoad : 1; unsigned char beaconRate : 1; unsigned char hOBool : 1; unsigned char lTEDataLQM : 1; unsigned char lTESINR : 1; unsigned char lTETxPower : 1; unsigned char lTEVoiceLQM : 1; unsigned char latteDejitterBufferUnderflow : 1; unsigned char latteErasures : 1; unsigned char latteNominalJitterBufferSize : 1; unsigned char latteRTPPacketLoss : 1; unsigned char sessionId : 1; unsigned char signalBar : 1; unsigned char wiFiRxRetry : 1; unsigned char wiFiTxPER : 1; unsigned char aTMRegistrationState : 1; unsigned char captiveNetwork : 1; unsigned char hOCapability : 1; unsigned char iPSecTunnelStatus : 1; unsigned char iWLANStatus : 1; unsigned char lTEQoSAvailable : 1; unsigned char wOWEnabled : 1; unsigned char wiFiBSSIDChange : 1; unsigned char wiFiPreferred : 1; } _has;
}
