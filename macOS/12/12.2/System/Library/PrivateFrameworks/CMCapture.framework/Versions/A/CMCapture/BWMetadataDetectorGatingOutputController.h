...
- (struct opaqueCMSampleBuffer { } *)_newOutputSampleBufferWithPixelBuffer:(struct __CVBuffer { } *)a0 inputSampleBuffer:(struct opaqueCMSampleBuffer { } *)a1 appliedPrimaryCaptureRect:(BOOL)a2;
