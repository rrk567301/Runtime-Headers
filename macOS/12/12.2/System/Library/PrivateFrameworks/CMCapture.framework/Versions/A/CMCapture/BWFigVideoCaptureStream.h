@class NSMutableDictionary, BWSphereModeSelector, BWStillImageCaptureStreamSettings, BWStillImageTimeMachine, NSDictionary, BWFigCaptureStream, NSObject, BWStillImageCaptureSettings, NSMutableArray, NSString, NSSet, BWFigCaptureSynchronizedStreamsGroup, BWNoiseReductionAndSharpeningParameters, NSArray, NSData;
