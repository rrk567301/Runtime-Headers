@class NSDictionary, BWImageControlModeTransitionMonitor, BWFigCaptureDeviceVendor, BWVariableFrameRateSelector, BWMemoryPool, NSString, BWFigCaptureDevice, NSMutableArray, BWRamp, BWInferenceResult, BWMetadataTimeMachine, NSArray, NSMutableDictionary, NSMutableSet, BWFigVideoCaptureStream, BWMovingWindowStats, BWFrameStatisticsByPortType, NSObject, NSSet, FigStateMachine, FigWeakReference, BWDeviceMotionActivityDetector, BWZoomCommandHandler, BWStillImageCaptureSettings, BWAmbientLightSensor, BWBravoStreamSelector, BWFigVideoCaptureSynchronizedStreamsGroup, BWStats, BWStreamStartStopSynchronizer, NSNumber;
