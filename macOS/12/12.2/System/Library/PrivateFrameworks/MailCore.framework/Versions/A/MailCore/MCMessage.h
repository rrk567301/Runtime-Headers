@class MCMimePart, NSColor, ECSubject, NSDate, NSDictionary, ECMessageFlags, NSString, NSSet, MCDisplayNameInfo, ECAngleBracketIDHash, NSMutableSet, NSArray, NSUUID;
@protocol MCMessageDataSource, MCMailAccount, MCMailbox, ECMimePart, ECMessageHeaders;
