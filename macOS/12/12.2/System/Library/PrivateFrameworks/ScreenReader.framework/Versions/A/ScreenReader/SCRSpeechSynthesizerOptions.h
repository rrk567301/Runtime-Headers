...
@property (nonatomic) double customizedNormalIntonation;
@property (nonatomic) double customizedMaxIntonation;
@property (nonatomic) double customizedMinIntonation;
