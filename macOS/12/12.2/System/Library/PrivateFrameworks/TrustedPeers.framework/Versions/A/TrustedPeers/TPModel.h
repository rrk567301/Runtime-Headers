...
- (id)createStableInfoWithFrozenPolicyVersion:(id)a0 flexiblePolicyVersion:(id)a1 policySecrets:(id)a2 syncUserControllableViews:(int)a3 secureElementIdentity:(id)a4 walrusSetting:(id)a5 deviceName:(id)a6 serialNumber:(id)a7 osVersion:(id)a8 signingKeyPair:(id)a9 recoverySigningPubKey:(id)a10 recoveryEncryptionPubKey:(id)a11 isInheritedAccount:(BOOL)a12 error:(id *)a13;
...
- (BOOL)isCustodianRecoveryKeyEnrolled:(id)a0;
