@class CCVegaWorker, NSDictionary, NSLocale, NSObject, CCVegaWorkerClient, NSAppearance, NSString, NSCalendar, CCVegaRenderer, NSLayoutConstraint, NSMutableSet, NSArray, NSTrackingArea, NSNumber;
