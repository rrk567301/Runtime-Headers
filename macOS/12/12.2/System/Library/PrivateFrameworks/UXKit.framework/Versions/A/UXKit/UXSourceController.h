@class UXNavigationController, NSMapTable, NSPopUpButton, NSSegmentedControl, _UXSourceSplitView, UXTransitionController, NSLayoutConstraint, NSString, UXView, NSWindow, NSArray, NSView, UXViewController, _UXViewControllerOneToOneTransitionContext, NSOperationQueue;
