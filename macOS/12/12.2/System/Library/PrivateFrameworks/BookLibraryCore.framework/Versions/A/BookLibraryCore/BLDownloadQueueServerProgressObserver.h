...
- (void)sendInitialProgressNotificationForDownloadWithStoreID:(id)a0 storePlaylistID:(id)a1 orPermlink:(id)a2 downloadID:(id)a3 title:(id)a4 collectionTitle:(id)a5 isPaused:(BOOL)a6 isAudiobook:(BOOL)a7 targetObserver:(id)a8;
