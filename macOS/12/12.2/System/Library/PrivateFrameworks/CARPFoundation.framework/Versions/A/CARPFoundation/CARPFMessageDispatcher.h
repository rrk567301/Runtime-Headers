@class NSString, NSBackgroundActivityScheduler, NSSet, CARPFMessageTransport, NSDictionary, NSObject, NSMutableOrderedSet, CARPFTimer;
@protocol OS_dispatch_queue;

@interface CARPFMessageDispatcher : CARPFObject <CARPFLogging, CARPFMessageTransportDelegate> {
    struct carpf_unfair_data_lock_s { struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } lock; } _lock;
...
@property (readonly, nonatomic) CARPFMessageTransport *transport;
