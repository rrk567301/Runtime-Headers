@class HMDRemoteMessageNotifications, NSString, NSArray, HMDHomeManager, HMDRemoteDeviceMonitor, NSMutableDictionary, NSMutableSet, NSObject, HMDRemoteMessageTransport;
...
- (id)initWithLegacyTransports:(id)a0 modernTransport:(id)a1;
