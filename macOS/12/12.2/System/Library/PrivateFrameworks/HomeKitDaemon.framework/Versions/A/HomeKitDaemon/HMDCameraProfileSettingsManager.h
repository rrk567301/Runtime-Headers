@class HMDAppleAccountManager, HMFTimer, HMDFeaturesDataSource, HMDDatabaseZoneManager, NSObject, HMFMessageDispatcher, NSUUID, HMCameraUserNotificationSettings, NSString, HMDCameraProfileSettingsDerivedPropertiesModel, HMDHAPAccessory, _HMCameraUserSettings, HMDBulletinBoard, NSNumber, HMDCharacteristicsAvailabilityListener, HMDCameraProfileSettingsModel, NSNotificationCenter, HMDCameraBulletinNotificationManager;
...
@property (retain) HMCameraUserNotificationSettings *cachedNotificationSettings;
