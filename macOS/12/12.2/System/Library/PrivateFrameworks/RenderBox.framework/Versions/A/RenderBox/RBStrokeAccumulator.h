...
@interface RBStrokeAccumulator : NSObject <RBStroke, RBLineStroke, RBParticleStroke, NSCopying> {
    struct vector<RBStrokeElement, 0, unsigned long> { unsigned char *_p; unsigned long long _size; unsigned long long _capacity; } _elements;
    struct vector<float, 0, unsigned long> { float *_p; unsigned long long _size; unsigned long long _capacity; } _values;
