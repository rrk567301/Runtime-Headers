@class NSString, NSArray, NSValue, NSIndexSet, NSObject, FI_TKeyValueObserverGlue;
...
@interface FI_TPropertyColumnPreviewSmallIconController : FI_TPropertyImageViewController <TPropertyThumbnailExtractorDelegate, TDraggingSource, TThumbnailExtractorDelegate> {
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _pendingKeyNodesToken;
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _updateAfterResizeToken;
