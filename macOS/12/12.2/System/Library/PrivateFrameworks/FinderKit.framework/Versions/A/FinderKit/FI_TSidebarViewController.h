...
@interface FI_TSidebarViewController : FI_TViewController <NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, NSMenuItemValidation, ISpawnOriginDelegateProtocol, QLSeamlessCloserDelegate, TMarkTornDown> {
    ...
    struct TNSWeakPtr<NSObject<TSidebarViewControllerDelegate>, void> { NSValue *fWeakObject; } _delegate;
    ...
    struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char __lx[24]; } __buf_; void *__f_; } __f_; } _sidebarUpdateCallback;
...
- (struct TFENodeVector { struct TFENode *x0; struct TFENode *x1; struct __compressed_pair<TFENode *, std::allocator<TFENode>> { struct TFENode *x0; } x2; })locationsNodes;
- (void)reloadOneZone:(const void *)a0 zoneKind:(int)a1;
...
- (void)setSidebarUpdateCallback:(struct function<void ()> { struct __value_func<void ()> { struct type { unsigned char x0[24]; } x0; void *x1; } x0; })a0;
