...
@interface FIFinderViewGutsController : FI_TViewController <FILocationPopUpDelegate, FIBrowserOverlayStackViewDelegate, NSMenuDelegate, NSMenuItemValidation, BrowserContainerTargeting, BrowserContainerSearching, BrowserContainerDelegate> {
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _pendingWindowOrderedOutToken;
    ...
    BOOL _hideExtension;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _deferredRetargetAndReloadToken;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _handleInitialTargetingToken;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _historyBeginsNowToken;
    ...
    struct map<TFENode, TriStateBool, std::less<TFENode>, std::allocator<std::pair<const TFENode, TriStateBool>>> { struct __tree<std::__value_type<TFENode, TriStateBool>, std::__map_value_compare<TFENode, std::__value_type<TFENode, TriStateBool>, std::less<TFENode>, true>, std::allocator<std::__value_type<TFENode, TriStateBool>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<TFENode, TriStateBool>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<TFENode, std::__value_type<TFENode, TriStateBool>, std::less<TFENode>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _enableStatesCache;
...
- (BOOL)cachedEnableStateForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 result:(BOOL *)a1;
...
- (void)presentLegacyGoToRelativeToNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 initialPath:(const void *)a1;
...
- (id)topBrowserOverlayStackView;
- (id)bottomBrowserOverlayStackView;
