@class FI_TNotificationCenterObserverGlue, NSString, NSImage, FI_TIconView, FI_TDesktopInlinePreviewController, NSObject, NSColor;
...
@interface FI_TIconCollectionViewController : FI_TIconOrGalleryCollectionViewController <TUpdateLayoutControllerSuspenderProtocol, TInfoExtractorDelegate, TDesktopInlinePreviewDataSource> {
    ...
    struct TriStateBool { int fState; } _hasNewDocumentButton;
...
- (void)invalidateKeyNodes:(const void *)a0 forThumbnails:(BOOL)a1;
