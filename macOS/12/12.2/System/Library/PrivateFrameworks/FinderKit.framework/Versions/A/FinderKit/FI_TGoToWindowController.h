...
@interface FI_TGoToWindowController : FI_TScriptableWindowController <NSTouchBarDelegate, TTouchBarGoToViewDelegate, NSWindowDelegate, NSTextFieldDelegate, NSMenuDelegate> {
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _initialItemsTimeoutToken;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _autoCompleteNowToken;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _autoCompleteSpinnerToken;
