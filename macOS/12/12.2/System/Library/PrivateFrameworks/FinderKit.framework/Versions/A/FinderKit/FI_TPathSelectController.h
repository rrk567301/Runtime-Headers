@class NSString, NSView, NSProgressIndicator, NSMenu, NSMenuItem, NSValue;
...
@interface FI_TPathSelectController : NSObject <NSMenuDelegate, TCoalescingNodeObserverProtocol, TMarkTornDown> {
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _slowLoadingToken;
