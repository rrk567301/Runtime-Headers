@class NSView, NSString, FI_TNodeViewSettings, NSArray, FI_TBrowserContainerController, NSValue, NSIndexSet, FI_TKeyValueObserverGlue, NSObject, FI_TNotificationCenterObserverGlue, NSSharingServicePicker, NSEvent;

@interface FI_TBaseBrowserViewController : FI_TViewController <NSDraggingSource, NSMenuItemValidation, NSSharingServiceDelegate, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TQLPreviewWindowControllerProtocol, TTypeSelectDelegate, TMarkTornDown, NSTouchBarDelegate, TFloatingInputWindowDelegateProtocol, TContextMenuDelegate> {
    ...
    struct TNSWeakPtr<FINode, void> { NSValue *fWeakObject; } _nodeToDoubleClick;
...
- (BOOL)useSpecialInFlightAnimation;
...
- (void)setMouseDownEventForDrag:(id)a0;
...
- (struct TFENode { struct OpaqueNodeRef *x0; })wellPositionedNodeFromNodes:(const void *)a0;
...
- (unsigned long long)getCommandTarget:(SEL)a0 outNodes:(void *)a1;
