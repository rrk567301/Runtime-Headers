@class TRITaskDatabase, TRIRolloutDatabase, TRISQLiteCKDatabase, TRIExperimentDatabase, TRIClient, TRIMLRuntimeEvaluationHistoryDatabase, TRIContentTracker, TRIKVStore, TRIActivationEventDatabase, TRINamespaceDatabase, TRIExperimentHistoryDatabase, TRISQLiteCKDatabaseFailureInjectionDelegate, TRIDatabase;
