@class ECSubject, NSDate, NSObject, ECMessageFlags, EMThreadObjectID, EMMailboxScope, NSString, EFFuture, NSIndexSet, EFQuery, NSArray, EMObjectID, EMMessageRepository;
