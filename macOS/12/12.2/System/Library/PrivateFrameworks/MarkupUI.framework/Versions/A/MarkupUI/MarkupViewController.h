...
@interface MarkupViewController : NSViewController <MUContentViewControllerDelegate, AKSidecarControllerDelegate, NSMenuItemValidation, NSTouchBarDelegate, NSWindowDelegate>
