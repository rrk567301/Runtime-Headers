@class TIKeyboardState, TIKeyboardTouchEvent, TIKeyboardInput, NSString, NSDate, NSMutableDictionary, NSLocale, TITypingSessionParams, NSMutableArray, TIFeatureUsageMetricsCache, TIWordEntry;
