@class _HMContext, HMFTimer, NSMutableArray, NSString, HMApplicationData, HMELastEventStore, NSArray, HMHome, NSCountedSet, NSObject, HMAccessorySettingsMetricsDispatcher, HMMutableArray, HMAccessorySetupCoordinator, NSSet, NSOperationQueue, HMCacheManager, HMCoreAnalyticsMetricEventDispatcher, HMNetworkRouterFirewallRuleManager, HMUserCloudShareManager, HMAccessory, HMXPCEventRouterClient, NSUUID, HMFUnfairLock, HMHomeManagerConfiguration, NSNumber;
@protocol HMHomeManagerDelegate, HMDarwinNotificationProvider, OS_dispatch_queue;

@interface HMHomeManager : NSObject <HMAccessorySettingsControllerFactory, HMAccessorySettingsControllerDataSource, HMAccessorySettingsDataSourceDataSource, HMAccessorySettingsMessengerFactory, HMAccessorySettingsMetricsDispatcherFactory, HMAccessorySettingsDataSourceFactory, HMCoreAnalyticsMetricEventDispatcherFactory, HMFLogging, HMFTimerDelegate, HMFMessageReceiver, HMMutableApplicationData, HMApplicationData> {
    HMFUnfairLock *_lock;
