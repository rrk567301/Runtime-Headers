@class NSDictionary, WBSWebExtensionLocalization, WBSWebExtensionContextMenuItemManager, NSMutableOrderedSet, NSBundle, WBSWebExtensionToolbarItem, NSMutableArray, NSString, NSArray, NSPointerArray, NSMutableDictionary, NSCountedSet, WKContentWorld, NSSet, WBSWebExtensionAlarmState, WBSDispatchSourceTimer, WBSWebExtensionSQLiteStore, WKWebView, NSImage, NSUUID, NSURL, NSDate, NSMapTable, NSExtension;
...
- (id)relatedInspectorForInspectorTabWithIdentifier:(id)a0;
