...
- (void)executeScriptWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)insertCSSWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)removeCSSWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 completionHandler:(id /* block */)a3;
