@class NSURL, WBSSFSearchResultAdapter, MKMapItem, SFSearchResult, WBSParsecImageRepresentation, SFFlight, NSString, WBSParsecActionButton, WBSQuerySuggestion, WBSParsecSearchMapsResultFeedbackSender, NSArray, NSNumber, WBSParsecLegacySearchResult, WBSParsecAuxiliaryInfo, WBSParsecSearchSportsAttributionExtraCompletionItem;
...
- (void).cxx_destruct;
- (id)_result;
- (void)setSelectedLegIndex:(unsigned long long)a0;
