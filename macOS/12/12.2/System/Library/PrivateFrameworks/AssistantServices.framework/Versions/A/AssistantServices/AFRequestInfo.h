@class NSUUID, NSString, NSData, SAStartRequest, SAStartLocalRequest, AFSpeechRequestOptions, NSDictionary, AFTestRequestOptions, AFRequestCompletionOptions, NSNumber;
