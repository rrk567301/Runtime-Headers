...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })uniformPadRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 widthPadding:(float)a1 heightPadding:(float)a2 width:(unsigned long long)a3 height:(unsigned long long)a4;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })aspectRatioPaddedRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 expectedWidth:(unsigned long long)a1 height:(unsigned long long)a2 orientation:(unsigned int)a3;
