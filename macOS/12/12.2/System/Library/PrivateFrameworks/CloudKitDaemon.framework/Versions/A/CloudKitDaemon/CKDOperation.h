@class CKDURLRequest, NSMutableDictionary, NSNumber, NSDate, CKDOperationMetrics, NSObject, NSMutableArray, NSString, CKOperationMMCSRequestOptions, CKDContainer, CKOperationMetrics, CKOperationInfo, NSError, CKDLogicalDeviceContext;
