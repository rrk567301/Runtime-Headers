@class NSDate, NSString, NSURL, NSData, NSArray, NSMutableDictionary, NSDictionary, IMConnectionMonitor, IMRemoteURLConnection, NSObject, NSNumber, NSMutableURLRequest;
