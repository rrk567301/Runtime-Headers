@class NSDictionary, WBTab, BrowserWindowController, ContinuousReadingListViewController, FormTextStatusWatcher, NSMutableArray, NSString, UnifiedTabBarItem, NSArray, NSTimer, NSColor, NSSet, BrowserTabViewController, SearchState, BrowserViewController, WBSTranslationContext, DelayedPopUpRolloverImageButton, NSImage, WKWebView, NSUUID, NSURL, NSDate, TabContentViewController;
@protocol WBSWebExtensionWindow, ThumbnailSnapshotProviding;

@interface BrowserTabViewItem : NSTabViewItem <DelayedPopUpRolloverImageButtonDelegate, WBReusableTab, FormTextStatusWatcherDelegate, TabBarViewItem, WBSOrderedTab, WBSWebExtensionTab> {
...
- (void)_tryToReload;
- (void)transferContentToPlaceholderTab:(id)a0;
