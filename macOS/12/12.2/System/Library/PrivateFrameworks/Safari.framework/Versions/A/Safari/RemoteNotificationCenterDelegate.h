@class SafariNotificationAgentDelegate, NSString, NSArray, NSURL, NSDate, NSUserNotificationCenter, NSMutableSet;

@interface RemoteNotificationCenterDelegate : NSObject <_NSUserNotificationCenterDelegatePrivate> {
    NSMutableSet *_requests;
    struct RetainPtr<RemoteNotificationCenterRequest> { void *m_ptr; } _pendingCenterRequest;
