@class NSTimer, NSString, NSAttributedString, BrowserViewController, ContinuousReadingBannerLayer, FlippedView, NSMutableArray, NSImage, ReaderViewController, WebViewController;
