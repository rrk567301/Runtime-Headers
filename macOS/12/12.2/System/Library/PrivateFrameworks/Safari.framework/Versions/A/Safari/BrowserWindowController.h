...
- (void)installSidebarWithCompletionHandler:(id /* block */)a0;
...
- (void)_createTabWithTabGroupTab:(id)a0 atIndex:(unsigned long long)a1;
...
- (unsigned long long)numberOfTabsForFunctionBarProvider:(id)a0;
- (id)functionBarProvider:(id)a0 thumbnailProviderForTabAtIndex:(unsigned long long)a1;
- (id)functionBarProvider:(id)a0 accessibilityDescriptionForTabAtIndex:(unsigned long long)a1;
