...
@interface DownloadsManager : NSObject <DownloadProgressEntryDelegate, PassFileDownloadDelegate, AuthenticationSheetRequestDelegate, DownloadAlertsManagerDataSource, DownloadViewControllerDataSource, DownloadViewControllerDelegate, _WKDownloadDelegate> {
    ...
    NSMutableSet *_entriesPendingDefaultDownloadLocationRequest;
...
@property (retain, nonatomic) NSURL *cachedDownloadLocationURL;
...
- (void)startDownloadForRequest:(id)a0 suggestedFilename:(id)a1 downloadLocationRequestType:(long long)a2 shouldAvoidPersistingIdentifyingInformation:(BOOL)a3 originatingWebView:(id)a4;
