...
- (void)didAllowAccessToOneSiteForExtension:(id)a0;
...
- (id)_inspectorForInspectorTabWithIdentifier:(id)a0;
...
- (BOOL)hasAllowedAccessToOneSiteForExtension:(id)a0;
- (void)extension:(id)a0 didShowInspectorTabWithIdentifier:(id)a1;
- (void)extension:(id)a0 didHideInspectorTabWithIdentifier:(id)a1;
