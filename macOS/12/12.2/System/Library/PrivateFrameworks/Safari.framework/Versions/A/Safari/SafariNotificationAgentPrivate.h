...
@interface SafariNotificationAgentPrivate : NSObject <SafariNotificationAgent, RemoteNotificationVerificationRequestProxyDelegate> {
    struct HashMap<unsigned long long, WTF::RetainPtr<RemoteNotificationVerificationRequestProxy>, WTF::DefaultHash<unsigned long long>, WTF::HashTraits<unsigned long long>, WTF::HashTraits<WTF::RetainPtr<RemoteNotificationVerificationRequestProxy>>, WTF::HashTableTraits> { struct HashTable<unsigned long long, WTF::KeyValuePair<unsigned long long, WTF::RetainPtr<RemoteNotificationVerificationRequestProxy>>, WTF::KeyValuePairKeyExtractor<WTF::KeyValuePair<unsigned long long, WTF::RetainPtr<RemoteNotificationVerificationRequestProxy>>>, WTF::DefaultHash<unsigned long long>, WTF::HashMap<unsigned long long, WTF::RetainPtr<RemoteNotificationVerificationRequestProxy>>::KeyValuePairTraits, WTF::HashTraits<unsigned long long>> { union { void *m_table; unsigned int *m_tableForLLDB; } ; } m_impl; } _pendingRequests;
}
