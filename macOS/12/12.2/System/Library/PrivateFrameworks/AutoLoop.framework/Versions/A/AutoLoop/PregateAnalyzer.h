...
- (BOOL)findNextUsableFrameFromIndex:(long long)a0 backwards:(BOOL)a1 inFrameInfoArray:(id)a2 toValue:(long long *)a3;
- (BOOL)findSurroundingUsableFramesForIndex:(long long)a0 inFrameInfoArray:(id)a1 prevIndex:(long long *)a2 nextIndex:(long long *)a3;
...
- (int)processPresentationTimesFromData:(id)a0 toBadFrameFlags:(id)a1 withMaxDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 firstIndex:(long long)a3 lastIndex:(long long)a4;
