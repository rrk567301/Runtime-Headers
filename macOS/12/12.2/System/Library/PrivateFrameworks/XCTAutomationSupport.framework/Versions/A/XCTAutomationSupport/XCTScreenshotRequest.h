...
@property (readonly) unsigned int screenID;
...
- (void).cxx_destruct;
- (id)initWithScreenID:(unsigned int)a0 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 encoding:(id)a2;
