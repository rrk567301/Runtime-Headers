...
@interface GEOTrafficSignal : PBCodable <NSCopying> {
    ...
    int _type;
    struct { unsigned char has_type : 1; unsigned char read_unknownFields : 1; unsigned char read_identifier : 1; unsigned char read_position : 1; unsigned char wrote_anyField : 1; } _flags;
}
