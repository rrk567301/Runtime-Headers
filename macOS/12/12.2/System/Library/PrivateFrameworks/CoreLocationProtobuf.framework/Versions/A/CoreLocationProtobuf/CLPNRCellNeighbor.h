@interface CLPNRCellNeighbor : PBCodable <NSCopying> {
    struct { unsigned char bandwidth : 1; unsigned char ecn0 : 1; unsigned char nrarfcn : 1; unsigned char pid : 1; unsigned char rscp : 1; unsigned char rssi : 1; unsigned char saOrNsaNeighbor : 1; unsigned char scs : 1; } _has;
}
