@class NSDictionary, NSArray, NSString, NSMutableDictionary, NSDate, AWDHomeKitVendorInformation, NSUUID;

@interface HMDCharacteristicReadWriteLogEvent : HMMLogEvent <HMDBiomeLogEvent, HMDCoreDuetLogEvent, HMDAWDLogEvent, HMMCoreAnalyticsLogging>
