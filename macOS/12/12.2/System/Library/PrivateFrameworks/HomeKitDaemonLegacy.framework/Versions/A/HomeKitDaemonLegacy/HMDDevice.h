@class NSUUID, NSString, NSArray, HMDDeviceCapabilities, NSData, HMDHomeKitVersion, HMFUnfairLock, HMFProductInfo, NSSet, HMDAccount, HMFNetService, HMDRPIdentity;
