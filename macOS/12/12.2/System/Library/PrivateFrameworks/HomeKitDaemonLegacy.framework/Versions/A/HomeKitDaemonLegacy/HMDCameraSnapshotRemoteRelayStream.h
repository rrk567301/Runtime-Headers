...
- (id)initWithSessionID:(id)a0 workQueue:(id)a1 options:(id)a2 device:(id)a3 accessory:(id)a4 delegate:(id)a5 delegateQueue:(id)a6 uniqueIdentifier:(id)a7 snapshotRequestHandler:(id)a8 residentMessageHandler:(id)a9;
