@class CNContactAvatarPersistenceHelper, CNLikenessEditorPresentationController, CNRecentLikenessesViewController, NSString, CNUIMeContactMonitor, CNContact, AKCardViewDataSource, CNLikeness, CNAvatarViewController;
