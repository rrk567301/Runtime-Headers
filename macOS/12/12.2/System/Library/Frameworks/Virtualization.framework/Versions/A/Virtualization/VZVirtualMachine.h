@class _VZDebugStub, NSArray, NSString, VZVirtualMachineConfiguration, NSObject;
...
@interface VZVirtualMachine : NSObject {
    ...
    struct unique_ptr<VzShared::Messenger, std::default_delete<VzShared::Messenger>> { struct __compressed_pair<VzShared::Messenger *, std::default_delete<VzShared::Messenger>> { struct Messenger *__value_; } __ptr_; } _messenger;
