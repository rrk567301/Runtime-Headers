...
@interface VZVirtioSocketDevice : VZSocketDevice {
    ...
    struct map<unsigned int, VZVirtioSocketListener *, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, VZVirtioSocketListener *>>> { struct __tree<std::__value_type<unsigned int, VZVirtioSocketListener *>, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, VZVirtioSocketListener *>, std::less<unsigned int>, true>, std::allocator<std::__value_type<unsigned int, VZVirtioSocketListener *>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<unsigned int, VZVirtioSocketListener *>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, VZVirtioSocketListener *>, std::less<unsigned int>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _listeners;
...
- (void)_didOpenGuestVirtioSocketWithAddress:(struct Address { unsigned int x0; unsigned int x1; })a0 success:(BOOL)a1;
- (void)_openHostVirtioWithIdentifier:(unsigned long long)a0 socket:(struct VirtioSocket { struct Address { unsigned int x0; unsigned int x1; } x0; struct FileDescriptor { int x0; } x1; })a1;
