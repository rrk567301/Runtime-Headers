...
@protocol OS_dispatch_queue, OS_xpc_object, _VZCustomVirtioDeviceDelegate;
...
@interface _VZCustomVirtioDevice : NSObject {
    ...
    struct BitSet<unsigned int, 64> { struct array<unsigned int, 2> { unsigned int __elems_[2]; } _blocks; } _driverFeatures;
