...
- (struct variant<VzCore::VirtualMachineConfiguration::SocketDevices::Virtio> { struct __impl<VzCore::VirtualMachineConfiguration::SocketDevices::Virtio> { union __union<std::__variant_detail::_Trait::_TriviallyAvailable, 0, VzCore::VirtualMachineConfiguration::SocketDevices::Virtio> { char x0; struct __alt<0, VzCore::VirtualMachineConfiguration::SocketDevices::Virtio> { struct Virtio { unsigned long long x0; } x0; } x1; union __union<std::__variant_detail::_Trait::_TriviallyAvailable, 1> { } x2; } x0; unsigned int x1; } x0; })_socketDeviceWithIdentifier:(unsigned long long)a0;
