@class CLSQuerySpecification, NSString, CLSSearchSpecification, NSDate, NSMutableArray;
...
+ (id)queryWithObjectType:(Class)a0 querySpecification:(id)a1 error:(id *)a2;
...
- (id)initWithObjectType:(Class)a0 querySpecification:(id)a1 error:(id *)a2;
