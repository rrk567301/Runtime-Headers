@class NSAccessibilityWeakReferenceContainer, NSCollectionViewHeaderAccessibility, NSArray, NSCollectionViewFooterAccessibility, NSCollectionViewAccessibilityHelper, NSCollectionView;
