...
- (void)_runOpenDocumentTestWithTestName:(id)a0 options:(id)a1;
- (void)_runCloseDocumentTestWithTestName:(id)a0 options:(id)a1;
- (void)_runResizeTestWithTestName:(id)a0 options:(id)a1;
- (void)_runScrollTestWithTestName:(id)a0 options:(id)a1;
- (void)_runActivationTestWithTestName:(id)a0 options:(id)a1;
- (BOOL)_applySandboxExtensionFromBookmarkForTestName:(id)a0 options:(id)a1;
- (id)_previouslyOpenedDocumentForTestWithTestName:(id)a0 options:(id)a1;
