@class NSString, NSArray, LPCaptionBarPresentationProperties, LPVideo, LPARAsset, LPImagePresentationProperties, NSColor, LPInlineMediaPlaybackInformation, LPImage, LPAudio, NSNumber;
