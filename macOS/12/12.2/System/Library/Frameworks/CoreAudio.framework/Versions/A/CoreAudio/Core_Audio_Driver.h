...
@property (nonatomic) struct shared_ptr<std::unordered_map<AMCP::Portal::IPC::io_messenger_id_t, std::shared_ptr<AMCP::Portal::IPC::IO_Receiver>>> { void *__ptr_; struct __shared_weak_count *__cntrl_; } registered_io_receivers;
...
- (void)start_synchronous_messenger:(unsigned int)a0 client_id:(unsigned int)a1 nominal_sample_rate:(double)a2 io_buffer_frame_size:(unsigned int)a3 reply:(id /* block */)a4;
...
- (void)add_device_client:(unsigned int)a0 client_info:(id)a1 io_messenger:(id)a2 work_group:(id)a3 reply:(id /* block */)a4;
...
- (int)create_io_receiver:(unsigned int)a0 client_id:(unsigned int)a1 io_messenger:(id)a2 work_group:(id)a3;
...
- (void)release_cf_object_from_qualifier_data:(id)a0 property_identity:(struct Driver_Property_Identity { unsigned int x0; int x1; struct AudioObjectPropertyAddress { unsigned int x0; unsigned int x1; unsigned int x2; } x2; })a1;
- (void)release_cf_object_from_property_data:(id)a0 property_identity:(struct Driver_Property_Identity { unsigned int x0; int x1; struct AudioObjectPropertyAddress { unsigned int x0; unsigned int x1; unsigned int x2; } x2; })a1;
- (struct tuple<NSData *, unsigned int> { struct __tuple_impl<std::__tuple_indices<0, 1>, NSData *, unsigned int> { id x0; unsigned int x1; } x0; })unpack_data_from_qualifier:(struct Driver_Property_Identity { unsigned int x0; int x1; struct AudioObjectPropertyAddress { unsigned int x0; unsigned int x1; unsigned int x2; } x2; })a0 qualifier:(id)a1;
- (struct tuple<NSData *, unsigned int> { struct __tuple_impl<std::__tuple_indices<0, 1>, NSData *, unsigned int> { id x0; unsigned int x1; } x0; })unpack_data_from_value:(struct Driver_Property_Identity { unsigned int x0; int x1; struct AudioObjectPropertyAddress { unsigned int x0; unsigned int x1; unsigned int x2; } x2; })a0 value:(id)a1;
