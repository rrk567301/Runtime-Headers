...
- (void)provideItemAtURL:(id)a0 forClaimWithID:(id)a1 madeByClientWithProcessIdentifier:(int)a2 options:(unsigned long long)a3 kernelInfo:(id)a4 completionHandler:(id /* block */)a5;
...
- (void)_makeProvider:(id)a0 provideItemAtURL:(id)a1 options:(unsigned long long)a2 forAccessClaimWithID:(id)a3 processIdentifier:(int)a4 kernelInfo:(id)a5 completionHandler:(id /* block */)a6;
