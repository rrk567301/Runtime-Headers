...
@property (readonly, nonatomic) struct LSApplicationParameters_V1 { long long x0; unsigned int x1; struct FSRef *x2; void *x3; struct __CFDictionary *x4; struct __CFArray *x5; struct AEDesc *x6; struct __CFArray *x7; struct __CFURL *x8; struct ProcessSerialNumber *x9; } *applicationParametersMutable;

- (id)init;
- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (void).cxx_destruct;
- (id)initWithApplicationParameters_V1:(const struct LSApplicationParameters_V1 { long long x0; unsigned int x1; struct FSRef *x2; void *x3; struct __CFDictionary *x4; struct __CFArray *x5; struct AEDesc *x6; struct __CFArray *x7; struct __CFURL *x8; struct ProcessSerialNumber *x9; } *)a0;
