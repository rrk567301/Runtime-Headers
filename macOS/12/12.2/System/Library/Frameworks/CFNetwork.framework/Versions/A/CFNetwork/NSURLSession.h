@class NSUUID, NSString, __CFN_SessionMetrics, NSOperationQueue, NSDictionary, __NSCFURLSessionDelegateWrapper, NSObject, NSMutableDictionary, __CFN_ConnectionContextManager, NSURLSessionConfiguration;
