@class NSURL, FPItem, NSDate, NSDictionary, NSFileProviderItemVersion, NSString, NSSet, NSPersonNameComponents, NSArray, NSData, NSNumber, UTType, NSError;
...
- (id)providerID;
- (id)initWithOriginalDocumentItem:(id)a0 alternateContentsURL:(id)a1;
