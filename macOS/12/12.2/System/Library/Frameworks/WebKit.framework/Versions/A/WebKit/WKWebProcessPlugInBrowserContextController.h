@class WKDOMRange, NSString, WKBrowsingContextHandle, WKWebProcessPlugInPageGroup, WKWebProcessPlugInFrame, _WKRemoteObjectRegistry, WKDOMDocument;
...
@interface WKWebProcessPlugInBrowserContextController : NSObject <WKObject> {
    struct ObjectStorage<WebKit::WebPage> { struct type { unsigned char __lx[1440]; } data; } _page;
