...
@interface WKWebsiteDataStore : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebsiteDataStore> { struct type { unsigned char __lx[200]; } data; } _websiteDataStore;
...
- (void)_statisticsDatabaseColumnsForTable:(id)a0 completionHandler:(id /* block */)a1;
