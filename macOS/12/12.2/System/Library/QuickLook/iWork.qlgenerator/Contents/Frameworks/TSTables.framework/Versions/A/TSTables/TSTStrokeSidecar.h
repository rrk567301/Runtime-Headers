...
- (void)accumulateCellBordersConcurrently:(struct vector<TSTCell *, std::allocator<TSTCell *>> { id *x0; id *x1; struct __compressed_pair<TSTCell *__strong *, std::allocator<TSTCell *>> { id *x0; } x2; })a0 inRow:(struct TSUModelRowIndex { unsigned int x0; })a1 atColumns:(void *)a2;
