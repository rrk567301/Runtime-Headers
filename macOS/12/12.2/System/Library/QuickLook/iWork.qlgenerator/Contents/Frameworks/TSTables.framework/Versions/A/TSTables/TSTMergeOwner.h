@class TSCECalculationEngine, TSTMergeChangeDistributor, NSString, TSCellRangeCache, TSTTableModel, TSTFormulaStore;

@interface TSTMergeOwner : NSObject <TSCEFormulaOwning>

@property (retain, nonatomic) TSCellRangeCache *mergeRangeCache;
