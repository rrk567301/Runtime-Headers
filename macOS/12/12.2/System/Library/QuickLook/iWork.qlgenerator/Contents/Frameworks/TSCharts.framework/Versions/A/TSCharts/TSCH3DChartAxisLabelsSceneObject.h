...
- (void)p_renderLabels:(id)a0 labelType:(int)a1 part:(id)a2 positioner:(id)a3 offset:(const void *)a4 offset2DBlock:(id /* block */)a5 strideBlock:(id /* block */)a6 skipFirst:(BOOL)a7 showLast:(BOOL)a8;
...
- (void)p_setOffset:(const void *)a0 forLabelType:(int)a1 pipeline:(id)a2 part:(id)a3 positioner:(id)a4;
