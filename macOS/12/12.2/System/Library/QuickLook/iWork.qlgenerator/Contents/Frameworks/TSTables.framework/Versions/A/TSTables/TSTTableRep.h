@class TSTLayout, NSObject, TSTCellRegionGatherer, TSTAnimation, NSMutableArray, TSTCellSelection, TSTLayoutEngine, NSString, NSSet, TSTSelectionDragController, CAShapeLayer, TSTTableReferences, TSTTableInfo;
