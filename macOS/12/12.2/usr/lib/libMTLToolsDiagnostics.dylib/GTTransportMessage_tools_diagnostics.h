@class GTTransport_tools_diagnostics, NSData, NSDictionary;

@interface GTTransportMessage_tools_diagnostics : NSObject <NSCopying> {
    id _decodedPayload;
    unsigned int _decodedPayloadType;
}

@property (readonly, retain, nonatomic) GTTransport_tools_diagnostics *transport;
