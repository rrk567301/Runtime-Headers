...
- (struct opaqueCMSampleBuffer { } *)resizeSampleBuffer:(struct opaqueCMSampleBuffer { } *)a0;
- (void)drainResizedSampleBuffersExpiredBefore:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0;
