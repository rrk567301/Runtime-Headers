...
+ (id)logCategory;
+ (id)updatePersonEventWithPersonEvent:(id)a0 torsoAnnotation:(id)a1 sessionEntityUUID:(id)a2 predictedLinkedEntityUUIDs:(id)a3 sessionEntityAssignment:(long long)a4;
