...
- (id)dueDate;
- (BOOL)isTopHit;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[3]; unsigned long long x2[3]; unsigned long long x3[3]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[3]; unsigned long long x2[3]; unsigned long long x3[3]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2;
- (long long)compare:(id)a0 currentTime:(double)a1;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[3]; unsigned long long x2[3]; unsigned long long x3[3]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isMetadataResult:(BOOL)a4;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[3]; unsigned long long x2[3]; unsigned long long x3[3]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isMetadataResult:(BOOL)a4 isServerAlternativeResult:(BOOL)a5;
