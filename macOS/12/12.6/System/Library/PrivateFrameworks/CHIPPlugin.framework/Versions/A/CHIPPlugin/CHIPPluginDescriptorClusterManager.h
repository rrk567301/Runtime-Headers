...
- (void)_verifyHAPCharacteristicSupportAtCHIPEndpoint:(id)a0 device:(id)a1 callbackQueue:(id)a2 clusterClassToQueryForFeatureMap:(id)a3 hapServicesToCheckForFeatureMap:(id)a4 deviceTopology:(id)a5 clusterFeatureMapValue:(id)a6 lastError:(id)a7 completionHandler:(id /* block */)a8;
...
- (id)hapServiceDescriptionForServiceType:(id)a0 clustersInUse:(id)a1 endpoint:(id)a2 hapToCHIPClusterMapping:(id)a3 clusterClassToQueryForFeatureMap:(id)a4 hapServicesToCheckForFeatureMap:(id)a5;
- (void)_removeDisabledCharacteristicsFromServiceDescription:(id)a0 endpoint:(id)a1 topology:(id)a2;
- (void)fetchHAPServicesAtCHIPEndpoint:(id)a0 deviceTopology:(id)a1 accessoryInfo:(id)a2 hapToCHIPClusterMapping:(id)a3 device:(id)a4 isABridge:(BOOL)a5 callbackQueue:(id)a6 completionHandler:(id /* block */)a7;
