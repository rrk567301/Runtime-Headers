...
- (void)_dispatchEventPayloadWithPreferenceName:(id)a0 activeInputModes:(id)a1 currentValue:(id)a2 previousValue:(id)a3 changedAt:(id)a4 analyzedAt:(id)a5 buildAtChange:(id)a6 isFreshInstall:(BOOL)a7 approxDateOfBuildInstall:(id)a8 buildAtLastAnalysis:(id)a9;
