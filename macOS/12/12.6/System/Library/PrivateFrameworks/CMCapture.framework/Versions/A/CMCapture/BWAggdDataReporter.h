...
- (void)_incrementAggdScalarKey:(id)a0 withValue:(long long)a1;
- (id)_aggdPearlInfraredProjectorUptimeStringFromCurrent:(int)a0 pattern:(int)a1 applicationID:(id)a2;
- (void)_pushValue:(double)a0 aggdDistributionKey:(id)a1;
...
- (void)_setAggdScalarKey:(id)a0 withValue:(long long)a1;
- (id)_captureTypeStringWithPrimaryCaptureType:(int)a0 secondaryCaptureType:(int)a1 captureFlags:(unsigned long long)a2 sceneFlags:(unsigned long long)a3;
