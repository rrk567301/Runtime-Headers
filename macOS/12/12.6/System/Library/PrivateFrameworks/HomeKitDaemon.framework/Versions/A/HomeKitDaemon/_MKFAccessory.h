@class _MKFApplicationData, Protocol, NSPredicate, _MKFRoom, _MKFAssistantAccessControl, _MKFSoftwareUpdate, MKFAccessoryDatabaseID, NSDate, NSString, NSSet, NSArray, NSData, _MKFHome, NSNumber, NSUUID;
