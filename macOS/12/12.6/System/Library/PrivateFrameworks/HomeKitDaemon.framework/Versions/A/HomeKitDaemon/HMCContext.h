...
+ (id)findAnnounceUserSettingsWithModelID:(id)a0 error:(id *)a1;
+ (id)findAnnounceUserSettingsWithDatabaseID:(id)a0;
+ (id)findAnnounceUserSettingsWithDatabaseID:(id)a0 error:(id *)a1;
+ (id)findAnnounceUserSettingsWithModelID:(id)a0;
...
+ (id)findAppleMediaAccessoryResidentWithModelID:(id)a0 error:(id *)a1;
+ (id)findAppleMediaAccessoryResidentWithDatabaseID:(id)a0;
+ (id)findAppleMediaAccessoryResidentWithDatabaseID:(id)a0 error:(id *)a1;
+ (id)findAppleMediaAccessoryResidentWithModelID:(id)a0;
