...
- (void)retrieveCurrentStateForIdentifer:(id)a0 stateNumber:(id *)a1 isReachable:(BOOL *)a2 linkQuality:(unsigned long long *)a3 lastSeen:(id *)a4;
...
- (void)_updateBrowsersForDiscoveryRemoteChange;
