...
- (id)initWithType:(long long)a0 accountId:(id)a1 objectId:(id)a2 preferredSize:(struct CGSize { double x0; double x1; })a3 scale:(double)a4 appearance:(unsigned long long)a5 isRTL:(BOOL)a6 contentSizeCategory:(id)a7 hasBoldText:(BOOL)a8 hasButtonShapes:(BOOL)a9 hasDarkerSystemColors:(BOOL)a10;
