...
- (id).cxx_construct;
- (BOOL)hasLabel;
- (struct Matrix<double, 3, 1> { double x0[3]; })worldPointWithContext:(const struct NavContext { void /* function */ **x0; struct LabelManager *x1; struct MapNavLabeler *x2; struct LabelLayoutContext *x3; struct LabelNavLayoutContext *x4; } *)a0;
