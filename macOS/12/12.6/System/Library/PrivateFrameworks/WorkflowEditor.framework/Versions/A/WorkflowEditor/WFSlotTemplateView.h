@class NSFont, WFSlotIdentifier, NSArray, NSTextContainer, NSString, WFSlotTemplateTypingTextView, NSMutableDictionary, WFSlotTemplateTextStorage, NSColor, NSParagraphStyle, WFSlotTemplateLayoutManager;
