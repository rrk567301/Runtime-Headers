@class CSTrialAssetManager, NSString, CSLanguageCodeUpdateMonitor, NSMutableDictionary, CSVoiceTriggerAssetDownloadMonitor, CSFirstUnlockMonitor, CSAsset, CSAssetManager, CSTrialAssetDownloadMonitor;
