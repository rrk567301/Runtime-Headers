...
+ (id)matchingSpanFromSpanMatch:(id)a0 withItemInfo:(id)a1 rankScore:(float)a2;
+ (id)matchingSpanFromSpanMatch:(id)a0 withItemInfo:(id)a1 rankScore:(float)a2 priorInfo:(id)a3;
