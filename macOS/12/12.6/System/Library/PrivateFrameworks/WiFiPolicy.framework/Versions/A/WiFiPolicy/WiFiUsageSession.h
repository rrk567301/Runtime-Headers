...
- (void)roamingStateDidChange:(BOOL)a0 flags:(unsigned long long)a1 scannedChannelCount:(unsigned long long)a2 reason:(unsigned long long)a3 latency:(unsigned long long)a4 andStatus:(unsigned long long)a5 andPingPongNth:(unsigned long long)a6;
