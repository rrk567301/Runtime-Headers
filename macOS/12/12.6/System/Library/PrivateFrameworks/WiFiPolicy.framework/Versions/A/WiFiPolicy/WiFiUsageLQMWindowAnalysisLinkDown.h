...
- (id)initWithRollingWindow:(id)a0 WithIsInvoluntary:(BOOL)a1 AndLinkChangeReason:(long long)a2 AndLinkChangeSubreason:(long long)a3 AndDuration:(unsigned long long)a4 andActiveCall:(BOOL)a5 onQueue:(id)a6;
