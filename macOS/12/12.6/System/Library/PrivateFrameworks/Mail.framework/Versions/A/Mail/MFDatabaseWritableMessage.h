...
- (long long)_globalIDForMessageIDHeaderHash:(id)a0 globalMessageIDsCache:(id)a1 cacheIsExhaustive:(BOOL)a2;
...
- (BOOL)updateFieldsFromMessage:(id)a0 subjectRowIDsCache:(id)a1 globalMessageIDsCache:(id)a2 addressRowIDsCache:(id)a3 cacheIsExhaustive:(BOOL)a4;
