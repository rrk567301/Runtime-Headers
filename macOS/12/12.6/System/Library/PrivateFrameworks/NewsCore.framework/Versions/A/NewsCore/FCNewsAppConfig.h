@class FCWidgetConfig, FCForYouGroupsConfiguration, NSDate, NSDictionary, FCIAdConfiguration, FCPaidBundleConfiguration, FCAppReviewRequestConfig, FCSmarterMessagingConfig, FCLaunchPresentationConfig, NSString, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, NTPBDiscoverMoreVideosInfo, FCPrefetchConfiguration, FCTopStoriesConfiguration, NSArray, FCVideoGroupsConfig, NSNumber, FCEmbedProxyConfiguration, FCPersonalizationTreatment;
...
@property (readonly, nonatomic) BOOL flexiblePaywallsEnabled;
@property (readonly, nonatomic) BOOL smarterMessagingEnabled;
@property (readonly, nonatomic) BOOL engagementUpsellEnabled;
@property (readonly, nonatomic) BOOL appReviewRequestEnabled;
@property (readonly, nonatomic) BOOL inAppMessagesEnabled;
@property (readonly, nonatomic) BOOL isContinueReadingEnabled;
@property (readonly, nonatomic) BOOL isCardFeedRedesignEnabled;
@property (readonly, nonatomic) BOOL isEndOfArticleRedesignEnabled;
