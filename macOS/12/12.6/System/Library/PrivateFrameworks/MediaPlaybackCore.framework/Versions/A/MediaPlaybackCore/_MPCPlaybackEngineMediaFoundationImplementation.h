@class MPCPlayPerfAnalytics, MPCItemBookmarker, MPCAVItemTrace, MPCLeaseController, NSDictionary, MPCExternalPlaybackControllerImplementation, NSString, MPAVItem, MPCPlaybackEngine, AVPlayerViewController, MPCPlayerItemConfigurator, MPCErrorControllerImplementation, _MPCAudioSessionController, MPCMediaFoundationTranslator;
