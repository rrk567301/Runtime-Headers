...
@protocol MPCQueueControllerDataSourceStateRestoring, MPCQueueControllerDataSource;
...
@property (readonly, nonatomic) id<MPCQueueControllerDataSource, MPCQueueControllerDataSourceStateRestoring> dataSource;
