...
+ (void)initialize;
+ (id)_stringForFormatDescription:(struct opaqueCMFormatDescription { } *)a0 centerStageSupported:(BOOL)a1 backgroundBlurSupported:(BOOL)a2 frameRateRanges:(id)a3;
+ (id)deviceFormatWithFormatDescription:(const struct opaqueCMFormatDescription { } *)a0 supportedFrameRateRanges:(id)a1 centerStageSupported:(BOOL)a2 backgroundBlurSupported:(BOOL)a3 autoFocusSystem:(long long)a4;
...
- (id)initWithFormatDescription:(const struct opaqueCMFormatDescription { } *)a0 supportedFrameRateRanges:(id)a1 centerStageSupported:(BOOL)a2 backgroundBlurSupported:(BOOL)a3 autoFocusSystem:(long long)a4;
