...
+ (void)_asyncExtractFromExtensionItem:(id)a0 wantsTextItems:(BOOL)a1 wantsFileURLItems:(BOOL)a2 wantsDistantURLs:(BOOL)a3 wantsImages:(BOOL)a4 treatImagesAsFileURLItems:(BOOL)a5 completionHandler:(id /* block */)a6;
