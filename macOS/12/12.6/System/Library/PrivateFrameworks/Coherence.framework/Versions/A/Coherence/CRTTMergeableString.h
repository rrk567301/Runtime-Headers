@class NSObject, NSUUID, CRContext, ObjCVersion, ObjCReplica;
...
- (void *)getSubstringBeforeTopoID:(struct TopoID { struct TopoReplica { id x0; unsigned int x1; } x0; unsigned int x1; })a0;
- (void)getSubstrings:(void *)a0 forTopoIDRange:(struct TopoIDRange { struct TopoID { struct TopoReplica { id x0; unsigned int x1; } x0; unsigned int x1; } x0; unsigned int x1; })a1;
...
- (void)saveSubstrings:(void *)a0 encoder:(id)a1;
