@class NSURL, PKPaymentInstallmentConfiguration, PKPaymentMerchantSession, NSDate, AKAppleIDAuthenticationContext, PKContact, NSTimeZone, NSString, NSSet, PKShippingMethods, PKApplePayTrustSignatureRequest, NSArray, NSData;
