@class NSString, PXPhotoLibraryLocalDefaults, NSArray, PXNavigationListItemDataSectionManager, NSOperationQueue, PHPhotoLibrary, NSMutableDictionary, PXOutlineDataSectionManager, NSMapTable, PXDataSectionManager;
