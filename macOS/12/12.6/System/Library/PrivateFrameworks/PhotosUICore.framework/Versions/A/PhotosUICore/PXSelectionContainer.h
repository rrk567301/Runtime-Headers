@class PXSelectionSnapshot, NSUndoManager, NSString, PHCollection;
...
- (id)init;
- (void).cxx_destruct;
- (id)initWithSelectionSnapshot:(id)a0 collection:(id)a1 undoManager:(id)a2 context:(unsigned long long)a3;
- (id)initWithContent:(id)a0 collection:(id)a1 undoManager:(id)a2 context:(unsigned long long)a3;
...
- (id)initWithSelectionSnapshot:(id)a0 undoManager:(id)a1 context:(unsigned long long)a2;
- (id)initWithContent:(id)a0 undoManager:(id)a1 context:(unsigned long long)a2;
