...
@interface NSTextLayoutManager : NSObject <NSTextViewportElementProvider, NSSecureCoding, NSTextSelectionDataSource> {
    ...
    struct { id x0; double x1; BOOL x2; BOOL x3; } *_activeEnumerationCache;
    BOOL _isProcessingRenderingAttributesMethod;
    struct { NSTextContainer *textContainer; NSTextRange *textRange; NSMapTable *layoutFragmentTable; struct CGRect { struct CGPoint { double x; double y; } origin; struct CGSize { double width; double height; } size; } usageBounds; layoutFragmentsHint **layoutFragments; layoutFragmentsCount **x0; unsigned long long x1; unsigned long long layoutFragmentsSize; unsigned long long layoutFragmentsGapIndex; BOOL layoutFragmentsValid; BOOL forPositionQuery; } _lastTextContainerEntry;
