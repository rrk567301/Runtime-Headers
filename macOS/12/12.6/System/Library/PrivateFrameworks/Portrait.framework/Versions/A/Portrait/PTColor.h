...
+ (struct half3x4 { struct half4 { void /* unknown type, blank encoding */ x0[4]; } x0[3]; })float4x4ToTransposed3x4:(struct { void /* unknown type, empty encoding */ x0[4]; })a0;
+ (struct half3x4 { struct half4 { void /* unknown type, blank encoding */ x0[4]; } x0[3]; })colorMatrixAndBiasTransposedFor:(int)a0 toRGB:(BOOL)a1 fullRange:(BOOL)a2 colorYCbCrDepth:(int)a3;
...
- (int)convertRGBLinearFromDestination:(id)a0 renderRequest:(id)a1 outRGBA:(id)a2;
