...
@protocol OS_dispatch_queue, HMUserActionPredictionProviderDataSource;
...
- (id)initWithWorkQueue:(id)a0 messageDispatcher:(id)a1 UUID:(id)a2 dataSource:(id)a3 duetDataSource:(id)a4 predictionTransformer:(id)a5;
