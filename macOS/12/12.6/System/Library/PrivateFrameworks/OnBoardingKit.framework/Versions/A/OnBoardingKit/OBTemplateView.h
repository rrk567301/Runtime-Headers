@class NSStackView, OBAnimationView, NSDictionary, OBTemplatePartLinkButton, NSScrollView, OBPrivacyLinkController, NSImageView, NSButton, NSImage, NSString, NSArray, NSView, NSTextField, NSColor;
