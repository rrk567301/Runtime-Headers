@class NSDictionary, NSNumber, NSURLRequest, NSURLSession, NSURL, NSMutableArray, NSString, NSMutableSet, CKDTrafficLogger, CKDTapToRadarRequest, NSError, CKDContainer, CKDFlowControlManager, NSMutableDictionary, NSArray, NSInputStream, CKDProtobufStreamWriter, NSObject, NSData, CKDResponseBodyParser, NSURLSessionDataTask, C2RequestOptions, NSHTTPURLResponse, CKDOperation, NSDate, CKDProtocolTranslator, CKSignpost, CKDOperationMetrics;
