@class NSString, GEOARInfo, GEOEVChargingInfo, PBUnknownFields, GEOPBTransitArtwork, GEOLatLng, GEOStyleAttributes, PBDataReader;
...
@interface GEOWaypointInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_muid : 1; unsigned char read_unknownFields : 1; unsigned char read_arInfo : 1; unsigned char read_artwork : 1; unsigned char read_evChargingInfo : 1; unsigned char read_name : 1; unsigned char read_position : 1; unsigned char read_styleAttributes : 1; unsigned char wrote_anyField : 1; } _flags;
}
