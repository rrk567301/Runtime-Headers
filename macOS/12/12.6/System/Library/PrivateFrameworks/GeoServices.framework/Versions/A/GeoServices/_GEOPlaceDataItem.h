@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, GEOAddressObject, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOMapRegion, GEOPDBusinessClaim, GEOMuninViewState, NSData, GEOEnclosingPlace, GEOPlace, GEOStorefrontPresentationInfo, NSMapTable, GEOBusinessHours, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOPlacecardLayoutData, GEOViewportFrame, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOPDMultiLocalizedString, GEOStyleAttributes, GEOStorefrontInfo, NSString, _GEOEncyclopedicInfo, NSTimeZone, GEORestaurantFeaturesLink, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, geo_reentrant_isolater, GEOPDPlace, GEOPriceDescription, GEOAddress;
