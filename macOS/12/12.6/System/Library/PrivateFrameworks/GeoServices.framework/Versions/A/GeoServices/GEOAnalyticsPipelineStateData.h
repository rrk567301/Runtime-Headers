@class GEOLogMsgStatePlaceCard, GEOMapsServerMetadata, GEOMapRegion, GEOCarInfo, GEOLogMsgStateUGCPhoto, GEOLocation, NSMutableArray, GEOLogMsgStateCuratedCollection, NSString, GEORouteDetails, GEOLogMsgEventPredExTrainingData, PBDataReader, NSData, GEOLogMsgStateAccount;
...
- (void)addMapSettingsNavVoiceSettings:(id)a0;
...
- (id)mapSettingsNavVoiceSettingsAtIndex:(unsigned long long)a0;
