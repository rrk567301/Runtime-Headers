...
@interface GEORPFeedbackFieldValue : PBCodable <NSCopying> {
    ...
    int _fieldValueType;
    struct { unsigned char has_fieldValueType : 1; unsigned char read_amenitiesField : 1; unsigned char read_annotations : 1; unsigned char read_booleanField : 1; unsigned char read_dateTimeField : 1; unsigned char read_doubleField : 1; unsigned char read_floatField : 1; unsigned char read_hoursFields : 1; unsigned char read_intField : 1; unsigned char read_locationField : 1; unsigned char read_longField : 1; unsigned char read_multiSelectField : 1; unsigned char read_routeStepField : 1; unsigned char read_singleSelectField : 1; unsigned char read_textField : 1; unsigned char read_textListField : 1; unsigned char read_tileFeatureInfoField : 1; unsigned char read_transitLineField : 1; unsigned char read_uintField : 1; unsigned char read_ulongField : 1; unsigned char read_ulongListField : 1; unsigned char wrote_anyField : 1; } _flags;
}
