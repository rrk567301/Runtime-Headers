...
@interface GEOPDCaptionedPhoto : PBCodable <NSCopying> {
    ...
    BOOL _useGallery;
    struct { unsigned char has_dateAdded : 1; unsigned char has_displayFullPhotoInline : 1; unsigned char has_displayFullScreenPhotoGallery : 1; unsigned char has_highQuality : 1; unsigned char has_isBusinessOwned : 1; unsigned char has_useGallery : 1; unsigned char read_unknownFields : 1; unsigned char read_attribution : 1; unsigned char read_author : 1; unsigned char read_caption : 1; unsigned char read_joeColor : 1; unsigned char read_licenseDescription : 1; unsigned char read_licenseUrl : 1; unsigned char read_photo : 1; unsigned char wrote_anyField : 1; } _flags;
}
