@class PBDataReader, NSString, GEORPRapProfileInfo, NSMutableArray, PBUnknownFields;
...
@interface GEORPFeedbackSubmissionResult : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_feedbackId : 1; unsigned char read_imageIdMapEntrys : 1; unsigned char read_rapInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
