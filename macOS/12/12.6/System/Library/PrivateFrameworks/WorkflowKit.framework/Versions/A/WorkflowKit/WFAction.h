@class NSDictionary, WFActionAuxiliaryButton, NSHashTable, WFWorkflow, WFParameter, NSString, WFColor, NSAttributedString, NSArray, NSMutableDictionary, WFAppInstalledResource, WFResourceManager, WFContentCollection, NSObject, WFActionParameterSummary, NSSet, WFImage, WFContentAttributionTracker, WFIcon, INAppDescriptor, ICApp, NSProgress, NSDate, WFContextualActionSuggestionMetadata;
