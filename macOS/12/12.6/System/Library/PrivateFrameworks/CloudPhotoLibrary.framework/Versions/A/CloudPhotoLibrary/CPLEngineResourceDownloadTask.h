@class CPLResource, NSString, NSData, NSMutableArray, CPLPlaceholderRecord;
...
- (id)initWithResource:(id)a0 taskIdentifier:(id)a1 launchHandler:(id /* block */)a2 cancelHandler:(id /* block */)a3 didStartHandler:(id /* block */)a4 progressHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
