@class FI_TCustomTouchBarItem, NSObject, FI_TImageView, FIAirDropView, FI_TNotificationCenterObserverGlue, FIAirDropListViewController, NSString, FI_TButton, NSImage, FI_TTextField, NSTimer, NSIndexSet, NSArray, FI_TUpdateLayerView, FI_TAirDropDiscoveryController, FI_TKeyValueObserverGlue, NSValue;
@protocol FI_TAirDropNotAvailableDelegateProtocol, FIAirDropViewDelegate;

@interface FIAirDropViewGutsController : FI_TViewController <NSTouchBarDelegate, TSFOperationDelegateProtocol, TMarkTornDown> {
    struct TNSWeakPtr<NSObject<FIAirDropViewDelegate>, void> { NSValue *fWeakObject; } _weakDelegate;
    ...
    struct vector<std::unique_ptr<TAirDropSenderOperationController>, std::allocator<std::unique_ptr<TAirDropSenderOperationController>>> { void *__begin_; void *__end_; struct __compressed_pair<std::unique_ptr<TAirDropSenderOperationController> *, std::allocator<std::unique_ptr<TAirDropSenderOperationController>>> { void *__value_; } __end_cap_; } _senderOpControllers;
    struct TNSWeakPtr<FI_TTouchBar, void> { NSValue *fWeakObject; } _participantsTouchBar;
    struct TNSWeakPtr<FI_TCustomTouchBarItem, void> { NSValue *fWeakObject; } _participantsTouchBarItem;
    FI_TCustomTouchBarItem *_escapeKeyTouchBarItem;
    struct TNSWeakPtr<FI_TTouchBar, void> { NSValue *fWeakObject; } _airDropNotAvailableTouchBar;
    struct TNSWeakPtr<FI_TCustomTouchBarItem, void> { NSValue *fWeakObject; } _turnOnWiFiBluetoothTouchBarItem;
}
