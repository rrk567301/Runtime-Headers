@class NSString, FI_TBrowserContainerController, NSValue, FI_TWindowHistoryEntry, NSMutableArray;
...
@interface FI_TWindowHistory : NSObject <TNodeObserverProtocol> {
    ...
    struct TNSWeakPtr<FI_TBrowserContainerController, void> { NSValue *fWeakObject; } _weakController;
}
