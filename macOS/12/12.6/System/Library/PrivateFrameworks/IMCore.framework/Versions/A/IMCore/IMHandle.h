@class NSURL, IMBrand, NSDate, NSDictionary, IMAccount, IMBrandManager, NSMutableArray, NSString, CNContact, NSSet, NSAttributedString, IMServiceImpl, NSData, NSArray, NSNumber;
