@class IFDTarget, NSString, IFDCustomizationItem, PKDistributionController, NSMutableDictionary, NSDictionary, PKDistributionChoiceItem, IFDocument, IFSearchContext;
