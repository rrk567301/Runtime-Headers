@class NSView, NSString, ICSearchResult, ICAttachmentBrickFrostedView, ICMZoomController, NSImage, NSLayoutConstraint, ICAttachment, NSRegularExpression, ICAttachmentBrickTextViewV2;
