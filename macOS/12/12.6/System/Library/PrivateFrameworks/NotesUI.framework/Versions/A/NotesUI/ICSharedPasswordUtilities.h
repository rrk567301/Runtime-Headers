...
+ (void)showDontForgetPasswordAlertForAccountIdentifier:(id)a0 isForFaceID:(BOOL)a1 withDisplayWindow:(id)a2;
...
+ (void)showDontForgetPasswordAlertIfNecessaryForAccountIdentifier:(id)a0 withDisplayWindow:(id)a1;
+ (id)alertTitleForDontForgetPasswordAlert;
+ (id)alertMessageForDontForgetPasswordAlertIsForFaceID:(BOOL)a0;
