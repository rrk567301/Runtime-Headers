@class NSData, NSString, NSArray, _MRContentItemMetadataProtobuf, NSDate, NSURL, NSDictionary, MRContentItemMetadataAudioFormat, MRContentItemMetadataAudioRoute;
