@class NSMapTable, NSMutableDictionary, NSArray, NSString, NSObject, MRAVOutputDevice;
...
@property (readonly, nonatomic) MRAVOutputDevice *unclusteredLocalOutputDevice;
@property (readonly, nonatomic) NSArray *unclusteredOutputDevices;
