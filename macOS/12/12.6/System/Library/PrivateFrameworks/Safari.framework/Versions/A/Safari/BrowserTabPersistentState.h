...
@property (readonly, nonatomic) struct Vector<unsigned int, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { unsigned int *m_buffer; unsigned int m_capacity; unsigned int m_size; } deprecatedAncestorTabIdentifiers;
