@class NSMutableDictionary, NSPProber, NWPath, NSDate, NSObject, NSPCandidateQuicProxyPath, NSDictionary, NSPOutageReasonStats, NSMutableArray, NSPToggleStats, NSPQuicProxyPath, NSString, NSPCandidateFallbackProxyPath, NSArray, NSData, NWInterface, NSPFallbackProxyPath;
...
@property (retain, nonatomic) NSPToggleStats *toggleStats;
...
- (id)createRTCReportPayloadWithToggleState:(BOOL)a0;
