...
+ (id)groupInteractionsContainingSearchStringInDisplayName:(id)a0 excludingInteractionUUIDs:(id)a1 account:(id)a2 directions:(id)a3 bundleIds:(id)a4 startDate:(id)a5 store:(id)a6 fetchLimit:(unsigned long long)a7 offset:(unsigned long long)a8;
