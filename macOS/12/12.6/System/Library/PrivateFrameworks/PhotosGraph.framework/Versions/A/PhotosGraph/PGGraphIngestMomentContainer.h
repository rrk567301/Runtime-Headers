@class NSDate, NSString, CLSInvestigationPhotoKitFeeder, NSArray, CLSClueCollection, PGCurationManager, NSNumber, CLSCurationContext;
...
@property (retain, nonatomic) NSArray *sensitiveLocationBlocklist;
...
- (BOOL)momentDateInterval:(id)a0 intersectsSensitiveDateIntervals:(id)a1;
- (id)initMomentContainerWithFeeder:(id)a0 clueCollection:(id)a1 curationManager:(id)a2 topTierAestheticScore:(double)a3 curationContext:(id)a4 sensitiveLocationBlocklist:(id)a5;
