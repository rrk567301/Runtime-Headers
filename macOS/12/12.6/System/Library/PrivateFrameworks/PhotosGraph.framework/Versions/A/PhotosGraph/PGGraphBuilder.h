@class PGManager, PGCurationManager, CLSFocusPeopleCache, PGGraphPeopleDomainBuildingHelper, NSMutableDictionary, NSDictionary, PHPhotoLibrary, NSObject, PGMutableGraph, PGGraphTimeDomainBuildingHelper, NSArray, CLSCurationContext;
@protocol OS_os_log;
...
@interface PGGraphBuilder : NSObject {
    ...
    NSArray *_sensitiveLocationBlocklist;
}
