...
- (void).cxx_destruct;
- (id)initWithType:(unsigned short)a0 subtype:(unsigned short)a1 enrichableEvent:(id)a2 sharingSuggestionResults:(id)a3 photoLibrary:(id)a4 curationManager:(id)a5 loggingConnection:(id)a6 titleGenerationContext:(id)a7;
