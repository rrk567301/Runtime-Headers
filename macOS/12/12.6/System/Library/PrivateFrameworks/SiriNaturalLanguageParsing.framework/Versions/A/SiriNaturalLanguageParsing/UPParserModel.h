...
- (id)_candidateForBeamSequence:(const void *)a0 utterance:(const void *)a1 outputTokens:(const void *)a2 resolver:(void *)a3;
- (id)_candidateForUtterance:(const void *)a0 probability:(float)a1 labelledSpans:(const void *)a2 intent:(id)a3;
...
- (id)_resultFromInferenceResult:(const void *)a0 query:(id)a1 outputTokens:(const void *)a2 resolver:(void *)a3;
