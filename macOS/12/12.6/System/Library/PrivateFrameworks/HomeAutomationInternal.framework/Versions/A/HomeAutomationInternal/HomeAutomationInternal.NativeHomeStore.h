@interface HomeAutomationInternal.NativeHomeStore : NSObject <HMHomeManagerDelegatePrivate, HMHomeDelegatePrivate, HMAccessoryDelegatePrivate, HMMediaSystemDelegate> {
    ...
    void /* unknown type, empty encoding */ osUpdateNeeded;
    void /* unknown type, empty encoding */ waitSemaphores;
