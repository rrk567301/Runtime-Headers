...
- (id)initWithDevice:(id)a0 srcAlpha:(unsigned long long)a1 destAlpha:(unsigned long long)a2 backgroundColor:(double *)a3 conversionInfo:(const struct CGColorConversionInfo { } *)a4;
