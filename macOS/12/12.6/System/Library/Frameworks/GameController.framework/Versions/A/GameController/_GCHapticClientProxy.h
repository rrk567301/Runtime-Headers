@class _GCControllerManagerServer, NSArray, NSMutableDictionary, NSString, NSObject, GCControllerSettings;
@protocol NSSecureCoding, OS_xpc_object, NSCopying, NSObject, _GCIPCIncomingConnection;
