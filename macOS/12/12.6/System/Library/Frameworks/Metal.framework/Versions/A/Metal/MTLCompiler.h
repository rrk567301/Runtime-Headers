...
- (struct MTLFunctionId { struct { unsigned char x0[32]; } x0[3]; unsigned int x1; })getFunctionId:(id)a0;
- (struct { unsigned char x0[32]; })getHashForScript:(const void *)a0 function:(id)a1 compilerOptions:(char **)a2 compilerOptionsSize:(unsigned long long)a3;
...
- (id)lookupBinaryInArchives:(id)a0;
...
- (BOOL)downgradeRequest:(struct MTLCompilerFunctionRequest { void /* function */ **x0; int x1; id x2; unsigned long long x3; id x4; id x5; unsigned int x6; unsigned int x7; unsigned int x8; id x9; id x10; unsigned long long x11; id x12; id x13; id x14; id x15; int x16; BOOL x17; unsigned int x18; } *)a0 frameworkData:(void *)a1 error:(id *)a2;
...
- (void)statelessBackendCompileRequestInternal:(struct MTLCompilerFunctionRequest { void /* function */ **x0; int x1; id x2; unsigned long long x3; id x4; id x5; unsigned int x6; unsigned int x7; unsigned int x8; id x9; id x10; unsigned long long x11; id x12; id x13; id x14; id x15; int x16; BOOL x17; unsigned int x18; } *)a0 sync:(BOOL)a1 compilerHash:(const struct { unsigned char x0[32]; } *)a2 reflectionOnly:(BOOL)a3 completionHandler:(id /* block */)a4;
...
- (void)initializeFunctionRequestScriptAndFunctionId:(id)a0 script:(const void *)a1 driverCompilerOptions:(id)a2;
