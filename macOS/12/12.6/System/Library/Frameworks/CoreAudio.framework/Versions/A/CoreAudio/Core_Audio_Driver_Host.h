...
- (int)add_device_client:(unsigned int)a0 client_info:(const struct AudioServerPlugInClientInfo { unsigned int x0; int x1; unsigned char x2; struct __CFString *x3; } *)a1 io_messenger:(id)a2 work_group_port:(unsigned int)a3;
...
- (int)start_synchronous_messenger:(unsigned int)a0 client_id:(unsigned int)a1 nominal_sample_rate:(double)a2 io_buffer_frame_size:(unsigned int)a3;
