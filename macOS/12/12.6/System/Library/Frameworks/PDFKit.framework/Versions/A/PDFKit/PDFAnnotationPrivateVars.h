@class NSMutableDictionary, NSColor, NSTextStorage, PDFPage, NSDictionary, PDFAnnotation, PDFAccessibilityNode, NSLayoutManager, NSString, NSIndexSet, PDFAKAnnotationAdaptor, NSArray, NSLock, NSUUID;
@protocol NSCopying;
...
@interface PDFAnnotationPrivateVars : NSObject {
    ...
    struct NSEdgeInsets { double top; double left; double bottom; double right; } textInsets;
