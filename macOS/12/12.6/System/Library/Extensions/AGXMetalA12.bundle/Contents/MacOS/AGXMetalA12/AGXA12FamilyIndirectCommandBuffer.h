@class NSString, AGXA12FamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXA12FamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXA12FamilyBuffer *_buffer;
