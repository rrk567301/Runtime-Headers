@class NSString, AGXG13GFamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG13GFamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG13GFamilyBuffer *_buffer;
