...
@interface B2PEngine : NSObject {
    ...
    struct { unsigned char cb[176]; struct { unsigned int response_timeouts; unsigned int midpacket_timeouts; unsigned int tx_packet_retry_cnt; unsigned int max_tx_level; unsigned int rx_packet_cnt; unsigned int rx_packet_err_cnt; unsigned int tx_packet_cnt; } dbg_stats; void *client_context; } _b2pContext;
