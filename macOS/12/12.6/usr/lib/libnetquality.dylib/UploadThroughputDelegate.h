...
- (id)initWithConfiguration:(id)a0 withQueue:(id)a1 testEndpoint:(id)a2 minSessions:(long long)a3 maxSessions:(long long)a4 maxTime:(float)a5 uploadSize:(long long)a6;
