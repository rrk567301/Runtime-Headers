...
- (BOOL)_rawPathIsUndiscoveredStickyExclusion:(const char *)a0 filterRules:(struct { unsigned long long x0; unsigned long long x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; })a1 hints:(struct _TMRulesQueryHints { unsigned short x0; int x1; BOOL x2; BOOL x3; BOOL x4; } *)a2;
- (BOOL)_rawPathHasStickyExclusionXattr:(const char *)a0;
