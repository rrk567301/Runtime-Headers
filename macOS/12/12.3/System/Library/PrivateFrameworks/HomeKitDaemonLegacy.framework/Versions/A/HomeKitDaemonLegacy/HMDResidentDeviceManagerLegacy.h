@class NSUUID, HMDResidentDevice, NSArray, NSString, NSSet, NSMutableSet, HMDHomePrimaryResidentInitialReachabilityManager, NSObject, HMDMessageDispatcher, HMDPrimaryElectionLegacyAddOn, NSNotificationCenter, HMDHome;
