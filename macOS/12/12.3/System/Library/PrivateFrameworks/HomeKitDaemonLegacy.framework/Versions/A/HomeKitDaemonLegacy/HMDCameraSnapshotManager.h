...
- (id)initWithAccessory:(id)a0 workQueue:(id)a1 streamSnapshotHandler:(id)a2 uniqueIdentifier:(id)a3 msgDispatcher:(id)a4 networkMonitor:(id)a5 logIdentifier:(id)a6 imageCacheDirectory:(id)a7 residentMessageHandler:(id)a8 snapshotSlotManager:(id)a9;
