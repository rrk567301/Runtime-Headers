@class HMDLogEventErrorEventsAnalyzer, HMDConfigurationLogEvent, HMDLogEventProcessMemoryEventsAnalyzer, NSMutableArray, HMDLogEventMessageEventsAnalyzer, HMDHomeManager, HMDCloudSyncLogEventsAnalyzer, HMDEventFlagsManager, HMDMessageDispatcher, NSString, HMDLogEventReachabilityEventsAnalyzer, NSArray, HMDLogEventDispatcher, HMDCoreAnalyticsLogObserver, HMDLogEventDailyScheduler, NSObject, HMDLogEventElectionEventsAnalyzer, HMDLogEventProcessLaunchAnalyzer, HMDLogEventUserActivityAnalyzer, HMDEventCountersManager, NSUUID, HMDLogEventHAPMetricsEventAnalyzer, HMFUnfairLock;
...
@property (readonly, getter=isHH2Enabled) BOOL HH2Enabled;
