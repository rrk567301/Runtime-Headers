@class SGMContactDetailSent, PETEventTracker2, SGMContactDetailExtraction;

@interface SGDetectedAttributeMetrics : NSObject

@property (retain, nonatomic) SGMContactDetailExtraction *contactDetailExtraction;
@property (retain, nonatomic) SGMContactDetailSent *contactDetailSent;
