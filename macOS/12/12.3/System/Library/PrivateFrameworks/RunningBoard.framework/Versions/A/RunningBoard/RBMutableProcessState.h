...
- (void)setAppNapPreventBackgroundSockets:(BOOL)a0;
...
- (void)setAppNapEnabled:(BOOL)a0;
- (void)setAppNapInactive:(BOOL)a0;
- (void)setAppNapPreventDiskThrottle:(BOOL)a0;
- (void)setAppNapPreventLowPriorityCPU:(BOOL)a0;
- (void)setAppNapPreventSuppressedCPU:(BOOL)a0;
