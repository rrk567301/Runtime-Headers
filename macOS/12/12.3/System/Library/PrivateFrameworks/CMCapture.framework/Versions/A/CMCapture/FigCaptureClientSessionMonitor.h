...
- (void)layoutMonitor:(id)a0 didUpdateLayoutWithForegroundApps:(id)a1 obscuredApps:(id)a2 transitioningApps:(id)a3 pipApps:(id)a4 siriVisible:(BOOL)a5 contactlessUIServiceVisible:(BOOL)a6;
