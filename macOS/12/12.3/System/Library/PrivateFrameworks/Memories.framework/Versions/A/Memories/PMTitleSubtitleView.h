@class PXExtendedTraitCollection, NSViewController, NSView, NSString, NSLayoutConstraint, PXTitleSubtitleNSLabel;
...
@property (retain, nonatomic) PXTitleSubtitleNSLabel *label;
@property (retain, nonatomic) NSView *dark;
