@class PBDataReader, GEOVLFInitializationFailureDetails, GEOVLFCorrection, GEOVLFEntryPoint, NSMutableArray, GEOVLFLocation;
...
@interface GEOLogMsgEventVLFUsage : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_initialPositionContextClassification : 1; unsigned char has_finalState : 1; unsigned char has_sessionTimeMs : 1; unsigned char has_timeRoundedToHour : 1; unsigned char read_arStates : 1; unsigned char read_deviceOrientations : 1; unsigned char read_entryPoint : 1; unsigned char read_initialLocation : 1; unsigned char read_initializationFailureDetails : 1; unsigned char read_localizationDetails : 1; unsigned char read_postFusionCorrection : 1; unsigned char wrote_anyField : 1; } _flags;
}
