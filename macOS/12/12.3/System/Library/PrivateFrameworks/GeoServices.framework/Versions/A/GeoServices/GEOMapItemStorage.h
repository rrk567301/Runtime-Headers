@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, NSMutableArray, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOMapRegion, GEOPDBusinessClaim, GEOMuninViewState, NSData, GEOEnclosingPlace, GEOPlace, GEOStorefrontPresentationInfo, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOPlacecardLayoutData, GEOViewportFrame, _GEOMapItemStorageNotificationTrampoline, PBDataReader, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOMapItemStorageUserValues, GEOStyleAttributes, GEOStorefrontInfo, NSString, NSTimeZone, GEOPDResultDetourInfo, GEORestaurantFeaturesLink, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEOLatLng, PBUnknownFields, GEOPDPlace, GEOPriceDescription, GEOAddress;
