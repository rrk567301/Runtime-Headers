...
- (id)_createOutgoingMessageUsingEncoder:(id)a0 topLevelPart:(id)a1 topLevelHeaders:(id)a2 datasByMimePart:(id)a3 error:(id *)a4;
...
- (void)setSigningIdentity:(struct __SecIdentity { } *)a0;
