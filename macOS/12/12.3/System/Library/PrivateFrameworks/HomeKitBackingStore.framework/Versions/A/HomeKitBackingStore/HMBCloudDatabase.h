@class NSMutableDictionary, HMBCloudDatabaseConfiguration, HMBLocalZone, NAFuture, HMBCloudDatabaseStateModel, HMBCloudCredentialsAvailabilityListener, CKContainerID, CKDatabase, NSSet, HMFUnfairLock, NSString, NSOperationQueue, HMBLocalDatabase, CKContainer;
