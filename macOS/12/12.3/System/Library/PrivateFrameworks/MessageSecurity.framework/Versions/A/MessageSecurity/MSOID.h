...
@property (readonly) const struct ccdigest_info { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; char *x4; void *x5; void /* function */ *x6; void /* function */ *x7; } *ccdigest;
...
+ (id)OIDWithString:(id)a0;
+ (id)OIDWithData:(id)a0;
