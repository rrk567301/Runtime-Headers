@class NSView, MUPlaceSectionFooterViewModel, NSString, MUPlaceSectionHeaderViewModel, MKWebContentViewController, MUPlaceSectionView, NSViewController, GEOWebContentModuleConfiguration, MKUGCCallToActionViewAppearance;
@protocol MUPlaceWebContentSectionControllerDelegate, MUInfoCardAnalyticsDelegate;

@interface MUPlaceWebContentSectionController : MUPlaceSectionController <MKWebContentViewControllerDelegate, MUPlaceSectionControlling> {
