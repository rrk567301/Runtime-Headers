@class NSView, MUPlaceSectionFooterViewModel, NSString, MUPlaceSectionHeaderViewModel, MUFixedHeightAwareViewController, MKTransitDeparturesViewController, NSViewController, MUPlaceFooterAttributionController, MKUGCCallToActionViewAppearance;
