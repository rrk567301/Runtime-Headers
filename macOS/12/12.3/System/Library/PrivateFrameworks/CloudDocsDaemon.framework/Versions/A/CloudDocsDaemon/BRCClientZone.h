...
- (id)cancelFetchAliasOperationAndReschedule:(id)a0;
...
- (id)fetchShareAliasIfNecessaryForTarget:(id)a0 isUserWaiting:(BOOL)a1;
...
- (void)_registerFetchAliasOperation:(id)a0;
