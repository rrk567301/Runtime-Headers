@class VCTriggerEventRunner, NSString, VCUserNotificationManager, WFTriggerNotificationScheduler, NSObject;
...
- (id)initWithDatabaseProvider:(id)a0 runCoordinator:(id)a1 notificationManager:(id)a2 notificationScheduler:(id)a3;
