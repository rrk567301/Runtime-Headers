...
- (void)updateHasLocallyProvisionedPass:(BOOL)a0 forFeatureIdentifier:(unsigned long long)a1 withCompletion:(id /* block */)a2;
...
- (BOOL)hasPassesWithFeatureIdentifier:(unsigned long long)a0;
- (id)passesOfType:(unsigned long long)a0;
- (id)passWithUniqueID:(id)a0;
- (BOOL)hasLocallyProvisionedPassForFeatureIdentifier:(unsigned long long)a0;
