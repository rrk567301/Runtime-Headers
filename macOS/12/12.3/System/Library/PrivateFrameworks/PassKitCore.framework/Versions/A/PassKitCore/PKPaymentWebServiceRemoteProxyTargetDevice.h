...
- (void)hasPassesWithFeatureIdentifier:(unsigned long long)a0 completion:(id /* block */)a1;
...
- (void)hasLocallyProvisionedPassForFeatureIdentifier:(unsigned long long)a0 completion:(id /* block */)a1;
