...
- (BOOL)paymentWebService:(id)a0 hasPassesWithFeatureIdentifier:(unsigned long long)a1;
- (BOOL)paymentWebService:(id)a0 canProvisionPaymentPassWithPrimaryAccountIdentifier:(id)a1;
- (BOOL)paymentWebService:(id)a0 hasLocallyProvisionedPassForFeatureIdentifier:(unsigned long long)a1;
- (void)paymentWebService:(id)a0 updateHasLocallyProvisionedPass:(BOOL)a1 forFeatureIdentifier:(unsigned long long)a2 withCompletion:(id /* block */)a3;
