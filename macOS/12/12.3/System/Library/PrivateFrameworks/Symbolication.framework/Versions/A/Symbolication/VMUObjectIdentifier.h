...
- (id)labelForDriverKitOSClassLoadInformation:(void *)a0 length:(unsigned long long)a1 remoteAddress:(unsigned long long)a2;
- (id)labelForDriverKitOSMetaClass:(void *)a0 length:(unsigned long long)a1 remoteAddress:(unsigned long long)a2;
