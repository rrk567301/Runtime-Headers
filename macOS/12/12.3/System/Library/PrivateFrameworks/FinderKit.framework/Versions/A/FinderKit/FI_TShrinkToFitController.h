@class NSFont, NSString, NSTimer, FI_TRenameOperation, NSValue, FI_TShrinkToFitTextView, NSObject, NSWindow;
...
@interface FI_TShrinkToFitController : NSObject <NSWindowDelegate> {
    ...
    struct TNSWeakPtr<NSObject<TShrinkToFitDelegateProtocol>, void> { NSValue *fWeakObject; } _weakDelegate;
}
