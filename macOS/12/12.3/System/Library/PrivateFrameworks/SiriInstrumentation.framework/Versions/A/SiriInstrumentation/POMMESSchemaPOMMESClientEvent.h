@class POMMESSchemaPOMMESServiceClassifierScoreReported, NSData, POMMESSchemaPOMMESClientEventMetadata, POMMESSchemaPOMMESOnDeviceIndexSearchContext, POMMESSchemaPOMMESPegasusRequestContext;
