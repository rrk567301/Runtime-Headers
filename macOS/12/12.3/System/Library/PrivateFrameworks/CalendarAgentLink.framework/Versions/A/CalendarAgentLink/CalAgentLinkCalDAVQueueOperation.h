...
@property (retain, nonatomic) NSString *changeRequestManagedObjectID;
...
- (void).cxx_destruct;
- (id)inputPayload;
- (id)initWithAction:(id)a0 principalManagedObjectID:(id)a1 changeRequestManagedObjectID:(id)a2;
