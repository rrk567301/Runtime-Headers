@class NSString, NSArray, HMDHomeManager, HMDRemoteDeviceMonitor, NSMutableDictionary, HMDModernTransportDeviceReachabilityObserver, NSMutableSet, NSObject, HMDRemoteMessageTransport;
