...
@interface HMDHAPAccessory : HMDAccessory <HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDSiriEndpointProfileMetricsDispatcherFactory, HMDAccessoryMinimumUserPrivilegeCapable, HMDServiceOwner, HAPAccessoryDelegate, HMFTimerDelegate, HAPAccessoryServerNotification, HMDAccessoryUserManagement> {
...
- (long long)linkSpeed;
- (void)readCharacteristicValues:(id)a0 source:(unsigned long long)a1 message:(id)a2 queue:(id)a3 logEvent:(id)a4 localOperationRequired:(BOOL)a5 completionHandler:(id /* block */)a6;
...
- (void)writeCharacteristicValues:(id)a0 source:(unsigned long long)a1 message:(id)a2 queue:(id)a3 logEvent:(id)a4 localOperationRequired:(BOOL)a5 completionHandler:(id /* block */)a6;
