@class Protocol, NSUUID, NSString, HMDDeviceCapabilitiesModel;
@protocol NSCopying;
...
- (id)initWithProductInfo:(id)a0 homekitVersion:(id)a1 overrideInfo:(id)a2;
- (id)initWithProductInfo:(id)a0 homekitVersion:(id)a1 overrideInfo:(id)a2 mobileGestaltClient:(id)a3;
