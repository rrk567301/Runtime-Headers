@class HMDHomeManager, NSUUID, NSString, NSMutableDictionary, NSObject, HMDMessageDispatcher;
@protocol OS_dispatch_queue;

@interface HMDUserDeviceCapabilitiesRequestManager : HMDRemoteMessageTransport <HMFMessageReceiver> {
