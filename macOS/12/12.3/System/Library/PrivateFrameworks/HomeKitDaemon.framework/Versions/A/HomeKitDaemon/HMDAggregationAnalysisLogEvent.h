@class HMDEventFlagsManager, NSString, NSDictionary, HMDEventCountersManager;
...
@property unsigned long long currentDeviceStartedElectionCount;
...
- (void).cxx_destruct;
- (id)alertMessageForRadarDialogWithCloudSyncBytesThreshold:(unsigned long long)a0 remoteMessageCountThreshold:(unsigned long long)a1;
