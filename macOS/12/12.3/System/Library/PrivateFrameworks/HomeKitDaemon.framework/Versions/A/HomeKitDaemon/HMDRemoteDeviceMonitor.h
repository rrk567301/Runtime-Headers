@class HMDAppleAccountManager, HMFMessageTransport, HMDRemoteAccountManager, NSMapTable, NSObject, IDSAccount, IDSService, NSString, HMDIDSActivityMonitorObserver, NSOperationQueue, NSArray, HMFNetMonitor, HMDAccountRegistry, HMFTimer;
...
- (id)newSendLocalMessageOperationWithMessage:(id)a0;
