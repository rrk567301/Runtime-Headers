@class HMDPhoneCallObserver, NSObject, HMFMessageDispatcher, HMDCameraStreamManagerSession, HMDService, HMDDynamicActivityAttributionPublisher, NSString, HMDCameraSupportedConfigurationCache, HMDHAPAccessory, HMDCameraStreamSnapshotHandler, HMFNetMonitor, HMDCameraResidentMessageHandler, NSUUID;
...
- (id)initWithWorkQueue:(id)a0 streamSnapshotHandler:(id)a1 accessory:(id)a2 streamManagementService:(id)a3 profileUniqueIdentifier:(id)a4 networkMonitor:(id)a5 residentMessageHandler:(id)a6 phoneCallObserver:(id)a7 dataSource:(id)a8;
