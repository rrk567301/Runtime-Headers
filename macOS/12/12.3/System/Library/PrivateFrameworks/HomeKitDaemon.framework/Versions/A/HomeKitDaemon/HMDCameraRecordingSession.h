@class HMDCameraClipUploader, NSUUID, HMDCameraRecordingSessionTimelineManager, NSObject, NSDictionary, HMFActivity, HMIVideoFragment, HMDCameraProfile, NSString, HMDCameraSignificantEventServer, HMDCameraRecordingSessionVariantFragmentManager, NSNumber, HMDStreamData, NSData, HMDCameraRecordingSessionSignificantEventManager, HMIVideoAnalyzerFragmentResult;
...
- (id)initWithWorkQueue:(id)a0 camera:(id)a1 hapAccessory:(id)a2 home:(id)a3 configuredFragmentDuration:(double)a4 timelineManager:(id)a5 significantEventServer:(id)a6 homePresenceByPairingIdentity:(id)a7;
- (id)initWithWorkQueue:(id)a0 camera:(id)a1 hapAccessory:(id)a2 home:(id)a3 configuredFragmentDuration:(double)a4 timelineManager:(id)a5 significantEventServer:(id)a6 homePresenceByPairingIdentity:(id)a7 factory:(id)a8;
