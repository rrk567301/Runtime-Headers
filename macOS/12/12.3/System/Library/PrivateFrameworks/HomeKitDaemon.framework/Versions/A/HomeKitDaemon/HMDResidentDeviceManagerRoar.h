@class HMDDeviceCapabilities, NSObject, HMDPrimaryResidentDiscoveryOperation, HMDMessageDispatcher, HMDResidentDevice, HMDPrimaryElectionCoordinationAddOn, HMDModernTransportDeviceReachabilityObserver, NSString, NSSet, NSMutableSet, NSArray, HMDHome, NSNotificationCenter, NSUUID;
