@class NSMutableDictionary, NSString, WiFiUsageBssDetails, NSDate, WiFiUsageNetworkDetails, NSMutableSet;
...
@property (nonatomic) unsigned long long min24GHzNeighborCount;
@property (nonatomic) unsigned long long max24GHzNeighborCount;
@property (nonatomic) unsigned long long min5GHzNeighborCount;
@property (nonatomic) unsigned long long max5GHzNeighborCount;
@property (nonatomic) long long min24GHzNeighborRssi;
@property (nonatomic) long long max24GHzNeighborRssi;
@property (nonatomic) long long min5GHzNeighborRssi;
@property (nonatomic) long long max5GHzNeighborRssi;
@property (retain, nonatomic) NSMutableSet *roam24GHzAllBSSes;
@property (retain, nonatomic) NSMutableSet *roam5GHzAllBSSes;
...
- (void)roamingStateDidChange:(BOOL)a0 flags:(unsigned long long)a1 scannedChannelCount:(unsigned long long)a2 reason:(unsigned long long)a3 latency:(unsigned long long)a4 andStatus:(unsigned long long)a5 andPingPongNth:(BOOL)a6;
