@class NSDate, NSString, NSArray, NSURL, NSData, EKEvent, EKStructuredLocation, NSMutableSet, NSTimeZone, EKSuggestedEventInfo, EKCalendar;
...
@property (retain) EKEvent *referenceEvent;
