@class SiriUIOrbView, NSDictionary, SiriUIBuddyEnableSiriController, AFVoiceInfo, SiriUIBuddyVoiceTriggerController, OBTemplateView, NSString, NSSet, NSLayoutConstraint, SiriUIBuddyVoiceTriggerIntroController, SiriUIBuddyChooseVoiceController, SiriUIRemoteDeviceBrowser, SSRVoiceProfile, NSViewController, SiriUIBuddyVoiceTriggerOutroController, SiriUIBuddyChooseLanguageController, SiriUIBuddyImproveSiriController;
...
- (void)remoteDeviceBrowser:(id)a0 connectedDeviceIdentifiersDidChange:(id)a1;
