@class NSData, NSString, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NTPBDate, NTPBRecordBase, NSMutableArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
