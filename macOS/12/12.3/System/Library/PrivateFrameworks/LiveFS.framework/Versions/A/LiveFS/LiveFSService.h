...
- (void)LiveMountAddDisk:(id)a0 FileSystemType:(id)a1 reply:(id /* block */)a2;
- (void)LiveMountAddVolume:(id)a0 withListener:(id)a1 andWithDescription:(id)a2 reply:(id /* block */)a3;
- (void)LiveMountAddShimForFileSystemType:(id)a0 parameterDict:(id)a1 reply:(id /* block */)a2;
- (void)LiveMountCredentialTypes:(id /* block */)a0;
- (void)LiveMountGetUniqueName:(id)a0 reply:(id /* block */)a1;
