...
+ (id)transformationWithFilterOptions:(long long)a0 otherArticleIDs:(id)a1 otherClusterIDs:(id)a2 subscribedTagIDs:(id)a3 mutedTagIDs:(id)a4 readingHistoryItems:(id)a5 playlistArticleIDs:(id)a6 briefingsTagID:(id)a7 paidAccessChecker:(id)a8 bundleSubscription:(id)a9;
