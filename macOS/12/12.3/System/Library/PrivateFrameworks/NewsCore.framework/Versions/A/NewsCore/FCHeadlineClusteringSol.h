...
- (void).cxx_destruct;
- (id)clusterHeadlinesByTopic:(id)a0 subscribedTags:(id)a1 favoritesPersonalizer:(id)a2 personalizer:(id)a3 rules:(id)a4 translationProvider:(id)a5 unpaidHeadlineIDs:(id)a6;
