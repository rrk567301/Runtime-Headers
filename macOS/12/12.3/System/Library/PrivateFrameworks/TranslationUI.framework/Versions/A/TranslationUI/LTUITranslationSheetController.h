@class NSArray, NSDictionary, NSString, NSTableView, NSButton;
...
@property (retain, nonatomic) NSArray *availableLocalePairs;
@property (retain, nonatomic) NSArray *installedLocales;
@property (retain, nonatomic) NSArray *availableLocales;
@property (retain, nonatomic) NSDictionary *installationStatus;
...
- (void)initializeWithCompletionBlock:(id /* block */)a0;
