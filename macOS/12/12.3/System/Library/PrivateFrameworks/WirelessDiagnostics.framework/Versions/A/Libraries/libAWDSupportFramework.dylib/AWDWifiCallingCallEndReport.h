...
@interface AWDWifiCallingCallEndReport : PBCodable <NSCopying> {
    ...
    struct { unsigned char timestamp : 1; unsigned char frameErasureRateMean : 1; unsigned char jitterBufferResidencyTime95Percentile : 1; unsigned char jitterBufferResidencyTimeMean : 1; unsigned char jitterBufferResidencyTimeMedian : 1; unsigned char jitterBufferUnderflowRateMean : 1; unsigned char rtpPacketLossRateMean : 1; } _has;
}
