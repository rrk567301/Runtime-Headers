...
+ (id)slotStyleWithAccessibilityContrast:(unsigned long long)a0 displayRange:(unsigned long long)a1 displayScale:(unsigned char)a2 layoutDirection:(unsigned long long)a3 legibilityWeight:(unsigned long long)a4 localization:(id)a5 preferredContentSizeCategory:(unsigned long long)a6 tintColor:(struct CGColor { } *)a7 userInterfaceIdiom:(unsigned long long)a8 userInterfaceStyle:(unsigned long long)a9;
+ (BOOL)_colorInGamut:(struct CGColor { } *)a0;
