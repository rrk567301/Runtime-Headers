...
+ (id)_createRequestFromDictionary:(id)a0 confirmationOnly:(BOOL)a1 delegateAuthenticationRequired:(BOOL)a2 biometricSignatureRequired:(BOOL)a3 authenticateResponse:(id)a4 taskInfo:(id)a5;
