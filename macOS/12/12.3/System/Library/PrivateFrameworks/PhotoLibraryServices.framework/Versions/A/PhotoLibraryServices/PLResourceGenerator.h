...
+ (id)expectedLocalResourceRecipesForAssetWithLibraryID:(id)a0 versions:(id)a1 assetHasAdjustments:(BOOL)a2 assetIsRAWOrRawPlugJPEGWithRawOnTop:(BOOL)a3 assetWidth:(long long)a4 assetHeight:(long long)a5 assetKind:(short)a6 assetkindSubtype:(short)a7 deferredProcessingNeeded:(unsigned short)a8 videoDeferredProcessingNeeded:(unsigned short)a9;
