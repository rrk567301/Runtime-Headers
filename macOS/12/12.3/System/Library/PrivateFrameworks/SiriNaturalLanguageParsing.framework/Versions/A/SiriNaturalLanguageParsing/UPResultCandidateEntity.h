@class NSString, NSNumber, UPResultLeafNode;
...
- (void).cxx_destruct;
- (id)initWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 label:(id)a1 text:(id)a2 groupId:(id)a3 semanticValue:(id)a4;
