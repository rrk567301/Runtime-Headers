...
- (void)_addPathForLabel:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 text:(id)a2 semanticValue:(id)a3 toGraphNode:(struct UsoGraphNode { void /* function */ **x0; struct UsoGraph *x1; unsigned long long x2; } *)a4 forGraph:(void *)a5;
