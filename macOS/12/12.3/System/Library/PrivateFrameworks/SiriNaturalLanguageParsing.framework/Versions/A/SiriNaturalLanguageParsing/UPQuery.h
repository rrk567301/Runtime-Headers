...
- (id)initWithProtobufQueryAndPlumSpans:(id)a0 plumSpans:(id)a1 error:(id *)a2;
- (id)_createTokenChainWithProtobufQuery:(id)a0;
- (id)_createEmbeddingsWithProtobufQuery:(id)a0 error:(id *)a1;
- (id)_createSpansWithProtobufQuery:(id)a0 plumSpans:(id)a1 error:(id *)a2;
