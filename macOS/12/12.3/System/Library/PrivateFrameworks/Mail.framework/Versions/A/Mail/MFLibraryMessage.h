@class ECSubject, MFMailbox, NSDate, NSDictionary, ECMessageFlags, MFMailAccount, NSString, MFLibraryCalendarEvent, ECAngleBracketIDHash, NSSet, NSArray, MFLibraryStore, NSUUID;
@protocol ECMessageHeaders, IMAPMessageDataSource, ECMimePart;
