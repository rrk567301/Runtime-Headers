...
- (void)connectionInvitationInbox:(id)a0 foundConection:(id)a1 senderAppleID:(id)a2 senderAddress:(id)a3 networkPowerAssertion:(id)a4 messagingVersion:(unsigned long long)a5 userInfo:(id)a6;
...
- (id)initWithIDSPrimitives:(id)a0 networkPowerPrimitives:(id)a1 sourceAppleID:(id)a2 connectionConfiguration:(id)a3;
- (id)initWithIDSPrimitives:(id)a0 networkPowerPrimitives:(id)a1 timerSource:(id)a2 workQueue:(id)a3 delegateQueue:(id)a4 sourceAppleID:(id)a5 connectionConfiguration:(id)a6;
...
- (void)connectionInvitationOutbox:(id)a0 foundConnection:(id)a1 destinationAppleID:(id)a2 destinationAddress:(id)a3 networkPowerAssertion:(id)a4 messagingVersion:(unsigned long long)a5 userInfo:(id)a6;
