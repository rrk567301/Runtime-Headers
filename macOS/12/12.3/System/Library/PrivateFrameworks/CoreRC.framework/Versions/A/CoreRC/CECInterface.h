...
@property (readonly, nonatomic) struct CECFrame { unsigned char blocks[16]; unsigned char length : 5; unsigned char reserved : 3; } lastReceivedFrame;
...
@property (readonly, nonatomic) BOOL promiscMode;
