...
+ (id)beautifiedLocationNodeStringWithPlaceNode:(id)a0;
...
+ (id)_commonAOIComponentsForMomentNodes:(id)a0 addressNodes:(id)a1 aoiDisplayType:(unsigned long long)a2 containsAmusementParkPOI:(BOOL)a3;
...
+ (id)_filteredAOINodesForAddressNodes:(id)a0 aoiTitleMaximumLength:(unsigned long long)a1;
+ (id)_aoiSubsetsFromAOI:(id)a0 maxSubsetSize:(unsigned long long)a1;
+ (id)_filteredAOINodeCombinationsForCombinations:(id)a0 minSize:(unsigned long long)a1 maxSize:(unsigned long long)a2 maxTitleLength:(unsigned long long)a3 minNumberOfAssets:(unsigned long long)a4 aoiNodesToAddressNodesMapTable:(id)a5 assetCountByAddressNodeIdentifier:(id)a6;
+ (id)_sortedAOINodeCombinationsForCombinations:(id)a0 aoiNodesToAddressNodesMapTable:(id)a1 assetCountByAddressNodeIdentifier:(id)a2;
+ (id)_aoiSubsetsFromAOI:(id)a0 idx:(unsigned long long)a1 currentSubset:(id)a2 subsetSize:(unsigned long long)a3;
+ (float)_weightForAreaNode:(id)a0 withAddressNodes:(id)a1;
