@class PGGraphHighlightTypeNodeCollection, NSArray, PGGraphHolidayNodeCollection, NSOrderedSet, NSSet, PGGraphPersonNodeCollection, PGGraphSocialGroupNodeCollection, PGGraphMomentNodeCollection;
...
@property (retain, nonatomic) NSSet *placeKeywords;
...
- (BOOL)isUsableWithConditionalKeywordsForCategory:(unsigned long long)a0 triggerTypes:(id)a1;
