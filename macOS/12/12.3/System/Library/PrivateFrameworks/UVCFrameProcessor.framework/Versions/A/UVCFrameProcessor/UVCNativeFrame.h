...
- (void)dealloc;
- (id)description;
- (id)initWithBuffer:(void *)a0 presentationTimestamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 presentationDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a2 discontinous:(BOOL)a3;
