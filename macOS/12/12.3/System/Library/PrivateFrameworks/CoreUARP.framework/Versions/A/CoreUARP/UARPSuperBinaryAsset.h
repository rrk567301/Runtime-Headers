@class UARPSuperBinaryMetaDataTable, NSArray, NSDictionary, NSURL, NSNumber, NSMutableArray;
...
- (BOOL)writeToURL:(id)a0 payloadStartOffset:(unsigned long long)a1 error:(id *)a2;
