...
- (id)initWithScene:(const void *)a0 withPredicate:(struct Usd_PrimFlagsPredicate { struct bitset<13UL> { unsigned long long x0; } x0; struct bitset<13UL> { unsigned long long x0; } x1; BOOL x2; })a1;
- (id)initWithPrim:(const void *)a0;
- (id)initWithPrim:(const void *)a0 withPredicate:(struct Usd_PrimFlagsPredicate { struct bitset<13UL> { unsigned long long x0; } x0; struct bitset<13UL> { unsigned long long x0; } x1; BOOL x2; })a1;
