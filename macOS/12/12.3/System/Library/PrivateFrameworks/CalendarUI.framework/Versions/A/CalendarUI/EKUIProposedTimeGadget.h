@class EKUIResizingTextField, EKParticipant, EKUICompositeGadget, EKUIProposedTimeResponseView, NSDate, NSArray;
...
@property (retain, nonatomic) EKParticipant *proposingAttendee;
