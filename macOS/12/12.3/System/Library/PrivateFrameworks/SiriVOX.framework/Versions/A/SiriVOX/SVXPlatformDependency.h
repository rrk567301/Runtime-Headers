@protocol SVXSpeechSynthesisListening, SVXServiceCommandHandling, SVXAudioStreamingListening, SVXSessionActivityListening, SVXSiriModesManaging, SVXAudioPowerUpdateListening;
