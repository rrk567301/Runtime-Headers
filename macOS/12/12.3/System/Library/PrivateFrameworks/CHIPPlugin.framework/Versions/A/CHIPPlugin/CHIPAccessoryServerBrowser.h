@class CHIPPluginStorage, CHIPDeviceController, NSString, CHIPPluginResidentStateManager, NSOperationQueue, CHIPPluginVendorMetadataStore, CHIPPluginMatterKeypair, NSMutableSet, NSObject;
