...
- (id)createHAPSensorService;
- (id)vendAccessoryServerWithNodeID:(id)a0 setupCode:(id)a1 discriminator:(id)a2 identifier:(id)a3 category:(id)a4 name:(id)a5 vendorID:(id)a6 productID:(id)a7 serialNumber:(id)a8 firmwareRevision:(id)a9;
- (id)createOnServiceType:(id)a0;
- (id)createLightServiceType:(id)a0;
- (id)createLockMechanismServiceType:(id)a0;
- (id)createSensorServiceType:(id)a0;
- (id)createWindowCoveringServiceType:(id)a0;
