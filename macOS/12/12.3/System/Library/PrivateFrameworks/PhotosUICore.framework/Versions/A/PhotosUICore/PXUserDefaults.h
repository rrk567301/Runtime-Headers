...
@property (copy, nonatomic) NSNumber *assetSource;
...
@property (copy, nonatomic) NSNumber *hubbleLastRadarPromptAnsweredQuestionCount;
@property (copy, nonatomic) NSDate *hubbleLastSurveyQuestionsRadarPromptDate;
@property (copy, nonatomic) NSDate *hubbleSurveyQuestionsHideDate;
