...
+ (void)performCurationForAssetResults:(id)a0 sceneIdentifiers:(id)a1 searchQuery:(id)a2 sceneTaxonomy:(id)a3 completion:(id /* block */)a4;
...
+ (void)_curationObjectsFromAssets:(id)a0 scenesMap:(id)a1 sceneIdentifiers:(id)a2 sceneTaxonomy:(id)a3 completion:(id /* block */)a4;
