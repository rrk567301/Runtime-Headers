...
- (BOOL)getHeliumImage:(id *)a0 layerOffsetX:(double *)a1 layerOffsetY:(double *)a2 requestInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a3 fromParm:(unsigned int)a4 atTime:(union { double x0; struct *x1; })a5;
...
- (BOOL)getBitmap:(id *)a0 layerOffsetX:(double *)a1 layerOffsetY:(double *)a2 requestInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a3 fromParm:(unsigned int)a4 atTime:(double)a5;
- (BOOL)getTexture:(id *)a0 layerOffsetX:(double *)a1 layerOffsetY:(double *)a2 requestInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a3 fromParm:(unsigned int)a4 atTime:(double)a5;
...
- (BOOL)retrieveImage:(id *)a0 layerOffsetX:(double *)a1 layerOffsetY:(double *)a2 requestInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a3 fromParm:(unsigned int)a4 atTime:(union { double x0; struct *x1; })a5 retriever:(SEL)a6 imageType:(unsigned long long)a7;
