@class NSSegmentedControl, NSString, NSTextField, NSScrollView, NSLayoutConstraint, DownloadViewController, NSPopover;
...
@property (weak) NSLayoutConstraint *scrollViewBottomConstraint;
