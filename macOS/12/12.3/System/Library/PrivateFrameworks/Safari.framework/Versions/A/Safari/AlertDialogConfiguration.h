...
+ (id)openApplicationPromptConfigurationWithApplicationName:(id)a0 originStringForAccessibility:(id)a1;
+ (id)unableToLoadPageInMainFrameConfigurationWithFailingURL:(id)a0;
+ (id)unableToOpenITunesURLConfigurationWithFailingURL:(id)a0;
...
+ (id)authenticatorDialogConfigurationForPanel:(id)a0 type:(long long)a1 withPresentationBlock:(id /* block */)a2 customLeftMostAction:(id /* block */)a3 tableData:(id)a4 tableDidSelectRowAction:(id /* block */)a5;
+ (id)requestWebAuthenticationConfigurationForDomain:(id)a0;
