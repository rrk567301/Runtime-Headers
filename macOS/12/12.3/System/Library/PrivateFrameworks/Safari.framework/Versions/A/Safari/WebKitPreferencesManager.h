...
+ (id)_webViewConfigurationForBrowsingMode:(unsigned long long)a0 relatedWebView:(id)a1 groupIdentifier:(id)a2 preferences:(id)a3 userContentController:(id)a4 preferencesManager:(id)a5;
