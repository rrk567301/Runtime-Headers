...
@property (retain, nonatomic) NSMutableArray *changedAtomBatchs;
...
- (void)addChangedAtomBatch:(id)a0;
...
- (unsigned long long)changedAtomBatchsCount;
- (void)clearChangedAtomBatchs;
- (id)changedAtomBatchAtIndex:(unsigned long long)a0;
