...
+ (id)overrideKeys;
+ (id)_generatePCSIdentityOptionsForService:(id)a0 forBackingFakeAccount:(id)a1 withError:(id *)a2;
...
+ (BOOL)_rollTestAccountIdentitySetForService:(id)a0 forBackingFakeAccount:(id)a1 withError:(id *)a2;
