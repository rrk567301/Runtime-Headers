@class _HMContext, HMFTimer, NSMutableArray, NSString, HMApplicationData, HMELastEventStore, HMUserActionPredictionProvider, HMHome, NSArray, NSCountedSet, NSObject, HMAccessorySettingsMetricsDispatcher, HMMutableArray, HMAccessorySetupCoordinator, NSSet, HMCacheManager, NSOperationQueue, HMCoreAnalyticsMetricEventDispatcher, HMNetworkRouterFirewallRuleManager, HMUserCloudShareManager, HMAccessory, HMXPCEventRouterClient, NSUUID, HMFUnfairLock, HMHomeManagerConfiguration, NSNumber;
