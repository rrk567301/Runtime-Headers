@class CSPhoneCallStateMonitor, CSSpeechManager, CSOpportuneSpeakEventMonitor, NSObject, CSOSTransaction, NSMutableArray, CSAudioStream, CSSiriClientBehaviorMonitor, CSAudioProvider, NSString, CSKeywordAnalyzerNDAPI, CSVoiceTriggerSecondPass, CSVoiceTriggerEnabledMonitor, CSAsset;
...
- (id)initWithSpeechManager:(id)a0 voiceTriggerEnabledMonitor:(id)a1 siriClientBehaviorMonitor:(id)a2 opportuneSpeakEventMonitor:(id)a3 phoneCallStateMonitor:(id)a4;
- (void)_stopListening;
