...
- (id)initWithModelDescription:(id)a0 expectedInputShape:(id)a1 expectedOutputShape:(id)a2 graph:(struct unique_ptr<DSPGraph::Graph, std::default_delete<DSPGraph::Graph>> { struct __compressed_pair<DSPGraph::Graph *, std::default_delete<DSPGraph::Graph>> { struct Graph *x0; } x0; })a3 error:(id *)a4;
