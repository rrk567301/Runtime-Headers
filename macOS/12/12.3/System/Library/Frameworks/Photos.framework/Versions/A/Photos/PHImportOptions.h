@class NSSortDescriptor, NSString, PHCollectionList, NSMutableDictionary, PHPhotoLibrary, PHAssetCollection, PHImportSource;

@interface PHImportOptions : NSObject {
    struct options_bits { unsigned char preserveFolderStructure : 1; unsigned char hideProgress : 1; unsigned char skipAlertWhenFinished : 1; unsigned char referencedImport : 1; unsigned char allowDuplicates : 1; unsigned char skipDiskSpaceCheck : 1; unsigned char deleteAfterImport : 1; unsigned char metadataAddMode : 1; unsigned char omitImportComplete : 1; unsigned char allowUnsupported : 1; unsigned char fileOperation : 3; unsigned char importedBy : 8; } _options_bits;
}
...
- (void).cxx_destruct;
- (short)importedBy;
- (void)setImportedBy:(short)a0;
- (BOOL)omitImportComplete;
- (void)setOmitImportComplete:(BOOL)a0;
- (BOOL)allowUnsupported;
- (void)setAllowUnsupported:(BOOL)a0;
