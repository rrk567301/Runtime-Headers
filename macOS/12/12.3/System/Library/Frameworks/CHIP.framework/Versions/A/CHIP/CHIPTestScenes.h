...
- (void)writeAttributeNameSupportWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSceneCountWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentSceneWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentGroupWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSceneValidWithValue:(id)a0 completionHandler:(id /* block */)a1;
