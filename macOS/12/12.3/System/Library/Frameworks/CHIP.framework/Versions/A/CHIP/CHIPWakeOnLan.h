...
- (void)readAttributeWakeOnLanMacAddressWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeWakeOnLanMacAddressWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
