...
- (void)readAttributeAudioOutputListWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeAudioOutputListWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeCurrentAudioOutputWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeCurrentAudioOutputWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
