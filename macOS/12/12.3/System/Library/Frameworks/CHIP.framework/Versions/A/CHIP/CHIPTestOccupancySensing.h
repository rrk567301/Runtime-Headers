...
- (void)writeAttributeOccupancyWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeOccupancySensorTypeWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeOccupancySensorTypeBitmapWithValue:(id)a0 completionHandler:(id /* block */)a1;
