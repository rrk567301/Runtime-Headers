...
- (void)writeAttributeAudioOutputListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentAudioOutputWithValue:(id)a0 completionHandler:(id /* block */)a1;
