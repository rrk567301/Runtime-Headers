...
- (void)writeAttributePlaybackStateWithValue:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)writeAttributePositionUpdatedAtWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributePositionWithValue:(id)a0 completionHandler:(id /* block */)a1;
