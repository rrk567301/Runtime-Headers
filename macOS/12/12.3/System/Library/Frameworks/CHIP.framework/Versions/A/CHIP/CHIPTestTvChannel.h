...
- (void)writeAttributeTvChannelListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeTvChannelLineupWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentTvChannelWithValue:(id)a0 completionHandler:(id /* block */)a1;
