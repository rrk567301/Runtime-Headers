...
- (void)readAttributeAcceptsHeaderListWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeAcceptsHeaderListWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeSupportedStreamingTypesWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeSupportedStreamingTypesWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
