...
- (void)subscribeAttributeOccupancyWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeOccupancySensorTypeWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeOccupancySensorTypeWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeOccupancySensorTypeBitmapWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeOccupancySensorTypeBitmapWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
