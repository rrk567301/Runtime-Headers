...
- (void)readAttributeGroupsWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeGroupsWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeGroupKeysWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeGroupKeysWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
