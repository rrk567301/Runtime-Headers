...
- (void)identifyQueryWithCompletionHandler:(id /* block */)a0;
...
- (void)subscribeAttributeIdentifyTimeWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeIdentifyTypeWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeIdentifyTypeWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
