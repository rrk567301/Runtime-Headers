...
- (void)writeAttributeMediaInputListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentMediaInputWithValue:(id)a0 completionHandler:(id /* block */)a1;
