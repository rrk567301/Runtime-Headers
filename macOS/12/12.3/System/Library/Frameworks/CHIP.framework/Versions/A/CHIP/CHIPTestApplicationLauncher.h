...
- (void)writeAttributeApplicationIdWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCatalogVendorIdWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeApplicationLauncherListWithValue:(id)a0 completionHandler:(id /* block */)a1;
