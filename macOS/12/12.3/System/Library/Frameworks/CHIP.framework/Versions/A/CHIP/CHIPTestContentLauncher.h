...
- (void)writeAttributeAcceptsHeaderListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSupportedStreamingTypesWithValue:(id)a0 completionHandler:(id /* block */)a1;
