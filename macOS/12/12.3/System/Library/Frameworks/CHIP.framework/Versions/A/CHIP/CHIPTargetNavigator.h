...
- (void)readAttributeTargetNavigatorListWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeTargetNavigatorListWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
