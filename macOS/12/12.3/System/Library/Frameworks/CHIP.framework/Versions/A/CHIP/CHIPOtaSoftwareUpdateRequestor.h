...
- (void)readAttributeDefaultOtaProviderWithCompletionHandler:(id /* block */)a0;
- (void)writeAttributeDefaultOtaProviderWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)subscribeAttributeDefaultOtaProviderWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
- (void)readAttributeUpdatePossibleWithCompletionHandler:(id /* block */)a0;
- (void)subscribeAttributeUpdatePossibleWithMinInterval:(unsigned short)a0 maxInterval:(unsigned short)a1 subscriptionEstablished:(id /* block */)a2 reportHandler:(id /* block */)a3;
