...
@interface WKGroupActivitiesCoordinatorDelegate : NSObject <AVPlaybackCoordinatorPlaybackControlDelegate> {
    struct WeakPtr<WebKit::GroupActivitiesCoordinator, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<>, WTF::RawPtrTraits<WTF::WeakPtrImpl<>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<>>> { void *m_ptr; } m_impl; } _parent;
}
