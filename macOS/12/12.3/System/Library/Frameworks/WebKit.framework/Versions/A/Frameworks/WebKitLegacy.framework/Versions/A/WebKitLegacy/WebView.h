...
- (void)reload:(id)a0;
- (void)_searchWithSpotlightFromMenu:(id)a0;
...
- (void)_addScrollerDashboardRegions:(id)a0;
- (id)_dashboardRegions;
- (void)_setDashboardBehavior:(int)a0 to:(BOOL)a1;
- (BOOL)_dashboardBehavior:(int)a0;
...
- (struct WebMediaPlaybackTargetPicker { void /* function */ **x0; struct Page *x1; id x2; } *)_devicePicker;
- (id)textTouchBar;
...
- (void)_showDictationAlternativeUI:(const struct FloatRect { struct FloatPoint { float x0; float x1; } x0; struct FloatSize { BOOL x0; BOOL x1; float x2; float x3; } x1; } *)a0 forDictationContext:(struct ObjectIdentifier<WebCore::DictationContextType> { unsigned long long x0; })a1;
- (void)_removeDictationAlternatives:(struct ObjectIdentifier<WebCore::DictationContextType> { unsigned long long x0; })a0;
- (struct Vector<WTF::String, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct String *x0; unsigned int x1; unsigned int x2; })_dictationAlternatives:(struct ObjectIdentifier<WebCore::DictationContextType> { unsigned long long x0; })a0;
...
- (void)_addPlaybackTargetPickerClient:(struct ObjectIdentifier<WebCore::PlaybackTargetClientContextIdentifierType> { unsigned long long x0; })a0;
- (void)_removePlaybackTargetPickerClient:(struct ObjectIdentifier<WebCore::PlaybackTargetClientContextIdentifierType> { unsigned long long x0; })a0;
- (void)_showPlaybackTargetPicker:(struct ObjectIdentifier<WebCore::PlaybackTargetClientContextIdentifierType> { unsigned long long x0; })a0 location:(const struct IntPoint { int x0; int x1; } *)a1 hasVideo:(BOOL)a2;
- (void)_playbackTargetPickerClientStateDidChange:(struct ObjectIdentifier<WebCore::PlaybackTargetClientContextIdentifierType> { unsigned long long x0; })a0 state:(struct OptionSet<WebCore::MediaProducerMediaState> { unsigned int x0; })a1;
