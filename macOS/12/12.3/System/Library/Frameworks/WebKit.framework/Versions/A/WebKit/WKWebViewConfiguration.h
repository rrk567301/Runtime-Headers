@class _WKWebsiteDataStore, NSString, NSArray, _WKApplicationManifest, NSSet, WKProcessPool, WKPreferences, WKUserContentController, WKWebpagePreferences, _WKVisitedLinkStore, WKWebsiteDataStore, WKWebView;
