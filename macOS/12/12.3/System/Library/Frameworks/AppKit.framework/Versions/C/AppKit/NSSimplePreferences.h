...
- (void)_addTabForSettingsPlist:(id)a0 inBundle:(id)a1 withTitle:(id)a2;
...
- (id)_createToggleControlForItem:(id)a0 valueKeyPath:(id)a1 bindOptions:(id)a2 title:(id)a3 inBundle:(id)a4 stringsTable:(id)a5 optionalFooter:(id)a6 module:(id)a7 nextItem:(id)a8;
