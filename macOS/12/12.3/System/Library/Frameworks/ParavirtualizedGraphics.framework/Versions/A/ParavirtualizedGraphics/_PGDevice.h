...
@interface _PGDevice : NSObject <PGDevice> {
    ...
    struct APVFeatures { BOOL objectTables; BOOL efiDisplay; BOOL displayDoorbell; BOOL mapperIOSurfaces; BOOL synchronizeAndDiscardResources; BOOL displayMapperSurface; BOOL discardResources; BOOL displaySleep; BOOL supportsRGhAPresents; BOOL synchronizeDiscardChildResources; BOOL dualPlaneTextures; } _features;
...
@property (readonly) const struct APVFeatures { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; } *features;
