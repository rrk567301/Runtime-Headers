@class NSNumber, NSMutableDictionary, NSDictionary, INParameterContexts, NSOrderedSet, NSString, INIntentDonationMetadata, INIntentCodableDescription, INIntentKeyParameter, NSArray, _INPBIntentMetadata, PBCodable, INImage, NSUUID;
