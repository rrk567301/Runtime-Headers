...
@interface AGXG13GFamilyThreadedRenderPass : IOGPUMetalParallelRenderCommandEncoder <MTLParallelRenderCommandEncoderSPI> {
    void *_impl;
    NSObject<OS_dispatch_queue> *dispatchQueue;
    struct vector<AGXG13GFamilyRenderContext *, std::allocator<AGXG13GFamilyRenderContext *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG13GFamilyRenderContext **, std::allocator<AGXG13GFamilyRenderContext *>> { id *__value_; } x1; } _subOBJCRenderCommandEncoders;
