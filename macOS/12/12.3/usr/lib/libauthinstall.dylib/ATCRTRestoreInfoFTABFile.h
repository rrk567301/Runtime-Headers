@class NSFileHandle, NSArray, NSMutableData, NSURL, NSData, ATCRTRestoreInfoFTABSubfile, NSMutableArray;

@interface ATCRTRestoreInfoFTABFile : NSObject <NSCopying> {
    NSData *_fileData;
...
@property (readonly) ATCRTRestoreInfoFTABSubfile *manifest;
