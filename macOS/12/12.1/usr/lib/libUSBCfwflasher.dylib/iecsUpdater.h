...
- (BOOL)getAceHeaderOffset:(const char *)a0 ofSize:(unsigned long long)a1 intoRidgeOffset:(unsigned int *)a2 intoAceOffset:(unsigned int *)a3 andLength:(unsigned int *)a4 signature:(id)a5 alternateSignature:(id)a6 andDeviceType:(unsigned int *)a7 andVersion:(unsigned int *)a8 andAppConfigVersion:(unsigned short *)a9;
