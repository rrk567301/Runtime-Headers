...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })_calculateBounds:(id)a0 transform:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a1 ink:(id)a2 strokePath:(id)a3;
+ (void)_consumeRenderVertexes:(id /* block */)a0 ink:(id)a1 strokePath:(id)a2;
