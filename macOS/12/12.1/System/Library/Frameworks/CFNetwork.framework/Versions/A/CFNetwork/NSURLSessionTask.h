@class NSURL, NSURLResponse, NSURLSessionConfiguration, NSURLSessionTaskDependency, NSDictionary, NSURLSession, NSObject, NSURLSessionTaskHTTPAuthenticator, NSURLSessionTaskDependencyTree, NSProgress, __CFN_TaskMetrics, NSDate, NSString, NSURLRequest, __CFN_TransactionMetrics, __NSCFURLSessionDelegateWrapper, NSArray, NSData, NSError, NSUUID;
@protocol __NSURLSessionTaskGroupForConfiguration, SZExtractor, NSURLSessionTaskDelegate, OS_nw_activity, OS_dispatch_queue, NSURLSessionAppleIDContext, OS_nw_endpoint, OS_voucher;
