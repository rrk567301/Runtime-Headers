...
@interface __NSCFURLLocalSessionConnection : __NSCFURLSessionConnection <NSURLAuthenticationChallengeSender, NSCopying> {
    ...
    struct URLConnectionLoader { void /* function */ **x0; struct __CFAllocator *x1; void /* function */ **x2; unsigned char x3; unsigned char x4; struct InterfaceRequiredForLoader *x5; id x6; void /* function */ **x7; void /* function */ **x8; id x9; id x10; long long x11; struct RedirectionRecorder *x12; unsigned char x13; unsigned char x14; unsigned char x15; id x16; unsigned char x17; double x18; double x19; unsigned char x20; struct URLProtocol *x21; id x22; unsigned char x23; struct CoreSchedulingSet *x24; double x25; double x26; unsigned long long x27; struct ConfigFlags { unsigned char x0 : 1; unsigned char x1 : 1; unsigned char x2 : 1; unsigned char x3 : 1; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; } x28; unsigned char x29; unsigned char x30; unsigned char x31; unsigned char x32; unsigned long long x33; unsigned int x34; unsigned char x35; BOOL x36; } *_loader;
    BOOL _canceled;
...
- (void)_didReceiveResponse:(id)a0 sniff:(BOOL)a1 rewrite:(BOOL)a2;
...
- (void)_needConnectedSocketToHost:(id)a0 port:(unsigned long long)a1 completion:(id /* block */)a2;
