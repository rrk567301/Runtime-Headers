...
- (struct __IOSurface { } *)currentSurface:(BOOL)a0;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2;
- (struct __IOSurface { } *)currentSurface:(BOOL)a0 protection:(unsigned long long)a1 needsClear:(BOOL *)a2 readOnly:(BOOL *)a3;
