@class PRLikeness, NSObject, CNAvatarViewModel, CNVariableChangeHelper, CNAvatarCache, CNLikenessEditorPresentationController, CNAvatarView, NSLayoutConstraint, CNContact, NSString, CNContactStore, NSViewController, NSArray, PRPersonaStore, CNAvatarPickerUserSetupMemojiData, CNAvatarPickerUserSetupPictureData;
...
@property (readonly) PRPersonaStore *personaStore;
