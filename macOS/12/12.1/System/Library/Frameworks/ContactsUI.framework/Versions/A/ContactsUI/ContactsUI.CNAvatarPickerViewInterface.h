@class NSColor, CNMemojiMetadata, NSDictionary;
...
@property (nonatomic, readonly) CNMemojiMetadata *memojiMetadata;
...
- (void)configurePickerWith:(id)a0 cropRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 memojiMetadata:(id)a2 initialMonogramText:(id)a3 showsAsCompany:(BOOL)a4 canSaveInitialImage:(BOOL)a5 likenessType:(long long)a6;
