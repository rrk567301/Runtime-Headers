@class NSView, NSString, NSArray, NSScrollView, MKMapItem, MKPlaceAttributionCell, _MKPlaceViewController, NSLayoutConstraint, MKPassthroughView, MKPhotoBigAttributionView, NSButton;
