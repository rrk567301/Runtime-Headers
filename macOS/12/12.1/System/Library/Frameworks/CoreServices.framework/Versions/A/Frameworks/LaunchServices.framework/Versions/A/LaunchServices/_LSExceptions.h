...
- (unsigned int)overrideFlagsForCapability:(const struct PrefsCapabilityInfo { long long x0; id x1; id x2; BOOL x3; BOOL x4; struct __CFString *x5; struct __CFString *x6; struct __CFString *x7; } *)a0 withBundleIdentifier:(id)a1 bundleVersion:(struct LSVersionNumber { unsigned char x0[32]; })a2 overrideDictionary:(id *)a3;
- (void)applyToInfoDictionary:(id)a0;
- (unsigned int)overrideFlagsForCapability:(const struct PrefsCapabilityInfo { long long x0; id x1; id x2; BOOL x3; BOOL x4; struct __CFString *x5; struct __CFString *x6; struct __CFString *x7; } *)a0 withBundleIdentifier:(id)a1 bundleVersion:(struct LSVersionNumber { unsigned char x0[32]; })a2;
