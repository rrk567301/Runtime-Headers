...
- (void)dealloc;
- (void).cxx_destruct;
- (struct CGImageSource { } *)_obtainCreatedCGImageSourceRefAtAddress:(struct CGImageSource **)a0 forSubSampleFactor:(unsigned int)a1 protectedWithUnfairLock:(struct os_unfair_lock_s { unsigned int x0; } *)a2 operatingInLowPriority:(BOOL)a3;
