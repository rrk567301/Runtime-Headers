...
- (id)initWithDevice:(id)a0 keepProbability:(float)a1 seed:(unsigned long long)a2 maskStrideInPixels:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a3;
...
- (id)privateResultStateForSourceImage:(id)a0 sourceStates:(id)a1 destinationImage:(id)a2 commandBuffer:(id)a3 isTemporary:(BOOL)a4;
- (id)initWithDevice:(id)a0 keepProbability:(float)a1 state:(id)a2 maskStrideInPixels:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })a3;
- (void)synchronizeRandomStateOnCommandBuffer:(id)a0;
