...
- (void)encodeTransformToCommandBuffer:(id)a0 sourceTexture:(id)a1 sourceHistogram:(id)a2 sourceHistogramOffset:(unsigned long long)a3 desiredHistogram:(id)a4 desiredHistogramOffset:(unsigned long long)a5;
