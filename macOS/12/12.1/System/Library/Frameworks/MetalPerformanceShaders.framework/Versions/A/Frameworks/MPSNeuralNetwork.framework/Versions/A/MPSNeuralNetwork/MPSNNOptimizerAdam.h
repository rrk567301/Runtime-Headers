...
- (id)initWithDevice:(id)a0 beta1:(double)a1 beta2:(double)a2 epsilon:(float)a3 timeStep:(unsigned long long)a4 optimizerDescriptor:(id)a5;
- (void)encodeToCommandBuffer:(id)a0 inputGradientVector:(id)a1 inputValuesVector:(id)a2 inputMomentumVector:(id)a3 inputVelocityVector:(id)a4 resultValuesVector:(id)a5;
- (void)encodeToCommandBuffer:(id)a0 convolutionGradientState:(id)a1 convolutionSourceState:(id)a2 inputMomentumVectors:(id)a3 inputVelocityVectors:(id)a4 resultState:(id)a5;
- (id)initWithCoder:(id)a0 device:(id)a1;
- (id)initWithDevice:(id)a0 optimizerDescriptor:(id)a1;
- (id)initWithDevice:(id)a0 learningRate:(float)a1;
- (void)encodeToCommandBuffer:(id)a0 inputGradientVector:(id)a1 inputValuesVector:(id)a2 inputMomentumVector:(id)a3 inputVelocityVector:(id)a4 maximumVelocityVector:(id)a5 resultValuesVector:(id)a6;
- (void)encodeToCommandBuffer:(id)a0 inputGradientMatrix:(id)a1 inputValuesMatrix:(id)a2 inputMomentumMatrix:(id)a3 inputVelocityMatrix:(id)a4 maximumVelocityMatrix:(id)a5 resultValuesMatrix:(id)a6;
- (void)encodeToCommandBuffer:(id)a0 convolutionGradientState:(id)a1 convolutionSourceState:(id)a2 inputMomentumVectors:(id)a3 inputVelocityVectors:(id)a4 maximumVelocityVectors:(id)a5 resultState:(id)a6;
- (void)encodeToCommandBuffer:(id)a0 batchNormalizationGradientState:(id)a1 batchNormalizationSourceState:(id)a2 inputMomentumVectors:(id)a3 inputVelocityVectors:(id)a4 maximumVelocityVectors:(id)a5 resultState:(id)a6;
- (void)encodeToCommandBuffer:(id)a0 batchNormalizationState:(id)a1 inputMomentumVectors:(id)a2 inputVelocityVectors:(id)a3 maximumVelocityVectors:(id)a4 resultState:(id)a5;
- (void)encodeToCommandBuffer:(id)a0 inputGradientMatrix:(id)a1 inputValuesMatrix:(id)a2 inputMomentumMatrix:(id)a3 inputVelocityMatrix:(id)a4 resultValuesMatrix:(id)a5;
- (void)encodeToCommandBuffer:(id)a0 batchNormalizationGradientState:(id)a1 batchNormalizationSourceState:(id)a2 inputMomentumVectors:(id)a3 inputVelocityVectors:(id)a4 resultState:(id)a5;
- (void)encodeToCommandBuffer:(id)a0 batchNormalizationState:(id)a1 inputMomentumVectors:(id)a2 inputVelocityVectors:(id)a3 resultState:(id)a4;
