...
- (void)encodeInternalToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceTexture:(id)a2 minmaxTexture:(id)a3 histogram:(id)a4 histogramOffset:(unsigned long long)a5 inputExtent:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; })a6 srcStyle:(int)a7;
- (void)encodeToCommandEncoder:(id)a0 commandBuffer:(id)a1 sourceTexture:(id)a2 minmaxTexture:(id)a3 histogram:(id)a4 histogramOffset:(unsigned long long)a5;
- (void)encodeToCommandBuffer:(id)a0 sourceTexture:(id)a1 minmaxTexture:(id)a2 histogram:(id)a3 histogramOffset:(unsigned long long)a4;
