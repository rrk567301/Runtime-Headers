@class NSImmediateActionGestureRecognizer, PDFScrollView, PDFPasswordViewController, PDFPage, NSObject, PDFAKOverlayAdaptor, PDFAnnotation, NSMutableArray, PDFRenderingProperties, PDFPageView, PDFDocument, PDFRevealManager, PDFCoachMarkManager, NSCursor, PDFSelection, PDFViewLayout, NSArray, PDFViewController, NSTrackingArea, PDFTimer;
