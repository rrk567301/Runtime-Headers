...
- (void)_playbackTargetPickerClientStateDidChange:(struct ObjectIdentifier<WebCore::PlaybackTargetClientContextIdentifierType> { unsigned long long x0; })a0 state:(struct OptionSet<WebCore::MediaProducer::MediaState> { unsigned int x0; })a1;
