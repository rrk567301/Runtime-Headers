...
@property (readonly, retain, nonatomic) TSCECellValue *groupCellValue;
...
- (id)initWithArchive:(const void *)a0 forGroupBy:(id)a1 atLevel:(unsigned char)a2;
- (void)enumerateRowUidsWithBlock:(id /* block */)a0;
- (void)addAggNode:(id)a0;
- (id)safeChildren;
- (void)encodeToArchive:(void *)a0 backwardCompat:(BOOL)a1;
