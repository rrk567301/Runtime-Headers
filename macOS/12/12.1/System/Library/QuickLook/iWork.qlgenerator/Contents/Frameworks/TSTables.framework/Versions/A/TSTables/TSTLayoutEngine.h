...
@property (retain, nonatomic) TSTRWRetainedPointerKeyDictionary *paraStyleToHeightCache;
...
- (struct CGSize { double x0; double x1; })tableNameTextSizeForTableName:(id)a0 maxWidth:(double)a1;
