...
- (unsigned char)hidingActionForUid:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a0 viewRcIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a1;
...
- (void)addHiddenIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0 viewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a1 forAction:(unsigned char)a2;
- (void)hiddenStateChangedForBaseIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0 viewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a1 forAction:(unsigned char)a2;
...
- (void)removeHiddenIndex:(struct TSUModelColumnOrRowIndex { unsigned int x0; })a0 viewIndex:(struct TSUViewColumnOrRowIndex { unsigned int x0; })a1 forAction:(unsigned char)a2;
