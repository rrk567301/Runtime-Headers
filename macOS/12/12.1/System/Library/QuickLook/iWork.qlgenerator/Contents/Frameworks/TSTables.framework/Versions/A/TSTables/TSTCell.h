...
+ (unsigned char)p_cellFormatKindForValueType:(unsigned char)a0;
...
- (void)applyFormulaResult:(const struct TSCEValue { union { struct { struct { unsigned long long x0[2]; } x0; unsigned char x1[24]; unsigned short x2; BOOL x3; } x0; unsigned long long x1[9]; } x0; unsigned char x1; } *)a0;
- (void)applyFormulaResult:(const struct TSCEValue { union { struct { struct { unsigned long long x0[2]; } x0; unsigned char x1[24]; unsigned short x2; BOOL x3; } x0; unsigned long long x1[9]; } x0; unsigned char x1; } *)a0 context:(id)a1 hasWarnings:(BOOL)a2 outWriteDidBeginOrEndWithTextCell:(BOOL *)a3 propagateCheckboxesAndRatings:(BOOL)a4;
...
- (id)p_formatOfCellFormatKind:(unsigned char)a0 create:(BOOL)a1 created:(BOOL *)a2;
