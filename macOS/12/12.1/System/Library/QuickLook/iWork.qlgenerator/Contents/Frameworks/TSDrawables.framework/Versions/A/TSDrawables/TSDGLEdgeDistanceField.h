...
+ (id)distanceFieldTextureWithTexture:(unsigned int)a0 textureSize:(struct CGSize { double x0; double x1; })a1 maxDistance:(long long)a2 edgeInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a3 downsampleScale:(double)a4 floatTexture:(BOOL)a5 GLState:(id)a6;

- (void)dealloc;
- (void)teardown;
- (void)p_setupBuffers;
- (void)p_setupShaders;
- (id)initWithTexture:(unsigned int)a0 textureSize:(struct CGSize { double x0; double x1; })a1 edgeInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2 downsampleScale:(double)a3 GLState:(id)a4;
