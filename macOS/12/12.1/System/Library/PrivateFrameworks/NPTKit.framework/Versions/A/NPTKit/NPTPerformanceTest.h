@class NPTResults, NSString, NPTUpload, NSMutableDictionary, NSDictionary, NetworkQualityExecutions, NPTPerformanceTestConfiguration, NPTPing, NSObject, NPTDownload;
