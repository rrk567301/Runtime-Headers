...
- (id)initWithNetworkActivityParent:(id)a0 concurrentStreams:(unsigned long long)a1 timedUploadLength:(unsigned long long)a2 endWhenStable:(BOOL)a3 stopAtFileSize:(BOOL)a4 callingClient:(id)a5;
