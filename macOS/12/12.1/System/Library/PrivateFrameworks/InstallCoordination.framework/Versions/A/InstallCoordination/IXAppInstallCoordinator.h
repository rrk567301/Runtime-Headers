...
+ (id)_coordinatorForBundleID:(id)a0 targetDirectoryIfInitiating:(id)a1 orTargetBundleIfUpdating:(id)a2 created:(BOOL *)a3 error:(id *)a4;
...
+ (void)_beginInstallForURL:(id)a0 withTargetDirectory:(id)a1 orTargetBundle:(id)a2 consumeSource:(BOOL)a3 shouldOverrideGatekeeper:(BOOL)a4 options:(id)a5 completion:(id /* block */)a6;
