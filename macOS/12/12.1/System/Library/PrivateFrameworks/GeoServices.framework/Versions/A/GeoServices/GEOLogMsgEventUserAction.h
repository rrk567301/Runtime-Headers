...
@interface GEOLogMsgEventUserAction : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_userActionEventAction : 1; unsigned char has_userActionEventTarget : 1; unsigned char read_moduleInfo : 1; unsigned char read_userActionEventKey : 1; unsigned char read_userActionEventValue : 1; unsigned char wrote_anyField : 1; } _flags;
}
