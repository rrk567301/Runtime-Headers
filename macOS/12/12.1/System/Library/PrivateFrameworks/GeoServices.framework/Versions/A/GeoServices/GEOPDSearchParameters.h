@class GEOPDSInferredSignals, GEOPDViewportInfo, GEOPDSSearchFilter, GEOPDETAFilter, GEOPDRecentRouteInfo, PBUnknownFields, GEOPDResultRefinementQuery, GEOPDSSearchEvChargingParameters, GEOPDAutocompleteEntry, NSString, PBDataReader, GEOPDRetainedSearchMetadata, GEOPDSSearchLocationParameters, NSData, GEOPDSSearchStructureIntentRequestType;
