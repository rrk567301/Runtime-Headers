...
@property (readonly, nonatomic) struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *connectivityJunction;
...
+ (struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *)connectivityJunctionForRoadFeature:(id)a0 startJunction:(BOOL)a1 outError:(out id *)a2;
