@class PBUnknownFields, PBDataReader, GEORPFeedbackOverview, GEORPPoiEnrichment, GEORPFeedbackNotification, GEORPFeedbackConversation, GEORPRapInfo;
...
@interface GEORPFeedbackComponentValue : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_conversation : 1; unsigned char read_notification : 1; unsigned char read_overview : 1; unsigned char read_poiEnrichment : 1; unsigned char read_rapInfo : 1; unsigned char wrote_anyField : 1; } _flags;
}
