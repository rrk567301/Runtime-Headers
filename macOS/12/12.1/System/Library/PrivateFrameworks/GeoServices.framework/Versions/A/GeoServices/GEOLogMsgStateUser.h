...
@interface GEOLogMsgStateUser : PBCodable <NSCopying> {
    ...
    BOOL _isTourist;
    struct { unsigned char has_preSyncSessionId : 1; unsigned char has_mapsUseLastDate : 1; unsigned char has_mapsUseStartDate : 1; unsigned char has_syncFirstTimestamp : 1; unsigned char has_syncLastTimestamp : 1; unsigned char has_isSignedInWithDsid : 1; unsigned char has_isTourist : 1; unsigned char read_homeCountryCode : 1; unsigned char read_homeMetroRegion : 1; unsigned char wrote_anyField : 1; } _flags;
}
