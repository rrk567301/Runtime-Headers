@class MNGuidanceSignInfo, GEOMotionContext, MNLocation, GEOApplicationAuditToken, MNAudioManager, MNTraceNavigationEventRecorder, MNVehicleMonitor, GEONavigationGuidanceState, MNTimeAndDistanceUpdater, NSString, MNLocationTracker, MNRouteManager, MNObserverHashTable, MNNavigationSessionLogger, MNGuidanceManager, MNNavigationTraceManager, GEOComposedWaypoint, MNTrafficIncidentAlert, GEOResourceManifestUpdateAssertion, NSUUID;
...
@property (retain, nonatomic) MNAudioManager *audioProvider;
...
- (void)guidanceManager:(id)a0 announce:(id)a1 isImportant:(BOOL)a2 shortPromptType:(unsigned long long)a3 ignorePromptStyle:(BOOL)a4 stage:(unsigned long long)a5 hasSecondaryManeuver:(BOOL)a6 completionBlock:(id /* block */)a7;
...
- (id)_transitStopAtStopIndex:(unsigned long long)a0;
