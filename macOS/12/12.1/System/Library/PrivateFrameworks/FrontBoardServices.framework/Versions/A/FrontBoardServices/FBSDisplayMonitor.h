@class NSEnumerator, FBSDisplayConfiguration, NSString, FBSDisplaySource, NSSet, NSHashTable, CADisplay, NSObject, FBSDisplayIdentity, NSMapTable;
...
- (id)_initWithBookendObserver:(id)a0;
