@class NSMutableDictionary, AFQueue, NSError, AFAnalytics, NSObject, AFWatchdogTimer, AFClientConfiguration, AFInstanceContext, AFOneArgumentSafetyBlock, NSString, AFSiriClientStateManager, AFCallSiteInfo, AFInterstitialProvider, NSArray, USTAgentConnection, NSXPCConnection, AFAudioPowerUpdater, NSUUID;
