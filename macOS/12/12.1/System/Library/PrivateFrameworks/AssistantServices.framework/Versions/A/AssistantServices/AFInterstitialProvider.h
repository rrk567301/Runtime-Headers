...
- (void).cxx_destruct;
- (void)_invalidate;
- (id)initWithStyle:(long long)a0 recordRoute:(id)a1 isVoiceTrigger:(BOOL)a2 isDucking:(BOOL)a3 isTwoShot:(BOOL)a4 speechEndHostTime:(unsigned long long)a5 context:(id)a6 instanceContext:(id)a7 delegate:(id)a8;
