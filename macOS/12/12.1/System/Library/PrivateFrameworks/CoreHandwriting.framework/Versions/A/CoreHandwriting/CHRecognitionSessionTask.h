...
@property (readonly, retain, nonatomic) NSObject<OS_dispatch_queue> *_recognizersQueue;
@property (readonly, retain, nonatomic) CHStrokeClassificationModel *strokeClassificationModel;
@property (readonly, retain, nonatomic) NSArray *subjectStrokeIdentifiers;
@property BOOL cancelled;
@property (copy, nonatomic) id /* block */ partialResultBlock;
@property (readonly, retain, nonatomic) CHRecognitionSessionResult *inputResult;
