...
@interface AutoFillFunctionBarProvider : NSObject <AutoFillCandidateListBarItemControllerDelegate, NSTouchBarDelegate, FormAutoFillCompletionControllerObserver, NSTouchBarProvider> {
    struct Vector<WTF::RefPtr<Safari::CompletionListItem>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> { void *m_buffer; unsigned int m_capacity; unsigned int m_size; } _currentCompletionListItems;
...
- (id)candidateListBarItemController:(id)a0 imageForCandidateAtIndex:(unsigned long long)a1;
