...
- (int)_performCredentialAutoFillActionForForm:(id)a0 ofType:(unsigned long long)a1 inViewController:(id)a2 isPreFill:(BOOL)a3 isUserInitiated:(BOOL)a4 frame:(const void *)a5;
...
- (void)_handleCredentialAutoFillActionWithSuccess:(BOOL)a0 shouldSubmit:(BOOL)a1 browserViewController:(id)a2 isPreFill:(BOOL)a3 frameHandle:(id)a4 mainFrameHandle:(id)a5 autoFillValues:(id)a6 formMetadata:(id)a7 autoFillCredentialMatch:(id)a8;
...
- (void)willSubmitFormWithCredentials:(id)a0 shouldPreferAnnotatedCredentials:(BOOL)a1 toFrame:(const void *)a2 fromFrame:(const void *)a3 forceConfirmationIfOverwritingSavedPassword:(BOOL)a4 passwordGenerationCredentials:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)_saveFormDataIfNecessary:(id)a0 page:(const void *)a1 frame:(const void *)a2 sourceFrame:(const void *)a3 values:(id)a4 forceConfirmationIfOverwritingSavedPassword:(BOOL)a5 passwordGenerationCredentials:(id)a6 completionHandler:(id /* block */)a7;
