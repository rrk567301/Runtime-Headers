@class NSTimer, NSString, NSURL, ReadingListDataStore, NSMutableDictionary, NSMutableSet, NSObject, NSMutableArray, NSCache;
...
- (void)thumbnailImageForUUID:(id)a0 completionHandler:(id /* block */)a1;
...
- (void)_saveThumbnailImage:(id)a0 forItem:(id)a1;
- (void)_didReceiveNetworkChangeNotification;
- (id)_archiveFolderURLForReadingListItemUUID:(id)a0;
- (void)_fetchThumbnailImageWithURL:(id)a0 forItem:(id)a1;
