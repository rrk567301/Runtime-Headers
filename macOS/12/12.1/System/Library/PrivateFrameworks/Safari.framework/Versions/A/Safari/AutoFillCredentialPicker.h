@class AuthorizationSheetViewController, SecureWindowLockPolicyEnforcer, NSButton, WBSAutoFillQuirksManager, NSMutableArray, WBSSiteMetadataManager, NSSearchField, NSString, NSWindow, NSArray, NSView, WBSSavedPasswordStore, NSTextField, WBSFaviconRequestsController;
...
- (void)showSheetInWindow:(id)a0 forPurpose:(long long)a1 savedPasswordStore:(id)a2 siteMetadataManager:(id)a3 autoFillQuirksManager:(id)a4 withCompletionHandler:(id /* block */)a5;
