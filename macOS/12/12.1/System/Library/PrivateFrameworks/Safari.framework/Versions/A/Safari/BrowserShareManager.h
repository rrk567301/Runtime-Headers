...
@interface BrowserShareManager : NSObject <BrowserSharingServiceInvocationDelegate, NSMenuDelegate, NSMenuItemValidation, NSSharingServiceDelegate, NSSharingServicePickerDelegate> {
    struct HashMap<unsigned long long, WTF::RetainPtr<BrowserSharingOperation>, WTF::DefaultHash<unsigned long long>, WTF::HashTraits<unsigned long long>, WTF::HashTraits<WTF::RetainPtr<BrowserSharingOperation>>, WTF::HashTableTraits> { struct HashTable<unsigned long long, WTF::KeyValuePair<unsigned long long, WTF::RetainPtr<BrowserSharingOperation>>, WTF::KeyValuePairKeyExtractor<WTF::KeyValuePair<unsigned long long, WTF::RetainPtr<BrowserSharingOperation>>>, WTF::DefaultHash<unsigned long long>, WTF::HashMap<unsigned long long, WTF::RetainPtr<BrowserSharingOperation>>::KeyValuePairTraits, WTF::HashTraits<unsigned long long>> { union { void *m_table; unsigned int *m_tableForLLDB; } ; } m_impl; } _browserSharingOperationMap;
