@class NSTextField, NSString, NSScrollView, NSTimer, PasswordsDetailTOTPSecretEntryViewController, NSStackView, WBSSavedPassword, NSMutableArray, NSLayoutConstraint, NSButton, TableViewPlus;
@protocol PasswordsDetailSheetTOTPViewControllerDelegate;

@interface PasswordsDetailSheetTOTPViewController : NSViewController <TableViewPlusDataSource, TableViewPlusDelegate, PasswordsDetailTOTPSecretEntryViewControllerDelegate> {
    NSTimer *_totpTimer;
    NSMutableArray *_totpGenerators;
    PasswordsDetailTOTPSecretEntryViewController *_secretEntryController;
}
...
@property (weak, nonatomic) id<PasswordsDetailSheetTOTPViewControllerDelegate> delegate;
