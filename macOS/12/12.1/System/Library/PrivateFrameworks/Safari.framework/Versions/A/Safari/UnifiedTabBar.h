@class WBSDispatchSourceTimer, UnifiedTabBarItem, NSMapTable, NSPopUpButton, NSScrollView, UnifiedTabBarButton, NSMutableArray, NSOrderedSet, NSString, UnifiedTabBarClipView, NSIndexSet, UnifiedTabBarLayout, NSMutableSet, NSArray, NSView, NSTrackingArea, CABackdropLayer, TabPreviewWindowController;
@protocol UnifiedTabBarDelegate, TabPreviewDataSource;

@interface UnifiedTabBar : NSView <DetachedTabDraggingImageToWindowTransitionControllerDelegate, MorphingDragImageControllerDragSource, TabPreviewWindowControllerDelegate, UnifiedTabBarAccessibilityElementDelegate, UnifiedTabBarButtonDelegate, TabDraggingDestination> {
...
@property (readonly, copy, nonatomic) NSIndexSet *selectedTabBarItemIndexes;
...
- (void)unifiedTabBarButton:(id)a0 accessoryViewsCountChanged:(long long)a1;
...
- (void)_moveTabBarItem:(id)a0 toIndex:(unsigned long long)a1;
...
- (long long)unifiedTabBarButtonStyle:(id)a0;
