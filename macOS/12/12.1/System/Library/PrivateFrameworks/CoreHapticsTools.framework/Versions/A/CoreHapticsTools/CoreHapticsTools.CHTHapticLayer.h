@interface CoreHapticsTools.CHTHapticLayer : CoreHapticsTools.CHTLayer {
    void /* unknown type, empty encoding */ maxSingleThreadEvents;
    void /* unknown type, empty encoding */ timeDomainParameterPointsForTransientEvents;
    void /* unknown type, empty encoding */ contextSizedPathForTransientEvents;
    ...
    void /* unknown type, empty encoding */ contextSizedPathForContinuousEvents;
