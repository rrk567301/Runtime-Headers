...
@interface CKDPZoneRetrieveResponseZoneSummary : PBCodable <NSCopying> {
    struct { unsigned char assetQuotaUsage : 1; unsigned char metadataQuotaUsage : 1; unsigned char deviceCount : 1; unsigned char zoneKeyRollAllowed : 1; unsigned char zoneishPcsNeedsRolled : 1; } _has;
}
