...
- (BOOL)addParameters;
- (BOOL)frameCleanup;
- (BOOL)getHeliumImage:(id *)a0 layerOffsetX:(double *)a1 layerOffsetY:(double *)a2 requestInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a3 fromParm:(int)a4 atTime:(union { double x0; struct *x1; })a5;
...
- (BOOL)getHeliumImage:(id *)a0 source:(BOOL)a1 withInfo:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a2 atTime:(union { double x0; struct *x1; })a3;
...
- (BOOL)isWideGamutHDRImage:(id)a0;
...
- (void)overrideFrameSetupForRenderMode:(struct { union { double x0; struct *x1; } x0; unsigned long long x1; unsigned long long x2; double x3; double x4; struct _CGLContextObject *x5; unsigned long long x6; })a0 hardware:(BOOL *)a1 software:(BOOL *)a2;
