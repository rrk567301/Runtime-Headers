...
- (void)estimateOfPurgeableSpaceForSandboxesOnVolume:(id)a0 systemSandboxes:(BOOL)a1 reply:(id /* block */)a2;
...
- (void)purgeableSpaceForOrphanedSandboxesOnVolume:(id)a0 reply:(id /* block */)a1;
...
- (void)startListeningForConnectionsToService:(id)a0;
