...
+ (unsigned long long)purgeSandboxesOnVolume:(id)a0 purgeAmountNeeded:(unsigned long long)a1 systemSandboxes:(BOOL)a2;
+ (unsigned long long)purgeableSpaceForOrphanedSandboxesOnVolume:(id)a0;
