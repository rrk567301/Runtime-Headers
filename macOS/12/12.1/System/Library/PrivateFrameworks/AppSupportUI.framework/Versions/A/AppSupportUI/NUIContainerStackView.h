...
@interface NUIContainerStackView : NUIContainerView <_NUIGridArrangementContainer> {
    ...
    struct map<NSView *, double, std::less<NSView *>, std::allocator<std::pair<NSView *const, double>>> { struct __tree<std::__value_type<NSView *, double>, std::__map_value_compare<NSView *, std::__value_type<NSView *, double>, std::less<NSView *>, true>, std::allocator<std::__value_type<NSView *, double>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<NSView *, double>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<NSView *, std::__value_type<NSView *, double>, std::less<NSView *>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _customSpacings;
