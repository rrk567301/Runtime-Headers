...
- (struct CGPoint { double x0; double x1; })_shiftCorrectionForLeftStrip:(BOOL)a0 byRegisteringWide:(struct opaqueCMSampleBuffer { } *)a1 tele:(struct opaqueCMSampleBuffer { } *)a2 centerBias:(BOOL)a3 widerToNarrowerCameraScale:(double)a4 isMacroScene:(BOOL)a5 err:(int *)a6;
