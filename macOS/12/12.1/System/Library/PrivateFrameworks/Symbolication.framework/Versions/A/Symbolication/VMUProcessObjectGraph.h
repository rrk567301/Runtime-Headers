@class VMUTaskMemoryScanner, VMUSymbolStore, VMUDebugTimer, NSArray, VMUNodeToStringMap, NSString, NSDictionary, VMUClassInfoMap, VMURangeToStringMap, VMUGraphStackLogReader;
