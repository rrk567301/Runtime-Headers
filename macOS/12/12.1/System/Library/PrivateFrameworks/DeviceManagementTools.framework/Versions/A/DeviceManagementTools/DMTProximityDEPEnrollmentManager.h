...
@protocol DMTRemoteSetupBroadcasting, DMTProximityDEPEnrollmentManagerTransitionDelegate, DMTDeviceInformationPrimitives, DMTProximityDEPEnrollmentManagerViewControllerPresentingDelegate, MBSecondPartyHost;

@interface DMTProximityDEPEnrollmentManager : NSObject <CATTaskServerDelegate>
