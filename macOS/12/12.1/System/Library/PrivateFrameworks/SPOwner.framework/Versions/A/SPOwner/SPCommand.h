...
+ (id)startSharingWithBeaconUUID:(id)a0 handle:(id)a1 expiration:(id)a2;
+ (id)stopSharingWithBeaconUUID:(id)a0 handle:(id)a1;
+ (id)acceptShareWithBeaconUUID:(id)a0;
+ (id)declineShareWithBeaconUUID:(id)a0;
