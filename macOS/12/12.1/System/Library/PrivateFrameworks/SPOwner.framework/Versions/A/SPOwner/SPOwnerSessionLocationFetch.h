...
- (oneway void)subscribeAndFetchLocationForContext:(id)a0 completion:(id /* block */)a1;
- (oneway void)unsubscribeLocationUpdatesWithCompletion:(id /* block */)a0;
- (void)setInvalidationBlock:(id /* block */)a0;
- (double)_decayedWaitIntervalForRetryCount:(unsigned long long)a0;
- (oneway void)receivedUpdatedLocation:(id)a0;
