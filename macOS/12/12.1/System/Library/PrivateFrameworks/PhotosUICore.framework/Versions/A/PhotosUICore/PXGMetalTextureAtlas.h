...
- (id)initWithThumbnailSize:(struct CGSize { double x0; double x1; })a0 pixelFormat:(unsigned long long)a1 capacity:(unsigned int)a2 colorProgram:(id)a3 device:(id)a4 layoutQueue:(id)a5;
