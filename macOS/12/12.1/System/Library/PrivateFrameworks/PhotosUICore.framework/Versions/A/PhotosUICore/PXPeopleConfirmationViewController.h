@class NSTimer, PXPeopleSuggestionView, NSProgressIndicator, PXPeopleConfirmationLoadingView, PXPeopleConfirmationSummaryViewController, PXAnimatedHeaderView, UXLabel, PXPeopleSuggestionManager, NSString;
