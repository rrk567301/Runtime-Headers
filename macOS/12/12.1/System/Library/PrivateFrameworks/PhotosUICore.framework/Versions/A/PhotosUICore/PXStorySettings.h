@class PXStoryTransitionsSettings, NSString, PXStoryScrubberLayoutSettings, PXStoryConcreteTimelineSettings;
...
@property (nonatomic) BOOL wantsInternalActions;
@property (nonatomic) BOOL wantsInternalErrorsAndOptions;
...
@property (nonatomic) BOOL allowsErrorIndicator;
...
@property (nonatomic) unsigned long long fullsizePaperTrailOptions;
...
@property (nonatomic) BOOL isExportEnabled;
@property (nonatomic) BOOL renderTitlesForRelated;
@property (nonatomic) BOOL shouldReplaceMemoryDetailsView;
@property (nonatomic) BOOL shouldReplaceMemoriesGadget;
@property (nonatomic) BOOL shouldReplaceMemoriesGadgetDataSource;
@property (nonatomic) BOOL shouldReplaceMemoriesFeed;
@property (nonatomic) BOOL enableCreateMemoryFromCollectionAction;
...
@property (nonatomic) BOOL shouldAlwaysPreserveOriginalPersistedStyle;
...
@property (nonatomic) BOOL allowsSongInChromeSubtitle;
...
@property (nonatomic) BOOL enableCompactEditSheetStyle;
@property (nonatomic) BOOL wantsEditSheet;
@property (nonatomic) BOOL wantsCustomEditSheet;
...
@property (nonatomic) BOOL shouldCapFeedItemWidth;
