@class NSDate, NSString, NSLock, EMRemoteContentURLSession, EDRemoteContentPersistence, ECRemoteContentParser, NSBackgroundActivityScheduler, EFCancelationToken, EFLocked;
@protocol EFScheduler, EDRemoteContentManagerTestDelegate;

@interface EDRemoteContentManager : NSObject <EDContentRuleListManagerObserver> {
