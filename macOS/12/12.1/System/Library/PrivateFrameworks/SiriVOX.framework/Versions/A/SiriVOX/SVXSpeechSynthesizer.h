@class NSString, SVXSessionManager, SVXSpeechSynthesisConfiguration, SVXModule, NSMutableArray, SVXSpeechSynthesisContext, SVXSpeechSynthesisAnnouncer, NSMutableSet;
