...
@property (retain, nonatomic) NSButton *publicButton;
@property (retain, nonatomic) NSButton *friendsOnlyButton;
@property (retain, nonatomic) NSButton *meOnlyButton;
...
@property NSView *privateContainer;
@property NSView *friendsOnlyContainer;
