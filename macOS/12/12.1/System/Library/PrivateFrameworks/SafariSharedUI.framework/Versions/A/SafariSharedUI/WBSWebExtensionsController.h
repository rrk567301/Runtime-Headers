@class NSMutableDictionary, NSMapTable, NSHashTable, _WKRemoteObjectInterface, WBSCoreAnalyticsExtensionsStatistics;
...
- (id)contextMenuItemsForContext:(id)a0;
...
- (void)executeScriptWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)insertCSSWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)removeCSSWithDetails:(id)a0 fromExtensionWithID:(id)a1 toTabWithID:(id)a2 webView:(id)a3 completionHandler:(id /* block */)a4;
...
- (void)createInspectorTabWithName:(id)a0 tabIconURL:(id)a1 sourceURL:(id)a2 extensionIdentifier:(id)a3 webView:(id)a4 completionHandler:(id /* block */)a5;
- (void)evaluateScript:(id)a0 frameURL:(id)a1 contextSecurityOrigin:(id)a2 useContentScriptContext:(BOOL)a3 extensionIdentifier:(id)a4 webView:(id)a5 completionHandler:(id /* block */)a6;
- (void)reloadIgnoringCache:(BOOL)a0 userAgent:(id)a1 injectedScript:(id)a2 extensionIdentifier:(id)a3 webView:(id)a4;
- (id)_allWindows;
...
- (void)_loadPermissionsFromStorageForWebExtension:(id)a0;
...
- (id)_validateRulesetIDs:(id)a0 webExtension:(id)a1;
...
- (void)fireOnUpdatedEventForTab:(id)a0 toExtension:(id)a1 withChangedProperties:(unsigned long long)a2;
