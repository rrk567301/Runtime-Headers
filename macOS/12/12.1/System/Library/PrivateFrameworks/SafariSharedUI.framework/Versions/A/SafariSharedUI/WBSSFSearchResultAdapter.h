@class NSURL, WBSParsecFlightFetcher, MKMapItem, SFSearchResult, WBSParsecImageRepresentation, WBSParsecActionButton, NSString, WBSQuerySuggestion, WBSParsecSearchMapsResultFeedbackSender, NSArray, WBSParsecSearchSportsAttributionExtraCompletionItem, WBSParsecAuxiliaryInfo, NSNumber, WBSParsecSportsScoreSummary;
