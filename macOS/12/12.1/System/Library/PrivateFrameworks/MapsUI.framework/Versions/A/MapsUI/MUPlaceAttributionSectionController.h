@class NSView, MUPlaceSectionFooterViewModel, NSString, MUPlaceSectionHeaderViewModel, MKPlaceAttributionViewController, NSViewController, MUPlaceSectionView, MKUGCCallToActionViewAppearance;
