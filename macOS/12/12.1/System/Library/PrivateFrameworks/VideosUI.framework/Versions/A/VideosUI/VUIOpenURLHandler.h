...
+ (void)_pushViewControllers:(id)a0 into:(id)a1 animated:(BOOL)a2 clearStack:(BOOL)a3;
...
- (void)_processLink:(id)a0 appContext:(id)a1 isDeeplink:(BOOL)a2 contextData:(id)a3 completion:(id /* block */)a4;
...
- (void)_postPurchaseOrLinkingProcessing:(id)a0 offerType:(unsigned long long)a1;
- (void)_handleBundleOfferCompletion:(BOOL)a0;
- (void)_displayPurchaseConfirmationForOfferType:(unsigned long long)a0;
