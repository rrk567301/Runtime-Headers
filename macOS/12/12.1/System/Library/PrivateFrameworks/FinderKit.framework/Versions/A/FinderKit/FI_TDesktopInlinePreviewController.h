@class QLPreviewView, NSString, QLInlinePreviewController, NSValue, NSObject;
...
@interface FI_TDesktopInlinePreviewController : NSObject <QLInlinePreviewDelegate, TTrackingAreaOwnerProtocol> {
    ...
    struct TNSWeakPtr<NSObject<TDesktopInlinePreviewDataSource>, void> { NSValue *fWeakObject; } _weakDataSource;
