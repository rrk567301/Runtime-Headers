@class NSMenuItem, NSString, NSValue, NSMenu, FI_TNodeViewSettings, FI_TViewOptionsSettingsController;
...
@interface FI_TArrangeByMenuController : NSObject <NSMenuItemValidation> {
    ...
    int _groupBy;
    int _sortBy;
    struct TNSWeakPtr<FI_TViewOptionsSettingsController, void> { NSValue *fWeakObject; } _weakViewOptionsSettingsController;
...
- (void)setViewOptionsSettingsController:(id)a0;
...
- (id)viewOptionsSettingsController;
