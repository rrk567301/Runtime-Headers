...
+ (id)calculateNormalizedShareFrequencyForContactGivenContactIdPredicate:(id)a0 totalFrequency:(id)a1 numberOfDaysToLookBack:(int)a2 timeOfShareInteraction:(id)a3 interactionStore:(id)a4;
+ (unsigned int)enforceOneSignificantFigureForSmallDouble:(double)a0;
+ (id)calculateNormalizedTextingFrequencyForContactGivenContactIdPredicate:(id)a0 totalFrequency:(id)a1 numberOfDaysToLookBack:(int)a2 timeOfShareInteraction:(id)a3 interactionStore:(id)a4 direction:(id)a5;
...
+ (id)calculateNormalizedCallingFrequencyForContactGivenContactIdPredicate:(id)a0 totalFrequency:(id)a1 numberOfDaysToLookBack:(int)a2 timeOfShareInteraction:(id)a3 interactionStore:(id)a4 direction:(id)a5;
...
+ (void)extractFrequencyRecencyFeaturesIntoPETMessage:(id)a0 recipientID:(id)a1 interaction:(id)a2 normConstants:(id)a3 numberOfDaysToLookBack:(int)a4 interactionStore:(id)a5 timeOfShareInteraction:(id)a6 contactPropertyCache:(id)a7 interactionCache:(id)a8;
