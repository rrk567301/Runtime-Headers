@class NSString, IMAPLocalActionSyncTask, NSConditionLock, IMAPAccountSyncTask, NSMutableDictionary, NSCountedSet, NSObject, _IMAPLock, NSMutableSet, MCAggregablePowerLog;
