...
+ (id)inputGeneratorWithModel:(id)a0 seed:(long long)a1 monteCarloIterations:(unsigned long long)a2;
...
- (id)initWithModel:(id)a0 seed:(long long)a1 monteCarloIterations:(unsigned long long)a2;
