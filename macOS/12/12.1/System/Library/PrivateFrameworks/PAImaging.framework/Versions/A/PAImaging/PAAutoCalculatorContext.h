@class NSArray, NSString, NUPriority, PAAutoCalculatorEntry, DGDescription, NSObject, NSMutableArray;
@protocol OS_dispatch_queue, DGDescriptionCompositionProvider, PAEditController;
