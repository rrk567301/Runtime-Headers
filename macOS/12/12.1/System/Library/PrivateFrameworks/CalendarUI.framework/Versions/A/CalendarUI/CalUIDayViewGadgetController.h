@class NSString, NSSet, NSArray, EKEventStore, NSDate, CalUIDayViewGadget, NSObject;
@protocol OS_dispatch_group, OS_dispatch_queue, CalUIDayViewGadgetAppearanceDelegate;
...
+ (id)controllerWithAppearanceDelegate:(id)a0 mouseDownBlock:(id /* block */)a1;
