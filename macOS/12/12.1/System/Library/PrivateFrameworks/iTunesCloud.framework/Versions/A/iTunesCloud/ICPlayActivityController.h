@class NSString, NSMutableDictionary, ICPlayActivityTable, NSOperationQueue, NSXPCConnection, NSMutableArray, NSObject;
...
- (id)initWithWritingStyle:(unsigned long long)a0 databasePath:(id)a1;
