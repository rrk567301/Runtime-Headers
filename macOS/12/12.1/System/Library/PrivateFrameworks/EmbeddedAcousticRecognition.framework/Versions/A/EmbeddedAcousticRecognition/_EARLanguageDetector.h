...
+ (void)initialize;
+ (struct vector<std::optional<quasar::Locale>, std::allocator<std::optional<quasar::Locale>>> { void *x0; void *x1; struct __compressed_pair<std::optional<quasar::Locale> *, std::allocator<std::optional<quasar::Locale>>> { void *x0; } x2; })quasarLocalesOfMessages:(id)a0;
