@class HMDCoreDuetLogEventObserver, HMDHomeManagerObjectLookup, HMDMultiUserSettingsMetricsEventDispatcher, NSMutableDictionary, NSMapTable, HMDMessageFilterChain, HMDAccessoryBrowser, HMDLocation, HMELastEventStore, HMDCloudManager, NSObject, HMDMetricsManager, HMDCloudDataSyncStateFilter, HMDAssistantGather, HMDSyncOperationManager, NSUUID, HMDIdentityRegistry, HMDUserDeviceCapabilitiesRequestManager, NSMutableArray, HMDResidentMesh, HMDAWDLogEventObserver, HMDFMFHandler, HMFDumpCategory, HMDAccountRegistry, HMDPowerManager, HMDMultiUserStatusController, HMDApplicationData, HMDXPCEventRouterServer, HMDKeyTransferAgent, HMDAccessoryFirmwareUpdateManager, HMDAppleAccessoryPairingController, HMDMobileAssetManager, HMDBackingStore, HMFPromise, HMDNameValidator, HMDSiriEndpointOnboardingManager, HMDBiomeLogEventObserver, HMDMessageDispatcher, HMDCompositeSettingsControllerManager, HMDSiriEndpointSettingsSyncManager, HMDDevice, NSDate, HMDCloudManagerDataSource, HMDCameraRecordingLoadBalancer, NSArray, HMDCHIPDataSource, HMDHH2FrameworkSwitch, HMDPairedSync, HMEMemoryEventBus, HMFBoolean, HMDUserCloudShareManager, HMDCloudAccount, HMDClientConnection, HMDHomeManagerObjectChangeHandler, NSString, HMDWatchManager, HMFTimer, HMDDuetEventManager, HMDHomeCloudShareManager, HMFFuture, HMDIDSInvitationManager, NSDictionary, HMDSoftwareUpdateManager, NSMutableSet, HMDMemoryUtilizationTracker, HMDCompanionManager, HMDBiomeEventManager, HMDApplicationDataPlugIn, HMFActivity, HMDAccessorySetupCoordinator;
...
- (void)handleAcceptRequestForIDSInvitationWithIdentifier:(id)a0 homeUUID:(id)a1 payload:(id)a2 fromAddress:(id)a3 senderMergeID:(id)a4;
- (void)handleDeclineRequestForIDSInvitationWithIdentifier:(id)a0 fromAddress:(id)a1 senderMergeID:(id)a2 homeUUID:(id)a3;
