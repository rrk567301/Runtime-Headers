@class HMDAccountRegistry, HMDAccount, APSConnection, NSObject, HMFFuture, IDSService, HMDAppleAccountContext, HMFExponentialBackoffTimer, HMDAppleAccountSettings, HMDDevice, HMDIDSActivityMonitorBroadcaster, HMDBackingStore, NSString, HMDCloudCache, HMFUnfairLock, ACAccountStore, HMFPromise, HMFTimer, NSUUID;
...
- (void)__updateMergeIDOnAccountIfNeeded;
