...
@property (readonly) id<HMESubscriptionProviding> subcriptionProvider;
...
- (id)initWithDataSource:(id)a0 subcriptionProvider:(id)a1 notificationCenter:(id)a2 workQueue:(id)a3;
