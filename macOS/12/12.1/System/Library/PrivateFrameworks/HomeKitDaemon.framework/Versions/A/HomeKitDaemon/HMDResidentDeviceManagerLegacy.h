@class HMDPrimaryElectionLegacyAddOn, NSObject, HMDMessageDispatcher, HMDPrimaryResidentDiscoveryOperation, HMDResidentDevice, NSString, HMDPrimaryElectionCoordinationAddOn, NSSet, NSMutableSet, HMDHome, NSArray, NSNotificationCenter, NSUUID;
