@class NSArray, ADMChangePasswordController, JSValue, MMWebKitViewController, NSDictionary, NSTouchBar, NSProgressIndicator, NSImage, NSString, MMICAWebKitViewController, CDPStateUIController, NSTimer, iCloudAddFamilyMember, iCloudTouchBarController, NSWindow, NSView, MMWebViewButtonBar, NSTextField, NSLayoutConstraint;
