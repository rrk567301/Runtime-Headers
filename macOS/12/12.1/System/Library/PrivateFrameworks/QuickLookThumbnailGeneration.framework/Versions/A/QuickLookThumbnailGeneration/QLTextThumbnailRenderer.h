...
+ (id)textStorageWithData:(id)a0 contentTypeUTI:(id)a1 stringEncoding:(unsigned long long)a2 documentAttributes:(id *)a3 truncationMode:(long long)a4;
...
+ (id)textStorageWithURL:(id)a0 contentTypeUTI:(id)a1 stringEncoding:(unsigned long long)a2 documentAttributes:(id *)a3 truncationMode:(long long)a4;
...
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })imageRectWithData:(id)a0 maxSize:(struct CGSize { double x0; double x1; })a1 stringEncoding:(unsigned long long)a2 contentTypeUTI:(id)a3 forIcon:(BOOL)a4 documentAttributes:(id *)a5 textStorage:(id *)a6 textRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a7;
+ (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })imageRectWithURL:(id)a0 maxSize:(struct CGSize { double x0; double x1; })a1 stringEncoding:(unsigned long long)a2 contentTypeUTI:(id)a3 forIcon:(BOOL)a4 documentAttributes:(id *)a5 textStorage:(id *)a6 textRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a7;
+ (void)generateThumbnailWithTextStorage:(id)a0 documentAttributes:(id)a1 contentTypeUTI:(id)a2 imageRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 textRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 context:(struct CGContext { } *)a5;
