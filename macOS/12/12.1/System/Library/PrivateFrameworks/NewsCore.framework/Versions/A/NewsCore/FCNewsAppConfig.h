@class FCWidgetConfig, FCForYouGroupsConfiguration, NSDate, NSDictionary, FCIAdConfiguration, FCPaidBundleConfiguration, FCSmarterMessagingConfig, NSString, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, NTPBDiscoverMoreVideosInfo, FCPrefetchConfiguration, FCTopStoriesConfiguration, NSArray, FCVideoGroupsConfig, NSNumber, FCEmbedProxyConfiguration, FCPersonalizationTreatment;
