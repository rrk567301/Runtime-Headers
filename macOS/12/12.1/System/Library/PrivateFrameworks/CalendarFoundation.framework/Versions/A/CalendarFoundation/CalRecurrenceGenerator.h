...
- (id)copyOccurrenceDatesBetweenStartDate:(struct { int x0; char x1; char x2; char x3; char x4; double x5; })a0 endDate:(struct { int x0; char x1; char x2; char x3; char x4; double x5; })a1 timeZone:(id)a2 limit:(long long)a3;
- (double)_convertAbsoluteTime:(double)a0 fromTimeZone:(id)a1 toTimeZone:(id)a2;
...
- (id)copyOccurrenceDatesWithInitialDate:(id)a0 rangeStart:(id)a1 rangeEnd:(id)a2 timeZone:(id)a3;
