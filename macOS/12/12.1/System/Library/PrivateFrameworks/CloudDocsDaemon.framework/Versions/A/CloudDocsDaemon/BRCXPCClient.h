@class NSXPCConnection, NSString, BRMangledID, NSSet, NSOperationQueue, BRCAccountSession, NSCountedSet, brc_task_tracker, NSObject, NSMutableDictionary, BRCClientPrivilegesDescriptor;
