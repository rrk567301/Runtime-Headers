@class SiriCoreSiriBackgroundConnection, NSString, NSURL, NSError, NWPathEvaluator, SAConnectionPolicy, NSObject, NSMutableSet, NSMutableArray;
...
- (id)_pathEvaluator:(id)a0 port:(id)a1;
