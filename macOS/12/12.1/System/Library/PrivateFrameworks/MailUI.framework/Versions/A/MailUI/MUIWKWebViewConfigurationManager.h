@class EMRemoteContentURLSession, NSString, EFCancelationToken, EMRemoteContentURLSchemeHandler, _WKUserStyleSheet, WKWebViewConfiguration;

@interface MUIWKWebViewConfigurationManager : NSObject <WKScriptMessageHandler, EDContentRuleListManagerObserver> {
