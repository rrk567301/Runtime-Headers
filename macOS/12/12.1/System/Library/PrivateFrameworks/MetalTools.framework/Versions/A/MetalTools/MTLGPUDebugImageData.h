@class MTLGPUDebugBuffer, NSString, MTLGPUDebugDevice, NSData, MTLGPUDebugDynamicLibrary, MTLDebugInstrumentationData, MTLGPUDebugFunction;
@protocol MTLBuffer;
...
@property (readonly, weak, nonatomic) MTLGPUDebugFunction *dynamicLibrary;

- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)_applyRelocation:(id)a0;
