@class NSURL, PKPassFrontFaceImageSet, PKPassLiveRenderedImageSet, NSDate, NSDictionary, PKPassPersonalization, PKPassBarcodeSettings, PKPassDisplayProfile, PKImage, NSString, NSSet, PKNFCPayload, PKBarcode, PKLiveRenderedShaderSet, PKPaymentPass, NSArray, NSData, NSNumber, PKSecureElementPass;
