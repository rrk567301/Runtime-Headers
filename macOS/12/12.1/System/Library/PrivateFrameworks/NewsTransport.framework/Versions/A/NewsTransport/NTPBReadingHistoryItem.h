...
@interface NTPBReadingHistoryItem : PBCodable <NSCopying> {
    struct { unsigned char listeningProgress : 1; unsigned char maxVersionRead : 1; unsigned char maxVersionSeen : 1; unsigned char readCount : 1; unsigned char flags : 1; } _has;
}
