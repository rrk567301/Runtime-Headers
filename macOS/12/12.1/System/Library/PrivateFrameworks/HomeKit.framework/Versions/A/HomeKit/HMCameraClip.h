...
- (void).cxx_destruct;
- (id)initWithUniqueIdentifier:(id)a0 startDate:(id)a1 duration:(double)a2 targetFragmentDuration:(double)a3 isComplete:(BOOL)a4 isDonated:(BOOL)a5 quality:(long long)a6 streamingAssetVersion:(id)a7 encryptionContext:(id)a8 posterFrames:(id)a9 videoSegments:(id)a10 significantEvents:(id)a11;
