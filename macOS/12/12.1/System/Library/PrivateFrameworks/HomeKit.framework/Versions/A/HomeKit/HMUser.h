@class _HMContext, HMHome, HMFPairingIdentity, NSObject, IDSURI, HMHomeAccessControl, HMUserListeningHistoryUpdateControl, HMPhotosPersonManagerSettings, NSString, HMMutableArray, HMSettingsController, HMSettings, HMFUnfairLock, HMPhotosPersonManager, HMAssistantAccessControl, HMMediaContentProfileAccessControl, HMAnnounceUserSettings, NSUUID;
