...
@interface CLPNRCellTowerLocation : PBCodable <NSCopying> {
    struct { unsigned char cellLatitude : 1; unsigned char cellLongitude : 1; unsigned char ci : 1; unsigned char bandInfo : 1; unsigned char bandwidth : 1; unsigned char downlinkBandwidth : 1; unsigned char ecn0 : 1; unsigned char gscn : 1; unsigned char latency : 1; unsigned char mcc : 1; unsigned char mnc : 1; unsigned char nrarfcn : 1; unsigned char pid : 1; unsigned char rscp : 1; unsigned char rssi : 1; unsigned char scs : 1; unsigned char serverHash : 1; unsigned char tac : 1; unsigned char isLimitedService : 1; unsigned char isStalled : 1; } _has;
}
