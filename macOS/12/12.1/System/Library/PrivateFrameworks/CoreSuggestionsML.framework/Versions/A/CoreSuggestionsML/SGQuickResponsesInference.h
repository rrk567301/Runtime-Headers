...
+ (id)quickResponsesForMessage:(id)a0 context:(id)a1 time:(id)a2 maxResponses:(unsigned long long)a3 locale:(id)a4 recipientHandles:(id)a5 chunkPath:(id)a6 plistPath:(id)a7 espressoBinFilePath:(id)a8;
...
- (id)quickResponsesFromReplyTextIds:(id)a0 isConfident:(BOOL)a1 config:(id)a2;
