...
@interface AGXG13XFamilyThreadedRenderPass : IOGPUMetalParallelRenderCommandEncoder <MTLParallelRenderCommandEncoderSPI> {
    void *_impl;
    NSObject<OS_dispatch_queue> *dispatchQueue;
    struct vector<AGXG13XFamilyRenderContext *, std::allocator<AGXG13XFamilyRenderContext *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG13XFamilyRenderContext **, std::allocator<AGXG13XFamilyRenderContext *>> { id *__value_; } x1; } _subOBJCRenderCommandEncoders;
