...
+ (id)pixelBufferWithSize:(const void *)a0 components:(unsigned long long)a1;
+ (id)pixelBufferFromFramebuffer:(id)a0 processor:(id)a1 session:(id)a2 sourceRegion:(const void *)a3 components:(unsigned long long)a4 flipped:(BOOL)a5;

- (void)dealloc;
- (void *)data;
- (id).cxx_construct;
- (void)flip;
- (id)initWithSize:(const void *)a0 components:(unsigned long long)a1;
- (id)TSUImage;
- (void)copyPixelsFromData:(const void *)a0;
- (void)copyPixelsFromSourceBuffer:(id)a0 sourceRegion:(const void *)a1 targetRegion:(const void *)a2 flipped:(BOOL)a3;
- (BOOL)copyPixelsFromFramebuffer:(id)a0 processor:(id)a1 session:(id)a2 sourceRegion:(const void *)a3 targetRegion:(const void *)a4 flipped:(BOOL)a5;
