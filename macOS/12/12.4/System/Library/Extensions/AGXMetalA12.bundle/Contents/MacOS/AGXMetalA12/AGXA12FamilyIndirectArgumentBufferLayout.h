@interface AGXA12FamilyIndirectArgumentBufferLayout : _MTLIndirectArgumentBufferLayout {
    struct unique_ptr<AGX::G11::IndirectArgumentLayout, std::default_delete<AGX::G11::IndirectArgumentLayout>> { struct __compressed_pair<AGX::G11::IndirectArgumentLayout *, std::default_delete<AGX::G11::IndirectArgumentLayout>> { struct IndirectArgumentLayout *__value_; } __ptr_; } _impl;
}
