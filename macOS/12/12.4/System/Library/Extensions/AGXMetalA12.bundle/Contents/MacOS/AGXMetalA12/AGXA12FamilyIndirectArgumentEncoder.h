@class NSString, AGXA12FamilyDevice, AGXA12FamilyBuffer;
@protocol MTLDevice;

@interface AGXA12FamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXA12FamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXA12FamilyBuffer *current_argument_buffer; } _impl;
}
