...
@property (readonly) struct ChannelClusterTest { void /* function */ **_vptr$ClusterBase; unsigned int mClusterId; struct DeviceProxy *mDevice; unsigned short mEndpoint; struct Optional<unsigned short> { BOOL mHasValue; union Value { unsigned short mData; } mValue; } mGroupId; struct Optional<std::chrono::duration<unsigned int, std::ratio<1, 1000>>> { BOOL mHasValue; union Value { struct duration<unsigned int, std::ratio<1, 1000>> { unsigned int __rep_; } mData; } mValue; } mTimeout; } cppCluster;
...
- (void)writeAttributeChannelListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeLineupWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentChannelWithValue:(id)a0 completionHandler:(id /* block */)a1;
