...
- (void)writeAttributeOutputListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeCurrentOutputWithValue:(id)a0 completionHandler:(id /* block */)a1;
