...
- (void)writeAttributeActionListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeEndpointListWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeSetupUrlWithValue:(id)a0 completionHandler:(id /* block */)a1;
