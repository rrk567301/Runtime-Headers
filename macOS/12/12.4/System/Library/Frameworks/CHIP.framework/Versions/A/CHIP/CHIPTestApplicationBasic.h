...
- (void)writeAttributeApplicationNameWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeProductIDWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeApplicationWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeStatusWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeApplicationVersionWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeAllowedVendorListWithValue:(id)a0 completionHandler:(id /* block */)a1;
