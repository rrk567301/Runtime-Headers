...
- (void)writeAttributeUpdatePossibleWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeUpdateStateWithValue:(id)a0 completionHandler:(id /* block */)a1;
- (void)writeAttributeUpdateStateProgressWithValue:(id)a0 completionHandler:(id /* block */)a1;
