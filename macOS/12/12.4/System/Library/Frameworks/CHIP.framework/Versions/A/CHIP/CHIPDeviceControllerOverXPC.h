@class CHIPDeviceControllerXPCConnection, NSObject;
...
- (void)subscribeAttributeCacheWithNodeId:(unsigned long long)a0 completion:(id /* block */)a1;
- (void)readAttributeCacheWithNodeId:(unsigned long long)a0 endpointId:(unsigned long long)a1 clusterId:(unsigned long long)a2 attributeId:(unsigned long long)a3 completion:(id /* block */)a4;
