@class NSMutableArray, NSString, NSArray, NSPredicate, NSMutableDictionary, NSFetchRequest, NSManagedObjectContext;
...
@interface NSFetchedResultsController : NSObject {
    ...
    id _cachePath;
    struct _fetchResultsControllerFlags { unsigned char _changedResultsSinceLastSave : 1; unsigned char _hasBatchedArrayResults : 1; unsigned char _hasMutableFetchedResults : 1; unsigned char _hasSections : 1; unsigned char _includesSubentities : 1; unsigned char _sendDidChangeContentDiffNotifications : 1; unsigned char _sendDidChangeContentNotifications : 1; unsigned char _sendDidChangeContentSnapshotNotifications : 1; unsigned char _sendObjectChangeNotifications : 1; unsigned char _sendSectionChangeNotifications : 1; unsigned char _sendSectionIndexTitleForSectionName : 1; unsigned char _sendWillChangeContentNotifications : 1; unsigned char _usesNonpersistedProperties : 1; unsigned int _reservedFlags : 19; } _flags;
    id _delegate;
    id _sortKeys;
    id _fetchedObjects;
    id _sections;
