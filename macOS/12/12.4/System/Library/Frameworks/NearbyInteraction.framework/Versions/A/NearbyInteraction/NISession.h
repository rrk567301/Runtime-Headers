@class NICarKeyEventNotifier, NSError, NSString, NIConfiguration, NSUUID, NIDeviceCapabilities, NSDictionary, NSObject, NIServerConnection, NIDevicePresenceNotifier, NIExportedObjectForwarder, NIDiscoveryToken;
