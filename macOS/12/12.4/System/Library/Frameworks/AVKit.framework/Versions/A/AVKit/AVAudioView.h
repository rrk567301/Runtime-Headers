@class NSMenu, NSString, AVControlsContainerViewController, AVDesktopPlaybackControlsController, AVNowPlayingInfoController, AVDesktopGestureController, AVPlaybackRateCollection, AVTrimControlsViewController, AVPlayerController, AVPlayerControlsViewController, AVPlaybackRate;

@interface AVAudioView : NSView <AVTrimControlsViewControllerDelegate, AVVolumeControlButtonDelegate, AVTouchBarControlsViewControllerDelegate> {
...
- (void)initializeDefaultPlaybackRates;
