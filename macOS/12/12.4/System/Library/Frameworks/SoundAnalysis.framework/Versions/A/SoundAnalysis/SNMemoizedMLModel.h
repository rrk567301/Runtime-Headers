...
@property (class, readonly) unsigned long long defaultMaxCacheSize;

@property (readonly) id<SNMLModel> wrappedModel;
...
+ (id)new;
+ (id)withWrappedModel:(id)a0 maxCacheSize:(unsigned long long)a1;
...
- (id)initWithWrappedModel:(id)a0 maxCacheSize:(unsigned long long)a1;
