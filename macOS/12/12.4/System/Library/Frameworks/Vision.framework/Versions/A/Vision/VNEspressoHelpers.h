...
+ (BOOL)createSingleNetworkPlanFromResourceName:(id)a0 usingProcessingDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 espressoResources:(id *)a6 error:(id *)a7;
...
+ (BOOL)createSingleNetworkPlanFromResourceName:(id)a0 usingProcessingDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 explicitNetworkLayersStorageType:(int)a6 espressoResources:(id *)a7 error:(id *)a8;
