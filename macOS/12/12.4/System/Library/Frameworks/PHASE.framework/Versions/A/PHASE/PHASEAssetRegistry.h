...
- (id)makeSoundAssetWithURL:(id)a0 uid:(id)a1 assetType:(long long)a2 channelLayout:(id)a3 normalizationMode:(long long)a4 outError:(id *)a5;
...
- (const struct SoundAssetInfo { void /* function */ **x0; long long x1; unsigned long long x2; long long x3; int x4; unsigned int x5; } *)getSoundAssetInfo:(unsigned long long)a0;
- (const void *)getChannelMapping:(unsigned long long)a0;
- (const void *)getGlobalMetaParameter:(unsigned long long)a0;
