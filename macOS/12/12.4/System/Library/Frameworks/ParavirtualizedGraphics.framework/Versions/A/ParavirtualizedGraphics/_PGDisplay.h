...
@protocol MTLTexture, MTLDevice, MTLFunction, OS_dispatch_source, OS_dispatch_queue, MTLBuffer;
...
- (void)presentFrame:(id)a0 iosurfacePixelFormat:(unsigned int)a1 task:(id)a2 gammaTableVirtualOffset:(unsigned long long)a3 gammaTableMappedLength:(unsigned long long)a4 gammaTableEntryCount:(unsigned int)a5 gammaTableSum:(unsigned int)a6 completionBlock:(id /* block */)a7;
