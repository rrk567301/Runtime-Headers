...
+ (id)readKeyboardShortcutLocalizationEquivalentsForInputLanguageID:(id)a0;
+ (id)filterKeyboardShortcutLocalizationEquivalentsIn:(id)a0 forBundleID:(id)a1;
+ (id)findLocalizationForKeyboardShortcut:(id)a0 withModifiers:(unsigned long long)a1 inApplicableOverrides:(id)a2;
...
+ (id)folderNameForKeyboardAdjustmentFileUsingInputSource:(struct __TISInputSource { } *)a0;
