@class NSDate, NSString, NSData, NSURL, NSSet, NSManagedObjectID, PHPhotoLibrary, NSArray, NSManagedObjectContext, CLLocation, NSNumber;
...
+ (id)fetchKeyAssetForSceneIdentifier:(unsigned int)a0 aboveConfidenceThreshold:(double)a1 options:(id)a2;
