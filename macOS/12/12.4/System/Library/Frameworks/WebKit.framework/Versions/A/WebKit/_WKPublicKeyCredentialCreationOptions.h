@class _WKAuthenticatorSelectionCriteria, NSArray, _WKAuthenticationExtensionsClientInputs, _WKPublicKeyCredentialUserEntity, _WKPublicKeyCredentialRelyingPartyEntity, NSNumber;
