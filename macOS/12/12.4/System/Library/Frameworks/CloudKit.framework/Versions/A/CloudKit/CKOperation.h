@class NSMutableDictionary, CKLogicalDeviceContext, CKPlaceholderOperation, NSObject, NSDictionary, CKSignpost, CKOperationGroup, NSString, CKOperationMMCSRequestOptions, CKOperationConfiguration, CKEventMetric, CKOperationMetrics, CKOperationInfo, NSError, CKOperationCallbackProxy;
