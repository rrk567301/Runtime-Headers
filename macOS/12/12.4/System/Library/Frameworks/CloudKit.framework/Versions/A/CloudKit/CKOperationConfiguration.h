@class NSString, CKContainer, NSMutableDictionary, NSDictionary, CKSchedulerActivity, CKAssetDownloadStagingManager, NSObject, NSNumber;
...
@property (copy, nonatomic) CKAssetDownloadStagingManager *assetDownloadStagingManager;
