...
- (void)_deviceScoreForEndpoint:(id)a0 withCompletion:(id /* block */)a1;
- (void)_deviceScoreForEndpoint:(id)a0 recipientAddress:(id)a1 withCompletion:(id /* block */)a2;
- (void)prewarmDeviceScoreForEndpoint:(id)a0 recipientAddress:(id)a1;
- (id)_createDeviceScorerForEndpoint:(id)a0 recipientAddress:(id)a1;
...
- (unsigned long long)disbursementVoucherWithRequest:(id)a0 certificates:(id)a1 completion:(id /* block */)a2;
...
- (void)prewarmDeviceScoreForEndpoint:(id)a0;
