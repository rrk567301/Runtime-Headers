...
- (BOOL)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)a0 merchantCapabilities:(unsigned long long)a1 merchantCountryCode:(id)a2 paymentMode:(long long)a3 paymentApplicationStates:(id)a4 isMultiTokensRequest:(BOOL)a5 webService:(id)a6;
- (BOOL)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)a0 merchantCapabilities:(unsigned long long)a1 merchantCountryCode:(id)a2 paymentMode:(long long)a3 paymentApplicationStates:(id)a4 isMultiTokensRequest:(BOOL)a5 webService:(id)a6;
