@class NSDecimalNumber, PKContactFormatValidator, PKPaymentOptionsDefaults, PKCurrencyAmount, PKPaymentApplication, NSString, NSMutableArray, PKPaymentPass, NSArray, NSMutableDictionary, PKPeerPaymentQuote, PKBankAccountInformation, PKPaymentRequest, PKPeerPaymentService, NSSet, PKDisbursementApplicationInformation, PKPeerPaymentAccount, PKPayment, PKRemoteDevice, PKPaymentOptionsRecents, CNContact, PKPaymentWebService, PKPaymentInstructions, PKPassLibrary, PKPaymentSummaryItem, NSMapTable, PKRemotePaymentInstrument, PKShippingMethod;
