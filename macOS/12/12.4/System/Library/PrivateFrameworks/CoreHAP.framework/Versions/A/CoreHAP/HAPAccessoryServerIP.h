@class HMFNetAddress, HMFBlockOperation, NSDate, HAPAccessoryServerBrowserIP, NSDictionary, HAPAuthSession, NSObject, HAPAccessory, NSMutableArray, HAPHTTPClient, HAPWACAccessory, NSString, HAPAccessoryWiFiConfiguration, HMFUnfairLock, NSOperationQueue, NSArray, NSData, HMFNetMonitor, HAPAccessoryProtocolInfo, HMFTimer;
