...
- (BOOL)shouldTryVideoRotationFastPath:(id)a0 options:(id)a1;
- (void)_exportVideoToURLFull:(id)a0 composition:(id)a1 options:(id)a2 properties:(id)a3 progress:(id)a4 completion:(id /* block */)a5;
