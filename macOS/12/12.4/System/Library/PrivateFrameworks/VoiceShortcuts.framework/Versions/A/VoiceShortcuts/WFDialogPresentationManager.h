@class WFDialogAttributions, WFScreenOnObserver, NSString, WFPresentedDialog, NSMutableArray, NSObject, NSXPCListener, WFDialogNotificationManager, WFWorkflowRunningContext;
