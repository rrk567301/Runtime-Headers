@class RCPPointerTrackingChildEventStream, RCPEventSenderProperties, NSString, NSMutableArray;

@interface RCPSyntheticEventStream : RCPEventStream <RCPEventStreamComposer, RCPFluidSwipeGesturesEventStreamComposer, RCPCrownEventStreamComposer, RCPPointerEventStreamComposer> {
    NSMutableArray *_processingEventBuffer;
    double _currentTimeOffset;
    long long _generationCount;
}

@property (readonly, nonatomic) struct { struct CGPoint { double x0; double x1; } x0; double x1; double x2; unsigned char x3; unsigned int x4; BOOL x5; } *activePoints;
