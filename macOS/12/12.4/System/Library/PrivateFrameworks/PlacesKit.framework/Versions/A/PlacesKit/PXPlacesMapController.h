...
+ (void)launchMapsAtCoordinate:(struct CLLocationCoordinate2D { double x0; double x1; })a0 withTitle:(id)a1;
...
- (void)_setVisibleMapRect:(struct { struct { double x0; double x1; } x0; struct { double x0; double x1; } x1; })a0 edgePadding:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a1 animated:(BOOL)a2;
