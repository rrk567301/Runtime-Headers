...
- (BOOL)setDeviceUID:(id)a0 error:(id *)a1;
- (struct AudioPresentationTimeStamp { unsigned int x0; unsigned int x1; unsigned long long x2; double x3; double x4; double x5; double x6; })presentationTime;
