@class NSString, NSArray, NSURL, FigCaptureIrisStillImageSettings, FigCaptureSemanticStyle, BWStillImageCaptureSettings, BWStats, BWSubjectRelightingCalculatorResult, FigCaptureMovieFileRecordingSettings;
