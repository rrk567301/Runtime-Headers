@class NSURL, FCIssue, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, FCColor, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCHeadlineThumbnail, NSString, NSSet, FCCoverArt, FCArticleAudioTrack, NSArray, NSData, FCHeadlineExperimentalTitleMetadata, FCAssetHandle;
