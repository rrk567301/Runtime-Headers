...
- (id)initWithBundlePurchaseID:(id)a0 bundleChannelIDs:(id)a1 bundleChannelIDsVersion:(id)a2 inTrialPeriod:(BOOL)a3 isPurchaser:(BOOL)a4 servicesBundlePurchaseID:(id)a5 isAmplifyUser:(BOOL)a6;
