@class NSUUID, NSString, NSDate, NSPredicate, Protocol, MKFAnnounceUserSettingsDatabaseID, _MKFUser, NSNumber;
@protocol MKFUser, MKFHome;

@interface _MKFAnnounceUserSettings : _MKFModel <HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFAnnounceUserSettings, MKFAnnounceUserSettingsPrivateExtensions>
