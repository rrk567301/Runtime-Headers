@class HMDDeviceCapabilities, NSObject, HMDPrimaryResidentDiscoveryOperation, HMDMessageDispatcher, HMFFuture, HMDResidentDevice, HMDPrimaryElectionCoordinationAddOn, HMDModernTransportDeviceReachabilityObserver, NSString, NSSet, NSMutableSet, NSArray, HMDHome, NSNotificationCenter, NSUUID;
