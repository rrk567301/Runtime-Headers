@class HMDEventFlagsManager, NSUserDefaults, HMDEventCountersManager;
...
- (id)initWithEventCountersManager:(id)a0 eventFlagsManager:(id)a1 logEventSubmitter:(id)a2 userDefaults:(id)a3;
