@class KTPublicKeyStore, NSMutableDictionary, NSDictionary, NSData, TransparencyManagedDataStore;
...
@property (retain) NSData *cachedGossip;
...
- (void)receivedSTHsFromPeers:(id)a0 logClient:(id)a1 verifier:(id)a2 block:(id /* block */)a3;
