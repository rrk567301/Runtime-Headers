@class HMDHomeManagerObjectLookup, HMDMultiUserSettingsMetricsEventDispatcher, NSMutableDictionary, NSMapTable, HMDMessageFilterChain, HMDAccessoryBrowser, HMDLocation, HMELastEventStore, HMDCloudManager, NSObject, HMDMetricsManager, HMDCloudDataSyncStateFilter, HMDAssistantGather, HMFNetMonitor, NSUUID, HMDIdentityRegistry, HMDAWDLogEventObserver, NSMutableArray, HMDResidentMesh, HMDFMFHandler, HMDAccountRegistry, HMFDumpCategory, NSSet, HMDPowerManager, HMDMultiUserStatusController, HMDApplicationData, HMDXPCEventRouterServer, HMDDuetPredictionSubscriber, HMDKeyTransferAgent, HMDSyncOperationManager, HMDAppleAccessoryPairingController, HMDBackingStore, HMDAccessoryFirmwareUpdateManager, HMDNameValidator, HMDSiriEndpointOnboardingManager, HMDBiomeLogEventObserver, HMDRemoteEventRouterAssertionController, HMDMessageDispatcher, HMDSiriEndpointSettingsSyncManager, HMDDevice, HMDMobileAssetManager, HMDCompositeSettingsControllerManager, NSDate, HMDCloudManagerDataSource, HMDCameraRecordingLoadBalancer, NSArray, HMDCHIPDataSource, HMDHH2FrameworkSwitch, HMDPairedSync, HMEMemoryEventBus, HMFBoolean, HMDUserCloudShareManager, HMDHomeManagerObjectChangeHandler, HMDClientConnection, HMDCloudAccount, NSString, HMDBonjourBrowserHelper, HMDAppleAccountManager, HMDWatchManager, HMFTimer, HMDDuetEventManager, HMFFuture, NSDictionary, HMDSoftwareUpdateManager, NSMutableSet, HMDMemoryUtilizationTracker, HMDCompanionManager, HMDBiomeEventManager, HMFActivity, HMDAccessorySetupCoordinator;
