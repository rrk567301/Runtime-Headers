...
- (id)_initWithMode:(id)a0 configuration:(id)a1 secureConfiguration:(id)a2 triggers:(id)a3 impactsAvailability:(unsigned long long)a4 dimsLockScreen:(unsigned long long)a5 created:(id)a6 lastModified:(id)a7 automaticallyGenerated:(BOOL)a8 compatibilityVersion:(long long)a9 ephemeralResolvedCompatibilityVersion:(long long)a10 hasSecureData:(BOOL)a11;
