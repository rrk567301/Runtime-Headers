...
+ (BOOL)_visitedLocationNodeMoreThanOnce:(id)a0 withReferenceMomentNodes:(id)a1;
+ (id)_filteredCityNodesByNameForCityNodes:(id)a0;
+ (void)_aoiTitleWithLocationNodes:(id)a0 momentNodes:(id)a1 allowLongAOI:(BOOL)a2 graph:(id)a3 result:(id /* block */)a4;
