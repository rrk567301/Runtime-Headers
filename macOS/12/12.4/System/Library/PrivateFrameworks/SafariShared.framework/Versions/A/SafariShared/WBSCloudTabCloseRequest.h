...
+ (id)_dictionaryWithURL:(id)a0 tabUUID:(id)a1 lastModified:(id)a2 sourceDeviceUUID:(id)a3 destinationDeviceUUID:(id)a4;
...
- (id)initWithURL:(id)a0 tabUUID:(id)a1 lastModified:(id)a2 sourceDeviceUUID:(id)a3 destinationDeviceUUID:(id)a4 requestUUID:(id)a5;
