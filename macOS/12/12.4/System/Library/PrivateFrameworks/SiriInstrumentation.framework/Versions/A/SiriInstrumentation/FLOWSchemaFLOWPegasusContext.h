@class SISchemaUUID, NSData, NSArray, FLOWSchemaFLOWWebAnswerExecution, PEGASUSSchemaPEGASUSIntent, FLOWSchemaFLOWKGQAExecution, FLOWSchemaFLOWSPORTSExecution, FLOWSchemaFLOWCrossIntentRankerResponse;
