@class NSURL, _LTTextToSpeechCache, NSDictionary, NSObject, _LTSpeechTranslationAssetInfo, NSLocale, _LTMultilingualSpeechRecognizer, _LTLanguageDetectionResult, NSString, _LTLocalePair, NSArray, _LTOfflineSpeechSynthesizer, EMTTranslator, NSError;
...
- (void)_translateString:(id)a0 withContext:(id)a1 toLocale:(id)a2 withSpans:(id)a3 completion:(id /* block */)a4;
