@class NSString, WPDeviceScanner, NSMutableSet, NSMutableArray, WPZoneTracker;
...
@property (retain, nonatomic) NSMutableArray *deviceScanRegistrations;
@property (retain, nonatomic) NSMutableArray *zoneRegistrations;
