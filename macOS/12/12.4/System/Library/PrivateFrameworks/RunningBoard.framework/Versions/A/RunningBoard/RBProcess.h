...
- (id)_initWithInstance:(id)a0 auditToken:(id)a1 bundleProperties:(id)a2 initialState:(id)a3 hostProcess:(id)a4 properties:(id)a5 systemPreventsIdleSleep:(BOOL)a6;
...
- (void)collectDiagnostic:(unsigned long long)a0 description:(id)a1 code:(unsigned long long)a2 additionalPayload:(id)a3 completion:(id /* block */)a4;
