@class RBProcessState, RBSAssertionIdentifier, NSString, NSArray, RBAssertionIntransientState, NSSet, RBAssertionTransientState, RBProcess, RBSProcessAssertionInfo, RBInheritanceCollection;
