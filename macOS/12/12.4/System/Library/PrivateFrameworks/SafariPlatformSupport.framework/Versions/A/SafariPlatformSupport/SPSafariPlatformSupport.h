...
- (struct CGPoint { double x0; double x1; })_topLeftPointOfCompletionWindowInWindow:(id)a0 positioningRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 contentSize:(struct CGSize { double x0; double x1; })a2;
...
- (void)_observeNotificationsForTextField:(id)a0 keyWindow:(id)a1;
