@interface UPPreprocessorOutput : NSObject {
    ...
    struct vector<uaap::UPDetectedSpan, std::allocator<uaap::UPDetectedSpan>> { struct UPDetectedSpan *__begin_; struct UPDetectedSpan *__end_; struct __compressed_pair<uaap::UPDetectedSpan *, std::allocator<uaap::UPDetectedSpan>> { struct UPDetectedSpan *__value_; } __end_cap_; } _dataDetectorSpans;
}
