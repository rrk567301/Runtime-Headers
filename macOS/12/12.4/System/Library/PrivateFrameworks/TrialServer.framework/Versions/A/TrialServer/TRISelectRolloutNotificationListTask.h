...
@property (readonly, nonatomic) NSSet *excludedNamespaceNames;
...
+ (id)taskWithNamespaceNames:(id)a0 excludingNamespaces:(id)a1 taskAttribution:(id)a2;
...
- (id)initWithNamespaceNames:(id)a0 excludingNamespaces:(id)a1 taskAttribution:(id)a2;
