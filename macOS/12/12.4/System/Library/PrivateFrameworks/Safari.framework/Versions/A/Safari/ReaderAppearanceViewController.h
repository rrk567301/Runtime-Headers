@class NSView, WBSReaderFontDownloadManager, NSScrollView, NSString, NSStackView, WBSReaderFont, NSLayoutConstraint, NSButton, ReaderThemeButton, NSTableView;
...
@property (weak) NSLayoutConstraint *tableViewTopConstraint;
@property (weak) NSLayoutConstraint *tableViewBottomConstraint;
