@class NSView, NSString, ForYouRecommendationMediator, BrowserViewController, NSScrollView, NSVisualEffectView, StartPageCollectionViewController, NSViewController, NSLayoutConstraint, KeyLoopSplicingContainerView;
