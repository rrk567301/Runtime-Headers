@class RemoteNotificationCenterRequest, NSString, NSArray, NSURL, NSDate, SafariNotificationAgentDelegate, NSUserNotificationCenter, NSMutableSet, NSMapTable;
...
@interface RemoteNotificationCenterDelegate : NSObject <_NSUserNotificationCenterDelegatePrivate> {
    ...
    NSMapTable *_localNotificationActivationHandlers;
}
...
- (void)_deliverNotificationWithTitle:(id)a0 informativeText:(id)a1 buttonTitle:(id)a2 activationURLArguments:(id)a3;
...
- (void)scheduleLocalNotification:(id)a0 activationHandler:(id /* block */)a1;
