@class NSXPCConnection, NSString, NSArray, _TtC26AuthenticationServicesCore13ASCABLEClient, ASCCredentialRequestContext, ASCAuthorizationPresenter, ASCAuthorizationTrafficController, NSXPCListener;
@protocol ASPublicKeyCredentialManagerInterface;

@interface ASCAgent : NSObject <NSXPCListenerDelegate, AuthenticationServicesCore.ASCABLEClientDelegate, ASPublicKeyCredentialManagerDelegate, ASCAuthorizationPresenterDelegate, ASCAgentProtocol> {
