@class EMMessageRepository, EMObjectID, ECSubject, NSDate, NSObject, ECMessageFlags, NSString, EFFuture, NSIndexSet, EMMessageObjectID, NSArray, EMMailDropMetadata, NSUUID;
