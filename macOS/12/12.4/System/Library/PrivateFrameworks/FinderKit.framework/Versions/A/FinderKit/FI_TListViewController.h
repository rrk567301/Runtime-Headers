...
+ (struct TString { struct TRef<const __CFString *, TRetainReleasePolicy<CFStringRef>> { struct __CFString *x0; } x0; })firstAuthorOfNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
...
- (id)originalEditedNameCellView;
- (void)setOriginalEditedNameCellView:(id)a0;
