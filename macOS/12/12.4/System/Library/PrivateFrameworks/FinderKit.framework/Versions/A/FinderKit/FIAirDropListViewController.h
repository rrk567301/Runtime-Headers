...
@interface FIAirDropListViewController : FI_TTableViewController <TMarkTornDown> {
    ...
    struct TNSRef<CNAvatarCache, void> { CNAvatarCache *fRef; } _avatarCache;
    struct TNSRef<NSTrackingArea, void> { NSTrackingArea *fRef; } _trackingArea;
    BOOL _repopulating;
    struct TNSWeakPtr<FI_TTouchBarScrollingStackViewController, void> { NSValue *fWeakObject; } _touchBarAirDropParticipantsViewController;
    struct TNSRef<NSImage, void> { NSImage *fRef; } _closeImage;
    struct TNSRef<NSImage, void> { NSImage *fRef; } _blankImage;
}
...
- (id)airDropParticipantsViewController;
