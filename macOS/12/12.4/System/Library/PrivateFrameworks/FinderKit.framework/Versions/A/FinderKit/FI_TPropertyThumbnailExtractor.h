...
@interface FI_TPropertyThumbnailExtractor : FI_TPropertyIconExtractor {
    ...
    struct TNSWeakPtr<NSObject<TPropertyThumbnailExtractorDelegate>, void> { NSValue *fWeakObject; } _weakDelegate;
...
- (struct shared_ptr<TThumbnailExtractorController> { struct TThumbnailExtractorController *x0; struct __shared_weak_count *x1; })thumbnailController;
- (id)extractValueFromNodes:(const void *)a0 partialOk:(BOOL)a1;
- (void)setThumbnailController:(struct shared_ptr<TThumbnailExtractorController> { struct TThumbnailExtractorController *x0; struct __shared_weak_count *x1; })a0;
