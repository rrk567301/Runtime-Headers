@class FI_TKeyValueObserverGlue, NSString, FI_TEphemeralPathBarDisplayController, FI_TPathSelectController, NSValue, NSArray, NSTrackingArea, FI_TPathControl, FI_TNotificationCenterObserverGlue, NSObject, NSIndexSet;
...
@interface FI_TPathBarController : FI_TViewController <FI_TPathSelectDelegate, TPathControlDelegate, TNodeObserverProtocol, NSMenuDelegate, TMarkTornDown> {
    ...
    struct TNSWeakPtr<NSObject<FI_TPathBarContainerDelegate>, void> { NSValue *fWeakObject; } _containerDelegate;
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _refreshToken;
    struct TNSWeakPtr<FI_TRunAfterHelper, void> { NSValue *fWeakObject; } _singleClickDelayToken;
