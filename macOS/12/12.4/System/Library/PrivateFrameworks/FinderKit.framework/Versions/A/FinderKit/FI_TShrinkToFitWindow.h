...
@interface FI_TShrinkToFitWindow : NSPanel {
    struct TNSWeakPtr<FI_TShrinkToFitScrollView, void> { NSValue *fWeakObject; } _weakStfScrollView;
    struct TNSWeakPtr<FI_TShrinkToFitTextView, void> { NSValue *fWeakObject; } _weakStfTextView;
...
- (void)setStfTextView:(id)a0;
- (void)setStfScrollView:(id)a0;
