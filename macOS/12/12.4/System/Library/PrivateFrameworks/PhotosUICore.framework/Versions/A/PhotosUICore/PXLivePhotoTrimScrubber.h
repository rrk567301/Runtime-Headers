@class UXView, AVVideoComposition, PXTrimScrubberLayoutHelper, NSArray, PXLivePhotoTrimScrubberLoupeView, NSImage, PXLivePhotoTrimScrubberHiddenAnimationHelper, UXImageView, PXLivePhotoTrimScrubberSpec, AVAsset;
...
- (void)_setKeyTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 canHaveImpact:(BOOL)a1;
