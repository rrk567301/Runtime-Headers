...
- (id)initWithSearchQuery:(id)a0 searchResults:(id)a1 searchAssetResults:(id)a2 curatedAssetsFetchResult:(id)a3 searchSuggestions:(id)a4 sceneIdentifiers:(id)a5 reloadItemIdentifiers:(id)a6;
