...
- (id)cloudResourceForLocalResource:(id *)a0 cloudRecord:(id *)a1 shouldNotTrustCaches:(BOOL *)a2 allowUnsafeClientCache:(BOOL)a3 transportScope:(id *)a4 error:(id *)a5;
...
- (id)_resourceStorageCopyTaskForResource:(id)a0 taskIdentifier:(id)a1 cloudResource:(id)a2 ofRecord:(id)a3 didStartHandler:(id /* block */)a4 progressHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
- (id)_realDownloadTaskForLocalResource:(id)a0 taskIdentifier:(id)a1 cloudResource:(id)a2 ofRecord:(id)a3 didStartHandler:(id /* block */)a4 progressHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
