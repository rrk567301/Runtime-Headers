@class CHIPPluginStorage, CHIPDeviceController, NSString, CHIPPluginResidentStateManager, NSOperationQueue, NSDictionary, CHIPPluginMatterKeypair, NSMutableSet, NSObject, CHIPPluginVendorMetadataStore;
