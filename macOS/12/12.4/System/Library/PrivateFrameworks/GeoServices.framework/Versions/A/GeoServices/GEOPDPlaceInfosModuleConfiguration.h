...
@interface GEOPDPlaceInfosModuleConfiguration : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_factoidInfoItem : 1; unsigned char read_locationInfoItem : 1; unsigned char wrote_anyField : 1; } _flags;
}
