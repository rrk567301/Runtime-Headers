@class GEOTransitOptions, PBUnknownFields, GEOPDViewportInfo, GEOMapRegion, GEOLocation, GEOPDResultRefinementQuery, NSMutableArray, GEOTraitsTransitScheduleFilter, NSString, GEOCyclingOptions, GEOAutomobileOptions, GEOWalkingOptions, PBDataReader, GEOPDVenueIdentifier;
