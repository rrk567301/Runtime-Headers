@class GEOMapServiceTraits, GEODirectionIntent, GEOMapRegion, NSDictionary, GEOPDMerchantLookupResult, NSString, GEOResultRefinementGroup, GEOPDPlaceSummaryLayoutMetadata, GEORelatedSearchSuggestion, GEOSearchAutoRedoThreshold, NSArray, GEOResolvedItem, GEOCategorySearchResultSection, GEOSearchSectionList;
