...
@property (readonly, nonatomic) id actions;
@property (readonly, nonatomic) id textFields;
...
+ (id)showTwoButtonAlertWithTitle:(id)a0 message:(id)a1 button1Title:(id)a2 button1Style:(int)a3 button1Handler:(id /* block */)a4 button2Title:(id)a5 button2Style:(int)a6 button2Handler:(id /* block */)a7;
+ (id)showTwoButtonSheetOnViewController:(id)a0 withTitle:(id)a1 message:(id)a2 button1Title:(id)a3 button1Style:(int)a4 button1Handler:(id /* block */)a5 button2Title:(id)a6 button2Style:(int)a7 button2Handler:(id /* block */)a8;
...
- (id)addAlertButtonWithTitle:(id)a0 style:(int)a1 tag:(long long)a2 action:(id /* block */)a3;
- (id)initWithStyle:(int)a0 title:(id)a1 message:(id)a2;
...
- (void)showFromRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 inView:(id)a1 viewController:(id)a2 arrowDirection:(int)a3 animated:(BOOL)a4;
