...
- (id)initWithText:(id)a0 lang:(id)a1 replyTextId:(unsigned long long)a2 styleGroupId:(unsigned long long)a3 semanticClassId:(unsigned long long)a4 modelId:(unsigned long long)a5 categoryId:(unsigned long long)a6 isCustomResponse:(BOOL)a7 isConfident:(BOOL)a8 proactiveTrigger:(id)a9;
- (id)initWithText:(id)a0 lang:(id)a1 replyTextId:(unsigned long long)a2 styleGroupId:(unsigned long long)a3 semanticClassId:(unsigned long long)a4 modelId:(unsigned long long)a5 categoryId:(unsigned long long)a6 isCustomResponse:(BOOL)a7 isConfident:(BOOL)a8;
