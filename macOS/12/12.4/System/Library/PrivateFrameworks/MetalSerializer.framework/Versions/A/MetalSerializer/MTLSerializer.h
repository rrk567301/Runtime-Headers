...
@interface MTLSerializer : NSObject {
    ...
    struct MTLSerializerFeatures { BOOL supportsGenerateResourceRefs; BOOL supportsReflectionSerializationVersion; BOOL supportsSharedTextures; BOOL supportsScripts; BOOL supportsOpenGL; BOOL supportsIOSurfaceTextureWithRotation; } _features;
}
