...
- (long long)classifyImage:(struct CGImage { } *)a0;
...
- (id)generateClassificationScoresForImage:(struct CGImage { } *)a0;
- (long long)classifyPixelBuffer:(struct __CVBuffer { } *)a0;
- (id)generateClassificationScoresForPixelBuffer:(struct __CVBuffer { } *)a0;
- (id)getOperatingPointDataForClassName:(id)a0;
