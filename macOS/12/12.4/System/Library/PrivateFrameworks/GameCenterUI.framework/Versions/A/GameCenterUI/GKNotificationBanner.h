...
+ (void)showBannerWithTitle:(id)a0 player:(id)a1 image:(id)a2 message:(id)a3 completionHandler:(id /* block */)a4;
+ (void)showWelcomeBannerWithTitle:(id)a0 message:(id)a1 completionHandler:(id /* block */)a2;
