@class NSView, NSString, GKTurnBasedMatchDetailViewController, GKGame, GKMatchRequest, GKTurnBasedInviteViewControllerObsolete, GKCollectionViewController, GKTurnBasedMatchesDataSource, GKTurnBasedInviteViewController, NSButton;
@protocol GKTurnBasedMatchesViewControllerDelegate;

@interface GKTurnBasedMatchesViewController : GKCollectionViewController <GKTurnBasedInviteViewControllerDelegateObsolete, GKTurnBasedInviteViewControllerDelegate, GKTurnBasedMatchDetailViewControllerDelegate>
...
@property (retain) GKTurnBasedInviteViewControllerObsolete *inviteControllerObsolete;
