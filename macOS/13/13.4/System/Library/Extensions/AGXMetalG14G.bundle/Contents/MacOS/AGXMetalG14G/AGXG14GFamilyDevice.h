@class MTLArchitecture, NSString, NSArray, NSMutableDictionary, NSDictionary, NSObject, MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSPointerArray;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface AGXG14GFamilyDevice : IOGPUMetalDevice <MTLDeviceSPI> {
    void *_impl;
    struct AGXATelemetry { struct atomic<unsigned long long> { struct __cxx_atomic_impl<unsigned long long, std::__cxx_atomic_base_impl<unsigned long long>> { _Atomic unsigned long long __a_value; } __a_; } usage[2]; unsigned long long prevUsage[2]; struct atomic<unsigned short> { struct __cxx_atomic_impl<unsigned short, std::__cxx_atomic_base_impl<unsigned short>> { _Atomic unsigned short __a_value; } __a_; } commandQsInFlight; NSArray *clientKeys; struct atomic<unsigned int> { struct __cxx_atomic_impl<unsigned int, std::__cxx_atomic_base_impl<unsigned int>> { _Atomic unsigned int __a_value; } __a_; } clientMask; unsigned int prevClientMask; NSObject<OS_dispatch_queue> *queue; NSObject<OS_dispatch_source> *timer; NSObject<OS_dispatch_queue> *backtraceQueue; NSString *deviceName; NSMutableDictionary *backtracePayload; NSMutableDictionary *dimensionPayload; NSMutableDictionary *payload; BOOL isEnabled; struct AGXATelemetryCounts { struct atomic<unsigned long long> { struct __cxx_atomic_impl<unsigned long long, std::__cxx_atomic_base_impl<unsigned long long>> { _Atomic unsigned long long __a_value; } __a_; } count[15]; } genericCounts; struct AGXATelemetryMaxs { struct atomic<unsigned long long> { struct __cxx_atomic_impl<unsigned long long, std::__cxx_atomic_base_impl<unsigned long long>> { _Atomic unsigned long long __a_value; } __a_; } max[1]; } genericMaxs; struct AGXATelemetryTextureCounts { struct atomic<unsigned long long> { struct __cxx_atomic_impl<unsigned long long, std::__cxx_atomic_base_impl<unsigned long long>> { _Atomic unsigned long long __a_value; } __a_; } count[73]; } textureCounts; } _telemetry;
...
- (unsigned long long *)getPerfCounterDataWithFilter:(void *)a0 returnSize:(unsigned int *)a1;
- (unsigned long long *)getRawPerfCounterDataWithFilter:(void *)a0 returnSize:(unsigned int *)a1;
