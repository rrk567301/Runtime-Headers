...
- (id)_initWithName:(const struct __CFString { } *)a0;
- (void)_onqueue_beginGenerationWithNewOwner:(const struct __CFUUID { } *)a0;
...
- (void)_onqueue_invalidateCurrentGenerationCacheEntries:(const struct __CFArray { } *)a0 inResponseToMessage:(id)a1;
