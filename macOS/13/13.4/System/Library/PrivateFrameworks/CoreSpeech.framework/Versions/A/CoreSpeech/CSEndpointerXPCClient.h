...
- (void)instrumentEndpointSignpostsForServerEndpointWithEndTime:(double)a0 leadingSilence:(double)a1 trailingSilence:(double)a2 stopRecordingMachContinousTime:(unsigned long long)a3 skippedSamplesTimeInSec:(double)a4;
