@class NSNumber, HAPDeviceID, NSMutableDictionary, NSDate, NSObject, HMFActivity, HAPAccessory, NSString, HMFVersion, NSHashTable, HAPKeyBag, NSArray, HAPSuspendedAccessory, NSData, HAPAccessoryPairingRequest, NSUUID;
...
@property (retain, nonatomic) NSMutableDictionary *metricPairingDictionary;
