...
@interface ASDTIOA2LevelControl : ASDLevelControl <ASDTIOA2Control> {
    ...
    struct CAVolumeCurve { unsigned int mTag; struct map<CARawPoint, CADBPoint, std::less<CARawPoint>, std::allocator<std::pair<const CARawPoint, CADBPoint>>> { struct __tree<std::__value_type<CARawPoint, CADBPoint>, std::__map_value_compare<CARawPoint, std::__value_type<CARawPoint, CADBPoint>, std::less<CARawPoint>, true>, std::allocator<std::__value_type<CARawPoint, CADBPoint>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<CARawPoint, CADBPoint>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<CARawPoint, std::__value_type<CARawPoint, CADBPoint>, std::less<CARawPoint>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } mCurveMap; BOOL mIsApplyingTransferFunction; unsigned int mTransferFunction; float mRawToScalarExponentNumerator; float mRawToScalarExponentDenominator; } _volumeCurve;
...
+ (struct CAVolumeCurve { unsigned int x0; struct map<CARawPoint, CADBPoint, std::less<CARawPoint>, std::allocator<std::pair<const CARawPoint, CADBPoint>>> { struct __tree<std::__value_type<CARawPoint, CADBPoint>, std::__map_value_compare<CARawPoint, std::__value_type<CARawPoint, CADBPoint>, std::less<CARawPoint>, true>, std::allocator<std::__value_type<CARawPoint, CADBPoint>>> { void *x0; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<CARawPoint, CADBPoint>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *x0; } x0; } x1; struct __compressed_pair<unsigned long, std::__map_value_compare<CARawPoint, std::__value_type<CARawPoint, CADBPoint>, std::less<CARawPoint>, true>> { unsigned long long x0; } x2; } x0; } x1; BOOL x2; unsigned int x3; float x4; float x5; })volumeCurveFromControlInfo:(id)a0;
