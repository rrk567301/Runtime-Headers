@class NSDictionary, NSProxy, CALayerHost, NSMutableArray, NSMutableSet, NSString, NSViewRemoteBridge, NSRemoteViewControllerParametersForService, NSArray, NSColor, NSXPCListenerEndpoint, NSCFRunLoopSemaphore, NSObject, NSSet, NSRemoteView, NSWindow, NSData, NSXPCInterface, NSAccessibilityRemoteUIElement, NSVBAccessoryWindow, NSTrackingArea, NSFakeServiceResponder, NSXPCConnection;
...
@interface NSRemoteViewMarshal : NSObject <NSRemoteViewMarshal, NSVBRedactedProtocol, NSScrollViewSeparatorTrackingAdapter> {
    ...
    unsigned char _delegateDidEncounterError : 1;
    unsigned char _delegateDidHandleInvalidation : 1;
...
- (void)setCursor:(id)a0 hotSpot:(struct CGPoint { double x0; double x1; })a1;
