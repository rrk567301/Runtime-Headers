...
@interface INFERENCESchemaINFERENCECRRTrainingSampleCollected : SISchemaInstrumentationMessage {
    struct { unsigned char resolutionState : 1; unsigned char resolutionType : 1; unsigned char isInteractionExecuted : 1; unsigned char isInteractionSuccess : 1; unsigned char interactionDurationInSecBucket : 1; unsigned char isPlusContactSuggesterEnabled : 1; } _has;
}
