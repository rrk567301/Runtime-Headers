...
- (void)_fetchCertForFabricWithIndex:(id)a0 isOwner:(BOOL)a1 completion:(id /* block */)a2;
...
- (void)fetchCertForFabricWithIndex:(id)a0 isOwner:(BOOL)a1 completion:(id /* block */)a2;
