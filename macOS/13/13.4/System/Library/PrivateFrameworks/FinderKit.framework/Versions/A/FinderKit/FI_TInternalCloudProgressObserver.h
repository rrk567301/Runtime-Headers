@class NSArray, NSIndexSet, NSProgress, FI_TICloudProgressObserver, NSObject, FI_TKeyValueObserverGlue;

@interface FI_TInternalCloudProgressObserver : NSObject {
    struct TNSWeakPtr<FI_TICloudProgressObserver> { FI_TICloudProgressObserver *fWeakObject; } _observer;
    ...
    struct TNSWeakPtr<NSProgress> { NSProgress *fWeakObject; } _progress;
    int _progressCount;
}
