@interface FI_IPropertySizeExtractor : FI_IPropertyValueExtractor {
    ...
    struct map<TFENode, NSMutableDictionary *, std::less<TFENode>, std::allocator<std::pair<const TFENode, NSMutableDictionary *>>> { struct __tree<std::__value_type<TFENode, NSMutableDictionary *>, std::__map_value_compare<TFENode, std::__value_type<TFENode, NSMutableDictionary *>, std::less<TFENode>, true>, std::allocator<std::__value_type<TFENode, NSMutableDictionary *>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<TFENode, NSMutableDictionary *>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<TFENode, std::__value_type<TFENode, NSMutableDictionary *>, std::less<TFENode>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _nodesAndSizeMap;
}
