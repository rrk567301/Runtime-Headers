...
@interface FI_TListViewController : FI_TBrowserViewController <TListHeaderRowViewDelegate, NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate, TListNameFieldDelegate, TListRowViewDelegate, TListViewDelegate> {
    ...
    struct multimap<long, TFENode, std::less<long>, std::allocator<std::pair<const long, TFENode>>> { struct __tree<std::__value_type<long, TFENode>, std::__map_value_compare<long, std::__value_type<long, TFENode>, std::less<long>, true>, std::allocator<std::__value_type<long, TFENode>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<long, TFENode>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<long, std::__value_type<long, TFENode>, std::less<long>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _depthToOpenContainerMap;
...
+ (void)updateSyncBadgeForNameCellView:(id)a0 node:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a1 canShowSyncBadge:(BOOL)a2 cloudSyncedLocation:(struct optional<bool> { union { char x0; BOOL x1; } x0; BOOL x1; })a3 forAccessibilityElement:(id)a4;
