@class _SFPBCoreSpotlightButtonItem, NSString, _SFPBWatchListButtonItem, _SFPBCommandButtonItem, _SFPBContactButtonItem, _SFPBAppAutoShortcutsButtonItem, NSData;
