...
- (id)initWithPurpose:(long long)a0 metric:(long long)a1 contentIdentifier:(id)a2 contextIdentifier:(id)a3 identifier:(id)a4 properties:(id)a5 internalProperties:(id)a6 options:(long long)a7;
