@class NSArray, MTLArchitecture, MTLGPUBVHBuilder, NSDictionary, NSString, MTLTargetDeviceArchitecture, NSMutableArray;
@protocol MTLDeviceSPI;

@interface PTMTLDeviceProxy : NSObject <MTLDeviceSPI>

@property (retain) id<MTLDeviceSPI> delegate;
@property (retain) NSMutableArray *allocatedTextures;
