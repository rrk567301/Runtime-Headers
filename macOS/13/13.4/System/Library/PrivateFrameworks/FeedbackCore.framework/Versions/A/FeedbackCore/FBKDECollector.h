@class NSString, NSSet, NSMutableSet, FBKGroupedDevice;
...
- (id)initWithRequirements:(id)a0 forDevice:(id)a1 filerForm:(id)a2 extensionsFromURL:(id)a3 listener:(id)a4 shouldGetSessionStatus:(BOOL)a5 shouldCheckDeferredLogs:(BOOL)a6;
