...
@property (retain, nonatomic) HMDAccessorySessionMetric *sessionMetric;
...
- (void)didUpdateConnectionState:(BOOL)a0 sessionInfo:(id)a1 withError:(id)a2;
- (void)didUpdateConnectionState:(BOOL)a0 withError:(id)a1;
...
- (void)handleLockNotificationMessage:(id)a0;
...
- (void)postUpdateEventsIfDifferentWithPerferredMediaUUID:(id)a0 selectionType:(unsigned long long)a1;
...
- (void)sendLockNotification:(id)a0 lockOperationType:(id)a1 lockOperationSource:(id)a2;
