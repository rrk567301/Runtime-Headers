...
- (id)cleanupBadHomeManagerRecordsForHomeManger:(id)a0;
- (void)generateModelChangesForHomeManger:(id)a0 homeName:(id)a1 pairingHomeUUID:(id)a2 defaultRoomUUID:(id)a3 homeZoneUUID:(id)a4 accessory:(id)a5 configurationAppIdentifier:(id)a6 outBlobChanges:(id *)a7 outLegacyChanges:(id *)a8 outHomeManagerChanges:(id *)a9;
