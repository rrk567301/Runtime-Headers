@class NSMutableArray, SUMacControllerScanEventInfo, SUCoreFSM, NSString, SUCoreLog, SUMacControllerBridgeOSManager, NSObject, SUMacControllerRosettaManager, SUMacControllerRecoveryOSManager, SUCoreScan, SUMacControllerClientRequest;
