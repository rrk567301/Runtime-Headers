@class RBProcess, RBPowerAssertionManager, RBProcessReconnectManager, RBAssertionManager, RBBundlePropertiesManager, RBEntitlementManager, RBThrottleBestEffortNetworkingManager, RBThermalResponseManager, RBAssertionDescriptorValidator, NSString, RBProcessManager, RBConnectionListener, RBAssertionOriginatorPidStore, RBStateCaptureManager, RBProcessMonitor, RBDomainAttributeManager, RBJetsamPropertyManager;
