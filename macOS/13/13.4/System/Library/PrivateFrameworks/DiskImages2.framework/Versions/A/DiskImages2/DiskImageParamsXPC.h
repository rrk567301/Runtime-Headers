@class BackendXPC, NSArray, NSUUID, NSURL;
...
@property (retain, nonatomic) NSArray *shadowBackendsXPC;
...
+ (id)createAEADIParamsXPCWithBackendXPC:(id)a0 error:(id *)a1;
+ (BOOL)getAEAKeyFromSAKSWithAEA_helper:(void *)a0 key:(char *)a1 error:(id *)a2;
+ (id)newWithUnlockedBackendXPC:(id)a0 error:(id *)a1;
+ (id)validateAEAFormatWithBackendXPC:(id)a0 error:(id *)a1;
