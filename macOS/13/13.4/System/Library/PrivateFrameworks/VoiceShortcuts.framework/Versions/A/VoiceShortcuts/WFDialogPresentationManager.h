@class WFScreenOnObserver, NSString, WFPresentedDialog, WFDialogAttribution, NSObject, NSMutableArray, NSXPCListener, WFWorkflowRunningContext, WFDialogNotificationManager;
