@class NSDate, PowerUIBDCDataManager, NSString, NSNumber, NSDictionary, PowerUINotificationManager, NSObject, PowerUIChargingController, NSUserDefaults, PowerUICECPredictedTimeManager;
