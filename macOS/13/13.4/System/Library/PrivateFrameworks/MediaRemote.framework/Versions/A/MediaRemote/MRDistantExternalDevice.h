@class NSXPCConnection, NSString, NSXPCListenerEndpoint, NSDate, MRAVDistantEndpoint, MRExternalOutputContextDataSource, NSArray, NSObject, NSMutableArray, MROrigin;
