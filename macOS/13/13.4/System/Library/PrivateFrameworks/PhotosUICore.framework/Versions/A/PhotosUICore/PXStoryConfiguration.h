@class NSString, NSArray, NSMutableDictionary, PXStoryErrorRepository, PHPhotoLibrary, PHAssetCollection, PXStorySongsConfiguration, PXVolumeController, NSObject, PXMediaProvider;
