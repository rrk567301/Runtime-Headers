...
- (void)textureProvider:(id)a0 didProvideCGImage:(struct CGImage { } *)a1 options:(struct { id x0; BOOL x1; })a2 isDegraded:(BOOL)a3 forRequestID:(int)a4;
...
- (void)textureProvider:(id)a0 didProvidePixelBuffer:(struct __CVBuffer { } *)a1 options:(struct { id x0; BOOL x1; })a2 forRequestID:(int)a3;
