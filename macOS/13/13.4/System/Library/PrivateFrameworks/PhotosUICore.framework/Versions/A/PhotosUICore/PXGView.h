...
@interface PXGView : NSView <PXGEngineDelegate, PXScrollViewControllerObserver, PXGLayoutScrollDelegate, PXGLayoutViewDelegate, PXGLayoutFocusDelegate, PXSettingsKeyObserver, PXNSScrollViewControllerAccessibilityDelegate, PXGAXResponder, PXGDiagnosticsProvider, PXDebugHierarchyProvider, PXTapToRadarDiagnosticProvider, PXGHitTestEnvironment> {
