@class NSString, NSArray, MPNowPlayingInfoCenter, MPRemoteCommandCenter, _MPCMediaRemotePublisher_Swift, NSDictionary, NSObject, MPCPlaybackEngine, NSUserDefaults, MSVBlockGuard;
