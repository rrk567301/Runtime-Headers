@class FCAssetHandle, NSString, NSArray, NSDate, FCColor, FCPaywallConfiguration, NSDictionary, NSData, FCSportsRecommendationMappings, NTPBPublisherPaidDescriptionStrings, FCInterestToken, FCSectionSupergroupKnobs;
@protocol FCChannelProviding, FCSportsTheming, FCSportsEventProviding, FCSectionProviding, FCTagStocksFields, FCSportsProviding, FCTopicProviding, FCFeedTheming;
...
- (id)initWithSportsEventRecord:(id)a0 eventCompetitorTags:(id)a1 eventLeagueTag:(id)a2 assetManager:(id)a3 interestToken:(id)a4 sportsEventPagesEnabled:(BOOL)a5;
