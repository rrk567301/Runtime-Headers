@class NSString, NSMutableDictionary, NSUUID, NSError, NSDictionary, NSArray;

@interface HMDCharacteristicReadWriteLogEvent : HMMHomeLogEvent <HMDBiomeLogEvent, HMMCoreAnalyticsLogging>
