...
- (void).cxx_destruct;
- (id)initWithAllowedCountriesDataSource:(id)a0 pairedDeviceCapabilityProvider:(id)a1 availableRegionsDevicePropertyName:(id)a2 loggingCategory:(id)a3 shouldReturnLocalAvailabilityForNilDeviceRegions:(BOOL)a4;
