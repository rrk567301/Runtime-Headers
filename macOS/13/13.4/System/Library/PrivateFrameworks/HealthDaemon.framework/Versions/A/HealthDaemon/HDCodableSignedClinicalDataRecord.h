...
@interface HDCodableSignedClinicalDataRecord : PBCodable <HDDecoding, NSCopying> {
    struct { unsigned char expirationDate : 1; unsigned char issuedDate : 1; unsigned char relevantDate : 1; unsigned char signatureStatus : 1; unsigned char sourceType : 1; } _has;
}
