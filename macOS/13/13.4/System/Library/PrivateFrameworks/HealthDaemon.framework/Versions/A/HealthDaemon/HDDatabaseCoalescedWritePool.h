@class _HKDelayedOperation, NSString, HDProfile, NSMutableArray, NSObject, HDDatabaseCoalescedWritePoolQuota;
...
@property (copy, nonatomic) HDDatabaseCoalescedWritePoolQuota *quota;
