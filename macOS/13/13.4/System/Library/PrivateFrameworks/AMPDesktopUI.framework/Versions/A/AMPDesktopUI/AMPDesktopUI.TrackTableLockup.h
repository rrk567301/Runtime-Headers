...
@interface AMPDesktopUI.TrackTableLockup : NSTableCellView <AMPDesktopUI.UXItemActionSupport, NSOutlineViewDataSource>

@property (nonatomic, readonly) NSArray *selectedViewModels;
