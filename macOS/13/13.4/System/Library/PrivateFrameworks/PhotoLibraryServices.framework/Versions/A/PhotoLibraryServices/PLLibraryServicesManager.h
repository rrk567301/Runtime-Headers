@class PLMomentGenerationDataManager, NSPersistentStoreCoordinator, PLCacheDeleteSupport, PLModelMigrator, NSMutableArray, PFClientSideEncryptionManager, PLDupeManager, PLLibraryServicesCPLReadiness, PLAssetsdCrashRecoverySupport, NSProgress, PLComputeCacheManager, PLCacheDeleteRegistration, PLPairing, PLClientServerTransaction, PLRebuildJournalManager, PLChangeHandlingContainer, PLQuickActionManager, NSURL, PLImageWriter, PLBackgroundJobService, PLDuplicateProcessor, PLLibraryServicesStateNode, PLTrackableRequestManager, PLSearchIndexManager, PLPhotoLibraryBundle, PLCloudPhotoLibraryManager, NSString, NSError, NSObject, PLKeywordManager, PLPhotoLibraryPathManager, PLLazyObject, NSMutableDictionary, PLDatabaseContext, PLRelationshipOrderKeyManager, PLSyndicationDeleteManager, PFStateCaptureHandler;
