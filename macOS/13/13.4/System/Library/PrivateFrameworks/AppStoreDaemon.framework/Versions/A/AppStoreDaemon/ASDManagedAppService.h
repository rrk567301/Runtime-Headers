...
- (void)availableVPPUpdatesWithResultHandler:(id /* block */)a0;
- (void)processITMSServicesRequest:(id)a0 withResultHandler:(id /* block */)a1;
- (void)reloadAvailableVPPUpdatesWithResultHandler:(id /* block */)a0;
