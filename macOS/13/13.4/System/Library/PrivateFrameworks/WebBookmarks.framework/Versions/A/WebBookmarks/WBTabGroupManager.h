@class NSHashTable, NSString, NSArray, WBBrowserState, NSSet, WBSCRDTPositionGenerator, NSMutableDictionary, WBParticipantPresenceCoordinator, NSObject, NSMutableSet, WBTabCollection;
