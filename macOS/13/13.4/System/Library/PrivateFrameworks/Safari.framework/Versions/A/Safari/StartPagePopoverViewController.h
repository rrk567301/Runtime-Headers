@class NSView, NSString, NSScrollView, NSArray, CollectionViewPlus, NSStackView, ToggleRowItem, NSLayoutConstraint, NSPopover, NSCollectionView, NSIndexPath;
...
- (id)initWithPositioningView:(id)a0 backgroundView:(id)a1;
