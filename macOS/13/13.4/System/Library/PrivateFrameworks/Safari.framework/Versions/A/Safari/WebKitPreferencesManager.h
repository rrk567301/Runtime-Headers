...
+ (id)_webViewConfigurationForBrowsingMode:(unsigned long long)a0 relatedWebView:(id)a1 groupIdentifier:(id)a2 preferences:(id)a3 userContentController:(id)a4 jitEnabled:(BOOL)a5 preferencesManager:(id)a6;
...
+ (id)contentWebViewConfigurationForBrowsingMode:(unsigned long long)a0;
+ (id)contentWebViewConfigurationForBrowsingMode:(unsigned long long)a0 jitEnabled:(BOOL)a1;
...
+ (id)readerWebViewConfigurationForBrowsingMode:(unsigned long long)a0 relatedWebView:(id)a1;
