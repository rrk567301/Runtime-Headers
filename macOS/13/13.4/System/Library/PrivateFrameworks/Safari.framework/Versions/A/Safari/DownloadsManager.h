...
- (id)startDownloadForRequest:(id)a0 shouldAvoidPersistingIdentifyingInformation:(BOOL)a1;
- (id)startDownloadForRequest:(id)a0 suggestedFilename:(id)a1 downloadLocationRequestType:(long long)a2 shouldAvoidPersistingIdentifyingInformation:(BOOL)a3 originatingWebView:(id)a4;
