...
- (void)dimForModalDialogPresentationWithCompletionHandler:(id /* block */)a0;
...
- (void)prepareForModalDialogPresentationWithDimmingView:(id)a0;
- (void)uninstallModalDialogDimmingViewAnimated:(BOOL)a0 completionHandler:(id /* block */)a1;
