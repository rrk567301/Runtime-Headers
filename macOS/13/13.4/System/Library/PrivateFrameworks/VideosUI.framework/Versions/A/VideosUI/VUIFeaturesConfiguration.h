@class VUIPlaybackUpNextConfig, VUIDownloadConfig, VUIMediaShowcasingConfig, VUINowPlayingConfig, VUIAutoPlayConfig, VUIAccountMessageConfig, VUILiveLinkConfig, VUIUpNextConfig, VUICanonicalConfig, VUIMultiviewConfig, VUISyndicationConfig, VUIInAppMessagesConfig, VUIDropOnTabConfig, VUIAccountConfig;
