@class VUICircularProgress, NSViewController, NSImage, VUITextLayout, NSImageSymbolConfiguration, VUIDownloadButtonViewModel, VUIDownloadButtonActionHandler;
...
- (id)_buttonPropertiesForState:(unsigned long long)a0 downloadExpirationDate:(id)a1 hasFailed:(BOOL)a2;
- (void)_configureProgressIndicatorWithProperties:(id)a0;
- (id)_connectingImage;
- (id)_downloadingImage;
- (id)_expiredDownloadImage;
- (id)_imageForDownloadState:(unsigned long long)a0 downloadExpirationDate:(id)a1 hasFailed:(BOOL)a2;
...
- (void)_updateButtonToState:(unsigned long long)a0 downloadExpirationDate:(id)a1 hasFailed:(BOOL)a2;
