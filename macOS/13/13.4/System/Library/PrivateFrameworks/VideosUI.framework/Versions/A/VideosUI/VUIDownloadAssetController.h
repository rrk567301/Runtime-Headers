@class VUIMediaEntityType, VUIVideosPlayable, VUIMediaEntityAssetControllerState, TVDownloadManagerProvider, NSString, NSObject, VUIDownloadItem;
@protocol OS_dispatch_queue, VUIMediaEntityIdentifier, VUIMediaEntityAssetControllerDelegate;
...
- (id)initWithVideosPlayable:(id)a0 delegate:(id)a1;
