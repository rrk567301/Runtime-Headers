@class NSView, NSString, GKGame, GKDashboardMultiplayerPickerViewController, _TtC12GameCenterUI23GKMultiplayerFooterView, NSURL, GKMultiplayerDataSource, GKMatchRequest;
