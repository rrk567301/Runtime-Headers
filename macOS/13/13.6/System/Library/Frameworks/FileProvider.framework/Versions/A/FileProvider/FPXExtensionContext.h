...
- (id)createTempThumbnailURLForVersion:(id)a0 itemIdentifier:(id)a1 isFromData:(BOOL)a2;
...
- (void)didUpdateAlternateContentsDocumentForDocumentWithItem:(id)a0 completionHandler:(id /* block */)a1;
