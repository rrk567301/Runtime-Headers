...
@property (readonly, nonatomic) BOOL associatedDomainsEnabled;
@property (readonly, nonatomic) BOOL textMessageVerificationEnabled;
@property (readonly, nonatomic) BOOL preArmTestVerificationEnabled;
@property (readonly, nonatomic) BOOL variantOfConcernEnabled;
...
@property (readonly, nonatomic) BOOL resetAvailabilityAlertForDeclinedUsers;
...
@property (readonly, nonatomic) BOOL isChaffingEnabled;
