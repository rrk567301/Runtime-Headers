...
@interface SCNPhysicsSliderJoint : SCNPhysicsBehavior {
    struct { SCNPhysicsBody *bodyA; SCNPhysicsBody *bodyB; struct SCNVector3 { double x; double y; double z; } axisA; struct SCNVector3 { double x; double y; double z; } anchorA; struct SCNVector3 { double x; double y; double z; } axisB; struct SCNVector3 { double x; double y; double z; } anchorB; double minLinearLimit; double maxLinearLimit; double minAngularLimit; double maxAngularLimit; double motorTargetLinearVelocity; double motorMaximumForce; double motorTargetAngularVelocity; double motorMaximumTorque; } _definition;
...
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } axisA;
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } anchorA;
@property (readonly, nonatomic) SCNPhysicsBody *bodyB;
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } axisB;
@property (nonatomic) struct SCNVector3 { double x0; double x1; double x2; } anchorB;
...
+ (id)jointWithBody:(id)a0 axis:(struct SCNVector3 { double x0; double x1; double x2; })a1 anchor:(struct SCNVector3 { double x0; double x1; double x2; })a2;
+ (id)jointWithBodyA:(id)a0 axisA:(struct SCNVector3 { double x0; double x1; double x2; })a1 anchorA:(struct SCNVector3 { double x0; double x1; double x2; })a2 bodyB:(id)a3 axisB:(struct SCNVector3 { double x0; double x1; double x2; })a4 anchorB:(struct SCNVector3 { double x0; double x1; double x2; })a5;
...
- (id)initWithBody:(id)a0 axis:(struct SCNVector3 { double x0; double x1; double x2; })a1 anchor:(struct SCNVector3 { double x0; double x1; double x2; })a2;
- (id)initWithBodyA:(id)a0 axisA:(struct SCNVector3 { double x0; double x1; double x2; })a1 anchorA:(struct SCNVector3 { double x0; double x1; double x2; })a2 bodyB:(id)a3 axisB:(struct SCNVector3 { double x0; double x1; double x2; })a4 anchorB:(struct SCNVector3 { double x0; double x1; double x2; })a5;
