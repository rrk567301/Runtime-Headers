...
@interface SCNPhysicsHingeJoint : SCNPhysicsBehavior {
    struct { SCNPhysicsBody *bodyA; SCNPhysicsBody *bodyB; struct SCNVector3 { double x; double y; double z; } anchorA; struct SCNVector3 { double x; double y; double z; } anchorB; struct SCNVector3 { double x; double y; double z; } axisA; struct SCNVector3 { double x; double y; double z; } axisB; } _definition;
