...
@protocol MEComposeSessionHandler, MEContentBlocker_Private, MEComposeSessionHandler_Private, MEMessageSecurityHandler, MEMessageActionHandler_Private, OS_dispatch_queue, MEMessageActionHandler;
...
@property (readonly, nonatomic) id<MEMessageActionHandler> messageActionInterface;
