...
- (bycopy id)clientWithId:(bycopy id)a0 wantsToBeginSyncPlanBeforeDate:(bycopy id)a1 entityNames:(bycopy id)a2 pushTruthForEntityNames:(bycopy id)a3 quietlyPushingTruth:(bycopy id)a4 callback:(byref id)a5 withPlanIdentifier:(id)a6 hasChanges:(bycopy id)a7 skip:(bycopy id)a8;
