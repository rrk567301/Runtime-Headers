@class SFColor, NSString, NSArray, NSURL, SFMessageAttachment, NSData, NSDictionary, SFCard, SFUserReportRequest, SFCommand;

@interface SFMessageCardSection : SFCardSection <SFMessageCardSection, NSSecureCoding, NSCopying> {
    struct { unsigned char canBeHidden : 1; unsigned char hasTopPadding : 1; unsigned char hasBottomPadding : 1; unsigned char separatorStyle : 1; unsigned char messageStatus : 1; unsigned char messageServiceType : 1; } _has;
}
