...
@interface GEOMapItemAddressBookAttributes : PBCodable <NSCopying> {
    ...
    int _addressType;
    BOOL _isMe;
    struct { unsigned char has_addressType : 1; unsigned char has_isMe : 1; unsigned char read_unknownFields : 1; unsigned char read_addressIdentifier : 1; unsigned char read_name : 1; unsigned char read_spokenName : 1; unsigned char wrote_anyField : 1; } _flags;
}
