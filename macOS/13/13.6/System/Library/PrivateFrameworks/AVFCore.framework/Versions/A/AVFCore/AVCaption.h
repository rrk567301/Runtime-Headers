...
+ (void)_appendFigStyleKey:(const struct __CFString { } *)a0 value:(const void *)a1 range:(struct { long long x0; long long x1; })a2 toArray:(id)a3;
+ (id)captionFromFigCaption:(const struct OpaqueFigCaption { } *)a0;
...
- (id)initWithFigCaptionData:(const struct OpaqueFigCaptionData { } *)a0 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a1;
