@class MTAlarmStorage, NSDate, MTTimerSnapshot, MTTimerServer, MTAlarmServer, MTSystemStateListener, NSString, MTTimerStorage, MTAlarmIntentDonor, MTTimeListener, MTLanguageChangeListener, MTAlarmSnapshot, MTTimerScheduler, MTAgentNotificationManager, MTAlarmScheduler, MTAgentDiagnosticListener;
