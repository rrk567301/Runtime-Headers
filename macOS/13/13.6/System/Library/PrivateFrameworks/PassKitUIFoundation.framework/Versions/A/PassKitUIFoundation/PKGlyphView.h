@class NSString, PKMicaLayer, LAUICheckmarkLayer, CALayer, CAShapeLayer, PKPhoneGlyphLayer, PKFingerprintGlyphView, NSObject, NSMutableArray, NSColor;
...
- (void)_layoutContentLayer:(id)a0 ringFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
