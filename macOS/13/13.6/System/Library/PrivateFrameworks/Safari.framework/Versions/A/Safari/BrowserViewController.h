@class PagePreviewAnimationController, FullscreenUnifiedFieldWindowController, NSWindow, NSUserActivity, BackgroundLoad, WebCrashBanner, NSMutableDictionary, NSMapTable, BrowserContainerViewController, NSURLProtectionSpace, WBSFluidProgressState, BrowserWindowController, SafariAppExtensionsController, NSURLRequest, ContinuousReadingListViewController, WBSHistoryVisit, WBSMutableOrderedSet, StartPageViewController, NSView, NSSet, NSMutableArray, TabDialogPresentationManager, SafariWebExtensionsController, NSTimer, Banner, StatusMessage, WBSTranslationContext, PointerLockBanner, BrowserTabViewItem, NSHashTable, TextFieldInformation, NSData, SheetRequest, _WKWebAuthenticationAssertionResponse, NSDate, WBSPermissionDialogThrottler, WBSMultiRoundAutoFillManager, BrowserTabPersistentState, TabDialogViewController, NSArray, CKContextCompleter, WBSCreditCardData, TabContentView, DefaultBrowserBanner, BrowserDocument, _WKRemoteObjectInterface, JavaScriptDialogSuppressionManager, WBSURLSpoofingMitigator, PrivateBrowsingExplanationBanner, HighlightBanner, ContinuousReadingListPageItem, NSString, NewExtensionBanner, BookmarksViewController, BrowserNavigationDelegate, CKContextResponse, NSURL, ReadingListItem, BrowserDiagnosticLoggingDelegate, BrowserInspectorDelegate, BrowserResourceLoadDelegate, NSDictionary, WBSSameDocumentNavigationToHistoryVisitCorrelator, PrintSheetSuppressionManager, ResponsiveDesignViewController, NSMutableSet, AppLinkBannerController, WBSSecIdentitiesCache, SearchableWKView, History, AutoFillFunctionBarProvider, WBSFormMetadata, BrowserWKView, WBSHistoryContextController, RemoteNotificationVerificationRequest, NSPrintInfo, PassDownloadSuppressionManager;
@protocol AppExtensionMessageReceiver, WBSSandboxExtensionToken, WBSCertificateWarningPagePresenter, AuthenticationSessionNavigationHandling, BundleBrowserViewController, RemoteNotificationStateObserver, FormAutoFiller, WKUIDelegate, WBSContentBlockerStatisticsStore, BrowserContentLoaderDelegate;
