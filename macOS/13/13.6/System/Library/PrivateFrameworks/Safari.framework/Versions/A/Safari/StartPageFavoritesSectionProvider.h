@class BookmarkAddressEditingPopoverViewController, NSString, WBTabGroup, SafariWebBookmarkList, NSArray, WBSPair, NSTimer;
...
@property (nonatomic) BOOL shouldHideSectionWhenEmpty;
