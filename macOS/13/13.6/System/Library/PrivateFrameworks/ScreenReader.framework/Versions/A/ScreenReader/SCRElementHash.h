@class NSLock, SCRCThreadKey, SCRCTargetSelectorTimer, NSConditionLock, SCRUIElement, SCRCStackQueue, SCRCIndexMap, NSMutableArray, AXFMutableDiscontinuousArray;
