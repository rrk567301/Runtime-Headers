...
- (id)init;
- (void)addPackagePropertiesFromReader:(id)a0 toMetadata:(id)a1;
- (void)addPackagePropertiesFromReader:(id)a0 toSearchableAttributes:(id)a1;
- (id)metadataForOfficeFileAtURL:(id)a0 error:(id *)a1;
- (id)metadataForXMLOfficeFileOfType:(unsigned long long)a0 atURL:(id)a1 error:(id *)a2;
