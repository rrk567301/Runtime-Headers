@class NSTextField, NSView, WKWebView, NSProgressIndicator, NSURL, NSString, NSArray, NSError, NSData, NSLayoutConstraint, NSButton, NSBox;
...
@property BOOL detectedProfileDownload;
...
- (void)clearStatus;
- (void)_webView:(id)a0 didStartProvisionalNavigation:(id)a1 userInfo:(id)a2;
