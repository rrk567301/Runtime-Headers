...
@interface _MRDeviceInfoMessageProtobuf : PBCodable <NSCopying> {
    struct { unsigned char protocolVersion : 1; unsigned char clusterType : 1; unsigned char deviceClass : 1; unsigned char lastKnownClusterType : 1; unsigned char lastSupportedMessageType : 1; unsigned char logicalDeviceCount : 1; unsigned char sharedQueueVersion : 1; unsigned char allowsPairing : 1; unsigned char connected : 1; unsigned char groupContainsDiscoverableGroupLeader : 1; unsigned char isAirplayActive : 1; unsigned char isClusterAware : 1; unsigned char isGroupLeader : 1; unsigned char isProxyGroupPlayer : 1; unsigned char parentGroupContainsDiscoverableGroupLeader : 1; unsigned char supportsACL : 1; unsigned char supportsExtendedMotion : 1; unsigned char supportsMultiplayer : 1; unsigned char supportsSharedQueue : 1; unsigned char supportsSystemPairing : 1; unsigned char tightlySyncedGroup : 1; } _has;
}
