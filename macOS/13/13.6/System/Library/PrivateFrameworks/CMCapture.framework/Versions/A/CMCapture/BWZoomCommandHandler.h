...
- (float)updateZoomModelAndAppliedZoomFactorForNextFrameWithPTS:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 ptsTolerance:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 delayedISPAppliedZoomFactor:(float)a2;
