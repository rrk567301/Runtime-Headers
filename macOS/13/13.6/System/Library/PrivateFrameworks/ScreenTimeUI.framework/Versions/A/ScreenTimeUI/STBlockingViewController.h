@class NSTextField, NSView, STHourglassView, NSBox, NSString, NSStackView, STManagementState, CNContactStore, STPasscodeField, NSImageView, NSLayoutConstraint, NSButton;
