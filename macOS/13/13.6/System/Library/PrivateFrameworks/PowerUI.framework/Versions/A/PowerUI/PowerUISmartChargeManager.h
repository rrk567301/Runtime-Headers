@class NSDate, NSDictionary, NSObject, PowerUIMLTwoStageModelPredictor, PowerUIDesktopModePredictor, NSDistributedNotificationCenter, PowerUISleepWakeMonitor, NSString, PowerUITrialManager, _CDContextualKeyPath, NSXPCListener, PowerUIBatteryMitigationManager, NSArray, PowerUIBDCDataManager, NSNumber, PowerUIChargingController, PowerUINotificationManager;
