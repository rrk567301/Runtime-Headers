@class NSMutableDictionary, SUOSUNotificationManagerController, SUOSUAuthenticationManager, NSDictionary, NSObject, NSMutableArray, SUOSUScheduler, NSString, NSXPCListener, NSArray, SUMacControllerOverrides, SUOSUMobileSoftwareUpdateController, NSProgress;
...
- (void)_queueMobileSoftwareUpdateDescriptorToApplyAtLogout:(id)a0 completion:(id /* block */)a1;
