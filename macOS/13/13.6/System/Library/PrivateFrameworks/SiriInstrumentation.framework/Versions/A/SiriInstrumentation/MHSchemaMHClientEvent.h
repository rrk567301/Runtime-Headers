@class MHSchemaMHDarwinConnectedDeviceWakeContext, MHSchemaMHEndpointerAccessibleContext, SISchemaInstrumentationMessage, MHSchemaMHAssistantDaemonAudioSessionSetInactiveContext, MHSchemaMHAssistantDaemonAudioPrewarmContext, MHSchemaMHAssistantDaemonAudioPrepareContext, MHSchemaMHVoiceTriggerContext, MHSchemaMHAssistantDaemonAudioInitContext, MHSchemaMHAudioDucked, MHSchemaMHAssistantDaemonAudioRecordingMissedBufferDetected, MHSchemaMHAssistantDaemonAudioFetchRouteContext, MHSchemaMHUnintendedResponseSuppressionEvaluationContext, MHSchemaMHAssistantDaemonAudioRecordingFailed, MHSchemaMHRTSFalseRejectDetected, MHSchemaMHVoiceTriggerTwoShotDetected, NSData, MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext, MHSchemaMHAssistantDaemonAudioTwoShotTransitionContext, MHSchemaMHEndpointDelayContext, MHSchemaMHApplicationPlaybackAttempted, MHSchemaMHAssistantDaemonAudioLateBufferDetected, MHSchemaMHAssistantDaemonAudioStartRecordingContext, MHSchemaMHSiriLaunchRequestContext, MHSchemaMHCarplayLanguageMismatch, MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext, MHSchemaMHAssistantDaemonAudioSessionSetActiveContext, MHSchemaMHMitigationDecisionRecommended, MHSchemaMHOdldFalseTriggerMitigated, MHSchemaMHServerEndpointerContext, MHSchemaMHAssistantDaemonAudioRecordingContext, MHSchemaMHSiriDirectedSpeechDetectionFailed, MHSchemaMHVoiceAdBlockerContext, MHSchemaMHCoreSpeechPreprocessorCompleted, MHSchemaMHASRAudioConfigureStarted, MHSchemaMHAssistantDaemonAudioStopRecordingContext, MHSchemaMHSpeakerFalseTriggerMitigated, MHSchemaMHTRPCreated, MHSchemaMHAssistantDaemonAudioConfigureContext, MHSchemaMHAssistantDaemonAudioBluetoothInfo, MHSchemaMHEndpointLatencyInfoReported, SISchemaUUID, MHSchemaMHClientEventMetadata, MHSchemaMHAssistantDaemonAudioRecordingFirstBufferContext, MHSchemaMHEndpointerUsed, MHSchemaMHAssistantDaemonAudioRecordingInterruptionContext, MHSchemaMHOnDeviceEndpointerContext, MHSchemaMHAcousticFalseTriggerMitigationEvaluationContext, MHSchemaMHAssistantDaemonAudioRecordingInterruptionStartedTier1, MHSchemaMHEndpointDetected;
