...
@property (setter=setPeriodicEventEnabled:) BOOL isPeriodicEventEnabled;
...
- (void)updateAVSyncOffsetSumAndCountWithValueOnCall:(int)a0;
- (void)updateAVSyncOffsetSumAndCountWithValueOnSegment:(int)a0;
...
- (void)updateAudioCodecAndMediaBitrateOnSegment:(id)a0 currentTime:(double)a1;
...
- (void)updateLastReportedValues:(id)a0;
- (void)updateLateFrameStatsOnCall:(id)a0;
- (void)updateLateFrameStatsOnSegment:(id)a0;
- (void)updateLinkSuggestionTelemetry:(id)a0;
- (void)updateNetworkSendResultStatsOnCall:(id)a0;
- (void)updateNetworkSendResultStatsOnSegment:(id)a0;
...
- (void)updateRTStatsOnCall:(id)a0 currentTime:(double)a1;
- (void)updateRTStatsOnSegment:(id)a0 currentTime:(double)a1;
- (void)updateRTXStatsOnCall:(id)a0;
- (void)updateRTXStatsOnSegment:(id)a0;
