@class PXExploreLayoutMetrics, NSShadow, PXStoryChromeButtonSpec, NSDictionary, NSColor;
...
@property (readonly, nonatomic) struct CGPoint { double x; double y; } thumbnailActionMenuButtonExtraOffset;
...
@property (readonly, nonatomic) BOOL thumbnailMenuPrefersFeatureLessActionDisambiguationSubmenu;
