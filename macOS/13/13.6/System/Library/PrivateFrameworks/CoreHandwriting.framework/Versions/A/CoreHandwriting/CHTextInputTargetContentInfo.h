...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })unionCharacterRectForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
