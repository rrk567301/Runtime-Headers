@class NSData, AKAuthorizationRequest, NSString, NSArray, ASGlobalFrameIdentifier, LAContext, ASCPublicKeyCredentialAssertionOptions, NSNumber, ASCPublicKeyCredentialCreationOptions;
