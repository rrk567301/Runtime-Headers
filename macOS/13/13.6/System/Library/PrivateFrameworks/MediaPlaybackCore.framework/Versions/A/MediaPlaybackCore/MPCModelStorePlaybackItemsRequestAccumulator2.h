@class NSError, NSString, MPPropertySet, NSHashTable, MPMutableSectionedCollection, NSMutableDictionary, MPCModelStorePlaybackItemsRequest, MPServerObjectDatabase, MPCModelStorePlaybackItemsRequestAccumulation, NSMutableArray, ICURLAggregatedPerformanceMetrics, NSMutableOrderedSet;
