@class NSString, NSArray, NSMutableDictionary, _MPCQueueControllerDisplayCache, MPAVItem, NSMutableArray, MPCPlaybackEngineEventStream, NSMapTable;
...
@property (retain, nonatomic) _MPCQueueControllerDisplayCache *displayCache;
...
- (void)_updateContentItemQueueIndexForItem:(id)a0;
