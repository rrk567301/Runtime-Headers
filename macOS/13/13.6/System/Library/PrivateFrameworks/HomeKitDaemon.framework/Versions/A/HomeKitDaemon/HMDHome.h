...
@property (nonatomic) BOOL threadNetworkPeriodicCheckScheduled;
...
- (void)retrieveCommissioningCertificatesForSharedAdminWithNodeID:(id)a0 publicKey:(id)a1 fabricIndex:(id)a2 completion:(id /* block */)a3;
