@class WBSCRDTPositionGenerator, NSMutableDictionary, NSObject, NSDictionary, WBBrowserState, NSString, NSSet, NSHashTable, WBParticipantPresenceCoordinator, NSMutableSet, WBSPair, NSArray, WBTabCollection, NSCountedSet;
