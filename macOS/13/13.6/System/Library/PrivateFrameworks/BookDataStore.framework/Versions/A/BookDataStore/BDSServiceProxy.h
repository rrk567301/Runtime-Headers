...
- (void)readingHistoryHandleSyncFileChangeWithSyncVersionInfo:(id)a0 completion:(id /* block */)a1;
- (void)readingHistoryIncrementWithDate:(id)a0 by:(long long)a1 withCompletion:(id /* block */)a2;
- (void)readingHistoryReadingHistoryModelSnapshotInfoWithCurrentTime:(id)a0 withCompletion:(id /* block */)a1;
