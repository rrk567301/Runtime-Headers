...
@interface _SVXDeviceSetupFlowMutation : NSObject <SVXDeviceSetupFlowMutating> {
    ...
    long long _gender;
    NSArray *_scenes;
    struct _mutationFlags { unsigned char isDirty : 1; unsigned char hasIdentifier : 1; unsigned char hasLanguageCode : 1; unsigned char hasGender : 1; unsigned char hasScenes : 1; } _mutationFlags;
}
