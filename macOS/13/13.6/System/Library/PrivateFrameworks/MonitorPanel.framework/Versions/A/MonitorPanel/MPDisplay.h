...
+ (id)displayResolutionPreview:(long long)a0 vendorID:(unsigned int)a1 productID:(unsigned int)a2 orientation:(long long)a3 rect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } *)a4 fallback:(BOOL)a5;
