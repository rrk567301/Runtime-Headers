...
@protocol OS_dnssd_cname_array, OS_nw_txt_record, OS_nw_protocol_definition, OS_nw_protocol_instance_registrar, OS_nw_context, OS_dispatch_data, OS_nw_array, OS_xpc_object, OS_nw_interface;
