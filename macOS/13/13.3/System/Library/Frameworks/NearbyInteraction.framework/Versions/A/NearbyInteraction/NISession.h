@class NICarKeyEventNotifier, NSError, NSString, NIConfiguration, NSUUID, NSDictionary, NIServerConnection, NSObject, NIDevicePresenceNotifier, NIExportedObjectForwarder, NIDiscoveryToken;
