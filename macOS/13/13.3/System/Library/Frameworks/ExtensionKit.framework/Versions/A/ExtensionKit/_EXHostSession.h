@class NSView, NSXPCConnection, NSError, NSXPCListenerEndpoint, NSUUID, _EXRemoteViewController, _EXExtensionProcessHandle, _EXHostViewControllerConfiguration, NSObject, NSString, NSXPCListener;
