...
@interface WKWebView : NSView <NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSScrollViewSeparatorTrackingAdapter, NSUserInterfaceValidations, WebViewImplDelegate, WKShareSheetDelegate> {
