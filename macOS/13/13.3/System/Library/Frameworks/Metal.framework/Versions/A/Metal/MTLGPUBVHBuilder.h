...
- (void)dispatchIndirect:(id)a0 counterBuffer:(id)a1 counterBufferOffset:(unsigned long long)a2 counterIndex:(unsigned long long)a3 encoder:(id)a4;
...
- (void)dispatchIndirect:(id)a0 counterBuffer:(id)a1 counterBufferOffset:(unsigned long long)a2 encoder:(id)a3;
...
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 createLeafNodes:(BOOL)a2 enforceMaxDepth:(BOOL)a3;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 threadgroupSize:(unsigned long long)a2;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 threadgroupSize:(unsigned long long)a2 createLeafNodes:(BOOL)a3 enforceMaxDepth:(BOOL)a4;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 threadgroupSize:(unsigned long long)a2 createLeafNodes:(BOOL)a3 enforceMaxDepth:(BOOL)a4 outExecutionWidth:(unsigned long long *)a5;
...
- (id)getPipelineWithKey:(struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 4; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 6; unsigned char x12 : 4; unsigned char x13 : 8; unsigned char x14 : 1; unsigned char x15 : 1; unsigned short x16 : 12; } x0; unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; })a0;
- (id)getPipelineWithKey:(struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 4; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 6; unsigned char x12 : 4; unsigned char x13 : 8; unsigned char x14 : 1; unsigned char x15 : 1; unsigned short x16 : 12; } x0; unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; })a0 outExecutionWidth:(unsigned long long *)a1;
