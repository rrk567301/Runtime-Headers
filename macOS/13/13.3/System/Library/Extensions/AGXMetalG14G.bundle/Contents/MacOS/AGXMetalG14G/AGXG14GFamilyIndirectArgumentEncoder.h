@class NSString, AGXG14GFamilyDevice, AGXG14GFamilyBuffer;
@protocol MTLDevice;

@interface AGXG14GFamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG14GFamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG14GFamilyBuffer *current_argument_buffer; } _impl;
}
