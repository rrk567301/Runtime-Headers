@class AGXG14GFamilyRenderContext, NSString, NSError, __end_, __end_cap_, NSMutableDictionary, NSDictionary, AGXG14GFamilyBlitContext, AGXG14GFamilyComputeContext;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLCommandQueue;

@interface AGXG14GFamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG14GFamilyBlitContext *_previousBlitCommandEncoder;
    AGXG14GFamilyComputeContext *_previousComputeCommandEncoder;
    AGXG14GFamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG14GFamilyTexture *, std::allocator<AGXG14GFamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG14GFamilyTexture **, std::allocator<AGXG14GFamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
