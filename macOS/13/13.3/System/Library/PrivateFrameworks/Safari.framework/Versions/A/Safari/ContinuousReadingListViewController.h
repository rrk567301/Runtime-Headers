...
- (BOOL)continuousPageView:(id)a0 pageViewHasHeaderBanner:(id)a1 pageItem:(id)a2;
...
- (BOOL)pageHasHeaderBanner:(struct Page { struct WKRetainPtr<const void *> { void *x0; } x0; })a0;
- (id)pageWithHeaderViewControllerForItem:(id)a0;
- (void)removeTemporaryHeaderBannerViewForBrowserWKView:(id)a0;
...
- (void)willReloadContinuousReadingViewPage:(struct Page { struct WKRetainPtr<const void *> { void *x0; } x0; })a0;
