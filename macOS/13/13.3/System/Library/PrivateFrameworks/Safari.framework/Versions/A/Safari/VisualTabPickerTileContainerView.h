...
@interface VisualTabPickerTileContainerView : NSView <VisualTabPickerTileContainerViewTransitionCoordinatorDataSource, VisualTabPickerNewTabViewDelegate, VisualTabPickerThumbnailDataSource, VisualTabPickerThumbnailDelegate> {
