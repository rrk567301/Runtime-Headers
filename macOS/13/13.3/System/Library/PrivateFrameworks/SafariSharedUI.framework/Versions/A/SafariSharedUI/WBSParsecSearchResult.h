@class NSURL, WBSSFSearchResultAdapter, MKMapItem, SFSearchResult, WBSParsecImageRepresentation, WBSParsecActionButton, NSString, WBSQuerySuggestion, WBSParsecSearchMapsResultFeedbackSender, WBSParsecSearchSportsAttributionExtraCompletionItem, NSArray, WBSParsecLegacySearchResult, WBSParsecAuxiliaryInfo, NSNumber;
