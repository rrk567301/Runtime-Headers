@class HMDTimeBasedFlagsManager, HMDAppleAccountManager, HMDLogEventErrorEventsAnalyzer, HMDMetricsAccessoryDetailsManager, HMDLogEventProcessMemoryEventsAnalyzer, NSMutableArray, HMDLogEventMessageEventsAnalyzer, HMDLogEventAccessoryFirmwareUpdateEventAnalyzer, HMDCloudSyncLogEventsAnalyzer, HMDMessageDispatcher, HMDHomeManager, HMDMetricsDeviceStateManager, HMDLogEventReachabilityEventsAnalyzer, NSString, HMDPowerLogObserver, HMDDiagnosticReporterLogObserver, HMDConfigurationLogEvent, HMDCoreAnalyticsLogObserver, HMDCoreDataLogEventsAnalyzer, HMDLogEventDailyScheduler, NSObject, NSArray, HMDNetworkObserver, HMDLogEventElectionEventsAnalyzer, HMDLogEventProcessLaunchAnalyzer, HMDLogEventUserActivityAnalyzer, HMDEventCountersManager, HMDDevice, HMDHH2AutoMigrationEligibilityLogEventSubmitter, HMDThreadNetworkObserver, HMDLogEventBulletinNotificationsAnalyzer, HMDLogEventHAPMetricsEventAnalyzer, NSUUID;
