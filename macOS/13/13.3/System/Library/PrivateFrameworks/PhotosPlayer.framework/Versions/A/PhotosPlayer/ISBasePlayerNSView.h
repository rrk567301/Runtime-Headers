@class ISVideoPlayerNSView, ISPhotoNSView, NSView, CAFilter, NSString, ISBasePlayer;
...
@property (nonatomic, setter=_setPhotoSize:) struct CGSize { double width; double height; } _photoSize;
