@class UNUserNotificationCenter, PORegistrationContext, NSDate, POKeyBag, SOExtensionManager, PODirectoryServices, POConfigurationManager, POAuthenticationProcess, POUIAuthenticationDialog, NSString, NSTimer, SOConfigurationHost, POKerberosHelper, NSNotificationCenter;
