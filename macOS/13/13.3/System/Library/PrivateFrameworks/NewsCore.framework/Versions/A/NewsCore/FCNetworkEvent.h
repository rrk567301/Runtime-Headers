...
- (id)description;
- (void).cxx_destruct;
- (id)initWithType:(int)a0 URL:(id)a1 operationID:(id)a2 requestUUID:(id)a3 responseMIMEType:(id)a4 HTTPStatusCode:(unsigned long long)a5 HTTPMethod:(id)a6 HTTPResponseHeaders:(id)a7 containerName:(id)a8 error:(id)a9 startTime:(double)a10 dnsDuration:(double)a11 connectDuration:(double)a12 requestDuration:(double)a13 responseDuration:(double)a14 requestSize:(double)a15 responseSize:(double)a16;
