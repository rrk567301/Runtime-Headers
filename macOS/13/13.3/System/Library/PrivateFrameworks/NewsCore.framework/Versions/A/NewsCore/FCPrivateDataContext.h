@class FCReadingList, FCPersonalizationData, FCUserInfo, FCTagSettings, FCPrivateChannelMembershipController, FCReadingHistory, NSString, FCIssueReadingHistory, FCSubscriptionList, FCUserEventHistory, FCAudioPlaylist, FCNetworkBehaviorMonitor, FCShortcutList;
