...
- (id)init;
- (void).cxx_destruct;
- (id)initWithMinClusterSize:(unsigned long long)a0 maxClusterSize:(unsigned long long)a1 minIdealClusterSize:(unsigned long long)a2 maxIdealClusterSize:(unsigned long long)a3 minClusterSizeAutoFavorite:(unsigned long long)a4 maxClusterSizeAutoFavorite:(unsigned long long)a5 minIdealClusterSizeAutoFavorite:(unsigned long long)a6 maxIdealClusterSizeAutoFavorite:(unsigned long long)a7 maxPublisherOccurrences:(unsigned long long)a8 enforcePublisherCap:(BOOL)a9 maxUnpaidArticles:(unsigned long long)a10 maxEvergreenArticles:(unsigned long long)a11 topicDiversityThreshold:(double)a12 enableOptimizedLayout:(BOOL)a13 optimizedLayoutSizeThreshold:(unsigned long long)a14 optimizedLayoutIncrementUnit:(unsigned long long)a15 solConfiguration:(id)a16 minSubscribedChannelRatioForUGroup:(double)a17 maxExpandedAutofavoriteGroupCandidateRatio:(double)a18 expandedAutofavoriteClusterMinSizeMultiplier:(double)a19 expandedAutofavoriteClusterMaxSizeMultiplier:(double)a20 maxNativeAdCount:(unsigned long long)a21;
