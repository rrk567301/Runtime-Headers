...
@interface CMContinuityCaptureAudioInputProvider : NSObject <NSXPCListenerDelegate, CMContinuityCaptureAudioInputProviderObject> {
    ...
    NSMutableDictionary *_sidecarDeviceUIDsByAudioDeviceUIDs;
...
- (void)publishDeviceForSidecarDeviceUID:(id)a0 audioDeviceUID:(id)a1 name:(id)a2;
...
- (void)startStreamingForAudioDeviceUID:(id)a0;
- (void)terminateDeviceForSidecarDeviceUID:(id)a0;
- (void)updateSynchronizedNetworkTime:(unsigned long long)a0 forSampleTime:(unsigned long long)a1 networkClockIdentifier:(unsigned long long)a2 transportTypeIsUSB:(BOOL)a3 forAudioDeviceUID:(id)a4;
