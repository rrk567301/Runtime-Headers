...
- (BOOL)_processAlbumElement:(struct shared_ptr<ML3CPP::Element> { struct Element *x0; struct __shared_weak_count *x1; })a0;
- (BOOL)_processArtistCount:(int)a0;
- (BOOL)_processArtistElement:(struct shared_ptr<ML3CPP::Element> { struct Element *x0; struct __shared_weak_count *x1; })a0;
...
- (BOOL)_processDeletedAlbumId:(long long)a0;
- (BOOL)_processDeletedArtistId:(long long)a0;
