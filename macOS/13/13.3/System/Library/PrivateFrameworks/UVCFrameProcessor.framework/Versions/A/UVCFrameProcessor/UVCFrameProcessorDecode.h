...
@interface UVCFrameProcessorDecode : UVCFrameProcessorBase {
    ...
    struct { unsigned long long noOfFramesDecodeSend; unsigned long long noOfFramesDecodeCompleted; unsigned long long decodeLatency; } _info;
...
- (const struct opaqueCMFormatDescription { } *)videoFormatDescriptor;
