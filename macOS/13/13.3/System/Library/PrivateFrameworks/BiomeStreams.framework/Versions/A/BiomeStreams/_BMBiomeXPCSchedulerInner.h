@class BMComputeXPCPublisherClient, NSString, BMDSL, BMStreamsAccessClient, BMBookmarkablePublisher, BPSSubscriptionStatus, NSObject, BMBookmarkStorage, BMComputeXPCSubscription;
...
@property (retain, nonatomic) BMBookmarkStorage *bookmarkStorage;
