...
- (void)_createPCSFromData:(id)a0 ofType:(unsigned long long)a1 usingPCSServiceType:(unsigned long long)a2 tryDecryptingWithOtherServices:(BOOL)a3 withSyncKeyRegistryRetry:(BOOL)a4 lastModifiedDate:(id)a5 completionHandler:(id /* block */)a6;
...
- (void)_locked_checkIdentitiesForService:(unsigned long long)a0 withSyncKeyRegistryRetry:(BOOL)a1 keySyncAnalytics:(id)a2 completionHandler:(id /* block */)a3;
- (void)_locked_createPCSFromData:(id)a0 ofType:(unsigned long long)a1 usingPCSServiceType:(unsigned long long)a2 tryDecryptingWithOtherServices:(BOOL)a3 withSyncKeyRegistryRetry:(BOOL)a4 lastModifiedDate:(id)a5 keySyncAnalytics:(id)a6 completionHandler:(id /* block */)a7;
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(BOOL)a0 keySyncAnalytics:(id)a1 completionHandler:(id /* block */)a2;
- (void)_locked_decryptCurrentPerParticipantPCSDataOnSharePCS:(id)a0 shareModificationDate:(id)a1 completionHandler:(id /* block */)a2;
- (void)_locked_decryptPCSDataOnSharePCS:(id)a0 shareModificationDate:(id)a1 withPublicSharingKey:(id)a2 completionHandler:(id /* block */)a3;
...
- (void)checkIdentitiesForService:(unsigned long long)a0 withSyncKeyRegistryRetry:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (void)createIngestedPPPCSDataFromInvitationData:(id)a0 shareModificationDate:(id)a1 completionHandler:(id /* block */)a2;
...
- (void)decryptPCSDataOnSharePCS:(id)a0 shareModificationDate:(id)a1 completionHandler:(id /* block */)a2;
