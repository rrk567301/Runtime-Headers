@class NSXPCConnection, NSString, NSArray, NSUUID, _TtC26AuthenticationServicesCore13ASCABLEClient, ASCCredentialRequestContext, ASCAuthorizationPresenter, NSObject, ASCAuthorizationTrafficController, NSXPCListener;
@protocol OS_os_activity, ASPublicKeyCredentialManagerInterface;

@interface ASCAgent : NSObject <NSXPCListenerDelegate, AuthenticationServicesCore.ASCABLEClientDelegate, ASCAuthorizationPresenterDelegate, ASCAgentProtocol, ASPublicKeyCredentialManagerDelegate> {
