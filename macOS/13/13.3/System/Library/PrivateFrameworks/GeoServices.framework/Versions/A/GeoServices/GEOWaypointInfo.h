@class GEOWaypointUUID, NSString, GEOAddress, GEOARInfo, GEOEVChargingInfo, GEOStyleAttributes, GEOPBTransitArtwork, GEOLatLng, PBUnknownFields, PBDataReader;
