...
@interface GEOLogMsgStateUserSession : PBCodable <NSCopying> {
    ...
    struct { unsigned char has_initialDeviceSessionId : 1; unsigned char has_navSessionId : 1; unsigned char has_preSyncSessionId : 1; unsigned char has_sessionId : 1; unsigned char has_ageOfSessionIdInSeconds : 1; unsigned char has_lastIcloudSyncDate : 1; unsigned char has_navSessionRelativeTimestamp : 1; unsigned char has_relativeTimestamp : 1; unsigned char has_sessionEpoch : 1; unsigned char has_sequenceNumber : 1; unsigned char has_didPreviouslyRotate : 1; } _flags;
}
