...
- (id)_createAndInsertNewItemWithImportObject:(id)a0 parentItem:(id)a1 fields:(unsigned long long)a2 templateItem:(id)a3 fileURL:(id)a4 options:(unsigned long long)a5 additionalAttrs:(id)a6 importBookmark:(id)a7 error:(id *)a8;
...
- (id)_locateMatchingItemForTemplateItem:(id)a0 parentItem:(id)a1 logicalName:(id)a2 options:(unsigned long long)a3 fileURL:(id)a4 fields:(unsigned long long *)a5 shouldReject:(BOOL *)a6 additionalAttrs:(id)a7 importBookmark:(id)a8 error:(id *)a9;
...
- (void)_propagateCrossZoneMove:(id)a0 persistedState:(id)a1 batchSize:(int)a2;
...
- (id)importNewItemAtURL:(id)a0 logicalName:(id)a1 parentItem:(id)a2 templateItem:(id)a3 fields:(unsigned long long)a4 options:(unsigned long long)a5 additionalItemAttributes:(id)a6 importBookmark:(id)a7 error:(id *)a8;
