...
- (void)fetchWorkoutDistancesWithOffset:(unsigned long long)a0 limit:(unsigned long long)a1 maxDistanceThreshold:(double)a2 handler:(id /* block */)a3;
- (void)_fetchWorkoutsWithOffset:(unsigned long long)a0 limit:(unsigned long long)a1 maxDistanceThreshold:(double)a2 handler:(id /* block */)a3;
