...
+ (id)managedObjectWithFirstWorkout:(id)a0 secondWorkout:(id)a1 distanceMetric:(long long)a2 workoutActivityType:(long long)a3 areBothWorkoutsDecimated:(BOOL)a4 distance:(double)a5 date:(id)a6 inManagedObjectContext:(id)a7;
