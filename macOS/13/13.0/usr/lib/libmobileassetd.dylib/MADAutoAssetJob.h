@class NSMutableDictionary, MAAutoAssetProgress, MAAutoAssetSelector, NSDictionary, SUCorePersistedState, MAAutoAssetInfoDesire, MAAutoAssetSummary, SUCoreFSM, NSMutableArray, NSString, MAAutoAssetInfoListen, MAAutoAssetInfoInstance, SUCoreLog, MAAutoAssetStatus, MAMsuDownloadOptions, MADAutoAssetDescriptor, MAAutoAssetPolicy, MAAutoAssetInfoFound, MAAutoAssetInfoEnd;
...
- (long long)action_AddTask:(id)a0 error:(id *)a1;
