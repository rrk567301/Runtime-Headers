@class NSDate, NSURL, NSURLSession, NSMutableDictionary, NSOperationQueue, NSObject, NSDateFormatter, PallasResponseVerifier, MADAnalyticsManager, NSURLSessionConfiguration;
...
@property (retain, nonatomic) MADAnalyticsManager *analytics;
...
- (id)newDefaultEventDictionary:(id)a0 sessionId:(id)a1 nonce:(id)a2 url:(id)a3 statusCode:(long long)a4 assetAudience:(id)a5 uuid:(id)a6 assetType:(id)a7 version:(id)a8 receiptResults:(id)a9 baseUrl:(id)a10;
- (void)checkSplunkStatus:(id)a0 failureReason:(id)a1 productVersion:(id)a2 sessionId:(id)a3 nonce:(id)a4 url:(id)a5 statusCode:(long long)a6 assetAudience:(id)a7 version:(id)a8 receiptResults:(id)a9 baseUrl:(id)a10;
