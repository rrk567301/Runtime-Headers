...
- (void)_removeStagedAssetFromFilesystem:(id)a0;
...
- (long long)_persistDescriptor:(id)a0 withRepresentation:(long long)a1;
- (id)_persistRebuildTrackingForFollowupEvent:(id)a0;
- (void)_trackReloadedDescriptorAvailableForStaging:(id)a0;
- (void)_removeDescrptorFromSuccessfullyStaged:(id)a0;
