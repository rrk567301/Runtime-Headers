...
- (id)initForFinishedJobSelector:(id)a0 withAutoAssetUUID:(id)a1;
...
- (id)initWithParamType:(long long)a0 withSafeSummary:(id)a1 withClientID:(id)a2 withClientRequestMessage:(id)a3 withClientProgressProxy:(id)a4 withClientReplyCompletion:(id /* block */)a5 withResponseMessage:(id)a6 withResponseError:(id)a7 withDownloadsInFlight:(id)a8 withAutoAssetJobID:(id)a9 withAutoAssetCatalog:(id)a10 withLockForUseError:(id)a11 withFinishedError:(id)a12 withDownloadProgress:(id)a13 withJobCurrentStatus:(id)a14 withAutoAssetSelector:(id)a15 withAutoAssetUUID:(id)a16 withSetOfAutoAssetSelectors:(id)a17 withPushNotifications:(id)a18 withAssetTargetOSVersion:(id)a19 withAssetTargetBuildVersion:(id)a20 withStagedToDownloaded:(id)a21 withDownloadingDescriptor:(id)a22 withBaseForPatchDescriptor:(id)a23;
