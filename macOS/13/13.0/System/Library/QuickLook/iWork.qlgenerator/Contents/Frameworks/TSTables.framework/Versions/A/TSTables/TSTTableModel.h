...
- (void)defaultStylesAtBaseCellCoord:(struct TSUModelCellCoord { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; })a0 useSoftDefault:(BOOL)a1 outCellStyle:(id *)a2 outTextStyle:(id *)a3;
