@class TSTTableHeaderStorage, TSTTableTileStorage, TSPLazyReference, TSTTableDataList, NSMutableDictionary, NSObject, TSTMergeRegionMap;
...
- (id)i_styleForDataListKey:(unsigned int)a0;
- (void)resetAllColumnRowSizes;
- (void)resetAlmostEverything;
- (id)p_addPasteboardCustomFormat:(id)a0 key:(id)a1 toDocument:(id)a2;
