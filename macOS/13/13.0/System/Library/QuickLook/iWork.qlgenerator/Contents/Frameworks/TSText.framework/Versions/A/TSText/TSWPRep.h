@class TSWPSelection, NSString, NSArray, TSDLayout, CALayer, CAShapeLayer, _TtC6TSText22TSWPSecondaryHighlight, NSMutableArray, TSWPStorage, TSUColor, TSWPSearchReference;
