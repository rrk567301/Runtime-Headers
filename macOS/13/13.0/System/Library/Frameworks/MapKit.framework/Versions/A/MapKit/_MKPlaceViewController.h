@class MKPlaceInfoViewController, MKPlacePoisInlineMapViewController, MKPlaceHeaderButtonsViewController, NSMapTable, NSMutableArray, NSString, MKPlaceActionManager, _MKPlaceActionButtonController, GEOWalkingOptions, NSViewController, GEOTransitOptions, NSObject, GEOCyclingOptions, MKETAProvider, MKPlaceCardHeaderViewController, CLLocation, CNContact, MKPlaceCardFooterActionsViewController, _MKDistanceDetailProvider, GEOAutomobileOptions, MKPlaceInlineMapViewController, NSPopover, CNContactStore, MKMapItem;
