@class MTKTextureLoader, PKMetalFramebuffer, PKMetalRenderState, PKLinedPaper, PKStroke, PKMetalResourceHandler;
...
@property (nonatomic) double pencilShadowElevation;
@property (nonatomic) double pencilShadowAlpha;
...
- (id)initWithDrawingPixelSize:(struct CGSize { double x0; double x1; })a0 actualSize:(struct CGSize { double x0; double x1; })a1 device:(id)a2 resourceHandler:(id)a3 sixChannelBlending:(BOOL)a4 pixelFormat:(unsigned long long)a5;
...
- (void)drawPencilShadowIfNecessary;
...
- (void)setupRenderStateWithLiveRenderConfig:(struct RenderStateConfig { id x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; BOOL x8; BOOL x9; long long x10; })a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })clipRectForVertices:(const struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a0 numVertices:(unsigned long long)a1;
...
- (void)setVertexBuffersForVertices:(const struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a0 numVertices:(unsigned long long)a1 renderEncoder:(id)a2;
- (void)renderStrokeVertices:(const struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a0 numVertices:(unsigned long long)a1 numIndices:(unsigned long long)a2 renderEncoder:(id)a3;
...
- (unsigned long long)renderVerticies:(struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a0 size:(unsigned long long)a1 numRenderedVertices:(unsigned long long)a2 numIndices:(unsigned long long)a3 localClipRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a4 animatingStroke:(void *)a5 secondaryParticles:(BOOL)a6 renderEncoder:(id)a7;
...
- (id)renderGroupRenderCommandEncoderForCommandBuffer:(id)a0 renderStateConfig:(struct RenderStateConfig { id x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; BOOL x8; BOOL x9; long long x10; })a1 renderState:(id)a2;
- (id)renderCommandEncoderForCommandBuffer:(id)a0 renderStateConfig:(struct RenderStateConfig { id x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; BOOL x8; BOOL x9; long long x10; })a1 renderState:(id)a2;
...
- (void)addBufferForRenderCache:(id)a0 strokeVertices:(struct StrokeVertex { float x0; float x1; float x2; float x3; float x4; float x5; float x6; float x7; } *)a1 numVertices:(unsigned long long)a2 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a3 secondaryParticles:(BOOL)a4 renderEncoder:(id)a5;
