@class MPAdvanceShuffleModeCommand, MPSetPlaybackSessionCommand, MPPreloadPlaybackSessionCommand, MPChangeRepeatModeCommand, MPChangeShuffleModeCommand, MPRatingCommand, NSMutableArray, MPChangePlaybackPositionCommand, MPSkipIntervalCommand, NSString, MPAdvanceRepeatModeCommand, MPRemoteCommand, MPReorderQueueCommand, MRPlayerPath, MPChangeQueueEndActionCommand, MPInsertIntoPlaybackQueueCommand, MPChangePlaybackRateCommand, MPSetPlaybackQueueCommand, MPFeedbackCommand, MPSetPriorityForPlaybackSessionCommand;
