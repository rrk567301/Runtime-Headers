...
+ (id)_configurationForAlertToDeletePasswordFromSavedAccount:(id)a0;
+ (id)_configurationForAlertToDeletePasskeyFromSavedAccount:(id)a0;
+ (id)_configurationForAlertToDeleteVerificationCodeFromSavedAccount:(id)a0;
...
+ (id)_subtitleStringForAlertToDeletePasswordFromSavedAccount:(id)a0;
+ (id)_subtitleStringForAlertToDeleteVerificationCodeFromSavedAccount:(id)a0;
+ (id)_subtitleStringForAlertToDeletePasskeyFromSavedAccount:(id)a0;
