...
- (void)feedViewObstructedEvent:(long long)a0 timestamp:(double)a1;
- (void)feedSmartPowerNapEvent:(long long)a0 timestamp:(double)a1;
- (void)feedDevicePresenceEvent:(long long)a0 timestamp:(double)a1;
