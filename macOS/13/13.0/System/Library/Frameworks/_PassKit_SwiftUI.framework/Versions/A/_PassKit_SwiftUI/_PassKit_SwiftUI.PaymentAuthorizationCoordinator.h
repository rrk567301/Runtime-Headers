@class PKPaymentRequestMerchantSessionUpdate, NSString, PKPaymentMethod, PKPaymentRequestPaymentMethodUpdate, PKPaymentRequestShippingMethodUpdate, PKPaymentRequestShippingContactUpdate, PKPaymentAuthorizationController, PKShippingMethod, PKContact, PKPaymentRequestCouponCodeUpdate;
