...
- (BOOL)_handleEvent:(id)a0 options:(unsigned long long)a1 completionHandler:(id /* block */)a2;
- (BOOL)_handleEvent:(id)a0 options:(unsigned long long)a1 allowingSyntheticEvent:(BOOL)a2 completionHandler:(id /* block */)a3;
