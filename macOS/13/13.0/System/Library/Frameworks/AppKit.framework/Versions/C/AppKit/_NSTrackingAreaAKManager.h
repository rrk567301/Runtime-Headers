...
- (void)_exitAllActiveTrackingAreas:(struct CGPoint { double x0; double x1; })a0;
- (void)_activeTrackingAreasNeedUpdate;
- (void)_updateTrackpadBehavior;
- (void)_updateMenuActiveTrackingAreasForWindowLocation:(struct CGPoint { double x0; double x1; })a0;
- (void)_updateDragTrackingAreasForWindowLocation:(struct CGPoint { double x0; double x1; })a0;
- (void)_updateActiveTrackingAreasForWindowLocation:(struct CGPoint { double x0; double x1; })a0;
