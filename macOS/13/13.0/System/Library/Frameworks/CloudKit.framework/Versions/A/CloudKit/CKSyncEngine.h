@class NSDate, NSString, CKSyncEngineMetadata, CKDatabase, NSArray, NSOperationQueue, NSObject, CKNotificationListener;
...
- (BOOL)allowFetchAndModifyConcurrentlyForContainerIdentifier:(id)a0;
