...
- (BOOL)useBatchingForFragmentCapacity:(unsigned long long)a0;
- (id)newPipelineWithKey:(struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 4; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 6; unsigned char x12 : 4; unsigned int x13 : 22; } x0; unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; })a0;
- (id)getPipelineWithKey:(struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 4; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 6; unsigned char x12 : 4; unsigned int x13 : 22; } x0; unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; })a0;
- (id)getPipelineWithKey:(struct PipelineKey { struct { unsigned char x0 : 8; unsigned char x1 : 2; unsigned char x2 : 4; unsigned char x3 : 8; unsigned char x4 : 1; unsigned char x5 : 1; unsigned char x6 : 1; unsigned char x7 : 4; unsigned char x8 : 1; unsigned char x9 : 1; unsigned char x10 : 1; unsigned char x11 : 6; unsigned char x12 : 4; unsigned int x13 : 22; } x0; unsigned int x1; unsigned int x2; unsigned int x3; float x4; float x5; float x6; })a0 outExecutionWidth:(unsigned long long *)a1;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 threadgroupSize:(unsigned long long)a2 outExecutionWidth:(unsigned long long *)a3;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1;
- (id)getPipeline:(unsigned long long)a0 descriptor:(id)a1 threadgroupSize:(unsigned long long)a2;
- (id)getPipeline:(unsigned long long)a0 threadgroupSize:(unsigned long long)a1 motion:(BOOL)a2 outExecutionWidth:(unsigned long long *)a3;
- (id)getPipeline:(unsigned long long)a0 threadgroupSize:(unsigned long long)a1 outExecutionWidth:(unsigned long long *)a2;
- (id)getPipeline:(unsigned long long)a0;
- (id)getPipeline:(unsigned long long)a0 threadgroupSize:(unsigned long long)a1;
- (id)getPipeline:(unsigned long long)a0 outExecutionWidth:(unsigned long long *)a1;
- (id)getPipeline:(unsigned long long)a0 motion:(BOOL)a1 outExecutionWidth:(unsigned long long *)a2;
- (unsigned long long)getBatchCountForFragmentCapacity:(unsigned long long)a0 batchSize:(unsigned long long)a1;
...
- (void)getPolygonFragmentsWithEncoder:(id)a0 descriptor:(id)a1 primitiveCountBuffer:(id)a2 primitiveCountBufferOffset:(unsigned long long)a3 fragmentBuffer:(id)a4 fragmentBufferOffset:(unsigned long long)a5 fragmentCountBuffer:(id)a6 fragmentCountBufferOffset:(unsigned long long)a7 boundsMinBuffer:(id)a8 boundsMinBufferOffset:(unsigned long long)a9 boundsMaxBuffer:(id)a10 boundsMaxBufferOffset:(unsigned long long)a11 boundsEndMinBuffer:(id)a12 boundsEndMinBufferOffset:(unsigned long long)a13 boundsEndMaxBuffer:(id)a14 boundsEndMaxBufferOffset:(unsigned long long)a15 boundsEndTimeBuffer:(id)a16 boundsEndTimeBufferOffset:(unsigned long long)a17 boundsStartTimeBuffer:(id)a18 boundsStartTimeBufferOffset:(unsigned long long)a19 resourceBuffer:(id)a20;
- (void)getBoundingBoxFragmentsWithEncoder:(id)a0 descriptor:(id)a1 primitiveCountBuffer:(id)a2 primitiveCountBufferOffset:(unsigned long long)a3 fragmentBuffer:(id)a4 fragmentBufferOffset:(unsigned long long)a5 fragmentCountBuffer:(id)a6 fragmentCountBufferOffset:(unsigned long long)a7 boundsMinBuffer:(id)a8 boundsMinBufferOffset:(unsigned long long)a9 boundsMaxBuffer:(id)a10 boundsMaxBufferOffset:(unsigned long long)a11 boundsEndMinBuffer:(id)a12 boundsEndMinBufferOffset:(unsigned long long)a13 boundsEndMaxBuffer:(id)a14 boundsEndMaxBufferOffset:(unsigned long long)a15 boundsEndTimeBuffer:(id)a16 boundsEndTimeBufferOffset:(unsigned long long)a17 boundsStartTimeBuffer:(id)a18 boundsStartTimeBufferOffset:(unsigned long long)a19 resourceBuffer:(id)a20;
- (void)buildWithEncoder:(id)a0 descriptor:(id)a1 scratchBuffer:(id)a2 scratchBufferOffset:(unsigned long long)a3 fragmentBuffer:(id)a4 fragmentBufferOffset:(unsigned long long)a5 fragmentIndexBuffer0:(id)a6 fragmentIndexBuffer0Offset:(unsigned long long)a7 fragmentIndexBuffer1:(id)a8 fragmentIndexBuffer1Offset:(unsigned long long)a9 nodeBuffer:(id)a10 nodeBufferOffset:(unsigned long long)a11 childIndexBuffer:(id)a12 childIndexBufferOffset:(unsigned long long)a13 counterBuffer:(id)a14 counterBufferOffset:(unsigned long long)a15 fragmentCountBuffer:(id)a16 fragmentCountBufferOffset:(unsigned long long)a17 boundsMinBuffer:(id)a18 boundsMinBufferOffset:(unsigned long long)a19 boundsMaxBuffer:(id)a20 boundsMaxBufferOffset:(unsigned long long)a21 boundsEndMinBuffer:(id)a22 boundsEndMinBufferOffset:(unsigned long long)a23 boundsEndMaxBuffer:(id)a24 boundsEndMaxBufferOffset:(unsigned long long)a25 boundsEndTimeBuffer:(id)a26 boundsEndTimeBufferOffset:(unsigned long long)a27 boundsStartTimeBuffer:(id)a28 boundsStartTimeBufferOffset:(unsigned long long)a29 resourceBuffer:(id)a30;
...
- (struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned long long x8; unsigned long long x9; })getMTLSWBVHSizeAndOffsetsForDescriptor:(id)a0;
- (unsigned long long)getMTLSWBVHSizeForDescriptor:(id)a0 refitDataOffset:(unsigned long long *)a1 innerNodeOffset:(unsigned long long *)a2 leafNodeOffset:(unsigned long long *)a3 primitiveOffset:(unsigned long long *)a4 primitiveRefitDataOffset:(unsigned long long *)a5 geometryOffset:(unsigned long long *)a6 primitiveBVHOffset:(unsigned long long *)a7 transformOffset:(unsigned long long *)a8;
...
- (void)copyMTLSWBVHWithEncoder:(id)a0 sourceBuffer:(id)a1 sourceBufferOffset:(unsigned long long)a2 toBuffer:(id)a3 destinationBufferOffset:(unsigned long long)a4 destinationUniqueIdentifier:(unsigned long long)a5 compact:(BOOL)a6 copyVertexData:(BOOL)a7 copyPerPrimitiveData:(BOOL)a8;
...
- (void)refitMTLSWBVHWithEncoder:(id)a0 descriptor:(id)a1 sourceBuffer:(id)a2 sourceBufferOffset:(unsigned long long)a3 destinationBuffer:(id)a4 destinationBufferOffset:(unsigned long long)a5 destinationUniqueIdentifier:(unsigned long long)a6 scratchBuffer:(id)a7 scratchBufferOffset:(unsigned long long)a8 options:(unsigned long long)a9;
