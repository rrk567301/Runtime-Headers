...
- (BOOL)addWithName:(id)a0 options:(id)a1 logger:(id)a2 flags:(unsigned int)a3;
...
- (id)describeWithChunk:(struct ktrace_chunk { struct ktrace_file *x0; unsigned long long x1; union { long long x0; struct __CFData *x1; } x2; unsigned long long x3; unsigned int x4; unsigned short x5; unsigned short x6; struct ktrace_chunk *x7; struct ktrace_chunk_array { struct ktrace_chunk **x0; struct ktrace_chunk *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; long long x5; long long x6; } x8; union { struct ktrace_chunk *x0; } x9; } *)a0;
