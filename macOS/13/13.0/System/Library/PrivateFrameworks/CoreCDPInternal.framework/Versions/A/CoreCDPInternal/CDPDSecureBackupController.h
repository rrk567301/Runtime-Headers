...
- (void)checkForExistingRecordForceFetch:(BOOL)a0 completion:(id /* block */)a1;
- (void)checkForExistingRecordWithPeerId:(id)a0 completion:(id /* block */)a1;
- (void)checkForExistingRecordWithPeerId:(id)a0 forceFetch:(BOOL)a1 completion:(id /* block */)a2;
