...
+ (struct basic_string<char16_t, std::char_traits<char16_t>, std::allocator<char16_t>> { struct __compressed_pair<std::basic_string<char16_t>::__rep, std::allocator<char16_t>> { struct __rep { union { struct __long { unsigned short *x0; unsigned long long x1; unsigned long long x2; } x0; struct __short { unsigned short x0[11]; struct { unsigned char x0[1]; unsigned char x1; } x1; } x1; struct __raw { unsigned long long x0[3]; } x2; } x0; } x0; } x0; })nSStringToU16String:(id)a0;
