@class NSView, NSString, GKTurnBasedMatchDetailViewController, GKGame, GKMatchRequest, GKCollectionViewController, GKTurnBasedMatchesDataSource, GKTurnBasedInviteViewController, NSButton;
...
@property (retain, nonatomic) NSButton *dimmingView;
