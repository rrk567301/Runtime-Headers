...
- (void)handleAcceptRequestForIDSInvitationWithIdentifier:(id)a0 payload:(id)a1 fromAddress:(id)a2;
- (void)_processUnacceptReverseShareAccessForUsers;
- (void)_handleUpdateRequestForHomeInvitation:(id)a0 controllerPublicKey:(id)a1 controllerUsername:(id)a2 invitationState:(long long)a3 presenceAuthStatus:(id)a4 preferredUserID:(id)a5 fromHandle:(id)a6 fromAddress:(id)a7 reverseShareURL:(id)a8 reverseShareToken:(id)a9 message:(id)a10 messageResponseHandler:(id /* block */)a11;
