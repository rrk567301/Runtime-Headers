@class HMDHome, HMDAppleAccountManager, NSArray, NSString, NSObject, HMDBulletinNotificationRegistrationSource, NSNotificationCenter, HMDNotificationConditionEvaluator;
