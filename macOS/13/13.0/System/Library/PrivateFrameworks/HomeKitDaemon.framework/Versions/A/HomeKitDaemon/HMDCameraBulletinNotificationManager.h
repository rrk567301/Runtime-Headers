@class HMDAppleAccountManager, NSMutableDictionary, HMFMessageDispatcher, NSObject, HMDCameraSignificantEventFaceClassificationResolver, HMDBulletinNotificationRegistrationSource, NSString, HMDNotificationConditionEvaluator, NSArray, HMDDoorbellPressTracker, HMDHome, NSNotificationCenter, NSUUID;
