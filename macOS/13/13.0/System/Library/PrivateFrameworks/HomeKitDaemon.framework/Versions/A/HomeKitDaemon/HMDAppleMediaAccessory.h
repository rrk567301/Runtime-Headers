@class HMFPairingIdentity, HMDDeviceAddress, HMDAppleMediaAccessoryInfoSubscriber, HMDAccessorySymptomHandler, HMDHome, HMDAppleMediaAccessoryMetricsDispatcher, NSNotificationCenter, HMMediaDestination, NSString, HMDAccessorySetupMetricDispatcher, HMDDeviceController, HMFWiFiNetworkInfo, HMDAppleMediaAccessorySleepWakeStateController, HMDAppleMediaAccessoryInfoController, NSArray, HMMediaDestinationControllerData, HMFSoftwareVersion, HMDSoftwareUpdateEventListener, NSObject, NSData, HMFActivity, HMDBackingStore, HMDDevice, HMDPreferredMediaUserEventController, HMFWiFiManager, HMDMediaDestinationController, HMDRemoteLoginHandler, HMDAccessorySettingsController, HMAccessoryCapabilities, HMDTargetControlManager, HMDFetchedAccessorySettingsController, HMDAppleMediaAccessoryMessenger, HMDMediaDestinationManager;
