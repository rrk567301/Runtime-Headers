@class NSString, NSArray, HMDRemoteDeviceMonitor, HMDModernTransportDeviceReachabilityObserver, NSMutableDictionary, HMFPromise, HMDAccountRegistry, HMDCloudDataSyncStateFilter, HMFFuture, NSObject, NSMutableSet;
...
- (void)configureWithCloudDataSyncStateFilter:(id)a0;
