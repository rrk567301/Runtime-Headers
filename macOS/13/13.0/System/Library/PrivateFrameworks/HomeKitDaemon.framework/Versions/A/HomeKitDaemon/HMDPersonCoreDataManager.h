@class NSUUID, NSString, HMDUser, HMCContext, HMDPersonResidentSyncManager, NSObject, NSNotificationCenter, HMDHome;
...
- (id)initWithUUID:(id)a0 workQueue:(id)a1 home:(id)a2 user:(id)a3;
- (id)initWithUUID:(id)a0 workQueue:(id)a1 home:(id)a2 user:(id)a3 context:(id)a4 residentSyncManager:(id)a5 notificationCenter:(id)a6;
