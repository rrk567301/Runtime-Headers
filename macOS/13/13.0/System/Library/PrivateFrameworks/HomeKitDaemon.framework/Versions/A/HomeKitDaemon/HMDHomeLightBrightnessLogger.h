@class NSNotificationCenter, NSString, BMStreamDatastorePruner, BMSource, BMStoreStream, HMDLogEventDailyScheduler, BMStoreConfig, NSObject, NSMapTable, HMDHome;
...
- (void)processCharacteristicsAndSubmitCoreAnalyticsEvents:(id)a0 withLogMessage:(id)a1 triggerSource:(id)a2 bundleId:(id)a3 userUUID:(id)a4;
