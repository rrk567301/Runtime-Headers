@class NSString, HMDAccessoryFirmwareUpdateConcurrencyLogEventManager, HMDHomeManager, HMFTimer, NSMutableDictionary, NSURL, HMDDefaultUARPControllerDelegate, NSObject, NSMapTable, UARPController;
