@class HMDAccessoryFirmwareUpdateManager, HMDCloudManagerDataSource, HMDCapabilitiesController, HMDBiomeEventManager, HMDAWDLogEventObserver, NSMutableDictionary, HMDLoggingEventForwarder, HMDCameraRecordingLoadBalancer, HMDLastEventStoreController, HMDBackingStore, HMDUserCloudShareManager, HMDDevice, HMDCloudManager, HMDHomeOwnerCloudShareManager, HMDWatchManager, HMEMemoryEventBus, HMFDumpCategory, NSUserDefaults, HMDCHIPDataSource, HMEDelegatingEventRouter, HMDIDSFirewallManager, NSObject, HMDSyncOperationManager, HMFTimer, HMDFMFHandler, HMDCompositeSettingsControllerManager, HMDBonjourBrowserHelper, HMDLogEventDispatcher, NSDate, HMDIdentityRegistry, HMDMessageDispatcher, HMDCompanionManager, HMDHomeManagerObjectChangeHandler, HMDNameValidator, HMDIDSServerBag, HMDApplicationData, HMDRemoteAccountManager, HMDSelfRemovalWatchdog, HMDHomeManagerHH2SharedUserLastSyncManager, HMDMediaGroupParticipantLocalDataStorage, NSMapTable, HMDUserDeviceCapabilitiesRequestManager, HMDHomeSharedUserCloudShareManager, HMDXPCEventRouterServer, HMDSiriEndpointOnboardingManager, HMDCloudDataSyncStateFilter, NSSet, NSUUID, HMDDuetPredictionSubscriber, HMDWidgetConfigurationReader, NSMutableSet, NSString, HMDDuetEventManager, HMDHH2FrameworkSwitch, HMDSharedUserPrivateSettingsManager, HMDAccessoryBrowser, HMFPromise, HMDMetricsManager, NSMutableArray, HMDMultiUserStatusController, HMDClientConnection, HMDMobileAssetManager, HMDMemoryUtilizationTracker, HMFBoolean, HMDPairedSync, HMDRemoteEventRouterAssertionController, NSNotificationCenter, HMFFuture, NSDictionary, NSArray, HMDSoftwareUpdateManager, HMFActivity, HMDAppleAccessoryPairingController, HMDBiomeLogEventObserver, HMDResidentMesh, HMDCloudAccount, HMDLocation, HMDAccessorySetupCoordinator, HMDSiriEndpointSettingsSyncManager, HMELastEventStore, HMFNetMonitor, HMDAssistantGather, HMDHomeManagerObjectLookup, HMDIDSInvitationManager, HMDAppleAccountManager, HMDMessageFilterChain, HMDAccountRegistry, HMDMultiUserSettingsMetricsEventDispatcher, HMDPowerManager;
