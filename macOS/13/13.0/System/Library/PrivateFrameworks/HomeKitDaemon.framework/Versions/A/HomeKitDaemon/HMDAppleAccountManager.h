@class ACAccountStore, HMDAccount, NSUUID, NSObject, HMFFuture, HMFExponentialBackoffTimer, HMDAppleAccountContext, HMDAppleAccountSettings, HMDDevice, HMDIDSActivityMonitorBroadcaster, HMDBackingStore, NSString, HMDCloudCache, NSData, HMFPromise, HMFTimer, HMDAccountRegistry;
@protocol HMDIDSService, HMDAPSConnection, OS_dispatch_queue;
...
- (id)initWithIDSService:(id)a0 activityBroadcaster:(id)a1 queue:(id)a2 pushConnection:(id)a3;
