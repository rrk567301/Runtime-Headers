...
@interface HMDResidentDeviceManagerRoar : HMFObject <HMDResidentDeviceManagerContext, HMDPrimaryResidentDiscoveryManagerDelegate, HMDPrimaryResidentElectionAddOnDelegate, HMDModernTransportDeviceReachabilityObserverListener, NSSecureCoding, HMDResidentDeviceManager> {
...
- (void)discoveryManager:(id)a0 didCompleteDiscoveryWithPrimaryResidentDevice:(id)a1 error:(id)a2;
...
- (void)handlePrimaryResidentDiscovered:(id)a0;
...
- (void)_handleUpdatedPrimaryResidentDevice:(id)a0 previousPrimaryResident:(id)a1;
