@class CHIPPluginMatterKeypair, NSNumber, CHIPPluginSystemCommissionerPairingManager, NSDictionary, NSObject, NSMutableArray, CHIPPluginAttestationStatus, CHIPPluginUIDialogPresenter, MTRDeviceController, NSString, CHIPPluginAttestationDataStore, CHIPPluginVendorMetadataStore, CHIPPluginResidentStateManager, CHIPPluginStorage, NSData, HAPPowerManager, CBCentralManager, NSMutableSet;
@protocol OS_dispatch_queue, OS_nw_browser, HAPAccessoryServerBrowserDelegate;
...
- (void)stageAccessoryServerWithSetupPayload:(id)a0 hasPriorSuccessfulPairing:(BOOL)a1 completionHandler:(id /* block */)a2;
...
- (void)_stageAccessoryServerWithSetupPayload:(id)a0 fabricIndex:(id)a1 deviceCredentialHandler:(id /* block */)a2 wifiScanResultsHandler:(id /* block */)a3 threadScanResultsHandler:(id /* block */)a4 hasPriorSuccessfulPairing:(BOOL)a5 completionHandler:(id /* block */)a6;
...
- (void)_prepareForPairingWithSetupPayload:(id)a0 fabricIndex:(id)a1 hasPriorSuccessfulPairing:(BOOL)a2 completionHandler:(id /* block */)a3;
