@class CHIPPluginClusterDescription, HAPCharacteristic, MTRBaseDevice, MTRAttributeCacheContainer, NSString;
...
@property (readonly, nonatomic) MTRAttributeCacheContainer *attributeCacheContainer;
...
- (id)initWithOperationOfType:(unsigned long long)a0 characteristic:(id)a1 attributeCacheContainer:(id)a2;
