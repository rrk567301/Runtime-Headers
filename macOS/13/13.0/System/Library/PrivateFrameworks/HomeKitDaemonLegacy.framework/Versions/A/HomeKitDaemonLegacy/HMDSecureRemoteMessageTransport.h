@class HMDRemoteMessageNotifications, NSString, NSArray, HMDRemoteDeviceMonitor, NSMutableDictionary, HMFPromise, HMDAccountRegistry, HMDCloudDataSyncStateFilter, HMFFuture, NSObject, NSMutableSet;
