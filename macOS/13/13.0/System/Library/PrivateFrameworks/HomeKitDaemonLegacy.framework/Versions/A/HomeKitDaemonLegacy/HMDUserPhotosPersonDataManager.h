@class NSUUID, NSString, HMDUser, HMFMessageDispatcher, HMDCloudPhotosSettingObserver, NSObject, HMPhotosPersonManagerSettings, HMDPhotosPersonManagerSettingsModel, HMBLocalZone, HMDPhotosPersonManager;
