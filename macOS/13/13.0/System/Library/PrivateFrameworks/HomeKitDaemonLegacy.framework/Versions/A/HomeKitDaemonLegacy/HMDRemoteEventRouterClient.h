@class HMFMessageDispatcher, NSString, NSNotificationCenter, NSUUID, NSObject, HMEMessageDatagramClient;
...
- (void)_handleEventUpdateMessage:(id)a0 fromServer:(id)a1 events:(id)a2;
- (void)_handleCachedEventMessage:(id)a0 fromServer:(id)a1 events:(id)a2;
