@class HMDAccount, NSObject, HMFExponentialBackoffTimer, HMDAppleAccountContext, HMDAppleAccountSettings, NSString, HMDDevice, HMDIDSActivityMonitorBroadcaster, HMDBackingStore, HMDCloudCache, NSData, ACAccountStore, HMFTimer, NSUUID;
