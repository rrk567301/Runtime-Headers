@class HMFPairingIdentity, HMDFetchedAccessorySettingsController, HMDAccessorySymptomHandler, HMDHome, HMDAppleMediaAccessoryMetricsDispatcher, NSNotificationCenter, HMMediaDestination, NSString, HMDAccessorySetupMetricDispatcher, HMDDeviceController, HMFWiFiNetworkInfo, HMDAppleMediaAccessorySleepWakeStateController, HMDAppleMediaAccessoryInfoController, NSArray, HMMediaDestinationControllerData, HMFSoftwareVersion, NSObject, NSData, HMFActivity, HMDBackingStore, HMDDevice, HMDPreferredMediaUserEventController, HMFWiFiManager, HMDMediaDestinationController, HMDRemoteLoginHandler, HMDAccessorySettingsController, HMAccessoryCapabilities, HMDTargetControlManager, HMDMediaDestinationManager, HMDAppleMediaAccessoryMessenger, HMDAppleMediaAccessoryInfoSubscriber;
