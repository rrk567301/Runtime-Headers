...
+ (void)animateDestinationWindow:(id)a0 fromDetachedTabAtPointOnScreen:(struct CGPoint { double x0; double x1; })a1 withDraggedMiniWindow:(id)a2 ofWidth:(double)a3 completionHandler:(id /* block */)a4;
