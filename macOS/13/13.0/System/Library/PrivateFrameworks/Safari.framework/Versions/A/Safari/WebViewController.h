@class WKWebViewConfiguration, NSString, NSURL, FindBanner, BannerContainerView, NSMutableArray, SearchableWKView, HeaderFooterPrintRenderer, WKWebsiteDataStore, TabContentViewController;
...
+ (id)webViewControllerForPage:(const void *)a0;
+ (void)enumerateWebViewControllersUsingBlock:(id /* block */)a0;
...
- (void)bannerContainerView:(id)a0 willInstallBanner:(id)a1;
- (void)bannerContainerView:(id)a0 didInstallBanner:(id)a1;
- (void)bannerContainerView:(id)a0 willUninstallBanner:(id)a1;
- (void)bannerContainerViewDidUpdateLayoutDuringAnimation:(id)a0;
