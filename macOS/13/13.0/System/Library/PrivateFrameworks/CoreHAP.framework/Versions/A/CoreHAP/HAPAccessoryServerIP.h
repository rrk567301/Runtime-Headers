@class HMFNetAddress, HMFBlockOperation, NSDate, HAPAccessoryServerBrowserIP, NSDictionary, HAPAuthSession, HAPHTTPClient, HAPAccessory, NSMutableArray, HAPWACAccessory, NSString, NSOperationQueue, NSArray, HMFNetMonitor, NSData, HMFTimer, HAPAccessoryProtocolInfo;
