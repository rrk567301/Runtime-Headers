@class MUPlaceActionManager, MUPlaceViewControllerConfiguration, NSString, MUScrollableStackView, _MKPlaceViewController, _MKPlaceActionButtonController, MUPlaceCardAnalyticsController, GEOWalkingOptions, GEOTransitOptions, MKUGCCallToActionViewAppearance, NSArray, MUPlaceInlineMapSectionController, GEOCyclingOptions, MKETAProvider, NSLayoutConstraint, MUScrollViewImpressionsCalculator, CLLocation, CNContact, GEOAutomobileOptions, NSUUID, CNContactStore, MKMapItem;
...
@interface MUPlaceViewController : _MKUIViewController <_MKPlaceViewControllerDelegate, _MKPlaceViewControllerFeedbackDelegate, MKPlaceCardActionControllerDelegate, MUPlaceSectionControllerDelegate, MKTransitDepaturesViewControllerDelegate, MKETAProviderDelegate, _MKPlaceViewControllerFeedbackDelegate, MKETAProviderObserver, MUVisibleItemsProvider, MUPlaceCardAnalyticsProvider, _MKPlaceCardConforming, MUPlaceCardContentProtocol> {
    BOOL _showNewUI;
...
- (void)placeCardActionControllerDidSelectDirections:(id)a0 options:(id)a1;
