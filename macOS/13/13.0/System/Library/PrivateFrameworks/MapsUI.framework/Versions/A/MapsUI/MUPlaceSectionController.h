@class NSView, MUPlaceSectionFooterViewModel, NSArray, MUPlaceSectionHeaderViewModel, MKMapItem, MKUGCCallToActionViewAppearance, NSString, NSViewController, GEORevealedPlaceCardModule, MUImpressionElement;
