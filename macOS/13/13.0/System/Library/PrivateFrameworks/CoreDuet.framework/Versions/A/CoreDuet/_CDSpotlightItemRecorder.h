@class NSString, BMIntentStream, _DKPrivacyPolicyEnforcer, _DKRateLimitPolicyEnforcer, NSMutableDictionary, _DKContactsPrivacyMaintainer, _PASBloomFilterForWriting, NSMutableArray, NSObject;
