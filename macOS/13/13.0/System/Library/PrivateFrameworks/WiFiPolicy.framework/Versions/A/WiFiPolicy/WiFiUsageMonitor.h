@class NSDate, NSString, WiFiUsageRangingSession, NSMutableDictionary, NSDictionary, NSMutableArray, WiFiUsageInterfaceStats, NSObject;
...
@property BOOL compatibilityModeEnabled;
...
- (void)initializeDeviceLockState:(BOOL)a0 displayState:(BOOL)a1 motionState:(BOOL)a2 vehicularState:(BOOL)a3 callState:(BOOL)a4 mediaState:(BOOL)a5 chargingState:(BOOL)a6 companionConnectionState:(BOOL)a7 andSecondaryInterfaceName:(id)a8 compatibilityMode:(BOOL)a9;
