...
@interface CLPCalibratedPressureCollectionRequest : PBRequest <NSCopying> {
    struct { unsigned char latitudeDeg : 1; unsigned char longitudeDeg : 1; unsigned char timeSinceLastSignificantLocationVisitExitS : 1; unsigned char timestampOfCalibrationS : 1; unsigned char altitudeHAEM : 1; unsigned char altitudeHAEUncM : 1; unsigned char calibratedPressurePa : 1; unsigned char calibratedPressureUncPa : 1; unsigned char devicePressurePa : 1; unsigned char devicePressureUncPa : 1; unsigned char horizontalUncM : 1; unsigned char referenceAltM : 1; unsigned char referenceAltUncM : 1; unsigned char reliability : 1; unsigned char speedMps : 1; unsigned char speedUncMps : 1; } _has;
}
