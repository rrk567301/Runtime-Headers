...
- (void)startWindowSessionWithType:(id)a0 window:(id)a1;
- (BOOL)killEndSessionBackgroundTaskIfNecessary;
- (void)performOnInstrumentationQueueWaitUntilDone:(BOOL)a0 block:(id /* block */)a1;
- (void)endSessionSynchronously:(BOOL)a0;
- (void)endSessionSynchronously:(BOOL)a0 forSessionType:(id)a1;
- (void)endSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 successHandler:(id /* block */)a2;
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 window:(id)a2;
- (void)endWindowSessionSynchronously:(BOOL)a0 forSessionType:(id)a1 window:(id)a2 successHandler:(id /* block */)a3;
- (void)pushLongLivedDataObjects:(id)a0;
- (void)pushLongLivedDataObjects:(id)a0 sessionIdentifier:(id)a1;
...
- (void)pushLongLivedPrivateEventData:(id)a0 sessionIdentifier:(id)a1;
