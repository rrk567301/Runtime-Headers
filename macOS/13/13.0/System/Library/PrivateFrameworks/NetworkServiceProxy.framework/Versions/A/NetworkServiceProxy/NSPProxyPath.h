@class NSString, NSArray, NSUUID, NSPPrivacyProxyNetworkRegistration, NSMutableDictionary, NSPProxyAgentNetworkStatistics, NSPProxyTokenInfo;
...
- (id)initWithDelegate:(id)a0 ingressProxy:(id)a1 egressProxy:(id)a2 proxyPathWeight:(unsigned long long)a3 obliviousConfigs:(id)a4 allowFallback:(BOOL)a5 fallbackToQUIC:(BOOL)a6 forceFallback:(BOOL)a7 allowFailOpen:(BOOL)a8 geohashSharingEnabled:(BOOL)a9 networkCharacteristics:(id)a10;
