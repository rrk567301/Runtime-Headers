@class NSHashTable, NSURL, CPLEngineScopeCleanupTasks, CPLEngineQuarantinedRecords, CPLChangeBatch, CPLResetTracker, NSMutableArray, NSString, CPLEngineChangePipe, CPLEngineCloudCache, NSArray, CPLEngineIDMapping, NSMutableDictionary, CPLEngineIgnoredRecords, CPLTransportScopeMapping, CPLEngineRemappedRecords, NSObject, NSSet, CPLSyncSessionPredictor, CPLEngineScopeStorage, CPLEngineTransientRepository, CPLEngineDerivativesCache, CPLEngineLibrary, CPLEngineResourceStorage, CPLEnginePendingRecordChecks, CPLEngineOutgoingResources, CPLEngineStatusCenter, CPLEnginePushRepository, NSDate, CPLRecordStorageView, CPLEngineResourceDownloadQueue, CPLPlatformObject;
