@class NSString, AMSMetricsDatabaseDataSource, AMSBagKeySet, NSDate, NSObject, AMSEngagement;
...
@property struct os_unfair_lock_s { unsigned int _os_unfair_lock_opaque; } flushingDisabledLock;
