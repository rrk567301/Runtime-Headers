...
+ (id)insertSourceWithUUID:(id)a0 logicalSourceID:(long long)a1 name:(id)a2 options:(unsigned long long)a3 isCurrentDevice:(BOOL)a4 productType:(id)a5 deleted:(BOOL)a6 modificationDate:(id)a7 provenance:(long long)a8 syncIdentity:(id)a9 transaction:(id)a10 error:(id *)a11;
