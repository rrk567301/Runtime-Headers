@class NSDate, NSString, HKDevice, HKObserverSet, NSSet, NSMutableDictionary, HDDataCollectorConfiguration, NSMutableArray, NSObject, HKSource, NSMapTable, HDProfile;
