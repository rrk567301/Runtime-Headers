...
+ (id)insertOrUpdateRacingCluster:(id)a0 routeSnapshot:(id)a1 transaction:(id)a2 error:(id *)a3;
...
+ (id)insertCodableCluster:(id)a0 syncProvenance:(long long)a1 transaction:(id)a2 error:(id *)a3;
