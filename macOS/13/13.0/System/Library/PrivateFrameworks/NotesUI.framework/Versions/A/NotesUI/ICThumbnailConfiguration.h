...
- (id)debugDescription;
- (void).cxx_destruct;
- (id)initWithThumbnailType:(long long)a0 uniqueKey:(id)a1 associatedObject:(id)a2 associatedObjectIdentifier:(id)a3 associatedObjectTitle:(id)a4 accountIdentifier:(id)a5 cacheLevel:(long long)a6 preferredSize:(struct CGSize { double x0; double x1; })a7 scale:(double)a8 appearanceInfo:(id)a9 backgroundColor:(id)a10;
- (id)initWithThumbnailType:(long long)a0 associatedObject:(id)a1 associatedObjectIdentifier:(id)a2 associatedObjectTitle:(id)a3 accountIdentifier:(id)a4 cacheLevel:(long long)a5 preferredSize:(struct CGSize { double x0; double x1; })a6 scale:(double)a7 appearanceInfo:(id)a8 backgroundColor:(id)a9;
...
- (id)initForSystemPaperWidgetWithNote:(id)a0 appearanceInfo:(id)a1;
- (id)initForAvatarWithParticipants:(id)a0 preferredSize:(struct CGSize { double x0; double x1; })a1;
