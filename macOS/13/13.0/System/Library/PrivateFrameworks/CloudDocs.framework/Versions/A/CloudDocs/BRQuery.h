@class NSMetadataQuery, NSString, NSArray, NSPredicate, NSMutableDictionary, NSOperationQueue, NSMutableArray, BRItemCollectionGatherer, BRNotificationReceiver;
