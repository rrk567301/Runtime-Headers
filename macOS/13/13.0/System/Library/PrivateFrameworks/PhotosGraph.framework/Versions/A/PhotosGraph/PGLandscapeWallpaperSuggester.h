@class PGLandscapeWallpaperSuggesterDistancingContext, PGLandscapeWallpaperSuggesterFilteringContext, CLSSceneConfidenceThresholdHelper, PGLandscapeWallpaperSuggesterScoringContext, PGWallpaperSuggestionAssetGater;
...
@property (retain, nonatomic) PGLandscapeWallpaperSuggesterFilteringContext *filteringContext;
