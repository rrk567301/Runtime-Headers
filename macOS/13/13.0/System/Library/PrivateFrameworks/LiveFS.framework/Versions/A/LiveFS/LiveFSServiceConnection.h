...
- (void)createIn:(id)a0 named:(id)a1 attributes:(id)a2 forPID:(int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeDirectoryIn:(id)a0 named:(id)a1 attributes:(id)a2 forPID:(int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeSymLinkIn:(id)a0 named:(id)a1 contents:(id)a2 attributes:(id)a3 forPID:(int)a4 requestID:(unsigned long long)a5 reply:(id /* block */)a6;
- (void)makeLinkOf:(id)a0 named:(id)a1 inDirectory:(id)a2 forPID:(int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)makeCloneOf:(id)a0 named:(id)a1 inDirectory:(id)a2 attributes:(id)a3 usingFlags:(unsigned int)a4 forPID:(int)a5 requestID:(unsigned long long)a6 reply:(id /* block */)a7;
...
- (void)writeTo:(id)a0 atOffset:(unsigned long long)a1 sharedBuffer:(id)a2 forPID:(int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
- (void)blockmapFile:(id)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 startIO:(int)a2 flags:(unsigned int)a3 bufFlags:(unsigned int)a4 forPID:(int)a5 requestID:(unsigned long long)a6 reply:(id /* block */)a7;
- (void)endIO:(unsigned long long)a0 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 status:(int)a2 flags:(unsigned int)a3 requestID:(unsigned long long)a4 reply:(id /* block */)a5;
