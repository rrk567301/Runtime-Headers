@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSURL, NSDate, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCFeedPersonalizedItemScoreProfile, SFSearchResult, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NTHeadlinePersonalizationMetadata, NTPBHeadlineAnalyticsElement, NSString, NTPBHeadlineBackingElement, NTPBHeadlineAdElement, NTPBFeedItem, NSArray;
