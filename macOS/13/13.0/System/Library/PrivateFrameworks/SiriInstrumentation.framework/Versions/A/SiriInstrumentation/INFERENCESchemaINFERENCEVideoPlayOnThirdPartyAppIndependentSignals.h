...
@interface INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppIndependentSignals : SISchemaInstrumentationMessage {
    struct { unsigned char isDeviceLockStatus : 1; unsigned char deviceMotionState : 1; unsigned char intentType : 1; unsigned char nowPlayingState : 1; unsigned char deviceClass : 1; unsigned char clientHourOfDay : 1; unsigned char clientLocale : 1; unsigned char clientLanguage : 1; unsigned char clientRegion : 1; } _has;
}
