@class NSData, SISchemaInstrumentationMessage, INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated, INFERENCESchemaINFERENCEVideoSmartAppSelectionDisambiguationSignalsGenerated, INFERENCESchemaINFERENCEResolutionQueryInfoGenerated, INFERENCESchemaINFERENCEContactCandidatesInfoGenerated, INFERENCESchemaINFERENCECRRTrainingSampleCollected, INFERENCESchemaINFERENCEClientEventMetadata, INFERENCESchemaINFERENCEMusicAppSelectionGroundTruthGenerated, INFERENCESchemaINFERENCEResolutionRequestContext, INFERENCESchemaINFERENCESimpleTaskInfoGenerated, INFERENCESchemaINFERENCEQueryUserPromptSelectedInfoGenerated;
