...
@interface ASRSchemaASRRecognitionMetrics : SISchemaInstrumentationMessage {
    struct { unsigned char personalizedLanguageModelAgeInNs : 1; unsigned char personalizedLanguageModelWeight : 1; unsigned char averageActiveTokensPerFrame : 1; unsigned char signalToNoiseRatioInDecibels : 1; unsigned char recognitionDurationInNs : 1; unsigned char audioDurationInNs : 1; unsigned char eagerEnabled : 1; unsigned char utteranceDetectionEnabled : 1; unsigned char utteranceConcatenationEnabled : 1; unsigned char continuousListeningEnabled : 1; unsigned char eagerCustomerPerceivedLatencyInNs : 1; unsigned char cpuRealTimeFactor : 1; unsigned char numLanguageModelEnrollmentDataStreams : 1; unsigned char inverseTextNormalizationDurationInNs : 1; } _has;
}
