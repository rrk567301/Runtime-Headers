@class RBDevice, NSString, NSDictionary, RBImageQueueLayer, CAContext, RBSharedSurfaceContents;
...
@interface RBLayer : CALayer <_RBDrawableDelegate, _RBSharedSurfaceOwner, RBDrawableStatistics> {
    ...
    struct SharedSubsurface { RBSharedSurfaceContents *_contents; void /* unknown type, empty encoding */ _origin; void /* unknown type, empty encoding */ _size; struct SharedSurfaceUser { struct objc_ptr<CAContext *> { CAContext *_p; } _context; double _deadline; unsigned int _seed; } _user; unsigned int _serial; BOOL _has_border; } _subsurface;
