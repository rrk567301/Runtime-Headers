@class NSString, NSArray, NSAttributedString, NSMutableDictionary, NSDictionary, RTIInputSourceState, TIKeyboardOutput, NSMutableArray, RTIStyledIntermediateText, TIKeyboardIntermediateText, NSObject;
