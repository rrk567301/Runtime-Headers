@class SearchUIStockDataSource, NSString, SearchUIExchange, NSURL, SearchUIStockChartData;
...
@property (retain, nonatomic) SearchUIExchange *exchange;
...
@property (retain, nonatomic) SearchUIStockDataSource *dataSource;
