...
+ (void)generateWatchListReponseForWatchListIdentifier:(id)a0 isSportsEvent:(BOOL)a1 completion:(id /* block */)a2;
+ (void)generateMediaContainerWatchListReponseForWatchListIdentifier:(id)a0 completion:(id /* block */)a1;
+ (void)fetchWatchListStateForWatchListIdentifier:(id)a0 isMediaContainer:(BOOL)a1 completion:(id /* block */)a2;
+ (void)fetchButtonsForWatchListIdentifier:(id)a0 isMediaContainer:(BOOL)a1 isHorizontallySrollingStyle:(BOOL)a2 completion:(id /* block */)a3;
+ (void)fetchButtonsForWatchListIdentifier:(id)a0 isMediaContainer:(BOOL)a1 isHorizontallySrollingStyle:(BOOL)a2 fetchButtons:(BOOL)a3 completion:(id /* block */)a4;
