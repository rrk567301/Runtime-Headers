@class NSMutableDictionary, MNGuidanceLaneInfo, NSMapTable, MNDisplayETAInfo, MNLocation, GEODirectionsResponse, MNActiveRouteInfo, GEONavigationGuidanceState, GEOComposedRoute, NSMutableArray, NSString, geo_isolater, GEODirectionsRequest, GEOComposedWaypoint, NSArray, MNRouteDistanceInfo, MNBatteryChargeInfo;
