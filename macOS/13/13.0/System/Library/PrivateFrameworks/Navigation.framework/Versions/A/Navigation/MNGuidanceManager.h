@class NSMutableDictionary, MNGuidanceSignInfo, MNAnnouncementPlanEvent, MNLocation, NSDictionary, MNAnnouncementEngine, GEOComposedRoute, NSMutableArray, GEOComposedGuidanceEvent, NSString, NSMutableSet, GEOComposedWaypoint, NSArray, MNJunctionViewImageLoader;
...
- (void)updateForReroute:(id)a0 rerouteReason:(unsigned long long)a1 location:(id)a2;
