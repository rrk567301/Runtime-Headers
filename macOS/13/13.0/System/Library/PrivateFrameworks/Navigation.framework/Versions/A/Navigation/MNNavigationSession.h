@class GEOProbeCrumbs, GEOMotionContext, MNLocation, GEOApplicationAuditToken, MNAudioManager, MNTraceNavigationEventRecorder, MNVehicleMonitor, GEONavigationGuidanceState, MNTimeAndDistanceUpdater, NSString, MNLocationTracker, MNRouteManager, MNTraceNavigationUpdateRecorder, MNNavigationSessionLogger, MNGuidanceManager, MNNavigationTraceManager, GEOComposedWaypoint, MNTrafficIncidentAlert, MNObserverHashTable, GEOResourceManifestUpdateAssertion;
