@class MNGuidanceLaneInfo, NSMutableDictionary, MNUserOptions, GEODirectionsResponse, MNLocation, MNNavigationDetails, MNDisplayETAInfo, GEOComposedRoute, MNObserverHashTable, NSString, NSSet, GEODirectionsRequest, MNNavigationServiceRemoteProxy, MNRouteDistanceInfo, NSArray, GEOComposedWaypoint, MNBatteryChargeInfo, MNNavigationClientProxy, NSUUID;
