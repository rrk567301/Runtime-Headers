...
- (id)initWithAnalysisType:(unsigned long long)a0 isLivePhoto:(BOOL)a1 photoOffset:(float)a2 hadFlash:(BOOL)a3 hadZoom:(BOOL)a4 isTimelapse:(BOOL)a5 preferredTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a6 asset:(id)a7;
...
- (float)analyzeOverallQuality:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 isSettlingEffect:(BOOL)a1;
