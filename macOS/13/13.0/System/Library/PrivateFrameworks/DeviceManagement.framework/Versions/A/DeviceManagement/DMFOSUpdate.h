...
- (void).cxx_destruct;
- (id)initWithProductKey:(id)a0 humanReadableName:(id)a1 productName:(id)a2 version:(id)a3 build:(id)a4 downloadSize:(unsigned long long)a5 installSize:(unsigned long long)a6 isCritical:(BOOL)a7 restartRequired:(BOOL)a8 allowsInstallLater:(BOOL)a9;
