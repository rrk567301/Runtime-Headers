@class PLPhotoLibrary, NSArray, PLManagedAsset, PLDuplicateAsset;
...
+ (id)_crashRecoveryMarkerFileURLWithPathManager:(id)a0;
+ (BOOL)_writeCrashRecoveryMarkerFileForTargetAssetUUID:(id)a0 pathManager:(id)a1;
+ (BOOL)_removeCrashRecoveryMarkerFileWithPathManager:(id)a0;
+ (void)processCrashRecoveryMarkerFileIfNeededWithPathManager:(id)a0;
