...
+ (id)_computeCountOfContributedAssetsTrashedByOtherParticipantsInLibraryScope:(id)a0 outPhotoCount:(unsigned long long *)a1 outVideoCount:(unsigned long long *)a2 outItemCount:(unsigned long long *)a3;
+ (id)fireParticipantAssetTrashNotificationIfNeededWithPhotoLibrary:(id)a0 forceNotification:(BOOL)a1;
+ (id)_nearestDateSetToHour:(long long)a0;
...
- (id)markOnboardingPreviewAssetsByProcessingRulesWithCompletionHandler:(id /* block */)a0;
