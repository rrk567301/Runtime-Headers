...
- (id)existingChannelForPresenceIdentifier:(id)a0 databaseContext:(id)a1;
...
- (id)createPresenceChannelForPresenceIdentifier:(id)a0 channelIdentifier:(id)a1 channelToken:(id)a2 peerKey:(id)a3 serverKey:(id)a4 membershipKey:(id)a5 databaseContext:(id)a6;
...
- (id)_existingChannelsForPresenceIdentifier:(id)a0 databaseContext:(id)a1;
