@class SKAPresenceClientConnection, NSString, NSSet, NSObject;
...
- (void)assertPresenceForIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)releasePresenceForIdentifier:(id)a0 completion:(id /* block */)a1;
- (void)fetchPresenceCapability:(id /* block */)a0;
- (void)registerForDelegateCallbacksWithPresenceIdentifier:(id)a0 completion:(id /* block */)a1;
