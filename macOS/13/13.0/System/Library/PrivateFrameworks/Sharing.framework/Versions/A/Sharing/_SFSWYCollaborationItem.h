@class NSUUID, SFCollaborationCloudSharingResult, NSArray, SFPendingCollaboration, NSItemProvider, NSString, SFCollaborationMetadata, SFCollaborationShareOptions, LPLinkMetadata;
