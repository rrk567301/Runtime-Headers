@class NSUUID, SFCollaborationCloudSharingResult, NSArray, NSString, NSItemProvider, SFCollaborationMetadata, SFCollaborationShareOptions, LPLinkMetadata, SFChangePublisher;
...
+ (id)collaborationItemForItemProvider:(id)a0 activityItem:(id)a1;
+ (id)collaborationItemForFileURL:(id)a0 itemProvider:(id)a1 activityItem:(id)a2 defaultCollaboration:(BOOL)a3;
