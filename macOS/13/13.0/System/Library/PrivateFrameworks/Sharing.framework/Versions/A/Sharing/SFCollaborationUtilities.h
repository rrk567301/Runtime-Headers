...
+ (BOOL)isSharedFileURL:(id)a0 isLocalStorageFileURL:(BOOL *)a1 isiCloudDriveFileURL:(BOOL *)a2;
...
+ (BOOL)canDeleteShareForCollaborationItem:(id)a0 existingShare:(BOOL)a1;
