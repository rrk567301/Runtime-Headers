@class NSUUID, SFCollaborationCloudSharingResult, NSURL, NSArray, NSItemProvider, NSString, SFCollaborationMetadata, SFCollaborationShareOptions, LPLinkMetadata;
...
- (id)initWithFileURL:(id)a0 itemProvider:(id)a1 activityItem:(id)a2 defaultCollaboration:(BOOL)a3;
