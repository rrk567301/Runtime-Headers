...
@property (readonly, nonatomic, getter=isSMSSubClassificationEnabled) BOOL smsSubClassification;
@property (readonly, nonatomic, getter=isSIMBasedFilteringEnabled) BOOL simBasedFiltering;
...
@property (readonly, nonatomic, getter=isTemplateCapabilityFallbackEnabled) BOOL templateCapabilityFallbackEnabled;
