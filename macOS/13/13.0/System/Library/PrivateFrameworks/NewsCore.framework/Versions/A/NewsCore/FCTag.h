@class NTPBPublisherPaidDescriptionStrings, FCTagBanner, NSString, FCContentArchive, NTPBTagRecord, NSArray, FCHeadlineTemplate, FCAssetManager, FCSectionSupergroupKnobs, FCPaywallConfiguration, FCInterestToken, NSData, FCAssetHandle, FCColorGradient, FCTextInfo, NFLazy, FCColor, FCSportsRecommendationMappings, NTPBFeedConfiguration, FCContentColorMap, NSDate;
