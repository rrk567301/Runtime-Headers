@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCFeedPersonalizedItemScoreProfile, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, FCColor, NTPBIssueRecord, FCInterestToken, NSString, FCContentArchive, NSArray, FCAssetHandle;
