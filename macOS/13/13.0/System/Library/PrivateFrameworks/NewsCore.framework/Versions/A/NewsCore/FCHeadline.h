@class NSURL, FCIssue, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCTopStoriesStyleConfiguration, FCColor, FCFeedPersonalizedItemScoreProfile, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, FCHeadlineThumbnail, NSString, NSSet, FCCoverArt, FCArticleAudioTrack, NSArray, NSData, FCHeadlineExperimentalTitleMetadata, FCAssetHandle;
