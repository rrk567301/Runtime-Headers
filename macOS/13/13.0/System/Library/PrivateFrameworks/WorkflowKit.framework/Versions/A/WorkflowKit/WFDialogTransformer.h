@class NSDate, WFSiriUIPresenter, NSArray, NSString, WFUIPresenter, WFAction, WFSequentialParameterInputProvider, WFChooseFromListDataStore, WFDialogAttribution, WFWorkflow, WFWorkflowController;
...
- (void).cxx_destruct;
- (void)cancel;
- (void)setExecutionContext:(long long)a0;
...
- (BOOL)openApp:(id)a0 completionHandler:(id /* block */)a1;
- (BOOL)executeLinkAction:(id)a0 inApplication:(id)a1 completionHandler:(id /* block */)a2;
- (BOOL)executeLinkAction:(id)a0 inApplication:(id)a1 withNameOverride:(id)a2 completionHandler:(id /* block */)a3;
- (void)punchOutRequestedWithCompletionHandler:(id /* block */)a0;
- (void)setAirPlayRouteIDs:(id)a0;
...
- (void)showLinkActionConfirmationWithActionMetadata:(id)a0 dialogString:(id)a1 viewSnippet:(id)a2 confirmationActionName:(id)a3 completionHandler:(id /* block */)a4;
