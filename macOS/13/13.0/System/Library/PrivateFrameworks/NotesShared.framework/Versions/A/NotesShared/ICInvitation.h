@class NSData, NSString, NSURL, NSDate, CKShareSystemFieldsTransformer, ICCloudSyncingObject, CKShare, ICAccount;

@interface ICInvitation : NSManagedObject

@property (class, readonly, nonatomic) CKShareSystemFieldsTransformer *shareSystemFieldsTransformer;
...
+ (id)makeOrUpdateInvitationWithShareURL:(id)a0 account:(id)a1 context:(id)a2;
