@class NSUUID, NSString, NSArray, NSAttributedString, NSData, _SWCollaborationMetadata, NSDictionary, _SWPendingCollaboration, CKContainerSetupInfo, CKShare, _SWCollaborationShareOptions;
