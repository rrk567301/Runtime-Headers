@class BRCSyncOperationBackoffRatio, BRCItemID, CKOperationGroup, BRCSyncDownOperation, BRCSyncBudgetThrottle, BRCAccountSession, NSMutableArray, NSString, NSMutableSet, BRCThrottleBase, NSError, BRCFetchRecentAndFavoriteDocumentsOperation, NSArray, NSMutableDictionary, brc_task_tracker, BRCPQLConnection, NSMutableIndexSet, NSObject, BRCZoneRowID, BRCDeadlineSource, BRCServerZone, BRCThrottle, BRCCreateZoneAndSubscribeOperation, BRCSyncOperationThrottle, BRMangledID, NSDate, BRCSyncUpOperation;
...
- (BOOL)existsByParentID:(id)a0 andCaseInsensitiveLogicalName:(id)a1 excludingItemID:(id)a2;
- (BOOL)existsByParentID:(id)a0 andCaseInsensitiveLogicalName:(id)a1 db:(id)a2;
- (BOOL)existsByParentID:(id)a0 andCaseInsensitiveLogicalName:(id)a1 excludingItemID:(id)a2 db:(id)a3;
...
- (id)itemEnumeratorByParentID:(id)a0 andCaseInsensitiveLogicalName:(id)a1;
