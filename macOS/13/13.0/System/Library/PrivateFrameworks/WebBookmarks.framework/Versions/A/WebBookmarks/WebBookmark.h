...
- (void)markAsRead;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 subtype:(long long)a3 deviceIdentifier:(id)a4;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 deviceIdentifier:(id)a3;
- (id)initWithTitle:(id)a0 address:(id)a1 parentID:(int)a2 folder:(BOOL)a3 deviceIdentifier:(id)a4;
- (id)initFolderWithParentID:(int)a0 subtype:(long long)a1 deviceIdentifier:(id)a2;
- (id)initFolderWithParentID:(int)a0;
- (id)initFolderWithParentID:(int)a0 deviceIdentifier:(id)a1;
...
- (BOOL)_usedForInMemoryChangeTracking;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 deviceIdentifier:(id)a1;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { } *)a0 deviceIdentifier:(id)a1 hasIcon:(BOOL)a2;
