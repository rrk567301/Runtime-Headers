@class _HMContext, HMFTimer, HMSoftwareUpdateDocumentationManager, NSMutableArray, NSString, NSError, HMApplicationData, HMELastEventStore, HMUserActionPredictionProvider, HMMigrationBoost, NSArray, HMHome, NSCountedSet, NSObject, HMAccessorySettingsMetricsDispatcher, HMMutableArray, NSSet, NSOperationQueue, HMCacheManager, HMAccessorySetupCoordinator, HMCoreAnalyticsMetricEventDispatcher, HMNetworkRouterFirewallRuleManager, HMUserCloudShareManager, HMAccessory, HMXPCEventRouterClient, NSUUID, NSNumber, HMHomeManagerConfiguration;
