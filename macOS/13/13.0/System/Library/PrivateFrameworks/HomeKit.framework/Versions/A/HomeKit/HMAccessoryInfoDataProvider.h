...
- (void)configureWithHomeIdentifier:(id)a0 accessoryIdentifier:(id)a1 accesoryInfoTypes:(unsigned long long)a2 dataProviderDelegate:(id)a3 completionHandler:(id /* block */)a4;
