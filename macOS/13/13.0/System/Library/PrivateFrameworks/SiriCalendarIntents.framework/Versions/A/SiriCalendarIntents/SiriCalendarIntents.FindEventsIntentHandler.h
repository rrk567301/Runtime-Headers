@class INStringResolutionResult, INEventAttributeResolutionResult, INPlacemarkResolutionResult, INFindEventsIntentResponse, INFindEventsIntent, INDateComponentsRangeResolutionResult;
