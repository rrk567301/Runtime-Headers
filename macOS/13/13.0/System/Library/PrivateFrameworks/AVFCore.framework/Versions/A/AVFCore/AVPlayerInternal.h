@class AVPixelBufferAttributeMediator, NSMutableDictionary, NSObject, NSDictionary, AVPlayerMediaSelectionCriteria, AVOutputContext, NSMutableArray, AVPlayerItem, NSString, AVPlayerPlaybackCoordinator, AVQueuePlayer, NSMutableSet, NSHashTable, NSArray, AVWeakReference, NSError, AVPlayerRateState;
