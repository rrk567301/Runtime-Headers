@class NSString, NSArray, _TtC12FeedbackCore37FBKDeviceDiagnosticsControllerCombine, NSSet, NSMutableDictionary, FBKAttachmentManager, FBKDeviceManager, NSMutableSet, DEDBugSession;
