@interface PaymentUI.ContactSearchController : NSObject <CNAutocompleteResultWindowDelegate, CNAutocompleteFetchDelegate, CNAutocompleteSuggestionsViewControllerDelegate, NSControlTextEditingDelegate, NSTextFieldDelegate> {
