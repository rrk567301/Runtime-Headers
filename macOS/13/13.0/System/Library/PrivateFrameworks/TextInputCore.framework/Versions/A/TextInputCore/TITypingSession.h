@class NSMutableDictionary, NSDate, TIKeyboardState, NSLocale, TITypingSessionParams, TIKeyboardTouchEvent, NSMutableArray, TIWordEntry, NSString, TIDeleteWordEvent, TIKeyboardInput, TIFeatureUsageMetricsCache, NSArray;
