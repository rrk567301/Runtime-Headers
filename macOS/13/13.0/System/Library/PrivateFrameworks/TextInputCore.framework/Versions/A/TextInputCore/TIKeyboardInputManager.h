...
- (void)handleLMTrialParametersDidChangeNotification:(id)a0;
...
- (void)registerNegativeEvidence:(id)a0 tokenID:(struct TITokenID { unsigned int x0; unsigned int x1; })a1 contextTokens:(id)a2 intendedTokenID:(struct TITokenID { unsigned int x0; unsigned int x1; } *)a3 hint:(int)a4;
