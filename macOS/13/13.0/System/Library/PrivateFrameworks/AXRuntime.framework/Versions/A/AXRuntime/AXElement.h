@class AXElementGroup, NSArray, NSString, NSDictionary, AXUIElement, NSURL;
...
@property (readonly, nonatomic) NSDictionary *focusableScenes;
@property (readonly, nonatomic) AXElement *focusedScene;
