@class GEOPDViewportInfo, NSString, NSData, GEOPDSearchOriginationInfo, PBDataReader, GEOPDRecentRouteInfo, GEOPDETAFilter, PBUnknownFields, GEOPDResultRefinementQuery, GEOPDSSearchEvChargingParameters;
