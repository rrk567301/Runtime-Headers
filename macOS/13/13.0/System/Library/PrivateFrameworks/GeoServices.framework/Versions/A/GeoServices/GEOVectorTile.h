...
@property (readonly, nonatomic) struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *junctions;
...
@property (readonly, nonatomic) struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *transitJunctions;
...
@property (readonly, nonatomic) struct GeoCodecsDaVinciMesh { unsigned char x0; unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; BOOL x6; float *x7; float *x8; } *daVinciMeshes;
...
- (void)forEachEdgeOnJunction:(const struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *)a0 visitor:(id /* block */)a1;
- (void)forEachEdgeInRoad:(id)a0 visitTwice:(BOOL)a1 visitor:(id /* block */)a2;
- (void)forEachTransitLinkOnJunction:(const struct GeoCodecsConnectivityJunction { unsigned int x0; unsigned int x1; struct GeoCodecsPointFeature *x2; } *)a0 visitor:(id /* block */)a1;
