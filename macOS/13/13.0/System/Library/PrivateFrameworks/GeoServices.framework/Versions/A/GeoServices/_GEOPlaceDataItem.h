@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, GEOAddressObject, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOEnrichmentData, GEOMapRegion, GEOMuninViewState, NSMapTable, NSData, GEOEnclosingPlace, GEOPlace, GEOStorefrontPresentationInfo, GEOEnrichmentInfo, GEOBusinessHours, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOPlacecardLayoutData, GEOViewportFrame, GEOPOIClaim, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOPDMultiLocalizedString, GEOStyleAttributes, GEOStorefrontInfo, NSString, _GEOEncyclopedicInfo, NSTimeZone, GEOMapItemPhotosAttribution, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEORestaurantFeaturesLink, geo_reentrant_isolater, GEOBusinessAssets, GEOPDPlace, GEOPriceDescription, GEOAddress;
