...
- (struct RoadNetworkPath<GEOPathMatcherRoadKey> { double x0; double x1; struct vector<GEOPathMatcherRoadKey, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey *x0; struct GEOPathMatcherRoadKey *x1; struct __compressed_pair<GEOPathMatcherRoadKey *, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey *x0; } x2; } x2; })_decodePathForRoute:(id)a0 start:(struct PolylineCoordinate { unsigned int x0; float x1; })a1 end:(struct PolylineCoordinate { unsigned int x0; float x1; })a2 roadNetwork:(const void *)a3 internalInfo:(id)a4;
...
- (void)_verifySegmentDistanceFromRoute:(id)a0 segmentIndex:(long long)a1 requestedPathRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a2;
