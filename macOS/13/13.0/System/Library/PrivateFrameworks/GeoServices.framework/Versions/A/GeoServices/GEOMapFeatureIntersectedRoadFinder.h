...
- (void).cxx_destruct;
- (id)findRoadsAtPreviousIntersectionOf:(id)a0 desiredRoadDirectionality:(unsigned long long)a1 handler:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (id)findRoadsAtNextIntersectionOf:(id)a0 desiredRoadDirectionality:(unsigned long long)a1 handler:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (id)findRoadsAtJunction:(id)a0 desiredRoadDirectionality:(unsigned long long)a1 handler:(id /* block */)a2 completionHandler:(id /* block */)a3;
- (id)_findRoadsAtJunction:(id)a0 desiredRoadDirectionality:(unsigned long long)a1 muid:(unsigned long long)a2 featureToIgnore:(id)a3 handler:(id /* block */)a4 completionHandler:(id /* block */)a5;
- (id)findUnjoinedRoadsAtJunction:(id)a0 desiredRoadDirectionality:(unsigned long long)a1 muid:(unsigned long long)a2 requireExactMuidMatch:(BOOL)a3 featureToIgnore:(id)a4 handler:(id /* block */)a5 completionHandler:(id /* block */)a6;
- (void)_tilesBorderingTile:(struct _GEOTileKey { unsigned char x0 : 7; unsigned char x1 : 1; union { struct _GEOStandardTileKey { unsigned long x0 : 40; unsigned char x1 : 6; unsigned int x2 : 26; unsigned int x3 : 26; unsigned short x4 : 14; unsigned char x5 : 4; unsigned char x6 : 4; } x0; struct _GEOGloriaQuadIDTileKey { unsigned char x0 : 6; unsigned long x1 : 64; unsigned short x2 : 14; unsigned long x3 : 36; } x1; struct _GEORegionalResourceKey { unsigned int x0 : 32; unsigned char x1 : 8; unsigned char x2 : 6; unsigned char x3 : 8; unsigned char x4 : 8; unsigned char x5 : 1; unsigned long x6 : 57; } x2; struct _GEOSputnikMetadataKey { unsigned int x0 : 32; unsigned int x1 : 24; unsigned short x2 : 14; unsigned char x3 : 8; unsigned long x4 : 42; } x3; struct _GEOFlyoverKey { unsigned char x0 : 6; unsigned int x1 : 26; unsigned int x2 : 26; unsigned char x3 : 8; unsigned int x4 : 24; unsigned short x5 : 14; unsigned char x6 : 8; unsigned char x7 : 8; } x4; struct _GEOTransitLineSelectionKey { unsigned char x0 : 6; unsigned int x1 : 25; unsigned int x2 : 25; unsigned long x3 : 64; } x5; struct _GEOPolygonSelectionKey { unsigned char x0 : 6; unsigned int x1 : 25; unsigned int x2 : 25; unsigned long x3 : 64; } x6; struct _GEOTileOverlayKey { unsigned char x0 : 6; unsigned int x1 : 26; unsigned int x2 : 26; unsigned char x3 : 8; unsigned int x4 : 32; unsigned short x5 : 16; unsigned char x6 : 6; } x7; struct _GEOIdentifiedResourceKey { unsigned long long x0; unsigned char x1; unsigned char x2; unsigned char x3 : 1; unsigned long x4 : 39; } x8; struct _GEOMuninMeshKey { unsigned long x0 : 64; unsigned int x1 : 32; unsigned short x2 : 16; unsigned char x3 : 5; unsigned char x4 : 3; } x9; struct _GEOS2TileKey { unsigned char x0 : 6; unsigned int x1 : 26; unsigned int x2 : 26; unsigned char x3 : 3; unsigned short x4 : 14; unsigned char x5 : 4; unsigned char x6 : 4; unsigned long x7 : 37; } x10; } x2; })a0 atPoint:(struct GeoCodecsVectorTilePoint { float x0; float x1; })a1 withHandler:(id /* block */)a2;
