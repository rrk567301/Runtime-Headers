@class GEOMatchedPathSegment, NSString, NSArray, GEOCommonOptions, GEOComposedRoute, GEORouteAttributes, GEOApplicationAuditToken, GEOComposedWaypoint, GEORecentLocationHistory, GEOLocation, GEOMapRegion, GEODirectionsRequestFeedback;
