@class NSData, FTBatchTranslationLoggingRequest, FTBatchTranslationResponse, NSMutableDictionary, FTFinalBlazarResponse, FTBatchTranslationFeedbackRequest, FTBatchTranslationRequest, NSObject;
