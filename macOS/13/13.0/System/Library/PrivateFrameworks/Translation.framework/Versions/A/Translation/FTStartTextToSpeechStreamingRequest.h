@class NSData, NSString, NSArray, FTTextToSpeechRequestExperiment, FTTextToSpeechRequestContext, FTTextToSpeechRequestProsodyTransferConfig, FTTextToSpeechRequestDebug, FTTextToSpeechRequestDevConfig, NSMutableDictionary, FTTextToSpeechRequestMeta, FTTTSRequestFeatureFlags, FTTextToSpeechUserProfile;
