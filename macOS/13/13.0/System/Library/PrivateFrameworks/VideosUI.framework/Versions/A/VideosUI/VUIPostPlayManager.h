@class NSString, VUIPostPlayContainerViewController, VUIVideosPlayable, NSView, NSDate, VUIStateMachine, NSWindow;
...
- (void)_setMinimalMetadataIfEnabled:(BOOL)a0;
...
- (id)_performPlaybackEngineSelector:(SEL)a0 withObject:(id)a1;
