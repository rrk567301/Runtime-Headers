...
- (id)_createSessionForPlayer_Legacy:(id)a0;
- (id)_trackerWithBaseEventDataForSession_Legacy:(id)a0;
- (void)_reportForSession_Legacy:(id)a0 state:(id)a1 reason:(id)a2;
- (void)_reportSeekStopAtTimeInMS_Legacy:(unsigned long long)a0 playbackDate:(id)a1 session:(id)a2 tracker:(id)a3 player:(id)a4;
