...
@interface VCAudioIOControllerClient : NSObject {
    ...
    struct _VCAudioIOControllerClientIO { void *processSamplesContext; void /* function */ *processSamples; NSObject<OS_dispatch_semaphore> *runLock; unsigned int audioSessionId; unsigned int channelIndex; unsigned int channelCount; struct opaqueVCAudioBufferList *controllerAudioBuffer; } _sinkIO;
    struct _VCAudioIOControllerClientIO { void *processSamplesContext; void /* function */ *processSamples; NSObject<OS_dispatch_semaphore> *runLock; unsigned int audioSessionId; unsigned int channelIndex; unsigned int channelCount; struct opaqueVCAudioBufferList *controllerAudioBuffer; } _sourceIO;
}
...
@property (readonly, nonatomic) struct _VCAudioIOControllerClientIO { void *x0; void /* function */ *x1; id x2; unsigned int x3; unsigned int x4; unsigned int x5; struct opaqueVCAudioBufferList *x6; } *sinkIO;
@property (readonly, nonatomic) struct _VCAudioIOControllerClientIO { void *x0; void /* function */ *x1; id x2; unsigned int x3; unsigned int x4; unsigned int x5; struct opaqueVCAudioBufferList *x6; } *sourceIO;
...
@property (readonly, nonatomic) unsigned int channelIndex;
...
- (id)initWithDelegate:(id)a0 audioSessionId:(unsigned int)a1 channelIndex:(unsigned int)a2 sourceContext:(void *)a3 sourceProcess:(void /* function */ *)a4 sinkContext:(void *)a5 sinkProcess:(void /* function */ *)a6 clientPid:(int)a7 isPrewarmingClient:(BOOL)a8 spatialToken:(unsigned long long)a9;
