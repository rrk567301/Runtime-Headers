...
@interface VCSystemAudioCapture : VCObject {
    ...
    struct tagVCSystemAudioCaptureTapSettings { unsigned int tapType; union { int audioProcessIdToTap; unsigned int sessionTypeToTap; } ; struct __CFString *captureContext; } _tapSettings;
