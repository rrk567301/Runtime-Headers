@class NSXPCConnection, NSString, GEOObserverHashTable, NSArray, MSPSharedTripSharingIdentity, NSDate, MSPSharedTripContactController, NSMutableDictionary, NSObject, NSMutableArray, NSData, MSPMapsPaths;
...
- (void)_fetchArchivedSharingStateWithCompletion:(id /* block */)a0;
