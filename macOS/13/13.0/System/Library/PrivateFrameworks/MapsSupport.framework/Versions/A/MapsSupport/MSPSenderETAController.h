@class MSPSharedTripRelay, NSObject, MSPSenderMessageStrategy, MSPNavigationListener, NSString, MSPSenderLiveStrategy, MSPSharingRestorationStorage, MSPGroupSessionStorage, NSMutableSet, MSPSharedTripGroupSession, NSArray, MSPSharedTripStorageController, MSPSenderMinimalStrategy;
