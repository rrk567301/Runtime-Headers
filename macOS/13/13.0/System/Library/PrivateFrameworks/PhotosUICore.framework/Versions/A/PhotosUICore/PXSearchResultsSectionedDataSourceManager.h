@class PHCachingImageManager, NSTimer, PXSearchActiveSearch, NSString, PLSearchMetadataStore, PSIDatabase, NSDictionary, NSObject, PXSearchResultsSectionedDataSource;
