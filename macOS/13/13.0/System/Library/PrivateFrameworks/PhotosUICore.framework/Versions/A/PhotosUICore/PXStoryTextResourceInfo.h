...
+ (id)_titlePrimaryAttributesForStylePairing:(long long)a0 scale:(double)a1 kind:(unsigned long long)a2 layoutScheme:(long long)a3 allowHyphenation:(BOOL)a4;
...
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
- (id)initWithString:(id)a0 associatedSubtitleString:(id)a1 type:(long long)a2 layoutScheme:(long long)a3;
