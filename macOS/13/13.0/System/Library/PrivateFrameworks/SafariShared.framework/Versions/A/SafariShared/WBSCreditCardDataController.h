@class PKSafariCardNotificationManager, NSArray, NSString, NSMapTable, PKVirtualCardManager, NSObject, NSCache;
...
- (void)_requestCardDetailsForNextVirtualCard:(id)a0 externalizedContext:(id)a1 blockToUpdateCardDetails:(id /* block */)a2;
