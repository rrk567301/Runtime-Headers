@class NSDictionary, ICMusicSubscriptionLeaseStatus, ICAVAssetDownloadURLSession, MPCModelGenericAVItemTimedMetadataResponse, MPCPlaybackRequestEnvironment, ICStoreRequestContext, NSString, ICMusicSubscriptionLeaseSession, ICURLRequest, MPGaplessInfo, MPCPlayerAudioFormat, MPCAudioAssetTypeSelection, MPPropertySet, MPCModelGenericAVItemTimedMetadataRequest, NSArray, MPModelGenericObject, MPMediaLibrary, NSObject, MPCSuzeLeaseSession, NSData, NSOperationQueue, MPCPlayerAudioRoute, MPCPlaybackEngineEventStream, ICContentKeySession, MPSubscriptionStatusPlaybackInformation, NSURL, NSNumber, MPCModelGenericAVItemUserIdentityPropertySet;
