@class MPPlaybackEQSetting, MPCMediaFoundationTranslator, NSString, MPCModelGenericAVItem, NSObject, MPCPlayerAudioRoute, MPCPlaybackEngine, MPAVRoutingController;
