...
@property (copy, nonatomic) NSString *preferredStartItemForCallingSuper;
...
- (BOOL)isAutoPlayItem:(id)a0;
- (void)removeAllItemsAfterItem:(id)a0;
...
- (id)_ICSharedListeningForMPSILItemIdentifiers:(id)a0;
