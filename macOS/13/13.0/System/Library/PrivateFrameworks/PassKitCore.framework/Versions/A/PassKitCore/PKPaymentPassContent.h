@class NSString, NSURL, NSArray, NSDictionary, PKPassAuxiliaryRegistrationRequirements, PKDynamicLayerConfiguration, PKSiriIntentsConfiguration, PKFidoProfile;
