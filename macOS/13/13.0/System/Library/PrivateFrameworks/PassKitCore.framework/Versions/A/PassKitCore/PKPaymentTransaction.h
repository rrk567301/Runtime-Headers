...
+ (id)formattedBalanceAdjustmentForAmount:(id)a0 transactionType:(long long)a1 adjustmentType:(long long)a2 peerPaymentType:(long long)a3 featureIdentifier:(unsigned long long)a4;
