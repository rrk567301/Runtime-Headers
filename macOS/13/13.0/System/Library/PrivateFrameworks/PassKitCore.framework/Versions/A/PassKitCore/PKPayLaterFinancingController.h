...
- (void)startedAuthenticatingFinancingOptionIdentifier:(id)a0;
- (void)receivedAuthenticationResult:(unsigned long long)a0 selectedOptionIdentifier:(id)a1 error:(id)a2;
