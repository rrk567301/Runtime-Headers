@class NSString, NSOrderedSet, PKPayLaterFinancingPlan, PKBankAccountInformation, NSURL, NSDictionary;
...
@property (readonly, copy, nonatomic) NSOrderedSet *acceptedPassUniqueIDs;
