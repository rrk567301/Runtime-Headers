@class NSString, NSURL, NSArray, NSSet, PKPassAuxiliaryRegistrationRequirements, PKCurrencyAmount, PKPaymentApplication, PKSiriIntentsConfiguration, PKTransitPassProperties;
...
- (BOOL)_networkSupportedForVirtualCard:(id)a0;
