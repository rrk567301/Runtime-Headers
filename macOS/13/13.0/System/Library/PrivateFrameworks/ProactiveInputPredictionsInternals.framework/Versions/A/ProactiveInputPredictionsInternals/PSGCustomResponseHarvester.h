...
+ (void)runHarvestSkipMessageCollection:(BOOL)a0 clearCheckpoint:(BOOL)a1 reportMetrics:(BOOL)a2 modelConfigPath:(id)a3 modelFilePath:(id)a4 storeDirectory:(id)a5 evalFraction:(id)a6;

- (void).cxx_destruct;
- (id)modelForLanguage:(id)a0;
- (BOOL)isSupportedLanguage:(id)a0;
- (id)initWithActivityManager:(id)a0;
- (id)initWithActivityManager:(id)a0 modelConfigPath:(id)a1 modelFilePath:(id)a2 storeDirectory:(id)a3;
