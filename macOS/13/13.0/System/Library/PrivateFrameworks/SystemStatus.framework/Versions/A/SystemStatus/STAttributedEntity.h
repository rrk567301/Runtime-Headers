@class NSString, STExecutableIdentity;
...
- (id)initWithExecutableIdentity:(id)a0 website:(id)a1 systemService:(BOOL)a2 bundleIdentifier:(id)a3 localizedDisplayName:(id)a4 localizedExecutableDisplayName:(id)a5;
