@class NSError, NSString, NetworkQualityConfiguration, NSDate, NSOperationQueue, NetworkQualityExecutionsResult, NetworkQualityExecutions, NSObject, NSMutableArray, NSURLRequest;
