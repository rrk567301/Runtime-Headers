@class NSString, AGXG14XFamilyDevice, AGXG14XFamilyBuffer;
@protocol MTLDevice;

@interface AGXG14XFamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG14XFamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG14XFamilyBuffer *current_argument_buffer; } _impl;
}
