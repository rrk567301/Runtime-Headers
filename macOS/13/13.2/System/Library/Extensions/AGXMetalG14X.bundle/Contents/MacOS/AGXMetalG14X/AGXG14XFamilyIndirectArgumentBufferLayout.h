@interface AGXG14XFamilyIndirectArgumentBufferLayout : _MTLIndirectArgumentBufferLayout {
    struct unique_ptr<AGX::G14X::IndirectArgumentLayout, std::default_delete<AGX::G14X::IndirectArgumentLayout>> { struct __compressed_pair<AGX::G14X::IndirectArgumentLayout *, std::default_delete<AGX::G14X::IndirectArgumentLayout>> { struct IndirectArgumentLayout *__value_; } __ptr_; } _impl;
}
