...
@protocol OS_dispatch_semaphore, SKAMessagingProviding, SKADatabaseManaging, SKAAccountProviding, SKAPresenceManagingDelegate, SKAStatusSubscriptionManaging, OS_dispatch_queue, SKAChannelManaging;
...
@property (retain, nonatomic) NSObject<OS_dispatch_semaphore> *channelCreationSemaphore;
@property (nonatomic) unsigned long long semaphoreTimeout;
