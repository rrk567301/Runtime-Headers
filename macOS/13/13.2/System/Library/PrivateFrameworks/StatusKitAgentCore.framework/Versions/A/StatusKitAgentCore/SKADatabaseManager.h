...
- (id)createPresenceChannelForPresenceIdentifier:(id)a0 channelIdentifier:(id)a1 channelToken:(id)a2 peerKey:(id)a3 serverKey:(id)a4 membershipKey:(id)a5 creationDate:(id)a6 isPersonal:(BOOL)a7 databaseContext:(id)a8;
