...
- (void)_prepareWithTriggeringItems:(id)a0 triggeringVisits:(id)a1;
- (id)_extraVisitsToDeleteWhenDeletingItems:(id)a0 visits:(id)a1;
- (id)_extraVisitsToDeleteWhenDeletingItems:(id)a0 visits:(id)a1 relatedVisitKey:(id)a2 relatedVisitsQueryFactory:(id /* block */)a3;
