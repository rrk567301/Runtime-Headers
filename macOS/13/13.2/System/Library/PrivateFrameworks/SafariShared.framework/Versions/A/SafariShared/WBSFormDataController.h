...
- (id)exactFQDNAndHighLevelDomainSavedAccountMatchesForForm:(id)a0 atURL:(id)a1 webFrameIdentifier:(id)a2;
...
- (id)lastUsedUsernameWithPasswordForURL:(id)a0;
- (id)_knownUsernamesWithPasswordsForURL:(id)a0;
...
- (void)savedAccountMatchesWithCriteria:(id)a0 completionHandler:(id /* block */)a1;
