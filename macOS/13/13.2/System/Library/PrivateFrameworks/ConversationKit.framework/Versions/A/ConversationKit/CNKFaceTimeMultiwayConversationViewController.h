...
@interface CNKFaceTimeMultiwayConversationViewController : ConversationKit.PlatformViewController <CNKFaceTimeInCallControlsViewControllerDelegate, CNKAudioRoutingDelegate, CNKFaceTimePiPSourceProviding> {
    ...
    void /* unknown type, empty encoding */ isCaptioningEnabled;
