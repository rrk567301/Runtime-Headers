@class NSMutableSet, NSString, CWFAutoJoinRequest, NSError, NSSet, NSMutableDictionary, CWFAutoJoinMetric, NSObject, NSMutableArray, CLLocation, CWFAutoJoinStatistics, CWFScanResult;
...
- (BOOL)__allowKnownNetwork:(id)a0 trigger:(long long)a1 allowForSeamlessSSIDTransition:(id)a2 error:(id *)a3;
...
- (BOOL)__calloutToAllowKnownNetwork:(id)a0 trigger:(long long)a1 allowForSeamlessSSIDTransition:(id)a2 error:(id *)a3;
