...
@interface USKData : NSObject {
    struct VtValue { struct type { unsigned char __lx[8]; } _storage; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *_ptrAndBits; } _info; } _value;
    USKNode *_nodeOwner;
...
- (struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })value;
- (id)resourcePath;
- (void)setValue:(struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })a0;
...
- (id)tokenArray;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })a0 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep *x0; } x0; })a1;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })a0 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep *x0; } x0; })a1 withNodeOwner:(id)a2;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })a0 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep *x0; } x0; })a1 withSceneOwner:(id)a2;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x0[8]; } x0; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo *x0; } x1; })a0 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep *x0; } x0; })a1 withPropertyOwner:(id)a2;
