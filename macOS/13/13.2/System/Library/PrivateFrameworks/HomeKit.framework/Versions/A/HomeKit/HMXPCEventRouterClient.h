...
- (id)initWithMessageTargetUUID:(id)a0 queue:(id)a1 messageDispatcher:(id)a2 changeRegistrationsMessageName:(id)a3 updateMessageName:(id)a4 notificationCenter:(id)a5 eventRouterClientFactory:(id /* block */)a6;
