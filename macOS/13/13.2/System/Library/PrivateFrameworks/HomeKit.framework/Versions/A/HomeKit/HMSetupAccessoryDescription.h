@class NSUUID, NSString, NSURL, HMAccessory, NSData, HMSetupAccessoryPayload, HMAccessoryOwnershipToken, NSError, NSArray, HMAccessoryCategory, HMMatterTopology;
...
@property (retain, nonatomic) HMMatterTopology *topology;
...
@property (readonly, nonatomic, getter=isSetupInitiatedByOtherMatterEcosystem) BOOL setupInitiatedByOtherMatterEcosystem;
@property (readonly, copy, nonatomic) NSString *matterEcosystemName;
