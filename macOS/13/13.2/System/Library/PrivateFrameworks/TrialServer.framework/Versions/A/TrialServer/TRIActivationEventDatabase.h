...
- (struct { unsigned long long x0; })addRecordWithParentId:(id)a0 factorPackSetId:(id)a1 deploymentId:(int)a2 osBuild:(id)a3 languageCode:(id)a4 regionCode:(id)a5 carrierBundleId:(id)a6 carrierCountryCode:(id)a7 transaction:(id)a8;
