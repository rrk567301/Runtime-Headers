@class NSData, AKAuthorizationRequest, NSString, NSArray, ASGlobalFrameIdentifier, ASCPublicKeyCredentialAssertionOptions, NSNumber, ASCPublicKeyCredentialCreationOptions;
