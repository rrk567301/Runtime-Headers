@class PXTilingScrollInfo, NSString, NSView, NSHashTable, NSObject;
@protocol PXAnonymousScrollView, PXAnonymousCoordinateSpace, PXTilingScrollControllerUpdateDelegate;
