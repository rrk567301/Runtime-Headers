@class PXPhotosGridFooterStatusController, PXMediaProvider, PXUpdater, PXAssetsDataSourceCountsController, PXExtendedTraitCollection, NSString, PXPhotosViewInteraction, NSUndoManager, UXView, PXPhotosLayout, PXGView, PXPhotosGridFooterPresentation, PXAssetReference, PXPhotosViewModel;
@protocol PXPhotosContentControllerDelegate, PXPhotosViewEventTracker, PXGAXResponder;

@interface PXPhotosContentController : NSObject <PXPhotosSectionHeaderLayoutViewProvider, PXScrollViewControllerObserver, PXPhotosGridFooterStatusControllerDelegate, PXPhotosGridFooterPresentationDelegate, PXPhotosLayoutDelegate, PXPhotosViewInteractionDelegate, PXChangeObserver, PXGAXResponder, PXSectionedDirectionSelectionDelegate>
