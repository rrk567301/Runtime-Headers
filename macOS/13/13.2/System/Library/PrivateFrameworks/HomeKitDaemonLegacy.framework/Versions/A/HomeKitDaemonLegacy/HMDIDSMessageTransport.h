...
@property (readonly, nonatomic, getter=isModernTransport) BOOL modernTransport;
...
- (id)initModernTransportWithAccountRegistry:(id)a0;
- (id)initModernTransportWithAccountRegistry:(id)a0 service:(id)a1 appleAccountManager:(id)a2 remoteAccountManager:(id)a3;
