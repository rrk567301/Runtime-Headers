...
- (void).cxx_destruct;
- (id)initWithGarageDoorStatus:(id)a0 accessoryUUID:(id)a1 characteristicUUID:(id)a2 timeStamp:(id)a3 homeUUID:(id)a4 homePresence:(id)a5 triggerSource:(id)a6 bundleId:(id)a7 userUUID:(id)a8;
