@class HMDTimeBasedFlagsManager, HMDLogEventErrorEventsAnalyzer, HMDMetricsDeviceStateManager, HMDLogEventProcessMemoryEventsAnalyzer, NSMutableArray, HMDLogEventMessageEventsAnalyzer, HMDLogEventAccessoryFirmwareUpdateEventAnalyzer, HMDCloudSyncLogEventsAnalyzer, HMDMessageDispatcher, HMDHomeManager, NSString, HMDLogEventReachabilityEventsAnalyzer, HMDConfigurationLogEvent, HMDPowerLogObserver, HMDDiagnosticReporterLogObserver, NSArray, HMDCoreAnalyticsLogObserver, HMDLogEventDailyScheduler, NSObject, HMDLogEventElectionEventsAnalyzer, HMDLogEventProcessLaunchAnalyzer, HMDHouseholdMetricsManager, HMDLogEventUserActivityAnalyzer, HMDEventCountersManager, HMDHH2AutoMigrationEligibilityLogEventSubmitter, HMFProductInfo, HMDLogEventBulletinNotificationsAnalyzer, HMDLogEventHAPMetricsEventAnalyzer, NSUUID;
...
@property (readonly, nonatomic) HMFProductInfo *currentDeviceProductInfo;
...
- (id)initWithMessageDispatcher:(id)a0 logEventDispatcher:(id)a1 dailyScheduler:(id)a2 countersManager:(id)a3 flagsManager:(id)a4 ewsLogger:(id)a5 deviceStateManager:(id)a6 hh2AutoMigrationEligibilitySubmitter:(id)a7;
