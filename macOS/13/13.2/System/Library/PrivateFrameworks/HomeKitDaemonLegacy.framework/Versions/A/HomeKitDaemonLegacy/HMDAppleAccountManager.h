@class NSUUID, HMDAccount, NSObject, HMFExponentialBackoffTimer, HMDAppleAccountContext, HMDAppleAccountSettings, HMDDevice, HMDBackingStore, HMDIDSActivityMonitorBroadcaster, NSString, HMDCloudCache, NSData, ACAccountStore, HMFTimer, NSNotificationCenter;
