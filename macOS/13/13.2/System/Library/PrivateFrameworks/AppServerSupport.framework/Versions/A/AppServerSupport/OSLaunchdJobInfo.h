@class NSObject, OSLaunchdJobExitStatus;
...
- (id)description;
- (void).cxx_destruct;
- (id)initWithState:(long long)a0 pid:(int)a1 lastSpawnError:(int)a2 lastExitStatus:(id)a3 additionalPropertiesDict:(id)a4 removing:(BOOL)a5;
