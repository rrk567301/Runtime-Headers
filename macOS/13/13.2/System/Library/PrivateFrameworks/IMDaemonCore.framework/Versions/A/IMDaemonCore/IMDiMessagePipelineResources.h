@class IMDMessageStore, IMDMessageFromStorageController, IMDRecentsController, IDSService, IMDAttachmentStore, IMDMessageSuppressionController, IMDChatRegistry, IMDAccount;
...
- (void).cxx_destruct;
- (id)initWithIMDAccount:(id)a0 service:(id)a1 messageStore:(id)a2 storageController:(id)a3 broadcaster:(id)a4 messageSuppressionController:(id)a5 recentsController:(id)a6 chatRegistry:(id)a7 attachmentStore:(id)a8;
