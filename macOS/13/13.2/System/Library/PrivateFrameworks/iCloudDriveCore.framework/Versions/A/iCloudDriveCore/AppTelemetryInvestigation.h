@class AppTelemetryFPFSMigrationInvestigation, NSString, AppTelemetryCiconiaInvestigation, NSData, AppTelemetryQBSInvestigation, AppTelemetryQBSPerformance, AppTelemetryCiconiaBouncesInvestigation;
