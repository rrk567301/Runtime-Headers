@class BRCGenerationID, NSString, BRCAccountSession, NSData, BRCItemGlobalID, NSURL, BRCAppLibrary;
...
@interface BRCImportObject : NSObject {
    ...
    struct timespec { long long tv_sec; long long tv_nsec; } _atime;
    unsigned int _flags;
...
- (id)initAsNewDirectoryWithLogicalName:(id)a0 parentItem:(id)a1 error:(id *)a2;
