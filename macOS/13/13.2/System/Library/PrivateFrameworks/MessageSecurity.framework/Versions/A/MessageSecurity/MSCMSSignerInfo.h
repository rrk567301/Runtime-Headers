...
@property struct heim_base_data { unsigned long long length; void *data; } signedAttrsSet;
@property (retain) NSData *unsignedAttrsData;
@property struct heim_base_data { unsigned long long length; void *data; } unsignedAttrsSet;
