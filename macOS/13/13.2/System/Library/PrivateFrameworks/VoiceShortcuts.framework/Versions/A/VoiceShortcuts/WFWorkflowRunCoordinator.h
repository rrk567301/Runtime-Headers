@class NSHashTable, WFDialogPresentationManager, WFUserNotificationManager, NSString, WFLSApplicationStateObserver, WFUIPresenter, NSMutableDictionary, WFApplicationTerminationMonitor, NSMutableSet, NSObject, WFRunnerPrewarmManager, WFWorkflowRunQueue;
