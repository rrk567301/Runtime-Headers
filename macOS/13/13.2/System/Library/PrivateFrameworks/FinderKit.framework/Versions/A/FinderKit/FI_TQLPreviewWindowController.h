...
@interface FI_TQLPreviewWindowController : NSObject <QLPreviewPanelDataSource, QLPreviewPanelDelegate, FIAliasResolution, TCoalescingNodeObserverProtocol> {
    ...
    struct TNSWeakPtr<NSObject<TQLPreviewWindowControllerProtocol>> { NSValue *fWeakObject; } _weakActiveViewController;
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper> { NSValue *fWeakObject; } _tearDownToken;
}
