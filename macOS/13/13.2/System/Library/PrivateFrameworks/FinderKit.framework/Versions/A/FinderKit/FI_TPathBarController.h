...
@interface FI_TPathBarController : FI_TViewController <FI_TPathSelectDelegate, TPathControlDelegate, TNodeObserverProtocol, NSMenuDelegate, TMarkTornDown> {
    ...
    struct TNSWeakPtr<NSObject<FI_TPathBarContainerDelegate>> { NSValue *fWeakObject; } _containerDelegate;
    ...
    struct TNSWeakPtr<FI_TRunAfterHelper> { NSValue *fWeakObject; } _refreshToken;
