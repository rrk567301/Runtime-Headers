...
- (struct IconSpatialData { int x0; int x1; int x2; short x3; })spatialDataFromNodePropertyList:(const struct TFENodePropertyList { struct OpaquePropertyListRef *x0; } *)a0;
- (void)setSpatialData:(const struct IconSpatialData { int x0; int x1; int x2; short x3; } *)a0 inNodePropertyList:(struct TFENodePropertyList { struct OpaquePropertyListRef *x0; } *)a1;
- (void)setSpatialDataOnNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 fromNodePropertyList:(const struct TFENodePropertyList { struct OpaquePropertyListRef *x0; } *)a1;
