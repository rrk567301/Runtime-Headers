...
@interface RemindersUICore.TTRReminderCopyPasteItem : NSObject <NSSecureCoding, NSPasteboardWriting, NSPasteboardReading, NSItemProviderWriting, NSItemProviderReading> {
