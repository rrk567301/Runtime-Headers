@class NSString, MPPropertySet, MPMutableSectionedCollection, NSMutableDictionary, MPCModelStorePlaybackItemsRequest, MPSectionedCollection, MPServerObjectDatabase, NSMutableArray, NSMutableOrderedSet, ICURLAggregatedPerformanceMetrics;
...
- (struct MPCModelStorePlaybackItemsRequestAccumulatorResult { BOOL x0; BOOL x1; BOOL x2; })handleResponse:(id)a0 error:(id)a1;
