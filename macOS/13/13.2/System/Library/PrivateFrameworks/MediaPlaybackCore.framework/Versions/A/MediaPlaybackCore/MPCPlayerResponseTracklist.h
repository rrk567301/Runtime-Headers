@class NSNumber, NSString, MPCPlayerResponseItem, MPCPlayerResponse, MPSectionedCollection, NSIndexPath;
...
@property (readonly, nonatomic) BOOL vocalControlEnabled;
@property (readonly, nonatomic) NSNumber *vocalControlLevel;
@property (readonly, nonatomic, getter=isVocalsControlActive) BOOL vocalsControlActive;
@property (readonly, nonatomic) float vocalsLevel;
@property (readonly, nonatomic) float minVocalsLevel;
@property (readonly, nonatomic) float maxVocalsLevel;
