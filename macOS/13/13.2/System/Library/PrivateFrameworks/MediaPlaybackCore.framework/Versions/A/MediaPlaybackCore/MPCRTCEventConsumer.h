@class NSString, MPCPlaybackEngineEvent, RTCReporting, NSObject;
...
- (void)_generateConfiguredReportingSessionWithToken:(id)a0 samplingUUID:(id)a1 serviceName:(id)a2 completion:(id /* block */)a3;
- (id)_rtcSessionInfoWithToken:(id)a0 samplingUUID:(id)a1;
...
- (void)_sendOneMessageWithToken:(id)a0 serviceName:(id)a1 category:(long long)a2 type:(long long)a3 payload:(id)a4;
