@class NSXPCListenerEndpoint, MPAVRoutingController, MPCPlaybackIntent, _MPCMediaRemotePublisher, MPCPlayerPath, NSString, _MPCReportingController, MPAVRoute, MPCAudioSpectrumAnalyzer, _MPCMusicPlayerControllerServer, _MPCLeaseManager, MPCWhiskyController, _MPCPlaybackEngineSessionManager, MPProtocolProxy, MPCPlaybackEngineEventStream;
...
@interface MPCPlaybackEngine : NSObject <MPCExplicitContentAuthorizationDelegate, MPAVRoutingControllerDelegate>
