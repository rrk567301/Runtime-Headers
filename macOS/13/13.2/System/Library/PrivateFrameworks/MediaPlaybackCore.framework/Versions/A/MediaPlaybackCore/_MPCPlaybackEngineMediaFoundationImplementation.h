@class MPCPlayPerfAnalytics, MPCItemBookmarker, NSNumber, MPCQueueController, NSDictionary, MPCAVItemTrace, MPCLeaseController, MPCExternalPlaybackControllerImplementation, NSString, MPAVItem, MPCPlaybackEngine, AVPlayerViewController, MPCPlayerItemConfigurator, MPCErrorControllerImplementation, _MPCAudioSessionController, MPCMediaFoundationTranslator;
@protocol MFQueueManagement, MPCPlaybackEngineEventStreamDeferralAssertion, MFAssetLoading, MFPlaybackStackController;

@interface _MPCPlaybackEngineMediaFoundationImplementation : NSObject <MFPlaybackStackControllerDelegate, MPCQueueControllerDelegate, MPCAssetLoaderDelegate, MPCPlaybackEngineImplementation>
...
@property (retain, nonatomic) MPCPlayPerfAnalytics *playPerfAnalytics;
...
- (void)reloadQueueForReason:(long long)a0 completion:(id /* block */)a1;
