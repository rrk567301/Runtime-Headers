@class AVPixelBufferAttributeMediator, NSMutableDictionary, NSObject, NSDictionary, AVPlayerMediaSelectionCriteria, AVOutputContext, NSMutableArray, NSString, AVPlayerItem, AVPlayerPlaybackCoordinator, AVQueuePlayer, NSMutableSet, NSHashTable, NSArray, AVWeakReference, NSError, AVPlayerRateState;
