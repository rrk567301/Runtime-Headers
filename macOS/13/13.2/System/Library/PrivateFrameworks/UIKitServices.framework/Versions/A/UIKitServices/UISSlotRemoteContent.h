...
- (id)newTouchAuthenticationSpecificationWithAuthenticationMessageContext:(unsigned long long)a0 hitTestInformationMask:(unsigned long long)a1 secureName:(unsigned int)a2;
