@class NSXPCConnection, NSString, NSXPCListenerEndpoint, MRAVDistantExternalDeviceMetadata, MRAVDistantEndpoint, MRExternalOutputContextDataSource, NSDate, NSArray, NSObject, MROrigin, NSNumber;
...
@property (readonly, nonatomic) MRAVDistantEndpoint *distantEndpoint;
