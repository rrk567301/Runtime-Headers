@class NSTimer, NSString, MRExternalDevice, MRAVOutputDevice, NSArray, MROutputContextDataSource, NSDictionary, _MRAVEndpointDescriptorProtobuf, NSMutableArray, MROrigin;
