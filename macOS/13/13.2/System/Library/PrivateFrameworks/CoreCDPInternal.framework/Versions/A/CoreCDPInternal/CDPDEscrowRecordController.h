...
- (void)generateEscrowRecordStatusReportUsingCache:(BOOL)a0 withCompletion:(id /* block */)a1;
- (void)generateEscrowRecordStatusReportUsingFetchSource:(long long)a0 withCompletion:(id /* block */)a1;
...
- (void)_beginSilentEscrowRecordRepairWithCompletion:(id /* block */)a0;
- (void)_continueSilentEscrowRecordRepairWithCompletion:(id /* block */)a0;
...
- (id)_reporterWithContext:(unsigned long long)a0 state:(unsigned long long)a1 usingCache:(BOOL)a2 error:(id)a3;
