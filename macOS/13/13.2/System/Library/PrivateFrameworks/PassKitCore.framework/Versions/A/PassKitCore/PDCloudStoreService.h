@class NSString, PDCloudStoreTransactionSourceController, PKEntitlementWhitelist, PDCloudStoreNotificationCoordinator;
...
@property (retain, nonatomic) PDCloudStoreTransactionSourceController *transactionSourceController;
