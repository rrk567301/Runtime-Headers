...
@property (nonatomic) unsigned long long selectedMethod;

- (void)encodeWithCoder:(id)a0;
- (id)initWithCoder:(id)a0;
- (void).cxx_destruct;
- (id)initWithBankAccountInformation:(id)a0 peerPaymentBalance:(id)a1 deviceSupportsPeerPaymentAccountPayment:(BOOL)a2 selectedMethod:(unsigned long long)a3;
