@class NSString, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NSMutableArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList;
