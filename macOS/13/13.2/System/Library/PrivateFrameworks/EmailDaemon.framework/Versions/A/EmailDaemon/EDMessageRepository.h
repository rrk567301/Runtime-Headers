...
@property (retain, nonatomic) NSMutableDictionary *filteredMailboxScopedQueryHandlers;
...
- (void)_enumerateObjectIDsAndQueryHandlersForObjectIDsByScope:(id)a0 withTargetClass:(Class)a1 usingBlock:(id /* block */)a2 failureBlock:(id /* block */)a3;
- (void)_enumerateThreadObjectIDsByScope:(id)a0 usingBlock:(id /* block */)a1;
