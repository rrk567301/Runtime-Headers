...
+ (id)contentsWithStep:(id)a0 destination:(id)a1 options:(struct { long long x0; double x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; int x6; int x7; } *)a2 isSecondary:(BOOL)a3;
