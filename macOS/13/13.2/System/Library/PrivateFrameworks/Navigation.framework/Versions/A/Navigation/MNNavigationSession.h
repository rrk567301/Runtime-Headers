@class GEONavigationGuidanceState, MNNavigationSessionLogger, GEOMotionContext, MNTrafficIncidentAlert, NSString, MNNavigationSessionState, GEOComposedWaypoint, GEOProbeCrumbs, MNObserverHashTable, MNRouteManager, MNTimeAndDistanceUpdater, MNNavigationTraceManager, MNVehicleMonitor, MNLocationTracker, MNGuidanceManager, GEOApplicationAuditToken, MNTraceNavigationEventRecorder, GEOResourceManifestUpdateAssertion, MNAudioManager, MNServerSessionStateInfo, MNTraceNavigationUpdateRecorder, MNLocation;
...
- (void)_startLocationTrackingWithInitialLocation:(id)a0;
