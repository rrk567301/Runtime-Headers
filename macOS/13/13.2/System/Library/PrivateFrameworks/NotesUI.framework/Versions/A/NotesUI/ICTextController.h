@class ICNote, NSMutableDictionary, ICAuthorHighlightsController, ICAttachmentInsertionController, NSTextStorage, ICMentionsController, NSMutableArray, ICHashtagController;
