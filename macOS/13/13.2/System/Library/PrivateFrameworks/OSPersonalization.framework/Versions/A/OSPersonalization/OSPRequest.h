@class NSUUID, NSString, NSURL, NSArray, NSData, NSSet, NSDictionary, OSPDevice, OSPVolume, OSPSecureBootBundle, OSPBuildIdentity;
...
@property BOOL skipPersonalizationForTesting;
@property long long fakePersonalizationErrorCode;
@property BOOL useDummyDeviceIdentity;
@property (retain) NSURL *signedPRDocumentPublicKeyURL;
...
@property BOOL automaticallyDetectSplat;
@property BOOL requestSplatTicket;
@property BOOL requestSplatTicketOnly;
...
- (BOOL)_parsePRDocument:(id)a0 enforceSignature:(BOOL)a1;
