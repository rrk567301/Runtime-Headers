@class CSOtherAppRecordingStateMonitor, CSKeywordAnalyzerNDEAPIResult, NSObject, CSKeywordAnalyzerNDEAPI, CSSpeechManager, NSMutableArray, CSVoiceTriggerSecondChanceContext, CSAudioStream, CSVoiceTriggerSecondPass, NSString, CSVoiceTriggerRTModel, CSAudioProvider, CSVoiceTriggerFirstPassMetrics, CSSPGEndpointAnalyzer, CSPlainAudioFileWriter, CSAsset, CSAudioStreamHolding;
