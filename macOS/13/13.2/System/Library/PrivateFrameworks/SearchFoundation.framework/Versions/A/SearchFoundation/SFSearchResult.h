@class NSURL, SFActionItem, NSDictionary, SFCard, SFCustom, SFTopic, SFPunchout, NSString, SFImage, NSArray, NSData, SFText, SFMoreResults, NSNumber;
...
- (void).cxx_destruct;
- (BOOL)compareWithResult:(id)a0 logger:(id /* block */)a1;
- (void)updatePunchout;
