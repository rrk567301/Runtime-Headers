...
- (BOOL)shouldUpdateCodecBitrate:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (BOOL)shouldUpdateCodecBandwidth:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (BOOL)isCodecModeChangeRequestValid:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (void)handleCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0 didUpdateBandwidth:(BOOL *)a1 didUpdateBitrate:(BOOL *)a2;
- (BOOL)sendCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
...
- (int)sendSframeEncryptedAudioPacket:(struct tagAudioPacketData { struct tagAudioHeaderData { int x0; unsigned int x1; unsigned char x2[16]; unsigned char x3; float x4; int x5; int x6; int x7; unsigned char x8; } x0; char *x1; int x2; })a0;
...
- (void)audioIssueDetectorProcessFrame:(struct opaqueVCAudioBufferList { } *)a0 payloadType:(int)a1 length:(unsigned short)a2 bitRate:(unsigned short)a3;
