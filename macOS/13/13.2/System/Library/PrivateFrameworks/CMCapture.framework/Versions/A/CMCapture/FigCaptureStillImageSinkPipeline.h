@class BWFigVideoCaptureDevice, NSArray, NSString, BWCompressedShotBufferNode, BWStillImageSampleBufferSinkNode, BWSISNode, BWStillImageCoordinatorNode, BWPortraitHDRStagingNode, BWDepthConverterNode, BWStillImageBravoDisparityNode;
