...
- (id)initWithUnderlyingFormat:(id)a0 isDeviceOriented:(BOOL)a1 videoContentMode:(long long)a2 includesInvalidContent:(BOOL)a3 cropDescriptor:(id)a4 rotationDegrees:(int)a5;
