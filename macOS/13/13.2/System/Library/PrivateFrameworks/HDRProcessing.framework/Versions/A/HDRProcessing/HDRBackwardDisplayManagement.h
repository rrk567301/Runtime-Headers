...
- (void)fillInverseScalingFactorTableFromDMConfig:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; int x22; } *)a0;
- (void)fillScalingTable_SDR2HDR:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; int x22; } *)a0 target_White:(float)a1 target_Black:(float)a2;
- (void)fillScalingTable_YUVTM:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; int x22; } *)a0 targetwhite:(float)a1 targetblack:(float)a2 satBoost:(float)a3 scalingFactor:(BOOL)a4 sdrOnly:(BOOL)a5;
- (void)createBuffers;
...
- (BOOL)updateConfigFromMetadata:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; int x22; } *)a0 uiScaleFactor:(float)a1 width:(int)a2 background:(struct { double x0; double x1; double x2; double x3; } *)a3 hdrVideoOnly:(BOOL)a4 hdr10TV:(BOOL)a5 sdrOnly:(BOOL)a6;
...
- (void)attatchInfoFrame:(struct { float x0; float x1; float x2; float x3; float x4[9]; float x5[9]; float x6[9]; float x7[9]; float x8[9]; float x9[3]; float x10[3]; float x11; unsigned int x12; unsigned int x13; unsigned int x14; float x15; unsigned int x16; float x17; struct { unsigned short x0; unsigned short x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned short x6; unsigned short x7; unsigned int x8; unsigned int x9; } x18; struct { unsigned short x0; unsigned short x1; } x19; unsigned int x20; unsigned char x21 : 1; int x22; } *)a0 toOutputSurface:(struct __IOSurface { } *)a1;
