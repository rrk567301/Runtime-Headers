@class WBSSafariExtensionStateObserver, NSString, NSURL, WBSWebExtensionData, NSMutableDictionary, WBSWebExtensionsController, NSImage, NSMutableSet, WKWebView;
