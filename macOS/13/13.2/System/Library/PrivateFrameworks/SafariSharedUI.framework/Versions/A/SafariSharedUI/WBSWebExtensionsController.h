@class NSHashTable, NSString, WBSCoreAnalyticsExtensionsStatistics, _WKRemoteObjectInterface, NSDictionary, NSMutableDictionary, WBSDispatchSourceTimer, NSMapTable;
@protocol WBSWebExtensionsControllerDelegate, WBSWebExtensionWindow;

@interface WBSWebExtensionsController : WBSExtensionsController <WBSCloudExtensionStateProvider> {
