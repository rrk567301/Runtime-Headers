@class FCSubscriptionController, FCLocalAreasManager, FCFeedManager, FCNotificationController, FCUserEventHistory, FCReadingHistory, FCArticleController, FCTranslationManager, NSString, FCNetworkBehaviorMonitor, FCReadingList, FCUserVectorManager, FCIssueReadingHistory, FCTagSettings, FCFlintResourceManager, FCAssetManager, FCAccessChecker, FCAudioPlaylist, FCTagController, FCEntitlementService, FCNotificationsEndpointConnection, FCPrivateChannelMembershipController, FCShortcutList, FCPersonalizationData, FCSubscriptionList, FCUserInfo, FCClientEndpointConnection, FCCommandQueue, NSURL, FCPurchaseController, FCNewsletterEndpointConnection;
@protocol FCLocalRegionManager, FCCurrentIssuesChecker, FCPPTContext, FCAVAssetFactoryType, FCContentContextInternal, FCPersonalizedGrouping, FCFavoritesPersonalizer, FCFeedPersonalizing, FCWebURLResolutionEndpointConnection, FCFeedDatabaseProtocol, FCOfflineArticleManagerType, FCBundleSubscriptionManagerType, FCPrivateDataContextInternal, FCContentContext, FCPurchaseManagerType, FCCoreConfigurationManager, FCNewsletterManager, FCBackgroundTaskable, FCNewsAppConfigurationManager, FCIssueArticleInventoryType, FCAVAssetPrewarming, FCPurchaseProviderType, FCAppActivityMonitor, FCPaidAccessCheckerType, FCPrivateDataContext, FCPushNotificationHandling;
...
@property (retain, nonatomic) id<FCFavoritesPersonalizer> favoritesPersonalizer;
@property (retain, nonatomic) id<FCPersonalizedGrouping> groupingPersonalizer;
...
@property (readonly, nonatomic) id<FCIssueArticleInventoryType> issueArticleInventory;
