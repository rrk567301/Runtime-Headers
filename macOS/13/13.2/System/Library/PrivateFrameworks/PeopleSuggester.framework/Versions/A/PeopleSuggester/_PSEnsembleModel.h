@class NSDictionary, _PSSharingContactRankerModel, PPTopicStore, NSString, _PSRuleMiningModel, PPContactStore, _PSFeatureCache, NSArray, _PSConfidenceModelForSharing, NSUserDefaults, NSSet, _PSFTZKWTrialData, _CDInteractionCache, _PSFTZKWOrchestrator, _PSContactResolver, _PSKNNModel, _PSHeuristics, _CDInteractionStore, CNContactStore, _PSInteractionAndContactMonitor, NSNumber;
...
- (void)setPhotoAnalysisFromAssetsWithPredictionContext:(id)a0 identifersOfPeopleInPhotos:(id)a1;
