@class DULanguageTaggingResponseObjC, DUDebugInfoObjC, DUTopicDetectionResponseObjC, DUProductClassificationResponseObjC, _TtC21DocumentUnderstanding10DUResponse, DUStructuredEntityResponseObjC;
