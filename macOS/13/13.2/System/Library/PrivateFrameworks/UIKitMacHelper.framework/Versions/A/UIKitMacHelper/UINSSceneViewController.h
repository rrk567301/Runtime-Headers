...
- (BOOL)sceneWindowSizeRequested:(struct CGSize { double x0; double x1; } *)a0;
- (BOOL)sceneWindowOriginRequested:(struct CGPoint { double x0; double x1; } *)a0;
...
- (void)_sceneCurSize:(struct CGSize { double x0; double x1; } *)a0 minSize:(struct CGSize { double x0; double x1; } *)a1 maxSize:(struct CGSize { double x0; double x1; } *)a2 maxScreenSize:(struct CGSize { double x0; double x1; } *)a3 allowsFullScreen:(BOOL *)a4;
