@class CHIPPluginAccessoryReachabilityManager, NSNumber, NSUUID, NSFileHandle, CHIPPluginOTAApplyUpdateTimer, MTRDevice, HAPAccessory, CHIPPluginOTAAnnounceTimer, CHIPPluginHAPEnumerator, NSString, CHIPAccessoryServerBrowser, CHIPPluginPairing, MTRDeviceController, NSOperationQueue, CHIPPluginStorage, NSArray, NSData, NSError, HMFTimer;
...
@property (readonly, nonatomic) CHIPPluginHAPEnumerator *hapEnumerator;
...
@property (retain, nonatomic) CHIPPluginOTAAnnounceTimer *otaAnnounceTimer;
