...
@property (readonly, nonatomic) CHIPAccessoryServer *chipAccessoryServer;
...
@property (retain, nonatomic) HMDAccessoryMetricCurrentSession *sessionMetric;
...
- (void)accessory:(id)a0 didUpdateConnectionState:(BOOL)a1 withError:(id)a2;
