@class NSHashTable, HMFTimer, HMDMediaBrowser, HMDHAP2Storage, NSMutableArray, NSMutableSet, HMDHomeManager, NSString, HMDAccessoryServerBrowserDemo, NSArray, HMDAuthServer, HMFMessageDispatcher, HMDUnassociatedMediaAccessory, HMDUnassociatedWACAccessory, CHIPAccessoryServerBrowser, NSObject, NSData, HMDWACBrowser, NSUUID, HAPAccessoryServerBrowserBTLE, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP;
