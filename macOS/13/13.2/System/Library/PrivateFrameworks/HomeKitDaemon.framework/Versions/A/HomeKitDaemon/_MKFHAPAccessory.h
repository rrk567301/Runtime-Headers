...
- (id)cameraSignificantEventBulletinRegistrationWithDeviceIdsIdentifier:(id)a0 context:(id)a1;
- (id)cameraAccessModeBulletinRegistrationWithDeviceIdsIdentifier:(id)a0 context:(id)a1;
- (id)cameraReachabilityBulletinRegistrationWithDeviceIdsIdentifier:(id)a0 context:(id)a1;
...
- (id)predicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)a0;
