@class NSMutableDictionary, WiFiUsageInterfaceStats, NSDate, WiFiUsageBssSession, NSObject, WiFiUsageNetworkIPv4Details, NSMutableArray, NSString, WiFiUsageNetworkDetails, WiFiUsageNetworkIPv6Details, NSMutableSet, NSNumber, WiFiUsageSessionLQM;
...
- (void)summarizeStashAndReset6eModeStats:(id)a0;
