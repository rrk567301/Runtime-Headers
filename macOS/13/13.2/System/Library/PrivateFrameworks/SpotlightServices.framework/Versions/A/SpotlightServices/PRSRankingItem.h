...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isMetadataResult:(BOOL)a4;
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3;
...
- (id)initWithAttrs:(struct { long long x0; unsigned long long x1[4]; unsigned long long x2[4]; unsigned long long x3[4]; void *x4[0]; } *)a0 bundleID:(id)a1 groupName:(id)a2 isAppleExternalApp:(BOOL)a3 isMetadataResult:(BOOL)a4 isServerAlternativeResult:(BOOL)a5;
