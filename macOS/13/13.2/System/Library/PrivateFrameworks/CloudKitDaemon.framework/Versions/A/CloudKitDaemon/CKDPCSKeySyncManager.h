...
- (void)getKeySyncEligibilityForService:(id)a0 isManatee:(BOOL)a1 account:(id)a2 zonePCSModificationDate:(id)a3 testOverrideProvider:(id)a4 completionHandler:(id /* block */)a5;
