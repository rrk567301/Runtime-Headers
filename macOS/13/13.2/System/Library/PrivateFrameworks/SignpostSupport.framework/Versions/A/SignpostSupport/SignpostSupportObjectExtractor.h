@class NSUUID, SignpostSupportObjectFilter, SignpostSupportUniquePIDFilter, SignpostSupportPIDFilter, SignpostSupportExactProcessNameFilter, OSLogEventLiveStream, SignpostIntervalBuilder, NSObject, SignpostSupportSubsystemCategoryFilter, SignpostSupportAnimationGraceTimeController;
@protocol OS_dispatch_queue, OS_dispatch_semaphore;

@interface SignpostSupportObjectExtractor : NSObject

@property (retain, nonatomic) SignpostSupportSubsystemCategoryFilter *metalSubsystemCategoryFilter;
