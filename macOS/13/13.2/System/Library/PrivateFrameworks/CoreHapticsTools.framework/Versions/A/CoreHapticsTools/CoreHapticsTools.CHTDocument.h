@interface CoreHapticsTools.CHTDocument : NSObject {
    ...
    void /* unknown type, empty encoding */ _hapticParameterCount;
    void /* unknown type, empty encoding */ _hapticParameterCurveCount;
    void /* unknown type, empty encoding */ _audioParameterCount;
    void /* unknown type, empty encoding */ _audioParameterCurveCount;
