@class VUIPlaybackUpNextConfig, VUIDownloadConfig, VUIMediaShowcasingConfig, VUINowPlayingConfig, VUIAutoPlayConfig, VUIContextMenuConfig, VUILiveLinkConfig, VUIUpNextConfig, VUICanonicalConfig, VUIAccountMessageConfig, VUISyndicationConfig, VUIInAppMessagesConfig, VUIDropOnTabConfig, VUIAccountConfig;
