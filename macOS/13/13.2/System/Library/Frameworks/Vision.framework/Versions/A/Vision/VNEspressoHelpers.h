...
+ (BOOL)getWidth:(unsigned long long *)a0 height:(unsigned long long *)a1 ofBlobNamed:(id)a2 forNetworkModelFileWithName:(id)a3 error:(id *)a4;
...
+ (BOOL)createSingleNetworkPlanFromResourceName:(id)a0 usingProcessingDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 memoryPoolId:(unsigned long long)a6 espressoResources:(id *)a7 error:(id *)a8;
+ (BOOL)createSingleNetworkPlanFromResourceName:(id)a0 usingProcessingDevice:(id)a1 lowPriorityMode:(BOOL)a2 inputBlobNames:(id)a3 outputBlobNames:(id)a4 networkConfiguration:(id)a5 explicitNetworkLayersStorageType:(int)a6 memoryPoolId:(unsigned long long)a7 espressoResources:(id *)a8 error:(id *)a9;
