...
- (id)beginAssertionsWithOptions:(id)a0 forProcessWithApplicationIdentifier:(id)a1 delegate:(id)a2 requestStyle:(long long)a3 webFrameIdentifier:(id)a4;
- (id)createNewPlatformCredentialWithOptions:(id)a0 authenticatedContext:(id)a1 delegate:(id)a2 webFrameIdentifier:(id)a3;
...
- (id)beginCreatingNewSecurityKeyCredentialIfAvailableWithOptions:(id)a0 delegate:(id)a1 webFrameIdentifier:(id)a2;
...
- (id)_createCredentialOfKind:(unsigned long long)a0 withOptions:(id)a1 authenticatedLAContext:(id)a2 delegate:(id)a3 webFrameIdentifier:(id)a4;
- (id)_newPanelForOperation:(id)a0;
- (id)_newOperationWithRelyingPartyIdentifier:(id)a0 delegate:(id)a1 sourceApplicationIdentifier:(id)a2 webFrameIdentifier:(id)a3;
