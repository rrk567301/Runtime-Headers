@class NSURL, NSArray, NSHTTPCookieStorage, NSDictionary, NSObject, NSURLCache, NSString, _NSHTTPAlternativeServicesStorage, NSSet, NSNumber, NSURLCredentialStorage, NSData, _NSHSTSStorage;
