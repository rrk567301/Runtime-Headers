...
- (void)_showOverlayWithSourceSubfieldsFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 elementFlags:(unsigned long long)a1 locale:(id)a2 calendar:(id)a3 font:(id)a4 sourceWindow:(id)a5;
...
- (void)_sizeToFitAndArrangeForRTL:(BOOL)a0;
