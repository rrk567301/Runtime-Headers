...
- (void)_setPopulating:(BOOL)a0;
- (void)_setHasBeenSuppressed:(BOOL)a0;
- (void)_setLastPopulateContext:(unsigned int)a0;
- (void)_setMinModifiersCacheTag:(unsigned int)a0;
- (void)_setReceivedMenuPopulate:(BOOL)a0;
- (void)_setReceivedMenuEnableItems:(BOOL)a0;
