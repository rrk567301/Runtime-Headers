...
- (id)initWithHealthStore:(id)a0 schemaProviderIdentifier:(id)a1;
...
- (void)removeReference:(id)a0 completion:(id /* block */)a1;
- (void)addAttachmentWithName:(id)a0 contentType:(id)a1 URL:(id)a2 toObjectWithIdentifier:(id)a3 attachmentMetadata:(id)a4 referenceMetadata:(id)a5 completion:(id /* block */)a6;
- (void)attachmentReferencesForObjectIdentifier:(id)a0 completion:(id /* block */)a1;
