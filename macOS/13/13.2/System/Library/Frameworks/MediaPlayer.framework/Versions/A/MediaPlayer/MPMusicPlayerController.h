@class NSXPCConnection, NSString, MPMusicPlayerControllerNowPlayingTimeSnapshot, NSArray, MPMusicPlayerApplicationController, MPMusicPlayerQueueDescriptor, MPMusicPlayerControllerNowPlaying, MPVolumeController, NSObject, MPMediaItem;
...
- (void)setPrioritizeStartupOverQuality:(BOOL)a0;
