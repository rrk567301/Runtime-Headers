@class NSURL, NSFileHandle, CKAssetDownloadPreauthorization, NSDate, NSDictionary, CKMergeableDeltaID, CKAssetTransferOptions, CKAssetReference, CKAssetCopyInfo, NSString, CKRecord, CKRecordID, CKMediaItemMaker, CKAssetRereferenceInfo, NSNumber, NSData;
