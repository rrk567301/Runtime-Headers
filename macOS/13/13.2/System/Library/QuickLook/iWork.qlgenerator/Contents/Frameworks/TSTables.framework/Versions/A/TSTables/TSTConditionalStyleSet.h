...
@property (readonly, nonatomic) NSMutableArray *currentRules;
...
- (id)copyByRemappingOwnerUIDsWithMap:(const void *)a0 calcEngine:(id)a1 error:(BOOL *)a2;
- (id)copyByRemappingHostCellAgnosticOwnerUIDsWithMap:(const void *)a0 calcEngine:(id)a1 ownerUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a2 error:(BOOL *)a3;
...
- (id)initWithConditionalStyleSet:(id)a0;
- (id)initWithContext:(id)a0 rules:(id)a1;
- (void)iterateFormulasWithContext:(struct TSCEFormulaRewriteContext { id x0; id x1; struct TSCEFormulaRewriteContextRecord { struct TSCEFormulaContainingCell { struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x0; struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; struct TSUColumnRowOffset { int x0; int x1; } x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; } x2; } *)a0 block:(id /* block */)a1;
- (id)copyByReparenting:(id)a0 groupByUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 rewriteContext:(struct TSCEFormulaRewriteContext { id x0; id x1; struct TSCEFormulaRewriteContextRecord { struct TSCEFormulaContainingCell { struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x0; struct TSCECellRef { struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; } x1; BOOL x2; BOOL x3; } x0; struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } x1; struct TSUColumnRowOffset { int x0; int x1; } x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; } x2; } *)a2;
...
- (id)copyToUidFormForTableInfo:(id)a0 inCellCoordinate:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1;
- (id)precedentsWithCalcEngine:(id)a0 hostOwnerUID:(const struct TSKUIDStruct { unsigned long long x0; unsigned long long x1; } *)a1 hostCellID:(const struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } *)a2;
- (id)rulesDescription;
