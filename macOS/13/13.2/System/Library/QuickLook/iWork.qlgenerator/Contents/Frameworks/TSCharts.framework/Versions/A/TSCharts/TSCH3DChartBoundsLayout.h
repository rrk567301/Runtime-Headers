...
- (id)initWithScene:(id)a0 containingViewport:(const void *)a1 originalContainingViewport:(const void *)a2 layoutSettings:(const struct { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; long long x8; unsigned long long x9; } *)a3;
