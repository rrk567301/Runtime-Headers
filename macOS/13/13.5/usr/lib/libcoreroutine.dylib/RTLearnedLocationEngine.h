...
- (void)_trainForReason:(unsigned long long)a0 handler:(id /* block */)a1;
...
- (void)_trainWithFromDate:(id)a0 ToDate:(id)a1 forLastLearnedVisit:(id)a2 reason:(unsigned long long)a3 handler:(id /* block */)a4;
...
- (void)trainForReason:(unsigned long long)a0 handler:(id /* block */)a1;
