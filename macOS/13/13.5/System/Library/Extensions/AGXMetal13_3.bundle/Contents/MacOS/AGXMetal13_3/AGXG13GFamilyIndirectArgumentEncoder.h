@class NSString, AGXG13GFamilyDevice, AGXG13GFamilyBuffer;
@protocol MTLDevice;

@interface AGXG13GFamilyIndirectArgumentEncoder : IOGPUMetalIndirectArgumentEncoder <MTLArgumentEncoder> {
    struct IndirectArgumentEncoder { AGXG13GFamilyDevice *device; struct IndirectArgumentLayout *layout; char *arguments; AGXG13GFamilyBuffer *current_argument_buffer; } _impl;
}
