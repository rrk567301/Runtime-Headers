@class AGXG13XFamilyRenderContext, NSString, NSError, __end_, AGXG13XFamilyComputeContext, NSMutableDictionary, NSDictionary, __end_cap_, AGXG13XFamilyBlitContext;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLCommandQueue;

@interface AGXG13XFamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG13XFamilyBlitContext *_previousBlitCommandEncoder;
    AGXG13XFamilyComputeContext *_previousComputeCommandEncoder;
    AGXG13XFamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG13XFamilyTexture *, std::allocator<AGXG13XFamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG13XFamilyTexture **, std::allocator<AGXG13XFamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
