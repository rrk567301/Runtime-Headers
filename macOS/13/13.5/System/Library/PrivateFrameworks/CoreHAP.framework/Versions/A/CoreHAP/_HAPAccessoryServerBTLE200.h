...
@property (retain, nonatomic) NSMutableSet *discoveredAccessoryCharacteriticsPendingRead;
...
- (void)_readPendingDiscoveredCharacteritiscTypesWithCompletion:(id /* block */)a0;
