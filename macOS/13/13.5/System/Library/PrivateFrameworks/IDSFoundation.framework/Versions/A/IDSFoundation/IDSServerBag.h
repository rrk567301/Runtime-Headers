@class NSURL, NSMutableDictionary, NSDate, NSDictionary, CUTDeferredTaskQueue, IMRemoteURLConnection, NSObject, NSMutableURLRequest, NSString, IMConnectionMonitor, NSArray, NSData, NSNumber;
...
@property (retain) IMRemoteURLConnection *_remoteURLConnection;
