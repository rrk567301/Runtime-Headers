@class NSDate, geo_isolater, GEOMapItemPlaceAttribution, NSDictionary, GEOAppleRating, GEOLabelGeometry, GEOPDFlyover, GEOMapItemContainedPlace, NSMutableArray, GEOMessageLink, GEOAssociatedApp, GEOFeatureStyleAttributes, GEOEnrichmentData, GEOMapRegion, GEOMuninViewState, NSData, GEOEnclosingPlace, GEOPlace, GEOStorefrontPresentationInfo, GEOEnrichmentInfo, GEOMapItemReviewsAttribution, GEOEnhancedPlacement, NSURL, GEOPlacecardLayoutData, GEOViewportFrame, GEOPOIClaim, _GEOMapItemStorageNotificationTrampoline, PBDataReader, GEOMiniBrowseCategories, GEOMapItemClientAttributes, GEOPlaceQuestionnaire, GEOPlaceResult, GEOExploreGuides, NSArray, GEOMapItemStorageUserValues, GEOStyleAttributes, GEOStorefrontInfo, NSString, NSTimeZone, GEOPDResultDetourInfo, GEOMapItemPhotosAttribution, GEOMapItemIdentifier, GEOMapItemDetourInfo, GEORestaurantFeaturesLink, GEOLatLng, PBUnknownFields, GEOBusinessAssets, GEOPDPlace, GEOPriceDescription, GEOAddress;
