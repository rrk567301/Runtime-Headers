...
- (void)setFloat:(float)a0 forKey:(unsigned long long)a1;
- (void)removeAll;
...
- (BOOL)getFloat:(float *)a0 forKey:(unsigned long long)a1;
- (id)initWithFloats:(const float *)a0 forKeys:(const unsigned long long *)a1 count:(unsigned long long)a2;
- (void)removeFloatForKey:(unsigned long long)a0;
