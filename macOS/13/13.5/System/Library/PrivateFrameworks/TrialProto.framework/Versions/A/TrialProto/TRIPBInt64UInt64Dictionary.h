...
- (BOOL)getUInt64:(unsigned long long *)a0 forKey:(long long)a1;
- (id)initWithUInt64s:(const unsigned long long *)a0 forKeys:(const long long *)a1 count:(unsigned long long)a2;
- (void)removeUInt64ForKey:(long long)a0;
...
- (void)setUInt64:(unsigned long long)a0 forKey:(long long)a1;
