...
- (BOOL)getUInt32:(unsigned int *)a0 forKey:(unsigned long long)a1;
- (id)initWithUInt32s:(const unsigned int *)a0 forKeys:(const unsigned long long *)a1 count:(unsigned long long)a2;
- (void)removeUInt32ForKey:(unsigned long long)a0;
...
- (void)setUInt32:(unsigned int)a0 forKey:(unsigned long long)a1;
