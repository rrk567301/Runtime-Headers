...
@interface NTPBScoreProfile : PBCodable <NSCopying> {
    struct { unsigned char agedPersonalizationScore : 1; unsigned char autoSubscribeCtr : 1; unsigned char computedGlobalScoreCoefficient : 1; unsigned char conversionMultiplier : 1; unsigned char dampenedStaticMultiplier : 1; unsigned char diversifiedPersonalizationScore : 1; unsigned char featureCtr : 1; unsigned char firstPassPersonalizationScore : 1; unsigned char paidNonpaidSubscriptionCtr : 1; unsigned char personalizationScore : 1; unsigned char publisherFavorability : 1; unsigned char qualitativeMultiplier : 1; unsigned char rawPersonalizationScore : 1; unsigned char rawUserFeedbackScore : 1; unsigned char staticMultiplier : 1; unsigned char subscribedChannelCtr : 1; unsigned char titleEmbeddingScore : 1; unsigned char userFeedbackScore : 1; } _has;
}
