...
- (void)accessoryServer:(id)a0 didUpdateConnectionState:(BOOL)a1 sessionInfo:(id)a2 withError:(id)a3;
...
- (void)accessoryServer:(id)a0 didUpdateConnectionState:(BOOL)a1 withError:(id)a2;
...
- (void)accessoryServerBrowser:(id)a0 getCommissioningCertificatesForNodeID:(id)a1 fabricIndex:(id)a2 publicKey:(id)a3 completion:(id /* block */)a4;
