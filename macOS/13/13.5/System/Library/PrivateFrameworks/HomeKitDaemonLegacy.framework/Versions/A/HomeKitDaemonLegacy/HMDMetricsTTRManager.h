...
- (void).cxx_destruct;
- (id)initWithDialog:(id)a0 workQueue:(id)a1;
- (id)initWithDialog:(id)a0 workQueue:(id)a1 dataStore:(id)a2 dateFactory:(id /* block */)a3;
- (void)presentRadarDialogForCategory:(id)a0;
