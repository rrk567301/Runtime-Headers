@class NSString, _CDSpotlightCoalescedDeletionManager, _DKPrivacyPolicyEnforcer, _DKRateLimitPolicyEnforcer, NSMutableDictionary, _DKContactsPrivacyMaintainer, _PASBloomFilterForWriting, NSMutableArray, NSObject, _CDUserActivityCache, BMIntentStream;
...
- (id)initWithInteractionRecorder:(id)a0 knowledgeStore:(id)a1 deletionManager:(id)a2;
