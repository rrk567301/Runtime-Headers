...
+ (const void *)_attemptAccountCreationForDirectory:(id)a0 withContext:(id)a1 inPass:(unsigned long long)a2 accountType:(int *)a3 principalUid:(id *)a4 accountIdentifier:(id *)a5 ownerPrincipalUid:(id *)a6 shouldMigrateData:(BOOL *)a7;
+ (const void *)_attemptAccountMigrationForDirectory:(id)a0 withContext:(id)a1 shouldMigrateData:(BOOL *)a2 inPass:(unsigned long long)a3 principalUid:(id *)a4 accountTypeOut:(int *)a5 migrationPrincipal:(id *)a6;
+ (void)_attemptCalendarMigrationForDirectory:(id)a0 withContext:(id)a1 storeForAccount:(const void *)a2 ownerPrincipalUid:(id)a3 accountInfo:(id)a4;
...
+ (BOOL)_importAlarmsIntoStore:(const void *)a0 withPlistDictionary:(id)a1 fromDirectory:(id)a2 withContext:(id)a3 syncDefaultAlarms:(BOOL)a4;
+ (void)_importDirectoryAsCalendar:(id)a0 withPlistDictionary:(id)a1 context:(id)a2 storeForAccount:(const void *)a3 ownerPrincipalUid:(id)a4 accountInfo:(id)a5;
+ (void)_importICSEventsInCalendarDirectory:(id)a0 inCalendar:(const void *)a1 withContext:(id)a2 accountInfo:(id)a3;
...
+ (void)_migrateCalendarsInAccountDirectory:(id)a0 withContext:(id)a1 storeForAccount:(const void *)a2 ownerPrincipalUid:(id)a3 accountInfo:(id)a4;
+ (void)_migrateDefaultCalendarWithContext:(id)a0;
+ (void)_migrateHolidayCalendarWithContext:(id)a0;
+ (void)_migrateInboxInDirectory:(id)a0 withContext:(id)a1 store:(const void *)a2 principal:(id)a3;
+ (void)_migrateLegacyDefaultsWithContext:(id)a0;
+ (void)_migrateNotificationsInDirectory:(id)a0 withContext:(id)a1 store:(const void *)a2 principal:(id)a3;
