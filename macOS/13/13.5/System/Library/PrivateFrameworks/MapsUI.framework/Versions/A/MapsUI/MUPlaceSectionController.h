@class NSView, MUPlaceSectionHeaderViewModel, NSArray, GEOAPPlaceCardModule, MKMapItem, MUPlaceSectionFooterViewModel, MKUGCCallToActionViewAppearance, NSString, NSViewController, GEORevealedPlaceCardModule, MUImpressionElement;
