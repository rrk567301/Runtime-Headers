...
+ (void)ensureFallbackPDFDirectoryExistsForAccount:(id)a0;
...
+ (id)fallbackPDFEncryptedURLForIdentifier:(id)a0 account:(id)a1;
+ (id)fallbackPDFURLForIdentifier:(id)a0 account:(id)a1;
...
- (void)processFallbackAsset:(id)a0 fallbackAssetType:(long long)a1;
...
- (void)writeFallbackPDFData:(id)a0;
