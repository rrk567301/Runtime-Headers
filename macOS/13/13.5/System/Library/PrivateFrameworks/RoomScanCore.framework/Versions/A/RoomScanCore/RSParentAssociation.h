...
- (id).cxx_construct;
- (void)reset;
- (id)runWithFloorplan:(id)a0 needMerge:(BOOL)a1 replaceOpendoorByOpening:(BOOL)a2 replaceOpeningByOpendoor:(BOOL)a3 replaceOpeningByDoor:(BOOL)a4;
