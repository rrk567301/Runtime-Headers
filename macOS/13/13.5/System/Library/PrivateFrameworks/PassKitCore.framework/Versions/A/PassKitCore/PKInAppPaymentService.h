...
- (void)presentInAppPaymentInterfaceWithPaymentRequest:(id)a0 forHostIdentifier:(id)a1 hostSceneIdentifier:(id)a2 orientation:(id)a3 intentTriggered:(BOOL)a4 completion:(id /* block */)a5;
