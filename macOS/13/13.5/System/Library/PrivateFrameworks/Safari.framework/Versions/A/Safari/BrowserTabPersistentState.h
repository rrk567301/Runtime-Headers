@class NSDate, NSString, NSURL, NSData, NSArray, NSUUID, NSDictionary, BrowserViewController, WBTab, WBLocalTabAttributes;
...
@property (readonly, nonatomic, getter=isInLocalTabGroup) BOOL inLocalTabGroup;
