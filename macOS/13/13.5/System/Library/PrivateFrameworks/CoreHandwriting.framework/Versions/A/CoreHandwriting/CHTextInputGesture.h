...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })_affectedRangeByExpandingToComposedCharacterSequences:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
