...
- (struct CGSize { double x0; double x1; })_legacyUsableDisplaySizeAllowingDockUnderlap:(BOOL)a0 forScreen:(id)a1;
- (struct CGSize { double x0; double x1; })_legacyUsableDisplaySizeAllowingDockUnderlap:(BOOL)a0 withScreenFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 andVisibleFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2;
