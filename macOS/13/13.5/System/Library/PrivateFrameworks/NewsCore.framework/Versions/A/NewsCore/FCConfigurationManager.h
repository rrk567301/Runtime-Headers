@class RCConfigurationManager, NSDate, NSObject, FCNewsAppConfig, FCKeyValueStore, FCAsyncSerialQueue, NSDictionary, NSString, NSHashTable, FCContextConfiguration, NFUnfairLock, NSArray, NSData, FCNetworkBehaviorMonitor;
