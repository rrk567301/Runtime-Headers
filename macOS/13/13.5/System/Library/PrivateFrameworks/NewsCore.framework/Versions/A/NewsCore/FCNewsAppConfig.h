@class NSDictionary, FCArticleModalBrandBarConfig, FCSmarterMessagingConfig, FCPaidBundleConfiguration, FCSportsFavoritesSyncModalConfig, FCTimesOfDayConfiguration, FCSportsUpsellConfig, FCLaunchPresentationConfig, NSString, FCForYouGroupsConfiguration, FCTopStoriesConfiguration, FCNewsPlusLabelConfigGroup, NSArray, FCStatelessPersonalizationPublisherFavorability, FCWidgetConfig, FCIAdConfiguration, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, FCEmbedProxyConfiguration, FCAppReviewRequestConfig, FCArticleLinkBehaviorConfig, FCVideoGroupsConfig, FCPrefetchConfiguration, NTPBDiscoverMoreVideosInfo, FCPersonalizationTreatment, FCSportsPrivacyConfiguration, FCPaidBundleViaOfferConfig, NSNumber;
...
@property (readonly, nonatomic) BOOL sportsBoxScoresEnabled;
@property (readonly, nonatomic) BOOL sportsBracketsEnabled;
@property (readonly, nonatomic) BOOL sportsInjuryReportsEnabled;
@property (readonly, nonatomic) BOOL sportsRecordEnabled;
@property (readonly, nonatomic) BOOL sportsEventPagesEnabled;
@property (readonly, nonatomic) BOOL shouldGroupSportsHighlights;
