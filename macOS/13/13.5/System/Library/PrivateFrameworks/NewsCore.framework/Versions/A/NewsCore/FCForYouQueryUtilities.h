...
+ (id)feedRequestsForTags:(id)a0 tagBinProvider:(id /* block */)a1 hiddenFeedIDs:(id)a2 allowPaidBundleFeed:(BOOL)a3 purchasedTagIDs:(id)a4 bundleSubscriptionProvider:(id)a5 configuration:(id)a6 maxCount:(unsigned long long)a7 tagIDFeedRangeProvider:(id /* block */)a8 isRunningPPT:(BOOL)a9;
