@class NSMutableDictionary, CLIPSShim, NSDate, NSObject, ProbeManager, SDRDiagnosticReporter, CellFallbackHandler, NSMutableArray, SystemProperties, PowerStateRelay, NSString, NSDataDetector, SystemSettingsRelay, NSMutableSet, SymptomExpertSystemState, NSNumber, NSArray, NSXPCConnection, SymptomsFileCleaner, NetworkAnalyticsStateRelay;
