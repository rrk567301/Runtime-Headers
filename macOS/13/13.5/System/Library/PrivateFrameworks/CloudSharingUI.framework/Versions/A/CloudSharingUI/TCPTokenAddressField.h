@class NSView, TCPTokenAddressTextView;

@interface TCPTokenAddressField : NSTokenField {
    TCPTokenAddressTextView *_addressTextView;
}

@property (nonatomic) NSView *parentAddressField;
