...
@property (readonly) struct optional<bool> { union { char __null_state_; BOOL __val_; } ; BOOL __engaged_; } cloudSyncedLocation;
...
- (void)resetCloudSyncedLocation:(struct optional<bool> { union { char x0; BOOL x1; } x0; BOOL x1; })a0;
