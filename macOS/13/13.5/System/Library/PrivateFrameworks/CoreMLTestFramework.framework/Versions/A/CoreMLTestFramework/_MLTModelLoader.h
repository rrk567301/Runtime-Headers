...
+ (id)modelAtPath:(id)a0 computeUnit:(long long)a1 allowFallback:(BOOL)a2 enableProfiling:(BOOL)a3 encryptCompiledModel:(BOOL)a4 sinfURL:(id)a5 usePreloadedKey:(BOOL)a6 addMLProgram:(BOOL)a7 assertModelIsMLProgram:(BOOL)a8 inMemoryModel:(BOOL)a9 error:(id *)a10;
+ (id)modelAtPath:(id)a0 computeUnit:(long long)a1 computeDevice:(id)a2 allowFallback:(BOOL)a3 enableProfiling:(BOOL)a4 encryptCompiledModel:(BOOL)a5 sinfURL:(id)a6 usePreloadedKey:(BOOL)a7 addMLProgram:(BOOL)a8 assertModelIsMLProgram:(BOOL)a9 inMemoryModel:(BOOL)a10 error:(id *)a11;
