@class NSString, _PGDisplayNub, PGChildFIFO, PGRootFIFO, _PGDisplay, NSMutableDictionary, NSObject, PGEFIDisplay, PGIOSurfaceHostDevice;
...
@property (readonly) const struct APVFeatures { BOOL x0; BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; BOOL x8; BOOL x9; BOOL x10; BOOL x11; BOOL x12; BOOL x13; BOOL x14; unsigned int x15; unsigned int x16; } *features;
@property (readonly) int runState;
@property (readonly) unsigned long long deviceTraceId;
@property (readonly) BOOL heapsEnabled;
@property (readonly) BOOL bufferFromIOSurfaceEnabled;
