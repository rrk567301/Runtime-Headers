...
+ (BOOL)deserializeHashesFromAIRNTHeaderAtOffset:(unsigned long long)a0 headerSize:(unsigned long long)a1 reader:(id /* block */)a2 errorHandler:(id /* block */)a3 handler:(id /* block */)a4;
+ (BOOL)deserializeObjectFromAIRNTHeaderAtOffset:(unsigned long long)a0 headerSize:(unsigned long long)a1 reader:(id /* block */)a2 errorHandler:(id /* block */)a3 handler:(id /* block */)a4;
+ (BOOL)deserializePipelinesFromAIRNTHeaderAtOffset:(unsigned long long)a0 headerSize:(unsigned long long)a1 reader:(id /* block */)a2 errorHandler:(id /* block */)a3 handler:(id /* block */)a4;
+ (BOOL)isAIRHeaderExtLoadCommand:(const void *)a0 headerOffset:(unsigned long long *)a1 headerSize:(unsigned long long *)a2;
