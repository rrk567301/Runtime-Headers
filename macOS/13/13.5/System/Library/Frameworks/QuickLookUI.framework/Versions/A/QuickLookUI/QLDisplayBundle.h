@class NSURL, QLPreview, NSDictionary, DMFApplicationPolicyMonitor, NSTouchBar, NSMutableArray, CALayer, NSResponder, NSString, QLDisplayBundleViewController, NSArray, NSData, NSView, DMFCategoryPolicyMonitor, NSUUID;
