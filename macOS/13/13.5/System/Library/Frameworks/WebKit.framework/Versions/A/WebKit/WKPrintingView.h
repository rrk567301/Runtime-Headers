...
@interface WKPrintingView : NSView {
    ...
    struct Vector<WTF::Vector<WTF::RetainPtr<PDFDestination>, 0, WTF::CrashOnOverflow, 16>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { void *m_buffer; unsigned int m_capacity; unsigned int m_size; } _linkDestinationsPerPage;
    struct ObjectIdentifier<IPC::Connection::AsyncReplyIDType> { unsigned long long m_identifier; } _expectedComputedPagesCallback;
    struct HashMap<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>, WebCore::IntRect, WTF::DefaultHash<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>>, WTF::HashTraits<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>>, WTF::HashTraits<WebCore::IntRect>, WTF::HashTableTraits> { struct HashTable<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>, WTF::KeyValuePair<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>, WebCore::IntRect>, WTF::KeyValuePairKeyExtractor<WTF::KeyValuePair<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>, WebCore::IntRect>>, WTF::DefaultHash<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>>, WTF::HashMap<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>, WebCore::IntRect>::KeyValuePairTraits, WTF::HashTraits<WTF::ObjectIdentifier<IPC::Connection::AsyncReplyIDType>>> { union { void *m_table; unsigned int *m_tableForLLDB; } ; } m_impl; } _expectedPreviewCallbacks;
    struct ObjectIdentifier<IPC::Connection::AsyncReplyIDType> { unsigned long long m_identifier; } _latestExpectedPreviewCallback;
    struct ObjectIdentifier<IPC::Connection::AsyncReplyIDType> { unsigned long long m_identifier; } _expectedPrintCallback;
...
- (struct ObjectIdentifier<IPC::Connection::AsyncReplyIDType> { unsigned long long x0; })_expectedPreviewCallbackForRect:(const struct IntRect { struct IntPoint { int x0; int x1; } x0; struct IntSize { int x0; int x1; } x1; } *)a0;
