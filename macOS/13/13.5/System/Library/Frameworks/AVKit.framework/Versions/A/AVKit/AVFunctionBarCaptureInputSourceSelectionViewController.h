@class NSSegmentedControl, NSArray, NSString, NSView, NSStackView, AVFunctionBarCaptureInputSourceItem, NSMutableArray;
@protocol AVFunctionBarRecordingControlsControllingInternal, AVFunctionBarCaptureInputSourceSelectionViewControllerDelegate;
...
@property (weak, nonatomic) id<AVFunctionBarCaptureInputSourceSelectionViewControllerDelegate> delegate;
...
- (void)actionSelectFunctionBarCaptureInputSourceItem:(id)a0;
