...
- (void).cxx_destruct;
- (id)initWithPath:(const struct ConcreteEventPath { unsigned short x0; BOOL x1; unsigned int x2; unsigned int x3; } *)a0 eventNumber:(id)a1 priority:(unsigned char)a2 timestamp:(const struct Timestamp { unsigned char x0; unsigned long long x1; } *)a3 value:(id)a4 error:(id)a5;
