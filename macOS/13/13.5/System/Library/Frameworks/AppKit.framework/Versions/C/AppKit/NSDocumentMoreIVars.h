@class NSURL, NSSavePanel, NSDate, NSFileVersion, NSObject, NSMutableArray, NSConditionLock, NSString, _NSDocumentActivity, NSPointerArray, NSTimer, NSPersonNameComponents, NSOperationQueue, NSArray, NSNumber, NSError, NSDocument;
