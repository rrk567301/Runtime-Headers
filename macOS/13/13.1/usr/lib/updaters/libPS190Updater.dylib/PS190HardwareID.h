...
- (id)description;
- (void).cxx_destruct;
- (id)initWithBoardID:(id)a0 certficateEpoch:(unsigned int)a1 chipID:(unsigned int)a2 debugDisable:(BOOL)a3 ecid:(unsigned long long)a4 nonce:(id)a5 productionMode:(id)a6 realHDCPKeysPresent:(BOOL)a7 securityDomain:(id)a8 securityMode:(BOOL)a9;
