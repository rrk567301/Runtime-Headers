...
@interface VCAudioStream : VCMediaStream <VCMediaStreamSyncSource, VCAudioIOSink, VCAudioIODelegate, VCTelephonyInterfaceDelegate> {
    int _clientPid;
...
- (void)reportInputHostTimeJumpWithSize:(double)a0;
- (void)reportingAlgosAudioStreamEvent:(unsigned short)a0;
- (int)getRatTypeForStreamMode:(long long)a0;
...
- (void)notifyCodecModeChangeToCT:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (void)setRemoteCodecTypeAndSampleRate:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (void)queryAnbrBitrate:(unsigned int)a0 forDirection:(long long)a1;
- (void)notifyCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0 didUpdateBandwidth:(BOOL)a1 didUpdateBitrate:(BOOL)a2;
- (void)handleCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (void)handleUplinkANBR:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
- (void)handleDownlinkANBR:(struct _VCAudioCodecModeChangeEvent { int x0; int x1; int x2; unsigned int x3; })a0;
