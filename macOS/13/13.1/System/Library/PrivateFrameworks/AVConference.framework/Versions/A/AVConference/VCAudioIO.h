...
+ (id)defaultControllerForAudioType:(unsigned int)a0 forDirection:(unsigned char)a1;
+ (id)controllerForDeviceRole:(int)a0 audioType:(unsigned int)a1 direction:(unsigned char)a2 streamInputID:(long long)a3 streamToken:(long long)a4 networkClockID:(unsigned long long)a5;
...
- (BOOL)reconfigureWithOperatingMode:(int)a0 deviceRole:(int)a1 direction:(unsigned char)a2 streamInputID:(long long)a3 streamToken:(long long)a4 allowAudioRecording:(BOOL)a5 networkClockID:(unsigned long long)a6;
- (void)forceCleanup;
