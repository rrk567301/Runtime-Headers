...
@property (nonatomic) struct { long long valueByBand[2]; BOOL valid[2]; } roamNeighsSmllstCurrentToBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[2]; BOOL valid[2]; } roamNeighsLrgstCurrentToBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[2]; BOOL valid[2]; } roamNeighsSmllstCurrentToNextBestRssiByBand;
@property (nonatomic) struct { long long valueByBand[2]; BOOL valid[2]; } roamNeighsLrgstCurrentToNextBestRssiByBand;
...
- (id)initWithInterfaceName:(id)a0 bssEnvironment:(id)a1 andBssDetails:(id)a2 andNetworkDetails:(id)a3 andCompatibilityMode:(BOOL)a4;
- (void)resetWithCompatibilityMode:(BOOL)a0;
- (void)setJoinRssi:(long long)a0;
- (void)bssDidChange:(id)a0 withDetails:(id)a1 whileCompatibilityMode:(BOOL)a2;
- (void)updateActivityDurations:(id)a0;
- (BOOL)submitAnalytics;
- (void)updateRssi:(long long)a0 timeSinceLastUpdate:(double)a1;
- (void)roamingStateDidChange:(BOOL)a0 reason:(unsigned long long)a1 andStatus:(unsigned long long)a2 andLatency:(unsigned long long)a3 andRoamData:(id)a4 andPingPongNth:(BOOL)a5 whileCompatibilityMode:(BOOL)a6;
