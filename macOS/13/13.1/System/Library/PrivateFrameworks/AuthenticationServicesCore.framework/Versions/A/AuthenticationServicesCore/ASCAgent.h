@class NSXPCConnection, NSString, NSArray, NSUUID, _TtC26AuthenticationServicesCore13ASCABLEClient, ASCCredentialRequestContext, ASCAuthorizationPresenter, ASCAuthorizationTrafficController, NSXPCListener;
