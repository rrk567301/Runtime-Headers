@class RBSTarget, NSString, BSXPCServiceConnectionContext, BSXPCServiceConnectionPeer, BSXPCServiceConnectionActivationMessage, NSObject, NSMutableArray, BSXPCServiceConnectionMessageReply, BSXPCServiceConnectionMessage, BSXPCServiceConnectionEventHandler;
