@class HDSourceOrderManager, HDSummarySharingEntryManager, NSDictionary, HDAssertionManager, HDSourceManager, HDPeriodicCountryMonitor, HDOntologyConceptManager, HDDaemon, NSMutableArray, HDSyncIdentityManager, HDDatabase, HDDataProvenanceManager, HDSharedSummaryManager, HDActivityCacheManager, HKProfileIdentifier, HDConceptIndexManager, HDUnitPreferencesManager, HDAuthorizationManager, HDFitnessMachineManager, HDMedicalIDDataManager, HDAgeGatingManager, HDCloudSyncManager, HDServiceConnectionManager, HDFeatureSettingsManager, NSURL, HDDataManager, HDContributorManager, HDTinkerPrivacyAlertCoordinator, HDNanoSyncManager, HDDataCollectionManager, HDRestorableAlarmScheduler, HDMigrationManager, HDSummarySharingEntryIDSManager, HDHealthServiceManager, HDCurrentActivitySummaryHelper, HDWorkoutManager, HDUserDomainConceptManager, HDAttachmentManager, HDNotificationManager, HDWorkoutCondenser, NSString, NSObject, HDMetadataManager, HDSharingAuthorizationManager, HDAppSubscriptionManager, HDDeviceManager, HKObserverSet, HDHealthRecordsAccountExistenceNotifier, HDAWDSubmissionManager, HDOntologyDatabase, HDUserCharacteristicsManager, HDDaemonSyncEngine, HDOnboardingCompletionManager;
