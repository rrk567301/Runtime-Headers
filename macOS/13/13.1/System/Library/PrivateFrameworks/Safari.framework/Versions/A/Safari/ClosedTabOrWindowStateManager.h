...
- (BOOL)_restoreTabPreservingTabGroupScopeWithTabState:(id)a0 atIndex:(unsigned long long)a1 inWindow:(id)a2;
- (void)_restoreTabWithState:(id)a0 atIndex:(unsigned long long)a1 inWindowWithUUID:(id)a2 preservingTabGroupScope:(BOOL)a3;
