@class WBSHostTabProvider, WBTab, BrowserWindowController, ContinuousReadingListViewController, NSDictionary, FormTextStatusWatcher, NSMutableArray, NSString, NSImageView, UnifiedTabBarItem, NSArray, NSMutableDictionary, NSTimer, NSColor, NSSet, BrowserTabViewController, NSLayoutConstraint, SearchState, NSView, BrowserViewController, WBSTranslationContext, DelayedPopUpRolloverImageButton, NSImage, WKWebView, NSUUID, NSURL, NSDate, TabContentViewController;
@protocol WBSWebExtensionWindow, ThumbnailSnapshotProviding;

@interface BrowserTabViewItem : NSTabViewItem <CNAvatarViewDelegate, WBTabGroupSyncAgentSyncObserver, DelayedPopUpRolloverImageButtonDelegate, WBReusableTab, FormTextStatusWatcherDelegate, TabBarViewItem, WBSOrderedTab, WBSWebExtensionTab, WBSHostableTab> {
