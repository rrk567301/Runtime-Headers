...
+ (id)phraseManagerWithPhrase:(id)a0 updatedSuggestion:(id)a1 filterQuery:(id)a2 inputLanguages:(id)a3;

- (void).cxx_destruct;
- (id)initWithPhrase:(id)a0 selectedSuggestions:(id)a1 vipManager:(id)a2 updatedSuggestion:(id)a3 scopeIdentifierForPeopleSuggestions:(id)a4 inputLanguages:(id)a5 implicitSuggestions:(id)a6 filterQuery:(id)a7 excludedMailboxes:(id)a8;
