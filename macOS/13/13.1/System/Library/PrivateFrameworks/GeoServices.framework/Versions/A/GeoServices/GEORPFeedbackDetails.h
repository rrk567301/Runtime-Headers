...
@interface GEORPFeedbackDetails : PBCodable <NSCopying> {
    ...
    struct { unsigned char read_unknownFields : 1; unsigned char read_addMapFeedback : 1; unsigned char read_addressPointFeedback : 1; unsigned char read_curatedCollectionFeedback : 1; unsigned char read_directionsFeedback : 1; unsigned char read_groundViewFeedback : 1; unsigned char read_incidentFeedback : 1; unsigned char read_localityFeedback : 1; unsigned char read_merchantLookupFeedback : 1; unsigned char read_photoAttributionPreferencesUpdate : 1; unsigned char read_poiActivityFeedback : 1; unsigned char read_poiEnrichmentUpdate : 1; unsigned char read_poiFeedback : 1; unsigned char read_poiImageFeedback : 1; unsigned char read_runningTrackFeedback : 1; unsigned char read_searchFeedback : 1; unsigned char read_streetFeedback : 1; unsigned char read_thirdPartyPhotoSharingPreferenceUpdate : 1; unsigned char read_tileFeedback : 1; unsigned char read_transitPoiFeedback : 1; unsigned char wrote_anyField : 1; } _flags;
}
