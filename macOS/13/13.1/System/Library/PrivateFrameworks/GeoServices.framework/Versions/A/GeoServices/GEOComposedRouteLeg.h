@class NSData, GEOFormattedString, GEOComposedRoute, GEOArrivalParameters, GEOComposedWaypoint, GEOWaypointInfo, GEOComposedRouteEVChargingStationInfo, GEOComposedWaypointDisplayInfo;
...
@property (readonly, nonatomic) GEOFormattedString *originListInstruction;
@property (readonly, nonatomic) GEOFormattedString *destinationListInstruction;
