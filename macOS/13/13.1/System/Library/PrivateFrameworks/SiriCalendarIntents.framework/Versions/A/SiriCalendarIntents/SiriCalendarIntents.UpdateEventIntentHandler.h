@class INStringResolutionResult, INUpdateEventIntentResponse, NSArray, INUpdateEventIntent, INPlacemarkResolutionResult, INDateComponentsRangeResolutionResult, INBooleanResolutionResult;
