...
@interface BU_TPrefsObserverBridge : NSObject <TMarkTornDown> {
    ...
    struct map<TString, TNotificationCenterObserver, std::less<TString>, std::allocator<std::pair<const TString, TNotificationCenterObserver>>> { struct __tree<std::__value_type<TString, TNotificationCenterObserver>, std::__map_value_compare<TString, std::__value_type<TString, TNotificationCenterObserver>, std::less<TString>, true>, std::allocator<std::__value_type<TString, TNotificationCenterObserver>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<TString, TNotificationCenterObserver>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<TString, std::__value_type<TString, TNotificationCenterObserver>, std::less<TString>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _globalKeysToObserverMap;
    struct map<UDefaults::RegistryID, TNotificationCenterObserver, std::less<UDefaults::RegistryID>, std::allocator<std::pair<const UDefaults::RegistryID, TNotificationCenterObserver>>> { struct __tree<std::__value_type<UDefaults::RegistryID, TNotificationCenterObserver>, std::__map_value_compare<UDefaults::RegistryID, std::__value_type<UDefaults::RegistryID, TNotificationCenterObserver>, std::less<UDefaults::RegistryID>, true>, std::allocator<std::__value_type<UDefaults::RegistryID, TNotificationCenterObserver>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<UDefaults::RegistryID, TNotificationCenterObserver>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<UDefaults::RegistryID, std::__value_type<UDefaults::RegistryID, TNotificationCenterObserver>, std::less<UDefaults::RegistryID>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _regIDsToObserverMap;
