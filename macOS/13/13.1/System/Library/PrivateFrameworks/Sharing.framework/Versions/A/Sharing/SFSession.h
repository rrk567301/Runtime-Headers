@class NSMutableDictionary, NSMutableData, SFAppleIDContactInfo, SFDevice, NSDictionary, NSObject, CUPairingSession, CUAppleIDClient, SDStatusMonitor, NSString, TRSession, NSXPCListenerEndpoint, CUMessageSession, CUMessageSessionServer, NSXPCConnection, NSUUID;
