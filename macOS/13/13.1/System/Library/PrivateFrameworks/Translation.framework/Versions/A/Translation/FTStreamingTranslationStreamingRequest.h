@class NSMutableDictionary, FTStreamingTranslationRequest, NSData, NSObject;
@protocol FLTBFBufferAccessor, NSCopying;

@interface FTStreamingTranslationStreamingRequest : NSObject <FLTBFBufferAccessor, NSCopying> {
