@class NSString, SiriAnalyticsPreprocessor, SiriAnalyticsClientMessageStream, SiriAnalyticsSensitiveConditionsObservers, SiriAnalyticsInternalTelemetry;
...
- (void)whiteRose:(id)a0 rootClockDestroyed:(id)a1 completion:(id /* block */)a2;
- (void)whiteRose:(id)a0 derivativeClockCreated:(id)a1 rootClock:(id)a2;
- (id)initWithInternalTelemetry:(id)a0 sensitiveConditionsObservers:(id)a1 clientMessageStream:(id)a2 preprocessor:(id)a3;
