...
- (id)_tokenizedTextResultFromTextDecodingResult:(id)a0 options:(id)a1 strokeEndings:(struct vector<long, std::allocator<long>> { long long *x0; long long *x1; struct __compressed_pair<long *, std::allocator<long>> { long long *x0; } x2; })a2 drawing:(id)a3 firstTokenHasPrecedingSpacePreference:(BOOL)a4;
