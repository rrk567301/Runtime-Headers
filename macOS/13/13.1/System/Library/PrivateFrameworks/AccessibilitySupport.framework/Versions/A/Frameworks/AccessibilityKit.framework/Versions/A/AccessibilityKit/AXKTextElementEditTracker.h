...
+ (id)elementInfoForElement:(id)a0 textRange:(id)a1;
...
- (void)_signalDelegatesWordCompleted:(id)a0 element:(id)a1 info:(id)a2;
...
- (void)_signalForElement:(id)a0 stringInserted:(id)a1 wordCompleted:(BOOL)a2 editTracker:(id)a3;
- (void)_signalForElement:(id)a0 wordCompleted:(id)a1 editTracker:(id)a2;
