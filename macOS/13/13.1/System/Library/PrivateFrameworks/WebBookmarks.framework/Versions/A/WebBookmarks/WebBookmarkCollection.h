...
- (BOOL)_insertTombsonesRecursivelyHelperCurrentDepth:(unsigned long long)a0 folder:(id)a1 insertTombstoneBlock:(id /* block */)a2;
...
- (id)secondaryZoneNameForBookmark:(id)a0;
...
- (BOOL)_updateBookmarkSyncPositionIfNeeded:(id)a0;
