...
+ (id)_placeholderForBundle:(id)a0 client:(unsigned long long)a1 withParent:(id)a2 installType:(unsigned long long)a3 metadata:(id)a4 placeholderType:(unsigned long long)a5 error:(id *)a6;
...
- (BOOL)_internalInitAppExtensionPlaceholderWithBundleName:(id)a0 bundleID:(id)a1 parentPlaceholder:(id)a2 placeholderType:(unsigned long long)a3 client:(unsigned long long)a4;
- (BOOL)_doInitWithBundleName:(id)a0 bundleID:(id)a1 installType:(unsigned long long)a2 placeholderType:(unsigned long long)a3;
