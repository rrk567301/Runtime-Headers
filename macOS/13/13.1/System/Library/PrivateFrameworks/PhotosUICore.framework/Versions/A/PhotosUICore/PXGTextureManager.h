...
- (id)_existingAdjustedTextureForSourceTexture:(id)a0 adjustment:(id)a1 wantsMipmaps:(BOOL)a2 presentationType:(int)a3;
...
- (void)_processCGImage:(struct CGImage { } *)a0 options:(struct { id x0; BOOL x1; })a1 isDegraded:(BOOL)a2 fromTextureProvider:(id)a3 withTextureConverter:(id)a4 requestID:(int)a5 requestDetails:(struct { int x0; unsigned int x1; })a6 deliveryOrder:(unsigned int)a7;
...
- (void)_processPixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { id x0; BOOL x1; })a1 fromTextureProvider:(id)a2 withTextureConverter:(id)a3 forRequestID:(int)a4 requestDetails:(struct { int x0; unsigned int x1; })a5 deliveryOrder:(unsigned int)a6;
...
- (void)_applyAdjustment:(id)a0 withMipmaps:(BOOL)a1 toTexture:(id)a2 fromTextureProvider:(id)a3 withTextureConverter:(id)a4 forRequestID:(int)a5 deliveryOrder:(unsigned int)a6 requestDetails:(struct { int x0; unsigned int x1; })a7;
