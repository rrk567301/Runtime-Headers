...
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { id x0; BOOL x1; })a1 isDegraded:(BOOL)a2 forRequestID:(int)a3;
- (void)provideCGImage:(struct CGImage { } *)a0 options:(struct { id x0; BOOL x1; })a1 forRequestID:(int)a2;
...
- (void)providePixelBuffer:(struct __CVBuffer { } *)a0 options:(struct { id x0; BOOL x1; })a1 forRequestID:(int)a2;
