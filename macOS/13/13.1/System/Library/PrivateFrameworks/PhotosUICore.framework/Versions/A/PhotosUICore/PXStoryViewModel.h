@class PXStoryOverlayController, PXStoryValidationController, NSMutableSet, PXPhotosViewInteraction, PXInfoUpdater, PXStoryPausableLoadingCoordinator, PXStoryPersistenceController, PXStoryAudioSessionController, PXVolumeController, PXStoryConfiguration, PXMediaProvider, PXStoryModel, PXStoryItemPlacement, PXStoryMuteStateController, NSMapTable, PXStoryRelatedController, PXStoryErrorRepository, PXUpdater, PXStoryViewPointerVisibilityController, PXStoryResourcesPreloadingCoordinator, PXStoryViewBufferingController, PXExtendedTraitCollection, PXStoryViewLayoutSpecManager, PXStoryViewResourcesPreloadingController, PXStoryPacingController, PXStoryMusicPlayer, NSArray, PXStoryViewModeTransition, PXStoryViewAccessibilityHUDContentProvider, NSAttributedString, NSDateFormatter, NSString, NSObject, NSView, NSError, PXObservable, PXPhotosViewModel, PXStorySongController, NSDate;
@protocol PXStoryPacingTimeSource, PXAnonymousCoordinateSpace, PXStoryViewLayoutSpec, PXUserDefaultsDataSource, OS_dispatch_queue, PXAnonymousViewController, PXStoryViewActionPerformer, PXDisplayAssetCollection, PXStoryErrorReporter, PXDisplayAsset;
...
+ (void)registerViewModelDesiringPlayback:(id)a0;
+ (void)unregisterViewModelDesiringPlayback:(id)a0;
