...
- (id)initWithExtendedTraitCollection:(id)a0 options:(unsigned long long)a1 availableThumbnailSizes:(id)a2 gridStyle:(long long)a3 itemAspectRatio:(double)a4 userDefaults:(id)a5 forceSaliency:(BOOL)a6;
