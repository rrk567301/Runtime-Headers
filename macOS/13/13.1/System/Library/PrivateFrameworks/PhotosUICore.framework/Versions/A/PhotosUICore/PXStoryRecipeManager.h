@class PXStoryProducerMonitor, PXAssetsDataSourceManager, NSDate, PXUpdater, NSDictionary, NSObject, PXStoryConfiguration, PXAssetsDataSource, PXStoryChapterCollectionManager, PXStoryProducerResult, NSSet, PXStoryAutoEditMomentsProvider, PXStoryRecipe, NSString, PXStoryRecipeAssetEdits, NSProgress;
