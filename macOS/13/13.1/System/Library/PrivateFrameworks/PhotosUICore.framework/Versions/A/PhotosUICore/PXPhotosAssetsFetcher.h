...
- (id)fetchCuratedAssetsInAssetCollection:(id)a0 referencePersons:(id)a1 curationType:(long long)a2 options:(unsigned long long)a3 libraryFilter:(long long)a4;
...
- (id)_fetchConfigurationForCurationWithReferencePersons:(id)a0 curationType:(long long)a1 options:(unsigned long long)a2 libraryFilter:(long long)a3;
