@class UXView, NSTimer, NSScrollView, PXGView, PXGPointReference, PXSectionedSelectionManager, NSView, PXSectionedDataSource, PXMutableIndexPathSet, PXIndexPathSet, NSEvent;
