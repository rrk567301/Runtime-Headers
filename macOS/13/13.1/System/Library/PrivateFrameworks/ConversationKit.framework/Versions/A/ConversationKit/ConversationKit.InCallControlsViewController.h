@interface ConversationKit.InCallControlsViewController : ConversationKit.PlatformViewController <NSCollectionViewDelegate, NSCollectionViewDelegateFlowLayout> {
