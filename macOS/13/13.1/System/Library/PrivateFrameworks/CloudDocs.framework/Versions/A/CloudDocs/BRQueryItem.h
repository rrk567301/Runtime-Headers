@class NSURL, NSMutableDictionary, NSDate, NSDictionary, BRFileObjectID, NSFileProviderItemVersion, NSString, NSSet, NSPersonNameComponents, NSArray, NSData, NSNumber, UTType, NSError;
