@class NSTextField, NSUUID, NSTimer, NSString, NSArray, VTUIPagedLabel, VTUITickMarkView, SSRVoiceProfile, SiriUIOrbView, NSButton, AFMyriadCoordinator, SSRVTUITrainingManager;
