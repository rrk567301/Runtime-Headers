...
- (id)initWithApplication:(id)a0 proxyApplication:(id)a1 pageId:(id)a2 url:(id)a3 title:(id)a4 type:(long long)a5 debuggerState:(long long)a6 userInfo:(id)a7;
- (id)owningApplication;
- (void)changeURL:(id)a0 title:(id)a1 debuggerState:(long long)a2 userInfo:(id)a3;
