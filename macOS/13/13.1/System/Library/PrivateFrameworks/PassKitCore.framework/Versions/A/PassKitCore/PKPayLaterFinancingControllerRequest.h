...
- (id)initWithTransactionAmount:(id)a0 optionIdentifierToCancel:(id)a1 authenticationState:(unsigned long long)a2 stateMachineError:(id)a3 completion:(id /* block */)a4;
