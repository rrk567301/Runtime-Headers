...
+ (id)amountDueOverNext30DaysForFinancingPlans:(id)a0 payLaterAccount:(id)a1 totalPending:(id *)a2 upcomingInstallments:(id *)a3 upcomingInstallmentsIdentifierToFinancingPlan:(id *)a4;
...
- (void)financingPlansWithStates:(id)a0 completion:(id /* block */)a1;
...
- (id)_sortedFinancingPlans:(id)a0;
