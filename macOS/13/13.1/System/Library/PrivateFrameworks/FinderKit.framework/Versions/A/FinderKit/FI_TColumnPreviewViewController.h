...
@interface FI_TColumnPreviewViewController : FI_TBaseInfoWindowViewController {
    ...
    struct TNSWeakPtr<NSLayoutConstraint> { NSValue *fWeakObject; } _maxRelativeHeightConstraint;
    struct TNSWeakPtr<NSLayoutConstraint> { NSValue *fWeakObject; } _heightHintConstraint;
}
