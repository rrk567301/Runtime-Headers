...
@interface FIAirDropViewGutsController : FI_TViewController <NSTouchBarDelegate, TSFOperationDelegateProtocol, TMarkTornDown> {
    struct TNSWeakPtr<NSObject<FIAirDropViewDelegate>> { NSValue *fWeakObject; } _weakDelegate;
    ...
    struct TNSWeakPtr<FI_TTouchBar> { NSValue *fWeakObject; } _participantsTouchBar;
    struct TNSWeakPtr<FI_TCustomTouchBarItem> { NSValue *fWeakObject; } _participantsTouchBarItem;
    FI_TCustomTouchBarItem *_escapeKeyTouchBarItem;
    struct TNSWeakPtr<FI_TTouchBar> { NSValue *fWeakObject; } _airDropNotAvailableTouchBar;
    struct TNSWeakPtr<FI_TCustomTouchBarItem> { NSValue *fWeakObject; } _turnOnWiFiBluetoothTouchBarItem;
}
