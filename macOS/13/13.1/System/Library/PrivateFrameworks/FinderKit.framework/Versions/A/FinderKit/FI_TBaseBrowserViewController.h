@class FI_TNodeViewSettings, NSEvent, NSObject, FI_TNotificationCenterObserverGlue, NSString, NSIndexSet, FI_TBrowserContainerController, FI_TKeyValueObserverGlue, NSArray, NSView, FI_TBrowserViewDataSource, NSSharingServicePicker, NSValue;

@interface FI_TBaseBrowserViewController : FI_TViewController <NSDraggingSource, NSMenuItemValidation, NSSharingServiceDelegate, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TQLPreviewWindowControllerProtocol, TTypeSelectDelegate, TMarkTornDown, NSTouchBarDelegate, TFloatingInputWindowDelegateProtocol, TContextMenuDelegate, TThumbnailExtractorDelegate> {
    ...
    struct TNSWeakPtr<FINode> { NSValue *fWeakObject; } _nodeToDoubleClick;
...
- (struct TriStateBool { unsigned char x0; })includeTargetForCommandSelector:(SEL)a0;
...
- (void)addSpatialDataForLocationInView:(const struct CGPoint { double x0; double x1; } *)a0 toPropertyList:(struct TFENodePropertyList { struct OpaquePropertyListRef *x0; } *)a1;
- (void)addOffsetSpatialDataFromNodes:(const void *)a0 toPropertyList:(void *)a1;
- (void)prepareSnapToGridForNode:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0;
