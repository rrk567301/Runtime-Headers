@interface FI_TSegmentedControl : NSSegmentedControl {
    struct map<long, FI_TSegmentedControlHelper *, std::less<long>, std::allocator<std::pair<const long, FI_TSegmentedControlHelper *>>> { struct __tree<std::__value_type<long, FI_TSegmentedControlHelper *>, std::__map_value_compare<long, std::__value_type<long, FI_TSegmentedControlHelper *>, std::less<long>, true>, std::allocator<std::__value_type<long, FI_TSegmentedControlHelper *>>> { void *__begin_node_; struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<long, FI_TSegmentedControlHelper *>, void *>>> { struct __tree_end_node<std::__tree_node_base<void *> *> { void *__left_; } __value_; } __pair1_; struct __compressed_pair<unsigned long, std::__map_value_compare<long, std::__value_type<long, FI_TSegmentedControlHelper *>, std::less<long>, true>> { unsigned long long __value_; } __pair3_; } __tree_; } _segmentToHelperMap;
}
