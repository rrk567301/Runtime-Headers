@interface FI_TNewAliasOperation : FI_TRenameOperation {
    ...
    struct __wrap_iter<const std::pair<TFENode, TFENodePropertyList> *> { void *__i; } _recordIter;
...
- (int)createNewAlias:(const struct TFENode { struct OpaqueNodeRef *x0; } *)a0 properties:(const struct TFENodePropertyList { struct OpaquePropertyListRef *x0; } *)a1 addAliasSuffix:(BOOL)a2;
