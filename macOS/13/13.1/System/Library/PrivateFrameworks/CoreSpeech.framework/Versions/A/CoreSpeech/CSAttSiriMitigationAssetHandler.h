@class CSAsset, CSVoiceTriggerAssetHandler, CSTrialAssetManager, CSAssetManager, NSString, CSTrialAssetDownloadMonitor;
...
@property (retain, nonatomic) CSVoiceTriggerAssetHandler *vtAssetHandler;
...
- (id)initWithAssetManager:(id)a0 withTrialAssetManager:(id)a1 withTrialDownloadMonitor:(id)a2 withVTAssetHandler:(id)a3 withAssetOverrideFlag:(BOOL)a4 withOverrideAssetPath:(id)a5;
