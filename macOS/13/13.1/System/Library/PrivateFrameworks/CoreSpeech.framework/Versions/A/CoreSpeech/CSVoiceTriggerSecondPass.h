@class NSMutableDictionary, CSVoiceTriggerSecondPassConfig, CSAudioCircularBuffer, NSDictionary, NSObject, CSSpeechManager, CSPhraseNDEAPIScorer, CSAudioStream, NSMutableArray, CSPhraseDetector, NSString, CSAudioTimeConverter, CSVoiceTriggerFirstPassMetrics, CSVTSecondPassLatencyMetrics, SSRSpeakerRecognitionController, SSRSpeakerRecognitionContext, CSPlainAudioFileWriter, CSAsset, NSUUID;
...
- (void)_analyzeForChannel:(unsigned long long)a0 keywordDetectorResult:(id)a1;
