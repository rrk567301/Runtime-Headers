...
- (id)loadUserSupportsAutomaticHH2MigrationModelWithModelID:(id)a0 error:(id *)a1;
- (void)registerForUserSupportsAutomaticHH2MigrationModelUpdates:(id)a0 modelID:(id)a1;
