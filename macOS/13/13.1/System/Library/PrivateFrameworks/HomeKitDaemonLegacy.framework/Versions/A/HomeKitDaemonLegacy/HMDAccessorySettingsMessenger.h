...
- (id)initWithMessageTargetUUID:(id)a0 messageDispatcher:(id)a1 messageRouter:(id)a2 messageHandler:(id)a3 logEventSubmitter:(id)a4 legacyMessageReceiver:(id)a5;
