@class HMDHomeManagerObjectLookup, HMDMultiUserSettingsMetricsEventDispatcher, NSMutableDictionary, HMEDelegatingEventRouter, NSMapTable, HMDMessageFilterChain, HMDAccessoryBrowser, HMDLocation, HMELastEventStore, HMDCloudManager, NSObject, HMDMetricsManager, HMDCloudDataSyncStateFilter, HMDAssistantGather, NSUUID, HMDSyncOperationManager, HMDIdentityRegistry, HMDAWDLogEventObserver, NSMutableArray, HMDLoggingEventForwarder, HMDFMFHandler, HMDAccountRegistry, HMFDumpCategory, NSSet, HMDPowerManager, HMDMultiUserStatusController, HMDDuetPredictionSubscriber, HMDXPCEventRouterServer, HMDIDSFirewallManager, HMDApplicationData, HMDResidentMesh, HMDKeyTransferAgent, HMDBackingStore, HMDAppleAccessoryPairingController, HMDNameValidator, HMDSiriEndpointOnboardingManager, HMDBiomeLogEventObserver, HMDRemoteEventRouterAssertionController, HMDMessageDispatcher, HMDSiriEndpointSettingsSyncManager, HMDDevice, HMDCurrentAccessorySetupMetricDispatcher, NSUserDefaults, HMDAccessoryFirmwareUpdateManager, HMDMatterSoftwareUpdateProviderDelegate, HMDLogEventDispatcher, HMDLastEventStoreController, NSDate, HMDRemoteAccountManager, HMDCloudManagerDataSource, HMDCameraRecordingLoadBalancer, HMDMobileAssetManager, HMDCHIPXPCListener, HMFNetMonitor, NSArray, HMDCompositeSettingsControllerManager, HMDCHIPDataSource, HMDHH2FrameworkSwitch, HMDPairedSync, HMDCapabilitiesController, HMEMemoryEventBus, HMFBoolean, HMDUserCloudShareManager, HMDIDSServerBag, HMDHomeManagerObjectChangeHandler, HMDClientConnection, NSString, HMDCloudAccount, NSNotificationCenter, HMDBonjourBrowserHelper, HMDWidgetConfigurationReader, HMDAppleAccountManager, HMDWatchManager, HMFTimer, HMDDuetEventManager, HMFFuture, NSDictionary, HMDSoftwareUpdateManager, NSMutableSet, HMDMemoryUtilizationTracker, HMDCompanionManager, HMDBiomeEventManager, HMDMediaGroupParticipantLocalDataStorage, HMFActivity, HMDAccessorySetupCoordinator;
