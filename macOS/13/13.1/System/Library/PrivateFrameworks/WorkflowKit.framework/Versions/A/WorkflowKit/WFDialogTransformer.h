@class NSDate, NSString, NSArray, WFWorkflowReference, WFAction, WFSequentialParameterInputProvider, WFUIPresenter, WFSiriWorkflowRunnerClientOptions, WFChooseFromListDataStore, WFDialogAttribution, WFWorkflowRunningContext, WFSiriUIPresenter;
