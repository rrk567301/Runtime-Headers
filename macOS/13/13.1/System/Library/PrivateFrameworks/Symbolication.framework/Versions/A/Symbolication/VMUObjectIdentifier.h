@class NSMutableDictionary, VMUClassInfoMap, NSMapTable, VMURangeArray, NSMutableArray, VMUNonOverlappingRangeArray, VMUClassInfo, NSHashTable, NSMutableSet, VMUTaskMemoryScanner, VMUObjectIdentifierDriverKitSupport, VMUSwiftRuntimeInfo;
