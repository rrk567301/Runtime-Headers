...
- (void)_runPersonalizationWithSectionCollection:(id)a0 localEquivalencyMapping:(id)a1 expirationDate:(id)a2 userIdentity:(id)a3 error:(id)a4 isFinalResponse:(BOOL)a5 isInvalidForPersonalization:(BOOL)a6 performanceMetrics:(id)a7;
