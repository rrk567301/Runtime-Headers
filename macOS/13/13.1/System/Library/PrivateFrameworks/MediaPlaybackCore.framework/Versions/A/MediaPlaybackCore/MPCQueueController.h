@class NSString, NSArray, AVPlayerPlaybackCoordinator, NSMutableDictionary, MPIdentifierSet, MPShuffleableSectionedIdentifierList, MPAVItem, MPSectionedIdentifierListPosition, MPCPlaybackEngine, MPSectionedIdentifierList;
@protocol MPCQueueControllerCommandInterposing, MPCQueueCoordinating, MPCQueueControllerDelegate;

@interface MPCQueueController : NSObject <MPShuffleableSectionedIdentifierListDelegate, MPSectionedIdentifierListAnnotationDelegate, MPCContinueListeningRadioQueueProviding, MPCPlaybackEngineEventObserving, MPArtworkDataSource, MPStartItemInfoProviding, MPCQueueItemProviding, MSVSegmentedCoding, MPCQueueControllerCommandInterposingHost> {
...
@property (copy, nonatomic) NSString *currentStartItemIdentifier;
...
@property (retain, nonatomic) id<MPCQueueCoordinating> queueCoordinator;
...
- (void)autoPlayEnabledDidChange:(BOOL)a0;
...
- (BOOL)canPreviousTrackForItem:(id)a0 reason:(id *)a1;
- (BOOL)canNextTrackForItem:(id)a0 reason:(id *)a1;
- (void)clearUpNext;
...
- (void)currentItemDidChangeFromItem:(id)a0 toItem:(id)a1;
...
- (void)_loadItemsForAutoplaySessionWithDeletedItemsCount:(long long)a0;
