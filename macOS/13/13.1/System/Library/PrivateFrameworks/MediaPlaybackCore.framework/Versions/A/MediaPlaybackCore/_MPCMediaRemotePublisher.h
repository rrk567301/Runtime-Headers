@class MPCPlayerPath, NSString, NSArray, MPNowPlayingInfoCenter, MPCPlayPerfMetrics, MPRemoteCommandCenter, NSObject, MPCPlaybackEngine, NSUserDefaults, MSVBlockGuard;
@protocol OS_dispatch_source;

@interface _MPCMediaRemotePublisher : NSObject <MPNowPlayingPlaybackQueueDataSourcePrivate, MPCPlaybackEngineEventObserving, MPCPlaybackAccountManagerObserver> {
    NSArray *_accounts;
