...
- (void)_addText:(id)a0 currentPos:(struct __DDQueryOffset { unsigned int x0 : 32; unsigned int x1 : 32; })a1 newPos:(struct __DDQueryOffset { unsigned int x0 : 32; unsigned int x1 : 32; })a2 offset:(struct __DDQueryOffset { unsigned int x0 : 32; unsigned int x1 : 32; })a3 query:(struct __DDScanQuery { } *)a4;
