@class NSUUID, NSDate, GEOComposedRoute, GEOComposedETARoute, MNDisplayETAInfo, MNRouteDistanceInfo, MNBatteryChargeInfo, GEOETATrafficUpdateResponse, GEOComposedRouteTraffic, GEOTransitRouteUpdateRequest;
...
@property (retain, nonatomic) NSDate *serverDisplayETA;
