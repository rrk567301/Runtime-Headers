...
+ (void)_drawIcon:(id)a0 inRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 withRenderer:(id)a2;
+ (void)drawIconsInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withRenderer:(id)a1;
+ (id)birthdayDotImage;
+ (id)birthdaySelectedDotImage;
+ (id)birthdayAllDayDotImageForFont:(id)a0;
+ (id)birthdayAllDaySelectedDotImageForFont:(id)a0;
