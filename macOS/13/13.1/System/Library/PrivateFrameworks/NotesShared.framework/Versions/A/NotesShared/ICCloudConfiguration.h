...
@property (nonatomic) BOOL fastSyncEnabled;
@property (nonatomic) unsigned long long fastSyncMaximumMessageSizeBytes;
@property (nonatomic) BOOL fastSyncPaperKitEnablePCSEncryption;
@property (nonatomic) BOOL fastSyncPaperKitEnableEphemeralRecords;
