...
- (BOOL)changeItem:(id)a0 baseVersion:(id)a1 changedFields:(unsigned long long)a2 newValues:(id)a3 contents:(id)a4 options:(unsigned long long)a5 additionalAttrs:(id)a6 clearCKInfoOnSyncUp:(BOOL)a7 error:(id *)a8;
