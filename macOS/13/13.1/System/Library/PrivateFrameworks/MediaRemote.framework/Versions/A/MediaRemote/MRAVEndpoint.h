@class NSTimer, NSString, MRExternalDevice, MRAVOutputDevice, NSArray, MROutputContextDataSource, NSDictionary, _MRAVEndpointDescriptorProtobuf, NSMutableArray, NSOperationQueue, MROrigin;
...
- (void)_handleEndpointDidConnectNotification:(id)a0;
