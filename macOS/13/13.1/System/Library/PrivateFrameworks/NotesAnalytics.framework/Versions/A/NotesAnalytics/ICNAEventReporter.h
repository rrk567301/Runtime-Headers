@class NSMutableDictionary, NSMutableSet, ICNASubTracker, NSWindow;
...
- (void)submitFastSyncSessionEndForNote:(id)a0 sessionID:(id)a1 participantVersions:(id)a2 numUniqueAccounts:(id)a3 numUniqueDevices:(id)a4;
