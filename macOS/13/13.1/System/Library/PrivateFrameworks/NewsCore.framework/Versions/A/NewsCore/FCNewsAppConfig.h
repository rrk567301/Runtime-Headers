@class NSDictionary, FCSmarterMessagingConfig, FCPaidBundleConfiguration, FCTimesOfDayConfiguration, FCSportsUpsellConfig, FCLaunchPresentationConfig, NSString, FCForYouGroupsConfiguration, FCTopStoriesConfiguration, FCNewsPlusLabelConfigGroup, NSArray, FCWidgetConfig, FCIAdConfiguration, FCNewsPersonalizationConfiguration, FCNotificationsConfiguration, FCEmbedProxyConfiguration, FCAppReviewRequestConfig, FCVideoGroupsConfig, FCPrefetchConfiguration, NTPBDiscoverMoreVideosInfo, FCPersonalizationTreatment, FCSportsPrivacyConfiguration, FCPaidBundleViaOfferConfig, NSNumber;
...
@property (readonly, nonatomic) BOOL shouldManuallySupplementEvergreenWithFeaturedArticles;
@property (readonly, nonatomic) BOOL shouldManuallySupplementEvergreenWithIssueArticles;
@property (readonly, nonatomic) long long maxIssuesPerIssueArticleInventoryRequest;
