@class NSDate, NSString, NSArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSData, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, CKRecord, FCFeedPersonalizedItemScoreProfile, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleScores, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleConversionStats;
