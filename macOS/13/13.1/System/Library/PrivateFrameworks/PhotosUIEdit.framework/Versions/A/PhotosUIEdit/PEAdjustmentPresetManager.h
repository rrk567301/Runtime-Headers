@class NSString, NSURL, PEEditActionEventBuilder, NSMutableDictionary, PEEditActionBatch, NSMutableArray, NSObject, NSPasteboard, PEPasteablePreset, PEResourceManager;
