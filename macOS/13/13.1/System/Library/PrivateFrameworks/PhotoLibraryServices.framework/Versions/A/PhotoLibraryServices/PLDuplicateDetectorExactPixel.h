...
- (id)_generateDuplicateContainerFromResults:(id)a0 excludedAssetOIDs:(id)a1;
...
- (id)_excludedAssetOIDsWithPhotoLibrary:(id)a0 error:(id *)a1;
...
- (id)_postProcessingRequestWithDuplicateAssetOIDs:(id)a0;
