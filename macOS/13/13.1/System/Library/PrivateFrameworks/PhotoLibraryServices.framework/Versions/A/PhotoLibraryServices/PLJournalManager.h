@class NSPersistentHistoryToken, PLLibraryServicesManager, PLChangeHandlingNotificationObserver, NSObject;
...
+ (id)entriesByPayloadClassIDFromHistoryToken:(id)a0 currentHistoryToken:(id *)a1 withManagedObjectContext:(id)a2 shouldStopBlock:(id /* block */)a3 error:(id *)a4;
