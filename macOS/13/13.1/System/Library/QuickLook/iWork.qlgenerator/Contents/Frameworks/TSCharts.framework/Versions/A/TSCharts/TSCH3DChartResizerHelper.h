...
+ (id)vectorForContainingViewport:(const void *)a0;
...
- (id)boundsLayoutResizedForScene:(id)a0 bounds:(const void *)a1 resizeStartingSize:(void *)a2 mode:(int)a3 returningResultSize:(void *)a4;
...
- (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })chartBodySizeByResizingScene:(id)a0 toLayoutSize:(const void *)a1 resizeStartingSize:(void *)a2 returningChartBodyLayoutOffsetInChartAreaLayoutSpace:(void *)a3 resultLayoutSize:(void *)a4;
- (struct tvec2<float> { union { float x0; float x1; float x2; } x0; union { float x0; float x1; float x2; } x1; })layoutSizeByResizingScene:(id)a0 toChartBodyLayoutSize:(const void *)a1 resizeStartingSize:(void *)a2 returningChartBodyLayoutBoundsInChartAreaLayoutSpace:(void *)a3;
