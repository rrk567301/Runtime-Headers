...
@interface TSTConcurrentCellList : TSPObject <NSCopying> {
    ...
    struct vector<TSTNineKeyStructPreBNC, std::allocator<TSTNineKeyStructPreBNC>> { struct *__begin_; struct *__end_; struct __compressed_pair<TSTNineKeyStructPreBNC *, std::allocator<TSTNineKeyStructPreBNC>> { struct *__value_; } __end_cap_; } _preBNCKeysList;
