@class NSString, AGXG13XFamilyBuffer;
@protocol MTLHeap, MTLDevice;

@interface AGXG13XFamilyIndirectCommandBuffer : IOGPUMetalIndirectCommandBuffer <MTLIndirectCommandBuffer> {
    int _type;
    AGXG13XFamilyBuffer *_buffer;
