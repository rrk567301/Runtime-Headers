@class NSError, NSString, AGXG13GFamilyRenderContext, __end_, __end_cap_, NSMutableDictionary, NSDictionary, AGXG13GFamilyComputeContext, AGXG13GFamilyBlitContext;
@protocol MTLDeadlineProfile, MTLDevice, MTLLogContainer, MTLCommandQueue;

@interface AGXG13GFamilyCommandBuffer : IOGPUMetalCommandBuffer <MTLCommandBufferSPI> {
    AGXG13GFamilyBlitContext *_previousBlitCommandEncoder;
    AGXG13GFamilyComputeContext *_previousComputeCommandEncoder;
    AGXG13GFamilyRenderContext *_previousRenderCommandEncoder;
    struct AGXATelemetryUsage { unsigned long long usage[2]; } _telemetryUsage;
    void *_impl;
    struct vector<AGXG13GFamilyTexture *, std::allocator<AGXG13GFamilyTexture *>> { __end_ **__begin_; __end_cap_ **x0; struct __compressed_pair<AGXG13GFamilyTexture **, std::allocator<AGXG13GFamilyTexture *>> { id *__value_; } x1; } texturesToEvaluate;
