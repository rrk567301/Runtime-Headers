...
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { } *)a0 infoDictionary:(id)a1 domains:(unsigned int)a2 delegatesMightBeMainBundle:(BOOL)a3;
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { } *)a0 infoDictionary:(id)a1 domains:(unsigned int)a2;
