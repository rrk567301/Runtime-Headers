...
- (id)fetchContentsForItemWithID:(id)a0 version:(id)a1 request:(id)a2 extent:(id)a3 alignment:(unsigned long long)a4 options:(unsigned long long)a5 shouldForwardVersion:(BOOL)a6 completionHandler:(id /* block */)a7;
