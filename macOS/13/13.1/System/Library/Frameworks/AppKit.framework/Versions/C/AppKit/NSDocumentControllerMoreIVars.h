@class NSMutableDictionary, NSObject, NSMenuItem, NSTouchBar, NSMutableArray, NSDocumentControllerPersistentRestoration, NSDocumentControllerSubMenuDelegate, NSString, NSMutableSet, NSOperationQueue, NSArray, NSWindow, NSSharingServicePicker, NSError, NSDocument;
