...
+ (const struct __CFString { } *)copyStringWithMarkdown:(struct __CFString { } *)a0 formatConfiguration:(struct __CFDictionary { } *)a1 bundle:(struct __CFBundle { } *)a2 tableURL:(struct __CFURL { } *)a3;
