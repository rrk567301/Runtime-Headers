@class NSString, NEIKEv2Packet, NEIKEv2IKESA, NSMutableDictionary, NEIKEv2RTT, NEIPSecSASession, NSMutableArray, NSObject, NEIKEv2IKESAConfiguration, NEIKEv2ChildSAConfiguration, NEIKEv2ConfigurationMessage;
