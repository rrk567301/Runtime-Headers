...
@interface WKWebsiteDataStore : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebsiteDataStore> { struct type { unsigned char __lx[208]; } data; } _websiteDataStore;
...
- (void)_getOriginsWithPushSubscriptions:(id /* block */)a0;
