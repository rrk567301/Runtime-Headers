...
@property (copy, nonatomic) MTRTestClusterClusterSimpleStruct *nullableStructValue;
@property (copy, nonatomic) NSNumber *optionalStructWasPresent;
@property (copy, nonatomic) MTRTestClusterClusterSimpleStruct *optionalStructValue;
...
@property (copy, nonatomic) MTRTestClusterClusterSimpleStruct *nullableOptionalStructValue;
